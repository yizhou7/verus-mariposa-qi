...
pub proof fn lemma_test(a: int, b: int, c: int) {
		...
		assert(temp_0 == temp_1) by 
			{lemma_mul_properties_auto(); }	// 0
		assert(temp_1 == temp_2) by 
			{lemma_mul_properties_auto(); }	// 1
		assert(temp_2 == temp_3) by 
			{lemma_mul_properties_auto(); }	// 2
		assert(temp_3 == temp_4) by 
			{lemma_mul_properties_auto(); }	// 3
		assert(temp_4 == temp_5) by 
			{lemma_mul_properties_auto(); }	// 4
		assert(temp_5 == temp_6) by 
			{lemma_mul_properties_auto(); }	// 5
		assert(temp_6 == temp_7) by 
			{lemma_mul_properties_auto(); }	// 6
		assert(temp_7 == temp_8) by 
			{lemma_mul_properties_auto(); }	// 7
		assert(temp_8 == temp_9) by 
			{lemma_mul_properties_auto(); }	// 8
		assert(temp_9 == temp_10) by 
			{lemma_mul_properties_auto(); }	// 9
		assert(temp_10 == temp_11) by 
			{lemma_mul_properties_auto(); }	// 10
		assert(temp_11 == temp_12) by 
			{lemma_mul_properties_auto(); }	// 11
		assert(temp_12 == temp_13) by 
			{lemma_mul_properties_auto(); }	// 12
		assert(temp_13 == temp_14) by 
			{lemma_mul_properties_auto(); }	// 13
		assert(temp_14 == temp_15) by 
			{lemma_mul_properties_auto(); }	// 14
		assert(temp_15 == temp_16) by 
			{lemma_mul_properties_auto(); }	// 15
		assert(temp_16 == temp_17) by 
			{lemma_mul_properties_auto(); }	// 16
		assert(temp_17 == temp_18) by 
			{lemma_mul_properties_auto(); }	// 17
		assert(temp_18 == temp_19) by 
			{lemma_mul_properties_auto(); }	// 18
		assert(temp_19 == temp_20) by 
			{lemma_mul_properties_auto(); }	// 19
}
} // verus!