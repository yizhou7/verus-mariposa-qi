...
(declare-const temp_1_0~585@ Int)
(declare-const temp_1_1~642@ Int)
(declare-const temp_2_0~751@ Int)
(declare-const temp_2_1~820@ Int)
(declare-const temp_3_0~1015@ Int)
(declare-const temp_3_1~1060@ Int)
(declare-const temp_4_0~1163@ Int)
(declare-const temp_4_1~1232@ Int)
(declare-const temp_5_0~1341@ Int)
(declare-const temp_5_1~1402@ Int)
(declare-const temp_6_0~1611@ Int)
(declare-const temp_6_1~1676@ Int)
(declare-const temp_7_0~1829@ Int)
(declare-const temp_7_1~1894@ Int)
(declare-const temp_8_0~1983@ Int)
(declare-const temp_8_1~2056@ Int)
(declare-const temp_9_0~2155@ Int)
(declare-const temp_9_1~2208@ Int)
(declare-const temp_10_0~2293@ Int)
(declare-const temp_10_1~2342@ Int)
(declare-const temp_11_0~2487@ Int)
(declare-const temp_11_1~2552@ Int)
(declare-const temp_12_0~2777@ Int)
(declare-const temp_12_1~2850@ Int)
(declare-const temp_13_0~3073@ Int)
(declare-const temp_13_1~3130@ Int)
(declare-const temp_14_0~3219@ Int)
(declare-const temp_14_1~3272@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Add a0~2@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Add a0~2@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Mul (Mul a0~2@ a0~2@) d0~8@) b0~4@)))) (and (=> (= tmp%1@ (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Add a0~2@ b0~4@) (Mul b0~4@ a0~2@)))) (=> (= tmp%2@ (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ a0~2@))) (=> (= tmp%3@ (Mul (Mul (Mul a0~2@ a0~2@) d0~8@) b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> (= tmp%4@ (Mul a0~2@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ d0~8@ b0~4@) (=> (= tmp%5@ (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Add a0~2@ b0~4@) (Mul b0~4@ a0~2@)))) (=> (= tmp%6@ (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ a0~2@))) (=> (= tmp%7@ (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ b0~4@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))))))))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~585@ (Mul (Mul (Mul (Sub a1~10@ a1~10@) (Sub c1~14@ c1~14@)) (Mul a1~10@ (Mul c1~14@ d1~16@))) (Mul (Mul (Sub c1~14@ d1~16@) (Mul b1~12@ c1~14@)) (Sub (Sub a1~10@ a1~10@) c1~14@)))) (=> (= temp_1_1~642@ (Mul (Mul (Mul (Sub a1~10@ a1~10@) (Sub c1~14@ c1~14@)) (Mul a1~10@ (Mul c1~14@ d1~16@))) (Mul (Sub (Sub a1~10@ a1~10@) c1~14@) (Mul (Sub c1~14@ d1~16@) (Mul b1~12@ c1~14@))))) (and (=> (= tmp%8@ (Sub (Sub a1~10@ a1~10@) c1~14@)) (=> (= tmp%9@ (Mul (Sub c1~14@ d1~16@) (Mul b1~12@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%1 (= temp_1_0~585@ temp_1_1~642@))))) (=> (= temp_1_0~585@ temp_1_1~642@) (=> (= temp_2_0~751@ (Mul (Mul (Add (Mul b2~20@ d2~24@) (Sub d2~24@ d2~24@)) (Mul (Mul c2~22@ a2~18@) c2~22@)) (Mul (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ b2~20@)) (Mul (Sub b2~20@ c2~22@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~820@ (Mul (Mul (Add (Mul b2~20@ d2~24@) (Sub d2~24@ d2~24@)) (Mul (Mul c2~22@ a2~18@) c2~22@)) (Mul (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ b2~20@)) (Sub (Mul b2~20@ (Mul c2~22@ c2~22@)) (Mul c2~22@ (Mul c2~22@ c2~22@)))))) (and (=> (= tmp%10@ (Mul (Add (Mul b2~20@ d2~24@) (Sub d2~24@ d2~24@)) (Mul (Mul c2~22@ a2~18@) c2~22@))) (=> (= tmp%11@ (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ b2~20@))) (=> (= tmp%12@ (Sub (Mul b2~20@ (Mul c2~22@ c2~22@)) (Mul c2~22@ (Mul c2~22@ c2~22@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> (= tmp%13@ (Mul c2~22@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b2~20@ c2~22@ tmp%13@) (=> (= tmp%14@ (Mul (Add (Mul b2~20@ d2~24@) (Sub d2~24@ d2~24@)) (Mul (Mul c2~22@ a2~18@) c2~22@))) (=> (= tmp%15@ (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ b2~20@))) (=> (= tmp%16@ (Mul (Sub b2~20@ c2~22@) (Mul c2~22@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%2 (= temp_2_0~751@ temp_2_1~820@)))))))))))) (=> (= temp_2_0~751@ temp_2_1~820@) (=> (= temp_3_0~1015@ (Mul (Mul (Add (Mul c3~30@ b3~28@) (Add a3~26@ b3~28@)) (Mul (Add b3~28@ d3~32@) (Mul a3~26@ c3~30@))) b3~28@)) (=> (= temp_3_1~1060@ (Mul (Mul (Add (Mul c3~30@ b3~28@) (Add a3~26@ b3~28@)) (Add (Mul b3~28@ (Mul a3~26@ c3~30@)) (Mul d3~32@ (Mul a3~26@ c3~30@)))) b3~28@)) (and (=> (= tmp%17@ (Mul a3~26@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b3~28@ d3~32@ tmp%17@) (=> %%location_label%%3 (= temp_3_0~1015@ temp_3_1~1060@)))) (=> (= temp_3_0~1015@ temp_3_1~1060@) (=> (= temp_4_0~1163@ (Sub (Mul (Mul (Add d4~40@ d4~40@) b4~36@) (Sub b4~36@ (Mul 40 d4~40@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ a4~34@)) (Mul (Add b4~36@ b4~36@) (Add a4~34@ a4~34@))))) (=> (= temp_4_1~1232@ (Sub (Mul (Sub b4~36@ (Mul 40 d4~40@)) (Mul (Add d4~40@ d4~40@) b4~36@)) (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ a4~34@)) (Mul (Add b4~36@ b4~36@) (Add a4~34@ a4~34@))))) (and (=> (= tmp%18@ (Sub b4~36@ (Mul 40 d4~40@))) (=> (= tmp%19@ (Mul (Add d4~40@ d4~40@) b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%4 (= temp_4_0~1163@ temp_4_1~1232@))))) (=> (= temp_4_0~1163@ temp_4_1~1232@) (=> (= temp_5_0~1341@ (Mul (Mul (Sub (Mul a5~42@ d5~48@) (Mul d5~48@ b5~44@)) (Mul (Add b5~44@ b5~44@) (Add c5~46@ d5~48@))) (Mul (Mul (Mul d5~48@ c5~46@) (Sub c5~46@ a5~42@)) (Mul (Mul b5~44@ c5~46@) a5~42@)))) (=> (= temp_5_1~1402@ (Mul (Mul (Sub (Mul a5~42@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Add b5~44@ b5~44@) (Add c5~46@ d5~48@))) (Mul (Mul (Mul d5~48@ c5~46@) (Sub c5~46@ a5~42@)) (Mul (Mul b5~44@ c5~46@) a5~42@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b5~44@ d5~48@) (=> (= tmp%20@ (Sub (Mul a5~42@ d5~48@) (Mul b5~44@ d5~48@))) (=> (= tmp%21@ (Mul (Add b5~44@ b5~44@) (Add c5~46@ d5~48@))) (=> (= tmp%22@ (Mul (Mul (Mul d5~48@ c5~46@) (Sub c5~46@ a5~42@)) (Mul (Mul b5~44@ c5~46@) a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> (= tmp%23@ (Sub (Mul a5~42@ d5~48@) (Mul d5~48@ b5~44@))) (=> (= tmp%24@ (Mul (Add b5~44@ b5~44@) (Add c5~46@ d5~48@))) (=> (= tmp%25@ (Mul (Mul (Mul d5~48@ c5~46@) (Sub c5~46@ a5~42@)) (Mul (Mul b5~44@ c5~46@) a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> %%location_label%%5 (= temp_5_0~1341@ temp_5_1~1402@))))))))))) (=> (= temp_5_0~1341@ temp_5_1~1402@) (=> (= temp_6_0~1611@ (Mul (Add (Add (Mul d6~56@ c6~54@) (Mul b6~52@ c6~54@)) (Sub (Mul c6~54@ d6~56@) (Mul a6~50@ d6~56@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ d6~56@)) (Add (Mul c6~54@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1676@ (Mul (Add (Add (Mul d6~56@ c6~54@) (Mul b6~52@ c6~54@)) (Sub (Mul c6~54@ d6~56@) (Mul a6~50@ d6~56@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ d6~56@)) (Add (Mul c6~54@ b6~52@) (Mul c6~54@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ c6~54@) (=> (= tmp%26@ (Mul d6~56@ c6~54@)) (=> (= tmp%27@ (Mul a6~50@ d6~56@)) (=> (= tmp%28@ (Add (Mul c6~54@ b6~52@) (Mul c6~54@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> (= tmp%29@ (Mul c6~54@ d6~56@)) (=> (= tmp%30@ (Mul a6~50@ d6~56@)) (=> (= tmp%31@ (Add (Mul c6~54@ b6~52@) (Mul c6~54@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> %%location_label%%6 (= temp_6_0~1611@ temp_6_1~1676@))))))))))) (=> (= temp_6_0~1611@ temp_6_1~1676@) (=> (= temp_7_0~1829@ (Sub (Sub (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@))) (Mul (Sub (Sub d7~64@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1894@ (Sub (Sub (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ d7~64@))) (Mul (Sub (Sub d7~64@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1829@ temp_7_1~1894@))) (=> (= temp_7_0~1829@ temp_7_1~1894@) (=> (= temp_8_0~1983@ (Mul (Mul (Add (Mul a8~66@ d8~72@) (Sub d8~72@ d8~72@)) (Mul (Mul b8~68@ a8~66@) d8~72@)) (Mul (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~2056@ (Mul (Add (Mul (Mul a8~66@ d8~72@) (Mul (Mul b8~68@ a8~66@) d8~72@)) (Mul (Sub d8~72@ d8~72@) (Mul (Mul b8~68@ a8~66@) d8~72@))) (Mul (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ a8~66@))))) (and (=> (= tmp%32@ (Mul a8~66@ d8~72@)) (=> (= tmp%33@ (Sub d8~72@ d8~72@)) (=> (= tmp%34@ (Mul (Mul b8~68@ a8~66@) d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%8 (= temp_8_0~1983@ temp_8_1~2056@)))))) (=> (= temp_8_0~1983@ temp_8_1~2056@) (=> (= temp_9_0~2155@ (Mul (Mul (Mul (Add c9~78@ c9~78@) (Mul b9~76@ d9~80@)) (Mul (Add d9~80@ a9~74@) (Mul c9~78@ b9~76@))) (Mul (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@)) d9~80@))) (=> (= temp_9_1~2208@ (Mul (Mul (Mul (Add c9~78@ c9~78@) (Mul b9~76@ d9~80@)) (Mul (Mul c9~78@ b9~76@) (Add d9~80@ a9~74@))) (Mul (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@)) d9~80@))) (and (=> (= tmp%35@ (Mul c9~78@ b9~76@)) (=> (= tmp%36@ (Add d9~80@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%35@ tmp%36@) (=> %%location_label%%9 (= temp_9_0~2155@ temp_9_1~2208@))))) (=> (= temp_9_0~2155@ temp_9_1~2208@) (=> (= temp_10_0~2293@ (Mul (Mul (Sub a10~82@ (Mul b10~84@ d10~88@)) (Mul (Sub b10~84@ c10~86@) (Mul c10~86@ b10~84@))) (Add a10~82@ (Mul (Mul b10~84@ b10~84@) (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~2342@ (Mul (Mul (Sub a10~82@ (Mul b10~84@ d10~88@)) (Mul (Sub b10~84@ c10~86@) (Mul b10~84@ c10~86@))) (Add a10~82@ (Mul (Mul b10~84@ b10~84@) (Mul a10~82@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b10~84@ c10~86@) (=> (= tmp%37@ (Sub a10~82@ (Mul b10~84@ d10~88@))) (=> (= tmp%38@ (Sub b10~84@ c10~86@)) (=> (= tmp%39@ (Mul b10~84@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%37@ tmp%38@ tmp%39@) (=> (= tmp%40@ (Sub a10~82@ (Mul b10~84@ d10~88@))) (=> (= tmp%41@ (Sub b10~84@ c10~86@)) (=> (= tmp%42@ (Mul c10~86@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ tmp%41@ tmp%42@) (=> %%location_label%%10 (= temp_10_0~2293@ temp_10_1~2342@))))))))))) (=> (= temp_10_0~2293@ temp_10_1~2342@) (=> (= temp_11_0~2487@ (Mul (Mul (Mul (Mul c11~94@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ a11~90@))) (Sub (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ c11~94@)) (Sub (Sub c11~94@ b11~92@) (Mul c11~94@ d11~96@))))) (=> (= temp_11_1~2552@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ d11~96@)) (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ a11~90@))) (Sub (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ c11~94@)) (Sub (Sub c11~94@ b11~92@) (Mul c11~94@ d11~96@))))) (and (=> (= tmp%43@ (Mul b11~92@ d11~96@)) (=> (= tmp%44@ (Mul c11~94@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%43@ tmp%44@) (=> (= tmp%45@ (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ d11~96@))) (=> (= tmp%46@ (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ a11~90@))) (=> (= tmp%47@ (Sub (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ c11~94@)) (Sub (Sub c11~94@ b11~92@) (Mul c11~94@ d11~96@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%45@ tmp%46@ tmp%47@) (=> (= tmp%48@ (Mul (Mul c11~94@ d11~96@) (Mul b11~92@ d11~96@))) (=> (= tmp%49@ (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ a11~90@))) (=> (= tmp%50@ (Sub (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ c11~94@)) (Sub (Sub c11~94@ b11~92@) (Mul c11~94@ d11~96@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%48@ tmp%49@ tmp%50@) (=> %%location_label%%11 (= temp_11_0~2487@ temp_11_1~2552@))))))))))))) (=> (= temp_11_0~2487@ temp_11_1~2552@) (=> (= temp_12_0~2777@ (Mul (Mul (Mul (Mul d12~104@ c12~102@) (Sub d12~104@ b12~100@)) (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@))) (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@)) (Mul (Mul b12~100@ a12~98@) (Sub a12~98@ d12~104@))))) (=> (= temp_12_1~2850@ (Mul (Mul (Mul (Mul d12~104@ c12~102@) (Sub d12~104@ b12~100@)) (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@))) (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@)) (Sub (Mul (Mul b12~100@ a12~98@) a12~98@) (Mul (Mul b12~100@ a12~98@) d12~104@))))) (and (=> (= tmp%51@ (Mul (Mul (Mul d12~104@ c12~102@) (Sub d12~104@ b12~100@)) (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@)))) (=> (= tmp%52@ (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@))) (=> (= tmp%53@ (Sub (Mul (Mul b12~100@ a12~98@) a12~98@) (Mul (Mul b12~100@ a12~98@) d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%51@ tmp%52@ tmp%53@) (=> (= tmp%54@ (Mul b12~100@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%54@ a12~98@ d12~104@) (=> (= tmp%55@ (Mul (Mul (Mul d12~104@ c12~102@) (Sub d12~104@ b12~100@)) (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@)))) (=> (= tmp%56@ (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@))) (=> (= tmp%57@ (Mul (Mul b12~100@ a12~98@) (Sub a12~98@ d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%55@ tmp%56@ tmp%57@) (=> %%location_label%%12 (= temp_12_0~2777@ temp_12_1~2850@)))))))))))) (=> (= temp_12_0~2777@ temp_12_1~2850@) (=> (= temp_13_0~3073@ (Sub (Sub (Add (Mul c13~110@ a13~106@) (Mul d13~112@ b13~108@)) (Mul c13~110@ (Sub c13~110@ c13~110@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ d13~112@)) (Mul d13~112@ (Mul a13~106@ d13~112@))))) (=> (= temp_13_1~3130@ (Sub (Sub (Add (Mul c13~110@ a13~106@) (Mul d13~112@ b13~108@)) (Mul c13~110@ (Sub c13~110@ c13~110@))) (Mul (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ d13~112@)) (Mul d13~112@ (Mul a13~106@ d13~112@))))) (and (=> (= tmp%58@ (Mul c13~110@ d13~112@)) (=> (= tmp%59@ (Mul d13~112@ d13~112@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%58@ tmp%59@) (=> %%location_label%%13 (= temp_13_0~3073@ temp_13_1~3130@))))) (=> (= temp_13_0~3073@ temp_13_1~3130@) (=> (= temp_14_0~3219@ (Mul (Mul (Mul (Mul a14~114@ b14~116@) (Mul b14~116@ b14~116@)) (Mul (Add a14~114@ b14~116@) (Mul a14~114@ d14~120@))) (Mul c14~118@ (Mul (Mul b14~116@ d14~120@) (Mul c14~118@ c14~118@))))) (=> (= temp_14_1~3272@ (Mul (Mul (Mul (Add a14~114@ b14~116@) (Mul a14~114@ d14~120@)) (Mul (Mul a14~114@ b14~116@) (Mul b14~116@ b14~116@))) (Mul c14~118@ (Mul (Mul b14~116@ d14~120@) (Mul c14~118@ c14~118@))))) (=> (= tmp%60@ (Mul (Add a14~114@ b14~116@) (Mul a14~114@ d14~120@))) (=> (= tmp%61@ (Mul (Mul a14~114@ b14~116@) (Mul b14~116@ b14~116@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%60@ tmp%61@) (=> %%location_label%%14 (= temp_14_0~3219@ temp_14_1~3272@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
