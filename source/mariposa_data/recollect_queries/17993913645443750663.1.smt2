...
(declare-const temp_3_0~872@ Int)
(declare-const temp_3_1~921@ Int)
(declare-const temp_4_0~1010@ Int)
(declare-const temp_4_1~1103@ Int)
(declare-const temp_5_0~1258@ Int)
(declare-const temp_5_1~1335@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ c0~6@)) (Add (Mul b0~4@ a0~2@) (Mul b0~4@ c0~6@))) (Mul (Add (Add d0~8@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ c0~6@)) (Add (Mul b0~4@ a0~2@) (Mul b0~4@ c0~6@))) (Mul (Add (Add d0~8@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ a0~2@))))) (and (=> (= tmp%1@ (Mul d0~8@ d0~8@)) (=> (= tmp%2@ (Mul a0~2@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> (= tmp%3@ (Mul (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ c0~6@)) (Add (Mul b0~4@ a0~2@) (Mul b0~4@ c0~6@)))) (=> (= tmp%4@ (Add (Add d0~8@ c0~6@) (Mul a0~2@ d0~8@))) (=> (= tmp%5@ (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Mul (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ c0~6@)) (Add (Mul b0~4@ a0~2@) (Mul b0~4@ c0~6@)))) (=> (= tmp%7@ (Add (Add d0~8@ c0~6@) (Mul a0~2@ d0~8@))) (=> (= tmp%8@ (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))))))))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~595@ (Sub (Mul (Mul (Mul a1~10@ a1~10@) (Add a1~10@ d1~16@)) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Sub c1~14@ d1~16@) (Sub c1~14@ d1~16@)) (Add (Mul c1~14@ a1~10@) (Add d1~16@ b1~12@))))) (=> (= temp_1_1~660@ (Sub (Mul (Mul a1~10@ (Mul a1~10@ (Add a1~10@ d1~16@))) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Sub c1~14@ d1~16@) (Sub c1~14@ d1~16@)) (Add (Mul c1~14@ a1~10@) (Add d1~16@ b1~12@))))) (and (=> (= tmp%9@ (Add a1~10@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a1~10@ a1~10@ tmp%9@) (=> %%location_label%%1 (= temp_1_0~595@ temp_1_1~660@)))) (=> (= temp_1_0~595@ temp_1_1~660@) (=> (= temp_2_0~751@ (Mul (Mul (Mul a2~18@ (Mul c2~22@ d2~24@)) (Sub (Mul c2~22@ c2~22@) (Sub a2~18@ c2~22@))) (Mul (Mul (Mul a2~18@ d2~24@) d2~24@) (Mul (Mul a2~18@ d2~24@) (Add c2~22@ b2~20@))))) (=> (= temp_2_1~808@ (Mul (Mul (Mul a2~18@ (Mul c2~22@ d2~24@)) (Sub (Mul c2~22@ c2~22@) (Sub a2~18@ c2~22@))) (Mul (Mul (Mul a2~18@ d2~24@) d2~24@) (Mul (Mul a2~18@ d2~24@) (Add c2~22@ b2~20@))))) (=> (= tmp%10@ (= temp_2_0~751@ temp_2_1~808@)) (and (=> %%location_label%%2 tmp%10@) (=> tmp%10@ (=> (= temp_3_0~872@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) c3~30@) b3~28@) (Mul (Mul (Mul c3~30@ b3~28@) (Mul d3~32@ a3~26@)) (Add (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~921@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) c3~30@) b3~28@) (Mul (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ d3~32@)) (Add (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ d3~32@) (=> %%location_label%%3 (= temp_3_0~872@ temp_3_1~921@))) (=> (= temp_3_0~872@ temp_3_1~921@) (=> (= temp_4_0~1010@ (Mul (Add (Add (Sub a4~34@ c4~38@) (Mul a4~34@ a4~34@)) (Mul c4~38@ (Mul a4~34@ a4~34@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Sub b4~36@ a4~34@))))) (=> (= temp_4_1~1103@ (Add (Mul (Add (Sub a4~34@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Sub b4~36@ a4~34@)))) (Mul (Mul c4~38@ (Mul a4~34@ a4~34@)) (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Sub b4~36@ a4~34@)))))) (and (=> (= tmp%11@ (Add (Sub a4~34@ c4~38@) (Mul a4~34@ a4~34@))) (=> (= tmp%12@ (Mul c4~38@ (Mul a4~34@ a4~34@))) (=> (= tmp%13@ (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Sub b4~36@ a4~34@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%4 (= temp_4_0~1010@ temp_4_1~1103@)))))) (=> (= temp_4_0~1010@ temp_4_1~1103@) (=> (= temp_5_0~1258@ (Mul (Mul a5~42@ (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul 12 d5~48@)) (Mul (Add c5~46@ 68) (Add d5~48@ a5~42@))))) (=> (= temp_5_1~1335@ (Mul (Mul (Mul a5~42@ (Mul d5~48@ d5~48@)) (Mul c5~46@ d5~48@)) (Mul (Mul (Mul d5~48@ b5~44@) (Mul 12 d5~48@)) (Mul (Add c5~46@ 68) (Add d5~48@ a5~42@))))) (=> (= tmp%14@ (Mul d5~48@ d5~48@)) (=> (= tmp%15@ (Mul c5~46@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a5~42@ tmp%14@ tmp%15@) (=> %%location_label%%5 (= temp_5_0~1258@ temp_5_1~1335@)))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
