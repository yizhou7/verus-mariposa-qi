...
(declare-const temp_2_0~757@ Int)
(declare-const temp_2_1~830@ Int)
(declare-const temp_3_0~931@ Int)
(declare-const temp_3_1~996@ Int)
(declare-const temp_4_0~1093@ Int)
(declare-const temp_4_1~1154@ Int)
(declare-const temp_5_0~1251@ Int)
(declare-const temp_5_1~1312@ Int)
(declare-const temp_6_0~1517@ Int)
(declare-const temp_6_1~1594@ Int)
(declare-const temp_7_0~1705@ Int)
(declare-const temp_7_1~1762@ Int)
(declare-const temp_8_0~1875@ Int)
(declare-const temp_8_1~1940@ Int)
(declare-const temp_9_0~2045@ Int)
(declare-const temp_9_1~2122@ Int)
(declare-const temp_10_0~2269@ Int)
(declare-const temp_10_1~2330@ Int)
(declare-const temp_11_0~2567@ Int)
(declare-const temp_11_1~2652@ Int)
(declare-const temp_12_0~2883@ Int)
(declare-const temp_12_1~2948@ Int)
(declare-const temp_13_0~3041@ Int)
(declare-const temp_13_1~3106@ Int)
(declare-const temp_14_0~3319@ Int)
(declare-const temp_14_1~3380@ Int)
(declare-const temp_15_0~3481@ Int)
(declare-const temp_15_1~3546@ Int)
(declare-const temp_16_0~3629@ Int)
(declare-const temp_16_1~3678@ Int)
(declare-const temp_17_0~3785@ Int)
(declare-const temp_17_1~3854@ Int)
(declare-const temp_18_0~3945@ Int)
(declare-const temp_18_1~4006@ Int)
(declare-const temp_19_0~4223@ Int)
(declare-const temp_19_1~4284@ Int)
(declare-const temp_20_0~4511@ Int)
(declare-const temp_20_1~4588@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~281@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) b0~4@) (Sub c0~6@ (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~322@ (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Mul b0~4@ (Sub c0~6@ (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@)))))) (and (=> (= tmp%1@ (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@))) (=> (= tmp%2@ (Sub c0~6@ (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b0~4@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~281@ temp_0_1~322@))))) (=> (= temp_0_0~281@ temp_0_1~322@) (=> (= temp_1_0~445@ (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ c1~14@)) (Mul (Add d1~16@ c1~14@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~518@ (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ c1~14@)) (Add (Mul d1~16@ (Mul a1~10@ a1~10@)) (Mul c1~14@ (Mul a1~10@ a1~10@)))))) (and (=> (= tmp%3@ (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@)))) (=> (= tmp%4@ (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ c1~14@))) (=> (= tmp%5@ (Add (Mul d1~16@ (Mul a1~10@ a1~10@)) (Mul c1~14@ (Mul a1~10@ a1~10@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Mul a1~10@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d1~16@ c1~14@ tmp%6@) (=> (= tmp%7@ (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@)))) (=> (= tmp%8@ (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ c1~14@))) (=> (= tmp%9@ (Mul (Add d1~16@ c1~14@) (Mul a1~10@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%1 (= temp_1_0~445@ temp_1_1~518@)))))))))))) (=> (= temp_1_0~445@ temp_1_1~518@) (=> (= temp_2_0~757@ (Sub (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul 13 c2~22@))) (Mul (Add c2~22@ (Add c2~22@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~830@ (Sub (Mul (Mul (Mul b2~20@ a2~18@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ c2~22@) (Mul 13 c2~22@))) (Mul (Add c2~22@ (Add c2~22@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@))))) (and (=> (= tmp%10@ (Mul b2~20@ a2~18@)) (=> (= tmp%11@ (Mul d2~24@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%2 (= temp_2_0~757@ temp_2_1~830@))))) (=> (= temp_2_0~757@ temp_2_1~830@) (=> (= temp_3_0~931@ (Sub (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@)) (Sub (Mul b3~28@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub d3~32@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~996@ (Sub (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@)) (Sub (Mul b3~28@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub d3~32@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul d3~32@ d3~32@))))) (and (=> (= tmp%12@ (Mul b3~28@ a3~26@)) (=> (= tmp%13@ (Mul c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%3 (= temp_3_0~931@ temp_3_1~996@))))) (=> (= temp_3_0~931@ temp_3_1~996@) (=> (= temp_4_0~1093@ (Mul (Mul (Mul b4~36@ (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ b4~36@))) (Mul (Mul (Add a4~34@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~1154@ (Mul (Mul (Mul b4~36@ (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul (Add a4~34@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@))))) (and (=> (= tmp%14@ (Mul c4~38@ b4~36@)) (=> (= tmp%15@ (Mul d4~40@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%4 (= temp_4_0~1093@ temp_4_1~1154@))))) (=> (= temp_4_0~1093@ temp_4_1~1154@) (=> (= temp_5_0~1251@ (Mul (Mul (Sub (Mul b5~44@ d5~48@) (Mul 10 b5~44@)) (Mul (Mul b5~44@ d5~48@) a5~42@)) (Mul b5~44@ (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1312@ (Mul (Mul (Sub (Mul b5~44@ d5~48@) (Mul 10 b5~44@)) (Mul (Mul b5~44@ d5~48@) a5~42@)) (Mul b5~44@ (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ d5~48@) (=> (= tmp%16@ (Mul (Sub (Mul b5~44@ d5~48@) (Mul 10 b5~44@)) (Mul (Mul b5~44@ d5~48@) a5~42@))) (=> (= tmp%17@ (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ b5~44@ tmp%17@) (=> (= tmp%18@ (Mul (Sub (Mul b5~44@ d5~48@) (Mul 10 b5~44@)) (Mul (Mul b5~44@ d5~48@) a5~42@))) (=> (= tmp%19@ (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ c5~46@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ b5~44@ tmp%19@) (=> %%location_label%%5 (= temp_5_0~1251@ temp_5_1~1312@))))))))) (=> (= temp_5_0~1251@ temp_5_1~1312@) (=> (= temp_6_0~1517@ (Mul (Add (Add (Add d6~56@ a6~50@) (Mul d6~56@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul 73 c6~54@) (Mul c6~54@ c6~54@)) (Sub (Add d6~56@ b6~52@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1594@ (Mul (Add (Add (Add d6~56@ a6~50@) (Mul d6~56@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Mul 73 c6~54@) (Mul (Mul c6~54@ c6~54@) (Sub (Add d6~56@ b6~52@) (Mul d6~56@ d6~56@)))))) (and (=> (= tmp%20@ (Mul 73 c6~54@)) (=> (= tmp%21@ (Mul c6~54@ c6~54@)) (=> (= tmp%22@ (Sub (Add d6~56@ b6~52@) (Mul d6~56@ d6~56@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%6 (= temp_6_0~1517@ temp_6_1~1594@)))))) (=> (= temp_6_0~1517@ temp_6_1~1594@) (=> (= temp_7_0~1705@ (Mul (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ d7~64@)) (Mul c7~62@ (Mul c7~62@ d7~64@))) (Mul (Add d7~64@ (Mul c7~62@ b7~60@)) (Mul (Add c7~62@ d7~64@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1762@ (Mul (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ d7~64@)) (Mul c7~62@ (Mul c7~62@ d7~64@))) (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ b7~60@)) (Add d7~64@ (Mul c7~62@ b7~60@))))) (and (=> (= tmp%23@ (Mul (Add c7~62@ d7~64@) (Mul d7~64@ b7~60@))) (=> (= tmp%24@ (Add d7~64@ (Mul c7~62@ b7~60@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> %%location_label%%7 (= temp_7_0~1705@ temp_7_1~1762@))))) (=> (= temp_7_0~1705@ temp_7_1~1762@) (=> (= temp_8_0~1875@ (Sub (Sub (Mul (Sub c8~70@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@))) (Sub (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Add b8~68@ d8~72@) (Add b8~68@ c8~70@))))) (=> (= temp_8_1~1940@ (Sub (Sub (Mul (Sub c8~70@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@))) (Sub (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Add b8~68@ d8~72@) (Add b8~68@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1875@ temp_8_1~1940@))) (=> (= temp_8_0~1875@ temp_8_1~1940@) (=> (= temp_9_0~2045@ (Mul (Mul (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ a9~74@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ d9~80@)) (Mul (Sub a9~74@ 17) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~2122@ (Mul (Mul (Mul (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ a9~74@))) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Sub a9~74@ 17) (Mul a9~74@ b9~76@)))) (and (=> (= tmp%25@ (Mul (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ a9~74@)))) (=> (= tmp%26@ (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ d9~80@))) (=> (= tmp%27@ (Mul (Sub a9~74@ 17) (Mul a9~74@ b9~76@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%9 (= temp_9_0~2045@ temp_9_1~2122@)))))) (=> (= temp_9_0~2045@ temp_9_1~2122@) (=> (= temp_10_0~2269@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ b10~84@)) (Mul (Sub a10~82@ a10~82@) c10~86@)))) (=> (= temp_10_1~2330@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ b10~84@)) (Mul (Sub a10~82@ a10~82@) c10~86@)))) (and (=> (= tmp%28@ (Mul c10~86@ b10~84@)) (=> (= tmp%29@ (Mul a10~82@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%28@ tmp%29@) (=> (= tmp%30@ (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ d10~88@))) (=> (= tmp%31@ (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (=> (= tmp%32@ (Mul (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ b10~84@)) (Mul (Sub a10~82@ a10~82@) c10~86@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%30@ tmp%31@ tmp%32@) (=> (= tmp%33@ (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ b10~84@))) (=> (= tmp%34@ (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (=> (= tmp%35@ (Mul (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ b10~84@)) (Mul (Sub a10~82@ a10~82@) c10~86@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ tmp%34@ tmp%35@) (=> %%location_label%%10 (= temp_10_0~2269@ temp_10_1~2330@))))))))))))) (=> (= temp_10_0~2269@ temp_10_1~2330@) (=> (= temp_11_0~2567@ (Mul (Mul (Sub (Mul d11~96@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Add 60 17))) (Mul (Mul c11~94@ (Mul b11~92@ c11~94@)) (Mul (Sub a11~90@ c11~94@) (Mul a11~90@ a11~90@))))) (=> (= temp_11_1~2652@ (Mul (Mul (Sub (Mul d11~96@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Add 60 17))) (Mul (Mul c11~94@ (Mul b11~92@ c11~94@)) (Mul (Mul (Sub a11~90@ c11~94@) a11~90@) a11~90@)))) (and (=> (= tmp%36@ (Mul (Sub (Mul d11~96@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (nClip (Add 60 17))))) (=> (= tmp%37@ (Mul c11~94@ (Mul b11~92@ c11~94@))) (=> (= tmp%38@ (Mul (Mul (Sub a11~90@ c11~94@) a11~90@) a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ tmp%37@ tmp%38@) (=> (= tmp%39@ (Sub a11~90@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%39@ a11~90@ a11~90@) (=> (= tmp%40@ (Mul (Sub (Mul d11~96@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (nClip (Add 60 17))))) (=> (= tmp%41@ (Mul c11~94@ (Mul b11~92@ c11~94@))) (=> (= tmp%42@ (Mul (Sub a11~90@ c11~94@) (Mul a11~90@ a11~90@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ tmp%41@ tmp%42@) (=> %%location_label%%11 (= temp_11_0~2567@ temp_11_1~2652@)))))))))))) (=> (= temp_11_0~2567@ temp_11_1~2652@) (=> (= temp_12_0~2883@ (Mul (Sub (Mul (Add c12~102@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ a12~98@) (Mul c12~102@ a12~98@))) (Add (Sub (Mul c12~102@ a12~98@) (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ a12~98@) (Sub b12~100@ a12~98@))))) (=> (= temp_12_1~2948@ (Mul (Sub (Mul (Add c12~102@ d12~104@) (Mul b12~100@ d12~104@)) (Mul (Mul d12~104@ a12~98@) (Mul c12~102@ a12~98@))) (Add (Sub (Mul c12~102@ a12~98@) (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ a12~98@) (Sub b12~100@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ d12~104@) (=> %%location_label%%12 (= temp_12_0~2883@ temp_12_1~2948@))) (=> (= temp_12_0~2883@ temp_12_1~2948@) (=> (= temp_13_0~3041@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Mul d13~112@ c13~110@)) (Mul (Mul d13~112@ c13~110@) (Mul d13~112@ c13~110@))) (Mul (Sub (Mul a13~106@ a13~106@) (Mul d13~112@ d13~112@)) (Mul (Mul a13~106@ c13~110@) (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~3106@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Mul d13~112@ c13~110@)) (Mul (Mul d13~112@ c13~110@) (Mul d13~112@ c13~110@))) (Mul (Sub (Mul a13~106@ a13~106@) (Mul d13~112@ d13~112@)) (Mul (Mul c13~110@ a13~106@) (Mul d13~112@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c13~110@ a13~106@) (=> (= tmp%43@ (Mul (Mul (Mul c13~110@ c13~110@) (Mul d13~112@ c13~110@)) (Mul (Mul d13~112@ c13~110@) (Mul d13~112@ c13~110@)))) (=> (= tmp%44@ (Sub (Mul a13~106@ a13~106@) (Mul d13~112@ d13~112@))) (=> (= tmp%45@ (Mul (Mul c13~110@ a13~106@) (Mul d13~112@ c13~110@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%43@ tmp%44@ tmp%45@) (=> (= tmp%46@ (Mul (Mul (Mul c13~110@ c13~110@) (Mul d13~112@ c13~110@)) (Mul (Mul d13~112@ c13~110@) (Mul d13~112@ c13~110@)))) (=> (= tmp%47@ (Sub (Mul a13~106@ a13~106@) (Mul d13~112@ d13~112@))) (=> (= tmp%48@ (Mul (Mul a13~106@ c13~110@) (Mul d13~112@ c13~110@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%46@ tmp%47@ tmp%48@) (=> %%location_label%%13 (= temp_13_0~3041@ temp_13_1~3106@))))))))))) (=> (= temp_13_0~3041@ temp_13_1~3106@) (=> (= temp_14_0~3319@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ d14~120@)) (Mul d14~120@ (Mul d14~120@ a14~114@))) (Mul (Mul (Mul c14~118@ c14~118@) (Mul a14~114@ d14~120@)) (Add (Mul c14~118@ d14~120@) (Add b14~116@ d14~120@))))) (=> (= temp_14_1~3380@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ d14~120@)) (Mul d14~120@ (Mul d14~120@ a14~114@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ c14~118@)) (Add (Mul c14~118@ d14~120@) (Add b14~116@ d14~120@))))) (and (=> (= tmp%49@ (Mul a14~114@ d14~120@)) (=> (= tmp%50@ (Mul c14~118@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%49@ tmp%50@) (=> %%location_label%%14 (= temp_14_0~3319@ temp_14_1~3380@))))) (=> (= temp_14_0~3319@ temp_14_1~3380@) (=> (= temp_15_0~3481@ (Sub (Mul (Mul (Mul b15~124@ a15~122@) (Mul a15~122@ 28)) (Mul (Sub d15~128@ c15~126@) (Mul b15~124@ a15~122@))) (Mul (Add (Mul a15~122@ d15~128@) (Mul d15~128@ b15~124@)) b15~124@))) (=> (= temp_15_1~3546@ (Sub (Mul (Mul (Mul b15~124@ a15~122@) (Mul a15~122@ 28)) (Mul (Mul (Sub d15~128@ c15~126@) b15~124@) a15~122@)) (Mul (Add (Mul a15~122@ d15~128@) (Mul d15~128@ b15~124@)) b15~124@))) (and (=> (= tmp%51@ (Sub d15~128@ c15~126@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%51@ b15~124@ a15~122@) (=> %%location_label%%15 (= temp_15_0~3481@ temp_15_1~3546@)))) (=> (= temp_15_0~3481@ temp_15_1~3546@) (=> (= temp_16_0~3629@ (Mul (Mul (Add (Mul c16~134@ d16~136@) (Sub c16~134@ a16~130@)) (Mul d16~136@ (Mul a16~130@ a16~130@))) (Mul b16~132@ (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~3678@ (Mul (Mul (Add (Mul c16~134@ d16~136@) (Sub c16~134@ a16~130@)) (Mul d16~136@ (Mul a16~130@ a16~130@))) (Mul (Mul b16~132@ (Mul a16~130@ d16~136@)) (Mul b16~132@ a16~130@)))) (and (=> (= tmp%52@ (Mul a16~130@ d16~136@)) (=> (= tmp%53@ (Mul b16~132@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b16~132@ tmp%52@ tmp%53@) (=> %%location_label%%16 (= temp_16_0~3629@ temp_16_1~3678@))))) (=> (= temp_16_0~3629@ temp_16_1~3678@) (=> (= temp_17_0~3785@ (Mul (Mul (Add (Mul b17~140@ c17~142@) (Mul 63 d17~144@)) (Mul c17~142@ (Mul c17~142@ c17~142@))) (Sub (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ d17~144@)) (Mul (Mul c17~142@ b17~140@) a17~138@)))) (=> (= temp_17_1~3854@ (Mul (Mul (Add (Mul b17~140@ c17~142@) (Mul 63 d17~144@)) (Mul c17~142@ (Mul c17~142@ c17~142@))) (Sub (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ d17~144@)) (Mul c17~142@ (Mul b17~140@ a17~138@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. c17~142@ b17~140@ a17~138@) (=> %%location_label%%17 (= temp_17_0~3785@ temp_17_1~3854@))) (=> (= temp_17_0~3785@ temp_17_1~3854@) (=> (= temp_18_0~3945@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ c18~150@)) (Mul c18~150@ (Mul c18~150@ c18~150@))) (Mul (Mul (Add d18~152@ a18~146@) (Mul c18~150@ d18~152@)) (Mul (Sub d18~152@ b18~148@) (Add b18~148@ d18~152@))))) (=> (= temp_18_1~4006@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ c18~150@)) (Mul c18~150@ (Mul c18~150@ c18~150@))) (Mul (Mul (Add d18~152@ a18~146@) (Mul c18~150@ d18~152@)) (Mul (Add b18~148@ d18~152@) (Sub d18~152@ b18~148@))))) (and (=> (= tmp%54@ (Add b18~148@ d18~152@)) (=> (= tmp%55@ (Sub d18~152@ b18~148@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%54@ tmp%55@) (=> (= tmp%56@ (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ c18~150@)) (Mul c18~150@ (Mul c18~150@ c18~150@)))) (=> (= tmp%57@ (Mul (Add d18~152@ a18~146@) (Mul c18~150@ d18~152@))) (=> (= tmp%58@ (Mul (Add b18~148@ d18~152@) (Sub d18~152@ b18~148@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%56@ tmp%57@ tmp%58@) (=> (= tmp%59@ (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ c18~150@)) (Mul c18~150@ (Mul c18~150@ c18~150@)))) (=> (= tmp%60@ (Mul (Add d18~152@ a18~146@) (Mul c18~150@ d18~152@))) (=> (= tmp%61@ (Mul (Sub d18~152@ b18~148@) (Add b18~148@ d18~152@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%59@ tmp%60@ tmp%61@) (=> %%location_label%%18 (= temp_18_0~3945@ temp_18_1~4006@))))))))))))) (=> (= temp_18_0~3945@ temp_18_1~4006@) (=> (= temp_19_0~4223@ (Mul (Mul (Add (Mul d19~160@ c19~158@) (Mul b19~156@ c19~158@)) (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ a19~154@))) (Sub (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ d19~160@)) (Mul (Mul c19~158@ b19~156@) (Mul c19~158@ d19~160@))))) (=> (= temp_19_1~4284@ (Mul (Mul (Mul (Add d19~160@ b19~156@) c19~158@) (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ a19~154@))) (Sub (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ d19~160@)) (Mul (Mul c19~158@ b19~156@) (Mul c19~158@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d19~160@ b19~156@ c19~158@) (=> (= tmp%62@ (Mul (Add d19~160@ b19~156@) c19~158@)) (=> (= tmp%63@ (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ a19~154@))) (=> (= tmp%64@ (Sub (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ d19~160@)) (Mul (Mul c19~158@ b19~156@) (Mul c19~158@ d19~160@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%62@ tmp%63@ tmp%64@) (=> (= tmp%65@ (Add (Mul d19~160@ c19~158@) (Mul b19~156@ c19~158@))) (=> (= tmp%66@ (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ a19~154@))) (=> (= tmp%67@ (Sub (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ d19~160@)) (Mul (Mul c19~158@ b19~156@) (Mul c19~158@ d19~160@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%65@ tmp%66@ tmp%67@) (=> %%location_label%%19 (= temp_19_0~4223@ temp_19_1~4284@))))))))))) (=> (= temp_19_0~4223@ temp_19_1~4284@) (=> (= temp_20_0~4511@ (Mul (Mul (Mul (Mul b20~164@ a20~162@) (Add d20~168@ c20~166@)) (Mul (Mul d20~168@ b20~164@) (Sub b20~164@ 98))) (Mul (Sub (Mul d20~168@ c20~166@) (Mul d20~168@ b20~164@)) (Mul (Mul d20~168@ a20~162@) (Mul b20~164@ d20~168@))))) (=> (= temp_20_1~4588@ (Mul (Mul (Mul (Mul d20~168@ b20~164@) (Sub b20~164@ 98)) (Mul (Mul b20~164@ a20~162@) (Add d20~168@ c20~166@))) (Mul (Sub (Mul d20~168@ c20~166@) (Mul d20~168@ b20~164@)) (Mul (Mul d20~168@ a20~162@) (Mul b20~164@ d20~168@))))) (=> (= tmp%68@ (Mul (Mul d20~168@ b20~164@) (Sub b20~164@ 98))) (=> (= tmp%69@ (Mul (Mul b20~164@ a20~162@) (Add d20~168@ c20~166@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%68@ tmp%69@) (=> %%location_label%%20 (= temp_20_0~4511@ temp_20_1~4588@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
