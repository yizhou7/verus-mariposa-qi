...
(declare-const temp_8_0~1682@ Int)
(declare-const temp_8_1~1775@ Int)
(declare-const temp_9_0~1886@ Int)
(declare-const temp_9_1~1947@ Int)
(declare-const temp_10_0~2062@ Int)
(declare-const temp_10_1~2131@ Int)
(declare-const temp_11_0~2328@ Int)
(declare-const temp_11_1~2389@ Int)
(declare-const temp_12_0~2500@ Int)
(declare-const temp_12_1~2577@ Int)
(declare-const temp_13_0~2826@ Int)
(declare-const temp_13_1~2903@ Int)
(declare-const temp_14_0~3018@ Int)
(declare-const temp_14_1~3095@ Int)
(declare-const temp_15_0~3204@ Int)
(declare-const temp_15_1~3285@ Int)
(declare-const temp_16_0~3408@ Int)
(declare-const temp_16_1~3497@ Int)
(declare-const temp_17_0~3626@ Int)
(declare-const temp_17_1~3703@ Int)
(declare-const temp_18_0~3824@ Int)
(declare-const temp_18_1~3889@ Int)
(declare-const temp_19_0~3969@ Int)
(declare-const temp_19_1~4034@ Int)
(declare-const temp_20_0~4223@ Int)
(declare-const temp_20_1~4260@ Int)
(declare-const temp_21_0~4352@ Int)
(declare-const temp_21_1~4429@ Int)
(declare-const temp_22_0~4548@ Int)
(declare-const temp_22_1~4613@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Add (Mul (Mul c0~6@ d0~8@) (Sub d0~8@ b0~4@)) (Mul (Mul d0~8@ a0~2@) c0~6@)) (Add (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ 0)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ a0~2@))))) (=> (= temp_0_1~386@ (Mul (Add (Mul c0~6@ (Mul d0~8@ (Sub d0~8@ b0~4@))) (Mul (Mul d0~8@ a0~2@) c0~6@)) (Add (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ 0)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ a0~2@))))) (and (=> (= tmp%1@ (Sub d0~8@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c0~6@ d0~8@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~386@)))) (=> (= temp_0_0~313@ temp_0_1~386@) (=> (= temp_1_0~493@ (Mul (Add (Mul b1~12@ (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul 95 c1~14@))))) (=> (= temp_1_1~566@ (Mul (Add (Mul (Mul b1~12@ c1~14@) a1~10@) (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul 95 c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b1~12@ c1~14@ a1~10@) (=> %%location_label%%1 (= temp_1_0~493@ temp_1_1~566@))) (=> (= temp_1_0~493@ temp_1_1~566@) (=> (= temp_2_0~657@ (Mul (Sub (Mul (Mul c2~22@ a2~18@) d2~24@) (Mul (Mul b2~20@ d2~24@) (Sub a2~18@ c2~22@))) (Add (Mul (Mul a2~18@ b2~20@) (Add b2~20@ d2~24@)) (Sub (Mul b2~20@ b2~20@) (Sub d2~24@ a2~18@))))) (=> (= temp_2_1~718@ (Mul (Sub (Mul (Mul c2~22@ a2~18@) d2~24@) (Mul (Mul b2~20@ d2~24@) (Sub a2~18@ c2~22@))) (Add (Mul a2~18@ (Mul b2~20@ (Add b2~20@ d2~24@))) (Sub (Mul b2~20@ b2~20@) (Sub d2~24@ a2~18@))))) (and (=> (= tmp%2@ (Add b2~20@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a2~18@ b2~20@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~657@ temp_2_1~718@)))) (=> (= temp_2_0~657@ temp_2_1~718@) (=> (= temp_3_0~801@ (Mul (Add (Mul a3~26@ (Mul b3~28@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ d3~32@)) b3~28@))) (=> (= temp_3_1~850@ (Mul (Add (Mul (Mul b3~28@ b3~28@) a3~26@) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ d3~32@)) b3~28@))) (and (=> (= tmp%3@ (Mul b3~28@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ a3~26@) (=> %%location_label%%3 (= temp_3_0~801@ temp_3_1~850@)))) (=> (= temp_3_0~801@ temp_3_1~850@) (=> (= temp_4_0~955@ (Mul (Mul (Mul c4~38@ (Mul 65 c4~38@)) (Mul (Add c4~38@ a4~34@) (Mul d4~40@ d4~40@))) (Mul (Add (Mul c4~38@ b4~36@) (Mul b4~36@ a4~34@)) (Add (Mul d4~40@ c4~38@) (Sub b4~36@ c4~38@))))) (=> (= temp_4_1~1028@ (Mul (Mul (Mul c4~38@ (Mul 65 c4~38@)) (Mul (Add c4~38@ a4~34@) (Mul d4~40@ d4~40@))) (Mul (Add (Mul c4~38@ b4~36@) (Mul a4~34@ b4~36@)) (Add (Mul d4~40@ c4~38@) (Sub b4~36@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ b4~36@) (=> %%location_label%%4 (= temp_4_0~955@ temp_4_1~1028@))) (=> (= temp_4_0~955@ temp_4_1~1028@) (=> (= temp_5_0~1117@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Mul (Sub d5~48@ c5~46@) c5~46@) (Mul (Add b5~44@ d5~48@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1178@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Mul (Sub d5~48@ c5~46@) c5~46@) (Mul (Mul (Add b5~44@ d5~48@) d5~48@) d5~48@)))) (and (=> (= tmp%4@ (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@)))) (=> (= tmp%5@ (Mul (Sub d5~48@ c5~46@) c5~46@)) (=> (= tmp%6@ (Mul (Mul (Add b5~44@ d5~48@) d5~48@) d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> (= tmp%7@ (Add b5~44@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ d5~48@ d5~48@) (=> (= tmp%8@ (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@)))) (=> (= tmp%9@ (Mul (Sub d5~48@ c5~46@) c5~46@)) (=> (= tmp%10@ (Mul (Add b5~44@ d5~48@) (Mul d5~48@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%5 (= temp_5_0~1117@ temp_5_1~1178@)))))))))))) (=> (= temp_5_0~1117@ temp_5_1~1178@) (=> (= temp_6_0~1389@ (Add (Add (Mul (Sub d6~56@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Sub c6~54@ d6~56@) b6~52@)) (Mul (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ b6~52@)) (Sub (Add a6~50@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1458@ (Add (Add (Sub (Mul d6~56@ (Mul d6~56@ b6~52@)) (Mul a6~50@ (Mul d6~56@ b6~52@))) (Mul (Sub c6~54@ d6~56@) b6~52@)) (Mul (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ b6~52@)) (Sub (Add a6~50@ b6~52@) (Mul c6~54@ c6~54@))))) (and (=> (= tmp%11@ (Mul d6~56@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d6~56@ a6~50@ tmp%11@) (=> %%location_label%%6 (= temp_6_0~1389@ temp_6_1~1458@)))) (=> (= temp_6_0~1389@ temp_6_1~1458@) (=> (= temp_7_0~1541@ (Mul (Mul d7~64@ (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@))) (Mul (Add c7~62@ (Mul a7~58@ c7~62@)) (Sub (Mul c7~62@ b7~60@) (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1590@ (Mul (Mul d7~64@ (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@))) (Mul (Add c7~62@ (Mul a7~58@ c7~62@)) (Sub (Mul c7~62@ b7~60@) (Mul a7~58@ b7~60@))))) (=> (= tmp%12@ (= temp_7_0~1541@ temp_7_1~1590@)) (and (=> %%location_label%%7 tmp%12@) (=> tmp%12@ (=> (= temp_8_0~1682@ (Mul (Mul (Add (Mul b8~68@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@))) (Sub (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ 93) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1775@ (Mul (Add (Mul (Mul b8~68@ c8~70@) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@))) (Mul (Mul a8~66@ b8~68@) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@)))) (Sub (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ 93) (Mul c8~70@ d8~72@))))) (and (=> (= tmp%13@ (Mul b8~68@ c8~70@)) (=> (= tmp%14@ (Mul a8~66@ b8~68@)) (=> (= tmp%15@ (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%8 (= temp_8_0~1682@ temp_8_1~1775@)))))) (=> (= temp_8_0~1682@ temp_8_1~1775@) (=> (= temp_9_0~1886@ (Mul (Mul (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Mul a9~74@ c9~78@) c9~78@)))) (=> (= temp_9_1~1947@ (Mul (Mul (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@))) (Mul (Mul d9~80@ a9~74@) (Mul (Mul d9~80@ b9~76@) (Mul (Mul a9~74@ c9~78@) c9~78@))))) (and (=> (= tmp%16@ (Mul d9~80@ a9~74@)) (=> (= tmp%17@ (Mul d9~80@ b9~76@)) (=> (= tmp%18@ (Mul (Mul a9~74@ c9~78@) c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%9 (= temp_9_0~1886@ temp_9_1~1947@)))))) (=> (= temp_9_0~1886@ temp_9_1~1947@) (=> (= temp_10_0~2062@ (Mul (Mul (Mul (Mul d10~88@ a10~82@) (Mul a10~82@ d10~88@)) (Mul b10~84@ (Mul a10~82@ a10~82@))) (Mul (Mul (Mul b10~84@ a10~82@) (Sub b10~84@ b10~84@)) (Mul (Sub a10~82@ 11) d10~88@)))) (=> (= temp_10_1~2131@ (Mul (Mul (Mul (Mul d10~88@ a10~82@) (Mul d10~88@ a10~82@)) (Mul b10~84@ (Mul a10~82@ a10~82@))) (Mul (Mul (Mul b10~84@ a10~82@) (Sub b10~84@ b10~84@)) (Mul (Sub a10~82@ 11) d10~88@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d10~88@ a10~82@) (=> (= tmp%19@ (Mul (Mul d10~88@ a10~82@) (Mul d10~88@ a10~82@))) (=> (= tmp%20@ (Mul b10~84@ (Mul a10~82@ a10~82@))) (=> (= tmp%21@ (Mul (Mul (Mul b10~84@ a10~82@) (Sub b10~84@ b10~84@)) (Mul (Sub a10~82@ 11) d10~88@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> (= tmp%22@ (Mul (Mul d10~88@ a10~82@) (Mul a10~82@ d10~88@))) (=> (= tmp%23@ (Mul b10~84@ (Mul a10~82@ a10~82@))) (=> (= tmp%24@ (Mul (Mul (Mul b10~84@ a10~82@) (Sub b10~84@ b10~84@)) (Mul (Sub a10~82@ 11) d10~88@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%10 (= temp_10_0~2062@ temp_10_1~2131@))))))))))) (=> (= temp_10_0~2062@ temp_10_1~2131@) (=> (= temp_11_0~2328@ (Mul (Sub (Mul c11~94@ a11~90@) (Mul (Sub a11~90@ a11~90@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul b11~92@ d11~96@)) (Mul c11~94@ (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2389@ (Mul (Sub (Mul c11~94@ a11~90@) (Sub (Mul a11~90@ (Mul c11~94@ d11~96@)) (Mul a11~90@ (Mul c11~94@ d11~96@)))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul b11~92@ d11~96@)) (Mul c11~94@ (Mul d11~96@ b11~92@))))) (and (=> (= tmp%25@ (Mul c11~94@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a11~90@ a11~90@ tmp%25@) (=> %%location_label%%11 (= temp_11_0~2328@ temp_11_1~2389@)))) (=> (= temp_11_0~2328@ temp_11_1~2389@) (=> (= temp_12_0~2500@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ d12~104@) (Add d12~104@ 32))))) (=> (= temp_12_1~2577@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Add d12~104@ 32) (Mul a12~98@ d12~104@))))) (and (=> (= tmp%26@ (Add d12~104@ 32)) (=> (= tmp%27@ (Mul a12~98@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%26@ tmp%27@) (=> (= tmp%28@ (Mul (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ c12~102@)))) (=> (= tmp%29@ (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ b12~100@))) (=> (= tmp%30@ (Mul (Add d12~104@ 32) (Mul a12~98@ d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> (= tmp%31@ (Mul (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ c12~102@)))) (=> (= tmp%32@ (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ b12~100@))) (=> (= tmp%33@ (Mul (Mul a12~98@ d12~104@) (Add d12~104@ 32))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> %%location_label%%12 (= temp_12_0~2500@ temp_12_1~2577@))))))))))))) (=> (= temp_12_0~2500@ temp_12_1~2577@) (=> (= temp_13_0~2826@ (Sub (Mul (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ c13~110@)) (Add (Mul a13~106@ c13~110@) (Mul d13~112@ b13~108@))) (Mul (Mul (Mul b13~108@ c13~110@) (Mul a13~106@ c13~110@)) (Mul (Mul d13~112@ 70) (Mul a13~106@ a13~106@))))) (=> (= temp_13_1~2903@ (Sub (Mul (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ c13~110@)) (Add (Mul a13~106@ c13~110@) (Mul d13~112@ b13~108@))) (Mul (Mul (Mul b13~108@ c13~110@) (Mul a13~106@ c13~110@)) (Mul (Mul (Mul d13~112@ 70) a13~106@) a13~106@)))) (and (=> (= tmp%34@ (Mul d13~112@ 70)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ a13~106@ a13~106@) (=> %%location_label%%13 (= temp_13_0~2826@ temp_13_1~2903@)))) (=> (= temp_13_0~2826@ temp_13_1~2903@) (=> (= temp_14_0~3018@ (Add (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Mul d14~120@ d14~120@) (Sub c14~118@ d14~120@))) (Add (Mul (Mul b14~116@ c14~118@) (Mul c14~118@ 32)) (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~3095@ (Add (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Mul d14~120@ d14~120@) (Sub c14~118@ d14~120@))) (Add (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ 32)) (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c14~118@ b14~116@) (=> %%location_label%%14 (= temp_14_0~3018@ temp_14_1~3095@))) (=> (= temp_14_0~3018@ temp_14_1~3095@) (=> (= temp_15_0~3204@ (Mul (Mul (Mul c15~126@ (Mul a15~122@ d15~128@)) (Mul (Mul b15~124@ a15~122@) (Mul a15~122@ a15~122@))) (Mul (Mul c15~126@ (Mul c15~126@ a15~122@)) (Add (Add c15~126@ 64) (Mul 90 b15~124@))))) (=> (= temp_15_1~3285@ (Mul (Mul (Mul c15~126@ (Mul a15~122@ d15~128@)) (Mul (Mul (Mul b15~124@ a15~122@) a15~122@) a15~122@)) (Mul (Mul c15~126@ (Mul c15~126@ a15~122@)) (Add (Add c15~126@ 64) (Mul 90 b15~124@))))) (and (=> (= tmp%35@ (Mul b15~124@ a15~122@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ a15~122@ a15~122@) (=> %%location_label%%15 (= temp_15_0~3204@ temp_15_1~3285@)))) (=> (= temp_15_0~3204@ temp_15_1~3285@) (=> (= temp_16_0~3408@ (Mul (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ d16~136@)) (Add (Mul c16~134@ a16~130@) (Mul b16~132@ a16~130@))) (Add (Mul (Mul c16~134@ d16~136@) (Sub c16~134@ c16~134@)) (Add (Sub 62 38) (Add c16~134@ c16~134@))))) (=> (= temp_16_1~3497@ (Mul (Mul (Add (Mul c16~134@ a16~130@) (Mul b16~132@ a16~130@)) (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ d16~136@))) (Add (Mul (Mul c16~134@ d16~136@) (Sub c16~134@ c16~134@)) (Add (Sub 62 38) (Add c16~134@ c16~134@))))) (and (=> (= tmp%36@ (Add (Mul c16~134@ a16~130@) (Mul b16~132@ a16~130@))) (=> (= tmp%37@ (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ d16~136@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%36@ tmp%37@) (=> %%location_label%%16 (= temp_16_0~3408@ temp_16_1~3497@))))) (=> (= temp_16_0~3408@ temp_16_1~3497@) (=> (= temp_17_0~3626@ (Mul (Mul (Sub (Sub a17~138@ a17~138@) (Mul a17~138@ c17~142@)) (Mul (Sub d17~144@ c17~142@) (Sub a17~138@ b17~140@))) (Mul (Mul (Mul c17~142@ 29) (Mul b17~140@ b17~140@)) (Mul (Sub c17~142@ d17~144@) (Mul c17~142@ d17~144@))))) (=> (= temp_17_1~3703@ (Mul (Mul (Sub (Sub a17~138@ a17~138@) (Mul a17~138@ c17~142@)) (Mul (Sub d17~144@ c17~142@) (Sub a17~138@ b17~140@))) (Mul (Mul (Sub c17~142@ d17~144@) (Mul c17~142@ d17~144@)) (Mul (Mul c17~142@ 29) (Mul b17~140@ b17~140@))))) (and (=> (= tmp%38@ (Mul (Sub c17~142@ d17~144@) (Mul c17~142@ d17~144@))) (=> (= tmp%39@ (Mul (Mul c17~142@ 29) (Mul b17~140@ b17~140@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%38@ tmp%39@) (=> %%location_label%%17 (= temp_17_0~3626@ temp_17_1~3703@))))) (=> (= temp_17_0~3626@ temp_17_1~3703@) (=> (= temp_18_0~3824@ (Mul (Mul (Mul (Mul c18~150@ d18~152@) (Mul a18~146@ c18~150@)) (Mul (Mul c18~150@ c18~150@) (Sub a18~146@ b18~148@))) (Mul (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ b18~148@)) (Sub (Mul c18~150@ b18~148@) (Sub a18~146@ c18~150@))))) (=> (= temp_18_1~3889@ (Mul (Mul (Mul (Mul c18~150@ d18~152@) (Mul a18~146@ c18~150@)) (Mul (Mul c18~150@ c18~150@) (Sub a18~146@ b18~148@))) (Mul (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ b18~148@)) (Sub (Mul c18~150@ b18~148@) (Sub a18~146@ c18~150@))))) (=> (= tmp%40@ (= temp_18_0~3824@ temp_18_1~3889@)) (and (=> %%location_label%%18 tmp%40@) (=> tmp%40@ (=> (= temp_19_0~3969@ (Mul (Mul (Mul (Mul a19~154@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Sub a19~154@ a19~154@) (Mul c19~158@ d19~160@))) (Mul (Mul (Mul a19~154@ b19~156@) (Sub c19~158@ c19~158@)) (Mul (Mul d19~160@ d19~160@) (Mul a19~154@ b19~156@))))) (=> (= temp_19_1~4034@ (Mul (Mul (Mul (Mul a19~154@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Sub a19~154@ a19~154@) (Mul c19~158@ d19~160@))) (Mul (Mul (Mul a19~154@ b19~156@) (Sub c19~158@ c19~158@)) (Mul (Mul d19~160@ d19~160@) (Mul b19~156@ a19~154@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a19~154@ b19~156@) (=> (= tmp%41@ (Mul (Mul (Mul a19~154@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Sub a19~154@ a19~154@) (Mul c19~158@ d19~160@)))) (=> (= tmp%42@ (Mul (Mul a19~154@ b19~156@) (Sub c19~158@ c19~158@))) (=> (= tmp%43@ (Mul (Mul d19~160@ d19~160@) (Mul b19~156@ a19~154@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ tmp%42@ tmp%43@) (=> (= tmp%44@ (Mul (Mul (Mul a19~154@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Sub a19~154@ a19~154@) (Mul c19~158@ d19~160@)))) (=> (= tmp%45@ (Mul (Mul a19~154@ b19~156@) (Sub c19~158@ c19~158@))) (=> (= tmp%46@ (Mul (Mul d19~160@ d19~160@) (Mul a19~154@ b19~156@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%44@ tmp%45@ tmp%46@) (=> %%location_label%%19 (= temp_19_0~3969@ temp_19_1~4034@))))))))))) (=> (= temp_19_0~3969@ temp_19_1~4034@) (=> (= temp_20_0~4223@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Mul c20~166@ c20~166@)) (Add (Mul b20~164@ c20~166@) (Mul b20~164@ a20~162@))) a20~162@)) (=> (= temp_20_1~4260@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Mul c20~166@ c20~166@)) (Add (Mul b20~164@ c20~166@) (Mul b20~164@ a20~162@))) a20~162@)) (=> (= tmp%47@ (= temp_20_0~4223@ temp_20_1~4260@)) (and (=> %%location_label%%20 tmp%47@) (=> tmp%47@ (=> (= temp_21_0~4352@ (Sub (Mul (Mul (Mul a21~170@ a21~170@) (Add a21~170@ 6)) (Mul (Mul d21~176@ c21~174@) (Mul c21~174@ b21~172@))) (Mul (Mul (Mul a21~170@ d21~176@) (Mul c21~174@ d21~176@)) (Add (Mul d21~176@ b21~172@) (Mul d21~176@ d21~176@))))) (=> (= temp_21_1~4429@ (Sub (Mul (Mul a21~170@ a21~170@) (Mul (Add a21~170@ 6) (Mul (Mul d21~176@ c21~174@) (Mul c21~174@ b21~172@)))) (Mul (Mul (Mul a21~170@ d21~176@) (Mul c21~174@ d21~176@)) (Add (Mul d21~176@ b21~172@) (Mul d21~176@ d21~176@))))) (and (=> (= tmp%48@ (Mul a21~170@ a21~170@)) (=> (= tmp%49@ (Add a21~170@ 6)) (=> (= tmp%50@ (Mul (Mul d21~176@ c21~174@) (Mul c21~174@ b21~172@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%48@ tmp%49@ tmp%50@) (=> %%location_label%%21 (= temp_21_0~4352@ temp_21_1~4429@)))))) (=> (= temp_21_0~4352@ temp_21_1~4429@) (=> (= temp_22_0~4548@ (Mul (Mul (Add (Mul a22~178@ c22~182@) (Mul b22~180@ b22~180@)) (Mul (Mul c22~182@ a22~178@) (Mul d22~184@ a22~178@))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul c22~182@ a22~178@)) (Mul (Mul a22~178@ d22~184@) (Mul b22~180@ c22~182@))))) (=> (= temp_22_1~4613@ (Mul (Mul (Add (Mul a22~178@ c22~182@) (Mul b22~180@ b22~180@)) (Mul (Mul c22~182@ a22~178@) (Mul d22~184@ a22~178@))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul c22~182@ a22~178@)) (Mul (Mul d22~184@ a22~178@) (Mul b22~180@ c22~182@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d22~184@ a22~178@) (=> (= tmp%51@ (Mul (Add (Mul a22~178@ c22~182@) (Mul b22~180@ b22~180@)) (Mul (Mul c22~182@ a22~178@) (Mul d22~184@ a22~178@)))) (=> (= tmp%52@ (Mul (Mul b22~180@ b22~180@) (Mul c22~182@ a22~178@))) (=> (= tmp%53@ (Mul (Mul d22~184@ a22~178@) (Mul b22~180@ c22~182@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%51@ tmp%52@ tmp%53@) (=> (= tmp%54@ (Mul (Add (Mul a22~178@ c22~182@) (Mul b22~180@ b22~180@)) (Mul (Mul c22~182@ a22~178@) (Mul d22~184@ a22~178@)))) (=> (= tmp%55@ (Mul (Mul b22~180@ b22~180@) (Mul c22~182@ a22~178@))) (=> (= tmp%56@ (Mul (Mul a22~178@ d22~184@) (Mul b22~180@ c22~182@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%54@ tmp%55@ tmp%56@) (=> %%location_label%%22 (= temp_22_0~4548@ temp_22_1~4613@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
