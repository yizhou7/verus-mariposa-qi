...
(assert (=> %%query%% (not (=> (= temp_0_0~325@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ 89) b0~4@)) (Mul (Mul (Add b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ 29) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~410@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@)) (Mul b0~4@ (Mul 89 b0~4@))) (Mul (Mul (Add b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ 29) (Mul a0~2@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ 89 b0~4@) (=> %%location_label%%0 (= temp_0_0~325@ temp_0_1~410@))) (=> (= temp_0_0~325@ temp_0_1~410@) (=> (= temp_1_0~509@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@))))) (=> (= temp_1_1~574@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ c1~14@) (=> %%location_label%%1 (= temp_1_0~509@ temp_1_1~574@))) (=> (= temp_1_0~509@ temp_1_1~574@) (=> (= temp_2_0~679@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub c2~22@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul 23 b2~20@))) (Mul (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Add c2~22@ c2~22@))))) (=> (= temp_2_1~756@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub c2~22@ d2~24@)) (Mul (Mul (Mul d2~24@ b2~20@) 23) b2~20@)) (Mul (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Add c2~22@ c2~22@))))) (and (=> (= tmp%1@ (Mul d2~24@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ 23 b2~20@) (=> %%location_label%%2 (= temp_2_0~679@ temp_2_1~756@)))) (=> (= temp_2_0~679@ temp_2_1~756@) (=> (= temp_3_0~843@ (Sub (Mul (Add (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ d3~32@))) (Mul (Mul a3~26@ (Mul a3~26@ a3~26@)) c3~30@))) (=> (= temp_3_1~892@ (Sub (Mul (Add (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ b3~28@))) (Mul (Mul a3~26@ (Mul a3~26@ a3~26@)) c3~30@))) (and (=> (= tmp%2@ (Mul b3~28@ d3~32@)) (=> (= tmp%3@ (Mul b3~28@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~843@ temp_3_1~892@))))) (=> (= temp_3_0~843@ temp_3_1~892@) (=> (= temp_4_0~989@ (Mul (Sub (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@)) (Mul a4~34@ (Mul b4~36@ b4~36@))) (Mul (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Add c4~38@ b4~36@))))) (=> (= temp_4_1~1050@ (Mul (Sub (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ b4~36@) b4~36@)) (Mul (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Add c4~38@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a4~34@ b4~36@ b4~36@) (=> %%location_label%%4 (= temp_4_0~989@ temp_4_1~1050@))) (=> (= temp_4_0~989@ temp_4_1~1050@) (=> (= temp_5_0~1157@ (Mul (Add (Mul (Add a5~42@ d5~48@) (Mul c5~46@ 13)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ c5~46@))) (Add (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1234@ (Mul (Add (Mul (Mul c5~46@ 13) (Add a5~42@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ c5~46@))) (Add (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@))))) (and (=> (= tmp%4@ (Mul c5~46@ 13)) (=> (= tmp%5@ (Add a5~42@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%5 (= temp_5_0~1157@ temp_5_1~1234@))))) (=> (= temp_5_0~1157@ temp_5_1~1234@) (=> (= temp_6_0~1335@ (Add (Mul (Mul d6~56@ (Mul b6~52@ b6~52@)) (Add (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@))) (Mul (Add (Sub d6~56@ a6~50@) (Mul c6~54@ c6~54@)) (Mul (Sub b6~52@ c6~54@) (Mul b6~52@ a6~50@))))) (=> (= temp_6_1~1396@ (Add (Mul (Mul d6~56@ (Mul b6~52@ b6~52@)) (Add (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@))) (Mul (Add (Sub d6~56@ a6~50@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Sub b6~52@ c6~54@))))) (and (=> (= tmp%6@ (Mul b6~52@ a6~50@)) (=> (= tmp%7@ (Sub b6~52@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%6 (= temp_6_0~1335@ temp_6_1~1396@))))) (=> (= temp_6_0~1335@ temp_6_1~1396@) (=> (= temp_7_0~1505@ (Mul (Sub (Sub (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Mul c7~62@ (Mul b7~60@ b7~60@))) (Add (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul a7~58@ c7~62@) (Mul 17 a7~58@))))) (=> (= temp_7_1~1578@ (Mul (Sub (Sub (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Mul c7~62@ (Mul b7~60@ b7~60@))) (Add (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul (Mul a7~58@ c7~62@) 17) a7~58@)))) (=> (= tmp%8@ (Mul a7~58@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ 17 a7~58@) (=> %%location_label%%7 (= temp_7_0~1505@ temp_7_1~1578@)))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
