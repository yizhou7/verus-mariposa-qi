...
(declare-const temp_4_0~1111@ Int)
(declare-const temp_4_1~1168@ Int)
(declare-const temp_5_0~1269@ Int)
(declare-const temp_5_1~1342@ Int)
(declare-const temp_6_0~1427@ Int)
(declare-const temp_6_1~1484@ Int)
(declare-const temp_7_0~1587@ Int)
(declare-const temp_7_1~1640@ Int)
(declare-const temp_8_0~1777@ Int)
(declare-const temp_8_1~1842@ Int)
(declare-const temp_9_0~1894@ Int)
(declare-const temp_9_1~1931@ Int)
(declare-const temp_10_0~2112@ Int)
(declare-const temp_10_1~2217@ Int)
(declare-const temp_11_0~2460@ Int)
(declare-const temp_11_1~2553@ Int)
(declare-const temp_12_0~2696@ Int)
(declare-const temp_12_1~2761@ Int)
(declare-const temp_13_0~2858@ Int)
(declare-const temp_13_1~2919@ Int)
(declare-const temp_14_0~3118@ Int)
(declare-const temp_14_1~3175@ Int)
(declare-const temp_15_0~3274@ Int)
(declare-const temp_15_1~3339@ Int)
(declare-const temp_16_0~3552@ Int)
(declare-const temp_16_1~3601@ Int)
(declare-const temp_17_0~3804@ Int)
(declare-const temp_17_1~3881@ Int)
(declare-const temp_18_0~3953@ Int)
(declare-const temp_18_1~4010@ Int)
(declare-const temp_19_0~4091@ Int)
(declare-const temp_19_1~4144@ Int)
(declare-const temp_20_0~4231@ Int)
(declare-const temp_20_1~4288@ Int)
(declare-const temp_21_0~4379@ Int)
(declare-const temp_21_1~4432@ Int)
(declare-const temp_22_0~4577@ Int)
(declare-const temp_22_1~4650@ Int)
(declare-const temp_23_0~4795@ Int)
(declare-const temp_23_1~4884@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Add c0~6@ a0~2@) (Mul c0~6@ d0~8@)) (Sub (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) (Add (Mul a0~2@ d0~8@) b0~4@)))) (=> (= temp_0_1~350@ (Mul (Mul (Mul (Add c0~6@ a0~2@) (Mul c0~6@ d0~8@)) (Mul b0~4@ (Sub b0~4@ a0~2@))) (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) (Add (Mul a0~2@ d0~8@) b0~4@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b0~4@ b0~4@ a0~2@) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~350@))) (=> (= temp_0_0~297@ temp_0_1~350@) (=> (= temp_1_0~445@ (Add (Mul (Mul (Mul a1~10@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Add c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Sub (Mul a1~10@ d1~16@) (Mul b1~12@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~510@ (Add (Mul (Mul (Mul a1~10@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Add c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Sub (Mul a1~10@ d1~16@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))))) (and (=> (= tmp%1@ (Mul d1~16@ b1~12@)) (=> (= tmp%2@ (Mul c1~14@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~445@ temp_1_1~510@))))) (=> (= temp_1_0~445@ temp_1_1~510@) (=> (= temp_2_0~619@ (Mul (Mul (Mul c2~22@ (Sub d2~24@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ b2~20@)) (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ 97))))) (=> (= temp_2_1~692@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@)) (Mul c2~22@ (Sub d2~24@ c2~22@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ b2~20@)) (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ 97))))) (and (=> (= tmp%3@ (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@))) (=> (= tmp%4@ (Mul c2~22@ (Sub d2~24@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~619@ temp_2_1~692@))))) (=> (= temp_2_0~619@ temp_2_1~692@) (=> (= temp_3_0~817@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ 27)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~894@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ 27)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ a3~26@) (=> (= tmp%5@ (Mul (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ 27)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@)))) (=> (= tmp%6@ (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@))) (=> (= tmp%7@ (Add (Mul d3~32@ a3~26@) (Mul c3~30@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> (= tmp%8@ (Mul (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ 27)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@)))) (=> (= tmp%9@ (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@))) (=> (= tmp%10@ (Add (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%3 (= temp_3_0~817@ temp_3_1~894@))))))))))) (=> (= temp_3_0~817@ temp_3_1~894@) (=> (= temp_4_0~1111@ (Mul (Mul (Sub (Mul b4~36@ b4~36@) a4~34@) (Mul (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@))) (Add (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@)) (Mul a4~34@ (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~1168@ (Mul (Mul (Sub (Mul b4~36@ b4~36@) a4~34@) (Mul (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@))) (Add (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@)) (Mul a4~34@ (Mul d4~40@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1111@ temp_4_1~1168@))) (=> (= temp_4_0~1111@ temp_4_1~1168@) (=> (= temp_5_0~1269@ (Mul (Sub (Mul a5~42@ (Sub 76 a5~42@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Add c5~46@ c5~46@) (Mul b5~44@ d5~48@))))) (=> (= temp_5_1~1342@ (Mul (Sub (Mul a5~42@ (Sub 76 a5~42@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Add c5~46@ c5~46@) (Mul b5~44@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1269@ temp_5_1~1342@))) (=> (= temp_5_0~1269@ temp_5_1~1342@) (=> (= temp_6_0~1427@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ d6~56@))) (Mul (Mul b6~52@ (Add b6~52@ c6~54@)) (Mul (Sub d6~56@ c6~54@) b6~52@)))) (=> (= temp_6_1~1484@ (Mul (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ d6~56@)) (Mul b6~52@ d6~56@)) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ (Add b6~52@ c6~54@)) (Mul (Sub d6~56@ c6~54@) b6~52@)))) (and (=> (= tmp%11@ (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ d6~56@))) (=> (= tmp%12@ (Mul b6~52@ d6~56@)) (=> (= tmp%13@ (Mul a6~50@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%6 (= temp_6_0~1427@ temp_6_1~1484@)))))) (=> (= temp_6_0~1427@ temp_6_1~1484@) (=> (= temp_7_0~1587@ (Mul (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ a7~58@)) a7~58@) (Mul (Sub (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1640@ (Mul (Mul (Sub (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ a7~58@)) a7~58@))) (and (=> (= tmp%14@ (Mul (Sub (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@)))) (=> (= tmp%15@ (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ a7~58@)) a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%7 (= temp_7_0~1587@ temp_7_1~1640@))))) (=> (= temp_7_0~1587@ temp_7_1~1640@) (=> (= temp_8_0~1777@ (Mul (Mul (Mul (Add c8~70@ a8~66@) (Sub d8~72@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ 91))) (Mul d8~72@ (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1842@ (Mul (Mul (Mul (Add c8~70@ a8~66@) (Sub d8~72@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ 91))) (Mul d8~72@ (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= tmp%16@ (= temp_8_0~1777@ temp_8_1~1842@)) (and (=> %%location_label%%8 tmp%16@) (=> tmp%16@ (=> (= temp_9_0~1894@ (Mul (Mul (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ b9~76@)) (Mul c9~78@ (Sub a9~74@ b9~76@))) (Mul a9~74@ a9~74@))) (=> (= temp_9_1~1931@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@)) (Mul c9~78@ (Sub a9~74@ b9~76@))) (Mul a9~74@ a9~74@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ b9~76@) (=> (= tmp%17@ (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@))) (=> (= tmp%18@ (Mul c9~78@ (Sub a9~74@ b9~76@))) (=> (= tmp%19@ (Mul a9~74@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> (= tmp%20@ (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ b9~76@))) (=> (= tmp%21@ (Mul c9~78@ (Sub a9~74@ b9~76@))) (=> (= tmp%22@ (Mul a9~74@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%9 (= temp_9_0~1894@ temp_9_1~1931@))))))))))) (=> (= temp_9_0~1894@ temp_9_1~1931@) (=> (= temp_10_0~2112@ (Mul (Mul (Mul (Add d10~88@ d10~88@) (Mul 66 a10~82@)) (Mul (Mul 56 b10~84@) d10~88@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Add d10~88@ c10~86@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~2217@ (Mul (Mul (Add (Mul d10~88@ (Mul 66 a10~82@)) (Mul d10~88@ (Mul 66 a10~82@))) (Mul (Mul 56 b10~84@) d10~88@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Add d10~88@ c10~86@) (Mul d10~88@ c10~86@))))) (and (=> (= tmp%23@ (Add (Mul d10~88@ (Mul 66 a10~82@)) (Mul d10~88@ (Mul 66 a10~82@)))) (=> (= tmp%24@ (Mul (Mul 56 b10~84@) d10~88@)) (=> (= tmp%25@ (Mul (Mul (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Add d10~88@ c10~86@) (Mul d10~88@ c10~86@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> (= tmp%26@ (Mul 66 a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d10~88@ d10~88@ tmp%26@) (=> (= tmp%27@ (Mul (Add d10~88@ d10~88@) (Mul 66 a10~82@))) (=> (= tmp%28@ (Mul (Mul 56 b10~84@) d10~88@)) (=> (= tmp%29@ (Mul (Mul (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Add d10~88@ c10~86@) (Mul d10~88@ c10~86@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> %%location_label%%10 (= temp_10_0~2112@ temp_10_1~2217@)))))))))))) (=> (= temp_10_0~2112@ temp_10_1~2217@) (=> (= temp_11_0~2460@ (Mul (Add (Mul (Mul b11~92@ a11~90@) (Mul b11~92@ b11~92@)) (Mul b11~92@ (Mul d11~96@ d11~96@))) (Mul (Add (Mul b11~92@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@))))) (=> (= temp_11_1~2553@ (Add (Mul (Mul (Mul b11~92@ a11~90@) (Mul b11~92@ b11~92@)) (Mul (Add (Mul b11~92@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)))) (Mul (Mul b11~92@ (Mul d11~96@ d11~96@)) (Mul (Add (Mul b11~92@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)))))) (and (=> (= tmp%30@ (Mul (Mul b11~92@ a11~90@) (Mul b11~92@ b11~92@))) (=> (= tmp%31@ (Mul b11~92@ (Mul d11~96@ d11~96@))) (=> (= tmp%32@ (Mul (Add (Mul b11~92@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%30@ tmp%31@ tmp%32@) (=> %%location_label%%11 (= temp_11_0~2460@ temp_11_1~2553@)))))) (=> (= temp_11_0~2460@ temp_11_1~2553@) (=> (= temp_12_0~2696@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Mul c12~102@ a12~98@) (Mul a12~98@ c12~102@))) (Add (Mul (Mul c12~102@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Sub d12~104@ d12~104@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2761@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ a12~98@))) (Add (Mul (Mul c12~102@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Sub d12~104@ d12~104@) (Mul d12~104@ a12~98@))))) (and (=> (= tmp%33@ (Mul a12~98@ c12~102@)) (=> (= tmp%34@ (Mul c12~102@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%33@ tmp%34@) (=> %%location_label%%12 (= temp_12_0~2696@ temp_12_1~2761@))))) (=> (= temp_12_0~2696@ temp_12_1~2761@) (=> (= temp_13_0~2858@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ b13~108@)) (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ c13~110@)) (Mul c13~110@ (Mul b13~108@ b13~108@))))) (=> (= temp_13_1~2919@ (Mul (Mul (Mul c13~110@ (Mul a13~106@ (Mul b13~108@ b13~108@))) (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ c13~110@)) (Mul c13~110@ (Mul b13~108@ b13~108@))))) (and (=> (= tmp%35@ (Mul b13~108@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c13~110@ a13~106@ tmp%35@) (=> (= tmp%36@ (Mul c13~110@ (Mul a13~106@ (Mul b13~108@ b13~108@)))) (=> (= tmp%37@ (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@))) (=> (= tmp%38@ (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ c13~110@)) (Mul c13~110@ (Mul b13~108@ b13~108@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ tmp%37@ tmp%38@) (=> (= tmp%39@ (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ b13~108@))) (=> (= tmp%40@ (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@))) (=> (= tmp%41@ (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ c13~110@)) (Mul c13~110@ (Mul b13~108@ b13~108@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%39@ tmp%40@ tmp%41@) (=> %%location_label%%13 (= temp_13_0~2858@ temp_13_1~2919@)))))))))))) (=> (= temp_13_0~2858@ temp_13_1~2919@) (=> (= temp_14_0~3118@ (Mul (Mul (Mul (Sub c14~118@ b14~116@) (Add b14~116@ b14~116@)) (Mul (Mul d14~120@ a14~114@) (Add c14~118@ a14~114@))) 22)) (=> (= temp_14_1~3175@ (Mul (Mul (Mul (Sub c14~118@ b14~116@) (Add b14~116@ b14~116@)) (Add (Mul (Mul d14~120@ a14~114@) c14~118@) (Mul (Mul d14~120@ a14~114@) a14~114@))) 22)) (and (=> (= tmp%42@ (Mul d14~120@ a14~114@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%42@ c14~118@ a14~114@) (=> %%location_label%%14 (= temp_14_0~3118@ temp_14_1~3175@)))) (=> (= temp_14_0~3118@ temp_14_1~3175@) (=> (= temp_15_0~3274@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ b15~124@) (Add b15~124@ d15~128@))) (Mul (Mul (Sub b15~124@ c15~126@) (Mul a15~122@ b15~124@)) (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~3339@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ b15~124@) (Add b15~124@ d15~128@))) (Mul (Mul (Sub b15~124@ c15~126@) (Mul a15~122@ b15~124@)) (Mul (Mul a15~122@ c15~126@) (Mul c15~126@ c15~126@))))) (and (=> (= tmp%43@ (Mul a15~122@ c15~126@)) (=> (= tmp%44@ (Mul c15~126@ c15~126@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%43@ tmp%44@) (=> (= tmp%45@ (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ b15~124@) (Add b15~124@ d15~128@)))) (=> (= tmp%46@ (Mul (Sub b15~124@ c15~126@) (Mul a15~122@ b15~124@))) (=> (= tmp%47@ (Mul (Mul a15~122@ c15~126@) (Mul c15~126@ c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%45@ tmp%46@ tmp%47@) (=> (= tmp%48@ (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ b15~124@) (Add b15~124@ d15~128@)))) (=> (= tmp%49@ (Mul (Sub b15~124@ c15~126@) (Mul a15~122@ b15~124@))) (=> (= tmp%50@ (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%48@ tmp%49@ tmp%50@) (=> %%location_label%%15 (= temp_15_0~3274@ temp_15_1~3339@))))))))))))) (=> (= temp_15_0~3274@ temp_15_1~3339@) (=> (= temp_16_0~3552@ (Mul (Mul (Sub (Mul a16~130@ b16~132@) (Mul a16~130@ d16~136@)) (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ a16~130@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ b16~132@)) d16~136@))) (=> (= temp_16_1~3601@ (Mul (Mul (Mul a16~130@ (Sub b16~132@ d16~136@)) (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ a16~130@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ b16~132@)) d16~136@))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. a16~130@ b16~132@ d16~136@) (=> (= tmp%51@ (Mul a16~130@ (Sub b16~132@ d16~136@))) (=> (= tmp%52@ (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ a16~130@))) (=> (= tmp%53@ (Mul (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ b16~132@)) d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%51@ tmp%52@ tmp%53@) (=> (= tmp%54@ (Sub (Mul a16~130@ b16~132@) (Mul a16~130@ d16~136@))) (=> (= tmp%55@ (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ a16~130@))) (=> (= tmp%56@ (Mul (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ b16~132@)) d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%54@ tmp%55@ tmp%56@) (=> %%location_label%%16 (= temp_16_0~3552@ temp_16_1~3601@))))))))))) (=> (= temp_16_0~3552@ temp_16_1~3601@) (=> (= temp_17_0~3804@ (Mul (Add (Mul (Add b17~140@ c17~142@) (Mul 36 d17~144@)) (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ d17~144@))) (Mul (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ c17~142@) (Sub c17~142@ b17~140@))))) (=> (= temp_17_1~3881@ (Mul (Add (Mul (Add b17~140@ c17~142@) (Mul 36 d17~144@)) (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ d17~144@))) (Mul (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ c17~142@) (Sub c17~142@ b17~140@))))) (=> (= tmp%57@ (= temp_17_0~3804@ temp_17_1~3881@)) (and (=> %%location_label%%17 tmp%57@) (=> tmp%57@ (=> (= temp_18_0~3953@ (Mul (Mul (Sub (Mul c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul a18~146@ a18~146@)) (Mul (Sub (Mul b18~148@ d18~152@) (Mul d18~152@ b18~148@)) (Mul (Add b18~148@ a18~146@) (Mul d18~152@ c18~150@))))) (=> (= temp_18_1~4010@ (Mul (Mul (Sub (Mul c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul a18~146@ a18~146@)) (Mul (Sub (Mul d18~152@ b18~148@) (Mul d18~152@ b18~148@)) (Mul (Add b18~148@ a18~146@) (Mul d18~152@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d18~152@ b18~148@) (=> %%location_label%%18 (= temp_18_0~3953@ temp_18_1~4010@))) (=> (= temp_18_0~3953@ temp_18_1~4010@) (=> (= temp_19_0~4091@ (Mul (Mul d19~160@ (Mul (Mul d19~160@ d19~160@) (Mul b19~156@ d19~160@))) (Mul (Sub (Mul b19~156@ a19~154@) (Mul b19~156@ d19~160@)) (Mul (Add d19~160@ d19~160@) (Mul d19~160@ a19~154@))))) (=> (= temp_19_1~4144@ (Mul (Mul d19~160@ (Mul d19~160@ (Mul d19~160@ (Mul b19~156@ d19~160@)))) (Mul (Sub (Mul b19~156@ a19~154@) (Mul b19~156@ d19~160@)) (Mul (Add d19~160@ d19~160@) (Mul d19~160@ a19~154@))))) (and (=> (= tmp%58@ (Mul b19~156@ d19~160@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d19~160@ d19~160@ tmp%58@) (=> %%location_label%%19 (= temp_19_0~4091@ temp_19_1~4144@)))) (=> (= temp_19_0~4091@ temp_19_1~4144@) (=> (= temp_20_0~4231@ (Sub (Mul (Mul (Add c20~166@ b20~164@) (Mul a20~162@ a20~162@)) (Sub (Mul d20~168@ b20~164@) (Mul d20~168@ b20~164@))) (Mul b20~164@ (Add (Mul b20~164@ b20~164@) (Mul b20~164@ b20~164@))))) (=> (= temp_20_1~4288@ (Sub (Mul (Mul (Add c20~166@ b20~164@) (Mul a20~162@ a20~162@)) (Sub (Mul d20~168@ b20~164@) (Mul d20~168@ b20~164@))) (Add (Mul b20~164@ (Mul b20~164@ b20~164@)) (Mul b20~164@ (Mul b20~164@ b20~164@))))) (and (=> (= tmp%59@ (Mul b20~164@ b20~164@)) (=> (= tmp%60@ (Mul b20~164@ b20~164@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b20~164@ tmp%59@ tmp%60@) (=> %%location_label%%20 (= temp_20_0~4231@ temp_20_1~4288@))))) (=> (= temp_20_0~4231@ temp_20_1~4288@) (=> (= temp_21_0~4379@ (Mul (Mul d21~176@ (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ c21~174@))) (Mul (Sub (Mul b21~172@ b21~172@) (Sub a21~170@ c21~174@)) (Sub (Mul d21~176@ d21~176@) (Mul c21~174@ a21~170@))))) (=> (= temp_21_1~4432@ (Mul (Mul (Sub (Mul b21~172@ b21~172@) (Sub a21~170@ c21~174@)) (Sub (Mul d21~176@ d21~176@) (Mul c21~174@ a21~170@))) (Mul d21~176@ (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ c21~174@))))) (and (=> (= tmp%61@ (Mul (Sub (Mul b21~172@ b21~172@) (Sub a21~170@ c21~174@)) (Sub (Mul d21~176@ d21~176@) (Mul c21~174@ a21~170@)))) (=> (= tmp%62@ (Mul d21~176@ (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ c21~174@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%61@ tmp%62@) (=> %%location_label%%21 (= temp_21_0~4379@ temp_21_1~4432@))))) (=> (= temp_21_0~4379@ temp_21_1~4432@) (=> (= temp_22_0~4577@ (Mul (Mul (Mul (Mul a22~178@ b22~180@) (Add a22~178@ c22~182@)) (Mul b22~180@ (Mul d22~184@ d22~184@))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul 13 d22~184@)) (Mul (Mul d22~184@ d22~184@) (Mul a22~178@ b22~180@))))) (=> (= temp_22_1~4650@ (Mul (Mul (Mul (Mul a22~178@ b22~180@) (Add a22~178@ c22~182@)) (Mul b22~180@ (Mul d22~184@ d22~184@))) (Mul (Mul (Mul d22~184@ d22~184@) (Mul a22~178@ b22~180@)) (Mul (Mul b22~180@ b22~180@) (Mul 13 d22~184@))))) (and (=> (= tmp%63@ (Mul (Mul d22~184@ d22~184@) (Mul a22~178@ b22~180@))) (=> (= tmp%64@ (Mul (Mul b22~180@ b22~180@) (Mul 13 d22~184@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%63@ tmp%64@) (=> %%location_label%%22 (= temp_22_0~4577@ temp_22_1~4650@))))) (=> (= temp_22_0~4577@ temp_22_1~4650@) (=> (= temp_23_0~4795@ (Mul (Mul (Add (Mul d23~192@ 5) (Mul d23~192@ c23~190@)) (Mul (Mul b23~188@ 82) (Mul a23~186@ a23~186@))) (Mul (Mul (Mul a23~186@ b23~188@) (Mul a23~186@ b23~188@)) (Mul (Mul c23~190@ c23~190@) (Sub d23~192@ d23~192@))))) (=> (= temp_23_1~4884@ (Mul (Mul (Add (Mul d23~192@ 5) (Mul c23~190@ d23~192@)) (Mul (Mul b23~188@ 82) (Mul a23~186@ a23~186@))) (Mul (Mul (Mul a23~186@ b23~188@) (Mul a23~186@ b23~188@)) (Mul (Mul c23~190@ c23~190@) (Sub d23~192@ d23~192@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c23~190@ d23~192@) (=> (= tmp%65@ (Add (Mul d23~192@ 5) (Mul c23~190@ d23~192@))) (=> (= tmp%66@ (Mul (Mul b23~188@ 82) (Mul a23~186@ a23~186@))) (=> (= tmp%67@ (Mul (Mul (Mul a23~186@ b23~188@) (Mul a23~186@ b23~188@)) (Mul (Mul c23~190@ c23~190@) (Sub d23~192@ d23~192@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%65@ tmp%66@ tmp%67@) (=> (= tmp%68@ (Add (Mul d23~192@ 5) (Mul d23~192@ c23~190@))) (=> (= tmp%69@ (Mul (Mul b23~188@ 82) (Mul a23~186@ a23~186@))) (=> (= tmp%70@ (Mul (Mul (Mul a23~186@ b23~188@) (Mul a23~186@ b23~188@)) (Mul (Mul c23~190@ c23~190@) (Sub d23~192@ d23~192@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%68@ tmp%69@ tmp%70@) (=> %%location_label%%23 (= temp_23_0~4795@ temp_23_1~4884@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
