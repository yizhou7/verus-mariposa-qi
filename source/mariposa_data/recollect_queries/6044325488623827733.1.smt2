...
(declare-const temp_6_0~1374@ Int)
(declare-const temp_6_1~1451@ Int)
(declare-const temp_7_0~1564@ Int)
(declare-const temp_7_1~1593@ Int)
(declare-const temp_8_0~1704@ Int)
(declare-const temp_8_1~1773@ Int)
(declare-const temp_9_0~1974@ Int)
(declare-const temp_9_1~2047@ Int)
(declare-const temp_10_0~2276@ Int)
(declare-const temp_10_1~2353@ Int)
(declare-const temp_11_0~2430@ Int)
(declare-const temp_11_1~2455@ Int)
(declare-const temp_12_0~2598@ Int)
(declare-const temp_12_1~2663@ Int)
(declare-const temp_13_0~2812@ Int)
(declare-const temp_13_1~2881@ Int)
(declare-const temp_14_0~2976@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Add (Mul (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)) (Mul (Add b0~4@ c0~6@) (Mul d0~8@ a0~2@))) (Mul (Sub d0~8@ (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~362@ (Add (Mul (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)) (Mul (Add b0~4@ c0~6@) (Mul d0~8@ a0~2@))) (Mul (Sub d0~8@ (Mul d0~8@ c0~6@)) (Mul c0~6@ (Mul a0~2@ (Mul c0~6@ b0~4@)))))) (and (=> (= tmp%1@ (Mul c0~6@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c0~6@ a0~2@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@)))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~461@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@)) (Add (Mul c1~14@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Sub c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Sub b1~12@ b1~12@) (Mul b1~12@ b1~12@))))) (=> (= temp_1_1~526@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@)) (Add (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@))) (Mul (Mul (Sub c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Sub b1~12@ b1~12@) (Mul b1~12@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ d1~16@) (=> %%location_label%%1 (= temp_1_0~461@ temp_1_1~526@))) (=> (= temp_1_0~461@ temp_1_1~526@) (=> (= temp_2_0~619@ (Sub (Mul (Sub (Add b2~20@ d2~24@) (Mul d2~24@ b2~20@)) (Sub (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul b2~20@ b2~20@) (Add c2~22@ c2~22@)) (Add (Mul b2~20@ d2~24@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~692@ (Sub (Mul (Sub (Add b2~20@ d2~24@) (Mul d2~24@ b2~20@)) (Sub (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@))) (Mul (Add (Mul (Mul b2~20@ b2~20@) c2~22@) (Mul (Mul b2~20@ b2~20@) c2~22@)) (Add (Mul b2~20@ d2~24@) (Mul d2~24@ b2~20@))))) (and (=> (= tmp%2@ (Mul b2~20@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%2@ c2~22@ c2~22@) (=> %%location_label%%2 (= temp_2_0~619@ temp_2_1~692@)))) (=> (= temp_2_0~619@ temp_2_1~692@) (=> (= temp_3_0~775@ (Mul (Mul (Sub (Add c3~30@ b3~28@) (Sub a3~26@ b3~28@)) (Mul (Mul c3~30@ a3~26@) (Add a3~26@ a3~26@))) (Mul d3~32@ (Mul a3~26@ (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~824@ (Mul (Mul (Mul (Sub (Add c3~30@ b3~28@) (Sub a3~26@ b3~28@)) (Mul c3~30@ a3~26@)) (Add a3~26@ a3~26@)) (Mul d3~32@ (Mul a3~26@ (Mul b3~28@ c3~30@))))) (and (=> (= tmp%3@ (Sub (Add c3~30@ b3~28@) (Sub a3~26@ b3~28@))) (=> (= tmp%4@ (Mul c3~30@ a3~26@)) (=> (= tmp%5@ (Add a3~26@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~775@ temp_3_1~824@)))))) (=> (= temp_3_0~775@ temp_3_1~824@) (=> (= temp_4_0~947@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ 46))) (Mul (Mul (Mul c4~38@ d4~40@) (Add b4~36@ b4~36@)) (Mul b4~36@ (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~1020@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ 46))) (Mul (Mul (Mul c4~38@ d4~40@) (Add b4~36@ b4~36@)) (Mul (Mul d4~40@ a4~34@) b4~36@)))) (and (=> (= tmp%6@ (Mul d4~40@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ b4~36@) (=> (= tmp%7@ (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ 46)))) (=> (= tmp%8@ (Mul (Mul c4~38@ d4~40@) (Add b4~36@ b4~36@))) (=> (= tmp%9@ (Mul (Mul d4~40@ a4~34@) b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> (= tmp%10@ (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ 46)))) (=> (= tmp%11@ (Mul (Mul c4~38@ d4~40@) (Add b4~36@ b4~36@))) (=> (= tmp%12@ (Mul b4~36@ (Mul d4~40@ a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%4 (= temp_4_0~947@ temp_4_1~1020@)))))))))))) (=> (= temp_4_0~947@ temp_4_1~1020@) (=> (= temp_5_0~1229@ (Mul (Mul (Sub (Mul c5~46@ c5~46@) (Mul a5~42@ a5~42@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Add c5~46@ (Mul (Mul c5~46@ c5~46@) (Sub d5~48@ d5~48@))))) (=> (= temp_5_1~1282@ (Mul (Mul (Sub (Mul c5~46@ c5~46@) (Mul a5~42@ a5~42@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Add c5~46@ (Mul (Mul c5~46@ c5~46@) (Sub d5~48@ d5~48@))))) (=> (= tmp%13@ (= temp_5_0~1229@ temp_5_1~1282@)) (and (=> %%location_label%%5 tmp%13@) (=> tmp%13@ (=> (= temp_6_0~1374@ (Sub (Mul (Sub (Mul c6~54@ 80) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Sub a6~50@ b6~52@))))) (=> (= temp_6_1~1451@ (Sub (Mul (Sub (Mul c6~54@ 80) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Sub a6~50@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ c6~54@) (=> (= tmp%14@ (Mul d6~56@ c6~54@)) (=> (= tmp%15@ (Mul b6~52@ b6~52@)) (=> (= tmp%16@ (Mul (Mul c6~54@ a6~50@) (Sub a6~50@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> (= tmp%17@ (Mul c6~54@ d6~56@)) (=> (= tmp%18@ (Mul b6~52@ b6~52@)) (=> (= tmp%19@ (Mul (Mul c6~54@ a6~50@) (Sub a6~50@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%6 (= temp_6_0~1374@ temp_6_1~1451@))))))))))) (=> (= temp_6_0~1374@ temp_6_1~1451@) (=> (= temp_7_0~1564@ (Mul c7~62@ (Add (Mul (Sub a7~58@ c7~62@) (Add a7~58@ d7~64@)) b7~60@))) (=> (= temp_7_1~1593@ (Add (Mul c7~62@ (Mul (Sub a7~58@ c7~62@) (Add a7~58@ d7~64@))) (Mul c7~62@ b7~60@))) (and (=> (= tmp%20@ (Mul (Sub a7~58@ c7~62@) (Add a7~58@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c7~62@ tmp%20@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1564@ temp_7_1~1593@)))) (=> (= temp_7_0~1564@ temp_7_1~1593@) (=> (= temp_8_0~1704@ (Mul (Add (Sub a8~66@ (Add c8~70@ b8~68@)) 96) (Mul (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ 81)) (Sub (Mul b8~68@ d8~72@) a8~66@)))) (=> (= temp_8_1~1773@ (Mul (Add (Sub a8~66@ (Add c8~70@ b8~68@)) 96) (Mul (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ 81)) (Sub (Mul d8~72@ b8~68@) a8~66@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d8~72@ b8~68@) (=> (= tmp%21@ (Add (Sub a8~66@ (Add c8~70@ b8~68@)) 96)) (=> (= tmp%22@ (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ 81))) (=> (= tmp%23@ (Sub (Mul d8~72@ b8~68@) a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> (= tmp%24@ (Add (Sub a8~66@ (Add c8~70@ b8~68@)) 96)) (=> (= tmp%25@ (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ 81))) (=> (= tmp%26@ (Sub (Mul b8~68@ d8~72@) a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%8 (= temp_8_0~1704@ temp_8_1~1773@))))))))))) (=> (= temp_8_0~1704@ temp_8_1~1773@) (=> (= temp_9_0~1974@ (Mul (Mul (Mul (Mul a9~74@ c9~78@) b9~76@) (Mul (Mul 50 d9~80@) (Mul a9~74@ b9~76@))) (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@)) (Mul (Sub c9~78@ c9~78@) (Add b9~76@ a9~74@))))) (=> (= temp_9_1~2047@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) b9~76@) (Mul (Mul 50 d9~80@) (Mul a9~74@ b9~76@))) (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@)) (Mul (Sub c9~78@ c9~78@) (Add b9~76@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c9~78@ a9~74@) (=> (= tmp%27@ (Mul (Mul c9~78@ a9~74@) b9~76@)) (=> (= tmp%28@ (Mul (Mul 50 d9~80@) (Mul a9~74@ b9~76@))) (=> (= tmp%29@ (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@)) (Mul (Sub c9~78@ c9~78@) (Add b9~76@ a9~74@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> (= tmp%30@ (Mul (Mul a9~74@ c9~78@) b9~76@)) (=> (= tmp%31@ (Mul (Mul 50 d9~80@) (Mul a9~74@ b9~76@))) (=> (= tmp%32@ (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@)) (Mul (Sub c9~78@ c9~78@) (Add b9~76@ a9~74@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%30@ tmp%31@ tmp%32@) (=> %%location_label%%9 (= temp_9_0~1974@ temp_9_1~2047@))))))))))) (=> (= temp_9_0~1974@ temp_9_1~2047@) (=> (= temp_10_0~2276@ (Mul (Mul (Add (Add d10~88@ c10~86@) (Mul b10~84@ a10~82@)) (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ 87))) (Mul (Mul (Sub c10~86@ a10~82@) (Sub c10~86@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~2353@ (Mul (Mul (Add (Add d10~88@ c10~86@) (Mul b10~84@ a10~82@)) (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ 87))) (Mul (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ d10~88@)) (Mul (Sub c10~86@ a10~82@) (Sub c10~86@ c10~86@))))) (and (=> (= tmp%33@ (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ d10~88@))) (=> (= tmp%34@ (Mul (Sub c10~86@ a10~82@) (Sub c10~86@ c10~86@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%33@ tmp%34@) (=> %%location_label%%10 (= temp_10_0~2276@ temp_10_1~2353@))))) (=> (= temp_10_0~2276@ temp_10_1~2353@) (=> (= temp_11_0~2430@ (Mul (Mul (Mul (Sub b11~92@ b11~92@) (Mul b11~92@ b11~92@)) b11~92@) b11~92@)) (=> (= temp_11_1~2455@ (Mul (Mul (Mul (Mul (Sub b11~92@ b11~92@) b11~92@) b11~92@) b11~92@) b11~92@)) (and (=> (= tmp%35@ (Mul (Mul (Sub b11~92@ b11~92@) b11~92@) b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ b11~92@ b11~92@) (=> (= tmp%36@ (Sub b11~92@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ b11~92@ b11~92@) (=> (= tmp%37@ (Mul (Sub b11~92@ b11~92@) (Mul b11~92@ b11~92@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%37@ b11~92@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2430@ temp_11_1~2455@)))))))) (=> (= temp_11_0~2430@ temp_11_1~2455@) (=> (= temp_12_0~2598@ (Sub (Mul (Mul (Mul b12~100@ a12~98@) (Sub d12~104@ c12~102@)) (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ b12~100@))) (Mul (Mul (Mul a12~98@ a12~98@) (Mul d12~104@ d12~104@)) (Mul (Add c12~102@ b12~100@) (Sub a12~98@ b12~100@))))) (=> (= temp_12_1~2663@ (Sub (Mul (Mul (Mul b12~100@ a12~98@) (Sub d12~104@ c12~102@)) (Mul (Mul c12~102@ c12~102@) (Mul b12~100@ d12~104@))) (Mul (Mul (Mul a12~98@ a12~98@) (Mul d12~104@ d12~104@)) (Mul (Add c12~102@ b12~100@) (Sub a12~98@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ d12~104@) (=> (= tmp%38@ (Mul (Mul b12~100@ a12~98@) (Sub d12~104@ c12~102@))) (=> (= tmp%39@ (Mul c12~102@ c12~102@)) (=> (= tmp%40@ (Mul b12~100@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> (= tmp%41@ (Mul (Mul b12~100@ a12~98@) (Sub d12~104@ c12~102@))) (=> (= tmp%42@ (Mul c12~102@ c12~102@)) (=> (= tmp%43@ (Mul d12~104@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ tmp%42@ tmp%43@) (=> %%location_label%%12 (= temp_12_0~2598@ temp_12_1~2663@))))))))))) (=> (= temp_12_0~2598@ temp_12_1~2663@) (=> (= temp_13_0~2812@ (Mul (Mul (Mul (Mul c13~110@ b13~108@) (Add b13~108@ c13~110@)) (Mul (Add c13~110@ a13~106@) (Mul a13~106@ a13~106@))) (Mul (Mul (Add c13~110@ c13~110@) c13~110@) (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ a13~106@))))) (=> (= temp_13_1~2881@ (Mul (Mul (Mul (Mul c13~110@ b13~108@) (Add b13~108@ c13~110@)) (Add (Mul c13~110@ (Mul a13~106@ a13~106@)) (Mul a13~106@ (Mul a13~106@ a13~106@)))) (Mul (Mul (Add c13~110@ c13~110@) c13~110@) (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ a13~106@))))) (and (=> (= tmp%44@ (Mul a13~106@ a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c13~110@ a13~106@ tmp%44@) (=> %%location_label%%13 (= temp_13_0~2812@ temp_13_1~2881@)))) (=> (= temp_13_0~2812@ temp_13_1~2881@) (=> (= temp_14_0~2976@ (Sub (Mul (Add (Mul d14~120@ a14~114@) d14~120@) (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@))) (Mul (Sub (Mul c14~118@ d14~120@) (Sub a14~114@ b14~116@)) (Mul (Mul b14~116@ a14~114@) (Add a14~114@ c14~118@))))) (=> (= temp_14_1~3037@ (Sub (Mul (Add (Mul d14~120@ a14~114@) d14~120@) (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@))) (Mul (Sub (Mul c14~118@ d14~120@) (Sub a14~114@ b14~116@)) (Mul b14~116@ (Mul a14~114@ (Add a14~114@ c14~118@)))))) (=> (= tmp%45@ (Add a14~114@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b14~116@ a14~114@ tmp%45@) (=> %%location_label%%14 (= temp_14_0~2976@ temp_14_1~3037@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
