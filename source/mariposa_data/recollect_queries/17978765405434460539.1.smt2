...
(declare-const temp_2_0~682@ Int)
(declare-const temp_2_1~759@ Int)
(declare-const temp_3_0~858@ Int)
(declare-const temp_3_1~923@ Int)
(declare-const temp_4_0~1018@ Int)
(declare-const temp_4_1~1079@ Int)
(declare-const temp_5_0~1180@ Int)
(declare-const temp_5_1~1229@ Int)
(declare-const temp_6_0~1324@ Int)
(declare-const temp_6_1~1397@ Int)
(declare-const temp_7_0~1492@ Int)
(declare-const temp_7_1~1553@ Int)
(declare-const temp_8_0~1766@ Int)
(declare-const temp_8_1~1827@ Int)
(declare-const temp_9_0~1926@ Int)
(declare-const temp_9_1~1991@ Int)
(declare-const temp_10_0~2055@ Int)
...
(declare-const temp_12_1~2496@ Int)
(declare-const temp_13_0~2573@ Int)
(declare-const temp_13_1~2622@ Int)
(declare-const temp_14_0~2751@ Int)
(declare-const temp_14_1~2808@ Int)
(declare-const temp_15_0~2899@ Int)
(declare-const temp_15_1~2960@ Int)
(declare-const temp_16_0~3048@ Int)
(declare-const temp_16_1~3121@ Int)
(declare-const temp_17_0~3342@ Int)
(declare-const temp_17_1~3403@ Int)
(declare-const temp_18_0~3520@ Int)
(declare-const temp_18_1~3573@ Int)
(declare-const temp_19_0~3666@ Int)
(declare-const temp_19_1~3731@ Int)
(declare-const temp_20_0~3799@ Int)
(declare-const temp_20_1~3852@ Int)
(declare-const temp_21_0~3975@ Int)
(declare-const temp_21_1~4028@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Sub b0~4@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Add (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Add c0~6@ c0~6@))))) (=> (= temp_0_1~370@ (Sub (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Sub b0~4@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Add (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Add c0~6@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~474@ (Add (Mul (Mul (Sub d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Add c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (Sub (Sub (Mul b1~12@ b1~12@) (Sub d1~16@ 27)) (Mul (Mul 16 c1~14@) (Mul a1~10@ d1~16@))))) (=> (= temp_1_1~571@ (Add (Mul (Mul (Sub d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Add (Mul c1~14@ (Mul d1~16@ b1~12@)) (Mul a1~10@ (Mul d1~16@ b1~12@)))) (Sub (Sub (Mul b1~12@ b1~12@) (Sub d1~16@ 27)) (Mul (Mul 16 c1~14@) (Mul a1~10@ d1~16@))))) (and (=> (= tmp%2@ (Mul d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c1~14@ a1~10@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~474@ temp_1_1~571@)))) (=> (= temp_1_0~474@ temp_1_1~571@) (=> (= temp_2_0~682@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Add (Sub a2~18@ c2~22@) (Mul d2~24@ 3)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~759@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul (Mul d2~24@ d2~24@) b2~20@) c2~22@)) (Mul (Add (Sub a2~18@ c2~22@) (Mul d2~24@ 3)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@))))) (and (=> (= tmp%3@ (Mul d2~24@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ b2~20@ c2~22@) (=> %%location_label%%2 (= temp_2_0~682@ temp_2_1~759@)))) (=> (= temp_2_0~682@ temp_2_1~759@) (=> (= temp_3_0~858@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Add d3~32@ a3~26@))) (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~923@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)) (Mul c3~30@ (Mul a3~26@ (Add d3~32@ a3~26@)))) (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@))))) (and (=> (= tmp%4@ (Add d3~32@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c3~30@ a3~26@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~858@ temp_3_1~923@)))) (=> (= temp_3_0~858@ temp_3_1~923@) (=> (= temp_4_0~1018@ (Mul (Mul (Mul (Add b4~36@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Sub d4~40@ (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~1079@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Add b4~36@ a4~34@) (Mul d4~40@ a4~34@))) (Mul (Sub d4~40@ (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))))) (and (=> (= tmp%5@ (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ c4~38@))) (=> (= tmp%6@ (Mul (Add b4~36@ a4~34@) (Mul d4~40@ a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~1018@ temp_4_1~1079@))))) (=> (= temp_4_0~1018@ temp_4_1~1079@) (=> (= temp_5_0~1180@ (Sub (Mul (Mul d5~48@ (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ d5~48@))) (Mul d5~48@ (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ d5~48@))))) (=> (= temp_5_1~1229@ (Sub (Mul (Mul (Mul d5~48@ d5~48@) a5~42@) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ d5~48@))) (Mul d5~48@ (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. d5~48@ d5~48@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1180@ temp_5_1~1229@))) (=> (= temp_5_0~1180@ temp_5_1~1229@) (=> (= temp_6_0~1324@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Add (Mul b6~52@ c6~54@) (Mul c6~54@ c6~54@))) (Mul (Mul (Sub c6~54@ b6~52@) (Mul c6~54@ c6~54@)) (Sub (Mul b6~52@ d6~56@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1397@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Add (Mul b6~52@ c6~54@) (Mul c6~54@ c6~54@))) (Mul (Sub (Mul c6~54@ (Mul c6~54@ c6~54@)) (Mul b6~52@ (Mul c6~54@ c6~54@))) (Sub (Mul b6~52@ d6~56@) (Mul b6~52@ c6~54@))))) (and (=> (= tmp%7@ (Mul c6~54@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c6~54@ b6~52@ tmp%7@) (=> %%location_label%%6 (= temp_6_0~1324@ temp_6_1~1397@)))) (=> (= temp_6_0~1324@ temp_6_1~1397@) (=> (= temp_7_0~1492@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Sub d7~64@ b7~60@)) (Mul c7~62@ (Mul a7~58@ a7~58@))) (Mul (Sub (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Add d7~64@ c7~62@) (Sub c7~62@ b7~60@))))) (=> (= temp_7_1~1553@ (Mul (Mul (Mul (Sub d7~64@ b7~60@) (Mul c7~62@ d7~64@)) (Mul c7~62@ (Mul a7~58@ a7~58@))) (Mul (Sub (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Add d7~64@ c7~62@) (Sub c7~62@ b7~60@))))) (and (=> (= tmp%8@ (Sub d7~64@ b7~60@)) (=> (= tmp%9@ (Mul c7~62@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> (= tmp%10@ (Mul (Sub d7~64@ b7~60@) (Mul c7~62@ d7~64@))) (=> (= tmp%11@ (Mul c7~62@ (Mul a7~58@ a7~58@))) (=> (= tmp%12@ (Mul (Sub (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Add d7~64@ c7~62@) (Sub c7~62@ b7~60@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> (= tmp%13@ (Mul (Mul c7~62@ d7~64@) (Sub d7~64@ b7~60@))) (=> (= tmp%14@ (Mul c7~62@ (Mul a7~58@ a7~58@))) (=> (= tmp%15@ (Mul (Sub (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Add d7~64@ c7~62@) (Sub c7~62@ b7~60@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%7 (= temp_7_0~1492@ temp_7_1~1553@))))))))))))) (=> (= temp_7_0~1492@ temp_7_1~1553@) (=> (= temp_8_0~1766@ (Mul (Mul (Mul d8~72@ (Mul c8~70@ b8~68@)) (Mul (Add a8~66@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1827@ (Mul (Mul (Mul d8~72@ (Mul c8~70@ b8~68@)) (Mul (Add a8~66@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul (Mul a8~66@ c8~70@) a8~66@) b8~68@) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@))))) (and (=> (= tmp%16@ (Mul a8~66@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ a8~66@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1766@ temp_8_1~1827@)))) (=> (= temp_8_0~1766@ temp_8_1~1827@) (=> (= temp_9_0~1926@ (Mul (Mul (Mul (Sub c9~78@ c9~78@) (Mul d9~80@ c9~78@)) (Mul d9~80@ d9~80@)) (Mul (Mul (Sub d9~80@ b9~76@) (Mul c9~78@ b9~76@)) (Mul b9~76@ (Add d9~80@ 37))))) (=> (= temp_9_1~1991@ (Mul (Mul (Mul (Sub c9~78@ c9~78@) (Mul d9~80@ c9~78@)) (Mul d9~80@ d9~80@)) (Mul (Mul (Sub d9~80@ b9~76@) (Mul c9~78@ b9~76@)) (Mul b9~76@ (Add d9~80@ 37))))) (=> (= tmp%17@ (= temp_9_0~1926@ temp_9_1~1991@)) (and (=> %%location_label%%9 tmp%17@) (=> tmp%17@ (=> (= temp_10_0~2055@ (Mul (Mul b10~84@ (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Add (Sub (Mul d10~88@ a10~82@) (Mul d10~88@ a10~82@)) (Sub (Mul c10~86@ b10~84@) c10~86@)))) (=> (= temp_10_1~2104@ (Mul (Mul b10~84@ (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Add (Sub (Mul d10~88@ a10~82@) (Mul a10~82@ d10~88@)) (Sub (Mul c10~86@ b10~84@) c10~86@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d10~88@ a10~82@) (=> %%location_label%%10 (= temp_10_0~2055@ temp_10_1~2104@))) (=> (= temp_10_0~2055@ temp_10_1~2104@) (=> (= temp_11_0~2209@ (Mul (Mul (Add (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul b11~92@ b11~92@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ 25) (Mul a11~90@ b11~92@))))) (=> (= temp_11_1~2286@ (Mul (Mul (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ 25) (Mul a11~90@ b11~92@))) (Mul (Add (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul b11~92@ b11~92@) (Mul c11~94@ b11~92@))))) (and (=> (= tmp%18@ (Mul (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ 25) (Mul a11~90@ b11~92@)))) (=> (= tmp%19@ (Mul (Add (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul b11~92@ b11~92@) (Mul c11~94@ b11~92@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%11 (= temp_11_0~2209@ temp_11_1~2286@))))) (=> (= temp_11_0~2209@ temp_11_1~2286@) (=> (= temp_12_0~2435@ (Mul (Add (Mul (Sub c12~102@ b12~100@) (Mul c12~102@ d12~104@)) (Sub (Mul d12~104@ b12~100@) (Mul b12~100@ a12~98@))) (Add (Mul (Mul d12~104@ c12~102@) a12~98@) (Sub (Mul b12~100@ b12~100@) (Mul b12~100@ c12~102@))))) (=> (= temp_12_1~2496@ (Mul (Add (Mul (Sub c12~102@ b12~100@) (Mul c12~102@ d12~104@)) (Sub (Mul d12~104@ b12~100@) (Mul a12~98@ b12~100@))) (Add (Mul (Mul d12~104@ c12~102@) a12~98@) (Sub (Mul b12~100@ b12~100@) (Mul b12~100@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a12~98@ b12~100@) (=> %%location_label%%12 (= temp_12_0~2435@ temp_12_1~2496@))) (=> (= temp_12_0~2435@ temp_12_1~2496@) (=> (= temp_13_0~2573@ (Mul (Mul (Mul c13~110@ (Mul d13~112@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ c13~110@))) (Add d13~112@ (Add (Sub c13~110@ c13~110@) (Mul b13~108@ c13~110@))))) (=> (= temp_13_1~2622@ (Mul (Add d13~112@ (Add (Sub c13~110@ c13~110@) (Mul b13~108@ c13~110@))) (Mul (Mul c13~110@ (Mul d13~112@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ c13~110@))))) (and (=> (= tmp%20@ (Add d13~112@ (Add (Sub c13~110@ c13~110@) (Mul b13~108@ c13~110@)))) (=> (= tmp%21@ (Mul (Mul c13~110@ (Mul d13~112@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ c13~110@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%13 (= temp_13_0~2573@ temp_13_1~2622@))))) (=> (= temp_13_0~2573@ temp_13_1~2622@) (=> (= temp_14_0~2751@ (Sub (Mul (Sub (Mul b14~116@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Mul c14~118@ d14~120@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul c14~118@ d14~120@)) (Mul b14~116@ (Mul a14~114@ d14~120@))))) (=> (= temp_14_1~2808@ (Sub (Mul (Mul (Sub b14~116@ c14~118@) b14~116@) (Mul (Mul a14~114@ b14~116@) (Mul c14~118@ d14~120@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul c14~118@ d14~120@)) (Mul b14~116@ (Mul a14~114@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b14~116@ c14~118@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2751@ temp_14_1~2808@))) (=> (= temp_14_0~2751@ temp_14_1~2808@) (=> (= temp_15_0~2899@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ a15~122@) d15~128@)) (Mul (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2960@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ a15~122@) d15~128@)) (Mul (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= tmp%22@ (= temp_15_0~2899@ temp_15_1~2960@)) (and (=> %%location_label%%15 tmp%22@) (=> tmp%22@ (=> (= temp_16_0~3048@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ 41)) (Mul a16~130@ (Add d16~136@ b16~132@))) (Mul (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Sub a16~130@ d16~136@) (Sub a16~130@ c16~134@))))) (=> (= temp_16_1~3121@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ 41)) (Mul a16~130@ (Add d16~136@ b16~132@))) (Mul (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Sub a16~130@ c16~134@) (Sub a16~130@ d16~136@))))) (and (=> (= tmp%23@ (Sub a16~130@ c16~134@)) (=> (= tmp%24@ (Sub a16~130@ d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> (= tmp%25@ (Mul (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ 41)) (Mul a16~130@ (Add d16~136@ b16~132@)))) (=> (= tmp%26@ (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@))) (=> (= tmp%27@ (Mul (Sub a16~130@ c16~134@) (Sub a16~130@ d16~136@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> (= tmp%28@ (Mul (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ 41)) (Mul a16~130@ (Add d16~136@ b16~132@)))) (=> (= tmp%29@ (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@))) (=> (= tmp%30@ (Mul (Sub a16~130@ d16~136@) (Sub a16~130@ c16~134@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%16 (= temp_16_0~3048@ temp_16_1~3121@))))))))))))) (=> (= temp_16_0~3048@ temp_16_1~3121@) (=> (= temp_17_0~3342@ (Mul (Mul a17~138@ (Mul (Sub d17~144@ d17~144@) (Mul b17~140@ a17~138@))) (Mul (Sub (Mul c17~142@ d17~144@) c17~142@) (Mul (Mul b17~140@ d17~144@) (Mul 30 d17~144@))))) (=> (= temp_17_1~3403@ (Mul (Mul a17~138@ (Mul (Sub d17~144@ d17~144@) (Mul a17~138@ b17~140@))) (Mul (Sub (Mul c17~142@ d17~144@) c17~142@) (Mul (Mul b17~140@ d17~144@) (Mul 30 d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a17~138@ b17~140@) (=> (= tmp%31@ (Sub d17~144@ d17~144@)) (=> (= tmp%32@ (Mul a17~138@ b17~140@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a17~138@ tmp%31@ tmp%32@) (=> (= tmp%33@ (Sub d17~144@ d17~144@)) (=> (= tmp%34@ (Mul b17~140@ a17~138@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a17~138@ tmp%33@ tmp%34@) (=> %%location_label%%17 (= temp_17_0~3342@ temp_17_1~3403@))))))))) (=> (= temp_17_0~3342@ temp_17_1~3403@) (=> (= temp_18_0~3520@ (Sub (Mul (Add (Mul a18~146@ d18~152@) (Mul b18~148@ d18~152@)) d18~152@) (Mul (Mul (Mul c18~150@ a18~146@) (Sub c18~150@ d18~152@)) (Mul (Sub a18~146@ b18~148@) (Mul b18~148@ d18~152@))))) (=> (= temp_18_1~3573@ (Sub (Mul (Add (Mul a18~146@ d18~152@) (Mul d18~152@ b18~148@)) d18~152@) (Mul (Mul (Mul c18~150@ a18~146@) (Sub c18~150@ d18~152@)) (Mul (Sub a18~146@ b18~148@) (Mul b18~148@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d18~152@ b18~148@) (=> %%location_label%%18 (= temp_18_0~3520@ temp_18_1~3573@))) (=> (= temp_18_0~3520@ temp_18_1~3573@) (=> (= temp_19_0~3666@ (Mul (Mul (Mul (Sub d19~160@ b19~156@) (Mul d19~160@ d19~160@)) (Mul (Mul d19~160@ b19~156@) (Sub b19~156@ c19~158@))) (Mul (Mul (Mul a19~154@ c19~158@) (Mul a19~154@ a19~154@)) (Sub (Mul b19~156@ d19~160@) (Mul a19~154@ a19~154@))))) (=> (= temp_19_1~3731@ (Mul (Mul (Mul (Sub d19~160@ b19~156@) (Mul d19~160@ d19~160@)) (Mul (Mul d19~160@ b19~156@) (Sub b19~156@ c19~158@))) (Mul (Mul (Mul a19~154@ c19~158@) (Mul a19~154@ a19~154@)) (Sub (Mul b19~156@ d19~160@) (Mul a19~154@ a19~154@))))) (=> (= tmp%35@ (= temp_19_0~3666@ temp_19_1~3731@)) (and (=> %%location_label%%19 tmp%35@) (=> tmp%35@ (=> (= temp_20_0~3799@ (Mul (Mul (Add (Mul a20~162@ d20~168@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ d20~168@))) (Mul a20~162@ (Mul (Mul a20~162@ b20~164@) (Mul a20~162@ d20~168@))))) (=> (= temp_20_1~3852@ (Mul (Mul (Mul (Add (Mul a20~162@ d20~168@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ d20~168@))) a20~162@) (Mul (Mul a20~162@ b20~164@) (Mul a20~162@ d20~168@)))) (and (=> (= tmp%36@ (Mul (Add (Mul a20~162@ d20~168@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ d20~168@)))) (=> (= tmp%37@ (Mul (Mul a20~162@ b20~164@) (Mul a20~162@ d20~168@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ a20~162@ tmp%37@) (=> %%location_label%%20 (= temp_20_0~3799@ temp_20_1~3852@))))) (=> (= temp_20_0~3799@ temp_20_1~3852@) (=> (= temp_21_0~3975@ (Mul (Mul (Mul (Mul c21~174@ c21~174@) (Mul b21~172@ a21~170@)) d21~176@) (Add (Mul (Mul d21~176@ d21~176@) (Add b21~172@ c21~174@)) (Mul (Mul c21~174@ d21~176@) (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~4028@ (Mul (Mul (Mul (Mul c21~174@ c21~174@) (Mul b21~172@ a21~170@)) d21~176@) (Add (Mul d21~176@ (Mul d21~176@ (Add b21~172@ c21~174@))) (Mul (Mul c21~174@ d21~176@) (Mul a21~170@ b21~172@))))) (=> (= tmp%38@ (Add b21~172@ c21~174@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d21~176@ d21~176@ tmp%38@) (=> %%location_label%%21 (= temp_21_0~3975@ temp_21_1~4028@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
