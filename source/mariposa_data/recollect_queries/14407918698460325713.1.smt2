...
(declare-const temp_1_0~387@ Int)
(declare-const temp_1_1~440@ Int)
...
(declare-const temp_5_1~1185@ Int)
(declare-const temp_6_0~1262@ Int)
(declare-const temp_6_1~1311@ Int)
(declare-const temp_7_0~1428@ Int)
(declare-const temp_7_1~1493@ Int)
(declare-const temp_8_0~1598@ Int)
(declare-const temp_8_1~1667@ Int)
(declare-const temp_9_0~1764@ Int)
(declare-const temp_9_1~1837@ Int)
(declare-const temp_10_0~1924@ Int)
(declare-const temp_10_1~1977@ Int)
(declare-const temp_11_0~2054@ Int)
(declare-const temp_11_1~2103@ Int)
(declare-const temp_12_0~2200@ Int)
(declare-const temp_12_1~2261@ Int)
(declare-const temp_13_0~2434@ Int)
(declare-const temp_13_1~2527@ Int)
(declare-const temp_14_0~2772@ Int)
(declare-const temp_14_1~2849@ Int)
(declare-const temp_15_0~3002@ Int)
(declare-const temp_15_1~3067@ Int)
(declare-const temp_16_0~3200@ Int)
(declare-const temp_16_1~3257@ Int)
(declare-const temp_17_0~3364@ Int)
(declare-const temp_17_1~3437@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Sub (Mul (Mul b0~4@ (Mul c0~6@ a0~2@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@))) d0~8@)) (=> (= temp_0_1~306@ (Sub (Mul (Mul b0~4@ (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@))) d0~8@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ c0~6@) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~306@))) (=> (= temp_0_0~273@ temp_0_1~306@) (=> (= temp_1_0~387@ (Mul (Mul (Mul a1~10@ (Add c1~14@ c1~14@)) (Mul (Mul b1~12@ a1~10@) a1~10@)) (Mul (Mul a1~10@ (Mul d1~16@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~440@ (Mul (Mul (Mul a1~10@ (Add c1~14@ c1~14@)) (Mul (Mul a1~10@ b1~12@) a1~10@)) (Mul (Mul a1~10@ (Mul d1~16@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a1~10@ b1~12@ a1~10@) (=> (= tmp%1@ (Mul b1~12@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ a1~10@) (=> %%location_label%%1 (= temp_1_0~387@ temp_1_1~440@))))) (=> (= temp_1_0~387@ temp_1_1~440@) (=> (= temp_2_0~535@ (Mul (Add d2~24@ (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~588@ (Mul (Add d2~24@ (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul (Mul a2~18@ a2~18@) b2~20@) d2~24@)))) (and (=> (= tmp%2@ (Add d2~24@ (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@)))) (=> (= tmp%3@ (Mul (Mul c2~22@ a2~18@) (Add b2~20@ d2~24@))) (=> (= tmp%4@ (Mul (Mul (Mul a2~18@ a2~18@) b2~20@) d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> (= tmp%5@ (Mul a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ b2~20@ d2~24@) (=> (= tmp%6@ (Add d2~24@ (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@)))) (=> (= tmp%7@ (Mul (Mul c2~22@ a2~18@) (Add b2~20@ d2~24@))) (=> (= tmp%8@ (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%2 (= temp_2_0~535@ temp_2_1~588@)))))))))))) (=> (= temp_2_0~535@ temp_2_1~588@) (=> (= temp_3_0~783@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ a3~26@)) (Add (Sub c3~30@ d3~32@) b3~28@)) (Mul (Sub (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~844@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ a3~26@)) (Add (Sub c3~30@ d3~32@) b3~28@)) (Mul (Sub (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))))) (=> (= tmp%9@ (= temp_3_0~783@ temp_3_1~844@)) (and (=> %%location_label%%3 tmp%9@) (=> tmp%9@ (=> (= temp_4_0~936@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ 62))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~1013@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ 62))) (Mul (Mul d4~40@ c4~38@) (Mul (Mul b4~36@ b4~36@) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@)))))) (and (=> (= tmp%10@ (Mul d4~40@ c4~38@)) (=> (= tmp%11@ (Mul b4~36@ b4~36@)) (=> (= tmp%12@ (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%4 (= temp_4_0~936@ temp_4_1~1013@)))))) (=> (= temp_4_0~936@ temp_4_1~1013@) (=> (= temp_5_0~1124@ (Mul (Add (Sub (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ d5~48@))) (Sub (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ a5~42@) d5~48@)))) (=> (= temp_5_1~1185@ (Mul (Add (Sub (Mul d5~48@ a5~42@) (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ d5~48@))) (Sub (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ a5~42@) d5~48@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1124@ temp_5_1~1185@))) (=> (= temp_5_0~1124@ temp_5_1~1185@) (=> (= temp_6_0~1262@ (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ a6~50@))) (Mul b6~52@ (Mul b6~52@ (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1311@ (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@))) (Mul b6~52@ (Mul b6~52@ (Mul b6~52@ d6~56@))))) (and (=> (= tmp%13@ (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ a6~50@))) (=> (= tmp%14@ (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%6 (= temp_6_0~1262@ temp_6_1~1311@))))) (=> (= temp_6_0~1262@ temp_6_1~1311@) (=> (= temp_7_0~1428@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Add c7~62@ d7~64@) (Mul b7~60@ b7~60@))) (Add (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1493@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Add c7~62@ d7~64@) (Mul b7~60@ b7~60@))) (Add (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@))))) (and (=> (= tmp%15@ (Mul c7~62@ a7~58@)) (=> (= tmp%16@ (Mul c7~62@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%7 (= temp_7_0~1428@ temp_7_1~1493@))))) (=> (= temp_7_0~1428@ temp_7_1~1493@) (=> (= temp_8_0~1598@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul b8~68@ (Mul a8~66@ b8~68@))) (Mul (Mul (Mul 48 b8~68@) c8~70@) (Mul (Sub a8~66@ d8~72@) (Sub b8~68@ c8~70@))))) (=> (= temp_8_1~1667@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@ b8~68@) b8~68@)) (Mul (Mul (Mul 48 b8~68@) c8~70@) (Mul (Sub a8~66@ d8~72@) (Sub b8~68@ c8~70@))))) (and (=> (= tmp%17@ (Mul a8~66@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1598@ temp_8_1~1667@)))) (=> (= temp_8_0~1598@ temp_8_1~1667@) (=> (= temp_9_0~1764@ (Mul (Add (Mul (Mul a9~74@ a9~74@) (Add c9~78@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Add c9~78@ a9~74@) (Mul d9~80@ c9~78@)) (Add (Sub a9~74@ a9~74@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1837@ (Mul (Add (Mul (Mul a9~74@ a9~74@) (Add c9~78@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Add (Mul c9~78@ (Mul d9~80@ c9~78@)) (Mul a9~74@ (Mul d9~80@ c9~78@))) (Add (Sub a9~74@ a9~74@) (Mul d9~80@ d9~80@))))) (and (=> (= tmp%18@ (Mul d9~80@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c9~78@ a9~74@ tmp%18@) (=> %%location_label%%9 (= temp_9_0~1764@ temp_9_1~1837@)))) (=> (= temp_9_0~1764@ temp_9_1~1837@) (=> (= temp_10_0~1924@ (Mul (Mul b10~84@ c10~86@) (Mul (Sub (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ 61) (Sub b10~84@ c10~86@))))) (=> (= temp_10_1~1977@ (Mul (Mul c10~86@ b10~84@) (Mul (Sub (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ 61) (Sub b10~84@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ b10~84@) (=> %%location_label%%10 (= temp_10_0~1924@ temp_10_1~1977@))) (=> (= temp_10_0~1924@ temp_10_1~1977@) (=> (= temp_11_0~2054@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) b11~92@) b11~92@) (Mul (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ d11~96@) (Mul a11~90@ a11~90@))))) (=> (= temp_11_1~2103@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) b11~92@) b11~92@) (Mul (Mul (Mul c11~94@ d11~96@) (Mul d11~96@ c11~94@)) (Mul (Mul d11~96@ d11~96@) (Mul a11~90@ a11~90@))))) (and (=> (= tmp%19@ (Mul c11~94@ d11~96@)) (=> (= tmp%20@ (Mul d11~96@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%11 (= temp_11_0~2054@ temp_11_1~2103@))))) (=> (= temp_11_0~2054@ temp_11_1~2103@) (=> (= temp_12_0~2200@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ c12~102@))) (Mul (Sub b12~100@ (Mul c12~102@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~2261@ (Mul (Mul (Sub b12~100@ (Mul c12~102@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ c12~102@))))) (and (=> (= tmp%21@ (Mul (Sub b12~100@ (Mul c12~102@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ b12~100@)))) (=> (= tmp%22@ (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ c12~102@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%12 (= temp_12_0~2200@ temp_12_1~2261@))))) (=> (= temp_12_0~2200@ temp_12_1~2261@) (=> (= temp_13_0~2434@ (Mul (Sub (Mul (Sub b13~108@ 62) c13~110@) (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@))) (Mul (Mul (Mul b13~108@ 15) 54) (Mul (Add a13~106@ a13~106@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2527@ (Mul (Sub (Mul (Sub b13~108@ 62) c13~110@) (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@))) (Mul (Mul (Mul b13~108@ 15) 54) (Mul (Mul d13~112@ a13~106@) (Add a13~106@ a13~106@))))) (and (=> (= tmp%23@ (Mul d13~112@ a13~106@)) (=> (= tmp%24@ (Add a13~106@ a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> (= tmp%25@ (Sub (Mul (Sub b13~108@ 62) c13~110@) (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@)))) (=> (= tmp%26@ (Mul (Mul b13~108@ 15) 54)) (=> (= tmp%27@ (Mul (Mul d13~112@ a13~106@) (Add a13~106@ a13~106@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> (= tmp%28@ (Sub (Mul (Sub b13~108@ 62) c13~110@) (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@)))) (=> (= tmp%29@ (Mul (Mul b13~108@ 15) 54)) (=> (= tmp%30@ (Mul (Add a13~106@ a13~106@) (Mul d13~112@ a13~106@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%13 (= temp_13_0~2434@ temp_13_1~2527@))))))))))))) (=> (= temp_13_0~2434@ temp_13_1~2527@) (=> (= temp_14_0~2772@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ 49)) (Mul (Mul d14~120@ c14~118@) (Add b14~116@ c14~118@))) (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2849@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ 49)) (Mul (Mul d14~120@ c14~118@) (Add b14~116@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul b14~116@ c14~118@)) (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b14~116@ d14~120@) (=> (= tmp%31@ (Mul b14~116@ d14~120@)) (=> (= tmp%32@ (Mul b14~116@ c14~118@)) (=> (= tmp%33@ (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ b14~116@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> (= tmp%34@ (Mul d14~120@ b14~116@)) (=> (= tmp%35@ (Mul b14~116@ c14~118@)) (=> (= tmp%36@ (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ b14~116@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ tmp%35@ tmp%36@) (=> %%location_label%%14 (= temp_14_0~2772@ temp_14_1~2849@))))))))))) (=> (= temp_14_0~2772@ temp_14_1~2849@) (=> (= temp_15_0~3002@ (Mul (Mul (Mul (Mul a15~122@ d15~128@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ b15~124@))) (Add (Mul (Sub b15~124@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~3067@ (Mul (Add (Mul (Sub b15~124@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ b15~124@))))) (and (=> (= tmp%37@ (Add (Mul (Sub b15~124@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@)))) (=> (= tmp%38@ (Mul (Mul (Mul a15~122@ d15~128@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ b15~124@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%37@ tmp%38@) (=> %%location_label%%15 (= temp_15_0~3002@ temp_15_1~3067@))))) (=> (= temp_15_0~3002@ temp_15_1~3067@) (=> (= temp_16_0~3200@ (Mul (Mul (Mul (Add a16~130@ b16~132@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Sub a16~130@ b16~132@))) (Add a16~130@ (Mul (Mul d16~136@ b16~132@) c16~134@)))) (=> (= temp_16_1~3257@ (Mul (Mul (Mul (Add a16~130@ b16~132@) (Mul b16~132@ b16~132@)) (Sub (Mul (Mul b16~132@ a16~130@) a16~130@) (Mul (Mul b16~132@ a16~130@) b16~132@))) (Add a16~130@ (Mul (Mul d16~136@ b16~132@) c16~134@)))) (and (=> (= tmp%39@ (Mul b16~132@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%39@ a16~130@ b16~132@) (=> %%location_label%%16 (= temp_16_0~3200@ temp_16_1~3257@)))) (=> (= temp_16_0~3200@ temp_16_1~3257@) (=> (= temp_17_0~3364@ (Mul (Mul (Mul d17~144@ (Mul a17~138@ d17~144@)) (Mul (Sub b17~140@ c17~142@) (Mul c17~142@ a17~138@))) (Sub (Mul (Mul a17~138@ a17~138@) (Mul 40 d17~144@)) (Mul (Sub b17~140@ a17~138@) (Mul b17~140@ a17~138@))))) (=> (= temp_17_1~3437@ (Mul (Mul (Mul d17~144@ (Mul a17~138@ d17~144@)) (Mul (Sub b17~140@ c17~142@) (Mul c17~142@ a17~138@))) (Sub (Mul (Mul 40 d17~144@) (Mul a17~138@ a17~138@)) (Mul (Sub b17~140@ a17~138@) (Mul b17~140@ a17~138@))))) (=> (= tmp%40@ (Mul 40 d17~144@)) (=> (= tmp%41@ (Mul a17~138@ a17~138@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%40@ tmp%41@) (=> %%location_label%%17 (= temp_17_0~3364@ temp_17_1~3437@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
