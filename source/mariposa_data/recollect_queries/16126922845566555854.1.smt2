...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Sub (Sub (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@)) (Sub (Add b0~4@ a0~2@) (Mul a0~2@ a0~2@))) (Sub (Add (Mul a0~2@ c0~6@) (Add d0~8@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~370@ (Sub (Sub (Sub (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@)) (Sub (Add b0~4@ a0~2@) (Mul a0~2@ a0~2@))) (Sub (Add (Mul a0~2@ c0~6@) (Add d0~8@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))))))
(assert %%query%%)
(check-sat)
