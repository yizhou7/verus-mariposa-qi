...
(declare-const temp_4_1~1150@ Int)
(declare-const temp_5_0~1257@ Int)
(declare-const temp_5_1~1330@ Int)
(declare-const temp_6_0~1499@ Int)
(declare-const temp_6_1~1572@ Int)
(declare-const temp_7_0~1689@ Int)
(declare-const temp_7_1~1754@ Int)
(declare-const temp_8_0~1891@ Int)
(declare-const temp_8_1~1940@ Int)
(declare-const temp_9_0~2049@ Int)
...
(declare-const temp_12_1~2674@ Int)
(declare-const temp_13_0~2807@ Int)
(declare-const temp_13_1~2884@ Int)
(declare-const temp_14_0~2948@ Int)
(declare-const temp_14_1~2997@ Int)
(declare-const temp_15_0~3094@ Int)
(declare-const temp_15_1~3155@ Int)
(declare-const temp_16_0~3268@ Int)
(declare-const temp_16_1~3333@ Int)
(declare-const temp_17_0~3474@ Int)
(declare-const temp_17_1~3527@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ d0~8@))) (Mul (Mul (Add c0~6@ b0~4@) (Sub d0~8@ d0~8@)) (Add (Mul d0~8@ b0~4@) d0~8@)))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ d0~8@))) (Mul (Add (Mul d0~8@ b0~4@) d0~8@) (Mul (Add c0~6@ b0~4@) (Sub d0~8@ d0~8@))))) (and (=> (= tmp%1@ (Add (Mul d0~8@ b0~4@) d0~8@)) (=> (= tmp%2@ (Mul (Add c0~6@ b0~4@) (Sub d0~8@ d0~8@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~487@ (Mul (Mul (Mul (Add a1~10@ a1~10@) (Mul 78 d1~16@)) (Mul (Sub d1~16@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Add (Add a1~10@ d1~16@) (Sub d1~16@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Add b1~12@ c1~14@))))) (=> (= temp_1_1~584@ (Mul (Mul (Add (Mul a1~10@ (Mul 78 d1~16@)) (Mul a1~10@ (Mul 78 d1~16@))) (Mul (Sub d1~16@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Add (Add a1~10@ d1~16@) (Sub d1~16@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Add b1~12@ c1~14@))))) (and (=> (= tmp%3@ (Add (Mul a1~10@ (Mul 78 d1~16@)) (Mul a1~10@ (Mul 78 d1~16@)))) (=> (= tmp%4@ (Mul (Sub d1~16@ c1~14@) (Mul a1~10@ a1~10@))) (=> (= tmp%5@ (Mul (Add (Add a1~10@ d1~16@) (Sub d1~16@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Add b1~12@ c1~14@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Mul 78 d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a1~10@ a1~10@ tmp%6@) (=> (= tmp%7@ (Mul (Add a1~10@ a1~10@) (Mul 78 d1~16@))) (=> (= tmp%8@ (Mul (Sub d1~16@ c1~14@) (Mul a1~10@ a1~10@))) (=> (= tmp%9@ (Mul (Add (Add a1~10@ d1~16@) (Sub d1~16@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Add b1~12@ c1~14@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%1 (= temp_1_0~487@ temp_1_1~584@)))))))))))) (=> (= temp_1_0~487@ temp_1_1~584@) (=> (= temp_2_0~827@ (Sub (Sub (Mul (Sub c2~22@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ c2~22@))) (Sub (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ c2~22@)) (Add (Add a2~18@ b2~20@) c2~22@)))) (=> (= temp_2_1~888@ (Sub (Sub (Mul (Sub c2~22@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@))) (Sub (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ c2~22@)) (Add (Add a2~18@ b2~20@) c2~22@)))) (and (=> (= tmp%10@ (Mul b2~20@ c2~22@)) (=> (= tmp%11@ (Mul d2~24@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%2 (= temp_2_0~827@ temp_2_1~888@))))) (=> (= temp_2_0~827@ temp_2_1~888@) (=> (= temp_3_0~969@ (Mul (Sub (Mul (Mul a3~26@ c3~30@) (Add a3~26@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Mul d3~32@ b3~28@))) (Mul d3~32@ (Mul c3~30@ b3~28@)))) (=> (= temp_3_1~1014@ (Mul (Sub (Mul (Mul a3~26@ c3~30@) (Add a3~26@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Mul d3~32@ b3~28@))) (Mul (Mul d3~32@ c3~30@) b3~28@))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. d3~32@ c3~30@ b3~28@) (=> %%location_label%%3 (= temp_3_0~969@ temp_3_1~1014@))) (=> (= temp_3_0~969@ temp_3_1~1014@) (=> (= temp_4_0~1097@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Add b4~36@ a4~34@)) (Mul (Sub d4~40@ a4~34@) (Mul c4~38@ c4~38@))) (Mul b4~36@ (Add (Sub d4~40@ c4~38@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~1150@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Add b4~36@ a4~34@)) (Mul (Mul (Sub d4~40@ a4~34@) c4~38@) c4~38@)) (Mul b4~36@ (Add (Sub d4~40@ c4~38@) (Mul b4~36@ d4~40@))))) (and (=> (= tmp%12@ (Sub d4~40@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ c4~38@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1097@ temp_4_1~1150@)))) (=> (= temp_4_0~1097@ temp_4_1~1150@) (=> (= temp_5_0~1257@ (Add (Mul (Add (Add 85 b5~44@) (Add c5~46@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Mul (Sub b5~44@ b5~44@) c5~46@) (Mul (Mul a5~42@ c5~46@) (Add a5~42@ d5~48@))))) (=> (= temp_5_1~1330@ (Add (Mul (Add (Add 85 b5~44@) (Add c5~46@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Sub b5~44@ b5~44@) c5~46@) (Mul (Mul a5~42@ c5~46@) (Add a5~42@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ b5~44@) (=> (= tmp%13@ (Add (Add 85 b5~44@) (Add c5~46@ a5~42@))) (=> (= tmp%14@ (Mul c5~46@ c5~46@)) (=> (= tmp%15@ (Mul c5~46@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> (= tmp%16@ (Add (Add 85 b5~44@) (Add c5~46@ a5~42@))) (=> (= tmp%17@ (Mul c5~46@ c5~46@)) (=> (= tmp%18@ (Mul b5~44@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%5 (= temp_5_0~1257@ temp_5_1~1330@))))))))))) (=> (= temp_5_0~1257@ temp_5_1~1330@) (=> (= temp_6_0~1499@ (Mul (Mul (Mul (Sub d6~56@ d6~56@) (Mul d6~56@ 8)) (Mul a6~50@ (Add b6~52@ c6~54@))) (Mul (Add (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Sub a6~50@ d6~56@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1572@ (Mul (Mul (Mul (Sub d6~56@ d6~56@) (Mul d6~56@ 8)) (Mul a6~50@ (Add b6~52@ c6~54@))) (Mul (Mul (Sub a6~50@ d6~56@) (Mul d6~56@ d6~56@)) (Add (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@))))) (and (=> (= tmp%19@ (Mul (Sub a6~50@ d6~56@) (Mul d6~56@ d6~56@))) (=> (= tmp%20@ (Add (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%6 (= temp_6_0~1499@ temp_6_1~1572@))))) (=> (= temp_6_0~1499@ temp_6_1~1572@) (=> (= temp_7_0~1689@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1754@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ c7~62@) (=> (= tmp%21@ (Mul b7~60@ c7~62@)) (=> (= tmp%22@ (Mul b7~60@ d7~64@)) (=> (= tmp%23@ (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> (= tmp%24@ (Mul c7~62@ b7~60@)) (=> (= tmp%25@ (Mul b7~60@ d7~64@)) (=> (= tmp%26@ (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%7 (= temp_7_0~1689@ temp_7_1~1754@))))))))))) (=> (= temp_7_0~1689@ temp_7_1~1754@) (=> (= temp_8_0~1891@ (Mul (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ d8~72@)) b8~68@) (Mul (Mul (Mul a8~66@ b8~68@) (Add b8~68@ b8~68@)) (Mul a8~66@ (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1940@ (Mul (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ d8~72@)) b8~68@) (Mul (Mul a8~66@ (Mul a8~66@ c8~70@)) (Mul (Mul a8~66@ b8~68@) (Add b8~68@ b8~68@))))) (and (=> (= tmp%27@ (Mul a8~66@ (Mul a8~66@ c8~70@))) (=> (= tmp%28@ (Mul (Mul a8~66@ b8~68@) (Add b8~68@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%8 (= temp_8_0~1891@ temp_8_1~1940@))))) (=> (= temp_8_0~1891@ temp_8_1~1940@) (=> (= temp_9_0~2049@ (Mul (Mul (Mul b9~76@ (Mul d9~80@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ c9~78@))) (Add (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ d9~80@))))) (=> (= temp_9_1~2110@ (Mul (Mul (Mul b9~76@ (Mul d9~80@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ c9~78@))) (Add (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ c9~78@) (=> %%location_label%%9 (= temp_9_0~2049@ temp_9_1~2110@))) (=> (= temp_9_0~2049@ temp_9_1~2110@) (=> (= temp_10_0~2199@ (Add (Mul (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ b10~84@)) (Mul c10~86@ (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~2260@ (Add (Mul (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ b10~84@)) c10~86@) (Mul a10~82@ c10~86@)))) (and (=> (= tmp%29@ (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ b10~84@))) (=> (= tmp%30@ (Mul a10~82@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ c10~86@ tmp%30@) (=> %%location_label%%10 (= temp_10_0~2199@ temp_10_1~2260@))))) (=> (= temp_10_0~2199@ temp_10_1~2260@) (=> (= temp_11_0~2371@ (Mul (Mul (Sub (Mul a11~90@ 12) (Sub b11~92@ d11~96@)) (Sub (Mul d11~96@ c11~94@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) d11~96@))) (=> (= temp_11_1~2436@ (Mul (Mul (Sub (Mul 12 a11~90@) (Sub b11~92@ d11~96@)) (Sub (Mul d11~96@ c11~94@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) d11~96@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 12 a11~90@) (=> (= tmp%31@ (Sub (Mul 12 a11~90@) (Sub b11~92@ d11~96@))) (=> (= tmp%32@ (Sub (Mul d11~96@ c11~94@) (Mul d11~96@ b11~92@))) (=> (= tmp%33@ (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> (= tmp%34@ (Sub (Mul a11~90@ 12) (Sub b11~92@ d11~96@))) (=> (= tmp%35@ (Sub (Mul d11~96@ c11~94@) (Mul d11~96@ b11~92@))) (=> (= tmp%36@ (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ tmp%35@ tmp%36@) (=> %%location_label%%11 (= temp_11_0~2371@ temp_11_1~2436@))))))))))) (=> (= temp_11_0~2371@ temp_11_1~2436@) (=> (= temp_12_0~2625@ (Sub (Mul (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ d12~104@))) (Mul (Mul (Mul c12~102@ a12~98@) a12~98@) b12~100@))) (=> (= temp_12_1~2674@ (Sub (Mul (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ d12~104@))) (Mul (Mul (Mul a12~98@ c12~102@) a12~98@) b12~100@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a12~98@ c12~102@) (=> (= tmp%37@ (Mul a12~98@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%37@ a12~98@ b12~100@) (=> (= tmp%38@ (Mul c12~102@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ a12~98@ b12~100@) (=> %%location_label%%12 (= temp_12_0~2625@ temp_12_1~2674@))))))) (=> (= temp_12_0~2625@ temp_12_1~2674@) (=> (= temp_13_0~2807@ (Add (Sub 69 (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul 3 b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ c13~110@))))) (=> (= temp_13_1~2884@ (Add (Sub 69 (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul 3 b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ c13~110@))))) (=> (= tmp%39@ (= temp_13_0~2807@ temp_13_1~2884@)) (and (=> %%location_label%%13 tmp%39@) (=> tmp%39@ (=> (= temp_14_0~2948@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ b14~116@))) (Mul (Mul (Mul b14~116@ d14~120@) a14~114@) c14~118@))) (=> (= temp_14_1~2997@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (Mul (Mul b14~116@ b14~116@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) a14~114@) c14~118@))) (and (=> (= tmp%40@ (Mul b14~116@ b14~116@)) (=> (= tmp%41@ (Mul a14~114@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%40@ tmp%41@) (=> %%location_label%%14 (= temp_14_0~2948@ temp_14_1~2997@))))) (=> (= temp_14_0~2948@ temp_14_1~2997@) (=> (= temp_15_0~3094@ (Mul (Mul (Mul (Mul b15~124@ c15~126@) (Sub b15~124@ c15~126@)) (Mul d15~128@ (Mul c15~126@ d15~128@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~3155@ (Mul (Mul (Mul d15~128@ (Mul c15~126@ d15~128@)) (Mul (Mul b15~124@ c15~126@) (Sub b15~124@ c15~126@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul d15~128@ d15~128@))))) (and (=> (= tmp%42@ (Mul d15~128@ (Mul c15~126@ d15~128@))) (=> (= tmp%43@ (Mul (Mul b15~124@ c15~126@) (Sub b15~124@ c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%42@ tmp%43@) (=> %%location_label%%15 (= temp_15_0~3094@ temp_15_1~3155@))))) (=> (= temp_15_0~3094@ temp_15_1~3155@) (=> (= temp_16_0~3268@ (Mul (Mul (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul b16~132@ c16~134@))) (Mul (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@))))) (=> (= temp_16_1~3333@ (Mul (Mul (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@))) (Mul (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c16~134@ b16~132@) (=> (= tmp%44@ (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@))) (=> (= tmp%45@ (Mul b16~132@ d16~136@)) (=> (= tmp%46@ (Mul c16~134@ b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%44@ tmp%45@ tmp%46@) (=> (= tmp%47@ (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@))) (=> (= tmp%48@ (Mul b16~132@ d16~136@)) (=> (= tmp%49@ (Mul b16~132@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%47@ tmp%48@ tmp%49@) (=> %%location_label%%16 (= temp_16_0~3268@ temp_16_1~3333@))))))))))) (=> (= temp_16_0~3268@ temp_16_1~3333@) (=> (= temp_17_0~3474@ (Mul (Sub (Mul (Mul c17~142@ c17~142@) (Add d17~144@ b17~140@)) (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul b17~140@ a17~138@) (Sub b17~140@ c17~142@)) b17~140@))) (=> (= temp_17_1~3527@ (Mul (Sub (Mul (Mul c17~142@ c17~142@) (Add d17~144@ b17~140@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul b17~140@ a17~138@) (Sub b17~140@ c17~142@)) b17~140@))) (=> (= tmp%50@ (Mul b17~140@ d17~144@)) (=> (= tmp%51@ (Mul b17~140@ c17~142@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%50@ tmp%51@) (=> %%location_label%%17 (= temp_17_0~3474@ temp_17_1~3527@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
