...
(declare-const temp_3_0~745@ Int)
(declare-const temp_3_1~806@ Int)
(declare-const temp_4_0~919@ Int)
(declare-const temp_4_1~980@ Int)
(declare-const temp_5_0~1193@ Int)
(declare-const temp_5_1~1266@ Int)
(declare-const temp_6_0~1365@ Int)
(declare-const temp_6_1~1430@ Int)
(declare-const temp_7_0~1543@ Int)
(declare-const temp_7_1~1604@ Int)
(declare-const temp_8_0~1703@ Int)
(declare-const temp_8_1~1768@ Int)
(declare-const temp_9_0~1829@ Int)
(declare-const temp_9_1~1862@ Int)
(declare-const temp_10_0~2003@ Int)
(declare-const temp_10_1~2064@ Int)
(declare-const temp_11_0~2181@ Int)
(declare-const temp_11_1~2270@ Int)
(declare-const temp_12_0~2363@ Int)
(declare-const temp_12_1~2424@ Int)
(declare-const temp_13_0~2645@ Int)
(declare-const temp_13_1~2722@ Int)
(declare-const temp_14_0~2955@ Int)
(declare-const temp_14_1~3028@ Int)
(declare-const temp_15_0~3141@ Int)
(declare-const temp_15_1~3206@ Int)
(declare-const temp_16_0~3407@ Int)
(declare-const temp_16_1~3456@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Sub (Mul (Add (Mul c0~6@ c0~6@) (Add c0~6@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) d0~8@) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~362@ (Sub (Mul (Mul (Add (Mul c0~6@ c0~6@) (Add c0~6@ b0~4@)) (Mul a0~2@ b0~4@)) (Mul d0~8@ c0~6@)) (Mul (Mul (Mul c0~6@ a0~2@) d0~8@) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@))))) (and (=> (= tmp%1@ (Add (Mul c0~6@ c0~6@) (Add c0~6@ b0~4@))) (=> (= tmp%2@ (Mul a0~2@ b0~4@)) (=> (= tmp%3@ (Mul d0~8@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@)))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~473@ (Mul (Sub (Mul c1~14@ (Mul c1~14@ d1~16@)) (Mul (Sub c1~14@ d1~16@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ b1~12@))))) (=> (= temp_1_1~534@ (Mul (Sub (Mul c1~14@ (Mul c1~14@ d1~16@)) (Mul (Sub c1~14@ d1~16@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@)) (Mul d1~16@ d1~16@)) (Mul a1~10@ b1~12@)))) (and (=> (= tmp%4@ (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@))) (=> (= tmp%5@ (Mul d1~16@ d1~16@)) (=> (= tmp%6@ (Mul a1~10@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%1 (= temp_1_0~473@ temp_1_1~534@)))))) (=> (= temp_1_0~473@ temp_1_1~534@) (=> (= temp_2_0~617@ (Sub (Mul (Mul c2~22@ (Add a2~18@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ d2~24@))) c2~22@)) (=> (= temp_2_1~650@ (Sub (Mul (Mul c2~22@ (Add a2~18@ b2~20@)) (Mul (Mul (Mul c2~22@ a2~18@) b2~20@) d2~24@)) c2~22@)) (and (=> (= tmp%7@ (Mul c2~22@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ b2~20@ d2~24@) (=> %%location_label%%2 (= temp_2_0~617@ temp_2_1~650@)))) (=> (= temp_2_0~617@ temp_2_1~650@) (=> (= temp_3_0~745@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@)) (Mul a3~26@ (Mul d3~32@ a3~26@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ b3~28@))))) (=> (= temp_3_1~806@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@)) (Mul a3~26@ (Mul d3~32@ a3~26@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@))))) (and (=> (= tmp%8@ (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ b3~28@))) (=> (= tmp%9@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%3 (= temp_3_0~745@ temp_3_1~806@))))) (=> (= temp_3_0~745@ temp_3_1~806@) (=> (= temp_4_0~919@ (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Mul d4~40@ d4~40@) d4~40@)))) (=> (= temp_4_1~980@ (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@)) (Mul d4~40@ (Mul d4~40@ d4~40@))))) (and (=> (= tmp%10@ (Mul d4~40@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ tmp%10@) (=> (= tmp%11@ (Mul (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ b4~36@)))) (=> (= tmp%12@ (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@))) (=> (= tmp%13@ (Mul d4~40@ (Mul d4~40@ d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> (= tmp%14@ (Mul (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ b4~36@)))) (=> (= tmp%15@ (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@))) (=> (= tmp%16@ (Mul (Mul d4~40@ d4~40@) d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%4 (= temp_4_0~919@ temp_4_1~980@)))))))))))) (=> (= temp_4_0~919@ temp_4_1~980@) (=> (= temp_5_0~1193@ (Mul (Mul (Add (Add d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Sub (Add c5~46@ b5~44@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul d5~48@ b5~44@) (Add b5~44@ a5~42@)) (Sub (Sub a5~42@ d5~48@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1266@ (Mul (Mul (Add (Add d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Sub (Add c5~46@ b5~44@) (Mul a5~42@ d5~48@))) (Mul (Add (Mul (Mul d5~48@ b5~44@) b5~44@) (Mul (Mul d5~48@ b5~44@) a5~42@)) (Sub (Sub a5~42@ d5~48@) (Mul a5~42@ d5~48@))))) (and (=> (= tmp%17@ (Mul d5~48@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%17@ b5~44@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1193@ temp_5_1~1266@)))) (=> (= temp_5_0~1193@ temp_5_1~1266@) (=> (= temp_6_0~1365@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) (Sub (Mul c6~54@ b6~52@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1430@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) (Sub (Mul c6~54@ b6~52@) (Mul d6~56@ c6~54@))))) (and (=> (= tmp%18@ (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ b6~52@))) (=> (= tmp%19@ (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%6 (= temp_6_0~1365@ temp_6_1~1430@))))) (=> (= temp_6_0~1365@ temp_6_1~1430@) (=> (= temp_7_0~1543@ (Mul (Mul (Mul a7~58@ (Add b7~60@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Add (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1604@ (Mul (Mul (Mul a7~58@ (Add b7~60@ b7~60@)) (Mul d7~64@ (Mul d7~64@ (Mul a7~58@ d7~64@)))) (Mul (Add (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ c7~62@))))) (and (=> (= tmp%20@ (Mul a7~58@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d7~64@ d7~64@ tmp%20@) (=> %%location_label%%7 (= temp_7_0~1543@ temp_7_1~1604@)))) (=> (= temp_7_0~1543@ temp_7_1~1604@) (=> (= temp_8_0~1703@ (Add (Mul (Mul (Add b8~68@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@)) (Sub (Mul c8~70@ a8~66@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1768@ (Add (Mul (Mul (Add b8~68@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@)) (Sub (Mul c8~70@ a8~66@) (Mul a8~66@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1703@ temp_8_1~1768@))) (=> (= temp_8_0~1703@ temp_8_1~1768@) (=> (= temp_9_0~1829@ (Sub (Mul (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ a9~74@)) (Mul b9~76@ (Mul b9~76@ a9~74@))) d9~80@)) (=> (= temp_9_1~1862@ (Sub (Mul (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ a9~74@)) (Mul b9~76@ (Mul b9~76@ a9~74@))) d9~80@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a9~74@ c9~78@) (=> (= tmp%21@ (Mul a9~74@ c9~78@)) (=> (= tmp%22@ (Mul b9~76@ a9~74@)) (=> (= tmp%23@ (Mul b9~76@ (Mul b9~76@ a9~74@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> (= tmp%24@ (Mul c9~78@ a9~74@)) (=> (= tmp%25@ (Mul b9~76@ a9~74@)) (=> (= tmp%26@ (Mul b9~76@ (Mul b9~76@ a9~74@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%9 (= temp_9_0~1829@ temp_9_1~1862@))))))))))) (=> (= temp_9_0~1829@ temp_9_1~1862@) (=> (= temp_10_0~2003@ (Mul (Mul (Mul (Sub c10~86@ c10~86@) a10~82@) (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@))) (Sub (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ b10~84@)) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~2064@ (Mul (Mul (Mul (Sub c10~86@ c10~86@) a10~82@) (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@))) (Sub (Mul (Mul a10~82@ b10~84@) (Mul b10~84@ b10~84@)) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a10~82@ b10~84@) (=> %%location_label%%10 (= temp_10_0~2003@ temp_10_1~2064@))) (=> (= temp_10_0~2003@ temp_10_1~2064@) (=> (= temp_11_0~2181@ (Sub (Add (Mul c11~94@ (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ d11~96@) c11~94@)) (Add (Sub (Mul 67 a11~90@) (Mul 97 b11~92@)) (Mul 22 (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2270@ (Sub (Add (Mul (Mul a11~90@ c11~94@) c11~94@) (Mul (Mul a11~90@ d11~96@) c11~94@)) (Add (Sub (Mul 67 a11~90@) (Mul 97 b11~92@)) (Mul 22 (Mul d11~96@ b11~92@))))) (and (=> (= tmp%27@ (Mul a11~90@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ c11~94@) (=> %%location_label%%11 (= temp_11_0~2181@ temp_11_1~2270@)))) (=> (= temp_11_0~2181@ temp_11_1~2270@) (=> (= temp_12_0~2363@ (Mul (Mul (Add (Mul d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Sub d12~104@ b12~100@) (Add a12~98@ b12~100@))) (Mul (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ d12~104@)) (Mul c12~102@ (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2424@ (Mul (Mul (Add (Mul d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Sub d12~104@ b12~100@) (Add a12~98@ b12~100@))) (Mul (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ d12~104@)) (Mul c12~102@ (Mul a12~98@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a12~98@ b12~100@) (=> (= tmp%28@ (Mul (Add (Mul d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Sub d12~104@ b12~100@) (Add a12~98@ b12~100@)))) (=> (= tmp%29@ (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ d12~104@))) (=> (= tmp%30@ (Mul c12~102@ (Mul a12~98@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> (= tmp%31@ (Mul (Add (Mul d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Sub d12~104@ b12~100@) (Add a12~98@ b12~100@)))) (=> (= tmp%32@ (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ d12~104@))) (=> (= tmp%33@ (Mul c12~102@ (Mul b12~100@ a12~98@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> %%location_label%%12 (= temp_12_0~2363@ temp_12_1~2424@))))))))))) (=> (= temp_12_0~2363@ temp_12_1~2424@) (=> (= temp_13_0~2645@ (Mul (Sub (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ c13~110@)) (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ a13~106@))) (Mul (Mul (Mul c13~110@ b13~108@) (Add b13~108@ c13~110@)) (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ 39))))) (=> (= temp_13_1~2722@ (Mul (Sub (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ c13~110@)) (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ a13~106@))) (Mul (Mul (Mul c13~110@ b13~108@) (Add b13~108@ c13~110@)) (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ 39))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d13~112@ b13~108@) (=> (= tmp%34@ (Sub (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ c13~110@)) (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ a13~106@)))) (=> (= tmp%35@ (Mul (Mul c13~110@ b13~108@) (Add b13~108@ c13~110@))) (=> (= tmp%36@ (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ 39))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ tmp%35@ tmp%36@) (=> (= tmp%37@ (Sub (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ c13~110@)) (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ a13~106@)))) (=> (= tmp%38@ (Mul (Mul c13~110@ b13~108@) (Add b13~108@ c13~110@))) (=> (= tmp%39@ (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ 39))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%37@ tmp%38@ tmp%39@) (=> %%location_label%%13 (= temp_13_0~2645@ temp_13_1~2722@))))))))))) (=> (= temp_13_0~2645@ temp_13_1~2722@) (=> (= temp_14_0~2955@ (Sub (Mul (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Add d14~120@ 15) (Add b14~116@ d14~120@))) (Mul (Sub (Mul a14~114@ b14~116@) (Mul b14~116@ c14~118@)) (Mul a14~114@ (Mul a14~114@ a14~114@))))) (=> (= temp_14_1~3028@ (Sub (Mul (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Add d14~120@ 15) (Add b14~116@ d14~120@))) (Mul (Mul a14~114@ (Mul a14~114@ a14~114@)) (Sub (Mul a14~114@ b14~116@) (Mul b14~116@ c14~118@))))) (and (=> (= tmp%40@ (Mul a14~114@ (Mul a14~114@ a14~114@))) (=> (= tmp%41@ (Sub (Mul a14~114@ b14~116@) (Mul b14~116@ c14~118@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%40@ tmp%41@) (=> %%location_label%%14 (= temp_14_0~2955@ temp_14_1~3028@))))) (=> (= temp_14_0~2955@ temp_14_1~3028@) (=> (= temp_15_0~3141@ (Mul (Mul (Mul (Add a15~122@ a15~122@) (Mul a15~122@ a15~122@)) (Mul (Add a15~122@ a15~122@) (Sub b15~124@ d15~128@))) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ d15~128@)) (Add (Mul a15~122@ d15~128@) (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~3206@ (Mul (Mul (Mul (Add a15~122@ a15~122@) (Mul a15~122@ a15~122@)) (Mul (Add a15~122@ a15~122@) (Sub b15~124@ d15~128@))) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ d15~128@)) (Add (Mul a15~122@ d15~128@) (Mul a15~122@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a15~122@ c15~126@) (=> (= tmp%42@ (Mul (Mul (Add a15~122@ a15~122@) (Mul a15~122@ a15~122@)) (Mul (Add a15~122@ a15~122@) (Sub b15~124@ d15~128@)))) (=> (= tmp%43@ (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ d15~128@))) (=> (= tmp%44@ (Add (Mul a15~122@ d15~128@) (Mul a15~122@ c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%42@ tmp%43@ tmp%44@) (=> (= tmp%45@ (Mul (Mul (Add a15~122@ a15~122@) (Mul a15~122@ a15~122@)) (Mul (Add a15~122@ a15~122@) (Sub b15~124@ d15~128@)))) (=> (= tmp%46@ (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ d15~128@))) (=> (= tmp%47@ (Add (Mul a15~122@ d15~128@) (Mul c15~126@ a15~122@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%45@ tmp%46@ tmp%47@) (=> %%location_label%%15 (= temp_15_0~3141@ temp_15_1~3206@))))))))))) (=> (= temp_15_0~3141@ temp_15_1~3206@) (=> (= temp_16_0~3407@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ a16~130@)) d16~136@) (Mul (Mul (Mul a16~130@ c16~134@) (Add b16~132@ b16~132@)) (Mul c16~134@ (Mul d16~136@ d16~136@))))) (=> (= temp_16_1~3456@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ a16~130@)) d16~136@) (Mul (Mul c16~134@ (Mul d16~136@ d16~136@)) (Mul (Mul a16~130@ c16~134@) (Add b16~132@ b16~132@))))) (=> (= tmp%48@ (Mul c16~134@ (Mul d16~136@ d16~136@))) (=> (= tmp%49@ (Mul (Mul a16~130@ c16~134@) (Add b16~132@ b16~132@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%48@ tmp%49@) (=> %%location_label%%16 (= temp_16_0~3407@ temp_16_1~3456@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
