...
(declare-const temp_2_1~826@ Int)
(declare-const temp_3_0~915@ Int)
(declare-const temp_3_1~976@ Int)
(declare-const temp_4_0~1095@ Int)
(declare-const temp_4_1~1180@ Int)
(declare-const temp_5_0~1287@ Int)
(declare-const temp_5_1~1344@ Int)
(declare-const temp_6_0~1437@ Int)
(declare-const temp_6_1~1502@ Int)
(declare-const temp_7_0~1613@ Int)
(declare-const temp_7_1~1674@ Int)
(declare-const temp_8_0~1885@ Int)
(declare-const temp_8_1~1978@ Int)
(declare-const temp_9_0~2117@ Int)
(declare-const temp_9_1~2178@ Int)
(declare-const temp_10_0~2267@ Int)
(declare-const temp_10_1~2328@ Int)
(declare-const temp_11_0~2404@ Int)
(declare-const temp_11_1~2465@ Int)
(declare-const temp_12_0~2568@ Int)
(declare-const temp_12_1~2621@ Int)
(declare-const temp_13_0~2744@ Int)
(declare-const temp_13_1~2825@ Int)
(declare-const temp_14_0~2960@ Int)
(declare-const temp_14_1~3025@ Int)
(declare-const temp_15_0~3136@ Int)
(declare-const temp_15_1~3197@ Int)
(declare-const temp_16_0~3368@ Int)
(declare-const temp_16_1~3405@ Int)
(declare-const temp_17_0~3514@ Int)
(declare-const temp_17_1~3587@ Int)
(declare-const temp_18_0~3706@ Int)
(declare-const temp_18_1~3743@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Add (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)) (Sub (Sub c0~6@ 51) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~394@ (Mul (Mul (Add (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)) (Sub (Sub c0~6@ 51) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ a0~2@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~487@ (Mul (Mul (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Add d1~16@ b1~12@))) (Mul (Mul (Sub d1~16@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~552@ (Mul (Mul (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Add d1~16@ b1~12@))) (Mul (Mul (Sub d1~16@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ c1~14@))))) (and (=> (= tmp%1@ (Mul c1~14@ a1~10@)) (=> (= tmp%2@ (Mul a1~10@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> (= tmp%3@ (Mul (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Add d1~16@ b1~12@)))) (=> (= tmp%4@ (Mul (Sub d1~16@ d1~16@) (Mul d1~16@ b1~12@))) (=> (= tmp%5@ (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Mul (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Add d1~16@ b1~12@)))) (=> (= tmp%7@ (Mul (Sub d1~16@ d1~16@) (Mul d1~16@ b1~12@))) (=> (= tmp%8@ (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%1 (= temp_1_0~487@ temp_1_1~552@))))))))))))) (=> (= temp_1_0~487@ temp_1_1~552@) (=> (= temp_2_0~769@ (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Add b2~20@ b2~20@)) (Mul (Sub c2~22@ b2~20@) (Add d2~24@ d2~24@))) (Mul (Sub c2~22@ (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ d2~24@) b2~20@)))) (=> (= temp_2_1~826@ (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Add b2~20@ b2~20@)) (Mul (Sub c2~22@ b2~20@) (Add d2~24@ d2~24@))) (Mul (Sub c2~22@ (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ d2~24@) b2~20@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ d2~24@) (=> %%location_label%%2 (= temp_2_0~769@ temp_2_1~826@))) (=> (= temp_2_0~769@ temp_2_1~826@) (=> (= temp_3_0~915@ (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ d3~32@) c3~30@)))) (=> (= temp_3_1~976@ (Mul (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@)) (Mul c3~30@ a3~26@)) (Mul b3~28@ c3~30@)) (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ d3~32@) c3~30@)))) (and (=> (= tmp%9@ (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@))) (=> (= tmp%10@ (Mul c3~30@ a3~26@)) (=> (= tmp%11@ (Mul b3~28@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%3 (= temp_3_0~915@ temp_3_1~976@)))))) (=> (= temp_3_0~915@ temp_3_1~976@) (=> (= temp_4_0~1095@ (Mul (Mul (Mul (Mul d4~40@ d4~40@) d4~40@) (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ b4~36@)) (Add 81 (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~1180@ (Mul (Mul (Mul (Mul d4~40@ d4~40@) d4~40@) (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@))) (Add (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ b4~36@)) 81) (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ b4~36@)) (Mul b4~36@ b4~36@))))) (and (=> (= tmp%12@ (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ b4~36@))) (=> (= tmp%13@ (Mul b4~36@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%12@ 81 tmp%13@) (=> %%location_label%%4 (= temp_4_0~1095@ temp_4_1~1180@))))) (=> (= temp_4_0~1095@ temp_4_1~1180@) (=> (= temp_5_0~1287@ (Mul (Mul (Sub (Sub d5~48@ d5~48@) c5~46@) (Mul (Mul c5~46@ b5~44@) (Add a5~42@ a5~42@))) (Mul (Add (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@)) (Mul (Mul c5~46@ d5~48@) a5~42@)))) (=> (= temp_5_1~1344@ (Mul (Mul (Sub (Sub d5~48@ d5~48@) c5~46@) (Mul (Mul c5~46@ b5~44@) (Add a5~42@ a5~42@))) (Mul (Add (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ d5~48@) a5~42@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ d5~48@) (=> %%location_label%%5 (= temp_5_0~1287@ temp_5_1~1344@))) (=> (= temp_5_0~1287@ temp_5_1~1344@) (=> (= temp_6_0~1437@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@)) (Add (Sub c6~54@ a6~50@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@)) (Add (Mul d6~56@ a6~50@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1502@ (Mul (Mul (Mul a6~50@ a6~50@) (Mul (Mul b6~52@ d6~56@) (Add (Sub c6~54@ a6~50@) (Mul d6~56@ c6~54@)))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@)) (Add (Mul d6~56@ a6~50@) (Mul c6~54@ b6~52@))))) (and (=> (= tmp%14@ (Mul a6~50@ a6~50@)) (=> (= tmp%15@ (Mul b6~52@ d6~56@)) (=> (= tmp%16@ (Add (Sub c6~54@ a6~50@) (Mul d6~56@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%6 (= temp_6_0~1437@ temp_6_1~1502@)))))) (=> (= temp_6_0~1437@ temp_6_1~1502@) (=> (= temp_7_0~1613@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@))) (Add (Mul (Sub d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Mul b7~60@ (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1674@ (Mul (Mul (Mul (Mul (Mul b7~60@ b7~60@) a7~58@) b7~60@) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@))) (Add (Mul (Sub d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Mul b7~60@ (Mul d7~64@ d7~64@))))) (and (=> (= tmp%17@ (Mul (Mul (Mul b7~60@ b7~60@) a7~58@) b7~60@)) (=> (= tmp%18@ (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@))) (=> (= tmp%19@ (Add (Mul (Sub d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Mul b7~60@ (Mul d7~64@ d7~64@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> (= tmp%20@ (Mul b7~60@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ a7~58@ b7~60@) (=> (= tmp%21@ (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@))) (=> (= tmp%22@ (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@))) (=> (= tmp%23@ (Add (Mul (Sub d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Mul b7~60@ (Mul d7~64@ d7~64@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%7 (= temp_7_0~1613@ temp_7_1~1674@)))))))))))) (=> (= temp_7_0~1613@ temp_7_1~1674@) (=> (= temp_8_0~1885@ (Mul (Sub (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@))) (Sub (Mul (Mul d8~72@ b8~68@) (Sub c8~70@ d8~72@)) (Sub d8~72@ (Add d8~72@ c8~70@))))) (=> (= temp_8_1~1978@ (Sub (Mul (Sub (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@))) (Mul (Mul d8~72@ b8~68@) (Sub c8~70@ d8~72@))) (Mul (Sub (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@))) (Sub d8~72@ (Add d8~72@ c8~70@))))) (and (=> (= tmp%24@ (Sub (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@)))) (=> (= tmp%25@ (Mul (Mul d8~72@ b8~68@) (Sub c8~70@ d8~72@))) (=> (= tmp%26@ (Sub d8~72@ (Add d8~72@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%8 (= temp_8_0~1885@ temp_8_1~1978@)))))) (=> (= temp_8_0~1885@ temp_8_1~1978@) (=> (= temp_9_0~2117@ (Sub (Add (Mul (Mul d9~80@ d9~80@) c9~78@) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ d9~80@))) (Mul (Mul (Add a9~74@ a9~74@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Add d9~80@ a9~74@))))) (=> (= temp_9_1~2178@ (Sub (Add (Mul (Mul d9~80@ d9~80@) c9~78@) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ d9~80@))) (Mul (Mul (Add a9~74@ a9~74@) (Mul a9~74@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Add d9~80@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c9~78@ a9~74@) (=> %%location_label%%9 (= temp_9_0~2117@ temp_9_1~2178@))) (=> (= temp_9_0~2117@ temp_9_1~2178@) (=> (= temp_10_0~2267@ (Mul (Mul (Mul a10~82@ (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ c10~86@))) (Sub (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@)) (Mul (Add b10~84@ b10~84@) (Mul c10~86@ c10~86@))))) (=> (= temp_10_1~2328@ (Mul (Mul (Mul a10~82@ (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ c10~86@))) (Sub (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@)) (Mul (Add b10~84@ b10~84@) (Mul c10~86@ c10~86@))))) (=> (= tmp%27@ (= temp_10_0~2267@ temp_10_1~2328@)) (and (=> %%location_label%%10 tmp%27@) (=> tmp%27@ (=> (= temp_11_0~2404@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) a11~90@) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Sub c11~94@ a11~90@) (Mul a11~90@ d11~96@)) (Mul (Mul d11~96@ d11~96@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2465@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) a11~90@) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Sub c11~94@ a11~90@) (Mul (Mul a11~90@ d11~96@) (Mul (Mul d11~96@ d11~96@) (Mul b11~92@ a11~90@)))))) (and (=> (= tmp%28@ (Sub c11~94@ a11~90@)) (=> (= tmp%29@ (Mul a11~90@ d11~96@)) (=> (= tmp%30@ (Mul (Mul d11~96@ d11~96@) (Mul b11~92@ a11~90@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%11 (= temp_11_0~2404@ temp_11_1~2465@)))))) (=> (= temp_11_0~2404@ temp_11_1~2465@) (=> (= temp_12_0~2568@ (Mul (Sub (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ c12~102@)) a12~98@) (Mul (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ b12~100@)) (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ b12~100@))))) (=> (= temp_12_1~2621@ (Mul (Mul (Sub (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ c12~102@)) a12~98@) (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ b12~100@))) (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ b12~100@)))) (and (=> (= tmp%31@ (Sub (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ c12~102@)) a12~98@)) (=> (= tmp%32@ (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ b12~100@))) (=> (= tmp%33@ (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> %%location_label%%12 (= temp_12_0~2568@ temp_12_1~2621@)))))) (=> (= temp_12_0~2568@ temp_12_1~2621@) (=> (= temp_13_0~2744@ (Mul (Add (Mul b13~108@ (Mul b13~108@ a13~106@)) (Sub (Mul d13~112@ c13~110@) d13~112@)) (Mul (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@)) (Mul a13~106@ (Sub d13~112@ d13~112@))))) (=> (= temp_13_1~2825@ (Add (Mul (Mul b13~108@ (Mul b13~108@ a13~106@)) (Mul (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@)) (Mul a13~106@ (Sub d13~112@ d13~112@)))) (Mul (Sub (Mul d13~112@ c13~110@) d13~112@) (Mul (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@)) (Mul a13~106@ (Sub d13~112@ d13~112@)))))) (and (=> (= tmp%34@ (Mul b13~108@ (Mul b13~108@ a13~106@))) (=> (= tmp%35@ (Sub (Mul d13~112@ c13~110@) d13~112@)) (=> (= tmp%36@ (Mul (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@)) (Mul a13~106@ (Sub d13~112@ d13~112@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%34@ tmp%35@ tmp%36@) (=> %%location_label%%13 (= temp_13_0~2744@ temp_13_1~2825@)))))) (=> (= temp_13_0~2744@ temp_13_1~2825@) (=> (= temp_14_0~2960@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ a14~114@)) (Add (Add c14~118@ c14~118@) (Mul a14~114@ b14~116@))) (Mul (Mul (Mul b14~116@ c14~118@) (Add c14~118@ d14~120@)) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@))))) (=> (= temp_14_1~3025@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ a14~114@)) (Add (Add c14~118@ c14~118@) (Mul a14~114@ b14~116@))) (Mul (Mul b14~116@ c14~118@) (Mul (Add c14~118@ d14~120@) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@)))))) (and (=> (= tmp%37@ (Mul b14~116@ c14~118@)) (=> (= tmp%38@ (Add c14~118@ d14~120@)) (=> (= tmp%39@ (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%37@ tmp%38@ tmp%39@) (=> %%location_label%%14 (= temp_14_0~2960@ temp_14_1~3025@)))))) (=> (= temp_14_0~2960@ temp_14_1~3025@) (=> (= temp_15_0~3136@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Sub b15~124@ b15~124@)) (Mul (Add 40 d15~128@) (Mul c15~126@ b15~124@))) (Mul b15~124@ (Mul b15~124@ (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~3197@ (Mul (Mul (Mul b15~124@ (Mul b15~124@ (Sub b15~124@ b15~124@))) (Mul (Add 40 d15~128@) (Mul c15~126@ b15~124@))) (Mul b15~124@ (Mul b15~124@ (Mul c15~126@ a15~122@))))) (and (=> (= tmp%40@ (Sub b15~124@ b15~124@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b15~124@ b15~124@ tmp%40@) (=> (= tmp%41@ (Mul b15~124@ (Mul b15~124@ (Sub b15~124@ b15~124@)))) (=> (= tmp%42@ (Mul (Add 40 d15~128@) (Mul c15~126@ b15~124@))) (=> (= tmp%43@ (Mul b15~124@ (Mul b15~124@ (Mul c15~126@ a15~122@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ tmp%42@ tmp%43@) (=> (= tmp%44@ (Mul (Mul b15~124@ b15~124@) (Sub b15~124@ b15~124@))) (=> (= tmp%45@ (Mul (Add 40 d15~128@) (Mul c15~126@ b15~124@))) (=> (= tmp%46@ (Mul b15~124@ (Mul b15~124@ (Mul c15~126@ a15~122@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%44@ tmp%45@ tmp%46@) (=> %%location_label%%15 (= temp_15_0~3136@ temp_15_1~3197@)))))))))))) (=> (= temp_15_0~3136@ temp_15_1~3197@) (=> (= temp_16_0~3368@ (Mul (Mul (Sub (Sub c16~134@ b16~132@) (Mul b16~132@ a16~130@)) (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ c16~134@))) b16~132@)) (=> (= temp_16_1~3405@ (Mul (Mul (Sub (Sub c16~134@ b16~132@) (Mul b16~132@ a16~130@)) (Mul (Mul b16~132@ c16~134@) (Mul c16~134@ b16~132@))) b16~132@)) (and (=> (= tmp%47@ (Mul b16~132@ c16~134@)) (=> (= tmp%48@ (Mul c16~134@ b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%47@ tmp%48@) (=> %%location_label%%16 (= temp_16_0~3368@ temp_16_1~3405@))))) (=> (= temp_16_0~3368@ temp_16_1~3405@) (=> (= temp_17_0~3514@ (Mul (Add (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ b17~140@)) (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul 77 c17~142@) b17~140@) (Add (Mul b17~140@ d17~144@) (Sub b17~140@ a17~138@))))) (=> (= temp_17_1~3587@ (Mul (Mul (Add (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ b17~140@)) (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ b17~140@))) (Mul (Mul 77 c17~142@) b17~140@)) (Add (Mul b17~140@ d17~144@) (Sub b17~140@ a17~138@)))) (and (=> (= tmp%49@ (Add (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ b17~140@)) (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ b17~140@)))) (=> (= tmp%50@ (Mul (Mul 77 c17~142@) b17~140@)) (=> (= tmp%51@ (Add (Mul b17~140@ d17~144@) (Sub b17~140@ a17~138@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%49@ tmp%50@ tmp%51@) (=> %%location_label%%17 (= temp_17_0~3514@ temp_17_1~3587@)))))) (=> (= temp_17_0~3514@ temp_17_1~3587@) (=> (= temp_18_0~3706@ (Sub (Mul (Mul (Mul b18~148@ d18~152@) (Mul b18~148@ d18~152@)) (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ b18~148@))) d18~152@)) (=> (= temp_18_1~3743@ (Sub (Mul (Mul (Mul d18~152@ b18~148@) (Mul b18~148@ d18~152@)) (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ b18~148@))) d18~152@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d18~152@ b18~148@) (=> (= tmp%52@ (Mul d18~152@ b18~148@)) (=> (= tmp%53@ (Mul b18~148@ d18~152@)) (=> (= tmp%54@ (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ b18~148@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%52@ tmp%53@ tmp%54@) (=> (= tmp%55@ (Mul b18~148@ d18~152@)) (=> (= tmp%56@ (Mul b18~148@ d18~152@)) (=> (= tmp%57@ (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ b18~148@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%55@ tmp%56@ tmp%57@) (=> %%location_label%%18 (= temp_18_0~3706@ temp_18_1~3743@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
