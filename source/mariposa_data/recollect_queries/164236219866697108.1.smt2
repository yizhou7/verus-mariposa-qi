...
(declare-const temp_2_1~728@ Int)
(declare-const temp_3_0~825@ Int)
(declare-const temp_3_1~886@ Int)
...
(declare-const temp_6_1~1556@ Int)
(declare-const temp_7_0~1653@ Int)
(declare-const temp_7_1~1718@ Int)
(declare-const temp_8_0~1935@ Int)
...
(declare-const temp_10_1~2288@ Int)
(declare-const temp_11_0~2445@ Int)
(declare-const temp_11_1~2482@ Int)
(declare-const temp_12_0~2583@ Int)
(declare-const temp_12_1~2648@ Int)
(declare-const temp_13_0~2745@ Int)
(declare-const temp_13_1~2806@ Int)
(declare-const temp_14_0~2905@ Int)
(declare-const temp_14_1~2970@ Int)
(declare-const temp_15_0~3091@ Int)
(declare-const temp_15_1~3176@ Int)
(declare-const temp_16_0~3413@ Int)
(declare-const temp_16_1~3478@ Int)
(declare-const temp_17_0~3577@ Int)
(declare-const temp_17_1~3642@ Int)
(declare-const temp_18_0~3739@ Int)
(declare-const temp_18_1~3800@ Int)
(declare-const temp_19_0~3941@ Int)
(declare-const temp_19_1~4002@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Sub (Add (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Sub c0~6@ a0~2@))) (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Add b0~4@ b0~4@))))) (=> (= temp_0_1~378@ (Mul (Sub (Add (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Sub (Mul (Mul b0~4@ a0~2@) c0~6@) (Mul (Mul b0~4@ a0~2@) a0~2@))) (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Add b0~4@ b0~4@))))) (and (=> (= tmp%1@ (Mul b0~4@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ c0~6@ a0~2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~378@)))) (=> (= temp_0_0~305@ temp_0_1~378@) (=> (= temp_1_0~489@ (Mul (Mul (Mul (Mul b1~12@ a1~10@) (Mul 88 d1~16@)) (Add (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~566@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul 88 d1~16@)) (Add (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))))) (and (=> (= tmp%2@ (Mul (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@)))) (=> (= tmp%3@ (Mul (Mul (Mul b1~12@ a1~10@) (Mul 88 d1~16@)) (Add (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~489@ temp_1_1~566@))))) (=> (= temp_1_0~489@ temp_1_1~566@) (=> (= temp_2_0~691@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Sub b2~20@ b2~20@)) c2~22@) (Mul c2~22@ (Mul d2~24@ (Mul d2~24@ d2~24@))))) (=> (= temp_2_1~728@ (Add (Mul (Mul (Sub b2~20@ b2~20@) (Mul d2~24@ d2~24@)) c2~22@) (Mul c2~22@ (Mul d2~24@ (Mul d2~24@ d2~24@))))) (and (=> (= tmp%4@ (Sub b2~20@ b2~20@)) (=> (= tmp%5@ (Mul d2~24@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~691@ temp_2_1~728@))))) (=> (= temp_2_0~691@ temp_2_1~728@) (=> (= temp_3_0~825@ (Mul (Sub (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Add b3~28@ c3~30@) (Mul a3~26@ a3~26@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@)) (Sub d3~32@ (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~886@ (Mul (Mul (Sub (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Add b3~28@ c3~30@) (Mul a3~26@ a3~26@))) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@))) (Sub d3~32@ (Mul c3~30@ c3~30@)))) (and (=> (= tmp%6@ (Sub (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Add b3~28@ c3~30@) (Mul a3~26@ a3~26@)))) (=> (= tmp%7@ (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@))) (=> (= tmp%8@ (Sub d3~32@ (Mul c3~30@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%3 (= temp_3_0~825@ temp_3_1~886@)))))) (=> (= temp_3_0~825@ temp_3_1~886@) (=> (= temp_4_0~1001@ (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@))) b4~36@)) (=> (= temp_4_1~1038@ (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@)) b4~36@))) (and (=> (= tmp%9@ (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ a4~34@))) (=> (= tmp%10@ (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ b4~36@) (=> %%location_label%%4 (= temp_4_0~1001@ temp_4_1~1038@))))) (=> (= temp_4_0~1001@ temp_4_1~1038@) (=> (= temp_5_0~1169@ (Mul (Mul (Mul (Mul 9 a5~42@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ c5~46@)) (Sub (Mul d5~48@ b5~44@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1246@ (Mul (Mul (Mul (Mul a5~42@ 9) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ c5~46@)) (Sub (Mul d5~48@ b5~44@) (Mul b5~44@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ 9) (=> (= tmp%11@ (Mul (Mul a5~42@ 9) (Mul c5~46@ b5~44@))) (=> (= tmp%12@ (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@))) (=> (= tmp%13@ (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ c5~46@)) (Sub (Mul d5~48@ b5~44@) (Mul b5~44@ b5~44@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> (= tmp%14@ (Mul (Mul 9 a5~42@) (Mul c5~46@ b5~44@))) (=> (= tmp%15@ (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@))) (=> (= tmp%16@ (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ c5~46@)) (Sub (Mul d5~48@ b5~44@) (Mul b5~44@ b5~44@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%5 (= temp_5_0~1169@ temp_5_1~1246@))))))))))) (=> (= temp_5_0~1169@ temp_5_1~1246@) (=> (= temp_6_0~1483@ (Mul (Mul (Mul (Add a6~50@ c6~54@) (Mul b6~52@ a6~50@)) (Mul b6~52@ (Mul d6~56@ a6~50@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul 55 b6~52@)) (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1556@ (Mul (Mul (Mul (Add a6~50@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Mul d6~56@ a6~50@) b6~52@)) (Mul (Mul (Mul d6~56@ b6~52@) (Mul 55 b6~52@)) (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ c6~54@))))) (and (=> (= tmp%17@ (Mul d6~56@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1483@ temp_6_1~1556@)))) (=> (= temp_6_0~1483@ temp_6_1~1556@) (=> (= temp_7_0~1653@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Sub (Mul d7~64@ b7~60@) (Sub d7~64@ b7~60@))))) (=> (= temp_7_1~1718@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@)) (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Sub (Mul d7~64@ b7~60@) (Sub d7~64@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ b7~60@) (=> (= tmp%18@ (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@))) (=> (= tmp%19@ (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))) (=> (= tmp%20@ (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Sub (Mul d7~64@ b7~60@) (Sub d7~64@ b7~60@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> (= tmp%21@ (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@))) (=> (= tmp%22@ (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))) (=> (= tmp%23@ (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Sub (Mul d7~64@ b7~60@) (Sub d7~64@ b7~60@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%7 (= temp_7_0~1653@ temp_7_1~1718@))))))))))) (=> (= temp_7_0~1653@ temp_7_1~1718@) (=> (= temp_8_0~1935@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@))))) (=> (= temp_8_1~2000@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@))))) (and (=> (= tmp%24@ (Mul b8~68@ c8~70@)) (=> (= tmp%25@ (Mul a8~66@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%24@ tmp%25@) (=> %%location_label%%8 (= temp_8_0~1935@ temp_8_1~2000@))))) (=> (= temp_8_0~1935@ temp_8_1~2000@) (=> (= temp_9_0~2097@ (Mul (Mul (Add (Sub d9~80@ c9~78@) (Mul d9~80@ d9~80@)) (Mul d9~80@ (Mul d9~80@ b9~76@))) (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~2158@ (Mul (Mul (Add (Sub d9~80@ c9~78@) (Mul d9~80@ d9~80@)) (Mul (Mul d9~80@ b9~76@) d9~80@)) (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ a9~74@))))) (and (=> (= tmp%26@ (Mul d9~80@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%26@ d9~80@) (=> %%location_label%%9 (= temp_9_0~2097@ temp_9_1~2158@)))) (=> (= temp_9_0~2097@ temp_9_1~2158@) (=> (= temp_10_0~2239@ (Mul (Mul (Add (Mul d10~88@ c10~86@) (Mul d10~88@ b10~84@)) c10~86@) (Add (Sub (Add c10~86@ a10~82@) (Mul c10~86@ a10~82@)) (Add c10~86@ (Sub d10~88@ b10~84@))))) (=> (= temp_10_1~2288@ (Mul (Mul (Add (Mul c10~86@ d10~88@) (Mul d10~88@ b10~84@)) c10~86@) (Add (Sub (Add c10~86@ a10~82@) (Mul c10~86@ a10~82@)) (Add c10~86@ (Sub d10~88@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ d10~88@) (=> (= tmp%27@ (Add (Mul c10~86@ d10~88@) (Mul d10~88@ b10~84@))) (=> (= tmp%28@ (Add (Sub (Add c10~86@ a10~82@) (Mul c10~86@ a10~82@)) (Add c10~86@ (Sub d10~88@ b10~84@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ c10~86@ tmp%28@) (=> (= tmp%29@ (Add (Mul d10~88@ c10~86@) (Mul d10~88@ b10~84@))) (=> (= tmp%30@ (Add (Sub (Add c10~86@ a10~82@) (Mul c10~86@ a10~82@)) (Add c10~86@ (Sub d10~88@ b10~84@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ c10~86@ tmp%30@) (=> %%location_label%%10 (= temp_10_0~2239@ temp_10_1~2288@))))))))) (=> (= temp_10_0~2239@ temp_10_1~2288@) (=> (= temp_11_0~2445@ (Mul d11~96@ (Mul (Mul (Mul b11~92@ d11~96@) (Add c11~94@ c11~94@)) (Mul (Add d11~96@ b11~92@) (Mul a11~90@ a11~90@))))) (=> (= temp_11_1~2482@ (Mul d11~96@ (Mul (Mul (Add c11~94@ c11~94@) (Mul b11~92@ d11~96@)) (Mul (Add d11~96@ b11~92@) (Mul a11~90@ a11~90@))))) (and (=> (= tmp%31@ (Add c11~94@ c11~94@)) (=> (= tmp%32@ (Mul b11~92@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%31@ tmp%32@) (=> %%location_label%%11 (= temp_11_0~2445@ temp_11_1~2482@))))) (=> (= temp_11_0~2445@ temp_11_1~2482@) (=> (= temp_12_0~2583@ (Sub (Sub (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ a12~98@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ d12~104@))) (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@)) (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2648@ (Sub (Sub (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ a12~98@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ d12~104@))) (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ c12~102@))))) (and (=> (= tmp%33@ (Mul d12~104@ d12~104@)) (=> (= tmp%34@ (Mul c12~102@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%33@ tmp%34@) (=> %%location_label%%12 (= temp_12_0~2583@ temp_12_1~2648@))))) (=> (= temp_12_0~2583@ temp_12_1~2648@) (=> (= temp_13_0~2745@ (Mul (Mul (Sub (Mul d13~112@ b13~108@) (Mul a13~106@ d13~112@)) (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ b13~108@))) (Mul (Mul (Mul a13~106@ a13~106@) (Mul a13~106@ b13~108@)) (Add (Mul b13~108@ b13~108@) b13~108@)))) (=> (= temp_13_1~2806@ (Mul (Mul (Sub (Mul d13~112@ b13~108@) (Mul a13~106@ d13~112@)) (Mul (Mul (Mul a13~106@ b13~108@) c13~110@) b13~108@)) (Mul (Mul (Mul a13~106@ a13~106@) (Mul a13~106@ b13~108@)) (Add (Mul b13~108@ b13~108@) b13~108@)))) (and (=> (= tmp%35@ (Mul a13~106@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ c13~110@ b13~108@) (=> %%location_label%%13 (= temp_13_0~2745@ temp_13_1~2806@)))) (=> (= temp_13_0~2745@ temp_13_1~2806@) (=> (= temp_14_0~2905@ (Sub (Mul c14~118@ (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ b14~116@))) (Sub (Mul (Sub c14~118@ b14~116@) (Mul a14~114@ 53)) (Add (Add d14~120@ c14~118@) (Mul c14~118@ a14~114@))))) (=> (= temp_14_1~2970@ (Sub (Mul c14~118@ (Mul (Mul c14~118@ b14~116@) (Mul d14~120@ c14~118@))) (Sub (Mul (Sub c14~118@ b14~116@) (Mul a14~114@ 53)) (Add (Add d14~120@ c14~118@) (Mul c14~118@ a14~114@))))) (and (=> (= tmp%36@ (Mul c14~118@ b14~116@)) (=> (= tmp%37@ (Mul d14~120@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%36@ tmp%37@) (=> %%location_label%%14 (= temp_14_0~2905@ temp_14_1~2970@))))) (=> (= temp_14_0~2905@ temp_14_1~2970@) (=> (= temp_15_0~3091@ (Mul (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ a15~122@)) (Add c15~126@ (Mul b15~124@ c15~126@))) (Mul (Mul (Mul 70 a15~122@) (Mul c15~126@ d15~128@)) (Mul (Mul d15~128@ a15~122@) (Mul 57 b15~124@))))) (=> (= temp_15_1~3176@ (Mul (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ a15~122@)) (Add c15~126@ (Mul b15~124@ c15~126@))) (Mul (Mul (Mul 70 a15~122@) (Mul c15~126@ d15~128@)) (Mul (Mul 57 b15~124@) (Mul d15~128@ a15~122@))))) (and (=> (= tmp%38@ (Mul 57 b15~124@)) (=> (= tmp%39@ (Mul d15~128@ a15~122@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%38@ tmp%39@) (=> (= tmp%40@ (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ a15~122@)) (Add c15~126@ (Mul b15~124@ c15~126@)))) (=> (= tmp%41@ (Mul (Mul 70 a15~122@) (Mul c15~126@ d15~128@))) (=> (= tmp%42@ (Mul (Mul 57 b15~124@) (Mul d15~128@ a15~122@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ tmp%41@ tmp%42@) (=> (= tmp%43@ (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ a15~122@)) (Add c15~126@ (Mul b15~124@ c15~126@)))) (=> (= tmp%44@ (Mul (Mul 70 a15~122@) (Mul c15~126@ d15~128@))) (=> (= tmp%45@ (Mul (Mul d15~128@ a15~122@) (Mul 57 b15~124@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%43@ tmp%44@ tmp%45@) (=> %%location_label%%15 (= temp_15_0~3091@ temp_15_1~3176@))))))))))))) (=> (= temp_15_0~3091@ temp_15_1~3176@) (=> (= temp_16_0~3413@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul d16~136@ b16~132@)) (Mul (Sub a16~130@ c16~134@) (Mul d16~136@ d16~136@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ c16~134@)) (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~3478@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul d16~136@ b16~132@)) (Mul (Mul (Sub a16~130@ c16~134@) d16~136@) d16~136@)) (Mul (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ c16~134@)) (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ d16~136@))))) (and (=> (= tmp%46@ (Sub a16~130@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%46@ d16~136@ d16~136@) (=> %%location_label%%16 (= temp_16_0~3413@ temp_16_1~3478@)))) (=> (= temp_16_0~3413@ temp_16_1~3478@) (=> (= temp_17_0~3577@ (Mul (Mul (Mul (Mul c17~142@ b17~140@) (Sub a17~138@ d17~144@)) (Mul (Mul c17~142@ b17~140@) (Mul a17~138@ d17~144@))) (Mul (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ c17~142@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ d17~144@))))) (=> (= temp_17_1~3642@ (Mul (Mul (Mul (Mul c17~142@ b17~140@) (Sub a17~138@ d17~144@)) (Mul (Mul c17~142@ b17~140@) (Mul a17~138@ d17~144@))) (Mul (Mul (Mul a17~138@ c17~142@) (Mul c17~142@ a17~138@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ d17~144@))))) (and (=> (= tmp%47@ (Mul a17~138@ c17~142@)) (=> (= tmp%48@ (Mul c17~142@ a17~138@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%47@ tmp%48@) (=> %%location_label%%17 (= temp_17_0~3577@ temp_17_1~3642@))))) (=> (= temp_17_0~3577@ temp_17_1~3642@) (=> (= temp_18_0~3739@ (Mul (Mul (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Add a18~146@ d18~152@) (Mul c18~150@ c18~150@))) (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ c18~150@)) (Mul b18~148@ (Mul b18~148@ b18~148@))))) (=> (= temp_18_1~3800@ (Mul (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ c18~150@)) (Mul b18~148@ (Mul b18~148@ b18~148@))) (Mul (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Add a18~146@ d18~152@) (Mul c18~150@ c18~150@))))) (and (=> (= tmp%49@ (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ c18~150@)) (Mul b18~148@ (Mul b18~148@ b18~148@)))) (=> (= tmp%50@ (Mul (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Add a18~146@ d18~152@) (Mul c18~150@ c18~150@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%49@ tmp%50@) (=> %%location_label%%18 (= temp_18_0~3739@ temp_18_1~3800@))))) (=> (= temp_18_0~3739@ temp_18_1~3800@) (=> (= temp_19_0~3941@ (Mul (Mul (Mul (Mul c19~158@ b19~156@) (Mul b19~156@ c19~158@)) (Mul (Mul c19~158@ a19~154@) b19~156@)) (Mul (Mul (Mul b19~156@ d19~160@) (Add a19~154@ b19~156@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ b19~156@))))) (=> (= temp_19_1~4002@ (Mul (Mul (Mul c19~158@ b19~156@) (Mul b19~156@ c19~158@)) (Mul (Mul (Mul c19~158@ a19~154@) b19~156@) (Mul (Mul (Mul b19~156@ d19~160@) (Add a19~154@ b19~156@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ b19~156@)))))) (=> (= tmp%51@ (Mul (Mul c19~158@ b19~156@) (Mul b19~156@ c19~158@))) (=> (= tmp%52@ (Mul (Mul c19~158@ a19~154@) b19~156@)) (=> (= tmp%53@ (Mul (Mul (Mul b19~156@ d19~160@) (Add a19~154@ b19~156@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ b19~156@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%51@ tmp%52@ tmp%53@) (=> %%location_label%%19 (= temp_19_0~3941@ temp_19_1~4002@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
