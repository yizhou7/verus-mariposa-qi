...
(declare-const temp_5_0~1297@ Int)
...
(declare-const temp_7_1~1749@ Int)
(declare-const temp_8_0~1854@ Int)
(declare-const temp_8_1~1923@ Int)
(declare-const temp_9_0~2014@ Int)
(declare-const temp_9_1~2075@ Int)
(declare-const temp_10_0~2166@ Int)
(declare-const temp_10_1~2223@ Int)
(declare-const temp_11_0~2318@ Int)
(declare-const temp_11_1~2383@ Int)
(declare-const temp_12_0~2466@ Int)
(declare-const temp_12_1~2519@ Int)
(declare-const temp_13_0~2612@ Int)
(declare-const temp_13_1~2677@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Sub (Mul (Mul (Mul d0~8@ c0~6@) (Add d0~8@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Sub 93 b0~4@))))) (=> (= temp_0_1~394@ (Sub (Mul (Mul (Mul d0~8@ c0~6@) (Add d0~8@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul c0~6@ b0~4@) (Sub 93 b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ b0~4@))))) (and (=> (= tmp%1@ (Mul (Mul c0~6@ b0~4@) (Sub 93 b0~4@))) (=> (= tmp%2@ (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ b0~4@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~487@ (Mul (Add (Sub (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ b1~12@))) a1~10@)) (=> (= temp_1_1~524@ (Mul (Add (Sub (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ b1~12@))) a1~10@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ d1~16@) (=> %%location_label%%1 (= temp_1_0~487@ temp_1_1~524@))) (=> (= temp_1_0~487@ temp_1_1~524@) (=> (= temp_2_0~617@ (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Add a2~18@ b2~20@))) (Add (Mul (Mul b2~20@ d2~24@) (Add c2~22@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~682@ (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Add a2~18@ b2~20@))) (Add (Mul (Mul b2~20@ d2~24@) (Add c2~22@ d2~24@)) (Mul a2~18@ (Mul d2~24@ (Mul c2~22@ a2~18@)))))) (and (=> (= tmp%3@ (Mul c2~22@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a2~18@ d2~24@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~617@ temp_2_1~682@)))) (=> (= temp_2_0~617@ temp_2_1~682@) (=> (= temp_3_0~793@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Sub d3~32@ b3~28@)) (Add (Sub c3~30@ d3~32@) (Mul a3~26@ b3~28@))) (Mul (Sub (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ 80) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~886@ (Mul (Add (Mul (Mul (Mul a3~26@ d3~32@) (Sub d3~32@ b3~28@)) (Sub c3~30@ d3~32@)) (Mul (Mul (Mul a3~26@ d3~32@) (Sub d3~32@ b3~28@)) (Mul a3~26@ b3~28@))) (Mul (Sub (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ 80) (Mul d3~32@ d3~32@))))) (and (=> (= tmp%4@ (Mul (Mul a3~26@ d3~32@) (Sub d3~32@ b3~28@))) (=> (= tmp%5@ (Sub c3~30@ d3~32@)) (=> (= tmp%6@ (Mul a3~26@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~793@ temp_3_1~886@)))))) (=> (= temp_3_0~793@ temp_3_1~886@) (=> (= temp_4_0~1009@ (Mul (Mul (Mul a4~34@ (Add c4~38@ 47)) (Mul (Mul d4~40@ a4~34@) (Add 26 d4~40@))) (Mul c4~38@ (Mul (Add a4~34@ b4~36@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~1086@ (Mul (Mul (Add (Mul a4~34@ c4~38@) (Mul a4~34@ 47)) (Mul (Mul d4~40@ a4~34@) (Add 26 d4~40@))) (Mul c4~38@ (Mul (Add a4~34@ b4~36@) (Mul b4~36@ b4~36@))))) (and (=> (= tmp%7@ (Add (Mul a4~34@ c4~38@) (Mul a4~34@ 47))) (=> (= tmp%8@ (Mul (Mul d4~40@ a4~34@) (Add 26 d4~40@))) (=> (= tmp%9@ (Mul c4~38@ (Mul (Add a4~34@ b4~36@) (Mul b4~36@ b4~36@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a4~34@ c4~38@ 47) (=> (= tmp%10@ (Mul a4~34@ (Add c4~38@ 47))) (=> (= tmp%11@ (Mul (Mul d4~40@ a4~34@) (Add 26 d4~40@))) (=> (= tmp%12@ (Mul c4~38@ (Mul (Add a4~34@ b4~36@) (Mul b4~36@ b4~36@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%4 (= temp_4_0~1009@ temp_4_1~1086@))))))))))) (=> (= temp_4_0~1009@ temp_4_1~1086@) (=> (= temp_5_0~1297@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ a5~42@) (Sub d5~48@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@))))) (=> (= temp_5_1~1362@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ a5~42@) (Sub d5~48@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@))))) (=> (= tmp%13@ (= temp_5_0~1297@ temp_5_1~1362@)) (and (=> %%location_label%%5 tmp%13@) (=> tmp%13@ (=> (= temp_6_0~1454@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul 42 c6~54@) (Mul d6~56@ a6~50@))) (Sub 77 (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1531@ (Mul (Sub 77 (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul 42 c6~54@) (Mul d6~56@ a6~50@))))) (and (=> (= tmp%14@ (Sub 77 (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ b6~52@)))) (=> (= tmp%15@ (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul 42 c6~54@) (Mul d6~56@ a6~50@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%6 (= temp_6_0~1454@ temp_6_1~1531@))))) (=> (= temp_6_0~1454@ temp_6_1~1531@) (=> (= temp_7_0~1680@ (Sub (Sub (Mul (Add c7~62@ a7~58@) (Sub d7~64@ b7~60@)) (Mul (Add c7~62@ 32) (Sub d7~64@ b7~60@))) (Mul (Add (Mul b7~60@ b7~60@) d7~64@) (Mul (Mul c7~62@ d7~64@) d7~64@)))) (=> (= temp_7_1~1749@ (Sub (Sub (Mul (Sub d7~64@ b7~60@) (Add c7~62@ a7~58@)) (Mul (Add c7~62@ 32) (Sub d7~64@ b7~60@))) (Mul (Add (Mul b7~60@ b7~60@) d7~64@) (Mul (Mul c7~62@ d7~64@) d7~64@)))) (and (=> (= tmp%16@ (Sub d7~64@ b7~60@)) (=> (= tmp%17@ (Add c7~62@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%7 (= temp_7_0~1680@ temp_7_1~1749@))))) (=> (= temp_7_0~1680@ temp_7_1~1749@) (=> (= temp_8_0~1854@ (Mul (Mul (Mul c8~70@ (Mul c8~70@ c8~70@)) (Add (Mul c8~70@ a8~66@) (Sub c8~70@ 15))) (Mul (Mul (Mul d8~72@ d8~72@) b8~68@) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1923@ (Mul (Mul (Mul c8~70@ (Mul c8~70@ c8~70@)) (Add (Mul c8~70@ a8~66@) (Sub c8~70@ 15))) (Mul (Mul d8~72@ (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. d8~72@ d8~72@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1854@ temp_8_1~1923@))) (=> (= temp_8_0~1854@ temp_8_1~1923@) (=> (= temp_9_0~2014@ (Mul (Add (Add (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@))) (Mul (Mul (Mul c9~78@ c9~78@) (Mul b9~76@ a9~74@)) (Mul b9~76@ (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~2075@ (Mul (Add (Add (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@))) (Mul (Mul c9~78@ (Mul c9~78@ (Mul b9~76@ a9~74@))) (Mul b9~76@ (Mul d9~80@ d9~80@))))) (and (=> (= tmp%18@ (Mul b9~76@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c9~78@ c9~78@ tmp%18@) (=> %%location_label%%9 (= temp_9_0~2014@ temp_9_1~2075@)))) (=> (= temp_9_0~2014@ temp_9_1~2075@) (=> (= temp_10_0~2166@ (Add (Mul (Mul (Mul d10~88@ b10~84@) d10~88@) (Mul d10~88@ (Mul c10~86@ d10~88@))) (Mul (Mul (Mul b10~84@ c10~86@) (Sub b10~84@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ c10~86@))))) (=> (= temp_10_1~2223@ (Add (Mul (Mul (Mul d10~88@ b10~84@) d10~88@) (Mul d10~88@ (Mul c10~86@ d10~88@))) (Mul (Mul (Mul b10~84@ c10~86@) (Sub b10~84@ a10~82@)) (Mul c10~86@ (Mul a10~82@ (Mul b10~84@ c10~86@)))))) (and (=> (= tmp%19@ (Mul b10~84@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c10~86@ a10~82@ tmp%19@) (=> %%location_label%%10 (= temp_10_0~2166@ temp_10_1~2223@)))) (=> (= temp_10_0~2166@ temp_10_1~2223@) (=> (= temp_11_0~2318@ (Mul (Sub (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ a11~90@)) (Mul (Sub a11~90@ a11~90@) (Mul d11~96@ b11~92@))) (Mul (Mul a11~90@ (Sub b11~92@ a11~90@)) (Mul (Add b11~92@ d11~96@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2383@ (Mul (Sub (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ a11~90@)) (Mul (Sub a11~90@ a11~90@) (Mul d11~96@ b11~92@))) (Mul (Sub (Mul a11~90@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (Add b11~92@ d11~96@) (Mul d11~96@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. a11~90@ b11~92@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2318@ temp_11_1~2383@))) (=> (= temp_11_0~2318@ temp_11_1~2383@) (=> (= temp_12_0~2466@ (Mul (Mul b12~100@ (Sub (Mul d12~104@ a12~98@) (Mul a12~98@ a12~98@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2519@ (Mul (Mul b12~100@ (Sub (Mul a12~98@ d12~104@) (Mul a12~98@ a12~98@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a12~98@ d12~104@) (=> %%location_label%%12 (= temp_12_0~2466@ temp_12_1~2519@))) (=> (= temp_12_0~2466@ temp_12_1~2519@) (=> (= temp_13_0~2612@ (Mul (Mul (Mul (Add c13~110@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ b13~108@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ c13~110@)) (Add (Mul b13~108@ c13~110@) (Sub b13~108@ c13~110@))))) (=> (= temp_13_1~2677@ (Mul (Mul (Mul (Add c13~110@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ b13~108@))) (Mul (Add (Mul b13~108@ c13~110@) (Sub b13~108@ c13~110@)) (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ c13~110@))))) (=> (= tmp%20@ (Add (Mul b13~108@ c13~110@) (Sub b13~108@ c13~110@))) (=> (= tmp%21@ (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ c13~110@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%13 (= temp_13_0~2612@ temp_13_1~2677@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
