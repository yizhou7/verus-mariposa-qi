...
(declare-const temp_3_0~917@ Int)
...
(declare-const temp_5_1~1292@ Int)
...
(declare-const temp_8_0~1783@ Int)
(declare-const temp_8_1~1848@ Int)
(declare-const temp_9_0~1928@ Int)
(declare-const temp_9_1~1993@ Int)
(declare-const temp_10_0~2104@ Int)
(declare-const temp_10_1~2181@ Int)
(declare-const temp_11_0~2354@ Int)
(declare-const temp_11_1~2427@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@)) (Add (Mul c0~6@ a0~2@) a0~2@)) (Mul c0~6@ (Mul (Mul d0~8@ a0~2@) (Add c0~6@ b0~4@))))) (=> (= temp_0_1~338@ (Mul (Mul (Add (Mul c0~6@ a0~2@) a0~2@) (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@))) (Mul c0~6@ (Mul (Mul d0~8@ a0~2@) (Add c0~6@ b0~4@))))) (and (=> (= tmp%1@ (Add (Mul c0~6@ a0~2@) a0~2@)) (=> (= tmp%2@ (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~338@))))) (=> (= temp_0_0~289@ temp_0_1~338@) (=> (= temp_1_0~447@ (Mul (Mul (Mul (Mul b1~12@ a1~10@) (Sub a1~10@ a1~10@)) (Mul (Mul b1~12@ c1~14@) b1~12@)) (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Add a1~10@ d1~16@) (Mul b1~12@ b1~12@))))) (=> (= temp_1_1~516@ (Mul (Mul (Sub (Mul (Mul b1~12@ a1~10@) a1~10@) (Mul (Mul b1~12@ a1~10@) a1~10@)) (Mul (Mul b1~12@ c1~14@) b1~12@)) (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Add a1~10@ d1~16@) (Mul b1~12@ b1~12@))))) (and (=> (= tmp%3@ (Sub (Mul (Mul b1~12@ a1~10@) a1~10@) (Mul (Mul b1~12@ a1~10@) a1~10@))) (=> (= tmp%4@ (Mul (Mul b1~12@ c1~14@) b1~12@)) (=> (= tmp%5@ (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Add a1~10@ d1~16@) (Mul b1~12@ b1~12@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Mul b1~12@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%6@ a1~10@ a1~10@) (=> (= tmp%7@ (Mul (Mul b1~12@ a1~10@) (Sub a1~10@ a1~10@))) (=> (= tmp%8@ (Mul (Mul b1~12@ c1~14@) b1~12@)) (=> (= tmp%9@ (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Add a1~10@ d1~16@) (Mul b1~12@ b1~12@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~516@)))))))))))) (=> (= temp_1_0~447@ temp_1_1~516@) (=> (= temp_2_0~751@ (Mul (Mul (Mul (Add 54 d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Sub d2~24@ c2~22@))) (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~828@ (Mul (Mul (Mul (Add 54 d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul a2~18@ b2~20@) (Sub d2~24@ c2~22@))) (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ b2~20@) (=> %%location_label%%2 (= temp_2_0~751@ temp_2_1~828@))) (=> (= temp_2_0~751@ temp_2_1~828@) (=> (= temp_3_0~917@ (Mul (Add (Add d3~32@ (Mul a3~26@ a3~26@)) (Add (Sub a3~26@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) (Add (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~978@ (Mul (Add (Add d3~32@ (Mul a3~26@ a3~26@)) (Add (Sub a3~26@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Add (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@))))) (and (=> (= tmp%10@ (Add (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@))) (=> (= tmp%11@ (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%3 (= temp_3_0~917@ temp_3_1~978@))))) (=> (= temp_3_0~917@ temp_3_1~978@) (=> (= temp_4_0~1083@ (Mul (Mul (Mul b4~36@ b4~36@) (Mul (Add b4~36@ b4~36@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ c4~38@)) (Sub (Add c4~38@ b4~36@) d4~40@)))) (=> (= temp_4_1~1136@ (Mul (Mul (Mul b4~36@ b4~36@) (Mul (Add b4~36@ b4~36@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul (Mul b4~36@ a4~34@) d4~40@) c4~38@) (Sub (Add c4~38@ b4~36@) d4~40@)))) (and (=> (= tmp%12@ (Mul b4~36@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ d4~40@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1083@ temp_4_1~1136@)))) (=> (= temp_4_0~1083@ temp_4_1~1136@) (=> (= temp_5_0~1223@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)) (Add (Add c5~46@ b5~44@) (Mul a5~42@ b5~44@))) (Mul (Mul (Add c5~46@ c5~46@) (Add b5~44@ c5~46@)) a5~42@))) (=> (= temp_5_1~1292@ (Sub (Add (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)) (Add c5~46@ b5~44@)) (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)) (Mul a5~42@ b5~44@))) (Mul (Mul (Add c5~46@ c5~46@) (Add b5~44@ c5~46@)) a5~42@))) (and (=> (= tmp%13@ (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@))) (=> (= tmp%14@ (Add c5~46@ b5~44@)) (=> (= tmp%15@ (Mul a5~42@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%5 (= temp_5_0~1223@ temp_5_1~1292@)))))) (=> (= temp_5_0~1223@ temp_5_1~1292@) (=> (= temp_6_0~1415@ (Mul (Mul (Mul (Mul b6~52@ 89) (Mul a6~50@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@))) (Add (Mul (Mul a6~50@ c6~54@) c6~54@) (Sub (Sub c6~54@ c6~54@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1488@ (Mul (Mul (Mul (Mul b6~52@ 89) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ c6~54@))) (Add (Mul (Mul a6~50@ c6~54@) c6~54@) (Sub (Sub c6~54@ c6~54@) (Mul b6~52@ c6~54@))))) (and (=> (= tmp%16@ (Mul c6~54@ a6~50@)) (=> (= tmp%17@ (Mul d6~56@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%6 (= temp_6_0~1415@ temp_6_1~1488@))))) (=> (= temp_6_0~1415@ temp_6_1~1488@) (=> (= temp_7_0~1577@ (Sub (Mul (Mul (Sub c7~62@ b7~60@) (Mul c7~62@ d7~64@)) a7~58@) (Mul (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ a7~58@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@))))) (=> (= temp_7_1~1630@ (Sub (Mul (Mul (Sub c7~62@ b7~60@) (Mul c7~62@ d7~64@)) a7~58@) (Mul (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ a7~58@)) (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ d7~64@) (=> (= tmp%18@ (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ a7~58@))) (=> (= tmp%19@ (Mul a7~58@ b7~60@)) (=> (= tmp%20@ (Mul c7~62@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> (= tmp%21@ (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ a7~58@))) (=> (= tmp%22@ (Mul a7~58@ b7~60@)) (=> (= tmp%23@ (Mul d7~64@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%7 (= temp_7_0~1577@ temp_7_1~1630@))))))))))) (=> (= temp_7_0~1577@ temp_7_1~1630@) (=> (= temp_8_0~1783@ (Mul (Mul (Add (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ d8~72@)) (Sub (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1848@ (Mul (Mul (Add (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ d8~72@)) (Sub (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= tmp%24@ (= temp_8_0~1783@ temp_8_1~1848@)) (and (=> %%location_label%%8 tmp%24@) (=> tmp%24@ (=> (= temp_9_0~1928@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Sub d9~80@ a9~74@)) (Mul (Mul c9~78@ a9~74@) (Mul a9~74@ b9~76@))) (Mul (Sub (Mul d9~80@ a9~74@) (Mul a9~74@ d9~80@)) (Add (Mul b9~76@ a9~74@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~1993@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Sub d9~80@ a9~74@)) (Mul c9~78@ (Mul a9~74@ (Mul a9~74@ b9~76@)))) (Mul (Sub (Mul d9~80@ a9~74@) (Mul a9~74@ d9~80@)) (Add (Mul b9~76@ a9~74@) (Mul c9~78@ c9~78@))))) (and (=> (= tmp%25@ (Mul a9~74@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c9~78@ a9~74@ tmp%25@) (=> %%location_label%%9 (= temp_9_0~1928@ temp_9_1~1993@)))) (=> (= temp_9_0~1928@ temp_9_1~1993@) (=> (= temp_10_0~2104@ (Sub (Mul (Mul (Mul a10~82@ a10~82@) (Sub c10~86@ a10~82@)) (Mul (Add a10~82@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Sub b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Mul c10~86@ c10~86@) (Mul a10~82@ 39))))) (=> (= temp_10_1~2181@ (Sub (Mul (Mul (Mul a10~82@ a10~82@) (Sub c10~86@ a10~82@)) (Mul (Add a10~82@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Sub b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Mul c10~86@ c10~86@) (Mul 39 a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 39 a10~82@) (=> (= tmp%26@ (Mul (Sub b10~84@ d10~88@) (Mul c10~86@ b10~84@))) (=> (= tmp%27@ (Mul c10~86@ c10~86@)) (=> (= tmp%28@ (Mul 39 a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> (= tmp%29@ (Mul (Sub b10~84@ d10~88@) (Mul c10~86@ b10~84@))) (=> (= tmp%30@ (Mul c10~86@ c10~86@)) (=> (= tmp%31@ (Mul a10~82@ 39)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> %%location_label%%10 (= temp_10_0~2104@ temp_10_1~2181@))))))))))) (=> (= temp_10_0~2104@ temp_10_1~2181@) (=> (= temp_11_0~2354@ (Sub (Mul (Mul (Mul 77 b11~92@) (Add d11~96@ b11~92@)) (Mul (Mul c11~94@ d11~96@) (Add c11~94@ d11~96@))) (Mul (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ c11~94@)) (Mul a11~90@ (Add c11~94@ d11~96@))))) (=> (= temp_11_1~2427@ (Sub (Mul (Mul 77 b11~92@) (Mul (Add d11~96@ b11~92@) (Mul (Mul c11~94@ d11~96@) (Add c11~94@ d11~96@)))) (Mul (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ c11~94@)) (Mul a11~90@ (Add c11~94@ d11~96@))))) (=> (= tmp%32@ (Mul 77 b11~92@)) (=> (= tmp%33@ (Add d11~96@ b11~92@)) (=> (= tmp%34@ (Mul (Mul c11~94@ d11~96@) (Add c11~94@ d11~96@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%11 (= temp_11_0~2354@ temp_11_1~2427@))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
