...
(declare-const temp_1_0~595@ Int)
(declare-const temp_1_1~668@ Int)
(declare-const temp_2_0~893@ Int)
(declare-const temp_2_1~966@ Int)
(declare-const temp_3_0~1055@ Int)
(declare-const temp_3_1~1116@ Int)
(declare-const temp_4_0~1229@ Int)
(declare-const temp_4_1~1314@ Int)
(declare-const temp_5_0~1521@ Int)
(declare-const temp_5_1~1558@ Int)
(declare-const temp_6_0~1697@ Int)
(declare-const temp_6_1~1786@ Int)
(declare-const temp_7_0~1887@ Int)
(declare-const temp_7_1~1952@ Int)
(declare-const temp_8_0~2101@ Int)
(declare-const temp_8_1~2166@ Int)
(declare-const temp_9_0~2389@ Int)
(declare-const temp_9_1~2454@ Int)
(declare-const temp_10_0~2603@ Int)
(declare-const temp_10_1~2664@ Int)
(declare-const temp_11_0~2803@ Int)
(declare-const temp_11_1~2864@ Int)
(declare-const temp_12_0~2983@ Int)
(declare-const temp_12_1~3056@ Int)
(declare-const temp_13_0~3140@ Int)
(declare-const temp_13_1~3209@ Int)
(declare-const temp_14_0~3320@ Int)
(declare-const temp_14_1~3393@ Int)
(declare-const temp_15_0~3516@ Int)
(declare-const temp_15_1~3593@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul a0~2@ d0~8@) (Add b0~4@ b0~4@)) (Mul (Add a0~2@ a0~2@) (Mul c0~6@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul a0~2@ d0~8@) (Add b0~4@ b0~4@)) (Mul (Add a0~2@ a0~2@) (Mul d0~8@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ c0~6@) (=> (= tmp%1@ (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@)))) (=> (= tmp%2@ (Mul (Mul a0~2@ d0~8@) (Add b0~4@ b0~4@))) (=> (= tmp%3@ (Mul (Add a0~2@ a0~2@) (Mul d0~8@ c0~6@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> (= tmp%4@ (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@)))) (=> (= tmp%5@ (Mul (Mul a0~2@ d0~8@) (Add b0~4@ b0~4@))) (=> (= tmp%6@ (Mul (Add a0~2@ a0~2@) (Mul c0~6@ d0~8@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))))))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~595@ (Mul (Mul (Sub (Mul a1~10@ d1~16@) d1~16@) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ 55))))) (=> (= temp_1_1~668@ (Mul (Mul (Sub (Mul d1~16@ a1~10@) d1~16@) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ 55))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ a1~10@) (=> (= tmp%7@ (Sub (Mul d1~16@ a1~10@) d1~16@)) (=> (= tmp%8@ (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))) (=> (= tmp%9@ (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ 55)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> (= tmp%10@ (Sub (Mul a1~10@ d1~16@) d1~16@)) (=> (= tmp%11@ (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))) (=> (= tmp%12@ (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ 55)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%1 (= temp_1_0~595@ temp_1_1~668@))))))))))) (=> (= temp_1_0~595@ temp_1_1~668@) (=> (= temp_2_0~893@ (Mul (Add (Mul a2~18@ (Sub a2~18@ b2~20@)) (Mul (Mul 76 d2~24@) (Mul d2~24@ a2~18@))) (Sub (Mul (Mul a2~18@ a2~18@) (Add a2~18@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Sub c2~22@ c2~22@))))) (=> (= temp_2_1~966@ (Mul (Add (Mul a2~18@ (Sub a2~18@ b2~20@)) (Mul (Mul 76 d2~24@) (Mul d2~24@ a2~18@))) (Sub (Mul (Mul a2~18@ a2~18@) (Add a2~18@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Sub c2~22@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ b2~20@) (=> %%location_label%%2 (= temp_2_0~893@ temp_2_1~966@))) (=> (= temp_2_0~893@ temp_2_1~966@) (=> (= temp_3_0~1055@ (Sub (Mul (Mul b3~28@ (Mul d3~32@ b3~28@)) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~1116@ (Sub (Mul (Mul b3~28@ (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ d3~32@))))) (and (=> (= tmp%13@ (Mul b3~28@ b3~28@)) (=> (= tmp%14@ (Mul c3~30@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%3 (= temp_3_0~1055@ temp_3_1~1116@))))) (=> (= temp_3_0~1055@ temp_3_1~1116@) (=> (= temp_4_0~1229@ (Mul (Mul (Sub (Sub 4 d4~40@) (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Add c4~38@ b4~36@))))) (=> (= temp_4_1~1314@ (Mul (Mul (Sub (Sub 4 d4~40@) (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ b4~36@)) (Add (Mul (Mul c4~38@ c4~38@) c4~38@) (Mul (Mul c4~38@ c4~38@) b4~36@))))) (and (=> (= tmp%15@ (Mul (Sub (Sub 4 d4~40@) (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@)))) (=> (= tmp%16@ (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ b4~36@))) (=> (= tmp%17@ (Add (Mul (Mul c4~38@ c4~38@) c4~38@) (Mul (Mul c4~38@ c4~38@) b4~36@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> (= tmp%18@ (Mul c4~38@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%18@ c4~38@ b4~36@) (=> (= tmp%19@ (Mul (Sub (Sub 4 d4~40@) (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@)))) (=> (= tmp%20@ (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ b4~36@))) (=> (= tmp%21@ (Mul (Mul c4~38@ c4~38@) (Add c4~38@ b4~36@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%4 (= temp_4_0~1229@ temp_4_1~1314@)))))))))))) (=> (= temp_4_0~1229@ temp_4_1~1314@) (=> (= temp_5_0~1521@ (Mul b5~44@ (Add (Mul (Mul c5~46@ c5~46@) d5~48@) (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1558@ (Add (Mul b5~44@ (Mul (Mul c5~46@ c5~46@) d5~48@)) (Mul b5~44@ (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ b5~44@))))) (and (=> (= tmp%22@ (Mul (Mul c5~46@ c5~46@) d5~48@)) (=> (= tmp%23@ (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ b5~44@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b5~44@ tmp%22@ tmp%23@) (=> %%location_label%%5 (= temp_5_0~1521@ temp_5_1~1558@))))) (=> (= temp_5_0~1521@ temp_5_1~1558@) (=> (= temp_6_0~1697@ (Add (Mul (Mul (Mul b6~52@ a6~50@) (Mul 1 c6~54@)) (Mul (Mul 60 b6~52@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul c6~54@ c6~54@) (Sub c6~54@ c6~54@)) (Sub (Mul b6~52@ c6~54@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1786@ (Add (Mul (Mul (Mul b6~52@ a6~50@) (Mul 1 c6~54@)) (Mul (Mul 60 b6~52@) (Mul b6~52@ d6~56@))) (Mul (Mul (Sub c6~54@ c6~54@) (Mul c6~54@ c6~54@)) (Sub (Mul b6~52@ c6~54@) (Mul c6~54@ b6~52@))))) (and (=> (= tmp%24@ (Sub c6~54@ c6~54@)) (=> (= tmp%25@ (Mul c6~54@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%24@ tmp%25@) (=> %%location_label%%6 (= temp_6_0~1697@ temp_6_1~1786@))))) (=> (= temp_6_0~1697@ temp_6_1~1786@) (=> (= temp_7_0~1887@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Add b7~60@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Sub b7~60@ a7~58@) (Add c7~62@ a7~58@))))) (=> (= temp_7_1~1952@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Sub b7~60@ a7~58@) (Add c7~62@ a7~58@))) (Mul (Mul (Mul a7~58@ a7~58@) (Add b7~60@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))))) (and (=> (= tmp%26@ (Mul (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Sub b7~60@ a7~58@) (Add c7~62@ a7~58@)))) (=> (= tmp%27@ (Mul (Mul (Mul a7~58@ a7~58@) (Add b7~60@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%26@ tmp%27@) (=> %%location_label%%7 (= temp_7_0~1887@ temp_7_1~1952@))))) (=> (= temp_7_0~1887@ temp_7_1~1952@) (=> (= temp_8_0~2101@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@))))) (=> (= temp_8_1~2166@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) (Mul c8~70@ (Mul b8~68@ (Mul d8~72@ b8~68@)))))) (and (=> (= tmp%28@ (Mul d8~72@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c8~70@ b8~68@ tmp%28@) (=> (= tmp%29@ (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ d8~72@)))) (=> (= tmp%30@ (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@))) (=> (= tmp%31@ (Mul c8~70@ (Mul b8~68@ (Mul d8~72@ b8~68@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> (= tmp%32@ (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ d8~72@)))) (=> (= tmp%33@ (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@))) (=> (= tmp%34@ (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%8 (= temp_8_0~2101@ temp_8_1~2166@)))))))))))) (=> (= temp_8_0~2101@ temp_8_1~2166@) (=> (= temp_9_0~2389@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ a9~74@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ c9~78@)) (Mul (Sub a9~74@ a9~74@) (Mul d9~80@ b9~76@))))) (=> (= temp_9_1~2454@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ a9~74@) (Mul a9~74@ c9~78@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ c9~78@)) (Mul (Sub a9~74@ a9~74@) (Mul d9~80@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a9~74@ c9~78@) (=> (= tmp%35@ (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ b9~76@))) (=> (= tmp%36@ (Mul a9~74@ a9~74@)) (=> (= tmp%37@ (Mul a9~74@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ tmp%36@ tmp%37@) (=> (= tmp%38@ (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ b9~76@))) (=> (= tmp%39@ (Mul a9~74@ a9~74@)) (=> (= tmp%40@ (Mul c9~78@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> %%location_label%%9 (= temp_9_0~2389@ temp_9_1~2454@))))))))))) (=> (= temp_9_0~2389@ temp_9_1~2454@) (=> (= temp_10_0~2603@ (Mul (Mul (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ c10~86@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ c10~86@))) (Mul (Mul (Add d10~88@ b10~84@) b10~84@) (Sub (Mul d10~88@ a10~82@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~2664@ (Mul (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ c10~86@)) (Mul (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ c10~86@)) (Mul (Mul (Add d10~88@ b10~84@) b10~84@) (Sub (Mul d10~88@ a10~82@) (Mul c10~86@ d10~88@)))))) (and (=> (= tmp%41@ (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ c10~86@))) (=> (= tmp%42@ (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ c10~86@))) (=> (= tmp%43@ (Mul (Mul (Add d10~88@ b10~84@) b10~84@) (Sub (Mul d10~88@ a10~82@) (Mul c10~86@ d10~88@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ tmp%42@ tmp%43@) (=> %%location_label%%10 (= temp_10_0~2603@ temp_10_1~2664@)))))) (=> (= temp_10_0~2603@ temp_10_1~2664@) (=> (= temp_11_0~2803@ (Mul (Mul (Mul (Sub b11~92@ d11~96@) (Mul a11~90@ d11~96@)) (Add (Mul d11~96@ a11~90@) (Mul a11~90@ b11~92@))) (Mul (Mul (Add d11~96@ c11~94@) c11~94@) (Mul (Mul b11~92@ c11~94@) (Add c11~94@ b11~92@))))) (=> (= temp_11_1~2864@ (Mul (Mul (Mul (Sub b11~92@ d11~96@) (Mul a11~90@ d11~96@)) (Add (Mul d11~96@ a11~90@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul (Add d11~96@ c11~94@) c11~94@) (Mul b11~92@ c11~94@)) (Add c11~94@ b11~92@)))) (and (=> (= tmp%44@ (Mul (Add d11~96@ c11~94@) c11~94@)) (=> (= tmp%45@ (Mul b11~92@ c11~94@)) (=> (= tmp%46@ (Add c11~94@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%44@ tmp%45@ tmp%46@) (=> %%location_label%%11 (= temp_11_0~2803@ temp_11_1~2864@)))))) (=> (= temp_11_0~2803@ temp_11_1~2864@) (=> (= temp_12_0~2983@ (Mul (Mul (Add (Add d12~104@ a12~98@) (Mul b12~100@ c12~102@)) (Mul (Mul b12~100@ b12~100@) (Mul c12~102@ 61))) (Mul (Mul (Sub c12~102@ d12~104@) a12~98@) (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ b12~100@))))) (=> (= temp_12_1~3056@ (Mul (Mul (Add (Add d12~104@ a12~98@) (Mul b12~100@ c12~102@)) (Mul (Mul b12~100@ b12~100@) (Mul c12~102@ 61))) (Mul (Mul (Sub c12~102@ d12~104@) a12~98@) (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ b12~100@))))) (=> (= tmp%47@ (= temp_12_0~2983@ temp_12_1~3056@)) (and (=> %%location_label%%12 tmp%47@) (=> tmp%47@ (=> (= temp_13_0~3140@ (Mul (Sub (Mul a13~106@ (Sub c13~110@ b13~108@)) (Mul (Add a13~106@ c13~110@) (Mul b13~108@ 67))) (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ c13~110@)) (Mul (Mul b13~108@ c13~110@) b13~108@)))) (=> (= temp_13_1~3209@ (Mul (Sub (Mul a13~106@ (Sub c13~110@ b13~108@)) (Mul (Mul (Add a13~106@ c13~110@) b13~108@) 67)) (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ c13~110@)) (Mul (Mul b13~108@ c13~110@) b13~108@)))) (and (=> (= tmp%48@ (Add a13~106@ c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%48@ b13~108@ 67) (=> %%location_label%%13 (= temp_13_0~3140@ temp_13_1~3209@)))) (=> (= temp_13_0~3140@ temp_13_1~3209@) (=> (= temp_14_0~3320@ (Mul (Mul (Mul (Add d14~120@ b14~116@) c14~118@) (Mul (Sub a14~114@ b14~116@) (Add b14~116@ d14~120@))) (Mul (Mul (Mul b14~116@ d14~120@) (Add c14~118@ c14~118@)) (Mul (Add d14~120@ b14~116@) (Mul 89 a14~114@))))) (=> (= temp_14_1~3393@ (Mul (Mul (Add d14~120@ b14~116@) (Mul c14~118@ (Mul (Sub a14~114@ b14~116@) (Add b14~116@ d14~120@)))) (Mul (Mul (Mul b14~116@ d14~120@) (Add c14~118@ c14~118@)) (Mul (Add d14~120@ b14~116@) (Mul 89 a14~114@))))) (and (=> (= tmp%49@ (Add d14~120@ b14~116@)) (=> (= tmp%50@ (Mul (Sub a14~114@ b14~116@) (Add b14~116@ d14~120@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%49@ c14~118@ tmp%50@) (=> %%location_label%%14 (= temp_14_0~3320@ temp_14_1~3393@))))) (=> (= temp_14_0~3320@ temp_14_1~3393@) (=> (= temp_15_0~3516@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul d15~128@ c15~126@)) (Mul (Sub 61 a15~122@) (Mul b15~124@ d15~128@))) (Mul (Add (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ d15~128@))))) (=> (= temp_15_1~3593@ (Mul (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul d15~128@ c15~126@)) (Mul (Sub 61 a15~122@) (Mul b15~124@ d15~128@))) (Add (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@))) (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ d15~128@)))) (=> (= tmp%51@ (Mul (Mul (Mul b15~124@ a15~122@) (Mul d15~128@ c15~126@)) (Mul (Sub 61 a15~122@) (Mul b15~124@ d15~128@)))) (=> (= tmp%52@ (Add (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@))) (=> (= tmp%53@ (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ d15~128@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%51@ tmp%52@ tmp%53@) (=> %%location_label%%15 (= temp_15_0~3516@ temp_15_1~3593@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
