...
(declare-const temp_9_0~2091@ Int)
(declare-const temp_9_1~2164@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ a0~2@))) (Mul (Mul (Add d0~8@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ b0~4@) (Sub d0~8@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul a0~2@ b0~4@) (Mul (Mul d0~8@ c0~6@) (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ a0~2@)))) (Mul (Mul (Add d0~8@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ b0~4@) (Sub d0~8@ c0~6@))))) (and (=> (= tmp%1@ (Mul a0~2@ b0~4@)) (=> (= tmp%2@ (Mul d0~8@ c0~6@)) (=> (= tmp%3@ (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~493@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ d1~16@))) (Mul (Mul (Sub d1~16@ c1~14@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ 10) b1~12@)))) (=> (= temp_1_1~566@ (Mul (Mul (Mul d1~16@ a1~10@) (Mul (Mul b1~12@ d1~16@) (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ d1~16@)))) (Mul (Mul (Sub d1~16@ c1~14@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ 10) b1~12@)))) (and (=> (= tmp%4@ (Mul d1~16@ a1~10@)) (=> (= tmp%5@ (Mul b1~12@ d1~16@)) (=> (= tmp%6@ (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ d1~16@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%1 (= temp_1_0~493@ temp_1_1~566@)))))) (=> (= temp_1_0~493@ temp_1_1~566@) (=> (= temp_2_0~677@ (Mul (Mul (Sub b2~20@ (Mul d2~24@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~738@ (Mul (Mul (Sub b2~20@ (Mul d2~24@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ c2~22@)) (Mul a2~18@ b2~20@)) (Mul c2~22@ c2~22@)))) (and (=> (= tmp%7@ (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ c2~22@))) (=> (= tmp%8@ (Mul a2~18@ b2~20@)) (=> (= tmp%9@ (Mul c2~22@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%2 (= temp_2_0~677@ temp_2_1~738@)))))) (=> (= temp_2_0~677@ temp_2_1~738@) (=> (= temp_3_0~833@ (Sub (Mul (Mul (Add c3~30@ b3~28@) (Mul c3~30@ 39)) (Mul (Mul b3~28@ d3~32@) c3~30@)) c3~30@)) (=> (= temp_3_1~878@ (Sub (Mul (Mul (Mul c3~30@ 39) (Add c3~30@ b3~28@)) (Mul (Mul b3~28@ d3~32@) c3~30@)) c3~30@)) (and (=> (= tmp%10@ (Mul c3~30@ 39)) (=> (= tmp%11@ (Add c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%3 (= temp_3_0~833@ temp_3_1~878@))))) (=> (= temp_3_0~833@ temp_3_1~878@) (=> (= temp_4_0~983@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ c4~38@))) (Add (Mul (Sub d4~40@ a4~34@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~1048@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ c4~38@))) (Add (Mul (Sub d4~40@ a4~34@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ a4~34@) (=> %%location_label%%4 (= temp_4_0~983@ temp_4_1~1048@))) (=> (= temp_4_0~983@ temp_4_1~1048@) (=> (= temp_5_0~1141@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@ b5~44@) (Add d5~48@ c5~46@))) (Sub (Mul (Mul c5~46@ a5~42@) (Sub c5~46@ a5~42@)) (Mul (Add c5~46@ c5~46@) (Add c5~46@ b5~44@))))) (=> (= temp_5_1~1206@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Add d5~48@ c5~46@))) (Sub (Mul (Mul c5~46@ a5~42@) (Sub c5~46@ a5~42@)) (Mul (Add c5~46@ c5~46@) (Add c5~46@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ c5~46@) (=> (= tmp%12@ (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ c5~46@))) (=> (= tmp%13@ (Mul (Mul b5~44@ b5~44@) (Add d5~48@ c5~46@))) (=> (= tmp%14@ (Sub (Mul (Mul c5~46@ a5~42@) (Sub c5~46@ a5~42@)) (Mul (Add c5~46@ c5~46@) (Add c5~46@ b5~44@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> (= tmp%15@ (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@))) (=> (= tmp%16@ (Mul (Mul b5~44@ b5~44@) (Add d5~48@ c5~46@))) (=> (= tmp%17@ (Sub (Mul (Mul c5~46@ a5~42@) (Sub c5~46@ a5~42@)) (Mul (Add c5~46@ c5~46@) (Add c5~46@ b5~44@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%5 (= temp_5_0~1141@ temp_5_1~1206@))))))))))) (=> (= temp_5_0~1141@ temp_5_1~1206@) (=> (= temp_6_0~1423@ (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ c6~54@)) (Add (Add a6~50@ b6~52@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1488@ (Mul (Mul (Add (Add a6~50@ b6~52@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ c6~54@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@))))) (and (=> (= tmp%18@ (Add (Add a6~50@ b6~52@) (Mul d6~56@ b6~52@))) (=> (= tmp%19@ (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%6 (= temp_6_0~1423@ temp_6_1~1488@))))) (=> (= temp_6_0~1423@ temp_6_1~1488@) (=> (= temp_7_0~1605@ (Mul (Mul (Sub (Mul c7~62@ d7~64@) (Mul a7~58@ c7~62@)) (Add (Mul c7~62@ d7~64@) (Mul d7~64@ b7~60@))) (Mul (Mul (Mul c7~62@ d7~64@) (Add c7~62@ a7~58@)) (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1670@ (Mul (Mul (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ a7~58@)) (Add (Mul c7~62@ d7~64@) (Mul d7~64@ b7~60@))) (Mul (Mul (Mul c7~62@ d7~64@) (Add c7~62@ a7~58@)) (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ a7~58@) (=> (= tmp%20@ (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ a7~58@))) (=> (= tmp%21@ (Add (Mul c7~62@ d7~64@) (Mul d7~64@ b7~60@))) (=> (= tmp%22@ (Mul (Mul (Mul c7~62@ d7~64@) (Add c7~62@ a7~58@)) (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> (= tmp%23@ (Sub (Mul c7~62@ d7~64@) (Mul a7~58@ c7~62@))) (=> (= tmp%24@ (Add (Mul c7~62@ d7~64@) (Mul d7~64@ b7~60@))) (=> (= tmp%25@ (Mul (Mul (Mul c7~62@ d7~64@) (Add c7~62@ a7~58@)) (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> %%location_label%%7 (= temp_7_0~1605@ temp_7_1~1670@))))))))))) (=> (= temp_7_0~1605@ temp_7_1~1670@) (=> (= temp_8_0~1887@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@)) (Sub (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Sub a8~66@ c8~70@) (Sub c8~70@ c8~70@))))) (=> (= temp_8_1~1968@ (Mul (Sub (Mul (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@)) (Mul c8~70@ c8~70@)) (Mul (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@)) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Sub a8~66@ c8~70@) (Sub c8~70@ c8~70@))))) (and (=> (= tmp%26@ (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@))) (=> (= tmp%27@ (Mul c8~70@ c8~70@)) (=> (= tmp%28@ (Mul a8~66@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%26@ tmp%27@ tmp%28@) (=> %%location_label%%8 (= temp_8_0~1887@ temp_8_1~1968@)))))) (=> (= temp_8_0~1887@ temp_8_1~1968@) (=> (= temp_9_0~2091@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ c9~78@)) (Mul (Mul a9~74@ b9~76@) b9~76@)) (Sub (Mul (Mul d9~80@ 8) (Mul c9~78@ c9~78@)) (Mul (Add a9~74@ a9~74@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~2164@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ c9~78@)) (Mul (Mul a9~74@ b9~76@) b9~76@)) (Sub (Mul (Mul d9~80@ 8) (Mul c9~78@ c9~78@)) (Mul (Add a9~74@ a9~74@) (Mul a9~74@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a9~74@ d9~80@) (=> %%location_label%%9 (= temp_9_0~2091@ temp_9_1~2164@))) (=> (= temp_9_0~2091@ temp_9_1~2164@) (=> (= temp_10_0~2269@ (Mul (Mul (Mul (Sub a10~82@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Add 38 a10~82@))) (Mul (Mul (Sub c10~86@ c10~86@) (Add d10~88@ a10~82@)) (Mul (Add b10~84@ c10~86@) (Mul d10~88@ d10~88@))))) (=> (= temp_10_1~2346@ (Mul (Mul (Mul (Sub a10~82@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Add 38 a10~82@))) (Mul (Mul (Sub c10~86@ c10~86@) (Add d10~88@ a10~82@)) (Mul (Mul (Add b10~84@ c10~86@) d10~88@) d10~88@)))) (=> (= tmp%29@ (Mul (Mul (Sub a10~82@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Add 38 a10~82@)))) (=> (= tmp%30@ (Mul (Sub c10~86@ c10~86@) (Add d10~88@ a10~82@))) (=> (= tmp%31@ (Mul (Mul (Add b10~84@ c10~86@) d10~88@) d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> (= tmp%32@ (Add b10~84@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ d10~88@ d10~88@) (=> (= tmp%33@ (Mul (Mul (Sub a10~82@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Add 38 a10~82@)))) (=> (= tmp%34@ (Mul (Sub c10~86@ c10~86@) (Add d10~88@ a10~82@))) (=> (= tmp%35@ (Mul (Add b10~84@ c10~86@) (Mul d10~88@ d10~88@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ tmp%34@ tmp%35@) (=> %%location_label%%10 (= temp_10_0~2269@ temp_10_1~2346@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
