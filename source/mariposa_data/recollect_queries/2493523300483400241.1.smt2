...
(declare-const temp_1_0~449@ Int)
(declare-const temp_1_1~510@ Int)
(declare-const temp_2_0~578@ Int)
(declare-const temp_2_1~631@ Int)
(declare-const temp_3_0~732@ Int)
(declare-const temp_3_1~797@ Int)
(declare-const temp_4_0~946@ Int)
(declare-const temp_4_1~1007@ Int)
(declare-const temp_5_0~1108@ Int)
(declare-const temp_5_1~1173@ Int)
(declare-const temp_6_0~1326@ Int)
(declare-const temp_6_1~1391@ Int)
(declare-const temp_7_0~1478@ Int)
(declare-const temp_7_1~1531@ Int)
(declare-const temp_8_0~1624@ Int)
(declare-const temp_8_1~1689@ Int)
(declare-const temp_9_0~1790@ Int)
(declare-const temp_9_1~1855@ Int)
(declare-const temp_10_0~1923@ Int)
(declare-const temp_10_1~1976@ Int)
(declare-const temp_11_0~2081@ Int)
(declare-const temp_11_1~2158@ Int)
(declare-const temp_12_0~2269@ Int)
(declare-const temp_12_1~2346@ Int)
(declare-const temp_13_0~2477@ Int)
(declare-const temp_13_1~2570@ Int)
(declare-const temp_14_0~2681@ Int)
(declare-const temp_14_1~2742@ Int)
(declare-const temp_15_0~2895@ Int)
(declare-const temp_15_1~2996@ Int)
(declare-const temp_16_0~3115@ Int)
(declare-const temp_16_1~3176@ Int)
(declare-const temp_17_0~3399@ Int)
(declare-const temp_17_1~3472@ Int)
(declare-const temp_18_0~3587@ Int)
(declare-const temp_18_1~3664@ Int)
(declare-const temp_19_0~3765@ Int)
(declare-const temp_19_1~3830@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Add (Mul (Mul (Add b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Add c0~6@ b0~4@) (Mul a0~2@ d0~8@))) (Mul c0~6@ (Mul c0~6@ (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~338@ (Add (Mul (Mul (Add b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Add c0~6@ b0~4@) (Mul a0~2@ d0~8@))) (Mul c0~6@ (Mul (Mul b0~4@ b0~4@) c0~6@)))) (and (=> (= tmp%1@ (Mul b0~4@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c0~6@ tmp%1@ c0~6@) (=> (= tmp%2@ (Mul c0~6@ (Mul b0~4@ b0~4@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~338@)))))) (=> (= temp_0_0~289@ temp_0_1~338@) (=> (= temp_1_0~449@ (Add (Mul (Mul b1~12@ (Mul a1~10@ a1~10@)) (Mul (Add a1~10@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~510@ (Add (Mul (Mul b1~12@ (Mul a1~10@ a1~10@)) (Mul (Add a1~10@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))))) (=> (= tmp%3@ (= temp_1_0~449@ temp_1_1~510@)) (and (=> %%location_label%%1 tmp%3@) (=> tmp%3@ (=> (= temp_2_0~578@ (Mul (Mul (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ a2~18@)) b2~20@) (Mul (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@)) (Add (Mul c2~22@ a2~18@) (Sub c2~22@ a2~18@))))) (=> (= temp_2_1~631@ (Mul (Mul (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ a2~18@)) b2~20@) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ c2~22@)) (Add (Mul c2~22@ a2~18@) (Sub c2~22@ a2~18@))))) (and (=> (= tmp%4@ (Mul d2~24@ b2~20@)) (=> (= tmp%5@ (Mul b2~20@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~578@ temp_2_1~631@))))) (=> (= temp_2_0~578@ temp_2_1~631@) (=> (= temp_3_0~732@ (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))) (Add (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Sub c3~30@ a3~26@))))) (=> (= temp_3_1~797@ (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ d3~32@))) (Add (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Sub c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ c3~30@) (=> (= tmp%6@ (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@))) (=> (= tmp%7@ (Mul a3~26@ a3~26@)) (=> (= tmp%8@ (Mul c3~30@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> (= tmp%9@ (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@))) (=> (= tmp%10@ (Mul a3~26@ a3~26@)) (=> (= tmp%11@ (Mul d3~32@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%3 (= temp_3_0~732@ temp_3_1~797@))))))))))) (=> (= temp_3_0~732@ temp_3_1~797@) (=> (= temp_4_0~946@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ a4~34@)) (Mul d4~40@ (Mul a4~34@ c4~38@))) (Sub (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~1007@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ a4~34@)) (Mul d4~40@ (Mul a4~34@ c4~38@))) (Sub (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ b4~36@))))) (and (=> (= tmp%12@ (Mul a4~34@ a4~34@)) (=> (= tmp%13@ (Mul c4~38@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%4 (= temp_4_0~946@ temp_4_1~1007@))))) (=> (= temp_4_0~946@ temp_4_1~1007@) (=> (= temp_5_0~1108@ (Add (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Sub b5~44@ b5~44@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1173@ (Add (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ b5~44@) (=> (= tmp%14@ (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@))) (=> (= tmp%15@ (Sub b5~44@ b5~44@)) (=> (= tmp%16@ (Mul b5~44@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> (= tmp%17@ (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@))) (=> (= tmp%18@ (Sub b5~44@ b5~44@)) (=> (= tmp%19@ (Mul c5~46@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%5 (= temp_5_0~1108@ temp_5_1~1173@))))))))))) (=> (= temp_5_0~1108@ temp_5_1~1173@) (=> (= temp_6_0~1326@ (Add (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Sub a6~50@ b6~52@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ d6~56@) (Add b6~52@ a6~50@))))) (=> (= temp_6_1~1391@ (Add (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Sub a6~50@ b6~52@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Mul a6~50@ (Mul d6~56@ (Add b6~52@ a6~50@)))))) (and (=> (= tmp%20@ (Add b6~52@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a6~50@ d6~56@ tmp%20@) (=> %%location_label%%6 (= temp_6_0~1326@ temp_6_1~1391@)))) (=> (= temp_6_0~1326@ temp_6_1~1391@) (=> (= temp_7_0~1478@ (Mul (Sub (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Sub a7~58@ a7~58@) (Mul a7~58@ a7~58@))) (Add (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ c7~62@)) d7~64@))) (=> (= temp_7_1~1531@ (Mul (Sub (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Sub a7~58@ a7~58@) (Mul a7~58@ a7~58@))) (Add (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ d7~64@)) d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1478@ temp_7_1~1531@))) (=> (= temp_7_0~1478@ temp_7_1~1531@) (=> (= temp_8_0~1624@ (Mul (Mul (Mul (Sub b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Add c8~70@ c8~70@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Sub d8~72@ b8~68@))))) (=> (= temp_8_1~1689@ (Mul (Mul (Mul (Sub b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Add c8~70@ c8~70@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Sub d8~72@ b8~68@))))) (and (=> (= tmp%21@ (Mul a8~66@ b8~68@)) (=> (= tmp%22@ (Mul b8~68@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%8 (= temp_8_0~1624@ temp_8_1~1689@))))) (=> (= temp_8_0~1624@ temp_8_1~1689@) (=> (= temp_9_0~1790@ (Mul (Mul d9~80@ (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ a9~74@))) (Mul (Sub (Sub d9~80@ a9~74@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Sub b9~76@ 5))))) (=> (= temp_9_1~1855@ (Mul (Mul d9~80@ (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ a9~74@))) (Mul (Sub (Sub d9~80@ a9~74@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Sub b9~76@ 5))))) (=> (= tmp%23@ (= temp_9_0~1790@ temp_9_1~1855@)) (and (=> %%location_label%%9 tmp%23@) (=> tmp%23@ (=> (= temp_10_0~1923@ (Sub (Add a10~82@ (Add (Mul d10~88@ a10~82@) (Mul b10~84@ b10~84@))) (Mul (Mul (Add b10~84@ b10~84@) (Mul b10~84@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@))))) (=> (= temp_10_1~1976@ (Sub (Add a10~82@ (Add (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))) (Mul (Mul (Add b10~84@ b10~84@) (Mul b10~84@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a10~82@ d10~88@) (=> %%location_label%%10 (= temp_10_0~1923@ temp_10_1~1976@))) (=> (= temp_10_0~1923@ temp_10_1~1976@) (=> (= temp_11_0~2081@ (Mul (Mul (Sub (Mul b11~92@ c11~94@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul b11~92@ d11~96@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ 32) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~2158@ (Mul (Mul (Sub (Mul b11~92@ c11~94@) (Mul b11~92@ b11~92@)) (Mul (Mul (Mul b11~92@ d11~96@) c11~94@) b11~92@)) (Mul (Mul (Mul b11~92@ d11~96@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ 32) (Mul a11~90@ c11~94@))))) (and (=> (= tmp%24@ (Mul b11~92@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ c11~94@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2081@ temp_11_1~2158@)))) (=> (= temp_11_0~2081@ temp_11_1~2158@) (=> (= temp_12_0~2269@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul 68 d12~104@) (Mul d12~104@ d12~104@))) (Mul (Mul (Mul a12~98@ c12~102@) (Sub b12~100@ a12~98@)) (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2346@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul 68 d12~104@) (Mul d12~104@ d12~104@))) (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Sub b12~100@ a12~98@)) (Mul b12~100@ c12~102@)) (Mul d12~104@ a12~98@)))) (and (=> (= tmp%25@ (Mul (Mul a12~98@ c12~102@) (Sub b12~100@ a12~98@))) (=> (= tmp%26@ (Mul b12~100@ c12~102@)) (=> (= tmp%27@ (Mul d12~104@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%12 (= temp_12_0~2269@ temp_12_1~2346@)))))) (=> (= temp_12_0~2269@ temp_12_1~2346@) (=> (= temp_13_0~2477@ (Mul (Mul (Mul a13~106@ (Mul d13~112@ c13~110@)) (Mul (Sub b13~108@ 91) (Mul b13~108@ b13~108@))) (Mul (Add (Mul c13~110@ 5) (Mul a13~106@ d13~112@)) (Sub d13~112@ (Mul a13~106@ a13~106@))))) (=> (= temp_13_1~2570@ (Mul (Mul (Mul a13~106@ (Mul d13~112@ c13~110@)) (Mul (Sub b13~108@ 91) (Mul b13~108@ b13~108@))) (Add (Mul (Mul c13~110@ 5) (Sub d13~112@ (Mul a13~106@ a13~106@))) (Mul (Mul a13~106@ d13~112@) (Sub d13~112@ (Mul a13~106@ a13~106@)))))) (and (=> (= tmp%28@ (Mul c13~110@ 5)) (=> (= tmp%29@ (Mul a13~106@ d13~112@)) (=> (= tmp%30@ (Sub d13~112@ (Mul a13~106@ a13~106@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%13 (= temp_13_0~2477@ temp_13_1~2570@)))))) (=> (= temp_13_0~2477@ temp_13_1~2570@) (=> (= temp_14_0~2681@ (Sub (Mul (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ b14~116@))) (Mul (Mul (Sub c14~118@ d14~120@) c14~118@) (Mul (Add b14~116@ b14~116@) (Sub a14~114@ a14~114@))))) (=> (= temp_14_1~2742@ (Sub (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ b14~116@)) (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ a14~114@))) (Mul (Mul (Sub c14~118@ d14~120@) c14~118@) (Mul (Add b14~116@ b14~116@) (Sub a14~114@ a14~114@))))) (and (=> (= tmp%31@ (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ b14~116@))) (=> (= tmp%32@ (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ a14~114@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%31@ tmp%32@) (=> %%location_label%%14 (= temp_14_0~2681@ temp_14_1~2742@))))) (=> (= temp_14_0~2681@ temp_14_1~2742@) (=> (= temp_15_0~2895@ (Mul (Mul (Add (Sub d15~128@ 40) (Mul a15~122@ a15~122@)) (Mul (Sub b15~124@ 49) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul d15~128@ c15~126@) (Mul 64 d15~128@)) (Mul (Add a15~122@ a15~122@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2996@ (Mul (Mul (Mul (Add (Sub d15~128@ 40) (Mul a15~122@ a15~122@)) (Sub b15~124@ 49)) (Mul c15~126@ c15~126@)) (Mul (Mul (Mul d15~128@ c15~126@) (Mul 64 d15~128@)) (Mul (Add a15~122@ a15~122@) (Mul c15~126@ c15~126@))))) (and (=> (= tmp%33@ (Add (Sub d15~128@ 40) (Mul a15~122@ a15~122@))) (=> (= tmp%34@ (Sub b15~124@ 49)) (=> (= tmp%35@ (Mul c15~126@ c15~126@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ tmp%34@ tmp%35@) (=> %%location_label%%15 (= temp_15_0~2895@ temp_15_1~2996@)))))) (=> (= temp_15_0~2895@ temp_15_1~2996@) (=> (= temp_16_0~3115@ (Mul (Mul (Mul a16~130@ (Mul a16~130@ b16~132@)) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ d16~136@))) (Mul (Sub (Mul a16~130@ d16~136@) (Mul a16~130@ d16~136@)) (Mul (Sub c16~134@ a16~130@) (Mul d16~136@ a16~130@))))) (=> (= temp_16_1~3176@ (Mul (Mul (Mul a16~130@ (Mul a16~130@ b16~132@)) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ d16~136@))) (Mul (Sub (Mul a16~130@ d16~136@) (Mul a16~130@ d16~136@)) (Mul (Mul (Sub c16~134@ a16~130@) d16~136@) a16~130@)))) (and (=> (= tmp%36@ (Mul (Mul a16~130@ (Mul a16~130@ b16~132@)) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ d16~136@)))) (=> (= tmp%37@ (Sub (Mul a16~130@ d16~136@) (Mul a16~130@ d16~136@))) (=> (= tmp%38@ (Mul (Mul (Sub c16~134@ a16~130@) d16~136@) a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ tmp%37@ tmp%38@) (=> (= tmp%39@ (Sub c16~134@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%39@ d16~136@ a16~130@) (=> (= tmp%40@ (Mul (Mul a16~130@ (Mul a16~130@ b16~132@)) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ d16~136@)))) (=> (= tmp%41@ (Sub (Mul a16~130@ d16~136@) (Mul a16~130@ d16~136@))) (=> (= tmp%42@ (Mul (Sub c16~134@ a16~130@) (Mul d16~136@ a16~130@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ tmp%41@ tmp%42@) (=> %%location_label%%16 (= temp_16_0~3115@ temp_16_1~3176@)))))))))))) (=> (= temp_16_0~3115@ temp_16_1~3176@) (=> (= temp_17_0~3399@ (Mul (Add (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@)) (Mul (Mul a17~138@ c17~142@) (Mul a17~138@ a17~138@))) (Mul (Mul (Add d17~144@ a17~138@) (Mul c17~142@ 40)) (Mul (Mul b17~140@ a17~138@) d17~144@)))) (=> (= temp_17_1~3472@ (Mul (Add (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@)) (Mul (Mul a17~138@ c17~142@) (Mul a17~138@ a17~138@))) (Mul (Mul (Mul (Add d17~144@ a17~138@) c17~142@) 40) (Mul (Mul b17~140@ a17~138@) d17~144@)))) (and (=> (= tmp%43@ (Add d17~144@ a17~138@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%43@ c17~142@ 40) (=> %%location_label%%17 (= temp_17_0~3399@ temp_17_1~3472@)))) (=> (= temp_17_0~3399@ temp_17_1~3472@) (=> (= temp_18_0~3587@ (Mul (Mul (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ b18~148@)) (Mul (Add d18~152@ 23) (Mul b18~148@ b18~148@))) (Mul (Add (Add a18~146@ d18~152@) (Sub a18~146@ d18~152@)) (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ a18~146@))))) (=> (= temp_18_1~3664@ (Mul (Mul (Mul (Add d18~152@ 23) (Mul b18~148@ b18~148@)) (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ b18~148@))) (Mul (Add (Add a18~146@ d18~152@) (Sub a18~146@ d18~152@)) (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ a18~146@))))) (and (=> (= tmp%44@ (Mul (Add d18~152@ 23) (Mul b18~148@ b18~148@))) (=> (= tmp%45@ (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ b18~148@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%44@ tmp%45@) (=> %%location_label%%18 (= temp_18_0~3587@ temp_18_1~3664@))))) (=> (= temp_18_0~3587@ temp_18_1~3664@) (=> (= temp_19_0~3765@ (Mul (Sub (Sub d19~160@ (Mul c19~158@ b19~156@)) (Sub (Mul a19~154@ d19~160@) a19~154@)) (Mul a19~154@ (Mul (Sub a19~154@ c19~158@) (Mul b19~156@ a19~154@))))) (=> (= temp_19_1~3830@ (Sub (Mul (Sub d19~160@ (Mul c19~158@ b19~156@)) (Mul a19~154@ (Mul (Sub a19~154@ c19~158@) (Mul b19~156@ a19~154@)))) (Mul (Sub (Mul a19~154@ d19~160@) a19~154@) (Mul a19~154@ (Mul (Sub a19~154@ c19~158@) (Mul b19~156@ a19~154@)))))) (=> (= tmp%46@ (Sub d19~160@ (Mul c19~158@ b19~156@))) (=> (= tmp%47@ (Sub (Mul a19~154@ d19~160@) a19~154@)) (=> (= tmp%48@ (Mul a19~154@ (Mul (Sub a19~154@ c19~158@) (Mul b19~156@ a19~154@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%46@ tmp%47@ tmp%48@) (=> %%location_label%%19 (= temp_19_0~3765@ temp_19_1~3830@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
