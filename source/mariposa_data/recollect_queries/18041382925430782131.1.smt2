...
(declare-const temp_1_1~684@ Int)
(declare-const temp_2_0~831@ Int)
(declare-const temp_2_1~892@ Int)
(declare-const temp_3_0~959@ Int)
(declare-const temp_3_1~996@ Int)
(declare-const temp_4_0~1085@ Int)
(declare-const temp_4_1~1130@ Int)
(declare-const temp_5_0~1213@ Int)
(declare-const temp_5_1~1282@ Int)
(declare-const temp_6_0~1397@ Int)
(declare-const temp_6_1~1474@ Int)
(declare-const temp_7_0~1575@ Int)
(declare-const temp_7_1~1676@ Int)
(declare-const temp_8_0~1831@ Int)
(declare-const temp_8_1~1904@ Int)
(declare-const temp_9_0~2125@ Int)
(declare-const temp_9_1~2190@ Int)
(declare-const temp_10_0~2403@ Int)
(declare-const temp_10_1~2464@ Int)
(declare-const temp_11_0~2543@ Int)
(declare-const temp_11_1~2592@ Int)
(declare-const temp_12_0~2675@ Int)
(declare-const temp_12_1~2728@ Int)
(declare-const temp_13_0~2801@ Int)
(declare-const temp_13_1~2854@ Int)
(declare-const temp_14_0~2977@ Int)
(declare-const temp_14_1~3050@ Int)
(declare-const temp_15_0~3203@ Int)
(declare-const temp_15_1~3268@ Int)
(declare-const temp_16_0~3356@ Int)
(declare-const temp_16_1~3429@ Int)
(declare-const temp_17_0~3546@ Int)
(declare-const temp_17_1~3623@ Int)
(declare-const temp_18_0~3724@ Int)
(declare-const temp_18_1~3789@ Int)
(declare-const temp_19_0~3924@ Int)
(declare-const temp_19_1~3977@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Sub (Mul c0~6@ d0~8@) (Add a0~2@ d0~8@)) (Add (Mul d0~8@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Sub (Mul c0~6@ d0~8@) (Add a0~2@ d0~8@)) (Add (Mul d0~8@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Add b0~4@ b0~4@) (Mul a0~2@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ d0~8@) (=> (= tmp%1@ (Mul (Sub (Mul c0~6@ d0~8@) (Add a0~2@ d0~8@)) (Add (Mul d0~8@ b0~4@) (Mul d0~8@ c0~6@)))) (=> (= tmp%2@ (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= tmp%3@ (Mul (Add b0~4@ b0~4@) (Mul a0~2@ d0~8@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> (= tmp%4@ (Mul (Sub (Mul c0~6@ d0~8@) (Add a0~2@ d0~8@)) (Add (Mul d0~8@ b0~4@) (Mul d0~8@ c0~6@)))) (=> (= tmp%5@ (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= tmp%6@ (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))))))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~587@ (Mul (Sub (Mul (Add a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Sub b1~12@ c1~14@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~684@ (Sub (Mul (Mul (Add a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@)))) (Mul (Mul (Sub b1~12@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@)))))) (and (=> (= tmp%7@ (Mul (Add a1~10@ b1~12@) (Mul c1~14@ a1~10@))) (=> (= tmp%8@ (Mul (Sub b1~12@ c1~14@) (Mul c1~14@ d1~16@))) (=> (= tmp%9@ (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%1 (= temp_1_0~587@ temp_1_1~684@)))))) (=> (= temp_1_0~587@ temp_1_1~684@) (=> (= temp_2_0~831@ (Sub (Mul (Mul (Add a2~18@ b2~20@) (Add a2~18@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Add (Mul c2~22@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Add b2~20@ b2~20@))))) (=> (= temp_2_1~892@ (Sub (Mul (Mul (Add a2~18@ b2~20@) (Add a2~18@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul (Add c2~22@ b2~20@) a2~18@) (Mul (Mul b2~20@ a2~18@) (Add b2~20@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. c2~22@ b2~20@ a2~18@) (=> %%location_label%%2 (= temp_2_0~831@ temp_2_1~892@))) (=> (= temp_2_0~831@ temp_2_1~892@) (=> (= temp_3_0~959@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@))) b3~28@)) (=> (= temp_3_1~996@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@))) b3~28@)) (and (=> (= tmp%10@ (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@))) (=> (= tmp%11@ (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%3 (= temp_3_0~959@ temp_3_1~996@))))) (=> (= temp_3_0~959@ temp_3_1~996@) (=> (= temp_4_0~1085@ (Sub (Mul (Mul (Mul c4~38@ d4~40@) (Sub c4~38@ d4~40@)) a4~34@) (Mul (Mul b4~36@ (Mul a4~34@ a4~34@)) d4~40@))) (=> (= temp_4_1~1130@ (Sub (Mul (Sub (Mul (Mul c4~38@ d4~40@) c4~38@) (Mul (Mul c4~38@ d4~40@) d4~40@)) a4~34@) (Mul (Mul b4~36@ (Mul a4~34@ a4~34@)) d4~40@))) (and (=> (= tmp%12@ (Mul c4~38@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%12@ c4~38@ d4~40@) (=> %%location_label%%4 (= temp_4_0~1085@ temp_4_1~1130@)))) (=> (= temp_4_0~1085@ temp_4_1~1130@) (=> (= temp_5_0~1213@ (Mul (Sub (Sub (Mul c5~46@ d5~48@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ 40) (Sub d5~48@ b5~44@))) c5~46@)) (=> (= temp_5_1~1282@ (Mul (Sub (Sub (Mul c5~46@ d5~48@) (Mul b5~44@ a5~42@)) (Sub (Mul (Mul b5~44@ 40) d5~48@) (Mul (Mul b5~44@ 40) b5~44@))) c5~46@)) (and (=> (= tmp%13@ (Mul b5~44@ 40)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%13@ d5~48@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1213@ temp_5_1~1282@)))) (=> (= temp_5_0~1213@ temp_5_1~1282@) (=> (= temp_6_0~1397@ (Add (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ b6~52@)) (Add (Mul 73 a6~50@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1474@ (Add (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ b6~52@)) (Add (Mul 73 a6~50@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1397@ temp_6_1~1474@))) (=> (= temp_6_0~1397@ temp_6_1~1474@) (=> (= temp_7_0~1575@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ d7~64@) a7~58@)) (Add (Mul (Mul 49 a7~58@) (Mul c7~62@ d7~64@)) (Add (Sub d7~64@ d7~64@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1676@ (Add (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ d7~64@) a7~58@)) (Mul (Mul 49 a7~58@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ d7~64@) a7~58@)) (Add (Sub d7~64@ d7~64@) (Mul d7~64@ b7~60@))))) (and (=> (= tmp%14@ (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ d7~64@) a7~58@))) (=> (= tmp%15@ (Mul (Mul 49 a7~58@) (Mul c7~62@ d7~64@))) (=> (= tmp%16@ (Add (Sub d7~64@ d7~64@) (Mul d7~64@ b7~60@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%7 (= temp_7_0~1575@ temp_7_1~1676@)))))) (=> (= temp_7_0~1575@ temp_7_1~1676@) (=> (= temp_8_0~1831@ (Mul (Mul (Mul (Mul a8~66@ 20) (Mul d8~72@ b8~68@)) (Sub (Mul b8~68@ d8~72@) (Add a8~66@ c8~70@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ c8~70@) b8~68@)))) (=> (= temp_8_1~1904@ (Mul (Mul (Mul (Mul a8~66@ 20) (Mul d8~72@ b8~68@)) (Sub (Mul b8~68@ d8~72@) (Add a8~66@ c8~70@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@)) (Mul b8~68@ (Mul a8~66@ c8~70@))))) (and (=> (= tmp%17@ (Mul a8~66@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ tmp%17@) (=> (= tmp%18@ (Mul (Mul (Mul a8~66@ 20) (Mul d8~72@ b8~68@)) (Sub (Mul b8~68@ d8~72@) (Add a8~66@ c8~70@)))) (=> (= tmp%19@ (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@))) (=> (= tmp%20@ (Mul b8~68@ (Mul a8~66@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> (= tmp%21@ (Mul (Mul (Mul a8~66@ 20) (Mul d8~72@ b8~68@)) (Sub (Mul b8~68@ d8~72@) (Add a8~66@ c8~70@)))) (=> (= tmp%22@ (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@))) (=> (= tmp%23@ (Mul (Mul a8~66@ c8~70@) b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%8 (= temp_8_0~1831@ temp_8_1~1904@)))))))))))) (=> (= temp_8_0~1831@ temp_8_1~1904@) (=> (= temp_9_0~2125@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))) (Mul (Sub (Mul b9~76@ d9~80@) (Mul b9~76@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ b9~76@))))) (=> (= temp_9_1~2190@ (Mul (Mul (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))) (Mul (Sub (Mul b9~76@ d9~80@) (Mul b9~76@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ c9~78@) (=> (= tmp%24@ (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ a9~74@))) (=> (= tmp%25@ (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))) (=> (= tmp%26@ (Mul (Sub (Mul b9~76@ d9~80@) (Mul b9~76@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ b9~76@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> (= tmp%27@ (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ a9~74@))) (=> (= tmp%28@ (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))) (=> (= tmp%29@ (Mul (Sub (Mul b9~76@ d9~80@) (Mul b9~76@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ b9~76@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> %%location_label%%9 (= temp_9_0~2125@ temp_9_1~2190@))))))))))) (=> (= temp_9_0~2125@ temp_9_1~2190@) (=> (= temp_10_0~2403@ (Mul (Sub (Mul (Mul c10~86@ d10~88@) (Sub b10~84@ b10~84@)) (Mul (Mul c10~86@ c10~86@) d10~88@)) (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ a10~82@)) (Mul (Add d10~88@ a10~82@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~2464@ (Mul (Sub (Mul (Mul c10~86@ d10~88@) (Sub b10~84@ b10~84@)) (Mul c10~86@ (Mul c10~86@ d10~88@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ a10~82@)) (Mul (Add d10~88@ a10~82@) (Mul c10~86@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. c10~86@ c10~86@ d10~88@) (=> %%location_label%%10 (= temp_10_0~2403@ temp_10_1~2464@))) (=> (= temp_10_0~2403@ temp_10_1~2464@) (=> (= temp_11_0~2543@ (Mul (Mul a11~90@ (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))) (Mul (Mul (Mul b11~92@ a11~90@) d11~96@) (Add (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~2592@ (Mul (Mul a11~90@ (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))) (Mul (Mul b11~92@ (Mul a11~90@ d11~96@)) (Add (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b11~92@ a11~90@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2543@ temp_11_1~2592@))) (=> (= temp_11_0~2543@ temp_11_1~2592@) (=> (= temp_12_0~2675@ (Mul (Mul d12~104@ (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ a12~98@))) (Mul (Mul (Add d12~104@ a12~98@) (Mul d12~104@ d12~104@)) (Sub (Mul a12~98@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2728@ (Mul (Mul d12~104@ (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ a12~98@))) (Mul (Mul (Mul d12~104@ d12~104@) (Add d12~104@ a12~98@)) (Sub (Mul a12~98@ a12~98@) (Mul c12~102@ d12~104@))))) (and (=> (= tmp%30@ (Mul d12~104@ d12~104@)) (=> (= tmp%31@ (Add d12~104@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%30@ tmp%31@) (=> %%location_label%%12 (= temp_12_0~2675@ temp_12_1~2728@))))) (=> (= temp_12_0~2675@ temp_12_1~2728@) (=> (= temp_13_0~2801@ (Mul a13~106@ (Mul (Sub (Mul c13~110@ c13~110@) (Mul b13~108@ b13~108@)) (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ a13~106@))))) (=> (= temp_13_1~2854@ (Mul a13~106@ (Sub (Mul (Mul c13~110@ c13~110@) (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ a13~106@))) (Mul (Mul b13~108@ b13~108@) (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ a13~106@)))))) (and (=> (= tmp%32@ (Mul c13~110@ c13~110@)) (=> (= tmp%33@ (Mul b13~108@ b13~108@)) (=> (= tmp%34@ (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ a13~106@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%13 (= temp_13_0~2801@ temp_13_1~2854@)))))) (=> (= temp_13_0~2801@ temp_13_1~2854@) (=> (= temp_14_0~2977@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ b14~116@)) (Mul (Mul d14~120@ a14~114@) (Mul c14~118@ d14~120@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul b14~116@ b14~116@)) (Mul (Mul a14~114@ 8) b14~116@)))) (=> (= temp_14_1~3050@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ b14~116@)) (Mul (Mul d14~120@ a14~114@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul b14~116@ b14~116@)) (Mul (Mul a14~114@ 8) b14~116@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ c14~118@) (=> (= tmp%35@ (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ b14~116@))) (=> (= tmp%36@ (Mul d14~120@ a14~114@)) (=> (= tmp%37@ (Mul d14~120@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ tmp%36@ tmp%37@) (=> (= tmp%38@ (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ b14~116@))) (=> (= tmp%39@ (Mul d14~120@ a14~114@)) (=> (= tmp%40@ (Mul c14~118@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> %%location_label%%14 (= temp_14_0~2977@ temp_14_1~3050@))))))))))) (=> (= temp_14_0~2977@ temp_14_1~3050@) (=> (= temp_15_0~3203@ (Mul (Add (Mul (Add b15~124@ c15~126@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ a15~122@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ b15~124@)) (Mul (Sub b15~124@ d15~128@) (Add c15~126@ d15~128@))))) (=> (= temp_15_1~3268@ (Mul (Add (Mul (Add b15~124@ c15~126@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ a15~122@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ b15~124@)) (Mul (Sub b15~124@ d15~128@) (Add c15~126@ d15~128@))))) (=> (= tmp%41@ (= temp_15_0~3203@ temp_15_1~3268@)) (and (=> %%location_label%%15 tmp%41@) (=> tmp%41@ (=> (= temp_16_0~3356@ (Mul (Add (Mul (Sub c16~134@ b16~132@) (Mul c16~134@ b16~132@)) (Mul (Add c16~134@ a16~130@) (Sub a16~130@ 70))) (Mul (Mul b16~132@ (Mul c16~134@ a16~130@)) (Sub (Mul d16~136@ a16~130@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~3429@ (Mul (Add (Mul (Sub c16~134@ b16~132@) (Mul c16~134@ b16~132@)) (Mul (Sub a16~130@ 70) (Add c16~134@ a16~130@))) (Mul (Mul b16~132@ (Mul c16~134@ a16~130@)) (Sub (Mul d16~136@ a16~130@) (Mul c16~134@ a16~130@))))) (and (=> (= tmp%42@ (Sub a16~130@ 70)) (=> (= tmp%43@ (Add c16~134@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%42@ tmp%43@) (=> %%location_label%%16 (= temp_16_0~3356@ temp_16_1~3429@))))) (=> (= temp_16_0~3356@ temp_16_1~3429@) (=> (= temp_17_0~3546@ (Sub (Mul (Sub (Mul 16 d17~144@) (Mul d17~144@ b17~140@)) (Sub (Add a17~138@ c17~142@) (Mul 21 d17~144@))) (Mul (Mul (Sub a17~138@ b17~140@) (Mul d17~144@ d17~144@)) c17~142@))) (=> (= temp_17_1~3623@ (Sub (Mul (Sub (Mul 16 d17~144@) (Mul d17~144@ b17~140@)) (Sub (Add a17~138@ c17~142@) (Mul 21 d17~144@))) (Mul (Mul (Mul d17~144@ d17~144@) (Sub a17~138@ b17~140@)) c17~142@))) (and (=> (= tmp%44@ (Mul d17~144@ d17~144@)) (=> (= tmp%45@ (Sub a17~138@ b17~140@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%44@ tmp%45@) (=> %%location_label%%17 (= temp_17_0~3546@ temp_17_1~3623@))))) (=> (= temp_17_0~3546@ temp_17_1~3623@) (=> (= temp_18_0~3724@ (Mul (Sub (Mul (Sub b18~148@ a18~146@) (Mul d18~152@ b18~148@)) (Mul (Mul a18~146@ c18~150@) (Sub d18~152@ c18~150@))) (Mul (Add (Sub b18~148@ b18~148@) (Mul b18~148@ d18~152@)) (Mul (Mul c18~150@ d18~152@) (Mul a18~146@ a18~146@))))) (=> (= temp_18_1~3789@ (Mul (Mul (Sub (Mul (Sub b18~148@ a18~146@) (Mul d18~152@ b18~148@)) (Mul (Mul a18~146@ c18~150@) (Sub d18~152@ c18~150@))) (Add (Sub b18~148@ b18~148@) (Mul b18~148@ d18~152@))) (Mul (Mul c18~150@ d18~152@) (Mul a18~146@ a18~146@)))) (and (=> (= tmp%46@ (Sub (Mul (Sub b18~148@ a18~146@) (Mul d18~152@ b18~148@)) (Mul (Mul a18~146@ c18~150@) (Sub d18~152@ c18~150@)))) (=> (= tmp%47@ (Add (Sub b18~148@ b18~148@) (Mul b18~148@ d18~152@))) (=> (= tmp%48@ (Mul (Mul c18~150@ d18~152@) (Mul a18~146@ a18~146@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%46@ tmp%47@ tmp%48@) (=> %%location_label%%18 (= temp_18_0~3724@ temp_18_1~3789@)))))) (=> (= temp_18_0~3724@ temp_18_1~3789@) (=> (= temp_19_0~3924@ (Mul (Mul a19~154@ (Mul (Add d19~160@ b19~156@) (Mul c19~158@ c19~158@))) (Mul (Sub (Mul c19~158@ d19~160@) (Sub d19~160@ a19~154@)) (Add (Mul d19~160@ b19~156@) (Mul c19~158@ a19~154@))))) (=> (= temp_19_1~3977@ (Mul (Mul a19~154@ (Mul (Add d19~160@ b19~156@) (Mul c19~158@ c19~158@))) (Mul (Add (Mul d19~160@ b19~156@) (Mul c19~158@ a19~154@)) (Sub (Mul c19~158@ d19~160@) (Sub d19~160@ a19~154@))))) (=> (= tmp%49@ (Add (Mul d19~160@ b19~156@) (Mul c19~158@ a19~154@))) (=> (= tmp%50@ (Sub (Mul c19~158@ d19~160@) (Sub d19~160@ a19~154@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%49@ tmp%50@) (=> %%location_label%%19 (= temp_19_0~3924@ temp_19_1~3977@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
