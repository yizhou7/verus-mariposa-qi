...
(declare-const temp_1_1~650@ Int)
(declare-const temp_2_0~863@ Int)
(declare-const temp_2_1~924@ Int)
(declare-const temp_3_0~1017@ Int)
(declare-const temp_3_1~1082@ Int)
(declare-const temp_4_0~1199@ Int)
(declare-const temp_4_1~1264@ Int)
(declare-const temp_5_0~1344@ Int)
(declare-const temp_5_1~1409@ Int)
(declare-const temp_6_0~1482@ Int)
(declare-const temp_6_1~1519@ Int)
(declare-const temp_7_0~1684@ Int)
(declare-const temp_7_1~1761@ Int)
(declare-const temp_8_0~1958@ Int)
(declare-const temp_8_1~1983@ Int)
(declare-const temp_9_0~2090@ Int)
(declare-const temp_9_1~2163@ Int)
(declare-const temp_10_0~2298@ Int)
(declare-const temp_10_1~2387@ Int)
(declare-const temp_11_0~2506@ Int)
(declare-const temp_11_1~2571@ Int)
(declare-const temp_12_0~2672@ Int)
(declare-const temp_12_1~2737@ Int)
(declare-const temp_13_0~2816@ Int)
(declare-const temp_13_1~2861@ Int)
(declare-const temp_14_0~3050@ Int)
(declare-const temp_14_1~3127@ Int)
(declare-const temp_15_0~3204@ Int)
(declare-const temp_15_1~3253@ Int)
(declare-const temp_16_0~3362@ Int)
(declare-const temp_16_1~3435@ Int)
(declare-const temp_17_0~3592@ Int)
(declare-const temp_17_1~3665@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~309@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@)) (Mul (Mul d0~8@ d0~8@) b0~4@)) (Mul (Sub (Mul c0~6@ b0~4@) 66) (Sub (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~378@ (Mul (Mul (Mul b0~4@ (Mul a0~2@ (Add c0~6@ c0~6@))) (Mul (Mul d0~8@ d0~8@) b0~4@)) (Mul (Sub (Mul c0~6@ b0~4@) 66) (Sub (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))))) (and (=> (= tmp%1@ (Add c0~6@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ a0~2@ tmp%1@) (=> (= tmp%2@ (Mul b0~4@ (Mul a0~2@ (Add c0~6@ c0~6@)))) (=> (= tmp%3@ (Mul (Mul d0~8@ d0~8@) b0~4@)) (=> (= tmp%4@ (Mul (Sub (Mul c0~6@ b0~4@) 66) (Sub (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> (= tmp%5@ (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@))) (=> (= tmp%6@ (Mul (Mul d0~8@ d0~8@) b0~4@)) (=> (= tmp%7@ (Mul (Sub (Mul c0~6@ b0~4@) 66) (Sub (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%0 (= temp_0_0~309@ temp_0_1~378@)))))))))))) (=> (= temp_0_0~309@ temp_0_1~378@) (=> (= temp_1_0~589@ (Mul (Mul (Mul (Sub b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Add a1~10@ b1~12@))) (Mul (Mul (Mul b1~12@ a1~10@) (Add a1~10@ d1~16@)) (Mul b1~12@ (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~650@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Sub b1~12@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Add a1~10@ b1~12@))) (Mul (Mul (Mul b1~12@ a1~10@) (Add a1~10@ d1~16@)) (Mul b1~12@ (Mul a1~10@ a1~10@))))) (and (=> (= tmp%8@ (Mul b1~12@ c1~14@)) (=> (= tmp%9@ (Sub b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> (= tmp%10@ (Mul (Mul b1~12@ c1~14@) (Sub b1~12@ c1~14@))) (=> (= tmp%11@ (Mul (Mul b1~12@ a1~10@) (Add a1~10@ b1~12@))) (=> (= tmp%12@ (Mul (Mul (Mul b1~12@ a1~10@) (Add a1~10@ d1~16@)) (Mul b1~12@ (Mul a1~10@ a1~10@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> (= tmp%13@ (Mul (Sub b1~12@ c1~14@) (Mul b1~12@ c1~14@))) (=> (= tmp%14@ (Mul (Mul b1~12@ a1~10@) (Add a1~10@ b1~12@))) (=> (= tmp%15@ (Mul (Mul (Mul b1~12@ a1~10@) (Add a1~10@ d1~16@)) (Mul b1~12@ (Mul a1~10@ a1~10@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%1 (= temp_1_0~589@ temp_1_1~650@))))))))))))) (=> (= temp_1_0~589@ temp_1_1~650@) (=> (= temp_2_0~863@ (Add (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul a2~18@ c2~22@) d2~24@) (Sub (Sub b2~20@ d2~24@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~924@ (Add (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul a2~18@ c2~22@) d2~24@) (Sub (Sub b2~20@ d2~24@) (Mul b2~20@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ c2~22@) (=> %%location_label%%2 (= temp_2_0~863@ temp_2_1~924@))) (=> (= temp_2_0~863@ temp_2_1~924@) (=> (= temp_3_0~1017@ (Mul (Mul (Sub (Mul a3~26@ d3~32@) (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~1082@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@)) (Sub (Mul a3~26@ d3~32@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@))))) (and (=> (= tmp%16@ (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@))) (=> (= tmp%17@ (Sub (Mul a3~26@ d3~32@) (Mul d3~32@ d3~32@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%3 (= temp_3_0~1017@ temp_3_1~1082@))))) (=> (= temp_3_0~1017@ temp_3_1~1082@) (=> (= temp_4_0~1199@ (Mul (Mul (Add (Mul c4~38@ a4~34@) (Add b4~36@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))) (Add (Sub (Mul d4~40@ d4~40@) (Mul d4~40@ a4~34@)) (Sub (Add a4~34@ c4~38@) (Add c4~38@ b4~36@))))) (=> (= temp_4_1~1264@ (Mul (Mul (Add (Mul c4~38@ a4~34@) (Add b4~36@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))) (Add (Sub (Mul d4~40@ d4~40@) (Mul d4~40@ a4~34@)) (Sub (Add a4~34@ c4~38@) (Add c4~38@ b4~36@))))) (=> (= tmp%18@ (= temp_4_0~1199@ temp_4_1~1264@)) (and (=> %%location_label%%4 tmp%18@) (=> tmp%18@ (=> (= temp_5_0~1344@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Sub (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ b5~44@) (Sub b5~44@ b5~44@)) (Add (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1409@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Sub (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@))) (Mul (Mul (Sub b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Add (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@))))) (and (=> (= tmp%19@ (Sub b5~44@ b5~44@)) (=> (= tmp%20@ (Mul c5~46@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%5 (= temp_5_0~1344@ temp_5_1~1409@))))) (=> (= temp_5_0~1344@ temp_5_1~1409@) (=> (= temp_6_0~1482@ (Mul a6~50@ (Mul (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1519@ (Mul a6~50@ (Mul (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ d6~56@) (=> (= tmp%21@ (Mul c6~54@ d6~56@)) (=> (= tmp%22@ (Mul b6~52@ d6~56@)) (=> (= tmp%23@ (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> (= tmp%24@ (Mul d6~56@ c6~54@)) (=> (= tmp%25@ (Mul b6~52@ d6~56@)) (=> (= tmp%26@ (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%6 (= temp_6_0~1482@ temp_6_1~1519@))))))))))) (=> (= temp_6_0~1482@ temp_6_1~1519@) (=> (= temp_7_0~1684@ (Mul (Mul (Mul (Mul 5 b7~60@) (Sub a7~58@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))) (Add (Mul (Sub a7~58@ a7~58@) (Add d7~64@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1761@ (Mul (Mul (Mul (Sub a7~58@ a7~58@) (Mul 5 b7~60@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))) (Add (Mul (Sub a7~58@ a7~58@) (Add d7~64@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ d7~64@))))) (and (=> (= tmp%27@ (Sub a7~58@ a7~58@)) (=> (= tmp%28@ (Mul 5 b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> (= tmp%29@ (Mul (Sub a7~58@ a7~58@) (Mul 5 b7~60@))) (=> (= tmp%30@ (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))) (=> (= tmp%31@ (Add (Mul (Sub a7~58@ a7~58@) (Add d7~64@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ d7~64@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> (= tmp%32@ (Mul (Mul 5 b7~60@) (Sub a7~58@ a7~58@))) (=> (= tmp%33@ (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))) (=> (= tmp%34@ (Add (Mul (Sub a7~58@ a7~58@) (Add d7~64@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ d7~64@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%7 (= temp_7_0~1684@ temp_7_1~1761@))))))))))))) (=> (= temp_7_0~1684@ temp_7_1~1761@) (=> (= temp_8_0~1958@ (Add (Mul a8~66@ (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ d8~72@))) c8~70@)) (=> (= temp_8_1~1983@ (Add (Mul a8~66@ (Mul (Mul (Mul c8~70@ c8~70@) d8~72@) d8~72@)) c8~70@)) (and (=> (= tmp%35@ (Mul c8~70@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ d8~72@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1958@ temp_8_1~1983@)))) (=> (= temp_8_0~1958@ temp_8_1~1983@) (=> (= temp_9_0~2090@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Mul d9~80@ (Sub c9~78@ a9~74@))) (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul 69 c9~78@) (Mul d9~80@ b9~76@))))) (=> (= temp_9_1~2163@ (Mul (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) d9~80@) (Sub c9~78@ a9~74@)) (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul 69 c9~78@) (Mul d9~80@ b9~76@))))) (and (=> (= tmp%36@ (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@))) (=> (= tmp%37@ (Sub c9~78@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ d9~80@ tmp%37@) (=> %%location_label%%9 (= temp_9_0~2090@ temp_9_1~2163@))))) (=> (= temp_9_0~2090@ temp_9_1~2163@) (=> (= temp_10_0~2298@ (Mul (Mul (Mul (Mul a10~82@ a10~82@) (Mul b10~84@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Mul 85 a10~82@))) (Add (Mul (Mul c10~86@ d10~88@) (Sub d10~88@ d10~88@)) (Mul (Mul b10~84@ 99) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~2387@ (Mul (Mul (Mul a10~82@ a10~82@) (Mul (Mul b10~84@ b10~84@) (Mul (Mul a10~82@ d10~88@) (Mul 85 a10~82@)))) (Add (Mul (Mul c10~86@ d10~88@) (Sub d10~88@ d10~88@)) (Mul (Mul b10~84@ 99) (Mul c10~86@ d10~88@))))) (and (=> (= tmp%38@ (Mul a10~82@ a10~82@)) (=> (= tmp%39@ (Mul b10~84@ b10~84@)) (=> (= tmp%40@ (Mul (Mul a10~82@ d10~88@) (Mul 85 a10~82@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> %%location_label%%10 (= temp_10_0~2298@ temp_10_1~2387@)))))) (=> (= temp_10_0~2298@ temp_10_1~2387@) (=> (= temp_11_0~2506@ (Add (Mul (Mul (Add a11~90@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (Mul c11~94@ a11~90@) (Sub d11~96@ a11~90@))) (Mul (Mul (Mul c11~94@ d11~96@) (Sub a11~90@ a11~90@)) (Add (Mul a11~90@ c11~94@) (Mul c11~94@ d11~96@))))) (=> (= temp_11_1~2571@ (Add (Mul (Mul (Add a11~90@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (Mul c11~94@ a11~90@) (Sub d11~96@ a11~90@))) (Mul (Mul (Sub a11~90@ a11~90@) (Mul c11~94@ d11~96@)) (Add (Mul a11~90@ c11~94@) (Mul c11~94@ d11~96@))))) (and (=> (= tmp%41@ (Sub a11~90@ a11~90@)) (=> (= tmp%42@ (Mul c11~94@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%41@ tmp%42@) (=> %%location_label%%11 (= temp_11_0~2506@ temp_11_1~2571@))))) (=> (= temp_11_0~2506@ temp_11_1~2571@) (=> (= temp_12_0~2672@ (Mul (Mul (Mul (Sub a12~98@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Sub d12~104@ a12~98@) (Mul d12~104@ c12~102@))) (Sub (Add (Add b12~100@ a12~98@) (Mul c12~102@ a12~98@)) (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2737@ (Mul (Mul (Mul (Sub a12~98@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Sub d12~104@ a12~98@) (Mul d12~104@ c12~102@))) (Sub (Add (Add b12~100@ a12~98@) (Mul c12~102@ a12~98@)) (Mul b12~100@ (Mul d12~104@ (Mul c12~102@ d12~104@)))))) (and (=> (= tmp%43@ (Mul c12~102@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b12~100@ d12~104@ tmp%43@) (=> %%location_label%%12 (= temp_12_0~2672@ temp_12_1~2737@)))) (=> (= temp_12_0~2672@ temp_12_1~2737@) (=> (= temp_13_0~2816@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) c13~110@) d13~112@) (Mul (Mul a13~106@ (Mul b13~108@ b13~108@)) (Sub (Mul d13~112@ a13~106@) (Mul a13~106@ b13~108@))))) (=> (= temp_13_1~2861@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) c13~110@) d13~112@) (Mul (Mul a13~106@ (Mul b13~108@ b13~108@)) (Sub (Mul d13~112@ a13~106@) (Mul b13~108@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b13~108@ a13~106@) (=> (= tmp%44@ (Mul (Mul (Mul d13~112@ b13~108@) c13~110@) d13~112@)) (=> (= tmp%45@ (Mul a13~106@ (Mul b13~108@ b13~108@))) (=> (= tmp%46@ (Sub (Mul d13~112@ a13~106@) (Mul b13~108@ a13~106@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%44@ tmp%45@ tmp%46@) (=> (= tmp%47@ (Mul (Mul (Mul d13~112@ b13~108@) c13~110@) d13~112@)) (=> (= tmp%48@ (Mul a13~106@ (Mul b13~108@ b13~108@))) (=> (= tmp%49@ (Sub (Mul d13~112@ a13~106@) (Mul a13~106@ b13~108@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%47@ tmp%48@ tmp%49@) (=> %%location_label%%13 (= temp_13_0~2816@ temp_13_1~2861@))))))))))) (=> (= temp_13_0~2816@ temp_13_1~2861@) (=> (= temp_14_0~3050@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ c14~118@)) (Sub (Mul b14~116@ b14~116@) (Mul b14~116@ c14~118@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@)) (Mul (Add d14~120@ 14) (Mul d14~120@ b14~116@))))) (=> (= temp_14_1~3127@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ c14~118@)) (Sub (Mul b14~116@ b14~116@) (Mul b14~116@ c14~118@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul a14~114@ d14~120@)) (Mul (Add d14~120@ 14) (Mul d14~120@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a14~114@ d14~120@) (=> %%location_label%%14 (= temp_14_0~3050@ temp_14_1~3127@))) (=> (= temp_14_0~3050@ temp_14_1~3127@) (=> (= temp_15_0~3204@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul c15~126@ 13)) (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ b15~124@))) c15~126@)) (=> (= temp_15_1~3253@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul c15~126@ 13)) (Mul (Mul d15~128@ b15~124@) (Mul a15~122@ c15~126@))) c15~126@)) (and (=> (= tmp%50@ (Mul d15~128@ b15~124@)) (=> (= tmp%51@ (Mul a15~122@ c15~126@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%50@ tmp%51@) (=> %%location_label%%15 (= temp_15_0~3204@ temp_15_1~3253@))))) (=> (= temp_15_0~3204@ temp_15_1~3253@) (=> (= temp_16_0~3362@ (Mul (Mul (Mul (Add d16~136@ d16~136@) (Mul b16~132@ c16~134@)) (Mul (Mul b16~132@ 54) (Mul b16~132@ c16~134@))) (Mul (Sub d16~136@ (Mul d16~136@ c16~134@)) (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ a16~130@))))) (=> (= temp_16_1~3435@ (Mul (Mul (Sub d16~136@ (Mul d16~136@ c16~134@)) (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ a16~130@))) (Mul (Mul (Add d16~136@ d16~136@) (Mul b16~132@ c16~134@)) (Mul (Mul b16~132@ 54) (Mul b16~132@ c16~134@))))) (and (=> (= tmp%52@ (Mul (Sub d16~136@ (Mul d16~136@ c16~134@)) (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ a16~130@)))) (=> (= tmp%53@ (Mul (Mul (Add d16~136@ d16~136@) (Mul b16~132@ c16~134@)) (Mul (Mul b16~132@ 54) (Mul b16~132@ c16~134@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%52@ tmp%53@) (=> %%location_label%%16 (= temp_16_0~3362@ temp_16_1~3435@))))) (=> (= temp_16_0~3362@ temp_16_1~3435@) (=> (= temp_17_0~3592@ (Mul (Mul (Mul (Mul a17~138@ 45) (Mul c17~142@ a17~138@)) (Sub (Mul b17~140@ a17~138@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul c17~142@ b17~140@) d17~144@)))) (=> (= temp_17_1~3665@ (Mul (Mul (Mul (Mul 45 a17~138@) (Mul c17~142@ a17~138@)) (Sub (Mul b17~140@ a17~138@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul c17~142@ b17~140@) d17~144@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. 45 a17~138@) (=> (= tmp%54@ (Mul (Mul 45 a17~138@) (Mul c17~142@ a17~138@))) (=> (= tmp%55@ (Sub (Mul b17~140@ a17~138@) (Mul b17~140@ b17~140@))) (=> (= tmp%56@ (Mul (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul c17~142@ b17~140@) d17~144@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%54@ tmp%55@ tmp%56@) (=> (= tmp%57@ (Mul (Mul a17~138@ 45) (Mul c17~142@ a17~138@))) (=> (= tmp%58@ (Sub (Mul b17~140@ a17~138@) (Mul b17~140@ b17~140@))) (=> (= tmp%59@ (Mul (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul c17~142@ b17~140@) d17~144@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%57@ tmp%58@ tmp%59@) (=> %%location_label%%17 (= temp_17_0~3592@ temp_17_1~3665@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
