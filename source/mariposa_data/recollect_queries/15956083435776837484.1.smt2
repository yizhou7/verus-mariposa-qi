...
(declare-const temp_2_1~775@ Int)
(declare-const temp_3_0~1000@ Int)
(declare-const temp_3_1~1073@ Int)
(declare-const temp_4_0~1172@ Int)
(declare-const temp_4_1~1237@ Int)
(declare-const temp_5_0~1320@ Int)
(declare-const temp_5_1~1369@ Int)
(declare-const temp_6_0~1548@ Int)
(declare-const temp_6_1~1601@ Int)
(declare-const temp_7_0~1806@ Int)
(declare-const temp_7_1~1875@ Int)
(declare-const temp_8_0~1970@ Int)
(declare-const temp_8_1~2035@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ b0~4@)) (Sub (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@))) (Add (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@)) (Add (Mul a0~2@ a0~2@) (Sub c0~6@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ b0~4@)) (Sub (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@))) (Add (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@)) (Add (Mul a0~2@ a0~2@) (Sub c0~6@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~450@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ c1~14@))) (Add (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~547@ (Add (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ c1~14@))) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ c1~14@))) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ c1~14@))))) (and (=> (= tmp%2@ (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ c1~14@)))) (=> (= tmp%3@ (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@))) (=> (= tmp%4@ (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%2@ tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~450@ temp_1_1~547@)))))) (=> (= temp_1_0~450@ temp_1_1~547@) (=> (= temp_2_0~702@ (Mul (Sub (Mul (Mul c2~22@ c2~22@) (Sub a2~18@ c2~22@)) (Mul a2~18@ (Mul c2~22@ c2~22@))) (Mul (Mul (Sub a2~18@ d2~24@) (Mul 84 c2~22@)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~775@ (Mul (Sub (Mul (Mul c2~22@ c2~22@) (Sub a2~18@ c2~22@)) (Mul a2~18@ (Mul c2~22@ c2~22@))) (Mul (Mul (Sub a2~18@ d2~24@) (Mul 84 c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ d2~24@))))) (and (=> (= tmp%5@ (Mul c2~22@ c2~22@)) (=> (= tmp%6@ (Mul b2~20@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> (= tmp%7@ (Sub (Mul (Mul c2~22@ c2~22@) (Sub a2~18@ c2~22@)) (Mul a2~18@ (Mul c2~22@ c2~22@)))) (=> (= tmp%8@ (Mul (Sub a2~18@ d2~24@) (Mul 84 c2~22@))) (=> (= tmp%9@ (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ d2~24@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> (= tmp%10@ (Sub (Mul (Mul c2~22@ c2~22@) (Sub a2~18@ c2~22@)) (Mul a2~18@ (Mul c2~22@ c2~22@)))) (=> (= tmp%11@ (Mul (Sub a2~18@ d2~24@) (Mul 84 c2~22@))) (=> (= tmp%12@ (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%2 (= temp_2_0~702@ temp_2_1~775@))))))))))))) (=> (= temp_2_0~702@ temp_2_1~775@) (=> (= temp_3_0~1000@ (Mul (Mul (Add (Mul a3~26@ d3~32@) (Mul d3~32@ c3~30@)) (Mul (Add d3~32@ a3~26@) (Mul d3~32@ c3~30@))) (Mul (Mul (Sub b3~28@ d3~32@) (Mul b3~28@ b3~28@)) (Add (Mul a3~26@ c3~30@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~1073@ (Mul (Mul (Add (Mul a3~26@ d3~32@) (Mul d3~32@ c3~30@)) (Mul (Add d3~32@ a3~26@) (Mul d3~32@ c3~30@))) (Mul (Sub (Mul b3~28@ (Mul b3~28@ b3~28@)) (Mul d3~32@ (Mul b3~28@ b3~28@))) (Add (Mul a3~26@ c3~30@) (Mul c3~30@ a3~26@))))) (and (=> (= tmp%13@ (Mul b3~28@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b3~28@ d3~32@ tmp%13@) (=> %%location_label%%3 (= temp_3_0~1000@ temp_3_1~1073@)))) (=> (= temp_3_0~1000@ temp_3_1~1073@) (=> (= temp_4_0~1172@ (Mul (Mul (Mul (Add c4~38@ b4~36@) (Mul b4~36@ d4~40@)) (Add (Mul a4~34@ b4~36@) (Mul d4~40@ a4~34@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~1237@ (Mul (Mul (Mul (Add c4~38@ b4~36@) (Mul b4~36@ d4~40@)) (Add (Mul a4~34@ b4~36@) (Mul d4~40@ a4~34@))) (Mul (Mul d4~40@ (Mul a4~34@ (Mul a4~34@ b4~36@))) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ a4~34@))))) (and (=> (= tmp%14@ (Mul a4~34@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d4~40@ a4~34@ tmp%14@) (=> %%location_label%%4 (= temp_4_0~1172@ temp_4_1~1237@)))) (=> (= temp_4_0~1172@ temp_4_1~1237@) (=> (= temp_5_0~1320@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) d5~48@) b5~44@) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1369@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) d5~48@) b5~44@) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Mul (Mul b5~44@ a5~42@) a5~42@) d5~48@)))) (and (=> (= tmp%15@ (Mul (Mul (Mul b5~44@ d5~48@) d5~48@) b5~44@)) (=> (= tmp%16@ (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@))) (=> (= tmp%17@ (Mul (Mul (Mul b5~44@ a5~42@) a5~42@) d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> (= tmp%18@ (Mul b5~44@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ a5~42@ d5~48@) (=> (= tmp%19@ (Mul (Mul (Mul b5~44@ d5~48@) d5~48@) b5~44@)) (=> (= tmp%20@ (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@))) (=> (= tmp%21@ (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%5 (= temp_5_0~1320@ temp_5_1~1369@)))))))))))) (=> (= temp_5_0~1320@ temp_5_1~1369@) (=> (= temp_6_0~1548@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) c6~54@) (Sub (Mul d6~56@ c6~54@) (Mul b6~52@ c6~54@))) (Mul (Mul (Mul a6~50@ c6~54@) d6~56@) (Mul c6~54@ (Add d6~56@ b6~52@))))) (=> (= temp_6_1~1601@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) c6~54@) (Sub (Mul d6~56@ c6~54@) (Mul b6~52@ c6~54@))) (Mul (Mul (Mul a6~50@ c6~54@) d6~56@) (Mul (Add d6~56@ b6~52@) c6~54@)))) (and (=> (= tmp%22@ (Add d6~56@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ c6~54@) (=> (= tmp%23@ (Mul (Mul (Mul a6~50@ d6~56@) c6~54@) (Sub (Mul d6~56@ c6~54@) (Mul b6~52@ c6~54@)))) (=> (= tmp%24@ (Mul (Mul a6~50@ c6~54@) d6~56@)) (=> (= tmp%25@ (Mul (Add d6~56@ b6~52@) c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> (= tmp%26@ (Mul (Mul (Mul a6~50@ d6~56@) c6~54@) (Sub (Mul d6~56@ c6~54@) (Mul b6~52@ c6~54@)))) (=> (= tmp%27@ (Mul (Mul a6~50@ c6~54@) d6~56@)) (=> (= tmp%28@ (Mul c6~54@ (Add d6~56@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> %%location_label%%6 (= temp_6_0~1548@ temp_6_1~1601@)))))))))))) (=> (= temp_6_0~1548@ temp_6_1~1601@) (=> (= temp_7_0~1806@ (Mul (Mul (Add (Mul d7~64@ b7~60@) (Mul b7~60@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ 87))) (Mul (Add (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ d7~64@) a7~58@)))) (=> (= temp_7_1~1875@ (Mul (Mul (Add (Mul d7~64@ b7~60@) (Mul b7~60@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ 87))) (Mul (Mul a7~58@ (Add d7~64@ c7~62@)) (Mul (Mul c7~62@ d7~64@) a7~58@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. a7~58@ d7~64@ c7~62@) (=> %%location_label%%7 (= temp_7_0~1806@ temp_7_1~1875@))) (=> (= temp_7_0~1806@ temp_7_1~1875@) (=> (= temp_8_0~1970@ (Mul (Mul (Mul (Sub b8~68@ c8~70@) (Mul c8~70@ a8~66@)) (Sub (Mul a8~66@ d8~72@) (Sub b8~68@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Add a8~66@ b8~68@))))) (=> (= temp_8_1~2035@ (Mul (Mul (Mul (Sub b8~68@ c8~70@) (Mul c8~70@ a8~66@)) (Sub (Mul a8~66@ d8~72@) (Sub b8~68@ d8~72@))) (Mul (Mul d8~72@ (Mul a8~66@ (Mul a8~66@ a8~66@))) (Mul (Mul b8~68@ d8~72@) (Add a8~66@ b8~68@))))) (=> (= tmp%29@ (Mul a8~66@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d8~72@ a8~66@ tmp%29@) (=> %%location_label%%8 (= temp_8_0~1970@ temp_8_1~2035@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
