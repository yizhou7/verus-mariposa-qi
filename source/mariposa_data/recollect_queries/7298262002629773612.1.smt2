...
(declare-const temp_2_1~856@ Int)
(declare-const temp_3_0~965@ Int)
(declare-const temp_3_1~1050@ Int)
(declare-const temp_4_0~1145@ Int)
(declare-const temp_4_1~1206@ Int)
(declare-const temp_5_0~1413@ Int)
(declare-const temp_5_1~1470@ Int)
(declare-const temp_6_0~1581@ Int)
(declare-const temp_6_1~1646@ Int)
(declare-const temp_7_0~1785@ Int)
(declare-const temp_7_1~1874@ Int)
(declare-const temp_8_0~1971@ Int)
(declare-const temp_8_1~2032@ Int)
(declare-const temp_9_0~2116@ Int)
(declare-const temp_9_1~2185@ Int)
(declare-const temp_10_0~2284@ Int)
(declare-const temp_10_1~2349@ Int)
(declare-const temp_11_0~2464@ Int)
(declare-const temp_11_1~2529@ Int)
(declare-const temp_12_0~2605@ Int)
(declare-const temp_12_1~2666@ Int)
(declare-const temp_13_0~2731@ Int)
(declare-const temp_13_1~2768@ Int)
(declare-const temp_14_0~2857@ Int)
(declare-const temp_14_1~2918@ Int)
(declare-const temp_15_0~3127@ Int)
(declare-const temp_15_1~3192@ Int)
(declare-const temp_16_0~3429@ Int)
(declare-const temp_16_1~3506@ Int)
(declare-const temp_17_0~3751@ Int)
(declare-const temp_17_1~3828@ Int)
(declare-const temp_18_0~3919@ Int)
(declare-const temp_18_1~3976@ Int)
(declare-const temp_19_0~4071@ Int)
(declare-const temp_19_1~4136@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Sub (Sub a0~2@ (Mul (Mul 76 c0~6@) (Mul d0~8@ a0~2@))) (Mul a0~2@ (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~346@ (Sub (Sub a0~2@ (Mul (Mul 76 c0~6@) (Mul d0~8@ a0~2@))) (Mul a0~2@ (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@))))) (and (=> (= tmp%1@ (Mul b0~4@ c0~6@)) (=> (= tmp%2@ (Mul d0~8@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@))))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~447@ (Mul (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ a1~10@))) (Mul (Add (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Sub d1~16@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~512@ (Mul (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ a1~10@))) (Mul (Add (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul (Sub d1~16@ b1~12@) c1~14@) d1~16@)))) (and (=> (= tmp%3@ (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ a1~10@)))) (=> (= tmp%4@ (Add (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@))) (=> (= tmp%5@ (Mul (Mul (Sub d1~16@ b1~12@) c1~14@) d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Sub d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ c1~14@ d1~16@) (=> (= tmp%7@ (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ a1~10@)))) (=> (= tmp%8@ (Add (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@))) (=> (= tmp%9@ (Mul (Sub d1~16@ b1~12@) (Mul c1~14@ d1~16@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~512@)))))))))))) (=> (= temp_1_0~447@ temp_1_1~512@) (=> (= temp_2_0~763@ (Mul (Add (Mul 23 (Mul 26 a2~18@)) (Mul a2~18@ (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul 98 a2~18@))))) (=> (= temp_2_1~856@ (Mul (Add (Mul 23 (Mul a2~18@ 26)) (Mul a2~18@ (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul 98 a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ 26) (=> %%location_label%%2 (= temp_2_0~763@ temp_2_1~856@))) (=> (= temp_2_0~763@ temp_2_1~856@) (=> (= temp_3_0~965@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Add d3~32@ 91)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub c3~30@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@))))) (=> (= temp_3_1~1050@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Add d3~32@ 91)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Sub (Mul (Mul c3~30@ d3~32@) c3~30@) (Mul (Mul c3~30@ d3~32@) d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@))))) (and (=> (= tmp%10@ (Mul c3~30@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%10@ c3~30@ d3~32@) (=> %%location_label%%3 (= temp_3_0~965@ temp_3_1~1050@)))) (=> (= temp_3_0~965@ temp_3_1~1050@) (=> (= temp_4_0~1145@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ d4~40@) c4~38@)) (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@))))) (=> (= temp_4_1~1206@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ d4~40@) c4~38@)) (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@)) (Mul d4~40@ (Mul d4~40@ (Mul a4~34@ a4~34@)))))) (and (=> (= tmp%11@ (Mul a4~34@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d4~40@ d4~40@ tmp%11@) (=> (= tmp%12@ (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ d4~40@) c4~38@))) (=> (= tmp%13@ (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@))) (=> (= tmp%14@ (Mul d4~40@ (Mul d4~40@ (Mul a4~34@ a4~34@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> (= tmp%15@ (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ d4~40@) c4~38@))) (=> (= tmp%16@ (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@))) (=> (= tmp%17@ (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%4 (= temp_4_0~1145@ temp_4_1~1206@)))))))))))) (=> (= temp_4_0~1145@ temp_4_1~1206@) (=> (= temp_5_0~1413@ (Mul (Mul (Sub (Mul c5~46@ d5~48@) (Mul c5~46@ d5~48@)) (Mul c5~46@ (Sub b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ a5~42@)) (Mul a5~42@ (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1470@ (Mul (Mul (Sub (Mul c5~46@ d5~48@) (Mul c5~46@ d5~48@)) (Mul c5~46@ (Sub b5~44@ a5~42@))) (Mul (Mul a5~42@ d5~48@) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ (Mul d5~48@ c5~46@)))))) (and (=> (= tmp%18@ (Mul a5~42@ d5~48@)) (=> (= tmp%19@ (Mul b5~44@ a5~42@)) (=> (= tmp%20@ (Mul a5~42@ (Mul d5~48@ c5~46@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%5 (= temp_5_0~1413@ temp_5_1~1470@)))))) (=> (= temp_5_0~1413@ temp_5_1~1470@) (=> (= temp_6_0~1581@ (Add (Add (Mul (Sub d6~56@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Add a6~50@ c6~54@) (Mul b6~52@ c6~54@))) (Mul (Mul (Sub a6~50@ c6~54@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1646@ (Add (Add (Mul (Sub d6~56@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Add a6~50@ c6~54@) (Mul b6~52@ c6~54@))) (Mul (Sub a6~50@ c6~54@) (Mul (Mul d6~56@ b6~52@) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@)))))) (and (=> (= tmp%21@ (Sub a6~50@ c6~54@)) (=> (= tmp%22@ (Mul d6~56@ b6~52@)) (=> (= tmp%23@ (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%6 (= temp_6_0~1581@ temp_6_1~1646@)))))) (=> (= temp_6_0~1581@ temp_6_1~1646@) (=> (= temp_7_0~1785@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul a7~58@ a7~58@))) (Sub (Sub (Mul 22 1) (Mul c7~62@ a7~58@)) (Add (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1874@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul a7~58@ a7~58@))) (Sub (Sub (Mul 1 22) (Mul c7~62@ a7~58@)) (Add (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 1 22) (=> %%location_label%%7 (= temp_7_0~1785@ temp_7_1~1874@))) (=> (= temp_7_0~1785@ temp_7_1~1874@) (=> (= temp_8_0~1971@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ b8~68@)) (Sub (Sub d8~72@ c8~70@) (Add b8~68@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) c8~70@) (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@))))) (=> (= temp_8_1~2032@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ b8~68@)) (Sub (Sub d8~72@ c8~70@) (Add b8~68@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) c8~70@) (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@))))) (=> (= tmp%24@ (= temp_8_0~1971@ temp_8_1~2032@)) (and (=> %%location_label%%8 tmp%24@) (=> tmp%24@ (=> (= temp_9_0~2116@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) a9~74@) (Mul (Mul a9~74@ a9~74@) (Mul b9~76@ a9~74@))) (Mul (Mul (Mul 99 a9~74@) d9~80@) (Mul (Add c9~78@ c9~78@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~2185@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) a9~74@) (Mul a9~74@ (Mul a9~74@ (Mul b9~76@ a9~74@)))) (Mul (Mul (Mul 99 a9~74@) d9~80@) (Mul (Add c9~78@ c9~78@) (Mul a9~74@ c9~78@))))) (and (=> (= tmp%25@ (Mul b9~76@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a9~74@ a9~74@ tmp%25@) (=> %%location_label%%9 (= temp_9_0~2116@ temp_9_1~2185@)))) (=> (= temp_9_0~2116@ temp_9_1~2185@) (=> (= temp_10_0~2284@ (Add (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ c10~86@) (Mul d10~88@ b10~84@))) (Mul (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~2349@ (Add (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ c10~86@) (Mul d10~88@ b10~84@))) (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@)) (Mul a10~82@ d10~88@)) (Mul c10~86@ b10~84@)))) (and (=> (= tmp%26@ (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@))) (=> (= tmp%27@ (Mul a10~82@ d10~88@)) (=> (= tmp%28@ (Mul c10~86@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> %%location_label%%10 (= temp_10_0~2284@ temp_10_1~2349@)))))) (=> (= temp_10_0~2284@ temp_10_1~2349@) (=> (= temp_11_0~2464@ (Mul (Add (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ d11~96@)) (Add (Mul d11~96@ d11~96@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ a11~90@) (Sub b11~92@ a11~90@)) (Mul (Add a11~90@ a11~90@) (Mul c11~94@ a11~90@))))) (=> (= temp_11_1~2529@ (Mul (Add (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ d11~96@)) (Add (Mul d11~96@ d11~96@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ a11~90@) (Sub b11~92@ a11~90@)) (Mul (Add a11~90@ a11~90@) (Mul c11~94@ a11~90@))))) (=> (= tmp%29@ (= temp_11_0~2464@ temp_11_1~2529@)) (and (=> %%location_label%%11 tmp%29@) (=> tmp%29@ (=> (= temp_12_0~2605@ (Mul (Mul (Mul d12~104@ (Mul b12~100@ a12~98@)) (Add (Mul b12~100@ a12~98@) (Mul c12~102@ a12~98@))) (Mul (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Sub c12~102@ b12~100@) (Add b12~100@ d12~104@))))) (=> (= temp_12_1~2666@ (Mul (Mul (Mul d12~104@ (Mul b12~100@ a12~98@)) (Add (Mul a12~98@ b12~100@) (Mul c12~102@ a12~98@))) (Mul (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Sub c12~102@ b12~100@) (Add b12~100@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2605@ temp_12_1~2666@))) (=> (= temp_12_0~2605@ temp_12_1~2666@) (=> (= temp_13_0~2731@ (Mul (Sub (Mul (Mul d13~112@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Add d13~112@ d13~112@) (Sub b13~108@ c13~110@))) b13~108@)) (=> (= temp_13_1~2768@ (Mul (Sub (Mul (Mul d13~112@ c13~110@) (Mul b13~108@ a13~106@)) (Mul (Add d13~112@ d13~112@) (Sub b13~108@ c13~110@))) b13~108@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b13~108@ a13~106@) (=> %%location_label%%13 (= temp_13_0~2731@ temp_13_1~2768@))) (=> (= temp_13_0~2731@ temp_13_1~2768@) (=> (= temp_14_0~2857@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Sub d14~120@ d14~120@))) (Mul (Mul (Mul c14~118@ c14~118@) d14~120@) (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2918@ (Mul (Mul (Mul (Mul b14~116@ c14~118@) (Mul c14~118@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Sub d14~120@ d14~120@))) (Mul (Mul (Mul c14~118@ c14~118@) d14~120@) (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b14~116@ c14~118@) (=> (= tmp%30@ (Mul (Mul b14~116@ c14~118@) (Mul c14~118@ b14~116@))) (=> (= tmp%31@ (Mul (Mul a14~114@ b14~116@) (Sub d14~120@ d14~120@))) (=> (= tmp%32@ (Mul (Mul (Mul c14~118@ c14~118@) d14~120@) (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ d14~120@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%30@ tmp%31@ tmp%32@) (=> (= tmp%33@ (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@))) (=> (= tmp%34@ (Mul (Mul a14~114@ b14~116@) (Sub d14~120@ d14~120@))) (=> (= tmp%35@ (Mul (Mul (Mul c14~118@ c14~118@) d14~120@) (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ d14~120@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ tmp%34@ tmp%35@) (=> %%location_label%%14 (= temp_14_0~2857@ temp_14_1~2918@))))))))))) (=> (= temp_14_0~2857@ temp_14_1~2918@) (=> (= temp_15_0~3127@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ c15~126@)) (Mul (Sub b15~124@ b15~124@) (Mul a15~122@ c15~126@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ b15~124@)) (Mul (Add d15~128@ b15~124@) (Add b15~124@ d15~128@))))) (=> (= temp_15_1~3192@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ c15~126@)) (Mul (Sub b15~124@ b15~124@) (Mul a15~122@ c15~126@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ b15~124@)) (Mul (Add b15~124@ d15~128@) (Add d15~128@ b15~124@))))) (and (=> (= tmp%36@ (Add b15~124@ d15~128@)) (=> (= tmp%37@ (Add d15~128@ b15~124@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%36@ tmp%37@) (=> (= tmp%38@ (Mul (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ c15~126@)) (Mul (Sub b15~124@ b15~124@) (Mul a15~122@ c15~126@)))) (=> (= tmp%39@ (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ b15~124@))) (=> (= tmp%40@ (Mul (Add b15~124@ d15~128@) (Add d15~128@ b15~124@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> (= tmp%41@ (Mul (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ c15~126@)) (Mul (Sub b15~124@ b15~124@) (Mul a15~122@ c15~126@)))) (=> (= tmp%42@ (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ b15~124@))) (=> (= tmp%43@ (Mul (Add d15~128@ b15~124@) (Add b15~124@ d15~128@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ tmp%42@ tmp%43@) (=> %%location_label%%15 (= temp_15_0~3127@ temp_15_1~3192@))))))))))))) (=> (= temp_15_0~3127@ temp_15_1~3192@) (=> (= temp_16_0~3429@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ 45)) (Mul (Mul d16~136@ d16~136@) (Sub c16~134@ c16~134@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul c16~134@ d16~136@) (Mul c16~134@ b16~132@))))) (=> (= temp_16_1~3506@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ 45)) (Mul (Mul d16~136@ d16~136@) (Sub c16~134@ c16~134@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ d16~136@))))) (and (=> (= tmp%44@ (Mul c16~134@ b16~132@)) (=> (= tmp%45@ (Mul c16~134@ d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%44@ tmp%45@) (=> (= tmp%46@ (Mul (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ 45)) (Mul (Mul d16~136@ d16~136@) (Sub c16~134@ c16~134@)))) (=> (= tmp%47@ (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ a16~130@))) (=> (= tmp%48@ (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ d16~136@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%46@ tmp%47@ tmp%48@) (=> (= tmp%49@ (Mul (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ 45)) (Mul (Mul d16~136@ d16~136@) (Sub c16~134@ c16~134@)))) (=> (= tmp%50@ (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ a16~130@))) (=> (= tmp%51@ (Mul (Mul c16~134@ d16~136@) (Mul c16~134@ b16~132@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%49@ tmp%50@ tmp%51@) (=> %%location_label%%16 (= temp_16_0~3429@ temp_16_1~3506@))))))))))))) (=> (= temp_16_0~3429@ temp_16_1~3506@) (=> (= temp_17_0~3751@ (Sub (Mul (Mul (Sub d17~144@ d17~144@) (Add 16 c17~142@)) (Sub (Mul a17~138@ d17~144@) (Mul a17~138@ c17~142@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul d17~144@ c17~142@)) (Mul (Mul b17~140@ b17~140@) (Add b17~140@ b17~140@))))) (=> (= temp_17_1~3828@ (Sub (Mul (Mul (Sub d17~144@ d17~144@) (Add 16 c17~142@)) (Sub (Mul a17~138@ d17~144@) (Mul a17~138@ c17~142@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul d17~144@ c17~142@)) (Mul b17~140@ (Mul b17~140@ (Add b17~140@ b17~140@)))))) (and (=> (= tmp%52@ (Add b17~140@ b17~140@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b17~140@ b17~140@ tmp%52@) (=> %%location_label%%17 (= temp_17_0~3751@ temp_17_1~3828@)))) (=> (= temp_17_0~3751@ temp_17_1~3828@) (=> (= temp_18_0~3919@ (Add (Mul (Mul (Sub c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ a18~146@))) (Mul (Mul (Mul d18~152@ a18~146@) d18~152@) (Mul (Sub c18~150@ a18~146@) c18~150@)))) (=> (= temp_18_1~3976@ (Add (Mul (Mul (Sub c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ a18~146@))) (Mul (Mul d18~152@ (Mul a18~146@ d18~152@)) (Mul (Sub c18~150@ a18~146@) c18~150@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. d18~152@ a18~146@ d18~152@) (=> %%location_label%%18 (= temp_18_0~3919@ temp_18_1~3976@))) (=> (= temp_18_0~3919@ temp_18_1~3976@) (=> (= temp_19_0~4071@ (Mul (Mul (Add (Mul d19~160@ d19~160@) (Mul d19~160@ c19~158@)) c19~158@) (Mul (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ d19~160@)) (Sub (Mul b19~156@ 93) (Add b19~156@ d19~160@))))) (=> (= temp_19_1~4136@ (Mul (Mul (Mul (Add (Mul d19~160@ d19~160@) (Mul d19~160@ c19~158@)) c19~158@) (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ d19~160@))) (Sub (Mul b19~156@ 93) (Add b19~156@ d19~160@)))) (=> (= tmp%53@ (Mul (Add (Mul d19~160@ d19~160@) (Mul d19~160@ c19~158@)) c19~158@)) (=> (= tmp%54@ (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ d19~160@))) (=> (= tmp%55@ (Sub (Mul b19~156@ 93) (Add b19~156@ d19~160@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%53@ tmp%54@ tmp%55@) (=> %%location_label%%19 (= temp_19_0~4071@ temp_19_1~4136@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
