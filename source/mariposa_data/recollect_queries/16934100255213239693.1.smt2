...
(declare-const temp_2_0~570@ Int)
(declare-const temp_2_1~623@ Int)
(declare-const temp_3_0~800@ Int)
(declare-const temp_3_1~869@ Int)
(declare-const temp_4_0~1012@ Int)
(declare-const temp_4_1~1089@ Int)
(declare-const temp_5_0~1176@ Int)
(declare-const temp_5_1~1213@ Int)
(declare-const temp_6_0~1366@ Int)
(declare-const temp_6_1~1431@ Int)
(declare-const temp_7_0~1554@ Int)
(declare-const temp_7_1~1595@ Int)
(declare-const temp_8_0~1784@ Int)
(declare-const temp_8_1~1861@ Int)
(declare-const temp_9_0~2002@ Int)
(declare-const temp_9_1~2055@ Int)
(declare-const temp_10_0~2156@ Int)
(declare-const temp_10_1~2217@ Int)
(declare-const temp_11_0~2326@ Int)
(declare-const temp_11_1~2399@ Int)
(declare-const temp_12_0~2548@ Int)
(declare-const temp_12_1~2613@ Int)
(declare-const temp_13_0~2760@ Int)
(declare-const temp_13_1~2825@ Int)
(declare-const temp_14_0~2978@ Int)
(declare-const temp_14_1~3043@ Int)
(declare-const temp_15_0~3148@ Int)
(declare-const temp_15_1~3217@ Int)
(declare-const temp_16_0~3297@ Int)
(declare-const temp_16_1~3370@ Int)
(declare-const temp_17_0~3465@ Int)
(declare-const temp_17_1~3526@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Add (Mul (Sub (Mul b0~4@ a0~2@) c0~6@) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Add a0~2@ d0~8@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~362@ (Add (Mul (Sub (Mul b0~4@ a0~2@) c0~6@) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Add a0~2@ d0~8@) (Mul d0~8@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~418@ (Mul (Mul (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@)) a1~10@) (Add a1~10@ (Mul (Add a1~10@ a1~10@) (Sub b1~12@ d1~16@))))) (=> (= temp_1_1~459@ (Mul (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@)) (Mul a1~10@ (Add a1~10@ (Mul (Add a1~10@ a1~10@) (Sub b1~12@ d1~16@)))))) (and (=> (= tmp%2@ (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))) (=> (= tmp%3@ (Add a1~10@ (Mul (Add a1~10@ a1~10@) (Sub b1~12@ d1~16@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ a1~10@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~418@ temp_1_1~459@))))) (=> (= temp_1_0~418@ temp_1_1~459@) (=> (= temp_2_0~570@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ d2~24@)) a2~18@) (Mul (Add (Sub c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~623@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ d2~24@)) a2~18@) (Mul (Add (Sub c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ c2~22@) (=> (= tmp%4@ (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ d2~24@))) (=> (= tmp%5@ (Mul (Add (Sub c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ a2~18@ tmp%5@) (=> (= tmp%6@ (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ d2~24@))) (=> (= tmp%7@ (Mul (Add (Sub c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ a2~18@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~570@ temp_2_1~623@))))))))) (=> (= temp_2_0~570@ temp_2_1~623@) (=> (= temp_3_0~800@ (Mul (Sub (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@ b3~28@) d3~32@)) (Mul b3~28@ (Sub (Mul c3~30@ b3~28@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~869@ (Sub (Mul (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ d3~32@)) (Mul b3~28@ (Sub (Mul c3~30@ b3~28@) (Mul c3~30@ d3~32@)))) (Mul (Mul (Mul c3~30@ b3~28@) d3~32@) (Mul b3~28@ (Sub (Mul c3~30@ b3~28@) (Mul c3~30@ d3~32@)))))) (and (=> (= tmp%8@ (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ d3~32@))) (=> (= tmp%9@ (Mul (Mul c3~30@ b3~28@) d3~32@)) (=> (= tmp%10@ (Mul b3~28@ (Sub (Mul c3~30@ b3~28@) (Mul c3~30@ d3~32@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%3 (= temp_3_0~800@ temp_3_1~869@)))))) (=> (= temp_3_0~800@ temp_3_1~869@) (=> (= temp_4_0~1012@ (Mul (Mul (Mul (Add b4~36@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Sub a4~34@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul (Sub c4~38@ a4~34@) (Sub b4~36@ 46)) (Mul (Add d4~40@ d4~40@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~1089@ (Mul (Mul (Mul (Mul (Add b4~36@ b4~36@) (Mul b4~36@ d4~40@)) (Sub a4~34@ a4~34@)) (Mul d4~40@ b4~36@)) (Mul (Mul (Sub c4~38@ a4~34@) (Sub b4~36@ 46)) (Mul (Add d4~40@ d4~40@) (Mul c4~38@ a4~34@))))) (and (=> (= tmp%11@ (Mul (Add b4~36@ b4~36@) (Mul b4~36@ d4~40@))) (=> (= tmp%12@ (Sub a4~34@ a4~34@)) (=> (= tmp%13@ (Mul d4~40@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%4 (= temp_4_0~1012@ temp_4_1~1089@)))))) (=> (= temp_4_0~1012@ temp_4_1~1089@) (=> (= temp_5_0~1176@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Sub d5~48@ c5~46@)) (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ b5~44@))) a5~42@)) (=> (= temp_5_1~1213@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Sub d5~48@ c5~46@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@))) a5~42@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b5~44@ d5~48@) (=> (= tmp%14@ (Mul (Mul a5~42@ d5~48@) (Sub d5~48@ c5~46@))) (=> (= tmp%15@ (Mul a5~42@ c5~46@)) (=> (= tmp%16@ (Mul b5~44@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> (= tmp%17@ (Mul (Mul a5~42@ d5~48@) (Sub d5~48@ c5~46@))) (=> (= tmp%18@ (Mul a5~42@ c5~46@)) (=> (= tmp%19@ (Mul d5~48@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%5 (= temp_5_0~1176@ temp_5_1~1213@))))))))))) (=> (= temp_5_0~1176@ temp_5_1~1213@) (=> (= temp_6_0~1366@ (Mul (Mul (Mul (Sub c6~54@ d6~56@) (Mul a6~50@ b6~52@)) (Add (Sub c6~54@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1431@ (Mul (Mul (Mul (Mul (Sub c6~54@ d6~56@) (Mul a6~50@ b6~52@)) (Add (Sub c6~54@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ b6~52@))) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)))) (and (=> (= tmp%20@ (Mul (Mul (Sub c6~54@ d6~56@) (Mul a6~50@ b6~52@)) (Add (Sub c6~54@ d6~56@) (Mul b6~52@ a6~50@)))) (=> (= tmp%21@ (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ b6~52@))) (=> (= tmp%22@ (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%6 (= temp_6_0~1366@ temp_6_1~1431@)))))) (=> (= temp_6_0~1366@ temp_6_1~1431@) (=> (= temp_7_0~1554@ (Mul (Mul c7~62@ c7~62@) (Mul (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@)) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ c7~62@))))) (=> (= temp_7_1~1595@ (Mul (Mul c7~62@ c7~62@) (Mul (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@)) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@))))) (and (=> (= tmp%23@ (Mul b7~60@ c7~62@)) (=> (= tmp%24@ (Mul d7~64@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> (= tmp%25@ (Mul c7~62@ c7~62@)) (=> (= tmp%26@ (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@))) (=> (= tmp%27@ (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> (= tmp%28@ (Mul c7~62@ c7~62@)) (=> (= tmp%29@ (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@))) (=> (= tmp%30@ (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ c7~62@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%7 (= temp_7_0~1554@ temp_7_1~1595@))))))))))))) (=> (= temp_7_0~1554@ temp_7_1~1595@) (=> (= temp_8_0~1784@ (Add (Mul (Mul (Sub d8~72@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ a8~66@))) (Add (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ c8~70@)) (Add (Mul d8~72@ 17) (Sub a8~66@ a8~66@))))) (=> (= temp_8_1~1861@ (Add (Mul (Mul (Sub d8~72@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@))) (Add (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ c8~70@)) (Add (Mul d8~72@ 17) (Sub a8~66@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ b8~68@) (=> (= tmp%31@ (Mul (Sub d8~72@ b8~68@) (Mul c8~70@ d8~72@))) (=> (= tmp%32@ (Mul d8~72@ d8~72@)) (=> (= tmp%33@ (Mul a8~66@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> (= tmp%34@ (Mul (Sub d8~72@ b8~68@) (Mul c8~70@ d8~72@))) (=> (= tmp%35@ (Mul d8~72@ d8~72@)) (=> (= tmp%36@ (Mul b8~68@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ tmp%35@ tmp%36@) (=> %%location_label%%8 (= temp_8_0~1784@ temp_8_1~1861@))))))))))) (=> (= temp_8_0~1784@ temp_8_1~1861@) (=> (= temp_9_0~2002@ (Sub (Mul b9~76@ (Mul (Sub d9~80@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~2055@ (Sub (Mul (Mul (Sub d9~80@ c9~78@) (Mul a9~74@ a9~74@)) b9~76@) (Mul (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ c9~78@))))) (and (=> (= tmp%37@ (Mul (Sub d9~80@ c9~78@) (Mul a9~74@ a9~74@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%37@ b9~76@) (=> %%location_label%%9 (= temp_9_0~2002@ temp_9_1~2055@)))) (=> (= temp_9_0~2002@ temp_9_1~2055@) (=> (= temp_10_0~2156@ (Mul (Mul (Add (Add b10~84@ b10~84@) (Mul c10~86@ b10~84@)) (Add (Mul d10~88@ d10~88@) d10~88@)) (Add (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ a10~82@)) (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ b10~84@))))) (=> (= temp_10_1~2217@ (Mul (Mul (Add (Add b10~84@ b10~84@) (Mul c10~86@ b10~84@)) (Add (Mul d10~88@ d10~88@) d10~88@)) (Add (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ c10~86@)) (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ b10~84@))))) (and (=> (= tmp%38@ (Mul c10~86@ a10~82@)) (=> (= tmp%39@ (Mul c10~86@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%38@ tmp%39@) (=> %%location_label%%10 (= temp_10_0~2156@ temp_10_1~2217@))))) (=> (= temp_10_0~2156@ temp_10_1~2217@) (=> (= temp_11_0~2326@ (Mul (Mul (Add (Mul b11~92@ c11~94@) (Mul c11~94@ a11~90@)) (Mul (Mul c11~94@ d11~96@) (Sub b11~92@ c11~94@))) (Mul (Mul (Add b11~92@ c11~94@) (Mul d11~96@ d11~96@)) (Mul (Mul a11~90@ a11~90@) 68)))) (=> (= temp_11_1~2399@ (Mul (Mul (Mul (Add b11~92@ c11~94@) (Mul d11~96@ d11~96@)) (Mul (Mul a11~90@ a11~90@) 68)) (Mul (Add (Mul b11~92@ c11~94@) (Mul c11~94@ a11~90@)) (Mul (Mul c11~94@ d11~96@) (Sub b11~92@ c11~94@))))) (and (=> (= tmp%40@ (Mul (Mul (Add b11~92@ c11~94@) (Mul d11~96@ d11~96@)) (Mul (Mul a11~90@ a11~90@) 68))) (=> (= tmp%41@ (Mul (Add (Mul b11~92@ c11~94@) (Mul c11~94@ a11~90@)) (Mul (Mul c11~94@ d11~96@) (Sub b11~92@ c11~94@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%40@ tmp%41@) (=> %%location_label%%11 (= temp_11_0~2326@ temp_11_1~2399@))))) (=> (= temp_11_0~2326@ temp_11_1~2399@) (=> (= temp_12_0~2548@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Add c12~102@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ d12~104@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul a12~98@ d12~104@)) (Add (Mul c12~102@ a12~98@) (Mul c12~102@ b12~100@))))) (=> (= temp_12_1~2613@ (Mul (Mul (Mul b12~100@ c12~102@) (Add c12~102@ a12~98@)) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ d12~104@)) (Mul (Mul (Mul b12~100@ d12~104@) (Mul a12~98@ d12~104@)) (Add (Mul c12~102@ a12~98@) (Mul c12~102@ b12~100@)))))) (and (=> (= tmp%42@ (Mul (Mul b12~100@ c12~102@) (Add c12~102@ a12~98@))) (=> (= tmp%43@ (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ d12~104@))) (=> (= tmp%44@ (Mul (Mul (Mul b12~100@ d12~104@) (Mul a12~98@ d12~104@)) (Add (Mul c12~102@ a12~98@) (Mul c12~102@ b12~100@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%42@ tmp%43@ tmp%44@) (=> %%location_label%%12 (= temp_12_0~2548@ temp_12_1~2613@)))))) (=> (= temp_12_0~2548@ temp_12_1~2613@) (=> (= temp_13_0~2760@ (Sub (Mul (Mul (Mul d13~112@ b13~108@) (Add c13~110@ b13~108@)) (Mul (Mul d13~112@ d13~112@) (Add d13~112@ a13~106@))) (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ a13~106@) (Mul c13~110@ c13~110@))))) (=> (= temp_13_1~2825@ (Sub (Mul (Mul (Mul b13~108@ d13~112@) (Add c13~110@ b13~108@)) (Mul (Mul d13~112@ d13~112@) (Add d13~112@ a13~106@))) (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ a13~106@) (Mul c13~110@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b13~108@ d13~112@) (=> (= tmp%45@ (Mul b13~108@ d13~112@)) (=> (= tmp%46@ (Add c13~110@ b13~108@)) (=> (= tmp%47@ (Mul (Mul d13~112@ d13~112@) (Add d13~112@ a13~106@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%45@ tmp%46@ tmp%47@) (=> (= tmp%48@ (Mul d13~112@ b13~108@)) (=> (= tmp%49@ (Add c13~110@ b13~108@)) (=> (= tmp%50@ (Mul (Mul d13~112@ d13~112@) (Add d13~112@ a13~106@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%48@ tmp%49@ tmp%50@) (=> %%location_label%%13 (= temp_13_0~2760@ temp_13_1~2825@))))))))))) (=> (= temp_13_0~2760@ temp_13_1~2825@) (=> (= temp_14_0~2978@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ d14~120@)) (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ d14~120@))))) (=> (= temp_14_1~3043@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ d14~120@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ d14~120@)) (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ d14~120@))))) (and (=> (= tmp%51@ (Mul d14~120@ b14~116@)) (=> (= tmp%52@ (Mul a14~114@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%51@ tmp%52@) (=> %%location_label%%14 (= temp_14_0~2978@ temp_14_1~3043@))))) (=> (= temp_14_0~2978@ temp_14_1~3043@) (=> (= temp_15_0~3148@ (Mul (Mul (Sub (Mul c15~126@ d15~128@) (Sub d15~128@ b15~124@)) (Mul (Mul a15~122@ c15~126@) d15~128@)) (Mul (Mul (Mul c15~126@ a15~122@) b15~124@) (Sub (Mul b15~124@ 53) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~3217@ (Mul (Mul (Sub (Mul c15~126@ d15~128@) (Sub d15~128@ b15~124@)) (Mul (Mul a15~122@ c15~126@) d15~128@)) (Mul (Mul (Mul c15~126@ a15~122@) b15~124@) (Sub (Mul b15~124@ 53) (Mul d15~128@ d15~128@))))) (=> (= tmp%53@ (= temp_15_0~3148@ temp_15_1~3217@)) (and (=> %%location_label%%15 tmp%53@) (=> tmp%53@ (=> (= temp_16_0~3297@ (Sub (Add (Mul (Mul c16~134@ d16~136@) (Mul c16~134@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Add d16~136@ b16~132@))) (Mul (Mul (Add c16~134@ d16~136@) (Mul c16~134@ a16~130@)) (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ b16~132@))))) (=> (= temp_16_1~3370@ (Sub (Add (Mul (Mul c16~134@ d16~136@) (Mul c16~134@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Add d16~136@ b16~132@))) (Mul (Add (Mul c16~134@ (Mul c16~134@ a16~130@)) (Mul d16~136@ (Mul c16~134@ a16~130@))) (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ b16~132@))))) (and (=> (= tmp%54@ (Mul c16~134@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c16~134@ d16~136@ tmp%54@) (=> %%location_label%%16 (= temp_16_0~3297@ temp_16_1~3370@)))) (=> (= temp_16_0~3297@ temp_16_1~3370@) (=> (= temp_17_0~3465@ (Mul (Mul (Add (Sub b17~140@ d17~144@) (Mul a17~138@ c17~142@)) (Sub d17~144@ (Mul c17~142@ c17~142@))) (Add (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul c17~142@ b17~140@) (Sub c17~142@ d17~144@))))) (=> (= temp_17_1~3526@ (Mul (Mul (Add (Sub b17~140@ d17~144@) (Mul a17~138@ c17~142@)) (Sub d17~144@ (Mul c17~142@ c17~142@))) (Add (Mul (Mul a17~138@ c17~142@) (Mul a17~138@ b17~140@)) (Mul (Mul c17~142@ b17~140@) (Sub c17~142@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a17~138@ c17~142@) (=> %%location_label%%17 (= temp_17_0~3465@ temp_17_1~3526@))) (=> (= temp_17_0~3465@ temp_17_1~3526@) (=> (= temp_18_0~3635@ (Mul (Add (Mul (Mul 61 c18~150@) c18~150@) (Mul (Mul 50 a18~146@) (Mul c18~150@ b18~148@))) (Sub (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ c18~150@)) (Mul (Mul d18~152@ c18~150@) d18~152@)))) (=> (= temp_18_1~3716@ (Mul (Add (Mul (Mul 61 c18~150@) c18~150@) (Mul (Mul 50 a18~146@) (Mul c18~150@ b18~148@))) (Sub (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ c18~150@)) (Mul d18~152@ (Mul d18~152@ c18~150@))))) (and (=> (= tmp%55@ (Mul d18~152@ c18~150@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d18~152@ tmp%55@) (=> %%location_label%%18 (= temp_18_0~3635@ temp_18_1~3716@)))) (=> (= temp_18_0~3635@ temp_18_1~3716@) (=> (= temp_19_0~3797@ (Sub (Mul (Mul (Mul d19~160@ c19~158@) (Mul d19~160@ a19~154@)) (Sub d19~160@ (Add a19~154@ c19~158@))) (Mul (Mul (Mul d19~160@ b19~156@) (Mul b19~156@ b19~156@)) c19~158@))) (=> (= temp_19_1~3846@ (Sub (Mul (Mul (Mul d19~160@ c19~158@) (Mul d19~160@ a19~154@)) (Sub d19~160@ (Add a19~154@ c19~158@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul d19~160@ b19~156@)) c19~158@))) (=> (= tmp%56@ (Mul b19~156@ b19~156@)) (=> (= tmp%57@ (Mul d19~160@ b19~156@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%56@ tmp%57@) (=> %%location_label%%19 (= temp_19_0~3797@ temp_19_1~3846@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
