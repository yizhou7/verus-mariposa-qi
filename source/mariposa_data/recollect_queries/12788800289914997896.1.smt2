...
(declare-const temp_2_0~807@ Int)
...
(declare-const temp_4_1~1222@ Int)
(declare-const temp_5_0~1294@ Int)
(declare-const temp_5_1~1363@ Int)
(declare-const temp_6_0~1466@ Int)
(declare-const temp_6_1~1527@ Int)
(declare-const temp_7_0~1762@ Int)
(declare-const temp_7_1~1847@ Int)
(declare-const temp_8_0~2012@ Int)
(declare-const temp_8_1~2081@ Int)
(declare-const temp_9_0~2176@ Int)
(declare-const temp_9_1~2237@ Int)
(declare-const temp_10_0~2330@ Int)
(declare-const temp_10_1~2395@ Int)
(declare-const temp_11_0~2471@ Int)
(declare-const temp_11_1~2548@ Int)
(declare-const temp_12_0~2659@ Int)
(declare-const temp_12_1~2724@ Int)
(declare-const temp_13_0~2843@ Int)
(declare-const temp_13_1~2908@ Int)
(declare-const temp_14_0~2991@ Int)
(declare-const temp_14_1~3040@ Int)
(declare-const temp_15_0~3145@ Int)
(declare-const temp_15_1~3210@ Int)
(declare-const temp_16_0~3303@ Int)
(declare-const temp_16_1~3376@ Int)
(declare-const temp_17_0~3607@ Int)
(declare-const temp_17_1~3672@ Int)
(declare-const temp_18_0~3773@ Int)
(declare-const temp_18_1~3822@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Sub (Mul (Mul a0~2@ 50) (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul a0~2@ d0~8@) (Add d0~8@ c0~6@)) (Mul (Add b0~4@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~394@ (Mul (Mul (Sub (Mul (Mul a0~2@ 50) (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Mul a0~2@ d0~8@) (Add d0~8@ c0~6@))) (Mul (Add b0~4@ c0~6@) (Mul b0~4@ d0~8@)))) (and (=> (= tmp%1@ (Sub (Mul (Mul a0~2@ 50) (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@)))) (=> (= tmp%2@ (Mul (Mul a0~2@ d0~8@) (Add d0~8@ c0~6@))) (=> (= tmp%3@ (Mul (Add b0~4@ c0~6@) (Mul b0~4@ d0~8@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@)))))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~545@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ 35)) (Mul (Sub a1~10@ b1~12@) (Sub d1~16@ c1~14@))) (Sub (Add (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) c1~14@))) (=> (= temp_1_1~610@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ 35)) (Mul (Sub a1~10@ b1~12@) (Sub d1~16@ c1~14@))) (Sub (Add (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ d1~16@) (=> (= tmp%4@ (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ 35))) (=> (= tmp%5@ (Mul (Sub a1~10@ b1~12@) (Sub d1~16@ c1~14@))) (=> (= tmp%6@ (Sub (Add (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> (= tmp%7@ (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ 35))) (=> (= tmp%8@ (Mul (Sub a1~10@ b1~12@) (Sub d1~16@ c1~14@))) (=> (= tmp%9@ (Sub (Add (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%1 (= temp_1_0~545@ temp_1_1~610@))))))))))) (=> (= temp_1_0~545@ temp_1_1~610@) (=> (= temp_2_0~807@ (Mul (Mul (Add (Mul d2~24@ c2~22@) a2~18@) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ d2~24@))) (Sub (Add (Add d2~24@ b2~20@) (Sub c2~22@ c2~22@)) (Mul (Add d2~24@ a2~18@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~868@ (Mul (Mul (Add (Mul d2~24@ c2~22@) a2~18@) (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@))) (Sub (Add (Add d2~24@ b2~20@) (Sub c2~22@ c2~22@)) (Mul (Add d2~24@ a2~18@) (Mul b2~20@ a2~18@))))) (and (=> (= tmp%10@ (Mul c2~22@ d2~24@)) (=> (= tmp%11@ (Mul a2~18@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%2 (= temp_2_0~807@ temp_2_1~868@))))) (=> (= temp_2_0~807@ temp_2_1~868@) (=> (= temp_3_0~969@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~1034@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul (Mul a3~26@ c3~30@) b3~28@) b3~28@) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ b3~28@))))) (and (=> (= tmp%12@ (Mul a3~26@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ b3~28@ b3~28@) (=> %%location_label%%3 (= temp_3_0~969@ temp_3_1~1034@)))) (=> (= temp_3_0~969@ temp_3_1~1034@) (=> (= temp_4_0~1145@ (Add (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul 35 a4~34@) (Add a4~34@ b4~36@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Sub (Mul d4~40@ d4~40@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~1222@ (Add (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul 35 a4~34@) (Add a4~34@ b4~36@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Sub (Mul d4~40@ d4~40@) (Mul a4~34@ c4~38@))))) (=> (= tmp%13@ (= temp_4_0~1145@ temp_4_1~1222@)) (and (=> %%location_label%%4 tmp%13@) (=> tmp%13@ (=> (= temp_5_0~1294@ (Mul (Add (Mul (Mul a5~42@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Add c5~46@ (Mul d5~48@ d5~48@)) (Mul d5~48@ (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1363@ (Mul (Add (Mul (Mul a5~42@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@))) (Add (Mul c5~46@ (Mul d5~48@ (Mul d5~48@ a5~42@))) (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ (Mul d5~48@ a5~42@)))))) (and (=> (= tmp%14@ (Mul d5~48@ d5~48@)) (=> (= tmp%15@ (Mul d5~48@ (Mul d5~48@ a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c5~46@ tmp%14@ tmp%15@) (=> %%location_label%%5 (= temp_5_0~1294@ temp_5_1~1363@))))) (=> (= temp_5_0~1294@ temp_5_1~1363@) (=> (= temp_6_0~1466@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@)) (Mul d6~56@ (Mul a6~50@ c6~54@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ d6~56@))))) (=> (= temp_6_1~1527@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@)) (Mul d6~56@ (Mul a6~50@ c6~54@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul (Mul c6~54@ c6~54@) a6~50@) d6~56@)))) (and (=> (= tmp%16@ (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@)) (Mul d6~56@ (Mul a6~50@ c6~54@)))) (=> (= tmp%17@ (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ b6~52@))) (=> (= tmp%18@ (Mul (Mul (Mul c6~54@ c6~54@) a6~50@) d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> (= tmp%19@ (Mul c6~54@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ a6~50@ d6~56@) (=> (= tmp%20@ (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@)) (Mul d6~56@ (Mul a6~50@ c6~54@)))) (=> (= tmp%21@ (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ b6~52@))) (=> (= tmp%22@ (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ d6~56@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%6 (= temp_6_0~1466@ temp_6_1~1527@)))))))))))) (=> (= temp_6_0~1466@ temp_6_1~1527@) (=> (= temp_7_0~1762@ (Sub (Mul (Sub (Mul 64 a7~58@) (Sub 75 c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ c7~62@))) (Mul (Add (Mul a7~58@ b7~60@) (Add b7~60@ a7~58@)) (Mul a7~58@ (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1847@ (Sub (Mul (Sub (Mul 64 a7~58@) (Sub 75 c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@))) (Mul (Add (Mul a7~58@ b7~60@) (Add b7~60@ a7~58@)) (Mul a7~58@ (Mul a7~58@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ d7~64@) (=> (= tmp%23@ (Sub (Mul 64 a7~58@) (Sub 75 c7~62@))) (=> (= tmp%24@ (Mul a7~58@ c7~62@)) (=> (= tmp%25@ (Mul c7~62@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> (= tmp%26@ (Sub (Mul 64 a7~58@) (Sub 75 c7~62@))) (=> (= tmp%27@ (Mul a7~58@ c7~62@)) (=> (= tmp%28@ (Mul d7~64@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> %%location_label%%7 (= temp_7_0~1762@ temp_7_1~1847@))))))))))) (=> (= temp_7_0~1762@ temp_7_1~1847@) (=> (= temp_8_0~2012@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Sub b8~68@ b8~68@) (Sub a8~66@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) (Add b8~68@ d8~72@)) (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~2081@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Sub b8~68@ b8~68@) (Sub a8~66@ c8~70@))) (Mul (Add (Mul (Mul b8~68@ c8~70@) b8~68@) (Mul (Mul b8~68@ c8~70@) d8~72@)) (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@))))) (and (=> (= tmp%29@ (Mul b8~68@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%29@ b8~68@ d8~72@) (=> %%location_label%%8 (= temp_8_0~2012@ temp_8_1~2081@)))) (=> (= temp_8_0~2012@ temp_8_1~2081@) (=> (= temp_9_0~2176@ (Mul (Sub (Add (Mul a9~74@ d9~80@) c9~78@) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ c9~78@))) (Mul (Sub (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@)) (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~2237@ (Mul (Sub (Add (Mul a9~74@ d9~80@) c9~78@) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ a9~74@))) (Mul (Sub (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@)) (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a9~74@ c9~78@) (=> %%location_label%%9 (= temp_9_0~2176@ temp_9_1~2237@))) (=> (= temp_9_0~2176@ temp_9_1~2237@) (=> (= temp_10_0~2330@ (Add (Mul (Mul (Sub c10~86@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))))) (=> (= temp_10_1~2395@ (Add (Mul (Mul (Sub c10~86@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))))) (=> (= tmp%30@ (= temp_10_0~2330@ temp_10_1~2395@)) (and (=> %%location_label%%10 tmp%30@) (=> tmp%30@ (=> (= temp_11_0~2471@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) (Sub d11~96@ c11~94@)) (Mul (Sub d11~96@ c11~94@) (Sub d11~96@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Add b11~92@ c11~94@)) (Sub (Mul d11~96@ a11~90@) c11~94@)))) (=> (= temp_11_1~2548@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) (Sub d11~96@ c11~94@)) (Mul (Sub d11~96@ c11~94@) (Sub d11~96@ b11~92@))) (Sub (Mul (Mul (Mul a11~90@ c11~94@) (Add b11~92@ c11~94@)) (Mul d11~96@ a11~90@)) (Mul (Mul (Mul a11~90@ c11~94@) (Add b11~92@ c11~94@)) c11~94@)))) (and (=> (= tmp%31@ (Mul (Mul a11~90@ c11~94@) (Add b11~92@ c11~94@))) (=> (= tmp%32@ (Mul d11~96@ a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%31@ tmp%32@ c11~94@) (=> %%location_label%%11 (= temp_11_0~2471@ temp_11_1~2548@))))) (=> (= temp_11_0~2471@ temp_11_1~2548@) (=> (= temp_12_0~2659@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ b12~100@) (Mul 35 d12~104@))) (Mul c12~102@ (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~2724@ (Mul (Mul (Mul b12~100@ c12~102@) (Mul (Mul d12~104@ b12~100@) (Mul (Mul c12~102@ b12~100@) (Mul 35 d12~104@)))) (Mul c12~102@ (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@))))) (and (=> (= tmp%33@ (Mul b12~100@ c12~102@)) (=> (= tmp%34@ (Mul d12~104@ b12~100@)) (=> (= tmp%35@ (Mul (Mul c12~102@ b12~100@) (Mul 35 d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ tmp%34@ tmp%35@) (=> %%location_label%%12 (= temp_12_0~2659@ temp_12_1~2724@)))))) (=> (= temp_12_0~2659@ temp_12_1~2724@) (=> (= temp_13_0~2843@ (Sub (Mul (Mul (Mul d13~112@ b13~108@) (Sub a13~106@ a13~106@)) (Mul (Sub d13~112@ d13~112@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Sub c13~110@ a13~106@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2908@ (Sub (Mul (Mul (Mul d13~112@ b13~108@) (Sub a13~106@ a13~106@)) (Mul (Sub d13~112@ d13~112@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul (Sub c13~110@ a13~106@) c13~110@) d13~112@)))) (and (=> (= tmp%36@ (Sub c13~110@ a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ c13~110@ d13~112@) (=> %%location_label%%13 (= temp_13_0~2843@ temp_13_1~2908@)))) (=> (= temp_13_0~2843@ temp_13_1~2908@) (=> (= temp_14_0~2991@ (Sub (Sub (Sub (Mul d14~120@ d14~120@) (Mul c14~118@ d14~120@)) (Add (Mul b14~116@ b14~116@) d14~120@)) (Mul c14~118@ (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ c14~118@))))) (=> (= temp_14_1~3040@ (Sub (Sub (Sub (Mul d14~120@ d14~120@) (Mul c14~118@ d14~120@)) (Add (Mul b14~116@ b14~116@) d14~120@)) (Mul (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ c14~118@)) c14~118@))) (and (=> (= tmp%37@ (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ c14~118@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%37@ c14~118@) (=> %%location_label%%14 (= temp_14_0~2991@ temp_14_1~3040@)))) (=> (= temp_14_0~2991@ temp_14_1~3040@) (=> (= temp_15_0~3145@ (Mul (Sub (Add (Mul b15~124@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ d15~128@))) (Mul (Mul (Mul b15~124@ b15~124@) (Sub a15~122@ c15~126@)) (Mul (Mul b15~124@ c15~126@) (Mul c15~126@ b15~124@))))) (=> (= temp_15_1~3210@ (Mul (Sub (Add (Mul a15~122@ b15~124@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ d15~128@))) (Mul (Mul (Mul b15~124@ b15~124@) (Sub a15~122@ c15~126@)) (Mul (Mul b15~124@ c15~126@) (Mul c15~126@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a15~122@ b15~124@) (=> %%location_label%%15 (= temp_15_0~3145@ temp_15_1~3210@))) (=> (= temp_15_0~3145@ temp_15_1~3210@) (=> (= temp_16_0~3303@ (Mul (Mul (Mul (Sub a16~130@ d16~136@) (Sub b16~132@ c16~134@)) (Mul (Add a16~130@ d16~136@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Sub d16~136@ c16~134@))))) (=> (= temp_16_1~3376@ (Mul (Mul (Sub (Mul (Sub a16~130@ d16~136@) b16~132@) (Mul (Sub a16~130@ d16~136@) c16~134@)) (Mul (Add a16~130@ d16~136@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Sub d16~136@ c16~134@))))) (and (=> (= tmp%38@ (Sub (Mul (Sub a16~130@ d16~136@) b16~132@) (Mul (Sub a16~130@ d16~136@) c16~134@))) (=> (= tmp%39@ (Mul (Add a16~130@ d16~136@) (Mul d16~136@ a16~130@))) (=> (= tmp%40@ (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Sub d16~136@ c16~134@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> (= tmp%41@ (Sub a16~130@ d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%41@ b16~132@ c16~134@) (=> (= tmp%42@ (Mul (Sub a16~130@ d16~136@) (Sub b16~132@ c16~134@))) (=> (= tmp%43@ (Mul (Add a16~130@ d16~136@) (Mul d16~136@ a16~130@))) (=> (= tmp%44@ (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Sub d16~136@ c16~134@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%42@ tmp%43@ tmp%44@) (=> %%location_label%%16 (= temp_16_0~3303@ temp_16_1~3376@)))))))))))) (=> (= temp_16_0~3303@ temp_16_1~3376@) (=> (= temp_17_0~3607@ (Mul (Mul (Mul (Sub b17~140@ b17~140@) (Sub a17~138@ b17~140@)) (Sub (Add d17~144@ c17~142@) (Sub a17~138@ a17~138@))) (Mul (Sub (Mul c17~142@ b17~140@) (Mul b17~140@ d17~144@)) (Sub (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@))))) (=> (= temp_17_1~3672@ (Mul (Mul (Sub (Add d17~144@ c17~142@) (Sub a17~138@ a17~138@)) (Mul (Sub b17~140@ b17~140@) (Sub a17~138@ b17~140@))) (Mul (Sub (Mul c17~142@ b17~140@) (Mul b17~140@ d17~144@)) (Sub (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@))))) (and (=> (= tmp%45@ (Sub (Add d17~144@ c17~142@) (Sub a17~138@ a17~138@))) (=> (= tmp%46@ (Mul (Sub b17~140@ b17~140@) (Sub a17~138@ b17~140@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%45@ tmp%46@) (=> %%location_label%%17 (= temp_17_0~3607@ temp_17_1~3672@))))) (=> (= temp_17_0~3607@ temp_17_1~3672@) (=> (= temp_18_0~3773@ (Sub (Mul a18~146@ (Mul (Mul b18~148@ d18~152@) (Mul b18~148@ b18~148@))) (Add (Add b18~148@ (Mul d18~152@ d18~152@)) (Mul (Mul d18~152@ a18~146@) (Mul b18~148@ d18~152@))))) (=> (= temp_18_1~3822@ (Sub (Mul a18~146@ (Mul (Mul b18~148@ d18~152@) (Mul b18~148@ b18~148@))) (Add (Add b18~148@ (Mul d18~152@ d18~152@)) (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ a18~146@))))) (=> (= tmp%47@ (Mul b18~148@ d18~152@)) (=> (= tmp%48@ (Mul d18~152@ a18~146@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%47@ tmp%48@) (=> %%location_label%%18 (= temp_18_0~3773@ temp_18_1~3822@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
