...
(declare-const temp_1_0~405@ Int)
(declare-const temp_1_1~462@ Int)
(declare-const temp_2_0~561@ Int)
(declare-const temp_2_1~614@ Int)
(declare-const temp_3_0~702@ Int)
(declare-const temp_3_1~775@ Int)
(declare-const temp_4_0~980@ Int)
(declare-const temp_4_1~1033@ Int)
(declare-const temp_5_0~1232@ Int)
(declare-const temp_5_1~1297@ Int)
(declare-const temp_6_0~1444@ Int)
(declare-const temp_6_1~1509@ Int)
(declare-const temp_7_0~1610@ Int)
(declare-const temp_7_1~1675@ Int)
...
(declare-const temp_10_1~2158@ Int)
(declare-const temp_11_0~2269@ Int)
(declare-const temp_11_1~2330@ Int)
(declare-const temp_12_0~2479@ Int)
(declare-const temp_12_1~2540@ Int)
(declare-const temp_13_0~2653@ Int)
(declare-const temp_13_1~2726@ Int)
(declare-const temp_14_0~2837@ Int)
(declare-const temp_14_1~2902@ Int)
(declare-const temp_15_0~3043@ Int)
(declare-const temp_15_1~3108@ Int)
(declare-const temp_16_0~3263@ Int)
(declare-const temp_16_1~3336@ Int)
(declare-const temp_17_0~3443@ Int)
(declare-const temp_17_1~3516@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Add (Mul (Mul (Mul b0~4@ b0~4@) (Sub c0~6@ d0~8@)) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ a0~2@))) b0~4@)) (=> (= temp_0_1~314@ (Add (Mul (Mul b0~4@ (Mul b0~4@ (Sub c0~6@ d0~8@))) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ a0~2@))) b0~4@)) (and (=> (= tmp%1@ (Sub c0~6@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ b0~4@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~277@ temp_0_1~314@)))) (=> (= temp_0_0~277@ temp_0_1~314@) (=> (= temp_1_0~405@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ d1~16@) c1~14@)) (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ a1~10@)) (Mul b1~12@ (Mul a1~10@ b1~12@))))) (=> (= temp_1_1~462@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ d1~16@) c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ (Mul a1~10@ b1~12@)))))) (and (=> (= tmp%2@ (Mul c1~14@ d1~16@)) (=> (= tmp%3@ (Mul a1~10@ a1~10@)) (=> (= tmp%4@ (Mul b1~12@ (Mul a1~10@ b1~12@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~405@ temp_1_1~462@)))))) (=> (= temp_1_0~405@ temp_1_1~462@) (=> (= temp_2_0~561@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) a2~18@) (Mul (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Sub (Mul d2~24@ d2~24@) (Sub c2~22@ d2~24@))))) (=> (= temp_2_1~614@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) a2~18@) (Mul (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Sub (Mul d2~24@ d2~24@) (Sub c2~22@ d2~24@))))) (=> (= tmp%5@ (= temp_2_0~561@ temp_2_1~614@)) (and (=> %%location_label%%2 tmp%5@) (=> tmp%5@ (=> (= temp_3_0~702@ (Mul (Mul (Mul a3~26@ (Mul c3~30@ 69)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)) (Add (Mul d3~32@ a3~26@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~775@ (Mul (Mul (Mul a3~26@ (Mul c3~30@ 69)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)) (Add (Mul d3~32@ a3~26@) (Mul d3~32@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ b3~28@) (=> (= tmp%6@ (Mul (Mul a3~26@ (Mul c3~30@ 69)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@)))) (=> (= tmp%7@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@))) (=> (= tmp%8@ (Add (Mul d3~32@ a3~26@) (Mul d3~32@ b3~28@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> (= tmp%9@ (Mul (Mul a3~26@ (Mul c3~30@ 69)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@)))) (=> (= tmp%10@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@))) (=> (= tmp%11@ (Add (Mul d3~32@ a3~26@) (Mul b3~28@ d3~32@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%3 (= temp_3_0~702@ temp_3_1~775@))))))))))) (=> (= temp_3_0~702@ temp_3_1~775@) (=> (= temp_4_0~980@ (Mul (Mul (Mul (Sub a4~34@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Add d4~40@ d4~40@))) (Mul c4~38@ (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~1033@ (Mul (Mul (Mul (Mul (Sub a4~34@ d4~40@) d4~40@) c4~38@) (Mul (Mul a4~34@ a4~34@) (Add d4~40@ d4~40@))) (Mul c4~38@ (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@))))) (and (=> (= tmp%12@ (Mul (Mul (Sub a4~34@ d4~40@) d4~40@) c4~38@)) (=> (= tmp%13@ (Mul (Mul a4~34@ a4~34@) (Add d4~40@ d4~40@))) (=> (= tmp%14@ (Mul c4~38@ (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> (= tmp%15@ (Sub a4~34@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ d4~40@ c4~38@) (=> (= tmp%16@ (Mul (Sub a4~34@ d4~40@) (Mul d4~40@ c4~38@))) (=> (= tmp%17@ (Mul (Mul a4~34@ a4~34@) (Add d4~40@ d4~40@))) (=> (= tmp%18@ (Mul c4~38@ (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%4 (= temp_4_0~980@ temp_4_1~1033@)))))))))))) (=> (= temp_4_0~980@ temp_4_1~1033@) (=> (= temp_5_0~1232@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@))) (Sub (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1297@ (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@)) (Sub (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ d5~48@)))))) (and (=> (= tmp%19@ (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (=> (= tmp%20@ (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@))) (=> (= tmp%21@ (Sub (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ d5~48@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%5 (= temp_5_0~1232@ temp_5_1~1297@)))))) (=> (= temp_5_0~1232@ temp_5_1~1297@) (=> (= temp_6_0~1444@ (Add (Mul (Sub (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ a6~50@))) (Add (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Add b6~52@ a6~50@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1509@ (Add (Mul (Sub (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ c6~54@))) (Add (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Add b6~52@ a6~50@) (Mul a6~50@ b6~52@))))) (and (=> (= tmp%22@ (Mul b6~52@ a6~50@)) (=> (= tmp%23@ (Mul c6~54@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%6 (= temp_6_0~1444@ temp_6_1~1509@))))) (=> (= temp_6_0~1444@ temp_6_1~1509@) (=> (= temp_7_0~1610@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Add a7~58@ d7~64@) (Mul d7~64@ c7~62@))) (Sub (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@))))) (=> (= temp_7_1~1675@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Add a7~58@ d7~64@) (Mul d7~64@ c7~62@))) (Sub (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@))))) (=> (= tmp%24@ (= temp_7_0~1610@ temp_7_1~1675@)) (and (=> %%location_label%%7 tmp%24@) (=> tmp%24@ (=> (= temp_8_0~1755@ (Add (Mul (Mul (Mul d8~72@ c8~70@) (Add c8~70@ d8~72@)) (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ d8~72@)) (Mul (Mul b8~68@ b8~68@) (Sub b8~68@ d8~72@))))) (=> (= temp_8_1~1820@ (Add (Mul (Mul (Mul d8~72@ c8~70@) (Add c8~70@ d8~72@)) (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ d8~72@)) (Mul b8~68@ (Mul b8~68@ (Sub b8~68@ d8~72@)))))) (and (=> (= tmp%25@ (Sub b8~68@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b8~68@ b8~68@ tmp%25@) (=> %%location_label%%8 (= temp_8_0~1755@ temp_8_1~1820@)))) (=> (= temp_8_0~1755@ temp_8_1~1820@) (=> (= temp_9_0~1907@ (Mul (Mul (Mul (Mul d9~80@ d9~80@) (Add d9~80@ d9~80@)) (Add (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@))) (Add c9~78@ (Mul (Mul a9~74@ a9~74@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~1960@ (Mul (Mul (Add (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Add d9~80@ d9~80@))) (Add c9~78@ (Mul (Mul a9~74@ a9~74@) (Mul d9~80@ a9~74@))))) (and (=> (= tmp%26@ (Add (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@))) (=> (= tmp%27@ (Mul (Mul d9~80@ d9~80@) (Add d9~80@ d9~80@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%26@ tmp%27@) (=> %%location_label%%9 (= temp_9_0~1907@ temp_9_1~1960@))))) (=> (= temp_9_0~1907@ temp_9_1~1960@) (=> (= temp_10_0~2077@ (Mul (Sub a10~82@ (Sub (Sub b10~84@ a10~82@) (Mul 75 a10~82@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ b10~84@)) (Sub (Mul d10~88@ d10~88@) (Sub b10~84@ d10~88@))))) (=> (= temp_10_1~2158@ (Mul (Sub a10~82@ (Sub (Sub b10~84@ a10~82@) (Mul 75 a10~82@))) (Sub (Mul (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ b10~84@)) (Mul d10~88@ d10~88@)) (Mul (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ b10~84@)) (Sub b10~84@ d10~88@))))) (and (=> (= tmp%28@ (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ b10~84@))) (=> (= tmp%29@ (Mul d10~88@ d10~88@)) (=> (= tmp%30@ (Sub b10~84@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%10 (= temp_10_0~2077@ temp_10_1~2158@)))))) (=> (= temp_10_0~2077@ temp_10_1~2158@) (=> (= temp_11_0~2269@ (Mul (Mul (Add (Mul b11~92@ d11~96@) (Mul a11~90@ d11~96@)) (Mul (Mul d11~96@ c11~94@) a11~90@)) (Mul (Mul (Mul b11~92@ c11~94@) (Mul d11~96@ a11~90@)) (Mul (Add a11~90@ a11~90@) (Add c11~94@ c11~94@))))) (=> (= temp_11_1~2330@ (Mul (Mul (Add (Mul b11~92@ d11~96@) (Mul a11~90@ d11~96@)) (Mul (Mul d11~96@ c11~94@) a11~90@)) (Mul (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ a11~90@)) (Mul (Add a11~90@ a11~90@) (Add c11~94@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c11~94@ b11~92@) (=> (= tmp%31@ (Mul c11~94@ b11~92@)) (=> (= tmp%32@ (Mul d11~96@ a11~90@)) (=> (= tmp%33@ (Mul (Add a11~90@ a11~90@) (Add c11~94@ c11~94@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> (= tmp%34@ (Mul b11~92@ c11~94@)) (=> (= tmp%35@ (Mul d11~96@ a11~90@)) (=> (= tmp%36@ (Mul (Add a11~90@ a11~90@) (Add c11~94@ c11~94@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ tmp%35@ tmp%36@) (=> %%location_label%%11 (= temp_11_0~2269@ temp_11_1~2330@))))))))))) (=> (= temp_11_0~2269@ temp_11_1~2330@) (=> (= temp_12_0~2479@ (Add (Mul (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2540@ (Add (Mul (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@)) (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@))) (Mul (Mul (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ d12~104@))))) (and (=> (= tmp%37@ (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@))) (=> (= tmp%38@ (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%37@ tmp%38@) (=> %%location_label%%12 (= temp_12_0~2479@ temp_12_1~2540@))))) (=> (= temp_12_0~2479@ temp_12_1~2540@) (=> (= temp_13_0~2653@ (Mul (Mul (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ b13~108@))) (Mul (Sub (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul b13~108@ b13~108@) c13~110@)))) (=> (= temp_13_1~2726@ (Mul (Mul (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ b13~108@))) (Sub (Mul (Mul d13~112@ b13~108@) (Mul (Mul b13~108@ b13~108@) c13~110@)) (Mul (Mul c13~110@ a13~106@) (Mul (Mul b13~108@ b13~108@) c13~110@))))) (and (=> (= tmp%39@ (Mul d13~112@ b13~108@)) (=> (= tmp%40@ (Mul c13~110@ a13~106@)) (=> (= tmp%41@ (Mul (Mul b13~108@ b13~108@) c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%39@ tmp%40@ tmp%41@) (=> %%location_label%%13 (= temp_13_0~2653@ temp_13_1~2726@)))))) (=> (= temp_13_0~2653@ temp_13_1~2726@) (=> (= temp_14_0~2837@ (Mul (Mul c14~118@ (Mul (Mul c14~118@ a14~114@) (Add d14~120@ c14~118@))) (Mul (Mul (Mul 14 c14~118@) (Mul a14~114@ b14~116@)) (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~2902@ (Mul (Mul (Mul (Mul 14 c14~118@) (Mul a14~114@ b14~116@)) (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@))) (Mul c14~118@ (Mul (Mul c14~118@ a14~114@) (Add d14~120@ c14~118@))))) (and (=> (= tmp%42@ (Mul (Mul (Mul 14 c14~118@) (Mul a14~114@ b14~116@)) (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@)))) (=> (= tmp%43@ (Mul c14~118@ (Mul (Mul c14~118@ a14~114@) (Add d14~120@ c14~118@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%42@ tmp%43@) (=> %%location_label%%14 (= temp_14_0~2837@ temp_14_1~2902@))))) (=> (= temp_14_0~2837@ temp_14_1~2902@) (=> (= temp_15_0~3043@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Add d15~128@ a15~122@)) (Mul (Sub c15~126@ c15~126@) (Mul a15~122@ b15~124@))) (Add (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ c15~126@)) (Sub (Mul b15~124@ c15~126@) (Mul b15~124@ b15~124@))))) (=> (= temp_15_1~3108@ (Mul (Mul (Mul b15~124@ d15~128@) (Add d15~128@ a15~122@)) (Mul (Mul (Sub c15~126@ c15~126@) (Mul a15~122@ b15~124@)) (Add (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ c15~126@)) (Sub (Mul b15~124@ c15~126@) (Mul b15~124@ b15~124@)))))) (and (=> (= tmp%44@ (Mul (Mul b15~124@ d15~128@) (Add d15~128@ a15~122@))) (=> (= tmp%45@ (Mul (Sub c15~126@ c15~126@) (Mul a15~122@ b15~124@))) (=> (= tmp%46@ (Add (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ c15~126@)) (Sub (Mul b15~124@ c15~126@) (Mul b15~124@ b15~124@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%44@ tmp%45@ tmp%46@) (=> %%location_label%%15 (= temp_15_0~3043@ temp_15_1~3108@)))))) (=> (= temp_15_0~3043@ temp_15_1~3108@) (=> (= temp_16_0~3263@ (Mul (Add (Mul a16~130@ (Mul a16~130@ 5)) (Mul (Sub c16~134@ a16~130@) (Mul c16~134@ c16~134@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul d16~136@ c16~134@)) (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ b16~132@))))) (=> (= temp_16_1~3336@ (Mul (Add (Mul a16~130@ (Mul a16~130@ 5)) (Mul (Sub c16~134@ a16~130@) (Mul c16~134@ c16~134@))) (Mul (Mul (Mul (Mul a16~130@ c16~134@) d16~136@) c16~134@) (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ b16~132@))))) (and (=> (= tmp%47@ (Mul a16~130@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%47@ d16~136@ c16~134@) (=> %%location_label%%16 (= temp_16_0~3263@ temp_16_1~3336@)))) (=> (= temp_16_0~3263@ temp_16_1~3336@) (=> (= temp_17_0~3443@ (Sub (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ c17~142@) c17~142@)) (Sub (Mul (Mul 55 c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ b17~140@))))) (=> (= temp_17_1~3516@ (Sub (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul d17~144@ (Mul c17~142@ c17~142@))) (Sub (Mul (Mul 55 c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ b17~140@))))) (=> (ens%main!nl_basics.lemma_mul_is_associative. d17~144@ c17~142@ c17~142@) (=> %%location_label%%17 (= temp_17_0~3443@ temp_17_1~3516@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
