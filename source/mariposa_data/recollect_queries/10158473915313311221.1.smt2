...
(declare-const temp_2_1~832@ Int)
(declare-const temp_3_0~939@ Int)
(declare-const temp_3_1~1004@ Int)
(declare-const temp_4_0~1120@ Int)
(declare-const temp_4_1~1221@ Int)
(declare-const temp_5_0~1342@ Int)
(declare-const temp_5_1~1419@ Int)
...
(declare-const temp_8_0~1870@ Int)
(declare-const temp_8_1~1923@ Int)
(declare-const temp_9_0~2116@ Int)
(declare-const temp_9_1~2181@ Int)
(declare-const temp_10_0~2282@ Int)
(declare-const temp_10_1~2331@ Int)
(declare-const temp_11_0~2396@ Int)
(declare-const temp_11_1~2449@ Int)
(declare-const temp_12_0~2560@ Int)
(declare-const temp_12_1~2621@ Int)
(declare-const temp_13_0~2722@ Int)
(declare-const temp_13_1~2775@ Int)
(declare-const temp_14_0~2998@ Int)
(declare-const temp_14_1~3087@ Int)
(declare-const temp_15_0~3326@ Int)
(declare-const temp_15_1~3387@ Int)
(declare-const temp_16_0~3490@ Int)
(declare-const temp_16_1~3543@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@)) (Sub (Mul a0~2@ c0~6@) (Mul c0~6@ b0~4@))) (Mul (Sub (Mul c0~6@ d0~8@) c0~6@) (Add (Mul c0~6@ d0~8@) c0~6@)))) (=> (= temp_0_1~354@ (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Sub (Mul a0~2@ c0~6@) (Mul c0~6@ b0~4@)) (Mul (Sub (Mul c0~6@ d0~8@) c0~6@) (Add (Mul c0~6@ d0~8@) c0~6@))))) (and (=> (= tmp%1@ (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@))) (=> (= tmp%2@ (Sub (Mul a0~2@ c0~6@) (Mul c0~6@ b0~4@))) (=> (= tmp%3@ (Mul (Sub (Mul c0~6@ d0~8@) c0~6@) (Add (Mul c0~6@ d0~8@) c0~6@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~354@)))))) (=> (= temp_0_0~297@ temp_0_1~354@) (=> (= temp_1_0~493@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@))) (Mul (Add (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@)) (Add (Sub d1~16@ c1~14@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~558@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@))) (Mul (Add (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@)) (Add (Sub d1~16@ c1~14@) (Mul b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ b1~12@) (=> (= tmp%4@ (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ b1~12@))) (=> (= tmp%5@ (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@))) (=> (= tmp%6@ (Mul (Add (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@)) (Add (Sub d1~16@ c1~14@) (Mul b1~12@ d1~16@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> (= tmp%7@ (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ c1~14@))) (=> (= tmp%8@ (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@))) (=> (= tmp%9@ (Mul (Add (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@)) (Add (Sub d1~16@ c1~14@) (Mul b1~12@ d1~16@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%1 (= temp_1_0~493@ temp_1_1~558@))))))))))) (=> (= temp_1_0~493@ temp_1_1~558@) (=> (= temp_2_0~771@ (Mul (Mul (Sub (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@))) (Mul (Mul a2~18@ (Mul a2~18@ d2~24@)) (Mul (Sub c2~22@ b2~20@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~832@ (Mul (Mul (Sub (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@))) (Mul (Mul a2~18@ (Mul d2~24@ a2~18@)) (Mul (Sub c2~22@ b2~20@) (Mul b2~20@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a2~18@ d2~24@ a2~18@) (=> (= tmp%10@ (Mul a2~18@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ tmp%10@) (=> %%location_label%%2 (= temp_2_0~771@ temp_2_1~832@))))) (=> (= temp_2_0~771@ temp_2_1~832@) (=> (= temp_3_0~939@ (Mul (Sub (Mul (Mul c3~30@ c3~30@) (Sub b3~28@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Sub a3~26@ b3~28@))) (Mul (Add (Mul a3~26@ a3~26@) (Add c3~30@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Add a3~26@ a3~26@))))) (=> (= temp_3_1~1004@ (Mul (Sub (Mul (Mul c3~30@ c3~30@) (Sub b3~28@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Sub a3~26@ b3~28@))) (Mul (Add (Mul a3~26@ a3~26@) (Add c3~30@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Add a3~26@ a3~26@))))) (=> (= tmp%11@ (= temp_3_0~939@ temp_3_1~1004@)) (and (=> %%location_label%%3 tmp%11@) (=> tmp%11@ (=> (= temp_4_0~1120@ (Mul (Mul (Mul (Mul b4~36@ 64) (Mul d4~40@ b4~36@)) (Mul (Mul 61 b4~36@) (Mul b4~36@ 11))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~1221@ (Mul (Mul (Mul (Mul b4~36@ 64) (Mul d4~40@ b4~36@)) (Mul (Mul b4~36@ 11) (Mul 61 b4~36@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@))))) (and (=> (= tmp%12@ (Mul b4~36@ 11)) (=> (= tmp%13@ (Mul 61 b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%4 (= temp_4_0~1120@ temp_4_1~1221@))))) (=> (= temp_4_0~1120@ temp_4_1~1221@) (=> (= temp_5_0~1342@ (Mul (Add (Mul (Mul a5~42@ 66) (Mul b5~44@ c5~46@)) (Sub (Add a5~42@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Sub b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1419@ (Mul (Add (Mul (Mul (Mul a5~42@ 66) b5~44@) c5~46@) (Sub (Add a5~42@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Sub b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ a5~42@))))) (and (=> (= tmp%14@ (Mul a5~42@ 66)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ b5~44@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1342@ temp_5_1~1419@)))) (=> (= temp_5_0~1342@ temp_5_1~1419@) (=> (= temp_6_0~1526@ (Mul (Sub (Mul (Mul d6~56@ d6~56@) b6~52@) (Sub (Mul 11 b6~52@) (Mul c6~54@ a6~50@))) (Mul (Mul c6~54@ (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1595@ (Mul (Sub (Mul (Mul d6~56@ d6~56@) b6~52@) (Sub (Mul 11 b6~52@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ b6~52@) c6~54@) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@))))) (and (=> (= tmp%15@ (Mul d6~56@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1526@ temp_6_1~1595@)))) (=> (= temp_6_0~1526@ temp_6_1~1595@) (=> (= temp_7_0~1708@ (Mul (Mul (Mul (Sub b7~60@ a7~58@) a7~58@) (Mul (Mul c7~62@ d7~64@) (Sub c7~62@ c7~62@))) (Mul (Mul (Add a7~58@ 38) c7~62@) (Mul (Add c7~62@ 34) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1789@ (Mul (Mul (Mul (Sub b7~60@ a7~58@) a7~58@) (Mul (Mul d7~64@ c7~62@) (Sub c7~62@ c7~62@))) (Mul (Mul (Add a7~58@ 38) c7~62@) (Mul (Add c7~62@ 34) (Mul a7~58@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ c7~62@) (=> %%location_label%%7 (= temp_7_0~1708@ temp_7_1~1789@))) (=> (= temp_7_0~1708@ temp_7_1~1789@) (=> (= temp_8_0~1870@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@)) a8~66@) (Mul (Mul (Sub b8~68@ a8~66@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1923@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@)) a8~66@) (Mul (Mul (Sub b8~68@ a8~66@) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ d8~72@) (=> (= tmp%16@ (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@)) a8~66@)) (=> (= tmp%17@ (Mul (Sub b8~68@ a8~66@) (Mul c8~70@ d8~72@))) (=> (= tmp%18@ (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> (= tmp%19@ (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@)) a8~66@)) (=> (= tmp%20@ (Mul (Sub b8~68@ a8~66@) (Mul c8~70@ d8~72@))) (=> (= tmp%21@ (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%8 (= temp_8_0~1870@ temp_8_1~1923@))))))))))) (=> (= temp_8_0~1870@ temp_8_1~1923@) (=> (= temp_9_0~2116@ (Mul (Mul (Mul (Sub c9~78@ b9~76@) (Mul d9~80@ b9~76@)) (Sub (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul a9~74@ a9~74@) (Mul a9~74@ d9~80@)) (Mul (Add d9~80@ c9~78@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~2181@ (Mul (Mul (Mul (Sub c9~78@ b9~76@) (Mul d9~80@ b9~76@)) (Sub (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@))) (Mul (Mul (Add d9~80@ c9~78@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ a9~74@) (Mul a9~74@ d9~80@))))) (and (=> (= tmp%22@ (Mul (Add d9~80@ c9~78@) (Mul b9~76@ a9~74@))) (=> (= tmp%23@ (Mul (Mul a9~74@ a9~74@) (Mul a9~74@ d9~80@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%9 (= temp_9_0~2116@ temp_9_1~2181@))))) (=> (= temp_9_0~2116@ temp_9_1~2181@) (=> (= temp_10_0~2282@ (Mul (Mul (Sub (Mul b10~84@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul b10~84@ c10~86@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul b10~84@ c10~86@) b10~84@) b10~84@))) (=> (= temp_10_1~2331@ (Mul (Mul (Sub (Mul b10~84@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul b10~84@ c10~86@) b10~84@) b10~84@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ b10~84@) (=> %%location_label%%10 (= temp_10_0~2282@ temp_10_1~2331@))) (=> (= temp_10_0~2282@ temp_10_1~2331@) (=> (= temp_11_0~2396@ (Mul a11~90@ (Mul (Sub (Sub b11~92@ a11~90@) (Mul a11~90@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ b11~92@))))) (=> (= temp_11_1~2449@ (Mul a11~90@ (Sub (Mul (Sub b11~92@ a11~90@) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ b11~92@))) (Mul (Mul a11~90@ c11~94@) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ b11~92@)))))) (and (=> (= tmp%24@ (Sub b11~92@ a11~90@)) (=> (= tmp%25@ (Mul a11~90@ c11~94@)) (=> (= tmp%26@ (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ b11~92@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%11 (= temp_11_0~2396@ temp_11_1~2449@)))))) (=> (= temp_11_0~2396@ temp_11_1~2449@) (=> (= temp_12_0~2560@ (Mul (Mul (Mul b12~100@ (Mul a12~98@ b12~100@)) (Mul (Mul d12~104@ d12~104@) (Add d12~104@ d12~104@))) (Mul (Mul (Mul a12~98@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@))))) (=> (= temp_12_1~2621@ (Mul (Mul (Mul (Mul d12~104@ d12~104@) (Add d12~104@ d12~104@)) (Mul b12~100@ (Mul a12~98@ b12~100@))) (Mul (Mul (Mul a12~98@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@))))) (and (=> (= tmp%27@ (Mul (Mul d12~104@ d12~104@) (Add d12~104@ d12~104@))) (=> (= tmp%28@ (Mul b12~100@ (Mul a12~98@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%12 (= temp_12_0~2560@ temp_12_1~2621@))))) (=> (= temp_12_0~2560@ temp_12_1~2621@) (=> (= temp_13_0~2722@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ b13~108@)) (Mul (Mul d13~112@ a13~106@) (Add c13~110@ c13~110@))) (Add (Mul (Mul b13~108@ b13~108@) (Sub b13~108@ b13~108@)) b13~108@))) (=> (= temp_13_1~2775@ (Mul (Mul (Mul d13~112@ (Mul b13~108@ (Mul a13~106@ b13~108@))) (Mul (Mul d13~112@ a13~106@) (Add c13~110@ c13~110@))) (Add (Mul (Mul b13~108@ b13~108@) (Sub b13~108@ b13~108@)) b13~108@))) (and (=> (= tmp%29@ (Mul a13~106@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d13~112@ b13~108@ tmp%29@) (=> (= tmp%30@ (Mul d13~112@ (Mul b13~108@ (Mul a13~106@ b13~108@)))) (=> (= tmp%31@ (Mul (Mul d13~112@ a13~106@) (Add c13~110@ c13~110@))) (=> (= tmp%32@ (Add (Mul (Mul b13~108@ b13~108@) (Sub b13~108@ b13~108@)) b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%30@ tmp%31@ tmp%32@) (=> (= tmp%33@ (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ b13~108@))) (=> (= tmp%34@ (Mul (Mul d13~112@ a13~106@) (Add c13~110@ c13~110@))) (=> (= tmp%35@ (Add (Mul (Mul b13~108@ b13~108@) (Sub b13~108@ b13~108@)) b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ tmp%34@ tmp%35@) (=> %%location_label%%13 (= temp_13_0~2722@ temp_13_1~2775@)))))))))))) (=> (= temp_13_0~2722@ temp_13_1~2775@) (=> (= temp_14_0~2998@ (Mul (Mul (Mul (Sub a14~114@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ c14~118@) (Add b14~116@ d14~120@))) (Mul (Mul (Mul 15 d14~120@) (Mul a14~114@ b14~116@)) (Mul (Mul 19 b14~116@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~3087@ (Mul (Mul (Mul (Sub a14~114@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ c14~118@) (Add b14~116@ d14~120@))) (Mul (Mul (Mul 15 d14~120@) (Mul a14~114@ b14~116@)) (Mul (Mul (Mul 19 b14~116@) c14~118@) b14~116@)))) (and (=> (= tmp%36@ (Mul (Mul (Sub a14~114@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ c14~118@) (Add b14~116@ d14~120@)))) (=> (= tmp%37@ (Mul (Mul 15 d14~120@) (Mul a14~114@ b14~116@))) (=> (= tmp%38@ (Mul (Mul (Mul 19 b14~116@) c14~118@) b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ tmp%37@ tmp%38@) (=> (= tmp%39@ (Mul 19 b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%39@ c14~118@ b14~116@) (=> (= tmp%40@ (Mul (Mul (Sub a14~114@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ c14~118@) (Add b14~116@ d14~120@)))) (=> (= tmp%41@ (Mul (Mul 15 d14~120@) (Mul a14~114@ b14~116@))) (=> (= tmp%42@ (Mul (Mul 19 b14~116@) (Mul c14~118@ b14~116@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ tmp%41@ tmp%42@) (=> %%location_label%%14 (= temp_14_0~2998@ temp_14_1~3087@)))))))))))) (=> (= temp_14_0~2998@ temp_14_1~3087@) (=> (= temp_15_0~3326@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ b15~124@)) (Mul b15~124@ (Mul b15~124@ c15~126@))) (Mul (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul c15~126@ a15~122@) (Sub c15~126@ d15~128@))))) (=> (= temp_15_1~3387@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ b15~124@)) (Mul b15~124@ (Mul b15~124@ c15~126@))) (Mul (Mul (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ a15~122@)) (Mul c15~126@ a15~122@)) (Sub c15~126@ d15~128@)))) (and (=> (= tmp%43@ (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ a15~122@))) (=> (= tmp%44@ (Mul c15~126@ a15~122@)) (=> (= tmp%45@ (Sub c15~126@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%43@ tmp%44@ tmp%45@) (=> %%location_label%%15 (= temp_15_0~3326@ temp_15_1~3387@)))))) (=> (= temp_15_0~3326@ temp_15_1~3387@) (=> (= temp_16_0~3490@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) b16~132@) (Mul (Add c16~134@ b16~132@) a16~130@)) (Mul (Mul d16~136@ (Mul a16~130@ a16~130@)) (Mul (Add c16~134@ c16~134@) (Mul c16~134@ c16~134@))))) (=> (= temp_16_1~3543@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) b16~132@) (Mul (Add c16~134@ b16~132@) a16~130@)) (Mul (Mul (Mul d16~136@ (Mul a16~130@ a16~130@)) (Add c16~134@ c16~134@)) (Mul c16~134@ c16~134@)))) (=> (= tmp%46@ (Mul d16~136@ (Mul a16~130@ a16~130@))) (=> (= tmp%47@ (Add c16~134@ c16~134@)) (=> (= tmp%48@ (Mul c16~134@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%46@ tmp%47@ tmp%48@) (=> %%location_label%%16 (= temp_16_0~3490@ temp_16_1~3543@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
