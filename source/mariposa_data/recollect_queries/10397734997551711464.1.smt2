...
(declare-const temp_4_0~999@ Int)
(declare-const temp_4_1~1076@ Int)
...
(declare-const temp_7_0~1659@ Int)
...
(declare-const temp_9_1~2168@ Int)
(declare-const temp_10_0~2385@ Int)
(declare-const temp_10_1~2446@ Int)
(declare-const temp_11_0~2679@ Int)
(declare-const temp_11_1~2768@ Int)
(declare-const temp_12_0~2836@ Int)
(declare-const temp_12_1~2889@ Int)
(declare-const temp_13_0~3002@ Int)
(declare-const temp_13_1~3075@ Int)
(declare-const temp_14_0~3190@ Int)
(declare-const temp_14_1~3255@ Int)
(declare-const temp_15_0~3474@ Int)
(declare-const temp_15_1~3535@ Int)
(declare-const temp_16_0~3624@ Int)
(declare-const temp_16_1~3685@ Int)
(declare-const temp_17_0~3790@ Int)
(declare-const temp_17_1~3867@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Sub (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul b0~4@ (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Add a0~2@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Sub (Mul b0~4@ (Mul a0~2@ (Mul d0~8@ d0~8@))) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul b0~4@ (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Add a0~2@ b0~4@))))) (and (=> (= tmp%1@ (Mul d0~8@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ a0~2@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@)))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~469@ (Mul (Sub (Mul (Mul a1~10@ b1~12@) (Sub a1~10@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul 76 d1~16@))) (Mul (Mul (Mul b1~12@ b1~12@) c1~14@) (Add (Mul b1~12@ a1~10@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~542@ (Mul (Sub (Mul (Mul a1~10@ b1~12@) (Sub a1~10@ c1~14@)) (Mul (Mul (Mul b1~12@ c1~14@) 76) d1~16@)) (Mul (Mul (Mul b1~12@ b1~12@) c1~14@) (Add (Mul b1~12@ a1~10@) (Mul c1~14@ b1~12@))))) (and (=> (= tmp%2@ (Mul b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ 76 d1~16@) (=> %%location_label%%1 (= temp_1_0~469@ temp_1_1~542@)))) (=> (= temp_1_0~469@ temp_1_1~542@) (=> (= temp_2_0~633@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Add d2~24@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@)) d2~24@))) (=> (= temp_2_1~686@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Add d2~24@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ b2~20@))) (Mul (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@)) d2~24@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ b2~20@) (=> (= tmp%3@ (Mul (Mul b2~20@ c2~22@) (Add d2~24@ b2~20@))) (=> (= tmp%4@ (Mul a2~18@ b2~20@)) (=> (= tmp%5@ (Mul a2~18@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Mul (Mul b2~20@ c2~22@) (Add d2~24@ b2~20@))) (=> (= tmp%7@ (Mul a2~18@ b2~20@)) (=> (= tmp%8@ (Mul b2~20@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%2 (= temp_2_0~633@ temp_2_1~686@))))))))))) (=> (= temp_2_0~633@ temp_2_1~686@) (=> (= temp_3_0~839@ (Mul (Mul (Sub (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Add (Sub b3~28@ a3~26@) (Sub c3~30@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Sub c3~30@ d3~32@)) (Add (Sub a3~26@ c3~30@) (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~904@ (Mul (Mul (Sub (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Add (Sub b3~28@ a3~26@) (Sub c3~30@ b3~28@))) (Mul (Mul d3~32@ (Mul a3~26@ (Sub c3~30@ d3~32@))) (Add (Sub a3~26@ c3~30@) (Mul c3~30@ b3~28@))))) (and (=> (= tmp%9@ (Sub c3~30@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d3~32@ a3~26@ tmp%9@) (=> %%location_label%%3 (= temp_3_0~839@ temp_3_1~904@)))) (=> (= temp_3_0~839@ temp_3_1~904@) (=> (= temp_4_0~999@ (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Add (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ b4~36@) d4~40@)))) (=> (= temp_4_1~1076@ (Mul (Add (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul a4~34@ a4~34@)) (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul d4~40@ d4~40@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ b4~36@) d4~40@)))) (and (=> (= tmp%10@ (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@))) (=> (= tmp%11@ (Mul a4~34@ a4~34@)) (=> (= tmp%12@ (Mul d4~40@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%4 (= temp_4_0~999@ temp_4_1~1076@)))))) (=> (= temp_4_0~999@ temp_4_1~1076@) (=> (= temp_5_0~1187@ (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ c5~46@) a5~42@)) (Sub (Add (Sub c5~46@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Add a5~42@ d5~48@) (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1248@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ c5~46@) a5~42@)) (Sub (Add (Sub c5~46@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Add a5~42@ d5~48@) (Mul a5~42@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ b5~44@) (=> (= tmp%13@ (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@))) (=> (= tmp%14@ (Mul (Mul d5~48@ c5~46@) a5~42@)) (=> (= tmp%15@ (Sub (Add (Sub c5~46@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Add a5~42@ d5~48@) (Mul a5~42@ a5~42@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> (= tmp%16@ (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ a5~42@))) (=> (= tmp%17@ (Mul (Mul d5~48@ c5~46@) a5~42@)) (=> (= tmp%18@ (Sub (Add (Sub c5~46@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Add a5~42@ d5~48@) (Mul a5~42@ a5~42@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%5 (= temp_5_0~1187@ temp_5_1~1248@))))))))))) (=> (= temp_5_0~1187@ temp_5_1~1248@) (=> (= temp_6_0~1457@ (Mul (Mul (Add (Sub b6~52@ b6~52@) (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ b6~52@))) (Mul (Sub (Mul a6~50@ d6~56@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1522@ (Mul (Mul (Add (Sub b6~52@ b6~52@) (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@))) (Mul (Sub (Mul a6~50@ d6~56@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ b6~52@) (=> (= tmp%19@ (Add (Sub b6~52@ b6~52@) (Mul c6~54@ d6~56@))) (=> (= tmp%20@ (Mul c6~54@ b6~52@)) (=> (= tmp%21@ (Mul b6~52@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> (= tmp%22@ (Add (Sub b6~52@ b6~52@) (Mul c6~54@ d6~56@))) (=> (= tmp%23@ (Mul c6~54@ b6~52@)) (=> (= tmp%24@ (Mul c6~54@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%6 (= temp_6_0~1457@ temp_6_1~1522@))))))))))) (=> (= temp_6_0~1457@ temp_6_1~1522@) (=> (= temp_7_0~1659@ (Mul (Mul (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul c7~62@ b7~60@) a7~58@)) (Mul (Sub (Mul a7~58@ b7~60@) (Add c7~62@ c7~62@)) b7~60@))) (=> (= temp_7_1~1708@ (Mul (Mul (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul a7~58@ (Mul c7~62@ b7~60@))) (Mul (Sub (Mul a7~58@ b7~60@) (Add c7~62@ c7~62@)) b7~60@))) (and (=> (= tmp%25@ (Mul c7~62@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ tmp%25@) (=> %%location_label%%7 (= temp_7_0~1659@ temp_7_1~1708@)))) (=> (= temp_7_0~1659@ temp_7_1~1708@) (=> (= temp_8_0~1805@ (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ d8~72@)) (Add (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ b8~68@))))) (=> (= temp_8_1~1870@ (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ a8~66@)) (Add (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d8~72@ a8~66@) (=> (= tmp%26@ (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ a8~66@))) (=> (= tmp%27@ (Add (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))) (=> (= tmp%28@ (Mul (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ b8~68@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> (= tmp%29@ (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ d8~72@))) (=> (= tmp%30@ (Add (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))) (=> (= tmp%31@ (Mul (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ b8~68@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> %%location_label%%8 (= temp_8_0~1805@ temp_8_1~1870@))))))))))) (=> (= temp_8_0~1805@ temp_8_1~1870@) (=> (= temp_9_0~2095@ (Mul (Mul (Mul a9~74@ (Mul c9~78@ a9~74@)) (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ 17))) (Mul (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@))))) (=> (= temp_9_1~2168@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) a9~74@) (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ 17))) (Mul (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@))))) (and (=> (= tmp%32@ (Mul c9~78@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%32@ a9~74@) (=> (= tmp%33@ (Mul (Mul c9~78@ a9~74@) a9~74@)) (=> (= tmp%34@ (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ 17))) (=> (= tmp%35@ (Mul (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ tmp%34@ tmp%35@) (=> (= tmp%36@ (Mul a9~74@ (Mul c9~78@ a9~74@))) (=> (= tmp%37@ (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ 17))) (=> (= tmp%38@ (Mul (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ tmp%37@ tmp%38@) (=> %%location_label%%9 (= temp_9_0~2095@ temp_9_1~2168@)))))))))))) (=> (= temp_9_0~2095@ temp_9_1~2168@) (=> (= temp_10_0~2385@ (Mul (Mul (Mul (Mul a10~82@ b10~84@) (Mul b10~84@ c10~86@)) (Add (Mul c10~86@ d10~88@) (Mul d10~88@ a10~82@))) (Mul (Mul (Mul d10~88@ b10~84@) (Add a10~82@ d10~88@)) (Mul d10~88@ (Mul d10~88@ d10~88@))))) (=> (= temp_10_1~2446@ (Mul (Mul (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ c10~86@)) (Add (Mul c10~86@ d10~88@) (Mul d10~88@ a10~82@))) (Mul (Mul (Mul d10~88@ b10~84@) (Add a10~82@ d10~88@)) (Mul d10~88@ (Mul d10~88@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b10~84@ a10~82@) (=> (= tmp%39@ (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ c10~86@))) (=> (= tmp%40@ (Add (Mul c10~86@ d10~88@) (Mul d10~88@ a10~82@))) (=> (= tmp%41@ (Mul (Mul (Mul d10~88@ b10~84@) (Add a10~82@ d10~88@)) (Mul d10~88@ (Mul d10~88@ d10~88@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%39@ tmp%40@ tmp%41@) (=> (= tmp%42@ (Mul (Mul a10~82@ b10~84@) (Mul b10~84@ c10~86@))) (=> (= tmp%43@ (Add (Mul c10~86@ d10~88@) (Mul d10~88@ a10~82@))) (=> (= tmp%44@ (Mul (Mul (Mul d10~88@ b10~84@) (Add a10~82@ d10~88@)) (Mul d10~88@ (Mul d10~88@ d10~88@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%42@ tmp%43@ tmp%44@) (=> %%location_label%%10 (= temp_10_0~2385@ temp_10_1~2446@))))))))))) (=> (= temp_10_0~2385@ temp_10_1~2446@) (=> (= temp_11_0~2679@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Add b11~92@ c11~94@)) (Add (Mul c11~94@ d11~96@) (Mul 81 c11~94@))) (Mul (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ c11~94@)) (Mul (Mul d11~96@ 18) (Mul b11~92@ b11~92@))))) (=> (= temp_11_1~2768@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Add b11~92@ c11~94@)) (Add (Mul c11~94@ d11~96@) (Mul 81 c11~94@))) (Mul (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ c11~94@)) (Mul (Mul d11~96@ 18) (Mul b11~92@ b11~92@))))) (=> (= tmp%45@ (= temp_11_0~2679@ temp_11_1~2768@)) (and (=> %%location_label%%11 tmp%45@) (=> tmp%45@ (=> (= temp_12_0~2836@ (Mul (Mul b12~100@ (Mul (Mul c12~102@ b12~100@) (Add b12~100@ d12~104@))) (Mul (Mul (Sub c12~102@ a12~98@) (Add b12~100@ d12~104@)) (Sub (Add b12~100@ c12~102@) (Mul c12~102@ a12~98@))))) (=> (= temp_12_1~2889@ (Mul (Mul (Mul (Mul c12~102@ b12~100@) (Add b12~100@ d12~104@)) b12~100@) (Mul (Mul (Sub c12~102@ a12~98@) (Add b12~100@ d12~104@)) (Sub (Add b12~100@ c12~102@) (Mul c12~102@ a12~98@))))) (and (=> (= tmp%46@ (Mul (Mul c12~102@ b12~100@) (Add b12~100@ d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%46@ b12~100@) (=> %%location_label%%12 (= temp_12_0~2836@ temp_12_1~2889@)))) (=> (= temp_12_0~2836@ temp_12_1~2889@) (=> (= temp_13_0~3002@ (Sub (Mul (Mul (Mul c13~110@ c13~110@) (Mul d13~112@ b13~108@)) (Mul (Mul b13~108@ d13~112@) (Mul d13~112@ a13~106@))) (Sub (Mul (Mul 96 d13~112@) a13~106@) (Mul (Mul a13~106@ c13~110@) (Mul b13~108@ c13~110@))))) (=> (= temp_13_1~3075@ (Sub (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Mul d13~112@ b13~108@)) (Mul b13~108@ d13~112@)) (Mul d13~112@ a13~106@)) (Sub (Mul (Mul 96 d13~112@) a13~106@) (Mul (Mul a13~106@ c13~110@) (Mul b13~108@ c13~110@))))) (and (=> (= tmp%47@ (Mul (Mul c13~110@ c13~110@) (Mul d13~112@ b13~108@))) (=> (= tmp%48@ (Mul b13~108@ d13~112@)) (=> (= tmp%49@ (Mul d13~112@ a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%47@ tmp%48@ tmp%49@) (=> %%location_label%%13 (= temp_13_0~3002@ temp_13_1~3075@)))))) (=> (= temp_13_0~3002@ temp_13_1~3075@) (=> (= temp_14_0~3190@ (Mul (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ c14~118@)) (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ d14~120@))) (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ a14~114@)) (Sub (Mul c14~118@ b14~116@) (Mul d14~120@ b14~116@))))) (=> (= temp_14_1~3255@ (Mul (Mul (Mul a14~114@ (Mul c14~118@ (Mul d14~120@ c14~118@))) (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ d14~120@))) (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ a14~114@)) (Sub (Mul c14~118@ b14~116@) (Mul d14~120@ b14~116@))))) (and (=> (= tmp%50@ (Mul d14~120@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a14~114@ c14~118@ tmp%50@) (=> (= tmp%51@ (Mul a14~114@ (Mul c14~118@ (Mul d14~120@ c14~118@)))) (=> (= tmp%52@ (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ d14~120@))) (=> (= tmp%53@ (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ a14~114@)) (Sub (Mul c14~118@ b14~116@) (Mul d14~120@ b14~116@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%51@ tmp%52@ tmp%53@) (=> (= tmp%54@ (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ c14~118@))) (=> (= tmp%55@ (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ d14~120@))) (=> (= tmp%56@ (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ a14~114@)) (Sub (Mul c14~118@ b14~116@) (Mul d14~120@ b14~116@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%54@ tmp%55@ tmp%56@) (=> %%location_label%%14 (= temp_14_0~3190@ temp_14_1~3255@)))))))))))) (=> (= temp_14_0~3190@ temp_14_1~3255@) (=> (= temp_15_0~3474@ (Add (Add (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ d15~128@)) (Mul (Mul a15~122@ c15~126@) (Mul a15~122@ b15~124@))) (Mul (Mul (Add b15~124@ d15~128@) c15~126@) (Mul (Mul a15~122@ b15~124@) (Mul a15~122@ a15~122@))))) (=> (= temp_15_1~3535@ (Add (Add (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ d15~128@)) (Mul (Mul c15~126@ a15~122@) (Mul a15~122@ b15~124@))) (Mul (Mul (Add b15~124@ d15~128@) c15~126@) (Mul (Mul a15~122@ b15~124@) (Mul a15~122@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c15~126@ a15~122@) (=> %%location_label%%15 (= temp_15_0~3474@ temp_15_1~3535@))) (=> (= temp_15_0~3474@ temp_15_1~3535@) (=> (= temp_16_0~3624@ (Mul (Sub (Mul (Mul a16~130@ d16~136@) (Mul a16~130@ b16~132@)) (Mul (Add b16~132@ a16~130@) (Add c16~134@ d16~136@))) (Add (Mul a16~130@ (Mul b16~132@ b16~132@)) (Mul (Mul a16~130@ a16~130@) (Mul d16~136@ c16~134@))))) (=> (= temp_16_1~3685@ (Mul (Sub (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Add b16~132@ a16~130@) (Add c16~134@ d16~136@))) (Add (Mul a16~130@ (Mul b16~132@ b16~132@)) (Mul (Mul a16~130@ a16~130@) (Mul d16~136@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b16~132@ a16~130@) (=> %%location_label%%16 (= temp_16_0~3624@ temp_16_1~3685@))) (=> (= temp_16_0~3624@ temp_16_1~3685@) (=> (= temp_17_0~3790@ (Mul (Mul (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ a17~138@)) (Mul (Mul a17~138@ d17~144@) (Sub c17~142@ c17~142@))) (Mul (Mul (Mul a17~138@ a17~138@) (Mul c17~142@ d17~144@)) (Mul (Mul c17~142@ 23) (Mul d17~144@ a17~138@))))) (=> (= temp_17_1~3867@ (Mul (Mul (Mul (Mul a17~138@ d17~144@) (Sub c17~142@ c17~142@)) (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ a17~138@))) (Mul (Mul (Mul a17~138@ a17~138@) (Mul c17~142@ d17~144@)) (Mul (Mul c17~142@ 23) (Mul d17~144@ a17~138@))))) (=> (= tmp%57@ (Mul (Mul a17~138@ d17~144@) (Sub c17~142@ c17~142@))) (=> (= tmp%58@ (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ a17~138@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%57@ tmp%58@) (=> %%location_label%%17 (= temp_17_0~3790@ temp_17_1~3867@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
