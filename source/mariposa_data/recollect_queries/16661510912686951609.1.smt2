...
(declare-const temp_4_0~1063@ Int)
(declare-const temp_4_1~1124@ Int)
(declare-const temp_5_0~1247@ Int)
...
(declare-const temp_7_1~1704@ Int)
(declare-const temp_8_0~1821@ Int)
(declare-const temp_8_1~1882@ Int)
(declare-const temp_9_0~2093@ Int)
(declare-const temp_9_1~2154@ Int)
(declare-const temp_10_0~2271@ Int)
(declare-const temp_10_1~2336@ Int)
(declare-const temp_11_0~2459@ Int)
(declare-const temp_11_1~2544@ Int)
(declare-const temp_12_0~2639@ Int)
(declare-const temp_12_1~2700@ Int)
(declare-const temp_13_0~2793@ Int)
(declare-const temp_13_1~2850@ Int)
(declare-const temp_14_0~2945@ Int)
(declare-const temp_14_1~3010@ Int)
(declare-const temp_15_0~3245@ Int)
(declare-const temp_15_1~3322@ Int)
(declare-const temp_16_0~3451@ Int)
(declare-const temp_16_1~3524@ Int)
(declare-const temp_17_0~3641@ Int)
(declare-const temp_17_1~3730@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Sub (Mul c0~6@ b0~4@) (Mul a0~2@ a0~2@))) (Mul (Mul (Mul d0~8@ c0~6@) (Add b0~4@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Sub (Mul c0~6@ b0~4@) (Mul a0~2@ a0~2@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Add b0~4@ b0~4@))))) (and (=> (= tmp%1@ (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= tmp%2@ (Mul (Mul d0~8@ c0~6@) (Add b0~4@ b0~4@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~475@ (Mul (Mul (Mul (Add d1~16@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ b1~12@))) (Sub (Add (Mul d1~16@ b1~12@) (Sub d1~16@ c1~14@)) b1~12@))) (=> (= temp_1_1~528@ (Mul (Mul (Mul (Mul (Add d1~16@ b1~12@) (Mul d1~16@ b1~12@)) (Mul b1~12@ b1~12@)) (Mul a1~10@ b1~12@)) (Sub (Add (Mul d1~16@ b1~12@) (Sub d1~16@ c1~14@)) b1~12@))) (and (=> (= tmp%3@ (Mul (Add d1~16@ b1~12@) (Mul d1~16@ b1~12@))) (=> (= tmp%4@ (Mul b1~12@ b1~12@)) (=> (= tmp%5@ (Mul a1~10@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~475@ temp_1_1~528@)))))) (=> (= temp_1_0~475@ temp_1_1~528@) (=> (= temp_2_0~639@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Sub a2~18@ d2~24@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@)) (Sub (Mul c2~22@ d2~24@) d2~24@)))) (=> (= temp_2_1~700@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Sub a2~18@ d2~24@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@)) (Sub (Mul d2~24@ c2~22@) d2~24@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ c2~22@) (=> (= tmp%6@ (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Sub a2~18@ d2~24@)))) (=> (= tmp%7@ (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@))) (=> (= tmp%8@ (Sub (Mul d2~24@ c2~22@) d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> (= tmp%9@ (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Sub a2~18@ d2~24@)))) (=> (= tmp%10@ (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@))) (=> (= tmp%11@ (Sub (Mul c2~22@ d2~24@) d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%2 (= temp_2_0~639@ temp_2_1~700@))))))))))) (=> (= temp_2_0~639@ temp_2_1~700@) (=> (= temp_3_0~909@ (Mul (Sub (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~974@ (Mul (Sub (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ d3~32@)) (Add (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ a3~26@) (=> %%location_label%%3 (= temp_3_0~909@ temp_3_1~974@))) (=> (= temp_3_0~909@ temp_3_1~974@) (=> (= temp_4_0~1063@ (Sub (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@)) (Add d4~40@ (Add d4~40@ a4~34@))) (Sub (Sub (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~1124@ (Sub (Mul (Mul d4~40@ c4~38@) (Mul (Mul d4~40@ a4~34@) (Add d4~40@ (Add d4~40@ a4~34@)))) (Sub (Sub (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@))))) (and (=> (= tmp%12@ (Mul d4~40@ c4~38@)) (=> (= tmp%13@ (Mul d4~40@ a4~34@)) (=> (= tmp%14@ (Add d4~40@ (Add d4~40@ a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%4 (= temp_4_0~1063@ temp_4_1~1124@)))))) (=> (= temp_4_0~1063@ temp_4_1~1124@) (=> (= temp_5_0~1247@ (Sub (Mul (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul 58 b5~44@))) (Mul (Add (Mul b5~44@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Sub c5~46@ b5~44@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1324@ (Sub (Mul (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ 58))) (Mul (Add (Mul b5~44@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Sub c5~46@ b5~44@) (Mul c5~46@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b5~44@ 58) (=> (= tmp%15@ (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ a5~42@))) (=> (= tmp%16@ (Mul a5~42@ c5~46@)) (=> (= tmp%17@ (Mul b5~44@ 58)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> (= tmp%18@ (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ a5~42@))) (=> (= tmp%19@ (Mul a5~42@ c5~46@)) (=> (= tmp%20@ (Mul 58 b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%5 (= temp_5_0~1247@ temp_5_1~1324@))))))))))) (=> (= temp_5_0~1247@ temp_5_1~1324@) (=> (= temp_6_0~1485@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@)) (Mul c6~54@ (Mul b6~52@ a6~50@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ b6~52@)) (Add (Mul c6~54@ d6~56@) (Sub b6~52@ a6~50@))))) (=> (= temp_6_1~1546@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@)) (Mul c6~54@ (Mul b6~52@ a6~50@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ d6~56@)) (Add (Mul c6~54@ d6~56@) (Sub b6~52@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b6~52@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1485@ temp_6_1~1546@))) (=> (= temp_6_0~1485@ temp_6_1~1546@) (=> (= temp_7_0~1639@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@)) b7~60@) (Mul (Sub (Mul d7~64@ d7~64@) (Mul c7~62@ 67)) (Add (Add d7~64@ c7~62@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1704@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@)) b7~60@) (Mul (Add (Add d7~64@ c7~62@) (Mul a7~58@ c7~62@)) (Sub (Mul d7~64@ d7~64@) (Mul c7~62@ 67))))) (and (=> (= tmp%21@ (Add (Add d7~64@ c7~62@) (Mul a7~58@ c7~62@))) (=> (= tmp%22@ (Sub (Mul d7~64@ d7~64@) (Mul c7~62@ 67))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%7 (= temp_7_0~1639@ temp_7_1~1704@))))) (=> (= temp_7_0~1639@ temp_7_1~1704@) (=> (= temp_8_0~1821@ (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1882@ (Mul (Mul (Mul d8~72@ (Mul b8~68@ (Mul d8~72@ d8~72@))) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ a8~66@))))) (and (=> (= tmp%23@ (Mul d8~72@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d8~72@ b8~68@ tmp%23@) (=> (= tmp%24@ (Mul d8~72@ (Mul b8~68@ (Mul d8~72@ d8~72@)))) (=> (= tmp%25@ (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ a8~66@))) (=> (= tmp%26@ (Mul (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ a8~66@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> (= tmp%27@ (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@))) (=> (= tmp%28@ (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ a8~66@))) (=> (= tmp%29@ (Mul (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ a8~66@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> %%location_label%%8 (= temp_8_0~1821@ temp_8_1~1882@)))))))))))) (=> (= temp_8_0~1821@ temp_8_1~1882@) (=> (= temp_9_0~2093@ (Mul (Mul (Mul d9~80@ (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ b9~76@) (Mul d9~80@ b9~76@))) (Mul (Mul (Add d9~80@ b9~76@) (Mul d9~80@ c9~78@)) (Mul (Add a9~74@ b9~76@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~2154@ (Mul (Mul (Mul d9~80@ (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ b9~76@) (Mul d9~80@ b9~76@))) (Mul (Mul (Add a9~74@ b9~76@) (Mul a9~74@ c9~78@)) (Mul (Add d9~80@ b9~76@) (Mul d9~80@ c9~78@))))) (and (=> (= tmp%30@ (Mul (Add a9~74@ b9~76@) (Mul a9~74@ c9~78@))) (=> (= tmp%31@ (Mul (Add d9~80@ b9~76@) (Mul d9~80@ c9~78@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%30@ tmp%31@) (=> %%location_label%%9 (= temp_9_0~2093@ temp_9_1~2154@))))) (=> (= temp_9_0~2093@ temp_9_1~2154@) (=> (= temp_10_0~2271@ (Add (Mul (Mul (Sub b10~84@ a10~82@) (Mul a10~82@ a10~82@)) (Sub (Mul d10~88@ b10~84@) (Mul d10~88@ c10~86@))) (Sub (Mul (Mul d10~88@ b10~84@) (Sub c10~86@ b10~84@)) (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ a10~82@))))) (=> (= temp_10_1~2336@ (Add (Mul (Mul (Mul (Sub b10~84@ a10~82@) a10~82@) a10~82@) (Sub (Mul d10~88@ b10~84@) (Mul d10~88@ c10~86@))) (Sub (Mul (Mul d10~88@ b10~84@) (Sub c10~86@ b10~84@)) (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ a10~82@))))) (and (=> (= tmp%32@ (Sub b10~84@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ a10~82@ a10~82@) (=> %%location_label%%10 (= temp_10_0~2271@ temp_10_1~2336@)))) (=> (= temp_10_0~2271@ temp_10_1~2336@) (=> (= temp_11_0~2459@ (Mul (Mul (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))) (Mul (Sub (Mul 31 d11~96@) (Mul d11~96@ d11~96@)) (Mul (Mul c11~94@ 99) (Mul a11~90@ a11~90@))))) (=> (= temp_11_1~2544@ (Mul (Mul (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))) (Mul (Mul (Sub 31 d11~96@) d11~96@) (Mul (Mul c11~94@ 99) (Mul a11~90@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. 31 d11~96@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2459@ temp_11_1~2544@))) (=> (= temp_11_0~2459@ temp_11_1~2544@) (=> (= temp_12_0~2639@ (Mul (Mul d12~104@ (Add (Mul c12~102@ 48) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ c12~102@)) (Mul d12~104@ (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2700@ (Mul (Mul d12~104@ (Add (Mul c12~102@ 48) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ a12~98@)) (Mul d12~104@ (Mul a12~98@ d12~104@))))) (and (=> (= tmp%33@ (Mul d12~104@ c12~102@)) (=> (= tmp%34@ (Mul c12~102@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%33@ tmp%34@) (=> %%location_label%%12 (= temp_12_0~2639@ temp_12_1~2700@))))) (=> (= temp_12_0~2639@ temp_12_1~2700@) (=> (= temp_13_0~2793@ (Mul (Mul (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@))) (Add (Mul (Mul c13~110@ d13~112@) c13~110@) (Mul (Mul b13~108@ b13~108@) c13~110@)))) (=> (= temp_13_1~2850@ (Mul (Mul (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@))) (Add (Mul (Mul c13~110@ d13~112@) c13~110@) (Mul b13~108@ (Mul b13~108@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b13~108@ b13~108@ c13~110@) (=> %%location_label%%13 (= temp_13_0~2793@ temp_13_1~2850@))) (=> (= temp_13_0~2793@ temp_13_1~2850@) (=> (= temp_14_0~2945@ (Mul (Mul (Mul (Add a14~114@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul c14~118@ b14~116@) (Mul d14~120@ d14~120@))) (Mul (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ c14~118@)) (Mul (Mul b14~116@ a14~114@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~3010@ (Mul (Mul (Mul (Add a14~114@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul c14~118@ b14~116@) (Mul d14~120@ d14~120@))) (Mul (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ c14~118@)) (Mul (Mul (Mul b14~116@ a14~114@) c14~118@) d14~120@)))) (and (=> (= tmp%35@ (Mul (Mul (Add a14~114@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul c14~118@ b14~116@) (Mul d14~120@ d14~120@)))) (=> (= tmp%36@ (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ c14~118@))) (=> (= tmp%37@ (Mul (Mul (Mul b14~116@ a14~114@) c14~118@) d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ tmp%36@ tmp%37@) (=> (= tmp%38@ (Mul b14~116@ a14~114@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ c14~118@ d14~120@) (=> (= tmp%39@ (Mul (Mul (Add a14~114@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul c14~118@ b14~116@) (Mul d14~120@ d14~120@)))) (=> (= tmp%40@ (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ c14~118@))) (=> (= tmp%41@ (Mul (Mul b14~116@ a14~114@) (Mul c14~118@ d14~120@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%39@ tmp%40@ tmp%41@) (=> %%location_label%%14 (= temp_14_0~2945@ temp_14_1~3010@)))))))))))) (=> (= temp_14_0~2945@ temp_14_1~3010@) (=> (= temp_15_0~3245@ (Sub (Mul (Add (Add a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Sub a15~122@ b15~124@) (Mul b15~124@ a15~122@))) (Mul (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ c15~126@)) (Mul (Mul b15~124@ 35) (Mul b15~124@ a15~122@))))) (=> (= temp_15_1~3322@ (Sub (Mul (Add (Add a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Sub a15~122@ b15~124@) (Mul b15~124@ a15~122@))) (Mul (Mul (Mul b15~124@ 35) (Mul b15~124@ a15~122@)) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ c15~126@))))) (and (=> (= tmp%42@ (Mul (Mul b15~124@ 35) (Mul b15~124@ a15~122@))) (=> (= tmp%43@ (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%42@ tmp%43@) (=> %%location_label%%15 (= temp_15_0~3245@ temp_15_1~3322@))))) (=> (= temp_15_0~3245@ temp_15_1~3322@) (=> (= temp_16_0~3451@ (Mul (Mul (Sub (Mul d16~136@ b16~132@) (Mul a16~130@ d16~136@)) (Mul (Mul a16~130@ b16~132@) d16~136@)) (Mul (Mul (Mul d16~136@ 51) (Mul b16~132@ b16~132@)) (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ c16~134@))))) (=> (= temp_16_1~3524@ (Mul (Mul (Sub (Mul d16~136@ b16~132@) (Mul a16~130@ d16~136@)) (Mul (Mul b16~132@ a16~130@) d16~136@)) (Mul (Mul (Mul d16~136@ 51) (Mul b16~132@ b16~132@)) (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b16~132@ a16~130@) (=> %%location_label%%16 (= temp_16_0~3451@ temp_16_1~3524@))) (=> (= temp_16_0~3451@ temp_16_1~3524@) (=> (= temp_17_0~3641@ (Mul (Mul (Mul (Mul b17~140@ d17~144@) (Mul c17~142@ a17~138@)) (Mul (Mul b17~140@ d17~144@) (Mul 93 d17~144@))) (Mul (Sub (Sub c17~142@ 85) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ d17~144@) (Mul c17~142@ d17~144@))))) (=> (= temp_17_1~3730@ (Mul (Mul (Mul (Mul b17~140@ d17~144@) (Mul c17~142@ a17~138@)) (Mul (Mul b17~140@ d17~144@) (Mul 93 d17~144@))) (Mul (Sub (Sub c17~142@ 85) (Mul d17~144@ d17~144@)) (Mul b17~140@ (Mul d17~144@ (Mul c17~142@ d17~144@)))))) (=> (= tmp%44@ (Mul c17~142@ d17~144@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b17~140@ d17~144@ tmp%44@) (=> (= tmp%45@ (Mul (Mul (Mul b17~140@ d17~144@) (Mul c17~142@ a17~138@)) (Mul (Mul b17~140@ d17~144@) (Mul 93 d17~144@)))) (=> (= tmp%46@ (Sub (Sub c17~142@ 85) (Mul d17~144@ d17~144@))) (=> (= tmp%47@ (Mul b17~140@ (Mul d17~144@ (Mul c17~142@ d17~144@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%45@ tmp%46@ tmp%47@) (=> (= tmp%48@ (Mul (Mul (Mul b17~140@ d17~144@) (Mul c17~142@ a17~138@)) (Mul (Mul b17~140@ d17~144@) (Mul 93 d17~144@)))) (=> (= tmp%49@ (Sub (Sub c17~142@ 85) (Mul d17~144@ d17~144@))) (=> (= tmp%50@ (Mul (Mul b17~140@ d17~144@) (Mul c17~142@ d17~144@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%48@ tmp%49@ tmp%50@) (=> %%location_label%%17 (= temp_17_0~3641@ temp_17_1~3730@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
