...
(declare-const temp_2_0~652@ Int)
(declare-const temp_2_1~713@ Int)
(declare-const temp_3_0~810@ Int)
(declare-const temp_3_1~879@ Int)
(declare-const temp_4_0~956@ Int)
(declare-const temp_4_1~993@ Int)
(declare-const temp_5_0~1088@ Int)
(declare-const temp_5_1~1149@ Int)
(declare-const temp_6_0~1248@ Int)
(declare-const temp_6_1~1313@ Int)
(declare-const temp_7_0~1412@ Int)
(declare-const temp_7_1~1477@ Int)
(declare-const temp_8_0~1612@ Int)
(declare-const temp_8_1~1665@ Int)
(declare-const temp_9_0~1760@ Int)
(declare-const temp_9_1~1821@ Int)
(declare-const temp_10_0~1926@ Int)
(declare-const temp_10_1~1995@ Int)
(declare-const temp_11_0~2108@ Int)
(declare-const temp_11_1~2173@ Int)
(declare-const temp_12_0~2410@ Int)
(declare-const temp_12_1~2487@ Int)
(declare-const temp_13_0~2576@ Int)
(declare-const temp_13_1~2637@ Int)
(declare-const temp_14_0~2738@ Int)
(declare-const temp_14_1~2791@ Int)
(declare-const temp_15_0~2888@ Int)
(declare-const temp_15_1~2957@ Int)
(declare-const temp_16_0~3200@ Int)
(declare-const temp_16_1~3277@ Int)
(declare-const temp_17_0~3514@ Int)
(declare-const temp_17_1~3591@ Int)
(declare-const temp_18_0~3684@ Int)
(declare-const temp_18_1~3749@ Int)
(declare-const temp_19_0~3860@ Int)
(declare-const temp_19_1~3937@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~309@ (Add (Sub (Add (Mul d0~8@ 56) (Mul a0~2@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@))) (Mul (Add (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@)) (Mul d0~8@ a0~2@)))) (=> (= temp_0_1~378@ (Add (Sub (Add (Mul d0~8@ 56) (Mul a0~2@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@))) (Mul (Mul d0~8@ a0~2@) (Add (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@))))) (and (=> (= tmp%1@ (Mul d0~8@ a0~2@)) (=> (= tmp%2@ (Add (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~309@ temp_0_1~378@))))) (=> (= temp_0_0~309@ temp_0_1~378@) (=> (= temp_1_0~499@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Sub a1~10@ b1~12@) (Mul a1~10@ 12))) (Add (Add (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Sub a1~10@ a1~10@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~576@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Sub a1~10@ b1~12@) (Mul a1~10@ 12))) (Add (Add (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Sub a1~10@ a1~10@) (Mul c1~14@ a1~10@))))) (=> (= tmp%3@ (= temp_1_0~499@ temp_1_1~576@)) (and (=> %%location_label%%1 tmp%3@) (=> tmp%3@ (=> (= temp_2_0~652@ (Add (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)) (Mul c2~22@ (Mul b2~20@ c2~22@))) (Mul (Sub (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@)) (Add (Sub a2~18@ c2~22@) (Sub c2~22@ b2~20@))))) (=> (= temp_2_1~713@ (Add (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)) (Mul c2~22@ (Mul b2~20@ c2~22@))) (Mul (Sub (Mul d2~24@ a2~18@) (Mul b2~20@ c2~22@)) (Add (Sub a2~18@ c2~22@) (Sub c2~22@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ a2~18@) (=> %%location_label%%2 (= temp_2_0~652@ temp_2_1~713@))) (=> (= temp_2_0~652@ temp_2_1~713@) (=> (= temp_3_0~810@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ a3~26@)) (Mul (Sub c3~30@ a3~26@) (Mul 96 c3~30@))) (Mul (Mul d3~32@ (Mul d3~32@ d3~32@)) (Sub (Mul b3~28@ c3~30@) c3~30@)))) (=> (= temp_3_1~879@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ a3~26@)) (Mul (Mul 96 c3~30@) (Sub c3~30@ a3~26@))) (Mul (Mul d3~32@ (Mul d3~32@ d3~32@)) (Sub (Mul b3~28@ c3~30@) c3~30@)))) (and (=> (= tmp%4@ (Mul 96 c3~30@)) (=> (= tmp%5@ (Sub c3~30@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~810@ temp_3_1~879@))))) (=> (= temp_3_0~810@ temp_3_1~879@) (=> (= temp_4_0~956@ (Mul c4~38@ (Mul (Mul (Sub b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~993@ (Mul c4~38@ (Mul (Mul (Mul (Sub b4~36@ d4~40@) d4~40@) c4~38@) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@))))) (and (=> (= tmp%6@ (Sub b4~36@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ d4~40@ c4~38@) (=> %%location_label%%4 (= temp_4_0~956@ temp_4_1~993@)))) (=> (= temp_4_0~956@ temp_4_1~993@) (=> (= temp_5_0~1088@ (Mul (Add (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ c5~46@)) (Mul b5~44@ (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1149@ (Mul (Add (Mul (Mul (Mul c5~46@ a5~42@) a5~42@) a5~42@) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ c5~46@)) (Mul b5~44@ (Mul c5~46@ d5~48@))))) (and (=> (= tmp%7@ (Mul c5~46@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ a5~42@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1088@ temp_5_1~1149@)))) (=> (= temp_5_0~1088@ temp_5_1~1149@) (=> (= temp_6_0~1248@ (Mul (Sub (Add (Mul c6~54@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Sub b6~52@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ d6~56@) (Sub a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1313@ (Mul (Sub (Add (Mul c6~54@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Sub b6~52@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Mul a6~50@ (Mul d6~56@ (Sub a6~50@ d6~56@))) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@))))) (and (=> (= tmp%8@ (Sub a6~50@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a6~50@ d6~56@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~1248@ temp_6_1~1313@)))) (=> (= temp_6_0~1248@ temp_6_1~1313@) (=> (= temp_7_0~1412@ (Mul (Mul (Mul (Add c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ b7~60@))) (Mul (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)) (Add (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@))))) (=> (= temp_7_1~1477@ (Mul (Mul (Mul (Mul (Add c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ b7~60@))) (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@))) (Add (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@)))) (and (=> (= tmp%9@ (Mul (Mul (Add c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ b7~60@)))) (=> (= tmp%10@ (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@))) (=> (= tmp%11@ (Add (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%7 (= temp_7_0~1412@ temp_7_1~1477@)))))) (=> (= temp_7_0~1412@ temp_7_1~1477@) (=> (= temp_8_0~1612@ (Mul (Add (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@)) d8~72@) (Mul a8~66@ (Mul (Mul a8~66@ c8~70@) (Add 38 b8~68@))))) (=> (= temp_8_1~1665@ (Mul (Add (Mul d8~72@ (Mul c8~70@ (Mul c8~70@ c8~70@))) d8~72@) (Mul a8~66@ (Mul (Mul a8~66@ c8~70@) (Add 38 b8~68@))))) (and (=> (= tmp%12@ (Mul c8~70@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d8~72@ c8~70@ tmp%12@) (=> %%location_label%%8 (= temp_8_0~1612@ temp_8_1~1665@)))) (=> (= temp_8_0~1612@ temp_8_1~1665@) (=> (= temp_9_0~1760@ (Mul (Mul (Mul b9~76@ (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~1821@ (Mul (Mul (Mul b9~76@ (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ c9~78@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ b9~76@))))) (and (=> (= tmp%13@ (Mul c9~78@ c9~78@)) (=> (= tmp%14@ (Mul b9~76@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%9 (= temp_9_0~1760@ temp_9_1~1821@))))) (=> (= temp_9_0~1760@ temp_9_1~1821@) (=> (= temp_10_0~1926@ (Mul (Mul (Mul a10~82@ (Sub a10~82@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@))) (Add (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@)) (Mul a10~82@ (Mul 41 b10~84@))))) (=> (= temp_10_1~1995@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@)) (Mul a10~82@ (Sub a10~82@ c10~86@))) (Add (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@)) (Mul a10~82@ (Mul 41 b10~84@))))) (and (=> (= tmp%15@ (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@))) (=> (= tmp%16@ (Mul a10~82@ (Sub a10~82@ c10~86@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%10 (= temp_10_0~1926@ temp_10_1~1995@))))) (=> (= temp_10_0~1926@ temp_10_1~1995@) (=> (= temp_11_0~2108@ (Mul (Mul (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2173@ (Mul (Mul (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@))))) (and (=> (= tmp%17@ (Mul a11~90@ d11~96@)) (=> (= tmp%18@ (Mul c11~94@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> (= tmp%19@ (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ d11~96@))) (=> (= tmp%20@ (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ d11~96@))) (=> (= tmp%21@ (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> (= tmp%22@ (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ d11~96@))) (=> (= tmp%23@ (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ d11~96@))) (=> (= tmp%24@ (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%11 (= temp_11_0~2108@ temp_11_1~2173@))))))))))))) (=> (= temp_11_0~2108@ temp_11_1~2173@) (=> (= temp_12_0~2410@ (Add (Mul (Sub (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ c12~102@))) (Mul (Mul (Add b12~100@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Mul a12~98@ 15) (Add c12~102@ d12~104@))))) (=> (= temp_12_1~2487@ (Add (Mul (Sub (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ c12~102@))) (Mul (Mul (Add b12~100@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Mul a12~98@ 15) (Add c12~102@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d12~104@ b12~100@) (=> %%location_label%%12 (= temp_12_0~2410@ temp_12_1~2487@))) (=> (= temp_12_0~2410@ temp_12_1~2487@) (=> (= temp_13_0~2576@ (Mul (Mul (Mul (Mul c13~110@ b13~108@) a13~106@) (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ c13~110@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Add a13~106@ b13~108@))))) (=> (= temp_13_1~2637@ (Mul (Mul (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ c13~110@)) (Mul (Mul c13~110@ b13~108@) a13~106@)) (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Add a13~106@ b13~108@))))) (and (=> (= tmp%25@ (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ c13~110@))) (=> (= tmp%26@ (Mul (Mul c13~110@ b13~108@) a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%25@ tmp%26@) (=> %%location_label%%13 (= temp_13_0~2576@ temp_13_1~2637@))))) (=> (= temp_13_0~2576@ temp_13_1~2637@) (=> (= temp_14_0~2738@ (Sub (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) a14~114@) (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2791@ (Sub (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) a14~114@) (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ b14~116@)) (Mul (Mul b14~116@ d14~120@) (Mul b14~116@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2738@ temp_14_1~2791@))) (=> (= temp_14_0~2738@ temp_14_1~2791@) (=> (= temp_15_0~2888@ (Mul (Mul (Mul (Mul c15~126@ 81) c15~126@) (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ d15~128@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul b15~124@ b15~124@) d15~128@)))) (=> (= temp_15_1~2957@ (Mul (Mul (Mul (Mul 81 c15~126@) c15~126@) (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ d15~128@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul b15~124@ b15~124@) d15~128@)))) (and (=> (= tmp%27@ (Mul 81 c15~126@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ c15~126@) (=> (= tmp%28@ (Mul (Mul 81 c15~126@) c15~126@)) (=> (= tmp%29@ (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ d15~128@))) (=> (= tmp%30@ (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul b15~124@ b15~124@) d15~128@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> (ens%main!nl_basics.lemma_mul_is_associative. c15~126@ 81 c15~126@) (=> (= tmp%31@ (Mul (Mul c15~126@ 81) c15~126@)) (=> (= tmp%32@ (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ d15~128@))) (=> (= tmp%33@ (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul b15~124@ b15~124@) d15~128@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> %%location_label%%15 (= temp_15_0~2888@ temp_15_1~2957@))))))))))))) (=> (= temp_15_0~2888@ temp_15_1~2957@) (=> (= temp_16_0~3200@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Add a16~130@ b16~132@)) (Sub (Mul a16~130@ d16~136@) (Mul d16~136@ c16~134@))) (Mul (Sub (Mul b16~132@ 70) (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ c16~134@))))) (=> (= temp_16_1~3277@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Add a16~130@ b16~132@)) (Sub (Mul a16~130@ d16~136@) (Mul d16~136@ c16~134@))) (Mul (Sub (Mul b16~132@ 70) (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d16~136@ b16~132@) (=> (= tmp%34@ (Mul (Mul d16~136@ b16~132@) (Add a16~130@ b16~132@))) (=> (= tmp%35@ (Sub (Mul a16~130@ d16~136@) (Mul d16~136@ c16~134@))) (=> (= tmp%36@ (Mul (Sub (Mul b16~132@ 70) (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ c16~134@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ tmp%35@ tmp%36@) (=> (= tmp%37@ (Mul (Mul b16~132@ d16~136@) (Add a16~130@ b16~132@))) (=> (= tmp%38@ (Sub (Mul a16~130@ d16~136@) (Mul d16~136@ c16~134@))) (=> (= tmp%39@ (Mul (Sub (Mul b16~132@ 70) (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ c16~134@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%37@ tmp%38@ tmp%39@) (=> %%location_label%%16 (= temp_16_0~3200@ temp_16_1~3277@))))))))))) (=> (= temp_16_0~3200@ temp_16_1~3277@) (=> (= temp_17_0~3514@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ d17~144@))) (Sub (Add (Mul 11 b17~140@) (Mul b17~140@ b17~140@)) (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ b17~140@))))) (=> (= temp_17_1~3591@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ d17~144@))) (Sub (Add (Mul 11 b17~140@) (Mul b17~140@ b17~140@)) (Mul (Mul d17~144@ b17~140@) (Mul b17~140@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b17~140@ d17~144@) (=> %%location_label%%17 (= temp_17_0~3514@ temp_17_1~3591@))) (=> (= temp_17_0~3514@ temp_17_1~3591@) (=> (= temp_18_0~3684@ (Mul (Mul (Add (Mul b18~148@ c18~150@) (Mul b18~148@ b18~148@)) (Add (Mul c18~150@ b18~148@) (Mul b18~148@ d18~152@))) (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ a18~146@)) (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~3749@ (Mul (Mul (Add (Mul b18~148@ c18~150@) (Mul b18~148@ b18~148@)) (Add (Mul c18~150@ b18~148@) (Mul b18~148@ d18~152@))) (Mul (Mul b18~148@ (Mul d18~152@ (Mul d18~152@ a18~146@))) (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ d18~152@))))) (and (=> (= tmp%40@ (Mul d18~152@ a18~146@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b18~148@ d18~152@ tmp%40@) (=> %%location_label%%18 (= temp_18_0~3684@ temp_18_1~3749@)))) (=> (= temp_18_0~3684@ temp_18_1~3749@) (=> (= temp_19_0~3860@ (Mul (Mul (Mul (Mul b19~156@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ c19~158@) (Add 69 b19~156@))) (Mul (Mul (Mul b19~156@ a19~154@) (Mul d19~160@ b19~156@)) (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ a19~154@))))) (=> (= temp_19_1~3937@ (Mul (Mul (Mul (Mul b19~156@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ c19~158@) (Add 69 b19~156@))) (Mul (Mul b19~156@ a19~154@) (Mul (Mul d19~160@ b19~156@) (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ a19~154@)))))) (=> (= tmp%41@ (Mul b19~156@ a19~154@)) (=> (= tmp%42@ (Mul d19~160@ b19~156@)) (=> (= tmp%43@ (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ a19~154@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ tmp%42@ tmp%43@) (=> %%location_label%%19 (= temp_19_0~3860@ temp_19_1~3937@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
