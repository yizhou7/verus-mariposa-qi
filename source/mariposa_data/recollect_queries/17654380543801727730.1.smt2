...
(declare-const temp_5_1~1460@ Int)
(declare-const temp_6_0~1528@ Int)
(declare-const temp_6_1~1589@ Int)
(declare-const temp_7_0~1676@ Int)
(declare-const temp_7_1~1729@ Int)
(declare-const temp_8_0~1828@ Int)
(declare-const temp_8_1~1893@ Int)
(declare-const temp_9_0~1982@ Int)
(declare-const temp_9_1~2043@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ b0~4@))))) (and (=> (= tmp%1@ (Mul d0~8@ c0~6@)) (=> (= tmp%2@ (Mul d0~8@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> (= tmp%3@ (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ d0~8@))) (=> (= tmp%4@ (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (=> (= tmp%5@ (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ b0~4@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@))) (=> (= tmp%7@ (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (=> (= tmp%8@ (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ b0~4@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))))))))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~591@ (Mul (Mul (Mul (Sub b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) b1~12@)))) (=> (= temp_1_1~652@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) b1~12@)) (Mul (Mul (Sub b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@))))) (and (=> (= tmp%9@ (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) b1~12@))) (=> (= tmp%10@ (Mul (Mul (Sub b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%1 (= temp_1_0~591@ temp_1_1~652@))))) (=> (= temp_1_0~591@ temp_1_1~652@) (=> (= temp_2_0~809@ (Mul (Mul (Add (Sub c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Sub a2~18@ d2~24@) (Sub a2~18@ c2~22@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ d2~24@)) (Mul (Mul 97 b2~20@) (Mul a2~18@ b2~20@))))) (=> (= temp_2_1~886@ (Mul (Mul (Mul (Add (Sub c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Sub a2~18@ d2~24@)) (Sub a2~18@ c2~22@)) (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ d2~24@)) (Mul (Mul 97 b2~20@) (Mul a2~18@ b2~20@))))) (and (=> (= tmp%11@ (Add (Sub c2~22@ c2~22@) (Mul a2~18@ a2~18@))) (=> (= tmp%12@ (Sub a2~18@ d2~24@)) (=> (= tmp%13@ (Sub a2~18@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%2 (= temp_2_0~809@ temp_2_1~886@)))))) (=> (= temp_2_0~809@ temp_2_1~886@) (=> (= temp_3_0~1001@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Add d3~32@ a3~26@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~1066@ (Mul (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Add d3~32@ a3~26@) (Mul b3~28@ d3~32@))) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@))) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)))) (and (=> (= tmp%14@ (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Add d3~32@ a3~26@) (Mul b3~28@ d3~32@)))) (=> (= tmp%15@ (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@))) (=> (= tmp%16@ (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%3 (= temp_3_0~1001@ temp_3_1~1066@)))))) (=> (= temp_3_0~1001@ temp_3_1~1066@) (=> (= temp_4_0~1213@ (Mul (Mul (Mul (Sub d4~40@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Sub c4~38@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~1278@ (Mul (Mul (Mul (Sub d4~40@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Sub c4~38@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ d4~40@) (=> %%location_label%%4 (= temp_4_0~1213@ temp_4_1~1278@))) (=> (= temp_4_0~1213@ temp_4_1~1278@) (=> (= temp_5_0~1383@ (Add (Mul (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (Mul (Sub (Mul d5~48@ c5~46@) (Mul 86 d5~48@)) (Add (Add c5~46@ d5~48@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~1460@ (Add (Mul (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (Mul (Sub (Mul d5~48@ c5~46@) (Mul 86 d5~48@)) (Add (Add c5~46@ d5~48@) (Mul a5~42@ b5~44@))))) (=> (= tmp%17@ (= temp_5_0~1383@ temp_5_1~1460@)) (and (=> %%location_label%%5 tmp%17@) (=> tmp%17@ (=> (= temp_6_0~1528@ (Add (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@)) (Mul (Add c6~54@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ a6~50@)) d6~56@))) (=> (= temp_6_1~1589@ (Add (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@)) (Add (Mul c6~54@ (Mul a6~50@ b6~52@)) (Mul d6~56@ (Mul a6~50@ b6~52@)))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ a6~50@)) d6~56@))) (and (=> (= tmp%18@ (Mul a6~50@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c6~54@ d6~56@ tmp%18@) (=> %%location_label%%6 (= temp_6_0~1528@ temp_6_1~1589@)))) (=> (= temp_6_0~1528@ temp_6_1~1589@) (=> (= temp_7_0~1676@ (Mul (Mul b7~60@ (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@))) (Add (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Add (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1729@ (Mul (Mul b7~60@ (Mul b7~60@ (Mul b7~60@ (Mul a7~58@ c7~62@)))) (Add (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Add (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))))) (and (=> (= tmp%19@ (Mul a7~58@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b7~60@ b7~60@ tmp%19@) (=> %%location_label%%7 (= temp_7_0~1676@ temp_7_1~1729@)))) (=> (= temp_7_0~1676@ temp_7_1~1729@) (=> (= temp_8_0~1828@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1893@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1828@ temp_8_1~1893@))) (=> (= temp_8_0~1828@ temp_8_1~1893@) (=> (= temp_9_0~1982@ (Mul (Sub (Mul (Sub d9~80@ a9~74@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))) (Add (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ c9~78@) d9~80@)))) (=> (= temp_9_1~2043@ (Mul (Sub (Mul (Mul d9~80@ c9~78@) (Sub d9~80@ a9~74@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))) (Add (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ c9~78@) d9~80@)))) (=> (= tmp%20@ (Mul d9~80@ c9~78@)) (=> (= tmp%21@ (Sub d9~80@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%9 (= temp_9_0~1982@ temp_9_1~2043@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
