...
(declare-const temp_1_1~448@ Int)
...
(declare-const temp_12_1~2470@ Int)
(declare-const temp_13_0~2597@ Int)
(declare-const temp_13_1~2650@ Int)
(declare-const temp_14_0~2730@ Int)
(declare-const temp_14_1~2795@ Int)
(declare-const temp_15_0~2956@ Int)
(declare-const temp_15_1~3081@ Int)
(declare-const temp_16_0~3202@ Int)
(declare-const temp_16_1~3271@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Add (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ a0~2@))) (Mul a0~2@ (Mul (Sub a0~2@ c0~6@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~346@ (Mul (Add (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ a0~2@))) (Mul a0~2@ (Mul (Sub a0~2@ c0~6@) (Mul a0~2@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ c0~6@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~411@ (Sub c1~14@ (Mul (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Add d1~16@ a1~10@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~448@ (Sub c1~14@ (Mul (Mul a1~10@ d1~16@) (Mul (Mul c1~14@ c1~14@) (Mul (Add d1~16@ a1~10@) (Mul a1~10@ a1~10@)))))) (and (=> (= tmp%1@ (Mul a1~10@ d1~16@)) (=> (= tmp%2@ (Mul c1~14@ c1~14@)) (=> (= tmp%3@ (Mul (Add d1~16@ a1~10@) (Mul a1~10@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~411@ temp_1_1~448@)))))) (=> (= temp_1_0~411@ temp_1_1~448@) (=> (= temp_2_0~595@ (Add (Mul (Add (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ 63) (Sub a2~18@ c2~22@))) (Mul (Mul (Mul 86 d2~24@) (Mul 20 b2~20@)) (Sub (Sub b2~20@ b2~20@) a2~18@)))) (=> (= temp_2_1~692@ (Add (Mul (Add (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ 63) (Sub a2~18@ c2~22@))) (Mul (Mul (Mul 86 d2~24@) (Mul b2~20@ 20)) (Sub (Sub b2~20@ b2~20@) a2~18@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ 20) (=> %%location_label%%2 (= temp_2_0~595@ temp_2_1~692@))) (=> (= temp_2_0~595@ temp_2_1~692@) (=> (= temp_3_0~801@ (Mul (Sub (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@)) (Add (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (Sub (Mul (Mul c3~30@ c3~30@) (Mul 43 b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~878@ (Mul (Sub (Mul (Mul (Mul d3~32@ c3~30@) d3~32@) a3~26@) (Add (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (Sub (Mul (Mul c3~30@ c3~30@) (Mul 43 b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ a3~26@))))) (and (=> (= tmp%4@ (Mul d3~32@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ d3~32@ a3~26@) (=> %%location_label%%3 (= temp_3_0~801@ temp_3_1~878@)))) (=> (= temp_3_0~801@ temp_3_1~878@) (=> (= temp_4_0~977@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Add b4~36@ a4~34@))) (Mul (Sub (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~1042@ (Mul (Mul (Sub (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Add b4~36@ a4~34@))))) (and (=> (= tmp%5@ (Mul (Sub (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)))) (=> (= tmp%6@ (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Add b4~36@ a4~34@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~977@ temp_4_1~1042@))))) (=> (= temp_4_0~977@ temp_4_1~1042@) (=> (= temp_5_0~1203@ (Mul (Mul (Mul (Mul a5~42@ 13) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1280@ (Mul (Mul (Mul (Mul a5~42@ 13) (Mul d5~48@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b5~44@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1203@ temp_5_1~1280@))) (=> (= temp_5_0~1203@ temp_5_1~1280@) (=> (= temp_6_0~1373@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@)) (Add (Mul d6~56@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ a6~50@)) (Mul (Mul b6~52@ c6~54@) (Sub b6~52@ d6~56@))))) (=> (= temp_6_1~1438@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@)) (Add (Mul d6~56@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul b6~52@ c6~54@) (Sub b6~52@ d6~56@))))) (and (=> (= tmp%7@ (Mul d6~56@ a6~50@)) (=> (= tmp%8@ (Mul b6~52@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~1373@ temp_6_1~1438@))))) (=> (= temp_6_0~1373@ temp_6_1~1438@) (=> (= temp_7_0~1551@ (Mul (Add (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))) (Mul (Sub (Sub a7~58@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Add 58 c7~62@))))) (=> (= temp_7_1~1656@ (Mul (Add (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))) (Sub (Mul (Sub a7~58@ d7~64@) (Mul (Mul b7~60@ c7~62@) (Add 58 c7~62@))) (Mul (Mul c7~62@ b7~60@) (Mul (Mul b7~60@ c7~62@) (Add 58 c7~62@)))))) (and (=> (= tmp%9@ (Sub a7~58@ d7~64@)) (=> (= tmp%10@ (Mul c7~62@ b7~60@)) (=> (= tmp%11@ (Mul (Mul b7~60@ c7~62@) (Add 58 c7~62@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%7 (= temp_7_0~1551@ temp_7_1~1656@)))))) (=> (= temp_7_0~1551@ temp_7_1~1656@) (=> (= temp_8_0~1763@ (Mul (Mul (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ c8~70@))) (Mul d8~72@ (Add (Sub d8~72@ a8~66@) (Mul c8~70@ b8~68@))))) (=> (= temp_8_1~1816@ (Mul (Mul (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ c8~70@))) (Mul (Add (Sub d8~72@ a8~66@) (Mul c8~70@ b8~68@)) d8~72@))) (and (=> (= tmp%12@ (Add (Sub d8~72@ a8~66@) (Mul c8~70@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1763@ temp_8_1~1816@)))) (=> (= temp_8_0~1763@ temp_8_1~1816@) (=> (= temp_9_0~1893@ (Mul c9~78@ (Mul (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ d9~80@)) (Sub (Sub c9~78@ a9~74@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1930@ (Mul c9~78@ (Mul (Sub (Sub c9~78@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ d9~80@))))) (and (=> (= tmp%13@ (Sub (Sub c9~78@ a9~74@) (Mul c9~78@ d9~80@))) (=> (= tmp%14@ (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ d9~80@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%9 (= temp_9_0~1893@ temp_9_1~1930@))))) (=> (= temp_9_0~1893@ temp_9_1~1930@) (=> (= temp_10_0~2035@ (Mul (Mul (Mul (Mul d10~88@ a10~82@) (Mul c10~86@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Sub c10~86@ b10~84@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) c10~86@))) (=> (= temp_10_1~2088@ (Mul (Mul (Mul (Mul (Mul d10~88@ a10~82@) c10~86@) a10~82@) (Mul (Mul a10~82@ c10~86@) (Sub c10~86@ b10~84@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) c10~86@))) (and (=> (= tmp%15@ (Mul (Mul (Mul d10~88@ a10~82@) c10~86@) a10~82@)) (=> (= tmp%16@ (Mul (Mul a10~82@ c10~86@) (Sub c10~86@ b10~84@))) (=> (= tmp%17@ (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> (= tmp%18@ (Mul d10~88@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ c10~86@ a10~82@) (=> (= tmp%19@ (Mul (Mul d10~88@ a10~82@) (Mul c10~86@ a10~82@))) (=> (= tmp%20@ (Mul (Mul a10~82@ c10~86@) (Sub c10~86@ b10~84@))) (=> (= tmp%21@ (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%10 (= temp_10_0~2035@ temp_10_1~2088@)))))))))))) (=> (= temp_10_0~2035@ temp_10_1~2088@) (=> (= temp_11_0~2271@ (Mul (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul d11~96@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul a11~90@ a11~90@) c11~94@) a11~90@))) (=> (= temp_11_1~2320@ (Mul (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ a11~90@))) (Mul (Mul (Mul a11~90@ a11~90@) c11~94@) a11~90@))) (and (=> (= tmp%22@ (Mul a11~90@ d11~96@)) (=> (= tmp%23@ (Mul d11~96@ a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%11 (= temp_11_0~2271@ temp_11_1~2320@))))) (=> (= temp_11_0~2271@ temp_11_1~2320@) (=> (= temp_12_0~2413@ (Mul (Mul (Mul b12~100@ (Mul c12~102@ d12~104@)) (Sub (Mul a12~98@ a12~98@) b12~100@)) (Mul (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@)) (Sub (Mul d12~104@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2470@ (Mul (Mul (Mul (Mul b12~100@ (Mul c12~102@ d12~104@)) (Sub (Mul a12~98@ a12~98@) b12~100@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@))) (Sub (Mul d12~104@ a12~98@) (Mul c12~102@ d12~104@)))) (and (=> (= tmp%24@ (Mul (Mul b12~100@ (Mul c12~102@ d12~104@)) (Sub (Mul a12~98@ a12~98@) b12~100@))) (=> (= tmp%25@ (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@))) (=> (= tmp%26@ (Sub (Mul d12~104@ a12~98@) (Mul c12~102@ d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%12 (= temp_12_0~2413@ temp_12_1~2470@)))))) (=> (= temp_12_0~2413@ temp_12_1~2470@) (=> (= temp_13_0~2597@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Add a13~106@ c13~110@) (Mul a13~106@ a13~106@))) (Mul b13~108@ (Add (Mul c13~110@ b13~108@) (Mul c13~110@ c13~110@))))) (=> (= temp_13_1~2650@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Add a13~106@ c13~110@) (Mul a13~106@ a13~106@))) (Mul b13~108@ (Add (Mul c13~110@ b13~108@) (Mul c13~110@ c13~110@))))) (=> (= tmp%27@ (= temp_13_0~2597@ temp_13_1~2650@)) (and (=> %%location_label%%13 tmp%27@) (=> tmp%27@ (=> (= temp_14_0~2730@ (Mul (Add (Mul (Mul d14~120@ b14~116@) (Mul c14~118@ d14~120@)) (Mul (Mul a14~114@ d14~120@) (Mul a14~114@ b14~116@))) (Mul (Mul (Mul d14~120@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ a14~114@) (Mul d14~120@ c14~118@))))) (=> (= temp_14_1~2795@ (Mul (Add (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul a14~114@ b14~116@))) (Mul (Mul (Mul d14~120@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ a14~114@) (Mul d14~120@ c14~118@))))) (and (=> (= tmp%28@ (Mul c14~118@ d14~120@)) (=> (= tmp%29@ (Mul d14~120@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%28@ tmp%29@) (=> %%location_label%%14 (= temp_14_0~2730@ temp_14_1~2795@))))) (=> (= temp_14_0~2730@ temp_14_1~2795@) (=> (= temp_15_0~2956@ (Mul (Mul (Mul (Mul c15~126@ 3) (Mul a15~122@ c15~126@)) (Add (Mul a15~122@ b15~124@) (Mul b15~124@ 89))) (Mul (Mul (Add 13 d15~128@) (Mul b15~124@ 73)) (Mul (Mul d15~128@ 47) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~3081@ (Mul (Mul (Add (Mul a15~122@ b15~124@) (Mul b15~124@ 89)) (Mul (Mul c15~126@ 3) (Mul a15~122@ c15~126@))) (Mul (Mul (Add 13 d15~128@) (Mul b15~124@ 73)) (Mul (Mul d15~128@ 47) (Mul d15~128@ a15~122@))))) (and (=> (= tmp%30@ (Add (Mul a15~122@ b15~124@) (Mul b15~124@ 89))) (=> (= tmp%31@ (Mul (Mul c15~126@ 3) (Mul a15~122@ c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%30@ tmp%31@) (=> %%location_label%%15 (= temp_15_0~2956@ temp_15_1~3081@))))) (=> (= temp_15_0~2956@ temp_15_1~3081@) (=> (= temp_16_0~3202@ (Mul (Mul (Add d16~136@ (Mul b16~132@ c16~134@)) (Mul (Add d16~136@ c16~134@) (Mul d16~136@ b16~132@))) (Add (Add (Mul b16~132@ b16~132@) (Add b16~132@ d16~136@)) (Mul (Sub a16~130@ b16~132@) (Mul c16~134@ c16~134@))))) (=> (= temp_16_1~3271@ (Mul (Mul (Add d16~136@ (Mul b16~132@ c16~134@)) (Mul (Add d16~136@ c16~134@) (Mul d16~136@ b16~132@))) (Add (Add (Mul b16~132@ b16~132@) (Add b16~132@ d16~136@)) (Sub (Mul a16~130@ (Mul c16~134@ c16~134@)) (Mul b16~132@ (Mul c16~134@ c16~134@)))))) (=> (= tmp%32@ (Mul c16~134@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a16~130@ b16~132@ tmp%32@) (=> %%location_label%%16 (= temp_16_0~3202@ temp_16_1~3271@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
