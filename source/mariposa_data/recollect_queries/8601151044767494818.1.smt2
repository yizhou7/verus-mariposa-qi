...
(declare-const temp_4_0~1023@ Int)
(declare-const temp_4_1~1084@ Int)
(declare-const temp_5_0~1185@ Int)
(declare-const temp_5_1~1242@ Int)
(declare-const temp_6_0~1341@ Int)
(declare-const temp_6_1~1402@ Int)
(declare-const temp_7_0~1603@ Int)
(declare-const temp_7_1~1660@ Int)
(declare-const temp_8_0~1753@ Int)
(declare-const temp_8_1~1814@ Int)
(declare-const temp_9_0~1933@ Int)
(declare-const temp_9_1~2070@ Int)
(declare-const temp_10_0~2229@ Int)
(declare-const temp_10_1~2302@ Int)
(declare-const temp_11_0~2403@ Int)
(declare-const temp_11_1~2468@ Int)
(declare-const temp_12_0~2697@ Int)
(declare-const temp_12_1~2774@ Int)
(declare-const temp_13_0~2923@ Int)
(declare-const temp_13_1~2976@ Int)
(declare-const temp_14_0~3056@ Int)
(declare-const temp_14_1~3121@ Int)
(declare-const temp_15_0~3225@ Int)
(declare-const temp_15_1~3314@ Int)
(declare-const temp_16_0~3435@ Int)
(declare-const temp_16_1~3500@ Int)
(declare-const temp_17_0~3609@ Int)
(declare-const temp_17_1~3682@ Int)
(declare-const temp_18_0~3759@ Int)
(declare-const temp_18_1~3820@ Int)
(declare-const temp_19_0~3919@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Sub c0~6@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Sub c0~6@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (and (=> (= tmp%1@ (Mul b0~4@ d0~8@)) (=> (= tmp%2@ (Mul d0~8@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~471@ (Mul (Sub (Mul (Mul a1~10@ 28) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Sub d1~16@ a1~10@))) (Mul (Add (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@)) (Mul b1~12@ (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~544@ (Mul (Mul (Add (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@)) (Mul b1~12@ (Mul c1~14@ b1~12@))) (Sub (Mul (Mul a1~10@ 28) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Sub d1~16@ a1~10@))))) (and (=> (= tmp%3@ (Mul (Add (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@)) (Mul b1~12@ (Mul c1~14@ b1~12@)))) (=> (= tmp%4@ (Sub (Mul (Mul a1~10@ 28) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Sub d1~16@ a1~10@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~471@ temp_1_1~544@))))) (=> (= temp_1_0~471@ temp_1_1~544@) (=> (= temp_2_0~693@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ b2~20@)) (Add (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@))) (Sub (Mul (Mul a2~18@ c2~22@) (Sub a2~18@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~758@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ b2~20@)) (Add (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@))) (Sub (Mul (Sub a2~18@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@))))) (and (=> (= tmp%5@ (Sub a2~18@ a2~18@)) (=> (= tmp%6@ (Mul a2~18@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%2 (= temp_2_0~693@ temp_2_1~758@))))) (=> (= temp_2_0~693@ temp_2_1~758@) (=> (= temp_3_0~855@ (Add (Mul (Mul d3~32@ (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul (Sub d3~32@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@))))) (=> (= temp_3_1~916@ (Add (Mul d3~32@ (Mul (Mul b3~28@ c3~30@) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@)))) (Mul (Mul (Sub d3~32@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@))))) (and (=> (= tmp%7@ (Mul b3~28@ c3~30@)) (=> (= tmp%8@ (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. d3~32@ tmp%7@ tmp%8@) (=> %%location_label%%3 (= temp_3_0~855@ temp_3_1~916@))))) (=> (= temp_3_0~855@ temp_3_1~916@) (=> (= temp_4_0~1023@ (Mul (Add (Mul (Add d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Add (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ b4~36@) c4~38@)))) (=> (= temp_4_1~1084@ (Mul (Add (Mul (Add d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul b4~36@ b4~36@) c4~38@) (Add (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@))))) (and (=> (= tmp%9@ (Mul (Mul b4~36@ b4~36@) c4~38@)) (=> (= tmp%10@ (Add (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%4 (= temp_4_0~1023@ temp_4_1~1084@))))) (=> (= temp_4_0~1023@ temp_4_1~1084@) (=> (= temp_5_0~1185@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ a5~42@))) (Mul c5~46@ (Add (Mul c5~46@ a5~42@) (Sub b5~44@ c5~46@))))) (=> (= temp_5_1~1242@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ a5~42@))) (Add (Mul c5~46@ (Mul c5~46@ a5~42@)) (Mul c5~46@ (Sub b5~44@ c5~46@))))) (and (=> (= tmp%11@ (Mul c5~46@ a5~42@)) (=> (= tmp%12@ (Sub b5~44@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c5~46@ tmp%11@ tmp%12@) (=> %%location_label%%5 (= temp_5_0~1185@ temp_5_1~1242@))))) (=> (= temp_5_0~1185@ temp_5_1~1242@) (=> (= temp_6_0~1341@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Sub a6~50@ a6~50@)) (Sub c6~54@ (Mul d6~56@ a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1402@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Sub a6~50@ a6~50@)) (Sub c6~54@ (Mul d6~56@ a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ d6~56@) (=> (= tmp%13@ (Mul (Mul (Mul b6~52@ d6~56@) (Sub a6~50@ a6~50@)) (Sub c6~54@ (Mul d6~56@ a6~50@)))) (=> (= tmp%14@ (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ c6~54@))) (=> (= tmp%15@ (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> (= tmp%16@ (Mul (Mul (Mul b6~52@ d6~56@) (Sub a6~50@ a6~50@)) (Sub c6~54@ (Mul d6~56@ a6~50@)))) (=> (= tmp%17@ (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ c6~54@))) (=> (= tmp%18@ (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ d6~56@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%6 (= temp_6_0~1341@ temp_6_1~1402@))))))))))) (=> (= temp_6_0~1341@ temp_6_1~1402@) (=> (= temp_7_0~1603@ (Mul (Mul (Add (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)) (Mul a7~58@ (Mul d7~64@ c7~62@))) (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ c7~62@) d7~64@)))) (=> (= temp_7_1~1660@ (Mul (Mul (Add (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)) (Mul (Mul d7~64@ c7~62@) a7~58@)) (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ c7~62@) d7~64@)))) (and (=> (= tmp%19@ (Mul d7~64@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1603@ temp_7_1~1660@)))) (=> (= temp_7_0~1603@ temp_7_1~1660@) (=> (= temp_8_0~1753@ (Mul (Sub (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Sub b8~68@ a8~66@))) (Add (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ d8~72@) c8~70@)))) (=> (= temp_8_1~1814@ (Mul (Sub (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Sub b8~68@ a8~66@))) (Add (Mul c8~70@ (Mul c8~70@ (Mul b8~68@ c8~70@))) (Mul (Mul c8~70@ d8~72@) c8~70@)))) (and (=> (= tmp%20@ (Mul b8~68@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c8~70@ c8~70@ tmp%20@) (=> %%location_label%%8 (= temp_8_0~1753@ temp_8_1~1814@)))) (=> (= temp_8_0~1753@ temp_8_1~1814@) (=> (= temp_9_0~1933@ (Mul (Add (Sub (Sub b9~76@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul b9~76@ 37) (Mul 58 d9~80@)) (Mul b9~76@ (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~2070@ (Add (Mul (Sub (Sub b9~76@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Mul (Mul b9~76@ 37) (Mul 58 d9~80@)) (Mul b9~76@ (Mul b9~76@ d9~80@)))) (Mul (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@)) (Mul (Mul (Mul b9~76@ 37) (Mul 58 d9~80@)) (Mul b9~76@ (Mul b9~76@ d9~80@)))))) (and (=> (= tmp%21@ (Sub (Sub b9~76@ a9~74@) (Mul a9~74@ a9~74@))) (=> (= tmp%22@ (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@))) (=> (= tmp%23@ (Mul (Mul (Mul b9~76@ 37) (Mul 58 d9~80@)) (Mul b9~76@ (Mul b9~76@ d9~80@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%9 (= temp_9_0~1933@ temp_9_1~2070@)))))) (=> (= temp_9_0~1933@ temp_9_1~2070@) (=> (= temp_10_0~2229@ (Mul (Sub (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ d10~88@))) (Mul (Mul (Mul c10~86@ a10~82@) 95) (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~2302@ (Mul (Sub (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@)) (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ d10~88@))) (Mul (Mul (Mul c10~86@ a10~82@) 95) (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ a10~82@))))) (and (=> (= tmp%24@ (Mul c10~86@ b10~84@)) (=> (= tmp%25@ (Mul a10~82@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%24@ tmp%25@) (=> %%location_label%%10 (= temp_10_0~2229@ temp_10_1~2302@))))) (=> (= temp_10_0~2229@ temp_10_1~2302@) (=> (= temp_11_0~2403@ (Mul (Mul (Mul (Add c11~94@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@)) (Mul (Mul c11~94@ a11~90@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2468@ (Mul (Mul (Mul (Add c11~94@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a11~90@ c11~94@) (=> (= tmp%26@ (Mul (Mul (Add c11~94@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ d11~96@) (Mul c11~94@ b11~92@)))) (=> (= tmp%27@ (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@))) (=> (= tmp%28@ (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> (= tmp%29@ (Mul (Mul (Add c11~94@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ d11~96@) (Mul c11~94@ b11~92@)))) (=> (= tmp%30@ (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@))) (=> (= tmp%31@ (Mul (Mul c11~94@ a11~90@) (Mul d11~96@ b11~92@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> %%location_label%%11 (= temp_11_0~2403@ temp_11_1~2468@))))))))))) (=> (= temp_11_0~2403@ temp_11_1~2468@) (=> (= temp_12_0~2697@ (Mul (Mul (Add (Mul a12~98@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul b12~100@ c12~102@) (Add b12~100@ b12~100@)) (Mul (Mul 75 a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2774@ (Mul (Mul (Add (Mul a12~98@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul c12~102@ b12~100@) (Add b12~100@ b12~100@)) (Mul (Mul 75 a12~98@) (Mul c12~102@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c12~102@ b12~100@) (=> (= tmp%32@ (Mul c12~102@ b12~100@)) (=> (= tmp%33@ (Add b12~100@ b12~100@)) (=> (= tmp%34@ (Mul (Mul 75 a12~98@) (Mul c12~102@ d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> (= tmp%35@ (Mul b12~100@ c12~102@)) (=> (= tmp%36@ (Add b12~100@ b12~100@)) (=> (= tmp%37@ (Mul (Mul 75 a12~98@) (Mul c12~102@ d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ tmp%36@ tmp%37@) (=> %%location_label%%12 (= temp_12_0~2697@ temp_12_1~2774@))))))))))) (=> (= temp_12_0~2697@ temp_12_1~2774@) (=> (= temp_13_0~2923@ (Mul (Sub (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ c13~110@)) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@))) (Add (Mul (Mul b13~108@ b13~108@) (Add d13~112@ c13~110@)) d13~112@))) (=> (= temp_13_1~2976@ (Mul (Sub (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ c13~110@)) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@))) (Add (Mul (Mul b13~108@ b13~108@) (Add d13~112@ c13~110@)) d13~112@))) (=> (= tmp%38@ (= temp_13_0~2923@ temp_13_1~2976@)) (and (=> %%location_label%%13 tmp%38@) (=> tmp%38@ (=> (= temp_14_0~3056@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ b14~116@)) (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ b14~116@))) (Add (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ d14~120@)) (Sub (Mul a14~114@ a14~114@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~3121@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ b14~116@)) (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ b14~116@))) (Add (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ d14~120@)) (Sub (Mul a14~114@ a14~114@) (Mul c14~118@ b14~116@))))) (=> (= tmp%39@ (= temp_14_0~3056@ temp_14_1~3121@)) (and (=> %%location_label%%14 tmp%39@) (=> tmp%39@ (=> (= temp_15_0~3225@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@)) (Mul (Sub c15~126@ d15~128@) (Mul c15~126@ 27))) (Mul (Sub (Mul a15~122@ d15~128@) (Mul d15~128@ a15~122@)) (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ 54))))) (=> (= temp_15_1~3314@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@)) (Mul (Sub c15~126@ d15~128@) (Mul c15~126@ 27))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ 54)) (Sub (Mul a15~122@ d15~128@) (Mul d15~128@ a15~122@))))) (and (=> (= tmp%40@ (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ 54))) (=> (= tmp%41@ (Sub (Mul a15~122@ d15~128@) (Mul d15~128@ a15~122@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%40@ tmp%41@) (=> %%location_label%%15 (= temp_15_0~3225@ temp_15_1~3314@))))) (=> (= temp_15_0~3225@ temp_15_1~3314@) (=> (= temp_16_0~3435@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@)) (Add (Mul d16~136@ d16~136@) (Mul b16~132@ d16~136@))) (Mul (Mul (Mul c16~134@ c16~134@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ a16~130@) (Sub c16~134@ b16~132@))))) (=> (= temp_16_1~3500@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@)) (Add (Mul d16~136@ d16~136@) (Mul b16~132@ d16~136@))) (Mul (Mul (Mul a16~130@ a16~130@) (Mul c16~134@ c16~134@)) (Mul (Mul b16~132@ a16~130@) (Sub c16~134@ b16~132@))))) (and (=> (= tmp%42@ (Mul a16~130@ a16~130@)) (=> (= tmp%43@ (Mul c16~134@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%42@ tmp%43@) (=> %%location_label%%16 (= temp_16_0~3435@ temp_16_1~3500@))))) (=> (= temp_16_0~3435@ temp_16_1~3500@) (=> (= temp_17_0~3609@ (Mul (Mul (Mul (Sub c17~142@ b17~140@) (Mul b17~140@ a17~138@)) (Mul (Sub c17~142@ b17~140@) (Add c17~142@ d17~144@))) (Mul (Mul d17~144@ (Mul b17~140@ a17~138@)) (Add (Add c17~142@ 93) (Add b17~140@ d17~144@))))) (=> (= temp_17_1~3682@ (Mul (Mul (Mul (Sub c17~142@ b17~140@) (Mul b17~140@ a17~138@)) (Mul (Sub c17~142@ b17~140@) (Add c17~142@ d17~144@))) (Mul (Mul d17~144@ (Mul a17~138@ b17~140@)) (Add (Add c17~142@ 93) (Add b17~140@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b17~140@ a17~138@) (=> %%location_label%%17 (= temp_17_0~3609@ temp_17_1~3682@))) (=> (= temp_17_0~3609@ temp_17_1~3682@) (=> (= temp_18_0~3759@ (Add (Mul (Mul a18~146@ (Sub c18~150@ a18~146@)) (Add (Add b18~148@ a18~146@) (Mul b18~148@ c18~150@))) (Mul (Mul (Add b18~148@ b18~148@) (Mul a18~146@ c18~150@)) a18~146@))) (=> (= temp_18_1~3820@ (Add (Add (Mul (Mul a18~146@ (Sub c18~150@ a18~146@)) (Add b18~148@ a18~146@)) (Mul (Mul a18~146@ (Sub c18~150@ a18~146@)) (Mul b18~148@ c18~150@))) (Mul (Mul (Add b18~148@ b18~148@) (Mul a18~146@ c18~150@)) a18~146@))) (and (=> (= tmp%44@ (Mul a18~146@ (Sub c18~150@ a18~146@))) (=> (= tmp%45@ (Add b18~148@ a18~146@)) (=> (= tmp%46@ (Mul b18~148@ c18~150@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%44@ tmp%45@ tmp%46@) (=> %%location_label%%18 (= temp_18_0~3759@ temp_18_1~3820@)))))) (=> (= temp_18_0~3759@ temp_18_1~3820@) (=> (= temp_19_0~3919@ (Mul (Mul (Mul (Sub c19~158@ d19~160@) (Mul a19~154@ a19~154@)) (Mul (Sub c19~158@ b19~156@) (Add d19~160@ d19~160@))) (Mul d19~160@ (Mul (Sub a19~154@ c19~158@) (Mul a19~154@ c19~158@))))) (=> (= temp_19_1~3972@ (Mul (Mul d19~160@ (Mul (Sub a19~154@ c19~158@) (Mul a19~154@ c19~158@))) (Mul (Mul (Sub c19~158@ d19~160@) (Mul a19~154@ a19~154@)) (Mul (Sub c19~158@ b19~156@) (Add d19~160@ d19~160@))))) (=> (= tmp%47@ (Mul d19~160@ (Mul (Sub a19~154@ c19~158@) (Mul a19~154@ c19~158@)))) (=> (= tmp%48@ (Mul (Mul (Sub c19~158@ d19~160@) (Mul a19~154@ a19~154@)) (Mul (Sub c19~158@ b19~156@) (Add d19~160@ d19~160@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%47@ tmp%48@) (=> %%location_label%%19 (= temp_19_0~3919@ temp_19_1~3972@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
