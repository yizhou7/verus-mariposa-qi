...
(declare-const temp_4_0~899@ Int)
(declare-const temp_4_1~968@ Int)
(declare-const temp_5_0~1077@ Int)
(declare-const temp_5_1~1150@ Int)
(declare-const temp_6_0~1210@ Int)
(declare-const temp_6_1~1255@ Int)
(declare-const temp_7_0~1340@ Int)
(declare-const temp_7_1~1393@ Int)
(declare-const temp_8_0~1492@ Int)
(declare-const temp_8_1~1553@ Int)
(declare-const temp_9_0~1660@ Int)
(declare-const temp_9_1~1737@ Int)
(declare-const temp_10_0~1858@ Int)
(declare-const temp_10_1~1923@ Int)
(declare-const temp_11_0~2154@ Int)
(declare-const temp_11_1~2227@ Int)
(declare-const temp_12_0~2324@ Int)
(declare-const temp_12_1~2385@ Int)
(declare-const temp_13_0~2512@ Int)
(declare-const temp_13_1~2561@ Int)
(declare-const temp_14_0~2650@ Int)
(declare-const temp_14_1~2719@ Int)
(declare-const temp_15_0~2938@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ 93) (Mul c0~6@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ d0~8@))) (Add (Add (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@)) d0~8@))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul d0~8@ 93) (Mul c0~6@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ d0~8@))) (Add (Add (Mul b0~4@ a0~2@) (Mul c0~6@ d0~8@)) d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ d0~8@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~463@ (Add (Sub (Mul (Mul d1~16@ b1~12@) (Add c1~14@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Add b1~12@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~536@ (Add (Sub (Mul (Mul d1~16@ b1~12@) (Add c1~14@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Add (Mul (Mul b1~12@ c1~14@) b1~12@) (Mul (Mul b1~12@ c1~14@) a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@))))) (and (=> (= tmp%1@ (Mul b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ b1~12@ a1~10@) (=> %%location_label%%1 (= temp_1_0~463@ temp_1_1~536@)))) (=> (= temp_1_0~463@ temp_1_1~536@) (=> (= temp_2_0~623@ (Mul (Mul (Mul (Add b2~20@ a2~18@) (Mul a2~18@ d2~24@)) a2~18@) (Mul (Add (Mul d2~24@ d2~24@) (Sub c2~22@ c2~22@)) (Sub (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))))) (=> (= temp_2_1~676@ (Mul (Mul (Mul (Add b2~20@ a2~18@) (Mul a2~18@ d2~24@)) a2~18@) (Mul (Sub (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Add (Mul d2~24@ d2~24@) (Sub c2~22@ c2~22@))))) (and (=> (= tmp%2@ (Sub (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))) (=> (= tmp%3@ (Add (Mul d2~24@ d2~24@) (Sub c2~22@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~623@ temp_2_1~676@))))) (=> (= temp_2_0~623@ temp_2_1~676@) (=> (= temp_3_0~765@ (Sub c3~30@ (Mul (Sub (Mul a3~26@ d3~32@) (Sub b3~28@ a3~26@)) (Add (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~802@ (Sub c3~30@ (Mul (Sub (Mul a3~26@ d3~32@) (Sub b3~28@ a3~26@)) (Add (Mul c3~30@ d3~32@) (Mul c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ d3~32@) (=> %%location_label%%3 (= temp_3_0~765@ temp_3_1~802@))) (=> (= temp_3_0~765@ temp_3_1~802@) (=> (= temp_4_0~899@ (Mul (Add (Mul d4~40@ (Mul a4~34@ b4~36@)) (Mul a4~34@ (Mul d4~40@ a4~34@))) (Mul (Mul (Mul c4~38@ a4~34@) (Sub d4~40@ d4~40@)) (Mul (Add 55 c4~38@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~968@ (Mul (Add (Mul d4~40@ (Mul a4~34@ b4~36@)) (Mul a4~34@ (Mul d4~40@ a4~34@))) (Mul (Mul (Sub d4~40@ d4~40@) (Mul c4~38@ a4~34@)) (Mul (Add 55 c4~38@) (Mul b4~36@ b4~36@))))) (and (=> (= tmp%4@ (Sub d4~40@ d4~40@)) (=> (= tmp%5@ (Mul c4~38@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%4 (= temp_4_0~899@ temp_4_1~968@))))) (=> (= temp_4_0~899@ temp_4_1~968@) (=> (= temp_5_0~1077@ (Mul (Add (Mul (Mul a5~42@ d5~48@) b5~44@) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ 44)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1150@ (Mul (Add (Mul (Mul a5~42@ d5~48@) b5~44@) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ 44)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1077@ temp_5_1~1150@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1210@ (Sub (Mul (Mul a6~50@ (Mul c6~54@ d6~56@)) (Mul d6~56@ (Mul b6~52@ b6~52@))) (Mul c6~54@ 73))) (=> (= temp_6_1~1255@ (Sub (Mul (Mul a6~50@ (Mul c6~54@ d6~56@)) (Mul (Mul b6~52@ b6~52@) d6~56@)) (Mul c6~54@ 73))) (and (=> (= tmp%7@ (Mul b6~52@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1210@ temp_6_1~1255@)))) (=> (= temp_6_0~1210@ temp_6_1~1255@) (=> (= temp_7_0~1340@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Add b7~60@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) d7~64@))) (=> (= temp_7_1~1393@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Add b7~60@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))) (Mul (Mul (Mul (Mul b7~60@ d7~64@) a7~58@) b7~60@) d7~64@))) (and (=> (= tmp%8@ (Mul b7~60@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ a7~58@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1340@ temp_7_1~1393@)))) (=> (= temp_7_0~1340@ temp_7_1~1393@) (=> (= temp_8_0~1492@ (Mul (Add (Sub (Mul c8~70@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul d8~72@ d8~72@) (Sub b8~68@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Sub b8~68@ a8~66@))))) (=> (= temp_8_1~1553@ (Mul (Add (Mul c8~70@ (Sub d8~72@ c8~70@)) (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul d8~72@ d8~72@) (Sub b8~68@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Sub b8~68@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. c8~70@ d8~72@ c8~70@) (=> %%location_label%%8 (= temp_8_0~1492@ temp_8_1~1553@))) (=> (= temp_8_0~1492@ temp_8_1~1553@) (=> (= temp_9_0~1660@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Sub c9~78@ d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ b9~76@))) (Mul (Mul (Mul c9~78@ a9~74@) (Mul 96 b9~76@)) (Mul (Mul c9~78@ a9~74@) (Add a9~74@ a9~74@))))) (=> (= temp_9_1~1737@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Sub c9~78@ d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ b9~76@))) (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ a9~74@)) (Mul (Mul c9~78@ a9~74@) (Mul 96 b9~76@))))) (and (=> (= tmp%9@ (Mul (Mul c9~78@ a9~74@) (Add a9~74@ a9~74@))) (=> (= tmp%10@ (Mul (Mul c9~78@ a9~74@) (Mul 96 b9~76@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%9 (= temp_9_0~1660@ temp_9_1~1737@))))) (=> (= temp_9_0~1660@ temp_9_1~1737@) (=> (= temp_10_0~1858@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Sub b10~84@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1923@ (Mul (Mul (Mul b10~84@ (Mul b10~84@ (Sub b10~84@ a10~82@))) (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul d10~88@ c10~86@))))) (and (=> (= tmp%11@ (Sub b10~84@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b10~84@ b10~84@ tmp%11@) (=> (= tmp%12@ (Mul b10~84@ (Mul b10~84@ (Sub b10~84@ a10~82@)))) (=> (= tmp%13@ (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@))) (=> (= tmp%14@ (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul d10~88@ c10~86@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> (= tmp%15@ (Mul (Mul b10~84@ b10~84@) (Sub b10~84@ a10~82@))) (=> (= tmp%16@ (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@))) (=> (= tmp%17@ (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul d10~88@ c10~86@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%10 (= temp_10_0~1858@ temp_10_1~1923@)))))))))))) (=> (= temp_10_0~1858@ temp_10_1~1923@) (=> (= temp_11_0~2154@ (Mul (Sub (Mul (Mul d11~96@ 51) (Add a11~90@ b11~92@)) (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Add c11~94@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ c11~94@) b11~92@)))) (=> (= temp_11_1~2227@ (Mul (Sub (Mul (Mul d11~96@ 51) (Add a11~90@ b11~92@)) (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul d11~96@ a11~90@) (Add c11~94@ d11~96@)) (Mul (Mul c11~94@ c11~94@) b11~92@)))) (and (=> (= tmp%18@ (Mul d11~96@ a11~90@)) (=> (= tmp%19@ (Add c11~94@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%11 (= temp_11_0~2154@ temp_11_1~2227@))))) (=> (= temp_11_0~2154@ temp_11_1~2227@) (=> (= temp_12_0~2324@ (Mul (Mul (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ c12~102@)) (Add (Mul b12~100@ a12~98@) c12~102@)) (Mul (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Add b12~100@ d12~104@))))) (=> (= temp_12_1~2385@ (Mul (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ c12~102@)) (Mul (Add (Mul b12~100@ a12~98@) c12~102@) (Mul (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Add b12~100@ d12~104@)))))) (and (=> (= tmp%20@ (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ c12~102@))) (=> (= tmp%21@ (Add (Mul b12~100@ a12~98@) c12~102@)) (=> (= tmp%22@ (Mul (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Add b12~100@ d12~104@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%12 (= temp_12_0~2324@ temp_12_1~2385@)))))) (=> (= temp_12_0~2324@ temp_12_1~2385@) (=> (= temp_13_0~2512@ (Mul (Add (Mul (Mul d13~112@ c13~110@) (Mul b13~108@ d13~112@)) (Mul (Mul a13~106@ c13~110@) d13~112@)) (Mul (Sub (Add d13~112@ d13~112@) (Mul d13~112@ a13~106@)) d13~112@))) (=> (= temp_13_1~2561@ (Mul (Add (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@)) (Mul (Mul a13~106@ c13~110@) d13~112@)) (Mul (Sub (Add d13~112@ d13~112@) (Mul d13~112@ a13~106@)) d13~112@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c13~110@ d13~112@) (=> %%location_label%%13 (= temp_13_0~2512@ temp_13_1~2561@))) (=> (= temp_13_0~2512@ temp_13_1~2561@) (=> (= temp_14_0~2650@ (Mul (Mul (Mul (Add b14~116@ d14~120@) (Mul d14~120@ c14~118@)) (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ a14~114@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ d14~120@)) (Mul (Mul d14~120@ b14~116@) a14~114@)))) (=> (= temp_14_1~2719@ (Mul (Mul (Add (Mul b14~116@ (Mul d14~120@ c14~118@)) (Mul d14~120@ (Mul d14~120@ c14~118@))) (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ a14~114@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ d14~120@)) (Mul (Mul d14~120@ b14~116@) a14~114@)))) (and (=> (= tmp%23@ (Add (Mul b14~116@ (Mul d14~120@ c14~118@)) (Mul d14~120@ (Mul d14~120@ c14~118@)))) (=> (= tmp%24@ (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ a14~114@))) (=> (= tmp%25@ (Mul (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ d14~120@)) (Mul (Mul d14~120@ b14~116@) a14~114@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> (= tmp%26@ (Mul d14~120@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b14~116@ d14~120@ tmp%26@) (=> (= tmp%27@ (Mul (Add b14~116@ d14~120@) (Mul d14~120@ c14~118@))) (=> (= tmp%28@ (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ a14~114@))) (=> (= tmp%29@ (Mul (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ d14~120@)) (Mul (Mul d14~120@ b14~116@) a14~114@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> %%location_label%%14 (= temp_14_0~2650@ temp_14_1~2719@)))))))))))) (=> (= temp_14_0~2650@ temp_14_1~2719@) (=> (= temp_15_0~2938@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Sub c15~126@ (Mul b15~124@ c15~126@))) (Mul (Mul (Mul c15~126@ a15~122@) (Mul a15~122@ a15~122@)) (Mul (Mul c15~126@ b15~124@) (Add b15~124@ d15~128@))))) (=> (= temp_15_1~2999@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Sub c15~126@ (Mul b15~124@ c15~126@))) (Mul (Mul (Mul c15~126@ a15~122@) (Mul a15~122@ a15~122@)) (Mul (Mul c15~126@ b15~124@) (Add b15~124@ d15~128@))))) (=> (= tmp%30@ (= temp_15_0~2938@ temp_15_1~2999@)) (and (=> %%location_label%%15 tmp%30@) (=> tmp%30@ (=> (= temp_16_0~3071@ (Mul (Mul (Mul (Sub d16~136@ b16~132@) (Mul c16~134@ d16~136@)) (Add (Sub c16~134@ b16~132@) (Add c16~134@ c16~134@))) (Mul (Mul a16~130@ (Mul b16~132@ b16~132@)) (Mul (Add b16~132@ c16~134@) b16~132@)))) (=> (= temp_16_1~3128@ (Mul (Mul (Mul (Sub d16~136@ b16~132@) (Mul c16~134@ d16~136@)) (Add (Sub c16~134@ b16~132@) (Add c16~134@ c16~134@))) (Mul a16~130@ (Mul (Mul b16~132@ b16~132@) (Mul (Add b16~132@ c16~134@) b16~132@))))) (and (=> (= tmp%31@ (Mul b16~132@ b16~132@)) (=> (= tmp%32@ (Mul (Add b16~132@ c16~134@) b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a16~130@ tmp%31@ tmp%32@) (=> %%location_label%%16 (= temp_16_0~3071@ temp_16_1~3128@))))) (=> (= temp_16_0~3071@ temp_16_1~3128@) (=> (= temp_17_0~3247@ (Sub (Sub (Sub (Mul c17~142@ b17~140@) (Mul d17~144@ a17~138@)) (Add (Add d17~144@ d17~144@) (Mul d17~144@ b17~140@))) (Mul (Mul (Mul c17~142@ b17~140@) (Mul a17~138@ a17~138@)) (Add (Mul 64 b17~140@) (Add a17~138@ c17~142@))))) (=> (= temp_17_1~3324@ (Sub (Sub (Sub (Mul c17~142@ b17~140@) (Mul d17~144@ a17~138@)) (Add (Add d17~144@ d17~144@) (Mul d17~144@ b17~140@))) (Mul (Mul (Mul c17~142@ b17~140@) (Mul a17~138@ a17~138@)) (Add (Mul b17~140@ 64) (Add a17~138@ c17~142@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b17~140@ 64) (=> %%location_label%%17 (= temp_17_0~3247@ temp_17_1~3324@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
