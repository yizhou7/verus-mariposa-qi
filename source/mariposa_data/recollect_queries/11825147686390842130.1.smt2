...
(declare-const temp_4_1~1318@ Int)
(declare-const temp_5_0~1561@ Int)
(declare-const temp_5_1~1638@ Int)
(declare-const temp_6_0~1725@ Int)
(declare-const temp_6_1~1782@ Int)
(declare-const temp_7_0~1889@ Int)
(declare-const temp_7_1~1962@ Int)
(declare-const temp_8_0~2059@ Int)
(declare-const temp_8_1~2120@ Int)
(declare-const temp_9_0~2273@ Int)
(declare-const temp_9_1~2346@ Int)
(declare-const temp_10_0~2439@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ d0~8@))) (Sub b0~4@ (Mul (Mul 59 a0~2@) (Sub b0~4@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul c0~6@ (Mul d0~8@ (Mul c0~6@ d0~8@))) (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ d0~8@))) (Sub b0~4@ (Mul (Mul 59 a0~2@) (Sub b0~4@ d0~8@))))) (and (=> (= tmp%1@ (Mul c0~6@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c0~6@ d0~8@ tmp%1@) (=> (= tmp%2@ (Mul c0~6@ (Mul d0~8@ (Mul c0~6@ d0~8@)))) (=> (= tmp%3@ (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ d0~8@))) (=> (= tmp%4@ (Sub b0~4@ (Mul (Mul 59 a0~2@) (Sub b0~4@ d0~8@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> (= tmp%5@ (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@))) (=> (= tmp%6@ (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ d0~8@))) (=> (= tmp%7@ (Sub b0~4@ (Mul (Mul 59 a0~2@) (Sub b0~4@ d0~8@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))))))))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~589@ (Mul (Add (Mul (Mul c1~14@ a1~10@) (Sub a1~10@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@))) (Sub (Mul (Mul 32 a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~666@ (Mul (Add (Mul (Mul c1~14@ a1~10@) (Sub a1~10@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ b1~12@))) (Sub (Mul (Mul 32 a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ a1~10@) (=> %%location_label%%1 (= temp_1_0~589@ temp_1_1~666@))) (=> (= temp_1_0~589@ temp_1_1~666@) (=> (= temp_2_0~771@ (Mul (Sub (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul a2~18@ a2~18@) (Sub 78 c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~848@ (Mul (Sub (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul a2~18@ a2~18@) (Sub 78 c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ d2~24@))))) (and (=> (= tmp%8@ (Mul c2~22@ b2~20@)) (=> (= tmp%9@ (Mul d2~24@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> (= tmp%10@ (Sub (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@)))) (=> (= tmp%11@ (Mul (Mul a2~18@ a2~18@) (Sub 78 c2~22@))) (=> (= tmp%12@ (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ d2~24@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> (= tmp%13@ (Sub (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@)))) (=> (= tmp%14@ (Mul (Mul a2~18@ a2~18@) (Sub 78 c2~22@))) (=> (= tmp%15@ (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%2 (= temp_2_0~771@ temp_2_1~848@))))))))))))) (=> (= temp_2_0~771@ temp_2_1~848@) (=> (= temp_3_0~1077@ (Mul (Mul (Mul c3~30@ (Mul a3~26@ a3~26@)) (Mul (Add a3~26@ b3~28@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~1146@ (Mul (Mul (Mul c3~30@ (Mul a3~26@ a3~26@)) (Add (Mul a3~26@ (Mul c3~30@ b3~28@)) (Mul b3~28@ (Mul c3~30@ b3~28@)))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))))) (and (=> (= tmp%16@ (Mul c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a3~26@ b3~28@ tmp%16@) (=> %%location_label%%3 (= temp_3_0~1077@ temp_3_1~1146@)))) (=> (= temp_3_0~1077@ temp_3_1~1146@) (=> (= temp_4_0~1245@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Add (Sub d4~40@ d4~40@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Add b4~36@ a4~34@)) (Mul (Sub b4~36@ a4~34@) (Add a4~34@ d4~40@))))) (=> (= temp_4_1~1318@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Add (Sub d4~40@ d4~40@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Add b4~36@ a4~34@)) (Sub (Mul b4~36@ (Add a4~34@ d4~40@)) (Mul a4~34@ (Add a4~34@ d4~40@)))))) (and (=> (= tmp%17@ (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Add (Sub d4~40@ d4~40@) (Mul d4~40@ c4~38@)))) (=> (= tmp%18@ (Mul (Mul d4~40@ c4~38@) (Add b4~36@ a4~34@))) (=> (= tmp%19@ (Sub (Mul b4~36@ (Add a4~34@ d4~40@)) (Mul a4~34@ (Add a4~34@ d4~40@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> (= tmp%20@ (Add a4~34@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b4~36@ a4~34@ tmp%20@) (=> (= tmp%21@ (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Add (Sub d4~40@ d4~40@) (Mul d4~40@ c4~38@)))) (=> (= tmp%22@ (Mul (Mul d4~40@ c4~38@) (Add b4~36@ a4~34@))) (=> (= tmp%23@ (Mul (Sub b4~36@ a4~34@) (Add a4~34@ d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%4 (= temp_4_0~1245@ temp_4_1~1318@)))))))))))) (=> (= temp_4_0~1245@ temp_4_1~1318@) (=> (= temp_5_0~1561@ (Sub (Mul (Mul (Mul 97 a5~42@) (Sub d5~48@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ c5~46@))) (Add (Add (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@)) (Add (Mul d5~48@ b5~44@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1638@ (Sub (Mul (Mul 97 (Mul a5~42@ (Sub d5~48@ b5~44@))) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ c5~46@))) (Add (Add (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@)) (Add (Mul d5~48@ b5~44@) (Mul b5~44@ a5~42@))))) (and (=> (= tmp%24@ (Sub d5~48@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. 97 a5~42@ tmp%24@) (=> %%location_label%%5 (= temp_5_0~1561@ temp_5_1~1638@)))) (=> (= temp_5_0~1561@ temp_5_1~1638@) (=> (= temp_6_0~1725@ (Sub (Mul (Mul (Sub d6~56@ c6~54@) (Mul c6~54@ b6~52@)) (Sub (Mul 71 d6~56@) (Mul d6~56@ b6~52@))) c6~54@)) (=> (= temp_6_1~1782@ (Sub (Mul (Sub (Mul d6~56@ (Mul c6~54@ b6~52@)) (Mul c6~54@ (Mul c6~54@ b6~52@))) (Sub (Mul 71 d6~56@) (Mul d6~56@ b6~52@))) c6~54@)) (and (=> (= tmp%25@ (Mul c6~54@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d6~56@ c6~54@ tmp%25@) (=> %%location_label%%6 (= temp_6_0~1725@ temp_6_1~1782@)))) (=> (= temp_6_0~1725@ temp_6_1~1782@) (=> (= temp_7_0~1889@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul b7~60@ c7~62@)) (Mul (Mul 99 d7~64@) (Sub a7~58@ b7~60@))) (Mul (Mul (Mul d7~64@ a7~58@) (Add c7~62@ a7~58@)) (Mul (Mul c7~62@ c7~62@) c7~62@)))) (=> (= temp_7_1~1962@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul b7~60@ c7~62@)) (Mul (Mul 99 d7~64@) (Sub a7~58@ b7~60@))) (Mul (Mul (Add c7~62@ a7~58@) (Mul d7~64@ a7~58@)) (Mul (Mul c7~62@ c7~62@) c7~62@)))) (and (=> (= tmp%26@ (Add c7~62@ a7~58@)) (=> (= tmp%27@ (Mul d7~64@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%26@ tmp%27@) (=> %%location_label%%7 (= temp_7_0~1889@ temp_7_1~1962@))))) (=> (= temp_7_0~1889@ temp_7_1~1962@) (=> (= temp_8_0~2059@ (Sub (Mul (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ b8~68@)) (Mul c8~70@ (Add d8~72@ a8~66@))) (Mul (Mul (Sub a8~66@ c8~70@) (Sub b8~68@ a8~66@)) 93))) (=> (= temp_8_1~2120@ (Sub (Mul (Mul (Mul c8~70@ a8~66@) (Mul a8~66@ b8~68@)) (Mul c8~70@ (Add d8~72@ a8~66@))) (Mul (Mul (Sub a8~66@ c8~70@) (Sub b8~68@ a8~66@)) 93))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ a8~66@) (=> (= tmp%28@ (Mul c8~70@ a8~66@)) (=> (= tmp%29@ (Mul a8~66@ b8~68@)) (=> (= tmp%30@ (Mul c8~70@ (Add d8~72@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> (= tmp%31@ (Mul a8~66@ c8~70@)) (=> (= tmp%32@ (Mul a8~66@ b8~68@)) (=> (= tmp%33@ (Mul c8~70@ (Add d8~72@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> %%location_label%%8 (= temp_8_0~2059@ temp_8_1~2120@))))))))))) (=> (= temp_8_0~2059@ temp_8_1~2120@) (=> (= temp_9_0~2273@ (Mul (Mul (Add (Mul d9~80@ 22) (Mul a9~74@ d9~80@)) (Mul d9~80@ (Mul b9~76@ d9~80@))) (Sub (Mul (Mul b9~76@ c9~78@) (Add b9~76@ c9~78@)) (Add (Mul d9~80@ c9~78@) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~2346@ (Mul (Mul (Add (Mul d9~80@ 22) (Mul a9~74@ d9~80@)) (Mul d9~80@ (Mul b9~76@ d9~80@))) (Sub (Mul (Mul b9~76@ c9~78@) (Add b9~76@ c9~78@)) (Add (Mul c9~78@ d9~80@) (Mul a9~74@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c9~78@ d9~80@) (=> %%location_label%%9 (= temp_9_0~2273@ temp_9_1~2346@))) (=> (= temp_9_0~2273@ temp_9_1~2346@) (=> (= temp_10_0~2439@ (Add (Mul (Mul (Mul b10~84@ a10~82@) (Mul c10~86@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))) (Mul (Sub (Mul c10~86@ a10~82@) (Add c10~86@ d10~88@)) (Mul (Mul d10~88@ d10~88@) (Sub a10~82@ c10~86@))))) (=> (= temp_10_1~2504@ (Add (Mul (Mul (Mul b10~84@ a10~82@) (Mul c10~86@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))) (Mul (Mul (Sub (Mul c10~86@ a10~82@) (Add c10~86@ d10~88@)) (Mul d10~88@ d10~88@)) (Sub a10~82@ c10~86@)))) (=> (= tmp%34@ (Sub (Mul c10~86@ a10~82@) (Add c10~86@ d10~88@))) (=> (= tmp%35@ (Mul d10~88@ d10~88@)) (=> (= tmp%36@ (Sub a10~82@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ tmp%35@ tmp%36@) (=> %%location_label%%10 (= temp_10_0~2439@ temp_10_1~2504@)))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
