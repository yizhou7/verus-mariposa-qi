...
(declare-const temp_3_0~951@ Int)
(declare-const temp_3_1~1028@ Int)
(declare-const temp_4_0~1135@ Int)
(declare-const temp_4_1~1208@ Int)
(declare-const temp_5_0~1311@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul d0~8@ (Sub (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Add (Mul d0~8@ b0~4@) (Add b0~4@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~346@ (Mul (Mul d0~8@ (Sub (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Mul (Add (Mul d0~8@ b0~4@) (Add b0~4@ d0~8@)) (Mul d0~8@ a0~2@)) (Mul a0~2@ b0~4@)))) (and (=> (= tmp%1@ (Add (Mul d0~8@ b0~4@) (Add b0~4@ d0~8@))) (=> (= tmp%2@ (Mul d0~8@ a0~2@)) (=> (= tmp%3@ (Mul a0~2@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@)))))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~461@ (Sub (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Add b1~12@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul a1~10@ b1~12@) (Sub a1~10@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~526@ (Sub (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul (Add b1~12@ c1~14@) a1~10@) a1~10@)) (Mul (Mul (Mul a1~10@ b1~12@) (Sub a1~10@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@))))) (and (=> (= tmp%4@ (Add b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ a1~10@ a1~10@) (=> %%location_label%%1 (= temp_1_0~461@ temp_1_1~526@)))) (=> (= temp_1_0~461@ temp_1_1~526@) (=> (= temp_2_0~637@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ c2~22@)) (Add (Mul d2~24@ d2~24@) (Mul d2~24@ a2~18@))) (Mul (Mul (Sub d2~24@ 9) (Mul b2~20@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~714@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Add b2~20@ c2~22@)) (Add (Mul d2~24@ d2~24@) (Mul d2~24@ a2~18@))) (Mul (Mul (Sub d2~24@ 9) (Mul b2~20@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ c2~22@) (=> (= tmp%5@ (Mul (Mul a2~18@ c2~22@) (Add b2~20@ c2~22@))) (=> (= tmp%6@ (Add (Mul d2~24@ d2~24@) (Mul d2~24@ a2~18@))) (=> (= tmp%7@ (Mul (Mul (Sub d2~24@ 9) (Mul b2~20@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> (= tmp%8@ (Mul (Mul c2~22@ a2~18@) (Add b2~20@ c2~22@))) (=> (= tmp%9@ (Add (Mul d2~24@ d2~24@) (Mul d2~24@ a2~18@))) (=> (= tmp%10@ (Mul (Mul (Sub d2~24@ 9) (Mul b2~20@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%2 (= temp_2_0~637@ temp_2_1~714@))))))))))) (=> (= temp_2_0~637@ temp_2_1~714@) (=> (= temp_3_0~951@ (Add (Mul (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ a3~26@)) (Mul (Mul 18 d3~32@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Add b3~28@ a3~26@))))) (=> (= temp_3_1~1028@ (Add (Mul (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ a3~26@)) (Mul (Mul 18 d3~32@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul (Mul d3~32@ a3~26@) a3~26@) b3~28@) (Mul (Mul d3~32@ c3~30@) (Add b3~28@ a3~26@))))) (and (=> (= tmp%11@ (Mul d3~32@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ a3~26@ b3~28@) (=> %%location_label%%3 (= temp_3_0~951@ temp_3_1~1028@)))) (=> (= temp_3_0~951@ temp_3_1~1028@) (=> (= temp_4_0~1135@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ d4~40@))) (Mul (Mul 58 (Add c4~38@ d4~40@)) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@))))) (=> (= temp_4_1~1208@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ d4~40@))) (Mul (Mul (Mul 58 (Add c4~38@ d4~40@)) (Mul d4~40@ c4~38@)) (Mul a4~34@ a4~34@)))) (and (=> (= tmp%12@ (Mul 58 (Add c4~38@ d4~40@))) (=> (= tmp%13@ (Mul d4~40@ c4~38@)) (=> (= tmp%14@ (Mul a4~34@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%4 (= temp_4_0~1135@ temp_4_1~1208@)))))) (=> (= temp_4_0~1135@ temp_4_1~1208@) (=> (= temp_5_0~1311@ (Mul (Mul (Sub (Mul a5~42@ a5~42@) (Mul c5~46@ b5~44@)) d5~48@) (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1364@ (Mul (Mul d5~48@ (Sub (Mul a5~42@ a5~42@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ b5~44@))))) (=> (= tmp%15@ (Sub (Mul a5~42@ a5~42@) (Mul c5~46@ b5~44@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ tmp%15@) (=> %%location_label%%5 (= temp_5_0~1311@ temp_5_1~1364@)))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
