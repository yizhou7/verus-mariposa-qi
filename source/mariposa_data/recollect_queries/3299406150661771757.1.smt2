...
(declare-const temp_2_0~731@ Int)
(declare-const temp_2_1~792@ Int)
(declare-const temp_3_0~889@ Int)
(declare-const temp_3_1~954@ Int)
(declare-const temp_4_0~1079@ Int)
(declare-const temp_4_1~1116@ Int)
(declare-const temp_5_0~1231@ Int)
(declare-const temp_5_1~1328@ Int)
(declare-const temp_6_0~1475@ Int)
(declare-const temp_6_1~1540@ Int)
(declare-const temp_7_0~1635@ Int)
(declare-const temp_7_1~1696@ Int)
(declare-const temp_8_0~1789@ Int)
(declare-const temp_8_1~1854@ Int)
(declare-const temp_9_0~1947@ Int)
(declare-const temp_9_1~2012@ Int)
(declare-const temp_10_0~2111@ Int)
(declare-const temp_10_1~2176@ Int)
(declare-const temp_11_0~2323@ Int)
(declare-const temp_11_1~2388@ Int)
(declare-const temp_12_0~2483@ Int)
(declare-const temp_12_1~2544@ Int)
(declare-const temp_13_0~2657@ Int)
(declare-const temp_13_1~2734@ Int)
(declare-const temp_14_0~2806@ Int)
(declare-const temp_14_1~2863@ Int)
(declare-const temp_15_0~3002@ Int)
(declare-const temp_15_1~3075@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Add (Mul (Add b0~4@ a0~2@) d0~8@) (Add (Mul b0~4@ a0~2@) (Mul c0~6@ c0~6@))) (Sub (Mul d0~8@ (Sub b0~4@ c0~6@)) (Mul (Mul b0~4@ b0~4@) d0~8@)))) (=> (= temp_0_1~350@ (Mul (Add (Add (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@)) (Add (Mul b0~4@ a0~2@) (Mul c0~6@ c0~6@))) (Sub (Mul d0~8@ (Sub b0~4@ c0~6@)) (Mul (Mul b0~4@ b0~4@) d0~8@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b0~4@ a0~2@ d0~8@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~350@))) (=> (= temp_0_0~293@ temp_0_1~350@) (=> (= temp_1_0~445@ (Mul (Mul (Mul (Add c1~14@ c1~14@) (Mul a1~10@ a1~10@)) (Add (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Add (Mul b1~12@ a1~10@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~510@ (Mul (Mul (Mul (Add c1~14@ c1~14@) (Mul a1~10@ a1~10@)) (Add (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Add (Mul b1~12@ a1~10@) (Mul c1~14@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@))))) (and (=> (= tmp%1@ (Mul a1~10@ c1~14@)) (=> (= tmp%2@ (Mul d1~16@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> (= tmp%3@ (Mul (Mul (Add c1~14@ c1~14@) (Mul a1~10@ a1~10@)) (Add (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@)))) (=> (= tmp%4@ (Add (Mul b1~12@ a1~10@) (Mul c1~14@ a1~10@))) (=> (= tmp%5@ (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Mul (Mul (Add c1~14@ c1~14@) (Mul a1~10@ a1~10@)) (Add (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@)))) (=> (= tmp%7@ (Add (Mul b1~12@ a1~10@) (Mul c1~14@ a1~10@))) (=> (= tmp%8@ (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%1 (= temp_1_0~445@ temp_1_1~510@))))))))))))) (=> (= temp_1_0~445@ temp_1_1~510@) (=> (= temp_2_0~731@ (Add (Mul (Sub (Mul 14 b2~20@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Add b2~20@ c2~22@))) (Sub (Mul d2~24@ (Mul d2~24@ d2~24@)) a2~18@))) (=> (= temp_2_1~792@ (Add (Mul (Sub (Mul b2~20@ 14) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Add b2~20@ c2~22@))) (Sub (Mul d2~24@ (Mul d2~24@ d2~24@)) a2~18@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ 14) (=> %%location_label%%2 (= temp_2_0~731@ temp_2_1~792@))) (=> (= temp_2_0~731@ temp_2_1~792@) (=> (= temp_3_0~889@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Add c3~30@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul d3~32@ c3~30@) (Sub a3~26@ a3~26@))))) (=> (= temp_3_1~954@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Add c3~30@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul d3~32@ c3~30@) (Sub a3~26@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ c3~30@) (=> (= tmp%9@ (Mul (Mul a3~26@ b3~28@) (Add c3~30@ b3~28@))) (=> (= tmp%10@ (Mul d3~32@ c3~30@)) (=> (= tmp%11@ (Mul a3~26@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> (= tmp%12@ (Mul (Mul a3~26@ b3~28@) (Add c3~30@ b3~28@))) (=> (= tmp%13@ (Mul d3~32@ c3~30@)) (=> (= tmp%14@ (Mul c3~30@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%3 (= temp_3_0~889@ temp_3_1~954@))))))))))) (=> (= temp_3_0~889@ temp_3_1~954@) (=> (= temp_4_0~1079@ (Mul a4~34@ (Mul (Mul (Mul b4~36@ a4~34@) (Add a4~34@ d4~40@)) (Mul (Add a4~34@ a4~34@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~1116@ (Mul a4~34@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Add a4~34@ d4~40@)) (Add a4~34@ a4~34@)) (Mul c4~38@ b4~36@)))) (and (=> (= tmp%15@ (Mul (Mul b4~36@ a4~34@) (Add a4~34@ d4~40@))) (=> (= tmp%16@ (Add a4~34@ a4~34@)) (=> (= tmp%17@ (Mul c4~38@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%4 (= temp_4_0~1079@ temp_4_1~1116@)))))) (=> (= temp_4_0~1079@ temp_4_1~1116@) (=> (= temp_5_0~1231@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ c5~46@))) (Sub (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1328@ (Sub (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ c5~46@))) (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ c5~46@))) (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@))))) (and (=> (= tmp%18@ (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ c5~46@)))) (=> (= tmp%19@ (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ a5~42@))) (=> (= tmp%20@ (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%5 (= temp_5_0~1231@ temp_5_1~1328@)))))) (=> (= temp_5_0~1231@ temp_5_1~1328@) (=> (= temp_6_0~1475@ (Mul (Mul (Add (Sub a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Sub d6~56@ b6~52@) (Mul a6~50@ c6~54@))) (Add (Mul (Mul d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1540@ (Mul (Mul (Add (Sub a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Mul (Sub d6~56@ b6~52@) a6~50@) c6~54@)) (Add (Mul (Mul d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@))))) (and (=> (= tmp%21@ (Sub d6~56@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ a6~50@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1475@ temp_6_1~1540@)))) (=> (= temp_6_0~1475@ temp_6_1~1540@) (=> (= temp_7_0~1635@ (Sub (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ a7~58@)) (Add d7~64@ (Mul b7~60@ a7~58@))) (Sub (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ a7~58@)) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1696@ (Sub (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ a7~58@)) (Add d7~64@ (Mul b7~60@ a7~58@))) (Sub (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ a7~58@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1635@ temp_7_1~1696@))) (=> (= temp_7_0~1635@ temp_7_1~1696@) (=> (= temp_8_0~1789@ (Sub (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Add (Mul d8~72@ d8~72@) (Add b8~68@ b8~68@))) (Add (Mul (Mul d8~72@ b8~68@) (Sub c8~70@ d8~72@)) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1854@ (Sub (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Add (Mul d8~72@ d8~72@) (Add b8~68@ b8~68@))) (Add (Mul (Mul b8~68@ d8~72@) (Sub c8~70@ d8~72@)) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1789@ temp_8_1~1854@))) (=> (= temp_8_0~1789@ temp_8_1~1854@) (=> (= temp_9_0~1947@ (Mul (Mul (Add (Add b9~76@ c9~78@) (Mul c9~78@ a9~74@)) (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ c9~78@))) (Mul (Mul (Add d9~80@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~2012@ (Mul (Mul (Add (Add b9~76@ c9~78@) (Mul c9~78@ a9~74@)) (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ c9~78@))) (Mul (Mul (Mul (Add d9~80@ c9~78@) d9~80@) c9~78@) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ a9~74@))))) (and (=> (= tmp%22@ (Add d9~80@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ d9~80@ c9~78@) (=> %%location_label%%9 (= temp_9_0~1947@ temp_9_1~2012@)))) (=> (= temp_9_0~1947@ temp_9_1~2012@) (=> (= temp_10_0~2111@ (Mul (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul c10~86@ c10~86@) (Mul a10~82@ d10~88@))) (Mul (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ c10~86@)) (Sub (Sub d10~88@ d10~88@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~2176@ (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul (Mul c10~86@ c10~86@) (Mul a10~82@ d10~88@)) (Mul (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ c10~86@)) (Sub (Sub d10~88@ d10~88@) (Mul b10~84@ d10~88@)))))) (and (=> (= tmp%23@ (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ c10~86@))) (=> (= tmp%24@ (Mul (Mul c10~86@ c10~86@) (Mul a10~82@ d10~88@))) (=> (= tmp%25@ (Mul (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ c10~86@)) (Sub (Sub d10~88@ d10~88@) (Mul b10~84@ d10~88@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> %%location_label%%10 (= temp_10_0~2111@ temp_10_1~2176@)))))) (=> (= temp_10_0~2111@ temp_10_1~2176@) (=> (= temp_11_0~2323@ (Add (Mul (Mul (Mul d11~96@ d11~96@) (Mul a11~90@ b11~92@)) (Mul (Sub d11~96@ b11~92@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ d11~96@))))) (=> (= temp_11_1~2388@ (Add (Mul (Mul (Mul d11~96@ d11~96@) (Mul a11~90@ b11~92@)) (Mul (Sub d11~96@ b11~92@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul (Mul b11~92@ b11~92@) d11~96@) b11~92@) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ d11~96@))))) (and (=> (= tmp%26@ (Mul b11~92@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ d11~96@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2323@ temp_11_1~2388@)))) (=> (= temp_11_0~2323@ temp_11_1~2388@) (=> (= temp_12_0~2483@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ d12~104@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ b12~100@) a12~98@)))) (=> (= temp_12_1~2544@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ b12~100@) a12~98@)))) (and (=> (= tmp%27@ (Mul b12~100@ d12~104@)) (=> (= tmp%28@ (Mul b12~100@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%12 (= temp_12_0~2483@ temp_12_1~2544@))))) (=> (= temp_12_0~2483@ temp_12_1~2544@) (=> (= temp_13_0~2657@ (Mul (Mul (Mul (Mul b13~108@ 20) (Add a13~106@ a13~106@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ d13~112@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Add a13~106@ d13~112@))))) (=> (= temp_13_1~2734@ (Mul (Mul (Mul (Mul b13~108@ 20) (Add a13~106@ a13~106@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ d13~112@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Add a13~106@ d13~112@))))) (=> (= tmp%29@ (= temp_13_0~2657@ temp_13_1~2734@)) (and (=> %%location_label%%13 tmp%29@) (=> tmp%29@ (=> (= temp_14_0~2806@ (Mul (Mul (Mul a14~114@ (Add d14~120@ b14~116@)) (Mul (Add d14~120@ b14~116@) (Mul d14~120@ a14~114@))) (Mul (Mul (Mul a14~114@ a14~114@) c14~118@) (Mul (Mul b14~116@ c14~118@) (Sub d14~120@ d14~120@))))) (=> (= temp_14_1~2863@ (Mul (Mul (Mul (Mul a14~114@ (Add d14~120@ b14~116@)) (Mul (Add d14~120@ b14~116@) (Mul d14~120@ a14~114@))) (Mul (Mul a14~114@ a14~114@) c14~118@)) (Mul (Mul b14~116@ c14~118@) (Sub d14~120@ d14~120@)))) (and (=> (= tmp%30@ (Mul (Mul a14~114@ (Add d14~120@ b14~116@)) (Mul (Add d14~120@ b14~116@) (Mul d14~120@ a14~114@)))) (=> (= tmp%31@ (Mul (Mul a14~114@ a14~114@) c14~118@)) (=> (= tmp%32@ (Mul (Mul b14~116@ c14~118@) (Sub d14~120@ d14~120@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%30@ tmp%31@ tmp%32@) (=> %%location_label%%14 (= temp_14_0~2806@ temp_14_1~2863@)))))) (=> (= temp_14_0~2806@ temp_14_1~2863@) (=> (= temp_15_0~3002@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ b15~124@)) (Mul (Add b15~124@ b15~124@) (Mul c15~126@ d15~128@))) (Mul (Sub (Mul b15~124@ a15~122@) (Mul b15~124@ d15~128@)) (Mul (Sub a15~122@ a15~122@) (Sub d15~128@ d15~128@))))) (=> (= temp_15_1~3075@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ b15~124@)) (Add (Mul b15~124@ (Mul c15~126@ d15~128@)) (Mul b15~124@ (Mul c15~126@ d15~128@)))) (Mul (Sub (Mul b15~124@ a15~122@) (Mul b15~124@ d15~128@)) (Mul (Sub a15~122@ a15~122@) (Sub d15~128@ d15~128@))))) (=> (= tmp%33@ (Mul c15~126@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b15~124@ b15~124@ tmp%33@) (=> %%location_label%%15 (= temp_15_0~3002@ temp_15_1~3075@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
