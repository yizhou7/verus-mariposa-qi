...
(declare-const temp_3_0~871@ Int)
...
(declare-const temp_6_0~1543@ Int)
(declare-const temp_6_1~1604@ Int)
...
(declare-const temp_9_0~2151@ Int)
(declare-const temp_9_1~2204@ Int)
(declare-const temp_10_0~2299@ Int)
(declare-const temp_10_1~2360@ Int)
(declare-const temp_11_0~2436@ Int)
(declare-const temp_11_1~2497@ Int)
(declare-const temp_12_0~2590@ Int)
(declare-const temp_12_1~2655@ Int)
(declare-const temp_13_0~2720@ Int)
(declare-const temp_13_1~2757@ Int)
(declare-const temp_14_0~2872@ Int)
(declare-const temp_14_1~2933@ Int)
(declare-const temp_15_0~3038@ Int)
(declare-const temp_15_1~3115@ Int)
(declare-const temp_16_0~3179@ Int)
(declare-const temp_16_1~3228@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul c0~6@ (Mul (Mul 4 a0~2@) (Mul b0~4@ c0~6@))) (Sub (Add b0~4@ (Mul d0~8@ c0~6@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~362@ (Mul (Mul c0~6@ (Mul (Mul 4 a0~2@) (Mul b0~4@ c0~6@))) (Sub (Add b0~4@ (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ b0~4@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~439@ (Mul (Add b1~12@ (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul b1~12@ d1~16@) b1~12@) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~488@ (Mul (Add b1~12@ (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul b1~12@ d1~16@) b1~12@) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ b1~12@) (=> %%location_label%%1 (= temp_1_0~439@ temp_1_1~488@))) (=> (= temp_1_0~439@ temp_1_1~488@) (=> (= temp_2_0~581@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Sub b2~20@ c2~22@) (Mul a2~18@ a2~18@))) (Mul (Mul (Add a2~18@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Add b2~20@ c2~22@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~646@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Sub b2~20@ c2~22@) (Mul a2~18@ a2~18@))) (Mul (Mul (Add a2~18@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Add b2~20@ c2~22@) (Mul c2~22@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ d2~24@) (=> (= tmp%1@ (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ d2~24@))) (=> (= tmp%2@ (Mul (Sub b2~20@ c2~22@) (Mul a2~18@ a2~18@))) (=> (= tmp%3@ (Mul (Mul (Add a2~18@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Add b2~20@ c2~22@) (Mul c2~22@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> (= tmp%4@ (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ c2~22@))) (=> (= tmp%5@ (Mul (Sub b2~20@ c2~22@) (Mul a2~18@ a2~18@))) (=> (= tmp%6@ (Mul (Mul (Add a2~18@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Add b2~20@ c2~22@) (Mul c2~22@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%2 (= temp_2_0~581@ temp_2_1~646@))))))))))) (=> (= temp_2_0~581@ temp_2_1~646@) (=> (= temp_3_0~871@ (Sub (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@)) (Mul (Sub b3~28@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Add 98 (Mul d3~32@ b3~28@)) (Mul (Sub b3~28@ c3~30@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~944@ (Sub (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@)) (Mul (Mul b3~28@ d3~32@) (Sub b3~28@ d3~32@))) (Mul (Add 98 (Mul d3~32@ b3~28@)) (Mul (Sub b3~28@ c3~30@) (Mul b3~28@ b3~28@))))) (and (=> (= tmp%7@ (Mul b3~28@ d3~32@)) (=> (= tmp%8@ (Sub b3~28@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%3 (= temp_3_0~871@ temp_3_1~944@))))) (=> (= temp_3_0~871@ temp_3_1~944@) (=> (= temp_4_0~1045@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Add (Mul b4~36@ d4~40@) (Add b4~36@ d4~40@))) (Mul (Mul (Mul d4~40@ d4~40@) (Add c4~38@ b4~36@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~1110@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Add (Mul b4~36@ d4~40@) (Add b4~36@ d4~40@))) (Mul (Mul (Mul d4~40@ d4~40@) (Add c4~38@ b4~36@)) (Mul (Mul (Mul d4~40@ a4~34@) b4~36@) d4~40@)))) (and (=> (= tmp%9@ (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Add (Mul b4~36@ d4~40@) (Add b4~36@ d4~40@)))) (=> (= tmp%10@ (Mul (Mul d4~40@ d4~40@) (Add c4~38@ b4~36@))) (=> (= tmp%11@ (Mul (Mul (Mul d4~40@ a4~34@) b4~36@) d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> (= tmp%12@ (Mul d4~40@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ b4~36@ d4~40@) (=> (= tmp%13@ (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Add (Mul b4~36@ d4~40@) (Add b4~36@ d4~40@)))) (=> (= tmp%14@ (Mul (Mul d4~40@ d4~40@) (Add c4~38@ b4~36@))) (=> (= tmp%15@ (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%4 (= temp_4_0~1045@ temp_4_1~1110@)))))))))))) (=> (= temp_4_0~1045@ temp_4_1~1110@) (=> (= temp_5_0~1333@ (Mul (Mul (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Add a5~42@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1398@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ c5~46@))) (Mul (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Add a5~42@ d5~48@) (Mul c5~46@ c5~46@))))) (and (=> (= tmp%16@ (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ c5~46@)))) (=> (= tmp%17@ (Mul (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Add a5~42@ d5~48@) (Mul c5~46@ c5~46@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%5 (= temp_5_0~1333@ temp_5_1~1398@))))) (=> (= temp_5_0~1333@ temp_5_1~1398@) (=> (= temp_6_0~1543@ (Mul (Mul (Mul c6~54@ (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@)) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1604@ (Mul (Mul (Mul c6~54@ (Mul a6~50@ d6~56@)) (Mul (Mul (Mul b6~52@ d6~56@) b6~52@) d6~56@)) (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@)) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (and (=> (= tmp%18@ (Mul b6~52@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ b6~52@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1543@ temp_6_1~1604@)))) (=> (= temp_6_0~1543@ temp_6_1~1604@) (=> (= temp_7_0~1711@ (Mul (Mul (Sub (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@)) (Mul d7~64@ (Mul c7~62@ 77))) (Mul (Add (Add c7~62@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1784@ (Mul (Mul (Sub (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@)) (Mul d7~64@ (Mul c7~62@ 77))) (Mul (Add (Add c7~62@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ d7~64@) (=> (= tmp%19@ (Mul (Sub (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@)) (Mul d7~64@ (Mul c7~62@ 77)))) (=> (= tmp%20@ (Add (Add c7~62@ b7~60@) (Mul d7~64@ d7~64@))) (=> (= tmp%21@ (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ b7~60@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> (= tmp%22@ (Mul (Sub (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@)) (Mul d7~64@ (Mul c7~62@ 77)))) (=> (= tmp%23@ (Add (Add c7~62@ b7~60@) (Mul d7~64@ d7~64@))) (=> (= tmp%24@ (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%7 (= temp_7_0~1711@ temp_7_1~1784@))))))))))) (=> (= temp_7_0~1711@ temp_7_1~1784@) (=> (= temp_8_0~1997@ (Mul (Add (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ d8~72@)) (Mul (Sub d8~72@ c8~70@) (Mul d8~72@ b8~68@))) (Mul (Mul c8~70@ (Mul d8~72@ b8~68@)) (Sub (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~2058@ (Mul (Add (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ d8~72@)) (Mul (Sub d8~72@ c8~70@) (Mul d8~72@ b8~68@))) (Mul (Sub (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@)) (Mul c8~70@ (Mul d8~72@ b8~68@))))) (and (=> (= tmp%25@ (Sub (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@))) (=> (= tmp%26@ (Mul c8~70@ (Mul d8~72@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%25@ tmp%26@) (=> %%location_label%%8 (= temp_8_0~1997@ temp_8_1~2058@))))) (=> (= temp_8_0~1997@ temp_8_1~2058@) (=> (= temp_9_0~2151@ (Mul (Sub (Mul (Mul d9~80@ b9~76@) (Add d9~80@ d9~80@)) (Sub d9~80@ (Mul d9~80@ c9~78@))) (Sub (Mul d9~80@ (Mul d9~80@ d9~80@)) b9~76@))) (=> (= temp_9_1~2204@ (Mul (Sub (Add (Mul (Mul d9~80@ b9~76@) d9~80@) (Mul (Mul d9~80@ b9~76@) d9~80@)) (Sub d9~80@ (Mul d9~80@ c9~78@))) (Sub (Mul d9~80@ (Mul d9~80@ d9~80@)) b9~76@))) (and (=> (= tmp%27@ (Mul d9~80@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%27@ d9~80@ d9~80@) (=> %%location_label%%9 (= temp_9_0~2151@ temp_9_1~2204@)))) (=> (= temp_9_0~2151@ temp_9_1~2204@) (=> (= temp_10_0~2299@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) b10~84@) (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ b10~84@)) (Add (Mul b10~84@ c10~86@) (Sub a10~82@ c10~86@))))) (=> (= temp_10_1~2360@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) b10~84@) (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ b10~84@)) (Add (Mul b10~84@ c10~86@) (Sub a10~82@ c10~86@))))) (=> (= tmp%28@ (= temp_10_0~2299@ temp_10_1~2360@)) (and (=> %%location_label%%10 tmp%28@) (=> tmp%28@ (=> (= temp_11_0~2436@ (Mul (Sub a11~90@ (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul c11~94@ d11~96@) d11~96@) (Add (Add 48 a11~90@) (Sub c11~94@ a11~90@))))) (=> (= temp_11_1~2497@ (Mul (Sub a11~90@ (Mul (Mul b11~92@ c11~94@) (Mul b11~92@ c11~94@))) (Mul (Mul (Mul c11~94@ d11~96@) d11~96@) (Add (Add 48 a11~90@) (Sub c11~94@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b11~92@ c11~94@) (=> %%location_label%%11 (= temp_11_0~2436@ temp_11_1~2497@))) (=> (= temp_11_0~2436@ temp_11_1~2497@) (=> (= temp_12_0~2590@ (Mul (Mul (Add (Mul c12~102@ c12~102@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ a12~98@) (Mul c12~102@ d12~104@))) (Sub (Mul (Mul a12~98@ b12~100@) (Mul b12~100@ d12~104@)) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2655@ (Mul (Mul (Add (Mul c12~102@ c12~102@) (Mul d12~104@ a12~98@)) (Mul (Mul a12~98@ d12~104@) (Mul c12~102@ d12~104@))) (Sub (Mul (Mul a12~98@ b12~100@) (Mul b12~100@ d12~104@)) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d12~104@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2590@ temp_12_1~2655@))) (=> (= temp_12_0~2590@ temp_12_1~2655@) (=> (= temp_13_0~2720@ (Mul a13~106@ (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ d13~112@)) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@))))) (=> (= temp_13_1~2757@ (Mul (Mul a13~106@ (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ d13~112@))) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@)))) (and (=> (= tmp%29@ (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ d13~112@))) (=> (= tmp%30@ (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. a13~106@ tmp%29@ tmp%30@) (=> %%location_label%%13 (= temp_13_0~2720@ temp_13_1~2757@))))) (=> (= temp_13_0~2720@ temp_13_1~2757@) (=> (= temp_14_0~2872@ (Mul (Mul (Mul c14~118@ (Mul a14~114@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Mul d14~120@ c14~118@))) (Mul (Add (Mul d14~120@ a14~114@) (Mul b14~116@ d14~120@)) (Mul (Mul c14~118@ c14~118@) (Mul a14~114@ d14~120@))))) (=> (= temp_14_1~2933@ (Mul (Mul (Mul c14~118@ (Mul a14~114@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Mul d14~120@ c14~118@))) (Mul (Add (Mul d14~120@ a14~114@) (Mul d14~120@ b14~116@)) (Mul (Mul c14~118@ c14~118@) (Mul a14~114@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2872@ temp_14_1~2933@))) (=> (= temp_14_0~2872@ temp_14_1~2933@) (=> (= temp_15_0~3038@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ c15~126@)) (Sub (Mul b15~124@ a15~122@) (Mul a15~122@ d15~128@))) (Sub (Add (Add c15~126@ b15~124@) (Mul a15~122@ 15)) (Mul (Add b15~124@ b15~124@) (Mul b15~124@ a15~122@))))) (=> (= temp_15_1~3115@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ c15~126@)) (Sub (Mul b15~124@ a15~122@) (Mul a15~122@ d15~128@))) (Sub (Add (Add c15~126@ b15~124@) (Mul a15~122@ 15)) (Mul (Add b15~124@ b15~124@) (Mul b15~124@ a15~122@))))) (=> (= tmp%31@ (= temp_15_0~3038@ temp_15_1~3115@)) (and (=> %%location_label%%15 tmp%31@) (=> tmp%31@ (=> (= temp_16_0~3179@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ d16~136@)) (Sub (Mul a16~130@ a16~130@) (Mul d16~136@ a16~130@))) (Sub (Mul a16~130@ (Mul a16~130@ b16~132@)) b16~132@))) (=> (= temp_16_1~3228@ (Mul (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ d16~136@)) (Mul (Sub (Mul a16~130@ a16~130@) (Mul d16~136@ a16~130@)) (Sub (Mul a16~130@ (Mul a16~130@ b16~132@)) b16~132@)))) (and (=> (= tmp%32@ (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ d16~136@))) (=> (= tmp%33@ (Sub (Mul a16~130@ a16~130@) (Mul d16~136@ a16~130@))) (=> (= tmp%34@ (Sub (Mul a16~130@ (Mul a16~130@ b16~132@)) b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%16 (= temp_16_0~3179@ temp_16_1~3228@)))))) (=> (= temp_16_0~3179@ temp_16_1~3228@) (=> (= temp_17_0~3339@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@)) a17~138@) (Mul (Mul b17~140@ 93) d17~144@))) (=> (= temp_17_1~3384@ (Mul (Mul (Mul a17~138@ (Mul a17~138@ (Mul d17~144@ b17~140@))) a17~138@) (Mul (Mul b17~140@ 93) d17~144@))) (=> (= tmp%35@ (Mul d17~144@ b17~140@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a17~138@ a17~138@ tmp%35@) (=> (= tmp%36@ (Mul a17~138@ (Mul a17~138@ (Mul d17~144@ b17~140@)))) (=> (= tmp%37@ (Mul (Mul b17~140@ 93) d17~144@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ a17~138@ tmp%37@) (=> (= tmp%38@ (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@))) (=> (= tmp%39@ (Mul (Mul b17~140@ 93) d17~144@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ a17~138@ tmp%39@) (=> %%location_label%%17 (= temp_17_0~3339@ temp_17_1~3384@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
