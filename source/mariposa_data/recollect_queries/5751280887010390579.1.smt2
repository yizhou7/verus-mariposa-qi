...
(declare-const temp_2_0~719@ Int)
(declare-const temp_2_1~780@ Int)
(declare-const temp_3_0~865@ Int)
...
(declare-const temp_6_0~1377@ Int)
(declare-const temp_6_1~1442@ Int)
(declare-const temp_7_0~1665@ Int)
(declare-const temp_7_1~1730@ Int)
(declare-const temp_8_0~1967@ Int)
(declare-const temp_8_1~2044@ Int)
(declare-const temp_9_0~2151@ Int)
(declare-const temp_9_1~2224@ Int)
(declare-const temp_10_0~2321@ Int)
(declare-const temp_10_1~2390@ Int)
(declare-const temp_11_0~2509@ Int)
(declare-const temp_11_1~2574@ Int)
(declare-const temp_12_0~2671@ Int)
(declare-const temp_12_1~2732@ Int)
(declare-const temp_13_0~2808@ Int)
(declare-const temp_13_1~2869@ Int)
(declare-const temp_14_0~3006@ Int)
(declare-const temp_14_1~3071@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Add a0~2@ 36)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Add (Add c0~6@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Add a0~2@ 36)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@)) (Add (Add c0~6@ c0~6@) (Mul c0~6@ d0~8@))))) (and (=> (= tmp%1@ (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@))) (=> (= tmp%2@ (Add (Add c0~6@ c0~6@) (Mul c0~6@ d0~8@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~511@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Add (Mul c1~14@ b1~12@) (Sub a1~10@ b1~12@))) (Mul (Sub (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@)) (Add (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~576@ (Mul (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Add (Mul c1~14@ b1~12@) (Sub a1~10@ b1~12@))) (Sub (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@))) (Add (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@)))) (and (=> (= tmp%3@ (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Add (Mul c1~14@ b1~12@) (Sub a1~10@ b1~12@)))) (=> (= tmp%4@ (Sub (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@))) (=> (= tmp%5@ (Add (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~511@ temp_1_1~576@)))))) (=> (= temp_1_0~511@ temp_1_1~576@) (=> (= temp_2_0~719@ (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ a2~18@)) (Add (Mul d2~24@ c2~22@) (Mul a2~18@ b2~20@))) (Mul (Add (Mul a2~18@ d2~24@) (Add b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) d2~24@)))) (=> (= temp_2_1~780@ (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ b2~20@)) (Add (Mul d2~24@ c2~22@) (Mul a2~18@ b2~20@))) (Mul (Add (Mul a2~18@ d2~24@) (Add b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) d2~24@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ b2~20@) (=> %%location_label%%2 (= temp_2_0~719@ temp_2_1~780@))) (=> (= temp_2_0~719@ temp_2_1~780@) (=> (= temp_3_0~865@ (Add (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@))) (Mul (Add (Mul b3~28@ d3~32@) c3~30@) (Mul (Mul c3~30@ d3~32@) a3~26@)))) (=> (= temp_3_1~922@ (Add (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Add (Mul b3~28@ d3~32@) c3~30@) (Mul (Mul c3~30@ d3~32@) a3~26@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ b3~28@) (=> %%location_label%%3 (= temp_3_0~865@ temp_3_1~922@))) (=> (= temp_3_0~865@ temp_3_1~922@) (=> (= temp_4_0~1011@ (Mul (Sub (Mul a4~34@ (Mul a4~34@ d4~40@)) (Mul (Mul a4~34@ d4~40@) (Sub b4~36@ a4~34@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ c4~38@)) (Sub (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~1088@ (Mul (Sub (Mul a4~34@ (Mul a4~34@ d4~40@)) (Mul (Mul a4~34@ d4~40@) (Sub b4~36@ a4~34@))) (Sub (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ c4~38@)) (Mul c4~38@ d4~40@)) (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ c4~38@)) (Mul b4~36@ c4~38@))))) (and (=> (= tmp%6@ (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ c4~38@))) (=> (= tmp%7@ (Mul c4~38@ d4~40@)) (=> (= tmp%8@ (Mul b4~36@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~1011@ temp_4_1~1088@)))))) (=> (= temp_4_0~1011@ temp_4_1~1088@) (=> (= temp_5_0~1207@ (Mul (Add (Mul (Mul d5~48@ a5~42@) (Add c5~46@ b5~44@)) (Mul (Mul a5~42@ d5~48@) d5~48@)) (Mul (Mul (Sub 60 c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ b5~44@) b5~44@)))) (=> (= temp_5_1~1276@ (Mul (Add (Mul (Add c5~46@ b5~44@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ d5~48@) d5~48@)) (Mul (Mul (Sub 60 c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ b5~44@) b5~44@)))) (and (=> (= tmp%9@ (Add c5~46@ b5~44@)) (=> (= tmp%10@ (Mul d5~48@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%5 (= temp_5_0~1207@ temp_5_1~1276@))))) (=> (= temp_5_0~1207@ temp_5_1~1276@) (=> (= temp_6_0~1377@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@))) (Sub (Mul (Mul a6~50@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1442@ (Mul (Mul (Mul (Mul (Mul b6~52@ a6~50@) a6~50@) a6~50@) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@))) (Sub (Mul (Mul a6~50@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@))))) (and (=> (= tmp%11@ (Mul (Mul (Mul b6~52@ a6~50@) a6~50@) a6~50@)) (=> (= tmp%12@ (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@))) (=> (= tmp%13@ (Sub (Mul (Mul a6~50@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> (= tmp%14@ (Mul b6~52@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ a6~50@ a6~50@) (=> (= tmp%15@ (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ a6~50@))) (=> (= tmp%16@ (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@))) (=> (= tmp%17@ (Sub (Mul (Mul a6~50@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%6 (= temp_6_0~1377@ temp_6_1~1442@)))))))))))) (=> (= temp_6_0~1377@ temp_6_1~1442@) (=> (= temp_7_0~1665@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@)) (Sub (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@))) (Mul (Mul (Sub b7~60@ b7~60@) (Mul d7~64@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1730@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@)) (Sub (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@))) (Mul (Mul (Sub b7~60@ b7~60@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ d7~64@))))) (and (=> (= tmp%18@ (Mul c7~62@ a7~58@)) (=> (= tmp%19@ (Mul a7~58@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> (= tmp%20@ (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@)) (Sub (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@)))) (=> (= tmp%21@ (Mul (Sub b7~60@ b7~60@) (Mul d7~64@ b7~60@))) (=> (= tmp%22@ (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> (= tmp%23@ (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@)) (Sub (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@)))) (=> (= tmp%24@ (Mul (Sub b7~60@ b7~60@) (Mul d7~64@ b7~60@))) (=> (= tmp%25@ (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ a7~58@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> %%location_label%%7 (= temp_7_0~1665@ temp_7_1~1730@))))))))))))) (=> (= temp_7_0~1665@ temp_7_1~1730@) (=> (= temp_8_0~1967@ (Mul (Add (Add (Mul b8~68@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Sub b8~68@ b8~68@))) (Add (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ 73)) 28))) (=> (= temp_8_1~2044@ (Mul (Add (Add (Mul b8~68@ d8~72@) (Mul b8~68@ c8~70@)) (Mul c8~70@ (Mul c8~70@ (Sub b8~68@ b8~68@)))) (Add (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ 73)) 28))) (and (=> (= tmp%26@ (Sub b8~68@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c8~70@ c8~70@ tmp%26@) (=> %%location_label%%8 (= temp_8_0~1967@ temp_8_1~2044@)))) (=> (= temp_8_0~1967@ temp_8_1~2044@) (=> (= temp_9_0~2151@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ c9~78@)) 30) (Mul (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ d9~80@) 46)))) (=> (= temp_9_1~2224@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ c9~78@)) 30) (Mul (Mul (Mul b9~76@ d9~80@) (Mul c9~78@ d9~80@)) (Mul (Mul d9~80@ d9~80@) 46)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ c9~78@) (=> %%location_label%%9 (= temp_9_0~2151@ temp_9_1~2224@))) (=> (= temp_9_0~2151@ temp_9_1~2224@) (=> (= temp_10_0~2321@ (Mul (Mul (Sub (Mul c10~86@ b10~84@) (Mul d10~88@ b10~84@)) (Mul d10~88@ d10~88@)) (Mul (Mul (Mul b10~84@ a10~82@) (Add d10~88@ c10~86@)) (Sub (Mul d10~88@ a10~82@) (Mul c10~86@ 18))))) (=> (= temp_10_1~2390@ (Mul (Mul (Sub (Mul c10~86@ b10~84@) (Mul d10~88@ b10~84@)) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ a10~82@) (Mul (Add d10~88@ c10~86@) (Sub (Mul d10~88@ a10~82@) (Mul c10~86@ 18)))))) (and (=> (= tmp%27@ (Mul b10~84@ a10~82@)) (=> (= tmp%28@ (Add d10~88@ c10~86@)) (=> (= tmp%29@ (Sub (Mul d10~88@ a10~82@) (Mul c10~86@ 18))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> %%location_label%%10 (= temp_10_0~2321@ temp_10_1~2390@)))))) (=> (= temp_10_0~2321@ temp_10_1~2390@) (=> (= temp_11_0~2509@ (Mul (Mul (Add (Mul d11~96@ c11~94@) (Mul c11~94@ a11~90@)) (Add (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@))) (Sub (Mul (Sub c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2574@ (Mul (Mul (Add (Mul d11~96@ c11~94@) (Mul c11~94@ a11~90@)) (Add (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@))) (Sub (Mul (Sub c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Mul b11~92@ c11~94@) (Mul d11~96@ a11~90@))))) (and (=> (= tmp%30@ (Mul b11~92@ c11~94@)) (=> (= tmp%31@ (Mul d11~96@ a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%30@ tmp%31@) (=> %%location_label%%11 (= temp_11_0~2509@ temp_11_1~2574@))))) (=> (= temp_11_0~2509@ temp_11_1~2574@) (=> (= temp_12_0~2671@ (Mul (Mul (Mul (Add d12~104@ c12~102@) (Mul a12~98@ a12~98@)) (Mul (Add d12~104@ b12~100@) d12~104@)) (Add (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@)) (Add (Mul c12~102@ b12~100@) (Mul a12~98@ a12~98@))))) (=> (= temp_12_1~2732@ (Mul (Mul (Mul (Add d12~104@ c12~102@) (Mul a12~98@ a12~98@)) (Mul (Add d12~104@ b12~100@) d12~104@)) (Add (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@)) (Add (Mul c12~102@ b12~100@) (Mul a12~98@ a12~98@))))) (=> (= tmp%32@ (= temp_12_0~2671@ temp_12_1~2732@)) (and (=> %%location_label%%12 tmp%32@) (=> tmp%32@ (=> (= temp_13_0~2808@ (Mul (Mul (Mul (Add b13~108@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ c13~110@))) (Mul a13~106@ (Add (Mul a13~106@ 9) b13~108@)))) (=> (= temp_13_1~2869@ (Mul (Mul a13~106@ (Add (Mul a13~106@ 9) b13~108@)) (Mul (Mul (Add b13~108@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ c13~110@))))) (and (=> (= tmp%33@ (Mul a13~106@ (Add (Mul a13~106@ 9) b13~108@))) (=> (= tmp%34@ (Mul (Mul (Add b13~108@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ c13~110@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%33@ tmp%34@) (=> %%location_label%%13 (= temp_13_0~2808@ temp_13_1~2869@))))) (=> (= temp_13_0~2808@ temp_13_1~2869@) (=> (= temp_14_0~3006@ (Mul (Mul (Mul (Mul a14~114@ b14~116@) (Add c14~118@ c14~118@)) (Mul (Mul d14~120@ c14~118@) (Mul b14~116@ c14~118@))) (Add (Mul (Sub c14~118@ b14~116@) (Mul a14~114@ d14~120@)) (Mul (Add c14~118@ d14~120@) (Mul c14~118@ a14~114@))))) (=> (= temp_14_1~3071@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Add c14~118@ c14~118@)) (Mul (Mul d14~120@ c14~118@) (Mul b14~116@ c14~118@))) (Add (Mul (Sub c14~118@ b14~116@) (Mul a14~114@ d14~120@)) (Mul (Add c14~118@ d14~120@) (Mul c14~118@ a14~114@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b14~116@ a14~114@) (=> (= tmp%35@ (Mul (Mul b14~116@ a14~114@) (Add c14~118@ c14~118@))) (=> (= tmp%36@ (Mul (Mul d14~120@ c14~118@) (Mul b14~116@ c14~118@))) (=> (= tmp%37@ (Add (Mul (Sub c14~118@ b14~116@) (Mul a14~114@ d14~120@)) (Mul (Add c14~118@ d14~120@) (Mul c14~118@ a14~114@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ tmp%36@ tmp%37@) (=> (= tmp%38@ (Mul (Mul a14~114@ b14~116@) (Add c14~118@ c14~118@))) (=> (= tmp%39@ (Mul (Mul d14~120@ c14~118@) (Mul b14~116@ c14~118@))) (=> (= tmp%40@ (Add (Mul (Sub c14~118@ b14~116@) (Mul a14~114@ d14~120@)) (Mul (Add c14~118@ d14~120@) (Mul c14~118@ a14~114@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> %%location_label%%14 (= temp_14_0~3006@ temp_14_1~3071@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
