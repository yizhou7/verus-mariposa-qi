...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Add (Mul (Add d0~8@ a0~2@) (Mul a0~2@ b0~4@)) (Add (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul d0~8@ (Mul b0~4@ b0~4@)) (Mul (Sub a0~2@ d0~8@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Add (Mul (Add d0~8@ a0~2@) (Mul a0~2@ b0~4@)) (Add (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul (Sub a0~2@ d0~8@) (Mul c0~6@ c0~6@)) (Mul d0~8@ (Mul b0~4@ b0~4@))))) (and (=> (= tmp%1@ (Mul (Sub a0~2@ d0~8@) (Mul c0~6@ c0~6@))) (=> (= tmp%2@ (Mul d0~8@ (Mul b0~4@ b0~4@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~475@ (Add (Mul (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Add d1~16@ d1~16@) (Mul a1~10@ c1~14@))) (Mul (Mul (Sub d1~16@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~548@ (Add (Mul (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ b1~12@)) (Add (Mul d1~16@ (Mul a1~10@ c1~14@)) (Mul d1~16@ (Mul a1~10@ c1~14@)))) (Mul (Mul (Sub d1~16@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ d1~16@))))) (and (=> (= tmp%3@ (Mul a1~10@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d1~16@ d1~16@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~475@ temp_1_1~548@)))) (=> (= temp_1_0~475@ temp_1_1~548@) (=> (= temp_2_0~647@ (Mul (Add (Sub (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Add (Mul c2~22@ c2~22@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Sub d2~24@ c2~22@) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~712@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Sub d2~24@ c2~22@) (Mul c2~22@ a2~18@))) (Add (Sub (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Add (Mul c2~22@ c2~22@) (Mul d2~24@ a2~18@))))) (and (=> (= tmp%4@ (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Sub d2~24@ c2~22@) (Mul c2~22@ a2~18@)))) (=> (= tmp%5@ (Add (Sub (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Add (Mul c2~22@ c2~22@) (Mul d2~24@ a2~18@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~647@ temp_2_1~712@))))) (=> (= temp_2_0~647@ temp_2_1~712@) (=> (= temp_3_0~857@ (Mul (Mul (Mul b3~28@ (Mul a3~26@ c3~30@)) (Mul (Sub a3~26@ c3~30@) (Mul d3~32@ d3~32@))) (Mul (Sub (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~918@ (Mul (Mul (Mul b3~28@ (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Sub a3~26@ c3~30@))) (Mul (Sub (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ c3~30@))))) (and (=> (= tmp%6@ (Mul d3~32@ d3~32@)) (=> (= tmp%7@ (Sub a3~26@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~857@ temp_3_1~918@))))) (=> (= temp_3_0~857@ temp_3_1~918@) (=> (= temp_4_0~1015@ (Mul (Mul (Mul a4~34@ (Mul a4~34@ d4~40@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@))) (Sub (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Add b4~36@ d4~40@))))) (=> (= temp_4_1~1076@ (Mul (Mul (Mul a4~34@ (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@))) (Sub (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Add b4~36@ d4~40@))))) (and (=> (= tmp%8@ (Mul d4~40@ a4~34@)) (=> (= tmp%9@ (Mul b4~36@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%4 (= temp_4_0~1015@ temp_4_1~1076@))))) (=> (= temp_4_0~1015@ temp_4_1~1076@) (=> (= temp_5_0~1169@ (Add (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@)) (Add (Sub b5~44@ d5~48@) (Sub a5~42@ c5~46@))) (Sub (Add (Mul d5~48@ b5~44@) (Sub a5~42@ c5~46@)) (Mul a5~42@ c5~46@)))) (=> (= temp_5_1~1226@ (Add (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@)) (Add (Sub b5~44@ d5~48@) (Sub a5~42@ c5~46@))) (Sub (Add (Mul d5~48@ b5~44@) (Sub a5~42@ c5~46@)) (Mul c5~46@ a5~42@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1169@ temp_5_1~1226@))) (=> (= temp_5_0~1169@ temp_5_1~1226@) (=> (= temp_6_0~1319@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Add b6~52@ b6~52@))) (Mul (Mul (Add d6~56@ d6~56@) (Add d6~56@ a6~50@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1384@ (Mul (Mul (Mul (Add d6~56@ d6~56@) (Add d6~56@ a6~50@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Add b6~52@ b6~52@))))) (and (=> (= tmp%10@ (Mul (Mul (Add d6~56@ d6~56@) (Add d6~56@ a6~50@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ b6~52@)))) (=> (= tmp%11@ (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Add b6~52@ b6~52@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%6 (= temp_6_0~1319@ temp_6_1~1384@))))) (=> (= temp_6_0~1319@ temp_6_1~1384@) (=> (= temp_7_0~1533@ (Mul (Add (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Mul 24 b7~60@) (Mul b7~60@ c7~62@))) (Mul (Mul (Mul d7~64@ d7~64@) (Sub b7~60@ c7~62@)) c7~62@))) (=> (= temp_7_1~1598@ (Mul (Add (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul 24 b7~60@) (Mul b7~60@ c7~62@))) (Mul (Mul (Mul d7~64@ d7~64@) (Sub b7~60@ c7~62@)) c7~62@))) (and (=> (= tmp%12@ (Mul b7~60@ a7~58@)) (=> (= tmp%13@ (Mul b7~60@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%7 (= temp_7_0~1533@ temp_7_1~1598@))))) (=> (= temp_7_0~1533@ temp_7_1~1598@) (=> (= temp_8_0~1695@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Add b8~68@ a8~66@)) (Mul d8~72@ (Sub a8~66@ b8~68@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1760@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Add b8~68@ a8~66@)) (Sub (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d8~72@ a8~66@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1695@ temp_8_1~1760@))) (=> (= temp_8_0~1695@ temp_8_1~1760@) (=> (= temp_9_0~1851@ (Mul (Mul (Mul (Mul a9~74@ a9~74@) (Sub d9~80@ b9~76@)) (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ a9~74@))) (Add (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) b9~76@)))) (=> (= temp_9_1~1912@ (Mul (Mul (Mul a9~74@ a9~74@) (Sub d9~80@ b9~76@)) (Mul (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ a9~74@)) (Add (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) b9~76@))))) (and (=> (= tmp%14@ (Mul (Mul a9~74@ a9~74@) (Sub d9~80@ b9~76@))) (=> (= tmp%15@ (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ a9~74@))) (=> (= tmp%16@ (Add (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) b9~76@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%9 (= temp_9_0~1851@ temp_9_1~1912@)))))) (=> (= temp_9_0~1851@ temp_9_1~1912@) (=> (= temp_10_0~2043@ (Sub (Mul b10~84@ (Mul (Add b10~84@ a10~82@) (Mul a10~82@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ a10~82@)) (Sub (Mul a10~82@ b10~84@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~2096@ (Sub (Mul b10~84@ (Mul (Add b10~84@ a10~82@) (Mul a10~82@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ a10~82@)) (Sub (Mul a10~82@ b10~84@) (Mul d10~88@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d10~88@ c10~86@) (=> %%location_label%%10 (= temp_10_0~2043@ temp_10_1~2096@))) (=> (= temp_10_0~2043@ temp_10_1~2096@) (=> (= temp_11_0~2225@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ d11~96@)) (Mul (Mul d11~96@ 1) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul b11~92@ a11~90@) (Add 45 a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ 74))))) (=> (= temp_11_1~2326@ (Mul (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ d11~96@)) (Mul (Mul (Mul d11~96@ 1) (Mul c11~94@ d11~96@)) (Mul (Mul (Mul b11~92@ a11~90@) (Add 45 a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ 74)))))) (=> (= tmp%17@ (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ d11~96@))) (=> (= tmp%18@ (Mul (Mul d11~96@ 1) (Mul c11~94@ d11~96@))) (=> (= tmp%19@ (Mul (Mul (Mul b11~92@ a11~90@) (Add 45 a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ 74)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%11 (= temp_11_0~2225@ temp_11_1~2326@)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
