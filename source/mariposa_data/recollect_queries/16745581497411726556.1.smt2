...
(declare-const temp_3_1~1010@ Int)
(declare-const temp_4_0~1121@ Int)
(declare-const temp_4_1~1186@ Int)
(declare-const temp_5_0~1305@ Int)
(declare-const temp_5_1~1374@ Int)
(declare-const temp_6_0~1583@ Int)
(declare-const temp_6_1~1644@ Int)
(declare-const temp_7_0~1853@ Int)
(declare-const temp_7_1~1918@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Add (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul a0~2@ (Mul b0~4@ b0~4@))) (Mul (Mul (Sub d0~8@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Add (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul a0~2@ (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) (Sub d0~8@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ b0~4@))))) (and (=> (= tmp%1@ (Mul d0~8@ b0~4@)) (=> (= tmp%2@ (Sub d0~8@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~459@ (Mul (Mul (Sub (Mul d1~16@ a1~10@) a1~10@) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Sub b1~12@ d1~16@))))) (=> (= temp_1_1~536@ (Mul (Sub (Mul (Mul d1~16@ a1~10@) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ a1~10@))) (Mul a1~10@ (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ a1~10@)))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Sub b1~12@ d1~16@))))) (and (=> (= tmp%3@ (Mul d1~16@ a1~10@)) (=> (= tmp%4@ (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ a1~10@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~459@ temp_1_1~536@))))) (=> (= temp_1_0~459@ temp_1_1~536@) (=> (= temp_2_0~647@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@)) (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Sub d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~712@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Sub d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ a2~18@) (=> (= tmp%5@ (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@))) (=> (= tmp%6@ (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (=> (= tmp%7@ (Mul (Mul (Sub d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> (= tmp%8@ (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@))) (=> (= tmp%9@ (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (=> (= tmp%10@ (Mul (Mul (Sub d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%2 (= temp_2_0~647@ temp_2_1~712@))))))))))) (=> (= temp_2_0~647@ temp_2_1~712@) (=> (= temp_3_0~937@ (Mul (Mul (Sub (Sub b3~28@ c3~30@) c3~30@) (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ c3~30@)) (Add (Mul 15 c3~30@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~1010@ (Mul (Mul (Mul (Sub (Sub b3~28@ c3~30@) c3~30@) (Mul a3~26@ a3~26@)) (Mul b3~28@ c3~30@)) (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ c3~30@)) (Add (Mul 15 c3~30@) (Mul c3~30@ d3~32@))))) (and (=> (= tmp%11@ (Sub (Sub b3~28@ c3~30@) c3~30@)) (=> (= tmp%12@ (Mul a3~26@ a3~26@)) (=> (= tmp%13@ (Mul b3~28@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%3 (= temp_3_0~937@ temp_3_1~1010@)))))) (=> (= temp_3_0~937@ temp_3_1~1010@) (=> (= temp_4_0~1121@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Add d4~40@ c4~38@) (Sub b4~36@ c4~38@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@)) (Sub (Add b4~36@ b4~36@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~1186@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Add d4~40@ c4~38@) (Sub b4~36@ c4~38@))) (Mul (Mul d4~40@ a4~34@) (Mul (Mul b4~36@ a4~34@) (Sub (Add b4~36@ b4~36@) (Mul a4~34@ c4~38@)))))) (and (=> (= tmp%14@ (Mul d4~40@ a4~34@)) (=> (= tmp%15@ (Mul b4~36@ a4~34@)) (=> (= tmp%16@ (Sub (Add b4~36@ b4~36@) (Mul a4~34@ c4~38@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%4 (= temp_4_0~1121@ temp_4_1~1186@)))))) (=> (= temp_4_0~1121@ temp_4_1~1186@) (=> (= temp_5_0~1305@ (Mul (Sub (Sub (Mul a5~42@ b5~44@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul 82 b5~44@))) (Mul (Mul c5~46@ (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ d5~48@) a5~42@)))) (=> (= temp_5_1~1374@ (Mul (Sub (Sub (Mul a5~42@ b5~44@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul 82 b5~44@))) (Mul (Mul c5~46@ (Mul a5~42@ c5~46@)) (Mul a5~42@ (Mul b5~44@ d5~48@))))) (and (=> (= tmp%17@ (Mul b5~44@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ tmp%17@) (=> (= tmp%18@ (Sub (Sub (Mul a5~42@ b5~44@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul 82 b5~44@)))) (=> (= tmp%19@ (Mul c5~46@ (Mul a5~42@ c5~46@))) (=> (= tmp%20@ (Mul a5~42@ (Mul b5~44@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> (= tmp%21@ (Sub (Sub (Mul a5~42@ b5~44@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul 82 b5~44@)))) (=> (= tmp%22@ (Mul c5~46@ (Mul a5~42@ c5~46@))) (=> (= tmp%23@ (Mul (Mul b5~44@ d5~48@) a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%5 (= temp_5_0~1305@ temp_5_1~1374@)))))))))))) (=> (= temp_5_0~1305@ temp_5_1~1374@) (=> (= temp_6_0~1583@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Add b6~52@ c6~54@)) (Mul a6~50@ (Mul c6~54@ b6~52@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Add b6~52@ b6~52@))))) (=> (= temp_6_1~1644@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Add b6~52@ c6~54@)) (Mul a6~50@ (Mul c6~54@ b6~52@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Add b6~52@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ d6~56@) (=> (= tmp%24@ (Mul (Mul a6~50@ d6~56@) (Add b6~52@ c6~54@))) (=> (= tmp%25@ (Mul a6~50@ (Mul c6~54@ b6~52@))) (=> (= tmp%26@ (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Add b6~52@ b6~52@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> (= tmp%27@ (Mul (Mul d6~56@ a6~50@) (Add b6~52@ c6~54@))) (=> (= tmp%28@ (Mul a6~50@ (Mul c6~54@ b6~52@))) (=> (= tmp%29@ (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Add b6~52@ b6~52@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> %%location_label%%6 (= temp_6_0~1583@ temp_6_1~1644@))))))))))) (=> (= temp_6_0~1583@ temp_6_1~1644@) (=> (= temp_7_0~1853@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ a7~58@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1918@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ a7~58@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))))) (=> (= tmp%30@ (Mul d7~64@ a7~58@)) (=> (= tmp%31@ (Mul a7~58@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%30@ tmp%31@) (=> %%location_label%%7 (= temp_7_0~1853@ temp_7_1~1918@))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
