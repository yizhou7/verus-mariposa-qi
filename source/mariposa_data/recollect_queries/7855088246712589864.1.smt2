...
(declare-const temp_2_0~592@ Int)
(declare-const temp_2_1~669@ Int)
(declare-const temp_3_0~782@ Int)
(declare-const temp_3_1~859@ Int)
(declare-const temp_4_0~1080@ Int)
...
(declare-const temp_6_1~1543@ Int)
(declare-const temp_7_0~1772@ Int)
(declare-const temp_7_1~1837@ Int)
(declare-const temp_8_0~1938@ Int)
(declare-const temp_8_1~2003@ Int)
(declare-const temp_9_0~2102@ Int)
(declare-const temp_9_1~2167@ Int)
(declare-const temp_10_0~2268@ Int)
(declare-const temp_10_1~2333@ Int)
(declare-const temp_11_0~2450@ Int)
(declare-const temp_11_1~2531@ Int)
(declare-const temp_12_0~2642@ Int)
(declare-const temp_12_1~2703@ Int)
(declare-const temp_13_0~2776@ Int)
(declare-const temp_13_1~2813@ Int)
(declare-const temp_14_0~2922@ Int)
(declare-const temp_14_1~2975@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul c0~6@ (Mul (Mul (Mul a0~2@ d0~8@) b0~4@) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~306@ (Mul c0~6@ (Mul (Mul (Mul a0~2@ d0~8@) b0~4@) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ d0~8@) (=> (= tmp%1@ (Mul (Mul a0~2@ d0~8@) b0~4@)) (=> (= tmp%2@ (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. c0~6@ tmp%1@ tmp%2@) (=> (= tmp%3@ (Mul (Mul a0~2@ d0~8@) b0~4@)) (=> (= tmp%4@ (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ b0~4@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. c0~6@ tmp%3@ tmp%4@) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~306@))))))))) (=> (= temp_0_0~273@ temp_0_1~306@) (=> (= temp_1_0~447@ (Mul (Mul (Mul c1~14@ (Mul c1~14@ b1~12@)) (Sub (Mul c1~14@ b1~12@) (Add b1~12@ c1~14@))) (Mul (Mul c1~14@ c1~14@) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@))))) (=> (= temp_1_1~500@ (Mul (Mul (Mul c1~14@ (Mul c1~14@ b1~12@)) (Sub (Mul c1~14@ b1~12@) (Add b1~12@ c1~14@))) (Mul (Mul c1~14@ c1~14@) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@))))) (=> (= tmp%5@ (= temp_1_0~447@ temp_1_1~500@)) (and (=> %%location_label%%1 tmp%5@) (=> tmp%5@ (=> (= temp_2_0~592@ (Mul (Mul (Add (Sub c2~22@ 8) (Mul a2~18@ b2~20@)) (Mul (Add a2~18@ c2~22@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@))))) (=> (= temp_2_1~669@ (Mul (Mul (Add (Sub c2~22@ 8) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Add a2~18@ c2~22@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@))))) (and (=> (= tmp%6@ (Mul d2~24@ d2~24@)) (=> (= tmp%7@ (Add a2~18@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~592@ temp_2_1~669@))))) (=> (= temp_2_0~592@ temp_2_1~669@) (=> (= temp_3_0~782@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Sub a3~26@ c3~30@) (Mul b3~28@ a3~26@))) (Add (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Mul 27 a3~26@) (Add b3~28@ d3~32@))))) (=> (= temp_3_1~859@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ a3~26@)) (Mul (Sub a3~26@ c3~30@) (Mul b3~28@ a3~26@))) (Add (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Mul 27 a3~26@) (Add b3~28@ d3~32@))))) (and (=> (= tmp%8@ (Mul b3~28@ b3~28@)) (=> (= tmp%9@ (Mul d3~32@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> (= tmp%10@ (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ a3~26@))) (=> (= tmp%11@ (Mul (Sub a3~26@ c3~30@) (Mul b3~28@ a3~26@))) (=> (= tmp%12@ (Add (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Mul 27 a3~26@) (Add b3~28@ d3~32@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> (= tmp%13@ (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@))) (=> (= tmp%14@ (Mul (Sub a3~26@ c3~30@) (Mul b3~28@ a3~26@))) (=> (= tmp%15@ (Add (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Mul 27 a3~26@) (Add b3~28@ d3~32@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%3 (= temp_3_0~782@ temp_3_1~859@))))))))))))) (=> (= temp_3_0~782@ temp_3_1~859@) (=> (= temp_4_0~1080@ (Sub (Mul (Mul (Sub b4~36@ a4~34@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@))) (Mul b4~36@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~1133@ (Sub (Mul (Mul (Sub b4~36@ a4~34@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@))) (Mul (Mul b4~36@ (Mul a4~34@ d4~40@)) (Mul a4~34@ d4~40@)))) (and (=> (= tmp%16@ (Mul a4~34@ d4~40@)) (=> (= tmp%17@ (Mul a4~34@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b4~36@ tmp%16@ tmp%17@) (=> %%location_label%%4 (= temp_4_0~1080@ temp_4_1~1133@))))) (=> (= temp_4_0~1080@ temp_4_1~1133@) (=> (= temp_5_0~1220@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Add d5~48@ b5~44@))) (Mul b5~44@ (Sub (Mul c5~46@ d5~48@) a5~42@)))) (=> (= temp_5_1~1269@ (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Add d5~48@ b5~44@))) (Mul b5~44@ (Sub (Mul c5~46@ d5~48@) a5~42@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ a5~42@) (=> (= tmp%18@ (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ a5~42@))) (=> (= tmp%19@ (Mul (Mul b5~44@ a5~42@) (Add d5~48@ b5~44@))) (=> (= tmp%20@ (Mul b5~44@ (Sub (Mul c5~46@ d5~48@) a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> (= tmp%21@ (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@))) (=> (= tmp%22@ (Mul (Mul b5~44@ a5~42@) (Add d5~48@ b5~44@))) (=> (= tmp%23@ (Mul b5~44@ (Sub (Mul c5~46@ d5~48@) a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%5 (= temp_5_0~1220@ temp_5_1~1269@))))))))))) (=> (= temp_5_0~1220@ temp_5_1~1269@) (=> (= temp_6_0~1466@ (Mul (Mul (Sub (Mul d6~56@ d6~56@) (Mul 3 d6~56@)) (Sub (Mul b6~52@ c6~54@) (Add d6~56@ b6~52@))) (Sub (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1543@ (Mul (Mul (Sub (Mul d6~56@ d6~56@) (Mul d6~56@ 3)) (Sub (Mul b6~52@ c6~54@) (Add d6~56@ b6~52@))) (Sub (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ 3) (=> (= tmp%24@ (Sub (Mul d6~56@ d6~56@) (Mul d6~56@ 3))) (=> (= tmp%25@ (Sub (Mul b6~52@ c6~54@) (Add d6~56@ b6~52@))) (=> (= tmp%26@ (Sub (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> (= tmp%27@ (Sub (Mul d6~56@ d6~56@) (Mul 3 d6~56@))) (=> (= tmp%28@ (Sub (Mul b6~52@ c6~54@) (Add d6~56@ b6~52@))) (=> (= tmp%29@ (Sub (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> %%location_label%%6 (= temp_6_0~1466@ temp_6_1~1543@))))))))))) (=> (= temp_6_0~1466@ temp_6_1~1543@) (=> (= temp_7_0~1772@ (Mul (Mul (Add (Mul c7~62@ a7~58@) (Sub b7~60@ c7~62@)) b7~60@) (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ 21) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1837@ (Mul (Mul (Add (Mul c7~62@ a7~58@) (Sub b7~60@ c7~62@)) b7~60@) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ d7~64@)) (Mul (Mul d7~64@ 21) (Mul d7~64@ a7~58@))))) (and (=> (= tmp%30@ (Mul b7~60@ b7~60@)) (=> (= tmp%31@ (Mul b7~60@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%30@ tmp%31@) (=> %%location_label%%7 (= temp_7_0~1772@ temp_7_1~1837@))))) (=> (= temp_7_0~1772@ temp_7_1~1837@) (=> (= temp_8_0~1938@ (Mul (Sub (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ a8~66@))) (Add (Mul (Mul a8~66@ c8~70@) (Add a8~66@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~2003@ (Mul (Sub (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ a8~66@))) (Add (Mul (Mul a8~66@ c8~70@) (Add a8~66@ d8~72@)) (Mul (Mul (Mul a8~66@ b8~68@) a8~66@) c8~70@)))) (and (=> (= tmp%32@ (Mul a8~66@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ a8~66@ c8~70@) (=> %%location_label%%8 (= temp_8_0~1938@ temp_8_1~2003@)))) (=> (= temp_8_0~1938@ temp_8_1~2003@) (=> (= temp_9_0~2102@ (Mul (Mul (Add (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Sub a9~74@ c9~78@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~2167@ (Mul (Mul (Add (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@)) (Mul (Sub a9~74@ c9~78@) (Mul d9~80@ b9~76@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul d9~80@ c9~78@))))) (and (=> (= tmp%33@ (Sub a9~74@ c9~78@)) (=> (= tmp%34@ (Mul d9~80@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%33@ tmp%34@) (=> %%location_label%%9 (= temp_9_0~2102@ temp_9_1~2167@))))) (=> (= temp_9_0~2102@ temp_9_1~2167@) (=> (= temp_10_0~2268@ (Add (Mul (Mul (Add a10~82@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Add d10~88@ b10~84@) (Add d10~88@ a10~82@))) (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~2333@ (Add (Mul (Mul (Add d10~88@ b10~84@) (Add d10~88@ a10~82@)) (Mul (Add a10~82@ a10~82@) (Mul d10~88@ b10~84@))) (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ c10~86@))))) (and (=> (= tmp%35@ (Mul (Add d10~88@ b10~84@) (Add d10~88@ a10~82@))) (=> (= tmp%36@ (Mul (Add a10~82@ a10~82@) (Mul d10~88@ b10~84@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%35@ tmp%36@) (=> %%location_label%%10 (= temp_10_0~2268@ temp_10_1~2333@))))) (=> (= temp_10_0~2268@ temp_10_1~2333@) (=> (= temp_11_0~2450@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ b11~92@))) (Mul (Add (Mul b11~92@ a11~90@) (Mul b11~92@ c11~94@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2531@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ b11~92@))) (Add (Mul (Mul b11~92@ a11~90@) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@))) (Mul (Mul b11~92@ c11~94@) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@)))))) (and (=> (= tmp%37@ (Mul b11~92@ a11~90@)) (=> (= tmp%38@ (Mul b11~92@ c11~94@)) (=> (= tmp%39@ (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%37@ tmp%38@ tmp%39@) (=> %%location_label%%11 (= temp_11_0~2450@ temp_11_1~2531@)))))) (=> (= temp_11_0~2450@ temp_11_1~2531@) (=> (= temp_12_0~2642@ (Sub (Mul (Mul (Mul d12~104@ a12~98@) (Add d12~104@ a12~98@)) (Mul (Mul d12~104@ b12~100@) (Mul c12~102@ d12~104@))) (Mul (Mul b12~100@ (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ a12~98@) (Add a12~98@ c12~102@))))) (=> (= temp_12_1~2703@ (Sub (Mul (Mul (Mul d12~104@ a12~98@) (Add d12~104@ a12~98@)) (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ b12~100@))) (Mul (Mul b12~100@ (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ a12~98@) (Add a12~98@ c12~102@))))) (and (=> (= tmp%40@ (Mul c12~102@ d12~104@)) (=> (= tmp%41@ (Mul d12~104@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%40@ tmp%41@) (=> %%location_label%%12 (= temp_12_0~2642@ temp_12_1~2703@))))) (=> (= temp_12_0~2642@ temp_12_1~2703@) (=> (= temp_13_0~2776@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ d13~112@))) c13~110@)) (=> (= temp_13_1~2813@ (Mul c13~110@ (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ d13~112@))))) (and (=> (= tmp%42@ (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ d13~112@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c13~110@ tmp%42@) (=> %%location_label%%13 (= temp_13_0~2776@ temp_13_1~2813@)))) (=> (= temp_13_0~2776@ temp_13_1~2813@) (=> (= temp_14_0~2922@ (Mul (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ d14~120@)) a14~114@) (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ c14~118@)) (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ d14~120@))))) (=> (= temp_14_1~2975@ (Mul (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ d14~120@)) a14~114@) (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ c14~118@)) (Mul (Mul (Mul d14~120@ d14~120@) b14~116@) d14~120@)))) (=> (= tmp%43@ (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ d14~120@)) a14~114@)) (=> (= tmp%44@ (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ c14~118@))) (=> (= tmp%45@ (Mul (Mul (Mul d14~120@ d14~120@) b14~116@) d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%43@ tmp%44@ tmp%45@) (=> (= tmp%46@ (Mul d14~120@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%46@ b14~116@ d14~120@) (=> (= tmp%47@ (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ d14~120@)) a14~114@)) (=> (= tmp%48@ (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ c14~118@))) (=> (= tmp%49@ (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ d14~120@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%47@ tmp%48@ tmp%49@) (=> %%location_label%%14 (= temp_14_0~2922@ temp_14_1~2975@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
