...
(declare-const temp_5_0~1275@ Int)
(declare-const temp_5_1~1364@ Int)
(declare-const temp_6_0~1495@ Int)
(declare-const temp_6_1~1572@ Int)
(declare-const temp_7_0~1795@ Int)
(declare-const temp_7_1~1852@ Int)
(declare-const temp_8_0~2071@ Int)
(declare-const temp_8_1~2148@ Int)
(declare-const temp_9_0~2251@ Int)
(declare-const temp_9_1~2344@ Int)
(declare-const temp_10_0~2459@ Int)
(declare-const temp_10_1~2524@ Int)
(declare-const temp_11_0~2623@ Int)
(declare-const temp_11_1~2688@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Add (Mul a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Sub b0~4@ d0~8@) b0~4@)) (Mul (Mul (Add a0~2@ b0~4@) (Mul d0~8@ d0~8@)) (Sub (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~378@ (Mul (Mul (Add (Mul a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Sub b0~4@ d0~8@) b0~4@)) (Sub (Mul (Mul (Add a0~2@ b0~4@) (Mul d0~8@ d0~8@)) (Mul d0~8@ b0~4@)) (Mul (Mul (Add a0~2@ b0~4@) (Mul d0~8@ d0~8@)) (Mul b0~4@ c0~6@))))) (and (=> (= tmp%1@ (Mul (Add a0~2@ b0~4@) (Mul d0~8@ d0~8@))) (=> (= tmp%2@ (Mul d0~8@ b0~4@)) (=> (= tmp%3@ (Mul b0~4@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~378@)))))) (=> (= temp_0_0~301@ temp_0_1~378@) (=> (= temp_1_0~493@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@)) b1~12@) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ 18) (Sub b1~12@ a1~10@))))) (=> (= temp_1_1~558@ (Mul (Mul (Mul a1~10@ a1~10@) (Mul (Mul a1~10@ d1~16@) b1~12@)) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ 18) (Sub b1~12@ a1~10@))))) (and (=> (= tmp%4@ (Mul a1~10@ a1~10@)) (=> (= tmp%5@ (Mul a1~10@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ b1~12@) (=> %%location_label%%1 (= temp_1_0~493@ temp_1_1~558@))))) (=> (= temp_1_0~493@ temp_1_1~558@) (=> (= temp_2_0~657@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Sub c2~22@ c2~22@) (Add c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ b2~20@)) (Mul a2~18@ (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~718@ (Mul (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@)) (Sub c2~22@ c2~22@)) (Add c2~22@ b2~20@)) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ b2~20@)) (Mul a2~18@ (Mul b2~20@ c2~22@))))) (and (=> (= tmp%6@ (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@))) (=> (= tmp%7@ (Sub c2~22@ c2~22@)) (=> (= tmp%8@ (Add c2~22@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%2 (= temp_2_0~657@ temp_2_1~718@)))))) (=> (= temp_2_0~657@ temp_2_1~718@) (=> (= temp_3_0~825@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@)) (Mul a3~26@ (Mul b3~28@ c3~30@))) (Mul (Mul (Mul b3~28@ a3~26@) (Add d3~32@ c3~30@)) (Mul d3~32@ (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~882@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@)) (Mul a3~26@ (Mul b3~28@ c3~30@))) (Mul (Mul (Mul b3~28@ a3~26@) (Add d3~32@ c3~30@)) (Mul (Mul d3~32@ b3~28@) c3~30@)))) (and (=> (= tmp%9@ (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@)) (Mul a3~26@ (Mul b3~28@ c3~30@)))) (=> (= tmp%10@ (Mul (Mul b3~28@ a3~26@) (Add d3~32@ c3~30@))) (=> (= tmp%11@ (Mul (Mul d3~32@ b3~28@) c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> (ens%main!nl_basics.lemma_mul_is_associative. d3~32@ b3~28@ c3~30@) (=> (= tmp%12@ (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@)) (Mul a3~26@ (Mul b3~28@ c3~30@)))) (=> (= tmp%13@ (Mul (Mul b3~28@ a3~26@) (Add d3~32@ c3~30@))) (=> (= tmp%14@ (Mul d3~32@ (Mul b3~28@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%3 (= temp_3_0~825@ temp_3_1~882@))))))))))) (=> (= temp_3_0~825@ temp_3_1~882@) (=> (= temp_4_0~1085@ (Sub (Add (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@))) (Sub (Sub (Mul a4~34@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Add d4~40@ a4~34@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~1150@ (Sub (Add (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@))) (Sub (Sub (Mul a4~34@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Add d4~40@ a4~34@))))) (and (=> (= tmp%15@ (Mul d4~40@ c4~38@)) (=> (= tmp%16@ (Add d4~40@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%4 (= temp_4_0~1085@ temp_4_1~1150@))))) (=> (= temp_4_0~1085@ temp_4_1~1150@) (=> (= temp_5_0~1275@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ b5~44@)) (Sub (Mul b5~44@ d5~48@) (Add 80 a5~42@))) (Mul (Mul (Mul 72 c5~46@) (Mul b5~44@ d5~48@)) (Mul (Add d5~48@ b5~44@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1364@ (Mul (Mul (Mul b5~44@ c5~46@) (Mul (Mul d5~48@ b5~44@) (Sub (Mul b5~44@ d5~48@) (Add 80 a5~42@)))) (Mul (Mul (Mul 72 c5~46@) (Mul b5~44@ d5~48@)) (Mul (Add d5~48@ b5~44@) (Mul d5~48@ c5~46@))))) (and (=> (= tmp%17@ (Mul b5~44@ c5~46@)) (=> (= tmp%18@ (Mul d5~48@ b5~44@)) (=> (= tmp%19@ (Sub (Mul b5~44@ d5~48@) (Add 80 a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%5 (= temp_5_0~1275@ temp_5_1~1364@)))))) (=> (= temp_5_0~1275@ temp_5_1~1364@) (=> (= temp_6_0~1495@ (Mul (Mul (Mul (Add d6~56@ b6~52@) (Mul 16 c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1572@ (Mul (Mul (Mul (Add d6~56@ b6~52@) (Mul 16 c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul (Mul b6~52@ c6~54@) a6~50@) b6~52@)))) (and (=> (= tmp%20@ (Mul (Mul (Add d6~56@ b6~52@) (Mul 16 c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ d6~56@)))) (=> (= tmp%21@ (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ c6~54@))) (=> (= tmp%22@ (Mul (Mul (Mul b6~52@ c6~54@) a6~50@) b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> (= tmp%23@ (Mul b6~52@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ a6~50@ b6~52@) (=> (= tmp%24@ (Mul (Mul (Add d6~56@ b6~52@) (Mul 16 c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ d6~56@)))) (=> (= tmp%25@ (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ c6~54@))) (=> (= tmp%26@ (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%6 (= temp_6_0~1495@ temp_6_1~1572@)))))))))))) (=> (= temp_6_0~1495@ temp_6_1~1572@) (=> (= temp_7_0~1795@ (Mul (Mul (Mul (Sub c7~62@ d7~64@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ d7~64@) b7~60@)) (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Add a7~58@ d7~64@) c7~62@)))) (=> (= temp_7_1~1852@ (Mul (Mul (Mul (Mul (Sub c7~62@ d7~64@) b7~60@) d7~64@) (Mul (Mul b7~60@ d7~64@) b7~60@)) (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Add a7~58@ d7~64@) c7~62@)))) (and (=> (= tmp%27@ (Mul (Mul (Sub c7~62@ d7~64@) b7~60@) d7~64@)) (=> (= tmp%28@ (Mul (Mul b7~60@ d7~64@) b7~60@)) (=> (= tmp%29@ (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Add a7~58@ d7~64@) c7~62@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> (= tmp%30@ (Sub c7~62@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%30@ b7~60@ d7~64@) (=> (= tmp%31@ (Mul (Sub c7~62@ d7~64@) (Mul b7~60@ d7~64@))) (=> (= tmp%32@ (Mul (Mul b7~60@ d7~64@) b7~60@)) (=> (= tmp%33@ (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Add a7~58@ d7~64@) c7~62@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> %%location_label%%7 (= temp_7_0~1795@ temp_7_1~1852@)))))))))))) (=> (= temp_7_0~1795@ temp_7_1~1852@) (=> (= temp_8_0~2071@ (Mul (Add (Mul (Add a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ a8~66@) (Add a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ c8~70@) (Add b8~68@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul 37 b8~68@))))) (=> (= temp_8_1~2148@ (Mul (Add (Mul (Mul (Add a8~66@ a8~66@) b8~68@) b8~68@) (Mul (Mul c8~70@ a8~66@) (Add a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ c8~70@) (Add b8~68@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul 37 b8~68@))))) (and (=> (= tmp%34@ (Add a8~66@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ b8~68@ b8~68@) (=> %%location_label%%8 (= temp_8_0~2071@ temp_8_1~2148@)))) (=> (= temp_8_0~2071@ temp_8_1~2148@) (=> (= temp_9_0~2251@ (Mul (Mul (Add (Mul b9~76@ a9~74@) (Mul b9~76@ d9~80@)) (Mul c9~78@ (Mul d9~80@ c9~78@))) (Mul (Sub (Mul b9~76@ a9~74@) (Mul b9~76@ d9~80@)) (Mul (Mul d9~80@ d9~80@) 17)))) (=> (= temp_9_1~2344@ (Mul (Mul (Add (Mul b9~76@ a9~74@) (Mul b9~76@ d9~80@)) (Mul c9~78@ (Mul d9~80@ c9~78@))) (Sub (Mul (Mul b9~76@ a9~74@) (Mul (Mul d9~80@ d9~80@) 17)) (Mul (Mul b9~76@ d9~80@) (Mul (Mul d9~80@ d9~80@) 17))))) (and (=> (= tmp%35@ (Mul b9~76@ a9~74@)) (=> (= tmp%36@ (Mul b9~76@ d9~80@)) (=> (= tmp%37@ (Mul (Mul d9~80@ d9~80@) 17)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%35@ tmp%36@ tmp%37@) (=> %%location_label%%9 (= temp_9_0~2251@ temp_9_1~2344@)))))) (=> (= temp_9_0~2251@ temp_9_1~2344@) (=> (= temp_10_0~2459@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ d10~88@))) (Add (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ c10~86@)) (Mul (Sub a10~82@ c10~86@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~2524@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ a10~82@)) (Mul c10~86@ (Mul a10~82@ (Mul c10~86@ d10~88@)))) (Add (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ c10~86@)) (Mul (Sub a10~82@ c10~86@) (Mul b10~84@ d10~88@))))) (and (=> (= tmp%38@ (Mul c10~86@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c10~86@ a10~82@ tmp%38@) (=> %%location_label%%10 (= temp_10_0~2459@ temp_10_1~2524@)))) (=> (= temp_10_0~2459@ temp_10_1~2524@) (=> (= temp_11_0~2623@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ b11~92@)) (Add (Mul b11~92@ a11~90@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2688@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul (Mul d11~96@ c11~94@) d11~96@) b11~92@) (Add (Mul b11~92@ a11~90@) (Mul b11~92@ a11~90@))))) (=> (= tmp%39@ (Mul d11~96@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%39@ d11~96@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2623@ temp_11_1~2688@)))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
