...
(declare-const temp_2_0~668@ Int)
(declare-const temp_2_1~733@ Int)
(declare-const temp_3_0~898@ Int)
(declare-const temp_3_1~991@ Int)
(declare-const temp_4_0~1098@ Int)
(declare-const temp_4_1~1151@ Int)
(declare-const temp_5_0~1246@ Int)
(declare-const temp_5_1~1307@ Int)
(declare-const temp_6_0~1430@ Int)
(declare-const temp_6_1~1503@ Int)
(declare-const temp_7_0~1598@ Int)
(declare-const temp_7_1~1663@ Int)
(declare-const temp_8_0~1726@ Int)
(declare-const temp_8_1~1759@ Int)
...
(declare-const temp_12_0~2405@ Int)
(declare-const temp_12_1~2478@ Int)
(declare-const temp_13_0~2693@ Int)
(declare-const temp_13_1~2754@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Add (Add (Mul b0~4@ b0~4@) (Sub b0~4@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~370@ (Sub (Add (Add (Mul b0~4@ b0~4@) (Sub b0~4@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~450@ (Sub (Mul (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Add d1~16@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub a1~10@ a1~10@)) (Mul (Sub c1~14@ c1~14@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~515@ (Sub (Mul (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Add d1~16@ a1~10@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub a1~10@ a1~10@)) (Mul (Sub c1~14@ c1~14@) (Mul d1~16@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ c1~14@) (=> (= tmp%2@ (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (=> (= tmp%3@ (Add d1~16@ a1~10@)) (=> (= tmp%4@ (Mul a1~10@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> (= tmp%5@ (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (=> (= tmp%6@ (Add d1~16@ a1~10@)) (=> (= tmp%7@ (Mul c1~14@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%1 (= temp_1_0~450@ temp_1_1~515@))))))))))) (=> (= temp_1_0~450@ temp_1_1~515@) (=> (= temp_2_0~668@ (Sub (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul c2~22@ b2~20@) (Sub a2~18@ d2~24@)) (Add (Mul a2~18@ b2~20@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~733@ (Sub (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul c2~22@ b2~20@) (Sub a2~18@ d2~24@)) (Add (Mul a2~18@ b2~20@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ d2~24@) (=> (= tmp%8@ (Mul c2~22@ d2~24@)) (=> (= tmp%9@ (Mul b2~20@ a2~18@)) (=> (= tmp%10@ (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ a2~18@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> (= tmp%11@ (Mul d2~24@ c2~22@)) (=> (= tmp%12@ (Mul b2~20@ a2~18@)) (=> (= tmp%13@ (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ a2~18@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%2 (= temp_2_0~668@ temp_2_1~733@))))))))))) (=> (= temp_2_0~668@ temp_2_1~733@) (=> (= temp_3_0~898@ (Sub (Mul (Add (Mul 72 d3~32@) (Sub a3~26@ c3~30@)) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@))) (Mul c3~30@ (Mul (Mul d3~32@ d3~32@) (Sub 39 c3~30@))))) (=> (= temp_3_1~991@ (Sub (Add (Mul (Mul 72 d3~32@) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@))) (Mul (Sub a3~26@ c3~30@) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@)))) (Mul c3~30@ (Mul (Mul d3~32@ d3~32@) (Sub 39 c3~30@))))) (and (=> (= tmp%14@ (Mul 72 d3~32@)) (=> (= tmp%15@ (Sub a3~26@ c3~30@)) (=> (= tmp%16@ (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%3 (= temp_3_0~898@ temp_3_1~991@)))))) (=> (= temp_3_0~898@ temp_3_1~991@) (=> (= temp_4_0~1098@ (Sub (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@)) c4~38@) (Mul (Mul (Mul b4~36@ a4~34@) (Add a4~34@ b4~36@)) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@))))) (=> (= temp_4_1~1151@ (Sub (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@)) c4~38@) (Mul (Mul b4~36@ (Mul a4~34@ (Add a4~34@ b4~36@))) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@))))) (and (=> (= tmp%17@ (Add a4~34@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b4~36@ a4~34@ tmp%17@) (=> %%location_label%%4 (= temp_4_0~1098@ temp_4_1~1151@)))) (=> (= temp_4_0~1098@ temp_4_1~1151@) (=> (= temp_5_0~1246@ (Mul (Mul (Mul (Sub d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Add (Mul c5~46@ c5~46@) (Mul d5~48@ a5~42@))) (Mul (Sub d5~48@ (Mul c5~46@ c5~46@)) (Mul (Sub a5~42@ a5~42@) (Mul d5~48@ b5~44@))))) (=> (= temp_5_1~1307@ (Mul (Mul (Sub d5~48@ c5~46@) (Mul (Mul a5~42@ d5~48@) (Add (Mul c5~46@ c5~46@) (Mul d5~48@ a5~42@)))) (Mul (Sub d5~48@ (Mul c5~46@ c5~46@)) (Mul (Sub a5~42@ a5~42@) (Mul d5~48@ b5~44@))))) (and (=> (= tmp%18@ (Sub d5~48@ c5~46@)) (=> (= tmp%19@ (Mul a5~42@ d5~48@)) (=> (= tmp%20@ (Add (Mul c5~46@ c5~46@) (Mul d5~48@ a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%5 (= temp_5_0~1246@ temp_5_1~1307@)))))) (=> (= temp_5_0~1246@ temp_5_1~1307@) (=> (= temp_6_0~1430@ (Mul (Mul (Mul (Sub b6~52@ b6~52@) (Mul d6~56@ a6~50@)) (Add d6~56@ (Mul 19 c6~54@))) (Add (Sub (Mul a6~50@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@ a6~50@) (Sub c6~54@ b6~52@))))) (=> (= temp_6_1~1503@ (Mul (Mul (Mul (Sub b6~52@ b6~52@) (Mul d6~56@ a6~50@)) (Add d6~56@ (Mul 19 c6~54@))) (Add (Sub (Mul a6~50@ d6~56@) (Mul c6~54@ a6~50@)) (Mul c6~54@ (Mul a6~50@ (Sub c6~54@ b6~52@)))))) (and (=> (= tmp%21@ (Sub c6~54@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c6~54@ a6~50@ tmp%21@) (=> %%location_label%%6 (= temp_6_0~1430@ temp_6_1~1503@)))) (=> (= temp_6_0~1430@ temp_6_1~1503@) (=> (= temp_7_0~1598@ (Add (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ c7~62@)) (Mul (Add a7~58@ a7~58@) d7~64@)) (Sub (Mul (Sub a7~58@ c7~62@) (Mul b7~60@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1663@ (Add (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ c7~62@)) (Add (Mul a7~58@ d7~64@) (Mul a7~58@ d7~64@))) (Sub (Mul (Sub a7~58@ c7~62@) (Mul b7~60@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. a7~58@ a7~58@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1598@ temp_7_1~1663@))) (=> (= temp_7_0~1598@ temp_7_1~1663@) (=> (= temp_8_0~1726@ (Add (Mul b8~68@ (Mul b8~68@ a8~66@)) (Mul (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ c8~70@)) b8~68@))) (=> (= temp_8_1~1759@ (Add (Mul b8~68@ (Mul a8~66@ b8~68@)) (Mul (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ c8~70@)) b8~68@))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b8~68@ a8~66@ b8~68@) (=> (= tmp%22@ (Mul b8~68@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ tmp%22@) (=> %%location_label%%8 (= temp_8_0~1726@ temp_8_1~1759@))))) (=> (= temp_8_0~1726@ temp_8_1~1759@) (=> (= temp_9_0~1866@ (Sub (Add (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@)) (Sub (Add d9~80@ d9~80@) (Mul b9~76@ b9~76@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ d9~80@)) (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1931@ (Sub (Add (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@)) (Sub (Add d9~80@ d9~80@) (Mul b9~76@ b9~76@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ d9~80@)) (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ a9~74@))))) (=> (= tmp%23@ (= temp_9_0~1866@ temp_9_1~1931@)) (and (=> %%location_label%%9 tmp%23@) (=> tmp%23@ (=> (= temp_10_0~1979@ (Mul c10~86@ (Add (Mul d10~88@ (Mul d10~88@ c10~86@)) (Mul (Add c10~86@ b10~84@) (Sub b10~84@ c10~86@))))) (=> (= temp_10_1~2016@ (Add (Mul c10~86@ (Mul d10~88@ (Mul d10~88@ c10~86@))) (Mul c10~86@ (Mul (Add c10~86@ b10~84@) (Sub b10~84@ c10~86@))))) (and (=> (= tmp%24@ (Mul d10~88@ (Mul d10~88@ c10~86@))) (=> (= tmp%25@ (Mul (Add c10~86@ b10~84@) (Sub b10~84@ c10~86@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c10~86@ tmp%24@ tmp%25@) (=> %%location_label%%10 (= temp_10_0~1979@ temp_10_1~2016@))))) (=> (= temp_10_0~1979@ temp_10_1~2016@) (=> (= temp_11_0~2127@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul c11~94@ a11~90@)) (Mul a11~90@ (Mul c11~94@ c11~94@))) (Mul (Mul (Sub c11~94@ c11~94@) (Mul c11~94@ c11~94@)) (Add (Mul b11~92@ d11~96@) (Mul c11~94@ d11~96@))))) (=> (= temp_11_1~2188@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ c11~94@)) (Mul a11~90@ (Mul c11~94@ c11~94@))) (Mul (Mul (Sub c11~94@ c11~94@) (Mul c11~94@ c11~94@)) (Add (Mul b11~92@ d11~96@) (Mul c11~94@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a11~90@ c11~94@) (=> (= tmp%26@ (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ c11~94@))) (=> (= tmp%27@ (Mul a11~90@ (Mul c11~94@ c11~94@))) (=> (= tmp%28@ (Mul (Mul (Sub c11~94@ c11~94@) (Mul c11~94@ c11~94@)) (Add (Mul b11~92@ d11~96@) (Mul c11~94@ d11~96@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> (= tmp%29@ (Mul (Mul a11~90@ a11~90@) (Mul c11~94@ a11~90@))) (=> (= tmp%30@ (Mul a11~90@ (Mul c11~94@ c11~94@))) (=> (= tmp%31@ (Mul (Mul (Sub c11~94@ c11~94@) (Mul c11~94@ c11~94@)) (Add (Mul b11~92@ d11~96@) (Mul c11~94@ d11~96@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> %%location_label%%11 (= temp_11_0~2127@ temp_11_1~2188@))))))))))) (=> (= temp_11_0~2127@ temp_11_1~2188@) (=> (= temp_12_0~2405@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul 91 b12~100@))) (Mul (Mul (Mul b12~100@ b12~100@) (Sub c12~102@ c12~102@)) (Mul d12~104@ (Mul a12~98@ a12~98@))))) (=> (= temp_12_1~2478@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul 91 b12~100@))) (Mul (Mul (Mul b12~100@ b12~100@) (Sub c12~102@ c12~102@)) (Mul (Mul d12~104@ a12~98@) a12~98@)))) (and (=> (= tmp%32@ (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul 91 b12~100@)))) (=> (= tmp%33@ (Mul (Mul b12~100@ b12~100@) (Sub c12~102@ c12~102@))) (=> (= tmp%34@ (Mul (Mul d12~104@ a12~98@) a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> (ens%main!nl_basics.lemma_mul_is_associative. d12~104@ a12~98@ a12~98@) (=> (= tmp%35@ (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul 91 b12~100@)))) (=> (= tmp%36@ (Mul (Mul b12~100@ b12~100@) (Sub c12~102@ c12~102@))) (=> (= tmp%37@ (Mul d12~104@ (Mul a12~98@ a12~98@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ tmp%36@ tmp%37@) (=> %%location_label%%12 (= temp_12_0~2405@ temp_12_1~2478@))))))))))) (=> (= temp_12_0~2405@ temp_12_1~2478@) (=> (= temp_13_0~2693@ (Mul (Mul (Mul (Add b13~108@ b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Sub b13~108@ c13~110@))) (Mul (Add (Mul b13~108@ b13~108@) (Mul d13~112@ b13~108@)) (Mul (Mul a13~106@ d13~112@) d13~112@)))) (=> (= temp_13_1~2754@ (Mul (Mul (Add b13~108@ b13~108@) (Mul (Mul b13~108@ d13~112@) (Mul (Mul c13~110@ c13~110@) (Sub b13~108@ c13~110@)))) (Mul (Add (Mul b13~108@ b13~108@) (Mul d13~112@ b13~108@)) (Mul (Mul a13~106@ d13~112@) d13~112@)))) (=> (= tmp%38@ (Add b13~108@ b13~108@)) (=> (= tmp%39@ (Mul b13~108@ d13~112@)) (=> (= tmp%40@ (Mul (Mul c13~110@ c13~110@) (Sub b13~108@ c13~110@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> %%location_label%%13 (= temp_13_0~2693@ temp_13_1~2754@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
