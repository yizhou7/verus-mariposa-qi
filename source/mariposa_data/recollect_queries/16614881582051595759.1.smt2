...
(declare-const temp_4_0~1020@ Int)
(declare-const temp_4_1~1097@ Int)
(declare-const temp_5_0~1244@ Int)
(declare-const temp_5_1~1305@ Int)
(declare-const temp_6_0~1426@ Int)
(declare-const temp_6_1~1499@ Int)
(declare-const temp_7_0~1576@ Int)
(declare-const temp_7_1~1617@ Int)
(declare-const temp_8_0~1710@ Int)
(declare-const temp_8_1~1791@ Int)
(declare-const temp_9_0~1902@ Int)
(declare-const temp_9_1~1963@ Int)
(declare-const temp_10_0~2039@ Int)
(declare-const temp_10_1~2100@ Int)
(declare-const temp_11_0~2183@ Int)
...
(declare-const temp_13_1~2512@ Int)
(declare-const temp_14_0~2609@ Int)
(declare-const temp_14_1~2678@ Int)
(declare-const temp_15_0~2789@ Int)
(declare-const temp_15_1~2866@ Int)
(declare-const temp_16_0~2967@ Int)
(declare-const temp_16_1~3040@ Int)
(declare-const temp_17_0~3175@ Int)
(declare-const temp_17_1~3228@ Int)
(declare-const temp_18_0~3365@ Int)
(declare-const temp_18_1~3430@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul c0~6@ (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ c0~6@))) (Mul (Add (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~362@ (Mul (Mul c0~6@ (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ c0~6@))) (Add (Mul (Mul b0~4@ c0~6@) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul a0~2@ b0~4@) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@)))))) (and (=> (= tmp%1@ (Mul b0~4@ c0~6@)) (=> (= tmp%2@ (Mul a0~2@ b0~4@)) (=> (= tmp%3@ (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~362@)))))) (=> (= temp_0_0~293@ temp_0_1~362@) (=> (= temp_1_0~449@ (Mul b1~12@ (Mul (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ d1~16@)) (Mul (Mul d1~16@ a1~10@) (Add a1~10@ c1~14@))))) (=> (= temp_1_1~486@ (Mul b1~12@ (Mul (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ d1~16@)) (Mul d1~16@ (Mul a1~10@ (Add a1~10@ c1~14@)))))) (and (=> (= tmp%4@ (Add a1~10@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d1~16@ a1~10@ tmp%4@) (=> (= tmp%5@ (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ d1~16@))) (=> (= tmp%6@ (Mul d1~16@ (Mul a1~10@ (Add a1~10@ c1~14@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. b1~12@ tmp%5@ tmp%6@) (=> (= tmp%7@ (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ d1~16@))) (=> (= tmp%8@ (Mul (Mul d1~16@ a1~10@) (Add a1~10@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. b1~12@ tmp%7@ tmp%8@) (=> %%location_label%%1 (= temp_1_0~449@ temp_1_1~486@)))))))))) (=> (= temp_1_0~449@ temp_1_1~486@) (=> (= temp_2_0~653@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Sub d2~24@ c2~22@) (Mul a2~18@ a2~18@))))) (=> (= temp_2_1~718@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Sub d2~24@ c2~22@) (Mul a2~18@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ a2~18@) (=> (= tmp%9@ (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ c2~22@))) (=> (= tmp%10@ (Mul b2~20@ a2~18@)) (=> (= tmp%11@ (Mul a2~18@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> (= tmp%12@ (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ c2~22@))) (=> (= tmp%13@ (Mul b2~20@ a2~18@)) (=> (= tmp%14@ (Mul b2~20@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%2 (= temp_2_0~653@ temp_2_1~718@))))))))))) (=> (= temp_2_0~653@ temp_2_1~718@) (=> (= temp_3_0~867@ (Add (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@)) (Sub d3~32@ (Mul c3~30@ c3~30@))) (Mul (Mul (Add b3~28@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ a3~26@))))) (=> (= temp_3_1~928@ (Add (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@)) (Sub d3~32@ (Mul c3~30@ c3~30@))) (Mul (Mul (Add b3~28@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ a3~26@))))) (=> (= tmp%15@ (= temp_3_0~867@ temp_3_1~928@)) (and (=> %%location_label%%3 tmp%15@) (=> tmp%15@ (=> (= temp_4_0~1020@ (Mul (Mul (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Add c4~38@ a4~34@) (Add c4~38@ a4~34@))) (Add (Mul (Mul b4~36@ 86) (Sub d4~40@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ d4~40@))))) (=> (= temp_4_1~1097@ (Mul (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul (Add c4~38@ a4~34@) (Add c4~38@ a4~34@)) (Add (Mul (Mul b4~36@ 86) (Sub d4~40@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ d4~40@)))))) (and (=> (= tmp%16@ (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ c4~38@))) (=> (= tmp%17@ (Mul (Add c4~38@ a4~34@) (Add c4~38@ a4~34@))) (=> (= tmp%18@ (Add (Mul (Mul b4~36@ 86) (Sub d4~40@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ d4~40@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%4 (= temp_4_0~1020@ temp_4_1~1097@)))))) (=> (= temp_4_0~1020@ temp_4_1~1097@) (=> (= temp_5_0~1244@ (Mul (Mul (Sub b5~44@ (Mul b5~44@ d5~48@)) (Mul (Sub b5~44@ b5~44@) (Mul c5~46@ d5~48@))) (Mul (Add (Mul c5~46@ d5~48@) (Mul a5~42@ c5~46@)) (Sub (Mul a5~42@ b5~44@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1305@ (Mul (Mul (Mul (Sub b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Sub b5~44@ (Mul b5~44@ d5~48@))) (Mul (Add (Mul c5~46@ d5~48@) (Mul a5~42@ c5~46@)) (Sub (Mul a5~42@ b5~44@) (Mul d5~48@ d5~48@))))) (and (=> (= tmp%19@ (Mul (Sub b5~44@ b5~44@) (Mul c5~46@ d5~48@))) (=> (= tmp%20@ (Sub b5~44@ (Mul b5~44@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%5 (= temp_5_0~1244@ temp_5_1~1305@))))) (=> (= temp_5_0~1244@ temp_5_1~1305@) (=> (= temp_6_0~1426@ (Sub (Sub (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@)) (Mul d6~56@ (Mul a6~50@ d6~56@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ 51))))) (=> (= temp_6_1~1499@ (Sub (Sub (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@)) (Mul d6~56@ (Mul a6~50@ d6~56@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ 51))))) (and (=> (= tmp%21@ (Mul a6~50@ d6~56@)) (=> (= tmp%22@ (Mul a6~50@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%6 (= temp_6_0~1426@ temp_6_1~1499@))))) (=> (= temp_6_0~1426@ temp_6_1~1499@) (=> (= temp_7_0~1576@ (Add (Sub d7~64@ (Add (Add a7~58@ c7~62@) (Mul d7~64@ b7~60@))) (Add c7~62@ (Add (Mul d7~64@ d7~64@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1617@ (Add (Sub d7~64@ (Add (Add a7~58@ c7~62@) (Mul d7~64@ b7~60@))) (Add c7~62@ (Add (Mul d7~64@ d7~64@) (Mul a7~58@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ c7~62@) (=> %%location_label%%7 (= temp_7_0~1576@ temp_7_1~1617@))) (=> (= temp_7_0~1576@ temp_7_1~1617@) (=> (= temp_8_0~1710@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@)) (Sub (Mul b8~68@ b8~68@) (Mul b8~68@ b8~68@))) (Mul (Sub (Mul d8~72@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@))))) (=> (= temp_8_1~1791@ (Mul (Sub (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@)) (Mul b8~68@ b8~68@)) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@)) (Mul b8~68@ b8~68@))) (Mul (Sub (Mul d8~72@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@))))) (and (=> (= tmp%23@ (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@))) (=> (= tmp%24@ (Mul b8~68@ b8~68@)) (=> (= tmp%25@ (Mul b8~68@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%23@ tmp%24@ tmp%25@) (=> %%location_label%%8 (= temp_8_0~1710@ temp_8_1~1791@)))))) (=> (= temp_8_0~1710@ temp_8_1~1791@) (=> (= temp_9_0~1902@ (Mul (Sub (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Sub d9~80@ b9~76@) (Mul d9~80@ d9~80@))) (Mul (Mul (Mul d9~80@ b9~76@) c9~78@) (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~1963@ (Mul (Sub (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Sub d9~80@ b9~76@) (Mul d9~80@ d9~80@))) (Mul (Mul (Mul d9~80@ b9~76@) c9~78@) (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ d9~80@))))) (=> (= tmp%26@ (= temp_9_0~1902@ temp_9_1~1963@)) (and (=> %%location_label%%9 tmp%26@) (=> tmp%26@ (=> (= temp_10_0~2039@ (Mul (Mul (Add (Mul a10~82@ c10~86@) (Add d10~88@ b10~84@)) (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul b10~84@ a10~82@) d10~88@) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~2100@ (Mul (Mul (Mul (Add (Mul a10~82@ c10~86@) (Add d10~88@ b10~84@)) (Mul c10~86@ b10~84@)) (Mul c10~86@ b10~84@)) (Mul (Mul (Mul b10~84@ a10~82@) d10~88@) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ b10~84@))))) (and (=> (= tmp%27@ (Add (Mul a10~82@ c10~86@) (Add d10~88@ b10~84@))) (=> (= tmp%28@ (Mul c10~86@ b10~84@)) (=> (= tmp%29@ (Mul c10~86@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> %%location_label%%10 (= temp_10_0~2039@ temp_10_1~2100@)))))) (=> (= temp_10_0~2039@ temp_10_1~2100@) (=> (= temp_11_0~2183@ (Mul (Mul (Mul (Add b11~92@ a11~90@) (Add c11~94@ a11~90@)) (Mul (Sub c11~94@ b11~92@) a11~90@)) c11~94@)) (=> (= temp_11_1~2220@ (Mul (Mul (Mul (Add b11~92@ a11~90@) (Add c11~94@ a11~90@)) (Sub (Mul c11~94@ a11~90@) (Mul b11~92@ a11~90@))) c11~94@)) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. c11~94@ b11~92@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2183@ temp_11_1~2220@))) (=> (= temp_11_0~2183@ temp_11_1~2220@) (=> (= temp_12_0~2303@ (Mul (Mul (Mul (Mul b12~100@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ b12~100@))) (Mul (Mul (Sub a12~98@ d12~104@) (Mul b12~100@ c12~102@)) b12~100@))) (=> (= temp_12_1~2356@ (Mul (Mul (Mul (Mul b12~100@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ b12~100@))) (Mul (Mul (Mul (Sub a12~98@ d12~104@) b12~100@) c12~102@) b12~100@))) (and (=> (= tmp%30@ (Sub a12~98@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%30@ b12~100@ c12~102@) (=> %%location_label%%12 (= temp_12_0~2303@ temp_12_1~2356@)))) (=> (= temp_12_0~2303@ temp_12_1~2356@) (=> (= temp_13_0~2451@ (Mul (Add (Sub (Mul c13~110@ a13~106@) (Sub d13~112@ c13~110@)) (Mul (Mul c13~110@ d13~112@) (Mul a13~106@ c13~110@))) (Mul (Mul a13~106@ (Mul b13~108@ b13~108@)) (Mul (Sub d13~112@ d13~112@) (Mul a13~106@ c13~110@))))) (=> (= temp_13_1~2512@ (Mul (Add (Sub (Mul c13~110@ a13~106@) (Sub d13~112@ c13~110@)) (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ a13~106@))) (Mul (Mul a13~106@ (Mul b13~108@ b13~108@)) (Mul (Sub d13~112@ d13~112@) (Mul a13~106@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c13~110@ a13~106@) (=> %%location_label%%13 (= temp_13_0~2451@ temp_13_1~2512@))) (=> (= temp_13_0~2451@ temp_13_1~2512@) (=> (= temp_14_0~2609@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) d14~120@) (Mul (Add 7 a14~114@) a14~114@)) (Mul (Mul (Mul a14~114@ a14~114@) (Add d14~120@ b14~116@)) (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2678@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) d14~120@) (Mul (Add 7 a14~114@) a14~114@)) (Mul (Mul a14~114@ (Mul a14~114@ (Add d14~120@ b14~116@))) (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ c14~118@))))) (and (=> (= tmp%31@ (Add d14~120@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a14~114@ a14~114@ tmp%31@) (=> %%location_label%%14 (= temp_14_0~2609@ temp_14_1~2678@)))) (=> (= temp_14_0~2609@ temp_14_1~2678@) (=> (= temp_15_0~2789@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul c15~126@ b15~124@)) (Add (Sub a15~122@ c15~126@) (Mul b15~124@ c15~126@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ d15~128@)) (Sub (Mul b15~124@ 30) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~2866@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul c15~126@ b15~124@)) (Add (Sub a15~122@ c15~126@) (Mul c15~126@ b15~124@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ d15~128@)) (Sub (Mul b15~124@ 30) (Mul d15~128@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c15~126@ b15~124@) (=> %%location_label%%15 (= temp_15_0~2789@ temp_15_1~2866@))) (=> (= temp_15_0~2789@ temp_15_1~2866@) (=> (= temp_16_0~2967@ (Mul (Sub (Mul b16~132@ (Mul d16~136@ a16~130@)) (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ a16~130@))) (Mul (Mul (Add c16~134@ c16~134@) (Mul b16~132@ 68)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@))))) (=> (= temp_16_1~3040@ (Mul (Mul (Sub (Mul b16~132@ (Mul d16~136@ a16~130@)) (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ a16~130@))) (Mul (Add c16~134@ c16~134@) (Mul b16~132@ 68))) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@)))) (and (=> (= tmp%32@ (Sub (Mul b16~132@ (Mul d16~136@ a16~130@)) (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ a16~130@)))) (=> (= tmp%33@ (Mul (Add c16~134@ c16~134@) (Mul b16~132@ 68))) (=> (= tmp%34@ (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%16 (= temp_16_0~2967@ temp_16_1~3040@)))))) (=> (= temp_16_0~2967@ temp_16_1~3040@) (=> (= temp_17_0~3175@ (Mul (Mul (Add (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)) (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ b17~140@))) (Sub (Mul (Sub a17~138@ d17~144@) (Mul d17~144@ a17~138@)) c17~142@))) (=> (= temp_17_1~3228@ (Mul (Sub (Mul (Sub a17~138@ d17~144@) (Mul d17~144@ a17~138@)) c17~142@) (Mul (Add (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)) (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ b17~140@))))) (and (=> (= tmp%35@ (Sub (Mul (Sub a17~138@ d17~144@) (Mul d17~144@ a17~138@)) c17~142@)) (=> (= tmp%36@ (Mul (Add (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)) (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ b17~140@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%35@ tmp%36@) (=> %%location_label%%17 (= temp_17_0~3175@ temp_17_1~3228@))))) (=> (= temp_17_0~3175@ temp_17_1~3228@) (=> (= temp_18_0~3365@ (Mul (Mul (Mul (Sub b18~148@ a18~146@) (Mul d18~152@ d18~152@)) (Sub (Mul c18~150@ a18~146@) (Mul a18~146@ c18~150@))) (Sub (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ a18~146@)) (Mul (Mul a18~146@ d18~152@) (Mul b18~148@ b18~148@))))) (=> (= temp_18_1~3430@ (Mul (Mul (Mul (Sub b18~148@ a18~146@) (Mul d18~152@ d18~152@)) (Sub (Mul c18~150@ a18~146@) (Mul a18~146@ c18~150@))) (Sub (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ a18~146@)) (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ d18~152@))))) (=> (= tmp%37@ (Mul b18~148@ b18~148@)) (=> (= tmp%38@ (Mul a18~146@ d18~152@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%37@ tmp%38@) (=> %%location_label%%18 (= temp_18_0~3365@ temp_18_1~3430@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
