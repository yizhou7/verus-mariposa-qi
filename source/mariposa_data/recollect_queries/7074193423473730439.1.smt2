...
(declare-const temp_5_0~1245@ Int)
(declare-const temp_5_1~1310@ Int)
(declare-const temp_6_0~1453@ Int)
(declare-const temp_6_1~1514@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Sub (Mul (Mul a0~2@ b0~4@) (Sub b0~4@ a0~2@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@))) (Mul (Mul (Mul b0~4@ d0~8@) c0~6@) (Mul (Mul c0~6@ c0~6@) (Add a0~2@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Sub (Mul (Mul a0~2@ b0~4@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@))) (Mul (Mul (Mul b0~4@ d0~8@) c0~6@) (Mul (Mul c0~6@ c0~6@) (Add a0~2@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ d0~8@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~467@ (Mul (Mul (Sub (Mul b1~12@ a1~10@) (Sub d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul 61 d1~16@)) (Sub (Mul a1~10@ c1~14@) (Add c1~14@ b1~12@))))) (=> (= temp_1_1~544@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ a1~10@)) (Sub (Mul b1~12@ a1~10@) (Sub d1~16@ d1~16@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul 61 d1~16@)) (Sub (Mul a1~10@ c1~14@) (Add c1~14@ b1~12@))))) (and (=> (= tmp%1@ (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ a1~10@))) (=> (= tmp%2@ (Sub (Mul b1~12@ a1~10@) (Sub d1~16@ d1~16@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~467@ temp_1_1~544@))))) (=> (= temp_1_0~467@ temp_1_1~544@) (=> (= temp_2_0~669@ (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ c2~22@) b2~20@)) (Sub (Mul (Sub 83 c2~22@) (Mul a2~18@ c2~22@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~742@ (Mul (Sub (Mul (Sub 83 c2~22@) (Mul a2~18@ c2~22@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ c2~22@) b2~20@)))) (and (=> (= tmp%3@ (Sub (Mul (Sub 83 c2~22@) (Mul a2~18@ c2~22@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@)))) (=> (= tmp%4@ (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ c2~22@) b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~669@ temp_2_1~742@))))) (=> (= temp_2_0~669@ temp_2_1~742@) (=> (= temp_3_0~887@ (Mul (Mul (Add c3~30@ (Mul b3~28@ b3~28@)) (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ d3~32@))) (Mul (Mul (Add d3~32@ a3~26@) (Sub b3~28@ d3~32@)) (Mul (Add a3~26@ a3~26@) (Mul a3~26@ b3~28@))))) (=> (= temp_3_1~948@ (Mul (Mul (Mul (Add d3~32@ a3~26@) (Sub b3~28@ d3~32@)) (Mul (Add a3~26@ a3~26@) (Mul a3~26@ b3~28@))) (Mul (Add c3~30@ (Mul b3~28@ b3~28@)) (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ d3~32@))))) (and (=> (= tmp%5@ (Mul (Mul (Add d3~32@ a3~26@) (Sub b3~28@ d3~32@)) (Mul (Add a3~26@ a3~26@) (Mul a3~26@ b3~28@)))) (=> (= tmp%6@ (Mul (Add c3~30@ (Mul b3~28@ b3~28@)) (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ d3~32@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~887@ temp_3_1~948@))))) (=> (= temp_3_0~887@ temp_3_1~948@) (=> (= temp_4_0~1089@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ c4~38@)) (Add (Sub d4~40@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul a4~34@ (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~1150@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ c4~38@)) (Add (Sub d4~40@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) a4~34@) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a4~34@ c4~38@ a4~34@) (=> %%location_label%%4 (= temp_4_0~1089@ temp_4_1~1150@))) (=> (= temp_4_0~1089@ temp_4_1~1150@) (=> (= temp_5_0~1245@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Mul (Sub d5~48@ a5~42@) (Mul b5~44@ b5~44@)) (Mul (Mul c5~46@ b5~44@) (Sub a5~42@ a5~42@))))) (=> (= temp_5_1~1310@ (Mul (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Sub d5~48@ a5~42@) (Mul b5~44@ b5~44@))) (Mul (Mul c5~46@ b5~44@) (Sub a5~42@ a5~42@)))) (and (=> (= tmp%7@ (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@)))) (=> (= tmp%8@ (Mul (Sub d5~48@ a5~42@) (Mul b5~44@ b5~44@))) (=> (= tmp%9@ (Mul (Mul c5~46@ b5~44@) (Sub a5~42@ a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%5 (= temp_5_0~1245@ temp_5_1~1310@)))))) (=> (= temp_5_0~1245@ temp_5_1~1310@) (=> (= temp_6_0~1453@ (Mul (Sub (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ c6~54@))) (Mul (Add (Sub d6~56@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul c6~54@ c6~54@) a6~50@)))) (=> (= temp_6_1~1514@ (Mul (Sub (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Add (Sub d6~56@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul c6~54@ c6~54@) a6~50@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1453@ temp_6_1~1514@))) (=> (= temp_6_0~1453@ temp_6_1~1514@) (=> (= temp_7_0~1603@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Add d7~64@ b7~60@)) (Mul (Mul b7~60@ d7~64@) (Mul d7~64@ c7~62@))) (Mul (Mul c7~62@ (Mul a7~58@ a7~58@)) (Add (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1664@ (Mul (Mul (Mul d7~64@ (Mul b7~60@ (Add d7~64@ b7~60@))) (Mul (Mul b7~60@ d7~64@) (Mul d7~64@ c7~62@))) (Mul (Mul c7~62@ (Mul a7~58@ a7~58@)) (Add (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@))))) (and (=> (= tmp%10@ (Add d7~64@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d7~64@ b7~60@ tmp%10@) (=> (= tmp%11@ (Mul d7~64@ (Mul b7~60@ (Add d7~64@ b7~60@)))) (=> (= tmp%12@ (Mul (Mul b7~60@ d7~64@) (Mul d7~64@ c7~62@))) (=> (= tmp%13@ (Mul (Mul c7~62@ (Mul a7~58@ a7~58@)) (Add (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> (= tmp%14@ (Mul (Mul d7~64@ b7~60@) (Add d7~64@ b7~60@))) (=> (= tmp%15@ (Mul (Mul b7~60@ d7~64@) (Mul d7~64@ c7~62@))) (=> (= tmp%16@ (Mul (Mul c7~62@ (Mul a7~58@ a7~58@)) (Add (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%7 (= temp_7_0~1603@ temp_7_1~1664@)))))))))))) (=> (= temp_7_0~1603@ temp_7_1~1664@) (=> (= temp_8_0~1875@ (Mul (Mul (Mul b8~68@ (Add b8~68@ a8~66@)) (Sub (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ b8~68@))))) (=> (= temp_8_1~1936@ (Mul (Mul (Sub (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@)) (Mul b8~68@ (Add b8~68@ a8~66@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ b8~68@))))) (=> (= tmp%17@ (Sub (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@))) (=> (= tmp%18@ (Mul b8~68@ (Add b8~68@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%8 (= temp_8_0~1875@ temp_8_1~1936@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
