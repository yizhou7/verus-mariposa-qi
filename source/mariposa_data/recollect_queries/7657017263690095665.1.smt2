...
(declare-const temp_3_1~1044@ Int)
(declare-const temp_4_0~1195@ Int)
(declare-const temp_4_1~1260@ Int)
(declare-const temp_5_0~1371@ Int)
(declare-const temp_5_1~1432@ Int)
(declare-const temp_6_0~1557@ Int)
(declare-const temp_6_1~1634@ Int)
...
(declare-const temp_9_0~2131@ Int)
(declare-const temp_9_1~2200@ Int)
(declare-const temp_10_0~2411@ Int)
(declare-const temp_10_1~2472@ Int)
(declare-const temp_11_0~2681@ Int)
(declare-const temp_11_1~2738@ Int)
(declare-const temp_12_0~2953@ Int)
(declare-const temp_12_1~3030@ Int)
(declare-const temp_13_0~3111@ Int)
(declare-const temp_13_1~3164@ Int)
(declare-const temp_14_0~3353@ Int)
(declare-const temp_14_1~3406@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Add a0~2@ b0~4@))) (Mul (Sub c0~6@ (Sub b0~4@ a0~2@)) d0~8@))) (=> (= temp_0_1~338@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Add a0~2@ b0~4@))) (Mul d0~8@ (Sub c0~6@ (Sub b0~4@ a0~2@))))) (and (=> (= tmp%1@ (Sub c0~6@ (Sub b0~4@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~338@)))) (=> (= temp_0_0~289@ temp_0_1~338@) (=> (= temp_1_0~463@ (Mul (Mul (Mul (Mul 42 b1~12@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Sub (Mul (Mul d1~16@ c1~14@) (Add d1~16@ b1~12@)) (Mul (Add b1~12@ d1~16@) (Mul 85 c1~14@))))) (=> (= temp_1_1~552@ (Mul (Mul (Mul (Mul 42 b1~12@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Sub (Mul (Mul d1~16@ c1~14@) (Add d1~16@ b1~12@)) (Mul (Mul 85 c1~14@) (Add b1~12@ d1~16@))))) (and (=> (= tmp%2@ (Mul 85 c1~14@)) (=> (= tmp%3@ (Add b1~12@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~463@ temp_1_1~552@))))) (=> (= temp_1_0~463@ temp_1_1~552@) (=> (= temp_2_0~657@ (Mul (Mul (Sub (Add d2~24@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Sub b2~20@ c2~22@) (Sub a2~18@ c2~22@))) (Sub (Mul (Mul a2~18@ a2~18@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~722@ (Mul (Mul (Sub (Add d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Sub b2~20@ c2~22@) (Sub a2~18@ c2~22@))) (Sub (Mul (Mul a2~18@ a2~18@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ b2~20@) (=> (= tmp%4@ (Sub (Add d2~24@ d2~24@) (Mul c2~22@ b2~20@))) (=> (= tmp%5@ (Mul (Sub b2~20@ c2~22@) (Sub a2~18@ c2~22@))) (=> (= tmp%6@ (Sub (Mul (Mul a2~18@ a2~18@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> (= tmp%7@ (Sub (Add d2~24@ d2~24@) (Mul b2~20@ c2~22@))) (=> (= tmp%8@ (Mul (Sub b2~20@ c2~22@) (Sub a2~18@ c2~22@))) (=> (= tmp%9@ (Sub (Mul (Mul a2~18@ a2~18@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%2 (= temp_2_0~657@ temp_2_1~722@))))))))))) (=> (= temp_2_0~657@ temp_2_1~722@) (=> (= temp_3_0~959@ (Mul (Mul (Add (Mul 3 d3~32@) (Mul a3~26@ c3~30@)) (Mul c3~30@ (Mul a3~26@ a3~26@))) (Add (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul 63 d3~32@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~1044@ (Mul (Add (Mul 3 d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ (Mul a3~26@ a3~26@)) (Add (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul 63 d3~32@) (Mul a3~26@ c3~30@)))))) (and (=> (= tmp%10@ (Add (Mul 3 d3~32@) (Mul a3~26@ c3~30@))) (=> (= tmp%11@ (Mul c3~30@ (Mul a3~26@ a3~26@))) (=> (= tmp%12@ (Add (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul 63 d3~32@) (Mul a3~26@ c3~30@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%3 (= temp_3_0~959@ temp_3_1~1044@)))))) (=> (= temp_3_0~959@ temp_3_1~1044@) (=> (= temp_4_0~1195@ (Sub (Mul (Add (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Add (Mul c4~38@ d4~40@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Add a4~34@ d4~40@))))) (=> (= temp_4_1~1260@ (Sub (Mul (Add (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Add (Mul c4~38@ d4~40@) (Mul a4~34@ b4~36@))) (Mul (Mul a4~34@ d4~40@) (Mul (Mul b4~36@ a4~34@) (Mul (Mul a4~34@ d4~40@) (Add a4~34@ d4~40@)))))) (and (=> (= tmp%13@ (Mul a4~34@ d4~40@)) (=> (= tmp%14@ (Mul b4~36@ a4~34@)) (=> (= tmp%15@ (Mul (Mul a4~34@ d4~40@) (Add a4~34@ d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%4 (= temp_4_0~1195@ temp_4_1~1260@)))))) (=> (= temp_4_0~1195@ temp_4_1~1260@) (=> (= temp_5_0~1371@ (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@)) (Mul (Mul a5~42@ b5~44@) d5~48@)))) (=> (= temp_5_1~1432@ (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul a5~42@ b5~44@) d5~48@) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@))))) (and (=> (= tmp%16@ (Mul (Mul a5~42@ b5~44@) d5~48@)) (=> (= tmp%17@ (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%5 (= temp_5_0~1371@ temp_5_1~1432@))))) (=> (= temp_5_0~1371@ temp_5_1~1432@) (=> (= temp_6_0~1557@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Add a6~50@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Sub 8 b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1634@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Add a6~50@ a6~50@)) (Mul d6~56@ (Mul b6~52@ (Sub 8 b6~52@)))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (and (=> (= tmp%18@ (Sub 8 b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d6~56@ b6~52@ tmp%18@) (=> %%location_label%%6 (= temp_6_0~1557@ temp_6_1~1634@)))) (=> (= temp_6_0~1557@ temp_6_1~1634@) (=> (= temp_7_0~1725@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ a7~58@))) (Mul d7~64@ (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1778@ (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@)) (Mul (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ a7~58@)) (Mul d7~64@ (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@)))))) (and (=> (= tmp%19@ (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@))) (=> (= tmp%20@ (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ a7~58@))) (=> (= tmp%21@ (Mul d7~64@ (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%7 (= temp_7_0~1725@ temp_7_1~1778@)))))) (=> (= temp_7_0~1725@ temp_7_1~1778@) (=> (= temp_8_0~1913@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@))) (Mul (Add (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1978@ (Mul (Mul (Add (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@))))) (and (=> (= tmp%22@ (Mul (Add (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@)))) (=> (= tmp%23@ (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%8 (= temp_8_0~1913@ temp_8_1~1978@))))) (=> (= temp_8_0~1913@ temp_8_1~1978@) (=> (= temp_9_0~2131@ (Mul (Mul (Mul (Add b9~76@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Sub b9~76@ b9~76@) b9~76@)) (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@)) (Mul a9~74@ (Mul 18 c9~78@))))) (=> (= temp_9_1~2200@ (Mul (Mul (Mul (Mul (Add b9~76@ c9~78@) c9~78@) b9~76@) (Mul (Sub b9~76@ b9~76@) b9~76@)) (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@)) (Mul a9~74@ (Mul 18 c9~78@))))) (and (=> (= tmp%24@ (Mul (Mul (Add b9~76@ c9~78@) c9~78@) b9~76@)) (=> (= tmp%25@ (Mul (Sub b9~76@ b9~76@) b9~76@)) (=> (= tmp%26@ (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@)) (Mul a9~74@ (Mul 18 c9~78@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> (= tmp%27@ (Add b9~76@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ c9~78@ b9~76@) (=> (= tmp%28@ (Mul (Add b9~76@ c9~78@) (Mul c9~78@ b9~76@))) (=> (= tmp%29@ (Mul (Sub b9~76@ b9~76@) b9~76@)) (=> (= tmp%30@ (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@)) (Mul a9~74@ (Mul 18 c9~78@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%9 (= temp_9_0~2131@ temp_9_1~2200@)))))))))))) (=> (= temp_9_0~2131@ temp_9_1~2200@) (=> (= temp_10_0~2411@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ a10~82@) c10~86@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@))))) (=> (= temp_10_1~2472@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ a10~82@) c10~86@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ c10~86@))))) (and (=> (= tmp%31@ (Mul d10~88@ b10~84@)) (=> (= tmp%32@ (Mul c10~86@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%31@ tmp%32@) (=> (= tmp%33@ (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ a10~82@) c10~86@))) (=> (= tmp%34@ (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@))) (=> (= tmp%35@ (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ c10~86@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ tmp%34@ tmp%35@) (=> (= tmp%36@ (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ a10~82@) c10~86@))) (=> (= tmp%37@ (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@))) (=> (= tmp%38@ (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ tmp%37@ tmp%38@) (=> %%location_label%%10 (= temp_10_0~2411@ temp_10_1~2472@))))))))))))) (=> (= temp_10_0~2411@ temp_10_1~2472@) (=> (= temp_11_0~2681@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) c11~94@) (Add (Mul d11~96@ c11~94@) (Mul c11~94@ b11~92@))) (Mul (Mul b11~92@ (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~2738@ (Mul (Mul (Mul a11~90@ (Mul a11~90@ c11~94@)) (Add (Mul d11~96@ c11~94@) (Mul c11~94@ b11~92@))) (Mul (Mul b11~92@ (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a11~90@ a11~90@ c11~94@) (=> (= tmp%39@ (Mul a11~90@ (Mul a11~90@ c11~94@))) (=> (= tmp%40@ (Add (Mul d11~96@ c11~94@) (Mul c11~94@ b11~92@))) (=> (= tmp%41@ (Mul (Mul b11~92@ (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ a11~90@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%39@ tmp%40@ tmp%41@) (=> (= tmp%42@ (Mul (Mul a11~90@ a11~90@) c11~94@)) (=> (= tmp%43@ (Add (Mul d11~96@ c11~94@) (Mul c11~94@ b11~92@))) (=> (= tmp%44@ (Mul (Mul b11~92@ (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ a11~90@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%42@ tmp%43@ tmp%44@) (=> %%location_label%%11 (= temp_11_0~2681@ temp_11_1~2738@))))))))))) (=> (= temp_11_0~2681@ temp_11_1~2738@) (=> (= temp_12_0~2953@ (Mul (Mul (Add (Add c12~102@ 77) (Mul a12~98@ d12~104@)) (Add (Add b12~100@ b12~100@) (Mul b12~100@ a12~98@))) (Mul (Add (Mul b12~100@ a12~98@) (Mul d12~104@ d12~104@)) (Mul (Add a12~98@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~3030@ (Mul (Mul (Add (Add c12~102@ 77) (Mul a12~98@ d12~104@)) (Add (Add b12~100@ b12~100@) (Mul b12~100@ a12~98@))) (Mul (Add (Mul a12~98@ b12~100@) (Mul d12~104@ d12~104@)) (Mul (Add a12~98@ a12~98@) (Mul c12~102@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2953@ temp_12_1~3030@))) (=> (= temp_12_0~2953@ temp_12_1~3030@) (=> (= temp_13_0~3111@ (Mul (Mul (Mul (Add a13~106@ a13~106@) (Mul a13~106@ c13~110@)) b13~108@) (Mul (Mul (Mul a13~106@ d13~112@) (Sub a13~106@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Add d13~112@ b13~108@))))) (=> (= temp_13_1~3164@ (Mul (Mul (Mul (Add a13~106@ a13~106@) (Mul a13~106@ c13~110@)) b13~108@) (Mul (Mul (Mul a13~106@ d13~112@) (Sub a13~106@ a13~106@)) (Mul (Add d13~112@ b13~108@) (Mul d13~112@ d13~112@))))) (and (=> (= tmp%45@ (Add d13~112@ b13~108@)) (=> (= tmp%46@ (Mul d13~112@ d13~112@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%45@ tmp%46@) (=> (= tmp%47@ (Mul (Mul (Add a13~106@ a13~106@) (Mul a13~106@ c13~110@)) b13~108@)) (=> (= tmp%48@ (Mul (Mul a13~106@ d13~112@) (Sub a13~106@ a13~106@))) (=> (= tmp%49@ (Mul (Add d13~112@ b13~108@) (Mul d13~112@ d13~112@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%47@ tmp%48@ tmp%49@) (=> (= tmp%50@ (Mul (Mul (Add a13~106@ a13~106@) (Mul a13~106@ c13~110@)) b13~108@)) (=> (= tmp%51@ (Mul (Mul a13~106@ d13~112@) (Sub a13~106@ a13~106@))) (=> (= tmp%52@ (Mul (Mul d13~112@ d13~112@) (Add d13~112@ b13~108@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%50@ tmp%51@ tmp%52@) (=> %%location_label%%13 (= temp_13_0~3111@ temp_13_1~3164@))))))))))))) (=> (= temp_13_0~3111@ temp_13_1~3164@) (=> (= temp_14_0~3353@ (Sub (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@)) (Mul (Sub b14~116@ d14~120@) (Mul d14~120@ c14~118@))) (Mul b14~116@ (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ a14~114@))))) (=> (= temp_14_1~3406@ (Sub (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@)) (Mul (Sub b14~116@ d14~120@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ a14~114@)) b14~116@))) (=> (= tmp%53@ (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ a14~114@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%53@ b14~116@) (=> %%location_label%%14 (= temp_14_0~3353@ temp_14_1~3406@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
