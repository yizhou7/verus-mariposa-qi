...
(declare-const temp_2_1~822@ Int)
(declare-const temp_3_0~965@ Int)
(declare-const temp_3_1~1026@ Int)
(declare-const temp_4_0~1227@ Int)
(declare-const temp_4_1~1276@ Int)
(declare-const temp_5_0~1371@ Int)
(declare-const temp_5_1~1432@ Int)
(declare-const temp_6_0~1657@ Int)
(declare-const temp_6_1~1730@ Int)
(declare-const temp_7_0~1810@ Int)
(declare-const temp_7_1~1875@ Int)
(declare-const temp_8_0~1980@ Int)
(declare-const temp_8_1~2057@ Int)
(declare-const temp_9_0~2140@ Int)
(declare-const temp_9_1~2189@ Int)
(declare-const temp_10_0~2282@ Int)
(declare-const temp_10_1~2343@ Int)
(declare-const temp_11_0~2431@ Int)
(declare-const temp_11_1~2504@ Int)
(declare-const temp_12_0~2709@ Int)
(declare-const temp_12_1~2762@ Int)
(declare-const temp_13_0~2867@ Int)
(declare-const temp_13_1~2932@ Int)
(declare-const temp_14_0~3033@ Int)
(declare-const temp_14_1~3098@ Int)
(declare-const temp_15_0~3235@ Int)
(declare-const temp_15_1~3284@ Int)
(declare-const temp_16_0~3353@ Int)
(declare-const temp_16_1~3386@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Add (Add (Sub (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@)) (Sub (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@))) (Mul (Sub (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@)) (Mul a0~2@ (Mul c0~6@ a0~2@))))) (=> (= temp_0_1~374@ (Add (Add (Sub (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@)) (Sub (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@))) (Sub (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ (Mul c0~6@ a0~2@))) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ (Mul c0~6@ a0~2@)))))) (and (=> (= tmp%1@ (Mul b0~4@ b0~4@)) (=> (= tmp%2@ (Mul b0~4@ a0~2@)) (=> (= tmp%3@ (Mul a0~2@ (Mul c0~6@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~374@)))))) (=> (= temp_0_0~301@ temp_0_1~374@) (=> (= temp_1_0~481@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul (Add d1~16@ a1~10@) (Sub a1~10@ b1~12@))) (Mul (Add (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~542@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul (Add d1~16@ a1~10@) (Sub a1~10@ b1~12@))) (Mul (Add (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul (Mul a1~10@ b1~12@) c1~14@) a1~10@)))) (and (=> (= tmp%4@ (Mul (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul (Add d1~16@ a1~10@) (Sub a1~10@ b1~12@)))) (=> (= tmp%5@ (Add (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@))) (=> (= tmp%6@ (Mul (Mul (Mul a1~10@ b1~12@) c1~14@) a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> (= tmp%7@ (Mul a1~10@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ c1~14@ a1~10@) (=> (= tmp%8@ (Mul (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul (Add d1~16@ a1~10@) (Sub a1~10@ b1~12@)))) (=> (= tmp%9@ (Add (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@))) (=> (= tmp%10@ (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%1 (= temp_1_0~481@ temp_1_1~542@)))))))))))) (=> (= temp_1_0~481@ temp_1_1~542@) (=> (= temp_2_0~757@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Add c2~22@ b2~20@))))) (=> (= temp_2_1~822@ (Mul (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@)) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Add c2~22@ b2~20@)))))) (and (=> (= tmp%11@ (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ d2~24@))) (=> (= tmp%12@ (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@))) (=> (= tmp%13@ (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Add c2~22@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%2 (= temp_2_0~757@ temp_2_1~822@)))))) (=> (= temp_2_0~757@ temp_2_1~822@) (=> (= temp_3_0~965@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Add b3~28@ d3~32@) d3~32@)) (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~1026@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Add b3~28@ d3~32@) d3~32@)) (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@))))) (and (=> (= tmp%14@ (Mul b3~28@ a3~26@)) (=> (= tmp%15@ (Mul b3~28@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> (= tmp%16@ (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ b3~28@))) (=> (= tmp%17@ (Mul (Add b3~28@ d3~32@) d3~32@)) (=> (= tmp%18@ (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> (= tmp%19@ (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ a3~26@))) (=> (= tmp%20@ (Mul (Add b3~28@ d3~32@) d3~32@)) (=> (= tmp%21@ (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%3 (= temp_3_0~965@ temp_3_1~1026@))))))))))))) (=> (= temp_3_0~965@ temp_3_1~1026@) (=> (= temp_4_0~1227@ (Mul (Mul a4~34@ (Mul (Mul c4~38@ b4~36@) (Add a4~34@ a4~34@))) (Mul (Mul (Add c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul a4~34@ (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~1276@ (Mul (Mul a4~34@ (Mul (Mul c4~38@ b4~36@) (Add a4~34@ a4~34@))) (Mul (Mul (Mul (Add c4~38@ d4~40@) b4~36@) c4~38@) (Mul a4~34@ (Mul d4~40@ c4~38@))))) (and (=> (= tmp%22@ (Add c4~38@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ b4~36@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1227@ temp_4_1~1276@)))) (=> (= temp_4_0~1227@ temp_4_1~1276@) (=> (= temp_5_0~1371@ (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Sub a5~42@ d5~48@)) (Sub (Add d5~48@ c5~46@) (Sub b5~44@ b5~44@))) (Mul (Add (Mul a5~42@ d5~48@) (Sub c5~46@ d5~48@)) (Sub a5~42@ (Mul b5~44@ d5~48@))))) (=> (= temp_5_1~1432@ (Mul (Mul (Mul (Sub a5~42@ d5~48@) (Mul d5~48@ c5~46@)) (Sub (Add d5~48@ c5~46@) (Sub b5~44@ b5~44@))) (Mul (Add (Mul a5~42@ d5~48@) (Sub c5~46@ d5~48@)) (Sub a5~42@ (Mul b5~44@ d5~48@))))) (and (=> (= tmp%23@ (Sub a5~42@ d5~48@)) (=> (= tmp%24@ (Mul d5~48@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> (= tmp%25@ (Mul (Sub a5~42@ d5~48@) (Mul d5~48@ c5~46@))) (=> (= tmp%26@ (Sub (Add d5~48@ c5~46@) (Sub b5~44@ b5~44@))) (=> (= tmp%27@ (Mul (Add (Mul a5~42@ d5~48@) (Sub c5~46@ d5~48@)) (Sub a5~42@ (Mul b5~44@ d5~48@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> (= tmp%28@ (Mul (Mul d5~48@ c5~46@) (Sub a5~42@ d5~48@))) (=> (= tmp%29@ (Sub (Add d5~48@ c5~46@) (Sub b5~44@ b5~44@))) (=> (= tmp%30@ (Mul (Add (Mul a5~42@ d5~48@) (Sub c5~46@ d5~48@)) (Sub a5~42@ (Mul b5~44@ d5~48@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%5 (= temp_5_0~1371@ temp_5_1~1432@))))))))))))) (=> (= temp_5_0~1371@ temp_5_1~1432@) (=> (= temp_6_0~1657@ (Mul (Mul (Add (Mul 90 c6~54@) (Mul d6~56@ b6~52@)) (Mul (Sub b6~52@ c6~54@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) a6~50@) (Add (Add c6~54@ c6~54@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1730@ (Mul (Mul (Add (Mul 90 c6~54@) (Mul d6~56@ b6~52@)) (Mul (Sub b6~52@ c6~54@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) a6~50@) (Add (Add c6~54@ c6~54@) (Mul b6~52@ d6~56@))))) (=> (= tmp%31@ (= temp_6_0~1657@ temp_6_1~1730@)) (and (=> %%location_label%%6 tmp%31@) (=> tmp%31@ (=> (= temp_7_0~1810@ (Sub (Mul (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Add b7~60@ d7~64@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Sub c7~62@ c7~62@) (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1875@ (Sub (Mul (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Add b7~60@ d7~64@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ a7~58@)) (Mul (Sub c7~62@ c7~62@) (Mul d7~64@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1810@ temp_7_1~1875@))) (=> (= temp_7_0~1810@ temp_7_1~1875@) (=> (= temp_8_0~1980@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ b8~68@))) (Mul (Mul (Add 72 c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~2057@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul c8~70@ (Mul b8~68@ (Mul c8~70@ b8~68@)))) (Mul (Mul (Add 72 c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@))))) (and (=> (= tmp%32@ (Mul c8~70@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c8~70@ b8~68@ tmp%32@) (=> %%location_label%%8 (= temp_8_0~1980@ temp_8_1~2057@)))) (=> (= temp_8_0~1980@ temp_8_1~2057@) (=> (= temp_9_0~2140@ (Sub (Mul a9~74@ (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ a9~74@))) (Mul (Mul (Mul d9~80@ d9~80@) d9~80@) (Add (Mul a9~74@ a9~74@) (Sub c9~78@ c9~78@))))) (=> (= temp_9_1~2189@ (Sub (Mul a9~74@ (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ a9~74@))) (Mul (Mul d9~80@ (Mul d9~80@ d9~80@)) (Add (Mul a9~74@ a9~74@) (Sub c9~78@ c9~78@))))) (and (=> (= tmp%33@ (Mul d9~80@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ tmp%33@) (=> %%location_label%%9 (= temp_9_0~2140@ temp_9_1~2189@)))) (=> (= temp_9_0~2140@ temp_9_1~2189@) (=> (= temp_10_0~2282@ (Mul (Mul (Mul (Mul d10~88@ a10~82@) d10~88@) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul d10~88@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ d10~88@))))) (=> (= temp_10_1~2343@ (Mul (Mul (Mul (Mul d10~88@ a10~82@) d10~88@) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul d10~88@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ d10~88@))))) (=> (= tmp%34@ (= temp_10_0~2282@ temp_10_1~2343@)) (and (=> %%location_label%%10 tmp%34@) (=> tmp%34@ (=> (= temp_11_0~2431@ (Mul (Mul (Mul (Sub 3 c11~94@) b11~92@) (Mul (Sub d11~96@ b11~92@) (Sub b11~92@ a11~90@))) (Mul (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~2504@ (Mul (Mul (Mul (Sub 3 c11~94@) b11~92@) (Mul (Sub d11~96@ b11~92@) (Sub b11~92@ a11~90@))) (Mul (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c11~94@ d11~96@) (=> (= tmp%35@ (Mul (Mul (Sub 3 c11~94@) b11~92@) (Mul (Sub d11~96@ b11~92@) (Sub b11~92@ a11~90@)))) (=> (= tmp%36@ (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ c11~94@))) (=> (= tmp%37@ (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ c11~94@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ tmp%36@ tmp%37@) (=> (= tmp%38@ (Mul (Mul (Sub 3 c11~94@) b11~92@) (Mul (Sub d11~96@ b11~92@) (Sub b11~92@ a11~90@)))) (=> (= tmp%39@ (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ c11~94@))) (=> (= tmp%40@ (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ c11~94@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> %%location_label%%11 (= temp_11_0~2431@ temp_11_1~2504@))))))))))) (=> (= temp_11_0~2431@ temp_11_1~2504@) (=> (= temp_12_0~2709@ (Mul (Add (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Sub d12~104@ b12~100@))) (Mul (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ b12~100@)) c12~102@))) (=> (= temp_12_1~2762@ (Mul (Add (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Sub d12~104@ b12~100@))) (Mul c12~102@ (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ b12~100@))))) (and (=> (= tmp%41@ (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c12~102@ tmp%41@) (=> %%location_label%%12 (= temp_12_0~2709@ temp_12_1~2762@)))) (=> (= temp_12_0~2709@ temp_12_1~2762@) (=> (= temp_13_0~2867@ (Add (Mul (Mul (Add b13~108@ a13~106@) (Sub a13~106@ b13~108@)) (Add (Add b13~108@ c13~110@) (Mul a13~106@ a13~106@))) (Mul (Mul (Add a13~106@ d13~112@) (Mul b13~108@ b13~108@)) (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2932@ (Add (Mul (Mul (Add b13~108@ a13~106@) (Sub a13~106@ b13~108@)) (Add (Add b13~108@ c13~110@) (Mul a13~106@ a13~106@))) (Mul (Mul (Mul b13~108@ b13~108@) (Add a13~106@ d13~112@)) (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@))))) (and (=> (= tmp%42@ (Mul b13~108@ b13~108@)) (=> (= tmp%43@ (Add a13~106@ d13~112@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%42@ tmp%43@) (=> %%location_label%%13 (= temp_13_0~2867@ temp_13_1~2932@))))) (=> (= temp_13_0~2867@ temp_13_1~2932@) (=> (= temp_14_0~3033@ (Mul (Mul (Sub (Mul a14~114@ b14~116@) (Mul c14~118@ d14~120@)) (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul d14~120@ b14~116@)) (Sub (Mul a14~114@ d14~120@) (Mul c14~118@ c14~118@))))) (=> (= temp_14_1~3098@ (Mul (Mul (Sub (Mul a14~114@ b14~116@) (Mul c14~118@ d14~120@)) (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ b14~116@)) (Sub (Mul a14~114@ d14~120@) (Mul c14~118@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c14~118@ b14~116@) (=> (= tmp%44@ (Mul b14~116@ c14~118@)) (=> (= tmp%45@ (Mul d14~120@ b14~116@)) (=> (= tmp%46@ (Sub (Mul a14~114@ d14~120@) (Mul c14~118@ c14~118@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%44@ tmp%45@ tmp%46@) (=> (= tmp%47@ (Mul c14~118@ b14~116@)) (=> (= tmp%48@ (Mul d14~120@ b14~116@)) (=> (= tmp%49@ (Sub (Mul a14~114@ d14~120@) (Mul c14~118@ c14~118@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%47@ tmp%48@ tmp%49@) (=> %%location_label%%14 (= temp_14_0~3033@ temp_14_1~3098@))))))))))) (=> (= temp_14_0~3033@ temp_14_1~3098@) (=> (= temp_15_0~3235@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) d15~128@) a15~122@) (Mul (Mul (Mul b15~124@ d15~128@) (Mul d15~128@ c15~126@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ b15~124@))))) (=> (= temp_15_1~3284@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) d15~128@) a15~122@) (Mul (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ b15~124@))))) (and (=> (= tmp%50@ (Mul d15~128@ c15~126@)) (=> (= tmp%51@ (Mul b15~124@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%50@ tmp%51@) (=> %%location_label%%15 (= temp_15_0~3235@ temp_15_1~3284@))))) (=> (= temp_15_0~3235@ temp_15_1~3284@) (=> (= temp_16_0~3353@ (Mul c16~134@ (Mul (Mul (Mul c16~134@ a16~130@) (Sub c16~134@ a16~130@)) (Mul a16~130@ (Add c16~134@ b16~132@))))) (=> (= temp_16_1~3386@ (Mul c16~134@ (Mul (Mul c16~134@ (Mul a16~130@ (Sub c16~134@ a16~130@))) (Mul a16~130@ (Add c16~134@ b16~132@))))) (=> (= tmp%52@ (Sub c16~134@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c16~134@ a16~130@ tmp%52@) (=> %%location_label%%16 (= temp_16_0~3353@ temp_16_1~3386@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
