...
(declare-const temp_4_0~1351@ Int)
(declare-const temp_4_1~1428@ Int)
(declare-const temp_5_0~1571@ Int)
(declare-const temp_5_1~1628@ Int)
(declare-const temp_6_0~1729@ Int)
(declare-const temp_6_1~1782@ Int)
(declare-const temp_7_0~1925@ Int)
(declare-const temp_7_1~1998@ Int)
(declare-const temp_8_0~2103@ Int)
(declare-const temp_8_1~2180@ Int)
(declare-const temp_9_0~2299@ Int)
(declare-const temp_9_1~2364@ Int)
(declare-const temp_10_0~2481@ Int)
(declare-const temp_10_1~2546@ Int)
(declare-const temp_11_0~2635@ Int)
(declare-const temp_11_1~2672@ Int)
(declare-const temp_12_0~2793@ Int)
(declare-const temp_12_1~2858@ Int)
(declare-const temp_13_0~2959@ Int)
(declare-const temp_13_1~3024@ Int)
(declare-const temp_14_0~3151@ Int)
(declare-const temp_14_1~3228@ Int)
(declare-const temp_15_0~3343@ Int)
(declare-const temp_15_1~3420@ Int)
(declare-const temp_16_0~3521@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Add (Add b0~4@ b0~4@) (Mul 11 a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@))))) (=> (= temp_0_1~394@ (Mul (Mul (Add (Add b0~4@ b0~4@) (Mul 11 a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul (Mul a0~2@ b0~4@) c0~6@) b0~4@) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@))))) (and (=> (= tmp%1@ (Mul a0~2@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@)))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~493@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))) (Add (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~558@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))) (Add (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ d1~16@) (=> (= tmp%2@ (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@))) (=> (= tmp%3@ (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))) (=> (= tmp%4@ (Add (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> (= tmp%5@ (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@))) (=> (= tmp%6@ (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))) (=> (= tmp%7@ (Add (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%1 (= temp_1_0~493@ temp_1_1~558@))))))))))) (=> (= temp_1_0~493@ temp_1_1~558@) (=> (= temp_2_0~787@ (Mul (Sub (Add (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Sub a2~18@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Add (Mul d2~24@ 19) (Mul d2~24@ c2~22@))))) (=> (= temp_2_1~864@ (Mul (Sub (Add (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Sub a2~18@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Add (Mul d2~24@ 19) (Mul c2~22@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ d2~24@) (=> (= tmp%8@ (Sub (Add (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Sub a2~18@ a2~18@) (Mul c2~22@ a2~18@)))) (=> (= tmp%9@ (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@))) (=> (= tmp%10@ (Add (Mul d2~24@ 19) (Mul c2~22@ d2~24@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> (= tmp%11@ (Sub (Add (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Sub a2~18@ a2~18@) (Mul c2~22@ a2~18@)))) (=> (= tmp%12@ (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@))) (=> (= tmp%13@ (Add (Mul d2~24@ 19) (Mul d2~24@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%2 (= temp_2_0~787@ temp_2_1~864@))))))))))) (=> (= temp_2_0~787@ temp_2_1~864@) (=> (= temp_3_0~1085@ (Mul (Sub b3~28@ (Sub (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@))) (Mul (Mul (Mul d3~32@ 73) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ b3~28@) a3~26@)))) (=> (= temp_3_1~1146@ (Mul (Sub b3~28@ (Sub (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@))) (Mul (Mul (Mul d3~32@ 73) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ c3~30@) a3~26@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ c3~30@) (=> (= tmp%14@ (Sub b3~28@ (Sub (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@)))) (=> (= tmp%15@ (Mul (Mul d3~32@ 73) (Mul b3~28@ c3~30@))) (=> (= tmp%16@ (Mul (Mul b3~28@ c3~30@) a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> (= tmp%17@ (Sub b3~28@ (Sub (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@)))) (=> (= tmp%18@ (Mul (Mul d3~32@ 73) (Mul b3~28@ c3~30@))) (=> (= tmp%19@ (Mul (Mul c3~30@ b3~28@) a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%3 (= temp_3_0~1085@ temp_3_1~1146@))))))))))) (=> (= temp_3_0~1085@ temp_3_1~1146@) (=> (= temp_4_0~1351@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ d4~40@)) (Sub (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul c4~38@ d4~40@) (Add c4~38@ 71)) (Mul (Mul b4~36@ d4~40@) (Add d4~40@ b4~36@))))) (=> (= temp_4_1~1428@ (Mul (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ d4~40@)) (Sub (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))) (Mul (Mul c4~38@ d4~40@) (Add c4~38@ 71))) (Mul (Mul b4~36@ d4~40@) (Add d4~40@ b4~36@)))) (and (=> (= tmp%20@ (Mul (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ d4~40@)) (Sub (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@)))) (=> (= tmp%21@ (Mul (Mul c4~38@ d4~40@) (Add c4~38@ 71))) (=> (= tmp%22@ (Mul (Mul b4~36@ d4~40@) (Add d4~40@ b4~36@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%4 (= temp_4_0~1351@ temp_4_1~1428@)))))) (=> (= temp_4_0~1351@ temp_4_1~1428@) (=> (= temp_5_0~1571@ (Mul (Mul (Add (Mul c5~46@ d5~48@) (Add d5~48@ c5~46@)) (Add (Sub d5~48@ c5~46@) d5~48@)) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@)) (Mul c5~46@ (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1628@ (Mul (Mul (Add (Sub d5~48@ c5~46@) d5~48@) (Add (Mul c5~46@ d5~48@) (Add d5~48@ c5~46@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@)) (Mul c5~46@ (Mul c5~46@ c5~46@))))) (and (=> (= tmp%23@ (Add (Mul c5~46@ d5~48@) (Add d5~48@ c5~46@))) (=> (= tmp%24@ (Add (Sub d5~48@ c5~46@) d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> %%location_label%%5 (= temp_5_0~1571@ temp_5_1~1628@))))) (=> (= temp_5_0~1571@ temp_5_1~1628@) (=> (= temp_6_0~1729@ (Mul (Mul (Add (Add c6~54@ c6~54@) (Mul d6~56@ d6~56@)) d6~56@) (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul a6~50@ b6~52@) (Add c6~54@ c6~54@))))) (=> (= temp_6_1~1782@ (Mul (Mul (Mul (Add (Add c6~54@ c6~54@) (Mul d6~56@ d6~56@)) d6~56@) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Mul a6~50@ b6~52@) (Add c6~54@ c6~54@)))) (and (=> (= tmp%25@ (Mul (Add (Add c6~54@ c6~54@) (Mul d6~56@ d6~56@)) d6~56@)) (=> (= tmp%26@ (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@))) (=> (= tmp%27@ (Mul (Mul a6~50@ b6~52@) (Add c6~54@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%6 (= temp_6_0~1729@ temp_6_1~1782@)))))) (=> (= temp_6_0~1729@ temp_6_1~1782@) (=> (= temp_7_0~1925@ (Sub (Sub (Mul d7~64@ (Mul a7~58@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@))) (Sub (Sub (Sub c7~62@ 16) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Add b7~60@ b7~60@))))) (=> (= temp_7_1~1998@ (Sub (Sub (Mul d7~64@ (Mul a7~58@ d7~64@)) (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ c7~62@))) (Sub (Sub (Sub c7~62@ 16) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Add b7~60@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1925@ temp_7_1~1998@))) (=> (= temp_7_0~1925@ temp_7_1~1998@) (=> (= temp_8_0~2103@ (Mul (Sub (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul b8~68@ 32) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ b8~68@))))) (=> (= temp_8_1~2180@ (Mul (Sub (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@))) (Mul (Mul b8~68@ 32) (Mul (Mul c8~70@ d8~72@) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ b8~68@)))))) (and (=> (= tmp%28@ (Mul b8~68@ 32)) (=> (= tmp%29@ (Mul c8~70@ d8~72@)) (=> (= tmp%30@ (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%8 (= temp_8_0~2103@ temp_8_1~2180@)))))) (=> (= temp_8_0~2103@ temp_8_1~2180@) (=> (= temp_9_0~2299@ (Mul (Mul (Sub (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@))) (Mul (Sub (Mul c9~78@ c9~78@) (Sub c9~78@ d9~80@)) (Mul (Add c9~78@ c9~78@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~2364@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@)) (Sub (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@))) (Mul (Sub (Mul c9~78@ c9~78@) (Sub c9~78@ d9~80@)) (Mul (Add c9~78@ c9~78@) (Mul b9~76@ a9~74@))))) (and (=> (= tmp%31@ (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@))) (=> (= tmp%32@ (Sub (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%31@ tmp%32@) (=> %%location_label%%9 (= temp_9_0~2299@ temp_9_1~2364@))))) (=> (= temp_9_0~2299@ temp_9_1~2364@) (=> (= temp_10_0~2481@ (Add (Mul (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ c10~86@)) (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ c10~86@))) (Mul (Mul (Add a10~82@ d10~88@) (Mul d10~88@ a10~82@)) (Add (Mul a10~82@ d10~88@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~2546@ (Add (Mul (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ c10~86@)) (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ c10~86@))) (Mul (Mul (Add a10~82@ d10~88@) (Mul d10~88@ a10~82@)) (Add (Mul a10~82@ d10~88@) (Mul c10~86@ a10~82@))))) (and (=> (= tmp%33@ (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ c10~86@))) (=> (= tmp%34@ (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ c10~86@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%33@ tmp%34@) (=> %%location_label%%10 (= temp_10_0~2481@ temp_10_1~2546@))))) (=> (= temp_10_0~2481@ temp_10_1~2546@) (=> (= temp_11_0~2635@ (Mul (Add (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ b11~92@)) (Mul (Sub a11~90@ d11~96@) (Mul a11~90@ d11~96@))) b11~92@)) (=> (= temp_11_1~2672@ (Mul b11~92@ (Add (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ b11~92@)) (Mul (Sub a11~90@ d11~96@) (Mul a11~90@ d11~96@))))) (and (=> (= tmp%35@ (Add (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ b11~92@)) (Mul (Sub a11~90@ d11~96@) (Mul a11~90@ d11~96@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b11~92@ tmp%35@) (=> %%location_label%%11 (= temp_11_0~2635@ temp_11_1~2672@)))) (=> (= temp_11_0~2635@ temp_11_1~2672@) (=> (= temp_12_0~2793@ (Sub (Mul (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Sub a12~98@ c12~102@) (Mul b12~100@ b12~100@))) (Mul (Mul (Sub c12~102@ a12~98@) (Sub d12~104@ a12~98@)) (Mul (Mul a12~98@ d12~104@) (Sub b12~100@ d12~104@))))) (=> (= temp_12_1~2858@ (Sub (Mul (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ b12~100@) (Sub a12~98@ c12~102@))) (Mul (Mul (Sub c12~102@ a12~98@) (Sub d12~104@ a12~98@)) (Mul (Mul a12~98@ d12~104@) (Sub b12~100@ d12~104@))))) (and (=> (= tmp%36@ (Mul b12~100@ b12~100@)) (=> (= tmp%37@ (Sub a12~98@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%36@ tmp%37@) (=> %%location_label%%12 (= temp_12_0~2793@ temp_12_1~2858@))))) (=> (= temp_12_0~2793@ temp_12_1~2858@) (=> (= temp_13_0~2959@ (Mul (Mul (Mul (Mul c13~110@ d13~112@) (Add b13~108@ c13~110@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@))) (Add (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Add a13~106@ a13~106@))))) (=> (= temp_13_1~3024@ (Mul (Mul (Mul c13~110@ d13~112@) (Mul (Add b13~108@ c13~110@) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)))) (Add (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Add a13~106@ a13~106@))))) (and (=> (= tmp%38@ (Mul c13~110@ d13~112@)) (=> (= tmp%39@ (Add b13~108@ c13~110@)) (=> (= tmp%40@ (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> %%location_label%%13 (= temp_13_0~2959@ temp_13_1~3024@)))))) (=> (= temp_13_0~2959@ temp_13_1~3024@) (=> (= temp_14_0~3151@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@)) (Mul (Sub 90 a14~114@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul a14~114@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~3228@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@)) (Mul (Mul (Sub 90 a14~114@) b14~116@) a14~114@)) (Mul (Mul (Mul a14~114@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ b14~116@))))) (and (=> (= tmp%41@ (Sub 90 a14~114@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ b14~116@ a14~114@) (=> %%location_label%%14 (= temp_14_0~3151@ temp_14_1~3228@)))) (=> (= temp_14_0~3151@ temp_14_1~3228@) (=> (= temp_15_0~3343@ (Mul (Mul (Add (Sub c15~126@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul a15~122@ 80) (Mul d15~128@ d15~128@))) (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~3420@ (Mul (Mul (Add (Sub c15~126@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ 80))) (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ d15~128@))))) (and (=> (= tmp%42@ (Mul d15~128@ d15~128@)) (=> (= tmp%43@ (Mul a15~122@ 80)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%42@ tmp%43@) (=> %%location_label%%15 (= temp_15_0~3343@ temp_15_1~3420@))))) (=> (= temp_15_0~3343@ temp_15_1~3420@) (=> (= temp_16_0~3521@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ b16~132@)) (Add (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@))) (Sub (Mul a16~130@ (Sub c16~134@ a16~130@)) (Mul (Sub b16~132@ d16~136@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~3582@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ b16~132@)) (Add (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@))) (Sub (Mul a16~130@ (Sub c16~134@ a16~130@)) (Mul (Mul c16~134@ a16~130@) (Sub b16~132@ d16~136@))))) (=> (= tmp%44@ (Mul c16~134@ a16~130@)) (=> (= tmp%45@ (Sub b16~132@ d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%44@ tmp%45@) (=> %%location_label%%16 (= temp_16_0~3521@ temp_16_1~3582@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
