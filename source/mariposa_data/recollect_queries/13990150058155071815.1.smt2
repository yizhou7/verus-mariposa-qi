...
(declare-const temp_6_0~1553@ Int)
(declare-const temp_6_1~1614@ Int)
(declare-const temp_7_0~1707@ Int)
(declare-const temp_7_1~1804@ Int)
(declare-const temp_8_0~1963@ Int)
(declare-const temp_8_1~2040@ Int)
(declare-const temp_9_0~2197@ Int)
(declare-const temp_9_1~2266@ Int)
(declare-const temp_10_0~2379@ Int)
(declare-const temp_10_1~2452@ Int)
(declare-const temp_11_0~2535@ Int)
(declare-const temp_11_1~2588@ Int)
(declare-const temp_12_0~2665@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul (Mul c0~6@ a0~2@) b0~4@) a0~2@)))) (and (=> (= tmp%1@ (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ b0~4@)))) (=> (= tmp%2@ (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@))) (=> (= tmp%3@ (Mul (Mul (Mul c0~6@ a0~2@) b0~4@) a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> (= tmp%4@ (Mul c0~6@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ b0~4@ a0~2@) (=> (= tmp%5@ (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ b0~4@)))) (=> (= tmp%6@ (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@))) (=> (= tmp%7@ (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))))))))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~585@ (Mul (Mul (Mul (Sub b1~12@ a1~10@) (Sub d1~16@ a1~10@)) (Add (Mul d1~16@ a1~10@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul d1~16@ b1~12@) d1~16@) (Mul (Mul c1~14@ b1~12@) c1~14@)))) (=> (= temp_1_1~650@ (Mul (Mul (Sub (Mul b1~12@ (Sub d1~16@ a1~10@)) (Mul a1~10@ (Sub d1~16@ a1~10@))) (Add (Mul d1~16@ a1~10@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul d1~16@ b1~12@) d1~16@) (Mul (Mul c1~14@ b1~12@) c1~14@)))) (and (=> (= tmp%8@ (Sub (Mul b1~12@ (Sub d1~16@ a1~10@)) (Mul a1~10@ (Sub d1~16@ a1~10@)))) (=> (= tmp%9@ (Add (Mul d1~16@ a1~10@) (Mul b1~12@ b1~12@))) (=> (= tmp%10@ (Mul (Mul (Mul d1~16@ b1~12@) d1~16@) (Mul (Mul c1~14@ b1~12@) c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> (= tmp%11@ (Sub d1~16@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b1~12@ a1~10@ tmp%11@) (=> (= tmp%12@ (Mul (Sub b1~12@ a1~10@) (Sub d1~16@ a1~10@))) (=> (= tmp%13@ (Add (Mul d1~16@ a1~10@) (Mul b1~12@ b1~12@))) (=> (= tmp%14@ (Mul (Mul (Mul d1~16@ b1~12@) d1~16@) (Mul (Mul c1~14@ b1~12@) c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%1 (= temp_1_0~585@ temp_1_1~650@)))))))))))) (=> (= temp_1_0~585@ temp_1_1~650@) (=> (= temp_2_0~853@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ b2~20@)) d2~24@) (Add (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Sub d2~24@ a2~18@))))) (=> (= temp_2_1~906@ (Mul (Mul (Mul b2~20@ c2~22@) (Mul (Mul c2~22@ b2~20@) d2~24@)) (Add (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Sub d2~24@ a2~18@))))) (and (=> (= tmp%15@ (Mul b2~20@ c2~22@)) (=> (= tmp%16@ (Mul c2~22@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ d2~24@) (=> %%location_label%%2 (= temp_2_0~853@ temp_2_1~906@))))) (=> (= temp_2_0~853@ temp_2_1~906@) (=> (= temp_3_0~1029@ (Add (Mul (Add (Mul d3~32@ d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@))) (Mul (Mul a3~26@ (Mul b3~28@ 2)) (Sub (Mul d3~32@ 9) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~1114@ (Add (Mul (Mul (Add (Mul d3~32@ d3~32@) (Mul a3~26@ c3~30@)) (Mul a3~26@ c3~30@)) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ (Mul b3~28@ 2)) (Sub (Mul d3~32@ 9) (Mul d3~32@ d3~32@))))) (and (=> (= tmp%17@ (Add (Mul d3~32@ d3~32@) (Mul a3~26@ c3~30@))) (=> (= tmp%18@ (Mul a3~26@ c3~30@)) (=> (= tmp%19@ (Mul c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%3 (= temp_3_0~1029@ temp_3_1~1114@)))))) (=> (= temp_3_0~1029@ temp_3_1~1114@) (=> (= temp_4_0~1229@ (Sub (Mul (Mul (Add d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Add c4~38@ d4~40@))) (Mul (Add (Mul c4~38@ b4~36@) (Mul a4~34@ a4~34@)) (Sub (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~1294@ (Sub (Mul (Mul (Add d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul d4~40@ (Mul a4~34@ (Add c4~38@ d4~40@)))) (Mul (Add (Mul c4~38@ b4~36@) (Mul a4~34@ a4~34@)) (Sub (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@))))) (and (=> (= tmp%20@ (Add c4~38@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d4~40@ a4~34@ tmp%20@) (=> %%location_label%%4 (= temp_4_0~1229@ temp_4_1~1294@)))) (=> (= temp_4_0~1229@ temp_4_1~1294@) (=> (= temp_5_0~1393@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ b5~44@)) (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ d5~48@))) (Add (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ b5~44@)) (Mul (Add d5~48@ c5~46@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1458@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ b5~44@)) (Mul d5~48@ (Mul a5~42@ (Mul c5~46@ d5~48@)))) (Add (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ b5~44@)) (Mul (Add d5~48@ c5~46@) (Mul b5~44@ b5~44@))))) (and (=> (= tmp%21@ (Mul c5~46@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d5~48@ a5~42@ tmp%21@) (=> %%location_label%%5 (= temp_5_0~1393@ temp_5_1~1458@)))) (=> (= temp_5_0~1393@ temp_5_1~1458@) (=> (= temp_6_0~1553@ (Mul (Add (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Add c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ a6~50@)) (Mul a6~50@ (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1614@ (Mul (Add (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Add c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ a6~50@)) (Mul a6~50@ (Mul b6~52@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b6~52@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1553@ temp_6_1~1614@))) (=> (= temp_6_0~1553@ temp_6_1~1614@) (=> (= temp_7_0~1707@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Sub d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Add a7~58@ b7~60@))) (Add (Mul (Mul a7~58@ d7~64@) (Sub c7~62@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Add d7~64@ d7~64@))))) (=> (= temp_7_1~1804@ (Add (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Sub d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Add a7~58@ b7~60@))) (Mul (Mul a7~58@ d7~64@) (Sub c7~62@ b7~60@))) (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Sub d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Add a7~58@ b7~60@))) (Mul (Mul b7~60@ b7~60@) (Add d7~64@ d7~64@))))) (and (=> (= tmp%22@ (Mul (Mul (Mul b7~60@ d7~64@) (Sub d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Add a7~58@ b7~60@)))) (=> (= tmp%23@ (Mul (Mul a7~58@ d7~64@) (Sub c7~62@ b7~60@))) (=> (= tmp%24@ (Mul (Mul b7~60@ b7~60@) (Add d7~64@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%7 (= temp_7_0~1707@ temp_7_1~1804@)))))) (=> (= temp_7_0~1707@ temp_7_1~1804@) (=> (= temp_8_0~1963@ (Mul (Sub (Mul (Mul d8~72@ a8~66@) (Add c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul 16 b8~68@) (Sub a8~66@ c8~70@))))) (=> (= temp_8_1~2040@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul 16 b8~68@) (Sub a8~66@ c8~70@))) (Sub (Mul (Mul d8~72@ a8~66@) (Add c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ b8~68@))))) (and (=> (= tmp%25@ (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul 16 b8~68@) (Sub a8~66@ c8~70@)))) (=> (= tmp%26@ (Sub (Mul (Mul d8~72@ a8~66@) (Add c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ b8~68@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%25@ tmp%26@) (=> %%location_label%%8 (= temp_8_0~1963@ temp_8_1~2040@))))) (=> (= temp_8_0~1963@ temp_8_1~2040@) (=> (= temp_9_0~2197@ (Add (Mul (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ 61)) (Mul (Mul a9~74@ b9~76@) b9~76@)) (Mul (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ c9~78@)) (Mul b9~76@ (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~2266@ (Add (Mul (Mul (Mul a9~74@ 61) (Mul b9~76@ b9~76@)) (Mul (Mul a9~74@ b9~76@) b9~76@)) (Mul (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ c9~78@)) (Mul b9~76@ (Mul d9~80@ c9~78@))))) (and (=> (= tmp%27@ (Mul a9~74@ 61)) (=> (= tmp%28@ (Mul b9~76@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%9 (= temp_9_0~2197@ temp_9_1~2266@))))) (=> (= temp_9_0~2197@ temp_9_1~2266@) (=> (= temp_10_0~2379@ (Mul (Mul (Add (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@)) (Mul a10~82@ (Mul c10~86@ c10~86@))) (Mul (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ d10~88@)) (Mul (Mul 92 d10~88@) (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~2452@ (Mul (Mul (Add (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@)) (Mul (Mul a10~82@ c10~86@) c10~86@)) (Mul (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ d10~88@)) (Mul (Mul 92 d10~88@) (Mul a10~82@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a10~82@ c10~86@ c10~86@) (=> %%location_label%%10 (= temp_10_0~2379@ temp_10_1~2452@))) (=> (= temp_10_0~2379@ temp_10_1~2452@) (=> (= temp_11_0~2535@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Add b11~92@ d11~96@)) (Mul (Add c11~94@ b11~92@) (Mul a11~90@ c11~94@))) (Sub (Mul (Add b11~92@ d11~96@) (Mul a11~90@ b11~92@)) a11~90@))) (=> (= temp_11_1~2588@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Add b11~92@ d11~96@)) (Mul (Add c11~94@ b11~92@) (Mul a11~90@ c11~94@))) (Sub (Mul (Add b11~92@ d11~96@) (Mul b11~92@ a11~90@)) a11~90@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b11~92@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2535@ temp_11_1~2588@))) (=> (= temp_11_0~2535@ temp_11_1~2588@) (=> (= temp_12_0~2665@ (Mul (Add (Sub (Mul a12~98@ c12~102@) (Mul c12~102@ c12~102@)) (Mul d12~104@ (Sub c12~102@ b12~100@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) b12~100@))) (=> (= temp_12_1~2710@ (Mul (Add (Mul (Sub a12~98@ c12~102@) c12~102@) (Mul d12~104@ (Sub c12~102@ b12~100@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a12~98@ c12~102@ c12~102@) (=> %%location_label%%12 (= temp_12_0~2665@ temp_12_1~2710@))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
