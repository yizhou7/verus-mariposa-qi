...
(declare-const temp_3_1~1084@ Int)
(declare-const temp_4_0~1281@ Int)
(declare-const temp_4_1~1334@ Int)
(declare-const temp_5_0~1445@ Int)
(declare-const temp_5_1~1538@ Int)
(declare-const temp_6_0~1681@ Int)
(declare-const temp_6_1~1746@ Int)
(declare-const temp_7_0~1859@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Sub d0~8@ 24))) (Mul (Mul c0~6@ (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~386@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Sub d0~8@ 24))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul c0~6@ (Mul a0~2@ c0~6@))))) (and (=> (= tmp%1@ (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@))) (=> (= tmp%2@ (Mul c0~6@ (Mul a0~2@ c0~6@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~386@))))) (=> (= temp_0_0~313@ temp_0_1~386@) (=> (= temp_1_0~523@ (Mul (Mul (Add (Mul d1~16@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Sub a1~10@ b1~12@) (Sub b1~12@ d1~16@))) (Mul (Sub (Mul 58 d1~16@) (Mul 72 b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~608@ (Mul (Mul (Mul d1~16@ (Add b1~12@ d1~16@)) (Mul (Sub a1~10@ b1~12@) (Sub b1~12@ d1~16@))) (Mul (Sub (Mul 58 d1~16@) (Mul 72 b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d1~16@ b1~12@ d1~16@) (=> (= tmp%3@ (Mul d1~16@ (Add b1~12@ d1~16@))) (=> (= tmp%4@ (Mul (Sub a1~10@ b1~12@) (Sub b1~12@ d1~16@))) (=> (= tmp%5@ (Mul (Sub (Mul 58 d1~16@) (Mul 72 b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Add (Mul d1~16@ b1~12@) (Mul d1~16@ d1~16@))) (=> (= tmp%7@ (Mul (Sub a1~10@ b1~12@) (Sub b1~12@ d1~16@))) (=> (= tmp%8@ (Mul (Sub (Mul 58 d1~16@) (Mul 72 b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%1 (= temp_1_0~523@ temp_1_1~608@))))))))))) (=> (= temp_1_0~523@ temp_1_1~608@) (=> (= temp_2_0~839@ (Sub (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ a2~18@) (Add a2~18@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~904@ (Sub (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ b2~20@))) (Mul (Mul c2~22@ (Mul a2~18@ (Add a2~18@ a2~18@))) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ b2~20@))))) (and (=> (= tmp%9@ (Add a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c2~22@ a2~18@ tmp%9@) (=> %%location_label%%2 (= temp_2_0~839@ temp_2_1~904@)))) (=> (= temp_2_0~839@ temp_2_1~904@) (=> (= temp_3_0~1011@ (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ 5) d3~32@)) (Mul (Add (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~1084@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ 5) d3~32@)) (Mul (Add (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@))))) (and (=> (= tmp%10@ (Mul b3~28@ a3~26@)) (=> (= tmp%11@ (Mul c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> (= tmp%12@ (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@))) (=> (= tmp%13@ (Mul (Mul d3~32@ 5) d3~32@)) (=> (= tmp%14@ (Mul (Add (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> (= tmp%15@ (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@))) (=> (= tmp%16@ (Mul (Mul d3~32@ 5) d3~32@)) (=> (= tmp%17@ (Mul (Add (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%3 (= temp_3_0~1011@ temp_3_1~1084@))))))))))))) (=> (= temp_3_0~1011@ temp_3_1~1084@) (=> (= temp_4_0~1281@ (Mul (Mul (Add (Mul d4~40@ b4~36@) (Sub a4~34@ d4~40@)) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ b4~36@))) d4~40@)) (=> (= temp_4_1~1334@ (Mul (Add (Mul (Mul d4~40@ b4~36@) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Sub a4~34@ d4~40@) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ b4~36@)))) d4~40@)) (and (=> (= tmp%18@ (Mul d4~40@ b4~36@)) (=> (= tmp%19@ (Sub a4~34@ d4~40@)) (=> (= tmp%20@ (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ b4~36@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%4 (= temp_4_0~1281@ temp_4_1~1334@)))))) (=> (= temp_4_0~1281@ temp_4_1~1334@) (=> (= temp_5_0~1445@ (Mul (Sub (Mul d5~48@ (Add b5~44@ c5~46@)) (Mul (Add a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1538@ (Sub (Mul (Mul d5~48@ (Add b5~44@ c5~46@)) (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@)))) (Mul (Mul (Add a5~42@ a5~42@) (Mul c5~46@ d5~48@)) (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@)))))) (and (=> (= tmp%21@ (Mul d5~48@ (Add b5~44@ c5~46@))) (=> (= tmp%22@ (Mul (Add a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (=> (= tmp%23@ (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%5 (= temp_5_0~1445@ temp_5_1~1538@)))))) (=> (= temp_5_0~1445@ temp_5_1~1538@) (=> (= temp_6_0~1681@ (Mul (Mul (Add (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Sub c6~54@ c6~54@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Sub a6~50@ a6~50@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1746@ (Mul (Mul (Add (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Sub c6~54@ c6~54@))) (Mul (Mul (Sub a6~50@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ c6~54@))))) (and (=> (= tmp%24@ (Mul (Sub a6~50@ a6~50@) (Mul c6~54@ b6~52@))) (=> (= tmp%25@ (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%24@ tmp%25@) (=> %%location_label%%6 (= temp_6_0~1681@ temp_6_1~1746@))))) (=> (= temp_6_0~1681@ temp_6_1~1746@) (=> (= temp_7_0~1859@ (Mul (Mul (Sub (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ b7~60@))) (Mul (Mul (Add d7~64@ d7~64@) b7~60@) (Sub (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1924@ (Mul (Mul (Sub (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ b7~60@))) (Mul (Add (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Sub (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d7~64@ d7~64@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1859@ temp_7_1~1924@))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
