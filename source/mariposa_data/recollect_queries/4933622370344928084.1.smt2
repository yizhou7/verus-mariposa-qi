...
(declare-const temp_2_0~660@ Int)
(declare-const temp_2_1~725@ Int)
(declare-const temp_3_0~854@ Int)
(declare-const temp_3_1~931@ Int)
(declare-const temp_4_0~1056@ Int)
(declare-const temp_4_1~1121@ Int)
(declare-const temp_5_0~1382@ Int)
(declare-const temp_5_1~1483@ Int)
(declare-const temp_6_0~1555@ Int)
(declare-const temp_6_1~1612@ Int)
(declare-const temp_7_0~1680@ Int)
(declare-const temp_7_1~1733@ Int)
(declare-const temp_8_0~1824@ Int)
(declare-const temp_8_1~1877@ Int)
(declare-const temp_9_0~1972@ Int)
(declare-const temp_9_1~2033@ Int)
(declare-const temp_10_0~2156@ Int)
(declare-const temp_10_1~2249@ Int)
(declare-const temp_11_0~2376@ Int)
(declare-const temp_11_1~2453@ Int)
(declare-const temp_12_0~2692@ Int)
(declare-const temp_12_1~2765@ Int)
(declare-const temp_13_0~2864@ Int)
(declare-const temp_13_1~2929@ Int)
(declare-const temp_14_0~3026@ Int)
(declare-const temp_14_1~3095@ Int)
(declare-const temp_15_0~3228@ Int)
(declare-const temp_15_1~3281@ Int)
(declare-const temp_16_0~3492@ Int)
(declare-const temp_16_1~3569@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ a0~2@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~370@ (Add (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ a0~2@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~462@ (Sub (Mul (Mul (Add d1~16@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Add 20 a1~10@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Sub (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~539@ (Sub (Mul (Mul (Add 20 a1~10@) (Mul c1~14@ d1~16@)) (Mul (Add d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Sub (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@))))) (and (=> (= tmp%2@ (Mul (Add 20 a1~10@) (Mul c1~14@ d1~16@))) (=> (= tmp%3@ (Mul (Add d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~462@ temp_1_1~539@))))) (=> (= temp_1_0~462@ temp_1_1~539@) (=> (= temp_2_0~660@ (Sub (Mul (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Add a2~18@ a2~18@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~725@ (Sub (Mul (Mul (Add a2~18@ a2~18@) (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))))) (and (=> (= tmp%4@ (Mul (Add a2~18@ a2~18@) (Mul b2~20@ c2~22@))) (=> (= tmp%5@ (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~660@ temp_2_1~725@))))) (=> (= temp_2_0~660@ temp_2_1~725@) (=> (= temp_3_0~854@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ b3~28@))) (Sub (Mul (Mul b3~28@ a3~26@) (Mul 97 d3~32@)) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~931@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ b3~28@))) (Sub (Mul (Mul b3~28@ a3~26@) (Mul 97 d3~32@)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ d3~32@) (=> (= tmp%6@ (Mul c3~30@ a3~26@)) (=> (= tmp%7@ (Mul b3~28@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> (= tmp%8@ (Mul d3~32@ b3~28@)) (=> (= tmp%9@ (Mul c3~30@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%3 (= temp_3_0~854@ temp_3_1~931@))))))))) (=> (= temp_3_0~854@ temp_3_1~931@) (=> (= temp_4_0~1056@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~1121@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@))))) (and (=> (= tmp%10@ (Mul b4~36@ a4~34@)) (=> (= tmp%11@ (Mul d4~40@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> (= tmp%12@ (Mul (Mul (Mul a4~34@ b4~36@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@)))) (=> (= tmp%13@ (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@))) (=> (= tmp%14@ (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> (= tmp%15@ (Mul (Mul (Mul a4~34@ b4~36@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@)))) (=> (= tmp%16@ (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@))) (=> (= tmp%17@ (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%4 (= temp_4_0~1056@ temp_4_1~1121@))))))))))))) (=> (= temp_4_0~1056@ temp_4_1~1121@) (=> (= temp_5_0~1382@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ c5~46@)) (Add (Mul a5~42@ a5~42@) (Mul 0 d5~48@))) (Mul (Mul (Mul 73 a5~42@) (Mul c5~46@ a5~42@)) (Mul (Add d5~48@ b5~44@) (Mul 9 b5~44@))))) (=> (= temp_5_1~1483@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ c5~46@)) (Add (Mul a5~42@ a5~42@) (Mul 0 d5~48@))) (Mul (Mul (Mul 73 a5~42@) (Mul c5~46@ a5~42@)) (Mul (Add d5~48@ b5~44@) (Mul 9 b5~44@))))) (=> (= tmp%18@ (= temp_5_0~1382@ temp_5_1~1483@)) (and (=> %%location_label%%5 tmp%18@) (=> tmp%18@ (=> (= temp_6_0~1555@ (Sub (Mul (Mul (Mul c6~54@ d6~56@) d6~56@) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@)) (Mul a6~50@ (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1612@ (Sub (Mul (Mul (Mul c6~54@ d6~56@) d6~56@) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@)) (Mul a6~50@ (Mul b6~52@ b6~52@))))) (=> (= tmp%19@ (= temp_6_0~1555@ temp_6_1~1612@)) (and (=> %%location_label%%6 tmp%19@) (=> tmp%19@ (=> (= temp_7_0~1680@ (Mul (Mul b7~60@ (Mul (Mul b7~60@ a7~58@) (Add d7~64@ c7~62@))) (Sub (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@))))) (=> (= temp_7_1~1733@ (Mul (Mul (Mul b7~60@ (Mul b7~60@ a7~58@)) (Add d7~64@ c7~62@)) (Sub (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@))))) (and (=> (= tmp%20@ (Mul b7~60@ a7~58@)) (=> (= tmp%21@ (Add d7~64@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b7~60@ tmp%20@ tmp%21@) (=> %%location_label%%7 (= temp_7_0~1680@ temp_7_1~1733@))))) (=> (= temp_7_0~1680@ temp_7_1~1733@) (=> (= temp_8_0~1824@ (Add (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ a8~66@)) c8~70@) (Mul (Mul (Sub a8~66@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1877@ (Add (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ a8~66@)) c8~70@) (Mul (Mul (Mul (Sub a8~66@ b8~68@) d8~72@) a8~66@) (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ a8~66@))))) (and (=> (= tmp%22@ (Sub a8~66@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ d8~72@ a8~66@) (=> %%location_label%%8 (= temp_8_0~1824@ temp_8_1~1877@)))) (=> (= temp_8_0~1824@ temp_8_1~1877@) (=> (= temp_9_0~1972@ (Mul (Mul (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ b9~76@)) (Mul c9~78@ (Mul d9~80@ d9~80@))) (Mul (Add (Mul d9~80@ b9~76@) (Sub b9~76@ a9~74@)) (Add (Mul a9~74@ d9~80@) (Mul d9~80@ b9~76@))))) (=> (= temp_9_1~2033@ (Mul (Mul (Mul (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ b9~76@)) c9~78@) (Mul d9~80@ d9~80@)) (Mul (Add (Mul d9~80@ b9~76@) (Sub b9~76@ a9~74@)) (Add (Mul a9~74@ d9~80@) (Mul d9~80@ b9~76@))))) (and (=> (= tmp%23@ (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ b9~76@))) (=> (= tmp%24@ (Mul d9~80@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ c9~78@ tmp%24@) (=> %%location_label%%9 (= temp_9_0~1972@ temp_9_1~2033@))))) (=> (= temp_9_0~1972@ temp_9_1~2033@) (=> (= temp_10_0~2156@ (Mul (Mul (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ 34) (Add a10~82@ d10~88@))) (Mul (Add (Mul a10~82@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Sub c10~86@ a10~82@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~2249@ (Mul (Mul (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ 34) (Add a10~82@ d10~88@))) (Add (Mul (Mul a10~82@ a10~82@) (Mul (Sub c10~86@ a10~82@) (Mul b10~84@ d10~88@))) (Mul (Mul a10~82@ a10~82@) (Mul (Sub c10~86@ a10~82@) (Mul b10~84@ d10~88@)))))) (and (=> (= tmp%25@ (Mul a10~82@ a10~82@)) (=> (= tmp%26@ (Mul a10~82@ a10~82@)) (=> (= tmp%27@ (Mul (Sub c10~86@ a10~82@) (Mul b10~84@ d10~88@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%10 (= temp_10_0~2156@ temp_10_1~2249@)))))) (=> (= temp_10_0~2156@ temp_10_1~2249@) (=> (= temp_11_0~2376@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ b11~92@)) (Sub (Mul 33 c11~94@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~2453@ (Mul (Mul (Mul a11~90@ (Mul a11~90@ (Mul d11~96@ b11~92@))) (Sub (Mul 33 c11~94@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ c11~94@))))) (and (=> (= tmp%28@ (Mul d11~96@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a11~90@ a11~90@ tmp%28@) (=> (= tmp%29@ (Mul a11~90@ (Mul a11~90@ (Mul d11~96@ b11~92@)))) (=> (= tmp%30@ (Sub (Mul 33 c11~94@) (Mul a11~90@ b11~92@))) (=> (= tmp%31@ (Mul (Mul (Mul a11~90@ c11~94@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ c11~94@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> (= tmp%32@ (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ b11~92@))) (=> (= tmp%33@ (Sub (Mul 33 c11~94@) (Mul a11~90@ b11~92@))) (=> (= tmp%34@ (Mul (Mul (Mul a11~90@ c11~94@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ c11~94@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%11 (= temp_11_0~2376@ temp_11_1~2453@)))))))))))) (=> (= temp_11_0~2376@ temp_11_1~2453@) (=> (= temp_12_0~2692@ (Mul (Add (Mul (Mul b12~100@ 22) (Mul b12~100@ a12~98@)) (Sub (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)) (Mul b12~100@ (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2765@ (Mul (Add (Mul (Mul b12~100@ 22) (Mul b12~100@ a12~98@)) (Sub (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@))) (Mul (Mul (Mul (Mul c12~102@ d12~104@) c12~102@) d12~104@) (Mul b12~100@ (Mul b12~100@ a12~98@))))) (and (=> (= tmp%35@ (Mul c12~102@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ c12~102@ d12~104@) (=> %%location_label%%12 (= temp_12_0~2692@ temp_12_1~2765@)))) (=> (= temp_12_0~2692@ temp_12_1~2765@) (=> (= temp_13_0~2864@ (Mul (Add (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ c13~110@))) (Mul (Mul (Add a13~106@ a13~106@) (Add d13~112@ c13~110@)) (Mul (Add d13~112@ a13~106@) (Add b13~108@ a13~106@))))) (=> (= temp_13_1~2929@ (Mul (Add (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Mul (Mul b13~108@ d13~112@) (Mul a13~106@ c13~110@))) (Mul (Mul (Add a13~106@ a13~106@) (Add d13~112@ c13~110@)) (Mul (Add d13~112@ a13~106@) (Add b13~108@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b13~108@ d13~112@) (=> %%location_label%%13 (= temp_13_0~2864@ temp_13_1~2929@))) (=> (= temp_13_0~2864@ temp_13_1~2929@) (=> (= temp_14_0~3026@ (Mul (Mul (Add (Mul c14~118@ a14~114@) (Add a14~114@ a14~114@)) (Mul a14~114@ (Mul a14~114@ b14~116@))) (Sub (Mul (Mul c14~118@ c14~118@) b14~116@) (Mul (Mul 98 d14~120@) (Mul c14~118@ c14~118@))))) (=> (= temp_14_1~3095@ (Mul (Mul (Add (Mul c14~118@ a14~114@) (Add a14~114@ a14~114@)) (Mul a14~114@ (Mul b14~116@ a14~114@))) (Sub (Mul (Mul c14~118@ c14~118@) b14~116@) (Mul (Mul 98 d14~120@) (Mul c14~118@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b14~116@ a14~114@) (=> (= tmp%36@ (Add (Mul c14~118@ a14~114@) (Add a14~114@ a14~114@))) (=> (= tmp%37@ (Mul b14~116@ a14~114@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ a14~114@ tmp%37@) (=> (= tmp%38@ (Add (Mul c14~118@ a14~114@) (Add a14~114@ a14~114@))) (=> (= tmp%39@ (Mul a14~114@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ a14~114@ tmp%39@) (=> %%location_label%%14 (= temp_14_0~3026@ temp_14_1~3095@))))))))) (=> (= temp_14_0~3026@ temp_14_1~3095@) (=> (= temp_15_0~3228@ (Mul (Mul (Sub (Sub d15~128@ a15~122@) (Add a15~122@ a15~122@)) c15~126@) (Mul (Add (Mul b15~124@ a15~122@) (Mul a15~122@ c15~126@)) (Mul (Mul a15~122@ b15~124@) (Mul a15~122@ b15~124@))))) (=> (= temp_15_1~3281@ (Mul (Mul (Sub (Sub d15~128@ a15~122@) (Add a15~122@ a15~122@)) c15~126@) (Mul (Add (Mul b15~124@ a15~122@) (Mul a15~122@ c15~126@)) (Mul a15~122@ (Mul b15~124@ (Mul a15~122@ b15~124@)))))) (and (=> (= tmp%40@ (Mul a15~122@ b15~124@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a15~122@ b15~124@ tmp%40@) (=> (= tmp%41@ (Mul (Sub (Sub d15~128@ a15~122@) (Add a15~122@ a15~122@)) c15~126@)) (=> (= tmp%42@ (Add (Mul b15~124@ a15~122@) (Mul a15~122@ c15~126@))) (=> (= tmp%43@ (Mul a15~122@ (Mul b15~124@ (Mul a15~122@ b15~124@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ tmp%42@ tmp%43@) (=> (= tmp%44@ (Mul (Sub (Sub d15~128@ a15~122@) (Add a15~122@ a15~122@)) c15~126@)) (=> (= tmp%45@ (Add (Mul b15~124@ a15~122@) (Mul a15~122@ c15~126@))) (=> (= tmp%46@ (Mul (Mul a15~122@ b15~124@) (Mul a15~122@ b15~124@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%44@ tmp%45@ tmp%46@) (=> %%location_label%%15 (= temp_15_0~3228@ temp_15_1~3281@)))))))))))) (=> (= temp_15_0~3228@ temp_15_1~3281@) (=> (= temp_16_0~3492@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) (Add a16~130@ a16~130@)) (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ b16~132@)) (Mul (Add b16~132@ a16~130@) (Mul d16~136@ 93))))) (=> (= temp_16_1~3569@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) (Add a16~130@ a16~130@)) (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ b16~132@)) (Mul (Add b16~132@ a16~130@) (Mul 93 d16~136@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. 93 d16~136@) (=> (= tmp%47@ (Mul (Mul (Mul d16~136@ a16~130@) (Add a16~130@ a16~130@)) (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@)))) (=> (= tmp%48@ (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ b16~132@))) (=> (= tmp%49@ (Mul (Add b16~132@ a16~130@) (Mul 93 d16~136@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%47@ tmp%48@ tmp%49@) (=> (= tmp%50@ (Mul (Mul (Mul d16~136@ a16~130@) (Add a16~130@ a16~130@)) (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@)))) (=> (= tmp%51@ (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ b16~132@))) (=> (= tmp%52@ (Mul (Add b16~132@ a16~130@) (Mul d16~136@ 93))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%50@ tmp%51@ tmp%52@) (=> %%location_label%%16 (= temp_16_0~3492@ temp_16_1~3569@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
