...
(declare-const temp_1_0~417@ Int)
(declare-const temp_1_1~482@ Int)
...
(declare-const temp_7_1~1554@ Int)
(declare-const temp_8_0~1651@ Int)
(declare-const temp_8_1~1720@ Int)
(declare-const temp_9_0~1803@ Int)
(declare-const temp_9_1~1856@ Int)
(declare-const temp_10_0~1989@ Int)
(declare-const temp_10_1~2050@ Int)
(declare-const temp_11_0~2149@ Int)
(declare-const temp_11_1~2214@ Int)
(declare-const temp_12_0~2451@ Int)
(declare-const temp_12_1~2536@ Int)
(declare-const temp_13_0~2779@ Int)
(declare-const temp_13_1~2844@ Int)
(declare-const temp_14_0~2932@ Int)
(declare-const temp_14_1~3021@ Int)
(declare-const temp_15_0~3136@ Int)
(declare-const temp_15_1~3197@ Int)
(declare-const temp_16_0~3414@ Int)
(declare-const temp_16_1~3487@ Int)
(declare-const temp_17_0~3580@ Int)
(declare-const temp_17_1~3645@ Int)
(declare-const temp_18_0~3738@ Int)
(declare-const temp_18_1~3803@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul b0~4@ (Mul (Mul (Sub c0~6@ b0~4@) (Add d0~8@ a0~2@)) (Sub (Sub b0~4@ c0~6@) a0~2@)))) (=> (= temp_0_1~306@ (Mul b0~4@ (Mul (Sub c0~6@ b0~4@) (Mul (Add d0~8@ a0~2@) (Sub (Sub b0~4@ c0~6@) a0~2@))))) (and (=> (= tmp%1@ (Sub c0~6@ b0~4@)) (=> (= tmp%2@ (Add d0~8@ a0~2@)) (=> (= tmp%3@ (Sub (Sub b0~4@ c0~6@) a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~306@)))))) (=> (= temp_0_0~273@ temp_0_1~306@) (=> (= temp_1_0~417@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ b1~12@)) (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~482@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ b1~12@)) (Mul b1~12@ d1~16@)) (Mul b1~12@ d1~16@)))) (and (=> (= tmp%4@ (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= tmp%5@ (Mul b1~12@ d1~16@)) (=> (= tmp%6@ (Mul b1~12@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%1 (= temp_1_0~417@ temp_1_1~482@)))))) (=> (= temp_1_0~417@ temp_1_1~482@) (=> (= temp_2_0~597@ (Mul (Mul (Add (Mul c2~22@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Sub d2~24@ d2~24@) (Mul d2~24@ c2~22@))) (Mul (Add (Mul a2~18@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~662@ (Mul (Mul (Add (Mul c2~22@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Sub d2~24@ d2~24@) (Mul d2~24@ c2~22@))) (Mul (Add (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ a2~18@) (=> %%location_label%%2 (= temp_2_0~597@ temp_2_1~662@))) (=> (= temp_2_0~597@ temp_2_1~662@) (=> (= temp_3_0~751@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ c3~30@) b3~28@)) (Add (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~804@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ c3~30@) b3~28@)) (Mul (Add (Mul b3~28@ d3~32@) (Mul c3~30@ c3~30@)) (Mul b3~28@ d3~32@)))) (and (=> (= tmp%7@ (Mul b3~28@ d3~32@)) (=> (= tmp%8@ (Mul c3~30@ c3~30@)) (=> (= tmp%9@ (Mul b3~28@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%3 (= temp_3_0~751@ temp_3_1~804@)))))) (=> (= temp_3_0~751@ temp_3_1~804@) (=> (= temp_4_0~911@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) (Add (Mul a4~34@ d4~40@) (Add a4~34@ d4~40@))) (Mul (Add (Mul d4~40@ b4~36@) (Mul b4~36@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Sub b4~36@ c4~38@))))) (=> (= temp_4_1~992@ (Mul (Add (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) (Mul a4~34@ d4~40@)) (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) (Add a4~34@ d4~40@))) (Mul (Add (Mul d4~40@ b4~36@) (Mul b4~36@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Sub b4~36@ c4~38@))))) (and (=> (= tmp%10@ (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@))) (=> (= tmp%11@ (Mul a4~34@ d4~40@)) (=> (= tmp%12@ (Add a4~34@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%4 (= temp_4_0~911@ temp_4_1~992@)))))) (=> (= temp_4_0~911@ temp_4_1~992@) (=> (= temp_5_0~1107@ (Sub (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ b5~44@)) (Mul (Sub d5~48@ 97) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ b5~44@)) c5~46@))) (=> (= temp_5_1~1172@ (Sub (Mul (Mul (Sub d5~48@ 97) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ b5~44@)) c5~46@))) (and (=> (= tmp%13@ (Mul (Sub d5~48@ 97) (Mul d5~48@ b5~44@))) (=> (= tmp%14@ (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ b5~44@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%5 (= temp_5_0~1107@ temp_5_1~1172@))))) (=> (= temp_5_0~1107@ temp_5_1~1172@) (=> (= temp_6_0~1293@ (Mul (Mul (Add (Mul b6~52@ b6~52@) (Mul c6~54@ d6~56@)) (Sub (Sub c6~54@ a6~50@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@)) (Add (Mul a6~50@ b6~52@) (Mul b6~52@ a6~50@))))) (=> (= temp_6_1~1374@ (Mul (Mul (Add (Mul b6~52@ b6~52@) (Mul c6~54@ d6~56@)) (Sub (Sub c6~54@ a6~50@) (Mul d6~56@ b6~52@))) (Add (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@)) (Mul a6~50@ b6~52@)) (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@)) (Mul b6~52@ a6~50@))))) (and (=> (= tmp%15@ (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@))) (=> (= tmp%16@ (Mul a6~50@ b6~52@)) (=> (= tmp%17@ (Mul b6~52@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%6 (= temp_6_0~1293@ temp_6_1~1374@)))))) (=> (= temp_6_0~1293@ temp_6_1~1374@) (=> (= temp_7_0~1489@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@))) (Mul (Add (Mul a7~58@ d7~64@) (Mul d7~64@ c7~62@)) (Sub (Mul d7~64@ d7~64@) (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1554@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ b7~60@))) (Mul (Add (Mul a7~58@ d7~64@) (Mul d7~64@ c7~62@)) (Sub (Mul d7~64@ d7~64@) (Mul d7~64@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1489@ temp_7_1~1554@))) (=> (= temp_7_0~1489@ temp_7_1~1554@) (=> (= temp_8_0~1651@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul 87 a8~66@)) (Mul a8~66@ (Mul a8~66@ b8~68@))) (Mul (Mul c8~70@ (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@))))) (=> (= temp_8_1~1720@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul 87 a8~66@)) (Mul (Mul a8~66@ a8~66@) b8~68@)) (Mul (Mul c8~70@ (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a8~66@ a8~66@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1651@ temp_8_1~1720@))) (=> (= temp_8_0~1651@ temp_8_1~1720@) (=> (= temp_9_0~1803@ (Mul (Mul d9~80@ (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Add a9~74@ d9~80@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~1856@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Add a9~74@ d9~80@) (Mul d9~80@ c9~78@))) (Mul d9~80@ (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ a9~74@))))) (and (=> (= tmp%18@ (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Add a9~74@ d9~80@) (Mul d9~80@ c9~78@)))) (=> (= tmp%19@ (Mul d9~80@ (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ a9~74@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%9 (= temp_9_0~1803@ temp_9_1~1856@))))) (=> (= temp_9_0~1803@ temp_9_1~1856@) (=> (= temp_10_0~1989@ (Sub (Sub (Mul (Mul d10~88@ b10~84@) b10~84@) (Mul (Mul b10~84@ c10~86@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul d10~88@ b10~84@) (Sub a10~82@ c10~86@)) (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ c10~86@))))) (=> (= temp_10_1~2050@ (Sub (Sub (Mul (Mul d10~88@ b10~84@) b10~84@) (Mul (Mul b10~84@ c10~86@) (Mul a10~82@ b10~84@))) (Mul (Mul d10~88@ (Mul b10~84@ (Sub a10~82@ c10~86@))) (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ c10~86@))))) (and (=> (= tmp%20@ (Sub a10~82@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d10~88@ b10~84@ tmp%20@) (=> %%location_label%%10 (= temp_10_0~1989@ temp_10_1~2050@)))) (=> (= temp_10_0~1989@ temp_10_1~2050@) (=> (= temp_11_0~2149@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ b11~92@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))) (Mul (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))))) (=> (= temp_11_1~2214@ (Mul (Mul (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ b11~92@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))) (Mul (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))))) (and (=> (= tmp%21@ (Mul c11~94@ b11~92@)) (=> (= tmp%22@ (Mul d11~96@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> (= tmp%23@ (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ b11~92@))) (=> (= tmp%24@ (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))) (=> (= tmp%25@ (Mul (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> (= tmp%26@ (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ b11~92@))) (=> (= tmp%27@ (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))) (=> (= tmp%28@ (Mul (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> %%location_label%%11 (= temp_11_0~2149@ temp_11_1~2214@))))))))))))) (=> (= temp_11_0~2149@ temp_11_1~2214@) (=> (= temp_12_0~2451@ (Mul (Add (Add (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ a12~98@))) (Mul (Mul (Sub d12~104@ d12~104@) (Add a12~98@ a12~98@)) (Mul (Add 32 a12~98@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2536@ (Mul (Add (Add (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ a12~98@))) (Mul (Mul (Sub d12~104@ d12~104@) (Add a12~98@ a12~98@)) (Add (Mul 32 (Mul a12~98@ c12~102@)) (Mul a12~98@ (Mul a12~98@ c12~102@)))))) (and (=> (= tmp%29@ (Add (Add (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ a12~98@)))) (=> (= tmp%30@ (Mul (Sub d12~104@ d12~104@) (Add a12~98@ a12~98@))) (=> (= tmp%31@ (Add (Mul 32 (Mul a12~98@ c12~102@)) (Mul a12~98@ (Mul a12~98@ c12~102@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> (= tmp%32@ (Mul a12~98@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. 32 a12~98@ tmp%32@) (=> (= tmp%33@ (Add (Add (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ a12~98@)))) (=> (= tmp%34@ (Mul (Sub d12~104@ d12~104@) (Add a12~98@ a12~98@))) (=> (= tmp%35@ (Mul (Add 32 a12~98@) (Mul a12~98@ c12~102@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ tmp%34@ tmp%35@) (=> %%location_label%%12 (= temp_12_0~2451@ temp_12_1~2536@)))))))))))) (=> (= temp_12_0~2451@ temp_12_1~2536@) (=> (= temp_13_0~2779@ (Mul (Add (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Mul b13~108@ a13~106@) (Add d13~112@ c13~110@))) (Add (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2844@ (Mul (Add (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Mul b13~108@ a13~106@) (Add d13~112@ c13~110@))) (Add (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ a13~106@))))) (=> (= tmp%36@ (= temp_13_0~2779@ temp_13_1~2844@)) (and (=> %%location_label%%13 tmp%36@) (=> tmp%36@ (=> (= temp_14_0~2932@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Mul c14~118@ a14~114@) c14~118@)) (Mul (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ b14~116@)) (Add (Mul 27 d14~120@) (Mul c14~118@ a14~114@))))) (=> (= temp_14_1~3021@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Mul c14~118@ a14~114@) c14~118@)) (Add (Mul (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ b14~116@)) (Mul 27 d14~120@)) (Mul (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ b14~116@)) (Mul c14~118@ a14~114@))))) (and (=> (= tmp%37@ (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ b14~116@))) (=> (= tmp%38@ (Mul 27 d14~120@)) (=> (= tmp%39@ (Mul c14~118@ a14~114@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%37@ tmp%38@ tmp%39@) (=> %%location_label%%14 (= temp_14_0~2932@ temp_14_1~3021@)))))) (=> (= temp_14_0~2932@ temp_14_1~3021@) (=> (= temp_15_0~3136@ (Mul (Mul (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Add b15~124@ c15~126@))) (Add (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ c15~126@)) (Mul d15~128@ (Mul d15~128@ b15~124@))))) (=> (= temp_15_1~3197@ (Mul (Mul (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Add b15~124@ c15~126@))) (Add (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ c15~126@)) (Mul d15~128@ (Mul d15~128@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c15~126@ b15~124@) (=> (= tmp%40@ (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ d15~128@))) (=> (= tmp%41@ (Mul (Mul a15~122@ a15~122@) (Add b15~124@ c15~126@))) (=> (= tmp%42@ (Add (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ c15~126@)) (Mul d15~128@ (Mul d15~128@ b15~124@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ tmp%41@ tmp%42@) (=> (= tmp%43@ (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ d15~128@))) (=> (= tmp%44@ (Mul (Mul a15~122@ a15~122@) (Add b15~124@ c15~126@))) (=> (= tmp%45@ (Add (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ c15~126@)) (Mul d15~128@ (Mul d15~128@ b15~124@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%43@ tmp%44@ tmp%45@) (=> %%location_label%%15 (= temp_15_0~3136@ temp_15_1~3197@))))))))))) (=> (= temp_15_0~3136@ temp_15_1~3197@) (=> (= temp_16_0~3414@ (Mul (Add (Mul (Mul a16~130@ c16~134@) (Sub d16~136@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ d16~136@))) (Mul (Mul (Sub d16~136@ d16~136@) (Mul d16~136@ a16~130@)) (Mul (Mul a16~130@ d16~136@) 43)))) (=> (= temp_16_1~3487@ (Mul (Add (Mul (Mul a16~130@ c16~134@) (Sub d16~136@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ d16~136@))) (Mul (Mul (Sub d16~136@ d16~136@) (Mul a16~130@ d16~136@)) (Mul (Mul a16~130@ d16~136@) 43)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a16~130@ d16~136@) (=> %%location_label%%16 (= temp_16_0~3414@ temp_16_1~3487@))) (=> (= temp_16_0~3414@ temp_16_1~3487@) (=> (= temp_17_0~3580@ (Mul (Mul (Mul (Mul a17~138@ d17~144@) (Mul b17~140@ d17~144@)) (Mul (Add c17~142@ d17~144@) (Mul a17~138@ c17~142@))) (Add (Sub (Mul c17~142@ a17~138@) (Mul c17~142@ a17~138@)) (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ d17~144@))))) (=> (= temp_17_1~3645@ (Mul (Mul (Mul (Mul a17~138@ d17~144@) (Mul b17~140@ d17~144@)) (Mul (Add c17~142@ d17~144@) (Mul a17~138@ c17~142@))) (Add (Sub (Mul c17~142@ a17~138@) (Mul c17~142@ a17~138@)) (Mul (Mul a17~138@ c17~142@) (Mul c17~142@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a17~138@ c17~142@) (=> %%location_label%%17 (= temp_17_0~3580@ temp_17_1~3645@))) (=> (= temp_17_0~3580@ temp_17_1~3645@) (=> (= temp_18_0~3738@ (Mul (Add (Mul (Mul c18~150@ a18~146@) (Add c18~150@ a18~146@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ d18~152@))) (Add (Sub (Mul a18~146@ c18~150@) (Mul d18~152@ a18~146@)) (Mul (Mul a18~146@ d18~152@) (Mul b18~148@ c18~150@))))) (=> (= temp_18_1~3803@ (Mul (Add (Mul (Mul c18~150@ a18~146@) (Add c18~150@ a18~146@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ d18~152@))) (Add (Sub (Mul a18~146@ c18~150@) (Mul a18~146@ d18~152@)) (Mul (Mul a18~146@ d18~152@) (Mul b18~148@ c18~150@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a18~146@ d18~152@) (=> %%location_label%%18 (= temp_18_0~3738@ temp_18_1~3803@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
