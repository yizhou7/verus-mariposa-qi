...
(declare-const temp_5_1~1214@ Int)
(declare-const temp_6_0~1415@ Int)
(declare-const temp_6_1~1488@ Int)
(declare-const temp_7_0~1727@ Int)
(declare-const temp_7_1~1812@ Int)
(declare-const temp_8_0~1899@ Int)
(declare-const temp_8_1~1952@ Int)
(declare-const temp_9_0~2063@ Int)
(declare-const temp_9_1~2124@ Int)
(declare-const temp_10_0~2235@ Int)
(declare-const temp_10_1~2300@ Int)
(declare-const temp_11_0~2377@ Int)
(declare-const temp_11_1~2426@ Int)
(declare-const temp_12_0~2527@ Int)
(declare-const temp_12_1~2600@ Int)
(declare-const temp_13_0~2817@ Int)
(declare-const temp_13_1~2878@ Int)
(declare-const temp_14_0~3035@ Int)
(declare-const temp_14_1~3112@ Int)
(declare-const temp_15_0~3188@ Int)
(declare-const temp_15_1~3249@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Sub b0~4@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) c0~6@) (Mul (Sub a0~2@ d0~8@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Sub b0~4@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul b0~4@ b0~4@) c0~6@) (Mul (Sub a0~2@ d0~8@) (Mul a0~2@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ a0~2@) (=> (= tmp%1@ (Mul (Sub b0~4@ d0~8@) (Mul c0~6@ d0~8@))) (=> (= tmp%2@ (Mul a0~2@ a0~2@)) (=> (= tmp%3@ (Mul d0~8@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> (= tmp%4@ (Mul (Sub b0~4@ d0~8@) (Mul c0~6@ d0~8@))) (=> (= tmp%5@ (Mul a0~2@ a0~2@)) (=> (= tmp%6@ (Mul a0~2@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))))))))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~511@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) b1~12@) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Add c1~14@ c1~14@) (Mul b1~12@ d1~16@)) (Add (Mul b1~12@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~572@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) b1~12@) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Add c1~14@ c1~14@) (Mul d1~16@ b1~12@)) (Add (Mul b1~12@ b1~12@) (Mul c1~14@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ b1~12@) (=> %%location_label%%1 (= temp_1_0~511@ temp_1_1~572@))) (=> (= temp_1_0~511@ temp_1_1~572@) (=> (= temp_2_0~653@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@)) (Add (Mul a2~18@ c2~22@) (Add b2~20@ a2~18@))) (Mul b2~20@ (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~706@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@)) (Add (Mul a2~18@ c2~22@) (Add b2~20@ a2~18@))) (Mul b2~20@ (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ c2~22@) (=> (= tmp%7@ (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@)) (Add (Mul a2~18@ c2~22@) (Add b2~20@ a2~18@)))) (=> (= tmp%8@ (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ b2~20@ tmp%8@) (=> (= tmp%9@ (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@)) (Add (Mul a2~18@ c2~22@) (Add b2~20@ a2~18@)))) (=> (= tmp%10@ (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ b2~20@ tmp%10@) (=> %%location_label%%2 (= temp_2_0~653@ temp_2_1~706@))))))))) (=> (= temp_2_0~653@ temp_2_1~706@) (=> (= temp_3_0~887@ (Mul (Mul a3~26@ (Mul (Add c3~30@ b3~28@) (Mul a3~26@ a3~26@))) (Sub (Add (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ a3~26@) (Sub c3~30@ c3~30@))))) (=> (= temp_3_1~936@ (Mul (Mul a3~26@ (Mul (Add c3~30@ b3~28@) (Mul a3~26@ a3~26@))) (Sub (Mul (Add d3~32@ c3~30@) c3~30@) (Mul (Mul c3~30@ a3~26@) (Sub c3~30@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d3~32@ c3~30@ c3~30@) (=> %%location_label%%3 (= temp_3_0~887@ temp_3_1~936@))) (=> (= temp_3_0~887@ temp_3_1~936@) (=> (= temp_4_0~1023@ (Mul (Mul (Mul a4~34@ (Mul b4~36@ c4~38@)) (Sub (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@)) (Add (Mul c4~38@ d4~40@) d4~40@)))) (=> (= temp_4_1~1080@ (Mul (Mul (Mul a4~34@ (Mul b4~36@ c4~38@)) (Sub (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ b4~36@)) (Add (Mul c4~38@ d4~40@) d4~40@)))) (and (=> (= tmp%11@ (Mul d4~40@ d4~40@)) (=> (= tmp%12@ (Mul a4~34@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%4 (= temp_4_0~1023@ temp_4_1~1080@))))) (=> (= temp_4_0~1023@ temp_4_1~1080@) (=> (= temp_5_0~1165@ (Mul (Sub c5~46@ (Mul (Sub c5~46@ d5~48@) d5~48@)) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Sub d5~48@ d5~48@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~1214@ (Mul (Sub c5~46@ (Mul (Sub c5~46@ d5~48@) d5~48@)) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Sub d5~48@ d5~48@))))) (and (=> (= tmp%13@ (Mul a5~42@ b5~44@)) (=> (= tmp%14@ (Sub d5~48@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> (= tmp%15@ (Sub c5~46@ (Mul (Sub c5~46@ d5~48@) d5~48@))) (=> (= tmp%16@ (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@))) (=> (= tmp%17@ (Mul (Mul a5~42@ b5~44@) (Sub d5~48@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> (= tmp%18@ (Sub c5~46@ (Mul (Sub c5~46@ d5~48@) d5~48@))) (=> (= tmp%19@ (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@))) (=> (= tmp%20@ (Mul (Sub d5~48@ d5~48@) (Mul a5~42@ b5~44@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%5 (= temp_5_0~1165@ temp_5_1~1214@))))))))))))) (=> (= temp_5_0~1165@ temp_5_1~1214@) (=> (= temp_6_0~1415@ (Mul (Mul (Mul (Mul b6~52@ c6~54@) (Mul 25 d6~56@)) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@)) (Sub d6~56@ (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1488@ (Mul (Mul (Mul (Mul (Mul b6~52@ c6~54@) 25) d6~56@) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@)) (Sub d6~56@ (Mul c6~54@ c6~54@))))) (and (=> (= tmp%21@ (Mul (Mul (Mul b6~52@ c6~54@) 25) d6~56@)) (=> (= tmp%22@ (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ a6~50@))) (=> (= tmp%23@ (Mul (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@)) (Sub d6~56@ (Mul c6~54@ c6~54@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> (= tmp%24@ (Mul b6~52@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ 25 d6~56@) (=> (= tmp%25@ (Mul (Mul b6~52@ c6~54@) (Mul 25 d6~56@))) (=> (= tmp%26@ (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ a6~50@))) (=> (= tmp%27@ (Mul (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@)) (Sub d6~56@ (Mul c6~54@ c6~54@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%6 (= temp_6_0~1415@ temp_6_1~1488@)))))))))))) (=> (= temp_6_0~1415@ temp_6_1~1488@) (=> (= temp_7_0~1727@ (Sub (Mul (Mul (Add a7~58@ c7~62@) (Mul c7~62@ a7~58@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ c7~62@)) (Sub (Sub 18 c7~62@) (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1812@ (Sub (Mul (Add (Mul a7~58@ (Mul c7~62@ a7~58@)) (Mul c7~62@ (Mul c7~62@ a7~58@))) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ c7~62@)) (Sub (Sub 18 c7~62@) (Mul a7~58@ b7~60@))))) (and (=> (= tmp%28@ (Mul c7~62@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a7~58@ c7~62@ tmp%28@) (=> %%location_label%%7 (= temp_7_0~1727@ temp_7_1~1812@)))) (=> (= temp_7_0~1727@ temp_7_1~1812@) (=> (= temp_8_0~1899@ (Mul (Sub (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) c8~70@) (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1952@ (Mul (Sub (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) c8~70@) (Mul (Mul a8~66@ b8~68@) (Mul (Mul a8~66@ b8~68@) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ d8~72@)))))) (and (=> (= tmp%29@ (Mul a8~66@ b8~68@)) (=> (= tmp%30@ (Mul a8~66@ b8~68@)) (=> (= tmp%31@ (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> %%location_label%%8 (= temp_8_0~1899@ temp_8_1~1952@)))))) (=> (= temp_8_0~1899@ temp_8_1~1952@) (=> (= temp_9_0~2063@ (Mul (Mul (Mul (Sub c9~78@ c9~78@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Sub c9~78@ b9~76@))) (Mul (Add (Mul c9~78@ b9~76@) (Mul a9~74@ d9~80@)) (Mul b9~76@ (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~2124@ (Mul (Mul (Mul (Sub c9~78@ c9~78@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Sub c9~78@ b9~76@))) (Mul (Mul (Add (Mul c9~78@ b9~76@) (Mul a9~74@ d9~80@)) b9~76@) (Mul a9~74@ b9~76@)))) (and (=> (= tmp%32@ (Add (Mul c9~78@ b9~76@) (Mul a9~74@ d9~80@))) (=> (= tmp%33@ (Mul a9~74@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ b9~76@ tmp%33@) (=> %%location_label%%9 (= temp_9_0~2063@ temp_9_1~2124@))))) (=> (= temp_9_0~2063@ temp_9_1~2124@) (=> (= temp_10_0~2235@ (Mul (Sub (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Sub b10~84@ a10~82@))) (Sub (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ d10~88@)) (Mul (Mul c10~86@ d10~88@) (Sub c10~86@ a10~82@))))) (=> (= temp_10_1~2300@ (Mul (Sub (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Sub b10~84@ a10~82@))) (Sub (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ c10~86@) (Sub c10~86@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d10~88@ c10~86@) (=> %%location_label%%10 (= temp_10_0~2235@ temp_10_1~2300@))) (=> (= temp_10_0~2235@ temp_10_1~2300@) (=> (= temp_11_0~2377@ (Sub (Mul (Add (Mul c11~94@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (Mul c11~94@ a11~90@) a11~90@)) (Mul c11~94@ (Mul (Mul c11~94@ a11~90@) (Add a11~90@ d11~96@))))) (=> (= temp_11_1~2426@ (Sub (Mul (Add (Mul c11~94@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (Mul c11~94@ a11~90@) a11~90@)) (Mul c11~94@ (Mul (Mul a11~90@ c11~94@) (Add a11~90@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c11~94@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2377@ temp_11_1~2426@))) (=> (= temp_11_0~2377@ temp_11_1~2426@) (=> (= temp_12_0~2527@ (Mul (Add (Mul (Sub a12~98@ a12~98@) (Mul b12~100@ b12~100@)) (Mul (Mul c12~102@ a12~98@) (Sub d12~104@ d12~104@))) (Mul (Sub (Mul a12~98@ c12~102@) a12~98@) (Mul (Mul c12~102@ 96) (Mul d12~104@ c12~102@))))) (=> (= temp_12_1~2600@ (Mul (Add (Mul (Sub a12~98@ a12~98@) (Mul b12~100@ b12~100@)) (Mul (Mul c12~102@ a12~98@) (Sub d12~104@ d12~104@))) (Mul (Sub (Mul a12~98@ c12~102@) a12~98@) (Mul (Mul 96 c12~102@) (Mul d12~104@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 96 c12~102@) (=> (= tmp%34@ (Add (Mul (Sub a12~98@ a12~98@) (Mul b12~100@ b12~100@)) (Mul (Mul c12~102@ a12~98@) (Sub d12~104@ d12~104@)))) (=> (= tmp%35@ (Sub (Mul a12~98@ c12~102@) a12~98@)) (=> (= tmp%36@ (Mul (Mul 96 c12~102@) (Mul d12~104@ c12~102@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ tmp%35@ tmp%36@) (=> (= tmp%37@ (Add (Mul (Sub a12~98@ a12~98@) (Mul b12~100@ b12~100@)) (Mul (Mul c12~102@ a12~98@) (Sub d12~104@ d12~104@)))) (=> (= tmp%38@ (Sub (Mul a12~98@ c12~102@) a12~98@)) (=> (= tmp%39@ (Mul (Mul c12~102@ 96) (Mul d12~104@ c12~102@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%37@ tmp%38@ tmp%39@) (=> %%location_label%%12 (= temp_12_0~2527@ temp_12_1~2600@))))))))))) (=> (= temp_12_0~2527@ temp_12_1~2600@) (=> (= temp_13_0~2817@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Mul c13~110@ b13~108@)) (Sub (Mul c13~110@ a13~106@) (Mul d13~112@ d13~112@))) (Mul (Mul a13~106@ (Mul a13~106@ b13~108@)) (Mul (Sub d13~112@ b13~108@) (Sub b13~108@ b13~108@))))) (=> (= temp_13_1~2878@ (Mul (Mul (Mul a13~106@ (Mul a13~106@ b13~108@)) (Mul (Sub d13~112@ b13~108@) (Sub b13~108@ b13~108@))) (Mul (Mul (Mul c13~110@ a13~106@) (Mul c13~110@ b13~108@)) (Sub (Mul c13~110@ a13~106@) (Mul d13~112@ d13~112@))))) (and (=> (= tmp%40@ (Mul (Mul a13~106@ (Mul a13~106@ b13~108@)) (Mul (Sub d13~112@ b13~108@) (Sub b13~108@ b13~108@)))) (=> (= tmp%41@ (Mul (Mul (Mul c13~110@ a13~106@) (Mul c13~110@ b13~108@)) (Sub (Mul c13~110@ a13~106@) (Mul d13~112@ d13~112@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%40@ tmp%41@) (=> %%location_label%%13 (= temp_13_0~2817@ temp_13_1~2878@))))) (=> (= temp_13_0~2817@ temp_13_1~2878@) (=> (= temp_14_0~3035@ (Add (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ b14~116@)) (Mul (Mul c14~118@ d14~120@) (Mul c14~118@ c14~118@))) (Sub (Add (Add a14~114@ b14~116@) (Mul d14~120@ b14~116@)) (Mul (Mul b14~116@ c14~118@) (Mul a14~114@ 75))))) (=> (= temp_14_1~3112@ (Add (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ b14~116@)) (Mul (Mul c14~118@ d14~120@) (Mul c14~118@ c14~118@))) (Sub (Add (Add a14~114@ b14~116@) (Mul d14~120@ b14~116@)) (Mul (Mul b14~116@ c14~118@) (Mul a14~114@ 75))))) (=> (= tmp%42@ (= temp_14_0~3035@ temp_14_1~3112@)) (and (=> %%location_label%%14 tmp%42@) (=> tmp%42@ (=> (= temp_15_0~3188@ (Mul (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ a15~122@))) (Mul (Mul (Mul b15~124@ a15~122@) c15~126@) (Mul (Mul d15~128@ d15~128@) (Mul c15~126@ d15~128@))))) (=> (= temp_15_1~3249@ (Mul (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ a15~122@))) (Mul (Mul b15~124@ (Mul a15~122@ c15~126@)) (Mul (Mul d15~128@ d15~128@) (Mul c15~126@ d15~128@))))) (=> (ens%main!nl_basics.lemma_mul_is_associative. b15~124@ a15~122@ c15~126@) (=> %%location_label%%15 (= temp_15_0~3188@ temp_15_1~3249@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
