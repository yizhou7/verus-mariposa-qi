...
(declare-const temp_1_1~644@ Int)
(declare-const temp_2_0~751@ Int)
(declare-const temp_2_1~824@ Int)
(declare-const temp_3_0~923@ Int)
(declare-const temp_3_1~988@ Int)
(declare-const temp_4_0~1213@ Int)
(declare-const temp_4_1~1278@ Int)
(declare-const temp_5_0~1375@ Int)
(declare-const temp_5_1~1436@ Int)
(declare-const temp_6_0~1653@ Int)
(declare-const temp_6_1~1718@ Int)
(declare-const temp_7_0~1807@ Int)
(declare-const temp_7_1~1868@ Int)
(declare-const temp_8_0~1975@ Int)
(declare-const temp_8_1~2036@ Int)
(declare-const temp_9_0~2125@ Int)
(declare-const temp_9_1~2178@ Int)
(declare-const temp_10_0~2301@ Int)
(declare-const temp_10_1~2382@ Int)
(declare-const temp_11_0~2477@ Int)
(declare-const temp_11_1~2538@ Int)
(declare-const temp_12_0~2618@ Int)
(declare-const temp_12_1~2683@ Int)
(declare-const temp_13_0~2772@ Int)
(declare-const temp_13_1~2833@ Int)
(declare-const temp_14_0~3060@ Int)
(declare-const temp_14_1~3137@ Int)
(declare-const temp_15_0~3290@ Int)
(declare-const temp_15_1~3355@ Int)
(declare-const temp_16_0~3450@ Int)
(declare-const temp_16_1~3511@ Int)
(declare-const temp_17_0~3650@ Int)
(declare-const temp_17_1~3711@ Int)
(declare-const temp_18_0~3796@ Int)
(declare-const temp_18_1~3853@ Int)
(declare-const temp_19_0~3929@ Int)
(declare-const temp_19_1~3990@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Sub (Mul b0~4@ c0~6@) c0~6@)) (Mul (Add (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ a0~2@)) (Sub (Mul b0~4@ c0~6@) c0~6@)) (Mul (Add (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@))))) (and (=> (= tmp%1@ (Mul a0~2@ a0~2@)) (=> (= tmp%2@ (Mul b0~4@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> (= tmp%3@ (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ a0~2@))) (=> (= tmp%4@ (Sub (Mul b0~4@ c0~6@) c0~6@)) (=> (= tmp%5@ (Mul (Add (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@))) (=> (= tmp%7@ (Sub (Mul b0~4@ c0~6@) c0~6@)) (=> (= tmp%8@ (Mul (Add (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))))))))))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~579@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ a1~10@) (Add a1~10@ d1~16@))) (Add (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Sub a1~10@ b1~12@) (Add d1~16@ a1~10@))))) (=> (= temp_1_1~644@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Mul a1~10@ (Mul a1~10@ (Add a1~10@ d1~16@)))) (Add (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Sub a1~10@ b1~12@) (Add d1~16@ a1~10@))))) (and (=> (= tmp%9@ (Add a1~10@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a1~10@ a1~10@ tmp%9@) (=> %%location_label%%1 (= temp_1_0~579@ temp_1_1~644@)))) (=> (= temp_1_0~579@ temp_1_1~644@) (=> (= temp_2_0~751@ (Mul (Mul (Sub (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Add d2~24@ a2~18@) (Mul b2~20@ c2~22@))) (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Add (Mul 79 d2~24@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~824@ (Mul (Mul (Sub (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul (Add d2~24@ a2~18@) b2~20@) c2~22@)) (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Add (Mul 79 d2~24@) (Mul b2~20@ d2~24@))))) (and (=> (= tmp%10@ (Add d2~24@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ b2~20@ c2~22@) (=> %%location_label%%2 (= temp_2_0~751@ temp_2_1~824@)))) (=> (= temp_2_0~751@ temp_2_1~824@) (=> (= temp_3_0~923@ (Mul (Sub (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@)) (Sub (Mul a3~26@ a3~26@) (Add b3~28@ a3~26@))) (Mul (Mul (Sub c3~30@ a3~26@) (Sub c3~30@ b3~28@)) (Mul (Sub c3~30@ b3~28@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~988@ (Mul (Sub (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@)) (Sub (Mul a3~26@ a3~26@) (Add b3~28@ a3~26@))) (Mul (Mul (Sub c3~30@ a3~26@) (Sub c3~30@ b3~28@)) (Mul (Mul b3~28@ d3~32@) (Sub c3~30@ b3~28@))))) (and (=> (= tmp%11@ (Mul b3~28@ d3~32@)) (=> (= tmp%12@ (Sub c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> (= tmp%13@ (Sub (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@)) (Sub (Mul a3~26@ a3~26@) (Add b3~28@ a3~26@)))) (=> (= tmp%14@ (Mul (Sub c3~30@ a3~26@) (Sub c3~30@ b3~28@))) (=> (= tmp%15@ (Mul (Mul b3~28@ d3~32@) (Sub c3~30@ b3~28@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> (= tmp%16@ (Sub (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@)) (Sub (Mul a3~26@ a3~26@) (Add b3~28@ a3~26@)))) (=> (= tmp%17@ (Mul (Sub c3~30@ a3~26@) (Sub c3~30@ b3~28@))) (=> (= tmp%18@ (Mul (Sub c3~30@ b3~28@) (Mul b3~28@ d3~32@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%3 (= temp_3_0~923@ temp_3_1~988@))))))))))))) (=> (= temp_3_0~923@ temp_3_1~988@) (=> (= temp_4_0~1213@ (Mul (Sub (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ 96) (Add d4~40@ a4~34@))) (Add a4~34@ (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~1278@ (Mul (Sub (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ 96) (Add d4~40@ a4~34@))) (Add a4~34@ (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ b4~36@))))) (and (=> (= tmp%19@ (Mul c4~38@ b4~36@)) (=> (= tmp%20@ (Mul a4~34@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%4 (= temp_4_0~1213@ temp_4_1~1278@))))) (=> (= temp_4_0~1213@ temp_4_1~1278@) (=> (= temp_5_0~1375@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Mul (Add a5~42@ a5~42@) (Mul b5~44@ c5~46@))) (Mul (Mul b5~44@ (Sub c5~46@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1436@ (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ a5~42@)) (Mul (Add a5~42@ a5~42@) (Mul b5~44@ c5~46@))) (Mul (Mul b5~44@ (Sub c5~46@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))))) (and (=> (= tmp%21@ (Mul d5~48@ c5~46@)) (=> (= tmp%22@ (Mul c5~46@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> (= tmp%23@ (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ a5~42@))) (=> (= tmp%24@ (Mul (Add a5~42@ a5~42@) (Mul b5~44@ c5~46@))) (=> (= tmp%25@ (Mul (Mul b5~44@ (Sub c5~46@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> (= tmp%26@ (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ c5~46@))) (=> (= tmp%27@ (Mul (Add a5~42@ a5~42@) (Mul b5~44@ c5~46@))) (=> (= tmp%28@ (Mul (Mul b5~44@ (Sub c5~46@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> %%location_label%%5 (= temp_5_0~1375@ temp_5_1~1436@))))))))))))) (=> (= temp_5_0~1375@ temp_5_1~1436@) (=> (= temp_6_0~1653@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@)) (Add (Mul d6~56@ d6~56@) (Sub d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1718@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@)) (Add (Mul d6~56@ d6~56@) (Sub d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1653@ temp_6_1~1718@))) (=> (= temp_6_0~1653@ temp_6_1~1718@) (=> (= temp_7_0~1807@ (Sub (Mul (Mul (Sub a7~58@ c7~62@) (Mul c7~62@ a7~58@)) (Add d7~64@ (Mul c7~62@ a7~58@))) (Mul (Add (Add a7~58@ c7~62@) (Mul c7~62@ d7~64@)) (Add (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1868@ (Sub (Mul (Sub a7~58@ c7~62@) (Mul (Mul c7~62@ a7~58@) (Add d7~64@ (Mul c7~62@ a7~58@)))) (Mul (Add (Add a7~58@ c7~62@) (Mul c7~62@ d7~64@)) (Add (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (and (=> (= tmp%29@ (Sub a7~58@ c7~62@)) (=> (= tmp%30@ (Mul c7~62@ a7~58@)) (=> (= tmp%31@ (Add d7~64@ (Mul c7~62@ a7~58@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> %%location_label%%7 (= temp_7_0~1807@ temp_7_1~1868@)))))) (=> (= temp_7_0~1807@ temp_7_1~1868@) (=> (= temp_8_0~1975@ (Sub (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Sub c8~70@ b8~68@))) (Mul (Mul (Mul a8~66@ a8~66@) b8~68@) (Mul (Mul a8~66@ d8~72@) (Add a8~66@ a8~66@))))) (=> (= temp_8_1~2036@ (Sub (Mul (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Sub c8~70@ b8~68@))) (Mul (Mul (Mul a8~66@ a8~66@) b8~68@) (Mul (Mul a8~66@ d8~72@) (Add a8~66@ a8~66@))))) (and (=> (= tmp%32@ (Mul c8~70@ b8~68@)) (=> (= tmp%33@ (Mul b8~68@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%32@ tmp%33@) (=> %%location_label%%8 (= temp_8_0~1975@ temp_8_1~2036@))))) (=> (= temp_8_0~1975@ temp_8_1~2036@) (=> (= temp_9_0~2125@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ c9~78@)) (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@))) (Mul b9~76@ (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~2178@ (Mul (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ c9~78@)) (Mul a9~74@ c9~78@)) (Mul b9~76@ b9~76@)) (Mul b9~76@ (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ d9~80@))))) (and (=> (= tmp%34@ (Mul (Mul c9~78@ a9~74@) (Add a9~74@ c9~78@))) (=> (= tmp%35@ (Mul a9~74@ c9~78@)) (=> (= tmp%36@ (Mul b9~76@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ tmp%35@ tmp%36@) (=> %%location_label%%9 (= temp_9_0~2125@ temp_9_1~2178@)))))) (=> (= temp_9_0~2125@ temp_9_1~2178@) (=> (= temp_10_0~2301@ (Sub (Add (Mul (Sub c10~86@ b10~84@) (Add c10~86@ b10~84@)) (Mul (Mul b10~84@ a10~82@) (Sub c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ c10~86@) b10~84@) (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ 8))))) (=> (= temp_10_1~2382@ (Sub (Add (Mul (Sub c10~86@ b10~84@) (Add c10~86@ b10~84@)) (Sub (Mul (Mul b10~84@ a10~82@) c10~86@) (Mul (Mul b10~84@ a10~82@) b10~84@))) (Mul (Mul (Mul d10~88@ c10~86@) b10~84@) (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ 8))))) (and (=> (= tmp%37@ (Mul b10~84@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%37@ c10~86@ b10~84@) (=> %%location_label%%10 (= temp_10_0~2301@ temp_10_1~2382@)))) (=> (= temp_10_0~2301@ temp_10_1~2382@) (=> (= temp_11_0~2477@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul a11~90@ (Mul b11~92@ b11~92@))) (Mul (Mul (Add b11~92@ a11~90@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2538@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul a11~90@ (Mul b11~92@ b11~92@))) (Mul (Mul (Add b11~92@ a11~90@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ c11~94@))))) (=> (= tmp%38@ (= temp_11_0~2477@ temp_11_1~2538@)) (and (=> %%location_label%%11 tmp%38@) (=> tmp%38@ (=> (= temp_12_0~2618@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@))) (Mul (Mul (Sub a12~98@ d12~104@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ d12~104@) (Sub b12~100@ d12~104@))))) (=> (= temp_12_1~2683@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@))) (Mul (Mul (Sub a12~98@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ d12~104@) (Sub b12~100@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d12~104@ b12~100@) (=> %%location_label%%12 (= temp_12_0~2618@ temp_12_1~2683@))) (=> (= temp_12_0~2618@ temp_12_1~2683@) (=> (= temp_13_0~2772@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Add b13~108@ d13~112@)) (Mul (Sub d13~112@ c13~110@) (Mul b13~108@ c13~110@))) (Mul (Mul (Sub a13~106@ b13~108@) d13~112@) (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ b13~108@))))) (=> (= temp_13_1~2833@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Add b13~108@ d13~112@)) (Mul (Sub d13~112@ c13~110@) (Mul b13~108@ c13~110@))) (Mul (Mul (Sub a13~106@ b13~108@) d13~112@) (Mul c13~110@ (Mul d13~112@ (Mul c13~110@ b13~108@)))))) (and (=> (= tmp%39@ (Mul c13~110@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c13~110@ d13~112@ tmp%39@) (=> (= tmp%40@ (Mul (Mul (Mul c13~110@ a13~106@) (Add b13~108@ d13~112@)) (Mul (Sub d13~112@ c13~110@) (Mul b13~108@ c13~110@)))) (=> (= tmp%41@ (Mul (Sub a13~106@ b13~108@) d13~112@)) (=> (= tmp%42@ (Mul c13~110@ (Mul d13~112@ (Mul c13~110@ b13~108@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ tmp%41@ tmp%42@) (=> (= tmp%43@ (Mul (Mul (Mul c13~110@ a13~106@) (Add b13~108@ d13~112@)) (Mul (Sub d13~112@ c13~110@) (Mul b13~108@ c13~110@)))) (=> (= tmp%44@ (Mul (Sub a13~106@ b13~108@) d13~112@)) (=> (= tmp%45@ (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ b13~108@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%43@ tmp%44@ tmp%45@) (=> %%location_label%%13 (= temp_13_0~2772@ temp_13_1~2833@)))))))))))) (=> (= temp_13_0~2772@ temp_13_1~2833@) (=> (= temp_14_0~3060@ (Sub (Add (Mul (Mul 82 a14~114@) (Mul a14~114@ b14~116@)) (Sub (Mul c14~118@ b14~116@) (Mul a14~114@ c14~118@))) (Mul (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~3137@ (Sub (Add (Mul (Mul 82 a14~114@) (Mul a14~114@ b14~116@)) (Sub (Mul c14~118@ b14~116@) (Mul a14~114@ c14~118@))) (Mul (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ c14~118@) (=> (= tmp%46@ (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ d14~120@))) (=> (= tmp%47@ (Mul a14~114@ d14~120@)) (=> (= tmp%48@ (Mul d14~120@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%46@ tmp%47@ tmp%48@) (=> (= tmp%49@ (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ d14~120@))) (=> (= tmp%50@ (Mul a14~114@ d14~120@)) (=> (= tmp%51@ (Mul c14~118@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%49@ tmp%50@ tmp%51@) (=> %%location_label%%14 (= temp_14_0~3060@ temp_14_1~3137@))))))))))) (=> (= temp_14_0~3060@ temp_14_1~3137@) (=> (= temp_15_0~3290@ (Mul (Mul (Add (Mul c15~126@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Sub c15~126@ c15~126@) (Mul b15~124@ b15~124@))) (Add (Mul (Sub b15~124@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul b15~124@ a15~122@) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~3355@ (Mul (Mul (Add (Mul c15~126@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Sub c15~126@ c15~126@) (Mul b15~124@ b15~124@))) (Add (Mul (Sub b15~124@ c15~126@) (Mul d15~128@ a15~122@)) (Mul b15~124@ (Mul a15~122@ (Mul a15~122@ d15~128@)))))) (and (=> (= tmp%52@ (Mul a15~122@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b15~124@ a15~122@ tmp%52@) (=> %%location_label%%15 (= temp_15_0~3290@ temp_15_1~3355@)))) (=> (= temp_15_0~3290@ temp_15_1~3355@) (=> (= temp_16_0~3450@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul b16~132@ b16~132@)) (Mul d16~136@ (Mul d16~136@ b16~132@))) (Mul (Mul (Mul a16~130@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ c16~134@))))) (=> (= temp_16_1~3511@ (Mul (Mul (Mul b16~132@ d16~136@) (Mul b16~132@ b16~132@)) (Mul (Mul d16~136@ (Mul d16~136@ b16~132@)) (Mul (Mul (Mul a16~130@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ c16~134@)))))) (and (=> (= tmp%53@ (Mul (Mul b16~132@ d16~136@) (Mul b16~132@ b16~132@))) (=> (= tmp%54@ (Mul d16~136@ (Mul d16~136@ b16~132@))) (=> (= tmp%55@ (Mul (Mul (Mul a16~130@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ c16~134@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%53@ tmp%54@ tmp%55@) (=> %%location_label%%16 (= temp_16_0~3450@ temp_16_1~3511@)))))) (=> (= temp_16_0~3450@ temp_16_1~3511@) (=> (= temp_17_0~3650@ (Add (Add (Sub (Mul d17~144@ b17~140@) a17~138@) (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ a17~138@))) (Mul (Sub (Mul b17~140@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~3711@ (Add (Add (Sub (Mul b17~140@ d17~144@) a17~138@) (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ a17~138@))) (Mul (Sub (Mul b17~140@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b17~140@ d17~144@) (=> %%location_label%%17 (= temp_17_0~3650@ temp_17_1~3711@))) (=> (= temp_17_0~3650@ temp_17_1~3711@) (=> (= temp_18_0~3796@ (Mul (Add (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ a18~146@)) (Mul (Sub d18~152@ a18~146@) (Mul b18~148@ a18~146@))) (Mul (Mul (Mul a18~146@ a18~146@) b18~148@) (Mul b18~148@ (Add b18~148@ c18~150@))))) (=> (= temp_18_1~3853@ (Mul (Add (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ a18~146@)) (Mul (Sub d18~152@ a18~146@) (Mul b18~148@ a18~146@))) (Mul (Mul (Mul a18~146@ a18~146@) b18~148@) (Mul b18~148@ (Add b18~148@ c18~150@))))) (=> (= tmp%56@ (= temp_18_0~3796@ temp_18_1~3853@)) (and (=> %%location_label%%18 tmp%56@) (=> tmp%56@ (=> (= temp_19_0~3929@ (Mul (Mul (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ c19~158@)) (Add (Sub c19~158@ c19~158@) (Mul b19~156@ d19~160@))) (Mul (Mul b19~156@ (Mul c19~158@ d19~160@)) (Mul (Mul b19~156@ b19~156@) (Mul c19~158@ c19~158@))))) (=> (= temp_19_1~3990@ (Mul (Mul (Mul b19~156@ (Mul c19~158@ d19~160@)) (Mul (Mul b19~156@ b19~156@) (Mul c19~158@ c19~158@))) (Mul (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ c19~158@)) (Add (Sub c19~158@ c19~158@) (Mul b19~156@ d19~160@))))) (=> (= tmp%57@ (Mul (Mul b19~156@ (Mul c19~158@ d19~160@)) (Mul (Mul b19~156@ b19~156@) (Mul c19~158@ c19~158@)))) (=> (= tmp%58@ (Mul (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ c19~158@)) (Add (Sub c19~158@ c19~158@) (Mul b19~156@ d19~160@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%57@ tmp%58@) (=> %%location_label%%19 (= temp_19_0~3929@ temp_19_1~3990@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
