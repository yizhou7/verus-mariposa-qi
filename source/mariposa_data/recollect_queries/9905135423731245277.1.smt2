...
(declare-const temp_3_1~1056@ Int)
(declare-const temp_4_0~1289@ Int)
(declare-const temp_4_1~1354@ Int)
(declare-const temp_5_0~1441@ Int)
(declare-const temp_5_1~1494@ Int)
(declare-const temp_6_0~1625@ Int)
(declare-const temp_6_1~1686@ Int)
(declare-const temp_7_0~1829@ Int)
(declare-const temp_7_1~1894@ Int)
(declare-const temp_8_0~1981@ Int)
(declare-const temp_8_1~2018@ Int)
(declare-const temp_9_0~2141@ Int)
(declare-const temp_9_1~2214@ Int)
(declare-const temp_10_0~2361@ Int)
(declare-const temp_10_1~2426@ Int)
(declare-const temp_11_0~2509@ Int)
(declare-const temp_11_1~2542@ Int)
(declare-const temp_12_0~2634@ Int)
(declare-const temp_12_1~2711@ Int)
(declare-const temp_13_0~2775@ Int)
(declare-const temp_13_1~2824@ Int)
(declare-const temp_14_0~2931@ Int)
(declare-const temp_14_1~2996@ Int)
(declare-const temp_15_0~3081@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul a0~2@ c0~6@) a0~2@) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ d0~8@) (Add d0~8@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ c0~6@) a0~2@)) (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ d0~8@) (Add d0~8@ c0~6@))))) (and (=> (= tmp%1@ (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@))) (=> (= tmp%2@ (Mul (Mul a0~2@ c0~6@) a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~483@ (Mul (Mul (Mul c1~14@ (Mul d1~16@ 66)) (Mul (Mul a1~10@ a1~10@) (Add c1~14@ a1~10@))) (Mul (Mul (Add b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~556@ (Mul (Mul (Mul c1~14@ (Mul d1~16@ 66)) (Mul a1~10@ (Mul a1~10@ (Add c1~14@ a1~10@)))) (Mul (Mul (Add b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@))))) (and (=> (= tmp%3@ (Add c1~14@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a1~10@ a1~10@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~483@ temp_1_1~556@)))) (=> (= temp_1_0~483@ temp_1_1~556@) (=> (= temp_2_0~655@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Sub b2~20@ d2~24@))) (Mul (Add (Mul b2~20@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~720@ (Mul (Mul (Mul d2~24@ (Mul c2~22@ (Mul d2~24@ d2~24@))) (Mul (Mul c2~22@ b2~20@) (Sub b2~20@ d2~24@))) (Mul (Add (Mul b2~20@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))))) (and (=> (= tmp%4@ (Mul d2~24@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d2~24@ c2~22@ tmp%4@) (=> (= tmp%5@ (Mul d2~24@ (Mul c2~22@ (Mul d2~24@ d2~24@)))) (=> (= tmp%6@ (Mul (Mul c2~22@ b2~20@) (Sub b2~20@ d2~24@))) (=> (= tmp%7@ (Mul (Add (Mul b2~20@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> (= tmp%8@ (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@))) (=> (= tmp%9@ (Mul (Mul c2~22@ b2~20@) (Sub b2~20@ d2~24@))) (=> (= tmp%10@ (Mul (Add (Mul b2~20@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%2 (= temp_2_0~655@ temp_2_1~720@)))))))))))) (=> (= temp_2_0~655@ temp_2_1~720@) (=> (= temp_3_0~967@ (Mul (Mul (Mul (Sub a3~26@ b3~28@) (Sub d3~32@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Add (Mul a3~26@ 74) (Add 66 b3~28@)) (Sub (Mul a3~26@ d3~32@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~1056@ (Mul (Mul (Mul (Sub a3~26@ b3~28@) (Sub d3~32@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Add (Mul a3~26@ 74) (Add 66 b3~28@)) (Sub (Mul d3~32@ a3~26@) (Mul d3~32@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ a3~26@) (=> (= tmp%11@ (Mul (Mul (Sub a3~26@ b3~28@) (Sub d3~32@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ b3~28@)))) (=> (= tmp%12@ (Add (Mul a3~26@ 74) (Add 66 b3~28@))) (=> (= tmp%13@ (Sub (Mul d3~32@ a3~26@) (Mul d3~32@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> (= tmp%14@ (Mul (Mul (Sub a3~26@ b3~28@) (Sub d3~32@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ b3~28@)))) (=> (= tmp%15@ (Add (Mul a3~26@ 74) (Add 66 b3~28@))) (=> (= tmp%16@ (Sub (Mul a3~26@ d3~32@) (Mul d3~32@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%3 (= temp_3_0~967@ temp_3_1~1056@))))))))))) (=> (= temp_3_0~967@ temp_3_1~1056@) (=> (= temp_4_0~1289@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Sub b4~36@ d4~40@) (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~1354@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul (Mul c4~38@ c4~38@) d4~40@) b4~36@)) (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Sub b4~36@ d4~40@) (Mul d4~40@ b4~36@))))) (and (=> (= tmp%17@ (Mul c4~38@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ d4~40@ b4~36@) (=> %%location_label%%4 (= temp_4_0~1289@ temp_4_1~1354@)))) (=> (= temp_4_0~1289@ temp_4_1~1354@) (=> (= temp_5_0~1441@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@)) c5~46@) (Mul (Add (Mul d5~48@ a5~42@) (Mul b5~44@ b5~44@)) (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1494@ (Mul (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@)) c5~46@) (Add (Mul d5~48@ a5~42@) (Mul b5~44@ b5~44@))) (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ a5~42@)))) (and (=> (= tmp%18@ (Mul (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@)) c5~46@)) (=> (= tmp%19@ (Add (Mul d5~48@ a5~42@) (Mul b5~44@ b5~44@))) (=> (= tmp%20@ (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%5 (= temp_5_0~1441@ temp_5_1~1494@)))))) (=> (= temp_5_0~1441@ temp_5_1~1494@) (=> (= temp_6_0~1625@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Mul d6~56@ (Sub d6~56@ b6~52@)) (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1686@ (Mul (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@))) (Mul d6~56@ (Sub d6~56@ b6~52@))) (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ c6~54@)))) (and (=> (= tmp%21@ (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@)))) (=> (= tmp%22@ (Mul d6~56@ (Sub d6~56@ b6~52@))) (=> (= tmp%23@ (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%6 (= temp_6_0~1625@ temp_6_1~1686@)))))) (=> (= temp_6_0~1625@ temp_6_1~1686@) (=> (= temp_7_0~1829@ (Sub (Mul (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Sub b7~60@ b7~60@) (Add c7~62@ a7~58@))) (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1894@ (Sub (Mul (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Sub b7~60@ b7~60@) (Add c7~62@ a7~58@))) (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ d7~64@)) (Mul d7~64@ a7~58@)) (Mul d7~64@ b7~60@)))) (and (=> (= tmp%24@ (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ d7~64@))) (=> (= tmp%25@ (Mul d7~64@ a7~58@)) (=> (= tmp%26@ (Mul d7~64@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%7 (= temp_7_0~1829@ temp_7_1~1894@)))))) (=> (= temp_7_0~1829@ temp_7_1~1894@) (=> (= temp_8_0~1981@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ c8~70@)) (Sub (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@))) c8~70@)) (=> (= temp_8_1~2018@ (Mul (Mul (Mul d8~72@ c8~70@) (Mul (Mul b8~68@ c8~70@) (Sub (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@)))) c8~70@)) (and (=> (= tmp%27@ (Mul d8~72@ c8~70@)) (=> (= tmp%28@ (Mul b8~68@ c8~70@)) (=> (= tmp%29@ (Sub (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> %%location_label%%8 (= temp_8_0~1981@ temp_8_1~2018@)))))) (=> (= temp_8_0~1981@ temp_8_1~2018@) (=> (= temp_9_0~2141@ (Mul (Mul (Mul (Add d9~80@ a9~74@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ a9~74@))) (Mul (Mul a9~74@ (Sub a9~74@ d9~80@)) (Mul (Sub 18 a9~74@) (Mul b9~76@ b9~76@))))) (=> (= temp_9_1~2214@ (Mul (Mul (Add d9~80@ a9~74@) (Mul c9~78@ c9~78@)) (Mul (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ a9~74@)) (Mul (Mul a9~74@ (Sub a9~74@ d9~80@)) (Mul (Sub 18 a9~74@) (Mul b9~76@ b9~76@)))))) (and (=> (= tmp%30@ (Mul (Add d9~80@ a9~74@) (Mul c9~78@ c9~78@))) (=> (= tmp%31@ (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ a9~74@))) (=> (= tmp%32@ (Mul (Mul a9~74@ (Sub a9~74@ d9~80@)) (Mul (Sub 18 a9~74@) (Mul b9~76@ b9~76@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%30@ tmp%31@ tmp%32@) (=> %%location_label%%9 (= temp_9_0~2141@ temp_9_1~2214@)))))) (=> (= temp_9_0~2141@ temp_9_1~2214@) (=> (= temp_10_0~2361@ (Mul (Mul (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ c10~86@))) (Mul (Mul (Mul b10~84@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~2426@ (Mul (Mul (Mul c10~86@ d10~88@) (Mul (Mul c10~86@ b10~84@) (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ c10~86@)))) (Mul (Mul (Mul b10~84@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ a10~82@))))) (and (=> (= tmp%33@ (Mul c10~86@ d10~88@)) (=> (= tmp%34@ (Mul c10~86@ b10~84@)) (=> (= tmp%35@ (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ c10~86@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ tmp%34@ tmp%35@) (=> %%location_label%%10 (= temp_10_0~2361@ temp_10_1~2426@)))))) (=> (= temp_10_0~2361@ temp_10_1~2426@) (=> (= temp_11_0~2509@ (Add (Mul (Mul (Mul c11~94@ c11~94@) b11~92@) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ a11~90@))) a11~90@)) (=> (= temp_11_1~2542@ (Add (Mul (Mul (Mul c11~94@ c11~94@) b11~92@) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ a11~90@))) a11~90@)) (=> (= tmp%36@ (= temp_11_0~2509@ temp_11_1~2542@)) (and (=> %%location_label%%11 tmp%36@) (=> tmp%36@ (=> (= temp_12_0~2634@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul a12~98@ b12~100@) (Mul 10 b12~100@))))) (=> (= temp_12_1~2711@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul a12~98@ b12~100@) (Mul 10 b12~100@))))) (=> (= tmp%37@ (= temp_12_0~2634@ temp_12_1~2711@)) (and (=> %%location_label%%12 tmp%37@) (=> tmp%37@ (=> (= temp_13_0~2775@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) b13~108@) (Sub c13~110@ (Sub b13~108@ c13~110@))) (Mul (Mul b13~108@ (Sub b13~108@ a13~106@)) (Mul c13~110@ (Mul a13~106@ a13~106@))))) (=> (= temp_13_1~2824@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) b13~108@) (Sub c13~110@ (Sub b13~108@ c13~110@))) (Mul (Mul (Mul b13~108@ (Sub b13~108@ a13~106@)) c13~110@) (Mul a13~106@ a13~106@)))) (and (=> (= tmp%38@ (Mul b13~108@ (Sub b13~108@ a13~106@))) (=> (= tmp%39@ (Mul a13~106@ a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ c13~110@ tmp%39@) (=> %%location_label%%13 (= temp_13_0~2775@ temp_13_1~2824@))))) (=> (= temp_13_0~2775@ temp_13_1~2824@) (=> (= temp_14_0~2931@ (Add (Mul (Mul (Mul b14~116@ b14~116@) (Add a14~114@ a14~114@)) (Mul (Mul d14~120@ c14~118@) (Add c14~118@ d14~120@))) (Mul (Sub (Add a14~114@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul c14~118@ c14~118@) (Mul d14~120@ c14~118@))))) (=> (= temp_14_1~2996@ (Add (Mul (Mul (Add a14~114@ a14~114@) (Mul b14~116@ b14~116@)) (Mul (Mul d14~120@ c14~118@) (Add c14~118@ d14~120@))) (Mul (Sub (Add a14~114@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul c14~118@ c14~118@) (Mul d14~120@ c14~118@))))) (and (=> (= tmp%40@ (Add a14~114@ a14~114@)) (=> (= tmp%41@ (Mul b14~116@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%40@ tmp%41@) (=> %%location_label%%14 (= temp_14_0~2931@ temp_14_1~2996@))))) (=> (= temp_14_0~2931@ temp_14_1~2996@) (=> (= temp_15_0~3081@ (Mul (Mul (Add (Mul c15~126@ b15~124@) (Mul a15~122@ c15~126@)) (Mul b15~124@ (Sub d15~128@ d15~128@))) (Mul b15~124@ (Mul (Sub c15~126@ c15~126@) (Sub c15~126@ a15~122@))))) (=> (= temp_15_1~3138@ (Mul (Mul (Add (Mul c15~126@ b15~124@) (Mul a15~122@ c15~126@)) (Mul b15~124@ (Sub d15~128@ d15~128@))) (Mul b15~124@ (Sub (Mul (Sub c15~126@ c15~126@) c15~126@) (Mul (Sub c15~126@ c15~126@) a15~122@))))) (=> (= tmp%42@ (Mul (Add (Mul c15~126@ b15~124@) (Mul a15~122@ c15~126@)) (Mul b15~124@ (Sub d15~128@ d15~128@)))) (=> (= tmp%43@ (Sub (Mul (Sub c15~126@ c15~126@) c15~126@) (Mul (Sub c15~126@ c15~126@) a15~122@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%42@ b15~124@ tmp%43@) (=> (= tmp%44@ (Sub c15~126@ c15~126@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%44@ c15~126@ a15~122@) (=> (= tmp%45@ (Mul (Add (Mul c15~126@ b15~124@) (Mul a15~122@ c15~126@)) (Mul b15~124@ (Sub d15~128@ d15~128@)))) (=> (= tmp%46@ (Mul (Sub c15~126@ c15~126@) (Sub c15~126@ a15~122@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%45@ b15~124@ tmp%46@) (=> %%location_label%%15 (= temp_15_0~3081@ temp_15_1~3138@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
