...
(declare-const temp_2_0~827@ Int)
(declare-const temp_2_1~900@ Int)
(declare-const temp_3_0~1061@ Int)
(declare-const temp_3_1~1146@ Int)
(declare-const temp_4_0~1385@ Int)
(declare-const temp_4_1~1450@ Int)
(declare-const temp_5_0~1549@ Int)
(declare-const temp_5_1~1614@ Int)
(declare-const temp_6_0~1726@ Int)
(declare-const temp_6_1~1823@ Int)
(declare-const temp_7_0~2060@ Int)
(declare-const temp_7_1~2121@ Int)
(declare-const temp_8_0~2228@ Int)
(declare-const temp_8_1~2305@ Int)
(declare-const temp_9_0~2424@ Int)
(declare-const temp_9_1~2505@ Int)
(declare-const temp_10_0~2620@ Int)
(declare-const temp_10_1~2701@ Int)
(declare-const temp_11_0~2808@ Int)
(declare-const temp_11_1~2865@ Int)
(declare-const temp_12_0~2970@ Int)
(declare-const temp_12_1~3043@ Int)
(declare-const temp_13_0~3134@ Int)
(declare-const temp_13_1~3199@ Int)
(declare-const temp_14_0~3298@ Int)
(declare-const temp_14_1~3363@ Int)
(declare-const temp_15_0~3512@ Int)
(declare-const temp_15_1~3573@ Int)
(declare-const temp_16_0~3666@ Int)
(declare-const temp_16_1~3731@ Int)
(declare-const temp_17_0~3846@ Int)
(declare-const temp_17_1~3911@ Int)
(declare-const temp_18_0~4146@ Int)
(declare-const temp_18_1~4223@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ b0~4@)) (Add (Mul 75 c0~6@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ b0~4@)) (Add (Mul 75 c0~6@) (Mul d0~8@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ d0~8@) (=> (= tmp%1@ (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@))) (=> (= tmp%2@ (Mul d0~8@ c0~6@)) (=> (= tmp%3@ (Mul c0~6@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> (= tmp%4@ (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@))) (=> (= tmp%5@ (Mul d0~8@ c0~6@)) (=> (= tmp%6@ (Mul d0~8@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))))))))))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~543@ (Mul (Mul (Mul (Sub c1~14@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@))) (Sub (Sub b1~12@ (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~604@ (Mul (Mul (Mul (Mul (Sub c1~14@ d1~16@) d1~16@) c1~14@) (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@))) (Sub (Sub b1~12@ (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@))))) (and (=> (= tmp%7@ (Mul (Mul (Sub c1~14@ d1~16@) d1~16@) c1~14@)) (=> (= tmp%8@ (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@))) (=> (= tmp%9@ (Sub (Sub b1~12@ (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> (= tmp%10@ (Sub c1~14@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ d1~16@ c1~14@) (=> (= tmp%11@ (Mul (Sub c1~14@ d1~16@) (Mul d1~16@ c1~14@))) (=> (= tmp%12@ (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@))) (=> (= tmp%13@ (Sub (Sub b1~12@ (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%1 (= temp_1_0~543@ temp_1_1~604@)))))))))))) (=> (= temp_1_0~543@ temp_1_1~604@) (=> (= temp_2_0~827@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Add b2~20@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ a2~18@))) (Add (Mul (Mul 77 a2~18@) a2~18@) (Mul (Add b2~20@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~900@ (Mul (Add (Mul (Mul 77 a2~18@) a2~18@) (Mul (Add b2~20@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul a2~18@ a2~18@) (Add b2~20@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ a2~18@))))) (and (=> (= tmp%14@ (Add (Mul (Mul 77 a2~18@) a2~18@) (Mul (Add b2~20@ d2~24@) (Mul b2~20@ b2~20@)))) (=> (= tmp%15@ (Mul (Mul (Mul a2~18@ a2~18@) (Add b2~20@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ a2~18@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%2 (= temp_2_0~827@ temp_2_1~900@))))) (=> (= temp_2_0~827@ temp_2_1~900@) (=> (= temp_3_0~1061@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Add b3~28@ d3~32@)) (Add (Sub b3~28@ c3~30@) (Mul c3~30@ b3~28@))) (Mul (Add (Mul a3~26@ d3~32@) (Mul b3~28@ 43)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~1146@ (Mul (Mul (Add (Mul (Mul b3~28@ d3~32@) b3~28@) (Mul (Mul b3~28@ d3~32@) d3~32@)) (Add (Sub b3~28@ c3~30@) (Mul c3~30@ b3~28@))) (Mul (Add (Mul a3~26@ d3~32@) (Mul b3~28@ 43)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@))))) (and (=> (= tmp%16@ (Add (Mul (Mul b3~28@ d3~32@) b3~28@) (Mul (Mul b3~28@ d3~32@) d3~32@))) (=> (= tmp%17@ (Add (Sub b3~28@ c3~30@) (Mul c3~30@ b3~28@))) (=> (= tmp%18@ (Mul (Add (Mul a3~26@ d3~32@) (Mul b3~28@ 43)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> (= tmp%19@ (Mul b3~28@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%19@ b3~28@ d3~32@) (=> (= tmp%20@ (Mul (Mul b3~28@ d3~32@) (Add b3~28@ d3~32@))) (=> (= tmp%21@ (Add (Sub b3~28@ c3~30@) (Mul c3~30@ b3~28@))) (=> (= tmp%22@ (Mul (Add (Mul a3~26@ d3~32@) (Mul b3~28@ 43)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%3 (= temp_3_0~1061@ temp_3_1~1146@)))))))))))) (=> (= temp_3_0~1061@ temp_3_1~1146@) (=> (= temp_4_0~1385@ (Mul (Add (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@))) (Add (Mul (Sub c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Sub d4~40@ c4~38@))))) (=> (= temp_4_1~1450@ (Mul (Add (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@))) (Add (Mul (Sub c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul a4~34@ (Mul b4~36@ (Sub d4~40@ c4~38@)))))) (and (=> (= tmp%23@ (Sub d4~40@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a4~34@ b4~36@ tmp%23@) (=> %%location_label%%4 (= temp_4_0~1385@ temp_4_1~1450@)))) (=> (= temp_4_0~1385@ temp_4_1~1450@) (=> (= temp_5_0~1549@ (Sub (Mul (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@)) (Sub (Mul a5~42@ a5~42@) (Add b5~44@ c5~46@))))) (=> (= temp_5_1~1614@ (Sub (Mul (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@)) (Sub (Mul a5~42@ a5~42@) (Add b5~44@ c5~46@))))) (=> (= tmp%24@ (= temp_5_0~1549@ temp_5_1~1614@)) (and (=> %%location_label%%5 tmp%24@) (=> tmp%24@ (=> (= temp_6_0~1726@ (Mul (Mul (Add (Mul b6~52@ b6~52@) (Mul c6~54@ 94)) (Mul (Add a6~50@ a6~50@) (Mul a6~50@ 47))) (Mul (Mul (Mul d6~56@ 36) (Mul d6~56@ b6~52@)) (Mul (Add a6~50@ c6~54@) c6~54@)))) (=> (= temp_6_1~1823@ (Mul (Mul (Add (Mul b6~52@ b6~52@) (Mul c6~54@ 94)) (Mul (Add a6~50@ a6~50@) (Mul a6~50@ 47))) (Mul (Mul (Mul d6~56@ 36) (Mul d6~56@ b6~52@)) (Mul c6~54@ (Add a6~50@ c6~54@))))) (and (=> (= tmp%25@ (Add a6~50@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ tmp%25@) (=> (= tmp%26@ (Mul (Add (Mul b6~52@ b6~52@) (Mul c6~54@ 94)) (Mul (Add a6~50@ a6~50@) (Mul a6~50@ 47)))) (=> (= tmp%27@ (Mul (Mul d6~56@ 36) (Mul d6~56@ b6~52@))) (=> (= tmp%28@ (Mul c6~54@ (Add a6~50@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> (= tmp%29@ (Mul (Add (Mul b6~52@ b6~52@) (Mul c6~54@ 94)) (Mul (Add a6~50@ a6~50@) (Mul a6~50@ 47)))) (=> (= tmp%30@ (Mul (Mul d6~56@ 36) (Mul d6~56@ b6~52@))) (=> (= tmp%31@ (Mul (Add a6~50@ c6~54@) c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> %%location_label%%6 (= temp_6_0~1726@ temp_6_1~1823@)))))))))))) (=> (= temp_6_0~1726@ temp_6_1~1823@) (=> (= temp_7_0~2060@ (Sub (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@)) (Sub (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@)) (Sub (Mul c7~62@ b7~60@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~2121@ (Sub (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@)) (Mul (Sub a7~58@ c7~62@) c7~62@)) (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@)) (Sub (Mul c7~62@ b7~60@) (Mul d7~64@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. a7~58@ c7~62@ c7~62@) (=> %%location_label%%7 (= temp_7_0~2060@ temp_7_1~2121@))) (=> (= temp_7_0~2060@ temp_7_1~2121@) (=> (= temp_8_0~2228@ (Sub (Mul (Mul (Mul 99 a8~66@) (Sub b8~68@ c8~70@)) (Add (Mul c8~70@ b8~68@) (Add a8~66@ c8~70@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~2305@ (Sub (Mul (Mul 99 a8~66@) (Mul (Sub b8~68@ c8~70@) (Add (Mul c8~70@ b8~68@) (Add a8~66@ c8~70@)))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ d8~72@))))) (and (=> (= tmp%32@ (Mul 99 a8~66@)) (=> (= tmp%33@ (Sub b8~68@ c8~70@)) (=> (= tmp%34@ (Add (Mul c8~70@ b8~68@) (Add a8~66@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%8 (= temp_8_0~2228@ temp_8_1~2305@)))))) (=> (= temp_8_0~2228@ temp_8_1~2305@) (=> (= temp_9_0~2424@ (Mul (Mul (Mul (Add a9~74@ c9~78@) (Sub a9~74@ b9~76@)) (Mul (Sub a9~74@ b9~76@) (Add d9~80@ a9~74@))) (Mul (Sub (Mul a9~74@ a9~74@) (Add a9~74@ d9~80@)) (Mul (Mul d9~80@ b9~76@) (Add b9~76@ d9~80@))))) (=> (= temp_9_1~2505@ (Mul (Mul (Mul (Add a9~74@ c9~78@) (Sub a9~74@ b9~76@)) (Mul (Sub a9~74@ b9~76@) (Add d9~80@ a9~74@))) (Sub (Mul (Mul a9~74@ a9~74@) (Mul (Mul d9~80@ b9~76@) (Add b9~76@ d9~80@))) (Mul (Add a9~74@ d9~80@) (Mul (Mul d9~80@ b9~76@) (Add b9~76@ d9~80@)))))) (and (=> (= tmp%35@ (Mul a9~74@ a9~74@)) (=> (= tmp%36@ (Add a9~74@ d9~80@)) (=> (= tmp%37@ (Mul (Mul d9~80@ b9~76@) (Add b9~76@ d9~80@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%35@ tmp%36@ tmp%37@) (=> %%location_label%%9 (= temp_9_0~2424@ temp_9_1~2505@)))))) (=> (= temp_9_0~2424@ temp_9_1~2505@) (=> (= temp_10_0~2620@ (Mul (Mul (Add (Sub a10~82@ d10~88@) (Mul c10~86@ c10~86@)) (Sub (Mul b10~84@ c10~86@) (Sub a10~82@ d10~88@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Add a10~82@ a10~82@) (Mul b10~84@ c10~86@))))) (=> (= temp_10_1~2701@ (Mul (Sub (Mul (Add (Sub a10~82@ d10~88@) (Mul c10~86@ c10~86@)) (Mul b10~84@ c10~86@)) (Mul (Add (Sub a10~82@ d10~88@) (Mul c10~86@ c10~86@)) (Sub a10~82@ d10~88@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Add a10~82@ a10~82@) (Mul b10~84@ c10~86@))))) (and (=> (= tmp%38@ (Add (Sub a10~82@ d10~88@) (Mul c10~86@ c10~86@))) (=> (= tmp%39@ (Mul b10~84@ c10~86@)) (=> (= tmp%40@ (Sub a10~82@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%38@ tmp%39@ tmp%40@) (=> %%location_label%%10 (= temp_10_0~2620@ temp_10_1~2701@)))))) (=> (= temp_10_0~2620@ temp_10_1~2701@) (=> (= temp_11_0~2808@ (Mul (Mul (Sub 27 (Mul d11~96@ a11~90@)) (Mul a11~90@ (Mul c11~94@ d11~96@))) (Mul a11~90@ (Sub (Mul d11~96@ d11~96@) (Add a11~90@ d11~96@))))) (=> (= temp_11_1~2865@ (Mul (Mul (Sub 27 (Mul d11~96@ a11~90@)) (Mul a11~90@ (Mul c11~94@ d11~96@))) (Mul (Sub (Mul d11~96@ d11~96@) (Add a11~90@ d11~96@)) a11~90@))) (and (=> (= tmp%41@ (Sub (Mul d11~96@ d11~96@) (Add a11~90@ d11~96@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%41@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2808@ temp_11_1~2865@)))) (=> (= temp_11_0~2808@ temp_11_1~2865@) (=> (= temp_12_0~2970@ (Add (Add (Mul (Mul d12~104@ a12~98@) (Sub d12~104@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul a12~98@ b12~100@))) (Sub (Mul (Add b12~100@ c12~102@) (Add a12~98@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@))))) (=> (= temp_12_1~3043@ (Add (Add (Sub (Mul (Mul d12~104@ a12~98@) d12~104@) (Mul (Mul d12~104@ a12~98@) d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul a12~98@ b12~100@))) (Sub (Mul (Add b12~100@ c12~102@) (Add a12~98@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@))))) (and (=> (= tmp%42@ (Mul d12~104@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%42@ d12~104@ d12~104@) (=> %%location_label%%12 (= temp_12_0~2970@ temp_12_1~3043@)))) (=> (= temp_12_0~2970@ temp_12_1~3043@) (=> (= temp_13_0~3134@ (Sub (Mul (Mul (Add c13~110@ d13~112@) a13~106@) (Mul (Mul d13~112@ c13~110@) (Add d13~112@ a13~106@))) (Mul (Mul (Add a13~106@ d13~112@) (Mul a13~106@ a13~106@)) (Mul b13~108@ (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~3199@ (Sub (Mul (Mul (Add c13~110@ d13~112@) a13~106@) (Add (Mul (Mul d13~112@ c13~110@) d13~112@) (Mul (Mul d13~112@ c13~110@) a13~106@))) (Mul (Mul (Add a13~106@ d13~112@) (Mul a13~106@ a13~106@)) (Mul b13~108@ (Mul d13~112@ a13~106@))))) (and (=> (= tmp%43@ (Mul d13~112@ c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%43@ d13~112@ a13~106@) (=> %%location_label%%13 (= temp_13_0~3134@ temp_13_1~3199@)))) (=> (= temp_13_0~3134@ temp_13_1~3199@) (=> (= temp_14_0~3298@ (Sub (Mul (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ d14~120@)) (Add (Mul b14~116@ d14~120@) (Add d14~120@ d14~120@))) (Sub (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@)) (Mul (Mul c14~118@ d14~120@) (Add a14~114@ b14~116@))))) (=> (= temp_14_1~3363@ (Sub (Mul (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ d14~120@)) (Add (Mul b14~116@ d14~120@) (Add d14~120@ d14~120@))) (Sub (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@)) (Mul (Mul c14~118@ d14~120@) (Add a14~114@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ c14~118@) (=> (= tmp%44@ (Mul d14~120@ c14~118@)) (=> (= tmp%45@ (Mul d14~120@ d14~120@)) (=> (= tmp%46@ (Add (Mul b14~116@ d14~120@) (Add d14~120@ d14~120@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%44@ tmp%45@ tmp%46@) (=> (= tmp%47@ (Mul c14~118@ d14~120@)) (=> (= tmp%48@ (Mul d14~120@ d14~120@)) (=> (= tmp%49@ (Add (Mul b14~116@ d14~120@) (Add d14~120@ d14~120@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%47@ tmp%48@ tmp%49@) (=> %%location_label%%14 (= temp_14_0~3298@ temp_14_1~3363@))))))))))) (=> (= temp_14_0~3298@ temp_14_1~3363@) (=> (= temp_15_0~3512@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Add a15~122@ b15~124@)) (Add (Mul c15~126@ c15~126@) (Mul a15~122@ b15~124@))) (Add (Mul (Sub c15~126@ b15~124@) c15~126@) (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ a15~122@))))) (=> (= temp_15_1~3573@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Add a15~122@ b15~124@)) (Add (Mul c15~126@ c15~126@) (Mul a15~122@ b15~124@))) (Add (Mul (Sub c15~126@ b15~124@) c15~126@) (Mul (Mul a15~122@ b15~124@) (Mul b15~124@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a15~122@ b15~124@) (=> %%location_label%%15 (= temp_15_0~3512@ temp_15_1~3573@))) (=> (= temp_15_0~3512@ temp_15_1~3573@) (=> (= temp_16_0~3666@ (Mul (Mul (Mul (Add d16~136@ d16~136@) (Mul a16~130@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ b16~132@))) (Mul (Mul (Sub b16~132@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~3731@ (Mul (Mul (Mul (Mul (Add d16~136@ d16~136@) (Mul a16~130@ b16~132@)) (Mul b16~132@ a16~130@)) (Mul b16~132@ b16~132@)) (Mul (Mul (Sub b16~132@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ d16~136@))))) (and (=> (= tmp%50@ (Mul (Add d16~136@ d16~136@) (Mul a16~130@ b16~132@))) (=> (= tmp%51@ (Mul b16~132@ a16~130@)) (=> (= tmp%52@ (Mul b16~132@ b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%50@ tmp%51@ tmp%52@) (=> %%location_label%%16 (= temp_16_0~3666@ temp_16_1~3731@)))))) (=> (= temp_16_0~3666@ temp_16_1~3731@) (=> (= temp_17_0~3846@ (Mul (Mul (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ b17~140@)) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ c17~142@))) (Add (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ b17~140@)) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~3911@ (Mul (Mul (Mul (Mul (Mul c17~142@ a17~138@) c17~142@) b17~140@) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ c17~142@))) (Add (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ b17~140@)) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@))))) (and (=> (= tmp%53@ (Mul (Mul (Mul c17~142@ a17~138@) c17~142@) b17~140@)) (=> (= tmp%54@ (Add (Mul d17~144@ b17~140@) (Mul a17~138@ c17~142@))) (=> (= tmp%55@ (Add (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ b17~140@)) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%53@ tmp%54@ tmp%55@) (=> (= tmp%56@ (Mul c17~142@ a17~138@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%56@ c17~142@ b17~140@) (=> (= tmp%57@ (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ b17~140@))) (=> (= tmp%58@ (Add (Mul d17~144@ b17~140@) (Mul a17~138@ c17~142@))) (=> (= tmp%59@ (Add (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ b17~140@)) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%57@ tmp%58@ tmp%59@) (=> %%location_label%%17 (= temp_17_0~3846@ temp_17_1~3911@)))))))))))) (=> (= temp_17_0~3846@ temp_17_1~3911@) (=> (= temp_18_0~4146@ (Mul (Mul (Sub (Mul c18~150@ d18~152@) (Mul d18~152@ b18~148@)) (Sub (Mul 80 c18~150@) (Mul a18~146@ d18~152@))) (Sub (Sub (Mul c18~150@ d18~152@) (Mul c18~150@ c18~150@)) (Mul (Mul d18~152@ b18~148@) (Mul a18~146@ b18~148@))))) (=> (= temp_18_1~4223@ (Mul (Mul (Sub (Mul c18~150@ d18~152@) (Mul d18~152@ b18~148@)) (Sub (Mul 80 c18~150@) (Mul a18~146@ d18~152@))) (Sub (Sub (Mul c18~150@ d18~152@) (Mul c18~150@ c18~150@)) (Mul (Mul d18~152@ b18~148@) (Mul b18~148@ a18~146@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b18~148@ a18~146@) (=> %%location_label%%18 (= temp_18_0~4146@ temp_18_1~4223@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
