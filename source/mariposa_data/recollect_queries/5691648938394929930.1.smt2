...
(declare-const temp_6_0~1232@ Int)
(declare-const temp_6_1~1297@ Int)
(declare-const temp_7_0~1386@ Int)
(declare-const temp_7_1~1439@ Int)
(declare-const temp_8_0~1524@ Int)
(declare-const temp_8_1~1577@ Int)
(declare-const temp_9_0~1742@ Int)
(declare-const temp_9_1~1779@ Int)
(declare-const temp_10_0~1942@ Int)
(declare-const temp_10_1~2003@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Mul c0~6@ (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@)) (Sub (Sub d0~8@ d0~8@) (Sub c0~6@ a0~2@))))) (=> (= temp_0_1~314@ (Mul c0~6@ (Mul (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ b0~4@)) (Sub (Sub d0~8@ d0~8@) (Sub c0~6@ a0~2@))))) (and (=> (= tmp%1@ (Mul b0~4@ c0~6@)) (=> (= tmp%2@ (Mul b0~4@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~277@ temp_0_1~314@))))) (=> (= temp_0_0~277@ temp_0_1~314@) (=> (= temp_1_0~411@ (Sub (Mul (Mul (Mul a1~10@ c1~14@) c1~14@) (Sub (Add d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Sub (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Add d1~16@ a1~10@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~484@ (Sub (Sub (Mul (Mul (Mul a1~10@ c1~14@) c1~14@) (Add d1~16@ b1~12@)) (Mul (Mul (Mul a1~10@ c1~14@) c1~14@) (Mul c1~14@ a1~10@))) (Sub (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Add d1~16@ a1~10@) (Mul a1~10@ c1~14@))))) (and (=> (= tmp%3@ (Mul (Mul a1~10@ c1~14@) c1~14@)) (=> (= tmp%4@ (Add d1~16@ b1~12@)) (=> (= tmp%5@ (Mul c1~14@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~411@ temp_1_1~484@)))))) (=> (= temp_1_0~411@ temp_1_1~484@) (=> (= temp_2_0~583@ (Mul (Mul c2~22@ (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul c2~22@ c2~22@) (Sub b2~20@ c2~22@)) (Mul (Add b2~20@ b2~20@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~636@ (Mul (Mul c2~22@ (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul c2~22@ c2~22@) (Sub b2~20@ c2~22@)) (Mul (Add b2~20@ b2~20@) (Mul c2~22@ c2~22@))))) (=> (= tmp%6@ (= temp_2_0~583@ temp_2_1~636@)) (and (=> %%location_label%%2 tmp%6@) (=> tmp%6@ (=> (= temp_3_0~724@ (Add (Mul (Mul (Mul c3~30@ c3~30@) a3~26@) (Add (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ 22)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~797@ (Add (Mul (Mul (Mul c3~30@ c3~30@) a3~26@) (Add (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ 22)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))))) (=> (= tmp%7@ (= temp_3_0~724@ temp_3_1~797@)) (and (=> %%location_label%%3 tmp%7@) (=> tmp%7@ (=> (= temp_4_0~889@ (Mul (Add (Mul (Add c4~38@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul 34 c4~38@) (Mul d4~40@ b4~36@))) (Add (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ a4~34@))))) (=> (= temp_4_1~966@ (Mul (Add (Mul (Add c4~38@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Mul 34 c4~38@))) (Add (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ a4~34@))))) (and (=> (= tmp%8@ (Mul d4~40@ b4~36@)) (=> (= tmp%9@ (Mul 34 c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%4 (= temp_4_0~889@ temp_4_1~966@))))) (=> (= temp_4_0~889@ temp_4_1~966@) (=> (= temp_5_0~1079@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ 31)) (Sub (Mul c5~46@ d5~48@) (Mul b5~44@ b5~44@))) (Sub (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@)) (Mul c5~46@ (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1152@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ 31)) (Sub (Mul c5~46@ d5~48@) (Mul b5~44@ b5~44@))) (Sub (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@)) (Mul c5~46@ (Mul a5~42@ a5~42@))))) (=> (= tmp%10@ (= temp_5_0~1079@ temp_5_1~1152@)) (and (=> %%location_label%%5 tmp%10@) (=> tmp%10@ (=> (= temp_6_0~1232@ (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Sub (Mul d6~56@ c6~54@) (Add d6~56@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1297@ (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Sub (Mul d6~56@ c6~54@) (Add d6~56@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ b6~52@))))) (and (=> (= tmp%11@ (Mul c6~54@ d6~56@)) (=> (= tmp%12@ (Mul a6~50@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%6 (= temp_6_0~1232@ temp_6_1~1297@))))) (=> (= temp_6_0~1232@ temp_6_1~1297@) (=> (= temp_7_0~1386@ (Mul (Mul (Mul (Sub b7~60@ b7~60@) (Sub b7~60@ a7~58@)) (Mul d7~64@ (Mul b7~60@ c7~62@))) (Mul (Mul (Mul d7~64@ a7~58@) b7~60@) (Mul c7~62@ (Mul d7~64@ c7~62@))))) (=> (= temp_7_1~1439@ (Mul (Mul (Mul (Sub b7~60@ b7~60@) (Sub b7~60@ a7~58@)) (Mul d7~64@ (Mul b7~60@ c7~62@))) (Mul (Mul b7~60@ (Mul d7~64@ a7~58@)) (Mul c7~62@ (Mul d7~64@ c7~62@))))) (and (=> (= tmp%13@ (Mul d7~64@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ tmp%13@) (=> %%location_label%%7 (= temp_7_0~1386@ temp_7_1~1439@)))) (=> (= temp_7_0~1386@ temp_7_1~1439@) (=> (= temp_8_0~1524@ (Mul (Add (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) c8~70@) (Mul (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1577@ (Mul (Add (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) c8~70@) (Mul (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d8~72@ a8~66@) (=> (= tmp%14@ (Add (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) c8~70@)) (=> (= tmp%15@ (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@))) (=> (= tmp%16@ (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> (= tmp%17@ (Add (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) c8~70@)) (=> (= tmp%18@ (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@))) (=> (= tmp%19@ (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%8 (= temp_8_0~1524@ temp_8_1~1577@))))))))))) (=> (= temp_8_0~1524@ temp_8_1~1577@) (=> (= temp_9_0~1742@ (Mul d9~80@ (Mul (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ d9~80@)) (Mul (Sub a9~74@ a9~74@) (Mul a9~74@ d9~80@))))) (=> (= temp_9_1~1779@ (Mul d9~80@ (Mul (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ d9~80@)) (Mul (Mul (Sub a9~74@ a9~74@) a9~74@) d9~80@)))) (and (=> (= tmp%20@ (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ d9~80@))) (=> (= tmp%21@ (Mul (Mul (Sub a9~74@ a9~74@) a9~74@) d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d9~80@ tmp%20@ tmp%21@) (=> (= tmp%22@ (Sub a9~74@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ a9~74@ d9~80@) (=> (= tmp%23@ (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ d9~80@))) (=> (= tmp%24@ (Mul (Sub a9~74@ a9~74@) (Mul a9~74@ d9~80@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. d9~80@ tmp%23@ tmp%24@) (=> %%location_label%%9 (= temp_9_0~1742@ temp_9_1~1779@)))))))))) (=> (= temp_9_0~1742@ temp_9_1~1779@) (=> (= temp_10_0~1942@ (Mul (Sub (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul b10~84@ d10~88@)) (Mul b10~84@ (Mul a10~82@ d10~88@))))) (=> (= temp_10_1~2003@ (Mul (Mul (Sub (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ c10~86@))) (Mul (Mul a10~82@ a10~82@) (Mul b10~84@ d10~88@))) (Mul b10~84@ (Mul a10~82@ d10~88@)))) (=> (= tmp%25@ (Sub (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ c10~86@)))) (=> (= tmp%26@ (Mul (Mul a10~82@ a10~82@) (Mul b10~84@ d10~88@))) (=> (= tmp%27@ (Mul b10~84@ (Mul a10~82@ d10~88@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%10 (= temp_10_0~1942@ temp_10_1~2003@))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
