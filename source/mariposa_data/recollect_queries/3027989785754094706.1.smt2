...
(declare-const temp_7_0~1625@ Int)
(declare-const temp_7_1~1686@ Int)
(declare-const temp_8_0~1758@ Int)
(declare-const temp_8_1~1815@ Int)
(declare-const temp_9_0~1954@ Int)
(declare-const temp_9_1~2019@ Int)
(declare-const temp_10_0~2236@ Int)
(declare-const temp_10_1~2305@ Int)
(declare-const temp_11_0~2412@ Int)
(declare-const temp_11_1~2477@ Int)
(declare-const temp_12_0~2570@ Int)
(declare-const temp_12_1~2627@ Int)
(declare-const temp_13_0~2828@ Int)
(declare-const temp_13_1~2893@ Int)
(declare-const temp_14_0~3004@ Int)
(declare-const temp_14_1~3081@ Int)
(declare-const temp_15_0~3206@ Int)
(declare-const temp_15_1~3275@ Int)
(declare-const temp_16_0~3392@ Int)
(declare-const temp_16_1~3457@ Int)
(declare-const temp_17_0~3684@ Int)
(declare-const temp_17_1~3753@ Int)
(declare-const temp_18_0~3868@ Int)
(declare-const temp_18_1~3933@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Sub a0~2@ d0~8@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~370@ (Add (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Sub a0~2@ d0~8@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@))))) (and (=> (= tmp%1@ (Mul a0~2@ b0~4@)) (=> (= tmp%2@ (Sub a0~2@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~471@ (Add (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~536@ (Add (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ a1~10@) (=> %%location_label%%1 (= temp_1_0~471@ temp_1_1~536@))) (=> (= temp_1_0~471@ temp_1_1~536@) (=> (= temp_2_0~629@ (Add (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ a2~18@)) (Sub (Mul d2~24@ a2~18@) (Mul a2~18@ b2~20@))) (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~694@ (Add (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ a2~18@)) (Sub (Mul d2~24@ a2~18@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ a2~18@) (=> %%location_label%%2 (= temp_2_0~629@ temp_2_1~694@))) (=> (= temp_2_0~629@ temp_2_1~694@) (=> (= temp_3_0~795@ (Mul (Add (Mul (Add d3~32@ c3~30@) b3~28@) (Mul (Mul d3~32@ a3~26@) (Sub d3~32@ 92))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub a3~26@ c3~30@)) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~868@ (Mul (Add (Mul (Add d3~32@ c3~30@) b3~28@) (Mul (Mul d3~32@ a3~26@) (Sub d3~32@ 92))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub a3~26@ c3~30@)) (Mul b3~28@ (Mul a3~26@ (Mul b3~28@ a3~26@)))))) (and (=> (= tmp%3@ (Mul b3~28@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b3~28@ a3~26@ tmp%3@) (=> (= tmp%4@ (Add (Mul (Add d3~32@ c3~30@) b3~28@) (Mul (Mul d3~32@ a3~26@) (Sub d3~32@ 92)))) (=> (= tmp%5@ (Mul (Mul c3~30@ d3~32@) (Sub a3~26@ c3~30@))) (=> (= tmp%6@ (Mul b3~28@ (Mul a3~26@ (Mul b3~28@ a3~26@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> (= tmp%7@ (Add (Mul (Add d3~32@ c3~30@) b3~28@) (Mul (Mul d3~32@ a3~26@) (Sub d3~32@ 92)))) (=> (= tmp%8@ (Mul (Mul c3~30@ d3~32@) (Sub a3~26@ c3~30@))) (=> (= tmp%9@ (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%3 (= temp_3_0~795@ temp_3_1~868@)))))))))))) (=> (= temp_3_0~795@ temp_3_1~868@) (=> (= temp_4_0~1091@ (Sub (Sub (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Sub (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~1156@ (Sub (Sub (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Sub (Mul c4~38@ d4~40@) (Mul a4~34@ c4~38@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c4~38@ d4~40@) (=> %%location_label%%4 (= temp_4_0~1091@ temp_4_1~1156@))) (=> (= temp_4_0~1091@ temp_4_1~1156@) (=> (= temp_5_0~1237@ (Mul (Sub (Mul (Mul b5~44@ a5~42@) d5~48@) (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Add b5~44@ c5~46@) a5~42@) (Mul d5~48@ (Sub b5~44@ d5~48@))))) (=> (= temp_5_1~1314@ (Sub (Mul (Mul (Mul b5~44@ a5~42@) d5~48@) (Mul (Mul (Add b5~44@ c5~46@) a5~42@) (Mul d5~48@ (Sub b5~44@ d5~48@)))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ b5~44@)) (Mul (Mul (Add b5~44@ c5~46@) a5~42@) (Mul d5~48@ (Sub b5~44@ d5~48@)))))) (and (=> (= tmp%10@ (Mul (Mul b5~44@ a5~42@) d5~48@)) (=> (= tmp%11@ (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ b5~44@))) (=> (= tmp%12@ (Mul (Mul (Add b5~44@ c5~46@) a5~42@) (Mul d5~48@ (Sub b5~44@ d5~48@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%5 (= temp_5_0~1237@ temp_5_1~1314@)))))) (=> (= temp_5_0~1237@ temp_5_1~1314@) (=> (= temp_6_0~1457@ (Add (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Add c6~54@ b6~52@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul d6~56@ 61) c6~54@) (Mul (Sub d6~56@ c6~54@) (Mul a6~50@ d6~56@))))) (=> (= temp_6_1~1530@ (Add (Mul (Mul (Mul (Mul c6~54@ d6~56@) c6~54@) a6~50@) (Mul (Add c6~54@ b6~52@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul d6~56@ 61) c6~54@) (Mul (Sub d6~56@ c6~54@) (Mul a6~50@ d6~56@))))) (and (=> (= tmp%13@ (Mul c6~54@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ c6~54@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1457@ temp_6_1~1530@)))) (=> (= temp_6_0~1457@ temp_6_1~1530@) (=> (= temp_7_0~1625@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ d7~64@)) (Add d7~64@ (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1686@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ d7~64@)) (Add d7~64@ (Mul a7~58@ a7~58@))))) (=> (= tmp%14@ (= temp_7_0~1625@ temp_7_1~1686@)) (and (=> %%location_label%%7 tmp%14@) (=> tmp%14@ (=> (= temp_8_0~1758@ (Mul (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul a8~66@ (Mul b8~68@ c8~70@))) (Mul (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ d8~72@) b8~68@)))) (=> (= temp_8_1~1815@ (Mul (Mul (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul a8~66@ (Mul b8~68@ c8~70@))) (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@))) (Mul (Mul b8~68@ d8~72@) b8~68@))) (and (=> (= tmp%15@ (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul a8~66@ (Mul b8~68@ c8~70@)))) (=> (= tmp%16@ (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@))) (=> (= tmp%17@ (Mul (Mul b8~68@ d8~72@) b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%8 (= temp_8_0~1758@ temp_8_1~1815@)))))) (=> (= temp_8_0~1758@ temp_8_1~1815@) (=> (= temp_9_0~1954@ (Mul (Sub (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@))) (Mul (Mul (Mul d9~80@ b9~76@) (Sub b9~76@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~2019@ (Mul (Sub (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@))) (Mul (Mul (Mul d9~80@ b9~76@) (Sub b9~76@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b9~76@ d9~80@) (=> (= tmp%18@ (Sub (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@)))) (=> (= tmp%19@ (Mul (Mul d9~80@ b9~76@) (Sub b9~76@ c9~78@))) (=> (= tmp%20@ (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ b9~76@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> (= tmp%21@ (Sub (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@)))) (=> (= tmp%22@ (Mul (Mul d9~80@ b9~76@) (Sub b9~76@ c9~78@))) (=> (= tmp%23@ (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ d9~80@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%9 (= temp_9_0~1954@ temp_9_1~2019@))))))))))) (=> (= temp_9_0~1954@ temp_9_1~2019@) (=> (= temp_10_0~2236@ (Add (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul a10~82@ (Sub (Mul 35 d10~88@) (Mul a10~82@ d10~88@))))) (=> (= temp_10_1~2305@ (Add (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Sub (Mul a10~82@ (Mul 35 d10~88@)) (Mul a10~82@ (Mul a10~82@ d10~88@))))) (and (=> (= tmp%24@ (Mul 35 d10~88@)) (=> (= tmp%25@ (Mul a10~82@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a10~82@ tmp%24@ tmp%25@) (=> %%location_label%%10 (= temp_10_0~2236@ temp_10_1~2305@))))) (=> (= temp_10_0~2236@ temp_10_1~2305@) (=> (= temp_11_0~2412@ (Add (Mul (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ b11~92@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~2477@ (Add (Mul (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ a11~90@))))) (and (=> (= tmp%26@ (Mul a11~90@ b11~92@)) (=> (= tmp%27@ (Mul c11~94@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%26@ tmp%27@) (=> %%location_label%%11 (= temp_11_0~2412@ temp_11_1~2477@))))) (=> (= temp_11_0~2412@ temp_11_1~2477@) (=> (= temp_12_0~2570@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ c12~102@))) (Mul (Add (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) d12~104@)))) (=> (= temp_12_1~2627@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ d12~104@)) (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ c12~102@))) (Mul (Add (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) d12~104@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a12~98@ d12~104@) (=> (= tmp%28@ (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ d12~104@))) (=> (= tmp%29@ (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ c12~102@))) (=> (= tmp%30@ (Mul (Add (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> (= tmp%31@ (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@))) (=> (= tmp%32@ (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ c12~102@))) (=> (= tmp%33@ (Mul (Add (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> %%location_label%%12 (= temp_12_0~2570@ temp_12_1~2627@))))))))))) (=> (= temp_12_0~2570@ temp_12_1~2627@) (=> (= temp_13_0~2828@ (Add (Mul d13~112@ (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul a13~106@ c13~110@)) (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ 45))))) (=> (= temp_13_1~2893@ (Add (Mul d13~112@ (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul (Mul d13~112@ c13~110@) a13~106@) c13~110@) (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ 45))))) (and (=> (= tmp%34@ (Mul d13~112@ c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ a13~106@ c13~110@) (=> %%location_label%%13 (= temp_13_0~2828@ temp_13_1~2893@)))) (=> (= temp_13_0~2828@ temp_13_1~2893@) (=> (= temp_14_0~3004@ (Mul (Mul (Mul (Mul a14~114@ 67) (Mul d14~120@ c14~118@)) (Sub (Mul c14~118@ c14~118@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Add b14~116@ b14~116@) (Sub c14~118@ a14~114@))))) (=> (= temp_14_1~3081@ (Mul (Mul (Sub (Mul c14~118@ c14~118@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ 67) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Add b14~116@ b14~116@) (Sub c14~118@ a14~114@))))) (and (=> (= tmp%35@ (Sub (Mul c14~118@ c14~118@) (Mul b14~116@ a14~114@))) (=> (= tmp%36@ (Mul (Mul a14~114@ 67) (Mul d14~120@ c14~118@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%35@ tmp%36@) (=> %%location_label%%14 (= temp_14_0~3004@ temp_14_1~3081@))))) (=> (= temp_14_0~3004@ temp_14_1~3081@) (=> (= temp_15_0~3206@ (Sub (Mul (Add c15~126@ (Mul a15~122@ c15~126@)) (Mul (Mul 77 a15~122@) (Mul a15~122@ a15~122@))) (Mul (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ b15~124@)) (Mul c15~126@ (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~3275@ (Sub (Mul (Mul (Mul 77 a15~122@) (Mul a15~122@ a15~122@)) (Add c15~126@ (Mul a15~122@ c15~126@))) (Mul (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ b15~124@)) (Mul c15~126@ (Mul a15~122@ c15~126@))))) (and (=> (= tmp%37@ (Mul (Mul 77 a15~122@) (Mul a15~122@ a15~122@))) (=> (= tmp%38@ (Add c15~126@ (Mul a15~122@ c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%37@ tmp%38@) (=> %%location_label%%15 (= temp_15_0~3206@ temp_15_1~3275@))))) (=> (= temp_15_0~3206@ temp_15_1~3275@) (=> (= temp_16_0~3392@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Sub c16~134@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Sub d16~136@ d16~136@))) (Mul (Mul (Add a16~130@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ c16~134@))))) (=> (= temp_16_1~3457@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Sub c16~134@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Sub d16~136@ d16~136@))) (Mul (Mul (Add a16~130@ d16~136@) (Mul d16~136@ d16~136@)) (Mul b16~132@ (Mul a16~130@ (Mul b16~132@ c16~134@)))))) (and (=> (= tmp%39@ (Mul b16~132@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b16~132@ a16~130@ tmp%39@) (=> (= tmp%40@ (Mul (Mul (Mul d16~136@ b16~132@) (Sub c16~134@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Sub d16~136@ d16~136@)))) (=> (= tmp%41@ (Mul (Add a16~130@ d16~136@) (Mul d16~136@ d16~136@))) (=> (= tmp%42@ (Mul b16~132@ (Mul a16~130@ (Mul b16~132@ c16~134@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ tmp%41@ tmp%42@) (=> (= tmp%43@ (Mul (Mul (Mul d16~136@ b16~132@) (Sub c16~134@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Sub d16~136@ d16~136@)))) (=> (= tmp%44@ (Mul (Add a16~130@ d16~136@) (Mul d16~136@ d16~136@))) (=> (= tmp%45@ (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ c16~134@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%43@ tmp%44@ tmp%45@) (=> %%location_label%%16 (= temp_16_0~3392@ temp_16_1~3457@)))))))))))) (=> (= temp_16_0~3392@ temp_16_1~3457@) (=> (= temp_17_0~3684@ (Mul (Mul (Add (Mul b17~140@ d17~144@) c17~142@) (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul b17~140@ a17~138@) (Mul b17~140@ b17~140@)) (Mul b17~140@ (Sub 19 d17~144@))))) (=> (= temp_17_1~3753@ (Mul (Mul (Add (Mul b17~140@ d17~144@) c17~142@) (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ b17~140@))) (Mul (Mul b17~140@ a17~138@) (Mul (Mul b17~140@ b17~140@) (Mul b17~140@ (Sub 19 d17~144@)))))) (and (=> (= tmp%46@ (Mul b17~140@ a17~138@)) (=> (= tmp%47@ (Mul b17~140@ b17~140@)) (=> (= tmp%48@ (Mul b17~140@ (Sub 19 d17~144@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%46@ tmp%47@ tmp%48@) (=> %%location_label%%17 (= temp_17_0~3684@ temp_17_1~3753@)))))) (=> (= temp_17_0~3684@ temp_17_1~3753@) (=> (= temp_18_0~3868@ (Mul (Add (Mul (Sub d18~152@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Mul a18~146@ d18~152@) (Add a18~146@ a18~146@))) (Mul (Mul (Add b18~148@ c18~150@) (Add c18~150@ a18~146@)) (Mul (Mul b18~148@ d18~152@) (Mul c18~150@ c18~150@))))) (=> (= temp_18_1~3933@ (Mul (Add (Mul (Sub d18~152@ b18~148@) (Mul b18~148@ c18~150@)) (Mul a18~146@ (Mul d18~152@ (Add a18~146@ a18~146@)))) (Mul (Mul (Add b18~148@ c18~150@) (Add c18~150@ a18~146@)) (Mul (Mul b18~148@ d18~152@) (Mul c18~150@ c18~150@))))) (=> (= tmp%49@ (Add a18~146@ a18~146@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a18~146@ d18~152@ tmp%49@) (=> %%location_label%%18 (= temp_18_0~3868@ temp_18_1~3933@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
