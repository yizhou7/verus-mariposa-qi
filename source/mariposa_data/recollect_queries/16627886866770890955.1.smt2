...
(declare-const temp_2_0~765@ Int)
(declare-const temp_2_1~842@ Int)
(declare-const temp_3_0~929@ Int)
(declare-const temp_3_1~982@ Int)
(declare-const temp_4_0~1095@ Int)
(declare-const temp_4_1~1144@ Int)
(declare-const temp_5_0~1259@ Int)
...
(declare-const temp_7_1~1700@ Int)
(declare-const temp_8_0~1788@ Int)
(declare-const temp_8_1~1869@ Int)
(declare-const temp_9_0~1960@ Int)
(declare-const temp_9_1~2013@ Int)
(declare-const temp_10_0~2106@ Int)
(declare-const temp_10_1~2159@ Int)
(declare-const temp_11_0~2256@ Int)
(declare-const temp_11_1~2321@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Mul (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ a0~2@)) (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (Add (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ b0~4@)) (Add (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~370@ (Add (Mul (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ a0~2@))) (Add (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ b0~4@)) (Add (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@))))) (and (=> (= tmp%1@ (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (=> (= tmp%2@ (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~483@ (Mul (Sub (Sub (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Sub d1~16@ a1~10@) (Sub a1~10@ a1~10@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@)) (Mul a1~10@ (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~544@ (Mul (Sub (Sub (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Sub d1~16@ a1~10@) (Sub a1~10@ a1~10@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@)) (Mul a1~10@ (Mul d1~16@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ b1~12@) (=> (= tmp%3@ (Sub (Sub (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Sub d1~16@ a1~10@) (Sub a1~10@ a1~10@)))) (=> (= tmp%4@ (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@))) (=> (= tmp%5@ (Mul a1~10@ (Mul d1~16@ b1~12@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Sub (Sub (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Sub d1~16@ a1~10@) (Sub a1~10@ a1~10@)))) (=> (= tmp%7@ (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@))) (=> (= tmp%8@ (Mul a1~10@ (Mul b1~12@ d1~16@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%1 (= temp_1_0~483@ temp_1_1~544@))))))))))) (=> (= temp_1_0~483@ temp_1_1~544@) (=> (= temp_2_0~765@ (Add (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Sub b2~20@ 31) (Add a2~18@ b2~20@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~842@ (Add (Mul (Mul c2~22@ (Mul d2~24@ (Mul d2~24@ a2~18@))) (Mul (Sub b2~20@ 31) (Add a2~18@ b2~20@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))))) (and (=> (= tmp%9@ (Mul d2~24@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c2~22@ d2~24@ tmp%9@) (=> %%location_label%%2 (= temp_2_0~765@ temp_2_1~842@)))) (=> (= temp_2_0~765@ temp_2_1~842@) (=> (= temp_3_0~929@ (Mul (Mul c3~30@ (Mul (Sub b3~28@ d3~32@) (Mul c3~30@ d3~32@))) (Mul (Mul (Mul b3~28@ d3~32@) (Sub d3~32@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~982@ (Mul (Mul c3~30@ (Mul (Sub b3~28@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Sub d3~32@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ c3~30@) (=> (= tmp%10@ (Sub b3~28@ d3~32@)) (=> (= tmp%11@ (Mul d3~32@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c3~30@ tmp%10@ tmp%11@) (=> (= tmp%12@ (Sub b3~28@ d3~32@)) (=> (= tmp%13@ (Mul c3~30@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c3~30@ tmp%12@ tmp%13@) (=> %%location_label%%3 (= temp_3_0~929@ temp_3_1~982@))))))))) (=> (= temp_3_0~929@ temp_3_1~982@) (=> (= temp_4_0~1095@ (Mul (Mul (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Mul (Sub b4~36@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul c4~38@ b4~36@) a4~34@) d4~40@))) (=> (= temp_4_1~1144@ (Mul (Mul (Mul (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Sub b4~36@ a4~34@)) (Mul c4~38@ b4~36@)) (Mul (Mul (Mul c4~38@ b4~36@) a4~34@) d4~40@))) (and (=> (= tmp%14@ (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@))) (=> (= tmp%15@ (Sub b4~36@ a4~34@)) (=> (= tmp%16@ (Mul c4~38@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%4 (= temp_4_0~1095@ temp_4_1~1144@)))))) (=> (= temp_4_0~1095@ temp_4_1~1144@) (=> (= temp_5_0~1259@ (Mul (Mul (Add (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1324@ (Mul (Mul (Add (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul (Mul d5~48@ a5~42@) a5~42@) d5~48@)) (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ b5~44@))))) (and (=> (= tmp%17@ (Mul d5~48@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ a5~42@ d5~48@) (=> %%location_label%%5 (= temp_5_0~1259@ temp_5_1~1324@)))) (=> (= temp_5_0~1259@ temp_5_1~1324@) (=> (= temp_6_0~1423@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Add (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Add (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1488@ (Mul (Add (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Add (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@)) (Mul (Add (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ c6~54@)))))) (and (=> (= tmp%18@ (Add (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@))) (=> (= tmp%19@ (Add (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@))) (=> (= tmp%20@ (Mul (Add (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ c6~54@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%6 (= temp_6_0~1423@ temp_6_1~1488@)))))) (=> (= temp_6_0~1423@ temp_6_1~1488@) (=> (= temp_7_0~1635@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Add (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@))) (Sub (Mul (Sub d7~64@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1700@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Add (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@))) (Sub (Mul (Sub d7~64@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))))) (=> (= tmp%21@ (= temp_7_0~1635@ temp_7_1~1700@)) (and (=> %%location_label%%7 tmp%21@) (=> tmp%21@ (=> (= temp_8_0~1788@ (Sub (Mul (Mul (Sub d8~72@ 55) (Add d8~72@ d8~72@)) (Mul b8~68@ (Mul c8~70@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@)) (Mul (Sub a8~66@ c8~70@) (Sub b8~68@ d8~72@))))) (=> (= temp_8_1~1869@ (Sub (Mul (Sub (Mul d8~72@ (Add d8~72@ d8~72@)) (Mul 55 (Add d8~72@ d8~72@))) (Mul b8~68@ (Mul c8~70@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@)) (Mul (Sub a8~66@ c8~70@) (Sub b8~68@ d8~72@))))) (and (=> (= tmp%22@ (Add d8~72@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d8~72@ 55 tmp%22@) (=> %%location_label%%8 (= temp_8_0~1788@ temp_8_1~1869@)))) (=> (= temp_8_0~1788@ temp_8_1~1869@) (=> (= temp_9_0~1960@ (Mul (Mul (Mul (Add a9~74@ c9~78@) (Mul b9~76@ a9~74@)) d9~80@) (Add (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ d9~80@))))) (=> (= temp_9_1~2013@ (Mul (Mul d9~80@ (Mul (Add a9~74@ c9~78@) (Mul b9~76@ a9~74@))) (Add (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ d9~80@))))) (and (=> (= tmp%23@ (Mul (Add a9~74@ c9~78@) (Mul b9~76@ a9~74@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ tmp%23@) (=> %%location_label%%9 (= temp_9_0~1960@ temp_9_1~2013@)))) (=> (= temp_9_0~1960@ temp_9_1~2013@) (=> (= temp_10_0~2106@ (Mul (Mul (Sub (Sub d10~88@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul a10~82@ d10~88@) (Add a10~82@ a10~82@)) d10~88@))) (=> (= temp_10_1~2159@ (Mul (Mul (Sub (Sub d10~88@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul a10~82@ d10~88@) (Add a10~82@ a10~82@)) d10~88@))) (and (=> (= tmp%24@ (Mul c10~86@ c10~86@)) (=> (= tmp%25@ (Mul c10~86@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%24@ tmp%25@) (=> %%location_label%%10 (= temp_10_0~2106@ temp_10_1~2159@))))) (=> (= temp_10_0~2106@ temp_10_1~2159@) (=> (= temp_11_0~2256@ (Mul (Add (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Mul b11~92@ (Add b11~92@ b11~92@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2321@ (Mul (Add (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Add (Mul b11~92@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b11~92@ b11~92@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2256@ temp_11_1~2321@))) (=> (= temp_11_0~2256@ temp_11_1~2321@) (=> (= temp_12_0~2416@ (Sub (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ a12~98@) (Mul c12~102@ c12~102@))) (Mul (Mul (Sub a12~98@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~2481@ (Sub (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul a12~98@ (Mul a12~98@ (Mul c12~102@ c12~102@)))) (Mul (Mul (Sub a12~98@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ b12~100@))))) (and (=> (= tmp%26@ (Mul c12~102@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a12~98@ a12~98@ tmp%26@) (=> %%location_label%%12 (= temp_12_0~2416@ temp_12_1~2481@)))) (=> (= temp_12_0~2416@ temp_12_1~2481@) (=> (= temp_13_0~2576@ (Mul (Mul (Mul a13~106@ (Sub b13~108@ d13~112@)) (Sub (Mul d13~112@ d13~112@) (Mul a13~106@ c13~110@))) (Mul (Mul (Mul b13~108@ a13~106@) (Mul d13~112@ c13~110@)) (Add (Add a13~106@ d13~112@) (Mul a13~106@ d13~112@))))) (=> (= temp_13_1~2637@ (Mul (Mul (Mul a13~106@ (Sub b13~108@ d13~112@)) (Sub (Mul d13~112@ d13~112@) (Mul a13~106@ c13~110@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul b13~108@ a13~106@)) (Add (Add a13~106@ d13~112@) (Mul a13~106@ d13~112@))))) (=> (= tmp%27@ (Mul d13~112@ c13~110@)) (=> (= tmp%28@ (Mul b13~108@ a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%13 (= temp_13_0~2576@ temp_13_1~2637@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
