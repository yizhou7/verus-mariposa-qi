...
(declare-const temp_8_1~1954@ Int)
(declare-const temp_9_0~2034@ Int)
(declare-const temp_9_1~2099@ Int)
(declare-const temp_10_0~2226@ Int)
(declare-const temp_10_1~2303@ Int)
(declare-const temp_11_0~2418@ Int)
(declare-const temp_11_1~2479@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Add (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ a0~2@) b0~4@)) (Mul (Sub (Mul d0~8@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@))))) (=> (= temp_0_1~378@ (Add (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ a0~2@) b0~4@)) (Sub (Mul (Mul d0~8@ d0~8@) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@))) (Mul (Mul c0~6@ a0~2@) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@)))))) (and (=> (= tmp%1@ (Mul d0~8@ d0~8@)) (=> (= tmp%2@ (Mul c0~6@ a0~2@)) (=> (= tmp%3@ (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~378@)))))) (=> (= temp_0_0~301@ temp_0_1~378@) (=> (= temp_1_0~493@ (Add (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Add c1~14@ b1~12@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~558@ (Add (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Add c1~14@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@))))) (and (=> (= tmp%4@ (Add c1~14@ b1~12@)) (=> (= tmp%5@ (Mul c1~14@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~493@ temp_1_1~558@))))) (=> (= temp_1_0~493@ temp_1_1~558@) (=> (= temp_2_0~667@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ 30) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~740@ (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ 30) (Mul c2~22@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ d2~24@) (=> (= tmp%6@ (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ b2~20@))) (=> (= tmp%7@ (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (=> (= tmp%8@ (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ 30) (Mul c2~22@ a2~18@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> (= tmp%9@ (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ b2~20@))) (=> (= tmp%10@ (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (=> (= tmp%11@ (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ 30) (Mul c2~22@ a2~18@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%2 (= temp_2_0~667@ temp_2_1~740@))))))))))) (=> (= temp_2_0~667@ temp_2_1~740@) (=> (= temp_3_0~953@ (Mul (Mul (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ a3~26@) d3~32@)) (Mul (Mul (Sub a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~1014@ (Mul (Mul (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ a3~26@) d3~32@)) (Mul (Mul (Mul (Sub a3~26@ c3~30@) b3~28@) d3~32@) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))))) (and (=> (= tmp%12@ (Sub a3~26@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ b3~28@ d3~32@) (=> %%location_label%%3 (= temp_3_0~953@ temp_3_1~1014@)))) (=> (= temp_3_0~953@ temp_3_1~1014@) (=> (= temp_4_0~1125@ (Sub (Add (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Add d4~40@ c4~38@) (Mul c4~38@ a4~34@))) (Mul (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul 93 b4~36@))))) (=> (= temp_4_1~1202@ (Sub (Add (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Add d4~40@ c4~38@) (Mul c4~38@ a4~34@))) (Mul (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul 93 b4~36@))))) (and (=> (= tmp%13@ (Mul a4~34@ c4~38@)) (=> (= tmp%14@ (Mul a4~34@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%4 (= temp_4_0~1125@ temp_4_1~1202@))))) (=> (= temp_4_0~1125@ temp_4_1~1202@) (=> (= temp_5_0~1315@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Sub 90 d5~48@)) (Add (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ c5~46@)) (Sub (Mul d5~48@ a5~42@) (Sub d5~48@ a5~42@))))) (=> (= temp_5_1~1392@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Sub 90 d5~48@)) (Add (Mul b5~44@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ c5~46@)) (Sub (Mul d5~48@ a5~42@) (Sub d5~48@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b5~44@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1315@ temp_5_1~1392@))) (=> (= temp_5_0~1315@ temp_5_1~1392@) (=> (= temp_6_0~1485@ (Sub (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ b6~52@))) (Mul (Sub (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@))))) (=> (= temp_6_1~1550@ (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ b6~52@)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Sub (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@))))) (and (=> (= tmp%15@ (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ b6~52@))) (=> (= tmp%16@ (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%6 (= temp_6_0~1485@ temp_6_1~1550@))))) (=> (= temp_6_0~1485@ temp_6_1~1550@) (=> (= temp_7_0~1699@ (Sub (Add (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Add d7~64@ b7~60@) (Mul a7~58@ d7~64@))) (Mul (Mul 52 (Mul a7~58@ a7~58@)) (Add (Mul b7~60@ 18) (Mul b7~60@ 39))))) (=> (= temp_7_1~1796@ (Sub (Add (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ a7~58@)) (Mul (Add d7~64@ b7~60@) (Mul a7~58@ d7~64@))) (Mul (Mul 52 (Mul a7~58@ a7~58@)) (Add (Mul b7~60@ 18) (Mul b7~60@ 39))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1699@ temp_7_1~1796@))) (=> (= temp_7_0~1699@ temp_7_1~1796@) (=> (= temp_8_0~1889@ (Mul (Sub (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))) (Mul (Add (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~1954@ (Mul (Sub (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))) (Mul (Add (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@))))) (=> (= tmp%17@ (= temp_8_0~1889@ temp_8_1~1954@)) (and (=> %%location_label%%8 tmp%17@) (=> tmp%17@ (=> (= temp_9_0~2034@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ b9~76@))) (Mul (Mul (Sub a9~74@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Sub c9~78@ c9~78@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~2099@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ b9~76@))) (Mul (Mul (Mul (Sub a9~74@ c9~78@) (Mul d9~80@ c9~78@)) (Sub c9~78@ c9~78@)) (Mul d9~80@ a9~74@)))) (and (=> (= tmp%18@ (Mul (Sub a9~74@ c9~78@) (Mul d9~80@ c9~78@))) (=> (= tmp%19@ (Sub c9~78@ c9~78@)) (=> (= tmp%20@ (Mul d9~80@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%9 (= temp_9_0~2034@ temp_9_1~2099@)))))) (=> (= temp_9_0~2034@ temp_9_1~2099@) (=> (= temp_10_0~2226@ (Add (Mul (Mul (Mul a10~82@ 39) (Mul c10~86@ c10~86@)) (Mul (Add b10~84@ d10~88@) (Mul d10~88@ b10~84@))) (Mul (Sub (Sub c10~86@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Add a10~82@ d10~88@))))) (=> (= temp_10_1~2303@ (Add (Mul (Mul (Mul (Mul a10~82@ 39) (Mul c10~86@ c10~86@)) (Add b10~84@ d10~88@)) (Mul d10~88@ b10~84@)) (Mul (Sub (Sub c10~86@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Add a10~82@ d10~88@))))) (and (=> (= tmp%21@ (Mul (Mul a10~82@ 39) (Mul c10~86@ c10~86@))) (=> (= tmp%22@ (Add b10~84@ d10~88@)) (=> (= tmp%23@ (Mul d10~88@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%10 (= temp_10_0~2226@ temp_10_1~2303@)))))) (=> (= temp_10_0~2226@ temp_10_1~2303@) (=> (= temp_11_0~2418@ (Mul (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ b11~92@)) (Mul (Mul c11~94@ d11~96@) c11~94@)) (Mul (Sub (Mul d11~96@ c11~94@) (Sub d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2479@ (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ b11~92@)) (Mul (Mul (Mul c11~94@ d11~96@) c11~94@) (Mul (Sub (Mul d11~96@ c11~94@) (Sub d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)))))) (=> (= tmp%24@ (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ b11~92@))) (=> (= tmp%25@ (Mul (Mul c11~94@ d11~96@) c11~94@)) (=> (= tmp%26@ (Mul (Sub (Mul d11~96@ c11~94@) (Sub d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%11 (= temp_11_0~2418@ temp_11_1~2479@))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
