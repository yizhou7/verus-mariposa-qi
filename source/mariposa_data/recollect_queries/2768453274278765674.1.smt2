...
(declare-const temp_2_0~735@ Int)
(declare-const temp_2_1~800@ Int)
(declare-const temp_3_0~913@ Int)
(declare-const temp_3_1~990@ Int)
(declare-const temp_4_0~1087@ Int)
(declare-const temp_4_1~1148@ Int)
...
(declare-const temp_7_0~1505@ Int)
...
(declare-const temp_9_1~1924@ Int)
(declare-const temp_10_0~2165@ Int)
(declare-const temp_10_1~2226@ Int)
(declare-const temp_11_0~2291@ Int)
(declare-const temp_11_1~2328@ Int)
(declare-const temp_12_0~2439@ Int)
(declare-const temp_12_1~2516@ Int)
(declare-const temp_13_0~2745@ Int)
(declare-const temp_13_1~2806@ Int)
(declare-const temp_14_0~2901@ Int)
(declare-const temp_14_1~2962@ Int)
(declare-const temp_15_0~3177@ Int)
(declare-const temp_15_1~3242@ Int)
(declare-const temp_16_0~3349@ Int)
(declare-const temp_16_1~3422@ Int)
(declare-const temp_17_0~3555@ Int)
(declare-const temp_17_1~3640@ Int)
(declare-const temp_18_0~3765@ Int)
(declare-const temp_18_1~3802@ Int)
(declare-const temp_19_0~3931@ Int)
(declare-const temp_19_1~4008@ Int)
(declare-const temp_20_0~4141@ Int)
(declare-const temp_20_1~4218@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~281@ (Mul (Add b0~4@ (Mul (Sub c0~6@ d0~8@) (Mul d0~8@ d0~8@))) (Mul b0~4@ (Mul (Mul b0~4@ c0~6@) (Sub b0~4@ b0~4@))))) (=> (= temp_0_1~322@ (Mul (Add b0~4@ (Mul (Mul d0~8@ d0~8@) (Sub c0~6@ d0~8@))) (Mul b0~4@ (Mul (Mul b0~4@ c0~6@) (Sub b0~4@ b0~4@))))) (and (=> (= tmp%1@ (Mul d0~8@ d0~8@)) (=> (= tmp%2@ (Sub c0~6@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~281@ temp_0_1~322@))))) (=> (= temp_0_0~281@ temp_0_1~322@) (=> (= temp_1_0~447@ (Mul (Sub (Mul (Sub 85 c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Add (Mul (Mul 29 c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~580@ (Add (Mul (Sub (Mul (Sub 85 c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Mul 29 c1~14@) (Mul c1~14@ d1~16@))) (Mul (Sub (Mul (Sub 85 c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@))))) (and (=> (= tmp%3@ (Sub (Mul (Sub 85 c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@)))) (=> (= tmp%4@ (Mul (Mul 29 c1~14@) (Mul c1~14@ d1~16@))) (=> (= tmp%5@ (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~580@)))))) (=> (= temp_1_0~447@ temp_1_1~580@) (=> (= temp_2_0~735@ (Add (Mul (Add (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@)) (Mul (Add a2~18@ b2~20@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul a2~18@ b2~20@) (Add b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~800@ (Add (Mul (Add (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@)) (Mul (Add a2~18@ b2~20@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul a2~18@ b2~20@) (Add b2~20@ c2~22@)) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@))))) (and (=> (= tmp%6@ (Mul b2~20@ b2~20@)) (=> (= tmp%7@ (Mul c2~22@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~735@ temp_2_1~800@))))) (=> (= temp_2_0~735@ temp_2_1~800@) (=> (= temp_3_0~913@ (Mul (Mul (Sub (Add a3~26@ b3~28@) (Mul 85 a3~26@)) (Mul (Add d3~32@ d3~32@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~990@ (Mul (Mul (Sub (Add a3~26@ b3~28@) (Mul 85 a3~26@)) (Mul (Mul c3~30@ c3~30@) (Add d3~32@ d3~32@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@))))) (and (=> (= tmp%8@ (Mul c3~30@ c3~30@)) (=> (= tmp%9@ (Add d3~32@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%3 (= temp_3_0~913@ temp_3_1~990@))))) (=> (= temp_3_0~913@ temp_3_1~990@) (=> (= temp_4_0~1087@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) b4~36@) (Mul (Sub d4~40@ d4~40@) (Sub c4~38@ c4~38@))) (Add (Mul (Mul a4~34@ b4~36@) (Sub c4~38@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Add d4~40@ a4~34@))))) (=> (= temp_4_1~1148@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) b4~36@) (Mul (Sub d4~40@ d4~40@) (Sub c4~38@ c4~38@))) (Add (Mul (Mul b4~36@ a4~34@) (Sub c4~38@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Add d4~40@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ b4~36@) (=> %%location_label%%4 (= temp_4_0~1087@ temp_4_1~1148@))) (=> (= temp_4_0~1087@ temp_4_1~1148@) (=> (= temp_5_0~1265@ (Sub (Sub (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@)) (Mul (Add 98 c5~46@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ 54))))) (=> (= temp_5_1~1354@ (Sub (Sub (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Add 98 c5~46@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ 54))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1265@ temp_5_1~1354@))) (=> (= temp_5_0~1265@ temp_5_1~1354@) (=> (= temp_6_0~1407@ (Mul (Mul d6~56@ c6~54@) (Mul (Mul (Mul c6~54@ c6~54@) c6~54@) c6~54@))) (=> (= temp_6_1~1432@ (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ (Mul (Mul c6~54@ c6~54@) c6~54@)))) (and (=> (= tmp%10@ (Mul (Mul c6~54@ c6~54@) c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~1407@ temp_6_1~1432@)))) (=> (= temp_6_0~1407@ temp_6_1~1432@) (=> (= temp_7_0~1505@ (Mul a7~58@ (Mul (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Add b7~60@ a7~58@))))) (=> (= temp_7_1~1542@ (Mul a7~58@ (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Add b7~60@ a7~58@))))) (and (=> (= tmp%11@ (Mul a7~58@ c7~62@)) (=> (= tmp%12@ (Mul c7~62@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%7 (= temp_7_0~1505@ temp_7_1~1542@))))) (=> (= temp_7_0~1505@ temp_7_1~1542@) (=> (= temp_8_0~1639@ (Mul (Mul (Mul (Sub b8~68@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Add c8~70@ d8~72@) a8~66@)) (Mul (Add (Mul a8~66@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Add d8~72@ a8~66@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1700@ (Mul (Mul (Sub b8~68@ c8~70@) (Mul (Mul a8~66@ b8~68@) (Mul (Add c8~70@ d8~72@) a8~66@))) (Mul (Add (Mul a8~66@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Add d8~72@ a8~66@) (Mul a8~66@ d8~72@))))) (and (=> (= tmp%13@ (Sub b8~68@ c8~70@)) (=> (= tmp%14@ (Mul a8~66@ b8~68@)) (=> (= tmp%15@ (Mul (Add c8~70@ d8~72@) a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%8 (= temp_8_0~1639@ temp_8_1~1700@)))))) (=> (= temp_8_0~1639@ temp_8_1~1700@) (=> (= temp_9_0~1835@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul 52 d9~80@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ b9~76@))) (Mul (Sub (Mul a9~74@ a9~74@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@ a9~74@) (Mul 20 a9~74@))))) (=> (= temp_9_1~1924@ (Mul (Mul (Mul (Mul 52 d9~80@) (Mul d9~80@ a9~74@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ b9~76@))) (Mul (Sub (Mul a9~74@ a9~74@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@ a9~74@) (Mul 20 a9~74@))))) (and (=> (= tmp%16@ (Mul 52 d9~80@)) (=> (= tmp%17@ (Mul d9~80@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> (= tmp%18@ (Mul (Mul 52 d9~80@) (Mul d9~80@ a9~74@))) (=> (= tmp%19@ (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ b9~76@))) (=> (= tmp%20@ (Mul (Sub (Mul a9~74@ a9~74@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@ a9~74@) (Mul 20 a9~74@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> (= tmp%21@ (Mul (Mul d9~80@ a9~74@) (Mul 52 d9~80@))) (=> (= tmp%22@ (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ b9~76@))) (=> (= tmp%23@ (Mul (Sub (Mul a9~74@ a9~74@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@ a9~74@) (Mul 20 a9~74@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%9 (= temp_9_0~1835@ temp_9_1~1924@))))))))))))) (=> (= temp_9_0~1835@ temp_9_1~1924@) (=> (= temp_10_0~2165@ (Mul (Mul (Mul a10~82@ (Add b10~84@ b10~84@)) (Mul (Sub b10~84@ b10~84@) (Mul a10~82@ c10~86@))) (Sub (Mul (Sub c10~86@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Add c10~86@ a10~82@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~2226@ (Mul (Mul (Mul a10~82@ (Add b10~84@ b10~84@)) (Mul (Sub b10~84@ b10~84@) (Mul a10~82@ c10~86@))) (Sub (Mul (Sub c10~86@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Add c10~86@ a10~82@) (Mul d10~88@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d10~88@ b10~84@) (=> %%location_label%%10 (= temp_10_0~2165@ temp_10_1~2226@))) (=> (= temp_10_0~2165@ temp_10_1~2226@) (=> (= temp_11_0~2291@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@)) (Mul (Mul a11~90@ a11~90@) (Sub b11~92@ b11~92@))) d11~96@)) (=> (= temp_11_1~2328@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@)) (Mul a11~90@ (Mul a11~90@ (Sub b11~92@ b11~92@)))) d11~96@)) (and (=> (= tmp%24@ (Sub b11~92@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a11~90@ a11~90@ tmp%24@) (=> %%location_label%%11 (= temp_11_0~2291@ temp_11_1~2328@)))) (=> (= temp_11_0~2291@ temp_11_1~2328@) (=> (= temp_12_0~2439@ (Mul (Mul (Add (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@)) (Sub (Mul 15 c12~102@) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul b12~100@ a12~98@) (Add b12~100@ b12~100@)) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ b12~100@))))) (=> (= temp_12_1~2516@ (Mul (Mul (Add (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@)) (Sub (Mul 15 c12~102@) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul b12~100@ a12~98@) (Add b12~100@ b12~100@)) (Mul (Mul a12~98@ b12~100@) (Mul b12~100@ a12~98@))))) (and (=> (= tmp%25@ (Mul a12~98@ b12~100@)) (=> (= tmp%26@ (Mul b12~100@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%25@ tmp%26@) (=> (= tmp%27@ (Mul (Add (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@)) (Sub (Mul 15 c12~102@) (Mul d12~104@ c12~102@)))) (=> (= tmp%28@ (Mul (Mul b12~100@ a12~98@) (Add b12~100@ b12~100@))) (=> (= tmp%29@ (Mul (Mul a12~98@ b12~100@) (Mul b12~100@ a12~98@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> (= tmp%30@ (Mul (Add (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@)) (Sub (Mul 15 c12~102@) (Mul d12~104@ c12~102@)))) (=> (= tmp%31@ (Mul (Mul b12~100@ a12~98@) (Add b12~100@ b12~100@))) (=> (= tmp%32@ (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%30@ tmp%31@ tmp%32@) (=> %%location_label%%12 (= temp_12_0~2439@ temp_12_1~2516@))))))))))))) (=> (= temp_12_0~2439@ temp_12_1~2516@) (=> (= temp_13_0~2745@ (Sub (Mul (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@)) (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ d13~112@))) (Mul (Mul b13~108@ (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ a13~106@) (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~2806@ (Sub (Mul (Mul (Mul (Mul a13~106@ a13~106@) b13~108@) c13~110@) (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ d13~112@))) (Mul (Mul b13~108@ (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ a13~106@) (Mul d13~112@ c13~110@))))) (and (=> (= tmp%33@ (Mul a13~106@ a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ b13~108@ c13~110@) (=> %%location_label%%13 (= temp_13_0~2745@ temp_13_1~2806@)))) (=> (= temp_13_0~2745@ temp_13_1~2806@) (=> (= temp_14_0~2901@ (Mul (Sub (Mul (Mul d14~120@ c14~118@) c14~118@) (Add (Mul c14~118@ c14~118@) (Add c14~118@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@)) (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2962@ (Mul (Sub (Mul (Mul d14~120@ c14~118@) c14~118@) (Add (Mul c14~118@ c14~118@) (Add c14~118@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@)) (Mul (Mul (Mul c14~118@ d14~120@) b14~116@) c14~118@)))) (and (=> (= tmp%34@ (Sub (Mul (Mul d14~120@ c14~118@) c14~118@) (Add (Mul c14~118@ c14~118@) (Add c14~118@ c14~118@)))) (=> (= tmp%35@ (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@))) (=> (= tmp%36@ (Mul (Mul (Mul c14~118@ d14~120@) b14~116@) c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ tmp%35@ tmp%36@) (=> (= tmp%37@ (Mul c14~118@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%37@ b14~116@ c14~118@) (=> (= tmp%38@ (Sub (Mul (Mul d14~120@ c14~118@) c14~118@) (Add (Mul c14~118@ c14~118@) (Add c14~118@ c14~118@)))) (=> (= tmp%39@ (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@))) (=> (= tmp%40@ (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ c14~118@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> %%location_label%%14 (= temp_14_0~2901@ temp_14_1~2962@)))))))))))) (=> (= temp_14_0~2901@ temp_14_1~2962@) (=> (= temp_15_0~3177@ (Sub (Mul (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Add a15~122@ c15~126@) (Mul b15~124@ a15~122@))) (Mul (Mul (Mul c15~126@ d15~128@) (Mul d15~128@ a15~122@)) (Sub (Mul a15~122@ c15~126@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~3242@ (Sub (Mul (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Add a15~122@ c15~126@) (Mul b15~124@ a15~122@))) (Mul (Mul (Mul (Mul c15~126@ d15~128@) d15~128@) a15~122@) (Sub (Mul a15~122@ c15~126@) (Mul c15~126@ c15~126@))))) (and (=> (= tmp%41@ (Mul c15~126@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ d15~128@ a15~122@) (=> %%location_label%%15 (= temp_15_0~3177@ temp_15_1~3242@)))) (=> (= temp_15_0~3177@ temp_15_1~3242@) (=> (= temp_16_0~3349@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ b16~132@)) (Sub (Mul 0 d16~136@) (Mul b16~132@ a16~130@))) (Mul (Mul (Mul c16~134@ a16~130@) (Add a16~130@ a16~130@)) (Mul c16~134@ (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~3422@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ b16~132@)) (Sub (Mul 0 d16~136@) (Mul b16~132@ a16~130@))) (Mul (Mul c16~134@ (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ a16~130@) (Add a16~130@ a16~130@))))) (and (=> (= tmp%42@ (Mul c16~134@ (Mul a16~130@ d16~136@))) (=> (= tmp%43@ (Mul (Mul c16~134@ a16~130@) (Add a16~130@ a16~130@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%42@ tmp%43@) (=> %%location_label%%16 (= temp_16_0~3349@ temp_16_1~3422@))))) (=> (= temp_16_0~3349@ temp_16_1~3422@) (=> (= temp_17_0~3555@ (Mul (Add (Mul (Mul 46 b17~140@) (Mul d17~144@ c17~142@)) (Mul b17~140@ (Add d17~144@ a17~138@))) (Mul (Mul (Sub d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul 67 a17~138@) (Mul b17~140@ d17~144@))))) (=> (= temp_17_1~3640@ (Mul (Mul (Mul (Sub d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul 67 a17~138@) (Mul b17~140@ d17~144@))) (Add (Mul (Mul 46 b17~140@) (Mul d17~144@ c17~142@)) (Mul b17~140@ (Add d17~144@ a17~138@))))) (and (=> (= tmp%44@ (Mul (Mul (Sub d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul 67 a17~138@) (Mul b17~140@ d17~144@)))) (=> (= tmp%45@ (Add (Mul (Mul 46 b17~140@) (Mul d17~144@ c17~142@)) (Mul b17~140@ (Add d17~144@ a17~138@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%44@ tmp%45@) (=> %%location_label%%17 (= temp_17_0~3555@ temp_17_1~3640@))))) (=> (= temp_17_0~3555@ temp_17_1~3640@) (=> (= temp_18_0~3765@ (Sub (Mul (Add (Add d18~152@ c18~150@) (Sub d18~152@ d18~152@)) (Sub (Mul b18~148@ b18~148@) (Mul c18~150@ b18~148@))) c18~150@)) (=> (= temp_18_1~3802@ (Sub (Mul (Sub (Mul b18~148@ b18~148@) (Mul c18~150@ b18~148@)) (Add (Add d18~152@ c18~150@) (Sub d18~152@ d18~152@))) c18~150@)) (and (=> (= tmp%46@ (Sub (Mul b18~148@ b18~148@) (Mul c18~150@ b18~148@))) (=> (= tmp%47@ (Add (Add d18~152@ c18~150@) (Sub d18~152@ d18~152@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%46@ tmp%47@) (=> %%location_label%%18 (= temp_18_0~3765@ temp_18_1~3802@))))) (=> (= temp_18_0~3765@ temp_18_1~3802@) (=> (= temp_19_0~3931@ (Mul (Mul (Add (Mul d19~160@ 48) (Add d19~160@ d19~160@)) (Sub (Mul b19~156@ c19~158@) (Sub b19~156@ d19~160@))) (Mul d19~160@ (Mul (Mul 50 c19~158@) (Add b19~156@ a19~154@))))) (=> (= temp_19_1~4008@ (Mul (Mul (Sub (Mul b19~156@ c19~158@) (Sub b19~156@ d19~160@)) (Add (Mul d19~160@ 48) (Add d19~160@ d19~160@))) (Mul d19~160@ (Mul (Mul 50 c19~158@) (Add b19~156@ a19~154@))))) (and (=> (= tmp%48@ (Sub (Mul b19~156@ c19~158@) (Sub b19~156@ d19~160@))) (=> (= tmp%49@ (Add (Mul d19~160@ 48) (Add d19~160@ d19~160@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%48@ tmp%49@) (=> %%location_label%%19 (= temp_19_0~3931@ temp_19_1~4008@))))) (=> (= temp_19_0~3931@ temp_19_1~4008@) (=> (= temp_20_0~4141@ (Mul (Mul (Mul (Mul c20~166@ d20~168@) (Mul b20~164@ d20~168@)) (Mul (Sub a20~162@ c20~166@) (Mul d20~168@ c20~166@))) (Sub (Mul (Mul b20~164@ c20~166@) (Mul b20~164@ c20~166@)) (Mul (Mul 22 a20~162@) (Mul b20~164@ b20~164@))))) (=> (= temp_20_1~4218@ (Mul (Mul (Mul (Mul c20~166@ d20~168@) (Mul b20~164@ d20~168@)) (Mul (Sub a20~162@ c20~166@) (Mul d20~168@ c20~166@))) (Sub (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ b20~164@)) (Mul (Mul 22 a20~162@) (Mul b20~164@ b20~164@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b20~164@ c20~166@) (=> %%location_label%%20 (= temp_20_0~4141@ temp_20_1~4218@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
