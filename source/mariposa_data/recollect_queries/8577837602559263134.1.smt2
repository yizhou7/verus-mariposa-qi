...
(declare-const temp_1_0~593@ Int)
(declare-const temp_1_1~666@ Int)
(declare-const temp_2_0~869@ Int)
(declare-const temp_2_1~906@ Int)
(declare-const temp_3_0~1005@ Int)
(declare-const temp_3_1~1070@ Int)
(declare-const temp_4_0~1219@ Int)
(declare-const temp_4_1~1280@ Int)
(declare-const temp_5_0~1501@ Int)
(declare-const temp_5_1~1606@ Int)
(declare-const temp_6_0~1737@ Int)
(declare-const temp_6_1~1814@ Int)
(declare-const temp_7_0~1923@ Int)
(declare-const temp_7_1~1992@ Int)
(declare-const temp_8_0~2225@ Int)
(declare-const temp_8_1~2302@ Int)
(declare-const temp_9_0~2382@ Int)
(declare-const temp_9_1~2447@ Int)
(declare-const temp_10_0~2600@ Int)
(declare-const temp_10_1~2665@ Int)
(declare-const temp_11_0~2754@ Int)
(declare-const temp_11_1~2807@ Int)
(declare-const temp_12_0~2918@ Int)
(declare-const temp_12_1~2995@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Add b0~4@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Add d0~8@ c0~6@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Add d0~8@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Add b0~4@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Add d0~8@ c0~6@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@)) (Mul c0~6@ (Mul c0~6@ (Add d0~8@ d0~8@)))))) (and (=> (= tmp%1@ (Add d0~8@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c0~6@ c0~6@ tmp%1@) (=> (= tmp%2@ (Mul (Mul (Mul c0~6@ b0~4@) (Add b0~4@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Add d0~8@ c0~6@)))) (=> (= tmp%3@ (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@))) (=> (= tmp%4@ (Mul c0~6@ (Mul c0~6@ (Add d0~8@ d0~8@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> (= tmp%5@ (Mul (Mul (Mul c0~6@ b0~4@) (Add b0~4@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Add d0~8@ c0~6@)))) (=> (= tmp%6@ (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@))) (=> (= tmp%7@ (Mul (Mul c0~6@ c0~6@) (Add d0~8@ d0~8@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))))))))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~593@ (Mul (Mul (Mul (Sub b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Add a1~10@ c1~14@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~666@ (Mul (Mul (Mul (Sub b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)) (Add (Mul a1~10@ (Mul c1~14@ b1~12@)) (Mul c1~14@ (Mul c1~14@ b1~12@)))))) (and (=> (= tmp%8@ (Mul (Mul (Sub b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@)))) (=> (= tmp%9@ (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@))) (=> (= tmp%10@ (Add (Mul a1~10@ (Mul c1~14@ b1~12@)) (Mul c1~14@ (Mul c1~14@ b1~12@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> (= tmp%11@ (Mul c1~14@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a1~10@ c1~14@ tmp%11@) (=> (= tmp%12@ (Mul (Mul (Sub b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@)))) (=> (= tmp%13@ (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@))) (=> (= tmp%14@ (Mul (Add a1~10@ c1~14@) (Mul c1~14@ b1~12@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%1 (= temp_1_0~593@ temp_1_1~666@)))))))))))) (=> (= temp_1_0~593@ temp_1_1~666@) (=> (= temp_2_0~869@ (Sub (Sub (Mul (Mul d2~24@ c2~22@) (Add c2~22@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ a2~18@))) a2~18@)) (=> (= temp_2_1~906@ (Sub (Sub (Mul d2~24@ (Mul c2~22@ (Add c2~22@ b2~20@))) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ a2~18@))) a2~18@)) (and (=> (= tmp%15@ (Add c2~22@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d2~24@ c2~22@ tmp%15@) (=> %%location_label%%2 (= temp_2_0~869@ temp_2_1~906@)))) (=> (= temp_2_0~869@ temp_2_1~906@) (=> (= temp_3_0~1005@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Add d3~32@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~1070@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Add d3~32@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ d3~32@) (=> (= tmp%16@ (Mul a3~26@ d3~32@)) (=> (= tmp%17@ (Mul a3~26@ d3~32@)) (=> (= tmp%18@ (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> (= tmp%19@ (Mul d3~32@ a3~26@)) (=> (= tmp%20@ (Mul a3~26@ d3~32@)) (=> (= tmp%21@ (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%3 (= temp_3_0~1005@ temp_3_1~1070@))))))))))) (=> (= temp_3_0~1005@ temp_3_1~1070@) (=> (= temp_4_0~1219@ (Mul (Mul (Add (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) d4~40@)))) (=> (= temp_4_1~1280@ (Mul (Mul (Add (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) d4~40@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ c4~38@) (=> (= tmp%22@ (Add (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@))) (=> (= tmp%23@ (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (=> (= tmp%24@ (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> (= tmp%25@ (Add (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@))) (=> (= tmp%26@ (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (=> (= tmp%27@ (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%4 (= temp_4_0~1219@ temp_4_1~1280@))))))))))) (=> (= temp_4_0~1219@ temp_4_1~1280@) (=> (= temp_5_0~1501@ (Mul (Mul (Mul (Mul c5~46@ 25) (Mul b5~44@ d5~48@)) (Add (Mul b5~44@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Add d5~48@ a5~42@) (Sub d5~48@ d5~48@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1606@ (Mul (Add (Mul (Mul (Mul c5~46@ 25) (Mul b5~44@ d5~48@)) (Mul b5~44@ c5~46@)) (Mul (Mul (Mul c5~46@ 25) (Mul b5~44@ d5~48@)) (Mul c5~46@ b5~44@))) (Mul (Mul (Add d5~48@ a5~42@) (Sub d5~48@ d5~48@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))))) (and (=> (= tmp%28@ (Mul (Mul c5~46@ 25) (Mul b5~44@ d5~48@))) (=> (= tmp%29@ (Mul b5~44@ c5~46@)) (=> (= tmp%30@ (Mul c5~46@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%5 (= temp_5_0~1501@ temp_5_1~1606@)))))) (=> (= temp_5_0~1501@ temp_5_1~1606@) (=> (= temp_6_0~1737@ (Mul (Mul (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul 59 b6~52@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1814@ (Mul (Mul (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul 59 b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))))) (and (=> (= tmp%31@ (Mul 59 b6~52@)) (=> (= tmp%32@ (Mul b6~52@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%31@ tmp%32@) (=> %%location_label%%6 (= temp_6_0~1737@ temp_6_1~1814@))))) (=> (= temp_6_0~1737@ temp_6_1~1814@) (=> (= temp_7_0~1923@ (Mul (Mul (Mul (Add d7~64@ d7~64@) (Mul b7~60@ 52)) (Mul (Mul a7~58@ a7~58@) b7~60@)) (Mul (Sub (Mul c7~62@ b7~60@) b7~60@) (Add (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1992@ (Mul (Mul (Mul (Mul b7~60@ 52) (Add d7~64@ d7~64@)) (Mul (Mul a7~58@ a7~58@) b7~60@)) (Mul (Sub (Mul c7~62@ b7~60@) b7~60@) (Add (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@))))) (and (=> (= tmp%33@ (Mul b7~60@ 52)) (=> (= tmp%34@ (Add d7~64@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%33@ tmp%34@) (=> (= tmp%35@ (Mul (Mul b7~60@ 52) (Add d7~64@ d7~64@))) (=> (= tmp%36@ (Mul (Mul a7~58@ a7~58@) b7~60@)) (=> (= tmp%37@ (Mul (Sub (Mul c7~62@ b7~60@) b7~60@) (Add (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ tmp%36@ tmp%37@) (=> (= tmp%38@ (Mul (Add d7~64@ d7~64@) (Mul b7~60@ 52))) (=> (= tmp%39@ (Mul (Mul a7~58@ a7~58@) b7~60@)) (=> (= tmp%40@ (Mul (Sub (Mul c7~62@ b7~60@) b7~60@) (Add (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> %%location_label%%7 (= temp_7_0~1923@ temp_7_1~1992@))))))))))))) (=> (= temp_7_0~1923@ temp_7_1~1992@) (=> (= temp_8_0~2225@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ c8~70@) (Sub c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ 22) (Mul c8~70@ c8~70@)) (Mul (Sub d8~72@ a8~66@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~2302@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ c8~70@) (Sub c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ 22) (Mul c8~70@ c8~70@)) (Mul (Sub d8~72@ a8~66@) (Mul a8~66@ a8~66@))))) (=> (= tmp%41@ (= temp_8_0~2225@ temp_8_1~2302@)) (and (=> %%location_label%%8 tmp%41@) (=> tmp%41@ (=> (= temp_9_0~2382@ (Mul (Mul (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~2447@ (Mul (Mul (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ a9~74@))) (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ a9~74@) (=> (= tmp%42@ (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@))) (=> (= tmp%43@ (Mul c9~78@ d9~80@)) (=> (= tmp%44@ (Mul d9~80@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%42@ tmp%43@ tmp%44@) (=> (= tmp%45@ (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@))) (=> (= tmp%46@ (Mul c9~78@ d9~80@)) (=> (= tmp%47@ (Mul a9~74@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%45@ tmp%46@ tmp%47@) (=> %%location_label%%9 (= temp_9_0~2382@ temp_9_1~2447@))))))))))) (=> (= temp_9_0~2382@ temp_9_1~2447@) (=> (= temp_10_0~2600@ (Mul (Mul (Add (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@)) (Mul (Mul d10~88@ c10~86@) (Sub a10~82@ d10~88@))) (Mul (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ a10~82@)) (Add (Mul b10~84@ c10~86@) (Mul b10~84@ c10~86@))))) (=> (= temp_10_1~2665@ (Mul (Mul (Add (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@)) (Mul (Mul d10~88@ c10~86@) (Sub a10~82@ d10~88@))) (Mul (Mul (Mul d10~88@ a10~82@) (Mul c10~86@ c10~86@)) (Add (Mul b10~84@ c10~86@) (Mul b10~84@ c10~86@))))) (and (=> (= tmp%48@ (Mul d10~88@ a10~82@)) (=> (= tmp%49@ (Mul c10~86@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%48@ tmp%49@) (=> %%location_label%%10 (= temp_10_0~2600@ temp_10_1~2665@))))) (=> (= temp_10_0~2600@ temp_10_1~2665@) (=> (= temp_11_0~2754@ (Sub (Mul (Mul (Mul b11~92@ a11~90@) (Mul c11~94@ d11~96@)) a11~90@) (Mul (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2807@ (Sub (Mul (Mul (Mul b11~92@ a11~90@) (Mul c11~94@ d11~96@)) a11~90@) (Mul (Mul (Mul (Mul b11~92@ b11~92@) a11~90@) c11~94@) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))))) (and (=> (= tmp%50@ (Mul b11~92@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%50@ a11~90@ c11~94@) (=> %%location_label%%11 (= temp_11_0~2754@ temp_11_1~2807@)))) (=> (= temp_11_0~2754@ temp_11_1~2807@) (=> (= temp_12_0~2918@ (Mul (Mul (Mul (Add d12~104@ b12~100@) (Mul a12~98@ c12~102@)) (Add (Sub d12~104@ c12~102@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul d12~104@ 69) (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2995@ (Mul (Mul (Mul (Add d12~104@ b12~100@) (Mul a12~98@ c12~102@)) (Add (Sub d12~104@ c12~102@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul d12~104@ 69) (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ d12~104@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a12~98@ d12~104@) (=> (= tmp%51@ (Mul (Mul (Add d12~104@ b12~100@) (Mul a12~98@ c12~102@)) (Add (Sub d12~104@ c12~102@) (Mul a12~98@ b12~100@)))) (=> (= tmp%52@ (Mul (Mul d12~104@ 69) (Mul d12~104@ b12~100@))) (=> (= tmp%53@ (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%51@ tmp%52@ tmp%53@) (=> (= tmp%54@ (Mul (Mul (Add d12~104@ b12~100@) (Mul a12~98@ c12~102@)) (Add (Sub d12~104@ c12~102@) (Mul a12~98@ b12~100@)))) (=> (= tmp%55@ (Mul (Mul d12~104@ 69) (Mul d12~104@ b12~100@))) (=> (= tmp%56@ (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ a12~98@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%54@ tmp%55@ tmp%56@) (=> %%location_label%%12 (= temp_12_0~2918@ temp_12_1~2995@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
