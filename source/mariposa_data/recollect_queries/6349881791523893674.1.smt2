...
(declare-const temp_1_0~437@ Int)
(declare-const temp_1_1~502@ Int)
...
(declare-const temp_4_1~1081@ Int)
(declare-const temp_5_0~1298@ Int)
(declare-const temp_5_1~1371@ Int)
(declare-const temp_6_0~1442@ Int)
(declare-const temp_6_1~1479@ Int)
(declare-const temp_7_0~1547@ Int)
(declare-const temp_7_1~1600@ Int)
(declare-const temp_8_0~1817@ Int)
(declare-const temp_8_1~1906@ Int)
...
(declare-const temp_11_1~2470@ Int)
(declare-const temp_12_0~2591@ Int)
(declare-const temp_12_1~2680@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul (Mul (Add d0~8@ b0~4@) b0~4@) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ a0~2@))) (Sub (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ b0~4@)) b0~4@))) (=> (= temp_0_1~338@ (Mul (Mul (Mul (Add d0~8@ b0~4@) b0~4@) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ a0~2@))) (Sub (Mul (Mul (Mul d0~8@ a0~2@) a0~2@) b0~4@) b0~4@))) (and (=> (= tmp%1@ (Mul d0~8@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ a0~2@ b0~4@) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~338@)))) (=> (= temp_0_0~289@ temp_0_1~338@) (=> (= temp_1_0~437@ (Mul (Mul b1~12@ (Mul (Mul c1~14@ a1~10@) (Mul 32 c1~14@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~502@ (Mul (Mul b1~12@ (Mul (Mul c1~14@ a1~10@) (Mul 32 c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@))))) (and (=> (= tmp%2@ (Mul d1~16@ a1~10@)) (=> (= tmp%3@ (Mul b1~12@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~437@ temp_1_1~502@))))) (=> (= temp_1_0~437@ temp_1_1~502@) (=> (= temp_2_0~603@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul (Sub d2~24@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ b2~20@))))) (=> (= temp_2_1~668@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul (Sub d2~24@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ b2~20@))))) (=> (= tmp%4@ (= temp_2_0~603@ temp_2_1~668@)) (and (=> %%location_label%%2 tmp%4@) (=> tmp%4@ (=> (= temp_3_0~748@ (Mul (Mul (Mul (Add d3~32@ c3~30@) (Mul c3~30@ b3~28@)) d3~32@) (Mul (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Sub a3~26@ 88))))) (=> (= temp_3_1~813@ (Mul (Mul (Mul (Add d3~32@ c3~30@) (Mul c3~30@ b3~28@)) d3~32@) (Mul (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ d3~32@)) (Mul c3~30@ (Mul c3~30@ (Sub a3~26@ 88)))))) (and (=> (= tmp%5@ (Sub a3~26@ 88)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c3~30@ c3~30@ tmp%5@) (=> (= tmp%6@ (Mul (Mul (Add d3~32@ c3~30@) (Mul c3~30@ b3~28@)) d3~32@)) (=> (= tmp%7@ (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ d3~32@))) (=> (= tmp%8@ (Mul c3~30@ (Mul c3~30@ (Sub a3~26@ 88)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> (= tmp%9@ (Mul (Mul (Add d3~32@ c3~30@) (Mul c3~30@ b3~28@)) d3~32@)) (=> (= tmp%10@ (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ d3~32@))) (=> (= tmp%11@ (Mul (Mul c3~30@ c3~30@) (Sub a3~26@ 88))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%3 (= temp_3_0~748@ temp_3_1~813@)))))))))))) (=> (= temp_3_0~748@ temp_3_1~813@) (=> (= temp_4_0~1020@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Sub d4~40@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@)) (Mul b4~36@ (Mul a4~34@ a4~34@))))) (=> (= temp_4_1~1081@ (Mul (Mul (Mul (Sub d4~40@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@)) (Mul b4~36@ (Mul a4~34@ a4~34@))))) (and (=> (= tmp%12@ (Sub d4~40@ c4~38@)) (=> (= tmp%13@ (Mul c4~38@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> (= tmp%14@ (Mul (Sub d4~40@ c4~38@) (Mul c4~38@ b4~36@))) (=> (= tmp%15@ (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@))) (=> (= tmp%16@ (Mul (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@)) (Mul b4~36@ (Mul a4~34@ a4~34@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> (= tmp%17@ (Mul (Mul c4~38@ b4~36@) (Sub d4~40@ c4~38@))) (=> (= tmp%18@ (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@))) (=> (= tmp%19@ (Mul (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@)) (Mul b4~36@ (Mul a4~34@ a4~34@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%4 (= temp_4_0~1020@ temp_4_1~1081@))))))))))))) (=> (= temp_4_0~1020@ temp_4_1~1081@) (=> (= temp_5_0~1298@ (Mul (Add (Mul (Mul d5~48@ d5~48@) (Sub c5~46@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1371@ (Mul (Add (Sub (Mul (Mul d5~48@ d5~48@) c5~46@) (Mul (Mul d5~48@ d5~48@) a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@))))) (and (=> (= tmp%20@ (Mul d5~48@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%20@ c5~46@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1298@ temp_5_1~1371@)))) (=> (= temp_5_0~1298@ temp_5_1~1371@) (=> (= temp_6_0~1442@ (Mul (Sub (Sub (Add a6~50@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Add a6~50@ b6~52@) (Mul a6~50@ a6~50@))) c6~54@)) (=> (= temp_6_1~1479@ (Mul (Sub (Sub (Add a6~50@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Add a6~50@ b6~52@) (Mul a6~50@ a6~50@))) c6~54@)) (=> (= tmp%21@ (= temp_6_0~1442@ temp_6_1~1479@)) (and (=> %%location_label%%6 tmp%21@) (=> tmp%21@ (=> (= temp_7_0~1547@ (Mul (Mul (Add (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@)) c7~62@) (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Mul (Add d7~64@ c7~62@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1600@ (Mul (Mul (Add (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@)) c7~62@) (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Mul (Add d7~64@ c7~62@) (Mul d7~64@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ c7~62@) (=> (= tmp%22@ (Mul (Add (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@)) c7~62@)) (=> (= tmp%23@ (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@))) (=> (= tmp%24@ (Mul (Add d7~64@ c7~62@) (Mul d7~64@ c7~62@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> (= tmp%25@ (Mul (Add (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@)) c7~62@)) (=> (= tmp%26@ (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@))) (=> (= tmp%27@ (Mul (Add d7~64@ c7~62@) (Mul c7~62@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%7 (= temp_7_0~1547@ temp_7_1~1600@))))))))))) (=> (= temp_7_0~1547@ temp_7_1~1600@) (=> (= temp_8_0~1817@ (Mul (Sub (Add (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Sub c8~70@ b8~68@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul 55 a8~66@) (Mul d8~72@ a8~66@)) (Sub (Add c8~70@ 9) (Mul a8~66@ b8~68@))))) (=> (= temp_8_1~1906@ (Mul (Mul (Mul (Mul 55 a8~66@) (Mul d8~72@ a8~66@)) (Sub (Add c8~70@ 9) (Mul a8~66@ b8~68@))) (Sub (Add (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Sub c8~70@ b8~68@) (Mul a8~66@ d8~72@))))) (and (=> (= tmp%28@ (Mul (Mul (Mul 55 a8~66@) (Mul d8~72@ a8~66@)) (Sub (Add c8~70@ 9) (Mul a8~66@ b8~68@)))) (=> (= tmp%29@ (Sub (Add (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Sub c8~70@ b8~68@) (Mul a8~66@ d8~72@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%28@ tmp%29@) (=> %%location_label%%8 (= temp_8_0~1817@ temp_8_1~1906@))))) (=> (= temp_8_0~1817@ temp_8_1~1906@) (=> (= temp_9_0~2063@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Add a9~74@ b9~76@) (Mul d9~80@ a9~74@))) (Mul (Mul (Sub c9~78@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Sub c9~78@ a9~74@))))) (=> (= temp_9_1~2128@ (Mul (Mul (Mul b9~76@ a9~74@) (Mul (Mul d9~80@ b9~76@) (Mul (Add a9~74@ b9~76@) (Mul d9~80@ a9~74@)))) (Mul (Mul (Sub c9~78@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Sub c9~78@ a9~74@))))) (and (=> (= tmp%30@ (Mul b9~76@ a9~74@)) (=> (= tmp%31@ (Mul d9~80@ b9~76@)) (=> (= tmp%32@ (Mul (Add a9~74@ b9~76@) (Mul d9~80@ a9~74@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%30@ tmp%31@ tmp%32@) (=> %%location_label%%9 (= temp_9_0~2063@ temp_9_1~2128@)))))) (=> (= temp_9_0~2063@ temp_9_1~2128@) (=> (= temp_10_0~2239@ (Mul (Mul c10~86@ (Mul (Mul c10~86@ b10~84@) (Mul 15 c10~86@))) (Mul (Sub c10~86@ (Add b10~84@ a10~82@)) (Add (Mul d10~88@ a10~82@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~2300@ (Mul (Mul c10~86@ (Mul (Mul c10~86@ b10~84@) (Mul 15 c10~86@))) (Mul (Add (Mul d10~88@ a10~82@) (Mul c10~86@ b10~84@)) (Sub c10~86@ (Add b10~84@ a10~82@))))) (and (=> (= tmp%33@ (Add (Mul d10~88@ a10~82@) (Mul c10~86@ b10~84@))) (=> (= tmp%34@ (Sub c10~86@ (Add b10~84@ a10~82@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%33@ tmp%34@) (=> %%location_label%%10 (= temp_10_0~2239@ temp_10_1~2300@))))) (=> (= temp_10_0~2239@ temp_10_1~2300@) (=> (= temp_11_0~2409@ (Mul (Sub (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ a11~90@))) (Mul (Mul c11~94@ (Mul d11~96@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Sub a11~90@ b11~92@))))) (=> (= temp_11_1~2470@ (Mul (Sub (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ a11~90@))) (Mul (Mul (Mul d11~96@ c11~94@) c11~94@) (Mul (Mul d11~96@ a11~90@) (Sub a11~90@ b11~92@))))) (and (=> (= tmp%35@ (Mul d11~96@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%35@ c11~94@) (=> %%location_label%%11 (= temp_11_0~2409@ temp_11_1~2470@)))) (=> (= temp_11_0~2409@ temp_11_1~2470@) (=> (= temp_12_0~2591@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ 95))) (Add (Mul (Add c12~102@ d12~104@) (Mul b12~100@ c12~102@)) (Add (Mul a12~98@ a12~98@) (Mul c12~102@ 35))))) (=> (= temp_12_1~2680@ (Mul (Mul (Mul (Mul (Mul c12~102@ d12~104@) c12~102@) c12~102@) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ 95))) (Add (Mul (Add c12~102@ d12~104@) (Mul b12~100@ c12~102@)) (Add (Mul a12~98@ a12~98@) (Mul c12~102@ 35))))) (=> (= tmp%36@ (Mul (Mul (Mul c12~102@ d12~104@) c12~102@) c12~102@)) (=> (= tmp%37@ (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ 95))) (=> (= tmp%38@ (Add (Mul (Add c12~102@ d12~104@) (Mul b12~100@ c12~102@)) (Add (Mul a12~98@ a12~98@) (Mul c12~102@ 35)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ tmp%37@ tmp%38@) (=> (= tmp%39@ (Mul c12~102@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%39@ c12~102@ c12~102@) (=> (= tmp%40@ (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@))) (=> (= tmp%41@ (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ 95))) (=> (= tmp%42@ (Add (Mul (Add c12~102@ d12~104@) (Mul b12~100@ c12~102@)) (Add (Mul a12~98@ a12~98@) (Mul c12~102@ 35)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ tmp%41@ tmp%42@) (=> %%location_label%%12 (= temp_12_0~2591@ temp_12_1~2680@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
