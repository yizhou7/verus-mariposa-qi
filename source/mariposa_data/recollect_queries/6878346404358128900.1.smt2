...
(declare-const temp_5_0~1291@ Int)
(declare-const temp_5_1~1348@ Int)
(declare-const temp_6_0~1475@ Int)
(declare-const temp_6_1~1576@ Int)
(declare-const temp_7_0~1723@ Int)
(declare-const temp_7_1~1796@ Int)
...
(declare-const temp_11_0~2435@ Int)
(declare-const temp_11_1~2508@ Int)
(declare-const temp_12_0~2591@ Int)
(declare-const temp_12_1~2640@ Int)
(declare-const temp_13_0~2789@ Int)
(declare-const temp_13_1~2850@ Int)
(declare-const temp_14_0~3059@ Int)
(declare-const temp_14_1~3132@ Int)
(declare-const temp_15_0~3215@ Int)
(declare-const temp_15_1~3264@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Sub (Add (Add (Mul b0~4@ c0~6@) (Mul c0~6@ d0~8@)) a0~2@) (Add (Mul (Sub d0~8@ b0~4@) (Mul b0~4@ b0~4@)) (Sub (Mul d0~8@ c0~6@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~342@ (Sub (Add (Add (Mul b0~4@ c0~6@) (Mul c0~6@ d0~8@)) a0~2@) (Add (Mul (Sub d0~8@ b0~4@) (Mul b0~4@ b0~4@)) (Mul (Sub d0~8@ b0~4@) c0~6@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d0~8@ b0~4@ c0~6@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~342@))) (=> (= temp_0_0~293@ temp_0_1~342@) (=> (= temp_1_0~433@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Add a1~10@ c1~14@) (Mul a1~10@ c1~14@))) (Mul (Add a1~10@ (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Add d1~16@ b1~12@))))) (=> (= temp_1_1~494@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Add a1~10@ c1~14@) (Mul a1~10@ c1~14@))) (Mul (Add a1~10@ (Mul c1~14@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Add d1~16@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ d1~16@) (=> %%location_label%%1 (= temp_1_0~433@ temp_1_1~494@))) (=> (= temp_1_0~433@ temp_1_1~494@) (=> (= temp_2_0~607@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@))) (Add (Mul (Mul c2~22@ b2~20@) (Mul 76 a2~18@)) (Mul (Add 94 a2~18@) a2~18@)))) (=> (= temp_2_1~724@ (Add (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul c2~22@ b2~20@) (Mul 76 a2~18@))) (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Add 94 a2~18@) a2~18@)))) (and (=> (= tmp%1@ (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@)))) (=> (= tmp%2@ (Mul (Mul c2~22@ b2~20@) (Mul 76 a2~18@))) (=> (= tmp%3@ (Mul (Add 94 a2~18@) a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~607@ temp_2_1~724@)))))) (=> (= temp_2_0~607@ temp_2_1~724@) (=> (= temp_3_0~875@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ a3~26@))) (Mul (Add (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@)) (Sub (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@))))) (=> (= temp_3_1~936@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ a3~26@))) (Mul (Mul d3~32@ (Add c3~30@ d3~32@)) (Sub (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d3~32@ c3~30@ d3~32@) (=> %%location_label%%3 (= temp_3_0~875@ temp_3_1~936@))) (=> (= temp_3_0~875@ temp_3_1~936@) (=> (= temp_4_0~1031@ (Mul (Mul (Mul (Add a4~34@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Add (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~1096@ (Mul (Mul (Mul (Mul (Add a4~34@ a4~34@) c4~38@) d4~40@) (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Add (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@))))) (and (=> (= tmp%4@ (Mul (Mul (Add a4~34@ a4~34@) c4~38@) d4~40@)) (=> (= tmp%5@ (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ a4~34@))) (=> (= tmp%6@ (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Add (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> (= tmp%7@ (Add a4~34@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ c4~38@ d4~40@) (=> (= tmp%8@ (Mul (Add a4~34@ a4~34@) (Mul c4~38@ d4~40@))) (=> (= tmp%9@ (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ a4~34@))) (=> (= tmp%10@ (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Add (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%4 (= temp_4_0~1031@ temp_4_1~1096@)))))))))))) (=> (= temp_4_0~1031@ temp_4_1~1096@) (=> (= temp_5_0~1291@ (Mul (Mul a5~42@ (Mul (Mul c5~46@ c5~46@) (Sub a5~42@ d5~48@))) (Sub (Mul (Mul c5~46@ a5~42@) b5~44@) c5~46@))) (=> (= temp_5_1~1348@ (Sub (Mul (Mul a5~42@ (Mul (Mul c5~46@ c5~46@) (Sub a5~42@ d5~48@))) (Mul (Mul c5~46@ a5~42@) b5~44@)) (Mul (Mul a5~42@ (Mul (Mul c5~46@ c5~46@) (Sub a5~42@ d5~48@))) c5~46@))) (and (=> (= tmp%11@ (Mul a5~42@ (Mul (Mul c5~46@ c5~46@) (Sub a5~42@ d5~48@)))) (=> (= tmp%12@ (Mul (Mul c5~46@ a5~42@) b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ tmp%12@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1291@ temp_5_1~1348@))))) (=> (= temp_5_0~1291@ temp_5_1~1348@) (=> (= temp_6_0~1475@ (Mul (Add (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ 3)) (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Sub b6~52@ d6~56@) a6~50@) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1576@ (Add (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ 3)) (Mul (Mul (Sub b6~52@ d6~56@) a6~50@) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@)))) (Mul (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Mul (Sub b6~52@ d6~56@) a6~50@) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@)))))) (and (=> (= tmp%13@ (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ 3))) (=> (= tmp%14@ (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ a6~50@))) (=> (= tmp%15@ (Mul (Mul (Sub b6~52@ d6~56@) a6~50@) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%6 (= temp_6_0~1475@ temp_6_1~1576@)))))) (=> (= temp_6_0~1475@ temp_6_1~1576@) (=> (= temp_7_0~1723@ (Add (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Sub d7~64@ b7~60@))) (Mul (Add (Mul a7~58@ c7~62@) (Sub b7~60@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1796@ (Add (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Sub (Mul (Mul d7~64@ b7~60@) d7~64@) (Mul (Mul d7~64@ b7~60@) b7~60@))) (Mul (Add (Mul a7~58@ c7~62@) (Sub b7~60@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ a7~58@))))) (and (=> (= tmp%16@ (Mul d7~64@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%16@ d7~64@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1723@ temp_7_1~1796@)))) (=> (= temp_7_0~1723@ temp_7_1~1796@) (=> (= temp_8_0~1891@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ b8~68@)) (Mul c8~70@ (Mul c8~70@ a8~66@))) (Mul (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1952@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ b8~68@)) (Mul c8~70@ (Mul c8~70@ a8~66@))))) (and (=> (= tmp%17@ (Mul (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)))) (=> (= tmp%18@ (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ b8~68@)) (Mul c8~70@ (Mul c8~70@ a8~66@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%8 (= temp_8_0~1891@ temp_8_1~1952@))))) (=> (= temp_8_0~1891@ temp_8_1~1952@) (=> (= temp_9_0~2097@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ c9~78@)) (Mul (Sub c9~78@ a9~74@) (Sub b9~76@ a9~74@))) (Add (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ b9~76@)) (Sub (Mul a9~74@ b9~76@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~2162@ (Mul (Mul (Mul a9~74@ b9~76@) (Mul (Mul c9~78@ c9~78@) (Mul (Sub c9~78@ a9~74@) (Sub b9~76@ a9~74@)))) (Add (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ b9~76@)) (Sub (Mul a9~74@ b9~76@) (Mul b9~76@ c9~78@))))) (and (=> (= tmp%19@ (Mul a9~74@ b9~76@)) (=> (= tmp%20@ (Mul c9~78@ c9~78@)) (=> (= tmp%21@ (Mul (Sub c9~78@ a9~74@) (Sub b9~76@ a9~74@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%9 (= temp_9_0~2097@ temp_9_1~2162@)))))) (=> (= temp_9_0~2097@ temp_9_1~2162@) (=> (= temp_10_0~2277@ (Mul (Mul (Add (Mul b10~84@ c10~86@) (Add d10~88@ b10~84@)) (Mul (Mul d10~88@ a10~82@) (Mul a10~82@ a10~82@))) (Add (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ b10~84@)) (Sub (Mul d10~88@ a10~82@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~2342@ (Mul (Mul (Add (Mul b10~84@ c10~86@) (Add d10~88@ b10~84@)) (Mul (Mul d10~88@ a10~82@) (Mul a10~82@ a10~82@))) (Add (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ b10~84@)) (Sub (Mul a10~82@ d10~88@) (Mul c10~86@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d10~88@ a10~82@) (=> %%location_label%%10 (= temp_10_0~2277@ temp_10_1~2342@))) (=> (= temp_10_0~2277@ temp_10_1~2342@) (=> (= temp_11_0~2435@ (Mul (Add (Mul (Sub b11~92@ d11~96@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Add c11~94@ c11~94@) (Sub b11~92@ a11~90@))))) (=> (= temp_11_1~2508@ (Mul (Add (Sub (Mul b11~92@ (Mul c11~94@ d11~96@)) (Mul d11~96@ (Mul c11~94@ d11~96@))) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Add c11~94@ c11~94@) (Sub b11~92@ a11~90@))))) (and (=> (= tmp%22@ (Mul c11~94@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b11~92@ d11~96@ tmp%22@) (=> %%location_label%%11 (= temp_11_0~2435@ temp_11_1~2508@)))) (=> (= temp_11_0~2435@ temp_11_1~2508@) (=> (= temp_12_0~2591@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@)) (Mul (Add d12~104@ d12~104@) (Mul a12~98@ c12~102@))) (Mul a12~98@ (Add d12~104@ (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2640@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@)) (Mul (Add d12~104@ d12~104@) (Mul c12~102@ a12~98@))) (Mul a12~98@ (Add d12~104@ (Mul a12~98@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c12~102@ a12~98@) (=> (= tmp%23@ (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@))) (=> (= tmp%24@ (Add d12~104@ d12~104@)) (=> (= tmp%25@ (Mul c12~102@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> (= tmp%26@ (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@))) (=> (= tmp%27@ (Add d12~104@ d12~104@)) (=> (= tmp%28@ (Mul a12~98@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> %%location_label%%12 (= temp_12_0~2591@ temp_12_1~2640@))))))))))) (=> (= temp_12_0~2591@ temp_12_1~2640@) (=> (= temp_13_0~2789@ (Mul (Mul (Mul b13~108@ (Mul d13~112@ c13~110@)) (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@))) (Mul (Add (Mul c13~110@ d13~112@) (Mul d13~112@ d13~112@)) (Mul (Add a13~106@ b13~108@) (Mul a13~106@ c13~110@))))) (=> (= temp_13_1~2850@ (Mul (Mul (Mul b13~108@ (Mul d13~112@ c13~110@)) (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@))) (Mul (Add (Mul c13~110@ d13~112@) (Mul d13~112@ d13~112@)) (Mul (Add a13~106@ b13~108@) (Mul c13~110@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c13~110@ a13~106@) (=> (= tmp%29@ (Mul (Mul b13~108@ (Mul d13~112@ c13~110@)) (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@)))) (=> (= tmp%30@ (Add (Mul c13~110@ d13~112@) (Mul d13~112@ d13~112@))) (=> (= tmp%31@ (Mul (Add a13~106@ b13~108@) (Mul c13~110@ a13~106@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> (= tmp%32@ (Mul (Mul b13~108@ (Mul d13~112@ c13~110@)) (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@)))) (=> (= tmp%33@ (Add (Mul c13~110@ d13~112@) (Mul d13~112@ d13~112@))) (=> (= tmp%34@ (Mul (Add a13~106@ b13~108@) (Mul a13~106@ c13~110@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%13 (= temp_13_0~2789@ temp_13_1~2850@))))))))))) (=> (= temp_13_0~2789@ temp_13_1~2850@) (=> (= temp_14_0~3059@ (Mul (Sub (Sub (Sub d14~120@ c14~118@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@))) (Mul (Mul (Mul c14~118@ b14~116@) (Sub c14~118@ b14~116@)) (Mul (Add d14~120@ a14~114@) (Sub a14~114@ b14~116@))))) (=> (= temp_14_1~3132@ (Mul (Sub (Sub (Sub d14~120@ c14~118@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@))) (Mul (Sub (Mul (Mul c14~118@ b14~116@) c14~118@) (Mul (Mul c14~118@ b14~116@) b14~116@)) (Mul (Add d14~120@ a14~114@) (Sub a14~114@ b14~116@))))) (and (=> (= tmp%35@ (Mul c14~118@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%35@ c14~118@ b14~116@) (=> %%location_label%%14 (= temp_14_0~3059@ temp_14_1~3132@)))) (=> (= temp_14_0~3059@ temp_14_1~3132@) (=> (= temp_15_0~3215@ (Sub d15~128@ (Add (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul 53 a15~122@))))) (=> (= temp_15_1~3264@ (Sub d15~128@ (Add (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul a15~122@ 53))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a15~122@ 53) (=> %%location_label%%15 (= temp_15_0~3215@ temp_15_1~3264@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
