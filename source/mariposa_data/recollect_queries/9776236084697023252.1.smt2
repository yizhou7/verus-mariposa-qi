...
(declare-const temp_3_1~1058@ Int)
(declare-const temp_4_0~1177@ Int)
(declare-const temp_4_1~1242@ Int)
(declare-const temp_5_0~1322@ Int)
(declare-const temp_5_1~1387@ Int)
(declare-const temp_6_0~1480@ Int)
(declare-const temp_6_1~1545@ Int)
(declare-const temp_7_0~1642@ Int)
(declare-const temp_7_1~1703@ Int)
(declare-const temp_8_0~1840@ Int)
(declare-const temp_8_1~1897@ Int)
(declare-const temp_9_0~2076@ Int)
(declare-const temp_9_1~2121@ Int)
(declare-const temp_10_0~2220@ Int)
(declare-const temp_10_1~2285@ Int)
(declare-const temp_11_0~2482@ Int)
(declare-const temp_11_1~2543@ Int)
(declare-const temp_12_0~2640@ Int)
(declare-const temp_12_1~2701@ Int)
(declare-const temp_13_0~2902@ Int)
(declare-const temp_13_1~2959@ Int)
(declare-const temp_14_0~3040@ Int)
(declare-const temp_14_1~3093@ Int)
(declare-const temp_15_0~3266@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Add b0~4@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Add d0~8@ c0~6@) (Mul 24 d0~8@))) (Mul (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Add b0~4@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Add d0~8@ c0~6@) (Mul 24 d0~8@))) (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ d0~8@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~487@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Add d1~16@ c1~14@)) (Mul (Add d1~16@ c1~14@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul c1~14@ a1~10@) (Sub d1~16@ b1~12@)) (Sub (Mul d1~16@ a1~10@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~560@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Add d1~16@ c1~14@)) (Add (Mul d1~16@ (Mul b1~12@ d1~16@)) (Mul c1~14@ (Mul b1~12@ d1~16@)))) (Mul (Mul (Mul c1~14@ a1~10@) (Sub d1~16@ b1~12@)) (Sub (Mul d1~16@ a1~10@) (Mul d1~16@ a1~10@))))) (and (=> (= tmp%1@ (Mul b1~12@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d1~16@ c1~14@ tmp%1@) (=> %%location_label%%1 (= temp_1_0~487@ temp_1_1~560@)))) (=> (= temp_1_0~487@ temp_1_1~560@) (=> (= temp_2_0~667@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ c2~22@)) (Mul d2~24@ (Mul b2~20@ d2~24@))) (Mul (Add (Mul b2~20@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ 28) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~740@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ c2~22@)) (Mul d2~24@ (Mul b2~20@ d2~24@))) (Mul (Add (Mul b2~20@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ 28))))) (and (=> (= tmp%2@ (Mul c2~22@ b2~20@)) (=> (= tmp%3@ (Mul a2~18@ 28)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> (= tmp%4@ (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ c2~22@)) (Mul d2~24@ (Mul b2~20@ d2~24@)))) (=> (= tmp%5@ (Add (Mul b2~20@ a2~18@) (Mul b2~20@ b2~20@))) (=> (= tmp%6@ (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ 28))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> (= tmp%7@ (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ c2~22@)) (Mul d2~24@ (Mul b2~20@ d2~24@)))) (=> (= tmp%8@ (Add (Mul b2~20@ a2~18@) (Mul b2~20@ b2~20@))) (=> (= tmp%9@ (Mul (Mul a2~18@ 28) (Mul c2~22@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%2 (= temp_2_0~667@ temp_2_1~740@))))))))))))) (=> (= temp_2_0~667@ temp_2_1~740@) (=> (= temp_3_0~981@ (Sub (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@)) (Add (Mul b3~28@ b3~28@) (Mul d3~32@ 42))) (Add (Mul (Mul b3~28@ c3~30@) (Sub a3~26@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Add c3~30@ c3~30@))))) (=> (= temp_3_1~1058@ (Sub (Mul (Mul a3~26@ c3~30@) (Mul (Mul b3~28@ a3~26@) (Add (Mul b3~28@ b3~28@) (Mul d3~32@ 42)))) (Add (Mul (Mul b3~28@ c3~30@) (Sub a3~26@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Add c3~30@ c3~30@))))) (and (=> (= tmp%10@ (Mul a3~26@ c3~30@)) (=> (= tmp%11@ (Mul b3~28@ a3~26@)) (=> (= tmp%12@ (Add (Mul b3~28@ b3~28@) (Mul d3~32@ 42))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%3 (= temp_3_0~981@ temp_3_1~1058@)))))) (=> (= temp_3_0~981@ temp_3_1~1058@) (=> (= temp_4_0~1177@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Add b4~36@ 81)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ d4~40@))) (Sub d4~40@ (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~1242@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Add b4~36@ 81)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ d4~40@))) (Sub d4~40@ (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@))))) (=> (= tmp%13@ (= temp_4_0~1177@ temp_4_1~1242@)) (and (=> %%location_label%%4 tmp%13@) (=> tmp%13@ (=> (= temp_5_0~1322@ (Sub (Mul (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ b5~44@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ c5~46@)) (Mul (Add d5~48@ c5~46@) (Mul b5~44@ c5~46@))))) (=> (= temp_5_1~1387@ (Sub (Mul (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ b5~44@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Add d5~48@ c5~46@) (Mul b5~44@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1322@ temp_5_1~1387@))) (=> (= temp_5_0~1322@ temp_5_1~1387@) (=> (= temp_6_0~1480@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@))))) (=> (= temp_6_1~1545@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@))))) (and (=> (= tmp%14@ (Mul a6~50@ d6~56@)) (=> (= tmp%15@ (Mul a6~50@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%6 (= temp_6_0~1480@ temp_6_1~1545@))))) (=> (= temp_6_0~1480@ temp_6_1~1545@) (=> (= temp_7_0~1642@ (Mul (Mul (Mul (Add a7~58@ c7~62@) (Mul a7~58@ b7~60@)) (Add (Mul d7~64@ c7~62@) (Mul a7~58@ d7~64@))) (Add (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)) (Mul c7~62@ (Mul b7~60@ d7~64@))))) (=> (= temp_7_1~1703@ (Mul (Add (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)) (Mul c7~62@ (Mul b7~60@ d7~64@))) (Mul (Mul (Add a7~58@ c7~62@) (Mul a7~58@ b7~60@)) (Add (Mul d7~64@ c7~62@) (Mul a7~58@ d7~64@))))) (and (=> (= tmp%16@ (Add (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)) (Mul c7~62@ (Mul b7~60@ d7~64@)))) (=> (= tmp%17@ (Mul (Mul (Add a7~58@ c7~62@) (Mul a7~58@ b7~60@)) (Add (Mul d7~64@ c7~62@) (Mul a7~58@ d7~64@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%7 (= temp_7_0~1642@ temp_7_1~1703@))))) (=> (= temp_7_0~1642@ temp_7_1~1703@) (=> (= temp_8_0~1840@ (Mul (Mul (Mul (Sub a8~66@ a8~66@) (Mul c8~70@ d8~72@)) (Mul (Mul c8~70@ a8~66@) d8~72@)) (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@)) (Mul a8~66@ (Mul d8~72@ d8~72@))))) (=> (= temp_8_1~1897@ (Mul (Mul (Mul (Mul (Sub a8~66@ a8~66@) c8~70@) d8~72@) (Mul (Mul c8~70@ a8~66@) d8~72@)) (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@)) (Mul a8~66@ (Mul d8~72@ d8~72@))))) (and (=> (= tmp%18@ (Mul (Mul (Sub a8~66@ a8~66@) c8~70@) d8~72@)) (=> (= tmp%19@ (Mul (Mul c8~70@ a8~66@) d8~72@)) (=> (= tmp%20@ (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@)) (Mul a8~66@ (Mul d8~72@ d8~72@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> (= tmp%21@ (Sub a8~66@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ c8~70@ d8~72@) (=> (= tmp%22@ (Mul (Sub a8~66@ a8~66@) (Mul c8~70@ d8~72@))) (=> (= tmp%23@ (Mul (Mul c8~70@ a8~66@) d8~72@)) (=> (= tmp%24@ (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@)) (Mul a8~66@ (Mul d8~72@ d8~72@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%8 (= temp_8_0~1840@ temp_8_1~1897@)))))))))))) (=> (= temp_8_0~1840@ temp_8_1~1897@) (=> (= temp_9_0~2076@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Sub c9~78@ c9~78@)) (Mul (Sub d9~80@ b9~76@) (Mul b9~76@ b9~76@))) c9~78@)) (=> (= temp_9_1~2121@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Sub c9~78@ c9~78@)) (Sub (Mul d9~80@ (Mul b9~76@ b9~76@)) (Mul b9~76@ (Mul b9~76@ b9~76@)))) c9~78@)) (and (=> (= tmp%25@ (Mul b9~76@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d9~80@ b9~76@ tmp%25@) (=> %%location_label%%9 (= temp_9_0~2076@ temp_9_1~2121@)))) (=> (= temp_9_0~2076@ temp_9_1~2121@) (=> (= temp_10_0~2220@ (Mul (Mul (Sub (Mul d10~88@ d10~88@) (Add b10~84@ b10~84@)) (Mul (Mul 96 b10~84@) (Mul d10~88@ b10~84@))) (Mul d10~88@ (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~2285@ (Mul (Mul (Sub (Mul d10~88@ d10~88@) (Add b10~84@ b10~84@)) (Mul (Mul 96 b10~84@) (Mul d10~88@ b10~84@))) (Mul d10~88@ (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a10~82@ c10~86@) (=> (= tmp%26@ (Mul (Sub (Mul d10~88@ d10~88@) (Add b10~84@ b10~84@)) (Mul (Mul 96 b10~84@) (Mul d10~88@ b10~84@)))) (=> (= tmp%27@ (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ b10~84@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ d10~88@ tmp%27@) (=> (= tmp%28@ (Mul (Sub (Mul d10~88@ d10~88@) (Add b10~84@ b10~84@)) (Mul (Mul 96 b10~84@) (Mul d10~88@ b10~84@)))) (=> (= tmp%29@ (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ b10~84@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ d10~88@ tmp%29@) (=> %%location_label%%10 (= temp_10_0~2220@ temp_10_1~2285@))))))))) (=> (= temp_10_0~2220@ temp_10_1~2285@) (=> (= temp_11_0~2482@ (Sub (Mul (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Sub a11~90@ b11~92@))) (Add (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (Mul c11~94@ a11~90@) c11~94@)))) (=> (= temp_11_1~2543@ (Sub (Mul (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@)) (Mul (Sub a11~90@ b11~92@) (Mul b11~92@ d11~96@))) (Add (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (Mul c11~94@ a11~90@) c11~94@)))) (and (=> (= tmp%30@ (Sub a11~90@ b11~92@)) (=> (= tmp%31@ (Mul b11~92@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%30@ tmp%31@) (=> %%location_label%%11 (= temp_11_0~2482@ temp_11_1~2543@))))) (=> (= temp_11_0~2482@ temp_11_1~2543@) (=> (= temp_12_0~2640@ (Mul (Mul (Sub (Mul d12~104@ c12~102@) (Add d12~104@ a12~98@)) (Mul b12~100@ (Add b12~100@ a12~98@))) (Mul (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ b12~100@)) (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@))))) (=> (= temp_12_1~2701@ (Mul (Mul (Sub (Mul c12~102@ d12~104@) (Add d12~104@ a12~98@)) (Mul b12~100@ (Add b12~100@ a12~98@))) (Mul (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ b12~100@)) (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c12~102@ d12~104@) (=> (= tmp%32@ (Sub (Mul c12~102@ d12~104@) (Add d12~104@ a12~98@))) (=> (= tmp%33@ (Mul b12~100@ (Add b12~100@ a12~98@))) (=> (= tmp%34@ (Mul (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ b12~100@)) (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> (= tmp%35@ (Sub (Mul d12~104@ c12~102@) (Add d12~104@ a12~98@))) (=> (= tmp%36@ (Mul b12~100@ (Add b12~100@ a12~98@))) (=> (= tmp%37@ (Mul (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ b12~100@)) (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ tmp%36@ tmp%37@) (=> %%location_label%%12 (= temp_12_0~2640@ temp_12_1~2701@))))))))))) (=> (= temp_12_0~2640@ temp_12_1~2701@) (=> (= temp_13_0~2902@ (Mul (Sub (Add (Mul b13~108@ c13~110@) d13~112@) (Mul (Mul c13~110@ b13~108@) (Mul b13~108@ b13~108@))) (Mul (Mul d13~112@ (Mul a13~106@ b13~108@)) (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ c13~110@))))) (=> (= temp_13_1~2959@ (Mul (Sub (Add (Mul b13~108@ c13~110@) d13~112@) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@))) (Mul (Mul d13~112@ (Mul a13~106@ b13~108@)) (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b13~108@ c13~110@) (=> %%location_label%%13 (= temp_13_0~2902@ temp_13_1~2959@))) (=> (= temp_13_0~2902@ temp_13_1~2959@) (=> (= temp_14_0~3040@ (Mul (Mul a14~114@ (Sub (Mul d14~120@ d14~120@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Sub a14~114@ a14~114@)) (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ a14~114@))))) (=> (= temp_14_1~3093@ (Mul (Mul a14~114@ (Sub (Mul d14~120@ d14~120@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Sub a14~114@ a14~114@)) (Mul (Mul c14~118@ d14~120@) (Mul a14~114@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c14~118@ d14~120@) (=> (= tmp%38@ (Mul a14~114@ (Sub (Mul d14~120@ d14~120@) (Mul a14~114@ c14~118@)))) (=> (= tmp%39@ (Mul (Mul b14~116@ d14~120@) (Sub a14~114@ a14~114@))) (=> (= tmp%40@ (Mul (Mul c14~118@ d14~120@) (Mul a14~114@ a14~114@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> (= tmp%41@ (Mul a14~114@ (Sub (Mul d14~120@ d14~120@) (Mul a14~114@ c14~118@)))) (=> (= tmp%42@ (Mul (Mul b14~116@ d14~120@) (Sub a14~114@ a14~114@))) (=> (= tmp%43@ (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ a14~114@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ tmp%42@ tmp%43@) (=> %%location_label%%14 (= temp_14_0~3040@ temp_14_1~3093@))))))))))) (=> (= temp_14_0~3040@ temp_14_1~3093@) (=> (= temp_15_0~3266@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) d15~128@) (Mul (Mul b15~124@ b15~124@) d15~128@)) (Sub (Sub (Mul c15~126@ c15~126@) (Mul a15~122@ c15~126@)) c15~126@))) (=> (= temp_15_1~3307@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) d15~128@) (Mul (Mul b15~124@ b15~124@) d15~128@)) (Sub (Mul (Sub c15~126@ a15~122@) c15~126@) c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c15~126@ a15~122@ c15~126@) (=> %%location_label%%15 (= temp_15_0~3266@ temp_15_1~3307@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
