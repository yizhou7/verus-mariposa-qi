...
(declare-const temp_4_1~1102@ Int)
(declare-const temp_5_0~1229@ Int)
(declare-const temp_5_1~1306@ Int)
(declare-const temp_6_0~1535@ Int)
(declare-const temp_6_1~1600@ Int)
(declare-const temp_7_0~1707@ Int)
(declare-const temp_7_1~1764@ Int)
(declare-const temp_8_0~1903@ Int)
(declare-const temp_8_1~1968@ Int)
(declare-const temp_9_0~2077@ Int)
(declare-const temp_9_1~2158@ Int)
(declare-const temp_10_0~2389@ Int)
(declare-const temp_10_1~2454@ Int)
(declare-const temp_11_0~2546@ Int)
(declare-const temp_11_1~2623@ Int)
(declare-const temp_12_0~2691@ Int)
(declare-const temp_12_1~2744@ Int)
(declare-const temp_13_0~2909@ Int)
(declare-const temp_13_1~2986@ Int)
(declare-const temp_14_0~3099@ Int)
(declare-const temp_14_1~3176@ Int)
(declare-const temp_15_0~3397@ Int)
(declare-const temp_15_1~3466@ Int)
(declare-const temp_16_0~3565@ Int)
(declare-const temp_16_1~3630@ Int)
(declare-const temp_17_0~3731@ Int)
(declare-const temp_17_1~3796@ Int)
(declare-const temp_18_0~3889@ Int)
(declare-const temp_18_1~3954@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Sub d0~8@ d0~8@)) (Sub (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))) (Sub (Sub a0~2@ (Mul d0~8@ a0~2@)) (Sub (Mul b0~4@ d0~8@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Sub d0~8@ d0~8@)) (Sub (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))) (Sub (Sub a0~2@ (Mul d0~8@ a0~2@)) (Sub (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ a0~2@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~467@ (Mul (Mul (Mul (Add d1~16@ c1~14@) (Mul 27 a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul d1~16@ d1~16@) (Sub c1~14@ c1~14@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~544@ (Mul (Mul (Mul (Add d1~16@ c1~14@) (Mul 27 a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ d1~16@) (Sub c1~14@ c1~14@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ d1~16@) (=> (= tmp%1@ (Mul (Add d1~16@ c1~14@) (Mul 27 a1~10@))) (=> (= tmp%2@ (Mul c1~14@ c1~14@)) (=> (= tmp%3@ (Mul b1~12@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> (= tmp%4@ (Mul (Add d1~16@ c1~14@) (Mul 27 a1~10@))) (=> (= tmp%5@ (Mul c1~14@ c1~14@)) (=> (= tmp%6@ (Mul d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%1 (= temp_1_0~467@ temp_1_1~544@))))))))))) (=> (= temp_1_0~467@ temp_1_1~544@) (=> (= temp_2_0~693@ (Mul (Mul (Mul (Mul c2~22@ c2~22@) d2~24@) (Mul d2~24@ (Mul a2~18@ d2~24@))) (Add (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) (Add (Sub b2~20@ c2~22@) d2~24@)))) (=> (= temp_2_1~746@ (Mul (Mul (Mul d2~24@ (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ c2~22@) d2~24@)) (Add (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) (Add (Sub b2~20@ c2~22@) d2~24@)))) (and (=> (= tmp%7@ (Mul d2~24@ (Mul a2~18@ d2~24@))) (=> (= tmp%8@ (Mul (Mul c2~22@ c2~22@) d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%2 (= temp_2_0~693@ temp_2_1~746@))))) (=> (= temp_2_0~693@ temp_2_1~746@) (=> (= temp_3_0~855@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ b3~28@))))) (=> (= temp_3_1~920@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ a3~26@))))) (and (=> (= tmp%9@ (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ b3~28@))) (=> (= tmp%10@ (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%3 (= temp_3_0~855@ temp_3_1~920@))))) (=> (= temp_3_0~855@ temp_3_1~920@) (=> (= temp_4_0~1037@ (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Sub b4~36@ b4~36@)) (Mul (Add c4~38@ b4~36@) (Sub c4~38@ a4~34@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~1102@ (Mul (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Sub b4~36@ b4~36@)) (Add c4~38@ b4~36@)) (Sub c4~38@ a4~34@)) (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ b4~36@))))) (and (=> (= tmp%11@ (Mul (Mul a4~34@ a4~34@) (Sub b4~36@ b4~36@))) (=> (= tmp%12@ (Add c4~38@ b4~36@)) (=> (= tmp%13@ (Sub c4~38@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%4 (= temp_4_0~1037@ temp_4_1~1102@)))))) (=> (= temp_4_0~1037@ temp_4_1~1102@) (=> (= temp_5_0~1229@ (Mul (Mul (Sub (Sub d5~48@ c5~46@) (Mul b5~44@ 97)) (Add (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul b5~44@ a5~42@) (Add d5~48@ a5~42@)) (Add (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1306@ (Mul (Mul (Sub (Sub d5~48@ c5~46@) (Mul 97 b5~44@)) (Add (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul b5~44@ a5~42@) (Add d5~48@ a5~42@)) (Add (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 97 b5~44@) (=> (= tmp%14@ (Sub (Sub d5~48@ c5~46@) (Mul 97 b5~44@))) (=> (= tmp%15@ (Add (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@))) (=> (= tmp%16@ (Mul (Mul (Mul b5~44@ a5~42@) (Add d5~48@ a5~42@)) (Add (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> (= tmp%17@ (Sub (Sub d5~48@ c5~46@) (Mul b5~44@ 97))) (=> (= tmp%18@ (Add (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@))) (=> (= tmp%19@ (Mul (Mul (Mul b5~44@ a5~42@) (Add d5~48@ a5~42@)) (Add (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%5 (= temp_5_0~1229@ temp_5_1~1306@))))))))))) (=> (= temp_5_0~1229@ temp_5_1~1306@) (=> (= temp_6_0~1535@ (Add (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ a6~50@))) (Mul (Mul (Sub d6~56@ c6~54@) (Add b6~52@ d6~56@)) (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1600@ (Add (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ a6~50@))) (Mul (Sub d6~56@ c6~54@) (Mul (Add b6~52@ d6~56@) (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ c6~54@)))))) (and (=> (= tmp%20@ (Sub d6~56@ c6~54@)) (=> (= tmp%21@ (Add b6~52@ d6~56@)) (=> (= tmp%22@ (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%6 (= temp_6_0~1535@ temp_6_1~1600@)))))) (=> (= temp_6_0~1535@ temp_6_1~1600@) (=> (= temp_7_0~1707@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul b7~60@ c7~62@) b7~60@) (Mul (Mul c7~62@ c7~62@) d7~64@)))) (=> (= temp_7_1~1764@ (Mul (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@))) (Mul (Mul b7~60@ c7~62@) b7~60@)) (Mul (Mul c7~62@ c7~62@) d7~64@))) (and (=> (= tmp%23@ (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@)))) (=> (= tmp%24@ (Mul (Mul b7~60@ c7~62@) b7~60@)) (=> (= tmp%25@ (Mul (Mul c7~62@ c7~62@) d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> %%location_label%%7 (= temp_7_0~1707@ temp_7_1~1764@)))))) (=> (= temp_7_0~1707@ temp_7_1~1764@) (=> (= temp_8_0~1903@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Sub a8~66@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1968@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) (Sub a8~66@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@))))) (and (=> (= tmp%26@ (Mul d8~72@ a8~66@)) (=> (= tmp%27@ (Sub a8~66@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%26@ tmp%27@) (=> %%location_label%%8 (= temp_8_0~1903@ temp_8_1~1968@))))) (=> (= temp_8_0~1903@ temp_8_1~1968@) (=> (= temp_9_0~2077@ (Mul (Mul (Mul (Sub a9~74@ d9~80@) (Add d9~80@ d9~80@)) (Sub a9~74@ (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ a9~74@) (Mul 52 a9~74@)) (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~2158@ (Mul (Mul (Sub (Mul a9~74@ (Add d9~80@ d9~80@)) (Mul d9~80@ (Add d9~80@ d9~80@))) (Sub a9~74@ (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ a9~74@) (Mul 52 a9~74@)) (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ d9~80@))))) (and (=> (= tmp%28@ (Sub (Mul a9~74@ (Add d9~80@ d9~80@)) (Mul d9~80@ (Add d9~80@ d9~80@)))) (=> (= tmp%29@ (Sub a9~74@ (Mul b9~76@ d9~80@))) (=> (= tmp%30@ (Mul (Mul (Mul b9~76@ a9~74@) (Mul 52 a9~74@)) (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ d9~80@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> (= tmp%31@ (Add d9~80@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a9~74@ d9~80@ tmp%31@) (=> (= tmp%32@ (Mul (Sub a9~74@ d9~80@) (Add d9~80@ d9~80@))) (=> (= tmp%33@ (Sub a9~74@ (Mul b9~76@ d9~80@))) (=> (= tmp%34@ (Mul (Mul (Mul b9~76@ a9~74@) (Mul 52 a9~74@)) (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ d9~80@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%9 (= temp_9_0~2077@ temp_9_1~2158@)))))))))))) (=> (= temp_9_0~2077@ temp_9_1~2158@) (=> (= temp_10_0~2389@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ c10~86@))))) (=> (= temp_10_1~2454@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ c10~86@))))) (=> (= tmp%35@ (= temp_10_0~2389@ temp_10_1~2454@)) (and (=> %%location_label%%10 tmp%35@) (=> tmp%35@ (=> (= temp_11_0~2546@ (Mul (Mul (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ b11~92@))) (Mul (Add (Mul a11~90@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul b11~92@ 17) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~2623@ (Mul (Mul (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ b11~92@))) (Mul (Add (Mul a11~90@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul b11~92@ 17) (Mul d11~96@ a11~90@))))) (=> (= tmp%36@ (= temp_11_0~2546@ temp_11_1~2623@)) (and (=> %%location_label%%11 tmp%36@) (=> tmp%36@ (=> (= temp_12_0~2691@ (Sub (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ c12~102@)) (Sub (Mul d12~104@ a12~98@) (Mul a12~98@ d12~104@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) b12~100@))) (=> (= temp_12_1~2744@ (Sub (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ c12~102@)) (Sub (Mul d12~104@ a12~98@) (Mul a12~98@ d12~104@))) (Mul (Mul b12~100@ (Mul d12~104@ (Mul c12~102@ b12~100@))) b12~100@))) (and (=> (= tmp%37@ (Mul d12~104@ (Mul c12~102@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ tmp%37@) (=> (= tmp%38@ (Mul c12~102@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b12~100@ d12~104@ tmp%38@) (=> (= tmp%39@ (Mul d12~104@ (Mul c12~102@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. b12~100@ tmp%39@ b12~100@) (=> (= tmp%40@ (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%40@ b12~100@) (=> %%location_label%%12 (= temp_12_0~2691@ temp_12_1~2744@)))))))))) (=> (= temp_12_0~2691@ temp_12_1~2744@) (=> (= temp_13_0~2909@ (Mul (Add (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ c13~110@)) (Mul (Mul b13~108@ b13~108@) (Mul 23 b13~108@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ c13~110@)) (Mul (Mul d13~112@ a13~106@) (Add b13~108@ b13~108@))))) (=> (= temp_13_1~2986@ (Mul (Add (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ c13~110@)) (Mul (Mul b13~108@ b13~108@) (Mul 23 b13~108@))) (Mul (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@)) (Mul (Mul d13~112@ a13~106@) (Add b13~108@ b13~108@))))) (and (=> (= tmp%41@ (Mul b13~108@ c13~110@)) (=> (= tmp%42@ (Mul b13~108@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%41@ tmp%42@) (=> %%location_label%%13 (= temp_13_0~2909@ temp_13_1~2986@))))) (=> (= temp_13_0~2909@ temp_13_1~2986@) (=> (= temp_14_0~3099@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ b14~116@)) (Mul (Mul 22 c14~118@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul c14~118@ a14~114@)) (Mul (Mul a14~114@ b14~116@) (Mul d14~120@ d14~120@))))) (=> (= temp_14_1~3176@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ b14~116@)) (Mul (Mul 22 c14~118@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul c14~118@ a14~114@)) (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b14~116@ a14~114@) (=> (= tmp%43@ (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ b14~116@)) (Mul (Mul 22 c14~118@) (Mul d14~120@ b14~116@)))) (=> (= tmp%44@ (Mul (Mul b14~116@ b14~116@) (Mul c14~118@ a14~114@))) (=> (= tmp%45@ (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%43@ tmp%44@ tmp%45@) (=> (= tmp%46@ (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ b14~116@)) (Mul (Mul 22 c14~118@) (Mul d14~120@ b14~116@)))) (=> (= tmp%47@ (Mul (Mul b14~116@ b14~116@) (Mul c14~118@ a14~114@))) (=> (= tmp%48@ (Mul (Mul a14~114@ b14~116@) (Mul d14~120@ d14~120@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%46@ tmp%47@ tmp%48@) (=> %%location_label%%14 (= temp_14_0~3099@ temp_14_1~3176@))))))))))) (=> (= temp_14_0~3099@ temp_14_1~3176@) (=> (= temp_15_0~3397@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ a15~122@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ b15~124@))) (Mul (Mul (Mul a15~122@ d15~128@) (Sub c15~126@ b15~124@)) (Add (Mul a15~122@ d15~128@) d15~128@)))) (=> (= temp_15_1~3466@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ a15~122@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ b15~124@))) (Mul (Sub (Mul (Mul a15~122@ d15~128@) c15~126@) (Mul (Mul a15~122@ d15~128@) b15~124@)) (Add (Mul a15~122@ d15~128@) d15~128@)))) (and (=> (= tmp%49@ (Mul a15~122@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%49@ c15~126@ b15~124@) (=> %%location_label%%15 (= temp_15_0~3397@ temp_15_1~3466@)))) (=> (= temp_15_0~3397@ temp_15_1~3466@) (=> (= temp_16_0~3565@ (Sub (Mul (Mul (Mul d16~136@ a16~130@) (Mul a16~130@ c16~134@)) (Mul (Mul c16~134@ a16~130@) (Mul b16~132@ b16~132@))) (Add (Mul (Mul c16~134@ c16~134@) (Mul d16~136@ c16~134@)) (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~3630@ (Sub (Mul (Mul (Mul d16~136@ a16~130@) (Mul a16~130@ c16~134@)) (Mul (Mul c16~134@ a16~130@) (Mul b16~132@ b16~132@))) (Add (Mul (Mul c16~134@ c16~134@) (Mul d16~136@ c16~134@)) (Mul (Mul a16~130@ d16~136@) (Mul d16~136@ d16~136@))))) (and (=> (= tmp%50@ (Mul a16~130@ d16~136@)) (=> (= tmp%51@ (Mul d16~136@ d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%50@ tmp%51@) (=> %%location_label%%16 (= temp_16_0~3565@ temp_16_1~3630@))))) (=> (= temp_16_0~3565@ temp_16_1~3630@) (=> (= temp_17_0~3731@ (Add (Mul (Mul (Mul c17~142@ a17~138@) (Mul b17~140@ a17~138@)) (Mul (Mul b17~140@ b17~140@) (Add a17~138@ c17~142@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@)) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ a17~138@))))) (=> (= temp_17_1~3796@ (Add (Mul (Mul (Mul c17~142@ a17~138@) (Mul b17~140@ a17~138@)) (Mul (Mul b17~140@ b17~140@) (Add a17~138@ c17~142@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ a17~138@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b17~140@ a17~138@) (=> %%location_label%%17 (= temp_17_0~3731@ temp_17_1~3796@))) (=> (= temp_17_0~3731@ temp_17_1~3796@) (=> (= temp_18_0~3889@ (Mul (Mul (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ a18~146@)) (Mul (Mul b18~148@ c18~150@) (Add c18~150@ c18~150@))) (Mul (Sub (Mul a18~146@ c18~150@) (Mul a18~146@ b18~148@)) (Mul (Mul a18~146@ a18~146@) (Mul b18~148@ a18~146@))))) (=> (= temp_18_1~3954@ (Mul (Mul (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ a18~146@)) (Mul (Mul b18~148@ c18~150@) (Add c18~150@ c18~150@))) (Mul (Sub (Mul c18~150@ a18~146@) (Mul a18~146@ b18~148@)) (Mul (Mul a18~146@ a18~146@) (Mul b18~148@ a18~146@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c18~150@ a18~146@) (=> %%location_label%%18 (= temp_18_0~3889@ temp_18_1~3954@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
