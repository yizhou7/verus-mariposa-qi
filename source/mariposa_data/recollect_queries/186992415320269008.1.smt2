...
(declare-const temp_3_0~982@ Int)
(declare-const temp_3_1~1047@ Int)
(declare-const temp_4_0~1180@ Int)
(declare-const temp_4_1~1229@ Int)
(declare-const temp_5_0~1314@ Int)
(declare-const temp_5_1~1367@ Int)
(declare-const temp_6_0~1460@ Int)
...
(declare-const temp_8_1~1858@ Int)
(declare-const temp_9_0~1945@ Int)
(declare-const temp_9_1~2026@ Int)
(declare-const temp_10_0~2157@ Int)
(declare-const temp_10_1~2234@ Int)
(declare-const temp_11_0~2357@ Int)
(declare-const temp_11_1~2426@ Int)
(declare-const temp_12_0~2517@ Int)
(declare-const temp_12_1~2578@ Int)
(declare-const temp_13_0~2677@ Int)
(declare-const temp_13_1~2742@ Int)
(declare-const temp_14_0~2831@ Int)
(declare-const temp_14_1~2868@ Int)
(declare-const temp_15_0~2973@ Int)
(declare-const temp_15_1~3050@ Int)
(declare-const temp_16_0~3151@ Int)
(declare-const temp_16_1~3216@ Int)
(declare-const temp_17_0~3317@ Int)
(declare-const temp_17_1~3382@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul a0~2@ (Mul a0~2@ d0~8@)) (Mul (Sub d0~8@ d0~8@) (Add c0~6@ d0~8@))) (Sub (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Mul b0~4@ c0~6@) c0~6@)))) (=> (= temp_0_1~354@ (Mul (Mul (Mul a0~2@ (Mul a0~2@ d0~8@)) (Mul (Sub d0~8@ d0~8@) (Add c0~6@ d0~8@))) (Sub (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Mul b0~4@ c0~6@) c0~6@)))) (=> (= tmp%1@ (= temp_0_0~297@ temp_0_1~354@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~430@ (Mul (Mul (Mul (Mul 51 d1~16@) (Add a1~10@ a1~10@)) (Mul a1~10@ (Mul b1~12@ b1~12@))) (Mul b1~12@ (Mul (Sub a1~10@ c1~14@) (Add d1~16@ d1~16@))))) (=> (= temp_1_1~491@ (Mul (Mul (Mul 51 (Mul d1~16@ (Add a1~10@ a1~10@))) (Mul a1~10@ (Mul b1~12@ b1~12@))) (Mul b1~12@ (Mul (Sub a1~10@ c1~14@) (Add d1~16@ d1~16@))))) (and (=> (= tmp%2@ (Add a1~10@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. 51 d1~16@ tmp%2@) (=> (= tmp%3@ (Mul 51 (Mul d1~16@ (Add a1~10@ a1~10@)))) (=> (= tmp%4@ (Mul a1~10@ (Mul b1~12@ b1~12@))) (=> (= tmp%5@ (Mul b1~12@ (Mul (Sub a1~10@ c1~14@) (Add d1~16@ d1~16@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Mul (Mul 51 d1~16@) (Add a1~10@ a1~10@))) (=> (= tmp%7@ (Mul a1~10@ (Mul b1~12@ b1~12@))) (=> (= tmp%8@ (Mul b1~12@ (Mul (Sub a1~10@ c1~14@) (Add d1~16@ d1~16@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%1 (= temp_1_0~430@ temp_1_1~491@)))))))))))) (=> (= temp_1_0~430@ temp_1_1~491@) (=> (= temp_2_0~694@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Add c2~22@ b2~20@) (Mul d2~24@ a2~18@))) (Mul (Mul (Add c2~22@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~759@ (Mul (Mul (Mul (Mul (Mul d2~24@ d2~24@) b2~20@) d2~24@) (Mul (Add c2~22@ b2~20@) (Mul d2~24@ a2~18@))) (Mul (Mul (Add c2~22@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@))))) (and (=> (= tmp%9@ (Mul (Mul (Mul d2~24@ d2~24@) b2~20@) d2~24@)) (=> (= tmp%10@ (Mul (Add c2~22@ b2~20@) (Mul d2~24@ a2~18@))) (=> (= tmp%11@ (Mul (Mul (Add c2~22@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> (= tmp%12@ (Mul d2~24@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ b2~20@ d2~24@) (=> (= tmp%13@ (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@))) (=> (= tmp%14@ (Mul (Add c2~22@ b2~20@) (Mul d2~24@ a2~18@))) (=> (= tmp%15@ (Mul (Mul (Add c2~22@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%2 (= temp_2_0~694@ temp_2_1~759@)))))))))))) (=> (= temp_2_0~694@ temp_2_1~759@) (=> (= temp_3_0~982@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ d3~32@)) (Sub (Mul b3~28@ c3~30@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~1047@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ d3~32@)) (Sub (Mul b3~28@ c3~30@) (Mul d3~32@ b3~28@))))) (and (=> (= tmp%16@ (Mul (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ b3~28@)))) (=> (= tmp%17@ (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ d3~32@)) (Sub (Mul b3~28@ c3~30@) (Mul d3~32@ b3~28@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%3 (= temp_3_0~982@ temp_3_1~1047@))))) (=> (= temp_3_0~982@ temp_3_1~1047@) (=> (= temp_4_0~1180@ (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Add d4~40@ c4~38@)) b4~36@) (Sub (Mul b4~36@ (Mul d4~40@ a4~34@)) (Add (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~1229@ (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Add d4~40@ c4~38@)) b4~36@) (Sub (Mul (Mul d4~40@ a4~34@) b4~36@) (Add (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@))))) (and (=> (= tmp%18@ (Mul d4~40@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ b4~36@) (=> %%location_label%%4 (= temp_4_0~1180@ temp_4_1~1229@)))) (=> (= temp_4_0~1180@ temp_4_1~1229@) (=> (= temp_5_0~1314@ (Mul (Mul (Sub (Mul b5~44@ d5~48@) (Sub c5~46@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ a5~42@)) a5~42@))) (=> (= temp_5_1~1367@ (Mul (Mul (Sub (Mul b5~44@ d5~48@) (Sub c5~46@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ a5~42@)) a5~42@))) (and (=> (= tmp%19@ (Mul c5~46@ c5~46@)) (=> (= tmp%20@ (Mul d5~48@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%5 (= temp_5_0~1314@ temp_5_1~1367@))))) (=> (= temp_5_0~1314@ temp_5_1~1367@) (=> (= temp_6_0~1460@ (Sub (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ d6~56@)) (Mul c6~54@ c6~54@)) (Mul (Sub (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1517@ (Sub (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ d6~56@)) (Mul c6~54@ c6~54@)) (Mul (Sub (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@))))) (=> (= tmp%21@ (= temp_6_0~1460@ temp_6_1~1517@)) (and (=> %%location_label%%6 tmp%21@) (=> tmp%21@ (=> (= temp_7_0~1589@ (Mul (Mul (Mul a7~58@ (Mul b7~60@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Add c7~62@ b7~60@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul b7~60@ (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1646@ (Mul (Mul (Mul a7~58@ (Mul b7~60@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Add c7~62@ b7~60@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ d7~64@) b7~60@)))) (and (=> (= tmp%22@ (Mul (Mul a7~58@ (Mul b7~60@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Add c7~62@ b7~60@)))) (=> (= tmp%23@ (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@))) (=> (= tmp%24@ (Mul (Mul b7~60@ d7~64@) b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> (ens%main!nl_basics.lemma_mul_is_associative. b7~60@ d7~64@ b7~60@) (=> (= tmp%25@ (Mul (Mul a7~58@ (Mul b7~60@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Add c7~62@ b7~60@)))) (=> (= tmp%26@ (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@))) (=> (= tmp%27@ (Mul b7~60@ (Mul d7~64@ b7~60@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%7 (= temp_7_0~1589@ temp_7_1~1646@))))))))))) (=> (= temp_7_0~1589@ temp_7_1~1646@) (=> (= temp_8_0~1821@ (Sub (Mul (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@))) a8~66@)) (=> (= temp_8_1~1858@ (Sub (Mul (Mul (Mul (Mul b8~68@ c8~70@) d8~72@) b8~68@) (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@))) a8~66@)) (and (=> (= tmp%28@ (Mul b8~68@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ d8~72@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1821@ temp_8_1~1858@)))) (=> (= temp_8_0~1821@ temp_8_1~1858@) (=> (= temp_9_0~1945@ (Mul (Add (Mul (Sub c9~78@ c9~78@) c9~78@) (Mul d9~80@ (Mul a9~74@ d9~80@))) (Add (Mul (Mul a9~74@ a9~74@) c9~78@) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~2026@ (Add (Mul (Mul (Sub c9~78@ c9~78@) c9~78@) (Add (Mul (Mul a9~74@ a9~74@) c9~78@) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ c9~78@)))) (Mul (Mul d9~80@ (Mul a9~74@ d9~80@)) (Add (Mul (Mul a9~74@ a9~74@) c9~78@) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ c9~78@)))))) (and (=> (= tmp%29@ (Mul (Sub c9~78@ c9~78@) c9~78@)) (=> (= tmp%30@ (Mul d9~80@ (Mul a9~74@ d9~80@))) (=> (= tmp%31@ (Add (Mul (Mul a9~74@ a9~74@) c9~78@) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ c9~78@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%29@ tmp%30@ tmp%31@) (=> %%location_label%%9 (= temp_9_0~1945@ temp_9_1~2026@)))))) (=> (= temp_9_0~1945@ temp_9_1~2026@) (=> (= temp_10_0~2157@ (Mul (Mul (Sub (Mul c10~86@ d10~88@) (Mul b10~84@ b10~84@)) (Mul (Sub b10~84@ c10~86@) (Sub b10~84@ b10~84@))) (Mul (Mul (Mul c10~86@ d10~88@) d10~88@) (Mul (Mul a10~82@ a10~82@) (Mul b10~84@ b10~84@))))) (=> (= temp_10_1~2234@ (Mul (Sub (Mul (Mul c10~86@ d10~88@) (Mul (Sub b10~84@ c10~86@) (Sub b10~84@ b10~84@))) (Mul (Mul b10~84@ b10~84@) (Mul (Sub b10~84@ c10~86@) (Sub b10~84@ b10~84@)))) (Mul (Mul (Mul c10~86@ d10~88@) d10~88@) (Mul (Mul a10~82@ a10~82@) (Mul b10~84@ b10~84@))))) (and (=> (= tmp%32@ (Mul c10~86@ d10~88@)) (=> (= tmp%33@ (Mul b10~84@ b10~84@)) (=> (= tmp%34@ (Mul (Sub b10~84@ c10~86@) (Sub b10~84@ b10~84@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%10 (= temp_10_0~2157@ temp_10_1~2234@)))))) (=> (= temp_10_0~2157@ temp_10_1~2234@) (=> (= temp_11_0~2357@ (Mul (Sub (Mul (Mul a11~90@ c11~94@) (Mul b11~92@ d11~96@)) (Add (Mul a11~90@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul a11~90@ c11~94@)) (Mul (Mul b11~92@ b11~92@) 94)))) (=> (= temp_11_1~2426@ (Mul (Sub (Mul (Mul a11~90@ c11~94@) (Mul b11~92@ d11~96@)) (Mul a11~90@ (Add b11~92@ d11~96@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul a11~90@ c11~94@)) (Mul (Mul b11~92@ b11~92@) 94)))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. a11~90@ b11~92@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2357@ temp_11_1~2426@))) (=> (= temp_11_0~2357@ temp_11_1~2426@) (=> (= temp_12_0~2517@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul b12~100@ (Sub b12~100@ c12~102@))) (Mul (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ a12~98@)) (Mul (Add d12~104@ d12~104@) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2578@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul b12~100@ (Sub b12~100@ c12~102@))) (Mul (Mul (Mul (Mul d12~104@ b12~100@) a12~98@) a12~98@) (Mul (Add d12~104@ d12~104@) (Mul b12~100@ a12~98@))))) (and (=> (= tmp%35@ (Mul d12~104@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ a12~98@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2517@ temp_12_1~2578@)))) (=> (= temp_12_0~2517@ temp_12_1~2578@) (=> (= temp_13_0~2677@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ a13~106@)) (Add (Add c13~110@ a13~106@) (Mul b13~108@ d13~112@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul c13~110@ c13~110@)) (Mul (Mul b13~108@ d13~112@) (Sub d13~112@ b13~108@))))) (=> (= temp_13_1~2742@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ a13~106@)) (Add (Add c13~110@ a13~106@) (Mul b13~108@ d13~112@))) (Mul (Mul (Mul b13~108@ d13~112@) (Sub d13~112@ b13~108@)) (Mul (Mul d13~112@ c13~110@) (Mul c13~110@ c13~110@))))) (and (=> (= tmp%36@ (Mul (Mul b13~108@ d13~112@) (Sub d13~112@ b13~108@))) (=> (= tmp%37@ (Mul (Mul d13~112@ c13~110@) (Mul c13~110@ c13~110@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%36@ tmp%37@) (=> %%location_label%%13 (= temp_13_0~2677@ temp_13_1~2742@))))) (=> (= temp_13_0~2677@ temp_13_1~2742@) (=> (= temp_14_0~2831@ (Mul c14~118@ (Add (Mul (Mul c14~118@ c14~118@) (Mul d14~120@ b14~116@)) (Sub (Mul b14~116@ d14~120@) (Mul b14~116@ d14~120@))))) (=> (= temp_14_1~2868@ (Mul c14~118@ (Add (Mul (Mul c14~118@ c14~118@) (Mul d14~120@ b14~116@)) (Sub (Mul d14~120@ b14~116@) (Mul b14~116@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2831@ temp_14_1~2868@))) (=> (= temp_14_0~2831@ temp_14_1~2868@) (=> (= temp_15_0~2973@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Sub d15~128@ a15~122@)) (Add (Sub d15~128@ 58) (Mul d15~128@ a15~122@))) (Mul (Mul (Mul b15~124@ b15~124@) (Sub a15~122@ d15~128@)) (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ c15~126@))))) (=> (= temp_15_1~3050@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Sub d15~128@ a15~122@)) (Add (Sub d15~128@ 58) (Mul d15~128@ a15~122@))) (Mul (Mul (Sub a15~122@ d15~128@) (Mul b15~124@ b15~124@)) (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ c15~126@))))) (and (=> (= tmp%38@ (Sub a15~122@ d15~128@)) (=> (= tmp%39@ (Mul b15~124@ b15~124@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%38@ tmp%39@) (=> %%location_label%%15 (= temp_15_0~2973@ temp_15_1~3050@))))) (=> (= temp_15_0~2973@ temp_15_1~3050@) (=> (= temp_16_0~3151@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Add d16~136@ d16~136@)) (Mul (Sub a16~130@ b16~132@) (Mul b16~132@ c16~134@))) (Mul (Mul (Mul d16~136@ c16~134@) (Sub c16~134@ a16~130@)) (Add (Add c16~134@ b16~132@) (Add a16~130@ b16~132@))))) (=> (= temp_16_1~3216@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Add d16~136@ d16~136@)) (Mul (Mul b16~132@ c16~134@) (Sub a16~130@ b16~132@))) (Mul (Mul (Mul d16~136@ c16~134@) (Sub c16~134@ a16~130@)) (Add (Add c16~134@ b16~132@) (Add a16~130@ b16~132@))))) (and (=> (= tmp%40@ (Mul b16~132@ c16~134@)) (=> (= tmp%41@ (Sub a16~130@ b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%40@ tmp%41@) (=> %%location_label%%16 (= temp_16_0~3151@ temp_16_1~3216@))))) (=> (= temp_16_0~3151@ temp_16_1~3216@) (=> (= temp_17_0~3317@ (Add (Sub (Mul (Mul d17~144@ b17~140@) (Mul b17~140@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ c17~142@))) (Mul (Add (Mul b17~140@ b17~140@) (Mul d17~144@ a17~138@)) (Mul (Mul a17~138@ b17~140@) (Mul c17~142@ d17~144@))))) (=> (= temp_17_1~3382@ (Add (Sub (Mul (Mul b17~140@ c17~142@) (Mul d17~144@ b17~140@)) (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ c17~142@))) (Mul (Add (Mul b17~140@ b17~140@) (Mul d17~144@ a17~138@)) (Mul (Mul a17~138@ b17~140@) (Mul c17~142@ d17~144@))))) (=> (= tmp%42@ (Mul b17~140@ c17~142@)) (=> (= tmp%43@ (Mul d17~144@ b17~140@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%42@ tmp%43@) (=> %%location_label%%17 (= temp_17_0~3317@ temp_17_1~3382@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
