...
(declare-const temp_1_1~652@ Int)
(declare-const temp_2_0~775@ Int)
(declare-const temp_2_1~848@ Int)
(declare-const temp_3_0~937@ Int)
(declare-const temp_3_1~998@ Int)
(declare-const temp_4_0~1067@ Int)
(declare-const temp_4_1~1100@ Int)
(declare-const temp_5_0~1217@ Int)
(declare-const temp_5_1~1282@ Int)
(declare-const temp_6_0~1419@ Int)
(declare-const temp_6_1~1468@ Int)
(declare-const temp_7_0~1613@ Int)
...
(declare-const temp_10_1~2218@ Int)
(declare-const temp_11_0~2399@ Int)
(declare-const temp_11_1~2444@ Int)
(declare-const temp_12_0~2507@ Int)
(declare-const temp_12_1~2548@ Int)
(declare-const temp_13_0~2659@ Int)
(declare-const temp_13_1~2736@ Int)
(declare-const temp_14_0~2835@ Int)
(declare-const temp_14_1~2900@ Int)
(declare-const temp_15_0~3005@ Int)
(declare-const temp_15_1~3058@ Int)
(declare-const temp_16_0~3147@ Int)
(declare-const temp_16_1~3196@ Int)
(declare-const temp_17_0~3293@ Int)
(declare-const temp_17_1~3350@ Int)
(declare-const temp_18_0~3461@ Int)
(declare-const temp_18_1~3538@ Int)
(declare-const temp_19_0~3651@ Int)
(declare-const temp_19_1~3724@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Sub d0~8@ b0~4@) (Mul b0~4@ b0~4@)) (Sub (Sub d0~8@ d0~8@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub d0~8@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Sub d0~8@ b0~4@)) (Sub (Sub d0~8@ d0~8@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub d0~8@ a0~2@))))) (and (=> (= tmp%1@ (Mul b0~4@ b0~4@)) (=> (= tmp%2@ (Sub d0~8@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> (= tmp%3@ (Mul (Mul b0~4@ b0~4@) (Sub d0~8@ b0~4@))) (=> (= tmp%4@ (Sub (Sub d0~8@ d0~8@) (Mul a0~2@ b0~4@))) (=> (= tmp%5@ (Mul (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub d0~8@ a0~2@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Mul (Sub d0~8@ b0~4@) (Mul b0~4@ b0~4@))) (=> (= tmp%7@ (Sub (Sub d0~8@ d0~8@) (Mul a0~2@ b0~4@))) (=> (= tmp%8@ (Mul (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub d0~8@ a0~2@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))))))))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~591@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ d1~16@)) (Sub (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ d1~16@) (Sub d1~16@ a1~10@)) (Add d1~16@ (Sub d1~16@ a1~10@))))) (=> (= temp_1_1~652@ (Mul (Mul (Mul d1~16@ a1~10@) (Mul (Mul c1~14@ d1~16@) (Sub (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@)))) (Mul (Mul (Mul b1~12@ d1~16@) (Sub d1~16@ a1~10@)) (Add d1~16@ (Sub d1~16@ a1~10@))))) (and (=> (= tmp%9@ (Mul d1~16@ a1~10@)) (=> (= tmp%10@ (Mul c1~14@ d1~16@)) (=> (= tmp%11@ (Sub (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%1 (= temp_1_0~591@ temp_1_1~652@)))))) (=> (= temp_1_0~591@ temp_1_1~652@) (=> (= temp_2_0~775@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul c2~22@ b2~20@) 84) (Mul (Mul d2~24@ c2~22@) (Add c2~22@ d2~24@))))) (=> (= temp_2_1~848@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul c2~22@ b2~20@) 84) (Mul (Mul d2~24@ c2~22@) (Add c2~22@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ c2~22@) (=> %%location_label%%2 (= temp_2_0~775@ temp_2_1~848@))) (=> (= temp_2_0~775@ temp_2_1~848@) (=> (= temp_3_0~937@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul a3~26@ b3~28@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~998@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul a3~26@ b3~28@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))))) (and (=> (= tmp%12@ (Mul a3~26@ d3~32@)) (=> (= tmp%13@ (Mul b3~28@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%3 (= temp_3_0~937@ temp_3_1~998@))))) (=> (= temp_3_0~937@ temp_3_1~998@) (=> (= temp_4_0~1067@ (Mul c4~38@ (Add (Add (Mul c4~38@ a4~34@) (Sub a4~34@ d4~40@)) (Add a4~34@ (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~1100@ (Mul (Add (Add (Mul c4~38@ a4~34@) (Sub a4~34@ d4~40@)) (Add a4~34@ (Mul b4~36@ b4~36@))) c4~38@)) (and (=> (= tmp%14@ (Add (Add (Mul c4~38@ a4~34@) (Sub a4~34@ d4~40@)) (Add a4~34@ (Mul b4~36@ b4~36@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1067@ temp_4_1~1100@)))) (=> (= temp_4_0~1067@ temp_4_1~1100@) (=> (= temp_5_0~1217@ (Sub (Mul (Mul (Mul d5~48@ b5~44@) (Add b5~44@ d5~48@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))) (Sub (Sub (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1282@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Add b5~44@ d5~48@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))) (Sub (Sub (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b5~44@ d5~48@) (=> (= tmp%15@ (Mul b5~44@ d5~48@)) (=> (= tmp%16@ (Add b5~44@ d5~48@)) (=> (= tmp%17@ (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> (= tmp%18@ (Mul d5~48@ b5~44@)) (=> (= tmp%19@ (Add b5~44@ d5~48@)) (=> (= tmp%20@ (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%5 (= temp_5_0~1217@ temp_5_1~1282@))))))))))) (=> (= temp_5_0~1217@ temp_5_1~1282@) (=> (= temp_6_0~1419@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Sub b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) c6~54@)) (Mul b6~52@ (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1468@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Sub b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) c6~54@)) (Mul b6~52@ (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b6~52@ a6~50@) (=> (= tmp%21@ (Mul (Mul (Mul b6~52@ b6~52@) (Sub b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) c6~54@))) (=> (= tmp%22@ (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ a6~50@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ b6~52@ tmp%22@) (=> (= tmp%23@ (Mul (Mul (Mul b6~52@ b6~52@) (Sub b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) c6~54@))) (=> (= tmp%24@ (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ b6~52@ tmp%24@) (=> %%location_label%%6 (= temp_6_0~1419@ temp_6_1~1468@))))))))) (=> (= temp_6_0~1419@ temp_6_1~1468@) (=> (= temp_7_0~1613@ (Mul d7~64@ (Sub c7~62@ (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1638@ (Mul (Sub c7~62@ (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ b7~60@))) d7~64@)) (and (=> (= tmp%25@ (Sub c7~62@ (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ b7~60@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%25@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1613@ temp_7_1~1638@)))) (=> (= temp_7_0~1613@ temp_7_1~1638@) (=> (= temp_8_0~1747@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ c8~70@)) (Mul (Add d8~72@ a8~66@) (Add c8~70@ b8~68@))) (Mul (Mul (Mul a8~66@ b8~68@) (Add a8~66@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1812@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ c8~70@)) (Mul (Add d8~72@ a8~66@) (Add c8~70@ b8~68@))) (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Add a8~66@ d8~72@)) (Mul d8~72@ a8~66@)) (Mul b8~68@ a8~66@)))) (and (=> (= tmp%26@ (Mul (Mul a8~66@ b8~68@) (Add a8~66@ d8~72@))) (=> (= tmp%27@ (Mul d8~72@ a8~66@)) (=> (= tmp%28@ (Mul b8~68@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> %%location_label%%8 (= temp_8_0~1747@ temp_8_1~1812@)))))) (=> (= temp_8_0~1747@ temp_8_1~1812@) (=> (= temp_9_0~1923@ (Mul (Mul (Mul (Mul c9~78@ 3) (Mul b9~76@ a9~74@)) (Mul b9~76@ (Mul d9~80@ d9~80@))) (Mul d9~80@ (Sub (Mul c9~78@ b9~76@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~1984@ (Mul (Mul (Mul (Mul c9~78@ 3) (Mul a9~74@ b9~76@)) (Mul b9~76@ (Mul d9~80@ d9~80@))) (Mul d9~80@ (Sub (Mul c9~78@ b9~76@) (Mul b9~76@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a9~74@ b9~76@) (=> (= tmp%29@ (Mul (Mul c9~78@ 3) (Mul a9~74@ b9~76@))) (=> (= tmp%30@ (Mul b9~76@ (Mul d9~80@ d9~80@))) (=> (= tmp%31@ (Mul d9~80@ (Sub (Mul c9~78@ b9~76@) (Mul b9~76@ a9~74@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> (= tmp%32@ (Mul (Mul c9~78@ 3) (Mul b9~76@ a9~74@))) (=> (= tmp%33@ (Mul b9~76@ (Mul d9~80@ d9~80@))) (=> (= tmp%34@ (Mul d9~80@ (Sub (Mul c9~78@ b9~76@) (Mul b9~76@ a9~74@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%9 (= temp_9_0~1923@ temp_9_1~1984@))))))))))) (=> (= temp_9_0~1923@ temp_9_1~1984@) (=> (= temp_10_0~2165@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Sub c10~86@ a10~82@) (Mul a10~82@ b10~84@))) (Add b10~84@ (Mul (Mul a10~82@ b10~84@) (Add a10~82@ c10~86@))))) (=> (= temp_10_1~2218@ (Mul (Mul (Mul (Add a10~82@ b10~84@) (Mul b10~84@ b10~84@)) (Mul (Sub c10~86@ a10~82@) (Mul a10~82@ b10~84@))) (Add b10~84@ (Mul (Mul a10~82@ b10~84@) (Add a10~82@ c10~86@))))) (and (=> (= tmp%35@ (Add a10~82@ b10~84@)) (=> (= tmp%36@ (Mul b10~84@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%35@ tmp%36@) (=> (= tmp%37@ (Mul (Add a10~82@ b10~84@) (Mul b10~84@ b10~84@))) (=> (= tmp%38@ (Mul (Sub c10~86@ a10~82@) (Mul a10~82@ b10~84@))) (=> (= tmp%39@ (Add b10~84@ (Mul (Mul a10~82@ b10~84@) (Add a10~82@ c10~86@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%37@ tmp%38@ tmp%39@) (=> (= tmp%40@ (Mul (Mul b10~84@ b10~84@) (Add a10~82@ b10~84@))) (=> (= tmp%41@ (Mul (Sub c10~86@ a10~82@) (Mul a10~82@ b10~84@))) (=> (= tmp%42@ (Add b10~84@ (Mul (Mul a10~82@ b10~84@) (Add a10~82@ c10~86@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ tmp%41@ tmp%42@) (=> %%location_label%%10 (= temp_10_0~2165@ temp_10_1~2218@))))))))))))) (=> (= temp_10_0~2165@ temp_10_1~2218@) (=> (= temp_11_0~2399@ (Mul (Mul (Mul (Add c11~94@ a11~90@) (Mul d11~96@ c11~94@)) (Sub (Mul b11~92@ d11~96@) (Add a11~90@ b11~92@))) (Mul c11~94@ (Mul c11~94@ d11~96@)))) (=> (= temp_11_1~2444@ (Mul (Mul (Mul (Add c11~94@ a11~90@) (Mul d11~96@ c11~94@)) (Sub (Mul b11~92@ d11~96@) (Add a11~90@ b11~92@))) (Mul (Mul c11~94@ c11~94@) d11~96@))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. c11~94@ c11~94@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2399@ temp_11_1~2444@))) (=> (= temp_11_0~2399@ temp_11_1~2444@) (=> (= temp_12_0~2507@ (Mul (Sub (Mul (Mul c12~102@ b12~100@) (Add a12~98@ d12~104@)) (Add b12~100@ (Mul c12~102@ b12~100@))) a12~98@)) (=> (= temp_12_1~2548@ (Mul (Sub (Add (Mul (Mul c12~102@ b12~100@) a12~98@) (Mul (Mul c12~102@ b12~100@) d12~104@)) (Add b12~100@ (Mul c12~102@ b12~100@))) a12~98@)) (and (=> (= tmp%43@ (Mul c12~102@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%43@ a12~98@ d12~104@) (=> %%location_label%%12 (= temp_12_0~2507@ temp_12_1~2548@)))) (=> (= temp_12_0~2507@ temp_12_1~2548@) (=> (= temp_13_0~2659@ (Mul (Sub (Mul (Mul a13~106@ a13~106@) (Mul a13~106@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ b13~108@)) (Mul (Add d13~112@ 87) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2736@ (Mul (Sub (Mul (Mul a13~106@ a13~106@) (Mul a13~106@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul (Mul d13~112@ b13~108@) b13~108@) b13~108@) (Mul (Add d13~112@ 87) (Mul c13~110@ d13~112@))))) (and (=> (= tmp%44@ (Mul d13~112@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%44@ b13~108@ b13~108@) (=> %%location_label%%13 (= temp_13_0~2659@ temp_13_1~2736@)))) (=> (= temp_13_0~2659@ temp_13_1~2736@) (=> (= temp_14_0~2835@ (Mul (Mul (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ c14~118@)) (Mul (Add c14~118@ d14~120@) (Mul b14~116@ b14~116@))) (Mul (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ c14~118@)) (Sub (Mul c14~118@ d14~120@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~2900@ (Mul (Mul (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ c14~118@)) (Mul (Add c14~118@ d14~120@) (Mul b14~116@ b14~116@))) (Mul (Sub (Mul c14~118@ d14~120@) (Mul c14~118@ b14~116@)) (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ c14~118@))))) (and (=> (= tmp%45@ (Sub (Mul c14~118@ d14~120@) (Mul c14~118@ b14~116@))) (=> (= tmp%46@ (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ c14~118@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%45@ tmp%46@) (=> %%location_label%%14 (= temp_14_0~2835@ temp_14_1~2900@))))) (=> (= temp_14_0~2835@ temp_14_1~2900@) (=> (= temp_15_0~3005@ (Sub (Mul (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ b15~124@)) (Mul (Add b15~124@ b15~124@) (Mul a15~122@ b15~124@))) (Mul (Mul (Mul b15~124@ c15~126@) (Sub d15~128@ c15~126@)) a15~122@))) (=> (= temp_15_1~3058@ (Sub (Mul (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ b15~124@)) (Mul (Add b15~124@ b15~124@) (Mul a15~122@ b15~124@))) (Mul a15~122@ (Mul (Mul b15~124@ c15~126@) (Sub d15~128@ c15~126@))))) (and (=> (= tmp%47@ (Mul (Mul b15~124@ c15~126@) (Sub d15~128@ c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a15~122@ tmp%47@) (=> %%location_label%%15 (= temp_15_0~3005@ temp_15_1~3058@)))) (=> (= temp_15_0~3005@ temp_15_1~3058@) (=> (= temp_16_0~3147@ (Sub (Mul (Add (Mul b16~132@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ 67))) d16~136@)) (=> (= temp_16_1~3196@ (Sub (Mul (Add (Mul b16~132@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul d16~136@ 67) (Mul c16~134@ d16~136@))) d16~136@)) (and (=> (= tmp%48@ (Mul d16~136@ 67)) (=> (= tmp%49@ (Mul c16~134@ d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%48@ tmp%49@) (=> %%location_label%%16 (= temp_16_0~3147@ temp_16_1~3196@))))) (=> (= temp_16_0~3147@ temp_16_1~3196@) (=> (= temp_17_0~3293@ (Sub (Mul (Mul b17~140@ (Mul a17~138@ b17~140@)) (Mul (Mul d17~144@ d17~144@) (Mul c17~142@ c17~142@))) (Mul (Mul (Mul c17~142@ d17~144@) d17~144@) (Sub (Mul d17~144@ c17~142@) (Mul a17~138@ d17~144@))))) (=> (= temp_17_1~3350@ (Sub (Mul (Mul b17~140@ (Mul a17~138@ b17~140@)) (Mul d17~144@ (Mul d17~144@ (Mul c17~142@ c17~142@)))) (Mul (Mul (Mul c17~142@ d17~144@) d17~144@) (Sub (Mul d17~144@ c17~142@) (Mul a17~138@ d17~144@))))) (and (=> (= tmp%50@ (Mul c17~142@ c17~142@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d17~144@ d17~144@ tmp%50@) (=> %%location_label%%17 (= temp_17_0~3293@ temp_17_1~3350@)))) (=> (= temp_17_0~3293@ temp_17_1~3350@) (=> (= temp_18_0~3461@ (Mul (Mul (Mul (Add b18~148@ c18~150@) (Mul a18~146@ b18~148@)) (Sub (Mul a18~146@ d18~152@) (Mul c18~150@ 31))) (Mul (Mul (Sub b18~148@ b18~148@) (Mul a18~146@ c18~150@)) (Mul (Mul a18~146@ c18~150@) (Sub c18~150@ d18~152@))))) (=> (= temp_18_1~3538@ (Mul (Mul (Sub (Mul a18~146@ d18~152@) (Mul c18~150@ 31)) (Mul (Add b18~148@ c18~150@) (Mul a18~146@ b18~148@))) (Mul (Mul (Sub b18~148@ b18~148@) (Mul a18~146@ c18~150@)) (Mul (Mul a18~146@ c18~150@) (Sub c18~150@ d18~152@))))) (and (=> (= tmp%51@ (Sub (Mul a18~146@ d18~152@) (Mul c18~150@ 31))) (=> (= tmp%52@ (Mul (Add b18~148@ c18~150@) (Mul a18~146@ b18~148@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%51@ tmp%52@) (=> %%location_label%%18 (= temp_18_0~3461@ temp_18_1~3538@))))) (=> (= temp_18_0~3461@ temp_18_1~3538@) (=> (= temp_19_0~3651@ (Mul (Mul (Mul d19~160@ (Mul a19~154@ d19~160@)) (Mul (Sub a19~154@ b19~156@) (Mul c19~158@ b19~156@))) (Mul (Add (Sub c19~158@ d19~160@) (Mul d19~160@ a19~154@)) (Add (Add a19~154@ a19~154@) b19~156@)))) (=> (= temp_19_1~3724@ (Mul (Mul (Mul d19~160@ (Mul a19~154@ d19~160@)) (Mul (Sub a19~154@ b19~156@) (Mul c19~158@ b19~156@))) (Add (Mul (Add (Sub c19~158@ d19~160@) (Mul d19~160@ a19~154@)) (Add a19~154@ a19~154@)) (Mul (Add (Sub c19~158@ d19~160@) (Mul d19~160@ a19~154@)) b19~156@)))) (=> (= tmp%53@ (Add (Sub c19~158@ d19~160@) (Mul d19~160@ a19~154@))) (=> (= tmp%54@ (Add a19~154@ a19~154@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%53@ tmp%54@ b19~156@) (=> %%location_label%%19 (= temp_19_0~3651@ temp_19_1~3724@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
