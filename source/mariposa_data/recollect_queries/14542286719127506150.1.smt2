...
(declare-const temp_2_0~626@ Int)
(declare-const temp_2_1~687@ Int)
(declare-const temp_3_0~828@ Int)
(declare-const temp_3_1~889@ Int)
(declare-const temp_4_0~978@ Int)
(declare-const temp_4_1~1039@ Int)
(declare-const temp_5_0~1250@ Int)
(declare-const temp_5_1~1327@ Int)
(declare-const temp_6_0~1564@ Int)
(declare-const temp_6_1~1641@ Int)
(declare-const temp_7_0~1760@ Int)
(declare-const temp_7_1~1825@ Int)
(declare-const temp_8_0~1936@ Int)
(declare-const temp_8_1~1997@ Int)
(declare-const temp_9_0~2085@ Int)
(declare-const temp_9_1~2158@ Int)
(declare-const temp_10_0~2251@ Int)
(declare-const temp_10_1~2316@ Int)
(declare-const temp_11_0~2403@ Int)
(declare-const temp_11_1~2460@ Int)
(declare-const temp_12_0~2673@ Int)
(declare-const temp_12_1~2782@ Int)
(declare-const temp_13_0~2917@ Int)
(declare-const temp_13_1~2970@ Int)
(declare-const temp_14_0~3069@ Int)
(declare-const temp_14_1~3130@ Int)
(declare-const temp_15_0~3319@ Int)
(declare-const temp_15_1~3356@ Int)
(declare-const temp_16_0~3455@ Int)
(declare-const temp_16_1~3520@ Int)
(declare-const temp_17_0~3623@ Int)
(declare-const temp_17_1~3688@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Add (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Mul (Sub c0~6@ b0~4@) (Add c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Add (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul c0~6@ c0~6@)) (Mul b0~4@ a0~2@)) (Mul (Mul (Sub c0~6@ b0~4@) (Add c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))))) (and (=> (= tmp%1@ (Add (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@))) (=> (= tmp%2@ (Mul c0~6@ c0~6@)) (=> (= tmp%3@ (Mul b0~4@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~485@ (Mul (Mul (Mul (Add a1~10@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ c1~14@))) (Mul (Sub (Mul b1~12@ d1~16@) (Sub b1~12@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~550@ (Mul (Mul (Mul (Add a1~10@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ c1~14@))) (Mul (Sub (Mul b1~12@ d1~16@) (Sub b1~12@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= tmp%4@ (= temp_1_0~485@ temp_1_1~550@)) (and (=> %%location_label%%1 tmp%4@) (=> tmp%4@ (=> (= temp_2_0~626@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Sub (Add d2~24@ a2~18@) (Mul a2~18@ c2~22@))) (Mul (Add (Mul c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) b2~20@)))) (=> (= temp_2_1~687@ (Mul (Mul (Add (Mul c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) b2~20@)) (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Sub (Add d2~24@ a2~18@) (Mul a2~18@ c2~22@))))) (and (=> (= tmp%5@ (Mul (Add (Mul c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) b2~20@))) (=> (= tmp%6@ (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Sub (Add d2~24@ a2~18@) (Mul a2~18@ c2~22@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%2 (= temp_2_0~626@ temp_2_1~687@))))) (=> (= temp_2_0~626@ temp_2_1~687@) (=> (= temp_3_0~828@ (Mul (Add (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Sub b3~28@ c3~30@) (Add c3~30@ a3~26@))) (Add (Mul c3~30@ (Mul c3~30@ c3~30@)) (Add (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~889@ (Mul (Add (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Sub b3~28@ c3~30@) (Add c3~30@ a3~26@))) (Add (Mul c3~30@ (Mul c3~30@ c3~30@)) (Add (Mul b3~28@ a3~26@) (Mul a3~26@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ a3~26@) (=> %%location_label%%3 (= temp_3_0~828@ temp_3_1~889@))) (=> (= temp_3_0~828@ temp_3_1~889@) (=> (= temp_4_0~978@ (Mul (Sub (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) d4~40@) (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ d4~40@) 6)))) (=> (= temp_4_1~1039@ (Mul (Sub (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) d4~40@) (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@)) (Mul c4~38@ (Mul d4~40@ 6))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. c4~38@ d4~40@ 6) (=> (= tmp%7@ (Sub (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) d4~40@)) (=> (= tmp%8@ (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@))) (=> (= tmp%9@ (Mul c4~38@ (Mul d4~40@ 6))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> (= tmp%10@ (Sub (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) d4~40@)) (=> (= tmp%11@ (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@))) (=> (= tmp%12@ (Mul (Mul c4~38@ d4~40@) 6)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%4 (= temp_4_0~978@ temp_4_1~1039@))))))))))) (=> (= temp_4_0~978@ temp_4_1~1039@) (=> (= temp_5_0~1250@ (Mul (Mul (Mul (Add d5~48@ d5~48@) (Mul d5~48@ c5~46@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ 78)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1327@ (Mul (Mul (Mul (Add d5~48@ d5~48@) (Mul c5~46@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ 78)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ d5~48@) (=> (= tmp%13@ (Mul (Add d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (=> (= tmp%14@ (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ b5~44@))) (=> (= tmp%15@ (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ 78)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> (= tmp%16@ (Mul (Add d5~48@ d5~48@) (Mul d5~48@ c5~46@))) (=> (= tmp%17@ (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ b5~44@))) (=> (= tmp%18@ (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ 78)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%5 (= temp_5_0~1250@ temp_5_1~1327@))))))))))) (=> (= temp_5_0~1250@ temp_5_1~1327@) (=> (= temp_6_0~1564@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@)) (Sub (Mul d6~56@ a6~50@) (Add d6~56@ 1))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@))))) (=> (= temp_6_1~1641@ (Mul (Mul (Mul d6~56@ a6~50@) (Mul (Mul b6~52@ b6~52@) (Sub (Mul d6~56@ a6~50@) (Add d6~56@ 1)))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@))))) (and (=> (= tmp%19@ (Mul d6~56@ a6~50@)) (=> (= tmp%20@ (Mul b6~52@ b6~52@)) (=> (= tmp%21@ (Sub (Mul d6~56@ a6~50@) (Add d6~56@ 1))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%6 (= temp_6_0~1564@ temp_6_1~1641@)))))) (=> (= temp_6_0~1564@ temp_6_1~1641@) (=> (= temp_7_0~1760@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Add c7~62@ c7~62@))) (Mul (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@))))) (=> (= temp_7_1~1825@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Add c7~62@ c7~62@))) (Mul (Mul (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@)) (Mul a7~58@ b7~60@)) (Mul c7~62@ c7~62@)))) (and (=> (= tmp%22@ (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@))) (=> (= tmp%23@ (Mul a7~58@ b7~60@)) (=> (= tmp%24@ (Mul c7~62@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%7 (= temp_7_0~1760@ temp_7_1~1825@)))))) (=> (= temp_7_0~1760@ temp_7_1~1825@) (=> (= temp_8_0~1936@ (Mul (Mul (Sub (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ b8~68@) c8~70@)))) (=> (= temp_8_1~1997@ (Mul (Mul (Sub (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ b8~68@) c8~70@)))) (=> (= tmp%25@ (= temp_8_0~1936@ temp_8_1~1997@)) (and (=> %%location_label%%8 tmp%25@) (=> tmp%25@ (=> (= temp_9_0~2085@ (Mul (Mul (Mul (Sub c9~78@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul c9~78@ 38))) (Add (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ d9~80@)) (Mul a9~74@ (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~2158@ (Mul (Mul (Mul (Sub c9~78@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul c9~78@ 38))) (Add (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ a9~74@) a9~74@)))) (and (=> (= tmp%26@ (Mul c9~78@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%26@ a9~74@) (=> %%location_label%%9 (= temp_9_0~2085@ temp_9_1~2158@)))) (=> (= temp_9_0~2085@ temp_9_1~2158@) (=> (= temp_10_0~2251@ (Mul (Sub (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ a10~82@)) (Sub (Mul d10~88@ a10~82@) (Mul b10~84@ d10~88@))) (Sub (Mul b10~84@ (Sub b10~84@ a10~82@)) (Mul (Mul a10~82@ b10~84@) (Sub b10~84@ c10~86@))))) (=> (= temp_10_1~2316@ (Mul (Sub (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ a10~82@)) (Sub (Mul d10~88@ a10~82@) (Mul b10~84@ d10~88@))) (Sub (Sub (Mul b10~84@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul a10~82@ b10~84@) (Sub b10~84@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b10~84@ b10~84@ a10~82@) (=> %%location_label%%10 (= temp_10_0~2251@ temp_10_1~2316@))) (=> (= temp_10_0~2251@ temp_10_1~2316@) (=> (= temp_11_0~2403@ (Mul (Add (Mul a11~90@ (Mul c11~94@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ b11~92@))) (Mul (Mul a11~90@ (Mul a11~90@ a11~90@)) (Sub (Mul b11~92@ a11~90@) (Mul c11~94@ c11~94@))))) (=> (= temp_11_1~2460@ (Mul (Add (Mul a11~90@ (Mul c11~94@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ b11~92@))) (Mul (Mul a11~90@ (Mul a11~90@ a11~90@)) (Sub (Mul a11~90@ b11~92@) (Mul c11~94@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a11~90@ b11~92@) (=> (= tmp%27@ (Add (Mul a11~90@ (Mul c11~94@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ b11~92@)))) (=> (= tmp%28@ (Mul a11~90@ (Mul a11~90@ a11~90@))) (=> (= tmp%29@ (Sub (Mul a11~90@ b11~92@) (Mul c11~94@ c11~94@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> (= tmp%30@ (Add (Mul a11~90@ (Mul c11~94@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ b11~92@)))) (=> (= tmp%31@ (Mul a11~90@ (Mul a11~90@ a11~90@))) (=> (= tmp%32@ (Sub (Mul b11~92@ a11~90@) (Mul c11~94@ c11~94@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%30@ tmp%31@ tmp%32@) (=> %%location_label%%11 (= temp_11_0~2403@ temp_11_1~2460@))))))))))) (=> (= temp_11_0~2403@ temp_11_1~2460@) (=> (= temp_12_0~2673@ (Mul (Sub (Add (Add 5 c12~102@) (Mul b12~100@ a12~98@)) (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ b12~100@))) (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Sub b12~100@ c12~102@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2782@ (Sub (Mul (Add (Add 5 c12~102@) (Mul b12~100@ a12~98@)) (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Sub b12~100@ c12~102@) (Mul d12~104@ d12~104@)))) (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ b12~100@)) (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Sub b12~100@ c12~102@) (Mul d12~104@ d12~104@)))))) (and (=> (= tmp%33@ (Add (Add 5 c12~102@) (Mul b12~100@ a12~98@))) (=> (= tmp%34@ (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ b12~100@))) (=> (= tmp%35@ (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Sub b12~100@ c12~102@) (Mul d12~104@ d12~104@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%33@ tmp%34@ tmp%35@) (=> %%location_label%%12 (= temp_12_0~2673@ temp_12_1~2782@)))))) (=> (= temp_12_0~2673@ temp_12_1~2782@) (=> (= temp_13_0~2917@ (Mul (Mul c13~110@ (Sub (Mul d13~112@ c13~110@) (Mul c13~110@ b13~108@))) (Add (Add c13~110@ (Mul c13~110@ d13~112@)) (Mul (Add a13~106@ a13~106@) (Mul a13~106@ b13~108@))))) (=> (= temp_13_1~2970@ (Mul (Sub (Mul c13~110@ (Mul d13~112@ c13~110@)) (Mul c13~110@ (Mul c13~110@ b13~108@))) (Add (Add c13~110@ (Mul c13~110@ d13~112@)) (Mul (Add a13~106@ a13~106@) (Mul a13~106@ b13~108@))))) (and (=> (= tmp%36@ (Mul d13~112@ c13~110@)) (=> (= tmp%37@ (Mul c13~110@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c13~110@ tmp%36@ tmp%37@) (=> %%location_label%%13 (= temp_13_0~2917@ temp_13_1~2970@))))) (=> (= temp_13_0~2917@ temp_13_1~2970@) (=> (= temp_14_0~3069@ (Mul (Mul (Mul (Add c14~118@ d14~120@) (Sub a14~114@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ a14~114@))) (Mul (Mul (Mul d14~120@ a14~114@) d14~120@) (Mul (Mul d14~120@ c14~118@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~3130@ (Mul (Mul (Mul (Add c14~118@ d14~120@) (Sub a14~114@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ a14~114@))) (Mul (Mul (Mul d14~120@ a14~114@) d14~120@) (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ c14~118@))))) (and (=> (= tmp%38@ (Mul b14~116@ c14~118@)) (=> (= tmp%39@ (Mul d14~120@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%38@ tmp%39@) (=> (= tmp%40@ (Mul (Mul (Add c14~118@ d14~120@) (Sub a14~114@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ a14~114@)))) (=> (= tmp%41@ (Mul (Mul d14~120@ a14~114@) d14~120@)) (=> (= tmp%42@ (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ c14~118@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ tmp%41@ tmp%42@) (=> (= tmp%43@ (Mul (Mul (Add c14~118@ d14~120@) (Sub a14~114@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ a14~114@)))) (=> (= tmp%44@ (Mul (Mul d14~120@ a14~114@) d14~120@)) (=> (= tmp%45@ (Mul (Mul d14~120@ c14~118@) (Mul b14~116@ c14~118@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%43@ tmp%44@ tmp%45@) (=> %%location_label%%14 (= temp_14_0~3069@ temp_14_1~3130@))))))))))))) (=> (= temp_14_0~3069@ temp_14_1~3130@) (=> (= temp_15_0~3319@ (Mul a15~122@ (Mul (Mul (Sub b15~124@ d15~128@) (Mul b15~124@ a15~122@)) (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~3356@ (Mul a15~122@ (Mul (Mul (Mul (Sub b15~124@ d15~128@) b15~124@) a15~122@) (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ d15~128@))))) (and (=> (= tmp%46@ (Sub b15~124@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%46@ b15~124@ a15~122@) (=> %%location_label%%15 (= temp_15_0~3319@ temp_15_1~3356@)))) (=> (= temp_15_0~3319@ temp_15_1~3356@) (=> (= temp_16_0~3455@ (Mul (Mul c16~134@ (Mul (Mul 10 b16~132@) (Mul c16~134@ b16~132@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ d16~136@) (Add d16~136@ c16~134@))))) (=> (= temp_16_1~3520@ (Mul (Mul c16~134@ (Mul 10 (Mul b16~132@ (Mul c16~134@ b16~132@)))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ d16~136@) (Add d16~136@ c16~134@))))) (and (=> (= tmp%47@ (Mul c16~134@ b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. 10 b16~132@ tmp%47@) (=> %%location_label%%16 (= temp_16_0~3455@ temp_16_1~3520@)))) (=> (= temp_16_0~3455@ temp_16_1~3520@) (=> (= temp_17_0~3623@ (Mul (Mul (Mul (Mul b17~140@ a17~138@) (Sub a17~138@ a17~138@)) (Mul (Mul b17~140@ b17~140@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ a17~138@) (Sub c17~142@ d17~144@))))) (=> (= temp_17_1~3688@ (Mul (Mul (Mul (Mul b17~140@ a17~138@) (Sub a17~138@ a17~138@)) (Mul b17~140@ (Mul b17~140@ (Mul b17~140@ d17~144@)))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ a17~138@) (Sub c17~142@ d17~144@))))) (=> (= tmp%48@ (Mul b17~140@ d17~144@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b17~140@ b17~140@ tmp%48@) (=> %%location_label%%17 (= temp_17_0~3623@ temp_17_1~3688@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
