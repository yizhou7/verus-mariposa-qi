...
(declare-const temp_1_1~458@ Int)
(declare-const temp_2_0~555@ Int)
(declare-const temp_2_1~616@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Sub (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) (Mul a0~2@ (Mul b0~4@ a0~2@))) a0~2@)) (=> (= temp_0_1~310@ (Sub (Mul (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) a0~2@) (Mul (Mul a0~2@ (Mul b0~4@ a0~2@)) a0~2@))) (and (=> (= tmp%1@ (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@))) (=> (= tmp%2@ (Mul a0~2@ (Mul b0~4@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ a0~2@) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~310@))))) (=> (= temp_0_0~273@ temp_0_1~310@) (=> (= temp_1_0~409@ (Add (Sub (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@))) (Mul c1~14@ (Add b1~12@ (Mul a1~10@ b1~12@))))) (=> (= temp_1_1~458@ (Add (Sub (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@))) (Mul c1~14@ (Add b1~12@ (Mul a1~10@ b1~12@))))) (and (=> (= tmp%3@ (Mul d1~16@ c1~14@)) (=> (= tmp%4@ (Mul b1~12@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~409@ temp_1_1~458@))))) (=> (= temp_1_0~409@ temp_1_1~458@) (=> (= temp_2_0~555@ (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ a2~18@) d2~24@)) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ c2~22@))))) (=> (= temp_2_1~616@ (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ a2~18@) d2~24@)) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ d2~24@) (=> (= tmp%5@ (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ a2~18@) d2~24@))) (=> (= tmp%6@ (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@))) (=> (= tmp%7@ (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> (= tmp%8@ (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ a2~18@) d2~24@))) (=> (= tmp%9@ (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@))) (=> (= tmp%10@ (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%2 (= temp_2_0~555@ temp_2_1~616@))))))))))) (=> (= temp_2_0~555@ temp_2_1~616@) (=> (= temp_3_0~821@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul d3~32@ (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~882@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ a3~26@) c3~30@)))) (=> (= tmp%11@ (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ c3~30@)))) (=> (= tmp%12@ (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ c3~30@))) (=> (= tmp%13@ (Mul (Mul d3~32@ a3~26@) c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> (ens%main!nl_basics.lemma_mul_is_associative. d3~32@ a3~26@ c3~30@) (=> (= tmp%14@ (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ c3~30@)))) (=> (= tmp%15@ (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ c3~30@))) (=> (= tmp%16@ (Mul d3~32@ (Mul a3~26@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%3 (= temp_3_0~821@ temp_3_1~882@))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
