...
(declare-const temp_3_1~905@ Int)
(declare-const temp_4_0~1034@ Int)
(declare-const temp_4_1~1111@ Int)
(declare-const temp_5_0~1220@ Int)
(declare-const temp_5_1~1297@ Int)
(declare-const temp_6_0~1389@ Int)
(declare-const temp_6_1~1466@ Int)
(declare-const temp_7_0~1555@ Int)
(declare-const temp_7_1~1604@ Int)
(declare-const temp_8_0~1697@ Int)
(declare-const temp_8_1~1762@ Int)
(declare-const temp_9_0~1875@ Int)
(declare-const temp_9_1~1952@ Int)
(declare-const temp_10_0~2097@ Int)
(declare-const temp_10_1~2154@ Int)
(declare-const temp_11_0~2269@ Int)
(declare-const temp_11_1~2338@ Int)
(declare-const temp_12_0~2559@ Int)
(declare-const temp_12_1~2632@ Int)
(declare-const temp_13_0~2855@ Int)
(declare-const temp_13_1~2920@ Int)
(declare-const temp_14_0~3067@ Int)
(declare-const temp_14_1~3132@ Int)
(declare-const temp_15_0~3231@ Int)
(declare-const temp_15_1~3296@ Int)
(declare-const temp_16_0~3381@ Int)
(declare-const temp_16_1~3438@ Int)
(declare-const temp_17_0~3547@ Int)
(declare-const temp_17_1~3608@ Int)
(declare-const temp_18_0~3721@ Int)
(declare-const temp_18_1~3802@ Int)
(declare-const temp_19_0~3917@ Int)
(declare-const temp_19_1~3982@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Add c0~6@ b0~4@))) (Sub (Mul (Mul b0~4@ c0~6@) (Sub d0~8@ d0~8@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~378@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ b0~4@)) (Add (Mul (Mul a0~2@ b0~4@) c0~6@) (Mul (Mul a0~2@ b0~4@) b0~4@))) (Sub (Mul (Mul b0~4@ c0~6@) (Sub d0~8@ d0~8@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))))) (and (=> (= tmp%1@ (Mul a0~2@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~378@)))) (=> (= temp_0_0~305@ temp_0_1~378@) (=> (= temp_1_0~493@ (Mul (Mul (Sub (Add b1~12@ a1~10@) (Mul c1~14@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul c1~14@ 99) (Mul c1~14@ a1~10@)) (Sub d1~16@ 43)))) (=> (= temp_1_1~574@ (Mul (Mul (Sub (Add b1~12@ a1~10@) (Mul c1~14@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ 99)) (Sub d1~16@ 43)))) (and (=> (= tmp%2@ (Mul c1~14@ a1~10@)) (=> (= tmp%3@ (Mul c1~14@ 99)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~493@ temp_1_1~574@))))) (=> (= temp_1_0~493@ temp_1_1~574@) (=> (= temp_2_0~679@ (Mul (Sub (Sub (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Add (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@))) (Sub (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ b2~20@))))) (=> (= temp_2_1~744@ (Mul (Sub (Sub (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Add (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@))) (Sub (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ b2~20@))))) (=> (= tmp%4@ (= temp_2_0~679@ temp_2_1~744@)) (and (=> %%location_label%%2 tmp%4@) (=> tmp%4@ (=> (= temp_3_0~832@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Add c3~30@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) 76) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~905@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Add c3~30@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul b3~28@ d3~32@) 76) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@))))) (and (=> (= tmp%5@ (Mul (Mul a3~26@ b3~28@) (Add c3~30@ c3~30@))) (=> (= tmp%6@ (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~832@ temp_3_1~905@))))) (=> (= temp_3_0~832@ temp_3_1~905@) (=> (= temp_4_0~1034@ (Mul (Add (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul 59 b4~36@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~1111@ (Mul (Add (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ 59)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ 59) (=> %%location_label%%4 (= temp_4_0~1034@ temp_4_1~1111@))) (=> (= temp_4_0~1034@ temp_4_1~1111@) (=> (= temp_5_0~1220@ (Mul (Sub (Mul (Mul c5~46@ 36) (Mul c5~46@ b5~44@)) (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ c5~46@))) (Mul (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1297@ (Mul (Sub (Mul (Mul c5~46@ 36) (Mul c5~46@ b5~44@)) (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ c5~46@))) (Mul (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ d5~48@))))) (=> (= tmp%7@ (= temp_5_0~1220@ temp_5_1~1297@)) (and (=> %%location_label%%5 tmp%7@) (=> tmp%7@ (=> (= temp_6_0~1389@ (Sub (Mul (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@))) (Mul (Add (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ 88) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1466@ (Sub (Mul (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@))) (Mul (Add (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ 88))))) (and (=> (= tmp%8@ (Mul d6~56@ d6~56@)) (=> (= tmp%9@ (Mul a6~50@ 88)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%6 (= temp_6_0~1389@ temp_6_1~1466@))))) (=> (= temp_6_0~1389@ temp_6_1~1466@) (=> (= temp_7_0~1555@ (Mul (Mul (Mul (Sub c7~62@ a7~58@) (Add a7~58@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ c7~62@))) (Mul a7~58@ (Mul d7~64@ (Mul b7~60@ d7~64@))))) (=> (= temp_7_1~1604@ (Mul (Mul (Mul (Sub c7~62@ a7~58@) (Add a7~58@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ c7~62@))) (Mul a7~58@ (Mul d7~64@ (Mul b7~60@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1555@ temp_7_1~1604@))) (=> (= temp_7_0~1555@ temp_7_1~1604@) (=> (= temp_8_0~1697@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ d8~72@))) (Mul (Mul (Add b8~68@ b8~68@) (Sub d8~72@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Sub d8~72@ c8~70@))))) (=> (= temp_8_1~1762@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ d8~72@))) (Mul (Mul (Sub d8~72@ a8~66@) (Add b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Sub d8~72@ c8~70@))))) (and (=> (= tmp%10@ (Sub d8~72@ a8~66@)) (=> (= tmp%11@ (Add b8~68@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~1697@ temp_8_1~1762@))))) (=> (= temp_8_0~1697@ temp_8_1~1762@) (=> (= temp_9_0~1875@ (Mul (Mul (Sub (Sub c9~78@ b9~76@) (Mul c9~78@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ 0)) (Sub (Mul c9~78@ c9~78@) (Mul a9~74@ d9~80@))))) (=> (= temp_9_1~1952@ (Mul (Mul (Sub (Sub c9~78@ b9~76@) (Mul c9~78@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ 0)) (Sub (Mul c9~78@ c9~78@) (Mul a9~74@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ b9~76@) (=> (= tmp%12@ (Sub (Sub c9~78@ b9~76@) (Mul c9~78@ c9~78@))) (=> (= tmp%13@ (Mul b9~76@ b9~76@)) (=> (= tmp%14@ (Mul d9~80@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> (= tmp%15@ (Sub (Sub c9~78@ b9~76@) (Mul c9~78@ c9~78@))) (=> (= tmp%16@ (Mul b9~76@ b9~76@)) (=> (= tmp%17@ (Mul b9~76@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%9 (= temp_9_0~1875@ temp_9_1~1952@))))))))))) (=> (= temp_9_0~1875@ temp_9_1~1952@) (=> (= temp_10_0~2097@ (Add (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ b10~84@) b10~84@)) (Sub (Mul c10~86@ (Mul a10~82@ c10~86@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~2154@ (Add (Mul (Mul a10~82@ b10~84@) (Mul (Mul d10~88@ d10~88@) (Mul (Mul b10~84@ b10~84@) b10~84@))) (Sub (Mul c10~86@ (Mul a10~82@ c10~86@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ c10~86@))))) (and (=> (= tmp%18@ (Mul a10~82@ b10~84@)) (=> (= tmp%19@ (Mul d10~88@ d10~88@)) (=> (= tmp%20@ (Mul (Mul b10~84@ b10~84@) b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%10 (= temp_10_0~2097@ temp_10_1~2154@)))))) (=> (= temp_10_0~2097@ temp_10_1~2154@) (=> (= temp_11_0~2269@ (Mul (Mul (Sub (Mul d11~96@ d11~96@) (Mul a11~90@ d11~96@)) (Mul c11~94@ (Mul d11~96@ a11~90@))) (Mul (Mul (Mul 50 a11~90@) (Mul b11~92@ c11~94@)) (Mul (Mul a11~90@ d11~96@) a11~90@)))) (=> (= temp_11_1~2338@ (Mul (Mul (Sub (Mul d11~96@ d11~96@) (Mul a11~90@ d11~96@)) (Mul c11~94@ (Mul d11~96@ a11~90@))) (Mul (Mul (Mul 50 a11~90@) (Mul b11~92@ c11~94@)) (Mul a11~90@ (Mul a11~90@ d11~96@))))) (and (=> (= tmp%21@ (Mul a11~90@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a11~90@ tmp%21@) (=> (= tmp%22@ (Mul (Sub (Mul d11~96@ d11~96@) (Mul a11~90@ d11~96@)) (Mul c11~94@ (Mul d11~96@ a11~90@)))) (=> (= tmp%23@ (Mul (Mul 50 a11~90@) (Mul b11~92@ c11~94@))) (=> (= tmp%24@ (Mul a11~90@ (Mul a11~90@ d11~96@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> (= tmp%25@ (Mul (Sub (Mul d11~96@ d11~96@) (Mul a11~90@ d11~96@)) (Mul c11~94@ (Mul d11~96@ a11~90@)))) (=> (= tmp%26@ (Mul (Mul 50 a11~90@) (Mul b11~92@ c11~94@))) (=> (= tmp%27@ (Mul (Mul a11~90@ d11~96@) a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%11 (= temp_11_0~2269@ temp_11_1~2338@)))))))))))) (=> (= temp_11_0~2269@ temp_11_1~2338@) (=> (= temp_12_0~2559@ (Mul (Mul (Mul b12~100@ (Sub b12~100@ d12~104@)) (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@))) (Mul (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ 12)) (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ c12~102@))))) (=> (= temp_12_1~2632@ (Mul (Mul (Mul b12~100@ (Sub b12~100@ d12~104@)) (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@))) (Mul (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ 12)) (Mul (Mul (Mul d12~104@ c12~102@) c12~102@) c12~102@)))) (and (=> (= tmp%28@ (Mul (Mul b12~100@ (Sub b12~100@ d12~104@)) (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@)))) (=> (= tmp%29@ (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ 12))) (=> (= tmp%30@ (Mul (Mul (Mul d12~104@ c12~102@) c12~102@) c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> (= tmp%31@ (Mul d12~104@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ c12~102@ c12~102@) (=> (= tmp%32@ (Mul (Mul b12~100@ (Sub b12~100@ d12~104@)) (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@)))) (=> (= tmp%33@ (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ 12))) (=> (= tmp%34@ (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ c12~102@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%12 (= temp_12_0~2559@ temp_12_1~2632@)))))))))))) (=> (= temp_12_0~2559@ temp_12_1~2632@) (=> (= temp_13_0~2855@ (Mul (Mul (Mul (Add a13~106@ c13~110@) (Mul d13~112@ a13~106@)) (Mul (Sub a13~106@ c13~110@) (Mul a13~106@ b13~108@))) (Mul (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Sub d13~112@ a13~106@) (Mul a13~106@ d13~112@))))) (=> (= temp_13_1~2920@ (Mul (Mul (Add a13~106@ c13~110@) (Mul d13~112@ a13~106@)) (Mul (Mul (Sub a13~106@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Sub d13~112@ a13~106@) (Mul a13~106@ d13~112@)))))) (and (=> (= tmp%35@ (Mul (Add a13~106@ c13~110@) (Mul d13~112@ a13~106@))) (=> (= tmp%36@ (Mul (Sub a13~106@ c13~110@) (Mul a13~106@ b13~108@))) (=> (= tmp%37@ (Mul (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Sub d13~112@ a13~106@) (Mul a13~106@ d13~112@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ tmp%36@ tmp%37@) (=> %%location_label%%13 (= temp_13_0~2855@ temp_13_1~2920@)))))) (=> (= temp_13_0~2855@ temp_13_1~2920@) (=> (= temp_14_0~3067@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul a14~114@ a14~114@)) (Mul (Add c14~118@ d14~120@) (Mul d14~120@ a14~114@))))) (=> (= temp_14_1~3132@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul (Mul d14~120@ d14~120@) a14~114@) a14~114@) (Mul (Add c14~118@ d14~120@) (Mul d14~120@ a14~114@))))) (and (=> (= tmp%38@ (Mul d14~120@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ a14~114@ a14~114@) (=> %%location_label%%14 (= temp_14_0~3067@ temp_14_1~3132@)))) (=> (= temp_14_0~3067@ temp_14_1~3132@) (=> (= temp_15_0~3231@ (Sub (Mul (Mul (Mul a15~122@ b15~124@) (Mul c15~126@ a15~122@)) (Mul (Mul d15~128@ c15~126@) (Mul a15~122@ b15~124@))) (Mul (Mul (Mul d15~128@ a15~122@) (Add c15~126@ c15~126@)) (Mul (Mul a15~122@ c15~126@) (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~3296@ (Sub (Mul (Mul (Mul a15~122@ b15~124@) (Mul c15~126@ a15~122@)) (Mul (Mul d15~128@ c15~126@) (Mul a15~122@ b15~124@))) (Mul (Mul (Mul d15~128@ a15~122@) (Add c15~126@ c15~126@)) (Mul (Mul c15~126@ a15~122@) (Mul a15~122@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c15~126@ a15~122@) (=> %%location_label%%15 (= temp_15_0~3231@ temp_15_1~3296@))) (=> (= temp_15_0~3231@ temp_15_1~3296@) (=> (= temp_16_0~3381@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Mul d16~136@ c16~134@)) (Mul (Mul d16~136@ b16~132@) c16~134@)) (Mul (Sub (Mul b16~132@ d16~136@) (Mul a16~130@ b16~132@)) (Mul (Mul d16~136@ c16~134@) a16~130@)))) (=> (= temp_16_1~3438@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) c16~134@) (Mul (Mul d16~136@ b16~132@) (Mul d16~136@ c16~134@))) (Mul (Sub (Mul b16~132@ d16~136@) (Mul a16~130@ b16~132@)) (Mul (Mul d16~136@ c16~134@) a16~130@)))) (and (=> (= tmp%39@ (Mul (Mul d16~136@ b16~132@) c16~134@)) (=> (= tmp%40@ (Mul (Mul d16~136@ b16~132@) (Mul d16~136@ c16~134@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%39@ tmp%40@) (=> %%location_label%%16 (= temp_16_0~3381@ temp_16_1~3438@))))) (=> (= temp_16_0~3381@ temp_16_1~3438@) (=> (= temp_17_0~3547@ (Mul (Mul (Add b17~140@ (Mul c17~142@ d17~144@)) (Mul (Mul d17~144@ a17~138@) (Sub c17~142@ c17~142@))) (Add (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)) (Mul (Mul d17~144@ a17~138@) (Mul d17~144@ d17~144@))))) (=> (= temp_17_1~3608@ (Mul (Mul (Mul (Mul d17~144@ a17~138@) (Sub c17~142@ c17~142@)) (Add b17~140@ (Mul c17~142@ d17~144@))) (Add (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)) (Mul (Mul d17~144@ a17~138@) (Mul d17~144@ d17~144@))))) (and (=> (= tmp%41@ (Mul (Mul d17~144@ a17~138@) (Sub c17~142@ c17~142@))) (=> (= tmp%42@ (Add b17~140@ (Mul c17~142@ d17~144@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%41@ tmp%42@) (=> %%location_label%%17 (= temp_17_0~3547@ temp_17_1~3608@))))) (=> (= temp_17_0~3547@ temp_17_1~3608@) (=> (= temp_18_0~3721@ (Mul (Mul (Mul (Mul d18~152@ a18~146@) (Add c18~150@ b18~148@)) (Add (Mul c18~150@ a18~146@) (Mul c18~150@ b18~148@))) (Mul (Mul (Mul c18~150@ a18~146@) (Mul c18~150@ b18~148@)) (Mul (Add b18~148@ d18~152@) (Mul d18~152@ c18~150@))))) (=> (= temp_18_1~3802@ (Mul (Add (Mul (Mul (Mul d18~152@ a18~146@) (Add c18~150@ b18~148@)) (Mul c18~150@ a18~146@)) (Mul (Mul (Mul d18~152@ a18~146@) (Add c18~150@ b18~148@)) (Mul c18~150@ b18~148@))) (Mul (Mul (Mul c18~150@ a18~146@) (Mul c18~150@ b18~148@)) (Mul (Add b18~148@ d18~152@) (Mul d18~152@ c18~150@))))) (and (=> (= tmp%43@ (Mul (Mul d18~152@ a18~146@) (Add c18~150@ b18~148@))) (=> (= tmp%44@ (Mul c18~150@ a18~146@)) (=> (= tmp%45@ (Mul c18~150@ b18~148@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%43@ tmp%44@ tmp%45@) (=> %%location_label%%18 (= temp_18_0~3721@ temp_18_1~3802@)))))) (=> (= temp_18_0~3721@ temp_18_1~3802@) (=> (= temp_19_0~3917@ (Sub (Mul (Mul (Add b19~156@ d19~160@) (Mul c19~158@ b19~156@)) (Mul (Mul c19~158@ c19~158@) (Mul b19~156@ d19~160@))) (Add (Mul (Add a19~154@ a19~154@) (Mul a19~154@ b19~156@)) (Mul (Mul c19~158@ b19~156@) (Mul c19~158@ c19~158@))))) (=> (= temp_19_1~3982@ (Sub (Mul (Mul (Mul c19~158@ b19~156@) (Add b19~156@ d19~160@)) (Mul (Mul c19~158@ c19~158@) (Mul b19~156@ d19~160@))) (Add (Mul (Add a19~154@ a19~154@) (Mul a19~154@ b19~156@)) (Mul (Mul c19~158@ b19~156@) (Mul c19~158@ c19~158@))))) (=> (= tmp%46@ (Mul c19~158@ b19~156@)) (=> (= tmp%47@ (Add b19~156@ d19~160@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%46@ tmp%47@) (=> %%location_label%%19 (= temp_19_0~3917@ temp_19_1~3982@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
