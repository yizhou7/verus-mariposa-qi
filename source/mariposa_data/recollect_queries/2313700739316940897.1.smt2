...
(declare-const temp_3_1~1102@ Int)
(declare-const temp_4_0~1191@ Int)
(declare-const temp_4_1~1268@ Int)
(declare-const temp_5_0~1379@ Int)
(declare-const temp_5_1~1444@ Int)
(declare-const temp_6_0~1524@ Int)
(declare-const temp_6_1~1589@ Int)
(declare-const temp_7_0~1714@ Int)
(declare-const temp_7_1~1799@ Int)
(declare-const temp_8_0~1948@ Int)
(declare-const temp_8_1~2001@ Int)
(declare-const temp_9_0~2100@ Int)
(declare-const temp_9_1~2161@ Int)
(declare-const temp_10_0~2252@ Int)
(declare-const temp_10_1~2309@ Int)
(declare-const temp_11_0~2398@ Int)
(declare-const temp_11_1~2459@ Int)
(declare-const temp_12_0~2598@ Int)
(declare-const temp_12_1~2687@ Int)
(declare-const temp_13_0~2788@ Int)
(declare-const temp_13_1~2849@ Int)
(declare-const temp_14_0~2992@ Int)
(declare-const temp_14_1~3057@ Int)
(declare-const temp_15_0~3146@ Int)
(declare-const temp_15_1~3203@ Int)
(declare-const temp_16_0~3310@ Int)
(declare-const temp_16_1~3387@ Int)
(declare-const temp_17_0~3480@ Int)
(declare-const temp_17_1~3545@ Int)
(declare-const temp_18_0~3646@ Int)
(declare-const temp_18_1~3711@ Int)
(declare-const temp_19_0~3806@ Int)
(declare-const temp_19_1~3867@ Int)
(declare-const temp_20_0~3976@ Int)
(declare-const temp_20_1~4053@ Int)
(declare-const temp_21_0~4146@ Int)
(declare-const temp_21_1~4215@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Sub (Add d0~8@ (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@))) (Mul (Sub (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~394@ (Sub (Mul (Add d0~8@ (Mul d0~8@ c0~6@)) (Mul (Sub (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@)) (Mul (Sub (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)))))) (and (=> (= tmp%1@ (Add d0~8@ (Mul d0~8@ c0~6@))) (=> (= tmp%2@ (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@))) (=> (= tmp%3@ (Mul (Sub (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~394@)))))) (=> (= temp_0_0~301@ temp_0_1~394@) (=> (= temp_1_0~537@ (Add (Mul (Add (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~602@ (Add (Mul (Add (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ d1~16@) (=> (= tmp%4@ (Mul b1~12@ d1~16@)) (=> (= tmp%5@ (Mul a1~10@ c1~14@)) (=> (= tmp%6@ (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> (= tmp%7@ (Mul d1~16@ b1~12@)) (=> (= tmp%8@ (Mul a1~10@ c1~14@)) (=> (= tmp%9@ (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%1 (= temp_1_0~537@ temp_1_1~602@))))))))))) (=> (= temp_1_0~537@ temp_1_1~602@) (=> (= temp_2_0~755@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))) (Mul (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@)) (Sub (Add a2~18@ b2~20@) (Sub b2~20@ a2~18@))))) (=> (= temp_2_1~820@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))) (Mul (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@)) (Sub (Add a2~18@ b2~20@) (Sub b2~20@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ c2~22@) (=> (= tmp%10@ (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ c2~22@))) (=> (= tmp%11@ (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))) (=> (= tmp%12@ (Mul (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@)) (Sub (Add a2~18@ b2~20@) (Sub b2~20@ a2~18@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> (= tmp%13@ (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ b2~20@))) (=> (= tmp%14@ (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))) (=> (= tmp%15@ (Mul (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@)) (Sub (Add a2~18@ b2~20@) (Sub b2~20@ a2~18@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%2 (= temp_2_0~755@ temp_2_1~820@))))))))))) (=> (= temp_2_0~755@ temp_2_1~820@) (=> (= temp_3_0~1037@ (Mul (Sub (Add (Mul d3~32@ a3~26@) (Add d3~32@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ c3~30@))) (Mul (Add (Mul a3~26@ a3~26@) (Mul c3~30@ b3~28@)) (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~1102@ (Mul (Sub (Add (Mul d3~32@ a3~26@) (Add d3~32@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ c3~30@))) (Mul (Add (Mul a3~26@ a3~26@) (Mul b3~28@ c3~30@)) (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ c3~30@) (=> %%location_label%%3 (= temp_3_0~1037@ temp_3_1~1102@))) (=> (= temp_3_0~1037@ temp_3_1~1102@) (=> (= temp_4_0~1191@ (Mul (Mul (Add d4~40@ (Sub c4~38@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ b4~36@))) (Mul (Sub (Add 12 a4~34@) (Mul c4~38@ d4~40@)) b4~36@))) (=> (= temp_4_1~1268@ (Mul (Add (Mul d4~40@ (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ b4~36@))) (Mul (Sub c4~38@ a4~34@) (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ b4~36@)))) (Mul (Sub (Add 12 a4~34@) (Mul c4~38@ d4~40@)) b4~36@))) (and (=> (= tmp%16@ (Sub c4~38@ a4~34@)) (=> (= tmp%17@ (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ b4~36@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d4~40@ tmp%16@ tmp%17@) (=> %%location_label%%4 (= temp_4_0~1191@ temp_4_1~1268@))))) (=> (= temp_4_0~1191@ temp_4_1~1268@) (=> (= temp_5_0~1379@ (Sub (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ c5~46@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1444@ (Sub (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ c5~46@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= tmp%18@ (= temp_5_0~1379@ temp_5_1~1444@)) (and (=> %%location_label%%5 tmp%18@) (=> tmp%18@ (=> (= temp_6_0~1524@ (Mul (Sub (Mul (Mul b6~52@ d6~56@) (Add c6~54@ d6~56@)) (Mul (Mul a6~50@ d6~56@) (Mul 98 a6~50@))) (Mul b6~52@ (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ d6~56@))))) (=> (= temp_6_1~1589@ (Mul (Sub (Mul (Mul b6~52@ d6~56@) (Add c6~54@ d6~56@)) (Mul (Mul 98 a6~50@) (Mul a6~50@ d6~56@))) (Mul b6~52@ (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ d6~56@))))) (and (=> (= tmp%19@ (Mul 98 a6~50@)) (=> (= tmp%20@ (Mul a6~50@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%6 (= temp_6_0~1524@ temp_6_1~1589@))))) (=> (= temp_6_0~1524@ temp_6_1~1589@) (=> (= temp_7_0~1714@ (Sub (Mul (Mul (Mul b7~60@ a7~58@) (Add b7~60@ a7~58@)) (Mul (Mul a7~58@ 35) b7~60@)) (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Sub a7~58@ 18) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1799@ (Sub (Mul (Mul (Mul b7~60@ a7~58@) (Add b7~60@ a7~58@)) (Mul (Mul a7~58@ 35) b7~60@)) (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Sub a7~58@ 18) (Mul d7~64@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ c7~62@) (=> (= tmp%21@ (Mul (Add c7~62@ b7~60@) (Mul b7~60@ b7~60@))) (=> (= tmp%22@ (Sub a7~58@ 18)) (=> (= tmp%23@ (Mul d7~64@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> (= tmp%24@ (Mul (Add c7~62@ b7~60@) (Mul b7~60@ b7~60@))) (=> (= tmp%25@ (Sub a7~58@ 18)) (=> (= tmp%26@ (Mul c7~62@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%7 (= temp_7_0~1714@ temp_7_1~1799@))))))))))) (=> (= temp_7_0~1714@ temp_7_1~1799@) (=> (= temp_8_0~1948@ (Mul (Mul a8~66@ (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ d8~72@) (Add d8~72@ c8~70@)) (Mul (Sub c8~70@ a8~66@) (Mul a8~66@ b8~68@))))) (=> (= temp_8_1~2001@ (Mul (Mul (Mul a8~66@ (Mul a8~66@ b8~68@)) (Mul c8~70@ d8~72@)) (Mul (Mul (Mul d8~72@ d8~72@) (Add d8~72@ c8~70@)) (Mul (Sub c8~70@ a8~66@) (Mul a8~66@ b8~68@))))) (and (=> (= tmp%27@ (Mul a8~66@ b8~68@)) (=> (= tmp%28@ (Mul c8~70@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a8~66@ tmp%27@ tmp%28@) (=> %%location_label%%8 (= temp_8_0~1948@ temp_8_1~2001@))))) (=> (= temp_8_0~1948@ temp_8_1~2001@) (=> (= temp_9_0~2100@ (Mul (Add (Mul (Mul b9~76@ a9~74@) (Sub a9~74@ b9~76@)) (Mul (Mul b9~76@ c9~78@) c9~78@)) (Mul (Add (Mul d9~80@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~2161@ (Mul (Add (Mul b9~76@ (Mul a9~74@ (Sub a9~74@ b9~76@))) (Mul (Mul b9~76@ c9~78@) c9~78@)) (Mul (Add (Mul d9~80@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ c9~78@))))) (and (=> (= tmp%29@ (Sub a9~74@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b9~76@ a9~74@ tmp%29@) (=> %%location_label%%9 (= temp_9_0~2100@ temp_9_1~2161@)))) (=> (= temp_9_0~2100@ temp_9_1~2161@) (=> (= temp_10_0~2252@ (Mul (Mul (Mul c10~86@ (Mul b10~84@ c10~86@)) (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ a10~82@))) (Mul (Sub (Mul b10~84@ d10~88@) a10~82@) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~2309@ (Mul (Mul (Mul c10~86@ (Mul b10~84@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Mul a10~82@ a10~82@))) (Mul (Sub (Mul b10~84@ d10~88@) a10~82@) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b10~84@ c10~86@) (=> %%location_label%%10 (= temp_10_0~2252@ temp_10_1~2309@))) (=> (= temp_10_0~2252@ temp_10_1~2309@) (=> (= temp_11_0~2398@ (Mul (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ c11~94@) c11~94@)) (Mul (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ a11~90@)) (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ a11~90@))))) (=> (= temp_11_1~2459@ (Mul (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ c11~94@) c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul (Mul c11~94@ a11~90@) (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ a11~90@)))))) (and (=> (= tmp%30@ (Mul a11~90@ d11~96@)) (=> (= tmp%31@ (Mul c11~94@ a11~90@)) (=> (= tmp%32@ (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ a11~90@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%30@ tmp%31@ tmp%32@) (=> %%location_label%%11 (= temp_11_0~2398@ temp_11_1~2459@)))))) (=> (= temp_11_0~2398@ temp_11_1~2459@) (=> (= temp_12_0~2598@ (Add (Sub (Mul (Mul c12~102@ d12~104@) (Mul 57 b12~100@)) (Mul (Add d12~104@ a12~98@) (Mul b12~100@ 95))) (Mul (Sub (Mul c12~102@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul b12~100@ c12~102@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2687@ (Add (Sub (Mul (Mul c12~102@ d12~104@) (Mul 57 b12~100@)) (Mul (Mul b12~100@ 95) (Add d12~104@ a12~98@))) (Mul (Sub (Mul c12~102@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul b12~100@ c12~102@) (Mul a12~98@ c12~102@))))) (and (=> (= tmp%33@ (Mul b12~100@ 95)) (=> (= tmp%34@ (Add d12~104@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%33@ tmp%34@) (=> %%location_label%%12 (= temp_12_0~2598@ temp_12_1~2687@))))) (=> (= temp_12_0~2598@ temp_12_1~2687@) (=> (= temp_13_0~2788@ (Mul (Mul (Sub a13~106@ (Mul b13~108@ b13~108@)) (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ b13~108@))) (Mul (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ b13~108@) (Mul a13~106@ a13~106@))))) (=> (= temp_13_1~2849@ (Mul (Sub a13~106@ (Mul b13~108@ b13~108@)) (Mul (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ b13~108@)) (Mul (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ b13~108@) (Mul a13~106@ a13~106@)))))) (and (=> (= tmp%35@ (Sub a13~106@ (Mul b13~108@ b13~108@))) (=> (= tmp%36@ (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ b13~108@))) (=> (= tmp%37@ (Mul (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ b13~108@) (Mul a13~106@ a13~106@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ tmp%36@ tmp%37@) (=> %%location_label%%13 (= temp_13_0~2788@ temp_13_1~2849@)))))) (=> (= temp_13_0~2788@ temp_13_1~2849@) (=> (= temp_14_0~2992@ (Mul (Mul (Mul (Mul b14~116@ c14~118@) (Mul a14~114@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul d14~120@ d14~120@))) (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ d14~120@)) (Sub (Sub b14~116@ c14~118@) (Add d14~120@ a14~114@))))) (=> (= temp_14_1~3057@ (Mul (Mul (Mul (Mul b14~116@ c14~118@) (Mul a14~114@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul d14~120@ d14~120@))) (Mul (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ b14~116@)) (Sub (Sub b14~116@ c14~118@) (Add d14~120@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2992@ temp_14_1~3057@))) (=> (= temp_14_0~2992@ temp_14_1~3057@) (=> (= temp_15_0~3146@ (Sub (Mul (Add (Sub a15~122@ a15~122@) (Mul a15~122@ d15~128@)) (Mul (Add c15~126@ b15~124@) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul b15~124@ b15~124@) d15~128@) (Add (Mul a15~122@ d15~128@) (Mul b15~124@ d15~128@))))) (=> (= temp_15_1~3203@ (Sub (Mul (Add (Sub a15~122@ a15~122@) (Mul a15~122@ d15~128@)) (Mul (Add c15~126@ b15~124@) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul b15~124@ b15~124@) d15~128@) (Mul (Add a15~122@ b15~124@) d15~128@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. a15~122@ b15~124@ d15~128@) (=> %%location_label%%15 (= temp_15_0~3146@ temp_15_1~3203@))) (=> (= temp_15_0~3146@ temp_15_1~3203@) (=> (= temp_16_0~3310@ (Add (Sub (Mul (Mul a16~130@ a16~130@) (Mul 51 b16~132@)) (Sub (Add a16~130@ d16~136@) (Mul a16~130@ a16~130@))) (Mul (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ d16~136@)) (Sub (Mul d16~136@ b16~132@) (Mul b16~132@ b16~132@))))) (=> (= temp_16_1~3387@ (Add (Sub (Mul (Mul a16~130@ a16~130@) (Mul 51 b16~132@)) (Sub (Add a16~130@ d16~136@) (Mul a16~130@ a16~130@))) (Mul (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ d16~136@)) (Sub (Mul b16~132@ d16~136@) (Mul b16~132@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b16~132@ d16~136@) (=> %%location_label%%16 (= temp_16_0~3310@ temp_16_1~3387@))) (=> (= temp_16_0~3310@ temp_16_1~3387@) (=> (= temp_17_0~3480@ (Mul (Add (Mul (Mul c17~142@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ a17~138@))) (Sub (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@)) (Mul (Mul c17~142@ a17~138@) (Mul b17~140@ c17~142@))))) (=> (= temp_17_1~3545@ (Mul (Add (Mul (Mul c17~142@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ a17~138@))) (Sub (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ c17~142@)) (Mul (Mul c17~142@ a17~138@) (Mul b17~140@ c17~142@))))) (and (=> (= tmp%38@ (Mul b17~140@ a17~138@)) (=> (= tmp%39@ (Mul d17~144@ c17~142@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%38@ tmp%39@) (=> %%location_label%%17 (= temp_17_0~3480@ temp_17_1~3545@))))) (=> (= temp_17_0~3480@ temp_17_1~3545@) (=> (= temp_18_0~3646@ (Mul (Add (Add (Add c18~150@ a18~146@) (Mul c18~150@ d18~152@)) (Mul (Mul d18~152@ d18~152@) (Mul c18~150@ b18~148@))) (Mul (Mul (Mul b18~148@ c18~150@) (Mul b18~148@ b18~148@)) (Mul (Mul d18~152@ a18~146@) (Mul a18~146@ b18~148@))))) (=> (= temp_18_1~3711@ (Mul (Add (Add (Add c18~150@ a18~146@) (Mul c18~150@ d18~152@)) (Mul (Mul (Mul d18~152@ d18~152@) c18~150@) b18~148@)) (Mul (Mul (Mul b18~148@ c18~150@) (Mul b18~148@ b18~148@)) (Mul (Mul d18~152@ a18~146@) (Mul a18~146@ b18~148@))))) (and (=> (= tmp%40@ (Mul d18~152@ d18~152@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ c18~150@ b18~148@) (=> %%location_label%%18 (= temp_18_0~3646@ temp_18_1~3711@)))) (=> (= temp_18_0~3646@ temp_18_1~3711@) (=> (= temp_19_0~3806@ (Mul (Mul (Mul (Sub b19~156@ b19~156@) (Mul a19~154@ c19~158@)) (Mul (Mul a19~154@ b19~156@) (Mul b19~156@ a19~154@))) (Mul (Mul (Mul a19~154@ c19~158@) a19~154@) (Sub (Add d19~160@ d19~160@) (Add a19~154@ b19~156@))))) (=> (= temp_19_1~3867@ (Mul (Mul (Mul (Sub b19~156@ b19~156@) (Mul a19~154@ c19~158@)) (Mul (Mul a19~154@ b19~156@) (Mul b19~156@ a19~154@))) (Mul (Mul a19~154@ (Mul a19~154@ c19~158@)) (Sub (Add d19~160@ d19~160@) (Add a19~154@ b19~156@))))) (and (=> (= tmp%41@ (Mul a19~154@ c19~158@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a19~154@ tmp%41@) (=> %%location_label%%19 (= temp_19_0~3806@ temp_19_1~3867@)))) (=> (= temp_19_0~3806@ temp_19_1~3867@) (=> (= temp_20_0~3976@ (Mul (Mul (Mul (Mul d20~168@ b20~164@) (Add d20~168@ b20~164@)) (Mul (Mul b20~164@ d20~168@) (Mul c20~166@ c20~166@))) (Mul (Mul (Add d20~168@ d20~168@) (Mul 14 d20~168@)) (Mul (Mul d20~168@ a20~162@) (Mul c20~166@ b20~164@))))) (=> (= temp_20_1~4053@ (Mul (Mul (Mul (Mul d20~168@ b20~164@) (Add d20~168@ b20~164@)) (Mul (Mul b20~164@ d20~168@) (Mul c20~166@ c20~166@))) (Mul (Mul (Add d20~168@ d20~168@) (Mul d20~168@ 14)) (Mul (Mul d20~168@ a20~162@) (Mul c20~166@ b20~164@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d20~168@ 14) (=> %%location_label%%20 (= temp_20_0~3976@ temp_20_1~4053@))) (=> (= temp_20_0~3976@ temp_20_1~4053@) (=> (= temp_21_0~4146@ (Add (Mul (Mul (Mul b21~172@ a21~170@) (Mul d21~176@ b21~172@)) (Mul c21~174@ (Mul a21~170@ c21~174@))) (Mul (Mul (Mul b21~172@ d21~176@) (Sub b21~172@ b21~172@)) (Mul (Mul d21~176@ a21~170@) (Mul d21~176@ c21~174@))))) (=> (= temp_21_1~4215@ (Add (Mul (Mul (Mul b21~172@ a21~170@) (Mul d21~176@ b21~172@)) (Mul c21~174@ (Mul a21~170@ c21~174@))) (Mul (Sub (Mul (Mul b21~172@ d21~176@) b21~172@) (Mul (Mul b21~172@ d21~176@) b21~172@)) (Mul (Mul d21~176@ a21~170@) (Mul d21~176@ c21~174@))))) (=> (= tmp%42@ (Mul b21~172@ d21~176@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%42@ b21~172@ b21~172@) (=> %%location_label%%21 (= temp_21_0~4146@ temp_21_1~4215@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
