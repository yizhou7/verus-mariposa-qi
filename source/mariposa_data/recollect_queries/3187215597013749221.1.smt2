...
(declare-const temp_4_0~1069@ Int)
(declare-const temp_4_1~1130@ Int)
(declare-const temp_5_0~1257@ Int)
(declare-const temp_5_1~1362@ Int)
(declare-const temp_6_0~1505@ Int)
(declare-const temp_6_1~1594@ Int)
(declare-const temp_7_0~1675@ Int)
(declare-const temp_7_1~1728@ Int)
(declare-const temp_8_0~1829@ Int)
(declare-const temp_8_1~1902@ Int)
(declare-const temp_9_0~2007@ Int)
(declare-const temp_9_1~2072@ Int)
(declare-const temp_10_0~2167@ Int)
(declare-const temp_10_1~2228@ Int)
(declare-const temp_11_0~2333@ Int)
...
(declare-const temp_13_1~2950@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) c0~6@) (Add (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@))) (Mul (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Sub d0~8@ d0~8@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Mul (Add (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ c0~6@) c0~6@)) (Mul (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Sub d0~8@ d0~8@) (Mul a0~2@ c0~6@))))) (and (=> (= tmp%1@ (Add (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@))) (=> (= tmp%2@ (Mul (Mul d0~8@ c0~6@) c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~471@ (Mul (Add (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ c1~14@) a1~10@)) (Mul (Mul (Add b1~12@ b1~12@) (Sub b1~12@ a1~10@)) (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~532@ (Mul (Add (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ c1~14@) a1~10@)) (Mul (Mul (Add b1~12@ b1~12@) (Sub b1~12@ a1~10@)) (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ a1~10@))))) (and (=> (= tmp%3@ (Mul d1~16@ b1~12@)) (=> (= tmp%4@ (Mul a1~10@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~471@ temp_1_1~532@))))) (=> (= temp_1_0~471@ temp_1_1~532@) (=> (= temp_2_0~637@ (Mul (Mul (Mul (Sub c2~22@ 34) (Mul d2~24@ a2~18@)) (Sub (Sub a2~18@ c2~22@) (Mul a2~18@ a2~18@))) (Mul (Add b2~20@ (Mul a2~18@ b2~20@)) (Add (Mul b2~20@ a2~18@) b2~20@)))) (=> (= temp_2_1~706@ (Mul (Mul (Mul (Sub c2~22@ 34) (Mul a2~18@ d2~24@)) (Sub (Sub a2~18@ c2~22@) (Mul a2~18@ a2~18@))) (Mul (Add b2~20@ (Mul a2~18@ b2~20@)) (Add (Mul b2~20@ a2~18@) b2~20@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ d2~24@) (=> (= tmp%5@ (Mul (Sub c2~22@ 34) (Mul a2~18@ d2~24@))) (=> (= tmp%6@ (Sub (Sub a2~18@ c2~22@) (Mul a2~18@ a2~18@))) (=> (= tmp%7@ (Mul (Add b2~20@ (Mul a2~18@ b2~20@)) (Add (Mul b2~20@ a2~18@) b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> (= tmp%8@ (Mul (Sub c2~22@ 34) (Mul d2~24@ a2~18@))) (=> (= tmp%9@ (Sub (Sub a2~18@ c2~22@) (Mul a2~18@ a2~18@))) (=> (= tmp%10@ (Mul (Add b2~20@ (Mul a2~18@ b2~20@)) (Add (Mul b2~20@ a2~18@) b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%2 (= temp_2_0~637@ temp_2_1~706@))))))))))) (=> (= temp_2_0~637@ temp_2_1~706@) (=> (= temp_3_0~915@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@)) (Add (Mul b3~28@ c3~30@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~980@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@)) (Add (Mul b3~28@ c3~30@) (Mul b3~28@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ a3~26@) (=> %%location_label%%3 (= temp_3_0~915@ temp_3_1~980@))) (=> (= temp_3_0~915@ temp_3_1~980@) (=> (= temp_4_0~1069@ (Add (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Add c4~38@ b4~36@) c4~38@)) (Mul (Mul (Add d4~40@ c4~38@) (Add a4~34@ d4~40@)) (Mul (Mul d4~40@ c4~38@) (Add c4~38@ d4~40@))))) (=> (= temp_4_1~1130@ (Add (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Add c4~38@ b4~36@) c4~38@)) (Mul (Mul (Mul (Add d4~40@ c4~38@) (Add a4~34@ d4~40@)) (Mul d4~40@ c4~38@)) (Add c4~38@ d4~40@)))) (and (=> (= tmp%11@ (Mul (Add d4~40@ c4~38@) (Add a4~34@ d4~40@))) (=> (= tmp%12@ (Mul d4~40@ c4~38@)) (=> (= tmp%13@ (Add c4~38@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%4 (= temp_4_0~1069@ temp_4_1~1130@)))))) (=> (= temp_4_0~1069@ temp_4_1~1130@) (=> (= temp_5_0~1257@ (Sub (Sub (Mul (Add c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Add (Sub c5~46@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Add (Add c5~46@ a5~42@) (Mul b5~44@ b5~44@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ 38))))) (=> (= temp_5_1~1362@ (Sub (Sub (Mul (Add c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Add (Sub c5~46@ d5~48@) (Mul c5~46@ a5~42@))) (Add (Mul (Add c5~46@ a5~42@) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ 38))) (Mul (Mul b5~44@ b5~44@) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ 38)))))) (and (=> (= tmp%14@ (Add c5~46@ a5~42@)) (=> (= tmp%15@ (Mul b5~44@ b5~44@)) (=> (= tmp%16@ (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ 38))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%5 (= temp_5_0~1257@ temp_5_1~1362@)))))) (=> (= temp_5_0~1257@ temp_5_1~1362@) (=> (= temp_6_0~1505@ (Add (Mul (Mul (Mul a6~50@ 12) (Mul c6~54@ b6~52@)) (Sub (Add 23 b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@)) (Add (Mul a6~50@ d6~56@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1594@ (Add (Mul (Mul (Mul a6~50@ 12) (Mul c6~54@ b6~52@)) (Sub (Add 23 b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@)) (Add (Mul a6~50@ d6~56@) (Mul b6~52@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b6~52@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1505@ temp_6_1~1594@))) (=> (= temp_6_0~1505@ temp_6_1~1594@) (=> (= temp_7_0~1675@ (Sub (Sub (Add (Mul b7~60@ b7~60@) (Mul b7~60@ b7~60@)) (Add (Mul a7~58@ a7~58@) (Mul d7~64@ c7~62@))) (Mul c7~62@ (Sub (Add a7~58@ b7~60@) (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1728@ (Sub (Sub (Add (Mul b7~60@ b7~60@) (Mul b7~60@ b7~60@)) (Add (Mul a7~58@ a7~58@) (Mul c7~62@ d7~64@))) (Mul c7~62@ (Sub (Add a7~58@ b7~60@) (Mul a7~58@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1675@ temp_7_1~1728@))) (=> (= temp_7_0~1675@ temp_7_1~1728@) (=> (= temp_8_0~1829@ (Mul (Mul (Add (Mul c8~70@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Mul 67 c8~70@))) (Mul (Sub a8~66@ (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1902@ (Mul (Mul (Add (Mul c8~70@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul 67 c8~70@) (Mul d8~72@ d8~72@))) (Mul (Sub a8~66@ (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ a8~66@))))) (and (=> (= tmp%17@ (Mul 67 c8~70@)) (=> (= tmp%18@ (Mul d8~72@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%8 (= temp_8_0~1829@ temp_8_1~1902@))))) (=> (= temp_8_0~1829@ temp_8_1~1902@) (=> (= temp_9_0~2007@ (Sub (Mul (Mul (Mul a9~74@ b9~76@) (Add b9~76@ d9~80@)) (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@))) (Mul (Mul (Add c9~78@ c9~78@) (Mul b9~76@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~2072@ (Sub (Mul (Mul (Mul a9~74@ b9~76@) (Add b9~76@ d9~80@)) (Mul c9~78@ (Mul b9~76@ (Mul a9~74@ b9~76@)))) (Mul (Mul (Add c9~78@ c9~78@) (Mul b9~76@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ d9~80@))))) (and (=> (= tmp%19@ (Mul a9~74@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c9~78@ b9~76@ tmp%19@) (=> %%location_label%%9 (= temp_9_0~2007@ temp_9_1~2072@)))) (=> (= temp_9_0~2007@ temp_9_1~2072@) (=> (= temp_10_0~2167@ (Sub (Mul (Mul d10~88@ (Mul d10~88@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@))) (Add (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))))) (=> (= temp_10_1~2228@ (Sub (Mul (Mul (Mul d10~88@ b10~84@) d10~88@) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@))) (Add (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))))) (and (=> (= tmp%20@ (Mul d10~88@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ d10~88@) (=> %%location_label%%10 (= temp_10_0~2167@ temp_10_1~2228@)))) (=> (= temp_10_0~2167@ temp_10_1~2228@) (=> (= temp_11_0~2333@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Sub d11~96@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ 72)) (Mul (Mul c11~94@ d11~96@) d11~96@)))) (=> (= temp_11_1~2406@ (Mul (Mul (Mul d11~96@ (Mul c11~94@ (Sub d11~96@ b11~92@))) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ 72)) (Mul (Mul c11~94@ d11~96@) d11~96@)))) (and (=> (= tmp%21@ (Sub d11~96@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d11~96@ c11~94@ tmp%21@) (=> (= tmp%22@ (Mul d11~96@ (Mul c11~94@ (Sub d11~96@ b11~92@)))) (=> (= tmp%23@ (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ d11~96@))) (=> (= tmp%24@ (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ 72)) (Mul (Mul c11~94@ d11~96@) d11~96@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> (= tmp%25@ (Mul (Mul d11~96@ c11~94@) (Sub d11~96@ b11~92@))) (=> (= tmp%26@ (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ d11~96@))) (=> (= tmp%27@ (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ 72)) (Mul (Mul c11~94@ d11~96@) d11~96@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%11 (= temp_11_0~2333@ temp_11_1~2406@)))))))))))) (=> (= temp_11_0~2333@ temp_11_1~2406@) (=> (= temp_12_0~2637@ (Mul (Mul (Add (Mul a12~98@ b12~100@) (Sub c12~102@ d12~104@)) (Mul (Mul a12~98@ 23) (Sub c12~102@ c12~102@))) (Add (Mul (Sub b12~100@ a12~98@) a12~98@) (Mul (Mul c12~102@ a12~98@) (Mul c12~102@ b12~100@))))) (=> (= temp_12_1~2754@ (Add (Mul (Mul (Add (Mul a12~98@ b12~100@) (Sub c12~102@ d12~104@)) (Mul (Mul a12~98@ 23) (Sub c12~102@ c12~102@))) (Mul (Sub b12~100@ a12~98@) a12~98@)) (Mul (Mul (Add (Mul a12~98@ b12~100@) (Sub c12~102@ d12~104@)) (Mul (Mul a12~98@ 23) (Sub c12~102@ c12~102@))) (Mul (Mul c12~102@ a12~98@) (Mul c12~102@ b12~100@))))) (and (=> (= tmp%28@ (Mul (Add (Mul a12~98@ b12~100@) (Sub c12~102@ d12~104@)) (Mul (Mul a12~98@ 23) (Sub c12~102@ c12~102@)))) (=> (= tmp%29@ (Mul (Sub b12~100@ a12~98@) a12~98@)) (=> (= tmp%30@ (Mul (Mul c12~102@ a12~98@) (Mul c12~102@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%12 (= temp_12_0~2637@ temp_12_1~2754@)))))) (=> (= temp_12_0~2637@ temp_12_1~2754@) (=> (= temp_13_0~2893@ (Mul (Sub (Mul (Add a13~106@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Mul d13~112@ b13~108@) d13~112@)) (Mul (Mul a13~106@ (Mul d13~112@ b13~108@)) (Mul (Mul b13~108@ c13~110@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2950@ (Mul (Sub (Mul (Add a13~106@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Mul d13~112@ b13~108@) d13~112@)) (Mul (Mul (Mul a13~106@ d13~112@) b13~108@) (Mul (Mul b13~108@ c13~110@) (Mul c13~110@ d13~112@))))) (=> (ens%main!nl_basics.lemma_mul_is_associative. a13~106@ d13~112@ b13~108@) (=> %%location_label%%13 (= temp_13_0~2893@ temp_13_1~2950@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
