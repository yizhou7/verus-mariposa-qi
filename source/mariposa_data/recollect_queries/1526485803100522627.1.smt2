...
(declare-const temp_1_0~509@ Int)
(declare-const temp_1_1~550@ Int)
(declare-const temp_2_0~671@ Int)
(declare-const temp_2_1~732@ Int)
(declare-const temp_3_0~901@ Int)
(declare-const temp_3_1~990@ Int)
(declare-const temp_4_0~1131@ Int)
(declare-const temp_4_1~1176@ Int)
(declare-const temp_5_0~1345@ Int)
(declare-const temp_5_1~1418@ Int)
(declare-const temp_6_0~1498@ Int)
(declare-const temp_6_1~1563@ Int)
(declare-const temp_7_0~1740@ Int)
(declare-const temp_7_1~1829@ Int)
(declare-const temp_8_0~1936@ Int)
(declare-const temp_8_1~2001@ Int)
(declare-const temp_9_0~2112@ Int)
(declare-const temp_9_1~2173@ Int)
(declare-const temp_10_0~2300@ Int)
(declare-const temp_10_1~2409@ Int)
(declare-const temp_11_0~2556@ Int)
(declare-const temp_11_1~2617@ Int)
(declare-const temp_12_0~2826@ Int)
(declare-const temp_12_1~2891@ Int)
(declare-const temp_13_0~2998@ Int)
(declare-const temp_13_1~3071@ Int)
(declare-const temp_14_0~3170@ Int)
(declare-const temp_14_1~3235@ Int)
(declare-const temp_15_0~3304@ Int)
(declare-const temp_15_1~3337@ Int)
(declare-const temp_16_0~3452@ Int)
(declare-const temp_16_1~3517@ Int)
(declare-const temp_17_0~3618@ Int)
(declare-const temp_17_1~3683@ Int)
(declare-const temp_18_0~3790@ Int)
(declare-const temp_18_1~3863@ Int)
(declare-const temp_19_0~3962@ Int)
(declare-const temp_19_1~4015@ Int)
(declare-const temp_20_0~4150@ Int)
(declare-const temp_20_1~4215@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ c0~6@))) (Mul (Mul d0~8@ (Mul b0~4@ c0~6@)) (Mul (Mul 81 a0~2@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~386@ (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ c0~6@)) (Mul (Mul d0~8@ (Mul b0~4@ c0~6@)) (Mul (Mul 81 a0~2@) (Mul a0~2@ c0~6@)))))) (and (=> (= tmp%1@ (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ c0~6@))) (=> (= tmp%2@ (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ c0~6@))) (=> (= tmp%3@ (Mul (Mul d0~8@ (Mul b0~4@ c0~6@)) (Mul (Mul 81 a0~2@) (Mul a0~2@ c0~6@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~386@)))))) (=> (= temp_0_0~313@ temp_0_1~386@) (=> (= temp_1_0~509@ (Mul (Mul c1~14@ (Mul b1~12@ (Mul a1~10@ a1~10@))) (Mul (Sub d1~16@ (Mul a1~10@ d1~16@)) (Mul a1~10@ (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~550@ (Mul (Mul (Sub d1~16@ (Mul a1~10@ d1~16@)) (Mul a1~10@ (Mul c1~14@ a1~10@))) (Mul c1~14@ (Mul b1~12@ (Mul a1~10@ a1~10@))))) (and (=> (= tmp%4@ (Mul (Sub d1~16@ (Mul a1~10@ d1~16@)) (Mul a1~10@ (Mul c1~14@ a1~10@)))) (=> (= tmp%5@ (Mul c1~14@ (Mul b1~12@ (Mul a1~10@ a1~10@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~509@ temp_1_1~550@))))) (=> (= temp_1_0~509@ temp_1_1~550@) (=> (= temp_2_0~671@ (Mul (Mul (Mul (Sub a2~18@ d2~24@) (Sub c2~22@ c2~22@)) (Mul c2~22@ (Add d2~24@ b2~20@))) (Mul (Mul (Mul d2~24@ a2~18@) (Add a2~18@ c2~22@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~732@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Add a2~18@ c2~22@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul (Sub a2~18@ d2~24@) (Sub c2~22@ c2~22@)) (Mul c2~22@ (Add d2~24@ b2~20@))))) (and (=> (= tmp%6@ (Mul (Mul (Mul d2~24@ a2~18@) (Add a2~18@ c2~22@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@)))) (=> (= tmp%7@ (Mul (Mul (Sub a2~18@ d2~24@) (Sub c2~22@ c2~22@)) (Mul c2~22@ (Add d2~24@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~671@ temp_2_1~732@))))) (=> (= temp_2_0~671@ temp_2_1~732@) (=> (= temp_3_0~901@ (Sub (Mul (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Sub c3~30@ b3~28@) (Mul a3~26@ 50))) (Mul (Mul (Mul b3~28@ b3~28@) (Mul 81 d3~32@)) (Mul (Sub c3~30@ a3~26@) (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~990@ (Sub (Mul (Mul (Mul b3~28@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Sub c3~30@ b3~28@) (Mul a3~26@ 50))) (Mul (Mul (Mul b3~28@ b3~28@) (Mul 81 d3~32@)) (Mul (Sub c3~30@ a3~26@) (Mul c3~30@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ d3~32@) (=> (= tmp%8@ (Mul b3~28@ d3~32@)) (=> (= tmp%9@ (Mul d3~32@ b3~28@)) (=> (= tmp%10@ (Mul (Sub c3~30@ b3~28@) (Mul a3~26@ 50))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> (= tmp%11@ (Mul d3~32@ b3~28@)) (=> (= tmp%12@ (Mul d3~32@ b3~28@)) (=> (= tmp%13@ (Mul (Sub c3~30@ b3~28@) (Mul a3~26@ 50))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%3 (= temp_3_0~901@ temp_3_1~990@))))))))))) (=> (= temp_3_0~901@ temp_3_1~990@) (=> (= temp_4_0~1131@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) 91) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ a4~34@))) a4~34@)) (=> (= temp_4_1~1176@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) 91) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ a4~34@))) a4~34@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c4~38@ b4~36@) (=> (= tmp%14@ (Mul (Mul c4~38@ b4~36@) 91)) (=> (= tmp%15@ (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ a4~34@) (=> (= tmp%16@ (Mul (Mul b4~36@ c4~38@) 91)) (=> (= tmp%17@ (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ a4~34@) (=> %%location_label%%4 (= temp_4_0~1131@ temp_4_1~1176@))))))))) (=> (= temp_4_0~1131@ temp_4_1~1176@) (=> (= temp_5_0~1345@ (Mul (Mul (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul 67 b5~44@) (Mul a5~42@ c5~46@)) (Add (Sub a5~42@ a5~42@) a5~42@)))) (=> (= temp_5_1~1418@ (Mul (Mul (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul 67 b5~44@) (Mul a5~42@ c5~46@)) (Add (Sub a5~42@ a5~42@) a5~42@)))) (=> (= tmp%18@ (= temp_5_0~1345@ temp_5_1~1418@)) (and (=> %%location_label%%5 tmp%18@) (=> tmp%18@ (=> (= temp_6_0~1498@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Add b6~52@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1563@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Add b6~52@ b6~52@) (Mul c6~54@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b6~52@ d6~56@) (=> (= tmp%19@ (Mul d6~56@ b6~52@)) (=> (= tmp%20@ (Mul c6~54@ c6~54@)) (=> (= tmp%21@ (Mul (Add b6~52@ b6~52@) (Mul c6~54@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> (= tmp%22@ (Mul b6~52@ d6~56@)) (=> (= tmp%23@ (Mul c6~54@ c6~54@)) (=> (= tmp%24@ (Mul (Add b6~52@ b6~52@) (Mul c6~54@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%6 (= temp_6_0~1498@ temp_6_1~1563@))))))))))) (=> (= temp_6_0~1498@ temp_6_1~1563@) (=> (= temp_7_0~1740@ (Add (Mul (Mul (Mul 46 b7~60@) (Sub 60 c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@))) (Mul (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1829@ (Add (Mul (Mul 46 (Mul b7~60@ (Sub 60 c7~62@))) (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@))) (Mul (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@))))) (and (=> (= tmp%25@ (Sub 60 c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. 46 b7~60@ tmp%25@) (=> %%location_label%%7 (= temp_7_0~1740@ temp_7_1~1829@)))) (=> (= temp_7_0~1740@ temp_7_1~1829@) (=> (= temp_8_0~1936@ (Mul (Sub (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ a8~66@)) (Add (Mul b8~68@ b8~68@) (Mul b8~68@ b8~68@))) (Mul (Mul (Add c8~70@ c8~70@) (Sub a8~66@ b8~68@)) (Add (Mul c8~70@ a8~66@) (Sub c8~70@ d8~72@))))) (=> (= temp_8_1~2001@ (Mul (Sub (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ a8~66@)) (Add (Mul b8~68@ b8~68@) (Mul b8~68@ b8~68@))) (Mul (Add c8~70@ c8~70@) (Mul (Sub a8~66@ b8~68@) (Add (Mul c8~70@ a8~66@) (Sub c8~70@ d8~72@)))))) (and (=> (= tmp%26@ (Add c8~70@ c8~70@)) (=> (= tmp%27@ (Sub a8~66@ b8~68@)) (=> (= tmp%28@ (Add (Mul c8~70@ a8~66@) (Sub c8~70@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> %%location_label%%8 (= temp_8_0~1936@ temp_8_1~2001@)))))) (=> (= temp_8_0~1936@ temp_8_1~2001@) (=> (= temp_9_0~2112@ (Mul (Add (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ d9~80@)) a9~74@) (Mul (Mul (Mul c9~78@ b9~76@) 92) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~2173@ (Mul (Add (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ d9~80@)) a9~74@) (Mul (Mul (Mul (Mul c9~78@ b9~76@) 92) (Mul a9~74@ d9~80@)) (Mul b9~76@ d9~80@)))) (and (=> (= tmp%29@ (Mul (Mul c9~78@ b9~76@) 92)) (=> (= tmp%30@ (Mul a9~74@ d9~80@)) (=> (= tmp%31@ (Mul b9~76@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> %%location_label%%9 (= temp_9_0~2112@ temp_9_1~2173@)))))) (=> (= temp_9_0~2112@ temp_9_1~2173@) (=> (= temp_10_0~2300@ (Mul (Sub (Sub (Mul c10~86@ d10~88@) (Mul d10~88@ b10~84@)) (Sub (Mul b10~84@ 4) (Mul d10~88@ b10~84@))) (Sub (Add (Add c10~86@ a10~82@) (Mul b10~84@ a10~82@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~2409@ (Sub (Mul (Sub (Mul c10~86@ d10~88@) (Mul d10~88@ b10~84@)) (Sub (Add (Add c10~86@ a10~82@) (Mul b10~84@ a10~82@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)))) (Mul (Sub (Mul b10~84@ 4) (Mul d10~88@ b10~84@)) (Sub (Add (Add c10~86@ a10~82@) (Mul b10~84@ a10~82@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)))))) (and (=> (= tmp%32@ (Sub (Mul c10~86@ d10~88@) (Mul d10~88@ b10~84@))) (=> (= tmp%33@ (Sub (Mul b10~84@ 4) (Mul d10~88@ b10~84@))) (=> (= tmp%34@ (Sub (Add (Add c10~86@ a10~82@) (Mul b10~84@ a10~82@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%10 (= temp_10_0~2300@ temp_10_1~2409@)))))) (=> (= temp_10_0~2300@ temp_10_1~2409@) (=> (= temp_11_0~2556@ (Mul (Mul (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ d11~96@)) (Add (Mul a11~90@ a11~90@) (Mul d11~96@ a11~90@))) (Mul (Sub (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ b11~92@) d11~96@)))) (=> (= temp_11_1~2617@ (Mul (Mul (Mul (Mul b11~92@ a11~90@) (Mul d11~96@ a11~90@)) (Add (Mul a11~90@ a11~90@) (Mul d11~96@ a11~90@))) (Mul (Sub (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ b11~92@) d11~96@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d11~96@ a11~90@) (=> (= tmp%35@ (Mul (Mul b11~92@ a11~90@) (Mul d11~96@ a11~90@))) (=> (= tmp%36@ (Add (Mul a11~90@ a11~90@) (Mul d11~96@ a11~90@))) (=> (= tmp%37@ (Mul (Sub (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ b11~92@) d11~96@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ tmp%36@ tmp%37@) (=> (= tmp%38@ (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ d11~96@))) (=> (= tmp%39@ (Add (Mul a11~90@ a11~90@) (Mul d11~96@ a11~90@))) (=> (= tmp%40@ (Mul (Sub (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ b11~92@) d11~96@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> %%location_label%%11 (= temp_11_0~2556@ temp_11_1~2617@))))))))))) (=> (= temp_11_0~2556@ temp_11_1~2617@) (=> (= temp_12_0~2826@ (Mul (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ c12~102@))) (Sub (Mul (Mul b12~100@ a12~98@) (Sub a12~98@ b12~100@)) (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@))))) (=> (= temp_12_1~2891@ (Mul (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ c12~102@))) (Sub (Mul (Mul b12~100@ a12~98@) (Sub a12~98@ b12~100@)) (Mul (Mul (Mul b12~100@ d12~104@) d12~104@) b12~100@)))) (and (=> (= tmp%41@ (Mul b12~100@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ d12~104@ b12~100@) (=> %%location_label%%12 (= temp_12_0~2826@ temp_12_1~2891@)))) (=> (= temp_12_0~2826@ temp_12_1~2891@) (=> (= temp_13_0~2998@ (Add (Add (Mul b13~108@ (Add b13~108@ b13~108@)) (Add (Mul c13~110@ a13~106@) (Mul b13~108@ a13~106@))) (Mul (Mul (Mul 64 b13~108@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ a13~106@) (Add a13~106@ d13~112@))))) (=> (= temp_13_1~3071@ (Add (Add (Mul b13~108@ (Add b13~108@ b13~108@)) (Add (Mul c13~110@ a13~106@) (Mul b13~108@ a13~106@))) (Mul (Mul (Mul 64 b13~108@) (Mul a13~106@ b13~108@)) (Mul b13~108@ (Mul a13~106@ (Add a13~106@ d13~112@)))))) (and (=> (= tmp%42@ (Add a13~106@ d13~112@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b13~108@ a13~106@ tmp%42@) (=> %%location_label%%13 (= temp_13_0~2998@ temp_13_1~3071@)))) (=> (= temp_13_0~2998@ temp_13_1~3071@) (=> (= temp_14_0~3170@ (Mul (Mul (Mul (Sub c14~118@ c14~118@) (Add c14~118@ c14~118@)) (Mul (Mul c14~118@ a14~114@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul a14~114@ b14~116@) (Add d14~120@ b14~116@)) (Sub (Mul a14~114@ a14~114@) (Mul a14~114@ b14~116@))))) (=> (= temp_14_1~3235@ (Mul (Mul (Mul (Sub c14~118@ c14~118@) (Add c14~118@ c14~118@)) (Mul (Mul c14~118@ a14~114@) (Mul d14~120@ c14~118@))) (Mul (Mul (Add d14~120@ b14~116@) (Mul a14~114@ b14~116@)) (Sub (Mul a14~114@ a14~114@) (Mul a14~114@ b14~116@))))) (and (=> (= tmp%43@ (Add d14~120@ b14~116@)) (=> (= tmp%44@ (Mul a14~114@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%43@ tmp%44@) (=> %%location_label%%14 (= temp_14_0~3170@ temp_14_1~3235@))))) (=> (= temp_14_0~3170@ temp_14_1~3235@) (=> (= temp_15_0~3304@ (Mul b15~124@ (Mul (Mul b15~124@ (Mul a15~122@ b15~124@)) (Sub (Mul a15~122@ d15~128@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~3337@ (Mul (Mul b15~124@ (Mul b15~124@ (Mul a15~122@ b15~124@))) (Sub (Mul a15~122@ d15~128@) (Mul d15~128@ d15~128@)))) (and (=> (= tmp%45@ (Mul b15~124@ (Mul a15~122@ b15~124@))) (=> (= tmp%46@ (Sub (Mul a15~122@ d15~128@) (Mul d15~128@ d15~128@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. b15~124@ tmp%45@ tmp%46@) (=> %%location_label%%15 (= temp_15_0~3304@ temp_15_1~3337@))))) (=> (= temp_15_0~3304@ temp_15_1~3337@) (=> (= temp_16_0~3452@ (Mul (Sub d16~136@ (Mul (Mul 26 b16~132@) (Sub b16~132@ b16~132@))) (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ d16~136@)) (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ a16~130@))))) (=> (= temp_16_1~3517@ (Mul (Sub d16~136@ (Mul (Mul 26 b16~132@) (Sub b16~132@ b16~132@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ a16~130@))))) (and (=> (= tmp%47@ (Mul c16~134@ d16~136@)) (=> (= tmp%48@ (Mul d16~136@ d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%47@ tmp%48@) (=> %%location_label%%16 (= temp_16_0~3452@ temp_16_1~3517@))))) (=> (= temp_16_0~3452@ temp_16_1~3517@) (=> (= temp_17_0~3618@ (Add (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ d17~144@))) (Sub (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ c17~142@)) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ c17~142@))))) (=> (= temp_17_1~3683@ (Add (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ d17~144@))) (Sub (Mul (Mul (Mul b17~140@ a17~138@) a17~138@) c17~142@) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ c17~142@))))) (and (=> (= tmp%49@ (Mul b17~140@ a17~138@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%49@ a17~138@ c17~142@) (=> %%location_label%%17 (= temp_17_0~3618@ temp_17_1~3683@)))) (=> (= temp_17_0~3618@ temp_17_1~3683@) (=> (= temp_18_0~3790@ (Mul (Add (Mul (Add 76 b18~148@) (Sub d18~152@ a18~146@)) (Sub (Mul a18~146@ b18~148@) (Mul d18~152@ a18~146@))) (Mul (Mul (Mul c18~150@ d18~152@) c18~150@) (Sub (Mul d18~152@ d18~152@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~3863@ (Mul (Add (Mul (Add 76 b18~148@) (Sub d18~152@ a18~146@)) (Sub (Mul a18~146@ b18~148@) (Mul d18~152@ a18~146@))) (Mul (Mul c18~150@ d18~152@) (Mul c18~150@ (Sub (Mul d18~152@ d18~152@) (Mul a18~146@ d18~152@)))))) (and (=> (= tmp%50@ (Mul c18~150@ d18~152@)) (=> (= tmp%51@ (Sub (Mul d18~152@ d18~152@) (Mul a18~146@ d18~152@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%50@ c18~150@ tmp%51@) (=> %%location_label%%18 (= temp_18_0~3790@ temp_18_1~3863@))))) (=> (= temp_18_0~3790@ temp_18_1~3863@) (=> (= temp_19_0~3962@ (Mul (Mul (Add (Mul b19~156@ d19~160@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ a19~154@) (Mul b19~156@ c19~158@))) (Mul a19~154@ (Mul (Add d19~160@ b19~156@) (Mul d19~160@ a19~154@))))) (=> (= temp_19_1~4015@ (Mul (Mul (Mul (Add (Mul b19~156@ d19~160@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ a19~154@) (Mul b19~156@ c19~158@))) a19~154@) (Mul (Add d19~160@ b19~156@) (Mul d19~160@ a19~154@)))) (and (=> (= tmp%52@ (Mul (Add (Mul b19~156@ d19~160@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ a19~154@) (Mul b19~156@ c19~158@)))) (=> (= tmp%53@ (Mul (Add d19~160@ b19~156@) (Mul d19~160@ a19~154@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%52@ a19~154@ tmp%53@) (=> %%location_label%%19 (= temp_19_0~3962@ temp_19_1~4015@))))) (=> (= temp_19_0~3962@ temp_19_1~4015@) (=> (= temp_20_0~4150@ (Mul (Sub (Mul (Mul d20~168@ b20~164@) (Add d20~168@ a20~162@)) (Mul (Mul a20~162@ b20~164@) (Mul d20~168@ b20~164@))) (Mul (Sub (Mul a20~162@ c20~166@) (Mul c20~166@ a20~162@)) (Mul (Mul d20~168@ b20~164@) (Mul b20~164@ b20~164@))))) (=> (= temp_20_1~4215@ (Mul (Sub (Mul (Mul d20~168@ b20~164@) (Add d20~168@ a20~162@)) (Mul (Mul a20~162@ b20~164@) (Mul d20~168@ b20~164@))) (Mul (Sub (Mul a20~162@ c20~166@) (Mul c20~166@ a20~162@)) (Mul (Mul b20~164@ d20~168@) (Mul b20~164@ b20~164@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d20~168@ b20~164@) (=> (= tmp%54@ (Sub (Mul (Mul d20~168@ b20~164@) (Add d20~168@ a20~162@)) (Mul (Mul a20~162@ b20~164@) (Mul d20~168@ b20~164@)))) (=> (= tmp%55@ (Sub (Mul a20~162@ c20~166@) (Mul c20~166@ a20~162@))) (=> (= tmp%56@ (Mul (Mul b20~164@ d20~168@) (Mul b20~164@ b20~164@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%54@ tmp%55@ tmp%56@) (=> (= tmp%57@ (Sub (Mul (Mul d20~168@ b20~164@) (Add d20~168@ a20~162@)) (Mul (Mul a20~162@ b20~164@) (Mul d20~168@ b20~164@)))) (=> (= tmp%58@ (Sub (Mul a20~162@ c20~166@) (Mul c20~166@ a20~162@))) (=> (= tmp%59@ (Mul (Mul d20~168@ b20~164@) (Mul b20~164@ b20~164@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%57@ tmp%58@ tmp%59@) (=> %%location_label%%20 (= temp_20_0~4150@ temp_20_1~4215@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
