...
(declare-const temp_1_0~581@ Int)
(declare-const temp_1_1~634@ Int)
(declare-const temp_2_0~733@ Int)
(declare-const temp_2_1~798@ Int)
(declare-const temp_3_0~947@ Int)
(declare-const temp_3_1~1008@ Int)
(declare-const temp_4_0~1225@ Int)
(declare-const temp_4_1~1290@ Int)
(declare-const temp_5_0~1443@ Int)
(declare-const temp_5_1~1508@ Int)
(declare-const temp_6_0~1669@ Int)
(declare-const temp_6_1~1742@ Int)
(declare-const temp_7_0~1891@ Int)
(declare-const temp_7_1~1952@ Int)
(declare-const temp_8_0~2049@ Int)
(declare-const temp_8_1~2118@ Int)
(declare-const temp_9_0~2333@ Int)
(declare-const temp_9_1~2390@ Int)
(declare-const temp_10_0~2503@ Int)
(declare-const temp_10_1~2588@ Int)
(declare-const temp_11_0~2717@ Int)
(declare-const temp_11_1~2758@ Int)
(declare-const temp_12_0~2834@ Int)
(declare-const temp_12_1~2895@ Int)
(declare-const temp_13_0~2992@ Int)
(declare-const temp_13_1~3053@ Int)
(declare-const temp_14_0~3170@ Int)
(declare-const temp_14_1~3239@ Int)
(declare-const temp_15_0~3354@ Int)
(declare-const temp_15_1~3415@ Int)
(declare-const temp_16_0~3522@ Int)
(declare-const temp_16_1~3583@ Int)
(declare-const temp_17_0~3794@ Int)
(declare-const temp_17_1~3855@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Sub d0~8@ c0~6@)) (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@))) (Mul (Add (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul b0~4@ (Mul c0~6@ (Sub d0~8@ c0~6@))) (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@))) (Mul (Add (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@))))) (and (=> (= tmp%1@ (Sub d0~8@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ c0~6@ tmp%1@) (=> (= tmp%2@ (Mul b0~4@ (Mul c0~6@ (Sub d0~8@ c0~6@)))) (=> (= tmp%3@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@))) (=> (= tmp%4@ (Mul (Add (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> (= tmp%5@ (Mul (Mul b0~4@ c0~6@) (Sub d0~8@ c0~6@))) (=> (= tmp%6@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@))) (=> (= tmp%7@ (Mul (Add (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))))))))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~581@ (Mul (Mul (Add (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ d1~16@))) (Mul (Sub (Mul c1~14@ d1~16@) (Mul d1~16@ b1~12@)) a1~10@))) (=> (= temp_1_1~634@ (Mul (Mul (Add (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul (Mul a1~10@ a1~10@) b1~12@) d1~16@)) (Mul (Sub (Mul c1~14@ d1~16@) (Mul d1~16@ b1~12@)) a1~10@))) (and (=> (= tmp%8@ (Mul a1~10@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ b1~12@ d1~16@) (=> %%location_label%%1 (= temp_1_0~581@ temp_1_1~634@)))) (=> (= temp_1_0~581@ temp_1_1~634@) (=> (= temp_2_0~733@ (Mul (Add (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul a2~18@ b2~20@) (Add b2~20@ a2~18@)) (Add (Sub b2~20@ b2~20@) (Sub d2~24@ c2~22@))))) (=> (= temp_2_1~798@ (Mul (Add (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul b2~20@ a2~18@) (Add b2~20@ a2~18@)) (Add (Sub b2~20@ b2~20@) (Sub d2~24@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ a2~18@) (=> (= tmp%9@ (Mul b2~20@ a2~18@)) (=> (= tmp%10@ (Add b2~20@ a2~18@)) (=> (= tmp%11@ (Add (Sub b2~20@ b2~20@) (Sub d2~24@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> (= tmp%12@ (Mul a2~18@ b2~20@)) (=> (= tmp%13@ (Add b2~20@ a2~18@)) (=> (= tmp%14@ (Add (Sub b2~20@ b2~20@) (Sub d2~24@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%2 (= temp_2_0~733@ temp_2_1~798@))))))))))) (=> (= temp_2_0~733@ temp_2_1~798@) (=> (= temp_3_0~947@ (Mul (Add (Mul (Mul d3~32@ a3~26@) c3~30@) (Sub (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul d3~32@ a3~26@) (Add b3~28@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Sub d3~32@ a3~26@))))) (=> (= temp_3_1~1008@ (Mul (Add (Mul (Mul d3~32@ a3~26@) c3~30@) (Sub (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul d3~32@ a3~26@) (Add b3~28@ d3~32@)) (Mul (Sub d3~32@ a3~26@) (Mul b3~28@ b3~28@))))) (and (=> (= tmp%15@ (Sub d3~32@ a3~26@)) (=> (= tmp%16@ (Mul b3~28@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> (= tmp%17@ (Add (Mul (Mul d3~32@ a3~26@) c3~30@) (Sub (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@)))) (=> (= tmp%18@ (Mul (Mul d3~32@ a3~26@) (Add b3~28@ d3~32@))) (=> (= tmp%19@ (Mul (Sub d3~32@ a3~26@) (Mul b3~28@ b3~28@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> (= tmp%20@ (Add (Mul (Mul d3~32@ a3~26@) c3~30@) (Sub (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@)))) (=> (= tmp%21@ (Mul (Mul d3~32@ a3~26@) (Add b3~28@ d3~32@))) (=> (= tmp%22@ (Mul (Mul b3~28@ b3~28@) (Sub d3~32@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%3 (= temp_3_0~947@ temp_3_1~1008@))))))))))))) (=> (= temp_3_0~947@ temp_3_1~1008@) (=> (= temp_4_0~1225@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Sub a4~34@ d4~40@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@)) 32))) (=> (= temp_4_1~1290@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Sub a4~34@ d4~40@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@)) 32))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ d4~40@) (=> (= tmp%23@ (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ b4~36@))) (=> (= tmp%24@ (Sub a4~34@ d4~40@)) (=> (= tmp%25@ (Mul b4~36@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> (= tmp%26@ (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ b4~36@))) (=> (= tmp%27@ (Sub a4~34@ d4~40@)) (=> (= tmp%28@ (Mul d4~40@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> %%location_label%%4 (= temp_4_0~1225@ temp_4_1~1290@))))))))))) (=> (= temp_4_0~1225@ temp_4_1~1290@) (=> (= temp_5_0~1443@ (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul a5~42@ d5~48@) (Sub b5~44@ b5~44@)) (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~1508@ (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul d5~48@ a5~42@) (Sub b5~44@ b5~44@)) (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ a5~42@) (=> (= tmp%29@ (Mul d5~48@ a5~42@)) (=> (= tmp%30@ (Sub b5~44@ b5~44@)) (=> (= tmp%31@ (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ b5~44@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> (= tmp%32@ (Mul a5~42@ d5~48@)) (=> (= tmp%33@ (Sub b5~44@ b5~44@)) (=> (= tmp%34@ (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ b5~44@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ tmp%33@ tmp%34@) (=> %%location_label%%5 (= temp_5_0~1443@ temp_5_1~1508@))))))))))) (=> (= temp_5_0~1443@ temp_5_1~1508@) (=> (= temp_6_0~1669@ (Mul (Mul (Add (Add c6~54@ c6~54@) (Mul d6~56@ c6~54@)) (Mul (Mul c6~54@ b6~52@) 14)) (Mul (Mul (Mul c6~54@ a6~50@) (Sub b6~52@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1742@ (Mul (Mul (Add (Add c6~54@ c6~54@) (Mul d6~56@ c6~54@)) (Mul (Mul c6~54@ b6~52@) 14)) (Mul (Mul (Mul a6~50@ c6~54@) (Sub b6~52@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ c6~54@) (=> (= tmp%35@ (Mul a6~50@ c6~54@)) (=> (= tmp%36@ (Sub b6~52@ c6~54@)) (=> (= tmp%37@ (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%35@ tmp%36@ tmp%37@) (=> (= tmp%38@ (Mul c6~54@ a6~50@)) (=> (= tmp%39@ (Sub b6~52@ c6~54@)) (=> (= tmp%40@ (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> %%location_label%%6 (= temp_6_0~1669@ temp_6_1~1742@))))))))))) (=> (= temp_6_0~1669@ temp_6_1~1742@) (=> (= temp_7_0~1891@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Add d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Sub b7~60@ d7~64@))) (Mul (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ b7~60@)) (Mul c7~62@ (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1952@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Add d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Sub b7~60@ d7~64@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@)) (Mul c7~62@ (Mul d7~64@ d7~64@))))) (and (=> (= tmp%41@ (Mul d7~64@ b7~60@)) (=> (= tmp%42@ (Mul d7~64@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%41@ tmp%42@) (=> %%location_label%%7 (= temp_7_0~1891@ temp_7_1~1952@))))) (=> (= temp_7_0~1891@ temp_7_1~1952@) (=> (= temp_8_0~2049@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Sub a8~66@ a8~66@)) (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ a8~66@))) (Mul (Sub (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) (Mul b8~68@ (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~2118@ (Mul (Mul (Sub (Mul (Mul b8~68@ d8~72@) a8~66@) (Mul (Mul b8~68@ d8~72@) a8~66@)) (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ a8~66@))) (Mul (Sub (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) (Mul b8~68@ (Mul b8~68@ c8~70@))))) (and (=> (= tmp%43@ (Sub (Mul (Mul b8~68@ d8~72@) a8~66@) (Mul (Mul b8~68@ d8~72@) a8~66@))) (=> (= tmp%44@ (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ a8~66@))) (=> (= tmp%45@ (Mul (Sub (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) (Mul b8~68@ (Mul b8~68@ c8~70@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%43@ tmp%44@ tmp%45@) (=> (= tmp%46@ (Mul b8~68@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%46@ a8~66@ a8~66@) (=> (= tmp%47@ (Mul (Mul b8~68@ d8~72@) (Sub a8~66@ a8~66@))) (=> (= tmp%48@ (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ a8~66@))) (=> (= tmp%49@ (Mul (Sub (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) (Mul b8~68@ (Mul b8~68@ c8~70@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%47@ tmp%48@ tmp%49@) (=> %%location_label%%8 (= temp_8_0~2049@ temp_8_1~2118@)))))))))))) (=> (= temp_8_0~2049@ temp_8_1~2118@) (=> (= temp_9_0~2333@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Mul 67 d9~80@)) (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ d9~80@))) (Mul a9~74@ (Mul c9~78@ a9~74@)))) (=> (= temp_9_1~2390@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Mul 67 d9~80@)) (Mul (Mul d9~80@ b9~76@) (Mul b9~76@ d9~80@))) (Mul a9~74@ (Mul c9~78@ a9~74@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ b9~76@) (=> %%location_label%%9 (= temp_9_0~2333@ temp_9_1~2390@))) (=> (= temp_9_0~2333@ temp_9_1~2390@) (=> (= temp_10_0~2503@ (Mul (Add (Mul (Mul 94 b10~84@) (Mul b10~84@ c10~86@)) (Mul (Mul c10~86@ d10~88@) (Add a10~82@ b10~84@))) (Mul (Mul (Mul d10~88@ d10~88@) (Sub c10~86@ c10~86@)) (Mul (Mul a10~82@ 71) d10~88@)))) (=> (= temp_10_1~2588@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Sub c10~86@ c10~86@)) (Mul (Mul a10~82@ 71) d10~88@)) (Add (Mul (Mul 94 b10~84@) (Mul b10~84@ c10~86@)) (Mul (Mul c10~86@ d10~88@) (Add a10~82@ b10~84@))))) (and (=> (= tmp%50@ (Mul (Mul (Mul d10~88@ d10~88@) (Sub c10~86@ c10~86@)) (Mul (Mul a10~82@ 71) d10~88@))) (=> (= tmp%51@ (Add (Mul (Mul 94 b10~84@) (Mul b10~84@ c10~86@)) (Mul (Mul c10~86@ d10~88@) (Add a10~82@ b10~84@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%50@ tmp%51@) (=> %%location_label%%10 (= temp_10_0~2503@ temp_10_1~2588@))))) (=> (= temp_10_0~2503@ temp_10_1~2588@) (=> (= temp_11_0~2717@ (Sub (Add c11~94@ (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ a11~90@))) (Mul (Mul (Mul b11~92@ c11~94@) (Mul d11~96@ c11~94@)) d11~96@))) (=> (= temp_11_1~2758@ (Sub (Add c11~94@ (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ a11~90@))) (Mul (Mul (Mul b11~92@ c11~94@) (Mul d11~96@ c11~94@)) d11~96@))) (=> (= tmp%52@ (= temp_11_0~2717@ temp_11_1~2758@)) (and (=> %%location_label%%11 tmp%52@) (=> tmp%52@ (=> (= temp_12_0~2834@ (Mul (Mul (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ a12~98@)) (Mul (Add b12~100@ a12~98@) (Add c12~102@ a12~98@))) (Mul (Mul (Add d12~104@ a12~98@) (Mul a12~98@ a12~98@)) (Mul (Mul d12~104@ a12~98@) d12~104@)))) (=> (= temp_12_1~2895@ (Mul (Mul (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ a12~98@)) (Mul (Add c12~102@ a12~98@) (Add b12~100@ a12~98@))) (Mul (Mul (Add d12~104@ a12~98@) (Mul a12~98@ a12~98@)) (Mul (Mul d12~104@ a12~98@) d12~104@)))) (and (=> (= tmp%53@ (Add c12~102@ a12~98@)) (=> (= tmp%54@ (Add b12~100@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%53@ tmp%54@) (=> %%location_label%%12 (= temp_12_0~2834@ temp_12_1~2895@))))) (=> (= temp_12_0~2834@ temp_12_1~2895@) (=> (= temp_13_0~2992@ (Mul (Mul (Add (Sub a13~106@ a13~106@) (Mul d13~112@ b13~108@)) (Mul (Mul a13~106@ c13~110@) (Mul d13~112@ c13~110@))) (Mul (Add a13~106@ (Mul c13~110@ c13~110@)) (Mul (Mul d13~112@ a13~106@) (Mul b13~108@ a13~106@))))) (=> (= temp_13_1~3053@ (Mul (Mul (Add (Sub a13~106@ a13~106@) (Mul d13~112@ b13~108@)) (Mul (Mul a13~106@ c13~110@) (Mul d13~112@ c13~110@))) (Mul (Mul (Mul d13~112@ a13~106@) (Mul b13~108@ a13~106@)) (Add a13~106@ (Mul c13~110@ c13~110@))))) (and (=> (= tmp%55@ (Mul (Mul d13~112@ a13~106@) (Mul b13~108@ a13~106@))) (=> (= tmp%56@ (Add a13~106@ (Mul c13~110@ c13~110@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%55@ tmp%56@) (=> %%location_label%%13 (= temp_13_0~2992@ temp_13_1~3053@))))) (=> (= temp_13_0~2992@ temp_13_1~3053@) (=> (= temp_14_0~3170@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ c14~118@)) (Mul (Mul c14~118@ 4) (Mul c14~118@ a14~114@))) (Mul (Mul d14~120@ c14~118@) (Add (Mul a14~114@ b14~116@) (Mul a14~114@ d14~120@))))) (=> (= temp_14_1~3239@ (Mul (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ c14~118@)) (Mul c14~118@ 4)) (Mul c14~118@ a14~114@)) (Mul (Mul d14~120@ c14~118@) (Add (Mul a14~114@ b14~116@) (Mul a14~114@ d14~120@))))) (and (=> (= tmp%57@ (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ c14~118@))) (=> (= tmp%58@ (Mul c14~118@ 4)) (=> (= tmp%59@ (Mul c14~118@ a14~114@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%57@ tmp%58@ tmp%59@) (=> %%location_label%%14 (= temp_14_0~3170@ temp_14_1~3239@)))))) (=> (= temp_14_0~3170@ temp_14_1~3239@) (=> (= temp_15_0~3354@ (Mul (Add (Mul (Mul a15~122@ b15~124@) (Mul b15~124@ a15~122@)) (Mul (Mul b15~124@ b15~124@) (Mul a15~122@ d15~128@))) (Mul (Mul a15~122@ (Mul c15~126@ a15~122@)) (Mul (Mul c15~126@ c15~126@) (Add a15~122@ d15~128@))))) (=> (= temp_15_1~3415@ (Mul (Add (Mul (Mul a15~122@ b15~124@) (Mul b15~124@ a15~122@)) (Mul (Mul b15~124@ b15~124@) (Mul a15~122@ d15~128@))) (Mul (Mul (Mul a15~122@ (Mul c15~126@ a15~122@)) (Mul c15~126@ c15~126@)) (Add a15~122@ d15~128@)))) (and (=> (= tmp%60@ (Mul a15~122@ (Mul c15~126@ a15~122@))) (=> (= tmp%61@ (Mul c15~126@ c15~126@)) (=> (= tmp%62@ (Add a15~122@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%60@ tmp%61@ tmp%62@) (=> %%location_label%%15 (= temp_15_0~3354@ temp_15_1~3415@)))))) (=> (= temp_15_0~3354@ temp_15_1~3415@) (=> (= temp_16_0~3522@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul d16~136@ c16~134@)) (Mul (Sub c16~134@ b16~132@) (Mul a16~130@ d16~136@))) (Mul (Mul (Mul c16~134@ d16~136@) (Add a16~130@ d16~136@)) (Add c16~134@ (Mul a16~130@ a16~130@))))) (=> (= temp_16_1~3583@ (Mul (Mul (Mul (Mul (Mul b16~132@ a16~130@) d16~136@) c16~134@) (Mul (Sub c16~134@ b16~132@) (Mul a16~130@ d16~136@))) (Mul (Mul (Mul c16~134@ d16~136@) (Add a16~130@ d16~136@)) (Add c16~134@ (Mul a16~130@ a16~130@))))) (and (=> (= tmp%63@ (Mul (Mul (Mul b16~132@ a16~130@) d16~136@) c16~134@)) (=> (= tmp%64@ (Mul (Sub c16~134@ b16~132@) (Mul a16~130@ d16~136@))) (=> (= tmp%65@ (Mul (Mul (Mul c16~134@ d16~136@) (Add a16~130@ d16~136@)) (Add c16~134@ (Mul a16~130@ a16~130@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%63@ tmp%64@ tmp%65@) (=> (= tmp%66@ (Mul b16~132@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%66@ d16~136@ c16~134@) (=> (= tmp%67@ (Mul (Mul b16~132@ a16~130@) (Mul d16~136@ c16~134@))) (=> (= tmp%68@ (Mul (Sub c16~134@ b16~132@) (Mul a16~130@ d16~136@))) (=> (= tmp%69@ (Mul (Mul (Mul c16~134@ d16~136@) (Add a16~130@ d16~136@)) (Add c16~134@ (Mul a16~130@ a16~130@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%67@ tmp%68@ tmp%69@) (=> %%location_label%%16 (= temp_16_0~3522@ temp_16_1~3583@)))))))))))) (=> (= temp_16_0~3522@ temp_16_1~3583@) (=> (= temp_17_0~3794@ (Mul (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ a17~138@)) c17~142@) (Mul (Mul (Mul 88 c17~142@) c17~142@) (Mul (Sub b17~140@ d17~144@) (Mul c17~142@ d17~144@))))) (=> (= temp_17_1~3855@ (Mul (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ a17~138@)) c17~142@) (Mul (Mul (Mul 88 c17~142@) c17~142@) (Mul (Mul (Sub b17~140@ d17~144@) c17~142@) d17~144@)))) (=> (= tmp%70@ (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ a17~138@)) c17~142@)) (=> (= tmp%71@ (Mul (Mul 88 c17~142@) c17~142@)) (=> (= tmp%72@ (Mul (Mul (Sub b17~140@ d17~144@) c17~142@) d17~144@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%70@ tmp%71@ tmp%72@) (=> (= tmp%73@ (Sub b17~140@ d17~144@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%73@ c17~142@ d17~144@) (=> (= tmp%74@ (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ a17~138@)) c17~142@)) (=> (= tmp%75@ (Mul (Mul 88 c17~142@) c17~142@)) (=> (= tmp%76@ (Mul (Sub b17~140@ d17~144@) (Mul c17~142@ d17~144@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%74@ tmp%75@ tmp%76@) (=> %%location_label%%17 (= temp_17_0~3794@ temp_17_1~3855@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
