...
(declare-const temp_2_0~614@ Int)
(declare-const temp_2_1~663@ Int)
(declare-const temp_3_0~864@ Int)
(declare-const temp_3_1~941@ Int)
...
(declare-const temp_8_0~1789@ Int)
(declare-const temp_8_1~1850@ Int)
(declare-const temp_9_0~2061@ Int)
(declare-const temp_9_1~2122@ Int)
(declare-const temp_10_0~2323@ Int)
(declare-const temp_10_1~2376@ Int)
(declare-const temp_11_0~2469@ Int)
(declare-const temp_11_1~2542@ Int)
(declare-const temp_12_0~2633@ Int)
(declare-const temp_12_1~2690@ Int)
(declare-const temp_13_0~2893@ Int)
(declare-const temp_13_1~2958@ Int)
(declare-const temp_14_0~3067@ Int)
(declare-const temp_14_1~3140@ Int)
(declare-const temp_15_0~3293@ Int)
(declare-const temp_15_1~3358@ Int)
(declare-const temp_16_0~3573@ Int)
(declare-const temp_16_1~3638@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Mul (Sub (Sub b0~4@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Add b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~386@ (Add (Sub (Mul (Sub b0~4@ c0~6@) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))) (Mul (Mul b0~4@ a0~2@) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@)))) (Mul (Mul (Mul c0~6@ d0~8@) (Add b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@))))) (and (=> (= tmp%1@ (Sub b0~4@ c0~6@)) (=> (= tmp%2@ (Mul b0~4@ a0~2@)) (=> (= tmp%3@ (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~386@)))))) (=> (= temp_0_0~305@ temp_0_1~386@) (=> (= temp_1_0~493@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ a1~10@) a1~10@)) (Sub (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Sub b1~12@ c1~14@) a1~10@)))) (=> (= temp_1_1~550@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ a1~10@) a1~10@)) (Sub (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Sub b1~12@ c1~14@) a1~10@)))) (=> (= tmp%4@ (= temp_1_0~493@ temp_1_1~550@)) (and (=> %%location_label%%1 tmp%4@) (=> tmp%4@ (=> (= temp_2_0~614@ (Mul (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@))) (Mul d2~24@ (Mul (Add b2~20@ b2~20@) c2~22@)))) (=> (= temp_2_1~663@ (Mul (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@))) (Mul d2~24@ (Mul c2~22@ (Add b2~20@ b2~20@))))) (and (=> (= tmp%5@ (Add b2~20@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ tmp%5@) (=> (= tmp%6@ (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@)))) (=> (= tmp%7@ (Mul c2~22@ (Add b2~20@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ d2~24@ tmp%7@) (=> (= tmp%8@ (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@)))) (=> (= tmp%9@ (Mul (Add b2~20@ b2~20@) c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ d2~24@ tmp%9@) (=> %%location_label%%2 (= temp_2_0~614@ temp_2_1~663@)))))))))) (=> (= temp_2_0~614@ temp_2_1~663@) (=> (= temp_3_0~864@ (Sub (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul 89 c3~30@)) (Sub (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~941@ (Sub (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul 89 c3~30@)) (Sub (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@))))) (=> (= tmp%10@ (= temp_3_0~864@ temp_3_1~941@)) (and (=> %%location_label%%3 tmp%10@) (=> tmp%10@ (=> (= temp_4_0~1017@ (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul d4~40@ d4~40@) a4~34@) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~1078@ (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul (Mul d4~40@ d4~40@) a4~34@) (Mul c4~38@ c4~38@)) (Mul a4~34@ b4~36@)))) (and (=> (= tmp%11@ (Mul (Mul d4~40@ d4~40@) a4~34@)) (=> (= tmp%12@ (Mul c4~38@ c4~38@)) (=> (= tmp%13@ (Mul a4~34@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%4 (= temp_4_0~1017@ temp_4_1~1078@)))))) (=> (= temp_4_0~1017@ temp_4_1~1078@) (=> (= temp_5_0~1189@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ c5~46@))) (Mul (Mul (Add a5~42@ d5~48@) (Mul a5~42@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1254@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul a5~42@ b5~44@) (Add a5~42@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))))) (and (=> (= tmp%14@ (Mul a5~42@ b5~44@)) (=> (= tmp%15@ (Add a5~42@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%5 (= temp_5_0~1189@ temp_5_1~1254@))))) (=> (= temp_5_0~1189@ temp_5_1~1254@) (=> (= temp_6_0~1351@ (Sub (Mul (Mul (Sub d6~56@ c6~54@) (Add b6~52@ d6~56@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@))) (Add (Mul b6~52@ (Mul c6~54@ a6~50@)) (Mul (Mul b6~52@ d6~56@) (Sub b6~52@ c6~54@))))) (=> (= temp_6_1~1412@ (Sub (Mul (Mul (Sub d6~56@ c6~54@) (Add b6~52@ d6~56@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@))) (Add (Mul b6~52@ (Mul c6~54@ a6~50@)) (Mul b6~52@ (Mul d6~56@ (Sub b6~52@ c6~54@)))))) (and (=> (= tmp%16@ (Sub b6~52@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b6~52@ d6~56@ tmp%16@) (=> %%location_label%%6 (= temp_6_0~1351@ temp_6_1~1412@)))) (=> (= temp_6_0~1351@ temp_6_1~1412@) (=> (= temp_7_0~1511@ (Mul (Mul (Add (Mul c7~62@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@))) (Mul (Add (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@)) (Add (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1576@ (Mul (Mul (Add (Mul c7~62@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@))) (Mul (Add (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@)) (Add (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ a7~58@) (=> (= tmp%17@ (Add (Mul c7~62@ a7~58@) (Mul c7~62@ a7~58@))) (=> (= tmp%18@ (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@))) (=> (= tmp%19@ (Mul (Add (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@)) (Add (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> (= tmp%20@ (Add (Mul c7~62@ a7~58@) (Mul a7~58@ c7~62@))) (=> (= tmp%21@ (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@))) (=> (= tmp%22@ (Mul (Add (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@)) (Add (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%7 (= temp_7_0~1511@ temp_7_1~1576@))))))))))) (=> (= temp_7_0~1511@ temp_7_1~1576@) (=> (= temp_8_0~1789@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ b8~68@) (Add c8~70@ d8~72@))) (Mul (Mul (Mul c8~70@ d8~72@) a8~66@) (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1850@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ b8~68@) (Add c8~70@ d8~72@))) (Mul (Mul (Mul c8~70@ d8~72@) a8~66@) (Mul b8~68@ (Mul b8~68@ (Mul c8~70@ d8~72@)))))) (and (=> (= tmp%23@ (Mul c8~70@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b8~68@ b8~68@ tmp%23@) (=> (= tmp%24@ (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ b8~68@) (Add c8~70@ d8~72@)))) (=> (= tmp%25@ (Mul (Mul c8~70@ d8~72@) a8~66@)) (=> (= tmp%26@ (Mul b8~68@ (Mul b8~68@ (Mul c8~70@ d8~72@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> (= tmp%27@ (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ b8~68@) (Add c8~70@ d8~72@)))) (=> (= tmp%28@ (Mul (Mul c8~70@ d8~72@) a8~66@)) (=> (= tmp%29@ (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> %%location_label%%8 (= temp_8_0~1789@ temp_8_1~1850@)))))))))))) (=> (= temp_8_0~1789@ temp_8_1~1850@) (=> (= temp_9_0~2061@ (Mul (Mul (Mul d9~80@ (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~2122@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) d9~80@) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@))))) (and (=> (= tmp%30@ (Mul c9~78@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%30@ d9~80@) (=> (= tmp%31@ (Mul (Mul c9~78@ b9~76@) d9~80@)) (=> (= tmp%32@ (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ d9~80@))) (=> (= tmp%33@ (Mul (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> (= tmp%34@ (Mul d9~80@ (Mul c9~78@ b9~76@))) (=> (= tmp%35@ (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ d9~80@))) (=> (= tmp%36@ (Mul (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ tmp%35@ tmp%36@) (=> %%location_label%%9 (= temp_9_0~2061@ temp_9_1~2122@)))))))))))) (=> (= temp_9_0~2061@ temp_9_1~2122@) (=> (= temp_10_0~2323@ (Sub (Add (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Sub c10~86@ c10~86@) (Mul d10~88@ d10~88@))) (Mul (Sub (Mul d10~88@ b10~84@) (Sub d10~88@ b10~84@)) d10~88@))) (=> (= temp_10_1~2376@ (Sub (Add (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Sub c10~86@ c10~86@) (Mul d10~88@ d10~88@))) (Mul (Sub (Mul b10~84@ d10~88@) (Sub d10~88@ b10~84@)) d10~88@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b10~84@ d10~88@) (=> %%location_label%%10 (= temp_10_0~2323@ temp_10_1~2376@))) (=> (= temp_10_0~2323@ temp_10_1~2376@) (=> (= temp_11_0~2469@ (Mul (Add (Mul (Mul d11~96@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul d11~96@ a11~90@))) (Mul (Mul (Mul a11~90@ b11~92@) (Add b11~92@ d11~96@)) (Add (Mul a11~90@ d11~96@) (Mul a11~90@ b11~92@))))) (=> (= temp_11_1~2542@ (Mul (Add (Mul (Mul d11~96@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul d11~96@ a11~90@))) (Mul (Add (Mul (Mul a11~90@ b11~92@) b11~92@) (Mul (Mul a11~90@ b11~92@) d11~96@)) (Add (Mul a11~90@ d11~96@) (Mul a11~90@ b11~92@))))) (and (=> (= tmp%37@ (Mul a11~90@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%37@ b11~92@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2469@ temp_11_1~2542@)))) (=> (= temp_11_0~2469@ temp_11_1~2542@) (=> (= temp_12_0~2633@ (Mul (Sub (Mul c12~102@ (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) (Mul (Mul b12~100@ b12~100@) c12~102@)))) (=> (= temp_12_1~2690@ (Mul (Sub (Mul c12~102@ (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) (Mul b12~100@ (Mul b12~100@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b12~100@ b12~100@ c12~102@) (=> (= tmp%38@ (Sub (Mul c12~102@ (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)))) (=> (= tmp%39@ (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@))) (=> (= tmp%40@ (Mul b12~100@ (Mul b12~100@ c12~102@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ tmp%39@ tmp%40@) (=> (= tmp%41@ (Sub (Mul c12~102@ (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)))) (=> (= tmp%42@ (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@))) (=> (= tmp%43@ (Mul (Mul b12~100@ b12~100@) c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ tmp%42@ tmp%43@) (=> %%location_label%%12 (= temp_12_0~2633@ temp_12_1~2690@))))))))))) (=> (= temp_12_0~2633@ temp_12_1~2690@) (=> (= temp_13_0~2893@ (Mul (Mul (Mul (Mul b13~108@ b13~108@) (Mul d13~112@ d13~112@)) (Sub (Mul c13~110@ a13~106@) (Mul a13~106@ b13~108@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul d13~112@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2958@ (Mul (Mul (Mul (Mul b13~108@ b13~108@) (Mul d13~112@ d13~112@)) (Sub (Mul c13~110@ a13~106@) (Mul a13~106@ b13~108@))) (Mul (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ c13~110@)) (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ a13~106@))))) (and (=> (= tmp%44@ (Mul d13~112@ a13~106@)) (=> (= tmp%45@ (Mul d13~112@ c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%44@ tmp%45@) (=> %%location_label%%13 (= temp_13_0~2893@ temp_13_1~2958@))))) (=> (= temp_13_0~2893@ temp_13_1~2958@) (=> (= temp_14_0~3067@ (Mul (Mul (Mul (Mul 96 c14~118@) (Mul a14~114@ d14~120@)) (Mul (Sub d14~120@ d14~120@) (Mul c14~118@ d14~120@))) (Mul (Mul (Mul c14~118@ d14~120@) (Mul a14~114@ a14~114@)) (Mul (Add b14~116@ b14~116@) b14~116@)))) (=> (= temp_14_1~3140@ (Mul (Mul (Mul (Mul 96 c14~118@) (Mul a14~114@ d14~120@)) (Mul (Sub d14~120@ d14~120@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul c14~118@ d14~120@) (Mul a14~114@ a14~114@)) (Mul (Add b14~116@ b14~116@) b14~116@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ c14~118@) (=> (= tmp%46@ (Mul (Mul 96 c14~118@) (Mul a14~114@ d14~120@))) (=> (= tmp%47@ (Sub d14~120@ d14~120@)) (=> (= tmp%48@ (Mul d14~120@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%46@ tmp%47@ tmp%48@) (=> (= tmp%49@ (Mul (Mul 96 c14~118@) (Mul a14~114@ d14~120@))) (=> (= tmp%50@ (Sub d14~120@ d14~120@)) (=> (= tmp%51@ (Mul c14~118@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%49@ tmp%50@ tmp%51@) (=> %%location_label%%14 (= temp_14_0~3067@ temp_14_1~3140@))))))))))) (=> (= temp_14_0~3067@ temp_14_1~3140@) (=> (= temp_15_0~3293@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Add d15~128@ b15~124@)) (Mul (Sub a15~122@ c15~126@) (Add d15~128@ a15~122@))) (Sub (Mul c15~126@ (Mul a15~122@ b15~124@)) (Mul c15~126@ (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~3358@ (Mul (Mul (Add (Mul (Mul d15~128@ c15~126@) d15~128@) (Mul (Mul d15~128@ c15~126@) b15~124@)) (Mul (Sub a15~122@ c15~126@) (Add d15~128@ a15~122@))) (Sub (Mul c15~126@ (Mul a15~122@ b15~124@)) (Mul c15~126@ (Mul c15~126@ a15~122@))))) (and (=> (= tmp%52@ (Add (Mul (Mul d15~128@ c15~126@) d15~128@) (Mul (Mul d15~128@ c15~126@) b15~124@))) (=> (= tmp%53@ (Mul (Sub a15~122@ c15~126@) (Add d15~128@ a15~122@))) (=> (= tmp%54@ (Sub (Mul c15~126@ (Mul a15~122@ b15~124@)) (Mul c15~126@ (Mul c15~126@ a15~122@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%52@ tmp%53@ tmp%54@) (=> (= tmp%55@ (Mul d15~128@ c15~126@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%55@ d15~128@ b15~124@) (=> (= tmp%56@ (Mul (Mul d15~128@ c15~126@) (Add d15~128@ b15~124@))) (=> (= tmp%57@ (Mul (Sub a15~122@ c15~126@) (Add d15~128@ a15~122@))) (=> (= tmp%58@ (Sub (Mul c15~126@ (Mul a15~122@ b15~124@)) (Mul c15~126@ (Mul c15~126@ a15~122@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%56@ tmp%57@ tmp%58@) (=> %%location_label%%15 (= temp_15_0~3293@ temp_15_1~3358@)))))))))))) (=> (= temp_15_0~3293@ temp_15_1~3358@) (=> (= temp_16_0~3573@ (Mul (Mul (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ d16~136@)) (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ c16~134@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@)) (Mul (Add c16~134@ c16~134@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~3638@ (Mul (Mul (Mul (Mul b16~132@ c16~134@) (Mul d16~136@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ c16~134@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@)) (Mul (Add c16~134@ c16~134@) (Mul c16~134@ a16~130@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d16~136@ a16~130@) (=> (= tmp%59@ (Mul (Mul b16~132@ c16~134@) (Mul d16~136@ a16~130@))) (=> (= tmp%60@ (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ c16~134@))) (=> (= tmp%61@ (Mul (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@)) (Mul (Add c16~134@ c16~134@) (Mul c16~134@ a16~130@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%59@ tmp%60@ tmp%61@) (=> (= tmp%62@ (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ d16~136@))) (=> (= tmp%63@ (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ c16~134@))) (=> (= tmp%64@ (Mul (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@)) (Mul (Add c16~134@ c16~134@) (Mul c16~134@ a16~130@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%62@ tmp%63@ tmp%64@) (=> %%location_label%%16 (= temp_16_0~3573@ temp_16_1~3638@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
