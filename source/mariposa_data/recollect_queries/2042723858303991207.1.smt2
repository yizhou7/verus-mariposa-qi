...
(declare-const temp_4_0~1169@ Int)
...
(declare-const temp_6_1~1642@ Int)
(declare-const temp_7_0~1725@ Int)
(declare-const temp_7_1~1762@ Int)
(declare-const temp_8_0~1877@ Int)
(declare-const temp_8_1~1942@ Int)
(declare-const temp_9_0~2035@ Int)
(declare-const temp_9_1~2100@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ d0~8@))) (Sub (Add (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@)) c0~6@))) (=> (= temp_0_1~346@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul (Mul c0~6@ a0~2@) c0~6@) d0~8@)) (Sub (Add (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@)) c0~6@))) (and (=> (= tmp%1@ (Mul c0~6@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ c0~6@ d0~8@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@)))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~457@ (Sub (Mul (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@))) (Sub (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ 20) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~534@ (Sub (Mul (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@))) (Sub (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ 20) (Mul b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ b1~12@) (=> %%location_label%%1 (= temp_1_0~457@ temp_1_1~534@))) (=> (= temp_1_0~457@ temp_1_1~534@) (=> (= temp_2_0~627@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ b2~20@))) (Mul (Add (Add a2~18@ a2~18@) (Mul b2~20@ a2~18@)) (Add (Sub a2~18@ d2~24@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~692@ (Mul (Mul (Add (Add a2~18@ a2~18@) (Mul b2~20@ a2~18@)) (Add (Sub a2~18@ d2~24@) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ b2~20@))))) (and (=> (= tmp%2@ (Mul (Add (Add a2~18@ a2~18@) (Mul b2~20@ a2~18@)) (Add (Sub a2~18@ d2~24@) (Mul c2~22@ b2~20@)))) (=> (= tmp%3@ (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~627@ temp_2_1~692@))))) (=> (= temp_2_0~627@ temp_2_1~692@) (=> (= temp_3_0~853@ (Mul (Mul (Mul (Mul 85 b3~28@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ c3~30@) (Add a3~26@ d3~32@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@)) (Mul (Sub d3~32@ c3~30@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~938@ (Mul (Mul (Mul (Mul 85 b3~28@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ c3~30@) (Add a3~26@ d3~32@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@)) (Sub (Mul d3~32@ (Mul b3~28@ a3~26@)) (Mul c3~30@ (Mul b3~28@ a3~26@)))))) (and (=> (= tmp%4@ (Mul (Mul (Mul 85 b3~28@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ c3~30@) (Add a3~26@ d3~32@)))) (=> (= tmp%5@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@))) (=> (= tmp%6@ (Sub (Mul d3~32@ (Mul b3~28@ a3~26@)) (Mul c3~30@ (Mul b3~28@ a3~26@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> (= tmp%7@ (Mul b3~28@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d3~32@ c3~30@ tmp%7@) (=> (= tmp%8@ (Mul (Mul (Mul 85 b3~28@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ c3~30@) (Add a3~26@ d3~32@)))) (=> (= tmp%9@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@))) (=> (= tmp%10@ (Mul (Sub d3~32@ c3~30@) (Mul b3~28@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%3 (= temp_3_0~853@ temp_3_1~938@)))))))))))) (=> (= temp_3_0~853@ temp_3_1~938@) (=> (= temp_4_0~1169@ (Mul (Add (Mul b4~36@ (Mul a4~34@ b4~36@)) (Mul c4~38@ (Sub a4~34@ b4~36@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ c4~38@)) (Mul (Sub b4~36@ a4~34@) (Mul a4~34@ a4~34@))))) (=> (= temp_4_1~1258@ (Add (Mul (Mul b4~36@ (Mul a4~34@ b4~36@)) (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ c4~38@)) (Mul (Sub b4~36@ a4~34@) (Mul a4~34@ a4~34@)))) (Mul (Mul c4~38@ (Sub a4~34@ b4~36@)) (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ c4~38@)) (Mul (Sub b4~36@ a4~34@) (Mul a4~34@ a4~34@)))))) (and (=> (= tmp%11@ (Mul b4~36@ (Mul a4~34@ b4~36@))) (=> (= tmp%12@ (Mul c4~38@ (Sub a4~34@ b4~36@))) (=> (= tmp%13@ (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ c4~38@)) (Mul (Sub b4~36@ a4~34@) (Mul a4~34@ a4~34@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%4 (= temp_4_0~1169@ temp_4_1~1258@)))))) (=> (= temp_4_0~1169@ temp_4_1~1258@) (=> (= temp_5_0~1409@ (Add (Mul (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ c5~46@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul d5~48@ 90)) (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ b5~44@))))) (=> (= temp_5_1~1486@ (Add (Mul (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ c5~46@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul d5~48@ 90)) (Mul (Mul (Mul c5~46@ c5~46@) d5~48@) b5~44@)))) (and (=> (= tmp%14@ (Mul c5~46@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ d5~48@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1409@ temp_5_1~1486@)))) (=> (= temp_5_0~1409@ temp_5_1~1486@) (=> (= temp_6_0~1581@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) d6~56@) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))) (Sub (Sub (Mul b6~52@ c6~54@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1642@ (Mul (Mul (Mul (Mul (Mul a6~50@ d6~56@) d6~56@) (Mul c6~54@ b6~52@)) (Mul d6~56@ a6~50@)) (Sub (Sub (Mul b6~52@ c6~54@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ b6~52@))))) (and (=> (= tmp%15@ (Mul (Mul a6~50@ d6~56@) d6~56@)) (=> (= tmp%16@ (Mul c6~54@ b6~52@)) (=> (= tmp%17@ (Mul d6~56@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%6 (= temp_6_0~1581@ temp_6_1~1642@)))))) (=> (= temp_6_0~1581@ temp_6_1~1642@) (=> (= temp_7_0~1725@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ d7~64@))) b7~60@)) (=> (= temp_7_1~1762@ (Mul (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@)) (Mul a7~58@ d7~64@)) (Mul a7~58@ d7~64@)) b7~60@)) (and (=> (= tmp%18@ (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@))) (=> (= tmp%19@ (Mul a7~58@ d7~64@)) (=> (= tmp%20@ (Mul a7~58@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%7 (= temp_7_0~1725@ temp_7_1~1762@)))))) (=> (= temp_7_0~1725@ temp_7_1~1762@) (=> (= temp_8_0~1877@ (Mul (Mul (Mul (Sub d8~72@ d8~72@) (Mul c8~70@ a8~66@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul c8~70@ a8~66@) (Add d8~72@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Sub d8~72@ c8~70@))))) (=> (= temp_8_1~1942@ (Mul (Mul (Mul (Sub d8~72@ d8~72@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul c8~70@ a8~66@) (Add d8~72@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Sub d8~72@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ a8~66@) (=> %%location_label%%8 (= temp_8_0~1877@ temp_8_1~1942@))) (=> (= temp_8_0~1877@ temp_8_1~1942@) (=> (= temp_9_0~2035@ (Mul (Add (Mul (Mul a9~74@ a9~74@) (Mul d9~80@ b9~76@)) (Sub (Mul b9~76@ d9~80@) (Mul d9~80@ d9~80@))) (Mul (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ a9~74@)) (Sub (Mul c9~78@ b9~76@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~2100@ (Mul (Add (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ a9~74@)) (Sub (Mul b9~76@ d9~80@) (Mul d9~80@ d9~80@))) (Mul (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ a9~74@)) (Sub (Mul c9~78@ b9~76@) (Mul a9~74@ c9~78@))))) (=> (= tmp%21@ (Mul d9~80@ b9~76@)) (=> (= tmp%22@ (Mul a9~74@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%9 (= temp_9_0~2035@ temp_9_1~2100@))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
