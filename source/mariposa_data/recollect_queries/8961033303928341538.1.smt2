...
(declare-const temp_4_0~1041@ Int)
(declare-const temp_4_1~1086@ Int)
(declare-const temp_5_0~1179@ Int)
(declare-const temp_5_1~1240@ Int)
(declare-const temp_6_0~1349@ Int)
(declare-const temp_6_1~1422@ Int)
(declare-const temp_7_0~1517@ Int)
(declare-const temp_7_1~1582@ Int)
(declare-const temp_8_0~1638@ Int)
(declare-const temp_8_1~1679@ Int)
(declare-const temp_9_0~1780@ Int)
(declare-const temp_9_1~1845@ Int)
(declare-const temp_10_0~1940@ Int)
(declare-const temp_10_1~2001@ Int)
(declare-const temp_11_0~2074@ Int)
(declare-const temp_11_1~2111@ Int)
(declare-const temp_12_0~2210@ Int)
(declare-const temp_12_1~2275@ Int)
(declare-const temp_13_0~2370@ Int)
(declare-const temp_13_1~2415@ Int)
(declare-const temp_14_0~2516@ Int)
(declare-const temp_14_1~2581@ Int)
(declare-const temp_15_0~2682@ Int)
(declare-const temp_15_1~2747@ Int)
(declare-const temp_16_0~2960@ Int)
(declare-const temp_16_1~3013@ Int)
(declare-const temp_17_0~3106@ Int)
(declare-const temp_17_1~3171@ Int)
(declare-const temp_18_0~3260@ Int)
(declare-const temp_18_1~3297@ Int)
(declare-const temp_19_0~3416@ Int)
(declare-const temp_19_1~3481@ Int)
(declare-const temp_20_0~3537@ Int)
(declare-const temp_20_1~3578@ Int)
(declare-const temp_21_0~3743@ Int)
(declare-const temp_21_1~3788@ Int)
(declare-const temp_22_0~3907@ Int)
(declare-const temp_22_1~3984@ Int)
(declare-const temp_23_0~4057@ Int)
(declare-const temp_23_1~4102@ Int)
(declare-const temp_24_0~4191@ Int)
(declare-const temp_24_1~4244@ Int)
(declare-const temp_25_0~4361@ Int)
(declare-const temp_25_1~4426@ Int)
(declare-const temp_26_0~4523@ Int)
(declare-const temp_26_1~4584@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Add (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@))) (Mul a0~2@ (Mul (Sub a0~2@ a0~2@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~366@ (Add (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul a0~2@ (Mul (Sub a0~2@ a0~2@) (Mul c0~6@ c0~6@)))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@)) (Mul a0~2@ (Mul (Sub a0~2@ a0~2@) (Mul c0~6@ c0~6@)))))) (and (=> (= tmp%1@ (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (=> (= tmp%2@ (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@))) (=> (= tmp%3@ (Mul a0~2@ (Mul (Sub a0~2@ a0~2@) (Mul c0~6@ c0~6@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~366@)))))) (=> (= temp_0_0~293@ temp_0_1~366@) (=> (= temp_1_0~489@ (Mul (Mul (Add (Sub a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ b1~12@))) (Mul d1~16@ (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~542@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ b1~12@)) (Add (Sub a1~10@ d1~16@) (Mul d1~16@ c1~14@))) (Mul d1~16@ (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ d1~16@))))) (and (=> (= tmp%4@ (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ b1~12@))) (=> (= tmp%5@ (Add (Sub a1~10@ d1~16@) (Mul d1~16@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~489@ temp_1_1~542@))))) (=> (= temp_1_0~489@ temp_1_1~542@) (=> (= temp_2_0~643@ (Add (Mul (Mul b2~20@ (Mul d2~24@ b2~20@)) (Sub (Add b2~20@ a2~18@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@)) c2~22@))) (=> (= temp_2_1~692@ (Add (Mul (Mul (Mul d2~24@ b2~20@) b2~20@) (Sub (Add b2~20@ a2~18@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@)) c2~22@))) (and (=> (= tmp%6@ (Mul d2~24@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ b2~20@) (=> %%location_label%%2 (= temp_2_0~643@ temp_2_1~692@)))) (=> (= temp_2_0~643@ temp_2_1~692@) (=> (= temp_3_0~785@ (Mul (Mul (Mul (Add a3~26@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul a3~26@ d3~32@) b3~28@) (Mul (Mul c3~30@ c3~30@) (Add c3~30@ d3~32@))))) (=> (= temp_3_1~846@ (Mul (Mul (Mul (Add a3~26@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul a3~26@ d3~32@) b3~28@) (Mul c3~30@ (Mul c3~30@ (Add c3~30@ d3~32@)))))) (and (=> (= tmp%7@ (Add c3~30@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c3~30@ c3~30@ tmp%7@) (=> (= tmp%8@ (Mul (Mul (Add a3~26@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@)))) (=> (= tmp%9@ (Mul (Mul a3~26@ d3~32@) b3~28@)) (=> (= tmp%10@ (Mul c3~30@ (Mul c3~30@ (Add c3~30@ d3~32@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> (= tmp%11@ (Mul (Mul (Add a3~26@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@)))) (=> (= tmp%12@ (Mul (Mul a3~26@ d3~32@) b3~28@)) (=> (= tmp%13@ (Mul (Mul c3~30@ c3~30@) (Add c3~30@ d3~32@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%3 (= temp_3_0~785@ temp_3_1~846@)))))))))))) (=> (= temp_3_0~785@ temp_3_1~846@) (=> (= temp_4_0~1041@ (Add (Mul (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ c4~38@) a4~34@)) (Mul c4~38@ (Mul (Mul c4~38@ a4~34@) d4~40@)))) (=> (= temp_4_1~1086@ (Add (Mul (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ c4~38@) a4~34@)) (Mul c4~38@ (Mul d4~40@ (Mul c4~38@ a4~34@))))) (and (=> (= tmp%14@ (Mul c4~38@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ tmp%14@) (=> %%location_label%%4 (= temp_4_0~1041@ temp_4_1~1086@)))) (=> (= temp_4_0~1041@ temp_4_1~1086@) (=> (= temp_5_0~1179@ (Add (Add (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ a5~42@)) (Mul (Add c5~46@ b5~44@) (Mul a5~42@ b5~44@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@)) (Mul a5~42@ (Sub a5~42@ b5~44@))))) (=> (= temp_5_1~1240@ (Add (Add (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ d5~48@)) (Mul (Add c5~46@ b5~44@) (Mul a5~42@ b5~44@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@)) (Mul a5~42@ (Sub a5~42@ b5~44@))))) (and (=> (= tmp%15@ (Mul b5~44@ a5~42@)) (=> (= tmp%16@ (Mul c5~46@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%5 (= temp_5_0~1179@ temp_5_1~1240@))))) (=> (= temp_5_0~1179@ temp_5_1~1240@) (=> (= temp_6_0~1349@ (Add (Sub (Mul (Add b6~52@ b6~52@) (Mul c6~54@ 86)) (Sub (Sub d6~56@ a6~50@) (Sub c6~54@ c6~54@))) (Sub (Mul b6~52@ (Mul d6~56@ a6~50@)) (Sub (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1422@ (Add (Sub (Mul (Add b6~52@ b6~52@) (Mul c6~54@ 86)) (Sub (Sub d6~56@ a6~50@) (Sub c6~54@ c6~54@))) (Sub (Mul (Mul b6~52@ d6~56@) a6~50@) (Sub (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b6~52@ d6~56@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1349@ temp_6_1~1422@))) (=> (= temp_6_0~1349@ temp_6_1~1422@) (=> (= temp_7_0~1517@ (Sub (Mul (Mul (Mul b7~60@ d7~64@) (Sub b7~60@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@))) (Sub (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@)) (Add (Sub d7~64@ b7~60@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1582@ (Sub (Mul (Mul (Mul b7~60@ d7~64@) (Sub b7~60@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@))) (Sub (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@)) (Add (Sub d7~64@ b7~60@) (Mul a7~58@ c7~62@))))) (=> (= tmp%17@ (= temp_7_0~1517@ temp_7_1~1582@)) (and (=> %%location_label%%7 tmp%17@) (=> tmp%17@ (=> (= temp_8_0~1638@ (Mul (Sub b8~68@ (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@)) d8~72@))) (=> (= temp_8_1~1679@ (Mul (Sub b8~68@ (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@)) d8~72@))) (and (=> (= tmp%18@ (Mul b8~68@ b8~68@)) (=> (= tmp%19@ (Mul d8~72@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%8 (= temp_8_0~1638@ temp_8_1~1679@))))) (=> (= temp_8_0~1638@ temp_8_1~1679@) (=> (= temp_9_0~1780@ (Mul (Mul (Mul (Sub b9~76@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ d9~80@))) (Mul (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ a9~74@)) (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1845@ (Mul (Mul (Mul (Sub b9~76@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ d9~80@))) (Mul (Mul a9~74@ (Mul c9~78@ (Mul d9~80@ a9~74@))) (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ c9~78@))))) (and (=> (= tmp%20@ (Mul d9~80@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a9~74@ c9~78@ tmp%20@) (=> %%location_label%%9 (= temp_9_0~1780@ temp_9_1~1845@)))) (=> (= temp_9_0~1780@ temp_9_1~1845@) (=> (= temp_10_0~1940@ (Sub (Mul (Mul (Mul b10~84@ d10~88@) (Mul a10~82@ d10~88@)) b10~84@) (Mul (Sub (Mul a10~82@ b10~84@) (Mul c10~86@ a10~82@)) (Mul a10~82@ (Mul 30 a10~82@))))) (=> (= temp_10_1~2001@ (Sub (Mul (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ d10~88@)) b10~84@) (Mul (Sub (Mul a10~82@ b10~84@) (Mul c10~86@ a10~82@)) (Mul a10~82@ (Mul 30 a10~82@))))) (and (=> (= tmp%21@ (Mul a10~82@ d10~88@)) (=> (= tmp%22@ (Mul b10~84@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%10 (= temp_10_0~1940@ temp_10_1~2001@))))) (=> (= temp_10_0~1940@ temp_10_1~2001@) (=> (= temp_11_0~2074@ (Add (Mul (Sub (Sub d11~96@ b11~92@) (Mul c11~94@ c11~94@)) (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ a11~90@))) c11~94@)) (=> (= temp_11_1~2111@ (Add (Mul (Sub (Sub d11~96@ b11~92@) (Mul c11~94@ c11~94@)) (Mul (Mul (Mul b11~92@ c11~94@) a11~90@) a11~90@)) c11~94@)) (and (=> (= tmp%23@ (Mul b11~92@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ a11~90@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2074@ temp_11_1~2111@)))) (=> (= temp_11_0~2074@ temp_11_1~2111@) (=> (= temp_12_0~2210@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ a12~98@)) (Sub (Sub d12~104@ b12~100@) (Mul d12~104@ a12~98@))) (Mul (Sub (Mul b12~100@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ a12~98@))))) (=> (= temp_12_1~2275@ (Mul (Mul (Mul a12~98@ c12~102@) (Mul (Mul b12~100@ a12~98@) (Sub (Sub d12~104@ b12~100@) (Mul d12~104@ a12~98@)))) (Mul (Sub (Mul b12~100@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ a12~98@))))) (and (=> (= tmp%24@ (Mul a12~98@ c12~102@)) (=> (= tmp%25@ (Mul b12~100@ a12~98@)) (=> (= tmp%26@ (Sub (Sub d12~104@ b12~100@) (Mul d12~104@ a12~98@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%12 (= temp_12_0~2210@ temp_12_1~2275@)))))) (=> (= temp_12_0~2210@ temp_12_1~2275@) (=> (= temp_13_0~2370@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) b13~108@) (Mul (Add c13~110@ c13~110@) (Mul c13~110@ d13~112@))) (Mul b13~108@ (Sub a13~106@ (Mul c13~110@ c13~110@))))) (=> (= temp_13_1~2415@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) b13~108@) (Mul (Mul c13~110@ d13~112@) (Add c13~110@ c13~110@))) (Mul b13~108@ (Sub a13~106@ (Mul c13~110@ c13~110@))))) (and (=> (= tmp%27@ (Mul c13~110@ d13~112@)) (=> (= tmp%28@ (Add c13~110@ c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%13 (= temp_13_0~2370@ temp_13_1~2415@))))) (=> (= temp_13_0~2370@ temp_13_1~2415@) (=> (= temp_14_0~2516@ (Mul (Sub (Sub (Mul c14~118@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Add b14~116@ a14~114@) (Mul b14~116@ d14~120@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@))))) (=> (= temp_14_1~2581@ (Mul (Sub (Sub (Mul c14~118@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Add b14~116@ a14~114@) (Mul b14~116@ d14~120@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@))))) (and (=> (= tmp%29@ (Mul b14~116@ b14~116@)) (=> (= tmp%30@ (Mul c14~118@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%29@ tmp%30@) (=> %%location_label%%14 (= temp_14_0~2516@ temp_14_1~2581@))))) (=> (= temp_14_0~2516@ temp_14_1~2581@) (=> (= temp_15_0~2682@ (Mul (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (Add (Mul d15~128@ a15~122@) (Mul a15~122@ b15~124@))) (Mul (Sub (Mul b15~124@ d15~128@) (Mul b15~124@ a15~122@)) (Sub (Mul c15~126@ a15~122@) (Mul c15~126@ d15~128@))))) (=> (= temp_15_1~2747@ (Mul (Mul (Mul (Mul b15~124@ c15~126@) (Mul a15~122@ d15~128@)) (Add (Mul d15~128@ a15~122@) (Mul a15~122@ b15~124@))) (Mul (Sub (Mul b15~124@ d15~128@) (Mul b15~124@ a15~122@)) (Sub (Mul c15~126@ a15~122@) (Mul c15~126@ d15~128@))))) (and (=> (= tmp%31@ (Mul b15~124@ c15~126@)) (=> (= tmp%32@ (Mul a15~122@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%31@ tmp%32@) (=> (= tmp%33@ (Mul (Mul b15~124@ c15~126@) (Mul a15~122@ d15~128@))) (=> (= tmp%34@ (Add (Mul d15~128@ a15~122@) (Mul a15~122@ b15~124@))) (=> (= tmp%35@ (Mul (Sub (Mul b15~124@ d15~128@) (Mul b15~124@ a15~122@)) (Sub (Mul c15~126@ a15~122@) (Mul c15~126@ d15~128@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ tmp%34@ tmp%35@) (=> (= tmp%36@ (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@))) (=> (= tmp%37@ (Add (Mul d15~128@ a15~122@) (Mul a15~122@ b15~124@))) (=> (= tmp%38@ (Mul (Sub (Mul b15~124@ d15~128@) (Mul b15~124@ a15~122@)) (Sub (Mul c15~126@ a15~122@) (Mul c15~126@ d15~128@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ tmp%37@ tmp%38@) (=> %%location_label%%15 (= temp_15_0~2682@ temp_15_1~2747@))))))))))))) (=> (= temp_15_0~2682@ temp_15_1~2747@) (=> (= temp_16_0~2960@ (Mul (Sub a16~130@ (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@))) (Mul (Mul (Add b16~132@ c16~134@) (Mul b16~132@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Sub d16~136@ b16~132@))))) (=> (= temp_16_1~3013@ (Mul (Sub a16~130@ (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@))) (Mul (Mul (Add b16~132@ c16~134@) (Mul a16~130@ b16~132@)) (Mul (Mul b16~132@ d16~136@) (Sub d16~136@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a16~130@ b16~132@) (=> %%location_label%%16 (= temp_16_0~2960@ temp_16_1~3013@))) (=> (= temp_16_0~2960@ temp_16_1~3013@) (=> (= temp_17_0~3106@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ c17~142@) (Add a17~138@ b17~140@))) (Mul (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ b17~140@)) (Add (Sub b17~140@ d17~144@) (Mul a17~138@ d17~144@))))) (=> (= temp_17_1~3171@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ c17~142@) (Add a17~138@ b17~140@))) (Mul (Add (Sub b17~140@ d17~144@) (Mul a17~138@ d17~144@)) (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ b17~140@))))) (and (=> (= tmp%39@ (Add (Sub b17~140@ d17~144@) (Mul a17~138@ d17~144@))) (=> (= tmp%40@ (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ b17~140@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%39@ tmp%40@) (=> %%location_label%%17 (= temp_17_0~3106@ temp_17_1~3171@))))) (=> (= temp_17_0~3106@ temp_17_1~3171@) (=> (= temp_18_0~3260@ (Mul (Mul (Mul (Mul b18~148@ b18~148@) (Mul c18~150@ b18~148@)) (Mul (Mul a18~146@ a18~146@) (Mul a18~146@ d18~152@))) d18~152@)) (=> (= temp_18_1~3297@ (Mul (Mul (Mul b18~148@ b18~148@) (Mul c18~150@ b18~148@)) (Mul (Mul (Mul a18~146@ a18~146@) (Mul a18~146@ d18~152@)) d18~152@))) (and (=> (= tmp%41@ (Mul (Mul b18~148@ b18~148@) (Mul c18~150@ b18~148@))) (=> (= tmp%42@ (Mul (Mul a18~146@ a18~146@) (Mul a18~146@ d18~152@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ tmp%42@ d18~152@) (=> %%location_label%%18 (= temp_18_0~3260@ temp_18_1~3297@))))) (=> (= temp_18_0~3260@ temp_18_1~3297@) (=> (= temp_19_0~3416@ (Sub (Add (Mul (Mul d19~160@ b19~156@) (Mul d19~160@ b19~156@)) (Add (Mul a19~154@ b19~156@) (Mul c19~158@ a19~154@))) (Add (Add (Sub a19~154@ d19~160@) (Mul b19~156@ a19~154@)) (Mul (Mul b19~156@ b19~156@) (Mul d19~160@ a19~154@))))) (=> (= temp_19_1~3481@ (Sub (Add (Mul (Mul d19~160@ b19~156@) (Mul d19~160@ b19~156@)) (Add (Mul a19~154@ b19~156@) (Mul c19~158@ a19~154@))) (Add (Add (Sub a19~154@ d19~160@) (Mul b19~156@ a19~154@)) (Mul (Mul b19~156@ b19~156@) (Mul d19~160@ a19~154@))))) (=> (= tmp%43@ (= temp_19_0~3416@ temp_19_1~3481@)) (and (=> %%location_label%%19 tmp%43@) (=> tmp%43@ (=> (= temp_20_0~3537@ (Mul (Sub a20~162@ b20~164@) (Mul (Add (Mul c20~166@ b20~164@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ d20~168@) (Mul c20~166@ a20~162@))))) (=> (= temp_20_1~3578@ (Mul (Sub a20~162@ b20~164@) (Mul (Add (Mul c20~166@ b20~164@) (Mul d20~168@ c20~166@)) (Mul (Mul c20~166@ a20~162@) (Mul b20~164@ d20~168@))))) (and (=> (= tmp%44@ (Mul c20~166@ a20~162@)) (=> (= tmp%45@ (Mul b20~164@ d20~168@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%44@ tmp%45@) (=> (= tmp%46@ (Sub a20~162@ b20~164@)) (=> (= tmp%47@ (Add (Mul c20~166@ b20~164@) (Mul d20~168@ c20~166@))) (=> (= tmp%48@ (Mul (Mul c20~166@ a20~162@) (Mul b20~164@ d20~168@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%46@ tmp%47@ tmp%48@) (=> (= tmp%49@ (Sub a20~162@ b20~164@)) (=> (= tmp%50@ (Add (Mul c20~166@ b20~164@) (Mul d20~168@ c20~166@))) (=> (= tmp%51@ (Mul (Mul b20~164@ d20~168@) (Mul c20~166@ a20~162@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%49@ tmp%50@ tmp%51@) (=> %%location_label%%20 (= temp_20_0~3537@ temp_20_1~3578@))))))))))))) (=> (= temp_20_0~3537@ temp_20_1~3578@) (=> (= temp_21_0~3743@ (Mul (Add (Mul (Mul d21~176@ c21~174@) (Mul d21~176@ a21~170@)) (Mul (Mul c21~174@ c21~174@) (Mul d21~176@ a21~170@))) (Sub b21~172@ (Mul (Mul b21~172@ d21~176@) (Add c21~174@ a21~170@))))) (=> (= temp_21_1~3788@ (Mul (Mul (Add (Mul d21~176@ c21~174@) (Mul c21~174@ c21~174@)) (Mul d21~176@ a21~170@)) (Sub b21~172@ (Mul (Mul b21~172@ d21~176@) (Add c21~174@ a21~170@))))) (and (=> (= tmp%52@ (Mul d21~176@ c21~174@)) (=> (= tmp%53@ (Mul c21~174@ c21~174@)) (=> (= tmp%54@ (Mul d21~176@ a21~170@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%52@ tmp%53@ tmp%54@) (=> %%location_label%%21 (= temp_21_0~3743@ temp_21_1~3788@)))))) (=> (= temp_21_0~3743@ temp_21_1~3788@) (=> (= temp_22_0~3907@ (Mul (Add (Add (Mul 30 a22~178@) (Mul b22~180@ b22~180@)) (Mul (Mul d22~184@ b22~180@) (Mul c22~182@ c22~182@))) (Add (Mul (Sub d22~184@ d22~184@) (Mul b22~180@ c22~182@)) (Mul (Mul a22~178@ c22~182@) (Mul a22~178@ d22~184@))))) (=> (= temp_22_1~3984@ (Mul (Add (Add (Mul 30 a22~178@) (Mul b22~180@ b22~180@)) (Mul (Mul d22~184@ b22~180@) (Mul c22~182@ c22~182@))) (Add (Mul (Sub d22~184@ d22~184@) (Mul b22~180@ c22~182@)) (Mul (Mul a22~178@ c22~182@) (Mul d22~184@ a22~178@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d22~184@ a22~178@) (=> %%location_label%%22 (= temp_22_0~3907@ temp_22_1~3984@))) (=> (= temp_22_0~3907@ temp_22_1~3984@) (=> (= temp_23_0~4057@ (Mul (Mul (Mul (Mul b23~188@ b23~188@) d23~192@) (Mul (Mul d23~192@ a23~186@) (Add a23~186@ c23~190@))) (Mul a23~186@ (Sub (Add c23~190@ b23~188@) b23~188@)))) (=> (= temp_23_1~4102@ (Mul (Mul (Mul (Mul b23~188@ b23~188@) d23~192@) (Mul (Mul d23~192@ a23~186@) (Add a23~186@ c23~190@))) (Mul (Sub (Add c23~190@ b23~188@) b23~188@) a23~186@))) (and (=> (= tmp%55@ (Sub (Add c23~190@ b23~188@) b23~188@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%55@ a23~186@) (=> %%location_label%%23 (= temp_23_0~4057@ temp_23_1~4102@)))) (=> (= temp_23_0~4057@ temp_23_1~4102@) (=> (= temp_24_0~4191@ (Add (Mul (Mul (Sub b24~196@ b24~196@) (Mul c24~198@ d24~200@)) a24~194@) (Mul (Mul (Sub a24~194@ a24~194@) (Sub c24~198@ d24~200@)) (Mul (Mul c24~198@ d24~200@) (Mul b24~196@ c24~198@))))) (=> (= temp_24_1~4244@ (Add (Mul (Mul (Sub b24~196@ b24~196@) (Mul c24~198@ d24~200@)) a24~194@) (Mul (Mul (Mul c24~198@ d24~200@) (Mul b24~196@ c24~198@)) (Mul (Sub a24~194@ a24~194@) (Sub c24~198@ d24~200@))))) (and (=> (= tmp%56@ (Mul (Mul c24~198@ d24~200@) (Mul b24~196@ c24~198@))) (=> (= tmp%57@ (Mul (Sub a24~194@ a24~194@) (Sub c24~198@ d24~200@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%56@ tmp%57@) (=> %%location_label%%24 (= temp_24_0~4191@ temp_24_1~4244@))))) (=> (= temp_24_0~4191@ temp_24_1~4244@) (=> (= temp_25_0~4361@ (Mul (Add (Mul (Mul b25~204@ b25~204@) (Mul d25~208@ c25~206@)) (Mul (Mul b25~204@ a25~202@) (Mul b25~204@ c25~206@))) (Mul (Sub (Sub d25~208@ c25~206@) (Mul b25~204@ b25~204@)) (Sub (Mul d25~208@ d25~208@) (Mul c25~206@ d25~208@))))) (=> (= temp_25_1~4426@ (Mul (Add (Mul (Mul b25~204@ b25~204@) (Mul d25~208@ c25~206@)) (Mul (Mul b25~204@ c25~206@) (Mul b25~204@ a25~202@))) (Mul (Sub (Sub d25~208@ c25~206@) (Mul b25~204@ b25~204@)) (Sub (Mul d25~208@ d25~208@) (Mul c25~206@ d25~208@))))) (and (=> (= tmp%58@ (Mul b25~204@ c25~206@)) (=> (= tmp%59@ (Mul b25~204@ a25~202@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%58@ tmp%59@) (=> %%location_label%%25 (= temp_25_0~4361@ temp_25_1~4426@))))) (=> (= temp_25_0~4361@ temp_25_1~4426@) (=> (= temp_26_0~4523@ (Mul (Mul (Mul (Add c26~214@ b26~212@) (Mul d26~216@ d26~216@)) (Sub (Mul d26~216@ d26~216@) (Mul c26~214@ b26~212@))) (Mul (Mul (Mul a26~210@ b26~212@) (Mul d26~216@ c26~214@)) (Mul b26~212@ (Sub d26~216@ c26~214@))))) (=> (= temp_26_1~4584@ (Mul (Mul (Mul (Add c26~214@ b26~212@) (Mul d26~216@ d26~216@)) (Sub (Mul d26~216@ d26~216@) (Mul c26~214@ b26~212@))) (Mul (Mul (Mul d26~216@ c26~214@) (Mul a26~210@ b26~212@)) (Mul b26~212@ (Sub d26~216@ c26~214@))))) (=> (= tmp%60@ (Mul d26~216@ c26~214@)) (=> (= tmp%61@ (Mul a26~210@ b26~212@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%60@ tmp%61@) (=> %%location_label%%26 (= temp_26_0~4523@ temp_26_1~4584@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
