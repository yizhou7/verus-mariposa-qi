...
(declare-const temp_2_0~552@ Int)
(declare-const temp_2_1~617@ Int)
(declare-const temp_3_0~685@ Int)
(declare-const temp_3_1~738@ Int)
(declare-const temp_4_0~923@ Int)
(declare-const temp_4_1~980@ Int)
(declare-const temp_5_0~1077@ Int)
(declare-const temp_5_1~1138@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Mul d0~8@ (Mul (Mul (Sub a0~2@ c0~6@) (Sub c0~6@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~314@ (Mul d0~8@ (Mul (Mul (Sub a0~2@ c0~6@) (Sub c0~6@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~277@ temp_0_1~314@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~390@ (Mul (Mul (Mul (Sub d1~16@ a1~10@) c1~14@) (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ a1~10@))) (Sub (Mul (Add a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~451@ (Mul (Mul (Mul (Sub d1~16@ a1~10@) c1~14@) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ b1~12@))) (Sub (Mul (Add a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@))))) (and (=> (= tmp%2@ (Mul b1~12@ a1~10@)) (=> (= tmp%3@ (Mul d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~390@ temp_1_1~451@))))) (=> (= temp_1_0~390@ temp_1_1~451@) (=> (= temp_2_0~552@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@))) (Sub (Mul (Mul a2~18@ d2~24@) (Add c2~22@ d2~24@)) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~617@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@))) (Sub (Mul (Mul a2~18@ d2~24@) (Add c2~22@ d2~24@)) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ c2~22@))))) (=> (= tmp%4@ (= temp_2_0~552@ temp_2_1~617@)) (and (=> %%location_label%%2 tmp%4@) (=> tmp%4@ (=> (= temp_3_0~685@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@)) (Add (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@))) (Mul b3~28@ (Mul (Mul c3~30@ b3~28@) (Sub b3~28@ a3~26@))))) (=> (= temp_3_1~738@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@)) (Add (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@))) (Mul b3~28@ (Mul (Mul b3~28@ c3~30@) (Sub b3~28@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ c3~30@) (=> (= tmp%5@ (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@)) (Add (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@)))) (=> (= tmp%6@ (Mul (Mul b3~28@ c3~30@) (Sub b3~28@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ b3~28@ tmp%6@) (=> (= tmp%7@ (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@)) (Add (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@)))) (=> (= tmp%8@ (Mul (Mul c3~30@ b3~28@) (Sub b3~28@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ b3~28@ tmp%8@) (=> %%location_label%%3 (= temp_3_0~685@ temp_3_1~738@))))))))) (=> (= temp_3_0~685@ temp_3_1~738@) (=> (= temp_4_0~923@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Sub b4~36@ a4~34@)) (Add (Mul b4~36@ d4~40@) c4~38@)) (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@)) (Add (Add d4~40@ d4~40@) d4~40@)))) (=> (= temp_4_1~980@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Sub b4~36@ a4~34@)) (Add (Mul b4~36@ d4~40@) c4~38@)) (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Add (Add d4~40@ d4~40@) d4~40@)))) (and (=> (= tmp%9@ (Mul a4~34@ c4~38@)) (=> (= tmp%10@ (Mul b4~36@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%4 (= temp_4_0~923@ temp_4_1~980@))))) (=> (= temp_4_0~923@ temp_4_1~980@) (=> (= temp_5_0~1077@ (Mul (Mul (Add d5~48@ (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Add c5~46@ a5~42@) (Mul c5~46@ d5~48@)) (Add (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1138@ (Mul (Mul (Add d5~48@ (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Add c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Add (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1077@ temp_5_1~1138@))) (=> (= temp_5_0~1077@ temp_5_1~1138@) (=> (= temp_6_0~1223@ (Mul (Mul (Mul b6~52@ (Sub a6~50@ d6~56@)) (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ 89))) (Sub (Sub b6~52@ (Mul b6~52@ c6~54@)) a6~50@))) (=> (= temp_6_1~1280@ (Mul (Mul b6~52@ (Mul (Sub a6~50@ d6~56@) (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ 89)))) (Sub (Sub b6~52@ (Mul b6~52@ c6~54@)) a6~50@))) (and (=> (= tmp%11@ (Sub a6~50@ d6~56@)) (=> (= tmp%12@ (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ 89))) (=> (ens%main!nl_basics.lemma_mul_is_associative. b6~52@ tmp%11@ tmp%12@) (=> %%location_label%%6 (= temp_6_0~1223@ temp_6_1~1280@))))) (=> (= temp_6_0~1223@ temp_6_1~1280@) (=> (= temp_7_0~1395@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Sub a7~58@ b7~60@) (Add a7~58@ a7~58@))) (Mul (Add (Sub d7~64@ c7~62@) (Add d7~64@ b7~60@)) (Add (Sub a7~58@ a7~58@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1460@ (Mul (Mul (Add (Sub d7~64@ c7~62@) (Add d7~64@ b7~60@)) (Add (Sub a7~58@ a7~58@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Sub a7~58@ b7~60@) (Add a7~58@ a7~58@))))) (=> (= tmp%13@ (Mul (Add (Sub d7~64@ c7~62@) (Add d7~64@ b7~60@)) (Add (Sub a7~58@ a7~58@) (Mul c7~62@ d7~64@)))) (=> (= tmp%14@ (Mul (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Sub a7~58@ b7~60@) (Add a7~58@ a7~58@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%7 (= temp_7_0~1395@ temp_7_1~1460@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
