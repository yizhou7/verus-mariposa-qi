...
(declare-const temp_3_1~964@ Int)
(declare-const temp_4_0~1125@ Int)
(declare-const temp_4_1~1198@ Int)
(declare-const temp_5_0~1345@ Int)
(declare-const temp_5_1~1410@ Int)
(declare-const temp_6_0~1599@ Int)
(declare-const temp_6_1~1652@ Int)
(declare-const temp_7_0~1767@ Int)
(declare-const temp_7_1~1832@ Int)
(declare-const temp_8_0~1947@ Int)
(declare-const temp_8_1~2012@ Int)
(declare-const temp_9_0~2161@ Int)
(declare-const temp_9_1~2222@ Int)
(declare-const temp_10_0~2305@ Int)
(declare-const temp_10_1~2366@ Int)
(declare-const temp_11_0~2597@ Int)
(declare-const temp_11_1~2686@ Int)
(declare-const temp_12_0~2797@ Int)
(declare-const temp_12_1~2874@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Sub d0~8@ (Mul d0~8@ b0~4@)) (Mul a0~2@ (Sub c0~6@ d0~8@))))) (=> (= temp_0_1~354@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul (Sub d0~8@ (Mul d0~8@ b0~4@)) a0~2@) (Sub c0~6@ d0~8@)))) (and (=> (= tmp%1@ (Sub d0~8@ (Mul d0~8@ b0~4@))) (=> (= tmp%2@ (Sub c0~6@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ a0~2@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~354@))))) (=> (= temp_0_0~297@ temp_0_1~354@) (=> (= temp_1_0~461@ (Sub (Add (Sub (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@)) (Add (Mul a1~10@ c1~14@) (Mul a1~10@ b1~12@))) (Mul (Sub (Sub d1~16@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Add a1~10@ a1~10@))))) (=> (= temp_1_1~526@ (Sub (Add (Sub (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@)) (Add (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@))) (Mul (Sub (Sub d1~16@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Add a1~10@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ a1~10@) (=> %%location_label%%1 (= temp_1_0~461@ temp_1_1~526@))) (=> (= temp_1_0~461@ temp_1_1~526@) (=> (= temp_2_0~619@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Add a2~18@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~684@ (Mul (Mul (Mul c2~22@ (Mul a2~18@ (Add a2~18@ a2~18@))) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))))) (and (=> (= tmp%3@ (Add a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c2~22@ a2~18@ tmp%3@) (=> (= tmp%4@ (Mul c2~22@ (Mul a2~18@ (Add a2~18@ a2~18@)))) (=> (= tmp%5@ (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))) (=> (= tmp%6@ (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> (= tmp%7@ (Mul (Mul c2~22@ a2~18@) (Add a2~18@ a2~18@))) (=> (= tmp%8@ (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))) (=> (= tmp%9@ (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%2 (= temp_2_0~619@ temp_2_1~684@)))))))))))) (=> (= temp_2_0~619@ temp_2_1~684@) (=> (= temp_3_0~903@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Sub d3~32@ b3~28@) (Mul b3~28@ d3~32@))) (Mul (Mul c3~30@ (Mul a3~26@ d3~32@)) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~964@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Sub d3~32@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul c3~30@ (Mul a3~26@ d3~32@)) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ b3~28@) (=> (= tmp%10@ (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@))) (=> (= tmp%11@ (Sub d3~32@ b3~28@)) (=> (= tmp%12@ (Mul d3~32@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> (= tmp%13@ (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@))) (=> (= tmp%14@ (Sub d3~32@ b3~28@)) (=> (= tmp%15@ (Mul b3~28@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%3 (= temp_3_0~903@ temp_3_1~964@))))))))))) (=> (= temp_3_0~903@ temp_3_1~964@) (=> (= temp_4_0~1125@ (Mul (Mul (Mul (Add c4~38@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Add c4~38@ c4~38@) (Mul d4~40@ a4~34@))) (Sub (Mul (Add d4~40@ a4~34@) (Mul a4~34@ 86)) (Mul (Add d4~40@ b4~36@) b4~36@)))) (=> (= temp_4_1~1198@ (Mul (Mul (Add c4~38@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul (Add c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Sub (Mul (Add d4~40@ a4~34@) (Mul a4~34@ 86)) (Mul (Add d4~40@ b4~36@) b4~36@))))) (and (=> (= tmp%16@ (Mul (Add c4~38@ c4~38@) (Mul a4~34@ d4~40@))) (=> (= tmp%17@ (Mul (Add c4~38@ c4~38@) (Mul d4~40@ a4~34@))) (=> (= tmp%18@ (Sub (Mul (Add d4~40@ a4~34@) (Mul a4~34@ 86)) (Mul (Add d4~40@ b4~36@) b4~36@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%4 (= temp_4_0~1125@ temp_4_1~1198@)))))) (=> (= temp_4_0~1125@ temp_4_1~1198@) (=> (= temp_5_0~1345@ (Mul (Mul (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ b5~44@)) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Mul (Add b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1410@ (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Mul (Add b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ c5~46@) (=> (= tmp%19@ (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@))) (=> (= tmp%20@ (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ c5~46@))) (=> (= tmp%21@ (Mul (Mul (Add b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ b5~44@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> (= tmp%22@ (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ b5~44@))) (=> (= tmp%23@ (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ c5~46@))) (=> (= tmp%24@ (Mul (Mul (Add b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ b5~44@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%5 (= temp_5_0~1345@ temp_5_1~1410@))))))))))) (=> (= temp_5_0~1345@ temp_5_1~1410@) (=> (= temp_6_0~1599@ (Sub (Mul (Sub (Mul c6~54@ c6~54@) (Mul a6~50@ d6~56@)) (Add (Mul c6~54@ c6~54@) (Add b6~52@ d6~56@))) a6~50@)) (=> (= temp_6_1~1652@ (Sub (Sub (Mul (Mul c6~54@ c6~54@) (Add (Mul c6~54@ c6~54@) (Add b6~52@ d6~56@))) (Mul (Mul a6~50@ d6~56@) (Add (Mul c6~54@ c6~54@) (Add b6~52@ d6~56@)))) a6~50@)) (and (=> (= tmp%25@ (Mul c6~54@ c6~54@)) (=> (= tmp%26@ (Mul a6~50@ d6~56@)) (=> (= tmp%27@ (Add (Mul c6~54@ c6~54@) (Add b6~52@ d6~56@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%6 (= temp_6_0~1599@ temp_6_1~1652@)))))) (=> (= temp_6_0~1599@ temp_6_1~1652@) (=> (= temp_7_0~1767@ (Mul (Mul (Sub (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@)) (Mul (Sub c7~62@ d7~64@) (Add d7~64@ b7~60@))) (Mul (Add (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@)) (Sub (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1832@ (Mul (Mul (Mul (Sub (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@)) (Sub c7~62@ d7~64@)) (Add d7~64@ b7~60@)) (Mul (Add (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@)) (Sub (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@))))) (and (=> (= tmp%28@ (Sub (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@))) (=> (= tmp%29@ (Sub c7~62@ d7~64@)) (=> (= tmp%30@ (Add d7~64@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%7 (= temp_7_0~1767@ temp_7_1~1832@)))))) (=> (= temp_7_0~1767@ temp_7_1~1832@) (=> (= temp_8_0~1947@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ c8~70@))) (Add (Mul (Add a8~66@ c8~70@) (Mul b8~68@ d8~72@)) (Add (Mul b8~68@ b8~68@) (Add d8~72@ d8~72@))))) (=> (= temp_8_1~2012@ (Mul (Add (Mul (Add a8~66@ c8~70@) (Mul b8~68@ d8~72@)) (Add (Mul b8~68@ b8~68@) (Add d8~72@ d8~72@))) (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ c8~70@))))) (and (=> (= tmp%31@ (Add (Mul (Add a8~66@ c8~70@) (Mul b8~68@ d8~72@)) (Add (Mul b8~68@ b8~68@) (Add d8~72@ d8~72@)))) (=> (= tmp%32@ (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ c8~70@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%31@ tmp%32@) (=> %%location_label%%8 (= temp_8_0~1947@ temp_8_1~2012@))))) (=> (= temp_8_0~1947@ temp_8_1~2012@) (=> (= temp_9_0~2161@ (Mul (Sub (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ c9~78@)) (Sub (Mul b9~76@ b9~76@) (Mul b9~76@ b9~76@))) (Add (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~2222@ (Mul (Sub (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ c9~78@)) (Mul b9~76@ (Sub b9~76@ b9~76@))) (Add (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b9~76@ b9~76@ b9~76@) (=> %%location_label%%9 (= temp_9_0~2161@ temp_9_1~2222@))) (=> (= temp_9_0~2161@ temp_9_1~2222@) (=> (= temp_10_0~2305@ (Mul (Mul (Mul (Add d10~88@ d10~88@) (Add d10~88@ d10~88@)) d10~88@) (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ a10~82@))))) (=> (= temp_10_1~2366@ (Mul (Mul (Add (Mul (Add d10~88@ d10~88@) d10~88@) (Mul (Add d10~88@ d10~88@) d10~88@)) d10~88@) (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ a10~82@))))) (and (=> (= tmp%33@ (Add (Mul (Add d10~88@ d10~88@) d10~88@) (Mul (Add d10~88@ d10~88@) d10~88@))) (=> (= tmp%34@ (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ a10~82@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ d10~88@ tmp%34@) (=> (= tmp%35@ (Add d10~88@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%35@ d10~88@ d10~88@) (=> (= tmp%36@ (Mul (Add d10~88@ d10~88@) (Add d10~88@ d10~88@))) (=> (= tmp%37@ (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ a10~82@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ d10~88@ tmp%37@) (=> %%location_label%%10 (= temp_10_0~2305@ temp_10_1~2366@)))))))))) (=> (= temp_10_0~2305@ temp_10_1~2366@) (=> (= temp_11_0~2597@ (Mul (Mul (Mul (Sub 53 c11~94@) (Mul d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ d11~96@))) (Sub (Mul (Sub a11~90@ c11~94@) (Mul c11~94@ a11~90@)) (Sub (Mul b11~92@ a11~90@) (Mul d11~96@ 77))))) (=> (= temp_11_1~2686@ (Mul (Mul (Mul (Sub 53 c11~94@) (Mul d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ d11~96@))) (Sub (Mul (Mul (Sub a11~90@ c11~94@) c11~94@) a11~90@) (Sub (Mul b11~92@ a11~90@) (Mul d11~96@ 77))))) (and (=> (= tmp%38@ (Sub a11~90@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%38@ c11~94@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2597@ temp_11_1~2686@)))) (=> (= temp_11_0~2597@ temp_11_1~2686@) (=> (= temp_12_0~2797@ (Mul (Mul (Sub (Mul b12~100@ a12~98@) (Mul d12~104@ 89)) (Mul (Mul b12~100@ b12~100@) (Sub b12~100@ b12~100@))) (Mul (Sub (Mul d12~104@ d12~104@) (Mul a12~98@ d12~104@)) (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ b12~100@))))) (=> (= temp_12_1~2874@ (Mul (Mul (Sub (Mul b12~100@ a12~98@) (Mul d12~104@ 89)) (Mul (Mul b12~100@ b12~100@) (Sub b12~100@ b12~100@))) (Mul (Sub (Mul d12~104@ d12~104@) (Mul a12~98@ d12~104@)) (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ c12~102@))))) (=> (= tmp%39@ (Mul d12~104@ b12~100@)) (=> (= tmp%40@ (Mul d12~104@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%39@ tmp%40@) (=> (= tmp%41@ (Mul (Sub (Mul b12~100@ a12~98@) (Mul d12~104@ 89)) (Mul (Mul b12~100@ b12~100@) (Sub b12~100@ b12~100@)))) (=> (= tmp%42@ (Sub (Mul d12~104@ d12~104@) (Mul a12~98@ d12~104@))) (=> (= tmp%43@ (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ c12~102@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%41@ tmp%42@ tmp%43@) (=> (= tmp%44@ (Mul (Sub (Mul b12~100@ a12~98@) (Mul d12~104@ 89)) (Mul (Mul b12~100@ b12~100@) (Sub b12~100@ b12~100@)))) (=> (= tmp%45@ (Sub (Mul d12~104@ d12~104@) (Mul a12~98@ d12~104@))) (=> (= tmp%46@ (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%44@ tmp%45@ tmp%46@) (=> %%location_label%%12 (= temp_12_0~2797@ temp_12_1~2874@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
