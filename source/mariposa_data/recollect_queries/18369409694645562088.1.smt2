...
(declare-const temp_2_0~750@ Int)
(declare-const temp_2_1~827@ Int)
(declare-const temp_3_0~978@ Int)
(declare-const temp_3_1~1051@ Int)
(declare-const temp_4_0~1282@ Int)
(declare-const temp_4_1~1347@ Int)
(declare-const temp_5_0~1474@ Int)
(declare-const temp_5_1~1551@ Int)
(declare-const temp_6_0~1654@ Int)
(declare-const temp_6_1~1707@ Int)
(declare-const temp_7_0~1808@ Int)
(declare-const temp_7_1~1873@ Int)
(declare-const temp_8_0~1990@ Int)
(declare-const temp_8_1~2055@ Int)
(declare-const temp_9_0~2172@ Int)
(declare-const temp_9_1~2237@ Int)
(declare-const temp_10_0~2317@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Add (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@)) (Sub (Mul b0~4@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Mul (Add d0~8@ c0~6@) (Mul a0~2@ a0~2@)) (Add (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Add (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@)) (Sub (Mul b0~4@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Mul (Add d0~8@ c0~6@) (Mul a0~2@ a0~2@)) (Add (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~450@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~515@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ c1~14@)) (Mul d1~16@ (Mul a1~10@ (Mul b1~12@ c1~14@)))))) (and (=> (= tmp%2@ (Mul b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d1~16@ a1~10@ tmp%2@) (=> (= tmp%3@ (Mul (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@)))) (=> (= tmp%4@ (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ c1~14@))) (=> (= tmp%5@ (Mul d1~16@ (Mul a1~10@ (Mul b1~12@ c1~14@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> (= tmp%6@ (Mul (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@)))) (=> (= tmp%7@ (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ c1~14@))) (=> (= tmp%8@ (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%1 (= temp_1_0~450@ temp_1_1~515@)))))))))))) (=> (= temp_1_0~450@ temp_1_1~515@) (=> (= temp_2_0~750@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Sub 59 b2~20@))))) (=> (= temp_2_1~827@ (Mul (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@))) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ c2~22@))) (Mul (Mul a2~18@ d2~24@) (Sub 59 b2~20@)))) (and (=> (= tmp%9@ (Mul (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@)))) (=> (= tmp%10@ (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ c2~22@))) (=> (= tmp%11@ (Mul (Mul a2~18@ d2~24@) (Sub 59 b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%2 (= temp_2_0~750@ temp_2_1~827@)))))) (=> (= temp_2_0~750@ temp_2_1~827@) (=> (= temp_3_0~978@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Sub d3~32@ d3~32@) (Mul a3~26@ a3~26@))))) (=> (= temp_3_1~1051@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ d3~32@)) (Sub (Mul d3~32@ (Mul a3~26@ a3~26@)) (Mul d3~32@ (Mul a3~26@ a3~26@)))))) (and (=> (= tmp%12@ (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@)))) (=> (= tmp%13@ (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ d3~32@))) (=> (= tmp%14@ (Sub (Mul d3~32@ (Mul a3~26@ a3~26@)) (Mul d3~32@ (Mul a3~26@ a3~26@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> (= tmp%15@ (Mul a3~26@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d3~32@ d3~32@ tmp%15@) (=> (= tmp%16@ (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@)))) (=> (= tmp%17@ (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ d3~32@))) (=> (= tmp%18@ (Mul (Sub d3~32@ d3~32@) (Mul a3~26@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%3 (= temp_3_0~978@ temp_3_1~1051@)))))))))))) (=> (= temp_3_0~978@ temp_3_1~1051@) (=> (= temp_4_0~1282@ (Mul (Sub (Mul (Mul d4~40@ d4~40@) (Add a4~34@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~1347@ (Mul (Sub (Mul (Mul d4~40@ d4~40@) (Add a4~34@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul a4~34@ d4~40@)) (Mul b4~36@ b4~36@)))) (and (=> (= tmp%19@ (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@))) (=> (= tmp%20@ (Mul a4~34@ d4~40@)) (=> (= tmp%21@ (Mul b4~36@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%4 (= temp_4_0~1282@ temp_4_1~1347@)))))) (=> (= temp_4_0~1282@ temp_4_1~1347@) (=> (= temp_5_0~1474@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul 64 a5~42@))) (Mul (Mul (Mul c5~46@ b5~44@) (Add a5~42@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1551@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul 64 a5~42@))) (Mul (Mul c5~46@ b5~44@) (Mul (Add a5~42@ d5~48@) (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ c5~46@)))))) (and (=> (= tmp%22@ (Mul c5~46@ b5~44@)) (=> (= tmp%23@ (Add a5~42@ d5~48@)) (=> (= tmp%24@ (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ c5~46@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%5 (= temp_5_0~1474@ temp_5_1~1551@)))))) (=> (= temp_5_0~1474@ temp_5_1~1551@) (=> (= temp_6_0~1654@ (Sub (Add (Mul (Mul d6~56@ a6~50@) (Sub c6~54@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) c6~54@))) (=> (= temp_6_1~1707@ (Sub (Add (Mul (Mul d6~56@ a6~50@) (Sub c6~54@ d6~56@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) c6~54@))) (and (=> (= tmp%25@ (Mul d6~56@ c6~54@)) (=> (= tmp%26@ (Mul c6~54@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%25@ tmp%26@) (=> %%location_label%%6 (= temp_6_0~1654@ temp_6_1~1707@))))) (=> (= temp_6_0~1654@ temp_6_1~1707@) (=> (= temp_7_0~1808@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@))) (Mul (Sub (Mul d7~64@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1873@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ d7~64@)) (Sub (Mul d7~64@ b7~60@) (Mul d7~64@ c7~62@))))) (and (=> (= tmp%27@ (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ d7~64@))) (=> (= tmp%28@ (Sub (Mul d7~64@ b7~60@) (Mul d7~64@ c7~62@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%7 (= temp_7_0~1808@ temp_7_1~1873@))))) (=> (= temp_7_0~1808@ temp_7_1~1873@) (=> (= temp_8_0~1990@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Add a8~66@ a8~66@))) (Mul (Sub (Mul b8~68@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Add c8~70@ b8~68@))))) (=> (= temp_8_1~2055@ (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Add a8~66@ a8~66@)) (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@))) (Mul (Sub (Mul b8~68@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Add c8~70@ b8~68@))))) (and (=> (= tmp%29@ (Mul (Mul d8~72@ d8~72@) (Add a8~66@ a8~66@))) (=> (= tmp%30@ (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%29@ tmp%30@) (=> %%location_label%%8 (= temp_8_0~1990@ temp_8_1~2055@))))) (=> (= temp_8_0~1990@ temp_8_1~2055@) (=> (= temp_9_0~2172@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))) (Mul (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~2237@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))) (Mul (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul b9~76@ c9~78@))))) (=> (= tmp%31@ (= temp_9_0~2172@ temp_9_1~2237@)) (and (=> %%location_label%%9 tmp%31@) (=> tmp%31@ (=> (= temp_10_0~2317@ (Add (Mul (Mul (Mul d10~88@ d10~88@) (Sub d10~88@ c10~86@)) (Mul (Mul d10~88@ a10~82@) (Mul c10~86@ b10~84@))) (Mul (Mul (Sub c10~86@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~2382@ (Add (Mul (Mul (Mul d10~88@ d10~88@) (Sub d10~88@ c10~86@)) (Mul (Mul d10~88@ a10~82@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul (Sub c10~86@ b10~84@) d10~88@) a10~82@) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ d10~88@))))) (=> (= tmp%32@ (Sub c10~86@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%32@ d10~88@ a10~82@) (=> %%location_label%%10 (= temp_10_0~2317@ temp_10_1~2382@)))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
