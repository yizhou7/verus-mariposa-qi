...
(declare-const temp_2_0~709@ Int)
(declare-const temp_2_1~758@ Int)
(declare-const temp_3_0~939@ Int)
(declare-const temp_3_1~1000@ Int)
(declare-const temp_4_0~1099@ Int)
(declare-const temp_4_1~1164@ Int)
(declare-const temp_5_0~1317@ Int)
(declare-const temp_5_1~1382@ Int)
(declare-const temp_6_0~1481@ Int)
(declare-const temp_6_1~1546@ Int)
(declare-const temp_7_0~1753@ Int)
(declare-const temp_7_1~1802@ Int)
(declare-const temp_8_0~1913@ Int)
(declare-const temp_8_1~1978@ Int)
(declare-const temp_9_0~2099@ Int)
(declare-const temp_9_1~2132@ Int)
(declare-const temp_10_0~2236@ Int)
(declare-const temp_10_1~2325@ Int)
(declare-const temp_11_0~2418@ Int)
(declare-const temp_11_1~2491@ Int)
(declare-const temp_12_0~2642@ Int)
(declare-const temp_12_1~2723@ Int)
(declare-const temp_13_0~2946@ Int)
(declare-const temp_13_1~3003@ Int)
(declare-const temp_14_0~3182@ Int)
(declare-const temp_14_1~3219@ Int)
(declare-const temp_15_0~3304@ Int)
(declare-const temp_15_1~3361@ Int)
(declare-const temp_16_0~3560@ Int)
(declare-const temp_16_1~3621@ Int)
(declare-const temp_17_0~3834@ Int)
(declare-const temp_17_1~3907@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul (Mul (Sub d0~8@ c0~6@) (Mul b0~4@ d0~8@)) b0~4@) (Mul (Add (Mul d0~8@ c0~6@) d0~8@) (Mul (Sub d0~8@ c0~6@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~338@ (Mul (Mul (Sub d0~8@ c0~6@) (Mul (Mul b0~4@ d0~8@) b0~4@)) (Mul (Add (Mul d0~8@ c0~6@) d0~8@) (Mul (Sub d0~8@ c0~6@) (Mul b0~4@ b0~4@))))) (and (=> (= tmp%1@ (Sub d0~8@ c0~6@)) (=> (= tmp%2@ (Mul b0~4@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ b0~4@) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~338@))))) (=> (= temp_0_0~289@ temp_0_1~338@) (=> (= temp_1_0~453@ (Mul (Mul (Add (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul 22 d1~16@))) (Sub (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ b1~12@)) (Sub (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~574@ (Sub (Mul (Mul (Add (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul 22 d1~16@))) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ b1~12@))) (Mul (Mul (Add (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul 22 d1~16@))) (Sub (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))))) (and (=> (= tmp%3@ (Mul (Add (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul 22 d1~16@)))) (=> (= tmp%4@ (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ b1~12@))) (=> (= tmp%5@ (Sub (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~453@ temp_1_1~574@)))))) (=> (= temp_1_0~453@ temp_1_1~574@) (=> (= temp_2_0~709@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Add c2~22@ d2~24@)) (Sub d2~24@ (Mul d2~24@ b2~20@))) (Mul a2~18@ (Mul (Add c2~22@ d2~24@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~758@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Add c2~22@ d2~24@)) (Sub d2~24@ (Mul d2~24@ b2~20@))) (Mul a2~18@ (Mul (Add c2~22@ d2~24@) (Mul d2~24@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ a2~18@) (=> (= tmp%6@ (Mul (Mul (Mul b2~20@ d2~24@) (Add c2~22@ d2~24@)) (Sub d2~24@ (Mul d2~24@ b2~20@)))) (=> (= tmp%7@ (Mul (Add c2~22@ d2~24@) (Mul d2~24@ a2~18@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ a2~18@ tmp%7@) (=> (= tmp%8@ (Mul (Mul (Mul b2~20@ d2~24@) (Add c2~22@ d2~24@)) (Sub d2~24@ (Mul d2~24@ b2~20@)))) (=> (= tmp%9@ (Mul (Add c2~22@ d2~24@) (Mul a2~18@ d2~24@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ a2~18@ tmp%9@) (=> %%location_label%%2 (= temp_2_0~709@ temp_2_1~758@))))))))) (=> (= temp_2_0~709@ temp_2_1~758@) (=> (= temp_3_0~939@ (Mul (Mul (Mul c3~30@ (Mul b3~28@ b3~28@)) (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Add c3~30@ d3~32@))))) (=> (= temp_3_1~1000@ (Mul (Mul (Mul c3~30@ (Mul b3~28@ b3~28@)) (Mul (Mul (Mul d3~32@ a3~26@) c3~30@) c3~30@)) (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Add c3~30@ d3~32@))))) (and (=> (= tmp%10@ (Mul d3~32@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ c3~30@ c3~30@) (=> %%location_label%%3 (= temp_3_0~939@ temp_3_1~1000@)))) (=> (= temp_3_0~939@ temp_3_1~1000@) (=> (= temp_4_0~1099@ (Add (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@)) (Add (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Sub c4~38@ d4~40@) (Add b4~36@ a4~34@))))) (=> (= temp_4_1~1164@ (Add (Mul (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ c4~38@)) (Add (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Sub c4~38@ d4~40@) (Add b4~36@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ d4~40@) (=> (= tmp%11@ (Mul b4~36@ d4~40@)) (=> (= tmp%12@ (Mul b4~36@ c4~38@)) (=> (= tmp%13@ (Add (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> (= tmp%14@ (Mul d4~40@ b4~36@)) (=> (= tmp%15@ (Mul b4~36@ c4~38@)) (=> (= tmp%16@ (Add (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%4 (= temp_4_0~1099@ temp_4_1~1164@))))))))))) (=> (= temp_4_0~1099@ temp_4_1~1164@) (=> (= temp_5_0~1317@ (Mul (Mul (Add (Sub c5~46@ c5~46@) (Sub b5~44@ b5~44@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))) (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1382@ (Mul (Mul (Add (Sub c5~46@ c5~46@) (Sub b5~44@ b5~44@)) (Mul (Mul (Mul c5~46@ c5~46@) c5~46@) c5~46@)) (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ d5~48@))))) (and (=> (= tmp%17@ (Mul c5~46@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ c5~46@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1317@ temp_5_1~1382@)))) (=> (= temp_5_0~1317@ temp_5_1~1382@) (=> (= temp_6_0~1481@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul a6~50@ d6~56@)) (Mul (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1546@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul a6~50@ d6~56@)) (Mul (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Mul (Mul d6~56@ b6~52@) c6~54@) c6~54@)))) (and (=> (= tmp%18@ (Mul (Add (Mul d6~56@ b6~52@) (Mul a6~50@ d6~56@)) (Mul (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@)))) (=> (= tmp%19@ (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ a6~50@))) (=> (= tmp%20@ (Mul (Mul (Mul d6~56@ b6~52@) c6~54@) c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> (= tmp%21@ (Mul d6~56@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ c6~54@ c6~54@) (=> (= tmp%22@ (Mul (Add (Mul d6~56@ b6~52@) (Mul a6~50@ d6~56@)) (Mul (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@)))) (=> (= tmp%23@ (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ a6~50@))) (=> (= tmp%24@ (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%6 (= temp_6_0~1481@ temp_6_1~1546@)))))))))))) (=> (= temp_6_0~1481@ temp_6_1~1546@) (=> (= temp_7_0~1753@ (Add (Mul (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ b7~60@)) (Add a7~58@ (Mul a7~58@ a7~58@))) (Sub (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ a7~58@)) b7~60@))) (=> (= temp_7_1~1802@ (Add (Mul (Mul c7~62@ b7~60@) (Mul (Mul d7~64@ b7~60@) (Add a7~58@ (Mul a7~58@ a7~58@)))) (Sub (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ a7~58@)) b7~60@))) (and (=> (= tmp%25@ (Mul c7~62@ b7~60@)) (=> (= tmp%26@ (Mul d7~64@ b7~60@)) (=> (= tmp%27@ (Add a7~58@ (Mul a7~58@ a7~58@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%7 (= temp_7_0~1753@ temp_7_1~1802@)))))) (=> (= temp_7_0~1753@ temp_7_1~1802@) (=> (= temp_8_0~1913@ (Mul (Mul (Mul (Sub b8~68@ c8~70@) (Add c8~70@ b8~68@)) (Mul (Add b8~68@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ d8~72@)) (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))))) (=> (= temp_8_1~1978@ (Mul (Mul (Mul (Sub b8~68@ c8~70@) (Add c8~70@ b8~68@)) (Mul (Add b8~68@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ b8~68@) (=> (= tmp%28@ (Mul a8~66@ b8~68@)) (=> (= tmp%29@ (Mul b8~68@ d8~72@)) (=> (= tmp%30@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> (= tmp%31@ (Mul b8~68@ a8~66@)) (=> (= tmp%32@ (Mul b8~68@ d8~72@)) (=> (= tmp%33@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> %%location_label%%8 (= temp_8_0~1913@ temp_8_1~1978@))))))))))) (=> (= temp_8_0~1913@ temp_8_1~1978@) (=> (= temp_9_0~2099@ (Add b9~76@ (Mul (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ c9~78@)) (Mul a9~74@ (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~2132@ (Add b9~76@ (Mul (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ c9~78@)) (Mul a9~74@ (Mul a9~74@ a9~74@))))) (=> (= tmp%34@ (= temp_9_0~2099@ temp_9_1~2132@)) (and (=> %%location_label%%9 tmp%34@) (=> tmp%34@ (=> (= temp_10_0~2236@ (Add (Mul (Mul (Mul c10~86@ c10~86@) (Sub 10 b10~84@)) (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ c10~86@))) (Add (Mul (Mul b10~84@ b10~84@) (Mul 32 b10~84@)) (Mul (Mul c10~86@ d10~88@) (Sub d10~88@ c10~86@))))) (=> (= temp_10_1~2325@ (Add (Mul (Mul (Mul c10~86@ c10~86@) (Sub 10 b10~84@)) (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ c10~86@))) (Add (Mul (Mul 32 b10~84@) (Mul b10~84@ b10~84@)) (Mul (Mul c10~86@ d10~88@) (Sub d10~88@ c10~86@))))) (and (=> (= tmp%35@ (Mul 32 b10~84@)) (=> (= tmp%36@ (Mul b10~84@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%35@ tmp%36@) (=> %%location_label%%10 (= temp_10_0~2236@ temp_10_1~2325@))))) (=> (= temp_10_0~2236@ temp_10_1~2325@) (=> (= temp_11_0~2418@ (Mul (Mul c11~94@ (Sub (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@))) (Sub (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ a11~90@))))) (=> (= temp_11_1~2491@ (Sub (Mul (Mul c11~94@ (Sub (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@))) (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Mul c11~94@ (Sub (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@))) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ a11~90@))))) (and (=> (= tmp%37@ (Mul c11~94@ (Sub (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@)))) (=> (= tmp%38@ (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ d11~96@))) (=> (= tmp%39@ (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ a11~90@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%37@ tmp%38@ tmp%39@) (=> %%location_label%%11 (= temp_11_0~2418@ temp_11_1~2491@)))))) (=> (= temp_11_0~2418@ temp_11_1~2491@) (=> (= temp_12_0~2642@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) a12~98@) (Mul c12~102@ (Sub 68 d12~104@))) (Mul (Mul (Add d12~104@ a12~98@) (Mul b12~100@ c12~102@)) (Mul (Mul b12~100@ 58) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2723@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) a12~98@) (Mul c12~102@ (Sub 68 d12~104@))) (Mul (Mul (Add d12~104@ a12~98@) (Mul b12~100@ c12~102@)) (Mul (Mul (Mul b12~100@ 58) b12~100@) a12~98@)))) (and (=> (= tmp%40@ (Mul (Mul (Mul b12~100@ d12~104@) a12~98@) (Mul c12~102@ (Sub 68 d12~104@)))) (=> (= tmp%41@ (Mul (Add d12~104@ a12~98@) (Mul b12~100@ c12~102@))) (=> (= tmp%42@ (Mul (Mul (Mul b12~100@ 58) b12~100@) a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ tmp%41@ tmp%42@) (=> (= tmp%43@ (Mul b12~100@ 58)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%43@ b12~100@ a12~98@) (=> (= tmp%44@ (Mul (Mul (Mul b12~100@ d12~104@) a12~98@) (Mul c12~102@ (Sub 68 d12~104@)))) (=> (= tmp%45@ (Mul (Add d12~104@ a12~98@) (Mul b12~100@ c12~102@))) (=> (= tmp%46@ (Mul (Mul b12~100@ 58) (Mul b12~100@ a12~98@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%44@ tmp%45@ tmp%46@) (=> %%location_label%%12 (= temp_12_0~2642@ temp_12_1~2723@)))))))))))) (=> (= temp_12_0~2642@ temp_12_1~2723@) (=> (= temp_13_0~2946@ (Mul (Sub (Mul c13~110@ (Mul c13~110@ d13~112@)) (Mul (Mul a13~106@ a13~106@) (Mul d13~112@ a13~106@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ b13~108@)) (Sub (Mul d13~112@ b13~108@) (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~3003@ (Mul (Sub (Mul c13~110@ (Mul c13~110@ d13~112@)) (Mul (Mul a13~106@ a13~106@) (Mul d13~112@ a13~106@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ b13~108@)) (Mul d13~112@ (Sub b13~108@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d13~112@ b13~108@ c13~110@) (=> (= tmp%47@ (Sub (Mul c13~110@ (Mul c13~110@ d13~112@)) (Mul (Mul a13~106@ a13~106@) (Mul d13~112@ a13~106@)))) (=> (= tmp%48@ (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ b13~108@))) (=> (= tmp%49@ (Mul d13~112@ (Sub b13~108@ c13~110@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%47@ tmp%48@ tmp%49@) (=> (= tmp%50@ (Sub (Mul c13~110@ (Mul c13~110@ d13~112@)) (Mul (Mul a13~106@ a13~106@) (Mul d13~112@ a13~106@)))) (=> (= tmp%51@ (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ b13~108@))) (=> (= tmp%52@ (Sub (Mul d13~112@ b13~108@) (Mul d13~112@ c13~110@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%50@ tmp%51@ tmp%52@) (=> %%location_label%%13 (= temp_13_0~2946@ temp_13_1~3003@))))))))))) (=> (= temp_13_0~2946@ temp_13_1~3003@) (=> (= temp_14_0~3182@ (Mul c14~118@ (Mul (Sub (Mul a14~114@ c14~118@) (Mul b14~116@ d14~120@)) (Mul (Sub b14~116@ c14~118@) (Mul a14~114@ c14~118@))))) (=> (= temp_14_1~3219@ (Mul c14~118@ (Mul (Sub (Mul c14~118@ a14~114@) (Mul b14~116@ d14~120@)) (Mul (Sub b14~116@ c14~118@) (Mul a14~114@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c14~118@ a14~114@) (=> %%location_label%%14 (= temp_14_0~3182@ temp_14_1~3219@))) (=> (= temp_14_0~3182@ temp_14_1~3219@) (=> (= temp_15_0~3304@ (Mul (Add (Mul (Mul d15~128@ b15~124@) b15~124@) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ c15~126@))) (Mul (Add (Mul b15~124@ a15~122@) (Mul d15~128@ d15~128@)) (Mul b15~124@ (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~3361@ (Mul (Add (Mul (Mul d15~128@ b15~124@) b15~124@) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ c15~126@))) (Mul (Add (Mul b15~124@ a15~122@) (Mul d15~128@ d15~128@)) (Mul (Mul b15~124@ c15~126@) a15~122@)))) (and (=> (= tmp%53@ (Add (Mul (Mul d15~128@ b15~124@) b15~124@) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ c15~126@)))) (=> (= tmp%54@ (Add (Mul b15~124@ a15~122@) (Mul d15~128@ d15~128@))) (=> (= tmp%55@ (Mul (Mul b15~124@ c15~126@) a15~122@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%53@ tmp%54@ tmp%55@) (=> (ens%main!nl_basics.lemma_mul_is_associative. b15~124@ c15~126@ a15~122@) (=> (= tmp%56@ (Add (Mul (Mul d15~128@ b15~124@) b15~124@) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ c15~126@)))) (=> (= tmp%57@ (Add (Mul b15~124@ a15~122@) (Mul d15~128@ d15~128@))) (=> (= tmp%58@ (Mul b15~124@ (Mul c15~126@ a15~122@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%56@ tmp%57@ tmp%58@) (=> %%location_label%%15 (= temp_15_0~3304@ temp_15_1~3361@))))))))))) (=> (= temp_15_0~3304@ temp_15_1~3361@) (=> (= temp_16_0~3560@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ c16~134@)) (Sub (Sub a16~130@ c16~134@) (Mul a16~130@ b16~132@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ a16~130@)) (Mul b16~132@ (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~3621@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ c16~134@)) (Sub (Sub a16~130@ c16~134@) (Mul a16~130@ b16~132@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul a16~130@ d16~136@) b16~132@)))) (and (=> (= tmp%59@ (Mul a16~130@ d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%59@ b16~132@) (=> (= tmp%60@ (Mul (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ c16~134@)) (Sub (Sub a16~130@ c16~134@) (Mul a16~130@ b16~132@)))) (=> (= tmp%61@ (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ a16~130@))) (=> (= tmp%62@ (Mul (Mul a16~130@ d16~136@) b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%60@ tmp%61@ tmp%62@) (=> (= tmp%63@ (Mul (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ c16~134@)) (Sub (Sub a16~130@ c16~134@) (Mul a16~130@ b16~132@)))) (=> (= tmp%64@ (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ a16~130@))) (=> (= tmp%65@ (Mul b16~132@ (Mul a16~130@ d16~136@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%63@ tmp%64@ tmp%65@) (=> %%location_label%%16 (= temp_16_0~3560@ temp_16_1~3621@)))))))))))) (=> (= temp_16_0~3560@ temp_16_1~3621@) (=> (= temp_17_0~3834@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Sub a17~138@ c17~142@)) (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@))) (Mul (Mul (Mul d17~144@ c17~142@) (Add b17~140@ b17~140@)) (Sub (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@))))) (=> (= temp_17_1~3907@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Sub a17~138@ c17~142@)) (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@))) (Mul (Add (Mul (Mul d17~144@ c17~142@) b17~140@) (Mul (Mul d17~144@ c17~142@) b17~140@)) (Sub (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@))))) (=> (= tmp%66@ (Mul d17~144@ c17~142@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%66@ b17~140@ b17~140@) (=> %%location_label%%17 (= temp_17_0~3834@ temp_17_1~3907@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
