...
(declare-const temp_3_0~987@ Int)
(declare-const temp_3_1~1052@ Int)
(declare-const temp_4_0~1132@ Int)
(declare-const temp_4_1~1197@ Int)
(declare-const temp_5_0~1302@ Int)
(declare-const temp_5_1~1379@ Int)
(declare-const temp_6_0~1456@ Int)
(declare-const temp_6_1~1505@ Int)
(declare-const temp_7_0~1582@ Int)
(declare-const temp_7_1~1639@ Int)
(declare-const temp_8_0~1722@ Int)
(declare-const temp_8_1~1775@ Int)
(declare-const temp_9_0~1890@ Int)
(declare-const temp_9_1~1939@ Int)
(declare-const temp_10_0~2042@ Int)
(declare-const temp_10_1~2103@ Int)
(declare-const temp_11_0~2320@ Int)
(declare-const temp_11_1~2393@ Int)
(declare-const temp_12_0~2498@ Int)
(declare-const temp_12_1~2555@ Int)
(declare-const temp_13_0~2756@ Int)
(declare-const temp_13_1~2821@ Int)
(declare-const temp_14_0~2970@ Int)
(declare-const temp_14_1~3035@ Int)
(declare-const temp_15_0~3115@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Mul c0~6@ (Mul (Add d0~8@ 1) (Mul b0~4@ d0~8@))) (Sub (Add (Mul d0~8@ c0~6@) (Add b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ a0~2@))))) (=> (= temp_0_1~378@ (Sub (Mul c0~6@ (Add (Mul d0~8@ (Mul b0~4@ d0~8@)) (Mul 1 (Mul b0~4@ d0~8@)))) (Sub (Add (Mul d0~8@ c0~6@) (Add b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ a0~2@))))) (and (=> (= tmp%1@ (Mul b0~4@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d0~8@ 1 tmp%1@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~378@)))) (=> (= temp_0_0~305@ temp_0_1~378@) (=> (= temp_1_0~493@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul 19 d1~16@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~570@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul (Mul 19 d1~16@) c1~14@) b1~12@)))) (and (=> (= tmp%2@ (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@)))) (=> (= tmp%3@ (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ a1~10@))) (=> (= tmp%4@ (Mul (Mul (Mul 19 d1~16@) c1~14@) b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> (= tmp%5@ (Mul 19 d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ c1~14@ b1~12@) (=> (= tmp%6@ (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@)))) (=> (= tmp%7@ (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ a1~10@))) (=> (= tmp%8@ (Mul (Mul 19 d1~16@) (Mul c1~14@ b1~12@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%1 (= temp_1_0~493@ temp_1_1~570@)))))))))))) (=> (= temp_1_0~493@ temp_1_1~570@) (=> (= temp_2_0~817@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul 84 c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ a2~18@))) (Sub (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Sub c2~22@ b2~20@) (Add c2~22@ c2~22@))))) (=> (= temp_2_1~894@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul 84 c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ a2~18@))) (Sub (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Sub c2~22@ b2~20@) (Add c2~22@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ a2~18@) (=> %%location_label%%2 (= temp_2_0~817@ temp_2_1~894@))) (=> (= temp_2_0~817@ temp_2_1~894@) (=> (= temp_3_0~987@ (Sub (Mul (Mul (Add d3~32@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@))) (Mul (Mul (Sub d3~32@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~1052@ (Sub (Mul (Mul (Add d3~32@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@))) (Mul (Mul (Sub d3~32@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= tmp%9@ (= temp_3_0~987@ temp_3_1~1052@)) (and (=> %%location_label%%3 tmp%9@) (=> tmp%9@ (=> (= temp_4_0~1132@ (Sub (Add (Add (Mul b4~36@ a4~34@) (Sub c4~38@ b4~36@)) (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul c4~38@ b4~36@) (Add d4~40@ c4~38@)) (Sub (Mul d4~40@ c4~38@) (Add b4~36@ c4~38@))))) (=> (= temp_4_1~1197@ (Sub (Add (Add (Mul b4~36@ a4~34@) (Sub c4~38@ b4~36@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul c4~38@ b4~36@) (Add d4~40@ c4~38@)) (Sub (Mul d4~40@ c4~38@) (Add b4~36@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c4~38@ b4~36@) (=> %%location_label%%4 (= temp_4_0~1132@ temp_4_1~1197@))) (=> (= temp_4_0~1132@ temp_4_1~1197@) (=> (= temp_5_0~1302@ (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) (Sub (Mul a5~42@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Add b5~44@ 19))))) (=> (= temp_5_1~1379@ (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) (Sub (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Add b5~44@ 19))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1302@ temp_5_1~1379@))) (=> (= temp_5_0~1302@ temp_5_1~1379@) (=> (= temp_6_0~1456@ (Add (Sub (Mul (Mul d6~56@ c6~54@) (Add 68 a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))) b6~52@)) (=> (= temp_6_1~1505@ (Add (Sub (Mul (Mul d6~56@ c6~54@) (Add 68 a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ d6~56@))) b6~52@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1456@ temp_6_1~1505@))) (=> (= temp_6_0~1456@ temp_6_1~1505@) (=> (= temp_7_0~1582@ (Mul (Add (Mul (Sub d7~64@ c7~62@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ d7~64@) (Add c7~62@ a7~58@))) (Mul b7~60@ (Mul (Mul a7~58@ a7~58@) a7~58@)))) (=> (= temp_7_1~1639@ (Mul (Add (Sub (Mul d7~64@ (Mul c7~62@ d7~64@)) (Mul c7~62@ (Mul c7~62@ d7~64@))) (Mul (Mul d7~64@ d7~64@) (Add c7~62@ a7~58@))) (Mul b7~60@ (Mul (Mul a7~58@ a7~58@) a7~58@)))) (and (=> (= tmp%10@ (Mul c7~62@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d7~64@ c7~62@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~1582@ temp_7_1~1639@)))) (=> (= temp_7_0~1582@ temp_7_1~1639@) (=> (= temp_8_0~1722@ (Mul (Sub (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@)) (Mul (Mul a8~66@ d8~72@) (Mul 14 a8~66@))) d8~72@)) (=> (= temp_8_1~1775@ (Sub (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@)) d8~72@) (Mul (Mul (Mul a8~66@ d8~72@) (Mul 14 a8~66@)) d8~72@))) (and (=> (= tmp%11@ (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@))) (=> (= tmp%12@ (Mul (Mul a8~66@ d8~72@) (Mul 14 a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ tmp%12@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1722@ temp_8_1~1775@))))) (=> (= temp_8_0~1722@ temp_8_1~1775@) (=> (= temp_9_0~1890@ (Mul (Mul (Mul b9~76@ (Mul a9~74@ a9~74@)) (Mul (Mul d9~80@ c9~78@) a9~74@)) (Sub (Mul (Sub c9~78@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1939@ (Mul (Mul (Mul b9~76@ (Mul a9~74@ a9~74@)) (Mul (Mul d9~80@ c9~78@) a9~74@)) (Mul (Sub (Sub c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Mul a9~74@ c9~78@)))) (and (=> (= tmp%13@ (Sub c9~78@ d9~80@)) (=> (= tmp%14@ (Mul b9~76@ c9~78@)) (=> (= tmp%15@ (Mul a9~74@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%9 (= temp_9_0~1890@ temp_9_1~1939@)))))) (=> (= temp_9_0~1890@ temp_9_1~1939@) (=> (= temp_10_0~2042@ (Mul (Mul (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Mul a10~82@ a10~82@) d10~88@)) (Mul (Add (Mul a10~82@ a10~82@) (Mul d10~88@ d10~88@)) (Add (Mul b10~84@ a10~82@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~2103@ (Mul (Mul (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Mul a10~82@ a10~82@) d10~88@)) (Mul (Add (Mul a10~82@ a10~82@) (Mul d10~88@ d10~88@)) (Add (Mul b10~84@ a10~82@) (Mul c10~86@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ d10~88@) (=> (= tmp%16@ (Mul (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Mul a10~82@ a10~82@) d10~88@))) (=> (= tmp%17@ (Add (Mul a10~82@ a10~82@) (Mul d10~88@ d10~88@))) (=> (= tmp%18@ (Add (Mul b10~84@ a10~82@) (Mul c10~86@ d10~88@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> (= tmp%19@ (Mul (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Mul a10~82@ a10~82@) d10~88@))) (=> (= tmp%20@ (Add (Mul a10~82@ a10~82@) (Mul d10~88@ d10~88@))) (=> (= tmp%21@ (Add (Mul b10~84@ a10~82@) (Mul d10~88@ c10~86@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%10 (= temp_10_0~2042@ temp_10_1~2103@))))))))))) (=> (= temp_10_0~2042@ temp_10_1~2103@) (=> (= temp_11_0~2320@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@)) (Mul (Add a11~90@ c11~94@) c11~94@)) (Add (Add (Mul a11~90@ b11~92@) (Mul b11~92@ c11~94@)) (Mul (Add a11~90@ 23) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2393@ (Mul (Mul (Mul (Add a11~90@ c11~94@) c11~94@) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (Add (Add (Mul a11~90@ b11~92@) (Mul b11~92@ c11~94@)) (Mul (Add a11~90@ 23) (Mul d11~96@ b11~92@))))) (and (=> (= tmp%22@ (Mul (Add a11~90@ c11~94@) c11~94@)) (=> (= tmp%23@ (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%11 (= temp_11_0~2320@ temp_11_1~2393@))))) (=> (= temp_11_0~2320@ temp_11_1~2393@) (=> (= temp_12_0~2498@ (Mul (Mul (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@)) (Mul a12~98@ (Add b12~100@ a12~98@))) (Mul (Add a12~98@ (Add b12~100@ b12~100@)) (Add (Mul c12~102@ d12~104@) (Mul b12~100@ c12~102@))))) (=> (= temp_12_1~2555@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ a12~98@)) (Mul a12~98@ (Add b12~100@ a12~98@))) (Mul (Add a12~98@ (Add b12~100@ b12~100@)) (Add (Mul c12~102@ d12~104@) (Mul b12~100@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c12~102@ d12~104@) (=> (= tmp%24@ (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ a12~98@))) (=> (= tmp%25@ (Mul a12~98@ (Add b12~100@ a12~98@))) (=> (= tmp%26@ (Mul (Add a12~98@ (Add b12~100@ b12~100@)) (Add (Mul c12~102@ d12~104@) (Mul b12~100@ c12~102@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> (= tmp%27@ (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@))) (=> (= tmp%28@ (Mul a12~98@ (Add b12~100@ a12~98@))) (=> (= tmp%29@ (Mul (Add a12~98@ (Add b12~100@ b12~100@)) (Add (Mul c12~102@ d12~104@) (Mul b12~100@ c12~102@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ tmp%29@) (=> %%location_label%%12 (= temp_12_0~2498@ temp_12_1~2555@))))))))))) (=> (= temp_12_0~2498@ temp_12_1~2555@) (=> (= temp_13_0~2756@ (Mul (Mul (Mul (Add b13~108@ a13~106@) (Add b13~108@ c13~110@)) (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@))) (Mul (Add (Add b13~108@ c13~110@) (Mul a13~106@ d13~112@)) (Sub (Mul c13~110@ b13~108@) (Sub d13~112@ c13~110@))))) (=> (= temp_13_1~2821@ (Mul (Mul (Add (Add b13~108@ c13~110@) (Mul a13~106@ d13~112@)) (Sub (Mul c13~110@ b13~108@) (Sub d13~112@ c13~110@))) (Mul (Mul (Add b13~108@ a13~106@) (Add b13~108@ c13~110@)) (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@))))) (and (=> (= tmp%30@ (Mul (Add (Add b13~108@ c13~110@) (Mul a13~106@ d13~112@)) (Sub (Mul c13~110@ b13~108@) (Sub d13~112@ c13~110@)))) (=> (= tmp%31@ (Mul (Mul (Add b13~108@ a13~106@) (Add b13~108@ c13~110@)) (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%30@ tmp%31@) (=> %%location_label%%13 (= temp_13_0~2756@ temp_13_1~2821@))))) (=> (= temp_13_0~2756@ temp_13_1~2821@) (=> (= temp_14_0~2970@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ b14~116@)) (Add (Sub b14~116@ d14~120@) (Mul b14~116@ a14~114@))) (Mul (Sub (Add d14~120@ c14~118@) (Sub c14~118@ d14~120@)) (Mul (Sub b14~116@ b14~116@) (Mul b14~116@ a14~114@))))) (=> (= temp_14_1~3035@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ b14~116@)) (Add (Sub b14~116@ d14~120@) (Mul b14~116@ a14~114@))) (Mul (Sub (Add d14~120@ c14~118@) (Sub c14~118@ d14~120@)) (Mul (Sub b14~116@ b14~116@) (Mul b14~116@ a14~114@))))) (=> (= tmp%32@ (= temp_14_0~2970@ temp_14_1~3035@)) (and (=> %%location_label%%14 tmp%32@) (=> tmp%32@ (=> (= temp_15_0~3115@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Sub b15~124@ d15~128@)) (Sub (Mul d15~128@ b15~124@) (Mul a15~122@ c15~126@))) (Mul (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ c15~126@)) (Add (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~3180@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Sub b15~124@ d15~128@)) (Sub (Mul d15~128@ b15~124@) (Mul a15~122@ c15~126@))) (Mul (Mul (Mul (Mul b15~124@ a15~122@) b15~124@) c15~126@) (Add (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= tmp%33@ (Mul b15~124@ a15~122@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ b15~124@ c15~126@) (=> %%location_label%%15 (= temp_15_0~3115@ temp_15_1~3180@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
