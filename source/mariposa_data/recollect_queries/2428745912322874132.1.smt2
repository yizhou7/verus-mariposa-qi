...
(declare-const temp_2_1~880@ Int)
(declare-const temp_3_0~977@ Int)
(declare-const temp_3_1~1042@ Int)
(declare-const temp_4_0~1139@ Int)
...
(declare-const temp_6_1~1578@ Int)
(declare-const temp_7_0~1721@ Int)
(declare-const temp_7_1~1798@ Int)
(declare-const temp_8_0~1913@ Int)
(declare-const temp_8_1~1978@ Int)
(declare-const temp_9_0~2067@ Int)
(declare-const temp_9_1~2128@ Int)
(declare-const temp_10_0~2239@ Int)
(declare-const temp_10_1~2304@ Int)
(declare-const temp_11_0~2453@ Int)
(declare-const temp_11_1~2518@ Int)
(declare-const temp_12_0~2755@ Int)
(declare-const temp_12_1~2832@ Int)
(declare-const temp_13_0~2939@ Int)
(declare-const temp_13_1~3012@ Int)
(declare-const temp_14_0~3233@ Int)
(declare-const temp_14_1~3294@ Int)
(declare-const temp_15_0~3407@ Int)
(declare-const temp_15_1~3484@ Int)
(declare-const temp_16_0~3629@ Int)
(declare-const temp_16_1~3694@ Int)
(declare-const temp_17_0~3925@ Int)
(declare-const temp_17_1~3998@ Int)
(declare-const temp_18_0~4074@ Int)
(declare-const temp_18_1~4135@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Sub (Mul d0~8@ d0~8@) (Add b0~4@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Sub (Mul d0~8@ d0~8@) (Add b0~4@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul a0~2@ (Mul b0~4@ (Mul c0~6@ a0~2@)))))) (and (=> (= tmp%1@ (Mul c0~6@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a0~2@ b0~4@ tmp%1@) (=> (= tmp%2@ (Mul (Sub (Mul d0~8@ d0~8@) (Add b0~4@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@)))) (=> (= tmp%3@ (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@))) (=> (= tmp%4@ (Mul a0~2@ (Mul b0~4@ (Mul c0~6@ a0~2@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> (= tmp%5@ (Mul (Sub (Mul d0~8@ d0~8@) (Add b0~4@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@)))) (=> (= tmp%6@ (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@))) (=> (= tmp%7@ (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))))))))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~605@ (Add (Mul (Mul (Mul a1~10@ 23) (Mul c1~14@ d1~16@)) (Mul (Sub a1~10@ c1~14@) (Mul b1~12@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Add a1~10@ b1~12@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~682@ (Add (Mul (Mul (Mul 23 a1~10@) (Mul c1~14@ d1~16@)) (Mul (Sub a1~10@ c1~14@) (Mul b1~12@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Add a1~10@ b1~12@) (Mul d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 23 a1~10@) (=> (= tmp%8@ (Mul 23 a1~10@)) (=> (= tmp%9@ (Mul c1~14@ d1~16@)) (=> (= tmp%10@ (Mul (Sub a1~10@ c1~14@) (Mul b1~12@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> (= tmp%11@ (Mul a1~10@ 23)) (=> (= tmp%12@ (Mul c1~14@ d1~16@)) (=> (= tmp%13@ (Mul (Sub a1~10@ c1~14@) (Mul b1~12@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%1 (= temp_1_0~605@ temp_1_1~682@))))))))))) (=> (= temp_1_0~605@ temp_1_1~682@) (=> (= temp_2_0~831@ (Add (Mul (Mul (Sub d2~24@ d2~24@) (Sub c2~22@ d2~24@)) (Mul (Add b2~20@ a2~18@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul d2~24@ c2~22@) c2~22@) d2~24@))) (=> (= temp_2_1~880@ (Add (Mul (Mul (Sub d2~24@ d2~24@) (Sub c2~22@ d2~24@)) (Mul (Add b2~20@ a2~18@) (Mul c2~22@ d2~24@))) (Mul (Mul c2~22@ (Mul d2~24@ c2~22@)) d2~24@))) (and (=> (= tmp%14@ (Mul d2~24@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ tmp%14@) (=> %%location_label%%2 (= temp_2_0~831@ temp_2_1~880@)))) (=> (= temp_2_0~831@ temp_2_1~880@) (=> (= temp_3_0~977@ (Add (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul (Add a3~26@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~1042@ (Add (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul (Add a3~26@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ d3~32@))))) (and (=> (= tmp%15@ (Mul b3~28@ a3~26@)) (=> (= tmp%16@ (Mul b3~28@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%3 (= temp_3_0~977@ temp_3_1~1042@))))) (=> (= temp_3_0~977@ temp_3_1~1042@) (=> (= temp_4_0~1139@ (Add (Mul (Sub a4~34@ (Mul b4~36@ b4~36@)) c4~38@) (Mul (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ 45))))) (=> (= temp_4_1~1200@ (Add (Mul (Sub a4~34@ (Mul b4~36@ b4~36@)) c4~38@) (Mul (Sub (Mul b4~36@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ 45))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ a4~34@) (=> %%location_label%%4 (= temp_4_0~1139@ temp_4_1~1200@))) (=> (= temp_4_0~1139@ temp_4_1~1200@) (=> (= temp_5_0~1305@ (Mul (Mul (Mul (Add b5~44@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ b5~44@)) (Sub (Mul 56 a5~42@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1382@ (Mul (Mul (Mul (Add b5~44@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul c5~46@ (Mul c5~46@ (Mul c5~46@ b5~44@))) (Sub (Mul 56 a5~42@) (Mul a5~42@ d5~48@))))) (and (=> (= tmp%17@ (Mul c5~46@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c5~46@ c5~46@ tmp%17@) (=> %%location_label%%5 (= temp_5_0~1305@ temp_5_1~1382@)))) (=> (= temp_5_0~1305@ temp_5_1~1382@) (=> (= temp_6_0~1481@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Add (Sub a6~50@ a6~50@) (Mul c6~54@ c6~54@))) (Sub (Mul (Add a6~50@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1578@ (Sub (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Add (Sub a6~50@ a6~50@) (Mul c6~54@ c6~54@))) (Mul (Add a6~50@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Add (Sub a6~50@ a6~50@) (Mul c6~54@ c6~54@))) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (and (=> (= tmp%18@ (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Add (Sub a6~50@ a6~50@) (Mul c6~54@ c6~54@)))) (=> (= tmp%19@ (Mul (Add a6~50@ d6~56@) (Mul d6~56@ b6~52@))) (=> (= tmp%20@ (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%6 (= temp_6_0~1481@ temp_6_1~1578@)))))) (=> (= temp_6_0~1481@ temp_6_1~1578@) (=> (= temp_7_0~1721@ (Mul (Mul (Sub (Add b7~60@ b7~60@) (Sub a7~58@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@)) (Add (Mul c7~62@ d7~64@) a7~58@)))) (=> (= temp_7_1~1798@ (Mul (Sub (Mul (Add b7~60@ b7~60@) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ b7~60@))) (Mul (Sub a7~58@ b7~60@) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ b7~60@)))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@)) (Add (Mul c7~62@ d7~64@) a7~58@)))) (and (=> (= tmp%21@ (Add b7~60@ b7~60@)) (=> (= tmp%22@ (Sub a7~58@ b7~60@)) (=> (= tmp%23@ (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ b7~60@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%7 (= temp_7_0~1721@ temp_7_1~1798@)))))) (=> (= temp_7_0~1721@ temp_7_1~1798@) (=> (= temp_8_0~1913@ (Add (Mul (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ b8~68@)) (Sub (Sub d8~72@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul 12 a8~66@) (Mul d8~72@ b8~68@)) a8~66@))) (=> (= temp_8_1~1978@ (Add (Mul (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ c8~70@)) (Sub (Sub d8~72@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul 12 a8~66@) (Mul d8~72@ b8~68@)) a8~66@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ c8~70@) (=> %%location_label%%8 (= temp_8_0~1913@ temp_8_1~1978@))) (=> (= temp_8_0~1913@ temp_8_1~1978@) (=> (= temp_9_0~2067@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ c9~78@)) (Mul a9~74@ (Mul a9~74@ b9~76@))) (Mul (Mul (Mul c9~78@ c9~78@) (Add b9~76@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~2128@ (Mul (Mul (Mul b9~76@ a9~74@) (Mul (Mul d9~80@ c9~78@) (Mul a9~74@ (Mul a9~74@ b9~76@)))) (Mul (Mul (Mul c9~78@ c9~78@) (Add b9~76@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ a9~74@))))) (and (=> (= tmp%24@ (Mul b9~76@ a9~74@)) (=> (= tmp%25@ (Mul d9~80@ c9~78@)) (=> (= tmp%26@ (Mul a9~74@ (Mul a9~74@ b9~76@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%9 (= temp_9_0~2067@ temp_9_1~2128@)))))) (=> (= temp_9_0~2067@ temp_9_1~2128@) (=> (= temp_10_0~2239@ (Mul (Mul (Mul (Add d10~88@ c10~86@) (Mul a10~82@ a10~82@)) (Mul (Mul d10~88@ d10~88@) (Add d10~88@ d10~88@))) (Mul (Sub (Mul a10~82@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~2304@ (Mul (Mul (Sub (Mul a10~82@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ d10~88@))) (Mul (Mul (Add d10~88@ c10~86@) (Mul a10~82@ a10~82@)) (Mul (Mul d10~88@ d10~88@) (Add d10~88@ d10~88@))))) (and (=> (= tmp%27@ (Mul (Sub (Mul a10~82@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ d10~88@)))) (=> (= tmp%28@ (Mul (Mul (Add d10~88@ c10~86@) (Mul a10~82@ a10~82@)) (Mul (Mul d10~88@ d10~88@) (Add d10~88@ d10~88@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%10 (= temp_10_0~2239@ temp_10_1~2304@))))) (=> (= temp_10_0~2239@ temp_10_1~2304@) (=> (= temp_11_0~2453@ (Mul (Mul (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ b11~92@)) (Add (Mul d11~96@ c11~94@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul a11~90@ b11~92@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Sub c11~94@ c11~94@))))) (=> (= temp_11_1~2518@ (Mul (Mul (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ a11~90@)) (Add (Mul d11~96@ c11~94@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul a11~90@ b11~92@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Sub c11~94@ c11~94@))))) (and (=> (= tmp%29@ (Mul a11~90@ b11~92@)) (=> (= tmp%30@ (Mul c11~94@ a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%29@ tmp%30@) (=> (= tmp%31@ (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ a11~90@))) (=> (= tmp%32@ (Add (Mul d11~96@ c11~94@) (Mul a11~90@ d11~96@))) (=> (= tmp%33@ (Mul (Mul (Mul a11~90@ b11~92@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Sub c11~94@ c11~94@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%31@ tmp%32@ tmp%33@) (=> (= tmp%34@ (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ b11~92@))) (=> (= tmp%35@ (Add (Mul d11~96@ c11~94@) (Mul a11~90@ d11~96@))) (=> (= tmp%36@ (Mul (Mul (Mul a11~90@ b11~92@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Sub c11~94@ c11~94@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%34@ tmp%35@ tmp%36@) (=> %%location_label%%11 (= temp_11_0~2453@ temp_11_1~2518@))))))))))))) (=> (= temp_11_0~2453@ temp_11_1~2518@) (=> (= temp_12_0~2755@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Mul a12~98@ a12~98@)) (Mul (Add d12~104@ d12~104@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul b12~100@ 66) (Mul d12~104@ c12~102@))))) (=> (= temp_12_1~2832@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Mul a12~98@ a12~98@)) (Mul (Add d12~104@ d12~104@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul (Mul b12~100@ d12~104@) b12~100@) b12~100@) (Mul (Mul b12~100@ 66) (Mul d12~104@ c12~102@))))) (and (=> (= tmp%37@ (Mul b12~100@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%37@ b12~100@ b12~100@) (=> %%location_label%%12 (= temp_12_0~2755@ temp_12_1~2832@)))) (=> (= temp_12_0~2755@ temp_12_1~2832@) (=> (= temp_13_0~2939@ (Mul (Mul (Add (Mul a13~106@ 39) (Mul b13~108@ a13~106@)) (Add (Mul a13~106@ d13~112@) (Mul a13~106@ a13~106@))) (Mul (Mul a13~106@ (Mul a13~106@ d13~112@)) (Mul (Sub c13~110@ b13~108@) (Mul d13~112@ d13~112@))))) (=> (= temp_13_1~3012@ (Mul (Mul (Add (Mul a13~106@ 39) (Mul b13~108@ a13~106@)) (Add (Mul a13~106@ d13~112@) (Mul a13~106@ a13~106@))) (Mul (Mul a13~106@ (Mul a13~106@ d13~112@)) (Mul (Mul d13~112@ d13~112@) (Sub c13~110@ b13~108@))))) (and (=> (= tmp%38@ (Mul d13~112@ d13~112@)) (=> (= tmp%39@ (Sub c13~110@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%38@ tmp%39@) (=> (= tmp%40@ (Mul (Add (Mul a13~106@ 39) (Mul b13~108@ a13~106@)) (Add (Mul a13~106@ d13~112@) (Mul a13~106@ a13~106@)))) (=> (= tmp%41@ (Mul a13~106@ (Mul a13~106@ d13~112@))) (=> (= tmp%42@ (Mul (Mul d13~112@ d13~112@) (Sub c13~110@ b13~108@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%40@ tmp%41@ tmp%42@) (=> (= tmp%43@ (Mul (Add (Mul a13~106@ 39) (Mul b13~108@ a13~106@)) (Add (Mul a13~106@ d13~112@) (Mul a13~106@ a13~106@)))) (=> (= tmp%44@ (Mul a13~106@ (Mul a13~106@ d13~112@))) (=> (= tmp%45@ (Mul (Sub c13~110@ b13~108@) (Mul d13~112@ d13~112@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%43@ tmp%44@ tmp%45@) (=> %%location_label%%13 (= temp_13_0~2939@ temp_13_1~3012@))))))))))))) (=> (= temp_13_0~2939@ temp_13_1~3012@) (=> (= temp_14_0~3233@ (Sub (Mul (Mul (Add d14~120@ c14~118@) (Mul a14~114@ d14~120@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@))) (Sub (Mul (Mul b14~116@ b14~116@) (Mul c14~118@ d14~120@)) (Mul (Mul c14~118@ a14~114@) b14~116@)))) (=> (= temp_14_1~3294@ (Sub (Mul (Mul (Add d14~120@ c14~118@) (Mul a14~114@ d14~120@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@))) (Sub (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ b14~116@)) (Mul (Mul c14~118@ a14~114@) b14~116@)))) (and (=> (= tmp%46@ (Mul c14~118@ d14~120@)) (=> (= tmp%47@ (Mul b14~116@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%46@ tmp%47@) (=> %%location_label%%14 (= temp_14_0~3233@ temp_14_1~3294@))))) (=> (= temp_14_0~3233@ temp_14_1~3294@) (=> (= temp_15_0~3407@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Add b15~124@ 72))) (Add a15~122@ (Mul (Mul 91 a15~122@) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~3484@ (Mul (Add a15~122@ (Mul (Mul 91 a15~122@) (Mul a15~122@ d15~128@))) (Mul (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Add b15~124@ 72))))) (and (=> (= tmp%48@ (Add a15~122@ (Mul (Mul 91 a15~122@) (Mul a15~122@ d15~128@)))) (=> (= tmp%49@ (Mul (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Add b15~124@ 72)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%48@ tmp%49@) (=> %%location_label%%15 (= temp_15_0~3407@ temp_15_1~3484@))))) (=> (= temp_15_0~3407@ temp_15_1~3484@) (=> (= temp_16_0~3629@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Add a16~130@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Sub b16~132@ a16~130@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~3694@ (Mul (Mul (Mul d16~136@ (Mul b16~132@ (Add a16~130@ d16~136@))) (Mul (Mul d16~136@ d16~136@) (Sub b16~132@ a16~130@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul b16~132@ a16~130@))))) (and (=> (= tmp%50@ (Add a16~130@ d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d16~136@ b16~132@ tmp%50@) (=> (= tmp%51@ (Mul d16~136@ (Mul b16~132@ (Add a16~130@ d16~136@)))) (=> (= tmp%52@ (Mul (Mul d16~136@ d16~136@) (Sub b16~132@ a16~130@))) (=> (= tmp%53@ (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul b16~132@ a16~130@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%51@ tmp%52@ tmp%53@) (=> (= tmp%54@ (Mul (Mul d16~136@ b16~132@) (Add a16~130@ d16~136@))) (=> (= tmp%55@ (Mul (Mul d16~136@ d16~136@) (Sub b16~132@ a16~130@))) (=> (= tmp%56@ (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul b16~132@ a16~130@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%54@ tmp%55@ tmp%56@) (=> %%location_label%%16 (= temp_16_0~3629@ temp_16_1~3694@)))))))))))) (=> (= temp_16_0~3629@ temp_16_1~3694@) (=> (= temp_17_0~3925@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)) (Mul 56 (Mul a17~138@ d17~144@))) (Mul (Mul (Mul d17~144@ d17~144@) (Add b17~140@ d17~144@)) (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~3998@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)) (Mul 56 (Mul a17~138@ d17~144@))) (Mul (Mul (Mul d17~144@ d17~144@) (Add b17~140@ d17~144@)) (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ b17~140@))))) (=> (= tmp%57@ (= temp_17_0~3925@ temp_17_1~3998@)) (and (=> %%location_label%%17 tmp%57@) (=> tmp%57@ (=> (= temp_18_0~4074@ (Mul (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ c18~150@)) (Mul (Sub c18~150@ d18~152@) d18~152@)) (Mul (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Sub b18~148@ a18~146@) (Sub b18~148@ c18~150@))))) (=> (= temp_18_1~4135@ (Mul (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ c18~150@)) (Mul (Sub c18~150@ d18~152@) d18~152@)) (Mul (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Sub b18~148@ c18~150@) (Sub b18~148@ a18~146@))))) (=> (= tmp%58@ (Sub b18~148@ c18~150@)) (=> (= tmp%59@ (Sub b18~148@ a18~146@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%58@ tmp%59@) (=> (= tmp%60@ (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ c18~150@)) (Mul (Sub c18~150@ d18~152@) d18~152@))) (=> (= tmp%61@ (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@))) (=> (= tmp%62@ (Mul (Sub b18~148@ c18~150@) (Sub b18~148@ a18~146@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%60@ tmp%61@ tmp%62@) (=> (= tmp%63@ (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ c18~150@)) (Mul (Sub c18~150@ d18~152@) d18~152@))) (=> (= tmp%64@ (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@))) (=> (= tmp%65@ (Mul (Sub b18~148@ a18~146@) (Sub b18~148@ c18~150@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%63@ tmp%64@ tmp%65@) (=> %%location_label%%18 (= temp_18_0~4074@ temp_18_1~4135@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
