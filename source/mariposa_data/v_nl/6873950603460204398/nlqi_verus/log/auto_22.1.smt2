...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Add (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) (Mul d0~8@ (Sub c0~6@ b0~4@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Sub b0~4@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Add (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ (Sub c0~6@ b0~4@)) (Mul (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Sub b0~4@ b0~4@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~439@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ b1~12@))) (Mul (Add (Mul b1~12@ c1~14@) (Add a1~10@ b1~12@)) a1~10@))) (=> (= temp_1_1~492@ (Mul (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ b1~12@)) (Mul (Add (Mul b1~12@ c1~14@) (Add a1~10@ b1~12@)) a1~10@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~439@ temp_1_1~492@))) (=> (= temp_1_0~439@ temp_1_1~492@) (=> (= temp_2_0~589@ (Mul (Add (Mul (Add b2~20@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ 4) (Mul d2~24@ d2~24@))) (Add (Mul b2~20@ (Sub b2~20@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~662@ (Mul (Add (Mul (Add b2~20@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul 4 c2~22@) (Mul d2~24@ d2~24@))) (Add (Mul b2~20@ (Sub b2~20@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~589@ temp_2_1~662@))) (=> (= temp_2_0~589@ temp_2_1~662@) (=> (= temp_3_0~751@ (Mul (Add (Mul (Mul c3~30@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Add d3~32@ b3~28@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~816@ (Mul (Add (Mul (Mul c3~30@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Add d3~32@ b3~28@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)) (Mul c3~30@ c3~30@)) (Mul c3~30@ b3~28@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~751@ temp_3_1~816@))) (=> (= temp_3_0~751@ temp_3_1~816@) (=> (= temp_4_0~917@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul 1 a4~34@) (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~994@ (Mul (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ c4~38@))) (Mul (Mul 1 a4~34@) (Mul b4~36@ a4~34@))) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~917@ temp_4_1~994@))) (=> (= temp_4_0~917@ temp_4_1~994@) (=> (= temp_5_0~1119@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ b5~44@)) (Mul (Mul d5~48@ d5~48@) (Mul 41 d5~48@))) (Add (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ 26)) (Mul (Mul a5~42@ a5~42@) (Mul 91 d5~48@))))) (=> (= temp_5_1~1220@ (Mul (Add (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ 26)) (Mul (Mul a5~42@ a5~42@) (Mul 91 d5~48@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ b5~44@)) (Mul (Mul d5~48@ d5~48@) (Mul 41 d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1119@ temp_5_1~1220@))) (=> (= temp_5_0~1119@ temp_5_1~1220@) (=> (= temp_6_0~1321@ (Mul (Mul (Sub (Mul b6~52@ a6~50@) (Mul a6~50@ a6~50@)) (Mul (Add 91 a6~50@) (Add b6~52@ a6~50@))) (Sub (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ d6~56@)) (Mul (Mul d6~56@ b6~52@) (Add d6~56@ d6~56@))))) (=> (= temp_6_1~1398@ (Mul (Mul (Sub (Mul a6~50@ b6~52@) (Mul a6~50@ a6~50@)) (Mul (Add 91 a6~50@) (Add b6~52@ a6~50@))) (Sub (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ d6~56@)) (Mul (Mul d6~56@ b6~52@) (Add d6~56@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1321@ temp_6_1~1398@))) (=> (= temp_6_0~1321@ temp_6_1~1398@) (=> (= temp_7_0~1471@ (Mul (Mul (Sub a7~58@ (Mul a7~58@ a7~58@)) b7~60@) (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1520@ (Mul (Mul (Sub a7~58@ (Mul a7~58@ a7~58@)) b7~60@) (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1471@ temp_7_1~1520@))) (=> (= temp_7_0~1471@ temp_7_1~1520@) (=> (= temp_8_0~1609@ (Mul (Mul (Mul (Sub d8~72@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Sub b8~68@ d8~72@) (Mul c8~70@ b8~68@))) (Add (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ b8~68@))))) (=> (= temp_8_1~1674@ (Mul (Mul (Mul (Sub d8~72@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Sub b8~68@ d8~72@) (Mul b8~68@ c8~70@))) (Add (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1609@ temp_8_1~1674@))) (=> (= temp_8_0~1609@ temp_8_1~1674@) (=> (= temp_9_0~1775@ (Add (Mul (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ a9~74@)) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ c9~78@))) (Mul (Add (Mul 96 b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ b9~76@))))) (=> (= temp_9_1~1852@ (Add (Mul (Mul b9~76@ d9~80@) (Mul (Mul b9~76@ a9~74@) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ c9~78@)))) (Mul (Add (Mul 96 b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1775@ temp_9_1~1852@))) (=> (= temp_9_0~1775@ temp_9_1~1852@) (=> (= temp_10_0~1929@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ a10~82@)) a10~82@) (Mul (Add (Mul b10~84@ a10~82@) (Mul c10~86@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ a10~82@))))) (=> (= temp_10_1~1982@ (Mul (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ a10~82@)) a10~82@) (Add (Mul b10~84@ a10~82@) (Mul c10~86@ b10~84@))) (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ a10~82@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1929@ temp_10_1~1982@))) (=> (= temp_10_0~1929@ temp_10_1~1982@) (=> (= temp_11_0~2079@ (Mul (Mul (Mul a11~90@ (Mul a11~90@ b11~92@)) (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ c11~94@))) (Add (Sub (Mul a11~90@ a11~90@) (Mul a11~90@ c11~94@)) (Mul (Mul c11~94@ 52) (Mul c11~94@ d11~96@))))) (=> (= temp_11_1~2152@ (Mul (Mul a11~90@ (Mul (Mul a11~90@ b11~92@) (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ c11~94@)))) (Add (Sub (Mul a11~90@ a11~90@) (Mul a11~90@ c11~94@)) (Mul (Mul c11~94@ 52) (Mul c11~94@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2079@ temp_11_1~2152@))) (=> (= temp_11_0~2079@ temp_11_1~2152@) (=> (= temp_12_0~2241@ (Mul (Add (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ a12~98@)) (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ d12~104@))) (Mul (Mul (Mul d12~104@ d12~104@) (Sub d12~104@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ b12~100@))))) (=> (= temp_12_1~2306@ (Mul (Add (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ a12~98@)) (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ d12~104@))) (Mul (Mul (Mul d12~104@ d12~104@) (Sub d12~104@ d12~104@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2241@ temp_12_1~2306@))) (=> (= temp_12_0~2241@ temp_12_1~2306@) (=> (= temp_13_0~2383@ (Mul (Sub (Add (Add c13~110@ a13~106@) (Mul b13~108@ c13~110@)) a13~106@) (Mul (Mul (Add c13~110@ d13~112@) (Mul a13~106@ a13~106@)) (Mul (Add b13~108@ d13~112@) (Mul a13~106@ b13~108@))))) (=> (= temp_13_1~2436@ (Mul (Sub (Add (Add c13~110@ a13~106@) (Mul c13~110@ b13~108@)) a13~106@) (Mul (Mul (Add c13~110@ d13~112@) (Mul a13~106@ a13~106@)) (Mul (Add b13~108@ d13~112@) (Mul a13~106@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2383@ temp_13_1~2436@))) (=> (= temp_13_0~2383@ temp_13_1~2436@) (=> (= temp_14_0~2525@ (Mul (Mul (Mul (Sub d14~120@ d14~120@) (Mul b14~116@ b14~116@)) (Add (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@))) (Mul (Mul (Add d14~120@ d14~120@) (Mul b14~116@ b14~116@)) (Add (Mul c14~118@ b14~116@) (Mul b14~116@ d14~120@))))) (=> (= temp_14_1~2590@ (Mul (Mul (Sub d14~120@ d14~120@) (Mul (Mul b14~116@ b14~116@) (Add (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)))) (Mul (Mul (Add d14~120@ d14~120@) (Mul b14~116@ b14~116@)) (Add (Mul c14~118@ b14~116@) (Mul b14~116@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2525@ temp_14_1~2590@))) (=> (= temp_14_0~2525@ temp_14_1~2590@) (=> (= temp_15_0~2667@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Add c15~126@ c15~126@)) (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ c15~126@))) (Mul b15~124@ (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~2720@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Add c15~126@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul c15~126@ c15~126@))) (Mul b15~124@ (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2667@ temp_15_1~2720@))) (=> (= temp_15_0~2667@ temp_15_1~2720@) (=> (= temp_16_0~2809@ (Mul (Sub (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ a16~130@))) (Mul (Mul (Add a16~130@ a16~130@) (Mul d16~136@ c16~134@)) (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ b16~132@))))) (=> (= temp_16_1~2874@ (Mul (Sub (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ a16~130@))) (Mul (Mul (Mul d16~136@ c16~134@) (Add a16~130@ a16~130@)) (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2809@ temp_16_1~2874@))) (=> (= temp_16_0~2809@ temp_16_1~2874@) (=> (= temp_17_0~2963@ (Mul (Mul (Mul (Sub c17~142@ a17~138@) (Mul b17~140@ b17~140@)) (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@))) (Add (Mul (Mul c17~142@ c17~142@) (Mul c17~142@ d17~144@)) (Sub (Mul b17~140@ c17~142@) (Sub d17~144@ b17~140@))))) (=> (= temp_17_1~3028@ (Mul (Mul (Mul (Sub c17~142@ a17~138@) (Mul b17~140@ b17~140@)) (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@))) (Add (Mul (Mul c17~142@ d17~144@) (Mul c17~142@ c17~142@)) (Sub (Mul b17~140@ c17~142@) (Sub d17~144@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2963@ temp_17_1~3028@))) (=> (= temp_17_0~2963@ temp_17_1~3028@) (=> (= temp_18_0~3117@ (Mul (Mul (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Mul d18~152@ a18~146@) (Mul a18~146@ d18~152@))) (Add (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ c18~150@)) (Mul (Mul b18~148@ b18~148@) (Mul c18~150@ a18~146@))))) (=> (= temp_18_1~3182@ (Mul (Mul (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Mul d18~152@ a18~146@) (Mul a18~146@ d18~152@))) (Add (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ c18~150@)) (Mul (Mul c18~150@ a18~146@) (Mul b18~148@ b18~148@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3117@ temp_18_1~3182@))) (=> (= temp_18_0~3117@ temp_18_1~3182@) (=> (= temp_19_0~3291@ (Mul (Add (Mul (Mul c19~158@ b19~156@) (Mul d19~160@ c19~158@)) (Mul (Mul d19~160@ d19~160@) (Mul 71 c19~158@))) (Mul (Mul (Sub b19~156@ a19~154@) c19~158@) (Add (Mul c19~158@ 43) (Mul a19~154@ b19~156@))))) (=> (= temp_19_1~3376@ (Mul (Mul (Add (Mul (Mul c19~158@ b19~156@) (Mul d19~160@ c19~158@)) (Mul (Mul d19~160@ d19~160@) (Mul 71 c19~158@))) (Mul (Sub b19~156@ a19~154@) c19~158@)) (Add (Mul c19~158@ 43) (Mul a19~154@ b19~156@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3291@ temp_19_1~3376@))) (=> (= temp_19_0~3291@ temp_19_1~3376@) (=> (= temp_20_0~3461@ (Mul (Mul (Mul (Sub c20~166@ a20~162@) (Mul c20~166@ d20~168@)) (Mul a20~162@ (Mul d20~168@ a20~162@))) (Mul (Mul (Mul d20~168@ c20~166@) (Add a20~162@ b20~164@)) (Mul (Mul d20~168@ b20~164@) (Mul d20~168@ d20~168@))))) (=> (= temp_20_1~3522@ (Mul (Mul (Mul (Sub c20~166@ a20~162@) (Mul c20~166@ d20~168@)) (Mul (Mul a20~162@ d20~168@) a20~162@)) (Mul (Mul (Mul d20~168@ c20~166@) (Add a20~162@ b20~164@)) (Mul (Mul d20~168@ b20~164@) (Mul d20~168@ d20~168@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3461@ temp_20_1~3522@))) (=> (= temp_20_0~3461@ temp_20_1~3522@) (=> (= temp_21_0~3631@ (Mul (Mul (Sub (Mul b21~172@ b21~172@) c21~174@) (Mul (Mul 65 b21~172@) (Mul b21~172@ 80))) (Add (Mul (Mul a21~170@ b21~172@) (Mul c21~174@ c21~174@)) (Mul (Mul a21~170@ d21~176@) (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~3716@ (Mul (Mul (Sub (Mul b21~172@ b21~172@) c21~174@) (Mul (Mul 65 b21~172@) (Mul b21~172@ 80))) (Add (Mul (Mul b21~172@ a21~170@) (Mul c21~174@ c21~174@)) (Mul (Mul a21~170@ d21~176@) (Mul a21~170@ b21~172@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3631@ temp_21_1~3716@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
