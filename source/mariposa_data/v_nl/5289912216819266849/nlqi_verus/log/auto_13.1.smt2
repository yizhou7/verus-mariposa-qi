...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Add b0~4@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Add c0~6@ a0~2@) (Mul d0~8@ a0~2@))) (Add (Mul (Add c0~6@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Add b0~4@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul (Add c0~6@ a0~2@) d0~8@) a0~2@)) (Add (Mul (Add c0~6@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~447@ (Add (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ b1~12@)) a1~10@) (Add (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Sub d1~16@ a1~10@))))) (=> (= temp_1_1~500@ (Add (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ b1~12@)) a1~10@) (Add (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Sub d1~16@ a1~10@) (Mul a1~10@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~500@))) (=> (= temp_1_0~447@ temp_1_1~500@) (=> (= temp_2_0~593@ (Mul (Mul (Sub (Mul c2~22@ b2~20@) a2~18@) (Mul (Add c2~22@ d2~24@) (Mul a2~18@ c2~22@))) (Mul (Mul 42 (Mul c2~22@ b2~20@)) (Mul (Sub d2~24@ a2~18@) (Add c2~22@ a2~18@))))) (=> (= temp_2_1~662@ (Mul (Mul (Sub (Mul c2~22@ b2~20@) a2~18@) (Mul (Mul (Add c2~22@ d2~24@) a2~18@) c2~22@)) (Mul (Mul 42 (Mul c2~22@ b2~20@)) (Mul (Sub d2~24@ a2~18@) (Add c2~22@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~593@ temp_2_1~662@))) (=> (= temp_2_0~593@ temp_2_1~662@) (=> (= temp_3_0~751@ (Mul (Mul (Add (Mul d3~32@ b3~28@) (Add b3~28@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ a3~26@))) (Mul (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ d3~32@)) (Sub (Sub b3~28@ a3~26@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~816@ (Mul (Mul (Mul (Add (Mul d3~32@ b3~28@) (Add b3~28@ b3~28@)) (Mul b3~28@ c3~30@)) (Mul a3~26@ a3~26@)) (Mul (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ d3~32@)) (Sub (Sub b3~28@ a3~26@) (Mul d3~32@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~751@ temp_3_1~816@))) (=> (= temp_3_0~751@ temp_3_1~816@) (=> (= temp_4_0~905@ (Add (Mul (Sub (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~970@ (Add (Mul (Sub (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~905@ temp_4_1~970@))) (=> (= temp_4_0~905@ temp_4_1~970@) (=> (= temp_5_0~1055@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Add a5~42@ c5~46@)) (Sub (Mul a5~42@ d5~48@) (Sub c5~46@ b5~44@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Sub c5~46@ a5~42@) b5~44@)))) (=> (= temp_5_1~1116@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Add a5~42@ c5~46@)) (Sub (Mul a5~42@ d5~48@) (Sub c5~46@ b5~44@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ d5~48@)) (Mul b5~44@ (Sub c5~46@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1055@ temp_5_1~1116@))) (=> (= temp_5_0~1055@ temp_5_1~1116@) (=> (= temp_6_0~1189@ (Mul (Mul (Mul (Mul c6~54@ c6~54@) (Sub b6~52@ a6~50@)) (Mul b6~52@ (Mul c6~54@ c6~54@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ b6~52@)) a6~50@))) (=> (= temp_6_1~1238@ (Mul (Mul (Mul (Mul c6~54@ c6~54@) (Sub b6~52@ a6~50@)) (Mul b6~52@ (Mul c6~54@ c6~54@))) (Mul (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ b6~52@)) a6~50@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1189@ temp_6_1~1238@))) (=> (= temp_6_0~1189@ temp_6_1~1238@) (=> (= temp_7_0~1323@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Add c7~62@ a7~58@) (Mul a7~58@ c7~62@))) (Mul (Add d7~64@ (Mul c7~62@ c7~62@)) (Add (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1384@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ d7~64@)) (Mul (Add c7~62@ a7~58@) (Mul a7~58@ c7~62@))) (Mul (Add d7~64@ (Mul c7~62@ c7~62@)) (Add (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1323@ temp_7_1~1384@))) (=> (= temp_7_0~1323@ temp_7_1~1384@) (=> (= temp_8_0~1473@ (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Sub a8~66@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ a8~66@) (Sub a8~66@ a8~66@)) (Mul (Mul c8~70@ b8~68@) (Sub a8~66@ b8~68@))))) (=> (= temp_8_1~1538@ (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Sub a8~66@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ a8~66@) (Sub a8~66@ a8~66@)) (Mul c8~70@ (Mul b8~68@ (Sub a8~66@ b8~68@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1473@ temp_8_1~1538@))) (=> (= temp_8_0~1473@ temp_8_1~1538@) (=> (= temp_9_0~1651@ (Sub (Mul (Mul (Mul b9~76@ 77) (Mul c9~78@ c9~78@)) (Mul (Sub 22 d9~80@) (Mul c9~78@ b9~76@))) (Mul (Mul (Add a9~74@ b9~76@) (Mul d9~80@ d9~80@)) (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~1740@ (Sub (Mul (Mul (Mul b9~76@ 77) (Mul c9~78@ c9~78@)) (Mul (Sub 22 d9~80@) (Mul c9~78@ b9~76@))) (Mul (Mul (Add a9~74@ b9~76@) (Mul d9~80@ d9~80@)) (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1651@ temp_9_1~1740@))) (=> (= temp_9_0~1651@ temp_9_1~1740@) (=> (= temp_10_0~1829@ (Mul (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)) (Mul (Mul d10~88@ b10~84@) (Mul a10~82@ c10~86@))) (Mul (Mul (Sub c10~86@ d10~88@) (Mul d10~88@ a10~82@)) (Mul (Add a10~82@ c10~86@) (Sub d10~88@ d10~88@))))) (=> (= temp_10_1~1894@ (Mul (Mul (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ a10~82@)) (Mul (Mul d10~88@ b10~84@) (Mul a10~82@ c10~86@))) (Mul (Mul (Sub c10~86@ d10~88@) (Mul d10~88@ a10~82@)) (Mul (Add a10~82@ c10~86@) (Sub d10~88@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1829@ temp_10_1~1894@))) (=> (= temp_10_0~1829@ temp_10_1~1894@) (=> (= temp_11_0~1979@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) c11~94@) (Add (Mul a11~90@ c11~94@) (Sub b11~92@ a11~90@))) (Mul (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ c11~94@)) (Mul (Mul c11~94@ a11~90@) (Add b11~92@ a11~90@))))) (=> (= temp_11_1~2040@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) c11~94@) (Add (Mul a11~90@ c11~94@) (Sub b11~92@ a11~90@))) (Mul (Mul (Mul (Mul c11~94@ c11~94@) b11~92@) c11~94@) (Mul (Mul c11~94@ a11~90@) (Add b11~92@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1979@ temp_11_1~2040@))) (=> (= temp_11_0~1979@ temp_11_1~2040@) (=> (= temp_12_0~2141@ (Sub (Mul (Mul (Add d12~104@ c12~102@) (Mul c12~102@ c12~102@)) (Mul (Add c12~102@ c12~102@) (Mul d12~104@ c12~102@))) (Mul (Sub (Mul a12~98@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul d12~104@ 33) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2246@ (Sub (Mul (Mul (Add d12~104@ c12~102@) (Mul c12~102@ c12~102@)) (Mul (Add c12~102@ c12~102@) (Mul d12~104@ c12~102@))) (Sub (Mul (Mul a12~98@ b12~100@) (Mul (Mul d12~104@ 33) (Mul d12~104@ d12~104@))) (Mul (Mul b12~100@ c12~102@) (Mul (Mul d12~104@ 33) (Mul d12~104@ d12~104@)))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2141@ temp_12_1~2246@))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
