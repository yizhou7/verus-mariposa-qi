...
(assert (=> %%query%% (not (=> (= temp_0_0~329@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul 60 c0~6@)) (Mul (Mul 75 d0~8@) (Mul d0~8@ c0~6@))) (Mul (Mul (Sub b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~418@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul 60 c0~6@)) (Mul (Mul 75 d0~8@) (Mul d0~8@ c0~6@))) (Mul (Mul (Sub b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~329@ temp_0_1~418@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~498@ (Mul (Mul (Mul (Add d1~16@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ a1~10@))) (Mul (Add (Mul b1~12@ a1~10@) (Mul d1~16@ a1~10@)) (Add (Mul d1~16@ a1~10@) (Add a1~10@ d1~16@))))) (=> (= temp_1_1~563@ (Mul (Mul (Mul (Mul (Add d1~16@ a1~10@) d1~16@) d1~16@) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ a1~10@))) (Mul (Add (Mul b1~12@ a1~10@) (Mul d1~16@ a1~10@)) (Add (Mul d1~16@ a1~10@) (Add a1~10@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~498@ temp_1_1~563@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~643@ (Mul (Mul (Mul (Add d2~24@ a2~18@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Add d2~24@ d2~24@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ d2~24@))))) (=> (= temp_2_1~708@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Add d2~24@ d2~24@)) (Mul (Add d2~24@ a2~18@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~643@ temp_2_1~708@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~788@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~853@ (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~788@ temp_3_1~853@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~933@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ b4~36@))) (Mul (Add (Mul c4~38@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~998@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ b4~36@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Add (Mul c4~38@ c4~38@) (Mul a4~34@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~933@ temp_4_1~998@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1046@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) a5~42@) (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ b5~44@))) d5~48@)) (=> (= temp_5_1~1079@ (Mul d5~48@ (Mul (Mul (Mul c5~46@ a5~42@) a5~42@) (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1046@ temp_5_1~1079@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1159@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Add d6~56@ a6~50@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1224@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Add d6~56@ a6~50@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1159@ temp_6_1~1224@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1316@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ 98)) (Mul (Mul c7~62@ b7~60@) (Sub b7~60@ b7~60@))) (Mul (Mul (Mul d7~64@ d7~64@) (Sub c7~62@ c7~62@)) (Mul (Mul d7~64@ c7~62@) (Add a7~58@ c7~62@))))) (=> (= temp_7_1~1393@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul 98 b7~60@)) (Mul (Mul c7~62@ b7~60@) (Sub b7~60@ b7~60@))) (Mul (Mul (Mul d7~64@ d7~64@) (Sub c7~62@ c7~62@)) (Mul (Mul d7~64@ c7~62@) (Add a7~58@ c7~62@))))) (=> (= tmp%8@ (= temp_7_0~1316@ temp_7_1~1393@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1469@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ d8~72@))) (Add (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ a8~66@) b8~68@)))) (=> (= temp_8_1~1530@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@))) (Add (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ a8~66@) b8~68@)))) (=> (= tmp%9@ (= temp_8_0~1469@ temp_8_1~1530@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1626@ (Mul (Mul (Mul (Mul 98 d9~80@) (Add b9~76@ d9~80@)) (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@))) (Mul (Mul d9~80@ (Mul d9~80@ a9~74@)) (Mul 23 (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1727@ (Mul (Mul (Add (Mul (Mul 98 d9~80@) b9~76@) (Mul (Mul 98 d9~80@) d9~80@)) (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@))) (Mul (Mul d9~80@ (Mul d9~80@ a9~74@)) (Mul 23 (Mul a9~74@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1626@ temp_9_1~1727@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1807@ (Mul (Sub (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ a10~82@)) (Sub (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@))) (Mul (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ b10~84@)) (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~1872@ (Mul (Sub (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ a10~82@)) (Sub (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@))) (Mul (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ b10~84@)) (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1807@ temp_10_1~1872@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1976@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul c11~94@ a11~90@)) (Add (Mul b11~92@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Add (Mul c11~94@ c11~94@) (Sub 83 d11~96@)) (Mul (Sub d11~96@ a11~90@) (Sub a11~90@ 84))))) (=> (= temp_11_1~2065@ (Mul (Mul (Add (Mul c11~94@ c11~94@) (Sub 83 d11~96@)) (Mul (Sub d11~96@ a11~90@) (Sub a11~90@ 84))) (Mul (Mul (Mul a11~90@ a11~90@) (Mul c11~94@ a11~90@)) (Add (Mul b11~92@ a11~90@) (Mul a11~90@ d11~96@))))) (=> (= tmp%12@ (= temp_11_0~1976@ temp_11_1~2065@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2141@ (Add (Mul (Mul (Mul d12~104@ d12~104@) (Mul d12~104@ b12~100@)) (Sub (Mul b12~100@ a12~98@) (Mul b12~100@ c12~102@))) (Mul (Mul (Add c12~102@ c12~102@) (Mul b12~100@ a12~98@)) (Add c12~102@ (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2202@ (Add (Mul (Mul (Mul d12~104@ d12~104@) (Mul d12~104@ b12~100@)) (Sub (Mul b12~100@ a12~98@) (Mul b12~100@ c12~102@))) (Mul (Mul (Mul (Add c12~102@ c12~102@) b12~100@) a12~98@) (Add c12~102@ (Mul b12~100@ a12~98@))))) (=> (= tmp%13@ (= temp_12_0~2141@ temp_12_1~2202@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2278@ (Mul (Mul (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@)) (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ c13~110@))) (Mul (Mul (Mul c13~110@ a13~106@) a13~106@) (Mul (Mul d13~112@ c13~110@) (Sub a13~106@ d13~112@))))) (=> (= temp_13_1~2339@ (Mul (Mul (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@)) (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ c13~110@))) (Mul (Mul (Mul c13~110@ a13~106@) a13~106@) (Mul d13~112@ (Mul c13~110@ (Sub a13~106@ d13~112@)))))) (=> (= tmp%14@ (= temp_13_0~2278@ temp_13_1~2339@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2411@ (Mul (Mul (Mul (Mul d14~120@ d14~120@) a14~114@) (Mul (Mul c14~118@ b14~116@) c14~118@)) (Sub (Add (Add a14~114@ d14~120@) (Mul d14~120@ a14~114@)) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ a14~114@))))) (=> (= temp_14_1~2468@ (Mul (Mul (Mul (Mul d14~120@ d14~120@) a14~114@) (Mul (Mul c14~118@ b14~116@) c14~118@)) (Sub (Add (Add a14~114@ d14~120@) (Mul d14~120@ a14~114@)) (Mul b14~116@ (Mul d14~120@ (Mul a14~114@ a14~114@)))))) (=> (= tmp%15@ (= temp_14_0~2411@ temp_14_1~2468@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2560@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul b15~124@ d15~128@)) (Mul (Mul b15~124@ 97) (Sub b15~124@ d15~128@))) (Mul (Add (Mul d15~128@ d15~128@) (Mul d15~128@ d15~128@)) (Mul (Mul b15~124@ d15~128@) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~2637@ (Mul (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul b15~124@ d15~128@)) (Mul b15~124@ 97)) (Sub b15~124@ d15~128@)) (Mul (Add (Mul d15~128@ d15~128@) (Mul d15~128@ d15~128@)) (Mul (Mul b15~124@ d15~128@) (Mul d15~128@ a15~122@))))) (=> (= tmp%16@ (= temp_15_0~2560@ temp_15_1~2637@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2705@ (Mul (Sub (Mul d16~136@ a16~130@) (Mul (Mul c16~134@ b16~132@) (Add d16~136@ a16~130@))) (Mul (Mul (Add b16~132@ b16~132@) (Mul d16~136@ c16~134@)) (Mul b16~132@ (Sub b16~132@ a16~130@))))) (=> (= temp_16_1~2758@ (Mul (Sub (Mul d16~136@ a16~130@) (Mul (Mul c16~134@ b16~132@) (Add d16~136@ a16~130@))) (Mul (Mul b16~132@ (Sub b16~132@ a16~130@)) (Mul (Add b16~132@ b16~132@) (Mul d16~136@ c16~134@))))) (=> (= tmp%17@ (= temp_16_0~2705@ temp_16_1~2758@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2826@ (Sub (Mul (Mul (Mul c17~142@ c17~142@) (Sub d17~144@ a17~138@)) c17~142@) (Mul (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@)) (Mul (Mul d17~144@ d17~144@) (Mul a17~138@ d17~144@))))) (=> (= temp_17_1~2879@ (Sub (Mul (Mul (Mul c17~142@ c17~142@) (Sub d17~144@ a17~138@)) c17~142@) (Mul (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@)) (Mul (Mul d17~144@ d17~144@) (Mul a17~138@ d17~144@))))) (=> (= tmp%18@ (= temp_17_0~2826@ temp_17_1~2879@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2955@ (Mul (Mul (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ d18~152@)) (Mul (Mul c18~150@ d18~152@) (Mul c18~150@ d18~152@))) (Mul (Mul (Mul d18~152@ b18~148@) (Add b18~148@ c18~150@)) (Mul a18~146@ (Mul c18~150@ c18~150@))))) (=> (= temp_18_1~3016@ (Mul (Mul (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ d18~152@)) (Mul (Mul c18~150@ d18~152@) (Mul c18~150@ d18~152@))) (Mul (Mul a18~146@ (Mul c18~150@ c18~150@)) (Mul (Mul d18~152@ b18~148@) (Add b18~148@ c18~150@))))) (=> (= tmp%19@ (= temp_18_0~2955@ temp_18_1~3016@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3084@ (Mul (Mul (Mul (Mul c19~158@ b19~156@) (Mul d19~160@ c19~158@)) c19~158@) (Mul (Mul (Mul d19~160@ c19~158@) (Mul b19~156@ a19~154@)) (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ b19~156@))))) (=> (= temp_19_1~3137@ (Mul (Mul (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ b19~156@)) c19~158@) (Mul (Mul (Mul d19~160@ c19~158@) (Mul b19~156@ a19~154@)) (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ b19~156@))))) (=> (= tmp%20@ (= temp_19_0~3084@ temp_19_1~3137@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3205@ (Mul (Sub (Mul (Sub d20~168@ a20~162@) (Mul d20~168@ c20~166@)) (Mul (Add c20~166@ c20~166@) (Add c20~166@ b20~164@))) (Mul (Mul (Mul c20~166@ b20~164@) (Sub a20~162@ a20~162@)) c20~166@))) (=> (= temp_20_1~3258@ (Mul (Sub (Mul (Sub d20~168@ a20~162@) (Mul d20~168@ c20~166@)) (Mul (Add c20~166@ b20~164@) (Add c20~166@ c20~166@))) (Mul (Mul (Mul c20~166@ b20~164@) (Sub a20~162@ a20~162@)) c20~166@))) (=> (= tmp%21@ (= temp_20_0~3205@ temp_20_1~3258@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3326@ (Add (Mul (Sub (Mul c21~174@ a21~170@) (Mul a21~170@ a21~170@)) (Mul (Sub b21~172@ a21~170@) (Mul a21~170@ b21~172@))) (Mul d21~176@ (Add (Mul b21~172@ b21~172@) (Add d21~176@ d21~176@))))) (=> (= temp_21_1~3383@ (Add (Mul (Sub (Mul c21~174@ a21~170@) (Mul a21~170@ a21~170@)) (Mul (Sub b21~172@ a21~170@) (Mul a21~170@ b21~172@))) (Add (Mul d21~176@ (Mul b21~172@ b21~172@)) (Mul d21~176@ (Add d21~176@ d21~176@))))) (=> (= tmp%22@ (= temp_21_0~3326@ temp_21_1~3383@)) (=> %%location_label%%21 tmp%22@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
