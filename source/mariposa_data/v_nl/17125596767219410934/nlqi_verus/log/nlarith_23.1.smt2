...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ c0~6@)) (Sub a0~2@ (Mul d0~8@ d0~8@))) (Add (Sub (Mul c0~6@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ c0~6@)) (Sub a0~2@ (Mul d0~8@ d0~8@))) (Add (Sub (Mul c0~6@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~426@ (Mul (Sub (Mul (Mul d1~16@ c1~14@) (Sub c1~14@ d1~16@)) c1~14@) (Add (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@)) (Mul (Sub d1~16@ c1~14@) d1~16@)))) (=> (= temp_1_1~475@ (Mul (Add (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@)) (Mul (Sub d1~16@ c1~14@) d1~16@)) (Sub (Mul (Mul d1~16@ c1~14@) (Sub c1~14@ d1~16@)) c1~14@))) (=> (= tmp%2@ (= temp_1_0~426@ temp_1_1~475@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~543@ (Mul (Mul d2~24@ (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@))) (Mul (Sub (Mul d2~24@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~596@ (Mul (Mul d2~24@ (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@)) (Sub (Mul d2~24@ d2~24@) (Mul c2~22@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~543@ temp_2_1~596@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~684@ (Add (Mul (Mul (Sub d3~32@ d3~32@) (Sub a3~26@ d3~32@)) (Mul 49 (Mul c3~30@ b3~28@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~757@ (Add (Mul (Mul (Sub d3~32@ d3~32@) (Sub a3~26@ d3~32@)) (Mul 49 (Mul c3~30@ b3~28@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul a3~26@ (Mul b3~28@ (Mul b3~28@ b3~28@)))))) (=> (= tmp%4@ (= temp_3_0~684@ temp_3_1~757@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~813@ (Mul (Mul a4~34@ (Mul (Sub b4~36@ b4~36@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ a4~34@)) d4~40@))) (=> (= temp_4_1~854@ (Mul (Mul (Mul a4~34@ (Sub b4~36@ b4~36@)) (Mul a4~34@ d4~40@)) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ a4~34@)) d4~40@))) (=> (= tmp%5@ (= temp_4_0~813@ temp_4_1~854@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~926@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ b5~44@) c5~46@) (Add (Mul c5~46@ d5~48@) d5~48@)))) (=> (= temp_5_1~983@ (Mul (Mul (Mul b5~44@ d5~48@) (Mul (Mul a5~42@ a5~42@) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@)))) (Mul (Mul (Mul d5~48@ b5~44@) c5~46@) (Add (Mul c5~46@ d5~48@) d5~48@)))) (=> (= tmp%6@ (= temp_5_0~926@ temp_5_1~983@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1059@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ a6~50@)) (Sub (Mul a6~50@ c6~54@) (Mul d6~56@ c6~54@))) (Mul (Mul d6~56@ (Mul c6~54@ b6~52@)) (Mul (Add d6~56@ d6~56@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1120@ (Mul (Mul (Sub (Mul a6~50@ c6~54@) (Mul d6~56@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul d6~56@ (Mul c6~54@ b6~52@)) (Mul (Add d6~56@ d6~56@) (Mul c6~54@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1059@ temp_6_1~1120@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1200@ (Mul (Mul (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul b7~60@ d7~64@) (Sub a7~58@ d7~64@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1265@ (Mul (Mul (Mul (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@)) (Mul b7~60@ d7~64@)) (Sub a7~58@ d7~64@)) (Mul (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1200@ temp_7_1~1265@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1345@ (Mul (Add (Mul (Add d8~72@ d8~72@) (Mul a8~66@ b8~68@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1410@ (Mul (Add (Mul (Add d8~72@ d8~72@) (Mul a8~66@ b8~68@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1345@ temp_8_1~1410@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1478@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ a9~74@)) a9~74@))) (=> (= temp_9_1~1531@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ a9~74@)) a9~74@))) (=> (= tmp%10@ (= temp_9_0~1478@ temp_9_1~1531@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1595@ (Mul (Mul (Add (Sub c10~86@ d10~88@) (Mul b10~84@ c10~86@)) (Add a10~82@ (Add b10~84@ d10~88@))) (Add (Add (Mul c10~86@ c10~86@) (Mul b10~84@ d10~88@)) c10~86@))) (=> (= temp_10_1~1644@ (Mul (Mul (Add (Sub c10~86@ d10~88@) (Mul c10~86@ b10~84@)) (Add a10~82@ (Add b10~84@ d10~88@))) (Add (Add (Mul c10~86@ c10~86@) (Mul b10~84@ d10~88@)) c10~86@))) (=> (= tmp%11@ (= temp_10_0~1595@ temp_10_1~1644@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1724@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) (Mul b11~92@ a11~90@)) (Sub (Mul d11~96@ c11~94@) (Mul d11~96@ d11~96@))) (Add (Mul (Sub a11~90@ c11~94@) (Mul d11~96@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~1789@ (Mul (Mul (Mul b11~92@ d11~96@) (Mul b11~92@ a11~90@)) (Mul (Sub (Mul d11~96@ c11~94@) (Mul d11~96@ d11~96@)) (Add (Mul (Sub a11~90@ c11~94@) (Mul d11~96@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Mul d11~96@ b11~92@)))))) (=> (= tmp%12@ (= temp_11_0~1724@ temp_11_1~1789@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1853@ (Sub (Mul d12~104@ (Sub (Mul a12~98@ a12~98@) (Sub d12~104@ a12~98@))) (Mul (Mul (Mul a12~98@ d12~104@) b12~100@) (Add (Mul a12~98@ d12~104@) (Mul b12~100@ d12~104@))))) (=> (= temp_12_1~1902@ (Sub (Mul d12~104@ (Sub (Mul a12~98@ a12~98@) (Sub d12~104@ a12~98@))) (Mul (Mul a12~98@ d12~104@) (Mul b12~100@ (Add (Mul a12~98@ d12~104@) (Mul b12~100@ d12~104@)))))) (=> (= tmp%13@ (= temp_12_0~1853@ temp_12_1~1902@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~1978@ (Mul (Mul (Mul (Mul a13~106@ d13~112@) (Mul a13~106@ c13~110@)) (Mul (Mul c13~110@ d13~112@) (Add c13~110@ b13~108@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ a13~106@)) (Sub (Mul d13~112@ b13~108@) b13~108@)))) (=> (= temp_13_1~2039@ (Mul (Mul (Mul (Mul a13~106@ d13~112@) (Mul a13~106@ c13~110@)) (Mul (Mul c13~110@ d13~112@) (Add c13~110@ b13~108@))) (Mul (Mul d13~112@ d13~112@) (Mul (Mul b13~108@ a13~106@) (Sub (Mul d13~112@ b13~108@) b13~108@))))) (=> (= tmp%14@ (= temp_13_0~1978@ temp_13_1~2039@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2119@ (Sub (Mul (Mul (Mul a14~114@ c14~118@) (Mul a14~114@ d14~120@)) (Mul (Add b14~116@ a14~114@) (Mul d14~120@ a14~114@))) (Sub (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Sub b14~116@ b14~116@) (Mul a14~114@ d14~120@))))) (=> (= temp_14_1~2184@ (Sub (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Add b14~116@ a14~114@) (Mul d14~120@ a14~114@))) (Sub (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Sub b14~116@ b14~116@) (Mul a14~114@ d14~120@))))) (=> (= tmp%15@ (= temp_14_0~2119@ temp_14_1~2184@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2252@ (Mul (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ b15~124@)) (Mul c15~126@ (Mul a15~122@ d15~128@))) (Add (Sub a15~122@ b15~124@) (Mul (Mul d15~128@ c15~126@) (Mul c15~126@ b15~124@))))) (=> (= temp_15_1~2305@ (Mul (Add (Sub a15~122@ b15~124@) (Mul (Mul d15~128@ c15~126@) (Mul c15~126@ b15~124@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ b15~124@)) (Mul c15~126@ (Mul a15~122@ d15~128@))))) (=> (= tmp%16@ (= temp_15_0~2252@ temp_15_1~2305@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2381@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ c16~134@)) (Mul (Mul b16~132@ a16~130@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul a16~130@ c16~134@) a16~130@) (Mul (Mul c16~134@ b16~132@) (Mul a16~130@ b16~132@))))) (=> (= temp_16_1~2442@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ c16~134@)) (Mul (Mul b16~132@ a16~130@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul a16~130@ c16~134@) a16~130@) (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ b16~132@))))) (=> (= tmp%17@ (= temp_16_0~2381@ temp_16_1~2442@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2534@ (Add (Add (Mul (Add 11 d17~144@) (Mul b17~140@ d17~144@)) (Mul (Add d17~144@ d17~144@) (Add c17~142@ c17~142@))) (Sub (Add (Sub b17~140@ b17~140@) (Mul b17~140@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~2611@ (Add (Add (Mul (Add 11 d17~144@) (Mul b17~140@ d17~144@)) (Mul (Add c17~142@ c17~142@) (Add d17~144@ d17~144@))) (Sub (Add (Sub b17~140@ b17~140@) (Mul b17~140@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@))))) (=> (= tmp%18@ (= temp_17_0~2534@ temp_17_1~2611@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2691@ (Sub (Mul (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ b18~148@)) (Sub (Add a18~146@ d18~152@) (Mul d18~152@ c18~150@))) (Mul (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Mul d18~152@ b18~148@) (Add d18~152@ d18~152@))))) (=> (= temp_18_1~2756@ (Sub (Mul (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ b18~148@)) (Sub (Add a18~146@ d18~152@) (Mul d18~152@ c18~150@))) (Mul (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ b18~148@)) (Mul d18~152@ (Mul b18~148@ (Add d18~152@ d18~152@)))))) (=> (= tmp%19@ (= temp_18_0~2691@ temp_18_1~2756@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2824@ (Mul (Mul (Mul (Mul a19~154@ a19~154@) (Mul d19~160@ b19~156@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ c19~158@))) (Mul (Sub (Mul b19~156@ d19~160@) (Mul d19~160@ c19~158@)) a19~154@))) (=> (= temp_19_1~2877@ (Mul (Mul (Mul (Mul a19~154@ a19~154@) (Mul d19~160@ b19~156@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ c19~158@))) (Mul (Sub (Mul d19~160@ b19~156@) (Mul d19~160@ c19~158@)) a19~154@))) (=> (= tmp%20@ (= temp_19_0~2824@ temp_19_1~2877@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~2957@ (Mul (Mul (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ c20~166@)) (Mul (Mul c20~166@ b20~164@) (Mul a20~162@ c20~166@))) (Mul (Mul (Mul c20~166@ b20~164@) (Mul b20~164@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Add a20~162@ a20~162@))))) (=> (= temp_20_1~3022@ (Mul (Mul (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ c20~166@)) (Mul (Mul c20~166@ b20~164@) (Mul a20~162@ c20~166@))) (Mul (Mul (Mul b20~164@ c20~166@) (Mul b20~164@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Add a20~162@ a20~162@))))) (=> (= tmp%21@ (= temp_20_0~2957@ temp_20_1~3022@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3122@ (Mul (Sub (Mul (Sub a21~170@ a21~170@) (Mul b21~172@ b21~172@)) (Mul (Mul d21~176@ 17) (Sub c21~174@ b21~172@))) (Mul (Mul (Mul a21~170@ d21~176@) (Mul 51 a21~170@)) (Mul a21~170@ (Mul d21~176@ a21~170@))))) (=> (= temp_21_1~3207@ (Mul (Sub (Mul (Sub a21~170@ a21~170@) (Mul b21~172@ b21~172@)) (Mul (Mul d21~176@ 17) (Sub c21~174@ b21~172@))) (Mul (Mul (Mul 51 a21~170@) (Mul a21~170@ d21~176@)) (Mul a21~170@ (Mul d21~176@ a21~170@))))) (=> (= tmp%22@ (= temp_21_0~3122@ temp_21_1~3207@)) (and (=> %%location_label%%21 tmp%22@) (=> tmp%22@ (=> (= temp_22_0~3295@ (Sub (Add (Mul (Mul a22~178@ c22~182@) (Mul d22~184@ c22~182@)) (Mul (Mul a22~178@ b22~180@) (Sub 26 a22~178@))) (Mul (Mul (Sub a22~178@ a22~178@) b22~180@) (Add (Add b22~180@ d22~184@) (Mul d22~184@ d22~184@))))) (=> (= temp_22_1~3368@ (Sub (Add (Mul (Mul a22~178@ c22~182@) (Mul d22~184@ c22~182@)) (Mul (Sub 26 a22~178@) (Mul a22~178@ b22~180@))) (Mul (Mul (Sub a22~178@ a22~178@) b22~180@) (Add (Add b22~180@ d22~184@) (Mul d22~184@ d22~184@))))) (=> (= tmp%23@ (= temp_22_0~3295@ temp_22_1~3368@)) (=> %%location_label%%22 tmp%23@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
