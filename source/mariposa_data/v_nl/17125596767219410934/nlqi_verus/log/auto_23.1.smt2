...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ c0~6@)) (Sub a0~2@ (Mul d0~8@ d0~8@))) (Add (Sub (Mul c0~6@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ c0~6@)) (Sub a0~2@ (Mul d0~8@ d0~8@))) (Add (Sub (Mul c0~6@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~435@ (Mul (Sub (Mul (Mul d1~16@ c1~14@) (Sub c1~14@ d1~16@)) c1~14@) (Add (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@)) (Mul (Sub d1~16@ c1~14@) d1~16@)))) (=> (= temp_1_1~484@ (Mul (Add (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@)) (Mul (Sub d1~16@ c1~14@) d1~16@)) (Sub (Mul (Mul d1~16@ c1~14@) (Sub c1~14@ d1~16@)) c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~435@ temp_1_1~484@))) (=> (= temp_1_0~435@ temp_1_1~484@) (=> (= temp_2_0~561@ (Mul (Mul d2~24@ (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@))) (Mul (Sub (Mul d2~24@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~614@ (Mul (Mul d2~24@ (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@)) (Sub (Mul d2~24@ d2~24@) (Mul c2~22@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~561@ temp_2_1~614@))) (=> (= temp_2_0~561@ temp_2_1~614@) (=> (= temp_3_0~711@ (Add (Mul (Mul (Sub d3~32@ d3~32@) (Sub a3~26@ d3~32@)) (Mul 49 (Mul c3~30@ b3~28@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~784@ (Add (Mul (Mul (Sub d3~32@ d3~32@) (Sub a3~26@ d3~32@)) (Mul 49 (Mul c3~30@ b3~28@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul a3~26@ (Mul b3~28@ (Mul b3~28@ b3~28@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~711@ temp_3_1~784@))) (=> (= temp_3_0~711@ temp_3_1~784@) (=> (= temp_4_0~849@ (Mul (Mul a4~34@ (Mul (Sub b4~36@ b4~36@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ a4~34@)) d4~40@))) (=> (= temp_4_1~890@ (Mul (Mul (Mul a4~34@ (Sub b4~36@ b4~36@)) (Mul a4~34@ d4~40@)) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ a4~34@)) d4~40@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~849@ temp_4_1~890@))) (=> (= temp_4_0~849@ temp_4_1~890@) (=> (= temp_5_0~971@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ b5~44@) c5~46@) (Add (Mul c5~46@ d5~48@) d5~48@)))) (=> (= temp_5_1~1028@ (Mul (Mul (Mul b5~44@ d5~48@) (Mul (Mul a5~42@ a5~42@) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@)))) (Mul (Mul (Mul d5~48@ b5~44@) c5~46@) (Add (Mul c5~46@ d5~48@) d5~48@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~971@ temp_5_1~1028@))) (=> (= temp_5_0~971@ temp_5_1~1028@) (=> (= temp_6_0~1113@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ a6~50@)) (Sub (Mul a6~50@ c6~54@) (Mul d6~56@ c6~54@))) (Mul (Mul d6~56@ (Mul c6~54@ b6~52@)) (Mul (Add d6~56@ d6~56@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1174@ (Mul (Mul (Sub (Mul a6~50@ c6~54@) (Mul d6~56@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul d6~56@ (Mul c6~54@ b6~52@)) (Mul (Add d6~56@ d6~56@) (Mul c6~54@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1113@ temp_6_1~1174@))) (=> (= temp_6_0~1113@ temp_6_1~1174@) (=> (= temp_7_0~1263@ (Mul (Mul (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul b7~60@ d7~64@) (Sub a7~58@ d7~64@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1328@ (Mul (Mul (Mul (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@)) (Mul b7~60@ d7~64@)) (Sub a7~58@ d7~64@)) (Mul (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1263@ temp_7_1~1328@))) (=> (= temp_7_0~1263@ temp_7_1~1328@) (=> (= temp_8_0~1417@ (Mul (Add (Mul (Add d8~72@ d8~72@) (Mul a8~66@ b8~68@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1482@ (Mul (Add (Mul (Add d8~72@ d8~72@) (Mul a8~66@ b8~68@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1417@ temp_8_1~1482@))) (=> (= temp_8_0~1417@ temp_8_1~1482@) (=> (= temp_9_0~1559@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ a9~74@)) a9~74@))) (=> (= temp_9_1~1612@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ a9~74@)) a9~74@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1559@ temp_9_1~1612@))) (=> (= temp_9_0~1559@ temp_9_1~1612@) (=> (= temp_10_0~1685@ (Mul (Mul (Add (Sub c10~86@ d10~88@) (Mul b10~84@ c10~86@)) (Add a10~82@ (Add b10~84@ d10~88@))) (Add (Add (Mul c10~86@ c10~86@) (Mul b10~84@ d10~88@)) c10~86@))) (=> (= temp_10_1~1734@ (Mul (Mul (Add (Sub c10~86@ d10~88@) (Mul c10~86@ b10~84@)) (Add a10~82@ (Add b10~84@ d10~88@))) (Add (Add (Mul c10~86@ c10~86@) (Mul b10~84@ d10~88@)) c10~86@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1685@ temp_10_1~1734@))) (=> (= temp_10_0~1685@ temp_10_1~1734@) (=> (= temp_11_0~1823@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) (Mul b11~92@ a11~90@)) (Sub (Mul d11~96@ c11~94@) (Mul d11~96@ d11~96@))) (Add (Mul (Sub a11~90@ c11~94@) (Mul d11~96@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~1888@ (Mul (Mul (Mul b11~92@ d11~96@) (Mul b11~92@ a11~90@)) (Mul (Sub (Mul d11~96@ c11~94@) (Mul d11~96@ d11~96@)) (Add (Mul (Sub a11~90@ c11~94@) (Mul d11~96@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Mul d11~96@ b11~92@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1823@ temp_11_1~1888@))) (=> (= temp_11_0~1823@ temp_11_1~1888@) (=> (= temp_12_0~1961@ (Sub (Mul d12~104@ (Sub (Mul a12~98@ a12~98@) (Sub d12~104@ a12~98@))) (Mul (Mul (Mul a12~98@ d12~104@) b12~100@) (Add (Mul a12~98@ d12~104@) (Mul b12~100@ d12~104@))))) (=> (= temp_12_1~2010@ (Sub (Mul d12~104@ (Sub (Mul a12~98@ a12~98@) (Sub d12~104@ a12~98@))) (Mul (Mul a12~98@ d12~104@) (Mul b12~100@ (Add (Mul a12~98@ d12~104@) (Mul b12~100@ d12~104@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~1961@ temp_12_1~2010@))) (=> (= temp_12_0~1961@ temp_12_1~2010@) (=> (= temp_13_0~2095@ (Mul (Mul (Mul (Mul a13~106@ d13~112@) (Mul a13~106@ c13~110@)) (Mul (Mul c13~110@ d13~112@) (Add c13~110@ b13~108@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ a13~106@)) (Sub (Mul d13~112@ b13~108@) b13~108@)))) (=> (= temp_13_1~2156@ (Mul (Mul (Mul (Mul a13~106@ d13~112@) (Mul a13~106@ c13~110@)) (Mul (Mul c13~110@ d13~112@) (Add c13~110@ b13~108@))) (Mul (Mul d13~112@ d13~112@) (Mul (Mul b13~108@ a13~106@) (Sub (Mul d13~112@ b13~108@) b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2095@ temp_13_1~2156@))) (=> (= temp_13_0~2095@ temp_13_1~2156@) (=> (= temp_14_0~2245@ (Sub (Mul (Mul (Mul a14~114@ c14~118@) (Mul a14~114@ d14~120@)) (Mul (Add b14~116@ a14~114@) (Mul d14~120@ a14~114@))) (Sub (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Sub b14~116@ b14~116@) (Mul a14~114@ d14~120@))))) (=> (= temp_14_1~2310@ (Sub (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Add b14~116@ a14~114@) (Mul d14~120@ a14~114@))) (Sub (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Sub b14~116@ b14~116@) (Mul a14~114@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2245@ temp_14_1~2310@))) (=> (= temp_14_0~2245@ temp_14_1~2310@) (=> (= temp_15_0~2387@ (Mul (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ b15~124@)) (Mul c15~126@ (Mul a15~122@ d15~128@))) (Add (Sub a15~122@ b15~124@) (Mul (Mul d15~128@ c15~126@) (Mul c15~126@ b15~124@))))) (=> (= temp_15_1~2440@ (Mul (Add (Sub a15~122@ b15~124@) (Mul (Mul d15~128@ c15~126@) (Mul c15~126@ b15~124@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ b15~124@)) (Mul c15~126@ (Mul a15~122@ d15~128@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2387@ temp_15_1~2440@))) (=> (= temp_15_0~2387@ temp_15_1~2440@) (=> (= temp_16_0~2525@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ c16~134@)) (Mul (Mul b16~132@ a16~130@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul a16~130@ c16~134@) a16~130@) (Mul (Mul c16~134@ b16~132@) (Mul a16~130@ b16~132@))))) (=> (= temp_16_1~2586@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ c16~134@)) (Mul (Mul b16~132@ a16~130@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul a16~130@ c16~134@) a16~130@) (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2525@ temp_16_1~2586@))) (=> (= temp_16_0~2525@ temp_16_1~2586@) (=> (= temp_17_0~2687@ (Add (Add (Mul (Add 11 d17~144@) (Mul b17~140@ d17~144@)) (Mul (Add d17~144@ d17~144@) (Add c17~142@ c17~142@))) (Sub (Add (Sub b17~140@ b17~140@) (Mul b17~140@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~2764@ (Add (Add (Mul (Add 11 d17~144@) (Mul b17~140@ d17~144@)) (Mul (Add c17~142@ c17~142@) (Add d17~144@ d17~144@))) (Sub (Add (Sub b17~140@ b17~140@) (Mul b17~140@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2687@ temp_17_1~2764@))) (=> (= temp_17_0~2687@ temp_17_1~2764@) (=> (= temp_18_0~2853@ (Sub (Mul (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ b18~148@)) (Sub (Add a18~146@ d18~152@) (Mul d18~152@ c18~150@))) (Mul (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Mul d18~152@ b18~148@) (Add d18~152@ d18~152@))))) (=> (= temp_18_1~2918@ (Sub (Mul (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ b18~148@)) (Sub (Add a18~146@ d18~152@) (Mul d18~152@ c18~150@))) (Mul (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ b18~148@)) (Mul d18~152@ (Mul b18~148@ (Add d18~152@ d18~152@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2853@ temp_18_1~2918@))) (=> (= temp_18_0~2853@ temp_18_1~2918@) (=> (= temp_19_0~2995@ (Mul (Mul (Mul (Mul a19~154@ a19~154@) (Mul d19~160@ b19~156@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ c19~158@))) (Mul (Sub (Mul b19~156@ d19~160@) (Mul d19~160@ c19~158@)) a19~154@))) (=> (= temp_19_1~3048@ (Mul (Mul (Mul (Mul a19~154@ a19~154@) (Mul d19~160@ b19~156@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ c19~158@))) (Mul (Sub (Mul d19~160@ b19~156@) (Mul d19~160@ c19~158@)) a19~154@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~2995@ temp_19_1~3048@))) (=> (= temp_19_0~2995@ temp_19_1~3048@) (=> (= temp_20_0~3137@ (Mul (Mul (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ c20~166@)) (Mul (Mul c20~166@ b20~164@) (Mul a20~162@ c20~166@))) (Mul (Mul (Mul c20~166@ b20~164@) (Mul b20~164@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Add a20~162@ a20~162@))))) (=> (= temp_20_1~3202@ (Mul (Mul (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ c20~166@)) (Mul (Mul c20~166@ b20~164@) (Mul a20~162@ c20~166@))) (Mul (Mul (Mul b20~164@ c20~166@) (Mul b20~164@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Add a20~162@ a20~162@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3137@ temp_20_1~3202@))) (=> (= temp_20_0~3137@ temp_20_1~3202@) (=> (= temp_21_0~3311@ (Mul (Sub (Mul (Sub a21~170@ a21~170@) (Mul b21~172@ b21~172@)) (Mul (Mul d21~176@ 17) (Sub c21~174@ b21~172@))) (Mul (Mul (Mul a21~170@ d21~176@) (Mul 51 a21~170@)) (Mul a21~170@ (Mul d21~176@ a21~170@))))) (=> (= temp_21_1~3396@ (Mul (Sub (Mul (Sub a21~170@ a21~170@) (Mul b21~172@ b21~172@)) (Mul (Mul d21~176@ 17) (Sub c21~174@ b21~172@))) (Mul (Mul (Mul 51 a21~170@) (Mul a21~170@ d21~176@)) (Mul a21~170@ (Mul d21~176@ a21~170@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3311@ temp_21_1~3396@))) (=> (= temp_21_0~3311@ temp_21_1~3396@) (=> (= temp_22_0~3493@ (Sub (Add (Mul (Mul a22~178@ c22~182@) (Mul d22~184@ c22~182@)) (Mul (Mul a22~178@ b22~180@) (Sub 26 a22~178@))) (Mul (Mul (Sub a22~178@ a22~178@) b22~180@) (Add (Add b22~180@ d22~184@) (Mul d22~184@ d22~184@))))) (=> (= temp_22_1~3566@ (Sub (Add (Mul (Mul a22~178@ c22~182@) (Mul d22~184@ c22~182@)) (Mul (Sub 26 a22~178@) (Mul a22~178@ b22~180@))) (Mul (Mul (Sub a22~178@ a22~178@) b22~180@) (Add (Add b22~180@ d22~184@) (Mul d22~184@ d22~184@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3493@ temp_22_1~3566@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
