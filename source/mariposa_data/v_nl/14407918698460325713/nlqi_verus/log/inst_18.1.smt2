...
(set-info :comment ";; mariposa_data/v_nl//14407918698460325713/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_2_0~521@ Int)
(declare-const temp_2_1~574@ Int)
(declare-const temp_3_0~669@ Int)
(declare-const temp_3_1~730@ Int)
(declare-const temp_4_0~835@ Int)
(declare-const temp_4_1~912@ Int)
...
(declare-const temp_10_0~1823@ Int)
(declare-const temp_10_1~1876@ Int)
(declare-const temp_11_0~1953@ Int)
(declare-const temp_11_1~2002@ Int)
(declare-const temp_12_0~2099@ Int)
(declare-const temp_12_1~2160@ Int)
(declare-const temp_13_0~2333@ Int)
(declare-const temp_13_1~2426@ Int)
(declare-const temp_14_0~2539@ Int)
(declare-const temp_14_1~2616@ Int)
(declare-const temp_15_0~2709@ Int)
(declare-const temp_15_1~2774@ Int)
(declare-const temp_16_0~2907@ Int)
(declare-const temp_16_1~2964@ Int)
(declare-const temp_17_0~3071@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Sub (Mul (Mul b0~4@ (Mul c0~6@ a0~2@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@))) d0~8@)) (=> (= temp_0_1~306@ (Sub (Mul (Mul b0~4@ (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@))) d0~8@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ a0~2@) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~306@))) (=> (= temp_0_0~273@ temp_0_1~306@) (=> (= temp_1_0~387@ (Mul (Mul (Mul a1~10@ (Add c1~14@ c1~14@)) (Mul (Mul b1~12@ a1~10@) a1~10@)) (Mul (Mul a1~10@ (Mul d1~16@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~440@ (Mul (Mul (Mul a1~10@ (Add c1~14@ c1~14@)) (Mul (Mul a1~10@ b1~12@) a1~10@)) (Mul (Mul a1~10@ (Mul d1~16@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ a1~10@) (=> %%location_label%%1 (= temp_1_0~387@ temp_1_1~440@))) (=> (= temp_1_0~387@ temp_1_1~440@) (=> (= temp_2_0~521@ (Mul (Add d2~24@ (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~574@ (Mul (Add d2~24@ (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul (Mul a2~18@ a2~18@) b2~20@) d2~24@)))) (and (=> (= tmp%1@ (Mul a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b2~20@ d2~24@) (=> %%location_label%%2 (= temp_2_0~521@ temp_2_1~574@)))) (=> (= temp_2_0~521@ temp_2_1~574@) (=> (= temp_3_0~669@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ a3~26@)) (Add (Sub c3~30@ d3~32@) b3~28@)) (Mul (Sub (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~730@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ a3~26@)) (Add (Sub c3~30@ d3~32@) b3~28@)) (Mul (Sub (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ c3~30@) (=> %%location_label%%3 (= temp_3_0~669@ temp_3_1~730@))) (=> (= temp_3_0~669@ temp_3_1~730@) (=> (= temp_4_0~835@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ 62))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~912@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ 62))) (Mul (Mul d4~40@ c4~38@) (Mul (Mul b4~36@ b4~36@) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@)))))) (and (=> (= tmp%2@ (Mul d4~40@ c4~38@)) (=> (= tmp%3@ (Mul b4~36@ b4~36@)) (=> (= tmp%4@ (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> %%location_label%%4 (= temp_4_0~835@ temp_4_1~912@)))))) (=> (= temp_4_0~835@ temp_4_1~912@) (=> (= temp_5_0~1023@ (Mul (Add (Sub (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ d5~48@))) (Sub (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ a5~42@) d5~48@)))) (=> (= temp_5_1~1084@ (Mul (Add (Sub (Mul d5~48@ a5~42@) (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ d5~48@))) (Sub (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ a5~42@) d5~48@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ d5~48@) (=> %%location_label%%5 (= temp_5_0~1023@ temp_5_1~1084@))) (=> (= temp_5_0~1023@ temp_5_1~1084@) (=> (= temp_6_0~1161@ (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ a6~50@))) (Mul b6~52@ (Mul b6~52@ (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1210@ (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@))) (Mul b6~52@ (Mul b6~52@ (Mul b6~52@ d6~56@))))) (and (=> (= tmp%5@ (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@))) (=> (= tmp%6@ (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ a6~50@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%6 (= temp_6_0~1161@ temp_6_1~1210@))))) (=> (= temp_6_0~1161@ temp_6_1~1210@) (=> (= temp_7_0~1327@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Add c7~62@ d7~64@) (Mul b7~60@ b7~60@))) (Add (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1392@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Add c7~62@ d7~64@) (Mul b7~60@ b7~60@))) (Add (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@))))) (and (=> (= tmp%7@ (Mul c7~62@ d7~64@)) (=> (= tmp%8@ (Mul c7~62@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%7 (= temp_7_0~1327@ temp_7_1~1392@))))) (=> (= temp_7_0~1327@ temp_7_1~1392@) (=> (= temp_8_0~1497@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul b8~68@ (Mul a8~66@ b8~68@))) (Mul (Mul (Mul 48 b8~68@) c8~70@) (Mul (Sub a8~66@ d8~72@) (Sub b8~68@ c8~70@))))) (=> (= temp_8_1~1566@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@ b8~68@) b8~68@)) (Mul (Mul (Mul 48 b8~68@) c8~70@) (Mul (Sub a8~66@ d8~72@) (Sub b8~68@ c8~70@))))) (and (=> (= tmp%9@ (Mul a8~66@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ tmp%9@) (=> %%location_label%%8 (= temp_8_0~1497@ temp_8_1~1566@)))) (=> (= temp_8_0~1497@ temp_8_1~1566@) (=> (= temp_9_0~1663@ (Mul (Add (Mul (Mul a9~74@ a9~74@) (Add c9~78@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Add c9~78@ a9~74@) (Mul d9~80@ c9~78@)) (Add (Sub a9~74@ a9~74@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1736@ (Mul (Add (Mul (Mul a9~74@ a9~74@) (Add c9~78@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Add (Mul c9~78@ (Mul d9~80@ c9~78@)) (Mul a9~74@ (Mul d9~80@ c9~78@))) (Add (Sub a9~74@ a9~74@) (Mul d9~80@ d9~80@))))) (and (=> (= tmp%10@ (Mul d9~80@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c9~78@ a9~74@ tmp%10@) (=> %%location_label%%9 (= temp_9_0~1663@ temp_9_1~1736@)))) (=> (= temp_9_0~1663@ temp_9_1~1736@) (=> (= temp_10_0~1823@ (Mul (Mul b10~84@ c10~86@) (Mul (Sub (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ 61) (Sub b10~84@ c10~86@))))) (=> (= temp_10_1~1876@ (Mul (Mul c10~86@ b10~84@) (Mul (Sub (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ 61) (Sub b10~84@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b10~84@ c10~86@) (=> %%location_label%%10 (= temp_10_0~1823@ temp_10_1~1876@))) (=> (= temp_10_0~1823@ temp_10_1~1876@) (=> (= temp_11_0~1953@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) b11~92@) b11~92@) (Mul (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ d11~96@) (Mul a11~90@ a11~90@))))) (=> (= temp_11_1~2002@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) b11~92@) b11~92@) (Mul (Mul (Mul c11~94@ d11~96@) (Mul d11~96@ c11~94@)) (Mul (Mul d11~96@ d11~96@) (Mul a11~90@ a11~90@))))) (and (=> (= tmp%11@ (Mul d11~96@ c11~94@)) (=> (= tmp%12@ (Mul c11~94@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%11 (= temp_11_0~1953@ temp_11_1~2002@))))) (=> (= temp_11_0~1953@ temp_11_1~2002@) (=> (= temp_12_0~2099@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ c12~102@))) (Mul (Sub b12~100@ (Mul c12~102@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~2160@ (Mul (Mul (Sub b12~100@ (Mul c12~102@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ c12~102@))))) (and (=> (= tmp%13@ (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ c12~102@)))) (=> (= tmp%14@ (Mul (Sub b12~100@ (Mul c12~102@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ b12~100@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%12 (= temp_12_0~2099@ temp_12_1~2160@))))) (=> (= temp_12_0~2099@ temp_12_1~2160@) (=> (= temp_13_0~2333@ (Mul (Sub (Mul (Sub b13~108@ 62) c13~110@) (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@))) (Mul (Mul (Mul b13~108@ 15) 54) (Mul (Add a13~106@ a13~106@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2426@ (Mul (Sub (Mul (Sub b13~108@ 62) c13~110@) (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@))) (Mul (Mul (Mul b13~108@ 15) 54) (Mul (Mul d13~112@ a13~106@) (Add a13~106@ a13~106@))))) (and (=> (= tmp%15@ (Add a13~106@ a13~106@)) (=> (= tmp%16@ (Mul d13~112@ a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%13 (= temp_13_0~2333@ temp_13_1~2426@))))) (=> (= temp_13_0~2333@ temp_13_1~2426@) (=> (= temp_14_0~2539@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ 49)) (Mul (Mul d14~120@ c14~118@) (Add b14~116@ c14~118@))) (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2616@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ 49)) (Mul (Mul d14~120@ c14~118@) (Add b14~116@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul b14~116@ c14~118@)) (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2539@ temp_14_1~2616@))) (=> (= temp_14_0~2539@ temp_14_1~2616@) (=> (= temp_15_0~2709@ (Mul (Mul (Mul (Mul a15~122@ d15~128@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ b15~124@))) (Add (Mul (Sub b15~124@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2774@ (Mul (Add (Mul (Sub b15~124@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ b15~124@))))) (and (=> (= tmp%17@ (Mul (Mul (Mul a15~122@ d15~128@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ b15~124@)))) (=> (= tmp%18@ (Add (Mul (Sub b15~124@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%15 (= temp_15_0~2709@ temp_15_1~2774@))))) (=> (= temp_15_0~2709@ temp_15_1~2774@) (=> (= temp_16_0~2907@ (Mul (Mul (Mul (Add a16~130@ b16~132@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Sub a16~130@ b16~132@))) (Add a16~130@ (Mul (Mul d16~136@ b16~132@) c16~134@)))) (=> (= temp_16_1~2964@ (Mul (Mul (Mul (Add a16~130@ b16~132@) (Mul b16~132@ b16~132@)) (Sub (Mul (Mul b16~132@ a16~130@) a16~130@) (Mul (Mul b16~132@ a16~130@) b16~132@))) (Add a16~130@ (Mul (Mul d16~136@ b16~132@) c16~134@)))) (and (=> (= tmp%19@ (Mul b16~132@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%19@ a16~130@ b16~132@) (=> %%location_label%%16 (= temp_16_0~2907@ temp_16_1~2964@)))) (=> (= temp_16_0~2907@ temp_16_1~2964@) (=> (= temp_17_0~3071@ (Mul (Mul (Mul d17~144@ (Mul a17~138@ d17~144@)) (Mul (Sub b17~140@ c17~142@) (Mul c17~142@ a17~138@))) (Sub (Mul (Mul a17~138@ a17~138@) (Mul 40 d17~144@)) (Mul (Sub b17~140@ a17~138@) (Mul b17~140@ a17~138@))))) (=> (= temp_17_1~3144@ (Mul (Mul (Mul d17~144@ (Mul a17~138@ d17~144@)) (Mul (Sub b17~140@ c17~142@) (Mul c17~142@ a17~138@))) (Sub (Mul (Mul 40 d17~144@) (Mul a17~138@ a17~138@)) (Mul (Sub b17~140@ a17~138@) (Mul b17~140@ a17~138@))))) (=> (= tmp%20@ (Mul a17~138@ a17~138@)) (=> (= tmp%21@ (Mul 40 d17~144@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%17 (= temp_17_0~3071@ temp_17_1~3144@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
