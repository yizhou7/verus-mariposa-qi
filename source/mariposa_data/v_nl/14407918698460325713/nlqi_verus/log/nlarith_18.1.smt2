...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Sub (Mul (Mul b0~4@ (Mul c0~6@ a0~2@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@))) d0~8@)) (=> (= temp_0_1~306@ (Sub (Mul (Mul b0~4@ (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@))) d0~8@)) (=> (= tmp%1@ (= temp_0_0~273@ temp_0_1~306@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~374@ (Mul (Mul (Mul a1~10@ (Add c1~14@ c1~14@)) (Mul (Mul b1~12@ a1~10@) a1~10@)) (Mul (Mul a1~10@ (Mul d1~16@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~427@ (Mul (Mul (Mul a1~10@ (Add c1~14@ c1~14@)) (Mul (Mul a1~10@ b1~12@) a1~10@)) (Mul (Mul a1~10@ (Mul d1~16@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~374@ temp_1_1~427@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~495@ (Mul (Add d2~24@ (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~548@ (Mul (Add d2~24@ (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul (Mul a2~18@ a2~18@) b2~20@) d2~24@)))) (=> (= tmp%3@ (= temp_2_0~495@ temp_2_1~548@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~624@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ a3~26@)) (Add (Sub c3~30@ d3~32@) b3~28@)) (Mul (Sub (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~685@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ a3~26@)) (Add (Sub c3~30@ d3~32@) b3~28@)) (Mul (Sub (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~624@ temp_3_1~685@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~777@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ 62))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~854@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ 62))) (Mul (Mul d4~40@ c4~38@) (Mul (Mul b4~36@ b4~36@) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@)))))) (=> (= tmp%5@ (= temp_4_0~777@ temp_4_1~854@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~930@ (Mul (Add (Sub (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ d5~48@))) (Sub (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ a5~42@) d5~48@)))) (=> (= temp_5_1~991@ (Mul (Add (Sub (Mul d5~48@ a5~42@) (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ d5~48@))) (Sub (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ a5~42@) d5~48@)))) (=> (= tmp%6@ (= temp_5_0~930@ temp_5_1~991@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1055@ (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ a6~50@))) (Mul b6~52@ (Mul b6~52@ (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1104@ (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@))) (Mul b6~52@ (Mul b6~52@ (Mul b6~52@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1055@ temp_6_1~1104@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1184@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Add c7~62@ d7~64@) (Mul b7~60@ b7~60@))) (Add (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1249@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Add c7~62@ d7~64@) (Mul b7~60@ b7~60@))) (Add (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1184@ temp_7_1~1249@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1333@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul b8~68@ (Mul a8~66@ b8~68@))) (Mul (Mul (Mul 48 b8~68@) c8~70@) (Mul (Sub a8~66@ d8~72@) (Sub b8~68@ c8~70@))))) (=> (= temp_8_1~1402@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@ b8~68@) b8~68@)) (Mul (Mul (Mul 48 b8~68@) c8~70@) (Mul (Sub a8~66@ d8~72@) (Sub b8~68@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1333@ temp_8_1~1402@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1482@ (Mul (Add (Mul (Mul a9~74@ a9~74@) (Add c9~78@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Add c9~78@ a9~74@) (Mul d9~80@ c9~78@)) (Add (Sub a9~74@ a9~74@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1555@ (Mul (Add (Mul (Mul a9~74@ a9~74@) (Add c9~78@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Add (Mul c9~78@ (Mul d9~80@ c9~78@)) (Mul a9~74@ (Mul d9~80@ c9~78@))) (Add (Sub a9~74@ a9~74@) (Mul d9~80@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1482@ temp_9_1~1555@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1623@ (Mul (Mul b10~84@ c10~86@) (Mul (Sub (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ 61) (Sub b10~84@ c10~86@))))) (=> (= temp_10_1~1676@ (Mul (Mul c10~86@ b10~84@) (Mul (Sub (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ 61) (Sub b10~84@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1623@ temp_10_1~1676@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1740@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) b11~92@) b11~92@) (Mul (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ d11~96@) (Mul a11~90@ a11~90@))))) (=> (= temp_11_1~1789@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) b11~92@) b11~92@) (Mul (Mul (Mul c11~94@ d11~96@) (Mul d11~96@ c11~94@)) (Mul (Mul d11~96@ d11~96@) (Mul a11~90@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1740@ temp_11_1~1789@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1865@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ c12~102@))) (Mul (Sub b12~100@ (Mul c12~102@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~1926@ (Mul (Mul (Sub b12~100@ (Mul c12~102@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~1865@ temp_12_1~1926@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2034@ (Mul (Sub (Mul (Sub b13~108@ 62) c13~110@) (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@))) (Mul (Mul (Mul b13~108@ 15) 54) (Mul (Add a13~106@ a13~106@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2127@ (Mul (Sub (Mul (Sub b13~108@ 62) c13~110@) (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@))) (Mul (Mul (Mul b13~108@ 15) 54) (Mul (Mul d13~112@ a13~106@) (Add a13~106@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2034@ temp_13_1~2127@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2219@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ 49)) (Mul (Mul d14~120@ c14~118@) (Add b14~116@ c14~118@))) (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2296@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ 49)) (Mul (Mul d14~120@ c14~118@) (Add b14~116@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul b14~116@ c14~118@)) (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2219@ temp_14_1~2296@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2376@ (Mul (Mul (Mul (Mul a15~122@ d15~128@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ b15~124@))) (Add (Mul (Sub b15~124@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2441@ (Mul (Add (Mul (Sub b15~124@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ b15~124@))))) (=> (= tmp%16@ (= temp_15_0~2376@ temp_15_1~2441@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2505@ (Mul (Mul (Mul (Add a16~130@ b16~132@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Sub a16~130@ b16~132@))) (Add a16~130@ (Mul (Mul d16~136@ b16~132@) c16~134@)))) (=> (= temp_16_1~2562@ (Mul (Mul (Mul (Add a16~130@ b16~132@) (Mul b16~132@ b16~132@)) (Sub (Mul (Mul b16~132@ a16~130@) a16~130@) (Mul (Mul b16~132@ a16~130@) b16~132@))) (Add a16~130@ (Mul (Mul d16~136@ b16~132@) c16~134@)))) (=> (= tmp%17@ (= temp_16_0~2505@ temp_16_1~2562@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2650@ (Mul (Mul (Mul d17~144@ (Mul a17~138@ d17~144@)) (Mul (Sub b17~140@ c17~142@) (Mul c17~142@ a17~138@))) (Sub (Mul (Mul a17~138@ a17~138@) (Mul 40 d17~144@)) (Mul (Sub b17~140@ a17~138@) (Mul b17~140@ a17~138@))))) (=> (= temp_17_1~2723@ (Mul (Mul (Mul d17~144@ (Mul a17~138@ d17~144@)) (Mul (Sub b17~140@ c17~142@) (Mul c17~142@ a17~138@))) (Sub (Mul (Mul 40 d17~144@) (Mul a17~138@ a17~138@)) (Mul (Sub b17~140@ a17~138@) (Mul b17~140@ a17~138@))))) (=> (= tmp%18@ (= temp_17_0~2650@ temp_17_1~2723@)) (=> %%location_label%%17 tmp%18@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
