...
;; mariposa_data/v_nl//17993913645443750663/nlqi_verus/src/main.rs:7:1: 36:40 (#0)
(push)
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ c0~6@)) (Add (Mul b0~4@ a0~2@)
         (Mul b0~4@ c0~6@)
        )
       ) (Mul (Add (Add d0~8@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@)))
     ))
     (=>
      (= temp_0_1~370@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ c0~6@)) (Add (Mul b0~4@ a0~2@)
          (Mul b0~4@ c0~6@)
         )
        ) (Mul (Add (Add d0~8@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ a0~2@)))
      ))
      (=>
       ...
       (and
        ...
        (=>
         tmp%1@
         (=>
          (= temp_1_0~450@ (Sub (Mul (Mul (Mul a1~10@ a1~10@) (Add a1~10@ d1~16@)) (Mul (Mul b1~12@
               b1~12@
              ) (Mul c1~14@ a1~10@)
             )
            ) (Mul (Mul (Sub c1~14@ d1~16@) (Sub c1~14@ d1~16@)) (Add (Mul c1~14@ a1~10@) (Add d1~16@
               b1~12@
          )))))
          (=>
           (= temp_1_1~515@ (Sub (Mul (Mul a1~10@ (Mul a1~10@ (Add a1~10@ d1~16@))) (Mul (Mul b1~12@
                b1~12@
               ) (Mul c1~14@ a1~10@)
              )
             ) (Mul (Mul (Sub c1~14@ d1~16@) (Sub c1~14@ d1~16@)) (Add (Mul c1~14@ a1~10@) (Add d1~16@
           ...
           (=>
            ...
            (and
             ...
             (=>
              tmp%2@
              (=>
               (= temp_2_0~587@ (Mul (Mul (Mul a2~18@ (Mul c2~22@ d2~24@)) (Sub (Mul c2~22@ c2~22@)
                   (Sub a2~18@ c2~22@)
                  )
                 ) (Mul (Mul (Mul a2~18@ d2~24@) d2~24@) (Mul (Mul a2~18@ d2~24@) (Add c2~22@ b2~20@)))
               ))
               (=>
                (= temp_2_1~644@ (Mul (Mul (Mul a2~18@ (Mul c2~22@ d2~24@)) (Sub (Mul c2~22@ c2~22@)
                    (Sub a2~18@ c2~22@)
                   )
                  ) (Mul (Mul (Mul a2~18@ d2~24@) d2~24@) (Mul (Mul a2~18@ d2~24@) (Add c2~22@ b2~20@)))
                ))
                (=>
                 (= tmp%3@ (= temp_2_0~587@ temp_2_1~644@))
                 (and
                  (=>
                   %%location_label%%2
                   tmp%3@
                  ...
                  (=>
                   tmp%3@
                   (=>
                    (= temp_3_0~708@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) c3~30@) b3~28@) (Mul (Mul (Mul c3~30@
                         b3~28@
                        ) (Mul d3~32@ a3~26@)
                       ) (Add (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@))
                    )))
                    (=>
                     (= temp_3_1~757@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) c3~30@) b3~28@) (Mul (Mul (Mul c3~30@
                          b3~28@
                         ) (Mul a3~26@ d3~32@)
                        ) (Add (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@))
                     )))
                     (=>
                      (= tmp%4@ (= temp_3_0~708@ temp_3_1~757@))
                      (and
                       (=>
                        %%location_label%%3
                        tmp%4@
                       ...
                       (=>
                        tmp%4@
                        (=>
                         (= temp_4_0~833@ (Mul (Add (Add (Sub a4~34@ c4~38@) (Mul a4~34@ a4~34@)) (Mul c4~38@
                             (Mul a4~34@ a4~34@)
                            )
                           ) (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Sub b4~36@
                              a4~34@
                         )))))
                         (=>
                          (= temp_4_1~926@ (Add (Mul (Add (Sub a4~34@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul (Mul
                                c4~38@ c4~38@
                               ) (Mul d4~40@ a4~34@)
                              ) (Mul (Mul b4~36@ c4~38@) (Sub b4~36@ a4~34@))
                             )
                            ) (Mul (Mul c4~38@ (Mul a4~34@ a4~34@)) (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ a4~34@))
                              (Mul (Mul b4~36@ c4~38@) (Sub b4~36@ a4~34@))
                          ))))
                          (=>
                           (= tmp%5@ (= temp_4_0~833@ temp_4_1~926@))
                           (and
                            (=>
                             %%location_label%%4
                             tmp%5@
                            ...
                            (=>
                             tmp%5@
                             (=>
                              (= temp_5_0~1018@ (Mul (Mul a5~42@ (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (
                                 Mul (Mul (Mul d5~48@ b5~44@) (Mul 12 d5~48@)) (Mul (Add c5~46@ 68) (Add d5~48@ a5~42@))
                              )))
                              (=>
                               (= temp_5_1~1095@ (Mul (Mul (Mul a5~42@ (Mul d5~48@ d5~48@)) (Mul c5~46@ d5~48@)) (
                                  Mul (Mul (Mul d5~48@ b5~44@) (Mul 12 d5~48@)) (Mul (Add c5~46@ 68) (Add d5~48@ a5~42@))
                               )))
                               (=>
