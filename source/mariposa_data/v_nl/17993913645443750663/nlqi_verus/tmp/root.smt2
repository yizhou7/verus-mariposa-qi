     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~459@ (Sub (Mul (Mul (Mul a1~10@ a1~10@) (Add a1~10@ d1~16@)) (Mul (Mul b1~12@
              b1~12@
             ) (Mul c1~14@ a1~10@)
            )
         ...
         (=>
          (= temp_1_1~524@ (Sub (Mul (Mul a1~10@ (Mul a1~10@ (Add a1~10@ d1~16@))) (Mul (Mul b1~12@
               b1~12@
              ) (Mul c1~14@ a1~10@)
             )
            ) (Mul (Mul (Sub c1~14@ d1~16@) (Sub c1~14@ d1~16@)) (Add (Mul c1~14@ a1~10@) (Add d1~16@
          ...
          (and
           ...
           (=>
            (= temp_1_0~459@ temp_1_1~524@)
            (=>
             (= temp_2_0~605@ (Mul (Mul (Mul a2~18@ (Mul c2~22@ d2~24@)) (Sub (Mul c2~22@ c2~22@)
                 (Sub a2~18@ c2~22@)
                )
               ) (Mul (Mul (Mul a2~18@ d2~24@) d2~24@) (Mul (Mul a2~18@ d2~24@) (Add c2~22@ b2~20@)))
             ))
             (=>
              (= temp_2_1~662@ (Mul (Mul (Mul a2~18@ (Mul c2~22@ d2~24@)) (Sub (Mul c2~22@ c2~22@)
                  (Sub a2~18@ c2~22@)
                 )
                ) (Mul (Mul (Mul a2~18@ d2~24@) d2~24@) (Mul (Mul a2~18@ d2~24@) (Add c2~22@ b2~20@)))
              ))
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~605@ temp_2_1~662@)
               ))
               (=>
                (= temp_2_0~605@ temp_2_1~662@)
                (=>
                 (= temp_3_0~735@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) c3~30@) b3~28@) (Mul (Mul (Mul c3~30@
                      b3~28@
                     ) (Mul d3~32@ a3~26@)
                    ) (Add (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@))
                 )))
                 (=>
                  (= temp_3_1~784@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) c3~30@) b3~28@) (Mul (Mul (Mul c3~30@
                       b3~28@
                      ) (Mul a3~26@ d3~32@)
                     ) (Add (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@))
                  )))
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~735@ temp_3_1~784@)
                   ))
                   (=>
                    (= temp_3_0~735@ temp_3_1~784@)
                    (=>
                     (= temp_4_0~869@ (Mul (Add (Add (Sub a4~34@ c4~38@) (Mul a4~34@ a4~34@)) (Mul c4~38@
                         (Mul a4~34@ a4~34@)
                        )
                     ...
                     (=>
                      (= temp_4_1~962@ (Add (Mul (Add (Sub a4~34@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul (Mul
                            c4~38@ c4~38@
                           ) (Mul d4~40@ a4~34@)
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~869@ temp_4_1~962@)
                       ))
                       (=>
                        (= temp_4_0~869@ temp_4_1~962@)
                        (=>
                         (= temp_5_0~1063@ (Mul (Mul a5~42@ (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (
                            Mul (Mul (Mul d5~48@ b5~44@) (Mul 12 d5~48@)) (Mul (Add c5~46@ 68) (Add d5~48@ a5~42@))
                         )))
                         (=>
                          (= temp_5_1~1140@ (Mul (Mul (Mul a5~42@ (Mul d5~48@ d5~48@)) (Mul c5~46@ d5~48@)) (
                             Mul (Mul (Mul d5~48@ b5~44@) (Mul 12 d5~48@)) (Mul (Add c5~46@ 68) (Add d5~48@ a5~42@))
                          )))
                          (=>
                           (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
