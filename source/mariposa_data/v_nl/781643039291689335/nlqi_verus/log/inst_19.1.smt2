...
(set-info :comment ";; mariposa_data/v_nl//781643039291689335/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_10_0~2027@ Int)
(declare-const temp_10_1~2088@ Int)
(declare-const temp_11_0~2201@ Int)
(declare-const temp_11_1~2278@ Int)
(declare-const temp_12_0~2383@ Int)
(declare-const temp_12_1~2436@ Int)
(declare-const temp_13_0~2541@ Int)
(declare-const temp_13_1~2606@ Int)
...
(declare-const temp_17_0~3251@ Int)
(declare-const temp_17_1~3316@ Int)
(declare-const temp_18_0~3405@ Int)
(declare-const temp_18_1~3466@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Sub (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ d0~8@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Sub (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ d0~8@))) (Mul (Mul d0~8@ a0~2@) (Mul (Mul b0~4@ b0~4@) (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)))))) (and (=> (= tmp%1@ (Mul d0~8@ a0~2@)) (=> (= tmp%2@ (Mul b0~4@ b0~4@)) (=> (= tmp%3@ (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~493@ (Mul (Sub (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Add c1~14@ (Add 57 c1~14@))) (Mul (Sub (Sub b1~12@ b1~12@) (Sub b1~12@ d1~16@)) (Mul (Add c1~14@ b1~12@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~598@ (Sub (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Sub (Sub b1~12@ b1~12@) (Sub b1~12@ d1~16@)) (Mul (Add c1~14@ b1~12@) (Mul d1~16@ d1~16@)))) (Mul (Add c1~14@ (Add 57 c1~14@)) (Mul (Sub (Sub b1~12@ b1~12@) (Sub b1~12@ d1~16@)) (Mul (Add c1~14@ b1~12@) (Mul d1~16@ d1~16@)))))) (and (=> (= tmp%4@ (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@))) (=> (= tmp%5@ (Add c1~14@ (Add 57 c1~14@))) (=> (= tmp%6@ (Mul (Sub (Sub b1~12@ b1~12@) (Sub b1~12@ d1~16@)) (Mul (Add c1~14@ b1~12@) (Mul d1~16@ d1~16@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%1 (= temp_1_0~493@ temp_1_1~598@)))))) (=> (= temp_1_0~493@ temp_1_1~598@) (=> (= temp_2_0~753@ (Mul (Sub (Mul (Add c2~22@ c2~22@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ b2~20@))) (Mul (Sub (Sub c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~826@ (Mul (Sub (Add (Mul c2~22@ (Mul d2~24@ b2~20@)) (Mul c2~22@ (Mul d2~24@ b2~20@))) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ b2~20@))) (Mul (Sub (Sub c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))))) (and (=> (= tmp%7@ (Mul d2~24@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c2~22@ c2~22@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~753@ temp_2_1~826@)))) (=> (= temp_2_0~753@ temp_2_1~826@) (=> (= temp_3_0~913@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Sub a3~26@ c3~30@))) (Add (Add (Mul a3~26@ b3~28@) (Mul b3~28@ c3~30@)) a3~26@))) (=> (= temp_3_1~966@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Sub a3~26@ c3~30@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@))) (Add (Add (Mul a3~26@ b3~28@) (Mul b3~28@ c3~30@)) a3~26@))) (and (=> (= tmp%8@ (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@))) (=> (= tmp%9@ (Mul (Mul a3~26@ a3~26@) (Sub a3~26@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%3 (= temp_3_0~913@ temp_3_1~966@))))) (=> (= temp_3_0~913@ temp_3_1~966@) (=> (= temp_4_0~1083@ (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~1148@ (Mul (Mul (Mul (Mul (Mul b4~36@ b4~36@) a4~34@) a4~34@) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@))))) (and (=> (= tmp%10@ (Mul b4~36@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ a4~34@ a4~34@) (=> %%location_label%%4 (= temp_4_0~1083@ temp_4_1~1148@)))) (=> (= temp_4_0~1083@ temp_4_1~1148@) (=> (= temp_5_0~1235@ (Mul (Mul (Mul d5~48@ (Mul d5~48@ b5~44@)) (Sub (Sub d5~48@ c5~46@) (Add b5~44@ c5~46@))) (Mul (Mul (Mul d5~48@ b5~44@) c5~46@) (Mul d5~48@ (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1288@ (Mul (Mul (Mul d5~48@ (Mul d5~48@ b5~44@)) (Sub (Sub d5~48@ c5~46@) (Add b5~44@ c5~46@))) (Mul (Mul c5~46@ (Mul d5~48@ b5~44@)) (Mul d5~48@ (Mul d5~48@ a5~42@))))) (and (=> (= tmp%11@ (Mul d5~48@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1235@ temp_5_1~1288@)))) (=> (= temp_5_0~1235@ temp_5_1~1288@) (=> (= temp_6_0~1381@ (Sub (Mul (Mul (Add d6~56@ a6~50@) c6~54@) (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1442@ (Sub (Mul (Mul (Add d6~56@ a6~50@) c6~54@) (Mul (Mul (Mul d6~56@ d6~56@) b6~52@) b6~52@)) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ b6~52@))))) (and (=> (= tmp%12@ (Mul d6~56@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ b6~52@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1381@ temp_6_1~1442@)))) (=> (= temp_6_0~1381@ temp_6_1~1442@) (=> (= temp_7_0~1537@ (Mul (Add (Sub (Sub b7~60@ d7~64@) (Add b7~60@ a7~58@)) (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@))) (Sub (Sub (Mul b7~60@ a7~58@) d7~64@) (Add (Mul a7~58@ b7~60@) (Sub c7~62@ a7~58@))))) (=> (= temp_7_1~1598@ (Mul (Add (Sub (Sub b7~60@ d7~64@) (Add b7~60@ a7~58@)) (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@))) (Sub (Sub (Mul b7~60@ a7~58@) d7~64@) (Add (Mul b7~60@ a7~58@) (Sub c7~62@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1537@ temp_7_1~1598@))) (=> (= temp_7_0~1537@ temp_7_1~1598@) (=> (= temp_8_0~1699@ (Add (Mul (Sub (Sub b8~68@ c8~70@) (Add d8~72@ c8~70@)) (Add (Add c8~70@ a8~66@) (Mul c8~70@ b8~68@))) (Mul (Mul (Mul c8~70@ b8~68@) c8~70@) (Mul (Mul b8~68@ b8~68@) (Mul 96 b8~68@))))) (=> (= temp_8_1~1772@ (Add (Mul (Sub (Sub b8~68@ c8~70@) (Add d8~72@ c8~70@)) (Add (Add c8~70@ a8~66@) (Mul c8~70@ b8~68@))) (Mul (Mul (Mul b8~68@ c8~70@) c8~70@) (Mul (Mul b8~68@ b8~68@) (Mul 96 b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1699@ temp_8_1~1772@))) (=> (= temp_8_0~1699@ temp_8_1~1772@) (=> (= temp_9_0~1865@ (Mul (Mul (Mul (Mul c9~78@ c9~78@) (Sub c9~78@ c9~78@)) (Mul (Add a9~74@ a9~74@) (Mul a9~74@ c9~78@))) (Mul (Mul (Mul a9~74@ a9~74@) (Sub a9~74@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Sub c9~78@ c9~78@))))) (=> (= temp_9_1~1930@ (Mul (Mul (Mul (Sub c9~78@ c9~78@) (Mul c9~78@ c9~78@)) (Mul (Add a9~74@ a9~74@) (Mul a9~74@ c9~78@))) (Mul (Mul (Mul a9~74@ a9~74@) (Sub a9~74@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Sub c9~78@ c9~78@))))) (and (=> (= tmp%13@ (Mul c9~78@ c9~78@)) (=> (= tmp%14@ (Sub c9~78@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%9 (= temp_9_0~1865@ temp_9_1~1930@))))) (=> (= temp_9_0~1865@ temp_9_1~1930@) (=> (= temp_10_0~2027@ (Sub (Mul (Mul (Mul b10~84@ a10~82@) (Add b10~84@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ d10~88@))) (Mul (Mul (Add b10~84@ a10~82@) (Mul c10~86@ a10~82@)) (Mul b10~84@ (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~2088@ (Sub (Mul (Mul (Add b10~84@ a10~82@) (Mul b10~84@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ d10~88@))) (Mul (Mul (Add b10~84@ a10~82@) (Mul c10~86@ a10~82@)) (Mul b10~84@ (Mul a10~82@ c10~86@))))) (and (=> (= tmp%15@ (Mul b10~84@ a10~82@)) (=> (= tmp%16@ (Add b10~84@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%10 (= temp_10_0~2027@ temp_10_1~2088@))))) (=> (= temp_10_0~2027@ temp_10_1~2088@) (=> (= temp_11_0~2201@ (Mul (Sub (Mul (Mul b11~92@ c11~94@) (Mul 18 b11~92@)) (Sub (Sub c11~94@ c11~94@) (Mul a11~90@ a11~90@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ a11~90@)) (Sub (Mul c11~94@ c11~94@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~2278@ (Mul (Sub (Mul (Mul b11~92@ c11~94@) (Mul 18 b11~92@)) (Sub (Sub c11~94@ c11~94@) (Mul a11~90@ a11~90@))) (Mul (Sub (Mul c11~94@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ a11~90@))))) (and (=> (= tmp%17@ (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ a11~90@))) (=> (= tmp%18@ (Sub (Mul c11~94@ c11~94@) (Mul a11~90@ d11~96@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%11 (= temp_11_0~2201@ temp_11_1~2278@))))) (=> (= temp_11_0~2201@ temp_11_1~2278@) (=> (= temp_12_0~2383@ (Add (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ a12~98@)) (Sub (Mul b12~100@ b12~100@) (Mul c12~102@ a12~98@))) (Mul (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ d12~104@)) b12~100@))) (=> (= temp_12_1~2436@ (Add (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ a12~98@)) (Sub (Mul b12~100@ b12~100@) (Mul c12~102@ a12~98@))) (Mul b12~100@ (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ d12~104@))))) (and (=> (= tmp%19@ (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ b12~100@) (=> %%location_label%%12 (= temp_12_0~2383@ temp_12_1~2436@)))) (=> (= temp_12_0~2383@ temp_12_1~2436@) (=> (= temp_13_0~2541@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Sub b13~108@ b13~108@)) (Add (Mul a13~106@ a13~106@) (Mul b13~108@ d13~112@))) (Mul (Mul (Add c13~110@ c13~110@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2606@ (Mul (Mul (Mul (Sub b13~108@ b13~108@) (Mul a13~106@ c13~110@)) (Add (Mul a13~106@ a13~106@) (Mul b13~108@ d13~112@))) (Mul (Mul (Add c13~110@ c13~110@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ b13~108@))))) (and (=> (= tmp%20@ (Mul a13~106@ c13~110@)) (=> (= tmp%21@ (Sub b13~108@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%13 (= temp_13_0~2541@ temp_13_1~2606@))))) (=> (= temp_13_0~2541@ temp_13_1~2606@) (=> (= temp_14_0~2707@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul d14~120@ b14~116@)) (Mul (Sub d14~120@ a14~114@) (Mul c14~118@ a14~114@))) (Mul (Mul (Sub a14~114@ d14~120@) (Mul 62 c14~118@)) c14~118@))) (=> (= temp_14_1~2772@ (Mul (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul d14~120@ b14~116@)) (Mul (Sub d14~120@ a14~114@) (Mul c14~118@ a14~114@))) (Mul (Sub a14~114@ d14~120@) (Mul 62 c14~118@))) c14~118@)) (and (=> (= tmp%22@ (Mul (Mul (Mul d14~120@ b14~116@) (Mul d14~120@ b14~116@)) (Mul (Sub d14~120@ a14~114@) (Mul c14~118@ a14~114@)))) (=> (= tmp%23@ (Mul (Sub a14~114@ d14~120@) (Mul 62 c14~118@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ c14~118@) (=> %%location_label%%14 (= temp_14_0~2707@ temp_14_1~2772@))))) (=> (= temp_14_0~2707@ temp_14_1~2772@) (=> (= temp_15_0~2899@ (Add (Mul (Mul (Mul a15~122@ a15~122@) (Mul b15~124@ c15~126@)) (Mul (Mul a15~122@ b15~124@) c15~126@)) (Sub b15~124@ (Mul d15~128@ (Mul c15~126@ d15~128@))))) (=> (= temp_15_1~2944@ (Add (Mul (Mul (Mul a15~122@ a15~122@) (Mul b15~124@ c15~126@)) (Mul (Mul a15~122@ b15~124@) c15~126@)) (Sub b15~124@ (Mul d15~128@ (Mul d15~128@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c15~126@ d15~128@) (=> %%location_label%%15 (= temp_15_0~2899@ temp_15_1~2944@))) (=> (= temp_15_0~2899@ temp_15_1~2944@) (=> (= temp_16_0~3037@ (Mul (Mul (Mul (Sub a16~130@ a16~130@) (Mul a16~130@ b16~132@)) (Add (Mul b16~132@ b16~132@) (Mul d16~136@ a16~130@))) (Sub (Mul (Mul d16~136@ c16~134@) (Sub d16~136@ d16~136@)) (Add (Add b16~132@ a16~130@) (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~3102@ (Mul (Sub (Mul (Mul d16~136@ c16~134@) (Sub d16~136@ d16~136@)) (Add (Add b16~132@ a16~130@) (Mul b16~132@ a16~130@))) (Mul (Mul (Sub a16~130@ a16~130@) (Mul a16~130@ b16~132@)) (Add (Mul b16~132@ b16~132@) (Mul d16~136@ a16~130@))))) (and (=> (= tmp%24@ (Mul (Mul (Sub a16~130@ a16~130@) (Mul a16~130@ b16~132@)) (Add (Mul b16~132@ b16~132@) (Mul d16~136@ a16~130@)))) (=> (= tmp%25@ (Sub (Mul (Mul d16~136@ c16~134@) (Sub d16~136@ d16~136@)) (Add (Add b16~132@ a16~130@) (Mul b16~132@ a16~130@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%24@ tmp%25@) (=> %%location_label%%16 (= temp_16_0~3037@ temp_16_1~3102@))))) (=> (= temp_16_0~3037@ temp_16_1~3102@) (=> (= temp_17_0~3251@ (Mul (Mul (Mul (Mul a17~138@ d17~144@) (Mul d17~144@ b17~140@)) (Mul (Mul b17~140@ d17~144@) (Mul a17~138@ c17~142@))) (Mul (Mul (Sub a17~138@ b17~140@) (Mul a17~138@ a17~138@)) (Mul (Add c17~142@ b17~140@) (Mul b17~140@ b17~140@))))) (=> (= temp_17_1~3316@ (Mul (Mul (Mul (Mul d17~144@ a17~138@) (Mul d17~144@ b17~140@)) (Mul (Mul b17~140@ d17~144@) (Mul a17~138@ c17~142@))) (Mul (Mul (Sub a17~138@ b17~140@) (Mul a17~138@ a17~138@)) (Mul (Add c17~142@ b17~140@) (Mul b17~140@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a17~138@ d17~144@) (=> %%location_label%%17 (= temp_17_0~3251@ temp_17_1~3316@))) (=> (= temp_17_0~3251@ temp_17_1~3316@) (=> (= temp_18_0~3405@ (Mul (Mul (Mul b18~148@ (Add b18~148@ b18~148@)) (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ c18~150@))) (Sub (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ d18~152@)) (Mul (Mul c18~150@ d18~152@) (Add d18~152@ a18~146@))))) (=> (= temp_18_1~3466@ (Mul (Mul (Mul b18~148@ (Add b18~148@ b18~148@)) (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ c18~150@))) (Sub (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ d18~152@)) (Mul (Mul c18~150@ d18~152@) (Add d18~152@ a18~146@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c18~150@ c18~150@) (=> %%location_label%%18 (= temp_18_0~3405@ temp_18_1~3466@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
