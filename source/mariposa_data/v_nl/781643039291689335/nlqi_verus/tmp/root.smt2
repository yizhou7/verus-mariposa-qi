...
;; mariposa_data/v_nl//781643039291689335/nlqi_verus/src/main.rs:7:1: 36:40 (#0)
(push)
 ...
 (declare-const temp_5_0~1095@ Int)
 ...
 (declare-const temp_16_1~2794@ Int)
 (declare-const temp_17_0~2883@ Int)
 (declare-const temp_17_1~2948@ Int)
 (declare-const temp_18_0~3033@ Int)
 (declare-const temp_18_1~3094@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~305@ (Mul (Sub (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ b0~4@)
         (Mul c0~6@ d0~8@)
        )
       ) (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)))
     ))
     (=>
      (= temp_0_1~370@ (Mul (Sub (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ b0~4@)
          (Mul c0~6@ d0~8@)
         )
        ) (Mul (Mul d0~8@ a0~2@) (Mul (Mul b0~4@ b0~4@) (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@))))
      ))
      (and
       (=>
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~467@ (Mul (Sub (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Add c1~14@
             (Add 57 c1~14@)
            )
           ) (Mul (Sub (Sub b1~12@ b1~12@) (Sub b1~12@ d1~16@)) (Mul (Add c1~14@ b1~12@) (Mul d1~16@
              d1~16@
         )))))
         (=>
          (= temp_1_1~572@ (Sub (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Sub (Sub
                b1~12@ b1~12@
               ) (Sub b1~12@ d1~16@)
              ) (Mul (Add c1~14@ b1~12@) (Mul d1~16@ d1~16@))
             )
            ) (Mul (Add c1~14@ (Add 57 c1~14@)) (Mul (Sub (Sub b1~12@ b1~12@) (Sub b1~12@ d1~16@))
              (Mul (Add c1~14@ b1~12@) (Mul d1~16@ d1~16@))
          ))))
          (and
           (=>
            ...
            (=>
             %%location_label%%1
             (= temp_1_0~467@ temp_1_1~572@)
           ))
           (=>
            (= temp_1_0~467@ temp_1_1~572@)
            (=>
             (= temp_2_0~661@ (Mul (Sub (Mul (Add c2~22@ c2~22@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@
                  b2~20@
                 ) (Mul a2~18@ b2~20@)
                )
               ) (Mul (Sub (Sub c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@
                  c2~22@
             )))))
             (=>
              (= temp_2_1~734@ (Mul (Sub (Add (Mul c2~22@ (Mul d2~24@ b2~20@)) (Mul c2~22@ (Mul d2~24@
                    b2~20@
                  ))
                 ) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ b2~20@))
                ) (Mul (Sub (Sub c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@
                   c2~22@
              )))))
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~661@ temp_2_1~734@)
               ))
               (=>
                (= temp_2_0~661@ temp_2_1~734@)
                (=>
                 (= temp_3_0~811@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@
                      a3~26@
                     ) (Sub a3~26@ c3~30@)
                    )
                   ) (Add (Add (Mul a3~26@ b3~28@) (Mul b3~28@ c3~30@)) a3~26@)
                 ))
                 (=>
                  (= temp_3_1~864@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Sub a3~26@ c3~30@)) (Mul (Mul a3~26@
                       c3~30@
                      ) (Mul c3~30@ b3~28@)
                     )
                    ) (Add (Add (Mul a3~26@ b3~28@) (Mul b3~28@ c3~30@)) a3~26@)
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~811@ temp_3_1~864@)
                   ))
                   (=>
                    (= temp_3_0~811@ temp_3_1~864@)
                    (=>
                     (= temp_4_0~953@ (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul a4~34@
                          a4~34@
                         ) (Mul a4~34@ b4~36@)
                        )
                       ) (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@
                          d4~40@
                     )))))
                     (=>
                      (= temp_4_1~1018@ (Mul (Mul (Mul (Mul (Mul b4~36@ b4~36@) a4~34@) a4~34@) (Mul (Mul a4~34@
                           a4~34@
                          ) (Mul a4~34@ b4~36@)
                         )
                        ) (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~953@ temp_4_1~1018@)
                        (=>
                         (= temp_5_0~1095@ (Mul (Mul (Mul d5~48@ (Mul d5~48@ b5~44@)) (Sub (Sub d5~48@ c5~46@)
                             (Add b5~44@ c5~46@)
                            )
                           ) (Mul (Mul (Mul d5~48@ b5~44@) c5~46@) (Mul d5~48@ (Mul d5~48@ a5~42@)))
                         ))
                         (=>
                          (= temp_5_1~1148@ (Mul (Mul (Mul d5~48@ (Mul d5~48@ b5~44@)) (Sub (Sub d5~48@ c5~46@)
                              (Add b5~44@ c5~46@)
                             )
                            ) (Mul (Mul c5~46@ (Mul d5~48@ b5~44@)) (Mul d5~48@ (Mul d5~48@ a5~42@)))
                          ))
                          (and
                           (=>
                            (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1095@ temp_5_1~1148@)
                           ))
                           (=>
                            (= temp_5_0~1095@ temp_5_1~1148@)
                            (=>
                             (= temp_6_0~1233@ (Sub (Mul (Mul (Add d6~56@ a6~50@) c6~54@) (Mul (Mul d6~56@ d6~56@)
                                 (Mul b6~52@ b6~52@)
                                )
                               ) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@
                                  b6~52@
                             )))))
                             (=>
                              (= temp_6_1~1294@ (Sub (Mul (Mul (Add d6~56@ a6~50@) c6~54@) (Mul (Mul (Mul d6~56@ d6~56@)
                                   b6~52@
                                  ) b6~52@
                                 )
                                ) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@
                              ...
                              (and
                               ...
                               (=>
                                (= temp_6_0~1233@ temp_6_1~1294@)
                                (=>
                                 (= temp_7_0~1379@ (Mul (Add (Sub (Sub b7~60@ d7~64@) (Add b7~60@ a7~58@)) (Mul (Mul c7~62@
                                      c7~62@
                                     ) (Mul b7~60@ c7~62@)
                                    )
                                   ) (Sub (Sub (Mul b7~60@ a7~58@) d7~64@) (Add (Mul a7~58@ b7~60@) (Sub c7~62@ a7~58@)))
                                 ))
                                 (=>
                                  (= temp_7_1~1440@ (Mul (Add (Sub (Sub b7~60@ d7~64@) (Add b7~60@ a7~58@)) (Mul (Mul c7~62@
                                       c7~62@
                                      ) (Mul b7~60@ c7~62@)
                                     )
                                    ) (Sub (Sub (Mul b7~60@ a7~58@) d7~64@) (Add (Mul b7~60@ a7~58@) (Sub c7~62@ a7~58@)))
                                  ))
                                  (and
                                   (=>
                                    (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                                   ...
                                   (=>
                                    (= temp_7_0~1379@ temp_7_1~1440@)
                                    (=>
                                     (= temp_8_0~1537@ (Add (Mul (Sub (Sub b8~68@ c8~70@) (Add d8~72@ c8~70@)) (Add (Add c8~70@
                                          a8~66@
                                         ) (Mul c8~70@ b8~68@)
                                        )
                                       ) (Mul (Mul (Mul c8~70@ b8~68@) c8~70@) (Mul (Mul b8~68@ b8~68@) (Mul 96 b8~68@)))
                                     ))
                                     (=>
                                      (= temp_8_1~1610@ (Add (Mul (Sub (Sub b8~68@ c8~70@) (Add d8~72@ c8~70@)) (Add (Add c8~70@
                                           a8~66@
                                          ) (Mul c8~70@ b8~68@)
                                         )
                                        ) (Mul (Mul (Mul b8~68@ c8~70@) c8~70@) (Mul (Mul b8~68@ b8~68@) (Mul 96 b8~68@)))
                                      ))
                                      (and
                                       (=>
                                        (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1537@ temp_8_1~1610@)
                                       ))
                                       (=>
                                        (= temp_8_0~1537@ temp_8_1~1610@)
                                        (=>
                                         (= temp_9_0~1699@ (Mul (Mul (Mul (Mul c9~78@ c9~78@) (Sub c9~78@ c9~78@)) (Mul (Add a9~74@
                                              a9~74@
                                             ) (Mul a9~74@ c9~78@)
                                            )
                                           ) (Mul (Mul (Mul a9~74@ a9~74@) (Sub a9~74@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Sub c9~78@
                                              c9~78@
                                         )))))
                                         (=>
                                          (= temp_9_1~1764@ (Mul (Mul (Mul (Sub c9~78@ c9~78@) (Mul c9~78@ c9~78@)) (Mul (Add a9~74@
                                               a9~74@
                                              ) (Mul a9~74@ c9~78@)
                                             )
                                            ) (Mul (Mul (Mul a9~74@ a9~74@) (Sub a9~74@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Sub c9~78@
                                          ...
                                          (and
                                           ...
                                           (=>
                                            (= temp_9_0~1699@ temp_9_1~1764@)
                                            (=>
                                             (= temp_10_0~1849@ (Sub (Mul (Mul (Mul b10~84@ a10~82@) (Add b10~84@ a10~82@)) (Mul (
                                                  Mul a10~82@ c10~86@
                                                 ) (Mul a10~82@ d10~88@)
                                                )
                                               ) (Mul (Mul (Add b10~84@ a10~82@) (Mul c10~86@ a10~82@)) (Mul b10~84@ (Mul a10~82@ c10~86@)))
                                             ))
                                             (=>
                                              (= temp_10_1~1910@ (Sub (Mul (Mul (Add b10~84@ a10~82@) (Mul b10~84@ a10~82@)) (Mul (
                                                   Mul a10~82@ c10~86@
                                                  ) (Mul a10~82@ d10~88@)
                                                 )
                                                ) (Mul (Mul (Add b10~84@ a10~82@) (Mul c10~86@ a10~82@)) (Mul b10~84@ (Mul a10~82@ c10~86@)))
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1849@ temp_10_1~1910@)
                                               ))
                                               (=>
                                                (= temp_10_0~1849@ temp_10_1~1910@)
                                                (=>
                                                 (= temp_11_0~2011@ (Mul (Sub (Mul (Mul b11~92@ c11~94@) (Mul 18 b11~92@)) (Sub (Sub c11~94@
                                                      c11~94@
                                                     ) (Mul a11~90@ a11~90@)
                                                    )
                                                   ) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ a11~90@)) (Sub (Mul c11~94@ c11~94@)
                                                     (Mul a11~90@ d11~96@)
                                                 ))))
                                                 (=>
                                                  (= temp_11_1~2088@ (Mul (Sub (Mul (Mul b11~92@ c11~94@) (Mul 18 b11~92@)) (Sub (Sub c11~94@
                                                       c11~94@
                                                      ) (Mul a11~90@ a11~90@)
                                                     )
                                                    ) (Mul (Sub (Mul c11~94@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (Mul d11~96@ d11~96@)
                                                      (Mul c11~94@ a11~90@)
                                                  ))))
                                                  (and
                                                   (=>
                                                   ...
                                                   (=>
                                                    (= temp_11_0~2011@ temp_11_1~2088@)
                                                    (=>
                                                     (= temp_12_0~2165@ (Add (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ a12~98@)) (Sub
                                                         (Mul b12~100@ b12~100@) (Mul c12~102@ a12~98@)
                                                        )
                                                       ) (Mul (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ d12~104@)) b12~100@)
                                                     ))
                                                     (=>
                                                      (= temp_12_1~2218@ (Add (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ a12~98@)) (Sub
                                                          (Mul b12~100@ b12~100@) (Mul c12~102@ a12~98@)
                                                         )
                                                        ) (Mul b12~100@ (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ d12~104@)))
                                                      ))
                                                      (and
                                                       (=>
                                                        (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2165@ temp_12_1~2218@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2165@ temp_12_1~2218@)
                                                        (=>
                                                         (= temp_13_0~2307@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Sub b13~108@ b13~108@)) (
                                                             Add (Mul a13~106@ a13~106@) (Mul b13~108@ d13~112@)
                                                            )
                                                           ) (Mul (Mul (Add c13~110@ c13~110@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ b13~108@)
                                                             (Mul d13~112@ b13~108@)
                                                         ))))
                                                         (=>
                                                          (= temp_13_1~2372@ (Mul (Mul (Mul (Sub b13~108@ b13~108@) (Mul a13~106@ c13~110@)) (
                                                              Add (Mul a13~106@ a13~106@) (Mul b13~108@ d13~112@)
                                                             )
                                                            ) (Mul (Mul (Add c13~110@ c13~110@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ b13~108@)
                                                              (Mul d13~112@ b13~108@)
                                                          ...
                                                          (and
                                                           ...
                                                           (=>
                                                            (= temp_13_0~2307@ temp_13_1~2372@)
                                                            (=>
                                                             (= temp_14_0~2461@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul d14~120@ b14~116@)) (
                                                                 Mul (Sub d14~120@ a14~114@) (Mul c14~118@ a14~114@)
                                                                )
                                                               ) (Mul (Mul (Sub a14~114@ d14~120@) (Mul 62 c14~118@)) c14~118@)
                                                             ))
                                                             (=>
                                                              (= temp_14_1~2526@ (Mul (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul d14~120@ b14~116@))
                                                                  (Mul (Sub d14~120@ a14~114@) (Mul c14~118@ a14~114@))
                                                                 ) (Mul (Sub a14~114@ d14~120@) (Mul 62 c14~118@))
                                                                ) c14~118@
                                                              ))
                                                              (and
                                                               (=>
                                                               ...
                                                               (=>
                                                                (= temp_14_0~2461@ temp_14_1~2526@)
                                                                (=>
                                                                 (= temp_15_0~2595@ (Add (Mul (Mul (Mul a15~122@ a15~122@) (Mul b15~124@ c15~126@)) (
                                                                     Mul (Mul a15~122@ b15~124@) c15~126@
                                                                    )
                                                                   ) (Sub b15~124@ (Mul d15~128@ (Mul c15~126@ d15~128@)))
                                                                 ))
                                                                 (=>
                                                                  (= temp_15_1~2640@ (Add (Mul (Mul (Mul a15~122@ a15~122@) (Mul b15~124@ c15~126@)) (
                                                                      Mul (Mul a15~122@ b15~124@) c15~126@
                                                                     )
                                                                    ) (Sub b15~124@ (Mul d15~128@ (Mul d15~128@ c15~126@)))
                                                                  ))
                                                                  (and
                                                                   (=>
                                                                    (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2595@ temp_15_1~2640@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2595@ temp_15_1~2640@)
                                                                    (=>
                                                                     (= temp_16_0~2729@ (Mul (Mul (Mul (Sub a16~130@ a16~130@) (Mul a16~130@ b16~132@)) (
                                                                         Add (Mul b16~132@ b16~132@) (Mul d16~136@ a16~130@)
                                                                        )
                                                                       ) (Sub (Mul (Mul d16~136@ c16~134@) (Sub d16~136@ d16~136@)) (Add (Add b16~132@ a16~130@)
                                                                         (Mul b16~132@ a16~130@)
                                                                     ))))
                                                                     (=>
                                                                      (= temp_16_1~2794@ (Mul (Sub (Mul (Mul d16~136@ c16~134@) (Sub d16~136@ d16~136@)) (
                                                                          Add (Add b16~132@ a16~130@) (Mul b16~132@ a16~130@)
                                                                         )
                                                                        ) (Mul (Mul (Sub a16~130@ a16~130@) (Mul a16~130@ b16~132@)) (Add (Mul b16~132@ b16~132@)
                                                                          (Mul d16~136@ a16~130@)
                                                                      ))))
                                                                      (and
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         %%location_label%%16
                                                                         (= temp_16_0~2729@ temp_16_1~2794@)
                                                                       ))
                                                                       (=>
                                                                        (= temp_16_0~2729@ temp_16_1~2794@)
                                                                        (=>
                                                                         (= temp_17_0~2883@ (Mul (Mul (Mul (Mul a17~138@ d17~144@) (Mul d17~144@ b17~140@)) (
                                                                             Mul (Mul b17~140@ d17~144@) (Mul a17~138@ c17~142@)
                                                                            )
                                                                           ) (Mul (Mul (Sub a17~138@ b17~140@) (Mul a17~138@ a17~138@)) (Mul (Add c17~142@ b17~140@)
                                                                             (Mul b17~140@ b17~140@)
                                                                         ))))
                                                                         (=>
                                                                          (= temp_17_1~2948@ (Mul (Mul (Mul (Mul d17~144@ a17~138@) (Mul d17~144@ b17~140@)) (
                                                                              Mul (Mul b17~140@ d17~144@) (Mul a17~138@ c17~142@)
                                                                             )
                                                                            ) (Mul (Mul (Sub a17~138@ b17~140@) (Mul a17~138@ a17~138@)) (Mul (Add c17~142@ b17~140@)
                                                                              (Mul b17~140@ b17~140@)
                                                                          ...
                                                                          (and
                                                                           (=>
                                                                            ...
                                                                            (=>
                                                                             %%location_label%%17
                                                                             (= temp_17_0~2883@ temp_17_1~2948@)
                                                                           ))
                                                                           (=>
                                                                            (= temp_17_0~2883@ temp_17_1~2948@)
                                                                            (=>
                                                                             (= temp_18_0~3033@ (Mul (Mul (Mul b18~148@ (Add b18~148@ b18~148@)) (Mul (Mul c18~150@
                                                                                  b18~148@
                                                                                 ) (Mul c18~150@ c18~150@)
                                                                                )
                                                                               ) (Sub (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ d18~152@)) (Mul (Mul c18~150@ d18~152@)
                                                                                 (Add d18~152@ a18~146@)
                                                                             ))))
                                                                             (=>
                                                                              (= temp_18_1~3094@ (Mul (Mul (Mul b18~148@ (Add b18~148@ b18~148@)) (Mul (Mul c18~150@
                                                                                   b18~148@
                                                                                  ) (Mul c18~150@ c18~150@)
                                                                                 )
                                                                                ) (Sub (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ d18~152@)) (Mul (Mul c18~150@ d18~152@)
