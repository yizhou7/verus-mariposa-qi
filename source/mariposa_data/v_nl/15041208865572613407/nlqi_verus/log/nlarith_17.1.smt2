...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul a0~2@ (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ b0~4@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ b0~4@)) (Mul d0~8@ (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~338@ (Mul (Mul a0~2@ (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ b0~4@)) (Mul d0~8@ (Mul a0~2@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~289@ temp_0_1~338@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~418@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~483@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~418@ temp_1_1~483@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~575@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ d2~24@)) (Sub (Mul d2~24@ c2~22@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul d2~24@ 65) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~652@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ d2~24@)) (Sub (Mul d2~24@ c2~22@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul 65 d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~575@ temp_2_1~652@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~732@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Sub a3~26@ a3~26@))) (Sub (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~797@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Sub a3~26@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ d3~32@))) (Sub (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~732@ temp_3_1~797@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~873@ (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Add a4~34@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ a4~34@))) (Mul (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Sub (Mul b4~36@ c4~38@) c4~38@)))) (=> (= temp_4_1~942@ (Mul (Mul (Add (Mul (Mul b4~36@ b4~36@) a4~34@) (Mul (Mul b4~36@ b4~36@) c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ a4~34@))) (Mul (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Sub (Mul b4~36@ c4~38@) c4~38@)))) (=> (= tmp%5@ (= temp_4_0~873@ temp_4_1~942@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1022@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ c5~46@)) (Sub (Mul c5~46@ a5~42@) (Mul a5~42@ a5~42@))) (Mul (Sub (Mul c5~46@ d5~48@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Add b5~44@ b5~44@))))) (=> (= temp_5_1~1087@ (Mul (Mul (Mul (Mul (Mul b5~44@ d5~48@) c5~46@) c5~46@) (Sub (Mul c5~46@ a5~42@) (Mul a5~42@ a5~42@))) (Mul (Sub (Mul c5~46@ d5~48@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Add b5~44@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1022@ temp_5_1~1087@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1167@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ b6~52@))) (Sub (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ d6~56@))))) (=> (= temp_6_1~1232@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ c6~54@))) (Sub (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1167@ temp_6_1~1232@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1312@ (Mul (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ a7~58@)) (Mul (Add d7~64@ c7~62@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ b7~60@)) (Add (Mul d7~64@ d7~64@) (Mul d7~64@ c7~62@))))) (=> (= temp_7_1~1377@ (Mul (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ a7~58@)) (Mul (Add d7~64@ c7~62@) (Mul d7~64@ a7~58@))) (Mul (Mul c7~62@ (Mul a7~58@ (Mul b7~60@ b7~60@))) (Add (Mul d7~64@ d7~64@) (Mul d7~64@ c7~62@))))) (=> (= tmp%8@ (= temp_7_0~1312@ temp_7_1~1377@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1469@ (Add (Mul (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul 93 d8~72@) (Mul b8~68@ d8~72@))))) (=> (= temp_8_1~1546@ (Add (Mul (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul 93 d8~72@) (Mul b8~68@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1469@ temp_8_1~1546@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1618@ (Mul (Add (Sub (Mul c9~78@ d9~80@) b9~76@) (Mul (Sub c9~78@ c9~78@) c9~78@)) (Mul (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ c9~78@)) (Mul (Add c9~78@ c9~78@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1675@ (Mul (Add (Sub (Mul c9~78@ d9~80@) b9~76@) (Mul c9~78@ (Sub c9~78@ c9~78@))) (Mul (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ c9~78@)) (Mul (Add c9~78@ c9~78@) (Mul d9~80@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1618@ temp_9_1~1675@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1743@ (Mul (Add (Add (Sub c10~86@ d10~88@) (Mul a10~82@ d10~88@)) c10~86@) (Mul (Mul (Mul d10~88@ d10~88@) (Add c10~86@ d10~88@)) (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ a10~82@))))) (=> (= temp_10_1~1796@ (Mul (Add (Add (Sub c10~86@ d10~88@) (Mul a10~82@ d10~88@)) c10~86@) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul d10~88@ d10~88@) (Add c10~86@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1743@ temp_10_1~1796@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1876@ (Mul (Mul (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ b11~92@))) (Add (Sub (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@)) (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~1941@ (Mul (Mul (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ b11~92@))) (Add (Sub (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@)) (Mul c11~94@ (Mul a11~90@ (Mul a11~90@ c11~94@)))))) (=> (= tmp%12@ (= temp_11_0~1876@ temp_11_1~1941@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2021@ (Sub (Mul (Mul (Mul b12~100@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Sub a12~98@ d12~104@) (Sub b12~100@ c12~102@))) (Mul (Mul (Sub c12~102@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul b12~100@ c12~102@))))) (=> (= temp_12_1~2086@ (Sub (Mul (Mul (Mul b12~100@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Sub a12~98@ d12~104@) (Sub b12~100@ c12~102@))) (Mul (Mul (Sub c12~102@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ b12~100@))))) (=> (= tmp%13@ (= temp_12_0~2021@ temp_12_1~2086@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2166@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ d13~112@)) (Mul (Sub a13~106@ c13~110@) (Mul c13~110@ c13~110@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ b13~108@)) (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2231@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ d13~112@)) (Mul (Sub a13~106@ c13~110@) (Mul c13~110@ c13~110@))) (Mul (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@)) (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ b13~108@))))) (=> (= tmp%14@ (= temp_13_0~2166@ temp_13_1~2231@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2311@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Sub a14~114@ a14~114@)) (Mul (Mul d14~120@ d14~120@) (Add d14~120@ d14~120@))) (Add (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ d14~120@)) (Mul (Mul a14~114@ c14~118@) (Mul a14~114@ d14~120@))))) (=> (= temp_14_1~2376@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Sub a14~114@ a14~114@)) (Mul (Mul d14~120@ d14~120@) (Add d14~120@ d14~120@))) (Add (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ d14~120@)) (Mul (Mul c14~118@ a14~114@) (Mul a14~114@ d14~120@))))) (=> (= tmp%15@ (= temp_14_0~2311@ temp_14_1~2376@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2448@ (Add (Mul (Mul (Mul c15~126@ a15~122@) (Mul d15~128@ d15~128@)) (Mul a15~122@ (Mul c15~126@ d15~128@))) (Add (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ c15~126@)) (Mul a15~122@ (Mul c15~126@ b15~124@))))) (=> (= temp_15_1~2505@ (Add (Mul (Mul (Mul c15~126@ a15~122@) (Mul d15~128@ d15~128@)) (Mul a15~122@ (Mul c15~126@ d15~128@))) (Add (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ c15~126@)) (Mul (Mul a15~122@ c15~126@) b15~124@)))) (=> (= tmp%16@ (= temp_15_0~2448@ temp_15_1~2505@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2581@ (Add (Mul (Mul (Mul c16~134@ c16~134@) (Mul d16~136@ d16~136@)) (Mul (Add d16~136@ d16~136@) (Mul b16~132@ d16~136@))) (Add (Mul (Mul b16~132@ c16~134@) (Mul c16~134@ a16~130@)) (Mul d16~136@ (Sub d16~136@ a16~130@))))) (=> (= temp_16_1~2642@ (Add (Mul (Mul (Mul c16~134@ c16~134@) (Mul d16~136@ d16~136@)) (Mul (Add d16~136@ d16~136@) (Mul d16~136@ b16~132@))) (Add (Mul (Mul b16~132@ c16~134@) (Mul c16~134@ a16~130@)) (Mul d16~136@ (Sub d16~136@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2581@ temp_16_1~2642@)) (=> %%location_label%%16 tmp%17@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
