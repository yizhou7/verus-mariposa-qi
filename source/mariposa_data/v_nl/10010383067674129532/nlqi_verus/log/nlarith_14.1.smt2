...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Sub (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Sub c0~6@ b0~4@) c0~6@)) c0~6@)) (=> (= temp_0_1~306@ (Mul (Sub (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@)) (Mul c0~6@ (Sub c0~6@ b0~4@))) c0~6@)) (=> (= tmp%1@ (= temp_0_0~273@ temp_0_1~306@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~386@ (Mul (Mul (Add (Add d1~16@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Sub a1~10@ a1~10@) (Mul b1~12@ a1~10@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Add (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~459@ (Mul (Mul (Add (Add d1~16@ d1~16@) (Mul d1~16@ d1~16@)) (Sub (Mul a1~10@ (Mul b1~12@ a1~10@)) (Mul a1~10@ (Mul b1~12@ a1~10@)))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Add (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~386@ temp_1_1~459@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~535@ (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ d2~24@) b2~20@)) (Mul (Mul (Mul b2~20@ d2~24@) (Sub d2~24@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ d2~24@))))) (=> (= temp_2_1~596@ (Mul (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ d2~24@) b2~20@)) (Mul (Mul b2~20@ d2~24@) (Sub d2~24@ b2~20@))) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ d2~24@)))) (=> (= tmp%3@ (= temp_2_0~535@ temp_2_1~596@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~688@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ 42)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Sub (Mul a3~26@ a3~26@) (Sub c3~30@ b3~28@))))) (=> (= temp_3_1~765@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ 42)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Sub (Mul a3~26@ a3~26@) (Sub c3~30@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~688@ temp_3_1~765@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~845@ (Sub (Add (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ d4~40@)) (Add (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~910@ (Sub (Add (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ d4~40@)) (Add (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~845@ temp_4_1~910@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~978@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Add d5~48@ a5~42@)) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@))) (Mul a5~42@ (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1031@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Add d5~48@ a5~42@)) (Mul c5~46@ (Mul b5~44@ (Mul a5~42@ c5~46@)))) (Mul a5~42@ (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~978@ temp_5_1~1031@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1107@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) c6~54@)) (Mul (Add (Mul a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1168@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) c6~54@)) (Mul (Add (Mul a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1107@ temp_6_1~1168@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1260@ (Mul (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ 6)) (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))) (Mul (Mul (Add a7~58@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1337@ (Mul (Mul (Mul (Mul (Add c7~62@ b7~60@) b7~60@) 6) (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))) (Mul (Mul (Add a7~58@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1260@ temp_7_1~1337@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1417@ (Sub (Add (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ b8~68@)) (Add (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@))))) (=> (= temp_8_1~1482@ (Sub (Add (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ b8~68@)) (Add (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1417@ temp_8_1~1482@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1562@ (Mul (Add b9~76@ (Sub (Sub c9~78@ d9~80@) (Add c9~78@ d9~80@))) (Mul (Mul (Mul b9~76@ d9~80@) (Sub c9~78@ d9~80@)) (Mul (Mul a9~74@ a9~74@) (Mul a9~74@ 35))))) (=> (= temp_9_1~1627@ (Mul (Add b9~76@ (Sub (Sub c9~78@ d9~80@) (Add c9~78@ d9~80@))) (Mul (Mul (Mul a9~74@ a9~74@) (Mul a9~74@ 35)) (Mul (Mul b9~76@ d9~80@) (Sub c9~78@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1562@ temp_9_1~1627@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1695@ (Mul (Mul a10~82@ (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ a10~82@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ b10~84@)) (Add (Mul d10~88@ c10~86@) (Mul a10~82@ d10~88@))))) (=> (= temp_10_1~1748@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ a10~82@)) a10~82@) (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ b10~84@)) (Add (Mul d10~88@ c10~86@) (Mul a10~82@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1695@ temp_10_1~1748@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1828@ (Mul (Mul (Mul (Mul c11~94@ b11~92@) (Mul c11~94@ c11~94@)) (Mul (Sub b11~92@ c11~94@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) (Mul (Sub c11~94@ b11~92@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~1893@ (Mul (Mul (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (Sub b11~92@ c11~94@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) (Mul (Sub c11~94@ b11~92@) (Mul a11~90@ d11~96@))))) (=> (= tmp%12@ (= temp_11_0~1828@ temp_11_1~1893@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1973@ (Mul (Mul (Sub (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@)) (Sub (Mul d12~104@ c12~102@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2038@ (Mul (Mul (Sub (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@)) (Sub (Mul d12~104@ c12~102@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~1973@ temp_12_1~2038@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2130@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Add c13~110@ c13~110@)) (Mul (Mul a13~106@ d13~112@) (Sub c13~110@ a13~106@))) (Mul (Mul (Mul 87 d13~112@) (Add a13~106@ d13~112@)) (Mul (Sub c13~110@ c13~110@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2207@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Add c13~110@ c13~110@)) (Mul a13~106@ (Mul d13~112@ (Sub c13~110@ a13~106@)))) (Mul (Mul (Mul 87 d13~112@) (Add a13~106@ d13~112@)) (Mul (Sub c13~110@ c13~110@) (Mul d13~112@ b13~108@))))) (=> (= tmp%14@ (= temp_13_0~2130@ temp_13_1~2207@)) (=> %%location_label%%13 tmp%14@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
