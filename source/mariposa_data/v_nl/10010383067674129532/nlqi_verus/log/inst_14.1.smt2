...
(set-info :comment ";; mariposa_data/v_nl//10010383067674129532/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_11_0~2119@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Sub (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Sub c0~6@ b0~4@) c0~6@)) c0~6@)) (=> (= temp_0_1~306@ (Mul (Sub (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@)) (Mul c0~6@ (Sub c0~6@ b0~4@))) c0~6@)) (and (=> (= tmp%1@ (Sub c0~6@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ c0~6@) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~306@)))) (=> (= temp_0_0~273@ temp_0_1~306@) (=> (= temp_1_0~403@ (Mul (Mul (Add (Add d1~16@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Sub a1~10@ a1~10@) (Mul b1~12@ a1~10@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Add (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~476@ (Mul (Mul (Add (Add d1~16@ d1~16@) (Mul d1~16@ d1~16@)) (Sub (Mul a1~10@ (Mul b1~12@ a1~10@)) (Mul a1~10@ (Mul b1~12@ a1~10@)))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Add (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))))) (and (=> (= tmp%2@ (Mul b1~12@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a1~10@ a1~10@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~403@ temp_1_1~476@)))) (=> (= temp_1_0~403@ temp_1_1~476@) (=> (= temp_2_0~571@ (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ d2~24@) b2~20@)) (Mul (Mul (Mul b2~20@ d2~24@) (Sub d2~24@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ d2~24@))))) (=> (= temp_2_1~632@ (Mul (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ d2~24@) b2~20@)) (Mul (Mul b2~20@ d2~24@) (Sub d2~24@ b2~20@))) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ d2~24@)))) (and (=> (= tmp%3@ (Add (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ d2~24@) b2~20@))) (=> (= tmp%4@ (Mul (Mul b2~20@ d2~24@) (Sub d2~24@ b2~20@))) (=> (= tmp%5@ (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ d2~24@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~571@ temp_2_1~632@)))))) (=> (= temp_2_0~571@ temp_2_1~632@) (=> (= temp_3_0~787@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ 42)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Sub (Mul a3~26@ a3~26@) (Sub c3~30@ b3~28@))))) (=> (= temp_3_1~864@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ 42)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Sub (Mul a3~26@ a3~26@) (Sub c3~30@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ b3~28@) (=> %%location_label%%3 (= temp_3_0~787@ temp_3_1~864@))) (=> (= temp_3_0~787@ temp_3_1~864@) (=> (= temp_4_0~957@ (Sub (Add (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ d4~40@)) (Add (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~1022@ (Sub (Add (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ d4~40@)) (Add (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ d4~40@))))) (and (=> (= tmp%6@ (Mul c4~38@ d4~40@)) (=> (= tmp%7@ (Mul b4~36@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%4 (= temp_4_0~957@ temp_4_1~1022@))))) (=> (= temp_4_0~957@ temp_4_1~1022@) (=> (= temp_5_0~1111@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Add d5~48@ a5~42@)) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@))) (Mul a5~42@ (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1164@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Add d5~48@ a5~42@)) (Mul c5~46@ (Mul b5~44@ (Mul a5~42@ c5~46@)))) (Mul a5~42@ (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@))))) (and (=> (= tmp%8@ (Mul a5~42@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c5~46@ b5~44@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~1111@ temp_5_1~1164@)))) (=> (= temp_5_0~1111@ temp_5_1~1164@) (=> (= temp_6_0~1259@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) c6~54@)) (Mul (Add (Mul a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1320@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) c6~54@)) (Mul (Add (Mul a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ b6~52@))))) (and (=> (= tmp%9@ (Mul c6~54@ b6~52@)) (=> (= tmp%10@ (Mul a6~50@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~1259@ temp_6_1~1320@))))) (=> (= temp_6_0~1259@ temp_6_1~1320@) (=> (= temp_7_0~1433@ (Mul (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ 6)) (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))) (Mul (Mul (Add a7~58@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1510@ (Mul (Mul (Mul (Mul (Add c7~62@ b7~60@) b7~60@) 6) (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))) (Mul (Mul (Add a7~58@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ a7~58@))))) (and (=> (= tmp%11@ (Add c7~62@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ b7~60@ 6) (=> %%location_label%%7 (= temp_7_0~1433@ temp_7_1~1510@)))) (=> (= temp_7_0~1433@ temp_7_1~1510@) (=> (= temp_8_0~1621@ (Sub (Add (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ b8~68@)) (Add (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@))))) (=> (= temp_8_1~1686@ (Sub (Add (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ b8~68@)) (Add (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1621@ temp_8_1~1686@))) (=> (= temp_8_0~1621@ temp_8_1~1686@) (=> (= temp_9_0~1779@ (Mul (Add b9~76@ (Sub (Sub c9~78@ d9~80@) (Add c9~78@ d9~80@))) (Mul (Mul (Mul b9~76@ d9~80@) (Sub c9~78@ d9~80@)) (Mul (Mul a9~74@ a9~74@) (Mul a9~74@ 35))))) (=> (= temp_9_1~1844@ (Mul (Add b9~76@ (Sub (Sub c9~78@ d9~80@) (Add c9~78@ d9~80@))) (Mul (Mul (Mul a9~74@ a9~74@) (Mul a9~74@ 35)) (Mul (Mul b9~76@ d9~80@) (Sub c9~78@ d9~80@))))) (and (=> (= tmp%12@ (Mul (Mul b9~76@ d9~80@) (Sub c9~78@ d9~80@))) (=> (= tmp%13@ (Mul (Mul a9~74@ a9~74@) (Mul a9~74@ 35))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%9 (= temp_9_0~1779@ temp_9_1~1844@))))) (=> (= temp_9_0~1779@ temp_9_1~1844@) (=> (= temp_10_0~1961@ (Mul (Mul a10~82@ (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ a10~82@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ b10~84@)) (Add (Mul d10~88@ c10~86@) (Mul a10~82@ d10~88@))))) (=> (= temp_10_1~2014@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ a10~82@)) a10~82@) (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ b10~84@)) (Add (Mul d10~88@ c10~86@) (Mul a10~82@ d10~88@))))) (and (=> (= tmp%14@ (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ a10~82@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a10~82@ tmp%14@) (=> %%location_label%%10 (= temp_10_0~1961@ temp_10_1~2014@)))) (=> (= temp_10_0~1961@ temp_10_1~2014@) (=> (= temp_11_0~2119@ (Mul (Mul (Mul (Mul c11~94@ b11~92@) (Mul c11~94@ c11~94@)) (Mul (Sub b11~92@ c11~94@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) (Mul (Sub c11~94@ b11~92@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~2184@ (Mul (Mul (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (Sub b11~92@ c11~94@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) (Mul (Sub c11~94@ b11~92@) (Mul a11~90@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c11~94@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2119@ temp_11_1~2184@))) (=> (= temp_11_0~2119@ temp_11_1~2184@) (=> (= temp_12_0~2277@ (Mul (Mul (Sub (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@)) (Sub (Mul d12~104@ c12~102@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2342@ (Mul (Mul (Sub (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@)) (Sub (Mul d12~104@ c12~102@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2277@ temp_12_1~2342@))) (=> (= temp_12_0~2277@ temp_12_1~2342@) (=> (= temp_13_0~2447@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Add c13~110@ c13~110@)) (Mul (Mul a13~106@ d13~112@) (Sub c13~110@ a13~106@))) (Mul (Mul (Mul 87 d13~112@) (Add a13~106@ d13~112@)) (Mul (Sub c13~110@ c13~110@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2524@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Add c13~110@ c13~110@)) (Mul a13~106@ (Mul d13~112@ (Sub c13~110@ a13~106@)))) (Mul (Mul (Mul 87 d13~112@) (Add a13~106@ d13~112@)) (Mul (Sub c13~110@ c13~110@) (Mul d13~112@ b13~108@))))) (=> (= tmp%15@ (Sub c13~110@ a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a13~106@ d13~112@ tmp%15@) (=> %%location_label%%13 (= temp_13_0~2447@ temp_13_1~2524@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
