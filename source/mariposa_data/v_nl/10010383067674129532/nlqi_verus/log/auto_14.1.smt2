...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Sub (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Sub c0~6@ b0~4@) c0~6@)) c0~6@)) (=> (= temp_0_1~306@ (Mul (Sub (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@)) (Mul c0~6@ (Sub c0~6@ b0~4@))) c0~6@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~306@))) (=> (= temp_0_0~273@ temp_0_1~306@) (=> (= temp_1_0~395@ (Mul (Mul (Add (Add d1~16@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Sub a1~10@ a1~10@) (Mul b1~12@ a1~10@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Add (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~468@ (Mul (Mul (Add (Add d1~16@ d1~16@) (Mul d1~16@ d1~16@)) (Sub (Mul a1~10@ (Mul b1~12@ a1~10@)) (Mul a1~10@ (Mul b1~12@ a1~10@)))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Add (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~395@ temp_1_1~468@))) (=> (= temp_1_0~395@ temp_1_1~468@) (=> (= temp_2_0~553@ (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ d2~24@) b2~20@)) (Mul (Mul (Mul b2~20@ d2~24@) (Sub d2~24@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ d2~24@))))) (=> (= temp_2_1~614@ (Mul (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ d2~24@) b2~20@)) (Mul (Mul b2~20@ d2~24@) (Sub d2~24@ b2~20@))) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ d2~24@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~553@ temp_2_1~614@))) (=> (= temp_2_0~553@ temp_2_1~614@) (=> (= temp_3_0~715@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ 42)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Sub (Mul a3~26@ a3~26@) (Sub c3~30@ b3~28@))))) (=> (= temp_3_1~792@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ 42)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Sub (Mul a3~26@ a3~26@) (Sub c3~30@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~715@ temp_3_1~792@))) (=> (= temp_3_0~715@ temp_3_1~792@) (=> (= temp_4_0~881@ (Sub (Add (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ d4~40@)) (Add (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~946@ (Sub (Add (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ d4~40@)) (Add (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~881@ temp_4_1~946@))) (=> (= temp_4_0~881@ temp_4_1~946@) (=> (= temp_5_0~1023@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Add d5~48@ a5~42@)) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@))) (Mul a5~42@ (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1076@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Add d5~48@ a5~42@)) (Mul c5~46@ (Mul b5~44@ (Mul a5~42@ c5~46@)))) (Mul a5~42@ (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1023@ temp_5_1~1076@))) (=> (= temp_5_0~1023@ temp_5_1~1076@) (=> (= temp_6_0~1161@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) c6~54@)) (Mul (Add (Mul a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1222@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) c6~54@)) (Mul (Add (Mul a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1161@ temp_6_1~1222@))) (=> (= temp_6_0~1161@ temp_6_1~1222@) (=> (= temp_7_0~1323@ (Mul (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ 6)) (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))) (Mul (Mul (Add a7~58@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1400@ (Mul (Mul (Mul (Mul (Add c7~62@ b7~60@) b7~60@) 6) (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))) (Mul (Mul (Add a7~58@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1323@ temp_7_1~1400@))) (=> (= temp_7_0~1323@ temp_7_1~1400@) (=> (= temp_8_0~1489@ (Sub (Add (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ b8~68@)) (Add (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@))))) (=> (= temp_8_1~1554@ (Sub (Add (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ b8~68@)) (Add (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1489@ temp_8_1~1554@))) (=> (= temp_8_0~1489@ temp_8_1~1554@) (=> (= temp_9_0~1643@ (Mul (Add b9~76@ (Sub (Sub c9~78@ d9~80@) (Add c9~78@ d9~80@))) (Mul (Mul (Mul b9~76@ d9~80@) (Sub c9~78@ d9~80@)) (Mul (Mul a9~74@ a9~74@) (Mul a9~74@ 35))))) (=> (= temp_9_1~1708@ (Mul (Add b9~76@ (Sub (Sub c9~78@ d9~80@) (Add c9~78@ d9~80@))) (Mul (Mul (Mul a9~74@ a9~74@) (Mul a9~74@ 35)) (Mul (Mul b9~76@ d9~80@) (Sub c9~78@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1643@ temp_9_1~1708@))) (=> (= temp_9_0~1643@ temp_9_1~1708@) (=> (= temp_10_0~1785@ (Mul (Mul a10~82@ (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ a10~82@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ b10~84@)) (Add (Mul d10~88@ c10~86@) (Mul a10~82@ d10~88@))))) (=> (= temp_10_1~1838@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ a10~82@)) a10~82@) (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ b10~84@)) (Add (Mul d10~88@ c10~86@) (Mul a10~82@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1785@ temp_10_1~1838@))) (=> (= temp_10_0~1785@ temp_10_1~1838@) (=> (= temp_11_0~1927@ (Mul (Mul (Mul (Mul c11~94@ b11~92@) (Mul c11~94@ c11~94@)) (Mul (Sub b11~92@ c11~94@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) (Mul (Sub c11~94@ b11~92@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~1992@ (Mul (Mul (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (Sub b11~92@ c11~94@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) (Mul (Sub c11~94@ b11~92@) (Mul a11~90@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1927@ temp_11_1~1992@))) (=> (= temp_11_0~1927@ temp_11_1~1992@) (=> (= temp_12_0~2081@ (Mul (Mul (Sub (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@)) (Sub (Mul d12~104@ c12~102@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2146@ (Mul (Mul (Sub (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@)) (Sub (Mul d12~104@ c12~102@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2081@ temp_12_1~2146@))) (=> (= temp_12_0~2081@ temp_12_1~2146@) (=> (= temp_13_0~2247@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Add c13~110@ c13~110@)) (Mul (Mul a13~106@ d13~112@) (Sub c13~110@ a13~106@))) (Mul (Mul (Mul 87 d13~112@) (Add a13~106@ d13~112@)) (Mul (Sub c13~110@ c13~110@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2324@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Add c13~110@ c13~110@)) (Mul a13~106@ (Mul d13~112@ (Sub c13~110@ a13~106@)))) (Mul (Mul (Mul 87 d13~112@) (Add a13~106@ d13~112@)) (Mul (Sub c13~110@ c13~110@) (Mul d13~112@ b13~108@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2247@ temp_13_1~2324@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
