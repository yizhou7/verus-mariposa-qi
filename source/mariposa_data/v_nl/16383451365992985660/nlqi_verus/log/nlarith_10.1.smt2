...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Sub (Mul d0~8@ c0~6@) (Add b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) c0~6@)) (Mul (Add (Mul c0~6@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Sub (Mul d0~8@ c0~6@) (Add b0~4@ a0~2@)) (Mul b0~4@ d0~8@)) c0~6@) (Mul (Add (Mul c0~6@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~442@ (Mul (Mul (Add (Mul a1~10@ a1~10@) (Mul d1~16@ c1~14@)) (Add (Sub c1~14@ a1~10@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~507@ (Mul (Mul (Add (Mul a1~10@ a1~10@) (Mul d1~16@ c1~14@)) (Add (Sub c1~14@ a1~10@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~442@ temp_1_1~507@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~587@ (Add (Mul (Mul (Mul 44 d2~24@) (Mul d2~24@ d2~24@)) d2~24@) (Mul (Sub (Mul d2~24@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~652@ (Add (Mul (Mul (Mul d2~24@ 44) (Mul d2~24@ d2~24@)) d2~24@) (Mul (Sub (Mul d2~24@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~587@ temp_2_1~652@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~732@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ d3~32@) (Sub d3~32@ b3~28@))) (Sub (Mul (Add d3~32@ c3~30@) (Mul b3~28@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Add d3~32@ d3~32@))))) (=> (= temp_3_1~797@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Sub d3~32@ b3~28@) (Mul b3~28@ d3~32@))) (Sub (Mul (Add d3~32@ c3~30@) (Mul b3~28@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Add d3~32@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~732@ temp_3_1~797@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~877@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Add c4~38@ b4~36@)) (Add (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@))) (Add (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Sub d4~40@ d4~40@))))) (=> (= temp_4_1~942@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Add c4~38@ b4~36@)) (Add (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@))) (Add (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ b4~36@) (Sub d4~40@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~877@ temp_4_1~942@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1042@ (Sub (Mul (Mul (Mul b5~44@ c5~46@) (Mul 72 b5~44@)) (Sub (Add d5~48@ c5~46@) c5~46@)) (Mul (Mul (Mul 74 d5~48@) (Mul b5~44@ d5~48@)) (Mul (Sub b5~44@ b5~44@) (Add c5~46@ a5~42@))))) (=> (= temp_5_1~1127@ (Sub (Mul (Mul (Mul b5~44@ c5~46@) (Mul 72 b5~44@)) (Sub (Add d5~48@ c5~46@) c5~46@)) (Mul (Mul (Mul d5~48@ 74) (Mul b5~44@ d5~48@)) (Mul (Sub b5~44@ b5~44@) (Add c5~46@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~1042@ temp_5_1~1127@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1231@ (Mul (Mul (Mul (Sub b6~52@ d6~56@) (Mul 61 b6~52@)) (Sub (Mul c6~54@ a6~50@) (Sub a6~50@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ 85)) (Mul (Add a6~50@ b6~52@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1320@ (Mul (Mul (Mul (Sub b6~52@ d6~56@) (Mul 61 b6~52@)) (Sub (Mul c6~54@ a6~50@) (Sub a6~50@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ 85)) (Mul (Add a6~50@ b6~52@) (Mul c6~54@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1231@ temp_6_1~1320@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1388@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@)) (Add (Mul b7~60@ b7~60@) (Mul a7~58@ a7~58@))) (Mul a7~58@ (Add (Mul b7~60@ c7~62@) (Sub a7~58@ d7~64@))))) (=> (= temp_7_1~1441@ (Mul (Mul (Mul b7~60@ c7~62@) (Mul (Mul b7~60@ b7~60@) (Add (Mul b7~60@ b7~60@) (Mul a7~58@ a7~58@)))) (Mul a7~58@ (Add (Mul b7~60@ c7~62@) (Sub a7~58@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1388@ temp_7_1~1441@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1509@ (Mul (Mul 47 c8~70@) (Mul (Mul (Mul c8~70@ b8~68@) (Add c8~70@ d8~72@)) (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1562@ (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Add c8~70@ d8~72@)) (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ a8~66@))) (Mul 47 c8~70@))) (=> (= tmp%9@ (= temp_8_0~1509@ temp_8_1~1562@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1630@ (Sub (Mul (Add (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@)) a9~74@) (Mul (Mul (Mul c9~78@ c9~78@) (Sub a9~74@ c9~78@)) (Mul (Mul a9~74@ a9~74@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~1683@ (Sub (Mul (Add (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@)) a9~74@) (Mul (Mul (Mul a9~74@ a9~74@) (Mul b9~76@ c9~78@)) (Mul (Mul c9~78@ c9~78@) (Sub a9~74@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1630@ temp_9_1~1683@)) (=> %%location_label%%9 tmp%10@))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
