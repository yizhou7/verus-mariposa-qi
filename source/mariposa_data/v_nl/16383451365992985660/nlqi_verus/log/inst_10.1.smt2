...
(set-info :comment ";; mariposa_data/v_nl//16383451365992985660/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_7_0~1529@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Sub (Mul d0~8@ c0~6@) (Add b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) c0~6@)) (Mul (Add (Mul c0~6@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Sub (Mul d0~8@ c0~6@) (Add b0~4@ a0~2@)) (Mul b0~4@ d0~8@)) c0~6@) (Mul (Add (Mul c0~6@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@))))) (and (=> (= tmp%1@ (Sub (Mul d0~8@ c0~6@) (Add b0~4@ a0~2@))) (=> (= tmp%2@ (Mul b0~4@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ c0~6@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~473@ (Mul (Mul (Add (Mul a1~10@ a1~10@) (Mul d1~16@ c1~14@)) (Add (Sub c1~14@ a1~10@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~538@ (Mul (Mul (Add (Mul a1~10@ a1~10@) (Mul d1~16@ c1~14@)) (Add (Sub c1~14@ a1~10@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~473@ temp_1_1~538@))) (=> (= temp_1_0~473@ temp_1_1~538@) (=> (= temp_2_0~631@ (Add (Mul (Mul (Mul 44 d2~24@) (Mul d2~24@ d2~24@)) d2~24@) (Mul (Sub (Mul d2~24@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~696@ (Add (Mul (Mul (Mul d2~24@ 44) (Mul d2~24@ d2~24@)) d2~24@) (Mul (Sub (Mul d2~24@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 44 d2~24@) (=> %%location_label%%2 (= temp_2_0~631@ temp_2_1~696@))) (=> (= temp_2_0~631@ temp_2_1~696@) (=> (= temp_3_0~801@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ d3~32@) (Sub d3~32@ b3~28@))) (Sub (Mul (Add d3~32@ c3~30@) (Mul b3~28@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Add d3~32@ d3~32@))))) (=> (= temp_3_1~866@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Sub d3~32@ b3~28@) (Mul b3~28@ d3~32@))) (Sub (Mul (Add d3~32@ c3~30@) (Mul b3~28@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Add d3~32@ d3~32@))))) (and (=> (= tmp%3@ (Mul b3~28@ d3~32@)) (=> (= tmp%4@ (Sub d3~32@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~801@ temp_3_1~866@))))) (=> (= temp_3_0~801@ temp_3_1~866@) (=> (= temp_4_0~967@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Add c4~38@ b4~36@)) (Add (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@))) (Add (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Sub d4~40@ d4~40@))))) (=> (= temp_4_1~1032@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Add c4~38@ b4~36@)) (Add (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@))) (Add (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ b4~36@) (Sub d4~40@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ c4~38@) (=> %%location_label%%4 (= temp_4_0~967@ temp_4_1~1032@))) (=> (= temp_4_0~967@ temp_4_1~1032@) (=> (= temp_5_0~1145@ (Sub (Mul (Mul (Mul b5~44@ c5~46@) (Mul 72 b5~44@)) (Sub (Add d5~48@ c5~46@) c5~46@)) (Mul (Mul (Mul 74 d5~48@) (Mul b5~44@ d5~48@)) (Mul (Sub b5~44@ b5~44@) (Add c5~46@ a5~42@))))) (=> (= temp_5_1~1230@ (Sub (Mul (Mul (Mul b5~44@ c5~46@) (Mul 72 b5~44@)) (Sub (Add d5~48@ c5~46@) c5~46@)) (Mul (Mul (Mul d5~48@ 74) (Mul b5~44@ d5~48@)) (Mul (Sub b5~44@ b5~44@) (Add c5~46@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 74 d5~48@) (=> %%location_label%%5 (= temp_5_0~1145@ temp_5_1~1230@))) (=> (= temp_5_0~1145@ temp_5_1~1230@) (=> (= temp_6_0~1359@ (Mul (Mul (Mul (Sub b6~52@ d6~56@) (Mul 61 b6~52@)) (Sub (Mul c6~54@ a6~50@) (Sub a6~50@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ 85)) (Mul (Add a6~50@ b6~52@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1448@ (Mul (Mul (Mul (Sub b6~52@ d6~56@) (Mul 61 b6~52@)) (Sub (Mul c6~54@ a6~50@) (Sub a6~50@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ 85)) (Mul (Add a6~50@ b6~52@) (Mul c6~54@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1359@ temp_6_1~1448@))) (=> (= temp_6_0~1359@ temp_6_1~1448@) (=> (= temp_7_0~1529@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@)) (Add (Mul b7~60@ b7~60@) (Mul a7~58@ a7~58@))) (Mul a7~58@ (Add (Mul b7~60@ c7~62@) (Sub a7~58@ d7~64@))))) (=> (= temp_7_1~1582@ (Mul (Mul (Mul b7~60@ c7~62@) (Mul (Mul b7~60@ b7~60@) (Add (Mul b7~60@ b7~60@) (Mul a7~58@ a7~58@)))) (Mul a7~58@ (Add (Mul b7~60@ c7~62@) (Sub a7~58@ d7~64@))))) (and (=> (= tmp%5@ (Mul b7~60@ c7~62@)) (=> (= tmp%6@ (Mul b7~60@ b7~60@)) (=> (= tmp%7@ (Add (Mul b7~60@ b7~60@) (Mul a7~58@ a7~58@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%7 (= temp_7_0~1529@ temp_7_1~1582@)))))) (=> (= temp_7_0~1529@ temp_7_1~1582@) (=> (= temp_8_0~1685@ (Mul (Mul 47 c8~70@) (Mul (Mul (Mul c8~70@ b8~68@) (Add c8~70@ d8~72@)) (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1738@ (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Add c8~70@ d8~72@)) (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ a8~66@))) (Mul 47 c8~70@))) (and (=> (= tmp%8@ (Mul 47 c8~70@)) (=> (= tmp%9@ (Mul (Mul (Mul c8~70@ b8~68@) (Add c8~70@ d8~72@)) (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ a8~66@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%8 (= temp_8_0~1685@ temp_8_1~1738@))))) (=> (= temp_8_0~1685@ temp_8_1~1738@) (=> (= temp_9_0~1863@ (Sub (Mul (Add (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@)) a9~74@) (Mul (Mul (Mul c9~78@ c9~78@) (Sub a9~74@ c9~78@)) (Mul (Mul a9~74@ a9~74@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~1916@ (Sub (Mul (Add (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@)) a9~74@) (Mul (Mul (Mul a9~74@ a9~74@) (Mul b9~76@ c9~78@)) (Mul (Mul c9~78@ c9~78@) (Sub a9~74@ c9~78@))))) (=> (= tmp%10@ (Mul (Mul c9~78@ c9~78@) (Sub a9~74@ c9~78@))) (=> (= tmp%11@ (Mul (Mul a9~74@ a9~74@) (Mul b9~76@ c9~78@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%9 (= temp_9_0~1863@ temp_9_1~1916@))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
