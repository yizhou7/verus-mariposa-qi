...
(set-info :comment ";; mariposa_data/v_nl//10897592030914879309/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_11_0~2109@ Int)
(declare-const temp_11_1~2182@ Int)
(declare-const temp_12_0~2263@ Int)
...
(declare-const temp_16_0~2847@ Int)
(declare-const temp_16_1~2880@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Add (Add (Sub (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@)) (Sub (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@))) (Mul (Sub (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@)) (Mul a0~2@ (Mul c0~6@ a0~2@))))) (=> (= temp_0_1~374@ (Add (Add (Sub (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@)) (Sub (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@))) (Sub (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ (Mul c0~6@ a0~2@))) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ (Mul c0~6@ a0~2@)))))) (and (=> (= tmp%1@ (Mul b0~4@ b0~4@)) (=> (= tmp%2@ (Mul b0~4@ a0~2@)) (=> (= tmp%3@ (Mul a0~2@ (Mul c0~6@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~374@)))))) (=> (= temp_0_0~301@ temp_0_1~374@) (=> (= temp_1_0~481@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul (Add d1~16@ a1~10@) (Sub a1~10@ b1~12@))) (Mul (Add (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~542@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul (Add d1~16@ a1~10@) (Sub a1~10@ b1~12@))) (Mul (Add (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul (Mul a1~10@ b1~12@) c1~14@) a1~10@)))) (and (=> (= tmp%4@ (Mul a1~10@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ c1~14@ a1~10@) (=> %%location_label%%1 (= temp_1_0~481@ temp_1_1~542@)))) (=> (= temp_1_0~481@ temp_1_1~542@) (=> (= temp_2_0~641@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Add c2~22@ b2~20@))))) (=> (= temp_2_1~706@ (Mul (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@)) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Add c2~22@ b2~20@)))))) (and (=> (= tmp%5@ (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ d2~24@))) (=> (= tmp%6@ (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@))) (=> (= tmp%7@ (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Add c2~22@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~641@ temp_2_1~706@)))))) (=> (= temp_2_0~641@ temp_2_1~706@) (=> (= temp_3_0~849@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Add b3~28@ d3~32@) d3~32@)) (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~910@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Add b3~28@ d3~32@) d3~32@)) (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@))))) (and (=> (= tmp%8@ (Mul b3~28@ b3~28@)) (=> (= tmp%9@ (Mul b3~28@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%3 (= temp_3_0~849@ temp_3_1~910@))))) (=> (= temp_3_0~849@ temp_3_1~910@) (=> (= temp_4_0~995@ (Mul (Mul a4~34@ (Mul (Mul c4~38@ b4~36@) (Add a4~34@ a4~34@))) (Mul (Mul (Add c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul a4~34@ (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~1044@ (Mul (Mul a4~34@ (Mul (Mul c4~38@ b4~36@) (Add a4~34@ a4~34@))) (Mul (Mul (Mul (Add c4~38@ d4~40@) b4~36@) c4~38@) (Mul a4~34@ (Mul d4~40@ c4~38@))))) (and (=> (= tmp%10@ (Add c4~38@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ b4~36@ c4~38@) (=> %%location_label%%4 (= temp_4_0~995@ temp_4_1~1044@)))) (=> (= temp_4_0~995@ temp_4_1~1044@) (=> (= temp_5_0~1139@ (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Sub a5~42@ d5~48@)) (Sub (Add d5~48@ c5~46@) (Sub b5~44@ b5~44@))) (Mul (Add (Mul a5~42@ d5~48@) (Sub c5~46@ d5~48@)) (Sub a5~42@ (Mul b5~44@ d5~48@))))) (=> (= temp_5_1~1200@ (Mul (Mul (Mul (Sub a5~42@ d5~48@) (Mul d5~48@ c5~46@)) (Sub (Add d5~48@ c5~46@) (Sub b5~44@ b5~44@))) (Mul (Add (Mul a5~42@ d5~48@) (Sub c5~46@ d5~48@)) (Sub a5~42@ (Mul b5~44@ d5~48@))))) (and (=> (= tmp%11@ (Mul d5~48@ c5~46@)) (=> (= tmp%12@ (Sub a5~42@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%5 (= temp_5_0~1139@ temp_5_1~1200@))))) (=> (= temp_5_0~1139@ temp_5_1~1200@) (=> (= temp_6_0~1309@ (Mul (Mul (Add (Mul 90 c6~54@) (Mul d6~56@ b6~52@)) (Mul (Sub b6~52@ c6~54@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) a6~50@) (Add (Add c6~54@ c6~54@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1382@ (Mul (Mul (Add (Mul 90 c6~54@) (Mul d6~56@ b6~52@)) (Mul (Sub b6~52@ c6~54@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) a6~50@) (Add (Add c6~54@ c6~54@) (Mul b6~52@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1309@ temp_6_1~1382@))) (=> (= temp_6_0~1309@ temp_6_1~1382@) (=> (= temp_7_0~1475@ (Sub (Mul (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Add b7~60@ d7~64@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Sub c7~62@ c7~62@) (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1540@ (Sub (Mul (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Add b7~60@ d7~64@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ a7~58@)) (Mul (Sub c7~62@ c7~62@) (Mul d7~64@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1475@ temp_7_1~1540@))) (=> (= temp_7_0~1475@ temp_7_1~1540@) (=> (= temp_8_0~1645@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ b8~68@))) (Mul (Mul (Add 72 c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1722@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul c8~70@ (Mul b8~68@ (Mul c8~70@ b8~68@)))) (Mul (Mul (Add 72 c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@))))) (and (=> (= tmp%13@ (Mul c8~70@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c8~70@ b8~68@ tmp%13@) (=> %%location_label%%8 (= temp_8_0~1645@ temp_8_1~1722@)))) (=> (= temp_8_0~1645@ temp_8_1~1722@) (=> (= temp_9_0~1805@ (Sub (Mul a9~74@ (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ a9~74@))) (Mul (Mul (Mul d9~80@ d9~80@) d9~80@) (Add (Mul a9~74@ a9~74@) (Sub c9~78@ c9~78@))))) (=> (= temp_9_1~1854@ (Sub (Mul a9~74@ (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ a9~74@))) (Mul (Mul d9~80@ (Mul d9~80@ d9~80@)) (Add (Mul a9~74@ a9~74@) (Sub c9~78@ c9~78@))))) (and (=> (= tmp%14@ (Mul d9~80@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ d9~80@) (=> %%location_label%%9 (= temp_9_0~1805@ temp_9_1~1854@)))) (=> (= temp_9_0~1805@ temp_9_1~1854@) (=> (= temp_10_0~1947@ (Mul (Mul (Mul (Mul d10~88@ a10~82@) d10~88@) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul d10~88@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ d10~88@))))) (=> (= temp_10_1~2008@ (Mul (Mul (Mul (Mul d10~88@ a10~82@) d10~88@) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul d10~88@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ c10~86@) (=> %%location_label%%10 (= temp_10_0~1947@ temp_10_1~2008@))) (=> (= temp_10_0~1947@ temp_10_1~2008@) (=> (= temp_11_0~2109@ (Mul (Mul (Mul (Sub 3 c11~94@) b11~92@) (Mul (Sub d11~96@ b11~92@) (Sub b11~92@ a11~90@))) (Mul (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~2182@ (Mul (Mul (Mul (Sub 3 c11~94@) b11~92@) (Mul (Sub d11~96@ b11~92@) (Sub b11~92@ a11~90@))) (Mul (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d11~96@ c11~94@) (=> %%location_label%%11 (= temp_11_0~2109@ temp_11_1~2182@))) (=> (= temp_11_0~2109@ temp_11_1~2182@) (=> (= temp_12_0~2263@ (Mul (Add (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Sub d12~104@ b12~100@))) (Mul (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ b12~100@)) c12~102@))) (=> (= temp_12_1~2316@ (Mul (Add (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Sub d12~104@ b12~100@))) (Mul c12~102@ (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ b12~100@))))) (and (=> (= tmp%15@ (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ c12~102@) (=> %%location_label%%12 (= temp_12_0~2263@ temp_12_1~2316@)))) (=> (= temp_12_0~2263@ temp_12_1~2316@) (=> (= temp_13_0~2421@ (Add (Mul (Mul (Add b13~108@ a13~106@) (Sub a13~106@ b13~108@)) (Add (Add b13~108@ c13~110@) (Mul a13~106@ a13~106@))) (Mul (Mul (Add a13~106@ d13~112@) (Mul b13~108@ b13~108@)) (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2486@ (Add (Mul (Mul (Add b13~108@ a13~106@) (Sub a13~106@ b13~108@)) (Add (Add b13~108@ c13~110@) (Mul a13~106@ a13~106@))) (Mul (Mul (Mul b13~108@ b13~108@) (Add a13~106@ d13~112@)) (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@))))) (and (=> (= tmp%16@ (Add a13~106@ d13~112@)) (=> (= tmp%17@ (Mul b13~108@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%13 (= temp_13_0~2421@ temp_13_1~2486@))))) (=> (= temp_13_0~2421@ temp_13_1~2486@) (=> (= temp_14_0~2587@ (Mul (Mul (Sub (Mul a14~114@ b14~116@) (Mul c14~118@ d14~120@)) (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul d14~120@ b14~116@)) (Sub (Mul a14~114@ d14~120@) (Mul c14~118@ c14~118@))))) (=> (= temp_14_1~2652@ (Mul (Mul (Sub (Mul a14~114@ b14~116@) (Mul c14~118@ d14~120@)) (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ b14~116@)) (Sub (Mul a14~114@ d14~120@) (Mul c14~118@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c14~118@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2587@ temp_14_1~2652@))) (=> (= temp_14_0~2587@ temp_14_1~2652@) (=> (= temp_15_0~2729@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) d15~128@) a15~122@) (Mul (Mul (Mul b15~124@ d15~128@) (Mul d15~128@ c15~126@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ b15~124@))))) (=> (= temp_15_1~2778@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) d15~128@) a15~122@) (Mul (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ b15~124@))))) (and (=> (= tmp%18@ (Mul b15~124@ d15~128@)) (=> (= tmp%19@ (Mul d15~128@ c15~126@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%15 (= temp_15_0~2729@ temp_15_1~2778@))))) (=> (= temp_15_0~2729@ temp_15_1~2778@) (=> (= temp_16_0~2847@ (Mul c16~134@ (Mul (Mul (Mul c16~134@ a16~130@) (Sub c16~134@ a16~130@)) (Mul a16~130@ (Add c16~134@ b16~132@))))) (=> (= temp_16_1~2880@ (Mul c16~134@ (Mul (Mul c16~134@ (Mul a16~130@ (Sub c16~134@ a16~130@))) (Mul a16~130@ (Add c16~134@ b16~132@))))) (=> (= tmp%20@ (Sub c16~134@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c16~134@ a16~130@ tmp%20@) (=> %%location_label%%16 (= temp_16_0~2847@ temp_16_1~2880@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
