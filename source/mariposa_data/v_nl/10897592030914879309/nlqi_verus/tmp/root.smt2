...
;; mariposa_data/v_nl//10897592030914879309/nlqi_verus/src/main.rs:7:1: 36:40 (#0)
(push)
 ...
 (declare-const temp_0_1~374@ Int)
 (declare-const temp_1_0~459@ Int)
 (declare-const temp_1_1~520@ Int)
 ...
 (declare-const temp_6_0~1185@ Int)
 ...
 (declare-const temp_16_0~2645@ Int)
 (declare-const temp_16_1~2678@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~301@ (Add (Add (Sub (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@)) (Sub (Mul d0~8@ c0~6@)
         (Mul b0~4@ d0~8@)
        )
       ) (Mul (Sub (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@)) (Mul a0~2@ (Mul c0~6@ a0~2@)))
     ))
     (=>
      (= temp_0_1~374@ (Add (Add (Sub (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@)) (Sub (Mul d0~8@ c0~6@)
          (Mul b0~4@ d0~8@)
         )
        ) (Sub (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ (Mul c0~6@ a0~2@))) (Mul (Mul b0~4@ a0~2@)
          (Mul a0~2@ (Mul c0~6@ a0~2@))
      ))))
      (and
       (=>
        ...
        (=>
         %%location_label%%0
         (= temp_0_0~301@ temp_0_1~374@)
       ))
       (=>
        (= temp_0_0~301@ temp_0_1~374@)
        (=>
         (= temp_1_0~459@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul (Add d1~16@ a1~10@)
             (Sub a1~10@ b1~12@)
            )
           ) (Mul (Add (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@
              a1~10@
         )))))
         (=>
          (= temp_1_1~520@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul (Add d1~16@ a1~10@)
              (Sub a1~10@ b1~12@)
             )
            ) (Mul (Add (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul (Mul a1~10@ b1~12@) c1~14@)
              a1~10@
          ))))
          (and
           (=>
            ...
            (=>
             %%location_label%%1
             (= temp_1_0~459@ temp_1_1~520@)
           ))
           (=>
            (= temp_1_0~459@ temp_1_1~520@)
            (=>
             (= temp_2_0~609@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@
                  c2~22@
                 ) (Mul b2~20@ a2~18@)
                )
               ) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Add c2~22@
                  b2~20@
             )))))
             (=>
              (= temp_2_1~674@ (Mul (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul (Mul b2~20@
                   c2~22@
                  ) (Mul b2~20@ a2~18@)
                 ) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Add c2~22@
                    b2~20@
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~609@ temp_2_1~674@)
               ))
               (=>
                (= temp_2_0~609@ temp_2_1~674@)
                (=>
                 (= temp_3_0~759@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Add b3~28@
                      d3~32@
                     ) d3~32@
                    )
                   ) (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@
                      d3~32@
                 )))))
                 (=>
                  (= temp_3_1~820@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Add b3~28@
                       d3~32@
                      ) d3~32@
                     )
                    ) (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~759@ temp_3_1~820@)
                   ))
                   (=>
                    (= temp_3_0~759@ temp_3_1~820@)
                    (=>
                     (= temp_4_0~893@ (Mul (Mul a4~34@ (Mul (Mul c4~38@ b4~36@) (Add a4~34@ a4~34@))) (Mul
                        (Mul (Add c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul a4~34@ (Mul d4~40@ c4~38@))
                     )))
                     (=>
                      (= temp_4_1~942@ (Mul (Mul a4~34@ (Mul (Mul c4~38@ b4~36@) (Add a4~34@ a4~34@))) (Mul
                         (Mul (Mul (Add c4~38@ d4~40@) b4~36@) c4~38@) (Mul a4~34@ (Mul d4~40@ c4~38@))
                      )))
                      (and
                       (=>
                        (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                        (=>
                         %%location_label%%4
                         (= temp_4_0~893@ temp_4_1~942@)
                       ))
                       (=>
                        (= temp_4_0~893@ temp_4_1~942@)
                        (=>
                         (= temp_5_0~1027@ (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Sub a5~42@ d5~48@)) (Sub (Add d5~48@
                              c5~46@
                             ) (Sub b5~44@ b5~44@)
                            )
                           ) (Mul (Add (Mul a5~42@ d5~48@) (Sub c5~46@ d5~48@)) (Sub a5~42@ (Mul b5~44@ d5~48@)))
                         ))
                         (=>
                          (= temp_5_1~1088@ (Mul (Mul (Mul (Sub a5~42@ d5~48@) (Mul d5~48@ c5~46@)) (Sub (Add d5~48@
                               c5~46@
                              ) (Sub b5~44@ b5~44@)
                             )
                            ) (Mul (Add (Mul a5~42@ d5~48@) (Sub c5~46@ d5~48@)) (Sub a5~42@ (Mul b5~44@ d5~48@)))
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1027@ temp_5_1~1088@)
                           ))
                           (=>
                            (= temp_5_0~1027@ temp_5_1~1088@)
                            (=>
                             (= temp_6_0~1185@ (Mul (Mul (Add (Mul 90 c6~54@) (Mul d6~56@ b6~52@)) (Mul (Sub b6~52@
                                  c6~54@
                                 ) (Mul c6~54@ b6~52@)
                                )
                               ) (Mul (Mul (Mul a6~50@ a6~50@) a6~50@) (Add (Add c6~54@ c6~54@) (Mul b6~52@ d6~56@)))
                             ))
                             (=>
                              (= temp_6_1~1258@ (Mul (Mul (Add (Mul 90 c6~54@) (Mul d6~56@ b6~52@)) (Mul (Sub b6~52@
                                   c6~54@
                                  ) (Mul c6~54@ b6~52@)
                                 )
                                ) (Mul (Mul (Mul a6~50@ a6~50@) a6~50@) (Add (Add c6~54@ c6~54@) (Mul b6~52@ d6~56@)))
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1185@ temp_6_1~1258@)
                               ))
                               (=>
                                (= temp_6_0~1185@ temp_6_1~1258@)
                                (=>
                                 (= temp_7_0~1347@ (Sub (Mul (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Add b7~60@
                                      d7~64@
                                     ) (Mul b7~60@ d7~64@)
                                    )
                                   ) (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Sub c7~62@ c7~62@) (Mul d7~64@
                                      d7~64@
                                 )))))
                                 (=>
                                  (= temp_7_1~1412@ (Sub (Mul (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Add b7~60@
                                       d7~64@
                                      ) (Mul b7~60@ d7~64@)
                                     )
                                    ) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ a7~58@)) (Mul (Sub c7~62@ c7~62@) (Mul d7~64@
                                       d7~64@
                                  )))))
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1347@ temp_7_1~1412@)
                                   ))
                                   (=>
                                    (= temp_7_0~1347@ temp_7_1~1412@)
                                    (=>
                                     (= temp_8_0~1513@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@
                                          b8~68@
                                         ) (Mul c8~70@ b8~68@)
                                        )
                                       ) (Mul (Mul (Add 72 c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@
                                          a8~66@
                                     )))))
                                     (=>
                                      (= temp_8_1~1590@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul c8~70@
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1513@ temp_8_1~1590@)
                                       ))
                                       (=>
                                        (= temp_8_0~1513@ temp_8_1~1590@)
                                        (=>
                                         (= temp_9_0~1663@ (Sub (Mul a9~74@ (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ a9~74@))) (
                                            Mul (Mul (Mul d9~80@ d9~80@) d9~80@) (Add (Mul a9~74@ a9~74@) (Sub c9~78@ c9~78@))
                                         )))
                                         (=>
                                          (= temp_9_1~1712@ (Sub (Mul a9~74@ (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ a9~74@))) (
                                             Mul (Mul d9~80@ (Mul d9~80@ d9~80@)) (Add (Mul a9~74@ a9~74@) (Sub c9~78@ c9~78@))
                                          )))
                                          (and
                                           (=>
                                            (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1663@ temp_9_1~1712@)
                                           ))
                                           (=>
                                            (= temp_9_0~1663@ temp_9_1~1712@)
                                            (=>
                                             (= temp_10_0~1797@ (Mul (Mul (Mul (Mul d10~88@ a10~82@) d10~88@) (Mul (Mul a10~82@ c10~86@)
                                                 (Mul c10~86@ c10~86@)
                                                )
                                               ) (Mul (Mul (Mul d10~88@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Mul a10~82@ c10~86@)
                                                 (Mul a10~82@ d10~88@)
                                             ))))
                                             (=>
                                              (= temp_10_1~1858@ (Mul (Mul (Mul (Mul d10~88@ a10~82@) d10~88@) (Mul (Mul a10~82@ c10~86@)
                                                  (Mul c10~86@ c10~86@)
                                                 )
                                                ) (Mul (Mul (Mul d10~88@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Mul a10~82@ c10~86@)
                                                  (Mul a10~82@ d10~88@)
                                              ...
                                              (and
                                               ...
                                               (=>
                                                (= temp_10_0~1797@ temp_10_1~1858@)
                                                (=>
                                                 (= temp_11_0~1955@ (Mul (Mul (Mul (Sub 3 c11~94@) b11~92@) (Mul (Sub d11~96@ b11~92@)
                                                     (Sub b11~92@ a11~90@)
                                                    )
                                                   ) (Mul (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ c11~94@)
                                                     (Mul a11~90@ c11~94@)
                                                 ))))
                                                 (=>
                                                  (= temp_11_1~2028@ (Mul (Mul (Mul (Sub 3 c11~94@) b11~92@) (Mul (Sub d11~96@ b11~92@)
                                                      (Sub b11~92@ a11~90@)
                                                     )
                                                    ) (Mul (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul c11~94@ d11~96@)
                                                      (Mul a11~90@ c11~94@)
                                                  ))))
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~1955@ temp_11_1~2028@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~1955@ temp_11_1~2028@)
                                                    (=>
                                                     (= temp_12_0~2105@ (Mul (Add (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@)) (Mul
                                                         (Mul a12~98@ b12~100@) (Sub d12~104@ b12~100@)
                                                        )
                                                       ) (Mul (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ b12~100@)) c12~102@)
                                                     ))
                                                     (=>
                                                      (= temp_12_1~2158@ (Mul (Add (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@)) (Mul
                                                          (Mul a12~98@ b12~100@) (Sub d12~104@ b12~100@)
                                                         )
                                                        ) (Mul c12~102@ (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ b12~100@)))
                                                      ))
                                                      (and
                                                       (=>
                                                        (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                                                       ...
                                                       (=>
                                                        (= temp_12_0~2105@ temp_12_1~2158@)
                                                        (=>
                                                         (= temp_13_0~2247@ (Add (Mul (Mul (Add b13~108@ a13~106@) (Sub a13~106@ b13~108@)) (
                                                             Add (Add b13~108@ c13~110@) (Mul a13~106@ a13~106@)
                                                            )
                                                           ) (Mul (Mul (Add a13~106@ d13~112@) (Mul b13~108@ b13~108@)) (Mul (Mul c13~110@ d13~112@)
                                                             (Mul d13~112@ a13~106@)
                                                         ))))
                                                         (=>
                                                          (= temp_13_1~2312@ (Add (Mul (Mul (Add b13~108@ a13~106@) (Sub a13~106@ b13~108@)) (
                                                              Add (Add b13~108@ c13~110@) (Mul a13~106@ a13~106@)
                                                             )
                                                            ) (Mul (Mul (Mul b13~108@ b13~108@) (Add a13~106@ d13~112@)) (Mul (Mul c13~110@ d13~112@)
                                                              (Mul d13~112@ a13~106@)
                                                          ))))
                                                          (and
                                                           (=>
                                                           ...
                                                           (=>
                                                            (= temp_13_0~2247@ temp_13_1~2312@)
                                                            (=>
                                                             (= temp_14_0~2401@ (Mul (Mul (Sub (Mul a14~114@ b14~116@) (Mul c14~118@ d14~120@)) (
                                                                 Mul (Mul c14~118@ b14~116@) (Mul b14~116@ a14~114@)
                                                                )
                                                               ) (Mul (Mul (Mul c14~118@ b14~116@) (Mul d14~120@ b14~116@)) (Sub (Mul a14~114@ d14~120@)
                                                                 (Mul c14~118@ c14~118@)
                                                             ))))
                                                             (=>
                                                              (= temp_14_1~2466@ (Mul (Mul (Sub (Mul a14~114@ b14~116@) (Mul c14~118@ d14~120@)) (
                                                                  Mul (Mul c14~118@ b14~116@) (Mul b14~116@ a14~114@)
                                                                 )
                                                                ) (Mul (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ b14~116@)) (Sub (Mul a14~114@ d14~120@)
                                                                  (Mul c14~118@ c14~118@)
                                                              ))))
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2401@ temp_14_1~2466@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2401@ temp_14_1~2466@)
                                                                (=>
                                                                 (= temp_15_0~2539@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) d15~128@) a15~122@) (Mul (
                                                                     Mul (Mul b15~124@ d15~128@) (Mul d15~128@ c15~126@)
                                                                    ) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ b15~124@))
                                                                 )))
                                                                 (=>
                                                                  (= temp_15_1~2588@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) d15~128@) a15~122@) (Mul (
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2539@ temp_15_1~2588@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2539@ temp_15_1~2588@)
                                                                    (=>
                                                                     (= temp_16_0~2645@ (Mul c16~134@ (Mul (Mul (Mul c16~134@ a16~130@) (Sub c16~134@ a16~130@))
                                                                        (Mul a16~130@ (Add c16~134@ b16~132@))
                                                                     )))
                                                                     (=>
                                                                      (= temp_16_1~2678@ (Mul c16~134@ (Mul (Mul c16~134@ (Mul a16~130@ (Sub c16~134@ a16~130@)))
                                                                         (Mul a16~130@ (Add c16~134@ b16~132@))
                                                                      )))
                                                                      (=>
                                                                       (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
