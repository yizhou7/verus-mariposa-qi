...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Add (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ a0~2@) b0~4@)) (Mul (Sub (Mul d0~8@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@))))) (=> (= temp_0_1~378@ (Add (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ a0~2@) b0~4@)) (Sub (Mul (Mul d0~8@ d0~8@) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@))) (Mul (Mul c0~6@ a0~2@) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~378@))) (=> (= temp_0_0~301@ temp_0_1~378@) (=> (= temp_1_0~467@ (Add (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Add c1~14@ b1~12@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~532@ (Add (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Add c1~14@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~467@ temp_1_1~532@))) (=> (= temp_1_0~467@ temp_1_1~532@) (=> (= temp_2_0~629@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ 30) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~702@ (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ 30) (Mul c2~22@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~629@ temp_2_1~702@))) (=> (= temp_2_0~629@ temp_2_1~702@) (=> (= temp_3_0~787@ (Mul (Mul (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ a3~26@) d3~32@)) (Mul (Mul (Sub a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~848@ (Mul (Mul (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ a3~26@) d3~32@)) (Mul (Mul (Mul (Sub a3~26@ c3~30@) b3~28@) d3~32@) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~787@ temp_3_1~848@))) (=> (= temp_3_0~787@ temp_3_1~848@) (=> (= temp_4_0~949@ (Sub (Add (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Add d4~40@ c4~38@) (Mul c4~38@ a4~34@))) (Mul (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul 93 b4~36@))))) (=> (= temp_4_1~1026@ (Sub (Add (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Add d4~40@ c4~38@) (Mul c4~38@ a4~34@))) (Mul (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul 93 b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~949@ temp_4_1~1026@))) (=> (= temp_4_0~949@ temp_4_1~1026@) (=> (= temp_5_0~1127@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Sub 90 d5~48@)) (Add (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ c5~46@)) (Sub (Mul d5~48@ a5~42@) (Sub d5~48@ a5~42@))))) (=> (= temp_5_1~1204@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Sub 90 d5~48@)) (Add (Mul b5~44@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ c5~46@)) (Sub (Mul d5~48@ a5~42@) (Sub d5~48@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1127@ temp_5_1~1204@))) (=> (= temp_5_0~1127@ temp_5_1~1204@) (=> (= temp_6_0~1293@ (Sub (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ b6~52@))) (Mul (Sub (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@))))) (=> (= temp_6_1~1358@ (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ b6~52@)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Sub (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1293@ temp_6_1~1358@))) (=> (= temp_6_0~1293@ temp_6_1~1358@) (=> (= temp_7_0~1479@ (Sub (Add (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Add d7~64@ b7~60@) (Mul a7~58@ d7~64@))) (Mul (Mul 52 (Mul a7~58@ a7~58@)) (Add (Mul b7~60@ 18) (Mul b7~60@ 39))))) (=> (= temp_7_1~1576@ (Sub (Add (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ a7~58@)) (Mul (Add d7~64@ b7~60@) (Mul a7~58@ d7~64@))) (Mul (Mul 52 (Mul a7~58@ a7~58@)) (Add (Mul b7~60@ 18) (Mul b7~60@ 39))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1479@ temp_7_1~1576@))) (=> (= temp_7_0~1479@ temp_7_1~1576@) (=> (= temp_8_0~1665@ (Mul (Sub (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))) (Mul (Add (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~1730@ (Mul (Sub (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))) (Mul (Add (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1665@ temp_8_1~1730@))) (=> (= temp_8_0~1665@ temp_8_1~1730@) (=> (= temp_9_0~1819@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ b9~76@))) (Mul (Mul (Sub a9~74@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Sub c9~78@ c9~78@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~1884@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ b9~76@))) (Mul (Mul (Mul (Sub a9~74@ c9~78@) (Mul d9~80@ c9~78@)) (Sub c9~78@ c9~78@)) (Mul d9~80@ a9~74@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1819@ temp_9_1~1884@))) (=> (= temp_9_0~1819@ temp_9_1~1884@) (=> (= temp_10_0~1985@ (Add (Mul (Mul (Mul a10~82@ 39) (Mul c10~86@ c10~86@)) (Mul (Add b10~84@ d10~88@) (Mul d10~88@ b10~84@))) (Mul (Sub (Sub c10~86@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Add a10~82@ d10~88@))))) (=> (= temp_10_1~2062@ (Add (Mul (Mul (Mul (Mul a10~82@ 39) (Mul c10~86@ c10~86@)) (Add b10~84@ d10~88@)) (Mul d10~88@ b10~84@)) (Mul (Sub (Sub c10~86@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Add a10~82@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1985@ temp_10_1~2062@))) (=> (= temp_10_0~1985@ temp_10_1~2062@) (=> (= temp_11_0~2147@ (Mul (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ b11~92@)) (Mul (Mul c11~94@ d11~96@) c11~94@)) (Mul (Sub (Mul d11~96@ c11~94@) (Sub d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2208@ (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ b11~92@)) (Mul (Mul (Mul c11~94@ d11~96@) c11~94@) (Mul (Sub (Mul d11~96@ c11~94@) (Sub d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2147@ temp_11_1~2208@))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
