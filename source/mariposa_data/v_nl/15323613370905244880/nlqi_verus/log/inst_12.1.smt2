...
(set-info :comment ";; mariposa_data/v_nl//15323613370905244880/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_8_0~1765@ Int)
(declare-const temp_8_1~1830@ Int)
(declare-const temp_9_0~1923@ Int)
(declare-const temp_9_1~1988@ Int)
(declare-const temp_10_0~2115@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Add (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ a0~2@) b0~4@)) (Mul (Sub (Mul d0~8@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@))))) (=> (= temp_0_1~378@ (Add (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ a0~2@) b0~4@)) (Sub (Mul (Mul d0~8@ d0~8@) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@))) (Mul (Mul c0~6@ a0~2@) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@)))))) (and (=> (= tmp%1@ (Mul d0~8@ d0~8@)) (=> (= tmp%2@ (Mul c0~6@ a0~2@)) (=> (= tmp%3@ (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~378@)))))) (=> (= temp_0_0~301@ temp_0_1~378@) (=> (= temp_1_0~493@ (Add (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Add c1~14@ b1~12@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~558@ (Add (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Add c1~14@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@))))) (and (=> (= tmp%4@ (Mul c1~14@ a1~10@)) (=> (= tmp%5@ (Add c1~14@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~493@ temp_1_1~558@))))) (=> (= temp_1_0~493@ temp_1_1~558@) (=> (= temp_2_0~667@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ 30) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~740@ (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ 30) (Mul c2~22@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ c2~22@) (=> %%location_label%%2 (= temp_2_0~667@ temp_2_1~740@))) (=> (= temp_2_0~667@ temp_2_1~740@) (=> (= temp_3_0~829@ (Mul (Mul (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ a3~26@) d3~32@)) (Mul (Mul (Sub a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~890@ (Mul (Mul (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ a3~26@) d3~32@)) (Mul (Mul (Mul (Sub a3~26@ c3~30@) b3~28@) d3~32@) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))))) (and (=> (= tmp%6@ (Sub a3~26@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ b3~28@ d3~32@) (=> %%location_label%%3 (= temp_3_0~829@ temp_3_1~890@)))) (=> (= temp_3_0~829@ temp_3_1~890@) (=> (= temp_4_0~1001@ (Sub (Add (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Add d4~40@ c4~38@) (Mul c4~38@ a4~34@))) (Mul (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul 93 b4~36@))))) (=> (= temp_4_1~1078@ (Sub (Add (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Add d4~40@ c4~38@) (Mul c4~38@ a4~34@))) (Mul (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul 93 b4~36@))))) (and (=> (= tmp%7@ (Mul a4~34@ a4~34@)) (=> (= tmp%8@ (Mul a4~34@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~1001@ temp_4_1~1078@))))) (=> (= temp_4_0~1001@ temp_4_1~1078@) (=> (= temp_5_0~1191@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Sub 90 d5~48@)) (Add (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ c5~46@)) (Sub (Mul d5~48@ a5~42@) (Sub d5~48@ a5~42@))))) (=> (= temp_5_1~1268@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Sub 90 d5~48@)) (Add (Mul b5~44@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ c5~46@)) (Sub (Mul d5~48@ a5~42@) (Sub d5~48@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1191@ temp_5_1~1268@))) (=> (= temp_5_0~1191@ temp_5_1~1268@) (=> (= temp_6_0~1361@ (Sub (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ b6~52@))) (Mul (Sub (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@))))) (=> (= temp_6_1~1426@ (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ b6~52@)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Sub (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ b6~52@))))) (and (=> (= tmp%9@ (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@))) (=> (= tmp%10@ (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~1361@ temp_6_1~1426@))))) (=> (= temp_6_0~1361@ temp_6_1~1426@) (=> (= temp_7_0~1575@ (Sub (Add (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Add d7~64@ b7~60@) (Mul a7~58@ d7~64@))) (Mul (Mul 52 (Mul a7~58@ a7~58@)) (Add (Mul b7~60@ 18) (Mul b7~60@ 39))))) (=> (= temp_7_1~1672@ (Sub (Add (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ a7~58@)) (Mul (Add d7~64@ b7~60@) (Mul a7~58@ d7~64@))) (Mul (Mul 52 (Mul a7~58@ a7~58@)) (Add (Mul b7~60@ 18) (Mul b7~60@ 39))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1575@ temp_7_1~1672@))) (=> (= temp_7_0~1575@ temp_7_1~1672@) (=> (= temp_8_0~1765@ (Mul (Sub (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))) (Mul (Add (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~1830@ (Mul (Sub (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))) (Mul (Add (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ c8~70@) (=> %%location_label%%8 (= temp_8_0~1765@ temp_8_1~1830@))) (=> (= temp_8_0~1765@ temp_8_1~1830@) (=> (= temp_9_0~1923@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ b9~76@))) (Mul (Mul (Sub a9~74@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Sub c9~78@ c9~78@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~1988@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ b9~76@))) (Mul (Mul (Mul (Sub a9~74@ c9~78@) (Mul d9~80@ c9~78@)) (Sub c9~78@ c9~78@)) (Mul d9~80@ a9~74@)))) (and (=> (= tmp%11@ (Mul (Sub a9~74@ c9~78@) (Mul d9~80@ c9~78@))) (=> (= tmp%12@ (Sub c9~78@ c9~78@)) (=> (= tmp%13@ (Mul d9~80@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%9 (= temp_9_0~1923@ temp_9_1~1988@)))))) (=> (= temp_9_0~1923@ temp_9_1~1988@) (=> (= temp_10_0~2115@ (Add (Mul (Mul (Mul a10~82@ 39) (Mul c10~86@ c10~86@)) (Mul (Add b10~84@ d10~88@) (Mul d10~88@ b10~84@))) (Mul (Sub (Sub c10~86@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Add a10~82@ d10~88@))))) (=> (= temp_10_1~2192@ (Add (Mul (Mul (Mul (Mul a10~82@ 39) (Mul c10~86@ c10~86@)) (Add b10~84@ d10~88@)) (Mul d10~88@ b10~84@)) (Mul (Sub (Sub c10~86@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Add a10~82@ d10~88@))))) (and (=> (= tmp%14@ (Mul (Mul a10~82@ 39) (Mul c10~86@ c10~86@))) (=> (= tmp%15@ (Add b10~84@ d10~88@)) (=> (= tmp%16@ (Mul d10~88@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%10 (= temp_10_0~2115@ temp_10_1~2192@)))))) (=> (= temp_10_0~2115@ temp_10_1~2192@) (=> (= temp_11_0~2315@ (Mul (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ b11~92@)) (Mul (Mul c11~94@ d11~96@) c11~94@)) (Mul (Sub (Mul d11~96@ c11~94@) (Sub d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2376@ (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ b11~92@)) (Mul (Mul (Mul c11~94@ d11~96@) c11~94@) (Mul (Sub (Mul d11~96@ c11~94@) (Sub d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)))))) (=> (= tmp%17@ (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ b11~92@))) (=> (= tmp%18@ (Mul (Mul c11~94@ d11~96@) c11~94@)) (=> (= tmp%19@ (Mul (Sub (Mul d11~96@ c11~94@) (Sub d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%11 (= temp_11_0~2315@ temp_11_1~2376@)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
