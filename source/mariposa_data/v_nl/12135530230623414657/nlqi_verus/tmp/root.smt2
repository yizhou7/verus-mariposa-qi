...
;; mariposa_data/v_nl//12135530230623414657/nlqi_verus/src/main.rs:7:1: 26:40 (#0)
(push)
 ...
 (declare-const temp_1_0~579@ Int)
 (declare-const temp_1_1~716@ Int)
 (declare-const temp_2_0~899@ Int)
 (declare-const temp_2_1~1036@ Int)
 (declare-const temp_3_0~1189@ Int)
 (declare-const temp_3_1~1314@ Int)
 (declare-const temp_4_0~1473@ Int)
 (declare-const temp_4_1~1598@ Int)
 (declare-const temp_5_0~1735@ Int)
 (declare-const temp_5_1~1844@ Int)
 (declare-const temp_6_0~2045@ Int)
 (declare-const temp_6_1~2198@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~289@ (Mul (Mul (Mul (Add (Mul d0~8@ b0~4@) (Mul b0~4@ b0~4@)) (Mul (Sub a0~2@
           d0~8@
          ) (Mul a0~2@ d0~8@)
         )
        ) (Mul (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Sub b0~4@ d0~8@)))
       ) (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@
           d0~8@
         ))
        ) (Mul (Mul (Mul c0~6@ b0~4@) (Add d0~8@ d0~8@)) (Sub (Add d0~8@ d0~8@) (Mul c0~6@ d0~8@)))
     )))
     (=>
      (= temp_0_1~418@ (Mul (Mul (Mul (Add (Mul d0~8@ b0~4@) (Mul b0~4@ b0~4@)) (Mul (Sub a0~2@
            d0~8@
           ) (Mul a0~2@ d0~8@)
          )
         ) (Mul (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Sub b0~4@ d0~8@)))
        ) (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@
            c0~6@
          ))
         ) (Mul (Mul (Mul c0~6@ b0~4@) (Add d0~8@ d0~8@)) (Sub (Add d0~8@ d0~8@) (Mul c0~6@ d0~8@)))
      )))
      (and
       ...
       (=>
        (= temp_0_0~289@ temp_0_1~418@)
        (=>
         (= temp_1_0~579@ (Mul (Mul (Mul (Sub d1~16@ (Sub c1~14@ d1~16@)) (Mul (Mul a1~10@ a1~10@)
              (Mul a1~10@ d1~16@)
             )
            ) (Mul (Mul (Add 50 d1~16@) b1~12@) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)))
           ) (Mul (Mul (Mul a1~10@ (Add d1~16@ a1~10@)) (Sub (Add c1~14@ b1~12@) (Mul d1~16@ a1~10@)))
            (Mul (Mul d1~16@ (Mul a1~10@ b1~12@)) (Mul (Add a1~10@ d1~16@) (Add a1~10@ c1~14@)))
         )))
         (=>
          (= temp_1_1~716@ (Mul (Mul (Mul (Sub d1~16@ (Sub c1~14@ d1~16@)) (Mul (Mul a1~10@ a1~10@)
               (Mul a1~10@ d1~16@)
              )
             ) (Mul (Mul (Add 50 d1~16@) b1~12@) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)))
            ) (Mul (Sub (Mul (Mul a1~10@ (Add d1~16@ a1~10@)) (Add c1~14@ b1~12@)) (Mul (Mul a1~10@
                (Add d1~16@ a1~10@)
               ) (Mul d1~16@ a1~10@)
              )
             ) (Mul (Mul d1~16@ (Mul a1~10@ b1~12@)) (Mul (Add a1~10@ d1~16@) (Add a1~10@ c1~14@)))
          ...
          (and
           (=>
            (= tmp%3@ (Mul a1~10@ (Add d1~16@ a1~10@)))
            (=>
             (= tmp%4@ (Add c1~14@ b1~12@))
             (=>
              (= tmp%5@ (Mul d1~16@ a1~10@))
              (=>
               (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ tmp%4@ tmp%5@)
               (=>
                %%location_label%%1
                (= temp_1_0~579@ temp_1_1~716@)
           )))))
           (=>
            (= temp_1_0~579@ temp_1_1~716@)
            (=>
             (= temp_2_0~899@ (Sub (Mul (Mul c2~22@ (Add (Mul b2~20@ a2~18@) (Mul d2~24@ a2~18@)))
                (Mul (Mul (Sub c2~22@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@
                   d2~24@
                )))
               ) (Add (Sub (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ 20)) (Sub (Mul d2~24@ c2~22@) (Sub d2~24@
                   d2~24@
                 ))
                ) (Add (Mul b2~20@ (Mul 57 c2~22@)) (Mul (Sub a2~18@ a2~18@) (Add c2~22@ c2~22@)))
             )))
             (=>
              (= temp_2_1~1036@ (Sub (Mul (Mul c2~22@ (Add (Mul b2~20@ a2~18@) (Mul d2~24@ a2~18@)))
                 (Mul (Mul (Sub c2~22@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@
                    d2~24@
                 )))
                ) (Add (Sub (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ 20)) (Sub (Mul d2~24@ c2~22@) (Sub d2~24@
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~899@ temp_2_1~1036@)
               ))
               (=>
                (= temp_2_0~899@ temp_2_1~1036@)
                (=>
                 (= temp_3_0~1189@ (Mul (Mul (Mul (Mul (Sub b3~28@ c3~30@) c3~30@) (Mul (Mul a3~26@ a3~26@)
                      (Mul c3~30@ a3~26@)
                     )
                    ) (Sub (Add (Mul a3~26@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ c3~30@) (Mul a3~26@
                       48
                    )))
                   ) (Mul (Mul b3~28@ (Mul (Sub a3~26@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul c3~30@
                       d3~32@
                      ) (Sub c3~30@ c3~30@)
                     ) (Mul (Mul b3~28@ c3~30@) (Sub a3~26@ d3~32@))
                 ))))
                 (=>
                  (= temp_3_1~1314@ (Mul (Mul (Mul (Mul (Sub b3~28@ c3~30@) c3~30@) (Mul (Mul a3~26@ a3~26@)
                       (Mul c3~30@ a3~26@)
                      )
                     ) (Sub (Add (Mul a3~26@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ c3~30@) (Mul a3~26@
                        48
                     )))
                    ) (Mul (Mul b3~28@ (Mul (Sub a3~26@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul c3~30@ (
                        Mul d3~32@ (Sub c3~30@ c3~30@)
                       )
                      ) (Mul (Mul b3~28@ c3~30@) (Sub a3~26@ d3~32@))
                  ))))
                  (and
                   (=>
                    (= tmp%6@ (Sub c3~30@ c3~30@))
                    (=>
                     (ens%main!nl_basics.lemma_mul_is_associative. c3~30@ d3~32@ tmp%6@)
                     (=>
                      %%location_label%%3
                      (= temp_3_0~1189@ temp_3_1~1314@)
                   )))
                   (=>
                    (= temp_3_0~1189@ temp_3_1~1314@)
                    (=>
                     (= temp_4_0~1473@ (Mul (Sub (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Sub
                           d4~40@ b4~36@
                          ) (Mul a4~34@ b4~36@)
                         )
                        ) (Mul (Mul (Mul d4~40@ d4~40@) (Add c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@
                           b4~36@
                        )))
                       ) (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Sub c4~38@ b4~36@) (
                           Mul d4~40@ b4~36@
                         ))
                        ) (Mul (Sub c4~38@ (Add a4~34@ a4~34@)) (Mul (Sub d4~40@ c4~38@) (Mul c4~38@ d4~40@)))
                     )))
                     (=>
                      (= temp_4_1~1598@ (Mul (Sub (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Sub
                            d4~40@ b4~36@
                           ) (Mul a4~34@ b4~36@)
                          )
                         ) (Mul (Mul (Mul d4~40@ d4~40@) (Add c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@
                      ...
                      (and
                       (=>
                        (ens%main!nl_basics.lemma_mul_is_commutative. c4~38@ b4~36@)
                        (=>
                         %%location_label%%4
                         (= temp_4_0~1473@ temp_4_1~1598@)
                       ))
                       (=>
                        (= temp_4_0~1473@ temp_4_1~1598@)
                        (=>
                         (= temp_5_0~1735@ (Mul (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Sub a5~42@ b5~44@)) (Mul (Add
                               b5~44@ b5~44@
                              ) (Mul b5~44@ b5~44@)
                             )
                            ) d5~48@
                           ) (Mul (Mul (Add (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@)) (Add (Mul d5~48@ d5~48@) (
                               Mul a5~42@ a5~42@
                             ))
                            ) (Mul (Mul (Mul c5~46@ 83) (Mul d5~48@ a5~42@)) (Add a5~42@ (Mul b5~44@ b5~44@)))
                         )))
                         (=>
                          (= temp_5_1~1844@ (Mul (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Sub a5~42@ b5~44@)) (Mul (Add
                                b5~44@ b5~44@
                               ) (Mul b5~44@ b5~44@)
                              )
                             ) d5~48@
                             ...
                             ) (Mul (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ 83)) (Add a5~42@ (Mul b5~44@ b5~44@)))
                          )))
                          (and
                           (=>
                            (= tmp%7@ (Mul c5~46@ 83))
                            (=>
                             ...
                             (=>
                              ...
                              (=>
                               %%location_label%%5
                               (= temp_5_0~1735@ temp_5_1~1844@)
                           ))))
                           (=>
                            (= temp_5_0~1735@ temp_5_1~1844@)
                            (=>
                             (= temp_6_0~2045@ (Sub (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Add a6~50@ c6~54@)) (Add (Add
                                   b6~52@ 37
                                  ) (Sub b6~52@ b6~52@)
                                 )
                                ) (Mul (Sub (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul 85 d6~56@) (Mul b6~52@
                                   c6~54@
                                )))
                               ) (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Sub b6~52@ a6~50@)) (Mul (Mul b6~52@ b6~52@) (
                                   Mul d6~56@ a6~50@
                                 ))
                                ) (Mul (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ d6~56@)) (Mul (Mul d6~56@ b6~52@) (Mul a6~50@
                                   b6~52@
                             ))))))
                             (=>
                              (= temp_6_1~2198@ (Sub (Mul (Mul (Mul b6~52@ (Mul d6~56@ (Add a6~50@ c6~54@))) (Add (Add
                                    b6~52@ 37
                                   ) (Sub b6~52@ b6~52@)
                                  )
                                 ) (Mul (Sub (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul 85 d6~56@) (Mul b6~52@
                              ...
                              (=>
                               (= tmp%9@ (Add a6~50@ c6~54@))
                               (=>
                                (ens%main!nl_basics.lemma_mul_is_associative. b6~52@ d6~56@ tmp%9@)
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~2045@ temp_6_1~2198@)
 ))))))))))))))))))))))))))))))))
 (get-info :version)
 (assert
  %%query%%
