...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Mul d0~8@ (Mul (Mul (Sub a0~2@ c0~6@) (Sub c0~6@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~314@ (Mul d0~8@ (Mul (Mul (Sub a0~2@ c0~6@) (Sub c0~6@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~277@ temp_0_1~314@))) (=> (= temp_0_0~277@ temp_0_1~314@) (=> (= temp_1_0~399@ (Mul (Mul (Mul (Sub d1~16@ a1~10@) c1~14@) (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ a1~10@))) (Sub (Mul (Add a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~460@ (Mul (Mul (Mul (Sub d1~16@ a1~10@) c1~14@) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ b1~12@))) (Sub (Mul (Add a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~399@ temp_1_1~460@))) (=> (= temp_1_0~399@ temp_1_1~460@) (=> (= temp_2_0~549@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@))) (Sub (Mul (Mul a2~18@ d2~24@) (Add c2~22@ d2~24@)) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~614@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@))) (Sub (Mul (Mul a2~18@ d2~24@) (Add c2~22@ d2~24@)) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~549@ temp_2_1~614@))) (=> (= temp_2_0~549@ temp_2_1~614@) (=> (= temp_3_0~691@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@)) (Add (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@))) (Mul b3~28@ (Mul (Mul c3~30@ b3~28@) (Sub b3~28@ a3~26@))))) (=> (= temp_3_1~744@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@)) (Add (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@))) (Mul b3~28@ (Mul (Mul b3~28@ c3~30@) (Sub b3~28@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~691@ temp_3_1~744@))) (=> (= temp_3_0~691@ temp_3_1~744@) (=> (= temp_4_0~825@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Sub b4~36@ a4~34@)) (Add (Mul b4~36@ d4~40@) c4~38@)) (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@)) (Add (Add d4~40@ d4~40@) d4~40@)))) (=> (= temp_4_1~882@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Sub b4~36@ a4~34@)) (Add (Mul b4~36@ d4~40@) c4~38@)) (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Add (Add d4~40@ d4~40@) d4~40@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~825@ temp_4_1~882@))) (=> (= temp_4_0~825@ temp_4_1~882@) (=> (= temp_5_0~967@ (Mul (Mul (Add d5~48@ (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Add c5~46@ a5~42@) (Mul c5~46@ d5~48@)) (Add (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1028@ (Mul (Mul (Add d5~48@ (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Add c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Add (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~967@ temp_5_1~1028@))) (=> (= temp_5_0~967@ temp_5_1~1028@) (=> (= temp_6_0~1109@ (Mul (Mul (Mul b6~52@ (Sub a6~50@ d6~56@)) (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ 89))) (Sub (Sub b6~52@ (Mul b6~52@ c6~54@)) a6~50@))) (=> (= temp_6_1~1166@ (Mul (Mul b6~52@ (Mul (Sub a6~50@ d6~56@) (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ 89)))) (Sub (Sub b6~52@ (Mul b6~52@ c6~54@)) a6~50@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1109@ temp_6_1~1166@))) (=> (= temp_6_0~1109@ temp_6_1~1166@) (=> (= temp_7_0~1255@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Sub a7~58@ b7~60@) (Add a7~58@ a7~58@))) (Mul (Add (Sub d7~64@ c7~62@) (Add d7~64@ b7~60@)) (Add (Sub a7~58@ a7~58@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1320@ (Mul (Mul (Add (Sub d7~64@ c7~62@) (Add d7~64@ b7~60@)) (Add (Sub a7~58@ a7~58@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Sub a7~58@ b7~60@) (Add a7~58@ a7~58@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1255@ temp_7_1~1320@))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
