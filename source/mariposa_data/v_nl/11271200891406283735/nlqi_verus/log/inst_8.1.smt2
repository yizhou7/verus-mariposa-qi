...
(set-info :comment ";; mariposa_data/v_nl//11271200891406283735/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_1_1~464@ Int)
...
(declare-const temp_7_0~1329@ Int)
(declare-const temp_7_1~1394@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Mul d0~8@ (Mul (Mul (Sub a0~2@ c0~6@) (Sub c0~6@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~314@ (Mul d0~8@ (Mul (Mul (Sub a0~2@ c0~6@) (Sub c0~6@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ d0~8@) (=> %%location_label%%0 (= temp_0_0~277@ temp_0_1~314@))) (=> (= temp_0_0~277@ temp_0_1~314@) (=> (= temp_1_0~403@ (Mul (Mul (Mul (Sub d1~16@ a1~10@) c1~14@) (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ a1~10@))) (Sub (Mul (Add a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~464@ (Mul (Mul (Mul (Sub d1~16@ a1~10@) c1~14@) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ b1~12@))) (Sub (Mul (Add a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@))))) (and (=> (= tmp%1@ (Mul d1~16@ b1~12@)) (=> (= tmp%2@ (Mul b1~12@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~403@ temp_1_1~464@))))) (=> (= temp_1_0~403@ temp_1_1~464@) (=> (= temp_2_0~565@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@))) (Sub (Mul (Mul a2~18@ d2~24@) (Add c2~22@ d2~24@)) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~630@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@))) (Sub (Mul (Mul a2~18@ d2~24@) (Add c2~22@ d2~24@)) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ c2~22@) (=> %%location_label%%2 (= temp_2_0~565@ temp_2_1~630@))) (=> (= temp_2_0~565@ temp_2_1~630@) (=> (= temp_3_0~711@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@)) (Add (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@))) (Mul b3~28@ (Mul (Mul c3~30@ b3~28@) (Sub b3~28@ a3~26@))))) (=> (= temp_3_1~764@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@)) (Add (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@))) (Mul b3~28@ (Mul (Mul b3~28@ c3~30@) (Sub b3~28@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ b3~28@) (=> %%location_label%%3 (= temp_3_0~711@ temp_3_1~764@))) (=> (= temp_3_0~711@ temp_3_1~764@) (=> (= temp_4_0~849@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Sub b4~36@ a4~34@)) (Add (Mul b4~36@ d4~40@) c4~38@)) (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@)) (Add (Add d4~40@ d4~40@) d4~40@)))) (=> (= temp_4_1~906@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Sub b4~36@ a4~34@)) (Add (Mul b4~36@ d4~40@) c4~38@)) (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Add (Add d4~40@ d4~40@) d4~40@)))) (and (=> (= tmp%3@ (Mul b4~36@ b4~36@)) (=> (= tmp%4@ (Mul a4~34@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%4 (= temp_4_0~849@ temp_4_1~906@))))) (=> (= temp_4_0~849@ temp_4_1~906@) (=> (= temp_5_0~1003@ (Mul (Mul (Add d5~48@ (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Add c5~46@ a5~42@) (Mul c5~46@ d5~48@)) (Add (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1064@ (Mul (Mul (Add d5~48@ (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Add c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Add (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ d5~48@) (=> %%location_label%%5 (= temp_5_0~1003@ temp_5_1~1064@))) (=> (= temp_5_0~1003@ temp_5_1~1064@) (=> (= temp_6_0~1149@ (Mul (Mul (Mul b6~52@ (Sub a6~50@ d6~56@)) (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ 89))) (Sub (Sub b6~52@ (Mul b6~52@ c6~54@)) a6~50@))) (=> (= temp_6_1~1206@ (Mul (Mul b6~52@ (Mul (Sub a6~50@ d6~56@) (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ 89)))) (Sub (Sub b6~52@ (Mul b6~52@ c6~54@)) a6~50@))) (and (=> (= tmp%5@ (Sub a6~50@ d6~56@)) (=> (= tmp%6@ (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ 89))) (=> (ens%main!nl_basics.lemma_mul_is_associative. b6~52@ tmp%5@ tmp%6@) (=> %%location_label%%6 (= temp_6_0~1149@ temp_6_1~1206@))))) (=> (= temp_6_0~1149@ temp_6_1~1206@) (=> (= temp_7_0~1329@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Sub a7~58@ b7~60@) (Add a7~58@ a7~58@))) (Mul (Add (Sub d7~64@ c7~62@) (Add d7~64@ b7~60@)) (Add (Sub a7~58@ a7~58@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1394@ (Mul (Mul (Add (Sub d7~64@ c7~62@) (Add d7~64@ b7~60@)) (Add (Sub a7~58@ a7~58@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Sub a7~58@ b7~60@) (Add a7~58@ a7~58@))))) (=> (= tmp%7@ (Mul (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Sub a7~58@ b7~60@) (Add a7~58@ a7~58@)))) (=> (= tmp%8@ (Mul (Add (Sub d7~64@ c7~62@) (Add d7~64@ b7~60@)) (Add (Sub a7~58@ a7~58@) (Mul c7~62@ d7~64@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%7 (= temp_7_0~1329@ temp_7_1~1394@))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
