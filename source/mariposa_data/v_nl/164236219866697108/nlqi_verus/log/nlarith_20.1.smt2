...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Sub (Add (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Sub c0~6@ a0~2@))) (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Add b0~4@ b0~4@))))) (=> (= temp_0_1~378@ (Mul (Sub (Add (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Sub (Mul (Mul b0~4@ a0~2@) c0~6@) (Mul (Mul b0~4@ a0~2@) a0~2@))) (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Add b0~4@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~378@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~470@ (Mul (Mul (Mul (Mul b1~12@ a1~10@) (Mul 88 d1~16@)) (Add (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~547@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul 88 d1~16@)) (Add (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~470@ temp_1_1~547@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~599@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Sub b2~20@ b2~20@)) c2~22@) (Mul c2~22@ (Mul d2~24@ (Mul d2~24@ d2~24@))))) (=> (= temp_2_1~636@ (Add (Mul (Mul (Sub b2~20@ b2~20@) (Mul d2~24@ d2~24@)) c2~22@) (Mul c2~22@ (Mul d2~24@ (Mul d2~24@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~599@ temp_2_1~636@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~712@ (Mul (Sub (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Add b3~28@ c3~30@) (Mul a3~26@ a3~26@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@)) (Sub d3~32@ (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~773@ (Mul (Mul (Sub (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Add b3~28@ c3~30@) (Mul a3~26@ a3~26@))) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@))) (Sub d3~32@ (Mul c3~30@ c3~30@)))) (=> (= tmp%4@ (= temp_3_0~712@ temp_3_1~773@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~825@ (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@))) b4~36@)) (=> (= temp_4_1~862@ (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@)) b4~36@))) (=> (= tmp%5@ (= temp_4_0~825@ temp_4_1~862@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~954@ (Mul (Mul (Mul (Mul 9 a5~42@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ c5~46@)) (Sub (Mul d5~48@ b5~44@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1031@ (Mul (Mul (Mul (Mul a5~42@ 9) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ c5~46@)) (Sub (Mul d5~48@ b5~44@) (Mul b5~44@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~954@ temp_5_1~1031@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1119@ (Mul (Mul (Mul (Add a6~50@ c6~54@) (Mul b6~52@ a6~50@)) (Mul b6~52@ (Mul d6~56@ a6~50@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul 55 b6~52@)) (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1192@ (Mul (Mul (Mul (Add a6~50@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Mul d6~56@ a6~50@) b6~52@)) (Mul (Mul (Mul d6~56@ b6~52@) (Mul 55 b6~52@)) (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1119@ temp_6_1~1192@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1272@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Sub (Mul d7~64@ b7~60@) (Sub d7~64@ b7~60@))))) (=> (= temp_7_1~1337@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@)) (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Sub (Mul d7~64@ b7~60@) (Sub d7~64@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1272@ temp_7_1~1337@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1417@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@))))) (=> (= temp_8_1~1482@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1417@ temp_8_1~1482@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1558@ (Mul (Mul (Add (Sub d9~80@ c9~78@) (Mul d9~80@ d9~80@)) (Mul d9~80@ (Mul d9~80@ b9~76@))) (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~1619@ (Mul (Mul (Add (Sub d9~80@ c9~78@) (Mul d9~80@ d9~80@)) (Mul (Mul d9~80@ b9~76@) d9~80@)) (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1558@ temp_9_1~1619@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1683@ (Mul (Mul (Add (Mul d10~88@ c10~86@) (Mul d10~88@ b10~84@)) c10~86@) (Add (Sub (Add c10~86@ a10~82@) (Mul c10~86@ a10~82@)) (Add c10~86@ (Sub d10~88@ b10~84@))))) (=> (= temp_10_1~1732@ (Mul (Mul (Add (Mul c10~86@ d10~88@) (Mul d10~88@ b10~84@)) c10~86@) (Add (Sub (Add c10~86@ a10~82@) (Mul c10~86@ a10~82@)) (Add c10~86@ (Sub d10~88@ b10~84@))))) (=> (= tmp%11@ (= temp_10_0~1683@ temp_10_1~1732@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1784@ (Mul d11~96@ (Mul (Mul (Mul b11~92@ d11~96@) (Add c11~94@ c11~94@)) (Mul (Add d11~96@ b11~92@) (Mul a11~90@ a11~90@))))) (=> (= temp_11_1~1821@ (Mul d11~96@ (Mul (Mul (Add c11~94@ c11~94@) (Mul b11~92@ d11~96@)) (Mul (Add d11~96@ b11~92@) (Mul a11~90@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1784@ temp_11_1~1821@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1901@ (Sub (Sub (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ a12~98@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ d12~104@))) (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@)) (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~1966@ (Sub (Sub (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ a12~98@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ d12~104@))) (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~1901@ temp_12_1~1966@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2042@ (Mul (Mul (Sub (Mul d13~112@ b13~108@) (Mul a13~106@ d13~112@)) (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ b13~108@))) (Mul (Mul (Mul a13~106@ a13~106@) (Mul a13~106@ b13~108@)) (Add (Mul b13~108@ b13~108@) b13~108@)))) (=> (= temp_13_1~2103@ (Mul (Mul (Sub (Mul d13~112@ b13~108@) (Mul a13~106@ d13~112@)) (Mul (Mul (Mul a13~106@ b13~108@) c13~110@) b13~108@)) (Mul (Mul (Mul a13~106@ a13~106@) (Mul a13~106@ b13~108@)) (Add (Mul b13~108@ b13~108@) b13~108@)))) (=> (= tmp%14@ (= temp_13_0~2042@ temp_13_1~2103@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2183@ (Sub (Mul c14~118@ (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ b14~116@))) (Sub (Mul (Sub c14~118@ b14~116@) (Mul a14~114@ 53)) (Add (Add d14~120@ c14~118@) (Mul c14~118@ a14~114@))))) (=> (= temp_14_1~2248@ (Sub (Mul c14~118@ (Mul (Mul c14~118@ b14~116@) (Mul d14~120@ c14~118@))) (Sub (Mul (Sub c14~118@ b14~116@) (Mul a14~114@ 53)) (Add (Add d14~120@ c14~118@) (Mul c14~118@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2183@ temp_14_1~2248@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2348@ (Mul (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ a15~122@)) (Add c15~126@ (Mul b15~124@ c15~126@))) (Mul (Mul (Mul 70 a15~122@) (Mul c15~126@ d15~128@)) (Mul (Mul d15~128@ a15~122@) (Mul 57 b15~124@))))) (=> (= temp_15_1~2433@ (Mul (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ a15~122@)) (Add c15~126@ (Mul b15~124@ c15~126@))) (Mul (Mul (Mul 70 a15~122@) (Mul c15~126@ d15~128@)) (Mul (Mul 57 b15~124@) (Mul d15~128@ a15~122@))))) (=> (= tmp%16@ (= temp_15_0~2348@ temp_15_1~2433@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2513@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul d16~136@ b16~132@)) (Mul (Sub a16~130@ c16~134@) (Mul d16~136@ d16~136@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ c16~134@)) (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~2578@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul d16~136@ b16~132@)) (Mul (Mul (Sub a16~130@ c16~134@) d16~136@) d16~136@)) (Mul (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ c16~134@)) (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ d16~136@))))) (=> (= tmp%17@ (= temp_16_0~2513@ temp_16_1~2578@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2658@ (Mul (Mul (Mul (Mul c17~142@ b17~140@) (Sub a17~138@ d17~144@)) (Mul (Mul c17~142@ b17~140@) (Mul a17~138@ d17~144@))) (Mul (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ c17~142@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ d17~144@))))) (=> (= temp_17_1~2723@ (Mul (Mul (Mul (Mul c17~142@ b17~140@) (Sub a17~138@ d17~144@)) (Mul (Mul c17~142@ b17~140@) (Mul a17~138@ d17~144@))) (Mul (Mul (Mul a17~138@ c17~142@) (Mul c17~142@ a17~138@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ d17~144@))))) (=> (= tmp%18@ (= temp_17_0~2658@ temp_17_1~2723@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2799@ (Mul (Mul (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Add a18~146@ d18~152@) (Mul c18~150@ c18~150@))) (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ c18~150@)) (Mul b18~148@ (Mul b18~148@ b18~148@))))) (=> (= temp_18_1~2860@ (Mul (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ c18~150@)) (Mul b18~148@ (Mul b18~148@ b18~148@))) (Mul (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Add a18~146@ d18~152@) (Mul c18~150@ c18~150@))))) (=> (= tmp%19@ (= temp_18_0~2799@ temp_18_1~2860@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2936@ (Mul (Mul (Mul (Mul c19~158@ b19~156@) (Mul b19~156@ c19~158@)) (Mul (Mul c19~158@ a19~154@) b19~156@)) (Mul (Mul (Mul b19~156@ d19~160@) (Add a19~154@ b19~156@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ b19~156@))))) (=> (= temp_19_1~2997@ (Mul (Mul (Mul c19~158@ b19~156@) (Mul b19~156@ c19~158@)) (Mul (Mul (Mul c19~158@ a19~154@) b19~156@) (Mul (Mul (Mul b19~156@ d19~160@) (Add a19~154@ b19~156@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ b19~156@)))))) (=> (= tmp%20@ (= temp_19_0~2936@ temp_19_1~2997@)) (=> %%location_label%%19 tmp%20@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
