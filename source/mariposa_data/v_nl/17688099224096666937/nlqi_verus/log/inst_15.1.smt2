...
(set-info :comment ";; mariposa_data/v_nl//17688099224096666937/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_3_0~675@ Int)
(declare-const temp_3_1~712@ Int)
(declare-const temp_4_0~819@ Int)
(declare-const temp_4_1~892@ Int)
...
(declare-const temp_7_0~1293@ Int)
(declare-const temp_7_1~1358@ Int)
(declare-const temp_8_0~1451@ Int)
(declare-const temp_8_1~1516@ Int)
...
(declare-const temp_11_0~1977@ Int)
(declare-const temp_11_1~2038@ Int)
(declare-const temp_12_0~2191@ Int)
(declare-const temp_12_1~2264@ Int)
(declare-const temp_13_0~2377@ Int)
(declare-const temp_13_1~2442@ Int)
(declare-const temp_14_0~2535@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Sub (Sub (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Sub a0~2@ c0~6@) (Mul d0~8@ a0~2@))) (Mul (Sub (Mul b0~4@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~370@ (Add (Sub (Sub (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Sub a0~2@ c0~6@) (Mul d0~8@ a0~2@))) (Mul (Sub (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ b0~4@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~447@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Mul 61 d1~16@))) c1~14@)) (=> (= temp_1_1~496@ (Mul (Mul (Mul (Mul (Mul b1~12@ c1~14@) b1~12@) d1~16@) (Mul (Mul b1~12@ a1~10@) (Mul 61 d1~16@))) c1~14@)) (and (=> (= tmp%1@ (Mul b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b1~12@ d1~16@) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~496@)))) (=> (= temp_1_0~447@ temp_1_1~496@) (=> (= temp_2_0~567@ (Sub (Mul (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))) b2~20@)) (=> (= temp_2_1~604@ (Sub (Mul (Mul (Mul (Mul a2~18@ a2~18@) c2~22@) d2~24@) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))) b2~20@)) (and (=> (= tmp%2@ (Mul a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ c2~22@ d2~24@) (=> %%location_label%%2 (= temp_2_0~567@ temp_2_1~604@)))) (=> (= temp_2_0~567@ temp_2_1~604@) (=> (= temp_3_0~675@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ b3~28@))) a3~26@)) (=> (= temp_3_1~712@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ c3~30@)) (Mul (Mul (Mul c3~30@ b3~28@) a3~26@) b3~28@)) a3~26@)) (and (=> (= tmp%3@ (Mul c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ a3~26@ b3~28@) (=> %%location_label%%3 (= temp_3_0~675@ temp_3_1~712@)))) (=> (= temp_3_0~675@ temp_3_1~712@) (=> (= temp_4_0~819@ (Mul (Add (Mul a4~34@ (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ b4~36@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul 73 d4~40@)) (Mul (Add d4~40@ d4~40@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~892@ (Mul (Add (Mul a4~34@ (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ b4~36@))) (Mul (Mul c4~38@ d4~40@) (Mul (Mul 73 d4~40@) (Mul (Add d4~40@ d4~40@) (Mul b4~36@ c4~38@)))))) (and (=> (= tmp%4@ (Mul c4~38@ d4~40@)) (=> (= tmp%5@ (Mul 73 d4~40@)) (=> (= tmp%6@ (Mul (Add d4~40@ d4~40@) (Mul b4~36@ c4~38@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~819@ temp_4_1~892@)))))) (=> (= temp_4_0~819@ temp_4_1~892@) (=> (= temp_5_0~1007@ (Mul (Mul (Mul (Sub a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ a5~42@))) (Mul c5~46@ (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1060@ (Mul (Mul (Mul (Sub a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ a5~42@))) (Mul c5~46@ (Mul (Mul (Mul d5~48@ c5~46@) c5~46@) a5~42@)))) (and (=> (= tmp%7@ (Mul d5~48@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ c5~46@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1007@ temp_5_1~1060@)))) (=> (= temp_5_0~1007@ temp_5_1~1060@) (=> (= temp_6_0~1147@ (Mul (Mul d6~56@ (Mul (Add c6~54@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1200@ (Mul (Mul d6~56@ (Mul (Add c6~54@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1147@ temp_6_1~1200@))) (=> (= temp_6_0~1147@ temp_6_1~1200@) (=> (= temp_7_0~1293@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Sub d7~64@ b7~60@)) (Mul (Add b7~60@ b7~60@) (Mul a7~58@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ a7~58@)) (Sub (Mul b7~60@ c7~62@) (Sub d7~64@ a7~58@))))) (=> (= temp_7_1~1358@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Sub d7~64@ b7~60@)) (Mul (Add b7~60@ b7~60@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ a7~58@)) (Sub (Mul b7~60@ c7~62@) (Sub d7~64@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1293@ temp_7_1~1358@))) (=> (= temp_7_0~1293@ temp_7_1~1358@) (=> (= temp_8_0~1451@ (Mul (Mul (Mul (Add c8~70@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Add b8~68@ d8~72@))) (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ c8~70@)) (Sub (Mul a8~66@ c8~70@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1516@ (Mul (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ c8~70@)) (Sub (Mul a8~66@ c8~70@) (Mul a8~66@ c8~70@))) (Mul (Mul (Add c8~70@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Add b8~68@ d8~72@))))) (and (=> (= tmp%8@ (Mul (Mul (Add c8~70@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Add b8~68@ d8~72@)))) (=> (= tmp%9@ (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ c8~70@)) (Sub (Mul a8~66@ c8~70@) (Mul a8~66@ c8~70@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%8 (= temp_8_0~1451@ temp_8_1~1516@))))) (=> (= temp_8_0~1451@ temp_8_1~1516@) (=> (= temp_9_0~1665@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Mul c9~78@ d9~80@)) (Sub (Add c9~78@ b9~76@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~1730@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Mul d9~80@ c9~78@)) (Sub (Add c9~78@ b9~76@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c9~78@ d9~80@) (=> %%location_label%%9 (= temp_9_0~1665@ temp_9_1~1730@))) (=> (= temp_9_0~1665@ temp_9_1~1730@) (=> (= temp_10_0~1823@ (Add (Mul (Mul (Mul b10~84@ d10~88@) (Sub c10~86@ c10~86@)) (Sub (Mul b10~84@ a10~82@) (Sub c10~86@ c10~86@))) (Add (Mul (Mul d10~88@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1888@ (Add (Mul (Mul (Mul b10~84@ d10~88@) (Sub c10~86@ c10~86@)) (Sub (Mul b10~84@ a10~82@) (Sub c10~86@ c10~86@))) (Add (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d10~88@ a10~82@) (=> %%location_label%%10 (= temp_10_0~1823@ temp_10_1~1888@))) (=> (= temp_10_0~1823@ temp_10_1~1888@) (=> (= temp_11_0~1977@ (Mul (Mul (Add (Mul d11~96@ d11~96@) (Mul b11~92@ c11~94@)) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ c11~94@))) (Mul (Mul (Mul c11~94@ b11~92@) c11~94@) (Mul (Add a11~90@ c11~94@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~2038@ (Mul (Mul (Mul (Mul c11~94@ b11~92@) c11~94@) (Mul (Add a11~90@ c11~94@) (Mul d11~96@ a11~90@))) (Mul (Add (Mul d11~96@ d11~96@) (Mul b11~92@ c11~94@)) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ c11~94@))))) (and (=> (= tmp%10@ (Mul (Add (Mul d11~96@ d11~96@) (Mul b11~92@ c11~94@)) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ c11~94@)))) (=> (= tmp%11@ (Mul (Mul (Mul c11~94@ b11~92@) c11~94@) (Mul (Add a11~90@ c11~94@) (Mul d11~96@ a11~90@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%11 (= temp_11_0~1977@ temp_11_1~2038@))))) (=> (= temp_11_0~1977@ temp_11_1~2038@) (=> (= temp_12_0~2191@ (Sub (Mul (Mul (Mul 78 d12~104@) (Mul c12~102@ b12~100@)) (Mul d12~104@ (Mul a12~98@ c12~102@))) (Mul (Sub (Mul c12~102@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ b12~100@))))) (=> (= temp_12_1~2264@ (Sub (Mul (Mul (Mul c12~102@ b12~100@) (Mul 78 d12~104@)) (Mul d12~104@ (Mul a12~98@ c12~102@))) (Mul (Sub (Mul c12~102@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ b12~100@))))) (and (=> (= tmp%12@ (Mul 78 d12~104@)) (=> (= tmp%13@ (Mul c12~102@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%12 (= temp_12_0~2191@ temp_12_1~2264@))))) (=> (= temp_12_0~2191@ temp_12_1~2264@) (=> (= temp_13_0~2377@ (Mul (Sub (Add (Mul b13~108@ d13~112@) (Mul a13~106@ d13~112@)) (Mul (Sub c13~110@ d13~112@) (Mul d13~112@ b13~108@))) (Sub (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Sub (Mul b13~108@ a13~106@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2442@ (Mul (Sub (Add (Mul b13~108@ d13~112@) (Mul a13~106@ d13~112@)) (Mul (Sub c13~110@ d13~112@) (Mul b13~108@ d13~112@))) (Sub (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Sub (Mul b13~108@ a13~106@) (Mul d13~112@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d13~112@ b13~108@) (=> %%location_label%%13 (= temp_13_0~2377@ temp_13_1~2442@))) (=> (= temp_13_0~2377@ temp_13_1~2442@) (=> (= temp_14_0~2535@ (Mul (Mul (Sub (Sub c14~118@ c14~118@) (Mul d14~120@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Mul d14~120@ b14~116@))) (Mul (Mul (Add b14~116@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ b14~116@))))) (=> (= temp_14_1~2600@ (Mul (Mul (Sub (Sub c14~118@ c14~118@) (Mul d14~120@ b14~116@)) (Mul d14~120@ (Mul b14~116@ (Mul d14~120@ b14~116@)))) (Mul (Mul (Add b14~116@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ b14~116@))))) (=> (= tmp%14@ (Mul d14~120@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d14~120@ b14~116@ tmp%14@) (=> %%location_label%%14 (= temp_14_0~2535@ temp_14_1~2600@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
