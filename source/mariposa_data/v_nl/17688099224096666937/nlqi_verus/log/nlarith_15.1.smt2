...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Sub (Sub (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Sub a0~2@ c0~6@) (Mul d0~8@ a0~2@))) (Mul (Sub (Mul b0~4@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~370@ (Add (Sub (Sub (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Sub a0~2@ c0~6@) (Mul d0~8@ a0~2@))) (Mul (Sub (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~434@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Mul 61 d1~16@))) c1~14@)) (=> (= temp_1_1~483@ (Mul (Mul (Mul (Mul (Mul b1~12@ c1~14@) b1~12@) d1~16@) (Mul (Mul b1~12@ a1~10@) (Mul 61 d1~16@))) c1~14@)) (=> (= tmp%2@ (= temp_1_0~434@ temp_1_1~483@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~535@ (Sub (Mul (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))) b2~20@)) (=> (= temp_2_1~572@ (Sub (Mul (Mul (Mul (Mul a2~18@ a2~18@) c2~22@) d2~24@) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))) b2~20@)) (=> (= tmp%3@ (= temp_2_0~535@ temp_2_1~572@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~624@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ b3~28@))) a3~26@)) (=> (= temp_3_1~661@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ c3~30@)) (Mul (Mul (Mul c3~30@ b3~28@) a3~26@) b3~28@)) a3~26@)) (=> (= tmp%4@ (= temp_3_0~624@ temp_3_1~661@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~749@ (Mul (Add (Mul a4~34@ (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ b4~36@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul 73 d4~40@)) (Mul (Add d4~40@ d4~40@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~822@ (Mul (Add (Mul a4~34@ (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ b4~36@))) (Mul (Mul c4~38@ d4~40@) (Mul (Mul 73 d4~40@) (Mul (Add d4~40@ d4~40@) (Mul b4~36@ c4~38@)))))) (=> (= tmp%5@ (= temp_4_0~749@ temp_4_1~822@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~890@ (Mul (Mul (Mul (Sub a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ a5~42@))) (Mul c5~46@ (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~943@ (Mul (Mul (Mul (Sub a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ a5~42@))) (Mul c5~46@ (Mul (Mul (Mul d5~48@ c5~46@) c5~46@) a5~42@)))) (=> (= tmp%6@ (= temp_5_0~890@ temp_5_1~943@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1011@ (Mul (Mul d6~56@ (Mul (Add c6~54@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1064@ (Mul (Mul d6~56@ (Mul (Add c6~54@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1011@ temp_6_1~1064@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1144@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Sub d7~64@ b7~60@)) (Mul (Add b7~60@ b7~60@) (Mul a7~58@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ a7~58@)) (Sub (Mul b7~60@ c7~62@) (Sub d7~64@ a7~58@))))) (=> (= temp_7_1~1209@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Sub d7~64@ b7~60@)) (Mul (Add b7~60@ b7~60@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ a7~58@)) (Sub (Mul b7~60@ c7~62@) (Sub d7~64@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1144@ temp_7_1~1209@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1289@ (Mul (Mul (Mul (Add c8~70@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Add b8~68@ d8~72@))) (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ c8~70@)) (Sub (Mul a8~66@ c8~70@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1354@ (Mul (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ c8~70@)) (Sub (Mul a8~66@ c8~70@) (Mul a8~66@ c8~70@))) (Mul (Mul (Add c8~70@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Add b8~68@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1289@ temp_8_1~1354@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1434@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Mul c9~78@ d9~80@)) (Sub (Add c9~78@ b9~76@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~1499@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Mul d9~80@ c9~78@)) (Sub (Add c9~78@ b9~76@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1434@ temp_9_1~1499@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1579@ (Add (Mul (Mul (Mul b10~84@ d10~88@) (Sub c10~86@ c10~86@)) (Sub (Mul b10~84@ a10~82@) (Sub c10~86@ c10~86@))) (Add (Mul (Mul d10~88@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1644@ (Add (Mul (Mul (Mul b10~84@ d10~88@) (Sub c10~86@ c10~86@)) (Sub (Mul b10~84@ a10~82@) (Sub c10~86@ c10~86@))) (Add (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1579@ temp_10_1~1644@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1720@ (Mul (Mul (Add (Mul d11~96@ d11~96@) (Mul b11~92@ c11~94@)) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ c11~94@))) (Mul (Mul (Mul c11~94@ b11~92@) c11~94@) (Mul (Add a11~90@ c11~94@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~1781@ (Mul (Mul (Mul (Mul c11~94@ b11~92@) c11~94@) (Mul (Add a11~90@ c11~94@) (Mul d11~96@ a11~90@))) (Mul (Add (Mul d11~96@ d11~96@) (Mul b11~92@ c11~94@)) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1720@ temp_11_1~1781@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1869@ (Sub (Mul (Mul (Mul 78 d12~104@) (Mul c12~102@ b12~100@)) (Mul d12~104@ (Mul a12~98@ c12~102@))) (Mul (Sub (Mul c12~102@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ b12~100@))))) (=> (= temp_12_1~1942@ (Sub (Mul (Mul (Mul c12~102@ b12~100@) (Mul 78 d12~104@)) (Mul d12~104@ (Mul a12~98@ c12~102@))) (Mul (Sub (Mul c12~102@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ b12~100@))))) (=> (= tmp%13@ (= temp_12_0~1869@ temp_12_1~1942@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2022@ (Mul (Sub (Add (Mul b13~108@ d13~112@) (Mul a13~106@ d13~112@)) (Mul (Sub c13~110@ d13~112@) (Mul d13~112@ b13~108@))) (Sub (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Sub (Mul b13~108@ a13~106@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2087@ (Mul (Sub (Add (Mul b13~108@ d13~112@) (Mul a13~106@ d13~112@)) (Mul (Sub c13~110@ d13~112@) (Mul b13~108@ d13~112@))) (Sub (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Sub (Mul b13~108@ a13~106@) (Mul d13~112@ b13~108@))))) (=> (= tmp%14@ (= temp_13_0~2022@ temp_13_1~2087@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2167@ (Mul (Mul (Sub (Sub c14~118@ c14~118@) (Mul d14~120@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Mul d14~120@ b14~116@))) (Mul (Mul (Add b14~116@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ b14~116@))))) (=> (= temp_14_1~2232@ (Mul (Mul (Sub (Sub c14~118@ c14~118@) (Mul d14~120@ b14~116@)) (Mul d14~120@ (Mul b14~116@ (Mul d14~120@ b14~116@)))) (Mul (Mul (Add b14~116@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2167@ temp_14_1~2232@)) (=> %%location_label%%14 tmp%15@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
