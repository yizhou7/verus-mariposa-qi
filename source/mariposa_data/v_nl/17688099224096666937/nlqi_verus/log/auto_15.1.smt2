...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Sub (Sub (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Sub a0~2@ c0~6@) (Mul d0~8@ a0~2@))) (Mul (Sub (Mul b0~4@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~370@ (Add (Sub (Sub (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Sub a0~2@ c0~6@) (Mul d0~8@ a0~2@))) (Mul (Sub (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~443@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Mul 61 d1~16@))) c1~14@)) (=> (= temp_1_1~492@ (Mul (Mul (Mul (Mul (Mul b1~12@ c1~14@) b1~12@) d1~16@) (Mul (Mul b1~12@ a1~10@) (Mul 61 d1~16@))) c1~14@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~443@ temp_1_1~492@))) (=> (= temp_1_0~443@ temp_1_1~492@) (=> (= temp_2_0~553@ (Sub (Mul (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))) b2~20@)) (=> (= temp_2_1~590@ (Sub (Mul (Mul (Mul (Mul a2~18@ a2~18@) c2~22@) d2~24@) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))) b2~20@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~553@ temp_2_1~590@))) (=> (= temp_2_0~553@ temp_2_1~590@) (=> (= temp_3_0~651@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ b3~28@))) a3~26@)) (=> (= temp_3_1~688@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ c3~30@)) (Mul (Mul (Mul c3~30@ b3~28@) a3~26@) b3~28@)) a3~26@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~651@ temp_3_1~688@))) (=> (= temp_3_0~651@ temp_3_1~688@) (=> (= temp_4_0~785@ (Mul (Add (Mul a4~34@ (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ b4~36@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul 73 d4~40@)) (Mul (Add d4~40@ d4~40@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~858@ (Mul (Add (Mul a4~34@ (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ b4~36@))) (Mul (Mul c4~38@ d4~40@) (Mul (Mul 73 d4~40@) (Mul (Add d4~40@ d4~40@) (Mul b4~36@ c4~38@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~785@ temp_4_1~858@))) (=> (= temp_4_0~785@ temp_4_1~858@) (=> (= temp_5_0~935@ (Mul (Mul (Mul (Sub a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ a5~42@))) (Mul c5~46@ (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~988@ (Mul (Mul (Mul (Sub a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ a5~42@))) (Mul c5~46@ (Mul (Mul (Mul d5~48@ c5~46@) c5~46@) a5~42@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~935@ temp_5_1~988@))) (=> (= temp_5_0~935@ temp_5_1~988@) (=> (= temp_6_0~1065@ (Mul (Mul d6~56@ (Mul (Add c6~54@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1118@ (Mul (Mul d6~56@ (Mul (Add c6~54@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1065@ temp_6_1~1118@))) (=> (= temp_6_0~1065@ temp_6_1~1118@) (=> (= temp_7_0~1207@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Sub d7~64@ b7~60@)) (Mul (Add b7~60@ b7~60@) (Mul a7~58@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ a7~58@)) (Sub (Mul b7~60@ c7~62@) (Sub d7~64@ a7~58@))))) (=> (= temp_7_1~1272@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Sub d7~64@ b7~60@)) (Mul (Add b7~60@ b7~60@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ a7~58@)) (Sub (Mul b7~60@ c7~62@) (Sub d7~64@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1207@ temp_7_1~1272@))) (=> (= temp_7_0~1207@ temp_7_1~1272@) (=> (= temp_8_0~1361@ (Mul (Mul (Mul (Add c8~70@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Add b8~68@ d8~72@))) (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ c8~70@)) (Sub (Mul a8~66@ c8~70@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1426@ (Mul (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ c8~70@)) (Sub (Mul a8~66@ c8~70@) (Mul a8~66@ c8~70@))) (Mul (Mul (Add c8~70@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Add b8~68@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1361@ temp_8_1~1426@))) (=> (= temp_8_0~1361@ temp_8_1~1426@) (=> (= temp_9_0~1515@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Mul c9~78@ d9~80@)) (Sub (Add c9~78@ b9~76@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~1580@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Mul d9~80@ c9~78@)) (Sub (Add c9~78@ b9~76@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1515@ temp_9_1~1580@))) (=> (= temp_9_0~1515@ temp_9_1~1580@) (=> (= temp_10_0~1669@ (Add (Mul (Mul (Mul b10~84@ d10~88@) (Sub c10~86@ c10~86@)) (Sub (Mul b10~84@ a10~82@) (Sub c10~86@ c10~86@))) (Add (Mul (Mul d10~88@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1734@ (Add (Mul (Mul (Mul b10~84@ d10~88@) (Sub c10~86@ c10~86@)) (Sub (Mul b10~84@ a10~82@) (Sub c10~86@ c10~86@))) (Add (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1669@ temp_10_1~1734@))) (=> (= temp_10_0~1669@ temp_10_1~1734@) (=> (= temp_11_0~1819@ (Mul (Mul (Add (Mul d11~96@ d11~96@) (Mul b11~92@ c11~94@)) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ c11~94@))) (Mul (Mul (Mul c11~94@ b11~92@) c11~94@) (Mul (Add a11~90@ c11~94@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~1880@ (Mul (Mul (Mul (Mul c11~94@ b11~92@) c11~94@) (Mul (Add a11~90@ c11~94@) (Mul d11~96@ a11~90@))) (Mul (Add (Mul d11~96@ d11~96@) (Mul b11~92@ c11~94@)) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1819@ temp_11_1~1880@))) (=> (= temp_11_0~1819@ temp_11_1~1880@) (=> (= temp_12_0~1977@ (Sub (Mul (Mul (Mul 78 d12~104@) (Mul c12~102@ b12~100@)) (Mul d12~104@ (Mul a12~98@ c12~102@))) (Mul (Sub (Mul c12~102@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ b12~100@))))) (=> (= temp_12_1~2050@ (Sub (Mul (Mul (Mul c12~102@ b12~100@) (Mul 78 d12~104@)) (Mul d12~104@ (Mul a12~98@ c12~102@))) (Mul (Sub (Mul c12~102@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~1977@ temp_12_1~2050@))) (=> (= temp_12_0~1977@ temp_12_1~2050@) (=> (= temp_13_0~2139@ (Mul (Sub (Add (Mul b13~108@ d13~112@) (Mul a13~106@ d13~112@)) (Mul (Sub c13~110@ d13~112@) (Mul d13~112@ b13~108@))) (Sub (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Sub (Mul b13~108@ a13~106@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2204@ (Mul (Sub (Add (Mul b13~108@ d13~112@) (Mul a13~106@ d13~112@)) (Mul (Sub c13~110@ d13~112@) (Mul b13~108@ d13~112@))) (Sub (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Sub (Mul b13~108@ a13~106@) (Mul d13~112@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2139@ temp_13_1~2204@))) (=> (= temp_13_0~2139@ temp_13_1~2204@) (=> (= temp_14_0~2293@ (Mul (Mul (Sub (Sub c14~118@ c14~118@) (Mul d14~120@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Mul d14~120@ b14~116@))) (Mul (Mul (Add b14~116@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ b14~116@))))) (=> (= temp_14_1~2358@ (Mul (Mul (Sub (Sub c14~118@ c14~118@) (Mul d14~120@ b14~116@)) (Mul d14~120@ (Mul b14~116@ (Mul d14~120@ b14~116@)))) (Mul (Mul (Add b14~116@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ b14~116@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2293@ temp_14_1~2358@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
