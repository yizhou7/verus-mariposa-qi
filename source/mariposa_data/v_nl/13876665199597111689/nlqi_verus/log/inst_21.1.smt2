...
(set-info :comment ";; mariposa_data/v_nl//13876665199597111689/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_5_0~1337@ Int)
(declare-const temp_5_1~1406@ Int)
(declare-const temp_6_0~1493@ Int)
(declare-const temp_6_1~1558@ Int)
(declare-const temp_7_0~1677@ Int)
(declare-const temp_7_1~1778@ Int)
(declare-const temp_8_0~1917@ Int)
(declare-const temp_8_1~1994@ Int)
(declare-const temp_9_0~2121@ Int)
(declare-const temp_9_1~2186@ Int)
(declare-const temp_10_0~2289@ Int)
(declare-const temp_10_1~2342@ Int)
(declare-const temp_11_0~2479@ Int)
(declare-const temp_11_1~2544@ Int)
(declare-const temp_12_0~2637@ Int)
(declare-const temp_12_1~2702@ Int)
(declare-const temp_13_0~2821@ Int)
(declare-const temp_13_1~2898@ Int)
(declare-const temp_14_0~3009@ Int)
(declare-const temp_14_1~3086@ Int)
(declare-const temp_15_0~3175@ Int)
(declare-const temp_15_1~3236@ Int)
(declare-const temp_16_0~3375@ Int)
(declare-const temp_16_1~3436@ Int)
(declare-const temp_17_0~3577@ Int)
(declare-const temp_17_1~3638@ Int)
(declare-const temp_18_0~3731@ Int)
(declare-const temp_18_1~3796@ Int)
(declare-const temp_19_0~3923@ Int)
(declare-const temp_19_1~4000@ Int)
(declare-const temp_20_0~4081@ Int)
(declare-const temp_20_1~4134@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Sub (Add c0~6@ b0~4@) (Mul a0~2@ d0~8@)) (Add (Sub d0~8@ d0~8@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Sub (Add c0~6@ b0~4@) (Mul a0~2@ d0~8@)) (Add (Sub d0~8@ d0~8@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ c0~6@))))) (and (=> (= tmp%1@ (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ c0~6@))) (=> (= tmp%2@ (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ c0~6@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~499@ (Sub (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)) (Sub (Mul c1~14@ b1~12@) (Mul a1~10@ 36))) (Mul (Add (Mul d1~16@ c1~14@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~576@ (Sub (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)) (Sub (Mul c1~14@ b1~12@) (Mul a1~10@ 36))) (Mul (Mul (Add (Mul d1~16@ c1~14@) (Mul d1~16@ d1~16@)) (Mul d1~16@ c1~14@)) (Mul a1~10@ c1~14@)))) (and (=> (= tmp%3@ (Add (Mul d1~16@ c1~14@) (Mul d1~16@ d1~16@))) (=> (= tmp%4@ (Mul d1~16@ c1~14@)) (=> (= tmp%5@ (Mul a1~10@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~499@ temp_1_1~576@)))))) (=> (= temp_1_0~499@ temp_1_1~576@) (=> (= temp_2_0~687@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Sub d2~24@ b2~20@) b2~20@)) (Mul (Mul (Add c2~22@ b2~20@) (Add a2~18@ b2~20@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~748@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Sub d2~24@ b2~20@) b2~20@)) (Mul (Add c2~22@ b2~20@) (Mul (Add a2~18@ b2~20@) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@)))))) (and (=> (= tmp%6@ (Add c2~22@ b2~20@)) (=> (= tmp%7@ (Add a2~18@ b2~20@)) (=> (= tmp%8@ (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%2 (= temp_2_0~687@ temp_2_1~748@)))))) (=> (= temp_2_0~687@ temp_2_1~748@) (=> (= temp_3_0~875@ (Mul (Sub (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ a3~26@)) (Add (Mul c3~30@ b3~28@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ 72)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ a3~26@))))) (=> (= temp_3_1~996@ (Sub (Mul (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ 72)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ a3~26@)))) (Mul (Add (Mul c3~30@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ 72)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ a3~26@)))))) (and (=> (= tmp%9@ (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ a3~26@))) (=> (= tmp%10@ (Add (Mul c3~30@ b3~28@) (Mul d3~32@ c3~30@))) (=> (= tmp%11@ (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ 72)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ a3~26@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%3 (= temp_3_0~875@ temp_3_1~996@)))))) (=> (= temp_3_0~875@ temp_3_1~996@) (=> (= temp_4_0~1163@ (Mul (Add (Mul (Mul c4~38@ 66) (Mul c4~38@ c4~38@)) (Mul c4~38@ (Mul c4~38@ a4~34@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Sub d4~40@ c4~38@) (Mul a4~34@ a4~34@))))) (=> (= temp_4_1~1236@ (Mul (Add (Mul (Mul c4~38@ 66) (Mul c4~38@ c4~38@)) (Mul c4~38@ (Mul c4~38@ a4~34@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Sub d4~40@ c4~38@) (Mul a4~34@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c4~38@ b4~36@) (=> %%location_label%%4 (= temp_4_0~1163@ temp_4_1~1236@))) (=> (= temp_4_0~1163@ temp_4_1~1236@) (=> (= temp_5_0~1337@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul 15 a5~42@) (Mul c5~46@ c5~46@))) (Add (Add (Mul c5~46@ a5~42@) (Mul c5~46@ c5~46@)) (Mul (Mul a5~42@ c5~46@) a5~42@)))) (=> (= temp_5_1~1406@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul 15 a5~42@) (Mul c5~46@ c5~46@))) (Add (Mul c5~46@ (Add a5~42@ c5~46@)) (Mul (Mul a5~42@ c5~46@) a5~42@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. c5~46@ a5~42@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1337@ temp_5_1~1406@))) (=> (= temp_5_0~1337@ temp_5_1~1406@) (=> (= temp_6_0~1493@ (Mul (Mul (Add (Mul c6~54@ b6~52@) c6~54@) (Mul (Add d6~56@ d6~56@) (Mul b6~52@ d6~56@))) (Mul (Sub (Add b6~52@ d6~56@) (Mul d6~56@ a6~50@)) (Mul a6~50@ (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1558@ (Mul (Mul (Add (Mul c6~54@ b6~52@) c6~54@) (Add (Mul d6~56@ (Mul b6~52@ d6~56@)) (Mul d6~56@ (Mul b6~52@ d6~56@)))) (Mul (Sub (Add b6~52@ d6~56@) (Mul d6~56@ a6~50@)) (Mul a6~50@ (Mul d6~56@ d6~56@))))) (and (=> (= tmp%12@ (Mul b6~52@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d6~56@ d6~56@ tmp%12@) (=> %%location_label%%6 (= temp_6_0~1493@ temp_6_1~1558@)))) (=> (= temp_6_0~1493@ temp_6_1~1558@) (=> (= temp_7_0~1677@ (Sub (Mul (Sub (Add a7~58@ d7~64@) (Mul b7~60@ 26)) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ b7~60@))) (Mul (Add (Mul a7~58@ a7~58@) (Add 41 a7~58@)) (Mul a7~58@ (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1778@ (Sub (Sub (Mul (Add a7~58@ d7~64@) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ b7~60@))) (Mul (Mul b7~60@ 26) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ b7~60@)))) (Mul (Add (Mul a7~58@ a7~58@) (Add 41 a7~58@)) (Mul a7~58@ (Mul b7~60@ b7~60@))))) (and (=> (= tmp%13@ (Add a7~58@ d7~64@)) (=> (= tmp%14@ (Mul b7~60@ 26)) (=> (= tmp%15@ (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ b7~60@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%7 (= temp_7_0~1677@ temp_7_1~1778@)))))) (=> (= temp_7_0~1677@ temp_7_1~1778@) (=> (= temp_8_0~1917@ (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Sub b8~68@ d8~72@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@)) (Sub (Mul 97 c8~70@) (Mul c8~70@ b8~68@))))) (=> (= temp_8_1~1994@ (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Sub b8~68@ d8~72@) (Mul a8~66@ b8~68@))) (Mul (Mul b8~68@ b8~68@) (Mul (Mul c8~70@ d8~72@) (Sub (Mul 97 c8~70@) (Mul c8~70@ b8~68@)))))) (and (=> (= tmp%16@ (Mul b8~68@ b8~68@)) (=> (= tmp%17@ (Mul c8~70@ d8~72@)) (=> (= tmp%18@ (Sub (Mul 97 c8~70@) (Mul c8~70@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%8 (= temp_8_0~1917@ temp_8_1~1994@)))))) (=> (= temp_8_0~1917@ temp_8_1~1994@) (=> (= temp_9_0~2121@ (Sub (Mul (Mul (Mul c9~78@ 38) (Mul d9~80@ c9~78@)) a9~74@) (Mul (Mul (Add b9~76@ d9~80@) (Mul d9~80@ a9~74@)) (Add (Mul c9~78@ d9~80@) (Sub d9~80@ b9~76@))))) (=> (= temp_9_1~2186@ (Sub (Mul (Mul (Mul c9~78@ 38) (Mul d9~80@ c9~78@)) a9~74@) (Mul (Add b9~76@ d9~80@) (Mul (Mul d9~80@ a9~74@) (Add (Mul c9~78@ d9~80@) (Sub d9~80@ b9~76@)))))) (and (=> (= tmp%19@ (Add b9~76@ d9~80@)) (=> (= tmp%20@ (Mul d9~80@ a9~74@)) (=> (= tmp%21@ (Add (Mul c9~78@ d9~80@) (Sub d9~80@ b9~76@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%9 (= temp_9_0~2121@ temp_9_1~2186@)))))) (=> (= temp_9_0~2121@ temp_9_1~2186@) (=> (= temp_10_0~2289@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ d10~88@)) (Sub (Mul d10~88@ d10~88@) (Sub b10~84@ d10~88@))) (Mul d10~88@ (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ a10~82@))))) (=> (= temp_10_1~2342@ (Mul (Mul d10~88@ (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ a10~82@))) (Mul (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ d10~88@)) (Sub (Mul d10~88@ d10~88@) (Sub b10~84@ d10~88@))))) (and (=> (= tmp%22@ (Mul (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ d10~88@)) (Sub (Mul d10~88@ d10~88@) (Sub b10~84@ d10~88@)))) (=> (= tmp%23@ (Mul d10~88@ (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ a10~82@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%10 (= temp_10_0~2289@ temp_10_1~2342@))))) (=> (= temp_10_0~2289@ temp_10_1~2342@) (=> (= temp_11_0~2479@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) (Add b11~92@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Sub d11~96@ b11~92@))) (Mul (Mul (Mul c11~94@ c11~94@) (Mul 32 b11~92@)) a11~90@))) (=> (= temp_11_1~2544@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) (Add b11~92@ c11~94@)) (Mul (Mul d11~96@ b11~92@) (Sub d11~96@ b11~92@))) (Mul (Mul (Mul c11~94@ c11~94@) (Mul 32 b11~92@)) a11~90@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b11~92@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2479@ temp_11_1~2544@))) (=> (= temp_11_0~2479@ temp_11_1~2544@) (=> (= temp_12_0~2637@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul b12~100@ b12~100@)) (Mul (Mul d12~104@ d12~104@) (Add c12~102@ a12~98@))) (Mul (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ d12~104@)) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2702@ (Mul (Mul (Mul b12~100@ c12~102@) (Mul (Mul b12~100@ b12~100@) (Mul (Mul d12~104@ d12~104@) (Add c12~102@ a12~98@)))) (Mul (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ d12~104@)) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@))))) (and (=> (= tmp%24@ (Mul b12~100@ c12~102@)) (=> (= tmp%25@ (Mul b12~100@ b12~100@)) (=> (= tmp%26@ (Mul (Mul d12~104@ d12~104@) (Add c12~102@ a12~98@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%12 (= temp_12_0~2637@ temp_12_1~2702@)))))) (=> (= temp_12_0~2637@ temp_12_1~2702@) (=> (= temp_13_0~2821@ (Mul (Mul (Mul (Sub c13~110@ b13~108@) (Mul c13~110@ 72)) (Mul a13~106@ (Mul a13~106@ d13~112@))) (Mul (Add (Mul b13~108@ a13~106@) d13~112@) (Mul (Add a13~106@ c13~110@) (Mul c13~110@ b13~108@))))) (=> (= temp_13_1~2898@ (Mul (Mul (Mul (Sub c13~110@ b13~108@) (Mul c13~110@ 72)) (Mul a13~106@ (Mul a13~106@ d13~112@))) (Mul (Add (Mul b13~108@ a13~106@) d13~112@) (Add (Mul a13~106@ (Mul c13~110@ b13~108@)) (Mul c13~110@ (Mul c13~110@ b13~108@)))))) (and (=> (= tmp%27@ (Mul c13~110@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a13~106@ c13~110@ tmp%27@) (=> %%location_label%%13 (= temp_13_0~2821@ temp_13_1~2898@)))) (=> (= temp_13_0~2821@ temp_13_1~2898@) (=> (= temp_14_0~3009@ (Mul (Mul (Mul (Mul c14~118@ 33) (Sub a14~114@ c14~118@)) (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ a14~114@))) (Mul (Add (Add d14~120@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul a14~114@ b14~116@) (Mul a14~114@ b14~116@))))) (=> (= temp_14_1~3086@ (Mul (Mul (Mul (Mul c14~118@ 33) (Sub a14~114@ c14~118@)) (Mul (Mul c14~118@ d14~120@) (Mul c14~118@ a14~114@))) (Mul (Add (Add d14~120@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul a14~114@ b14~116@) (Mul a14~114@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ c14~118@) (=> %%location_label%%14 (= temp_14_0~3009@ temp_14_1~3086@))) (=> (= temp_14_0~3009@ temp_14_1~3086@) (=> (= temp_15_0~3175@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) c15~126@) (Mul (Sub c15~126@ d15~128@) (Add a15~122@ c15~126@))) (Mul (Mul (Add c15~126@ c15~126@) (Sub c15~126@ b15~124@)) (Mul (Add a15~122@ b15~124@) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~3236@ (Mul (Mul (Mul (Mul (Mul d15~128@ b15~124@) c15~126@) (Mul (Sub c15~126@ d15~128@) (Add a15~122@ c15~126@))) (Mul (Add c15~126@ c15~126@) (Sub c15~126@ b15~124@))) (Mul (Add a15~122@ b15~124@) (Mul a15~122@ d15~128@)))) (and (=> (= tmp%28@ (Mul (Mul (Mul d15~128@ b15~124@) c15~126@) (Mul (Sub c15~126@ d15~128@) (Add a15~122@ c15~126@)))) (=> (= tmp%29@ (Mul (Add c15~126@ c15~126@) (Sub c15~126@ b15~124@))) (=> (= tmp%30@ (Mul (Add a15~122@ b15~124@) (Mul a15~122@ d15~128@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%15 (= temp_15_0~3175@ temp_15_1~3236@)))))) (=> (= temp_15_0~3175@ temp_15_1~3236@) (=> (= temp_16_0~3375@ (Mul (Mul (Mul (Mul a16~130@ d16~136@) (Mul c16~134@ c16~134@)) (Mul (Mul c16~134@ c16~134@) (Add a16~130@ b16~132@))) (Sub (Mul (Mul a16~130@ b16~132@) (Mul d16~136@ b16~132@)) (Mul b16~132@ (Mul d16~136@ d16~136@))))) (=> (= temp_16_1~3436@ (Mul (Sub (Mul (Mul a16~130@ b16~132@) (Mul d16~136@ b16~132@)) (Mul b16~132@ (Mul d16~136@ d16~136@))) (Mul (Mul (Mul a16~130@ d16~136@) (Mul c16~134@ c16~134@)) (Mul (Mul c16~134@ c16~134@) (Add a16~130@ b16~132@))))) (and (=> (= tmp%31@ (Mul (Mul (Mul a16~130@ d16~136@) (Mul c16~134@ c16~134@)) (Mul (Mul c16~134@ c16~134@) (Add a16~130@ b16~132@)))) (=> (= tmp%32@ (Sub (Mul (Mul a16~130@ b16~132@) (Mul d16~136@ b16~132@)) (Mul b16~132@ (Mul d16~136@ d16~136@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%31@ tmp%32@) (=> %%location_label%%16 (= temp_16_0~3375@ temp_16_1~3436@))))) (=> (= temp_16_0~3375@ temp_16_1~3436@) (=> (= temp_17_0~3577@ (Mul (Mul (Mul (Mul d17~144@ c17~142@) (Mul a17~138@ a17~138@)) (Mul (Mul a17~138@ a17~138@) (Add c17~142@ a17~138@))) (Sub (Mul c17~142@ (Mul a17~138@ a17~138@)) (Sub (Mul b17~140@ c17~142@) (Mul c17~142@ d17~144@))))) (=> (= temp_17_1~3638@ (Mul (Mul (Mul (Mul d17~144@ c17~142@) (Mul a17~138@ a17~138@)) (Mul (Mul a17~138@ a17~138@) (Add c17~142@ a17~138@))) (Sub (Mul c17~142@ (Mul a17~138@ a17~138@)) (Sub (Mul b17~140@ c17~142@) (Mul d17~144@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c17~142@ d17~144@) (=> %%location_label%%17 (= temp_17_0~3577@ temp_17_1~3638@))) (=> (= temp_17_0~3577@ temp_17_1~3638@) (=> (= temp_18_0~3731@ (Add (Mul (Sub (Mul c18~150@ c18~150@) (Mul d18~152@ a18~146@)) (Mul (Mul b18~148@ a18~146@) (Mul a18~146@ d18~152@))) (Mul (Mul (Mul c18~150@ b18~148@) (Sub a18~146@ a18~146@)) (Mul (Mul b18~148@ d18~152@) (Mul c18~150@ b18~148@))))) (=> (= temp_18_1~3796@ (Add (Mul (Mul (Sub (Mul c18~150@ c18~150@) (Mul d18~152@ a18~146@)) (Mul b18~148@ a18~146@)) (Mul a18~146@ d18~152@)) (Mul (Mul (Mul c18~150@ b18~148@) (Sub a18~146@ a18~146@)) (Mul (Mul b18~148@ d18~152@) (Mul c18~150@ b18~148@))))) (and (=> (= tmp%33@ (Sub (Mul c18~150@ c18~150@) (Mul d18~152@ a18~146@))) (=> (= tmp%34@ (Mul b18~148@ a18~146@)) (=> (= tmp%35@ (Mul a18~146@ d18~152@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ tmp%34@ tmp%35@) (=> %%location_label%%18 (= temp_18_0~3731@ temp_18_1~3796@)))))) (=> (= temp_18_0~3731@ temp_18_1~3796@) (=> (= temp_19_0~3923@ (Mul (Mul (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Mul a19~154@ b19~156@) (Add b19~156@ b19~156@))) (Mul (Mul (Add c19~158@ d19~160@) (Mul 27 a19~154@)) (Mul (Mul b19~156@ d19~160@) (Mul c19~158@ d19~160@))))) (=> (= temp_19_1~4000@ (Mul (Mul (Mul (Mul b19~156@ b19~156@) (Mul d19~160@ b19~156@)) (Mul (Mul a19~154@ b19~156@) (Add b19~156@ b19~156@))) (Mul (Mul (Add c19~158@ d19~160@) (Mul 27 a19~154@)) (Mul (Mul b19~156@ d19~160@) (Mul c19~158@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b19~156@ d19~160@) (=> %%location_label%%19 (= temp_19_0~3923@ temp_19_1~4000@))) (=> (= temp_19_0~3923@ temp_19_1~4000@) (=> (= temp_20_0~4081@ (Mul (Sub (Sub (Mul b20~164@ c20~166@) (Mul b20~164@ c20~166@)) c20~166@) (Mul (Mul (Add b20~164@ c20~166@) (Mul d20~168@ d20~168@)) (Mul (Mul c20~166@ b20~164@) (Mul a20~162@ d20~168@))))) (=> (= temp_20_1~4134@ (Mul (Mul (Sub (Sub (Mul b20~164@ c20~166@) (Mul b20~164@ c20~166@)) c20~166@) (Mul (Add b20~164@ c20~166@) (Mul d20~168@ d20~168@))) (Mul (Mul c20~166@ b20~164@) (Mul a20~162@ d20~168@)))) (=> (= tmp%36@ (Sub (Sub (Mul b20~164@ c20~166@) (Mul b20~164@ c20~166@)) c20~166@)) (=> (= tmp%37@ (Mul (Add b20~164@ c20~166@) (Mul d20~168@ d20~168@))) (=> (= tmp%38@ (Mul (Mul c20~166@ b20~164@) (Mul a20~162@ d20~168@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%36@ tmp%37@ tmp%38@) (=> %%location_label%%20 (= temp_20_0~4081@ temp_20_1~4134@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
