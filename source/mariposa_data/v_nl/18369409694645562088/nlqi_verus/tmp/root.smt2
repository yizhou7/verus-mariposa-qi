...
;; mariposa_data/v_nl//18369409694645562088/nlqi_verus/src/main.rs:7:1: 36:40 (#0)
(push)
 ...
 (declare-const temp_10_1~1942@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~305@ (Mul (Mul (Add (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@)) (Sub (Mul b0~4@ b0~4@)
         (Mul d0~8@ c0~6@)
        )
       ) (Mul (Mul (Add d0~8@ c0~6@) (Mul a0~2@ a0~2@)) (Add (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@)))
     ))
     (=>
      (= temp_0_1~370@ (Mul (Mul (Add (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@)) (Sub (Mul b0~4@ b0~4@)
          (Mul d0~8@ c0~6@)
         )
        ) (Mul (Mul (Add d0~8@ c0~6@) (Mul a0~2@ a0~2@)) (Add (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@)))
      ))
      (and
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~459@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@
              a1~10@
             ) (Mul c1~14@ c1~14@)
            )
           ) (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul b1~12@
              c1~14@
         )))))
         (=>
          (= temp_1_1~524@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@
               a1~10@
              ) (Mul c1~14@ c1~14@)
             )
            ) (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ c1~14@)) (Mul d1~16@ (Mul a1~10@ (Mul b1~12@
                c1~14@
          ))))))
          (and
           (=>
           ...
           (=>
            (= temp_1_0~459@ temp_1_1~524@)
            (=>
             (= temp_2_0~625@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul a2~18@
                  a2~18@
                 ) (Mul a2~18@ d2~24@)
                )
               ) (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Sub 59
                  b2~20@
             )))))
             (=>
              (= temp_2_1~702@ (Mul (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul
                    a2~18@ a2~18@
                   ) (Mul a2~18@ d2~24@)
                  )
                 ) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ c2~22@))
                ) (Mul (Mul a2~18@ d2~24@) (Sub 59 b2~20@))
              ))
              (and
               (=>
                (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
               ...
               (=>
                (= temp_2_0~625@ temp_2_1~702@)
                (=>
                 (= temp_3_0~791@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@
                      a3~26@
                     ) (Mul a3~26@ d3~32@)
                    )
                   ) (Mul (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Sub d3~32@ d3~32@) (Mul a3~26@
                      a3~26@
                 )))))
                 (=>
                  (= temp_3_1~864@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@
                       a3~26@
                      ) (Mul a3~26@ d3~32@)
                     )
                    ) (Mul (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ d3~32@)) (Sub (Mul d3~32@ (Mul a3~26@ a3~26@))
                      (Mul d3~32@ (Mul a3~26@ a3~26@))
                  ))))
                  (and
                   (=>
                    (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                   ...
                   (=>
                    (= temp_3_0~791@ temp_3_1~864@)
                    (=>
                     (= temp_4_0~953@ (Mul (Sub (Mul (Mul d4~40@ d4~40@) (Add a4~34@ b4~36@)) (Mul (Mul d4~40@
                          b4~36@
                         ) (Mul c4~38@ b4~36@)
                        )
                       ) (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@
                          b4~36@
                     )))))
                     (=>
                      (= temp_4_1~1018@ (Mul (Sub (Mul (Mul d4~40@ d4~40@) (Add a4~34@ b4~36@)) (Mul (Mul d4~40@
                           b4~36@
                          ) (Mul c4~38@ b4~36@)
                         )
                        ) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul a4~34@ d4~40@)) (Mul
                          b4~36@ b4~36@
                      ))))
                      (and
                       (=>
                       ...
                       (=>
                        (= temp_4_0~953@ temp_4_1~1018@)
                        (=>
                         (= temp_5_0~1119@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@
                              a5~42@
                             ) (Mul 64 a5~42@)
                            )
                           ) (Mul (Mul (Mul c5~46@ b5~44@) (Add a5~42@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul c5~46@
                              c5~46@
                         )))))
                         (=>
                          (= temp_5_1~1196@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@
                               a5~42@
                              ) (Mul 64 a5~42@)
                             )
                            ) (Mul (Mul c5~46@ b5~44@) (Mul (Add a5~42@ d5~48@) (Mul (Mul b5~44@ c5~46@) (Mul c5~46@
                                c5~46@
                          ))))))
                          (and
                           (=>
                           ...
                           (=>
                            (= temp_5_0~1119@ temp_5_1~1196@)
                            (=>
                             (= temp_6_0~1273@ (Sub (Add (Mul (Mul d6~56@ a6~50@) (Sub c6~54@ d6~56@)) (Mul (Mul c6~54@
                                  d6~56@
                                 ) (Mul d6~56@ c6~54@)
                                )
                               ) (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) c6~54@)
                             ))
                             (=>
                              (= temp_6_1~1326@ (Sub (Add (Mul (Mul d6~56@ a6~50@) (Sub c6~54@ d6~56@)) (Mul (Mul d6~56@
                                   c6~54@
                                  ) (Mul c6~54@ d6~56@)
                                 )
                                ) (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) c6~54@)
                              ...
                              (and
                               ...
                               (=>
                                (= temp_6_0~1273@ temp_6_1~1326@)
                                (=>
                                 (= temp_7_0~1415@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul a7~58@
                                      b7~60@
                                     ) (Mul c7~62@ a7~58@)
                                    )
                                   ) (Mul (Sub (Mul d7~64@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul a7~58@
                                      d7~64@
                                 )))))
                                 (=>
                                  (= temp_7_1~1480@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul a7~58@
                                       b7~60@
                                      ) (Mul c7~62@ a7~58@)
                                     )
                                    ) (Mul (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ d7~64@)) (Sub (Mul d7~64@ b7~60@) (Mul d7~64@
                                       c7~62@
                                  )))))
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1415@ temp_7_1~1480@)
                                   ))
                                   (=>
                                    (= temp_7_0~1415@ temp_7_1~1480@)
                                    (=>
                                     (= temp_8_0~1569@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@
                                          d8~72@
                                         ) (Add a8~66@ a8~66@)
                                        )
                                       ) (Mul (Sub (Mul b8~68@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Add c8~70@
                                          b8~68@
                                     )))))
                                     (=>
                                      (= temp_8_1~1634@ (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Add a8~66@ a8~66@)) (Mul (Mul a8~66@
                                           b8~68@
                                          ) (Mul c8~70@ a8~66@)
                                         )
                                        ) (Mul (Sub (Mul b8~68@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Add c8~70@
                                      ...
                                      (and
                                       ...
                                       (=>
                                        (= temp_8_0~1569@ temp_8_1~1634@)
                                        (=>
                                         (= temp_9_0~1723@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@
                                              c9~78@
                                             ) (Mul d9~80@ d9~80@)
                                            )
                                           ) (Mul (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul b9~76@
                                              c9~78@
                                         )))))
                                         (=>
                                          (= temp_9_1~1788@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@
                                               c9~78@
                                              ) (Mul d9~80@ d9~80@)
                                             )
                                            ) (Mul (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul b9~76@
                                          ...
                                          (and
                                           ...
                                           (=>
                                            (= temp_9_0~1723@ temp_9_1~1788@)
                                            (=>
                                             (= temp_10_0~1877@ (Add (Mul (Mul (Mul d10~88@ d10~88@) (Sub d10~88@ c10~86@)) (Mul (
                                                  Mul d10~88@ a10~82@
                                                 ) (Mul c10~86@ b10~84@)
                                                )
                                               ) (Mul (Mul (Sub c10~86@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul d10~88@ b10~84@)
                                                 (Mul c10~86@ d10~88@)
                                             ))))
                                             (=>
                                              (= temp_10_1~1942@ (Add (Mul (Mul (Mul d10~88@ d10~88@) (Sub d10~88@ c10~86@)) (Mul (
                                                   Mul d10~88@ a10~82@
                                                  ) (Mul c10~86@ b10~84@)
                                                 )
                                                ) (Mul (Mul (Mul (Sub c10~86@ b10~84@) d10~88@) a10~82@) (Mul (Mul d10~88@ b10~84@)
                                                  (Mul c10~86@ d10~88@)
                                              ))))
                                              (=>
                                               (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
