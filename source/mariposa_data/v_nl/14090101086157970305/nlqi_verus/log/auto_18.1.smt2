...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Add c0~6@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ c0~6@))) (Add (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Add c0~6@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ c0~6@))) (Add (Mul d0~8@ (Mul c0~6@ (Sub c0~6@ d0~8@))) (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~459@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub a1~10@ a1~10@)) (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~524@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub a1~10@ a1~10@)) (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~459@ temp_1_1~524@))) (=> (= temp_1_0~459@ temp_1_1~524@) (=> (= temp_2_0~613@ (Add (Mul (Add (Add 27 d2~24@) (Add b2~20@ a2~18@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))) (Mul a2~18@ (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@))))) (=> (= temp_2_1~678@ (Add (Mul (Add (Add 27 d2~24@) (Add b2~20@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ c2~22@))) (Mul a2~18@ (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~613@ temp_2_1~678@))) (=> (= temp_2_0~613@ temp_2_1~678@) (=> (= temp_3_0~751@ (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ (Mul a3~26@ c3~30@))) (Mul (Sub (Mul d3~32@ a3~26@) (Sub b3~28@ a3~26@)) (Add (Sub a3~26@ c3~30@) b3~28@)))) (=> (= temp_3_1~800@ (Mul (Mul (Mul d3~32@ b3~28@) (Mul (Mul a3~26@ c3~30@) c3~30@)) (Mul (Sub (Mul d3~32@ a3~26@) (Sub b3~28@ a3~26@)) (Add (Sub a3~26@ c3~30@) b3~28@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~751@ temp_3_1~800@))) (=> (= temp_3_0~751@ temp_3_1~800@) (=> (= temp_4_0~889@ (Mul (Mul (Sub (Add a4~34@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~954@ (Mul (Mul (Sub (Add a4~34@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~889@ temp_4_1~954@))) (=> (= temp_4_0~889@ temp_4_1~954@) (=> (= temp_5_0~1039@ (Mul (Add (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Add c5~46@ a5~42@) (Mul d5~48@ b5~44@)) (Mul c5~46@ (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1100@ (Mul (Add (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ b5~44@))) (Mul (Mul (Add c5~46@ a5~42@) (Mul d5~48@ b5~44@)) (Mul c5~46@ (Mul b5~44@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1039@ temp_5_1~1100@))) (=> (= temp_5_0~1039@ temp_5_1~1100@) (=> (= temp_6_0~1201@ (Mul (Mul (Add (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@)) (Sub (Mul b6~52@ b6~52@) (Sub 88 c6~54@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1278@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ b6~52@))) (Mul (Add (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@)) (Sub (Mul b6~52@ b6~52@) (Sub 88 c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1201@ temp_6_1~1278@))) (=> (= temp_6_0~1201@ temp_6_1~1278@) (=> (= temp_7_0~1367@ (Mul (Add (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1432@ (Mul (Add (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1367@ temp_7_1~1432@))) (=> (= temp_7_0~1367@ temp_7_1~1432@) (=> (= temp_8_0~1521@ (Mul (Add (Add (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1618@ (Add (Mul (Add (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@)) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ a8~66@)))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ a8~66@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1521@ temp_8_1~1618@))) (=> (= temp_8_0~1521@ temp_8_1~1618@) (=> (= temp_9_0~1695@ (Mul (Mul (Mul (Add d9~80@ a9~74@) (Mul a9~74@ c9~78@)) c9~78@) (Mul (Add (Mul c9~78@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Sub c9~78@ a9~74@) (Mul c9~78@ b9~76@))))) (=> (= temp_9_1~1748@ (Mul (Mul (Mul (Mul (Add d9~80@ a9~74@) a9~74@) c9~78@) c9~78@) (Mul (Add (Mul c9~78@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Sub c9~78@ a9~74@) (Mul c9~78@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1695@ temp_9_1~1748@))) (=> (= temp_9_0~1695@ temp_9_1~1748@) (=> (= temp_10_0~1825@ (Sub (Add (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ c10~86@))) (Mul (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ a10~82@)) c10~86@))) (=> (= temp_10_1~1878@ (Sub (Add (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ c10~86@))) (Mul (Mul a10~82@ c10~86@) (Mul (Mul a10~82@ a10~82@) c10~86@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1825@ temp_10_1~1878@))) (=> (= temp_10_0~1825@ temp_10_1~1878@) (=> (= temp_11_0~1975@ (Mul (Mul (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ a11~90@))) (Sub (Mul (Mul a11~90@ 9) (Mul d11~96@ d11~96@)) (Mul (Mul d11~96@ c11~94@) d11~96@)))) (=> (= temp_11_1~2048@ (Mul (Mul (Mul c11~94@ b11~92@) (Mul (Mul b11~92@ a11~90@) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ a11~90@)))) (Sub (Mul (Mul a11~90@ 9) (Mul d11~96@ d11~96@)) (Mul (Mul d11~96@ c11~94@) d11~96@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1975@ temp_11_1~2048@))) (=> (= temp_11_0~1975@ temp_11_1~2048@) (=> (= temp_12_0~2133@ (Mul (Add (Mul (Add d12~104@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ a12~98@) b12~100@)) (Mul (Mul (Mul d12~104@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ d12~104@))))) (=> (= temp_12_1~2194@ (Mul (Add (Mul (Add d12~104@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ a12~98@) b12~100@)) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2133@ temp_12_1~2194@))) (=> (= temp_12_0~2133@ temp_12_1~2194@) (=> (= temp_13_0~2283@ (Mul (Mul (Mul (Sub a13~106@ d13~112@) (Mul c13~110@ a13~106@)) (Mul (Mul d13~112@ c13~110@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul a13~106@ d13~112@))))) (=> (= temp_13_1~2348@ (Mul (Mul (Mul (Sub a13~106@ d13~112@) (Mul c13~110@ a13~106@)) (Mul (Mul d13~112@ c13~110@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul a13~106@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2283@ temp_13_1~2348@))) (=> (= temp_13_0~2283@ temp_13_1~2348@) (=> (= temp_14_0~2437@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@)) (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul b14~116@ b14~116@) (Sub c14~118@ a14~114@)) (Mul (Add b14~116@ a14~114@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2502@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@)) (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul b14~116@ b14~116@) (Sub c14~118@ a14~114@)) (Mul (Mul c14~118@ d14~120@) (Add b14~116@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2437@ temp_14_1~2502@))) (=> (= temp_14_0~2437@ temp_14_1~2502@) (=> (= temp_15_0~2587@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ a15~122@)) (Mul (Mul d15~128@ c15~126@) (Add d15~128@ a15~122@))) (Mul (Mul (Mul a15~122@ d15~128@) (Add d15~128@ a15~122@)) (Mul (Mul b15~124@ c15~126@) d15~128@)))) (=> (= temp_15_1~2648@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ a15~122@)) (Mul (Mul d15~128@ c15~126@) (Add d15~128@ a15~122@))) (Mul (Mul (Add d15~128@ a15~122@) (Mul a15~122@ d15~128@)) (Mul (Mul b15~124@ c15~126@) d15~128@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2587@ temp_15_1~2648@))) (=> (= temp_15_0~2587@ temp_15_1~2648@) (=> (= temp_16_0~2709@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ c16~134@))) d16~136@)) (=> (= temp_16_1~2746@ (Mul (Mul (Mul (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ d16~136@)) (Mul d16~136@ d16~136@)) (Mul d16~136@ c16~134@)) d16~136@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2709@ temp_16_1~2746@))) (=> (= temp_16_0~2709@ temp_16_1~2746@) (=> (= temp_17_0~2847@ (Sub (Mul (Mul (Mul c17~142@ c17~142@) (Mul b17~140@ d17~144@)) (Add (Mul d17~144@ d17~144@) (Mul b17~140@ 74))) (Mul (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ a17~138@)) (Add (Mul d17~144@ a17~138@) (Add c17~142@ b17~140@))))) (=> (= temp_17_1~2924@ (Sub (Mul (Mul (Mul b17~140@ d17~144@) (Mul c17~142@ c17~142@)) (Add (Mul d17~144@ d17~144@) (Mul b17~140@ 74))) (Mul (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ a17~138@)) (Add (Mul d17~144@ a17~138@) (Add c17~142@ b17~140@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2847@ temp_17_1~2924@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
