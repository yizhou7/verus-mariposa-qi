...
(set-info :comment ";; mariposa_data/v_nl//14090101086157970305/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_10_0~2019@ Int)
(declare-const temp_10_1~2072@ Int)
(declare-const temp_11_0~2183@ Int)
(declare-const temp_11_1~2256@ Int)
(declare-const temp_12_0~2367@ Int)
(declare-const temp_12_1~2428@ Int)
(declare-const temp_13_0~2529@ Int)
(declare-const temp_13_1~2594@ Int)
(declare-const temp_14_0~2687@ Int)
(declare-const temp_14_1~2752@ Int)
(declare-const temp_15_0~2849@ Int)
(declare-const temp_15_1~2910@ Int)
(declare-const temp_16_0~2983@ Int)
(declare-const temp_16_1~3020@ Int)
(declare-const temp_17_0~3147@ Int)
(declare-const temp_17_1~3224@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Add c0~6@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ c0~6@))) (Add (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Add c0~6@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ c0~6@))) (Add (Mul d0~8@ (Mul c0~6@ (Sub c0~6@ d0~8@))) (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ a0~2@))))) (and (=> (= tmp%1@ (Sub c0~6@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d0~8@ c0~6@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~469@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub a1~10@ a1~10@)) (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~534@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub a1~10@ a1~10@)) (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ c1~14@) (=> %%location_label%%1 (= temp_1_0~469@ temp_1_1~534@))) (=> (= temp_1_0~469@ temp_1_1~534@) (=> (= temp_2_0~627@ (Add (Mul (Add (Add 27 d2~24@) (Add b2~20@ a2~18@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))) (Mul a2~18@ (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@))))) (=> (= temp_2_1~692@ (Add (Mul (Add (Add 27 d2~24@) (Add b2~20@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ c2~22@))) (Mul a2~18@ (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@))))) (and (=> (= tmp%2@ (Mul a2~18@ c2~22@)) (=> (= tmp%3@ (Mul b2~20@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~627@ temp_2_1~692@))))) (=> (= temp_2_0~627@ temp_2_1~692@) (=> (= temp_3_0~777@ (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ (Mul a3~26@ c3~30@))) (Mul (Sub (Mul d3~32@ a3~26@) (Sub b3~28@ a3~26@)) (Add (Sub a3~26@ c3~30@) b3~28@)))) (=> (= temp_3_1~826@ (Mul (Mul (Mul d3~32@ b3~28@) (Mul (Mul a3~26@ c3~30@) c3~30@)) (Mul (Sub (Mul d3~32@ a3~26@) (Sub b3~28@ a3~26@)) (Add (Sub a3~26@ c3~30@) b3~28@)))) (and (=> (= tmp%4@ (Mul a3~26@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~777@ temp_3_1~826@)))) (=> (= temp_3_0~777@ temp_3_1~826@) (=> (= temp_4_0~923@ (Mul (Mul (Sub (Add a4~34@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~988@ (Mul (Mul (Sub (Add a4~34@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))))) (and (=> (= tmp%5@ (Mul c4~38@ b4~36@)) (=> (= tmp%6@ (Mul a4~34@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~923@ temp_4_1~988@))))) (=> (= temp_4_0~923@ temp_4_1~988@) (=> (= temp_5_0~1085@ (Mul (Add (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Add c5~46@ a5~42@) (Mul d5~48@ b5~44@)) (Mul c5~46@ (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1146@ (Mul (Add (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ b5~44@))) (Mul (Mul (Add c5~46@ a5~42@) (Mul d5~48@ b5~44@)) (Mul c5~46@ (Mul b5~44@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1085@ temp_5_1~1146@))) (=> (= temp_5_0~1085@ temp_5_1~1146@) (=> (= temp_6_0~1251@ (Mul (Mul (Add (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@)) (Sub (Mul b6~52@ b6~52@) (Sub 88 c6~54@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1328@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ b6~52@))) (Mul (Add (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@)) (Sub (Mul b6~52@ b6~52@) (Sub 88 c6~54@))))) (and (=> (= tmp%7@ (Mul (Add (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@)) (Sub (Mul b6~52@ b6~52@) (Sub 88 c6~54@)))) (=> (= tmp%8@ (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ b6~52@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~1251@ temp_6_1~1328@))))) (=> (= temp_6_0~1251@ temp_6_1~1328@) (=> (= temp_7_0~1489@ (Mul (Add (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1554@ (Mul (Add (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1489@ temp_7_1~1554@))) (=> (= temp_7_0~1489@ temp_7_1~1554@) (=> (= temp_8_0~1647@ (Mul (Add (Add (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1744@ (Add (Mul (Add (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@)) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ a8~66@)))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ a8~66@)))))) (and (=> (= tmp%9@ (Add (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@))) (=> (= tmp%10@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ b8~68@))) (=> (= tmp%11@ (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ a8~66@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~1647@ temp_8_1~1744@)))))) (=> (= temp_8_0~1647@ temp_8_1~1744@) (=> (= temp_9_0~1879@ (Mul (Mul (Mul (Add d9~80@ a9~74@) (Mul a9~74@ c9~78@)) c9~78@) (Mul (Add (Mul c9~78@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Sub c9~78@ a9~74@) (Mul c9~78@ b9~76@))))) (=> (= temp_9_1~1932@ (Mul (Mul (Mul (Mul (Add d9~80@ a9~74@) a9~74@) c9~78@) c9~78@) (Mul (Add (Mul c9~78@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Sub c9~78@ a9~74@) (Mul c9~78@ b9~76@))))) (and (=> (= tmp%12@ (Add d9~80@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ a9~74@ c9~78@) (=> %%location_label%%9 (= temp_9_0~1879@ temp_9_1~1932@)))) (=> (= temp_9_0~1879@ temp_9_1~1932@) (=> (= temp_10_0~2019@ (Sub (Add (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ c10~86@))) (Mul (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ a10~82@)) c10~86@))) (=> (= temp_10_1~2072@ (Sub (Add (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ c10~86@))) (Mul (Mul a10~82@ c10~86@) (Mul (Mul a10~82@ a10~82@) c10~86@)))) (and (=> (= tmp%13@ (Mul a10~82@ c10~86@)) (=> (= tmp%14@ (Mul a10~82@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ c10~86@) (=> %%location_label%%10 (= temp_10_0~2019@ temp_10_1~2072@))))) (=> (= temp_10_0~2019@ temp_10_1~2072@) (=> (= temp_11_0~2183@ (Mul (Mul (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ a11~90@))) (Sub (Mul (Mul a11~90@ 9) (Mul d11~96@ d11~96@)) (Mul (Mul d11~96@ c11~94@) d11~96@)))) (=> (= temp_11_1~2256@ (Mul (Mul (Mul c11~94@ b11~92@) (Mul (Mul b11~92@ a11~90@) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ a11~90@)))) (Sub (Mul (Mul a11~90@ 9) (Mul d11~96@ d11~96@)) (Mul (Mul d11~96@ c11~94@) d11~96@)))) (and (=> (= tmp%15@ (Mul c11~94@ b11~92@)) (=> (= tmp%16@ (Mul b11~92@ a11~90@)) (=> (= tmp%17@ (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ a11~90@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%11 (= temp_11_0~2183@ temp_11_1~2256@)))))) (=> (= temp_11_0~2183@ temp_11_1~2256@) (=> (= temp_12_0~2367@ (Mul (Add (Mul (Add d12~104@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ a12~98@) b12~100@)) (Mul (Mul (Mul d12~104@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ d12~104@))))) (=> (= temp_12_1~2428@ (Mul (Add (Mul (Add d12~104@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ a12~98@) b12~100@)) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ d12~104@))))) (and (=> (= tmp%18@ (Mul d12~104@ a12~98@)) (=> (= tmp%19@ (Mul c12~102@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%12 (= temp_12_0~2367@ temp_12_1~2428@))))) (=> (= temp_12_0~2367@ temp_12_1~2428@) (=> (= temp_13_0~2529@ (Mul (Mul (Mul (Sub a13~106@ d13~112@) (Mul c13~110@ a13~106@)) (Mul (Mul d13~112@ c13~110@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul a13~106@ d13~112@))))) (=> (= temp_13_1~2594@ (Mul (Mul (Mul (Sub a13~106@ d13~112@) (Mul c13~110@ a13~106@)) (Mul (Mul d13~112@ c13~110@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul a13~106@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d13~112@ d13~112@) (=> %%location_label%%13 (= temp_13_0~2529@ temp_13_1~2594@))) (=> (= temp_13_0~2529@ temp_13_1~2594@) (=> (= temp_14_0~2687@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@)) (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul b14~116@ b14~116@) (Sub c14~118@ a14~114@)) (Mul (Add b14~116@ a14~114@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2752@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@)) (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul b14~116@ b14~116@) (Sub c14~118@ a14~114@)) (Mul (Mul c14~118@ d14~120@) (Add b14~116@ a14~114@))))) (and (=> (= tmp%20@ (Add b14~116@ a14~114@)) (=> (= tmp%21@ (Mul c14~118@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%14 (= temp_14_0~2687@ temp_14_1~2752@))))) (=> (= temp_14_0~2687@ temp_14_1~2752@) (=> (= temp_15_0~2849@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ a15~122@)) (Mul (Mul d15~128@ c15~126@) (Add d15~128@ a15~122@))) (Mul (Mul (Mul a15~122@ d15~128@) (Add d15~128@ a15~122@)) (Mul (Mul b15~124@ c15~126@) d15~128@)))) (=> (= temp_15_1~2910@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ a15~122@)) (Mul (Mul d15~128@ c15~126@) (Add d15~128@ a15~122@))) (Mul (Mul (Add d15~128@ a15~122@) (Mul a15~122@ d15~128@)) (Mul (Mul b15~124@ c15~126@) d15~128@)))) (and (=> (= tmp%22@ (Mul a15~122@ d15~128@)) (=> (= tmp%23@ (Add d15~128@ a15~122@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%15 (= temp_15_0~2849@ temp_15_1~2910@))))) (=> (= temp_15_0~2849@ temp_15_1~2910@) (=> (= temp_16_0~2983@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ c16~134@))) d16~136@)) (=> (= temp_16_1~3020@ (Mul (Mul (Mul (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ d16~136@)) (Mul d16~136@ d16~136@)) (Mul d16~136@ c16~134@)) d16~136@)) (and (=> (= tmp%24@ (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ d16~136@))) (=> (= tmp%25@ (Mul d16~136@ d16~136@)) (=> (= tmp%26@ (Mul d16~136@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%16 (= temp_16_0~2983@ temp_16_1~3020@)))))) (=> (= temp_16_0~2983@ temp_16_1~3020@) (=> (= temp_17_0~3147@ (Sub (Mul (Mul (Mul c17~142@ c17~142@) (Mul b17~140@ d17~144@)) (Add (Mul d17~144@ d17~144@) (Mul b17~140@ 74))) (Mul (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ a17~138@)) (Add (Mul d17~144@ a17~138@) (Add c17~142@ b17~140@))))) (=> (= temp_17_1~3224@ (Sub (Mul (Mul (Mul b17~140@ d17~144@) (Mul c17~142@ c17~142@)) (Add (Mul d17~144@ d17~144@) (Mul b17~140@ 74))) (Mul (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ a17~138@)) (Add (Mul d17~144@ a17~138@) (Add c17~142@ b17~140@))))) (=> (= tmp%27@ (Mul c17~142@ c17~142@)) (=> (= tmp%28@ (Mul b17~140@ d17~144@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%17 (= temp_17_0~3147@ temp_17_1~3224@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
