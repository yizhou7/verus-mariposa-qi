...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Add b0~4@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Add d0~8@ c0~6@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Add d0~8@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Add b0~4@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Add d0~8@ c0~6@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@)) (Mul c0~6@ (Mul c0~6@ (Add d0~8@ d0~8@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~459@ (Mul (Mul (Mul (Sub b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Add a1~10@ c1~14@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~532@ (Mul (Mul (Mul (Sub b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)) (Add (Mul a1~10@ (Mul c1~14@ b1~12@)) (Mul c1~14@ (Mul c1~14@ b1~12@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~459@ temp_1_1~532@))) (=> (= temp_1_0~459@ temp_1_1~532@) (=> (= temp_2_0~593@ (Sub (Sub (Mul (Mul d2~24@ c2~22@) (Add c2~22@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ a2~18@))) a2~18@)) (=> (= temp_2_1~630@ (Sub (Sub (Mul d2~24@ (Mul c2~22@ (Add c2~22@ b2~20@))) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ a2~18@))) a2~18@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~593@ temp_2_1~630@))) (=> (= temp_2_0~593@ temp_2_1~630@) (=> (= temp_3_0~719@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Add d3~32@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~784@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Add d3~32@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~719@ temp_3_1~784@))) (=> (= temp_3_0~719@ temp_3_1~784@) (=> (= temp_4_0~869@ (Mul (Mul (Add (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) d4~40@)))) (=> (= temp_4_1~930@ (Mul (Mul (Add (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) d4~40@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~869@ temp_4_1~930@))) (=> (= temp_4_0~869@ temp_4_1~930@) (=> (= temp_5_0~1031@ (Mul (Mul (Mul (Mul c5~46@ 25) (Mul b5~44@ d5~48@)) (Add (Mul b5~44@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Add d5~48@ a5~42@) (Sub d5~48@ d5~48@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1136@ (Mul (Add (Mul (Mul (Mul c5~46@ 25) (Mul b5~44@ d5~48@)) (Mul b5~44@ c5~46@)) (Mul (Mul (Mul c5~46@ 25) (Mul b5~44@ d5~48@)) (Mul c5~46@ b5~44@))) (Mul (Mul (Add d5~48@ a5~42@) (Sub d5~48@ d5~48@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1031@ temp_5_1~1136@))) (=> (= temp_5_0~1031@ temp_5_1~1136@) (=> (= temp_6_0~1237@ (Mul (Mul (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul 59 b6~52@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1314@ (Mul (Mul (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul 59 b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1237@ temp_6_1~1314@))) (=> (= temp_6_0~1237@ temp_6_1~1314@) (=> (= temp_7_0~1407@ (Mul (Mul (Mul (Add d7~64@ d7~64@) (Mul b7~60@ 52)) (Mul (Mul a7~58@ a7~58@) b7~60@)) (Mul (Sub (Mul c7~62@ b7~60@) b7~60@) (Add (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1476@ (Mul (Mul (Mul (Mul b7~60@ 52) (Add d7~64@ d7~64@)) (Mul (Mul a7~58@ a7~58@) b7~60@)) (Mul (Sub (Mul c7~62@ b7~60@) b7~60@) (Add (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1407@ temp_7_1~1476@))) (=> (= temp_7_0~1407@ temp_7_1~1476@) (=> (= temp_8_0~1577@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ c8~70@) (Sub c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ 22) (Mul c8~70@ c8~70@)) (Mul (Sub d8~72@ a8~66@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1654@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ c8~70@) (Sub c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ 22) (Mul c8~70@ c8~70@)) (Mul (Sub d8~72@ a8~66@) (Mul a8~66@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1577@ temp_8_1~1654@))) (=> (= temp_8_0~1577@ temp_8_1~1654@) (=> (= temp_9_0~1743@ (Mul (Mul (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~1808@ (Mul (Mul (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ a9~74@))) (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1743@ temp_9_1~1808@))) (=> (= temp_9_0~1743@ temp_9_1~1808@) (=> (= temp_10_0~1897@ (Mul (Mul (Add (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@)) (Mul (Mul d10~88@ c10~86@) (Sub a10~82@ d10~88@))) (Mul (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ a10~82@)) (Add (Mul b10~84@ c10~86@) (Mul b10~84@ c10~86@))))) (=> (= temp_10_1~1962@ (Mul (Mul (Add (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@)) (Mul (Mul d10~88@ c10~86@) (Sub a10~82@ d10~88@))) (Mul (Mul (Mul d10~88@ a10~82@) (Mul c10~86@ c10~86@)) (Add (Mul b10~84@ c10~86@) (Mul b10~84@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1897@ temp_10_1~1962@))) (=> (= temp_10_0~1897@ temp_10_1~1962@) (=> (= temp_11_0~2039@ (Sub (Mul (Mul (Mul b11~92@ a11~90@) (Mul c11~94@ d11~96@)) a11~90@) (Mul (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2092@ (Sub (Mul (Mul (Mul b11~92@ a11~90@) (Mul c11~94@ d11~96@)) a11~90@) (Mul (Mul (Mul (Mul b11~92@ b11~92@) a11~90@) c11~94@) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2039@ temp_11_1~2092@))) (=> (= temp_11_0~2039@ temp_11_1~2092@) (=> (= temp_12_0~2193@ (Mul (Mul (Mul (Add d12~104@ b12~100@) (Mul a12~98@ c12~102@)) (Add (Sub d12~104@ c12~102@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul d12~104@ 69) (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2270@ (Mul (Mul (Mul (Add d12~104@ b12~100@) (Mul a12~98@ c12~102@)) (Add (Sub d12~104@ c12~102@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul d12~104@ 69) (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ d12~104@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2193@ temp_12_1~2270@))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
