...
(set-info :comment ";; mariposa_data/v_nl//8577837602559263134/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_4_1~964@ Int)
(declare-const temp_5_0~1069@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Add b0~4@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Add d0~8@ c0~6@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Add d0~8@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Add b0~4@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Add d0~8@ c0~6@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@)) (Mul c0~6@ (Mul c0~6@ (Add d0~8@ d0~8@)))))) (and (=> (= tmp%1@ (Add d0~8@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c0~6@ c0~6@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~469@ (Mul (Mul (Mul (Sub b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Add a1~10@ c1~14@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~542@ (Mul (Mul (Mul (Sub b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)) (Add (Mul a1~10@ (Mul c1~14@ b1~12@)) (Mul c1~14@ (Mul c1~14@ b1~12@)))))) (and (=> (= tmp%2@ (Mul c1~14@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a1~10@ c1~14@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~469@ temp_1_1~542@)))) (=> (= temp_1_0~469@ temp_1_1~542@) (=> (= temp_2_0~613@ (Sub (Sub (Mul (Mul d2~24@ c2~22@) (Add c2~22@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ a2~18@))) a2~18@)) (=> (= temp_2_1~650@ (Sub (Sub (Mul d2~24@ (Mul c2~22@ (Add c2~22@ b2~20@))) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ a2~18@))) a2~18@)) (and (=> (= tmp%3@ (Add c2~22@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d2~24@ c2~22@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~613@ temp_2_1~650@)))) (=> (= temp_2_0~613@ temp_2_1~650@) (=> (= temp_3_0~749@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Add d3~32@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~814@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Add d3~32@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ a3~26@) (=> %%location_label%%3 (= temp_3_0~749@ temp_3_1~814@))) (=> (= temp_3_0~749@ temp_3_1~814@) (=> (= temp_4_0~903@ (Mul (Mul (Add (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) d4~40@)))) (=> (= temp_4_1~964@ (Mul (Mul (Add (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) d4~40@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c4~38@ a4~34@) (=> %%location_label%%4 (= temp_4_0~903@ temp_4_1~964@))) (=> (= temp_4_0~903@ temp_4_1~964@) (=> (= temp_5_0~1069@ (Mul (Mul (Mul (Mul c5~46@ 25) (Mul b5~44@ d5~48@)) (Add (Mul b5~44@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Add d5~48@ a5~42@) (Sub d5~48@ d5~48@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1174@ (Mul (Add (Mul (Mul (Mul c5~46@ 25) (Mul b5~44@ d5~48@)) (Mul b5~44@ c5~46@)) (Mul (Mul (Mul c5~46@ 25) (Mul b5~44@ d5~48@)) (Mul c5~46@ b5~44@))) (Mul (Mul (Add d5~48@ a5~42@) (Sub d5~48@ d5~48@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))))) (and (=> (= tmp%4@ (Mul (Mul c5~46@ 25) (Mul b5~44@ d5~48@))) (=> (= tmp%5@ (Mul b5~44@ c5~46@)) (=> (= tmp%6@ (Mul c5~46@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~1069@ temp_5_1~1174@)))))) (=> (= temp_5_0~1069@ temp_5_1~1174@) (=> (= temp_6_0~1313@ (Mul (Mul (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul 59 b6~52@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1390@ (Mul (Mul (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul 59 b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))))) (and (=> (= tmp%7@ (Mul b6~52@ c6~54@)) (=> (= tmp%8@ (Mul 59 b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~1313@ temp_6_1~1390@))))) (=> (= temp_6_0~1313@ temp_6_1~1390@) (=> (= temp_7_0~1507@ (Mul (Mul (Mul (Add d7~64@ d7~64@) (Mul b7~60@ 52)) (Mul (Mul a7~58@ a7~58@) b7~60@)) (Mul (Sub (Mul c7~62@ b7~60@) b7~60@) (Add (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1576@ (Mul (Mul (Mul (Mul b7~60@ 52) (Add d7~64@ d7~64@)) (Mul (Mul a7~58@ a7~58@) b7~60@)) (Mul (Sub (Mul c7~62@ b7~60@) b7~60@) (Add (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@))))) (and (=> (= tmp%9@ (Add d7~64@ d7~64@)) (=> (= tmp%10@ (Mul b7~60@ 52)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~1507@ temp_7_1~1576@))))) (=> (= temp_7_0~1507@ temp_7_1~1576@) (=> (= temp_8_0~1701@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ c8~70@) (Sub c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ 22) (Mul c8~70@ c8~70@)) (Mul (Sub d8~72@ a8~66@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1778@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ c8~70@) (Sub c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ 22) (Mul c8~70@ c8~70@)) (Mul (Sub d8~72@ a8~66@) (Mul a8~66@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ c8~70@) (=> %%location_label%%8 (= temp_8_0~1701@ temp_8_1~1778@))) (=> (= temp_8_0~1701@ temp_8_1~1778@) (=> (= temp_9_0~1871@ (Mul (Mul (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~1936@ (Mul (Mul (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ a9~74@))) (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a9~74@ d9~80@) (=> %%location_label%%9 (= temp_9_0~1871@ temp_9_1~1936@))) (=> (= temp_9_0~1871@ temp_9_1~1936@) (=> (= temp_10_0~2029@ (Mul (Mul (Add (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@)) (Mul (Mul d10~88@ c10~86@) (Sub a10~82@ d10~88@))) (Mul (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ a10~82@)) (Add (Mul b10~84@ c10~86@) (Mul b10~84@ c10~86@))))) (=> (= temp_10_1~2094@ (Mul (Mul (Add (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@)) (Mul (Mul d10~88@ c10~86@) (Sub a10~82@ d10~88@))) (Mul (Mul (Mul d10~88@ a10~82@) (Mul c10~86@ c10~86@)) (Add (Mul b10~84@ c10~86@) (Mul b10~84@ c10~86@))))) (and (=> (= tmp%11@ (Mul c10~86@ c10~86@)) (=> (= tmp%12@ (Mul d10~88@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%10 (= temp_10_0~2029@ temp_10_1~2094@))))) (=> (= temp_10_0~2029@ temp_10_1~2094@) (=> (= temp_11_0~2183@ (Sub (Mul (Mul (Mul b11~92@ a11~90@) (Mul c11~94@ d11~96@)) a11~90@) (Mul (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2236@ (Sub (Mul (Mul (Mul b11~92@ a11~90@) (Mul c11~94@ d11~96@)) a11~90@) (Mul (Mul (Mul (Mul b11~92@ b11~92@) a11~90@) c11~94@) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))))) (and (=> (= tmp%13@ (Mul b11~92@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ a11~90@ c11~94@) (=> %%location_label%%11 (= temp_11_0~2183@ temp_11_1~2236@)))) (=> (= temp_11_0~2183@ temp_11_1~2236@) (=> (= temp_12_0~2347@ (Mul (Mul (Mul (Add d12~104@ b12~100@) (Mul a12~98@ c12~102@)) (Add (Sub d12~104@ c12~102@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul d12~104@ 69) (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2424@ (Mul (Mul (Mul (Add d12~104@ b12~100@) (Mul a12~98@ c12~102@)) (Add (Sub d12~104@ c12~102@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul d12~104@ 69) (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ d12~104@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d12~104@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2347@ temp_12_1~2424@))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
