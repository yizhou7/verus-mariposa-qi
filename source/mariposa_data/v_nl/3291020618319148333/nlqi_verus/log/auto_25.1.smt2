...
(assert (=> %%query%% (not (=> (= temp_0_0~285@ (Sub (Mul (Sub (Mul c0~6@ d0~8@) (Mul c0~6@ c0~6@)) b0~4@) (Mul (Mul (Add c0~6@ a0~2@) (Mul a0~2@ c0~6@)) (Add b0~4@ d0~8@)))) (=> (= temp_0_1~326@ (Sub (Mul (Mul c0~6@ (Sub d0~8@ c0~6@)) b0~4@) (Mul (Mul (Add c0~6@ a0~2@) (Mul a0~2@ c0~6@)) (Add b0~4@ d0~8@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~285@ temp_0_1~326@))) (=> (= temp_0_0~285@ temp_0_1~326@) (=> (= temp_1_0~415@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Add b1~12@ b1~12@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ c1~14@)) (Add (Add d1~16@ b1~12@) (Mul b1~12@ b1~12@))))) (=> (= temp_1_1~480@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Add b1~12@ b1~12@))) (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ c1~14@)) (Add (Add d1~16@ b1~12@) (Mul b1~12@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~415@ temp_1_1~480@))) (=> (= temp_1_0~415@ temp_1_1~480@) (=> (= temp_2_0~561@ (Mul (Mul (Add d2~24@ (Mul a2~18@ d2~24@)) (Sub (Add d2~24@ d2~24@) (Sub b2~20@ b2~20@))) (Mul (Mul (Add b2~20@ d2~24@) (Add b2~20@ b2~20@)) (Mul (Mul b2~20@ c2~22@) a2~18@)))) (=> (= temp_2_1~618@ (Mul (Mul (Add d2~24@ (Mul a2~18@ d2~24@)) (Sub (Add d2~24@ d2~24@) (Sub b2~20@ b2~20@))) (Mul (Mul (Add b2~20@ b2~20@) (Add b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) a2~18@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~561@ temp_2_1~618@))) (=> (= temp_2_0~561@ temp_2_1~618@) (=> (= temp_3_0~707@ (Mul (Sub (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Add d3~32@ a3~26@))) (Mul (Mul (Mul b3~28@ a3~26@) (Add d3~32@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Add c3~30@ d3~32@))))) (=> (= temp_3_1~772@ (Mul (Sub (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Add d3~32@ a3~26@))) (Mul (Mul (Mul b3~28@ a3~26@) (Add d3~32@ d3~32@)) (Mul (Add c3~30@ d3~32@) (Mul b3~28@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~707@ temp_3_1~772@))) (=> (= temp_3_0~707@ temp_3_1~772@) (=> (= temp_4_0~869@ (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Add (Mul 29 a4~34@) (Mul b4~36@ d4~40@)) (Mul b4~36@ (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~942@ (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Mul b4~36@ (Mul a4~34@ c4~38@)) (Add (Mul 29 a4~34@) (Mul b4~36@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~869@ temp_4_1~942@))) (=> (= temp_4_0~869@ temp_4_1~942@) (=> (= temp_5_0~1031@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ d5~48@)) (Add (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Add (Mul d5~48@ b5~44@) (Mul d5~48@ a5~42@)) (Add (Add d5~48@ c5~46@) (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1112@ (Mul (Add (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ d5~48@)) (Mul c5~46@ a5~42@)) (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ d5~48@)) (Mul b5~44@ a5~42@))) (Mul (Add (Mul d5~48@ b5~44@) (Mul d5~48@ a5~42@)) (Add (Add d5~48@ c5~46@) (Mul c5~46@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1031@ temp_5_1~1112@))) (=> (= temp_5_0~1031@ temp_5_1~1112@) (=> (= temp_6_0~1201@ (Mul (Sub (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@)) (Sub (Mul d6~56@ c6~54@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul b6~52@ a6~50@)) (Sub (Mul b6~52@ a6~50@) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1266@ (Mul (Sub (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ c6~54@)) (Sub (Mul d6~56@ c6~54@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul b6~52@ a6~50@)) (Sub (Mul b6~52@ a6~50@) (Mul d6~56@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1201@ temp_6_1~1266@))) (=> (= temp_6_0~1201@ temp_6_1~1266@) (=> (= temp_7_0~1355@ (Sub (Sub (Mul (Mul c7~62@ d7~64@) (Sub a7~58@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@))) (Mul (Mul (Sub d7~64@ d7~64@) (Mul b7~60@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Sub b7~60@ b7~60@))))) (=> (= temp_7_1~1420@ (Sub (Sub (Mul (Mul c7~62@ d7~64@) (Sub a7~58@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@))) (Mul (Mul (Sub d7~64@ d7~64@) (Mul b7~60@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Sub b7~60@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1355@ temp_7_1~1420@))) (=> (= temp_7_0~1355@ temp_7_1~1420@) (=> (= temp_8_0~1501@ (Sub (Mul (Mul d8~72@ (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ a8~66@))) (Mul (Add b8~68@ (Sub c8~70@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1558@ (Sub (Mul (Mul d8~72@ (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ a8~66@))) (Mul (Mul (Add b8~68@ (Sub c8~70@ d8~72@)) (Mul d8~72@ d8~72@)) (Mul c8~70@ d8~72@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1501@ temp_8_1~1558@))) (=> (= temp_8_0~1501@ temp_8_1~1558@) (=> (= temp_9_0~1639@ (Mul (Sub (Mul (Mul b9~76@ d9~80@) d9~80@) (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ b9~76@))) (Mul (Mul (Mul c9~78@ c9~78@) d9~80@) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1724@ (Sub (Mul (Mul (Mul b9~76@ d9~80@) d9~80@) (Mul (Mul (Mul c9~78@ c9~78@) d9~80@) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ d9~80@)))) (Mul (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Mul (Mul c9~78@ c9~78@) d9~80@) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ d9~80@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1639@ temp_9_1~1724@))) (=> (= temp_9_0~1639@ temp_9_1~1724@) (=> (= temp_10_0~1809@ (Mul (Mul (Mul (Mul b10~84@ a10~82@) a10~82@) (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ b10~84@))) (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ a10~82@)) (Sub (Sub c10~86@ a10~82@) (Mul a10~82@ b10~84@))))) (=> (= temp_10_1~1870@ (Mul (Mul (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul b10~84@ a10~82@) a10~82@)) (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ a10~82@)) (Sub (Sub c10~86@ a10~82@) (Mul a10~82@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1809@ temp_10_1~1870@))) (=> (= temp_10_0~1809@ temp_10_1~1870@) (=> (= temp_11_0~1959@ (Mul (Add (Mul (Sub d11~96@ b11~92@) (Mul d11~96@ a11~90@)) (Mul (Sub b11~92@ d11~96@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ b11~92@))))) (=> (= temp_11_1~2024@ (Mul (Add (Mul (Sub d11~96@ b11~92@) (Mul d11~96@ a11~90@)) (Mul (Sub b11~92@ d11~96@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ b11~92@) (Mul b11~92@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1959@ temp_11_1~2024@))) (=> (= temp_11_0~1959@ temp_11_1~2024@) (=> (= temp_12_0~2121@ (Add (Mul (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ 3)) (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ c12~102@))) (Add (Add (Mul d12~104@ d12~104@) (Mul c12~102@ b12~100@)) (Mul (Mul a12~98@ b12~100@) b12~100@)))) (=> (= temp_12_1~2194@ (Add (Mul (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ 3)) (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ c12~102@))) (Add (Add (Mul d12~104@ d12~104@) (Mul c12~102@ b12~100@)) (Mul (Mul a12~98@ b12~100@) b12~100@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2121@ temp_12_1~2194@))) (=> (= temp_12_0~2121@ temp_12_1~2194@) (=> (= temp_13_0~2283@ (Mul (Sub (Sub (Mul d13~112@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ a13~106@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul d13~112@ c13~110@)) (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ a13~106@))))) (=> (= temp_13_1~2348@ (Mul (Sub (Sub (Mul d13~112@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ a13~106@))) (Mul (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Mul d13~112@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2283@ temp_13_1~2348@))) (=> (= temp_13_0~2283@ temp_13_1~2348@) (=> (= temp_14_0~2461@ (Sub (Sub (Mul (Mul b14~116@ d14~120@) (Mul d14~120@ d14~120@)) (Mul (Mul a14~114@ a14~114@) (Mul 92 59))) (Mul (Add (Mul d14~120@ c14~118@) (Mul b14~116@ c14~118@)) (Sub (Sub a14~114@ d14~120@) (Mul d14~120@ b14~116@))))) (=> (= temp_14_1~2550@ (Sub (Sub (Mul (Mul b14~116@ d14~120@) (Mul d14~120@ d14~120@)) (Mul (Mul a14~114@ a14~114@) (Mul 59 92))) (Mul (Add (Mul d14~120@ c14~118@) (Mul b14~116@ c14~118@)) (Sub (Sub a14~114@ d14~120@) (Mul d14~120@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2461@ temp_14_1~2550@))) (=> (= temp_14_0~2461@ temp_14_1~2550@) (=> (= temp_15_0~2635@ (Mul (Sub (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ d15~128@)) (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ a15~122@))) (Sub (Mul (Mul c15~126@ a15~122@) (Mul d15~128@ a15~122@)) (Mul (Mul c15~126@ d15~128@) d15~128@)))) (=> (= temp_15_1~2696@ (Mul (Sub (Mul (Mul (Mul c15~126@ c15~126@) d15~128@) d15~128@) (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ a15~122@))) (Sub (Mul (Mul c15~126@ a15~122@) (Mul d15~128@ a15~122@)) (Mul (Mul c15~126@ d15~128@) d15~128@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2635@ temp_15_1~2696@))) (=> (= temp_15_0~2635@ temp_15_1~2696@) (=> (= temp_16_0~2785@ (Mul (Sub (Sub (Mul a16~130@ b16~132@) (Sub c16~134@ b16~132@)) (Mul (Mul a16~130@ c16~134@) (Sub b16~132@ a16~130@))) (Mul (Sub (Mul b16~132@ b16~132@) (Mul d16~136@ b16~132@)) (Mul (Mul a16~130@ d16~136@) (Sub b16~132@ d16~136@))))) (=> (= temp_16_1~2866@ (Mul (Sub (Sub (Mul a16~130@ b16~132@) (Sub c16~134@ b16~132@)) (Mul (Mul a16~130@ c16~134@) (Sub b16~132@ a16~130@))) (Sub (Mul (Mul b16~132@ b16~132@) (Mul (Mul a16~130@ d16~136@) (Sub b16~132@ d16~136@))) (Mul (Mul d16~136@ b16~132@) (Mul (Mul a16~130@ d16~136@) (Sub b16~132@ d16~136@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2785@ temp_16_1~2866@))) (=> (= temp_16_0~2785@ temp_16_1~2866@) (=> (= temp_17_0~2955@ (Mul (Sub (Mul (Mul c17~142@ d17~144@) (Mul c17~142@ c17~142@)) (Mul (Mul a17~138@ d17~144@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ c17~142@)) (Sub (Mul c17~142@ d17~144@) (Mul b17~140@ d17~144@))))) (=> (= temp_17_1~3020@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ c17~142@)) (Sub (Mul c17~142@ d17~144@) (Mul b17~140@ d17~144@))) (Sub (Mul (Mul c17~142@ d17~144@) (Mul c17~142@ c17~142@)) (Mul (Mul a17~138@ d17~144@) (Mul b17~140@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2955@ temp_17_1~3020@))) (=> (= temp_17_0~2955@ temp_17_1~3020@) (=> (= temp_18_0~3093@ (Mul a18~146@ (Mul (Mul (Mul b18~148@ a18~146@) (Mul 86 c18~150@)) (Mul (Mul c18~150@ d18~152@) (Mul a18~146@ c18~150@))))) (=> (= temp_18_1~3142@ (Mul a18~146@ (Mul (Mul (Mul b18~148@ a18~146@) (Mul 86 c18~150@)) (Mul (Mul c18~150@ d18~152@) (Mul c18~150@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3093@ temp_18_1~3142@))) (=> (= temp_18_0~3093@ temp_18_1~3142@) (=> (= temp_19_0~3219@ (Sub (Mul b19~156@ (Mul (Mul a19~154@ d19~160@) (Mul b19~156@ a19~154@))) (Mul (Mul (Mul b19~156@ b19~156@) (Sub c19~158@ c19~158@)) (Sub (Add a19~154@ d19~160@) (Mul b19~156@ d19~160@))))) (=> (= temp_19_1~3280@ (Sub (Mul b19~156@ (Mul (Mul a19~154@ d19~160@) (Mul b19~156@ a19~154@))) (Mul (Sub (Mul (Mul b19~156@ b19~156@) c19~158@) (Mul (Mul b19~156@ b19~156@) c19~158@)) (Sub (Add a19~154@ d19~160@) (Mul b19~156@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3219@ temp_19_1~3280@))) (=> (= temp_19_0~3219@ temp_19_1~3280@) (=> (= temp_20_0~3365@ (Sub (Mul (Sub (Sub d20~168@ d20~168@) (Sub d20~168@ c20~166@)) (Mul (Mul b20~164@ b20~164@) (Mul d20~168@ c20~166@))) (Mul (Mul a20~162@ (Mul b20~164@ a20~162@)) (Mul (Mul c20~166@ a20~162@) (Mul d20~168@ c20~166@))))) (=> (= temp_20_1~3426@ (Sub (Mul (Sub (Sub d20~168@ d20~168@) (Sub d20~168@ c20~166@)) (Mul (Mul b20~164@ b20~164@) (Mul d20~168@ c20~166@))) (Mul (Mul (Mul b20~164@ a20~162@) a20~162@) (Mul (Mul c20~166@ a20~162@) (Mul d20~168@ c20~166@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3365@ temp_20_1~3426@))) (=> (= temp_20_0~3365@ temp_20_1~3426@) (=> (= temp_21_0~3515@ (Sub (Mul (Mul (Mul d21~176@ c21~174@) (Mul a21~170@ b21~172@)) (Mul (Mul a21~170@ c21~174@) (Mul b21~172@ d21~176@))) (Add (Mul (Mul a21~170@ d21~176@) (Add d21~176@ b21~172@)) (Mul (Mul b21~172@ d21~176@) (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~3580@ (Sub (Mul (Mul (Mul d21~176@ c21~174@) (Mul a21~170@ b21~172@)) (Mul (Mul a21~170@ c21~174@) (Mul b21~172@ d21~176@))) (Add (Mul (Mul a21~170@ d21~176@) (Add d21~176@ b21~172@)) (Mul (Mul d21~176@ b21~172@) (Mul a21~170@ b21~172@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3515@ temp_21_1~3580@))) (=> (= temp_21_0~3515@ temp_21_1~3580@) (=> (= temp_22_0~3661@ (Mul (Mul (Mul (Mul c22~182@ a22~178@) c22~182@) (Add (Mul d22~184@ b22~180@) (Mul b22~180@ c22~182@))) (Mul (Mul c22~182@ (Mul b22~180@ a22~178@)) (Add (Sub d22~184@ d22~184@) (Add d22~184@ c22~182@))))) (=> (= temp_22_1~3718@ (Mul (Mul (Mul (Mul c22~182@ a22~178@) c22~182@) (Add (Mul b22~180@ d22~184@) (Mul b22~180@ c22~182@))) (Mul (Mul c22~182@ (Mul b22~180@ a22~178@)) (Add (Sub d22~184@ d22~184@) (Add d22~184@ c22~182@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3661@ temp_22_1~3718@))) (=> (= temp_22_0~3661@ temp_22_1~3718@) (=> (= temp_23_0~3803@ (Mul (Mul (Mul (Sub c23~190@ d23~192@) (Add c23~190@ d23~192@)) (Mul b23~188@ (Mul c23~190@ c23~190@))) (Mul (Mul (Mul a23~186@ a23~186@) (Add b23~188@ d23~192@)) (Add (Mul b23~188@ b23~188@) (Mul b23~188@ a23~186@))))) (=> (= temp_23_1~3864@ (Mul (Mul (Mul (Sub c23~190@ d23~192@) (Add c23~190@ d23~192@)) (Mul b23~188@ (Mul c23~190@ c23~190@))) (Mul (Mul (Mul a23~186@ a23~186@) (Add b23~188@ d23~192@)) (Add (Mul b23~188@ b23~188@) (Mul b23~188@ a23~186@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3803@ temp_23_1~3864@))) (=> (= temp_23_0~3803@ temp_23_1~3864@) (=> (= temp_24_0~3949@ (Mul (Mul (Mul (Mul a24~194@ a24~194@) (Sub d24~200@ a24~194@)) (Mul (Mul a24~194@ b24~196@) a24~194@)) (Mul (Mul (Mul b24~196@ d24~200@) (Mul d24~200@ c24~198@)) (Mul (Mul b24~196@ c24~198@) (Mul c24~198@ a24~194@))))) (=> (= temp_24_1~4010@ (Mul (Mul (Mul (Mul a24~194@ a24~194@) (Sub d24~200@ a24~194@)) (Mul (Mul b24~196@ a24~194@) a24~194@)) (Mul (Mul (Mul b24~196@ d24~200@) (Mul d24~200@ c24~198@)) (Mul (Mul b24~196@ c24~198@) (Mul c24~198@ a24~194@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3949@ temp_24_1~4010@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
