...
(set-info :comment ";; mariposa_data/v_nl//1675701205702059556/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_2_0~685@ Int)
...
(declare-const temp_7_1~1538@ Int)
(declare-const temp_8_0~1631@ Int)
(declare-const temp_8_1~1692@ Int)
(declare-const temp_9_0~1811@ Int)
(declare-const temp_9_1~1852@ Int)
(declare-const temp_10_0~1947@ Int)
(declare-const temp_10_1~2008@ Int)
(declare-const temp_11_0~2093@ Int)
(declare-const temp_11_1~2150@ Int)
(declare-const temp_12_0~2271@ Int)
(declare-const temp_12_1~2348@ Int)
(declare-const temp_13_0~2429@ Int)
(declare-const temp_13_1~2482@ Int)
(declare-const temp_14_0~2579@ Int)
(declare-const temp_14_1~2648@ Int)
(declare-const temp_15_0~2777@ Int)
(declare-const temp_15_1~2842@ Int)
(declare-const temp_16_0~2943@ Int)
(declare-const temp_16_1~3008@ Int)
(declare-const temp_17_0~3113@ Int)
(declare-const temp_17_1~3182@ Int)
(declare-const temp_18_0~3271@ Int)
(declare-const temp_18_1~3324@ Int)
(declare-const temp_19_0~3425@ Int)
(declare-const temp_19_1~3498@ Int)
(declare-const temp_20_0~3655@ Int)
(declare-const temp_20_1~3720@ Int)
(declare-const temp_21_0~3825@ Int)
(declare-const temp_21_1~3946@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~309@ (Sub (Mul (Mul (Mul b0~4@ b0~4@) d0~8@) (Sub (Add c0~6@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Add d0~8@ b0~4@) (Mul a0~2@ b0~4@)) (Add d0~8@ (Mul c0~6@ 86))))) (=> (= temp_0_1~378@ (Sub (Mul (Mul d0~8@ (Mul b0~4@ b0~4@)) (Sub (Add c0~6@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Add d0~8@ b0~4@) (Mul a0~2@ b0~4@)) (Add d0~8@ (Mul c0~6@ 86))))) (and (=> (= tmp%1@ (Mul b0~4@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ d0~8@) (=> %%location_label%%0 (= temp_0_0~309@ temp_0_1~378@)))) (=> (= temp_0_0~309@ temp_0_1~378@) (=> (= temp_1_0~475@ (Mul (Mul a1~10@ (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Sub b1~12@ 24) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~540@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Sub b1~12@ 24) (Mul b1~12@ a1~10@))) (Mul a1~10@ (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ b1~12@))))) (and (=> (= tmp%2@ (Mul a1~10@ (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ b1~12@)))) (=> (= tmp%3@ (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Sub b1~12@ 24) (Mul b1~12@ a1~10@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~475@ temp_1_1~540@))))) (=> (= temp_1_0~475@ temp_1_1~540@) (=> (= temp_2_0~685@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ b2~20@))) (Mul (Sub (Mul b2~20@ c2~22@) a2~18@) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~746@ (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ b2~20@)) (Mul (Sub (Mul b2~20@ c2~22@) a2~18@) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ a2~18@)))))) (and (=> (= tmp%4@ (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@))) (=> (= tmp%5@ (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ b2~20@))) (=> (= tmp%6@ (Mul (Sub (Mul b2~20@ c2~22@) a2~18@) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ a2~18@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%2 (= temp_2_0~685@ temp_2_1~746@)))))) (=> (= temp_2_0~685@ temp_2_1~746@) (=> (= temp_3_0~877@ (Sub (Mul (Sub (Mul d3~32@ c3~30@) (Sub b3~28@ b3~28@)) b3~28@) (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~930@ (Sub (Mul (Sub (Mul d3~32@ c3~30@) (Sub b3~28@ b3~28@)) b3~28@) (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ d3~32@) (=> %%location_label%%3 (= temp_3_0~877@ temp_3_1~930@))) (=> (= temp_3_0~877@ temp_3_1~930@) (=> (= temp_4_0~1011@ (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ c4~38@)) (Add (Mul b4~36@ b4~36@) (Add d4~40@ b4~36@))) (Mul d4~40@ (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~1064@ (Mul (Mul (Mul (Mul (Mul a4~34@ d4~40@) c4~38@) c4~38@) (Add (Mul b4~36@ b4~36@) (Add d4~40@ b4~36@))) (Mul d4~40@ (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@))))) (and (=> (= tmp%7@ (Mul a4~34@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ c4~38@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1011@ temp_4_1~1064@)))) (=> (= temp_4_0~1011@ temp_4_1~1064@) (=> (= temp_5_0~1151@ (Mul (Mul c5~46@ (Sub (Mul a5~42@ a5~42@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ d5~48@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1204@ (Mul (Mul c5~46@ (Sub (Mul a5~42@ a5~42@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@)) (Mul b5~44@ (Mul d5~48@ (Mul b5~44@ a5~42@)))))) (and (=> (= tmp%8@ (Mul b5~44@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b5~44@ d5~48@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~1151@ temp_5_1~1204@)))) (=> (= temp_5_0~1151@ temp_5_1~1204@) (=> (= temp_6_0~1299@ (Mul (Sub (Mul (Mul c6~54@ a6~50@) (Add a6~50@ a6~50@)) (Mul (Mul c6~54@ c6~54@) d6~56@)) (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ d6~56@)) (Sub (Mul d6~56@ d6~56@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1360@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ d6~56@)) (Sub (Mul d6~56@ d6~56@) (Mul b6~52@ d6~56@))) (Sub (Mul (Mul c6~54@ a6~50@) (Add a6~50@ a6~50@)) (Mul (Mul c6~54@ c6~54@) d6~56@)))) (and (=> (= tmp%9@ (Sub (Mul (Mul c6~54@ a6~50@) (Add a6~50@ a6~50@)) (Mul (Mul c6~54@ c6~54@) d6~56@))) (=> (= tmp%10@ (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ d6~56@)) (Sub (Mul d6~56@ d6~56@) (Mul b6~52@ d6~56@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~1299@ temp_6_1~1360@))))) (=> (= temp_6_0~1299@ temp_6_1~1360@) (=> (= temp_7_0~1489@ (Mul (Mul (Mul d7~64@ (Sub a7~58@ a7~58@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ d7~64@)) a7~58@))) (=> (= temp_7_1~1538@ (Mul (Mul (Mul (Sub a7~58@ a7~58@) d7~64@) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ d7~64@)) a7~58@))) (and (=> (= tmp%11@ (Sub a7~58@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ tmp%11@) (=> %%location_label%%7 (= temp_7_0~1489@ temp_7_1~1538@)))) (=> (= temp_7_0~1489@ temp_7_1~1538@) (=> (= temp_8_0~1631@ (Mul (Mul (Mul a8~66@ (Mul d8~72@ b8~68@)) (Mul (Mul b8~68@ c8~70@) (Sub d8~72@ c8~70@))) (Sub (Add (Mul d8~72@ a8~66@) (Sub c8~70@ b8~68@)) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ b8~68@))))) (=> (= temp_8_1~1692@ (Mul (Mul a8~66@ (Mul d8~72@ b8~68@)) (Mul (Mul (Mul b8~68@ c8~70@) (Sub d8~72@ c8~70@)) (Sub (Add (Mul d8~72@ a8~66@) (Sub c8~70@ b8~68@)) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ b8~68@)))))) (and (=> (= tmp%12@ (Mul a8~66@ (Mul d8~72@ b8~68@))) (=> (= tmp%13@ (Mul (Mul b8~68@ c8~70@) (Sub d8~72@ c8~70@))) (=> (= tmp%14@ (Sub (Add (Mul d8~72@ a8~66@) (Sub c8~70@ b8~68@)) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ b8~68@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%8 (= temp_8_0~1631@ temp_8_1~1692@)))))) (=> (= temp_8_0~1631@ temp_8_1~1692@) (=> (= temp_9_0~1811@ (Mul (Mul a9~74@ (Mul (Mul a9~74@ d9~80@) (Mul d9~80@ d9~80@))) (Mul a9~74@ (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~1852@ (Mul (Mul a9~74@ (Mul a9~74@ (Mul d9~80@ (Mul d9~80@ d9~80@)))) (Mul a9~74@ (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ a9~74@))))) (and (=> (= tmp%15@ (Mul d9~80@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a9~74@ d9~80@ tmp%15@) (=> %%location_label%%9 (= temp_9_0~1811@ temp_9_1~1852@)))) (=> (= temp_9_0~1811@ temp_9_1~1852@) (=> (= temp_10_0~1947@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ d10~88@)) (Mul (Mul c10~86@ d10~88@) (Add d10~88@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ c10~86@)) (Mul (Mul b10~84@ c10~86@) d10~88@)))) (=> (= temp_10_1~2008@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul c10~86@ d10~88@) (Add d10~88@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ c10~86@)) (Mul (Mul b10~84@ c10~86@) d10~88@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ d10~88@) (=> %%location_label%%10 (= temp_10_0~1947@ temp_10_1~2008@))) (=> (= temp_10_0~1947@ temp_10_1~2008@) (=> (= temp_11_0~2093@ (Mul (Mul (Mul (Mul d11~96@ d11~96@) a11~90@) (Mul a11~90@ (Mul b11~92@ a11~90@))) (Mul (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ b11~92@)) (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~2150@ (Mul (Mul (Mul a11~90@ (Mul b11~92@ a11~90@)) (Mul (Mul d11~96@ d11~96@) a11~90@)) (Mul (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ b11~92@)) (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ a11~90@))))) (and (=> (= tmp%16@ (Mul (Mul d11~96@ d11~96@) a11~90@)) (=> (= tmp%17@ (Mul a11~90@ (Mul b11~92@ a11~90@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%11 (= temp_11_0~2093@ temp_11_1~2150@))))) (=> (= temp_11_0~2093@ temp_11_1~2150@) (=> (= temp_12_0~2271@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ 42))) (Mul (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Mul b12~100@ c12~102@) (Sub c12~102@ c12~102@))))) (=> (= temp_12_1~2348@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ 42))) (Mul (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Mul b12~100@ c12~102@) (Sub c12~102@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d12~104@ c12~102@) (=> %%location_label%%12 (= temp_12_0~2271@ temp_12_1~2348@))) (=> (= temp_12_0~2271@ temp_12_1~2348@) (=> (= temp_13_0~2429@ (Mul (Mul (Add (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (Sub (Mul a13~106@ a13~106@) d13~112@)) (Mul (Mul b13~108@ (Mul a13~106@ d13~112@)) (Mul a13~106@ (Sub a13~106@ a13~106@))))) (=> (= temp_13_1~2482@ (Mul (Mul (Add (Mul a13~106@ b13~108@) (Mul c13~110@ c13~110@)) (Sub (Mul a13~106@ a13~106@) d13~112@)) (Mul (Mul b13~108@ (Mul a13~106@ d13~112@)) (Mul a13~106@ (Sub a13~106@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b13~108@ a13~106@) (=> %%location_label%%13 (= temp_13_0~2429@ temp_13_1~2482@))) (=> (= temp_13_0~2429@ temp_13_1~2482@) (=> (= temp_14_0~2579@ (Mul (Sub (Mul (Mul d14~120@ a14~114@) c14~118@) (Mul (Mul d14~120@ a14~114@) d14~120@)) (Mul (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ 15)) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@))))) (=> (= temp_14_1~2648@ (Mul (Sub (Mul (Mul d14~120@ a14~114@) c14~118@) (Mul (Mul d14~120@ a14~114@) d14~120@)) (Mul (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ 15))))) (and (=> (= tmp%18@ (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ 15))) (=> (= tmp%19@ (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%14 (= temp_14_0~2579@ temp_14_1~2648@))))) (=> (= temp_14_0~2579@ temp_14_1~2648@) (=> (= temp_15_0~2777@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ b15~124@)) (Mul (Add a15~122@ a15~122@) (Mul d15~128@ b15~124@))) (Mul (Mul (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~2842@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ b15~124@)) (Mul (Add a15~122@ a15~122@) (Mul d15~128@ b15~124@))) (Mul (Mul (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@)) (Mul (Mul a15~122@ d15~128@) (Mul d15~128@ a15~122@))))) (and (=> (= tmp%20@ (Mul d15~128@ a15~122@)) (=> (= tmp%21@ (Mul a15~122@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%15 (= temp_15_0~2777@ temp_15_1~2842@))))) (=> (= temp_15_0~2777@ temp_15_1~2842@) (=> (= temp_16_0~2943@ (Mul (Mul (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ c16~134@)) (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ c16~134@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ b16~132@)) (Mul (Add c16~134@ c16~134@) (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~3008@ (Mul (Mul (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ c16~134@)) (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ b16~132@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ b16~132@)) (Mul (Add c16~134@ c16~134@) (Mul a16~130@ d16~136@))))) (and (=> (= tmp%22@ (Mul a16~130@ b16~132@)) (=> (= tmp%23@ (Mul a16~130@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%16 (= temp_16_0~2943@ temp_16_1~3008@))))) (=> (= temp_16_0~2943@ temp_16_1~3008@) (=> (= temp_17_0~3113@ (Mul (Mul (Mul (Mul c17~142@ b17~140@) (Add a17~138@ b17~140@)) (Mul b17~140@ (Mul 8 b17~140@))) (Sub (Mul (Add d17~144@ b17~140@) b17~140@) (Mul (Add d17~144@ b17~140@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~3182@ (Mul (Mul (Mul (Mul c17~142@ b17~140@) (Add a17~138@ b17~140@)) (Mul b17~140@ (Mul 8 b17~140@))) (Sub (Mul (Add d17~144@ b17~140@) b17~140@) (Mul (Mul c17~142@ c17~142@) (Add d17~144@ b17~140@))))) (and (=> (= tmp%24@ (Add d17~144@ b17~140@)) (=> (= tmp%25@ (Mul c17~142@ c17~142@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%24@ tmp%25@) (=> %%location_label%%17 (= temp_17_0~3113@ temp_17_1~3182@))))) (=> (= temp_17_0~3113@ temp_17_1~3182@) (=> (= temp_18_0~3271@ (Sub (Mul (Mul (Mul a18~146@ d18~152@) (Mul c18~150@ b18~148@)) (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ c18~150@))) (Mul (Mul (Mul b18~148@ d18~152@) (Mul a18~146@ d18~152@)) d18~152@))) (=> (= temp_18_1~3324@ (Sub (Mul (Mul (Mul a18~146@ d18~152@) (Mul c18~150@ b18~148@)) (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ c18~150@))) (Mul (Mul (Mul b18~148@ d18~152@) (Mul a18~146@ d18~152@)) d18~152@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b18~148@ c18~150@) (=> %%location_label%%18 (= temp_18_0~3271@ temp_18_1~3324@))) (=> (= temp_18_0~3271@ temp_18_1~3324@) (=> (= temp_19_0~3425@ (Mul (Mul (Add (Sub c19~158@ c19~158@) (Add d19~160@ a19~154@)) (Sub d19~160@ (Mul a19~154@ a19~154@))) (Mul (Mul (Mul 57 b19~156@) (Sub a19~154@ b19~156@)) (Sub (Mul a19~154@ b19~156@) (Mul d19~160@ d19~160@))))) (=> (= temp_19_1~3498@ (Mul (Mul (Mul (Mul 57 b19~156@) (Sub a19~154@ b19~156@)) (Sub (Mul a19~154@ b19~156@) (Mul d19~160@ d19~160@))) (Mul (Add (Sub c19~158@ c19~158@) (Add d19~160@ a19~154@)) (Sub d19~160@ (Mul a19~154@ a19~154@))))) (and (=> (= tmp%26@ (Mul (Add (Sub c19~158@ c19~158@) (Add d19~160@ a19~154@)) (Sub d19~160@ (Mul a19~154@ a19~154@)))) (=> (= tmp%27@ (Mul (Mul (Mul 57 b19~156@) (Sub a19~154@ b19~156@)) (Sub (Mul a19~154@ b19~156@) (Mul d19~160@ d19~160@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%26@ tmp%27@) (=> %%location_label%%19 (= temp_19_0~3425@ temp_19_1~3498@))))) (=> (= temp_19_0~3425@ temp_19_1~3498@) (=> (= temp_20_0~3655@ (Add (Mul (Sub (Mul d20~168@ c20~166@) (Add b20~164@ c20~166@)) (Mul (Mul d20~168@ c20~166@) (Mul b20~164@ c20~166@))) (Mul (Mul (Mul d20~168@ a20~162@) (Mul a20~162@ d20~168@)) (Mul (Mul a20~162@ b20~164@) (Mul a20~162@ a20~162@))))) (=> (= temp_20_1~3720@ (Add (Mul (Sub (Mul c20~166@ d20~168@) (Add b20~164@ c20~166@)) (Mul (Mul d20~168@ c20~166@) (Mul b20~164@ c20~166@))) (Mul (Mul (Mul d20~168@ a20~162@) (Mul a20~162@ d20~168@)) (Mul (Mul a20~162@ b20~164@) (Mul a20~162@ a20~162@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d20~168@ c20~166@) (=> %%location_label%%20 (= temp_20_0~3655@ temp_20_1~3720@))) (=> (= temp_20_0~3655@ temp_20_1~3720@) (=> (= temp_21_0~3825@ (Mul (Sub (Mul (Add a21~170@ a21~170@) (Mul a21~170@ b21~172@)) (Mul (Mul a21~170@ d21~176@) (Mul d21~176@ c21~174@))) (Mul (Mul (Mul c21~174@ d21~176@) (Mul a21~170@ b21~172@)) (Mul (Mul 13 a21~170@) (Sub c21~174@ a21~170@))))) (=> (= temp_21_1~3946@ (Sub (Mul (Mul (Add a21~170@ a21~170@) (Mul a21~170@ b21~172@)) (Mul (Mul (Mul c21~174@ d21~176@) (Mul a21~170@ b21~172@)) (Mul (Mul 13 a21~170@) (Sub c21~174@ a21~170@)))) (Mul (Mul (Mul a21~170@ d21~176@) (Mul d21~176@ c21~174@)) (Mul (Mul (Mul c21~174@ d21~176@) (Mul a21~170@ b21~172@)) (Mul (Mul 13 a21~170@) (Sub c21~174@ a21~170@)))))) (=> (= tmp%28@ (Mul (Add a21~170@ a21~170@) (Mul a21~170@ b21~172@))) (=> (= tmp%29@ (Mul (Mul a21~170@ d21~176@) (Mul d21~176@ c21~174@))) (=> (= tmp%30@ (Mul (Mul (Mul c21~174@ d21~176@) (Mul a21~170@ b21~172@)) (Mul (Mul 13 a21~170@) (Sub c21~174@ a21~170@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%21 (= temp_21_0~3825@ temp_21_1~3946@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
