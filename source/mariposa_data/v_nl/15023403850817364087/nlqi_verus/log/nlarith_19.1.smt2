...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Sub d0~8@ d0~8@)) (Sub (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))) (Sub (Sub a0~2@ (Mul d0~8@ a0~2@)) (Sub (Mul b0~4@ d0~8@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Sub d0~8@ d0~8@)) (Sub (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))) (Sub (Sub a0~2@ (Mul d0~8@ a0~2@)) (Sub (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~454@ (Mul (Mul (Mul (Add d1~16@ c1~14@) (Mul 27 a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul d1~16@ d1~16@) (Sub c1~14@ c1~14@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~531@ (Mul (Mul (Mul (Add d1~16@ c1~14@) (Mul 27 a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ d1~16@) (Sub c1~14@ c1~14@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~454@ temp_1_1~531@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~599@ (Mul (Mul (Mul (Mul c2~22@ c2~22@) d2~24@) (Mul d2~24@ (Mul a2~18@ d2~24@))) (Add (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) (Add (Sub b2~20@ c2~22@) d2~24@)))) (=> (= temp_2_1~652@ (Mul (Mul (Mul d2~24@ (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ c2~22@) d2~24@)) (Add (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) (Add (Sub b2~20@ c2~22@) d2~24@)))) (=> (= tmp%3@ (= temp_2_0~599@ temp_2_1~652@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~732@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ b3~28@))))) (=> (= temp_3_1~797@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~732@ temp_3_1~797@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~877@ (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Sub b4~36@ b4~36@)) (Mul (Add c4~38@ b4~36@) (Sub c4~38@ a4~34@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~942@ (Mul (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Sub b4~36@ b4~36@)) (Add c4~38@ b4~36@)) (Sub c4~38@ a4~34@)) (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~877@ temp_4_1~942@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1034@ (Mul (Mul (Sub (Sub d5~48@ c5~46@) (Mul b5~44@ 97)) (Add (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul b5~44@ a5~42@) (Add d5~48@ a5~42@)) (Add (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1111@ (Mul (Mul (Sub (Sub d5~48@ c5~46@) (Mul 97 b5~44@)) (Add (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul b5~44@ a5~42@) (Add d5~48@ a5~42@)) (Add (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1034@ temp_5_1~1111@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1191@ (Add (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ a6~50@))) (Mul (Mul (Sub d6~56@ c6~54@) (Add b6~52@ d6~56@)) (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1256@ (Add (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ a6~50@))) (Mul (Sub d6~56@ c6~54@) (Mul (Add b6~52@ d6~56@) (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ c6~54@)))))) (=> (= tmp%7@ (= temp_6_0~1191@ temp_6_1~1256@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1328@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul b7~60@ c7~62@) b7~60@) (Mul (Mul c7~62@ c7~62@) d7~64@)))) (=> (= temp_7_1~1385@ (Mul (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@))) (Mul (Mul b7~60@ c7~62@) b7~60@)) (Mul (Mul c7~62@ c7~62@) d7~64@))) (=> (= tmp%8@ (= temp_7_0~1328@ temp_7_1~1385@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1465@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Sub a8~66@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1530@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) (Sub a8~66@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1465@ temp_8_1~1530@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1618@ (Mul (Mul (Mul (Sub a9~74@ d9~80@) (Add d9~80@ d9~80@)) (Sub a9~74@ (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ a9~74@) (Mul 52 a9~74@)) (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~1699@ (Mul (Mul (Sub (Mul a9~74@ (Add d9~80@ d9~80@)) (Mul d9~80@ (Add d9~80@ d9~80@))) (Sub a9~74@ (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ a9~74@) (Mul 52 a9~74@)) (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1618@ temp_9_1~1699@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1779@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ c10~86@))))) (=> (= temp_10_1~1844@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1779@ temp_10_1~1844@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1936@ (Mul (Mul (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ b11~92@))) (Mul (Add (Mul a11~90@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul b11~92@ 17) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~2013@ (Mul (Mul (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ b11~92@))) (Mul (Add (Mul a11~90@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul b11~92@ 17) (Mul d11~96@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1936@ temp_11_1~2013@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2081@ (Sub (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ c12~102@)) (Sub (Mul d12~104@ a12~98@) (Mul a12~98@ d12~104@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) b12~100@))) (=> (= temp_12_1~2134@ (Sub (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ c12~102@)) (Sub (Mul d12~104@ a12~98@) (Mul a12~98@ d12~104@))) (Mul (Mul b12~100@ (Mul d12~104@ (Mul c12~102@ b12~100@))) b12~100@))) (=> (= tmp%13@ (= temp_12_0~2081@ temp_12_1~2134@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2226@ (Mul (Add (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ c13~110@)) (Mul (Mul b13~108@ b13~108@) (Mul 23 b13~108@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ c13~110@)) (Mul (Mul d13~112@ a13~106@) (Add b13~108@ b13~108@))))) (=> (= temp_13_1~2303@ (Mul (Add (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ c13~110@)) (Mul (Mul b13~108@ b13~108@) (Mul 23 b13~108@))) (Mul (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@)) (Mul (Mul d13~112@ a13~106@) (Add b13~108@ b13~108@))))) (=> (= tmp%14@ (= temp_13_0~2226@ temp_13_1~2303@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2395@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ b14~116@)) (Mul (Mul 22 c14~118@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul c14~118@ a14~114@)) (Mul (Mul a14~114@ b14~116@) (Mul d14~120@ d14~120@))))) (=> (= temp_14_1~2472@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ b14~116@)) (Mul (Mul 22 c14~118@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul c14~118@ a14~114@)) (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@))))) (=> (= tmp%15@ (= temp_14_0~2395@ temp_14_1~2472@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2548@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ a15~122@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ b15~124@))) (Mul (Mul (Mul a15~122@ d15~128@) (Sub c15~126@ b15~124@)) (Add (Mul a15~122@ d15~128@) d15~128@)))) (=> (= temp_15_1~2617@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ a15~122@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ b15~124@))) (Mul (Sub (Mul (Mul a15~122@ d15~128@) c15~126@) (Mul (Mul a15~122@ d15~128@) b15~124@)) (Add (Mul a15~122@ d15~128@) d15~128@)))) (=> (= tmp%16@ (= temp_15_0~2548@ temp_15_1~2617@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2697@ (Sub (Mul (Mul (Mul d16~136@ a16~130@) (Mul a16~130@ c16~134@)) (Mul (Mul c16~134@ a16~130@) (Mul b16~132@ b16~132@))) (Add (Mul (Mul c16~134@ c16~134@) (Mul d16~136@ c16~134@)) (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~2762@ (Sub (Mul (Mul (Mul d16~136@ a16~130@) (Mul a16~130@ c16~134@)) (Mul (Mul c16~134@ a16~130@) (Mul b16~132@ b16~132@))) (Add (Mul (Mul c16~134@ c16~134@) (Mul d16~136@ c16~134@)) (Mul (Mul a16~130@ d16~136@) (Mul d16~136@ d16~136@))))) (=> (= tmp%17@ (= temp_16_0~2697@ temp_16_1~2762@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2842@ (Add (Mul (Mul (Mul c17~142@ a17~138@) (Mul b17~140@ a17~138@)) (Mul (Mul b17~140@ b17~140@) (Add a17~138@ c17~142@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@)) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ a17~138@))))) (=> (= temp_17_1~2907@ (Add (Mul (Mul (Mul c17~142@ a17~138@) (Mul b17~140@ a17~138@)) (Mul (Mul b17~140@ b17~140@) (Add a17~138@ c17~142@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ a17~138@))))) (=> (= tmp%18@ (= temp_17_0~2842@ temp_17_1~2907@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2987@ (Mul (Mul (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ a18~146@)) (Mul (Mul b18~148@ c18~150@) (Add c18~150@ c18~150@))) (Mul (Sub (Mul a18~146@ c18~150@) (Mul a18~146@ b18~148@)) (Mul (Mul a18~146@ a18~146@) (Mul b18~148@ a18~146@))))) (=> (= temp_18_1~3052@ (Mul (Mul (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ a18~146@)) (Mul (Mul b18~148@ c18~150@) (Add c18~150@ c18~150@))) (Mul (Sub (Mul c18~150@ a18~146@) (Mul a18~146@ b18~148@)) (Mul (Mul a18~146@ a18~146@) (Mul b18~148@ a18~146@))))) (=> (= tmp%19@ (= temp_18_0~2987@ temp_18_1~3052@)) (=> %%location_label%%18 tmp%19@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
