...
(declare-const temp_2_0~835@ Int)
(declare-const temp_2_1~972@ Int)
(declare-const temp_3_0~1088@ Int)
(declare-const temp_3_1~1189@ Int)
(declare-const temp_4_0~1329@ Int)
(declare-const temp_4_1~1454@ Int)
(declare-const temp_5_0~1598@ Int)
(declare-const temp_5_1~1727@ Int)
(declare-const temp_6_0~1855@ Int)
(declare-const temp_6_1~1968@ Int)
(declare-const temp_7_0~2088@ Int)
(declare-const temp_7_1~2193@ Int)
(declare-const temp_8_0~2277@ Int)
(declare-const temp_8_1~2354@ Int)
(declare-const temp_9_0~2490@ Int)
(declare-const temp_9_1~2611@ Int)
(declare-const temp_10_0~2739@ Int)
(declare-const temp_10_1~2852@ Int)
(declare-const temp_11_0~2984@ Int)
(declare-const temp_11_1~3101@ Int)
(declare-const temp_12_0~3241@ Int)
(declare-const temp_12_1~3366@ Int)
(declare-const temp_13_0~3490@ Int)
(declare-const temp_13_1~3599@ Int)
(declare-const temp_14_0~3759@ Int)
(declare-const temp_14_1~3904@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Sub (Mul (Add (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@))) (Add (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)))) (Sub (Mul (Sub (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@)) (Mul d0~8@ (Sub 88 d0~8@))) (Mul (Sub (Mul b0~4@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Sub a0~2@ b0~4@) (Add b0~4@ d0~8@)))))) (=> (= temp_0_1~434@ (Sub (Mul (Add (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@))) (Add (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)))) (Sub (Mul (Mul d0~8@ (Sub 88 d0~8@)) (Sub (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@))) (Mul (Sub (Mul b0~4@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Sub a0~2@ b0~4@) (Add b0~4@ d0~8@)))))) (=> (= tmp%1@ (= temp_0_0~297@ temp_0_1~434@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~570@ (Mul (Mul (Mul (Mul (Add a1~10@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul 2 c1~14@) (Mul b1~12@ a1~10@))) (Sub (Mul (Mul b1~12@ b1~12@) a1~10@) a1~10@)) (Mul (Mul (Mul (Mul a1~10@ a1~10@) b1~12@) (Mul (Mul c1~14@ d1~16@) (Sub a1~10@ a1~10@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@)) (Sub (Mul d1~16@ c1~14@) (Mul d1~16@ a1~10@)))))) (=> (= temp_1_1~691@ (Mul (Mul (Mul (Mul (Add a1~10@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul 2 c1~14@) (Mul b1~12@ a1~10@))) (Sub (Mul (Mul b1~12@ b1~12@) a1~10@) a1~10@)) (Mul (Mul (Mul (Mul a1~10@ a1~10@) b1~12@) (Mul (Mul c1~14@ d1~16@) (Sub a1~10@ a1~10@))) (Mul (Sub (Mul d1~16@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@)))))) (=> (= tmp%2@ (= temp_1_0~570@ temp_1_1~691@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~835@ (Mul (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Sub c2~22@ d2~24@) (Sub c2~22@ d2~24@)))) (Sub (Mul (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Add b2~20@ b2~20@)))))) (=> (= temp_2_1~972@ (Mul (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ a2~18@)) (Sub (Mul (Sub c2~22@ d2~24@) c2~22@) (Mul (Sub c2~22@ d2~24@) d2~24@)))) (Sub (Mul (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Add b2~20@ b2~20@)))))) (=> (= tmp%3@ (= temp_2_0~835@ temp_2_1~972@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1088@ (Mul (Add (Sub (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul c3~30@ c3~30@) (Sub a3~26@ d3~32@)) (Mul (Add b3~28@ b3~28@) (Mul a3~26@ a3~26@)))) (Mul c3~30@ (Sub (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Add b3~28@ c3~30@)))))) (=> (= temp_3_1~1189@ (Mul (Add (Sub (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul c3~30@ c3~30@) (Sub a3~26@ d3~32@)) (Mul (Mul (Add b3~28@ b3~28@) a3~26@) a3~26@))) (Mul c3~30@ (Sub (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Add b3~28@ c3~30@)))))) (=> (= tmp%4@ (= temp_3_0~1088@ temp_3_1~1189@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1329@ (Mul (Sub (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul c4~38@ c4~38@) b4~36@)) (Mul (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ a4~34@)) c4~38@)) (Add (Add (Mul (Mul a4~34@ 50) (Mul b4~36@ b4~36@)) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ c4~38@))) (Sub (Mul (Add c4~38@ d4~40@) (Mul a4~34@ c4~38@)) (Add (Sub d4~40@ c4~38@) (Mul c4~38@ d4~40@)))))) (=> (= temp_4_1~1454@ (Mul (Sub (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul c4~38@ c4~38@) b4~36@)) (Mul (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ a4~34@)) c4~38@)) (Add (Add (Mul (Mul a4~34@ 50) (Mul b4~36@ b4~36@)) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ c4~38@))) (Sub (Mul (Add c4~38@ d4~40@) (Mul c4~38@ a4~34@)) (Add (Sub d4~40@ c4~38@) (Mul c4~38@ d4~40@)))))) (=> (= tmp%5@ (= temp_4_0~1329@ temp_4_1~1454@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1598@ (Mul (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@)))) (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Add c5~46@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Add d5~48@ a5~42@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@)))))) (=> (= temp_5_1~1727@ (Mul (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@)))) (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Add c5~46@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Add d5~48@ a5~42@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@)))))) (=> (= tmp%6@ (= temp_5_0~1598@ temp_5_1~1727@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1855@ (Mul (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ d6~56@)) (Sub c6~54@ (Mul d6~56@ d6~56@))) (Add (Mul b6~52@ (Mul a6~50@ d6~56@)) (Mul (Add b6~52@ d6~56@) (Mul d6~56@ c6~54@)))) (Mul (Mul (Mul (Sub d6~56@ d6~56@) c6~54@) (Mul c6~54@ (Mul a6~50@ d6~56@))) (Mul (Mul (Add d6~56@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ d6~56@)))))) (=> (= temp_6_1~1968@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul (Mul b6~52@ d6~56@) (Sub c6~54@ (Mul d6~56@ d6~56@)))) (Add (Mul b6~52@ (Mul a6~50@ d6~56@)) (Mul (Add b6~52@ d6~56@) (Mul d6~56@ c6~54@)))) (Mul (Mul (Mul (Sub d6~56@ d6~56@) c6~54@) (Mul c6~54@ (Mul a6~50@ d6~56@))) (Mul (Mul (Add d6~56@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ d6~56@)))))) (=> (= tmp%7@ (= temp_6_0~1855@ temp_6_1~1968@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2088@ (Mul (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@)) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ b7~60@))) (Sub (Add (Mul a7~58@ b7~60@) d7~64@) (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ d7~64@)))) (Mul (Mul (Add (Sub b7~60@ b7~60@) (Mul c7~62@ a7~58@)) (Mul (Mul a7~58@ b7~60@) d7~64@)) (Mul b7~60@ (Sub a7~58@ (Mul c7~62@ d7~64@)))))) (=> (= temp_7_1~2193@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@)) (Mul (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ b7~60@)) (Sub (Add (Mul a7~58@ b7~60@) d7~64@) (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ d7~64@))))) (Mul (Mul (Add (Sub b7~60@ b7~60@) (Mul c7~62@ a7~58@)) (Mul (Mul a7~58@ b7~60@) d7~64@)) (Mul b7~60@ (Sub a7~58@ (Mul c7~62@ d7~64@)))))) (=> (= tmp%8@ (= temp_7_0~2088@ temp_7_1~2193@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2277@ (Mul b8~68@ (Mul (Add (Add (Mul a8~66@ b8~68@) (Mul a8~66@ b8~68@)) (Mul (Sub b8~68@ c8~70@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ b8~68@)))))) (=> (= temp_8_1~2354@ (Mul b8~68@ (Mul (Add (Add (Mul a8~66@ b8~68@) (Mul a8~66@ b8~68@)) (Sub (Mul b8~68@ (Mul d8~72@ d8~72@)) (Mul c8~70@ (Mul d8~72@ d8~72@)))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ b8~68@)))))) (=> (= tmp%9@ (= temp_8_0~2277@ temp_8_1~2354@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2490@ (Add (Mul (Add (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul a9~74@ a9~74@))) (Sub (Mul (Add a9~74@ c9~78@) a9~74@) (Mul (Mul b9~76@ c9~78@) (Add b9~76@ a9~74@)))) (Mul (Mul (Add (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Add b9~76@ b9~76@) (Add b9~76@ a9~74@))) (Mul (Add (Mul d9~80@ d9~80@) b9~76@) (Mul (Mul d9~80@ b9~76@) (Mul b9~76@ d9~80@)))))) (=> (= temp_9_1~2611@ (Add (Mul (Add (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul a9~74@ a9~74@))) (Sub (Mul (Add a9~74@ c9~78@) a9~74@) (Mul (Mul b9~76@ c9~78@) (Add b9~76@ a9~74@)))) (Mul (Mul (Add (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Add b9~76@ b9~76@) (Add b9~76@ a9~74@))) (Mul (Add (Mul d9~80@ d9~80@) b9~76@) (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@)))))) (=> (= tmp%10@ (= temp_9_0~2490@ temp_9_1~2611@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~2739@ (Add (Mul (Mul (Add (Mul a10~82@ b10~84@) (Mul a10~82@ b10~84@)) (Mul b10~84@ (Add a10~82@ a10~82@))) (Mul (Mul (Mul b10~84@ 4) (Sub b10~84@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ b10~84@)))) (Mul (Mul b10~84@ (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ a10~82@))) (Add (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ a10~82@)) c10~86@)))) (=> (= temp_10_1~2852@ (Add (Mul (Mul (Add (Mul a10~82@ b10~84@) (Mul b10~84@ a10~82@)) (Mul b10~84@ (Add a10~82@ a10~82@))) (Mul (Mul (Mul b10~84@ 4) (Sub b10~84@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ b10~84@)))) (Mul (Mul b10~84@ (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ a10~82@))) (Add (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ a10~82@)) c10~86@)))) (=> (= tmp%11@ (= temp_10_0~2739@ temp_10_1~2852@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~2984@ (Mul (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Sub d11~96@ a11~90@) (Mul b11~92@ a11~90@)))) (Add (Mul d11~96@ (Mul (Sub c11~94@ b11~92@) (Mul c11~94@ c11~94@))) (Add (Add (Mul b11~92@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@)))))) (=> (= temp_11_1~3101@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Sub d11~96@ a11~90@) (Mul b11~92@ a11~90@))) (Add (Mul d11~96@ (Mul (Sub c11~94@ b11~92@) (Mul c11~94@ c11~94@))) (Add (Add (Mul b11~92@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@))))))) (=> (= tmp%12@ (= temp_11_0~2984@ temp_11_1~3101@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~3241@ (Sub (Mul (Mul (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ b12~100@)) (Mul (Mul c12~102@ b12~100@) (Add b12~100@ a12~98@))) (Mul (Mul c12~102@ (Add a12~98@ b12~100@)) (Add (Mul b12~100@ c12~102@) (Mul a12~98@ c12~102@)))) (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ a12~98@))) (Mul (Mul (Add d12~104@ a12~98@) (Sub a12~98@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul d12~104@ c12~102@)))))) (=> (= temp_12_1~3366@ (Sub (Mul (Mul (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ b12~100@)) (Mul (Mul c12~102@ b12~100@) (Add b12~100@ a12~98@))) (Mul (Mul c12~102@ (Add a12~98@ b12~100@)) (Add (Mul b12~100@ c12~102@) (Mul a12~98@ c12~102@)))) (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ a12~98@))) (Mul (Mul (Add d12~104@ a12~98@) (Sub a12~98@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul d12~104@ c12~102@)))))) (=> (= tmp%13@ (= temp_12_0~3241@ temp_12_1~3366@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~3490@ (Mul (Mul (Mul (Sub (Add b13~108@ b13~108@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ b13~108@))) (Mul (Mul (Mul a13~106@ b13~108@) (Mul d13~112@ a13~106@)) (Sub (Mul c13~110@ d13~112@) (Mul a13~106@ a13~106@)))) (Mul (Mul (Mul (Sub a13~106@ c13~110@) (Sub c13~110@ d13~112@)) a13~106@) (Mul (Add b13~108@ (Mul d13~112@ d13~112@)) (Mul c13~110@ (Mul a13~106@ b13~108@)))))) (=> (= temp_13_1~3599@ (Mul (Mul (Mul (Sub (Add b13~108@ b13~108@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ b13~108@))) (Mul (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ d13~112@)) (Sub (Mul c13~110@ d13~112@) (Mul a13~106@ a13~106@)))) (Mul (Mul (Mul (Sub a13~106@ c13~110@) (Sub c13~110@ d13~112@)) a13~106@) (Mul (Add b13~108@ (Mul d13~112@ d13~112@)) (Mul c13~110@ (Mul a13~106@ b13~108@)))))) (=> (= tmp%14@ (= temp_13_0~3490@ temp_13_1~3599@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~3759@ (Mul (Mul (Add (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ c14~118@)) (Mul (Add b14~116@ d14~120@) d14~120@)) (Mul (Mul (Mul b14~116@ b14~116@) (Add c14~118@ b14~116@)) (Mul (Mul b14~116@ d14~120@) (Sub d14~120@ d14~120@)))) (Mul (Mul (Mul (Mul c14~118@ 84) (Mul d14~120@ b14~116@)) (Add (Mul c14~118@ b14~116@) d14~120@)) (Add (Add (Mul a14~114@ b14~116@) (Mul a14~114@ b14~116@)) (Mul (Mul b14~116@ b14~116@) (Sub b14~116@ 23)))))) (=> (= temp_14_1~3904@ (Mul (Mul (Add (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ c14~118@)) (Mul (Add b14~116@ d14~120@) d14~120@)) (Mul (Mul (Mul b14~116@ b14~116@) (Add c14~118@ b14~116@)) (Mul (Mul b14~116@ d14~120@) (Sub d14~120@ d14~120@)))) (Mul (Mul (Mul (Mul c14~118@ 84) (Mul d14~120@ b14~116@)) (Add (Mul c14~118@ b14~116@) d14~120@)) (Add (Add (Mul a14~114@ b14~116@) (Mul a14~114@ b14~116@)) (Mul b14~116@ (Mul b14~116@ (Sub b14~116@ 23))))))) (=> (= tmp%15@ (= temp_14_0~3759@ temp_14_1~3904@)) (=> %%location_label%%14 tmp%15@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
