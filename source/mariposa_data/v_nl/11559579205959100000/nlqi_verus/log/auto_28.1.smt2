...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Sub (Mul (Mul d0~8@ (Mul a0~2@ b0~4@)) (Mul (Sub d0~8@ b0~4@) c0~6@)) (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ c0~6@)) (Sub (Add b0~4@ c0~6@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~354@ (Sub (Mul (Mul d0~8@ (Mul a0~2@ b0~4@)) (Mul (Sub d0~8@ b0~4@) c0~6@)) (Mul (Sub (Add b0~4@ c0~6@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~354@))) (=> (= temp_0_0~297@ temp_0_1~354@) (=> (= temp_1_0~443@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Sub c1~14@ a1~10@)) (Mul (Mul b1~12@ a1~10@) (Mul c1~14@ d1~16@))) (Add (Mul (Sub b1~12@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~508@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Sub c1~14@ a1~10@)) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ c1~14@))) (Add (Mul (Sub b1~12@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~443@ temp_1_1~508@))) (=> (= temp_1_0~443@ temp_1_1~508@) (=> (= temp_2_0~573@ (Mul (Mul c2~22@ (Mul (Sub d2~24@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Mul (Add b2~20@ d2~24@) (Mul b2~20@ d2~24@)) b2~20@))) (=> (= temp_2_1~614@ (Mul (Mul c2~22@ (Mul (Sub d2~24@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Add b2~20@ d2~24@) (Mul (Mul b2~20@ d2~24@) b2~20@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~573@ temp_2_1~614@))) (=> (= temp_2_0~573@ temp_2_1~614@) (=> (= temp_3_0~703@ (Mul (Sub (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~768@ (Mul (Sub (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~703@ temp_3_1~768@))) (=> (= temp_3_0~703@ temp_3_1~768@) (=> (= temp_4_0~869@ (Mul (Sub (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul 63 c4~38@) (Mul c4~38@ d4~40@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Sub b4~36@ a4~34@))))) (=> (= temp_4_1~946@ (Mul (Sub (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul 63 c4~38@) (Mul c4~38@ d4~40@))) (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Mul d4~40@ b4~36@)) (Sub b4~36@ a4~34@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~869@ temp_4_1~946@))) (=> (= temp_4_0~869@ temp_4_1~946@) (=> (= temp_5_0~1035@ (Sub (Add (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul d5~48@ a5~42@) (Sub c5~46@ a5~42@)) (Add (Mul c5~46@ d5~48@) (Sub b5~44@ d5~48@))))) (=> (= temp_5_1~1100@ (Sub (Add (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul d5~48@ a5~42@) (Sub c5~46@ a5~42@)) (Add (Mul d5~48@ c5~46@) (Sub b5~44@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1035@ temp_5_1~1100@))) (=> (= temp_5_0~1035@ temp_5_1~1100@) (=> (= temp_6_0~1201@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Sub a6~50@ a6~50@))) (Mul (Mul (Mul c6~54@ a6~50@) (Sub a6~50@ 5)) (Mul (Add b6~52@ c6~54@) (Mul a6~50@ c6~54@))))) (=> (= temp_6_1~1286@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ b6~52@)) (Sub (Mul (Mul a6~50@ c6~54@) a6~50@) (Mul (Mul a6~50@ c6~54@) a6~50@))) (Mul (Mul (Mul c6~54@ a6~50@) (Sub a6~50@ 5)) (Mul (Add b6~52@ c6~54@) (Mul a6~50@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1201@ temp_6_1~1286@))) (=> (= temp_6_0~1201@ temp_6_1~1286@) (=> (= temp_7_0~1375@ (Mul (Sub (Add (Mul d7~64@ c7~62@) (Sub a7~58@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ b7~60@))) (Mul (Mul (Add b7~60@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1440@ (Mul (Sub (Add (Mul d7~64@ c7~62@) (Sub a7~58@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul d7~64@ b7~60@) (Add b7~60@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1375@ temp_7_1~1440@))) (=> (= temp_7_0~1375@ temp_7_1~1440@) (=> (= temp_8_0~1489@ (Add d8~72@ (Mul (Mul (Add b8~68@ a8~66@) (Mul a8~66@ b8~68@)) b8~68@))) (=> (= temp_8_1~1514@ (Add d8~72@ (Mul (Add b8~68@ a8~66@) (Mul (Mul a8~66@ b8~68@) b8~68@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1489@ temp_8_1~1514@))) (=> (= temp_8_0~1489@ temp_8_1~1514@) (=> (= temp_9_0~1603@ (Mul (Mul (Sub (Add a9~74@ d9~80@) (Mul a9~74@ a9~74@)) (Mul (Sub b9~76@ d9~80@) (Mul b9~76@ b9~76@))) (Add (Mul (Mul c9~78@ b9~76@) (Mul d9~80@ b9~76@)) (Sub (Mul c9~78@ a9~74@) (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~1668@ (Mul (Mul (Sub (Add a9~74@ d9~80@) (Mul a9~74@ a9~74@)) (Mul (Sub b9~76@ d9~80@) (Mul b9~76@ b9~76@))) (Add (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ b9~76@)) (Sub (Mul c9~78@ a9~74@) (Mul c9~78@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1603@ temp_9_1~1668@))) (=> (= temp_9_0~1603@ temp_9_1~1668@) (=> (= temp_10_0~1765@ (Mul (Add (Mul (Mul d10~88@ c10~86@) (Add d10~88@ a10~82@)) (Add (Mul b10~84@ b10~84@) d10~88@)) (Mul (Mul (Mul c10~86@ 14) (Mul c10~86@ d10~88@)) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ a10~82@))))) (=> (= temp_10_1~1838@ (Mul (Add (Mul (Mul d10~88@ c10~86@) (Add d10~88@ a10~82@)) (Add (Mul b10~84@ b10~84@) d10~88@)) (Mul (Mul (Mul c10~86@ 14) (Mul c10~86@ d10~88@)) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1765@ temp_10_1~1838@))) (=> (= temp_10_0~1765@ temp_10_1~1838@) (=> (= temp_11_0~1927@ (Sub (Mul (Mul (Mul c11~94@ a11~90@) (Mul b11~92@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ a11~90@))) (Sub (Add (Mul c11~94@ d11~96@) (Mul a11~90@ d11~96@)) (Add (Mul b11~92@ a11~90@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~1992@ (Sub (Mul (Mul (Mul c11~94@ a11~90@) (Mul b11~92@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ a11~90@))) (Sub (Add (Mul c11~94@ d11~96@) (Mul a11~90@ d11~96@)) (Add (Mul b11~92@ a11~90@) (Mul b11~92@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1927@ temp_11_1~1992@))) (=> (= temp_11_0~1927@ temp_11_1~1992@) (=> (= temp_12_0~2077@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) c12~102@) (Sub (Mul d12~104@ c12~102@) (Mul d12~104@ c12~102@))) (Add (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ a12~98@)) (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2150@ (Mul (Sub (Mul (Mul (Mul d12~104@ a12~98@) c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul (Mul d12~104@ a12~98@) c12~102@) (Mul d12~104@ c12~102@))) (Add (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ a12~98@)) (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2077@ temp_12_1~2150@))) (=> (= temp_12_0~2077@ temp_12_1~2150@) (=> (= temp_13_0~2239@ (Mul (Mul (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ c13~110@)) (Mul (Sub b13~108@ a13~106@) (Mul c13~110@ d13~112@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul c13~110@ d13~112@)) (Sub (Mul a13~106@ d13~112@) (Mul b13~108@ c13~110@))))) (=> (= temp_13_1~2304@ (Mul (Mul (Mul (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ c13~110@)) (Mul (Sub b13~108@ a13~106@) (Mul c13~110@ d13~112@))) (Mul (Mul d13~112@ c13~110@) (Mul c13~110@ d13~112@))) (Sub (Mul a13~106@ d13~112@) (Mul b13~108@ c13~110@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2239@ temp_13_1~2304@))) (=> (= temp_13_0~2239@ temp_13_1~2304@) (=> (= temp_14_0~2405@ (Mul (Mul (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ d14~120@)) (Sub (Mul b14~116@ 8) (Add b14~116@ a14~114@))) (Mul (Add (Sub a14~114@ c14~118@) (Mul b14~116@ c14~118@)) (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2482@ (Mul (Mul (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ d14~120@)) (Sub (Mul b14~116@ 8) (Add b14~116@ a14~114@))) (Mul (Add (Sub a14~114@ c14~118@) (Mul c14~118@ b14~116@)) (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2405@ temp_14_1~2482@))) (=> (= temp_14_0~2405@ temp_14_1~2482@) (=> (= temp_15_0~2539@ (Mul c15~126@ (Mul (Mul b15~124@ (Mul d15~128@ d15~128@)) (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ a15~122@))))) (=> (= temp_15_1~2572@ (Mul c15~126@ (Mul (Mul b15~124@ (Mul d15~128@ d15~128@)) (Mul (Mul c15~126@ b15~124@) (Mul a15~122@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2539@ temp_15_1~2572@))) (=> (= temp_15_0~2539@ temp_15_1~2572@) (=> (= temp_16_0~2669@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ d16~136@)) (Mul (Mul 12 c16~134@) (Mul c16~134@ c16~134@))) (Sub (Mul (Mul a16~130@ b16~132@) d16~136@) (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~2742@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ d16~136@)) (Mul (Mul 12 c16~134@) (Mul c16~134@ c16~134@))) (Sub (Mul (Mul a16~130@ b16~132@) d16~136@) (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2669@ temp_16_1~2742@))) (=> (= temp_16_0~2669@ temp_16_1~2742@) (=> (= temp_17_0~2831@ (Sub (Add (Mul (Sub b17~140@ c17~142@) (Mul c17~142@ a17~138@)) (Mul (Mul b17~140@ a17~138@) (Mul b17~140@ a17~138@))) (Sub (Mul (Mul a17~138@ c17~142@) (Mul d17~144@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul b17~140@ c17~142@))))) (=> (= temp_17_1~2896@ (Sub (Add (Mul (Sub b17~140@ c17~142@) (Mul c17~142@ a17~138@)) (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ b17~140@))) (Sub (Mul (Mul a17~138@ c17~142@) (Mul d17~144@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul b17~140@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2831@ temp_17_1~2896@))) (=> (= temp_17_0~2831@ temp_17_1~2896@) (=> (= temp_18_0~2985@ (Add (Mul (Mul (Mul b18~148@ b18~148@) (Add a18~146@ b18~148@)) (Mul (Add a18~146@ a18~146@) (Mul b18~148@ b18~148@))) (Mul (Mul (Sub d18~152@ a18~146@) (Mul a18~146@ d18~152@)) (Mul (Sub b18~148@ a18~146@) (Mul b18~148@ a18~146@))))) (=> (= temp_18_1~3058@ (Add (Mul (Add (Mul (Mul b18~148@ b18~148@) a18~146@) (Mul (Mul b18~148@ b18~148@) b18~148@)) (Mul (Add a18~146@ a18~146@) (Mul b18~148@ b18~148@))) (Mul (Mul (Sub d18~152@ a18~146@) (Mul a18~146@ d18~152@)) (Mul (Sub b18~148@ a18~146@) (Mul b18~148@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2985@ temp_18_1~3058@))) (=> (= temp_18_0~2985@ temp_18_1~3058@) (=> (= temp_19_0~3135@ (Add (Add (Mul (Mul d19~160@ b19~156@) (Add c19~158@ a19~154@)) b19~156@) (Add (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ a19~154@)) (Mul (Mul c19~158@ b19~156@) (Mul c19~158@ c19~158@))))) (=> (= temp_19_1~3188@ (Add (Add (Mul (Mul d19~160@ b19~156@) (Add c19~158@ a19~154@)) b19~156@) (Add (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ a19~154@)) (Mul (Mul b19~156@ c19~158@) (Mul c19~158@ c19~158@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3135@ temp_19_1~3188@))) (=> (= temp_19_0~3135@ temp_19_1~3188@) (=> (= temp_20_0~3245@ (Mul (Mul (Mul (Sub d20~168@ d20~168@) (Mul a20~162@ d20~168@)) (Mul c20~166@ (Mul a20~162@ b20~164@))) a20~162@)) (=> (= temp_20_1~3278@ (Mul (Mul (Mul (Mul (Sub d20~168@ d20~168@) a20~162@) d20~168@) (Mul c20~166@ (Mul a20~162@ b20~164@))) a20~162@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3245@ temp_20_1~3278@))) (=> (= temp_20_0~3245@ temp_20_1~3278@) (=> (= temp_21_0~3367@ (Mul (Sub (Sub (Mul d21~176@ b21~172@) (Add a21~170@ b21~172@)) (Mul (Mul d21~176@ a21~170@) (Mul d21~176@ b21~172@))) (Mul (Mul (Mul b21~172@ a21~170@) (Add d21~176@ c21~174@)) (Mul (Mul c21~174@ c21~174@) (Mul a21~170@ d21~176@))))) (=> (= temp_21_1~3432@ (Mul (Sub (Sub (Mul d21~176@ b21~172@) (Add a21~170@ b21~172@)) (Mul (Mul d21~176@ a21~170@) (Mul d21~176@ b21~172@))) (Mul (Mul (Mul b21~172@ a21~170@) (Add d21~176@ c21~174@)) (Mul (Mul a21~170@ d21~176@) (Mul c21~174@ c21~174@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3367@ temp_21_1~3432@))) (=> (= temp_21_0~3367@ temp_21_1~3432@) (=> (= temp_22_0~3521@ (Mul (Mul (Mul (Mul b22~180@ d22~184@) (Mul b22~180@ c22~182@)) (Mul (Mul b22~180@ b22~180@) (Mul d22~184@ a22~178@))) (Mul (Mul (Mul a22~178@ d22~184@) (Mul c22~182@ b22~180@)) (Mul (Mul d22~184@ a22~178@) (Mul a22~178@ c22~182@))))) (=> (= temp_22_1~3586@ (Mul (Mul (Mul (Mul b22~180@ d22~184@) (Mul b22~180@ c22~182@)) (Mul (Mul b22~180@ b22~180@) (Mul d22~184@ a22~178@))) (Mul (Mul (Mul a22~178@ d22~184@) (Mul c22~182@ b22~180@)) (Mul (Mul d22~184@ a22~178@) (Mul c22~182@ a22~178@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3521@ temp_22_1~3586@))) (=> (= temp_22_0~3521@ temp_22_1~3586@) (=> (= temp_23_0~3675@ (Mul (Mul (Mul (Mul c23~190@ d23~192@) (Mul a23~186@ b23~188@)) (Mul (Sub a23~186@ c23~190@) (Mul b23~188@ a23~186@))) (Mul (Mul (Mul d23~192@ a23~186@) (Mul a23~186@ d23~192@)) (Mul (Mul b23~188@ d23~192@) (Mul b23~188@ c23~190@))))) (=> (= temp_23_1~3740@ (Mul (Mul (Mul (Mul c23~190@ d23~192@) (Mul a23~186@ b23~188@)) (Mul (Sub a23~186@ c23~190@) (Mul a23~186@ b23~188@))) (Mul (Mul (Mul d23~192@ a23~186@) (Mul a23~186@ d23~192@)) (Mul (Mul b23~188@ d23~192@) (Mul b23~188@ c23~190@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3675@ temp_23_1~3740@))) (=> (= temp_23_0~3675@ temp_23_1~3740@) (=> (= temp_24_0~3813@ (Mul (Add b24~196@ (Mul (Mul b24~196@ a24~194@) (Sub d24~200@ c24~198@))) (Mul (Mul (Mul a24~194@ a24~194@) (Mul b24~196@ d24~200@)) (Mul c24~198@ (Mul c24~198@ a24~194@))))) (=> (= temp_24_1~3862@ (Mul (Add b24~196@ (Mul (Mul b24~196@ a24~194@) (Sub d24~200@ c24~198@))) (Mul (Mul (Mul a24~194@ a24~194@) (Mul b24~196@ d24~200@)) (Mul (Mul c24~198@ c24~198@) a24~194@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3813@ temp_24_1~3862@))) (=> (= temp_24_0~3813@ temp_24_1~3862@) (=> (= temp_25_0~3935@ (Mul (Mul (Sub (Mul b25~204@ a25~202@) (Mul b25~204@ b25~204@)) (Mul (Mul d25~208@ b25~204@) d25~208@)) (Mul (Mul (Mul d25~208@ c25~206@) (Add d25~208@ b25~204@)) a25~202@))) (=> (= temp_25_1~3984@ (Mul (Mul (Sub (Mul b25~204@ a25~202@) (Mul b25~204@ b25~204@)) (Mul (Mul d25~208@ b25~204@) d25~208@)) (Mul (Mul d25~208@ c25~206@) (Mul (Add d25~208@ b25~204@) a25~202@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~3935@ temp_25_1~3984@))) (=> (= temp_25_0~3935@ temp_25_1~3984@) (=> (= temp_26_0~4065@ (Mul (Sub (Mul (Sub a26~210@ b26~212@) d26~216@) (Mul (Mul a26~210@ a26~210@) (Mul a26~210@ a26~210@))) (Mul (Mul (Mul a26~210@ b26~212@) (Mul a26~210@ d26~216@)) (Mul d26~216@ (Add d26~216@ a26~210@))))) (=> (= temp_26_1~4122@ (Mul (Sub (Mul (Sub a26~210@ b26~212@) d26~216@) (Mul (Mul a26~210@ a26~210@) (Mul a26~210@ a26~210@))) (Mul (Mul (Mul a26~210@ b26~212@) (Mul a26~210@ d26~216@)) (Mul d26~216@ (Add d26~216@ a26~210@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%26 (= temp_26_0~4065@ temp_26_1~4122@))) (=> (= temp_26_0~4065@ temp_26_1~4122@) (=> (= temp_27_0~4203@ (Mul (Mul (Mul (Mul c27~222@ a27~218@) (Mul a27~218@ a27~218@)) (Mul (Mul c27~222@ a27~218@) (Mul b27~220@ c27~222@))) (Mul (Add (Mul a27~218@ a27~218@) d27~224@) (Mul (Mul a27~218@ c27~222@) d27~224@)))) (=> (= temp_27_1~4260@ (Mul (Mul (Mul (Mul c27~222@ a27~218@) (Mul a27~218@ a27~218@)) (Mul (Mul a27~218@ c27~222@) (Mul b27~220@ c27~222@))) (Mul (Add (Mul a27~218@ a27~218@) d27~224@) (Mul (Mul a27~218@ c27~222@) d27~224@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%27 (= temp_27_0~4203@ temp_27_1~4260@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
