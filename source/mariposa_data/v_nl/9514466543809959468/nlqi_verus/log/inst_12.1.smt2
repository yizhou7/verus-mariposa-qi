...
(set-info :comment ";; mariposa_data/v_nl//9514466543809959468/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_6_1~1428@ Int)
(declare-const temp_7_0~1521@ Int)
(declare-const temp_7_1~1586@ Int)
...
(declare-const temp_11_0~2207@ Int)
(declare-const temp_11_1~2272@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ a0~2@) c0~6@)) (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ d0~8@) c0~6@)))) (=> (= temp_0_1~354@ (Mul (Mul (Mul (Mul d0~8@ a0~2@) c0~6@) (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ d0~8@) c0~6@)))) (and (=> (= tmp%1@ (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ d0~8@))) (=> (= tmp%2@ (Mul (Mul d0~8@ a0~2@) c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~354@))))) (=> (= temp_0_0~297@ temp_0_1~354@) (=> (= temp_1_0~463@ (Sub (Mul (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@))) (Mul (Add (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Add a1~10@ (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~524@ (Sub (Mul (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ d1~16@)) (Mul (Mul (Mul b1~12@ c1~14@) d1~16@) c1~14@)) (Mul (Add (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Add a1~10@ (Mul c1~14@ a1~10@))))) (and (=> (= tmp%3@ (Mul b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~463@ temp_1_1~524@)))) (=> (= temp_1_0~463@ temp_1_1~524@) (=> (= temp_2_0~635@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ 54))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ d2~24@)) (Add (Mul c2~22@ c2~22@) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~712@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ 54) (Mul a2~18@ a2~18@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ d2~24@)) (Add (Mul c2~22@ c2~22@) (Mul c2~22@ d2~24@))))) (and (=> (= tmp%4@ (Mul a2~18@ a2~18@)) (=> (= tmp%5@ (Mul a2~18@ 54)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~635@ temp_2_1~712@))))) (=> (= temp_2_0~635@ temp_2_1~712@) (=> (= temp_3_0~849@ (Mul (Add (Mul (Mul a3~26@ c3~30@) (Mul 53 b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul b3~28@ 7) (Mul c3~30@ a3~26@)) (Mul (Mul d3~32@ b3~28@) (Sub d3~32@ b3~28@))))) (=> (= temp_3_1~938@ (Mul (Add (Mul (Mul a3~26@ c3~30@) (Mul 53 b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul b3~28@ 7) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Sub d3~32@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ a3~26@) (=> %%location_label%%3 (= temp_3_0~849@ temp_3_1~938@))) (=> (= temp_3_0~849@ temp_3_1~938@) (=> (= temp_4_0~1031@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul c4~38@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~1096@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul c4~38@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul c4~38@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c4~38@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1031@ temp_4_1~1096@))) (=> (= temp_4_0~1031@ temp_4_1~1096@) (=> (= temp_5_0~1189@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)) (Add (Sub a5~42@ c5~46@) (Mul c5~46@ c5~46@))) (Add (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1254@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)) (Add (Sub a5~42@ c5~46@) (Mul c5~46@ c5~46@))) (Add (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ d5~48@) (=> %%location_label%%5 (= temp_5_0~1189@ temp_5_1~1254@))) (=> (= temp_5_0~1189@ temp_5_1~1254@) (=> (= temp_6_0~1355@ (Mul (Mul (Mul c6~54@ (Mul c6~54@ c6~54@)) (Mul (Mul 82 d6~56@) (Mul c6~54@ d6~56@))) (Mul (Sub (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@)) (Add (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1428@ (Mul (Mul (Mul c6~54@ (Mul c6~54@ c6~54@)) (Mul (Mul 82 d6~56@) (Mul c6~54@ d6~56@))) (Mul (Sub (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@)) (Add (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1355@ temp_6_1~1428@))) (=> (= temp_6_0~1355@ temp_6_1~1428@) (=> (= temp_7_0~1521@ (Mul (Sub (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ d7~64@)) (Sub (Mul d7~64@ c7~62@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1586@ (Mul (Sub (Mul (Mul (Mul d7~64@ b7~60@) c7~62@) d7~64@) (Sub (Mul d7~64@ c7~62@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))))) (and (=> (= tmp%6@ (Mul d7~64@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ c7~62@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1521@ temp_7_1~1586@)))) (=> (= temp_7_0~1521@ temp_7_1~1586@) (=> (= temp_8_0~1697@ (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ a8~66@)) (Mul (Sub a8~66@ d8~72@) (Mul a8~66@ c8~70@))) (Add (Mul (Mul 32 d8~72@) (Add a8~66@ c8~70@)) (Mul (Add d8~72@ b8~68@) (Mul b8~68@ b8~68@))))) (=> (= temp_8_1~1774@ (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ a8~66@)) (Mul (Sub a8~66@ d8~72@) (Mul a8~66@ c8~70@))) (Add (Mul (Mul d8~72@ 32) (Add a8~66@ c8~70@)) (Mul (Add d8~72@ b8~68@) (Mul b8~68@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 32 d8~72@) (=> %%location_label%%8 (= temp_8_0~1697@ temp_8_1~1774@))) (=> (= temp_8_0~1697@ temp_8_1~1774@) (=> (= temp_9_0~1879@ (Sub (Mul (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ b9~76@) (Sub c9~78@ c9~78@))) (Mul (Sub (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~1944@ (Sub (Mul (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ b9~76@) (Sub c9~78@ c9~78@))) (Mul (Sub (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Mul c9~78@ (Mul b9~76@ (Mul b9~76@ d9~80@)))))) (and (=> (= tmp%7@ (Mul b9~76@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c9~78@ b9~76@ tmp%7@) (=> %%location_label%%9 (= temp_9_0~1879@ temp_9_1~1944@)))) (=> (= temp_9_0~1879@ temp_9_1~1944@) (=> (= temp_10_0~2043@ (Mul (Mul (Mul (Mul d10~88@ c10~86@) (Add d10~88@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul a10~82@ a10~82@))) (Mul (Sub (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ b10~84@))))) (=> (= temp_10_1~2108@ (Mul (Mul (Mul (Mul d10~88@ c10~86@) (Add d10~88@ d10~88@)) (Mul c10~86@ (Mul c10~86@ (Mul a10~82@ a10~82@)))) (Mul (Sub (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ b10~84@))))) (and (=> (= tmp%8@ (Mul a10~82@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c10~86@ c10~86@ tmp%8@) (=> %%location_label%%10 (= temp_10_0~2043@ temp_10_1~2108@)))) (=> (= temp_10_0~2043@ temp_10_1~2108@) (=> (= temp_11_0~2207@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ d11~96@) (Mul b11~92@ d11~96@))) (Sub (Sub (Mul a11~90@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ b11~92@) (Mul d11~96@ d11~96@))))) (=> (= temp_11_1~2272@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ d11~96@) (Mul d11~96@ b11~92@))) (Sub (Sub (Mul a11~90@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ b11~92@) (Mul d11~96@ d11~96@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b11~92@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2207@ temp_11_1~2272@))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
