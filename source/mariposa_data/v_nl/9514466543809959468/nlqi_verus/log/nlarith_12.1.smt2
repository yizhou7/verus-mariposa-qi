...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ a0~2@) c0~6@)) (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ d0~8@) c0~6@)))) (=> (= temp_0_1~354@ (Mul (Mul (Mul (Mul d0~8@ a0~2@) c0~6@) (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ d0~8@) c0~6@)))) (=> (= tmp%1@ (= temp_0_0~297@ temp_0_1~354@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~430@ (Sub (Mul (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@))) (Mul (Add (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Add a1~10@ (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~491@ (Sub (Mul (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ d1~16@)) (Mul (Mul (Mul b1~12@ c1~14@) d1~16@) c1~14@)) (Mul (Add (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Add a1~10@ (Mul c1~14@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~430@ temp_1_1~491@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~583@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ 54))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ d2~24@)) (Add (Mul c2~22@ c2~22@) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~660@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ 54) (Mul a2~18@ a2~18@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ d2~24@)) (Add (Mul c2~22@ c2~22@) (Mul c2~22@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~583@ temp_2_1~660@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~764@ (Mul (Add (Mul (Mul a3~26@ c3~30@) (Mul 53 b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul b3~28@ 7) (Mul c3~30@ a3~26@)) (Mul (Mul d3~32@ b3~28@) (Sub d3~32@ b3~28@))))) (=> (= temp_3_1~853@ (Mul (Add (Mul (Mul a3~26@ c3~30@) (Mul 53 b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul b3~28@ 7) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Sub d3~32@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~764@ temp_3_1~853@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~933@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul c4~38@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~998@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul c4~38@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul c4~38@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~933@ temp_4_1~998@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1078@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)) (Add (Sub a5~42@ c5~46@) (Mul c5~46@ c5~46@))) (Add (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1143@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)) (Add (Sub a5~42@ c5~46@) (Mul c5~46@ c5~46@))) (Add (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1078@ temp_5_1~1143@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1231@ (Mul (Mul (Mul c6~54@ (Mul c6~54@ c6~54@)) (Mul (Mul 82 d6~56@) (Mul c6~54@ d6~56@))) (Mul (Sub (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@)) (Add (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1304@ (Mul (Mul (Mul c6~54@ (Mul c6~54@ c6~54@)) (Mul (Mul 82 d6~56@) (Mul c6~54@ d6~56@))) (Mul (Sub (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@)) (Add (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1231@ temp_6_1~1304@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1384@ (Mul (Sub (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ d7~64@)) (Sub (Mul d7~64@ c7~62@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1449@ (Mul (Sub (Mul (Mul (Mul d7~64@ b7~60@) c7~62@) d7~64@) (Sub (Mul d7~64@ c7~62@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1384@ temp_7_1~1449@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1541@ (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ a8~66@)) (Mul (Sub a8~66@ d8~72@) (Mul a8~66@ c8~70@))) (Add (Mul (Mul 32 d8~72@) (Add a8~66@ c8~70@)) (Mul (Add d8~72@ b8~68@) (Mul b8~68@ b8~68@))))) (=> (= temp_8_1~1618@ (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ a8~66@)) (Mul (Sub a8~66@ d8~72@) (Mul a8~66@ c8~70@))) (Add (Mul (Mul d8~72@ 32) (Add a8~66@ c8~70@)) (Mul (Add d8~72@ b8~68@) (Mul b8~68@ b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1541@ temp_8_1~1618@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1698@ (Sub (Mul (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ b9~76@) (Sub c9~78@ c9~78@))) (Mul (Sub (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~1763@ (Sub (Mul (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ b9~76@) (Sub c9~78@ c9~78@))) (Mul (Sub (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Mul c9~78@ (Mul b9~76@ (Mul b9~76@ d9~80@)))))) (=> (= tmp%10@ (= temp_9_0~1698@ temp_9_1~1763@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1843@ (Mul (Mul (Mul (Mul d10~88@ c10~86@) (Add d10~88@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul a10~82@ a10~82@))) (Mul (Sub (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ b10~84@))))) (=> (= temp_10_1~1908@ (Mul (Mul (Mul (Mul d10~88@ c10~86@) (Add d10~88@ d10~88@)) (Mul c10~86@ (Mul c10~86@ (Mul a10~82@ a10~82@)))) (Mul (Sub (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ b10~84@))))) (=> (= tmp%11@ (= temp_10_0~1843@ temp_10_1~1908@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1988@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ d11~96@) (Mul b11~92@ d11~96@))) (Sub (Sub (Mul a11~90@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ b11~92@) (Mul d11~96@ d11~96@))))) (=> (= temp_11_1~2053@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ d11~96@) (Mul d11~96@ b11~92@))) (Sub (Sub (Mul a11~90@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ b11~92@) (Mul d11~96@ d11~96@))))) (=> (= tmp%12@ (= temp_11_0~1988@ temp_11_1~2053@)) (=> %%location_label%%11 tmp%12@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
