...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ d0~8@)) (Mul d0~8@ (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ d0~8@)) (Mul d0~8@ (Mul b0~4@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~447@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ b1~12@)) (Mul a1~10@ (Add d1~16@ d1~16@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~508@ (Mul (Mul (Mul a1~10@ (Add d1~16@ d1~16@)) (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ b1~12@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~508@))) (=> (= temp_1_0~447@ temp_1_1~508@) (=> (= temp_2_0~605@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) b2~20@) (Mul (Sub c2~22@ a2~18@) (Mul a2~18@ a2~18@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul b2~20@ 35) (Mul a2~18@ b2~20@))))) (=> (= temp_2_1~678@ (Mul (Mul (Mul c2~22@ (Mul b2~20@ b2~20@)) (Mul (Sub c2~22@ a2~18@) (Mul a2~18@ a2~18@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul b2~20@ 35) (Mul a2~18@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~605@ temp_2_1~678@))) (=> (= temp_2_0~605@ temp_2_1~678@) (=> (= temp_3_0~727@ (Mul (Sub (Mul (Mul d3~32@ a3~26@) (Add b3~28@ a3~26@)) c3~30@) b3~28@)) (=> (= temp_3_1~760@ (Mul (Sub (Add (Mul (Mul d3~32@ a3~26@) b3~28@) (Mul (Mul d3~32@ a3~26@) a3~26@)) c3~30@) b3~28@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~727@ temp_3_1~760@))) (=> (= temp_3_0~727@ temp_3_1~760@) (=> (= temp_4_0~817@ (Sub (Sub (Mul (Sub d4~40@ b4~36@) (Mul c4~38@ d4~40@)) (Mul c4~38@ (Mul d4~40@ d4~40@))) a4~34@)) (=> (= temp_4_1~850@ (Sub (Sub (Mul (Sub d4~40@ b4~36@) (Mul c4~38@ d4~40@)) (Mul (Mul c4~38@ d4~40@) d4~40@)) a4~34@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~817@ temp_4_1~850@))) (=> (= temp_4_0~817@ temp_4_1~850@) (=> (= temp_5_0~939@ (Sub (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (Mul (Sub (Mul c5~46@ a5~42@) (Mul b5~44@ b5~44@)) (Add (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))))) (=> (= temp_5_1~1004@ (Sub (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (Mul (Add (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@)) (Sub (Mul c5~46@ a5~42@) (Mul b5~44@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~939@ temp_5_1~1004@))) (=> (= temp_5_0~939@ temp_5_1~1004@) (=> (= temp_6_0~1093@ (Sub (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ d6~56@)) (Mul (Sub d6~56@ a6~50@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1166@ (Sub (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ d6~56@)) (Sub (Mul d6~56@ (Mul b6~52@ b6~52@)) (Mul a6~50@ (Mul b6~52@ b6~52@)))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1093@ temp_6_1~1166@))) (=> (= temp_6_0~1093@ temp_6_1~1166@) (=> (= temp_7_0~1255@ (Add (Mul (Mul (Mul b7~60@ b7~60@) (Sub d7~64@ a7~58@)) (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Sub d7~64@ d7~64@) (Add d7~64@ d7~64@))))) (=> (= temp_7_1~1320@ (Add (Mul (Mul b7~60@ (Mul b7~60@ (Sub d7~64@ a7~58@))) (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Sub d7~64@ d7~64@) (Add d7~64@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1255@ temp_7_1~1320@))) (=> (= temp_7_0~1255@ temp_7_1~1320@) (=> (= temp_8_0~1409@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1474@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1409@ temp_8_1~1474@))) (=> (= temp_8_0~1409@ temp_8_1~1474@) (=> (= temp_9_0~1563@ (Mul (Add (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@)) (Mul (Mul a9~74@ c9~78@) (Add b9~76@ c9~78@))) (Mul (Mul (Mul b9~76@ d9~80@) (Add c9~78@ c9~78@)) (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~1628@ (Mul (Add (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@)) (Mul (Mul a9~74@ c9~78@) (Add b9~76@ c9~78@))) (Mul (Mul (Mul b9~76@ d9~80@) (Add c9~78@ c9~78@)) (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1563@ temp_9_1~1628@))) (=> (= temp_9_0~1563@ temp_9_1~1628@) (=> (= temp_10_0~1705@ (Mul (Sub (Mul (Mul d10~88@ d10~88@) (Add a10~82@ c10~86@)) (Mul (Sub b10~84@ c10~86@) (Mul b10~84@ c10~86@))) (Mul d10~88@ (Mul (Mul b10~84@ b10~84@) (Sub c10~86@ b10~84@))))) (=> (= temp_10_1~1758@ (Mul (Mul (Sub (Mul (Mul d10~88@ d10~88@) (Add a10~82@ c10~86@)) (Mul (Sub b10~84@ c10~86@) (Mul b10~84@ c10~86@))) d10~88@) (Mul (Mul b10~84@ b10~84@) (Sub c10~86@ b10~84@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1705@ temp_10_1~1758@))) (=> (= temp_10_0~1705@ temp_10_1~1758@) (=> (= temp_11_0~1847@ (Mul (Mul (Add (Mul b11~92@ c11~94@) (Mul c11~94@ a11~90@)) (Mul (Mul c11~94@ d11~96@) (Add b11~92@ a11~90@))) (Mul (Mul (Mul d11~96@ a11~90@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~1928@ (Mul (Add (Mul (Mul b11~92@ c11~94@) (Mul (Mul c11~94@ d11~96@) (Add b11~92@ a11~90@))) (Mul (Mul c11~94@ a11~90@) (Mul (Mul c11~94@ d11~96@) (Add b11~92@ a11~90@)))) (Mul (Mul (Mul d11~96@ a11~90@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1847@ temp_11_1~1928@))) (=> (= temp_11_0~1847@ temp_11_1~1928@) (=> (= temp_12_0~2041@ (Mul (Add (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul c12~102@ d12~104@) (Sub b12~100@ 82))) (Mul (Add (Mul a12~98@ 62) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ c12~102@) (Add a12~98@ c12~102@))))) (=> (= temp_12_1~2130@ (Mul (Add (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul c12~102@ d12~104@) (Sub b12~100@ 82))) (Mul (Add (Mul 62 a12~98@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ c12~102@) (Add a12~98@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2041@ temp_12_1~2130@))) (=> (= temp_12_0~2041@ temp_12_1~2130@) (=> (= temp_13_0~2211@ (Mul (Mul (Add (Sub a13~106@ b13~108@) (Mul b13~108@ d13~112@)) (Sub a13~106@ (Mul d13~112@ d13~112@))) (Mul (Mul (Mul c13~110@ c13~110@) (Mul d13~112@ b13~108@)) (Mul d13~112@ (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~2268@ (Mul (Mul (Add (Sub a13~106@ b13~108@) (Mul b13~108@ d13~112@)) (Sub a13~106@ (Mul d13~112@ d13~112@))) (Mul (Mul d13~112@ (Mul d13~112@ c13~110@)) (Mul (Mul c13~110@ c13~110@) (Mul d13~112@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2211@ temp_13_1~2268@))) (=> (= temp_13_0~2211@ temp_13_1~2268@) (=> (= temp_14_0~2357@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul d14~120@ c14~118@) (Mul b14~116@ b14~116@))) (Mul (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ d14~120@)) (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2422@ (Mul (Mul (Mul (Mul (Mul d14~120@ c14~118@) c14~118@) a14~114@) (Mul (Mul d14~120@ c14~118@) (Mul b14~116@ b14~116@))) (Mul (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ d14~120@)) (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2357@ temp_14_1~2422@))) (=> (= temp_14_0~2357@ temp_14_1~2422@) (=> (= temp_15_0~2507@ (Mul (Mul (Mul (Mul c15~126@ a15~122@) (Mul a15~122@ d15~128@)) (Sub (Mul d15~128@ c15~126@) (Mul c15~126@ a15~122@))) (Mul (Mul (Mul a15~122@ b15~124@) (Mul d15~128@ d15~128@)) (Mul b15~124@ (Mul a15~122@ b15~124@))))) (=> (= temp_15_1~2568@ (Mul (Mul (Mul (Mul c15~126@ a15~122@) (Mul a15~122@ d15~128@)) (Sub (Mul d15~128@ c15~126@) (Mul c15~126@ a15~122@))) (Mul (Mul (Mul a15~122@ b15~124@) (Mul d15~128@ d15~128@)) (Mul b15~124@ (Mul a15~122@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2507@ temp_15_1~2568@))) (=> (= temp_15_0~2507@ temp_15_1~2568@) (=> (= temp_16_0~2653@ (Mul (Mul (Sub (Add d16~136@ d16~136@) (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul b16~132@ c16~134@) (Mul b16~132@ a16~130@)) (Mul c16~134@ (Mul a16~130@ c16~134@))))) (=> (= temp_16_1~2714@ (Mul (Mul (Sub (Add d16~136@ d16~136@) (Mul a16~130@ d16~136@)) (Mul (Mul b16~132@ c16~134@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul b16~132@ c16~134@) (Mul b16~132@ a16~130@)) (Mul c16~134@ (Mul a16~130@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2653@ temp_16_1~2714@))) (=> (= temp_16_0~2653@ temp_16_1~2714@) (=> (= temp_17_0~2787@ (Mul (Mul d17~144@ (Mul d17~144@ (Mul d17~144@ c17~142@))) (Mul (Mul (Mul c17~142@ a17~138@) (Add a17~138@ a17~138@)) (Mul (Mul d17~144@ d17~144@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~2836@ (Mul (Mul d17~144@ (Mul d17~144@ (Mul d17~144@ c17~142@))) (Mul (Mul (Mul a17~138@ c17~142@) (Add a17~138@ a17~138@)) (Mul (Mul d17~144@ d17~144@) (Mul c17~142@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2787@ temp_17_1~2836@))) (=> (= temp_17_0~2787@ temp_17_1~2836@) (=> (= temp_18_0~2925@ (Mul (Mul (Mul (Add d18~152@ c18~150@) (Mul a18~146@ a18~146@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ c18~150@))) (Mul (Add (Mul a18~146@ d18~152@) (Add b18~148@ d18~152@)) (Sub (Mul b18~148@ d18~152@) (Mul d18~152@ b18~148@))))) (=> (= temp_18_1~2990@ (Mul (Mul (Mul (Add d18~152@ c18~150@) (Mul a18~146@ a18~146@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ c18~150@))) (Mul (Add (Mul a18~146@ d18~152@) (Add b18~148@ d18~152@)) (Sub (Mul b18~148@ d18~152@) (Mul d18~152@ b18~148@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2925@ temp_18_1~2990@))) (=> (= temp_18_0~2925@ temp_18_1~2990@) (=> (= temp_19_0~3067@ (Mul (Mul (Mul (Mul b19~156@ d19~160@) (Mul c19~158@ c19~158@)) (Mul (Mul b19~156@ c19~158@) (Sub a19~154@ d19~160@))) (Mul (Mul (Mul d19~160@ d19~160@) (Mul c19~158@ b19~156@)) b19~156@))) (=> (= temp_19_1~3120@ (Mul (Mul (Mul (Mul b19~156@ d19~160@) (Mul c19~158@ c19~158@)) (Mul (Mul b19~156@ c19~158@) (Sub a19~154@ d19~160@))) (Mul b19~156@ (Mul (Mul d19~160@ d19~160@) (Mul c19~158@ b19~156@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3067@ temp_19_1~3120@))) (=> (= temp_19_0~3067@ temp_19_1~3120@) (=> (= temp_20_0~3197@ (Sub (Mul (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Mul (Mul c20~166@ a20~162@) (Add d20~168@ b20~164@))) (Mul c20~166@ (Mul (Mul b20~164@ a20~162@) (Mul b20~164@ c20~166@))))) (=> (= temp_20_1~3250@ (Sub (Mul (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Mul c20~166@ (Mul a20~162@ (Add d20~168@ b20~164@)))) (Mul c20~166@ (Mul (Mul b20~164@ a20~162@) (Mul b20~164@ c20~166@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3197@ temp_20_1~3250@))) (=> (= temp_20_0~3197@ temp_20_1~3250@) (=> (= temp_21_0~3347@ (Mul (Sub (Mul (Mul d21~176@ b21~172@) (Mul c21~174@ a21~170@)) (Mul (Mul b21~172@ d21~176@) (Sub a21~170@ a21~170@))) (Mul (Add (Mul c21~174@ c21~174@) a21~170@) (Mul (Mul d21~176@ c21~174@) (Mul 15 c21~174@))))) (=> (= temp_21_1~3448@ (Mul (Sub (Mul (Mul d21~176@ b21~172@) (Mul c21~174@ a21~170@)) (Mul (Mul b21~172@ d21~176@) (Sub a21~170@ a21~170@))) (Add (Mul (Mul c21~174@ c21~174@) (Mul (Mul d21~176@ c21~174@) (Mul 15 c21~174@))) (Mul a21~170@ (Mul (Mul d21~176@ c21~174@) (Mul 15 c21~174@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3347@ temp_21_1~3448@))) (=> (= temp_21_0~3347@ temp_21_1~3448@) (=> (= temp_22_0~3521@ (Mul (Mul c22~182@ (Sub (Mul a22~178@ a22~178@) (Mul c22~182@ b22~180@))) (Add (Sub (Mul c22~182@ d22~184@) (Mul c22~182@ a22~178@)) (Mul (Mul d22~184@ a22~178@) a22~178@)))) (=> (= temp_22_1~3570@ (Mul (Mul c22~182@ (Sub (Mul a22~178@ a22~178@) (Mul c22~182@ b22~180@))) (Add (Sub (Mul c22~182@ d22~184@) (Mul c22~182@ a22~178@)) (Mul (Mul d22~184@ a22~178@) a22~178@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3521@ temp_22_1~3570@))) (=> (= temp_22_0~3521@ temp_22_1~3570@) (=> (= temp_23_0~3659@ (Mul (Mul (Add (Mul a23~186@ a23~186@) (Mul a23~186@ b23~188@)) (Mul (Mul d23~192@ b23~188@) (Mul d23~192@ a23~186@))) (Sub (Mul (Mul d23~192@ c23~190@) (Mul a23~186@ a23~186@)) (Mul (Mul b23~188@ a23~186@) (Sub d23~192@ d23~192@))))) (=> (= temp_23_1~3724@ (Mul (Mul (Add (Mul a23~186@ a23~186@) (Mul a23~186@ b23~188@)) (Mul (Mul d23~192@ b23~188@) (Mul d23~192@ a23~186@))) (Sub (Mul (Mul c23~190@ d23~192@) (Mul a23~186@ a23~186@)) (Mul (Mul b23~188@ a23~186@) (Sub d23~192@ d23~192@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3659@ temp_23_1~3724@))) (=> (= temp_23_0~3659@ temp_23_1~3724@) (=> (= temp_24_0~3813@ (Sub (Mul (Mul (Mul a24~194@ 22) (Mul a24~194@ d24~200@)) (Mul (Mul c24~198@ c24~198@) (Mul c24~198@ c24~198@))) (Mul (Mul (Mul a24~194@ c24~198@) (Mul c24~198@ b24~196@)) a24~194@))) (=> (= temp_24_1~3878@ (Sub (Mul (Mul (Mul a24~194@ 22) (Mul a24~194@ d24~200@)) (Mul (Mul c24~198@ c24~198@) (Mul c24~198@ c24~198@))) (Mul (Mul (Mul c24~198@ b24~196@) (Mul a24~194@ c24~198@)) a24~194@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3813@ temp_24_1~3878@))) (=> (= temp_24_0~3813@ temp_24_1~3878@) (=> (= temp_25_0~3959@ (Mul (Mul (Mul (Mul d25~208@ c25~206@) (Mul c25~206@ b25~204@)) (Mul (Mul a25~202@ b25~204@) (Mul d25~208@ a25~202@))) (Mul (Mul a25~202@ d25~208@) (Mul (Sub b25~204@ b25~204@) (Sub a25~202@ b25~204@))))) (=> (= temp_25_1~4016@ (Mul (Mul (Mul (Mul (Mul d25~208@ c25~206@) c25~206@) b25~204@) (Mul (Mul a25~202@ b25~204@) (Mul d25~208@ a25~202@))) (Mul (Mul a25~202@ d25~208@) (Mul (Sub b25~204@ b25~204@) (Sub a25~202@ b25~204@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~3959@ temp_25_1~4016@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
