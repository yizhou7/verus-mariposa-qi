...
(assert (=> %%query%% (not (=> (= temp_0_0~329@ (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Add c0~6@ c0~6@)) (Add (Mul b0~4@ a0~2@) (Mul c0~6@ 35))) (Mul (Add (Sub d0~8@ d0~8@) (Mul b0~4@ 92)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~418@ (Mul (Mul (Mul (Mul c0~6@ a0~2@) (Add c0~6@ c0~6@)) (Add (Mul b0~4@ a0~2@) (Mul c0~6@ 35))) (Mul (Add (Sub d0~8@ d0~8@) (Mul b0~4@ 92)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~329@ temp_0_1~418@))) (=> (= temp_0_0~329@ temp_0_1~418@) (=> (= temp_1_0~515@ (Mul (Mul (Mul (Sub a1~10@ c1~14@) (Sub d1~16@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ 63)) (Mul b1~12@ (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~588@ (Mul (Mul (Mul (Sub a1~10@ c1~14@) (Sub d1~16@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ d1~16@))) (Mul (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ 63)) (Mul b1~12@ (Mul b1~12@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~515@ temp_1_1~588@))) (=> (= temp_1_0~515@ temp_1_1~588@) (=> (= temp_2_0~697@ (Add (Mul (Add (Sub c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Add (Mul a2~18@ d2~24@) (Mul c2~22@ 11))) (Add (Mul b2~20@ (Mul d2~24@ c2~22@)) (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ 37))))) (=> (= temp_2_1~782@ (Add (Mul (Add (Sub c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Add (Mul a2~18@ d2~24@) (Mul c2~22@ 11))) (Add (Mul b2~20@ (Mul d2~24@ c2~22@)) (Mul b2~20@ (Mul d2~24@ (Mul d2~24@ 37)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~697@ temp_2_1~782@))) (=> (= temp_2_0~697@ temp_2_1~782@) (=> (= temp_3_0~867@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ c3~30@)) (Add (Mul d3~32@ c3~30@) b3~28@)) (Mul (Add (Mul d3~32@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Add c3~30@ a3~26@))))) (=> (= temp_3_1~928@ (Mul (Mul (Mul (Mul (Mul a3~26@ b3~28@) c3~30@) c3~30@) (Add (Mul d3~32@ c3~30@) b3~28@)) (Mul (Add (Mul d3~32@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Add c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~867@ temp_3_1~928@))) (=> (= temp_3_0~867@ temp_3_1~928@) (=> (= temp_4_0~1013@ (Add (Mul (Mul (Add d4~40@ a4~34@) b4~36@) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Sub b4~36@ b4~36@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~1074@ (Add (Mul (Mul (Add d4~40@ a4~34@) b4~36@) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Sub b4~36@ b4~36@) (Mul d4~40@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~1013@ temp_4_1~1074@))) (=> (= temp_4_0~1013@ temp_4_1~1074@) (=> (= temp_5_0~1159@ (Mul (Add (Mul c5~46@ (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Sub b5~44@ d5~48@))) (Sub (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ b5~44@)) (Sub (Mul c5~46@ d5~48@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1220@ (Mul (Add (Mul c5~46@ (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ a5~42@) (Sub b5~44@ d5~48@))) (Sub (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ b5~44@)) (Sub (Mul c5~46@ d5~48@) (Mul b5~44@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1159@ temp_5_1~1220@))) (=> (= temp_5_0~1159@ temp_5_1~1220@) (=> (= temp_6_0~1305@ (Mul (Mul (Add (Mul d6~56@ d6~56@) (Mul b6~52@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@))) (Mul (Add (Add b6~52@ b6~52@) (Mul b6~52@ b6~52@)) (Mul a6~50@ (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1366@ (Mul (Mul (Add (Mul d6~56@ d6~56@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ d6~56@))) (Mul (Add (Add b6~52@ b6~52@) (Mul b6~52@ b6~52@)) (Mul a6~50@ (Mul b6~52@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1305@ temp_6_1~1366@))) (=> (= temp_6_0~1305@ temp_6_1~1366@) (=> (= temp_7_0~1443@ (Mul (Mul b7~60@ (Add (Mul c7~62@ a7~58@) (Sub b7~60@ d7~64@))) (Mul (Sub (Mul a7~58@ b7~60@) (Add b7~60@ b7~60@)) (Add (Sub b7~60@ a7~58@) (Mul b7~60@ c7~62@))))) (=> (= temp_7_1~1496@ (Mul (Mul (Add (Mul c7~62@ a7~58@) (Sub b7~60@ d7~64@)) b7~60@) (Mul (Sub (Mul a7~58@ b7~60@) (Add b7~60@ b7~60@)) (Add (Sub b7~60@ a7~58@) (Mul b7~60@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1443@ temp_7_1~1496@))) (=> (= temp_7_0~1443@ temp_7_1~1496@) (=> (= temp_8_0~1581@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) d8~72@) (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))) (Sub (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1642@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) d8~72@) (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ d8~72@))) (Sub (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1581@ temp_8_1~1642@))) (=> (= temp_8_0~1581@ temp_8_1~1642@) (=> (= temp_9_0~1731@ (Sub (Mul (Mul (Mul d9~80@ b9~76@) (Add a9~74@ a9~74@)) (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul a9~74@ b9~76@) (Sub d9~80@ c9~78@)) (Mul (Mul c9~78@ c9~78@) (Add a9~74@ d9~80@))))) (=> (= temp_9_1~1796@ (Sub (Mul (Mul (Mul d9~80@ b9~76@) (Add a9~74@ a9~74@)) (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul a9~74@ b9~76@) (Sub d9~80@ c9~78@)) (Mul (Mul c9~78@ c9~78@) (Add a9~74@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1731@ temp_9_1~1796@))) (=> (= temp_9_0~1731@ temp_9_1~1796@) (=> (= temp_10_0~1873@ (Sub (Sub (Mul (Mul d10~88@ c10~86@) (Sub d10~88@ c10~86@)) b10~84@) (Mul (Mul (Mul c10~86@ b10~84@) (Sub a10~82@ d10~88@)) (Mul (Sub a10~82@ a10~82@) (Mul b10~84@ a10~82@))))) (=> (= temp_10_1~1934@ (Sub (Sub (Sub (Mul (Mul d10~88@ c10~86@) d10~88@) (Mul (Mul d10~88@ c10~86@) c10~86@)) b10~84@) (Mul (Mul (Mul c10~86@ b10~84@) (Sub a10~82@ d10~88@)) (Mul (Sub a10~82@ a10~82@) (Mul b10~84@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1873@ temp_10_1~1934@))) (=> (= temp_10_0~1873@ temp_10_1~1934@) (=> (= temp_11_0~2015@ (Sub (Mul (Sub (Mul a11~90@ b11~92@) (Sub d11~96@ c11~94@)) (Mul (Mul d11~96@ a11~90@) a11~90@)) (Mul (Mul d11~96@ (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2072@ (Sub (Mul (Sub (Mul b11~92@ a11~90@) (Sub d11~96@ c11~94@)) (Mul (Mul d11~96@ a11~90@) a11~90@)) (Mul (Mul d11~96@ (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2015@ temp_11_1~2072@))) (=> (= temp_11_0~2015@ temp_11_1~2072@) (=> (= temp_12_0~2133@ (Mul (Add (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ c12~102@)) (Add (Add c12~102@ b12~100@) (Mul a12~98@ a12~98@))) a12~98@)) (=> (= temp_12_1~2170@ (Mul a12~98@ (Add (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ c12~102@)) (Add (Add c12~102@ b12~100@) (Mul a12~98@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2133@ temp_12_1~2170@))) (=> (= temp_12_0~2133@ temp_12_1~2170@) (=> (= temp_13_0~2255@ (Add (Mul (Mul (Mul a13~106@ b13~108@) a13~106@) (Sub (Mul b13~108@ c13~110@) (Sub a13~106@ b13~108@))) (Mul (Add (Add c13~110@ b13~108@) (Mul d13~112@ b13~108@)) (Sub (Mul b13~108@ a13~106@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2316@ (Add (Mul (Mul (Mul b13~108@ a13~106@) a13~106@) (Sub (Mul b13~108@ c13~110@) (Sub a13~106@ b13~108@))) (Mul (Add (Add c13~110@ b13~108@) (Mul d13~112@ b13~108@)) (Sub (Mul b13~108@ a13~106@) (Mul d13~112@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2255@ temp_13_1~2316@))) (=> (= temp_13_0~2255@ temp_13_1~2316@) (=> (= temp_14_0~2405@ (Mul (Mul (Sub (Add c14~118@ d14~120@) (Mul c14~118@ a14~114@)) (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ d14~120@)) (Sub (Mul a14~114@ c14~118@) (Sub c14~118@ a14~114@))))) (=> (= temp_14_1~2470@ (Mul (Mul (Sub (Add c14~118@ d14~120@) (Mul c14~118@ a14~114@)) (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul d14~120@ a14~114@)) (Sub (Mul a14~114@ c14~118@) (Sub c14~118@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2405@ temp_14_1~2470@))) (=> (= temp_14_0~2405@ temp_14_1~2470@) (=> (= temp_15_0~2559@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul c15~126@ a15~122@)) (Mul (Add c15~126@ c15~126@) (Mul a15~122@ a15~122@))) (Mul (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ a15~122@)) (Sub (Mul a15~122@ c15~126@) (Mul a15~122@ a15~122@))))) (=> (= temp_15_1~2624@ (Mul (Mul (Mul (Mul (Mul b15~124@ a15~122@) c15~126@) a15~122@) (Mul (Add c15~126@ c15~126@) (Mul a15~122@ a15~122@))) (Mul (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ a15~122@)) (Sub (Mul a15~122@ c15~126@) (Mul a15~122@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2559@ temp_15_1~2624@))) (=> (= temp_15_0~2559@ temp_15_1~2624@) (=> (= temp_16_0~2709@ (Mul (Add (Mul (Mul a16~130@ a16~130@) (Sub d16~136@ a16~130@)) (Mul b16~132@ (Mul b16~132@ c16~134@))) (Mul (Mul (Mul a16~130@ d16~136@) (Add b16~132@ d16~136@)) (Mul (Mul a16~130@ a16~130@) (Mul c16~134@ b16~132@))))) (=> (= temp_16_1~2778@ (Mul (Add (Mul (Mul a16~130@ a16~130@) (Sub d16~136@ a16~130@)) (Mul b16~132@ (Mul b16~132@ c16~134@))) (Mul (Add (Mul (Mul a16~130@ d16~136@) b16~132@) (Mul (Mul a16~130@ d16~136@) d16~136@)) (Mul (Mul a16~130@ a16~130@) (Mul c16~134@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2709@ temp_16_1~2778@))) (=> (= temp_16_0~2709@ temp_16_1~2778@) (=> (= temp_17_0~2867@ (Mul (Mul (Mul (Mul c17~142@ c17~142@) (Mul b17~140@ d17~144@)) (Mul (Mul d17~144@ a17~138@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul d17~144@ d17~144@) (Add b17~140@ d17~144@)) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ a17~138@))))) (=> (= temp_17_1~2932@ (Mul (Mul (Mul (Mul d17~144@ a17~138@) (Mul b17~140@ d17~144@)) (Mul (Mul c17~142@ c17~142@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul d17~144@ d17~144@) (Add b17~140@ d17~144@)) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ a17~138@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2867@ temp_17_1~2932@))) (=> (= temp_17_0~2867@ temp_17_1~2932@) (=> (= temp_18_0~3021@ (Sub (Sub (Mul (Mul b18~148@ d18~152@) (Add c18~150@ a18~146@)) (Mul (Mul d18~152@ b18~148@) (Sub b18~148@ d18~152@))) (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ c18~150@)) (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ c18~150@))))) (=> (= temp_18_1~3086@ (Sub (Sub (Mul (Mul b18~148@ d18~152@) (Add c18~150@ a18~146@)) (Mul (Mul b18~148@ d18~152@) (Sub b18~148@ d18~152@))) (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ c18~150@)) (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3021@ temp_18_1~3086@))) (=> (= temp_18_0~3021@ temp_18_1~3086@) (=> (= temp_19_0~3195@ (Mul (Add (Mul (Mul d19~160@ a19~154@) 95) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ a19~154@))) (Mul (Mul (Mul b19~156@ c19~158@) (Mul b19~156@ d19~160@)) (Mul (Add 86 d19~160@) (Mul b19~156@ b19~156@))))) (=> (= temp_19_1~3280@ (Mul (Mul (Add (Mul (Mul d19~160@ a19~154@) 95) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ a19~154@))) (Mul (Mul b19~156@ c19~158@) (Mul b19~156@ d19~160@))) (Mul (Add 86 d19~160@) (Mul b19~156@ b19~156@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3195@ temp_19_1~3280@))) (=> (= temp_19_0~3195@ temp_19_1~3280@) (=> (= temp_20_0~3365@ (Mul (Mul (Add (Sub d20~168@ c20~166@) (Add a20~162@ c20~166@)) (Mul (Mul d20~168@ c20~166@) (Mul c20~166@ d20~168@))) (Mul (Mul (Mul d20~168@ b20~164@) d20~168@) (Sub (Sub d20~168@ a20~162@) (Sub b20~164@ a20~162@))))) (=> (= temp_20_1~3426@ (Mul (Mul (Add (Sub d20~168@ c20~166@) (Add a20~162@ c20~166@)) (Mul (Mul c20~166@ d20~168@) (Mul d20~168@ c20~166@))) (Mul (Mul (Mul d20~168@ b20~164@) d20~168@) (Sub (Sub d20~168@ a20~162@) (Sub b20~164@ a20~162@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3365@ temp_20_1~3426@))) (=> (= temp_20_0~3365@ temp_20_1~3426@) (=> (= temp_21_0~3539@ (Sub (Mul (Mul (Mul c21~174@ b21~172@) (Mul c21~174@ d21~176@)) (Mul (Mul b21~172@ a21~170@) (Mul a21~170@ c21~174@))) (Mul (Mul (Sub d21~176@ b21~172@) (Mul 46 91)) (Sub (Sub c21~174@ b21~172@) (Mul c21~174@ b21~172@))))) (=> (= temp_21_1~3628@ (Sub (Mul (Mul (Mul c21~174@ b21~172@) (Mul d21~176@ c21~174@)) (Mul (Mul b21~172@ a21~170@) (Mul a21~170@ c21~174@))) (Mul (Mul (Sub d21~176@ b21~172@) (Mul 46 91)) (Sub (Sub c21~174@ b21~172@) (Mul c21~174@ b21~172@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3539@ temp_21_1~3628@))) (=> (= temp_21_0~3539@ temp_21_1~3628@) (=> (= temp_22_0~3713@ (Mul (Add (Mul (Mul a22~178@ c22~182@) c22~182@) (Add (Mul c22~182@ d22~184@) (Mul d22~184@ b22~180@))) (Mul (Sub (Mul c22~182@ b22~180@) (Mul c22~182@ b22~180@)) (Mul (Mul b22~180@ a22~178@) (Mul c22~182@ b22~180@))))) (=> (= temp_22_1~3774@ (Mul (Add (Mul (Mul a22~178@ c22~182@) c22~182@) (Add (Mul c22~182@ d22~184@) (Mul d22~184@ b22~180@))) (Mul (Mul (Sub (Mul c22~182@ b22~180@) (Mul c22~182@ b22~180@)) (Mul b22~180@ a22~178@)) (Mul c22~182@ b22~180@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3713@ temp_22_1~3774@))) (=> (= temp_22_0~3713@ temp_22_1~3774@) (=> (= temp_23_0~3851@ (Mul (Mul (Sub (Sub c23~190@ d23~192@) (Mul d23~192@ b23~188@)) (Mul (Add d23~192@ a23~186@) (Mul a23~186@ b23~188@))) (Mul (Mul (Mul d23~192@ c23~190@) (Mul b23~188@ b23~188@)) d23~192@))) (=> (= temp_23_1~3904@ (Mul (Mul (Sub (Sub c23~190@ d23~192@) (Mul d23~192@ b23~188@)) (Mul (Add d23~192@ a23~186@) (Mul b23~188@ a23~186@))) (Mul (Mul (Mul d23~192@ c23~190@) (Mul b23~188@ b23~188@)) d23~192@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3851@ temp_23_1~3904@))) (=> (= temp_23_0~3851@ temp_23_1~3904@) (=> (= temp_24_0~3981@ (Mul (Mul a24~194@ d24~200@) (Mul (Mul (Mul d24~200@ d24~200@) (Mul d24~200@ 16)) (Mul (Mul a24~194@ c24~198@) (Add b24~196@ a24~194@))))) (=> (= temp_24_1~4034@ (Mul (Mul a24~194@ d24~200@) (Mul (Mul (Mul d24~200@ d24~200@) (Mul d24~200@ 16)) (Mul a24~194@ (Mul c24~198@ (Add b24~196@ a24~194@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3981@ temp_24_1~4034@))) (=> (= temp_24_0~3981@ temp_24_1~4034@) (=> (= temp_25_0~4147@ (Mul (Sub (Add (Mul d25~208@ d25~208@) (Add a25~202@ a25~202@)) (Sub (Mul d25~208@ a25~202@) (Mul b25~204@ d25~208@))) (Mul (Mul (Mul a25~202@ a25~202@) (Mul 6 c25~206@)) (Mul (Mul b25~204@ d25~208@) (Sub d25~208@ 88))))) (=> (= temp_25_1~4236@ (Mul (Sub (Add (Mul d25~208@ d25~208@) (Add a25~202@ a25~202@)) (Sub (Mul d25~208@ a25~202@) (Mul b25~204@ d25~208@))) (Mul (Mul (Mul a25~202@ a25~202@) (Mul 6 c25~206@)) (Mul (Mul b25~204@ d25~208@) (Sub d25~208@ 88))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~4147@ temp_25_1~4236@))) (=> (= temp_25_0~4147@ temp_25_1~4236@) (=> (= temp_26_0~4313@ (Mul (Mul b26~212@ (Sub (Mul b26~212@ b26~212@) (Sub b26~212@ a26~210@))) (Add (Mul (Mul c26~214@ b26~212@) (Mul b26~212@ b26~212@)) (Add (Mul b26~212@ d26~216@) (Mul a26~210@ c26~214@))))) (=> (= temp_26_1~4366@ (Mul (Mul (Sub (Mul b26~212@ b26~212@) (Sub b26~212@ a26~210@)) b26~212@) (Add (Mul (Mul c26~214@ b26~212@) (Mul b26~212@ b26~212@)) (Add (Mul b26~212@ d26~216@) (Mul a26~210@ c26~214@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%26 (= temp_26_0~4313@ temp_26_1~4366@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
