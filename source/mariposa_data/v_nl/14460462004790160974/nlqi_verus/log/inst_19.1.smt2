...
(set-info :comment ";; mariposa_data/v_nl//14460462004790160974/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_7_0~1409@ Int)
(declare-const temp_7_1~1462@ Int)
(declare-const temp_8_0~1557@ Int)
(declare-const temp_8_1~1618@ Int)
(declare-const temp_9_0~1757@ Int)
(declare-const temp_9_1~1818@ Int)
...
(declare-const temp_12_0~2203@ Int)
(declare-const temp_12_1~2264@ Int)
(declare-const temp_13_0~2379@ Int)
(declare-const temp_13_1~2444@ Int)
(declare-const temp_14_0~2537@ Int)
(declare-const temp_14_1~2602@ Int)
(declare-const temp_15_0~2729@ Int)
(declare-const temp_15_1~2806@ Int)
(declare-const temp_16_0~2893@ Int)
(declare-const temp_16_1~2946@ Int)
(declare-const temp_17_0~3023@ Int)
(declare-const temp_17_1~3084@ Int)
(declare-const temp_18_0~3207@ Int)
(declare-const temp_18_1~3272@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ b0~4@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ b0~4@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ c0~6@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~459@ (Sub (Mul (Sub (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul c1~14@ c1~14@) (Add b1~12@ a1~10@)) (Mul a1~10@ (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~520@ (Sub (Mul (Sub (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ a1~10@))) (Mul (Mul c1~14@ (Mul c1~14@ (Add b1~12@ a1~10@))) (Mul a1~10@ (Mul b1~12@ d1~16@))))) (and (=> (= tmp%1@ (Add b1~12@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c1~14@ c1~14@ tmp%1@) (=> %%location_label%%1 (= temp_1_0~459@ temp_1_1~520@)))) (=> (= temp_1_0~459@ temp_1_1~520@) (=> (= temp_2_0~619@ (Mul (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Sub b2~20@ b2~20@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~684@ (Mul (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Sub b2~20@ b2~20@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul (Mul d2~24@ b2~20@) a2~18@) a2~18@) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@))))) (and (=> (= tmp%2@ (Mul d2~24@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ a2~18@ a2~18@) (=> %%location_label%%2 (= temp_2_0~619@ temp_2_1~684@)))) (=> (= temp_2_0~619@ temp_2_1~684@) (=> (= temp_3_0~767@ (Add (Sub (Mul (Mul d3~32@ a3~26@) d3~32@) c3~30@) (Mul (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~816@ (Add (Sub (Mul (Mul d3~32@ a3~26@) d3~32@) c3~30@) (Mul (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@))))) (and (=> (= tmp%3@ (Mul c3~30@ c3~30@)) (=> (= tmp%4@ (Mul d3~32@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~767@ temp_3_1~816@))))) (=> (= temp_3_0~767@ temp_3_1~816@) (=> (= temp_4_0~917@ (Add (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@)) (Mul (Sub a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Sub (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~982@ (Add (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@)) (Mul (Sub a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ b4~36@)) (Sub (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@))))) (and (=> (= tmp%5@ (Sub (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@))) (=> (= tmp%6@ (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ b4~36@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~917@ temp_4_1~982@))))) (=> (= temp_4_0~917@ temp_4_1~982@) (=> (= temp_5_0~1099@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Sub a5~42@ b5~44@)) (Mul (Add c5~46@ d5~48@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~1164@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Sub a5~42@ b5~44@)) (Mul (Add c5~46@ d5~48@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b5~44@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1099@ temp_5_1~1164@))) (=> (= temp_5_0~1099@ temp_5_1~1164@) (=> (= temp_6_0~1257@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Add d6~56@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1322@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Add d6~56@ a6~50@)) (Mul (Mul (Mul d6~56@ b6~52@) d6~56@) b6~52@)) (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (and (=> (= tmp%7@ (Mul d6~56@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ d6~56@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1257@ temp_6_1~1322@)))) (=> (= temp_6_0~1257@ temp_6_1~1322@) (=> (= temp_7_0~1409@ (Mul (Mul (Add (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@)) d7~64@) (Add (Mul (Mul c7~62@ b7~60@) (Sub b7~60@ d7~64@)) (Mul (Add d7~64@ b7~60@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1462@ (Mul (Mul (Add (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@)) d7~64@) (Add (Mul c7~62@ (Mul b7~60@ (Sub b7~60@ d7~64@))) (Mul (Add d7~64@ b7~60@) (Mul c7~62@ d7~64@))))) (and (=> (= tmp%8@ (Sub b7~60@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c7~62@ b7~60@ tmp%8@) (=> %%location_label%%7 (= temp_7_0~1409@ temp_7_1~1462@)))) (=> (= temp_7_0~1409@ temp_7_1~1462@) (=> (= temp_8_0~1557@ (Mul (Mul (Mul b8~68@ (Mul 25 a8~66@)) (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@))) (Mul a8~66@ (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ c8~70@))))) (=> (= temp_8_1~1618@ (Mul (Mul b8~68@ (Mul 25 a8~66@)) (Mul (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@)) (Mul a8~66@ (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ c8~70@)))))) (and (=> (= tmp%9@ (Mul b8~68@ (Mul 25 a8~66@))) (=> (= tmp%10@ (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@))) (=> (= tmp%11@ (Mul a8~66@ (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ c8~70@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~1557@ temp_8_1~1618@)))))) (=> (= temp_8_0~1557@ temp_8_1~1618@) (=> (= temp_9_0~1757@ (Mul (Add (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)) (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Mul (Add a9~74@ a9~74@) (Sub d9~80@ d9~80@)) (Mul b9~76@ (Sub b9~76@ d9~80@))))) (=> (= temp_9_1~1818@ (Mul (Mul (Add (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)) (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Add a9~74@ a9~74@) (Sub d9~80@ d9~80@))) (Mul b9~76@ (Sub b9~76@ d9~80@)))) (and (=> (= tmp%12@ (Add (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)) (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@)))) (=> (= tmp%13@ (Mul (Add a9~74@ a9~74@) (Sub d9~80@ d9~80@))) (=> (= tmp%14@ (Mul b9~76@ (Sub b9~76@ d9~80@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%9 (= temp_9_0~1757@ temp_9_1~1818@)))))) (=> (= temp_9_0~1757@ temp_9_1~1818@) (=> (= temp_10_0~1961@ (Sub (Add (Mul (Add b10~84@ c10~86@) (Mul c10~86@ b10~84@)) (Sub (Add d10~88@ c10~86@) (Mul b10~84@ b10~84@))) (Mul (Sub (Mul b10~84@ d10~88@) (Add b10~84@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Sub a10~82@ b10~84@))))) (=> (= temp_10_1~2026@ (Sub (Add (Mul (Add b10~84@ c10~86@) (Mul b10~84@ c10~86@)) (Sub (Add d10~88@ c10~86@) (Mul b10~84@ b10~84@))) (Mul (Sub (Mul b10~84@ d10~88@) (Add b10~84@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Sub a10~82@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ b10~84@) (=> %%location_label%%10 (= temp_10_0~1961@ temp_10_1~2026@))) (=> (= temp_10_0~1961@ temp_10_1~2026@) (=> (= temp_11_0~2079@ (Mul d11~96@ (Mul a11~90@ (Mul (Mul d11~96@ a11~90@) (Add a11~90@ d11~96@))))) (=> (= temp_11_1~2104@ (Mul d11~96@ (Mul (Mul a11~90@ (Mul d11~96@ a11~90@)) (Add a11~90@ d11~96@)))) (and (=> (= tmp%15@ (Mul d11~96@ a11~90@)) (=> (= tmp%16@ (Add a11~90@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a11~90@ tmp%15@ tmp%16@) (=> %%location_label%%11 (= temp_11_0~2079@ temp_11_1~2104@))))) (=> (= temp_11_0~2079@ temp_11_1~2104@) (=> (= temp_12_0~2203@ (Mul (Sub (Mul (Sub a12~98@ a12~98@) a12~98@) (Mul (Mul c12~102@ b12~100@) (Add a12~98@ a12~98@))) (Mul (Mul (Sub c12~102@ d12~104@) (Sub d12~104@ d12~104@)) (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~2264@ (Mul (Sub (Mul (Sub a12~98@ a12~98@) a12~98@) (Mul (Mul c12~102@ b12~100@) (Add a12~98@ a12~98@))) (Mul (Sub c12~102@ d12~104@) (Mul (Sub d12~104@ d12~104@) (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@)))))) (and (=> (= tmp%17@ (Sub c12~102@ d12~104@)) (=> (= tmp%18@ (Sub d12~104@ d12~104@)) (=> (= tmp%19@ (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%12 (= temp_12_0~2203@ temp_12_1~2264@)))))) (=> (= temp_12_0~2203@ temp_12_1~2264@) (=> (= temp_13_0~2379@ (Sub (Mul (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ c13~110@)) (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ d13~112@))) (Mul (Add (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ c13~110@))))) (=> (= temp_13_1~2444@ (Sub (Mul (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ c13~110@)) (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ d13~112@))) (Mul (Add (Mul a13~106@ a13~106@) (Mul c13~110@ b13~108@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b13~108@ c13~110@) (=> %%location_label%%13 (= temp_13_0~2379@ temp_13_1~2444@))) (=> (= temp_13_0~2379@ temp_13_1~2444@) (=> (= temp_14_0~2537@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ b14~116@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Add c14~118@ b14~116@) (Mul a14~114@ b14~116@))))) (=> (= temp_14_1~2602@ (Mul (Mul (Mul b14~116@ a14~114@) (Mul (Mul b14~116@ a14~114@) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ b14~116@)))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Add c14~118@ b14~116@) (Mul a14~114@ b14~116@))))) (and (=> (= tmp%20@ (Mul b14~116@ a14~114@)) (=> (= tmp%21@ (Mul b14~116@ a14~114@)) (=> (= tmp%22@ (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ b14~116@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%14 (= temp_14_0~2537@ temp_14_1~2602@)))))) (=> (= temp_14_0~2537@ temp_14_1~2602@) (=> (= temp_15_0~2729@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ c15~126@)) (Mul (Mul c15~126@ b15~124@) (Add c15~126@ b15~124@))) (Mul (Mul (Add d15~128@ d15~128@) (Mul 5 d15~128@)) (Mul (Mul c15~126@ a15~122@) (Mul b15~124@ a15~122@))))) (=> (= temp_15_1~2806@ (Mul (Mul (Mul (Mul (Mul b15~124@ d15~128@) c15~126@) c15~126@) (Mul (Mul c15~126@ b15~124@) (Add c15~126@ b15~124@))) (Mul (Mul (Add d15~128@ d15~128@) (Mul 5 d15~128@)) (Mul (Mul c15~126@ a15~122@) (Mul b15~124@ a15~122@))))) (and (=> (= tmp%23@ (Mul b15~124@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ c15~126@ c15~126@) (=> %%location_label%%15 (= temp_15_0~2729@ temp_15_1~2806@)))) (=> (= temp_15_0~2729@ temp_15_1~2806@) (=> (= temp_16_0~2893@ (Mul (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ a16~130@)) a16~130@) (Sub (Mul (Add a16~130@ b16~132@) (Mul a16~130@ b16~132@)) (Sub (Mul b16~132@ c16~134@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2946@ (Mul (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ a16~130@)) a16~130@) (Sub (Mul (Mul a16~130@ b16~132@) (Add a16~130@ b16~132@)) (Sub (Mul b16~132@ c16~134@) (Mul c16~134@ a16~130@))))) (and (=> (= tmp%24@ (Add a16~130@ b16~132@)) (=> (= tmp%25@ (Mul a16~130@ b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%24@ tmp%25@) (=> %%location_label%%16 (= temp_16_0~2893@ temp_16_1~2946@))))) (=> (= temp_16_0~2893@ temp_16_1~2946@) (=> (= temp_17_0~3023@ (Mul (Mul d17~144@ (Mul (Mul d17~144@ b17~140@) (Add d17~144@ d17~144@))) (Sub c17~142@ (Mul (Mul c17~142@ b17~140@) (Mul b17~140@ b17~140@))))) (=> (= temp_17_1~3084@ (Sub (Mul (Mul d17~144@ (Mul (Mul d17~144@ b17~140@) (Add d17~144@ d17~144@))) c17~142@) (Mul (Mul d17~144@ (Mul (Mul d17~144@ b17~140@) (Add d17~144@ d17~144@))) (Mul (Mul c17~142@ b17~140@) (Mul b17~140@ b17~140@))))) (and (=> (= tmp%26@ (Mul d17~144@ (Mul (Mul d17~144@ b17~140@) (Add d17~144@ d17~144@)))) (=> (= tmp%27@ (Mul (Mul c17~142@ b17~140@) (Mul b17~140@ b17~140@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%26@ c17~142@ tmp%27@) (=> %%location_label%%17 (= temp_17_0~3023@ temp_17_1~3084@))))) (=> (= temp_17_0~3023@ temp_17_1~3084@) (=> (= temp_18_0~3207@ (Mul (Add (Add (Mul d18~152@ c18~150@) (Mul d18~152@ a18~146@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ b18~148@))) (Mul (Mul (Mul c18~150@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~3272@ (Mul (Add (Add (Mul d18~152@ c18~150@) (Mul d18~152@ a18~146@)) (Mul (Mul d18~152@ d18~152@) (Mul b18~148@ d18~152@))) (Mul (Mul (Mul c18~150@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ d18~152@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d18~152@ b18~148@) (=> %%location_label%%18 (= temp_18_0~3207@ temp_18_1~3272@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
