...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ b0~4@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ b0~4@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~446@ (Sub (Mul (Sub (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul c1~14@ c1~14@) (Add b1~12@ a1~10@)) (Mul a1~10@ (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~507@ (Sub (Mul (Sub (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ a1~10@))) (Mul (Mul c1~14@ (Mul c1~14@ (Add b1~12@ a1~10@))) (Mul a1~10@ (Mul b1~12@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~446@ temp_1_1~507@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~587@ (Mul (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Sub b2~20@ b2~20@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~652@ (Mul (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Sub b2~20@ b2~20@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul (Mul d2~24@ b2~20@) a2~18@) a2~18@) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~587@ temp_2_1~652@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~716@ (Add (Sub (Mul (Mul d3~32@ a3~26@) d3~32@) c3~30@) (Mul (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~765@ (Add (Sub (Mul (Mul d3~32@ a3~26@) d3~32@) c3~30@) (Mul (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~716@ temp_3_1~765@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~845@ (Add (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@)) (Mul (Sub a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Sub (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~910@ (Add (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@)) (Mul (Sub a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ b4~36@)) (Sub (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~845@ temp_4_1~910@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~990@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Sub a5~42@ b5~44@)) (Mul (Add c5~46@ d5~48@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~1055@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Sub a5~42@ b5~44@)) (Mul (Add c5~46@ d5~48@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~990@ temp_5_1~1055@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1135@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Add d6~56@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1200@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Add d6~56@ a6~50@)) (Mul (Mul (Mul d6~56@ b6~52@) d6~56@) b6~52@)) (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1135@ temp_6_1~1200@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1268@ (Mul (Mul (Add (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@)) d7~64@) (Add (Mul (Mul c7~62@ b7~60@) (Sub b7~60@ d7~64@)) (Mul (Add d7~64@ b7~60@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1321@ (Mul (Mul (Add (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@)) d7~64@) (Add (Mul c7~62@ (Mul b7~60@ (Sub b7~60@ d7~64@))) (Mul (Add d7~64@ b7~60@) (Mul c7~62@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1268@ temp_7_1~1321@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1397@ (Mul (Mul (Mul b8~68@ (Mul 25 a8~66@)) (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@))) (Mul a8~66@ (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ c8~70@))))) (=> (= temp_8_1~1458@ (Mul (Mul b8~68@ (Mul 25 a8~66@)) (Mul (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@)) (Mul a8~66@ (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ c8~70@)))))) (=> (= tmp%9@ (= temp_8_0~1397@ temp_8_1~1458@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1534@ (Mul (Add (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)) (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Mul (Add a9~74@ a9~74@) (Sub d9~80@ d9~80@)) (Mul b9~76@ (Sub b9~76@ d9~80@))))) (=> (= temp_9_1~1595@ (Mul (Mul (Add (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)) (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Add a9~74@ a9~74@) (Sub d9~80@ d9~80@))) (Mul b9~76@ (Sub b9~76@ d9~80@)))) (=> (= tmp%10@ (= temp_9_0~1534@ temp_9_1~1595@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1675@ (Sub (Add (Mul (Add b10~84@ c10~86@) (Mul c10~86@ b10~84@)) (Sub (Add d10~88@ c10~86@) (Mul b10~84@ b10~84@))) (Mul (Sub (Mul b10~84@ d10~88@) (Add b10~84@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Sub a10~82@ b10~84@))))) (=> (= temp_10_1~1740@ (Sub (Add (Mul (Add b10~84@ c10~86@) (Mul b10~84@ c10~86@)) (Sub (Add d10~88@ c10~86@) (Mul b10~84@ b10~84@))) (Mul (Sub (Mul b10~84@ d10~88@) (Add b10~84@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Sub a10~82@ b10~84@))))) (=> (= tmp%11@ (= temp_10_0~1675@ temp_10_1~1740@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1780@ (Mul d11~96@ (Mul a11~90@ (Mul (Mul d11~96@ a11~90@) (Add a11~90@ d11~96@))))) (=> (= temp_11_1~1805@ (Mul d11~96@ (Mul (Mul a11~90@ (Mul d11~96@ a11~90@)) (Add a11~90@ d11~96@)))) (=> (= tmp%12@ (= temp_11_0~1780@ temp_11_1~1805@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1881@ (Mul (Sub (Mul (Sub a12~98@ a12~98@) a12~98@) (Mul (Mul c12~102@ b12~100@) (Add a12~98@ a12~98@))) (Mul (Mul (Sub c12~102@ d12~104@) (Sub d12~104@ d12~104@)) (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~1942@ (Mul (Sub (Mul (Sub a12~98@ a12~98@) a12~98@) (Mul (Mul c12~102@ b12~100@) (Add a12~98@ a12~98@))) (Mul (Sub c12~102@ d12~104@) (Mul (Sub d12~104@ d12~104@) (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@)))))) (=> (= tmp%13@ (= temp_12_0~1881@ temp_12_1~1942@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2022@ (Sub (Mul (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ c13~110@)) (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ d13~112@))) (Mul (Add (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ c13~110@))))) (=> (= temp_13_1~2087@ (Sub (Mul (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ c13~110@)) (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ d13~112@))) (Mul (Add (Mul a13~106@ a13~106@) (Mul c13~110@ b13~108@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2022@ temp_13_1~2087@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2167@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ b14~116@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Add c14~118@ b14~116@) (Mul a14~114@ b14~116@))))) (=> (= temp_14_1~2232@ (Mul (Mul (Mul b14~116@ a14~114@) (Mul (Mul b14~116@ a14~114@) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ b14~116@)))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Add c14~118@ b14~116@) (Mul a14~114@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2167@ temp_14_1~2232@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2324@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ c15~126@)) (Mul (Mul c15~126@ b15~124@) (Add c15~126@ b15~124@))) (Mul (Mul (Add d15~128@ d15~128@) (Mul 5 d15~128@)) (Mul (Mul c15~126@ a15~122@) (Mul b15~124@ a15~122@))))) (=> (= temp_15_1~2401@ (Mul (Mul (Mul (Mul (Mul b15~124@ d15~128@) c15~126@) c15~126@) (Mul (Mul c15~126@ b15~124@) (Add c15~126@ b15~124@))) (Mul (Mul (Add d15~128@ d15~128@) (Mul 5 d15~128@)) (Mul (Mul c15~126@ a15~122@) (Mul b15~124@ a15~122@))))) (=> (= tmp%16@ (= temp_15_0~2324@ temp_15_1~2401@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2469@ (Mul (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ a16~130@)) a16~130@) (Sub (Mul (Add a16~130@ b16~132@) (Mul a16~130@ b16~132@)) (Sub (Mul b16~132@ c16~134@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2522@ (Mul (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ a16~130@)) a16~130@) (Sub (Mul (Mul a16~130@ b16~132@) (Add a16~130@ b16~132@)) (Sub (Mul b16~132@ c16~134@) (Mul c16~134@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2469@ temp_16_1~2522@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2578@ (Mul (Mul d17~144@ (Mul (Mul d17~144@ b17~140@) (Add d17~144@ d17~144@))) (Sub c17~142@ (Mul (Mul c17~142@ b17~140@) (Mul b17~140@ b17~140@))))) (=> (= temp_17_1~2639@ (Sub (Mul (Mul d17~144@ (Mul (Mul d17~144@ b17~140@) (Add d17~144@ d17~144@))) c17~142@) (Mul (Mul d17~144@ (Mul (Mul d17~144@ b17~140@) (Add d17~144@ d17~144@))) (Mul (Mul c17~142@ b17~140@) (Mul b17~140@ b17~140@))))) (=> (= tmp%18@ (= temp_17_0~2578@ temp_17_1~2639@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2719@ (Mul (Add (Add (Mul d18~152@ c18~150@) (Mul d18~152@ a18~146@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ b18~148@))) (Mul (Mul (Mul c18~150@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~2784@ (Mul (Add (Add (Mul d18~152@ c18~150@) (Mul d18~152@ a18~146@)) (Mul (Mul d18~152@ d18~152@) (Mul b18~148@ d18~152@))) (Mul (Mul (Mul c18~150@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ d18~152@))))) (=> (= tmp%19@ (= temp_18_0~2719@ temp_18_1~2784@)) (=> %%location_label%%18 tmp%19@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
