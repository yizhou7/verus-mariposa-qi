...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ b0~4@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ b0~4@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~455@ (Sub (Mul (Sub (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul c1~14@ c1~14@) (Add b1~12@ a1~10@)) (Mul a1~10@ (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~516@ (Sub (Mul (Sub (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ a1~10@))) (Mul (Mul c1~14@ (Mul c1~14@ (Add b1~12@ a1~10@))) (Mul a1~10@ (Mul b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~455@ temp_1_1~516@))) (=> (= temp_1_0~455@ temp_1_1~516@) (=> (= temp_2_0~605@ (Mul (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Sub b2~20@ b2~20@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~670@ (Mul (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Sub b2~20@ b2~20@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul (Mul d2~24@ b2~20@) a2~18@) a2~18@) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~605@ temp_2_1~670@))) (=> (= temp_2_0~605@ temp_2_1~670@) (=> (= temp_3_0~743@ (Add (Sub (Mul (Mul d3~32@ a3~26@) d3~32@) c3~30@) (Mul (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~792@ (Add (Sub (Mul (Mul d3~32@ a3~26@) d3~32@) c3~30@) (Mul (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~743@ temp_3_1~792@))) (=> (= temp_3_0~743@ temp_3_1~792@) (=> (= temp_4_0~881@ (Add (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@)) (Mul (Sub a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Sub (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~946@ (Add (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@)) (Mul (Sub a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ b4~36@)) (Sub (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~881@ temp_4_1~946@))) (=> (= temp_4_0~881@ temp_4_1~946@) (=> (= temp_5_0~1035@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Sub a5~42@ b5~44@)) (Mul (Add c5~46@ d5~48@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~1100@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Sub a5~42@ b5~44@)) (Mul (Add c5~46@ d5~48@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1035@ temp_5_1~1100@))) (=> (= temp_5_0~1035@ temp_5_1~1100@) (=> (= temp_6_0~1189@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Add d6~56@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1254@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Add d6~56@ a6~50@)) (Mul (Mul (Mul d6~56@ b6~52@) d6~56@) b6~52@)) (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1189@ temp_6_1~1254@))) (=> (= temp_6_0~1189@ temp_6_1~1254@) (=> (= temp_7_0~1331@ (Mul (Mul (Add (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@)) d7~64@) (Add (Mul (Mul c7~62@ b7~60@) (Sub b7~60@ d7~64@)) (Mul (Add d7~64@ b7~60@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1384@ (Mul (Mul (Add (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@)) d7~64@) (Add (Mul c7~62@ (Mul b7~60@ (Sub b7~60@ d7~64@))) (Mul (Add d7~64@ b7~60@) (Mul c7~62@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1331@ temp_7_1~1384@))) (=> (= temp_7_0~1331@ temp_7_1~1384@) (=> (= temp_8_0~1469@ (Mul (Mul (Mul b8~68@ (Mul 25 a8~66@)) (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@))) (Mul a8~66@ (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ c8~70@))))) (=> (= temp_8_1~1530@ (Mul (Mul b8~68@ (Mul 25 a8~66@)) (Mul (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@)) (Mul a8~66@ (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ c8~70@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1469@ temp_8_1~1530@))) (=> (= temp_8_0~1469@ temp_8_1~1530@) (=> (= temp_9_0~1615@ (Mul (Add (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)) (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Mul (Add a9~74@ a9~74@) (Sub d9~80@ d9~80@)) (Mul b9~76@ (Sub b9~76@ d9~80@))))) (=> (= temp_9_1~1676@ (Mul (Mul (Add (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)) (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Add a9~74@ a9~74@) (Sub d9~80@ d9~80@))) (Mul b9~76@ (Sub b9~76@ d9~80@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1615@ temp_9_1~1676@))) (=> (= temp_9_0~1615@ temp_9_1~1676@) (=> (= temp_10_0~1765@ (Sub (Add (Mul (Add b10~84@ c10~86@) (Mul c10~86@ b10~84@)) (Sub (Add d10~88@ c10~86@) (Mul b10~84@ b10~84@))) (Mul (Sub (Mul b10~84@ d10~88@) (Add b10~84@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Sub a10~82@ b10~84@))))) (=> (= temp_10_1~1830@ (Sub (Add (Mul (Add b10~84@ c10~86@) (Mul b10~84@ c10~86@)) (Sub (Add d10~88@ c10~86@) (Mul b10~84@ b10~84@))) (Mul (Sub (Mul b10~84@ d10~88@) (Add b10~84@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Sub a10~82@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1765@ temp_10_1~1830@))) (=> (= temp_10_0~1765@ temp_10_1~1830@) (=> (= temp_11_0~1879@ (Mul d11~96@ (Mul a11~90@ (Mul (Mul d11~96@ a11~90@) (Add a11~90@ d11~96@))))) (=> (= temp_11_1~1904@ (Mul d11~96@ (Mul (Mul a11~90@ (Mul d11~96@ a11~90@)) (Add a11~90@ d11~96@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1879@ temp_11_1~1904@))) (=> (= temp_11_0~1879@ temp_11_1~1904@) (=> (= temp_12_0~1989@ (Mul (Sub (Mul (Sub a12~98@ a12~98@) a12~98@) (Mul (Mul c12~102@ b12~100@) (Add a12~98@ a12~98@))) (Mul (Mul (Sub c12~102@ d12~104@) (Sub d12~104@ d12~104@)) (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~2050@ (Mul (Sub (Mul (Sub a12~98@ a12~98@) a12~98@) (Mul (Mul c12~102@ b12~100@) (Add a12~98@ a12~98@))) (Mul (Sub c12~102@ d12~104@) (Mul (Sub d12~104@ d12~104@) (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~1989@ temp_12_1~2050@))) (=> (= temp_12_0~1989@ temp_12_1~2050@) (=> (= temp_13_0~2139@ (Sub (Mul (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ c13~110@)) (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ d13~112@))) (Mul (Add (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ c13~110@))))) (=> (= temp_13_1~2204@ (Sub (Mul (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ c13~110@)) (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ d13~112@))) (Mul (Add (Mul a13~106@ a13~106@) (Mul c13~110@ b13~108@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2139@ temp_13_1~2204@))) (=> (= temp_13_0~2139@ temp_13_1~2204@) (=> (= temp_14_0~2293@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ b14~116@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Add c14~118@ b14~116@) (Mul a14~114@ b14~116@))))) (=> (= temp_14_1~2358@ (Mul (Mul (Mul b14~116@ a14~114@) (Mul (Mul b14~116@ a14~114@) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ b14~116@)))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Add c14~118@ b14~116@) (Mul a14~114@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2293@ temp_14_1~2358@))) (=> (= temp_14_0~2293@ temp_14_1~2358@) (=> (= temp_15_0~2459@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ c15~126@)) (Mul (Mul c15~126@ b15~124@) (Add c15~126@ b15~124@))) (Mul (Mul (Add d15~128@ d15~128@) (Mul 5 d15~128@)) (Mul (Mul c15~126@ a15~122@) (Mul b15~124@ a15~122@))))) (=> (= temp_15_1~2536@ (Mul (Mul (Mul (Mul (Mul b15~124@ d15~128@) c15~126@) c15~126@) (Mul (Mul c15~126@ b15~124@) (Add c15~126@ b15~124@))) (Mul (Mul (Add d15~128@ d15~128@) (Mul 5 d15~128@)) (Mul (Mul c15~126@ a15~122@) (Mul b15~124@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2459@ temp_15_1~2536@))) (=> (= temp_15_0~2459@ temp_15_1~2536@) (=> (= temp_16_0~2613@ (Mul (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ a16~130@)) a16~130@) (Sub (Mul (Add a16~130@ b16~132@) (Mul a16~130@ b16~132@)) (Sub (Mul b16~132@ c16~134@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2666@ (Mul (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ a16~130@)) a16~130@) (Sub (Mul (Mul a16~130@ b16~132@) (Add a16~130@ b16~132@)) (Sub (Mul b16~132@ c16~134@) (Mul c16~134@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2613@ temp_16_1~2666@))) (=> (= temp_16_0~2613@ temp_16_1~2666@) (=> (= temp_17_0~2731@ (Mul (Mul d17~144@ (Mul (Mul d17~144@ b17~140@) (Add d17~144@ d17~144@))) (Sub c17~142@ (Mul (Mul c17~142@ b17~140@) (Mul b17~140@ b17~140@))))) (=> (= temp_17_1~2792@ (Sub (Mul (Mul d17~144@ (Mul (Mul d17~144@ b17~140@) (Add d17~144@ d17~144@))) c17~142@) (Mul (Mul d17~144@ (Mul (Mul d17~144@ b17~140@) (Add d17~144@ d17~144@))) (Mul (Mul c17~142@ b17~140@) (Mul b17~140@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2731@ temp_17_1~2792@))) (=> (= temp_17_0~2731@ temp_17_1~2792@) (=> (= temp_18_0~2881@ (Mul (Add (Add (Mul d18~152@ c18~150@) (Mul d18~152@ a18~146@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ b18~148@))) (Mul (Mul (Mul c18~150@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~2946@ (Mul (Add (Add (Mul d18~152@ c18~150@) (Mul d18~152@ a18~146@)) (Mul (Mul d18~152@ d18~152@) (Mul b18~148@ d18~152@))) (Mul (Mul (Mul c18~150@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ d18~152@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2881@ temp_18_1~2946@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
