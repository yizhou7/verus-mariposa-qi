...
(set-info :comment ";; mariposa_data/v_nl//7657017263690095665/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Add a0~2@ b0~4@))) (Mul (Sub c0~6@ (Sub b0~4@ a0~2@)) d0~8@))) (=> (= temp_0_1~338@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Add a0~2@ b0~4@))) (Mul d0~8@ (Sub c0~6@ (Sub b0~4@ a0~2@))))) (and (=> (= tmp%1@ (Sub c0~6@ (Sub b0~4@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ d0~8@) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~338@)))) (=> (= temp_0_0~289@ temp_0_1~338@) (=> (= temp_1_0~463@ (Mul (Mul (Mul (Mul 42 b1~12@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Sub (Mul (Mul d1~16@ c1~14@) (Add d1~16@ b1~12@)) (Mul (Add b1~12@ d1~16@) (Mul 85 c1~14@))))) (=> (= temp_1_1~552@ (Mul (Mul (Mul (Mul 42 b1~12@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Sub (Mul (Mul d1~16@ c1~14@) (Add d1~16@ b1~12@)) (Mul (Mul 85 c1~14@) (Add b1~12@ d1~16@))))) (and (=> (= tmp%2@ (Add b1~12@ d1~16@)) (=> (= tmp%3@ (Mul 85 c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~463@ temp_1_1~552@))))) (=> (= temp_1_0~463@ temp_1_1~552@) (=> (= temp_2_0~665@ (Mul (Mul (Sub (Add d2~24@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Sub b2~20@ c2~22@) (Sub a2~18@ c2~22@))) (Sub (Mul (Mul a2~18@ a2~18@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~730@ (Mul (Mul (Sub (Add d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Sub b2~20@ c2~22@) (Sub a2~18@ c2~22@))) (Sub (Mul (Mul a2~18@ a2~18@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ c2~22@) (=> %%location_label%%2 (= temp_2_0~665@ temp_2_1~730@))) (=> (= temp_2_0~665@ temp_2_1~730@) (=> (= temp_3_0~843@ (Mul (Mul (Add (Mul 3 d3~32@) (Mul a3~26@ c3~30@)) (Mul c3~30@ (Mul a3~26@ a3~26@))) (Add (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul 63 d3~32@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~928@ (Mul (Add (Mul 3 d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ (Mul a3~26@ a3~26@)) (Add (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul 63 d3~32@) (Mul a3~26@ c3~30@)))))) (and (=> (= tmp%4@ (Add (Mul 3 d3~32@) (Mul a3~26@ c3~30@))) (=> (= tmp%5@ (Mul c3~30@ (Mul a3~26@ a3~26@))) (=> (= tmp%6@ (Add (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul 63 d3~32@) (Mul a3~26@ c3~30@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~843@ temp_3_1~928@)))))) (=> (= temp_3_0~843@ temp_3_1~928@) (=> (= temp_4_0~1095@ (Sub (Mul (Add (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Add (Mul c4~38@ d4~40@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Add a4~34@ d4~40@))))) (=> (= temp_4_1~1160@ (Sub (Mul (Add (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Add (Mul c4~38@ d4~40@) (Mul a4~34@ b4~36@))) (Mul (Mul a4~34@ d4~40@) (Mul (Mul b4~36@ a4~34@) (Mul (Mul a4~34@ d4~40@) (Add a4~34@ d4~40@)))))) (and (=> (= tmp%7@ (Mul a4~34@ d4~40@)) (=> (= tmp%8@ (Mul b4~36@ a4~34@)) (=> (= tmp%9@ (Mul (Mul a4~34@ d4~40@) (Add a4~34@ d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%4 (= temp_4_0~1095@ temp_4_1~1160@)))))) (=> (= temp_4_0~1095@ temp_4_1~1160@) (=> (= temp_5_0~1271@ (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@)) (Mul (Mul a5~42@ b5~44@) d5~48@)))) (=> (= temp_5_1~1332@ (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul a5~42@ b5~44@) d5~48@) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@))))) (and (=> (= tmp%10@ (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@))) (=> (= tmp%11@ (Mul (Mul a5~42@ b5~44@) d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%5 (= temp_5_0~1271@ temp_5_1~1332@))))) (=> (= temp_5_0~1271@ temp_5_1~1332@) (=> (= temp_6_0~1457@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Add a6~50@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Sub 8 b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1534@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Add a6~50@ a6~50@)) (Mul d6~56@ (Mul b6~52@ (Sub 8 b6~52@)))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (and (=> (= tmp%12@ (Sub 8 b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d6~56@ b6~52@ tmp%12@) (=> %%location_label%%6 (= temp_6_0~1457@ temp_6_1~1534@)))) (=> (= temp_6_0~1457@ temp_6_1~1534@) (=> (= temp_7_0~1633@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ a7~58@))) (Mul d7~64@ (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1686@ (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@)) (Mul (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ a7~58@)) (Mul d7~64@ (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@)))))) (and (=> (= tmp%13@ (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@))) (=> (= tmp%14@ (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ a7~58@))) (=> (= tmp%15@ (Mul d7~64@ (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%7 (= temp_7_0~1633@ temp_7_1~1686@)))))) (=> (= temp_7_0~1633@ temp_7_1~1686@) (=> (= temp_8_0~1821@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@))) (Mul (Add (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1886@ (Mul (Mul (Add (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@))))) (and (=> (= tmp%16@ (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)))) (=> (= tmp%17@ (Mul (Add (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%8 (= temp_8_0~1821@ temp_8_1~1886@))))) (=> (= temp_8_0~1821@ temp_8_1~1886@) (=> (= temp_9_0~2039@ (Mul (Mul (Mul (Add b9~76@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Sub b9~76@ b9~76@) b9~76@)) (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@)) (Mul a9~74@ (Mul 18 c9~78@))))) (=> (= temp_9_1~2108@ (Mul (Mul (Mul (Mul (Add b9~76@ c9~78@) c9~78@) b9~76@) (Mul (Sub b9~76@ b9~76@) b9~76@)) (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@)) (Mul a9~74@ (Mul 18 c9~78@))))) (and (=> (= tmp%18@ (Add b9~76@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ c9~78@ b9~76@) (=> %%location_label%%9 (= temp_9_0~2039@ temp_9_1~2108@)))) (=> (= temp_9_0~2039@ temp_9_1~2108@) (=> (= temp_10_0~2203@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ a10~82@) c10~86@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@))))) (=> (= temp_10_1~2264@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ a10~82@) c10~86@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ c10~86@))))) (and (=> (= tmp%19@ (Mul c10~86@ c10~86@)) (=> (= tmp%20@ (Mul d10~88@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%10 (= temp_10_0~2203@ temp_10_1~2264@))))) (=> (= temp_10_0~2203@ temp_10_1~2264@) (=> (= temp_11_0~2357@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) c11~94@) (Add (Mul d11~96@ c11~94@) (Mul c11~94@ b11~92@))) (Mul (Mul b11~92@ (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~2414@ (Mul (Mul (Mul a11~90@ (Mul a11~90@ c11~94@)) (Add (Mul d11~96@ c11~94@) (Mul c11~94@ b11~92@))) (Mul (Mul b11~92@ (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a11~90@ a11~90@ c11~94@) (=> %%location_label%%11 (= temp_11_0~2357@ temp_11_1~2414@))) (=> (= temp_11_0~2357@ temp_11_1~2414@) (=> (= temp_12_0~2521@ (Mul (Mul (Add (Add c12~102@ 77) (Mul a12~98@ d12~104@)) (Add (Add b12~100@ b12~100@) (Mul b12~100@ a12~98@))) (Mul (Add (Mul b12~100@ a12~98@) (Mul d12~104@ d12~104@)) (Mul (Add a12~98@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2598@ (Mul (Mul (Add (Add c12~102@ 77) (Mul a12~98@ d12~104@)) (Add (Add b12~100@ b12~100@) (Mul b12~100@ a12~98@))) (Mul (Add (Mul a12~98@ b12~100@) (Mul d12~104@ d12~104@)) (Mul (Add a12~98@ a12~98@) (Mul c12~102@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2521@ temp_12_1~2598@))) (=> (= temp_12_0~2521@ temp_12_1~2598@) (=> (= temp_13_0~2679@ (Mul (Mul (Mul (Add a13~106@ a13~106@) (Mul a13~106@ c13~110@)) b13~108@) (Mul (Mul (Mul a13~106@ d13~112@) (Sub a13~106@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Add d13~112@ b13~108@))))) (=> (= temp_13_1~2732@ (Mul (Mul (Mul (Add a13~106@ a13~106@) (Mul a13~106@ c13~110@)) b13~108@) (Mul (Mul (Mul a13~106@ d13~112@) (Sub a13~106@ a13~106@)) (Mul (Add d13~112@ b13~108@) (Mul d13~112@ d13~112@))))) (and (=> (= tmp%21@ (Mul d13~112@ d13~112@)) (=> (= tmp%22@ (Add d13~112@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%13 (= temp_13_0~2679@ temp_13_1~2732@))))) (=> (= temp_13_0~2679@ temp_13_1~2732@) (=> (= temp_14_0~2821@ (Sub (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@)) (Mul (Sub b14~116@ d14~120@) (Mul d14~120@ c14~118@))) (Mul b14~116@ (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ a14~114@))))) (=> (= temp_14_1~2874@ (Sub (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@)) (Mul (Sub b14~116@ d14~120@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ a14~114@)) b14~116@))) (=> (= tmp%23@ (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ a14~114@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b14~116@ tmp%23@) (=> %%location_label%%14 (= temp_14_0~2821@ temp_14_1~2874@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
