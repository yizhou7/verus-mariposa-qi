...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Add a0~2@ b0~4@))) (Mul (Sub c0~6@ (Sub b0~4@ a0~2@)) d0~8@))) (=> (= temp_0_1~338@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Add a0~2@ b0~4@))) (Mul d0~8@ (Sub c0~6@ (Sub b0~4@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~289@ temp_0_1~338@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~442@ (Mul (Mul (Mul (Mul 42 b1~12@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Sub (Mul (Mul d1~16@ c1~14@) (Add d1~16@ b1~12@)) (Mul (Add b1~12@ d1~16@) (Mul 85 c1~14@))))) (=> (= temp_1_1~531@ (Mul (Mul (Mul (Mul 42 b1~12@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Sub (Mul (Mul d1~16@ c1~14@) (Add d1~16@ b1~12@)) (Mul (Mul 85 c1~14@) (Add b1~12@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~442@ temp_1_1~531@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~611@ (Mul (Mul (Sub (Add d2~24@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Sub b2~20@ c2~22@) (Sub a2~18@ c2~22@))) (Sub (Mul (Mul a2~18@ a2~18@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~676@ (Mul (Mul (Sub (Add d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Sub b2~20@ c2~22@) (Sub a2~18@ c2~22@))) (Sub (Mul (Mul a2~18@ a2~18@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~611@ temp_2_1~676@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~776@ (Mul (Mul (Add (Mul 3 d3~32@) (Mul a3~26@ c3~30@)) (Mul c3~30@ (Mul a3~26@ a3~26@))) (Add (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul 63 d3~32@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~861@ (Mul (Add (Mul 3 d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ (Mul a3~26@ a3~26@)) (Add (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul 63 d3~32@) (Mul a3~26@ c3~30@)))))) (=> (= tmp%4@ (= temp_3_0~776@ temp_3_1~861@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~941@ (Sub (Mul (Add (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Add (Mul c4~38@ d4~40@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Add a4~34@ d4~40@))))) (=> (= temp_4_1~1006@ (Sub (Mul (Add (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Add (Mul c4~38@ d4~40@) (Mul a4~34@ b4~36@))) (Mul (Mul a4~34@ d4~40@) (Mul (Mul b4~36@ a4~34@) (Mul (Mul a4~34@ d4~40@) (Add a4~34@ d4~40@)))))) (=> (= tmp%5@ (= temp_4_0~941@ temp_4_1~1006@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1082@ (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@)) (Mul (Mul a5~42@ b5~44@) d5~48@)))) (=> (= temp_5_1~1143@ (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul a5~42@ b5~44@) d5~48@) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1082@ temp_5_1~1143@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1235@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Add a6~50@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Sub 8 b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1312@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Add a6~50@ a6~50@)) (Mul d6~56@ (Mul b6~52@ (Sub 8 b6~52@)))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1235@ temp_6_1~1312@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1380@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ a7~58@))) (Mul d7~64@ (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1433@ (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@)) (Mul (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ a7~58@)) (Mul d7~64@ (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@)))))) (=> (= tmp%8@ (= temp_7_0~1380@ temp_7_1~1433@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1513@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@))) (Mul (Add (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1578@ (Mul (Mul (Add (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1513@ temp_8_1~1578@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1662@ (Mul (Mul (Mul (Add b9~76@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Sub b9~76@ b9~76@) b9~76@)) (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@)) (Mul a9~74@ (Mul 18 c9~78@))))) (=> (= temp_9_1~1731@ (Mul (Mul (Mul (Mul (Add b9~76@ c9~78@) c9~78@) b9~76@) (Mul (Sub b9~76@ b9~76@) b9~76@)) (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@)) (Mul a9~74@ (Mul 18 c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1662@ temp_9_1~1731@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1807@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ a10~82@) c10~86@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@))))) (=> (= temp_10_1~1868@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ a10~82@) c10~86@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1807@ temp_10_1~1868@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1940@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) c11~94@) (Add (Mul d11~96@ c11~94@) (Mul c11~94@ b11~92@))) (Mul (Mul b11~92@ (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~1997@ (Mul (Mul (Mul a11~90@ (Mul a11~90@ c11~94@)) (Add (Mul d11~96@ c11~94@) (Mul c11~94@ b11~92@))) (Mul (Mul b11~92@ (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1940@ temp_11_1~1997@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2089@ (Mul (Mul (Add (Add c12~102@ 77) (Mul a12~98@ d12~104@)) (Add (Add b12~100@ b12~100@) (Mul b12~100@ a12~98@))) (Mul (Add (Mul b12~100@ a12~98@) (Mul d12~104@ d12~104@)) (Mul (Add a12~98@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2166@ (Mul (Mul (Add (Add c12~102@ 77) (Mul a12~98@ d12~104@)) (Add (Add b12~100@ b12~100@) (Mul b12~100@ a12~98@))) (Mul (Add (Mul a12~98@ b12~100@) (Mul d12~104@ d12~104@)) (Mul (Add a12~98@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= tmp%13@ (= temp_12_0~2089@ temp_12_1~2166@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2234@ (Mul (Mul (Mul (Add a13~106@ a13~106@) (Mul a13~106@ c13~110@)) b13~108@) (Mul (Mul (Mul a13~106@ d13~112@) (Sub a13~106@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Add d13~112@ b13~108@))))) (=> (= temp_13_1~2287@ (Mul (Mul (Mul (Add a13~106@ a13~106@) (Mul a13~106@ c13~110@)) b13~108@) (Mul (Mul (Mul a13~106@ d13~112@) (Sub a13~106@ a13~106@)) (Mul (Add d13~112@ b13~108@) (Mul d13~112@ d13~112@))))) (=> (= tmp%14@ (= temp_13_0~2234@ temp_13_1~2287@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2355@ (Sub (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@)) (Mul (Sub b14~116@ d14~120@) (Mul d14~120@ c14~118@))) (Mul b14~116@ (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ a14~114@))))) (=> (= temp_14_1~2408@ (Sub (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@)) (Mul (Sub b14~116@ d14~120@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ a14~114@)) b14~116@))) (=> (= tmp%15@ (= temp_14_0~2355@ temp_14_1~2408@)) (=> %%location_label%%14 tmp%15@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
