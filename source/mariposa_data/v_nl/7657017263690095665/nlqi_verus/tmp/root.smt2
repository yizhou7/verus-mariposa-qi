...
(push)
 ...
 (declare-const temp_14_1~2534@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~289@ temp_0_1~338@)
        (=>
         (= temp_1_0~451@ (Mul (Mul (Mul (Mul 42 b1~12@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@
              b1~12@
             ) (Mul c1~14@ a1~10@)
            )
         ...
         (=>
          (= temp_1_1~540@ (Mul (Mul (Mul (Mul 42 b1~12@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@
               b1~12@
              ) (Mul c1~14@ a1~10@)
             )
          ...
          (and
           (=>
            ...
            (=>
             %%location_label%%1
             (= temp_1_0~451@ temp_1_1~540@)
           ))
           (=>
            (= temp_1_0~451@ temp_1_1~540@)
            (=>
             (= temp_2_0~629@ (Mul (Mul (Sub (Add d2~24@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Sub b2~20@
                  c2~22@
                 ) (Sub a2~18@ c2~22@)
                )
             ...
             (=>
              (= temp_2_1~694@ (Mul (Mul (Sub (Add d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Sub b2~20@
                   c2~22@
                  ) (Sub a2~18@ c2~22@)
                 )
                ) (Sub (Mul (Mul a2~18@ a2~18@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@
              ...
              (and
               ...
               (=>
                (= temp_2_0~629@ temp_2_1~694@)
                (=>
                 (= temp_3_0~803@ (Mul (Mul (Add (Mul 3 d3~32@) (Mul a3~26@ c3~30@)) (Mul c3~30@ (Mul a3~26@
                      a3~26@
                    ))
                 ...
                 (=>
                  (= temp_3_1~888@ (Mul (Add (Mul 3 d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ (Mul a3~26@
                       a3~26@
                      )
                     ) (Add (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul 63 d3~32@) (Mul a3~26@
                        c3~30@
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~803@ temp_3_1~888@)
                   ))
                   (=>
                    (= temp_3_0~803@ temp_3_1~888@)
                    (=>
                     (= temp_4_0~977@ (Sub (Mul (Add (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Add (Mul c4~38@
                          d4~40@
                         ) (Mul a4~34@ b4~36@)
                        )
                     ...
                     (=>
                      (= temp_4_1~1042@ (Sub (Mul (Add (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Add (Mul c4~38@
                           d4~40@
                          ) (Mul a4~34@ b4~36@)
                         )
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~977@ temp_4_1~1042@)
                       ))
                       (=>
                        (= temp_4_0~977@ temp_4_1~1042@)
                        (=>
                         (= temp_5_0~1127@ (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@
                              b5~44@
                             ) (Mul d5~48@ d5~48@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1188@ (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@
                               b5~44@
                              ) (Mul d5~48@ d5~48@)
                             )
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1127@ temp_5_1~1188@)
                           ))
                           (=>
                            (= temp_5_0~1127@ temp_5_1~1188@)
                            (=>
                             (= temp_6_0~1289@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Add a6~50@ a6~50@)) (Mul (Mul d6~56@
                                  b6~52@
                                 ) (Sub 8 b6~52@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1366@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Add a6~50@ a6~50@)) (Mul d6~56@
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1289@ temp_6_1~1366@)
                               ))
                               (=>
                                (= temp_6_0~1289@ temp_6_1~1366@)
                                (=>
                                 (= temp_7_0~1443@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@)) (Mul (Mul a7~58@
                                      a7~58@
                                     ) (Mul d7~64@ a7~58@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1496@ (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@)) (Mul (Mul (Mul a7~58@
                                       a7~58@
                                      ) (Mul d7~64@ a7~58@)
                                     ) (Mul d7~64@ (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@)))
                                  )))
                                  (and
                                   ...
                                   (=>
                                    (= temp_7_0~1443@ temp_7_1~1496@)
                                    (=>
                                     (= temp_8_0~1585@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul b8~68@
                                          d8~72@
                                         ) (Mul d8~72@ a8~66@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1650@ (Mul (Mul (Add (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@
                                           c8~70@
                                          ) (Mul a8~66@ a8~66@)
                                         )
                                      ...
                                      (and
                                       ...
                                       (=>
                                        (= temp_8_0~1585@ temp_8_1~1650@)
                                        (=>
                                         (= temp_9_0~1743@ (Mul (Mul (Mul (Add b9~76@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Sub b9~76@
                                              b9~76@
                                             ) b9~76@
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1812@ (Mul (Mul (Mul (Mul (Add b9~76@ c9~78@) c9~78@) b9~76@) (Mul (Sub b9~76@
                                               b9~76@
                                              ) b9~76@
                                             )
                                            ) (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@)) (Mul a9~74@ (Mul 18 c9~78@)))
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1743@ temp_9_1~1812@)
                                           ))
                                           (=>
                                            (= temp_9_0~1743@ temp_9_1~1812@)
                                            (=>
                                             (= temp_10_0~1897@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (
                                                  Mul d10~88@ a10~82@
                                                 ) c10~86@
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1958@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (
                                                   Mul d10~88@ a10~82@
                                                  ) c10~86@
                                                 )
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1897@ temp_10_1~1958@)
                                               ))
                                               (=>
                                                (= temp_10_0~1897@ temp_10_1~1958@)
                                                (=>
                                                 (= temp_11_0~2039@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) c11~94@) (Add (Mul d11~96@ c11~94@)
                                                     (Mul c11~94@ b11~92@)
                                                    )
                                                   ) (Mul (Mul b11~92@ (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ a11~90@)))
                                                 ))
                                                 (=>
                                                  (= temp_11_1~2096@ (Mul (Mul (Mul a11~90@ (Mul a11~90@ c11~94@)) (Add (Mul d11~96@ c11~94@)
                                                      (Mul c11~94@ b11~92@)
                                                     )
                                                    ) (Mul (Mul b11~92@ (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ a11~90@)))
                                                  ))
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~2039@ temp_11_1~2096@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~2039@ temp_11_1~2096@)
                                                    (=>
                                                     (= temp_12_0~2197@ (Mul (Mul (Add (Add c12~102@ 77) (Mul a12~98@ d12~104@)) (Add (Add
                                                          b12~100@ b12~100@
                                                         ) (Mul b12~100@ a12~98@)
                                                        )
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2274@ (Mul (Mul (Add (Add c12~102@ 77) (Mul a12~98@ d12~104@)) (Add (Add
                                                           b12~100@ b12~100@
                                                          ) (Mul b12~100@ a12~98@)
                                                         )
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2197@ temp_12_1~2274@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2197@ temp_12_1~2274@)
                                                        (=>
                                                         (= temp_13_0~2351@ (Mul (Mul (Mul (Add a13~106@ a13~106@) (Mul a13~106@ c13~110@)) b13~108@)
                                                           (Mul (Mul (Mul a13~106@ d13~112@) (Sub a13~106@ a13~106@)) (Mul (Mul d13~112@ d13~112@)
                                                             (Add d13~112@ b13~108@)
                                                         ))))
                                                         (=>
                                                          (= temp_13_1~2404@ (Mul (Mul (Mul (Add a13~106@ a13~106@) (Mul a13~106@ c13~110@)) b13~108@)
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2351@ temp_13_1~2404@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2351@ temp_13_1~2404@)
                                                            (=>
                                                             (= temp_14_0~2481@ (Sub (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@)) (
                                                                 Mul (Sub b14~116@ d14~120@) (Mul d14~120@ c14~118@)
                                                                )
                                                               ) (Mul b14~116@ (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ a14~114@)))
                                                             ))
                                                             (=>
                                                              (= temp_14_1~2534@ (Sub (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@)) (
                                                                  Mul (Sub b14~116@ d14~120@) (Mul d14~120@ c14~118@)
                                                                 )
