...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Add (Mul (Mul (Mul b0~4@ d0~8@) a0~2@) (Sub (Sub c0~6@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Add a0~2@ a0~2@)) (Sub (Mul 0 a0~2@) (Mul c0~6@ a0~2@))))) (=> (= temp_0_1~386@ (Add (Mul (Mul (Mul b0~4@ d0~8@) a0~2@) (Sub (Sub c0~6@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Sub (Mul 0 a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Add a0~2@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~313@ temp_0_1~386@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~462@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ d1~16@)) (Sub (Mul c1~14@ a1~10@) (Mul d1~16@ a1~10@))) (Mul (Add c1~14@ (Sub b1~12@ c1~14@)) (Add (Add d1~16@ d1~16@) (Add a1~10@ d1~16@))))) (=> (= temp_1_1~523@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ a1~10@)) (Sub (Mul c1~14@ a1~10@) (Mul d1~16@ a1~10@))) (Mul (Add c1~14@ (Sub b1~12@ c1~14@)) (Add (Add d1~16@ d1~16@) (Add a1~10@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~462@ temp_1_1~523@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~603@ (Add (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~668@ (Add (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~603@ temp_2_1~668@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~748@ (Mul (Sub (Add (Mul a3~26@ c3~30@) (Sub a3~26@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@))) (Mul (Add (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~829@ (Mul (Sub (Add (Mul a3~26@ c3~30@) (Sub a3~26@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@))) (Add (Mul (Mul b3~28@ a3~26@) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@))) (Mul (Mul b3~28@ c3~30@) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@)))))) (=> (= tmp%4@ (= temp_3_0~748@ temp_3_1~829@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~909@ (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Add (Mul b4~36@ b4~36@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~974@ (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ b4~36@)) (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Add (Mul b4~36@ b4~36@) (Mul a4~34@ b4~36@)))))) (=> (= tmp%5@ (= temp_4_0~909@ temp_4_1~974@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1050@ (Mul (Mul (Sub (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@ b5~44@) c5~46@)) (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ d5~48@) (Sub d5~48@ a5~42@))))) (=> (= temp_5_1~1111@ (Mul (Mul (Sub (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Mul a5~42@ (Mul b5~44@ c5~46@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ d5~48@) (Sub d5~48@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~1050@ temp_5_1~1111@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1191@ (Sub (Sub (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@)) (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1256@ (Sub (Sub (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@)) (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1191@ temp_6_1~1256@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1344@ (Mul (Mul (Add (Add b7~60@ c7~62@) b7~60@) (Sub (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@))) (Sub (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Sub c7~62@ 61) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1425@ (Mul (Mul (Add (Add b7~60@ c7~62@) b7~60@) (Sub (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@))) (Sub (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ b7~60@)) (Sub (Mul c7~62@ (Mul a7~58@ c7~62@)) (Mul 61 (Mul a7~58@ c7~62@)))))) (=> (= tmp%8@ (= temp_7_0~1344@ temp_7_1~1425@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1517@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Sub c8~70@ a8~66@) (Mul a8~66@ 56))) (Mul (Mul (Mul b8~68@ b8~68@) (Add d8~72@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@))))) (=> (= temp_8_1~1594@ (Mul (Mul (Mul (Mul b8~68@ b8~68@) (Add d8~72@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Sub c8~70@ a8~66@) (Mul a8~66@ 56))))) (=> (= tmp%9@ (= temp_8_0~1517@ temp_8_1~1594@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1686@ (Mul (Mul (Mul (Mul 5 a9~74@) (Mul a9~74@ d9~80@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ c9~78@))) (Mul (Mul (Mul c9~78@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~1763@ (Mul (Mul (Mul (Mul (Mul 5 a9~74@) (Mul a9~74@ d9~80@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ c9~78@))) (Mul (Mul c9~78@ a9~74@) (Mul d9~80@ d9~80@))) (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)))) (=> (= tmp%10@ (= temp_9_0~1686@ temp_9_1~1763@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1839@ (Mul (Add (Mul (Mul c10~86@ d10~88@) (Mul b10~84@ a10~82@)) (Add (Mul a10~82@ d10~88@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul a10~82@ d10~88@) c10~86@) (Sub (Mul d10~88@ a10~82@) (Mul a10~82@ b10~84@))))) (=> (= temp_10_1~1900@ (Mul (Add (Mul (Mul c10~86@ d10~88@) (Mul b10~84@ a10~82@)) (Add (Mul a10~82@ d10~88@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul a10~82@ d10~88@) c10~86@) (Sub (Mul a10~82@ d10~88@) (Mul a10~82@ b10~84@))))) (=> (= tmp%11@ (= temp_10_0~1839@ temp_10_1~1900@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1976@ (Sub (Mul (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ a11~90@)) (Mul (Add d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Mul b11~92@ (Mul d11~96@ a11~90@)) (Sub (Mul a11~90@ b11~92@) (Mul b11~92@ b11~92@))))) (=> (= temp_11_1~2037@ (Sub (Mul (Mul (Mul d11~96@ a11~90@) (Mul a11~90@ b11~92@)) (Mul (Add d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Mul b11~92@ (Mul d11~96@ a11~90@)) (Sub (Mul a11~90@ b11~92@) (Mul b11~92@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1976@ temp_11_1~2037@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2089@ (Mul d12~104@ (Mul (Add (Mul a12~98@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ b12~100@))))) (=> (= temp_12_1~2142@ (Mul d12~104@ (Add (Mul (Mul a12~98@ a12~98@) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ b12~100@))) (Mul (Mul b12~100@ a12~98@) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ b12~100@)))))) (=> (= tmp%13@ (= temp_12_0~2089@ temp_12_1~2142@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2222@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ a13~106@)) (Mul (Mul a13~106@ c13~110@) (Add b13~108@ b13~108@))) (Mul (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ c13~110@))))) (=> (= temp_13_1~2287@ (Mul (Mul (Mul (Mul a13~106@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Mul a13~106@ c13~110@) (Add b13~108@ b13~108@))) (Mul (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2222@ temp_13_1~2287@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2367@ (Mul (Mul (Add (Mul b14~116@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Mul c14~118@ 69) (Mul a14~114@ a14~114@))) (Mul d14~120@ (Mul (Mul d14~120@ b14~116@) (Sub a14~114@ c14~118@))))) (=> (= temp_14_1~2432@ (Mul (Mul d14~120@ (Mul (Mul d14~120@ b14~116@) (Sub a14~114@ c14~118@))) (Mul (Add (Mul b14~116@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Mul c14~118@ 69) (Mul a14~114@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2367@ temp_14_1~2432@)) (=> %%location_label%%14 tmp%15@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
