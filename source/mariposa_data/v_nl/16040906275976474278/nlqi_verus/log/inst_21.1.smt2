...
(set-info :comment ";; mariposa_data/v_nl//16040906275976474278/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_3_0~781@ Int)
(declare-const temp_3_1~830@ Int)
...
(declare-const temp_8_0~1539@ Int)
(declare-const temp_8_1~1604@ Int)
(declare-const temp_9_0~1697@ Int)
(declare-const temp_9_1~1762@ Int)
(declare-const temp_10_0~1855@ Int)
(declare-const temp_10_1~1920@ Int)
(declare-const temp_11_0~2079@ Int)
(declare-const temp_11_1~2164@ Int)
(declare-const temp_12_0~2251@ Int)
(declare-const temp_12_1~2312@ Int)
(declare-const temp_13_0~2419@ Int)
(declare-const temp_13_1~2492@ Int)
(declare-const temp_14_0~2643@ Int)
(declare-const temp_14_1~2704@ Int)
(declare-const temp_15_0~2839@ Int)
(declare-const temp_15_1~2896@ Int)
(declare-const temp_16_0~3037@ Int)
(declare-const temp_16_1~3102@ Int)
(declare-const temp_17_0~3191@ Int)
(declare-const temp_17_1~3252@ Int)
(declare-const temp_18_0~3353@ Int)
(declare-const temp_18_1~3410@ Int)
(declare-const temp_19_0~3509@ Int)
(declare-const temp_19_1~3574@ Int)
(declare-const temp_20_0~3649@ Int)
(declare-const temp_20_1~3690@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~370@ (Sub (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@))))) (and (=> (= tmp%1@ (Mul c0~6@ a0~2@)) (=> (= tmp%2@ (Mul b0~4@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~455@ (Add (Sub (Add d1~16@ (Mul c1~14@ a1~10@)) (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ b1~12@))) (Add b1~12@ (Mul (Mul a1~10@ c1~14@) (Add c1~14@ d1~16@))))) (=> (= temp_1_1~500@ (Add (Sub (Add d1~16@ (Mul c1~14@ a1~10@)) (Mul b1~12@ (Sub a1~10@ b1~12@))) (Add b1~12@ (Mul (Mul a1~10@ c1~14@) (Add c1~14@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b1~12@ a1~10@ b1~12@) (=> %%location_label%%1 (= temp_1_0~455@ temp_1_1~500@))) (=> (= temp_1_0~455@ temp_1_1~500@) (=> (= temp_2_0~619@ (Mul (Mul (Sub (Mul c2~22@ c2~22@) (Mul a2~18@ 46)) (Add (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@))) (Mul (Sub (Mul a2~18@ 64) (Mul b2~20@ d2~24@)) (Sub (Mul b2~20@ a2~18@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~708@ (Mul (Mul (Sub (Mul c2~22@ c2~22@) (Mul a2~18@ 46)) (Add (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@))) (Mul (Sub (Mul a2~18@ 64) (Mul b2~20@ d2~24@)) (Sub (Mul b2~20@ a2~18@) (Mul c2~22@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ c2~22@) (=> %%location_label%%2 (= temp_2_0~619@ temp_2_1~708@))) (=> (= temp_2_0~619@ temp_2_1~708@) (=> (= temp_3_0~781@ (Mul (Mul a3~26@ (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@))) (Sub (Mul (Mul d3~32@ d3~32@) c3~30@) (Mul (Add d3~32@ d3~32@) a3~26@)))) (=> (= temp_3_1~830@ (Mul (Mul a3~26@ (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@))) (Sub (Mul (Mul d3~32@ d3~32@) c3~30@) (Add (Mul d3~32@ a3~26@) (Mul d3~32@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d3~32@ d3~32@ a3~26@) (=> %%location_label%%3 (= temp_3_0~781@ temp_3_1~830@))) (=> (= temp_3_0~781@ temp_3_1~830@) (=> (= temp_4_0~937@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))) (Sub (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Mul 35 b4~36@))))) (=> (= temp_4_1~1014@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))) (Sub (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul 35 b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ c4~38@) (=> %%location_label%%4 (= temp_4_0~937@ temp_4_1~1014@))) (=> (= temp_4_0~937@ temp_4_1~1014@) (=> (= temp_5_0~1095@ (Add (Mul (Add (Mul c5~46@ b5~44@) (Mul a5~42@ b5~44@)) b5~44@) (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1148@ (Add (Mul (Add (Mul c5~46@ b5~44@) (Mul a5~42@ b5~44@)) b5~44@) (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ b5~44@))))) (and (=> (= tmp%3@ (Mul a5~42@ b5~44@)) (=> (= tmp%4@ (Mul c5~46@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%5 (= temp_5_0~1095@ temp_5_1~1148@))))) (=> (= temp_5_0~1095@ temp_5_1~1148@) (=> (= temp_6_0~1249@ (Mul (Mul (Mul (Add a6~50@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Add a6~50@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1314@ (Mul (Mul (Mul (Add a6~50@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Add a6~50@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1249@ temp_6_1~1314@))) (=> (= temp_6_0~1249@ temp_6_1~1314@) (=> (= temp_7_0~1391@ (Mul (Sub (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@)) (Sub (Add a7~58@ a7~58@) c7~62@)) (Mul (Mul (Mul b7~60@ c7~62@) (Add a7~58@ c7~62@)) a7~58@))) (=> (= temp_7_1~1440@ (Mul (Sub (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@)) (Sub (Add a7~58@ a7~58@) c7~62@)) (Mul (Mul b7~60@ (Mul c7~62@ (Add a7~58@ c7~62@))) a7~58@))) (and (=> (= tmp%5@ (Add a7~58@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b7~60@ c7~62@ tmp%5@) (=> %%location_label%%7 (= temp_7_0~1391@ temp_7_1~1440@)))) (=> (= temp_7_0~1391@ temp_7_1~1440@) (=> (= temp_8_0~1539@ (Mul (Add (Sub (Mul a8~66@ c8~70@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Mul (Sub c8~70@ d8~72@) (Mul d8~72@ a8~66@)) (Sub (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@))))) (=> (= temp_8_1~1604@ (Mul (Add (Sub (Mul a8~66@ c8~70@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Mul (Sub c8~70@ d8~72@) (Mul d8~72@ a8~66@)) (Sub (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ c8~70@) (=> %%location_label%%8 (= temp_8_0~1539@ temp_8_1~1604@))) (=> (= temp_8_0~1539@ temp_8_1~1604@) (=> (= temp_9_0~1697@ (Sub (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Sub (Sub c9~78@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ c9~78@) (Sub b9~76@ c9~78@)) (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~1762@ (Sub (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Sub (Sub c9~78@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ c9~78@) (Sub b9~76@ c9~78@)) (Mul (Mul b9~76@ a9~74@) (Mul c9~78@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a9~74@ b9~76@) (=> %%location_label%%9 (= temp_9_0~1697@ temp_9_1~1762@))) (=> (= temp_9_0~1697@ temp_9_1~1762@) (=> (= temp_10_0~1855@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Sub b10~84@ c10~86@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ d10~88@))) (Sub (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1920@ (Mul (Mul (Mul d10~88@ d10~88@) (Sub b10~84@ c10~86@)) (Mul (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ d10~88@)) (Sub (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Mul d10~88@ c10~86@)))))) (and (=> (= tmp%6@ (Mul (Mul d10~88@ d10~88@) (Sub b10~84@ c10~86@))) (=> (= tmp%7@ (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ d10~88@))) (=> (= tmp%8@ (Sub (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Mul d10~88@ c10~86@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%10 (= temp_10_0~1855@ temp_10_1~1920@)))))) (=> (= temp_10_0~1855@ temp_10_1~1920@) (=> (= temp_11_0~2079@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) (Add b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ c11~94@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ 46))))) (=> (= temp_11_1~2164@ (Mul (Mul (Add (Mul (Mul c11~94@ c11~94@) b11~92@) (Mul (Mul c11~94@ c11~94@) d11~96@)) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ c11~94@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ 46))))) (and (=> (= tmp%9@ (Mul c11~94@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ b11~92@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2079@ temp_11_1~2164@)))) (=> (= temp_11_0~2079@ temp_11_1~2164@) (=> (= temp_12_0~2251@ (Mul (Mul (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ a12~98@))) (Mul a12~98@ (Mul (Mul c12~102@ c12~102@) (Add b12~100@ b12~100@))))) (=> (= temp_12_1~2312@ (Mul (Mul (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ a12~98@))) (Mul a12~98@ (Add (Mul (Mul c12~102@ c12~102@) b12~100@) (Mul (Mul c12~102@ c12~102@) b12~100@))))) (and (=> (= tmp%10@ (Mul c12~102@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%10@ b12~100@ b12~100@) (=> %%location_label%%12 (= temp_12_0~2251@ temp_12_1~2312@)))) (=> (= temp_12_0~2251@ temp_12_1~2312@) (=> (= temp_13_0~2419@ (Mul (Sub (Add b13~108@ (Mul 83 a13~106@)) (Mul (Sub a13~106@ b13~108@) (Mul b13~108@ c13~110@))) (Mul (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ d13~112@)) (Mul (Mul a13~106@ a13~106@) (Add b13~108@ a13~106@))))) (=> (= temp_13_1~2492@ (Mul (Mul (Sub (Add b13~108@ (Mul 83 a13~106@)) (Mul (Sub a13~106@ b13~108@) (Mul b13~108@ c13~110@))) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ d13~112@))) (Mul (Mul a13~106@ a13~106@) (Add b13~108@ a13~106@)))) (and (=> (= tmp%11@ (Sub (Add b13~108@ (Mul 83 a13~106@)) (Mul (Sub a13~106@ b13~108@) (Mul b13~108@ c13~110@)))) (=> (= tmp%12@ (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ d13~112@))) (=> (= tmp%13@ (Mul (Mul a13~106@ a13~106@) (Add b13~108@ a13~106@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%13 (= temp_13_0~2419@ temp_13_1~2492@)))))) (=> (= temp_13_0~2419@ temp_13_1~2492@) (=> (= temp_14_0~2643@ (Mul (Mul (Sub (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ d14~120@))) (Mul (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul a14~114@ (Sub c14~118@ c14~118@))))) (=> (= temp_14_1~2704@ (Mul (Sub (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ d14~120@)) (Mul (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul a14~114@ (Sub c14~118@ c14~118@)))))) (and (=> (= tmp%14@ (Sub (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@))) (=> (= tmp%15@ (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ d14~120@))) (=> (= tmp%16@ (Mul (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul a14~114@ (Sub c14~118@ c14~118@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%14 (= temp_14_0~2643@ temp_14_1~2704@)))))) (=> (= temp_14_0~2643@ temp_14_1~2704@) (=> (= temp_15_0~2839@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Sub c15~126@ a15~122@)) (Mul (Mul c15~126@ c15~126@) d15~128@)) (Mul (Mul c15~126@ (Mul b15~124@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ a15~122@))))) (=> (= temp_15_1~2896@ (Mul (Mul (Mul c15~126@ (Mul b15~124@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ a15~122@))) (Mul (Mul (Mul d15~128@ d15~128@) (Sub c15~126@ a15~122@)) (Mul (Mul c15~126@ c15~126@) d15~128@)))) (and (=> (= tmp%17@ (Mul (Mul (Mul d15~128@ d15~128@) (Sub c15~126@ a15~122@)) (Mul (Mul c15~126@ c15~126@) d15~128@))) (=> (= tmp%18@ (Mul (Mul c15~126@ (Mul b15~124@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ a15~122@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%15 (= temp_15_0~2839@ temp_15_1~2896@))))) (=> (= temp_15_0~2839@ temp_15_1~2896@) (=> (= temp_16_0~3037@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Sub b16~132@ d16~136@)) (Add (Mul c16~134@ d16~136@) (Sub b16~132@ d16~136@))) (Add (Mul (Mul d16~136@ b16~132@) (Mul a16~130@ d16~136@)) (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ d16~136@))))) (=> (= temp_16_1~3102@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Sub b16~132@ d16~136@)) (Add (Mul c16~134@ d16~136@) (Sub b16~132@ d16~136@))) (Add (Mul (Mul d16~136@ b16~132@) (Mul a16~130@ d16~136@)) (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d16~136@ d16~136@) (=> %%location_label%%16 (= temp_16_0~3037@ temp_16_1~3102@))) (=> (= temp_16_0~3037@ temp_16_1~3102@) (=> (= temp_17_0~3191@ (Add (Mul (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ a17~138@)) (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@))) (Add (Mul (Mul b17~140@ d17~144@) d17~144@) (Mul (Add c17~142@ a17~138@) (Add c17~142@ b17~140@))))) (=> (= temp_17_1~3252@ (Add (Mul (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ a17~138@))) (Add (Mul (Mul b17~140@ d17~144@) d17~144@) (Mul (Add c17~142@ a17~138@) (Add c17~142@ b17~140@))))) (and (=> (= tmp%19@ (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ a17~138@))) (=> (= tmp%20@ (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%17 (= temp_17_0~3191@ temp_17_1~3252@))))) (=> (= temp_17_0~3191@ temp_17_1~3252@) (=> (= temp_18_0~3353@ (Mul (Mul c18~150@ (Mul (Sub d18~152@ a18~146@) (Sub d18~152@ a18~146@))) (Add (Mul (Mul d18~152@ d18~152@) (Mul a18~146@ b18~148@)) (Mul a18~146@ (Mul c18~150@ a18~146@))))) (=> (= temp_18_1~3410@ (Mul (Mul c18~150@ (Sub (Mul (Sub d18~152@ a18~146@) d18~152@) (Mul (Sub d18~152@ a18~146@) a18~146@))) (Add (Mul (Mul d18~152@ d18~152@) (Mul a18~146@ b18~148@)) (Mul a18~146@ (Mul c18~150@ a18~146@))))) (and (=> (= tmp%21@ (Sub d18~152@ a18~146@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%21@ d18~152@ a18~146@) (=> %%location_label%%18 (= temp_18_0~3353@ temp_18_1~3410@)))) (=> (= temp_18_0~3353@ temp_18_1~3410@) (=> (= temp_19_0~3509@ (Mul (Mul (Mul (Mul b19~156@ b19~156@) (Mul a19~154@ c19~158@)) (Add (Mul c19~158@ a19~154@) (Mul c19~158@ b19~156@))) (Sub (Mul (Add c19~158@ a19~154@) (Mul b19~156@ c19~158@)) (Mul (Mul b19~156@ d19~160@) (Mul b19~156@ a19~154@))))) (=> (= temp_19_1~3574@ (Mul (Mul (Mul (Mul b19~156@ b19~156@) (Mul a19~154@ c19~158@)) (Add (Mul c19~158@ a19~154@) (Mul c19~158@ b19~156@))) (Sub (Mul (Add c19~158@ a19~154@) (Mul b19~156@ c19~158@)) (Mul b19~156@ (Mul d19~160@ (Mul b19~156@ a19~154@)))))) (and (=> (= tmp%22@ (Mul b19~156@ a19~154@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b19~156@ d19~160@ tmp%22@) (=> %%location_label%%19 (= temp_19_0~3509@ temp_19_1~3574@)))) (=> (= temp_19_0~3509@ temp_19_1~3574@) (=> (= temp_20_0~3649@ (Mul (Mul (Mul (Mul c20~166@ d20~168@) (Mul b20~164@ a20~162@)) b20~164@) (Mul a20~162@ (Add (Mul c20~166@ c20~166@) (Mul a20~162@ b20~164@))))) (=> (= temp_20_1~3690@ (Mul (Mul (Mul (Mul c20~166@ d20~168@) (Mul b20~164@ a20~162@)) b20~164@) (Mul a20~162@ (Add (Mul c20~166@ c20~166@) (Mul a20~162@ b20~164@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c20~166@ c20~166@) (=> %%location_label%%20 (= temp_20_0~3649@ temp_20_1~3690@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
