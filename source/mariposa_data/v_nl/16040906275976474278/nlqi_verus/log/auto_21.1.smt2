...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~370@ (Sub (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~443@ (Add (Sub (Add d1~16@ (Mul c1~14@ a1~10@)) (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ b1~12@))) (Add b1~12@ (Mul (Mul a1~10@ c1~14@) (Add c1~14@ d1~16@))))) (=> (= temp_1_1~488@ (Add (Sub (Add d1~16@ (Mul c1~14@ a1~10@)) (Mul b1~12@ (Sub a1~10@ b1~12@))) (Add b1~12@ (Mul (Mul a1~10@ c1~14@) (Add c1~14@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~443@ temp_1_1~488@))) (=> (= temp_1_0~443@ temp_1_1~488@) (=> (= temp_2_0~601@ (Mul (Mul (Sub (Mul c2~22@ c2~22@) (Mul a2~18@ 46)) (Add (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@))) (Mul (Sub (Mul a2~18@ 64) (Mul b2~20@ d2~24@)) (Sub (Mul b2~20@ a2~18@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~690@ (Mul (Mul (Sub (Mul c2~22@ c2~22@) (Mul a2~18@ 46)) (Add (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@))) (Mul (Sub (Mul a2~18@ 64) (Mul b2~20@ d2~24@)) (Sub (Mul b2~20@ a2~18@) (Mul c2~22@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~601@ temp_2_1~690@))) (=> (= temp_2_0~601@ temp_2_1~690@) (=> (= temp_3_0~759@ (Mul (Mul a3~26@ (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@))) (Sub (Mul (Mul d3~32@ d3~32@) c3~30@) (Mul (Add d3~32@ d3~32@) a3~26@)))) (=> (= temp_3_1~808@ (Mul (Mul a3~26@ (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@))) (Sub (Mul (Mul d3~32@ d3~32@) c3~30@) (Add (Mul d3~32@ a3~26@) (Mul d3~32@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~759@ temp_3_1~808@))) (=> (= temp_3_0~759@ temp_3_1~808@) (=> (= temp_4_0~909@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))) (Sub (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Mul 35 b4~36@))))) (=> (= temp_4_1~986@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))) (Sub (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul 35 b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~909@ temp_4_1~986@))) (=> (= temp_4_0~909@ temp_4_1~986@) (=> (= temp_5_0~1063@ (Add (Mul (Add (Mul c5~46@ b5~44@) (Mul a5~42@ b5~44@)) b5~44@) (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1116@ (Add (Mul (Add (Mul c5~46@ b5~44@) (Mul a5~42@ b5~44@)) b5~44@) (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1063@ temp_5_1~1116@))) (=> (= temp_5_0~1063@ temp_5_1~1116@) (=> (= temp_6_0~1205@ (Mul (Mul (Mul (Add a6~50@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Add a6~50@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1270@ (Mul (Mul (Mul (Add a6~50@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Add a6~50@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1205@ temp_6_1~1270@))) (=> (= temp_6_0~1205@ temp_6_1~1270@) (=> (= temp_7_0~1343@ (Mul (Sub (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@)) (Sub (Add a7~58@ a7~58@) c7~62@)) (Mul (Mul (Mul b7~60@ c7~62@) (Add a7~58@ c7~62@)) a7~58@))) (=> (= temp_7_1~1392@ (Mul (Sub (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@)) (Sub (Add a7~58@ a7~58@) c7~62@)) (Mul (Mul b7~60@ (Mul c7~62@ (Add a7~58@ c7~62@))) a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1343@ temp_7_1~1392@))) (=> (= temp_7_0~1343@ temp_7_1~1392@) (=> (= temp_8_0~1481@ (Mul (Add (Sub (Mul a8~66@ c8~70@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Mul (Sub c8~70@ d8~72@) (Mul d8~72@ a8~66@)) (Sub (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@))))) (=> (= temp_8_1~1546@ (Mul (Add (Sub (Mul a8~66@ c8~70@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Mul (Sub c8~70@ d8~72@) (Mul d8~72@ a8~66@)) (Sub (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1481@ temp_8_1~1546@))) (=> (= temp_8_0~1481@ temp_8_1~1546@) (=> (= temp_9_0~1635@ (Sub (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Sub (Sub c9~78@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ c9~78@) (Sub b9~76@ c9~78@)) (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~1700@ (Sub (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Sub (Sub c9~78@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ c9~78@) (Sub b9~76@ c9~78@)) (Mul (Mul b9~76@ a9~74@) (Mul c9~78@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1635@ temp_9_1~1700@))) (=> (= temp_9_0~1635@ temp_9_1~1700@) (=> (= temp_10_0~1789@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Sub b10~84@ c10~86@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ d10~88@))) (Sub (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1854@ (Mul (Mul (Mul d10~88@ d10~88@) (Sub b10~84@ c10~86@)) (Mul (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ d10~88@)) (Sub (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Mul d10~88@ c10~86@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1789@ temp_10_1~1854@))) (=> (= temp_10_0~1789@ temp_10_1~1854@) (=> (= temp_11_0~1955@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) (Add b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ c11~94@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ 46))))) (=> (= temp_11_1~2040@ (Mul (Mul (Add (Mul (Mul c11~94@ c11~94@) b11~92@) (Mul (Mul c11~94@ c11~94@) d11~96@)) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ c11~94@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ 46))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1955@ temp_11_1~2040@))) (=> (= temp_11_0~1955@ temp_11_1~2040@) (=> (= temp_12_0~2117@ (Mul (Mul (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ a12~98@))) (Mul a12~98@ (Mul (Mul c12~102@ c12~102@) (Add b12~100@ b12~100@))))) (=> (= temp_12_1~2178@ (Mul (Mul (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ a12~98@))) (Mul a12~98@ (Add (Mul (Mul c12~102@ c12~102@) b12~100@) (Mul (Mul c12~102@ c12~102@) b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2117@ temp_12_1~2178@))) (=> (= temp_12_0~2117@ temp_12_1~2178@) (=> (= temp_13_0~2275@ (Mul (Sub (Add b13~108@ (Mul 83 a13~106@)) (Mul (Sub a13~106@ b13~108@) (Mul b13~108@ c13~110@))) (Mul (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ d13~112@)) (Mul (Mul a13~106@ a13~106@) (Add b13~108@ a13~106@))))) (=> (= temp_13_1~2348@ (Mul (Mul (Sub (Add b13~108@ (Mul 83 a13~106@)) (Mul (Sub a13~106@ b13~108@) (Mul b13~108@ c13~110@))) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ d13~112@))) (Mul (Mul a13~106@ a13~106@) (Add b13~108@ a13~106@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2275@ temp_13_1~2348@))) (=> (= temp_13_0~2275@ temp_13_1~2348@) (=> (= temp_14_0~2433@ (Mul (Mul (Sub (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ d14~120@))) (Mul (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul a14~114@ (Sub c14~118@ c14~118@))))) (=> (= temp_14_1~2494@ (Mul (Sub (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ d14~120@)) (Mul (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul a14~114@ (Sub c14~118@ c14~118@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2433@ temp_14_1~2494@))) (=> (= temp_14_0~2433@ temp_14_1~2494@) (=> (= temp_15_0~2575@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Sub c15~126@ a15~122@)) (Mul (Mul c15~126@ c15~126@) d15~128@)) (Mul (Mul c15~126@ (Mul b15~124@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ a15~122@))))) (=> (= temp_15_1~2632@ (Mul (Mul (Mul c15~126@ (Mul b15~124@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ a15~122@))) (Mul (Mul (Mul d15~128@ d15~128@) (Sub c15~126@ a15~122@)) (Mul (Mul c15~126@ c15~126@) d15~128@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2575@ temp_15_1~2632@))) (=> (= temp_15_0~2575@ temp_15_1~2632@) (=> (= temp_16_0~2721@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Sub b16~132@ d16~136@)) (Add (Mul c16~134@ d16~136@) (Sub b16~132@ d16~136@))) (Add (Mul (Mul d16~136@ b16~132@) (Mul a16~130@ d16~136@)) (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ d16~136@))))) (=> (= temp_16_1~2786@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Sub b16~132@ d16~136@)) (Add (Mul c16~134@ d16~136@) (Sub b16~132@ d16~136@))) (Add (Mul (Mul d16~136@ b16~132@) (Mul a16~130@ d16~136@)) (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2721@ temp_16_1~2786@))) (=> (= temp_16_0~2721@ temp_16_1~2786@) (=> (= temp_17_0~2871@ (Add (Mul (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ a17~138@)) (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@))) (Add (Mul (Mul b17~140@ d17~144@) d17~144@) (Mul (Add c17~142@ a17~138@) (Add c17~142@ b17~140@))))) (=> (= temp_17_1~2932@ (Add (Mul (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ a17~138@))) (Add (Mul (Mul b17~140@ d17~144@) d17~144@) (Mul (Add c17~142@ a17~138@) (Add c17~142@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2871@ temp_17_1~2932@))) (=> (= temp_17_0~2871@ temp_17_1~2932@) (=> (= temp_18_0~3005@ (Mul (Mul c18~150@ (Mul (Sub d18~152@ a18~146@) (Sub d18~152@ a18~146@))) (Add (Mul (Mul d18~152@ d18~152@) (Mul a18~146@ b18~148@)) (Mul a18~146@ (Mul c18~150@ a18~146@))))) (=> (= temp_18_1~3062@ (Mul (Mul c18~150@ (Sub (Mul (Sub d18~152@ a18~146@) d18~152@) (Mul (Sub d18~152@ a18~146@) a18~146@))) (Add (Mul (Mul d18~152@ d18~152@) (Mul a18~146@ b18~148@)) (Mul a18~146@ (Mul c18~150@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3005@ temp_18_1~3062@))) (=> (= temp_18_0~3005@ temp_18_1~3062@) (=> (= temp_19_0~3151@ (Mul (Mul (Mul (Mul b19~156@ b19~156@) (Mul a19~154@ c19~158@)) (Add (Mul c19~158@ a19~154@) (Mul c19~158@ b19~156@))) (Sub (Mul (Add c19~158@ a19~154@) (Mul b19~156@ c19~158@)) (Mul (Mul b19~156@ d19~160@) (Mul b19~156@ a19~154@))))) (=> (= temp_19_1~3216@ (Mul (Mul (Mul (Mul b19~156@ b19~156@) (Mul a19~154@ c19~158@)) (Add (Mul c19~158@ a19~154@) (Mul c19~158@ b19~156@))) (Sub (Mul (Add c19~158@ a19~154@) (Mul b19~156@ c19~158@)) (Mul b19~156@ (Mul d19~160@ (Mul b19~156@ a19~154@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3151@ temp_19_1~3216@))) (=> (= temp_19_0~3151@ temp_19_1~3216@) (=> (= temp_20_0~3281@ (Mul (Mul (Mul (Mul c20~166@ d20~168@) (Mul b20~164@ a20~162@)) b20~164@) (Mul a20~162@ (Add (Mul c20~166@ c20~166@) (Mul a20~162@ b20~164@))))) (=> (= temp_20_1~3322@ (Mul (Mul (Mul (Mul c20~166@ d20~168@) (Mul b20~164@ a20~162@)) b20~164@) (Mul a20~162@ (Add (Mul c20~166@ c20~166@) (Mul a20~162@ b20~164@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3281@ temp_20_1~3322@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
