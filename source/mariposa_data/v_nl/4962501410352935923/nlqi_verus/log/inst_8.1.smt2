...
(set-info :comment ";; mariposa_data/v_nl//4962501410352935923/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul (Mul (Add b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Mul d0~8@ (Add a0~2@ a0~2@))) (Mul (Mul c0~6@ (Mul a0~2@ a0~2@)) (Mul d0~8@ (Mul a0~2@ a0~2@))))) (=> (= temp_0_1~346@ (Mul (Mul (Mul d0~8@ (Add a0~2@ a0~2@)) (Mul (Add b0~4@ a0~2@) (Mul c0~6@ d0~8@))) (Mul (Mul c0~6@ (Mul a0~2@ a0~2@)) (Mul d0~8@ (Mul a0~2@ a0~2@))))) (and (=> (= tmp%1@ (Mul (Add b0~4@ a0~2@) (Mul c0~6@ d0~8@))) (=> (= tmp%2@ (Mul d0~8@ (Add a0~2@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@))))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~459@ (Add (Mul (Add (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Add b1~12@ c1~14@))) (Add (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ c1~14@)) (Mul (Sub a1~10@ a1~10@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~524@ (Add (Mul (Add (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Add b1~12@ c1~14@))) (Add (Mul (Mul (Mul a1~10@ b1~12@) d1~16@) c1~14@) (Mul (Sub a1~10@ a1~10@) (Mul c1~14@ b1~12@))))) (and (=> (= tmp%3@ (Mul a1~10@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~459@ temp_1_1~524@)))) (=> (= temp_1_0~459@ temp_1_1~524@) (=> (= temp_2_0~623@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@))) (Add (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ a2~18@))))) (=> (= temp_2_1~688@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@))) (Add (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ c2~22@) (=> %%location_label%%2 (= temp_2_0~623@ temp_2_1~688@))) (=> (= temp_2_0~623@ temp_2_1~688@) (=> (= temp_3_0~785@ (Mul (Mul (Mul c3~30@ (Mul a3~26@ c3~30@)) (Mul (Sub c3~30@ c3~30@) b3~28@)) (Sub (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Sub 15 b3~28@))))) (=> (= temp_3_1~854@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) c3~30@) (Mul (Sub c3~30@ c3~30@) b3~28@)) (Sub (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Sub 15 b3~28@))))) (and (=> (= tmp%4@ (Mul a3~26@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~785@ temp_3_1~854@)))) (=> (= temp_3_0~785@ temp_3_1~854@) (=> (= temp_4_0~951@ (Sub (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Sub a4~34@ d4~40@) (Sub c4~38@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~1016@ (Sub (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ c4~38@))) (Mul (Mul (Sub a4~34@ d4~40@) (Sub c4~38@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul c4~38@ c4~38@))))) (and (=> (= tmp%5@ (Mul c4~38@ c4~38@)) (=> (= tmp%6@ (Mul a4~34@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~951@ temp_4_1~1016@))))) (=> (= temp_4_0~951@ temp_4_1~1016@) (=> (= temp_5_0~1085@ (Mul (Mul (Mul (Mul b5~44@ a5~42@) a5~42@) (Mul (Mul d5~48@ c5~46@) (Sub a5~42@ d5~48@))) a5~42@)) (=> (= temp_5_1~1126@ (Mul (Mul (Mul (Mul b5~44@ a5~42@) a5~42@) (Sub (Mul (Mul d5~48@ c5~46@) a5~42@) (Mul (Mul d5~48@ c5~46@) d5~48@))) a5~42@)) (and (=> (= tmp%7@ (Mul d5~48@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%7@ a5~42@ d5~48@) (=> %%location_label%%5 (= temp_5_0~1085@ temp_5_1~1126@)))) (=> (= temp_5_0~1085@ temp_5_1~1126@) (=> (= temp_6_0~1221@ (Mul (Mul (Mul (Mul c6~54@ d6~56@) c6~54@) (Mul (Add d6~56@ d6~56@) (Mul b6~52@ b6~52@))) (Add (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@))))) (=> (= temp_6_1~1282@ (Mul (Add (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul c6~54@ d6~56@) c6~54@) (Mul (Add d6~56@ d6~56@) (Mul b6~52@ b6~52@))))) (and (=> (= tmp%8@ (Mul (Mul (Mul c6~54@ d6~56@) c6~54@) (Mul (Add d6~56@ d6~56@) (Mul b6~52@ b6~52@)))) (=> (= tmp%9@ (Add (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%6 (= temp_6_0~1221@ temp_6_1~1282@))))) (=> (= temp_6_0~1221@ temp_6_1~1282@) (=> (= temp_7_0~1411@ (Mul (Mul (Sub (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@))) (Mul c7~62@ (Mul (Mul d7~64@ d7~64@) d7~64@)))) (=> (= temp_7_1~1460@ (Mul (Mul (Sub (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@))) (Mul (Mul c7~62@ (Mul d7~64@ d7~64@)) d7~64@))) (=> (= tmp%10@ (Mul d7~64@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c7~62@ tmp%10@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1411@ temp_7_1~1460@)))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
