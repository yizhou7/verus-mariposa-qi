...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul (Mul (Add b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Mul d0~8@ (Add a0~2@ a0~2@))) (Mul (Mul c0~6@ (Mul a0~2@ a0~2@)) (Mul d0~8@ (Mul a0~2@ a0~2@))))) (=> (= temp_0_1~346@ (Mul (Mul (Mul d0~8@ (Add a0~2@ a0~2@)) (Mul (Add b0~4@ a0~2@) (Mul c0~6@ d0~8@))) (Mul (Mul c0~6@ (Mul a0~2@ a0~2@)) (Mul d0~8@ (Mul a0~2@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~293@ temp_0_1~346@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~426@ (Add (Mul (Add (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Add b1~12@ c1~14@))) (Add (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ c1~14@)) (Mul (Sub a1~10@ a1~10@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~491@ (Add (Mul (Add (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Add b1~12@ c1~14@))) (Add (Mul (Mul (Mul a1~10@ b1~12@) d1~16@) c1~14@) (Mul (Sub a1~10@ a1~10@) (Mul c1~14@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~426@ temp_1_1~491@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~571@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@))) (Add (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ a2~18@))))) (=> (= temp_2_1~636@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@))) (Add (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~571@ temp_2_1~636@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~720@ (Mul (Mul (Mul c3~30@ (Mul a3~26@ c3~30@)) (Mul (Sub c3~30@ c3~30@) b3~28@)) (Sub (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Sub 15 b3~28@))))) (=> (= temp_3_1~789@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) c3~30@) (Mul (Sub c3~30@ c3~30@) b3~28@)) (Sub (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Sub 15 b3~28@))))) (=> (= tmp%4@ (= temp_3_0~720@ temp_3_1~789@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~869@ (Sub (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Sub a4~34@ d4~40@) (Sub c4~38@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~934@ (Sub (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ c4~38@))) (Mul (Mul (Sub a4~34@ d4~40@) (Sub c4~38@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul c4~38@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~869@ temp_4_1~934@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~982@ (Mul (Mul (Mul (Mul b5~44@ a5~42@) a5~42@) (Mul (Mul d5~48@ c5~46@) (Sub a5~42@ d5~48@))) a5~42@)) (=> (= temp_5_1~1023@ (Mul (Mul (Mul (Mul b5~44@ a5~42@) a5~42@) (Sub (Mul (Mul d5~48@ c5~46@) a5~42@) (Mul (Mul d5~48@ c5~46@) d5~48@))) a5~42@)) (=> (= tmp%6@ (= temp_5_0~982@ temp_5_1~1023@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1099@ (Mul (Mul (Mul (Mul c6~54@ d6~56@) c6~54@) (Mul (Add d6~56@ d6~56@) (Mul b6~52@ b6~52@))) (Add (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@))))) (=> (= temp_6_1~1160@ (Mul (Add (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul c6~54@ d6~56@) c6~54@) (Mul (Add d6~56@ d6~56@) (Mul b6~52@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1099@ temp_6_1~1160@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1224@ (Mul (Mul (Sub (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@))) (Mul c7~62@ (Mul (Mul d7~64@ d7~64@) d7~64@)))) (=> (= temp_7_1~1273@ (Mul (Mul (Sub (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@))) (Mul (Mul c7~62@ (Mul d7~64@ d7~64@)) d7~64@))) (=> (= tmp%8@ (= temp_7_0~1224@ temp_7_1~1273@)) (=> %%location_label%%7 tmp%8@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
