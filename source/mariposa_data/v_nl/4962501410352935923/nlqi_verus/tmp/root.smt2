      ...
      (=>
       ...
       (and
        ...
        (=>
         tmp%1@
         (=>
          (= temp_1_0~426@ (Add (Mul (Add (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul d1~16@
               b1~12@
              ) (Add b1~12@ c1~14@)
             )
          ...
          (=>
           (= temp_1_1~491@ (Add (Mul (Add (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul d1~16@
                b1~12@
               ) (Add b1~12@ c1~14@)
              )
           ...
           (=>
            ...
            (and
             ...
             (=>
              tmp%2@
              (=>
               (= temp_2_0~571@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@
                    c2~22@
                   ) (Mul d2~24@ d2~24@)
                  )
               ...
               (=>
                (= temp_2_1~636@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@
                     c2~22@
                    ) (Mul d2~24@ d2~24@)
                   )
                  ) (Add (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   tmp%3@
                   (=>
                    (= temp_3_0~720@ (Mul (Mul (Mul c3~30@ (Mul a3~26@ c3~30@)) (Mul (Sub c3~30@ c3~30@)
                        b3~28@
                       )
                    ...
                    (=>
                     (= temp_3_1~789@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) c3~30@) (Mul (Sub c3~30@ c3~30@)
                         b3~28@
                        )
                       ) (Sub (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Sub 15
                          b3~28@
                     ...
                     (=>
                      (= tmp%4@ (= temp_3_0~720@ temp_3_1~789@))
                      (and
                       (=>
                        %%location_label%%3
                        tmp%4@
                       ...
                       (=>
                        tmp%4@
                        (=>
                         (= temp_4_0~869@ (Sub (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul c4~38@
                              c4~38@
                             ) (Mul a4~34@ a4~34@)
                            )
                         ...
                         (=>
                          (= temp_4_1~934@ (Sub (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul a4~34@
                               a4~34@
                              ) (Mul c4~38@ c4~38@)
                             )
                            ) (Mul (Mul (Sub a4~34@ d4~40@) (Sub c4~38@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul c4~38@
                          ...
                          (=>
                           ...
                           (and
                            ...
                            (=>
                             tmp%5@
                             (=>
                              (= temp_5_0~982@ (Mul (Mul (Mul (Mul b5~44@ a5~42@) a5~42@) (Mul (Mul d5~48@ c5~46@)
                                  (Sub a5~42@ d5~48@)
                                 )
                                ) a5~42@
                              ))
                              (=>
                               (= temp_5_1~1023@ (Mul (Mul (Mul (Mul b5~44@ a5~42@) a5~42@) (Sub (Mul (Mul d5~48@ c5~46@)
                                    a5~42@
                               ...
                               (=>
                                (= tmp%6@ (= temp_5_0~982@ temp_5_1~1023@))
                                (and
                                 (=>
                                  %%location_label%%5
                                  tmp%6@
                                 ...
                                 (=>
                                  tmp%6@
                                  (=>
                                   (= temp_6_0~1099@ (Mul (Mul (Mul (Mul c6~54@ d6~56@) c6~54@) (Mul (Add d6~56@ d6~56@)
                                       (Mul b6~52@ b6~52@)
                                      )
                                   ...
                                   (=>
                                    (= temp_6_1~1160@ (Mul (Add (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@
                                         d6~56@
                                        ) (Mul b6~52@ a6~50@)
                                       )
                                    ...
                                    (=>
                                     ...
                                     (and
                                      ...
                                      (=>
                                       tmp%7@
                                       (=>
                                        (= temp_7_0~1224@ (Mul (Mul (Sub (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@
                                             c7~62@
                                            ) (Mul a7~58@ a7~58@)
                                           )
                                        ...
                                        (=>
                                         (= temp_7_1~1273@ (Mul (Mul (Sub (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@
                                              c7~62@
                                             ) (Mul a7~58@ a7~58@)
                                            )
