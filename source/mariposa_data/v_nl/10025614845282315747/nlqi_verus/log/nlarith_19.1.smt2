...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Add (Mul (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@))) (Mul (Mul b0~4@ (Add c0~6@ c0~6@)) (Add (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~362@ (Add (Mul (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@))) (Mul (Mul b0~4@ (Add c0~6@ c0~6@)) (Add (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~430@ (Mul (Sub (Mul (Mul a1~10@ b1~12@) (Add a1~10@ c1~14@)) (Mul (Add b1~12@ b1~12@) (Add b1~12@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ d1~16@)) a1~10@))) (=> (= temp_1_1~483@ (Mul (Sub (Mul (Mul a1~10@ b1~12@) (Add a1~10@ c1~14@)) (Mul (Add b1~12@ a1~10@) (Add b1~12@ b1~12@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ d1~16@)) a1~10@))) (=> (= tmp%2@ (= temp_1_0~430@ temp_1_1~483@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~559@ (Sub (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@)) (Add a2~18@ (Mul a2~18@ c2~22@))) (Mul (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~620@ (Sub (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@)) (Add a2~18@ (Mul a2~18@ c2~22@))) (Mul (Mul d2~24@ (Mul a2~18@ (Mul d2~24@ d2~24@))) (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~559@ temp_2_1~620@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~688@ (Add (Sub (Sub (Sub a3~26@ c3~30@) (Mul b3~28@ c3~30@)) b3~28@) (Mul (Sub (Mul b3~28@ d3~32@) (Sub a3~26@ d3~32@)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ a3~26@))))) (=> (= temp_3_1~757@ (Add (Sub (Sub (Sub a3~26@ c3~30@) (Mul b3~28@ c3~30@)) b3~28@) (Sub (Mul (Mul b3~28@ d3~32@) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ a3~26@))) (Mul (Sub a3~26@ d3~32@) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ a3~26@)))))) (=> (= tmp%4@ (= temp_3_0~688@ temp_3_1~757@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~837@ (Mul (Mul (Add (Mul c4~38@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~902@ (Mul (Mul (Add (Mul c4~38@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~837@ temp_4_1~902@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~982@ (Mul (Mul (Add (Mul b5~44@ d5~48@) (Add c5~46@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul c5~46@ a5~42@) (Sub c5~46@ b5~44@))))) (=> (= temp_5_1~1047@ (Mul (Mul (Add (Mul b5~44@ d5~48@) (Add c5~46@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul c5~46@ a5~42@) (Sub c5~46@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~982@ temp_5_1~1047@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1123@ (Sub (Mul (Mul (Mul c6~54@ d6~56@) c6~54@) (Mul (Add d6~56@ c6~54@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul c6~54@ b6~52@) (Add a6~50@ b6~52@)) (Mul (Sub a6~50@ b6~52@) (Sub b6~52@ a6~50@))))) (=> (= temp_6_1~1184@ (Sub (Mul (Mul (Mul c6~54@ d6~56@) c6~54@) (Mul (Add d6~56@ c6~54@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul c6~54@ b6~52@) (Add a6~50@ b6~52@)) (Mul (Sub b6~52@ a6~50@) (Sub a6~50@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1123@ temp_6_1~1184@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1260@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ c7~62@))) (Sub (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ a7~58@) a7~58@)))) (=> (= temp_7_1~1321@ (Mul (Sub (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ a7~58@) a7~58@)) (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ c7~62@))))) (=> (= tmp%8@ (= temp_7_0~1260@ temp_7_1~1321@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1401@ (Add (Mul (Mul (Mul c8~70@ a8~66@) (Add b8~68@ d8~72@)) (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1466@ (Add (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ a8~66@) (Add b8~68@ d8~72@))) (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1401@ temp_8_1~1466@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1542@ (Mul (Add (Mul (Mul a9~74@ b9~76@) (Sub b9~76@ a9~74@)) (Mul a9~74@ (Mul a9~74@ b9~76@))) (Mul (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~1603@ (Mul (Add (Mul (Mul a9~74@ b9~76@) (Sub b9~76@ a9~74@)) (Mul (Mul a9~74@ a9~74@) b9~76@)) (Mul (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1542@ temp_9_1~1603@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1671@ (Mul (Mul d10~88@ d10~88@) (Mul (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ c10~86@)) (Mul (Add d10~88@ d10~88@) (Mul a10~82@ 90))))) (=> (= temp_10_1~1724@ (Mul (Mul d10~88@ d10~88@) (Mul (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ c10~86@)) (Mul (Add d10~88@ d10~88@) (Mul a10~82@ 90))))) (=> (= tmp%11@ (= temp_10_0~1671@ temp_10_1~1724@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1824@ (Mul (Add (Sub (Mul c11~94@ b11~92@) (Mul b11~92@ c11~94@)) (Add (Mul a11~90@ a11~90@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul 60 d11~96@) (Mul a11~90@ 56)) (Mul b11~92@ (Mul c11~94@ b11~92@))))) (=> (= temp_11_1~1909@ (Mul (Add (Sub (Mul c11~94@ b11~92@) (Mul b11~92@ c11~94@)) (Add (Mul a11~90@ a11~90@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul 60 d11~96@) (Mul a11~90@ 56)) (Mul b11~92@ (Mul b11~92@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1824@ temp_11_1~1909@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1981@ (Mul (Mul (Mul c12~102@ (Mul c12~102@ a12~98@)) (Mul (Mul c12~102@ a12~98@) (Add a12~98@ d12~104@))) (Mul (Mul (Mul c12~102@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Mul b12~100@ d12~104@) d12~104@)))) (=> (= temp_12_1~2038@ (Mul (Mul (Mul c12~102@ (Mul c12~102@ a12~98@)) (Mul (Mul c12~102@ a12~98@) (Add a12~98@ d12~104@))) (Mul (Mul c12~102@ (Mul a12~98@ (Mul b12~100@ a12~98@))) (Mul (Mul b12~100@ d12~104@) d12~104@)))) (=> (= tmp%13@ (= temp_12_0~1981@ temp_12_1~2038@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2114@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Mul b13~108@ b13~108@)) (Add (Mul d13~112@ c13~110@) (Sub a13~106@ b13~108@))) (Mul (Mul (Mul b13~108@ a13~106@) (Add c13~110@ b13~108@)) (Mul a13~106@ (Mul a13~106@ c13~110@))))) (=> (= temp_13_1~2175@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Mul b13~108@ b13~108@)) (Add (Mul d13~112@ c13~110@) (Sub a13~106@ b13~108@))) (Mul (Mul a13~106@ (Mul a13~106@ c13~110@)) (Mul (Mul b13~108@ a13~106@) (Add c13~110@ b13~108@))))) (=> (= tmp%14@ (= temp_13_0~2114@ temp_13_1~2175@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2247@ (Mul (Mul (Sub d14~120@ (Mul a14~114@ a14~114@)) (Mul (Mul d14~120@ b14~116@) (Mul c14~118@ a14~114@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ a14~114@)) (Add (Mul b14~116@ b14~116@) d14~120@)))) (=> (= temp_14_1~2304@ (Mul (Mul (Sub d14~120@ (Mul a14~114@ a14~114@)) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ a14~114@)) (Add (Mul b14~116@ b14~116@) d14~120@)))) (=> (= tmp%15@ (= temp_14_0~2247@ temp_14_1~2304@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2384@ (Mul (Sub (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Sub b15~124@ b15~124@))) (Mul (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ a15~122@)) (Mul (Mul d15~128@ d15~128@) (Mul b15~124@ d15~128@))))) (=> (= temp_15_1~2449@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ a15~122@)) (Mul (Mul d15~128@ d15~128@) (Mul b15~124@ d15~128@))) (Sub (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Sub b15~124@ b15~124@))))) (=> (= tmp%16@ (= temp_15_0~2384@ temp_15_1~2449@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2529@ (Sub (Mul (Mul (Sub b16~132@ d16~136@) (Add c16~134@ d16~136@)) (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ b16~132@))) (Mul (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ b16~132@) (Sub a16~130@ a16~130@))))) (=> (= temp_16_1~2594@ (Sub (Mul (Mul (Sub b16~132@ d16~136@) (Add c16~134@ d16~136@)) (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ b16~132@))) (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ b16~132@)) (Mul b16~132@ b16~132@)) (Sub a16~130@ a16~130@)))) (=> (= tmp%17@ (= temp_16_0~2529@ temp_16_1~2594@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2686@ (Mul (Mul (Mul (Mul a17~138@ c17~142@) (Mul c17~142@ c17~142@)) (Mul (Mul a17~138@ 60) (Mul b17~140@ b17~140@))) (Mul (Mul (Sub d17~144@ a17~138@) (Mul b17~140@ a17~138@)) (Mul (Add c17~142@ b17~140@) (Mul b17~140@ c17~142@))))) (=> (= temp_17_1~2763@ (Mul (Mul (Mul (Mul a17~138@ c17~142@) (Mul c17~142@ c17~142@)) (Mul (Mul a17~138@ 60) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul (Sub d17~144@ a17~138@) b17~140@) a17~138@) (Mul (Add c17~142@ b17~140@) (Mul b17~140@ c17~142@))))) (=> (= tmp%18@ (= temp_17_0~2686@ temp_17_1~2763@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2843@ (Mul (Mul (Mul (Add b18~148@ a18~146@) (Sub c18~150@ a18~146@)) (Add (Mul c18~150@ c18~150@) (Mul a18~146@ c18~150@))) (Add (Sub (Sub b18~148@ c18~150@) (Add b18~148@ c18~150@)) (Mul (Mul d18~152@ b18~148@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~2908@ (Mul (Add (Sub (Sub b18~148@ c18~150@) (Add b18~148@ c18~150@)) (Mul (Mul d18~152@ b18~148@) (Mul a18~146@ d18~152@))) (Mul (Mul (Add b18~148@ a18~146@) (Sub c18~150@ a18~146@)) (Add (Mul c18~150@ c18~150@) (Mul a18~146@ c18~150@))))) (=> (= tmp%19@ (= temp_18_0~2843@ temp_18_1~2908@)) (=> %%location_label%%18 tmp%19@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
