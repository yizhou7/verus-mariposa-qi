...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Add (Sub (Add (Mul a0~2@ c0~6@) d0~8@) (Add c0~6@ (Mul d0~8@ d0~8@))) (Mul (Mul b0~4@ (Mul a0~2@ d0~8@)) (Sub (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~346@ (Add (Sub (Add (Mul a0~2@ c0~6@) d0~8@) (Add c0~6@ (Mul d0~8@ d0~8@))) (Mul b0~4@ (Mul (Mul a0~2@ d0~8@) (Sub (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~471@ (Mul (Mul (Mul (Add d1~16@ 2) (Mul b1~12@ c1~14@)) (Mul (Mul 59 d1~16@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Sub a1~10@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul 5 c1~14@))))) (=> (= temp_1_1~572@ (Mul (Mul (Mul (Mul 59 d1~16@) (Mul c1~14@ a1~10@)) (Mul (Add d1~16@ 2) (Mul b1~12@ c1~14@))) (Mul (Mul (Mul b1~12@ c1~14@) (Sub a1~10@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul 5 c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~471@ temp_1_1~572@))) (=> (= temp_1_0~471@ temp_1_1~572@) (=> (= temp_2_0~669@ (Mul (Mul (Mul (Sub d2~24@ a2~18@) (Sub b2~20@ d2~24@)) (Mul d2~24@ (Mul 58 a2~18@))) (Mul 17 (Mul (Mul a2~18@ c2~22@) (Sub d2~24@ d2~24@))))) (=> (= temp_2_1~742@ (Mul (Mul (Mul (Sub d2~24@ a2~18@) (Sub b2~20@ d2~24@)) (Mul d2~24@ (Mul 58 a2~18@))) (Mul 17 (Mul (Mul c2~22@ a2~18@) (Sub d2~24@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~669@ temp_2_1~742@))) (=> (= temp_2_0~669@ temp_2_1~742@) (=> (= temp_3_0~831@ (Add (Mul (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ a3~26@))) (Sub (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ c3~30@)) (Mul (Add c3~30@ b3~28@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~896@ (Add (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ a3~26@))) (Sub (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ c3~30@)) (Mul (Add c3~30@ b3~28@) (Mul b3~28@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~831@ temp_3_1~896@))) (=> (= temp_3_0~831@ temp_3_1~896@) (=> (= temp_4_0~981@ (Mul (Mul (Mul b4~36@ (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~1042@ (Mul (Mul (Mul b4~36@ (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~981@ temp_4_1~1042@))) (=> (= temp_4_0~981@ temp_4_1~1042@) (=> (= temp_5_0~1131@ (Add (Sub (Sub (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Sub d5~48@ b5~44@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~1196@ (Add (Sub (Sub (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ a5~42@))) (Mul (Mul b5~44@ (Mul c5~46@ (Mul d5~48@ c5~46@))) (Mul (Sub d5~48@ b5~44@) (Mul a5~42@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1131@ temp_5_1~1196@))) (=> (= temp_5_0~1131@ temp_5_1~1196@) (=> (= temp_6_0~1293@ (Mul (Mul (Sub (Mul a6~50@ c6~54@) (Mul c6~54@ 8)) (Add (Mul a6~50@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Add a6~50@ (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@ a6~50@) (Add d6~56@ c6~54@))))) (=> (= temp_6_1~1366@ (Mul (Mul (Sub (Mul c6~54@ a6~50@) (Mul c6~54@ 8)) (Add (Mul a6~50@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Add a6~50@ (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@ a6~50@) (Add d6~56@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1293@ temp_6_1~1366@))) (=> (= temp_6_0~1293@ temp_6_1~1366@) (=> (= temp_7_0~1451@ (Sub (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ a7~58@)) (Mul (Sub b7~60@ d7~64@) a7~58@)))) (=> (= temp_7_1~1512@ (Sub (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@)) (Mul (Sub b7~60@ d7~64@) a7~58@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1451@ temp_7_1~1512@))) (=> (= temp_7_0~1451@ temp_7_1~1512@) (=> (= temp_8_0~1561@ (Mul (Mul d8~72@ (Mul (Sub d8~72@ c8~70@) (Mul b8~68@ d8~72@))) c8~70@)) (=> (= temp_8_1~1594@ (Mul (Mul d8~72@ (Sub (Mul d8~72@ (Mul b8~68@ d8~72@)) (Mul c8~70@ (Mul b8~68@ d8~72@)))) c8~70@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1561@ temp_8_1~1594@))) (=> (= temp_8_0~1561@ temp_8_1~1594@) (=> (= temp_9_0~1695@ (Sub (Mul (Mul (Mul a9~74@ a9~74@) (Mul d9~80@ c9~78@)) (Sub (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ a9~74@)) (Add (Mul 80 d9~80@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~1772@ (Sub (Mul (Mul (Mul a9~74@ a9~74@) (Mul d9~80@ c9~78@)) (Sub (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ a9~74@)) (Add (Mul 80 d9~80@) (Mul a9~74@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1695@ temp_9_1~1772@))) (=> (= temp_9_0~1695@ temp_9_1~1772@) (=> (= temp_10_0~1861@ (Mul (Mul (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ a10~82@)) (Mul (Sub c10~86@ a10~82@) (Mul c10~86@ c10~86@))) (Mul (Mul (Add b10~84@ d10~88@) (Mul b10~84@ c10~86@)) (Mul (Mul c10~86@ a10~82@) (Add c10~86@ c10~86@))))) (=> (= temp_10_1~1926@ (Mul (Mul (Mul (Add b10~84@ d10~88@) (Mul b10~84@ c10~86@)) (Mul (Mul c10~86@ a10~82@) (Add c10~86@ c10~86@))) (Mul (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ a10~82@)) (Mul (Sub c10~86@ a10~82@) (Mul c10~86@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1861@ temp_10_1~1926@))) (=> (= temp_10_0~1861@ temp_10_1~1926@) (=> (= temp_11_0~2023@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) (Mul 39 b11~92@)) (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul d11~96@ (Mul c11~94@ c11~94@))))) (=> (= temp_11_1~2096@ (Mul (Mul (Mul (Mul (Mul c11~94@ c11~94@) 39) b11~92@) (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul d11~96@ (Mul c11~94@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2023@ temp_11_1~2096@))) (=> (= temp_11_0~2023@ temp_11_1~2096@) (=> (= temp_12_0~2209@ (Mul (Mul (Sub (Sub d12~104@ c12~102@) (Mul 52 a12~98@)) (Mul (Mul b12~100@ b12~100@) (Add b12~100@ d12~104@))) (Mul (Mul (Mul d12~104@ a12~98@) (Add a12~98@ d12~104@)) (Mul (Mul d12~104@ c12~102@) (Mul 62 b12~100@))))) (=> (= temp_12_1~2306@ (Mul (Mul (Sub (Sub d12~104@ c12~102@) (Mul 52 a12~98@)) (Add (Mul (Mul b12~100@ b12~100@) b12~100@) (Mul (Mul b12~100@ b12~100@) d12~104@))) (Mul (Mul (Mul d12~104@ a12~98@) (Add a12~98@ d12~104@)) (Mul (Mul d12~104@ c12~102@) (Mul 62 b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2209@ temp_12_1~2306@))) (=> (= temp_12_0~2209@ temp_12_1~2306@) (=> (= temp_13_0~2383@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ c13~110@)) (Mul (Mul a13~106@ d13~112@) (Mul c13~110@ a13~106@))) (Mul b13~108@ (Mul (Mul d13~112@ a13~106@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2436@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ c13~110@)) (Mul (Mul c13~110@ a13~106@) (Mul a13~106@ d13~112@))) (Mul b13~108@ (Mul (Mul d13~112@ a13~106@) (Mul c13~110@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2383@ temp_13_1~2436@))) (=> (= temp_13_0~2383@ temp_13_1~2436@) (=> (= temp_14_0~2509@ (Mul a14~114@ (Add (Add (Add c14~118@ c14~118@) (Mul d14~120@ 79)) (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2558@ (Mul a14~114@ (Add (Add (Add c14~118@ c14~118@) (Mul d14~120@ 79)) (Mul (Mul b14~116@ b14~116@) (Mul b14~116@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2509@ temp_14_1~2558@))) (=> (= temp_14_0~2509@ temp_14_1~2558@) (=> (= temp_15_0~2647@ (Mul (Mul (Mul (Mul c15~126@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ c15~126@))) (Mul (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ a15~122@)) (Sub (Add d15~128@ d15~128@) (Mul b15~124@ b15~124@))))) (=> (= temp_15_1~2712@ (Mul (Mul (Mul (Mul (Mul c15~126@ a15~122@) c15~126@) c15~126@) (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ c15~126@))) (Mul (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ a15~122@)) (Sub (Add d15~128@ d15~128@) (Mul b15~124@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2647@ temp_15_1~2712@))) (=> (= temp_15_0~2647@ temp_15_1~2712@) (=> (= temp_16_0~2801@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Add c16~134@ a16~130@) (Add d16~136@ d16~136@))) (Mul (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ a16~130@)) (Add (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@))))) (=> (= temp_16_1~2866@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Add c16~134@ a16~130@) (Add d16~136@ d16~136@))) (Mul (Mul (Mul a16~130@ a16~130@) (Mul b16~132@ c16~134@)) (Add (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2801@ temp_16_1~2866@))) (=> (= temp_16_0~2801@ temp_16_1~2866@) (=> (= temp_17_0~2955@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul c17~142@ b17~140@)) (Mul (Mul b17~140@ d17~144@) (Mul d17~144@ a17~138@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~3020@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul c17~142@ b17~140@)) (Mul (Mul d17~144@ a17~138@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2955@ temp_17_1~3020@))) (=> (= temp_17_0~2955@ temp_17_1~3020@) (=> (= temp_18_0~3109@ (Mul (Mul (Mul (Mul d18~152@ b18~148@) (Mul b18~148@ a18~146@)) (Mul (Add a18~146@ c18~150@) (Mul b18~148@ c18~150@))) (Mul (Add (Mul b18~148@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul b18~148@ b18~148@) (Add b18~148@ b18~148@))))) (=> (= temp_18_1~3174@ (Mul (Mul (Mul (Mul d18~152@ b18~148@) (Mul b18~148@ a18~146@)) (Mul (Mul (Add a18~146@ c18~150@) b18~148@) c18~150@)) (Mul (Add (Mul b18~148@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul b18~148@ b18~148@) (Add b18~148@ b18~148@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3109@ temp_18_1~3174@))) (=> (= temp_18_0~3109@ temp_18_1~3174@) (=> (= temp_19_0~3251@ (Mul (Mul (Mul (Mul a19~154@ b19~156@) (Mul d19~160@ a19~154@)) (Mul (Mul d19~160@ a19~154@) (Mul b19~156@ c19~158@))) (Mul c19~158@ (Mul (Mul d19~160@ d19~160@) (Mul a19~154@ a19~154@))))) (=> (= temp_19_1~3304@ (Mul (Mul (Mul (Mul (Mul a19~154@ b19~156@) d19~160@) a19~154@) (Mul (Mul d19~160@ a19~154@) (Mul b19~156@ c19~158@))) (Mul c19~158@ (Mul (Mul d19~160@ d19~160@) (Mul a19~154@ a19~154@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3251@ temp_19_1~3304@))) (=> (= temp_19_0~3251@ temp_19_1~3304@) (=> (= temp_20_0~3353@ (Mul (Mul c20~166@ (Mul (Mul c20~166@ b20~164@) (Mul d20~168@ a20~162@))) d20~168@)) (=> (= temp_20_1~3378@ (Mul (Mul c20~166@ (Mul (Mul c20~166@ b20~164@) (Mul a20~162@ d20~168@))) d20~168@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3353@ temp_20_1~3378@))) (=> (= temp_20_0~3353@ temp_20_1~3378@) (=> (= temp_21_0~3487@ (Mul (Mul (Mul (Mul a21~170@ d21~176@) (Add c21~174@ a21~170@)) (Mul b21~172@ (Mul a21~170@ c21~174@))) (Mul (Mul (Sub c21~174@ b21~172@) (Mul d21~176@ c21~174@)) (Mul (Mul 55 d21~176@) (Mul a21~170@ 72))))) (=> (= temp_21_1~3572@ (Mul (Mul (Mul (Mul a21~170@ d21~176@) (Add c21~174@ a21~170@)) (Mul b21~172@ (Mul a21~170@ c21~174@))) (Mul (Mul (Mul d21~176@ c21~174@) (Sub c21~174@ b21~172@)) (Mul (Mul 55 d21~176@) (Mul a21~170@ 72))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3487@ temp_21_1~3572@))) (=> (= temp_21_0~3487@ temp_21_1~3572@) (=> (= temp_22_0~3673@ (Mul (Mul (Mul (Mul c22~182@ 15) (Mul d22~184@ b22~180@)) (Mul (Mul d22~184@ b22~180@) (Mul c22~182@ b22~180@))) (Mul (Sub (Mul c22~182@ c22~182@) (Mul a22~178@ a22~178@)) (Mul (Mul a22~178@ a22~178@) (Sub a22~178@ a22~178@))))) (=> (= temp_22_1~3750@ (Mul (Mul (Mul (Mul (Mul c22~182@ 15) d22~184@) b22~180@) (Mul (Mul d22~184@ b22~180@) (Mul c22~182@ b22~180@))) (Mul (Sub (Mul c22~182@ c22~182@) (Mul a22~178@ a22~178@)) (Mul (Mul a22~178@ a22~178@) (Sub a22~178@ a22~178@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3673@ temp_22_1~3750@))) (=> (= temp_22_0~3673@ temp_22_1~3750@) (=> (= temp_23_0~3847@ (Mul (Add (Mul (Mul b23~188@ a23~186@) (Mul b23~188@ a23~186@)) (Mul (Mul b23~188@ a23~186@) (Mul a23~186@ b23~188@))) (Mul (Mul (Mul b23~188@ b23~188@) (Mul d23~192@ b23~188@)) (Mul 83 (Mul c23~190@ a23~186@))))) (=> (= temp_23_1~3920@ (Mul (Add (Mul (Mul b23~188@ a23~186@) (Mul b23~188@ a23~186@)) (Mul (Mul b23~188@ a23~186@) (Mul a23~186@ b23~188@))) (Mul (Mul (Mul d23~192@ b23~188@) (Mul b23~188@ b23~188@)) (Mul 83 (Mul c23~190@ a23~186@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3847@ temp_23_1~3920@))) (=> (= temp_23_0~3847@ temp_23_1~3920@) (=> (= temp_24_0~4009@ (Mul (Mul (Mul (Mul a24~194@ d24~200@) (Mul b24~196@ a24~194@)) (Mul (Mul d24~200@ d24~200@) (Mul a24~194@ a24~194@))) (Mul (Mul (Mul a24~194@ b24~196@) (Mul a24~194@ d24~200@)) (Mul (Mul c24~198@ d24~200@) (Mul d24~200@ d24~200@))))) (=> (= temp_24_1~4074@ (Mul (Mul (Mul (Mul a24~194@ d24~200@) (Mul b24~196@ a24~194@)) (Mul (Mul d24~200@ d24~200@) (Mul a24~194@ a24~194@))) (Mul (Mul (Mul a24~194@ b24~196@) (Mul a24~194@ d24~200@)) (Mul (Mul d24~200@ c24~198@) (Mul d24~200@ d24~200@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~4009@ temp_24_1~4074@))) (=> (= temp_24_0~4009@ temp_24_1~4074@) (=> (= temp_25_0~4159@ (Sub (Mul (Mul (Mul c25~206@ a25~202@) (Mul a25~202@ a25~202@)) (Mul (Mul a25~202@ c25~206@) (Mul c25~206@ c25~206@))) (Mul (Mul d25~208@ (Mul a25~202@ a25~202@)) (Add (Mul d25~208@ d25~208@) (Mul b25~204@ a25~202@))))) (=> (= temp_25_1~4220@ (Sub (Mul (Mul (Mul c25~206@ a25~202@) (Mul a25~202@ a25~202@)) (Mul (Mul a25~202@ c25~206@) (Mul c25~206@ c25~206@))) (Mul (Mul d25~208@ (Mul a25~202@ a25~202@)) (Add (Mul d25~208@ d25~208@) (Mul b25~204@ a25~202@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~4159@ temp_25_1~4220@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
