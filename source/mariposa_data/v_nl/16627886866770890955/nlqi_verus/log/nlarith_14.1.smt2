...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Mul (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ a0~2@)) (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (Add (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ b0~4@)) (Add (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~370@ (Add (Mul (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ a0~2@))) (Add (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ b0~4@)) (Add (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~446@ (Mul (Sub (Sub (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Sub d1~16@ a1~10@) (Sub a1~10@ a1~10@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@)) (Mul a1~10@ (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~507@ (Mul (Sub (Sub (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Sub d1~16@ a1~10@) (Sub a1~10@ a1~10@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@)) (Mul a1~10@ (Mul d1~16@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~446@ temp_1_1~507@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~599@ (Add (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Sub b2~20@ 31) (Add a2~18@ b2~20@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~676@ (Add (Mul (Mul c2~22@ (Mul d2~24@ (Mul d2~24@ a2~18@))) (Mul (Sub b2~20@ 31) (Add a2~18@ b2~20@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~599@ temp_2_1~676@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~744@ (Mul (Mul c3~30@ (Mul (Sub b3~28@ d3~32@) (Mul c3~30@ d3~32@))) (Mul (Mul (Mul b3~28@ d3~32@) (Sub d3~32@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~797@ (Mul (Mul c3~30@ (Mul (Sub b3~28@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Sub d3~32@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~744@ temp_3_1~797@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~861@ (Mul (Mul (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Mul (Sub b4~36@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul c4~38@ b4~36@) a4~34@) d4~40@))) (=> (= temp_4_1~910@ (Mul (Mul (Mul (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Sub b4~36@ a4~34@)) (Mul c4~38@ b4~36@)) (Mul (Mul (Mul c4~38@ b4~36@) a4~34@) d4~40@))) (=> (= tmp%5@ (= temp_4_0~861@ temp_4_1~910@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~990@ (Mul (Mul (Add (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1055@ (Mul (Mul (Add (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul (Mul d5~48@ a5~42@) a5~42@) d5~48@)) (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~990@ temp_5_1~1055@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1135@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Add (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Add (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1200@ (Mul (Add (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Add (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@)) (Mul (Add (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ c6~54@)))))) (=> (= tmp%7@ (= temp_6_0~1135@ temp_6_1~1200@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1280@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Add (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@))) (Sub (Mul (Sub d7~64@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1345@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Add (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@))) (Sub (Mul (Sub d7~64@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1280@ temp_7_1~1345@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1433@ (Sub (Mul (Mul (Sub d8~72@ 55) (Add d8~72@ d8~72@)) (Mul b8~68@ (Mul c8~70@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@)) (Mul (Sub a8~66@ c8~70@) (Sub b8~68@ d8~72@))))) (=> (= temp_8_1~1514@ (Sub (Mul (Sub (Mul d8~72@ (Add d8~72@ d8~72@)) (Mul 55 (Add d8~72@ d8~72@))) (Mul b8~68@ (Mul c8~70@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@)) (Mul (Sub a8~66@ c8~70@) (Sub b8~68@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1433@ temp_8_1~1514@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1582@ (Mul (Mul (Mul (Add a9~74@ c9~78@) (Mul b9~76@ a9~74@)) d9~80@) (Add (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ d9~80@))))) (=> (= temp_9_1~1635@ (Mul (Mul d9~80@ (Mul (Add a9~74@ c9~78@) (Mul b9~76@ a9~74@))) (Add (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1582@ temp_9_1~1635@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1703@ (Mul (Mul (Sub (Sub d10~88@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul a10~82@ d10~88@) (Add a10~82@ a10~82@)) d10~88@))) (=> (= temp_10_1~1756@ (Mul (Mul (Sub (Sub d10~88@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul a10~82@ d10~88@) (Add a10~82@ a10~82@)) d10~88@))) (=> (= tmp%11@ (= temp_10_0~1703@ temp_10_1~1756@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1832@ (Mul (Add (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Mul b11~92@ (Add b11~92@ b11~92@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~1897@ (Mul (Add (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Add (Mul b11~92@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1832@ temp_11_1~1897@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1977@ (Sub (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ a12~98@) (Mul c12~102@ c12~102@))) (Mul (Mul (Sub a12~98@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~2042@ (Sub (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul a12~98@ (Mul a12~98@ (Mul c12~102@ c12~102@)))) (Mul (Mul (Sub a12~98@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ b12~100@))))) (=> (= tmp%13@ (= temp_12_0~1977@ temp_12_1~2042@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2118@ (Mul (Mul (Mul a13~106@ (Sub b13~108@ d13~112@)) (Sub (Mul d13~112@ d13~112@) (Mul a13~106@ c13~110@))) (Mul (Mul (Mul b13~108@ a13~106@) (Mul d13~112@ c13~110@)) (Add (Add a13~106@ d13~112@) (Mul a13~106@ d13~112@))))) (=> (= temp_13_1~2179@ (Mul (Mul (Mul a13~106@ (Sub b13~108@ d13~112@)) (Sub (Mul d13~112@ d13~112@) (Mul a13~106@ c13~110@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul b13~108@ a13~106@)) (Add (Add a13~106@ d13~112@) (Mul a13~106@ d13~112@))))) (=> (= tmp%14@ (= temp_13_0~2118@ temp_13_1~2179@)) (=> %%location_label%%13 tmp%14@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
