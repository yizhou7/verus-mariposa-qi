...
(set-info :comment ";; mariposa_data/v_nl//16627886866770890955/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_12_0~2285@ Int)
(declare-const temp_12_1~2350@ Int)
(declare-const temp_13_0~2445@ Int)
(declare-const temp_13_1~2506@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Mul (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ a0~2@)) (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (Add (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ b0~4@)) (Add (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~370@ (Add (Mul (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ a0~2@))) (Add (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ b0~4@)) (Add (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@))))) (and (=> (= tmp%1@ (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ a0~2@))) (=> (= tmp%2@ (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~483@ (Mul (Sub (Sub (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Sub d1~16@ a1~10@) (Sub a1~10@ a1~10@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@)) (Mul a1~10@ (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~544@ (Mul (Sub (Sub (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Sub d1~16@ a1~10@) (Sub a1~10@ a1~10@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@)) (Mul a1~10@ (Mul d1~16@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ d1~16@) (=> %%location_label%%1 (= temp_1_0~483@ temp_1_1~544@))) (=> (= temp_1_0~483@ temp_1_1~544@) (=> (= temp_2_0~649@ (Add (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Sub b2~20@ 31) (Add a2~18@ b2~20@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~726@ (Add (Mul (Mul c2~22@ (Mul d2~24@ (Mul d2~24@ a2~18@))) (Mul (Sub b2~20@ 31) (Add a2~18@ b2~20@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))))) (and (=> (= tmp%3@ (Mul d2~24@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c2~22@ d2~24@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~649@ temp_2_1~726@)))) (=> (= temp_2_0~649@ temp_2_1~726@) (=> (= temp_3_0~813@ (Mul (Mul c3~30@ (Mul (Sub b3~28@ d3~32@) (Mul c3~30@ d3~32@))) (Mul (Mul (Mul b3~28@ d3~32@) (Sub d3~32@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~866@ (Mul (Mul c3~30@ (Mul (Sub b3~28@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Sub d3~32@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ d3~32@) (=> %%location_label%%3 (= temp_3_0~813@ temp_3_1~866@))) (=> (= temp_3_0~813@ temp_3_1~866@) (=> (= temp_4_0~943@ (Mul (Mul (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Mul (Sub b4~36@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul c4~38@ b4~36@) a4~34@) d4~40@))) (=> (= temp_4_1~992@ (Mul (Mul (Mul (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Sub b4~36@ a4~34@)) (Mul c4~38@ b4~36@)) (Mul (Mul (Mul c4~38@ b4~36@) a4~34@) d4~40@))) (and (=> (= tmp%4@ (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@))) (=> (= tmp%5@ (Sub b4~36@ a4~34@)) (=> (= tmp%6@ (Mul c4~38@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~943@ temp_4_1~992@)))))) (=> (= temp_4_0~943@ temp_4_1~992@) (=> (= temp_5_0~1107@ (Mul (Mul (Add (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1172@ (Mul (Mul (Add (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul (Mul d5~48@ a5~42@) a5~42@) d5~48@)) (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ b5~44@))))) (and (=> (= tmp%7@ (Mul d5~48@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ a5~42@ d5~48@) (=> %%location_label%%5 (= temp_5_0~1107@ temp_5_1~1172@)))) (=> (= temp_5_0~1107@ temp_5_1~1172@) (=> (= temp_6_0~1271@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Add (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Add (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1336@ (Mul (Add (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Add (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@)) (Mul (Add (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ c6~54@)))))) (and (=> (= tmp%8@ (Add (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@))) (=> (= tmp%9@ (Add (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@))) (=> (= tmp%10@ (Mul (Add (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ c6~54@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~1271@ temp_6_1~1336@)))))) (=> (= temp_6_0~1271@ temp_6_1~1336@) (=> (= temp_7_0~1483@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Add (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@))) (Sub (Mul (Sub d7~64@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1548@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Add (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@))) (Sub (Mul (Sub d7~64@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1483@ temp_7_1~1548@))) (=> (= temp_7_0~1483@ temp_7_1~1548@) (=> (= temp_8_0~1649@ (Sub (Mul (Mul (Sub d8~72@ 55) (Add d8~72@ d8~72@)) (Mul b8~68@ (Mul c8~70@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@)) (Mul (Sub a8~66@ c8~70@) (Sub b8~68@ d8~72@))))) (=> (= temp_8_1~1730@ (Sub (Mul (Sub (Mul d8~72@ (Add d8~72@ d8~72@)) (Mul 55 (Add d8~72@ d8~72@))) (Mul b8~68@ (Mul c8~70@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@)) (Mul (Sub a8~66@ c8~70@) (Sub b8~68@ d8~72@))))) (and (=> (= tmp%11@ (Add d8~72@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d8~72@ 55 tmp%11@) (=> %%location_label%%8 (= temp_8_0~1649@ temp_8_1~1730@)))) (=> (= temp_8_0~1649@ temp_8_1~1730@) (=> (= temp_9_0~1829@ (Mul (Mul (Mul (Add a9~74@ c9~78@) (Mul b9~76@ a9~74@)) d9~80@) (Add (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ d9~80@))))) (=> (= temp_9_1~1882@ (Mul (Mul d9~80@ (Mul (Add a9~74@ c9~78@) (Mul b9~76@ a9~74@))) (Add (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ d9~80@))))) (and (=> (= tmp%12@ (Mul (Add a9~74@ c9~78@) (Mul b9~76@ a9~74@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ d9~80@) (=> %%location_label%%9 (= temp_9_0~1829@ temp_9_1~1882@)))) (=> (= temp_9_0~1829@ temp_9_1~1882@) (=> (= temp_10_0~1975@ (Mul (Mul (Sub (Sub d10~88@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul a10~82@ d10~88@) (Add a10~82@ a10~82@)) d10~88@))) (=> (= temp_10_1~2028@ (Mul (Mul (Sub (Sub d10~88@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul a10~82@ d10~88@) (Add a10~82@ a10~82@)) d10~88@))) (and (=> (= tmp%13@ (Mul c10~86@ a10~82@)) (=> (= tmp%14@ (Mul c10~86@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%10 (= temp_10_0~1975@ temp_10_1~2028@))))) (=> (= temp_10_0~1975@ temp_10_1~2028@) (=> (= temp_11_0~2125@ (Mul (Add (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Mul b11~92@ (Add b11~92@ b11~92@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2190@ (Mul (Add (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Add (Mul b11~92@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b11~92@ b11~92@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2125@ temp_11_1~2190@))) (=> (= temp_11_0~2125@ temp_11_1~2190@) (=> (= temp_12_0~2285@ (Sub (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ a12~98@) (Mul c12~102@ c12~102@))) (Mul (Mul (Sub a12~98@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~2350@ (Sub (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul a12~98@ (Mul a12~98@ (Mul c12~102@ c12~102@)))) (Mul (Mul (Sub a12~98@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ b12~100@))))) (and (=> (= tmp%15@ (Mul c12~102@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a12~98@ a12~98@ tmp%15@) (=> %%location_label%%12 (= temp_12_0~2285@ temp_12_1~2350@)))) (=> (= temp_12_0~2285@ temp_12_1~2350@) (=> (= temp_13_0~2445@ (Mul (Mul (Mul a13~106@ (Sub b13~108@ d13~112@)) (Sub (Mul d13~112@ d13~112@) (Mul a13~106@ c13~110@))) (Mul (Mul (Mul b13~108@ a13~106@) (Mul d13~112@ c13~110@)) (Add (Add a13~106@ d13~112@) (Mul a13~106@ d13~112@))))) (=> (= temp_13_1~2506@ (Mul (Mul (Mul a13~106@ (Sub b13~108@ d13~112@)) (Sub (Mul d13~112@ d13~112@) (Mul a13~106@ c13~110@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul b13~108@ a13~106@)) (Add (Add a13~106@ d13~112@) (Mul a13~106@ d13~112@))))) (=> (= tmp%16@ (Mul b13~108@ a13~106@)) (=> (= tmp%17@ (Mul d13~112@ c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%13 (= temp_13_0~2445@ temp_13_1~2506@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
