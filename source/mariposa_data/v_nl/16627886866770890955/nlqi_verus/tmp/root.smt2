...
(push)
 ...
 (declare-const temp_13_1~2296@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~455@ (Mul (Sub (Sub (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Sub d1~16@
              a1~10@
             ) (Sub a1~10@ a1~10@)
            )
         ...
         (=>
          (= temp_1_1~516@ (Mul (Sub (Sub (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Sub d1~16@
               a1~10@
              ) (Sub a1~10@ a1~10@)
             )
          ...
          (and
           ...
           (=>
            (= temp_1_0~455@ temp_1_1~516@)
            (=>
             (= temp_2_0~617@ (Add (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Sub b2~20@
                  31
                 ) (Add a2~18@ b2~20@)
                )
             ...
             (=>
              (= temp_2_1~694@ (Add (Mul (Mul c2~22@ (Mul d2~24@ (Mul d2~24@ a2~18@))) (Mul (Sub b2~20@
                   31
                  ) (Add a2~18@ b2~20@)
                 )
                ) (Mul (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@
              ...
              (and
               ...
               (=>
                (= temp_2_0~617@ temp_2_1~694@)
                (=>
                 (= temp_3_0~771@ (Mul (Mul c3~30@ (Mul (Sub b3~28@ d3~32@) (Mul c3~30@ d3~32@))) (Mul
                    (Mul (Mul b3~28@ d3~32@) (Sub d3~32@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@
                      c3~30@
                 )))))
                 (=>
                  (= temp_3_1~824@ (Mul (Mul c3~30@ (Mul (Sub b3~28@ d3~32@) (Mul d3~32@ c3~30@))) (Mul
                     (Mul (Mul b3~28@ d3~32@) (Sub d3~32@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@
                       c3~30@
                  )))))
                  (and
                   ...
                   (=>
                    (= temp_3_0~771@ temp_3_1~824@)
                    (=>
                     (= temp_4_0~897@ (Mul (Mul (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Mul (Sub b4~36@
                          a4~34@
                         ) (Mul c4~38@ b4~36@)
                        )
                     ...
                     (=>
                      (= temp_4_1~946@ (Mul (Mul (Mul (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Sub b4~36@
                           a4~34@
                          )
                         ) (Mul c4~38@ b4~36@)
                        ) (Mul (Mul (Mul c4~38@ b4~36@) a4~34@) d4~40@)
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~897@ temp_4_1~946@)
                       ))
                       (=>
                        (= temp_4_0~897@ temp_4_1~946@)
                        (=>
                         (= temp_5_0~1035@ (Mul (Mul (Add (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul d5~48@
                              a5~42@
                             ) (Mul a5~42@ d5~48@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1100@ (Mul (Mul (Add (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul (Mul
                                d5~48@ a5~42@
                               ) a5~42@
                              ) d5~48@
                             )
                          ...
                          (and
                           ...
                           (=>
                            (= temp_5_0~1035@ temp_5_1~1100@)
                            (=>
                             (= temp_6_0~1189@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Add (Mul d6~56@
                                  d6~56@
                                 ) (Mul d6~56@ c6~54@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1254@ (Mul (Add (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Add (Mul d6~56@
                                   d6~56@
                                  ) (Mul d6~56@ c6~54@)
                                 ) (Mul (Add (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@
                                    c6~54@
                              ...
                              (and
                               ...
                               (=>
                                (= temp_6_0~1189@ temp_6_1~1254@)
                                (=>
                                 (= temp_7_0~1343@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Add (Mul c7~62@
                                      b7~60@
                                     ) (Mul d7~64@ d7~64@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1408@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Add (Mul c7~62@
                                       b7~60@
                                      ) (Mul d7~64@ d7~64@)
                                     )
                                    ) (Sub (Mul (Sub d7~64@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1343@ temp_7_1~1408@)
                                   ))
                                   (=>
                                    (= temp_7_0~1343@ temp_7_1~1408@)
                                    (=>
                                     (= temp_8_0~1505@ (Sub (Mul (Mul (Sub d8~72@ 55) (Add d8~72@ d8~72@)) (Mul b8~68@ (Mul
                                          c8~70@ c8~70@
                                        ))
                                     ...
                                     (=>
                                      (= temp_8_1~1586@ (Sub (Mul (Sub (Mul d8~72@ (Add d8~72@ d8~72@)) (Mul 55 (Add d8~72@ d8~72@)))
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1505@ temp_8_1~1586@)
                                       ))
                                       (=>
                                        (= temp_8_0~1505@ temp_8_1~1586@)
                                        (=>
                                         (= temp_9_0~1663@ (Mul (Mul (Mul (Add a9~74@ c9~78@) (Mul b9~76@ a9~74@)) d9~80@) (
                                            Add (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul a9~74@
                                              d9~80@
                                         )))))
                                         (=>
                                          (= temp_9_1~1716@ (Mul (Mul d9~80@ (Mul (Add a9~74@ c9~78@) (Mul b9~76@ a9~74@))) (
                                             Add (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul a9~74@
                                               d9~80@
                                          )))))
                                          (and
                                           ...
                                           (=>
                                            (= temp_9_0~1663@ temp_9_1~1716@)
                                            (=>
                                             (= temp_10_0~1793@ (Mul (Mul (Sub (Sub d10~88@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (
                                                  Mul c10~86@ a10~82@
                                                 ) (Mul c10~86@ c10~86@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1846@ (Mul (Mul (Sub (Sub d10~88@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (
                                                   Mul c10~86@ c10~86@
                                                  ) (Mul c10~86@ a10~82@)
                                                 )
                                                ) (Mul (Mul (Mul a10~82@ d10~88@) (Add a10~82@ a10~82@)) d10~88@)
                                              ...
                                              (and
                                               ...
                                               (=>
                                                (= temp_10_0~1793@ temp_10_1~1846@)
                                                (=>
                                                 (= temp_11_0~1931@ (Mul (Add (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (
                                                      Mul c11~94@ a11~90@
                                                     ) (Mul a11~90@ d11~96@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~1996@ (Mul (Add (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (
                                                       Mul c11~94@ a11~90@
                                                      ) (Mul a11~90@ d11~96@)
                                                     )
                                                  ...
                                                  (and
                                                   ...
                                                   (=>
                                                    (= temp_11_0~1931@ temp_11_1~1996@)
                                                    (=>
                                                     (= temp_12_0~2085@ (Sub (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2150@ (Sub (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2085@ temp_12_1~2150@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2085@ temp_12_1~2150@)
                                                        (=>
                                                         (= temp_13_0~2235@ (Mul (Mul (Mul a13~106@ (Sub b13~108@ d13~112@)) (Sub (Mul d13~112@
                                                              d13~112@
                                                             ) (Mul a13~106@ c13~110@)
                                                            )
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2296@ (Mul (Mul (Mul a13~106@ (Sub b13~108@ d13~112@)) (Sub (Mul d13~112@
                                                               d13~112@
                                                              ) (Mul a13~106@ c13~110@)
                                                             )
