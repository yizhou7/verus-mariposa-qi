...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) c0~6@) (Add (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@))) (Mul (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Sub d0~8@ d0~8@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Mul (Add (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ c0~6@) c0~6@)) (Mul (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Sub d0~8@ d0~8@) (Mul a0~2@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~438@ (Mul (Add (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ c1~14@) a1~10@)) (Mul (Mul (Add b1~12@ b1~12@) (Sub b1~12@ a1~10@)) (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~499@ (Mul (Add (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ c1~14@) a1~10@)) (Mul (Mul (Add b1~12@ b1~12@) (Sub b1~12@ a1~10@)) (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~438@ temp_1_1~499@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~583@ (Mul (Mul (Mul (Sub c2~22@ 34) (Mul d2~24@ a2~18@)) (Sub (Sub a2~18@ c2~22@) (Mul a2~18@ a2~18@))) (Mul (Add b2~20@ (Mul a2~18@ b2~20@)) (Add (Mul b2~20@ a2~18@) b2~20@)))) (=> (= temp_2_1~652@ (Mul (Mul (Mul (Sub c2~22@ 34) (Mul a2~18@ d2~24@)) (Sub (Sub a2~18@ c2~22@) (Mul a2~18@ a2~18@))) (Mul (Add b2~20@ (Mul a2~18@ b2~20@)) (Add (Mul b2~20@ a2~18@) b2~20@)))) (=> (= tmp%3@ (= temp_2_0~583@ temp_2_1~652@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~732@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@)) (Add (Mul b3~28@ c3~30@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~797@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@)) (Add (Mul b3~28@ c3~30@) (Mul b3~28@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~732@ temp_3_1~797@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~873@ (Add (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Add c4~38@ b4~36@) c4~38@)) (Mul (Mul (Add d4~40@ c4~38@) (Add a4~34@ d4~40@)) (Mul (Mul d4~40@ c4~38@) (Add c4~38@ d4~40@))))) (=> (= temp_4_1~934@ (Add (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Add c4~38@ b4~36@) c4~38@)) (Mul (Mul (Mul (Add d4~40@ c4~38@) (Add a4~34@ d4~40@)) (Mul d4~40@ c4~38@)) (Add c4~38@ d4~40@)))) (=> (= tmp%5@ (= temp_4_0~873@ temp_4_1~934@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1026@ (Sub (Sub (Mul (Add c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Add (Sub c5~46@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Add (Add c5~46@ a5~42@) (Mul b5~44@ b5~44@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ 38))))) (=> (= temp_5_1~1131@ (Sub (Sub (Mul (Add c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Add (Sub c5~46@ d5~48@) (Mul c5~46@ a5~42@))) (Add (Mul (Add c5~46@ a5~42@) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ 38))) (Mul (Mul b5~44@ b5~44@) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ 38)))))) (=> (= tmp%6@ (= temp_5_0~1026@ temp_5_1~1131@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1235@ (Add (Mul (Mul (Mul a6~50@ 12) (Mul c6~54@ b6~52@)) (Sub (Add 23 b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@)) (Add (Mul a6~50@ d6~56@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1324@ (Add (Mul (Mul (Mul a6~50@ 12) (Mul c6~54@ b6~52@)) (Sub (Add 23 b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@)) (Add (Mul a6~50@ d6~56@) (Mul b6~52@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1235@ temp_6_1~1324@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1392@ (Sub (Sub (Add (Mul b7~60@ b7~60@) (Mul b7~60@ b7~60@)) (Add (Mul a7~58@ a7~58@) (Mul d7~64@ c7~62@))) (Mul c7~62@ (Sub (Add a7~58@ b7~60@) (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1445@ (Sub (Sub (Add (Mul b7~60@ b7~60@) (Mul b7~60@ b7~60@)) (Add (Mul a7~58@ a7~58@) (Mul c7~62@ d7~64@))) (Mul c7~62@ (Sub (Add a7~58@ b7~60@) (Mul a7~58@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1392@ temp_7_1~1445@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1533@ (Mul (Mul (Add (Mul c8~70@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Mul 67 c8~70@))) (Mul (Sub a8~66@ (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1606@ (Mul (Mul (Add (Mul c8~70@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul 67 c8~70@) (Mul d8~72@ d8~72@))) (Mul (Sub a8~66@ (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1533@ temp_8_1~1606@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1686@ (Sub (Mul (Mul (Mul a9~74@ b9~76@) (Add b9~76@ d9~80@)) (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@))) (Mul (Mul (Add c9~78@ c9~78@) (Mul b9~76@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1751@ (Sub (Mul (Mul (Mul a9~74@ b9~76@) (Add b9~76@ d9~80@)) (Mul c9~78@ (Mul b9~76@ (Mul a9~74@ b9~76@)))) (Mul (Mul (Add c9~78@ c9~78@) (Mul b9~76@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1686@ temp_9_1~1751@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1827@ (Sub (Mul (Mul d10~88@ (Mul d10~88@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@))) (Add (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))))) (=> (= temp_10_1~1888@ (Sub (Mul (Mul (Mul d10~88@ b10~84@) d10~88@) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@))) (Add (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))))) (=> (= tmp%11@ (= temp_10_0~1827@ temp_10_1~1888@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1976@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Sub d11~96@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ 72)) (Mul (Mul c11~94@ d11~96@) d11~96@)))) (=> (= temp_11_1~2049@ (Mul (Mul (Mul d11~96@ (Mul c11~94@ (Sub d11~96@ b11~92@))) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ 72)) (Mul (Mul c11~94@ d11~96@) d11~96@)))) (=> (= tmp%12@ (= temp_11_0~1976@ temp_11_1~2049@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2137@ (Mul (Mul (Add (Mul a12~98@ b12~100@) (Sub c12~102@ d12~104@)) (Mul (Mul a12~98@ 23) (Sub c12~102@ c12~102@))) (Add (Mul (Sub b12~100@ a12~98@) a12~98@) (Mul (Mul c12~102@ a12~98@) (Mul c12~102@ b12~100@))))) (=> (= temp_12_1~2254@ (Add (Mul (Mul (Add (Mul a12~98@ b12~100@) (Sub c12~102@ d12~104@)) (Mul (Mul a12~98@ 23) (Sub c12~102@ c12~102@))) (Mul (Sub b12~100@ a12~98@) a12~98@)) (Mul (Mul (Add (Mul a12~98@ b12~100@) (Sub c12~102@ d12~104@)) (Mul (Mul a12~98@ 23) (Sub c12~102@ c12~102@))) (Mul (Mul c12~102@ a12~98@) (Mul c12~102@ b12~100@))))) (=> (= tmp%13@ (= temp_12_0~2137@ temp_12_1~2254@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2326@ (Mul (Sub (Mul (Add a13~106@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Mul d13~112@ b13~108@) d13~112@)) (Mul (Mul a13~106@ (Mul d13~112@ b13~108@)) (Mul (Mul b13~108@ c13~110@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2383@ (Mul (Sub (Mul (Add a13~106@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Mul d13~112@ b13~108@) d13~112@)) (Mul (Mul (Mul a13~106@ d13~112@) b13~108@) (Mul (Mul b13~108@ c13~110@) (Mul c13~110@ d13~112@))))) (=> (= tmp%14@ (= temp_13_0~2326@ temp_13_1~2383@)) (=> %%location_label%%13 tmp%14@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
