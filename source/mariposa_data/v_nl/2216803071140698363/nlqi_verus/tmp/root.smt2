      ...
      (=>
       ...
       (and
        ...
        (=>
         tmp%1@
         (=>
          (= temp_1_0~458@ (Mul (Mul (Sub (Mul c1~14@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@
               c1~14@
              ) (Sub a1~10@ c1~14@)
             )
          ...
          (=>
           (= temp_1_1~523@ (Mul (Mul (Sub (Mul c1~14@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@
                c1~14@
               ) (Sub a1~10@ c1~14@)
              )
           ...
           (=>
            ...
            (and
             ...
             (=>
              tmp%2@
              (=>
               (= temp_2_0~603@ (Mul (Mul (Mul (Mul c2~22@ c2~22@) (Sub d2~24@ c2~22@)) (Mul (Sub c2~22@
                    b2~20@
                   ) (Sub a2~18@ c2~22@)
                  )
               ...
               (=>
                (= temp_2_1~668@ (Mul (Mul (Mul c2~22@ (Mul c2~22@ (Sub d2~24@ c2~22@))) (Mul (Sub c2~22@
                     b2~20@
                    ) (Sub a2~18@ c2~22@)
                   )
                  ) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ a2~18@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   tmp%3@
                   (=>
                    (= temp_3_0~744@ (Sub (Sub (Mul (Sub c3~30@ b3~28@) a3~26@) (Add (Mul b3~28@ d3~32@)
                        (Mul c3~30@ b3~28@)
                       )
                    ...
                    (=>
                     (= temp_3_1~805@ (Sub (Sub (Mul (Sub c3~30@ b3~28@) a3~26@) (Add (Mul b3~28@ d3~32@)
                         (Mul c3~30@ b3~28@)
                        )
                     ...
                     (=>
                      ...
                      (and
                       ...
                       (=>
                        tmp%4@
                        (=>
                         (= temp_4_0~893@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Sub a4~34@
                              53
                             ) (Mul b4~36@ d4~40@)
                            )
                         ...
                         (=>
                          (= temp_4_1~966@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Sub a4~34@
                               53
                              ) (Mul b4~36@ d4~40@)
                             )
                          ...
                          (=>
                           ...
                           (and
                            ...
                            (=>
                             tmp%5@
                             (=>
                              (= temp_5_0~1046@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Mul a5~42@
                                   d5~48@
                                  ) (Mul c5~46@ b5~44@)
                                 )
                              ...
                              (=>
                               (= temp_5_1~1111@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@
                                    d5~48@
                                   ) (Mul c5~46@ b5~44@)
                                  )
                                 ) (Add (Mul (Mul a5~42@ c5~46@) (Add c5~46@ c5~46@)) (Sub (Mul d5~48@ b5~44@) (Sub a5~42@
