...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Sub b0~4@ b0~4@) (Add a0~2@ d0~8@)) (Sub (Add c0~6@ b0~4@) (Mul a0~2@ a0~2@))) (Add (Add (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Sub a0~2@ d0~8@) (Add a0~2@ b0~4@))))) (=> (= temp_0_1~378@ (Mul (Mul (Mul (Sub b0~4@ b0~4@) (Add a0~2@ d0~8@)) (Sub (Add c0~6@ b0~4@) (Mul a0~2@ a0~2@))) (Add (Add (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@)) (Sub (Mul a0~2@ (Add a0~2@ b0~4@)) (Mul d0~8@ (Add a0~2@ b0~4@)))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~378@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~458@ (Mul (Mul (Sub (Mul c1~14@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Sub a1~10@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ a1~10@)) (Add (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~523@ (Mul (Mul (Sub (Mul c1~14@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Sub a1~10@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Add (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~458@ temp_1_1~523@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~603@ (Mul (Mul (Mul (Mul c2~22@ c2~22@) (Sub d2~24@ c2~22@)) (Mul (Sub c2~22@ b2~20@) (Sub a2~18@ c2~22@))) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ a2~18@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~668@ (Mul (Mul (Mul c2~22@ (Mul c2~22@ (Sub d2~24@ c2~22@))) (Mul (Sub c2~22@ b2~20@) (Sub a2~18@ c2~22@))) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ a2~18@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~603@ temp_2_1~668@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~744@ (Sub (Sub (Mul (Sub c3~30@ b3~28@) a3~26@) (Add (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~805@ (Sub (Sub (Mul (Sub c3~30@ b3~28@) a3~26@) (Add (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul (Mul d3~32@ a3~26@) d3~32@) b3~28@) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~744@ temp_3_1~805@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~893@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Sub a4~34@ 53) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@)) (Sub a4~34@ (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~966@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Sub a4~34@ 53) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ d4~40@)) (Sub a4~34@ (Mul c4~38@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~893@ temp_4_1~966@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1046@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@))) (Add (Mul (Mul a5~42@ c5~46@) (Add c5~46@ c5~46@)) (Sub (Mul d5~48@ b5~44@) (Sub a5~42@ d5~48@))))) (=> (= temp_5_1~1111@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@))) (Add (Mul (Mul a5~42@ c5~46@) (Add c5~46@ c5~46@)) (Sub (Mul d5~48@ b5~44@) (Sub a5~42@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1046@ temp_5_1~1111@)) (=> %%location_label%%5 tmp%6@))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
