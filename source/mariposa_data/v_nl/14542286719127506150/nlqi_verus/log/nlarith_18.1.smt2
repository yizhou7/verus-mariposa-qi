...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Add (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Mul (Sub c0~6@ b0~4@) (Add c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Add (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul c0~6@ c0~6@)) (Mul b0~4@ a0~2@)) (Mul (Mul (Sub c0~6@ b0~4@) (Add c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~450@ (Mul (Mul (Mul (Add a1~10@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ c1~14@))) (Mul (Sub (Mul b1~12@ d1~16@) (Sub b1~12@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~515@ (Mul (Mul (Mul (Add a1~10@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ c1~14@))) (Mul (Sub (Mul b1~12@ d1~16@) (Sub b1~12@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~450@ temp_1_1~515@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~591@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Sub (Add d2~24@ a2~18@) (Mul a2~18@ c2~22@))) (Mul (Add (Mul c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) b2~20@)))) (=> (= temp_2_1~652@ (Mul (Mul (Add (Mul c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) b2~20@)) (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Sub (Add d2~24@ a2~18@) (Mul a2~18@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~591@ temp_2_1~652@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~728@ (Mul (Add (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Sub b3~28@ c3~30@) (Add c3~30@ a3~26@))) (Add (Mul c3~30@ (Mul c3~30@ c3~30@)) (Add (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~789@ (Mul (Add (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Sub b3~28@ c3~30@) (Add c3~30@ a3~26@))) (Add (Mul c3~30@ (Mul c3~30@ c3~30@)) (Add (Mul b3~28@ a3~26@) (Mul a3~26@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~728@ temp_3_1~789@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~865@ (Mul (Sub (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) d4~40@) (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ d4~40@) 6)))) (=> (= temp_4_1~926@ (Mul (Sub (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) d4~40@) (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@)) (Mul c4~38@ (Mul d4~40@ 6))))) (=> (= tmp%5@ (= temp_4_0~865@ temp_4_1~926@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1018@ (Mul (Mul (Mul (Add d5~48@ d5~48@) (Mul d5~48@ c5~46@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ 78)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1095@ (Mul (Mul (Mul (Add d5~48@ d5~48@) (Mul c5~46@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ 78)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1018@ temp_5_1~1095@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1187@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@)) (Sub (Mul d6~56@ a6~50@) (Add d6~56@ 1))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@))))) (=> (= temp_6_1~1264@ (Mul (Mul (Mul d6~56@ a6~50@) (Mul (Mul b6~52@ b6~52@) (Sub (Mul d6~56@ a6~50@) (Add d6~56@ 1)))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~1187@ temp_6_1~1264@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1344@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Add c7~62@ c7~62@))) (Mul (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@))))) (=> (= temp_7_1~1409@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Add c7~62@ c7~62@))) (Mul (Mul (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@)) (Mul a7~58@ b7~60@)) (Mul c7~62@ c7~62@)))) (=> (= tmp%8@ (= temp_7_0~1344@ temp_7_1~1409@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1485@ (Mul (Mul (Sub (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ b8~68@) c8~70@)))) (=> (= temp_8_1~1546@ (Mul (Mul (Sub (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ b8~68@) c8~70@)))) (=> (= tmp%9@ (= temp_8_0~1485@ temp_8_1~1546@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1634@ (Mul (Mul (Mul (Sub c9~78@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul c9~78@ 38))) (Add (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ d9~80@)) (Mul a9~74@ (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~1707@ (Mul (Mul (Mul (Sub c9~78@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul c9~78@ 38))) (Add (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ a9~74@) a9~74@)))) (=> (= tmp%10@ (= temp_9_0~1634@ temp_9_1~1707@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1783@ (Mul (Sub (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ a10~82@)) (Sub (Mul d10~88@ a10~82@) (Mul b10~84@ d10~88@))) (Sub (Mul b10~84@ (Sub b10~84@ a10~82@)) (Mul (Mul a10~82@ b10~84@) (Sub b10~84@ c10~86@))))) (=> (= temp_10_1~1848@ (Mul (Sub (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ a10~82@)) (Sub (Mul d10~88@ a10~82@) (Mul b10~84@ d10~88@))) (Sub (Sub (Mul b10~84@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul a10~82@ b10~84@) (Sub b10~84@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1783@ temp_10_1~1848@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1920@ (Mul (Add (Mul a11~90@ (Mul c11~94@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ b11~92@))) (Mul (Mul a11~90@ (Mul a11~90@ a11~90@)) (Sub (Mul b11~92@ a11~90@) (Mul c11~94@ c11~94@))))) (=> (= temp_11_1~1977@ (Mul (Add (Mul a11~90@ (Mul c11~94@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ b11~92@))) (Mul (Mul a11~90@ (Mul a11~90@ a11~90@)) (Sub (Mul a11~90@ b11~92@) (Mul c11~94@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1920@ temp_11_1~1977@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2069@ (Mul (Sub (Add (Add 5 c12~102@) (Mul b12~100@ a12~98@)) (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ b12~100@))) (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Sub b12~100@ c12~102@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2178@ (Sub (Mul (Add (Add 5 c12~102@) (Mul b12~100@ a12~98@)) (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Sub b12~100@ c12~102@) (Mul d12~104@ d12~104@)))) (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ b12~100@)) (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Sub b12~100@ c12~102@) (Mul d12~104@ d12~104@)))))) (=> (= tmp%13@ (= temp_12_0~2069@ temp_12_1~2178@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2242@ (Mul (Mul c13~110@ (Sub (Mul d13~112@ c13~110@) (Mul c13~110@ b13~108@))) (Add (Add c13~110@ (Mul c13~110@ d13~112@)) (Mul (Add a13~106@ a13~106@) (Mul a13~106@ b13~108@))))) (=> (= temp_13_1~2295@ (Mul (Sub (Mul c13~110@ (Mul d13~112@ c13~110@)) (Mul c13~110@ (Mul c13~110@ b13~108@))) (Add (Add c13~110@ (Mul c13~110@ d13~112@)) (Mul (Add a13~106@ a13~106@) (Mul a13~106@ b13~108@))))) (=> (= tmp%14@ (= temp_13_0~2242@ temp_13_1~2295@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2371@ (Mul (Mul (Mul (Add c14~118@ d14~120@) (Sub a14~114@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ a14~114@))) (Mul (Mul (Mul d14~120@ a14~114@) d14~120@) (Mul (Mul d14~120@ c14~118@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2432@ (Mul (Mul (Mul (Add c14~118@ d14~120@) (Sub a14~114@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ a14~114@))) (Mul (Mul (Mul d14~120@ a14~114@) d14~120@) (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2371@ temp_14_1~2432@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2484@ (Mul a15~122@ (Mul (Mul (Sub b15~124@ d15~128@) (Mul b15~124@ a15~122@)) (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2521@ (Mul a15~122@ (Mul (Mul (Mul (Sub b15~124@ d15~128@) b15~124@) a15~122@) (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= tmp%16@ (= temp_15_0~2484@ temp_15_1~2521@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2601@ (Mul (Mul c16~134@ (Mul (Mul 10 b16~132@) (Mul c16~134@ b16~132@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ d16~136@) (Add d16~136@ c16~134@))))) (=> (= temp_16_1~2666@ (Mul (Mul c16~134@ (Mul 10 (Mul b16~132@ (Mul c16~134@ b16~132@)))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ d16~136@) (Add d16~136@ c16~134@))))) (=> (= tmp%17@ (= temp_16_0~2601@ temp_16_1~2666@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2746@ (Mul (Mul (Mul (Mul b17~140@ a17~138@) (Sub a17~138@ a17~138@)) (Mul (Mul b17~140@ b17~140@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ a17~138@) (Sub c17~142@ d17~144@))))) (=> (= temp_17_1~2811@ (Mul (Mul (Mul (Mul b17~140@ a17~138@) (Sub a17~138@ a17~138@)) (Mul b17~140@ (Mul b17~140@ (Mul b17~140@ d17~144@)))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ a17~138@) (Sub c17~142@ d17~144@))))) (=> (= tmp%18@ (= temp_17_0~2746@ temp_17_1~2811@)) (=> %%location_label%%17 tmp%18@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
