...
(set-info :comment ";; mariposa_data/v_nl//14542286719127506150/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_3_0~841@ Int)
(declare-const temp_3_1~902@ Int)
(declare-const temp_4_0~991@ Int)
...
(declare-const temp_11_0~2221@ Int)
(declare-const temp_11_1~2278@ Int)
(declare-const temp_12_0~2383@ Int)
(declare-const temp_12_1~2492@ Int)
(declare-const temp_13_0~2635@ Int)
(declare-const temp_13_1~2688@ Int)
(declare-const temp_14_0~2787@ Int)
(declare-const temp_14_1~2848@ Int)
(declare-const temp_15_0~2921@ Int)
(declare-const temp_15_1~2958@ Int)
(declare-const temp_16_0~3057@ Int)
(declare-const temp_16_1~3122@ Int)
(declare-const temp_17_0~3233@ Int)
(declare-const temp_17_1~3298@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Add (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Mul (Sub c0~6@ b0~4@) (Add c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Add (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul c0~6@ c0~6@)) (Mul b0~4@ a0~2@)) (Mul (Mul (Sub c0~6@ b0~4@) (Add c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))))) (and (=> (= tmp%1@ (Add (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@))) (=> (= tmp%2@ (Mul c0~6@ c0~6@)) (=> (= tmp%3@ (Mul b0~4@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~485@ (Mul (Mul (Mul (Add a1~10@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ c1~14@))) (Mul (Sub (Mul b1~12@ d1~16@) (Sub b1~12@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~550@ (Mul (Mul (Mul (Add a1~10@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ c1~14@))) (Mul (Sub (Mul b1~12@ d1~16@) (Sub b1~12@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ b1~12@) (=> %%location_label%%1 (= temp_1_0~485@ temp_1_1~550@))) (=> (= temp_1_0~485@ temp_1_1~550@) (=> (= temp_2_0~639@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Sub (Add d2~24@ a2~18@) (Mul a2~18@ c2~22@))) (Mul (Add (Mul c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) b2~20@)))) (=> (= temp_2_1~700@ (Mul (Mul (Add (Mul c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) b2~20@)) (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Sub (Add d2~24@ a2~18@) (Mul a2~18@ c2~22@))))) (and (=> (= tmp%4@ (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Sub (Add d2~24@ a2~18@) (Mul a2~18@ c2~22@)))) (=> (= tmp%5@ (Mul (Add (Mul c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~639@ temp_2_1~700@))))) (=> (= temp_2_0~639@ temp_2_1~700@) (=> (= temp_3_0~841@ (Mul (Add (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Sub b3~28@ c3~30@) (Add c3~30@ a3~26@))) (Add (Mul c3~30@ (Mul c3~30@ c3~30@)) (Add (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~902@ (Mul (Add (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Sub b3~28@ c3~30@) (Add c3~30@ a3~26@))) (Add (Mul c3~30@ (Mul c3~30@ c3~30@)) (Add (Mul b3~28@ a3~26@) (Mul a3~26@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ b3~28@) (=> %%location_label%%3 (= temp_3_0~841@ temp_3_1~902@))) (=> (= temp_3_0~841@ temp_3_1~902@) (=> (= temp_4_0~991@ (Mul (Sub (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) d4~40@) (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ d4~40@) 6)))) (=> (= temp_4_1~1052@ (Mul (Sub (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) d4~40@) (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@)) (Mul c4~38@ (Mul d4~40@ 6))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. c4~38@ d4~40@ 6) (=> %%location_label%%4 (= temp_4_0~991@ temp_4_1~1052@))) (=> (= temp_4_0~991@ temp_4_1~1052@) (=> (= temp_5_0~1171@ (Mul (Mul (Mul (Add d5~48@ d5~48@) (Mul d5~48@ c5~46@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ 78)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1248@ (Mul (Mul (Mul (Add d5~48@ d5~48@) (Mul c5~46@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ 78)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1171@ temp_5_1~1248@))) (=> (= temp_5_0~1171@ temp_5_1~1248@) (=> (= temp_6_0~1353@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@)) (Sub (Mul d6~56@ a6~50@) (Add d6~56@ 1))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@))))) (=> (= temp_6_1~1430@ (Mul (Mul (Mul d6~56@ a6~50@) (Mul (Mul b6~52@ b6~52@) (Sub (Mul d6~56@ a6~50@) (Add d6~56@ 1)))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@))))) (and (=> (= tmp%6@ (Mul d6~56@ a6~50@)) (=> (= tmp%7@ (Mul b6~52@ b6~52@)) (=> (= tmp%8@ (Sub (Mul d6~56@ a6~50@) (Add d6~56@ 1))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~1353@ temp_6_1~1430@)))))) (=> (= temp_6_0~1353@ temp_6_1~1430@) (=> (= temp_7_0~1557@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Add c7~62@ c7~62@))) (Mul (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@))))) (=> (= temp_7_1~1622@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Add c7~62@ c7~62@))) (Mul (Mul (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@)) (Mul a7~58@ b7~60@)) (Mul c7~62@ c7~62@)))) (and (=> (= tmp%9@ (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@))) (=> (= tmp%10@ (Mul a7~58@ b7~60@)) (=> (= tmp%11@ (Mul c7~62@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%7 (= temp_7_0~1557@ temp_7_1~1622@)))))) (=> (= temp_7_0~1557@ temp_7_1~1622@) (=> (= temp_8_0~1733@ (Mul (Mul (Sub (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ b8~68@) c8~70@)))) (=> (= temp_8_1~1794@ (Mul (Mul (Sub (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ b8~68@) c8~70@)))) (and (=> (= tmp%12@ (Mul d8~72@ b8~68@)) (=> (= tmp%13@ (Mul d8~72@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%8 (= temp_8_0~1733@ temp_8_1~1794@))))) (=> (= temp_8_0~1733@ temp_8_1~1794@) (=> (= temp_9_0~1903@ (Mul (Mul (Mul (Sub c9~78@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul c9~78@ 38))) (Add (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ d9~80@)) (Mul a9~74@ (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~1976@ (Mul (Mul (Mul (Sub c9~78@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul c9~78@ 38))) (Add (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ a9~74@) a9~74@)))) (and (=> (= tmp%14@ (Mul c9~78@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a9~74@ tmp%14@) (=> %%location_label%%9 (= temp_9_0~1903@ temp_9_1~1976@)))) (=> (= temp_9_0~1903@ temp_9_1~1976@) (=> (= temp_10_0~2069@ (Mul (Sub (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ a10~82@)) (Sub (Mul d10~88@ a10~82@) (Mul b10~84@ d10~88@))) (Sub (Mul b10~84@ (Sub b10~84@ a10~82@)) (Mul (Mul a10~82@ b10~84@) (Sub b10~84@ c10~86@))))) (=> (= temp_10_1~2134@ (Mul (Sub (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ a10~82@)) (Sub (Mul d10~88@ a10~82@) (Mul b10~84@ d10~88@))) (Sub (Sub (Mul b10~84@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul a10~82@ b10~84@) (Sub b10~84@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b10~84@ b10~84@ a10~82@) (=> %%location_label%%10 (= temp_10_0~2069@ temp_10_1~2134@))) (=> (= temp_10_0~2069@ temp_10_1~2134@) (=> (= temp_11_0~2221@ (Mul (Add (Mul a11~90@ (Mul c11~94@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ b11~92@))) (Mul (Mul a11~90@ (Mul a11~90@ a11~90@)) (Sub (Mul b11~92@ a11~90@) (Mul c11~94@ c11~94@))))) (=> (= temp_11_1~2278@ (Mul (Add (Mul a11~90@ (Mul c11~94@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ b11~92@))) (Mul (Mul a11~90@ (Mul a11~90@ a11~90@)) (Sub (Mul a11~90@ b11~92@) (Mul c11~94@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b11~92@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2221@ temp_11_1~2278@))) (=> (= temp_11_0~2221@ temp_11_1~2278@) (=> (= temp_12_0~2383@ (Mul (Sub (Add (Add 5 c12~102@) (Mul b12~100@ a12~98@)) (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ b12~100@))) (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Sub b12~100@ c12~102@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2492@ (Sub (Mul (Add (Add 5 c12~102@) (Mul b12~100@ a12~98@)) (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Sub b12~100@ c12~102@) (Mul d12~104@ d12~104@)))) (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ b12~100@)) (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Sub b12~100@ c12~102@) (Mul d12~104@ d12~104@)))))) (and (=> (= tmp%15@ (Add (Add 5 c12~102@) (Mul b12~100@ a12~98@))) (=> (= tmp%16@ (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ b12~100@))) (=> (= tmp%17@ (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Sub b12~100@ c12~102@) (Mul d12~104@ d12~104@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%12 (= temp_12_0~2383@ temp_12_1~2492@)))))) (=> (= temp_12_0~2383@ temp_12_1~2492@) (=> (= temp_13_0~2635@ (Mul (Mul c13~110@ (Sub (Mul d13~112@ c13~110@) (Mul c13~110@ b13~108@))) (Add (Add c13~110@ (Mul c13~110@ d13~112@)) (Mul (Add a13~106@ a13~106@) (Mul a13~106@ b13~108@))))) (=> (= temp_13_1~2688@ (Mul (Sub (Mul c13~110@ (Mul d13~112@ c13~110@)) (Mul c13~110@ (Mul c13~110@ b13~108@))) (Add (Add c13~110@ (Mul c13~110@ d13~112@)) (Mul (Add a13~106@ a13~106@) (Mul a13~106@ b13~108@))))) (and (=> (= tmp%18@ (Mul d13~112@ c13~110@)) (=> (= tmp%19@ (Mul c13~110@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c13~110@ tmp%18@ tmp%19@) (=> %%location_label%%13 (= temp_13_0~2635@ temp_13_1~2688@))))) (=> (= temp_13_0~2635@ temp_13_1~2688@) (=> (= temp_14_0~2787@ (Mul (Mul (Mul (Add c14~118@ d14~120@) (Sub a14~114@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ a14~114@))) (Mul (Mul (Mul d14~120@ a14~114@) d14~120@) (Mul (Mul d14~120@ c14~118@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2848@ (Mul (Mul (Mul (Add c14~118@ d14~120@) (Sub a14~114@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Add c14~118@ a14~114@))) (Mul (Mul (Mul d14~120@ a14~114@) d14~120@) (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ c14~118@))))) (and (=> (= tmp%20@ (Mul d14~120@ c14~118@)) (=> (= tmp%21@ (Mul b14~116@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%14 (= temp_14_0~2787@ temp_14_1~2848@))))) (=> (= temp_14_0~2787@ temp_14_1~2848@) (=> (= temp_15_0~2921@ (Mul a15~122@ (Mul (Mul (Sub b15~124@ d15~128@) (Mul b15~124@ a15~122@)) (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2958@ (Mul a15~122@ (Mul (Mul (Mul (Sub b15~124@ d15~128@) b15~124@) a15~122@) (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ d15~128@))))) (and (=> (= tmp%22@ (Sub b15~124@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ b15~124@ a15~122@) (=> %%location_label%%15 (= temp_15_0~2921@ temp_15_1~2958@)))) (=> (= temp_15_0~2921@ temp_15_1~2958@) (=> (= temp_16_0~3057@ (Mul (Mul c16~134@ (Mul (Mul 10 b16~132@) (Mul c16~134@ b16~132@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ d16~136@) (Add d16~136@ c16~134@))))) (=> (= temp_16_1~3122@ (Mul (Mul c16~134@ (Mul 10 (Mul b16~132@ (Mul c16~134@ b16~132@)))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ d16~136@) (Add d16~136@ c16~134@))))) (and (=> (= tmp%23@ (Mul c16~134@ b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. 10 b16~132@ tmp%23@) (=> %%location_label%%16 (= temp_16_0~3057@ temp_16_1~3122@)))) (=> (= temp_16_0~3057@ temp_16_1~3122@) (=> (= temp_17_0~3233@ (Mul (Mul (Mul (Mul b17~140@ a17~138@) (Sub a17~138@ a17~138@)) (Mul (Mul b17~140@ b17~140@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ a17~138@) (Sub c17~142@ d17~144@))))) (=> (= temp_17_1~3298@ (Mul (Mul (Mul (Mul b17~140@ a17~138@) (Sub a17~138@ a17~138@)) (Mul b17~140@ (Mul b17~140@ (Mul b17~140@ d17~144@)))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ a17~138@) (Sub c17~142@ d17~144@))))) (=> (= tmp%24@ (Mul b17~140@ d17~144@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b17~140@ b17~140@ tmp%24@) (=> %%location_label%%17 (= temp_17_0~3233@ temp_17_1~3298@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
