...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Add (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul b0~4@ (Add d0~8@ b0~4@)) (Add (Mul a0~2@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~358@ (Mul (Add (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul b0~4@ (Add d0~8@ b0~4@)) (Mul a0~2@ (Add c0~6@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~358@))) (=> (= temp_0_0~301@ temp_0_1~358@) (=> (= temp_1_0~447@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~512@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~512@))) (=> (= temp_1_0~447@ temp_1_1~512@) (=> (= temp_2_0~593@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ b2~20@)) (Add (Sub b2~20@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Sub (Mul d2~24@ b2~20@) a2~18@) (Sub c2~22@ (Add a2~18@ b2~20@))))) (=> (= temp_2_1~650@ (Mul (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Add (Sub b2~20@ d2~24@) (Mul b2~20@ b2~20@)) (Mul (Sub (Mul d2~24@ b2~20@) a2~18@) (Sub c2~22@ (Add a2~18@ b2~20@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~593@ temp_2_1~650@))) (=> (= temp_2_0~593@ temp_2_1~650@) (=> (= temp_3_0~739@ (Mul (Add (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul c3~30@ c3~30@) (Add c3~30@ c3~30@))))) (=> (= temp_3_1~804@ (Mul (Add (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Add c3~30@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~739@ temp_3_1~804@))) (=> (= temp_3_0~739@ temp_3_1~804@) (=> (= temp_4_0~893@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Sub a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Sub c4~38@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~958@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Sub a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Sub c4~38@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~893@ temp_4_1~958@))) (=> (= temp_4_0~893@ temp_4_1~958@) (=> (= temp_5_0~1043@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Sub d5~48@ a5~42@) (Sub c5~46@ c5~46@))) (Mul (Sub (Mul a5~42@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@ d5~48@) c5~46@)))) (=> (= temp_5_1~1104@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Sub d5~48@ a5~42@) (Sub c5~46@ c5~46@))) (Mul (Sub (Mul a5~42@ b5~44@) (Mul d5~48@ d5~48@)) (Mul c5~46@ (Mul a5~42@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1043@ temp_5_1~1104@))) (=> (= temp_5_0~1043@ temp_5_1~1104@) (=> (= temp_6_0~1189@ (Mul (Mul c6~54@ (Mul (Mul c6~54@ 19) (Sub c6~54@ a6~50@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@)) (Mul (Add b6~52@ a6~50@) d6~56@)))) (=> (= temp_6_1~1250@ (Mul (Mul c6~54@ (Mul (Mul c6~54@ 19) (Sub c6~54@ a6~50@))) (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@)) (Add b6~52@ a6~50@)) d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1189@ temp_6_1~1250@))) (=> (= temp_6_0~1189@ temp_6_1~1250@) (=> (= temp_7_0~1323@ (Mul (Sub (Sub d7~64@ (Mul b7~60@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@))) (Sub c7~62@ (Sub (Mul d7~64@ d7~64@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1372@ (Mul (Sub (Sub d7~64@ (Mul b7~60@ c7~62@)) (Mul (Mul (Mul d7~64@ b7~60@) c7~62@) b7~60@)) (Sub c7~62@ (Sub (Mul d7~64@ d7~64@) (Mul b7~60@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1323@ temp_7_1~1372@))) (=> (= temp_7_0~1323@ temp_7_1~1372@) (=> (= temp_8_0~1449@ (Mul (Mul (Mul (Sub c8~70@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ a8~66@))) (Mul (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ a8~66@)) a8~66@))) (=> (= temp_8_1~1506@ (Mul (Mul (Mul (Sub c8~70@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ a8~66@))) (Sub (Mul (Mul d8~72@ d8~72@) a8~66@) (Mul (Mul c8~70@ a8~66@) a8~66@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1449@ temp_8_1~1506@))) (=> (= temp_8_0~1449@ temp_8_1~1506@) (=> (= temp_9_0~1567@ (Mul d9~80@ (Mul (Sub (Mul d9~80@ c9~78@) (Mul a9~74@ d9~80@)) (Sub (Mul c9~78@ b9~76@) (Mul c9~78@ b9~76@))))) (=> (= temp_9_1~1604@ (Mul d9~80@ (Mul (Sub (Mul d9~80@ c9~78@) (Mul a9~74@ d9~80@)) (Sub (Mul b9~76@ c9~78@) (Mul c9~78@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1567@ temp_9_1~1604@))) (=> (= temp_9_0~1567@ temp_9_1~1604@) (=> (= temp_10_0~1669@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ b10~84@)) b10~84@) (Mul (Sub (Mul c10~86@ c10~86@) (Mul d10~88@ d10~88@)) d10~88@))) (=> (= temp_10_1~1710@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ b10~84@)) b10~84@) (Mul (Sub (Mul c10~86@ c10~86@) (Mul d10~88@ d10~88@)) d10~88@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1669@ temp_10_1~1710@))) (=> (= temp_10_0~1669@ temp_10_1~1710@) (=> (= temp_11_0~1799@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Sub c11~94@ c11~94@)) (Mul (Mul b11~92@ c11~94@) (Mul b11~92@ b11~92@))) (Mul 62 (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~1872@ (Mul (Mul (Sub (Mul (Mul d11~96@ c11~94@) c11~94@) (Mul (Mul d11~96@ c11~94@) c11~94@)) (Mul (Mul b11~92@ c11~94@) (Mul b11~92@ b11~92@))) (Mul 62 (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1799@ temp_11_1~1872@))) (=> (= temp_11_0~1799@ temp_11_1~1872@) (=> (= temp_12_0~1945@ (Mul (Mul c12~102@ (Mul (Mul b12~100@ a12~98@) (Sub d12~104@ b12~100@))) (Add (Add (Mul a12~98@ c12~102@) (Mul d12~104@ b12~100@)) (Add (Mul a12~98@ c12~102@) a12~98@)))) (=> (= temp_12_1~1994@ (Mul (Mul c12~102@ (Mul b12~100@ (Mul a12~98@ (Sub d12~104@ b12~100@)))) (Add (Add (Mul a12~98@ c12~102@) (Mul d12~104@ b12~100@)) (Add (Mul a12~98@ c12~102@) a12~98@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~1945@ temp_12_1~1994@))) (=> (= temp_12_0~1945@ temp_12_1~1994@) (=> (= temp_13_0~2079@ (Add (Mul (Add (Mul d13~112@ c13~110@) d13~112@) (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ c13~110@))) (Sub (Mul (Sub b13~108@ a13~106@) (Add a13~106@ c13~110@)) (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2140@ (Add (Mul (Add (Mul d13~112@ c13~110@) d13~112@) (Mul (Mul d13~112@ a13~106@) (Mul c13~110@ a13~106@))) (Sub (Mul (Sub b13~108@ a13~106@) (Add a13~106@ c13~110@)) (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2079@ temp_13_1~2140@))) (=> (= temp_13_0~2079@ temp_13_1~2140@) (=> (= temp_14_0~2225@ (Mul (Mul (Mul (Add d14~120@ d14~120@) (Mul a14~114@ a14~114@)) (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ a14~114@))) (Mul (Sub (Sub c14~118@ a14~114@) a14~114@) (Mul (Mul b14~116@ c14~118@) (Add b14~116@ b14~116@))))) (=> (= temp_14_1~2286@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Add d14~120@ d14~120@)) (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ a14~114@))) (Mul (Sub (Sub c14~118@ a14~114@) a14~114@) (Mul (Mul b14~116@ c14~118@) (Add b14~116@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2225@ temp_14_1~2286@))) (=> (= temp_14_0~2225@ temp_14_1~2286@) (=> (= temp_15_0~2375@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul d15~128@ a15~122@)) (Mul (Mul c15~126@ d15~128@) (Mul a15~122@ b15~124@))) (Mul (Add (Mul c15~126@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Add c15~126@ a15~122@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2440@ (Mul (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ a15~122@)) (Mul (Mul c15~126@ d15~128@) (Mul a15~122@ b15~124@))) (Mul (Add (Mul c15~126@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Add c15~126@ a15~122@) (Mul c15~126@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2375@ temp_15_1~2440@))) (=> (= temp_15_0~2375@ temp_15_1~2440@) (=> (= temp_16_0~2537@ (Mul (Mul (Add (Add d16~136@ a16~130@) c16~134@) (Mul (Sub c16~134@ c16~134@) (Mul c16~134@ b16~132@))) (Sub (Mul (Add 94 d16~136@) (Add d16~136@ d16~136@)) (Mul (Mul a16~130@ d16~136@) (Add a16~130@ a16~130@))))) (=> (= temp_16_1~2610@ (Mul (Mul (Add (Add d16~136@ a16~130@) c16~134@) (Mul (Sub c16~134@ c16~134@) (Mul b16~132@ c16~134@))) (Sub (Mul (Add 94 d16~136@) (Add d16~136@ d16~136@)) (Mul (Mul a16~130@ d16~136@) (Add a16~130@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2537@ temp_16_1~2610@))) (=> (= temp_16_0~2537@ temp_16_1~2610@) (=> (= temp_17_0~2707@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ 3)) (Mul b17~140@ (Mul c17~142@ b17~140@))) (Mul (Mul (Mul d17~144@ d17~144@) (Mul d17~144@ d17~144@)) (Mul (Mul c17~142@ a17~138@) (Mul b17~140@ d17~144@))))) (=> (= temp_17_1~2780@ (Mul (Mul (Mul (Mul b17~140@ 3) (Mul c17~142@ d17~144@)) (Mul b17~140@ (Mul c17~142@ b17~140@))) (Mul (Mul (Mul d17~144@ d17~144@) (Mul d17~144@ d17~144@)) (Mul (Mul c17~142@ a17~138@) (Mul b17~140@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2707@ temp_17_1~2780@))) (=> (= temp_17_0~2707@ temp_17_1~2780@) (=> (= temp_18_0~2869@ (Mul (Mul (Mul (Add c18~150@ c18~150@) (Add a18~146@ c18~150@)) (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ a18~146@))) (Add (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ b18~148@)) (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ a18~146@))))) (=> (= temp_18_1~2934@ (Mul (Mul (Mul (Add c18~150@ c18~150@) (Add a18~146@ c18~150@)) (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ a18~146@))) (Add (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ b18~148@)) (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2869@ temp_18_1~2934@))) (=> (= temp_18_0~2869@ temp_18_1~2934@) (=> (= temp_19_0~3019@ (Mul (Mul (Sub (Mul d19~160@ a19~154@) (Mul d19~160@ c19~158@)) (Mul (Add b19~156@ c19~158@) (Mul b19~156@ c19~158@))) (Mul (Sub b19~156@ (Mul c19~158@ a19~154@)) (Mul (Mul c19~158@ a19~154@) (Add c19~158@ b19~156@))))) (=> (= temp_19_1~3080@ (Mul (Mul (Mul (Sub (Mul d19~160@ a19~154@) (Mul d19~160@ c19~158@)) (Add b19~156@ c19~158@)) (Mul b19~156@ c19~158@)) (Mul (Sub b19~156@ (Mul c19~158@ a19~154@)) (Mul (Mul c19~158@ a19~154@) (Add c19~158@ b19~156@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3019@ temp_19_1~3080@))) (=> (= temp_19_0~3019@ temp_19_1~3080@) (=> (= temp_20_0~3181@ (Sub (Mul (Sub (Mul c20~166@ c20~166@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ 59) (Mul d20~168@ b20~164@))) (Mul (Mul (Mul a20~162@ a20~162@) (Mul d20~168@ a20~162@)) (Mul (Mul b20~164@ b20~164@) (Sub b20~164@ a20~162@))))) (=> (= temp_20_1~3258@ (Sub (Mul (Sub (Mul c20~166@ c20~166@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ 59) (Mul b20~164@ d20~168@))) (Mul (Mul (Mul a20~162@ a20~162@) (Mul d20~168@ a20~162@)) (Mul (Mul b20~164@ b20~164@) (Sub b20~164@ a20~162@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3181@ temp_20_1~3258@))) (=> (= temp_20_0~3181@ temp_20_1~3258@) (=> (= temp_21_0~3347@ (Mul (Mul (Mul (Mul a21~170@ b21~172@) (Mul b21~172@ a21~170@)) (Mul (Mul b21~172@ a21~170@) (Add d21~176@ c21~174@))) (Add (Mul (Mul a21~170@ b21~172@) (Mul c21~174@ b21~172@)) (Mul (Sub d21~176@ b21~172@) (Mul c21~174@ a21~170@))))) (=> (= temp_21_1~3412@ (Mul (Mul (Mul a21~170@ b21~172@) (Mul b21~172@ a21~170@)) (Mul (Mul (Mul b21~172@ a21~170@) (Add d21~176@ c21~174@)) (Add (Mul (Mul a21~170@ b21~172@) (Mul c21~174@ b21~172@)) (Mul (Sub d21~176@ b21~172@) (Mul c21~174@ a21~170@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3347@ temp_21_1~3412@))) (=> (= temp_21_0~3347@ temp_21_1~3412@) (=> (= temp_22_0~3501@ (Add (Mul b22~180@ (Mul (Mul b22~180@ b22~180@) (Mul b22~180@ c22~182@))) (Mul (Mul (Mul d22~184@ a22~178@) (Mul a22~178@ 77)) (Mul (Mul b22~180@ a22~178@) (Mul b22~180@ a22~178@))))) (=> (= temp_22_1~3566@ (Add (Mul b22~180@ (Mul (Mul b22~180@ b22~180@) (Mul b22~180@ c22~182@))) (Mul (Mul (Mul d22~184@ a22~178@) (Mul 77 a22~178@)) (Mul (Mul b22~180@ a22~178@) (Mul b22~180@ a22~178@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3501@ temp_22_1~3566@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
