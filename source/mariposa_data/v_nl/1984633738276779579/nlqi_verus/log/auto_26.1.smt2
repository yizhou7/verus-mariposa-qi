...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Add (Mul d0~8@ (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@))) (Mul (Add (Mul c0~6@ b0~4@) (Mul d0~8@ c0~6@)) (Mul (Add b0~4@ b0~4@) d0~8@)))) (=> (= temp_0_1~354@ (Mul (Add (Mul d0~8@ (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@))) (Mul (Mul (Add b0~4@ b0~4@) d0~8@) (Add (Mul c0~6@ b0~4@) (Mul d0~8@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~354@))) (=> (= temp_0_0~297@ temp_0_1~354@) (=> (= temp_1_0~431@ (Mul (Mul (Sub (Mul a1~10@ a1~10@) (Add d1~16@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ b1~12@))) (Add (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) b1~12@))) (=> (= temp_1_1~500@ (Mul (Sub (Mul (Mul a1~10@ a1~10@) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ b1~12@))) (Mul (Add d1~16@ a1~10@) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ b1~12@)))) (Add (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) b1~12@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~431@ temp_1_1~500@))) (=> (= temp_1_0~431@ temp_1_1~500@) (=> (= temp_2_0~585@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Add b2~20@ a2~18@) (Add d2~24@ b2~20@))) (Mul (Mul (Mul a2~18@ d2~24@) c2~22@) (Add (Mul a2~18@ c2~22@) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~646@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Add b2~20@ a2~18@) (Add d2~24@ b2~20@))) (Mul (Mul c2~22@ (Mul a2~18@ d2~24@)) (Add (Mul a2~18@ c2~22@) (Mul c2~22@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~585@ temp_2_1~646@))) (=> (= temp_2_0~585@ temp_2_1~646@) (=> (= temp_3_0~743@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) a3~26@) (Mul (Add a3~26@ c3~30@) (Mul d3~32@ d3~32@))) (Add (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ c3~30@)) (Sub (Sub c3~30@ d3~32@) (Mul 92 d3~32@))))) (=> (= temp_3_1~816@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) a3~26@) (Mul (Add a3~26@ c3~30@) (Mul d3~32@ d3~32@))) (Add (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@)) (Sub (Sub c3~30@ d3~32@) (Mul 92 d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~743@ temp_3_1~816@))) (=> (= temp_3_0~743@ temp_3_1~816@) (=> (= temp_4_0~913@ (Add (Add (Sub (Add d4~40@ a4~34@) (Mul a4~34@ d4~40@)) (Mul a4~34@ (Sub c4~38@ c4~38@))) (Mul (Mul (Mul 3 d4~40@) (Mul c4~38@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~986@ (Add (Add (Sub (Add d4~40@ a4~34@) (Mul a4~34@ d4~40@)) (Mul a4~34@ (Sub c4~38@ c4~38@))) (Mul (Mul (Mul c4~38@ a4~34@) (Mul 3 d4~40@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~913@ temp_4_1~986@))) (=> (= temp_4_0~913@ temp_4_1~986@) (=> (= temp_5_0~1075@ (Mul (Mul (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ a5~42@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1140@ (Mul (Mul (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ a5~42@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ a5~42@)) (Mul c5~46@ d5~48@)) (Mul c5~46@ b5~44@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1075@ temp_5_1~1140@))) (=> (= temp_5_0~1075@ temp_5_1~1140@) (=> (= temp_6_0~1253@ (Mul (Mul (Sub (Sub b6~52@ b6~52@) (Mul d6~56@ b6~52@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@))) (Sub (Mul (Mul c6~54@ 87) (Sub c6~54@ b6~52@)) (Sub (Add 91 c6~54@) (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1358@ (Mul (Sub (Mul (Sub b6~52@ b6~52@) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Mul d6~56@ b6~52@) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@)))) (Sub (Mul (Mul c6~54@ 87) (Sub c6~54@ b6~52@)) (Sub (Add 91 c6~54@) (Mul c6~54@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1253@ temp_6_1~1358@))) (=> (= temp_6_0~1253@ temp_6_1~1358@) (=> (= temp_7_0~1443@ (Mul (Sub (Sub (Mul c7~62@ a7~58@) d7~64@) (Mul (Mul a7~58@ a7~58@) (Sub a7~58@ d7~64@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ d7~64@)) (Add (Mul d7~64@ c7~62@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1504@ (Mul (Sub (Sub (Mul c7~62@ a7~58@) d7~64@) (Mul (Sub a7~58@ d7~64@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ d7~64@)) (Add (Mul d7~64@ c7~62@) (Mul c7~62@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1443@ temp_7_1~1504@))) (=> (= temp_7_0~1443@ temp_7_1~1504@) (=> (= temp_8_0~1585@ (Sub (Sub (Mul (Mul c8~70@ d8~72@) (Add d8~72@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@))) (Sub (Mul (Mul a8~66@ d8~72@) (Sub d8~72@ d8~72@)) (Mul c8~70@ b8~68@)))) (=> (= temp_8_1~1642@ (Sub (Sub (Mul (Mul c8~70@ d8~72@) (Add d8~72@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@))) (Sub (Mul (Sub d8~72@ d8~72@) (Mul a8~66@ d8~72@)) (Mul c8~70@ b8~68@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1585@ temp_8_1~1642@))) (=> (= temp_8_0~1585@ temp_8_1~1642@) (=> (= temp_9_0~1715@ (Mul a9~74@ (Mul (Mul (Mul b9~76@ 33) (Mul d9~80@ a9~74@)) (Mul (Mul a9~74@ a9~74@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~1764@ (Mul a9~74@ (Mul (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ 33)) (Mul (Mul a9~74@ a9~74@) (Mul d9~80@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1715@ temp_9_1~1764@))) (=> (= temp_9_0~1715@ temp_9_1~1764@) (=> (= temp_10_0~1853@ (Sub (Mul (Mul (Sub b10~84@ b10~84@) (Mul a10~82@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~1926@ (Sub (Mul (Sub (Mul b10~84@ (Mul a10~82@ c10~86@)) (Mul b10~84@ (Mul a10~82@ c10~86@))) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1853@ temp_10_1~1926@))) (=> (= temp_10_0~1853@ temp_10_1~1926@) (=> (= temp_11_0~2015@ (Mul (Mul (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ c11~94@)) (Sub (Mul d11~96@ a11~90@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ a11~90@)) (Add (Mul c11~94@ a11~90@) (Add d11~96@ a11~90@))))) (=> (= temp_11_1~2080@ (Mul (Mul (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ c11~94@)) (Sub (Mul d11~96@ a11~90@) (Mul d11~96@ d11~96@))) (Mul (Mul b11~92@ d11~96@) (Mul (Mul a11~90@ a11~90@) (Add (Mul c11~94@ a11~90@) (Add d11~96@ a11~90@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2015@ temp_11_1~2080@))) (=> (= temp_11_0~2015@ temp_11_1~2080@) (=> (= temp_12_0~2165@ (Mul (Mul (Mul a12~98@ (Mul b12~100@ c12~102@)) (Add (Mul c12~102@ c12~102@) (Mul a12~98@ d12~104@))) (Mul (Mul (Mul c12~102@ d12~104@) (Add b12~100@ d12~104@)) (Mul (Mul d12~104@ a12~98@) (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2226@ (Mul (Mul (Mul a12~98@ (Mul b12~100@ c12~102@)) (Add (Mul c12~102@ c12~102@) (Mul d12~104@ a12~98@))) (Mul (Mul (Mul c12~102@ d12~104@) (Add b12~100@ d12~104@)) (Mul (Mul d12~104@ a12~98@) (Mul a12~98@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2165@ temp_12_1~2226@))) (=> (= temp_12_0~2165@ temp_12_1~2226@) (=> (= temp_13_0~2323@ (Mul (Mul (Sub (Add c13~110@ 99) (Mul c13~110@ a13~106@)) (Add (Mul d13~112@ c13~110@) a13~106@)) (Sub (Mul (Mul a13~106@ b13~108@) (Mul d13~112@ a13~106@)) (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2408@ (Mul (Sub (Mul (Add c13~110@ 99) (Add (Mul d13~112@ c13~110@) a13~106@)) (Mul (Mul c13~110@ a13~106@) (Add (Mul d13~112@ c13~110@) a13~106@))) (Sub (Mul (Mul a13~106@ b13~108@) (Mul d13~112@ a13~106@)) (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2323@ temp_13_1~2408@))) (=> (= temp_13_0~2323@ temp_13_1~2408@) (=> (= temp_14_0~2497@ (Mul (Mul (Sub (Mul d14~120@ a14~114@) (Mul b14~116@ d14~120@)) a14~114@) (Mul (Mul (Add a14~114@ b14~116@) (Mul a14~114@ c14~118@)) (Mul (Mul d14~120@ 47) (Sub c14~118@ b14~116@))))) (=> (= temp_14_1~2570@ (Mul (Mul (Sub (Mul d14~120@ a14~114@) (Mul b14~116@ d14~120@)) a14~114@) (Mul (Add (Mul a14~114@ (Mul a14~114@ c14~118@)) (Mul b14~116@ (Mul a14~114@ c14~118@))) (Mul (Mul d14~120@ 47) (Sub c14~118@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2497@ temp_14_1~2570@))) (=> (= temp_14_0~2497@ temp_14_1~2570@) (=> (= temp_15_0~2655@ (Sub (Mul (Mul (Mul c15~126@ b15~124@) a15~122@) (Mul (Mul b15~124@ b15~124@) (Mul a15~122@ b15~124@))) (Mul (Mul (Mul d15~128@ a15~122@) (Sub c15~126@ b15~124@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ b15~124@))))) (=> (= temp_15_1~2716@ (Sub (Mul (Mul (Mul c15~126@ b15~124@) a15~122@) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ a15~122@))) (Mul (Mul (Mul d15~128@ a15~122@) (Sub c15~126@ b15~124@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2655@ temp_15_1~2716@))) (=> (= temp_15_0~2655@ temp_15_1~2716@) (=> (= temp_16_0~2801@ (Mul (Mul (Add a16~130@ (Mul c16~134@ a16~130@)) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ d16~136@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ b16~132@)) (Mul (Add a16~130@ c16~134@) (Mul b16~132@ c16~134@))))) (=> (= temp_16_1~2862@ (Mul (Mul (Add a16~130@ (Mul c16~134@ a16~130@)) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ d16~136@))) (Mul (Mul (Mul b16~132@ c16~134@) (Mul d16~136@ b16~132@)) (Mul (Add a16~130@ c16~134@) (Mul b16~132@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2801@ temp_16_1~2862@))) (=> (= temp_16_0~2801@ temp_16_1~2862@) (=> (= temp_17_0~2947@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) d17~144@) (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul a17~138@ b17~140@) (Mul d17~144@ a17~138@)) (Mul (Mul a17~138@ c17~142@) (Sub c17~142@ c17~142@))))) (=> (= temp_17_1~3008@ (Mul (Mul (Mul (Mul a17~138@ b17~140@) (Mul d17~144@ a17~138@)) (Mul (Mul a17~138@ c17~142@) (Sub c17~142@ c17~142@))) (Mul (Mul (Mul d17~144@ b17~140@) d17~144@) (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2947@ temp_17_1~3008@))) (=> (= temp_17_0~2947@ temp_17_1~3008@) (=> (= temp_18_0~3097@ (Mul (Mul (Mul (Mul c18~150@ a18~146@) (Add a18~146@ c18~150@)) c18~150@) (Mul (Mul (Add c18~150@ c18~150@) (Mul c18~150@ b18~148@)) (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ 68))))) (=> (= temp_18_1~3162@ (Mul (Mul (Mul c18~150@ a18~146@) (Mul (Add a18~146@ c18~150@) c18~150@)) (Mul (Mul (Add c18~150@ c18~150@) (Mul c18~150@ b18~148@)) (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ 68))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3097@ temp_18_1~3162@))) (=> (= temp_18_0~3097@ temp_18_1~3162@) (=> (= temp_19_0~3243@ (Sub (Mul (Mul (Mul b19~156@ c19~158@) c19~158@) (Mul b19~156@ (Mul b19~156@ c19~158@))) (Add (Mul (Add d19~160@ b19~156@) (Add c19~158@ b19~156@)) (Mul (Mul b19~156@ b19~156@) (Sub d19~160@ d19~160@))))) (=> (= temp_19_1~3308@ (Sub (Mul (Mul (Mul b19~156@ c19~158@) c19~158@) (Mul b19~156@ (Mul b19~156@ c19~158@))) (Add (Mul (Add d19~160@ b19~156@) (Add c19~158@ b19~156@)) (Sub (Mul (Mul b19~156@ b19~156@) d19~160@) (Mul (Mul b19~156@ b19~156@) d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3243@ temp_19_1~3308@))) (=> (= temp_19_0~3243@ temp_19_1~3308@) (=> (= temp_20_0~3397@ (Add (Mul (Mul (Add d20~168@ d20~168@) (Mul a20~162@ b20~164@)) (Mul (Sub c20~166@ d20~168@) (Mul b20~164@ d20~168@))) (Mul (Add (Sub a20~162@ b20~164@) (Mul c20~166@ c20~166@)) (Mul (Mul c20~166@ c20~166@) (Mul a20~162@ b20~164@))))) (=> (= temp_20_1~3462@ (Add (Mul (Mul (Add d20~168@ d20~168@) (Mul a20~162@ b20~164@)) (Mul (Sub c20~166@ d20~168@) (Mul b20~164@ d20~168@))) (Mul (Mul (Mul c20~166@ c20~166@) (Mul a20~162@ b20~164@)) (Add (Sub a20~162@ b20~164@) (Mul c20~166@ c20~166@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3397@ temp_20_1~3462@))) (=> (= temp_20_0~3397@ temp_20_1~3462@) (=> (= temp_21_0~3551@ (Sub (Mul (Mul (Mul c21~174@ c21~174@) (Mul c21~174@ 45)) (Mul (Mul d21~176@ a21~170@) (Mul b21~172@ b21~172@))) (Mul (Mul (Mul b21~172@ b21~172@) (Add c21~174@ d21~176@)) d21~176@))) (=> (= temp_21_1~3616@ (Sub (Mul (Mul (Mul c21~174@ 45) (Mul c21~174@ c21~174@)) (Mul (Mul d21~176@ a21~170@) (Mul b21~172@ b21~172@))) (Mul (Mul (Mul b21~172@ b21~172@) (Add c21~174@ d21~176@)) d21~176@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3551@ temp_21_1~3616@))) (=> (= temp_21_0~3551@ temp_21_1~3616@) (=> (= temp_22_0~3705@ (Sub (Mul (Mul (Add d22~184@ c22~182@) (Mul d22~184@ c22~182@)) (Mul (Mul b22~180@ a22~178@) (Mul a22~178@ c22~182@))) (Mul (Mul (Add d22~184@ b22~180@) (Mul b22~180@ d22~184@)) (Mul (Mul b22~180@ a22~178@) (Mul c22~182@ a22~178@))))) (=> (= temp_22_1~3770@ (Sub (Mul (Mul (Mul (Add d22~184@ c22~182@) (Mul d22~184@ c22~182@)) (Mul b22~180@ a22~178@)) (Mul a22~178@ c22~182@)) (Mul (Mul (Add d22~184@ b22~180@) (Mul b22~180@ d22~184@)) (Mul (Mul b22~180@ a22~178@) (Mul c22~182@ a22~178@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3705@ temp_22_1~3770@))) (=> (= temp_22_0~3705@ temp_22_1~3770@) (=> (= temp_23_0~3835@ (Mul (Mul d23~192@ (Mul (Mul c23~190@ c23~190@) (Mul a23~186@ d23~192@))) (Mul d23~192@ (Mul (Mul d23~192@ c23~190@) (Mul b23~188@ c23~190@))))) (=> (= temp_23_1~3876@ (Mul (Mul d23~192@ (Mul (Mul c23~190@ c23~190@) (Mul a23~186@ d23~192@))) (Mul (Mul (Mul d23~192@ c23~190@) (Mul b23~188@ c23~190@)) d23~192@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3835@ temp_23_1~3876@))) (=> (= temp_23_0~3835@ temp_23_1~3876@) (=> (= temp_24_0~3965@ (Mul (Sub (Mul (Mul b24~196@ d24~200@) (Mul d24~200@ b24~196@)) (Mul (Mul d24~200@ d24~200@) (Mul d24~200@ b24~196@))) (Mul (Mul (Mul a24~194@ d24~200@) (Sub d24~200@ a24~194@)) (Mul (Sub c24~198@ d24~200@) (Add b24~196@ d24~200@))))) (=> (= temp_24_1~4030@ (Mul (Sub (Mul (Mul b24~196@ d24~200@) (Mul d24~200@ b24~196@)) (Mul (Mul d24~200@ b24~196@) (Mul d24~200@ d24~200@))) (Mul (Mul (Mul a24~194@ d24~200@) (Sub d24~200@ a24~194@)) (Mul (Sub c24~198@ d24~200@) (Add b24~196@ d24~200@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3965@ temp_24_1~4030@))) (=> (= temp_24_0~3965@ temp_24_1~4030@) (=> (= temp_25_0~4131@ (Mul (Sub (Mul (Mul d25~208@ d25~208@) (Mul a25~202@ c25~206@)) (Mul (Mul d25~208@ d25~208@) (Mul b25~204@ b25~204@))) (Mul (Mul (Sub a25~202@ d25~208@) (Mul d25~208@ a25~202@)) (Mul (Sub 3 c25~206@) (Add d25~208@ a25~202@))))) (=> (= temp_25_1~4208@ (Mul (Sub (Mul (Mul d25~208@ d25~208@) (Mul a25~202@ c25~206@)) (Mul (Mul b25~204@ b25~204@) (Mul d25~208@ d25~208@))) (Mul (Mul (Sub a25~202@ d25~208@) (Mul d25~208@ a25~202@)) (Mul (Sub 3 c25~206@) (Add d25~208@ a25~202@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~4131@ temp_25_1~4208@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
