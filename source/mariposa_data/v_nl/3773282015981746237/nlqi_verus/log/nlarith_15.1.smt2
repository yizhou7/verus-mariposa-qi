...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Add (Mul (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Sub c0~6@ d0~8@) (Mul b0~4@ a0~2@))) (Mul (Mul (Add d0~8@ b0~4@) (Mul a0~2@ a0~2@)) (Sub (Mul b0~4@ c0~6@) (Mul 35 b0~4@))))) (=> (= temp_0_1~402@ (Add (Mul (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ a0~2@)) (Sub (Mul c0~6@ (Mul b0~4@ a0~2@)) (Mul d0~8@ (Mul b0~4@ a0~2@)))) (Mul (Mul (Add d0~8@ b0~4@) (Mul a0~2@ a0~2@)) (Sub (Mul b0~4@ c0~6@) (Mul 35 b0~4@))))) (=> (= tmp%1@ (= temp_0_0~317@ temp_0_1~402@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~470@ (Mul (Mul a1~10@ (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Add d1~16@ d1~16@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~523@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Add d1~16@ d1~16@) (Mul d1~16@ b1~12@))) (Mul a1~10@ (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~470@ temp_1_1~523@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~599@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ a2~18@))) (Mul (Add (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ b2~20@) b2~20@)))) (=> (= temp_2_1~660@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ a2~18@))) (Mul (Add (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ b2~20@) b2~20@)))) (=> (= tmp%3@ (= temp_2_0~599@ temp_2_1~660@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~744@ (Mul (Sub (Mul (Add 23 d3~32@) b3~28@) (Sub (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul c3~30@ b3~28@) (Add b3~28@ c3~30@)) (Mul (Mul c3~30@ c3~30@) c3~30@)))) (=> (= temp_3_1~813@ (Mul (Sub (Mul (Add 23 d3~32@) b3~28@) (Sub (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul c3~30@ (Mul b3~28@ (Add b3~28@ c3~30@))) (Mul (Mul c3~30@ c3~30@) c3~30@)))) (=> (= tmp%4@ (= temp_3_0~744@ temp_3_1~813@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~905@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ 5) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)) (Sub (Mul d4~40@ c4~38@) (Mul d4~40@ d4~40@))))) (=> (= temp_4_1~982@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Mul c4~38@ (Mul 5 (Mul a4~34@ d4~40@)))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)) (Sub (Mul d4~40@ c4~38@) (Mul d4~40@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~905@ temp_4_1~982@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1062@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Sub a5~42@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~1127@ (Mul (Mul (Mul b5~44@ c5~46@) (Mul (Sub a5~42@ d5~48@) (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@)))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1062@ temp_5_1~1127@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1179@ (Add (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ b6~52@)) (Mul (Sub b6~52@ a6~50@) (Mul a6~50@ b6~52@))) b6~52@)) (=> (= temp_6_1~1216@ (Add (Mul (Mul d6~56@ (Mul d6~56@ (Mul a6~50@ b6~52@))) (Mul (Sub b6~52@ a6~50@) (Mul a6~50@ b6~52@))) b6~52@)) (=> (= tmp%7@ (= temp_6_0~1179@ temp_6_1~1216@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1284@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)) d7~64@) (Sub (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1337@ (Mul (Mul (Mul c7~62@ (Mul c7~62@ (Mul a7~58@ a7~58@))) d7~64@) (Sub (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1284@ temp_7_1~1337@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1409@ (Mul (Mul (Mul (Mul d8~72@ d8~72@) b8~68@) (Mul (Sub d8~72@ d8~72@) a8~66@)) (Mul (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1466@ (Mul (Mul (Mul b8~68@ (Mul d8~72@ d8~72@)) (Mul (Sub d8~72@ d8~72@) a8~66@)) (Mul (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1409@ temp_8_1~1466@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1558@ (Mul (Mul (Mul (Mul 13 d9~80@) (Mul a9~74@ b9~76@)) (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1635@ (Mul (Mul (Mul 13 d9~80@) (Mul a9~74@ b9~76@)) (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ d9~80@)))))) (=> (= tmp%10@ (= temp_9_0~1558@ temp_9_1~1635@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1711@ (Mul (Mul (Add (Mul a10~82@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul a10~82@ d10~88@) b10~84@)) (Mul (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ b10~84@))))) (=> (= temp_10_1~1772@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ b10~84@))) (Mul (Add (Mul a10~82@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul a10~82@ d10~88@) b10~84@)))) (=> (= tmp%11@ (= temp_10_0~1711@ temp_10_1~1772@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1848@ (Mul (Mul (Mul (Add b11~92@ b11~92@) (Sub d11~96@ c11~94@)) (Mul (Mul d11~96@ c11~94@) b11~92@)) (Sub (Sub (Mul c11~94@ c11~94@) (Mul d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~1909@ (Mul (Mul (Mul (Add b11~92@ b11~92@) (Sub d11~96@ c11~94@)) (Mul (Mul d11~96@ c11~94@) b11~92@)) (Sub (Sub (Mul c11~94@ c11~94@) (Mul d11~96@ b11~92@)) (Mul a11~90@ (Mul c11~94@ (Mul b11~92@ a11~90@)))))) (=> (= tmp%12@ (= temp_11_0~1848@ temp_11_1~1909@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1989@ (Mul (Mul (Sub (Mul a12~98@ d12~104@) (Sub c12~102@ c12~102@)) (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ d12~104@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~2054@ (Mul (Mul (Sub (Mul a12~98@ d12~104@) (Sub c12~102@ c12~102@)) (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ d12~104@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@)) (Mul c12~102@ (Mul c12~102@ (Mul b12~100@ b12~100@)))))) (=> (= tmp%13@ (= temp_12_0~1989@ temp_12_1~2054@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2134@ (Mul (Mul b13~108@ (Mul (Mul a13~106@ a13~106@) (Sub b13~108@ b13~108@))) (Sub (Mul (Mul a13~106@ d13~112@) (Mul a13~106@ c13~110@)) (Mul (Mul c13~110@ b13~108@) (Mul b13~108@ 35))))) (=> (= temp_13_1~2199@ (Mul (Mul b13~108@ (Mul (Mul a13~106@ a13~106@) (Sub b13~108@ b13~108@))) (Sub (Mul a13~106@ (Mul d13~112@ (Mul a13~106@ c13~110@))) (Mul (Mul c13~110@ b13~108@) (Mul b13~108@ 35))))) (=> (= tmp%14@ (= temp_13_0~2134@ temp_13_1~2199@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2279@ (Mul (Mul (Mul (Sub b14~116@ a14~114@) (Add b14~116@ a14~114@)) (Mul (Mul d14~120@ 56) (Mul d14~120@ b14~116@))) (Mul b14~116@ (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ d14~120@))))) (=> (= temp_14_1~2352@ (Mul (Mul (Sub (Mul b14~116@ (Add b14~116@ a14~114@)) (Mul a14~114@ (Add b14~116@ a14~114@))) (Mul (Mul d14~120@ 56) (Mul d14~120@ b14~116@))) (Mul b14~116@ (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ d14~120@))))) (=> (= tmp%15@ (= temp_14_0~2279@ temp_14_1~2352@)) (=> %%location_label%%14 tmp%15@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
