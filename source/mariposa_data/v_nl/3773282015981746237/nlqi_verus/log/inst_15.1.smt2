...
(set-info :comment ";; mariposa_data/v_nl//3773282015981746237/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_9_0~1787@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Add (Mul (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Sub c0~6@ d0~8@) (Mul b0~4@ a0~2@))) (Mul (Mul (Add d0~8@ b0~4@) (Mul a0~2@ a0~2@)) (Sub (Mul b0~4@ c0~6@) (Mul 35 b0~4@))))) (=> (= temp_0_1~402@ (Add (Mul (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ a0~2@)) (Sub (Mul c0~6@ (Mul b0~4@ a0~2@)) (Mul d0~8@ (Mul b0~4@ a0~2@)))) (Mul (Mul (Add d0~8@ b0~4@) (Mul a0~2@ a0~2@)) (Sub (Mul b0~4@ c0~6@) (Mul 35 b0~4@))))) (and (=> (= tmp%1@ (Mul b0~4@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c0~6@ d0~8@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~402@)))) (=> (= temp_0_0~317@ temp_0_1~402@) (=> (= temp_1_0~489@ (Mul (Mul a1~10@ (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Add d1~16@ d1~16@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~542@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Add d1~16@ d1~16@) (Mul d1~16@ b1~12@))) (Mul a1~10@ (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ b1~12@))))) (and (=> (= tmp%2@ (Mul a1~10@ (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ b1~12@)))) (=> (= tmp%3@ (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Add d1~16@ d1~16@) (Mul d1~16@ b1~12@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~489@ temp_1_1~542@))))) (=> (= temp_1_0~489@ temp_1_1~542@) (=> (= temp_2_0~675@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ a2~18@))) (Mul (Add (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ b2~20@) b2~20@)))) (=> (= temp_2_1~736@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ a2~18@))) (Mul (Add (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ b2~20@) b2~20@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ b2~20@) (=> %%location_label%%2 (= temp_2_0~675@ temp_2_1~736@))) (=> (= temp_2_0~675@ temp_2_1~736@) (=> (= temp_3_0~833@ (Mul (Sub (Mul (Add 23 d3~32@) b3~28@) (Sub (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul c3~30@ b3~28@) (Add b3~28@ c3~30@)) (Mul (Mul c3~30@ c3~30@) c3~30@)))) (=> (= temp_3_1~902@ (Mul (Sub (Mul (Add 23 d3~32@) b3~28@) (Sub (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul c3~30@ (Mul b3~28@ (Add b3~28@ c3~30@))) (Mul (Mul c3~30@ c3~30@) c3~30@)))) (and (=> (= tmp%4@ (Add b3~28@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c3~30@ b3~28@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~833@ temp_3_1~902@)))) (=> (= temp_3_0~833@ temp_3_1~902@) (=> (= temp_4_0~1013@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ 5) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)) (Sub (Mul d4~40@ c4~38@) (Mul d4~40@ d4~40@))))) (=> (= temp_4_1~1090@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Mul c4~38@ (Mul 5 (Mul a4~34@ d4~40@)))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)) (Sub (Mul d4~40@ c4~38@) (Mul d4~40@ d4~40@))))) (and (=> (= tmp%5@ (Mul a4~34@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c4~38@ 5 tmp%5@) (=> %%location_label%%4 (= temp_4_0~1013@ temp_4_1~1090@)))) (=> (= temp_4_0~1013@ temp_4_1~1090@) (=> (= temp_5_0~1201@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Sub a5~42@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~1266@ (Mul (Mul (Mul b5~44@ c5~46@) (Mul (Sub a5~42@ d5~48@) (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@)))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ b5~44@))))) (and (=> (= tmp%6@ (Mul b5~44@ c5~46@)) (=> (= tmp%7@ (Sub a5~42@ d5~48@)) (=> (= tmp%8@ (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~1201@ temp_5_1~1266@)))))) (=> (= temp_5_0~1201@ temp_5_1~1266@) (=> (= temp_6_0~1353@ (Add (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ b6~52@)) (Mul (Sub b6~52@ a6~50@) (Mul a6~50@ b6~52@))) b6~52@)) (=> (= temp_6_1~1390@ (Add (Mul (Mul d6~56@ (Mul d6~56@ (Mul a6~50@ b6~52@))) (Mul (Sub b6~52@ a6~50@) (Mul a6~50@ b6~52@))) b6~52@)) (and (=> (= tmp%9@ (Mul a6~50@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d6~56@ d6~56@ tmp%9@) (=> %%location_label%%6 (= temp_6_0~1353@ temp_6_1~1390@)))) (=> (= temp_6_0~1353@ temp_6_1~1390@) (=> (= temp_7_0~1477@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)) d7~64@) (Sub (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1530@ (Mul (Mul (Mul c7~62@ (Mul c7~62@ (Mul a7~58@ a7~58@))) d7~64@) (Sub (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))))) (and (=> (= tmp%10@ (Mul a7~58@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c7~62@ c7~62@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~1477@ temp_7_1~1530@)))) (=> (= temp_7_0~1477@ temp_7_1~1530@) (=> (= temp_8_0~1621@ (Mul (Mul (Mul (Mul d8~72@ d8~72@) b8~68@) (Mul (Sub d8~72@ d8~72@) a8~66@)) (Mul (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1678@ (Mul (Mul (Mul b8~68@ (Mul d8~72@ d8~72@)) (Mul (Sub d8~72@ d8~72@) a8~66@)) (Mul (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@))))) (and (=> (= tmp%11@ (Mul d8~72@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1621@ temp_8_1~1678@)))) (=> (= temp_8_0~1621@ temp_8_1~1678@) (=> (= temp_9_0~1787@ (Mul (Mul (Mul (Mul 13 d9~80@) (Mul a9~74@ b9~76@)) (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1864@ (Mul (Mul (Mul 13 d9~80@) (Mul a9~74@ b9~76@)) (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ d9~80@)))))) (and (=> (= tmp%12@ (Mul (Mul 13 d9~80@) (Mul a9~74@ b9~76@))) (=> (= tmp%13@ (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ d9~80@))) (=> (= tmp%14@ (Mul (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ d9~80@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%9 (= temp_9_0~1787@ temp_9_1~1864@)))))) (=> (= temp_9_0~1787@ temp_9_1~1864@) (=> (= temp_10_0~2019@ (Mul (Mul (Add (Mul a10~82@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul a10~82@ d10~88@) b10~84@)) (Mul (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ b10~84@))))) (=> (= temp_10_1~2080@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ b10~84@))) (Mul (Add (Mul a10~82@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul a10~82@ d10~88@) b10~84@)))) (and (=> (= tmp%15@ (Mul (Add (Mul a10~82@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul a10~82@ d10~88@) b10~84@))) (=> (= tmp%16@ (Mul (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ b10~84@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%10 (= temp_10_0~2019@ temp_10_1~2080@))))) (=> (= temp_10_0~2019@ temp_10_1~2080@) (=> (= temp_11_0~2221@ (Mul (Mul (Mul (Add b11~92@ b11~92@) (Sub d11~96@ c11~94@)) (Mul (Mul d11~96@ c11~94@) b11~92@)) (Sub (Sub (Mul c11~94@ c11~94@) (Mul d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2282@ (Mul (Mul (Mul (Add b11~92@ b11~92@) (Sub d11~96@ c11~94@)) (Mul (Mul d11~96@ c11~94@) b11~92@)) (Sub (Sub (Mul c11~94@ c11~94@) (Mul d11~96@ b11~92@)) (Mul a11~90@ (Mul c11~94@ (Mul b11~92@ a11~90@)))))) (and (=> (= tmp%17@ (Mul b11~92@ a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a11~90@ c11~94@ tmp%17@) (=> %%location_label%%11 (= temp_11_0~2221@ temp_11_1~2282@)))) (=> (= temp_11_0~2221@ temp_11_1~2282@) (=> (= temp_12_0~2381@ (Mul (Mul (Sub (Mul a12~98@ d12~104@) (Sub c12~102@ c12~102@)) (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ d12~104@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~2446@ (Mul (Mul (Sub (Mul a12~98@ d12~104@) (Sub c12~102@ c12~102@)) (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ d12~104@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@)) (Mul c12~102@ (Mul c12~102@ (Mul b12~100@ b12~100@)))))) (and (=> (= tmp%18@ (Mul b12~100@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c12~102@ c12~102@ tmp%18@) (=> %%location_label%%12 (= temp_12_0~2381@ temp_12_1~2446@)))) (=> (= temp_12_0~2381@ temp_12_1~2446@) (=> (= temp_13_0~2545@ (Mul (Mul b13~108@ (Mul (Mul a13~106@ a13~106@) (Sub b13~108@ b13~108@))) (Sub (Mul (Mul a13~106@ d13~112@) (Mul a13~106@ c13~110@)) (Mul (Mul c13~110@ b13~108@) (Mul b13~108@ 35))))) (=> (= temp_13_1~2610@ (Mul (Mul b13~108@ (Mul (Mul a13~106@ a13~106@) (Sub b13~108@ b13~108@))) (Sub (Mul a13~106@ (Mul d13~112@ (Mul a13~106@ c13~110@))) (Mul (Mul c13~110@ b13~108@) (Mul b13~108@ 35))))) (and (=> (= tmp%19@ (Mul a13~106@ c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a13~106@ d13~112@ tmp%19@) (=> %%location_label%%13 (= temp_13_0~2545@ temp_13_1~2610@)))) (=> (= temp_13_0~2545@ temp_13_1~2610@) (=> (= temp_14_0~2709@ (Mul (Mul (Mul (Sub b14~116@ a14~114@) (Add b14~116@ a14~114@)) (Mul (Mul d14~120@ 56) (Mul d14~120@ b14~116@))) (Mul b14~116@ (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ d14~120@))))) (=> (= temp_14_1~2782@ (Mul (Mul (Sub (Mul b14~116@ (Add b14~116@ a14~114@)) (Mul a14~114@ (Add b14~116@ a14~114@))) (Mul (Mul d14~120@ 56) (Mul d14~120@ b14~116@))) (Mul b14~116@ (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ d14~120@))))) (=> (= tmp%20@ (Add b14~116@ a14~114@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b14~116@ a14~114@ tmp%20@) (=> %%location_label%%14 (= temp_14_0~2709@ temp_14_1~2782@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
