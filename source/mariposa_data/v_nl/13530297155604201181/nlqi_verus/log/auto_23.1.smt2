...
(assert (=> %%query%% (not (=> (= temp_0_0~281@ (Mul (Mul c0~6@ (Add (Sub a0~2@ c0~6@) (Add c0~6@ a0~2@))) (Mul (Add (Mul b0~4@ a0~2@) (Mul b0~4@ c0~6@)) b0~4@))) (=> (= temp_0_1~322@ (Mul (Mul c0~6@ (Add (Sub a0~2@ c0~6@) (Add c0~6@ a0~2@))) (Mul b0~4@ (Add (Mul b0~4@ a0~2@) (Mul b0~4@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~281@ temp_0_1~322@))) (=> (= temp_0_0~281@ temp_0_1~322@) (=> (= temp_1_0~407@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ a1~10@)) (Mul d1~16@ (Add c1~14@ a1~10@))) (Add (Sub (Mul b1~12@ a1~10@) (Mul d1~16@ c1~14@)) (Mul (Add b1~12@ d1~16@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~468@ (Mul (Add (Sub (Mul b1~12@ a1~10@) (Mul d1~16@ c1~14@)) (Mul (Add b1~12@ d1~16@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ a1~10@)) (Mul d1~16@ (Add c1~14@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~407@ temp_1_1~468@))) (=> (= temp_1_0~407@ temp_1_1~468@) (=> (= temp_2_0~553@ (Mul (Mul (Mul (Sub b2~20@ c2~22@) (Mul a2~18@ c2~22@)) (Mul (Sub c2~22@ c2~22@) (Sub a2~18@ d2~24@))) (Mul (Mul (Mul b2~20@ a2~18@) d2~24@) (Mul (Mul c2~22@ c2~22@) (Sub d2~24@ a2~18@))))) (=> (= temp_2_1~614@ (Mul (Mul (Mul (Sub b2~20@ c2~22@) (Mul a2~18@ c2~22@)) (Mul (Sub c2~22@ c2~22@) (Sub a2~18@ d2~24@))) (Mul (Mul (Mul b2~20@ a2~18@) d2~24@) (Mul c2~22@ (Mul c2~22@ (Sub d2~24@ a2~18@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~553@ temp_2_1~614@))) (=> (= temp_2_0~553@ temp_2_1~614@) (=> (= temp_3_0~727@ (Mul (Mul (Mul (Mul c3~30@ 0) (Mul a3~26@ b3~28@)) (Sub (Mul 64 d3~32@) (Sub b3~28@ c3~30@))) (Mul (Mul (Add a3~26@ c3~30@) (Mul b3~28@ b3~28@)) (Mul (Add a3~26@ d3~32@) (Mul a3~26@ a3~26@))))) (=> (= temp_3_1~816@ (Mul (Mul (Mul (Mul c3~30@ 0) (Mul a3~26@ b3~28@)) (Sub (Mul d3~32@ 64) (Sub b3~28@ c3~30@))) (Mul (Mul (Add a3~26@ c3~30@) (Mul b3~28@ b3~28@)) (Mul (Add a3~26@ d3~32@) (Mul a3~26@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~727@ temp_3_1~816@))) (=> (= temp_3_0~727@ temp_3_1~816@) (=> (= temp_4_0~917@ (Sub (Mul (Mul (Mul c4~38@ a4~34@) (Sub d4~40@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Sub d4~40@ a4~34@))) (Mul (Sub (Mul d4~40@ b4~36@) (Mul 88 d4~40@)) (Sub (Mul a4~34@ b4~36@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~994@ (Sub (Mul (Mul (Mul c4~38@ a4~34@) (Sub d4~40@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Sub d4~40@ a4~34@))) (Mul (Sub (Mul d4~40@ b4~36@) (Mul d4~40@ 88)) (Sub (Mul a4~34@ b4~36@) (Mul b4~36@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~917@ temp_4_1~994@))) (=> (= temp_4_0~917@ temp_4_1~994@) (=> (= temp_5_0~1091@ (Mul (Sub (Mul (Add d5~48@ 13) (Sub c5~46@ c5~46@)) (Mul (Mul c5~46@ b5~44@) (Add c5~46@ c5~46@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ b5~44@)) (Mul d5~48@ (Sub d5~48@ a5~42@))))) (=> (= temp_5_1~1164@ (Mul (Sub (Mul (Add d5~48@ 13) (Sub c5~46@ c5~46@)) (Mul (Mul c5~46@ b5~44@) (Add c5~46@ c5~46@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ d5~48@)) (Mul d5~48@ (Sub d5~48@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1091@ temp_5_1~1164@))) (=> (= temp_5_0~1091@ temp_5_1~1164@) (=> (= temp_6_0~1241@ (Mul (Sub c6~54@ (Sub (Mul c6~54@ a6~50@) (Sub a6~50@ c6~54@))) (Mul (Mul (Mul c6~54@ b6~52@) (Add a6~50@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1294@ (Mul (Sub c6~54@ (Sub (Mul c6~54@ a6~50@) (Sub a6~50@ c6~54@))) (Mul (Mul (Mul c6~54@ b6~52@) (Add a6~50@ d6~56@)) (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1241@ temp_6_1~1294@))) (=> (= temp_6_0~1241@ temp_6_1~1294@) (=> (= temp_7_0~1395@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ a7~58@)) (Mul (Sub d7~64@ c7~62@) (Mul b7~60@ 55))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Add d7~64@ c7~62@))))) (=> (= temp_7_1~1472@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ a7~58@)) (Mul (Sub d7~64@ c7~62@) (Mul b7~60@ 55))) (Mul (Mul (Mul a7~58@ d7~64@) (Add d7~64@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1395@ temp_7_1~1472@))) (=> (= temp_7_0~1395@ temp_7_1~1472@) (=> (= temp_8_0~1557@ (Mul (Mul (Sub (Mul a8~66@ c8~70@) d8~72@) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ b8~68@))) (Mul (Mul (Sub d8~72@ c8~70@) (Mul c8~70@ c8~70@)) (Add (Mul a8~66@ c8~70@) (Add a8~66@ d8~72@))))) (=> (= temp_8_1~1618@ (Mul (Mul (Sub (Mul a8~66@ c8~70@) d8~72@) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ b8~68@))) (Mul (Mul (Sub d8~72@ c8~70@) (Mul c8~70@ c8~70@)) (Add (Mul a8~66@ c8~70@) (Add a8~66@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1557@ temp_8_1~1618@))) (=> (= temp_8_0~1557@ temp_8_1~1618@) (=> (= temp_9_0~1707@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Add a9~74@ d9~80@) (Sub d9~80@ a9~74@))) (Mul (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1772@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Add a9~74@ d9~80@) (Sub d9~80@ a9~74@))) (Mul (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1707@ temp_9_1~1772@))) (=> (= temp_9_0~1707@ temp_9_1~1772@) (=> (= temp_10_0~1873@ (Mul (Mul (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@))) (Mul (Add (Mul c10~86@ a10~82@) (Mul b10~84@ c10~86@)) (Mul (Mul 13 c10~86@) (Mul b10~84@ c10~86@))))) (=> (= temp_10_1~1978@ (Mul (Mul (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@))) (Add (Mul (Mul c10~86@ a10~82@) (Mul (Mul 13 c10~86@) (Mul b10~84@ c10~86@))) (Mul (Mul b10~84@ c10~86@) (Mul (Mul 13 c10~86@) (Mul b10~84@ c10~86@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1873@ temp_10_1~1978@))) (=> (= temp_10_0~1873@ temp_10_1~1978@) (=> (= temp_11_0~2067@ (Mul (Mul (Mul (Sub b11~92@ d11~96@) (Mul d11~96@ b11~92@)) (Mul (Mul b11~92@ a11~90@) (Sub a11~90@ a11~90@))) (Mul (Add (Mul d11~96@ d11~96@) (Sub c11~94@ a11~90@)) (Mul (Mul d11~96@ b11~92@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~2140@ (Mul (Mul (Sub (Mul b11~92@ (Mul d11~96@ b11~92@)) (Mul d11~96@ (Mul d11~96@ b11~92@))) (Mul (Mul b11~92@ a11~90@) (Sub a11~90@ a11~90@))) (Mul (Add (Mul d11~96@ d11~96@) (Sub c11~94@ a11~90@)) (Mul (Mul d11~96@ b11~92@) (Mul d11~96@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2067@ temp_11_1~2140@))) (=> (= temp_11_0~2067@ temp_11_1~2140@) (=> (= temp_12_0~2237@ (Mul (Sub (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ b12~100@) (Mul c12~102@ c12~102@))) (Add (Mul c12~102@ (Mul a12~98@ 62)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@))))) (=> (= temp_12_1~2310@ (Mul (Sub (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ c12~102@) (Mul b12~100@ b12~100@))) (Add (Mul c12~102@ (Mul a12~98@ 62)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2237@ temp_12_1~2310@))) (=> (= temp_12_0~2237@ temp_12_1~2310@) (=> (= temp_13_0~2399@ (Mul (Mul (Mul (Mul b13~108@ d13~112@) (Sub b13~108@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@))) (Mul (Mul (Sub b13~108@ a13~106@) (Mul d13~112@ b13~108@)) (Add (Mul a13~106@ d13~112@) (Mul a13~106@ b13~108@))))) (=> (= temp_13_1~2464@ (Mul (Mul (Mul (Mul b13~108@ d13~112@) (Sub b13~108@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@))) (Mul (Mul (Sub b13~108@ a13~106@) (Mul d13~112@ b13~108@)) (Add (Mul d13~112@ a13~106@) (Mul a13~106@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2399@ temp_13_1~2464@))) (=> (= temp_13_0~2399@ temp_13_1~2464@) (=> (= temp_14_0~2565@ (Add (Mul (Mul (Mul 22 c14~118@) (Mul b14~116@ a14~114@)) (Sub (Mul c14~118@ d14~120@) (Add c14~118@ d14~120@))) (Mul (Add (Sub d14~120@ a14~114@) (Sub a14~114@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2642@ (Add (Mul (Mul (Mul c14~118@ 22) (Mul b14~116@ a14~114@)) (Sub (Mul c14~118@ d14~120@) (Add c14~118@ d14~120@))) (Mul (Add (Sub d14~120@ a14~114@) (Sub a14~114@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2565@ temp_14_1~2642@))) (=> (= temp_14_0~2565@ temp_14_1~2642@) (=> (= temp_15_0~2735@ (Mul (Mul (Add (Mul b15~124@ c15~126@) (Sub a15~122@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Mul 87 a15~122@))) (Mul (Mul (Sub c15~126@ d15~128@) d15~128@) (Mul (Mul c15~126@ a15~122@) b15~124@)))) (=> (= temp_15_1~2804@ (Mul (Mul (Mul (Mul c15~126@ b15~124@) (Mul 87 a15~122@)) (Add (Mul b15~124@ c15~126@) (Sub a15~122@ b15~124@))) (Mul (Mul (Sub c15~126@ d15~128@) d15~128@) (Mul (Mul c15~126@ a15~122@) b15~124@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2735@ temp_15_1~2804@))) (=> (= temp_15_0~2735@ temp_15_1~2804@) (=> (= temp_16_0~2893@ (Mul (Mul (Sub (Mul a16~130@ a16~130@) (Mul b16~132@ a16~130@)) (Mul (Mul a16~130@ b16~132@) (Mul b16~132@ b16~132@))) (Mul (Mul (Mul c16~134@ a16~130@) (Mul b16~132@ d16~136@)) (Mul (Sub d16~136@ c16~134@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2958@ (Mul (Mul (Sub (Mul a16~130@ a16~130@) (Mul b16~132@ a16~130@)) (Mul (Mul a16~130@ b16~132@) (Mul b16~132@ b16~132@))) (Mul (Mul c16~134@ a16~130@) (Mul (Mul b16~132@ d16~136@) (Mul (Sub d16~136@ c16~134@) (Mul c16~134@ a16~130@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2893@ temp_16_1~2958@))) (=> (= temp_16_0~2893@ temp_16_1~2958@) (=> (= temp_17_0~3047@ (Mul (Mul (Mul (Mul d17~144@ c17~142@) (Sub d17~144@ b17~140@)) (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ a17~138@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul d17~144@ d17~144@) (Mul d17~144@ a17~138@))))) (=> (= temp_17_1~3112@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Sub d17~144@ b17~140@)) (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ a17~138@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul d17~144@ d17~144@) (Mul d17~144@ a17~138@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~3047@ temp_17_1~3112@))) (=> (= temp_17_0~3047@ temp_17_1~3112@) (=> (= temp_18_0~3185@ (Mul (Mul (Mul (Sub d18~152@ c18~150@) (Mul d18~152@ b18~148@)) (Mul (Mul d18~152@ a18~146@) (Mul 86 a18~146@))) d18~152@)) (=> (= temp_18_1~3234@ (Mul d18~152@ (Mul (Mul (Sub d18~152@ c18~150@) (Mul d18~152@ b18~148@)) (Mul (Mul d18~152@ a18~146@) (Mul 86 a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3185@ temp_18_1~3234@))) (=> (= temp_18_0~3185@ temp_18_1~3234@) (=> (= temp_19_0~3319@ (Mul (Mul (Mul (Sub a19~154@ a19~154@) (Mul d19~160@ a19~154@)) (Sub (Mul c19~158@ d19~160@) (Mul d19~160@ c19~158@))) (Mul (Mul c19~158@ (Mul d19~160@ a19~154@)) (Mul (Mul b19~156@ a19~154@) (Mul a19~154@ a19~154@))))) (=> (= temp_19_1~3380@ (Mul (Mul (Mul (Sub a19~154@ a19~154@) (Mul d19~160@ a19~154@)) (Sub (Mul c19~158@ d19~160@) (Mul d19~160@ c19~158@))) (Mul (Mul c19~158@ (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ b19~156@) (Mul a19~154@ a19~154@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3319@ temp_19_1~3380@))) (=> (= temp_19_0~3319@ temp_19_1~3380@) (=> (= temp_20_0~3493@ (Mul (Mul (Mul (Mul a20~162@ b20~164@) (Mul c20~166@ c20~166@)) (Add (Mul d20~168@ a20~162@) (Mul c20~166@ a20~162@))) (Mul (Mul (Mul c20~166@ b20~164@) (Mul b20~164@ d20~168@)) (Sub (Mul 0 b20~164@) (Mul b20~164@ 62))))) (=> (= temp_20_1~3598@ (Mul (Add (Mul (Mul (Mul a20~162@ b20~164@) (Mul c20~166@ c20~166@)) (Mul d20~168@ a20~162@)) (Mul (Mul (Mul a20~162@ b20~164@) (Mul c20~166@ c20~166@)) (Mul c20~166@ a20~162@))) (Mul (Mul (Mul c20~166@ b20~164@) (Mul b20~164@ d20~168@)) (Sub (Mul 0 b20~164@) (Mul b20~164@ 62))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3493@ temp_20_1~3598@))) (=> (= temp_20_0~3493@ temp_20_1~3598@) (=> (= temp_21_0~3695@ (Mul (Mul (Mul (Add d21~176@ b21~172@) (Mul a21~170@ a21~170@)) (Mul (Add d21~176@ c21~174@) (Mul a21~170@ a21~170@))) (Mul (Mul d21~176@ (Mul 88 c21~174@)) (Mul (Mul c21~174@ b21~172@) (Add c21~174@ c21~174@))))) (=> (= temp_21_1~3768@ (Mul (Mul (Mul (Add d21~176@ b21~172@) (Mul a21~170@ a21~170@)) (Mul (Add d21~176@ c21~174@) (Mul a21~170@ a21~170@))) (Mul (Mul d21~176@ (Mul 88 c21~174@)) (Mul c21~174@ (Mul b21~172@ (Add c21~174@ c21~174@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3695@ temp_21_1~3768@))) (=> (= temp_21_0~3695@ temp_21_1~3768@) (=> (= temp_22_0~3853@ (Add (Sub (Mul (Mul c22~182@ d22~184@) (Mul a22~178@ d22~184@)) (Mul (Mul b22~180@ b22~180@) (Mul a22~178@ c22~182@))) (Mul (Mul (Mul a22~178@ a22~178@) (Add c22~182@ d22~184@)) (Mul (Mul b22~180@ a22~178@) d22~184@)))) (=> (= temp_22_1~3914@ (Add (Sub (Mul (Mul c22~182@ d22~184@) (Mul a22~178@ d22~184@)) (Mul (Mul b22~180@ b22~180@) (Mul a22~178@ c22~182@))) (Mul (Mul (Mul a22~178@ a22~178@) (Add c22~182@ d22~184@)) (Mul d22~184@ (Mul b22~180@ a22~178@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3853@ temp_22_1~3914@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
