...
(push)
 ...
 (declare-const temp_10_0~1753@ Int)
 ...
 (declare-const temp_13_1~2212@ Int)
 ...
 (declare-const temp_16_0~2601@ Int)
 (declare-const temp_16_1~2666@ Int)
 (declare-const temp_17_0~2767@ Int)
 (declare-const temp_17_1~2844@ Int)
 (declare-const temp_18_0~2933@ Int)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~317@ temp_0_1~394@)
        (=>
         (= temp_1_0~487@ (Add (Mul (Mul (Add b1~12@ d1~16@) 72) (Sub (Mul c1~14@ d1~16@) (Mul
              c1~14@ a1~10@
            ))
           ) (Mul (Add a1~10@ (Add c1~14@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@)))
         ))
         (=>
          (= temp_1_1~556@ (Add (Mul (Mul (Add b1~12@ d1~16@) 72) (Sub (Mul c1~14@ d1~16@) (Mul
               a1~10@ c1~14@
             ))
            ) (Mul (Add a1~10@ (Add c1~14@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@)))
          ))
          (and
           ...
           (=>
            (= temp_1_0~487@ temp_1_1~556@)
            (=>
             (= temp_2_0~641@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@
                  a2~18@
                 ) a2~18@
                )
             ...
             (=>
              (= temp_2_1~702@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@
                   a2~18@
                  ) a2~18@
                 )
              ...
              (and
               ...
               (=>
                (= temp_2_0~641@ temp_2_1~702@)
                (=>
                 (= temp_3_0~791@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Sub a3~26@
                      a3~26@
                     ) (Mul c3~30@ c3~30@)
                    )
                 ...
                 (=>
                  (= temp_3_1~856@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Sub a3~26@
                       a3~26@
                      ) (Mul c3~30@ c3~30@)
                     )
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~791@ temp_3_1~856@)
                    (=>
                     (= temp_4_0~933@ (Mul (Mul b4~36@ (Mul (Mul a4~34@ d4~40@) (Add c4~38@ a4~34@))) (Add
                        (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@)) (Add (Mul d4~40@ a4~34@) (Mul d4~40@
                          c4~38@
                     )))))
                     (=>
                      (= temp_4_1~986@ (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Add c4~38@ a4~34@)) b4~36@) (Add
                         (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@)) (Add (Mul d4~40@ a4~34@) (Mul d4~40@
                           c4~38@
                      )))))
                      (and
                       ...
                       (=>
                        (= temp_4_0~933@ temp_4_1~986@)
                        (=>
                         (= temp_5_0~1063@ (Add (Sub (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ b5~44@)) b5~44@) (
                            Add (Mul (Mul c5~46@ b5~44@) (Add b5~44@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@
                              c5~46@
                         )))))
                         (=>
                          (= temp_5_1~1116@ (Add (Sub (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ b5~44@)) b5~44@) (
                             Add (Mul (Mul c5~46@ b5~44@) (Add b5~44@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@
                               c5~46@
                          )))))
                          (and
                           ...
                           (=>
                            (= temp_5_0~1063@ temp_5_1~1116@)
                            (=>
                             (= temp_6_0~1229@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Mul 51
                                  c6~54@
                                 ) (Add 82 d6~56@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1318@ (Mul (Mul (Mul b6~52@ (Mul b6~52@ (Mul c6~54@ b6~52@))) (Mul (Mul 51
                                   c6~54@
                                  ) (Add 82 d6~56@)
                                 )
                                ) (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@)) (Add (Mul b6~52@ d6~56@) (Mul a6~50@
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1229@ temp_6_1~1318@)
                               ))
                               (=>
                                (= temp_6_0~1229@ temp_6_1~1318@)
                                (=>
                                 (= temp_7_0~1383@ (Mul (Mul (Mul (Add d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@
                                      b7~60@
                                     ) (Mul d7~64@ d7~64@)
                                    )
                                   ) (Mul c7~62@ b7~60@)
                                 ...
                                 (=>
                                  (= temp_7_1~1424@ (Mul (Mul c7~62@ b7~60@) (Mul (Mul (Add d7~64@ a7~58@) (Mul c7~62@ c7~62@))
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1383@ temp_7_1~1424@)
                                   ))
                                   (=>
                                    (= temp_7_0~1383@ temp_7_1~1424@)
                                    (=>
                                     (= temp_8_0~1521@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Add (Add b8~68@
                                          b8~68@
                                         ) (Add c8~70@ a8~66@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1594@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Add (Add b8~68@
                                           b8~68@
                                          ) (Add c8~70@ a8~66@)
                                         )
                                      ...
                                      (and
                                       ...
                                       (=>
                                        (= temp_8_0~1521@ temp_8_1~1594@)
                                        (=>
                                         (= temp_9_0~1655@ (Mul (Mul (Sub (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Add d9~80@
                                              c9~78@
                                             ) (Mul c9~78@ b9~76@)
                                            )
                                           ) d9~80@
                                         ...
                                         (=>
                                          (= temp_9_1~1692@ (Mul (Sub (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul (Add d9~80@
                                               c9~78@
                                              ) (Mul c9~78@ b9~76@)
                                             ) d9~80@
                                          )))
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1655@ temp_9_1~1692@)
                                           ))
                                           (=>
                                            (= temp_9_0~1655@ temp_9_1~1692@)
                                            (=>
                                             (= temp_10_0~1753@ (Mul a10~82@ (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ d10~88@))
                                                (Sub (Mul c10~86@ c10~86@) (Mul a10~82@ a10~82@))
                                             )))
                                             (=>
                                              (= temp_10_1~1790@ (Mul a10~82@ (Mul (Mul (Mul (Mul d10~88@ b10~84@) c10~86@) d10~88@)
                                                 (Sub (Mul c10~86@ c10~86@) (Mul a10~82@ a10~82@))
                                              )))
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1753@ temp_10_1~1790@)
                                               ))
                                               (=>
                                                (= temp_10_0~1753@ temp_10_1~1790@)
                                                (=>
                                                 (= temp_11_0~1879@ (Add (Mul (Mul (Mul c11~94@ c11~94@) (Add a11~90@ c11~94@)) (Mul (
                                                      Mul d11~96@ d11~96@
                                                     ) (Mul d11~96@ d11~96@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~1944@ (Add (Mul (Mul (Mul c11~94@ c11~94@) (Add a11~90@ c11~94@)) (Mul (
                                                       Mul d11~96@ d11~96@
                                                      ) (Mul d11~96@ d11~96@)
                                                     )
                                                    ) (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ b11~92@)) (Sub (Mul d11~96@ d11~96@)
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~1879@ temp_11_1~1944@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~1879@ temp_11_1~1944@)
                                                    (=>
                                                     (= temp_12_0~2009@ (Mul (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ c12~102@)) (Mul
                                                         (Mul a12~98@ c12~102@) (Mul b12~100@ b12~100@)
                                                        )
                                                       ) (Mul d12~104@ b12~100@)
                                                     ))
                                                     (=>
                                                      (= temp_12_1~2050@ (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ c12~102@)) (Mul (Mul
                                                          (Mul a12~98@ c12~102@) (Mul b12~100@ b12~100@)
                                                         ) (Mul d12~104@ b12~100@)
                                                      )))
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2009@ temp_12_1~2050@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2009@ temp_12_1~2050@)
                                                        (=>
                                                         (= temp_13_0~2143@ (Mul (Mul (Add (Add c13~110@ c13~110@) (Mul c13~110@ 53)) (Mul (Mul
                                                              b13~108@ b13~108@
                                                             ) a13~106@
                                                            )
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2212@ (Mul (Add (Add c13~110@ c13~110@) (Mul c13~110@ 53)) (Mul (Mul (Mul
                                                               b13~108@ b13~108@
                                                              ) a13~106@
                                                             ) (Mul (Mul (Mul a13~106@ b13~108@) (Sub d13~112@ a13~106@)) (Mul b13~108@ (Mul d13~112@
                                                                c13~110@
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2143@ temp_13_1~2212@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2143@ temp_13_1~2212@)
                                                            (=>
                                                             (= temp_14_0~2297@ (Add (Mul (Sub (Mul d14~120@ d14~120@) (Mul c14~118@ c14~118@)) (
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2358@ (Add (Mul (Sub (Mul d14~120@ d14~120@) (Mul c14~118@ c14~118@)) (
                                                                  Mul (Mul c14~118@ c14~118@) (Add d14~120@ c14~118@)
                                                                 )
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2297@ temp_14_1~2358@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2297@ temp_14_1~2358@)
                                                                (=>
                                                                 (= temp_15_0~2447@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ b15~124@)) (
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2512@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ b15~124@)) (
                                                                      Mul (Mul c15~126@ c15~126@) (Mul c15~126@ d15~128@)
                                                                     )
                                                                  ...
                                                                  (and
                                                                   ...
                                                                   (=>
                                                                    (= temp_15_0~2447@ temp_15_1~2512@)
                                                                    (=>
                                                                     (= temp_16_0~2601@ (Mul (Mul (Sub (Mul d16~136@ c16~134@) (Mul c16~134@ b16~132@)) (
                                                                     ...
                                                                     (=>
                                                                      (= temp_16_1~2666@ (Mul (Mul (Sub (Mul d16~136@ c16~134@) (Mul c16~134@ b16~132@)) (
                                                                          Mul (Mul a16~130@ c16~134@) (Sub b16~132@ b16~132@)
                                                                         )
                                                                      ...
                                                                      (and
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         %%location_label%%16
                                                                         (= temp_16_0~2601@ temp_16_1~2666@)
                                                                       ))
                                                                       (=>
                                                                        (= temp_16_0~2601@ temp_16_1~2666@)
                                                                        (=>
                                                                         (= temp_17_0~2767@ (Mul (Mul (Sub (Mul b17~140@ b17~140@) (Mul b17~140@ c17~142@)) (
                                                                         ...
                                                                         (=>
                                                                          (= temp_17_1~2844@ (Mul (Mul (Add (Mul d17~144@ b17~140@) (Mul 63 a17~138@)) (Mul (Mul
                                                                               c17~142@ b17~140@
                                                                              ) (Mul d17~144@ c17~142@)
                                                                             )
                                                                          ...
                                                                          (and
                                                                           (=>
                                                                            ...
                                                                            (=>
                                                                             %%location_label%%17
                                                                             (= temp_17_0~2767@ temp_17_1~2844@)
                                                                           ))
                                                                           (=>
                                                                            (= temp_17_0~2767@ temp_17_1~2844@)
                                                                            (=>
                                                                             (= temp_18_0~2933@ (Mul (Sub (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)) (
                                                                             ...
                                                                             (=>
                                                                              (= temp_18_1~2998@ (Mul (Sub (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)) (
                                                                                  Mul (Mul d18~152@ d18~152@) (Mul a18~146@ a18~146@)
                                                                                 )
                                                                                ) (Sub (Mul (Mul b18~148@ b18~148@) (Mul d18~152@ d18~152@)) (Mul (Mul a18~146@ c18~150@)
                                                                                  (Add d18~152@ c18~150@)
                                                                              ...
                                                                              (and
                                                                               (=>
                                                                                ...
                                                                                (=>
                                                                                 %%location_label%%18
                                                                                 (= temp_18_0~2933@ temp_18_1~2998@)
                                                                               ))
                                                                               (=>
                                                                                (= temp_18_0~2933@ temp_18_1~2998@)
                                                                                (=>
                                                                                 (= temp_19_0~3087@ (Mul (Mul (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ a19~154@)) d19~160@)
                                                                                   (Sub (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ d19~160@)) (Mul (Mul a19~154@ b19~156@)
                                                                                     (Mul 95 d19~160@)
                                                                                 ))))
                                                                                 (=>
                                                                                  (= temp_19_1~3152@ (Mul (Mul (Mul c19~158@ (Mul c19~158@ (Mul a19~154@ a19~154@))) d19~160@)
                                                                                    (Sub (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ d19~160@)) (Mul (Mul a19~154@ b19~156@)
                                                                                      (Mul 95 d19~160@)
                                                                                  ))))
                                                                                  (=>
