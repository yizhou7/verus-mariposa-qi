...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Sub (Mul (Mul 27 b0~4@) (Mul b0~4@ b0~4@)) (Mul (Add a0~2@ c0~6@) (Sub a0~2@ d0~8@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ d0~8@))))) (=> (= temp_0_1~394@ (Mul (Sub (Mul (Mul (Mul 27 b0~4@) b0~4@) b0~4@) (Mul (Add a0~2@ c0~6@) (Sub a0~2@ d0~8@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~317@ temp_0_1~394@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~478@ (Add (Mul (Mul (Add b1~12@ d1~16@) 72) (Sub (Mul c1~14@ d1~16@) (Mul c1~14@ a1~10@))) (Mul (Add a1~10@ (Add c1~14@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~547@ (Add (Mul (Mul (Add b1~12@ d1~16@) 72) (Sub (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@))) (Mul (Add a1~10@ (Add c1~14@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~478@ temp_1_1~547@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~623@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@ a2~18@) a2~18@)) (Add (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~684@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@ a2~18@) a2~18@)) (Add (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~623@ temp_2_1~684@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~764@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~829@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~764@ temp_3_1~829@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~897@ (Mul (Mul b4~36@ (Mul (Mul a4~34@ d4~40@) (Add c4~38@ a4~34@))) (Add (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@)) (Add (Mul d4~40@ a4~34@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~950@ (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Add c4~38@ a4~34@)) b4~36@) (Add (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@)) (Add (Mul d4~40@ a4~34@) (Mul d4~40@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~897@ temp_4_1~950@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1018@ (Add (Sub (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ b5~44@)) b5~44@) (Add (Mul (Mul c5~46@ b5~44@) (Add b5~44@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1071@ (Add (Sub (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ b5~44@)) b5~44@) (Add (Mul (Mul c5~46@ b5~44@) (Add b5~44@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1018@ temp_5_1~1071@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1175@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Mul 51 c6~54@) (Add 82 d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@)) (Add (Mul b6~52@ d6~56@) (Mul a6~50@ c6~54@))))) (=> (= temp_6_1~1264@ (Mul (Mul (Mul b6~52@ (Mul b6~52@ (Mul c6~54@ b6~52@))) (Mul (Mul 51 c6~54@) (Add 82 d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@)) (Add (Mul b6~52@ d6~56@) (Mul a6~50@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1175@ temp_6_1~1264@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1320@ (Mul (Mul (Mul (Add d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@))) (Mul c7~62@ b7~60@))) (=> (= temp_7_1~1361@ (Mul (Mul c7~62@ b7~60@) (Mul (Mul (Add d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1320@ temp_7_1~1361@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1449@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Add (Add b8~68@ b8~68@) (Add c8~70@ a8~66@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ c8~70@)) (Mul a8~66@ (Mul a8~66@ 13))))) (=> (= temp_8_1~1522@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Add (Add b8~68@ b8~68@) (Add c8~70@ a8~66@))) (Mul (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)) (Mul a8~66@ (Mul a8~66@ 13))))) (=> (= tmp%9@ (= temp_8_0~1449@ temp_8_1~1522@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1574@ (Mul (Mul (Sub (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Add d9~80@ c9~78@) (Mul c9~78@ b9~76@))) d9~80@)) (=> (= temp_9_1~1611@ (Mul (Sub (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul (Add d9~80@ c9~78@) (Mul c9~78@ b9~76@)) d9~80@))) (=> (= tmp%10@ (= temp_9_0~1574@ temp_9_1~1611@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1663@ (Mul a10~82@ (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ d10~88@)) (Sub (Mul c10~86@ c10~86@) (Mul a10~82@ a10~82@))))) (=> (= temp_10_1~1700@ (Mul a10~82@ (Mul (Mul (Mul (Mul d10~88@ b10~84@) c10~86@) d10~88@) (Sub (Mul c10~86@ c10~86@) (Mul a10~82@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1663@ temp_10_1~1700@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1780@ (Add (Mul (Mul (Mul c11~94@ c11~94@) (Add a11~90@ c11~94@)) (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ b11~92@)) (Sub (Mul d11~96@ d11~96@) (Mul c11~94@ b11~92@))))) (=> (= temp_11_1~1845@ (Add (Mul (Mul (Mul c11~94@ c11~94@) (Add a11~90@ c11~94@)) (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ b11~92@)) (Sub (Mul d11~96@ d11~96@) (Mul b11~92@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1780@ temp_11_1~1845@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1901@ (Mul (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ b12~100@))) (Mul d12~104@ b12~100@))) (=> (= temp_12_1~1942@ (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ c12~102@)) (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ b12~100@)) (Mul d12~104@ b12~100@)))) (=> (= tmp%13@ (= temp_12_0~1901@ temp_12_1~1942@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2026@ (Mul (Mul (Add (Add c13~110@ c13~110@) (Mul c13~110@ 53)) (Mul (Mul b13~108@ b13~108@) a13~106@)) (Mul (Mul (Mul a13~106@ b13~108@) (Sub d13~112@ a13~106@)) (Mul b13~108@ (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~2095@ (Mul (Add (Add c13~110@ c13~110@) (Mul c13~110@ 53)) (Mul (Mul (Mul b13~108@ b13~108@) a13~106@) (Mul (Mul (Mul a13~106@ b13~108@) (Sub d13~112@ a13~106@)) (Mul b13~108@ (Mul d13~112@ c13~110@)))))) (=> (= tmp%14@ (= temp_13_0~2026@ temp_13_1~2095@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2171@ (Add (Mul (Sub (Mul d14~120@ d14~120@) (Mul c14~118@ c14~118@)) (Mul (Mul c14~118@ c14~118@) (Add d14~120@ c14~118@))) (Add (Sub (Mul a14~114@ d14~120@) (Mul d14~120@ a14~114@)) (Mul d14~120@ (Mul c14~118@ a14~114@))))) (=> (= temp_14_1~2232@ (Add (Mul (Sub (Mul d14~120@ d14~120@) (Mul c14~118@ c14~118@)) (Mul (Mul c14~118@ c14~118@) (Add d14~120@ c14~118@))) (Add (Sub (Mul a14~114@ d14~120@) (Mul d14~120@ a14~114@)) (Mul (Mul d14~120@ c14~118@) a14~114@)))) (=> (= tmp%15@ (= temp_14_0~2171@ temp_14_1~2232@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2312@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ b15~124@)) (Mul (Mul c15~126@ c15~126@) (Mul c15~126@ d15~128@))) (Mul (Mul (Mul c15~126@ d15~128@) (Mul c15~126@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~2377@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ b15~124@)) (Mul (Mul c15~126@ c15~126@) (Mul c15~126@ d15~128@))) (Mul (Mul (Mul (Mul c15~126@ d15~128@) (Mul c15~126@ b15~124@)) (Mul a15~122@ d15~128@)) (Mul c15~126@ a15~122@)))) (=> (= tmp%16@ (= temp_15_0~2312@ temp_15_1~2377@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2457@ (Mul (Mul (Sub (Mul d16~136@ c16~134@) (Mul c16~134@ b16~132@)) (Mul (Mul a16~130@ c16~134@) (Sub b16~132@ b16~132@))) (Mul (Mul (Add c16~134@ a16~130@) (Mul a16~130@ d16~136@)) (Mul (Add c16~134@ a16~130@) (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~2522@ (Mul (Mul (Sub (Mul d16~136@ c16~134@) (Mul c16~134@ b16~132@)) (Mul (Mul a16~130@ c16~134@) (Sub b16~132@ b16~132@))) (Mul (Mul (Mul (Add c16~134@ a16~130@) a16~130@) d16~136@) (Mul (Add c16~134@ a16~130@) (Mul b16~132@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2457@ temp_16_1~2522@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2614@ (Mul (Mul (Sub (Mul b17~140@ b17~140@) (Mul b17~140@ c17~142@)) (Sub (Mul c17~142@ c17~142@) (Mul b17~140@ a17~138@))) (Mul (Add (Mul d17~144@ b17~140@) (Mul 63 a17~138@)) (Mul (Mul c17~142@ b17~140@) (Mul d17~144@ c17~142@))))) (=> (= temp_17_1~2691@ (Mul (Mul (Add (Mul d17~144@ b17~140@) (Mul 63 a17~138@)) (Mul (Mul c17~142@ b17~140@) (Mul d17~144@ c17~142@))) (Mul (Sub (Mul b17~140@ b17~140@) (Mul b17~140@ c17~142@)) (Sub (Mul c17~142@ c17~142@) (Mul b17~140@ a17~138@))))) (=> (= tmp%18@ (= temp_17_0~2614@ temp_17_1~2691@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2771@ (Mul (Sub (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Mul d18~152@ d18~152@) (Mul a18~146@ a18~146@))) (Sub (Mul (Mul b18~148@ b18~148@) (Mul d18~152@ d18~152@)) (Mul (Mul a18~146@ c18~150@) (Add d18~152@ c18~150@))))) (=> (= temp_18_1~2836@ (Mul (Sub (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Mul d18~152@ d18~152@) (Mul a18~146@ a18~146@))) (Sub (Mul (Mul b18~148@ b18~148@) (Mul d18~152@ d18~152@)) (Mul (Mul a18~146@ c18~150@) (Add d18~152@ c18~150@))))) (=> (= tmp%19@ (= temp_18_0~2771@ temp_18_1~2836@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2916@ (Mul (Mul (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ a19~154@)) d19~160@) (Sub (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ d19~160@)) (Mul (Mul a19~154@ b19~156@) (Mul 95 d19~160@))))) (=> (= temp_19_1~2981@ (Mul (Mul (Mul c19~158@ (Mul c19~158@ (Mul a19~154@ a19~154@))) d19~160@) (Sub (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ d19~160@)) (Mul (Mul a19~154@ b19~156@) (Mul 95 d19~160@))))) (=> (= tmp%20@ (= temp_19_0~2916@ temp_19_1~2981@)) (=> %%location_label%%19 tmp%20@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
