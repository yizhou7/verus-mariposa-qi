...
(set-info :comment ";; mariposa_data/v_nl//3106586111090654302/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_10_1~1932@ Int)
...
(declare-const temp_13_1~2402@ Int)
(declare-const temp_14_0~2549@ Int)
(declare-const temp_14_1~2610@ Int)
(declare-const temp_15_0~2705@ Int)
(declare-const temp_15_1~2770@ Int)
(declare-const temp_16_0~2885@ Int)
(declare-const temp_16_1~2950@ Int)
(declare-const temp_17_0~3061@ Int)
(declare-const temp_17_1~3138@ Int)
(declare-const temp_18_0~3299@ Int)
(declare-const temp_18_1~3364@ Int)
(declare-const temp_19_0~3457@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Sub (Mul (Mul 27 b0~4@) (Mul b0~4@ b0~4@)) (Mul (Add a0~2@ c0~6@) (Sub a0~2@ d0~8@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ d0~8@))))) (=> (= temp_0_1~394@ (Mul (Sub (Mul (Mul (Mul 27 b0~4@) b0~4@) b0~4@) (Mul (Add a0~2@ c0~6@) (Sub a0~2@ d0~8@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ d0~8@))))) (and (=> (= tmp%1@ (Mul 27 b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b0~4@ b0~4@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@)))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~509@ (Add (Mul (Mul (Add b1~12@ d1~16@) 72) (Sub (Mul c1~14@ d1~16@) (Mul c1~14@ a1~10@))) (Mul (Add a1~10@ (Add c1~14@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~578@ (Add (Mul (Mul (Add b1~12@ d1~16@) 72) (Sub (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@))) (Mul (Add a1~10@ (Add c1~14@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ a1~10@) (=> %%location_label%%1 (= temp_1_0~509@ temp_1_1~578@))) (=> (= temp_1_0~509@ temp_1_1~578@) (=> (= temp_2_0~667@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@ a2~18@) a2~18@)) (Add (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~728@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@ a2~18@) a2~18@)) (Add (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ d2~24@) (=> %%location_label%%2 (= temp_2_0~667@ temp_2_1~728@))) (=> (= temp_2_0~667@ temp_2_1~728@) (=> (= temp_3_0~821@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~886@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ b3~28@) (=> %%location_label%%3 (= temp_3_0~821@ temp_3_1~886@))) (=> (= temp_3_0~821@ temp_3_1~886@) (=> (= temp_4_0~967@ (Mul (Mul b4~36@ (Mul (Mul a4~34@ d4~40@) (Add c4~38@ a4~34@))) (Add (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@)) (Add (Mul d4~40@ a4~34@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~1020@ (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Add c4~38@ a4~34@)) b4~36@) (Add (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@)) (Add (Mul d4~40@ a4~34@) (Mul d4~40@ c4~38@))))) (and (=> (= tmp%2@ (Mul (Mul a4~34@ d4~40@) (Add c4~38@ a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ tmp%2@) (=> %%location_label%%4 (= temp_4_0~967@ temp_4_1~1020@)))) (=> (= temp_4_0~967@ temp_4_1~1020@) (=> (= temp_5_0~1113@ (Add (Sub (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ b5~44@)) b5~44@) (Add (Mul (Mul c5~46@ b5~44@) (Add b5~44@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1166@ (Add (Sub (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ b5~44@)) b5~44@) (Add (Mul (Mul c5~46@ b5~44@) (Add b5~44@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1113@ temp_5_1~1166@))) (=> (= temp_5_0~1113@ temp_5_1~1166@) (=> (= temp_6_0~1283@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Mul 51 c6~54@) (Add 82 d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@)) (Add (Mul b6~52@ d6~56@) (Mul a6~50@ c6~54@))))) (=> (= temp_6_1~1372@ (Mul (Mul (Mul b6~52@ (Mul b6~52@ (Mul c6~54@ b6~52@))) (Mul (Mul 51 c6~54@) (Add 82 d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@)) (Add (Mul b6~52@ d6~56@) (Mul a6~50@ c6~54@))))) (and (=> (= tmp%3@ (Mul c6~54@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b6~52@ b6~52@ tmp%3@) (=> %%location_label%%6 (= temp_6_0~1283@ temp_6_1~1372@)))) (=> (= temp_6_0~1283@ temp_6_1~1372@) (=> (= temp_7_0~1447@ (Mul (Mul (Mul (Add d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@))) (Mul c7~62@ b7~60@))) (=> (= temp_7_1~1488@ (Mul (Mul c7~62@ b7~60@) (Mul (Mul (Add d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@))))) (and (=> (= tmp%4@ (Mul (Mul (Add d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@)))) (=> (= tmp%5@ (Mul c7~62@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%7 (= temp_7_0~1447@ temp_7_1~1488@))))) (=> (= temp_7_0~1447@ temp_7_1~1488@) (=> (= temp_8_0~1621@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Add (Add b8~68@ b8~68@) (Add c8~70@ a8~66@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ c8~70@)) (Mul a8~66@ (Mul a8~66@ 13))))) (=> (= temp_8_1~1694@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Add (Add b8~68@ b8~68@) (Add c8~70@ a8~66@))) (Mul (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)) (Mul a8~66@ (Mul a8~66@ 13))))) (and (=> (= tmp%6@ (Mul c8~70@ b8~68@)) (=> (= tmp%7@ (Mul d8~72@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%8 (= temp_8_0~1621@ temp_8_1~1694@))))) (=> (= temp_8_0~1621@ temp_8_1~1694@) (=> (= temp_9_0~1767@ (Mul (Mul (Sub (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Add d9~80@ c9~78@) (Mul c9~78@ b9~76@))) d9~80@)) (=> (= temp_9_1~1804@ (Mul (Sub (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul (Add d9~80@ c9~78@) (Mul c9~78@ b9~76@)) d9~80@))) (and (=> (= tmp%8@ (Sub (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@))) (=> (= tmp%9@ (Mul (Add d9~80@ c9~78@) (Mul c9~78@ b9~76@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ d9~80@) (=> %%location_label%%9 (= temp_9_0~1767@ temp_9_1~1804@))))) (=> (= temp_9_0~1767@ temp_9_1~1804@) (=> (= temp_10_0~1895@ (Mul a10~82@ (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ d10~88@)) (Sub (Mul c10~86@ c10~86@) (Mul a10~82@ a10~82@))))) (=> (= temp_10_1~1932@ (Mul a10~82@ (Mul (Mul (Mul (Mul d10~88@ b10~84@) c10~86@) d10~88@) (Sub (Mul c10~86@ c10~86@) (Mul a10~82@ a10~82@))))) (and (=> (= tmp%10@ (Mul d10~88@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ c10~86@ d10~88@) (=> %%location_label%%10 (= temp_10_0~1895@ temp_10_1~1932@)))) (=> (= temp_10_0~1895@ temp_10_1~1932@) (=> (= temp_11_0~2031@ (Add (Mul (Mul (Mul c11~94@ c11~94@) (Add a11~90@ c11~94@)) (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ b11~92@)) (Sub (Mul d11~96@ d11~96@) (Mul c11~94@ b11~92@))))) (=> (= temp_11_1~2096@ (Add (Mul (Mul (Mul c11~94@ c11~94@) (Add a11~90@ c11~94@)) (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ b11~92@)) (Sub (Mul d11~96@ d11~96@) (Mul b11~92@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c11~94@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2031@ temp_11_1~2096@))) (=> (= temp_11_0~2031@ temp_11_1~2096@) (=> (= temp_12_0~2165@ (Mul (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ b12~100@))) (Mul d12~104@ b12~100@))) (=> (= temp_12_1~2206@ (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ c12~102@)) (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ b12~100@)) (Mul d12~104@ b12~100@)))) (and (=> (= tmp%11@ (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ c12~102@))) (=> (= tmp%12@ (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ b12~100@))) (=> (= tmp%13@ (Mul d12~104@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%12 (= temp_12_0~2165@ temp_12_1~2206@)))))) (=> (= temp_12_0~2165@ temp_12_1~2206@) (=> (= temp_13_0~2333@ (Mul (Mul (Add (Add c13~110@ c13~110@) (Mul c13~110@ 53)) (Mul (Mul b13~108@ b13~108@) a13~106@)) (Mul (Mul (Mul a13~106@ b13~108@) (Sub d13~112@ a13~106@)) (Mul b13~108@ (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~2402@ (Mul (Add (Add c13~110@ c13~110@) (Mul c13~110@ 53)) (Mul (Mul (Mul b13~108@ b13~108@) a13~106@) (Mul (Mul (Mul a13~106@ b13~108@) (Sub d13~112@ a13~106@)) (Mul b13~108@ (Mul d13~112@ c13~110@)))))) (and (=> (= tmp%14@ (Add (Add c13~110@ c13~110@) (Mul c13~110@ 53))) (=> (= tmp%15@ (Mul (Mul b13~108@ b13~108@) a13~106@)) (=> (= tmp%16@ (Mul (Mul (Mul a13~106@ b13~108@) (Sub d13~112@ a13~106@)) (Mul b13~108@ (Mul d13~112@ c13~110@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%13 (= temp_13_0~2333@ temp_13_1~2402@)))))) (=> (= temp_13_0~2333@ temp_13_1~2402@) (=> (= temp_14_0~2549@ (Add (Mul (Sub (Mul d14~120@ d14~120@) (Mul c14~118@ c14~118@)) (Mul (Mul c14~118@ c14~118@) (Add d14~120@ c14~118@))) (Add (Sub (Mul a14~114@ d14~120@) (Mul d14~120@ a14~114@)) (Mul d14~120@ (Mul c14~118@ a14~114@))))) (=> (= temp_14_1~2610@ (Add (Mul (Sub (Mul d14~120@ d14~120@) (Mul c14~118@ c14~118@)) (Mul (Mul c14~118@ c14~118@) (Add d14~120@ c14~118@))) (Add (Sub (Mul a14~114@ d14~120@) (Mul d14~120@ a14~114@)) (Mul (Mul d14~120@ c14~118@) a14~114@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. d14~120@ c14~118@ a14~114@) (=> %%location_label%%14 (= temp_14_0~2549@ temp_14_1~2610@))) (=> (= temp_14_0~2549@ temp_14_1~2610@) (=> (= temp_15_0~2705@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ b15~124@)) (Mul (Mul c15~126@ c15~126@) (Mul c15~126@ d15~128@))) (Mul (Mul (Mul c15~126@ d15~128@) (Mul c15~126@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~2770@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ b15~124@)) (Mul (Mul c15~126@ c15~126@) (Mul c15~126@ d15~128@))) (Mul (Mul (Mul (Mul c15~126@ d15~128@) (Mul c15~126@ b15~124@)) (Mul a15~122@ d15~128@)) (Mul c15~126@ a15~122@)))) (and (=> (= tmp%17@ (Mul (Mul c15~126@ d15~128@) (Mul c15~126@ b15~124@))) (=> (= tmp%18@ (Mul a15~122@ d15~128@)) (=> (= tmp%19@ (Mul c15~126@ a15~122@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%15 (= temp_15_0~2705@ temp_15_1~2770@)))))) (=> (= temp_15_0~2705@ temp_15_1~2770@) (=> (= temp_16_0~2885@ (Mul (Mul (Sub (Mul d16~136@ c16~134@) (Mul c16~134@ b16~132@)) (Mul (Mul a16~130@ c16~134@) (Sub b16~132@ b16~132@))) (Mul (Mul (Add c16~134@ a16~130@) (Mul a16~130@ d16~136@)) (Mul (Add c16~134@ a16~130@) (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~2950@ (Mul (Mul (Sub (Mul d16~136@ c16~134@) (Mul c16~134@ b16~132@)) (Mul (Mul a16~130@ c16~134@) (Sub b16~132@ b16~132@))) (Mul (Mul (Mul (Add c16~134@ a16~130@) a16~130@) d16~136@) (Mul (Add c16~134@ a16~130@) (Mul b16~132@ a16~130@))))) (and (=> (= tmp%20@ (Add c16~134@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ a16~130@ d16~136@) (=> %%location_label%%16 (= temp_16_0~2885@ temp_16_1~2950@)))) (=> (= temp_16_0~2885@ temp_16_1~2950@) (=> (= temp_17_0~3061@ (Mul (Mul (Sub (Mul b17~140@ b17~140@) (Mul b17~140@ c17~142@)) (Sub (Mul c17~142@ c17~142@) (Mul b17~140@ a17~138@))) (Mul (Add (Mul d17~144@ b17~140@) (Mul 63 a17~138@)) (Mul (Mul c17~142@ b17~140@) (Mul d17~144@ c17~142@))))) (=> (= temp_17_1~3138@ (Mul (Mul (Add (Mul d17~144@ b17~140@) (Mul 63 a17~138@)) (Mul (Mul c17~142@ b17~140@) (Mul d17~144@ c17~142@))) (Mul (Sub (Mul b17~140@ b17~140@) (Mul b17~140@ c17~142@)) (Sub (Mul c17~142@ c17~142@) (Mul b17~140@ a17~138@))))) (and (=> (= tmp%21@ (Mul (Sub (Mul b17~140@ b17~140@) (Mul b17~140@ c17~142@)) (Sub (Mul c17~142@ c17~142@) (Mul b17~140@ a17~138@)))) (=> (= tmp%22@ (Mul (Add (Mul d17~144@ b17~140@) (Mul 63 a17~138@)) (Mul (Mul c17~142@ b17~140@) (Mul d17~144@ c17~142@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%17 (= temp_17_0~3061@ temp_17_1~3138@))))) (=> (= temp_17_0~3061@ temp_17_1~3138@) (=> (= temp_18_0~3299@ (Mul (Sub (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Mul d18~152@ d18~152@) (Mul a18~146@ a18~146@))) (Sub (Mul (Mul b18~148@ b18~148@) (Mul d18~152@ d18~152@)) (Mul (Mul a18~146@ c18~150@) (Add d18~152@ c18~150@))))) (=> (= temp_18_1~3364@ (Mul (Sub (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Mul d18~152@ d18~152@) (Mul a18~146@ a18~146@))) (Sub (Mul (Mul b18~148@ b18~148@) (Mul d18~152@ d18~152@)) (Mul (Mul a18~146@ c18~150@) (Add d18~152@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d18~152@ d18~152@) (=> %%location_label%%18 (= temp_18_0~3299@ temp_18_1~3364@))) (=> (= temp_18_0~3299@ temp_18_1~3364@) (=> (= temp_19_0~3457@ (Mul (Mul (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ a19~154@)) d19~160@) (Sub (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ d19~160@)) (Mul (Mul a19~154@ b19~156@) (Mul 95 d19~160@))))) (=> (= temp_19_1~3522@ (Mul (Mul (Mul c19~158@ (Mul c19~158@ (Mul a19~154@ a19~154@))) d19~160@) (Sub (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ d19~160@)) (Mul (Mul a19~154@ b19~156@) (Mul 95 d19~160@))))) (=> (= tmp%23@ (Mul a19~154@ a19~154@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c19~158@ c19~158@ tmp%23@) (=> %%location_label%%19 (= temp_19_0~3457@ temp_19_1~3522@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
