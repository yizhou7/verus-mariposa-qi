...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul c0~6@ (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ 65))) (Mul (Add (Sub b0~4@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ 79))))) (=> (= temp_0_1~422@ (Mul (Mul c0~6@ (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ 65))) (Add (Mul (Sub b0~4@ b0~4@) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ 79))) (Mul (Mul c0~6@ a0~2@) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ 79)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~422@))) (=> (= temp_0_0~317@ temp_0_1~422@) (=> (= temp_1_0~523@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@))) (Mul (Add (Add d1~16@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul 35 c1~14@))))) (=> (= temp_1_1~600@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@))) (Mul (Add (Add d1~16@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul 35 c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~523@ temp_1_1~600@))) (=> (= temp_1_0~523@ temp_1_1~600@) (=> (= temp_2_0~673@ (Mul d2~24@ (Add (Mul (Mul 84 b2~20@) (Mul a2~18@ c2~22@)) (Mul (Add a2~18@ a2~18@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~722@ (Mul d2~24@ (Add (Mul (Mul 84 b2~20@) (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Add a2~18@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~673@ temp_2_1~722@))) (=> (= temp_2_0~673@ temp_2_1~722@) (=> (= temp_3_0~807@ (Mul (Sub (Mul c3~30@ (Mul d3~32@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~868@ (Mul (Sub (Mul c3~30@ (Mul d3~32@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~807@ temp_3_1~868@))) (=> (= temp_3_0~807@ temp_3_1~868@) (=> (= temp_4_0~945@ (Sub (Mul (Sub (Sub c4~38@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ c4~38@)) a4~34@))) (=> (= temp_4_1~998@ (Sub (Mul (Sub (Sub c4~38@ c4~38@) (Mul b4~36@ a4~34@)) (Mul b4~36@ (Mul d4~40@ (Mul a4~34@ b4~36@)))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ c4~38@)) a4~34@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~945@ temp_4_1~998@))) (=> (= temp_4_0~945@ temp_4_1~998@) (=> (= temp_5_0~1087@ (Mul (Mul (Mul (Sub b5~44@ a5~42@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ c5~46@))) (Sub (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1152@ (Mul (Mul (Mul (Sub b5~44@ a5~42@) (Mul a5~42@ b5~44@)) (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ c5~46@))) (Sub (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1087@ temp_5_1~1152@))) (=> (= temp_5_0~1087@ temp_5_1~1152@) (=> (= temp_6_0~1233@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ a6~50@)) (Mul b6~52@ c6~54@)) (Sub (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1290@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ a6~50@)) (Mul b6~52@ c6~54@)) (Sub (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1233@ temp_6_1~1290@))) (=> (= temp_6_0~1233@ temp_6_1~1290@) (=> (= temp_7_0~1375@ (Mul (Add (Mul (Mul a7~58@ c7~62@) c7~62@) (Mul (Add c7~62@ a7~58@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ c7~62@))))) (=> (= temp_7_1~1436@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ c7~62@))) (Add (Mul (Mul a7~58@ c7~62@) c7~62@) (Mul (Add c7~62@ a7~58@) (Mul c7~62@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1375@ temp_7_1~1436@))) (=> (= temp_7_0~1375@ temp_7_1~1436@) (=> (= temp_8_0~1525@ (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Sub c8~70@ c8~70@)) (Add (Add d8~72@ d8~72@) (Mul a8~66@ b8~68@))) (Mul (Add (Mul d8~72@ c8~70@) (Add d8~72@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1590@ (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Sub c8~70@ c8~70@)) (Add (Add d8~72@ d8~72@) (Mul a8~66@ b8~68@))) (Mul (Add (Mul d8~72@ c8~70@) (Add d8~72@ b8~68@)) (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1525@ temp_8_1~1590@))) (=> (= temp_8_0~1525@ temp_8_1~1590@) (=> (= temp_9_0~1651@ (Mul (Mul (Mul c9~78@ (Mul a9~74@ d9~80@)) b9~76@) (Mul a9~74@ (Sub (Mul a9~74@ d9~80@) (Mul c9~78@ b9~76@))))) (=> (= temp_9_1~1688@ (Mul (Mul c9~78@ (Mul (Mul a9~74@ d9~80@) b9~76@)) (Mul a9~74@ (Sub (Mul a9~74@ d9~80@) (Mul c9~78@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1651@ temp_9_1~1688@))) (=> (= temp_9_0~1651@ temp_9_1~1688@) (=> (= temp_10_0~1761@ (Mul (Mul (Mul (Mul b10~84@ a10~82@) (Mul c10~86@ c10~86@)) (Add a10~82@ (Mul b10~84@ b10~84@))) (Mul d10~88@ (Mul (Add b10~84@ a10~82@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~1810@ (Mul (Mul (Mul (Mul b10~84@ a10~82@) (Mul c10~86@ c10~86@)) (Add a10~82@ (Mul b10~84@ b10~84@))) (Mul d10~88@ (Mul (Mul c10~86@ b10~84@) (Add b10~84@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1761@ temp_10_1~1810@))) (=> (= temp_10_0~1761@ temp_10_1~1810@) (=> (= temp_11_0~1895@ (Mul (Mul (Sub (Mul d11~96@ d11~96@) (Mul b11~92@ a11~90@)) (Mul c11~94@ (Mul c11~94@ b11~92@))) (Mul (Mul (Mul c11~94@ d11~96@) (Add d11~96@ c11~94@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ c11~94@))))) (=> (= temp_11_1~1956@ (Mul (Mul (Sub (Mul d11~96@ d11~96@) (Mul b11~92@ a11~90@)) (Mul c11~94@ (Mul c11~94@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ c11~94@)) (Mul (Mul c11~94@ d11~96@) (Add d11~96@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1895@ temp_11_1~1956@))) (=> (= temp_11_0~1895@ temp_11_1~1956@) (=> (= temp_12_0~2045@ (Mul (Mul (Mul (Mul a12~98@ d12~104@) (Mul b12~100@ a12~98@)) (Sub (Mul d12~104@ b12~100@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2110@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ a12~98@)) (Sub (Mul d12~104@ b12~100@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2045@ temp_12_1~2110@))) (=> (= temp_12_0~2045@ temp_12_1~2110@) (=> (= temp_13_0~2183@ (Mul (Mul b13~108@ (Mul (Mul b13~108@ d13~112@) c13~110@)) (Mul (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@)) (Mul (Mul c13~110@ b13~108@) (Mul b13~108@ a13~106@))))) (=> (= temp_13_1~2232@ (Mul (Mul b13~108@ (Mul (Mul b13~108@ d13~112@) c13~110@)) (Mul (Mul (Mul a13~106@ c13~110@) (Mul a13~106@ c13~110@)) (Mul (Mul c13~110@ b13~108@) (Mul b13~108@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2183@ temp_13_1~2232@))) (=> (= temp_13_0~2183@ temp_13_1~2232@) (=> (= temp_14_0~2309@ (Add (Sub d14~120@ (Mul (Add c14~118@ c14~118@) (Mul b14~116@ c14~118@))) (Mul (Mul (Mul b14~116@ a14~114@) (Sub b14~116@ c14~118@)) (Mul (Add d14~120@ c14~118@) (Add c14~118@ d14~120@))))) (=> (= temp_14_1~2362@ (Add (Sub d14~120@ (Mul (Add c14~118@ c14~118@) (Mul b14~116@ c14~118@))) (Mul (Mul (Add d14~120@ c14~118@) (Add c14~118@ d14~120@)) (Mul (Mul b14~116@ a14~114@) (Sub b14~116@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2309@ temp_14_1~2362@))) (=> (= temp_14_0~2309@ temp_14_1~2362@) (=> (= temp_15_0~2463@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Sub c15~126@ a15~122@)) (Mul (Mul b15~124@ c15~126@) (Sub c15~126@ b15~124@))) (Mul (Sub (Mul 75 c15~126@) (Mul b15~124@ a15~122@)) (Mul (Mul c15~126@ b15~124@) (Sub c15~126@ c15~126@))))) (=> (= temp_15_1~2540@ (Mul (Mul (Sub (Mul 75 c15~126@) (Mul b15~124@ a15~122@)) (Mul (Mul c15~126@ b15~124@) (Sub c15~126@ c15~126@))) (Mul (Mul (Mul c15~126@ c15~126@) (Sub c15~126@ a15~122@)) (Mul (Mul b15~124@ c15~126@) (Sub c15~126@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2463@ temp_15_1~2540@))) (=> (= temp_15_0~2463@ temp_15_1~2540@) (=> (= temp_16_0~2629@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul c16~134@ d16~136@)) (Mul (Mul d16~136@ b16~132@) (Mul a16~130@ d16~136@))) (Mul (Mul (Mul b16~132@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Sub d16~136@ b16~132@) (Sub d16~136@ d16~136@))))) (=> (= temp_16_1~2694@ (Mul (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul d16~136@ b16~132@) (Mul a16~130@ d16~136@))) (Mul (Mul (Mul b16~132@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Sub d16~136@ b16~132@) (Sub d16~136@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2629@ temp_16_1~2694@))) (=> (= temp_16_0~2629@ temp_16_1~2694@) (=> (= temp_17_0~2791@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) 50) (Mul (Add c17~142@ a17~138@) (Mul a17~138@ d17~144@))) (Mul (Mul (Mul b17~140@ d17~144@) (Sub a17~138@ c17~142@)) (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ b17~140@))))) (=> (= temp_17_1~2864@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) 50) (Mul (Add c17~142@ a17~138@) (Mul a17~138@ d17~144@))) (Mul (Mul (Mul b17~140@ d17~144@) (Sub a17~138@ c17~142@)) (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2791@ temp_17_1~2864@))) (=> (= temp_17_0~2791@ temp_17_1~2864@) (=> (= temp_18_0~2965@ (Mul (Sub (Sub (Mul c18~150@ c18~150@) (Mul c18~150@ b18~148@)) (Sub (Mul a18~146@ c18~150@) (Mul 2 d18~152@))) (Sub (Sub (Mul d18~152@ c18~150@) (Mul a18~146@ a18~146@)) (Mul (Mul b18~148@ b18~148@) (Mul d18~152@ c18~150@))))) (=> (= temp_18_1~3042@ (Mul (Sub (Sub (Mul c18~150@ c18~150@) (Mul c18~150@ b18~148@)) (Sub (Mul a18~146@ c18~150@) (Mul 2 d18~152@))) (Sub (Sub (Mul d18~152@ c18~150@) (Mul a18~146@ a18~146@)) (Mul (Mul b18~148@ b18~148@) (Mul d18~152@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2965@ temp_18_1~3042@))) (=> (= temp_18_0~2965@ temp_18_1~3042@) (=> (= temp_19_0~3127@ (Add (Mul (Sub a19~154@ (Mul a19~154@ d19~160@)) (Mul (Mul c19~158@ c19~158@) (Mul c19~158@ c19~158@))) (Mul (Mul (Mul c19~158@ c19~158@) (Mul c19~158@ d19~160@)) (Sub (Sub b19~156@ b19~156@) (Mul c19~158@ c19~158@))))) (=> (= temp_19_1~3188@ (Add (Mul (Sub a19~154@ (Mul a19~154@ d19~160@)) (Mul (Mul c19~158@ c19~158@) (Mul c19~158@ c19~158@))) (Mul (Mul (Mul c19~158@ c19~158@) (Mul c19~158@ d19~160@)) (Sub (Sub b19~156@ b19~156@) (Mul c19~158@ c19~158@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3127@ temp_19_1~3188@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
