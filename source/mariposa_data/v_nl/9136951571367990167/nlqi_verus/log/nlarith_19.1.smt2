...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ b0~4@)) (Add (Mul 75 c0~6@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ b0~4@)) (Add (Mul 75 c0~6@) (Mul d0~8@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~317@ temp_0_1~394@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~470@ (Mul (Mul (Mul (Sub c1~14@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@))) (Sub (Sub b1~12@ (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~531@ (Mul (Mul (Mul (Mul (Sub c1~14@ d1~16@) d1~16@) c1~14@) (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@))) (Sub (Sub b1~12@ (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~470@ temp_1_1~531@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~619@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Add b2~20@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ a2~18@))) (Add (Mul (Mul 77 a2~18@) a2~18@) (Mul (Add b2~20@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~692@ (Mul (Add (Mul (Mul 77 a2~18@) a2~18@) (Mul (Add b2~20@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul a2~18@ a2~18@) (Add b2~20@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~619@ temp_2_1~692@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~784@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Add b3~28@ d3~32@)) (Add (Sub b3~28@ c3~30@) (Mul c3~30@ b3~28@))) (Mul (Add (Mul a3~26@ d3~32@) (Mul b3~28@ 43)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~869@ (Mul (Mul (Add (Mul (Mul b3~28@ d3~32@) b3~28@) (Mul (Mul b3~28@ d3~32@) d3~32@)) (Add (Sub b3~28@ c3~30@) (Mul c3~30@ b3~28@))) (Mul (Add (Mul a3~26@ d3~32@) (Mul b3~28@ 43)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~784@ temp_3_1~869@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~949@ (Mul (Add (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@))) (Add (Mul (Sub c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Sub d4~40@ c4~38@))))) (=> (= temp_4_1~1014@ (Mul (Add (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@))) (Add (Mul (Sub c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul a4~34@ (Mul b4~36@ (Sub d4~40@ c4~38@)))))) (=> (= tmp%5@ (= temp_4_0~949@ temp_4_1~1014@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1094@ (Sub (Mul (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@)) (Sub (Mul a5~42@ a5~42@) (Add b5~44@ c5~46@))))) (=> (= temp_5_1~1159@ (Sub (Mul (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@)) (Sub (Mul a5~42@ a5~42@) (Add b5~44@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1094@ temp_5_1~1159@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1271@ (Mul (Mul (Add (Mul b6~52@ b6~52@) (Mul c6~54@ 94)) (Mul (Add a6~50@ a6~50@) (Mul a6~50@ 47))) (Mul (Mul (Mul d6~56@ 36) (Mul d6~56@ b6~52@)) (Mul (Add a6~50@ c6~54@) c6~54@)))) (=> (= temp_6_1~1368@ (Mul (Mul (Add (Mul b6~52@ b6~52@) (Mul c6~54@ 94)) (Mul (Add a6~50@ a6~50@) (Mul a6~50@ 47))) (Mul (Mul (Mul d6~56@ 36) (Mul d6~56@ b6~52@)) (Mul c6~54@ (Add a6~50@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1271@ temp_6_1~1368@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1448@ (Sub (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@)) (Sub (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@)) (Sub (Mul c7~62@ b7~60@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1509@ (Sub (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@)) (Mul (Sub a7~58@ c7~62@) c7~62@)) (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@)) (Sub (Mul c7~62@ b7~60@) (Mul d7~64@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1448@ temp_7_1~1509@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1601@ (Sub (Mul (Mul (Mul 99 a8~66@) (Sub b8~68@ c8~70@)) (Add (Mul c8~70@ b8~68@) (Add a8~66@ c8~70@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1678@ (Sub (Mul (Mul 99 a8~66@) (Mul (Sub b8~68@ c8~70@) (Add (Mul c8~70@ b8~68@) (Add a8~66@ c8~70@)))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1601@ temp_8_1~1678@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1758@ (Mul (Mul (Mul (Add a9~74@ c9~78@) (Sub a9~74@ b9~76@)) (Mul (Sub a9~74@ b9~76@) (Add d9~80@ a9~74@))) (Mul (Sub (Mul a9~74@ a9~74@) (Add a9~74@ d9~80@)) (Mul (Mul d9~80@ b9~76@) (Add b9~76@ d9~80@))))) (=> (= temp_9_1~1839@ (Mul (Mul (Mul (Add a9~74@ c9~78@) (Sub a9~74@ b9~76@)) (Mul (Sub a9~74@ b9~76@) (Add d9~80@ a9~74@))) (Sub (Mul (Mul a9~74@ a9~74@) (Mul (Mul d9~80@ b9~76@) (Add b9~76@ d9~80@))) (Mul (Add a9~74@ d9~80@) (Mul (Mul d9~80@ b9~76@) (Add b9~76@ d9~80@)))))) (=> (= tmp%10@ (= temp_9_0~1758@ temp_9_1~1839@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1919@ (Mul (Mul (Add (Sub a10~82@ d10~88@) (Mul c10~86@ c10~86@)) (Sub (Mul b10~84@ c10~86@) (Sub a10~82@ d10~88@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Add a10~82@ a10~82@) (Mul b10~84@ c10~86@))))) (=> (= temp_10_1~2000@ (Mul (Sub (Mul (Add (Sub a10~82@ d10~88@) (Mul c10~86@ c10~86@)) (Mul b10~84@ c10~86@)) (Mul (Add (Sub a10~82@ d10~88@) (Mul c10~86@ c10~86@)) (Sub a10~82@ d10~88@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Add a10~82@ a10~82@) (Mul b10~84@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1919@ temp_10_1~2000@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~2072@ (Mul (Mul (Sub 27 (Mul d11~96@ a11~90@)) (Mul a11~90@ (Mul c11~94@ d11~96@))) (Mul a11~90@ (Sub (Mul d11~96@ d11~96@) (Add a11~90@ d11~96@))))) (=> (= temp_11_1~2129@ (Mul (Mul (Sub 27 (Mul d11~96@ a11~90@)) (Mul a11~90@ (Mul c11~94@ d11~96@))) (Mul (Sub (Mul d11~96@ d11~96@) (Add a11~90@ d11~96@)) a11~90@))) (=> (= tmp%12@ (= temp_11_0~2072@ temp_11_1~2129@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2209@ (Add (Add (Mul (Mul d12~104@ a12~98@) (Sub d12~104@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul a12~98@ b12~100@))) (Sub (Mul (Add b12~100@ c12~102@) (Add a12~98@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@))))) (=> (= temp_12_1~2282@ (Add (Add (Sub (Mul (Mul d12~104@ a12~98@) d12~104@) (Mul (Mul d12~104@ a12~98@) d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul a12~98@ b12~100@))) (Sub (Mul (Add b12~100@ c12~102@) (Add a12~98@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@))))) (=> (= tmp%13@ (= temp_12_0~2209@ temp_12_1~2282@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2354@ (Sub (Mul (Mul (Add c13~110@ d13~112@) a13~106@) (Mul (Mul d13~112@ c13~110@) (Add d13~112@ a13~106@))) (Mul (Mul (Add a13~106@ d13~112@) (Mul a13~106@ a13~106@)) (Mul b13~108@ (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2419@ (Sub (Mul (Mul (Add c13~110@ d13~112@) a13~106@) (Add (Mul (Mul d13~112@ c13~110@) d13~112@) (Mul (Mul d13~112@ c13~110@) a13~106@))) (Mul (Mul (Add a13~106@ d13~112@) (Mul a13~106@ a13~106@)) (Mul b13~108@ (Mul d13~112@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2354@ temp_13_1~2419@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2499@ (Sub (Mul (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ d14~120@)) (Add (Mul b14~116@ d14~120@) (Add d14~120@ d14~120@))) (Sub (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@)) (Mul (Mul c14~118@ d14~120@) (Add a14~114@ b14~116@))))) (=> (= temp_14_1~2564@ (Sub (Mul (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ d14~120@)) (Add (Mul b14~116@ d14~120@) (Add d14~120@ d14~120@))) (Sub (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@)) (Mul (Mul c14~118@ d14~120@) (Add a14~114@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2499@ temp_14_1~2564@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2640@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Add a15~122@ b15~124@)) (Add (Mul c15~126@ c15~126@) (Mul a15~122@ b15~124@))) (Add (Mul (Sub c15~126@ b15~124@) c15~126@) (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ a15~122@))))) (=> (= temp_15_1~2701@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Add a15~122@ b15~124@)) (Add (Mul c15~126@ c15~126@) (Mul a15~122@ b15~124@))) (Add (Mul (Sub c15~126@ b15~124@) c15~126@) (Mul (Mul a15~122@ b15~124@) (Mul b15~124@ a15~122@))))) (=> (= tmp%16@ (= temp_15_0~2640@ temp_15_1~2701@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2781@ (Mul (Mul (Mul (Add d16~136@ d16~136@) (Mul a16~130@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ b16~132@))) (Mul (Mul (Sub b16~132@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~2846@ (Mul (Mul (Mul (Mul (Add d16~136@ d16~136@) (Mul a16~130@ b16~132@)) (Mul b16~132@ a16~130@)) (Mul b16~132@ b16~132@)) (Mul (Mul (Sub b16~132@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ d16~136@))))) (=> (= tmp%17@ (= temp_16_0~2781@ temp_16_1~2846@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2926@ (Mul (Mul (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ b17~140@)) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ c17~142@))) (Add (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ b17~140@)) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~2991@ (Mul (Mul (Mul (Mul (Mul c17~142@ a17~138@) c17~142@) b17~140@) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ c17~142@))) (Add (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ b17~140@)) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@))))) (=> (= tmp%18@ (= temp_17_0~2926@ temp_17_1~2991@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~3083@ (Mul (Mul (Sub (Mul c18~150@ d18~152@) (Mul d18~152@ b18~148@)) (Sub (Mul 80 c18~150@) (Mul a18~146@ d18~152@))) (Sub (Sub (Mul c18~150@ d18~152@) (Mul c18~150@ c18~150@)) (Mul (Mul d18~152@ b18~148@) (Mul a18~146@ b18~148@))))) (=> (= temp_18_1~3160@ (Mul (Mul (Sub (Mul c18~150@ d18~152@) (Mul d18~152@ b18~148@)) (Sub (Mul 80 c18~150@) (Mul a18~146@ d18~152@))) (Sub (Sub (Mul c18~150@ d18~152@) (Mul c18~150@ c18~150@)) (Mul (Mul d18~152@ b18~148@) (Mul b18~148@ a18~146@))))) (=> (= tmp%19@ (= temp_18_0~3083@ temp_18_1~3160@)) (=> %%location_label%%18 tmp%19@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
