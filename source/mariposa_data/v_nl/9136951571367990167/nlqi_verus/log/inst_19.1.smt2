...
(set-info :comment ";; mariposa_data/v_nl//9136951571367990167/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_3_1~978@ Int)
(declare-const temp_4_0~1077@ Int)
(declare-const temp_4_1~1142@ Int)
(declare-const temp_5_0~1241@ Int)
...
(declare-const temp_8_0~1793@ Int)
(declare-const temp_8_1~1870@ Int)
(declare-const temp_9_0~1997@ Int)
(declare-const temp_9_1~2078@ Int)
(declare-const temp_10_0~2193@ Int)
(declare-const temp_10_1~2274@ Int)
(declare-const temp_11_0~2381@ Int)
(declare-const temp_11_1~2438@ Int)
(declare-const temp_12_0~2543@ Int)
(declare-const temp_12_1~2616@ Int)
(declare-const temp_13_0~2707@ Int)
(declare-const temp_13_1~2772@ Int)
(declare-const temp_14_0~2871@ Int)
(declare-const temp_14_1~2936@ Int)
(declare-const temp_15_0~3025@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ b0~4@)) (Add (Mul 75 c0~6@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ b0~4@)) (Add (Mul 75 c0~6@) (Mul d0~8@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ c0~6@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~483@ (Mul (Mul (Mul (Sub c1~14@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@))) (Sub (Sub b1~12@ (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~544@ (Mul (Mul (Mul (Mul (Sub c1~14@ d1~16@) d1~16@) c1~14@) (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@))) (Sub (Sub b1~12@ (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@))))) (and (=> (= tmp%1@ (Sub c1~14@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~483@ temp_1_1~544@)))) (=> (= temp_1_0~483@ temp_1_1~544@) (=> (= temp_2_0~651@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Add b2~20@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ a2~18@))) (Add (Mul (Mul 77 a2~18@) a2~18@) (Mul (Add b2~20@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~724@ (Mul (Add (Mul (Mul 77 a2~18@) a2~18@) (Mul (Add b2~20@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul a2~18@ a2~18@) (Add b2~20@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ a2~18@))))) (and (=> (= tmp%2@ (Mul (Mul (Mul a2~18@ a2~18@) (Add b2~20@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ a2~18@)))) (=> (= tmp%3@ (Add (Mul (Mul 77 a2~18@) a2~18@) (Mul (Add b2~20@ d2~24@) (Mul b2~20@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~651@ temp_2_1~724@))))) (=> (= temp_2_0~651@ temp_2_1~724@) (=> (= temp_3_0~893@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Add b3~28@ d3~32@)) (Add (Sub b3~28@ c3~30@) (Mul c3~30@ b3~28@))) (Mul (Add (Mul a3~26@ d3~32@) (Mul b3~28@ 43)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~978@ (Mul (Mul (Add (Mul (Mul b3~28@ d3~32@) b3~28@) (Mul (Mul b3~28@ d3~32@) d3~32@)) (Add (Sub b3~28@ c3~30@) (Mul c3~30@ b3~28@))) (Mul (Add (Mul a3~26@ d3~32@) (Mul b3~28@ 43)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@))))) (and (=> (= tmp%4@ (Mul b3~28@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ b3~28@ d3~32@) (=> %%location_label%%3 (= temp_3_0~893@ temp_3_1~978@)))) (=> (= temp_3_0~893@ temp_3_1~978@) (=> (= temp_4_0~1077@ (Mul (Add (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@))) (Add (Mul (Sub c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Sub d4~40@ c4~38@))))) (=> (= temp_4_1~1142@ (Mul (Add (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@))) (Add (Mul (Sub c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul a4~34@ (Mul b4~36@ (Sub d4~40@ c4~38@)))))) (and (=> (= tmp%5@ (Sub d4~40@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a4~34@ b4~36@ tmp%5@) (=> %%location_label%%4 (= temp_4_0~1077@ temp_4_1~1142@)))) (=> (= temp_4_0~1077@ temp_4_1~1142@) (=> (= temp_5_0~1241@ (Sub (Mul (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@)) (Sub (Mul a5~42@ a5~42@) (Add b5~44@ c5~46@))))) (=> (= temp_5_1~1306@ (Sub (Mul (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@)) (Sub (Mul a5~42@ a5~42@) (Add b5~44@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1241@ temp_5_1~1306@))) (=> (= temp_5_0~1241@ temp_5_1~1306@) (=> (= temp_6_0~1431@ (Mul (Mul (Add (Mul b6~52@ b6~52@) (Mul c6~54@ 94)) (Mul (Add a6~50@ a6~50@) (Mul a6~50@ 47))) (Mul (Mul (Mul d6~56@ 36) (Mul d6~56@ b6~52@)) (Mul (Add a6~50@ c6~54@) c6~54@)))) (=> (= temp_6_1~1528@ (Mul (Mul (Add (Mul b6~52@ b6~52@) (Mul c6~54@ 94)) (Mul (Add a6~50@ a6~50@) (Mul a6~50@ 47))) (Mul (Mul (Mul d6~56@ 36) (Mul d6~56@ b6~52@)) (Mul c6~54@ (Add a6~50@ c6~54@))))) (and (=> (= tmp%6@ (Add a6~50@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1431@ temp_6_1~1528@)))) (=> (= temp_6_0~1431@ temp_6_1~1528@) (=> (= temp_7_0~1625@ (Sub (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@)) (Sub (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@)) (Sub (Mul c7~62@ b7~60@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1686@ (Sub (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@)) (Mul (Sub a7~58@ c7~62@) c7~62@)) (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@)) (Sub (Mul c7~62@ b7~60@) (Mul d7~64@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. a7~58@ c7~62@ c7~62@) (=> %%location_label%%7 (= temp_7_0~1625@ temp_7_1~1686@))) (=> (= temp_7_0~1625@ temp_7_1~1686@) (=> (= temp_8_0~1793@ (Sub (Mul (Mul (Mul 99 a8~66@) (Sub b8~68@ c8~70@)) (Add (Mul c8~70@ b8~68@) (Add a8~66@ c8~70@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1870@ (Sub (Mul (Mul 99 a8~66@) (Mul (Sub b8~68@ c8~70@) (Add (Mul c8~70@ b8~68@) (Add a8~66@ c8~70@)))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ d8~72@))))) (and (=> (= tmp%7@ (Mul 99 a8~66@)) (=> (= tmp%8@ (Sub b8~68@ c8~70@)) (=> (= tmp%9@ (Add (Mul c8~70@ b8~68@) (Add a8~66@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%8 (= temp_8_0~1793@ temp_8_1~1870@)))))) (=> (= temp_8_0~1793@ temp_8_1~1870@) (=> (= temp_9_0~1997@ (Mul (Mul (Mul (Add a9~74@ c9~78@) (Sub a9~74@ b9~76@)) (Mul (Sub a9~74@ b9~76@) (Add d9~80@ a9~74@))) (Mul (Sub (Mul a9~74@ a9~74@) (Add a9~74@ d9~80@)) (Mul (Mul d9~80@ b9~76@) (Add b9~76@ d9~80@))))) (=> (= temp_9_1~2078@ (Mul (Mul (Mul (Add a9~74@ c9~78@) (Sub a9~74@ b9~76@)) (Mul (Sub a9~74@ b9~76@) (Add d9~80@ a9~74@))) (Sub (Mul (Mul a9~74@ a9~74@) (Mul (Mul d9~80@ b9~76@) (Add b9~76@ d9~80@))) (Mul (Add a9~74@ d9~80@) (Mul (Mul d9~80@ b9~76@) (Add b9~76@ d9~80@)))))) (and (=> (= tmp%10@ (Mul a9~74@ a9~74@)) (=> (= tmp%11@ (Add a9~74@ d9~80@)) (=> (= tmp%12@ (Mul (Mul d9~80@ b9~76@) (Add b9~76@ d9~80@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%9 (= temp_9_0~1997@ temp_9_1~2078@)))))) (=> (= temp_9_0~1997@ temp_9_1~2078@) (=> (= temp_10_0~2193@ (Mul (Mul (Add (Sub a10~82@ d10~88@) (Mul c10~86@ c10~86@)) (Sub (Mul b10~84@ c10~86@) (Sub a10~82@ d10~88@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Add a10~82@ a10~82@) (Mul b10~84@ c10~86@))))) (=> (= temp_10_1~2274@ (Mul (Sub (Mul (Add (Sub a10~82@ d10~88@) (Mul c10~86@ c10~86@)) (Mul b10~84@ c10~86@)) (Mul (Add (Sub a10~82@ d10~88@) (Mul c10~86@ c10~86@)) (Sub a10~82@ d10~88@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Add a10~82@ a10~82@) (Mul b10~84@ c10~86@))))) (and (=> (= tmp%13@ (Add (Sub a10~82@ d10~88@) (Mul c10~86@ c10~86@))) (=> (= tmp%14@ (Mul b10~84@ c10~86@)) (=> (= tmp%15@ (Sub a10~82@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%10 (= temp_10_0~2193@ temp_10_1~2274@)))))) (=> (= temp_10_0~2193@ temp_10_1~2274@) (=> (= temp_11_0~2381@ (Mul (Mul (Sub 27 (Mul d11~96@ a11~90@)) (Mul a11~90@ (Mul c11~94@ d11~96@))) (Mul a11~90@ (Sub (Mul d11~96@ d11~96@) (Add a11~90@ d11~96@))))) (=> (= temp_11_1~2438@ (Mul (Mul (Sub 27 (Mul d11~96@ a11~90@)) (Mul a11~90@ (Mul c11~94@ d11~96@))) (Mul (Sub (Mul d11~96@ d11~96@) (Add a11~90@ d11~96@)) a11~90@))) (and (=> (= tmp%16@ (Sub (Mul d11~96@ d11~96@) (Add a11~90@ d11~96@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a11~90@ tmp%16@) (=> %%location_label%%11 (= temp_11_0~2381@ temp_11_1~2438@)))) (=> (= temp_11_0~2381@ temp_11_1~2438@) (=> (= temp_12_0~2543@ (Add (Add (Mul (Mul d12~104@ a12~98@) (Sub d12~104@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul a12~98@ b12~100@))) (Sub (Mul (Add b12~100@ c12~102@) (Add a12~98@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@))))) (=> (= temp_12_1~2616@ (Add (Add (Sub (Mul (Mul d12~104@ a12~98@) d12~104@) (Mul (Mul d12~104@ a12~98@) d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul a12~98@ b12~100@))) (Sub (Mul (Add b12~100@ c12~102@) (Add a12~98@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@))))) (and (=> (= tmp%17@ (Mul d12~104@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%17@ d12~104@ d12~104@) (=> %%location_label%%12 (= temp_12_0~2543@ temp_12_1~2616@)))) (=> (= temp_12_0~2543@ temp_12_1~2616@) (=> (= temp_13_0~2707@ (Sub (Mul (Mul (Add c13~110@ d13~112@) a13~106@) (Mul (Mul d13~112@ c13~110@) (Add d13~112@ a13~106@))) (Mul (Mul (Add a13~106@ d13~112@) (Mul a13~106@ a13~106@)) (Mul b13~108@ (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2772@ (Sub (Mul (Mul (Add c13~110@ d13~112@) a13~106@) (Add (Mul (Mul d13~112@ c13~110@) d13~112@) (Mul (Mul d13~112@ c13~110@) a13~106@))) (Mul (Mul (Add a13~106@ d13~112@) (Mul a13~106@ a13~106@)) (Mul b13~108@ (Mul d13~112@ a13~106@))))) (and (=> (= tmp%18@ (Mul d13~112@ c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%18@ d13~112@ a13~106@) (=> %%location_label%%13 (= temp_13_0~2707@ temp_13_1~2772@)))) (=> (= temp_13_0~2707@ temp_13_1~2772@) (=> (= temp_14_0~2871@ (Sub (Mul (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ d14~120@)) (Add (Mul b14~116@ d14~120@) (Add d14~120@ d14~120@))) (Sub (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@)) (Mul (Mul c14~118@ d14~120@) (Add a14~114@ b14~116@))))) (=> (= temp_14_1~2936@ (Sub (Mul (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ d14~120@)) (Add (Mul b14~116@ d14~120@) (Add d14~120@ d14~120@))) (Sub (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@)) (Mul (Mul c14~118@ d14~120@) (Add a14~114@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c14~118@ d14~120@) (=> %%location_label%%14 (= temp_14_0~2871@ temp_14_1~2936@))) (=> (= temp_14_0~2871@ temp_14_1~2936@) (=> (= temp_15_0~3025@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Add a15~122@ b15~124@)) (Add (Mul c15~126@ c15~126@) (Mul a15~122@ b15~124@))) (Add (Mul (Sub c15~126@ b15~124@) c15~126@) (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ a15~122@))))) (=> (= temp_15_1~3086@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Add a15~122@ b15~124@)) (Add (Mul c15~126@ c15~126@) (Mul a15~122@ b15~124@))) (Add (Mul (Sub c15~126@ b15~124@) c15~126@) (Mul (Mul a15~122@ b15~124@) (Mul b15~124@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b15~124@ a15~122@) (=> %%location_label%%15 (= temp_15_0~3025@ temp_15_1~3086@))) (=> (= temp_15_0~3025@ temp_15_1~3086@) (=> (= temp_16_0~3179@ (Mul (Mul (Mul (Add d16~136@ d16~136@) (Mul a16~130@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ b16~132@))) (Mul (Mul (Sub b16~132@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~3244@ (Mul (Mul (Mul (Mul (Add d16~136@ d16~136@) (Mul a16~130@ b16~132@)) (Mul b16~132@ a16~130@)) (Mul b16~132@ b16~132@)) (Mul (Mul (Sub b16~132@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ d16~136@))))) (and (=> (= tmp%19@ (Mul (Add d16~136@ d16~136@) (Mul a16~130@ b16~132@))) (=> (= tmp%20@ (Mul b16~132@ a16~130@)) (=> (= tmp%21@ (Mul b16~132@ b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%16 (= temp_16_0~3179@ temp_16_1~3244@)))))) (=> (= temp_16_0~3179@ temp_16_1~3244@) (=> (= temp_17_0~3359@ (Mul (Mul (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ b17~140@)) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ c17~142@))) (Add (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ b17~140@)) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~3424@ (Mul (Mul (Mul (Mul (Mul c17~142@ a17~138@) c17~142@) b17~140@) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ c17~142@))) (Add (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ b17~140@)) (Add (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@))))) (and (=> (= tmp%22@ (Mul c17~142@ a17~138@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ c17~142@ b17~140@) (=> %%location_label%%17 (= temp_17_0~3359@ temp_17_1~3424@)))) (=> (= temp_17_0~3359@ temp_17_1~3424@) (=> (= temp_18_0~3535@ (Mul (Mul (Sub (Mul c18~150@ d18~152@) (Mul d18~152@ b18~148@)) (Sub (Mul 80 c18~150@) (Mul a18~146@ d18~152@))) (Sub (Sub (Mul c18~150@ d18~152@) (Mul c18~150@ c18~150@)) (Mul (Mul d18~152@ b18~148@) (Mul a18~146@ b18~148@))))) (=> (= temp_18_1~3612@ (Mul (Mul (Sub (Mul c18~150@ d18~152@) (Mul d18~152@ b18~148@)) (Sub (Mul 80 c18~150@) (Mul a18~146@ d18~152@))) (Sub (Sub (Mul c18~150@ d18~152@) (Mul c18~150@ c18~150@)) (Mul (Mul d18~152@ b18~148@) (Mul b18~148@ a18~146@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a18~146@ b18~148@) (=> %%location_label%%18 (= temp_18_0~3535@ temp_18_1~3612@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
