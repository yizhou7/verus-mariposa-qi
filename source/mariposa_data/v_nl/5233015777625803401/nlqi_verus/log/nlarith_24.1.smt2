...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Sub (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ a0~2@))))) (=> (= temp_0_1~370@ (Add (Sub (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~450@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Add b1~12@ d1~16@) (Sub d1~16@ d1~16@))) (Mul (Sub (Mul c1~14@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~515@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Add b1~12@ d1~16@) (Sub d1~16@ d1~16@))) (Mul (Sub (Mul c1~14@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~450@ temp_1_1~515@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~591@ (Mul (Mul (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Add c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul c2~22@ (Mul a2~18@ d2~24@)) (Sub (Mul c2~22@ b2~20@) (Add a2~18@ d2~24@))))) (=> (= temp_2_1~652@ (Mul (Mul (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Add c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul c2~22@ (Mul (Mul a2~18@ d2~24@) (Sub (Mul c2~22@ b2~20@) (Add a2~18@ d2~24@)))))) (=> (= tmp%3@ (= temp_2_0~591@ temp_2_1~652@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~728@ (Mul (Mul (Mul a3~26@ (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~789@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul a3~26@ (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~728@ temp_3_1~789@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~889@ (Mul (Mul (Add b4~36@ (Add b4~36@ a4~34@)) (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@))) (Add (Mul (Mul b4~36@ c4~38@) (Mul 43 b4~36@)) (Sub (Mul 29 b4~36@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~974@ (Mul (Mul (Add b4~36@ (Add b4~36@ a4~34@)) (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@))) (Add (Mul (Mul b4~36@ c4~38@) (Mul 43 b4~36@)) (Sub (Mul 29 b4~36@) (Mul d4~40@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~889@ temp_4_1~974@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1054@ (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Add b5~44@ a5~42@)) (Sub (Mul d5~48@ d5~48@) (Mul d5~48@ a5~42@))) (Mul (Add (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1119@ (Mul (Mul (Mul d5~48@ c5~46@) (Mul (Add b5~44@ a5~42@) (Sub (Mul d5~48@ d5~48@) (Mul d5~48@ a5~42@)))) (Mul (Add (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1054@ temp_5_1~1119@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1187@ (Add (Mul (Mul (Add c6~54@ d6~56@) (Mul b6~52@ a6~50@)) c6~54@) (Mul (Mul (Mul c6~54@ a6~50@) (Sub c6~54@ c6~54@)) (Sub (Add a6~50@ a6~50@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1240@ (Add (Mul (Mul (Add c6~54@ d6~56@) (Mul b6~52@ a6~50@)) c6~54@) (Mul (Sub (Add a6~50@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Sub c6~54@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1187@ temp_6_1~1240@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1308@ (Mul (Mul d7~64@ (Add (Sub c7~62@ d7~64@) (Add b7~60@ b7~60@))) (Mul (Mul (Sub a7~58@ c7~62@) (Sub c7~62@ d7~64@)) (Add (Mul b7~60@ d7~64@) (Mul d7~64@ c7~62@))))) (=> (= temp_7_1~1361@ (Mul (Mul (Mul (Sub a7~58@ c7~62@) (Sub c7~62@ d7~64@)) (Add (Mul b7~60@ d7~64@) (Mul d7~64@ c7~62@))) (Mul d7~64@ (Add (Sub c7~62@ d7~64@) (Add b7~60@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1308@ temp_7_1~1361@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1477@ (Mul (Sub (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ a8~66@)) (Sub (Mul a8~66@ b8~68@) (Mul 18 b8~68@))) (Sub (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul 49 d8~72@) (Mul 22 b8~68@))))) (=> (= temp_8_1~1578@ (Mul (Sub (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ a8~66@)) (Sub (Mul a8~66@ b8~68@) (Mul 18 b8~68@))) (Sub (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul 49 d8~72@) (Mul 22 b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1477@ temp_8_1~1578@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1654@ (Mul (Mul (Mul a9~74@ (Mul b9~76@ a9~74@)) (Sub (Add c9~78@ a9~74@) (Mul c9~78@ d9~80@))) (Mul (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ c9~78@)) (Mul (Add a9~74@ b9~76@) (Sub c9~78@ b9~76@))))) (=> (= temp_9_1~1723@ (Mul (Mul (Mul a9~74@ (Mul b9~76@ a9~74@)) (Sub (Add c9~78@ a9~74@) (Mul c9~78@ d9~80@))) (Mul (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ c9~78@)) (Sub (Mul (Add a9~74@ b9~76@) c9~78@) (Mul (Add a9~74@ b9~76@) b9~76@))))) (=> (= tmp%10@ (= temp_9_0~1654@ temp_9_1~1723@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1803@ (Sub (Mul (Add (Add c10~86@ d10~88@) (Mul a10~82@ b10~84@)) (Mul (Add d10~88@ d10~88@) (Sub d10~88@ d10~88@))) (Add (Mul (Mul b10~84@ c10~86@) (Mul a10~82@ c10~86@)) (Mul (Mul b10~84@ d10~88@) (Add b10~84@ a10~82@))))) (=> (= temp_10_1~1876@ (Sub (Mul (Add (Add c10~86@ d10~88@) (Mul a10~82@ b10~84@)) (Mul (Add d10~88@ d10~88@) (Sub d10~88@ d10~88@))) (Add (Mul (Mul b10~84@ c10~86@) (Mul a10~82@ c10~86@)) (Add (Mul (Mul b10~84@ d10~88@) b10~84@) (Mul (Mul b10~84@ d10~88@) a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1803@ temp_10_1~1876@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1928@ (Mul b11~92@ (Add (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ a11~90@)) (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ b11~92@))))) (=> (= temp_11_1~1965@ (Mul b11~92@ (Add (Mul (Mul (Mul c11~94@ c11~94@) c11~94@) a11~90@) (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1928@ temp_11_1~1965@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2013@ (Mul (Mul (Sub (Sub b12~100@ d12~104@) (Sub b12~100@ b12~100@)) (Mul b12~100@ (Sub a12~98@ a12~98@))) b12~100@)) (=> (= temp_12_1~2050@ (Mul (Mul (Sub (Sub b12~100@ d12~104@) (Sub b12~100@ b12~100@)) (Sub (Mul b12~100@ a12~98@) (Mul b12~100@ a12~98@))) b12~100@)) (=> (= tmp%13@ (= temp_12_0~2013@ temp_12_1~2050@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2106@ (Sub (Mul a13~106@ (Mul (Mul b13~108@ a13~106@) (Mul d13~112@ c13~110@))) (Mul d13~112@ (Mul (Add d13~112@ c13~110@) (Add d13~112@ c13~110@))))) (=> (= temp_13_1~2147@ (Sub (Mul a13~106@ (Mul (Mul b13~108@ a13~106@) (Mul d13~112@ c13~110@))) (Mul d13~112@ (Mul (Add d13~112@ c13~110@) (Add d13~112@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2106@ temp_13_1~2147@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2223@ (Mul (Sub (Mul (Mul c14~118@ c14~118@) (Add c14~118@ b14~116@)) (Mul (Mul d14~120@ c14~118@) d14~120@)) (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ a14~114@))))) (=> (= temp_14_1~2316@ (Sub (Mul (Mul (Mul c14~118@ c14~118@) (Add c14~118@ b14~116@)) (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ a14~114@)))) (Mul (Mul (Mul d14~120@ c14~118@) d14~120@) (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ a14~114@)))))) (=> (= tmp%15@ (= temp_14_0~2223@ temp_14_1~2316@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2384@ (Mul (Sub (Mul (Mul d15~128@ c15~126@) (Mul a15~122@ b15~124@)) (Mul (Mul b15~124@ c15~126@) (Mul c15~126@ b15~124@))) (Mul d15~128@ (Mul (Sub d15~128@ d15~128@) (Add b15~124@ b15~124@))))) (=> (= temp_15_1~2437@ (Mul (Sub (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ a15~122@)) (Mul (Mul b15~124@ c15~126@) (Mul c15~126@ b15~124@))) (Mul d15~128@ (Mul (Sub d15~128@ d15~128@) (Add b15~124@ b15~124@))))) (=> (= tmp%16@ (= temp_15_0~2384@ temp_15_1~2437@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2529@ (Mul (Mul (Mul (Mul 96 b16~132@) (Mul c16~134@ d16~136@)) (Mul (Mul d16~136@ c16~134@) (Sub b16~132@ c16~134@))) (Mul (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ b16~132@)) (Mul (Add c16~134@ b16~132@) (Mul d16~136@ c16~134@))))) (=> (= temp_16_1~2606@ (Mul (Mul (Mul (Mul 96 b16~132@) (Mul c16~134@ d16~136@)) (Mul (Mul d16~136@ c16~134@) (Sub b16~132@ c16~134@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ a16~130@)) (Mul (Add c16~134@ b16~132@) (Mul d16~136@ c16~134@))))) (=> (= tmp%17@ (= temp_16_0~2529@ temp_16_1~2606@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2682@ (Mul (Mul (Mul (Mul b17~140@ b17~140@) (Sub c17~142@ c17~142@)) (Mul (Mul c17~142@ b17~140@) b17~140@)) (Mul (Add (Add a17~138@ c17~142@) (Mul c17~142@ b17~140@)) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ a17~138@))))) (=> (= temp_17_1~2751@ (Mul (Mul (Sub (Mul (Mul b17~140@ b17~140@) c17~142@) (Mul (Mul b17~140@ b17~140@) c17~142@)) (Mul (Mul c17~142@ b17~140@) b17~140@)) (Mul (Add (Add a17~138@ c17~142@) (Mul c17~142@ b17~140@)) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ a17~138@))))) (=> (= tmp%18@ (= temp_17_0~2682@ temp_17_1~2751@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2831@ (Sub (Mul (Mul (Mul d18~152@ a18~146@) (Mul d18~152@ c18~150@)) (Mul (Mul c18~150@ d18~152@) (Sub a18~146@ b18~148@))) (Mul (Add (Add c18~150@ b18~148@) (Mul d18~152@ b18~148@)) (Mul (Mul a18~146@ a18~146@) (Mul b18~148@ a18~146@))))) (=> (= temp_18_1~2896@ (Sub (Mul (Mul (Mul (Mul d18~152@ a18~146@) (Mul d18~152@ c18~150@)) (Mul c18~150@ d18~152@)) (Sub a18~146@ b18~148@)) (Mul (Add (Add c18~150@ b18~148@) (Mul d18~152@ b18~148@)) (Mul (Mul a18~146@ a18~146@) (Mul b18~148@ a18~146@))))) (=> (= tmp%19@ (= temp_18_0~2831@ temp_18_1~2896@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2976@ (Mul (Mul (Mul (Mul d19~160@ a19~154@) (Mul a19~154@ a19~154@)) (Mul (Mul c19~158@ a19~154@) (Mul c19~158@ c19~158@))) (Mul (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ d19~160@)) (Mul (Sub c19~158@ c19~158@) (Mul d19~160@ a19~154@))))) (=> (= temp_19_1~3041@ (Mul (Mul (Mul (Mul c19~158@ a19~154@) (Mul c19~158@ c19~158@)) (Mul (Mul d19~160@ a19~154@) (Mul a19~154@ a19~154@))) (Mul (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ d19~160@)) (Mul (Sub c19~158@ c19~158@) (Mul d19~160@ a19~154@))))) (=> (= tmp%20@ (= temp_19_0~2976@ temp_19_1~3041@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3133@ (Sub (Add (Mul (Mul c20~166@ b20~164@) (Add a20~162@ b20~164@)) (Mul (Mul c20~166@ d20~168@) (Mul a20~162@ c20~166@))) (Mul (Mul (Mul c20~166@ d20~168@) (Sub d20~168@ 74)) (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ a20~162@))))) (=> (= temp_20_1~3210@ (Sub (Add (Mul (Mul c20~166@ b20~164@) (Add a20~162@ b20~164@)) (Mul (Mul c20~166@ d20~168@) (Mul a20~162@ c20~166@))) (Mul (Mul (Mul c20~166@ d20~168@) (Sub d20~168@ 74)) (Mul (Mul b20~164@ a20~162@) (Mul a20~162@ a20~162@))))) (=> (= tmp%21@ (= temp_20_0~3133@ temp_20_1~3210@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3290@ (Add (Mul (Mul (Add a21~170@ d21~176@) (Add a21~170@ b21~172@)) (Mul (Mul c21~174@ b21~172@) (Mul c21~174@ a21~170@))) (Mul (Mul (Mul c21~174@ b21~172@) (Mul b21~172@ b21~172@)) (Mul (Add d21~176@ a21~170@) (Mul c21~174@ d21~176@))))) (=> (= temp_21_1~3355@ (Add (Mul (Mul (Add a21~170@ d21~176@) (Add a21~170@ b21~172@)) (Mul (Mul c21~174@ b21~172@) (Mul c21~174@ a21~170@))) (Mul (Mul (Mul c21~174@ b21~172@) (Mul b21~172@ b21~172@)) (Mul (Add d21~176@ a21~170@) (Mul d21~176@ c21~174@))))) (=> (= tmp%22@ (= temp_21_0~3290@ temp_21_1~3355@)) (and (=> %%location_label%%21 tmp%22@) (=> tmp%22@ (=> (= temp_22_0~3447@ (Mul (Mul (Mul (Mul d22~184@ c22~182@) (Add d22~184@ a22~178@)) (Mul (Add a22~178@ b22~180@) (Mul a22~178@ 15))) (Mul (Mul (Mul a22~178@ c22~182@) (Mul c22~182@ b22~180@)) (Sub (Mul d22~184@ d22~184@) (Mul c22~182@ b22~180@))))) (=> (= temp_22_1~3540@ (Mul (Mul (Mul (Mul d22~184@ c22~182@) (Add d22~184@ a22~178@)) (Mul (Add a22~178@ b22~180@) (Mul a22~178@ 15))) (Sub (Mul (Mul (Mul a22~178@ c22~182@) (Mul c22~182@ b22~180@)) (Mul d22~184@ d22~184@)) (Mul (Mul (Mul a22~178@ c22~182@) (Mul c22~182@ b22~180@)) (Mul c22~182@ b22~180@))))) (=> (= tmp%23@ (= temp_22_0~3447@ temp_22_1~3540@)) (and (=> %%location_label%%22 tmp%23@) (=> tmp%23@ (=> (= temp_23_0~3604@ (Mul (Mul (Mul (Add a23~186@ b23~188@) (Mul c23~190@ b23~188@)) (Sub (Mul b23~188@ b23~188@) (Mul a23~186@ c23~190@))) (Mul (Mul (Mul b23~188@ c23~190@) b23~188@) a23~186@))) (=> (= temp_23_1~3653@ (Mul (Mul (Mul (Add a23~186@ b23~188@) (Mul c23~190@ b23~188@)) (Sub (Mul b23~188@ b23~188@) (Mul c23~190@ a23~186@))) (Mul (Mul (Mul b23~188@ c23~190@) b23~188@) a23~186@))) (=> (= tmp%24@ (= temp_23_0~3604@ temp_23_1~3653@)) (=> %%location_label%%23 tmp%24@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
