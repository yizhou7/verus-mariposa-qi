...
(assert (=> %%query%% (not (=> (= temp_0_0~281@ (Mul (Mul d0~8@ (Mul (Mul c0~6@ b0~4@) (Sub c0~6@ d0~8@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ c0~6@)) b0~4@))) (=> (= temp_0_1~322@ (Mul (Mul d0~8@ (Mul (Mul c0~6@ b0~4@) (Sub c0~6@ d0~8@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ c0~6@)) b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~281@ temp_0_1~322@))) (=> (= temp_0_0~281@ temp_0_1~322@) (=> (= temp_1_0~423@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ d1~16@)) (Add (Mul a1~10@ d1~16@) (Mul b1~12@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul 32 c1~14@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~500@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ d1~16@)) (Add (Mul a1~10@ d1~16@) (Mul b1~12@ a1~10@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul 32 c1~14@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~423@ temp_1_1~500@))) (=> (= temp_1_0~423@ temp_1_1~500@) (=> (= temp_2_0~593@ (Sub (Add (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ 96)) (Mul a2~18@ d2~24@)) (Mul (Mul (Mul b2~20@ a2~18@) (Sub a2~18@ b2~20@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~662@ (Sub (Add (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ 96)) (Mul a2~18@ d2~24@)) (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Sub a2~18@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~593@ temp_2_1~662@))) (=> (= temp_2_0~593@ temp_2_1~662@) (=> (= temp_3_0~739@ (Mul (Sub (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@))) (Mul (Add (Add a3~26@ d3~32@) (Mul a3~26@ c3~30@)) a3~26@))) (=> (= temp_3_1~792@ (Mul (Mul (Add (Add a3~26@ d3~32@) (Mul a3~26@ c3~30@)) a3~26@) (Sub (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~739@ temp_3_1~792@))) (=> (= temp_3_0~739@ temp_3_1~792@) (=> (= temp_4_0~893@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Add d4~40@ a4~34@) (Mul d4~40@ b4~36@))) (Sub (Mul (Mul a4~34@ d4~40@) (Add b4~36@ a4~34@)) (Mul (Mul 37 c4~38@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~978@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Add d4~40@ a4~34@) (Mul d4~40@ b4~36@))) (Sub (Add (Mul (Mul a4~34@ d4~40@) b4~36@) (Mul (Mul a4~34@ d4~40@) a4~34@)) (Mul (Mul 37 c4~38@) (Mul b4~36@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~893@ temp_4_1~978@))) (=> (= temp_4_0~893@ temp_4_1~978@) (=> (= temp_5_0~1067@ (Mul (Sub (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul b5~44@ d5~48@) (Add c5~46@ d5~48@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@))))) (=> (= temp_5_1~1132@ (Mul (Sub (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ a5~42@))) (Mul (Mul (Add c5~46@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1067@ temp_5_1~1132@))) (=> (= temp_5_0~1067@ temp_5_1~1132@) (=> (= temp_6_0~1217@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) b6~52@) (Mul (Mul b6~52@ b6~52@) (Sub a6~50@ b6~52@))) (Mul (Mul (Sub a6~50@ d6~56@) (Add b6~52@ a6~50@)) (Mul (Add a6~50@ b6~52@) (Sub a6~50@ b6~52@))))) (=> (= temp_6_1~1278@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) b6~52@) (Mul (Mul b6~52@ b6~52@) (Sub a6~50@ b6~52@))) (Mul (Mul (Add b6~52@ a6~50@) (Sub a6~50@ d6~56@)) (Mul (Add a6~50@ b6~52@) (Sub a6~50@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1217@ temp_6_1~1278@))) (=> (= temp_6_0~1217@ temp_6_1~1278@) (=> (= temp_7_0~1367@ (Mul (Mul (Mul (Sub b7~60@ c7~62@) (Add c7~62@ a7~58@)) (Mul (Sub b7~60@ a7~58@) (Mul c7~62@ d7~64@))) (Sub (Sub (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@)) (Sub (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1432@ (Mul (Mul (Mul (Sub b7~60@ c7~62@) (Add c7~62@ a7~58@)) (Mul (Sub b7~60@ a7~58@) (Mul c7~62@ d7~64@))) (Sub (Sub (Mul d7~64@ b7~60@) (Mul c7~62@ c7~62@)) (Sub (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1367@ temp_7_1~1432@))) (=> (= temp_7_0~1367@ temp_7_1~1432@) (=> (= temp_8_0~1497@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ d8~72@)) b8~68@) (Mul c8~70@ (Add (Mul c8~70@ a8~66@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1538@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ d8~72@)) b8~68@) (Mul c8~70@ (Add (Mul c8~70@ a8~66@) (Mul c8~70@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1497@ temp_8_1~1538@))) (=> (= temp_8_0~1497@ temp_8_1~1538@) (=> (= temp_9_0~1623@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Sub d9~80@ b9~76@)) (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ b9~76@))) (Mul (Mul (Sub d9~80@ c9~78@) (Mul d9~80@ d9~80@)) (Mul d9~80@ (Mul b9~76@ b9~76@))))) (=> (= temp_9_1~1692@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Sub d9~80@ b9~76@)) (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ b9~76@))) (Mul (Sub (Mul d9~80@ (Mul d9~80@ d9~80@)) (Mul c9~78@ (Mul d9~80@ d9~80@))) (Mul d9~80@ (Mul b9~76@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1623@ temp_9_1~1692@))) (=> (= temp_9_0~1623@ temp_9_1~1692@) (=> (= temp_10_0~1745@ (Add (Mul (Mul (Mul a10~82@ a10~82@) d10~88@) (Sub b10~84@ (Mul d10~88@ a10~82@))) d10~88@)) (=> (= temp_10_1~1774@ (Add (Mul (Mul (Mul a10~82@ a10~82@) d10~88@) (Sub b10~84@ (Mul d10~88@ a10~82@))) d10~88@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1745@ temp_10_1~1774@))) (=> (= temp_10_0~1745@ temp_10_1~1774@) (=> (= temp_11_0~1831@ (Mul (Mul (Mul (Mul d11~96@ d11~96@) (Mul b11~92@ c11~94@)) (Mul c11~94@ (Add b11~92@ c11~94@))) b11~92@)) (=> (= temp_11_1~1868@ (Mul (Mul (Mul (Mul d11~96@ d11~96@) (Mul b11~92@ c11~94@)) (Add (Mul c11~94@ b11~92@) (Mul c11~94@ c11~94@))) b11~92@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1831@ temp_11_1~1868@))) (=> (= temp_11_0~1831@ temp_11_1~1868@) (=> (= temp_12_0~1969@ (Mul (Add (Mul (Mul a12~98@ a12~98@) (Mul d12~104@ c12~102@)) (Add (Sub c12~102@ c12~102@) (Mul c12~102@ b12~100@))) (Mul (Add (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@)) (Add (Add 98 a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2046@ (Mul (Add (Mul (Mul a12~98@ a12~98@) (Mul d12~104@ c12~102@)) (Add (Sub c12~102@ c12~102@) (Mul c12~102@ b12~100@))) (Mul (Add (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@)) (Add (Add 98 a12~98@) (Mul c12~102@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~1969@ temp_12_1~2046@))) (=> (= temp_12_0~1969@ temp_12_1~2046@) (=> (= temp_13_0~2135@ (Sub (Mul (Mul (Mul d13~112@ d13~112@) (Mul a13~106@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ a13~106@))) (Mul (Mul (Mul c13~110@ a13~106@) (Mul a13~106@ b13~108@)) (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ a13~106@))))) (=> (= temp_13_1~2200@ (Sub (Mul (Mul (Mul (Mul d13~112@ d13~112@) (Mul a13~106@ d13~112@)) (Mul c13~110@ c13~110@)) (Mul a13~106@ a13~106@)) (Mul (Mul (Mul c13~110@ a13~106@) (Mul a13~106@ b13~108@)) (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2135@ temp_13_1~2200@))) (=> (= temp_13_0~2135@ temp_13_1~2200@) (=> (= temp_14_0~2285@ (Mul (Mul (Mul (Mul d14~120@ d14~120@) (Mul a14~114@ a14~114@)) (Mul b14~116@ (Mul c14~118@ a14~114@))) (Add (Sub (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ a14~114@))))) (=> (= temp_14_1~2346@ (Mul (Mul (Mul d14~120@ d14~120@) (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ (Mul c14~118@ a14~114@)))) (Add (Sub (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2285@ temp_14_1~2346@))) (=> (= temp_14_0~2285@ temp_14_1~2346@) (=> (= temp_15_0~2427@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) a15~122@) (Mul (Mul a15~122@ c15~126@) (Mul c15~126@ b15~124@))) (Mul (Mul (Mul a15~122@ d15~128@) (Add d15~128@ a15~122@)) (Mul a15~122@ (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~2484@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) a15~122@) (Mul (Mul a15~122@ c15~126@) (Mul c15~126@ b15~124@))) (Mul (Mul (Mul d15~128@ a15~122@) (Add d15~128@ a15~122@)) (Mul a15~122@ (Mul d15~128@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2427@ temp_15_1~2484@))) (=> (= temp_15_0~2427@ temp_15_1~2484@) (=> (= temp_16_0~2561@ (Mul (Mul (Mul (Add d16~136@ a16~130@) (Mul a16~130@ b16~132@)) (Add (Mul a16~130@ c16~134@) (Mul a16~130@ c16~134@))) (Mul d16~136@ (Mul (Mul c16~134@ c16~134@) (Mul d16~136@ c16~134@))))) (=> (= temp_16_1~2614@ (Mul (Mul (Add (Mul a16~130@ c16~134@) (Mul a16~130@ c16~134@)) (Mul (Add d16~136@ a16~130@) (Mul a16~130@ b16~132@))) (Mul d16~136@ (Mul (Mul c16~134@ c16~134@) (Mul d16~136@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2561@ temp_16_1~2614@))) (=> (= temp_16_0~2561@ temp_16_1~2614@) (=> (= temp_17_0~2699@ (Mul (Mul (Add (Sub b17~140@ c17~142@) (Mul c17~142@ b17~140@)) (Mul d17~144@ (Mul c17~142@ a17~138@))) (Sub (Mul (Mul a17~138@ c17~142@) (Mul d17~144@ a17~138@)) (Mul (Mul c17~142@ d17~144@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~2760@ (Mul (Mul (Add (Sub b17~140@ c17~142@) (Mul c17~142@ b17~140@)) (Mul d17~144@ (Mul c17~142@ a17~138@))) (Sub (Mul (Mul a17~138@ c17~142@) (Mul d17~144@ a17~138@)) (Mul (Mul c17~142@ d17~144@) (Mul c17~142@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2699@ temp_17_1~2760@))) (=> (= temp_17_0~2699@ temp_17_1~2760@) (=> (= temp_18_0~2849@ (Mul (Mul (Add (Mul b18~148@ a18~146@) (Mul a18~146@ c18~150@)) (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ b18~148@))) (Sub (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ c18~150@)) (Mul (Mul c18~150@ b18~148@) (Mul b18~148@ c18~150@))))) (=> (= temp_18_1~2914@ (Mul (Mul (Add (Mul b18~148@ a18~146@) (Mul a18~146@ c18~150@)) (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ b18~148@))) (Sub (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ c18~150@)) (Mul (Mul c18~150@ b18~148@) (Mul b18~148@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2849@ temp_18_1~2914@))) (=> (= temp_18_0~2849@ temp_18_1~2914@) (=> (= temp_19_0~3003@ (Mul (Add (Mul (Add d19~160@ a19~154@) (Mul b19~156@ d19~160@)) (Mul (Mul c19~158@ a19~154@) (Mul c19~158@ d19~160@))) (Mul (Mul (Mul c19~158@ c19~158@) (Mul c19~158@ b19~156@)) (Mul (Sub b19~156@ a19~154@) (Mul d19~160@ c19~158@))))) (=> (= temp_19_1~3068@ (Mul (Add (Mul (Add d19~160@ a19~154@) (Mul b19~156@ d19~160@)) (Mul (Mul c19~158@ a19~154@) (Mul c19~158@ d19~160@))) (Mul (Mul (Mul c19~158@ c19~158@) (Mul c19~158@ b19~156@)) (Mul (Sub b19~156@ a19~154@) (Mul d19~160@ c19~158@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3003@ temp_19_1~3068@))) (=> (= temp_19_0~3003@ temp_19_1~3068@) (=> (= temp_20_0~3157@ (Mul (Mul (Add (Mul a20~162@ d20~168@) (Mul c20~166@ c20~166@)) (Mul (Mul d20~168@ a20~162@) (Mul b20~164@ a20~162@))) (Mul (Mul (Mul b20~164@ b20~164@) (Mul a20~162@ b20~164@)) (Mul (Mul b20~164@ d20~168@) (Mul b20~164@ b20~164@))))) (=> (= temp_20_1~3222@ (Mul (Mul (Add (Mul a20~162@ d20~168@) (Mul c20~166@ c20~166@)) (Mul (Mul d20~168@ a20~162@) (Mul b20~164@ a20~162@))) (Mul (Mul (Mul b20~164@ b20~164@) (Mul a20~162@ b20~164@)) (Mul (Mul b20~164@ d20~168@) (Mul b20~164@ b20~164@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3157@ temp_20_1~3222@))) (=> (= temp_20_0~3157@ temp_20_1~3222@) (=> (= temp_21_0~3299@ (Mul (Mul (Mul (Sub c21~174@ a21~170@) (Add a21~170@ d21~176@)) (Add (Mul b21~172@ c21~174@) (Sub a21~170@ d21~176@))) (Mul d21~176@ (Mul (Sub b21~172@ d21~176@) (Mul c21~174@ d21~176@))))) (=> (= temp_21_1~3352@ (Mul (Mul (Mul (Sub c21~174@ a21~170@) (Add a21~170@ d21~176@)) (Add (Mul b21~172@ c21~174@) (Sub a21~170@ d21~176@))) (Mul d21~176@ (Mul (Mul c21~174@ d21~176@) (Sub b21~172@ d21~176@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3299@ temp_21_1~3352@))) (=> (= temp_21_0~3299@ temp_21_1~3352@) (=> (= temp_22_0~3437@ (Mul (Sub (Mul (Mul b22~180@ c22~182@) (Mul c22~182@ c22~182@)) (Mul (Mul a22~178@ b22~180@) (Mul c22~182@ d22~184@))) (Sub (Sub (Sub a22~178@ a22~178@) a22~178@) (Mul (Mul c22~182@ a22~178@) (Sub a22~178@ a22~178@))))) (=> (= temp_22_1~3498@ (Mul (Sub (Mul (Mul c22~182@ c22~182@) (Mul b22~180@ c22~182@)) (Mul (Mul a22~178@ b22~180@) (Mul c22~182@ d22~184@))) (Sub (Sub (Sub a22~178@ a22~178@) a22~178@) (Mul (Mul c22~182@ a22~178@) (Sub a22~178@ a22~178@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3437@ temp_22_1~3498@))) (=> (= temp_22_0~3437@ temp_22_1~3498@) (=> (= temp_23_0~3587@ (Mul (Add (Mul (Add d23~192@ a23~186@) (Sub a23~186@ d23~192@)) (Mul (Mul c23~190@ b23~188@) (Sub a23~186@ b23~188@))) (Mul (Sub (Add b23~188@ d23~192@) (Mul c23~190@ a23~186@)) (Mul (Mul c23~190@ c23~190@) (Mul a23~186@ c23~190@))))) (=> (= temp_23_1~3652@ (Mul (Add (Mul (Sub a23~186@ d23~192@) (Add d23~192@ a23~186@)) (Mul (Mul c23~190@ b23~188@) (Sub a23~186@ b23~188@))) (Mul (Sub (Add b23~188@ d23~192@) (Mul c23~190@ a23~186@)) (Mul (Mul c23~190@ c23~190@) (Mul a23~186@ c23~190@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3587@ temp_23_1~3652@))) (=> (= temp_23_0~3587@ temp_23_1~3652@) (=> (= temp_24_0~3741@ (Mul (Add (Mul (Mul a24~194@ d24~200@) (Mul d24~200@ d24~200@)) (Mul (Mul d24~200@ b24~196@) (Sub d24~200@ a24~194@))) (Mul (Mul (Mul c24~198@ c24~198@) (Mul a24~194@ d24~200@)) (Mul (Mul c24~198@ b24~196@) (Mul b24~196@ a24~194@))))) (=> (= temp_24_1~3806@ (Mul (Add (Mul (Mul a24~194@ d24~200@) (Mul d24~200@ d24~200@)) (Mul (Mul d24~200@ b24~196@) (Sub d24~200@ a24~194@))) (Mul (Mul c24~198@ (Mul c24~198@ (Mul a24~194@ d24~200@))) (Mul (Mul c24~198@ b24~196@) (Mul b24~196@ a24~194@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3741@ temp_24_1~3806@))) (=> (= temp_24_0~3741@ temp_24_1~3806@) (=> (= temp_25_0~3887@ (Mul (Mul (Mul (Mul b25~204@ a25~202@) b25~204@) (Mul (Sub a25~202@ c25~206@) (Mul b25~204@ a25~202@))) (Mul (Mul (Mul a25~202@ a25~202@) (Mul c25~206@ b25~204@)) (Mul d25~208@ (Mul b25~204@ a25~202@))))) (=> (= temp_25_1~3944@ (Mul (Mul (Mul (Mul a25~202@ a25~202@) (Mul c25~206@ b25~204@)) (Mul d25~208@ (Mul b25~204@ a25~202@))) (Mul (Mul (Mul b25~204@ a25~202@) b25~204@) (Mul (Sub a25~202@ c25~206@) (Mul b25~204@ a25~202@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~3887@ temp_25_1~3944@))) (=> (= temp_25_0~3887@ temp_25_1~3944@) (=> (= temp_26_0~4025@ (Mul (Mul (Mul (Mul a26~210@ a26~210@) d26~216@) (Mul (Sub c26~214@ c26~214@) (Mul d26~216@ c26~214@))) (Mul a26~210@ (Mul (Mul 98 b26~212@) b26~212@)))) (=> (= temp_26_1~4082@ (Mul (Mul (Mul (Mul a26~210@ a26~210@) d26~216@) (Mul (Sub c26~214@ c26~214@) (Mul d26~216@ c26~214@))) (Mul a26~210@ (Mul (Mul b26~212@ 98) b26~212@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%26 (= temp_26_0~4025@ temp_26_1~4082@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
