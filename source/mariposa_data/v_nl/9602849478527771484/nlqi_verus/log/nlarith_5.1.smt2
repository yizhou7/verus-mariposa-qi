...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul (Mul b0~4@ (Sub b0~4@ b0~4@)) (Mul (Mul a0~2@ c0~6@) b0~4@)) (Sub (Mul (Mul a0~2@ b0~4@) a0~2@) (Mul (Add c0~6@ d0~8@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~346@ (Mul (Mul (Mul b0~4@ (Sub b0~4@ b0~4@)) (Mul (Mul a0~2@ c0~6@) b0~4@)) (Sub (Mul (Mul a0~2@ b0~4@) a0~2@) (Mul (Add c0~6@ d0~8@) (Mul a0~2@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~293@ temp_0_1~346@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~422@ (Mul (Mul (Mul b1~12@ (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ a1~10@))) (Sub (Mul (Add d1~16@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~491@ (Mul (Mul (Mul b1~12@ (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ a1~10@))) (Sub (Add (Mul d1~16@ (Mul b1~12@ a1~10@)) (Mul b1~12@ (Mul b1~12@ a1~10@))) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~422@ temp_1_1~491@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~571@ (Mul (Add (Add (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@)) (Add (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@))) (Add (Add (Mul d2~24@ b2~20@) (Mul b2~20@ c2~22@)) (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~636@ (Mul (Add (Add (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@)) (Add (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@))) (Add (Add (Mul d2~24@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~571@ temp_2_1~636@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~716@ (Sub (Mul (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~781@ (Sub (Mul (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul (Mul a3~26@ b3~28@) d3~32@) a3~26@)) (Mul (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~716@ temp_3_1~781@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~849@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Sub a4~34@ b4~36@)) (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ d4~40@))) (Mul d4~40@ (Add (Mul c4~38@ c4~38@) (Sub a4~34@ d4~40@))))) (=> (= temp_4_1~902@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Sub a4~34@ b4~36@)) (Mul (Mul (Mul d4~40@ a4~34@) c4~38@) d4~40@)) (Mul d4~40@ (Add (Mul c4~38@ c4~38@) (Sub a4~34@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~849@ temp_4_1~902@)) (=> %%location_label%%4 tmp%5@)))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
