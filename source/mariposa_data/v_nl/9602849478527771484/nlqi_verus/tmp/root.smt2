      ...
      (=>
       ...
       (and
        ...
        (=>
         tmp%1@
         (=>
          (= temp_1_0~422@ (Mul (Mul (Mul b1~12@ (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ c1~14@)
              (Mul c1~14@ a1~10@)
             )
          ...
          (=>
           (= temp_1_1~491@ (Mul (Mul (Mul b1~12@ (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ c1~14@)
               (Mul c1~14@ a1~10@)
              )
           ...
           (=>
            ...
            (and
             ...
             (=>
              tmp%2@
              (=>
               (= temp_2_0~571@ (Mul (Add (Add (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@)) (Add (Mul d2~24@
                    b2~20@
                   ) (Mul b2~20@ a2~18@)
                  )
               ...
               (=>
                (= temp_2_1~636@ (Mul (Add (Add (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@)) (Add (Mul d2~24@
                     b2~20@
                    ) (Mul b2~20@ a2~18@)
                   )
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   tmp%3@
                   (=>
                    (= temp_3_0~716@ (Sub (Mul (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul a3~26@
                         b3~28@
                        ) (Mul d3~32@ a3~26@)
                       )
                    ...
                    (=>
                     (= temp_3_1~781@ (Sub (Mul (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul (Mul
                           a3~26@ b3~28@
                          ) d3~32@
                         ) a3~26@
                        )
                     ...
                     (=>
                      ...
                      (and
                       ...
                       (=>
                        tmp%4@
                        (=>
                         (= temp_4_0~849@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Sub a4~34@ b4~36@)) (Mul (Mul d4~40@
                              a4~34@
                             ) (Mul c4~38@ d4~40@)
                            )
                         ...
                         (=>
                          (= temp_4_1~902@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Sub a4~34@ b4~36@)) (Mul (Mul (Mul
                                d4~40@ a4~34@
                               ) c4~38@
                              ) d4~40@
                             )
