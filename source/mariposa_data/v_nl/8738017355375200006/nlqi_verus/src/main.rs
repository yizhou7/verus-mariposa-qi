...
a19: int, b19: int, c19: int, d19: int)
{
	...
	let temp_4_0 = (((((b4-a4)*(c4*d4))*((a4*(80 as int))*(c4*a4)))*(((d4*d4)*b4)*((c4-d4)*(d4*a4))))*((((d4*d4)*(d4*(53 as int)))+((b4*c4)*(d4-a4)))+(((d4*d4)-(b4+c4))*((c4*d4)*((99 as int)+a4)))));
	let temp_4_1 = (((((b4-a4)*(c4*d4))*((a4*(80 as int))*(c4*a4)))*(((d4*d4)*b4)*((c4-d4)*(d4*a4))))*((((d4*d4)*((53 as int)*d4))+((b4*c4)*(d4-a4)))+(((d4*d4)-(b4+c4))*((c4*d4)*((99 as int)+a4)))));
	assert(temp_4_0 == temp_4_1);
	let temp_5_0 = (((((d5+d5)*(c5*d5))*((b5*a5)*(d5*b5)))+(((b5*b5)*(b5*c5))*((d5*a5)*(a5*a5))))*((((d5*d5)*(b5*c5))*(d5*(b5*b5)))*(((d5*d5)*(c5*c5))*((c5*b5)*(b5*a5)))));
	let temp_5_1 = (((((d5+d5)*(c5*d5))*((b5*a5)*(d5*b5)))+(((b5*b5)*(b5*c5))*((d5*a5)*(a5*a5))))*((((d5*d5)*(b5*c5))*(d5*(b5*b5)))*(((c5*b5)*(b5*a5))*((d5*d5)*(c5*c5)))));
	assert(temp_5_0 == temp_5_1);
	let temp_6_0 = (((((b6*b6)-(d6*d6))*a6)*(((d6*a6)*(a6*b6))+((a6*c6)*(b6*b6))))*((((c6*a6)+(d6-a6))+((d6*a6)*(c6*a6)))+(((d6*c6)*(a6+c6))*((c6*b6)*(c6+a6)))));
	let temp_6_1 = (((((b6*b6)-(d6*d6))*a6)*(((d6*a6)*(a6*b6))+((b6*b6)*(a6*c6))))*((((c6*a6)+(d6-a6))+((d6*a6)*(c6*a6)))+(((d6*c6)*(a6+c6))*((c6*b6)*(c6+a6)))));
	assert(temp_6_0 == temp_6_1);
	let temp_7_0 = (((((d7+c7)*(a7*d7))+d7)*(((b7*a7)*(d7*c7))+((a7*a7)*(d7*c7))))*(((a7*(b7*b7))*(c7*(d7+d7)))*(((a7-d7)-(c7*b7))*((d7*b7)*(d7*d7)))));
	let temp_7_1 = ((((((d7+c7)*(a7*d7))+d7)*(((b7*a7)*(d7*c7))+((a7*a7)*(d7*c7))))*((a7*(b7*b7))*(c7*(d7+d7))))*(((a7-d7)-(c7*b7))*((d7*b7)*(d7*d7))));
	assert(temp_7_0 == temp_7_1);
	let temp_8_0 = (((a8-b8)*(((c8*b8)*(a8*d8))-((a8*b8)*(a8*c8))))*((((d8*c8)*(a8*a8))*((c8*a8)*(d8*c8)))*(((b8+b8)+(d8-d8))*(c8-(a8*c8)))));
	let temp_8_1 = (((a8-b8)*(((c8*b8)*(a8*d8))-(a8*(b8*(a8*c8)))))*((((d8*c8)*(a8*a8))*((c8*a8)*(d8*c8)))*(((b8+b8)+(d8-d8))*(c8-(a8*c8)))));
