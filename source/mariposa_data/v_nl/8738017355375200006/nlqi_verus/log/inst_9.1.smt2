...
(set-info :comment ";; mariposa_data/v_nl//8738017355375200006/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~285@ (Mul (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ d0~8@)) (Add (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@)))) (Mul (Sub (Mul a0~2@ (Sub c0~6@ a0~2@)) (Mul (Add c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (Mul (Mul (Add d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Add (Mul c0~6@ a0~2@) (Add a0~2@ a0~2@)))))) (=> (= temp_0_1~410@ (Mul (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ d0~8@)) (Add (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ c0~6@)))) (Mul (Sub (Mul a0~2@ (Sub c0~6@ a0~2@)) (Mul (Add c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (Mul (Mul (Add d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Add (Mul c0~6@ a0~2@) (Add a0~2@ a0~2@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~285@ temp_0_1~410@))) (=> (= temp_0_0~285@ temp_0_1~410@) (=> (= temp_1_0~535@ (Mul (Mul a1~10@ (Mul (Mul (Add d1~16@ a1~10@) (Mul a1~10@ b1~12@)) (Add (Mul b1~12@ b1~12@) (Add b1~12@ c1~14@)))) (Mul (Mul (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ a1~10@) c1~14@)) (Mul (Sub (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@)) (Mul (Add d1~16@ c1~14@) (Mul c1~14@ a1~10@)))))) (=> (= temp_1_1~632@ (Mul (Mul a1~10@ (Mul (Mul (Add d1~16@ a1~10@) (Mul a1~10@ b1~12@)) (Add (Mul b1~12@ b1~12@) (Add b1~12@ c1~14@)))) (Mul (Mul (Mul (Mul (Mul b1~12@ a1~10@) b1~12@) c1~14@) (Mul (Mul c1~14@ a1~10@) c1~14@)) (Mul (Sub (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@)) (Mul (Add d1~16@ c1~14@) (Mul c1~14@ a1~10@)))))) (and (=> (= tmp%1@ (Mul b1~12@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b1~12@ c1~14@) (=> %%location_label%%1 (= temp_1_0~535@ temp_1_1~632@)))) (=> (= temp_1_0~535@ temp_1_1~632@) (=> (= temp_2_0~799@ (Mul (Mul (Mul (Mul c2~22@ (Mul a2~18@ b2~20@)) (Add (Add c2~22@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Add (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Sub (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@)))) (Add (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@)) c2~22@) (Mul (Mul (Mul 81 b2~20@) (Mul a2~18@ a2~18@)) (Mul a2~18@ (Mul a2~18@ 78)))))) (=> (= temp_2_1~932@ (Mul (Mul (Mul (Mul c2~22@ (Mul a2~18@ b2~20@)) (Add (Add c2~22@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Add (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Sub (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@)))) (Add (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@)) c2~22@) (Mul (Mul (Mul 81 b2~20@) (Mul a2~18@ a2~18@)) (Mul a2~18@ (Mul a2~18@ 78)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ b2~20@) (=> %%location_label%%2 (= temp_2_0~799@ temp_2_1~932@))) (=> (= temp_2_0~799@ temp_2_1~932@) (=> (= temp_3_0~1085@ (Add (Mul (Mul (Add (Mul b3~28@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Add a3~26@ d3~32@) (Sub d3~32@ d3~32@))) (Sub (Mul (Mul d3~32@ a3~26@) (Add c3~30@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ b3~28@)))) (Sub (Add (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@)) (Mul a3~26@ (Mul d3~32@ d3~32@))) (Mul c3~30@ (Sub (Add b3~28@ a3~26@) (Mul 48 b3~28@)))))) (=> (= temp_3_1~1210@ (Add (Mul (Mul (Add (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Add a3~26@ d3~32@) (Sub d3~32@ d3~32@))) (Sub (Mul (Mul d3~32@ a3~26@) (Add c3~30@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ b3~28@)))) (Sub (Add (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@)) (Mul a3~26@ (Mul d3~32@ d3~32@))) (Mul c3~30@ (Sub (Add b3~28@ a3~26@) (Mul 48 b3~28@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ a3~26@) (=> %%location_label%%3 (= temp_3_0~1085@ temp_3_1~1210@))) (=> (= temp_3_0~1085@ temp_3_1~1210@) (=> (= temp_4_0~1399@ (Mul (Mul (Mul (Mul (Sub b4~36@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ 80) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul d4~40@ d4~40@) b4~36@) (Mul (Sub c4~38@ d4~40@) (Mul d4~40@ a4~34@)))) (Add (Add (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ 53)) (Mul (Mul b4~36@ c4~38@) (Sub d4~40@ a4~34@))) (Mul (Sub (Mul d4~40@ d4~40@) (Add b4~36@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Add 99 a4~34@)))))) (=> (= temp_4_1~1560@ (Mul (Mul (Mul (Mul (Sub b4~36@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ 80) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul d4~40@ d4~40@) b4~36@) (Mul (Sub c4~38@ d4~40@) (Mul d4~40@ a4~34@)))) (Add (Add (Mul (Mul d4~40@ d4~40@) (Mul 53 d4~40@)) (Mul (Mul b4~36@ c4~38@) (Sub d4~40@ a4~34@))) (Mul (Sub (Mul d4~40@ d4~40@) (Add b4~36@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Add 99 a4~34@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ 53) (=> %%location_label%%4 (= temp_4_0~1399@ temp_4_1~1560@))) (=> (= temp_4_0~1399@ temp_4_1~1560@) (=> (= temp_5_0~1725@ (Mul (Add (Mul (Mul (Add d5~48@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ c5~46@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)))) (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)) (Mul d5~48@ (Mul b5~44@ b5~44@))) (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@)) (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ a5~42@)))))) (=> (= temp_5_1~1850@ (Mul (Add (Mul (Mul (Add d5~48@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ c5~46@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)))) (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)) (Mul d5~48@ (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@)))))) (and (=> (= tmp%2@ (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@))) (=> (= tmp%3@ (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%5 (= temp_5_0~1725@ temp_5_1~1850@))))) (=> (= temp_5_0~1725@ temp_5_1~1850@) (=> (= temp_6_0~2019@ (Mul (Mul (Mul (Sub (Mul b6~52@ b6~52@) (Mul d6~56@ d6~56@)) a6~50@) (Add (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ b6~52@)))) (Add (Add (Add (Mul c6~54@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Add c6~54@ a6~50@)))))) (=> (= temp_6_1~2136@ (Mul (Mul (Mul (Sub (Mul b6~52@ b6~52@) (Mul d6~56@ d6~56@)) a6~50@) (Add (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)))) (Add (Add (Add (Mul c6~54@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Add c6~54@ a6~50@)))))) (and (=> (= tmp%4@ (Mul a6~50@ c6~54@)) (=> (= tmp%5@ (Mul b6~52@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%6 (= temp_6_0~2019@ temp_6_1~2136@))))) (=> (= temp_6_0~2019@ temp_6_1~2136@) (=> (= temp_7_0~2281@ (Mul (Mul (Add (Mul (Add d7~64@ c7~62@) (Mul a7~58@ d7~64@)) d7~64@) (Add (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ c7~62@)))) (Mul (Mul (Mul a7~58@ (Mul b7~60@ b7~60@)) (Mul c7~62@ (Add d7~64@ d7~64@))) (Mul (Sub (Sub a7~58@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@)))))) (=> (= temp_7_1~2390@ (Mul (Mul (Mul (Add (Mul (Add d7~64@ c7~62@) (Mul a7~58@ d7~64@)) d7~64@) (Add (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ c7~62@)))) (Mul (Mul a7~58@ (Mul b7~60@ b7~60@)) (Mul c7~62@ (Add d7~64@ d7~64@)))) (Mul (Sub (Sub a7~58@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@))))) (and (=> (= tmp%6@ (Mul (Add (Mul (Add d7~64@ c7~62@) (Mul a7~58@ d7~64@)) d7~64@) (Add (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ c7~62@))))) (=> (= tmp%7@ (Mul (Mul a7~58@ (Mul b7~60@ b7~60@)) (Mul c7~62@ (Add d7~64@ d7~64@)))) (=> (= tmp%8@ (Mul (Sub (Sub a7~58@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%7 (= temp_7_0~2281@ temp_7_1~2390@)))))) (=> (= temp_7_0~2281@ temp_7_1~2390@) (=> (= temp_8_0~2617@ (Mul (Mul (Sub a8~66@ b8~68@) (Sub (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@)))) (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Add (Add b8~68@ b8~68@) (Sub d8~72@ d8~72@)) (Sub c8~70@ (Mul a8~66@ c8~70@)))))) (=> (= temp_8_1~2718@ (Mul (Mul (Sub a8~66@ b8~68@) (Sub (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@)) (Mul a8~66@ (Mul b8~68@ (Mul a8~66@ c8~70@))))) (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Add (Add b8~68@ b8~68@) (Sub d8~72@ d8~72@)) (Sub c8~70@ (Mul a8~66@ c8~70@)))))) (=> (= tmp%9@ (Mul a8~66@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a8~66@ b8~68@ tmp%9@) (=> %%location_label%%8 (= temp_8_0~2617@ temp_8_1~2718@)))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
