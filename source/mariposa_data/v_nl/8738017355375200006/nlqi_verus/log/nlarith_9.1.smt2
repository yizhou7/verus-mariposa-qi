...
(declare-const temp_1_1~619@ Int)
(declare-const temp_2_0~767@ Int)
(declare-const temp_2_1~900@ Int)
(declare-const temp_3_0~1040@ Int)
(declare-const temp_3_1~1165@ Int)
(declare-const temp_4_0~1341@ Int)
(declare-const temp_4_1~1502@ Int)
(declare-const temp_5_0~1642@ Int)
(declare-const temp_5_1~1767@ Int)
(declare-const temp_6_0~1899@ Int)
(declare-const temp_6_1~2016@ Int)
(declare-const temp_7_0~2140@ Int)
(declare-const temp_7_1~2249@ Int)
(declare-const temp_8_0~2365@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~285@ (Mul (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ d0~8@)) (Add (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@)))) (Mul (Sub (Mul a0~2@ (Sub c0~6@ a0~2@)) (Mul (Add c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (Mul (Mul (Add d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Add (Mul c0~6@ a0~2@) (Add a0~2@ a0~2@)))))) (=> (= temp_0_1~410@ (Mul (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ d0~8@)) (Add (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ c0~6@)))) (Mul (Sub (Mul a0~2@ (Sub c0~6@ a0~2@)) (Mul (Add c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (Mul (Mul (Add d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Add (Mul c0~6@ a0~2@) (Add a0~2@ a0~2@)))))) (=> (= tmp%1@ (= temp_0_0~285@ temp_0_1~410@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~522@ (Mul (Mul a1~10@ (Mul (Mul (Add d1~16@ a1~10@) (Mul a1~10@ b1~12@)) (Add (Mul b1~12@ b1~12@) (Add b1~12@ c1~14@)))) (Mul (Mul (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ a1~10@) c1~14@)) (Mul (Sub (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@)) (Mul (Add d1~16@ c1~14@) (Mul c1~14@ a1~10@)))))) (=> (= temp_1_1~619@ (Mul (Mul a1~10@ (Mul (Mul (Add d1~16@ a1~10@) (Mul a1~10@ b1~12@)) (Add (Mul b1~12@ b1~12@) (Add b1~12@ c1~14@)))) (Mul (Mul (Mul (Mul (Mul b1~12@ a1~10@) b1~12@) c1~14@) (Mul (Mul c1~14@ a1~10@) c1~14@)) (Mul (Sub (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@)) (Mul (Add d1~16@ c1~14@) (Mul c1~14@ a1~10@)))))) (=> (= tmp%2@ (= temp_1_0~522@ temp_1_1~619@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~767@ (Mul (Mul (Mul (Mul c2~22@ (Mul a2~18@ b2~20@)) (Add (Add c2~22@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Add (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Sub (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@)))) (Add (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@)) c2~22@) (Mul (Mul (Mul 81 b2~20@) (Mul a2~18@ a2~18@)) (Mul a2~18@ (Mul a2~18@ 78)))))) (=> (= temp_2_1~900@ (Mul (Mul (Mul (Mul c2~22@ (Mul a2~18@ b2~20@)) (Add (Add c2~22@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Add (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Sub (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@)))) (Add (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@)) c2~22@) (Mul (Mul (Mul 81 b2~20@) (Mul a2~18@ a2~18@)) (Mul a2~18@ (Mul a2~18@ 78)))))) (=> (= tmp%3@ (= temp_2_0~767@ temp_2_1~900@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1040@ (Add (Mul (Mul (Add (Mul b3~28@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Add a3~26@ d3~32@) (Sub d3~32@ d3~32@))) (Sub (Mul (Mul d3~32@ a3~26@) (Add c3~30@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ b3~28@)))) (Sub (Add (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@)) (Mul a3~26@ (Mul d3~32@ d3~32@))) (Mul c3~30@ (Sub (Add b3~28@ a3~26@) (Mul 48 b3~28@)))))) (=> (= temp_3_1~1165@ (Add (Mul (Mul (Add (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Add a3~26@ d3~32@) (Sub d3~32@ d3~32@))) (Sub (Mul (Mul d3~32@ a3~26@) (Add c3~30@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ b3~28@)))) (Sub (Add (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@)) (Mul a3~26@ (Mul d3~32@ d3~32@))) (Mul c3~30@ (Sub (Add b3~28@ a3~26@) (Mul 48 b3~28@)))))) (=> (= tmp%4@ (= temp_3_0~1040@ temp_3_1~1165@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1341@ (Mul (Mul (Mul (Mul (Sub b4~36@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ 80) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul d4~40@ d4~40@) b4~36@) (Mul (Sub c4~38@ d4~40@) (Mul d4~40@ a4~34@)))) (Add (Add (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ 53)) (Mul (Mul b4~36@ c4~38@) (Sub d4~40@ a4~34@))) (Mul (Sub (Mul d4~40@ d4~40@) (Add b4~36@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Add 99 a4~34@)))))) (=> (= temp_4_1~1502@ (Mul (Mul (Mul (Mul (Sub b4~36@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ 80) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul d4~40@ d4~40@) b4~36@) (Mul (Sub c4~38@ d4~40@) (Mul d4~40@ a4~34@)))) (Add (Add (Mul (Mul d4~40@ d4~40@) (Mul 53 d4~40@)) (Mul (Mul b4~36@ c4~38@) (Sub d4~40@ a4~34@))) (Mul (Sub (Mul d4~40@ d4~40@) (Add b4~36@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Add 99 a4~34@)))))) (=> (= tmp%5@ (= temp_4_0~1341@ temp_4_1~1502@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1642@ (Mul (Add (Mul (Mul (Add d5~48@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ c5~46@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)))) (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)) (Mul d5~48@ (Mul b5~44@ b5~44@))) (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@)) (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ a5~42@)))))) (=> (= temp_5_1~1767@ (Mul (Add (Mul (Mul (Add d5~48@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ c5~46@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)))) (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)) (Mul d5~48@ (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@)))))) (=> (= tmp%6@ (= temp_5_0~1642@ temp_5_1~1767@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1899@ (Mul (Mul (Mul (Sub (Mul b6~52@ b6~52@) (Mul d6~56@ d6~56@)) a6~50@) (Add (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ b6~52@)))) (Add (Add (Add (Mul c6~54@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Add c6~54@ a6~50@)))))) (=> (= temp_6_1~2016@ (Mul (Mul (Mul (Sub (Mul b6~52@ b6~52@) (Mul d6~56@ d6~56@)) a6~50@) (Add (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)))) (Add (Add (Add (Mul c6~54@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Add c6~54@ a6~50@)))))) (=> (= tmp%7@ (= temp_6_0~1899@ temp_6_1~2016@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2140@ (Mul (Mul (Add (Mul (Add d7~64@ c7~62@) (Mul a7~58@ d7~64@)) d7~64@) (Add (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ c7~62@)))) (Mul (Mul (Mul a7~58@ (Mul b7~60@ b7~60@)) (Mul c7~62@ (Add d7~64@ d7~64@))) (Mul (Sub (Sub a7~58@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@)))))) (=> (= temp_7_1~2249@ (Mul (Mul (Mul (Add (Mul (Add d7~64@ c7~62@) (Mul a7~58@ d7~64@)) d7~64@) (Add (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ c7~62@)))) (Mul (Mul a7~58@ (Mul b7~60@ b7~60@)) (Mul c7~62@ (Add d7~64@ d7~64@)))) (Mul (Sub (Sub a7~58@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~2140@ temp_7_1~2249@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2365@ (Mul (Mul (Sub a8~66@ b8~68@) (Sub (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@)))) (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Add (Add b8~68@ b8~68@) (Sub d8~72@ d8~72@)) (Sub c8~70@ (Mul a8~66@ c8~70@)))))) (=> (= temp_8_1~2466@ (Mul (Mul (Sub a8~66@ b8~68@) (Sub (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@)) (Mul a8~66@ (Mul b8~68@ (Mul a8~66@ c8~70@))))) (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Add (Add b8~68@ b8~68@) (Sub d8~72@ d8~72@)) (Sub c8~70@ (Mul a8~66@ c8~70@)))))) (=> (= tmp%9@ (= temp_8_0~2365@ temp_8_1~2466@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
