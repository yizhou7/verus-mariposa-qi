...
(declare-const temp_3_0~964@ Int)
(declare-const temp_3_1~1093@ Int)
(declare-const temp_4_0~1233@ Int)
(declare-const temp_4_1~1422@ Int)
(declare-const temp_5_0~1518@ Int)
(declare-const temp_5_1~1599@ Int)
(declare-const temp_6_0~1671@ Int)
(declare-const temp_6_1~1728@ Int)
(declare-const temp_7_0~1856@ Int)
(declare-const temp_7_1~2001@ Int)
(declare-const temp_8_0~2133@ Int)
(declare-const temp_8_1~2250@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~237@ (Mul (Mul (Mul b0~4@ (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ b0~4@))) (Add (Mul (Sub a0~2@ d0~8@) (Mul d0~8@ b0~4@)) a0~2@)) (Mul c0~6@ (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ d0~8@)))))) (=> (= temp_0_1~314@ (Mul (Mul (Mul b0~4@ (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ c0~6@))) (Add (Mul (Sub a0~2@ d0~8@) (Mul d0~8@ b0~4@)) a0~2@)) (Mul c0~6@ (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ d0~8@)))))) (=> (= tmp%1@ (= temp_0_0~237@ temp_0_1~314@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~454@ (Mul (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) (Add (Mul b1~12@ a1~10@) a1~10@)) (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Add a1~10@ d1~16@)))) (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))) (Mul 52 (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ b1~12@)))))) (=> (= temp_1_1~579@ (Mul (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) (Add (Mul b1~12@ a1~10@) a1~10@)) (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@)) (Mul (Mul c1~14@ a1~10@) (Add a1~10@ d1~16@)))) (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))) (Mul 52 (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ b1~12@)))))) (=> (= tmp%2@ (= temp_1_0~454@ temp_1_1~579@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~711@ (Add (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ c2~22@))) (Add (Mul (Mul c2~22@ b2~20@) (Sub a2~18@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Add a2~18@ d2~24@)))) (Mul (Mul (Mul c2~22@ (Mul b2~20@ b2~20@)) (Add (Mul b2~20@ d2~24@) (Sub c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ c2~22@) d2~24@) (Mul (Mul a2~18@ c2~22@) d2~24@))))) (=> (= temp_2_1~828@ (Add (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ c2~22@))) (Add (Mul (Mul c2~22@ b2~20@) (Sub a2~18@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Add a2~18@ d2~24@)))) (Mul (Mul (Mul (Mul c2~22@ b2~20@) b2~20@) (Add (Mul b2~20@ d2~24@) (Sub c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ c2~22@) d2~24@) (Mul (Mul a2~18@ c2~22@) d2~24@))))) (=> (= tmp%3@ (= temp_2_0~711@ temp_2_1~828@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~964@ (Mul (Mul (Mul (Add (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ a3~26@) (Mul c3~30@ a3~26@))) (Mul (Mul b3~28@ (Mul c3~30@ a3~26@)) (Mul (Sub a3~26@ c3~30@) c3~30@))) (Mul (Sub (Mul (Mul a3~26@ c3~30@) (Sub d3~32@ c3~30@)) (Mul (Add c3~30@ b3~28@) (Mul c3~30@ d3~32@))) (Mul (Mul (Add d3~32@ c3~30@) (Sub c3~30@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ d3~32@)))))) (=> (= temp_3_1~1093@ (Mul (Mul (Mul (Add (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ a3~26@) (Mul c3~30@ a3~26@))) (Mul (Mul b3~28@ (Mul c3~30@ a3~26@)) (Mul (Sub a3~26@ c3~30@) c3~30@))) (Mul (Sub (Mul (Mul a3~26@ c3~30@) (Sub d3~32@ c3~30@)) (Mul (Add c3~30@ b3~28@) (Mul c3~30@ d3~32@))) (Mul (Sub (Mul (Add d3~32@ c3~30@) c3~30@) (Mul (Add d3~32@ c3~30@) a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ d3~32@)))))) (=> (= tmp%4@ (= temp_3_0~964@ temp_3_1~1093@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1233@ (Mul (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) (Add (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)))) (Sub (Add (Mul (Add b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ c4~38@))) (Mul (Sub b4~36@ (Mul b4~36@ d4~40@)) (Mul (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@)))))) (=> (= temp_4_1~1422@ (Sub (Mul (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) (Add (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)))) (Add (Mul (Add b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ c4~38@)))) (Mul (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) (Add (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)))) (Mul (Sub b4~36@ (Mul b4~36@ d4~40@)) (Mul (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@)))))) (=> (= tmp%5@ (= temp_4_0~1233@ temp_4_1~1422@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1518@ (Mul (Mul (Mul (Mul (Mul b5~44@ d5~48@) b5~44@) c5~46@) (Mul d5~48@ (Mul (Mul c5~46@ c5~46@) d5~48@))) (Mul (Mul (Sub (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@)) a5~42@) (Sub (Mul d5~48@ (Add a5~42@ c5~46@)) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@)))))) (=> (= temp_5_1~1599@ (Mul (Mul (Mul (Sub (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@)) a5~42@) (Sub (Mul d5~48@ (Add a5~42@ c5~46@)) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@)))) (Mul (Mul (Mul (Mul b5~44@ d5~48@) b5~44@) c5~46@) (Mul d5~48@ (Mul (Mul c5~46@ c5~46@) d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1518@ temp_5_1~1599@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1671@ (Mul a6~50@ (Mul (Sub (Mul (Mul b6~52@ d6~56@) (Mul 53 a6~50@)) b6~52@) (Mul b6~52@ (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ b6~52@)))))) (=> (= temp_6_1~1728@ (Mul a6~50@ (Mul (Sub (Mul (Mul b6~52@ d6~56@) (Mul 53 a6~50@)) b6~52@) (Mul b6~52@ (Mul (Mul (Mul a6~50@ a6~50@) a6~50@) b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1671@ temp_6_1~1728@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1856@ (Mul (Mul (Add c7~62@ (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ c7~62@))) (Mul (Mul (Add c7~62@ a7~58@) (Sub c7~62@ a7~58@)) (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)))) (Mul (Mul (Mul (Mul d7~64@ a7~58@) d7~64@) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))) (Mul (Mul (Add c7~62@ d7~64@) (Sub a7~58@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)))))) (=> (= temp_7_1~2001@ (Mul (Add (Mul c7~62@ (Mul (Mul (Add c7~62@ a7~58@) (Sub c7~62@ a7~58@)) (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ c7~62@)) (Mul (Mul (Add c7~62@ a7~58@) (Sub c7~62@ a7~58@)) (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@))))) (Mul (Mul (Mul (Mul d7~64@ a7~58@) d7~64@) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))) (Mul (Mul (Add c7~62@ d7~64@) (Sub a7~58@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)))))) (=> (= tmp%8@ (= temp_7_0~1856@ temp_7_1~2001@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2133@ (Mul (Mul (Mul (Mul (Add b8~68@ b8~68@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Add b8~68@ a8~66@))) (Add (Mul (Mul c8~70@ a8~66@) (Mul a8~66@ d8~72@)) (Mul (Mul c8~70@ a8~66@) (Sub a8~66@ c8~70@)))) (Mul (Mul (Add (Mul b8~68@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@))) (Add (Mul (Add b8~68@ c8~70@) (Mul d8~72@ b8~68@)) a8~66@)))) (=> (= temp_8_1~2250@ (Mul (Mul (Mul (Mul (Add b8~68@ b8~68@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Add b8~68@ a8~66@))) (Add (Mul c8~70@ (Mul a8~66@ (Mul a8~66@ d8~72@))) (Mul (Mul c8~70@ a8~66@) (Sub a8~66@ c8~70@)))) (Mul (Mul (Add (Mul b8~68@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@))) (Add (Mul (Add b8~68@ c8~70@) (Mul d8~72@ b8~68@)) a8~66@)))) (=> (= tmp%9@ (= temp_8_0~2133@ temp_8_1~2250@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
