...
(set-info :comment ";; mariposa_data/v_nl//3904875551386462867/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~237@ (Mul (Mul (Mul b0~4@ (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ b0~4@))) (Add (Mul (Sub a0~2@ d0~8@) (Mul d0~8@ b0~4@)) a0~2@)) (Mul c0~6@ (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ d0~8@)))))) (=> (= temp_0_1~314@ (Mul (Mul (Mul b0~4@ (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ c0~6@))) (Add (Mul (Sub a0~2@ d0~8@) (Mul d0~8@ b0~4@)) a0~2@)) (Mul c0~6@ (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ d0~8@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~237@ temp_0_1~314@))) (=> (= temp_0_0~237@ temp_0_1~314@) (=> (= temp_1_0~467@ (Mul (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) (Add (Mul b1~12@ a1~10@) a1~10@)) (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Add a1~10@ d1~16@)))) (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))) (Mul 52 (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ b1~12@)))))) (=> (= temp_1_1~592@ (Mul (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) (Add (Mul b1~12@ a1~10@) a1~10@)) (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@)) (Mul (Mul c1~14@ a1~10@) (Add a1~10@ d1~16@)))) (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))) (Mul 52 (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ b1~12@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ c1~14@) (=> %%location_label%%1 (= temp_1_0~467@ temp_1_1~592@))) (=> (= temp_1_0~467@ temp_1_1~592@) (=> (= temp_2_0~737@ (Add (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ c2~22@))) (Add (Mul (Mul c2~22@ b2~20@) (Sub a2~18@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Add a2~18@ d2~24@)))) (Mul (Mul (Mul c2~22@ (Mul b2~20@ b2~20@)) (Add (Mul b2~20@ d2~24@) (Sub c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ c2~22@) d2~24@) (Mul (Mul a2~18@ c2~22@) d2~24@))))) (=> (= temp_2_1~854@ (Add (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ c2~22@))) (Add (Mul (Mul c2~22@ b2~20@) (Sub a2~18@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Add a2~18@ d2~24@)))) (Mul (Mul (Mul (Mul c2~22@ b2~20@) b2~20@) (Add (Mul b2~20@ d2~24@) (Sub c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ c2~22@) d2~24@) (Mul (Mul a2~18@ c2~22@) d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. c2~22@ b2~20@ b2~20@) (=> %%location_label%%2 (= temp_2_0~737@ temp_2_1~854@))) (=> (= temp_2_0~737@ temp_2_1~854@) (=> (= temp_3_0~1005@ (Mul (Mul (Mul (Add (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ a3~26@) (Mul c3~30@ a3~26@))) (Mul (Mul b3~28@ (Mul c3~30@ a3~26@)) (Mul (Sub a3~26@ c3~30@) c3~30@))) (Mul (Sub (Mul (Mul a3~26@ c3~30@) (Sub d3~32@ c3~30@)) (Mul (Add c3~30@ b3~28@) (Mul c3~30@ d3~32@))) (Mul (Mul (Add d3~32@ c3~30@) (Sub c3~30@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ d3~32@)))))) (=> (= temp_3_1~1134@ (Mul (Mul (Mul (Add (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ a3~26@) (Mul c3~30@ a3~26@))) (Mul (Mul b3~28@ (Mul c3~30@ a3~26@)) (Mul (Sub a3~26@ c3~30@) c3~30@))) (Mul (Sub (Mul (Mul a3~26@ c3~30@) (Sub d3~32@ c3~30@)) (Mul (Add c3~30@ b3~28@) (Mul c3~30@ d3~32@))) (Mul (Sub (Mul (Add d3~32@ c3~30@) c3~30@) (Mul (Add d3~32@ c3~30@) a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ d3~32@)))))) (and (=> (= tmp%1@ (Add d3~32@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ c3~30@ a3~26@) (=> %%location_label%%3 (= temp_3_0~1005@ temp_3_1~1134@)))) (=> (= temp_3_0~1005@ temp_3_1~1134@) (=> (= temp_4_0~1293@ (Mul (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) (Add (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)))) (Sub (Add (Mul (Add b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ c4~38@))) (Mul (Sub b4~36@ (Mul b4~36@ d4~40@)) (Mul (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@)))))) (=> (= temp_4_1~1482@ (Sub (Mul (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) (Add (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)))) (Add (Mul (Add b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ c4~38@)))) (Mul (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) (Add (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)))) (Mul (Sub b4~36@ (Mul b4~36@ d4~40@)) (Mul (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@)))))) (and (=> (= tmp%2@ (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) (Add (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@))))) (=> (= tmp%3@ (Add (Mul (Add b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ c4~38@)))) (=> (= tmp%4@ (Mul (Sub b4~36@ (Mul b4~36@ d4~40@)) (Mul (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%2@ tmp%3@ tmp%4@) (=> %%location_label%%4 (= temp_4_0~1293@ temp_4_1~1482@)))))) (=> (= temp_4_0~1293@ temp_4_1~1482@) (=> (= temp_5_0~1705@ (Mul (Mul (Mul (Mul (Mul b5~44@ d5~48@) b5~44@) c5~46@) (Mul d5~48@ (Mul (Mul c5~46@ c5~46@) d5~48@))) (Mul (Mul (Sub (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@)) a5~42@) (Sub (Mul d5~48@ (Add a5~42@ c5~46@)) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@)))))) (=> (= temp_5_1~1786@ (Mul (Mul (Mul (Sub (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@)) a5~42@) (Sub (Mul d5~48@ (Add a5~42@ c5~46@)) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@)))) (Mul (Mul (Mul (Mul b5~44@ d5~48@) b5~44@) c5~46@) (Mul d5~48@ (Mul (Mul c5~46@ c5~46@) d5~48@))))) (and (=> (= tmp%5@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) b5~44@) c5~46@) (Mul d5~48@ (Mul (Mul c5~46@ c5~46@) d5~48@)))) (=> (= tmp%6@ (Mul (Mul (Sub (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@)) a5~42@) (Sub (Mul d5~48@ (Add a5~42@ c5~46@)) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~1705@ temp_5_1~1786@))))) (=> (= temp_5_0~1705@ temp_5_1~1786@) (=> (= temp_6_0~1943@ (Mul a6~50@ (Mul (Sub (Mul (Mul b6~52@ d6~56@) (Mul 53 a6~50@)) b6~52@) (Mul b6~52@ (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ b6~52@)))))) (=> (= temp_6_1~2000@ (Mul a6~50@ (Mul (Sub (Mul (Mul b6~52@ d6~56@) (Mul 53 a6~50@)) b6~52@) (Mul b6~52@ (Mul (Mul (Mul a6~50@ a6~50@) a6~50@) b6~52@))))) (and (=> (= tmp%7@ (Mul a6~50@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ a6~50@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1943@ temp_6_1~2000@)))) (=> (= temp_6_0~1943@ temp_6_1~2000@) (=> (= temp_7_0~2147@ (Mul (Mul (Add c7~62@ (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ c7~62@))) (Mul (Mul (Add c7~62@ a7~58@) (Sub c7~62@ a7~58@)) (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)))) (Mul (Mul (Mul (Mul d7~64@ a7~58@) d7~64@) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))) (Mul (Mul (Add c7~62@ d7~64@) (Sub a7~58@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)))))) (=> (= temp_7_1~2292@ (Mul (Add (Mul c7~62@ (Mul (Mul (Add c7~62@ a7~58@) (Sub c7~62@ a7~58@)) (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ c7~62@)) (Mul (Mul (Add c7~62@ a7~58@) (Sub c7~62@ a7~58@)) (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@))))) (Mul (Mul (Mul (Mul d7~64@ a7~58@) d7~64@) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))) (Mul (Mul (Add c7~62@ d7~64@) (Sub a7~58@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)))))) (and (=> (= tmp%8@ (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ c7~62@))) (=> (= tmp%9@ (Mul (Mul (Add c7~62@ a7~58@) (Sub c7~62@ a7~58@)) (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c7~62@ tmp%8@ tmp%9@) (=> %%location_label%%7 (= temp_7_0~2147@ temp_7_1~2292@))))) (=> (= temp_7_0~2147@ temp_7_1~2292@) (=> (= temp_8_0~2479@ (Mul (Mul (Mul (Mul (Add b8~68@ b8~68@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Add b8~68@ a8~66@))) (Add (Mul (Mul c8~70@ a8~66@) (Mul a8~66@ d8~72@)) (Mul (Mul c8~70@ a8~66@) (Sub a8~66@ c8~70@)))) (Mul (Mul (Add (Mul b8~68@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@))) (Add (Mul (Add b8~68@ c8~70@) (Mul d8~72@ b8~68@)) a8~66@)))) (=> (= temp_8_1~2596@ (Mul (Mul (Mul (Mul (Add b8~68@ b8~68@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Add b8~68@ a8~66@))) (Add (Mul c8~70@ (Mul a8~66@ (Mul a8~66@ d8~72@))) (Mul (Mul c8~70@ a8~66@) (Sub a8~66@ c8~70@)))) (Mul (Mul (Add (Mul b8~68@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@))) (Add (Mul (Add b8~68@ c8~70@) (Mul d8~72@ b8~68@)) a8~66@)))) (=> (= tmp%10@ (Mul a8~66@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c8~70@ a8~66@ tmp%10@) (=> %%location_label%%8 (= temp_8_0~2479@ temp_8_1~2596@)))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
