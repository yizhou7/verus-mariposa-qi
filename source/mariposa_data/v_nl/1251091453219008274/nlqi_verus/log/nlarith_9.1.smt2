...
(declare-const temp_3_0~1072@ Int)
(declare-const temp_3_1~1181@ Int)
(declare-const temp_4_0~1325@ Int)
(declare-const temp_4_1~1454@ Int)
(declare-const temp_5_0~1594@ Int)
(declare-const temp_5_1~1719@ Int)
(declare-const temp_6_0~1839@ Int)
(declare-const temp_6_1~1944@ Int)
(declare-const temp_7_0~2080@ Int)
(declare-const temp_7_1~2201@ Int)
(declare-const temp_8_0~2289@ Int)
(declare-const temp_8_1~2370@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Add (Mul (Sub (Mul c0~6@ d0~8@) (Add b0~4@ b0~4@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))) (Sub (Mul (Sub d0~8@ c0~6@) (Sub b0~4@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@)))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Sub 54 a0~2@)) (Mul (Mul b0~4@ c0~6@) (Add b0~4@ b0~4@))) (Mul (Add (Mul c0~6@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@)))))) (=> (= temp_0_1~442@ (Mul (Add (Mul (Sub (Mul c0~6@ d0~8@) (Add b0~4@ b0~4@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))) (Sub (Mul (Sub d0~8@ c0~6@) (Sub b0~4@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@)))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Sub 54 a0~2@)) (Mul (Mul c0~6@ b0~4@) (Add b0~4@ b0~4@))) (Mul (Add (Mul c0~6@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@)))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~442@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~570@ (Mul (Mul d1~16@ (Mul (Mul (Mul b1~12@ b1~12@) (Add c1~14@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ d1~16@)))) (Mul (Add (Sub (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Sub b1~12@ b1~12@))) (Add (Mul (Mul d1~16@ d1~16@) (Add 23 a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ b1~12@)))))) (=> (= temp_1_1~683@ (Mul (Mul d1~16@ (Mul (Mul (Mul b1~12@ b1~12@) (Add c1~14@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ d1~16@)))) (Mul (Add (Sub (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Sub b1~12@ b1~12@))) (Add (Mul (Mul d1~16@ d1~16@) (Add 23 a1~10@)) (Mul (Mul (Mul a1~10@ a1~10@) b1~12@) b1~12@))))) (=> (= tmp%2@ (= temp_1_0~570@ temp_1_1~683@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~823@ (Sub (Add (Mul (Mul d2~24@ (Mul b2~20@ b2~20@)) (Mul (Add a2~18@ c2~22@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Sub a2~18@ c2~22@) (Mul b2~20@ a2~18@)))) (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Add c2~22@ d2~24@)) (Add (Add c2~22@ b2~20@) (Mul b2~20@ a2~18@))) (Add (Mul (Sub c2~22@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Sub d2~24@ b2~20@)))))) (=> (= temp_2_1~948@ (Sub (Add (Mul (Mul (Mul b2~20@ b2~20@) d2~24@) (Mul (Add a2~18@ c2~22@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Sub a2~18@ c2~22@) (Mul b2~20@ a2~18@)))) (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Add c2~22@ d2~24@)) (Add (Add c2~22@ b2~20@) (Mul b2~20@ a2~18@))) (Add (Mul (Sub c2~22@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Sub d2~24@ b2~20@)))))) (=> (= tmp%3@ (= temp_2_0~823@ temp_2_1~948@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1072@ (Mul (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ 57) (Mul a3~26@ b3~28@))) (Mul d3~32@ (Sub (Sub d3~32@ c3~30@) (Mul d3~32@ a3~26@)))) (Mul (Add (Sub 53 (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))) a3~26@))) (=> (= temp_3_1~1181@ (Mul (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ 57) (Mul b3~28@ a3~26@))) (Mul d3~32@ (Sub (Sub d3~32@ c3~30@) (Mul d3~32@ a3~26@)))) (Mul (Add (Sub 53 (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))) a3~26@))) (=> (= tmp%4@ (= temp_3_0~1072@ temp_3_1~1181@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1325@ (Mul (Mul (Mul (Mul (Add d4~40@ b4~36@) (Mul b4~36@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ a4~34@)))) (Add (Mul (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ a4~34@)) (Sub (Mul c4~38@ d4~40@) (Sub b4~36@ d4~40@))) (Mul (Add (Mul c4~38@ c4~38@) (Add c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ a4~34@)))))) (=> (= temp_4_1~1454@ (Mul (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Add d4~40@ b4~36@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ a4~34@)))) (Add (Mul (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ a4~34@)) (Sub (Mul c4~38@ d4~40@) (Sub b4~36@ d4~40@))) (Mul (Add (Mul c4~38@ c4~38@) (Add c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ a4~34@)))))) (=> (= tmp%5@ (= temp_4_0~1325@ temp_4_1~1454@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1594@ (Sub (Add (Mul (Add (Mul c5~46@ b5~44@) (Mul b5~44@ b5~44@)) (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ d5~48@))) (Sub (Sub (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ a5~42@)))) (Mul (Add (Mul (Add b5~44@ b5~44@) a5~42@) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)))))) (=> (= temp_5_1~1719@ (Sub (Add (Mul (Add (Mul c5~46@ b5~44@) (Mul b5~44@ b5~44@)) (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ d5~48@))) (Sub (Sub (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ a5~42@)))) (Mul (Add (Mul (Add b5~44@ b5~44@) a5~42@) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)))))) (=> (= tmp%6@ (= temp_5_0~1594@ temp_5_1~1719@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1839@ (Mul (Sub (Sub (Mul a6~50@ (Add d6~56@ b6~52@)) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ 44))) (Mul (Mul b6~52@ (Mul d6~56@ c6~54@)) d6~56@)) (Mul (Mul (Mul c6~54@ (Mul a6~50@ a6~50@)) c6~54@) (Mul a6~50@ (Mul (Mul b6~52@ 0) (Mul b6~52@ a6~50@)))))) (=> (= temp_6_1~1944@ (Mul (Sub (Sub (Mul a6~50@ (Add d6~56@ b6~52@)) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ 44))) (Mul (Mul b6~52@ (Mul d6~56@ c6~54@)) d6~56@)) (Mul (Mul (Mul c6~54@ (Mul a6~50@ a6~50@)) c6~54@) (Mul a6~50@ (Mul (Mul b6~52@ 0) (Mul b6~52@ a6~50@)))))) (=> (= tmp%7@ (= temp_6_0~1839@ temp_6_1~1944@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2080@ (Mul (Mul (Mul (Add (Mul d7~64@ d7~64@) (Add c7~62@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Add c7~62@ d7~64@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@ a7~58@) d7~64@))) (Add (Mul (Mul (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@)) (Sub (Mul b7~60@ c7~62@) (Add c7~62@ b7~60@))) (Mul (Mul a7~58@ (Mul d7~64@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ c7~62@)))))) (=> (= temp_7_1~2201@ (Mul (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Add c7~62@ d7~64@)) (Add (Mul d7~64@ d7~64@) (Add c7~62@ d7~64@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@ a7~58@) d7~64@))) (Add (Mul (Mul (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@)) (Sub (Mul b7~60@ c7~62@) (Add c7~62@ b7~60@))) (Mul (Mul a7~58@ (Mul d7~64@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ c7~62@)))))) (=> (= tmp%8@ (= temp_7_0~2080@ temp_7_1~2201@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2289@ (Sub (Mul (Add (Mul (Add b8~68@ a8~66@) (Mul a8~66@ c8~70@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@))) c8~70@) (Add (Mul (Sub (Mul a8~66@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ a8~66@))) d8~72@))) (=> (= temp_8_1~2370@ (Sub (Mul (Add (Add (Mul b8~68@ (Mul a8~66@ c8~70@)) (Mul a8~66@ (Mul a8~66@ c8~70@))) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@))) c8~70@) (Add (Mul (Sub (Mul a8~66@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ a8~66@))) d8~72@))) (=> (= tmp%9@ (= temp_8_0~2289@ temp_8_1~2370@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
