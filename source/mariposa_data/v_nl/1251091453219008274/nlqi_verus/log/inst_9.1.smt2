...
(set-info :comment ";; mariposa_data/v_nl//1251091453219008274/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Add (Mul (Sub (Mul c0~6@ d0~8@) (Add b0~4@ b0~4@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))) (Sub (Mul (Sub d0~8@ c0~6@) (Sub b0~4@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@)))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Sub 54 a0~2@)) (Mul (Mul b0~4@ c0~6@) (Add b0~4@ b0~4@))) (Mul (Add (Mul c0~6@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@)))))) (=> (= temp_0_1~442@ (Mul (Add (Mul (Sub (Mul c0~6@ d0~8@) (Add b0~4@ b0~4@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))) (Sub (Mul (Sub d0~8@ c0~6@) (Sub b0~4@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@)))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Sub 54 a0~2@)) (Mul (Mul c0~6@ b0~4@) (Add b0~4@ b0~4@))) (Mul (Add (Mul c0~6@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ c0~6@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~442@))) (=> (= temp_0_0~301@ temp_0_1~442@) (=> (= temp_1_0~583@ (Mul (Mul d1~16@ (Mul (Mul (Mul b1~12@ b1~12@) (Add c1~14@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ d1~16@)))) (Mul (Add (Sub (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Sub b1~12@ b1~12@))) (Add (Mul (Mul d1~16@ d1~16@) (Add 23 a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ b1~12@)))))) (=> (= temp_1_1~696@ (Mul (Mul d1~16@ (Mul (Mul (Mul b1~12@ b1~12@) (Add c1~14@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ d1~16@)))) (Mul (Add (Sub (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Sub b1~12@ b1~12@))) (Add (Mul (Mul d1~16@ d1~16@) (Add 23 a1~10@)) (Mul (Mul (Mul a1~10@ a1~10@) b1~12@) b1~12@))))) (and (=> (= tmp%1@ (Mul a1~10@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b1~12@ b1~12@) (=> %%location_label%%1 (= temp_1_0~583@ temp_1_1~696@)))) (=> (= temp_1_0~583@ temp_1_1~696@) (=> (= temp_2_0~855@ (Sub (Add (Mul (Mul d2~24@ (Mul b2~20@ b2~20@)) (Mul (Add a2~18@ c2~22@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Sub a2~18@ c2~22@) (Mul b2~20@ a2~18@)))) (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Add c2~22@ d2~24@)) (Add (Add c2~22@ b2~20@) (Mul b2~20@ a2~18@))) (Add (Mul (Sub c2~22@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Sub d2~24@ b2~20@)))))) (=> (= temp_2_1~980@ (Sub (Add (Mul (Mul (Mul b2~20@ b2~20@) d2~24@) (Mul (Add a2~18@ c2~22@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Sub a2~18@ c2~22@) (Mul b2~20@ a2~18@)))) (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Add c2~22@ d2~24@)) (Add (Add c2~22@ b2~20@) (Mul b2~20@ a2~18@))) (Add (Mul (Sub c2~22@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Sub d2~24@ b2~20@)))))) (and (=> (= tmp%2@ (Mul b2~20@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~855@ temp_2_1~980@)))) (=> (= temp_2_0~855@ temp_2_1~980@) (=> (= temp_3_0~1121@ (Mul (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ 57) (Mul a3~26@ b3~28@))) (Mul d3~32@ (Sub (Sub d3~32@ c3~30@) (Mul d3~32@ a3~26@)))) (Mul (Add (Sub 53 (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))) a3~26@))) (=> (= temp_3_1~1230@ (Mul (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ 57) (Mul b3~28@ a3~26@))) (Mul d3~32@ (Sub (Sub d3~32@ c3~30@) (Mul d3~32@ a3~26@)))) (Mul (Add (Sub 53 (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))) a3~26@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ b3~28@) (=> %%location_label%%3 (= temp_3_0~1121@ temp_3_1~1230@))) (=> (= temp_3_0~1121@ temp_3_1~1230@) (=> (= temp_4_0~1387@ (Mul (Mul (Mul (Mul (Add d4~40@ b4~36@) (Mul b4~36@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ a4~34@)))) (Add (Mul (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ a4~34@)) (Sub (Mul c4~38@ d4~40@) (Sub b4~36@ d4~40@))) (Mul (Add (Mul c4~38@ c4~38@) (Add c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ a4~34@)))))) (=> (= temp_4_1~1516@ (Mul (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Add d4~40@ b4~36@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ a4~34@)))) (Add (Mul (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ a4~34@)) (Sub (Mul c4~38@ d4~40@) (Sub b4~36@ d4~40@))) (Mul (Add (Mul c4~38@ c4~38@) (Add c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ a4~34@)))))) (and (=> (= tmp%3@ (Mul (Add d4~40@ b4~36@) (Mul b4~36@ a4~34@))) (=> (= tmp%4@ (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%4 (= temp_4_0~1387@ temp_4_1~1516@))))) (=> (= temp_4_0~1387@ temp_4_1~1516@) (=> (= temp_5_0~1693@ (Sub (Add (Mul (Add (Mul c5~46@ b5~44@) (Mul b5~44@ b5~44@)) (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ d5~48@))) (Sub (Sub (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ a5~42@)))) (Mul (Add (Mul (Add b5~44@ b5~44@) a5~42@) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)))))) (=> (= temp_5_1~1818@ (Sub (Add (Mul (Add (Mul c5~46@ b5~44@) (Mul b5~44@ b5~44@)) (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ d5~48@))) (Sub (Sub (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ a5~42@)))) (Mul (Add (Mul (Add b5~44@ b5~44@) a5~42@) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)))))) (and (=> (= tmp%5@ (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@))) (=> (= tmp%6@ (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~1693@ temp_5_1~1818@))))) (=> (= temp_5_0~1693@ temp_5_1~1818@) (=> (= temp_6_0~1975@ (Mul (Sub (Sub (Mul a6~50@ (Add d6~56@ b6~52@)) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ 44))) (Mul (Mul b6~52@ (Mul d6~56@ c6~54@)) d6~56@)) (Mul (Mul (Mul c6~54@ (Mul a6~50@ a6~50@)) c6~54@) (Mul a6~50@ (Mul (Mul b6~52@ 0) (Mul b6~52@ a6~50@)))))) (=> (= temp_6_1~2080@ (Mul (Sub (Sub (Mul a6~50@ (Add d6~56@ b6~52@)) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ 44))) (Mul (Mul b6~52@ (Mul d6~56@ c6~54@)) d6~56@)) (Mul (Mul (Mul c6~54@ (Mul a6~50@ a6~50@)) c6~54@) (Mul a6~50@ (Mul (Mul b6~52@ 0) (Mul b6~52@ a6~50@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1975@ temp_6_1~2080@))) (=> (= temp_6_0~1975@ temp_6_1~2080@) (=> (= temp_7_0~2229@ (Mul (Mul (Mul (Add (Mul d7~64@ d7~64@) (Add c7~62@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Add c7~62@ d7~64@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@ a7~58@) d7~64@))) (Add (Mul (Mul (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@)) (Sub (Mul b7~60@ c7~62@) (Add c7~62@ b7~60@))) (Mul (Mul a7~58@ (Mul d7~64@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ c7~62@)))))) (=> (= temp_7_1~2350@ (Mul (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Add c7~62@ d7~64@)) (Add (Mul d7~64@ d7~64@) (Add c7~62@ d7~64@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@ a7~58@) d7~64@))) (Add (Mul (Mul (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@)) (Sub (Mul b7~60@ c7~62@) (Add c7~62@ b7~60@))) (Mul (Mul a7~58@ (Mul d7~64@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ c7~62@)))))) (and (=> (= tmp%7@ (Add (Mul d7~64@ d7~64@) (Add c7~62@ d7~64@))) (=> (= tmp%8@ (Mul (Mul b7~60@ b7~60@) (Add c7~62@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%7 (= temp_7_0~2229@ temp_7_1~2350@))))) (=> (= temp_7_0~2229@ temp_7_1~2350@) (=> (= temp_8_0~2475@ (Sub (Mul (Add (Mul (Add b8~68@ a8~66@) (Mul a8~66@ c8~70@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@))) c8~70@) (Add (Mul (Sub (Mul a8~66@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ a8~66@))) d8~72@))) (=> (= temp_8_1~2556@ (Sub (Mul (Add (Add (Mul b8~68@ (Mul a8~66@ c8~70@)) (Mul a8~66@ (Mul a8~66@ c8~70@))) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@))) c8~70@) (Add (Mul (Sub (Mul a8~66@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ a8~66@))) d8~72@))) (=> (= tmp%9@ (Mul a8~66@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b8~68@ a8~66@ tmp%9@) (=> %%location_label%%8 (= temp_8_0~2475@ temp_8_1~2556@)))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
