...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Sub d0~8@ 24))) (Mul (Mul c0~6@ (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~386@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Sub d0~8@ 24))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul c0~6@ (Mul a0~2@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~313@ temp_0_1~386@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~490@ (Mul (Mul (Add (Mul d1~16@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Sub a1~10@ b1~12@) (Sub b1~12@ d1~16@))) (Mul (Sub (Mul 58 d1~16@) (Mul 72 b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~575@ (Mul (Mul (Mul d1~16@ (Add b1~12@ d1~16@)) (Mul (Sub a1~10@ b1~12@) (Sub b1~12@ d1~16@))) (Mul (Sub (Mul 58 d1~16@) (Mul 72 b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~490@ temp_1_1~575@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~655@ (Sub (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ a2~18@) (Add a2~18@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~720@ (Sub (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ b2~20@))) (Mul (Mul c2~22@ (Mul a2~18@ (Add a2~18@ a2~18@))) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~655@ temp_2_1~720@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~808@ (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ 5) d3~32@)) (Mul (Add (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~881@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ 5) d3~32@)) (Mul (Add (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~808@ temp_3_1~881@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~933@ (Mul (Mul (Add (Mul d4~40@ b4~36@) (Sub a4~34@ d4~40@)) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ b4~36@))) d4~40@)) (=> (= temp_4_1~986@ (Mul (Add (Mul (Mul d4~40@ b4~36@) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Sub a4~34@ d4~40@) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ b4~36@)))) d4~40@)) (=> (= tmp%5@ (= temp_4_0~933@ temp_4_1~986@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1062@ (Mul (Sub (Mul d5~48@ (Add b5~44@ c5~46@)) (Mul (Add a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1155@ (Sub (Mul (Mul d5~48@ (Add b5~44@ c5~46@)) (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@)))) (Mul (Mul (Add a5~42@ a5~42@) (Mul c5~46@ d5~48@)) (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@)))))) (=> (= tmp%6@ (= temp_5_0~1062@ temp_5_1~1155@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1235@ (Mul (Mul (Add (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Sub c6~54@ c6~54@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Sub a6~50@ a6~50@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1300@ (Mul (Mul (Add (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Sub c6~54@ c6~54@))) (Mul (Mul (Sub a6~50@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1235@ temp_6_1~1300@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1376@ (Mul (Mul (Sub (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ b7~60@))) (Mul (Mul (Add d7~64@ d7~64@) b7~60@) (Sub (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1441@ (Mul (Mul (Sub (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ b7~60@))) (Mul (Add (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Sub (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1376@ temp_7_1~1441@)) (=> %%location_label%%7 tmp%8@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
