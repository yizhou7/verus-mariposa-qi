...
;; mariposa_data/v_nl//13348694943851565950/nlqi_verus/src/main.rs:7:1: 36:40 (#0)
(push)
 ...
 (declare-const temp_1_1~423@ Int)
 (declare-const temp_2_0~499@ Int)
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~273@ (Mul (Sub (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) (Mul a0~2@ (Mul b0~4@
          a0~2@
        ))
       ) a0~2@
     ))
     (=>
      (= temp_0_1~310@ (Sub (Mul (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) a0~2@) (Mul (Mul
          a0~2@ (Mul b0~4@ a0~2@)
         ) a0~2@
      )))
      (=>
       (= tmp%1@ (= temp_0_0~273@ temp_0_1~310@))
       (and
        (=>
         %%location_label%%0
         tmp%1@
        ...
        (=>
         tmp%1@
         (=>
          (= temp_1_0~374@ (Add (Sub (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@
               a1~10@
              ) (Mul d1~16@ c1~14@)
             )
            ) (Mul c1~14@ (Add b1~12@ (Mul a1~10@ b1~12@)))
          ))
          (=>
           (= temp_1_1~423@ (Add (Sub (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@
                a1~10@
               ) (Mul d1~16@ c1~14@)
              )
             ) (Mul c1~14@ (Add b1~12@ (Mul a1~10@ b1~12@)))
           ...
           (=>
            (= tmp%2@ (= temp_1_0~374@ temp_1_1~423@))
            (and
             (=>
              %%location_label%%1
              tmp%2@
             ...
             (=>
              tmp%2@
              (=>
               (= temp_2_0~499@ (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@
                    a2~18@
                   ) d2~24@
                  )
                 ) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul a2~18@
                    c2~22@
               )))))
               (=>
                (= temp_2_1~560@ (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@
                     a2~18@
                    ) d2~24@
                   )
                  ) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Mul a2~18@
                     c2~22@
                )))))
                (=>
                 (= tmp%3@ (= temp_2_0~499@ temp_2_1~560@))
                 (and
                  (=>
                   %%location_label%%2
                   tmp%3@
                  ...
                  (=>
                   tmp%3@
                   (=>
                    (= temp_3_0~636@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@
                         a3~26@
                        ) (Mul b3~28@ c3~30@)
                       )
                      ) (Mul (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul d3~32@ (Mul a3~26@ c3~30@)))
                    ))
                    (=>
                     (= temp_3_1~697@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@
                          a3~26@
                         ) (Mul b3~28@ c3~30@)
                        )
                       ) (Mul (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ a3~26@) c3~30@))
                     ))
                     (=>
                      (= tmp%4@ (= temp_3_0~636@ temp_3_1~697@))
                      (=>
                       %%location_label%%3
                       tmp%4@
 ))))))))))))))))))))))
