...
(push)
 ...
 (declare-const temp_1_1~432@ Int)
 (declare-const temp_2_0~517@ Int)
 (declare-const temp_2_1~578@ Int)
 (declare-const temp_3_0~663@ Int)
 (declare-const temp_3_1~724@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
     ...
     (=>
      ...
      (and
       (=>
        ...
        (=>
         %%location_label%%0
         (= temp_0_0~273@ temp_0_1~310@)
       ))
       (=>
        (= temp_0_0~273@ temp_0_1~310@)
        (=>
         (= temp_1_0~383@ (Add (Sub (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@
              a1~10@
             ) (Mul d1~16@ c1~14@)
            )
         ...
         (=>
          (= temp_1_1~432@ (Add (Sub (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@
               a1~10@
              ) (Mul d1~16@ c1~14@)
             )
            ) (Mul c1~14@ (Add b1~12@ (Mul a1~10@ b1~12@)))
          ...
          (and
           (=>
            ...
            (=>
             %%location_label%%1
             (= temp_1_0~383@ temp_1_1~432@)
           ))
           (=>
            (= temp_1_0~383@ temp_1_1~432@)
            (=>
             (= temp_2_0~517@ (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@
                  a2~18@
                 ) d2~24@
                )
             ...
             (=>
              (= temp_2_1~578@ (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@
                   a2~18@
                  ) d2~24@
                 )
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~517@ temp_2_1~578@)
               ))
               (=>
                (= temp_2_0~517@ temp_2_1~578@)
                (=>
                 (= temp_3_0~663@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@
                      a3~26@
                     ) (Mul b3~28@ c3~30@)
                    )
                 ...
                 (=>
                  (= temp_3_1~724@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@
                       a3~26@
                      ) (Mul b3~28@ c3~30@)
                     )
