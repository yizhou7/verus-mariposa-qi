...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Sub (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) (Mul a0~2@ (Mul b0~4@ a0~2@))) a0~2@)) (=> (= temp_0_1~310@ (Sub (Mul (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) a0~2@) (Mul (Mul a0~2@ (Mul b0~4@ a0~2@)) a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~310@))) (=> (= temp_0_0~273@ temp_0_1~310@) (=> (= temp_1_0~383@ (Add (Sub (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@))) (Mul c1~14@ (Add b1~12@ (Mul a1~10@ b1~12@))))) (=> (= temp_1_1~432@ (Add (Sub (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@))) (Mul c1~14@ (Add b1~12@ (Mul a1~10@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~383@ temp_1_1~432@))) (=> (= temp_1_0~383@ temp_1_1~432@) (=> (= temp_2_0~517@ (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ a2~18@) d2~24@)) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ c2~22@))))) (=> (= temp_2_1~578@ (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ a2~18@) d2~24@)) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~517@ temp_2_1~578@))) (=> (= temp_2_0~517@ temp_2_1~578@) (=> (= temp_3_0~663@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul d3~32@ (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~724@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ a3~26@) c3~30@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~663@ temp_3_1~724@))))))))))))))))))))
(assert %%query%%)
(check-sat)
