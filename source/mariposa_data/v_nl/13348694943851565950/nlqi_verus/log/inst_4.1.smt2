...
(set-info :comment ";; mariposa_data/v_nl//13348694943851565950/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_3_1~766@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Sub (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) (Mul a0~2@ (Mul b0~4@ a0~2@))) a0~2@)) (=> (= temp_0_1~310@ (Sub (Mul (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) a0~2@) (Mul (Mul a0~2@ (Mul b0~4@ a0~2@)) a0~2@))) (and (=> (= tmp%1@ (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@))) (=> (= tmp%2@ (Mul a0~2@ (Mul b0~4@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ a0~2@) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~310@))))) (=> (= temp_0_0~273@ temp_0_1~310@) (=> (= temp_1_0~409@ (Add (Sub (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@))) (Mul c1~14@ (Add b1~12@ (Mul a1~10@ b1~12@))))) (=> (= temp_1_1~458@ (Add (Sub (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@))) (Mul c1~14@ (Add b1~12@ (Mul a1~10@ b1~12@))))) (and (=> (= tmp%3@ (Mul b1~12@ d1~16@)) (=> (= tmp%4@ (Mul d1~16@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~409@ temp_1_1~458@))))) (=> (= temp_1_0~409@ temp_1_1~458@) (=> (= temp_2_0~555@ (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ a2~18@) d2~24@)) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ c2~22@))))) (=> (= temp_2_1~616@ (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ a2~18@) d2~24@)) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ c2~22@) (=> %%location_label%%2 (= temp_2_0~555@ temp_2_1~616@))) (=> (= temp_2_0~555@ temp_2_1~616@) (=> (= temp_3_0~705@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul d3~32@ (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~766@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ a3~26@) c3~30@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. d3~32@ a3~26@ c3~30@) (=> %%location_label%%3 (= temp_3_0~705@ temp_3_1~766@))))))))))))))))))))
(assert %%query%%)
(check-sat)
