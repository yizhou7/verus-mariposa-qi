...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Sub (Mul 53 a0~2@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul c0~6@ d0~8@) (Add d0~8@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~394@ (Mul (Mul (Sub (Mul 53 a0~2@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul c0~6@ d0~8@) (Add d0~8@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~471@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ c1~14@)) a1~10@) (Sub (Mul (Sub b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~524@ (Mul (Mul (Mul (Mul (Mul b1~12@ b1~12@) d1~16@) c1~14@) a1~10@) (Sub (Mul (Sub b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~471@ temp_1_1~524@))) (=> (= temp_1_0~471@ temp_1_1~524@) (=> (= temp_2_0~629@ (Mul (Mul (Mul c2~22@ (Add b2~20@ b2~20@)) (Mul (Sub c2~22@ 38) (Sub b2~20@ d2~24@))) (Mul (Mul (Mul d2~24@ 49) a2~18@) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~710@ (Mul (Mul (Mul c2~22@ (Add b2~20@ b2~20@)) (Mul (Sub b2~20@ d2~24@) (Sub c2~22@ 38))) (Mul (Mul (Mul d2~24@ 49) a2~18@) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~629@ temp_2_1~710@))) (=> (= temp_2_0~629@ temp_2_1~710@) (=> (= temp_3_0~799@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~864@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~799@ temp_3_1~864@))) (=> (= temp_3_0~799@ temp_3_1~864@) (=> (= temp_4_0~949@ (Add (Mul (Mul c4~38@ (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul c4~38@ d4~40@) (Add c4~38@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~1010@ (Add (Mul (Mul c4~38@ (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))) (Mul (Mul (Add c4~38@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~949@ temp_4_1~1010@))) (=> (= temp_4_0~949@ temp_4_1~1010@) (=> (= temp_5_0~1099@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Mul (Sub b5~44@ c5~46@) (Mul b5~44@ b5~44@)) (Sub (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1164@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Mul (Sub b5~44@ c5~46@) (Mul b5~44@ b5~44@)) (Sub (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1099@ temp_5_1~1164@))) (=> (= temp_5_0~1099@ temp_5_1~1164@) (=> (= temp_6_0~1249@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul d6~56@ (Mul a6~50@ d6~56@))))) (=> (= temp_6_1~1310@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ d6~56@) d6~56@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1249@ temp_6_1~1310@))) (=> (= temp_6_0~1249@ temp_6_1~1310@) (=> (= temp_7_0~1411@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Add a7~58@ d7~64@)) (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@))) (Add (Sub (Mul d7~64@ 54) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1488@ (Mul (Mul (Mul a7~58@ a7~58@) (Mul (Add a7~58@ d7~64@) (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@)))) (Add (Sub (Mul d7~64@ 54) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1411@ temp_7_1~1488@))) (=> (= temp_7_0~1411@ temp_7_1~1488@) (=> (= temp_8_0~1573@ (Sub (Mul (Sub (Mul d8~72@ a8~66@) (Add a8~66@ c8~70@)) (Add (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@))) (Sub (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ c8~70@)) (Mul d8~72@ (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1634@ (Sub (Mul (Add (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@)) (Sub (Mul d8~72@ a8~66@) (Add a8~66@ c8~70@))) (Sub (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ c8~70@)) (Mul d8~72@ (Mul d8~72@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1573@ temp_8_1~1634@))) (=> (= temp_8_0~1573@ temp_8_1~1634@) (=> (= temp_9_0~1723@ (Mul (Mul (Mul (Add c9~78@ d9~80@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ d9~80@) (Mul d9~80@ c9~78@))) (Mul (Sub (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@)) (Sub (Sub a9~74@ d9~80@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1804@ (Mul (Mul (Mul (Add c9~78@ d9~80@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ d9~80@) (Mul d9~80@ c9~78@))) (Sub (Mul (Sub (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@)) (Sub a9~74@ d9~80@)) (Mul (Sub (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@)) (Mul a9~74@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1723@ temp_9_1~1804@))) (=> (= temp_9_0~1723@ temp_9_1~1804@) (=> (= temp_10_0~1893@ (Add (Mul (Mul (Sub a10~82@ d10~88@) (Mul a10~82@ d10~88@)) (Mul (Sub d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Add c10~86@ d10~88@))))) (=> (= temp_10_1~1966@ (Add (Mul (Sub (Mul a10~82@ (Mul a10~82@ d10~88@)) (Mul d10~88@ (Mul a10~82@ d10~88@))) (Mul (Sub d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Add c10~86@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1893@ temp_10_1~1966@))) (=> (= temp_10_0~1893@ temp_10_1~1966@) (=> (= temp_11_0~2051@ (Add (Mul (Mul d11~96@ (Sub a11~90@ b11~92@)) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ c11~94@))) (Sub (Add (Mul d11~96@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ b11~92@))))) (=> (= temp_11_1~2112@ (Add (Mul (Mul d11~96@ (Sub a11~90@ b11~92@)) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ c11~94@))) (Sub (Add (Mul d11~96@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul a11~90@ c11~94@) (Mul b11~92@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2051@ temp_11_1~2112@))) (=> (= temp_11_0~2051@ temp_11_1~2112@) (=> (= temp_12_0~2197@ (Mul (Add (Add b12~100@ (Mul b12~100@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ b12~100@))) (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ b12~100@))))) (=> (= temp_12_1~2258@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ b12~100@))) (Add (Add b12~100@ (Mul b12~100@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2197@ temp_12_1~2258@))) (=> (= temp_12_0~2197@ temp_12_1~2258@) (=> (= temp_13_0~2359@ (Mul (Mul (Sub (Sub d13~112@ a13~106@) (Add c13~110@ a13~106@)) (Mul (Mul b13~108@ c13~110@) (Sub c13~110@ b13~108@))) (Mul (Sub (Mul b13~108@ c13~110@) (Mul 58 a13~106@)) (Add (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))))) (=> (= temp_13_1~2436@ (Mul (Mul (Mul (Sub (Sub d13~112@ a13~106@) (Add c13~110@ a13~106@)) (Mul b13~108@ c13~110@)) (Sub c13~110@ b13~108@)) (Mul (Sub (Mul b13~108@ c13~110@) (Mul 58 a13~106@)) (Add (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2359@ temp_13_1~2436@))) (=> (= temp_13_0~2359@ temp_13_1~2436@) (=> (= temp_14_0~2509@ (Mul (Mul (Add (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul b14~116@ c14~118@) (Add b14~116@ a14~114@))) (Mul a14~114@ (Sub d14~120@ (Add b14~116@ c14~118@))))) (=> (= temp_14_1~2558@ (Mul (Mul a14~114@ (Sub d14~120@ (Add b14~116@ c14~118@))) (Mul (Add (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul b14~116@ c14~118@) (Add b14~116@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2509@ temp_14_1~2558@))) (=> (= temp_14_0~2509@ temp_14_1~2558@) (=> (= temp_15_0~2639@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) b15~124@) (Mul (Mul b15~124@ c15~126@) d15~128@)) (Mul (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@)) (Add (Mul c15~126@ d15~128@) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~2696@ (Mul (Mul (Mul a15~122@ c15~126@) b15~124@) (Mul (Mul (Mul b15~124@ c15~126@) d15~128@) (Mul (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@)) (Add (Mul c15~126@ d15~128@) (Mul d15~128@ a15~122@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2639@ temp_15_1~2696@))) (=> (= temp_15_0~2639@ temp_15_1~2696@) (=> (= temp_16_0~2781@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@)) (Mul d16~136@ (Mul a16~130@ c16~134@))) (Mul (Mul (Mul c16~134@ c16~134@) (Mul b16~132@ d16~136@)) (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ b16~132@))))) (=> (= temp_16_1~2842@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@)) (Mul d16~136@ (Mul a16~130@ c16~134@))) (Mul (Mul (Mul (Mul c16~134@ c16~134@) (Mul b16~132@ d16~136@)) (Mul c16~134@ b16~132@)) (Mul b16~132@ b16~132@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2781@ temp_16_1~2842@))) (=> (= temp_16_0~2781@ temp_16_1~2842@) (=> (= temp_17_0~2919@ (Mul (Mul (Mul (Add a17~138@ d17~144@) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ b17~140@) (Mul a17~138@ b17~140@))) (Mul (Add (Sub a17~138@ b17~140@) (Mul c17~142@ b17~140@)) c17~142@))) (=> (= temp_17_1~2972@ (Mul (Mul (Mul (Add a17~138@ d17~144@) (Mul d17~144@ d17~144@)) (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ b17~140@))) (Mul (Add (Sub a17~138@ b17~140@) (Mul c17~142@ b17~140@)) c17~142@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2919@ temp_17_1~2972@))) (=> (= temp_17_0~2919@ temp_17_1~2972@) (=> (= temp_18_0~3061@ (Add (Mul (Mul (Mul b18~148@ a18~146@) (Mul b18~148@ d18~152@)) (Sub (Mul d18~152@ c18~150@) (Add c18~150@ c18~150@))) (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ a18~146@))))) (=> (= temp_18_1~3126@ (Add (Mul (Mul (Mul b18~148@ a18~146@) (Mul b18~148@ d18~152@)) (Sub (Mul d18~152@ c18~150@) (Add c18~150@ c18~150@))) (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3061@ temp_18_1~3126@))) (=> (= temp_18_0~3061@ temp_18_1~3126@) (=> (= temp_19_0~3215@ (Mul (Mul (Sub (Mul b19~156@ b19~156@) (Add b19~156@ c19~158@)) (Mul (Mul a19~154@ a19~154@) (Mul a19~154@ c19~158@))) (Mul (Mul (Mul a19~154@ c19~158@) (Add c19~158@ c19~158@)) (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ d19~160@))))) (=> (= temp_19_1~3280@ (Mul (Mul (Sub (Mul b19~156@ b19~156@) (Add b19~156@ c19~158@)) (Mul (Mul a19~154@ a19~154@) (Mul a19~154@ c19~158@))) (Mul (Mul (Mul c19~158@ a19~154@) (Add c19~158@ c19~158@)) (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3215@ temp_19_1~3280@))) (=> (= temp_19_0~3215@ temp_19_1~3280@) (=> (= temp_20_0~3369@ (Mul (Mul (Mul (Mul b20~164@ c20~166@) (Mul d20~168@ c20~166@)) (Mul (Mul d20~168@ a20~162@) (Sub b20~164@ d20~168@))) (Mul (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ d20~168@)) (Mul (Sub b20~164@ a20~162@) (Mul b20~164@ c20~166@))))) (=> (= temp_20_1~3434@ (Mul (Mul (Mul (Mul d20~168@ c20~166@) (Mul b20~164@ c20~166@)) (Mul (Mul d20~168@ a20~162@) (Sub b20~164@ d20~168@))) (Mul (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ d20~168@)) (Mul (Sub b20~164@ a20~162@) (Mul b20~164@ c20~166@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3369@ temp_20_1~3434@))) (=> (= temp_20_0~3369@ temp_20_1~3434@) (=> (= temp_21_0~3523@ (Mul (Add (Sub (Mul d21~176@ c21~174@) (Mul c21~174@ b21~172@)) (Mul (Mul b21~172@ a21~170@) (Mul b21~172@ a21~170@))) (Mul (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ a21~170@)) (Mul (Mul c21~174@ a21~170@) (Sub c21~174@ a21~170@))))) (=> (= temp_21_1~3588@ (Mul (Add (Sub (Mul d21~176@ c21~174@) (Mul c21~174@ b21~172@)) (Mul (Mul b21~172@ a21~170@) (Mul b21~172@ a21~170@))) (Mul (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ a21~170@)) (Mul (Mul a21~170@ c21~174@) (Sub c21~174@ a21~170@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3523@ temp_21_1~3588@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
