...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Sub (Mul 53 a0~2@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul c0~6@ d0~8@) (Add d0~8@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~394@ (Mul (Mul (Sub (Mul 53 a0~2@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul c0~6@ d0~8@) (Add d0~8@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~317@ temp_0_1~394@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~462@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ c1~14@)) a1~10@) (Sub (Mul (Sub b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~515@ (Mul (Mul (Mul (Mul (Mul b1~12@ b1~12@) d1~16@) c1~14@) a1~10@) (Sub (Mul (Sub b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~462@ temp_1_1~515@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~611@ (Mul (Mul (Mul c2~22@ (Add b2~20@ b2~20@)) (Mul (Sub c2~22@ 38) (Sub b2~20@ d2~24@))) (Mul (Mul (Mul d2~24@ 49) a2~18@) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~692@ (Mul (Mul (Mul c2~22@ (Add b2~20@ b2~20@)) (Mul (Sub b2~20@ d2~24@) (Sub c2~22@ 38))) (Mul (Mul (Mul d2~24@ 49) a2~18@) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~611@ temp_2_1~692@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~772@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~837@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~772@ temp_3_1~837@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~913@ (Add (Mul (Mul c4~38@ (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul c4~38@ d4~40@) (Add c4~38@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~974@ (Add (Mul (Mul c4~38@ (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))) (Mul (Mul (Add c4~38@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~913@ temp_4_1~974@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1054@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Mul (Sub b5~44@ c5~46@) (Mul b5~44@ b5~44@)) (Sub (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1119@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Mul (Sub b5~44@ c5~46@) (Mul b5~44@ b5~44@)) (Sub (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1054@ temp_5_1~1119@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1195@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul d6~56@ (Mul a6~50@ d6~56@))))) (=> (= temp_6_1~1256@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ d6~56@) d6~56@)))) (=> (= tmp%7@ (= temp_6_0~1195@ temp_6_1~1256@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1348@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Add a7~58@ d7~64@)) (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@))) (Add (Sub (Mul d7~64@ 54) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1425@ (Mul (Mul (Mul a7~58@ a7~58@) (Mul (Add a7~58@ d7~64@) (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@)))) (Add (Sub (Mul d7~64@ 54) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1348@ temp_7_1~1425@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1501@ (Sub (Mul (Sub (Mul d8~72@ a8~66@) (Add a8~66@ c8~70@)) (Add (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@))) (Sub (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ c8~70@)) (Mul d8~72@ (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1562@ (Sub (Mul (Add (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@)) (Sub (Mul d8~72@ a8~66@) (Add a8~66@ c8~70@))) (Sub (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ c8~70@)) (Mul d8~72@ (Mul d8~72@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1501@ temp_8_1~1562@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1642@ (Mul (Mul (Mul (Add c9~78@ d9~80@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ d9~80@) (Mul d9~80@ c9~78@))) (Mul (Sub (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@)) (Sub (Sub a9~74@ d9~80@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1723@ (Mul (Mul (Mul (Add c9~78@ d9~80@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ d9~80@) (Mul d9~80@ c9~78@))) (Sub (Mul (Sub (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@)) (Sub a9~74@ d9~80@)) (Mul (Sub (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@)) (Mul a9~74@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1642@ temp_9_1~1723@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1803@ (Add (Mul (Mul (Sub a10~82@ d10~88@) (Mul a10~82@ d10~88@)) (Mul (Sub d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Add c10~86@ d10~88@))))) (=> (= temp_10_1~1876@ (Add (Mul (Sub (Mul a10~82@ (Mul a10~82@ d10~88@)) (Mul d10~88@ (Mul a10~82@ d10~88@))) (Mul (Sub d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Add c10~86@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1803@ temp_10_1~1876@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1952@ (Add (Mul (Mul d11~96@ (Sub a11~90@ b11~92@)) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ c11~94@))) (Sub (Add (Mul d11~96@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ b11~92@))))) (=> (= temp_11_1~2013@ (Add (Mul (Mul d11~96@ (Sub a11~90@ b11~92@)) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ c11~94@))) (Sub (Add (Mul d11~96@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul a11~90@ c11~94@) (Mul b11~92@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1952@ temp_11_1~2013@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2089@ (Mul (Add (Add b12~100@ (Mul b12~100@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ b12~100@))) (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ b12~100@))))) (=> (= temp_12_1~2150@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ b12~100@))) (Add (Add b12~100@ (Mul b12~100@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ b12~100@))))) (=> (= tmp%13@ (= temp_12_0~2089@ temp_12_1~2150@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2242@ (Mul (Mul (Sub (Sub d13~112@ a13~106@) (Add c13~110@ a13~106@)) (Mul (Mul b13~108@ c13~110@) (Sub c13~110@ b13~108@))) (Mul (Sub (Mul b13~108@ c13~110@) (Mul 58 a13~106@)) (Add (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))))) (=> (= temp_13_1~2319@ (Mul (Mul (Mul (Sub (Sub d13~112@ a13~106@) (Add c13~110@ a13~106@)) (Mul b13~108@ c13~110@)) (Sub c13~110@ b13~108@)) (Mul (Sub (Mul b13~108@ c13~110@) (Mul 58 a13~106@)) (Add (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))))) (=> (= tmp%14@ (= temp_13_0~2242@ temp_13_1~2319@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2383@ (Mul (Mul (Add (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul b14~116@ c14~118@) (Add b14~116@ a14~114@))) (Mul a14~114@ (Sub d14~120@ (Add b14~116@ c14~118@))))) (=> (= temp_14_1~2432@ (Mul (Mul a14~114@ (Sub d14~120@ (Add b14~116@ c14~118@))) (Mul (Add (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul b14~116@ c14~118@) (Add b14~116@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2383@ temp_14_1~2432@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2504@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) b15~124@) (Mul (Mul b15~124@ c15~126@) d15~128@)) (Mul (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@)) (Add (Mul c15~126@ d15~128@) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~2561@ (Mul (Mul (Mul a15~122@ c15~126@) b15~124@) (Mul (Mul (Mul b15~124@ c15~126@) d15~128@) (Mul (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@)) (Add (Mul c15~126@ d15~128@) (Mul d15~128@ a15~122@)))))) (=> (= tmp%16@ (= temp_15_0~2504@ temp_15_1~2561@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2637@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@)) (Mul d16~136@ (Mul a16~130@ c16~134@))) (Mul (Mul (Mul c16~134@ c16~134@) (Mul b16~132@ d16~136@)) (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ b16~132@))))) (=> (= temp_16_1~2698@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@)) (Mul d16~136@ (Mul a16~130@ c16~134@))) (Mul (Mul (Mul (Mul c16~134@ c16~134@) (Mul b16~132@ d16~136@)) (Mul c16~134@ b16~132@)) (Mul b16~132@ b16~132@)))) (=> (= tmp%17@ (= temp_16_0~2637@ temp_16_1~2698@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2766@ (Mul (Mul (Mul (Add a17~138@ d17~144@) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ b17~140@) (Mul a17~138@ b17~140@))) (Mul (Add (Sub a17~138@ b17~140@) (Mul c17~142@ b17~140@)) c17~142@))) (=> (= temp_17_1~2819@ (Mul (Mul (Mul (Add a17~138@ d17~144@) (Mul d17~144@ d17~144@)) (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ b17~140@))) (Mul (Add (Sub a17~138@ b17~140@) (Mul c17~142@ b17~140@)) c17~142@))) (=> (= tmp%18@ (= temp_17_0~2766@ temp_17_1~2819@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2899@ (Add (Mul (Mul (Mul b18~148@ a18~146@) (Mul b18~148@ d18~152@)) (Sub (Mul d18~152@ c18~150@) (Add c18~150@ c18~150@))) (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ a18~146@))))) (=> (= temp_18_1~2964@ (Add (Mul (Mul (Mul b18~148@ a18~146@) (Mul b18~148@ d18~152@)) (Sub (Mul d18~152@ c18~150@) (Add c18~150@ c18~150@))) (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ a18~146@))))) (=> (= tmp%19@ (= temp_18_0~2899@ temp_18_1~2964@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3044@ (Mul (Mul (Sub (Mul b19~156@ b19~156@) (Add b19~156@ c19~158@)) (Mul (Mul a19~154@ a19~154@) (Mul a19~154@ c19~158@))) (Mul (Mul (Mul a19~154@ c19~158@) (Add c19~158@ c19~158@)) (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ d19~160@))))) (=> (= temp_19_1~3109@ (Mul (Mul (Sub (Mul b19~156@ b19~156@) (Add b19~156@ c19~158@)) (Mul (Mul a19~154@ a19~154@) (Mul a19~154@ c19~158@))) (Mul (Mul (Mul c19~158@ a19~154@) (Add c19~158@ c19~158@)) (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ d19~160@))))) (=> (= tmp%20@ (= temp_19_0~3044@ temp_19_1~3109@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3189@ (Mul (Mul (Mul (Mul b20~164@ c20~166@) (Mul d20~168@ c20~166@)) (Mul (Mul d20~168@ a20~162@) (Sub b20~164@ d20~168@))) (Mul (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ d20~168@)) (Mul (Sub b20~164@ a20~162@) (Mul b20~164@ c20~166@))))) (=> (= temp_20_1~3254@ (Mul (Mul (Mul (Mul d20~168@ c20~166@) (Mul b20~164@ c20~166@)) (Mul (Mul d20~168@ a20~162@) (Sub b20~164@ d20~168@))) (Mul (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ d20~168@)) (Mul (Sub b20~164@ a20~162@) (Mul b20~164@ c20~166@))))) (=> (= tmp%21@ (= temp_20_0~3189@ temp_20_1~3254@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3334@ (Mul (Add (Sub (Mul d21~176@ c21~174@) (Mul c21~174@ b21~172@)) (Mul (Mul b21~172@ a21~170@) (Mul b21~172@ a21~170@))) (Mul (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ a21~170@)) (Mul (Mul c21~174@ a21~170@) (Sub c21~174@ a21~170@))))) (=> (= temp_21_1~3399@ (Mul (Add (Sub (Mul d21~176@ c21~174@) (Mul c21~174@ b21~172@)) (Mul (Mul b21~172@ a21~170@) (Mul b21~172@ a21~170@))) (Mul (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ a21~170@)) (Mul (Mul a21~170@ c21~174@) (Sub c21~174@ a21~170@))))) (=> (= tmp%22@ (= temp_21_0~3334@ temp_21_1~3399@)) (=> %%location_label%%21 tmp%22@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
