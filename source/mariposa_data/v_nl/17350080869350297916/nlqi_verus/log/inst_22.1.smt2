...
(set-info :comment ";; mariposa_data/v_nl//17350080869350297916/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_3_0~837@ Int)
(declare-const temp_3_1~902@ Int)
(declare-const temp_4_0~1047@ Int)
(declare-const temp_4_1~1108@ Int)
(declare-const temp_5_0~1209@ Int)
(declare-const temp_5_1~1274@ Int)
(declare-const temp_6_0~1363@ Int)
(declare-const temp_6_1~1424@ Int)
(declare-const temp_7_0~1533@ Int)
(declare-const temp_7_1~1610@ Int)
(declare-const temp_8_0~1721@ Int)
(declare-const temp_8_1~1782@ Int)
(declare-const temp_9_0~1899@ Int)
(declare-const temp_9_1~1980@ Int)
(declare-const temp_10_0~2095@ Int)
(declare-const temp_10_1~2168@ Int)
(declare-const temp_11_0~2263@ Int)
(declare-const temp_11_1~2324@ Int)
(declare-const temp_12_0~2413@ Int)
(declare-const temp_12_1~2474@ Int)
(declare-const temp_13_0~2631@ Int)
(declare-const temp_13_1~2708@ Int)
(declare-const temp_14_0~2807@ Int)
(declare-const temp_14_1~2856@ Int)
(declare-const temp_15_0~2981@ Int)
(declare-const temp_15_1~3038@ Int)
(declare-const temp_16_0~3173@ Int)
(declare-const temp_16_1~3234@ Int)
(declare-const temp_17_0~3337@ Int)
(declare-const temp_17_1~3390@ Int)
(declare-const temp_18_0~3491@ Int)
(declare-const temp_18_1~3556@ Int)
(declare-const temp_19_0~3657@ Int)
(declare-const temp_19_1~3722@ Int)
(declare-const temp_20_0~3815@ Int)
(declare-const temp_20_1~3880@ Int)
(declare-const temp_21_0~3981@ Int)
(declare-const temp_21_1~4046@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Sub (Mul 53 a0~2@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul c0~6@ d0~8@) (Add d0~8@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~394@ (Mul (Mul (Sub (Mul 53 a0~2@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul c0~6@ d0~8@) (Add d0~8@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ c0~6@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~475@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ c1~14@)) a1~10@) (Sub (Mul (Sub b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~528@ (Mul (Mul (Mul (Mul (Mul b1~12@ b1~12@) d1~16@) c1~14@) a1~10@) (Sub (Mul (Sub b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ d1~16@))))) (and (=> (= tmp%1@ (Mul b1~12@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~475@ temp_1_1~528@)))) (=> (= temp_1_0~475@ temp_1_1~528@) (=> (= temp_2_0~643@ (Mul (Mul (Mul c2~22@ (Add b2~20@ b2~20@)) (Mul (Sub c2~22@ 38) (Sub b2~20@ d2~24@))) (Mul (Mul (Mul d2~24@ 49) a2~18@) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~724@ (Mul (Mul (Mul c2~22@ (Add b2~20@ b2~20@)) (Mul (Sub b2~20@ d2~24@) (Sub c2~22@ 38))) (Mul (Mul (Mul d2~24@ 49) a2~18@) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))))) (and (=> (= tmp%2@ (Sub c2~22@ 38)) (=> (= tmp%3@ (Sub b2~20@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~643@ temp_2_1~724@))))) (=> (= temp_2_0~643@ temp_2_1~724@) (=> (= temp_3_0~837@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~902@ (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@))))) (and (=> (= tmp%4@ (Mul (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)))) (=> (= tmp%5@ (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~837@ temp_3_1~902@))))) (=> (= temp_3_0~837@ temp_3_1~902@) (=> (= temp_4_0~1047@ (Add (Mul (Mul c4~38@ (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul c4~38@ d4~40@) (Add c4~38@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~1108@ (Add (Mul (Mul c4~38@ (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))) (Mul (Mul (Add c4~38@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ a4~34@))))) (and (=> (= tmp%6@ (Mul c4~38@ d4~40@)) (=> (= tmp%7@ (Add c4~38@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%4 (= temp_4_0~1047@ temp_4_1~1108@))))) (=> (= temp_4_0~1047@ temp_4_1~1108@) (=> (= temp_5_0~1209@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Mul (Sub b5~44@ c5~46@) (Mul b5~44@ b5~44@)) (Sub (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1274@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Mul (Sub b5~44@ c5~46@) (Mul b5~44@ b5~44@)) (Sub (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1209@ temp_5_1~1274@))) (=> (= temp_5_0~1209@ temp_5_1~1274@) (=> (= temp_6_0~1363@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul d6~56@ (Mul a6~50@ d6~56@))))) (=> (= temp_6_1~1424@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ d6~56@) d6~56@)))) (and (=> (= tmp%8@ (Mul a6~50@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~1363@ temp_6_1~1424@)))) (=> (= temp_6_0~1363@ temp_6_1~1424@) (=> (= temp_7_0~1533@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Add a7~58@ d7~64@)) (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@))) (Add (Sub (Mul d7~64@ 54) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1610@ (Mul (Mul (Mul a7~58@ a7~58@) (Mul (Add a7~58@ d7~64@) (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@)))) (Add (Sub (Mul d7~64@ 54) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@))))) (and (=> (= tmp%9@ (Mul a7~58@ a7~58@)) (=> (= tmp%10@ (Add a7~58@ d7~64@)) (=> (= tmp%11@ (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%7 (= temp_7_0~1533@ temp_7_1~1610@)))))) (=> (= temp_7_0~1533@ temp_7_1~1610@) (=> (= temp_8_0~1721@ (Sub (Mul (Sub (Mul d8~72@ a8~66@) (Add a8~66@ c8~70@)) (Add (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@))) (Sub (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ c8~70@)) (Mul d8~72@ (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1782@ (Sub (Mul (Add (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@)) (Sub (Mul d8~72@ a8~66@) (Add a8~66@ c8~70@))) (Sub (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ c8~70@)) (Mul d8~72@ (Mul d8~72@ a8~66@))))) (and (=> (= tmp%12@ (Sub (Mul d8~72@ a8~66@) (Add a8~66@ c8~70@))) (=> (= tmp%13@ (Add (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%8 (= temp_8_0~1721@ temp_8_1~1782@))))) (=> (= temp_8_0~1721@ temp_8_1~1782@) (=> (= temp_9_0~1899@ (Mul (Mul (Mul (Add c9~78@ d9~80@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ d9~80@) (Mul d9~80@ c9~78@))) (Mul (Sub (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@)) (Sub (Sub a9~74@ d9~80@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1980@ (Mul (Mul (Mul (Add c9~78@ d9~80@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ d9~80@) (Mul d9~80@ c9~78@))) (Sub (Mul (Sub (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@)) (Sub a9~74@ d9~80@)) (Mul (Sub (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@)) (Mul a9~74@ c9~78@))))) (and (=> (= tmp%14@ (Sub (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@))) (=> (= tmp%15@ (Sub a9~74@ d9~80@)) (=> (= tmp%16@ (Mul a9~74@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%9 (= temp_9_0~1899@ temp_9_1~1980@)))))) (=> (= temp_9_0~1899@ temp_9_1~1980@) (=> (= temp_10_0~2095@ (Add (Mul (Mul (Sub a10~82@ d10~88@) (Mul a10~82@ d10~88@)) (Mul (Sub d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Add c10~86@ d10~88@))))) (=> (= temp_10_1~2168@ (Add (Mul (Sub (Mul a10~82@ (Mul a10~82@ d10~88@)) (Mul d10~88@ (Mul a10~82@ d10~88@))) (Mul (Sub d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Add c10~86@ d10~88@))))) (and (=> (= tmp%17@ (Mul a10~82@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a10~82@ d10~88@ tmp%17@) (=> %%location_label%%10 (= temp_10_0~2095@ temp_10_1~2168@)))) (=> (= temp_10_0~2095@ temp_10_1~2168@) (=> (= temp_11_0~2263@ (Add (Mul (Mul d11~96@ (Sub a11~90@ b11~92@)) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ c11~94@))) (Sub (Add (Mul d11~96@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ b11~92@))))) (=> (= temp_11_1~2324@ (Add (Mul (Mul d11~96@ (Sub a11~90@ b11~92@)) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ c11~94@))) (Sub (Add (Mul d11~96@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul a11~90@ c11~94@) (Mul b11~92@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c11~94@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2263@ temp_11_1~2324@))) (=> (= temp_11_0~2263@ temp_11_1~2324@) (=> (= temp_12_0~2413@ (Mul (Add (Add b12~100@ (Mul b12~100@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ b12~100@))) (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ b12~100@))))) (=> (= temp_12_1~2474@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ b12~100@))) (Add (Add b12~100@ (Mul b12~100@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ b12~100@))))) (and (=> (= tmp%18@ (Add (Add b12~100@ (Mul b12~100@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ b12~100@)))) (=> (= tmp%19@ (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ b12~100@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%12 (= temp_12_0~2413@ temp_12_1~2474@))))) (=> (= temp_12_0~2413@ temp_12_1~2474@) (=> (= temp_13_0~2631@ (Mul (Mul (Sub (Sub d13~112@ a13~106@) (Add c13~110@ a13~106@)) (Mul (Mul b13~108@ c13~110@) (Sub c13~110@ b13~108@))) (Mul (Sub (Mul b13~108@ c13~110@) (Mul 58 a13~106@)) (Add (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))))) (=> (= temp_13_1~2708@ (Mul (Mul (Mul (Sub (Sub d13~112@ a13~106@) (Add c13~110@ a13~106@)) (Mul b13~108@ c13~110@)) (Sub c13~110@ b13~108@)) (Mul (Sub (Mul b13~108@ c13~110@) (Mul 58 a13~106@)) (Add (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))))) (and (=> (= tmp%20@ (Sub (Sub d13~112@ a13~106@) (Add c13~110@ a13~106@))) (=> (= tmp%21@ (Mul b13~108@ c13~110@)) (=> (= tmp%22@ (Sub c13~110@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%13 (= temp_13_0~2631@ temp_13_1~2708@)))))) (=> (= temp_13_0~2631@ temp_13_1~2708@) (=> (= temp_14_0~2807@ (Mul (Mul (Add (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul b14~116@ c14~118@) (Add b14~116@ a14~114@))) (Mul a14~114@ (Sub d14~120@ (Add b14~116@ c14~118@))))) (=> (= temp_14_1~2856@ (Mul (Mul a14~114@ (Sub d14~120@ (Add b14~116@ c14~118@))) (Mul (Add (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul b14~116@ c14~118@) (Add b14~116@ a14~114@))))) (and (=> (= tmp%23@ (Mul (Add (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul b14~116@ c14~118@) (Add b14~116@ a14~114@)))) (=> (= tmp%24@ (Mul a14~114@ (Sub d14~120@ (Add b14~116@ c14~118@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> %%location_label%%14 (= temp_14_0~2807@ temp_14_1~2856@))))) (=> (= temp_14_0~2807@ temp_14_1~2856@) (=> (= temp_15_0~2981@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) b15~124@) (Mul (Mul b15~124@ c15~126@) d15~128@)) (Mul (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@)) (Add (Mul c15~126@ d15~128@) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~3038@ (Mul (Mul (Mul a15~122@ c15~126@) b15~124@) (Mul (Mul (Mul b15~124@ c15~126@) d15~128@) (Mul (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@)) (Add (Mul c15~126@ d15~128@) (Mul d15~128@ a15~122@)))))) (and (=> (= tmp%25@ (Mul (Mul a15~122@ c15~126@) b15~124@)) (=> (= tmp%26@ (Mul (Mul b15~124@ c15~126@) d15~128@)) (=> (= tmp%27@ (Mul (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@)) (Add (Mul c15~126@ d15~128@) (Mul d15~128@ a15~122@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%15 (= temp_15_0~2981@ temp_15_1~3038@)))))) (=> (= temp_15_0~2981@ temp_15_1~3038@) (=> (= temp_16_0~3173@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@)) (Mul d16~136@ (Mul a16~130@ c16~134@))) (Mul (Mul (Mul c16~134@ c16~134@) (Mul b16~132@ d16~136@)) (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ b16~132@))))) (=> (= temp_16_1~3234@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@)) (Mul d16~136@ (Mul a16~130@ c16~134@))) (Mul (Mul (Mul (Mul c16~134@ c16~134@) (Mul b16~132@ d16~136@)) (Mul c16~134@ b16~132@)) (Mul b16~132@ b16~132@)))) (and (=> (= tmp%28@ (Mul (Mul c16~134@ c16~134@) (Mul b16~132@ d16~136@))) (=> (= tmp%29@ (Mul c16~134@ b16~132@)) (=> (= tmp%30@ (Mul b16~132@ b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%16 (= temp_16_0~3173@ temp_16_1~3234@)))))) (=> (= temp_16_0~3173@ temp_16_1~3234@) (=> (= temp_17_0~3337@ (Mul (Mul (Mul (Add a17~138@ d17~144@) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ b17~140@) (Mul a17~138@ b17~140@))) (Mul (Add (Sub a17~138@ b17~140@) (Mul c17~142@ b17~140@)) c17~142@))) (=> (= temp_17_1~3390@ (Mul (Mul (Mul (Add a17~138@ d17~144@) (Mul d17~144@ d17~144@)) (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ b17~140@))) (Mul (Add (Sub a17~138@ b17~140@) (Mul c17~142@ b17~140@)) c17~142@))) (and (=> (= tmp%31@ (Mul b17~140@ b17~140@)) (=> (= tmp%32@ (Mul a17~138@ b17~140@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%31@ tmp%32@) (=> %%location_label%%17 (= temp_17_0~3337@ temp_17_1~3390@))))) (=> (= temp_17_0~3337@ temp_17_1~3390@) (=> (= temp_18_0~3491@ (Add (Mul (Mul (Mul b18~148@ a18~146@) (Mul b18~148@ d18~152@)) (Sub (Mul d18~152@ c18~150@) (Add c18~150@ c18~150@))) (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ a18~146@))))) (=> (= temp_18_1~3556@ (Add (Mul (Mul (Mul b18~148@ a18~146@) (Mul b18~148@ d18~152@)) (Sub (Mul d18~152@ c18~150@) (Add c18~150@ c18~150@))) (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ a18~146@))))) (and (=> (= tmp%33@ (Mul a18~146@ a18~146@)) (=> (= tmp%34@ (Mul c18~150@ a18~146@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%33@ tmp%34@) (=> %%location_label%%18 (= temp_18_0~3491@ temp_18_1~3556@))))) (=> (= temp_18_0~3491@ temp_18_1~3556@) (=> (= temp_19_0~3657@ (Mul (Mul (Sub (Mul b19~156@ b19~156@) (Add b19~156@ c19~158@)) (Mul (Mul a19~154@ a19~154@) (Mul a19~154@ c19~158@))) (Mul (Mul (Mul a19~154@ c19~158@) (Add c19~158@ c19~158@)) (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ d19~160@))))) (=> (= temp_19_1~3722@ (Mul (Mul (Sub (Mul b19~156@ b19~156@) (Add b19~156@ c19~158@)) (Mul (Mul a19~154@ a19~154@) (Mul a19~154@ c19~158@))) (Mul (Mul (Mul c19~158@ a19~154@) (Add c19~158@ c19~158@)) (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a19~154@ c19~158@) (=> %%location_label%%19 (= temp_19_0~3657@ temp_19_1~3722@))) (=> (= temp_19_0~3657@ temp_19_1~3722@) (=> (= temp_20_0~3815@ (Mul (Mul (Mul (Mul b20~164@ c20~166@) (Mul d20~168@ c20~166@)) (Mul (Mul d20~168@ a20~162@) (Sub b20~164@ d20~168@))) (Mul (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ d20~168@)) (Mul (Sub b20~164@ a20~162@) (Mul b20~164@ c20~166@))))) (=> (= temp_20_1~3880@ (Mul (Mul (Mul (Mul d20~168@ c20~166@) (Mul b20~164@ c20~166@)) (Mul (Mul d20~168@ a20~162@) (Sub b20~164@ d20~168@))) (Mul (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ d20~168@)) (Mul (Sub b20~164@ a20~162@) (Mul b20~164@ c20~166@))))) (and (=> (= tmp%35@ (Mul b20~164@ c20~166@)) (=> (= tmp%36@ (Mul d20~168@ c20~166@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%35@ tmp%36@) (=> %%location_label%%20 (= temp_20_0~3815@ temp_20_1~3880@))))) (=> (= temp_20_0~3815@ temp_20_1~3880@) (=> (= temp_21_0~3981@ (Mul (Add (Sub (Mul d21~176@ c21~174@) (Mul c21~174@ b21~172@)) (Mul (Mul b21~172@ a21~170@) (Mul b21~172@ a21~170@))) (Mul (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ a21~170@)) (Mul (Mul c21~174@ a21~170@) (Sub c21~174@ a21~170@))))) (=> (= temp_21_1~4046@ (Mul (Add (Sub (Mul d21~176@ c21~174@) (Mul c21~174@ b21~172@)) (Mul (Mul b21~172@ a21~170@) (Mul b21~172@ a21~170@))) (Mul (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ a21~170@)) (Mul (Mul a21~170@ c21~174@) (Sub c21~174@ a21~170@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c21~174@ a21~170@) (=> %%location_label%%21 (= temp_21_0~3981@ temp_21_1~4046@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
