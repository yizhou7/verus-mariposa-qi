...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Sub a0~2@ d0~8@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~370@ (Add (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Sub a0~2@ d0~8@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~450@ (Add (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~515@ (Add (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~450@ temp_1_1~515@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~595@ (Add (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ a2~18@)) (Sub (Mul d2~24@ a2~18@) (Mul a2~18@ b2~20@))) (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~660@ (Add (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ a2~18@)) (Sub (Mul d2~24@ a2~18@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~595@ temp_2_1~660@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~748@ (Mul (Add (Mul (Add d3~32@ c3~30@) b3~28@) (Mul (Mul d3~32@ a3~26@) (Sub d3~32@ 92))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub a3~26@ c3~30@)) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~821@ (Mul (Add (Mul (Add d3~32@ c3~30@) b3~28@) (Mul (Mul d3~32@ a3~26@) (Sub d3~32@ 92))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub a3~26@ c3~30@)) (Mul b3~28@ (Mul a3~26@ (Mul b3~28@ a3~26@)))))) (=> (= tmp%4@ (= temp_3_0~748@ temp_3_1~821@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~901@ (Sub (Sub (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Sub (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~966@ (Sub (Sub (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Sub (Mul c4~38@ d4~40@) (Mul a4~34@ c4~38@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~901@ temp_4_1~966@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1034@ (Mul (Sub (Mul (Mul b5~44@ a5~42@) d5~48@) (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Add b5~44@ c5~46@) a5~42@) (Mul d5~48@ (Sub b5~44@ d5~48@))))) (=> (= temp_5_1~1111@ (Sub (Mul (Mul (Mul b5~44@ a5~42@) d5~48@) (Mul (Mul (Add b5~44@ c5~46@) a5~42@) (Mul d5~48@ (Sub b5~44@ d5~48@)))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ b5~44@)) (Mul (Mul (Add b5~44@ c5~46@) a5~42@) (Mul d5~48@ (Sub b5~44@ d5~48@)))))) (=> (= tmp%6@ (= temp_5_0~1034@ temp_5_1~1111@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1199@ (Add (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Add c6~54@ b6~52@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul d6~56@ 61) c6~54@) (Mul (Sub d6~56@ c6~54@) (Mul a6~50@ d6~56@))))) (=> (= temp_6_1~1272@ (Add (Mul (Mul (Mul (Mul c6~54@ d6~56@) c6~54@) a6~50@) (Mul (Add c6~54@ b6~52@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul d6~56@ 61) c6~54@) (Mul (Sub d6~56@ c6~54@) (Mul a6~50@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1199@ temp_6_1~1272@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1348@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ d7~64@)) (Add d7~64@ (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1409@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ d7~64@)) (Add d7~64@ (Mul a7~58@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1348@ temp_7_1~1409@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1481@ (Mul (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul a8~66@ (Mul b8~68@ c8~70@))) (Mul (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ d8~72@) b8~68@)))) (=> (= temp_8_1~1538@ (Mul (Mul (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul a8~66@ (Mul b8~68@ c8~70@))) (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@))) (Mul (Mul b8~68@ d8~72@) b8~68@))) (=> (= tmp%9@ (= temp_8_0~1481@ temp_8_1~1538@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1618@ (Mul (Sub (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@))) (Mul (Mul (Mul d9~80@ b9~76@) (Sub b9~76@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~1683@ (Mul (Sub (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@))) (Mul (Mul (Mul d9~80@ b9~76@) (Sub b9~76@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ b9~76@))))) (=> (= tmp%10@ (= temp_9_0~1618@ temp_9_1~1683@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1763@ (Add (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul a10~82@ (Sub (Mul 35 d10~88@) (Mul a10~82@ d10~88@))))) (=> (= temp_10_1~1832@ (Add (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Sub (Mul a10~82@ (Mul 35 d10~88@)) (Mul a10~82@ (Mul a10~82@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1763@ temp_10_1~1832@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1912@ (Add (Mul (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ b11~92@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~1977@ (Add (Mul (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1912@ temp_11_1~1977@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2049@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ c12~102@))) (Mul (Add (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) d12~104@)))) (=> (= temp_12_1~2106@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ d12~104@)) (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ c12~102@))) (Mul (Add (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) d12~104@)))) (=> (= tmp%13@ (= temp_12_0~2049@ temp_12_1~2106@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2186@ (Add (Mul d13~112@ (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul a13~106@ c13~110@)) (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ 45))))) (=> (= temp_13_1~2251@ (Add (Mul d13~112@ (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul (Mul d13~112@ c13~110@) a13~106@) c13~110@) (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ 45))))) (=> (= tmp%14@ (= temp_13_0~2186@ temp_13_1~2251@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2343@ (Mul (Mul (Mul (Mul a14~114@ 67) (Mul d14~120@ c14~118@)) (Sub (Mul c14~118@ c14~118@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Add b14~116@ b14~116@) (Sub c14~118@ a14~114@))))) (=> (= temp_14_1~2420@ (Mul (Mul (Sub (Mul c14~118@ c14~118@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ 67) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Add b14~116@ b14~116@) (Sub c14~118@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2343@ temp_14_1~2420@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2504@ (Sub (Mul (Add c15~126@ (Mul a15~122@ c15~126@)) (Mul (Mul 77 a15~122@) (Mul a15~122@ a15~122@))) (Mul (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ b15~124@)) (Mul c15~126@ (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~2573@ (Sub (Mul (Mul (Mul 77 a15~122@) (Mul a15~122@ a15~122@)) (Add c15~126@ (Mul a15~122@ c15~126@))) (Mul (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ b15~124@)) (Mul c15~126@ (Mul a15~122@ c15~126@))))) (=> (= tmp%16@ (= temp_15_0~2504@ temp_15_1~2573@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2653@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Sub c16~134@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Sub d16~136@ d16~136@))) (Mul (Mul (Add a16~130@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ c16~134@))))) (=> (= temp_16_1~2718@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Sub c16~134@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Sub d16~136@ d16~136@))) (Mul (Mul (Add a16~130@ d16~136@) (Mul d16~136@ d16~136@)) (Mul b16~132@ (Mul a16~130@ (Mul b16~132@ c16~134@)))))) (=> (= tmp%17@ (= temp_16_0~2653@ temp_16_1~2718@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2802@ (Mul (Mul (Add (Mul b17~140@ d17~144@) c17~142@) (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul b17~140@ a17~138@) (Mul b17~140@ b17~140@)) (Mul b17~140@ (Sub 19 d17~144@))))) (=> (= temp_17_1~2871@ (Mul (Mul (Add (Mul b17~140@ d17~144@) c17~142@) (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ b17~140@))) (Mul (Mul b17~140@ a17~138@) (Mul (Mul b17~140@ b17~140@) (Mul b17~140@ (Sub 19 d17~144@)))))) (=> (= tmp%18@ (= temp_17_0~2802@ temp_17_1~2871@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2951@ (Mul (Add (Mul (Sub d18~152@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Mul a18~146@ d18~152@) (Add a18~146@ a18~146@))) (Mul (Mul (Add b18~148@ c18~150@) (Add c18~150@ a18~146@)) (Mul (Mul b18~148@ d18~152@) (Mul c18~150@ c18~150@))))) (=> (= temp_18_1~3016@ (Mul (Add (Mul (Sub d18~152@ b18~148@) (Mul b18~148@ c18~150@)) (Mul a18~146@ (Mul d18~152@ (Add a18~146@ a18~146@)))) (Mul (Mul (Add b18~148@ c18~150@) (Add c18~150@ a18~146@)) (Mul (Mul b18~148@ d18~152@) (Mul c18~150@ c18~150@))))) (=> (= tmp%19@ (= temp_18_0~2951@ temp_18_1~3016@)) (=> %%location_label%%18 tmp%19@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
