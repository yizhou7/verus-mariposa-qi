...
(set-info :comment ";; mariposa_data/v_nl//3027989785754094706/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_4_1~1032@ Int)
...
(declare-const temp_8_0~1647@ Int)
(declare-const temp_8_1~1704@ Int)
...
(declare-const temp_11_0~2185@ Int)
...
(declare-const temp_14_0~2669@ Int)
(declare-const temp_14_1~2746@ Int)
(declare-const temp_15_0~2879@ Int)
(declare-const temp_15_1~2948@ Int)
(declare-const temp_16_0~3073@ Int)
(declare-const temp_16_1~3138@ Int)
(declare-const temp_17_0~3241@ Int)
(declare-const temp_17_1~3310@ Int)
(declare-const temp_18_0~3433@ Int)
(declare-const temp_18_1~3498@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Sub a0~2@ d0~8@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~370@ (Add (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Sub a0~2@ d0~8@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@))))) (and (=> (= tmp%1@ (Sub a0~2@ d0~8@)) (=> (= tmp%2@ (Mul a0~2@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~471@ (Add (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~536@ (Add (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ a1~10@) (=> %%location_label%%1 (= temp_1_0~471@ temp_1_1~536@))) (=> (= temp_1_0~471@ temp_1_1~536@) (=> (= temp_2_0~629@ (Add (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ a2~18@)) (Sub (Mul d2~24@ a2~18@) (Mul a2~18@ b2~20@))) (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~694@ (Add (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ a2~18@)) (Sub (Mul d2~24@ a2~18@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ b2~20@) (=> %%location_label%%2 (= temp_2_0~629@ temp_2_1~694@))) (=> (= temp_2_0~629@ temp_2_1~694@) (=> (= temp_3_0~795@ (Mul (Add (Mul (Add d3~32@ c3~30@) b3~28@) (Mul (Mul d3~32@ a3~26@) (Sub d3~32@ 92))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub a3~26@ c3~30@)) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~868@ (Mul (Add (Mul (Add d3~32@ c3~30@) b3~28@) (Mul (Mul d3~32@ a3~26@) (Sub d3~32@ 92))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub a3~26@ c3~30@)) (Mul b3~28@ (Mul a3~26@ (Mul b3~28@ a3~26@)))))) (and (=> (= tmp%3@ (Mul b3~28@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b3~28@ a3~26@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~795@ temp_3_1~868@)))) (=> (= temp_3_0~795@ temp_3_1~868@) (=> (= temp_4_0~967@ (Sub (Sub (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Sub (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~1032@ (Sub (Sub (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Sub (Mul c4~38@ d4~40@) (Mul a4~34@ c4~38@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ c4~38@) (=> %%location_label%%4 (= temp_4_0~967@ temp_4_1~1032@))) (=> (= temp_4_0~967@ temp_4_1~1032@) (=> (= temp_5_0~1113@ (Mul (Sub (Mul (Mul b5~44@ a5~42@) d5~48@) (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Add b5~44@ c5~46@) a5~42@) (Mul d5~48@ (Sub b5~44@ d5~48@))))) (=> (= temp_5_1~1190@ (Sub (Mul (Mul (Mul b5~44@ a5~42@) d5~48@) (Mul (Mul (Add b5~44@ c5~46@) a5~42@) (Mul d5~48@ (Sub b5~44@ d5~48@)))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ b5~44@)) (Mul (Mul (Add b5~44@ c5~46@) a5~42@) (Mul d5~48@ (Sub b5~44@ d5~48@)))))) (and (=> (= tmp%4@ (Mul (Mul b5~44@ a5~42@) d5~48@)) (=> (= tmp%5@ (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ b5~44@))) (=> (= tmp%6@ (Mul (Mul (Add b5~44@ c5~46@) a5~42@) (Mul d5~48@ (Sub b5~44@ d5~48@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~1113@ temp_5_1~1190@)))))) (=> (= temp_5_0~1113@ temp_5_1~1190@) (=> (= temp_6_0~1333@ (Add (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Add c6~54@ b6~52@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul d6~56@ 61) c6~54@) (Mul (Sub d6~56@ c6~54@) (Mul a6~50@ d6~56@))))) (=> (= temp_6_1~1406@ (Add (Mul (Mul (Mul (Mul c6~54@ d6~56@) c6~54@) a6~50@) (Mul (Add c6~54@ b6~52@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul d6~56@ 61) c6~54@) (Mul (Sub d6~56@ c6~54@) (Mul a6~50@ d6~56@))))) (and (=> (= tmp%7@ (Mul c6~54@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ c6~54@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1333@ temp_6_1~1406@)))) (=> (= temp_6_0~1333@ temp_6_1~1406@) (=> (= temp_7_0~1501@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ d7~64@)) (Add d7~64@ (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1562@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ d7~64@)) (Add d7~64@ (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1501@ temp_7_1~1562@))) (=> (= temp_7_0~1501@ temp_7_1~1562@) (=> (= temp_8_0~1647@ (Mul (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul a8~66@ (Mul b8~68@ c8~70@))) (Mul (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ d8~72@) b8~68@)))) (=> (= temp_8_1~1704@ (Mul (Mul (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul a8~66@ (Mul b8~68@ c8~70@))) (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@))) (Mul (Mul b8~68@ d8~72@) b8~68@))) (and (=> (= tmp%8@ (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul a8~66@ (Mul b8~68@ c8~70@)))) (=> (= tmp%9@ (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@))) (=> (= tmp%10@ (Mul (Mul b8~68@ d8~72@) b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%8 (= temp_8_0~1647@ temp_8_1~1704@)))))) (=> (= temp_8_0~1647@ temp_8_1~1704@) (=> (= temp_9_0~1843@ (Mul (Sub (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@))) (Mul (Mul (Mul d9~80@ b9~76@) (Sub b9~76@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~1908@ (Mul (Sub (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@))) (Mul (Mul (Mul d9~80@ b9~76@) (Sub b9~76@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b9~76@ d9~80@) (=> %%location_label%%9 (= temp_9_0~1843@ temp_9_1~1908@))) (=> (= temp_9_0~1843@ temp_9_1~1908@) (=> (= temp_10_0~2001@ (Add (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul a10~82@ (Sub (Mul 35 d10~88@) (Mul a10~82@ d10~88@))))) (=> (= temp_10_1~2070@ (Add (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Sub (Mul a10~82@ (Mul 35 d10~88@)) (Mul a10~82@ (Mul a10~82@ d10~88@))))) (and (=> (= tmp%11@ (Mul 35 d10~88@)) (=> (= tmp%12@ (Mul a10~82@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a10~82@ tmp%11@ tmp%12@) (=> %%location_label%%10 (= temp_10_0~2001@ temp_10_1~2070@))))) (=> (= temp_10_0~2001@ temp_10_1~2070@) (=> (= temp_11_0~2185@ (Add (Mul (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ b11~92@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~2250@ (Add (Mul (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ a11~90@))))) (and (=> (= tmp%13@ (Mul c11~94@ b11~92@)) (=> (= tmp%14@ (Mul a11~90@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%11 (= temp_11_0~2185@ temp_11_1~2250@))))) (=> (= temp_11_0~2185@ temp_11_1~2250@) (=> (= temp_12_0~2343@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ c12~102@))) (Mul (Add (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) d12~104@)))) (=> (= temp_12_1~2400@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ d12~104@)) (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ c12~102@))) (Mul (Add (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) d12~104@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d12~104@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2343@ temp_12_1~2400@))) (=> (= temp_12_0~2343@ temp_12_1~2400@) (=> (= temp_13_0~2493@ (Add (Mul d13~112@ (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul a13~106@ c13~110@)) (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ 45))))) (=> (= temp_13_1~2558@ (Add (Mul d13~112@ (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul (Mul d13~112@ c13~110@) a13~106@) c13~110@) (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ 45))))) (and (=> (= tmp%15@ (Mul d13~112@ c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ a13~106@ c13~110@) (=> %%location_label%%13 (= temp_13_0~2493@ temp_13_1~2558@)))) (=> (= temp_13_0~2493@ temp_13_1~2558@) (=> (= temp_14_0~2669@ (Mul (Mul (Mul (Mul a14~114@ 67) (Mul d14~120@ c14~118@)) (Sub (Mul c14~118@ c14~118@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Add b14~116@ b14~116@) (Sub c14~118@ a14~114@))))) (=> (= temp_14_1~2746@ (Mul (Mul (Sub (Mul c14~118@ c14~118@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ 67) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Add b14~116@ b14~116@) (Sub c14~118@ a14~114@))))) (and (=> (= tmp%16@ (Mul (Mul a14~114@ 67) (Mul d14~120@ c14~118@))) (=> (= tmp%17@ (Sub (Mul c14~118@ c14~118@) (Mul b14~116@ a14~114@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%14 (= temp_14_0~2669@ temp_14_1~2746@))))) (=> (= temp_14_0~2669@ temp_14_1~2746@) (=> (= temp_15_0~2879@ (Sub (Mul (Add c15~126@ (Mul a15~122@ c15~126@)) (Mul (Mul 77 a15~122@) (Mul a15~122@ a15~122@))) (Mul (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ b15~124@)) (Mul c15~126@ (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~2948@ (Sub (Mul (Mul (Mul 77 a15~122@) (Mul a15~122@ a15~122@)) (Add c15~126@ (Mul a15~122@ c15~126@))) (Mul (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ b15~124@)) (Mul c15~126@ (Mul a15~122@ c15~126@))))) (and (=> (= tmp%18@ (Add c15~126@ (Mul a15~122@ c15~126@))) (=> (= tmp%19@ (Mul (Mul 77 a15~122@) (Mul a15~122@ a15~122@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%15 (= temp_15_0~2879@ temp_15_1~2948@))))) (=> (= temp_15_0~2879@ temp_15_1~2948@) (=> (= temp_16_0~3073@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Sub c16~134@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Sub d16~136@ d16~136@))) (Mul (Mul (Add a16~130@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ c16~134@))))) (=> (= temp_16_1~3138@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Sub c16~134@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Sub d16~136@ d16~136@))) (Mul (Mul (Add a16~130@ d16~136@) (Mul d16~136@ d16~136@)) (Mul b16~132@ (Mul a16~130@ (Mul b16~132@ c16~134@)))))) (and (=> (= tmp%20@ (Mul b16~132@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b16~132@ a16~130@ tmp%20@) (=> %%location_label%%16 (= temp_16_0~3073@ temp_16_1~3138@)))) (=> (= temp_16_0~3073@ temp_16_1~3138@) (=> (= temp_17_0~3241@ (Mul (Mul (Add (Mul b17~140@ d17~144@) c17~142@) (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul b17~140@ a17~138@) (Mul b17~140@ b17~140@)) (Mul b17~140@ (Sub 19 d17~144@))))) (=> (= temp_17_1~3310@ (Mul (Mul (Add (Mul b17~140@ d17~144@) c17~142@) (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ b17~140@))) (Mul (Mul b17~140@ a17~138@) (Mul (Mul b17~140@ b17~140@) (Mul b17~140@ (Sub 19 d17~144@)))))) (and (=> (= tmp%21@ (Mul b17~140@ a17~138@)) (=> (= tmp%22@ (Mul b17~140@ b17~140@)) (=> (= tmp%23@ (Mul b17~140@ (Sub 19 d17~144@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%17 (= temp_17_0~3241@ temp_17_1~3310@)))))) (=> (= temp_17_0~3241@ temp_17_1~3310@) (=> (= temp_18_0~3433@ (Mul (Add (Mul (Sub d18~152@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Mul a18~146@ d18~152@) (Add a18~146@ a18~146@))) (Mul (Mul (Add b18~148@ c18~150@) (Add c18~150@ a18~146@)) (Mul (Mul b18~148@ d18~152@) (Mul c18~150@ c18~150@))))) (=> (= temp_18_1~3498@ (Mul (Add (Mul (Sub d18~152@ b18~148@) (Mul b18~148@ c18~150@)) (Mul a18~146@ (Mul d18~152@ (Add a18~146@ a18~146@)))) (Mul (Mul (Add b18~148@ c18~150@) (Add c18~150@ a18~146@)) (Mul (Mul b18~148@ d18~152@) (Mul c18~150@ c18~150@))))) (=> (= tmp%24@ (Add a18~146@ a18~146@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a18~146@ d18~152@ tmp%24@) (=> %%location_label%%18 (= temp_18_0~3433@ temp_18_1~3498@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
