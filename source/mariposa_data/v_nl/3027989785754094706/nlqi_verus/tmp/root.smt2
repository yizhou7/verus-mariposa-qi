...
(push)
 ...
 (declare-const temp_8_0~1553@ Int)
 ...
 (declare-const temp_11_1~2076@ Int)
 ...
 (declare-const temp_18_0~3113@ Int)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~459@ (Add (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@)) (Mul (Mul b1~12@
              c1~14@
             ) (Mul c1~14@ a1~10@)
            )
         ...
         (=>
          (= temp_1_1~524@ (Add (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@
               c1~14@
              ) (Mul c1~14@ a1~10@)
             )
            ) (Mul (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Mul b1~12@
          ...
          (and
           ...
           (=>
            (= temp_1_0~459@ temp_1_1~524@)
            (=>
             (= temp_2_0~613@ (Add (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ a2~18@)) (Sub (Mul d2~24@
                  a2~18@
                 ) (Mul a2~18@ b2~20@)
                )
             ...
             (=>
              (= temp_2_1~678@ (Add (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ a2~18@)) (Sub (Mul d2~24@
                   a2~18@
                  ) (Mul b2~20@ a2~18@)
                 )
                ) (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@
              ...
              (and
               ...
               (=>
                (= temp_2_0~613@ temp_2_1~678@)
                (=>
                 (= temp_3_0~775@ (Mul (Add (Mul (Add d3~32@ c3~30@) b3~28@) (Mul (Mul d3~32@ a3~26@)
                     (Sub d3~32@ 92)
                    )
                 ...
                 (=>
                  (= temp_3_1~848@ (Mul (Add (Mul (Add d3~32@ c3~30@) b3~28@) (Mul (Mul d3~32@ a3~26@)
                      (Sub d3~32@ 92)
                     )
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~775@ temp_3_1~848@)
                   ))
                   (=>
                    (= temp_3_0~775@ temp_3_1~848@)
                    (=>
                     (= temp_4_0~937@ (Sub (Sub (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Sub (Mul d4~40@
                          c4~38@
                         ) (Mul a4~34@ c4~38@)
                        )
                     ...
                     (=>
                      (= temp_4_1~1002@ (Sub (Sub (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Sub (Mul c4~38@
                           d4~40@
                          ) (Mul a4~34@ c4~38@)
                         )
                        ) (Sub (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~937@ temp_4_1~1002@)
                        (=>
                         (= temp_5_0~1079@ (Mul (Sub (Mul (Mul b5~44@ a5~42@) d5~48@) (Mul (Mul b5~44@ c5~46@)
                             (Mul c5~46@ b5~44@)
                            )
                           ) (Mul (Mul (Add b5~44@ c5~46@) a5~42@) (Mul d5~48@ (Sub b5~44@ d5~48@)))
                         ))
                         (=>
                          (= temp_5_1~1156@ (Sub (Mul (Mul (Mul b5~44@ a5~42@) d5~48@) (Mul (Mul (Add b5~44@ c5~46@)
                               a5~42@
                          ...
                          (and
                           ...
                           (=>
                            (= temp_5_0~1079@ temp_5_1~1156@)
                            (=>
                             (= temp_6_0~1253@ (Add (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Add c6~54@
                                  b6~52@
                                 ) (Mul b6~52@ a6~50@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1326@ (Add (Mul (Mul (Mul (Mul c6~54@ d6~56@) c6~54@) a6~50@) (Mul (Add c6~54@
                                   b6~52@
                                  ) (Mul b6~52@ a6~50@)
                                 )
                                ) (Mul (Mul (Mul d6~56@ 61) c6~54@) (Mul (Sub d6~56@ c6~54@) (Mul a6~50@ d6~56@)))
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1253@ temp_6_1~1326@)
                               ))
                               (=>
                                (= temp_6_0~1253@ temp_6_1~1326@)
                                (=>
                                 (= temp_7_0~1411@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@
                                      d7~64@
                                     ) (Mul b7~60@ b7~60@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1472@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@
                                       d7~64@
                                      ) (Mul b7~60@ b7~60@)
                                     )
                                    ) (Mul (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ d7~64@)) (Add d7~64@ (Mul a7~58@ a7~58@)))
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1411@ temp_7_1~1472@)
                                   ))
                                   (=>
                                    (= temp_7_0~1411@ temp_7_1~1472@)
                                    (=>
                                     (= temp_8_0~1553@ (Mul (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul a8~66@
                                         (Mul b8~68@ c8~70@)
                                        )
                                       ) (Mul (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ d8~72@) b8~68@))
                                     ))
                                     (=>
                                      (= temp_8_1~1610@ (Mul (Mul (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul a8~66@
                                           (Mul b8~68@ c8~70@)
                                          )
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1553@ temp_8_1~1610@)
                                       ))
                                       (=>
                                        (= temp_8_0~1553@ temp_8_1~1610@)
                                        (=>
                                         (= temp_9_0~1699@ (Mul (Sub (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@
                                              d9~80@
                                             ) (Add c9~78@ a9~74@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1764@ (Mul (Sub (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@
                                               d9~80@
                                              ) (Add c9~78@ a9~74@)
                                             )
                                          ...
                                          (and
                                           ...
                                           (=>
                                            (= temp_9_0~1699@ temp_9_1~1764@)
                                            (=>
                                             (= temp_10_0~1853@ (Add (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ d10~88@)) (Mul (
                                                  Mul d10~88@ b10~84@
                                                 ) (Mul c10~86@ a10~82@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1922@ (Add (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ d10~88@)) (Mul (
                                                   Mul d10~88@ b10~84@
                                                  ) (Mul c10~86@ a10~82@)
                                                 )
                                              ...
                                              (and
                                               ...
                                               (=>
                                                (= temp_10_0~1853@ temp_10_1~1922@)
                                                (=>
                                                 (= temp_11_0~2011@ (Add (Mul (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (
                                                      Mul c11~94@ b11~92@
                                                     ) (Mul a11~90@ b11~92@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2076@ (Add (Mul (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (
                                                       Mul a11~90@ b11~92@
                                                      ) (Mul c11~94@ b11~92@)
                                                     )
                                                    ) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ b11~92@)) (Mul (Mul d11~96@ a11~90@)
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~2011@ temp_11_1~2076@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~2011@ temp_11_1~2076@)
                                                    (=>
                                                     (= temp_12_0~2157@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) (Mul
                                                         (Mul c12~102@ b12~100@) (Mul a12~98@ c12~102@)
                                                        )
                                                       ) (Mul (Add (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) d12~104@))
                                                     ))
                                                     (=>
                                                      (= temp_12_1~2214@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ d12~104@)) (Mul
                                                          (Mul c12~102@ b12~100@) (Mul a12~98@ c12~102@)
                                                         )
                                                        ) (Mul (Add (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) d12~104@))
                                                      ))
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2157@ temp_12_1~2214@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2157@ temp_12_1~2214@)
                                                        (=>
                                                         (= temp_13_0~2303@ (Add (Mul d13~112@ (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ d13~112@)))
                                                           (Mul (Mul (Mul d13~112@ c13~110@) (Mul a13~106@ c13~110@)) (Mul (Mul d13~112@ a13~106@)
                                                             (Mul a13~106@ 45)
                                                         ))))
                                                         (=>
                                                          (= temp_13_1~2368@ (Add (Mul d13~112@ (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ d13~112@)))
                                                          ...
                                                          (and
                                                           ...
                                                           (=>
                                                            (= temp_13_0~2303@ temp_13_1~2368@)
                                                            (=>
                                                             (= temp_14_0~2469@ (Mul (Mul (Mul (Mul a14~114@ 67) (Mul d14~120@ c14~118@)) (Sub (Mul
                                                                  c14~118@ c14~118@
                                                                 ) (Mul b14~116@ a14~114@)
                                                                )
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2546@ (Mul (Mul (Sub (Mul c14~118@ c14~118@) (Mul b14~116@ a14~114@)) (
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2469@ temp_14_1~2546@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2469@ temp_14_1~2546@)
                                                                (=>
                                                                 (= temp_15_0~2639@ (Sub (Mul (Add c15~126@ (Mul a15~122@ c15~126@)) (Mul (Mul 77 a15~122@)
                                                                     (Mul a15~122@ a15~122@)
                                                                    )
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2708@ (Sub (Mul (Mul (Mul 77 a15~122@) (Mul a15~122@ a15~122@)) (Add c15~126@
                                                                      (Mul a15~122@ c15~126@)
                                                                     )
                                                                    ) (Mul (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ b15~124@)) (Mul c15~126@ (Mul a15~122@
                                                                       c15~126@
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2639@ temp_15_1~2708@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2639@ temp_15_1~2708@)
                                                                    (=>
                                                                     (= temp_16_0~2797@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Sub c16~134@ c16~134@)) (
                                                                     ...
                                                                     (=>
                                                                      (= temp_16_1~2862@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Sub c16~134@ c16~134@)) (
                                                                          Mul (Mul d16~136@ b16~132@) (Sub d16~136@ d16~136@)
                                                                         )
                                                                      ...
                                                                      (and
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         %%location_label%%16
                                                                         (= temp_16_0~2797@ temp_16_1~2862@)
                                                                       ))
                                                                       (=>
                                                                        (= temp_16_0~2797@ temp_16_1~2862@)
                                                                        (=>
                                                                         (= temp_17_0~2955@ (Mul (Mul (Add (Mul b17~140@ d17~144@) c17~142@) (Mul (Mul d17~144@
                                                                              c17~142@
                                                                             ) (Mul b17~140@ b17~140@)
                                                                            )
                                                                         ...
                                                                         (=>
                                                                          (= temp_17_1~3024@ (Mul (Mul (Add (Mul b17~140@ d17~144@) c17~142@) (Mul (Mul d17~144@
                                                                               c17~142@
                                                                              ) (Mul b17~140@ b17~140@)
                                                                             )
                                                                          ...
                                                                          (and
                                                                           (=>
                                                                            ...
                                                                            (=>
                                                                             %%location_label%%17
                                                                             (= temp_17_0~2955@ temp_17_1~3024@)
                                                                           ))
                                                                           (=>
                                                                            (= temp_17_0~2955@ temp_17_1~3024@)
                                                                            (=>
                                                                             (= temp_18_0~3113@ (Mul (Add (Mul (Sub d18~152@ b18~148@) (Mul b18~148@ c18~150@)) (
                                                                             ...
                                                                             (=>
                                                                              (= temp_18_1~3178@ (Mul (Add (Mul (Sub d18~152@ b18~148@) (Mul b18~148@ c18~150@)) (
