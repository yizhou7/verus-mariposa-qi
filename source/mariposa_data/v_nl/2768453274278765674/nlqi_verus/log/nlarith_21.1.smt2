...
(assert (=> %%query%% (not (=> (= temp_0_0~281@ (Mul (Add b0~4@ (Mul (Sub c0~6@ d0~8@) (Mul d0~8@ d0~8@))) (Mul b0~4@ (Mul (Mul b0~4@ c0~6@) (Sub b0~4@ b0~4@))))) (=> (= temp_0_1~322@ (Mul (Add b0~4@ (Mul (Mul d0~8@ d0~8@) (Sub c0~6@ d0~8@))) (Mul b0~4@ (Mul (Mul b0~4@ c0~6@) (Sub b0~4@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~281@ temp_0_1~322@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~426@ (Mul (Sub (Mul (Sub 85 c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Add (Mul (Mul 29 c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~559@ (Add (Mul (Sub (Mul (Sub 85 c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Mul 29 c1~14@) (Mul c1~14@ d1~16@))) (Mul (Sub (Mul (Sub 85 c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~426@ temp_1_1~559@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~639@ (Add (Mul (Add (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@)) (Mul (Add a2~18@ b2~20@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul a2~18@ b2~20@) (Add b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~704@ (Add (Mul (Add (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@)) (Mul (Add a2~18@ b2~20@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul a2~18@ b2~20@) (Add b2~20@ c2~22@)) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~639@ temp_2_1~704@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~796@ (Mul (Mul (Sub (Add a3~26@ b3~28@) (Mul 85 a3~26@)) (Mul (Add d3~32@ d3~32@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~873@ (Mul (Mul (Sub (Add a3~26@ b3~28@) (Mul 85 a3~26@)) (Mul (Mul c3~30@ c3~30@) (Add d3~32@ d3~32@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~796@ temp_3_1~873@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~949@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) b4~36@) (Mul (Sub d4~40@ d4~40@) (Sub c4~38@ c4~38@))) (Add (Mul (Mul a4~34@ b4~36@) (Sub c4~38@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Add d4~40@ a4~34@))))) (=> (= temp_4_1~1010@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) b4~36@) (Mul (Sub d4~40@ d4~40@) (Sub c4~38@ c4~38@))) (Add (Mul (Mul b4~36@ a4~34@) (Sub c4~38@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Add d4~40@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~949@ temp_4_1~1010@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1114@ (Sub (Sub (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@)) (Mul (Add 98 c5~46@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ 54))))) (=> (= temp_5_1~1203@ (Sub (Sub (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Add 98 c5~46@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ 54))))) (=> (= tmp%6@ (= temp_5_0~1114@ temp_5_1~1203@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1243@ (Mul (Mul d6~56@ c6~54@) (Mul (Mul (Mul c6~54@ c6~54@) c6~54@) c6~54@))) (=> (= temp_6_1~1268@ (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ (Mul (Mul c6~54@ c6~54@) c6~54@)))) (=> (= tmp%7@ (= temp_6_0~1243@ temp_6_1~1268@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1320@ (Mul a7~58@ (Mul (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Add b7~60@ a7~58@))))) (=> (= temp_7_1~1357@ (Mul a7~58@ (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Add b7~60@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1320@ temp_7_1~1357@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1433@ (Mul (Mul (Mul (Sub b8~68@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Add c8~70@ d8~72@) a8~66@)) (Mul (Add (Mul a8~66@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Add d8~72@ a8~66@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1494@ (Mul (Mul (Sub b8~68@ c8~70@) (Mul (Mul a8~66@ b8~68@) (Mul (Add c8~70@ d8~72@) a8~66@))) (Mul (Add (Mul a8~66@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Add d8~72@ a8~66@) (Mul a8~66@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1433@ temp_8_1~1494@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1598@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul 52 d9~80@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ b9~76@))) (Mul (Sub (Mul a9~74@ a9~74@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@ a9~74@) (Mul 20 a9~74@))))) (=> (= temp_9_1~1687@ (Mul (Mul (Mul (Mul 52 d9~80@) (Mul d9~80@ a9~74@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ b9~76@))) (Mul (Sub (Mul a9~74@ a9~74@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@ a9~74@) (Mul 20 a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1598@ temp_9_1~1687@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1763@ (Mul (Mul (Mul a10~82@ (Add b10~84@ b10~84@)) (Mul (Sub b10~84@ b10~84@) (Mul a10~82@ c10~86@))) (Sub (Mul (Sub c10~86@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Add c10~86@ a10~82@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~1824@ (Mul (Mul (Mul a10~82@ (Add b10~84@ b10~84@)) (Mul (Sub b10~84@ b10~84@) (Mul a10~82@ c10~86@))) (Sub (Mul (Sub c10~86@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Add c10~86@ a10~82@) (Mul d10~88@ b10~84@))))) (=> (= tmp%11@ (= temp_10_0~1763@ temp_10_1~1824@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1876@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@)) (Mul (Mul a11~90@ a11~90@) (Sub b11~92@ b11~92@))) d11~96@)) (=> (= temp_11_1~1913@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@)) (Mul a11~90@ (Mul a11~90@ (Sub b11~92@ b11~92@)))) d11~96@)) (=> (= tmp%12@ (= temp_11_0~1876@ temp_11_1~1913@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2005@ (Mul (Mul (Add (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@)) (Sub (Mul 15 c12~102@) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul b12~100@ a12~98@) (Add b12~100@ b12~100@)) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ b12~100@))))) (=> (= temp_12_1~2082@ (Mul (Mul (Add (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@)) (Sub (Mul 15 c12~102@) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul b12~100@ a12~98@) (Add b12~100@ b12~100@)) (Mul (Mul a12~98@ b12~100@) (Mul b12~100@ a12~98@))))) (=> (= tmp%13@ (= temp_12_0~2005@ temp_12_1~2082@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2158@ (Sub (Mul (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@)) (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ d13~112@))) (Mul (Mul b13~108@ (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ a13~106@) (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~2219@ (Sub (Mul (Mul (Mul (Mul a13~106@ a13~106@) b13~108@) c13~110@) (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ d13~112@))) (Mul (Mul b13~108@ (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ a13~106@) (Mul d13~112@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2158@ temp_13_1~2219@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2295@ (Mul (Sub (Mul (Mul d14~120@ c14~118@) c14~118@) (Add (Mul c14~118@ c14~118@) (Add c14~118@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@)) (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2356@ (Mul (Sub (Mul (Mul d14~120@ c14~118@) c14~118@) (Add (Mul c14~118@ c14~118@) (Add c14~118@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@)) (Mul (Mul (Mul c14~118@ d14~120@) b14~116@) c14~118@)))) (=> (= tmp%15@ (= temp_14_0~2295@ temp_14_1~2356@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2436@ (Sub (Mul (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Add a15~122@ c15~126@) (Mul b15~124@ a15~122@))) (Mul (Mul (Mul c15~126@ d15~128@) (Mul d15~128@ a15~122@)) (Sub (Mul a15~122@ c15~126@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2501@ (Sub (Mul (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Add a15~122@ c15~126@) (Mul b15~124@ a15~122@))) (Mul (Mul (Mul (Mul c15~126@ d15~128@) d15~128@) a15~122@) (Sub (Mul a15~122@ c15~126@) (Mul c15~126@ c15~126@))))) (=> (= tmp%16@ (= temp_15_0~2436@ temp_15_1~2501@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2589@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ b16~132@)) (Sub (Mul 0 d16~136@) (Mul b16~132@ a16~130@))) (Mul (Mul (Mul c16~134@ a16~130@) (Add a16~130@ a16~130@)) (Mul c16~134@ (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~2662@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ b16~132@)) (Sub (Mul 0 d16~136@) (Mul b16~132@ a16~130@))) (Mul (Mul c16~134@ (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ a16~130@) (Add a16~130@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2589@ temp_16_1~2662@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2762@ (Mul (Add (Mul (Mul 46 b17~140@) (Mul d17~144@ c17~142@)) (Mul b17~140@ (Add d17~144@ a17~138@))) (Mul (Mul (Sub d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul 67 a17~138@) (Mul b17~140@ d17~144@))))) (=> (= temp_17_1~2847@ (Mul (Mul (Mul (Sub d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul 67 a17~138@) (Mul b17~140@ d17~144@))) (Add (Mul (Mul 46 b17~140@) (Mul d17~144@ c17~142@)) (Mul b17~140@ (Add d17~144@ a17~138@))))) (=> (= tmp%18@ (= temp_17_0~2762@ temp_17_1~2847@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2899@ (Sub (Mul (Add (Add d18~152@ c18~150@) (Sub d18~152@ d18~152@)) (Sub (Mul b18~148@ b18~148@) (Mul c18~150@ b18~148@))) c18~150@)) (=> (= temp_18_1~2936@ (Sub (Mul (Sub (Mul b18~148@ b18~148@) (Mul c18~150@ b18~148@)) (Add (Add d18~152@ c18~150@) (Sub d18~152@ d18~152@))) c18~150@)) (=> (= tmp%19@ (= temp_18_0~2899@ temp_18_1~2936@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3028@ (Mul (Mul (Add (Mul d19~160@ 48) (Add d19~160@ d19~160@)) (Sub (Mul b19~156@ c19~158@) (Sub b19~156@ d19~160@))) (Mul d19~160@ (Mul (Mul 50 c19~158@) (Add b19~156@ a19~154@))))) (=> (= temp_19_1~3105@ (Mul (Mul (Sub (Mul b19~156@ c19~158@) (Sub b19~156@ d19~160@)) (Add (Mul d19~160@ 48) (Add d19~160@ d19~160@))) (Mul d19~160@ (Mul (Mul 50 c19~158@) (Add b19~156@ a19~154@))))) (=> (= tmp%20@ (= temp_19_0~3028@ temp_19_1~3105@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3197@ (Mul (Mul (Mul (Mul c20~166@ d20~168@) (Mul b20~164@ d20~168@)) (Mul (Sub a20~162@ c20~166@) (Mul d20~168@ c20~166@))) (Sub (Mul (Mul b20~164@ c20~166@) (Mul b20~164@ c20~166@)) (Mul (Mul 22 a20~162@) (Mul b20~164@ b20~164@))))) (=> (= temp_20_1~3274@ (Mul (Mul (Mul (Mul c20~166@ d20~168@) (Mul b20~164@ d20~168@)) (Mul (Sub a20~162@ c20~166@) (Mul d20~168@ c20~166@))) (Sub (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ b20~164@)) (Mul (Mul 22 a20~162@) (Mul b20~164@ b20~164@))))) (=> (= tmp%21@ (= temp_20_0~3197@ temp_20_1~3274@)) (=> %%location_label%%20 tmp%21@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
