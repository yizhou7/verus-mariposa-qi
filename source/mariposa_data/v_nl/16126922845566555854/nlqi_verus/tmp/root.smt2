...
;; mariposa_data/v_nl//16126922845566555854/nlqi_verus/src/main.rs:7:1: 36:40 (#0)
(push)
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~305@ (Sub (Sub (Sub (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@)) (Sub (Add b0~4@ a0~2@)
         (Mul a0~2@ a0~2@)
        )
       ) (Sub (Add (Mul a0~2@ c0~6@) (Add d0~8@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@)))
     ))
     (=>
      (= temp_0_1~370@ (Sub (Sub (Sub (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@)) (Sub (Add b0~4@ a0~2@)
          (Mul a0~2@ a0~2@)
         )
        ) (Sub (Add (Mul a0~2@ c0~6@) (Add d0~8@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@)))
      ))
