...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Sub (Mul b0~4@ a0~2@) (Mul c0~6@ b0~4@))) (Sub (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)) (Add (Add d0~8@ b0~4@) (Sub c0~6@ b0~4@))))) (=> (= temp_0_1~386@ (Mul (Sub (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul b0~4@ a0~2@)) (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul c0~6@ b0~4@))) (Sub (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)) (Add (Add d0~8@ b0~4@) (Sub c0~6@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~386@))) (=> (= temp_0_0~305@ temp_0_1~386@) (=> (= temp_1_0~475@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ c1~14@)) (Add (Mul c1~14@ c1~14@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul c1~14@ c1~14@) (Sub c1~14@ d1~16@)) (Sub (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~540@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ c1~14@)) (Add (Mul c1~14@ c1~14@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul c1~14@ c1~14@) (Sub c1~14@ d1~16@)) (Sub (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~475@ temp_1_1~540@))) (=> (= temp_1_0~475@ temp_1_1~540@) (=> (= temp_2_0~605@ (Add (Add d2~24@ (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ a2~18@))) (Mul a2~18@ (Mul (Mul b2~20@ a2~18@) (Add b2~20@ c2~22@))))) (=> (= temp_2_1~646@ (Add (Add d2~24@ (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ a2~18@))) (Mul a2~18@ (Mul b2~20@ (Mul a2~18@ (Add b2~20@ c2~22@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~605@ temp_2_1~646@))) (=> (= temp_2_0~605@ temp_2_1~646@) (=> (= temp_3_0~731@ (Add (Mul (Mul (Mul a3~26@ c3~30@) (Sub c3~30@ b3~28@)) (Mul a3~26@ (Mul d3~32@ c3~30@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~792@ (Add (Mul (Mul (Mul a3~26@ c3~30@) (Sub c3~30@ b3~28@)) (Mul a3~26@ (Mul d3~32@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~731@ temp_3_1~792@))) (=> (= temp_3_0~731@ temp_3_1~792@) (=> (= temp_4_0~881@ (Mul (Mul (Add (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Sub d4~40@ b4~36@) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~946@ (Mul (Mul (Add (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Sub d4~40@ b4~36@) (Mul c4~38@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~881@ temp_4_1~946@))) (=> (= temp_4_0~881@ temp_4_1~946@) (=> (= temp_5_0~1047@ (Mul (Mul (Sub (Mul b5~44@ a5~42@) (Mul d5~48@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ d5~48@))) (Mul (Add (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Sub b5~44@ d5~48@) (Mul c5~46@ 94))))) (=> (= temp_5_1~1124@ (Mul (Mul (Mul (Sub (Mul b5~44@ a5~42@) (Mul d5~48@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ d5~48@))) (Add (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@))) (Mul (Sub b5~44@ d5~48@) (Mul c5~46@ 94)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1047@ temp_5_1~1124@))) (=> (= temp_5_0~1047@ temp_5_1~1124@) (=> (= temp_6_0~1213@ (Add (Sub (Add (Mul b6~52@ d6~56@) (Mul c6~54@ b6~52@)) (Sub (Mul b6~52@ b6~52@) (Sub c6~54@ a6~50@))) (Mul (Sub (Mul d6~56@ b6~52@) (Mul a6~50@ a6~50@)) (Add (Mul d6~56@ d6~56@) (Sub b6~52@ c6~54@))))) (=> (= temp_6_1~1278@ (Add (Sub (Add (Mul d6~56@ b6~52@) (Mul c6~54@ b6~52@)) (Sub (Mul b6~52@ b6~52@) (Sub c6~54@ a6~50@))) (Mul (Sub (Mul d6~56@ b6~52@) (Mul a6~50@ a6~50@)) (Add (Mul d6~56@ d6~56@) (Sub b6~52@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1213@ temp_6_1~1278@))) (=> (= temp_6_0~1213@ temp_6_1~1278@) (=> (= temp_7_0~1359@ (Sub (Mul (Sub (Sub b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul b7~60@ (Add c7~62@ b7~60@))) (Mul (Add (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@)) (Sub a7~58@ (Add a7~58@ d7~64@))))) (=> (= temp_7_1~1416@ (Sub (Mul (Sub (Sub b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Add c7~62@ b7~60@) b7~60@)) (Mul (Add (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@)) (Sub a7~58@ (Add a7~58@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1359@ temp_7_1~1416@))) (=> (= temp_7_0~1359@ temp_7_1~1416@) (=> (= temp_8_0~1493@ (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ c8~70@)) (Sub (Mul a8~66@ d8~72@) (Mul d8~72@ c8~70@))) (Mul d8~72@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1546@ (Mul (Mul d8~72@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ c8~70@)) (Sub (Mul a8~66@ d8~72@) (Mul d8~72@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1493@ temp_8_1~1546@))) (=> (= temp_8_0~1493@ temp_8_1~1546@) (=> (= temp_9_0~1643@ (Mul (Mul (Mul (Add c9~78@ c9~78@) a9~74@) (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ c9~78@))) (Mul (Mul (Sub 61 d9~80@) (Mul c9~78@ c9~78@)) (Sub (Mul d9~80@ d9~80@) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1716@ (Mul (Mul (Add c9~78@ c9~78@) a9~74@) (Mul (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul (Sub 61 d9~80@) (Mul c9~78@ c9~78@)) (Sub (Mul d9~80@ d9~80@) (Mul a9~74@ a9~74@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1643@ temp_9_1~1716@))) (=> (= temp_9_0~1643@ temp_9_1~1716@) (=> (= temp_10_0~1801@ (Mul (Mul (Add (Mul d10~88@ d10~88@) (Add d10~88@ a10~82@)) (Sub d10~88@ (Add d10~88@ c10~86@))) (Mul (Sub (Mul a10~82@ d10~88@) (Sub d10~88@ a10~82@)) (Mul (Mul d10~88@ d10~88@) (Add c10~86@ d10~88@))))) (=> (= temp_10_1~1878@ (Mul (Mul (Add (Mul d10~88@ d10~88@) (Add d10~88@ a10~82@)) (Sub d10~88@ (Add d10~88@ c10~86@))) (Sub (Mul (Mul a10~82@ d10~88@) (Mul (Mul d10~88@ d10~88@) (Add c10~86@ d10~88@))) (Mul (Sub d10~88@ a10~82@) (Mul (Mul d10~88@ d10~88@) (Add c10~86@ d10~88@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1801@ temp_10_1~1878@))) (=> (= temp_10_0~1801@ temp_10_1~1878@) (=> (= temp_11_0~1955@ (Sub (Mul (Mul (Mul a11~90@ c11~94@) (Mul b11~92@ a11~90@)) (Add (Mul a11~90@ a11~90@) (Mul a11~90@ a11~90@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ a11~90@)) a11~90@))) (=> (= temp_11_1~2008@ (Sub (Mul (Mul (Mul (Mul a11~90@ c11~94@) b11~92@) a11~90@) (Add (Mul a11~90@ a11~90@) (Mul a11~90@ a11~90@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ a11~90@)) a11~90@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1955@ temp_11_1~2008@))) (=> (= temp_11_0~1955@ temp_11_1~2008@) (=> (= temp_12_0~2097@ (Add (Mul (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ b12~100@)) (Mul (Sub a12~98@ a12~98@) (Mul a12~98@ a12~98@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ d12~104@)) (Mul (Mul d12~104@ a12~98@) (Sub d12~104@ d12~104@))))) (=> (= temp_12_1~2162@ (Add (Mul (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ b12~100@)) (Mul (Sub a12~98@ a12~98@) (Mul a12~98@ a12~98@))) (Mul (Mul c12~102@ (Mul d12~104@ (Mul b12~100@ d12~104@))) (Mul (Mul d12~104@ a12~98@) (Sub d12~104@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2097@ temp_12_1~2162@))) (=> (= temp_12_0~2097@ temp_12_1~2162@) (=> (= temp_13_0~2239@ (Mul (Add (Sub (Mul b13~108@ a13~106@) (Mul b13~108@ b13~108@)) c13~110@) (Mul (Mul (Mul d13~112@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Add b13~108@ b13~108@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2292@ (Mul (Add (Sub (Mul b13~108@ a13~106@) (Mul b13~108@ b13~108@)) c13~110@) (Mul (Mul (Mul d13~112@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Add b13~108@ b13~108@) (Mul d13~112@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2239@ temp_13_1~2292@))) (=> (= temp_13_0~2239@ temp_13_1~2292@) (=> (= temp_14_0~2381@ (Mul (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ b14~116@)) (Mul (Add c14~118@ b14~116@) (Sub a14~114@ b14~116@))) (Mul (Mul (Sub b14~116@ b14~116@) (Add a14~114@ c14~118@)) (Add (Mul c14~118@ c14~118@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2446@ (Mul (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ b14~116@)) (Mul (Add c14~118@ b14~116@) (Sub a14~114@ b14~116@))) (Mul (Mul (Add a14~114@ c14~118@) (Sub b14~116@ b14~116@)) (Add (Mul c14~118@ c14~118@) (Mul b14~116@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2381@ temp_14_1~2446@))) (=> (= temp_14_0~2381@ temp_14_1~2446@) (=> (= temp_15_0~2531@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Sub d15~128@ b15~124@))) (Mul (Mul c15~126@ (Mul d15~128@ d15~128@)) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~2592@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Sub d15~128@ b15~124@))) (Mul (Mul c15~126@ (Mul d15~128@ d15~128@)) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2531@ temp_15_1~2592@))) (=> (= temp_15_0~2531@ temp_15_1~2592@) (=> (= temp_16_0~2681@ (Mul (Mul (Add (Add d16~136@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul a16~130@ c16~134@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ b16~132@)) (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2746@ (Mul (Mul (Add (Add d16~136@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul a16~130@ c16~134@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ b16~132@)) (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2681@ temp_16_1~2746@))) (=> (= temp_16_0~2681@ temp_16_1~2746@) (=> (= temp_17_0~2835@ (Mul (Mul (Sub (Mul a17~138@ d17~144@) (Mul b17~140@ d17~144@)) (Mul (Sub a17~138@ d17~144@) (Mul b17~140@ a17~138@))) (Mul (Add (Mul d17~144@ c17~142@) (Mul a17~138@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ b17~140@))))) (=> (= temp_17_1~2900@ (Mul (Mul (Sub (Mul a17~138@ d17~144@) (Mul b17~140@ d17~144@)) (Mul (Sub a17~138@ d17~144@) (Mul b17~140@ a17~138@))) (Mul (Add (Mul d17~144@ c17~142@) (Mul a17~138@ c17~142@)) (Mul b17~140@ (Mul a17~138@ (Mul d17~144@ b17~140@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2835@ temp_17_1~2900@))) (=> (= temp_17_0~2835@ temp_17_1~2900@) (=> (= temp_18_0~2977@ (Mul (Sub d18~152@ (Mul (Mul a18~146@ a18~146@) (Mul b18~148@ a18~146@))) (Mul (Add (Sub d18~152@ c18~150@) (Add c18~150@ d18~152@)) (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ a18~146@))))) (=> (= temp_18_1~3030@ (Mul (Mul (Add (Sub d18~152@ c18~150@) (Add c18~150@ d18~152@)) (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ a18~146@))) (Sub d18~152@ (Mul (Mul a18~146@ a18~146@) (Mul b18~148@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2977@ temp_18_1~3030@))) (=> (= temp_18_0~2977@ temp_18_1~3030@) (=> (= temp_19_0~3091@ (Add (Mul c19~158@ (Mul a19~154@ (Mul b19~156@ a19~154@))) (Mul (Mul (Mul c19~158@ d19~160@) (Mul b19~156@ b19~156@)) a19~154@))) (=> (= temp_19_1~3128@ (Add (Mul c19~158@ (Mul a19~154@ (Mul b19~156@ a19~154@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul c19~158@ d19~160@)) a19~154@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3091@ temp_19_1~3128@))) (=> (= temp_19_0~3091@ temp_19_1~3128@) (=> (= temp_20_0~3213@ (Sub (Mul (Mul (Mul d20~168@ a20~162@) (Mul b20~164@ b20~164@)) (Mul (Mul d20~168@ a20~162@) (Mul c20~166@ a20~162@))) (Mul (Mul c20~166@ (Mul a20~162@ c20~166@)) (Mul (Mul c20~166@ b20~164@) (Mul b20~164@ a20~162@))))) (=> (= temp_20_1~3274@ (Sub (Mul (Mul d20~168@ (Mul a20~162@ (Mul b20~164@ b20~164@))) (Mul (Mul d20~168@ a20~162@) (Mul c20~166@ a20~162@))) (Mul (Mul c20~166@ (Mul a20~162@ c20~166@)) (Mul (Mul c20~166@ b20~164@) (Mul b20~164@ a20~162@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3213@ temp_20_1~3274@))) (=> (= temp_20_0~3213@ temp_20_1~3274@) (=> (= temp_21_0~3347@ (Mul (Add (Mul (Mul a21~170@ a21~170@) a21~170@) (Add (Mul d21~176@ c21~174@) (Mul c21~174@ a21~170@))) (Mul b21~172@ (Add (Mul c21~174@ b21~172@) (Mul b21~172@ a21~170@))))) (=> (= temp_21_1~3396@ (Mul (Add (Mul a21~170@ (Mul a21~170@ a21~170@)) (Add (Mul d21~176@ c21~174@) (Mul c21~174@ a21~170@))) (Mul b21~172@ (Add (Mul c21~174@ b21~172@) (Mul b21~172@ a21~170@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3347@ temp_21_1~3396@))) (=> (= temp_21_0~3347@ temp_21_1~3396@) (=> (= temp_22_0~3477@ (Mul (Mul (Mul (Mul a22~178@ c22~182@) (Add c22~182@ c22~182@)) (Add c22~182@ (Mul d22~184@ a22~178@))) (Mul (Mul (Mul d22~184@ d22~184@) c22~182@) (Mul (Mul c22~182@ a22~178@) (Mul a22~178@ c22~182@))))) (=> (= temp_22_1~3534@ (Mul (Mul (Mul (Mul a22~178@ c22~182@) (Add c22~182@ c22~182@)) (Add c22~182@ (Mul d22~184@ a22~178@))) (Mul (Mul (Mul d22~184@ d22~184@) c22~182@) (Mul (Mul c22~182@ a22~178@) (Mul c22~182@ a22~178@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3477@ temp_22_1~3534@))) (=> (= temp_22_0~3477@ temp_22_1~3534@) (=> (= temp_23_0~3623@ (Mul (Sub (Mul (Mul b23~188@ d23~192@) (Mul d23~192@ c23~190@)) (Mul (Sub b23~188@ d23~192@) (Mul d23~192@ d23~192@))) (Mul (Mul (Mul c23~190@ b23~188@) (Mul b23~188@ a23~186@)) (Sub (Mul c23~190@ d23~192@) (Mul c23~190@ d23~192@))))) (=> (= temp_23_1~3688@ (Mul (Sub (Mul (Mul b23~188@ d23~192@) (Mul d23~192@ c23~190@)) (Mul (Sub b23~188@ d23~192@) (Mul d23~192@ d23~192@))) (Mul (Mul c23~190@ b23~188@) (Mul (Mul b23~188@ a23~186@) (Sub (Mul c23~190@ d23~192@) (Mul c23~190@ d23~192@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3623@ temp_23_1~3688@))) (=> (= temp_23_0~3623@ temp_23_1~3688@) (=> (= temp_24_0~3773@ (Mul (Mul a24~194@ (Mul (Mul 38 b24~196@) (Mul c24~198@ b24~196@))) (Mul (Mul (Mul a24~194@ a24~194@) (Mul a24~194@ d24~200@)) (Mul (Add d24~200@ d24~200@) a24~194@)))) (=> (= temp_24_1~3834@ (Mul (Mul a24~194@ (Mul (Mul 38 b24~196@) (Mul c24~198@ b24~196@))) (Mul (Mul a24~194@ a24~194@) (Mul (Mul a24~194@ d24~200@) (Mul (Add d24~200@ d24~200@) a24~194@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3773@ temp_24_1~3834@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
