...
;; mariposa_data/v_nl//1490560167721805727/nlqi_verus/src/main.rs:7:1: 26:40 (#0)
(push)
 ...
 (declare-const temp_3_1~1216@ Int)
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~273@ (Mul (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Add b0~4@ b0~4@)) (Mul (Mul a0~2@
           d0~8@
          ) (Mul b0~4@ d0~8@)
         )
        ) d0~8@
       ) (Mul (Mul (Mul (Add c0~6@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ 61) (Add c0~6@
           d0~8@
         ))
        ) (Add (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ d0~8@)))
     )))
     (=>
      (= temp_0_1~386@ (Mul (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Add b0~4@ b0~4@)) (Mul (Mul a0~2@
            d0~8@
           ) (Mul b0~4@ d0~8@)
          )
         ) d0~8@
         ...
         ) (Add (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ d0~8@)))
      )))
      (and
       (=>
        (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ d0~8@)
        (=>
         %%location_label%%0
       ...
       (=>
        (= temp_0_0~273@ temp_0_1~386@)
        (=>
         (= temp_1_0~547@ (Mul (Mul (Mul (Mul a1~10@ (Mul a1~10@ d1~16@)) (Mul (Sub c1~14@ a1~10@)
              (Mul a1~10@ a1~10@)
             )
            ) (Sub (Mul (Mul 49 b1~12@) c1~14@) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ b1~12@)))
           ) (Sub (Mul (Mul (Sub d1~16@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Add a1~10@ c1~14@) (
               Mul a1~10@ b1~12@
             ))
            ) (Mul (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@
               a1~10@
         ))))))
         (=>
          (= temp_1_1~680@ (Mul (Mul (Mul (Mul a1~10@ (Mul a1~10@ d1~16@)) (Mul (Sub c1~14@ a1~10@)
               (Mul a1~10@ a1~10@)
              )
             ) (Sub (Mul (Mul 49 b1~12@) c1~14@) (Mul d1~16@ (Mul c1~14@ (Mul a1~10@ b1~12@))))
            ) (Sub (Mul (Mul (Sub d1~16@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Add a1~10@ c1~14@) (
                Mul a1~10@ b1~12@
              ))
             ) (Mul (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@
          ...
          (and
           (=>
            (= tmp%1@ (Mul a1~10@ b1~12@))
            (=>
             (ens%main!nl_basics.lemma_mul_is_associative. d1~16@ c1~14@ tmp%1@)
             (=>
              %%location_label%%1
              (= temp_1_0~547@ temp_1_1~680@)
           )))
           (=>
            (= temp_1_0~547@ temp_1_1~680@)
            (=>
             (= temp_2_0~839@ (Mul (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul
                   c2~22@ d2~24@
                  ) (Mul b2~20@ c2~22@)
                 )
                ) (Mul (Mul (Sub c2~22@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Mul a2~18@
                   a2~18@
                )))
               ) (Mul (Sub (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (
                   Mul b2~20@ a2~18@
                 ))
                ) (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@ d2~24@) d2~24@))
             )))
             (=>
              (= temp_2_1~964@ (Mul (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul
                    c2~22@ d2~24@
                   ) (Mul b2~20@ c2~22@)
                  )
                 ) (Mul (Mul (Sub c2~22@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Mul a2~18@
                 ...
                 ) (Mul (Mul (Mul (Mul d2~24@ c2~22@) b2~20@) c2~22@) (Mul (Mul c2~22@ d2~24@) d2~24@))
              )))
              (and
               (=>
                (= tmp%2@ (Mul d2~24@ c2~22@))
                (=>
                 (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ b2~20@ c2~22@)
                 (=>
                  %%location_label%%2
                  (= temp_2_0~839@ temp_2_1~964@)
               )))
               (=>
                (= temp_2_0~839@ temp_2_1~964@)
                (=>
                 (= temp_3_0~1107@ (Mul (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ 6)) (Mul (Mul c3~30@
                       c3~30@
                      ) (Mul b3~28@ b3~28@)
                     )
                    ) b3~28@
                   ) (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (
                       Mul d3~32@ a3~26@
                     ))
                    ) (Mul (Mul c3~30@ (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ d3~32@) (Add a3~26@ d3~32@)))
                 )))
                 (=>
                  (= temp_3_1~1216@ (Mul (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ 6)) (Mul (Mul c3~30@
                        c3~30@
                       ) (Mul b3~28@ b3~28@)
                      )
                     ) b3~28@
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~1107@ temp_3_1~1216@)
                   ))
                   (=>
                    (= temp_3_0~1107@ temp_3_1~1216@)
                    (=>
                     (= temp_4_0~1361@ (Sub (Mul (Sub (Mul b4~36@ (Mul d4~40@ d4~40@)) (Mul b4~36@ (Mul c4~38@
                           b4~36@
                         ))
                        ) (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@
                           d4~40@
                        )))
                       ) (Mul (Mul (Mul (Mul a4~34@ d4~40@) d4~40@) (Mul (Add d4~40@ c4~38@) (Mul c4~38@ c4~38@)))
                        (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul a4~34@
                           b4~36@
                     ))))))
                     (=>
                      (= temp_4_1~1478@ (Sub (Mul (Sub (Mul b4~36@ (Mul d4~40@ d4~40@)) (Mul b4~36@ (Mul c4~38@
                            b4~36@
                          ))
                         ) (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul d4~40@ (Mul c4~38@ (Mul a4~34@
                             d4~40@
                         ))))
                        ) (Mul (Mul (Mul (Mul a4~34@ d4~40@) d4~40@) (Mul (Add d4~40@ c4~38@) (Mul c4~38@ c4~38@)))
                         (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul a4~34@
                      ...
                      (=>
                       (= tmp%3@ (Mul a4~34@ d4~40@))
                       (=>
                        (ens%main!nl_basics.lemma_mul_is_associative. d4~40@ c4~38@ tmp%3@)
                        (=>
                         %%location_label%%4
                         (= temp_4_0~1361@ temp_4_1~1478@)
 ))))))))))))))))))))))))
 (get-info :version)
 (assert
  %%query%%
