...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Add b0~4@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@))) d0~8@) (Mul (Mul (Mul (Add c0~6@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ 61) (Add c0~6@ d0~8@))) (Add (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ d0~8@)))))) (=> (= temp_0_1~386@ (Mul (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Add b0~4@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@))) d0~8@) (Mul (Mul (Mul (Add c0~6@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ 61) (Add c0~6@ d0~8@))) (Add (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ d0~8@)))))) (=> (= tmp%1@ (= temp_0_0~273@ temp_0_1~386@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~534@ (Mul (Mul (Mul (Mul a1~10@ (Mul a1~10@ d1~16@)) (Mul (Sub c1~14@ a1~10@) (Mul a1~10@ a1~10@))) (Sub (Mul (Mul 49 b1~12@) c1~14@) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ b1~12@)))) (Sub (Mul (Mul (Sub d1~16@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Add a1~10@ c1~14@) (Mul a1~10@ b1~12@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@)))))) (=> (= temp_1_1~667@ (Mul (Mul (Mul (Mul a1~10@ (Mul a1~10@ d1~16@)) (Mul (Sub c1~14@ a1~10@) (Mul a1~10@ a1~10@))) (Sub (Mul (Mul 49 b1~12@) c1~14@) (Mul d1~16@ (Mul c1~14@ (Mul a1~10@ b1~12@))))) (Sub (Mul (Mul (Sub d1~16@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Add a1~10@ c1~14@) (Mul a1~10@ b1~12@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@)))))) (=> (= tmp%2@ (= temp_1_0~534@ temp_1_1~667@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~807@ (Mul (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Sub c2~22@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ a2~18@)))) (Mul (Sub (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@ d2~24@) d2~24@))))) (=> (= temp_2_1~932@ (Mul (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Sub c2~22@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ a2~18@)))) (Mul (Sub (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul (Mul d2~24@ c2~22@) b2~20@) c2~22@) (Mul (Mul c2~22@ d2~24@) d2~24@))))) (=> (= tmp%3@ (= temp_2_0~807@ temp_2_1~932@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1056@ (Mul (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ 6)) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ b3~28@))) b3~28@) (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ a3~26@))) (Mul (Mul c3~30@ (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ d3~32@) (Add a3~26@ d3~32@)))))) (=> (= temp_3_1~1165@ (Mul (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ 6)) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ b3~28@))) b3~28@) (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ a3~26@))) (Mul (Mul c3~30@ (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ d3~32@) (Add a3~26@ d3~32@)))))) (=> (= tmp%4@ (= temp_3_0~1056@ temp_3_1~1165@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1297@ (Sub (Mul (Sub (Mul b4~36@ (Mul d4~40@ d4~40@)) (Mul b4~36@ (Mul c4~38@ b4~36@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)))) (Mul (Mul (Mul (Mul a4~34@ d4~40@) d4~40@) (Mul (Add d4~40@ c4~38@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@)))))) (=> (= temp_4_1~1414@ (Sub (Mul (Sub (Mul b4~36@ (Mul d4~40@ d4~40@)) (Mul b4~36@ (Mul c4~38@ b4~36@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul d4~40@ (Mul c4~38@ (Mul a4~34@ d4~40@))))) (Mul (Mul (Mul (Mul a4~34@ d4~40@) d4~40@) (Mul (Add d4~40@ c4~38@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@)))))) (=> (= tmp%5@ (= temp_4_0~1297@ temp_4_1~1414@)) (=> %%location_label%%4 tmp%5@)))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
