...
(set-info :comment ";; mariposa_data/v_nl//15294475969189781596/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Sub (Mul (Mul (Sub a0~2@ d0~8@) (Mul b0~4@ b0~4@)) a0~2@) (Mul (Mul d0~8@ (Sub c0~6@ b0~4@)) (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ a0~2@))))) (=> (= temp_0_1~338@ (Sub (Mul (Mul (Mul (Sub a0~2@ d0~8@) b0~4@) b0~4@) a0~2@) (Mul (Mul d0~8@ (Sub c0~6@ b0~4@)) (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ a0~2@))))) (and (=> (= tmp%1@ (Sub a0~2@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b0~4@ b0~4@) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~338@)))) (=> (= temp_0_0~289@ temp_0_1~338@) (=> (= temp_1_0~457@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul 15 a1~10@)) (Mul d1~16@ (Mul c1~14@ d1~16@))) (Mul (Sub (Mul b1~12@ c1~14@) (Mul 73 c1~14@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~542@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul 15 a1~10@)) (Mul d1~16@ (Mul c1~14@ d1~16@))) (Mul (Sub (Mul b1~12@ c1~14@) (Mul 73 c1~14@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ a1~10@) (=> %%location_label%%1 (= temp_1_0~457@ temp_1_1~542@))) (=> (= temp_1_0~457@ temp_1_1~542@) (=> (= temp_2_0~627@ (Mul (Mul (Mul a2~18@ (Mul c2~22@ a2~18@)) (Mul (Add c2~22@ c2~22@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul b2~20@ d2~24@) b2~20@) (Add (Mul a2~18@ c2~22@) (Sub b2~20@ c2~22@))))) (=> (= temp_2_1~684@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) a2~18@) (Mul (Add c2~22@ c2~22@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul b2~20@ d2~24@) b2~20@) (Add (Mul a2~18@ c2~22@) (Sub b2~20@ c2~22@))))) (and (=> (= tmp%2@ (Mul c2~22@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~627@ temp_2_1~684@)))) (=> (= temp_2_0~627@ temp_2_1~684@) (=> (= temp_3_0~777@ (Mul (Add (Mul (Mul a3~26@ c3~30@) a3~26@) (Add (Mul c3~30@ c3~30@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~838@ (Mul (Add (Mul (Mul a3~26@ c3~30@) a3~26@) (Add (Mul c3~30@ c3~30@) (Mul a3~26@ b3~28@))) (Mul (Mul b3~28@ c3~30@) (Mul (Mul a3~26@ d3~32@) (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@)))))) (and (=> (= tmp%3@ (Mul b3~28@ c3~30@)) (=> (= tmp%4@ (Mul a3~26@ d3~32@)) (=> (= tmp%5@ (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~777@ temp_3_1~838@)))))) (=> (= temp_3_0~777@ temp_3_1~838@) (=> (= temp_4_0~953@ (Mul (Mul (Mul (Add b4~36@ b4~36@) (Mul b4~36@ a4~34@)) (Mul (Add d4~40@ c4~38@) (Mul c4~38@ c4~38@))) (Sub (Mul (Mul d4~40@ c4~38@) (Sub a4~34@ a4~34@)) (Mul (Sub b4~36@ c4~38@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~1018@ (Mul (Mul (Mul (Add b4~36@ b4~36@) (Mul b4~36@ a4~34@)) (Mul (Add d4~40@ c4~38@) (Mul c4~38@ c4~38@))) (Sub (Mul (Sub a4~34@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Sub b4~36@ c4~38@) (Mul b4~36@ c4~38@))))) (=> (= tmp%6@ (Mul d4~40@ c4~38@)) (=> (= tmp%7@ (Sub a4~34@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%4 (= temp_4_0~953@ temp_4_1~1018@))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
