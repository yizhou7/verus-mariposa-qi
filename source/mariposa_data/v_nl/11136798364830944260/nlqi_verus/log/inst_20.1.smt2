...
(set-info :comment ";; mariposa_data/v_nl//11136798364830944260/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_4_0~943@ Int)
...
(declare-const temp_7_0~1337@ Int)
(declare-const temp_7_1~1362@ Int)
(declare-const temp_8_0~1471@ Int)
(declare-const temp_8_1~1536@ Int)
...
(declare-const temp_12_0~2031@ Int)
(declare-const temp_12_1~2072@ Int)
(declare-const temp_13_0~2183@ Int)
(declare-const temp_13_1~2260@ Int)
(declare-const temp_14_0~2359@ Int)
(declare-const temp_14_1~2424@ Int)
(declare-const temp_15_0~2529@ Int)
(declare-const temp_15_1~2582@ Int)
(declare-const temp_16_0~2671@ Int)
(declare-const temp_16_1~2720@ Int)
(declare-const temp_17_0~2825@ Int)
(declare-const temp_17_1~2882@ Int)
(declare-const temp_18_0~2993@ Int)
(declare-const temp_18_1~3070@ Int)
(declare-const temp_19_0~3191@ Int)
(declare-const temp_19_1~3264@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Sub d0~8@ b0~4@) (Mul b0~4@ b0~4@)) (Sub (Sub d0~8@ d0~8@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub d0~8@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Sub d0~8@ b0~4@)) (Sub (Sub d0~8@ d0~8@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub d0~8@ a0~2@))))) (and (=> (= tmp%1@ (Sub d0~8@ b0~4@)) (=> (= tmp%2@ (Mul b0~4@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~467@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ d1~16@)) (Sub (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ d1~16@) (Sub d1~16@ a1~10@)) (Add d1~16@ (Sub d1~16@ a1~10@))))) (=> (= temp_1_1~528@ (Mul (Mul (Mul d1~16@ a1~10@) (Mul (Mul c1~14@ d1~16@) (Sub (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@)))) (Mul (Mul (Mul b1~12@ d1~16@) (Sub d1~16@ a1~10@)) (Add d1~16@ (Sub d1~16@ a1~10@))))) (and (=> (= tmp%3@ (Mul d1~16@ a1~10@)) (=> (= tmp%4@ (Mul c1~14@ d1~16@)) (=> (= tmp%5@ (Sub (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~467@ temp_1_1~528@)))))) (=> (= temp_1_0~467@ temp_1_1~528@) (=> (= temp_2_0~651@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul c2~22@ b2~20@) 84) (Mul (Mul d2~24@ c2~22@) (Add c2~22@ d2~24@))))) (=> (= temp_2_1~724@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul c2~22@ b2~20@) 84) (Mul (Mul d2~24@ c2~22@) (Add c2~22@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ c2~22@) (=> %%location_label%%2 (= temp_2_0~651@ temp_2_1~724@))) (=> (= temp_2_0~651@ temp_2_1~724@) (=> (= temp_3_0~813@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul a3~26@ b3~28@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~874@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul a3~26@ b3~28@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))))) (and (=> (= tmp%6@ (Mul b3~28@ b3~28@)) (=> (= tmp%7@ (Mul a3~26@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~813@ temp_3_1~874@))))) (=> (= temp_3_0~813@ temp_3_1~874@) (=> (= temp_4_0~943@ (Mul c4~38@ (Add (Add (Mul c4~38@ a4~34@) (Sub a4~34@ d4~40@)) (Add a4~34@ (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~976@ (Mul (Add (Add (Mul c4~38@ a4~34@) (Sub a4~34@ d4~40@)) (Add a4~34@ (Mul b4~36@ b4~36@))) c4~38@)) (and (=> (= tmp%8@ (Add (Add (Mul c4~38@ a4~34@) (Sub a4~34@ d4~40@)) (Add a4~34@ (Mul b4~36@ b4~36@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c4~38@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~943@ temp_4_1~976@)))) (=> (= temp_4_0~943@ temp_4_1~976@) (=> (= temp_5_0~1093@ (Sub (Mul (Mul (Mul d5~48@ b5~44@) (Add b5~44@ d5~48@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))) (Sub (Sub (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1158@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Add b5~44@ d5~48@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))) (Sub (Sub (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1093@ temp_5_1~1158@))) (=> (= temp_5_0~1093@ temp_5_1~1158@) (=> (= temp_6_0~1235@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Sub b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) c6~54@)) (Mul b6~52@ (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1284@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Sub b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) c6~54@)) (Mul b6~52@ (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1235@ temp_6_1~1284@))) (=> (= temp_6_0~1235@ temp_6_1~1284@) (=> (= temp_7_0~1337@ (Mul d7~64@ (Sub c7~62@ (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1362@ (Mul (Sub c7~62@ (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ b7~60@))) d7~64@)) (and (=> (= tmp%9@ (Sub c7~62@ (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ b7~60@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ tmp%9@) (=> %%location_label%%7 (= temp_7_0~1337@ temp_7_1~1362@)))) (=> (= temp_7_0~1337@ temp_7_1~1362@) (=> (= temp_8_0~1471@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ c8~70@)) (Mul (Add d8~72@ a8~66@) (Add c8~70@ b8~68@))) (Mul (Mul (Mul a8~66@ b8~68@) (Add a8~66@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1536@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ c8~70@)) (Mul (Add d8~72@ a8~66@) (Add c8~70@ b8~68@))) (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Add a8~66@ d8~72@)) (Mul d8~72@ a8~66@)) (Mul b8~68@ a8~66@)))) (and (=> (= tmp%10@ (Mul (Mul a8~66@ b8~68@) (Add a8~66@ d8~72@))) (=> (= tmp%11@ (Mul d8~72@ a8~66@)) (=> (= tmp%12@ (Mul b8~68@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%8 (= temp_8_0~1471@ temp_8_1~1536@)))))) (=> (= temp_8_0~1471@ temp_8_1~1536@) (=> (= temp_9_0~1647@ (Mul (Mul (Mul (Mul c9~78@ 3) (Mul b9~76@ a9~74@)) (Mul b9~76@ (Mul d9~80@ d9~80@))) (Mul d9~80@ (Sub (Mul c9~78@ b9~76@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~1708@ (Mul (Mul (Mul (Mul c9~78@ 3) (Mul a9~74@ b9~76@)) (Mul b9~76@ (Mul d9~80@ d9~80@))) (Mul d9~80@ (Sub (Mul c9~78@ b9~76@) (Mul b9~76@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b9~76@ a9~74@) (=> %%location_label%%9 (= temp_9_0~1647@ temp_9_1~1708@))) (=> (= temp_9_0~1647@ temp_9_1~1708@) (=> (= temp_10_0~1789@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Sub c10~86@ a10~82@) (Mul a10~82@ b10~84@))) (Add b10~84@ (Mul (Mul a10~82@ b10~84@) (Add a10~82@ c10~86@))))) (=> (= temp_10_1~1842@ (Mul (Mul (Mul (Add a10~82@ b10~84@) (Mul b10~84@ b10~84@)) (Mul (Sub c10~86@ a10~82@) (Mul a10~82@ b10~84@))) (Add b10~84@ (Mul (Mul a10~82@ b10~84@) (Add a10~82@ c10~86@))))) (and (=> (= tmp%13@ (Mul b10~84@ b10~84@)) (=> (= tmp%14@ (Add a10~82@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%10 (= temp_10_0~1789@ temp_10_1~1842@))))) (=> (= temp_10_0~1789@ temp_10_1~1842@) (=> (= temp_11_0~1923@ (Mul (Mul (Mul (Add c11~94@ a11~90@) (Mul d11~96@ c11~94@)) (Sub (Mul b11~92@ d11~96@) (Add a11~90@ b11~92@))) (Mul c11~94@ (Mul c11~94@ d11~96@)))) (=> (= temp_11_1~1968@ (Mul (Mul (Mul (Add c11~94@ a11~90@) (Mul d11~96@ c11~94@)) (Sub (Mul b11~92@ d11~96@) (Add a11~90@ b11~92@))) (Mul (Mul c11~94@ c11~94@) d11~96@))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. c11~94@ c11~94@ d11~96@) (=> %%location_label%%11 (= temp_11_0~1923@ temp_11_1~1968@))) (=> (= temp_11_0~1923@ temp_11_1~1968@) (=> (= temp_12_0~2031@ (Mul (Sub (Mul (Mul c12~102@ b12~100@) (Add a12~98@ d12~104@)) (Add b12~100@ (Mul c12~102@ b12~100@))) a12~98@)) (=> (= temp_12_1~2072@ (Mul (Sub (Add (Mul (Mul c12~102@ b12~100@) a12~98@) (Mul (Mul c12~102@ b12~100@) d12~104@)) (Add b12~100@ (Mul c12~102@ b12~100@))) a12~98@)) (and (=> (= tmp%15@ (Mul c12~102@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%15@ a12~98@ d12~104@) (=> %%location_label%%12 (= temp_12_0~2031@ temp_12_1~2072@)))) (=> (= temp_12_0~2031@ temp_12_1~2072@) (=> (= temp_13_0~2183@ (Mul (Sub (Mul (Mul a13~106@ a13~106@) (Mul a13~106@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ b13~108@)) (Mul (Add d13~112@ 87) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2260@ (Mul (Sub (Mul (Mul a13~106@ a13~106@) (Mul a13~106@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul (Mul d13~112@ b13~108@) b13~108@) b13~108@) (Mul (Add d13~112@ 87) (Mul c13~110@ d13~112@))))) (and (=> (= tmp%16@ (Mul d13~112@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ b13~108@ b13~108@) (=> %%location_label%%13 (= temp_13_0~2183@ temp_13_1~2260@)))) (=> (= temp_13_0~2183@ temp_13_1~2260@) (=> (= temp_14_0~2359@ (Mul (Mul (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ c14~118@)) (Mul (Add c14~118@ d14~120@) (Mul b14~116@ b14~116@))) (Mul (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ c14~118@)) (Sub (Mul c14~118@ d14~120@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~2424@ (Mul (Mul (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ c14~118@)) (Mul (Add c14~118@ d14~120@) (Mul b14~116@ b14~116@))) (Mul (Sub (Mul c14~118@ d14~120@) (Mul c14~118@ b14~116@)) (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ c14~118@))))) (and (=> (= tmp%17@ (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ c14~118@))) (=> (= tmp%18@ (Sub (Mul c14~118@ d14~120@) (Mul c14~118@ b14~116@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%14 (= temp_14_0~2359@ temp_14_1~2424@))))) (=> (= temp_14_0~2359@ temp_14_1~2424@) (=> (= temp_15_0~2529@ (Sub (Mul (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ b15~124@)) (Mul (Add b15~124@ b15~124@) (Mul a15~122@ b15~124@))) (Mul (Mul (Mul b15~124@ c15~126@) (Sub d15~128@ c15~126@)) a15~122@))) (=> (= temp_15_1~2582@ (Sub (Mul (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ b15~124@)) (Mul (Add b15~124@ b15~124@) (Mul a15~122@ b15~124@))) (Mul a15~122@ (Mul (Mul b15~124@ c15~126@) (Sub d15~128@ c15~126@))))) (and (=> (= tmp%19@ (Mul (Mul b15~124@ c15~126@) (Sub d15~128@ c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ a15~122@) (=> %%location_label%%15 (= temp_15_0~2529@ temp_15_1~2582@)))) (=> (= temp_15_0~2529@ temp_15_1~2582@) (=> (= temp_16_0~2671@ (Sub (Mul (Add (Mul b16~132@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ 67))) d16~136@)) (=> (= temp_16_1~2720@ (Sub (Mul (Add (Mul b16~132@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul d16~136@ 67) (Mul c16~134@ d16~136@))) d16~136@)) (and (=> (= tmp%20@ (Mul c16~134@ d16~136@)) (=> (= tmp%21@ (Mul d16~136@ 67)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%16 (= temp_16_0~2671@ temp_16_1~2720@))))) (=> (= temp_16_0~2671@ temp_16_1~2720@) (=> (= temp_17_0~2825@ (Sub (Mul (Mul b17~140@ (Mul a17~138@ b17~140@)) (Mul (Mul d17~144@ d17~144@) (Mul c17~142@ c17~142@))) (Mul (Mul (Mul c17~142@ d17~144@) d17~144@) (Sub (Mul d17~144@ c17~142@) (Mul a17~138@ d17~144@))))) (=> (= temp_17_1~2882@ (Sub (Mul (Mul b17~140@ (Mul a17~138@ b17~140@)) (Mul d17~144@ (Mul d17~144@ (Mul c17~142@ c17~142@)))) (Mul (Mul (Mul c17~142@ d17~144@) d17~144@) (Sub (Mul d17~144@ c17~142@) (Mul a17~138@ d17~144@))))) (and (=> (= tmp%22@ (Mul c17~142@ c17~142@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d17~144@ d17~144@ tmp%22@) (=> %%location_label%%17 (= temp_17_0~2825@ temp_17_1~2882@)))) (=> (= temp_17_0~2825@ temp_17_1~2882@) (=> (= temp_18_0~2993@ (Mul (Mul (Mul (Add b18~148@ c18~150@) (Mul a18~146@ b18~148@)) (Sub (Mul a18~146@ d18~152@) (Mul c18~150@ 31))) (Mul (Mul (Sub b18~148@ b18~148@) (Mul a18~146@ c18~150@)) (Mul (Mul a18~146@ c18~150@) (Sub c18~150@ d18~152@))))) (=> (= temp_18_1~3070@ (Mul (Mul (Sub (Mul a18~146@ d18~152@) (Mul c18~150@ 31)) (Mul (Add b18~148@ c18~150@) (Mul a18~146@ b18~148@))) (Mul (Mul (Sub b18~148@ b18~148@) (Mul a18~146@ c18~150@)) (Mul (Mul a18~146@ c18~150@) (Sub c18~150@ d18~152@))))) (and (=> (= tmp%23@ (Mul (Add b18~148@ c18~150@) (Mul a18~146@ b18~148@))) (=> (= tmp%24@ (Sub (Mul a18~146@ d18~152@) (Mul c18~150@ 31))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> %%location_label%%18 (= temp_18_0~2993@ temp_18_1~3070@))))) (=> (= temp_18_0~2993@ temp_18_1~3070@) (=> (= temp_19_0~3191@ (Mul (Mul (Mul d19~160@ (Mul a19~154@ d19~160@)) (Mul (Sub a19~154@ b19~156@) (Mul c19~158@ b19~156@))) (Mul (Add (Sub c19~158@ d19~160@) (Mul d19~160@ a19~154@)) (Add (Add a19~154@ a19~154@) b19~156@)))) (=> (= temp_19_1~3264@ (Mul (Mul (Mul d19~160@ (Mul a19~154@ d19~160@)) (Mul (Sub a19~154@ b19~156@) (Mul c19~158@ b19~156@))) (Add (Mul (Add (Sub c19~158@ d19~160@) (Mul d19~160@ a19~154@)) (Add a19~154@ a19~154@)) (Mul (Add (Sub c19~158@ d19~160@) (Mul d19~160@ a19~154@)) b19~156@)))) (=> (= tmp%25@ (Add (Sub c19~158@ d19~160@) (Mul d19~160@ a19~154@))) (=> (= tmp%26@ (Add a19~154@ a19~154@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%25@ tmp%26@ b19~156@) (=> %%location_label%%19 (= temp_19_0~3191@ temp_19_1~3264@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
