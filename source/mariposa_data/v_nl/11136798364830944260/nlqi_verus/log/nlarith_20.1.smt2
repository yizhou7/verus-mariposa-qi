...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Sub d0~8@ b0~4@) (Mul b0~4@ b0~4@)) (Sub (Sub d0~8@ d0~8@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub d0~8@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Sub d0~8@ b0~4@)) (Sub (Sub d0~8@ d0~8@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub d0~8@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~446@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ d1~16@)) (Sub (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ d1~16@) (Sub d1~16@ a1~10@)) (Add d1~16@ (Sub d1~16@ a1~10@))))) (=> (= temp_1_1~507@ (Mul (Mul (Mul d1~16@ a1~10@) (Mul (Mul c1~14@ d1~16@) (Sub (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@)))) (Mul (Mul (Mul b1~12@ d1~16@) (Sub d1~16@ a1~10@)) (Add d1~16@ (Sub d1~16@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~446@ temp_1_1~507@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~595@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul c2~22@ b2~20@) 84) (Mul (Mul d2~24@ c2~22@) (Add c2~22@ d2~24@))))) (=> (= temp_2_1~668@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul c2~22@ b2~20@) 84) (Mul (Mul d2~24@ c2~22@) (Add c2~22@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~595@ temp_2_1~668@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~744@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul a3~26@ b3~28@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~805@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul a3~26@ b3~28@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~744@ temp_3_1~805@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~853@ (Mul c4~38@ (Add (Add (Mul c4~38@ a4~34@) (Sub a4~34@ d4~40@)) (Add a4~34@ (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~886@ (Mul (Add (Add (Mul c4~38@ a4~34@) (Sub a4~34@ d4~40@)) (Add a4~34@ (Mul b4~36@ b4~36@))) c4~38@)) (=> (= tmp%5@ (= temp_4_0~853@ temp_4_1~886@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~966@ (Sub (Mul (Mul (Mul d5~48@ b5~44@) (Add b5~44@ d5~48@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))) (Sub (Sub (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1031@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Add b5~44@ d5~48@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))) (Sub (Sub (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~966@ temp_5_1~1031@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1095@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Sub b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) c6~54@)) (Mul b6~52@ (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1144@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Sub b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) c6~54@)) (Mul b6~52@ (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~1095@ temp_6_1~1144@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1184@ (Mul d7~64@ (Sub c7~62@ (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1209@ (Mul (Sub c7~62@ (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ b7~60@))) d7~64@)) (=> (= tmp%8@ (= temp_7_0~1184@ temp_7_1~1209@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1289@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ c8~70@)) (Mul (Add d8~72@ a8~66@) (Add c8~70@ b8~68@))) (Mul (Mul (Mul a8~66@ b8~68@) (Add a8~66@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1354@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ c8~70@)) (Mul (Add d8~72@ a8~66@) (Add c8~70@ b8~68@))) (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Add a8~66@ d8~72@)) (Mul d8~72@ a8~66@)) (Mul b8~68@ a8~66@)))) (=> (= tmp%9@ (= temp_8_0~1289@ temp_8_1~1354@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1430@ (Mul (Mul (Mul (Mul c9~78@ 3) (Mul b9~76@ a9~74@)) (Mul b9~76@ (Mul d9~80@ d9~80@))) (Mul d9~80@ (Sub (Mul c9~78@ b9~76@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~1491@ (Mul (Mul (Mul (Mul c9~78@ 3) (Mul a9~74@ b9~76@)) (Mul b9~76@ (Mul d9~80@ d9~80@))) (Mul d9~80@ (Sub (Mul c9~78@ b9~76@) (Mul b9~76@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1430@ temp_9_1~1491@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1559@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Sub c10~86@ a10~82@) (Mul a10~82@ b10~84@))) (Add b10~84@ (Mul (Mul a10~82@ b10~84@) (Add a10~82@ c10~86@))))) (=> (= temp_10_1~1612@ (Mul (Mul (Mul (Add a10~82@ b10~84@) (Mul b10~84@ b10~84@)) (Mul (Sub c10~86@ a10~82@) (Mul a10~82@ b10~84@))) (Add b10~84@ (Mul (Mul a10~82@ b10~84@) (Add a10~82@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1559@ temp_10_1~1612@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1672@ (Mul (Mul (Mul (Add c11~94@ a11~90@) (Mul d11~96@ c11~94@)) (Sub (Mul b11~92@ d11~96@) (Add a11~90@ b11~92@))) (Mul c11~94@ (Mul c11~94@ d11~96@)))) (=> (= temp_11_1~1717@ (Mul (Mul (Mul (Add c11~94@ a11~90@) (Mul d11~96@ c11~94@)) (Sub (Mul b11~92@ d11~96@) (Add a11~90@ b11~92@))) (Mul (Mul c11~94@ c11~94@) d11~96@))) (=> (= tmp%12@ (= temp_11_0~1672@ temp_11_1~1717@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1765@ (Mul (Sub (Mul (Mul c12~102@ b12~100@) (Add a12~98@ d12~104@)) (Add b12~100@ (Mul c12~102@ b12~100@))) a12~98@)) (=> (= temp_12_1~1806@ (Mul (Sub (Add (Mul (Mul c12~102@ b12~100@) a12~98@) (Mul (Mul c12~102@ b12~100@) d12~104@)) (Add b12~100@ (Mul c12~102@ b12~100@))) a12~98@)) (=> (= tmp%13@ (= temp_12_0~1765@ temp_12_1~1806@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~1898@ (Mul (Sub (Mul (Mul a13~106@ a13~106@) (Mul a13~106@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ b13~108@)) (Mul (Add d13~112@ 87) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~1975@ (Mul (Sub (Mul (Mul a13~106@ a13~106@) (Mul a13~106@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul (Mul d13~112@ b13~108@) b13~108@) b13~108@) (Mul (Add d13~112@ 87) (Mul c13~110@ d13~112@))))) (=> (= tmp%14@ (= temp_13_0~1898@ temp_13_1~1975@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2055@ (Mul (Mul (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ c14~118@)) (Mul (Add c14~118@ d14~120@) (Mul b14~116@ b14~116@))) (Mul (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ c14~118@)) (Sub (Mul c14~118@ d14~120@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~2120@ (Mul (Mul (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ c14~118@)) (Mul (Add c14~118@ d14~120@) (Mul b14~116@ b14~116@))) (Mul (Sub (Mul c14~118@ d14~120@) (Mul c14~118@ b14~116@)) (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2055@ temp_14_1~2120@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2188@ (Sub (Mul (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ b15~124@)) (Mul (Add b15~124@ b15~124@) (Mul a15~122@ b15~124@))) (Mul (Mul (Mul b15~124@ c15~126@) (Sub d15~128@ c15~126@)) a15~122@))) (=> (= temp_15_1~2241@ (Sub (Mul (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ b15~124@)) (Mul (Add b15~124@ b15~124@) (Mul a15~122@ b15~124@))) (Mul a15~122@ (Mul (Mul b15~124@ c15~126@) (Sub d15~128@ c15~126@))))) (=> (= tmp%16@ (= temp_15_0~2188@ temp_15_1~2241@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2305@ (Sub (Mul (Add (Mul b16~132@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ 67))) d16~136@)) (=> (= temp_16_1~2354@ (Sub (Mul (Add (Mul b16~132@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul d16~136@ 67) (Mul c16~134@ d16~136@))) d16~136@)) (=> (= tmp%17@ (= temp_16_0~2305@ temp_16_1~2354@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2426@ (Sub (Mul (Mul b17~140@ (Mul a17~138@ b17~140@)) (Mul (Mul d17~144@ d17~144@) (Mul c17~142@ c17~142@))) (Mul (Mul (Mul c17~142@ d17~144@) d17~144@) (Sub (Mul d17~144@ c17~142@) (Mul a17~138@ d17~144@))))) (=> (= temp_17_1~2483@ (Sub (Mul (Mul b17~140@ (Mul a17~138@ b17~140@)) (Mul d17~144@ (Mul d17~144@ (Mul c17~142@ c17~142@)))) (Mul (Mul (Mul c17~142@ d17~144@) d17~144@) (Sub (Mul d17~144@ c17~142@) (Mul a17~138@ d17~144@))))) (=> (= tmp%18@ (= temp_17_0~2426@ temp_17_1~2483@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2575@ (Mul (Mul (Mul (Add b18~148@ c18~150@) (Mul a18~146@ b18~148@)) (Sub (Mul a18~146@ d18~152@) (Mul c18~150@ 31))) (Mul (Mul (Sub b18~148@ b18~148@) (Mul a18~146@ c18~150@)) (Mul (Mul a18~146@ c18~150@) (Sub c18~150@ d18~152@))))) (=> (= temp_18_1~2652@ (Mul (Mul (Sub (Mul a18~146@ d18~152@) (Mul c18~150@ 31)) (Mul (Add b18~148@ c18~150@) (Mul a18~146@ b18~148@))) (Mul (Mul (Sub b18~148@ b18~148@) (Mul a18~146@ c18~150@)) (Mul (Mul a18~146@ c18~150@) (Sub c18~150@ d18~152@))))) (=> (= tmp%19@ (= temp_18_0~2575@ temp_18_1~2652@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2724@ (Mul (Mul (Mul d19~160@ (Mul a19~154@ d19~160@)) (Mul (Sub a19~154@ b19~156@) (Mul c19~158@ b19~156@))) (Mul (Add (Sub c19~158@ d19~160@) (Mul d19~160@ a19~154@)) (Add (Add a19~154@ a19~154@) b19~156@)))) (=> (= temp_19_1~2797@ (Mul (Mul (Mul d19~160@ (Mul a19~154@ d19~160@)) (Mul (Sub a19~154@ b19~156@) (Mul c19~158@ b19~156@))) (Add (Mul (Add (Sub c19~158@ d19~160@) (Mul d19~160@ a19~154@)) (Add a19~154@ a19~154@)) (Mul (Add (Sub c19~158@ d19~160@) (Mul d19~160@ a19~154@)) b19~156@)))) (=> (= tmp%20@ (= temp_19_0~2724@ temp_19_1~2797@)) (=> %%location_label%%19 tmp%20@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
