...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ a0~2@)) (Mul (Mul 77 d0~8@) (Add a0~2@ b0~4@))) (Mul (Mul (Mul b0~4@ d0~8@) b0~4@) (Mul (Add b0~4@ c0~6@) (Sub b0~4@ b0~4@))))) (=> (= temp_0_1~386@ (Mul (Mul (Mul (Mul 77 d0~8@) (Add a0~2@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ a0~2@))) (Mul (Mul (Mul b0~4@ d0~8@) b0~4@) (Mul (Add b0~4@ c0~6@) (Sub b0~4@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~386@))) (=> (= temp_0_0~313@ temp_0_1~386@) (=> (= temp_1_0~475@ (Mul (Add (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ a1~10@))) (Mul (Add (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@)) (Mul (Sub b1~12@ b1~12@) (Sub a1~10@ d1~16@))))) (=> (= temp_1_1~540@ (Mul (Add (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@))) (Mul (Add (Mul c1~14@ a1~10@) (Mul d1~16@ c1~14@)) (Mul (Sub b1~12@ b1~12@) (Sub a1~10@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~475@ temp_1_1~540@))) (=> (= temp_1_0~475@ temp_1_1~540@) (=> (= temp_2_0~617@ (Add (Mul c2~22@ (Mul (Add a2~18@ d2~24@) (Sub b2~20@ a2~18@))) (Add (Mul (Add a2~18@ c2~22@) (Mul d2~24@ b2~20@)) (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~670@ (Add (Mul (Mul (Add a2~18@ d2~24@) (Sub b2~20@ a2~18@)) c2~22@) (Add (Mul (Add a2~18@ c2~22@) (Mul d2~24@ b2~20@)) (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~617@ temp_2_1~670@))) (=> (= temp_2_0~617@ temp_2_1~670@) (=> (= temp_3_0~747@ (Add (Mul (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ d3~32@)) b3~28@))) (=> (= temp_3_1~800@ (Add (Mul (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@)) b3~28@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~747@ temp_3_1~800@))) (=> (= temp_3_0~747@ temp_3_1~800@) (=> (= temp_4_0~861@ (Mul c4~38@ (Mul (Mul (Sub b4~36@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~898@ (Mul c4~38@ (Mul (Mul (Sub b4~36@ c4~38@) (Mul d4~40@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~861@ temp_4_1~898@))) (=> (= temp_4_0~861@ temp_4_1~898@) (=> (= temp_5_0~983@ (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ a5~42@)) (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@))) (Mul (Mul d5~48@ (Add b5~44@ c5~46@)) (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@))))) (=> (= temp_5_1~1044@ (Mul (Mul (Mul d5~48@ (Add b5~44@ c5~46@)) (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ a5~42@)) (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~983@ temp_5_1~1044@))) (=> (= temp_5_0~983@ temp_5_1~1044@) (=> (= temp_6_0~1145@ (Mul (Mul (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Mul b6~52@ d6~56@) (Add d6~56@ b6~52@))) (Sub (Mul (Mul 0 a6~50@) (Sub a6~50@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1222@ (Mul (Mul (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Mul b6~52@ d6~56@) (Add d6~56@ b6~52@))) (Sub (Mul (Mul 0 a6~50@) (Sub a6~50@ a6~50@)) (Mul (Mul (Mul c6~54@ d6~56@) b6~52@) b6~52@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1145@ temp_6_1~1222@))) (=> (= temp_6_0~1145@ temp_6_1~1222@) (=> (= temp_7_0~1299@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ d7~64@))) (Mul b7~60@ (Mul (Mul c7~62@ d7~64@) (Sub b7~60@ d7~64@))))) (=> (= temp_7_1~1352@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ b7~60@))) (Mul b7~60@ (Mul (Mul c7~62@ d7~64@) (Sub b7~60@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1299@ temp_7_1~1352@))) (=> (= temp_7_0~1299@ temp_7_1~1352@) (=> (= temp_8_0~1401@ (Mul (Mul a8~66@ (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ a8~66@))) d8~72@)) (=> (= temp_8_1~1426@ (Mul (Mul a8~66@ (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ b8~68@))) d8~72@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1401@ temp_8_1~1426@))) (=> (= temp_8_0~1401@ temp_8_1~1426@) (=> (= temp_9_0~1535@ (Add (Mul (Mul (Mul c9~78@ d9~80@) (Sub d9~80@ b9~76@)) (Add (Mul c9~78@ b9~76@) 39)) (Mul (Mul (Mul b9~76@ 9) (Mul a9~74@ a9~74@)) (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1620@ (Add (Mul (Mul (Mul c9~78@ d9~80@) (Sub d9~80@ b9~76@)) (Add (Mul c9~78@ b9~76@) 39)) (Mul (Mul (Mul b9~76@ 9) (Mul a9~74@ a9~74@)) (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1535@ temp_9_1~1620@))) (=> (= temp_9_0~1535@ temp_9_1~1620@) (=> (= temp_10_0~1705@ (Add (Add d10~88@ (Mul (Mul b10~84@ c10~86@) (Sub a10~82@ b10~84@))) (Sub (Sub a10~82@ (Mul b10~84@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ 38))))) (=> (= temp_10_1~1774@ (Add (Add d10~88@ (Sub (Mul (Mul b10~84@ c10~86@) a10~82@) (Mul (Mul b10~84@ c10~86@) b10~84@))) (Sub (Sub a10~82@ (Mul b10~84@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ 38))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1705@ temp_10_1~1774@))) (=> (= temp_10_0~1705@ temp_10_1~1774@) (=> (= temp_11_0~1863@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul d11~96@ b11~92@)) (Mul (Add b11~92@ c11~94@) (Sub d11~96@ a11~90@))) (Sub (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ b11~92@)) (Mul (Add a11~90@ a11~90@) (Add a11~90@ d11~96@))))) (=> (= temp_11_1~1928@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul b11~92@ d11~96@)) (Mul (Add b11~92@ c11~94@) (Sub d11~96@ a11~90@))) (Sub (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ b11~92@)) (Mul (Add a11~90@ a11~90@) (Add a11~90@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1863@ temp_11_1~1928@))) (=> (= temp_11_0~1863@ temp_11_1~1928@) (=> (= temp_12_0~2013@ (Mul (Add (Mul (Mul c12~102@ a12~98@) (Sub d12~104@ d12~104@)) (Mul a12~98@ (Mul b12~100@ a12~98@))) (Mul (Mul (Add a12~98@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2082@ (Mul (Add (Sub (Mul (Mul c12~102@ a12~98@) d12~104@) (Mul (Mul c12~102@ a12~98@) d12~104@)) (Mul a12~98@ (Mul b12~100@ a12~98@))) (Mul (Mul (Add a12~98@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2013@ temp_12_1~2082@))) (=> (= temp_12_0~2013@ temp_12_1~2082@) (=> (= temp_13_0~2147@ (Mul (Mul b13~108@ (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ d13~112@))) (Add (Mul (Mul d13~112@ c13~110@) (Mul c13~110@ d13~112@)) b13~108@))) (=> (= temp_13_1~2188@ (Mul (Mul b13~108@ (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ d13~112@))) (Add (Mul d13~112@ (Mul c13~110@ (Mul c13~110@ d13~112@))) b13~108@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2147@ temp_13_1~2188@))) (=> (= temp_13_0~2147@ temp_13_1~2188@) (=> (= temp_14_0~2265@ (Mul (Mul (Mul (Add d14~120@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Mul a14~114@ d14~120@) (Sub d14~120@ b14~116@))) (Mul (Mul (Mul c14~118@ d14~120@) (Mul c14~118@ b14~116@)) c14~118@))) (=> (= temp_14_1~2318@ (Mul (Mul (Mul (Mul (Add d14~120@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Mul a14~114@ d14~120@) (Sub d14~120@ b14~116@))) (Mul (Mul c14~118@ d14~120@) (Mul c14~118@ b14~116@))) c14~118@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2265@ temp_14_1~2318@))) (=> (= temp_14_0~2265@ temp_14_1~2318@) (=> (= temp_15_0~2399@ (Mul (Mul (Add (Sub d15~128@ a15~122@) (Mul c15~126@ b15~124@)) (Mul (Mul a15~122@ d15~128@) a15~122@)) (Mul (Mul (Sub c15~126@ b15~124@) (Mul b15~124@ b15~124@)) (Mul a15~122@ (Mul d15~128@ c15~126@))))) (=> (= temp_15_1~2456@ (Mul (Mul (Add (Sub d15~128@ a15~122@) (Mul c15~126@ b15~124@)) (Mul (Mul a15~122@ d15~128@) a15~122@)) (Mul (Mul a15~122@ (Mul d15~128@ c15~126@)) (Mul (Sub c15~126@ b15~124@) (Mul b15~124@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2399@ temp_15_1~2456@))) (=> (= temp_15_0~2399@ temp_15_1~2456@) (=> (= temp_16_0~2529@ (Add (Mul c16~134@ (Sub a16~130@ (Mul b16~132@ c16~134@))) (Mul (Sub (Mul c16~134@ d16~136@) (Mul a16~130@ c16~134@)) (Mul (Sub a16~130@ b16~132@) (Add b16~132@ c16~134@))))) (=> (= temp_16_1~2578@ (Add (Mul c16~134@ (Sub a16~130@ (Mul b16~132@ c16~134@))) (Mul (Mul (Sub a16~130@ b16~132@) (Add b16~132@ c16~134@)) (Sub (Mul c16~134@ d16~136@) (Mul a16~130@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2529@ temp_16_1~2578@))) (=> (= temp_16_0~2529@ temp_16_1~2578@) (=> (= temp_17_0~2667@ (Mul (Mul (Sub (Mul a17~138@ d17~144@) (Mul a17~138@ d17~144@)) (Mul (Mul c17~142@ b17~140@) (Mul a17~138@ c17~142@))) (Mul (Mul (Mul c17~142@ c17~142@) (Mul c17~142@ c17~142@)) (Mul (Sub a17~138@ a17~138@) (Add a17~138@ b17~140@))))) (=> (= temp_17_1~2732@ (Mul (Mul (Sub (Mul a17~138@ d17~144@) (Mul d17~144@ a17~138@)) (Mul (Mul c17~142@ b17~140@) (Mul a17~138@ c17~142@))) (Mul (Mul (Mul c17~142@ c17~142@) (Mul c17~142@ c17~142@)) (Mul (Sub a17~138@ a17~138@) (Add a17~138@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2667@ temp_17_1~2732@))) (=> (= temp_17_0~2667@ temp_17_1~2732@) (=> (= temp_18_0~2821@ (Mul (Add (Add (Mul b18~148@ c18~150@) (Add c18~150@ d18~152@)) (Mul (Add c18~150@ b18~148@) (Mul d18~152@ a18~146@))) (Mul (Mul (Mul b18~148@ a18~146@) (Mul a18~146@ c18~150@)) (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ a18~146@))))) (=> (= temp_18_1~2886@ (Mul (Add (Add (Mul b18~148@ c18~150@) (Add c18~150@ d18~152@)) (Mul (Add c18~150@ b18~148@) (Mul d18~152@ a18~146@))) (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2821@ temp_18_1~2886@))) (=> (= temp_18_0~2821@ temp_18_1~2886@) (=> (= temp_19_0~2943@ (Mul (Add (Sub (Mul a19~154@ b19~156@) (Mul b19~156@ b19~156@)) (Mul c19~158@ (Mul b19~156@ a19~154@))) a19~154@)) (=> (= temp_19_1~2976@ (Mul (Add (Sub (Mul a19~154@ b19~156@) (Mul b19~156@ b19~156@)) (Mul (Mul b19~156@ a19~154@) c19~158@)) a19~154@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~2943@ temp_19_1~2976@))) (=> (= temp_19_0~2943@ temp_19_1~2976@) (=> (= temp_20_0~3057@ (Mul (Mul (Mul b20~164@ (Mul c20~166@ a20~162@)) (Mul c20~166@ (Mul d20~168@ a20~162@))) (Mul (Mul (Sub a20~162@ c20~166@) (Add c20~166@ c20~166@)) (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ c20~166@))))) (=> (= temp_20_1~3114@ (Mul (Mul (Mul b20~164@ (Mul a20~162@ c20~166@)) (Mul c20~166@ (Mul d20~168@ a20~162@))) (Mul (Mul (Sub a20~162@ c20~166@) (Add c20~166@ c20~166@)) (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ c20~166@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3057@ temp_20_1~3114@))) (=> (= temp_20_0~3057@ temp_20_1~3114@) (=> (= temp_21_0~3199@ (Mul (Mul (Sub (Mul a21~170@ b21~172@) (Mul b21~172@ c21~174@)) (Mul (Mul d21~176@ a21~170@) (Add a21~170@ c21~174@))) (Sub (Mul (Mul d21~176@ c21~174@) (Sub d21~176@ a21~170@)) (Mul (Mul d21~176@ b21~172@) b21~172@)))) (=> (= temp_21_1~3260@ (Mul (Mul (Mul (Mul d21~176@ a21~170@) (Add a21~170@ c21~174@)) (Sub (Mul a21~170@ b21~172@) (Mul b21~172@ c21~174@))) (Sub (Mul (Mul d21~176@ c21~174@) (Sub d21~176@ a21~170@)) (Mul (Mul d21~176@ b21~172@) b21~172@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3199@ temp_21_1~3260@))) (=> (= temp_21_0~3199@ temp_21_1~3260@) (=> (= temp_22_0~3361@ (Mul (Mul (Mul (Mul b22~180@ a22~178@) (Mul d22~184@ d22~184@)) (Mul (Mul c22~182@ a22~178@) (Mul 26 a22~178@))) (Mul (Mul (Mul c22~182@ b22~180@) (Mul a22~178@ a22~178@)) (Mul (Mul c22~182@ c22~182@) (Mul c22~182@ b22~180@))))) (=> (= temp_22_1~3438@ (Mul (Mul (Mul (Mul b22~180@ a22~178@) (Mul d22~184@ d22~184@)) (Mul (Mul c22~182@ a22~178@) (Mul 26 a22~178@))) (Mul (Mul (Mul c22~182@ b22~180@) (Mul a22~178@ a22~178@)) (Mul (Mul (Mul c22~182@ c22~182@) c22~182@) b22~180@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3361@ temp_22_1~3438@))) (=> (= temp_22_0~3361@ temp_22_1~3438@) (=> (= temp_23_0~3527@ (Mul (Add c23~190@ (Mul (Mul d23~192@ 52) (Mul d23~192@ c23~190@))) (Mul (Mul (Mul c23~190@ b23~188@) (Sub b23~188@ c23~190@)) (Sub (Mul b23~188@ d23~192@) (Mul a23~186@ a23~186@))))) (=> (= temp_23_1~3592@ (Mul (Add c23~190@ (Mul (Mul d23~192@ 52) (Mul d23~192@ c23~190@))) (Mul (Sub (Mul b23~188@ d23~192@) (Mul a23~186@ a23~186@)) (Mul (Mul c23~190@ b23~188@) (Sub b23~188@ c23~190@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3527@ temp_23_1~3592@))) (=> (= temp_23_0~3527@ temp_23_1~3592@) (=> (= temp_24_0~3681@ (Mul (Mul (Sub (Sub c24~198@ d24~200@) (Sub d24~200@ c24~198@)) (Mul (Mul a24~194@ c24~198@) (Mul a24~194@ b24~196@))) (Mul (Mul (Mul c24~198@ d24~200@) (Mul c24~198@ c24~198@)) (Mul (Mul a24~194@ a24~194@) (Mul c24~198@ c24~198@))))) (=> (= temp_24_1~3746@ (Mul (Sub (Sub c24~198@ d24~200@) (Sub d24~200@ c24~198@)) (Mul (Mul (Mul a24~194@ c24~198@) (Mul a24~194@ b24~196@)) (Mul (Mul (Mul c24~198@ d24~200@) (Mul c24~198@ c24~198@)) (Mul (Mul a24~194@ a24~194@) (Mul c24~198@ c24~198@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3681@ temp_24_1~3746@))) (=> (= temp_24_0~3681@ temp_24_1~3746@) (=> (= temp_25_0~3843@ (Mul (Mul (Sub (Mul a25~202@ d25~208@) (Mul b25~204@ a25~202@)) (Sub (Mul c25~206@ c25~206@) (Mul d25~208@ 67))) (Mul (Mul (Mul d25~208@ c25~206@) (Mul c25~206@ d25~208@)) (Mul a25~202@ (Mul a25~202@ c25~206@))))) (=> (= temp_25_1~3916@ (Mul (Mul (Sub (Mul a25~202@ d25~208@) (Mul b25~204@ a25~202@)) (Sub (Mul c25~206@ c25~206@) (Mul d25~208@ 67))) (Mul (Mul (Mul d25~208@ c25~206@) (Mul c25~206@ d25~208@)) (Mul (Mul a25~202@ a25~202@) c25~206@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~3843@ temp_25_1~3916@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
