...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Add a0~2@ a0~2@)) (Mul (Add a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul (Add a0~2@ b0~4@) (Mul c0~6@ a0~2@)) (Mul d0~8@ (Sub c0~6@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Add a0~2@ a0~2@)) (Mul (Add a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul (Add a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul d0~8@ (Sub c0~6@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~438@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ d1~16@)) (Sub (Mul c1~14@ a1~10@) (Add a1~10@ b1~12@))) (Sub (Add (Sub b1~12@ b1~12@) (Add a1~10@ c1~14@)) (Mul (Mul c1~14@ b1~12@) b1~12@)))) (=> (= temp_1_1~499@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ d1~16@)) (Sub (Mul c1~14@ a1~10@) (Add a1~10@ b1~12@))) (Sub (Add (Sub b1~12@ b1~12@) (Add a1~10@ c1~14@)) (Mul b1~12@ (Mul c1~14@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~438@ temp_1_1~499@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~579@ (Mul (Add (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Add (Mul c2~22@ b2~20@) (Mul d2~24@ b2~20@)) (Mul (Sub c2~22@ b2~20@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~644@ (Mul (Add (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Add (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Sub c2~22@ b2~20@) (Mul c2~22@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~579@ temp_2_1~644@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~720@ (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Add b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@))) (Mul (Mul c3~30@ (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ a3~26@))))) (=> (= temp_3_1~781@ (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Add b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@))) (Mul c3~30@ (Mul (Mul a3~26@ d3~32@) (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ a3~26@)))))) (=> (= tmp%4@ (= temp_3_0~720@ temp_3_1~781@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~873@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Sub a4~34@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@))) (Mul (Mul (Mul a4~34@ 87) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~950@ (Mul (Mul (Mul c4~38@ d4~40@) (Sub a4~34@ c4~38@)) (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul (Mul a4~34@ 87) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ a4~34@)))))) (=> (= tmp%5@ (= temp_4_0~873@ temp_4_1~950@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1026@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Sub (Mul c5~46@ c5~46@) (Mul a5~42@ b5~44@))) (Mul (Mul (Add a5~42@ c5~46@) d5~48@) (Mul (Mul a5~42@ a5~42@) (Sub a5~42@ a5~42@))))) (=> (= temp_5_1~1087@ (Mul (Mul (Mul (Add a5~42@ c5~46@) d5~48@) (Mul (Mul a5~42@ a5~42@) (Sub a5~42@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Sub (Mul c5~46@ c5~46@) (Mul a5~42@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1026@ temp_5_1~1087@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1175@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Sub d6~56@ c6~54@)) (Add (Mul b6~52@ c6~54@) (Mul 33 b6~52@))) (Mul (Mul b6~52@ (Mul d6~56@ c6~54@)) (Add (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1248@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Sub d6~56@ c6~54@)) (Add (Mul b6~52@ c6~54@) (Mul 33 b6~52@))) (Mul (Mul b6~52@ (Mul d6~56@ c6~54@)) (Add (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1175@ temp_6_1~1248@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1316@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@)) d7~64@) (Mul (Add (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1369@ (Mul (Mul (Add (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ a7~58@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@)) d7~64@))) (=> (= tmp%8@ (= temp_7_0~1316@ temp_7_1~1369@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1461@ (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Sub d8~72@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Sub b8~68@ d8~72@))) (Mul (Mul (Sub 74 a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ b8~68@))))) (=> (= temp_8_1~1538@ (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Sub d8~72@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Sub b8~68@ d8~72@))) (Mul (Mul (Sub 74 a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul d8~72@ b8~68@) (Mul a8~66@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1461@ temp_8_1~1538@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1622@ (Add (Sub (Sub (Mul c9~78@ b9~76@) (Add b9~76@ c9~78@)) (Mul d9~80@ (Add d9~80@ b9~76@))) (Mul (Mul 26 (Mul c9~78@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~1691@ (Add (Sub (Sub (Mul c9~78@ b9~76@) (Add b9~76@ c9~78@)) (Mul (Add d9~80@ b9~76@) d9~80@)) (Mul (Mul 26 (Mul c9~78@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1622@ temp_9_1~1691@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1771@ (Mul (Mul (Mul (Sub c10~86@ b10~84@) (Mul c10~86@ c10~86@)) (Sub (Mul b10~84@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul b10~84@ a10~82@) (Add a10~82@ b10~84@)) (Mul (Add d10~88@ a10~82@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~1836@ (Mul (Mul (Mul (Sub c10~86@ b10~84@) (Mul c10~86@ c10~86@)) (Sub (Mul b10~84@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul b10~84@ a10~82@) (Add a10~82@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Add d10~88@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1771@ temp_10_1~1836@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1912@ (Add (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul c11~94@ b11~92@))) (Mul (Sub (Add d11~96@ b11~92@) d11~96@) (Mul (Add d11~96@ c11~94@) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~1973@ (Add (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ c11~94@))) (Mul (Sub (Add d11~96@ b11~92@) d11~96@) (Mul (Add d11~96@ c11~94@) (Mul a11~90@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1912@ temp_11_1~1973@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2037@ (Mul (Mul (Sub c12~102@ (Mul d12~104@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ b12~100@))) (Sub d12~104@ (Mul (Mul c12~102@ a12~98@) (Mul c12~102@ c12~102@))))) (=> (= temp_12_1~2086@ (Mul (Sub c12~102@ (Mul d12~104@ c12~102@)) (Mul (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ b12~100@)) (Sub d12~104@ (Mul (Mul c12~102@ a12~98@) (Mul c12~102@ c12~102@)))))) (=> (= tmp%13@ (= temp_12_0~2037@ temp_12_1~2086@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2190@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Add 86 a13~106@)) (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ b13~108@))) (Mul (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ b13~108@)) (Mul (Mul d13~112@ 77) (Mul b13~108@ c13~110@))))) (=> (= temp_13_1~2279@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Add 86 a13~106@)) (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ b13~108@))) (Mul (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ b13~108@)) (Mul (Mul 77 d13~112@) (Mul b13~108@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2190@ temp_13_1~2279@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2379@ (Mul (Mul (Mul (Mul a14~114@ 15) d14~120@) (Mul (Mul b14~116@ b14~116@) (Mul 49 b14~116@))) (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Mul a14~114@ b14~116@) (Mul c14~118@ c14~118@))))) (=> (= temp_14_1~2464@ (Mul (Mul (Mul (Mul 15 a14~114@) d14~120@) (Mul (Mul b14~116@ b14~116@) (Mul 49 b14~116@))) (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Mul a14~114@ b14~116@) (Mul c14~118@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2379@ temp_14_1~2464@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2536@ (Sub (Add (Add (Mul a15~122@ b15~124@) (Mul b15~124@ a15~122@)) (Mul c15~126@ (Mul a15~122@ c15~126@))) (Mul (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ d15~128@)) (Mul (Mul a15~122@ d15~128@) b15~124@)))) (=> (= temp_15_1~2593@ (Sub (Add (Add (Mul a15~122@ b15~124@) (Mul b15~124@ a15~122@)) (Mul c15~126@ (Mul a15~122@ c15~126@))) (Mul (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ d15~128@)) (Mul (Mul d15~128@ a15~122@) b15~124@)))) (=> (= tmp%16@ (= temp_15_0~2536@ temp_15_1~2593@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2661@ (Mul (Mul b16~132@ (Add (Mul b16~132@ d16~136@) (Mul a16~130@ d16~136@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ d16~136@))))) (=> (= temp_16_1~2714@ (Mul (Mul (Mul (Mul a16~130@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ d16~136@))) (Mul b16~132@ (Add (Mul b16~132@ d16~136@) (Mul a16~130@ d16~136@))))) (=> (= tmp%17@ (= temp_16_0~2661@ temp_16_1~2714@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2806@ (Mul (Sub (Mul (Mul a17~138@ 3) (Mul b17~140@ d17~144@)) (Mul (Mul c17~142@ b17~140@) (Mul c17~142@ b17~140@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ c17~142@)) (Add (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~2883@ (Mul (Sub (Mul (Mul a17~138@ 3) (Mul d17~144@ b17~140@)) (Mul (Mul c17~142@ b17~140@) (Mul c17~142@ b17~140@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ c17~142@)) (Add (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@))))) (=> (= tmp%18@ (= temp_17_0~2806@ temp_17_1~2883@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2971@ (Mul (Mul (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ a18~146@)) (Mul b18~148@ (Add 47 c18~150@))) (Mul (Mul (Sub b18~148@ c18~150@) (Mul a18~146@ d18~152@)) (Mul (Add a18~146@ d18~152@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~3052@ (Mul (Mul (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ a18~146@)) (Mul b18~148@ (Add 47 c18~150@))) (Mul (Sub (Mul b18~148@ (Mul a18~146@ d18~152@)) (Mul c18~150@ (Mul a18~146@ d18~152@))) (Mul (Add a18~146@ d18~152@) (Mul a18~146@ d18~152@))))) (=> (= tmp%19@ (= temp_18_0~2971@ temp_18_1~3052@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3144@ (Mul (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ d19~160@)) (Mul (Mul c19~158@ 24) (Add b19~156@ a19~154@))) (Mul (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ b19~156@)) (Mul (Add c19~158@ b19~156@) (Mul d19~160@ a19~154@))))) (=> (= temp_19_1~3221@ (Mul (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ d19~160@)) (Mul (Mul c19~158@ 24) (Add b19~156@ a19~154@))) (Mul (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ b19~156@)) (Mul (Add c19~158@ b19~156@) (Mul a19~154@ d19~160@))))) (=> (= tmp%20@ (= temp_19_0~3144@ temp_19_1~3221@)) (=> %%location_label%%19 tmp%20@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
