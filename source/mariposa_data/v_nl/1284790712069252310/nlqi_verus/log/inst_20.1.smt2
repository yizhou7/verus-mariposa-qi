...
(set-info :comment ";; mariposa_data/v_nl//1284790712069252310/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_8_0~1749@ Int)
(declare-const temp_8_1~1826@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Add a0~2@ a0~2@)) (Mul (Add a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul (Add a0~2@ b0~4@) (Mul c0~6@ a0~2@)) (Mul d0~8@ (Sub c0~6@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Add a0~2@ a0~2@)) (Mul (Add a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul (Add a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul d0~8@ (Sub c0~6@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ a0~2@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~451@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ d1~16@)) (Sub (Mul c1~14@ a1~10@) (Add a1~10@ b1~12@))) (Sub (Add (Sub b1~12@ b1~12@) (Add a1~10@ c1~14@)) (Mul (Mul c1~14@ b1~12@) b1~12@)))) (=> (= temp_1_1~512@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ d1~16@)) (Sub (Mul c1~14@ a1~10@) (Add a1~10@ b1~12@))) (Sub (Add (Sub b1~12@ b1~12@) (Add a1~10@ c1~14@)) (Mul b1~12@ (Mul c1~14@ b1~12@))))) (and (=> (= tmp%1@ (Mul c1~14@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ b1~12@) (=> %%location_label%%1 (= temp_1_0~451@ temp_1_1~512@)))) (=> (= temp_1_0~451@ temp_1_1~512@) (=> (= temp_2_0~609@ (Mul (Add (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Add (Mul c2~22@ b2~20@) (Mul d2~24@ b2~20@)) (Mul (Sub c2~22@ b2~20@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~674@ (Mul (Add (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Add (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Sub c2~22@ b2~20@) (Mul c2~22@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ b2~20@) (=> %%location_label%%2 (= temp_2_0~609@ temp_2_1~674@))) (=> (= temp_2_0~609@ temp_2_1~674@) (=> (= temp_3_0~763@ (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Add b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@))) (Mul (Mul c3~30@ (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ a3~26@))))) (=> (= temp_3_1~824@ (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Add b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@))) (Mul c3~30@ (Mul (Mul a3~26@ d3~32@) (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ a3~26@)))))) (and (=> (= tmp%2@ (Mul a3~26@ d3~32@)) (=> (= tmp%3@ (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. c3~30@ tmp%2@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~763@ temp_3_1~824@))))) (=> (= temp_3_0~763@ temp_3_1~824@) (=> (= temp_4_0~947@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Sub a4~34@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@))) (Mul (Mul (Mul a4~34@ 87) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~1024@ (Mul (Mul (Mul c4~38@ d4~40@) (Sub a4~34@ c4~38@)) (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul (Mul a4~34@ 87) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ a4~34@)))))) (and (=> (= tmp%4@ (Mul (Mul c4~38@ d4~40@) (Sub a4~34@ c4~38@))) (=> (= tmp%5@ (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@))) (=> (= tmp%6@ (Mul (Mul (Mul a4~34@ 87) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ a4~34@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~947@ temp_4_1~1024@)))))) (=> (= temp_4_0~947@ temp_4_1~1024@) (=> (= temp_5_0~1179@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Sub (Mul c5~46@ c5~46@) (Mul a5~42@ b5~44@))) (Mul (Mul (Add a5~42@ c5~46@) d5~48@) (Mul (Mul a5~42@ a5~42@) (Sub a5~42@ a5~42@))))) (=> (= temp_5_1~1240@ (Mul (Mul (Mul (Add a5~42@ c5~46@) d5~48@) (Mul (Mul a5~42@ a5~42@) (Sub a5~42@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Sub (Mul c5~46@ c5~46@) (Mul a5~42@ b5~44@))))) (and (=> (= tmp%7@ (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Sub (Mul c5~46@ c5~46@) (Mul a5~42@ b5~44@)))) (=> (= tmp%8@ (Mul (Mul (Add a5~42@ c5~46@) d5~48@) (Mul (Mul a5~42@ a5~42@) (Sub a5~42@ a5~42@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~1179@ temp_5_1~1240@))))) (=> (= temp_5_0~1179@ temp_5_1~1240@) (=> (= temp_6_0~1393@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Sub d6~56@ c6~54@)) (Add (Mul b6~52@ c6~54@) (Mul 33 b6~52@))) (Mul (Mul b6~52@ (Mul d6~56@ c6~54@)) (Add (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1466@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Sub d6~56@ c6~54@)) (Add (Mul b6~52@ c6~54@) (Mul 33 b6~52@))) (Mul (Mul b6~52@ (Mul d6~56@ c6~54@)) (Add (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1393@ temp_6_1~1466@))) (=> (= temp_6_0~1393@ temp_6_1~1466@) (=> (= temp_7_0~1547@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@)) d7~64@) (Mul (Add (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1600@ (Mul (Mul (Add (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ a7~58@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@)) d7~64@))) (and (=> (= tmp%9@ (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@)) d7~64@)) (=> (= tmp%10@ (Mul (Add (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ a7~58@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~1547@ temp_7_1~1600@))))) (=> (= temp_7_0~1547@ temp_7_1~1600@) (=> (= temp_8_0~1749@ (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Sub d8~72@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Sub b8~68@ d8~72@))) (Mul (Mul (Sub 74 a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ b8~68@))))) (=> (= temp_8_1~1826@ (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Sub d8~72@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Sub b8~68@ d8~72@))) (Mul (Mul (Sub 74 a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul d8~72@ b8~68@) (Mul a8~66@ d8~72@))))) (and (=> (= tmp%11@ (Mul a8~66@ d8~72@)) (=> (= tmp%12@ (Mul d8~72@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%8 (= temp_8_0~1749@ temp_8_1~1826@))))) (=> (= temp_8_0~1749@ temp_8_1~1826@) (=> (= temp_9_0~1931@ (Add (Sub (Sub (Mul c9~78@ b9~76@) (Add b9~76@ c9~78@)) (Mul d9~80@ (Add d9~80@ b9~76@))) (Mul (Mul 26 (Mul c9~78@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~2000@ (Add (Sub (Sub (Mul c9~78@ b9~76@) (Add b9~76@ c9~78@)) (Mul (Add d9~80@ b9~76@) d9~80@)) (Mul (Mul 26 (Mul c9~78@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ a9~74@))))) (and (=> (= tmp%13@ (Add d9~80@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ tmp%13@) (=> %%location_label%%9 (= temp_9_0~1931@ temp_9_1~2000@)))) (=> (= temp_9_0~1931@ temp_9_1~2000@) (=> (= temp_10_0~2097@ (Mul (Mul (Mul (Sub c10~86@ b10~84@) (Mul c10~86@ c10~86@)) (Sub (Mul b10~84@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul b10~84@ a10~82@) (Add a10~82@ b10~84@)) (Mul (Add d10~88@ a10~82@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~2162@ (Mul (Mul (Mul (Sub c10~86@ b10~84@) (Mul c10~86@ c10~86@)) (Sub (Mul b10~84@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul b10~84@ a10~82@) (Add a10~82@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Add d10~88@ a10~82@))))) (and (=> (= tmp%14@ (Add d10~88@ a10~82@)) (=> (= tmp%15@ (Mul b10~84@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%10 (= temp_10_0~2097@ temp_10_1~2162@))))) (=> (= temp_10_0~2097@ temp_10_1~2162@) (=> (= temp_11_0~2259@ (Add (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul c11~94@ b11~92@))) (Mul (Sub (Add d11~96@ b11~92@) d11~96@) (Mul (Add d11~96@ c11~94@) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~2320@ (Add (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ c11~94@))) (Mul (Sub (Add d11~96@ b11~92@) d11~96@) (Mul (Add d11~96@ c11~94@) (Mul a11~90@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c11~94@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2259@ temp_11_1~2320@))) (=> (= temp_11_0~2259@ temp_11_1~2320@) (=> (= temp_12_0~2397@ (Mul (Mul (Sub c12~102@ (Mul d12~104@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ b12~100@))) (Sub d12~104@ (Mul (Mul c12~102@ a12~98@) (Mul c12~102@ c12~102@))))) (=> (= temp_12_1~2446@ (Mul (Sub c12~102@ (Mul d12~104@ c12~102@)) (Mul (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ b12~100@)) (Sub d12~104@ (Mul (Mul c12~102@ a12~98@) (Mul c12~102@ c12~102@)))))) (and (=> (= tmp%16@ (Sub c12~102@ (Mul d12~104@ c12~102@))) (=> (= tmp%17@ (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ b12~100@))) (=> (= tmp%18@ (Sub d12~104@ (Mul (Mul c12~102@ a12~98@) (Mul c12~102@ c12~102@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%12 (= temp_12_0~2397@ temp_12_1~2446@)))))) (=> (= temp_12_0~2397@ temp_12_1~2446@) (=> (= temp_13_0~2601@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Add 86 a13~106@)) (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ b13~108@))) (Mul (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ b13~108@)) (Mul (Mul d13~112@ 77) (Mul b13~108@ c13~110@))))) (=> (= temp_13_1~2690@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Add 86 a13~106@)) (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ b13~108@))) (Mul (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ b13~108@)) (Mul (Mul 77 d13~112@) (Mul b13~108@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d13~112@ 77) (=> %%location_label%%13 (= temp_13_0~2601@ temp_13_1~2690@))) (=> (= temp_13_0~2601@ temp_13_1~2690@) (=> (= temp_14_0~2815@ (Mul (Mul (Mul (Mul a14~114@ 15) d14~120@) (Mul (Mul b14~116@ b14~116@) (Mul 49 b14~116@))) (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Mul a14~114@ b14~116@) (Mul c14~118@ c14~118@))))) (=> (= temp_14_1~2900@ (Mul (Mul (Mul (Mul 15 a14~114@) d14~120@) (Mul (Mul b14~116@ b14~116@) (Mul 49 b14~116@))) (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Mul a14~114@ b14~116@) (Mul c14~118@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a14~114@ 15) (=> %%location_label%%14 (= temp_14_0~2815@ temp_14_1~2900@))) (=> (= temp_14_0~2815@ temp_14_1~2900@) (=> (= temp_15_0~2997@ (Sub (Add (Add (Mul a15~122@ b15~124@) (Mul b15~124@ a15~122@)) (Mul c15~126@ (Mul a15~122@ c15~126@))) (Mul (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ d15~128@)) (Mul (Mul a15~122@ d15~128@) b15~124@)))) (=> (= temp_15_1~3054@ (Sub (Add (Add (Mul a15~122@ b15~124@) (Mul b15~124@ a15~122@)) (Mul c15~126@ (Mul a15~122@ c15~126@))) (Mul (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ d15~128@)) (Mul (Mul d15~128@ a15~122@) b15~124@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a15~122@ d15~128@) (=> %%location_label%%15 (= temp_15_0~2997@ temp_15_1~3054@))) (=> (= temp_15_0~2997@ temp_15_1~3054@) (=> (= temp_16_0~3135@ (Mul (Mul b16~132@ (Add (Mul b16~132@ d16~136@) (Mul a16~130@ d16~136@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ d16~136@))))) (=> (= temp_16_1~3188@ (Mul (Mul (Mul (Mul a16~130@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ d16~136@))) (Mul b16~132@ (Add (Mul b16~132@ d16~136@) (Mul a16~130@ d16~136@))))) (and (=> (= tmp%19@ (Mul b16~132@ (Add (Mul b16~132@ d16~136@) (Mul a16~130@ d16~136@)))) (=> (= tmp%20@ (Mul (Mul (Mul a16~130@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ d16~136@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%16 (= temp_16_0~3135@ temp_16_1~3188@))))) (=> (= temp_16_0~3135@ temp_16_1~3188@) (=> (= temp_17_0~3337@ (Mul (Sub (Mul (Mul a17~138@ 3) (Mul b17~140@ d17~144@)) (Mul (Mul c17~142@ b17~140@) (Mul c17~142@ b17~140@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ c17~142@)) (Add (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~3414@ (Mul (Sub (Mul (Mul a17~138@ 3) (Mul d17~144@ b17~140@)) (Mul (Mul c17~142@ b17~140@) (Mul c17~142@ b17~140@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ c17~142@)) (Add (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b17~140@ d17~144@) (=> %%location_label%%17 (= temp_17_0~3337@ temp_17_1~3414@))) (=> (= temp_17_0~3337@ temp_17_1~3414@) (=> (= temp_18_0~3515@ (Mul (Mul (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ a18~146@)) (Mul b18~148@ (Add 47 c18~150@))) (Mul (Mul (Sub b18~148@ c18~150@) (Mul a18~146@ d18~152@)) (Mul (Add a18~146@ d18~152@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~3596@ (Mul (Mul (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ a18~146@)) (Mul b18~148@ (Add 47 c18~150@))) (Mul (Sub (Mul b18~148@ (Mul a18~146@ d18~152@)) (Mul c18~150@ (Mul a18~146@ d18~152@))) (Mul (Add a18~146@ d18~152@) (Mul a18~146@ d18~152@))))) (and (=> (= tmp%21@ (Mul a18~146@ d18~152@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b18~148@ c18~150@ tmp%21@) (=> %%location_label%%18 (= temp_18_0~3515@ temp_18_1~3596@)))) (=> (= temp_18_0~3515@ temp_18_1~3596@) (=> (= temp_19_0~3707@ (Mul (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ d19~160@)) (Mul (Mul c19~158@ 24) (Add b19~156@ a19~154@))) (Mul (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ b19~156@)) (Mul (Add c19~158@ b19~156@) (Mul d19~160@ a19~154@))))) (=> (= temp_19_1~3784@ (Mul (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ d19~160@)) (Mul (Mul c19~158@ 24) (Add b19~156@ a19~154@))) (Mul (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ b19~156@)) (Mul (Add c19~158@ b19~156@) (Mul a19~154@ d19~160@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d19~160@ a19~154@) (=> %%location_label%%19 (= temp_19_0~3707@ temp_19_1~3784@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
