...
(push)
 ...
 (declare-const temp_15_1~2728@ Int)
 ...
 (declare-const temp_19_0~3315@ Int)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~301@ temp_0_1~362@)
        (=>
         (= temp_1_0~447@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ d1~16@)) (Sub (Mul c1~14@
              a1~10@
             ) (Add a1~10@ b1~12@)
            )
         ...
         (=>
          (= temp_1_1~508@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ d1~16@)) (Sub (Mul c1~14@
               a1~10@
              ) (Add a1~10@ b1~12@)
             )
          ...
          (and
           ...
           (=>
            (= temp_1_0~447@ temp_1_1~508@)
            (=>
             (= temp_2_0~597@ (Mul (Add (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@
                  c2~22@
                 ) (Mul b2~20@ c2~22@)
                )
             ...
             (=>
              (= temp_2_1~662@ (Mul (Add (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@
                   c2~22@
                  ) (Mul b2~20@ c2~22@)
                 )
              ...
              (and
               ...
               (=>
                (= temp_2_0~597@ temp_2_1~662@)
                (=>
                 (= temp_3_0~747@ (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Add b3~28@ d3~32@)) (Mul (Mul d3~32@
                      c3~30@
                     ) (Mul b3~28@ b3~28@)
                    )
                 ...
                 (=>
                  (= temp_3_1~808@ (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Add b3~28@ d3~32@)) (Mul (Mul d3~32@
                       c3~30@
                      ) (Mul b3~28@ b3~28@)
                     )
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~747@ temp_3_1~808@)
                    (=>
                     (= temp_4_0~909@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Sub a4~34@ c4~38@)) (Mul (Mul a4~34@
                          a4~34@
                         ) (Mul d4~40@ d4~40@)
                        )
                     ...
                     (=>
                      (= temp_4_1~986@ (Mul (Mul (Mul c4~38@ d4~40@) (Sub a4~34@ c4~38@)) (Mul (Mul (Mul a4~34@
                           a4~34@
                          ) (Mul d4~40@ d4~40@)
                         ) (Mul (Mul (Mul a4~34@ 87) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@
                            a4~34@
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~909@ temp_4_1~986@)
                        (=>
                         (= temp_5_0~1071@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Sub (Mul c5~46@
                              c5~46@
                             ) (Mul a5~42@ b5~44@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1132@ (Mul (Mul (Mul (Add a5~42@ c5~46@) d5~48@) (Mul (Mul a5~42@ a5~42@)
                              (Sub a5~42@ a5~42@)
                             )
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1071@ temp_5_1~1132@)
                           ))
                           (=>
                            (= temp_5_0~1071@ temp_5_1~1132@)
                            (=>
                             (= temp_6_0~1229@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Sub d6~56@ c6~54@)) (Add (Mul b6~52@
                                  c6~54@
                                 ) (Mul 33 b6~52@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1302@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Sub d6~56@ c6~54@)) (Add (Mul b6~52@
                                   c6~54@
                                  ) (Mul 33 b6~52@)
                                 )
                                ) (Mul (Mul b6~52@ (Mul d6~56@ c6~54@)) (Add (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@)))
                              ...
                              (and
                               ...
                               (=>
                                (= temp_6_0~1229@ temp_6_1~1302@)
                                (=>
                                 (= temp_7_0~1379@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@)) d7~64@) (
                                    Mul (Add (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul b7~60@
                                      a7~58@
                                 )))))
                                 (=>
                                  (= temp_7_1~1432@ (Mul (Mul (Add (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@
                                       b7~60@
                                      ) (Mul b7~60@ a7~58@)
                                     )
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1379@ temp_7_1~1432@)
                                   ))
                                   (=>
                                    (= temp_7_0~1379@ temp_7_1~1432@)
                                    (=>
                                     (= temp_8_0~1533@ (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Sub d8~72@ d8~72@)) (Mul (Mul d8~72@
                                          d8~72@
                                         ) (Sub b8~68@ d8~72@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1610@ (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Sub d8~72@ d8~72@)) (Mul (Mul d8~72@
                                           d8~72@
                                          ) (Sub b8~68@ d8~72@)
                                         )
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1533@ temp_8_1~1610@)
                                       ))
                                       (=>
                                        (= temp_8_0~1533@ temp_8_1~1610@)
                                        (=>
                                         (= temp_9_0~1703@ (Add (Sub (Sub (Mul c9~78@ b9~76@) (Add b9~76@ c9~78@)) (Mul d9~80@
                                             (Add d9~80@ b9~76@)
                                            )
                                           ) (Mul (Mul 26 (Mul c9~78@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ a9~74@)))
                                         ))
                                         (=>
                                          (= temp_9_1~1772@ (Add (Sub (Sub (Mul c9~78@ b9~76@) (Add b9~76@ c9~78@)) (Mul (Add d9~80@
                                               b9~76@
                                              ) d9~80@
                                             )
                                            ) (Mul (Mul 26 (Mul c9~78@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ a9~74@)))
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1703@ temp_9_1~1772@)
                                           ))
                                           (=>
                                            (= temp_9_0~1703@ temp_9_1~1772@)
                                            (=>
                                             (= temp_10_0~1861@ (Mul (Mul (Mul (Sub c10~86@ b10~84@) (Mul c10~86@ c10~86@)) (Sub (
                                                  Mul b10~84@ b10~84@
                                                 ) (Mul c10~86@ b10~84@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1926@ (Mul (Mul (Mul (Sub c10~86@ b10~84@) (Mul c10~86@ c10~86@)) (Sub (
                                                   Mul b10~84@ b10~84@
                                                  ) (Mul c10~86@ b10~84@)
                                                 )
                                              ...
                                              (and
                                               ...
                                               (=>
                                                (= temp_10_0~1861@ temp_10_1~1926@)
                                                (=>
                                                 (= temp_11_0~2011@ (Add (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (
                                                      Mul c11~94@ b11~92@
                                                     ) (Mul c11~94@ b11~92@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2072@ (Add (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (
                                                       Mul c11~94@ b11~92@
                                                      ) (Mul b11~92@ c11~94@)
                                                     )
                                                    ) (Mul (Sub (Add d11~96@ b11~92@) d11~96@) (Mul (Add d11~96@ c11~94@) (Mul a11~90@ c11~94@)))
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~2011@ temp_11_1~2072@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~2011@ temp_11_1~2072@)
                                                    (=>
                                                     (= temp_12_0~2145@ (Mul (Mul (Sub c12~102@ (Mul d12~104@ c12~102@)) (Mul (Mul d12~104@
                                                          b12~100@
                                                         ) (Mul a12~98@ b12~100@)
                                                        )
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2194@ (Mul (Sub c12~102@ (Mul d12~104@ c12~102@)) (Mul (Mul (Mul d12~104@
                                                           b12~100@
                                                          ) (Mul a12~98@ b12~100@)
                                                         ) (Sub d12~104@ (Mul (Mul c12~102@ a12~98@) (Mul c12~102@ c12~102@)))
                                                      )))
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2145@ temp_12_1~2194@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2145@ temp_12_1~2194@)
                                                        (=>
                                                         (= temp_13_0~2307@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Add 86 a13~106@)) (Mul (Mul
                                                              a13~106@ d13~112@
                                                             ) (Mul d13~112@ b13~108@)
                                                            )
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2396@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Add 86 a13~106@)) (Mul (Mul
                                                               a13~106@ d13~112@
                                                              ) (Mul d13~112@ b13~108@)
                                                             )
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2307@ temp_13_1~2396@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2307@ temp_13_1~2396@)
                                                            (=>
                                                             (= temp_14_0~2505@ (Mul (Mul (Mul (Mul a14~114@ 15) d14~120@) (Mul (Mul b14~116@ b14~116@)
                                                                 (Mul 49 b14~116@)
                                                                )
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2590@ (Mul (Mul (Mul (Mul 15 a14~114@) d14~120@) (Mul (Mul b14~116@ b14~116@)
                                                                  (Mul 49 b14~116@)
                                                                 )
                                                                ) (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Mul a14~114@ b14~116@)
                                                                  (Mul c14~118@ c14~118@)
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2505@ temp_14_1~2590@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2505@ temp_14_1~2590@)
                                                                (=>
                                                                 (= temp_15_0~2671@ (Sub (Add (Add (Mul a15~122@ b15~124@) (Mul b15~124@ a15~122@)) (
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2728@ (Sub (Add (Add (Mul a15~122@ b15~124@) (Mul b15~124@ a15~122@)) (
                                                                      Mul c15~126@ (Mul a15~122@ c15~126@)
                                                                     )
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2671@ temp_15_1~2728@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2671@ temp_15_1~2728@)
                                                                    (=>
                                                                     (= temp_16_0~2805@ (Mul (Mul b16~132@ (Add (Mul b16~132@ d16~136@) (Mul a16~130@ d16~136@)))
                                                                       (Mul (Mul (Mul a16~130@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Mul d16~136@ b16~132@)
                                                                         (Mul c16~134@ d16~136@)
                                                                     ))))
                                                                     (=>
                                                                      (= temp_16_1~2858@ (Mul (Mul (Mul (Mul a16~130@ c16~134@) (Mul c16~134@ d16~136@)) (
                                                                      ...
                                                                      (and
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         %%location_label%%16
                                                                         (= temp_16_0~2805@ temp_16_1~2858@)
                                                                       ))
                                                                       (=>
                                                                        (= temp_16_0~2805@ temp_16_1~2858@)
                                                                        (=>
                                                                         (= temp_17_0~2959@ (Mul (Sub (Mul (Mul a17~138@ 3) (Mul b17~140@ d17~144@)) (Mul (Mul
                                                                              c17~142@ b17~140@
                                                                             ) (Mul c17~142@ b17~140@)
                                                                            )
                                                                         ...
                                                                         (=>
                                                                          (= temp_17_1~3036@ (Mul (Sub (Mul (Mul a17~138@ 3) (Mul d17~144@ b17~140@)) (Mul (Mul
                                                                               c17~142@ b17~140@
                                                                              ) (Mul c17~142@ b17~140@)
                                                                             )
                                                                            ) (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ c17~142@)) (Add (Mul d17~144@ c17~142@)
                                                                          ...
                                                                          (and
                                                                           (=>
                                                                            ...
                                                                            (=>
                                                                             %%location_label%%17
                                                                             (= temp_17_0~2959@ temp_17_1~3036@)
                                                                           ))
                                                                           (=>
                                                                            (= temp_17_0~2959@ temp_17_1~3036@)
                                                                            (=>
                                                                             (= temp_18_0~3133@ (Mul (Mul (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ a18~146@)) (
                                                                             ...
                                                                             (=>
                                                                              (= temp_18_1~3214@ (Mul (Mul (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ a18~146@)) (
                                                                                  Mul b18~148@ (Add 47 c18~150@)
                                                                                 )
                                                                              ...
                                                                              (and
                                                                               (=>
                                                                                ...
                                                                                (=>
                                                                                 %%location_label%%18
                                                                                 (= temp_18_0~3133@ temp_18_1~3214@)
                                                                               ))
                                                                               (=>
                                                                                (= temp_18_0~3133@ temp_18_1~3214@)
                                                                                (=>
                                                                                 (= temp_19_0~3315@ (Mul (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ d19~160@)) (
                                                                                 ...
                                                                                 (=>
                                                                                  (= temp_19_1~3392@ (Mul (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ d19~160@)) (
                                                                                      Mul (Mul c19~158@ 24) (Add b19~156@ a19~154@)
                                                                                     )
                                                                                    ) (Mul (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ b19~156@)) (Mul (Add c19~158@ b19~156@)
                                                                                      (Mul a19~154@ d19~160@)
