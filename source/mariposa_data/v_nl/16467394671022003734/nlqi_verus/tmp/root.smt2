     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~293@ temp_0_1~346@)
        (=>
         (= temp_1_0~435@ (Sub (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Add b1~12@
              c1~14@
             ) (Mul a1~10@ a1~10@)
            )
         ...
         (=>
          (= temp_1_1~500@ (Sub (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul (Add
                b1~12@ c1~14@
               ) a1~10@
              ) a1~10@
             )
          ...
          (and
           ...
           (=>
            (= temp_1_0~435@ temp_1_1~500@)
            (=>
             (= temp_2_0~601@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ c2~22@)) (Add (Mul d2~24@
                  d2~24@
                 ) (Mul d2~24@ a2~18@)
                )
             ...
             (=>
              (= temp_2_1~678@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Add b2~20@ c2~22@)) (Add (Mul d2~24@
                   d2~24@
                  ) (Mul d2~24@ a2~18@)
                 )
                ) (Mul (Mul (Sub d2~24@ 9) (Mul b2~20@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@
              ...
              (and
               ...
               (=>
                (= temp_2_0~601@ temp_2_1~678@)
                (=>
                 (= temp_3_0~779@ (Add (Mul (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ a3~26@)) (Mul (Mul 18
                      d3~32@
                     ) (Mul a3~26@ d3~32@)
                    )
                 ...
                 (=>
                  (= temp_3_1~856@ (Add (Mul (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ a3~26@)) (Mul (Mul 18
                       d3~32@
                      ) (Mul a3~26@ d3~32@)
                     )
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~779@ temp_3_1~856@)
                    (=>
                     (= temp_4_0~953@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@
                          a4~34@
                         ) (Mul c4~38@ d4~40@)
                        )
                     ...
                     (=>
                      (= temp_4_1~1026@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@
                           a4~34@
                          ) (Mul c4~38@ d4~40@)
                         )
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~953@ temp_4_1~1026@)
                       ))
                       (=>
                        (= temp_4_0~953@ temp_4_1~1026@)
                        (=>
                         (= temp_5_0~1103@ (Mul (Mul (Sub (Mul a5~42@ a5~42@) (Mul c5~46@ b5~44@)) d5~48@) (
                            Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Sub b5~44@ b5~44@) (Mul b5~44@
                              b5~44@
                         )))))
                         (=>
                          (= temp_5_1~1156@ (Mul (Mul d5~48@ (Sub (Mul a5~42@ a5~42@) (Mul c5~46@ b5~44@))) (
                             Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Sub b5~44@ b5~44@) (Mul b5~44@
                               b5~44@
                          )))))
                          (=>
