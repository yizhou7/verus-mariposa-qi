...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul d0~8@ (Sub (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Add (Mul d0~8@ b0~4@) (Add b0~4@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~346@ (Mul (Mul d0~8@ (Sub (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Mul (Add (Mul d0~8@ b0~4@) (Add b0~4@ d0~8@)) (Mul d0~8@ a0~2@)) (Mul a0~2@ b0~4@)))) (=> (= tmp%1@ (= temp_0_0~293@ temp_0_1~346@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~426@ (Sub (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Add b1~12@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul a1~10@ b1~12@) (Sub a1~10@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~491@ (Sub (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul (Add b1~12@ c1~14@) a1~10@) a1~10@)) (Mul (Mul (Mul a1~10@ b1~12@) (Sub a1~10@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~426@ temp_1_1~491@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~583@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ c2~22@)) (Add (Mul d2~24@ d2~24@) (Mul d2~24@ a2~18@))) (Mul (Mul (Sub d2~24@ 9) (Mul b2~20@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~660@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Add b2~20@ c2~22@)) (Add (Mul d2~24@ d2~24@) (Mul d2~24@ a2~18@))) (Mul (Mul (Sub d2~24@ 9) (Mul b2~20@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~583@ temp_2_1~660@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~752@ (Add (Mul (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ a3~26@)) (Mul (Mul 18 d3~32@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Add b3~28@ a3~26@))))) (=> (= temp_3_1~829@ (Add (Mul (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ a3~26@)) (Mul (Mul 18 d3~32@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul (Mul d3~32@ a3~26@) a3~26@) b3~28@) (Mul (Mul d3~32@ c3~30@) (Add b3~28@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~752@ temp_3_1~829@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~917@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ d4~40@))) (Mul (Mul 58 (Add c4~38@ d4~40@)) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@))))) (=> (= temp_4_1~990@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ d4~40@))) (Mul (Mul (Mul 58 (Add c4~38@ d4~40@)) (Mul d4~40@ c4~38@)) (Mul a4~34@ a4~34@)))) (=> (= tmp%5@ (= temp_4_0~917@ temp_4_1~990@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1058@ (Mul (Mul (Sub (Mul a5~42@ a5~42@) (Mul c5~46@ b5~44@)) d5~48@) (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1111@ (Mul (Mul d5~48@ (Sub (Mul a5~42@ a5~42@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1058@ temp_5_1~1111@)) (=> %%location_label%%5 tmp%6@))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
