...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Sub (Mul a0~2@ c0~6@) (Sub b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Add c0~6@ c0~6@))))) (=> (= temp_0_1~378@ (Mul (Mul (Sub (Mul a0~2@ c0~6@) (Sub b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@)) (Add (Mul (Mul b0~4@ d0~8@) c0~6@) (Mul (Mul b0~4@ d0~8@) c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~378@))) (=> (= temp_0_0~305@ temp_0_1~378@) (=> (= temp_1_0~463@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ c1~14@))) (Mul (Mul (Sub a1~10@ d1~16@) (Mul c1~14@ d1~16@)) (Sub d1~16@ (Add d1~16@ a1~10@))))) (=> (= temp_1_1~524@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ c1~14@))) (Mul (Mul (Sub a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Sub d1~16@ (Add d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~463@ temp_1_1~524@))) (=> (= temp_1_0~463@ temp_1_1~524@) (=> (= temp_2_0~625@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ a2~18@)) (Add (Mul 88 a2~18@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~702@ (Mul (Mul (Add (Mul 88 a2~18@) (Mul b2~20@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ a2~18@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~625@ temp_2_1~702@))) (=> (= temp_2_0~625@ temp_2_1~702@) (=> (= temp_3_0~791@ (Mul (Mul (Add (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ a3~26@))) (Mul (Add (Add c3~30@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~856@ (Mul (Mul (Add (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ a3~26@))) (Mul (Add (Add c3~30@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~791@ temp_3_1~856@))) (=> (= temp_3_0~791@ temp_3_1~856@) (=> (= temp_4_0~941@ (Mul (Mul (Mul (Add c4~38@ d4~40@) c4~38@) (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~1002@ (Mul (Mul (Add c4~38@ d4~40@) c4~38@) (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ c4~38@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~941@ temp_4_1~1002@))) (=> (= temp_4_0~941@ temp_4_1~1002@) (=> (= temp_5_0~1087@ (Mul (Add (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul c5~46@ d5~48@) b5~44@)) (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ a5~42@)) (Sub (Sub a5~42@ d5~48@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1148@ (Mul (Add (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul c5~46@ d5~48@) b5~44@)) (Mul (Mul (Mul (Mul c5~46@ c5~46@) d5~48@) a5~42@) (Sub (Sub a5~42@ d5~48@) (Mul c5~46@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1087@ temp_5_1~1148@))) (=> (= temp_5_0~1087@ temp_5_1~1148@) (=> (= temp_6_0~1233@ (Add (Mul (Sub (Add d6~56@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul d6~56@ a6~50@) c6~54@)) (Mul (Mul (Sub c6~54@ a6~50@) (Mul a6~50@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Add d6~56@ c6~54@))))) (=> (= temp_6_1~1294@ (Add (Mul (Sub (Add d6~56@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul d6~56@ a6~50@) c6~54@)) (Mul (Mul (Mul (Sub c6~54@ a6~50@) a6~50@) a6~50@) (Mul (Mul d6~56@ b6~52@) (Add d6~56@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1233@ temp_6_1~1294@))) (=> (= temp_6_0~1233@ temp_6_1~1294@) (=> (= temp_7_0~1395@ (Mul (Mul (Mul (Mul d7~64@ 21) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ a7~58@))) (Add (Mul (Mul d7~64@ c7~62@) (Sub c7~62@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Add a7~58@ a7~58@))))) (=> (= temp_7_1~1472@ (Mul (Mul (Mul (Mul d7~64@ 21) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ a7~58@))) (Add (Mul (Mul c7~62@ d7~64@) (Sub c7~62@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Add a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1395@ temp_7_1~1472@))) (=> (= temp_7_0~1395@ temp_7_1~1472@) (=> (= temp_8_0~1561@ (Mul (Mul (Sub (Mul c8~70@ d8~72@) (Sub c8~70@ d8~72@)) (Add (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@))) (Sub (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ b8~68@) (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1626@ (Mul (Mul (Sub (Mul c8~70@ d8~72@) (Sub c8~70@ d8~72@)) (Add (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@))) (Sub (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ b8~68@) (Mul b8~68@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1561@ temp_8_1~1626@))) (=> (= temp_8_0~1561@ temp_8_1~1626@) (=> (= temp_9_0~1687@ (Mul b9~76@ (Mul (Sub (Mul c9~78@ d9~80@) (Sub b9~76@ a9~74@)) (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~1724@ (Mul b9~76@ (Mul (Sub (Mul c9~78@ d9~80@) (Sub b9~76@ a9~74@)) (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1687@ temp_9_1~1724@))) (=> (= temp_9_0~1687@ temp_9_1~1724@) (=> (= temp_10_0~1813@ (Mul (Mul (Mul (Mul d10~88@ b10~84@) (Mul a10~82@ c10~86@)) (Add (Mul b10~84@ a10~82@) (Mul b10~84@ a10~82@))) (Mul (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ b10~84@)) (Mul (Sub a10~82@ b10~84@) (Add a10~82@ b10~84@))))) (=> (= temp_10_1~1878@ (Mul (Mul (Mul d10~88@ b10~84@) (Mul a10~82@ c10~86@)) (Mul (Add (Mul b10~84@ a10~82@) (Mul b10~84@ a10~82@)) (Mul (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ b10~84@)) (Mul (Sub a10~82@ b10~84@) (Add a10~82@ b10~84@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1813@ temp_10_1~1878@))) (=> (= temp_10_0~1813@ temp_10_1~1878@) (=> (= temp_11_0~1979@ (Mul (Mul (Add (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ 32) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~2056@ (Mul (Mul (Add (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ 32) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)) (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1979@ temp_11_1~2056@))) (=> (= temp_11_0~1979@ temp_11_1~2056@) (=> (= temp_12_0~2145@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul c12~102@ c12~102@) (Mul b12~100@ a12~98@))) (Mul (Add (Mul a12~98@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ c12~102@))))) (=> (= temp_12_1~2210@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul c12~102@ c12~102@) (Mul b12~100@ a12~98@))) (Mul (Add (Mul a12~98@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2145@ temp_12_1~2210@))) (=> (= temp_12_0~2145@ temp_12_1~2210@) (=> (= temp_13_0~2299@ (Mul (Add c13~110@ (Mul (Mul d13~112@ b13~108@) (Sub c13~110@ d13~112@))) (Sub (Sub (Mul a13~106@ 56) (Add b13~108@ d13~112@)) (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ b13~108@))))) (=> (= temp_13_1~2364@ (Mul (Add c13~110@ (Mul (Mul b13~108@ d13~112@) (Sub c13~110@ d13~112@))) (Sub (Sub (Mul a13~106@ 56) (Add b13~108@ d13~112@)) (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2299@ temp_13_1~2364@))) (=> (= temp_13_0~2299@ temp_13_1~2364@) (=> (= temp_14_0~2453@ (Mul (Add (Mul (Mul c14~118@ c14~118@) (Sub c14~118@ d14~120@)) (Mul (Mul b14~116@ c14~118@) (Mul c14~118@ c14~118@))) (Add (Mul (Mul b14~116@ b14~116@) (Mul b14~116@ d14~120@)) (Mul (Mul a14~114@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2518@ (Mul (Add (Mul (Mul c14~118@ c14~118@) (Sub c14~118@ d14~120@)) (Mul (Mul b14~116@ c14~118@) (Mul c14~118@ c14~118@))) (Add (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Mul b14~116@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2453@ temp_14_1~2518@))) (=> (= temp_14_0~2453@ temp_14_1~2518@) (=> (= temp_15_0~2595@ (Mul (Sub (Mul (Sub b15~124@ b15~124@) (Mul d15~128@ b15~124@)) d15~128@) (Mul (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ c15~126@)) (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2648@ (Mul (Sub (Mul (Mul (Sub b15~124@ b15~124@) d15~128@) b15~124@) d15~128@) (Mul (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ c15~126@)) (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2595@ temp_15_1~2648@))) (=> (= temp_15_0~2595@ temp_15_1~2648@) (=> (= temp_16_0~2737@ (Sub (Mul (Mul (Mul a16~130@ b16~132@) (Mul d16~136@ d16~136@)) (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ c16~134@))) (Mul (Mul (Mul b16~132@ c16~134@) (Mul d16~136@ b16~132@)) (Mul (Mul d16~136@ c16~134@) (Add d16~136@ c16~134@))))) (=> (= temp_16_1~2802@ (Sub (Mul (Mul (Mul a16~130@ b16~132@) (Mul d16~136@ d16~136@)) (Mul (Mul (Mul a16~130@ c16~134@) a16~130@) c16~134@)) (Mul (Mul (Mul b16~132@ c16~134@) (Mul d16~136@ b16~132@)) (Mul (Mul d16~136@ c16~134@) (Add d16~136@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2737@ temp_16_1~2802@))) (=> (= temp_16_0~2737@ temp_16_1~2802@) (=> (= temp_17_0~2879@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ a17~138@)) b17~140@) (Mul (Mul (Mul a17~138@ b17~140@) (Add a17~138@ d17~144@)) (Mul (Add a17~138@ d17~144@) (Mul b17~140@ a17~138@))))) (=> (= temp_17_1~2932@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ a17~138@)) b17~140@) (Mul (Mul (Add a17~138@ d17~144@) (Mul a17~138@ b17~140@)) (Mul (Add a17~138@ d17~144@) (Mul b17~140@ a17~138@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2879@ temp_17_1~2932@))) (=> (= temp_17_0~2879@ temp_17_1~2932@) (=> (= temp_18_0~3029@ (Sub (Mul (Mul (Mul b18~148@ 80) (Mul d18~152@ a18~146@)) (Mul (Mul b18~148@ a18~146@) b18~148@)) (Mul (Sub (Sub c18~150@ c18~150@) (Sub d18~152@ d18~152@)) (Add (Mul d18~152@ c18~150@) (Mul b18~148@ a18~146@))))) (=> (= temp_18_1~3102@ (Sub (Mul (Mul (Mul b18~148@ 80) (Mul d18~152@ a18~146@)) (Mul b18~148@ (Mul a18~146@ b18~148@))) (Mul (Sub (Sub c18~150@ c18~150@) (Sub d18~152@ d18~152@)) (Add (Mul d18~152@ c18~150@) (Mul b18~148@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3029@ temp_18_1~3102@))) (=> (= temp_18_0~3029@ temp_18_1~3102@) (=> (= temp_19_0~3187@ (Mul (Sub (Sub (Mul a19~154@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Mul a19~154@ d19~160@) (Mul c19~158@ b19~156@))) (Sub (Add (Mul b19~156@ c19~158@) a19~154@) (Mul (Mul a19~154@ c19~158@) (Sub d19~160@ c19~158@))))) (=> (= temp_19_1~3248@ (Mul (Sub (Sub (Mul a19~154@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Mul a19~154@ d19~160@) (Mul c19~158@ b19~156@))) (Sub (Add (Mul b19~156@ c19~158@) a19~154@) (Mul (Mul c19~158@ a19~154@) (Sub d19~160@ c19~158@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3187@ temp_19_1~3248@))) (=> (= temp_19_0~3187@ temp_19_1~3248@) (=> (= temp_20_0~3341@ (Mul (Mul (Mul (Sub c20~166@ d20~168@) (Mul b20~164@ 99)) (Mul (Mul c20~166@ d20~168@) c20~166@)) (Mul (Add (Sub d20~168@ c20~166@) (Mul d20~168@ d20~168@)) (Add (Mul c20~166@ d20~168@) d20~168@)))) (=> (= temp_20_1~3410@ (Mul (Mul (Mul (Mul b20~164@ 99) (Sub c20~166@ d20~168@)) (Mul (Mul c20~166@ d20~168@) c20~166@)) (Mul (Add (Sub d20~168@ c20~166@) (Mul d20~168@ d20~168@)) (Add (Mul c20~166@ d20~168@) d20~168@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3341@ temp_20_1~3410@))) (=> (= temp_20_0~3341@ temp_20_1~3410@) (=> (= temp_21_0~3495@ (Sub (Mul (Mul (Mul c21~174@ c21~174@) (Mul c21~174@ d21~176@)) (Mul b21~172@ (Mul b21~172@ b21~172@))) (Mul (Mul (Add a21~170@ d21~176@) (Add b21~172@ d21~176@)) (Mul (Mul a21~170@ c21~174@) (Mul b21~172@ d21~176@))))) (=> (= temp_21_1~3556@ (Sub (Mul (Mul (Mul c21~174@ c21~174@) (Mul c21~174@ d21~176@)) (Mul b21~172@ (Mul b21~172@ b21~172@))) (Mul (Mul (Add b21~172@ d21~176@) (Add a21~170@ d21~176@)) (Mul (Mul a21~170@ c21~174@) (Mul b21~172@ d21~176@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3495@ temp_21_1~3556@))) (=> (= temp_21_0~3495@ temp_21_1~3556@) (=> (= temp_22_0~3641@ (Mul (Mul (Mul (Mul c22~182@ d22~184@) (Add c22~182@ d22~184@)) (Mul (Mul b22~180@ d22~184@) (Mul a22~178@ d22~184@))) (Mul (Mul b22~180@ (Mul d22~184@ d22~184@)) (Mul (Mul d22~184@ b22~180@) (Mul b22~180@ c22~182@))))) (=> (= temp_22_1~3702@ (Mul (Mul (Mul (Mul c22~182@ d22~184@) (Add c22~182@ d22~184@)) (Mul (Mul a22~178@ d22~184@) (Mul b22~180@ d22~184@))) (Mul (Mul b22~180@ (Mul d22~184@ d22~184@)) (Mul (Mul d22~184@ b22~180@) (Mul b22~180@ c22~182@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3641@ temp_22_1~3702@))) (=> (= temp_22_0~3641@ temp_22_1~3702@) (=> (= temp_23_0~3767@ (Mul (Mul c23~190@ (Add (Add d23~192@ b23~188@) (Mul d23~192@ b23~188@))) (Mul (Mul (Mul b23~188@ c23~190@) (Mul a23~186@ b23~188@)) d23~192@))) (=> (= temp_23_1~3812@ (Mul (Add (Mul c23~190@ (Add d23~192@ b23~188@)) (Mul c23~190@ (Mul d23~192@ b23~188@))) (Mul (Mul (Mul b23~188@ c23~190@) (Mul a23~186@ b23~188@)) d23~192@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3767@ temp_23_1~3812@))) (=> (= temp_23_0~3767@ temp_23_1~3812@) (=> (= temp_24_0~3901@ (Mul (Add (Add (Mul b24~196@ c24~198@) (Sub c24~198@ c24~198@)) (Add (Mul b24~196@ a24~194@) (Sub c24~198@ d24~200@))) (Mul (Mul (Mul d24~200@ d24~200@) (Mul c24~198@ d24~200@)) (Mul (Mul a24~194@ d24~200@) (Mul a24~194@ b24~196@))))) (=> (= temp_24_1~3966@ (Mul (Add (Add (Mul b24~196@ c24~198@) (Sub c24~198@ c24~198@)) (Add (Mul b24~196@ a24~194@) (Sub c24~198@ d24~200@))) (Mul (Mul (Mul d24~200@ d24~200@) (Mul c24~198@ d24~200@)) (Mul a24~194@ (Mul d24~200@ (Mul a24~194@ b24~196@)))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3901@ temp_24_1~3966@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
