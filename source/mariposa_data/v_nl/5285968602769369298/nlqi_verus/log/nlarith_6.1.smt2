...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) b0~4@) (Mul (Mul b0~4@ a0~2@) c0~6@)) (Mul (Mul (Add c0~6@ a0~2@) (Mul c0~6@ c0~6@)) (Add (Mul a0~2@ b0~4@) (Mul a0~2@ a0~2@))))) (=> (= temp_0_1~354@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) c0~6@) (Mul (Mul b0~4@ d0~8@) b0~4@)) (Mul (Mul (Add c0~6@ a0~2@) (Mul c0~6@ c0~6@)) (Add (Mul a0~2@ b0~4@) (Mul a0~2@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~297@ temp_0_1~354@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~434@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul c1~14@ d1~16@) (Add b1~12@ d1~16@)) (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~499@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Add b1~12@ d1~16@) (Mul c1~14@ d1~16@)) (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~434@ temp_1_1~499@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~567@ (Mul (Mul (Mul (Mul b2~20@ b2~20@) (Add a2~18@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Sub d2~24@ c2~22@))) (Mul (Mul (Sub a2~18@ d2~24@) (Mul a2~18@ d2~24@)) d2~24@))) (=> (= temp_2_1~620@ (Mul (Mul (Mul (Mul b2~20@ b2~20@) (Add a2~18@ c2~22@)) (Mul (Sub d2~24@ c2~22@) (Mul c2~22@ b2~20@))) (Mul (Mul (Sub a2~18@ d2~24@) (Mul a2~18@ d2~24@)) d2~24@))) (=> (= tmp%3@ (= temp_2_0~567@ temp_2_1~620@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~700@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ b3~28@)) (Add (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul d3~32@ b3~28@) (Add d3~32@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~765@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ b3~28@)) (Add (Mul c3~30@ a3~26@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul d3~32@ b3~28@) (Add d3~32@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~700@ temp_3_1~765@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~857@ (Add (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)) (Sub (Mul b4~36@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul a4~34@ 29) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~934@ (Add (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)) (Sub (Mul b4~36@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ d4~40@)) (Mul a4~34@ 29)) (Mul a4~34@ b4~36@)))) (=> (= tmp%5@ (= temp_4_0~857@ temp_4_1~934@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1010@ (Add (Mul (Mul (Mul b5~44@ a5~42@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ d5~48@))) (Mul (Mul b5~44@ (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1071@ (Add (Mul (Mul (Mul b5~44@ a5~42@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul b5~44@ d5~48@) d5~48@) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~1010@ temp_5_1~1071@)) (=> %%location_label%%5 tmp%6@))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
