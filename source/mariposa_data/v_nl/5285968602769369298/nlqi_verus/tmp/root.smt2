      ...
      (=>
       ...
       (and
        ...
        (=>
         tmp%1@
         (=>
          (= temp_1_0~434@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@
               b1~12@
              ) (Mul c1~14@ a1~10@)
             )
          ...
          (=>
           (= temp_1_1~499@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@
                b1~12@
               ) (Mul c1~14@ a1~10@)
              )
           ...
           (=>
            ...
            (and
             ...
             (=>
              tmp%2@
              (=>
               (= temp_2_0~567@ (Mul (Mul (Mul (Mul b2~20@ b2~20@) (Add a2~18@ c2~22@)) (Mul (Mul c2~22@
                    b2~20@
                   ) (Sub d2~24@ c2~22@)
                  )
               ...
               (=>
                (= temp_2_1~620@ (Mul (Mul (Mul (Mul b2~20@ b2~20@) (Add a2~18@ c2~22@)) (Mul (Sub d2~24@
                     c2~22@
                    ) (Mul c2~22@ b2~20@)
                   )
                  ) (Mul (Mul (Sub a2~18@ d2~24@) (Mul a2~18@ d2~24@)) d2~24@)
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   tmp%3@
                   (=>
                    (= temp_3_0~700@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ b3~28@)) (Add (Mul a3~26@
                         c3~30@
                        ) (Mul b3~28@ a3~26@)
                       )
                    ...
                    (=>
                     (= temp_3_1~765@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ b3~28@)) (Add (Mul c3~30@
                          a3~26@
                         ) (Mul b3~28@ a3~26@)
                        )
                       ) (Mul (Mul (Mul d3~32@ b3~28@) (Add d3~32@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul d3~32@
                     ...
                     (=>
                      (= tmp%4@ (= temp_3_0~700@ temp_3_1~765@))
                      (and
                       (=>
                        %%location_label%%3
                        tmp%4@
                       ...
                       (=>
                        tmp%4@
                        (=>
                         (= temp_4_0~857@ (Add (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)) (Sub (Mul b4~36@
                              b4~36@
                             ) (Mul b4~36@ c4~38@)
                            )
                         ...
                         (=>
                          (= temp_4_1~934@ (Add (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)) (Sub (Mul b4~36@
                               b4~36@
                              ) (Mul b4~36@ c4~38@)
                             )
                          ...
                          (=>
                           ...
                           (and
                            ...
                            (=>
                             tmp%5@
                             (=>
                              (= temp_5_0~1010@ (Add (Mul (Mul (Mul b5~44@ a5~42@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@
                                   d5~48@
                                  ) (Mul a5~42@ d5~48@)
                                 )
                              ...
                              (=>
                               (= temp_5_1~1071@ (Add (Mul (Mul (Mul b5~44@ a5~42@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@
                                    d5~48@
                                   ) (Mul a5~42@ d5~48@)
                                  )
