...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ d0~8@))) (Mul (Mul (Add c0~6@ b0~4@) (Sub d0~8@ d0~8@)) (Add (Mul d0~8@ b0~4@) d0~8@)))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ d0~8@))) (Mul (Add (Mul d0~8@ b0~4@) d0~8@) (Mul (Add c0~6@ b0~4@) (Sub d0~8@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~454@ (Mul (Mul (Mul (Add a1~10@ a1~10@) (Mul 78 d1~16@)) (Mul (Sub d1~16@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Add (Add a1~10@ d1~16@) (Sub d1~16@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Add b1~12@ c1~14@))))) (=> (= temp_1_1~551@ (Mul (Mul (Add (Mul a1~10@ (Mul 78 d1~16@)) (Mul a1~10@ (Mul 78 d1~16@))) (Mul (Sub d1~16@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Add (Add a1~10@ d1~16@) (Sub d1~16@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Add b1~12@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~454@ temp_1_1~551@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~627@ (Sub (Sub (Mul (Sub c2~22@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ c2~22@))) (Sub (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ c2~22@)) (Add (Add a2~18@ b2~20@) c2~22@)))) (=> (= temp_2_1~688@ (Sub (Sub (Mul (Sub c2~22@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@))) (Sub (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ c2~22@)) (Add (Add a2~18@ b2~20@) c2~22@)))) (=> (= tmp%3@ (= temp_2_0~627@ temp_2_1~688@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~748@ (Mul (Sub (Mul (Mul a3~26@ c3~30@) (Add a3~26@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Mul d3~32@ b3~28@))) (Mul d3~32@ (Mul c3~30@ b3~28@)))) (=> (= temp_3_1~793@ (Mul (Sub (Mul (Mul a3~26@ c3~30@) (Add a3~26@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Mul d3~32@ b3~28@))) (Mul (Mul d3~32@ c3~30@) b3~28@))) (=> (= tmp%4@ (= temp_3_0~748@ temp_3_1~793@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~861@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Add b4~36@ a4~34@)) (Mul (Sub d4~40@ a4~34@) (Mul c4~38@ c4~38@))) (Mul b4~36@ (Add (Sub d4~40@ c4~38@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~914@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Add b4~36@ a4~34@)) (Mul (Mul (Sub d4~40@ a4~34@) c4~38@) c4~38@)) (Mul b4~36@ (Add (Sub d4~40@ c4~38@) (Mul b4~36@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~861@ temp_4_1~914@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1002@ (Add (Mul (Add (Add 85 b5~44@) (Add c5~46@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Mul (Sub b5~44@ b5~44@) c5~46@) (Mul (Mul a5~42@ c5~46@) (Add a5~42@ d5~48@))))) (=> (= temp_5_1~1075@ (Add (Mul (Add (Add 85 b5~44@) (Add c5~46@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Sub b5~44@ b5~44@) c5~46@) (Mul (Mul a5~42@ c5~46@) (Add a5~42@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1002@ temp_5_1~1075@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1163@ (Mul (Mul (Mul (Sub d6~56@ d6~56@) (Mul d6~56@ 8)) (Mul a6~50@ (Add b6~52@ c6~54@))) (Mul (Add (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Sub a6~50@ d6~56@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1236@ (Mul (Mul (Mul (Sub d6~56@ d6~56@) (Mul d6~56@ 8)) (Mul a6~50@ (Add b6~52@ c6~54@))) (Mul (Mul (Sub a6~50@ d6~56@) (Mul d6~56@ d6~56@)) (Add (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~1163@ temp_6_1~1236@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1316@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1381@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1316@ temp_7_1~1381@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1445@ (Mul (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ d8~72@)) b8~68@) (Mul (Mul (Mul a8~66@ b8~68@) (Add b8~68@ b8~68@)) (Mul a8~66@ (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1494@ (Mul (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ d8~72@)) b8~68@) (Mul (Mul a8~66@ (Mul a8~66@ c8~70@)) (Mul (Mul a8~66@ b8~68@) (Add b8~68@ b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1445@ temp_8_1~1494@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1570@ (Mul (Mul (Mul b9~76@ (Mul d9~80@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ c9~78@))) (Add (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ d9~80@))))) (=> (= temp_9_1~1631@ (Mul (Mul (Mul b9~76@ (Mul d9~80@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ c9~78@))) (Add (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1570@ temp_9_1~1631@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1707@ (Add (Mul (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ b10~84@)) (Mul c10~86@ (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~1768@ (Add (Mul (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ b10~84@)) c10~86@) (Mul a10~82@ c10~86@)))) (=> (= tmp%11@ (= temp_10_0~1707@ temp_10_1~1768@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1848@ (Mul (Mul (Sub (Mul a11~90@ 12) (Sub b11~92@ d11~96@)) (Sub (Mul d11~96@ c11~94@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) d11~96@))) (=> (= temp_11_1~1913@ (Mul (Mul (Sub (Mul 12 a11~90@) (Sub b11~92@ d11~96@)) (Sub (Mul d11~96@ c11~94@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) d11~96@))) (=> (= tmp%12@ (= temp_11_0~1848@ temp_11_1~1913@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1977@ (Sub (Mul (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ d12~104@))) (Mul (Mul (Mul c12~102@ a12~98@) a12~98@) b12~100@))) (=> (= temp_12_1~2026@ (Sub (Mul (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ d12~104@))) (Mul (Mul (Mul a12~98@ c12~102@) a12~98@) b12~100@))) (=> (= tmp%13@ (= temp_12_0~1977@ temp_12_1~2026@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2118@ (Add (Sub 69 (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul 3 b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ c13~110@))))) (=> (= temp_13_1~2195@ (Add (Sub 69 (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul 3 b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2118@ temp_13_1~2195@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2259@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ b14~116@))) (Mul (Mul (Mul b14~116@ d14~120@) a14~114@) c14~118@))) (=> (= temp_14_1~2308@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (Mul (Mul b14~116@ b14~116@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) a14~114@) c14~118@))) (=> (= tmp%15@ (= temp_14_0~2259@ temp_14_1~2308@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2384@ (Mul (Mul (Mul (Mul b15~124@ c15~126@) (Sub b15~124@ c15~126@)) (Mul d15~128@ (Mul c15~126@ d15~128@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2445@ (Mul (Mul (Mul d15~128@ (Mul c15~126@ d15~128@)) (Mul (Mul b15~124@ c15~126@) (Sub b15~124@ c15~126@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul d15~128@ d15~128@))))) (=> (= tmp%16@ (= temp_15_0~2384@ temp_15_1~2445@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2525@ (Mul (Mul (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul b16~132@ c16~134@))) (Mul (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@))))) (=> (= temp_16_1~2590@ (Mul (Mul (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@))) (Mul (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@))))) (=> (= tmp%17@ (= temp_16_0~2525@ temp_16_1~2590@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2658@ (Mul (Sub (Mul (Mul c17~142@ c17~142@) (Add d17~144@ b17~140@)) (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul b17~140@ a17~138@) (Sub b17~140@ c17~142@)) b17~140@))) (=> (= temp_17_1~2711@ (Mul (Sub (Mul (Mul c17~142@ c17~142@) (Add d17~144@ b17~140@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul b17~140@ a17~138@) (Sub b17~140@ c17~142@)) b17~140@))) (=> (= tmp%18@ (= temp_17_0~2658@ temp_17_1~2711@)) (=> %%location_label%%17 tmp%18@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
