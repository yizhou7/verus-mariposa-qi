...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ d0~8@))) (Mul (Mul (Add c0~6@ b0~4@) (Sub d0~8@ d0~8@)) (Add (Mul d0~8@ b0~4@) d0~8@)))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ d0~8@))) (Mul (Add (Mul d0~8@ b0~4@) d0~8@) (Mul (Add c0~6@ b0~4@) (Sub d0~8@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~463@ (Mul (Mul (Mul (Add a1~10@ a1~10@) (Mul 78 d1~16@)) (Mul (Sub d1~16@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Add (Add a1~10@ d1~16@) (Sub d1~16@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Add b1~12@ c1~14@))))) (=> (= temp_1_1~560@ (Mul (Mul (Add (Mul a1~10@ (Mul 78 d1~16@)) (Mul a1~10@ (Mul 78 d1~16@))) (Mul (Sub d1~16@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Add (Add a1~10@ d1~16@) (Sub d1~16@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Add b1~12@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~463@ temp_1_1~560@))) (=> (= temp_1_0~463@ temp_1_1~560@) (=> (= temp_2_0~645@ (Sub (Sub (Mul (Sub c2~22@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ c2~22@))) (Sub (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ c2~22@)) (Add (Add a2~18@ b2~20@) c2~22@)))) (=> (= temp_2_1~706@ (Sub (Sub (Mul (Sub c2~22@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@))) (Sub (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ c2~22@)) (Add (Add a2~18@ b2~20@) c2~22@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~645@ temp_2_1~706@))) (=> (= temp_2_0~645@ temp_2_1~706@) (=> (= temp_3_0~775@ (Mul (Sub (Mul (Mul a3~26@ c3~30@) (Add a3~26@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Mul d3~32@ b3~28@))) (Mul d3~32@ (Mul c3~30@ b3~28@)))) (=> (= temp_3_1~820@ (Mul (Sub (Mul (Mul a3~26@ c3~30@) (Add a3~26@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Mul d3~32@ b3~28@))) (Mul (Mul d3~32@ c3~30@) b3~28@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~775@ temp_3_1~820@))) (=> (= temp_3_0~775@ temp_3_1~820@) (=> (= temp_4_0~897@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Add b4~36@ a4~34@)) (Mul (Sub d4~40@ a4~34@) (Mul c4~38@ c4~38@))) (Mul b4~36@ (Add (Sub d4~40@ c4~38@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~950@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Add b4~36@ a4~34@)) (Mul (Mul (Sub d4~40@ a4~34@) c4~38@) c4~38@)) (Mul b4~36@ (Add (Sub d4~40@ c4~38@) (Mul b4~36@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~897@ temp_4_1~950@))) (=> (= temp_4_0~897@ temp_4_1~950@) (=> (= temp_5_0~1047@ (Add (Mul (Add (Add 85 b5~44@) (Add c5~46@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Mul (Sub b5~44@ b5~44@) c5~46@) (Mul (Mul a5~42@ c5~46@) (Add a5~42@ d5~48@))))) (=> (= temp_5_1~1120@ (Add (Mul (Add (Add 85 b5~44@) (Add c5~46@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Sub b5~44@ b5~44@) c5~46@) (Mul (Mul a5~42@ c5~46@) (Add a5~42@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1047@ temp_5_1~1120@))) (=> (= temp_5_0~1047@ temp_5_1~1120@) (=> (= temp_6_0~1217@ (Mul (Mul (Mul (Sub d6~56@ d6~56@) (Mul d6~56@ 8)) (Mul a6~50@ (Add b6~52@ c6~54@))) (Mul (Add (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Sub a6~50@ d6~56@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1290@ (Mul (Mul (Mul (Sub d6~56@ d6~56@) (Mul d6~56@ 8)) (Mul a6~50@ (Add b6~52@ c6~54@))) (Mul (Mul (Sub a6~50@ d6~56@) (Mul d6~56@ d6~56@)) (Add (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1217@ temp_6_1~1290@))) (=> (= temp_6_0~1217@ temp_6_1~1290@) (=> (= temp_7_0~1379@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1444@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1379@ temp_7_1~1444@))) (=> (= temp_7_0~1379@ temp_7_1~1444@) (=> (= temp_8_0~1517@ (Mul (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ d8~72@)) b8~68@) (Mul (Mul (Mul a8~66@ b8~68@) (Add b8~68@ b8~68@)) (Mul a8~66@ (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1566@ (Mul (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ d8~72@)) b8~68@) (Mul (Mul a8~66@ (Mul a8~66@ c8~70@)) (Mul (Mul a8~66@ b8~68@) (Add b8~68@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1517@ temp_8_1~1566@))) (=> (= temp_8_0~1517@ temp_8_1~1566@) (=> (= temp_9_0~1651@ (Mul (Mul (Mul b9~76@ (Mul d9~80@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ c9~78@))) (Add (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ d9~80@))))) (=> (= temp_9_1~1712@ (Mul (Mul (Mul b9~76@ (Mul d9~80@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ c9~78@))) (Add (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1651@ temp_9_1~1712@))) (=> (= temp_9_0~1651@ temp_9_1~1712@) (=> (= temp_10_0~1797@ (Add (Mul (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ b10~84@)) (Mul c10~86@ (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~1858@ (Add (Mul (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ b10~84@)) c10~86@) (Mul a10~82@ c10~86@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1797@ temp_10_1~1858@))) (=> (= temp_10_0~1797@ temp_10_1~1858@) (=> (= temp_11_0~1947@ (Mul (Mul (Sub (Mul a11~90@ 12) (Sub b11~92@ d11~96@)) (Sub (Mul d11~96@ c11~94@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) d11~96@))) (=> (= temp_11_1~2012@ (Mul (Mul (Sub (Mul 12 a11~90@) (Sub b11~92@ d11~96@)) (Sub (Mul d11~96@ c11~94@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@)) d11~96@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1947@ temp_11_1~2012@))) (=> (= temp_11_0~1947@ temp_11_1~2012@) (=> (= temp_12_0~2085@ (Sub (Mul (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ d12~104@))) (Mul (Mul (Mul c12~102@ a12~98@) a12~98@) b12~100@))) (=> (= temp_12_1~2134@ (Sub (Mul (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ d12~104@))) (Mul (Mul (Mul a12~98@ c12~102@) a12~98@) b12~100@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2085@ temp_12_1~2134@))) (=> (= temp_12_0~2085@ temp_12_1~2134@) (=> (= temp_13_0~2235@ (Add (Sub 69 (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul 3 b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ c13~110@))))) (=> (= temp_13_1~2312@ (Add (Sub 69 (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul 3 b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2235@ temp_13_1~2312@))) (=> (= temp_13_0~2235@ temp_13_1~2312@) (=> (= temp_14_0~2385@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ b14~116@))) (Mul (Mul (Mul b14~116@ d14~120@) a14~114@) c14~118@))) (=> (= temp_14_1~2434@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (Mul (Mul b14~116@ b14~116@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) a14~114@) c14~118@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2385@ temp_14_1~2434@))) (=> (= temp_14_0~2385@ temp_14_1~2434@) (=> (= temp_15_0~2519@ (Mul (Mul (Mul (Mul b15~124@ c15~126@) (Sub b15~124@ c15~126@)) (Mul d15~128@ (Mul c15~126@ d15~128@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2580@ (Mul (Mul (Mul d15~128@ (Mul c15~126@ d15~128@)) (Mul (Mul b15~124@ c15~126@) (Sub b15~124@ c15~126@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul d15~128@ d15~128@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2519@ temp_15_1~2580@))) (=> (= temp_15_0~2519@ temp_15_1~2580@) (=> (= temp_16_0~2669@ (Mul (Mul (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul b16~132@ c16~134@))) (Mul (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@))))) (=> (= temp_16_1~2734@ (Mul (Mul (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@))) (Mul (Sub (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2669@ temp_16_1~2734@))) (=> (= temp_16_0~2669@ temp_16_1~2734@) (=> (= temp_17_0~2811@ (Mul (Sub (Mul (Mul c17~142@ c17~142@) (Add d17~144@ b17~140@)) (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul b17~140@ a17~138@) (Sub b17~140@ c17~142@)) b17~140@))) (=> (= temp_17_1~2864@ (Mul (Sub (Mul (Mul c17~142@ c17~142@) (Add d17~144@ b17~140@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul b17~140@ a17~138@) (Sub b17~140@ c17~142@)) b17~140@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2811@ temp_17_1~2864@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
