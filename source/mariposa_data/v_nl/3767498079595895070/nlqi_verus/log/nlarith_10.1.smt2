...
(declare-const temp_3_0~924@ Int)
(declare-const temp_3_1~1021@ Int)
(declare-const temp_4_0~1129@ Int)
(declare-const temp_4_1~1222@ Int)
(declare-const temp_5_0~1318@ Int)
(declare-const temp_5_1~1399@ Int)
(declare-const temp_6_0~1543@ Int)
(declare-const temp_6_1~1672@ Int)
(declare-const temp_7_0~1756@ Int)
(declare-const temp_7_1~1821@ Int)
(declare-const temp_8_0~1957@ Int)
(declare-const temp_8_1~2078@ Int)
(declare-const temp_9_0~2214@ Int)
(declare-const temp_9_1~2335@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~249@ (Mul (Mul (Mul (Mul (Add c0~6@ c0~6@) (Mul d0~8@ a0~2@)) (Sub b0~4@ a0~2@)) (Mul a0~2@ d0~8@)) (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ d0~8@)) (Sub (Mul b0~4@ d0~8@) b0~4@)) (Mul c0~6@ (Mul b0~4@ (Mul a0~2@ 66)))))) (=> (= temp_0_1~338@ (Mul (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Add c0~6@ c0~6@)) (Sub b0~4@ a0~2@)) (Mul a0~2@ d0~8@)) (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ d0~8@)) (Sub (Mul b0~4@ d0~8@) b0~4@)) (Mul c0~6@ (Mul b0~4@ (Mul a0~2@ 66)))))) (=> (= tmp%1@ (= temp_0_0~249@ temp_0_1~338@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~466@ (Add (Mul (Mul (Add (Mul a1~10@ d1~16@) (Add d1~16@ d1~16@)) (Mul d1~16@ (Mul a1~10@ d1~16@))) (Add (Mul (Add d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Add c1~14@ c1~14@) (Mul b1~12@ b1~12@)))) (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Sub d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Sub (Add b1~12@ a1~10@) (Add a1~10@ a1~10@)) d1~16@)))) (=> (= temp_1_1~587@ (Add (Mul (Mul (Add (Mul a1~10@ d1~16@) (Add d1~16@ d1~16@)) (Mul d1~16@ (Mul a1~10@ d1~16@))) (Add (Mul (Add d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Add (Mul c1~14@ (Mul b1~12@ b1~12@)) (Mul c1~14@ (Mul b1~12@ b1~12@))))) (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Sub d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Sub (Add b1~12@ a1~10@) (Add a1~10@ a1~10@)) d1~16@)))) (=> (= tmp%2@ (= temp_1_0~466@ temp_1_1~587@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~707@ (Mul (Sub (Mul (Mul (Mul b2~20@ d2~24@) (Sub c2~22@ c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ b2~20@))) (Mul (Sub c2~22@ b2~20@) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)))) (Mul (Mul c2~22@ (Mul (Mul c2~22@ a2~18@) (Sub a2~18@ b2~20@))) (Mul (Mul a2~18@ (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Add d2~24@ d2~24@)))))) (=> (= temp_2_1~812@ (Mul (Sub (Mul (Mul (Mul b2~20@ d2~24@) (Sub c2~22@ c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ b2~20@))) (Mul (Sub c2~22@ b2~20@) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)))) (Mul (Mul c2~22@ (Mul (Mul c2~22@ a2~18@) (Sub a2~18@ b2~20@))) (Mul (Mul a2~18@ (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Add d2~24@ d2~24@)))))) (=> (= tmp%3@ (= temp_2_0~707@ temp_2_1~812@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~924@ (Mul (Sub (Add (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ b3~28@))) (Mul b3~28@ (Sub (Mul b3~28@ a3~26@) d3~32@))) (Mul (Mul (Sub (Mul a3~26@ d3~32@) (Sub b3~28@ b3~28@)) (Mul c3~30@ (Mul b3~28@ b3~28@))) (Sub (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ a3~26@)) b3~28@)))) (=> (= temp_3_1~1021@ (Mul (Sub (Add (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul (Mul d3~32@ c3~30@) a3~26@) b3~28@)) (Mul b3~28@ (Sub (Mul b3~28@ a3~26@) d3~32@))) (Mul (Mul (Sub (Mul a3~26@ d3~32@) (Sub b3~28@ b3~28@)) (Mul c3~30@ (Mul b3~28@ b3~28@))) (Sub (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ a3~26@)) b3~28@)))) (=> (= tmp%4@ (= temp_3_0~924@ temp_3_1~1021@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1129@ (Mul (Mul (Mul (Mul d4~40@ (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ b4~36@))) (Add (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Add d4~40@ b4~36@) b4~36@))) (Mul c4~38@ (Mul (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Sub a4~34@ a4~34@)))))) (=> (= temp_4_1~1222@ (Mul (Mul (Mul (Mul d4~40@ (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ b4~36@))) (Add (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Add d4~40@ b4~36@) b4~36@))) (Mul c4~38@ (Mul (Mul b4~36@ (Mul d4~40@ (Mul a4~34@ b4~36@))) (Mul (Mul a4~34@ d4~40@) (Sub a4~34@ a4~34@)))))) (=> (= tmp%5@ (= temp_4_0~1129@ temp_4_1~1222@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1318@ (Sub (Add (Mul (Mul (Mul c5~46@ a5~42@) (Add a5~42@ d5~48@)) c5~46@) (Mul (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ 4) d5~48@))) (Mul (Mul a5~42@ (Mul c5~46@ (Mul b5~44@ d5~48@))) c5~46@))) (=> (= temp_5_1~1399@ (Sub (Add (Mul (Mul (Mul c5~46@ a5~42@) (Add a5~42@ d5~48@)) c5~46@) (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul a5~42@ 4) d5~48@))) (Mul (Mul a5~42@ (Mul c5~46@ (Mul b5~44@ d5~48@))) c5~46@))) (=> (= tmp%6@ (= temp_5_0~1318@ temp_5_1~1399@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1543@ (Add (Sub (Mul (Sub (Mul d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Sub (Mul a6~50@ b6~52@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@)) (Add (Mul a6~50@ c6~54@) (Add d6~56@ a6~50@)))) (Mul (Add (Sub (Mul a6~50@ b6~52@) (Mul b6~52@ a6~50@)) (Sub (Mul c6~54@ d6~56@) (Mul a6~50@ d6~56@))) (Mul (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ c6~54@)) (Add (Mul c6~54@ a6~50@) (Sub c6~54@ d6~56@)))))) (=> (= temp_6_1~1672@ (Add (Sub (Mul (Sub (Mul d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Sub (Mul a6~50@ b6~52@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@)) (Add (Mul a6~50@ c6~54@) (Add d6~56@ a6~50@)))) (Mul (Add (Sub (Mul a6~50@ b6~52@) (Mul b6~52@ a6~50@)) (Sub (Mul c6~54@ d6~56@) (Mul a6~50@ d6~56@))) (Mul (Mul b6~52@ d6~56@) (Mul (Mul a6~50@ c6~54@) (Add (Mul c6~54@ a6~50@) (Sub c6~54@ d6~56@))))))) (=> (= tmp%7@ (= temp_6_0~1543@ temp_6_1~1672@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1756@ (Add d7~64@ (Mul (Sub (Add (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ b7~60@)))))) (=> (= temp_7_1~1821@ (Add d7~64@ (Mul (Sub (Mul b7~60@ (Add a7~58@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ b7~60@)))))) (=> (= tmp%8@ (= temp_7_0~1756@ temp_7_1~1821@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1957@ (Sub (Mul (Mul d8~72@ (Mul (Add c8~70@ d8~72@) (Sub a8~66@ b8~68@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Mul b8~68@ b8~68@) b8~68@))) (Mul (Mul (Mul (Mul 71 a8~66@) (Mul a8~66@ d8~72@)) (Mul d8~72@ (Mul b8~68@ c8~70@))) (Sub (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Add c8~70@ c8~70@) (Mul a8~66@ a8~66@)))))) (=> (= temp_8_1~2078@ (Sub (Mul (Mul d8~72@ (Mul (Add c8~70@ d8~72@) (Sub a8~66@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) b8~68@) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ b8~68@)))) (Mul (Mul (Mul (Mul 71 a8~66@) (Mul a8~66@ d8~72@)) (Mul d8~72@ (Mul b8~68@ c8~70@))) (Sub (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Add c8~70@ c8~70@) (Mul a8~66@ a8~66@)))))) (=> (= tmp%9@ (= temp_8_0~1957@ temp_8_1~2078@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2214@ (Mul (Sub (Add (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Mul d9~80@ b9~76@) (Mul b9~76@ b9~76@))) (Mul (Mul d9~80@ (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Add a9~74@ c9~78@)))) (Add (Mul (Mul (Add d9~80@ a9~74@) (Add a9~74@ c9~78@)) (Mul (Mul c9~78@ b9~76@) a9~74@)) (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ a9~74@)))))) (=> (= temp_9_1~2335@ (Mul (Sub (Add (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Mul (Mul d9~80@ b9~76@) b9~76@) b9~76@)) (Mul (Mul d9~80@ (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Add a9~74@ c9~78@)))) (Add (Mul (Mul (Add d9~80@ a9~74@) (Add a9~74@ c9~78@)) (Mul (Mul c9~78@ b9~76@) a9~74@)) (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ a9~74@)))))) (=> (= tmp%10@ (= temp_9_0~2214@ temp_9_1~2335@)) (=> %%location_label%%9 tmp%10@))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
