...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Sub d0~8@ (Mul d0~8@ b0~4@)) (Mul a0~2@ (Sub c0~6@ d0~8@))))) (=> (= temp_0_1~354@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul (Sub d0~8@ (Mul d0~8@ b0~4@)) a0~2@) (Sub c0~6@ d0~8@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~354@))) (=> (= temp_0_0~297@ temp_0_1~354@) (=> (= temp_1_0~443@ (Sub (Add (Sub (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@)) (Add (Mul a1~10@ c1~14@) (Mul a1~10@ b1~12@))) (Mul (Sub (Sub d1~16@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Add a1~10@ a1~10@))))) (=> (= temp_1_1~508@ (Sub (Add (Sub (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@)) (Add (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@))) (Mul (Sub (Sub d1~16@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Add a1~10@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~443@ temp_1_1~508@))) (=> (= temp_1_0~443@ temp_1_1~508@) (=> (= temp_2_0~597@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Add a2~18@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~662@ (Mul (Mul (Mul c2~22@ (Mul a2~18@ (Add a2~18@ a2~18@))) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~597@ temp_2_1~662@))) (=> (= temp_2_0~597@ temp_2_1~662@) (=> (= temp_3_0~747@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Sub d3~32@ b3~28@) (Mul b3~28@ d3~32@))) (Mul (Mul c3~30@ (Mul a3~26@ d3~32@)) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~808@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Sub d3~32@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul c3~30@ (Mul a3~26@ d3~32@)) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~747@ temp_3_1~808@))) (=> (= temp_3_0~747@ temp_3_1~808@) (=> (= temp_4_0~905@ (Mul (Mul (Mul (Add c4~38@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Add c4~38@ c4~38@) (Mul d4~40@ a4~34@))) (Sub (Mul (Add d4~40@ a4~34@) (Mul a4~34@ 86)) (Mul (Add d4~40@ b4~36@) b4~36@)))) (=> (= temp_4_1~978@ (Mul (Mul (Add c4~38@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul (Add c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Sub (Mul (Add d4~40@ a4~34@) (Mul a4~34@ 86)) (Mul (Add d4~40@ b4~36@) b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~905@ temp_4_1~978@))) (=> (= temp_4_0~905@ temp_4_1~978@) (=> (= temp_5_0~1067@ (Mul (Mul (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ b5~44@)) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Mul (Add b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1132@ (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Mul (Add b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1067@ temp_5_1~1132@))) (=> (= temp_5_0~1067@ temp_5_1~1132@) (=> (= temp_6_0~1193@ (Sub (Mul (Sub (Mul c6~54@ c6~54@) (Mul a6~50@ d6~56@)) (Add (Mul c6~54@ c6~54@) (Add b6~52@ d6~56@))) a6~50@)) (=> (= temp_6_1~1246@ (Sub (Sub (Mul (Mul c6~54@ c6~54@) (Add (Mul c6~54@ c6~54@) (Add b6~52@ d6~56@))) (Mul (Mul a6~50@ d6~56@) (Add (Mul c6~54@ c6~54@) (Add b6~52@ d6~56@)))) a6~50@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1193@ temp_6_1~1246@))) (=> (= temp_6_0~1193@ temp_6_1~1246@) (=> (= temp_7_0~1335@ (Mul (Mul (Sub (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@)) (Mul (Sub c7~62@ d7~64@) (Add d7~64@ b7~60@))) (Mul (Add (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@)) (Sub (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1400@ (Mul (Mul (Mul (Sub (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@)) (Sub c7~62@ d7~64@)) (Add d7~64@ b7~60@)) (Mul (Add (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@)) (Sub (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1335@ temp_7_1~1400@))) (=> (= temp_7_0~1335@ temp_7_1~1400@) (=> (= temp_8_0~1489@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ c8~70@))) (Add (Mul (Add a8~66@ c8~70@) (Mul b8~68@ d8~72@)) (Add (Mul b8~68@ b8~68@) (Add d8~72@ d8~72@))))) (=> (= temp_8_1~1554@ (Mul (Add (Mul (Add a8~66@ c8~70@) (Mul b8~68@ d8~72@)) (Add (Mul b8~68@ b8~68@) (Add d8~72@ d8~72@))) (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1489@ temp_8_1~1554@))) (=> (= temp_8_0~1489@ temp_8_1~1554@) (=> (= temp_9_0~1643@ (Mul (Sub (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ c9~78@)) (Sub (Mul b9~76@ b9~76@) (Mul b9~76@ b9~76@))) (Add (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~1704@ (Mul (Sub (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ c9~78@)) (Mul b9~76@ (Sub b9~76@ b9~76@))) (Add (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1643@ temp_9_1~1704@))) (=> (= temp_9_0~1643@ temp_9_1~1704@) (=> (= temp_10_0~1781@ (Mul (Mul (Mul (Add d10~88@ d10~88@) (Add d10~88@ d10~88@)) d10~88@) (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ a10~82@))))) (=> (= temp_10_1~1842@ (Mul (Mul (Add (Mul (Add d10~88@ d10~88@) d10~88@) (Mul (Add d10~88@ d10~88@) d10~88@)) d10~88@) (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1781@ temp_10_1~1842@))) (=> (= temp_10_0~1781@ temp_10_1~1842@) (=> (= temp_11_0~1955@ (Mul (Mul (Mul (Sub 53 c11~94@) (Mul d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ d11~96@))) (Sub (Mul (Sub a11~90@ c11~94@) (Mul c11~94@ a11~90@)) (Sub (Mul b11~92@ a11~90@) (Mul d11~96@ 77))))) (=> (= temp_11_1~2044@ (Mul (Mul (Mul (Sub 53 c11~94@) (Mul d11~96@ b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ d11~96@))) (Sub (Mul (Mul (Sub a11~90@ c11~94@) c11~94@) a11~90@) (Sub (Mul b11~92@ a11~90@) (Mul d11~96@ 77))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1955@ temp_11_1~2044@))) (=> (= temp_11_0~1955@ temp_11_1~2044@) (=> (= temp_12_0~2145@ (Mul (Mul (Sub (Mul b12~100@ a12~98@) (Mul d12~104@ 89)) (Mul (Mul b12~100@ b12~100@) (Sub b12~100@ b12~100@))) (Mul (Sub (Mul d12~104@ d12~104@) (Mul a12~98@ d12~104@)) (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ b12~100@))))) (=> (= temp_12_1~2222@ (Mul (Mul (Sub (Mul b12~100@ a12~98@) (Mul d12~104@ 89)) (Mul (Mul b12~100@ b12~100@) (Sub b12~100@ b12~100@))) (Mul (Sub (Mul d12~104@ d12~104@) (Mul a12~98@ d12~104@)) (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ c12~102@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2145@ temp_12_1~2222@))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
