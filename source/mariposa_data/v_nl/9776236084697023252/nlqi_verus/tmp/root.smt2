...
(push)
 ...
 (declare-const temp_14_0~2417@ Int)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~317@ temp_0_1~394@)
        (=>
         (= temp_1_0~483@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Add d1~16@ c1~14@)) (Mul (Add d1~16@
              c1~14@
             ) (Mul b1~12@ d1~16@)
            )
         ...
         (=>
          (= temp_1_1~556@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Add d1~16@ c1~14@)) (Add (Mul d1~16@
               (Mul b1~12@ d1~16@)
          ...
          (and
           ...
           (=>
            (= temp_1_0~483@ temp_1_1~556@)
            (=>
             (= temp_2_0~653@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ c2~22@)) (Mul d2~24@
                 (Mul b2~20@ d2~24@)
                )
             ...
             (=>
              (= temp_2_1~726@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ c2~22@)) (Mul d2~24@
                  (Mul b2~20@ d2~24@)
                 )
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~653@ temp_2_1~726@)
               ))
               (=>
                (= temp_2_0~653@ temp_2_1~726@)
                (=>
                 (= temp_3_0~827@ (Sub (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@)) (Add (Mul b3~28@
                      b3~28@
                     ) (Mul d3~32@ 42)
                    )
                 ...
                 (=>
                  (= temp_3_1~904@ (Sub (Mul (Mul a3~26@ c3~30@) (Mul (Mul b3~28@ a3~26@) (Add (Mul b3~28@
                        b3~28@
                       ) (Mul d3~32@ 42)
                     ))
                    ) (Add (Mul (Mul b3~28@ c3~30@) (Sub a3~26@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Add c3~30@
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~827@ temp_3_1~904@)
                    (=>
                     (= temp_4_0~993@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Add b4~36@ 81)) (Mul (Mul b4~36@
                          d4~40@
                         ) (Mul b4~36@ d4~40@)
                        )
                     ...
                     (=>
                      (= temp_4_1~1058@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Add b4~36@ 81)) (Mul (Mul b4~36@
                           d4~40@
                          ) (Mul b4~36@ d4~40@)
                         )
                        ) (Sub d4~40@ (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@)))
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~993@ temp_4_1~1058@)
                        (=>
                         (= temp_5_0~1147@ (Sub (Mul (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@
                              b5~44@
                             ) (Mul a5~42@ b5~44@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1212@ (Sub (Mul (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@
                               b5~44@
                              ) (Mul a5~42@ b5~44@)
                             )
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1147@ temp_5_1~1212@)
                           ))
                           (=>
                            (= temp_5_0~1147@ temp_5_1~1212@)
                            (=>
                             (= temp_6_0~1301@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul d6~56@
                                  b6~52@
                                 ) (Mul a6~50@ b6~52@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1366@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul d6~56@
                                   b6~52@
                                  ) (Mul a6~50@ b6~52@)
                                 )
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1301@ temp_6_1~1366@)
                               ))
                               (=>
                                (= temp_6_0~1301@ temp_6_1~1366@)
                                (=>
                                 (= temp_7_0~1451@ (Mul (Mul (Mul (Add a7~58@ c7~62@) (Mul a7~58@ b7~60@)) (Add (Mul d7~64@
                                      c7~62@
                                     ) (Mul a7~58@ d7~64@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1512@ (Mul (Add (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)) (Mul c7~62@
                                      (Mul b7~60@ d7~64@)
                                     )
                                  ...
                                  (and
                                   ...
                                   (=>
                                    (= temp_7_0~1451@ temp_7_1~1512@)
                                    (=>
                                     (= temp_8_0~1593@ (Mul (Mul (Mul (Sub a8~66@ a8~66@) (Mul c8~70@ d8~72@)) (Mul (Mul c8~70@
                                          a8~66@
                                         ) d8~72@
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1650@ (Mul (Mul (Mul (Mul (Sub a8~66@ a8~66@) c8~70@) d8~72@) (Mul (Mul c8~70@
                                           a8~66@
                                          ) d8~72@
                                         )
                                        ) (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@)) (Mul a8~66@ (Mul d8~72@ d8~72@)))
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1593@ temp_8_1~1650@)
                                       ))
                                       (=>
                                        (= temp_8_0~1593@ temp_8_1~1650@)
                                        (=>
                                         (= temp_9_0~1711@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Sub c9~78@ c9~78@)) (Mul (Sub d9~80@
                                              b9~76@
                                             ) (Mul b9~76@ b9~76@)
                                            )
                                           ) c9~78@
                                         ...
                                         (=>
                                          (= temp_9_1~1756@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Sub c9~78@ c9~78@)) (Sub (Mul d9~80@
                                               (Mul b9~76@ b9~76@)
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1711@ temp_9_1~1756@)
                                           ))
                                           (=>
                                            (= temp_9_0~1711@ temp_9_1~1756@)
                                            (=>
                                             (= temp_10_0~1845@ (Mul (Mul (Sub (Mul d10~88@ d10~88@) (Add b10~84@ b10~84@)) (Mul (
                                                  Mul 96 b10~84@
                                                 ) (Mul d10~88@ b10~84@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1910@ (Mul (Mul (Sub (Mul d10~88@ d10~88@) (Add b10~84@ b10~84@)) (Mul (
                                                   Mul 96 b10~84@
                                                  ) (Mul d10~88@ b10~84@)
                                                 )
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1845@ temp_10_1~1910@)
                                               ))
                                               (=>
                                                (= temp_10_0~1845@ temp_10_1~1910@)
                                                (=>
                                                 (= temp_11_0~1995@ (Sub (Mul (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@)) (Mul (
                                                      Mul b11~92@ d11~96@
                                                     ) (Sub a11~90@ b11~92@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2056@ (Sub (Mul (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@)) (Mul (
                                                       Sub a11~90@ b11~92@
                                                      ) (Mul b11~92@ d11~96@)
                                                     )
                                                    ) (Add (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (Mul c11~94@ a11~90@)
                                                  ...
                                                  (and
                                                   ...
                                                   (=>
                                                    (= temp_11_0~1995@ temp_11_1~2056@)
                                                    (=>
                                                     (= temp_12_0~2141@ (Mul (Mul (Sub (Mul d12~104@ c12~102@) (Add d12~104@ a12~98@)) (Mul
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2202@ (Mul (Mul (Sub (Mul c12~102@ d12~104@) (Add d12~104@ a12~98@)) (Mul
                                                          b12~100@ (Add b12~100@ a12~98@)
                                                         )
                                                        ) (Mul (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ b12~100@)) (Mul (Mul c12~102@ d12~104@)
                                                          (Mul c12~102@ c12~102@)
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2141@ temp_12_1~2202@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2141@ temp_12_1~2202@)
                                                        (=>
                                                         (= temp_13_0~2283@ (Mul (Sub (Add (Mul b13~108@ c13~110@) d13~112@) (Mul (Mul c13~110@
                                                              b13~108@
                                                             ) (Mul b13~108@ b13~108@)
                                                            )
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2340@ (Mul (Sub (Add (Mul b13~108@ c13~110@) d13~112@) (Mul (Mul b13~108@
                                                               c13~110@
                                                              ) (Mul b13~108@ b13~108@)
                                                             )
                                                            ) (Mul (Mul d13~112@ (Mul a13~106@ b13~108@)) (Mul (Mul c13~110@ a13~106@) (Mul b13~108@
                                                          ...
                                                          (and
                                                           ...
                                                           (=>
                                                            (= temp_13_0~2283@ temp_13_1~2340@)
                                                            (=>
                                                             (= temp_14_0~2417@ (Mul (Mul a14~114@ (Sub (Mul d14~120@ d14~120@) (Mul a14~114@ c14~118@)))
                                                               (Mul (Mul (Mul b14~116@ d14~120@) (Sub a14~114@ a14~114@)) (Mul (Mul d14~120@ c14~118@)
                                                                 (Mul a14~114@ a14~114@)
                                                             ))))
                                                             (=>
                                                              (= temp_14_1~2470@ (Mul (Mul a14~114@ (Sub (Mul d14~120@ d14~120@) (Mul a14~114@ c14~118@)))
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2417@ temp_14_1~2470@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2417@ temp_14_1~2470@)
                                                                (=>
                                                                 (= temp_15_0~2539@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) d15~128@) (Mul (Mul b15~124@
                                                                      b15~124@
                                                                     ) d15~128@
                                                                    )
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2580@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) d15~128@) (Mul (Mul b15~124@
                                                                       b15~124@
                                                                      ) d15~128@
                                                                     )
