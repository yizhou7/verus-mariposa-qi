...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ b0~4@)) (Mul (Add b0~4@ b0~4@) (Add d0~8@ d0~8@))) (Sub (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul c0~6@ c0~6@) (Mul (Mul a0~2@ b0~4@) (Mul (Add b0~4@ b0~4@) (Add d0~8@ d0~8@)))) (Sub (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~459@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Add a1~10@ b1~12@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~524@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Add a1~10@ b1~12@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~459@ temp_1_1~524@))) (=> (= temp_1_0~459@ temp_1_1~524@) (=> (= temp_2_0~597@ (Mul (Mul a2~18@ (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ c2~22@))) (Mul (Mul c2~22@ (Mul c2~22@ c2~22@)) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~646@ (Mul (Mul a2~18@ (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ c2~22@))) (Mul (Mul c2~22@ (Mul c2~22@ c2~22@)) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~597@ temp_2_1~646@))) (=> (= temp_2_0~597@ temp_2_1~646@) (=> (= temp_3_0~731@ (Mul (Mul (Mul c3~30@ (Mul d3~32@ d3~32@)) (Mul (Sub a3~26@ d3~32@) (Mul a3~26@ c3~30@))) (Add (Mul (Mul a3~26@ d3~32@) (Add a3~26@ b3~28@)) (Mul (Add c3~30@ a3~26@) (Sub d3~32@ d3~32@))))) (=> (= temp_3_1~792@ (Mul (Mul (Mul c3~30@ (Mul d3~32@ d3~32@)) (Mul (Sub a3~26@ d3~32@) (Mul a3~26@ c3~30@))) (Add (Mul a3~26@ (Mul d3~32@ (Add a3~26@ b3~28@))) (Mul (Add c3~30@ a3~26@) (Sub d3~32@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~731@ temp_3_1~792@))) (=> (= temp_3_0~731@ temp_3_1~792@) (=> (= temp_4_0~893@ (Mul (Add (Mul (Mul b4~36@ 19) (Mul c4~38@ c4~38@)) (Add (Mul d4~40@ d4~40@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@)) (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~970@ (Mul (Add (Mul (Mul b4~36@ 19) (Mul c4~38@ c4~38@)) (Add (Mul d4~40@ d4~40@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~893@ temp_4_1~970@))) (=> (= temp_4_0~893@ temp_4_1~970@) (=> (= temp_5_0~1051@ (Sub (Mul (Mul (Mul b5~44@ a5~42@) (Sub c5~46@ b5~44@)) (Mul (Mul b5~44@ b5~44@) (Sub a5~42@ d5~48@))) (Add (Add d5~48@ b5~44@) (Mul (Mul d5~48@ c5~46@) (Add b5~44@ c5~46@))))) (=> (= temp_5_1~1108@ (Sub (Mul (Mul (Mul b5~44@ a5~42@) (Sub c5~46@ b5~44@)) (Mul (Mul b5~44@ b5~44@) (Sub a5~42@ d5~48@))) (Add (Add d5~48@ b5~44@) (Mul d5~48@ (Mul c5~46@ (Add b5~44@ c5~46@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1051@ temp_5_1~1108@))) (=> (= temp_5_0~1051@ temp_5_1~1108@) (=> (= temp_6_0~1205@ (Mul (Mul (Mul (Mul 70 c6~54@) (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Add b6~52@ (Sub a6~50@ d6~56@)) (Sub (Mul a6~50@ a6~50@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1278@ (Mul (Mul (Mul (Mul 70 c6~54@) (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Sub (Mul a6~50@ a6~50@) (Mul d6~56@ d6~56@)) (Add b6~52@ (Sub a6~50@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1205@ temp_6_1~1278@))) (=> (= temp_6_0~1205@ temp_6_1~1278@) (=> (= temp_7_0~1367@ (Mul (Sub (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ d7~64@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)) (Sub (Mul d7~64@ d7~64@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1432@ (Mul (Sub (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)) (Sub (Mul d7~64@ d7~64@) (Mul b7~60@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1367@ temp_7_1~1432@))) (=> (= temp_7_0~1367@ temp_7_1~1432@) (=> (= temp_8_0~1509@ (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ a8~66@)) a8~66@) (Mul (Mul (Sub c8~70@ d8~72@) (Mul d8~72@ d8~72@)) (Sub (Add c8~70@ a8~66@) (Mul a8~66@ b8~68@))))) (=> (= temp_8_1~1562@ (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ a8~66@)) a8~66@) (Mul (Sub c8~70@ d8~72@) (Mul (Mul d8~72@ d8~72@) (Sub (Add c8~70@ a8~66@) (Mul a8~66@ b8~68@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1509@ temp_8_1~1562@))) (=> (= temp_8_0~1509@ temp_8_1~1562@) (=> (= temp_9_0~1647@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ a9~74@)) (Sub (Mul b9~76@ a9~74@) (Add d9~80@ d9~80@))) (Mul (Mul (Mul d9~80@ c9~78@) (Sub a9~74@ d9~80@)) (Mul d9~80@ (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1724@ (Mul (Sub (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ a9~74@)) (Mul b9~76@ a9~74@)) (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ a9~74@)) (Add d9~80@ d9~80@))) (Mul (Mul (Mul d9~80@ c9~78@) (Sub a9~74@ d9~80@)) (Mul d9~80@ (Mul c9~78@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1647@ temp_9_1~1724@))) (=> (= temp_9_0~1647@ temp_9_1~1724@) (=> (= temp_10_0~1801@ (Mul (Mul (Mul (Mul b10~84@ c10~86@) (Sub c10~86@ b10~84@)) (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ d10~88@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ a10~82@)) c10~86@))) (=> (= temp_10_1~1854@ (Mul (Mul (Mul (Mul b10~84@ c10~86@) (Sub c10~86@ b10~84@)) (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ d10~88@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ b10~84@)) c10~86@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1801@ temp_10_1~1854@))) (=> (= temp_10_0~1801@ temp_10_1~1854@) (=> (= temp_11_0~1943@ (Sub (Mul (Mul (Mul b11~92@ c11~94@) (Mul b11~92@ d11~96@)) (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ c11~94@))) (Mul (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ b11~92@)) (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ b11~92@))))) (=> (= temp_11_1~2008@ (Sub (Mul (Mul (Mul b11~92@ c11~94@) (Mul b11~92@ d11~96@)) (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ c11~94@))) (Mul (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ b11~92@)) (Mul (Mul b11~92@ c11~94@) (Mul b11~92@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1943@ temp_11_1~2008@))) (=> (= temp_11_0~1943@ temp_11_1~2008@) (=> (= temp_12_0~2069@ (Mul d12~104@ (Mul (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2106@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ a12~98@))) d12~104@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2069@ temp_12_1~2106@))) (=> (= temp_12_0~2069@ temp_12_1~2106@) (=> (= temp_13_0~2183@ (Mul (Mul (Mul (Mul c13~110@ d13~112@) (Mul a13~106@ c13~110@)) a13~106@) (Mul (Mul (Mul b13~108@ d13~112@) (Add d13~112@ d13~112@)) (Sub (Add b13~108@ a13~106@) (Add c13~110@ a13~106@))))) (=> (= temp_13_1~2236@ (Mul (Mul (Mul c13~110@ (Mul d13~112@ (Mul a13~106@ c13~110@))) a13~106@) (Mul (Mul (Mul b13~108@ d13~112@) (Add d13~112@ d13~112@)) (Sub (Add b13~108@ a13~106@) (Add c13~110@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2183@ temp_13_1~2236@))) (=> (= temp_13_0~2183@ temp_13_1~2236@) (=> (= temp_14_0~2337@ (Mul (Add (Mul (Mul d14~120@ c14~118@) (Add d14~120@ a14~114@)) (Mul (Mul a14~114@ a14~114@) (Add a14~114@ 19))) (Mul (Mul (Mul b14~116@ c14~118@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ c14~118@) (Mul a14~114@ a14~114@))))) (=> (= temp_14_1~2422@ (Mul (Add (Mul (Mul d14~120@ c14~118@) (Add d14~120@ a14~114@)) (Add (Mul (Mul a14~114@ a14~114@) a14~114@) (Mul (Mul a14~114@ a14~114@) 19))) (Mul (Mul (Mul b14~116@ c14~118@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ c14~118@) (Mul a14~114@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2337@ temp_14_1~2422@))) (=> (= temp_14_0~2337@ temp_14_1~2422@) (=> (= temp_15_0~2495@ (Add (Mul (Mul (Add b15~124@ b15~124@) (Mul b15~124@ d15~128@)) (Add (Mul b15~124@ d15~128@) (Mul d15~128@ a15~122@))) (Mul a15~122@ (Mul (Add a15~122@ d15~128@) b15~124@)))) (=> (= temp_15_1~2544@ (Add (Mul (Mul (Add b15~124@ b15~124@) (Mul b15~124@ d15~128@)) (Add (Mul d15~128@ b15~124@) (Mul d15~128@ a15~122@))) (Mul a15~122@ (Mul (Add a15~122@ d15~128@) b15~124@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2495@ temp_15_1~2544@))) (=> (= temp_15_0~2495@ temp_15_1~2544@) (=> (= temp_16_0~2633@ (Mul (Add (Mul (Add d16~136@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ d16~136@) (Mul c16~134@ d16~136@))) (Mul (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2698@ (Mul (Add (Mul (Add d16~136@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul a16~130@ d16~136@) (Mul c16~134@ d16~136@))) (Mul (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ b16~132@)) (Mul (Mul d16~136@ a16~130@) (Mul c16~134@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2633@ temp_16_1~2698@))) (=> (= temp_16_0~2633@ temp_16_1~2698@) (=> (= temp_17_0~2767@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) c17~142@) (Mul (Mul c17~142@ c17~142@) b17~140@)) (Mul a17~138@ (Mul (Sub a17~138@ a17~138@) (Mul a17~138@ d17~144@))))) (=> (= temp_17_1~2812@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) c17~142@) (Mul (Mul c17~142@ c17~142@) b17~140@)) (Mul a17~138@ (Mul (Sub a17~138@ a17~138@) (Mul a17~138@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2767@ temp_17_1~2812@))) (=> (= temp_17_0~2767@ temp_17_1~2812@) (=> (= temp_18_0~2925@ (Mul (Mul (Mul (Sub 21 c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ b18~148@))) (Sub (Mul (Mul d18~152@ a18~146@) (Mul d18~152@ c18~150@)) (Add (Mul d18~152@ d18~152@) (Mul 89 a18~146@))))) (=> (= temp_18_1~3014@ (Mul (Sub (Mul (Mul d18~152@ a18~146@) (Mul d18~152@ c18~150@)) (Add (Mul d18~152@ d18~152@) (Mul 89 a18~146@))) (Mul (Mul (Sub 21 c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ b18~148@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2925@ temp_18_1~3014@))) (=> (= temp_18_0~2925@ temp_18_1~3014@) (=> (= temp_19_0~3099@ (Mul (Mul (Mul (Mul a19~154@ a19~154@) (Mul c19~158@ a19~154@)) (Mul (Mul a19~154@ d19~160@) (Mul c19~158@ b19~156@))) (Mul (Mul (Sub a19~154@ b19~156@) (Mul b19~156@ b19~156@)) (Mul (Mul b19~156@ a19~154@) d19~160@)))) (=> (= temp_19_1~3160@ (Mul (Mul (Mul (Mul a19~154@ a19~154@) (Mul c19~158@ a19~154@)) (Mul (Mul a19~154@ d19~160@) (Mul c19~158@ b19~156@))) (Mul (Mul (Sub a19~154@ b19~156@) (Mul b19~156@ b19~156@)) (Mul (Mul a19~154@ b19~156@) d19~160@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3099@ temp_19_1~3160@))) (=> (= temp_19_0~3099@ temp_19_1~3160@) (=> (= temp_20_0~3249@ (Mul (Sub (Mul (Mul d20~168@ c20~166@) (Mul b20~164@ a20~162@)) (Mul (Mul d20~168@ d20~168@) (Add c20~166@ a20~162@))) (Mul (Add (Mul c20~166@ c20~166@) (Mul c20~166@ c20~166@)) (Mul (Mul b20~164@ b20~164@) (Mul b20~164@ b20~164@))))) (=> (= temp_20_1~3314@ (Mul (Mul (Sub (Mul (Mul d20~168@ c20~166@) (Mul b20~164@ a20~162@)) (Mul (Mul d20~168@ d20~168@) (Add c20~166@ a20~162@))) (Add (Mul c20~166@ c20~166@) (Mul c20~166@ c20~166@))) (Mul (Mul b20~164@ b20~164@) (Mul b20~164@ b20~164@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3249@ temp_20_1~3314@))) (=> (= temp_20_0~3249@ temp_20_1~3314@) (=> (= temp_21_0~3403@ (Mul (Mul (Mul (Mul d21~176@ d21~176@) (Sub b21~172@ a21~170@)) (Sub (Mul c21~174@ a21~170@) (Mul d21~176@ a21~170@))) (Mul (Mul (Sub b21~172@ b21~172@) (Mul b21~172@ c21~174@)) (Mul (Mul a21~170@ b21~172@) (Mul d21~176@ a21~170@))))) (=> (= temp_21_1~3468@ (Mul (Mul (Mul (Sub b21~172@ b21~172@) (Mul b21~172@ c21~174@)) (Mul (Mul a21~170@ b21~172@) (Mul d21~176@ a21~170@))) (Mul (Mul (Mul d21~176@ d21~176@) (Sub b21~172@ a21~170@)) (Sub (Mul c21~174@ a21~170@) (Mul d21~176@ a21~170@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3403@ temp_21_1~3468@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
