...
(set-info :comment ";; mariposa_data/v_nl//17298556895922633107/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_7_0~1457@ Int)
(declare-const temp_7_1~1498@ Int)
(declare-const temp_8_0~1599@ Int)
(declare-const temp_8_1~1672@ Int)
(declare-const temp_9_0~1767@ Int)
(declare-const temp_9_1~1836@ Int)
(declare-const temp_10_0~1935@ Int)
(declare-const temp_10_1~2000@ Int)
(declare-const temp_11_0~2149@ Int)
(declare-const temp_11_1~2214@ Int)
(declare-const temp_12_0~2325@ Int)
(declare-const temp_12_1~2386@ Int)
(declare-const temp_13_0~2499@ Int)
(declare-const temp_13_1~2560@ Int)
(declare-const temp_14_0~2695@ Int)
(declare-const temp_14_1~2804@ Int)
(declare-const temp_15_0~2971@ Int)
(declare-const temp_15_1~3044@ Int)
(declare-const temp_16_0~3199@ Int)
(declare-const temp_16_1~3264@ Int)
(declare-const temp_17_0~3369@ Int)
(declare-const temp_17_1~3446@ Int)
(declare-const temp_18_0~3571@ Int)
(declare-const temp_18_1~3632@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul (Sub (Mul c0~6@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Add d0~8@ a0~2@))) (Mul a0~2@ (Sub (Mul a0~2@ d0~8@) (Mul b0~4@ a0~2@))))) (=> (= temp_0_1~346@ (Mul (Mul (Sub (Mul b0~4@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Add d0~8@ a0~2@))) (Mul a0~2@ (Sub (Mul a0~2@ d0~8@) (Mul b0~4@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~423@ (Mul (Mul (Sub (Mul d1~16@ c1~14@) b1~12@) a1~10@) (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~472@ (Mul (Mul (Sub (Mul d1~16@ c1~14@) b1~12@) a1~10@) (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul (Mul b1~12@ c1~14@) d1~16@) a1~10@)))) (and (=> (= tmp%1@ (Mul b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ d1~16@ a1~10@) (=> %%location_label%%1 (= temp_1_0~423@ temp_1_1~472@)))) (=> (= temp_1_0~423@ temp_1_1~472@) (=> (= temp_2_0~567@ (Mul (Mul (Sub (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) (Sub c2~22@ (Mul c2~22@ b2~20@))) (Mul (Add (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Add b2~20@ d2~24@))))) (=> (= temp_2_1~644@ (Mul (Sub (Mul (Sub (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) c2~22@) (Mul (Sub (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) (Mul c2~22@ b2~20@))) (Mul (Add (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Add b2~20@ d2~24@))))) (and (=> (= tmp%2@ (Sub (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@))) (=> (= tmp%3@ (Mul c2~22@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%2@ c2~22@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~567@ temp_2_1~644@))))) (=> (= temp_2_0~567@ temp_2_1~644@) (=> (= temp_3_0~767@ (Add (Mul (Mul (Sub b3~28@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul 38 b3~28@) (Sub d3~32@ b3~28@))) (Mul (Mul (Mul a3~26@ a3~26@) (Sub c3~30@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~844@ (Add (Mul (Mul (Sub b3~28@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul 38 b3~28@) (Sub d3~32@ b3~28@))) (Mul (Mul (Mul a3~26@ a3~26@) (Sub c3~30@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ d3~32@) (=> %%location_label%%3 (= temp_3_0~767@ temp_3_1~844@))) (=> (= temp_3_0~767@ temp_3_1~844@) (=> (= temp_4_0~945@ (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@))) (Sub (Mul (Add a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul a4~34@ (Mul 20 a4~34@))))) (=> (= temp_4_1~1018@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@))) (Sub (Mul (Add a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul a4~34@ (Mul 20 a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ d4~40@) (=> %%location_label%%4 (= temp_4_0~945@ temp_4_1~1018@))) (=> (= temp_4_0~945@ temp_4_1~1018@) (=> (= temp_5_0~1111@ (Sub (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ c5~46@)) (Add (Sub c5~46@ b5~44@) (Add a5~42@ c5~46@))))) (=> (= temp_5_1~1192@ (Sub (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@))) (Add (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ c5~46@)) (Sub c5~46@ b5~44@)) (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ c5~46@)) (Add a5~42@ c5~46@))))) (and (=> (= tmp%4@ (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ c5~46@))) (=> (= tmp%5@ (Sub c5~46@ b5~44@)) (=> (= tmp%6@ (Add a5~42@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~1111@ temp_5_1~1192@)))))) (=> (= temp_5_0~1111@ temp_5_1~1192@) (=> (= temp_6_0~1315@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) b6~52@) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul d6~56@ d6~56@) (Add d6~56@ 40)) (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1388@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) b6~52@) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul d6~56@ d6~56@) (Add d6~56@ 40)) (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1315@ temp_6_1~1388@))) (=> (= temp_6_0~1315@ temp_6_1~1388@) (=> (= temp_7_0~1457@ (Mul (Mul b7~60@ (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul c7~62@ c7~62@) (Add a7~58@ b7~60@)) b7~60@))) (=> (= temp_7_1~1498@ (Mul (Mul b7~60@ (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul c7~62@ c7~62@) (Add a7~58@ b7~60@)) b7~60@))) (and (=> (= tmp%7@ (Mul c7~62@ d7~64@)) (=> (= tmp%8@ (Mul d7~64@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%7 (= temp_7_0~1457@ temp_7_1~1498@))))) (=> (= temp_7_0~1457@ temp_7_1~1498@) (=> (= temp_8_0~1599@ (Mul (Mul (Mul (Add c8~70@ d8~72@) (Add d8~72@ c8~70@)) (Add (Add b8~68@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Sub (Mul b8~68@ a8~66@) (Mul b8~68@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Sub a8~66@ d8~72@))))) (=> (= temp_8_1~1672@ (Mul (Mul (Mul (Add c8~70@ d8~72@) (Add d8~72@ c8~70@)) (Add (Add b8~68@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Sub (Mul b8~68@ a8~66@) (Mul b8~68@ d8~72@)) (Sub (Mul (Mul a8~66@ b8~68@) a8~66@) (Mul (Mul a8~66@ b8~68@) d8~72@))))) (and (=> (= tmp%9@ (Mul a8~66@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ a8~66@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1599@ temp_8_1~1672@)))) (=> (= temp_8_0~1599@ temp_8_1~1672@) (=> (= temp_9_0~1767@ (Mul (Mul (Sub (Mul c9~78@ b9~76@) (Mul c9~78@ c9~78@)) (Mul (Sub c9~78@ a9~74@) (Mul a9~74@ d9~80@))) (Sub (Mul b9~76@ (Mul c9~78@ d9~80@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~1836@ (Mul (Mul (Sub (Mul c9~78@ b9~76@) (Mul c9~78@ c9~78@)) (Sub (Mul c9~78@ (Mul a9~74@ d9~80@)) (Mul a9~74@ (Mul a9~74@ d9~80@)))) (Sub (Mul b9~76@ (Mul c9~78@ d9~80@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ b9~76@))))) (and (=> (= tmp%10@ (Mul a9~74@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c9~78@ a9~74@ tmp%10@) (=> %%location_label%%9 (= temp_9_0~1767@ temp_9_1~1836@)))) (=> (= temp_9_0~1767@ temp_9_1~1836@) (=> (= temp_10_0~1935@ (Mul (Mul (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ c10~86@)) (Mul (Sub a10~82@ b10~84@) (Mul b10~84@ c10~86@))) (Mul (Mul (Mul c10~86@ b10~84@) (Sub a10~82@ d10~88@)) (Add (Mul c10~86@ d10~88@) (Mul d10~88@ a10~82@))))) (=> (= temp_10_1~2000@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Sub a10~82@ d10~88@)) (Add (Mul c10~86@ d10~88@) (Mul d10~88@ a10~82@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ c10~86@)) (Mul (Sub a10~82@ b10~84@) (Mul b10~84@ c10~86@))))) (and (=> (= tmp%11@ (Mul (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ c10~86@)) (Mul (Sub a10~82@ b10~84@) (Mul b10~84@ c10~86@)))) (=> (= tmp%12@ (Mul (Mul (Mul c10~86@ b10~84@) (Sub a10~82@ d10~88@)) (Add (Mul c10~86@ d10~88@) (Mul d10~88@ a10~82@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%10 (= temp_10_0~1935@ temp_10_1~2000@))))) (=> (= temp_10_0~1935@ temp_10_1~2000@) (=> (= temp_11_0~2149@ (Add (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (Add a11~90@ d11~96@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul c11~94@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2214@ (Add (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (Add a11~90@ d11~96@) (Mul d11~96@ c11~94@))) (Mul (Mul c11~94@ c11~94@) (Mul (Mul a11~90@ a11~90@) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@)))))) (and (=> (= tmp%13@ (Mul c11~94@ c11~94@)) (=> (= tmp%14@ (Mul a11~90@ a11~90@)) (=> (= tmp%15@ (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%11 (= temp_11_0~2149@ temp_11_1~2214@)))))) (=> (= temp_11_0~2149@ temp_11_1~2214@) (=> (= temp_12_0~2325@ (Add (Mul (Mul (Mul b12~100@ d12~104@) (Sub b12~100@ b12~100@)) (Mul b12~100@ (Mul d12~104@ c12~102@))) (Mul (Mul (Add a12~98@ c12~102@) (Add d12~104@ d12~104@)) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2386@ (Add (Mul (Mul (Mul b12~100@ d12~104@) (Sub b12~100@ b12~100@)) (Mul b12~100@ (Mul d12~104@ c12~102@))) (Mul (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ d12~104@)) (Mul (Add a12~98@ c12~102@) (Add d12~104@ d12~104@))))) (and (=> (= tmp%16@ (Mul (Add a12~98@ c12~102@) (Add d12~104@ d12~104@))) (=> (= tmp%17@ (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%12 (= temp_12_0~2325@ temp_12_1~2386@))))) (=> (= temp_12_0~2325@ temp_12_1~2386@) (=> (= temp_13_0~2499@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Add d13~112@ d13~112@)) b13~108@) (Mul (Mul d13~112@ (Mul b13~108@ d13~112@)) (Add (Mul a13~106@ a13~106@) (Sub 86 b13~108@))))) (=> (= temp_13_1~2560@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Add d13~112@ d13~112@)) b13~108@) (Mul d13~112@ (Mul (Mul b13~108@ d13~112@) (Add (Mul a13~106@ a13~106@) (Sub 86 b13~108@)))))) (and (=> (= tmp%18@ (Mul b13~108@ d13~112@)) (=> (= tmp%19@ (Add (Mul a13~106@ a13~106@) (Sub 86 b13~108@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. d13~112@ tmp%18@ tmp%19@) (=> %%location_label%%13 (= temp_13_0~2499@ temp_13_1~2560@))))) (=> (= temp_13_0~2499@ temp_13_1~2560@) (=> (= temp_14_0~2695@ (Mul (Sub (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (Add (Mul b14~116@ 92) (Sub d14~120@ c14~118@))) (Mul (Sub (Mul a14~114@ c14~118@) (Mul d14~120@ c14~118@)) (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2804@ (Sub (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (Mul (Sub (Mul a14~114@ c14~118@) (Mul d14~120@ c14~118@)) (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ b14~116@)))) (Mul (Add (Mul b14~116@ 92) (Sub d14~120@ c14~118@)) (Mul (Sub (Mul a14~114@ c14~118@) (Mul d14~120@ c14~118@)) (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ b14~116@)))))) (and (=> (= tmp%20@ (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@))) (=> (= tmp%21@ (Add (Mul b14~116@ 92) (Sub d14~120@ c14~118@))) (=> (= tmp%22@ (Mul (Sub (Mul a14~114@ c14~118@) (Mul d14~120@ c14~118@)) (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ b14~116@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%14 (= temp_14_0~2695@ temp_14_1~2804@)))))) (=> (= temp_14_0~2695@ temp_14_1~2804@) (=> (= temp_15_0~2971@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) b15~124@) (Mul (Add a15~122@ a15~122@) (Mul c15~126@ b15~124@))) (Mul (Mul (Mul 67 d15~128@) (Mul a15~122@ c15~126@)) (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@))))) (=> (= temp_15_1~3044@ (Mul (Mul (Mul b15~124@ a15~122@) b15~124@) (Mul (Mul (Add a15~122@ a15~122@) (Mul c15~126@ b15~124@)) (Mul (Mul (Mul 67 d15~128@) (Mul a15~122@ c15~126@)) (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@)))))) (and (=> (= tmp%23@ (Mul (Mul b15~124@ a15~122@) b15~124@)) (=> (= tmp%24@ (Mul (Add a15~122@ a15~122@) (Mul c15~126@ b15~124@))) (=> (= tmp%25@ (Mul (Mul (Mul 67 d15~128@) (Mul a15~122@ c15~126@)) (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> %%location_label%%15 (= temp_15_0~2971@ temp_15_1~3044@)))))) (=> (= temp_15_0~2971@ temp_15_1~3044@) (=> (= temp_16_0~3199@ (Mul (Mul (Mul (Mul 52 d16~136@) (Add b16~132@ a16~130@)) (Sub (Mul c16~134@ c16~134@) (Mul a16~130@ d16~136@))) (Mul (Add (Mul d16~136@ c16~134@) (Mul c16~134@ b16~132@)) d16~136@))) (=> (= temp_16_1~3264@ (Mul (Mul (Mul (Mul 52 d16~136@) (Add b16~132@ a16~130@)) (Sub (Mul c16~134@ c16~134@) (Mul a16~130@ d16~136@))) (Mul (Add (Mul c16~134@ d16~136@) (Mul c16~134@ b16~132@)) d16~136@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d16~136@ c16~134@) (=> %%location_label%%16 (= temp_16_0~3199@ temp_16_1~3264@))) (=> (= temp_16_0~3199@ temp_16_1~3264@) (=> (= temp_17_0~3369@ (Mul (Mul (Mul (Mul a17~138@ c17~142@) (Sub b17~140@ d17~144@)) (Mul (Mul c17~142@ d17~144@) (Mul 38 b17~140@))) (Mul (Sub (Mul b17~140@ b17~140@) (Mul c17~142@ a17~138@)) (Add (Mul c17~142@ b17~140@) (Mul c17~142@ b17~140@))))) (=> (= temp_17_1~3446@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Mul 38 b17~140@)) (Mul (Mul a17~138@ c17~142@) (Sub b17~140@ d17~144@))) (Mul (Sub (Mul b17~140@ b17~140@) (Mul c17~142@ a17~138@)) (Add (Mul c17~142@ b17~140@) (Mul c17~142@ b17~140@))))) (and (=> (= tmp%26@ (Mul (Mul a17~138@ c17~142@) (Sub b17~140@ d17~144@))) (=> (= tmp%27@ (Mul (Mul c17~142@ d17~144@) (Mul 38 b17~140@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%26@ tmp%27@) (=> %%location_label%%17 (= temp_17_0~3369@ temp_17_1~3446@))))) (=> (= temp_17_0~3369@ temp_17_1~3446@) (=> (= temp_18_0~3571@ (Mul (Add (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ d18~152@)) (Mul (Mul c18~150@ b18~148@) (Mul d18~152@ d18~152@))) (Mul (Sub (Sub b18~148@ c18~150@) (Mul b18~148@ c18~150@)) (Mul (Mul b18~148@ b18~148@) c18~150@)))) (=> (= temp_18_1~3632@ (Mul (Mul (Add (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ d18~152@)) (Mul (Mul c18~150@ b18~148@) (Mul d18~152@ d18~152@))) (Sub (Sub b18~148@ c18~150@) (Mul b18~148@ c18~150@))) (Mul (Mul b18~148@ b18~148@) c18~150@))) (and (=> (= tmp%28@ (Add (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ d18~152@)) (Mul (Mul c18~150@ b18~148@) (Mul d18~152@ d18~152@)))) (=> (= tmp%29@ (Sub (Sub b18~148@ c18~150@) (Mul b18~148@ c18~150@))) (=> (= tmp%30@ (Mul (Mul b18~148@ b18~148@) c18~150@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%18 (= temp_18_0~3571@ temp_18_1~3632@)))))) (=> (= temp_18_0~3571@ temp_18_1~3632@) (=> (= temp_19_0~3787@ (Mul (Mul (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ b19~156@)) (Mul (Add b19~156@ b19~156@) (Sub c19~158@ d19~160@))) (Add (Mul (Mul c19~158@ c19~158@) (Mul c19~158@ b19~156@)) (Mul (Mul b19~156@ b19~156@) (Mul 6 b19~156@))))) (=> (= temp_19_1~3864@ (Mul (Mul (Mul (Mul b19~156@ c19~158@) (Mul b19~156@ a19~154@)) (Mul (Add b19~156@ b19~156@) (Sub c19~158@ d19~160@))) (Add (Mul (Mul c19~158@ c19~158@) (Mul c19~158@ b19~156@)) (Mul (Mul b19~156@ b19~156@) (Mul 6 b19~156@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a19~154@ b19~156@) (=> %%location_label%%19 (= temp_19_0~3787@ temp_19_1~3864@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
