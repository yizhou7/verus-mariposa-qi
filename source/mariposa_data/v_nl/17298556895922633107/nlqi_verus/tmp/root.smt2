...
(push)
 ...
 (declare-const temp_1_0~419@ Int)
 ...
 (declare-const temp_18_1~3198@ Int)
 (declare-const temp_19_0~3299@ Int)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~293@ temp_0_1~346@)
        (=>
         (= temp_1_0~419@ (Mul (Mul (Sub (Mul d1~16@ c1~14@) b1~12@) a1~10@) (Mul (Mul (Mul b1~12@
              c1~14@
             ) (Mul b1~12@ a1~10@)
            ) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))
         )))
         (=>
          (= temp_1_1~468@ (Mul (Mul (Sub (Mul d1~16@ c1~14@) b1~12@) a1~10@) (Mul (Mul (Mul b1~12@
               c1~14@
              ) (Mul b1~12@ a1~10@)
          ...
          (and
           (=>
            ...
            (=>
             %%location_label%%1
             (= temp_1_0~419@ temp_1_1~468@)
           ))
           (=>
            (= temp_1_0~419@ temp_1_1~468@)
            (=>
             (= temp_2_0~553@ (Mul (Mul (Sub (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) (Sub c2~22@
                 (Mul c2~22@ b2~20@)
                )
             ...
             (=>
              (= temp_2_1~630@ (Mul (Sub (Mul (Sub (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) c2~22@)
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~553@ temp_2_1~630@)
               ))
               (=>
                (= temp_2_0~553@ temp_2_1~630@)
                (=>
                 (= temp_3_0~731@ (Add (Mul (Mul (Sub b3~28@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul 38
                      b3~28@
                     ) (Sub d3~32@ b3~28@)
                    )
                 ...
                 (=>
                  (= temp_3_1~808@ (Add (Mul (Mul (Sub b3~28@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul 38
                       b3~28@
                      ) (Sub d3~32@ b3~28@)
                     )
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~731@ temp_3_1~808@)
                    (=>
                     (= temp_4_0~905@ (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@
                          b4~36@
                         ) (Mul d4~40@ c4~38@)
                        )
                     ...
                     (=>
                      (= temp_4_1~978@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@
                           b4~36@
                          ) (Mul d4~40@ c4~38@)
                         )
                        ) (Sub (Mul (Add a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul a4~34@ (Mul 20 a4~34@)))
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~905@ temp_4_1~978@)
                        (=>
                         (= temp_5_0~1067@ (Sub (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul a5~42@
                              a5~42@
                             ) (Mul a5~42@ b5~44@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1148@ (Sub (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul a5~42@
                               a5~42@
                              ) (Mul a5~42@ b5~44@)
                             )
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1067@ temp_5_1~1148@)
                           ))
                           (=>
                            (= temp_5_0~1067@ temp_5_1~1148@)
                            (=>
                             (= temp_6_0~1245@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) b6~52@) (Mul (Mul c6~54@ c6~54@)
                                 (Mul d6~56@ c6~54@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1318@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) b6~52@) (Mul (Mul c6~54@ c6~54@)
                                  (Mul d6~56@ c6~54@)
                                 )
                              ...
                              (and
                               ...
                               (=>
                                (= temp_6_0~1245@ temp_6_1~1318@)
                                (=>
                                 (= temp_7_0~1383@ (Mul (Mul b7~60@ (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ d7~64@))) (
                                    Mul (Mul (Mul c7~62@ c7~62@) (Add a7~58@ b7~60@)) b7~60@
                                 )))
                                 (=>
                                  (= temp_7_1~1424@ (Mul (Mul b7~60@ (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ d7~64@))) (
                                     Mul (Mul (Mul c7~62@ c7~62@) (Add a7~58@ b7~60@)) b7~60@
                                  )))
                                  (and
                                   (=>
                                   ...
                                   (=>
                                    (= temp_7_0~1383@ temp_7_1~1424@)
                                    (=>
                                     (= temp_8_0~1513@ (Mul (Mul (Mul (Add c8~70@ d8~72@) (Add d8~72@ c8~70@)) (Add (Add b8~68@
                                          c8~70@
                                         ) (Mul d8~72@ c8~70@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1586@ (Mul (Mul (Mul (Add c8~70@ d8~72@) (Add d8~72@ c8~70@)) (Add (Add b8~68@
                                           c8~70@
                                          ) (Mul d8~72@ c8~70@)
                                         )
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1513@ temp_8_1~1586@)
                                       ))
                                       (=>
                                        (= temp_8_0~1513@ temp_8_1~1586@)
                                        (=>
                                         (= temp_9_0~1671@ (Mul (Mul (Sub (Mul c9~78@ b9~76@) (Mul c9~78@ c9~78@)) (Mul (Sub c9~78@
                                              a9~74@
                                             ) (Mul a9~74@ d9~80@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1740@ (Mul (Mul (Sub (Mul c9~78@ b9~76@) (Mul c9~78@ c9~78@)) (Sub (Mul c9~78@
                                               (Mul a9~74@ d9~80@)
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1671@ temp_9_1~1740@)
                                           ))
                                           (=>
                                            (= temp_9_0~1671@ temp_9_1~1740@)
                                            (=>
                                             (= temp_10_0~1829@ (Mul (Mul (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ c10~86@)) (Mul (
                                                  Sub a10~82@ b10~84@
                                                 ) (Mul b10~84@ c10~86@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1894@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Sub a10~82@ d10~88@)) (Add (
                                                   Mul c10~86@ d10~88@
                                                  ) (Mul d10~88@ a10~82@)
                                                 )
                                              ...
                                              (and
                                               ...
                                               (=>
                                                (= temp_10_0~1829@ temp_10_1~1894@)
                                                (=>
                                                 (= temp_11_0~1983@ (Add (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (
                                                      Add a11~90@ d11~96@
                                                     ) (Mul d11~96@ c11~94@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2048@ (Add (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (
                                                       Add a11~90@ d11~96@
                                                      ) (Mul d11~96@ c11~94@)
                                                     )
                                                  ...
                                                  (and
                                                   ...
                                                   (=>
                                                    (= temp_11_0~1983@ temp_11_1~2048@)
                                                    (=>
                                                     (= temp_12_0~2133@ (Add (Mul (Mul (Mul b12~100@ d12~104@) (Sub b12~100@ b12~100@)) (
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2194@ (Add (Mul (Mul (Mul b12~100@ d12~104@) (Sub b12~100@ b12~100@)) (
                                                          Mul b12~100@ (Mul d12~104@ c12~102@)
                                                         )
                                                      ...
                                                      (and
                                                       ...
                                                       (=>
                                                        (= temp_12_0~2133@ temp_12_1~2194@)
                                                        (=>
                                                         (= temp_13_0~2279@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Add d13~112@ d13~112@)) b13~108@)
                                                           (Mul (Mul d13~112@ (Mul b13~108@ d13~112@)) (Add (Mul a13~106@ a13~106@) (Sub 86 b13~108@)))
                                                         ))
                                                         (=>
                                                          (= temp_13_1~2340@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Add d13~112@ d13~112@)) b13~108@)
                                                          ...
                                                          (and
                                                           ...
                                                           (=>
                                                            (= temp_13_0~2279@ temp_13_1~2340@)
                                                            (=>
                                                             (= temp_14_0~2441@ (Mul (Sub (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2550@ (Sub (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (
                                                                  Mul (Sub (Mul a14~114@ c14~118@) (Mul d14~120@ c14~118@)) (Mul (Mul a14~114@ c14~118@)
                                                                   (Mul b14~116@ b14~116@)
                                                                 ))
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2441@ temp_14_1~2550@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2441@ temp_14_1~2550@)
                                                                (=>
                                                                 (= temp_15_0~2647@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) b15~124@) (Mul (Add a15~122@
                                                                      a15~122@
                                                                     ) (Mul c15~126@ b15~124@)
                                                                    )
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2720@ (Mul (Mul (Mul b15~124@ a15~122@) b15~124@) (Mul (Mul (Add a15~122@
                                                                       a15~122@
                                                                      ) (Mul c15~126@ b15~124@)
                                                                     ) (Mul (Mul (Mul 67 d15~128@) (Mul a15~122@ c15~126@)) (Mul (Mul a15~122@ a15~122@)
                                                                       (Mul d15~128@ b15~124@)
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2647@ temp_15_1~2720@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2647@ temp_15_1~2720@)
                                                                    (=>
                                                                     (= temp_16_0~2809@ (Mul (Mul (Mul (Mul 52 d16~136@) (Add b16~132@ a16~130@)) (Sub (Mul
                                                                          c16~134@ c16~134@
                                                                         ) (Mul a16~130@ d16~136@)
                                                                        )
                                                                     ...
                                                                     (=>
                                                                      (= temp_16_1~2874@ (Mul (Mul (Mul (Mul 52 d16~136@) (Add b16~132@ a16~130@)) (Sub (Mul
                                                                           c16~134@ c16~134@
                                                                          ) (Mul a16~130@ d16~136@)
                                                                         )
                                                                      ...
                                                                      (and
                                                                       ...
                                                                       (=>
                                                                        (= temp_16_0~2809@ temp_16_1~2874@)
                                                                        (=>
                                                                         (= temp_17_0~2975@ (Mul (Mul (Mul (Mul a17~138@ c17~142@) (Sub b17~140@ d17~144@)) (
                                                                         ...
                                                                         (=>
                                                                          (= temp_17_1~3052@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Mul 38 b17~140@)) (Mul (Mul
                                                                               a17~138@ c17~142@
                                                                              ) (Sub b17~140@ d17~144@)
                                                                             )
                                                                            ) (Mul (Sub (Mul b17~140@ b17~140@) (Mul c17~142@ a17~138@)) (Add (Mul c17~142@ b17~140@)
                                                                          ...
                                                                          (and
                                                                           ...
                                                                           (=>
                                                                            (= temp_17_0~2975@ temp_17_1~3052@)
                                                                            (=>
                                                                             (= temp_18_0~3137@ (Mul (Add (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ d18~152@)) (
                                                                             ...
                                                                             (=>
                                                                              (= temp_18_1~3198@ (Mul (Mul (Add (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ d18~152@))
                                                                                  (Mul (Mul c18~150@ b18~148@) (Mul d18~152@ d18~152@))
                                                                              ...
                                                                              (and
                                                                               (=>
                                                                                ...
                                                                                (=>
                                                                                 %%location_label%%18
                                                                                 (= temp_18_0~3137@ temp_18_1~3198@)
                                                                               ))
                                                                               (=>
                                                                                (= temp_18_0~3137@ temp_18_1~3198@)
                                                                                (=>
                                                                                 (= temp_19_0~3299@ (Mul (Mul (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ b19~156@)) (
                                                                                 ...
                                                                                 (=>
                                                                                  (= temp_19_1~3376@ (Mul (Mul (Mul (Mul b19~156@ c19~158@) (Mul b19~156@ a19~154@)) (
                                                                                      Mul (Add b19~156@ b19~156@) (Sub c19~158@ d19~160@)
                                                                                     )
                                                                                    ) (Add (Mul (Mul c19~158@ c19~158@) (Mul c19~158@ b19~156@)) (Mul (Mul b19~156@ b19~156@)
                                                                                      (Mul 6 b19~156@)
