...
(push)
 ...
 (declare-const temp_14_0~2325@ Int)
 (declare-const temp_14_1~2378@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~451@ (Mul (Mul (Mul (Sub a1~10@ a1~10@) (Sub c1~14@ c1~14@)) (Mul a1~10@
             (Mul c1~14@ d1~16@)
            )
           ) (Mul (Mul (Sub c1~14@ d1~16@) (Mul b1~12@ c1~14@)) (Sub (Sub a1~10@ a1~10@) c1~14@))
         ))
         (=>
          (= temp_1_1~508@ (Mul (Mul (Mul (Sub a1~10@ a1~10@) (Sub c1~14@ c1~14@)) (Mul a1~10@
              (Mul c1~14@ d1~16@)
             )
          ...
          (and
           ...
           (=>
            (= temp_1_0~451@ temp_1_1~508@)
            (=>
             (= temp_2_0~593@ (Mul (Mul (Add (Mul b2~20@ d2~24@) (Sub d2~24@ d2~24@)) (Mul (Mul c2~22@
                  a2~18@
                 ) c2~22@
                )
             ...
             (=>
              (= temp_2_1~662@ (Mul (Mul (Add (Mul b2~20@ d2~24@) (Sub d2~24@ d2~24@)) (Mul (Mul c2~22@
                   a2~18@
                  ) c2~22@
                 )
              ...
              (and
               ...
               (=>
                (= temp_2_0~593@ temp_2_1~662@)
                (=>
                 (= temp_3_0~723@ (Mul (Mul (Add (Mul c3~30@ b3~28@) (Add a3~26@ b3~28@)) (Mul (Add b3~28@
                      d3~32@
                     ) (Mul a3~26@ c3~30@)
                    )
                   ) b3~28@
                 ...
                 (=>
                  (= temp_3_1~768@ (Mul (Mul (Add (Mul c3~30@ b3~28@) (Add a3~26@ b3~28@)) (Add (Mul b3~28@
                       (Mul a3~26@ c3~30@)
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~723@ temp_3_1~768@)
                    (=>
                     (= temp_4_0~861@ (Sub (Mul (Mul (Add d4~40@ d4~40@) b4~36@) (Sub b4~36@ (Mul 40 d4~40@)))
                       (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ a4~34@)) (Mul (Add b4~36@ b4~36@) (Add a4~34@
                          a4~34@
                     )))))
                     (=>
                      (= temp_4_1~930@ (Sub (Mul (Sub b4~36@ (Mul 40 d4~40@)) (Mul (Add d4~40@ d4~40@) b4~36@))
                        (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ a4~34@)) (Mul (Add b4~36@ b4~36@) (Add a4~34@
                           a4~34@
                      )))))
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~861@ temp_4_1~930@)
                       ))
                       (=>
                        (= temp_4_0~861@ temp_4_1~930@)
                        (=>
                         (= temp_5_0~1015@ (Mul (Mul (Sub (Mul a5~42@ d5~48@) (Mul d5~48@ b5~44@)) (Mul (Add b5~44@
                              b5~44@
                             ) (Add c5~46@ d5~48@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1076@ (Mul (Mul (Sub (Mul a5~42@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Add b5~44@
                               b5~44@
                              ) (Add c5~46@ d5~48@)
                             )
                            ) (Mul (Mul (Mul d5~48@ c5~46@) (Sub c5~46@ a5~42@)) (Mul (Mul b5~44@ c5~46@) a5~42@))
                          ...
                          (and
                           ...
                           (=>
                            (= temp_5_0~1015@ temp_5_1~1076@)
                            (=>
                             (= temp_6_0~1165@ (Mul (Add (Add (Mul d6~56@ c6~54@) (Mul b6~52@ c6~54@)) (Sub (Mul c6~54@
                                  d6~56@
                                 ) (Mul a6~50@ d6~56@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1230@ (Mul (Add (Add (Mul d6~56@ c6~54@) (Mul b6~52@ c6~54@)) (Sub (Mul c6~54@
                                   d6~56@
                                  ) (Mul a6~50@ d6~56@)
                                 )
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1165@ temp_6_1~1230@)
                               ))
                               (=>
                                (= temp_6_0~1165@ temp_6_1~1230@)
                                (=>
                                 (= temp_7_0~1319@ (Sub (Sub (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul c7~62@
                                      c7~62@
                                     ) (Mul d7~64@ b7~60@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1384@ (Sub (Sub (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul c7~62@
                                       c7~62@
                                      ) (Mul b7~60@ d7~64@)
                                     )
                                    ) (Mul (Sub (Sub d7~64@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul a7~58@
                                  ...
                                  (and
                                   ...
                                   (=>
                                    (= temp_7_0~1319@ temp_7_1~1384@)
                                    (=>
                                     (= temp_8_0~1469@ (Mul (Mul (Add (Mul a8~66@ d8~72@) (Sub d8~72@ d8~72@)) (Mul (Mul b8~68@
                                          a8~66@
                                         ) d8~72@
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1542@ (Mul (Add (Mul (Mul a8~66@ d8~72@) (Mul (Mul b8~68@ a8~66@) d8~72@))
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1469@ temp_8_1~1542@)
                                       ))
                                       (=>
                                        (= temp_8_0~1469@ temp_8_1~1542@)
                                        (=>
                                         (= temp_9_0~1619@ (Mul (Mul (Mul (Add c9~78@ c9~78@) (Mul b9~76@ d9~80@)) (Mul (Add d9~80@
                                              a9~74@
                                             ) (Mul c9~78@ b9~76@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1672@ (Mul (Mul (Mul (Add c9~78@ c9~78@) (Mul b9~76@ d9~80@)) (Mul (Mul c9~78@
                                               b9~76@
                                              ) (Add d9~80@ a9~74@)
                                             )
                                            ) (Mul (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@)) d9~80@)
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1619@ temp_9_1~1672@)
                                           ))
                                           (=>
                                            (= temp_9_0~1619@ temp_9_1~1672@)
                                            (=>
                                             (= temp_10_0~1745@ (Mul (Mul (Sub a10~82@ (Mul b10~84@ d10~88@)) (Mul (Sub b10~84@ c10~86@)
                                                 (Mul c10~86@ b10~84@)
                                                )
                                               ) (Add a10~82@ (Mul (Mul b10~84@ b10~84@) (Mul a10~82@ c10~86@)))
                                             ))
                                             (=>
                                              (= temp_10_1~1794@ (Mul (Mul (Sub a10~82@ (Mul b10~84@ d10~88@)) (Mul (Sub b10~84@ c10~86@)
                                                  (Mul b10~84@ c10~86@)
                                                 )
                                                ) (Add a10~82@ (Mul (Mul b10~84@ b10~84@) (Mul a10~82@ c10~86@)))
                                              ))
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1745@ temp_10_1~1794@)
                                               ))
                                               (=>
                                                (= temp_10_0~1745@ temp_10_1~1794@)
                                                (=>
                                                 (= temp_11_0~1883@ (Mul (Mul (Mul (Mul c11~94@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (
                                                      Mul b11~92@ c11~94@
                                                     ) (Mul a11~90@ a11~90@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~1948@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ d11~96@)) (Mul (
                                                       Mul b11~92@ c11~94@
                                                      ) (Mul a11~90@ a11~90@)
                                                     )
                                                    ) (Sub (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ c11~94@)) (Sub (Sub c11~94@ b11~92@)
                                                  ...
                                                  (and
                                                   ...
                                                   (=>
                                                    (= temp_11_0~1883@ temp_11_1~1948@)
                                                    (=>
                                                     (= temp_12_0~2037@ (Mul (Mul (Mul (Mul d12~104@ c12~102@) (Sub d12~104@ b12~100@)) (
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2110@ (Mul (Mul (Mul (Mul d12~104@ c12~102@) (Sub d12~104@ b12~100@)) (
                                                          Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@)
                                                         )
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2037@ temp_12_1~2110@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2037@ temp_12_1~2110@)
                                                        (=>
                                                         (= temp_13_0~2191@ (Sub (Sub (Add (Mul c13~110@ a13~106@) (Mul d13~112@ b13~108@)) (
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2248@ (Sub (Sub (Add (Mul c13~110@ a13~106@) (Mul d13~112@ b13~108@)) (
                                                              Mul c13~110@ (Sub c13~110@ c13~110@)
                                                             )
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2191@ temp_13_1~2248@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2191@ temp_13_1~2248@)
                                                            (=>
                                                             (= temp_14_0~2325@ (Mul (Mul (Mul (Mul a14~114@ b14~116@) (Mul b14~116@ b14~116@)) (
                                                                 Mul (Add a14~114@ b14~116@) (Mul a14~114@ d14~120@)
                                                                )
                                                               ) (Mul c14~118@ (Mul (Mul b14~116@ d14~120@) (Mul c14~118@ c14~118@)))
                                                             ))
                                                             (=>
                                                              (= temp_14_1~2378@ (Mul (Mul (Mul (Add a14~114@ b14~116@) (Mul a14~114@ d14~120@)) (
