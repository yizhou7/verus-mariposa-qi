...
(assert (=> %%query%% (not (=> (= temp_0_0~309@ (Add (Sub (Add (Mul d0~8@ 56) (Mul a0~2@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@))) (Mul (Add (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@)) (Mul d0~8@ a0~2@)))) (=> (= temp_0_1~378@ (Add (Sub (Add (Mul d0~8@ 56) (Mul a0~2@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@))) (Mul (Mul d0~8@ a0~2@) (Add (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~309@ temp_0_1~378@))) (=> (= temp_0_0~309@ temp_0_1~378@) (=> (= temp_1_0~479@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Sub a1~10@ b1~12@) (Mul a1~10@ 12))) (Add (Add (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Sub a1~10@ a1~10@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~556@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Sub a1~10@ b1~12@) (Mul a1~10@ 12))) (Add (Add (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Sub a1~10@ a1~10@) (Mul c1~14@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~479@ temp_1_1~556@))) (=> (= temp_1_0~479@ temp_1_1~556@) (=> (= temp_2_0~641@ (Add (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)) (Mul c2~22@ (Mul b2~20@ c2~22@))) (Mul (Sub (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@)) (Add (Sub a2~18@ c2~22@) (Sub c2~22@ b2~20@))))) (=> (= temp_2_1~702@ (Add (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)) (Mul c2~22@ (Mul b2~20@ c2~22@))) (Mul (Sub (Mul d2~24@ a2~18@) (Mul b2~20@ c2~22@)) (Add (Sub a2~18@ c2~22@) (Sub c2~22@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~641@ temp_2_1~702@))) (=> (= temp_2_0~641@ temp_2_1~702@) (=> (= temp_3_0~795@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ a3~26@)) (Mul (Sub c3~30@ a3~26@) (Mul 96 c3~30@))) (Mul (Mul d3~32@ (Mul d3~32@ d3~32@)) (Sub (Mul b3~28@ c3~30@) c3~30@)))) (=> (= temp_3_1~864@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ a3~26@)) (Mul (Mul 96 c3~30@) (Sub c3~30@ a3~26@))) (Mul (Mul d3~32@ (Mul d3~32@ d3~32@)) (Sub (Mul b3~28@ c3~30@) c3~30@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~795@ temp_3_1~864@))) (=> (= temp_3_0~795@ temp_3_1~864@) (=> (= temp_4_0~925@ (Mul c4~38@ (Mul (Mul (Sub b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~962@ (Mul c4~38@ (Mul (Mul (Mul (Sub b4~36@ d4~40@) d4~40@) c4~38@) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~925@ temp_4_1~962@))) (=> (= temp_4_0~925@ temp_4_1~962@) (=> (= temp_5_0~1047@ (Mul (Add (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ c5~46@)) (Mul b5~44@ (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1108@ (Mul (Add (Mul (Mul (Mul c5~46@ a5~42@) a5~42@) a5~42@) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ c5~46@)) (Mul b5~44@ (Mul c5~46@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1047@ temp_5_1~1108@))) (=> (= temp_5_0~1047@ temp_5_1~1108@) (=> (= temp_6_0~1197@ (Mul (Sub (Add (Mul c6~54@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Sub b6~52@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ d6~56@) (Sub a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1262@ (Mul (Sub (Add (Mul c6~54@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Sub b6~52@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Mul a6~50@ (Mul d6~56@ (Sub a6~50@ d6~56@))) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1197@ temp_6_1~1262@))) (=> (= temp_6_0~1197@ temp_6_1~1262@) (=> (= temp_7_0~1351@ (Mul (Mul (Mul (Add c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ b7~60@))) (Mul (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)) (Add (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@))))) (=> (= temp_7_1~1416@ (Mul (Mul (Mul (Mul (Add c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ b7~60@))) (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@))) (Add (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1351@ temp_7_1~1416@))) (=> (= temp_7_0~1351@ temp_7_1~1416@) (=> (= temp_8_0~1493@ (Mul (Add (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@)) d8~72@) (Mul a8~66@ (Mul (Mul a8~66@ c8~70@) (Add 38 b8~68@))))) (=> (= temp_8_1~1546@ (Mul (Add (Mul d8~72@ (Mul c8~70@ (Mul c8~70@ c8~70@))) d8~72@) (Mul a8~66@ (Mul (Mul a8~66@ c8~70@) (Add 38 b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1493@ temp_8_1~1546@))) (=> (= temp_8_0~1493@ temp_8_1~1546@) (=> (= temp_9_0~1631@ (Mul (Mul (Mul b9~76@ (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~1692@ (Mul (Mul (Mul b9~76@ (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ c9~78@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1631@ temp_9_1~1692@))) (=> (= temp_9_0~1631@ temp_9_1~1692@) (=> (= temp_10_0~1785@ (Mul (Mul (Mul a10~82@ (Sub a10~82@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@))) (Add (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@)) (Mul a10~82@ (Mul 41 b10~84@))))) (=> (= temp_10_1~1854@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@)) (Mul a10~82@ (Sub a10~82@ c10~86@))) (Add (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@)) (Mul a10~82@ (Mul 41 b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1785@ temp_10_1~1854@))) (=> (= temp_10_0~1785@ temp_10_1~1854@) (=> (= temp_11_0~1943@ (Mul (Mul (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2008@ (Mul (Mul (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1943@ temp_11_1~2008@))) (=> (= temp_11_0~1943@ temp_11_1~2008@) (=> (= temp_12_0~2109@ (Add (Mul (Sub (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ c12~102@))) (Mul (Mul (Add b12~100@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Mul a12~98@ 15) (Add c12~102@ d12~104@))))) (=> (= temp_12_1~2186@ (Add (Mul (Sub (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ c12~102@))) (Mul (Mul (Add b12~100@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Mul a12~98@ 15) (Add c12~102@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2109@ temp_12_1~2186@))) (=> (= temp_12_0~2109@ temp_12_1~2186@) (=> (= temp_13_0~2271@ (Mul (Mul (Mul (Mul c13~110@ b13~108@) a13~106@) (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ c13~110@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Add a13~106@ b13~108@))))) (=> (= temp_13_1~2332@ (Mul (Mul (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ c13~110@)) (Mul (Mul c13~110@ b13~108@) a13~106@)) (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Add a13~106@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2271@ temp_13_1~2332@))) (=> (= temp_13_0~2271@ temp_13_1~2332@) (=> (= temp_14_0~2409@ (Sub (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) a14~114@) (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2462@ (Sub (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) a14~114@) (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ b14~116@)) (Mul (Mul b14~116@ d14~120@) (Mul b14~116@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2409@ temp_14_1~2462@))) (=> (= temp_14_0~2409@ temp_14_1~2462@) (=> (= temp_15_0~2555@ (Mul (Mul (Mul (Mul c15~126@ 81) c15~126@) (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ d15~128@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul b15~124@ b15~124@) d15~128@)))) (=> (= temp_15_1~2624@ (Mul (Mul (Mul (Mul 81 c15~126@) c15~126@) (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ d15~128@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul b15~124@ b15~124@) d15~128@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2555@ temp_15_1~2624@))) (=> (= temp_15_0~2555@ temp_15_1~2624@) (=> (= temp_16_0~2725@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Add a16~130@ b16~132@)) (Sub (Mul a16~130@ d16~136@) (Mul d16~136@ c16~134@))) (Mul (Sub (Mul b16~132@ 70) (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ c16~134@))))) (=> (= temp_16_1~2802@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Add a16~130@ b16~132@)) (Sub (Mul a16~130@ d16~136@) (Mul d16~136@ c16~134@))) (Mul (Sub (Mul b16~132@ 70) (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2725@ temp_16_1~2802@))) (=> (= temp_16_0~2725@ temp_16_1~2802@) (=> (= temp_17_0~2903@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ d17~144@))) (Sub (Add (Mul 11 b17~140@) (Mul b17~140@ b17~140@)) (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ b17~140@))))) (=> (= temp_17_1~2980@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ d17~144@))) (Sub (Add (Mul 11 b17~140@) (Mul b17~140@ b17~140@)) (Mul (Mul d17~144@ b17~140@) (Mul b17~140@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2903@ temp_17_1~2980@))) (=> (= temp_17_0~2903@ temp_17_1~2980@) (=> (= temp_18_0~3069@ (Mul (Mul (Add (Mul b18~148@ c18~150@) (Mul b18~148@ b18~148@)) (Add (Mul c18~150@ b18~148@) (Mul b18~148@ d18~152@))) (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ a18~146@)) (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~3134@ (Mul (Mul (Add (Mul b18~148@ c18~150@) (Mul b18~148@ b18~148@)) (Add (Mul c18~150@ b18~148@) (Mul b18~148@ d18~152@))) (Mul (Mul b18~148@ (Mul d18~152@ (Mul d18~152@ a18~146@))) (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3069@ temp_18_1~3134@))) (=> (= temp_18_0~3069@ temp_18_1~3134@) (=> (= temp_19_0~3235@ (Mul (Mul (Mul (Mul b19~156@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ c19~158@) (Add 69 b19~156@))) (Mul (Mul (Mul b19~156@ a19~154@) (Mul d19~160@ b19~156@)) (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ a19~154@))))) (=> (= temp_19_1~3312@ (Mul (Mul (Mul (Mul b19~156@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ c19~158@) (Add 69 b19~156@))) (Mul (Mul b19~156@ a19~154@) (Mul (Mul d19~160@ b19~156@) (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ a19~154@)))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3235@ temp_19_1~3312@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
