...
(set-info :comment ";; mariposa_data/v_nl//16279850040026406244/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_5_1~1170@ Int)
...
(declare-const temp_8_1~1686@ Int)
(declare-const temp_9_0~1781@ Int)
(declare-const temp_9_1~1842@ Int)
...
(declare-const temp_13_0~2473@ Int)
(declare-const temp_13_1~2534@ Int)
(declare-const temp_14_0~2635@ Int)
...
(declare-const temp_17_0~3153@ Int)
(declare-const temp_17_1~3230@ Int)
(declare-const temp_18_0~3323@ Int)
(declare-const temp_18_1~3388@ Int)
(declare-const temp_19_0~3499@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~309@ (Add (Sub (Add (Mul d0~8@ 56) (Mul a0~2@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@))) (Mul (Add (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@)) (Mul d0~8@ a0~2@)))) (=> (= temp_0_1~378@ (Add (Sub (Add (Mul d0~8@ 56) (Mul a0~2@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@))) (Mul (Mul d0~8@ a0~2@) (Add (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@))))) (and (=> (= tmp%1@ (Add (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@))) (=> (= tmp%2@ (Mul d0~8@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~309@ temp_0_1~378@))))) (=> (= temp_0_0~309@ temp_0_1~378@) (=> (= temp_1_0~499@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Sub a1~10@ b1~12@) (Mul a1~10@ 12))) (Add (Add (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Sub a1~10@ a1~10@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~576@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Sub a1~10@ b1~12@) (Mul a1~10@ 12))) (Add (Add (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Sub a1~10@ a1~10@) (Mul c1~14@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ b1~12@) (=> %%location_label%%1 (= temp_1_0~499@ temp_1_1~576@))) (=> (= temp_1_0~499@ temp_1_1~576@) (=> (= temp_2_0~665@ (Add (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)) (Mul c2~22@ (Mul b2~20@ c2~22@))) (Mul (Sub (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@)) (Add (Sub a2~18@ c2~22@) (Sub c2~22@ b2~20@))))) (=> (= temp_2_1~726@ (Add (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)) (Mul c2~22@ (Mul b2~20@ c2~22@))) (Mul (Sub (Mul d2~24@ a2~18@) (Mul b2~20@ c2~22@)) (Add (Sub a2~18@ c2~22@) (Sub c2~22@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ d2~24@) (=> %%location_label%%2 (= temp_2_0~665@ temp_2_1~726@))) (=> (= temp_2_0~665@ temp_2_1~726@) (=> (= temp_3_0~823@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ a3~26@)) (Mul (Sub c3~30@ a3~26@) (Mul 96 c3~30@))) (Mul (Mul d3~32@ (Mul d3~32@ d3~32@)) (Sub (Mul b3~28@ c3~30@) c3~30@)))) (=> (= temp_3_1~892@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ a3~26@)) (Mul (Mul 96 c3~30@) (Sub c3~30@ a3~26@))) (Mul (Mul d3~32@ (Mul d3~32@ d3~32@)) (Sub (Mul b3~28@ c3~30@) c3~30@)))) (and (=> (= tmp%3@ (Sub c3~30@ a3~26@)) (=> (= tmp%4@ (Mul 96 c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~823@ temp_3_1~892@))))) (=> (= temp_3_0~823@ temp_3_1~892@) (=> (= temp_4_0~977@ (Mul c4~38@ (Mul (Mul (Sub b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~1014@ (Mul c4~38@ (Mul (Mul (Mul (Sub b4~36@ d4~40@) d4~40@) c4~38@) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@))))) (and (=> (= tmp%5@ (Sub b4~36@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ d4~40@ c4~38@) (=> %%location_label%%4 (= temp_4_0~977@ temp_4_1~1014@)))) (=> (= temp_4_0~977@ temp_4_1~1014@) (=> (= temp_5_0~1109@ (Mul (Add (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ c5~46@)) (Mul b5~44@ (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1170@ (Mul (Add (Mul (Mul (Mul c5~46@ a5~42@) a5~42@) a5~42@) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ c5~46@)) (Mul b5~44@ (Mul c5~46@ d5~48@))))) (and (=> (= tmp%6@ (Mul c5~46@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ a5~42@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1109@ temp_5_1~1170@)))) (=> (= temp_5_0~1109@ temp_5_1~1170@) (=> (= temp_6_0~1269@ (Mul (Sub (Add (Mul c6~54@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Sub b6~52@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ d6~56@) (Sub a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1334@ (Mul (Sub (Add (Mul c6~54@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Sub b6~52@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Mul a6~50@ (Mul d6~56@ (Sub a6~50@ d6~56@))) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@))))) (and (=> (= tmp%7@ (Sub a6~50@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a6~50@ d6~56@ tmp%7@) (=> %%location_label%%6 (= temp_6_0~1269@ temp_6_1~1334@)))) (=> (= temp_6_0~1269@ temp_6_1~1334@) (=> (= temp_7_0~1433@ (Mul (Mul (Mul (Add c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ b7~60@))) (Mul (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)) (Add (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@))))) (=> (= temp_7_1~1498@ (Mul (Mul (Mul (Mul (Add c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ b7~60@))) (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@))) (Add (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@)))) (and (=> (= tmp%8@ (Mul (Mul (Add c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ b7~60@)))) (=> (= tmp%9@ (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@))) (=> (= tmp%10@ (Add (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~1433@ temp_7_1~1498@)))))) (=> (= temp_7_0~1433@ temp_7_1~1498@) (=> (= temp_8_0~1633@ (Mul (Add (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@)) d8~72@) (Mul a8~66@ (Mul (Mul a8~66@ c8~70@) (Add 38 b8~68@))))) (=> (= temp_8_1~1686@ (Mul (Add (Mul d8~72@ (Mul c8~70@ (Mul c8~70@ c8~70@))) d8~72@) (Mul a8~66@ (Mul (Mul a8~66@ c8~70@) (Add 38 b8~68@))))) (and (=> (= tmp%11@ (Mul c8~70@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d8~72@ c8~70@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~1633@ temp_8_1~1686@)))) (=> (= temp_8_0~1633@ temp_8_1~1686@) (=> (= temp_9_0~1781@ (Mul (Mul (Mul b9~76@ (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~1842@ (Mul (Mul (Mul b9~76@ (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ c9~78@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ b9~76@))))) (and (=> (= tmp%12@ (Mul b9~76@ d9~80@)) (=> (= tmp%13@ (Mul c9~78@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%9 (= temp_9_0~1781@ temp_9_1~1842@))))) (=> (= temp_9_0~1781@ temp_9_1~1842@) (=> (= temp_10_0~1947@ (Mul (Mul (Mul a10~82@ (Sub a10~82@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@))) (Add (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@)) (Mul a10~82@ (Mul 41 b10~84@))))) (=> (= temp_10_1~2016@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@)) (Mul a10~82@ (Sub a10~82@ c10~86@))) (Add (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@)) (Mul a10~82@ (Mul 41 b10~84@))))) (and (=> (= tmp%14@ (Mul a10~82@ (Sub a10~82@ c10~86@))) (=> (= tmp%15@ (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%10 (= temp_10_0~1947@ temp_10_1~2016@))))) (=> (= temp_10_0~1947@ temp_10_1~2016@) (=> (= temp_11_0~2129@ (Mul (Mul (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2194@ (Mul (Mul (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@))))) (and (=> (= tmp%16@ (Mul c11~94@ d11~96@)) (=> (= tmp%17@ (Mul a11~90@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%11 (= temp_11_0~2129@ temp_11_1~2194@))))) (=> (= temp_11_0~2129@ temp_11_1~2194@) (=> (= temp_12_0~2307@ (Add (Mul (Sub (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ c12~102@))) (Mul (Mul (Add b12~100@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Mul a12~98@ 15) (Add c12~102@ d12~104@))))) (=> (= temp_12_1~2384@ (Add (Mul (Sub (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ c12~102@))) (Mul (Mul (Add b12~100@ d12~104@) (Mul c12~102@ d12~104@)) (Add (Mul a12~98@ 15) (Add c12~102@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ d12~104@) (=> %%location_label%%12 (= temp_12_0~2307@ temp_12_1~2384@))) (=> (= temp_12_0~2307@ temp_12_1~2384@) (=> (= temp_13_0~2473@ (Mul (Mul (Mul (Mul c13~110@ b13~108@) a13~106@) (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ c13~110@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Add a13~106@ b13~108@))))) (=> (= temp_13_1~2534@ (Mul (Mul (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ c13~110@)) (Mul (Mul c13~110@ b13~108@) a13~106@)) (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Add a13~106@ b13~108@))))) (and (=> (= tmp%18@ (Mul (Mul c13~110@ b13~108@) a13~106@)) (=> (= tmp%19@ (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ c13~110@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%13 (= temp_13_0~2473@ temp_13_1~2534@))))) (=> (= temp_13_0~2473@ temp_13_1~2534@) (=> (= temp_14_0~2635@ (Sub (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) a14~114@) (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2688@ (Sub (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) a14~114@) (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ b14~116@)) (Mul (Mul b14~116@ d14~120@) (Mul b14~116@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2635@ temp_14_1~2688@))) (=> (= temp_14_0~2635@ temp_14_1~2688@) (=> (= temp_15_0~2785@ (Mul (Mul (Mul (Mul c15~126@ 81) c15~126@) (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ d15~128@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul b15~124@ b15~124@) d15~128@)))) (=> (= temp_15_1~2854@ (Mul (Mul (Mul (Mul 81 c15~126@) c15~126@) (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ d15~128@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul b15~124@ b15~124@) d15~128@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c15~126@ 81) (=> %%location_label%%15 (= temp_15_0~2785@ temp_15_1~2854@))) (=> (= temp_15_0~2785@ temp_15_1~2854@) (=> (= temp_16_0~2971@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Add a16~130@ b16~132@)) (Sub (Mul a16~130@ d16~136@) (Mul d16~136@ c16~134@))) (Mul (Sub (Mul b16~132@ 70) (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ c16~134@))))) (=> (= temp_16_1~3048@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Add a16~130@ b16~132@)) (Sub (Mul a16~130@ d16~136@) (Mul d16~136@ c16~134@))) (Mul (Sub (Mul b16~132@ 70) (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b16~132@ d16~136@) (=> %%location_label%%16 (= temp_16_0~2971@ temp_16_1~3048@))) (=> (= temp_16_0~2971@ temp_16_1~3048@) (=> (= temp_17_0~3153@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ d17~144@))) (Sub (Add (Mul 11 b17~140@) (Mul b17~140@ b17~140@)) (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ b17~140@))))) (=> (= temp_17_1~3230@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ d17~144@))) (Sub (Add (Mul 11 b17~140@) (Mul b17~140@ b17~140@)) (Mul (Mul d17~144@ b17~140@) (Mul b17~140@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d17~144@ b17~140@) (=> %%location_label%%17 (= temp_17_0~3153@ temp_17_1~3230@))) (=> (= temp_17_0~3153@ temp_17_1~3230@) (=> (= temp_18_0~3323@ (Mul (Mul (Add (Mul b18~148@ c18~150@) (Mul b18~148@ b18~148@)) (Add (Mul c18~150@ b18~148@) (Mul b18~148@ d18~152@))) (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ a18~146@)) (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~3388@ (Mul (Mul (Add (Mul b18~148@ c18~150@) (Mul b18~148@ b18~148@)) (Add (Mul c18~150@ b18~148@) (Mul b18~148@ d18~152@))) (Mul (Mul b18~148@ (Mul d18~152@ (Mul d18~152@ a18~146@))) (Mul (Mul c18~150@ a18~146@) (Mul a18~146@ d18~152@))))) (and (=> (= tmp%20@ (Mul d18~152@ a18~146@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b18~148@ d18~152@ tmp%20@) (=> %%location_label%%18 (= temp_18_0~3323@ temp_18_1~3388@)))) (=> (= temp_18_0~3323@ temp_18_1~3388@) (=> (= temp_19_0~3499@ (Mul (Mul (Mul (Mul b19~156@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ c19~158@) (Add 69 b19~156@))) (Mul (Mul (Mul b19~156@ a19~154@) (Mul d19~160@ b19~156@)) (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ a19~154@))))) (=> (= temp_19_1~3576@ (Mul (Mul (Mul (Mul b19~156@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ c19~158@) (Add 69 b19~156@))) (Mul (Mul b19~156@ a19~154@) (Mul (Mul d19~160@ b19~156@) (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ a19~154@)))))) (=> (= tmp%21@ (Mul b19~156@ a19~154@)) (=> (= tmp%22@ (Mul d19~160@ b19~156@)) (=> (= tmp%23@ (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ a19~154@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%19 (= temp_19_0~3499@ temp_19_1~3576@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
