...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Add (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)) (Sub (Sub c0~6@ 51) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~394@ (Mul (Mul (Add (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)) (Sub (Sub c0~6@ 51) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~317@ temp_0_1~394@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~474@ (Mul (Mul (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Add d1~16@ b1~12@))) (Mul (Mul (Sub d1~16@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~539@ (Mul (Mul (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Add d1~16@ b1~12@))) (Mul (Mul (Sub d1~16@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~474@ temp_1_1~539@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~611@ (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Add b2~20@ b2~20@)) (Mul (Sub c2~22@ b2~20@) (Add d2~24@ d2~24@))) (Mul (Sub c2~22@ (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ d2~24@) b2~20@)))) (=> (= temp_2_1~668@ (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Add b2~20@ b2~20@)) (Mul (Sub c2~22@ b2~20@) (Add d2~24@ d2~24@))) (Mul (Sub c2~22@ (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ d2~24@) b2~20@)))) (=> (= tmp%3@ (= temp_2_0~611@ temp_2_1~668@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~744@ (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ d3~32@) c3~30@)))) (=> (= temp_3_1~805@ (Mul (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@)) (Mul c3~30@ a3~26@)) (Mul b3~28@ c3~30@)) (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ d3~32@) c3~30@)))) (=> (= tmp%4@ (= temp_3_0~744@ temp_3_1~805@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~889@ (Mul (Mul (Mul (Mul d4~40@ d4~40@) d4~40@) (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ b4~36@)) (Add 81 (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~974@ (Mul (Mul (Mul (Mul d4~40@ d4~40@) d4~40@) (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@))) (Add (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ b4~36@)) 81) (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ b4~36@)) (Mul b4~36@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~889@ temp_4_1~974@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1046@ (Mul (Mul (Sub (Sub d5~48@ d5~48@) c5~46@) (Mul (Mul c5~46@ b5~44@) (Add a5~42@ a5~42@))) (Mul (Add (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@)) (Mul (Mul c5~46@ d5~48@) a5~42@)))) (=> (= temp_5_1~1103@ (Mul (Mul (Sub (Sub d5~48@ d5~48@) c5~46@) (Mul (Mul c5~46@ b5~44@) (Add a5~42@ a5~42@))) (Mul (Add (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ d5~48@) a5~42@)))) (=> (= tmp%6@ (= temp_5_0~1046@ temp_5_1~1103@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1183@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@)) (Add (Sub c6~54@ a6~50@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@)) (Add (Mul d6~56@ a6~50@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1248@ (Mul (Mul (Mul a6~50@ a6~50@) (Mul (Mul b6~52@ d6~56@) (Add (Sub c6~54@ a6~50@) (Mul d6~56@ c6~54@)))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@)) (Add (Mul d6~56@ a6~50@) (Mul c6~54@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1183@ temp_6_1~1248@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1324@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@))) (Add (Mul (Sub d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Mul b7~60@ (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1385@ (Mul (Mul (Mul (Mul (Mul b7~60@ b7~60@) a7~58@) b7~60@) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@))) (Add (Mul (Sub d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Mul b7~60@ (Mul d7~64@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1324@ temp_7_1~1385@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1461@ (Mul (Sub (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@))) (Sub (Mul (Mul d8~72@ b8~68@) (Sub c8~70@ d8~72@)) (Sub d8~72@ (Add d8~72@ c8~70@))))) (=> (= temp_8_1~1554@ (Sub (Mul (Sub (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@))) (Mul (Mul d8~72@ b8~68@) (Sub c8~70@ d8~72@))) (Mul (Sub (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@))) (Sub d8~72@ (Add d8~72@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1461@ temp_8_1~1554@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1630@ (Sub (Add (Mul (Mul d9~80@ d9~80@) c9~78@) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ d9~80@))) (Mul (Mul (Add a9~74@ a9~74@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Add d9~80@ a9~74@))))) (=> (= temp_9_1~1691@ (Sub (Add (Mul (Mul d9~80@ d9~80@) c9~78@) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ d9~80@))) (Mul (Mul (Add a9~74@ a9~74@) (Mul a9~74@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Add d9~80@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1630@ temp_9_1~1691@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1767@ (Mul (Mul (Mul a10~82@ (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ c10~86@))) (Sub (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@)) (Mul (Add b10~84@ b10~84@) (Mul c10~86@ c10~86@))))) (=> (= temp_10_1~1828@ (Mul (Mul (Mul a10~82@ (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ c10~86@))) (Sub (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@)) (Mul (Add b10~84@ b10~84@) (Mul c10~86@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1767@ temp_10_1~1828@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1904@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) a11~90@) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Sub c11~94@ a11~90@) (Mul a11~90@ d11~96@)) (Mul (Mul d11~96@ d11~96@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~1965@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) a11~90@) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Sub c11~94@ a11~90@) (Mul (Mul a11~90@ d11~96@) (Mul (Mul d11~96@ d11~96@) (Mul b11~92@ a11~90@)))))) (=> (= tmp%12@ (= temp_11_0~1904@ temp_11_1~1965@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2033@ (Mul (Sub (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ c12~102@)) a12~98@) (Mul (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ b12~100@)) (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ b12~100@))))) (=> (= temp_12_1~2086@ (Mul (Mul (Sub (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ c12~102@)) a12~98@) (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ b12~100@))) (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ b12~100@)))) (=> (= tmp%13@ (= temp_12_0~2033@ temp_12_1~2086@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2154@ (Mul (Add (Mul b13~108@ (Mul b13~108@ a13~106@)) (Sub (Mul d13~112@ c13~110@) d13~112@)) (Mul (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@)) (Mul a13~106@ (Sub d13~112@ d13~112@))))) (=> (= temp_13_1~2235@ (Add (Mul (Mul b13~108@ (Mul b13~108@ a13~106@)) (Mul (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@)) (Mul a13~106@ (Sub d13~112@ d13~112@)))) (Mul (Sub (Mul d13~112@ c13~110@) d13~112@) (Mul (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@)) (Mul a13~106@ (Sub d13~112@ d13~112@)))))) (=> (= tmp%14@ (= temp_13_0~2154@ temp_13_1~2235@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2315@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ a14~114@)) (Add (Add c14~118@ c14~118@) (Mul a14~114@ b14~116@))) (Mul (Mul (Mul b14~116@ c14~118@) (Add c14~118@ d14~120@)) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@))))) (=> (= temp_14_1~2380@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ a14~114@)) (Add (Add c14~118@ c14~118@) (Mul a14~114@ b14~116@))) (Mul (Mul b14~116@ c14~118@) (Mul (Add c14~118@ d14~120@) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@)))))) (=> (= tmp%15@ (= temp_14_0~2315@ temp_14_1~2380@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2456@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Sub b15~124@ b15~124@)) (Mul (Add 40 d15~128@) (Mul c15~126@ b15~124@))) (Mul b15~124@ (Mul b15~124@ (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~2517@ (Mul (Mul (Mul b15~124@ (Mul b15~124@ (Sub b15~124@ b15~124@))) (Mul (Add 40 d15~128@) (Mul c15~126@ b15~124@))) (Mul b15~124@ (Mul b15~124@ (Mul c15~126@ a15~122@))))) (=> (= tmp%16@ (= temp_15_0~2456@ temp_15_1~2517@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2569@ (Mul (Mul (Sub (Sub c16~134@ b16~132@) (Mul b16~132@ a16~130@)) (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ c16~134@))) b16~132@)) (=> (= temp_16_1~2606@ (Mul (Mul (Sub (Sub c16~134@ b16~132@) (Mul b16~132@ a16~130@)) (Mul (Mul b16~132@ c16~134@) (Mul c16~134@ b16~132@))) b16~132@)) (=> (= tmp%17@ (= temp_16_0~2569@ temp_16_1~2606@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2694@ (Mul (Add (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ b17~140@)) (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul 77 c17~142@) b17~140@) (Add (Mul b17~140@ d17~144@) (Sub b17~140@ a17~138@))))) (=> (= temp_17_1~2767@ (Mul (Mul (Add (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ b17~140@)) (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ b17~140@))) (Mul (Mul 77 c17~142@) b17~140@)) (Add (Mul b17~140@ d17~144@) (Sub b17~140@ a17~138@)))) (=> (= tmp%18@ (= temp_17_0~2694@ temp_17_1~2767@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2819@ (Sub (Mul (Mul (Mul b18~148@ d18~152@) (Mul b18~148@ d18~152@)) (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ b18~148@))) d18~152@)) (=> (= temp_18_1~2856@ (Sub (Mul (Mul (Mul d18~152@ b18~148@) (Mul b18~148@ d18~152@)) (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ b18~148@))) d18~152@)) (=> (= tmp%19@ (= temp_18_0~2819@ temp_18_1~2856@)) (=> %%location_label%%18 tmp%19@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
