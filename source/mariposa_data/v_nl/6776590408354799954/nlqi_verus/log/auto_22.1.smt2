...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Sub (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@)) (Sub (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Sub c0~6@ d0~8@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Sub (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@)) (Sub (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Sub c0~6@ d0~8@) (Mul b0~4@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~431@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul c1~14@ d1~16@))) c1~14@)) (=> (= temp_1_1~468@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul c1~14@ d1~16@))) c1~14@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~431@ temp_1_1~468@))) (=> (= temp_1_0~431@ temp_1_1~468@) (=> (= temp_2_0~569@ (Add (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul 68 c2~22@))) (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Sub c2~22@ c2~22@))))) (=> (= temp_2_1~646@ (Add (Mul (Mul (Mul c2~22@ a2~18@) (Mul 68 c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Sub c2~22@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~569@ temp_2_1~646@))) (=> (= temp_2_0~569@ temp_2_1~646@) (=> (= temp_3_0~735@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Sub a3~26@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ c3~30@))) (Mul (Add (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~800@ (Mul (Mul (Add (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul a3~26@ d3~32@) (Sub a3~26@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~735@ temp_3_1~800@))) (=> (= temp_3_0~735@ temp_3_1~800@) (=> (= temp_4_0~897@ (Mul (Sub (Add (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ d4~40@) c4~38@)) (Add (Mul (Sub c4~38@ d4~40@) (Add d4~40@ c4~38@)) (Mul (Add b4~36@ d4~40@) (Sub 7 b4~36@))))) (=> (= temp_4_1~970@ (Mul (Add (Mul (Sub c4~38@ d4~40@) (Add d4~40@ c4~38@)) (Mul (Add b4~36@ d4~40@) (Sub 7 b4~36@))) (Sub (Add (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ d4~40@) c4~38@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~897@ temp_4_1~970@))) (=> (= temp_4_0~897@ temp_4_1~970@) (=> (= temp_5_0~1031@ (Mul (Mul (Add (Mul b5~44@ c5~46@) (Sub d5~48@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ d5~48@))) a5~42@)) (=> (= temp_5_1~1068@ (Mul (Mul (Mul (Add (Mul b5~44@ c5~46@) (Sub d5~48@ b5~44@)) (Mul b5~44@ a5~42@)) (Mul a5~42@ d5~48@)) a5~42@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1031@ temp_5_1~1068@))) (=> (= temp_5_0~1031@ temp_5_1~1068@) (=> (= temp_6_0~1157@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) (Add (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add a6~50@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1222@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) (Add (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add a6~50@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1157@ temp_6_1~1222@))) (=> (= temp_6_0~1157@ temp_6_1~1222@) (=> (= temp_7_0~1319@ (Mul (Mul (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)) (Add (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@))) (Mul (Mul a7~58@ (Sub 59 d7~64@)) (Mul (Sub d7~64@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1392@ (Mul (Mul (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)) (Add (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@))) (Mul (Mul a7~58@ (Sub 59 d7~64@)) (Mul (Mul (Sub d7~64@ a7~58@) a7~58@) a7~58@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1319@ temp_7_1~1392@))) (=> (= temp_7_0~1319@ temp_7_1~1392@) (=> (= temp_8_0~1457@ (Mul (Mul d8~72@ (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@))) (Mul a8~66@ (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1498@ (Mul (Mul (Mul d8~72@ (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@))) a8~66@) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ a8~66@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1457@ temp_8_1~1498@))) (=> (= temp_8_0~1457@ temp_8_1~1498@) (=> (= temp_9_0~1535@ (Mul c9~78@ (Mul b9~76@ c9~78@))) (=> (= temp_9_1~1548@ (Mul (Mul b9~76@ c9~78@) c9~78@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1535@ temp_9_1~1548@))) (=> (= temp_9_0~1535@ temp_9_1~1548@) (=> (= temp_10_0~1625@ (Sub (Mul (Mul (Mul d10~88@ a10~82@) (Add b10~84@ d10~88@)) a10~82@) (Mul (Sub (Mul b10~84@ c10~86@) (Mul b10~84@ b10~84@)) (Sub (Mul a10~82@ b10~84@) (Mul d10~88@ a10~82@))))) (=> (= temp_10_1~1678@ (Sub (Mul (Mul (Add b10~84@ d10~88@) (Mul d10~88@ a10~82@)) a10~82@) (Mul (Sub (Mul b10~84@ c10~86@) (Mul b10~84@ b10~84@)) (Sub (Mul a10~82@ b10~84@) (Mul d10~88@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1625@ temp_10_1~1678@))) (=> (= temp_10_0~1625@ temp_10_1~1678@) (=> (= temp_11_0~1767@ (Mul (Mul (Mul (Sub b11~92@ b11~92@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ b11~92@))) (Add (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@))))) (=> (= temp_11_1~1832@ (Mul (Mul (Mul (Sub b11~92@ b11~92@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ b11~92@))) (Add (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ a11~90@)) (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1767@ temp_11_1~1832@))) (=> (= temp_11_0~1767@ temp_11_1~1832@) (=> (= temp_12_0~1933@ (Add (Mul (Mul (Add c12~102@ d12~104@) (Mul c12~102@ b12~100@)) (Mul (Mul d12~104@ d12~104@) (Mul d12~104@ b12~100@))) (Sub (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@)) (Add (Mul d12~104@ d12~104@) (Mul 62 b12~100@))))) (=> (= temp_12_1~2010@ (Add (Mul (Mul (Mul (Add c12~102@ d12~104@) (Mul c12~102@ b12~100@)) (Mul d12~104@ d12~104@)) (Mul d12~104@ b12~100@)) (Sub (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@)) (Add (Mul d12~104@ d12~104@) (Mul 62 b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~1933@ temp_12_1~2010@))) (=> (= temp_12_0~1933@ temp_12_1~2010@) (=> (= temp_13_0~2111@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Mul d13~112@ a13~106@)) (Mul (Sub d13~112@ 89) (Mul a13~106@ a13~106@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2188@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Mul d13~112@ a13~106@)) (Mul (Sub d13~112@ 89) (Mul a13~106@ a13~106@))) (Mul (Mul b13~108@ b13~108@) (Mul (Mul d13~112@ d13~112@) (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ b13~108@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2111@ temp_13_1~2188@))) (=> (= temp_13_0~2111@ temp_13_1~2188@) (=> (= temp_14_0~2285@ (Mul (Mul (Mul (Mul c14~118@ c14~118@) (Sub c14~118@ b14~116@)) (Mul (Mul c14~118@ d14~120@) (Add d14~120@ a14~114@))) (Mul (Mul (Mul b14~116@ b14~116@) 52) (Mul (Add c14~118@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2358@ (Mul (Mul (Mul c14~118@ c14~118@) (Sub c14~118@ b14~116@)) (Mul (Mul (Mul c14~118@ d14~120@) (Add d14~120@ a14~114@)) (Mul (Mul (Mul b14~116@ b14~116@) 52) (Mul (Add c14~118@ b14~116@) (Mul b14~116@ c14~118@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2285@ temp_14_1~2358@))) (=> (= temp_14_0~2285@ temp_14_1~2358@) (=> (= temp_15_0~2451@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Mul b15~124@ b15~124@)) (Sub (Mul 2 27) 49)) d15~128@)) (=> (= temp_15_1~2520@ (Mul (Mul (Mul d15~128@ d15~128@) (Mul b15~124@ b15~124@)) (Mul (Sub (Mul 2 27) 49) d15~128@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2451@ temp_15_1~2520@))) (=> (= temp_15_0~2451@ temp_15_1~2520@) (=> (= temp_16_0~2609@ (Add (Mul (Mul (Mul a16~130@ a16~130@) (Mul b16~132@ c16~134@)) (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ c16~134@))) (Mul (Mul (Mul c16~134@ d16~136@) (Add c16~134@ c16~134@)) (Mul (Add a16~130@ d16~136@) (Mul b16~132@ d16~136@))))) (=> (= temp_16_1~2674@ (Add (Mul (Mul (Mul a16~130@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ c16~134@))) (Mul (Mul (Mul c16~134@ d16~136@) (Add c16~134@ c16~134@)) (Mul (Add a16~130@ d16~136@) (Mul b16~132@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2609@ temp_16_1~2674@))) (=> (= temp_16_0~2609@ temp_16_1~2674@) (=> (= temp_17_0~2755@ (Mul (Mul (Mul (Sub a17~138@ c17~142@) b17~140@) (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul a17~138@ c17~142@) c17~142@)))) (=> (= temp_17_1~2812@ (Mul (Mul (Mul (Sub a17~138@ c17~142@) b17~140@) (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul c17~142@ a17~138@) c17~142@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2755@ temp_17_1~2812@))) (=> (= temp_17_0~2755@ temp_17_1~2812@) (=> (= temp_18_0~2909@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ 21)) (Mul (Sub b18~148@ b18~148@) (Mul c18~150@ b18~148@))) (Mul (Mul b18~148@ (Mul c18~150@ d18~152@)) (Sub (Mul b18~148@ c18~150@) (Add d18~152@ d18~152@))))) (=> (= temp_18_1~2982@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ 21)) (Mul (Mul (Sub b18~148@ b18~148@) c18~150@) b18~148@)) (Mul (Mul b18~148@ (Mul c18~150@ d18~152@)) (Sub (Mul b18~148@ c18~150@) (Add d18~152@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2909@ temp_18_1~2982@))) (=> (= temp_18_0~2909@ temp_18_1~2982@) (=> (= temp_19_0~3063@ (Mul (Sub (Add (Mul b19~156@ a19~154@) (Mul c19~158@ b19~156@)) (Sub (Mul d19~160@ a19~154@) (Mul b19~156@ d19~160@))) (Add (Add (Mul b19~156@ c19~158@) c19~158@) (Mul (Mul d19~160@ a19~154@) a19~154@)))) (=> (= temp_19_1~3120@ (Mul (Sub (Add (Mul a19~154@ b19~156@) (Mul c19~158@ b19~156@)) (Sub (Mul d19~160@ a19~154@) (Mul b19~156@ d19~160@))) (Add (Add (Mul b19~156@ c19~158@) c19~158@) (Mul (Mul d19~160@ a19~154@) a19~154@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3063@ temp_19_1~3120@))) (=> (= temp_19_0~3063@ temp_19_1~3120@) (=> (= temp_20_0~3221@ (Mul (Mul (Mul (Add b20~164@ 3) (Mul b20~164@ a20~162@)) (Mul (Add b20~164@ c20~166@) (Sub b20~164@ a20~162@))) (Mul (Mul (Add a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Add (Mul a20~162@ c20~166@) (Mul a20~162@ d20~168@))))) (=> (= temp_20_1~3306@ (Mul (Mul (Mul (Add b20~164@ 3) (Mul b20~164@ a20~162@)) (Add (Mul b20~164@ (Sub b20~164@ a20~162@)) (Mul c20~166@ (Sub b20~164@ a20~162@)))) (Mul (Mul (Add a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Add (Mul a20~162@ c20~166@) (Mul a20~162@ d20~168@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3221@ temp_20_1~3306@))) (=> (= temp_20_0~3221@ temp_20_1~3306@) (=> (= temp_21_0~3403@ (Sub (Mul (Add (Mul b21~172@ a21~170@) (Mul c21~174@ d21~176@)) (Mul (Mul d21~176@ d21~176@) (Mul 89 b21~172@))) (Mul (Add (Mul c21~174@ b21~172@) (Mul d21~176@ c21~174@)) (Mul b21~172@ (Mul d21~176@ b21~172@))))) (=> (= temp_21_1~3476@ (Sub (Mul (Add (Mul b21~172@ a21~170@) (Mul c21~174@ d21~176@)) (Mul (Mul d21~176@ d21~176@) (Mul b21~172@ 89))) (Mul (Add (Mul c21~174@ b21~172@) (Mul d21~176@ c21~174@)) (Mul b21~172@ (Mul d21~176@ b21~172@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3403@ temp_21_1~3476@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
