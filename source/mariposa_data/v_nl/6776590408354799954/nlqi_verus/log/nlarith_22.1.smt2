...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Sub (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@)) (Sub (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Sub c0~6@ d0~8@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Sub (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@)) (Sub (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Sub c0~6@ d0~8@) (Mul b0~4@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~422@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul c1~14@ d1~16@))) c1~14@)) (=> (= temp_1_1~459@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul c1~14@ d1~16@))) c1~14@)) (=> (= tmp%2@ (= temp_1_0~422@ temp_1_1~459@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~551@ (Add (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul 68 c2~22@))) (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Sub c2~22@ c2~22@))))) (=> (= temp_2_1~628@ (Add (Mul (Mul (Mul c2~22@ a2~18@) (Mul 68 c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Sub c2~22@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~551@ temp_2_1~628@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~708@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Sub a3~26@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ c3~30@))) (Mul (Add (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~773@ (Mul (Mul (Add (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul a3~26@ d3~32@) (Sub a3~26@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~708@ temp_3_1~773@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~861@ (Mul (Sub (Add (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ d4~40@) c4~38@)) (Add (Mul (Sub c4~38@ d4~40@) (Add d4~40@ c4~38@)) (Mul (Add b4~36@ d4~40@) (Sub 7 b4~36@))))) (=> (= temp_4_1~934@ (Mul (Add (Mul (Sub c4~38@ d4~40@) (Add d4~40@ c4~38@)) (Mul (Add b4~36@ d4~40@) (Sub 7 b4~36@))) (Sub (Add (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ d4~40@) c4~38@)))) (=> (= tmp%5@ (= temp_4_0~861@ temp_4_1~934@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~986@ (Mul (Mul (Add (Mul b5~44@ c5~46@) (Sub d5~48@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ d5~48@))) a5~42@)) (=> (= temp_5_1~1023@ (Mul (Mul (Mul (Add (Mul b5~44@ c5~46@) (Sub d5~48@ b5~44@)) (Mul b5~44@ a5~42@)) (Mul a5~42@ d5~48@)) a5~42@)) (=> (= tmp%6@ (= temp_5_0~986@ temp_5_1~1023@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1103@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) (Add (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add a6~50@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1168@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) (Add (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add a6~50@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1103@ temp_6_1~1168@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1256@ (Mul (Mul (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)) (Add (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@))) (Mul (Mul a7~58@ (Sub 59 d7~64@)) (Mul (Sub d7~64@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1329@ (Mul (Mul (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)) (Add (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@))) (Mul (Mul a7~58@ (Sub 59 d7~64@)) (Mul (Mul (Sub d7~64@ a7~58@) a7~58@) a7~58@)))) (=> (= tmp%8@ (= temp_7_0~1256@ temp_7_1~1329@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1385@ (Mul (Mul d8~72@ (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@))) (Mul a8~66@ (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1426@ (Mul (Mul (Mul d8~72@ (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@))) a8~66@) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ a8~66@)))) (=> (= tmp%9@ (= temp_8_0~1385@ temp_8_1~1426@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1454@ (Mul c9~78@ (Mul b9~76@ c9~78@))) (=> (= temp_9_1~1467@ (Mul (Mul b9~76@ c9~78@) c9~78@)) (=> (= tmp%10@ (= temp_9_0~1454@ temp_9_1~1467@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1535@ (Sub (Mul (Mul (Mul d10~88@ a10~82@) (Add b10~84@ d10~88@)) a10~82@) (Mul (Sub (Mul b10~84@ c10~86@) (Mul b10~84@ b10~84@)) (Sub (Mul a10~82@ b10~84@) (Mul d10~88@ a10~82@))))) (=> (= temp_10_1~1588@ (Sub (Mul (Mul (Add b10~84@ d10~88@) (Mul d10~88@ a10~82@)) a10~82@) (Mul (Sub (Mul b10~84@ c10~86@) (Mul b10~84@ b10~84@)) (Sub (Mul a10~82@ b10~84@) (Mul d10~88@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1535@ temp_10_1~1588@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1668@ (Mul (Mul (Mul (Sub b11~92@ b11~92@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ b11~92@))) (Add (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@))))) (=> (= temp_11_1~1733@ (Mul (Mul (Mul (Sub b11~92@ b11~92@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ b11~92@))) (Add (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ a11~90@)) (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1668@ temp_11_1~1733@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1825@ (Add (Mul (Mul (Add c12~102@ d12~104@) (Mul c12~102@ b12~100@)) (Mul (Mul d12~104@ d12~104@) (Mul d12~104@ b12~100@))) (Sub (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@)) (Add (Mul d12~104@ d12~104@) (Mul 62 b12~100@))))) (=> (= temp_12_1~1902@ (Add (Mul (Mul (Mul (Add c12~102@ d12~104@) (Mul c12~102@ b12~100@)) (Mul d12~104@ d12~104@)) (Mul d12~104@ b12~100@)) (Sub (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@)) (Add (Mul d12~104@ d12~104@) (Mul 62 b12~100@))))) (=> (= tmp%13@ (= temp_12_0~1825@ temp_12_1~1902@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~1994@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Mul d13~112@ a13~106@)) (Mul (Sub d13~112@ 89) (Mul a13~106@ a13~106@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2071@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Mul d13~112@ a13~106@)) (Mul (Sub d13~112@ 89) (Mul a13~106@ a13~106@))) (Mul (Mul b13~108@ b13~108@) (Mul (Mul d13~112@ d13~112@) (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ b13~108@)))))) (=> (= tmp%14@ (= temp_13_0~1994@ temp_13_1~2071@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2159@ (Mul (Mul (Mul (Mul c14~118@ c14~118@) (Sub c14~118@ b14~116@)) (Mul (Mul c14~118@ d14~120@) (Add d14~120@ a14~114@))) (Mul (Mul (Mul b14~116@ b14~116@) 52) (Mul (Add c14~118@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2232@ (Mul (Mul (Mul c14~118@ c14~118@) (Sub c14~118@ b14~116@)) (Mul (Mul (Mul c14~118@ d14~120@) (Add d14~120@ a14~114@)) (Mul (Mul (Mul b14~116@ b14~116@) 52) (Mul (Add c14~118@ b14~116@) (Mul b14~116@ c14~118@)))))) (=> (= tmp%15@ (= temp_14_0~2159@ temp_14_1~2232@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2316@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Mul b15~124@ b15~124@)) (Sub (Mul 2 27) 49)) d15~128@)) (=> (= temp_15_1~2385@ (Mul (Mul (Mul d15~128@ d15~128@) (Mul b15~124@ b15~124@)) (Mul (Sub (Mul 2 27) 49) d15~128@))) (=> (= tmp%16@ (= temp_15_0~2316@ temp_15_1~2385@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2465@ (Add (Mul (Mul (Mul a16~130@ a16~130@) (Mul b16~132@ c16~134@)) (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ c16~134@))) (Mul (Mul (Mul c16~134@ d16~136@) (Add c16~134@ c16~134@)) (Mul (Add a16~130@ d16~136@) (Mul b16~132@ d16~136@))))) (=> (= temp_16_1~2530@ (Add (Mul (Mul (Mul a16~130@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ c16~134@))) (Mul (Mul (Mul c16~134@ d16~136@) (Add c16~134@ c16~134@)) (Mul (Add a16~130@ d16~136@) (Mul b16~132@ d16~136@))))) (=> (= tmp%17@ (= temp_16_0~2465@ temp_16_1~2530@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2602@ (Mul (Mul (Mul (Sub a17~138@ c17~142@) b17~140@) (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul a17~138@ c17~142@) c17~142@)))) (=> (= temp_17_1~2659@ (Mul (Mul (Mul (Sub a17~138@ c17~142@) b17~140@) (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul c17~142@ a17~138@) c17~142@)))) (=> (= tmp%18@ (= temp_17_0~2602@ temp_17_1~2659@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2747@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ 21)) (Mul (Sub b18~148@ b18~148@) (Mul c18~150@ b18~148@))) (Mul (Mul b18~148@ (Mul c18~150@ d18~152@)) (Sub (Mul b18~148@ c18~150@) (Add d18~152@ d18~152@))))) (=> (= temp_18_1~2820@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ 21)) (Mul (Mul (Sub b18~148@ b18~148@) c18~150@) b18~148@)) (Mul (Mul b18~148@ (Mul c18~150@ d18~152@)) (Sub (Mul b18~148@ c18~150@) (Add d18~152@ d18~152@))))) (=> (= tmp%19@ (= temp_18_0~2747@ temp_18_1~2820@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2892@ (Mul (Sub (Add (Mul b19~156@ a19~154@) (Mul c19~158@ b19~156@)) (Sub (Mul d19~160@ a19~154@) (Mul b19~156@ d19~160@))) (Add (Add (Mul b19~156@ c19~158@) c19~158@) (Mul (Mul d19~160@ a19~154@) a19~154@)))) (=> (= temp_19_1~2949@ (Mul (Sub (Add (Mul a19~154@ b19~156@) (Mul c19~158@ b19~156@)) (Sub (Mul d19~160@ a19~154@) (Mul b19~156@ d19~160@))) (Add (Add (Mul b19~156@ c19~158@) c19~158@) (Mul (Mul d19~160@ a19~154@) a19~154@)))) (=> (= tmp%20@ (= temp_19_0~2892@ temp_19_1~2949@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3041@ (Mul (Mul (Mul (Add b20~164@ 3) (Mul b20~164@ a20~162@)) (Mul (Add b20~164@ c20~166@) (Sub b20~164@ a20~162@))) (Mul (Mul (Add a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Add (Mul a20~162@ c20~166@) (Mul a20~162@ d20~168@))))) (=> (= temp_20_1~3126@ (Mul (Mul (Mul (Add b20~164@ 3) (Mul b20~164@ a20~162@)) (Add (Mul b20~164@ (Sub b20~164@ a20~162@)) (Mul c20~166@ (Sub b20~164@ a20~162@)))) (Mul (Mul (Add a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Add (Mul a20~162@ c20~166@) (Mul a20~162@ d20~168@))))) (=> (= tmp%21@ (= temp_20_0~3041@ temp_20_1~3126@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3214@ (Sub (Mul (Add (Mul b21~172@ a21~170@) (Mul c21~174@ d21~176@)) (Mul (Mul d21~176@ d21~176@) (Mul 89 b21~172@))) (Mul (Add (Mul c21~174@ b21~172@) (Mul d21~176@ c21~174@)) (Mul b21~172@ (Mul d21~176@ b21~172@))))) (=> (= temp_21_1~3287@ (Sub (Mul (Add (Mul b21~172@ a21~170@) (Mul c21~174@ d21~176@)) (Mul (Mul d21~176@ d21~176@) (Mul b21~172@ 89))) (Mul (Add (Mul c21~174@ b21~172@) (Mul d21~176@ c21~174@)) (Mul b21~172@ (Mul d21~176@ b21~172@))))) (=> (= tmp%22@ (= temp_21_0~3214@ temp_21_1~3287@)) (=> %%location_label%%21 tmp%22@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
