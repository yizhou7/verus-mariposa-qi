...
(set-info :comment ";; mariposa_data/v_nl//6776590408354799954/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_19_0~3543@ Int)
(declare-const temp_19_1~3600@ Int)
(declare-const temp_20_0~3705@ Int)
(declare-const temp_20_1~3790@ Int)
(declare-const temp_21_0~3897@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Sub (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@)) (Sub (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Sub c0~6@ d0~8@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Sub (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@)) (Sub (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Sub c0~6@ d0~8@) (Mul b0~4@ d0~8@))))) (and (=> (= tmp%1@ (Mul a0~2@ a0~2@)) (=> (= tmp%2@ (Mul a0~2@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~443@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul c1~14@ d1~16@))) c1~14@)) (=> (= temp_1_1~480@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul c1~14@ d1~16@))) c1~14@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ b1~12@) (=> %%location_label%%1 (= temp_1_0~443@ temp_1_1~480@))) (=> (= temp_1_0~443@ temp_1_1~480@) (=> (= temp_2_0~585@ (Add (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul 68 c2~22@))) (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Sub c2~22@ c2~22@))))) (=> (= temp_2_1~662@ (Add (Mul (Mul (Mul c2~22@ a2~18@) (Mul 68 c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Sub c2~22@ c2~22@))))) (and (=> (= tmp%3@ (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@))) (=> (= tmp%4@ (Mul (Mul c2~22@ a2~18@) (Mul 68 c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~585@ temp_2_1~662@))))) (=> (= temp_2_0~585@ temp_2_1~662@) (=> (= temp_3_0~791@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Sub a3~26@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ c3~30@))) (Mul (Add (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~856@ (Mul (Mul (Add (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul a3~26@ d3~32@) (Sub a3~26@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ c3~30@))))) (and (=> (= tmp%5@ (Mul (Mul (Mul a3~26@ d3~32@) (Sub a3~26@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ c3~30@)))) (=> (= tmp%6@ (Mul (Add (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~791@ temp_3_1~856@))))) (=> (= temp_3_0~791@ temp_3_1~856@) (=> (= temp_4_0~1013@ (Mul (Sub (Add (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ d4~40@) c4~38@)) (Add (Mul (Sub c4~38@ d4~40@) (Add d4~40@ c4~38@)) (Mul (Add b4~36@ d4~40@) (Sub 7 b4~36@))))) (=> (= temp_4_1~1086@ (Mul (Add (Mul (Sub c4~38@ d4~40@) (Add d4~40@ c4~38@)) (Mul (Add b4~36@ d4~40@) (Sub 7 b4~36@))) (Sub (Add (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ d4~40@) c4~38@)))) (and (=> (= tmp%7@ (Sub (Add (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ d4~40@) c4~38@))) (=> (= tmp%8@ (Add (Mul (Sub c4~38@ d4~40@) (Add d4~40@ c4~38@)) (Mul (Add b4~36@ d4~40@) (Sub 7 b4~36@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~1013@ temp_4_1~1086@))))) (=> (= temp_4_0~1013@ temp_4_1~1086@) (=> (= temp_5_0~1215@ (Mul (Mul (Add (Mul b5~44@ c5~46@) (Sub d5~48@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ d5~48@))) a5~42@)) (=> (= temp_5_1~1252@ (Mul (Mul (Mul (Add (Mul b5~44@ c5~46@) (Sub d5~48@ b5~44@)) (Mul b5~44@ a5~42@)) (Mul a5~42@ d5~48@)) a5~42@)) (and (=> (= tmp%9@ (Add (Mul b5~44@ c5~46@) (Sub d5~48@ b5~44@))) (=> (= tmp%10@ (Mul b5~44@ a5~42@)) (=> (= tmp%11@ (Mul a5~42@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%5 (= temp_5_0~1215@ temp_5_1~1252@)))))) (=> (= temp_5_0~1215@ temp_5_1~1252@) (=> (= temp_6_0~1367@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) (Add (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add a6~50@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1432@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) (Add (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add a6~50@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1367@ temp_6_1~1432@))) (=> (= temp_6_0~1367@ temp_6_1~1432@) (=> (= temp_7_0~1533@ (Mul (Mul (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)) (Add (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@))) (Mul (Mul a7~58@ (Sub 59 d7~64@)) (Mul (Sub d7~64@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1606@ (Mul (Mul (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)) (Add (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@))) (Mul (Mul a7~58@ (Sub 59 d7~64@)) (Mul (Mul (Sub d7~64@ a7~58@) a7~58@) a7~58@)))) (and (=> (= tmp%12@ (Sub d7~64@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ a7~58@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1533@ temp_7_1~1606@)))) (=> (= temp_7_0~1533@ temp_7_1~1606@) (=> (= temp_8_0~1681@ (Mul (Mul d8~72@ (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@))) (Mul a8~66@ (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1722@ (Mul (Mul (Mul d8~72@ (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@))) a8~66@) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ a8~66@)))) (and (=> (= tmp%13@ (Mul d8~72@ (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@)))) (=> (= tmp%14@ (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ a8~66@ tmp%14@) (=> %%location_label%%8 (= temp_8_0~1681@ temp_8_1~1722@))))) (=> (= temp_8_0~1681@ temp_8_1~1722@) (=> (= temp_9_0~1793@ (Mul c9~78@ (Mul b9~76@ c9~78@))) (=> (= temp_9_1~1806@ (Mul (Mul b9~76@ c9~78@) c9~78@)) (and (=> (= tmp%15@ (Mul b9~76@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c9~78@ tmp%15@) (=> %%location_label%%9 (= temp_9_0~1793@ temp_9_1~1806@)))) (=> (= temp_9_0~1793@ temp_9_1~1806@) (=> (= temp_10_0~1891@ (Sub (Mul (Mul (Mul d10~88@ a10~82@) (Add b10~84@ d10~88@)) a10~82@) (Mul (Sub (Mul b10~84@ c10~86@) (Mul b10~84@ b10~84@)) (Sub (Mul a10~82@ b10~84@) (Mul d10~88@ a10~82@))))) (=> (= temp_10_1~1944@ (Sub (Mul (Mul (Add b10~84@ d10~88@) (Mul d10~88@ a10~82@)) a10~82@) (Mul (Sub (Mul b10~84@ c10~86@) (Mul b10~84@ b10~84@)) (Sub (Mul a10~82@ b10~84@) (Mul d10~88@ a10~82@))))) (and (=> (= tmp%16@ (Mul d10~88@ a10~82@)) (=> (= tmp%17@ (Add b10~84@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%10 (= temp_10_0~1891@ temp_10_1~1944@))))) (=> (= temp_10_0~1891@ temp_10_1~1944@) (=> (= temp_11_0~2045@ (Mul (Mul (Mul (Sub b11~92@ b11~92@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ b11~92@))) (Add (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@))))) (=> (= temp_11_1~2110@ (Mul (Mul (Mul (Sub b11~92@ b11~92@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ b11~92@))) (Add (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ a11~90@)) (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a11~90@ c11~94@) (=> %%location_label%%11 (= temp_11_0~2045@ temp_11_1~2110@))) (=> (= temp_11_0~2045@ temp_11_1~2110@) (=> (= temp_12_0~2215@ (Add (Mul (Mul (Add c12~102@ d12~104@) (Mul c12~102@ b12~100@)) (Mul (Mul d12~104@ d12~104@) (Mul d12~104@ b12~100@))) (Sub (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@)) (Add (Mul d12~104@ d12~104@) (Mul 62 b12~100@))))) (=> (= temp_12_1~2292@ (Add (Mul (Mul (Mul (Add c12~102@ d12~104@) (Mul c12~102@ b12~100@)) (Mul d12~104@ d12~104@)) (Mul d12~104@ b12~100@)) (Sub (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@)) (Add (Mul d12~104@ d12~104@) (Mul 62 b12~100@))))) (and (=> (= tmp%18@ (Mul (Add c12~102@ d12~104@) (Mul c12~102@ b12~100@))) (=> (= tmp%19@ (Mul d12~104@ d12~104@)) (=> (= tmp%20@ (Mul d12~104@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%12 (= temp_12_0~2215@ temp_12_1~2292@)))))) (=> (= temp_12_0~2215@ temp_12_1~2292@) (=> (= temp_13_0~2419@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Mul d13~112@ a13~106@)) (Mul (Sub d13~112@ 89) (Mul a13~106@ a13~106@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2496@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Mul d13~112@ a13~106@)) (Mul (Sub d13~112@ 89) (Mul a13~106@ a13~106@))) (Mul (Mul b13~108@ b13~108@) (Mul (Mul d13~112@ d13~112@) (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ b13~108@)))))) (and (=> (= tmp%21@ (Mul b13~108@ b13~108@)) (=> (= tmp%22@ (Mul d13~112@ d13~112@)) (=> (= tmp%23@ (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ b13~108@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%13 (= temp_13_0~2419@ temp_13_1~2496@)))))) (=> (= temp_13_0~2419@ temp_13_1~2496@) (=> (= temp_14_0~2619@ (Mul (Mul (Mul (Mul c14~118@ c14~118@) (Sub c14~118@ b14~116@)) (Mul (Mul c14~118@ d14~120@) (Add d14~120@ a14~114@))) (Mul (Mul (Mul b14~116@ b14~116@) 52) (Mul (Add c14~118@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2692@ (Mul (Mul (Mul c14~118@ c14~118@) (Sub c14~118@ b14~116@)) (Mul (Mul (Mul c14~118@ d14~120@) (Add d14~120@ a14~114@)) (Mul (Mul (Mul b14~116@ b14~116@) 52) (Mul (Add c14~118@ b14~116@) (Mul b14~116@ c14~118@)))))) (and (=> (= tmp%24@ (Mul (Mul c14~118@ c14~118@) (Sub c14~118@ b14~116@))) (=> (= tmp%25@ (Mul (Mul c14~118@ d14~120@) (Add d14~120@ a14~114@))) (=> (= tmp%26@ (Mul (Mul (Mul b14~116@ b14~116@) 52) (Mul (Add c14~118@ b14~116@) (Mul b14~116@ c14~118@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%14 (= temp_14_0~2619@ temp_14_1~2692@)))))) (=> (= temp_14_0~2619@ temp_14_1~2692@) (=> (= temp_15_0~2851@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Mul b15~124@ b15~124@)) (Sub (Mul 2 27) 49)) d15~128@)) (=> (= temp_15_1~2920@ (Mul (Mul (Mul d15~128@ d15~128@) (Mul b15~124@ b15~124@)) (Mul (Sub (Mul 2 27) 49) d15~128@))) (and (=> (= tmp%27@ (Mul (Mul d15~128@ d15~128@) (Mul b15~124@ b15~124@))) (=> (= tmp%28@ (Sub (Mul 2 27) 49)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ tmp%28@ d15~128@) (=> %%location_label%%15 (= temp_15_0~2851@ temp_15_1~2920@))))) (=> (= temp_15_0~2851@ temp_15_1~2920@) (=> (= temp_16_0~3071@ (Add (Mul (Mul (Mul a16~130@ a16~130@) (Mul b16~132@ c16~134@)) (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ c16~134@))) (Mul (Mul (Mul c16~134@ d16~136@) (Add c16~134@ c16~134@)) (Mul (Add a16~130@ d16~136@) (Mul b16~132@ d16~136@))))) (=> (= temp_16_1~3136@ (Add (Mul (Mul (Mul a16~130@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ c16~134@))) (Mul (Mul (Mul c16~134@ d16~136@) (Add c16~134@ c16~134@)) (Mul (Add a16~130@ d16~136@) (Mul b16~132@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b16~132@ c16~134@) (=> %%location_label%%16 (= temp_16_0~3071@ temp_16_1~3136@))) (=> (= temp_16_0~3071@ temp_16_1~3136@) (=> (= temp_17_0~3221@ (Mul (Mul (Mul (Sub a17~138@ c17~142@) b17~140@) (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul a17~138@ c17~142@) c17~142@)))) (=> (= temp_17_1~3278@ (Mul (Mul (Mul (Sub a17~138@ c17~142@) b17~140@) (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul c17~142@ a17~138@) c17~142@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a17~138@ c17~142@) (=> %%location_label%%17 (= temp_17_0~3221@ temp_17_1~3278@))) (=> (= temp_17_0~3221@ temp_17_1~3278@) (=> (= temp_18_0~3379@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ 21)) (Mul (Sub b18~148@ b18~148@) (Mul c18~150@ b18~148@))) (Mul (Mul b18~148@ (Mul c18~150@ d18~152@)) (Sub (Mul b18~148@ c18~150@) (Add d18~152@ d18~152@))))) (=> (= temp_18_1~3452@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ 21)) (Mul (Mul (Sub b18~148@ b18~148@) c18~150@) b18~148@)) (Mul (Mul b18~148@ (Mul c18~150@ d18~152@)) (Sub (Mul b18~148@ c18~150@) (Add d18~152@ d18~152@))))) (and (=> (= tmp%29@ (Sub b18~148@ b18~148@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ c18~150@ b18~148@) (=> %%location_label%%18 (= temp_18_0~3379@ temp_18_1~3452@)))) (=> (= temp_18_0~3379@ temp_18_1~3452@) (=> (= temp_19_0~3543@ (Mul (Sub (Add (Mul b19~156@ a19~154@) (Mul c19~158@ b19~156@)) (Sub (Mul d19~160@ a19~154@) (Mul b19~156@ d19~160@))) (Add (Add (Mul b19~156@ c19~158@) c19~158@) (Mul (Mul d19~160@ a19~154@) a19~154@)))) (=> (= temp_19_1~3600@ (Mul (Sub (Add (Mul a19~154@ b19~156@) (Mul c19~158@ b19~156@)) (Sub (Mul d19~160@ a19~154@) (Mul b19~156@ d19~160@))) (Add (Add (Mul b19~156@ c19~158@) c19~158@) (Mul (Mul d19~160@ a19~154@) a19~154@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b19~156@ a19~154@) (=> %%location_label%%19 (= temp_19_0~3543@ temp_19_1~3600@))) (=> (= temp_19_0~3543@ temp_19_1~3600@) (=> (= temp_20_0~3705@ (Mul (Mul (Mul (Add b20~164@ 3) (Mul b20~164@ a20~162@)) (Mul (Add b20~164@ c20~166@) (Sub b20~164@ a20~162@))) (Mul (Mul (Add a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Add (Mul a20~162@ c20~166@) (Mul a20~162@ d20~168@))))) (=> (= temp_20_1~3790@ (Mul (Mul (Mul (Add b20~164@ 3) (Mul b20~164@ a20~162@)) (Add (Mul b20~164@ (Sub b20~164@ a20~162@)) (Mul c20~166@ (Sub b20~164@ a20~162@)))) (Mul (Mul (Add a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Add (Mul a20~162@ c20~166@) (Mul a20~162@ d20~168@))))) (and (=> (= tmp%30@ (Sub b20~164@ a20~162@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b20~164@ c20~166@ tmp%30@) (=> %%location_label%%20 (= temp_20_0~3705@ temp_20_1~3790@)))) (=> (= temp_20_0~3705@ temp_20_1~3790@) (=> (= temp_21_0~3897@ (Sub (Mul (Add (Mul b21~172@ a21~170@) (Mul c21~174@ d21~176@)) (Mul (Mul d21~176@ d21~176@) (Mul 89 b21~172@))) (Mul (Add (Mul c21~174@ b21~172@) (Mul d21~176@ c21~174@)) (Mul b21~172@ (Mul d21~176@ b21~172@))))) (=> (= temp_21_1~3970@ (Sub (Mul (Add (Mul b21~172@ a21~170@) (Mul c21~174@ d21~176@)) (Mul (Mul d21~176@ d21~176@) (Mul b21~172@ 89))) (Mul (Add (Mul c21~174@ b21~172@) (Mul d21~176@ c21~174@)) (Mul b21~172@ (Mul d21~176@ b21~172@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. 89 b21~172@) (=> %%location_label%%21 (= temp_21_0~3897@ temp_21_1~3970@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
