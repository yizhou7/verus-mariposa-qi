...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Add (Sub (Mul d0~8@ (Add a0~2@ d0~8@)) (Sub (Mul a0~2@ b0~4@) (Mul b0~4@ b0~4@))) (Add (Add (Mul d0~8@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Add c0~6@ c0~6@) (Sub b0~4@ a0~2@))))) (=> (= temp_0_1~366@ (Add (Sub (Add (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@)) (Sub (Mul a0~2@ b0~4@) (Mul b0~4@ b0~4@))) (Add (Add (Mul d0~8@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Add c0~6@ c0~6@) (Sub b0~4@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~366@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~446@ (Mul (Mul (Mul (Sub a1~10@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ c1~14@))) (Add (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ c1~14@))))) (=> (= temp_1_1~519@ (Mul (Mul (Sub (Mul a1~10@ (Mul b1~12@ a1~10@)) (Mul c1~14@ (Mul b1~12@ a1~10@))) (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ c1~14@))) (Add (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~446@ temp_1_1~519@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~587@ (Mul (Mul d2~24@ (Sub (Mul c2~22@ c2~22@) (Mul c2~22@ d2~24@))) (Mul (Add (Sub c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Sub (Mul b2~20@ d2~24@) (Add a2~18@ c2~22@))))) (=> (= temp_2_1~640@ (Mul (Mul (Sub (Mul c2~22@ c2~22@) (Mul c2~22@ d2~24@)) d2~24@) (Mul (Add (Sub c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Sub (Mul b2~20@ d2~24@) (Add a2~18@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~587@ temp_2_1~640@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~744@ (Sub (Mul (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ 18) (Mul d3~32@ a3~26@))) (Mul (Add (Add b3~28@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ 96))))) (=> (= temp_3_1~833@ (Sub (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@)) (Mul a3~26@ 18)) (Mul d3~32@ a3~26@)) (Mul (Add (Add b3~28@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ 96))))) (=> (= tmp%4@ (= temp_3_0~744@ temp_3_1~833@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~897@ (Mul (Add (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ c4~38@)) (Mul c4~38@ (Add b4~36@ b4~36@))) (Mul c4~38@ (Sub (Add d4~40@ b4~36@) (Add c4~38@ a4~34@))))) (=> (= temp_4_1~950@ (Mul (Add (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ c4~38@)) (Mul c4~38@ (Add b4~36@ b4~36@))) (Sub (Mul c4~38@ (Add d4~40@ b4~36@)) (Mul c4~38@ (Add c4~38@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~897@ temp_4_1~950@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1030@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@))) (Mul (Sub (Mul c5~46@ a5~42@) (Add d5~48@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1095@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Sub (Mul c5~46@ a5~42@) (Add d5~48@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~1030@ temp_5_1~1095@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1175@ (Mul (Sub (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul c6~54@ a6~50@) (Sub d6~56@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Sub b6~52@ a6~50@))))) (=> (= temp_6_1~1240@ (Mul (Sub (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul c6~54@ a6~50@) (Sub d6~56@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Sub b6~52@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~1175@ temp_6_1~1240@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1332@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ d7~64@)) (Sub (Mul 18 c7~62@) (Mul a7~58@ b7~60@))) (Sub (Mul (Sub b7~60@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Sub b7~60@ a7~58@))))) (=> (= temp_7_1~1409@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ d7~64@)) (Sub (Mul 18 c7~62@) (Mul b7~60@ a7~58@))) (Sub (Mul (Sub b7~60@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Sub b7~60@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1332@ temp_7_1~1409@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1473@ (Add (Mul b8~68@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) (Sub b8~68@ b8~68@)) (Mul (Mul c8~70@ a8~66@) d8~72@)))) (=> (= temp_8_1~1522@ (Add (Mul b8~68@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) (Sub b8~68@ b8~68@)) (Mul c8~70@ (Mul a8~66@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1473@ temp_8_1~1522@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1614@ (Add (Mul (Mul (Add b9~76@ 37) (Add b9~76@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Add d9~80@ a9~74@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ a9~74@)) (Mul (Sub a9~74@ a9~74@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~1691@ (Add (Mul (Add b9~76@ 37) (Mul (Add b9~76@ d9~80@) (Mul (Mul a9~74@ c9~78@) (Add d9~80@ a9~74@)))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ a9~74@)) (Mul (Sub a9~74@ a9~74@) (Mul b9~76@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1614@ temp_9_1~1691@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1775@ (Mul (Mul (Mul (Mul a10~82@ 31) d10~88@) (Mul (Mul c10~86@ d10~88@) (Mul b10~84@ b10~84@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ b10~84@) d10~88@)))) (=> (= temp_10_1~1844@ (Mul (Mul (Mul a10~82@ (Mul 31 d10~88@)) (Mul (Mul c10~86@ d10~88@) (Mul b10~84@ b10~84@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ b10~84@) d10~88@)))) (=> (= tmp%11@ (= temp_10_0~1775@ temp_10_1~1844@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1924@ (Mul (Mul (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul c11~94@ d11~96@) (Mul c11~94@ a11~90@))) (Mul (Add (Mul b11~92@ a11~90@) (Mul b11~92@ d11~96@)) (Mul (Mul d11~96@ c11~94@) (Add a11~90@ a11~90@))))) (=> (= temp_11_1~2005@ (Mul (Mul (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul c11~94@ d11~96@) (Mul c11~94@ a11~90@))) (Add (Mul (Mul b11~92@ a11~90@) (Mul (Mul d11~96@ c11~94@) (Add a11~90@ a11~90@))) (Mul (Mul b11~92@ d11~96@) (Mul (Mul d11~96@ c11~94@) (Add a11~90@ a11~90@)))))) (=> (= tmp%12@ (= temp_11_0~1924@ temp_11_1~2005@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2085@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ c12~102@)) (Mul (Sub d12~104@ b12~100@) (Mul a12~98@ d12~104@))) (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ d12~104@)) (Add (Mul a12~98@ d12~104@) (Add d12~104@ d12~104@))))) (=> (= temp_12_1~2150@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ c12~102@)) (Mul (Sub d12~104@ b12~100@) (Mul d12~104@ a12~98@))) (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ d12~104@)) (Add (Mul a12~98@ d12~104@) (Add d12~104@ d12~104@))))) (=> (= tmp%13@ (= temp_12_0~2085@ temp_12_1~2150@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2230@ (Sub (Mul (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@)) (Mul (Mul b13~108@ a13~106@) (Mul b13~108@ d13~112@))) (Mul (Add (Mul c13~110@ b13~108@) (Mul a13~106@ c13~110@)) (Sub (Mul d13~112@ d13~112@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2295@ (Sub (Mul (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@)) (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ a13~106@))) (Mul (Add (Mul c13~110@ b13~108@) (Mul a13~106@ c13~110@)) (Sub (Mul d13~112@ d13~112@) (Mul d13~112@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2230@ temp_13_1~2295@)) (=> %%location_label%%13 tmp%14@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
