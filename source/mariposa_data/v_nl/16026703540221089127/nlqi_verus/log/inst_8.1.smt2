...
(set-info :comment ";; mariposa_data/v_nl//16026703540221089127/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul (Mul (Mul c0~6@ (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@))) (Sub (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ b0~4@)))) (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Sub b0~4@ a0~2@) c0~6@)) (Mul (Mul (Sub d0~8@ d0~8@) (Mul d0~8@ c0~6@)) (Mul (Add 84 c0~6@) (Mul d0~8@ c0~6@)))))) (=> (= temp_0_1~426@ (Mul (Mul (Mul (Mul c0~6@ (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@))) (Sub (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ b0~4@)))) (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Sub b0~4@ a0~2@) c0~6@)) (Mul (Mul (Sub d0~8@ d0~8@) (Mul d0~8@ c0~6@)) (Mul (Add 84 c0~6@) (Mul d0~8@ c0~6@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ a0~2@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~426@))) (=> (= temp_0_0~293@ temp_0_1~426@) (=> (= temp_1_0~591@ (Mul (Mul (Mul c1~14@ (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ d1~16@))) (Mul (Mul a1~10@ (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul 20 52)))) (Sub (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Add a1~10@ d1~16@) (Mul a1~10@ d1~16@))) (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Add a1~10@ d1~16@) (Mul b1~12@ d1~16@)))))) (=> (= temp_1_1~728@ (Mul (Mul (Mul c1~14@ (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ d1~16@))) (Mul (Mul a1~10@ (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul 20 52)))) (Sub (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Add a1~10@ d1~16@) (Mul a1~10@ d1~16@))) (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ d1~16@)) (Mul (Add a1~10@ d1~16@) (Mul b1~12@ d1~16@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ c1~14@) (=> %%location_label%%1 (= temp_1_0~591@ temp_1_1~728@))) (=> (= temp_1_0~591@ temp_1_1~728@) (=> (= temp_2_0~885@ (Mul (Mul (Mul (Mul (Sub a2~18@ b2~20@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ c2~22@))) (Mul (Add (Mul d2~24@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Add c2~22@ a2~18@)))) (Mul (Add (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Sub b2~20@ d2~24@) (Sub d2~24@ a2~18@))) (Mul (Mul (Add a2~18@ a2~18@) (Mul c2~22@ b2~20@)) (Sub (Mul b2~20@ a2~18@) (Mul d2~24@ a2~18@)))))) (=> (= temp_2_1~1014@ (Mul (Mul (Mul (Mul (Sub a2~18@ b2~20@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ c2~22@))) (Mul (Add (Mul d2~24@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Add c2~22@ a2~18@)))) (Mul (Add (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Sub b2~20@ d2~24@) (Sub d2~24@ a2~18@))) (Mul (Mul (Add a2~18@ a2~18@) (Mul c2~22@ b2~20@)) (Sub (Mul b2~20@ a2~18@) (Mul d2~24@ a2~18@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ a2~18@) (=> %%location_label%%2 (= temp_2_0~885@ temp_2_1~1014@))) (=> (= temp_2_0~885@ temp_2_1~1014@) (=> (= temp_3_0~1163@ (Mul (Sub a3~26@ (Mul (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ 4)))) (Add (Mul (Mul b3~28@ (Sub a3~26@ a3~26@)) (Mul (Mul b3~28@ d3~32@) (Sub c3~30@ a3~26@))) (Mul (Sub (Mul c3~30@ d3~32@) (Mul a3~26@ 63)) (Sub (Mul a3~26@ a3~26@) (Mul c3~30@ b3~28@)))))) (=> (= temp_3_1~1284@ (Mul (Sub a3~26@ (Mul (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ 4)))) (Add (Mul (Mul b3~28@ (Sub a3~26@ a3~26@)) (Mul b3~28@ (Mul d3~32@ (Sub c3~30@ a3~26@)))) (Mul (Sub (Mul c3~30@ d3~32@) (Mul a3~26@ 63)) (Sub (Mul a3~26@ a3~26@) (Mul c3~30@ b3~28@)))))) (and (=> (= tmp%1@ (Sub c3~30@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b3~28@ d3~32@ tmp%1@) (=> %%location_label%%3 (= temp_3_0~1163@ temp_3_1~1284@)))) (=> (= temp_3_0~1163@ temp_3_1~1284@) (=> (= temp_4_0~1447@ (Sub (Sub (Mul (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ d4~40@)) (Mul d4~40@ (Sub b4~36@ c4~38@))) (Mul (Mul b4~36@ (Mul c4~38@ c4~38@)) (Add (Mul b4~36@ b4~36@) (Mul 14 b4~36@)))) (Sub (Mul (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ c4~38@))) (Mul (Add (Mul d4~40@ a4~34@) a4~34@) (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ c4~38@)))))) (=> (= temp_4_1~1576@ (Sub (Sub (Mul (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ d4~40@)) (Mul d4~40@ (Sub b4~36@ c4~38@))) (Mul (Mul b4~36@ (Mul c4~38@ c4~38@)) (Add (Mul b4~36@ b4~36@) (Mul 14 b4~36@)))) (Sub (Mul (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Add (Mul d4~40@ a4~34@) a4~34@) (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ c4~38@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1447@ temp_4_1~1576@))) (=> (= temp_4_0~1447@ temp_4_1~1576@) (=> (= temp_5_0~1721@ (Mul (Mul (Sub (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ a5~42@)) c5~46@) (Sub (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@)))) (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ b5~44@)) (Add (Add a5~42@ b5~44@) (Mul a5~42@ d5~48@)))))) (=> (= temp_5_1~1838@ (Mul (Mul (Sub (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ a5~42@)) c5~46@) (Sub (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@)))) (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ d5~48@)) (Add (Add a5~42@ b5~44@) (Mul a5~42@ d5~48@)))))) (and (=> (= tmp%2@ (Mul a5~42@ d5~48@)) (=> (= tmp%3@ (Mul d5~48@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%5 (= temp_5_0~1721@ temp_5_1~1838@))))) (=> (= temp_5_0~1721@ temp_5_1~1838@) (=> (= temp_6_0~1999@ (Add (Mul (Mul (Mul b6~52@ (Mul c6~54@ c6~54@)) (Sub (Mul a6~50@ b6~52@) (Mul c6~54@ a6~50@))) (Add (Sub (Mul c6~54@ d6~56@) (Sub d6~56@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)))) (Mul (Mul (Mul (Add a6~50@ d6~56@) (Mul a6~50@ d6~56@)) (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ c6~54@))) (Mul (Mul (Sub c6~54@ b6~52@) (Sub c6~54@ c6~54@)) (Mul (Mul a6~50@ b6~52@) (Add c6~54@ b6~52@)))))) (=> (= temp_6_1~2124@ (Add (Mul (Mul (Mul b6~52@ (Mul c6~54@ c6~54@)) (Sub (Mul a6~50@ b6~52@) (Mul c6~54@ a6~50@))) (Add (Sub (Mul c6~54@ d6~56@) (Sub d6~56@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)))) (Mul (Mul (Mul (Add a6~50@ d6~56@) (Mul a6~50@ d6~56@)) (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ c6~54@))) (Mul (Mul (Sub c6~54@ b6~52@) (Sub c6~54@ c6~54@)) (Mul (Mul a6~50@ b6~52@) (Add c6~54@ b6~52@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1999@ temp_6_1~2124@))) (=> (= temp_6_0~1999@ temp_6_1~2124@) (=> (= temp_7_0~2269@ (Sub (Mul (Add (Mul (Mul a7~58@ a7~58@) (Sub a7~58@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@))) (Mul (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)) (Mul (Sub c7~62@ b7~60@) (Mul b7~60@ b7~60@)))) (Mul (Sub (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@))) (Mul (Mul (Sub d7~64@ b7~60@) (Sub a7~58@ d7~64@)) a7~58@)))) (=> (= temp_7_1~2386@ (Sub (Mul (Add (Mul a7~58@ (Mul a7~58@ (Sub a7~58@ c7~62@))) (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@))) (Mul (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)) (Mul (Sub c7~62@ b7~60@) (Mul b7~60@ b7~60@)))) (Mul (Sub (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@))) (Mul (Mul (Sub d7~64@ b7~60@) (Sub a7~58@ d7~64@)) a7~58@)))) (=> (= tmp%4@ (Sub a7~58@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a7~58@ a7~58@ tmp%4@) (=> %%location_label%%7 (= temp_7_0~2269@ temp_7_1~2386@)))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
