...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul 87 b0~4@))) (Sub (Mul (Add a0~2@ 21) (Mul d0~8@ a0~2@)) d0~8@))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Mul 87 b0~4@))) (Sub (Mul (Add a0~2@ 21) (Mul d0~8@ a0~2@)) d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~471@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) a1~10@) (Mul (Add d1~16@ b1~12@) c1~14@)) (Mul (Mul (Mul d1~16@ a1~10@) c1~14@) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~528@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) a1~10@) (Add (Mul d1~16@ c1~14@) (Mul b1~12@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) c1~14@) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~471@ temp_1_1~528@))) (=> (= temp_1_0~471@ temp_1_1~528@) (=> (= temp_2_0~617@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ b2~20@))))) (=> (= temp_2_1~682@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~617@ temp_2_1~682@))) (=> (= temp_2_0~617@ temp_2_1~682@) (=> (= temp_3_0~755@ (Mul (Mul b3~28@ (Mul (Mul c3~30@ c3~30@) a3~26@)) (Sub (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Add d3~32@ d3~32@))))) (=> (= temp_3_1~804@ (Mul (Mul b3~28@ (Mul (Mul c3~30@ c3~30@) a3~26@)) (Sub (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ c3~30@) (Add d3~32@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~755@ temp_3_1~804@))) (=> (= temp_3_0~755@ temp_3_1~804@) (=> (= temp_4_0~893@ (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Add a4~34@ d4~40@)) (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ b4~36@))) (Sub (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ a4~34@)) (Sub (Mul b4~36@ d4~40@) (Sub c4~38@ a4~34@))))) (=> (= temp_4_1~958@ (Mul (Mul (Mul a4~34@ a4~34@) (Add a4~34@ d4~40@)) (Mul (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Sub (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ a4~34@)) (Sub (Mul b4~36@ d4~40@) (Sub c4~38@ a4~34@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~893@ temp_4_1~958@))) (=> (= temp_4_0~893@ temp_4_1~958@) (=> (= temp_5_0~1047@ (Mul (Sub (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))) (Mul (Add (Mul c5~46@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1112@ (Mul (Sub (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))) (Mul (Add (Mul c5~46@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1047@ temp_5_1~1112@))) (=> (= temp_5_0~1047@ temp_5_1~1112@) (=> (= temp_6_0~1213@ (Mul (Mul (Sub (Sub c6~54@ 85) (Mul c6~54@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@))) (Mul (Mul (Add d6~56@ d6~56@) (Add b6~52@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1290@ (Mul (Mul (Sub (Sub c6~54@ 85) (Mul c6~54@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@))) (Mul (Mul (Add d6~56@ d6~56@) (Add b6~52@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1213@ temp_6_1~1290@))) (=> (= temp_6_0~1213@ temp_6_1~1290@) (=> (= temp_7_0~1379@ (Mul (Mul (Sub (Add c7~62@ c7~62@) (Add c7~62@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ d7~64@))) (Add (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1444@ (Mul (Mul (Sub (Add c7~62@ c7~62@) (Add c7~62@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ d7~64@))) (Add (Mul a7~58@ (Mul d7~64@ (Mul a7~58@ c7~62@))) (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1379@ temp_7_1~1444@))) (=> (= temp_7_0~1379@ temp_7_1~1444@) (=> (= temp_8_0~1525@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ c8~70@) a8~66@)) (Mul (Sub (Mul c8~70@ d8~72@) a8~66@) (Mul (Sub b8~68@ a8~66@) (Add b8~68@ d8~72@))))) (=> (= temp_8_1~1598@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ c8~70@) a8~66@)) (Sub (Mul (Mul c8~70@ d8~72@) (Mul (Sub b8~68@ a8~66@) (Add b8~68@ d8~72@))) (Mul a8~66@ (Mul (Sub b8~68@ a8~66@) (Add b8~68@ d8~72@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1525@ temp_8_1~1598@))) (=> (= temp_8_0~1525@ temp_8_1~1598@) (=> (= temp_9_0~1687@ (Add (Mul (Sub (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ c9~78@))) (Mul (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ a9~74@)) (Sub (Mul a9~74@ c9~78@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~1752@ (Add (Mul (Sub (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ c9~78@))) (Mul (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ a9~74@)) (Sub (Mul c9~78@ a9~74@) (Mul b9~76@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1687@ temp_9_1~1752@))) (=> (= temp_9_0~1687@ temp_9_1~1752@) (=> (= temp_10_0~1841@ (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul a10~82@ c10~86@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul d10~88@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Sub b10~84@ b10~84@))))) (=> (= temp_10_1~1906@ (Mul (Mul (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ c10~86@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul d10~88@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Sub b10~84@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1841@ temp_10_1~1906@))) (=> (= temp_10_0~1841@ temp_10_1~1906@) (=> (= temp_11_0~1995@ (Mul (Mul (Mul (Sub a11~90@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul c11~94@ c11~94@) (Mul d11~96@ d11~96@))) (Mul (Add (Sub c11~94@ a11~90@) (Sub d11~96@ d11~96@)) (Sub (Mul a11~90@ d11~96@) (Mul b11~92@ d11~96@))))) (=> (= temp_11_1~2068@ (Mul (Mul (Sub (Mul a11~90@ (Mul d11~96@ c11~94@)) (Mul a11~90@ (Mul d11~96@ c11~94@))) (Mul (Mul c11~94@ c11~94@) (Mul d11~96@ d11~96@))) (Mul (Add (Sub c11~94@ a11~90@) (Sub d11~96@ d11~96@)) (Sub (Mul a11~90@ d11~96@) (Mul b11~92@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1995@ temp_11_1~2068@))) (=> (= temp_11_0~1995@ temp_11_1~2068@) (=> (= temp_12_0~2145@ (Add (Mul (Mul d12~104@ c12~102@) (Mul (Mul c12~102@ d12~104@) a12~98@)) (Mul (Mul (Mul a12~98@ a12~98@) (Mul a12~98@ a12~98@)) (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2198@ (Add (Mul (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ d12~104@)) a12~98@) (Mul (Mul (Mul a12~98@ a12~98@) (Mul a12~98@ a12~98@)) (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2145@ temp_12_1~2198@))) (=> (= temp_12_0~2145@ temp_12_1~2198@) (=> (= temp_13_0~2291@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ a13~106@)) (Mul (Mul c13~110@ a13~106@) 86)) (Mul (Mul c13~110@ (Mul c13~110@ c13~110@)) (Mul (Sub d13~112@ d13~112@) (Add b13~108@ b13~108@))))) (=> (= temp_13_1~2360@ (Mul (Mul (Mul (Mul a13~106@ a13~106@) (Mul d13~112@ b13~108@)) (Mul (Mul c13~110@ a13~106@) 86)) (Mul (Mul c13~110@ (Mul c13~110@ c13~110@)) (Mul (Sub d13~112@ d13~112@) (Add b13~108@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2291@ temp_13_1~2360@))) (=> (= temp_13_0~2291@ temp_13_1~2360@) (=> (= temp_14_0~2437@ (Add (Add (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul d14~120@ b14~116@))) (Mul c14~118@ (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@))))) (=> (= temp_14_1~2490@ (Add (Add (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ d14~120@)) (Mul (Mul b14~116@ d14~120@) (Mul d14~120@ b14~116@))) (Mul c14~118@ (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2437@ temp_14_1~2490@))) (=> (= temp_14_0~2437@ temp_14_1~2490@) (=> (= temp_15_0~2591@ (Sub (Mul (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ d15~128@)) (Mul (Mul b15~124@ d15~128@) (Mul d15~128@ c15~126@))) (Mul (Add (Mul b15~124@ 40) (Mul d15~128@ c15~126@)) (Add (Mul a15~122@ c15~126@) (Add b15~124@ a15~122@))))) (=> (= temp_15_1~2668@ (Sub (Mul (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ d15~128@)) (Mul (Mul b15~124@ d15~128@) (Mul d15~128@ c15~126@))) (Mul (Add (Mul a15~122@ c15~126@) (Add b15~124@ a15~122@)) (Add (Mul b15~124@ 40) (Mul d15~128@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2591@ temp_15_1~2668@))) (=> (= temp_15_0~2591@ temp_15_1~2668@) (=> (= temp_16_0~2757@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ b16~132@)) (Add (Mul b16~132@ c16~134@) (Mul c16~134@ b16~132@))) (Mul (Mul (Add b16~132@ b16~132@) (Mul d16~136@ b16~132@)) (Mul (Add a16~130@ d16~136@) (Mul d16~136@ c16~134@))))) (=> (= temp_16_1~2838@ (Mul (Add (Mul (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ b16~132@)) (Mul b16~132@ c16~134@)) (Mul (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ b16~132@)) (Mul c16~134@ b16~132@))) (Mul (Mul (Add b16~132@ b16~132@) (Mul d16~136@ b16~132@)) (Mul (Add a16~130@ d16~136@) (Mul d16~136@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2757@ temp_16_1~2838@))) (=> (= temp_16_0~2757@ temp_16_1~2838@) (=> (= temp_17_0~2939@ (Mul (Mul (Add (Mul a17~138@ d17~144@) (Mul a17~138@ d17~144@)) (Add (Mul c17~142@ b17~140@) (Sub b17~140@ d17~144@))) (Mul (Mul (Mul c17~142@ d17~144@) (Mul d17~144@ 14)) (Mul (Mul b17~140@ d17~144@) (Sub d17~144@ b17~140@))))) (=> (= temp_17_1~3016@ (Mul (Mul (Add (Mul a17~138@ d17~144@) (Mul a17~138@ d17~144@)) (Add (Mul c17~142@ b17~140@) (Sub b17~140@ d17~144@))) (Mul (Mul (Mul c17~142@ d17~144@) (Mul 14 d17~144@)) (Mul (Mul b17~140@ d17~144@) (Sub d17~144@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2939@ temp_17_1~3016@))) (=> (= temp_17_0~2939@ temp_17_1~3016@) (=> (= temp_18_0~3101@ (Mul (Mul (Mul (Mul c18~150@ b18~148@) (Add d18~152@ c18~150@)) (Mul (Mul a18~146@ c18~150@) (Mul d18~152@ b18~148@))) (Mul (Mul (Mul c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Sub d18~152@ d18~152@) b18~148@)))) (=> (= temp_18_1~3162@ (Mul (Mul (Mul (Mul c18~150@ b18~148@) (Add d18~152@ c18~150@)) (Mul (Mul c18~150@ a18~146@) (Mul d18~152@ b18~148@))) (Mul (Mul (Mul c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Sub d18~152@ d18~152@) b18~148@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3101@ temp_18_1~3162@))) (=> (= temp_18_0~3101@ temp_18_1~3162@) (=> (= temp_19_0~3251@ (Mul (Mul (Mul (Mul d19~160@ b19~156@) (Add d19~160@ c19~158@)) (Mul (Mul b19~156@ c19~158@) (Sub b19~156@ b19~156@))) (Add (Mul (Sub b19~156@ b19~156@) (Sub d19~160@ b19~156@)) (Add (Mul d19~160@ b19~156@) (Mul d19~160@ b19~156@))))) (=> (= temp_19_1~3316@ (Mul (Mul (Mul (Mul b19~156@ d19~160@) (Add d19~160@ c19~158@)) (Mul (Mul b19~156@ c19~158@) (Sub b19~156@ b19~156@))) (Add (Mul (Sub b19~156@ b19~156@) (Sub d19~160@ b19~156@)) (Add (Mul d19~160@ b19~156@) (Mul d19~160@ b19~156@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3251@ temp_19_1~3316@))) (=> (= temp_19_0~3251@ temp_19_1~3316@) (=> (= temp_20_0~3393@ (Add (Mul (Mul (Mul d20~168@ b20~164@) (Mul a20~162@ c20~166@)) 83) (Mul d20~168@ (Mul (Mul c20~166@ c20~166@) (Mul a20~162@ b20~164@))))) (=> (= temp_20_1~3446@ (Add (Mul (Mul (Mul (Mul d20~168@ b20~164@) a20~162@) c20~166@) 83) (Mul d20~168@ (Mul (Mul c20~166@ c20~166@) (Mul a20~162@ b20~164@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3393@ temp_20_1~3446@))) (=> (= temp_20_0~3393@ temp_20_1~3446@) (=> (= temp_21_0~3535@ (Mul (Mul (Mul (Mul d21~176@ c21~174@) (Mul a21~170@ a21~170@)) (Add (Mul b21~172@ b21~172@) (Sub c21~174@ c21~174@))) (Mul (Mul (Mul d21~176@ b21~172@) (Mul a21~170@ b21~172@)) (Mul (Mul a21~170@ d21~176@) (Mul c21~174@ d21~176@))))) (=> (= temp_21_1~3600@ (Mul (Mul (Add (Mul b21~172@ b21~172@) (Sub c21~174@ c21~174@)) (Mul (Mul d21~176@ c21~174@) (Mul a21~170@ a21~170@))) (Mul (Mul (Mul d21~176@ b21~172@) (Mul a21~170@ b21~172@)) (Mul (Mul a21~170@ d21~176@) (Mul c21~174@ d21~176@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3535@ temp_21_1~3600@))) (=> (= temp_21_0~3535@ temp_21_1~3600@) (=> (= temp_22_0~3669@ (Mul (Mul (Sub (Mul a22~178@ d22~184@) (Mul b22~180@ c22~182@)) c22~182@) (Mul (Mul b22~180@ (Add a22~178@ d22~184@)) (Mul c22~182@ (Mul d22~184@ d22~184@))))) (=> (= temp_22_1~3714@ (Mul (Mul (Mul (Sub (Mul a22~178@ d22~184@) (Mul b22~180@ c22~182@)) c22~182@) (Mul b22~180@ (Add a22~178@ d22~184@))) (Mul c22~182@ (Mul d22~184@ d22~184@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3669@ temp_22_1~3714@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
