...
(set-info :comment ";; mariposa_data/v_nl//17037612864152200606/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_1_0~521@ Int)
...
(declare-const temp_5_0~1157@ Int)
(declare-const temp_5_1~1230@ Int)
(declare-const temp_6_0~1335@ Int)
(declare-const temp_6_1~1400@ Int)
(declare-const temp_7_0~1473@ Int)
...
(declare-const temp_11_1~2300@ Int)
(declare-const temp_12_0~2449@ Int)
(declare-const temp_12_1~2530@ Int)
(declare-const temp_13_0~2641@ Int)
(declare-const temp_13_1~2710@ Int)
(declare-const temp_14_0~2821@ Int)
(declare-const temp_14_1~2898@ Int)
(declare-const temp_15_0~2971@ Int)
(declare-const temp_15_1~3008@ Int)
(declare-const temp_16_0~3125@ Int)
(declare-const temp_16_1~3186@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Sub a0~2@ d0~8@)) (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Add (Mul b0~4@ c0~6@) (Add c0~6@ 83)) (Mul c0~6@ (Sub b0~4@ b0~4@))))) (=> (= temp_0_1~398@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Sub a0~2@ d0~8@)) (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ c0~6@))) (Add (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ (Sub b0~4@ b0~4@))) (Mul (Add c0~6@ 83) (Mul c0~6@ (Sub b0~4@ b0~4@)))))) (and (=> (= tmp%1@ (Mul b0~4@ c0~6@)) (=> (= tmp%2@ (Add c0~6@ 83)) (=> (= tmp%3@ (Mul c0~6@ (Sub b0~4@ b0~4@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~398@)))))) (=> (= temp_0_0~313@ temp_0_1~398@) (=> (= temp_1_0~521@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Add c1~14@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Add b1~12@ b1~12@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ b1~12@)) (Add (Mul c1~14@ b1~12@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~586@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Add c1~14@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Add b1~12@ b1~12@))) (Mul (Mul b1~12@ (Mul b1~12@ (Mul a1~10@ b1~12@))) (Add (Mul c1~14@ b1~12@) (Mul a1~10@ a1~10@))))) (and (=> (= tmp%4@ (Mul a1~10@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b1~12@ b1~12@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~521@ temp_1_1~586@)))) (=> (= temp_1_0~521@ temp_1_1~586@) (=> (= temp_2_0~681@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ a2~18@)) (Mul (Mul a2~18@ d2~24@) a2~18@)) (Mul (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Add b2~20@ a2~18@))))) (=> (= temp_2_1~742@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Sub b2~20@ a2~18@)) (Mul (Mul a2~18@ d2~24@) a2~18@)) (Mul (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Add b2~20@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ b2~20@) (=> %%location_label%%2 (= temp_2_0~681@ temp_2_1~742@))) (=> (= temp_2_0~681@ temp_2_1~742@) (=> (= temp_3_0~819@ (Add (Mul (Add (Mul d3~32@ b3~28@) (Sub d3~32@ a3~26@)) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@))) 5)) (=> (= temp_3_1~868@ (Add (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@)) (Add (Mul d3~32@ b3~28@) (Sub d3~32@ a3~26@))) 5)) (and (=> (= tmp%5@ (Add (Mul d3~32@ b3~28@) (Sub d3~32@ a3~26@))) (=> (= tmp%6@ (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~819@ temp_3_1~868@))))) (=> (= temp_3_0~819@ temp_3_1~868@) (=> (= temp_4_0~985@ (Mul (Sub (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ a4~34@)) (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Sub (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~1050@ (Mul (Sub (Mul c4~38@ (Mul a4~34@ (Mul a4~34@ a4~34@))) (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Sub (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@))))) (and (=> (= tmp%7@ (Mul a4~34@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c4~38@ a4~34@ tmp%7@) (=> %%location_label%%4 (= temp_4_0~985@ temp_4_1~1050@)))) (=> (= temp_4_0~985@ temp_4_1~1050@) (=> (= temp_5_0~1157@ (Add (Add (Add (Mul 98 b5~44@) a5~42@) (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@)) (Add (Mul a5~42@ c5~46@) (Sub c5~46@ a5~42@))))) (=> (= temp_5_1~1230@ (Add (Add (Add (Mul b5~44@ 98) a5~42@) (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@)) (Add (Mul a5~42@ c5~46@) (Sub c5~46@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 98 b5~44@) (=> %%location_label%%5 (= temp_5_0~1157@ temp_5_1~1230@))) (=> (= temp_5_0~1157@ temp_5_1~1230@) (=> (= temp_6_0~1335@ (Mul (Mul (Sub (Mul d6~56@ c6~54@) (Add c6~54@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Add c6~54@ d6~56@))) (Add (Add (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1400@ (Mul (Mul (Sub (Mul d6~56@ c6~54@) (Add c6~54@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Add c6~54@ d6~56@))) (Add (Add (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ a6~50@))))) (and (=> (= tmp%8@ (Mul c6~54@ a6~50@)) (=> (= tmp%9@ (Mul b6~52@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%6 (= temp_6_0~1335@ temp_6_1~1400@))))) (=> (= temp_6_0~1335@ temp_6_1~1400@) (=> (= temp_7_0~1473@ (Mul b7~60@ (Sub (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@)) (Mul (Sub c7~62@ c7~62@) (Mul b7~60@ d7~64@))))) (=> (= temp_7_1~1518@ (Mul b7~60@ (Sub (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@)) (Sub (Mul c7~62@ (Mul b7~60@ d7~64@)) (Mul c7~62@ (Mul b7~60@ d7~64@)))))) (and (=> (= tmp%10@ (Mul b7~60@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c7~62@ c7~62@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~1473@ temp_7_1~1518@)))) (=> (= temp_7_0~1473@ temp_7_1~1518@) (=> (= temp_8_0~1641@ (Sub (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ 20) (Sub d8~72@ d8~72@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul 57 d8~72@)) (Mul (Add a8~66@ a8~66@) (Add d8~72@ c8~70@))))) (=> (= temp_8_1~1730@ (Sub (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ 20) (Sub d8~72@ d8~72@))) (Mul (Mul b8~68@ c8~70@) (Mul (Mul 57 d8~72@) (Mul (Add a8~66@ a8~66@) (Add d8~72@ c8~70@)))))) (and (=> (= tmp%11@ (Mul b8~68@ c8~70@)) (=> (= tmp%12@ (Mul 57 d8~72@)) (=> (= tmp%13@ (Mul (Add a8~66@ a8~66@) (Add d8~72@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%8 (= temp_8_0~1641@ temp_8_1~1730@)))))) (=> (= temp_8_0~1641@ temp_8_1~1730@) (=> (= temp_9_0~1865@ (Sub (Sub (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Sub d9~80@ 16) (Sub d9~80@ c9~78@))) (Mul (Mul (Sub b9~76@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ c9~78@) c9~78@)))) (=> (= temp_9_1~1938@ (Sub (Sub (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Sub d9~80@ 16) (Sub d9~80@ c9~78@))) (Mul (Mul (Mul d9~80@ c9~78@) c9~78@) (Mul (Sub b9~76@ c9~78@) (Mul d9~80@ b9~76@))))) (and (=> (= tmp%14@ (Mul (Sub b9~76@ c9~78@) (Mul d9~80@ b9~76@))) (=> (= tmp%15@ (Mul (Mul d9~80@ c9~78@) c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%9 (= temp_9_0~1865@ temp_9_1~1938@))))) (=> (= temp_9_0~1865@ temp_9_1~1938@) (=> (= temp_10_0~2035@ (Mul (Mul (Mul (Add c10~86@ a10~82@) (Mul a10~82@ c10~86@)) b10~84@) (Sub (Add b10~84@ (Sub c10~86@ b10~84@)) (Mul (Mul a10~82@ a10~82@) (Add c10~86@ c10~86@))))) (=> (= temp_10_1~2104@ (Sub (Mul (Mul (Mul (Add c10~86@ a10~82@) (Mul a10~82@ c10~86@)) b10~84@) (Add b10~84@ (Sub c10~86@ b10~84@))) (Mul (Mul (Mul (Add c10~86@ a10~82@) (Mul a10~82@ c10~86@)) b10~84@) (Mul (Mul a10~82@ a10~82@) (Add c10~86@ c10~86@))))) (and (=> (= tmp%16@ (Mul (Mul (Add c10~86@ a10~82@) (Mul a10~82@ c10~86@)) b10~84@)) (=> (= tmp%17@ (Add b10~84@ (Sub c10~86@ b10~84@))) (=> (= tmp%18@ (Mul (Mul a10~82@ a10~82@) (Add c10~86@ c10~86@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%10 (= temp_10_0~2035@ temp_10_1~2104@)))))) (=> (= temp_10_0~2035@ temp_10_1~2104@) (=> (= temp_11_0~2235@ (Mul (Mul (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ a11~90@))) (Mul (Mul (Mul d11~96@ a11~90@) (Add b11~92@ a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2300@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Add b11~92@ a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ c11~94@))) (Mul (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ a11~90@))))) (and (=> (= tmp%19@ (Mul (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ a11~90@)))) (=> (= tmp%20@ (Mul (Mul (Mul d11~96@ a11~90@) (Add b11~92@ a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ c11~94@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%11 (= temp_11_0~2235@ temp_11_1~2300@))))) (=> (= temp_11_0~2235@ temp_11_1~2300@) (=> (= temp_12_0~2449@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Add (Mul d12~104@ d12~104@) (Mul b12~100@ b12~100@))) (Add (Add (Mul d12~104@ a12~98@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2530@ (Mul (Add (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul d12~104@ d12~104@)) (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul b12~100@ b12~100@))) (Add (Add (Mul d12~104@ a12~98@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@))))) (and (=> (= tmp%21@ (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@))) (=> (= tmp%22@ (Mul d12~104@ d12~104@)) (=> (= tmp%23@ (Mul b12~100@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%12 (= temp_12_0~2449@ temp_12_1~2530@)))))) (=> (= temp_12_0~2449@ temp_12_1~2530@) (=> (= temp_13_0~2641@ (Mul (Mul (Mul (Mul d13~112@ d13~112@) (Sub d13~112@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ b13~108@))) (Add (Mul d13~112@ (Mul c13~110@ d13~112@)) (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ a13~106@))))) (=> (= temp_13_1~2710@ (Mul (Mul (Sub (Mul (Mul d13~112@ d13~112@) d13~112@) (Mul (Mul d13~112@ d13~112@) a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ b13~108@))) (Add (Mul d13~112@ (Mul c13~110@ d13~112@)) (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ a13~106@))))) (and (=> (= tmp%24@ (Mul d13~112@ d13~112@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%24@ d13~112@ a13~106@) (=> %%location_label%%13 (= temp_13_0~2641@ temp_13_1~2710@)))) (=> (= temp_13_0~2641@ temp_13_1~2710@) (=> (= temp_14_0~2821@ (Add (Mul (Mul (Mul b14~116@ c14~118@) (Mul 81 c14~118@)) (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ c14~118@))) (Mul (Mul (Sub c14~118@ d14~120@) (Mul d14~120@ d14~120@)) (Mul (Mul c14~118@ c14~118@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2898@ (Add (Mul (Mul (Mul b14~116@ c14~118@) (Mul 81 c14~118@)) (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ c14~118@))) (Mul (Mul (Sub c14~118@ d14~120@) (Mul d14~120@ d14~120@)) (Mul (Mul c14~118@ d14~120@) (Mul c14~118@ c14~118@))))) (and (=> (= tmp%25@ (Mul c14~118@ c14~118@)) (=> (= tmp%26@ (Mul c14~118@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%25@ tmp%26@) (=> %%location_label%%14 (= temp_14_0~2821@ temp_14_1~2898@))))) (=> (= temp_14_0~2821@ temp_14_1~2898@) (=> (= temp_15_0~2971@ (Mul (Sub (Mul (Mul b15~124@ b15~124@) (Mul a15~122@ b15~124@)) (Mul (Mul c15~126@ d15~128@) (Mul c15~126@ d15~128@))) a15~122@)) (=> (= temp_15_1~3008@ (Mul a15~122@ (Sub (Mul (Mul b15~124@ b15~124@) (Mul a15~122@ b15~124@)) (Mul (Mul c15~126@ d15~128@) (Mul c15~126@ d15~128@))))) (and (=> (= tmp%27@ (Sub (Mul (Mul b15~124@ b15~124@) (Mul a15~122@ b15~124@)) (Mul (Mul c15~126@ d15~128@) (Mul c15~126@ d15~128@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ a15~122@) (=> %%location_label%%15 (= temp_15_0~2971@ temp_15_1~3008@)))) (=> (= temp_15_0~2971@ temp_15_1~3008@) (=> (= temp_16_0~3125@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Sub c16~134@ c16~134@) (Mul c16~134@ d16~136@))) (Mul (Mul (Mul b16~132@ a16~130@) d16~136@) (Mul (Mul c16~134@ d16~136@) (Add d16~136@ c16~134@))))) (=> (= temp_16_1~3186@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) d16~136@) (Mul (Mul c16~134@ d16~136@) (Add d16~136@ c16~134@))) (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Sub c16~134@ c16~134@) (Mul c16~134@ d16~136@))))) (=> (= tmp%28@ (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Sub c16~134@ c16~134@) (Mul c16~134@ d16~136@)))) (=> (= tmp%29@ (Mul (Mul (Mul b16~132@ a16~130@) d16~136@) (Mul (Mul c16~134@ d16~136@) (Add d16~136@ c16~134@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%28@ tmp%29@) (=> %%location_label%%16 (= temp_16_0~3125@ temp_16_1~3186@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
