...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Sub a0~2@ d0~8@)) (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Add (Mul b0~4@ c0~6@) (Add c0~6@ 83)) (Mul c0~6@ (Sub b0~4@ b0~4@))))) (=> (= temp_0_1~398@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Sub a0~2@ d0~8@)) (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ c0~6@))) (Add (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ (Sub b0~4@ b0~4@))) (Mul (Add c0~6@ 83) (Mul c0~6@ (Sub b0~4@ b0~4@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~398@))) (=> (= temp_0_0~313@ temp_0_1~398@) (=> (= temp_1_0~487@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Add c1~14@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Add b1~12@ b1~12@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ b1~12@)) (Add (Mul c1~14@ b1~12@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~552@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Add c1~14@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Add b1~12@ b1~12@))) (Mul (Mul b1~12@ (Mul b1~12@ (Mul a1~10@ b1~12@))) (Add (Mul c1~14@ b1~12@) (Mul a1~10@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~487@ temp_1_1~552@))) (=> (= temp_1_0~487@ temp_1_1~552@) (=> (= temp_2_0~637@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ a2~18@)) (Mul (Mul a2~18@ d2~24@) a2~18@)) (Mul (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Add b2~20@ a2~18@))))) (=> (= temp_2_1~698@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Sub b2~20@ a2~18@)) (Mul (Mul a2~18@ d2~24@) a2~18@)) (Mul (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Add b2~20@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~637@ temp_2_1~698@))) (=> (= temp_2_0~637@ temp_2_1~698@) (=> (= temp_3_0~771@ (Add (Mul (Add (Mul d3~32@ b3~28@) (Sub d3~32@ a3~26@)) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@))) 5)) (=> (= temp_3_1~820@ (Add (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@)) (Add (Mul d3~32@ b3~28@) (Sub d3~32@ a3~26@))) 5)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~771@ temp_3_1~820@))) (=> (= temp_3_0~771@ temp_3_1~820@) (=> (= temp_4_0~909@ (Mul (Sub (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ a4~34@)) (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Sub (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~974@ (Mul (Sub (Mul c4~38@ (Mul a4~34@ (Mul a4~34@ a4~34@))) (Sub (Add b4~36@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Sub (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~909@ temp_4_1~974@))) (=> (= temp_4_0~909@ temp_4_1~974@) (=> (= temp_5_0~1071@ (Add (Add (Add (Mul 98 b5~44@) a5~42@) (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@)) (Add (Mul a5~42@ c5~46@) (Sub c5~46@ a5~42@))))) (=> (= temp_5_1~1144@ (Add (Add (Add (Mul b5~44@ 98) a5~42@) (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@)) (Add (Mul a5~42@ c5~46@) (Sub c5~46@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1071@ temp_5_1~1144@))) (=> (= temp_5_0~1071@ temp_5_1~1144@) (=> (= temp_6_0~1233@ (Mul (Mul (Sub (Mul d6~56@ c6~54@) (Add c6~54@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Add c6~54@ d6~56@))) (Add (Add (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1298@ (Mul (Mul (Sub (Mul d6~56@ c6~54@) (Add c6~54@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Add c6~54@ d6~56@))) (Add (Add (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1233@ temp_6_1~1298@))) (=> (= temp_6_0~1233@ temp_6_1~1298@) (=> (= temp_7_0~1359@ (Mul b7~60@ (Sub (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@)) (Mul (Sub c7~62@ c7~62@) (Mul b7~60@ d7~64@))))) (=> (= temp_7_1~1404@ (Mul b7~60@ (Sub (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@)) (Sub (Mul c7~62@ (Mul b7~60@ d7~64@)) (Mul c7~62@ (Mul b7~60@ d7~64@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1359@ temp_7_1~1404@))) (=> (= temp_7_0~1359@ temp_7_1~1404@) (=> (= temp_8_0~1517@ (Sub (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ 20) (Sub d8~72@ d8~72@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul 57 d8~72@)) (Mul (Add a8~66@ a8~66@) (Add d8~72@ c8~70@))))) (=> (= temp_8_1~1606@ (Sub (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ 20) (Sub d8~72@ d8~72@))) (Mul (Mul b8~68@ c8~70@) (Mul (Mul 57 d8~72@) (Mul (Add a8~66@ a8~66@) (Add d8~72@ c8~70@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1517@ temp_8_1~1606@))) (=> (= temp_8_0~1517@ temp_8_1~1606@) (=> (= temp_9_0~1703@ (Sub (Sub (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Sub d9~80@ 16) (Sub d9~80@ c9~78@))) (Mul (Mul (Sub b9~76@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ c9~78@) c9~78@)))) (=> (= temp_9_1~1776@ (Sub (Sub (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Sub d9~80@ 16) (Sub d9~80@ c9~78@))) (Mul (Mul (Mul d9~80@ c9~78@) c9~78@) (Mul (Sub b9~76@ c9~78@) (Mul d9~80@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1703@ temp_9_1~1776@))) (=> (= temp_9_0~1703@ temp_9_1~1776@) (=> (= temp_10_0~1849@ (Mul (Mul (Mul (Add c10~86@ a10~82@) (Mul a10~82@ c10~86@)) b10~84@) (Sub (Add b10~84@ (Sub c10~86@ b10~84@)) (Mul (Mul a10~82@ a10~82@) (Add c10~86@ c10~86@))))) (=> (= temp_10_1~1918@ (Sub (Mul (Mul (Mul (Add c10~86@ a10~82@) (Mul a10~82@ c10~86@)) b10~84@) (Add b10~84@ (Sub c10~86@ b10~84@))) (Mul (Mul (Mul (Add c10~86@ a10~82@) (Mul a10~82@ c10~86@)) b10~84@) (Mul (Mul a10~82@ a10~82@) (Add c10~86@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1849@ temp_10_1~1918@))) (=> (= temp_10_0~1849@ temp_10_1~1918@) (=> (= temp_11_0~2007@ (Mul (Mul (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ a11~90@))) (Mul (Mul (Mul d11~96@ a11~90@) (Add b11~92@ a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2072@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Add b11~92@ a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ c11~94@))) (Mul (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2007@ temp_11_1~2072@))) (=> (= temp_11_0~2007@ temp_11_1~2072@) (=> (= temp_12_0~2161@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Add (Mul d12~104@ d12~104@) (Mul b12~100@ b12~100@))) (Add (Add (Mul d12~104@ a12~98@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2242@ (Mul (Add (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul d12~104@ d12~104@)) (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul b12~100@ b12~100@))) (Add (Add (Mul d12~104@ a12~98@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2161@ temp_12_1~2242@))) (=> (= temp_12_0~2161@ temp_12_1~2242@) (=> (= temp_13_0~2327@ (Mul (Mul (Mul (Mul d13~112@ d13~112@) (Sub d13~112@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ b13~108@))) (Add (Mul d13~112@ (Mul c13~110@ d13~112@)) (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ a13~106@))))) (=> (= temp_13_1~2396@ (Mul (Mul (Sub (Mul (Mul d13~112@ d13~112@) d13~112@) (Mul (Mul d13~112@ d13~112@) a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ b13~108@))) (Add (Mul d13~112@ (Mul c13~110@ d13~112@)) (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2327@ temp_13_1~2396@))) (=> (= temp_13_0~2327@ temp_13_1~2396@) (=> (= temp_14_0~2497@ (Add (Mul (Mul (Mul b14~116@ c14~118@) (Mul 81 c14~118@)) (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ c14~118@))) (Mul (Mul (Sub c14~118@ d14~120@) (Mul d14~120@ d14~120@)) (Mul (Mul c14~118@ c14~118@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2574@ (Add (Mul (Mul (Mul b14~116@ c14~118@) (Mul 81 c14~118@)) (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ c14~118@))) (Mul (Mul (Sub c14~118@ d14~120@) (Mul d14~120@ d14~120@)) (Mul (Mul c14~118@ d14~120@) (Mul c14~118@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2497@ temp_14_1~2574@))) (=> (= temp_14_0~2497@ temp_14_1~2574@) (=> (= temp_15_0~2635@ (Mul (Sub (Mul (Mul b15~124@ b15~124@) (Mul a15~122@ b15~124@)) (Mul (Mul c15~126@ d15~128@) (Mul c15~126@ d15~128@))) a15~122@)) (=> (= temp_15_1~2672@ (Mul a15~122@ (Sub (Mul (Mul b15~124@ b15~124@) (Mul a15~122@ b15~124@)) (Mul (Mul c15~126@ d15~128@) (Mul c15~126@ d15~128@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2635@ temp_15_1~2672@))) (=> (= temp_15_0~2635@ temp_15_1~2672@) (=> (= temp_16_0~2757@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Sub c16~134@ c16~134@) (Mul c16~134@ d16~136@))) (Mul (Mul (Mul b16~132@ a16~130@) d16~136@) (Mul (Mul c16~134@ d16~136@) (Add d16~136@ c16~134@))))) (=> (= temp_16_1~2818@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) d16~136@) (Mul (Mul c16~134@ d16~136@) (Add d16~136@ c16~134@))) (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Sub c16~134@ c16~134@) (Mul c16~134@ d16~136@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2757@ temp_16_1~2818@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
