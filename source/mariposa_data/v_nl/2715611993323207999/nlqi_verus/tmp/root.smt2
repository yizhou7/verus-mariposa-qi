...
(push)
 ...
 (declare-const temp_11_0~1963@ Int)
 ...
 (declare-const temp_16_0~2689@ Int)
 (declare-const temp_16_1~2726@ Int)
 (declare-const temp_17_0~2835@ Int)
 (declare-const temp_17_1~2920@ Int)
 (declare-const temp_18_0~3009@ Int)
 (declare-const temp_18_1~3074@ Int)
 (declare-const temp_19_0~3183@ Int)
 (declare-const temp_19_1~3268@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
     ...
     (=>
      ...
      (and
       (=>
        ...
        (=>
         %%location_label%%0
         (= temp_0_0~293@ temp_0_1~354@)
       ))
       (=>
        (= temp_0_0~293@ temp_0_1~354@)
        (=>
         (= temp_1_0~455@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Sub b1~12@
              68
             ) (Mul a1~10@ a1~10@)
            )
         ...
         (=>
          (= temp_1_1~532@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@
               a1~10@
              ) (Sub b1~12@ 68)
             )
            ) (Mul (Add (Add b1~12@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Add a1~10@
          ...
          (and
           (=>
            ...
            (=>
             %%location_label%%1
             (= temp_1_0~455@ temp_1_1~532@)
           ))
           (=>
            (= temp_1_0~455@ temp_1_1~532@)
            (=>
             (= temp_2_0~613@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ b2~20@)) (Mul b2~20@
                 a2~18@
                )
             ...
             (=>
              (= temp_2_1~670@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ b2~20@)) (Mul b2~20@
                  a2~18@
                 )
              ...
              (and
               ...
               (=>
                (= temp_2_0~613@ temp_2_1~670@)
                (=>
                 (= temp_3_0~755@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Add d3~32@ a3~26@)) (Mul d3~32@
                     (Mul c3~30@ b3~28@)
                    )
                 ...
                 (=>
                  (= temp_3_1~816@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Add d3~32@ a3~26@)) (Mul d3~32@
                      (Mul c3~30@ b3~28@)
                     )
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~755@ temp_3_1~816@)
                    (=>
                     (= temp_4_0~917@ (Mul (Add (Mul (Mul c4~38@ c4~38@) (Sub b4~36@ d4~40@)) (Mul (Mul b4~36@
                          c4~38@
                         ) (Mul d4~40@ b4~36@)
                        )
                     ...
                     (=>
                      (= temp_4_1~994@ (Mul (Add (Mul (Mul c4~38@ c4~38@) (Sub b4~36@ d4~40@)) (Mul (Mul b4~36@
                           c4~38@
                          ) (Mul d4~40@ b4~36@)
                         )
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~917@ temp_4_1~994@)
                        (=>
                         (= temp_5_0~1071@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ d5~48@)) (Add (Mul a5~42@
                              c5~46@
                             ) (Mul a5~42@ c5~46@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1124@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ c5~46@)) (Add (Mul a5~42@
                               c5~46@
                              ) (Mul a5~42@ c5~46@)
                             )
                            ) (Mul b5~44@ (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ d5~48@)))
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1071@ temp_5_1~1124@)
                           ))
                           (=>
                            (= temp_5_0~1071@ temp_5_1~1124@)
                            (=>
                             (= temp_6_0~1209@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@)) (Mul (Sub c6~54@
                                  b6~52@
                                 ) (Mul a6~50@ b6~52@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1270@ (Mul (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@)) (Mul (Mul (Sub c6~54@
                                   b6~52@
                                  ) (Mul a6~50@ b6~52@)
                                 ) (Mul (Sub b6~52@ (Mul a6~50@ d6~56@)) (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ c6~54@)))
                              )))
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1209@ temp_6_1~1270@)
                               ))
                               (=>
                                (= temp_6_0~1209@ temp_6_1~1270@)
                                (=>
                                 (= temp_7_0~1355@ (Mul (Mul (Add (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@)) (Mul d7~64@
                                     (Mul c7~62@ a7~58@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1416@ (Mul (Mul (Mul (Add (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@)) d7~64@)
                                     (Mul c7~62@ a7~58@)
                                    ) (Mul (Mul (Mul a7~58@ b7~60@) (Add b7~60@ d7~64@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@
                                       d7~64@
                                  )))))
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1355@ temp_7_1~1416@)
                                   ))
                                   (=>
                                    (= temp_7_0~1355@ temp_7_1~1416@)
                                    (=>
                                     (= temp_8_0~1505@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Sub b8~68@ d8~72@)) (Mul (Mul a8~66@
                                          d8~72@
                                         ) (Mul b8~68@ d8~72@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1570@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Sub b8~68@ d8~72@)) (Mul (Mul b8~68@
                                           d8~72@
                                          ) (Mul a8~66@ d8~72@)
                                         )
                                        ) (Mul (Mul (Mul b8~68@ d8~72@) (Add a8~66@ d8~72@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@
                                      ...
                                      (and
                                       ...
                                       (=>
                                        (= temp_8_0~1505@ temp_8_1~1570@)
                                        (=>
                                         (= temp_9_0~1659@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ c9~78@)) (Sub (Add a9~74@
                                              c9~78@
                                             ) (Mul c9~78@ d9~80@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1724@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul c9~78@ b9~76@)) (Sub (Add a9~74@
                                               c9~78@
                                              ) (Mul c9~78@ d9~80@)
                                             )
                                            ) (Add (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ a9~74@)) (Mul (Mul d9~80@ a9~74@) (Mul d9~80@
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1659@ temp_9_1~1724@)
                                           ))
                                           (=>
                                            (= temp_9_0~1659@ temp_9_1~1724@)
                                            (=>
                                             (= temp_10_0~1813@ (Mul (Mul (Mul (Add d10~88@ b10~84@) (Mul a10~82@ b10~84@)) (Mul (
                                                  Sub d10~88@ a10~82@
                                                 ) (Sub d10~88@ a10~82@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1878@ (Mul (Mul (Mul (Add d10~88@ b10~84@) (Mul a10~82@ b10~84@)) (Mul (
                                                   Sub d10~88@ a10~82@
                                                  ) (Sub d10~88@ a10~82@)
                                                 )
                                              ...
                                              (and
                                               ...
                                               (=>
                                                (= temp_10_0~1813@ temp_10_1~1878@)
                                                (=>
                                                 (= temp_11_0~1963@ (Mul (Sub (Mul (Mul c11~94@ d11~96@) (Mul d11~96@ c11~94@)) (Mul a11~90@
                                                     (Mul d11~96@ a11~90@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2024@ (Mul (Sub (Mul (Mul c11~94@ d11~96@) (Mul d11~96@ c11~94@)) (Mul a11~90@
                                                      (Mul d11~96@ a11~90@)
                                                     )
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~1963@ temp_11_1~2024@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~1963@ temp_11_1~2024@)
                                                    (=>
                                                     (= temp_12_0~2109@ (Mul (Mul (Sub (Mul d12~104@ a12~98@) (Sub b12~100@ b12~100@)) (Mul
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2170@ (Mul (Mul (Sub (Mul d12~104@ a12~98@) (Sub b12~100@ b12~100@)) (Mul
                                                      ...
                                                      (and
                                                       ...
                                                       (=>
                                                        (= temp_12_0~2109@ temp_12_1~2170@)
                                                        (=>
                                                         (= temp_13_0~2259@ (Mul (Mul (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ c13~110@)) (
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2324@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ c13~110@)) (
                                                          ...
                                                          (and
                                                           ...
                                                           (=>
                                                            (= temp_13_0~2259@ temp_13_1~2324@)
                                                            (=>
                                                             (= temp_14_0~2413@ (Mul (Mul (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ d14~120@)) (
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2474@ (Mul (Mul (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ d14~120@)) (
                                                              ...
                                                              (and
                                                               ...
                                                               (=>
                                                                (= temp_14_0~2413@ temp_14_1~2474@)
                                                                (=>
                                                                 (= temp_15_0~2563@ (Mul (Mul (Mul (Mul c15~126@ b15~124@) (Add d15~128@ a15~122@)) (
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2628@ (Mul (Mul (Mul (Mul c15~126@ b15~124@) (Add d15~128@ a15~122@)) (
                                                                      Add (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@)
                                                                     )
                                                                    ) (Add (Mul (Mul b15~124@ c15~126@) (Mul b15~124@ c15~126@)) (Mul (Mul d15~128@ a15~122@)
                                                                      (Mul c15~126@ c15~126@)
                                                                  ...
                                                                  (and
                                                                   ...
                                                                   (=>
                                                                    (= temp_15_0~2563@ temp_15_1~2628@)
                                                                    (=>
                                                                     (= temp_16_0~2689@ (Add (Mul (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ b16~132@)) (
                                                                         Mul (Mul b16~132@ a16~130@) (Mul a16~130@ c16~134@)
                                                                        )
                                                                       ) b16~132@
                                                                     ))
                                                                     (=>
                                                                      (= temp_16_1~2726@ (Add (Mul (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ b16~132@)) (
                                                                      ...
                                                                      (and
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         %%location_label%%16
                                                                         (= temp_16_0~2689@ temp_16_1~2726@)
                                                                       ))
                                                                       (=>
                                                                        (= temp_16_0~2689@ temp_16_1~2726@)
                                                                        (=>
                                                                         (= temp_17_0~2835@ (Sub (Mul (Mul (Mul a17~138@ a17~138@) (Mul c17~142@ b17~140@)) (
                                                                             Mul (Mul c17~142@ a17~138@) (Mul b17~140@ d17~144@)
                                                                            )
                                                                           ) (Mul (Mul (Mul b17~140@ c17~142@) a17~138@) (Mul (Mul 29 d17~144@) (Mul 82 c17~142@)))
                                                                         ))
                                                                         (=>
                                                                          (= temp_17_1~2920@ (Sub (Mul (Mul (Mul a17~138@ a17~138@) (Mul c17~142@ b17~140@)) (
                                                                              Mul (Mul c17~142@ a17~138@) (Mul b17~140@ d17~144@)
                                                                             )
                                                                          ...
                                                                          (and
                                                                           (=>
                                                                            ...
                                                                            (=>
                                                                             %%location_label%%17
                                                                             (= temp_17_0~2835@ temp_17_1~2920@)
                                                                           ))
                                                                           (=>
                                                                            (= temp_17_0~2835@ temp_17_1~2920@)
                                                                            (=>
                                                                             (= temp_18_0~3009@ (Sub (Sub (Mul (Add b18~148@ c18~150@) (Sub b18~148@ b18~148@)) (
                                                                             ...
                                                                             (=>
                                                                              (= temp_18_1~3074@ (Sub (Sub (Mul (Add b18~148@ c18~150@) (Sub b18~148@ b18~148@)) (
                                                                                  Mul (Mul a18~146@ a18~146@) (Mul b18~148@ d18~152@)
                                                                                 )
                                                                                ) (Mul (Mul (Mul c18~150@ d18~152@) (Mul c18~150@ a18~146@)) (Mul (Mul a18~146@ a18~146@)
                                                                                  (Mul a18~146@ d18~152@)
                                                                              ...
                                                                              (and
                                                                               (=>
                                                                                ...
                                                                                (=>
                                                                                 %%location_label%%18
                                                                                 (= temp_18_0~3009@ temp_18_1~3074@)
                                                                               ))
                                                                               (=>
                                                                                (= temp_18_0~3009@ temp_18_1~3074@)
                                                                                (=>
                                                                                 (= temp_19_0~3183@ (Add (Mul (Mul (Mul b19~156@ b19~156@) (Mul 95 d19~160@)) (Mul (Mul
                                                                                      c19~158@ a19~154@
                                                                                     ) (Mul c19~158@ 12)
                                                                                    )
                                                                                 ...
                                                                                 (=>
                                                                                  (= temp_19_1~3268@ (Add (Mul (Mul (Mul b19~156@ b19~156@) (Mul 95 d19~160@)) (Mul c19~158@
