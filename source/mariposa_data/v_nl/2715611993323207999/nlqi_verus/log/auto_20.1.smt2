...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Sub (Mul (Sub (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul a0~2@ (Mul (Mul d0~8@ b0~4@) (Add d0~8@ b0~4@))))) (=> (= temp_0_1~354@ (Sub (Mul (Sub (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul a0~2@ (Add (Mul (Mul d0~8@ b0~4@) d0~8@) (Mul (Mul d0~8@ b0~4@) b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~354@))) (=> (= temp_0_0~293@ temp_0_1~354@) (=> (= temp_1_0~455@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Sub b1~12@ 68) (Mul a1~10@ a1~10@))) (Mul (Add (Add b1~12@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Add a1~10@ d1~16@))))) (=> (= temp_1_1~532@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Sub b1~12@ 68))) (Mul (Add (Add b1~12@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Add a1~10@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~455@ temp_1_1~532@))) (=> (= temp_1_0~455@ temp_1_1~532@) (=> (= temp_2_0~613@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ b2~20@)) (Mul b2~20@ a2~18@)) (Sub (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~670@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ b2~20@)) (Mul b2~20@ a2~18@)) (Sub (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ a2~18@)) (Mul a2~18@ (Mul d2~24@ (Mul c2~22@ c2~22@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~613@ temp_2_1~670@))) (=> (= temp_2_0~613@ temp_2_1~670@) (=> (= temp_3_0~755@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Add d3~32@ a3~26@)) (Mul d3~32@ (Mul c3~30@ b3~28@))) (Mul (Sub (Mul b3~28@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Sub d3~32@ c3~30@))))) (=> (= temp_3_1~816@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Add d3~32@ a3~26@)) (Mul d3~32@ (Mul c3~30@ b3~28@))) (Mul (Sub (Mul b3~28@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Sub d3~32@ c3~30@) (Mul c3~30@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~755@ temp_3_1~816@))) (=> (= temp_3_0~755@ temp_3_1~816@) (=> (= temp_4_0~917@ (Mul (Add (Mul (Mul c4~38@ c4~38@) (Sub b4~36@ d4~40@)) (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Mul (Add c4~38@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Sub a4~34@ 50) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~994@ (Mul (Add (Mul (Mul c4~38@ c4~38@) (Sub b4~36@ d4~40@)) (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Add c4~38@ b4~36@) (Mul (Mul b4~36@ c4~38@) (Mul (Sub a4~34@ 50) (Mul c4~38@ d4~40@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~917@ temp_4_1~994@))) (=> (= temp_4_0~917@ temp_4_1~994@) (=> (= temp_5_0~1071@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ d5~48@)) (Add (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@))) (Mul b5~44@ (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1124@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ c5~46@)) (Add (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@))) (Mul b5~44@ (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1071@ temp_5_1~1124@))) (=> (= temp_5_0~1071@ temp_5_1~1124@) (=> (= temp_6_0~1209@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@)) (Mul (Sub c6~54@ b6~52@) (Mul a6~50@ b6~52@))) (Mul (Sub b6~52@ (Mul a6~50@ d6~56@)) (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1270@ (Mul (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@)) (Mul (Mul (Sub c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Sub b6~52@ (Mul a6~50@ d6~56@)) (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ c6~54@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1209@ temp_6_1~1270@))) (=> (= temp_6_0~1209@ temp_6_1~1270@) (=> (= temp_7_0~1355@ (Mul (Mul (Add (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@)) (Mul d7~64@ (Mul c7~62@ a7~58@))) (Mul (Mul (Mul a7~58@ b7~60@) (Add b7~60@ d7~64@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ d7~64@))))) (=> (= temp_7_1~1416@ (Mul (Mul (Mul (Add (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@)) d7~64@) (Mul c7~62@ a7~58@)) (Mul (Mul (Mul a7~58@ b7~60@) (Add b7~60@ d7~64@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1355@ temp_7_1~1416@))) (=> (= temp_7_0~1355@ temp_7_1~1416@) (=> (= temp_8_0~1505@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Sub b8~68@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul b8~68@ d8~72@) (Add a8~66@ d8~72@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@))))) (=> (= temp_8_1~1570@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Sub b8~68@ d8~72@)) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul b8~68@ d8~72@) (Add a8~66@ d8~72@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1505@ temp_8_1~1570@))) (=> (= temp_8_0~1505@ temp_8_1~1570@) (=> (= temp_9_0~1659@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ c9~78@)) (Sub (Add a9~74@ c9~78@) (Mul c9~78@ d9~80@))) (Add (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ a9~74@)) (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~1724@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul c9~78@ b9~76@)) (Sub (Add a9~74@ c9~78@) (Mul c9~78@ d9~80@))) (Add (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ a9~74@)) (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1659@ temp_9_1~1724@))) (=> (= temp_9_0~1659@ temp_9_1~1724@) (=> (= temp_10_0~1813@ (Mul (Mul (Mul (Add d10~88@ b10~84@) (Mul a10~82@ b10~84@)) (Mul (Sub d10~88@ a10~82@) (Sub d10~88@ a10~82@))) (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ b10~84@)) (Sub (Mul d10~88@ a10~82@) (Add d10~88@ c10~86@))))) (=> (= temp_10_1~1878@ (Mul (Mul (Mul (Add d10~88@ b10~84@) (Mul a10~82@ b10~84@)) (Mul (Sub d10~88@ a10~82@) (Sub d10~88@ a10~82@))) (Mul (Mul (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Sub (Mul d10~88@ a10~82@) (Add d10~88@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1813@ temp_10_1~1878@))) (=> (= temp_10_0~1813@ temp_10_1~1878@) (=> (= temp_11_0~1963@ (Mul (Sub (Mul (Mul c11~94@ d11~96@) (Mul d11~96@ c11~94@)) (Mul a11~90@ (Mul d11~96@ a11~90@))) (Sub (Mul (Mul d11~96@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~2024@ (Mul (Sub (Mul (Mul c11~94@ d11~96@) (Mul d11~96@ c11~94@)) (Mul a11~90@ (Mul d11~96@ a11~90@))) (Sub (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1963@ temp_11_1~2024@))) (=> (= temp_11_0~1963@ temp_11_1~2024@) (=> (= temp_12_0~2109@ (Mul (Mul (Sub (Mul d12~104@ a12~98@) (Sub b12~100@ b12~100@)) (Mul (Mul b12~100@ c12~102@) c12~102@)) (Mul (Mul (Mul d12~104@ b12~100@) (Sub b12~100@ a12~98@)) (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ c12~102@))))) (=> (= temp_12_1~2170@ (Mul (Mul (Sub (Mul d12~104@ a12~98@) (Sub b12~100@ b12~100@)) (Mul (Mul c12~102@ b12~100@) c12~102@)) (Mul (Mul (Mul d12~104@ b12~100@) (Sub b12~100@ a12~98@)) (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2109@ temp_12_1~2170@))) (=> (= temp_12_0~2109@ temp_12_1~2170@) (=> (= temp_13_0~2259@ (Mul (Mul (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ c13~110@)) (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ c13~110@))) (Mul (Mul (Mul c13~110@ a13~106@) (Mul d13~112@ d13~112@)) (Mul (Add b13~108@ b13~108@) (Mul a13~106@ d13~112@))))) (=> (= temp_13_1~2324@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ c13~110@)) (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ c13~110@))) (Mul (Mul (Mul c13~110@ a13~106@) (Mul d13~112@ d13~112@)) (Mul (Add b13~108@ b13~108@) (Mul a13~106@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2259@ temp_13_1~2324@))) (=> (= temp_13_0~2259@ temp_13_1~2324@) (=> (= temp_14_0~2413@ (Mul (Mul (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ d14~120@)) (Sub (Mul c14~118@ b14~116@) (Mul c14~118@ d14~120@))) (Mul (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ c14~118@)) (Add (Mul c14~118@ d14~120@) (Mul d14~120@ d14~120@))))) (=> (= temp_14_1~2474@ (Mul (Mul (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ d14~120@)) (Mul c14~118@ (Sub b14~116@ d14~120@))) (Mul (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ c14~118@)) (Add (Mul c14~118@ d14~120@) (Mul d14~120@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2413@ temp_14_1~2474@))) (=> (= temp_14_0~2413@ temp_14_1~2474@) (=> (= temp_15_0~2563@ (Mul (Mul (Mul (Mul c15~126@ b15~124@) (Add d15~128@ a15~122@)) (Add (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@))) (Add (Mul (Mul b15~124@ c15~126@) (Mul b15~124@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2628@ (Mul (Mul (Mul (Mul c15~126@ b15~124@) (Add d15~128@ a15~122@)) (Add (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@))) (Add (Mul (Mul b15~124@ c15~126@) (Mul b15~124@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul c15~126@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2563@ temp_15_1~2628@))) (=> (= temp_15_0~2563@ temp_15_1~2628@) (=> (= temp_16_0~2689@ (Add (Mul (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ c16~134@))) b16~132@)) (=> (= temp_16_1~2726@ (Add (Mul (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Mul c16~134@ a16~130@))) b16~132@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2689@ temp_16_1~2726@))) (=> (= temp_16_0~2689@ temp_16_1~2726@) (=> (= temp_17_0~2835@ (Sub (Mul (Mul (Mul a17~138@ a17~138@) (Mul c17~142@ b17~140@)) (Mul (Mul c17~142@ a17~138@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul b17~140@ c17~142@) a17~138@) (Mul (Mul 29 d17~144@) (Mul 82 c17~142@))))) (=> (= temp_17_1~2920@ (Sub (Mul (Mul (Mul a17~138@ a17~138@) (Mul c17~142@ b17~140@)) (Mul (Mul c17~142@ a17~138@) (Mul b17~140@ d17~144@))) (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ (Mul (Mul 29 d17~144@) (Mul 82 c17~142@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2835@ temp_17_1~2920@))) (=> (= temp_17_0~2835@ temp_17_1~2920@) (=> (= temp_18_0~3009@ (Sub (Sub (Mul (Add b18~148@ c18~150@) (Sub b18~148@ b18~148@)) (Mul (Mul a18~146@ a18~146@) (Mul b18~148@ d18~152@))) (Mul (Mul (Mul c18~150@ d18~152@) (Mul c18~150@ a18~146@)) (Mul (Mul a18~146@ a18~146@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~3074@ (Sub (Sub (Mul (Add b18~148@ c18~150@) (Sub b18~148@ b18~148@)) (Mul (Mul a18~146@ a18~146@) (Mul b18~148@ d18~152@))) (Mul (Mul (Mul c18~150@ d18~152@) (Mul c18~150@ a18~146@)) (Mul (Mul a18~146@ a18~146@) (Mul a18~146@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3009@ temp_18_1~3074@))) (=> (= temp_18_0~3009@ temp_18_1~3074@) (=> (= temp_19_0~3183@ (Add (Mul (Mul (Mul b19~156@ b19~156@) (Mul 95 d19~160@)) (Mul (Mul c19~158@ a19~154@) (Mul c19~158@ 12))) (Mul (Mul (Mul a19~154@ b19~156@) (Mul b19~156@ b19~156@)) (Mul c19~158@ (Mul d19~160@ d19~160@))))) (=> (= temp_19_1~3268@ (Add (Mul (Mul (Mul b19~156@ b19~156@) (Mul 95 d19~160@)) (Mul c19~158@ (Mul a19~154@ (Mul c19~158@ 12)))) (Mul (Mul (Mul a19~154@ b19~156@) (Mul b19~156@ b19~156@)) (Mul c19~158@ (Mul d19~160@ d19~160@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3183@ temp_19_1~3268@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
