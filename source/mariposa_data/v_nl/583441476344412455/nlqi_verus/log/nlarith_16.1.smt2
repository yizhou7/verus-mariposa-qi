...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Mul c0~6@ (Mul (Add d0~8@ 1) (Mul b0~4@ d0~8@))) (Sub (Add (Mul d0~8@ c0~6@) (Add b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ a0~2@))))) (=> (= temp_0_1~378@ (Sub (Mul c0~6@ (Add (Mul d0~8@ (Mul b0~4@ d0~8@)) (Mul 1 (Mul b0~4@ d0~8@)))) (Sub (Add (Mul d0~8@ c0~6@) (Add b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~378@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~470@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul 19 d1~16@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~547@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul (Mul 19 d1~16@) c1~14@) b1~12@)))) (=> (= tmp%2@ (= temp_1_0~470@ temp_1_1~547@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~639@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul 84 c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ a2~18@))) (Sub (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Sub c2~22@ b2~20@) (Add c2~22@ c2~22@))))) (=> (= temp_2_1~716@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul 84 c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ a2~18@))) (Sub (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Sub c2~22@ b2~20@) (Add c2~22@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~639@ temp_2_1~716@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~796@ (Sub (Mul (Mul (Add d3~32@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@))) (Mul (Mul (Sub d3~32@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~861@ (Sub (Mul (Mul (Add d3~32@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@))) (Mul (Mul (Sub d3~32@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~796@ temp_3_1~861@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~941@ (Sub (Add (Add (Mul b4~36@ a4~34@) (Sub c4~38@ b4~36@)) (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul c4~38@ b4~36@) (Add d4~40@ c4~38@)) (Sub (Mul d4~40@ c4~38@) (Add b4~36@ c4~38@))))) (=> (= temp_4_1~1006@ (Sub (Add (Add (Mul b4~36@ a4~34@) (Sub c4~38@ b4~36@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul c4~38@ b4~36@) (Add d4~40@ c4~38@)) (Sub (Mul d4~40@ c4~38@) (Add b4~36@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~941@ temp_4_1~1006@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1098@ (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) (Sub (Mul a5~42@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Add b5~44@ 19))))) (=> (= temp_5_1~1175@ (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) (Sub (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Add b5~44@ 19))))) (=> (= tmp%6@ (= temp_5_0~1098@ temp_5_1~1175@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1239@ (Add (Sub (Mul (Mul d6~56@ c6~54@) (Add 68 a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))) b6~52@)) (=> (= temp_6_1~1288@ (Add (Sub (Mul (Mul d6~56@ c6~54@) (Add 68 a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ d6~56@))) b6~52@)) (=> (= tmp%7@ (= temp_6_0~1239@ temp_6_1~1288@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1352@ (Mul (Add (Mul (Sub d7~64@ c7~62@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ d7~64@) (Add c7~62@ a7~58@))) (Mul b7~60@ (Mul (Mul a7~58@ a7~58@) a7~58@)))) (=> (= temp_7_1~1409@ (Mul (Add (Sub (Mul d7~64@ (Mul c7~62@ d7~64@)) (Mul c7~62@ (Mul c7~62@ d7~64@))) (Mul (Mul d7~64@ d7~64@) (Add c7~62@ a7~58@))) (Mul b7~60@ (Mul (Mul a7~58@ a7~58@) a7~58@)))) (=> (= tmp%8@ (= temp_7_0~1352@ temp_7_1~1409@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1473@ (Mul (Sub (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@)) (Mul (Mul a8~66@ d8~72@) (Mul 14 a8~66@))) d8~72@)) (=> (= temp_8_1~1526@ (Sub (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@)) d8~72@) (Mul (Mul (Mul a8~66@ d8~72@) (Mul 14 a8~66@)) d8~72@))) (=> (= tmp%9@ (= temp_8_0~1473@ temp_8_1~1526@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1598@ (Mul (Mul (Mul b9~76@ (Mul a9~74@ a9~74@)) (Mul (Mul d9~80@ c9~78@) a9~74@)) (Sub (Mul (Sub c9~78@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1647@ (Mul (Mul (Mul b9~76@ (Mul a9~74@ a9~74@)) (Mul (Mul d9~80@ c9~78@) a9~74@)) (Mul (Sub (Sub c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Mul a9~74@ c9~78@)))) (=> (= tmp%10@ (= temp_9_0~1598@ temp_9_1~1647@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1723@ (Mul (Mul (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Mul a10~82@ a10~82@) d10~88@)) (Mul (Add (Mul a10~82@ a10~82@) (Mul d10~88@ d10~88@)) (Add (Mul b10~84@ a10~82@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1784@ (Mul (Mul (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ c10~86@)) (Mul (Mul a10~82@ a10~82@) d10~88@)) (Mul (Add (Mul a10~82@ a10~82@) (Mul d10~88@ d10~88@)) (Add (Mul b10~84@ a10~82@) (Mul c10~86@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1723@ temp_10_1~1784@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1872@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@)) (Mul (Add a11~90@ c11~94@) c11~94@)) (Add (Add (Mul a11~90@ b11~92@) (Mul b11~92@ c11~94@)) (Mul (Add a11~90@ 23) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~1945@ (Mul (Mul (Mul (Add a11~90@ c11~94@) c11~94@) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (Add (Add (Mul a11~90@ b11~92@) (Mul b11~92@ c11~94@)) (Mul (Add a11~90@ 23) (Mul d11~96@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1872@ temp_11_1~1945@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2017@ (Mul (Mul (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@)) (Mul a12~98@ (Add b12~100@ a12~98@))) (Mul (Add a12~98@ (Add b12~100@ b12~100@)) (Add (Mul c12~102@ d12~104@) (Mul b12~100@ c12~102@))))) (=> (= temp_12_1~2074@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ a12~98@)) (Mul a12~98@ (Add b12~100@ a12~98@))) (Mul (Add a12~98@ (Add b12~100@ b12~100@)) (Add (Mul c12~102@ d12~104@) (Mul b12~100@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~2017@ temp_12_1~2074@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2154@ (Mul (Mul (Mul (Add b13~108@ a13~106@) (Add b13~108@ c13~110@)) (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@))) (Mul (Add (Add b13~108@ c13~110@) (Mul a13~106@ d13~112@)) (Sub (Mul c13~110@ b13~108@) (Sub d13~112@ c13~110@))))) (=> (= temp_13_1~2219@ (Mul (Mul (Add (Add b13~108@ c13~110@) (Mul a13~106@ d13~112@)) (Sub (Mul c13~110@ b13~108@) (Sub d13~112@ c13~110@))) (Mul (Mul (Add b13~108@ a13~106@) (Add b13~108@ c13~110@)) (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2154@ temp_13_1~2219@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2299@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ b14~116@)) (Add (Sub b14~116@ d14~120@) (Mul b14~116@ a14~114@))) (Mul (Sub (Add d14~120@ c14~118@) (Sub c14~118@ d14~120@)) (Mul (Sub b14~116@ b14~116@) (Mul b14~116@ a14~114@))))) (=> (= temp_14_1~2364@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ b14~116@)) (Add (Sub b14~116@ d14~120@) (Mul b14~116@ a14~114@))) (Mul (Sub (Add d14~120@ c14~118@) (Sub c14~118@ d14~120@)) (Mul (Sub b14~116@ b14~116@) (Mul b14~116@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2299@ temp_14_1~2364@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2444@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Sub b15~124@ d15~128@)) (Sub (Mul d15~128@ b15~124@) (Mul a15~122@ c15~126@))) (Mul (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ c15~126@)) (Add (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2509@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Sub b15~124@ d15~128@)) (Sub (Mul d15~128@ b15~124@) (Mul a15~122@ c15~126@))) (Mul (Mul (Mul (Mul b15~124@ a15~122@) b15~124@) c15~126@) (Add (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= tmp%16@ (= temp_15_0~2444@ temp_15_1~2509@)) (=> %%location_label%%15 tmp%16@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
