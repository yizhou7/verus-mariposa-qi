...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Add (Add (Mul (Mul d0~8@ d0~8@) (Sub c0~6@ b0~4@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ b0~4@)) d0~8@))) (=> (= temp_0_1~354@ (Add (Add (Sub (Mul (Mul d0~8@ d0~8@) c0~6@) (Mul (Mul d0~8@ d0~8@) b0~4@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ b0~4@)) d0~8@))) (=> (= tmp%1@ (= temp_0_0~293@ temp_0_1~354@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~434@ (Add (Add (Mul (Mul b1~12@ c1~14@) (Add a1~10@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ c1~14@))) (Add (Mul (Mul b1~12@ a1~10@) (Sub c1~14@ a1~10@)) (Mul (Sub b1~12@ c1~14@) (Add a1~10@ a1~10@))))) (=> (= temp_1_1~499@ (Add (Add (Mul b1~12@ (Mul c1~14@ (Add a1~10@ b1~12@))) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ c1~14@))) (Add (Mul (Mul b1~12@ a1~10@) (Sub c1~14@ a1~10@)) (Mul (Sub b1~12@ c1~14@) (Add a1~10@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~434@ temp_1_1~499@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~563@ (Mul a2~18@ (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ 14)) (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~612@ (Mul a2~18@ (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ 14)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~563@ temp_2_1~612@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~664@ (Mul d3~32@ (Sub (Sub (Mul b3~28@ c3~30@) (Sub d3~32@ a3~26@)) (Mul (Add c3~30@ d3~32@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~701@ (Mul (Sub (Sub (Mul b3~28@ c3~30@) (Sub d3~32@ a3~26@)) (Mul (Add c3~30@ d3~32@) (Mul c3~30@ d3~32@))) d3~32@)) (=> (= tmp%4@ (= temp_3_0~664@ temp_3_1~701@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~789@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul 62 d4~40@)) (Add (Mul c4~38@ b4~36@) (Sub c4~38@ d4~40@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ c4~38@)) (Sub d4~40@ (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~862@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul 62 d4~40@)) (Add (Mul c4~38@ b4~36@) (Sub c4~38@ d4~40@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@)) (Sub d4~40@ (Mul d4~40@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~789@ temp_4_1~862@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~930@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ c5~46@))) (Mul b5~44@ (Mul (Add c5~46@ b5~44@) (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~983@ (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ c5~46@)) (Mul b5~44@ (Mul (Add c5~46@ b5~44@) (Mul d5~48@ a5~42@)))))) (=> (= tmp%6@ (= temp_5_0~930@ temp_5_1~983@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1051@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Add c6~54@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ b6~52@))) (Mul (Sub (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) b6~52@))) (=> (= temp_6_1~1104@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Add c6~54@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ b6~52@))) (Mul (Sub (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) b6~52@))) (=> (= tmp%7@ (= temp_6_0~1051@ temp_6_1~1104@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1180@ (Mul (Sub (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@)) (Sub a7~58@ (Mul c7~62@ c7~62@))) (Mul (Mul (Add a7~58@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Add a7~58@ a7~58@) (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1273@ (Sub (Mul (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Mul (Add a7~58@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Add a7~58@ a7~58@) (Mul a7~58@ b7~60@)))) (Mul (Sub a7~58@ (Mul c7~62@ c7~62@)) (Mul (Mul (Add a7~58@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Add a7~58@ a7~58@) (Mul a7~58@ b7~60@)))))) (=> (= tmp%8@ (= temp_7_0~1180@ temp_7_1~1273@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1349@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) c8~70@) (Mul (Add a8~66@ a8~66@) (Mul b8~68@ b8~68@))) (Mul (Mul (Sub a8~66@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@))))) (=> (= temp_8_1~1410@ (Mul (Mul (Mul c8~70@ (Mul b8~68@ d8~72@)) (Mul (Add a8~66@ a8~66@) (Mul b8~68@ b8~68@))) (Mul (Mul (Sub a8~66@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1349@ temp_8_1~1410@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1486@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ c9~78@)) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ c9~78@))) (Mul (Sub (Add c9~78@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Sub c9~78@ c9~78@) d9~80@)))) (=> (= temp_9_1~1547@ (Mul (Mul (Mul (Mul (Mul d9~80@ b9~76@) d9~80@) c9~78@) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ c9~78@))) (Mul (Sub (Add c9~78@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Sub c9~78@ c9~78@) d9~80@)))) (=> (= tmp%10@ (= temp_9_0~1486@ temp_9_1~1547@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1627@ (Mul (Mul (Mul (Mul a10~82@ b10~84@) (Mul c10~86@ c10~86@)) (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ b10~84@))) (Mul (Mul (Add a10~82@ a10~82@) (Mul c10~86@ b10~84@)) (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~1692@ (Mul (Mul (Mul a10~82@ b10~84@) (Mul (Mul c10~86@ c10~86@) (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ b10~84@)))) (Mul (Mul (Add a10~82@ a10~82@) (Mul c10~86@ b10~84@)) (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1627@ temp_10_1~1692@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1764@ (Add (Mul (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@)) (Mul c11~94@ (Mul c11~94@ b11~92@))) (Sub (Add c11~94@ (Mul a11~90@ a11~90@)) (Mul (Mul d11~96@ c11~94@) (Sub d11~96@ a11~90@))))) (=> (= temp_11_1~1821@ (Add (Mul (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@)) (Mul (Mul c11~94@ b11~92@) c11~94@)) (Sub (Add c11~94@ (Mul a11~90@ a11~90@)) (Mul (Mul d11~96@ c11~94@) (Sub d11~96@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1764@ temp_11_1~1821@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1893@ (Mul (Sub (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ a12~98@)) (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ c12~102@))) (Mul (Mul c12~102@ b12~100@) (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~1950@ (Mul (Sub (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ a12~98@)) (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@))) (Mul (Mul c12~102@ b12~100@) (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~1893@ temp_12_1~1950@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2006@ (Mul (Sub (Mul (Add a13~106@ d13~112@) (Mul c13~110@ d13~112@)) (Mul (Mul d13~112@ c13~110@) (Sub c13~110@ d13~112@))) (Sub c13~110@ a13~106@))) (=> (= temp_13_1~2047@ (Mul (Sub (Mul (Add a13~106@ d13~112@) (Mul c13~110@ d13~112@)) (Mul d13~112@ (Mul c13~110@ (Sub c13~110@ d13~112@)))) (Sub c13~110@ a13~106@))) (=> (= tmp%14@ (= temp_13_0~2006@ temp_13_1~2047@)) (=> %%location_label%%13 tmp%14@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
