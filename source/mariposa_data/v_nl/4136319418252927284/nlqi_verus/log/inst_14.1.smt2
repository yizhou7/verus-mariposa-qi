...
(set-info :comment ";; mariposa_data/v_nl//4136319418252927284/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_7_1~1446@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Add (Add (Mul (Mul d0~8@ d0~8@) (Sub c0~6@ b0~4@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ b0~4@)) d0~8@))) (=> (= temp_0_1~354@ (Add (Add (Sub (Mul (Mul d0~8@ d0~8@) c0~6@) (Mul (Mul d0~8@ d0~8@) b0~4@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ b0~4@)) d0~8@))) (and (=> (= tmp%1@ (Mul d0~8@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~354@)))) (=> (= temp_0_0~293@ temp_0_1~354@) (=> (= temp_1_0~453@ (Add (Add (Mul (Mul b1~12@ c1~14@) (Add a1~10@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ c1~14@))) (Add (Mul (Mul b1~12@ a1~10@) (Sub c1~14@ a1~10@)) (Mul (Sub b1~12@ c1~14@) (Add a1~10@ a1~10@))))) (=> (= temp_1_1~518@ (Add (Add (Mul b1~12@ (Mul c1~14@ (Add a1~10@ b1~12@))) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ c1~14@))) (Add (Mul (Mul b1~12@ a1~10@) (Sub c1~14@ a1~10@)) (Mul (Sub b1~12@ c1~14@) (Add a1~10@ a1~10@))))) (and (=> (= tmp%2@ (Add a1~10@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b1~12@ c1~14@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~453@ temp_1_1~518@)))) (=> (= temp_1_0~453@ temp_1_1~518@) (=> (= temp_2_0~601@ (Mul a2~18@ (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ 14)) (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~650@ (Mul a2~18@ (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ 14)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ a2~18@) (=> %%location_label%%2 (= temp_2_0~601@ temp_2_1~650@))) (=> (= temp_2_0~601@ temp_2_1~650@) (=> (= temp_3_0~715@ (Mul d3~32@ (Sub (Sub (Mul b3~28@ c3~30@) (Sub d3~32@ a3~26@)) (Mul (Add c3~30@ d3~32@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~752@ (Mul (Sub (Sub (Mul b3~28@ c3~30@) (Sub d3~32@ a3~26@)) (Mul (Add c3~30@ d3~32@) (Mul c3~30@ d3~32@))) d3~32@)) (and (=> (= tmp%3@ (Sub (Sub (Mul b3~28@ c3~30@) (Sub d3~32@ a3~26@)) (Mul (Add c3~30@ d3~32@) (Mul c3~30@ d3~32@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~715@ temp_3_1~752@)))) (=> (= temp_3_0~715@ temp_3_1~752@) (=> (= temp_4_0~881@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul 62 d4~40@)) (Add (Mul c4~38@ b4~36@) (Sub c4~38@ d4~40@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ c4~38@)) (Sub d4~40@ (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~954@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul 62 d4~40@)) (Add (Mul c4~38@ b4~36@) (Sub c4~38@ d4~40@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@)) (Sub d4~40@ (Mul d4~40@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ a4~34@) (=> %%location_label%%4 (= temp_4_0~881@ temp_4_1~954@))) (=> (= temp_4_0~881@ temp_4_1~954@) (=> (= temp_5_0~1035@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ c5~46@))) (Mul b5~44@ (Mul (Add c5~46@ b5~44@) (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1088@ (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ c5~46@)) (Mul b5~44@ (Mul (Add c5~46@ b5~44@) (Mul d5~48@ a5~42@)))))) (and (=> (= tmp%4@ (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@))) (=> (= tmp%5@ (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ c5~46@))) (=> (= tmp%6@ (Mul b5~44@ (Mul (Add c5~46@ b5~44@) (Mul d5~48@ a5~42@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~1035@ temp_5_1~1088@)))))) (=> (= temp_5_0~1035@ temp_5_1~1088@) (=> (= temp_6_0~1211@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Add c6~54@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ b6~52@))) (Mul (Sub (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) b6~52@))) (=> (= temp_6_1~1264@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Add c6~54@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ b6~52@))) (Mul (Sub (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) b6~52@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1211@ temp_6_1~1264@))) (=> (= temp_6_0~1211@ temp_6_1~1264@) (=> (= temp_7_0~1353@ (Mul (Sub (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@)) (Sub a7~58@ (Mul c7~62@ c7~62@))) (Mul (Mul (Add a7~58@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Add a7~58@ a7~58@) (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1446@ (Sub (Mul (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Mul (Add a7~58@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Add a7~58@ a7~58@) (Mul a7~58@ b7~60@)))) (Mul (Sub a7~58@ (Mul c7~62@ c7~62@)) (Mul (Mul (Add a7~58@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Add a7~58@ a7~58@) (Mul a7~58@ b7~60@)))))) (and (=> (= tmp%7@ (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@))) (=> (= tmp%8@ (Sub a7~58@ (Mul c7~62@ c7~62@))) (=> (= tmp%9@ (Mul (Mul (Add a7~58@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Add a7~58@ a7~58@) (Mul a7~58@ b7~60@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%7 (= temp_7_0~1353@ temp_7_1~1446@)))))) (=> (= temp_7_0~1353@ temp_7_1~1446@) (=> (= temp_8_0~1585@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) c8~70@) (Mul (Add a8~66@ a8~66@) (Mul b8~68@ b8~68@))) (Mul (Mul (Sub a8~66@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@))))) (=> (= temp_8_1~1646@ (Mul (Mul (Mul c8~70@ (Mul b8~68@ d8~72@)) (Mul (Add a8~66@ a8~66@) (Mul b8~68@ b8~68@))) (Mul (Mul (Sub a8~66@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@))))) (and (=> (= tmp%10@ (Mul b8~68@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ c8~70@) (=> %%location_label%%8 (= temp_8_0~1585@ temp_8_1~1646@)))) (=> (= temp_8_0~1585@ temp_8_1~1646@) (=> (= temp_9_0~1739@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ c9~78@)) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ c9~78@))) (Mul (Sub (Add c9~78@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Sub c9~78@ c9~78@) d9~80@)))) (=> (= temp_9_1~1800@ (Mul (Mul (Mul (Mul (Mul d9~80@ b9~76@) d9~80@) c9~78@) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ c9~78@))) (Mul (Sub (Add c9~78@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Sub c9~78@ c9~78@) d9~80@)))) (and (=> (= tmp%11@ (Mul d9~80@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ d9~80@ c9~78@) (=> %%location_label%%9 (= temp_9_0~1739@ temp_9_1~1800@)))) (=> (= temp_9_0~1739@ temp_9_1~1800@) (=> (= temp_10_0~1899@ (Mul (Mul (Mul (Mul a10~82@ b10~84@) (Mul c10~86@ c10~86@)) (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ b10~84@))) (Mul (Mul (Add a10~82@ a10~82@) (Mul c10~86@ b10~84@)) (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~1964@ (Mul (Mul (Mul a10~82@ b10~84@) (Mul (Mul c10~86@ c10~86@) (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ b10~84@)))) (Mul (Mul (Add a10~82@ a10~82@) (Mul c10~86@ b10~84@)) (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ a10~82@))))) (and (=> (= tmp%12@ (Mul a10~82@ b10~84@)) (=> (= tmp%13@ (Mul c10~86@ c10~86@)) (=> (= tmp%14@ (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ b10~84@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%10 (= temp_10_0~1899@ temp_10_1~1964@)))))) (=> (= temp_10_0~1899@ temp_10_1~1964@) (=> (= temp_11_0~2071@ (Add (Mul (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@)) (Mul c11~94@ (Mul c11~94@ b11~92@))) (Sub (Add c11~94@ (Mul a11~90@ a11~90@)) (Mul (Mul d11~96@ c11~94@) (Sub d11~96@ a11~90@))))) (=> (= temp_11_1~2128@ (Add (Mul (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@)) (Mul (Mul c11~94@ b11~92@) c11~94@)) (Sub (Add c11~94@ (Mul a11~90@ a11~90@)) (Mul (Mul d11~96@ c11~94@) (Sub d11~96@ a11~90@))))) (and (=> (= tmp%15@ (Mul c11~94@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c11~94@ tmp%15@) (=> %%location_label%%11 (= temp_11_0~2071@ temp_11_1~2128@)))) (=> (= temp_11_0~2071@ temp_11_1~2128@) (=> (= temp_12_0~2217@ (Mul (Sub (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ a12~98@)) (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ c12~102@))) (Mul (Mul c12~102@ b12~100@) (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2274@ (Mul (Sub (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ a12~98@)) (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@))) (Mul (Mul c12~102@ b12~100@) (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ c12~102@))))) (and (=> (= tmp%16@ (Mul d12~104@ a12~98@)) (=> (= tmp%17@ (Mul b12~100@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%12 (= temp_12_0~2217@ temp_12_1~2274@))))) (=> (= temp_12_0~2217@ temp_12_1~2274@) (=> (= temp_13_0~2351@ (Mul (Sub (Mul (Add a13~106@ d13~112@) (Mul c13~110@ d13~112@)) (Mul (Mul d13~112@ c13~110@) (Sub c13~110@ d13~112@))) (Sub c13~110@ a13~106@))) (=> (= temp_13_1~2392@ (Mul (Sub (Mul (Add a13~106@ d13~112@) (Mul c13~110@ d13~112@)) (Mul d13~112@ (Mul c13~110@ (Sub c13~110@ d13~112@)))) (Sub c13~110@ a13~106@))) (=> (= tmp%18@ (Sub c13~110@ d13~112@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d13~112@ c13~110@ tmp%18@) (=> %%location_label%%13 (= temp_13_0~2351@ temp_13_1~2392@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
