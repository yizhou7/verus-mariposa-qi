     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~451@ (Add (Mul (Mul (Mul b1~12@ a1~10@) b1~12@) (Mul a1~10@ (Mul a1~10@ b1~12@)))
           (Mul (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@)) (Add (Mul d1~16@ c1~14@) (Sub d1~16@
              a1~10@
         )))))
         (=>
          (= temp_1_1~508@ (Add (Mul (Mul (Mul b1~12@ a1~10@) b1~12@) (Mul (Mul a1~10@ b1~12@)
              a1~10@
             )
            ) (Mul (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@)) (Add (Mul d1~16@ c1~14@) (Sub d1~16@
               a1~10@
          ...
          (and
           ...
           (=>
            (= temp_1_0~451@ temp_1_1~508@)
            (=>
             (= temp_2_0~605@ (Add (Mul (Sub (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@)) (Mul (Mul d2~24@
                  34
                 ) d2~24@
                )
             ...
             (=>
              (= temp_2_1~694@ (Add (Mul (Sub (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@)) (Mul (Mul d2~24@
                   34
                  ) d2~24@
                 )
