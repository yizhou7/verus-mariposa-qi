...
(set-info :comment ";; mariposa_data/v_nl//13452356439655812593/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Add a0~2@ c0~6@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ d0~8@)) (Mul b0~4@ (Mul a0~2@ (Add a0~2@ c0~6@)))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@))))) (and (=> (= tmp%1@ (Add a0~2@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ a0~2@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~461@ (Add (Mul (Mul (Mul b1~12@ a1~10@) b1~12@) (Mul a1~10@ (Mul a1~10@ b1~12@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@)) (Add (Mul d1~16@ c1~14@) (Sub d1~16@ a1~10@))))) (=> (= temp_1_1~518@ (Add (Mul (Mul (Mul b1~12@ a1~10@) b1~12@) (Mul (Mul a1~10@ b1~12@) a1~10@)) (Mul (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@)) (Add (Mul d1~16@ c1~14@) (Sub d1~16@ a1~10@))))) (and (=> (= tmp%2@ (Mul a1~10@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~461@ temp_1_1~518@)))) (=> (= temp_1_0~461@ temp_1_1~518@) (=> (= temp_2_0~623@ (Add (Mul (Sub (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@)) (Mul (Mul d2~24@ 34) d2~24@)) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ b2~20@)) (Add (Mul d2~24@ d2~24@) (Add c2~22@ a2~18@))))) (=> (= temp_2_1~712@ (Add (Mul (Sub (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@)) (Mul (Mul d2~24@ 34) d2~24@)) (Add (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ b2~20@)) (Mul d2~24@ d2~24@)) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ b2~20@)) (Add c2~22@ a2~18@))))) (=> (= tmp%3@ (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ b2~20@))) (=> (= tmp%4@ (Mul d2~24@ d2~24@)) (=> (= tmp%5@ (Add c2~22@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~623@ temp_2_1~712@)))))))))))))))))))
(assert %%query%%)
(check-sat)
