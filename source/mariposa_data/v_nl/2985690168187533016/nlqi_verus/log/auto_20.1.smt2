...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Sub c0~6@ a0~2@)) (Mul (Mul 22 d0~8@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul c0~6@ b0~4@) (Sub a0~2@ c0~6@)) (Mul a0~2@ (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~386@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Sub c0~6@ a0~2@)) (Mul (Mul d0~8@ 22) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul c0~6@ b0~4@) (Sub a0~2@ c0~6@)) (Mul a0~2@ (Mul d0~8@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~386@))) (=> (= temp_0_0~313@ temp_0_1~386@) (=> (= temp_1_0~499@ (Mul (Mul (Mul (Mul 71 16) (Mul d1~16@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ d1~16@))) (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Sub b1~12@ a1~10@))))) (=> (= temp_1_1~588@ (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Sub b1~12@ a1~10@))) (Mul (Mul (Mul 71 16) (Mul d1~16@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~499@ temp_1_1~588@))) (=> (= temp_1_0~499@ temp_1_1~588@) (=> (= temp_2_0~677@ (Mul (Mul (Add (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ d2~24@)) (Mul (Add a2~18@ d2~24@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~742@ (Mul (Mul (Add (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Add a2~18@ d2~24@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~677@ temp_2_1~742@))) (=> (= temp_2_0~677@ temp_2_1~742@) (=> (= temp_3_0~799@ (Mul c3~30@ (Mul (Mul (Sub a3~26@ b3~28@) a3~26@) (Mul (Mul b3~28@ d3~32@) (Add b3~28@ a3~26@))))) (=> (= temp_3_1~832@ (Mul c3~30@ (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ (Mul (Mul b3~28@ d3~32@) (Add b3~28@ a3~26@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~799@ temp_3_1~832@))) (=> (= temp_3_0~799@ temp_3_1~832@) (=> (= temp_4_0~921@ (Mul (Add (Mul (Add d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Add (Sub a4~34@ d4~40@) (Sub a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~986@ (Mul (Mul (Add (Mul (Add d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Add (Sub a4~34@ d4~40@) (Sub a4~34@ a4~34@))) (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@))) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ d4~40@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~921@ temp_4_1~986@))) (=> (= temp_4_0~921@ temp_4_1~986@) (=> (= temp_5_0~1075@ (Sub (Mul (Mul (Sub d5~48@ 73) (Sub d5~48@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@))) (Mul c5~46@ (Add (Mul c5~46@ a5~42@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1140@ (Sub (Mul (Mul (Sub d5~48@ 73) (Sub d5~48@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@))) (Mul (Add (Mul c5~46@ a5~42@) (Mul c5~46@ c5~46@)) c5~46@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1075@ temp_5_1~1140@))) (=> (= temp_5_0~1075@ temp_5_1~1140@) (=> (= temp_6_0~1237@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@)) (Mul a6~50@ (Mul b6~52@ a6~50@))) (Mul (Mul (Sub a6~50@ 78) (Mul b6~52@ d6~56@)) (Add (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1310@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ a6~50@)) (Mul a6~50@ (Mul b6~52@ a6~50@))) (Mul (Mul (Sub a6~50@ 78) (Mul b6~52@ d6~56@)) (Add (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1237@ temp_6_1~1310@))) (=> (= temp_6_0~1237@ temp_6_1~1310@) (=> (= temp_7_0~1399@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ d7~64@))) (Mul (Mul (Mul d7~64@ b7~60@) (Sub d7~64@ b7~60@)) (Sub (Mul c7~62@ b7~60@) (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1464@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Sub d7~64@ b7~60@)) (Sub (Mul c7~62@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1399@ temp_7_1~1464@))) (=> (= temp_7_0~1399@ temp_7_1~1464@) (=> (= temp_8_0~1565@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ c8~70@)) (Add (Sub d8~72@ 13) (Sub d8~72@ b8~68@))) (Mul (Mul (Add b8~68@ b8~68@) (Mul a8~66@ a8~66@)) (Sub (Mul b8~68@ b8~68@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1642@ (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Add (Sub d8~72@ 13) (Sub d8~72@ b8~68@)) (Mul (Mul (Add b8~68@ b8~68@) (Mul a8~66@ a8~66@)) (Sub (Mul b8~68@ b8~68@) (Mul b8~68@ a8~66@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1565@ temp_8_1~1642@))) (=> (= temp_8_0~1565@ temp_8_1~1642@) (=> (= temp_9_0~1731@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ a9~74@)) (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@))) (Mul (Mul (Sub d9~80@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~1796@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ a9~74@)) (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ b9~76@))) (Mul (Mul (Sub d9~80@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1731@ temp_9_1~1796@))) (=> (= temp_9_0~1731@ temp_9_1~1796@) (=> (= temp_10_0~1885@ (Mul (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ d10~88@)) (Add (Sub d10~88@ d10~88@) (Mul c10~86@ d10~88@))) (Mul (Mul (Add d10~88@ c10~86@) (Mul a10~82@ d10~88@)) (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~1950@ (Mul (Mul (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ d10~88@)) (Add (Sub d10~88@ d10~88@) (Mul c10~86@ d10~88@))) (Mul (Add d10~88@ c10~86@) (Mul a10~82@ d10~88@))) (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ c10~86@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1885@ temp_10_1~1950@))) (=> (= temp_10_0~1885@ temp_10_1~1950@) (=> (= temp_11_0~2047@ (Add (Mul (Mul (Mul 99 c11~94@) (Mul d11~96@ c11~94@)) (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@))) (Add (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ b11~92@)) (Mul b11~92@ (Add c11~94@ d11~96@))))) (=> (= temp_11_1~2120@ (Add (Mul (Mul (Mul 99 c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@))) (Add (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ b11~92@)) (Mul b11~92@ (Add c11~94@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2047@ temp_11_1~2120@))) (=> (= temp_11_0~2047@ temp_11_1~2120@) (=> (= temp_12_0~2209@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Add a12~98@ c12~102@)) (Add (Mul d12~104@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Mul (Add d12~104@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Sub b12~100@ d12~104@) (Mul a12~98@ b12~100@))))) (=> (= temp_12_1~2274@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Add a12~98@ c12~102@)) (Add (Mul d12~104@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Mul (Add d12~104@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Sub b12~100@ d12~104@) (Mul a12~98@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2209@ temp_12_1~2274@))) (=> (= temp_12_0~2209@ temp_12_1~2274@) (=> (= temp_13_0~2335@ (Mul d13~112@ (Mul (Mul (Mul d13~112@ c13~110@) (Mul a13~106@ a13~106@)) (Add (Sub a13~106@ c13~110@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2372@ (Mul d13~112@ (Mul (Mul (Mul a13~106@ a13~106@) (Mul d13~112@ c13~110@)) (Add (Sub a13~106@ c13~110@) (Mul c13~110@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2335@ temp_13_1~2372@))) (=> (= temp_13_0~2335@ temp_13_1~2372@) (=> (= temp_14_0~2461@ (Mul (Mul (Mul (Sub a14~114@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul b14~116@ d14~120@) (Sub d14~120@ d14~120@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@)) (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2526@ (Mul (Mul (Mul (Sub a14~114@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul b14~116@ d14~120@) (Sub d14~120@ d14~120@))) (Mul (Mul d14~120@ (Mul d14~120@ (Mul d14~120@ a14~114@))) (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2461@ temp_14_1~2526@))) (=> (= temp_14_0~2461@ temp_14_1~2526@) (=> (= temp_15_0~2599@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) d15~128@) (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ c15~126@))) (Mul d15~128@ (Mul (Mul c15~126@ a15~122@) (Sub a15~122@ a15~122@))))) (=> (= temp_15_1~2648@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) d15~128@) (Mul (Mul (Mul a15~122@ d15~128@) c15~126@) c15~126@)) (Mul d15~128@ (Mul (Mul c15~126@ a15~122@) (Sub a15~122@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2599@ temp_15_1~2648@))) (=> (= temp_15_0~2599@ temp_15_1~2648@) (=> (= temp_16_0~2769@ (Sub (Add (Mul (Mul 36 c16~134@) (Mul a16~130@ b16~132@)) (Mul (Add c16~134@ b16~132@) (Sub a16~130@ 12))) (Mul (Mul (Sub c16~134@ c16~134@) b16~132@) (Mul (Mul 93 a16~130@) (Add a16~130@ b16~132@))))) (=> (= temp_16_1~2866@ (Sub (Add (Mul (Mul 36 c16~134@) (Mul a16~130@ b16~132@)) (Mul (Add c16~134@ b16~132@) (Sub a16~130@ 12))) (Mul (Mul (Sub c16~134@ c16~134@) b16~132@) (Mul 93 (Mul a16~130@ (Add a16~130@ b16~132@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2769@ temp_16_1~2866@))) (=> (= temp_16_0~2769@ temp_16_1~2866@) (=> (= temp_17_0~2955@ (Mul (Mul (Mul (Sub a17~138@ d17~144@) (Mul c17~142@ b17~140@)) (Add (Mul a17~138@ d17~144@) (Mul d17~144@ a17~138@))) (Mul (Sub (Mul a17~138@ a17~138@) (Mul b17~140@ b17~140@)) (Mul (Mul c17~142@ c17~142@) (Mul a17~138@ c17~142@))))) (=> (= temp_17_1~3020@ (Mul (Mul (Mul (Sub a17~138@ d17~144@) (Mul c17~142@ b17~140@)) (Add (Mul a17~138@ d17~144@) (Mul d17~144@ a17~138@))) (Mul (Sub (Mul a17~138@ a17~138@) (Mul b17~140@ b17~140@)) (Mul (Mul c17~142@ c17~142@) (Mul a17~138@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2955@ temp_17_1~3020@))) (=> (= temp_17_0~2955@ temp_17_1~3020@) (=> (= temp_18_0~3109@ (Mul (Mul d18~152@ (Mul (Add c18~150@ c18~150@) (Mul c18~150@ c18~150@))) (Mul (Add (Mul b18~148@ d18~152@) (Add d18~152@ b18~148@)) (Mul (Mul b18~148@ 69) (Add b18~148@ a18~146@))))) (=> (= temp_18_1~3174@ (Mul (Mul d18~152@ (Mul (Add c18~150@ c18~150@) (Mul c18~150@ c18~150@))) (Mul (Add (Mul b18~148@ d18~152@) (Add d18~152@ b18~148@)) (Mul (Mul 69 b18~148@) (Add b18~148@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3109@ temp_18_1~3174@))) (=> (= temp_18_0~3109@ temp_18_1~3174@) (=> (= temp_19_0~3259@ (Mul (Mul (Mul (Mul c19~158@ b19~156@) (Mul a19~154@ d19~160@)) (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ b19~156@))) (Mul (Mul a19~154@ (Mul a19~154@ c19~158@)) (Mul (Mul d19~160@ a19~154@) (Add a19~154@ c19~158@))))) (=> (= temp_19_1~3320@ (Mul (Mul (Mul c19~158@ (Mul b19~156@ (Mul a19~154@ d19~160@))) (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ b19~156@))) (Mul (Mul a19~154@ (Mul a19~154@ c19~158@)) (Mul (Mul d19~160@ a19~154@) (Add a19~154@ c19~158@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3259@ temp_19_1~3320@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
