...
(set-info :comment ";; mariposa_data/v_nl//2985690168187533016/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_2_0~777@ Int)
...
(declare-const temp_5_0~1267@ Int)
(declare-const temp_5_1~1332@ Int)
(declare-const temp_6_0~1445@ Int)
(declare-const temp_6_1~1518@ Int)
(declare-const temp_7_0~1619@ Int)
(declare-const temp_7_1~1684@ Int)
(declare-const temp_8_0~1845@ Int)
(declare-const temp_8_1~1922@ Int)
...
(declare-const temp_11_1~2532@ Int)
(declare-const temp_12_0~2625@ Int)
(declare-const temp_12_1~2690@ Int)
(declare-const temp_13_0~2755@ Int)
(declare-const temp_13_1~2792@ Int)
(declare-const temp_14_0~2893@ Int)
(declare-const temp_14_1~2958@ Int)
(declare-const temp_15_0~3041@ Int)
(declare-const temp_15_1~3090@ Int)
(declare-const temp_16_0~3221@ Int)
(declare-const temp_16_1~3318@ Int)
(declare-const temp_17_0~3429@ Int)
(declare-const temp_17_1~3494@ Int)
(declare-const temp_18_0~3587@ Int)
(declare-const temp_18_1~3652@ Int)
(declare-const temp_19_0~3753@ Int)
(declare-const temp_19_1~3814@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Sub c0~6@ a0~2@)) (Mul (Mul 22 d0~8@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul c0~6@ b0~4@) (Sub a0~2@ c0~6@)) (Mul a0~2@ (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~386@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Sub c0~6@ a0~2@)) (Mul (Mul d0~8@ 22) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul c0~6@ b0~4@) (Sub a0~2@ c0~6@)) (Mul a0~2@ (Mul d0~8@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 22 d0~8@) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~386@))) (=> (= temp_0_0~313@ temp_0_1~386@) (=> (= temp_1_0~515@ (Mul (Mul (Mul (Mul 71 16) (Mul d1~16@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ d1~16@))) (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Sub b1~12@ a1~10@))))) (=> (= temp_1_1~604@ (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Sub b1~12@ a1~10@))) (Mul (Mul (Mul 71 16) (Mul d1~16@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ d1~16@))))) (and (=> (= tmp%1@ (Mul (Mul (Mul 71 16) (Mul d1~16@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ d1~16@)))) (=> (= tmp%2@ (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Sub b1~12@ a1~10@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~515@ temp_1_1~604@))))) (=> (= temp_1_0~515@ temp_1_1~604@) (=> (= temp_2_0~777@ (Mul (Mul (Add (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ d2~24@)) (Mul (Add a2~18@ d2~24@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~842@ (Mul (Mul (Add (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Add a2~18@ d2~24@) (Mul b2~20@ d2~24@))))) (and (=> (= tmp%3@ (Mul c2~22@ b2~20@)) (=> (= tmp%4@ (Mul c2~22@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~777@ temp_2_1~842@))))) (=> (= temp_2_0~777@ temp_2_1~842@) (=> (= temp_3_0~911@ (Mul c3~30@ (Mul (Mul (Sub a3~26@ b3~28@) a3~26@) (Mul (Mul b3~28@ d3~32@) (Add b3~28@ a3~26@))))) (=> (= temp_3_1~944@ (Mul c3~30@ (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ (Mul (Mul b3~28@ d3~32@) (Add b3~28@ a3~26@)))))) (and (=> (= tmp%5@ (Sub a3~26@ b3~28@)) (=> (= tmp%6@ (Mul (Mul b3~28@ d3~32@) (Add b3~28@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ a3~26@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~911@ temp_3_1~944@))))) (=> (= temp_3_0~911@ temp_3_1~944@) (=> (= temp_4_0~1055@ (Mul (Add (Mul (Add d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Add (Sub a4~34@ d4~40@) (Sub a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~1120@ (Mul (Mul (Add (Mul (Add d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Add (Sub a4~34@ d4~40@) (Sub a4~34@ a4~34@))) (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@))) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ d4~40@)))) (and (=> (= tmp%7@ (Add (Mul (Add d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Add (Sub a4~34@ d4~40@) (Sub a4~34@ a4~34@)))) (=> (= tmp%8@ (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@))) (=> (= tmp%9@ (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%4 (= temp_4_0~1055@ temp_4_1~1120@)))))) (=> (= temp_4_0~1055@ temp_4_1~1120@) (=> (= temp_5_0~1267@ (Sub (Mul (Mul (Sub d5~48@ 73) (Sub d5~48@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@))) (Mul c5~46@ (Add (Mul c5~46@ a5~42@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1332@ (Sub (Mul (Mul (Sub d5~48@ 73) (Sub d5~48@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@))) (Mul (Add (Mul c5~46@ a5~42@) (Mul c5~46@ c5~46@)) c5~46@))) (and (=> (= tmp%10@ (Add (Mul c5~46@ a5~42@) (Mul c5~46@ c5~46@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ tmp%10@) (=> %%location_label%%5 (= temp_5_0~1267@ temp_5_1~1332@)))) (=> (= temp_5_0~1267@ temp_5_1~1332@) (=> (= temp_6_0~1445@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@)) (Mul a6~50@ (Mul b6~52@ a6~50@))) (Mul (Mul (Sub a6~50@ 78) (Mul b6~52@ d6~56@)) (Add (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1518@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ a6~50@)) (Mul a6~50@ (Mul b6~52@ a6~50@))) (Mul (Mul (Sub a6~50@ 78) (Mul b6~52@ d6~56@)) (Add (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@))))) (and (=> (= tmp%11@ (Mul a6~50@ a6~50@)) (=> (= tmp%12@ (Mul b6~52@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%6 (= temp_6_0~1445@ temp_6_1~1518@))))) (=> (= temp_6_0~1445@ temp_6_1~1518@) (=> (= temp_7_0~1619@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ d7~64@))) (Mul (Mul (Mul d7~64@ b7~60@) (Sub d7~64@ b7~60@)) (Sub (Mul c7~62@ b7~60@) (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1684@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Sub d7~64@ b7~60@)) (Sub (Mul c7~62@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ d7~64@))))) (and (=> (= tmp%13@ (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ d7~64@)))) (=> (= tmp%14@ (Mul (Mul (Mul d7~64@ b7~60@) (Sub d7~64@ b7~60@)) (Sub (Mul c7~62@ b7~60@) (Mul c7~62@ b7~60@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%7 (= temp_7_0~1619@ temp_7_1~1684@))))) (=> (= temp_7_0~1619@ temp_7_1~1684@) (=> (= temp_8_0~1845@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ c8~70@)) (Add (Sub d8~72@ 13) (Sub d8~72@ b8~68@))) (Mul (Mul (Add b8~68@ b8~68@) (Mul a8~66@ a8~66@)) (Sub (Mul b8~68@ b8~68@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1922@ (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Add (Sub d8~72@ 13) (Sub d8~72@ b8~68@)) (Mul (Mul (Add b8~68@ b8~68@) (Mul a8~66@ a8~66@)) (Sub (Mul b8~68@ b8~68@) (Mul b8~68@ a8~66@)))))) (and (=> (= tmp%15@ (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ c8~70@))) (=> (= tmp%16@ (Add (Sub d8~72@ 13) (Sub d8~72@ b8~68@))) (=> (= tmp%17@ (Mul (Mul (Add b8~68@ b8~68@) (Mul a8~66@ a8~66@)) (Sub (Mul b8~68@ b8~68@) (Mul b8~68@ a8~66@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%8 (= temp_8_0~1845@ temp_8_1~1922@)))))) (=> (= temp_8_0~1845@ temp_8_1~1922@) (=> (= temp_9_0~2081@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ a9~74@)) (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@))) (Mul (Mul (Sub d9~80@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~2146@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ a9~74@)) (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ b9~76@))) (Mul (Mul (Sub d9~80@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ b9~76@) (=> %%location_label%%9 (= temp_9_0~2081@ temp_9_1~2146@))) (=> (= temp_9_0~2081@ temp_9_1~2146@) (=> (= temp_10_0~2239@ (Mul (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ d10~88@)) (Add (Sub d10~88@ d10~88@) (Mul c10~86@ d10~88@))) (Mul (Mul (Add d10~88@ c10~86@) (Mul a10~82@ d10~88@)) (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~2304@ (Mul (Mul (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ d10~88@)) (Add (Sub d10~88@ d10~88@) (Mul c10~86@ d10~88@))) (Mul (Add d10~88@ c10~86@) (Mul a10~82@ d10~88@))) (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ c10~86@)))) (and (=> (= tmp%18@ (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ d10~88@)) (Add (Sub d10~88@ d10~88@) (Mul c10~86@ d10~88@)))) (=> (= tmp%19@ (Mul (Add d10~88@ c10~86@) (Mul a10~82@ d10~88@))) (=> (= tmp%20@ (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ c10~86@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%10 (= temp_10_0~2239@ temp_10_1~2304@)))))) (=> (= temp_10_0~2239@ temp_10_1~2304@) (=> (= temp_11_0~2459@ (Add (Mul (Mul (Mul 99 c11~94@) (Mul d11~96@ c11~94@)) (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@))) (Add (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ b11~92@)) (Mul b11~92@ (Add c11~94@ d11~96@))))) (=> (= temp_11_1~2532@ (Add (Mul (Mul (Mul 99 c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@))) (Add (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ b11~92@)) (Mul b11~92@ (Add c11~94@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d11~96@ c11~94@) (=> %%location_label%%11 (= temp_11_0~2459@ temp_11_1~2532@))) (=> (= temp_11_0~2459@ temp_11_1~2532@) (=> (= temp_12_0~2625@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Add a12~98@ c12~102@)) (Add (Mul d12~104@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Mul (Add d12~104@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Sub b12~100@ d12~104@) (Mul a12~98@ b12~100@))))) (=> (= temp_12_1~2690@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Add a12~98@ c12~102@)) (Add (Mul d12~104@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Mul (Add d12~104@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Sub b12~100@ d12~104@) (Mul a12~98@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c12~102@ c12~102@) (=> %%location_label%%12 (= temp_12_0~2625@ temp_12_1~2690@))) (=> (= temp_12_0~2625@ temp_12_1~2690@) (=> (= temp_13_0~2755@ (Mul d13~112@ (Mul (Mul (Mul d13~112@ c13~110@) (Mul a13~106@ a13~106@)) (Add (Sub a13~106@ c13~110@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2792@ (Mul d13~112@ (Mul (Mul (Mul a13~106@ a13~106@) (Mul d13~112@ c13~110@)) (Add (Sub a13~106@ c13~110@) (Mul c13~110@ d13~112@))))) (and (=> (= tmp%21@ (Mul d13~112@ c13~110@)) (=> (= tmp%22@ (Mul a13~106@ a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%13 (= temp_13_0~2755@ temp_13_1~2792@))))) (=> (= temp_13_0~2755@ temp_13_1~2792@) (=> (= temp_14_0~2893@ (Mul (Mul (Mul (Sub a14~114@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul b14~116@ d14~120@) (Sub d14~120@ d14~120@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@)) (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2958@ (Mul (Mul (Mul (Sub a14~114@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul b14~116@ d14~120@) (Sub d14~120@ d14~120@))) (Mul (Mul d14~120@ (Mul d14~120@ (Mul d14~120@ a14~114@))) (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@))))) (and (=> (= tmp%23@ (Mul d14~120@ a14~114@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d14~120@ d14~120@ tmp%23@) (=> %%location_label%%14 (= temp_14_0~2893@ temp_14_1~2958@)))) (=> (= temp_14_0~2893@ temp_14_1~2958@) (=> (= temp_15_0~3041@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) d15~128@) (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ c15~126@))) (Mul d15~128@ (Mul (Mul c15~126@ a15~122@) (Sub a15~122@ a15~122@))))) (=> (= temp_15_1~3090@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) d15~128@) (Mul (Mul (Mul a15~122@ d15~128@) c15~126@) c15~126@)) (Mul d15~128@ (Mul (Mul c15~126@ a15~122@) (Sub a15~122@ a15~122@))))) (and (=> (= tmp%24@ (Mul a15~122@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ c15~126@ c15~126@) (=> %%location_label%%15 (= temp_15_0~3041@ temp_15_1~3090@)))) (=> (= temp_15_0~3041@ temp_15_1~3090@) (=> (= temp_16_0~3221@ (Sub (Add (Mul (Mul 36 c16~134@) (Mul a16~130@ b16~132@)) (Mul (Add c16~134@ b16~132@) (Sub a16~130@ 12))) (Mul (Mul (Sub c16~134@ c16~134@) b16~132@) (Mul (Mul 93 a16~130@) (Add a16~130@ b16~132@))))) (=> (= temp_16_1~3318@ (Sub (Add (Mul (Mul 36 c16~134@) (Mul a16~130@ b16~132@)) (Mul (Add c16~134@ b16~132@) (Sub a16~130@ 12))) (Mul (Mul (Sub c16~134@ c16~134@) b16~132@) (Mul 93 (Mul a16~130@ (Add a16~130@ b16~132@)))))) (and (=> (= tmp%25@ (Add a16~130@ b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. 93 a16~130@ tmp%25@) (=> %%location_label%%16 (= temp_16_0~3221@ temp_16_1~3318@)))) (=> (= temp_16_0~3221@ temp_16_1~3318@) (=> (= temp_17_0~3429@ (Mul (Mul (Mul (Sub a17~138@ d17~144@) (Mul c17~142@ b17~140@)) (Add (Mul a17~138@ d17~144@) (Mul d17~144@ a17~138@))) (Mul (Sub (Mul a17~138@ a17~138@) (Mul b17~140@ b17~140@)) (Mul (Mul c17~142@ c17~142@) (Mul a17~138@ c17~142@))))) (=> (= temp_17_1~3494@ (Mul (Mul (Mul (Sub a17~138@ d17~144@) (Mul c17~142@ b17~140@)) (Add (Mul a17~138@ d17~144@) (Mul d17~144@ a17~138@))) (Mul (Sub (Mul a17~138@ a17~138@) (Mul b17~140@ b17~140@)) (Mul (Mul c17~142@ c17~142@) (Mul a17~138@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a17~138@ a17~138@) (=> %%location_label%%17 (= temp_17_0~3429@ temp_17_1~3494@))) (=> (= temp_17_0~3429@ temp_17_1~3494@) (=> (= temp_18_0~3587@ (Mul (Mul d18~152@ (Mul (Add c18~150@ c18~150@) (Mul c18~150@ c18~150@))) (Mul (Add (Mul b18~148@ d18~152@) (Add d18~152@ b18~148@)) (Mul (Mul b18~148@ 69) (Add b18~148@ a18~146@))))) (=> (= temp_18_1~3652@ (Mul (Mul d18~152@ (Mul (Add c18~150@ c18~150@) (Mul c18~150@ c18~150@))) (Mul (Add (Mul b18~148@ d18~152@) (Add d18~152@ b18~148@)) (Mul (Mul 69 b18~148@) (Add b18~148@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b18~148@ 69) (=> %%location_label%%18 (= temp_18_0~3587@ temp_18_1~3652@))) (=> (= temp_18_0~3587@ temp_18_1~3652@) (=> (= temp_19_0~3753@ (Mul (Mul (Mul (Mul c19~158@ b19~156@) (Mul a19~154@ d19~160@)) (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ b19~156@))) (Mul (Mul a19~154@ (Mul a19~154@ c19~158@)) (Mul (Mul d19~160@ a19~154@) (Add a19~154@ c19~158@))))) (=> (= temp_19_1~3814@ (Mul (Mul (Mul c19~158@ (Mul b19~156@ (Mul a19~154@ d19~160@))) (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ b19~156@))) (Mul (Mul a19~154@ (Mul a19~154@ c19~158@)) (Mul (Mul d19~160@ a19~154@) (Add a19~154@ c19~158@))))) (=> (= tmp%26@ (Mul a19~154@ d19~160@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c19~158@ b19~156@ tmp%26@) (=> %%location_label%%19 (= temp_19_0~3753@ temp_19_1~3814@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
