...
(set-info :comment ";; mariposa_data/v_nl//12788800289914997896/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_10_0~2051@ Int)
(declare-const temp_10_1~2116@ Int)
(declare-const temp_11_0~2205@ Int)
(declare-const temp_11_1~2282@ Int)
(declare-const temp_12_0~2393@ Int)
(declare-const temp_12_1~2458@ Int)
(declare-const temp_13_0~2585@ Int)
(declare-const temp_13_1~2650@ Int)
...
(declare-const temp_17_0~3217@ Int)
(declare-const temp_17_1~3282@ Int)
(declare-const temp_18_0~3383@ Int)
(declare-const temp_18_1~3432@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Sub (Mul (Mul a0~2@ 50) (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul a0~2@ d0~8@) (Add d0~8@ c0~6@)) (Mul (Add b0~4@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~394@ (Mul (Mul (Sub (Mul (Mul a0~2@ 50) (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Mul a0~2@ d0~8@) (Add d0~8@ c0~6@))) (Mul (Add b0~4@ c0~6@) (Mul b0~4@ d0~8@)))) (and (=> (= tmp%1@ (Sub (Mul (Mul a0~2@ 50) (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@)))) (=> (= tmp%2@ (Mul (Mul a0~2@ d0~8@) (Add d0~8@ c0~6@))) (=> (= tmp%3@ (Mul (Add b0~4@ c0~6@) (Mul b0~4@ d0~8@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@)))))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~553@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ 35)) (Mul (Sub a1~10@ b1~12@) (Sub d1~16@ c1~14@))) (Sub (Add (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) c1~14@))) (=> (= temp_1_1~618@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ 35)) (Mul (Sub a1~10@ b1~12@) (Sub d1~16@ c1~14@))) (Sub (Add (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ a1~10@) (=> %%location_label%%1 (= temp_1_0~553@ temp_1_1~618@))) (=> (= temp_1_0~553@ temp_1_1~618@) (=> (= temp_2_0~707@ (Mul (Mul (Add (Mul d2~24@ c2~22@) a2~18@) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ d2~24@))) (Sub (Add (Add d2~24@ b2~20@) (Sub c2~22@ c2~22@)) (Mul (Add d2~24@ a2~18@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~768@ (Mul (Mul (Add (Mul d2~24@ c2~22@) a2~18@) (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@))) (Sub (Add (Add d2~24@ b2~20@) (Sub c2~22@ c2~22@)) (Mul (Add d2~24@ a2~18@) (Mul b2~20@ a2~18@))))) (and (=> (= tmp%4@ (Mul a2~18@ b2~20@)) (=> (= tmp%5@ (Mul c2~22@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~707@ temp_2_1~768@))))) (=> (= temp_2_0~707@ temp_2_1~768@) (=> (= temp_3_0~869@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~934@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul (Mul a3~26@ c3~30@) b3~28@) b3~28@) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ b3~28@))))) (and (=> (= tmp%6@ (Mul a3~26@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ b3~28@ b3~28@) (=> %%location_label%%3 (= temp_3_0~869@ temp_3_1~934@)))) (=> (= temp_3_0~869@ temp_3_1~934@) (=> (= temp_4_0~1045@ (Add (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul 35 a4~34@) (Add a4~34@ b4~36@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Sub (Mul d4~40@ d4~40@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~1122@ (Add (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul 35 a4~34@) (Add a4~34@ b4~36@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Sub (Mul d4~40@ d4~40@) (Mul a4~34@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ d4~40@) (=> %%location_label%%4 (= temp_4_0~1045@ temp_4_1~1122@))) (=> (= temp_4_0~1045@ temp_4_1~1122@) (=> (= temp_5_0~1207@ (Mul (Add (Mul (Mul a5~42@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Add c5~46@ (Mul d5~48@ d5~48@)) (Mul d5~48@ (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1276@ (Mul (Add (Mul (Mul a5~42@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@))) (Add (Mul c5~46@ (Mul d5~48@ (Mul d5~48@ a5~42@))) (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ (Mul d5~48@ a5~42@)))))) (and (=> (= tmp%7@ (Mul d5~48@ d5~48@)) (=> (= tmp%8@ (Mul d5~48@ (Mul d5~48@ a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c5~46@ tmp%7@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~1207@ temp_5_1~1276@))))) (=> (= temp_5_0~1207@ temp_5_1~1276@) (=> (= temp_6_0~1379@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@)) (Mul d6~56@ (Mul a6~50@ c6~54@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ d6~56@))))) (=> (= temp_6_1~1440@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@)) (Mul d6~56@ (Mul a6~50@ c6~54@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul (Mul c6~54@ c6~54@) a6~50@) d6~56@)))) (and (=> (= tmp%9@ (Mul c6~54@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ a6~50@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1379@ temp_6_1~1440@)))) (=> (= temp_6_0~1379@ temp_6_1~1440@) (=> (= temp_7_0~1559@ (Sub (Mul (Sub (Mul 64 a7~58@) (Sub 75 c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ c7~62@))) (Mul (Add (Mul a7~58@ b7~60@) (Add b7~60@ a7~58@)) (Mul a7~58@ (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1644@ (Sub (Mul (Sub (Mul 64 a7~58@) (Sub 75 c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@))) (Mul (Add (Mul a7~58@ b7~60@) (Add b7~60@ a7~58@)) (Mul a7~58@ (Mul a7~58@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ c7~62@) (=> %%location_label%%7 (= temp_7_0~1559@ temp_7_1~1644@))) (=> (= temp_7_0~1559@ temp_7_1~1644@) (=> (= temp_8_0~1733@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Sub b8~68@ b8~68@) (Sub a8~66@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) (Add b8~68@ d8~72@)) (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~1802@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Sub b8~68@ b8~68@) (Sub a8~66@ c8~70@))) (Mul (Add (Mul (Mul b8~68@ c8~70@) b8~68@) (Mul (Mul b8~68@ c8~70@) d8~72@)) (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@))))) (and (=> (= tmp%10@ (Mul b8~68@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%10@ b8~68@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1733@ temp_8_1~1802@)))) (=> (= temp_8_0~1733@ temp_8_1~1802@) (=> (= temp_9_0~1897@ (Mul (Sub (Add (Mul a9~74@ d9~80@) c9~78@) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ c9~78@))) (Mul (Sub (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@)) (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~1958@ (Mul (Sub (Add (Mul a9~74@ d9~80@) c9~78@) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ a9~74@))) (Mul (Sub (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@)) (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a9~74@ c9~78@) (=> %%location_label%%9 (= temp_9_0~1897@ temp_9_1~1958@))) (=> (= temp_9_0~1897@ temp_9_1~1958@) (=> (= temp_10_0~2051@ (Add (Mul (Mul (Sub c10~86@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))))) (=> (= temp_10_1~2116@ (Add (Mul (Mul (Sub c10~86@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ c10~86@) (=> %%location_label%%10 (= temp_10_0~2051@ temp_10_1~2116@))) (=> (= temp_10_0~2051@ temp_10_1~2116@) (=> (= temp_11_0~2205@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) (Sub d11~96@ c11~94@)) (Mul (Sub d11~96@ c11~94@) (Sub d11~96@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Add b11~92@ c11~94@)) (Sub (Mul d11~96@ a11~90@) c11~94@)))) (=> (= temp_11_1~2282@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) (Sub d11~96@ c11~94@)) (Mul (Sub d11~96@ c11~94@) (Sub d11~96@ b11~92@))) (Sub (Mul (Mul (Mul a11~90@ c11~94@) (Add b11~92@ c11~94@)) (Mul d11~96@ a11~90@)) (Mul (Mul (Mul a11~90@ c11~94@) (Add b11~92@ c11~94@)) c11~94@)))) (and (=> (= tmp%11@ (Mul (Mul a11~90@ c11~94@) (Add b11~92@ c11~94@))) (=> (= tmp%12@ (Mul d11~96@ a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ tmp%12@ c11~94@) (=> %%location_label%%11 (= temp_11_0~2205@ temp_11_1~2282@))))) (=> (= temp_11_0~2205@ temp_11_1~2282@) (=> (= temp_12_0~2393@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ b12~100@) (Mul 35 d12~104@))) (Mul c12~102@ (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~2458@ (Mul (Mul (Mul b12~100@ c12~102@) (Mul (Mul d12~104@ b12~100@) (Mul (Mul c12~102@ b12~100@) (Mul 35 d12~104@)))) (Mul c12~102@ (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@))))) (and (=> (= tmp%13@ (Mul b12~100@ c12~102@)) (=> (= tmp%14@ (Mul d12~104@ b12~100@)) (=> (= tmp%15@ (Mul (Mul c12~102@ b12~100@) (Mul 35 d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%12 (= temp_12_0~2393@ temp_12_1~2458@)))))) (=> (= temp_12_0~2393@ temp_12_1~2458@) (=> (= temp_13_0~2585@ (Sub (Mul (Mul (Mul d13~112@ b13~108@) (Sub a13~106@ a13~106@)) (Mul (Sub d13~112@ d13~112@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Sub c13~110@ a13~106@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2650@ (Sub (Mul (Mul (Mul d13~112@ b13~108@) (Sub a13~106@ a13~106@)) (Mul (Sub d13~112@ d13~112@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul (Sub c13~110@ a13~106@) c13~110@) d13~112@)))) (and (=> (= tmp%16@ (Sub c13~110@ a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ c13~110@ d13~112@) (=> %%location_label%%13 (= temp_13_0~2585@ temp_13_1~2650@)))) (=> (= temp_13_0~2585@ temp_13_1~2650@) (=> (= temp_14_0~2733@ (Sub (Sub (Sub (Mul d14~120@ d14~120@) (Mul c14~118@ d14~120@)) (Add (Mul b14~116@ b14~116@) d14~120@)) (Mul c14~118@ (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ c14~118@))))) (=> (= temp_14_1~2782@ (Sub (Sub (Sub (Mul d14~120@ d14~120@) (Mul c14~118@ d14~120@)) (Add (Mul b14~116@ b14~116@) d14~120@)) (Mul (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ c14~118@)) c14~118@))) (and (=> (= tmp%17@ (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ c14~118@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c14~118@ tmp%17@) (=> %%location_label%%14 (= temp_14_0~2733@ temp_14_1~2782@)))) (=> (= temp_14_0~2733@ temp_14_1~2782@) (=> (= temp_15_0~2887@ (Mul (Sub (Add (Mul b15~124@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ d15~128@))) (Mul (Mul (Mul b15~124@ b15~124@) (Sub a15~122@ c15~126@)) (Mul (Mul b15~124@ c15~126@) (Mul c15~126@ b15~124@))))) (=> (= temp_15_1~2952@ (Mul (Sub (Add (Mul a15~122@ b15~124@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ d15~128@))) (Mul (Mul (Mul b15~124@ b15~124@) (Sub a15~122@ c15~126@)) (Mul (Mul b15~124@ c15~126@) (Mul c15~126@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b15~124@ a15~122@) (=> %%location_label%%15 (= temp_15_0~2887@ temp_15_1~2952@))) (=> (= temp_15_0~2887@ temp_15_1~2952@) (=> (= temp_16_0~3045@ (Mul (Mul (Mul (Sub a16~130@ d16~136@) (Sub b16~132@ c16~134@)) (Mul (Add a16~130@ d16~136@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Sub d16~136@ c16~134@))))) (=> (= temp_16_1~3118@ (Mul (Mul (Sub (Mul (Sub a16~130@ d16~136@) b16~132@) (Mul (Sub a16~130@ d16~136@) c16~134@)) (Mul (Add a16~130@ d16~136@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Sub d16~136@ c16~134@))))) (and (=> (= tmp%18@ (Sub a16~130@ d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%18@ b16~132@ c16~134@) (=> %%location_label%%16 (= temp_16_0~3045@ temp_16_1~3118@)))) (=> (= temp_16_0~3045@ temp_16_1~3118@) (=> (= temp_17_0~3217@ (Mul (Mul (Mul (Sub b17~140@ b17~140@) (Sub a17~138@ b17~140@)) (Sub (Add d17~144@ c17~142@) (Sub a17~138@ a17~138@))) (Mul (Sub (Mul c17~142@ b17~140@) (Mul b17~140@ d17~144@)) (Sub (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@))))) (=> (= temp_17_1~3282@ (Mul (Mul (Sub (Add d17~144@ c17~142@) (Sub a17~138@ a17~138@)) (Mul (Sub b17~140@ b17~140@) (Sub a17~138@ b17~140@))) (Mul (Sub (Mul c17~142@ b17~140@) (Mul b17~140@ d17~144@)) (Sub (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@))))) (and (=> (= tmp%19@ (Mul (Sub b17~140@ b17~140@) (Sub a17~138@ b17~140@))) (=> (= tmp%20@ (Sub (Add d17~144@ c17~142@) (Sub a17~138@ a17~138@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%17 (= temp_17_0~3217@ temp_17_1~3282@))))) (=> (= temp_17_0~3217@ temp_17_1~3282@) (=> (= temp_18_0~3383@ (Sub (Mul a18~146@ (Mul (Mul b18~148@ d18~152@) (Mul b18~148@ b18~148@))) (Add (Add b18~148@ (Mul d18~152@ d18~152@)) (Mul (Mul d18~152@ a18~146@) (Mul b18~148@ d18~152@))))) (=> (= temp_18_1~3432@ (Sub (Mul a18~146@ (Mul (Mul b18~148@ d18~152@) (Mul b18~148@ b18~148@))) (Add (Add b18~148@ (Mul d18~152@ d18~152@)) (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ a18~146@))))) (=> (= tmp%21@ (Mul d18~152@ a18~146@)) (=> (= tmp%22@ (Mul b18~148@ d18~152@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%18 (= temp_18_0~3383@ temp_18_1~3432@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
