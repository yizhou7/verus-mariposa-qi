...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Sub (Mul (Mul a0~2@ 50) (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul a0~2@ d0~8@) (Add d0~8@ c0~6@)) (Mul (Add b0~4@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~394@ (Mul (Mul (Sub (Mul (Mul a0~2@ 50) (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Mul a0~2@ d0~8@) (Add d0~8@ c0~6@))) (Mul (Add b0~4@ c0~6@) (Mul b0~4@ d0~8@)))) (=> (= tmp%1@ (= temp_0_0~317@ temp_0_1~394@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~474@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ 35)) (Mul (Sub a1~10@ b1~12@) (Sub d1~16@ c1~14@))) (Sub (Add (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) c1~14@))) (=> (= temp_1_1~539@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ 35)) (Mul (Sub a1~10@ b1~12@) (Sub d1~16@ c1~14@))) (Sub (Add (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) c1~14@))) (=> (= tmp%2@ (= temp_1_0~474@ temp_1_1~539@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~615@ (Mul (Mul (Add (Mul d2~24@ c2~22@) a2~18@) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ d2~24@))) (Sub (Add (Add d2~24@ b2~20@) (Sub c2~22@ c2~22@)) (Mul (Add d2~24@ a2~18@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~676@ (Mul (Mul (Add (Mul d2~24@ c2~22@) a2~18@) (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@))) (Sub (Add (Add d2~24@ b2~20@) (Sub c2~22@ c2~22@)) (Mul (Add d2~24@ a2~18@) (Mul b2~20@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~615@ temp_2_1~676@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~756@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~821@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul (Mul a3~26@ c3~30@) b3~28@) b3~28@) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~756@ temp_3_1~821@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~913@ (Add (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul 35 a4~34@) (Add a4~34@ b4~36@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Sub (Mul d4~40@ d4~40@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~990@ (Add (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul 35 a4~34@) (Add a4~34@ b4~36@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) (Sub (Mul d4~40@ d4~40@) (Mul a4~34@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~913@ temp_4_1~990@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1062@ (Mul (Add (Mul (Mul a5~42@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Add c5~46@ (Mul d5~48@ d5~48@)) (Mul d5~48@ (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1131@ (Mul (Add (Mul (Mul a5~42@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@))) (Add (Mul c5~46@ (Mul d5~48@ (Mul d5~48@ a5~42@))) (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ (Mul d5~48@ a5~42@)))))) (=> (= tmp%6@ (= temp_5_0~1062@ temp_5_1~1131@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1207@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@)) (Mul d6~56@ (Mul a6~50@ c6~54@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ d6~56@))))) (=> (= temp_6_1~1268@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@)) (Mul d6~56@ (Mul a6~50@ c6~54@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul (Mul c6~54@ c6~54@) a6~50@) d6~56@)))) (=> (= tmp%7@ (= temp_6_0~1207@ temp_6_1~1268@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1368@ (Sub (Mul (Sub (Mul 64 a7~58@) (Sub 75 c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ c7~62@))) (Mul (Add (Mul a7~58@ b7~60@) (Add b7~60@ a7~58@)) (Mul a7~58@ (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1453@ (Sub (Mul (Sub (Mul 64 a7~58@) (Sub 75 c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@))) (Mul (Add (Mul a7~58@ b7~60@) (Add b7~60@ a7~58@)) (Mul a7~58@ (Mul a7~58@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1368@ temp_7_1~1453@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1529@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Sub b8~68@ b8~68@) (Sub a8~66@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) (Add b8~68@ d8~72@)) (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~1598@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Sub b8~68@ b8~68@) (Sub a8~66@ c8~70@))) (Mul (Add (Mul (Mul b8~68@ c8~70@) b8~68@) (Mul (Mul b8~68@ c8~70@) d8~72@)) (Add (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1529@ temp_8_1~1598@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1674@ (Mul (Sub (Add (Mul a9~74@ d9~80@) c9~78@) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ c9~78@))) (Mul (Sub (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@)) (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~1735@ (Mul (Sub (Add (Mul a9~74@ d9~80@) c9~78@) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ a9~74@))) (Mul (Sub (Mul b9~76@ d9~80@) (Add c9~78@ a9~74@)) (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1674@ temp_9_1~1735@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1815@ (Add (Mul (Mul (Sub c10~86@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))))) (=> (= temp_10_1~1880@ (Add (Mul (Mul (Sub c10~86@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))))) (=> (= tmp%11@ (= temp_10_0~1815@ temp_10_1~1880@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1956@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) (Sub d11~96@ c11~94@)) (Mul (Sub d11~96@ c11~94@) (Sub d11~96@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Add b11~92@ c11~94@)) (Sub (Mul d11~96@ a11~90@) c11~94@)))) (=> (= temp_11_1~2033@ (Mul (Mul (Mul (Mul c11~94@ c11~94@) (Sub d11~96@ c11~94@)) (Mul (Sub d11~96@ c11~94@) (Sub d11~96@ b11~92@))) (Sub (Mul (Mul (Mul a11~90@ c11~94@) (Add b11~92@ c11~94@)) (Mul d11~96@ a11~90@)) (Mul (Mul (Mul a11~90@ c11~94@) (Add b11~92@ c11~94@)) c11~94@)))) (=> (= tmp%12@ (= temp_11_0~1956@ temp_11_1~2033@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2113@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ b12~100@) (Mul 35 d12~104@))) (Mul c12~102@ (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~2178@ (Mul (Mul (Mul b12~100@ c12~102@) (Mul (Mul d12~104@ b12~100@) (Mul (Mul c12~102@ b12~100@) (Mul 35 d12~104@)))) (Mul c12~102@ (Sub (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@))))) (=> (= tmp%13@ (= temp_12_0~2113@ temp_12_1~2178@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2258@ (Sub (Mul (Mul (Mul d13~112@ b13~108@) (Sub a13~106@ a13~106@)) (Mul (Sub d13~112@ d13~112@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Sub c13~110@ a13~106@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2323@ (Sub (Mul (Mul (Mul d13~112@ b13~108@) (Sub a13~106@ a13~106@)) (Mul (Sub d13~112@ d13~112@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul (Sub c13~110@ a13~106@) c13~110@) d13~112@)))) (=> (= tmp%14@ (= temp_13_0~2258@ temp_13_1~2323@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2387@ (Sub (Sub (Sub (Mul d14~120@ d14~120@) (Mul c14~118@ d14~120@)) (Add (Mul b14~116@ b14~116@) d14~120@)) (Mul c14~118@ (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ c14~118@))))) (=> (= temp_14_1~2436@ (Sub (Sub (Sub (Mul d14~120@ d14~120@) (Mul c14~118@ d14~120@)) (Add (Mul b14~116@ b14~116@) d14~120@)) (Mul (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ c14~118@)) c14~118@))) (=> (= tmp%15@ (= temp_14_0~2387@ temp_14_1~2436@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2516@ (Mul (Sub (Add (Mul b15~124@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ d15~128@))) (Mul (Mul (Mul b15~124@ b15~124@) (Sub a15~122@ c15~126@)) (Mul (Mul b15~124@ c15~126@) (Mul c15~126@ b15~124@))))) (=> (= temp_15_1~2581@ (Mul (Sub (Add (Mul a15~122@ b15~124@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ d15~128@))) (Mul (Mul (Mul b15~124@ b15~124@) (Sub a15~122@ c15~126@)) (Mul (Mul b15~124@ c15~126@) (Mul c15~126@ b15~124@))))) (=> (= tmp%16@ (= temp_15_0~2516@ temp_15_1~2581@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2661@ (Mul (Mul (Mul (Sub a16~130@ d16~136@) (Sub b16~132@ c16~134@)) (Mul (Add a16~130@ d16~136@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Sub d16~136@ c16~134@))))) (=> (= temp_16_1~2734@ (Mul (Mul (Sub (Mul (Sub a16~130@ d16~136@) b16~132@) (Mul (Sub a16~130@ d16~136@) c16~134@)) (Mul (Add a16~130@ d16~136@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Sub d16~136@ c16~134@))))) (=> (= tmp%17@ (= temp_16_0~2661@ temp_16_1~2734@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2814@ (Mul (Mul (Mul (Sub b17~140@ b17~140@) (Sub a17~138@ b17~140@)) (Sub (Add d17~144@ c17~142@) (Sub a17~138@ a17~138@))) (Mul (Sub (Mul c17~142@ b17~140@) (Mul b17~140@ d17~144@)) (Sub (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@))))) (=> (= temp_17_1~2879@ (Mul (Mul (Sub (Add d17~144@ c17~142@) (Sub a17~138@ a17~138@)) (Mul (Sub b17~140@ b17~140@) (Sub a17~138@ b17~140@))) (Mul (Sub (Mul c17~142@ b17~140@) (Mul b17~140@ d17~144@)) (Sub (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@))))) (=> (= tmp%18@ (= temp_17_0~2814@ temp_17_1~2879@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2943@ (Sub (Mul a18~146@ (Mul (Mul b18~148@ d18~152@) (Mul b18~148@ b18~148@))) (Add (Add b18~148@ (Mul d18~152@ d18~152@)) (Mul (Mul d18~152@ a18~146@) (Mul b18~148@ d18~152@))))) (=> (= temp_18_1~2992@ (Sub (Mul a18~146@ (Mul (Mul b18~148@ d18~152@) (Mul b18~148@ b18~148@))) (Add (Add b18~148@ (Mul d18~152@ d18~152@)) (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ a18~146@))))) (=> (= tmp%19@ (= temp_18_0~2943@ temp_18_1~2992@)) (=> %%location_label%%18 tmp%19@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
