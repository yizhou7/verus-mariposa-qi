...
(set-info :comment ";; mariposa_data/v_nl//7298262002629773612/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_4_0~1029@ Int)
(declare-const temp_4_1~1090@ Int)
(declare-const temp_5_0~1181@ Int)
...
(declare-const temp_9_0~1913@ Int)
(declare-const temp_9_1~1982@ Int)
(declare-const temp_10_0~2081@ Int)
(declare-const temp_10_1~2146@ Int)
(declare-const temp_11_0~2261@ Int)
(declare-const temp_11_1~2326@ Int)
...
(declare-const temp_14_1~2728@ Int)
(declare-const temp_15_0~2821@ Int)
(declare-const temp_15_1~2886@ Int)
(declare-const temp_16_0~2999@ Int)
(declare-const temp_16_1~3076@ Int)
(declare-const temp_17_0~3189@ Int)
(declare-const temp_17_1~3266@ Int)
(declare-const temp_18_0~3357@ Int)
(declare-const temp_18_1~3414@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Sub (Sub a0~2@ (Mul (Mul 76 c0~6@) (Mul d0~8@ a0~2@))) (Mul a0~2@ (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~346@ (Sub (Sub a0~2@ (Mul (Mul 76 c0~6@) (Mul d0~8@ a0~2@))) (Mul a0~2@ (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@))))) (and (=> (= tmp%1@ (Mul d0~8@ a0~2@)) (=> (= tmp%2@ (Mul b0~4@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@))))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~447@ (Mul (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ a1~10@))) (Mul (Add (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Sub d1~16@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~512@ (Mul (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ a1~10@))) (Mul (Add (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul (Sub d1~16@ b1~12@) c1~14@) d1~16@)))) (and (=> (= tmp%3@ (Sub d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ c1~14@ d1~16@) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~512@)))) (=> (= temp_1_0~447@ temp_1_1~512@) (=> (= temp_2_0~639@ (Mul (Add (Mul 23 (Mul 26 a2~18@)) (Mul a2~18@ (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul 98 a2~18@))))) (=> (= temp_2_1~732@ (Mul (Add (Mul 23 (Mul a2~18@ 26)) (Mul a2~18@ (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul 98 a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 26 a2~18@) (=> %%location_label%%2 (= temp_2_0~639@ temp_2_1~732@))) (=> (= temp_2_0~639@ temp_2_1~732@) (=> (= temp_3_0~849@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Add d3~32@ 91)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub c3~30@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@))))) (=> (= temp_3_1~934@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Add d3~32@ 91)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Sub (Mul (Mul c3~30@ d3~32@) c3~30@) (Mul (Mul c3~30@ d3~32@) d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@))))) (and (=> (= tmp%4@ (Mul c3~30@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ c3~30@ d3~32@) (=> %%location_label%%3 (= temp_3_0~849@ temp_3_1~934@)))) (=> (= temp_3_0~849@ temp_3_1~934@) (=> (= temp_4_0~1029@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ d4~40@) c4~38@)) (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@))))) (=> (= temp_4_1~1090@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ d4~40@) c4~38@)) (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@)) (Mul d4~40@ (Mul d4~40@ (Mul a4~34@ a4~34@)))))) (and (=> (= tmp%5@ (Mul a4~34@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d4~40@ d4~40@ tmp%5@) (=> %%location_label%%4 (= temp_4_0~1029@ temp_4_1~1090@)))) (=> (= temp_4_0~1029@ temp_4_1~1090@) (=> (= temp_5_0~1181@ (Mul (Mul (Sub (Mul c5~46@ d5~48@) (Mul c5~46@ d5~48@)) (Mul c5~46@ (Sub b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ a5~42@)) (Mul a5~42@ (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1238@ (Mul (Mul (Sub (Mul c5~46@ d5~48@) (Mul c5~46@ d5~48@)) (Mul c5~46@ (Sub b5~44@ a5~42@))) (Mul (Mul a5~42@ d5~48@) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ (Mul d5~48@ c5~46@)))))) (and (=> (= tmp%6@ (Mul a5~42@ d5~48@)) (=> (= tmp%7@ (Mul b5~44@ a5~42@)) (=> (= tmp%8@ (Mul a5~42@ (Mul d5~48@ c5~46@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~1181@ temp_5_1~1238@)))))) (=> (= temp_5_0~1181@ temp_5_1~1238@) (=> (= temp_6_0~1349@ (Add (Add (Mul (Sub d6~56@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Add a6~50@ c6~54@) (Mul b6~52@ c6~54@))) (Mul (Mul (Sub a6~50@ c6~54@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1414@ (Add (Add (Mul (Sub d6~56@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Add a6~50@ c6~54@) (Mul b6~52@ c6~54@))) (Mul (Sub a6~50@ c6~54@) (Mul (Mul d6~56@ b6~52@) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@)))))) (and (=> (= tmp%9@ (Sub a6~50@ c6~54@)) (=> (= tmp%10@ (Mul d6~56@ b6~52@)) (=> (= tmp%11@ (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%6 (= temp_6_0~1349@ temp_6_1~1414@)))))) (=> (= temp_6_0~1349@ temp_6_1~1414@) (=> (= temp_7_0~1553@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul a7~58@ a7~58@))) (Sub (Sub (Mul 22 1) (Mul c7~62@ a7~58@)) (Add (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1642@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul a7~58@ a7~58@))) (Sub (Sub (Mul 1 22) (Mul c7~62@ a7~58@)) (Add (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 22 1) (=> %%location_label%%7 (= temp_7_0~1553@ temp_7_1~1642@))) (=> (= temp_7_0~1553@ temp_7_1~1642@) (=> (= temp_8_0~1755@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ b8~68@)) (Sub (Sub d8~72@ c8~70@) (Add b8~68@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) c8~70@) (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@))))) (=> (= temp_8_1~1816@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ b8~68@)) (Sub (Sub d8~72@ c8~70@) (Add b8~68@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) c8~70@) (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1755@ temp_8_1~1816@))) (=> (= temp_8_0~1755@ temp_8_1~1816@) (=> (= temp_9_0~1913@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) a9~74@) (Mul (Mul a9~74@ a9~74@) (Mul b9~76@ a9~74@))) (Mul (Mul (Mul 99 a9~74@) d9~80@) (Mul (Add c9~78@ c9~78@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1982@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) a9~74@) (Mul a9~74@ (Mul a9~74@ (Mul b9~76@ a9~74@)))) (Mul (Mul (Mul 99 a9~74@) d9~80@) (Mul (Add c9~78@ c9~78@) (Mul a9~74@ c9~78@))))) (and (=> (= tmp%12@ (Mul b9~76@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a9~74@ a9~74@ tmp%12@) (=> %%location_label%%9 (= temp_9_0~1913@ temp_9_1~1982@)))) (=> (= temp_9_0~1913@ temp_9_1~1982@) (=> (= temp_10_0~2081@ (Add (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ c10~86@) (Mul d10~88@ b10~84@))) (Mul (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~2146@ (Add (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ c10~86@) (Mul d10~88@ b10~84@))) (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@)) (Mul a10~82@ d10~88@)) (Mul c10~86@ b10~84@)))) (and (=> (= tmp%13@ (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@))) (=> (= tmp%14@ (Mul a10~82@ d10~88@)) (=> (= tmp%15@ (Mul c10~86@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%10 (= temp_10_0~2081@ temp_10_1~2146@)))))) (=> (= temp_10_0~2081@ temp_10_1~2146@) (=> (= temp_11_0~2261@ (Mul (Add (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ d11~96@)) (Add (Mul d11~96@ d11~96@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ a11~90@) (Sub b11~92@ a11~90@)) (Mul (Add a11~90@ a11~90@) (Mul c11~94@ a11~90@))))) (=> (= temp_11_1~2326@ (Mul (Add (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ d11~96@)) (Add (Mul d11~96@ d11~96@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ a11~90@) (Sub b11~92@ a11~90@)) (Mul (Add a11~90@ a11~90@) (Mul c11~94@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d11~96@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2261@ temp_11_1~2326@))) (=> (= temp_11_0~2261@ temp_11_1~2326@) (=> (= temp_12_0~2415@ (Mul (Mul (Mul d12~104@ (Mul b12~100@ a12~98@)) (Add (Mul b12~100@ a12~98@) (Mul c12~102@ a12~98@))) (Mul (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Sub c12~102@ b12~100@) (Add b12~100@ d12~104@))))) (=> (= temp_12_1~2476@ (Mul (Mul (Mul d12~104@ (Mul b12~100@ a12~98@)) (Add (Mul a12~98@ b12~100@) (Mul c12~102@ a12~98@))) (Mul (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Sub c12~102@ b12~100@) (Add b12~100@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2415@ temp_12_1~2476@))) (=> (= temp_12_0~2415@ temp_12_1~2476@) (=> (= temp_13_0~2541@ (Mul (Sub (Mul (Mul d13~112@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Add d13~112@ d13~112@) (Sub b13~108@ c13~110@))) b13~108@)) (=> (= temp_13_1~2578@ (Mul (Sub (Mul (Mul d13~112@ c13~110@) (Mul b13~108@ a13~106@)) (Mul (Add d13~112@ d13~112@) (Sub b13~108@ c13~110@))) b13~108@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a13~106@ b13~108@) (=> %%location_label%%13 (= temp_13_0~2541@ temp_13_1~2578@))) (=> (= temp_13_0~2541@ temp_13_1~2578@) (=> (= temp_14_0~2667@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Sub d14~120@ d14~120@))) (Mul (Mul (Mul c14~118@ c14~118@) d14~120@) (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2728@ (Mul (Mul (Mul (Mul b14~116@ c14~118@) (Mul c14~118@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Sub d14~120@ d14~120@))) (Mul (Mul (Mul c14~118@ c14~118@) d14~120@) (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c14~118@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2667@ temp_14_1~2728@))) (=> (= temp_14_0~2667@ temp_14_1~2728@) (=> (= temp_15_0~2821@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ c15~126@)) (Mul (Sub b15~124@ b15~124@) (Mul a15~122@ c15~126@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ b15~124@)) (Mul (Add d15~128@ b15~124@) (Add b15~124@ d15~128@))))) (=> (= temp_15_1~2886@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ c15~126@)) (Mul (Sub b15~124@ b15~124@) (Mul a15~122@ c15~126@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ b15~124@)) (Mul (Add b15~124@ d15~128@) (Add d15~128@ b15~124@))))) (and (=> (= tmp%16@ (Add d15~128@ b15~124@)) (=> (= tmp%17@ (Add b15~124@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%15 (= temp_15_0~2821@ temp_15_1~2886@))))) (=> (= temp_15_0~2821@ temp_15_1~2886@) (=> (= temp_16_0~2999@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ 45)) (Mul (Mul d16~136@ d16~136@) (Sub c16~134@ c16~134@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul c16~134@ d16~136@) (Mul c16~134@ b16~132@))))) (=> (= temp_16_1~3076@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ 45)) (Mul (Mul d16~136@ d16~136@) (Sub c16~134@ c16~134@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ d16~136@))))) (and (=> (= tmp%18@ (Mul c16~134@ d16~136@)) (=> (= tmp%19@ (Mul c16~134@ b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%16 (= temp_16_0~2999@ temp_16_1~3076@))))) (=> (= temp_16_0~2999@ temp_16_1~3076@) (=> (= temp_17_0~3189@ (Sub (Mul (Mul (Sub d17~144@ d17~144@) (Add 16 c17~142@)) (Sub (Mul a17~138@ d17~144@) (Mul a17~138@ c17~142@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul d17~144@ c17~142@)) (Mul (Mul b17~140@ b17~140@) (Add b17~140@ b17~140@))))) (=> (= temp_17_1~3266@ (Sub (Mul (Mul (Sub d17~144@ d17~144@) (Add 16 c17~142@)) (Sub (Mul a17~138@ d17~144@) (Mul a17~138@ c17~142@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul d17~144@ c17~142@)) (Mul b17~140@ (Mul b17~140@ (Add b17~140@ b17~140@)))))) (and (=> (= tmp%20@ (Add b17~140@ b17~140@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b17~140@ b17~140@ tmp%20@) (=> %%location_label%%17 (= temp_17_0~3189@ temp_17_1~3266@)))) (=> (= temp_17_0~3189@ temp_17_1~3266@) (=> (= temp_18_0~3357@ (Add (Mul (Mul (Sub c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ a18~146@))) (Mul (Mul (Mul d18~152@ a18~146@) d18~152@) (Mul (Sub c18~150@ a18~146@) c18~150@)))) (=> (= temp_18_1~3414@ (Add (Mul (Mul (Sub c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ a18~146@))) (Mul (Mul d18~152@ (Mul a18~146@ d18~152@)) (Mul (Sub c18~150@ a18~146@) c18~150@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. d18~152@ a18~146@ d18~152@) (=> %%location_label%%18 (= temp_18_0~3357@ temp_18_1~3414@))) (=> (= temp_18_0~3357@ temp_18_1~3414@) (=> (= temp_19_0~3509@ (Mul (Mul (Add (Mul d19~160@ d19~160@) (Mul d19~160@ c19~158@)) c19~158@) (Mul (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ d19~160@)) (Sub (Mul b19~156@ 93) (Add b19~156@ d19~160@))))) (=> (= temp_19_1~3574@ (Mul (Mul (Mul (Add (Mul d19~160@ d19~160@) (Mul d19~160@ c19~158@)) c19~158@) (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ d19~160@))) (Sub (Mul b19~156@ 93) (Add b19~156@ d19~160@)))) (=> (= tmp%21@ (Mul (Add (Mul d19~160@ d19~160@) (Mul d19~160@ c19~158@)) c19~158@)) (=> (= tmp%22@ (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ d19~160@))) (=> (= tmp%23@ (Sub (Mul b19~156@ 93) (Add b19~156@ d19~160@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%19 (= temp_19_0~3509@ temp_19_1~3574@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
