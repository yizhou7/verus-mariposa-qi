...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Sub (Sub a0~2@ (Mul (Mul 76 c0~6@) (Mul d0~8@ a0~2@))) (Mul a0~2@ (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~346@ (Sub (Sub a0~2@ (Mul (Mul 76 c0~6@) (Mul d0~8@ a0~2@))) (Mul a0~2@ (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~435@ (Mul (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ a1~10@))) (Mul (Add (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Sub d1~16@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~500@ (Mul (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ a1~10@))) (Mul (Add (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul (Sub d1~16@ b1~12@) c1~14@) d1~16@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~435@ temp_1_1~500@))) (=> (= temp_1_0~435@ temp_1_1~500@) (=> (= temp_2_0~617@ (Mul (Add (Mul 23 (Mul 26 a2~18@)) (Mul a2~18@ (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul 98 a2~18@))))) (=> (= temp_2_1~710@ (Mul (Add (Mul 23 (Mul a2~18@ 26)) (Mul a2~18@ (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul 98 a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~617@ temp_2_1~710@))) (=> (= temp_2_0~617@ temp_2_1~710@) (=> (= temp_3_0~811@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Add d3~32@ 91)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub c3~30@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@))))) (=> (= temp_3_1~896@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Add d3~32@ 91)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Sub (Mul (Mul c3~30@ d3~32@) c3~30@) (Mul (Mul c3~30@ d3~32@) d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~811@ temp_3_1~896@))) (=> (= temp_3_0~811@ temp_3_1~896@) (=> (= temp_4_0~981@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ d4~40@) c4~38@)) (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@))))) (=> (= temp_4_1~1042@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ d4~40@) c4~38@)) (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@)) (Mul d4~40@ (Mul d4~40@ (Mul a4~34@ a4~34@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~981@ temp_4_1~1042@))) (=> (= temp_4_0~981@ temp_4_1~1042@) (=> (= temp_5_0~1123@ (Mul (Mul (Sub (Mul c5~46@ d5~48@) (Mul c5~46@ d5~48@)) (Mul c5~46@ (Sub b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ a5~42@)) (Mul a5~42@ (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1180@ (Mul (Mul (Sub (Mul c5~46@ d5~48@) (Mul c5~46@ d5~48@)) (Mul c5~46@ (Sub b5~44@ a5~42@))) (Mul (Mul a5~42@ d5~48@) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ (Mul d5~48@ c5~46@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1123@ temp_5_1~1180@))) (=> (= temp_5_0~1123@ temp_5_1~1180@) (=> (= temp_6_0~1269@ (Add (Add (Mul (Sub d6~56@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Add a6~50@ c6~54@) (Mul b6~52@ c6~54@))) (Mul (Mul (Sub a6~50@ c6~54@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1334@ (Add (Add (Mul (Sub d6~56@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Add a6~50@ c6~54@) (Mul b6~52@ c6~54@))) (Mul (Sub a6~50@ c6~54@) (Mul (Mul d6~56@ b6~52@) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1269@ temp_6_1~1334@))) (=> (= temp_6_0~1269@ temp_6_1~1334@) (=> (= temp_7_0~1447@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul a7~58@ a7~58@))) (Sub (Sub (Mul 22 1) (Mul c7~62@ a7~58@)) (Add (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1536@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul a7~58@ a7~58@))) (Sub (Sub (Mul 1 22) (Mul c7~62@ a7~58@)) (Add (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1447@ temp_7_1~1536@))) (=> (= temp_7_0~1447@ temp_7_1~1536@) (=> (= temp_8_0~1621@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ b8~68@)) (Sub (Sub d8~72@ c8~70@) (Add b8~68@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) c8~70@) (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@))))) (=> (= temp_8_1~1682@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ b8~68@)) (Sub (Sub d8~72@ c8~70@) (Add b8~68@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) c8~70@) (Mul (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1621@ temp_8_1~1682@))) (=> (= temp_8_0~1621@ temp_8_1~1682@) (=> (= temp_9_0~1775@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) a9~74@) (Mul (Mul a9~74@ a9~74@) (Mul b9~76@ a9~74@))) (Mul (Mul (Mul 99 a9~74@) d9~80@) (Mul (Add c9~78@ c9~78@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1844@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) a9~74@) (Mul a9~74@ (Mul a9~74@ (Mul b9~76@ a9~74@)))) (Mul (Mul (Mul 99 a9~74@) d9~80@) (Mul (Add c9~78@ c9~78@) (Mul a9~74@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1775@ temp_9_1~1844@))) (=> (= temp_9_0~1775@ temp_9_1~1844@) (=> (= temp_10_0~1933@ (Add (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ c10~86@) (Mul d10~88@ b10~84@))) (Mul (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@)) (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~1998@ (Add (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ c10~86@) (Mul d10~88@ b10~84@))) (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@)) (Mul a10~82@ d10~88@)) (Mul c10~86@ b10~84@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1933@ temp_10_1~1998@))) (=> (= temp_10_0~1933@ temp_10_1~1998@) (=> (= temp_11_0~2087@ (Mul (Add (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ d11~96@)) (Add (Mul d11~96@ d11~96@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ a11~90@) (Sub b11~92@ a11~90@)) (Mul (Add a11~90@ a11~90@) (Mul c11~94@ a11~90@))))) (=> (= temp_11_1~2152@ (Mul (Add (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ d11~96@)) (Add (Mul d11~96@ d11~96@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ a11~90@) (Sub b11~92@ a11~90@)) (Mul (Add a11~90@ a11~90@) (Mul c11~94@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2087@ temp_11_1~2152@))) (=> (= temp_11_0~2087@ temp_11_1~2152@) (=> (= temp_12_0~2237@ (Mul (Mul (Mul d12~104@ (Mul b12~100@ a12~98@)) (Add (Mul b12~100@ a12~98@) (Mul c12~102@ a12~98@))) (Mul (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Sub c12~102@ b12~100@) (Add b12~100@ d12~104@))))) (=> (= temp_12_1~2298@ (Mul (Mul (Mul d12~104@ (Mul b12~100@ a12~98@)) (Add (Mul a12~98@ b12~100@) (Mul c12~102@ a12~98@))) (Mul (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Sub c12~102@ b12~100@) (Add b12~100@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2237@ temp_12_1~2298@))) (=> (= temp_12_0~2237@ temp_12_1~2298@) (=> (= temp_13_0~2359@ (Mul (Sub (Mul (Mul d13~112@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Add d13~112@ d13~112@) (Sub b13~108@ c13~110@))) b13~108@)) (=> (= temp_13_1~2396@ (Mul (Sub (Mul (Mul d13~112@ c13~110@) (Mul b13~108@ a13~106@)) (Mul (Add d13~112@ d13~112@) (Sub b13~108@ c13~110@))) b13~108@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2359@ temp_13_1~2396@))) (=> (= temp_13_0~2359@ temp_13_1~2396@) (=> (= temp_14_0~2481@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Sub d14~120@ d14~120@))) (Mul (Mul (Mul c14~118@ c14~118@) d14~120@) (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2542@ (Mul (Mul (Mul (Mul b14~116@ c14~118@) (Mul c14~118@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Sub d14~120@ d14~120@))) (Mul (Mul (Mul c14~118@ c14~118@) d14~120@) (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2481@ temp_14_1~2542@))) (=> (= temp_14_0~2481@ temp_14_1~2542@) (=> (= temp_15_0~2631@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ c15~126@)) (Mul (Sub b15~124@ b15~124@) (Mul a15~122@ c15~126@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ b15~124@)) (Mul (Add d15~128@ b15~124@) (Add b15~124@ d15~128@))))) (=> (= temp_15_1~2696@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ c15~126@)) (Mul (Sub b15~124@ b15~124@) (Mul a15~122@ c15~126@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ b15~124@)) (Mul (Add b15~124@ d15~128@) (Add d15~128@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2631@ temp_15_1~2696@))) (=> (= temp_15_0~2631@ temp_15_1~2696@) (=> (= temp_16_0~2797@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ 45)) (Mul (Mul d16~136@ d16~136@) (Sub c16~134@ c16~134@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul c16~134@ d16~136@) (Mul c16~134@ b16~132@))))) (=> (= temp_16_1~2874@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ 45)) (Mul (Mul d16~136@ d16~136@) (Sub c16~134@ c16~134@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2797@ temp_16_1~2874@))) (=> (= temp_16_0~2797@ temp_16_1~2874@) (=> (= temp_17_0~2975@ (Sub (Mul (Mul (Sub d17~144@ d17~144@) (Add 16 c17~142@)) (Sub (Mul a17~138@ d17~144@) (Mul a17~138@ c17~142@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul d17~144@ c17~142@)) (Mul (Mul b17~140@ b17~140@) (Add b17~140@ b17~140@))))) (=> (= temp_17_1~3052@ (Sub (Mul (Mul (Sub d17~144@ d17~144@) (Add 16 c17~142@)) (Sub (Mul a17~138@ d17~144@) (Mul a17~138@ c17~142@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul d17~144@ c17~142@)) (Mul b17~140@ (Mul b17~140@ (Add b17~140@ b17~140@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2975@ temp_17_1~3052@))) (=> (= temp_17_0~2975@ temp_17_1~3052@) (=> (= temp_18_0~3133@ (Add (Mul (Mul (Sub c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ a18~146@))) (Mul (Mul (Mul d18~152@ a18~146@) d18~152@) (Mul (Sub c18~150@ a18~146@) c18~150@)))) (=> (= temp_18_1~3190@ (Add (Mul (Mul (Sub c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ a18~146@))) (Mul (Mul d18~152@ (Mul a18~146@ d18~152@)) (Mul (Sub c18~150@ a18~146@) c18~150@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3133@ temp_18_1~3190@))) (=> (= temp_18_0~3133@ temp_18_1~3190@) (=> (= temp_19_0~3279@ (Mul (Mul (Add (Mul d19~160@ d19~160@) (Mul d19~160@ c19~158@)) c19~158@) (Mul (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ d19~160@)) (Sub (Mul b19~156@ 93) (Add b19~156@ d19~160@))))) (=> (= temp_19_1~3344@ (Mul (Mul (Mul (Add (Mul d19~160@ d19~160@) (Mul d19~160@ c19~158@)) c19~158@) (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ d19~160@))) (Sub (Mul b19~156@ 93) (Add b19~156@ d19~160@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3279@ temp_19_1~3344@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
