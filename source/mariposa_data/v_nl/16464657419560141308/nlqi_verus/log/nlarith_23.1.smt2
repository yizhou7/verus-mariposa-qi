...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@))) (Mul (Mul (Add d0~8@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Mul (Mul d0~8@ a0~2@) b0~4@) d0~8@)) (Mul (Mul (Add d0~8@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~450@ (Mul (Mul (Add (Mul c1~14@ a1~10@) (Sub c1~14@ b1~12@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~515@ (Mul (Mul (Add (Mul c1~14@ a1~10@) (Sub c1~14@ b1~12@)) (Mul a1~10@ (Mul c1~14@ (Mul d1~16@ a1~10@)))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~450@ temp_1_1~515@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~583@ (Mul (Mul (Sub (Mul d2~24@ d2~24@) (Sub a2~18@ a2~18@)) (Mul (Sub a2~18@ d2~24@) (Mul d2~24@ b2~20@))) (Mul (Mul (Add d2~24@ d2~24@) (Mul c2~22@ c2~22@)) d2~24@))) (=> (= temp_2_1~636@ (Mul (Mul (Sub (Mul d2~24@ d2~24@) (Sub a2~18@ a2~18@)) (Mul (Sub a2~18@ d2~24@) (Mul d2~24@ b2~20@))) (Mul d2~24@ (Mul (Add d2~24@ d2~24@) (Mul c2~22@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~583@ temp_2_1~636@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~704@ (Mul (Mul (Mul (Sub c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ d3~32@))) (Mul b3~28@ (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~757@ (Mul (Mul (Mul (Sub c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@))) (Mul b3~28@ (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~704@ temp_3_1~757@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~837@ (Mul (Sub (Mul (Mul a4~34@ d4~40@) (Add a4~34@ d4~40@)) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@))) (Sub (Mul (Mul b4~36@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~902@ (Mul (Sub (Mul a4~34@ (Mul d4~40@ (Add a4~34@ d4~40@))) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@))) (Sub (Mul (Mul b4~36@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~837@ temp_4_1~902@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~978@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (Mul (Add c5~46@ (Mul b5~44@ c5~46@)) (Mul (Add b5~44@ a5~42@) (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1039@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ d5~48@))) (Mul (Add c5~46@ (Mul b5~44@ c5~46@)) (Mul (Add b5~44@ a5~42@) (Mul a5~42@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~978@ temp_5_1~1039@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1107@ (Sub (Add (Mul (Add c6~54@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@))) (Mul a6~50@ (Add (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1160@ (Sub (Add (Mul (Add c6~54@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@))) (Mul a6~50@ (Add (Mul a6~50@ b6~52@) (Mul b6~52@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1107@ temp_6_1~1160@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1236@ (Mul (Mul (Mul (Add d7~64@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ a7~58@))) (Mul (Mul (Sub d7~64@ d7~64@) (Sub a7~58@ c7~62@)) (Mul a7~58@ (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1297@ (Mul (Mul (Mul (Add d7~64@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ a7~58@))) (Mul (Mul (Mul (Sub d7~64@ d7~64@) (Sub a7~58@ c7~62@)) a7~58@) (Mul a7~58@ b7~60@)))) (=> (= tmp%8@ (= temp_7_0~1236@ temp_7_1~1297@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1349@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Add d8~72@ a8~66@)) (Add (Mul a8~66@ d8~72@) (Mul b8~68@ d8~72@))) a8~66@)) (=> (= temp_8_1~1386@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Add d8~72@ a8~66@)) (Add (Mul a8~66@ d8~72@) (Mul d8~72@ b8~68@))) a8~66@)) (=> (= tmp%9@ (= temp_8_0~1349@ temp_8_1~1386@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1466@ (Mul (Sub (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ b9~76@)) (Mul (Add c9~78@ b9~76@) (Mul b9~76@ a9~74@))) (Mul (Mul (Sub a9~74@ c9~78@) (Mul c9~78@ d9~80@)) (Add (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1531@ (Mul (Sub (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Add c9~78@ b9~76@) (Mul b9~76@ a9~74@))) (Mul (Mul (Sub a9~74@ c9~78@) (Mul c9~78@ d9~80@)) (Add (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1466@ temp_9_1~1531@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1611@ (Add (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@)) (Add (Sub c10~86@ a10~82@) (Mul b10~84@ d10~88@))) (Mul (Mul (Add d10~88@ b10~84@) (Mul b10~84@ a10~82@)) (Add (Mul a10~82@ a10~82@) (Add c10~86@ a10~82@))))) (=> (= temp_10_1~1692@ (Add (Add (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@)) (Sub c10~86@ a10~82@)) (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@)) (Mul b10~84@ d10~88@))) (Mul (Mul (Add d10~88@ b10~84@) (Mul b10~84@ a10~82@)) (Add (Mul a10~82@ a10~82@) (Add c10~86@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1611@ temp_10_1~1692@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1760@ (Sub (Sub d11~96@ (Add (Mul b11~92@ a11~90@) (Mul c11~94@ b11~92@))) (Mul (Mul (Add a11~90@ b11~92@) (Sub c11~94@ c11~94@)) (Mul (Mul b11~92@ c11~94@) (Sub d11~96@ d11~96@))))) (=> (= temp_11_1~1813@ (Sub (Sub d11~96@ (Add (Mul b11~92@ a11~90@) (Mul c11~94@ b11~92@))) (Mul (Mul (Add a11~90@ b11~92@) (Sub c11~94@ c11~94@)) (Mul b11~92@ (Mul c11~94@ (Sub d11~96@ d11~96@)))))) (=> (= tmp%12@ (= temp_11_0~1760@ temp_11_1~1813@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1905@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ 81) (Mul c12~102@ b12~100@))) (Sub (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ a12~98@))))) (=> (= temp_12_1~1982@ (Mul (Mul (Mul (Mul b12~100@ 81) (Mul c12~102@ b12~100@)) (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ a12~98@))) (Sub (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ a12~98@))))) (=> (= tmp%13@ (= temp_12_0~1905@ temp_12_1~1982@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2058@ (Add (Mul (Mul (Mul b13~108@ c13~110@) (Add a13~106@ c13~110@)) (Mul (Mul a13~106@ d13~112@) (Mul c13~110@ c13~110@))) (Mul (Add (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@)) (Mul a13~106@ (Add c13~110@ a13~106@))))) (=> (= temp_13_1~2119@ (Add (Mul (Mul (Mul (Mul b13~108@ c13~110@) (Add a13~106@ c13~110@)) (Mul a13~106@ d13~112@)) (Mul c13~110@ c13~110@)) (Mul (Add (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@)) (Mul a13~106@ (Add c13~110@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2058@ temp_13_1~2119@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2183@ (Add (Mul (Mul d14~120@ (Sub a14~114@ b14~116@)) (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul a14~114@ b14~116@) (Add b14~116@ a14~114@)) b14~116@))) (=> (= temp_14_1~2232@ (Add (Mul (Mul (Sub a14~114@ b14~116@) d14~120@) (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul a14~114@ b14~116@) (Add b14~116@ a14~114@)) b14~116@))) (=> (= tmp%15@ (= temp_14_0~2183@ temp_14_1~2232@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2312@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul a15~122@ d15~128@) (Sub b15~124@ c15~126@))) (Mul (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ a15~122@)) (Sub (Mul b15~124@ b15~124@) (Sub c15~126@ c15~126@))))) (=> (= temp_15_1~2377@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Mul c15~126@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Sub b15~124@ c15~126@))) (Mul (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ a15~122@)) (Sub (Mul b15~124@ b15~124@) (Sub c15~126@ c15~126@))))) (=> (= tmp%16@ (= temp_15_0~2312@ temp_15_1~2377@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2449@ (Mul (Sub (Mul (Mul a16~130@ b16~132@) d16~136@) (Mul c16~134@ (Add b16~132@ a16~130@))) (Mul (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul a16~130@ a16~130@) (Mul d16~136@ c16~134@))))) (=> (= temp_16_1~2506@ (Mul (Sub (Mul (Mul b16~132@ a16~130@) d16~136@) (Mul c16~134@ (Add b16~132@ a16~130@))) (Mul (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul a16~130@ a16~130@) (Mul d16~136@ c16~134@))))) (=> (= tmp%17@ (= temp_16_0~2449@ temp_16_1~2506@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2570@ (Add (Mul (Mul (Add c17~142@ a17~138@) (Mul a17~138@ d17~144@)) c17~142@) (Mul (Sub (Mul a17~138@ d17~144@) c17~142@) (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ b17~140@))))) (=> (= temp_17_1~2627@ (Add (Mul (Add (Mul c17~142@ (Mul a17~138@ d17~144@)) (Mul a17~138@ (Mul a17~138@ d17~144@))) c17~142@) (Mul (Sub (Mul a17~138@ d17~144@) c17~142@) (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ b17~140@))))) (=> (= tmp%18@ (= temp_17_0~2570@ temp_17_1~2627@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2707@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Add b18~148@ b18~148@)) (Mul (Mul d18~152@ c18~150@) (Sub d18~152@ a18~146@))) (Mul (Mul (Add a18~146@ c18~150@) (Mul a18~146@ b18~148@)) (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ d18~152@))))) (=> (= temp_18_1~2780@ (Mul (Mul (Add (Mul (Mul a18~146@ c18~150@) b18~148@) (Mul (Mul a18~146@ c18~150@) b18~148@)) (Mul (Mul d18~152@ c18~150@) (Sub d18~152@ a18~146@))) (Mul (Mul (Add a18~146@ c18~150@) (Mul a18~146@ b18~148@)) (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ d18~152@))))) (=> (= tmp%19@ (= temp_18_0~2707@ temp_18_1~2780@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2872@ (Add (Mul (Add (Mul a19~154@ c19~158@) (Mul c19~158@ b19~156@)) (Add (Mul b19~156@ c19~158@) (Mul b19~156@ a19~154@))) (Mul (Mul (Mul d19~160@ 40) (Mul a19~154@ b19~156@)) (Mul (Mul d19~160@ d19~160@) (Add b19~156@ a19~154@))))) (=> (= temp_19_1~2949@ (Add (Mul (Add (Mul a19~154@ c19~158@) (Mul c19~158@ b19~156@)) (Add (Mul b19~156@ c19~158@) (Mul b19~156@ a19~154@))) (Mul (Mul (Mul 40 d19~160@) (Mul a19~154@ b19~156@)) (Mul (Mul d19~160@ d19~160@) (Add b19~156@ a19~154@))))) (=> (= tmp%20@ (= temp_19_0~2872@ temp_19_1~2949@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3029@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Sub b20~164@ b20~164@)) (Sub (Mul a20~162@ d20~168@) (Add b20~164@ c20~166@))) (Mul (Mul (Mul a20~162@ b20~164@) (Sub b20~164@ b20~164@)) (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ b20~164@))))) (=> (= temp_20_1~3094@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Sub b20~164@ b20~164@)) (Sub (Mul a20~162@ d20~168@) (Add b20~164@ c20~166@))) (Mul (Mul (Mul b20~164@ a20~162@) (Sub b20~164@ b20~164@)) (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ b20~164@))))) (=> (= tmp%21@ (= temp_20_0~3029@ temp_20_1~3094@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3162@ (Mul (Mul (Mul (Mul b21~172@ d21~176@) (Mul b21~172@ b21~172@)) (Mul (Mul b21~172@ d21~176@) (Mul a21~170@ c21~174@))) (Mul (Mul (Sub b21~172@ c21~174@) (Mul a21~170@ b21~172@)) a21~170@))) (=> (= temp_21_1~3215@ (Mul (Mul (Mul (Mul b21~172@ d21~176@) (Mul a21~170@ c21~174@)) (Mul (Mul b21~172@ d21~176@) (Mul b21~172@ b21~172@))) (Mul (Mul (Sub b21~172@ c21~174@) (Mul a21~170@ b21~172@)) a21~170@))) (=> (= tmp%22@ (= temp_21_0~3162@ temp_21_1~3215@)) (and (=> %%location_label%%21 tmp%22@) (=> tmp%22@ (=> (= temp_22_0~3267@ (Mul (Mul (Mul (Mul b22~180@ c22~182@) (Mul b22~180@ a22~178@)) (Mul (Mul d22~184@ a22~178@) (Mul a22~178@ a22~178@))) c22~182@)) (=> (= temp_22_1~3304@ (Mul (Mul (Mul (Mul b22~180@ c22~182@) (Mul b22~180@ a22~178@)) (Mul (Mul (Mul d22~184@ a22~178@) a22~178@) a22~178@)) c22~182@)) (=> (= tmp%23@ (= temp_22_0~3267@ temp_22_1~3304@)) (=> %%location_label%%22 tmp%23@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
