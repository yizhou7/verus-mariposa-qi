...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@))) (Mul (Mul (Add d0~8@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Mul (Mul d0~8@ a0~2@) b0~4@) d0~8@)) (Mul (Mul (Add d0~8@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~459@ (Mul (Mul (Add (Mul c1~14@ a1~10@) (Sub c1~14@ b1~12@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~524@ (Mul (Mul (Add (Mul c1~14@ a1~10@) (Sub c1~14@ b1~12@)) (Mul a1~10@ (Mul c1~14@ (Mul d1~16@ a1~10@)))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~459@ temp_1_1~524@))) (=> (= temp_1_0~459@ temp_1_1~524@) (=> (= temp_2_0~601@ (Mul (Mul (Sub (Mul d2~24@ d2~24@) (Sub a2~18@ a2~18@)) (Mul (Sub a2~18@ d2~24@) (Mul d2~24@ b2~20@))) (Mul (Mul (Add d2~24@ d2~24@) (Mul c2~22@ c2~22@)) d2~24@))) (=> (= temp_2_1~654@ (Mul (Mul (Sub (Mul d2~24@ d2~24@) (Sub a2~18@ a2~18@)) (Mul (Sub a2~18@ d2~24@) (Mul d2~24@ b2~20@))) (Mul d2~24@ (Mul (Add d2~24@ d2~24@) (Mul c2~22@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~601@ temp_2_1~654@))) (=> (= temp_2_0~601@ temp_2_1~654@) (=> (= temp_3_0~731@ (Mul (Mul (Mul (Sub c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ d3~32@))) (Mul b3~28@ (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~784@ (Mul (Mul (Mul (Sub c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@))) (Mul b3~28@ (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~731@ temp_3_1~784@))) (=> (= temp_3_0~731@ temp_3_1~784@) (=> (= temp_4_0~873@ (Mul (Sub (Mul (Mul a4~34@ d4~40@) (Add a4~34@ d4~40@)) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@))) (Sub (Mul (Mul b4~36@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~938@ (Mul (Sub (Mul a4~34@ (Mul d4~40@ (Add a4~34@ d4~40@))) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@))) (Sub (Mul (Mul b4~36@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~873@ temp_4_1~938@))) (=> (= temp_4_0~873@ temp_4_1~938@) (=> (= temp_5_0~1023@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (Mul (Add c5~46@ (Mul b5~44@ c5~46@)) (Mul (Add b5~44@ a5~42@) (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1084@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ d5~48@))) (Mul (Add c5~46@ (Mul b5~44@ c5~46@)) (Mul (Add b5~44@ a5~42@) (Mul a5~42@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1023@ temp_5_1~1084@))) (=> (= temp_5_0~1023@ temp_5_1~1084@) (=> (= temp_6_0~1161@ (Sub (Add (Mul (Add c6~54@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@))) (Mul a6~50@ (Add (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1214@ (Sub (Add (Mul (Add c6~54@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@))) (Mul a6~50@ (Add (Mul a6~50@ b6~52@) (Mul b6~52@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1161@ temp_6_1~1214@))) (=> (= temp_6_0~1161@ temp_6_1~1214@) (=> (= temp_7_0~1299@ (Mul (Mul (Mul (Add d7~64@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ a7~58@))) (Mul (Mul (Sub d7~64@ d7~64@) (Sub a7~58@ c7~62@)) (Mul a7~58@ (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1360@ (Mul (Mul (Mul (Add d7~64@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ a7~58@))) (Mul (Mul (Mul (Sub d7~64@ d7~64@) (Sub a7~58@ c7~62@)) a7~58@) (Mul a7~58@ b7~60@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1299@ temp_7_1~1360@))) (=> (= temp_7_0~1299@ temp_7_1~1360@) (=> (= temp_8_0~1421@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Add d8~72@ a8~66@)) (Add (Mul a8~66@ d8~72@) (Mul b8~68@ d8~72@))) a8~66@)) (=> (= temp_8_1~1458@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Add d8~72@ a8~66@)) (Add (Mul a8~66@ d8~72@) (Mul d8~72@ b8~68@))) a8~66@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1421@ temp_8_1~1458@))) (=> (= temp_8_0~1421@ temp_8_1~1458@) (=> (= temp_9_0~1547@ (Mul (Sub (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ b9~76@)) (Mul (Add c9~78@ b9~76@) (Mul b9~76@ a9~74@))) (Mul (Mul (Sub a9~74@ c9~78@) (Mul c9~78@ d9~80@)) (Add (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1612@ (Mul (Sub (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Add c9~78@ b9~76@) (Mul b9~76@ a9~74@))) (Mul (Mul (Sub a9~74@ c9~78@) (Mul c9~78@ d9~80@)) (Add (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1547@ temp_9_1~1612@))) (=> (= temp_9_0~1547@ temp_9_1~1612@) (=> (= temp_10_0~1701@ (Add (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@)) (Add (Sub c10~86@ a10~82@) (Mul b10~84@ d10~88@))) (Mul (Mul (Add d10~88@ b10~84@) (Mul b10~84@ a10~82@)) (Add (Mul a10~82@ a10~82@) (Add c10~86@ a10~82@))))) (=> (= temp_10_1~1782@ (Add (Add (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@)) (Sub c10~86@ a10~82@)) (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@)) (Mul b10~84@ d10~88@))) (Mul (Mul (Add d10~88@ b10~84@) (Mul b10~84@ a10~82@)) (Add (Mul a10~82@ a10~82@) (Add c10~86@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1701@ temp_10_1~1782@))) (=> (= temp_10_0~1701@ temp_10_1~1782@) (=> (= temp_11_0~1859@ (Sub (Sub d11~96@ (Add (Mul b11~92@ a11~90@) (Mul c11~94@ b11~92@))) (Mul (Mul (Add a11~90@ b11~92@) (Sub c11~94@ c11~94@)) (Mul (Mul b11~92@ c11~94@) (Sub d11~96@ d11~96@))))) (=> (= temp_11_1~1912@ (Sub (Sub d11~96@ (Add (Mul b11~92@ a11~90@) (Mul c11~94@ b11~92@))) (Mul (Mul (Add a11~90@ b11~92@) (Sub c11~94@ c11~94@)) (Mul b11~92@ (Mul c11~94@ (Sub d11~96@ d11~96@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1859@ temp_11_1~1912@))) (=> (= temp_11_0~1859@ temp_11_1~1912@) (=> (= temp_12_0~2013@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ 81) (Mul c12~102@ b12~100@))) (Sub (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ a12~98@))))) (=> (= temp_12_1~2090@ (Mul (Mul (Mul (Mul b12~100@ 81) (Mul c12~102@ b12~100@)) (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ a12~98@))) (Sub (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2013@ temp_12_1~2090@))) (=> (= temp_12_0~2013@ temp_12_1~2090@) (=> (= temp_13_0~2175@ (Add (Mul (Mul (Mul b13~108@ c13~110@) (Add a13~106@ c13~110@)) (Mul (Mul a13~106@ d13~112@) (Mul c13~110@ c13~110@))) (Mul (Add (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@)) (Mul a13~106@ (Add c13~110@ a13~106@))))) (=> (= temp_13_1~2236@ (Add (Mul (Mul (Mul (Mul b13~108@ c13~110@) (Add a13~106@ c13~110@)) (Mul a13~106@ d13~112@)) (Mul c13~110@ c13~110@)) (Mul (Add (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@)) (Mul a13~106@ (Add c13~110@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2175@ temp_13_1~2236@))) (=> (= temp_13_0~2175@ temp_13_1~2236@) (=> (= temp_14_0~2309@ (Add (Mul (Mul d14~120@ (Sub a14~114@ b14~116@)) (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul a14~114@ b14~116@) (Add b14~116@ a14~114@)) b14~116@))) (=> (= temp_14_1~2358@ (Add (Mul (Mul (Sub a14~114@ b14~116@) d14~120@) (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul a14~114@ b14~116@) (Add b14~116@ a14~114@)) b14~116@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2309@ temp_14_1~2358@))) (=> (= temp_14_0~2309@ temp_14_1~2358@) (=> (= temp_15_0~2447@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul a15~122@ d15~128@) (Sub b15~124@ c15~126@))) (Mul (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ a15~122@)) (Sub (Mul b15~124@ b15~124@) (Sub c15~126@ c15~126@))))) (=> (= temp_15_1~2512@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Mul c15~126@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Sub b15~124@ c15~126@))) (Mul (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ a15~122@)) (Sub (Mul b15~124@ b15~124@) (Sub c15~126@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2447@ temp_15_1~2512@))) (=> (= temp_15_0~2447@ temp_15_1~2512@) (=> (= temp_16_0~2593@ (Mul (Sub (Mul (Mul a16~130@ b16~132@) d16~136@) (Mul c16~134@ (Add b16~132@ a16~130@))) (Mul (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul a16~130@ a16~130@) (Mul d16~136@ c16~134@))))) (=> (= temp_16_1~2650@ (Mul (Sub (Mul (Mul b16~132@ a16~130@) d16~136@) (Mul c16~134@ (Add b16~132@ a16~130@))) (Mul (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul a16~130@ a16~130@) (Mul d16~136@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2593@ temp_16_1~2650@))) (=> (= temp_16_0~2593@ temp_16_1~2650@) (=> (= temp_17_0~2723@ (Add (Mul (Mul (Add c17~142@ a17~138@) (Mul a17~138@ d17~144@)) c17~142@) (Mul (Sub (Mul a17~138@ d17~144@) c17~142@) (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ b17~140@))))) (=> (= temp_17_1~2780@ (Add (Mul (Add (Mul c17~142@ (Mul a17~138@ d17~144@)) (Mul a17~138@ (Mul a17~138@ d17~144@))) c17~142@) (Mul (Sub (Mul a17~138@ d17~144@) c17~142@) (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2723@ temp_17_1~2780@))) (=> (= temp_17_0~2723@ temp_17_1~2780@) (=> (= temp_18_0~2869@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Add b18~148@ b18~148@)) (Mul (Mul d18~152@ c18~150@) (Sub d18~152@ a18~146@))) (Mul (Mul (Add a18~146@ c18~150@) (Mul a18~146@ b18~148@)) (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ d18~152@))))) (=> (= temp_18_1~2942@ (Mul (Mul (Add (Mul (Mul a18~146@ c18~150@) b18~148@) (Mul (Mul a18~146@ c18~150@) b18~148@)) (Mul (Mul d18~152@ c18~150@) (Sub d18~152@ a18~146@))) (Mul (Mul (Add a18~146@ c18~150@) (Mul a18~146@ b18~148@)) (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2869@ temp_18_1~2942@))) (=> (= temp_18_0~2869@ temp_18_1~2942@) (=> (= temp_19_0~3043@ (Add (Mul (Add (Mul a19~154@ c19~158@) (Mul c19~158@ b19~156@)) (Add (Mul b19~156@ c19~158@) (Mul b19~156@ a19~154@))) (Mul (Mul (Mul d19~160@ 40) (Mul a19~154@ b19~156@)) (Mul (Mul d19~160@ d19~160@) (Add b19~156@ a19~154@))))) (=> (= temp_19_1~3120@ (Add (Mul (Add (Mul a19~154@ c19~158@) (Mul c19~158@ b19~156@)) (Add (Mul b19~156@ c19~158@) (Mul b19~156@ a19~154@))) (Mul (Mul (Mul 40 d19~160@) (Mul a19~154@ b19~156@)) (Mul (Mul d19~160@ d19~160@) (Add b19~156@ a19~154@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3043@ temp_19_1~3120@))) (=> (= temp_19_0~3043@ temp_19_1~3120@) (=> (= temp_20_0~3209@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Sub b20~164@ b20~164@)) (Sub (Mul a20~162@ d20~168@) (Add b20~164@ c20~166@))) (Mul (Mul (Mul a20~162@ b20~164@) (Sub b20~164@ b20~164@)) (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ b20~164@))))) (=> (= temp_20_1~3274@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Sub b20~164@ b20~164@)) (Sub (Mul a20~162@ d20~168@) (Add b20~164@ c20~166@))) (Mul (Mul (Mul b20~164@ a20~162@) (Sub b20~164@ b20~164@)) (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ b20~164@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3209@ temp_20_1~3274@))) (=> (= temp_20_0~3209@ temp_20_1~3274@) (=> (= temp_21_0~3351@ (Mul (Mul (Mul (Mul b21~172@ d21~176@) (Mul b21~172@ b21~172@)) (Mul (Mul b21~172@ d21~176@) (Mul a21~170@ c21~174@))) (Mul (Mul (Sub b21~172@ c21~174@) (Mul a21~170@ b21~172@)) a21~170@))) (=> (= temp_21_1~3404@ (Mul (Mul (Mul (Mul b21~172@ d21~176@) (Mul a21~170@ c21~174@)) (Mul (Mul b21~172@ d21~176@) (Mul b21~172@ b21~172@))) (Mul (Mul (Sub b21~172@ c21~174@) (Mul a21~170@ b21~172@)) a21~170@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3351@ temp_21_1~3404@))) (=> (= temp_21_0~3351@ temp_21_1~3404@) (=> (= temp_22_0~3465@ (Mul (Mul (Mul (Mul b22~180@ c22~182@) (Mul b22~180@ a22~178@)) (Mul (Mul d22~184@ a22~178@) (Mul a22~178@ a22~178@))) c22~182@)) (=> (= temp_22_1~3502@ (Mul (Mul (Mul (Mul b22~180@ c22~182@) (Mul b22~180@ a22~178@)) (Mul (Mul (Mul d22~184@ a22~178@) a22~178@) a22~178@)) c22~182@)) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3465@ temp_22_1~3502@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
