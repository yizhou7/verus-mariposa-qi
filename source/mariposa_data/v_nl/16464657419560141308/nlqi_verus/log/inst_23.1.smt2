...
(set-info :comment ";; mariposa_data/v_nl//16464657419560141308/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_5_0~1073@ Int)
(declare-const temp_5_1~1134@ Int)
(declare-const temp_6_0~1239@ Int)
(declare-const temp_6_1~1292@ Int)
(declare-const temp_7_0~1381@ Int)
(declare-const temp_7_1~1442@ Int)
...
(declare-const temp_11_0~1997@ Int)
(declare-const temp_11_1~2050@ Int)
...
(declare-const temp_14_1~2572@ Int)
(declare-const temp_15_0~2669@ Int)
(declare-const temp_15_1~2734@ Int)
(declare-const temp_16_0~2819@ Int)
(declare-const temp_16_1~2876@ Int)
(declare-const temp_17_0~2953@ Int)
(declare-const temp_17_1~3010@ Int)
(declare-const temp_18_0~3109@ Int)
(declare-const temp_18_1~3182@ Int)
(declare-const temp_19_0~3293@ Int)
(declare-const temp_19_1~3370@ Int)
(declare-const temp_20_0~3475@ Int)
(declare-const temp_20_1~3540@ Int)
(declare-const temp_21_0~3621@ Int)
(declare-const temp_21_1~3674@ Int)
(declare-const temp_22_0~3763@ Int)
(declare-const temp_22_1~3800@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@))) (Mul (Mul (Add d0~8@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Mul (Mul d0~8@ a0~2@) b0~4@) d0~8@)) (Mul (Mul (Add d0~8@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ d0~8@))))) (and (=> (= tmp%1@ (Mul d0~8@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b0~4@ d0~8@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~469@ (Mul (Mul (Add (Mul c1~14@ a1~10@) (Sub c1~14@ b1~12@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~534@ (Mul (Mul (Add (Mul c1~14@ a1~10@) (Sub c1~14@ b1~12@)) (Mul a1~10@ (Mul c1~14@ (Mul d1~16@ a1~10@)))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@))))) (and (=> (= tmp%2@ (Mul d1~16@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a1~10@ c1~14@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~469@ temp_1_1~534@)))) (=> (= temp_1_0~469@ temp_1_1~534@) (=> (= temp_2_0~621@ (Mul (Mul (Sub (Mul d2~24@ d2~24@) (Sub a2~18@ a2~18@)) (Mul (Sub a2~18@ d2~24@) (Mul d2~24@ b2~20@))) (Mul (Mul (Add d2~24@ d2~24@) (Mul c2~22@ c2~22@)) d2~24@))) (=> (= temp_2_1~674@ (Mul (Mul (Sub (Mul d2~24@ d2~24@) (Sub a2~18@ a2~18@)) (Mul (Sub a2~18@ d2~24@) (Mul d2~24@ b2~20@))) (Mul d2~24@ (Mul (Add d2~24@ d2~24@) (Mul c2~22@ c2~22@))))) (and (=> (= tmp%3@ (Mul (Add d2~24@ d2~24@) (Mul c2~22@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ d2~24@) (=> %%location_label%%2 (= temp_2_0~621@ temp_2_1~674@)))) (=> (= temp_2_0~621@ temp_2_1~674@) (=> (= temp_3_0~767@ (Mul (Mul (Mul (Sub c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ d3~32@))) (Mul b3~28@ (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~820@ (Mul (Mul (Mul (Sub c3~30@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@))) (Mul b3~28@ (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ d3~32@) (=> %%location_label%%3 (= temp_3_0~767@ temp_3_1~820@))) (=> (= temp_3_0~767@ temp_3_1~820@) (=> (= temp_4_0~913@ (Mul (Sub (Mul (Mul a4~34@ d4~40@) (Add a4~34@ d4~40@)) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@))) (Sub (Mul (Mul b4~36@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~978@ (Mul (Sub (Mul a4~34@ (Mul d4~40@ (Add a4~34@ d4~40@))) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@))) (Sub (Mul (Mul b4~36@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ b4~36@))))) (and (=> (= tmp%4@ (Add a4~34@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a4~34@ d4~40@ tmp%4@) (=> %%location_label%%4 (= temp_4_0~913@ temp_4_1~978@)))) (=> (= temp_4_0~913@ temp_4_1~978@) (=> (= temp_5_0~1073@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (Mul (Add c5~46@ (Mul b5~44@ c5~46@)) (Mul (Add b5~44@ a5~42@) (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1134@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ d5~48@))) (Mul (Add c5~46@ (Mul b5~44@ c5~46@)) (Mul (Add b5~44@ a5~42@) (Mul a5~42@ a5~42@))))) (and (=> (= tmp%5@ (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ d5~48@))) (=> (= tmp%6@ (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~1073@ temp_5_1~1134@))))) (=> (= temp_5_0~1073@ temp_5_1~1134@) (=> (= temp_6_0~1239@ (Sub (Add (Mul (Add c6~54@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@))) (Mul a6~50@ (Add (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1292@ (Sub (Add (Mul (Add c6~54@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@))) (Mul a6~50@ (Add (Mul a6~50@ b6~52@) (Mul b6~52@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b6~52@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1239@ temp_6_1~1292@))) (=> (= temp_6_0~1239@ temp_6_1~1292@) (=> (= temp_7_0~1381@ (Mul (Mul (Mul (Add d7~64@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ a7~58@))) (Mul (Mul (Sub d7~64@ d7~64@) (Sub a7~58@ c7~62@)) (Mul a7~58@ (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1442@ (Mul (Mul (Mul (Add d7~64@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ a7~58@))) (Mul (Mul (Mul (Sub d7~64@ d7~64@) (Sub a7~58@ c7~62@)) a7~58@) (Mul a7~58@ b7~60@)))) (and (=> (= tmp%7@ (Mul (Sub d7~64@ d7~64@) (Sub a7~58@ c7~62@))) (=> (= tmp%8@ (Mul a7~58@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ a7~58@ tmp%8@) (=> %%location_label%%7 (= temp_7_0~1381@ temp_7_1~1442@))))) (=> (= temp_7_0~1381@ temp_7_1~1442@) (=> (= temp_8_0~1525@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Add d8~72@ a8~66@)) (Add (Mul a8~66@ d8~72@) (Mul b8~68@ d8~72@))) a8~66@)) (=> (= temp_8_1~1562@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Add d8~72@ a8~66@)) (Add (Mul a8~66@ d8~72@) (Mul d8~72@ b8~68@))) a8~66@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1525@ temp_8_1~1562@))) (=> (= temp_8_0~1525@ temp_8_1~1562@) (=> (= temp_9_0~1655@ (Mul (Sub (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ b9~76@)) (Mul (Add c9~78@ b9~76@) (Mul b9~76@ a9~74@))) (Mul (Mul (Sub a9~74@ c9~78@) (Mul c9~78@ d9~80@)) (Add (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1720@ (Mul (Sub (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Add c9~78@ b9~76@) (Mul b9~76@ a9~74@))) (Mul (Mul (Sub a9~74@ c9~78@) (Mul c9~78@ d9~80@)) (Add (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c9~78@ a9~74@) (=> %%location_label%%9 (= temp_9_0~1655@ temp_9_1~1720@))) (=> (= temp_9_0~1655@ temp_9_1~1720@) (=> (= temp_10_0~1813@ (Add (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@)) (Add (Sub c10~86@ a10~82@) (Mul b10~84@ d10~88@))) (Mul (Mul (Add d10~88@ b10~84@) (Mul b10~84@ a10~82@)) (Add (Mul a10~82@ a10~82@) (Add c10~86@ a10~82@))))) (=> (= temp_10_1~1894@ (Add (Add (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@)) (Sub c10~86@ a10~82@)) (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@)) (Mul b10~84@ d10~88@))) (Mul (Mul (Add d10~88@ b10~84@) (Mul b10~84@ a10~82@)) (Add (Mul a10~82@ a10~82@) (Add c10~86@ a10~82@))))) (and (=> (= tmp%9@ (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@))) (=> (= tmp%10@ (Sub c10~86@ a10~82@)) (=> (= tmp%11@ (Mul b10~84@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%10 (= temp_10_0~1813@ temp_10_1~1894@)))))) (=> (= temp_10_0~1813@ temp_10_1~1894@) (=> (= temp_11_0~1997@ (Sub (Sub d11~96@ (Add (Mul b11~92@ a11~90@) (Mul c11~94@ b11~92@))) (Mul (Mul (Add a11~90@ b11~92@) (Sub c11~94@ c11~94@)) (Mul (Mul b11~92@ c11~94@) (Sub d11~96@ d11~96@))))) (=> (= temp_11_1~2050@ (Sub (Sub d11~96@ (Add (Mul b11~92@ a11~90@) (Mul c11~94@ b11~92@))) (Mul (Mul (Add a11~90@ b11~92@) (Sub c11~94@ c11~94@)) (Mul b11~92@ (Mul c11~94@ (Sub d11~96@ d11~96@)))))) (and (=> (= tmp%12@ (Sub d11~96@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b11~92@ c11~94@ tmp%12@) (=> %%location_label%%11 (= temp_11_0~1997@ temp_11_1~2050@)))) (=> (= temp_11_0~1997@ temp_11_1~2050@) (=> (= temp_12_0~2161@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ 81) (Mul c12~102@ b12~100@))) (Sub (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ a12~98@))))) (=> (= temp_12_1~2238@ (Mul (Mul (Mul (Mul b12~100@ 81) (Mul c12~102@ b12~100@)) (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ a12~98@))) (Sub (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ a12~98@))))) (and (=> (= tmp%13@ (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ a12~98@))) (=> (= tmp%14@ (Mul (Mul b12~100@ 81) (Mul c12~102@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%12 (= temp_12_0~2161@ temp_12_1~2238@))))) (=> (= temp_12_0~2161@ temp_12_1~2238@) (=> (= temp_13_0~2363@ (Add (Mul (Mul (Mul b13~108@ c13~110@) (Add a13~106@ c13~110@)) (Mul (Mul a13~106@ d13~112@) (Mul c13~110@ c13~110@))) (Mul (Add (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@)) (Mul a13~106@ (Add c13~110@ a13~106@))))) (=> (= temp_13_1~2424@ (Add (Mul (Mul (Mul (Mul b13~108@ c13~110@) (Add a13~106@ c13~110@)) (Mul a13~106@ d13~112@)) (Mul c13~110@ c13~110@)) (Mul (Add (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@)) (Mul a13~106@ (Add c13~110@ a13~106@))))) (and (=> (= tmp%15@ (Mul (Mul b13~108@ c13~110@) (Add a13~106@ c13~110@))) (=> (= tmp%16@ (Mul a13~106@ d13~112@)) (=> (= tmp%17@ (Mul c13~110@ c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%13 (= temp_13_0~2363@ temp_13_1~2424@)))))) (=> (= temp_13_0~2363@ temp_13_1~2424@) (=> (= temp_14_0~2523@ (Add (Mul (Mul d14~120@ (Sub a14~114@ b14~116@)) (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul a14~114@ b14~116@) (Add b14~116@ a14~114@)) b14~116@))) (=> (= temp_14_1~2572@ (Add (Mul (Mul (Sub a14~114@ b14~116@) d14~120@) (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul a14~114@ b14~116@) (Add b14~116@ a14~114@)) b14~116@))) (and (=> (= tmp%18@ (Sub a14~114@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ tmp%18@) (=> %%location_label%%14 (= temp_14_0~2523@ temp_14_1~2572@)))) (=> (= temp_14_0~2523@ temp_14_1~2572@) (=> (= temp_15_0~2669@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul a15~122@ d15~128@) (Sub b15~124@ c15~126@))) (Mul (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ a15~122@)) (Sub (Mul b15~124@ b15~124@) (Sub c15~126@ c15~126@))))) (=> (= temp_15_1~2734@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Mul c15~126@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Sub b15~124@ c15~126@))) (Mul (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ a15~122@)) (Sub (Mul b15~124@ b15~124@) (Sub c15~126@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b15~124@ c15~126@) (=> %%location_label%%15 (= temp_15_0~2669@ temp_15_1~2734@))) (=> (= temp_15_0~2669@ temp_15_1~2734@) (=> (= temp_16_0~2819@ (Mul (Sub (Mul (Mul a16~130@ b16~132@) d16~136@) (Mul c16~134@ (Add b16~132@ a16~130@))) (Mul (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul a16~130@ a16~130@) (Mul d16~136@ c16~134@))))) (=> (= temp_16_1~2876@ (Mul (Sub (Mul (Mul b16~132@ a16~130@) d16~136@) (Mul c16~134@ (Add b16~132@ a16~130@))) (Mul (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul a16~130@ a16~130@) (Mul d16~136@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a16~130@ b16~132@) (=> %%location_label%%16 (= temp_16_0~2819@ temp_16_1~2876@))) (=> (= temp_16_0~2819@ temp_16_1~2876@) (=> (= temp_17_0~2953@ (Add (Mul (Mul (Add c17~142@ a17~138@) (Mul a17~138@ d17~144@)) c17~142@) (Mul (Sub (Mul a17~138@ d17~144@) c17~142@) (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ b17~140@))))) (=> (= temp_17_1~3010@ (Add (Mul (Add (Mul c17~142@ (Mul a17~138@ d17~144@)) (Mul a17~138@ (Mul a17~138@ d17~144@))) c17~142@) (Mul (Sub (Mul a17~138@ d17~144@) c17~142@) (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ b17~140@))))) (and (=> (= tmp%19@ (Mul a17~138@ d17~144@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c17~142@ a17~138@ tmp%19@) (=> %%location_label%%17 (= temp_17_0~2953@ temp_17_1~3010@)))) (=> (= temp_17_0~2953@ temp_17_1~3010@) (=> (= temp_18_0~3109@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Add b18~148@ b18~148@)) (Mul (Mul d18~152@ c18~150@) (Sub d18~152@ a18~146@))) (Mul (Mul (Add a18~146@ c18~150@) (Mul a18~146@ b18~148@)) (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ d18~152@))))) (=> (= temp_18_1~3182@ (Mul (Mul (Add (Mul (Mul a18~146@ c18~150@) b18~148@) (Mul (Mul a18~146@ c18~150@) b18~148@)) (Mul (Mul d18~152@ c18~150@) (Sub d18~152@ a18~146@))) (Mul (Mul (Add a18~146@ c18~150@) (Mul a18~146@ b18~148@)) (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ d18~152@))))) (and (=> (= tmp%20@ (Mul a18~146@ c18~150@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%20@ b18~148@ b18~148@) (=> %%location_label%%18 (= temp_18_0~3109@ temp_18_1~3182@)))) (=> (= temp_18_0~3109@ temp_18_1~3182@) (=> (= temp_19_0~3293@ (Add (Mul (Add (Mul a19~154@ c19~158@) (Mul c19~158@ b19~156@)) (Add (Mul b19~156@ c19~158@) (Mul b19~156@ a19~154@))) (Mul (Mul (Mul d19~160@ 40) (Mul a19~154@ b19~156@)) (Mul (Mul d19~160@ d19~160@) (Add b19~156@ a19~154@))))) (=> (= temp_19_1~3370@ (Add (Mul (Add (Mul a19~154@ c19~158@) (Mul c19~158@ b19~156@)) (Add (Mul b19~156@ c19~158@) (Mul b19~156@ a19~154@))) (Mul (Mul (Mul 40 d19~160@) (Mul a19~154@ b19~156@)) (Mul (Mul d19~160@ d19~160@) (Add b19~156@ a19~154@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d19~160@ 40) (=> %%location_label%%19 (= temp_19_0~3293@ temp_19_1~3370@))) (=> (= temp_19_0~3293@ temp_19_1~3370@) (=> (= temp_20_0~3475@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Sub b20~164@ b20~164@)) (Sub (Mul a20~162@ d20~168@) (Add b20~164@ c20~166@))) (Mul (Mul (Mul a20~162@ b20~164@) (Sub b20~164@ b20~164@)) (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ b20~164@))))) (=> (= temp_20_1~3540@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Sub b20~164@ b20~164@)) (Sub (Mul a20~162@ d20~168@) (Add b20~164@ c20~166@))) (Mul (Mul (Mul b20~164@ a20~162@) (Sub b20~164@ b20~164@)) (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ b20~164@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a20~162@ b20~164@) (=> %%location_label%%20 (= temp_20_0~3475@ temp_20_1~3540@))) (=> (= temp_20_0~3475@ temp_20_1~3540@) (=> (= temp_21_0~3621@ (Mul (Mul (Mul (Mul b21~172@ d21~176@) (Mul b21~172@ b21~172@)) (Mul (Mul b21~172@ d21~176@) (Mul a21~170@ c21~174@))) (Mul (Mul (Sub b21~172@ c21~174@) (Mul a21~170@ b21~172@)) a21~170@))) (=> (= temp_21_1~3674@ (Mul (Mul (Mul (Mul b21~172@ d21~176@) (Mul a21~170@ c21~174@)) (Mul (Mul b21~172@ d21~176@) (Mul b21~172@ b21~172@))) (Mul (Mul (Sub b21~172@ c21~174@) (Mul a21~170@ b21~172@)) a21~170@))) (and (=> (= tmp%21@ (Mul (Mul b21~172@ d21~176@) (Mul b21~172@ b21~172@))) (=> (= tmp%22@ (Mul (Mul b21~172@ d21~176@) (Mul a21~170@ c21~174@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%21 (= temp_21_0~3621@ temp_21_1~3674@))))) (=> (= temp_21_0~3621@ temp_21_1~3674@) (=> (= temp_22_0~3763@ (Mul (Mul (Mul (Mul b22~180@ c22~182@) (Mul b22~180@ a22~178@)) (Mul (Mul d22~184@ a22~178@) (Mul a22~178@ a22~178@))) c22~182@)) (=> (= temp_22_1~3800@ (Mul (Mul (Mul (Mul b22~180@ c22~182@) (Mul b22~180@ a22~178@)) (Mul (Mul (Mul d22~184@ a22~178@) a22~178@) a22~178@)) c22~182@)) (=> (= tmp%23@ (Mul d22~184@ a22~178@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ a22~178@ a22~178@) (=> %%location_label%%22 (= temp_22_0~3763@ temp_22_1~3800@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
