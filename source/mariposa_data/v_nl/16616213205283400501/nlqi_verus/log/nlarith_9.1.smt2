...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Add (Sub (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@)) (Mul c0~6@ (Add c0~6@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@)))) (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ c0~6@)) (Sub (Mul d0~8@ d0~8@) (Sub c0~6@ d0~8@))) (Mul (Mul (Sub d0~8@ a0~2@) (Mul b0~4@ d0~8@)) c0~6@)))) (=> (= temp_0_1~386@ (Mul (Add (Sub (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@)) (Mul c0~6@ (Add c0~6@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@)))) (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ c0~6@)) (Sub (Mul d0~8@ d0~8@) (Sub c0~6@ d0~8@))) (Mul (Mul (Sub d0~8@ a0~2@) (Mul b0~4@ d0~8@)) c0~6@)))) (=> (= tmp%1@ (= temp_0_0~273@ temp_0_1~386@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~530@ (Mul (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Add d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Add c1~14@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Add d1~16@ a1~10@) (Mul a1~10@ d1~16@)))) (Mul (Add (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)))))) (=> (= temp_1_1~659@ (Mul (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Add d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Add d1~16@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Add c1~14@ c1~14@) (Mul d1~16@ b1~12@)))) (Mul (Add (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)))))) (=> (= tmp%2@ (= temp_1_0~530@ temp_1_1~659@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~771@ (Mul (Mul (Mul (Sub (Add d2~24@ c2~22@) (Mul d2~24@ a2~18@)) c2~22@) (Mul (Mul (Sub c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ d2~24@)))) (Sub b2~20@ (Mul (Mul (Mul c2~22@ 80) (Mul b2~20@ d2~24@)) (Mul d2~24@ (Add c2~22@ a2~18@)))))) (=> (= temp_2_1~868@ (Mul (Mul (Mul (Mul (Sub c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ d2~24@))) (Mul (Sub (Add d2~24@ c2~22@) (Mul d2~24@ a2~18@)) c2~22@)) (Sub b2~20@ (Mul (Mul (Mul c2~22@ 80) (Mul b2~20@ d2~24@)) (Mul d2~24@ (Add c2~22@ a2~18@)))))) (=> (= tmp%3@ (= temp_2_0~771@ temp_2_1~868@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1000@ (Mul (Mul (Mul b3~28@ (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ c3~30@))) (Mul d3~32@ (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@)))) (Mul (Mul (Sub (Sub b3~28@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Add c3~30@ d3~32@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Add 84 d3~32@) (Mul d3~32@ c3~30@)))))) (=> (= temp_3_1~1117@ (Mul (Mul (Mul b3~28@ (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ c3~30@))) (Mul d3~32@ (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ c3~30@)))) (Mul (Mul (Sub (Sub b3~28@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Add c3~30@ d3~32@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Add 84 d3~32@) (Mul d3~32@ c3~30@)))))) (=> (= tmp%4@ (= temp_3_0~1000@ temp_3_1~1117@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1241@ (Mul (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Add d4~40@ c4~38@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ d4~40@)) (Mul b4~36@ (Add a4~34@ a4~34@)))) (Mul (Mul a4~34@ (Mul d4~40@ (Sub a4~34@ a4~34@))) (Mul (Mul (Mul b4~36@ d4~40@) (Add b4~36@ d4~40@)) (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ b4~36@)))))) (=> (= temp_4_1~1350@ (Mul (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ b4~36@) (Add d4~40@ c4~38@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ d4~40@)) (Mul b4~36@ (Add a4~34@ a4~34@)))) (Mul (Mul a4~34@ (Mul d4~40@ (Sub a4~34@ a4~34@))) (Mul (Mul (Mul b4~36@ d4~40@) (Add b4~36@ d4~40@)) (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ b4~36@)))))) (=> (= tmp%5@ (= temp_4_0~1241@ temp_4_1~1350@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1498@ (Mul (Mul (Mul (Mul (Mul b5~44@ d5~48@) a5~42@) (Mul (Add d5~48@ a5~42@) a5~42@)) (Sub (Mul (Sub d5~48@ b5~44@) (Mul a5~42@ c5~46@)) (Add (Mul a5~42@ c5~46@) (Sub a5~42@ c5~46@)))) (Mul (Mul (Mul (Sub d5~48@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ 45)))))) (=> (= temp_5_1~1631@ (Mul (Mul (Mul (Mul (Sub d5~48@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ 45)))) (Mul (Mul (Mul (Mul b5~44@ d5~48@) a5~42@) (Mul (Add d5~48@ a5~42@) a5~42@)) (Sub (Mul (Sub d5~48@ b5~44@) (Mul a5~42@ c5~46@)) (Add (Mul a5~42@ c5~46@) (Sub a5~42@ c5~46@)))))) (=> (= tmp%6@ (= temp_5_0~1498@ temp_5_1~1631@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1743@ (Mul (Mul (Add (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ a6~50@))) (Mul (Sub b6~52@ (Mul c6~54@ a6~50@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ c6~54@)))) (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ a6~50@)) b6~52@) (Mul (Mul (Add c6~54@ c6~54@) a6~50@) a6~50@)))) (=> (= temp_6_1~1840@ (Mul (Mul (Add (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ a6~50@))) (Mul (Sub b6~52@ (Mul c6~54@ a6~50@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ c6~54@)))) (Mul (Mul (Mul (Mul (Mul d6~56@ d6~56@) c6~54@) a6~50@) b6~52@) (Mul (Mul (Add c6~54@ c6~54@) a6~50@) a6~50@)))) (=> (= tmp%7@ (= temp_6_0~1743@ temp_6_1~1840@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1972@ (Sub (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ d7~64@))) (Add (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ b7~60@)) b7~60@)) (Mul (Sub d7~64@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul c7~62@ c7~62@) (Add d7~64@ b7~60@)) (Mul (Sub b7~60@ b7~60@) (Add d7~64@ 73)))))) (=> (= temp_7_1~2089@ (Sub (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ a7~58@)) (Mul b7~60@ (Mul a7~58@ (Mul b7~60@ d7~64@)))) (Add (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ b7~60@)) b7~60@)) (Mul (Sub d7~64@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul c7~62@ c7~62@) (Add d7~64@ b7~60@)) (Mul (Sub b7~60@ b7~60@) (Add d7~64@ 73)))))) (=> (= tmp%8@ (= temp_7_0~1972@ temp_7_1~2089@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2233@ (Mul (Mul (Mul (Sub (Add b8~68@ d8~72@) (Sub c8~70@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Sub c8~70@ b8~68@) (Mul a8~66@ c8~70@)))) (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Add c8~70@ b8~68@) (Sub b8~68@ d8~72@))) (Add (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ c8~70@)))))) (=> (= temp_8_1~2362@ (Mul (Mul (Mul (Sub (Add b8~68@ d8~72@) (Sub c8~70@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Mul (Sub c8~70@ b8~68@) a8~66@) c8~70@))) (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Add c8~70@ b8~68@) (Sub b8~68@ d8~72@))) (Add (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ c8~70@)))))) (=> (= tmp%9@ (= temp_8_0~2233@ temp_8_1~2362@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
