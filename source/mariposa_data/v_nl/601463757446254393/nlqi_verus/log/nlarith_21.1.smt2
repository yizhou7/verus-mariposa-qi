...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul d0~8@ (Sub c0~6@ a0~2@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@))) (Mul (Sub (Add a0~2@ b0~4@) (Add a0~2@ c0~6@)) (Mul (Sub d0~8@ b0~4@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Mul (Sub (Add a0~2@ b0~4@) (Add a0~2@ c0~6@)) (Mul (Sub d0~8@ b0~4@) (Mul d0~8@ b0~4@))) (Mul (Mul d0~8@ (Sub c0~6@ a0~2@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~434@ (Mul (Mul (Mul c1~14@ (Add c1~14@ a1~10@)) (Mul (Sub c1~14@ c1~14@) (Sub a1~10@ d1~16@))) (Mul (Mul d1~16@ (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Add d1~16@ c1~14@))))) (=> (= temp_1_1~491@ (Mul (Mul (Mul (Sub c1~14@ c1~14@) (Sub a1~10@ d1~16@)) (Mul c1~14@ (Add c1~14@ a1~10@))) (Mul (Mul d1~16@ (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Add d1~16@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~434@ temp_1_1~491@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~571@ (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Add d2~24@ a2~18@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Sub d2~24@ d2~24@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~636@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Sub d2~24@ d2~24@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Add d2~24@ a2~18@) (Mul b2~20@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~571@ temp_2_1~636@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~708@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) b3~28@) (Mul b3~28@ (Sub d3~32@ a3~26@))) (Mul (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~765@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) b3~28@) (Mul b3~28@ (Sub d3~32@ a3~26@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~708@ temp_3_1~765@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~845@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Sub c4~38@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ d4~40@))) (Add (Mul (Sub d4~40@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~910@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Sub c4~38@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ b4~36@))) (Add (Mul (Sub d4~40@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~845@ temp_4_1~910@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~986@ (Mul (Add (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Sub (Add c5~46@ d5~48@) (Mul d5~48@ c5~46@))) (Add (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Mul d5~48@ (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1047@ (Mul (Add (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Sub (Add c5~46@ d5~48@) (Mul d5~48@ c5~46@))) (Add (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@)) (Mul d5~48@ (Mul a5~42@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~986@ temp_5_1~1047@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1135@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Sub (Mul a6~50@ d6~56@) (Mul c6~54@ 30))) (Mul (Mul (Sub b6~52@ d6~56@) (Sub c6~54@ b6~52@)) (Mul (Mul b6~52@ c6~54@) d6~56@)))) (=> (= temp_6_1~1208@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Sub (Mul a6~50@ d6~56@) (Mul c6~54@ 30))) (Mul (Mul (Sub c6~54@ b6~52@) (Sub b6~52@ d6~56@)) (Mul (Mul b6~52@ c6~54@) d6~56@)))) (=> (= tmp%7@ (= temp_6_0~1135@ temp_6_1~1208@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1284@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@)) (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ a7~58@))) (Mul (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Sub a7~58@ b7~60@) d7~64@)))) (=> (= temp_7_1~1345@ (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@)) (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ a7~58@))) (Mul (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Sub a7~58@ b7~60@) d7~64@)))) (=> (= tmp%8@ (= temp_7_0~1284@ temp_7_1~1345@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1425@ (Mul (Mul (Add (Mul a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1506@ (Mul (Add (Mul (Mul a8~66@ a8~66@) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ b8~68@))) (Mul (Mul b8~68@ b8~68@) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ b8~68@)))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1425@ temp_8_1~1506@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1586@ (Mul (Sub (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul d9~80@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ d9~80@)) (Add (Mul a9~74@ b9~76@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~1651@ (Mul (Sub (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul d9~80@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ d9~80@)) (Add (Mul a9~74@ b9~76@) (Mul b9~76@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1586@ temp_9_1~1651@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1711@ (Mul (Mul (Add (Add c10~86@ a10~82@) b10~84@) (Mul (Mul b10~84@ b10~84@) (Add a10~82@ b10~84@))) (Mul d10~88@ (Sub (Sub a10~82@ b10~84@) b10~84@)))) (=> (= temp_10_1~1756@ (Mul (Mul (Mul (Add (Add c10~86@ a10~82@) b10~84@) (Mul (Mul b10~84@ b10~84@) (Add a10~82@ b10~84@))) d10~88@) (Sub (Sub a10~82@ b10~84@) b10~84@))) (=> (= tmp%11@ (= temp_10_0~1711@ temp_10_1~1756@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1836@ (Sub (Mul (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ b11~92@) (Mul d11~96@ d11~96@))) (Add (Mul (Mul b11~92@ a11~90@) (Mul d11~96@ d11~96@)) (Mul (Mul d11~96@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~1901@ (Sub (Mul (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ b11~92@) (Mul d11~96@ d11~96@))) (Add (Mul (Mul b11~92@ a11~90@) (Mul d11~96@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Mul b11~92@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1836@ temp_11_1~1901@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1981@ (Sub (Mul (Mul (Add c12~102@ a12~98@) (Sub d12~104@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Add b12~100@ c12~102@))) (Sub (Mul (Mul a12~98@ a12~98@) (Mul d12~104@ b12~100@)) (Add (Add c12~102@ a12~98@) (Mul a12~98@ a12~98@))))) (=> (= temp_12_1~2046@ (Sub (Mul (Add c12~102@ a12~98@) (Mul (Sub d12~104@ d12~104@) (Mul (Mul a12~98@ b12~100@) (Add b12~100@ c12~102@)))) (Sub (Mul (Mul a12~98@ a12~98@) (Mul d12~104@ b12~100@)) (Add (Add c12~102@ a12~98@) (Mul a12~98@ a12~98@))))) (=> (= tmp%13@ (= temp_12_0~1981@ temp_12_1~2046@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2126@ (Add (Sub (Mul (Mul d13~112@ d13~112@) (Mul a13~106@ d13~112@)) (Sub (Mul b13~108@ c13~110@) (Mul d13~112@ c13~110@))) (Mul (Mul (Mul c13~110@ b13~108@) (Mul a13~106@ b13~108@)) (Mul (Add b13~108@ a13~106@) (Mul a13~106@ b13~108@))))) (=> (= temp_13_1~2191@ (Add (Sub (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ d13~112@)) (Sub (Mul b13~108@ c13~110@) (Mul d13~112@ c13~110@))) (Mul (Mul (Mul c13~110@ b13~108@) (Mul a13~106@ b13~108@)) (Mul (Add b13~108@ a13~106@) (Mul a13~106@ b13~108@))))) (=> (= tmp%14@ (= temp_13_0~2126@ temp_13_1~2191@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2283@ (Mul (Mul (Mul (Add b14~116@ 19) (Mul d14~120@ a14~114@)) (Mul (Mul b14~116@ b14~116@) (Mul c14~118@ a14~114@))) (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ d14~120@)) (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ b14~116@))))) (=> (= temp_14_1~2360@ (Mul (Mul (Mul (Mul (Add b14~116@ 19) (Mul d14~120@ a14~114@)) (Mul b14~116@ b14~116@)) (Mul c14~118@ a14~114@)) (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ d14~120@)) (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2283@ temp_14_1~2360@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2452@ (Mul (Mul (Mul (Sub b15~124@ c15~126@) (Mul b15~124@ c15~126@)) (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ c15~126@))) (Sub (Mul (Mul c15~126@ a15~122@) (Mul a15~122@ 85)) (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ b15~124@))))) (=> (= temp_15_1~2529@ (Mul (Mul (Mul (Sub b15~124@ c15~126@) (Mul c15~126@ b15~124@)) (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ c15~126@))) (Sub (Mul (Mul c15~126@ a15~122@) (Mul a15~122@ 85)) (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ b15~124@))))) (=> (= tmp%16@ (= temp_15_0~2452@ temp_15_1~2529@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2609@ (Mul (Mul (Mul (Add d16~136@ b16~132@) (Mul c16~134@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Add d16~136@ a16~130@))) (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ a16~130@)) (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ b16~132@))))) (=> (= temp_16_1~2674@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ a16~130@)) (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ b16~132@))) (Mul (Mul (Add d16~136@ b16~132@) (Mul c16~134@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Add d16~136@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2609@ temp_16_1~2674@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2754@ (Mul (Mul (Mul (Add c17~142@ c17~142@) (Sub a17~138@ d17~144@)) (Mul (Mul d17~144@ b17~140@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ b17~140@)) (Add (Sub a17~138@ b17~140@) (Mul c17~142@ b17~140@))))) (=> (= temp_17_1~2827@ (Mul (Mul (Add (Mul c17~142@ (Sub a17~138@ d17~144@)) (Mul c17~142@ (Sub a17~138@ d17~144@))) (Mul (Mul d17~144@ b17~140@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ b17~140@)) (Add (Sub a17~138@ b17~140@) (Mul c17~142@ b17~140@))))) (=> (= tmp%18@ (= temp_17_0~2754@ temp_17_1~2827@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2903@ (Mul (Add (Mul c18~150@ (Mul b18~148@ b18~148@)) (Mul (Mul b18~148@ b18~148@) (Mul d18~152@ d18~152@))) (Mul (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ c18~150@)) (Add (Mul c18~150@ b18~148@) (Mul c18~150@ b18~148@))))) (=> (= temp_18_1~2964@ (Mul (Add (Mul c18~150@ (Mul b18~148@ b18~148@)) (Mul (Mul b18~148@ b18~148@) (Mul d18~152@ d18~152@))) (Mul (Mul (Mul (Mul d18~152@ d18~152@) d18~152@) c18~150@) (Add (Mul c18~150@ b18~148@) (Mul c18~150@ b18~148@))))) (=> (= tmp%19@ (= temp_18_0~2903@ temp_18_1~2964@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3040@ (Mul (Mul (Mul (Sub c19~158@ c19~158@) (Mul b19~156@ c19~158@)) (Mul (Mul a19~154@ a19~154@) (Mul c19~158@ d19~160@))) (Mul (Mul (Mul d19~160@ c19~158@) (Mul a19~154@ d19~160@)) (Mul (Mul b19~156@ c19~158@) a19~154@)))) (=> (= temp_19_1~3101@ (Mul (Mul (Mul (Sub c19~158@ c19~158@) (Mul b19~156@ c19~158@)) (Mul a19~154@ (Mul a19~154@ (Mul c19~158@ d19~160@)))) (Mul (Mul (Mul d19~160@ c19~158@) (Mul a19~154@ d19~160@)) (Mul (Mul b19~156@ c19~158@) a19~154@)))) (=> (= tmp%20@ (= temp_19_0~3040@ temp_19_1~3101@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3177@ (Mul (Mul (Mul (Mul d20~168@ d20~168@) c20~166@) (Add (Mul c20~166@ d20~168@) (Mul d20~168@ a20~162@))) (Mul (Mul (Sub c20~166@ a20~162@) (Sub c20~166@ c20~166@)) (Mul (Mul a20~162@ b20~164@) (Mul d20~168@ d20~168@))))) (=> (= temp_20_1~3238@ (Mul (Mul (Mul (Sub c20~166@ a20~162@) (Sub c20~166@ c20~166@)) (Mul (Mul a20~162@ b20~164@) (Mul d20~168@ d20~168@))) (Mul (Mul (Mul d20~168@ d20~168@) c20~166@) (Add (Mul c20~166@ d20~168@) (Mul d20~168@ a20~162@))))) (=> (= tmp%21@ (= temp_20_0~3177@ temp_20_1~3238@)) (=> %%location_label%%20 tmp%21@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
