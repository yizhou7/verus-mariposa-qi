...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Add a0~2@ c0~6@))) (Sub (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Sub d0~8@ d0~8@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Sub (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Sub d0~8@ d0~8@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Add a0~2@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~462@ (Mul (Mul (Mul (Mul a1~10@ 71) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~539@ (Mul (Mul (Mul (Mul a1~10@ 71) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~462@ temp_1_1~539@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~607@ (Mul (Sub (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Sub d2~24@ a2~18@) (Mul c2~22@ c2~22@))) (Mul a2~18@ (Mul (Mul c2~22@ b2~20@) (Add d2~24@ c2~22@))))) (=> (= temp_2_1~668@ (Mul (Sub (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Sub (Mul d2~24@ (Mul c2~22@ c2~22@)) (Mul a2~18@ (Mul c2~22@ c2~22@)))) (Mul a2~18@ (Mul (Mul c2~22@ b2~20@) (Add d2~24@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~607@ temp_2_1~668@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~740@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul c3~30@ (Add b3~28@ b3~28@)) (Mul (Sub d3~32@ c3~30@) (Sub a3~26@ d3~32@))))) (=> (= temp_3_1~797@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul c3~30@ (Add b3~28@ b3~28@)) (Mul (Sub a3~26@ d3~32@) (Sub d3~32@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~740@ temp_3_1~797@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~885@ (Mul (Add (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Sub (Sub d4~40@ 39) (Sub a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Mul b4~36@ b4~36@) b4~36@)))) (=> (= temp_4_1~958@ (Mul (Add (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@)) (Sub (Sub d4~40@ 39) (Sub a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Mul b4~36@ b4~36@) b4~36@)))) (=> (= tmp%5@ (= temp_4_0~885@ temp_4_1~958@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1034@ (Mul (Mul (Sub (Mul d5~48@ b5~44@) (Sub c5~46@ c5~46@)) (Mul (Mul c5~46@ 4) (Mul c5~46@ c5~46@))) (Mul b5~44@ (Mul b5~44@ (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1095@ (Mul (Mul (Sub (Mul d5~48@ b5~44@) (Sub c5~46@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ 4))) (Mul b5~44@ (Mul b5~44@ (Mul b5~44@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1034@ temp_5_1~1095@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1175@ (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Add c6~54@ a6~50@))))) (=> (= temp_6_1~1240@ (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Add c6~54@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~1175@ temp_6_1~1240@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1332@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Add c7~62@ a7~58@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Sub c7~62@ 58) (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1409@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Add c7~62@ a7~58@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul (Sub c7~62@ 58) a7~58@) d7~64@)))) (=> (= tmp%8@ (= temp_7_0~1332@ temp_7_1~1409@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1477@ (Mul (Add (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) c8~70@) (Mul (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1530@ (Mul (Mul (Add (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) c8~70@) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ a8~66@))) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)))) (=> (= tmp%9@ (= temp_8_0~1477@ temp_8_1~1530@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1642@ (Mul (Mul (Mul (Sub 66 4) b9~76@) (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ a9~74@))) (Sub (Mul (Sub a9~74@ b9~76@) (Mul b9~76@ a9~74@)) (Sub (Mul 91 d9~80@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1739@ (Mul (Mul (Mul (Sub 66 4) b9~76@) (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ a9~74@))) (Sub (Mul (Sub a9~74@ b9~76@) (Mul b9~76@ a9~74@)) (Sub (Mul d9~80@ 91) (Mul a9~74@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1642@ temp_9_1~1739@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1791@ (Mul d10~88@ (Add (Mul (Mul b10~84@ b10~84@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Add d10~88@ c10~86@))))) (=> (= temp_10_1~1828@ (Mul d10~88@ (Add (Mul (Mul b10~84@ b10~84@) (Mul a10~82@ a10~82@)) (Mul c10~86@ (Mul a10~82@ (Add d10~88@ c10~86@)))))) (=> (= tmp%11@ (= temp_10_0~1791@ temp_10_1~1828@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1928@ (Mul (Mul (Mul b11~92@ (Mul a11~90@ a11~90@)) (Mul (Sub c11~94@ c11~94@) (Mul b11~92@ 79))) (Mul (Mul (Mul 56 b11~92@) (Sub c11~94@ c11~94@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ d11~96@))))) (=> (= temp_11_1~2013@ (Mul (Mul (Mul b11~92@ (Mul a11~90@ a11~90@)) (Mul (Sub c11~94@ c11~94@) (Mul b11~92@ 79))) (Mul (Mul (Sub c11~94@ c11~94@) (Mul 56 b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ d11~96@))))) (=> (= tmp%12@ (= temp_11_0~1928@ temp_11_1~2013@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2101@ (Mul (Mul (Mul (Mul a12~98@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ d12~104@))) (Mul (Sub (Mul c12~102@ b12~100@) (Mul a12~98@ a12~98@)) (Mul (Mul b12~100@ 35) b12~100@)))) (=> (= temp_12_1~2174@ (Mul (Mul (Mul (Mul b12~100@ b12~100@) (Mul a12~98@ d12~104@)) (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ d12~104@))) (Mul (Sub (Mul c12~102@ b12~100@) (Mul a12~98@ a12~98@)) (Mul (Mul b12~100@ 35) b12~100@)))) (=> (= tmp%13@ (= temp_12_0~2101@ temp_12_1~2174@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2250@ (Mul (Sub (Mul (Sub c13~110@ b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul c13~110@ b13~108@) (Mul b13~108@ c13~110@))) (Mul (Add (Mul b13~108@ b13~108@) (Mul c13~110@ d13~112@)) (Mul b13~108@ (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2311@ (Mul (Sub (Mul (Sub c13~110@ b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul c13~110@ b13~108@) (Mul b13~108@ c13~110@))) (Mul (Add (Mul b13~108@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul b13~108@ b13~108@) d13~112@)))) (=> (= tmp%14@ (= temp_13_0~2250@ temp_13_1~2311@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2391@ (Mul (Mul (Mul (Mul a14~114@ b14~116@) (Sub d14~120@ b14~116@)) (Add (Mul a14~114@ b14~116@) (Mul b14~116@ c14~118@))) (Add (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@))))) (=> (= temp_14_1~2456@ (Mul (Add (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul a14~114@ b14~116@) (Sub d14~120@ b14~116@)) (Add (Mul a14~114@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2391@ temp_14_1~2456@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2536@ (Mul (Mul (Mul (Sub d15~128@ a15~122@) (Add b15~124@ a15~122@)) (Mul (Sub a15~122@ b15~124@) (Mul c15~126@ d15~128@))) (Mul (Mul (Mul a15~122@ c15~126@) (Sub b15~124@ d15~128@)) (Add (Mul d15~128@ a15~122@) (Mul a15~122@ b15~124@))))) (=> (= temp_15_1~2609@ (Mul (Mul (Mul (Sub d15~128@ a15~122@) (Add b15~124@ a15~122@)) (Sub (Mul a15~122@ (Mul c15~126@ d15~128@)) (Mul b15~124@ (Mul c15~126@ d15~128@)))) (Mul (Mul (Mul a15~122@ c15~126@) (Sub b15~124@ d15~128@)) (Add (Mul d15~128@ a15~122@) (Mul a15~122@ b15~124@))))) (=> (= tmp%16@ (= temp_15_0~2536@ temp_15_1~2609@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2701@ (Mul (Mul (Mul (Sub c16~134@ a16~130@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ b16~132@) (Sub 94 b16~132@))) (Mul (Sub (Mul a16~130@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ d16~136@))))) (=> (= temp_16_1~2778@ (Mul (Mul (Mul (Sub c16~134@ a16~130@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ b16~132@) (Sub 94 b16~132@))) (Mul (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ d16~136@)) (Sub (Mul a16~130@ d16~136@) (Mul a16~130@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2701@ temp_16_1~2778@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2858@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@)) (Mul (Mul a17~138@ c17~142@) (Add a17~138@ b17~140@))) (Mul (Mul (Mul a17~138@ c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ c17~142@))))) (=> (= temp_17_1~2923@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@)) (Mul (Add a17~138@ b17~140@) (Mul a17~138@ c17~142@))) (Mul (Mul (Mul a17~138@ c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ c17~142@))))) (=> (= tmp%18@ (= temp_17_0~2858@ temp_17_1~2923@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2979@ (Mul (Mul (Add (Mul d18~152@ d18~152@) (Sub d18~152@ a18~146@)) c18~150@) (Sub (Mul (Add a18~146@ d18~152@) (Mul d18~152@ b18~148@)) a18~146@))) (=> (= temp_18_1~3020@ (Mul (Sub (Mul (Add a18~146@ d18~152@) (Mul d18~152@ b18~148@)) a18~146@) (Mul (Add (Mul d18~152@ d18~152@) (Sub d18~152@ a18~146@)) c18~150@))) (=> (= tmp%19@ (= temp_18_0~2979@ temp_18_1~3020@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3096@ (Mul (Mul (Sub (Mul d19~160@ a19~154@) (Add b19~156@ c19~158@)) (Mul (Add c19~158@ b19~156@) (Mul c19~158@ b19~156@))) (Mul (Mul (Mul b19~156@ c19~158@) (Mul c19~158@ b19~156@)) (Mul (Sub b19~156@ d19~160@) b19~156@)))) (=> (= temp_19_1~3157@ (Mul (Mul (Sub (Mul d19~160@ a19~154@) (Add b19~156@ c19~158@)) (Mul (Mul c19~158@ b19~156@) (Add c19~158@ b19~156@))) (Mul (Mul (Mul b19~156@ c19~158@) (Mul c19~158@ b19~156@)) (Mul (Sub b19~156@ d19~160@) b19~156@)))) (=> (= tmp%20@ (= temp_19_0~3096@ temp_19_1~3157@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3249@ (Mul (Sub (Add (Mul a20~162@ c20~166@) (Mul d20~168@ a20~162@)) (Add (Add a20~162@ d20~168@) (Mul b20~164@ 74))) (Mul (Mul (Mul a20~162@ c20~166@) (Mul b20~164@ b20~164@)) (Mul (Mul b20~164@ d20~168@) (Sub b20~164@ c20~166@))))) (=> (= temp_20_1~3326@ (Mul (Sub (Add (Mul a20~162@ c20~166@) (Mul d20~168@ a20~162@)) (Add (Add a20~162@ d20~168@) (Mul b20~164@ 74))) (Mul (Mul (Mul c20~166@ a20~162@) (Mul b20~164@ b20~164@)) (Mul (Mul b20~164@ d20~168@) (Sub b20~164@ c20~166@))))) (=> (= tmp%21@ (= temp_20_0~3249@ temp_20_1~3326@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3398@ (Mul (Mul (Mul (Mul d21~176@ c21~174@) (Mul c21~174@ d21~176@)) (Mul a21~170@ (Mul a21~170@ b21~172@))) (Mul (Sub (Mul c21~174@ a21~170@) (Add a21~170@ d21~176@)) (Mul a21~170@ (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~3455@ (Mul (Mul (Mul (Mul c21~174@ d21~176@) (Mul d21~176@ c21~174@)) (Mul a21~170@ (Mul a21~170@ b21~172@))) (Mul (Sub (Mul c21~174@ a21~170@) (Add a21~170@ d21~176@)) (Mul a21~170@ (Mul a21~170@ b21~172@))))) (=> (= tmp%22@ (= temp_21_0~3398@ temp_21_1~3455@)) (=> %%location_label%%21 tmp%22@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
