...
(set-info :comment ";; mariposa_data/v_nl//12676445640037346034/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_3_0~849@ Int)
(declare-const temp_3_1~906@ Int)
(declare-const temp_4_0~1015@ Int)
(declare-const temp_4_1~1088@ Int)
(declare-const temp_5_0~1177@ Int)
(declare-const temp_5_1~1238@ Int)
(declare-const temp_6_0~1351@ Int)
(declare-const temp_6_1~1416@ Int)
(declare-const temp_7_0~1521@ Int)
(declare-const temp_7_1~1598@ Int)
(declare-const temp_8_0~1697@ Int)
(declare-const temp_8_1~1750@ Int)
(declare-const temp_9_0~1917@ Int)
(declare-const temp_9_1~2014@ Int)
(declare-const temp_10_0~2091@ Int)
...
(declare-const temp_14_0~2779@ Int)
(declare-const temp_14_1~2844@ Int)
(declare-const temp_15_0~2993@ Int)
(declare-const temp_15_1~3066@ Int)
(declare-const temp_16_0~3177@ Int)
(declare-const temp_16_1~3254@ Int)
(declare-const temp_17_0~3371@ Int)
(declare-const temp_17_1~3436@ Int)
(declare-const temp_18_0~3513@ Int)
(declare-const temp_18_1~3554@ Int)
(declare-const temp_19_0~3675@ Int)
(declare-const temp_19_1~3736@ Int)
(declare-const temp_20_0~3849@ Int)
(declare-const temp_20_1~3926@ Int)
(declare-const temp_21_0~4011@ Int)
(declare-const temp_21_1~4068@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Add a0~2@ c0~6@))) (Sub (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Sub d0~8@ d0~8@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Sub (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Sub d0~8@ d0~8@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Add a0~2@ c0~6@))))) (and (=> (= tmp%1@ (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Add a0~2@ c0~6@)))) (=> (= tmp%2@ (Sub (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Sub d0~8@ d0~8@) (Mul d0~8@ c0~6@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~531@ (Mul (Mul (Mul (Mul a1~10@ 71) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~608@ (Mul (Mul (Mul (Mul a1~10@ 71) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@))))) (and (=> (= tmp%3@ (Mul a1~10@ c1~14@)) (=> (= tmp%4@ (Mul c1~14@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~531@ temp_1_1~608@))))) (=> (= temp_1_0~531@ temp_1_1~608@) (=> (= temp_2_0~697@ (Mul (Sub (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Sub d2~24@ a2~18@) (Mul c2~22@ c2~22@))) (Mul a2~18@ (Mul (Mul c2~22@ b2~20@) (Add d2~24@ c2~22@))))) (=> (= temp_2_1~758@ (Mul (Sub (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Sub (Mul d2~24@ (Mul c2~22@ c2~22@)) (Mul a2~18@ (Mul c2~22@ c2~22@)))) (Mul a2~18@ (Mul (Mul c2~22@ b2~20@) (Add d2~24@ c2~22@))))) (and (=> (= tmp%5@ (Mul c2~22@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d2~24@ a2~18@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~697@ temp_2_1~758@)))) (=> (= temp_2_0~697@ temp_2_1~758@) (=> (= temp_3_0~849@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul c3~30@ (Add b3~28@ b3~28@)) (Mul (Sub d3~32@ c3~30@) (Sub a3~26@ d3~32@))))) (=> (= temp_3_1~906@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul c3~30@ (Add b3~28@ b3~28@)) (Mul (Sub a3~26@ d3~32@) (Sub d3~32@ c3~30@))))) (and (=> (= tmp%6@ (Sub d3~32@ c3~30@)) (=> (= tmp%7@ (Sub a3~26@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~849@ temp_3_1~906@))))) (=> (= temp_3_0~849@ temp_3_1~906@) (=> (= temp_4_0~1015@ (Mul (Add (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Sub (Sub d4~40@ 39) (Sub a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Mul b4~36@ b4~36@) b4~36@)))) (=> (= temp_4_1~1088@ (Mul (Add (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@)) (Sub (Sub d4~40@ 39) (Sub a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Mul b4~36@ b4~36@) b4~36@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ a4~34@) (=> %%location_label%%4 (= temp_4_0~1015@ temp_4_1~1088@))) (=> (= temp_4_0~1015@ temp_4_1~1088@) (=> (= temp_5_0~1177@ (Mul (Mul (Sub (Mul d5~48@ b5~44@) (Sub c5~46@ c5~46@)) (Mul (Mul c5~46@ 4) (Mul c5~46@ c5~46@))) (Mul b5~44@ (Mul b5~44@ (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1238@ (Mul (Mul (Sub (Mul d5~48@ b5~44@) (Sub c5~46@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ 4))) (Mul b5~44@ (Mul b5~44@ (Mul b5~44@ b5~44@))))) (and (=> (= tmp%8@ (Mul c5~46@ 4)) (=> (= tmp%9@ (Mul c5~46@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%5 (= temp_5_0~1177@ temp_5_1~1238@))))) (=> (= temp_5_0~1177@ temp_5_1~1238@) (=> (= temp_6_0~1351@ (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Add c6~54@ a6~50@))))) (=> (= temp_6_1~1416@ (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Add c6~54@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1351@ temp_6_1~1416@))) (=> (= temp_6_0~1351@ temp_6_1~1416@) (=> (= temp_7_0~1521@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Add c7~62@ a7~58@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Sub c7~62@ 58) (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1598@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Add c7~62@ a7~58@)) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul (Sub c7~62@ 58) a7~58@) d7~64@)))) (and (=> (= tmp%10@ (Sub c7~62@ 58)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ a7~58@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1521@ temp_7_1~1598@)))) (=> (= temp_7_0~1521@ temp_7_1~1598@) (=> (= temp_8_0~1697@ (Mul (Add (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) c8~70@) (Mul (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1750@ (Mul (Mul (Add (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) c8~70@) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ a8~66@))) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)))) (and (=> (= tmp%11@ (Add (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) c8~70@)) (=> (= tmp%12@ (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ a8~66@))) (=> (= tmp%13@ (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%8 (= temp_8_0~1697@ temp_8_1~1750@)))))) (=> (= temp_8_0~1697@ temp_8_1~1750@) (=> (= temp_9_0~1917@ (Mul (Mul (Mul (Sub 66 4) b9~76@) (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ a9~74@))) (Sub (Mul (Sub a9~74@ b9~76@) (Mul b9~76@ a9~74@)) (Sub (Mul 91 d9~80@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~2014@ (Mul (Mul (Mul (Sub 66 4) b9~76@) (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ a9~74@))) (Sub (Mul (Sub a9~74@ b9~76@) (Mul b9~76@ a9~74@)) (Sub (Mul d9~80@ 91) (Mul a9~74@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 91 d9~80@) (=> %%location_label%%9 (= temp_9_0~1917@ temp_9_1~2014@))) (=> (= temp_9_0~1917@ temp_9_1~2014@) (=> (= temp_10_0~2091@ (Mul d10~88@ (Add (Mul (Mul b10~84@ b10~84@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Add d10~88@ c10~86@))))) (=> (= temp_10_1~2128@ (Mul d10~88@ (Add (Mul (Mul b10~84@ b10~84@) (Mul a10~82@ a10~82@)) (Mul c10~86@ (Mul a10~82@ (Add d10~88@ c10~86@)))))) (and (=> (= tmp%14@ (Add d10~88@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c10~86@ a10~82@ tmp%14@) (=> %%location_label%%10 (= temp_10_0~2091@ temp_10_1~2128@)))) (=> (= temp_10_0~2091@ temp_10_1~2128@) (=> (= temp_11_0~2247@ (Mul (Mul (Mul b11~92@ (Mul a11~90@ a11~90@)) (Mul (Sub c11~94@ c11~94@) (Mul b11~92@ 79))) (Mul (Mul (Mul 56 b11~92@) (Sub c11~94@ c11~94@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ d11~96@))))) (=> (= temp_11_1~2332@ (Mul (Mul (Mul b11~92@ (Mul a11~90@ a11~90@)) (Mul (Sub c11~94@ c11~94@) (Mul b11~92@ 79))) (Mul (Mul (Sub c11~94@ c11~94@) (Mul 56 b11~92@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ d11~96@))))) (and (=> (= tmp%15@ (Mul 56 b11~92@)) (=> (= tmp%16@ (Sub c11~94@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%11 (= temp_11_0~2247@ temp_11_1~2332@))))) (=> (= temp_11_0~2247@ temp_11_1~2332@) (=> (= temp_12_0~2453@ (Mul (Mul (Mul (Mul a12~98@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ d12~104@))) (Mul (Sub (Mul c12~102@ b12~100@) (Mul a12~98@ a12~98@)) (Mul (Mul b12~100@ 35) b12~100@)))) (=> (= temp_12_1~2526@ (Mul (Mul (Mul (Mul b12~100@ b12~100@) (Mul a12~98@ d12~104@)) (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ d12~104@))) (Mul (Sub (Mul c12~102@ b12~100@) (Mul a12~98@ a12~98@)) (Mul (Mul b12~100@ 35) b12~100@)))) (and (=> (= tmp%17@ (Mul a12~98@ d12~104@)) (=> (= tmp%18@ (Mul b12~100@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%12 (= temp_12_0~2453@ temp_12_1~2526@))))) (=> (= temp_12_0~2453@ temp_12_1~2526@) (=> (= temp_13_0~2623@ (Mul (Sub (Mul (Sub c13~110@ b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul c13~110@ b13~108@) (Mul b13~108@ c13~110@))) (Mul (Add (Mul b13~108@ b13~108@) (Mul c13~110@ d13~112@)) (Mul b13~108@ (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2684@ (Mul (Sub (Mul (Sub c13~110@ b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul c13~110@ b13~108@) (Mul b13~108@ c13~110@))) (Mul (Add (Mul b13~108@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul b13~108@ b13~108@) d13~112@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b13~108@ b13~108@ d13~112@) (=> %%location_label%%13 (= temp_13_0~2623@ temp_13_1~2684@))) (=> (= temp_13_0~2623@ temp_13_1~2684@) (=> (= temp_14_0~2779@ (Mul (Mul (Mul (Mul a14~114@ b14~116@) (Sub d14~120@ b14~116@)) (Add (Mul a14~114@ b14~116@) (Mul b14~116@ c14~118@))) (Add (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@))))) (=> (= temp_14_1~2844@ (Mul (Add (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul a14~114@ b14~116@) (Sub d14~120@ b14~116@)) (Add (Mul a14~114@ b14~116@) (Mul b14~116@ c14~118@))))) (and (=> (= tmp%19@ (Mul (Mul (Mul a14~114@ b14~116@) (Sub d14~120@ b14~116@)) (Add (Mul a14~114@ b14~116@) (Mul b14~116@ c14~118@)))) (=> (= tmp%20@ (Add (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%14 (= temp_14_0~2779@ temp_14_1~2844@))))) (=> (= temp_14_0~2779@ temp_14_1~2844@) (=> (= temp_15_0~2993@ (Mul (Mul (Mul (Sub d15~128@ a15~122@) (Add b15~124@ a15~122@)) (Mul (Sub a15~122@ b15~124@) (Mul c15~126@ d15~128@))) (Mul (Mul (Mul a15~122@ c15~126@) (Sub b15~124@ d15~128@)) (Add (Mul d15~128@ a15~122@) (Mul a15~122@ b15~124@))))) (=> (= temp_15_1~3066@ (Mul (Mul (Mul (Sub d15~128@ a15~122@) (Add b15~124@ a15~122@)) (Sub (Mul a15~122@ (Mul c15~126@ d15~128@)) (Mul b15~124@ (Mul c15~126@ d15~128@)))) (Mul (Mul (Mul a15~122@ c15~126@) (Sub b15~124@ d15~128@)) (Add (Mul d15~128@ a15~122@) (Mul a15~122@ b15~124@))))) (and (=> (= tmp%21@ (Mul c15~126@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a15~122@ b15~124@ tmp%21@) (=> %%location_label%%15 (= temp_15_0~2993@ temp_15_1~3066@)))) (=> (= temp_15_0~2993@ temp_15_1~3066@) (=> (= temp_16_0~3177@ (Mul (Mul (Mul (Sub c16~134@ a16~130@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ b16~132@) (Sub 94 b16~132@))) (Mul (Sub (Mul a16~130@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ d16~136@))))) (=> (= temp_16_1~3254@ (Mul (Mul (Mul (Sub c16~134@ a16~130@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ b16~132@) (Sub 94 b16~132@))) (Mul (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ d16~136@)) (Sub (Mul a16~130@ d16~136@) (Mul a16~130@ a16~130@))))) (and (=> (= tmp%22@ (Sub (Mul a16~130@ d16~136@) (Mul a16~130@ a16~130@))) (=> (= tmp%23@ (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ d16~136@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%16 (= temp_16_0~3177@ temp_16_1~3254@))))) (=> (= temp_16_0~3177@ temp_16_1~3254@) (=> (= temp_17_0~3371@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@)) (Mul (Mul a17~138@ c17~142@) (Add a17~138@ b17~140@))) (Mul (Mul (Mul a17~138@ c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ c17~142@))))) (=> (= temp_17_1~3436@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@)) (Mul (Add a17~138@ b17~140@) (Mul a17~138@ c17~142@))) (Mul (Mul (Mul a17~138@ c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ c17~142@))))) (and (=> (= tmp%24@ (Mul a17~138@ c17~142@)) (=> (= tmp%25@ (Add a17~138@ b17~140@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%24@ tmp%25@) (=> %%location_label%%17 (= temp_17_0~3371@ temp_17_1~3436@))))) (=> (= temp_17_0~3371@ temp_17_1~3436@) (=> (= temp_18_0~3513@ (Mul (Mul (Add (Mul d18~152@ d18~152@) (Sub d18~152@ a18~146@)) c18~150@) (Sub (Mul (Add a18~146@ d18~152@) (Mul d18~152@ b18~148@)) a18~146@))) (=> (= temp_18_1~3554@ (Mul (Sub (Mul (Add a18~146@ d18~152@) (Mul d18~152@ b18~148@)) a18~146@) (Mul (Add (Mul d18~152@ d18~152@) (Sub d18~152@ a18~146@)) c18~150@))) (and (=> (= tmp%26@ (Mul (Add (Mul d18~152@ d18~152@) (Sub d18~152@ a18~146@)) c18~150@)) (=> (= tmp%27@ (Sub (Mul (Add a18~146@ d18~152@) (Mul d18~152@ b18~148@)) a18~146@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%26@ tmp%27@) (=> %%location_label%%18 (= temp_18_0~3513@ temp_18_1~3554@))))) (=> (= temp_18_0~3513@ temp_18_1~3554@) (=> (= temp_19_0~3675@ (Mul (Mul (Sub (Mul d19~160@ a19~154@) (Add b19~156@ c19~158@)) (Mul (Add c19~158@ b19~156@) (Mul c19~158@ b19~156@))) (Mul (Mul (Mul b19~156@ c19~158@) (Mul c19~158@ b19~156@)) (Mul (Sub b19~156@ d19~160@) b19~156@)))) (=> (= temp_19_1~3736@ (Mul (Mul (Sub (Mul d19~160@ a19~154@) (Add b19~156@ c19~158@)) (Mul (Mul c19~158@ b19~156@) (Add c19~158@ b19~156@))) (Mul (Mul (Mul b19~156@ c19~158@) (Mul c19~158@ b19~156@)) (Mul (Sub b19~156@ d19~160@) b19~156@)))) (and (=> (= tmp%28@ (Add c19~158@ b19~156@)) (=> (= tmp%29@ (Mul c19~158@ b19~156@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%28@ tmp%29@) (=> %%location_label%%19 (= temp_19_0~3675@ temp_19_1~3736@))))) (=> (= temp_19_0~3675@ temp_19_1~3736@) (=> (= temp_20_0~3849@ (Mul (Sub (Add (Mul a20~162@ c20~166@) (Mul d20~168@ a20~162@)) (Add (Add a20~162@ d20~168@) (Mul b20~164@ 74))) (Mul (Mul (Mul a20~162@ c20~166@) (Mul b20~164@ b20~164@)) (Mul (Mul b20~164@ d20~168@) (Sub b20~164@ c20~166@))))) (=> (= temp_20_1~3926@ (Mul (Sub (Add (Mul a20~162@ c20~166@) (Mul d20~168@ a20~162@)) (Add (Add a20~162@ d20~168@) (Mul b20~164@ 74))) (Mul (Mul (Mul c20~166@ a20~162@) (Mul b20~164@ b20~164@)) (Mul (Mul b20~164@ d20~168@) (Sub b20~164@ c20~166@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a20~162@ c20~166@) (=> %%location_label%%20 (= temp_20_0~3849@ temp_20_1~3926@))) (=> (= temp_20_0~3849@ temp_20_1~3926@) (=> (= temp_21_0~4011@ (Mul (Mul (Mul (Mul d21~176@ c21~174@) (Mul c21~174@ d21~176@)) (Mul a21~170@ (Mul a21~170@ b21~172@))) (Mul (Sub (Mul c21~174@ a21~170@) (Add a21~170@ d21~176@)) (Mul a21~170@ (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~4068@ (Mul (Mul (Mul (Mul c21~174@ d21~176@) (Mul d21~176@ c21~174@)) (Mul a21~170@ (Mul a21~170@ b21~172@))) (Mul (Sub (Mul c21~174@ a21~170@) (Add a21~170@ d21~176@)) (Mul a21~170@ (Mul a21~170@ b21~172@))))) (=> (= tmp%30@ (Mul d21~176@ c21~174@)) (=> (= tmp%31@ (Mul c21~174@ d21~176@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%30@ tmp%31@) (=> %%location_label%%21 (= temp_21_0~4011@ temp_21_1~4068@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
