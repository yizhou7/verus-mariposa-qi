...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Mul (Mul (Add (Mul b0~4@ a0~2@) (Add a0~2@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ c0~6@))) a0~2@)) (=> (= temp_0_1~314@ (Mul a0~2@ (Mul (Add (Mul b0~4@ a0~2@) (Add a0~2@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~277@ temp_0_1~314@))) (=> (= temp_0_0~277@ temp_0_1~314@) (=> (= temp_1_0~399@ (Sub (Mul (Mul (Mul c1~14@ d1~16@) d1~16@) (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Add d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~460@ (Sub (Mul (Mul (Mul c1~14@ d1~16@) d1~16@) (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul c1~14@ a1~10@) (Add d1~16@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~399@ temp_1_1~460@))) (=> (= temp_1_0~399@ temp_1_1~460@) (=> (= temp_2_0~537@ (Mul (Mul (Mul (Add a2~18@ c2~22@) (Sub c2~22@ b2~20@)) c2~22@) (Mul (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~590@ (Mul (Mul (Mul (Add a2~18@ c2~22@) (Sub c2~22@ b2~20@)) c2~22@) (Mul (Mul (Mul b2~20@ a2~18@) (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~537@ temp_2_1~590@))) (=> (= temp_2_0~537@ temp_2_1~590@) (=> (= temp_3_0~679@ (Mul (Add (Sub (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Add b3~28@ d3~32@))) (Mul (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~744@ (Mul (Add (Sub (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Add b3~28@ d3~32@))) (Mul (Mul (Mul (Sub c3~30@ d3~32@) b3~28@) c3~30@) (Add (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~679@ temp_3_1~744@))) (=> (= temp_3_0~679@ temp_3_1~744@) (=> (= temp_4_0~829@ (Mul (Mul (Mul (Add b4~36@ d4~40@) (Add b4~36@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ a4~34@))) (Mul (Add (Mul a4~34@ c4~38@) c4~38@) (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~890@ (Mul (Mul (Mul (Add b4~36@ d4~40@) (Add b4~36@ b4~36@)) (Mul (Mul (Mul c4~38@ d4~40@) a4~34@) a4~34@)) (Mul (Add (Mul a4~34@ c4~38@) c4~38@) (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~829@ temp_4_1~890@))) (=> (= temp_4_0~829@ temp_4_1~890@) (=> (= temp_5_0~979@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ d5~48@))) (Sub (Mul (Mul b5~44@ a5~42@) (Sub a5~42@ a5~42@)) (Mul (Add d5~48@ b5~44@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1044@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ a5~42@))) (Sub (Mul (Mul b5~44@ a5~42@) (Sub a5~42@ a5~42@)) (Mul (Add d5~48@ b5~44@) (Mul c5~46@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~979@ temp_5_1~1044@))) (=> (= temp_5_0~979@ temp_5_1~1044@) (=> (= temp_6_0~1129@ (Mul (Mul (Add (Sub d6~56@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ d6~56@))) (Mul (Mul d6~56@ (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1190@ (Mul (Mul (Add (Sub d6~56@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Mul d6~56@ (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1129@ temp_6_1~1190@))) (=> (= temp_6_0~1129@ temp_6_1~1190@) (=> (= temp_7_0~1279@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1344@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ c7~62@)) (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1279@ temp_7_1~1344@))) (=> (= temp_7_0~1279@ temp_7_1~1344@) (=> (= temp_8_0~1429@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~1490@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1429@ temp_8_1~1490@))) (=> (= temp_8_0~1429@ temp_8_1~1490@) (=> (= temp_9_0~1571@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ b9~76@)) (Mul b9~76@ (Mul b9~76@ a9~74@))) (Mul (Mul (Sub d9~80@ c9~78@) c9~78@) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~1628@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ b9~76@)) (Mul b9~76@ (Mul b9~76@ a9~74@))) (Mul (Mul (Sub d9~80@ c9~78@) c9~78@) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1571@ temp_9_1~1628@))) (=> (= temp_9_0~1571@ temp_9_1~1628@) (=> (= temp_10_0~1725@ (Mul (Sub (Add a10~82@ (Mul a10~82@ c10~86@)) (Sub (Mul a10~82@ d10~88@) (Mul 44 a10~82@))) (Add (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~1798@ (Mul (Sub (Add a10~82@ (Mul a10~82@ c10~86@)) (Sub (Mul a10~82@ d10~88@) (Mul 44 a10~82@))) (Add (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ b10~84@)) (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1725@ temp_10_1~1798@))) (=> (= temp_10_0~1725@ temp_10_1~1798@) (=> (= temp_11_0~1895@ (Add (Mul (Add (Mul c11~94@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul 31 c11~94@))) (Mul (Mul b11~92@ (Mul d11~96@ b11~92@)) (Mul (Add c11~94@ a11~90@) (Mul b11~92@ b11~92@))))) (=> (= temp_11_1~1968@ (Add (Mul (Add (Mul c11~94@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul 31 c11~94@))) (Mul (Mul (Mul d11~96@ b11~92@) b11~92@) (Mul (Add c11~94@ a11~90@) (Mul b11~92@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1895@ temp_11_1~1968@))) (=> (= temp_11_0~1895@ temp_11_1~1968@) (=> (= temp_12_0~2077@ (Mul (Mul (Mul (Mul d12~104@ c12~102@) d12~104@) (Mul (Mul a12~98@ 21) (Sub 80 a12~98@))) (Mul (Mul (Sub a12~98@ b12~100@) (Mul a12~98@ a12~98@)) (Mul (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2162@ (Mul (Mul (Mul (Mul (Mul d12~104@ c12~102@) d12~104@) (Mul (Mul a12~98@ 21) (Sub 80 a12~98@))) (Mul (Sub a12~98@ b12~100@) (Mul a12~98@ a12~98@))) (Mul (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2077@ temp_12_1~2162@))) (=> (= temp_12_0~2077@ temp_12_1~2162@) (=> (= temp_13_0~2247@ (Mul (Mul (Mul (Add a13~106@ a13~106@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ c13~110@))) (Sub (Mul (Mul a13~106@ d13~112@) c13~110@) (Sub (Add a13~106@ a13~106@) (Mul b13~108@ a13~106@))))) (=> (= temp_13_1~2308@ (Mul (Mul (Mul (Add a13~106@ a13~106@) (Mul c13~110@ d13~112@)) (Mul c13~110@ (Mul d13~112@ (Mul c13~110@ c13~110@)))) (Sub (Mul (Mul a13~106@ d13~112@) c13~110@) (Sub (Add a13~106@ a13~106@) (Mul b13~108@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2247@ temp_13_1~2308@))) (=> (= temp_13_0~2247@ temp_13_1~2308@) (=> (= temp_14_0~2397@ (Mul (Add (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ b14~116@)) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ a14~114@)) (Mul (Sub d14~120@ d14~120@) (Mul d14~120@ b14~116@))))) (=> (= temp_14_1~2462@ (Mul (Add (Mul d14~120@ (Mul c14~118@ (Mul c14~118@ b14~116@))) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ a14~114@)) (Mul (Sub d14~120@ d14~120@) (Mul d14~120@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2397@ temp_14_1~2462@))) (=> (= temp_14_0~2397@ temp_14_1~2462@) (=> (= temp_15_0~2523@ (Mul b15~124@ (Mul (Mul (Mul b15~124@ a15~122@) (Sub c15~126@ a15~122@)) (Mul (Mul d15~128@ a15~122@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2560@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Sub c15~126@ a15~122@)) (Mul (Mul d15~128@ a15~122@) (Mul c15~126@ c15~126@))) b15~124@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2523@ temp_15_1~2560@))) (=> (= temp_15_0~2523@ temp_15_1~2560@) (=> (= temp_16_0~2625@ (Add (Mul (Mul (Mul b16~132@ d16~136@) (Add a16~130@ c16~134@)) d16~136@) (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ d16~136@)) a16~130@))) (=> (= temp_16_1~2666@ (Add (Mul (Mul (Add a16~130@ c16~134@) (Mul b16~132@ d16~136@)) d16~136@) (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ d16~136@)) a16~130@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2625@ temp_16_1~2666@))) (=> (= temp_16_0~2625@ temp_16_1~2666@) (=> (= temp_17_0~2755@ (Mul (Sub (Add (Mul a17~138@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Mul a17~138@ d17~144@) (Mul a17~138@ b17~140@))) (Add (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ b17~140@)) (Sub (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@))))) (=> (= temp_17_1~2820@ (Mul (Add (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ b17~140@)) (Sub (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@))) (Sub (Add (Mul a17~138@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Mul a17~138@ d17~144@) (Mul a17~138@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2755@ temp_17_1~2820@))) (=> (= temp_17_0~2755@ temp_17_1~2820@) (=> (= temp_18_0~2921@ (Mul (Sub (Mul (Mul c18~150@ a18~146@) (Mul c18~150@ b18~148@)) (Mul (Sub d18~152@ 37) (Mul b18~148@ b18~148@))) (Mul (Mul (Mul b18~148@ a18~146@) (Mul d18~152@ a18~146@)) (Mul (Mul b18~148@ c18~150@) (Mul b18~148@ b18~148@))))) (=> (= temp_18_1~2998@ (Mul (Sub (Mul (Mul c18~150@ a18~146@) (Mul c18~150@ b18~148@)) (Mul (Sub d18~152@ 37) (Mul b18~148@ b18~148@))) (Mul (Mul (Mul b18~148@ a18~146@) (Mul d18~152@ a18~146@)) (Mul (Mul b18~148@ b18~148@) (Mul b18~148@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2921@ temp_18_1~2998@))) (=> (= temp_18_0~2921@ temp_18_1~2998@) (=> (= temp_19_0~3087@ (Mul (Mul (Mul (Mul d19~160@ a19~154@) (Mul c19~158@ a19~154@)) (Mul (Mul b19~156@ a19~154@) (Mul c19~158@ a19~154@))) (Mul (Mul (Mul c19~158@ a19~154@) (Add d19~160@ d19~160@)) (Sub (Mul d19~160@ c19~158@) (Mul b19~156@ d19~160@))))) (=> (= temp_19_1~3152@ (Mul (Mul (Mul (Mul d19~160@ a19~154@) (Mul c19~158@ a19~154@)) (Mul (Mul b19~156@ a19~154@) (Mul c19~158@ a19~154@))) (Mul (Mul (Add d19~160@ d19~160@) (Mul c19~158@ a19~154@)) (Sub (Mul d19~160@ c19~158@) (Mul b19~156@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3087@ temp_19_1~3152@))) (=> (= temp_19_0~3087@ temp_19_1~3152@) (=> (= temp_20_0~3237@ (Mul (Mul (Mul (Mul b20~164@ a20~162@) (Mul c20~166@ c20~166@)) (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ b20~164@))) (Mul (Add (Mul c20~166@ d20~168@) (Mul a20~162@ d20~168@)) (Mul c20~166@ (Mul c20~166@ b20~164@))))) (=> (= temp_20_1~3294@ (Mul (Mul (Mul (Mul b20~164@ a20~162@) (Mul c20~166@ c20~166@)) (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ b20~164@))) (Mul (Mul (Add c20~166@ a20~162@) d20~168@) (Mul c20~166@ (Mul c20~166@ b20~164@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3237@ temp_20_1~3294@))) (=> (= temp_20_0~3237@ temp_20_1~3294@) (=> (= temp_21_0~3383@ (Mul (Mul (Sub (Mul d21~176@ c21~174@) (Mul c21~174@ a21~170@)) (Mul (Sub d21~176@ d21~176@) (Mul c21~174@ d21~176@))) (Mul (Mul (Mul b21~172@ a21~170@) (Mul a21~170@ c21~174@)) (Mul (Mul d21~176@ c21~174@) (Mul b21~172@ a21~170@))))) (=> (= temp_21_1~3448@ (Mul (Mul (Sub (Mul d21~176@ c21~174@) (Mul c21~174@ a21~170@)) (Mul (Sub d21~176@ d21~176@) (Mul d21~176@ c21~174@))) (Mul (Mul (Mul b21~172@ a21~170@) (Mul a21~170@ c21~174@)) (Mul (Mul d21~176@ c21~174@) (Mul b21~172@ a21~170@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3383@ temp_21_1~3448@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
