...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Mul (Mul (Add (Mul b0~4@ a0~2@) (Add a0~2@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ c0~6@))) a0~2@)) (=> (= temp_0_1~314@ (Mul a0~2@ (Mul (Add (Mul b0~4@ a0~2@) (Add a0~2@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~277@ temp_0_1~314@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~390@ (Sub (Mul (Mul (Mul c1~14@ d1~16@) d1~16@) (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Add d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~451@ (Sub (Mul (Mul (Mul c1~14@ d1~16@) d1~16@) (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul c1~14@ a1~10@) (Add d1~16@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~390@ temp_1_1~451@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~519@ (Mul (Mul (Mul (Add a2~18@ c2~22@) (Sub c2~22@ b2~20@)) c2~22@) (Mul (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~572@ (Mul (Mul (Mul (Add a2~18@ c2~22@) (Sub c2~22@ b2~20@)) c2~22@) (Mul (Mul (Mul b2~20@ a2~18@) (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~519@ temp_2_1~572@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~652@ (Mul (Add (Sub (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Add b3~28@ d3~32@))) (Mul (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~717@ (Mul (Add (Sub (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Add b3~28@ d3~32@))) (Mul (Mul (Mul (Sub c3~30@ d3~32@) b3~28@) c3~30@) (Add (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~652@ temp_3_1~717@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~793@ (Mul (Mul (Mul (Add b4~36@ d4~40@) (Add b4~36@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ a4~34@))) (Mul (Add (Mul a4~34@ c4~38@) c4~38@) (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~854@ (Mul (Mul (Mul (Add b4~36@ d4~40@) (Add b4~36@ b4~36@)) (Mul (Mul (Mul c4~38@ d4~40@) a4~34@) a4~34@)) (Mul (Add (Mul a4~34@ c4~38@) c4~38@) (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~793@ temp_4_1~854@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~934@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ d5~48@))) (Sub (Mul (Mul b5~44@ a5~42@) (Sub a5~42@ a5~42@)) (Mul (Add d5~48@ b5~44@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~999@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ a5~42@))) (Sub (Mul (Mul b5~44@ a5~42@) (Sub a5~42@ a5~42@)) (Mul (Add d5~48@ b5~44@) (Mul c5~46@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~934@ temp_5_1~999@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1075@ (Mul (Mul (Add (Sub d6~56@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ d6~56@))) (Mul (Mul d6~56@ (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1136@ (Mul (Mul (Add (Sub d6~56@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Mul d6~56@ (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1075@ temp_6_1~1136@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1216@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1281@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ c7~62@)) (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1216@ temp_7_1~1281@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1357@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~1418@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1357@ temp_8_1~1418@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1490@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ b9~76@)) (Mul b9~76@ (Mul b9~76@ a9~74@))) (Mul (Mul (Sub d9~80@ c9~78@) c9~78@) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~1547@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ b9~76@)) (Mul b9~76@ (Mul b9~76@ a9~74@))) (Mul (Mul (Sub d9~80@ c9~78@) c9~78@) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ b9~76@))))) (=> (= tmp%10@ (= temp_9_0~1490@ temp_9_1~1547@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1635@ (Mul (Sub (Add a10~82@ (Mul a10~82@ c10~86@)) (Sub (Mul a10~82@ d10~88@) (Mul 44 a10~82@))) (Add (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~1708@ (Mul (Sub (Add a10~82@ (Mul a10~82@ c10~86@)) (Sub (Mul a10~82@ d10~88@) (Mul 44 a10~82@))) (Add (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ b10~84@)) (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1635@ temp_10_1~1708@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1796@ (Add (Mul (Add (Mul c11~94@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul 31 c11~94@))) (Mul (Mul b11~92@ (Mul d11~96@ b11~92@)) (Mul (Add c11~94@ a11~90@) (Mul b11~92@ b11~92@))))) (=> (= temp_11_1~1869@ (Add (Mul (Add (Mul c11~94@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul 31 c11~94@))) (Mul (Mul (Mul d11~96@ b11~92@) b11~92@) (Mul (Add c11~94@ a11~90@) (Mul b11~92@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1796@ temp_11_1~1869@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1969@ (Mul (Mul (Mul (Mul d12~104@ c12~102@) d12~104@) (Mul (Mul a12~98@ 21) (Sub 80 a12~98@))) (Mul (Mul (Sub a12~98@ b12~100@) (Mul a12~98@ a12~98@)) (Mul (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2054@ (Mul (Mul (Mul (Mul (Mul d12~104@ c12~102@) d12~104@) (Mul (Mul a12~98@ 21) (Sub 80 a12~98@))) (Mul (Sub a12~98@ b12~100@) (Mul a12~98@ a12~98@))) (Mul (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@)))) (=> (= tmp%13@ (= temp_12_0~1969@ temp_12_1~2054@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2130@ (Mul (Mul (Mul (Add a13~106@ a13~106@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ c13~110@))) (Sub (Mul (Mul a13~106@ d13~112@) c13~110@) (Sub (Add a13~106@ a13~106@) (Mul b13~108@ a13~106@))))) (=> (= temp_13_1~2191@ (Mul (Mul (Mul (Add a13~106@ a13~106@) (Mul c13~110@ d13~112@)) (Mul c13~110@ (Mul d13~112@ (Mul c13~110@ c13~110@)))) (Sub (Mul (Mul a13~106@ d13~112@) c13~110@) (Sub (Add a13~106@ a13~106@) (Mul b13~108@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2130@ temp_13_1~2191@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2271@ (Mul (Add (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ b14~116@)) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ a14~114@)) (Mul (Sub d14~120@ d14~120@) (Mul d14~120@ b14~116@))))) (=> (= temp_14_1~2336@ (Mul (Add (Mul d14~120@ (Mul c14~118@ (Mul c14~118@ b14~116@))) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ a14~114@)) (Mul (Sub d14~120@ d14~120@) (Mul d14~120@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2271@ temp_14_1~2336@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2388@ (Mul b15~124@ (Mul (Mul (Mul b15~124@ a15~122@) (Sub c15~126@ a15~122@)) (Mul (Mul d15~128@ a15~122@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2425@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Sub c15~126@ a15~122@)) (Mul (Mul d15~128@ a15~122@) (Mul c15~126@ c15~126@))) b15~124@)) (=> (= tmp%16@ (= temp_15_0~2388@ temp_15_1~2425@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2481@ (Add (Mul (Mul (Mul b16~132@ d16~136@) (Add a16~130@ c16~134@)) d16~136@) (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ d16~136@)) a16~130@))) (=> (= temp_16_1~2522@ (Add (Mul (Mul (Add a16~130@ c16~134@) (Mul b16~132@ d16~136@)) d16~136@) (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ d16~136@)) a16~130@))) (=> (= tmp%17@ (= temp_16_0~2481@ temp_16_1~2522@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2602@ (Mul (Sub (Add (Mul a17~138@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Mul a17~138@ d17~144@) (Mul a17~138@ b17~140@))) (Add (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ b17~140@)) (Sub (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@))))) (=> (= temp_17_1~2667@ (Mul (Add (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ b17~140@)) (Sub (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@))) (Sub (Add (Mul a17~138@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Mul a17~138@ d17~144@) (Mul a17~138@ b17~140@))))) (=> (= tmp%18@ (= temp_17_0~2602@ temp_17_1~2667@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2759@ (Mul (Sub (Mul (Mul c18~150@ a18~146@) (Mul c18~150@ b18~148@)) (Mul (Sub d18~152@ 37) (Mul b18~148@ b18~148@))) (Mul (Mul (Mul b18~148@ a18~146@) (Mul d18~152@ a18~146@)) (Mul (Mul b18~148@ c18~150@) (Mul b18~148@ b18~148@))))) (=> (= temp_18_1~2836@ (Mul (Sub (Mul (Mul c18~150@ a18~146@) (Mul c18~150@ b18~148@)) (Mul (Sub d18~152@ 37) (Mul b18~148@ b18~148@))) (Mul (Mul (Mul b18~148@ a18~146@) (Mul d18~152@ a18~146@)) (Mul (Mul b18~148@ b18~148@) (Mul b18~148@ c18~150@))))) (=> (= tmp%19@ (= temp_18_0~2759@ temp_18_1~2836@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2916@ (Mul (Mul (Mul (Mul d19~160@ a19~154@) (Mul c19~158@ a19~154@)) (Mul (Mul b19~156@ a19~154@) (Mul c19~158@ a19~154@))) (Mul (Mul (Mul c19~158@ a19~154@) (Add d19~160@ d19~160@)) (Sub (Mul d19~160@ c19~158@) (Mul b19~156@ d19~160@))))) (=> (= temp_19_1~2981@ (Mul (Mul (Mul (Mul d19~160@ a19~154@) (Mul c19~158@ a19~154@)) (Mul (Mul b19~156@ a19~154@) (Mul c19~158@ a19~154@))) (Mul (Mul (Add d19~160@ d19~160@) (Mul c19~158@ a19~154@)) (Sub (Mul d19~160@ c19~158@) (Mul b19~156@ d19~160@))))) (=> (= tmp%20@ (= temp_19_0~2916@ temp_19_1~2981@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3057@ (Mul (Mul (Mul (Mul b20~164@ a20~162@) (Mul c20~166@ c20~166@)) (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ b20~164@))) (Mul (Add (Mul c20~166@ d20~168@) (Mul a20~162@ d20~168@)) (Mul c20~166@ (Mul c20~166@ b20~164@))))) (=> (= temp_20_1~3114@ (Mul (Mul (Mul (Mul b20~164@ a20~162@) (Mul c20~166@ c20~166@)) (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ b20~164@))) (Mul (Mul (Add c20~166@ a20~162@) d20~168@) (Mul c20~166@ (Mul c20~166@ b20~164@))))) (=> (= tmp%21@ (= temp_20_0~3057@ temp_20_1~3114@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3194@ (Mul (Mul (Sub (Mul d21~176@ c21~174@) (Mul c21~174@ a21~170@)) (Mul (Sub d21~176@ d21~176@) (Mul c21~174@ d21~176@))) (Mul (Mul (Mul b21~172@ a21~170@) (Mul a21~170@ c21~174@)) (Mul (Mul d21~176@ c21~174@) (Mul b21~172@ a21~170@))))) (=> (= temp_21_1~3259@ (Mul (Mul (Sub (Mul d21~176@ c21~174@) (Mul c21~174@ a21~170@)) (Mul (Sub d21~176@ d21~176@) (Mul d21~176@ c21~174@))) (Mul (Mul (Mul b21~172@ a21~170@) (Mul a21~170@ c21~174@)) (Mul (Mul d21~176@ c21~174@) (Mul b21~172@ a21~170@))))) (=> (= tmp%22@ (= temp_21_0~3194@ temp_21_1~3259@)) (=> %%location_label%%21 tmp%22@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
