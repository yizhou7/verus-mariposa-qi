...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul c0~6@ (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul b0~4@ b0~4@) (Sub a0~2@ c0~6@)) (Mul (Sub d0~8@ b0~4@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul c0~6@ (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ a0~2@))) (Mul (Mul (Sub d0~8@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ b0~4@) (Sub a0~2@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~459@ (Sub (Sub (Mul (Mul d1~16@ d1~16@) (Add c1~14@ 60)) (Mul (Sub b1~12@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Add b1~12@ (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~532@ (Sub (Sub (Mul (Mul d1~16@ d1~16@) (Add c1~14@ 60)) (Mul (Sub b1~12@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Add b1~12@ (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~459@ temp_1_1~532@))) (=> (= temp_1_0~459@ temp_1_1~532@) (=> (= temp_2_0~613@ (Sub (Sub (Mul (Mul a2~18@ c2~22@) b2~20@) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Sub (Mul c2~22@ c2~22@) (Add a2~18@ b2~20@)) (Mul (Mul d2~24@ d2~24@) c2~22@)))) (=> (= temp_2_1~670@ (Sub (Sub (Mul (Mul a2~18@ c2~22@) b2~20@) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Sub (Mul c2~22@ c2~22@) (Add a2~18@ b2~20@)) (Mul (Mul d2~24@ d2~24@) c2~22@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~613@ temp_2_1~670@))) (=> (= temp_2_0~613@ temp_2_1~670@) (=> (= temp_3_0~759@ (Mul (Mul (Mul (Add c3~30@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~824@ (Mul (Mul (Mul (Add c3~30@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~759@ temp_3_1~824@))) (=> (= temp_3_0~759@ temp_3_1~824@) (=> (= temp_4_0~909@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ b4~36@))) (Mul (Sub (Mul c4~38@ d4~40@) (Mul a4~34@ a4~34@)) (Sub c4~38@ (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~986@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ b4~36@))) (Sub (Mul (Sub (Mul c4~38@ d4~40@) (Mul a4~34@ a4~34@)) c4~38@) (Mul (Sub (Mul c4~38@ d4~40@) (Mul a4~34@ a4~34@)) (Mul c4~38@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~909@ temp_4_1~986@))) (=> (= temp_4_0~909@ temp_4_1~986@) (=> (= temp_5_0~1075@ (Add (Mul (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Add d5~48@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Add d5~48@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ d5~48@) (Mul b5~44@ c5~46@))))) (=> (= temp_5_1~1140@ (Add (Mul (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Add d5~48@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Add d5~48@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ d5~48@) (Mul b5~44@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1075@ temp_5_1~1140@))) (=> (= temp_5_0~1075@ temp_5_1~1140@) (=> (= temp_6_0~1229@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ d6~56@)) (Mul (Mul a6~50@ b6~52@) (Sub a6~50@ b6~52@))) (Sub (Mul (Add c6~54@ b6~52@) (Sub c6~54@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1294@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ b6~52@) (Sub a6~50@ b6~52@))) (Sub (Mul (Add c6~54@ b6~52@) (Sub c6~54@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1229@ temp_6_1~1294@))) (=> (= temp_6_0~1229@ temp_6_1~1294@) (=> (= temp_7_0~1383@ (Mul (Mul (Add (Mul b7~60@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Add (Add c7~62@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1448@ (Mul (Mul (Add (Mul b7~60@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Add (Add c7~62@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1383@ temp_7_1~1448@))) (=> (= temp_7_0~1383@ temp_7_1~1448@) (=> (= temp_8_0~1509@ (Mul (Mul (Mul (Mul b8~68@ b8~68@) (Add b8~68@ b8~68@)) (Sub (Mul c8~70@ d8~72@) (Mul b8~68@ a8~66@))) d8~72@)) (=> (= temp_8_1~1554@ (Mul (Mul (Add (Mul (Mul b8~68@ b8~68@) b8~68@) (Mul (Mul b8~68@ b8~68@) b8~68@)) (Sub (Mul c8~70@ d8~72@) (Mul b8~68@ a8~66@))) d8~72@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1509@ temp_8_1~1554@))) (=> (= temp_8_0~1509@ temp_8_1~1554@) (=> (= temp_9_0~1643@ (Mul (Mul (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ d9~80@)) (Mul (Sub d9~80@ d9~80@) (Mul a9~74@ a9~74@))) (Mul (Mul (Sub c9~78@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul d9~80@ b9~76@) (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~1708@ (Mul (Mul (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ d9~80@)) (Mul (Sub d9~80@ d9~80@) (Mul a9~74@ a9~74@))) (Mul (Mul (Sub c9~78@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ a9~74@) (Mul d9~80@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1643@ temp_9_1~1708@))) (=> (= temp_9_0~1643@ temp_9_1~1708@) (=> (= temp_10_0~1785@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ c10~86@))) (Mul (Mul (Mul d10~88@ a10~82@) (Sub d10~88@ c10~86@)) d10~88@))) (=> (= temp_10_1~1838@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ c10~86@))) (Mul (Mul d10~88@ (Mul a10~82@ (Sub d10~88@ c10~86@))) d10~88@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1785@ temp_10_1~1838@))) (=> (= temp_10_0~1785@ temp_10_1~1838@) (=> (= temp_11_0~1939@ (Add (Mul (Sub (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@)) (Sub (Mul c11~94@ 52) (Mul d11~96@ b11~92@))) (Mul (Mul (Sub d11~96@ a11~90@) (Mul c11~94@ b11~92@)) (Mul (Mul c11~94@ b11~92@) (Mul a11~90@ b11~92@))))) (=> (= temp_11_1~2024@ (Add (Mul (Sub (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@)) (Sub (Mul c11~94@ 52) (Mul d11~96@ b11~92@))) (Mul (Sub (Mul d11~96@ (Mul c11~94@ b11~92@)) (Mul a11~90@ (Mul c11~94@ b11~92@))) (Mul (Mul c11~94@ b11~92@) (Mul a11~90@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1939@ temp_11_1~2024@))) (=> (= temp_11_0~1939@ temp_11_1~2024@) (=> (= temp_12_0~2109@ (Add (Mul (Mul (Mul a12~98@ d12~104@) (Mul b12~100@ a12~98@)) (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ b12~100@)) (Add (Sub b12~100@ a12~98@) a12~98@)))) (=> (= temp_12_1~2170@ (Add (Mul (Mul (Mul a12~98@ d12~104@) (Mul b12~100@ a12~98@)) (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ c12~102@)) (Add (Sub b12~100@ a12~98@) a12~98@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2109@ temp_12_1~2170@))) (=> (= temp_12_0~2109@ temp_12_1~2170@) (=> (= temp_13_0~2259@ (Mul (Sub (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ d13~112@))) (Mul (Mul (Mul a13~106@ a13~106@) (Add b13~108@ a13~106@)) (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ d13~112@))))) (=> (= temp_13_1~2324@ (Mul (Mul (Sub (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ d13~112@))) (Mul (Mul a13~106@ a13~106@) (Add b13~108@ a13~106@))) (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ d13~112@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2259@ temp_13_1~2324@))) (=> (= temp_13_0~2259@ temp_13_1~2324@) (=> (= temp_14_0~2425@ (Mul (Mul (Sub (Sub a14~114@ c14~118@) (Mul b14~116@ c14~118@)) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ d14~120@))) (Add (Mul (Mul b14~116@ a14~114@) (Mul a14~114@ b14~116@)) (Mul (Mul 80 d14~120@) (Mul a14~114@ c14~118@))))) (=> (= temp_14_1~2502@ (Mul (Mul (Sub (Sub a14~114@ c14~118@) (Mul b14~116@ c14~118@)) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ d14~120@))) (Add (Mul (Mul (Mul b14~116@ a14~114@) a14~114@) b14~116@) (Mul (Mul 80 d14~120@) (Mul a14~114@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2425@ temp_14_1~2502@))) (=> (= temp_14_0~2425@ temp_14_1~2502@) (=> (= temp_15_0~2603@ (Add (Mul (Mul (Mul a15~122@ 71) (Mul c15~126@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ a15~122@))) (Mul (Mul (Add d15~128@ c15~126@) (Mul b15~124@ a15~122@)) (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2680@ (Add (Mul (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ 71)) (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ a15~122@))) (Mul (Mul (Add d15~128@ c15~126@) (Mul b15~124@ a15~122@)) (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2603@ temp_15_1~2680@))) (=> (= temp_15_0~2603@ temp_15_1~2680@) (=> (= temp_16_0~2765@ (Mul (Sub (Mul (Mul c16~134@ a16~130@) c16~134@) (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul b16~132@ a16~130@) (Sub d16~136@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ c16~134@))))) (=> (= temp_16_1~2826@ (Mul (Sub (Mul (Mul c16~134@ a16~130@) c16~134@) (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul b16~132@ a16~130@) (Sub d16~136@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2765@ temp_16_1~2826@))) (=> (= temp_16_0~2765@ temp_16_1~2826@) (=> (= temp_17_0~2903@ (Mul (Add (Mul (Mul d17~144@ c17~142@) (Mul a17~138@ c17~142@)) (Mul (Sub b17~140@ c17~142@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul c17~142@ a17~138@)) a17~138@))) (=> (= temp_17_1~2956@ (Mul (Add (Mul (Mul c17~142@ d17~144@) (Mul a17~138@ c17~142@)) (Mul (Sub b17~140@ c17~142@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul c17~142@ a17~138@)) a17~138@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2903@ temp_17_1~2956@))) (=> (= temp_17_0~2903@ temp_17_1~2956@) (=> (= temp_18_0~3057@ (Add (Mul (Mul (Mul d18~152@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ a18~146@))) (Mul (Mul (Mul 47 c18~150@) (Mul b18~148@ b18~148@)) (Mul (Mul d18~152@ c18~150@) (Sub a18~146@ c18~150@))))) (=> (= temp_18_1~3134@ (Add (Mul (Mul (Mul d18~152@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ a18~146@))) (Mul (Mul (Mul b18~148@ b18~148@) (Mul 47 c18~150@)) (Mul (Mul d18~152@ c18~150@) (Sub a18~146@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3057@ temp_18_1~3134@))) (=> (= temp_18_0~3057@ temp_18_1~3134@) (=> (= temp_19_0~3235@ (Mul (Mul (Mul (Add d19~160@ d19~160@) (Mul 23 a19~154@)) (Add (Mul c19~158@ d19~160@) (Mul c19~158@ b19~156@))) (Mul (Mul (Mul c19~158@ a19~154@) (Mul a19~154@ b19~156@)) (Mul (Mul d19~160@ c19~158@) (Mul b19~156@ d19~160@))))) (=> (= temp_19_1~3312@ (Mul (Mul (Mul (Add d19~160@ d19~160@) (Mul 23 a19~154@)) (Add (Mul c19~158@ d19~160@) (Mul c19~158@ b19~156@))) (Mul (Mul (Mul c19~158@ a19~154@) (Mul b19~156@ a19~154@)) (Mul (Mul d19~160@ c19~158@) (Mul b19~156@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3235@ temp_19_1~3312@))) (=> (= temp_19_0~3235@ temp_19_1~3312@) (=> (= temp_20_0~3421@ (Mul (Mul (Mul (Add b20~164@ b20~164@) (Mul d20~168@ b20~164@)) (Mul (Mul b20~164@ a20~162@) (Mul c20~166@ c20~166@))) (Mul (Mul (Mul c20~166@ 72) (Mul d20~168@ a20~162@)) (Mul (Add c20~166@ 22) c20~166@)))) (=> (= temp_20_1~3506@ (Mul (Mul (Mul (Add b20~164@ b20~164@) (Mul d20~168@ b20~164@)) (Mul (Mul c20~166@ c20~166@) (Mul b20~164@ a20~162@))) (Mul (Mul (Mul c20~166@ 72) (Mul d20~168@ a20~162@)) (Mul (Add c20~166@ 22) c20~166@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3421@ temp_20_1~3506@))) (=> (= temp_20_0~3421@ temp_20_1~3506@) (=> (= temp_21_0~3607@ (Mul (Mul (Mul (Mul d21~176@ d21~176@) (Mul c21~174@ c21~174@)) (Sub (Mul a21~170@ b21~172@) (Mul a21~170@ a21~170@))) (Add (Mul (Mul b21~172@ b21~172@) (Mul a21~170@ d21~176@)) (Sub (Mul a21~170@ 82) (Mul b21~172@ b21~172@))))) (=> (= temp_21_1~3684@ (Mul (Mul (Mul (Mul d21~176@ d21~176@) (Mul c21~174@ c21~174@)) (Sub (Mul a21~170@ b21~172@) (Mul a21~170@ a21~170@))) (Add (Mul (Mul b21~172@ b21~172@) (Mul a21~170@ d21~176@)) (Sub (Mul a21~170@ 82) (Mul b21~172@ b21~172@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3607@ temp_21_1~3684@))) (=> (= temp_21_0~3607@ temp_21_1~3684@) (=> (= temp_22_0~3773@ (Sub (Mul (Mul (Mul b22~180@ c22~182@) (Add d22~184@ c22~182@)) (Mul (Add d22~184@ d22~184@) (Mul b22~180@ d22~184@))) (Mul (Sub (Sub c22~182@ d22~184@) (Mul a22~178@ a22~178@)) (Sub (Add b22~180@ a22~178@) (Mul b22~180@ c22~182@))))) (=> (= temp_22_1~3838@ (Sub (Mul (Mul (Add d22~184@ d22~184@) (Mul b22~180@ d22~184@)) (Mul (Mul b22~180@ c22~182@) (Add d22~184@ c22~182@))) (Mul (Sub (Sub c22~182@ d22~184@) (Mul a22~178@ a22~178@)) (Sub (Add b22~180@ a22~178@) (Mul b22~180@ c22~182@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3773@ temp_22_1~3838@))) (=> (= temp_22_0~3773@ temp_22_1~3838@) (=> (= temp_23_0~3939@ (Mul (Sub (Add (Mul c23~190@ b23~188@) (Mul b23~188@ c23~190@)) (Add (Mul b23~188@ c23~190@) (Mul d23~192@ b23~188@))) (Mul (Mul (Mul d23~192@ 59) (Mul c23~190@ d23~192@)) (Mul (Mul c23~190@ b23~188@) (Mul b23~188@ a23~186@))))) (=> (= temp_23_1~4016@ (Mul (Mul (Sub (Add (Mul c23~190@ b23~188@) (Mul b23~188@ c23~190@)) (Add (Mul b23~188@ c23~190@) (Mul d23~192@ b23~188@))) (Mul (Mul d23~192@ 59) (Mul c23~190@ d23~192@))) (Mul (Mul c23~190@ b23~188@) (Mul b23~188@ a23~186@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3939@ temp_23_1~4016@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
