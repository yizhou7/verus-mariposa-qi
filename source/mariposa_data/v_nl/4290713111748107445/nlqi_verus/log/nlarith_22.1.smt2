...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Add (Sub d0~8@ c0~6@) (Mul a0~2@ c0~6@)) (Mul b0~4@ (Mul a0~2@ d0~8@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Mul (Add (Sub d0~8@ c0~6@) (Mul a0~2@ c0~6@)) (Mul b0~4@ (Mul a0~2@ d0~8@))) (Mul (Mul (Mul (Mul d0~8@ b0~4@) d0~8@) d0~8@) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~438@ (Add (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ d1~16@))) (Mul (Mul (Mul b1~12@ a1~10@) d1~16@) (Add (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~499@ (Add (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ d1~16@))) (Mul (Mul (Mul b1~12@ a1~10@) d1~16@) (Add (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~438@ temp_1_1~499@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~591@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul a2~18@ c2~22@) (Sub 13 a2~18@))) (Mul (Mul (Mul b2~20@ d2~24@) (Add d2~24@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~668@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul a2~18@ c2~22@) (Sub 13 a2~18@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Add d2~24@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~591@ temp_2_1~668@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~736@ (Mul (Sub (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ a3~26@)) (Mul (Sub a3~26@ d3~32@) (Mul a3~26@ a3~26@))) (Mul (Mul (Mul a3~26@ c3~30@) (Sub c3~30@ a3~26@)) c3~30@))) (=> (= temp_3_1~789@ (Mul (Sub (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Sub a3~26@ d3~32@) (Mul a3~26@ a3~26@))) (Mul (Mul (Mul a3~26@ c3~30@) (Sub c3~30@ a3~26@)) c3~30@))) (=> (= tmp%4@ (= temp_3_0~736@ temp_3_1~789@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~865@ (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Add d4~40@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul b4~36@ (Add c4~38@ d4~40@)) (Sub (Sub d4~40@ c4~38@) (Sub c4~38@ d4~40@))))) (=> (= temp_4_1~938@ (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Add d4~40@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@))) (Sub (Mul (Mul b4~36@ (Add c4~38@ d4~40@)) (Sub d4~40@ c4~38@)) (Mul (Mul b4~36@ (Add c4~38@ d4~40@)) (Sub c4~38@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~865@ temp_4_1~938@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1026@ (Add (Mul (Mul (Add a5~42@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Sub a5~42@ a5~42@))) (Add (Mul (Mul a5~42@ d5~48@) d5~48@) (Add (Mul 51 a5~42@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1107@ (Add (Mul (Mul (Add a5~42@ b5~44@) (Mul d5~48@ c5~46@)) (Sub (Mul (Mul b5~44@ d5~48@) a5~42@) (Mul (Mul b5~44@ d5~48@) a5~42@))) (Add (Mul (Mul a5~42@ d5~48@) d5~48@) (Add (Mul 51 a5~42@) (Mul a5~42@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1026@ temp_5_1~1107@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1199@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Add d6~56@ 29)) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ d6~56@))) (Mul (Sub (Mul a6~50@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ b6~52@) (Add c6~54@ b6~52@))))) (=> (= temp_6_1~1276@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Add d6~56@ 29)) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ d6~56@))) (Mul (Sub (Mul c6~54@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ b6~52@) (Add c6~54@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1199@ temp_6_1~1276@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1344@ (Mul (Mul (Sub b7~60@ (Mul d7~64@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ c7~62@))) (Mul (Mul a7~58@ (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ d7~64@) b7~60@)))) (=> (= temp_7_1~1397@ (Mul (Mul (Sub b7~60@ (Mul d7~64@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ c7~62@))) (Mul (Mul a7~58@ (Mul c7~62@ c7~62@)) (Mul b7~60@ (Mul d7~64@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1344@ temp_7_1~1397@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1473@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ d8~72@)) (Sub (Mul c8~70@ b8~68@) (Mul a8~66@ c8~70@))) (Add (Mul (Add c8~70@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Add a8~66@ a8~66@) a8~66@)))) (=> (= temp_8_1~1534@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@)) (Sub (Mul c8~70@ b8~68@) (Mul a8~66@ c8~70@))) (Add (Mul (Add c8~70@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Add a8~66@ a8~66@) a8~66@)))) (=> (= tmp%9@ (= temp_8_0~1473@ temp_8_1~1534@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1614@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ d9~80@)) (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~1679@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ d9~80@)) (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1614@ temp_9_1~1679@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1763@ (Add (Mul (Mul (Mul b10~84@ b10~84@) (Sub a10~82@ c10~86@)) (Sub (Mul b10~84@ b10~84@) b10~84@)) (Mul (Mul (Mul d10~88@ c10~86@) (Mul b10~84@ 30)) (Mul a10~82@ (Mul d10~88@ b10~84@))))) (=> (= temp_10_1~1832@ (Add (Mul (Sub (Mul b10~84@ b10~84@) b10~84@) (Mul (Mul b10~84@ b10~84@) (Sub a10~82@ c10~86@))) (Mul (Mul (Mul d10~88@ c10~86@) (Mul b10~84@ 30)) (Mul a10~82@ (Mul d10~88@ b10~84@))))) (=> (= tmp%11@ (= temp_10_0~1763@ temp_10_1~1832@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1924@ (Mul (Mul (Mul (Mul c11~94@ a11~90@) (Mul d11~96@ d11~96@)) (Mul (Sub d11~96@ a11~90@) (Sub c11~94@ d11~96@))) (Add (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul 78 b11~92@))))) (=> (= temp_11_1~2001@ (Mul (Mul (Mul (Mul c11~94@ a11~90@) (Mul d11~96@ d11~96@)) (Mul (Sub c11~94@ d11~96@) (Sub d11~96@ a11~90@))) (Add (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul 78 b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1924@ temp_11_1~2001@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2077@ (Add (Sub (Sub (Mul d12~104@ d12~104@) b12~100@) (Mul (Add c12~102@ b12~100@) (Mul b12~100@ c12~102@))) (Mul (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ a12~98@)) (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2146@ (Add (Sub (Sub (Mul d12~104@ d12~104@) b12~100@) (Add (Mul c12~102@ (Mul b12~100@ c12~102@)) (Mul b12~100@ (Mul b12~100@ c12~102@)))) (Mul (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ a12~98@)) (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ d12~104@))))) (=> (= tmp%13@ (= temp_12_0~2077@ temp_12_1~2146@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2198@ (Mul a13~106@ (Mul (Mul (Mul d13~112@ b13~108@) (Sub b13~108@ c13~110@)) (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2235@ (Mul a13~106@ (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ d13~112@)) (Mul (Mul d13~112@ b13~108@) (Sub b13~108@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2198@ temp_13_1~2235@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2323@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul 50 c14~118@)) (Mul a14~114@ (Mul d14~120@ b14~116@))) (Mul (Mul (Mul a14~114@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ b14~116@) (Sub d14~120@ a14~114@))))) (=> (= temp_14_1~2396@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul 50 c14~118@)) (Mul a14~114@ (Mul d14~120@ b14~116@))) (Mul (Mul (Mul c14~118@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ b14~116@) (Sub d14~120@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2323@ temp_14_1~2396@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2476@ (Add (Add (Mul (Mul a15~122@ d15~128@) (Add b15~124@ b15~124@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul d15~128@ b15~124@) (Add b15~124@ c15~126@)) (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ d15~128@))))) (=> (= temp_15_1~2541@ (Add (Add (Mul (Mul a15~122@ d15~128@) (Add b15~124@ b15~124@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ c15~126@))) (Mul (Mul d15~128@ b15~124@) (Mul (Add b15~124@ c15~126@) (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ d15~128@)))))) (=> (= tmp%16@ (= temp_15_0~2476@ temp_15_1~2541@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2621@ (Mul (Mul (Mul (Add c16~134@ c16~134@) (Mul d16~136@ d16~136@)) (Mul (Mul a16~130@ a16~130@) (Mul d16~136@ b16~132@))) (Sub (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~2686@ (Mul (Mul (Add c16~134@ c16~134@) (Mul d16~136@ d16~136@)) (Mul (Mul (Mul a16~130@ a16~130@) (Mul d16~136@ b16~132@)) (Sub (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ a16~130@)))))) (=> (= tmp%17@ (= temp_16_0~2621@ temp_16_1~2686@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2766@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ c17~142@)) (Mul (Mul a17~138@ c17~142@) (Sub b17~140@ d17~144@))) (Mul (Mul (Mul b17~140@ c17~142@) (Sub a17~138@ b17~140@)) (Mul (Mul b17~140@ a17~138@) (Sub a17~138@ d17~144@))))) (=> (= temp_17_1~2839@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ c17~142@)) (Sub (Mul (Mul a17~138@ c17~142@) b17~140@) (Mul (Mul a17~138@ c17~142@) d17~144@))) (Mul (Mul (Mul b17~140@ c17~142@) (Sub a17~138@ b17~140@)) (Mul (Mul b17~140@ a17~138@) (Sub a17~138@ d17~144@))))) (=> (= tmp%18@ (= temp_17_0~2766@ temp_17_1~2839@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2927@ (Mul (Add (Mul (Mul 60 c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ a18~146@))) (Mul (Mul (Mul c18~150@ b18~148@) c18~150@) (Mul (Mul b18~148@ c18~150@) (Sub c18~150@ d18~152@))))) (=> (= temp_18_1~3000@ (Mul (Add (Mul (Mul 60 c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ a18~146@))) (Mul (Mul (Mul c18~150@ b18~148@) c18~150@) (Mul (Mul c18~150@ b18~148@) (Sub c18~150@ d18~152@))))) (=> (= tmp%19@ (= temp_18_0~2927@ temp_18_1~3000@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3092@ (Mul (Mul (Mul (Add c19~158@ 20) (Add b19~156@ d19~160@)) (Mul (Add d19~160@ d19~160@) (Mul d19~160@ d19~160@))) (Mul (Mul (Mul d19~160@ a19~154@) (Mul c19~158@ b19~156@)) (Mul (Sub b19~156@ c19~158@) (Mul c19~158@ b19~156@))))) (=> (= temp_19_1~3169@ (Mul (Mul (Mul (Add c19~158@ 20) (Add b19~156@ d19~160@)) (Mul (Mul (Add d19~160@ d19~160@) d19~160@) d19~160@)) (Mul (Mul (Mul d19~160@ a19~154@) (Mul c19~158@ b19~156@)) (Mul (Sub b19~156@ c19~158@) (Mul c19~158@ b19~156@))))) (=> (= tmp%20@ (= temp_19_0~3092@ temp_19_1~3169@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3233@ (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul c20~166@ b20~164@)) d20~168@) (Add (Mul (Mul a20~162@ d20~168@) (Mul a20~162@ a20~162@)) (Mul (Add c20~166@ b20~164@) d20~168@)))) (=> (= temp_20_1~3302@ (Add (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul c20~166@ b20~164@)) d20~168@) (Mul (Mul a20~162@ d20~168@) (Mul a20~162@ a20~162@))) (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul c20~166@ b20~164@)) d20~168@) (Mul (Add c20~166@ b20~164@) d20~168@)))) (=> (= tmp%21@ (= temp_20_0~3233@ temp_20_1~3302@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3370@ (Mul (Mul (Mul (Add a21~170@ d21~176@) (Mul d21~176@ a21~170@)) (Mul (Mul d21~176@ d21~176@) (Mul a21~170@ d21~176@))) (Sub a21~170@ (Mul (Mul c21~174@ b21~172@) (Mul b21~172@ a21~170@))))) (=> (= temp_21_1~3423@ (Mul (Mul (Add a21~170@ d21~176@) (Mul (Mul d21~176@ a21~170@) (Mul (Mul d21~176@ d21~176@) (Mul a21~170@ d21~176@)))) (Sub a21~170@ (Mul (Mul c21~174@ b21~172@) (Mul b21~172@ a21~170@))))) (=> (= tmp%22@ (= temp_21_0~3370@ temp_21_1~3423@)) (=> %%location_label%%21 tmp%22@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
