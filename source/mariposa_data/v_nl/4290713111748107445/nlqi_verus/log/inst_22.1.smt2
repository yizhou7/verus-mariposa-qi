...
(set-info :comment ";; mariposa_data/v_nl//4290713111748107445/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_9_0~1789@ Int)
(declare-const temp_9_1~1854@ Int)
(declare-const temp_10_0~1959@ Int)
(declare-const temp_10_1~2028@ Int)
(declare-const temp_11_0~2153@ Int)
(declare-const temp_11_1~2230@ Int)
(declare-const temp_12_0~2327@ Int)
(declare-const temp_12_1~2396@ Int)
(declare-const temp_13_0~2467@ Int)
(declare-const temp_13_1~2504@ Int)
(declare-const temp_14_0~2629@ Int)
(declare-const temp_14_1~2702@ Int)
(declare-const temp_15_0~2795@ Int)
(declare-const temp_15_1~2860@ Int)
(declare-const temp_16_0~2975@ Int)
(declare-const temp_16_1~3040@ Int)
(declare-const temp_17_0~3187@ Int)
(declare-const temp_17_1~3260@ Int)
(declare-const temp_18_0~3367@ Int)
(declare-const temp_18_1~3440@ Int)
(declare-const temp_19_0~3545@ Int)
(declare-const temp_19_1~3622@ Int)
(declare-const temp_20_0~3705@ Int)
(declare-const temp_20_1~3774@ Int)
(declare-const temp_21_0~3893@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Add (Sub d0~8@ c0~6@) (Mul a0~2@ c0~6@)) (Mul b0~4@ (Mul a0~2@ d0~8@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Mul (Add (Sub d0~8@ c0~6@) (Mul a0~2@ c0~6@)) (Mul b0~4@ (Mul a0~2@ d0~8@))) (Mul (Mul (Mul (Mul d0~8@ b0~4@) d0~8@) d0~8@) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ c0~6@))))) (and (=> (= tmp%1@ (Mul d0~8@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ d0~8@ d0~8@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@)))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~457@ (Add (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ d1~16@))) (Mul (Mul (Mul b1~12@ a1~10@) d1~16@) (Add (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~518@ (Add (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ d1~16@))) (Mul (Mul (Mul b1~12@ a1~10@) d1~16@) (Add (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ d1~16@) (=> %%location_label%%1 (= temp_1_0~457@ temp_1_1~518@))) (=> (= temp_1_0~457@ temp_1_1~518@) (=> (= temp_2_0~623@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul a2~18@ c2~22@) (Sub 13 a2~18@))) (Mul (Mul (Mul b2~20@ d2~24@) (Add d2~24@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~700@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul a2~18@ c2~22@) (Sub 13 a2~18@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Add d2~24@ c2~22@))))) (and (=> (= tmp%2@ (Mul (Mul b2~20@ d2~24@) (Add d2~24@ c2~22@))) (=> (= tmp%3@ (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ a2~18@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~623@ temp_2_1~700@))))) (=> (= temp_2_0~623@ temp_2_1~700@) (=> (= temp_3_0~805@ (Mul (Sub (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ a3~26@)) (Mul (Sub a3~26@ d3~32@) (Mul a3~26@ a3~26@))) (Mul (Mul (Mul a3~26@ c3~30@) (Sub c3~30@ a3~26@)) c3~30@))) (=> (= temp_3_1~858@ (Mul (Sub (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Sub a3~26@ d3~32@) (Mul a3~26@ a3~26@))) (Mul (Mul (Mul a3~26@ c3~30@) (Sub c3~30@ a3~26@)) c3~30@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ d3~32@) (=> %%location_label%%3 (= temp_3_0~805@ temp_3_1~858@))) (=> (= temp_3_0~805@ temp_3_1~858@) (=> (= temp_4_0~947@ (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Add d4~40@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul b4~36@ (Add c4~38@ d4~40@)) (Sub (Sub d4~40@ c4~38@) (Sub c4~38@ d4~40@))))) (=> (= temp_4_1~1020@ (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Add d4~40@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@))) (Sub (Mul (Mul b4~36@ (Add c4~38@ d4~40@)) (Sub d4~40@ c4~38@)) (Mul (Mul b4~36@ (Add c4~38@ d4~40@)) (Sub c4~38@ d4~40@))))) (and (=> (= tmp%4@ (Mul b4~36@ (Add c4~38@ d4~40@))) (=> (= tmp%5@ (Sub d4~40@ c4~38@)) (=> (= tmp%6@ (Sub c4~38@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~947@ temp_4_1~1020@)))))) (=> (= temp_4_0~947@ temp_4_1~1020@) (=> (= temp_5_0~1139@ (Add (Mul (Mul (Add a5~42@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Sub a5~42@ a5~42@))) (Add (Mul (Mul a5~42@ d5~48@) d5~48@) (Add (Mul 51 a5~42@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1220@ (Add (Mul (Mul (Add a5~42@ b5~44@) (Mul d5~48@ c5~46@)) (Sub (Mul (Mul b5~44@ d5~48@) a5~42@) (Mul (Mul b5~44@ d5~48@) a5~42@))) (Add (Mul (Mul a5~42@ d5~48@) d5~48@) (Add (Mul 51 a5~42@) (Mul a5~42@ d5~48@))))) (and (=> (= tmp%7@ (Mul b5~44@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%7@ a5~42@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1139@ temp_5_1~1220@)))) (=> (= temp_5_0~1139@ temp_5_1~1220@) (=> (= temp_6_0~1331@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Add d6~56@ 29)) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ d6~56@))) (Mul (Sub (Mul a6~50@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ b6~52@) (Add c6~54@ b6~52@))))) (=> (= temp_6_1~1408@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Add d6~56@ 29)) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ d6~56@))) (Mul (Sub (Mul c6~54@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ b6~52@) (Add c6~54@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1331@ temp_6_1~1408@))) (=> (= temp_6_0~1331@ temp_6_1~1408@) (=> (= temp_7_0~1489@ (Mul (Mul (Sub b7~60@ (Mul d7~64@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ c7~62@))) (Mul (Mul a7~58@ (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ d7~64@) b7~60@)))) (=> (= temp_7_1~1542@ (Mul (Mul (Sub b7~60@ (Mul d7~64@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ c7~62@))) (Mul (Mul a7~58@ (Mul c7~62@ c7~62@)) (Mul b7~60@ (Mul d7~64@ d7~64@))))) (and (=> (= tmp%8@ (Mul d7~64@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1489@ temp_7_1~1542@)))) (=> (= temp_7_0~1489@ temp_7_1~1542@) (=> (= temp_8_0~1635@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ d8~72@)) (Sub (Mul c8~70@ b8~68@) (Mul a8~66@ c8~70@))) (Add (Mul (Add c8~70@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Add a8~66@ a8~66@) a8~66@)))) (=> (= temp_8_1~1696@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@)) (Sub (Mul c8~70@ b8~68@) (Mul a8~66@ c8~70@))) (Add (Mul (Add c8~70@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Add a8~66@ a8~66@) a8~66@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1635@ temp_8_1~1696@))) (=> (= temp_8_0~1635@ temp_8_1~1696@) (=> (= temp_9_0~1789@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ d9~80@)) (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ a9~74@))))) (=> (= temp_9_1~1854@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ d9~80@)) (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ a9~74@))))) (and (=> (= tmp%9@ (Mul d9~80@ d9~80@)) (=> (= tmp%10@ (Mul b9~76@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%9 (= temp_9_0~1789@ temp_9_1~1854@))))) (=> (= temp_9_0~1789@ temp_9_1~1854@) (=> (= temp_10_0~1959@ (Add (Mul (Mul (Mul b10~84@ b10~84@) (Sub a10~82@ c10~86@)) (Sub (Mul b10~84@ b10~84@) b10~84@)) (Mul (Mul (Mul d10~88@ c10~86@) (Mul b10~84@ 30)) (Mul a10~82@ (Mul d10~88@ b10~84@))))) (=> (= temp_10_1~2028@ (Add (Mul (Sub (Mul b10~84@ b10~84@) b10~84@) (Mul (Mul b10~84@ b10~84@) (Sub a10~82@ c10~86@))) (Mul (Mul (Mul d10~88@ c10~86@) (Mul b10~84@ 30)) (Mul a10~82@ (Mul d10~88@ b10~84@))))) (and (=> (= tmp%11@ (Mul (Mul b10~84@ b10~84@) (Sub a10~82@ c10~86@))) (=> (= tmp%12@ (Sub (Mul b10~84@ b10~84@) b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%10 (= temp_10_0~1959@ temp_10_1~2028@))))) (=> (= temp_10_0~1959@ temp_10_1~2028@) (=> (= temp_11_0~2153@ (Mul (Mul (Mul (Mul c11~94@ a11~90@) (Mul d11~96@ d11~96@)) (Mul (Sub d11~96@ a11~90@) (Sub c11~94@ d11~96@))) (Add (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul 78 b11~92@))))) (=> (= temp_11_1~2230@ (Mul (Mul (Mul (Mul c11~94@ a11~90@) (Mul d11~96@ d11~96@)) (Mul (Sub c11~94@ d11~96@) (Sub d11~96@ a11~90@))) (Add (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul 78 b11~92@))))) (and (=> (= tmp%13@ (Sub d11~96@ a11~90@)) (=> (= tmp%14@ (Sub c11~94@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%11 (= temp_11_0~2153@ temp_11_1~2230@))))) (=> (= temp_11_0~2153@ temp_11_1~2230@) (=> (= temp_12_0~2327@ (Add (Sub (Sub (Mul d12~104@ d12~104@) b12~100@) (Mul (Add c12~102@ b12~100@) (Mul b12~100@ c12~102@))) (Mul (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ a12~98@)) (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2396@ (Add (Sub (Sub (Mul d12~104@ d12~104@) b12~100@) (Add (Mul c12~102@ (Mul b12~100@ c12~102@)) (Mul b12~100@ (Mul b12~100@ c12~102@)))) (Mul (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ a12~98@)) (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ d12~104@))))) (and (=> (= tmp%15@ (Mul b12~100@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c12~102@ b12~100@ tmp%15@) (=> %%location_label%%12 (= temp_12_0~2327@ temp_12_1~2396@)))) (=> (= temp_12_0~2327@ temp_12_1~2396@) (=> (= temp_13_0~2467@ (Mul a13~106@ (Mul (Mul (Mul d13~112@ b13~108@) (Sub b13~108@ c13~110@)) (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2504@ (Mul a13~106@ (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ d13~112@)) (Mul (Mul d13~112@ b13~108@) (Sub b13~108@ c13~110@))))) (and (=> (= tmp%16@ (Mul (Mul d13~112@ b13~108@) (Sub b13~108@ c13~110@))) (=> (= tmp%17@ (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ d13~112@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%13 (= temp_13_0~2467@ temp_13_1~2504@))))) (=> (= temp_13_0~2467@ temp_13_1~2504@) (=> (= temp_14_0~2629@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul 50 c14~118@)) (Mul a14~114@ (Mul d14~120@ b14~116@))) (Mul (Mul (Mul a14~114@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ b14~116@) (Sub d14~120@ a14~114@))))) (=> (= temp_14_1~2702@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul 50 c14~118@)) (Mul a14~114@ (Mul d14~120@ b14~116@))) (Mul (Mul (Mul c14~118@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ b14~116@) (Sub d14~120@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a14~114@ c14~118@) (=> %%location_label%%14 (= temp_14_0~2629@ temp_14_1~2702@))) (=> (= temp_14_0~2629@ temp_14_1~2702@) (=> (= temp_15_0~2795@ (Add (Add (Mul (Mul a15~122@ d15~128@) (Add b15~124@ b15~124@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul d15~128@ b15~124@) (Add b15~124@ c15~126@)) (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ d15~128@))))) (=> (= temp_15_1~2860@ (Add (Add (Mul (Mul a15~122@ d15~128@) (Add b15~124@ b15~124@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ c15~126@))) (Mul (Mul d15~128@ b15~124@) (Mul (Add b15~124@ c15~126@) (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ d15~128@)))))) (and (=> (= tmp%18@ (Mul d15~128@ b15~124@)) (=> (= tmp%19@ (Add b15~124@ c15~126@)) (=> (= tmp%20@ (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ d15~128@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%15 (= temp_15_0~2795@ temp_15_1~2860@)))))) (=> (= temp_15_0~2795@ temp_15_1~2860@) (=> (= temp_16_0~2975@ (Mul (Mul (Mul (Add c16~134@ c16~134@) (Mul d16~136@ d16~136@)) (Mul (Mul a16~130@ a16~130@) (Mul d16~136@ b16~132@))) (Sub (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~3040@ (Mul (Mul (Add c16~134@ c16~134@) (Mul d16~136@ d16~136@)) (Mul (Mul (Mul a16~130@ a16~130@) (Mul d16~136@ b16~132@)) (Sub (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ a16~130@)))))) (and (=> (= tmp%21@ (Mul (Add c16~134@ c16~134@) (Mul d16~136@ d16~136@))) (=> (= tmp%22@ (Mul (Mul a16~130@ a16~130@) (Mul d16~136@ b16~132@))) (=> (= tmp%23@ (Sub (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ a16~130@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%16 (= temp_16_0~2975@ temp_16_1~3040@)))))) (=> (= temp_16_0~2975@ temp_16_1~3040@) (=> (= temp_17_0~3187@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ c17~142@)) (Mul (Mul a17~138@ c17~142@) (Sub b17~140@ d17~144@))) (Mul (Mul (Mul b17~140@ c17~142@) (Sub a17~138@ b17~140@)) (Mul (Mul b17~140@ a17~138@) (Sub a17~138@ d17~144@))))) (=> (= temp_17_1~3260@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ c17~142@)) (Sub (Mul (Mul a17~138@ c17~142@) b17~140@) (Mul (Mul a17~138@ c17~142@) d17~144@))) (Mul (Mul (Mul b17~140@ c17~142@) (Sub a17~138@ b17~140@)) (Mul (Mul b17~140@ a17~138@) (Sub a17~138@ d17~144@))))) (and (=> (= tmp%24@ (Mul a17~138@ c17~142@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%24@ b17~140@ d17~144@) (=> %%location_label%%17 (= temp_17_0~3187@ temp_17_1~3260@)))) (=> (= temp_17_0~3187@ temp_17_1~3260@) (=> (= temp_18_0~3367@ (Mul (Add (Mul (Mul 60 c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ a18~146@))) (Mul (Mul (Mul c18~150@ b18~148@) c18~150@) (Mul (Mul b18~148@ c18~150@) (Sub c18~150@ d18~152@))))) (=> (= temp_18_1~3440@ (Mul (Add (Mul (Mul 60 c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ a18~146@))) (Mul (Mul (Mul c18~150@ b18~148@) c18~150@) (Mul (Mul c18~150@ b18~148@) (Sub c18~150@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b18~148@ c18~150@) (=> %%location_label%%18 (= temp_18_0~3367@ temp_18_1~3440@))) (=> (= temp_18_0~3367@ temp_18_1~3440@) (=> (= temp_19_0~3545@ (Mul (Mul (Mul (Add c19~158@ 20) (Add b19~156@ d19~160@)) (Mul (Add d19~160@ d19~160@) (Mul d19~160@ d19~160@))) (Mul (Mul (Mul d19~160@ a19~154@) (Mul c19~158@ b19~156@)) (Mul (Sub b19~156@ c19~158@) (Mul c19~158@ b19~156@))))) (=> (= temp_19_1~3622@ (Mul (Mul (Mul (Add c19~158@ 20) (Add b19~156@ d19~160@)) (Mul (Mul (Add d19~160@ d19~160@) d19~160@) d19~160@)) (Mul (Mul (Mul d19~160@ a19~154@) (Mul c19~158@ b19~156@)) (Mul (Sub b19~156@ c19~158@) (Mul c19~158@ b19~156@))))) (and (=> (= tmp%25@ (Add d19~160@ d19~160@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ d19~160@ d19~160@) (=> %%location_label%%19 (= temp_19_0~3545@ temp_19_1~3622@)))) (=> (= temp_19_0~3545@ temp_19_1~3622@) (=> (= temp_20_0~3705@ (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul c20~166@ b20~164@)) d20~168@) (Add (Mul (Mul a20~162@ d20~168@) (Mul a20~162@ a20~162@)) (Mul (Add c20~166@ b20~164@) d20~168@)))) (=> (= temp_20_1~3774@ (Add (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul c20~166@ b20~164@)) d20~168@) (Mul (Mul a20~162@ d20~168@) (Mul a20~162@ a20~162@))) (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul c20~166@ b20~164@)) d20~168@) (Mul (Add c20~166@ b20~164@) d20~168@)))) (and (=> (= tmp%26@ (Mul (Mul (Mul a20~162@ a20~162@) (Mul c20~166@ b20~164@)) d20~168@)) (=> (= tmp%27@ (Mul (Mul a20~162@ d20~168@) (Mul a20~162@ a20~162@))) (=> (= tmp%28@ (Mul (Add c20~166@ b20~164@) d20~168@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%26@ tmp%27@ tmp%28@) (=> %%location_label%%20 (= temp_20_0~3705@ temp_20_1~3774@)))))) (=> (= temp_20_0~3705@ temp_20_1~3774@) (=> (= temp_21_0~3893@ (Mul (Mul (Mul (Add a21~170@ d21~176@) (Mul d21~176@ a21~170@)) (Mul (Mul d21~176@ d21~176@) (Mul a21~170@ d21~176@))) (Sub a21~170@ (Mul (Mul c21~174@ b21~172@) (Mul b21~172@ a21~170@))))) (=> (= temp_21_1~3946@ (Mul (Mul (Add a21~170@ d21~176@) (Mul (Mul d21~176@ a21~170@) (Mul (Mul d21~176@ d21~176@) (Mul a21~170@ d21~176@)))) (Sub a21~170@ (Mul (Mul c21~174@ b21~172@) (Mul b21~172@ a21~170@))))) (=> (= tmp%29@ (Add a21~170@ d21~176@)) (=> (= tmp%30@ (Mul d21~176@ a21~170@)) (=> (= tmp%31@ (Mul (Mul d21~176@ d21~176@) (Mul a21~170@ d21~176@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ tmp%30@ tmp%31@) (=> %%location_label%%21 (= temp_21_0~3893@ temp_21_1~3946@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
