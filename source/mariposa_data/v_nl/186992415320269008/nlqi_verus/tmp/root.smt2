...
(push)
 ...
 (declare-const temp_5_0~1007@ Int)
 (declare-const temp_5_1~1060@ Int)
 ...
 (declare-const temp_9_1~1592@ Int)
 (declare-const temp_10_0~1677@ Int)
 (declare-const temp_10_1~1754@ Int)
 (declare-const temp_11_0~1851@ Int)
 ...
 (declare-const temp_14_0~2281@ Int)
 (declare-const temp_14_1~2318@ Int)
 (declare-const temp_15_0~2419@ Int)
 (declare-const temp_15_1~2496@ Int)
 (declare-const temp_16_0~2585@ Int)
 (declare-const temp_16_1~2650@ Int)
 (declare-const temp_17_0~2739@ Int)
 (declare-const temp_17_1~2804@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~297@ temp_0_1~354@)
        (=>
         (= temp_1_0~439@ (Mul (Mul (Mul (Mul 51 d1~16@) (Add a1~10@ a1~10@)) (Mul a1~10@ (Mul
              b1~12@ b1~12@
            ))
           ) (Mul b1~12@ (Mul (Sub a1~10@ c1~14@) (Add d1~16@ d1~16@)))
         ))
         (=>
          (= temp_1_1~500@ (Mul (Mul (Mul 51 (Mul d1~16@ (Add a1~10@ a1~10@))) (Mul a1~10@ (Mul
               b1~12@ b1~12@
             ))
            ) (Mul b1~12@ (Mul (Sub a1~10@ c1~14@) (Add d1~16@ d1~16@)))
          ))
          (and
           (=>
            ...
            (=>
             %%location_label%%1
             (= temp_1_0~439@ temp_1_1~500@)
           ))
           (=>
            (= temp_1_0~439@ temp_1_1~500@)
            (=>
             (= temp_2_0~589@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Add c2~22@
                  b2~20@
                 ) (Mul d2~24@ a2~18@)
                )
             ...
             (=>
              (= temp_2_1~654@ (Mul (Mul (Mul (Mul (Mul d2~24@ d2~24@) b2~20@) d2~24@) (Mul (Add c2~22@
                   b2~20@
                  ) (Mul d2~24@ a2~18@)
                 )
                ) (Mul (Mul (Add c2~22@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@
              ...
              (and
               ...
               (=>
                (= temp_2_0~589@ temp_2_1~654@)
                (=>
                 (= temp_3_0~743@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ d3~32@)) (Sub (Mul b3~28@
                      c3~30@
                     ) (Mul d3~32@ b3~28@)
                    )
                 ...
                 (=>
                  (= temp_3_1~808@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@
                       c3~30@
                      ) (Mul b3~28@ b3~28@)
                     )
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~743@ temp_3_1~808@)
                    (=>
                     (= temp_4_0~881@ (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Add d4~40@ c4~38@)) b4~36@) (Sub
                        (Mul b4~36@ (Mul d4~40@ a4~34@)) (Add (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@))
                     )))
                     (=>
                      (= temp_4_1~930@ (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Add d4~40@ c4~38@)) b4~36@) (Sub
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~881@ temp_4_1~930@)
                        (=>
                         (= temp_5_0~1007@ (Mul (Mul (Sub (Mul b5~44@ d5~48@) (Sub c5~46@ a5~42@)) (Mul (Mul d5~48@
                              d5~48@
                             ) (Mul c5~46@ c5~46@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1060@ (Mul (Mul (Sub (Mul b5~44@ d5~48@) (Sub c5~46@ a5~42@)) (Mul (Mul c5~46@
                               c5~46@
                              ) (Mul d5~48@ d5~48@)
                             )
                            ) (Mul (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ a5~42@)) a5~42@)
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1007@ temp_5_1~1060@)
                           ))
                           (=>
                            (= temp_5_0~1007@ temp_5_1~1060@)
                            (=>
                             (= temp_6_0~1141@ (Sub (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ d6~56@)) (Mul c6~54@
                                 c6~54@
                                )
                             ...
                             (=>
                              (= temp_6_1~1198@ (Sub (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ d6~56@)) (Mul c6~54@
                                  c6~54@
                                 )
                                ) (Mul (Sub (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@
                                   c6~54@
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1141@ temp_6_1~1198@)
                               ))
                               (=>
                                (= temp_6_0~1141@ temp_6_1~1198@)
                                (=>
                                 (= temp_7_0~1279@ (Mul (Mul (Mul a7~58@ (Mul b7~60@ d7~64@)) (Mul (Mul c7~62@ d7~64@)
                                     (Add c7~62@ b7~60@)
                                    )
                                   ) (Mul (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul b7~60@ (Mul d7~64@ b7~60@)))
                                 ))
                                 (=>
                                  (= temp_7_1~1336@ (Mul (Mul (Mul a7~58@ (Mul b7~60@ d7~64@)) (Mul (Mul c7~62@ d7~64@)
                                      (Add c7~62@ b7~60@)
                                     )
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1279@ temp_7_1~1336@)
                                   ))
                                   (=>
                                    (= temp_7_0~1279@ temp_7_1~1336@)
                                    (=>
                                     (= temp_8_0~1397@ (Sub (Mul (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@
                                          c8~70@
                                         ) (Mul c8~70@ c8~70@)
                                        )
                                       ) a8~66@
                                     ...
                                     (=>
                                      (= temp_8_1~1434@ (Sub (Mul (Mul (Mul (Mul b8~68@ c8~70@) d8~72@) b8~68@) (Mul (Mul c8~70@
                                           c8~70@
                                          ) (Mul c8~70@ c8~70@)
                                         )
                                        ) a8~66@
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1397@ temp_8_1~1434@)
                                       ))
                                       (=>
                                        (= temp_8_0~1397@ temp_8_1~1434@)
                                        (=>
                                         (= temp_9_0~1511@ (Mul (Add (Mul (Sub c9~78@ c9~78@) c9~78@) (Mul d9~80@ (Mul a9~74@ d9~80@)))
                                           (Add (Mul (Mul a9~74@ a9~74@) c9~78@) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ c9~78@)))
                                         ))
                                         (=>
                                          (= temp_9_1~1592@ (Add (Mul (Mul (Sub c9~78@ c9~78@) c9~78@) (Add (Mul (Mul a9~74@ a9~74@)
                                               c9~78@
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1511@ temp_9_1~1592@)
                                           ))
                                           (=>
                                            (= temp_9_0~1511@ temp_9_1~1592@)
                                            (=>
                                             (= temp_10_0~1677@ (Mul (Mul (Sub (Mul c10~86@ d10~88@) (Mul b10~84@ b10~84@)) (Mul (
                                                  Sub b10~84@ c10~86@
                                                 ) (Sub b10~84@ b10~84@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1754@ (Mul (Sub (Mul (Mul c10~86@ d10~88@) (Mul (Sub b10~84@ c10~86@) (Sub
                                                    b10~84@ b10~84@
                                                  ))
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1677@ temp_10_1~1754@)
                                               ))
                                               (=>
                                                (= temp_10_0~1677@ temp_10_1~1754@)
                                                (=>
                                                 (= temp_11_0~1851@ (Mul (Sub (Mul (Mul a11~90@ c11~94@) (Mul b11~92@ d11~96@)) (Add (
                                                      Mul a11~90@ b11~92@
                                                     ) (Mul a11~90@ d11~96@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~1920@ (Mul (Sub (Mul (Mul a11~90@ c11~94@) (Mul b11~92@ d11~96@)) (Mul a11~90@
                                                      (Add b11~92@ d11~96@)
                                                     )
                                                    ) (Mul (Mul (Mul d11~96@ d11~96@) (Mul a11~90@ c11~94@)) (Mul (Mul b11~92@ b11~92@)
                                                      94
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~1851@ temp_11_1~1920@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~1851@ temp_11_1~1920@)
                                                    (=>
                                                     (= temp_12_0~2005@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2066@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul
                                                          b12~100@ (Sub b12~100@ c12~102@)
                                                         )
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2005@ temp_12_1~2066@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2005@ temp_12_1~2066@)
                                                        (=>
                                                         (= temp_13_0~2155@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ a13~106@)) (
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2220@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ a13~106@)) (
                                                              Add (Add c13~110@ a13~106@) (Mul b13~108@ d13~112@)
                                                             )
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2155@ temp_13_1~2220@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2155@ temp_13_1~2220@)
                                                            (=>
                                                             (= temp_14_0~2281@ (Mul c14~118@ (Add (Mul (Mul c14~118@ c14~118@) (Mul d14~120@ b14~116@))
                                                                (Sub (Mul b14~116@ d14~120@) (Mul b14~116@ d14~120@))
                                                             )))
                                                             (=>
                                                              (= temp_14_1~2318@ (Mul c14~118@ (Add (Mul (Mul c14~118@ c14~118@) (Mul d14~120@ b14~116@))
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2281@ temp_14_1~2318@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2281@ temp_14_1~2318@)
                                                                (=>
                                                                 (= temp_15_0~2419@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Sub d15~128@ a15~122@)) (
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2496@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Sub d15~128@ a15~122@)) (
                                                                      Add (Sub d15~128@ 58) (Mul d15~128@ a15~122@)
                                                                     )
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2419@ temp_15_1~2496@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2419@ temp_15_1~2496@)
                                                                    (=>
                                                                     (= temp_16_0~2585@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Add d16~136@ d16~136@)) (
                                                                     ...
                                                                     (=>
                                                                      (= temp_16_1~2650@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Add d16~136@ d16~136@)) (
                                                                      ...
                                                                      (and
                                                                       ...
                                                                       (=>
                                                                        (= temp_16_0~2585@ temp_16_1~2650@)
                                                                        (=>
                                                                         (= temp_17_0~2739@ (Add (Sub (Mul (Mul d17~144@ b17~140@) (Mul b17~140@ c17~142@)) (
                                                                         ...
                                                                         (=>
                                                                          (= temp_17_1~2804@ (Add (Sub (Mul (Mul b17~140@ c17~142@) (Mul d17~144@ b17~140@)) (
                                                                              Mul (Mul b17~140@ a17~138@) (Mul d17~144@ c17~142@)
                                                                             )
                                                                            ) (Mul (Add (Mul b17~140@ b17~140@) (Mul d17~144@ a17~138@)) (Mul (Mul a17~138@ b17~140@)
                                                                              (Mul c17~142@ d17~144@)
