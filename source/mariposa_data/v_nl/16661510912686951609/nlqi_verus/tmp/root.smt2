...
(push)
 ...
 (declare-const temp_10_0~1805@ Int)
 ...
 (declare-const temp_13_0~2295@ Int)
 ...
 (declare-const temp_15_1~2684@ Int)
 (declare-const temp_16_0~2781@ Int)
 (declare-const temp_16_1~2854@ Int)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~447@ (Mul (Mul (Mul (Add d1~16@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@
              b1~12@
             ) (Mul a1~10@ b1~12@)
            )
         ...
         (=>
          (= temp_1_1~500@ (Mul (Mul (Mul (Mul (Add d1~16@ b1~12@) (Mul d1~16@ b1~12@)) (Mul b1~12@
               b1~12@
              )
             ) (Mul a1~10@ b1~12@)
            ) (Sub (Add (Mul d1~16@ b1~12@) (Sub d1~16@ c1~14@)) b1~12@)
          ...
          (and
           ...
           (=>
            (= temp_1_0~447@ temp_1_1~500@)
            (=>
             (= temp_2_0~585@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@
                  a2~18@
                 ) (Sub a2~18@ d2~24@)
                )
             ...
             (=>
              (= temp_2_1~646@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@
                   a2~18@
                  ) (Sub a2~18@ d2~24@)
                 )
              ...
              (and
               ...
               (=>
                (= temp_2_0~585@ temp_2_1~646@)
                (=>
                 (= temp_3_0~735@ (Mul (Sub (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ a3~26@)) (Add (Mul d3~32@
                      a3~26@
                     ) (Mul a3~26@ b3~28@)
                    )
                 ...
                 (=>
                  (= temp_3_1~800@ (Mul (Sub (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ d3~32@)) (Add (Mul d3~32@
                       a3~26@
                      ) (Mul a3~26@ b3~28@)
                     )
                    ) (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~735@ temp_3_1~800@)
                    (=>
                     (= temp_4_0~885@ (Sub (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@)) (Add d4~40@
                         (Add d4~40@ a4~34@)
                        )
                     ...
                     (=>
                      (= temp_4_1~946@ (Sub (Mul (Mul d4~40@ c4~38@) (Mul (Mul d4~40@ a4~34@) (Add d4~40@ (Add
                            d4~40@ a4~34@
                         )))
                        ) (Sub (Sub (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Mul a4~34@ d4~40@) (Mul a4~34@
                           b4~36@
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~885@ temp_4_1~946@)
                       ))
                       (=>
                        (= temp_4_0~885@ temp_4_1~946@)
                        (=>
                         (= temp_5_0~1047@ (Sub (Mul (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@
                              c5~46@
                             ) (Mul 58 b5~44@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1124@ (Sub (Mul (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@
                               c5~46@
                              ) (Mul b5~44@ 58)
                             )
                            ) (Mul (Add (Mul b5~44@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Sub c5~46@ b5~44@) (Mul c5~46@
                          ...
                          (and
                           ...
                           (=>
                            (= temp_5_0~1047@ temp_5_1~1124@)
                            (=>
                             (= temp_6_0~1209@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@)) (Mul c6~54@
                                 (Mul b6~52@ a6~50@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1270@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@)) (Mul c6~54@
                                  (Mul b6~52@ a6~50@)
                                 )
                              ...
                              (and
                               ...
                               (=>
                                (= temp_6_0~1209@ temp_6_1~1270@)
                                (=>
                                 (= temp_7_0~1359@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@)) b7~60@) (
                                    Mul (Sub (Mul d7~64@ d7~64@) (Mul c7~62@ 67)) (Add (Add d7~64@ c7~62@) (Mul a7~58@
                                      c7~62@
                                 )))))
                                 (=>
                                  (= temp_7_1~1424@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@)) b7~60@) (
                                  ...
                                  (and
                                   ...
                                   (=>
                                    (= temp_7_0~1359@ temp_7_1~1424@)
                                    (=>
                                     (= temp_8_0~1509@ (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@
                                          d8~72@
                                         ) (Mul c8~70@ a8~66@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1570@ (Mul (Mul (Mul d8~72@ (Mul b8~68@ (Mul d8~72@ d8~72@))) (Mul (Mul d8~72@
                                           d8~72@
                                          ) (Mul c8~70@ a8~66@)
                                         )
                                        ) (Mul (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ a8~66@)))
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1509@ temp_8_1~1570@)
                                       ))
                                       (=>
                                        (= temp_8_0~1509@ temp_8_1~1570@)
                                        (=>
                                         (= temp_9_0~1655@ (Mul (Mul (Mul d9~80@ (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ b9~76@)
                                             (Mul d9~80@ b9~76@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1716@ (Mul (Mul (Mul d9~80@ (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ b9~76@)
                                              (Mul d9~80@ b9~76@)
                                             )
                                          ...
                                          (and
                                           ...
                                           (=>
                                            (= temp_9_0~1655@ temp_9_1~1716@)
                                            (=>
                                             (= temp_10_0~1805@ (Add (Mul (Mul (Sub b10~84@ a10~82@) (Mul a10~82@ a10~82@)) (Sub (
                                                  Mul d10~88@ b10~84@
                                                 ) (Mul d10~88@ c10~86@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1870@ (Add (Mul (Mul (Mul (Sub b10~84@ a10~82@) a10~82@) a10~82@) (Sub (
                                                   Mul d10~88@ b10~84@
                                                  ) (Mul d10~88@ c10~86@)
                                                 )
                                                ) (Sub (Mul (Mul d10~88@ b10~84@) (Sub c10~86@ b10~84@)) (Mul (Mul a10~82@ c10~86@)
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1805@ temp_10_1~1870@)
                                               ))
                                               (=>
                                                (= temp_10_0~1805@ temp_10_1~1870@)
                                                (=>
                                                 (= temp_11_0~1983@ (Mul (Mul (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (
                                                      Mul a11~90@ d11~96@
                                                     ) (Mul c11~94@ c11~94@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2068@ (Mul (Mul (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (
                                                       Mul a11~90@ d11~96@
                                                      ) (Mul c11~94@ c11~94@)
                                                     )
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~1983@ temp_11_1~2068@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~1983@ temp_11_1~2068@)
                                                    (=>
                                                     (= temp_12_0~2153@ (Mul (Mul d12~104@ (Add (Mul c12~102@ 48) (Mul d12~104@ c12~102@)))
                                                       (Mul (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ c12~102@)) (Mul d12~104@ (Mul a12~98@
                                                          d12~104@
                                                     )))))
                                                     (=>
                                                      (= temp_12_1~2214@ (Mul (Mul d12~104@ (Add (Mul c12~102@ 48) (Mul d12~104@ c12~102@)))
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2153@ temp_12_1~2214@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2153@ temp_12_1~2214@)
                                                        (=>
                                                         (= temp_13_0~2295@ (Mul (Mul (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ a13~106@)) (
                                                             Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@)
                                                            )
                                                           ) (Add (Mul (Mul c13~110@ d13~112@) c13~110@) (Mul (Mul b13~108@ b13~108@) c13~110@))
                                                         ))
                                                         (=>
                                                          (= temp_13_1~2352@ (Mul (Mul (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ a13~106@)) (
                                                              Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@)
                                                             )
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2295@ temp_13_1~2352@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2295@ temp_13_1~2352@)
                                                            (=>
                                                             (= temp_14_0~2441@ (Mul (Mul (Mul (Add a14~114@ b14~116@) (Mul c14~118@ c14~118@)) (
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2506@ (Mul (Mul (Mul (Add a14~114@ b14~116@) (Mul c14~118@ c14~118@)) (
                                                                  Mul (Mul c14~118@ b14~116@) (Mul d14~120@ d14~120@)
                                                                 )
                                                              ...
                                                              (and
                                                               ...
                                                               (=>
                                                                (= temp_14_0~2441@ temp_14_1~2506@)
                                                                (=>
                                                                 (= temp_15_0~2607@ (Sub (Mul (Add (Add a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2684@ (Sub (Mul (Add (Add a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (
                                                                      Mul (Sub a15~122@ b15~124@) (Mul b15~124@ a15~122@)
                                                                     )
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2607@ temp_15_1~2684@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2607@ temp_15_1~2684@)
                                                                    (=>
                                                                     (= temp_16_0~2781@ (Mul (Mul (Sub (Mul d16~136@ b16~132@) (Mul a16~130@ d16~136@)) (
                                                                     ...
                                                                     (=>
                                                                      (= temp_16_1~2854@ (Mul (Mul (Sub (Mul d16~136@ b16~132@) (Mul a16~130@ d16~136@)) (
                                                                      ...
                                                                      (and
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         %%location_label%%16
                                                                         (= temp_16_0~2781@ temp_16_1~2854@)
                                                                       ))
                                                                       (=>
                                                                        (= temp_16_0~2781@ temp_16_1~2854@)
                                                                        (=>
                                                                         (= temp_17_0~2967@ (Mul (Mul (Mul (Mul b17~140@ d17~144@) (Mul c17~142@ a17~138@)) (
                                                                         ...
                                                                         (=>
                                                                          (= temp_17_1~3056@ (Mul (Mul (Mul (Mul b17~140@ d17~144@) (Mul c17~142@ a17~138@)) (
                                                                              Mul (Mul b17~140@ d17~144@) (Mul 93 d17~144@)
                                                                             )
