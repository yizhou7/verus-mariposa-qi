...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Sub (Mul c0~6@ b0~4@) (Mul a0~2@ a0~2@))) (Mul (Mul (Mul d0~8@ c0~6@) (Add b0~4@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Sub (Mul c0~6@ b0~4@) (Mul a0~2@ a0~2@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Add b0~4@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~438@ (Mul (Mul (Mul (Add d1~16@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ b1~12@))) (Sub (Add (Mul d1~16@ b1~12@) (Sub d1~16@ c1~14@)) b1~12@))) (=> (= temp_1_1~491@ (Mul (Mul (Mul (Mul (Add d1~16@ b1~12@) (Mul d1~16@ b1~12@)) (Mul b1~12@ b1~12@)) (Mul a1~10@ b1~12@)) (Sub (Add (Mul d1~16@ b1~12@) (Sub d1~16@ c1~14@)) b1~12@))) (=> (= tmp%2@ (= temp_1_0~438@ temp_1_1~491@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~567@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Sub a2~18@ d2~24@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@)) (Sub (Mul c2~22@ d2~24@) d2~24@)))) (=> (= temp_2_1~628@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Sub a2~18@ d2~24@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@)) (Sub (Mul d2~24@ c2~22@) d2~24@)))) (=> (= tmp%3@ (= temp_2_0~567@ temp_2_1~628@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~708@ (Mul (Sub (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~773@ (Mul (Sub (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ d3~32@)) (Add (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~708@ temp_3_1~773@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~849@ (Sub (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@)) (Add d4~40@ (Add d4~40@ a4~34@))) (Sub (Sub (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~910@ (Sub (Mul (Mul d4~40@ c4~38@) (Mul (Mul d4~40@ a4~34@) (Add d4~40@ (Add d4~40@ a4~34@)))) (Sub (Sub (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~849@ temp_4_1~910@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1002@ (Sub (Mul (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul 58 b5~44@))) (Mul (Add (Mul b5~44@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Sub c5~46@ b5~44@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1079@ (Sub (Mul (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ 58))) (Mul (Add (Mul b5~44@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Sub c5~46@ b5~44@) (Mul c5~46@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1002@ temp_5_1~1079@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1155@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@)) (Mul c6~54@ (Mul b6~52@ a6~50@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ b6~52@)) (Add (Mul c6~54@ d6~56@) (Sub b6~52@ a6~50@))))) (=> (= temp_6_1~1216@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@)) (Mul c6~54@ (Mul b6~52@ a6~50@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ d6~56@)) (Add (Mul c6~54@ d6~56@) (Sub b6~52@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~1155@ temp_6_1~1216@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1296@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@)) b7~60@) (Mul (Sub (Mul d7~64@ d7~64@) (Mul c7~62@ 67)) (Add (Add d7~64@ c7~62@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1361@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@)) b7~60@) (Mul (Add (Add d7~64@ c7~62@) (Mul a7~58@ c7~62@)) (Sub (Mul d7~64@ d7~64@) (Mul c7~62@ 67))))) (=> (= tmp%8@ (= temp_7_0~1296@ temp_7_1~1361@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1437@ (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1498@ (Mul (Mul (Mul d8~72@ (Mul b8~68@ (Mul d8~72@ d8~72@))) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1437@ temp_8_1~1498@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1574@ (Mul (Mul (Mul d9~80@ (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ b9~76@) (Mul d9~80@ b9~76@))) (Mul (Mul (Add d9~80@ b9~76@) (Mul d9~80@ c9~78@)) (Mul (Add a9~74@ b9~76@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1635@ (Mul (Mul (Mul d9~80@ (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ b9~76@) (Mul d9~80@ b9~76@))) (Mul (Mul (Add a9~74@ b9~76@) (Mul a9~74@ c9~78@)) (Mul (Add d9~80@ b9~76@) (Mul d9~80@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1574@ temp_9_1~1635@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1715@ (Add (Mul (Mul (Sub b10~84@ a10~82@) (Mul a10~82@ a10~82@)) (Sub (Mul d10~88@ b10~84@) (Mul d10~88@ c10~86@))) (Sub (Mul (Mul d10~88@ b10~84@) (Sub c10~86@ b10~84@)) (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ a10~82@))))) (=> (= temp_10_1~1780@ (Add (Mul (Mul (Mul (Sub b10~84@ a10~82@) a10~82@) a10~82@) (Sub (Mul d10~88@ b10~84@) (Mul d10~88@ c10~86@))) (Sub (Mul (Mul d10~88@ b10~84@) (Sub c10~86@ b10~84@)) (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1715@ temp_10_1~1780@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1884@ (Mul (Mul (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))) (Mul (Sub (Mul 31 d11~96@) (Mul d11~96@ d11~96@)) (Mul (Mul c11~94@ 99) (Mul a11~90@ a11~90@))))) (=> (= temp_11_1~1969@ (Mul (Mul (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))) (Mul (Mul (Sub 31 d11~96@) d11~96@) (Mul (Mul c11~94@ 99) (Mul a11~90@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1884@ temp_11_1~1969@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2045@ (Mul (Mul d12~104@ (Add (Mul c12~102@ 48) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ c12~102@)) (Mul d12~104@ (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2106@ (Mul (Mul d12~104@ (Add (Mul c12~102@ 48) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ a12~98@)) (Mul d12~104@ (Mul a12~98@ d12~104@))))) (=> (= tmp%13@ (= temp_12_0~2045@ temp_12_1~2106@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2178@ (Mul (Mul (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@))) (Add (Mul (Mul c13~110@ d13~112@) c13~110@) (Mul (Mul b13~108@ b13~108@) c13~110@)))) (=> (= temp_13_1~2235@ (Mul (Mul (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@))) (Add (Mul (Mul c13~110@ d13~112@) c13~110@) (Mul b13~108@ (Mul b13~108@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2178@ temp_13_1~2235@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2315@ (Mul (Mul (Mul (Add a14~114@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul c14~118@ b14~116@) (Mul d14~120@ d14~120@))) (Mul (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ c14~118@)) (Mul (Mul b14~116@ a14~114@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2380@ (Mul (Mul (Mul (Add a14~114@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul c14~118@ b14~116@) (Mul d14~120@ d14~120@))) (Mul (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ c14~118@)) (Mul (Mul (Mul b14~116@ a14~114@) c14~118@) d14~120@)))) (=> (= tmp%15@ (= temp_14_0~2315@ temp_14_1~2380@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2472@ (Sub (Mul (Add (Add a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Sub a15~122@ b15~124@) (Mul b15~124@ a15~122@))) (Mul (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ c15~126@)) (Mul (Mul b15~124@ 35) (Mul b15~124@ a15~122@))))) (=> (= temp_15_1~2549@ (Sub (Mul (Add (Add a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Sub a15~122@ b15~124@) (Mul b15~124@ a15~122@))) (Mul (Mul (Mul b15~124@ 35) (Mul b15~124@ a15~122@)) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ c15~126@))))) (=> (= tmp%16@ (= temp_15_0~2472@ temp_15_1~2549@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2637@ (Mul (Mul (Sub (Mul d16~136@ b16~132@) (Mul a16~130@ d16~136@)) (Mul (Mul a16~130@ b16~132@) d16~136@)) (Mul (Mul (Mul d16~136@ 51) (Mul b16~132@ b16~132@)) (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ c16~134@))))) (=> (= temp_16_1~2710@ (Mul (Mul (Sub (Mul d16~136@ b16~132@) (Mul a16~130@ d16~136@)) (Mul (Mul b16~132@ a16~130@) d16~136@)) (Mul (Mul (Mul d16~136@ 51) (Mul b16~132@ b16~132@)) (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ c16~134@))))) (=> (= tmp%17@ (= temp_16_0~2637@ temp_16_1~2710@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2814@ (Mul (Mul (Mul (Mul b17~140@ d17~144@) (Mul c17~142@ a17~138@)) (Mul (Mul b17~140@ d17~144@) (Mul 93 d17~144@))) (Mul (Sub (Sub c17~142@ 85) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ d17~144@) (Mul c17~142@ d17~144@))))) (=> (= temp_17_1~2903@ (Mul (Mul (Mul (Mul b17~140@ d17~144@) (Mul c17~142@ a17~138@)) (Mul (Mul b17~140@ d17~144@) (Mul 93 d17~144@))) (Mul (Sub (Sub c17~142@ 85) (Mul d17~144@ d17~144@)) (Mul b17~140@ (Mul d17~144@ (Mul c17~142@ d17~144@)))))) (=> (= tmp%18@ (= temp_17_0~2814@ temp_17_1~2903@)) (=> %%location_label%%17 tmp%18@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
