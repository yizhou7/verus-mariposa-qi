...
(set-info :comment ";; mariposa_data/v_nl//1667337654596510450/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_12_1~2342@ Int)
(declare-const temp_13_0~2421@ Int)
(declare-const temp_13_1~2466@ Int)
(declare-const temp_14_0~2571@ Int)
(declare-const temp_14_1~2648@ Int)
(declare-const temp_15_0~2725@ Int)
(declare-const temp_15_1~2774@ Int)
(declare-const temp_16_0~2883@ Int)
(declare-const temp_16_1~2956@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~309@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@)) (Mul (Mul d0~8@ d0~8@) b0~4@)) (Mul (Sub (Mul c0~6@ b0~4@) 66) (Sub (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~378@ (Mul (Mul (Mul b0~4@ (Mul a0~2@ (Add c0~6@ c0~6@))) (Mul (Mul d0~8@ d0~8@) b0~4@)) (Mul (Sub (Mul c0~6@ b0~4@) 66) (Sub (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))))) (and (=> (= tmp%1@ (Add c0~6@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ a0~2@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~309@ temp_0_1~378@)))) (=> (= temp_0_0~309@ temp_0_1~378@) (=> (= temp_1_0~473@ (Mul (Mul (Mul (Sub b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Add a1~10@ b1~12@))) (Mul (Mul (Mul b1~12@ a1~10@) (Add a1~10@ d1~16@)) (Mul b1~12@ (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~534@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Sub b1~12@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Add a1~10@ b1~12@))) (Mul (Mul (Mul b1~12@ a1~10@) (Add a1~10@ d1~16@)) (Mul b1~12@ (Mul a1~10@ a1~10@))))) (and (=> (= tmp%2@ (Sub b1~12@ c1~14@)) (=> (= tmp%3@ (Mul b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~473@ temp_1_1~534@))))) (=> (= temp_1_0~473@ temp_1_1~534@) (=> (= temp_2_0~631@ (Add (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul a2~18@ c2~22@) d2~24@) (Sub (Sub b2~20@ d2~24@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~692@ (Add (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul a2~18@ c2~22@) d2~24@) (Sub (Sub b2~20@ d2~24@) (Mul b2~20@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ b2~20@) (=> %%location_label%%2 (= temp_2_0~631@ temp_2_1~692@))) (=> (= temp_2_0~631@ temp_2_1~692@) (=> (= temp_3_0~785@ (Mul (Mul (Sub (Mul a3~26@ d3~32@) (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~850@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@)) (Sub (Mul a3~26@ d3~32@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@))))) (and (=> (= tmp%4@ (Sub (Mul a3~26@ d3~32@) (Mul d3~32@ d3~32@))) (=> (= tmp%5@ (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~785@ temp_3_1~850@))))) (=> (= temp_3_0~785@ temp_3_1~850@) (=> (= temp_4_0~967@ (Mul (Mul (Add (Mul c4~38@ a4~34@) (Add b4~36@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))) (Add (Sub (Mul d4~40@ d4~40@) (Mul d4~40@ a4~34@)) (Sub (Add a4~34@ c4~38@) (Add c4~38@ b4~36@))))) (=> (= temp_4_1~1032@ (Mul (Mul (Add (Mul c4~38@ a4~34@) (Add b4~36@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))) (Add (Sub (Mul d4~40@ d4~40@) (Mul d4~40@ a4~34@)) (Sub (Add a4~34@ c4~38@) (Add c4~38@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ d4~40@) (=> %%location_label%%4 (= temp_4_0~967@ temp_4_1~1032@))) (=> (= temp_4_0~967@ temp_4_1~1032@) (=> (= temp_5_0~1125@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Sub (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ b5~44@) (Sub b5~44@ b5~44@)) (Add (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1190@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Sub (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@))) (Mul (Mul (Sub b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Add (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@))))) (and (=> (= tmp%6@ (Mul c5~46@ b5~44@)) (=> (= tmp%7@ (Sub b5~44@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%5 (= temp_5_0~1125@ temp_5_1~1190@))))) (=> (= temp_5_0~1125@ temp_5_1~1190@) (=> (= temp_6_0~1263@ (Mul a6~50@ (Mul (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1300@ (Mul a6~50@ (Mul (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1263@ temp_6_1~1300@))) (=> (= temp_6_0~1263@ temp_6_1~1300@) (=> (= temp_7_0~1405@ (Mul (Mul (Mul (Mul 5 b7~60@) (Sub a7~58@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))) (Add (Mul (Sub a7~58@ a7~58@) (Add d7~64@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1482@ (Mul (Mul (Mul (Sub a7~58@ a7~58@) (Mul 5 b7~60@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))) (Add (Mul (Sub a7~58@ a7~58@) (Add d7~64@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ d7~64@))))) (and (=> (= tmp%8@ (Mul 5 b7~60@)) (=> (= tmp%9@ (Sub a7~58@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%7 (= temp_7_0~1405@ temp_7_1~1482@))))) (=> (= temp_7_0~1405@ temp_7_1~1482@) (=> (= temp_8_0~1555@ (Add (Mul a8~66@ (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ d8~72@))) c8~70@)) (=> (= temp_8_1~1580@ (Add (Mul a8~66@ (Mul (Mul (Mul c8~70@ c8~70@) d8~72@) d8~72@)) c8~70@)) (and (=> (= tmp%10@ (Mul c8~70@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ d8~72@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1555@ temp_8_1~1580@)))) (=> (= temp_8_0~1555@ temp_8_1~1580@) (=> (= temp_9_0~1687@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Mul d9~80@ (Sub c9~78@ a9~74@))) (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul 69 c9~78@) (Mul d9~80@ b9~76@))))) (=> (= temp_9_1~1760@ (Mul (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) d9~80@) (Sub c9~78@ a9~74@)) (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul 69 c9~78@) (Mul d9~80@ b9~76@))))) (and (=> (= tmp%11@ (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@))) (=> (= tmp%12@ (Sub c9~78@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ d9~80@ tmp%12@) (=> %%location_label%%9 (= temp_9_0~1687@ temp_9_1~1760@))))) (=> (= temp_9_0~1687@ temp_9_1~1760@) (=> (= temp_10_0~1895@ (Mul (Mul (Mul (Mul a10~82@ a10~82@) (Mul b10~84@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Mul 85 a10~82@))) (Add (Mul (Mul c10~86@ d10~88@) (Sub d10~88@ d10~88@)) (Mul (Mul b10~84@ 99) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~1984@ (Mul (Mul (Mul a10~82@ a10~82@) (Mul (Mul b10~84@ b10~84@) (Mul (Mul a10~82@ d10~88@) (Mul 85 a10~82@)))) (Add (Mul (Mul c10~86@ d10~88@) (Sub d10~88@ d10~88@)) (Mul (Mul b10~84@ 99) (Mul c10~86@ d10~88@))))) (and (=> (= tmp%13@ (Mul a10~82@ a10~82@)) (=> (= tmp%14@ (Mul b10~84@ b10~84@)) (=> (= tmp%15@ (Mul (Mul a10~82@ d10~88@) (Mul 85 a10~82@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%10 (= temp_10_0~1895@ temp_10_1~1984@)))))) (=> (= temp_10_0~1895@ temp_10_1~1984@) (=> (= temp_11_0~2111@ (Add (Mul (Mul (Add a11~90@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (Mul c11~94@ a11~90@) (Sub d11~96@ a11~90@))) (Mul (Mul (Mul c11~94@ d11~96@) (Sub a11~90@ a11~90@)) (Add (Mul a11~90@ c11~94@) (Mul c11~94@ d11~96@))))) (=> (= temp_11_1~2176@ (Add (Mul (Mul (Add a11~90@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (Mul c11~94@ a11~90@) (Sub d11~96@ a11~90@))) (Mul (Mul (Sub a11~90@ a11~90@) (Mul c11~94@ d11~96@)) (Add (Mul a11~90@ c11~94@) (Mul c11~94@ d11~96@))))) (and (=> (= tmp%16@ (Mul c11~94@ d11~96@)) (=> (= tmp%17@ (Sub a11~90@ a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%11 (= temp_11_0~2111@ temp_11_1~2176@))))) (=> (= temp_11_0~2111@ temp_11_1~2176@) (=> (= temp_12_0~2277@ (Mul (Mul (Mul (Sub a12~98@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Sub d12~104@ a12~98@) (Mul d12~104@ c12~102@))) (Sub (Add (Add b12~100@ a12~98@) (Mul c12~102@ a12~98@)) (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2342@ (Mul (Mul (Mul (Sub a12~98@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Sub d12~104@ a12~98@) (Mul d12~104@ c12~102@))) (Sub (Add (Add b12~100@ a12~98@) (Mul c12~102@ a12~98@)) (Mul b12~100@ (Mul d12~104@ (Mul c12~102@ d12~104@)))))) (and (=> (= tmp%18@ (Mul c12~102@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b12~100@ d12~104@ tmp%18@) (=> %%location_label%%12 (= temp_12_0~2277@ temp_12_1~2342@)))) (=> (= temp_12_0~2277@ temp_12_1~2342@) (=> (= temp_13_0~2421@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) c13~110@) d13~112@) (Mul (Mul a13~106@ (Mul b13~108@ b13~108@)) (Sub (Mul d13~112@ a13~106@) (Mul a13~106@ b13~108@))))) (=> (= temp_13_1~2466@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) c13~110@) d13~112@) (Mul (Mul a13~106@ (Mul b13~108@ b13~108@)) (Sub (Mul d13~112@ a13~106@) (Mul b13~108@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a13~106@ b13~108@) (=> %%location_label%%13 (= temp_13_0~2421@ temp_13_1~2466@))) (=> (= temp_13_0~2421@ temp_13_1~2466@) (=> (= temp_14_0~2571@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ c14~118@)) (Sub (Mul b14~116@ b14~116@) (Mul b14~116@ c14~118@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ a14~114@)) (Mul (Add d14~120@ 14) (Mul d14~120@ b14~116@))))) (=> (= temp_14_1~2648@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ c14~118@)) (Sub (Mul b14~116@ b14~116@) (Mul b14~116@ c14~118@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul a14~114@ d14~120@)) (Mul (Add d14~120@ 14) (Mul d14~120@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ a14~114@) (=> %%location_label%%14 (= temp_14_0~2571@ temp_14_1~2648@))) (=> (= temp_14_0~2571@ temp_14_1~2648@) (=> (= temp_15_0~2725@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul c15~126@ 13)) (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ b15~124@))) c15~126@)) (=> (= temp_15_1~2774@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul c15~126@ 13)) (Mul (Mul d15~128@ b15~124@) (Mul a15~122@ c15~126@))) c15~126@)) (and (=> (= tmp%19@ (Mul a15~122@ c15~126@)) (=> (= tmp%20@ (Mul d15~128@ b15~124@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%15 (= temp_15_0~2725@ temp_15_1~2774@))))) (=> (= temp_15_0~2725@ temp_15_1~2774@) (=> (= temp_16_0~2883@ (Mul (Mul (Mul (Add d16~136@ d16~136@) (Mul b16~132@ c16~134@)) (Mul (Mul b16~132@ 54) (Mul b16~132@ c16~134@))) (Mul (Sub d16~136@ (Mul d16~136@ c16~134@)) (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ a16~130@))))) (=> (= temp_16_1~2956@ (Mul (Mul (Sub d16~136@ (Mul d16~136@ c16~134@)) (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ a16~130@))) (Mul (Mul (Add d16~136@ d16~136@) (Mul b16~132@ c16~134@)) (Mul (Mul b16~132@ 54) (Mul b16~132@ c16~134@))))) (and (=> (= tmp%21@ (Mul (Mul (Add d16~136@ d16~136@) (Mul b16~132@ c16~134@)) (Mul (Mul b16~132@ 54) (Mul b16~132@ c16~134@)))) (=> (= tmp%22@ (Mul (Sub d16~136@ (Mul d16~136@ c16~134@)) (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ a16~130@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%16 (= temp_16_0~2883@ temp_16_1~2956@))))) (=> (= temp_16_0~2883@ temp_16_1~2956@) (=> (= temp_17_0~3121@ (Mul (Mul (Mul (Mul a17~138@ 45) (Mul c17~142@ a17~138@)) (Sub (Mul b17~140@ a17~138@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul c17~142@ b17~140@) d17~144@)))) (=> (= temp_17_1~3194@ (Mul (Mul (Mul (Mul 45 a17~138@) (Mul c17~142@ a17~138@)) (Sub (Mul b17~140@ a17~138@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul c17~142@ b17~140@) d17~144@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a17~138@ 45) (=> %%location_label%%17 (= temp_17_0~3121@ temp_17_1~3194@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
