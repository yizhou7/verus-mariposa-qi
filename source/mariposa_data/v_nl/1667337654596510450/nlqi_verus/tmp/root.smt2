...
(push)
 ...
 (declare-const temp_9_0~1579@ Int)
 (declare-const temp_9_1~1652@ Int)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~309@ temp_0_1~378@)
        (=>
         (= temp_1_0~463@ (Mul (Mul (Mul (Sub b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@
              a1~10@
             ) (Add a1~10@ b1~12@)
            )
         ...
         (=>
          (= temp_1_1~524@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Sub b1~12@ c1~14@)) (Mul (Mul b1~12@
               a1~10@
              ) (Add a1~10@ b1~12@)
             )
            ) (Mul (Mul (Mul b1~12@ a1~10@) (Add a1~10@ d1~16@)) (Mul b1~12@ (Mul a1~10@ a1~10@)))
          ...
          (and
           ...
           (=>
            (= temp_1_0~463@ temp_1_1~524@)
            (=>
             (= temp_2_0~609@ (Add (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul b2~20@
                  a2~18@
                 ) (Mul c2~22@ a2~18@)
                )
             ...
             (=>
              (= temp_2_1~670@ (Add (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul b2~20@
                   a2~18@
                  ) (Mul c2~22@ a2~18@)
                 )
              ...
              (and
               ...
               (=>
                (= temp_2_0~609@ temp_2_1~670@)
                (=>
                 (= temp_3_0~759@ (Mul (Mul (Sub (Mul a3~26@ d3~32@) (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@
                      d3~32@
                     ) (Mul b3~28@ c3~30@)
                    )
                 ...
                 (=>
                  (= temp_3_1~824@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@)) (Sub (Mul a3~26@
                       d3~32@
                      ) (Mul d3~32@ d3~32@)
                     )
                    ) (Mul (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~759@ temp_3_1~824@)
                    (=>
                     (= temp_4_0~913@ (Mul (Mul (Add (Mul c4~38@ a4~34@) (Add b4~36@ a4~34@)) (Mul (Mul a4~34@
                          b4~36@
                         ) (Mul c4~38@ b4~36@)
                        )
                     ...
                     (=>
                      (= temp_4_1~978@ (Mul (Mul (Add (Mul c4~38@ a4~34@) (Add b4~36@ a4~34@)) (Mul (Mul a4~34@
                           b4~36@
                          ) (Mul c4~38@ b4~36@)
                         )
                        ) (Add (Sub (Mul d4~40@ d4~40@) (Mul d4~40@ a4~34@)) (Sub (Add a4~34@ c4~38@) (Add c4~38@
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~913@ temp_4_1~978@)
                        (=>
                         (= temp_5_0~1067@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Sub (Mul b5~44@
                              c5~46@
                             ) (Mul b5~44@ a5~42@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1132@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Sub (Mul b5~44@
                               c5~46@
                              ) (Mul b5~44@ a5~42@)
                             )
                          ...
                          (and
                           ...
                           (=>
                            (= temp_5_0~1067@ temp_5_1~1132@)
                            (=>
                             (= temp_6_0~1193@ (Mul a6~50@ (Mul (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ d6~56@)) (Mul
                                 (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@)
                             ))))
                             (=>
                              (= temp_6_1~1230@ (Mul a6~50@ (Mul (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ d6~56@)) (Mul
                                  (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@)
                              ))))
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1193@ temp_6_1~1230@)
                               ))
                               (=>
                                (= temp_6_0~1193@ temp_6_1~1230@)
                                (=>
                                 (= temp_7_0~1331@ (Mul (Mul (Mul (Mul 5 b7~60@) (Sub a7~58@ a7~58@)) (Mul (Mul a7~58@
                                      a7~58@
                                     ) (Mul d7~64@ b7~60@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1408@ (Mul (Mul (Mul (Sub a7~58@ a7~58@) (Mul 5 b7~60@)) (Mul (Mul a7~58@
                                       a7~58@
                                      ) (Mul d7~64@ b7~60@)
                                     )
                                    ) (Add (Mul (Sub a7~58@ a7~58@) (Add d7~64@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul c7~62@
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1331@ temp_7_1~1408@)
                                   ))
                                   (=>
                                    (= temp_7_0~1331@ temp_7_1~1408@)
                                    (=>
                                     (= temp_8_0~1457@ (Add (Mul a8~66@ (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ d8~72@))) c8~70@))
                                     (=>
                                      (= temp_8_1~1482@ (Add (Mul a8~66@ (Mul (Mul (Mul c8~70@ c8~70@) d8~72@) d8~72@)) c8~70@))
                                      (and
                                       (=>
                                        (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1457@ temp_8_1~1482@)
                                       ))
                                       (=>
                                        (= temp_8_0~1457@ temp_8_1~1482@)
                                        (=>
                                         (= temp_9_0~1579@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Mul d9~80@
                                             (Sub c9~78@ a9~74@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1652@ (Mul (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) d9~80@)
                                             (Sub c9~78@ a9~74@)
                                            ) (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul 69 c9~78@) (Mul d9~80@
                                               b9~76@
                                          )))))
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1579@ temp_9_1~1652@)
                                           ))
                                           (=>
                                            (= temp_9_0~1579@ temp_9_1~1652@)
                                            (=>
                                             (= temp_10_0~1765@ (Mul (Mul (Mul (Mul a10~82@ a10~82@) (Mul b10~84@ b10~84@)) (Mul (
                                                  Mul a10~82@ d10~88@
                                                 ) (Mul 85 a10~82@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1854@ (Mul (Mul (Mul a10~82@ a10~82@) (Mul (Mul b10~84@ b10~84@) (Mul (Mul
                                                    a10~82@ d10~88@
                                                   ) (Mul 85 a10~82@)
                                                 ))
                                                ) (Add (Mul (Mul c10~86@ d10~88@) (Sub d10~88@ d10~88@)) (Mul (Mul b10~84@ 99) (Mul
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1765@ temp_10_1~1854@)
                                               ))
                                               (=>
                                                (= temp_10_0~1765@ temp_10_1~1854@)
                                                (=>
                                                 (= temp_11_0~1943@ (Add (Mul (Mul (Add a11~90@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (
                                                      Mul c11~94@ a11~90@
                                                     ) (Sub d11~96@ a11~90@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2008@ (Add (Mul (Mul (Add a11~90@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (
                                                       Mul c11~94@ a11~90@
                                                      ) (Sub d11~96@ a11~90@)
                                                     )
                                                  ...
                                                  (and
                                                   ...
                                                   (=>
                                                    (= temp_11_0~1943@ temp_11_1~2008@)
                                                    (=>
                                                     (= temp_12_0~2097@ (Mul (Mul (Mul (Sub a12~98@ d12~104@) (Mul b12~100@ b12~100@)) (Mul
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2162@ (Mul (Mul (Mul (Sub a12~98@ d12~104@) (Mul b12~100@ b12~100@)) (Mul
                                                          (Sub d12~104@ a12~98@) (Mul d12~104@ c12~102@)
                                                         )
                                                      ...
                                                      (and
                                                       ...
                                                       (=>
                                                        (= temp_12_0~2097@ temp_12_1~2162@)
                                                        (=>
                                                         (= temp_13_0~2231@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) c13~110@) d13~112@) (Mul (
                                                             Mul a13~106@ (Mul b13~108@ b13~108@)
                                                            ) (Sub (Mul d13~112@ a13~106@) (Mul a13~106@ b13~108@))
                                                         )))
                                                         (=>
                                                          (= temp_13_1~2276@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) c13~110@) d13~112@) (Mul (
                                                              Mul a13~106@ (Mul b13~108@ b13~108@)
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2231@ temp_13_1~2276@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2231@ temp_13_1~2276@)
                                                            (=>
                                                             (= temp_14_0~2377@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ c14~118@)) (
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2454@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ c14~118@)) (
                                                                  Sub (Mul b14~116@ b14~116@) (Mul b14~116@ c14~118@)
                                                                 )
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2377@ temp_14_1~2454@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2377@ temp_14_1~2454@)
                                                                (=>
                                                                 (= temp_15_0~2527@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul c15~126@ 13)) (Mul (Mul
                                                                      a15~122@ c15~126@
                                                                     ) (Mul d15~128@ b15~124@)
                                                                    )
                                                                   ) c15~126@
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2576@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul c15~126@ 13)) (Mul (Mul
                                                                       d15~128@ b15~124@
                                                                      ) (Mul a15~122@ c15~126@)
                                                                     )
                                                                    ) c15~126@
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2527@ temp_15_1~2576@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2527@ temp_15_1~2576@)
                                                                    (=>
                                                                     (= temp_16_0~2673@ (Mul (Mul (Mul (Add d16~136@ d16~136@) (Mul b16~132@ c16~134@)) (
                                                                     ...
                                                                     (=>
                                                                      (= temp_16_1~2746@ (Mul (Mul (Sub d16~136@ (Mul d16~136@ c16~134@)) (Mul (Mul c16~134@
                                                                           a16~130@
                                                                          ) (Mul a16~130@ a16~130@)
                                                                         )
                                                                      ...
                                                                      (and
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         %%location_label%%16
                                                                         (= temp_16_0~2673@ temp_16_1~2746@)
                                                                       ))
                                                                       (=>
                                                                        (= temp_16_0~2673@ temp_16_1~2746@)
                                                                        (=>
                                                                         (= temp_17_0~2843@ (Mul (Mul (Mul (Mul a17~138@ 45) (Mul c17~142@ a17~138@)) (Sub (Mul
                                                                              b17~140@ a17~138@
                                                                             ) (Mul b17~140@ b17~140@)
                                                                            )
                                                                         ...
                                                                         (=>
                                                                          (= temp_17_1~2916@ (Mul (Mul (Mul (Mul 45 a17~138@) (Mul c17~142@ a17~138@)) (Sub (Mul
                                                                               b17~140@ a17~138@
                                                                              ) (Mul b17~140@ b17~140@)
                                                                             )
                                                                            ) (Mul (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul c17~142@ b17~140@)
