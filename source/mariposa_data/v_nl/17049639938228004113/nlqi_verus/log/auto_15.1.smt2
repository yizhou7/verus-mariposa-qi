...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Add c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Sub (Add a0~2@ b0~4@) (Add b0~4@ b0~4@)) b0~4@))) (=> (= temp_0_1~346@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Add c0~6@ b0~4@))) (Mul (Sub (Add a0~2@ b0~4@) (Add b0~4@ b0~4@)) b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~431@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@)) (Mul b1~12@ (Mul d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@)) (Mul (Sub b1~12@ c1~14@) (Mul a1~10@ b1~12@))))) (=> (= temp_1_1~492@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@)) (Mul b1~12@ (Mul d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Sub b1~12@ c1~14@) (Mul a1~10@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~431@ temp_1_1~492@))) (=> (= temp_1_0~431@ temp_1_1~492@) (=> (= temp_2_0~601@ (Mul (Sub (Mul (Mul 75 a2~18@) (Mul b2~20@ 49)) (Sub (Mul d2~24@ c2~22@) (Mul c2~22@ d2~24@))) (Sub (Mul (Mul d2~24@ a2~18@) b2~20@) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~686@ (Mul (Sub (Mul (Mul 75 a2~18@) (Mul b2~20@ 49)) (Sub (Mul d2~24@ c2~22@) (Mul c2~22@ d2~24@))) (Sub (Mul (Mul d2~24@ a2~18@) b2~20@) (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~601@ temp_2_1~686@))) (=> (= temp_2_0~601@ temp_2_1~686@) (=> (= temp_3_0~775@ (Add (Mul (Mul (Sub c3~30@ d3~32@) (Sub b3~28@ a3~26@)) (Add (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))) (Add (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~840@ (Add (Mul (Mul (Sub c3~30@ d3~32@) (Sub b3~28@ a3~26@)) (Add (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))) (Add (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~775@ temp_3_1~840@))) (=> (= temp_3_0~775@ temp_3_1~840@) (=> (= temp_4_0~941@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul 71 b4~36@)) (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Sub (Mul d4~40@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~1018@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul 71 b4~36@)) (Mul c4~38@ (Mul b4~36@ (Mul d4~40@ c4~38@)))) (Mul (Sub (Mul d4~40@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~941@ temp_4_1~1018@))) (=> (= temp_4_0~941@ temp_4_1~1018@) (=> (= temp_5_0~1095@ (Add (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) a5~42@) (Mul (Add (Mul a5~42@ b5~44@) (Add b5~44@ a5~42@)) (Mul (Mul a5~42@ a5~42@) (Add c5~46@ a5~42@))))) (=> (= temp_5_1~1148@ (Add (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) a5~42@) (Mul (Mul (Mul a5~42@ a5~42@) (Add c5~46@ a5~42@)) (Add (Mul a5~42@ b5~44@) (Add b5~44@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1095@ temp_5_1~1148@))) (=> (= temp_5_0~1095@ temp_5_1~1148@) (=> (= temp_6_0~1237@ (Mul (Mul (Mul (Sub d6~56@ b6~52@) (Mul c6~54@ c6~54@)) (Sub (Mul a6~50@ b6~52@) (Add c6~54@ a6~50@))) (Mul b6~52@ (Add (Mul d6~56@ 24) (Mul c6~54@ a6~50@))))) (=> (= temp_6_1~1302@ (Mul (Mul (Mul (Sub d6~56@ b6~52@) (Mul c6~54@ c6~54@)) (Sub (Mul a6~50@ b6~52@) (Add c6~54@ a6~50@))) (Mul b6~52@ (Add (Mul d6~56@ 24) (Mul c6~54@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1237@ temp_6_1~1302@))) (=> (= temp_6_0~1237@ temp_6_1~1302@) (=> (= temp_7_0~1391@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Add b7~60@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Sub d7~64@ a7~58@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1456@ (Mul (Mul (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul b7~60@ a7~58@) (Add b7~60@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Sub d7~64@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1391@ temp_7_1~1456@))) (=> (= temp_7_0~1391@ temp_7_1~1456@) (=> (= temp_8_0~1545@ (Sub (Mul (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@))) (Mul (Add (Mul c8~70@ d8~72@) (Mul d8~72@ c8~70@)) (Sub (Add d8~72@ a8~66@) (Mul d8~72@ d8~72@))))) (=> (= temp_8_1~1626@ (Sub (Mul (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@))) (Add (Mul (Mul c8~70@ d8~72@) (Sub (Add d8~72@ a8~66@) (Mul d8~72@ d8~72@))) (Mul (Mul d8~72@ c8~70@) (Sub (Add d8~72@ a8~66@) (Mul d8~72@ d8~72@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1545@ temp_8_1~1626@))) (=> (= temp_8_0~1545@ temp_8_1~1626@) (=> (= temp_9_0~1707@ (Add (Mul (Add b9~76@ (Mul b9~76@ b9~76@)) (Mul a9~74@ (Mul a9~74@ c9~78@))) (Mul (Add (Mul a9~74@ d9~80@) (Mul b9~76@ c9~78@)) (Sub (Mul a9~74@ c9~78@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~1760@ (Add (Mul (Add b9~76@ (Mul b9~76@ b9~76@)) (Mul a9~74@ (Mul a9~74@ c9~78@))) (Mul (Add (Mul a9~74@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Sub a9~74@ d9~80@) c9~78@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1707@ temp_9_1~1760@))) (=> (= temp_9_0~1707@ temp_9_1~1760@) (=> (= temp_10_0~1833@ (Mul (Mul (Mul (Sub c10~86@ c10~86@) (Mul b10~84@ b10~84@)) (Mul (Mul d10~88@ b10~84@) (Add c10~86@ b10~84@))) (Mul (Add d10~88@ (Mul c10~86@ b10~84@)) b10~84@))) (=> (= temp_10_1~1882@ (Mul (Mul (Mul (Mul d10~88@ b10~84@) (Add c10~86@ b10~84@)) (Mul (Sub c10~86@ c10~86@) (Mul b10~84@ b10~84@))) (Mul (Add d10~88@ (Mul c10~86@ b10~84@)) b10~84@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1833@ temp_10_1~1882@))) (=> (= temp_10_0~1833@ temp_10_1~1882@) (=> (= temp_11_0~1983@ (Mul (Mul (Mul (Mul b11~92@ a11~90@) (Mul b11~92@ d11~96@)) (Add (Add 77 c11~94@) (Mul c11~94@ a11~90@))) (Mul (Mul (Sub d11~96@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Sub d11~96@ a11~90@))))) (=> (= temp_11_1~2060@ (Mul (Mul (Mul b11~92@ a11~90@) (Mul (Mul b11~92@ d11~96@) (Add (Add 77 c11~94@) (Mul c11~94@ a11~90@)))) (Mul (Mul (Sub d11~96@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Sub d11~96@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1983@ temp_11_1~2060@))) (=> (= temp_11_0~1983@ temp_11_1~2060@) (=> (= temp_12_0~2121@ (Add c12~102@ (Mul (Mul (Add a12~98@ d12~104@) (Mul c12~102@ a12~98@)) (Mul (Sub c12~102@ d12~104@) (Sub d12~104@ c12~102@))))) (=> (= temp_12_1~2158@ (Add c12~102@ (Mul (Mul (Add a12~98@ d12~104@) (Mul c12~102@ a12~98@)) (Mul (Sub d12~104@ c12~102@) (Sub c12~102@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2121@ temp_12_1~2158@))) (=> (= temp_12_0~2121@ temp_12_1~2158@) (=> (= temp_13_0~2243@ (Mul (Mul (Add (Mul b13~108@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ c13~110@))) (Mul (Mul b13~108@ (Add a13~106@ c13~110@)) (Mul (Mul a13~106@ a13~106@) (Sub d13~112@ b13~108@))))) (=> (= temp_13_1~2304@ (Mul (Mul (Add (Mul b13~108@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ c13~110@))) (Mul (Mul b13~108@ (Add a13~106@ c13~110@)) (Mul (Mul a13~106@ a13~106@) (Sub d13~112@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2243@ temp_13_1~2304@))) (=> (= temp_13_0~2243@ temp_13_1~2304@) (=> (= temp_14_0~2389@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ b14~116@)) (Mul (Mul d14~120@ d14~120@) d14~120@)) (Mul (Mul (Mul d14~120@ c14~118@) (Add b14~116@ c14~118@)) (Mul (Mul c14~118@ d14~120@) (Mul a14~114@ b14~116@))))) (=> (= temp_14_1~2450@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ b14~116@)) (Mul (Mul d14~120@ d14~120@) d14~120@)) (Mul (Mul (Mul c14~118@ d14~120@) (Add b14~116@ c14~118@)) (Mul (Mul c14~118@ d14~120@) (Mul a14~114@ b14~116@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2389@ temp_14_1~2450@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
