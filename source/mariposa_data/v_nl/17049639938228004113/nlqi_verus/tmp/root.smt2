...
(push)
 ...
 (declare-const temp_14_1~2450@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~293@ temp_0_1~346@)
        (=>
         (= temp_1_0~431@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@)) (Mul b1~12@
             (Mul d1~16@ c1~14@)
            )
         ...
         (=>
          (= temp_1_1~492@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@)) (Mul b1~12@
              (Mul d1~16@ c1~14@)
             )
          ...
          (and
           (=>
            ...
            (=>
             %%location_label%%1
             (= temp_1_0~431@ temp_1_1~492@)
           ))
           (=>
            (= temp_1_0~431@ temp_1_1~492@)
            (=>
             (= temp_2_0~601@ (Mul (Sub (Mul (Mul 75 a2~18@) (Mul b2~20@ 49)) (Sub (Mul d2~24@ c2~22@)
                 (Mul c2~22@ d2~24@)
                )
               ) (Sub (Mul (Mul d2~24@ a2~18@) b2~20@) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ d2~24@)))
             ))
             (=>
              (= temp_2_1~686@ (Mul (Sub (Mul (Mul 75 a2~18@) (Mul b2~20@ 49)) (Sub (Mul d2~24@ c2~22@)
                  (Mul c2~22@ d2~24@)
                 )
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~601@ temp_2_1~686@)
               ))
               (=>
                (= temp_2_0~601@ temp_2_1~686@)
                (=>
                 (= temp_3_0~775@ (Add (Mul (Mul (Sub c3~30@ d3~32@) (Sub b3~28@ a3~26@)) (Add (Mul a3~26@
                      b3~28@
                     ) (Mul c3~30@ a3~26@)
                    )
                 ...
                 (=>
                  (= temp_3_1~840@ (Add (Mul (Mul (Sub c3~30@ d3~32@) (Sub b3~28@ a3~26@)) (Add (Mul a3~26@
                       b3~28@
                      ) (Mul c3~30@ a3~26@)
                     )
                    ) (Add (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~775@ temp_3_1~840@)
                    (=>
                     (= temp_4_0~941@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul 71 b4~36@)) (Mul (Mul c4~38@
                          b4~36@
                         ) (Mul d4~40@ c4~38@)
                        )
                     ...
                     (=>
                      (= temp_4_1~1018@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul 71 b4~36@)) (Mul c4~38@ (Mul
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~941@ temp_4_1~1018@)
                        (=>
                         (= temp_5_0~1095@ (Add (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) a5~42@) (
                            Mul (Add (Mul a5~42@ b5~44@) (Add b5~44@ a5~42@)) (Mul (Mul a5~42@ a5~42@) (Add c5~46@
                              a5~42@
                         )))))
                         (=>
                          (= temp_5_1~1148@ (Add (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) a5~42@) (
                          ...
                          (and
                           ...
                           (=>
                            (= temp_5_0~1095@ temp_5_1~1148@)
                            (=>
                             (= temp_6_0~1237@ (Mul (Mul (Mul (Sub d6~56@ b6~52@) (Mul c6~54@ c6~54@)) (Sub (Mul a6~50@
                                  b6~52@
                                 ) (Add c6~54@ a6~50@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1302@ (Mul (Mul (Mul (Sub d6~56@ b6~52@) (Mul c6~54@ c6~54@)) (Sub (Mul a6~50@
                                   b6~52@
                                  ) (Add c6~54@ a6~50@)
                                 )
                                ) (Mul b6~52@ (Add (Mul d6~56@ 24) (Mul c6~54@ a6~50@)))
                              ...
                              (and
                               ...
                               (=>
                                (= temp_6_0~1237@ temp_6_1~1302@)
                                (=>
                                 (= temp_7_0~1391@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Add b7~60@ b7~60@)) (Mul (Mul d7~64@
                                      b7~60@
                                     ) (Sub d7~64@ a7~58@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1456@ (Mul (Mul (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Mul c7~62@
                                       b7~60@
                                      ) (Mul a7~58@ b7~60@)
                                     )
                                  ...
                                  (and
                                   ...
                                   (=>
                                    (= temp_7_0~1391@ temp_7_1~1456@)
                                    (=>
                                     (= temp_8_0~1545@ (Sub (Mul (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Mul d8~72@
                                          c8~70@
                                         ) (Mul b8~68@ d8~72@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1626@ (Sub (Mul (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Mul d8~72@
                                           c8~70@
                                          ) (Mul b8~68@ d8~72@)
                                         )
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1545@ temp_8_1~1626@)
                                       ))
                                       (=>
                                        (= temp_8_0~1545@ temp_8_1~1626@)
                                        (=>
                                         (= temp_9_0~1707@ (Add (Mul (Add b9~76@ (Mul b9~76@ b9~76@)) (Mul a9~74@ (Mul a9~74@ c9~78@)))
                                           (Mul (Add (Mul a9~74@ d9~80@) (Mul b9~76@ c9~78@)) (Sub (Mul a9~74@ c9~78@) (Mul d9~80@
                                              c9~78@
                                         )))))
                                         (=>
                                          (= temp_9_1~1760@ (Add (Mul (Add b9~76@ (Mul b9~76@ b9~76@)) (Mul a9~74@ (Mul a9~74@ c9~78@)))
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1707@ temp_9_1~1760@)
                                           ))
                                           (=>
                                            (= temp_9_0~1707@ temp_9_1~1760@)
                                            (=>
                                             (= temp_10_0~1833@ (Mul (Mul (Mul (Sub c10~86@ c10~86@) (Mul b10~84@ b10~84@)) (Mul (
                                                  Mul d10~88@ b10~84@
                                                 ) (Add c10~86@ b10~84@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1882@ (Mul (Mul (Mul (Mul d10~88@ b10~84@) (Add c10~86@ b10~84@)) (Mul (
                                                   Sub c10~86@ c10~86@
                                                  ) (Mul b10~84@ b10~84@)
                                                 )
                                                ) (Mul (Add d10~88@ (Mul c10~86@ b10~84@)) b10~84@)
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1833@ temp_10_1~1882@)
                                               ))
                                               (=>
                                                (= temp_10_0~1833@ temp_10_1~1882@)
                                                (=>
                                                 (= temp_11_0~1983@ (Mul (Mul (Mul (Mul b11~92@ a11~90@) (Mul b11~92@ d11~96@)) (Add (
                                                      Add 77 c11~94@
                                                     ) (Mul c11~94@ a11~90@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2060@ (Mul (Mul (Mul b11~92@ a11~90@) (Mul (Mul b11~92@ d11~96@) (Add (Add
                                                        77 c11~94@
                                                       ) (Mul c11~94@ a11~90@)
                                                     ))
                                                    ) (Mul (Mul (Sub d11~96@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul b11~92@ a11~90@)
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~1983@ temp_11_1~2060@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~1983@ temp_11_1~2060@)
                                                    (=>
                                                     (= temp_12_0~2121@ (Add c12~102@ (Mul (Mul (Add a12~98@ d12~104@) (Mul c12~102@ a12~98@))
                                                        (Mul (Sub c12~102@ d12~104@) (Sub d12~104@ c12~102@))
                                                     )))
                                                     (=>
                                                      (= temp_12_1~2158@ (Add c12~102@ (Mul (Mul (Add a12~98@ d12~104@) (Mul c12~102@ a12~98@))
                                                      ...
                                                      (and
                                                       ...
                                                       (=>
                                                        (= temp_12_0~2121@ temp_12_1~2158@)
                                                        (=>
                                                         (= temp_13_0~2243@ (Mul (Mul (Add (Mul b13~108@ b13~108@) (Mul d13~112@ d13~112@)) (
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2304@ (Mul (Mul (Add (Mul b13~108@ b13~108@) (Mul d13~112@ d13~112@)) (
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2243@ temp_13_1~2304@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2243@ temp_13_1~2304@)
                                                            (=>
                                                             (= temp_14_0~2389@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ b14~116@)) (
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2450@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ b14~116@)) (
                                                                  Mul (Mul d14~120@ d14~120@) d14~120@
                                                                 )
