...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Add b0~4@ d0~8@) (Mul d0~8@ d0~8@)) (Mul d0~8@ (Mul b0~4@ b0~4@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Add b0~4@ d0~8@) (Mul d0~8@ d0~8@)) (Mul d0~8@ (Mul b0~4@ b0~4@))) (Mul (Mul b0~4@ (Mul c0~6@ (Mul c0~6@ c0~6@))) (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~447@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Sub b1~12@ c1~14@) a1~10@)) (Mul (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ c1~14@)) (Add (Mul c1~14@ c1~14@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~512@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ a1~10@)) (Sub (Mul b1~12@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ c1~14@)) (Add (Mul c1~14@ c1~14@) (Mul c1~14@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~512@))) (=> (= temp_1_0~447@ temp_1_1~512@) (=> (= temp_2_0~573@ (Mul (Mul (Mul (Add d2~24@ b2~20@) (Mul b2~20@ d2~24@)) (Add (Mul b2~20@ d2~24@) (Mul b2~20@ b2~20@))) c2~22@)) (=> (= temp_2_1~610@ (Mul (Mul (Mul (Add d2~24@ b2~20@) (Mul b2~20@ d2~24@)) (Add (Mul d2~24@ b2~20@) (Mul b2~20@ b2~20@))) c2~22@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~573@ temp_2_1~610@))) (=> (= temp_2_0~573@ temp_2_1~610@) (=> (= temp_3_0~695@ (Mul (Sub (Mul (Mul a3~26@ b3~28@) d3~32@) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~756@ (Mul (Sub (Mul (Mul a3~26@ b3~28@) d3~32@) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ d3~32@))) (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~695@ temp_3_1~756@))) (=> (= temp_3_0~695@ temp_3_1~756@) (=> (= temp_4_0~833@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ d4~40@)) a4~34@) (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul a4~34@ c4~38@) (Add a4~34@ b4~36@))))) (=> (= temp_4_1~886@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ d4~40@)) a4~34@) (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul a4~34@ c4~38@) (Add a4~34@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~833@ temp_4_1~886@))) (=> (= temp_4_0~833@ temp_4_1~886@) (=> (= temp_5_0~975@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ d5~48@)) (Mul (Add d5~48@ a5~42@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ b5~44@)) (Mul (Add a5~42@ a5~42@) (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1040@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ d5~48@)) (Mul (Add d5~48@ a5~42@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ c5~46@)) (Mul (Add a5~42@ a5~42@) (Mul d5~48@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~975@ temp_5_1~1040@))) (=> (= temp_5_0~975@ temp_5_1~1040@) (=> (= temp_6_0~1137@ (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Mul 56 b6~52@)) (Mul c6~54@ (Add b6~52@ b6~52@))) (Add (Mul (Mul b6~52@ c6~54@) (Sub b6~52@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1210@ (Mul (Mul (Mul (Mul (Mul d6~56@ c6~54@) 56) b6~52@) (Mul c6~54@ (Add b6~52@ b6~52@))) (Add (Mul (Mul b6~52@ c6~54@) (Sub b6~52@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1137@ temp_6_1~1210@))) (=> (= temp_6_0~1137@ temp_6_1~1210@) (=> (= temp_7_0~1311@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Add d7~64@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ a7~58@) (Mul 73 a7~58@))))) (=> (= temp_7_1~1388@ (Mul (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ c7~62@)) (Add d7~64@ b7~60@)) (Mul a7~58@ a7~58@)) (Mul (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ a7~58@) (Mul 73 a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1311@ temp_7_1~1388@))) (=> (= temp_7_0~1311@ temp_7_1~1388@) (=> (= temp_8_0~1465@ (Mul (Add a8~66@ (Add (Mul c8~70@ d8~72@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1518@ (Mul (Add a8~66@ (Add (Mul c8~70@ d8~72@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1465@ temp_8_1~1518@))) (=> (= temp_8_0~1465@ temp_8_1~1518@) (=> (= temp_9_0~1619@ (Mul (Add (Mul (Mul d9~80@ c9~78@) (Add b9~76@ d9~80@)) (Mul (Mul b9~76@ c9~78@) (Mul 84 d9~80@))) (Mul (Sub (Add a9~74@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~1728@ (Add (Mul (Mul (Mul d9~80@ c9~78@) (Add b9~76@ d9~80@)) (Mul (Sub (Add a9~74@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)))) (Mul (Mul (Mul b9~76@ c9~78@) (Mul 84 d9~80@)) (Mul (Sub (Add a9~74@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1619@ temp_9_1~1728@))) (=> (= temp_9_0~1619@ temp_9_1~1728@) (=> (= temp_10_0~1809@ (Mul (Mul b10~84@ (Mul (Add c10~86@ b10~84@) (Add d10~88@ c10~86@))) (Mul (Mul (Mul a10~82@ d10~88@) 1) (Mul a10~82@ (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~1866@ (Mul (Mul b10~84@ (Mul (Add d10~88@ c10~86@) (Add c10~86@ b10~84@))) (Mul (Mul (Mul a10~82@ d10~88@) 1) (Mul a10~82@ (Mul c10~86@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1809@ temp_10_1~1866@))) (=> (= temp_10_0~1809@ temp_10_1~1866@) (=> (= temp_11_0~1967@ (Mul (Mul (Mul (Mul 99 a11~90@) (Add a11~90@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ a11~90@))) (Mul (Mul (Mul b11~92@ a11~90@) (Add c11~94@ c11~94@)) (Mul (Sub b11~92@ c11~94@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~2044@ (Mul (Mul (Mul (Mul 99 a11~90@) (Add a11~90@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ a11~90@))) (Mul (Mul (Sub b11~92@ c11~94@) (Mul d11~96@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Add c11~94@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1967@ temp_11_1~2044@))) (=> (= temp_11_0~1967@ temp_11_1~2044@) (=> (= temp_12_0~2133@ (Mul (Mul (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ a12~98@)) (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ d12~104@)) (Mul (Mul b12~100@ d12~104@) (Add d12~104@ d12~104@))))) (=> (= temp_12_1~2198@ (Mul (Mul (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ a12~98@)) (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul (Mul d12~104@ b12~100@) d12~104@) d12~104@) (Mul (Mul b12~100@ d12~104@) (Add d12~104@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2133@ temp_12_1~2198@))) (=> (= temp_12_0~2133@ temp_12_1~2198@) (=> (= temp_13_0~2287@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul b13~108@ a13~106@) (Mul d13~112@ b13~108@))) (Mul (Mul (Sub d13~112@ b13~108@) (Mul c13~110@ c13~110@)) (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ c13~110@))))) (=> (= temp_13_1~2352@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul b13~108@ a13~106@) (Mul d13~112@ b13~108@))) (Mul (Mul (Sub d13~112@ b13~108@) (Mul c13~110@ c13~110@)) (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2287@ temp_13_1~2352@))) (=> (= temp_13_0~2287@ temp_13_1~2352@) (=> (= temp_14_0~2425@ (Mul (Add a14~114@ (Add (Mul b14~116@ b14~116@) b14~116@)) (Mul (Mul (Mul d14~120@ d14~120@) (Sub a14~114@ d14~120@)) (Sub (Sub a14~114@ a14~114@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2474@ (Mul (Mul (Mul (Mul d14~120@ d14~120@) (Sub a14~114@ d14~120@)) (Sub (Sub a14~114@ a14~114@) (Mul b14~116@ c14~118@))) (Add a14~114@ (Add (Mul b14~116@ b14~116@) b14~116@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2425@ temp_14_1~2474@))) (=> (= temp_14_0~2425@ temp_14_1~2474@) (=> (= temp_15_0~2563@ (Mul (Mul (Mul (Mul b15~124@ c15~126@) (Mul b15~124@ d15~128@)) (Mul (Mul c15~126@ b15~124@) (Mul a15~122@ a15~122@))) (Mul (Mul (Mul b15~124@ b15~124@) (Mul a15~122@ c15~126@)) (Add (Mul c15~126@ d15~128@) (Mul b15~124@ c15~126@))))) (=> (= temp_15_1~2628@ (Mul (Mul (Mul (Mul b15~124@ c15~126@) (Mul b15~124@ d15~128@)) (Mul (Mul c15~126@ b15~124@) (Mul a15~122@ a15~122@))) (Mul (Mul (Mul (Mul b15~124@ b15~124@) a15~122@) c15~126@) (Add (Mul c15~126@ d15~128@) (Mul b15~124@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2563@ temp_15_1~2628@))) (=> (= temp_15_0~2563@ temp_15_1~2628@) (=> (= temp_16_0~2717@ (Sub (Sub (Mul (Mul c16~134@ c16~134@) (Mul d16~136@ a16~130@)) (Mul (Add a16~130@ d16~136@) (Mul c16~134@ d16~136@))) (Mul (Sub (Mul c16~134@ c16~134@) (Mul c16~134@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2782@ (Sub (Sub (Mul (Mul c16~134@ c16~134@) (Mul d16~136@ a16~130@)) (Mul (Add a16~130@ d16~136@) (Mul c16~134@ d16~136@))) (Mul (Sub (Mul c16~134@ c16~134@) (Mul c16~134@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2717@ temp_16_1~2782@))) (=> (= temp_16_0~2717@ temp_16_1~2782@) (=> (= temp_17_0~2843@ (Mul (Mul (Mul (Mul a17~138@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Sub d17~144@ d17~144@) (Mul b17~140@ c17~142@))) c17~142@)) (=> (= temp_17_1~2880@ (Mul (Mul (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ d17~144@)) (Mul (Sub d17~144@ d17~144@) (Mul b17~140@ c17~142@))) c17~142@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2843@ temp_17_1~2880@))) (=> (= temp_17_0~2843@ temp_17_1~2880@) (=> (= temp_18_0~2969@ (Mul (Mul (Mul (Sub a18~146@ d18~152@) (Mul c18~150@ d18~152@)) (Mul (Mul b18~148@ c18~150@) (Mul a18~146@ a18~146@))) (Mul (Mul (Sub d18~152@ a18~146@) (Mul c18~150@ b18~148@)) (Sub (Mul b18~148@ a18~146@) (Sub b18~148@ b18~148@))))) (=> (= temp_18_1~3034@ (Mul (Mul (Mul (Sub a18~146@ d18~152@) (Mul c18~150@ d18~152@)) (Mul (Mul b18~148@ c18~150@) (Mul a18~146@ a18~146@))) (Mul (Mul (Sub d18~152@ a18~146@) (Mul c18~150@ b18~148@)) (Sub (Mul a18~146@ b18~148@) (Sub b18~148@ b18~148@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2969@ temp_18_1~3034@))) (=> (= temp_18_0~2969@ temp_18_1~3034@) (=> (= temp_19_0~3119@ (Mul (Mul (Mul (Mul d19~160@ b19~156@) (Mul a19~154@ d19~160@)) (Mul (Mul a19~154@ b19~156@) (Mul b19~156@ d19~160@))) (Sub (Mul (Mul b19~156@ c19~158@) (Add b19~156@ d19~160@)) (Mul a19~154@ (Mul a19~154@ a19~154@))))) (=> (= temp_19_1~3180@ (Mul (Mul (Mul (Mul (Mul d19~160@ b19~156@) (Mul a19~154@ d19~160@)) (Mul a19~154@ b19~156@)) (Mul b19~156@ d19~160@)) (Sub (Mul (Mul b19~156@ c19~158@) (Add b19~156@ d19~160@)) (Mul a19~154@ (Mul a19~154@ a19~154@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3119@ temp_19_1~3180@))) (=> (= temp_19_0~3119@ temp_19_1~3180@) (=> (= temp_20_0~3265@ (Mul (Mul (Mul (Mul b20~164@ c20~166@) d20~168@) (Add b20~164@ (Mul c20~166@ b20~164@))) (Mul (Mul b20~164@ a20~162@) (Mul (Mul b20~164@ b20~164@) (Mul b20~164@ 20))))) (=> (= temp_20_1~3326@ (Mul (Mul (Mul (Mul b20~164@ c20~166@) d20~168@) (Add b20~164@ (Mul c20~166@ b20~164@))) (Mul (Mul a20~162@ b20~164@) (Mul (Mul b20~164@ b20~164@) (Mul b20~164@ 20))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3265@ temp_20_1~3326@))) (=> (= temp_20_0~3265@ temp_20_1~3326@) (=> (= temp_21_0~3427@ (Mul (Mul (Mul (Mul d21~176@ d21~176@) (Add d21~176@ d21~176@)) (Mul (Mul c21~174@ b21~172@) (Mul a21~170@ a21~170@))) (Mul (Mul (Mul a21~170@ d21~176@) (Mul d21~176@ c21~174@)) (Mul (Mul d21~176@ b21~172@) (Mul 67 b21~172@))))) (=> (= temp_21_1~3504@ (Mul (Mul (Mul (Mul d21~176@ d21~176@) (Add d21~176@ d21~176@)) (Mul (Mul b21~172@ c21~174@) (Mul a21~170@ a21~170@))) (Mul (Mul (Mul a21~170@ d21~176@) (Mul d21~176@ c21~174@)) (Mul (Mul d21~176@ b21~172@) (Mul 67 b21~172@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3427@ temp_21_1~3504@))) (=> (= temp_21_0~3427@ temp_21_1~3504@) (=> (= temp_22_0~3617@ (Mul (Mul (Add (Mul d22~184@ c22~182@) (Mul c22~182@ b22~180@)) (Mul (Mul a22~178@ c22~182@) (Mul 42 b22~180@))) (Mul (Mul (Mul c22~182@ b22~180@) (Mul c22~182@ d22~184@)) (Mul (Mul c22~182@ 78) (Mul a22~178@ d22~184@))))) (=> (= temp_22_1~3706@ (Mul (Mul (Add (Mul d22~184@ c22~182@) (Mul c22~182@ b22~180@)) (Mul (Mul a22~178@ c22~182@) (Mul 42 b22~180@))) (Mul (Mul (Mul c22~182@ 78) (Mul a22~178@ d22~184@)) (Mul (Mul c22~182@ b22~180@) (Mul c22~182@ d22~184@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3617@ temp_22_1~3706@))) (=> (= temp_22_0~3617@ temp_22_1~3706@) (=> (= temp_23_0~3795@ (Mul (Mul (Mul (Mul c23~190@ a23~186@) (Mul d23~192@ d23~192@)) (Mul (Mul d23~192@ a23~186@) (Mul a23~186@ a23~186@))) (Mul (Add (Mul b23~188@ d23~192@) (Mul c23~190@ b23~188@)) (Mul (Mul d23~192@ c23~190@) (Mul a23~186@ d23~192@))))) (=> (= temp_23_1~3860@ (Mul (Mul (Mul (Mul d23~192@ d23~192@) (Mul c23~190@ a23~186@)) (Mul (Mul d23~192@ a23~186@) (Mul a23~186@ a23~186@))) (Mul (Add (Mul b23~188@ d23~192@) (Mul c23~190@ b23~188@)) (Mul (Mul d23~192@ c23~190@) (Mul a23~186@ d23~192@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3795@ temp_23_1~3860@))) (=> (= temp_23_0~3795@ temp_23_1~3860@) (=> (= temp_24_0~3937@ (Mul (Mul (Mul (Mul d24~200@ c24~198@) (Mul b24~196@ a24~194@)) (Mul (Mul b24~196@ c24~198@) (Mul d24~200@ c24~198@))) (Mul c24~198@ (Sub (Mul a24~194@ b24~196@) (Mul c24~198@ a24~194@))))) (=> (= temp_24_1~3990@ (Mul (Mul (Mul d24~200@ c24~198@) (Mul b24~196@ a24~194@)) (Mul (Mul (Mul b24~196@ c24~198@) (Mul d24~200@ c24~198@)) (Mul c24~198@ (Sub (Mul a24~194@ b24~196@) (Mul c24~198@ a24~194@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3937@ temp_24_1~3990@))) (=> (= temp_24_0~3937@ temp_24_1~3990@) (=> (= temp_25_0~4091@ (Mul (Mul (Sub (Mul 5 b25~204@) (Mul c25~206@ a25~202@)) (Mul (Add b25~204@ c25~206@) (Mul a25~202@ c25~206@))) (Add (Mul (Mul a25~202@ c25~206@) (Mul b25~204@ d25~208@)) (Add (Mul d25~208@ d25~208@) (Mul c25~206@ c25~206@))))) (=> (= temp_25_1~4168@ (Mul (Mul (Sub (Mul 5 b25~204@) (Mul c25~206@ a25~202@)) (Mul (Add b25~204@ c25~206@) (Mul a25~202@ c25~206@))) (Add (Mul (Mul c25~206@ a25~202@) (Mul b25~204@ d25~208@)) (Add (Mul d25~208@ d25~208@) (Mul c25~206@ c25~206@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~4091@ temp_25_1~4168@))) (=> (= temp_25_0~4091@ temp_25_1~4168@) (=> (= temp_26_0~4257@ (Mul (Mul (Mul (Mul d26~216@ b26~212@) (Mul a26~210@ d26~216@)) (Mul (Add d26~216@ d26~216@) (Mul c26~214@ a26~210@))) (Mul (Mul (Add b26~212@ a26~210@) (Mul c26~214@ c26~214@)) (Sub (Sub b26~212@ a26~210@) (Mul d26~216@ c26~214@))))) (=> (= temp_26_1~4322@ (Mul (Mul (Mul (Mul d26~216@ b26~212@) (Mul a26~210@ d26~216@)) (Mul (Add d26~216@ d26~216@) (Mul c26~214@ a26~210@))) (Mul (Mul (Add b26~212@ a26~210@) (Mul c26~214@ c26~214@)) (Sub (Sub b26~212@ a26~210@) (Mul c26~214@ d26~216@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%26 (= temp_26_0~4257@ temp_26_1~4322@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
