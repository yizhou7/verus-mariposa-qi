...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Add c0~6@ a0~2@) (Mul c0~6@ d0~8@)) (Sub (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) (Add (Mul a0~2@ d0~8@) b0~4@)))) (=> (= temp_0_1~350@ (Mul (Mul (Mul (Add c0~6@ a0~2@) (Mul c0~6@ d0~8@)) (Mul b0~4@ (Sub b0~4@ a0~2@))) (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) (Add (Mul a0~2@ d0~8@) b0~4@)))) (=> (= tmp%1@ (= temp_0_0~297@ temp_0_1~350@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~430@ (Add (Mul (Mul (Mul a1~10@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Add c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Sub (Mul a1~10@ d1~16@) (Mul b1~12@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~495@ (Add (Mul (Mul (Mul a1~10@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Add c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Sub (Mul a1~10@ d1~16@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~430@ temp_1_1~495@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~583@ (Mul (Mul (Mul c2~22@ (Sub d2~24@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ b2~20@)) (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ 97))))) (=> (= temp_2_1~656@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@)) (Mul c2~22@ (Sub d2~24@ c2~22@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ b2~20@)) (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ 97))))) (=> (= tmp%3@ (= temp_2_0~583@ temp_2_1~656@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~748@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ 27)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~825@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ 27)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul c3~30@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~748@ temp_3_1~825@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~897@ (Mul (Mul (Sub (Mul b4~36@ b4~36@) a4~34@) (Mul (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@))) (Add (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@)) (Mul a4~34@ (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~954@ (Mul (Mul (Sub (Mul b4~36@ b4~36@) a4~34@) (Mul (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@))) (Add (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@)) (Mul a4~34@ (Mul d4~40@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~897@ temp_4_1~954@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1042@ (Mul (Sub (Mul a5~42@ (Sub 76 a5~42@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Add c5~46@ c5~46@) (Mul b5~44@ d5~48@))))) (=> (= temp_5_1~1115@ (Mul (Sub (Mul a5~42@ (Sub 76 a5~42@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Add c5~46@ c5~46@) (Mul b5~44@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1042@ temp_5_1~1115@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1187@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ d6~56@))) (Mul (Mul b6~52@ (Add b6~52@ c6~54@)) (Mul (Sub d6~56@ c6~54@) b6~52@)))) (=> (= temp_6_1~1244@ (Mul (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ d6~56@)) (Mul b6~52@ d6~56@)) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ (Add b6~52@ c6~54@)) (Mul (Sub d6~56@ c6~54@) b6~52@)))) (=> (= tmp%7@ (= temp_6_0~1187@ temp_6_1~1244@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1312@ (Mul (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ a7~58@)) a7~58@) (Mul (Sub (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1365@ (Mul (Mul (Sub (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ a7~58@)) a7~58@))) (=> (= tmp%8@ (= temp_7_0~1312@ temp_7_1~1365@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1445@ (Mul (Mul (Mul (Add c8~70@ a8~66@) (Sub d8~72@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ 91))) (Mul d8~72@ (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1510@ (Mul (Mul (Mul (Add c8~70@ a8~66@) (Sub d8~72@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ 91))) (Mul d8~72@ (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1445@ temp_8_1~1510@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1562@ (Mul (Mul (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ b9~76@)) (Mul c9~78@ (Sub a9~74@ b9~76@))) (Mul a9~74@ a9~74@))) (=> (= temp_9_1~1599@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@)) (Mul c9~78@ (Sub a9~74@ b9~76@))) (Mul a9~74@ a9~74@))) (=> (= tmp%10@ (= temp_9_0~1562@ temp_9_1~1599@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1699@ (Mul (Mul (Mul (Add d10~88@ d10~88@) (Mul 66 a10~82@)) (Mul (Mul 56 b10~84@) d10~88@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Add d10~88@ c10~86@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1804@ (Mul (Mul (Add (Mul d10~88@ (Mul 66 a10~82@)) (Mul d10~88@ (Mul 66 a10~82@))) (Mul (Mul 56 b10~84@) d10~88@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Add d10~88@ c10~86@) (Mul d10~88@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1699@ temp_10_1~1804@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1880@ (Mul (Add (Mul (Mul b11~92@ a11~90@) (Mul b11~92@ b11~92@)) (Mul b11~92@ (Mul d11~96@ d11~96@))) (Mul (Add (Mul b11~92@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@))))) (=> (= temp_11_1~1973@ (Add (Mul (Mul (Mul b11~92@ a11~90@) (Mul b11~92@ b11~92@)) (Mul (Add (Mul b11~92@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)))) (Mul (Mul b11~92@ (Mul d11~96@ d11~96@)) (Mul (Add (Mul b11~92@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)))))) (=> (= tmp%12@ (= temp_11_0~1880@ temp_11_1~1973@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2053@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Mul c12~102@ a12~98@) (Mul a12~98@ c12~102@))) (Add (Mul (Mul c12~102@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Sub d12~104@ d12~104@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2118@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ a12~98@))) (Add (Mul (Mul c12~102@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Sub d12~104@ d12~104@) (Mul d12~104@ a12~98@))))) (=> (= tmp%13@ (= temp_12_0~2053@ temp_12_1~2118@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2194@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ b13~108@)) (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ c13~110@)) (Mul c13~110@ (Mul b13~108@ b13~108@))))) (=> (= temp_13_1~2255@ (Mul (Mul (Mul c13~110@ (Mul a13~106@ (Mul b13~108@ b13~108@))) (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ c13~110@)) (Mul c13~110@ (Mul b13~108@ b13~108@))))) (=> (= tmp%14@ (= temp_13_0~2194@ temp_13_1~2255@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2319@ (Mul (Mul (Mul (Sub c14~118@ b14~116@) (Add b14~116@ b14~116@)) (Mul (Mul d14~120@ a14~114@) (Add c14~118@ a14~114@))) 22)) (=> (= temp_14_1~2376@ (Mul (Mul (Mul (Sub c14~118@ b14~116@) (Add b14~116@ b14~116@)) (Add (Mul (Mul d14~120@ a14~114@) c14~118@) (Mul (Mul d14~120@ a14~114@) a14~114@))) 22)) (=> (= tmp%15@ (= temp_14_0~2319@ temp_14_1~2376@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2456@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ b15~124@) (Add b15~124@ d15~128@))) (Mul (Mul (Sub b15~124@ c15~126@) (Mul a15~122@ b15~124@)) (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~2521@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ b15~124@) (Add b15~124@ d15~128@))) (Mul (Mul (Sub b15~124@ c15~126@) (Mul a15~122@ b15~124@)) (Mul (Mul a15~122@ c15~126@) (Mul c15~126@ c15~126@))))) (=> (= tmp%16@ (= temp_15_0~2456@ temp_15_1~2521@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2589@ (Mul (Mul (Sub (Mul a16~130@ b16~132@) (Mul a16~130@ d16~136@)) (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ a16~130@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ b16~132@)) d16~136@))) (=> (= temp_16_1~2638@ (Mul (Mul (Mul a16~130@ (Sub b16~132@ d16~136@)) (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ a16~130@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ b16~132@)) d16~136@))) (=> (= tmp%17@ (= temp_16_0~2589@ temp_16_1~2638@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2730@ (Mul (Add (Mul (Add b17~140@ c17~142@) (Mul 36 d17~144@)) (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ d17~144@))) (Mul (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ c17~142@) (Sub c17~142@ b17~140@))))) (=> (= temp_17_1~2807@ (Mul (Add (Mul (Add b17~140@ c17~142@) (Mul 36 d17~144@)) (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ d17~144@))) (Mul (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ c17~142@) (Sub c17~142@ b17~140@))))) (=> (= tmp%18@ (= temp_17_0~2730@ temp_17_1~2807@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2879@ (Mul (Mul (Sub (Mul c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul a18~146@ a18~146@)) (Mul (Sub (Mul b18~148@ d18~152@) (Mul d18~152@ b18~148@)) (Mul (Add b18~148@ a18~146@) (Mul d18~152@ c18~150@))))) (=> (= temp_18_1~2936@ (Mul (Mul (Sub (Mul c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul a18~146@ a18~146@)) (Mul (Sub (Mul d18~152@ b18~148@) (Mul d18~152@ b18~148@)) (Mul (Add b18~148@ a18~146@) (Mul d18~152@ c18~150@))))) (=> (= tmp%19@ (= temp_18_0~2879@ temp_18_1~2936@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3004@ (Mul (Mul d19~160@ (Mul (Mul d19~160@ d19~160@) (Mul b19~156@ d19~160@))) (Mul (Sub (Mul b19~156@ a19~154@) (Mul b19~156@ d19~160@)) (Mul (Add d19~160@ d19~160@) (Mul d19~160@ a19~154@))))) (=> (= temp_19_1~3057@ (Mul (Mul d19~160@ (Mul d19~160@ (Mul d19~160@ (Mul b19~156@ d19~160@)))) (Mul (Sub (Mul b19~156@ a19~154@) (Mul b19~156@ d19~160@)) (Mul (Add d19~160@ d19~160@) (Mul d19~160@ a19~154@))))) (=> (= tmp%20@ (= temp_19_0~3004@ temp_19_1~3057@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3125@ (Sub (Mul (Mul (Add c20~166@ b20~164@) (Mul a20~162@ a20~162@)) (Sub (Mul d20~168@ b20~164@) (Mul d20~168@ b20~164@))) (Mul b20~164@ (Add (Mul b20~164@ b20~164@) (Mul b20~164@ b20~164@))))) (=> (= temp_20_1~3182@ (Sub (Mul (Mul (Add c20~166@ b20~164@) (Mul a20~162@ a20~162@)) (Sub (Mul d20~168@ b20~164@) (Mul d20~168@ b20~164@))) (Add (Mul b20~164@ (Mul b20~164@ b20~164@)) (Mul b20~164@ (Mul b20~164@ b20~164@))))) (=> (= tmp%21@ (= temp_20_0~3125@ temp_20_1~3182@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3250@ (Mul (Mul d21~176@ (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ c21~174@))) (Mul (Sub (Mul b21~172@ b21~172@) (Sub a21~170@ c21~174@)) (Sub (Mul d21~176@ d21~176@) (Mul c21~174@ a21~170@))))) (=> (= temp_21_1~3303@ (Mul (Mul (Sub (Mul b21~172@ b21~172@) (Sub a21~170@ c21~174@)) (Sub (Mul d21~176@ d21~176@) (Mul c21~174@ a21~170@))) (Mul d21~176@ (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ c21~174@))))) (=> (= tmp%22@ (= temp_21_0~3250@ temp_21_1~3303@)) (and (=> %%location_label%%21 tmp%22@) (=> tmp%22@ (=> (= temp_22_0~3391@ (Mul (Mul (Mul (Mul a22~178@ b22~180@) (Add a22~178@ c22~182@)) (Mul b22~180@ (Mul d22~184@ d22~184@))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul 13 d22~184@)) (Mul (Mul d22~184@ d22~184@) (Mul a22~178@ b22~180@))))) (=> (= temp_22_1~3464@ (Mul (Mul (Mul (Mul a22~178@ b22~180@) (Add a22~178@ c22~182@)) (Mul b22~180@ (Mul d22~184@ d22~184@))) (Mul (Mul (Mul d22~184@ d22~184@) (Mul a22~178@ b22~180@)) (Mul (Mul b22~180@ b22~180@) (Mul 13 d22~184@))))) (=> (= tmp%23@ (= temp_22_0~3391@ temp_22_1~3464@)) (and (=> %%location_label%%22 tmp%23@) (=> tmp%23@ (=> (= temp_23_0~3568@ (Mul (Mul (Add (Mul d23~192@ 5) (Mul d23~192@ c23~190@)) (Mul (Mul b23~188@ 82) (Mul a23~186@ a23~186@))) (Mul (Mul (Mul a23~186@ b23~188@) (Mul a23~186@ b23~188@)) (Mul (Mul c23~190@ c23~190@) (Sub d23~192@ d23~192@))))) (=> (= temp_23_1~3657@ (Mul (Mul (Add (Mul d23~192@ 5) (Mul c23~190@ d23~192@)) (Mul (Mul b23~188@ 82) (Mul a23~186@ a23~186@))) (Mul (Mul (Mul a23~186@ b23~188@) (Mul a23~186@ b23~188@)) (Mul (Mul c23~190@ c23~190@) (Sub d23~192@ d23~192@))))) (=> (= tmp%24@ (= temp_23_0~3568@ temp_23_1~3657@)) (=> %%location_label%%23 tmp%24@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
