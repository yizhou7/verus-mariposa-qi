...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Add c0~6@ a0~2@) (Mul c0~6@ d0~8@)) (Sub (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) (Add (Mul a0~2@ d0~8@) b0~4@)))) (=> (= temp_0_1~350@ (Mul (Mul (Mul (Add c0~6@ a0~2@) (Mul c0~6@ d0~8@)) (Mul b0~4@ (Sub b0~4@ a0~2@))) (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) (Add (Mul a0~2@ d0~8@) b0~4@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~350@))) (=> (= temp_0_0~297@ temp_0_1~350@) (=> (= temp_1_0~439@ (Add (Mul (Mul (Mul a1~10@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Add c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Sub (Mul a1~10@ d1~16@) (Mul b1~12@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~504@ (Add (Mul (Mul (Mul a1~10@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Add c1~14@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Sub (Mul a1~10@ d1~16@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~439@ temp_1_1~504@))) (=> (= temp_1_0~439@ temp_1_1~504@) (=> (= temp_2_0~601@ (Mul (Mul (Mul c2~22@ (Sub d2~24@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ b2~20@)) (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ 97))))) (=> (= temp_2_1~674@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@)) (Mul c2~22@ (Sub d2~24@ c2~22@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ b2~20@)) (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ 97))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~601@ temp_2_1~674@))) (=> (= temp_2_0~601@ temp_2_1~674@) (=> (= temp_3_0~775@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ 27)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~852@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ 27)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~775@ temp_3_1~852@))) (=> (= temp_3_0~775@ temp_3_1~852@) (=> (= temp_4_0~933@ (Mul (Mul (Sub (Mul b4~36@ b4~36@) a4~34@) (Mul (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@))) (Add (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@)) (Mul a4~34@ (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~990@ (Mul (Mul (Sub (Mul b4~36@ b4~36@) a4~34@) (Mul (Add b4~36@ d4~40@) (Mul c4~38@ c4~38@))) (Add (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@)) (Mul a4~34@ (Mul d4~40@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~933@ temp_4_1~990@))) (=> (= temp_4_0~933@ temp_4_1~990@) (=> (= temp_5_0~1087@ (Mul (Sub (Mul a5~42@ (Sub 76 a5~42@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Add c5~46@ c5~46@) (Mul b5~44@ d5~48@))))) (=> (= temp_5_1~1160@ (Mul (Sub (Mul a5~42@ (Sub 76 a5~42@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Add c5~46@ c5~46@) (Mul b5~44@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1087@ temp_5_1~1160@))) (=> (= temp_5_0~1087@ temp_5_1~1160@) (=> (= temp_6_0~1241@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ d6~56@))) (Mul (Mul b6~52@ (Add b6~52@ c6~54@)) (Mul (Sub d6~56@ c6~54@) b6~52@)))) (=> (= temp_6_1~1298@ (Mul (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ d6~56@)) (Mul b6~52@ d6~56@)) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ (Add b6~52@ c6~54@)) (Mul (Sub d6~56@ c6~54@) b6~52@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1241@ temp_6_1~1298@))) (=> (= temp_6_0~1241@ temp_6_1~1298@) (=> (= temp_7_0~1375@ (Mul (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ a7~58@)) a7~58@) (Mul (Sub (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1428@ (Mul (Mul (Sub (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ a7~58@)) a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1375@ temp_7_1~1428@))) (=> (= temp_7_0~1375@ temp_7_1~1428@) (=> (= temp_8_0~1517@ (Mul (Mul (Mul (Add c8~70@ a8~66@) (Sub d8~72@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ 91))) (Mul d8~72@ (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1582@ (Mul (Mul (Mul (Add c8~70@ a8~66@) (Sub d8~72@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ 91))) (Mul d8~72@ (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1517@ temp_8_1~1582@))) (=> (= temp_8_0~1517@ temp_8_1~1582@) (=> (= temp_9_0~1643@ (Mul (Mul (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ b9~76@)) (Mul c9~78@ (Sub a9~74@ b9~76@))) (Mul a9~74@ a9~74@))) (=> (= temp_9_1~1680@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@)) (Mul c9~78@ (Sub a9~74@ b9~76@))) (Mul a9~74@ a9~74@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1643@ temp_9_1~1680@))) (=> (= temp_9_0~1643@ temp_9_1~1680@) (=> (= temp_10_0~1789@ (Mul (Mul (Mul (Add d10~88@ d10~88@) (Mul 66 a10~82@)) (Mul (Mul 56 b10~84@) d10~88@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Add d10~88@ c10~86@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1894@ (Mul (Mul (Add (Mul d10~88@ (Mul 66 a10~82@)) (Mul d10~88@ (Mul 66 a10~82@))) (Mul (Mul 56 b10~84@) d10~88@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Add d10~88@ c10~86@) (Mul d10~88@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1789@ temp_10_1~1894@))) (=> (= temp_10_0~1789@ temp_10_1~1894@) (=> (= temp_11_0~1979@ (Mul (Add (Mul (Mul b11~92@ a11~90@) (Mul b11~92@ b11~92@)) (Mul b11~92@ (Mul d11~96@ d11~96@))) (Mul (Add (Mul b11~92@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@))))) (=> (= temp_11_1~2072@ (Add (Mul (Mul (Mul b11~92@ a11~90@) (Mul b11~92@ b11~92@)) (Mul (Add (Mul b11~92@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)))) (Mul (Mul b11~92@ (Mul d11~96@ d11~96@)) (Mul (Add (Mul b11~92@ a11~90@) (Mul d11~96@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1979@ temp_11_1~2072@))) (=> (= temp_11_0~1979@ temp_11_1~2072@) (=> (= temp_12_0~2161@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Mul c12~102@ a12~98@) (Mul a12~98@ c12~102@))) (Add (Mul (Mul c12~102@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Sub d12~104@ d12~104@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2226@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ a12~98@))) (Add (Mul (Mul c12~102@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Sub d12~104@ d12~104@) (Mul d12~104@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2161@ temp_12_1~2226@))) (=> (= temp_12_0~2161@ temp_12_1~2226@) (=> (= temp_13_0~2311@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ b13~108@)) (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ c13~110@)) (Mul c13~110@ (Mul b13~108@ b13~108@))))) (=> (= temp_13_1~2372@ (Mul (Mul (Mul c13~110@ (Mul a13~106@ (Mul b13~108@ b13~108@))) (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ c13~110@)) (Mul c13~110@ (Mul b13~108@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2311@ temp_13_1~2372@))) (=> (= temp_13_0~2311@ temp_13_1~2372@) (=> (= temp_14_0~2445@ (Mul (Mul (Mul (Sub c14~118@ b14~116@) (Add b14~116@ b14~116@)) (Mul (Mul d14~120@ a14~114@) (Add c14~118@ a14~114@))) 22)) (=> (= temp_14_1~2502@ (Mul (Mul (Mul (Sub c14~118@ b14~116@) (Add b14~116@ b14~116@)) (Add (Mul (Mul d14~120@ a14~114@) c14~118@) (Mul (Mul d14~120@ a14~114@) a14~114@))) 22)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2445@ temp_14_1~2502@))) (=> (= temp_14_0~2445@ temp_14_1~2502@) (=> (= temp_15_0~2591@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ b15~124@) (Add b15~124@ d15~128@))) (Mul (Mul (Sub b15~124@ c15~126@) (Mul a15~122@ b15~124@)) (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~2656@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ b15~124@) (Add b15~124@ d15~128@))) (Mul (Mul (Sub b15~124@ c15~126@) (Mul a15~122@ b15~124@)) (Mul (Mul a15~122@ c15~126@) (Mul c15~126@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2591@ temp_15_1~2656@))) (=> (= temp_15_0~2591@ temp_15_1~2656@) (=> (= temp_16_0~2733@ (Mul (Mul (Sub (Mul a16~130@ b16~132@) (Mul a16~130@ d16~136@)) (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ a16~130@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ b16~132@)) d16~136@))) (=> (= temp_16_1~2782@ (Mul (Mul (Mul a16~130@ (Sub b16~132@ d16~136@)) (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ a16~130@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ b16~132@)) d16~136@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2733@ temp_16_1~2782@))) (=> (= temp_16_0~2733@ temp_16_1~2782@) (=> (= temp_17_0~2883@ (Mul (Add (Mul (Add b17~140@ c17~142@) (Mul 36 d17~144@)) (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ d17~144@))) (Mul (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ c17~142@) (Sub c17~142@ b17~140@))))) (=> (= temp_17_1~2960@ (Mul (Add (Mul (Add b17~140@ c17~142@) (Mul 36 d17~144@)) (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ d17~144@))) (Mul (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ c17~142@) (Sub c17~142@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2883@ temp_17_1~2960@))) (=> (= temp_17_0~2883@ temp_17_1~2960@) (=> (= temp_18_0~3041@ (Mul (Mul (Sub (Mul c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul a18~146@ a18~146@)) (Mul (Sub (Mul b18~148@ d18~152@) (Mul d18~152@ b18~148@)) (Mul (Add b18~148@ a18~146@) (Mul d18~152@ c18~150@))))) (=> (= temp_18_1~3098@ (Mul (Mul (Sub (Mul c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul a18~146@ a18~146@)) (Mul (Sub (Mul d18~152@ b18~148@) (Mul d18~152@ b18~148@)) (Mul (Add b18~148@ a18~146@) (Mul d18~152@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3041@ temp_18_1~3098@))) (=> (= temp_18_0~3041@ temp_18_1~3098@) (=> (= temp_19_0~3175@ (Mul (Mul d19~160@ (Mul (Mul d19~160@ d19~160@) (Mul b19~156@ d19~160@))) (Mul (Sub (Mul b19~156@ a19~154@) (Mul b19~156@ d19~160@)) (Mul (Add d19~160@ d19~160@) (Mul d19~160@ a19~154@))))) (=> (= temp_19_1~3228@ (Mul (Mul d19~160@ (Mul d19~160@ (Mul d19~160@ (Mul b19~156@ d19~160@)))) (Mul (Sub (Mul b19~156@ a19~154@) (Mul b19~156@ d19~160@)) (Mul (Add d19~160@ d19~160@) (Mul d19~160@ a19~154@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3175@ temp_19_1~3228@))) (=> (= temp_19_0~3175@ temp_19_1~3228@) (=> (= temp_20_0~3305@ (Sub (Mul (Mul (Add c20~166@ b20~164@) (Mul a20~162@ a20~162@)) (Sub (Mul d20~168@ b20~164@) (Mul d20~168@ b20~164@))) (Mul b20~164@ (Add (Mul b20~164@ b20~164@) (Mul b20~164@ b20~164@))))) (=> (= temp_20_1~3362@ (Sub (Mul (Mul (Add c20~166@ b20~164@) (Mul a20~162@ a20~162@)) (Sub (Mul d20~168@ b20~164@) (Mul d20~168@ b20~164@))) (Add (Mul b20~164@ (Mul b20~164@ b20~164@)) (Mul b20~164@ (Mul b20~164@ b20~164@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3305@ temp_20_1~3362@))) (=> (= temp_20_0~3305@ temp_20_1~3362@) (=> (= temp_21_0~3439@ (Mul (Mul d21~176@ (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ c21~174@))) (Mul (Sub (Mul b21~172@ b21~172@) (Sub a21~170@ c21~174@)) (Sub (Mul d21~176@ d21~176@) (Mul c21~174@ a21~170@))))) (=> (= temp_21_1~3492@ (Mul (Mul (Sub (Mul b21~172@ b21~172@) (Sub a21~170@ c21~174@)) (Sub (Mul d21~176@ d21~176@) (Mul c21~174@ a21~170@))) (Mul d21~176@ (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ c21~174@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3439@ temp_21_1~3492@))) (=> (= temp_21_0~3439@ temp_21_1~3492@) (=> (= temp_22_0~3589@ (Mul (Mul (Mul (Mul a22~178@ b22~180@) (Add a22~178@ c22~182@)) (Mul b22~180@ (Mul d22~184@ d22~184@))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul 13 d22~184@)) (Mul (Mul d22~184@ d22~184@) (Mul a22~178@ b22~180@))))) (=> (= temp_22_1~3662@ (Mul (Mul (Mul (Mul a22~178@ b22~180@) (Add a22~178@ c22~182@)) (Mul b22~180@ (Mul d22~184@ d22~184@))) (Mul (Mul (Mul d22~184@ d22~184@) (Mul a22~178@ b22~180@)) (Mul (Mul b22~180@ b22~180@) (Mul 13 d22~184@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3589@ temp_22_1~3662@))) (=> (= temp_22_0~3589@ temp_22_1~3662@) (=> (= temp_23_0~3775@ (Mul (Mul (Add (Mul d23~192@ 5) (Mul d23~192@ c23~190@)) (Mul (Mul b23~188@ 82) (Mul a23~186@ a23~186@))) (Mul (Mul (Mul a23~186@ b23~188@) (Mul a23~186@ b23~188@)) (Mul (Mul c23~190@ c23~190@) (Sub d23~192@ d23~192@))))) (=> (= temp_23_1~3864@ (Mul (Mul (Add (Mul d23~192@ 5) (Mul c23~190@ d23~192@)) (Mul (Mul b23~188@ 82) (Mul a23~186@ a23~186@))) (Mul (Mul (Mul a23~186@ b23~188@) (Mul a23~186@ b23~188@)) (Mul (Mul c23~190@ c23~190@) (Sub d23~192@ d23~192@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3775@ temp_23_1~3864@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
