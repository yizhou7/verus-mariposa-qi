...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Sub (Mul (Add (Mul c0~6@ c0~6@) (Add c0~6@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) d0~8@) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~362@ (Sub (Mul (Mul (Add (Mul c0~6@ c0~6@) (Add c0~6@ b0~4@)) (Mul a0~2@ b0~4@)) (Mul d0~8@ c0~6@)) (Mul (Mul (Mul c0~6@ a0~2@) d0~8@) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~438@ (Mul (Sub (Mul c1~14@ (Mul c1~14@ d1~16@)) (Mul (Sub c1~14@ d1~16@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ b1~12@))))) (=> (= temp_1_1~499@ (Mul (Sub (Mul c1~14@ (Mul c1~14@ d1~16@)) (Mul (Sub c1~14@ d1~16@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@)) (Mul d1~16@ d1~16@)) (Mul a1~10@ b1~12@)))) (=> (= tmp%2@ (= temp_1_0~438@ temp_1_1~499@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~547@ (Sub (Mul (Mul c2~22@ (Add a2~18@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ d2~24@))) c2~22@)) (=> (= temp_2_1~580@ (Sub (Mul (Mul c2~22@ (Add a2~18@ b2~20@)) (Mul (Mul (Mul c2~22@ a2~18@) b2~20@) d2~24@)) c2~22@)) (=> (= tmp%3@ (= temp_2_0~547@ temp_2_1~580@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~656@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@)) (Mul a3~26@ (Mul d3~32@ a3~26@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ b3~28@))))) (=> (= temp_3_1~717@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@)) (Mul a3~26@ (Mul d3~32@ a3~26@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~656@ temp_3_1~717@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~793@ (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Mul d4~40@ d4~40@) d4~40@)))) (=> (= temp_4_1~854@ (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@)) (Mul d4~40@ (Mul d4~40@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~793@ temp_4_1~854@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~934@ (Mul (Mul (Add (Add d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Sub (Add c5~46@ b5~44@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul d5~48@ b5~44@) (Add b5~44@ a5~42@)) (Sub (Sub a5~42@ d5~48@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1007@ (Mul (Mul (Add (Add d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Sub (Add c5~46@ b5~44@) (Mul a5~42@ d5~48@))) (Mul (Add (Mul (Mul d5~48@ b5~44@) b5~44@) (Mul (Mul d5~48@ b5~44@) a5~42@)) (Sub (Sub a5~42@ d5~48@) (Mul a5~42@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~934@ temp_5_1~1007@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1087@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) (Sub (Mul c6~54@ b6~52@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1152@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) (Sub (Mul c6~54@ b6~52@) (Mul d6~56@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1087@ temp_6_1~1152@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1228@ (Mul (Mul (Mul a7~58@ (Add b7~60@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Add (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1289@ (Mul (Mul (Mul a7~58@ (Add b7~60@ b7~60@)) (Mul d7~64@ (Mul d7~64@ (Mul a7~58@ d7~64@)))) (Mul (Add (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ c7~62@))))) (=> (= tmp%8@ (= temp_7_0~1228@ temp_7_1~1289@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1369@ (Add (Mul (Mul (Add b8~68@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@)) (Sub (Mul c8~70@ a8~66@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1434@ (Add (Mul (Mul (Add b8~68@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@)) (Sub (Mul c8~70@ a8~66@) (Mul a8~66@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1369@ temp_8_1~1434@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1482@ (Sub (Mul (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ a9~74@)) (Mul b9~76@ (Mul b9~76@ a9~74@))) d9~80@)) (=> (= temp_9_1~1515@ (Sub (Mul (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ a9~74@)) (Mul b9~76@ (Mul b9~76@ a9~74@))) d9~80@)) (=> (= tmp%10@ (= temp_9_0~1482@ temp_9_1~1515@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1591@ (Mul (Mul (Mul (Sub c10~86@ c10~86@) a10~82@) (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@))) (Sub (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ b10~84@)) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~1652@ (Mul (Mul (Mul (Sub c10~86@ c10~86@) a10~82@) (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@))) (Sub (Mul (Mul a10~82@ b10~84@) (Mul b10~84@ b10~84@)) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ b10~84@))))) (=> (= tmp%11@ (= temp_10_0~1591@ temp_10_1~1652@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1756@ (Sub (Add (Mul c11~94@ (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ d11~96@) c11~94@)) (Add (Sub (Mul 67 a11~90@) (Mul 97 b11~92@)) (Mul 22 (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~1845@ (Sub (Add (Mul (Mul a11~90@ c11~94@) c11~94@) (Mul (Mul a11~90@ d11~96@) c11~94@)) (Add (Sub (Mul 67 a11~90@) (Mul 97 b11~92@)) (Mul 22 (Mul d11~96@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1756@ temp_11_1~1845@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1921@ (Mul (Mul (Add (Mul d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Sub d12~104@ b12~100@) (Add a12~98@ b12~100@))) (Mul (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ d12~104@)) (Mul c12~102@ (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~1982@ (Mul (Mul (Add (Mul d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Sub d12~104@ b12~100@) (Add a12~98@ b12~100@))) (Mul (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ d12~104@)) (Mul c12~102@ (Mul a12~98@ b12~100@))))) (=> (= tmp%13@ (= temp_12_0~1921@ temp_12_1~1982@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2074@ (Mul (Sub (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ c13~110@)) (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ a13~106@))) (Mul (Mul (Mul c13~110@ b13~108@) (Add b13~108@ c13~110@)) (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ 39))))) (=> (= temp_13_1~2151@ (Mul (Sub (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ c13~110@)) (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ a13~106@))) (Mul (Mul (Mul c13~110@ b13~108@) (Add b13~108@ c13~110@)) (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ 39))))) (=> (= tmp%14@ (= temp_13_0~2074@ temp_13_1~2151@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2239@ (Sub (Mul (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Add d14~120@ 15) (Add b14~116@ d14~120@))) (Mul (Sub (Mul a14~114@ b14~116@) (Mul b14~116@ c14~118@)) (Mul a14~114@ (Mul a14~114@ a14~114@))))) (=> (= temp_14_1~2312@ (Sub (Mul (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Add d14~120@ 15) (Add b14~116@ d14~120@))) (Mul (Mul a14~114@ (Mul a14~114@ a14~114@)) (Sub (Mul a14~114@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2239@ temp_14_1~2312@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2392@ (Mul (Mul (Mul (Add a15~122@ a15~122@) (Mul a15~122@ a15~122@)) (Mul (Add a15~122@ a15~122@) (Sub b15~124@ d15~128@))) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ d15~128@)) (Add (Mul a15~122@ d15~128@) (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~2457@ (Mul (Mul (Mul (Add a15~122@ a15~122@) (Mul a15~122@ a15~122@)) (Mul (Add a15~122@ a15~122@) (Sub b15~124@ d15~128@))) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ d15~128@)) (Add (Mul a15~122@ d15~128@) (Mul a15~122@ c15~126@))))) (=> (= tmp%16@ (= temp_15_0~2392@ temp_15_1~2457@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2521@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ a16~130@)) d16~136@) (Mul (Mul (Mul a16~130@ c16~134@) (Add b16~132@ b16~132@)) (Mul c16~134@ (Mul d16~136@ d16~136@))))) (=> (= temp_16_1~2570@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ a16~130@)) d16~136@) (Mul (Mul c16~134@ (Mul d16~136@ d16~136@)) (Mul (Mul a16~130@ c16~134@) (Add b16~132@ b16~132@))))) (=> (= tmp%17@ (= temp_16_0~2521@ temp_16_1~2570@)) (=> %%location_label%%16 tmp%17@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
