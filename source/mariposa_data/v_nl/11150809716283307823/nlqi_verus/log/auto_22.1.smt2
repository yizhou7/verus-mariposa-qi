...
(assert (=> %%query%% (not (=> (= temp_0_0~329@ (Mul (Mul (Mul (Mul b0~4@ 40) (Mul c0~6@ 0)) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ d0~8@))) (Sub (Mul (Mul d0~8@ a0~2@) (Sub b0~4@ b0~4@)) (Mul (Mul c0~6@ a0~2@) (Add c0~6@ c0~6@))))) (=> (= temp_0_1~418@ (Mul (Mul (Mul b0~4@ 40) (Mul (Mul c0~6@ 0) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ d0~8@)))) (Sub (Mul (Mul d0~8@ a0~2@) (Sub b0~4@ b0~4@)) (Mul (Mul c0~6@ a0~2@) (Add c0~6@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~329@ temp_0_1~418@))) (=> (= temp_0_0~329@ temp_0_1~418@) (=> (= temp_1_0~507@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Sub d1~16@ c1~14@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~572@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Sub d1~16@ c1~14@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul c1~14@ (Mul b1~12@ (Mul d1~16@ b1~12@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~507@ temp_1_1~572@))) (=> (= temp_1_0~507@ temp_1_1~572@) (=> (= temp_2_0~657@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ b2~20@))) (Mul (Mul c2~22@ (Mul c2~22@ c2~22@)) (Mul (Add d2~24@ a2~18@) (Mul d2~24@ c2~22@))))) (=> (= temp_2_1~718@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ d2~24@)) (Mul a2~18@ (Mul c2~22@ (Mul a2~18@ b2~20@)))) (Mul (Mul c2~22@ (Mul c2~22@ c2~22@)) (Mul (Add d2~24@ a2~18@) (Mul d2~24@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~657@ temp_2_1~718@))) (=> (= temp_2_0~657@ temp_2_1~718@) (=> (= temp_3_0~799@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ a3~26@))) (Mul (Mul a3~26@ a3~26@) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~856@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ d3~32@))) (Mul (Mul a3~26@ a3~26@) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~799@ temp_3_1~856@))) (=> (= temp_3_0~799@ temp_3_1~856@) (=> (= temp_4_0~937@ (Mul (Mul (Add c4~38@ (Add a4~34@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul b4~36@ a4~34@) (Add c4~38@ b4~36@)) (Mul (Mul b4~36@ a4~34@) a4~34@)))) (=> (= temp_4_1~1002@ (Mul (Mul (Add c4~38@ (Add a4~34@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ d4~40@))) (Mul (Add (Mul (Mul b4~36@ a4~34@) c4~38@) (Mul (Mul b4~36@ a4~34@) b4~36@)) (Mul (Mul b4~36@ a4~34@) a4~34@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~937@ temp_4_1~1002@))) (=> (= temp_4_0~937@ temp_4_1~1002@) (=> (= temp_5_0~1103@ (Mul (Mul (Sub (Add c5~46@ c5~46@) (Mul c5~46@ b5~44@)) (Mul (Sub b5~44@ c5~46@) (Mul b5~44@ a5~42@))) (Mul (Add (Mul c5~46@ a5~42@) (Mul b5~44@ c5~46@)) (Add (Mul b5~44@ 54) (Mul b5~44@ d5~48@))))) (=> (= temp_5_1~1180@ (Mul (Mul (Sub (Add c5~46@ c5~46@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Sub b5~44@ c5~46@))) (Mul (Add (Mul c5~46@ a5~42@) (Mul b5~44@ c5~46@)) (Add (Mul b5~44@ 54) (Mul b5~44@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1103@ temp_5_1~1180@))) (=> (= temp_5_0~1103@ temp_5_1~1180@) (=> (= temp_6_0~1293@ (Mul (Mul (Sub (Add 43 b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ 91) (Mul c6~54@ d6~56@))) (Mul (Mul (Add a6~50@ d6~56@) (Mul d6~56@ b6~52@)) (Add (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@))))) (=> (= temp_6_1~1382@ (Mul (Mul (Sub (Add 43 b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ 91) (Mul c6~54@ d6~56@))) (Mul (Mul (Add a6~50@ d6~56@) (Mul b6~52@ d6~56@)) (Add (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1293@ temp_6_1~1382@))) (=> (= temp_6_0~1293@ temp_6_1~1382@) (=> (= temp_7_0~1479@ (Mul (Mul (Sub (Mul d7~64@ c7~62@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ b7~60@) b7~60@)) (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@)) (Mul (Mul 23 d7~64@) (Sub a7~58@ b7~60@))))) (=> (= temp_7_1~1552@ (Mul (Mul (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ b7~60@) b7~60@)) (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@)) (Mul (Mul 23 d7~64@) (Sub a7~58@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1479@ temp_7_1~1552@))) (=> (= temp_7_0~1479@ temp_7_1~1552@) (=> (= temp_8_0~1629@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@)) (Add (Mul c8~70@ a8~66@) (Add a8~66@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul a8~66@ b8~68@)) b8~68@))) (=> (= temp_8_1~1682@ (Mul (Mul (Mul b8~68@ a8~66@) (Mul (Mul d8~72@ c8~70@) (Add (Mul c8~70@ a8~66@) (Add a8~66@ a8~66@)))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul a8~66@ b8~68@)) b8~68@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1629@ temp_8_1~1682@))) (=> (= temp_8_0~1629@ temp_8_1~1682@) (=> (= temp_9_0~1767@ (Mul (Add (Add (Mul d9~80@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Add d9~80@ a9~74@) (Sub b9~76@ d9~80@))) (Mul (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@)) (Mul a9~74@ (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1856@ (Add (Mul (Add (Mul d9~80@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@)) (Mul a9~74@ (Mul a9~74@ a9~74@)))) (Mul (Mul (Add d9~80@ a9~74@) (Sub b9~76@ d9~80@)) (Mul (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@)) (Mul a9~74@ (Mul a9~74@ a9~74@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1767@ temp_9_1~1856@))) (=> (= temp_9_0~1767@ temp_9_1~1856@) (=> (= temp_10_0~1941@ (Mul (Mul (Add (Mul d10~88@ d10~88@) a10~82@) (Mul (Sub b10~84@ a10~82@) (Mul d10~88@ b10~84@))) (Mul (Add (Mul a10~82@ b10~84@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ a10~82@))))) (=> (= temp_10_1~2002@ (Mul (Mul (Add (Mul d10~88@ d10~88@) a10~82@) (Mul (Sub b10~84@ a10~82@) (Mul d10~88@ b10~84@))) (Mul (Add (Mul a10~82@ b10~84@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1941@ temp_10_1~2002@))) (=> (= temp_10_0~1941@ temp_10_1~2002@) (=> (= temp_11_0~2091@ (Mul (Add (Mul (Sub c11~94@ d11~96@) (Mul b11~92@ c11~94@)) (Mul (Mul d11~96@ c11~94@) (Sub d11~96@ c11~94@))) (Mul (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ a11~90@))))) (=> (= temp_11_1~2156@ (Mul (Add (Mul (Sub c11~94@ d11~96@) (Mul b11~92@ c11~94@)) (Mul (Sub d11~96@ c11~94@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2091@ temp_11_1~2156@))) (=> (= temp_11_0~2091@ temp_11_1~2156@) (=> (= temp_12_0~2249@ (Mul (Mul (Mul c12~102@ (Sub c12~102@ b12~100@)) (Mul (Add c12~102@ c12~102@) 89)) (Mul (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ b12~100@))))) (=> (= temp_12_1~2318@ (Mul (Mul (Mul (Mul c12~102@ (Sub c12~102@ b12~100@)) (Mul (Add c12~102@ c12~102@) 89)) (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ d12~104@))) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ b12~100@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2249@ temp_12_1~2318@))) (=> (= temp_12_0~2249@ temp_12_1~2318@) (=> (= temp_13_0~2407@ (Add (Mul (Mul (Add b13~108@ c13~110@) (Mul a13~106@ a13~106@)) (Mul (Mul c13~110@ a13~106@) (Mul a13~106@ a13~106@))) (Sub (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ b13~108@) (Sub d13~112@ b13~108@))))) (=> (= temp_13_1~2472@ (Add (Mul (Mul (Add b13~108@ c13~110@) (Mul a13~106@ a13~106@)) (Mul (Mul c13~110@ a13~106@) (Mul a13~106@ a13~106@))) (Sub (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ c13~110@)) (Mul (Mul c13~110@ b13~108@) (Sub d13~112@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2407@ temp_13_1~2472@))) (=> (= temp_13_0~2407@ temp_13_1~2472@) (=> (= temp_14_0~2573@ (Mul (Mul (Mul (Mul b14~116@ 78) (Mul c14~118@ c14~118@)) (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ d14~120@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Sub a14~114@ d14~120@) (Mul c14~118@ a14~114@))))) (=> (= temp_14_1~2650@ (Mul (Mul (Mul (Mul b14~116@ 78) (Mul c14~118@ c14~118@)) (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ d14~120@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Sub a14~114@ d14~120@) (Mul c14~118@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2573@ temp_14_1~2650@))) (=> (= temp_14_0~2573@ temp_14_1~2650@) (=> (= temp_15_0~2751@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ b15~124@)) (Mul (Sub c15~126@ d15~128@) (Mul c15~126@ b15~124@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul a15~122@ d15~128@)) (Mul (Sub 27 c15~126@) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~2828@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ b15~124@)) (Mul (Sub c15~126@ d15~128@) (Mul b15~124@ c15~126@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul a15~122@ d15~128@)) (Mul (Sub 27 c15~126@) (Mul d15~128@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2751@ temp_15_1~2828@))) (=> (= temp_15_0~2751@ temp_15_1~2828@) (=> (= temp_16_0~2917@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ a16~130@)) (Add (Add d16~136@ a16~130@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Sub c16~134@ d16~136@))))) (=> (= temp_16_1~2990@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ a16~130@)) (Add (Add d16~136@ a16~130@) (Mul d16~136@ a16~130@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@)) (Sub (Mul (Mul b16~132@ b16~132@) c16~134@) (Mul (Mul b16~132@ b16~132@) d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2917@ temp_16_1~2990@))) (=> (= temp_16_0~2917@ temp_16_1~2990@) (=> (= temp_17_0~3079@ (Mul (Sub (Mul (Mul c17~142@ 88) (Mul d17~144@ c17~142@)) (Mul (Mul b17~140@ d17~144@) (Sub c17~142@ c17~142@))) (Mul b17~140@ (Add (Mul a17~138@ b17~140@) (Sub c17~142@ b17~140@))))) (=> (= temp_17_1~3144@ (Mul (Mul b17~140@ (Add (Mul a17~138@ b17~140@) (Sub c17~142@ b17~140@))) (Sub (Mul (Mul c17~142@ 88) (Mul d17~144@ c17~142@)) (Mul (Mul b17~140@ d17~144@) (Sub c17~142@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~3079@ temp_17_1~3144@))) (=> (= temp_17_0~3079@ temp_17_1~3144@) (=> (= temp_18_0~3245@ (Mul (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ a18~146@)) (Add (Mul b18~148@ b18~148@) (Mul c18~150@ c18~150@))) (Mul (Mul (Mul b18~148@ c18~150@) (Mul d18~152@ b18~148@)) (Mul (Mul 45 b18~148@) (Mul a18~146@ b18~148@))))) (=> (= temp_18_1~3322@ (Mul (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ a18~146@)) (Add (Mul b18~148@ b18~148@) (Mul c18~150@ c18~150@))) (Mul (Mul b18~148@ (Mul c18~150@ (Mul d18~152@ b18~148@))) (Mul (Mul 45 b18~148@) (Mul a18~146@ b18~148@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3245@ temp_18_1~3322@))) (=> (= temp_18_0~3245@ temp_18_1~3322@) (=> (= temp_19_0~3407@ (Add (Mul (Mul (Mul d19~160@ a19~154@) (Add b19~156@ d19~160@)) (Mul (Mul d19~160@ b19~156@) (Mul b19~156@ b19~156@))) (Mul (Sub (Sub c19~158@ c19~158@) (Mul b19~156@ b19~156@)) (Sub d19~160@ (Sub b19~156@ b19~156@))))) (=> (= temp_19_1~3476@ (Add (Mul (Add (Mul (Mul d19~160@ a19~154@) b19~156@) (Mul (Mul d19~160@ a19~154@) d19~160@)) (Mul (Mul d19~160@ b19~156@) (Mul b19~156@ b19~156@))) (Mul (Sub (Sub c19~158@ c19~158@) (Mul b19~156@ b19~156@)) (Sub d19~160@ (Sub b19~156@ b19~156@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3407@ temp_19_1~3476@))) (=> (= temp_19_0~3407@ temp_19_1~3476@) (=> (= temp_20_0~3561@ (Mul (Mul (Add (Mul b20~164@ c20~166@) (Mul a20~162@ b20~164@)) (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ a20~162@))) (Add (Sub (Mul b20~164@ a20~162@) (Mul b20~164@ d20~168@)) (Sub (Mul c20~166@ a20~162@) b20~164@)))) (=> (= temp_20_1~3654@ (Add (Mul (Mul (Add (Mul b20~164@ c20~166@) (Mul a20~162@ b20~164@)) (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ a20~162@))) (Sub (Mul b20~164@ a20~162@) (Mul b20~164@ d20~168@))) (Mul (Mul (Add (Mul b20~164@ c20~166@) (Mul a20~162@ b20~164@)) (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ a20~162@))) (Sub (Mul c20~166@ a20~162@) b20~164@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3561@ temp_20_1~3654@))) (=> (= temp_20_0~3561@ temp_20_1~3654@) (=> (= temp_21_0~3755@ (Mul (Mul (Mul (Add c21~174@ a21~170@) (Mul b21~172@ d21~176@)) (Mul (Mul c21~174@ a21~170@) (Mul a21~170@ b21~172@))) (Mul (Mul (Mul c21~174@ b21~172@) (Mul a21~170@ b21~172@)) (Mul (Mul 18 a21~170@) (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~3832@ (Mul (Mul (Mul (Mul b21~172@ d21~176@) (Add c21~174@ a21~170@)) (Mul (Mul c21~174@ a21~170@) (Mul a21~170@ b21~172@))) (Mul (Mul (Mul c21~174@ b21~172@) (Mul a21~170@ b21~172@)) (Mul (Mul 18 a21~170@) (Mul a21~170@ b21~172@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3755@ temp_21_1~3832@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
