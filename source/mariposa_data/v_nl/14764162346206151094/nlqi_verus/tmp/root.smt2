     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~301@ temp_0_1~362@)
        (=>
         (= temp_1_0~451@ (Add (Mul (Sub (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@
              d1~16@
             ) (Mul a1~10@ d1~16@)
            )
         ...
         (=>
          (= temp_1_1~516@ (Add (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Sub (Mul d1~16@
               d1~16@
              ) (Mul b1~12@ b1~12@)
             )
            ) (Mul (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Add b1~12@
          ...
          (and
           ...
           (=>
            (= temp_1_0~451@ temp_1_1~516@)
            (=>
             (= temp_2_0~617@ (Mul (Add (Mul (Mul d2~24@ b2~20@) (Add 80 b2~20@)) (Mul (Add d2~24@
                  d2~24@
                 ) (Add b2~20@ c2~22@)
                )
             ...
             (=>
              (= temp_2_1~694@ (Mul (Add (Mul (Mul b2~20@ d2~24@) (Add 80 b2~20@)) (Mul (Add d2~24@
                   d2~24@
                  ) (Add b2~20@ c2~22@)
                 )
                ) (Mul (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@
              ...
              (and
               ...
               (=>
                (= temp_2_0~617@ temp_2_1~694@)
                (=>
                 (= temp_3_0~775@ (Add (Mul (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ d3~32@)) (Add b3~28@
                     (Mul a3~26@ b3~28@)
                    )
                   ) (Mul (Add (Mul b3~28@ d3~32@) (Add b3~28@ d3~32@)) (Sub a3~26@ (Mul b3~28@ c3~30@)))
                 ))
                 (=>
                  (= temp_3_1~832@ (Add (Mul (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ d3~32@)) (Add b3~28@
                      (Mul a3~26@ b3~28@)
                     )
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~775@ temp_3_1~832@)
                    (=>
                     (= temp_4_0~909@ (Mul (Mul (Sub (Mul b4~36@ a4~34@) (Add c4~38@ a4~34@)) (Add (Mul d4~40@
                          a4~34@
                         ) (Mul c4~38@ a4~34@)
                        )
                     ...
                     (=>
                      (= temp_4_1~962@ (Mul (Mul (Sub (Mul a4~34@ b4~36@) (Add c4~38@ a4~34@)) (Add (Mul d4~40@
                           a4~34@
                          ) (Mul c4~38@ a4~34@)
                         )
                        ) (Sub a4~34@ (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@)))
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~909@ temp_4_1~962@)
                       ))
                       (=>
                        (= temp_4_0~909@ temp_4_1~962@)
                        (=>
                         (= temp_5_0~1075@ (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@
                              d5~48@
                             ) (Add b5~44@ a5~42@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1164@ (Mul (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul
                                b5~44@ d5~48@
                               ) (Add b5~44@ a5~42@)
                              )
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1075@ temp_5_1~1164@)
                           ))
                           (=>
                            (= temp_5_0~1075@ temp_5_1~1164@)
                            (=>
                             (= temp_6_0~1249@ (Add (Mul (Sub (Mul d6~56@ a6~50@) d6~56@) (Add (Mul d6~56@ d6~56@)
                                 (Mul b6~52@ b6~52@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1326@ (Add (Sub (Mul (Mul d6~56@ a6~50@) (Add (Mul d6~56@ d6~56@) (Mul b6~52@
                                    b6~52@
                                  ))
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1249@ temp_6_1~1326@)
                               ))
                               (=>
                                (= temp_6_0~1249@ temp_6_1~1326@)
                                (=>
                                 (= temp_7_0~1439@ (Mul (Mul (Mul (Mul c7~62@ 10) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@
                                      d7~64@
                                     ) (Mul b7~60@ b7~60@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1528@ (Mul (Mul (Mul (Mul c7~62@ 10) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@
                                       d7~64@
                                      ) (Mul b7~60@ b7~60@)
                                     )
