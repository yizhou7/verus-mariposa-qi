...
;; mariposa_data/v_nl//14764162346206151094/nlqi_verus/src/main.rs:7:1: 36:40 (#0)
(push)
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~301@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ b0~4@)
         b0~4@
        )
       ) (Mul (Mul (Mul d0~8@ a0~2@) (Add b0~4@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@)))
     ))
     (=>
      (= temp_0_1~362@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ b0~4@)
          b0~4@
         )
        ) (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Add b0~4@ d0~8@)) (Mul b0~4@ d0~8@)) (Mul b0~4@
          a0~2@
      ))))
      (=>
       ...
       (and
        ...
        (=>
         tmp%1@
         (=>
          (= temp_1_0~442@ (Add (Mul (Sub (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@
               d1~16@
              ) (Mul a1~10@ d1~16@)
             )
            ) (Mul (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Add b1~12@
               d1~16@
          )))))
          (=>
           (= temp_1_1~507@ (Add (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Sub (Mul d1~16@
                d1~16@
               ) (Mul b1~12@ b1~12@)
              )
             ) (Mul (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Add b1~12@
           ...
           (=>
            ...
            (and
             ...
             (=>
              tmp%2@
              (=>
               (= temp_2_0~599@ (Mul (Add (Mul (Mul d2~24@ b2~20@) (Add 80 b2~20@)) (Mul (Add d2~24@
                    d2~24@
                   ) (Add b2~20@ c2~22@)
                  )
                 ) (Mul (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@
                    a2~18@
               )))))
               (=>
                (= temp_2_1~676@ (Mul (Add (Mul (Mul b2~20@ d2~24@) (Add 80 b2~20@)) (Mul (Add d2~24@
                     d2~24@
                    ) (Add b2~20@ c2~22@)
                   )
                  ) (Mul (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   tmp%3@
                   (=>
                    (= temp_3_0~748@ (Add (Mul (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ d3~32@)) (Add b3~28@
                        (Mul a3~26@ b3~28@)
                       )
                      ) (Mul (Add (Mul b3~28@ d3~32@) (Add b3~28@ d3~32@)) (Sub a3~26@ (Mul b3~28@ c3~30@)))
                    ))
                    (=>
                     (= temp_3_1~805@ (Add (Mul (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ d3~32@)) (Add b3~28@
                         (Mul a3~26@ b3~28@)
                        )
                       ) (Mul (Sub a3~26@ (Mul b3~28@ c3~30@)) (Add (Mul b3~28@ d3~32@) (Add b3~28@ d3~32@)))
                     ))
                     (=>
                      ...
                      (and
                       ...
                       (=>
                        tmp%4@
                        (=>
                         (= temp_4_0~873@ (Mul (Mul (Sub (Mul b4~36@ a4~34@) (Add c4~38@ a4~34@)) (Add (Mul d4~40@
                              a4~34@
                             ) (Mul c4~38@ a4~34@)
                            )
                           ) (Sub a4~34@ (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@)))
                         ))
                         (=>
                          (= temp_4_1~926@ (Mul (Mul (Sub (Mul a4~34@ b4~36@) (Add c4~38@ a4~34@)) (Add (Mul d4~40@
                               a4~34@
                              ) (Mul c4~38@ a4~34@)
                             )
                            ) (Sub a4~34@ (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@)))
                          ...
                          (=>
                           (= tmp%5@ (= temp_4_0~873@ temp_4_1~926@))
                           (and
                            (=>
                             %%location_label%%4
                             tmp%5@
                            ...
                            (=>
                             tmp%5@
                             (=>
                              (= temp_5_0~1030@ (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@
                                   d5~48@
                                  ) (Add b5~44@ a5~42@)
                                 )
                                ) (Mul (Mul (Add 86 b5~44@) (Mul b5~44@ c5~46@)) (Sub (Mul b5~44@ c5~46@) (Mul 41 b5~44@)))
                              ))
                              (=>
                               (= temp_5_1~1119@ (Mul (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul
                                     b5~44@ d5~48@
                                    ) (Add b5~44@ a5~42@)
                                   )
                                  ) (Mul (Add 86 b5~44@) (Mul b5~44@ c5~46@))
                                 ) (Sub (Mul b5~44@ c5~46@) (Mul 41 b5~44@))
                               ))
                               (=>
                                (= tmp%6@ (= temp_5_0~1030@ temp_5_1~1119@))
                                (and
                                 (=>
                                  %%location_label%%5
                                  tmp%6@
                                 ...
                                 (=>
                                  tmp%6@
                                  (=>
                                   (= temp_6_0~1195@ (Add (Mul (Sub (Mul d6~56@ a6~50@) d6~56@) (Add (Mul d6~56@ d6~56@)
                                       (Mul b6~52@ b6~52@)
                                      )
                                     ) (Mul (Mul (Mul b6~52@ b6~52@) (Sub d6~56@ c6~54@)) (Sub (Mul a6~50@ a6~50@) (Mul a6~50@
                                        c6~54@
                                   )))))
                                   (=>
                                    (= temp_6_1~1272@ (Add (Sub (Mul (Mul d6~56@ a6~50@) (Add (Mul d6~56@ d6~56@) (Mul b6~52@
                                          b6~52@
                                        ))
                                       ) (Mul d6~56@ (Add (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@)))
                                      ) (Mul (Mul (Mul b6~52@ b6~52@) (Sub d6~56@ c6~54@)) (Sub (Mul a6~50@ a6~50@) (Mul a6~50@
                                         c6~54@
                                    )))))
                                    (=>
                                     (= tmp%7@ (= temp_6_0~1195@ temp_6_1~1272@))
                                     (and
                                      (=>
                                       %%location_label%%6
                                       tmp%7@
                                      ...
                                      (=>
                                       tmp%7@
                                       (=>
                                        (= temp_7_0~1376@ (Mul (Mul (Mul (Mul c7~62@ 10) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@
                                             d7~64@
                                            ) (Mul b7~60@ b7~60@)
                                           )
                                          ) (Mul (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ 57) (Mul d7~64@
                                             a7~58@
                                        )))))
                                        (=>
                                         (= temp_7_1~1465@ (Mul (Mul (Mul (Mul c7~62@ 10) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@
                                              d7~64@
                                             ) (Mul b7~60@ b7~60@)
                                            )
                                           ) (Mul (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ 57) (Mul d7~64@
                                              a7~58@
                                         )))))
                                         (=>
                                          (= tmp%8@ (= temp_7_0~1376@ temp_7_1~1465@))
                                          (=>
                                           %%location_label%%7
                                           tmp%8@
 ))))))))))))))))))))))))))))))))))))))))))
