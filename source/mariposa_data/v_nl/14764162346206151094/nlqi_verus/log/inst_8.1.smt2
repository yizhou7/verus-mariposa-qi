...
(set-info :comment ";; mariposa_data/v_nl//14764162346206151094/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ b0~4@) b0~4@)) (Mul (Mul (Mul d0~8@ a0~2@) (Add b0~4@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ b0~4@) b0~4@)) (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Add b0~4@ d0~8@)) (Mul b0~4@ d0~8@)) (Mul b0~4@ a0~2@)))) (and (=> (= tmp%1@ (Mul (Mul d0~8@ a0~2@) (Add b0~4@ d0~8@))) (=> (= tmp%2@ (Mul b0~4@ d0~8@)) (=> (= tmp%3@ (Mul b0~4@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@)))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~477@ (Add (Mul (Sub (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Add b1~12@ d1~16@))))) (=> (= temp_1_1~542@ (Add (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Sub (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Add b1~12@ d1~16@))))) (and (=> (= tmp%4@ (Sub (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@))) (=> (= tmp%5@ (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~477@ temp_1_1~542@))))) (=> (= temp_1_0~477@ temp_1_1~542@) (=> (= temp_2_0~671@ (Mul (Add (Mul (Mul d2~24@ b2~20@) (Add 80 b2~20@)) (Mul (Add d2~24@ d2~24@) (Add b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~748@ (Mul (Add (Mul (Mul b2~20@ d2~24@) (Add 80 b2~20@)) (Mul (Add d2~24@ d2~24@) (Add b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ b2~20@) (=> %%location_label%%2 (= temp_2_0~671@ temp_2_1~748@))) (=> (= temp_2_0~671@ temp_2_1~748@) (=> (= temp_3_0~833@ (Add (Mul (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ d3~32@)) (Add b3~28@ (Mul a3~26@ b3~28@))) (Mul (Add (Mul b3~28@ d3~32@) (Add b3~28@ d3~32@)) (Sub a3~26@ (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~890@ (Add (Mul (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ d3~32@)) (Add b3~28@ (Mul a3~26@ b3~28@))) (Mul (Sub a3~26@ (Mul b3~28@ c3~30@)) (Add (Mul b3~28@ d3~32@) (Add b3~28@ d3~32@))))) (and (=> (= tmp%6@ (Add (Mul b3~28@ d3~32@) (Add b3~28@ d3~32@))) (=> (= tmp%7@ (Sub a3~26@ (Mul b3~28@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~833@ temp_3_1~890@))))) (=> (= temp_3_0~833@ temp_3_1~890@) (=> (= temp_4_0~991@ (Mul (Mul (Sub (Mul b4~36@ a4~34@) (Add c4~38@ a4~34@)) (Add (Mul d4~40@ a4~34@) (Mul c4~38@ a4~34@))) (Sub a4~34@ (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~1044@ (Mul (Mul (Sub (Mul a4~34@ b4~36@) (Add c4~38@ a4~34@)) (Add (Mul d4~40@ a4~34@) (Mul c4~38@ a4~34@))) (Sub a4~34@ (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ a4~34@) (=> %%location_label%%4 (= temp_4_0~991@ temp_4_1~1044@))) (=> (= temp_4_0~991@ temp_4_1~1044@) (=> (= temp_5_0~1161@ (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Add b5~44@ a5~42@))) (Mul (Mul (Add 86 b5~44@) (Mul b5~44@ c5~46@)) (Sub (Mul b5~44@ c5~46@) (Mul 41 b5~44@))))) (=> (= temp_5_1~1250@ (Mul (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Add b5~44@ a5~42@))) (Mul (Add 86 b5~44@) (Mul b5~44@ c5~46@))) (Sub (Mul b5~44@ c5~46@) (Mul 41 b5~44@)))) (and (=> (= tmp%8@ (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Add b5~44@ a5~42@)))) (=> (= tmp%9@ (Mul (Add 86 b5~44@) (Mul b5~44@ c5~46@))) (=> (= tmp%10@ (Sub (Mul b5~44@ c5~46@) (Mul 41 b5~44@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%5 (= temp_5_0~1161@ temp_5_1~1250@)))))) (=> (= temp_5_0~1161@ temp_5_1~1250@) (=> (= temp_6_0~1417@ (Add (Mul (Sub (Mul d6~56@ a6~50@) d6~56@) (Add (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul b6~52@ b6~52@) (Sub d6~56@ c6~54@)) (Sub (Mul a6~50@ a6~50@) (Mul a6~50@ c6~54@))))) (=> (= temp_6_1~1494@ (Add (Sub (Mul (Mul d6~56@ a6~50@) (Add (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@))) (Mul d6~56@ (Add (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@)))) (Mul (Mul (Mul b6~52@ b6~52@) (Sub d6~56@ c6~54@)) (Sub (Mul a6~50@ a6~50@) (Mul a6~50@ c6~54@))))) (and (=> (= tmp%11@ (Mul d6~56@ a6~50@)) (=> (= tmp%12@ (Add (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ d6~56@ tmp%12@) (=> %%location_label%%6 (= temp_6_0~1417@ temp_6_1~1494@))))) (=> (= temp_6_0~1417@ temp_6_1~1494@) (=> (= temp_7_0~1629@ (Mul (Mul (Mul (Mul c7~62@ 10) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ 57) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1718@ (Mul (Mul (Mul (Mul c7~62@ 10) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ 57) (Mul d7~64@ a7~58@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1629@ temp_7_1~1718@))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
