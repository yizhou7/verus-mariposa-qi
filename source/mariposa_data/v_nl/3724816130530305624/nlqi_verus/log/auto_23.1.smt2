...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Sub (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ c0~6@))) (Add (Add (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Add (Add (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ c0~6@))) (Sub (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~451@ (Mul (Mul (Sub (Sub a1~10@ c1~14@) (Add a1~10@ a1~10@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul b1~12@ b1~12@) d1~16@) (Mul d1~16@ (Mul b1~12@ b1~12@))))) (=> (= temp_1_1~508@ (Mul (Mul (Sub (Sub a1~10@ c1~14@) (Add a1~10@ a1~10@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) d1~16@) (Mul d1~16@ (Mul b1~12@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~451@ temp_1_1~508@))) (=> (= temp_1_0~451@ temp_1_1~508@) (=> (= temp_2_0~597@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ a2~18@))) (Mul (Mul (Mul d2~24@ b2~20@) (Add d2~24@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@))))) (=> (= temp_2_1~662@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ a2~18@))) (Mul (Mul (Mul b2~20@ d2~24@) (Add d2~24@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~597@ temp_2_1~662@))) (=> (= temp_2_0~597@ temp_2_1~662@) (=> (= temp_3_0~723@ (Mul c3~30@ (Mul (Mul (Add b3~28@ d3~32@) (Mul b3~28@ a3~26@)) (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ a3~26@))))) (=> (= temp_3_1~768@ (Mul c3~30@ (Mul (Add (Mul b3~28@ (Mul b3~28@ a3~26@)) (Mul d3~32@ (Mul b3~28@ a3~26@))) (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~723@ temp_3_1~768@))) (=> (= temp_3_0~723@ temp_3_1~768@) (=> (= temp_4_0~865@ (Mul (Mul (Add (Add c4~38@ a4~34@) (Mul b4~36@ b4~36@)) (Mul (Mul a4~34@ 87) (Mul b4~36@ c4~38@))) (Mul (Mul (Sub d4~40@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ b4~36@) b4~36@)))) (=> (= temp_4_1~966@ (Mul (Add (Mul (Add c4~38@ a4~34@) (Mul (Mul a4~34@ 87) (Mul b4~36@ c4~38@))) (Mul (Mul b4~36@ b4~36@) (Mul (Mul a4~34@ 87) (Mul b4~36@ c4~38@)))) (Mul (Mul (Sub d4~40@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ b4~36@) b4~36@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~865@ temp_4_1~966@))) (=> (= temp_4_0~865@ temp_4_1~966@) (=> (= temp_5_0~1067@ (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Sub b5~44@ a5~42@)) (Sub (Mul b5~44@ d5~48@) (Sub b5~44@ c5~46@))) (Add (Add (Mul a5~42@ d5~48@) (Mul 69 b5~44@)) (Add (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1176@ (Add (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Sub b5~44@ a5~42@)) (Sub (Mul b5~44@ d5~48@) (Sub b5~44@ c5~46@))) (Add (Mul a5~42@ d5~48@) (Mul 69 b5~44@))) (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Sub b5~44@ a5~42@)) (Sub (Mul b5~44@ d5~48@) (Sub b5~44@ c5~46@))) (Add (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1067@ temp_5_1~1176@))) (=> (= temp_5_0~1067@ temp_5_1~1176@) (=> (= temp_6_0~1237@ (Mul (Mul a6~50@ d6~56@) (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@)) (Mul (Mul b6~52@ a6~50@) c6~54@)))) (=> (= temp_6_1~1274@ (Mul (Mul (Mul a6~50@ d6~56@) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Mul b6~52@ a6~50@) c6~54@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1237@ temp_6_1~1274@))) (=> (= temp_6_0~1237@ temp_6_1~1274@) (=> (= temp_7_0~1375@ (Mul (Mul (Sub (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul c7~62@ a7~58@) (Mul 79 b7~60@)) (Sub (Mul d7~64@ c7~62@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1452@ (Mul (Mul (Sub (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Mul a7~58@ b7~60@) (Mul b7~60@ a7~58@))) (Mul (Mul (Mul c7~62@ a7~58@) (Mul 79 b7~60@)) (Sub (Mul d7~64@ c7~62@) (Mul c7~62@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1375@ temp_7_1~1452@))) (=> (= temp_7_0~1375@ temp_7_1~1452@) (=> (= temp_8_0~1541@ (Mul (Sub (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ a8~66@)) (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul d8~72@ d8~72@) (Sub a8~66@ c8~70@)) (Mul (Sub a8~66@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1606@ (Mul (Mul (Sub (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ a8~66@)) (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ c8~70@))) (Mul (Mul d8~72@ d8~72@) (Sub a8~66@ c8~70@))) (Mul (Sub a8~66@ b8~68@) (Mul c8~70@ d8~72@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1541@ temp_8_1~1606@))) (=> (= temp_8_0~1541@ temp_8_1~1606@) (=> (= temp_9_0~1679@ (Sub (Mul (Mul (Sub b9~76@ a9~74@) (Mul c9~78@ d9~80@)) d9~80@) (Mul (Mul (Mul b9~76@ d9~80@) (Mul c9~78@ d9~80@)) (Mul b9~76@ (Sub a9~74@ b9~76@))))) (=> (= temp_9_1~1728@ (Sub (Mul (Mul (Sub b9~76@ a9~74@) (Mul c9~78@ d9~80@)) d9~80@) (Mul (Mul (Mul d9~80@ b9~76@) (Mul c9~78@ d9~80@)) (Mul b9~76@ (Sub a9~74@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1679@ temp_9_1~1728@))) (=> (= temp_9_0~1679@ temp_9_1~1728@) (=> (= temp_10_0~1809@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) a10~82@) (Mul (Mul a10~82@ a10~82@) (Sub c10~86@ a10~82@))) (Mul (Mul (Mul d10~88@ a10~82@) (Sub c10~86@ b10~84@)) (Mul b10~84@ (Add c10~86@ d10~88@))))) (=> (= temp_10_1~1866@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) a10~82@) (Mul (Mul a10~82@ a10~82@) (Sub c10~86@ a10~82@))) (Mul (Mul (Mul d10~88@ a10~82@) (Sub c10~86@ b10~84@)) (Mul (Add c10~86@ d10~88@) b10~84@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1809@ temp_10_1~1866@))) (=> (= temp_10_0~1809@ temp_10_1~1866@) (=> (= temp_11_0~1951@ (Mul (Mul (Add c11~94@ (Mul d11~96@ c11~94@)) (Mul (Sub a11~90@ d11~96@) (Add b11~92@ d11~96@))) (Mul (Mul (Mul c11~94@ b11~92@) (Sub c11~94@ c11~94@)) (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~2012@ (Mul (Mul (Add c11~94@ (Mul d11~96@ c11~94@)) (Mul (Sub a11~90@ d11~96@) (Add b11~92@ d11~96@))) (Mul (Mul c11~94@ (Mul b11~92@ (Sub c11~94@ c11~94@))) (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1951@ temp_11_1~2012@))) (=> (= temp_11_0~1951@ temp_11_1~2012@) (=> (= temp_12_0~2109@ (Sub (Mul (Mul (Sub a12~98@ b12~100@) (Sub d12~104@ b12~100@)) (Mul (Mul b12~100@ b12~100@) (Mul a12~98@ c12~102@))) (Mul (Mul d12~104@ (Sub d12~104@ b12~100@)) (Mul (Mul 53 d12~104@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2182@ (Sub (Mul (Mul (Sub a12~98@ b12~100@) (Sub d12~104@ b12~100@)) (Mul (Mul b12~100@ b12~100@) (Mul a12~98@ c12~102@))) (Mul (Mul d12~104@ (Sub d12~104@ b12~100@)) (Mul (Mul a12~98@ c12~102@) (Mul 53 d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2109@ temp_12_1~2182@))) (=> (= temp_12_0~2109@ temp_12_1~2182@) (=> (= temp_13_0~2267@ (Mul (Add (Add (Mul d13~112@ c13~110@) (Mul b13~108@ d13~112@)) (Sub (Mul a13~106@ d13~112@) c13~110@)) (Sub (Mul (Mul b13~108@ c13~110@) (Mul c13~110@ b13~108@)) (Mul (Mul b13~108@ a13~106@) (Add c13~110@ a13~106@))))) (=> (= temp_13_1~2328@ (Mul (Add (Add (Mul d13~112@ c13~110@) (Mul b13~108@ d13~112@)) (Sub (Mul a13~106@ d13~112@) c13~110@)) (Sub (Mul (Mul (Mul b13~108@ c13~110@) c13~110@) b13~108@) (Mul (Mul b13~108@ a13~106@) (Add c13~110@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2267@ temp_13_1~2328@))) (=> (= temp_13_0~2267@ temp_13_1~2328@) (=> (= temp_14_0~2413@ (Mul (Mul (Mul (Mul d14~120@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Mul a14~114@ d14~120@) d14~120@)) (Sub (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ c14~118@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@))))) (=> (= temp_14_1~2474@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ a14~114@)) (Mul (Mul a14~114@ d14~120@) d14~120@)) (Sub (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ c14~118@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2413@ temp_14_1~2474@))) (=> (= temp_14_0~2413@ temp_14_1~2474@) (=> (= temp_15_0~2555@ (Mul (Mul (Sub (Add c15~126@ c15~126@) (Mul a15~122@ a15~122@)) (Mul (Mul a15~122@ b15~124@) (Mul a15~122@ a15~122@))) (Mul (Sub b15~124@ (Mul b15~124@ c15~126@)) (Mul d15~128@ (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~2612@ (Mul (Mul (Sub (Add c15~126@ c15~126@) (Mul a15~122@ a15~122@)) (Mul (Mul a15~122@ b15~124@) (Mul a15~122@ a15~122@))) (Mul (Mul d15~128@ (Mul a15~122@ c15~126@)) (Sub b15~124@ (Mul b15~124@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2555@ temp_15_1~2612@))) (=> (= temp_15_0~2555@ temp_15_1~2612@) (=> (= temp_16_0~2701@ (Mul (Sub (Mul (Mul c16~134@ 70) (Mul c16~134@ c16~134@)) c16~134@) (Mul (Mul (Mul b16~132@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul b16~132@ d16~136@) (Mul a16~130@ b16~132@))))) (=> (= temp_16_1~2766@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul b16~132@ d16~136@) (Mul a16~130@ b16~132@))) (Sub (Mul (Mul c16~134@ 70) (Mul c16~134@ c16~134@)) c16~134@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2701@ temp_16_1~2766@))) (=> (= temp_16_0~2701@ temp_16_1~2766@) (=> (= temp_17_0~2863@ (Add (Mul (Sub a17~138@ (Sub 93 d17~144@)) (Mul (Sub d17~144@ b17~140@) (Mul c17~142@ d17~144@))) (Mul (Mul (Mul c17~142@ d17~144@) (Mul d17~144@ a17~138@)) (Mul (Sub d17~144@ b17~140@) (Mul c17~142@ a17~138@))))) (=> (= temp_17_1~2936@ (Add (Mul (Sub a17~138@ (Sub 93 d17~144@)) (Mul (Sub d17~144@ b17~140@) (Mul c17~142@ d17~144@))) (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Mul d17~144@ a17~138@)) (Sub d17~144@ b17~140@)) (Mul c17~142@ a17~138@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2863@ temp_17_1~2936@))) (=> (= temp_17_0~2863@ temp_17_1~2936@) (=> (= temp_18_0~3037@ (Mul (Sub (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Mul c18~150@ d18~152@) (Mul c18~150@ 33))) (Mul (Mul (Mul b18~148@ d18~152@) (Mul b18~148@ d18~152@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ a18~146@))))) (=> (= temp_18_1~3114@ (Mul (Sub (Mul (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)) (Mul (Mul c18~150@ d18~152@) (Mul c18~150@ 33))) (Mul (Mul (Mul b18~148@ d18~152@) (Mul b18~148@ d18~152@)) (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3037@ temp_18_1~3114@))) (=> (= temp_18_0~3037@ temp_18_1~3114@) (=> (= temp_19_0~3199@ (Mul (Add (Mul (Mul d19~160@ c19~158@) (Mul a19~154@ b19~156@)) (Mul c19~158@ (Mul d19~160@ d19~160@))) (Mul (Sub (Mul a19~154@ d19~160@) (Mul c19~158@ d19~160@)) (Add (Mul c19~158@ b19~156@) (Sub c19~158@ d19~160@))))) (=> (= temp_19_1~3276@ (Mul (Add (Mul (Mul d19~160@ c19~158@) (Mul a19~154@ b19~156@)) (Mul c19~158@ (Mul d19~160@ d19~160@))) (Sub (Mul (Mul a19~154@ d19~160@) (Add (Mul c19~158@ b19~156@) (Sub c19~158@ d19~160@))) (Mul (Mul c19~158@ d19~160@) (Add (Mul c19~158@ b19~156@) (Sub c19~158@ d19~160@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3199@ temp_19_1~3276@))) (=> (= temp_19_0~3199@ temp_19_1~3276@) (=> (= temp_20_0~3353@ (Sub (Mul (Mul (Mul a20~162@ d20~168@) (Mul a20~162@ a20~162@)) c20~166@) (Mul (Mul (Mul d20~168@ a20~162@) (Mul d20~168@ c20~166@)) (Sub (Mul b20~164@ c20~166@) (Mul b20~164@ d20~168@))))) (=> (= temp_20_1~3406@ (Sub (Mul (Mul (Mul a20~162@ a20~162@) (Mul a20~162@ d20~168@)) c20~166@) (Mul (Mul (Mul d20~168@ a20~162@) (Mul d20~168@ c20~166@)) (Sub (Mul b20~164@ c20~166@) (Mul b20~164@ d20~168@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3353@ temp_20_1~3406@))) (=> (= temp_20_0~3353@ temp_20_1~3406@) (=> (= temp_21_0~3503@ (Mul (Add (Mul (Mul d21~176@ b21~172@) (Mul 92 c21~174@)) (Mul (Mul c21~174@ d21~176@) (Mul d21~176@ d21~176@))) (Add (Mul (Mul b21~172@ d21~176@) (Mul a21~170@ d21~176@)) (Mul c21~174@ (Mul a21~170@ c21~174@))))) (=> (= temp_21_1~3576@ (Mul (Add (Mul (Mul d21~176@ b21~172@) (Mul c21~174@ 92)) (Mul (Mul c21~174@ d21~176@) (Mul d21~176@ d21~176@))) (Add (Mul (Mul b21~172@ d21~176@) (Mul a21~170@ d21~176@)) (Mul c21~174@ (Mul a21~170@ c21~174@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3503@ temp_21_1~3576@))) (=> (= temp_21_0~3503@ temp_21_1~3576@) (=> (= temp_22_0~3661@ (Mul (Mul (Mul (Add a22~178@ b22~180@) (Mul c22~182@ b22~180@)) (Mul (Mul d22~184@ a22~178@) (Mul a22~178@ d22~184@))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul b22~180@ d22~184@)) (Mul c22~182@ (Add c22~182@ b22~180@))))) (=> (= temp_22_1~3722@ (Mul (Mul (Mul (Add a22~178@ b22~180@) (Mul c22~182@ b22~180@)) (Mul d22~184@ (Mul a22~178@ (Mul a22~178@ d22~184@)))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul b22~180@ d22~184@)) (Mul c22~182@ (Add c22~182@ b22~180@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3661@ temp_22_1~3722@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
