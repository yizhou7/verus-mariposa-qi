...
(push)
 ...
 (declare-const temp_7_1~1600@ Int)
 (declare-const temp_8_0~1701@ Int)
 (declare-const temp_8_1~1778@ Int)
 (declare-const temp_9_0~1867@ Int)
 (declare-const temp_9_1~1932@ Int)
 (declare-const temp_10_0~2021@ Int)
 (declare-const temp_10_1~2086@ Int)
 (declare-const temp_11_0~2175@ Int)
 (declare-const temp_11_1~2240@ Int)
 (declare-const temp_12_0~2317@ Int)
 (declare-const temp_12_1~2370@ Int)
 (declare-const temp_13_0~2459@ Int)
 (declare-const temp_13_1~2524@ Int)
 (declare-const temp_14_0~2637@ Int)
 (declare-const temp_14_1~2726@ Int)
 (declare-const temp_15_0~2815@ Int)
 (declare-const temp_15_1~2880@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~329@ temp_0_1~418@)
        (=>
         (= temp_1_0~507@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@
              a1~10@
             ) (Mul b1~12@ d1~16@)
            )
         ...
         (=>
          (= temp_1_1~572@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@
               a1~10@
              ) (Mul b1~12@ d1~16@)
             )
          ...
          (and
           ...
           (=>
            (= temp_1_0~507@ temp_1_1~572@)
            (=>
             (= temp_2_0~653@ (Add (Mul (Mul (Mul b2~20@ a2~18@) (Sub b2~20@ d2~24@)) (Mul (Mul a2~18@
                  d2~24@
                 ) d2~24@
                )
             ...
             (=>
              (= temp_2_1~710@ (Add (Mul (Mul (Mul b2~20@ a2~18@) (Sub b2~20@ d2~24@)) (Mul (Mul a2~18@
                   d2~24@
                  ) d2~24@
                 )
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~653@ temp_2_1~710@)
               ))
               (=>
                (= temp_2_0~653@ temp_2_1~710@)
                (=>
                 (= temp_3_0~807@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Sub a3~26@ a3~26@)) (Add (Mul d3~32@
                      a3~26@
                     ) (Mul c3~30@ b3~28@)
                    )
                 ...
                 (=>
                  (= temp_3_1~880@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Sub a3~26@ a3~26@)) (Add (Mul d3~32@
                       a3~26@
                      ) (Mul b3~28@ c3~30@)
                     )
                    ) (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Sub b3~28@ 38) b3~28@))
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~807@ temp_3_1~880@)
                   ))
                   (=>
                    (= temp_3_0~807@ temp_3_1~880@)
                    (=>
                     (= temp_4_0~969@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul a4~34@
                          c4~38@
                         ) (Mul a4~34@ d4~40@)
                        )
                     ...
                     (=>
                      (= temp_4_1~1034@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul a4~34@
                           c4~38@
                          ) (Mul d4~40@ a4~34@)
                         )
                        ) (Mul (Mul (Add b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Add (Mul a4~34@ d4~40@) (Mul b4~36@
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~969@ temp_4_1~1034@)
                        (=>
                         (= temp_5_0~1123@ (Mul (Add (Mul (Mul d5~48@ b5~44@) (Add c5~46@ c5~46@)) (Add (Mul c5~46@
                              b5~44@
                             ) (Add d5~48@ a5~42@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1188@ (Mul (Add (Mul (Mul d5~48@ b5~44@) (Add c5~46@ c5~46@)) (Add (Mul c5~46@
                               b5~44@
                              ) (Add d5~48@ a5~42@)
                             )
                          ...
                          (and
                           ...
                           (=>
                            (= temp_5_0~1123@ temp_5_1~1188@)
                            (=>
                             (= temp_6_0~1277@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@
                                  c6~54@
                                 ) (Mul a6~50@ d6~56@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1342@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@
                                   c6~54@
                                  ) (Mul a6~50@ d6~56@)
                                 )
                                ) (Mul (Sub (Add c6~54@ d6~56@) (Sub d6~56@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul c6~54@
                              ...
                              (and
                               ...
                               (=>
                                (= temp_6_0~1277@ temp_6_1~1342@)
                                (=>
                                 (= temp_7_0~1455@ (Mul (Add (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ b7~60@)) (Add (Mul d7~64@
                                      d7~64@
                                     ) (Mul b7~60@ d7~64@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1600@ (Add (Mul (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Mul (Mul
                                        d7~64@ a7~58@
                                       ) (Mul b7~60@ 96)
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1455@ temp_7_1~1600@)
                                   ))
                                   (=>
                                    (= temp_7_0~1455@ temp_7_1~1600@)
                                    (=>
                                     (= temp_8_0~1701@ (Mul (Mul (Mul (Add b8~68@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul c8~70@
                                          c8~70@
                                         ) (Mul d8~72@ c8~70@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1778@ (Mul (Mul (Mul (Add b8~68@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul c8~70@
                                           c8~70@
                                          ) (Mul d8~72@ c8~70@)
                                         )
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1701@ temp_8_1~1778@)
                                       ))
                                       (=>
                                        (= temp_8_0~1701@ temp_8_1~1778@)
                                        (=>
                                         (= temp_9_0~1867@ (Mul (Add (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Add a9~74@
                                              b9~76@
                                             ) (Mul d9~80@ a9~74@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1932@ (Mul (Add (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Add a9~74@
                                               b9~76@
                                              ) (Mul d9~80@ a9~74@)
                                             )
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1867@ temp_9_1~1932@)
                                           ))
                                           (=>
                                            (= temp_9_0~1867@ temp_9_1~1932@)
                                            (=>
                                             (= temp_10_0~2021@ (Mul (Mul (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ c10~86@)) (Mul (
                                                  Mul d10~88@ d10~88@
                                                 ) (Mul c10~86@ c10~86@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~2086@ (Mul (Mul (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ c10~86@)) (Mul (
                                                   Mul d10~88@ d10~88@
                                                  ) (Mul c10~86@ c10~86@)
                                                 )
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~2021@ temp_10_1~2086@)
                                               ))
                                               (=>
                                                (= temp_10_0~2021@ temp_10_1~2086@)
                                                (=>
                                                 (= temp_11_0~2175@ (Mul (Mul (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (
                                                      Mul d11~96@ b11~92@
                                                     ) (Mul a11~90@ d11~96@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2240@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ b11~92@)) (Mul (
                                                       Mul d11~96@ b11~92@
                                                      ) (Mul a11~90@ d11~96@)
                                                     )
                                                    ) (Mul (Sub (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)) (Mul (Mul c11~94@ a11~90@)
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~2175@ temp_11_1~2240@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~2175@ temp_11_1~2240@)
                                                    (=>
                                                     (= temp_12_0~2317@ (Sub (Mul (Sub (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@)) c12~102@)
                                                       (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ a12~98@)) (Mul (Sub b12~100@ a12~98@)
                                                         (Mul b12~100@ a12~98@)
                                                     ))))
                                                     (=>
                                                      (= temp_12_1~2370@ (Sub (Mul (Sub (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@)) c12~102@)
                                                        (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ a12~98@)) (Mul (Sub b12~100@ a12~98@)
                                                          (Mul a12~98@ b12~100@)
                                                      ))))
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2317@ temp_12_1~2370@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2317@ temp_12_1~2370@)
                                                        (=>
                                                         (= temp_13_0~2459@ (Mul (Mul (Sub (Mul b13~108@ b13~108@) (Mul d13~112@ a13~106@)) (
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2524@ (Mul (Mul (Sub (Mul b13~108@ b13~108@) (Mul d13~112@ a13~106@)) (
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2459@ temp_13_1~2524@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2459@ temp_13_1~2524@)
                                                            (=>
                                                             (= temp_14_0~2637@ (Mul (Mul (Mul (Sub d14~120@ 28) (Sub d14~120@ d14~120@)) (Mul (Mul
                                                                  b14~116@ d14~120@
                                                                 ) (Mul a14~114@ 56)
                                                                )
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2726@ (Mul (Mul (Mul (Sub d14~120@ 28) (Sub d14~120@ d14~120@)) (Mul (Mul
                                                                   d14~120@ b14~116@
                                                                  ) (Mul a14~114@ 56)
                                                                 )
                                                                ) (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ c14~118@)) (Add (Mul b14~116@ b14~116@)
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2637@ temp_14_1~2726@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2637@ temp_14_1~2726@)
                                                                (=>
                                                                 (= temp_15_0~2815@ (Add (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2880@ (Add (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (
                                                                      Mul (Mul b15~124@ d15~128@) (Sub c15~126@ c15~126@)
                                                                     )
