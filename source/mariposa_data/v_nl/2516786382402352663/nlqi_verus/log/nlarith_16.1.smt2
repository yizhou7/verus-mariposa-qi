...
(assert (=> %%query%% (not (=> (= temp_0_0~329@ (Add (Add (Mul (Sub 77 c0~6@) (Sub b0~4@ 41)) (Add (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@))) (Add (Mul (Mul b0~4@ b0~4@) (Sub c0~6@ a0~2@)) (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ a0~2@))))) (=> (= temp_0_1~418@ (Add (Add (Mul (Sub 77 c0~6@) (Sub b0~4@ 41)) (Add (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@))) (Add (Mul (Mul b0~4@ b0~4@) (Sub c0~6@ a0~2@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~329@ temp_0_1~418@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~498@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~563@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~498@ temp_1_1~563@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~635@ (Add (Mul (Mul (Mul b2~20@ a2~18@) (Sub b2~20@ d2~24@)) (Mul (Mul a2~18@ d2~24@) d2~24@)) (Mul (Add (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@)) (Add a2~18@ (Mul a2~18@ b2~20@))))) (=> (= temp_2_1~692@ (Add (Mul (Mul (Mul b2~20@ a2~18@) (Sub b2~20@ d2~24@)) (Mul (Mul a2~18@ d2~24@) d2~24@)) (Mul (Add a2~18@ (Mul a2~18@ b2~20@)) (Add (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~635@ temp_2_1~692@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~780@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Sub a3~26@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Sub b3~28@ 38) b3~28@)))) (=> (= temp_3_1~853@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Sub a3~26@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Sub b3~28@ 38) b3~28@)))) (=> (= tmp%4@ (= temp_3_0~780@ temp_3_1~853@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~933@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ d4~40@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Add (Mul a4~34@ d4~40@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~998@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Add (Mul a4~34@ d4~40@) (Mul b4~36@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~933@ temp_4_1~998@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1078@ (Mul (Add (Mul (Mul d5~48@ b5~44@) (Add c5~46@ c5~46@)) (Add (Mul c5~46@ b5~44@) (Add d5~48@ a5~42@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1143@ (Mul (Add (Mul (Mul d5~48@ b5~44@) (Add c5~46@ c5~46@)) (Add (Mul c5~46@ b5~44@) (Add d5~48@ a5~42@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ a5~42@)) (Sub (Mul b5~44@ c5~46@) (Mul a5~42@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1078@ temp_5_1~1143@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1223@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ d6~56@))) (Mul (Sub (Add c6~54@ d6~56@) (Sub d6~56@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1288@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ d6~56@))) (Mul (Sub (Add c6~54@ d6~56@) (Sub d6~56@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1223@ temp_6_1~1288@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1392@ (Mul (Add (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ b7~60@)) (Add (Mul d7~64@ d7~64@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ 96)) (Mul (Mul 65 d7~64@) (Mul c7~62@ c7~62@))))) (=> (= temp_7_1~1537@ (Add (Mul (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ 96)) (Mul (Mul 65 d7~64@) (Mul c7~62@ c7~62@)))) (Mul (Add (Mul d7~64@ d7~64@) (Mul b7~60@ d7~64@)) (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ 96)) (Mul (Mul 65 d7~64@) (Mul c7~62@ c7~62@)))))) (=> (= tmp%8@ (= temp_7_0~1392@ temp_7_1~1537@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1629@ (Mul (Mul (Mul (Add b8~68@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Sub (Add (Mul c8~70@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ 64))))) (=> (= temp_8_1~1706@ (Mul (Mul (Mul (Add b8~68@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Sub (Add (Mul c8~70@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ 64) (Mul d8~72@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1629@ temp_8_1~1706@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1786@ (Mul (Add (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Add a9~74@ b9~76@) (Mul d9~80@ a9~74@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~1851@ (Mul (Add (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Add a9~74@ b9~76@) (Mul d9~80@ a9~74@))) (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ b9~76@)) (Mul d9~80@ c9~78@)) (Mul d9~80@ a9~74@)))) (=> (= tmp%10@ (= temp_9_0~1786@ temp_9_1~1851@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1931@ (Mul (Mul (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ b10~84@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~1996@ (Mul (Mul (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ a10~82@)) (Mul (Mul b10~84@ a10~82@) (Mul c10~86@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1931@ temp_10_1~1996@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~2076@ (Mul (Mul (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Sub (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)) (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ a11~90@))))) (=> (= temp_11_1~2141@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Sub (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)) (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~2076@ temp_11_1~2141@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2209@ (Sub (Mul (Sub (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@)) c12~102@) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ a12~98@)) (Mul (Sub b12~100@ a12~98@) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2262@ (Sub (Mul (Sub (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@)) c12~102@) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ a12~98@)) (Mul (Sub b12~100@ a12~98@) (Mul a12~98@ b12~100@))))) (=> (= tmp%13@ (= temp_12_0~2209@ temp_12_1~2262@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2342@ (Mul (Mul (Sub (Mul b13~108@ b13~108@) (Mul d13~112@ a13~106@)) (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ a13~106@))) (Add (Mul (Mul a13~106@ d13~112@) (Mul c13~110@ b13~108@)) (Mul (Mul a13~106@ a13~106@) (Mul c13~110@ c13~110@))))) (=> (= temp_13_1~2407@ (Mul (Mul (Sub (Mul b13~108@ b13~108@) (Mul d13~112@ a13~106@)) (Mul (Mul a13~106@ d13~112@) (Mul a13~106@ d13~112@))) (Add (Mul (Mul a13~106@ d13~112@) (Mul c13~110@ b13~108@)) (Mul (Mul a13~106@ a13~106@) (Mul c13~110@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2342@ temp_13_1~2407@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2511@ (Mul (Mul (Mul (Sub d14~120@ 28) (Sub d14~120@ d14~120@)) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ 56))) (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ c14~118@)) (Add (Mul b14~116@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2600@ (Mul (Mul (Mul (Sub d14~120@ 28) (Sub d14~120@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ 56))) (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ c14~118@)) (Add (Mul b14~116@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2511@ temp_14_1~2600@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2680@ (Add (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul b15~124@ d15~128@) (Sub c15~126@ c15~126@))) (Mul (Mul (Mul d15~128@ d15~128@) (Sub b15~124@ c15~126@)) (Mul (Mul c15~126@ a15~122@) (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~2745@ (Add (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul b15~124@ d15~128@) (Sub c15~126@ c15~126@))) (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Sub b15~124@ c15~126@)) (Mul c15~126@ a15~122@)) (Mul a15~122@ c15~126@)))) (=> (= tmp%16@ (= temp_15_0~2680@ temp_15_1~2745@)) (=> %%location_label%%15 tmp%16@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
