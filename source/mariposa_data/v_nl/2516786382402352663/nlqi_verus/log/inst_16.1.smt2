...
(set-info :comment ";; mariposa_data/v_nl//2516786382402352663/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_4_0~1005@ Int)
...
(declare-const temp_10_0~2225@ Int)
(declare-const temp_10_1~2290@ Int)
(declare-const temp_11_0~2383@ Int)
(declare-const temp_11_1~2448@ Int)
(declare-const temp_12_0~2537@ Int)
(declare-const temp_12_1~2590@ Int)
(declare-const temp_13_0~2683@ Int)
(declare-const temp_13_1~2748@ Int)
(declare-const temp_14_0~2865@ Int)
(declare-const temp_14_1~2954@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~329@ (Add (Add (Mul (Sub 77 c0~6@) (Sub b0~4@ 41)) (Add (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@))) (Add (Mul (Mul b0~4@ b0~4@) (Sub c0~6@ a0~2@)) (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ a0~2@))))) (=> (= temp_0_1~418@ (Add (Add (Mul (Sub 77 c0~6@) (Sub b0~4@ 41)) (Add (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@))) (Add (Mul (Mul b0~4@ b0~4@) (Sub c0~6@ a0~2@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ a0~2@) (=> %%location_label%%0 (= temp_0_0~329@ temp_0_1~418@))) (=> (= temp_0_0~329@ temp_0_1~418@) (=> (= temp_1_0~511@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~576@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ b1~12@) (=> %%location_label%%1 (= temp_1_0~511@ temp_1_1~576@))) (=> (= temp_1_0~511@ temp_1_1~576@) (=> (= temp_2_0~661@ (Add (Mul (Mul (Mul b2~20@ a2~18@) (Sub b2~20@ d2~24@)) (Mul (Mul a2~18@ d2~24@) d2~24@)) (Mul (Add (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@)) (Add a2~18@ (Mul a2~18@ b2~20@))))) (=> (= temp_2_1~718@ (Add (Mul (Mul (Mul b2~20@ a2~18@) (Sub b2~20@ d2~24@)) (Mul (Mul a2~18@ d2~24@) d2~24@)) (Mul (Add a2~18@ (Mul a2~18@ b2~20@)) (Add (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@))))) (and (=> (= tmp%1@ (Add (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@))) (=> (= tmp%2@ (Add a2~18@ (Mul a2~18@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~661@ temp_2_1~718@))))) (=> (= temp_2_0~661@ temp_2_1~718@) (=> (= temp_3_0~839@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Sub a3~26@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Sub b3~28@ 38) b3~28@)))) (=> (= temp_3_1~912@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Sub a3~26@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Sub b3~28@ 38) b3~28@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ b3~28@) (=> %%location_label%%3 (= temp_3_0~839@ temp_3_1~912@))) (=> (= temp_3_0~839@ temp_3_1~912@) (=> (= temp_4_0~1005@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ d4~40@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Add (Mul a4~34@ d4~40@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~1070@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Add (Mul a4~34@ d4~40@) (Mul b4~36@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ d4~40@) (=> %%location_label%%4 (= temp_4_0~1005@ temp_4_1~1070@))) (=> (= temp_4_0~1005@ temp_4_1~1070@) (=> (= temp_5_0~1163@ (Mul (Add (Mul (Mul d5~48@ b5~44@) (Add c5~46@ c5~46@)) (Add (Mul c5~46@ b5~44@) (Add d5~48@ a5~42@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1228@ (Mul (Add (Mul (Mul d5~48@ b5~44@) (Add c5~46@ c5~46@)) (Add (Mul c5~46@ b5~44@) (Add d5~48@ a5~42@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ a5~42@)) (Sub (Mul b5~44@ c5~46@) (Mul a5~42@ b5~44@))))) (and (=> (= tmp%3@ (Sub (Mul b5~44@ c5~46@) (Mul a5~42@ b5~44@))) (=> (= tmp%4@ (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%5 (= temp_5_0~1163@ temp_5_1~1228@))))) (=> (= temp_5_0~1163@ temp_5_1~1228@) (=> (= temp_6_0~1345@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ d6~56@))) (Mul (Sub (Add c6~54@ d6~56@) (Sub d6~56@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1410@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ d6~56@))) (Mul (Sub (Add c6~54@ d6~56@) (Sub d6~56@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1345@ temp_6_1~1410@))) (=> (= temp_6_0~1345@ temp_6_1~1410@) (=> (= temp_7_0~1527@ (Mul (Add (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ b7~60@)) (Add (Mul d7~64@ d7~64@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ 96)) (Mul (Mul 65 d7~64@) (Mul c7~62@ c7~62@))))) (=> (= temp_7_1~1672@ (Add (Mul (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ 96)) (Mul (Mul 65 d7~64@) (Mul c7~62@ c7~62@)))) (Mul (Add (Mul d7~64@ d7~64@) (Mul b7~60@ d7~64@)) (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ 96)) (Mul (Mul 65 d7~64@) (Mul c7~62@ c7~62@)))))) (and (=> (= tmp%5@ (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ b7~60@))) (=> (= tmp%6@ (Add (Mul d7~64@ d7~64@) (Mul b7~60@ d7~64@))) (=> (= tmp%7@ (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ 96)) (Mul (Mul 65 d7~64@) (Mul c7~62@ c7~62@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%7 (= temp_7_0~1527@ temp_7_1~1672@)))))) (=> (= temp_7_0~1527@ temp_7_1~1672@) (=> (= temp_8_0~1855@ (Mul (Mul (Mul (Add b8~68@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Sub (Add (Mul c8~70@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ 64))))) (=> (= temp_8_1~1932@ (Mul (Mul (Mul (Add b8~68@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Sub (Add (Mul c8~70@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ 64) (Mul d8~72@ a8~66@))))) (and (=> (= tmp%8@ (Mul d8~72@ a8~66@)) (=> (= tmp%9@ (Mul a8~66@ 64)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%8 (= temp_8_0~1855@ temp_8_1~1932@))))) (=> (= temp_8_0~1855@ temp_8_1~1932@) (=> (= temp_9_0~2045@ (Mul (Add (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Add a9~74@ b9~76@) (Mul d9~80@ a9~74@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~2110@ (Mul (Add (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Add a9~74@ b9~76@) (Mul d9~80@ a9~74@))) (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ b9~76@)) (Mul d9~80@ c9~78@)) (Mul d9~80@ a9~74@)))) (and (=> (= tmp%10@ (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ b9~76@))) (=> (= tmp%11@ (Mul d9~80@ c9~78@)) (=> (= tmp%12@ (Mul d9~80@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%9 (= temp_9_0~2045@ temp_9_1~2110@)))))) (=> (= temp_9_0~2045@ temp_9_1~2110@) (=> (= temp_10_0~2225@ (Mul (Mul (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ b10~84@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~2290@ (Mul (Mul (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ a10~82@)) (Mul (Mul b10~84@ a10~82@) (Mul c10~86@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a10~82@ b10~84@) (=> %%location_label%%10 (= temp_10_0~2225@ temp_10_1~2290@))) (=> (= temp_10_0~2225@ temp_10_1~2290@) (=> (= temp_11_0~2383@ (Mul (Mul (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Sub (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)) (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ a11~90@))))) (=> (= temp_11_1~2448@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Sub (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)) (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ a11~90@))))) (and (=> (= tmp%13@ (Mul a11~90@ b11~92@)) (=> (= tmp%14@ (Mul a11~90@ a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%11 (= temp_11_0~2383@ temp_11_1~2448@))))) (=> (= temp_11_0~2383@ temp_11_1~2448@) (=> (= temp_12_0~2537@ (Sub (Mul (Sub (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@)) c12~102@) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ a12~98@)) (Mul (Sub b12~100@ a12~98@) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2590@ (Sub (Mul (Sub (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@)) c12~102@) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ a12~98@)) (Mul (Sub b12~100@ a12~98@) (Mul a12~98@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2537@ temp_12_1~2590@))) (=> (= temp_12_0~2537@ temp_12_1~2590@) (=> (= temp_13_0~2683@ (Mul (Mul (Sub (Mul b13~108@ b13~108@) (Mul d13~112@ a13~106@)) (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ a13~106@))) (Add (Mul (Mul a13~106@ d13~112@) (Mul c13~110@ b13~108@)) (Mul (Mul a13~106@ a13~106@) (Mul c13~110@ c13~110@))))) (=> (= temp_13_1~2748@ (Mul (Mul (Sub (Mul b13~108@ b13~108@) (Mul d13~112@ a13~106@)) (Mul (Mul a13~106@ d13~112@) (Mul a13~106@ d13~112@))) (Add (Mul (Mul a13~106@ d13~112@) (Mul c13~110@ b13~108@)) (Mul (Mul a13~106@ a13~106@) (Mul c13~110@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d13~112@ a13~106@) (=> %%location_label%%13 (= temp_13_0~2683@ temp_13_1~2748@))) (=> (= temp_13_0~2683@ temp_13_1~2748@) (=> (= temp_14_0~2865@ (Mul (Mul (Mul (Sub d14~120@ 28) (Sub d14~120@ d14~120@)) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ 56))) (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ c14~118@)) (Add (Mul b14~116@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2954@ (Mul (Mul (Mul (Sub d14~120@ 28) (Sub d14~120@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ 56))) (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ c14~118@)) (Add (Mul b14~116@ b14~116@) (Mul b14~116@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b14~116@ d14~120@) (=> %%location_label%%14 (= temp_14_0~2865@ temp_14_1~2954@))) (=> (= temp_14_0~2865@ temp_14_1~2954@) (=> (= temp_15_0~3047@ (Add (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul b15~124@ d15~128@) (Sub c15~126@ c15~126@))) (Mul (Mul (Mul d15~128@ d15~128@) (Sub b15~124@ c15~126@)) (Mul (Mul c15~126@ a15~122@) (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~3112@ (Add (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul b15~124@ d15~128@) (Sub c15~126@ c15~126@))) (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Sub b15~124@ c15~126@)) (Mul c15~126@ a15~122@)) (Mul a15~122@ c15~126@)))) (=> (= tmp%15@ (Mul (Mul d15~128@ d15~128@) (Sub b15~124@ c15~126@))) (=> (= tmp%16@ (Mul c15~126@ a15~122@)) (=> (= tmp%17@ (Mul a15~122@ c15~126@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%15 (= temp_15_0~3047@ temp_15_1~3112@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
