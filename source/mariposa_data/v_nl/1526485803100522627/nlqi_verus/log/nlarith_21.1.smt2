...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ c0~6@))) (Mul (Mul d0~8@ (Mul b0~4@ c0~6@)) (Mul (Mul 81 a0~2@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~386@ (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ c0~6@)) (Mul (Mul d0~8@ (Mul b0~4@ c0~6@)) (Mul (Mul 81 a0~2@) (Mul a0~2@ c0~6@)))))) (=> (= tmp%1@ (= temp_0_0~313@ temp_0_1~386@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~442@ (Mul (Mul c1~14@ (Mul b1~12@ (Mul a1~10@ a1~10@))) (Mul (Sub d1~16@ (Mul a1~10@ d1~16@)) (Mul a1~10@ (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~483@ (Mul (Mul (Sub d1~16@ (Mul a1~10@ d1~16@)) (Mul a1~10@ (Mul c1~14@ a1~10@))) (Mul c1~14@ (Mul b1~12@ (Mul a1~10@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~442@ temp_1_1~483@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~559@ (Mul (Mul (Mul (Sub a2~18@ d2~24@) (Sub c2~22@ c2~22@)) (Mul c2~22@ (Add d2~24@ b2~20@))) (Mul (Mul (Mul d2~24@ a2~18@) (Add a2~18@ c2~22@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~620@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Add a2~18@ c2~22@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul (Sub a2~18@ d2~24@) (Sub c2~22@ c2~22@)) (Mul c2~22@ (Add d2~24@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~559@ temp_2_1~620@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~724@ (Sub (Mul (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Sub c3~30@ b3~28@) (Mul a3~26@ 50))) (Mul (Mul (Mul b3~28@ b3~28@) (Mul 81 d3~32@)) (Mul (Sub c3~30@ a3~26@) (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~813@ (Sub (Mul (Mul (Mul b3~28@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Sub c3~30@ b3~28@) (Mul a3~26@ 50))) (Mul (Mul (Mul b3~28@ b3~28@) (Mul 81 d3~32@)) (Mul (Sub c3~30@ a3~26@) (Mul c3~30@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~724@ temp_3_1~813@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~873@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) 91) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ a4~34@))) a4~34@)) (=> (= temp_4_1~918@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) 91) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ a4~34@))) a4~34@)) (=> (= tmp%5@ (= temp_4_0~873@ temp_4_1~918@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1006@ (Mul (Mul (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul 67 b5~44@) (Mul a5~42@ c5~46@)) (Add (Sub a5~42@ a5~42@) a5~42@)))) (=> (= temp_5_1~1079@ (Mul (Mul (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul 67 b5~44@) (Mul a5~42@ c5~46@)) (Add (Sub a5~42@ a5~42@) a5~42@)))) (=> (= tmp%6@ (= temp_5_0~1006@ temp_5_1~1079@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1159@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Add b6~52@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1224@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Add b6~52@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1159@ temp_6_1~1224@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1328@ (Add (Mul (Mul (Mul 46 b7~60@) (Sub 60 c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@))) (Mul (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1417@ (Add (Mul (Mul 46 (Mul b7~60@ (Sub 60 c7~62@))) (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@))) (Mul (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1328@ temp_7_1~1417@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1497@ (Mul (Sub (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ a8~66@)) (Add (Mul b8~68@ b8~68@) (Mul b8~68@ b8~68@))) (Mul (Mul (Add c8~70@ c8~70@) (Sub a8~66@ b8~68@)) (Add (Mul c8~70@ a8~66@) (Sub c8~70@ d8~72@))))) (=> (= temp_8_1~1562@ (Mul (Sub (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ a8~66@)) (Add (Mul b8~68@ b8~68@) (Mul b8~68@ b8~68@))) (Mul (Add c8~70@ c8~70@) (Mul (Sub a8~66@ b8~68@) (Add (Mul c8~70@ a8~66@) (Sub c8~70@ d8~72@)))))) (=> (= tmp%9@ (= temp_8_0~1497@ temp_8_1~1562@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1638@ (Mul (Add (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ d9~80@)) a9~74@) (Mul (Mul (Mul c9~78@ b9~76@) 92) (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~1699@ (Mul (Add (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ d9~80@)) a9~74@) (Mul (Mul (Mul (Mul c9~78@ b9~76@) 92) (Mul a9~74@ d9~80@)) (Mul b9~76@ d9~80@)))) (=> (= tmp%10@ (= temp_9_0~1638@ temp_9_1~1699@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1791@ (Mul (Sub (Sub (Mul c10~86@ d10~88@) (Mul d10~88@ b10~84@)) (Sub (Mul b10~84@ 4) (Mul d10~88@ b10~84@))) (Sub (Add (Add c10~86@ a10~82@) (Mul b10~84@ a10~82@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~1900@ (Sub (Mul (Sub (Mul c10~86@ d10~88@) (Mul d10~88@ b10~84@)) (Sub (Add (Add c10~86@ a10~82@) (Mul b10~84@ a10~82@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)))) (Mul (Sub (Mul b10~84@ 4) (Mul d10~88@ b10~84@)) (Sub (Add (Add c10~86@ a10~82@) (Mul b10~84@ a10~82@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)))))) (=> (= tmp%11@ (= temp_10_0~1791@ temp_10_1~1900@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1976@ (Mul (Mul (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ d11~96@)) (Add (Mul a11~90@ a11~90@) (Mul d11~96@ a11~90@))) (Mul (Sub (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ b11~92@) d11~96@)))) (=> (= temp_11_1~2037@ (Mul (Mul (Mul (Mul b11~92@ a11~90@) (Mul d11~96@ a11~90@)) (Add (Mul a11~90@ a11~90@) (Mul d11~96@ a11~90@))) (Mul (Sub (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ b11~92@) d11~96@)))) (=> (= tmp%12@ (= temp_11_0~1976@ temp_11_1~2037@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2117@ (Mul (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ c12~102@))) (Sub (Mul (Mul b12~100@ a12~98@) (Sub a12~98@ b12~100@)) (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@))))) (=> (= temp_12_1~2182@ (Mul (Mul (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ c12~102@))) (Sub (Mul (Mul b12~100@ a12~98@) (Sub a12~98@ b12~100@)) (Mul (Mul (Mul b12~100@ d12~104@) d12~104@) b12~100@)))) (=> (= tmp%13@ (= temp_12_0~2117@ temp_12_1~2182@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2270@ (Add (Add (Mul b13~108@ (Add b13~108@ b13~108@)) (Add (Mul c13~110@ a13~106@) (Mul b13~108@ a13~106@))) (Mul (Mul (Mul 64 b13~108@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ a13~106@) (Add a13~106@ d13~112@))))) (=> (= temp_13_1~2343@ (Add (Add (Mul b13~108@ (Add b13~108@ b13~108@)) (Add (Mul c13~110@ a13~106@) (Mul b13~108@ a13~106@))) (Mul (Mul (Mul 64 b13~108@) (Mul a13~106@ b13~108@)) (Mul b13~108@ (Mul a13~106@ (Add a13~106@ d13~112@)))))) (=> (= tmp%14@ (= temp_13_0~2270@ temp_13_1~2343@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2423@ (Mul (Mul (Mul (Sub c14~118@ c14~118@) (Add c14~118@ c14~118@)) (Mul (Mul c14~118@ a14~114@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul a14~114@ b14~116@) (Add d14~120@ b14~116@)) (Sub (Mul a14~114@ a14~114@) (Mul a14~114@ b14~116@))))) (=> (= temp_14_1~2488@ (Mul (Mul (Mul (Sub c14~118@ c14~118@) (Add c14~118@ c14~118@)) (Mul (Mul c14~118@ a14~114@) (Mul d14~120@ c14~118@))) (Mul (Mul (Add d14~120@ b14~116@) (Mul a14~114@ b14~116@)) (Sub (Mul a14~114@ a14~114@) (Mul a14~114@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2423@ temp_14_1~2488@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2536@ (Mul b15~124@ (Mul (Mul b15~124@ (Mul a15~122@ b15~124@)) (Sub (Mul a15~122@ d15~128@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2569@ (Mul (Mul b15~124@ (Mul b15~124@ (Mul a15~122@ b15~124@))) (Sub (Mul a15~122@ d15~128@) (Mul d15~128@ d15~128@)))) (=> (= tmp%16@ (= temp_15_0~2536@ temp_15_1~2569@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2649@ (Mul (Sub d16~136@ (Mul (Mul 26 b16~132@) (Sub b16~132@ b16~132@))) (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ d16~136@)) (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ a16~130@))))) (=> (= temp_16_1~2714@ (Mul (Sub d16~136@ (Mul (Mul 26 b16~132@) (Sub b16~132@ b16~132@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2649@ temp_16_1~2714@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2794@ (Add (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ d17~144@))) (Sub (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ c17~142@)) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ c17~142@))))) (=> (= temp_17_1~2859@ (Add (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ d17~144@))) (Sub (Mul (Mul (Mul b17~140@ a17~138@) a17~138@) c17~142@) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ c17~142@))))) (=> (= tmp%18@ (= temp_17_0~2794@ temp_17_1~2859@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2947@ (Mul (Add (Mul (Add 76 b18~148@) (Sub d18~152@ a18~146@)) (Sub (Mul a18~146@ b18~148@) (Mul d18~152@ a18~146@))) (Mul (Mul (Mul c18~150@ d18~152@) c18~150@) (Sub (Mul d18~152@ d18~152@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~3020@ (Mul (Add (Mul (Add 76 b18~148@) (Sub d18~152@ a18~146@)) (Sub (Mul a18~146@ b18~148@) (Mul d18~152@ a18~146@))) (Mul (Mul c18~150@ d18~152@) (Mul c18~150@ (Sub (Mul d18~152@ d18~152@) (Mul a18~146@ d18~152@)))))) (=> (= tmp%19@ (= temp_18_0~2947@ temp_18_1~3020@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3088@ (Mul (Mul (Add (Mul b19~156@ d19~160@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ a19~154@) (Mul b19~156@ c19~158@))) (Mul a19~154@ (Mul (Add d19~160@ b19~156@) (Mul d19~160@ a19~154@))))) (=> (= temp_19_1~3141@ (Mul (Mul (Mul (Add (Mul b19~156@ d19~160@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ a19~154@) (Mul b19~156@ c19~158@))) a19~154@) (Mul (Add d19~160@ b19~156@) (Mul d19~160@ a19~154@)))) (=> (= tmp%20@ (= temp_19_0~3088@ temp_19_1~3141@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3221@ (Mul (Sub (Mul (Mul d20~168@ b20~164@) (Add d20~168@ a20~162@)) (Mul (Mul a20~162@ b20~164@) (Mul d20~168@ b20~164@))) (Mul (Sub (Mul a20~162@ c20~166@) (Mul c20~166@ a20~162@)) (Mul (Mul d20~168@ b20~164@) (Mul b20~164@ b20~164@))))) (=> (= temp_20_1~3286@ (Mul (Sub (Mul (Mul d20~168@ b20~164@) (Add d20~168@ a20~162@)) (Mul (Mul a20~162@ b20~164@) (Mul d20~168@ b20~164@))) (Mul (Sub (Mul a20~162@ c20~166@) (Mul c20~166@ a20~162@)) (Mul (Mul b20~164@ d20~168@) (Mul b20~164@ b20~164@))))) (=> (= tmp%21@ (= temp_20_0~3221@ temp_20_1~3286@)) (=> %%location_label%%20 tmp%21@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
