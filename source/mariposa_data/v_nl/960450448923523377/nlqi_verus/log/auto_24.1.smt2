...
(assert (=> %%query%% (not (=> (= temp_0_0~285@ (Mul (Mul a0~2@ (Mul c0~6@ (Mul c0~6@ a0~2@))) (Mul (Sub (Mul c0~6@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ b0~4@) d0~8@)))) (=> (= temp_0_1~330@ (Mul (Mul a0~2@ (Mul (Mul c0~6@ a0~2@) c0~6@)) (Mul (Sub (Mul c0~6@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ b0~4@) d0~8@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~285@ temp_0_1~330@))) (=> (= temp_0_0~285@ temp_0_1~330@) (=> (= temp_1_0~427@ (Add (Mul (Mul d1~16@ (Add d1~16@ d1~16@)) (Add (Add b1~12@ d1~16@) (Sub d1~16@ 61))) (Mul (Mul (Add b1~12@ a1~10@) (Sub a1~10@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~500@ (Add (Mul (Mul (Add d1~16@ d1~16@) d1~16@) (Add (Add b1~12@ d1~16@) (Sub d1~16@ 61))) (Mul (Mul (Add b1~12@ a1~10@) (Sub a1~10@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~427@ temp_1_1~500@))) (=> (= temp_1_0~427@ temp_1_1~500@) (=> (= temp_2_0~577@ (Mul (Mul (Sub (Sub a2~18@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ c2~22@))) (Add a2~18@ (Mul (Mul a2~18@ c2~22@) (Sub c2~22@ b2~20@))))) (=> (= temp_2_1~638@ (Mul (Mul (Sub (Sub a2~18@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ c2~22@))) (Add a2~18@ (Sub (Mul (Mul a2~18@ c2~22@) c2~22@) (Mul (Mul a2~18@ c2~22@) b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~577@ temp_2_1~638@))) (=> (= temp_2_0~577@ temp_2_1~638@) (=> (= temp_3_0~739@ (Mul (Add (Sub (Mul c3~30@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Add a3~26@ 21))) (Mul (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ b3~28@) (Sub c3~30@ d3~32@))))) (=> (= temp_3_1~816@ (Mul (Add (Sub (Mul c3~30@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Add a3~26@ 21))) (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Mul c3~30@ b3~28@) (Sub c3~30@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~739@ temp_3_1~816@))) (=> (= temp_3_0~739@ temp_3_1~816@) (=> (= temp_4_0~905@ (Add (Sub (Mul (Add b4~36@ b4~36@) (Sub b4~36@ b4~36@)) (Mul (Mul a4~34@ c4~38@) (Add a4~34@ d4~40@))) (Sub (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Add d4~40@ b4~36@))))) (=> (= temp_4_1~978@ (Add (Sub (Mul (Add b4~36@ b4~36@) (Sub b4~36@ b4~36@)) (Add (Mul (Mul a4~34@ c4~38@) a4~34@) (Mul (Mul a4~34@ c4~38@) d4~40@))) (Sub (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Add d4~40@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~905@ temp_4_1~978@))) (=> (= temp_4_0~905@ temp_4_1~978@) (=> (= temp_5_0~1079@ (Mul (Mul (Add (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Add d5~48@ d5~48@))) (Mul (Add (Mul c5~46@ a5~42@) (Mul c5~46@ b5~44@)) (Mul (Mul 79 a5~42@) (Sub a5~42@ c5~46@))))) (=> (= temp_5_1~1164@ (Mul (Mul (Add (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Add (Mul (Mul d5~48@ a5~42@) d5~48@) (Mul (Mul d5~48@ a5~42@) d5~48@))) (Mul (Add (Mul c5~46@ a5~42@) (Mul c5~46@ b5~44@)) (Mul (Mul 79 a5~42@) (Sub a5~42@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1079@ temp_5_1~1164@))) (=> (= temp_5_0~1079@ temp_5_1~1164@) (=> (= temp_6_0~1265@ (Mul (Add (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ c6~54@))) (Mul (Mul (Add 57 b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ a6~50@))))) (=> (= temp_6_1~1342@ (Mul (Add (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul (Add 57 b6~52@) (Mul a6~50@ c6~54@)) (Mul d6~56@ b6~52@)) (Mul b6~52@ a6~50@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1265@ temp_6_1~1342@))) (=> (= temp_6_0~1265@ temp_6_1~1342@) (=> (= temp_7_0~1431@ (Mul (Sub (Sub (Add d7~64@ c7~62@) (Mul a7~58@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Add (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1528@ (Sub (Mul (Sub (Add d7~64@ c7~62@) (Mul a7~58@ d7~64@)) (Mul (Add (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@)))) (Mul (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Add (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1431@ temp_7_1~1528@))) (=> (= temp_7_0~1431@ temp_7_1~1528@) (=> (= temp_8_0~1613@ (Add (Add (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ a8~66@))) (Sub (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul d8~72@ b8~68@) c8~70@)))) (=> (= temp_8_1~1674@ (Add (Add (Mul (Mul (Mul c8~70@ b8~68@) a8~66@) d8~72@) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ a8~66@))) (Sub (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul d8~72@ b8~68@) c8~70@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1613@ temp_8_1~1674@))) (=> (= temp_8_0~1613@ temp_8_1~1674@) (=> (= temp_9_0~1763@ (Mul (Mul (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ a9~74@)) (Mul (Mul d9~80@ d9~80@) (Add c9~78@ a9~74@))) (Mul (Mul (Mul d9~80@ c9~78@) (Sub d9~80@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~1828@ (Mul (Mul (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ a9~74@)) (Mul (Mul d9~80@ d9~80@) (Add c9~78@ a9~74@))) (Mul (Mul (Mul d9~80@ c9~78@) (Sub d9~80@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1763@ temp_9_1~1828@))) (=> (= temp_9_0~1763@ temp_9_1~1828@) (=> (= temp_10_0~1917@ (Sub (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Sub d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul d10~88@ c10~86@) (Add d10~88@ a10~82@))))) (=> (= temp_10_1~1982@ (Sub (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Sub d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ d10~88@)) (Mul (Mul d10~88@ c10~86@) (Add d10~88@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1917@ temp_10_1~1982@))) (=> (= temp_10_0~1917@ temp_10_1~1982@) (=> (= temp_11_0~2083@ (Sub (Mul (Sub (Sub b11~92@ 8) (Sub a11~90@ a11~90@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ a11~90@))) (Mul b11~92@ (Mul (Mul b11~92@ b11~92@) (Mul b11~92@ 93))))) (=> (= temp_11_1~2160@ (Sub (Mul (Sub (Sub b11~92@ 8) (Sub a11~90@ a11~90@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ a11~90@))) (Mul b11~92@ (Mul (Mul b11~92@ b11~92@) (Mul b11~92@ 93))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2083@ temp_11_1~2160@))) (=> (= temp_11_0~2083@ temp_11_1~2160@) (=> (= temp_12_0~2245@ (Add (Mul (Add (Add d12~104@ a12~98@) b12~100@) (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@))) (Mul (Mul (Mul d12~104@ b12~100@) (Sub a12~98@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul b12~100@ d12~104@))))) (=> (= temp_12_1~2306@ (Add (Mul (Add (Add d12~104@ a12~98@) b12~100@) (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@))) (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Sub a12~98@ d12~104@)) (Mul a12~98@ b12~100@)) (Mul b12~100@ d12~104@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2245@ temp_12_1~2306@))) (=> (= temp_12_0~2245@ temp_12_1~2306@) (=> (= temp_13_0~2383@ (Mul (Mul (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ d13~112@)) (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ c13~110@))) (Mul a13~106@ (Mul (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))))) (=> (= temp_13_1~2436@ (Mul (Mul (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ d13~112@)) (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ b13~108@))) (Mul a13~106@ (Mul (Mul d13~112@ d13~112@) (Mul d13~112@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2383@ temp_13_1~2436@))) (=> (= temp_13_0~2383@ temp_13_1~2436@) (=> (= temp_14_0~2525@ (Mul (Mul (Mul (Sub a14~114@ d14~120@) (Mul c14~118@ d14~120@)) (Mul (Mul c14~118@ b14~116@) (Sub d14~120@ d14~120@))) (Mul (Sub (Mul b14~116@ a14~114@) (Mul a14~114@ a14~114@)) (Mul (Sub d14~120@ d14~120@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2590@ (Mul (Mul (Mul (Sub a14~114@ d14~120@) (Mul c14~118@ d14~120@)) (Mul (Mul c14~118@ b14~116@) (Sub d14~120@ d14~120@))) (Mul (Sub (Mul b14~116@ a14~114@) (Mul a14~114@ a14~114@)) (Mul (Sub d14~120@ d14~120@) (Mul c14~118@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2525@ temp_14_1~2590@))) (=> (= temp_14_0~2525@ temp_14_1~2590@) (=> (= temp_15_0~2699@ (Mul (Mul (Sub (Mul a15~122@ a15~122@) (Add c15~126@ d15~128@)) (Sub (Mul c15~126@ c15~126@) b15~124@)) (Mul (Mul (Mul a15~122@ 44) (Mul d15~128@ a15~122@)) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ 17))))) (=> (= temp_15_1~2784@ (Mul (Mul (Sub (Mul a15~122@ a15~122@) (Add c15~126@ d15~128@)) (Sub (Mul c15~126@ c15~126@) b15~124@)) (Mul (Mul a15~122@ (Mul 44 (Mul d15~128@ a15~122@))) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ 17))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2699@ temp_15_1~2784@))) (=> (= temp_15_0~2699@ temp_15_1~2784@) (=> (= temp_16_0~2849@ (Sub (Add (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ b16~132@)) d16~136@) (Mul b16~132@ (Mul (Mul c16~134@ b16~132@) (Mul a16~130@ c16~134@))))) (=> (= temp_16_1~2890@ (Sub (Add (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ b16~132@)) d16~136@) (Mul b16~132@ (Mul c16~134@ (Mul b16~132@ (Mul a16~130@ c16~134@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2849@ temp_16_1~2890@))) (=> (= temp_16_0~2849@ temp_16_1~2890@) (=> (= temp_17_0~2975@ (Mul (Mul (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ b17~140@)) (Mul (Mul c17~142@ c17~142@) b17~140@)) (Mul (Mul (Mul c17~142@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul d17~144@ d17~144@) (Add a17~138@ b17~140@))))) (=> (= temp_17_1~3036@ (Mul (Mul (Mul (Mul b17~140@ b17~140@) (Mul a17~138@ c17~142@)) (Mul (Mul c17~142@ c17~142@) b17~140@)) (Mul (Mul (Mul c17~142@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul d17~144@ d17~144@) (Add a17~138@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2975@ temp_17_1~3036@))) (=> (= temp_17_0~2975@ temp_17_1~3036@) (=> (= temp_18_0~3133@ (Mul (Sub (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ c18~150@)) (Mul (Sub a18~146@ 56) (Mul c18~150@ b18~148@))) (Mul (Mul c18~150@ (Mul b18~148@ a18~146@)) (Mul (Add c18~150@ c18~150@) (Mul d18~152@ d18~152@))))) (=> (= temp_18_1~3206@ (Mul (Sub (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ c18~150@)) (Mul (Sub a18~146@ 56) (Mul c18~150@ b18~148@))) (Mul (Mul (Mul b18~148@ a18~146@) c18~150@) (Mul (Add c18~150@ c18~150@) (Mul d18~152@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3133@ temp_18_1~3206@))) (=> (= temp_18_0~3133@ temp_18_1~3206@) (=> (= temp_19_0~3303@ (Mul (Add (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ b19~156@)) (Mul (Sub c19~158@ d19~160@) (Mul b19~156@ d19~160@))) (Mul (Mul a19~154@ (Mul d19~160@ 33)) (Mul (Add a19~154@ a19~154@) (Mul a19~154@ c19~158@))))) (=> (= temp_19_1~3376@ (Mul (Add (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ b19~156@)) (Mul (Sub c19~158@ d19~160@) (Mul d19~160@ b19~156@))) (Mul (Mul a19~154@ (Mul d19~160@ 33)) (Mul (Add a19~154@ a19~154@) (Mul a19~154@ c19~158@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3303@ temp_19_1~3376@))) (=> (= temp_19_0~3303@ temp_19_1~3376@) (=> (= temp_20_0~3473@ (Mul (Sub (Mul d20~168@ (Mul a20~162@ c20~166@)) (Mul (Mul a20~162@ b20~164@) (Mul a20~162@ a20~162@))) (Mul (Mul (Sub a20~162@ a20~162@) (Sub b20~164@ 53)) (Mul (Mul d20~168@ a20~162@) (Sub b20~164@ d20~168@))))) (=> (= temp_20_1~3546@ (Mul (Sub (Mul d20~168@ (Mul a20~162@ c20~166@)) (Mul (Mul a20~162@ b20~164@) (Mul a20~162@ a20~162@))) (Mul (Mul (Sub b20~164@ 53) (Sub a20~162@ a20~162@)) (Mul (Mul d20~168@ a20~162@) (Sub b20~164@ d20~168@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3473@ temp_20_1~3546@))) (=> (= temp_20_0~3473@ temp_20_1~3546@) (=> (= temp_21_0~3635@ (Mul (Mul (Mul (Mul d21~176@ b21~172@) (Add b21~172@ b21~172@)) (Mul (Mul d21~176@ d21~176@) (Mul c21~174@ b21~172@))) (Sub (Mul (Mul c21~174@ a21~170@) (Mul d21~176@ d21~176@)) (Mul (Mul c21~174@ b21~172@) (Mul d21~176@ a21~170@))))) (=> (= temp_21_1~3700@ (Mul (Mul (Mul (Mul d21~176@ d21~176@) (Mul c21~174@ b21~172@)) (Mul (Mul d21~176@ b21~172@) (Add b21~172@ b21~172@))) (Sub (Mul (Mul c21~174@ a21~170@) (Mul d21~176@ d21~176@)) (Mul (Mul c21~174@ b21~172@) (Mul d21~176@ a21~170@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3635@ temp_21_1~3700@))) (=> (= temp_21_0~3635@ temp_21_1~3700@) (=> (= temp_22_0~3785@ (Mul (Mul (Mul (Add c22~182@ c22~182@) (Mul c22~182@ b22~180@)) (Mul a22~178@ (Mul c22~182@ d22~184@))) (Mul (Add (Sub c22~182@ b22~180@) (Add d22~184@ c22~182@)) (Sub (Mul a22~178@ d22~184@) (Mul d22~184@ d22~184@))))) (=> (= temp_22_1~3846@ (Mul (Mul (Mul (Mul (Add c22~182@ c22~182@) (Mul c22~182@ b22~180@)) a22~178@) (Mul c22~182@ d22~184@)) (Mul (Add (Sub c22~182@ b22~180@) (Add d22~184@ c22~182@)) (Sub (Mul a22~178@ d22~184@) (Mul d22~184@ d22~184@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3785@ temp_22_1~3846@))) (=> (= temp_22_0~3785@ temp_22_1~3846@) (=> (= temp_23_0~3947@ (Add (Mul (Mul (Mul a23~186@ b23~188@) (Mul b23~188@ c23~190@)) (Mul (Mul c23~190@ a23~186@) (Mul d23~192@ b23~188@))) (Mul (Mul (Mul c23~190@ 26) (Mul d23~192@ d23~192@)) (Mul (Mul b23~188@ a23~186@) (Mul b23~188@ b23~188@))))) (=> (= temp_23_1~4024@ (Add (Mul (Mul (Mul a23~186@ b23~188@) (Mul b23~188@ c23~190@)) (Mul (Mul c23~190@ a23~186@) (Mul d23~192@ b23~188@))) (Mul (Mul (Mul 26 c23~190@) (Mul d23~192@ d23~192@)) (Mul (Mul b23~188@ a23~186@) (Mul b23~188@ b23~188@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3947@ temp_23_1~4024@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
