...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Add d0~8@ a0~2@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Add d0~8@ a0~2@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul (Mul a0~2@ d0~8@) d0~8@) b0~4@)))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~438@ (Mul (Mul c1~14@ (Mul (Mul b1~12@ c1~14@) (Add c1~14@ a1~10@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ b1~12@)) (Sub (Mul c1~14@ b1~12@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~491@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ b1~12@)) (Sub (Mul c1~14@ b1~12@) (Mul a1~10@ a1~10@))) (Mul c1~14@ (Mul (Mul b1~12@ c1~14@) (Add c1~14@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~438@ temp_1_1~491@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~571@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~636@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~571@ temp_2_1~636@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~688@ (Mul a3~26@ (Mul (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@)) (Mul (Sub d3~32@ a3~26@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~725@ (Mul (Mul a3~26@ (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@))) (Mul (Sub d3~32@ a3~26@) (Mul b3~28@ a3~26@)))) (=> (= tmp%4@ (= temp_3_0~688@ temp_3_1~725@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~805@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ d4~40@)) (Sub (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Add a4~34@ d4~40@)) (Mul (Add a4~34@ a4~34@) (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~878@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ d4~40@)) (Sub (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Add a4~34@ d4~40@)) (Add (Mul a4~34@ (Mul d4~40@ b4~36@)) (Mul a4~34@ (Mul d4~40@ b4~36@)))))) (=> (= tmp%5@ (= temp_4_0~805@ temp_4_1~878@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~930@ (Mul (Mul (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Sub d5~48@ a5~42@) (Mul c5~46@ a5~42@))) d5~48@)) (=> (= temp_5_1~967@ (Mul d5~48@ (Mul (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Sub d5~48@ a5~42@) (Mul c5~46@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~930@ temp_5_1~967@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1043@ (Mul (Mul (Mul (Add d6~56@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul b6~52@ c6~54@) b6~52@) (Add (Mul b6~52@ a6~50@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1104@ (Mul (Mul (Add d6~56@ b6~52@) (Mul (Mul a6~50@ c6~54@) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ a6~50@)))) (Mul (Mul (Mul b6~52@ c6~54@) b6~52@) (Add (Mul b6~52@ a6~50@) (Mul a6~50@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1043@ temp_6_1~1104@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1184@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Add d7~64@ a7~58@)) (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1249@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Add d7~64@ a7~58@)) (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ d7~64@)) (Mul (Mul (Mul a7~58@ b7~60@) c7~62@) a7~58@)))) (=> (= tmp%8@ (= temp_7_0~1184@ temp_7_1~1249@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1329@ (Mul (Mul (Mul (Mul c8~70@ a8~66@) (Mul a8~66@ d8~72@)) (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Add c8~70@ b8~68@))))) (=> (= temp_8_1~1394@ (Mul (Mul (Mul (Mul c8~70@ a8~66@) (Mul a8~66@ d8~72@)) (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Mul a8~66@ (Mul a8~66@ (Mul c8~70@ a8~66@))) (Mul (Mul b8~68@ c8~70@) (Add c8~70@ b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1329@ temp_8_1~1394@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1442@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Sub b9~76@ a9~74@)) (Sub a9~74@ (Mul a9~74@ b9~76@))) b9~76@)) (=> (= temp_9_1~1475@ (Mul b9~76@ (Mul (Mul (Mul d9~80@ b9~76@) (Sub b9~76@ a9~74@)) (Sub a9~74@ (Mul a9~74@ b9~76@))))) (=> (= tmp%10@ (= temp_9_0~1442@ temp_9_1~1475@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1555@ (Mul (Mul (Add (Mul d10~88@ a10~82@) (Sub b10~84@ d10~88@)) (Sub (Mul d10~88@ b10~84@) (Mul a10~82@ a10~82@))) (Add (Sub (Add c10~86@ c10~86@) (Mul d10~88@ a10~82@)) (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~1620@ (Mul (Mul (Add (Mul d10~88@ a10~82@) (Sub b10~84@ d10~88@)) (Sub (Mul d10~88@ b10~84@) (Mul a10~82@ a10~82@))) (Add (Sub (Add c10~86@ c10~86@) (Mul d10~88@ a10~82@)) (Mul (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@))))) (=> (= tmp%11@ (= temp_10_0~1555@ temp_10_1~1620@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1684@ (Mul (Mul (Mul (Sub b11~92@ a11~90@) (Mul 53 d11~96@)) (Mul (Mul b11~92@ c11~94@) (Mul d11~96@ a11~90@))) b11~92@)) (=> (= temp_11_1~1733@ (Mul (Mul (Mul (Sub b11~92@ a11~90@) (Mul d11~96@ 53)) (Mul (Mul b11~92@ c11~94@) (Mul d11~96@ a11~90@))) b11~92@)) (=> (= tmp%12@ (= temp_11_0~1684@ temp_11_1~1733@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1797@ (Mul (Mul d12~104@ (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ b12~100@))) (Mul (Mul b12~100@ (Mul c12~102@ c12~102@)) (Mul (Mul a12~98@ d12~104@) (Mul c12~102@ c12~102@))))) (=> (= temp_12_1~1846@ (Mul (Mul d12~104@ (Mul c12~102@ (Mul d12~104@ (Mul c12~102@ b12~100@)))) (Mul (Mul b12~100@ (Mul c12~102@ c12~102@)) (Mul (Mul a12~98@ d12~104@) (Mul c12~102@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~1797@ temp_12_1~1846@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~1926@ (Mul (Add (Mul (Sub d13~112@ c13~110@) (Mul c13~110@ a13~106@)) (Mul (Mul b13~108@ d13~112@) (Add b13~108@ d13~112@))) (Mul (Mul (Mul b13~108@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ a13~106@) (Mul a13~106@ a13~106@))))) (=> (= temp_13_1~1991@ (Mul (Add (Mul (Sub d13~112@ c13~110@) (Mul a13~106@ c13~110@)) (Mul (Mul b13~108@ d13~112@) (Add b13~108@ d13~112@))) (Mul (Mul (Mul b13~108@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ a13~106@) (Mul a13~106@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~1926@ temp_13_1~1991@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2071@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ c14~118@)) (Mul (Add b14~116@ a14~114@) (Mul b14~116@ c14~118@))) (Mul (Add (Sub b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Sub a14~114@ b14~116@) (Mul d14~120@ c14~118@))))) (=> (= temp_14_1~2136@ (Mul (Mul (Add (Sub b14~116@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Sub a14~114@ b14~116@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ c14~118@)) (Mul (Add b14~116@ a14~114@) (Mul b14~116@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2071@ temp_14_1~2136@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2216@ (Mul (Mul (Mul (Mul d15~128@ d15~128@) (Mul c15~126@ b15~124@)) (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@))) (Mul (Mul (Mul c15~126@ a15~122@) (Mul d15~128@ a15~122@)) (Mul (Add b15~124@ c15~126@) (Mul b15~124@ d15~128@))))) (=> (= temp_15_1~2281@ (Mul (Mul (Mul (Mul c15~126@ a15~122@) (Mul d15~128@ a15~122@)) (Mul (Add b15~124@ c15~126@) (Mul b15~124@ d15~128@))) (Mul (Mul (Mul d15~128@ d15~128@) (Mul c15~126@ b15~124@)) (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= tmp%16@ (= temp_15_0~2216@ temp_15_1~2281@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2361@ (Mul (Mul (Add (Mul d16~136@ c16~134@) (Mul d16~136@ c16~134@)) (Mul (Mul d16~136@ c16~134@) (Sub c16~134@ a16~130@))) (Mul (Add (Sub b16~132@ a16~130@) (Mul c16~134@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ b16~132@))))) (=> (= temp_16_1~2442@ (Mul (Mul (Add (Mul d16~136@ c16~134@) (Mul d16~136@ c16~134@)) (Mul (Mul d16~136@ c16~134@) (Sub c16~134@ a16~130@))) (Add (Mul (Sub b16~132@ a16~130@) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ b16~132@))) (Mul (Mul c16~134@ d16~136@) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ b16~132@)))))) (=> (= tmp%17@ (= temp_16_0~2361@ temp_16_1~2442@)) (=> %%location_label%%16 tmp%17@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
