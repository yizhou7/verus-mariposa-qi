...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul (Mul (Add d0~8@ b0~4@) b0~4@) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ a0~2@))) (Sub (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ b0~4@)) b0~4@))) (=> (= temp_0_1~338@ (Mul (Mul (Mul (Add d0~8@ b0~4@) b0~4@) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ a0~2@))) (Sub (Mul (Mul (Mul d0~8@ a0~2@) a0~2@) b0~4@) b0~4@))) (=> (= tmp%1@ (= temp_0_0~289@ temp_0_1~338@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~418@ (Mul (Mul b1~12@ (Mul (Mul c1~14@ a1~10@) (Mul 32 c1~14@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~483@ (Mul (Mul b1~12@ (Mul (Mul c1~14@ a1~10@) (Mul 32 c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~418@ temp_1_1~483@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~563@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul (Sub d2~24@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ b2~20@))))) (=> (= temp_2_1~628@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul (Sub d2~24@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~563@ temp_2_1~628@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~708@ (Mul (Mul (Mul (Add d3~32@ c3~30@) (Mul c3~30@ b3~28@)) d3~32@) (Mul (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Sub a3~26@ 88))))) (=> (= temp_3_1~773@ (Mul (Mul (Mul (Add d3~32@ c3~30@) (Mul c3~30@ b3~28@)) d3~32@) (Mul (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ d3~32@)) (Mul c3~30@ (Mul c3~30@ (Sub a3~26@ 88)))))) (=> (= tmp%4@ (= temp_3_0~708@ temp_3_1~773@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~849@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Sub d4~40@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@)) (Mul b4~36@ (Mul a4~34@ a4~34@))))) (=> (= temp_4_1~910@ (Mul (Mul (Mul (Sub d4~40@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@)) (Mul b4~36@ (Mul a4~34@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~849@ temp_4_1~910@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~990@ (Mul (Add (Mul (Mul d5~48@ d5~48@) (Sub c5~46@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1063@ (Mul (Add (Sub (Mul (Mul d5~48@ d5~48@) c5~46@) (Mul (Mul d5~48@ d5~48@) a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~990@ temp_5_1~1063@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1115@ (Mul (Sub (Sub (Add a6~50@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Add a6~50@ b6~52@) (Mul a6~50@ a6~50@))) c6~54@)) (=> (= temp_6_1~1152@ (Mul (Sub (Sub (Add a6~50@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Add a6~50@ b6~52@) (Mul a6~50@ a6~50@))) c6~54@)) (=> (= tmp%7@ (= temp_6_0~1115@ temp_6_1~1152@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1220@ (Mul (Mul (Add (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@)) c7~62@) (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Mul (Add d7~64@ c7~62@) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1273@ (Mul (Mul (Add (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@)) c7~62@) (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@)) (Mul (Add d7~64@ c7~62@) (Mul d7~64@ c7~62@))))) (=> (= tmp%8@ (= temp_7_0~1220@ temp_7_1~1273@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1377@ (Mul (Sub (Add (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Sub c8~70@ b8~68@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul 55 a8~66@) (Mul d8~72@ a8~66@)) (Sub (Add c8~70@ 9) (Mul a8~66@ b8~68@))))) (=> (= temp_8_1~1466@ (Mul (Mul (Mul (Mul 55 a8~66@) (Mul d8~72@ a8~66@)) (Sub (Add c8~70@ 9) (Mul a8~66@ b8~68@))) (Sub (Add (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Sub c8~70@ b8~68@) (Mul a8~66@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1377@ temp_8_1~1466@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1546@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Add a9~74@ b9~76@) (Mul d9~80@ a9~74@))) (Mul (Mul (Sub c9~78@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Sub c9~78@ a9~74@))))) (=> (= temp_9_1~1611@ (Mul (Mul (Mul b9~76@ a9~74@) (Mul (Mul d9~80@ b9~76@) (Mul (Add a9~74@ b9~76@) (Mul d9~80@ a9~74@)))) (Mul (Mul (Sub c9~78@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Sub c9~78@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1546@ temp_9_1~1611@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1687@ (Mul (Mul c10~86@ (Mul (Mul c10~86@ b10~84@) (Mul 15 c10~86@))) (Mul (Sub c10~86@ (Add b10~84@ a10~82@)) (Add (Mul d10~88@ a10~82@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~1748@ (Mul (Mul c10~86@ (Mul (Mul c10~86@ b10~84@) (Mul 15 c10~86@))) (Mul (Add (Mul d10~88@ a10~82@) (Mul c10~86@ b10~84@)) (Sub c10~86@ (Add b10~84@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1687@ temp_10_1~1748@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1824@ (Mul (Sub (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ a11~90@))) (Mul (Mul c11~94@ (Mul d11~96@ c11~94@)) (Mul (Mul d11~96@ a11~90@) (Sub a11~90@ b11~92@))))) (=> (= temp_11_1~1885@ (Mul (Sub (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ a11~90@))) (Mul (Mul (Mul d11~96@ c11~94@) c11~94@) (Mul (Mul d11~96@ a11~90@) (Sub a11~90@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1824@ temp_11_1~1885@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1989@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ 95))) (Add (Mul (Add c12~102@ d12~104@) (Mul b12~100@ c12~102@)) (Add (Mul a12~98@ a12~98@) (Mul c12~102@ 35))))) (=> (= temp_12_1~2078@ (Mul (Mul (Mul (Mul (Mul c12~102@ d12~104@) c12~102@) c12~102@) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ 95))) (Add (Mul (Add c12~102@ d12~104@) (Mul b12~100@ c12~102@)) (Add (Mul a12~98@ a12~98@) (Mul c12~102@ 35))))) (=> (= tmp%13@ (= temp_12_0~1989@ temp_12_1~2078@)) (=> %%location_label%%12 tmp%13@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
