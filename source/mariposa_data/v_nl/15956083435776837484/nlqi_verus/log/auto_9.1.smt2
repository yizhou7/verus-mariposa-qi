...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ b0~4@)) (Sub (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@))) (Add (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@)) (Add (Mul a0~2@ a0~2@) (Sub c0~6@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ b0~4@)) (Sub (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@))) (Add (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@)) (Add (Mul a0~2@ a0~2@) (Sub c0~6@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~459@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ c1~14@))) (Add (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~556@ (Add (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ c1~14@))) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ c1~14@))) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~459@ temp_1_1~556@))) (=> (= temp_1_0~459@ temp_1_1~556@) (=> (= temp_2_0~653@ (Mul (Sub (Mul (Mul c2~22@ c2~22@) (Sub a2~18@ c2~22@)) (Mul a2~18@ (Mul c2~22@ c2~22@))) (Mul (Mul (Sub a2~18@ d2~24@) (Mul 84 c2~22@)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~726@ (Mul (Sub (Mul (Mul c2~22@ c2~22@) (Sub a2~18@ c2~22@)) (Mul a2~18@ (Mul c2~22@ c2~22@))) (Mul (Mul (Sub a2~18@ d2~24@) (Mul 84 c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~653@ temp_2_1~726@))) (=> (= temp_2_0~653@ temp_2_1~726@) (=> (= temp_3_0~815@ (Mul (Mul (Add (Mul a3~26@ d3~32@) (Mul d3~32@ c3~30@)) (Mul (Add d3~32@ a3~26@) (Mul d3~32@ c3~30@))) (Mul (Mul (Sub b3~28@ d3~32@) (Mul b3~28@ b3~28@)) (Add (Mul a3~26@ c3~30@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~888@ (Mul (Mul (Add (Mul a3~26@ d3~32@) (Mul d3~32@ c3~30@)) (Mul (Add d3~32@ a3~26@) (Mul d3~32@ c3~30@))) (Mul (Sub (Mul b3~28@ (Mul b3~28@ b3~28@)) (Mul d3~32@ (Mul b3~28@ b3~28@))) (Add (Mul a3~26@ c3~30@) (Mul c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~815@ temp_3_1~888@))) (=> (= temp_3_0~815@ temp_3_1~888@) (=> (= temp_4_0~977@ (Mul (Mul (Mul (Add c4~38@ b4~36@) (Mul b4~36@ d4~40@)) (Add (Mul a4~34@ b4~36@) (Mul d4~40@ a4~34@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~1042@ (Mul (Mul (Mul (Add c4~38@ b4~36@) (Mul b4~36@ d4~40@)) (Add (Mul a4~34@ b4~36@) (Mul d4~40@ a4~34@))) (Mul (Mul d4~40@ (Mul a4~34@ (Mul a4~34@ b4~36@))) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~977@ temp_4_1~1042@))) (=> (= temp_4_0~977@ temp_4_1~1042@) (=> (= temp_5_0~1115@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) d5~48@) b5~44@) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1164@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) d5~48@) b5~44@) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Mul (Mul b5~44@ a5~42@) a5~42@) d5~48@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1115@ temp_5_1~1164@))) (=> (= temp_5_0~1115@ temp_5_1~1164@) (=> (= temp_6_0~1241@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) c6~54@) (Sub (Mul d6~56@ c6~54@) (Mul b6~52@ c6~54@))) (Mul (Mul (Mul a6~50@ c6~54@) d6~56@) (Mul c6~54@ (Add d6~56@ b6~52@))))) (=> (= temp_6_1~1294@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) c6~54@) (Sub (Mul d6~56@ c6~54@) (Mul b6~52@ c6~54@))) (Mul (Mul (Mul a6~50@ c6~54@) d6~56@) (Mul (Add d6~56@ b6~52@) c6~54@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1241@ temp_6_1~1294@))) (=> (= temp_6_0~1241@ temp_6_1~1294@) (=> (= temp_7_0~1391@ (Mul (Mul (Add (Mul d7~64@ b7~60@) (Mul b7~60@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ 87))) (Mul (Add (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ d7~64@) a7~58@)))) (=> (= temp_7_1~1460@ (Mul (Mul (Add (Mul d7~64@ b7~60@) (Mul b7~60@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ 87))) (Mul (Mul a7~58@ (Add d7~64@ c7~62@)) (Mul (Mul c7~62@ d7~64@) a7~58@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1391@ temp_7_1~1460@))) (=> (= temp_7_0~1391@ temp_7_1~1460@) (=> (= temp_8_0~1549@ (Mul (Mul (Mul (Sub b8~68@ c8~70@) (Mul c8~70@ a8~66@)) (Sub (Mul a8~66@ d8~72@) (Sub b8~68@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Add a8~66@ b8~68@))))) (=> (= temp_8_1~1614@ (Mul (Mul (Mul (Sub b8~68@ c8~70@) (Mul c8~70@ a8~66@)) (Sub (Mul a8~66@ d8~72@) (Sub b8~68@ d8~72@))) (Mul (Mul d8~72@ (Mul a8~66@ (Mul a8~66@ a8~66@))) (Mul (Mul b8~68@ d8~72@) (Add a8~66@ b8~68@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1549@ temp_8_1~1614@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
