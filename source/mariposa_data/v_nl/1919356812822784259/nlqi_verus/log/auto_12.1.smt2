...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Add (Mul a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Sub b0~4@ d0~8@) b0~4@)) (Mul (Mul (Add a0~2@ b0~4@) (Mul d0~8@ d0~8@)) (Sub (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~378@ (Mul (Mul (Add (Mul a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Sub b0~4@ d0~8@) b0~4@)) (Sub (Mul (Mul (Add a0~2@ b0~4@) (Mul d0~8@ d0~8@)) (Mul d0~8@ b0~4@)) (Mul (Mul (Add a0~2@ b0~4@) (Mul d0~8@ d0~8@)) (Mul b0~4@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~378@))) (=> (= temp_0_0~301@ temp_0_1~378@) (=> (= temp_1_0~467@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@)) b1~12@) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ 18) (Sub b1~12@ a1~10@))))) (=> (= temp_1_1~532@ (Mul (Mul (Mul a1~10@ a1~10@) (Mul (Mul a1~10@ d1~16@) b1~12@)) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ 18) (Sub b1~12@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~467@ temp_1_1~532@))) (=> (= temp_1_0~467@ temp_1_1~532@) (=> (= temp_2_0~617@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Sub c2~22@ c2~22@) (Add c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ b2~20@)) (Mul a2~18@ (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~678@ (Mul (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@)) (Sub c2~22@ c2~22@)) (Add c2~22@ b2~20@)) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ b2~20@)) (Mul a2~18@ (Mul b2~20@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~617@ temp_2_1~678@))) (=> (= temp_2_0~617@ temp_2_1~678@) (=> (= temp_3_0~759@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@)) (Mul a3~26@ (Mul b3~28@ c3~30@))) (Mul (Mul (Mul b3~28@ a3~26@) (Add d3~32@ c3~30@)) (Mul d3~32@ (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~816@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@)) (Mul a3~26@ (Mul b3~28@ c3~30@))) (Mul (Mul (Mul b3~28@ a3~26@) (Add d3~32@ c3~30@)) (Mul (Mul d3~32@ b3~28@) c3~30@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~759@ temp_3_1~816@))) (=> (= temp_3_0~759@ temp_3_1~816@) (=> (= temp_4_0~905@ (Sub (Add (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@))) (Sub (Sub (Mul a4~34@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Add d4~40@ a4~34@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~970@ (Sub (Add (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@))) (Sub (Sub (Mul a4~34@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Add d4~40@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~905@ temp_4_1~970@))) (=> (= temp_4_0~905@ temp_4_1~970@) (=> (= temp_5_0~1083@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ b5~44@)) (Sub (Mul b5~44@ d5~48@) (Add 80 a5~42@))) (Mul (Mul (Mul 72 c5~46@) (Mul b5~44@ d5~48@)) (Mul (Add d5~48@ b5~44@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1172@ (Mul (Mul (Mul b5~44@ c5~46@) (Mul (Mul d5~48@ b5~44@) (Sub (Mul b5~44@ d5~48@) (Add 80 a5~42@)))) (Mul (Mul (Mul 72 c5~46@) (Mul b5~44@ d5~48@)) (Mul (Add d5~48@ b5~44@) (Mul d5~48@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1083@ temp_5_1~1172@))) (=> (= temp_5_0~1083@ temp_5_1~1172@) (=> (= temp_6_0~1273@ (Mul (Mul (Mul (Add d6~56@ b6~52@) (Mul 16 c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1350@ (Mul (Mul (Mul (Add d6~56@ b6~52@) (Mul 16 c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul (Mul b6~52@ c6~54@) a6~50@) b6~52@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1273@ temp_6_1~1350@))) (=> (= temp_6_0~1273@ temp_6_1~1350@) (=> (= temp_7_0~1431@ (Mul (Mul (Mul (Sub c7~62@ d7~64@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ d7~64@) b7~60@)) (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Add a7~58@ d7~64@) c7~62@)))) (=> (= temp_7_1~1488@ (Mul (Mul (Mul (Mul (Sub c7~62@ d7~64@) b7~60@) d7~64@) (Mul (Mul b7~60@ d7~64@) b7~60@)) (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Add a7~58@ d7~64@) c7~62@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1431@ temp_7_1~1488@))) (=> (= temp_7_0~1431@ temp_7_1~1488@) (=> (= temp_8_0~1589@ (Mul (Add (Mul (Add a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ a8~66@) (Add a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ c8~70@) (Add b8~68@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul 37 b8~68@))))) (=> (= temp_8_1~1666@ (Mul (Add (Mul (Mul (Add a8~66@ a8~66@) b8~68@) b8~68@) (Mul (Mul c8~70@ a8~66@) (Add a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ c8~70@) (Add b8~68@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul 37 b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1589@ temp_8_1~1666@))) (=> (= temp_8_0~1589@ temp_8_1~1666@) (=> (= temp_9_0~1759@ (Mul (Mul (Add (Mul b9~76@ a9~74@) (Mul b9~76@ d9~80@)) (Mul c9~78@ (Mul d9~80@ c9~78@))) (Mul (Sub (Mul b9~76@ a9~74@) (Mul b9~76@ d9~80@)) (Mul (Mul d9~80@ d9~80@) 17)))) (=> (= temp_9_1~1852@ (Mul (Mul (Add (Mul b9~76@ a9~74@) (Mul b9~76@ d9~80@)) (Mul c9~78@ (Mul d9~80@ c9~78@))) (Sub (Mul (Mul b9~76@ a9~74@) (Mul (Mul d9~80@ d9~80@) 17)) (Mul (Mul b9~76@ d9~80@) (Mul (Mul d9~80@ d9~80@) 17))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1759@ temp_9_1~1852@))) (=> (= temp_9_0~1759@ temp_9_1~1852@) (=> (= temp_10_0~1941@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ d10~88@))) (Add (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ c10~86@)) (Mul (Sub a10~82@ c10~86@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~2006@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ a10~82@)) (Mul c10~86@ (Mul a10~82@ (Mul c10~86@ d10~88@)))) (Add (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ c10~86@)) (Mul (Sub a10~82@ c10~86@) (Mul b10~84@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1941@ temp_10_1~2006@))) (=> (= temp_10_0~1941@ temp_10_1~2006@) (=> (= temp_11_0~2095@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ b11~92@)) (Add (Mul b11~92@ a11~90@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2160@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul (Mul d11~96@ c11~94@) d11~96@) b11~92@) (Add (Mul b11~92@ a11~90@) (Mul b11~92@ a11~90@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2095@ temp_11_1~2160@))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
