...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Add (Mul a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Sub b0~4@ d0~8@) b0~4@)) (Mul (Mul (Add a0~2@ b0~4@) (Mul d0~8@ d0~8@)) (Sub (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~378@ (Mul (Mul (Add (Mul a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Sub b0~4@ d0~8@) b0~4@)) (Sub (Mul (Mul (Add a0~2@ b0~4@) (Mul d0~8@ d0~8@)) (Mul d0~8@ b0~4@)) (Mul (Mul (Add a0~2@ b0~4@) (Mul d0~8@ d0~8@)) (Mul b0~4@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~378@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~458@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@)) b1~12@) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ 18) (Sub b1~12@ a1~10@))))) (=> (= temp_1_1~523@ (Mul (Mul (Mul a1~10@ a1~10@) (Mul (Mul a1~10@ d1~16@) b1~12@)) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ 18) (Sub b1~12@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~458@ temp_1_1~523@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~599@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Sub c2~22@ c2~22@) (Add c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ b2~20@)) (Mul a2~18@ (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~660@ (Mul (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@)) (Sub c2~22@ c2~22@)) (Add c2~22@ b2~20@)) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ b2~20@)) (Mul a2~18@ (Mul b2~20@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~599@ temp_2_1~660@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~732@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@)) (Mul a3~26@ (Mul b3~28@ c3~30@))) (Mul (Mul (Mul b3~28@ a3~26@) (Add d3~32@ c3~30@)) (Mul d3~32@ (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~789@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@)) (Mul a3~26@ (Mul b3~28@ c3~30@))) (Mul (Mul (Mul b3~28@ a3~26@) (Add d3~32@ c3~30@)) (Mul (Mul d3~32@ b3~28@) c3~30@)))) (=> (= tmp%4@ (= temp_3_0~732@ temp_3_1~789@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~869@ (Sub (Add (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@))) (Sub (Sub (Mul a4~34@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Add d4~40@ a4~34@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~934@ (Sub (Add (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@))) (Sub (Sub (Mul a4~34@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Add d4~40@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~869@ temp_4_1~934@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1038@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ b5~44@)) (Sub (Mul b5~44@ d5~48@) (Add 80 a5~42@))) (Mul (Mul (Mul 72 c5~46@) (Mul b5~44@ d5~48@)) (Mul (Add d5~48@ b5~44@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1127@ (Mul (Mul (Mul b5~44@ c5~46@) (Mul (Mul d5~48@ b5~44@) (Sub (Mul b5~44@ d5~48@) (Add 80 a5~42@)))) (Mul (Mul (Mul 72 c5~46@) (Mul b5~44@ d5~48@)) (Mul (Add d5~48@ b5~44@) (Mul d5~48@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1038@ temp_5_1~1127@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1219@ (Mul (Mul (Mul (Add d6~56@ b6~52@) (Mul 16 c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1296@ (Mul (Mul (Mul (Add d6~56@ b6~52@) (Mul 16 c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul (Mul b6~52@ c6~54@) a6~50@) b6~52@)))) (=> (= tmp%7@ (= temp_6_0~1219@ temp_6_1~1296@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1368@ (Mul (Mul (Mul (Sub c7~62@ d7~64@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ d7~64@) b7~60@)) (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Add a7~58@ d7~64@) c7~62@)))) (=> (= temp_7_1~1425@ (Mul (Mul (Mul (Mul (Sub c7~62@ d7~64@) b7~60@) d7~64@) (Mul (Mul b7~60@ d7~64@) b7~60@)) (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Add a7~58@ d7~64@) c7~62@)))) (=> (= tmp%8@ (= temp_7_0~1368@ temp_7_1~1425@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1517@ (Mul (Add (Mul (Add a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ a8~66@) (Add a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ c8~70@) (Add b8~68@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul 37 b8~68@))))) (=> (= temp_8_1~1594@ (Mul (Add (Mul (Mul (Add a8~66@ a8~66@) b8~68@) b8~68@) (Mul (Mul c8~70@ a8~66@) (Add a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ c8~70@) (Add b8~68@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul 37 b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1517@ temp_8_1~1594@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1678@ (Mul (Mul (Add (Mul b9~76@ a9~74@) (Mul b9~76@ d9~80@)) (Mul c9~78@ (Mul d9~80@ c9~78@))) (Mul (Sub (Mul b9~76@ a9~74@) (Mul b9~76@ d9~80@)) (Mul (Mul d9~80@ d9~80@) 17)))) (=> (= temp_9_1~1771@ (Mul (Mul (Add (Mul b9~76@ a9~74@) (Mul b9~76@ d9~80@)) (Mul c9~78@ (Mul d9~80@ c9~78@))) (Sub (Mul (Mul b9~76@ a9~74@) (Mul (Mul d9~80@ d9~80@) 17)) (Mul (Mul b9~76@ d9~80@) (Mul (Mul d9~80@ d9~80@) 17))))) (=> (= tmp%10@ (= temp_9_0~1678@ temp_9_1~1771@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1851@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ d10~88@))) (Add (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ c10~86@)) (Mul (Sub a10~82@ c10~86@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~1916@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ a10~82@)) (Mul c10~86@ (Mul a10~82@ (Mul c10~86@ d10~88@)))) (Add (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ c10~86@)) (Mul (Sub a10~82@ c10~86@) (Mul b10~84@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1851@ temp_10_1~1916@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1996@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ b11~92@)) (Add (Mul b11~92@ a11~90@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2061@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul (Mul d11~96@ c11~94@) d11~96@) b11~92@) (Add (Mul b11~92@ a11~90@) (Mul b11~92@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1996@ temp_11_1~2061@)) (=> %%location_label%%11 tmp%12@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
