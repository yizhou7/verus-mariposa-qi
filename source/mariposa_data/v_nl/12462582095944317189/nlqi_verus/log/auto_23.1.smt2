...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Add (Add (Mul b0~4@ a0~2@) (Mul d0~8@ a0~2@)) (Mul (Add d0~8@ c0~6@) (Sub a0~2@ d0~8@))) (Sub (Mul (Add d0~8@ d0~8@) (Add c0~6@ d0~8@)) (Add (Sub b0~4@ d0~8@) (Sub d0~8@ c0~6@))))) (=> (= temp_0_1~378@ (Mul (Add (Add (Mul b0~4@ a0~2@) (Mul d0~8@ a0~2@)) (Mul (Add d0~8@ c0~6@) (Sub a0~2@ d0~8@))) (Sub (Add (Mul d0~8@ (Add c0~6@ d0~8@)) (Mul d0~8@ (Add c0~6@ d0~8@))) (Add (Sub b0~4@ d0~8@) (Sub d0~8@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~378@))) (=> (= temp_0_0~305@ temp_0_1~378@) (=> (= temp_1_0~451@ (Mul (Mul (Add (Mul b1~12@ a1~10@) d1~16@) (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@))) (Mul c1~14@ (Mul (Add a1~10@ b1~12@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~500@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@)) (Add (Mul b1~12@ a1~10@) d1~16@)) (Mul c1~14@ (Mul (Add a1~10@ b1~12@) (Mul b1~12@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~451@ temp_1_1~500@))) (=> (= temp_1_0~451@ temp_1_1~500@) (=> (= temp_2_0~601@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Sub b2~20@ b2~20@)) (Mul (Sub c2~22@ a2~18@) (Mul 76 d2~24@))) (Mul (Mul (Mul d2~24@ c2~22@) (Add a2~18@ d2~24@)) (Add (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@))))) (=> (= temp_2_1~698@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Sub b2~20@ b2~20@)) (Sub (Mul c2~22@ (Mul 76 d2~24@)) (Mul a2~18@ (Mul 76 d2~24@)))) (Mul (Mul (Mul d2~24@ c2~22@) (Add a2~18@ d2~24@)) (Add (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~601@ temp_2_1~698@))) (=> (= temp_2_0~601@ temp_2_1~698@) (=> (= temp_3_0~783@ (Mul (Add (Mul (Sub a3~26@ a3~26@) (Mul d3~32@ d3~32@)) (Add (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@))) (Mul (Sub (Mul a3~26@ c3~30@) (Add a3~26@ d3~32@)) (Mul c3~30@ (Mul a3~26@ b3~28@))))) (=> (= temp_3_1~852@ (Mul (Add (Sub (Mul a3~26@ (Mul d3~32@ d3~32@)) (Mul a3~26@ (Mul d3~32@ d3~32@))) (Add (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@))) (Mul (Sub (Mul a3~26@ c3~30@) (Add a3~26@ d3~32@)) (Mul c3~30@ (Mul a3~26@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~783@ temp_3_1~852@))) (=> (= temp_3_0~783@ temp_3_1~852@) (=> (= temp_4_0~949@ (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Mul 19 d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ c4~38@))) (Mul (Mul (Sub a4~34@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul d4~40@ c4~38@) d4~40@)))) (=> (= temp_4_1~1022@ (Mul (Mul (Mul b4~36@ (Mul b4~36@ (Mul 19 d4~40@))) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ c4~38@))) (Mul (Mul (Sub a4~34@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul d4~40@ c4~38@) d4~40@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~949@ temp_4_1~1022@))) (=> (= temp_4_0~949@ temp_4_1~1022@) (=> (= temp_5_0~1123@ (Sub (Add (Add (Mul b5~44@ 88) (Sub c5~46@ d5~48@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ b5~44@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1200@ (Sub (Add (Add (Mul b5~44@ 88) (Sub c5~46@ d5~48@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ b5~44@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1123@ temp_5_1~1200@))) (=> (= temp_5_0~1123@ temp_5_1~1200@) (=> (= temp_6_0~1261@ (Mul (Mul (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ a6~50@))) b6~52@)) (=> (= temp_6_1~1298@ (Mul (Mul (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ c6~54@)) (Mul (Mul (Mul d6~56@ c6~54@) a6~50@) a6~50@)) b6~52@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1261@ temp_6_1~1298@))) (=> (= temp_6_0~1261@ temp_6_1~1298@) (=> (= temp_7_0~1399@ (Mul (Mul (Mul (Mul 57 b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul c7~62@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Sub d7~64@ b7~60@))))) (=> (= temp_7_1~1476@ (Mul (Mul (Mul (Mul 57 b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul c7~62@ c7~62@) (Mul c7~62@ b7~60@)) (Mul d7~64@ (Mul d7~64@ (Sub d7~64@ b7~60@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1399@ temp_7_1~1476@))) (=> (= temp_7_0~1399@ temp_7_1~1476@) (=> (= temp_8_0~1561@ (Mul (Mul (Add (Mul b8~68@ a8~66@) d8~72@) (Sub (Mul b8~68@ c8~70@) (Add d8~72@ d8~72@))) (Mul (Sub (Mul a8~66@ c8~70@) (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~1622@ (Mul (Mul (Add (Mul b8~68@ a8~66@) d8~72@) (Sub (Mul b8~68@ c8~70@) (Add d8~72@ d8~72@))) (Mul (Sub (Mul a8~66@ c8~70@) (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1561@ temp_8_1~1622@))) (=> (= temp_8_0~1561@ temp_8_1~1622@) (=> (= temp_9_0~1699@ (Mul (Mul (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ b9~76@)) b9~76@) (Mul (Sub (Mul c9~78@ d9~80@) (Sub a9~74@ b9~76@)) (Mul (Mul a9~74@ b9~76@) (Add d9~80@ d9~80@))))) (=> (= temp_9_1~1752@ (Mul (Mul (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ b9~76@)) b9~76@) (Mul (Sub (Mul c9~78@ d9~80@) (Sub a9~74@ b9~76@)) (Mul (Mul b9~76@ a9~74@) (Add d9~80@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1699@ temp_9_1~1752@))) (=> (= temp_9_0~1699@ temp_9_1~1752@) (=> (= temp_10_0~1841@ (Mul (Mul (Add (Add b10~84@ a10~82@) (Sub b10~84@ d10~88@)) (Add (Mul c10~86@ b10~84@) (Mul c10~86@ a10~82@))) (Mul (Sub (Sub c10~86@ d10~88@) (Sub d10~88@ a10~82@)) (Mul (Mul a10~82@ b10~84@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~1906@ (Mul (Mul (Add (Mul c10~86@ b10~84@) (Mul c10~86@ a10~82@)) (Add (Add b10~84@ a10~82@) (Sub b10~84@ d10~88@))) (Mul (Sub (Sub c10~86@ d10~88@) (Sub d10~88@ a10~82@)) (Mul (Mul a10~82@ b10~84@) (Mul c10~86@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1841@ temp_10_1~1906@))) (=> (= temp_10_0~1841@ temp_10_1~1906@) (=> (= temp_11_0~1991@ (Mul (Sub (Mul (Mul d11~96@ b11~92@) (Sub d11~96@ a11~90@)) (Mul (Mul d11~96@ c11~94@) (Mul b11~92@ c11~94@))) (Mul (Sub (Mul c11~94@ a11~90@) (Add d11~96@ c11~94@)) (Mul d11~96@ (Mul d11~96@ d11~96@))))) (=> (= temp_11_1~2052@ (Mul (Sub (Mul (Mul d11~96@ b11~92@) (Sub d11~96@ a11~90@)) (Mul (Mul d11~96@ c11~94@) (Mul b11~92@ c11~94@))) (Mul (Sub (Mul c11~94@ a11~90@) (Add d11~96@ c11~94@)) (Mul d11~96@ (Mul d11~96@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1991@ temp_11_1~2052@))) (=> (= temp_11_0~1991@ temp_11_1~2052@) (=> (= temp_12_0~2141@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul a12~98@ b12~100@))) (Mul (Mul (Mul b12~100@ c12~102@) (Sub b12~100@ d12~104@)) (Mul (Sub b12~100@ c12~102@) (Add c12~102@ d12~104@))))) (=> (= temp_12_1~2206@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Sub b12~100@ d12~104@)) (Mul (Sub b12~100@ c12~102@) (Add c12~102@ d12~104@))) (Mul (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul a12~98@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2141@ temp_12_1~2206@))) (=> (= temp_12_0~2141@ temp_12_1~2206@) (=> (= temp_13_0~2291@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Mul b13~108@ d13~112@)) (Mul (Mul a13~106@ a13~106@) a13~106@)) (Sub (Mul (Mul a13~106@ d13~112@) (Add a13~106@ d13~112@)) (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2352@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Mul b13~108@ d13~112@)) (Mul (Mul a13~106@ a13~106@) a13~106@)) (Sub (Mul (Add a13~106@ d13~112@) (Mul a13~106@ d13~112@)) (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2291@ temp_13_1~2352@))) (=> (= temp_13_0~2291@ temp_13_1~2352@) (=> (= temp_14_0~2461@ (Add (Mul (Mul (Mul 62 c14~118@) (Mul d14~120@ c14~118@)) (Mul (Mul a14~114@ d14~120@) (Add c14~118@ a14~114@))) (Add (Mul (Mul b14~116@ 40) (Sub a14~114@ b14~116@)) (Mul (Add b14~116@ c14~118@) d14~120@)))) (=> (= temp_14_1~2546@ (Add (Mul (Mul (Mul 62 c14~118@) (Mul d14~120@ c14~118@)) (Mul (Add c14~118@ a14~114@) (Mul a14~114@ d14~120@))) (Add (Mul (Mul b14~116@ 40) (Sub a14~114@ b14~116@)) (Mul (Add b14~116@ c14~118@) d14~120@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2461@ temp_14_1~2546@))) (=> (= temp_14_0~2461@ temp_14_1~2546@) (=> (= temp_15_0~2635@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Sub a15~122@ a15~122@)) (Mul (Mul c15~126@ c15~126@) (Sub b15~124@ d15~128@))) (Mul (Mul (Mul a15~122@ a15~122@) (Sub d15~128@ b15~124@)) (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2708@ (Mul (Mul (Sub (Mul (Mul a15~122@ a15~122@) a15~122@) (Mul (Mul a15~122@ a15~122@) a15~122@)) (Mul (Mul c15~126@ c15~126@) (Sub b15~124@ d15~128@))) (Mul (Mul (Mul a15~122@ a15~122@) (Sub d15~128@ b15~124@)) (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2635@ temp_15_1~2708@))) (=> (= temp_15_0~2635@ temp_15_1~2708@) (=> (= temp_16_0~2781@ (Mul (Mul (Mul (Mul c16~134@ a16~130@) (Mul b16~132@ b16~132@)) (Mul (Mul c16~134@ 92) (Mul c16~134@ c16~134@))) b16~132@)) (=> (= temp_16_1~2830@ (Mul (Mul (Mul (Mul c16~134@ a16~130@) (Mul b16~132@ b16~132@)) (Mul c16~134@ (Mul 92 (Mul c16~134@ c16~134@)))) b16~132@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2781@ temp_16_1~2830@))) (=> (= temp_16_0~2781@ temp_16_1~2830@) (=> (= temp_17_0~2927@ (Sub (Sub (Mul (Mul 81 c17~142@) d17~144@) (Sub (Mul b17~140@ b17~140@) (Sub b17~140@ b17~140@))) (Mul (Mul (Mul a17~138@ a17~138@) (Sub b17~140@ c17~142@)) (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~3000@ (Sub (Sub (Mul (Mul 81 c17~142@) d17~144@) (Sub (Mul b17~140@ b17~140@) (Sub b17~140@ b17~140@))) (Mul (Mul (Mul a17~138@ a17~138@) (Sub b17~140@ c17~142@)) (Mul (Mul d17~144@ b17~140@) (Mul b17~140@ a17~138@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2927@ temp_17_1~3000@))) (=> (= temp_17_0~2927@ temp_17_1~3000@) (=> (= temp_18_0~3077@ (Mul (Mul (Sub (Mul c18~150@ a18~146@) (Mul d18~152@ d18~152@)) (Mul (Mul d18~152@ a18~146@) (Sub a18~146@ a18~146@))) (Mul (Mul (Add a18~146@ d18~152@) (Mul d18~152@ d18~152@)) c18~150@))) (=> (= temp_18_1~3130@ (Mul (Mul (Sub (Mul c18~150@ a18~146@) (Mul d18~152@ d18~152@)) (Mul d18~152@ (Mul a18~146@ (Sub a18~146@ a18~146@)))) (Mul (Mul (Add a18~146@ d18~152@) (Mul d18~152@ d18~152@)) c18~150@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3077@ temp_18_1~3130@))) (=> (= temp_18_0~3077@ temp_18_1~3130@) (=> (= temp_19_0~3219@ (Mul (Mul (Mul (Mul c19~158@ b19~156@) (Mul d19~160@ b19~156@)) (Mul (Add c19~158@ a19~154@) (Mul a19~154@ d19~160@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul d19~160@ a19~154@)) (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ b19~156@))))) (=> (= temp_19_1~3284@ (Mul (Mul (Mul (Mul (Mul c19~158@ b19~156@) (Mul d19~160@ b19~156@)) (Add c19~158@ a19~154@)) (Mul a19~154@ d19~160@)) (Mul (Mul (Mul b19~156@ b19~156@) (Mul d19~160@ a19~154@)) (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ b19~156@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3219@ temp_19_1~3284@))) (=> (= temp_19_0~3219@ temp_19_1~3284@) (=> (= temp_20_0~3373@ (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul d20~168@ d20~168@)) (Mul (Mul 20 d20~168@) (Mul b20~164@ d20~168@))) (Mul a20~162@ (Add (Mul c20~166@ a20~162@) (Add d20~168@ a20~162@))))) (=> (= temp_20_1~3438@ (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul d20~168@ d20~168@)) (Mul (Mul b20~164@ d20~168@) (Mul 20 d20~168@))) (Mul a20~162@ (Add (Mul c20~166@ a20~162@) (Add d20~168@ a20~162@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3373@ temp_20_1~3438@))) (=> (= temp_20_0~3373@ temp_20_1~3438@) (=> (= temp_21_0~3539@ (Mul (Mul (Sub (Mul a21~170@ a21~170@) (Mul b21~172@ c21~174@)) (Mul (Sub c21~174@ 67) (Mul c21~174@ d21~176@))) (Mul (Sub (Mul c21~174@ d21~176@) (Mul d21~176@ a21~170@)) (Mul (Mul d21~176@ d21~176@) (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~3644@ (Mul (Sub (Mul (Mul a21~170@ a21~170@) (Mul (Sub c21~174@ 67) (Mul c21~174@ d21~176@))) (Mul (Mul b21~172@ c21~174@) (Mul (Sub c21~174@ 67) (Mul c21~174@ d21~176@)))) (Mul (Sub (Mul c21~174@ d21~176@) (Mul d21~176@ a21~170@)) (Mul (Mul d21~176@ d21~176@) (Mul a21~170@ b21~172@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3539@ temp_21_1~3644@))) (=> (= temp_21_0~3539@ temp_21_1~3644@) (=> (= temp_22_0~3729@ (Mul (Add (Mul (Mul c22~182@ a22~178@) (Mul d22~184@ c22~182@)) (Mul (Mul d22~184@ b22~180@) (Mul a22~178@ d22~184@))) (Mul (Mul (Mul d22~184@ a22~178@) d22~184@) (Mul (Mul a22~178@ c22~182@) (Mul a22~178@ b22~180@))))) (=> (= temp_22_1~3790@ (Mul (Add (Mul (Mul c22~182@ a22~178@) (Mul d22~184@ c22~182@)) (Mul (Mul d22~184@ b22~180@) (Mul a22~178@ d22~184@))) (Mul (Mul d22~184@ (Mul a22~178@ d22~184@)) (Mul (Mul a22~178@ c22~182@) (Mul a22~178@ b22~180@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3729@ temp_22_1~3790@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
