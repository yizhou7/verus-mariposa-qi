...
(push)
 ...
 (declare-const temp_10_0~1909@ Int)
 (declare-const temp_10_1~1974@ Int)
 ...
 (declare-const temp_15_1~2736@ Int)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~317@ temp_0_1~394@)
        (=>
         (= temp_1_0~483@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@
              c1~14@
             ) (Mul c1~14@ a1~10@)
            )
         ...
         (=>
          (= temp_1_1~548@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@
               c1~14@
              ) (Mul c1~14@ a1~10@)
             )
            ) (Add (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Sub (Mul c1~14@ c1~14@) (Mul b1~12@
          ...
          (and
           ...
           (=>
            (= temp_1_0~483@ temp_1_1~548@)
            (=>
             (= temp_2_0~649@ (Mul (Sub (Add (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Sub a2~18@
                  a2~18@
                 ) (Mul c2~22@ a2~18@)
                )
             ...
             (=>
              (= temp_2_1~726@ (Mul (Sub (Add (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Sub a2~18@
                   a2~18@
                  ) (Mul c2~22@ a2~18@)
                 )
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~649@ temp_2_1~726@)
               ))
               (=>
                (= temp_2_0~649@ temp_2_1~726@)
                (=>
                 (= temp_3_0~811@ (Mul (Sub b3~28@ (Sub (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@))) (Mul
                    (Mul (Mul d3~32@ 73) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ b3~28@) a3~26@)
                 )))
                 (=>
                  (= temp_3_1~872@ (Mul (Sub b3~28@ (Sub (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@))) (Mul
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~811@ temp_3_1~872@)
                   ))
                   (=>
                    (= temp_3_0~811@ temp_3_1~872@)
                    (=>
                     (= temp_4_0~973@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ d4~40@)) (Sub (Mul c4~38@
                          a4~34@
                         ) (Mul b4~36@ d4~40@)
                        )
                     ...
                     (=>
                      (= temp_4_1~1050@ (Mul (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ d4~40@)) (Sub (Mul
                            c4~38@ a4~34@
                           ) (Mul b4~36@ d4~40@)
                          )
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~973@ temp_4_1~1050@)
                       ))
                       (=>
                        (= temp_4_0~973@ temp_4_1~1050@)
                        (=>
                         (= temp_5_0~1131@ (Mul (Mul (Add (Mul c5~46@ d5~48@) (Add d5~48@ c5~46@)) (Add (Sub d5~48@
                              c5~46@
                             ) d5~48@
                            )
                         ...
                         (=>
                          (= temp_5_1~1188@ (Mul (Mul (Add (Sub d5~48@ c5~46@) d5~48@) (Add (Mul c5~46@ d5~48@)
                              (Add d5~48@ c5~46@)
                             )
                            ) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@)) (Mul c5~46@ (Mul c5~46@ c5~46@)))
                          ))
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1131@ temp_5_1~1188@)
                           ))
                           (=>
                            (= temp_5_0~1131@ temp_5_1~1188@)
                            (=>
                             (= temp_6_0~1265@ (Mul (Mul (Add (Add c6~54@ c6~54@) (Mul d6~56@ d6~56@)) d6~56@) (
                                Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul a6~50@ b6~52@) (Add c6~54@
                                  c6~54@
                             )))))
                             (=>
                              (= temp_6_1~1318@ (Mul (Mul (Mul (Add (Add c6~54@ c6~54@) (Mul d6~56@ d6~56@)) d6~56@)
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1265@ temp_6_1~1318@)
                               ))
                               (=>
                                (= temp_6_0~1265@ temp_6_1~1318@)
                                (=>
                                 (= temp_7_0~1415@ (Sub (Sub (Mul d7~64@ (Mul a7~58@ d7~64@)) (Mul (Mul a7~58@ b7~60@)
                                     (Mul c7~62@ c7~62@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1488@ (Sub (Sub (Mul d7~64@ (Mul a7~58@ d7~64@)) (Mul (Mul b7~60@ a7~58@)
                                      (Mul c7~62@ c7~62@)
                                     )
                                    ) (Sub (Sub (Sub c7~62@ 16) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Add b7~60@
                                       b7~60@
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1415@ temp_7_1~1488@)
                                   ))
                                   (=>
                                    (= temp_7_0~1415@ temp_7_1~1488@)
                                    (=>
                                     (= temp_8_0~1589@ (Mul (Sub (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul a8~66@
                                          a8~66@
                                         ) (Mul c8~70@ d8~72@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1666@ (Mul (Sub (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul a8~66@
                                           a8~66@
                                          ) (Mul c8~70@ d8~72@)
                                         )
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1589@ temp_8_1~1666@)
                                       ))
                                       (=>
                                        (= temp_8_0~1589@ temp_8_1~1666@)
                                        (=>
                                         (= temp_9_0~1755@ (Mul (Mul (Sub (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@
                                              a9~74@
                                             ) (Mul d9~80@ d9~80@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1820@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@)) (Sub (Mul d9~80@
                                               c9~78@
                                              ) (Mul d9~80@ c9~78@)
                                             )
                                            ) (Mul (Sub (Mul c9~78@ c9~78@) (Sub c9~78@ d9~80@)) (Mul (Add c9~78@ c9~78@) (Mul b9~76@
                                          ...
                                          (and
                                           ...
                                           (=>
                                            (= temp_9_0~1755@ temp_9_1~1820@)
                                            (=>
                                             (= temp_10_0~1909@ (Add (Mul (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ c10~86@)) (Mul (
                                                  Mul b10~84@ b10~84@
                                                 ) (Mul c10~86@ c10~86@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1974@ (Add (Mul (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ c10~86@)) (Mul (
                                                   Mul b10~84@ a10~82@
                                                  ) (Mul b10~84@ c10~86@)
                                                 )
                                                ) (Mul (Mul (Add a10~82@ d10~88@) (Mul d10~88@ a10~82@)) (Add (Mul a10~82@ d10~88@)
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1909@ temp_10_1~1974@)
                                               ))
                                               (=>
                                                (= temp_10_0~1909@ temp_10_1~1974@)
                                                (=>
                                                 (= temp_11_0~2035@ (Mul (Add (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ b11~92@)) (Mul (
                                                      Sub a11~90@ d11~96@
                                                     ) (Mul a11~90@ d11~96@)
                                                    )
                                                   ) b11~92@
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2072@ (Mul b11~92@ (Add (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ b11~92@))
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~2035@ temp_11_1~2072@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~2035@ temp_11_1~2072@)
                                                    (=>
                                                     (= temp_12_0~2161@ (Sub (Mul (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ a12~98@)) (Mul
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2226@ (Sub (Mul (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ a12~98@)) (Mul
                                                      ...
                                                      (and
                                                       ...
                                                       (=>
                                                        (= temp_12_0~2161@ temp_12_1~2226@)
                                                        (=>
                                                         (= temp_13_0~2315@ (Mul (Mul (Mul (Mul c13~110@ d13~112@) (Add b13~108@ c13~110@)) (
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2380@ (Mul (Mul (Mul c13~110@ d13~112@) (Mul (Add b13~108@ c13~110@) (Mul
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2315@ temp_13_1~2380@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2315@ temp_13_1~2380@)
                                                            (=>
                                                             (= temp_14_0~2481@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@)) (
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2558@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@)) (
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2481@ temp_14_1~2558@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2481@ temp_14_1~2558@)
                                                                (=>
                                                                 (= temp_15_0~2659@ (Mul (Mul (Add (Sub c15~126@ c15~126@) (Mul d15~128@ a15~122@)) (
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2736@ (Mul (Mul (Add (Sub c15~126@ c15~126@) (Mul d15~128@ a15~122@)) (
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2659@ temp_15_1~2736@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2659@ temp_15_1~2736@)
                                                                    (=>
                                                                     (= temp_16_0~2821@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ b16~132@)) (
                                                                     ...
                                                                     (=>
                                                                      (= temp_16_1~2882@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ b16~132@)) (
                                                                          Add (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@)
                                                                         )
