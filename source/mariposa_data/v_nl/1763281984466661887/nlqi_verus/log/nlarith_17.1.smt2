...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Add (Add b0~4@ b0~4@) (Mul 11 a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@))))) (=> (= temp_0_1~394@ (Mul (Mul (Add (Add b0~4@ b0~4@) (Mul 11 a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul (Mul a0~2@ b0~4@) c0~6@) b0~4@) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~317@ temp_0_1~394@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~474@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))) (Add (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~539@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))) (Add (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~474@ temp_1_1~539@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~631@ (Mul (Sub (Add (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Sub a2~18@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Add (Mul d2~24@ 19) (Mul d2~24@ c2~22@))))) (=> (= temp_2_1~708@ (Mul (Sub (Add (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Sub a2~18@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Add (Mul d2~24@ 19) (Mul c2~22@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~631@ temp_2_1~708@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~784@ (Mul (Sub b3~28@ (Sub (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@))) (Mul (Mul (Mul d3~32@ 73) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ b3~28@) a3~26@)))) (=> (= temp_3_1~845@ (Mul (Sub b3~28@ (Sub (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@))) (Mul (Mul (Mul d3~32@ 73) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ c3~30@) a3~26@)))) (=> (= tmp%4@ (= temp_3_0~784@ temp_3_1~845@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~937@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ d4~40@)) (Sub (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul c4~38@ d4~40@) (Add c4~38@ 71)) (Mul (Mul b4~36@ d4~40@) (Add d4~40@ b4~36@))))) (=> (= temp_4_1~1014@ (Mul (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ d4~40@)) (Sub (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))) (Mul (Mul c4~38@ d4~40@) (Add c4~38@ 71))) (Mul (Mul b4~36@ d4~40@) (Add d4~40@ b4~36@)))) (=> (= tmp%5@ (= temp_4_0~937@ temp_4_1~1014@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1086@ (Mul (Mul (Add (Mul c5~46@ d5~48@) (Add d5~48@ c5~46@)) (Add (Sub d5~48@ c5~46@) d5~48@)) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@)) (Mul c5~46@ (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1143@ (Mul (Mul (Add (Sub d5~48@ c5~46@) d5~48@) (Add (Mul c5~46@ d5~48@) (Add d5~48@ c5~46@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@)) (Mul c5~46@ (Mul c5~46@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1086@ temp_5_1~1143@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1211@ (Mul (Mul (Add (Add c6~54@ c6~54@) (Mul d6~56@ d6~56@)) d6~56@) (Mul (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul a6~50@ b6~52@) (Add c6~54@ c6~54@))))) (=> (= temp_6_1~1264@ (Mul (Mul (Mul (Add (Add c6~54@ c6~54@) (Mul d6~56@ d6~56@)) d6~56@) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Mul a6~50@ b6~52@) (Add c6~54@ c6~54@)))) (=> (= tmp%7@ (= temp_6_0~1211@ temp_6_1~1264@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1352@ (Sub (Sub (Mul d7~64@ (Mul a7~58@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@))) (Sub (Sub (Sub c7~62@ 16) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Add b7~60@ b7~60@))))) (=> (= temp_7_1~1425@ (Sub (Sub (Mul d7~64@ (Mul a7~58@ d7~64@)) (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ c7~62@))) (Sub (Sub (Sub c7~62@ 16) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Add b7~60@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1352@ temp_7_1~1425@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1517@ (Mul (Sub (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul b8~68@ 32) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ b8~68@))))) (=> (= temp_8_1~1594@ (Mul (Sub (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@))) (Mul (Mul b8~68@ 32) (Mul (Mul c8~70@ d8~72@) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ b8~68@)))))) (=> (= tmp%9@ (= temp_8_0~1517@ temp_8_1~1594@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1674@ (Mul (Mul (Sub (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@))) (Mul (Sub (Mul c9~78@ c9~78@) (Sub c9~78@ d9~80@)) (Mul (Add c9~78@ c9~78@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~1739@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@)) (Sub (Mul d9~80@ c9~78@) (Mul d9~80@ c9~78@))) (Mul (Sub (Mul c9~78@ c9~78@) (Sub c9~78@ d9~80@)) (Mul (Add c9~78@ c9~78@) (Mul b9~76@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1674@ temp_9_1~1739@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1819@ (Add (Mul (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ c10~86@)) (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ c10~86@))) (Mul (Mul (Add a10~82@ d10~88@) (Mul d10~88@ a10~82@)) (Add (Mul a10~82@ d10~88@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~1884@ (Add (Mul (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ c10~86@)) (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ c10~86@))) (Mul (Mul (Add a10~82@ d10~88@) (Mul d10~88@ a10~82@)) (Add (Mul a10~82@ d10~88@) (Mul c10~86@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1819@ temp_10_1~1884@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1936@ (Mul (Add (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ b11~92@)) (Mul (Sub a11~90@ d11~96@) (Mul a11~90@ d11~96@))) b11~92@)) (=> (= temp_11_1~1973@ (Mul b11~92@ (Add (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ b11~92@)) (Mul (Sub a11~90@ d11~96@) (Mul a11~90@ d11~96@))))) (=> (= tmp%12@ (= temp_11_0~1936@ temp_11_1~1973@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2053@ (Sub (Mul (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Sub a12~98@ c12~102@) (Mul b12~100@ b12~100@))) (Mul (Mul (Sub c12~102@ a12~98@) (Sub d12~104@ a12~98@)) (Mul (Mul a12~98@ d12~104@) (Sub b12~100@ d12~104@))))) (=> (= temp_12_1~2118@ (Sub (Mul (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ b12~100@) (Sub a12~98@ c12~102@))) (Mul (Mul (Sub c12~102@ a12~98@) (Sub d12~104@ a12~98@)) (Mul (Mul a12~98@ d12~104@) (Sub b12~100@ d12~104@))))) (=> (= tmp%13@ (= temp_12_0~2053@ temp_12_1~2118@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2198@ (Mul (Mul (Mul (Mul c13~110@ d13~112@) (Add b13~108@ c13~110@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@))) (Add (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Add a13~106@ a13~106@))))) (=> (= temp_13_1~2263@ (Mul (Mul (Mul c13~110@ d13~112@) (Mul (Add b13~108@ c13~110@) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)))) (Add (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Add a13~106@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2198@ temp_13_1~2263@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2355@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@)) (Mul (Sub 90 a14~114@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul a14~114@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~2432@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@)) (Mul (Mul (Sub 90 a14~114@) b14~116@) a14~114@)) (Mul (Mul (Mul a14~114@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2355@ temp_14_1~2432@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2524@ (Mul (Mul (Add (Sub c15~126@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul a15~122@ 80) (Mul d15~128@ d15~128@))) (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~2601@ (Mul (Mul (Add (Sub c15~126@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ 80))) (Mul (Mul (Mul b15~124@ d15~128@) (Mul b15~124@ c15~126@)) (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ d15~128@))))) (=> (= tmp%16@ (= temp_15_0~2524@ temp_15_1~2601@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2677@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ b16~132@)) (Add (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@))) (Sub (Mul a16~130@ (Sub c16~134@ a16~130@)) (Mul (Sub b16~132@ d16~136@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2738@ (Add (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ b16~132@)) (Add (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@))) (Sub (Mul a16~130@ (Sub c16~134@ a16~130@)) (Mul (Mul c16~134@ a16~130@) (Sub b16~132@ d16~136@))))) (=> (= tmp%17@ (= temp_16_0~2677@ temp_16_1~2738@)) (=> %%location_label%%16 tmp%17@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
