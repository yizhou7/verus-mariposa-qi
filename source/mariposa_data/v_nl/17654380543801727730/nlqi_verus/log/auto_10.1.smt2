...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~455@ (Mul (Mul (Mul (Sub b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) b1~12@)))) (=> (= temp_1_1~516@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) b1~12@)) (Mul (Mul (Sub b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~455@ temp_1_1~516@))) (=> (= temp_1_0~455@ temp_1_1~516@) (=> (= temp_2_0~617@ (Mul (Mul (Add (Sub c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Sub a2~18@ d2~24@) (Sub a2~18@ c2~22@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ d2~24@)) (Mul (Mul 97 b2~20@) (Mul a2~18@ b2~20@))))) (=> (= temp_2_1~694@ (Mul (Mul (Mul (Add (Sub c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Sub a2~18@ d2~24@)) (Sub a2~18@ c2~22@)) (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ d2~24@)) (Mul (Mul 97 b2~20@) (Mul a2~18@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~617@ temp_2_1~694@))) (=> (= temp_2_0~617@ temp_2_1~694@) (=> (= temp_3_0~783@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Add d3~32@ a3~26@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~848@ (Mul (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Add d3~32@ a3~26@) (Mul b3~28@ d3~32@))) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@))) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~783@ temp_3_1~848@))) (=> (= temp_3_0~783@ temp_3_1~848@) (=> (= temp_4_0~937@ (Mul (Mul (Mul (Sub d4~40@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Sub c4~38@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~1002@ (Mul (Mul (Mul (Sub d4~40@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Sub c4~38@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~937@ temp_4_1~1002@))) (=> (= temp_4_0~937@ temp_4_1~1002@) (=> (= temp_5_0~1103@ (Add (Mul (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (Mul (Sub (Mul d5~48@ c5~46@) (Mul 86 d5~48@)) (Add (Add c5~46@ d5~48@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~1180@ (Add (Mul (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (Mul (Sub (Mul d5~48@ c5~46@) (Mul 86 d5~48@)) (Add (Add c5~46@ d5~48@) (Mul a5~42@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1103@ temp_5_1~1180@))) (=> (= temp_5_0~1103@ temp_5_1~1180@) (=> (= temp_6_0~1257@ (Add (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@)) (Mul (Add c6~54@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ a6~50@)) d6~56@))) (=> (= temp_6_1~1318@ (Add (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@)) (Add (Mul c6~54@ (Mul a6~50@ b6~52@)) (Mul d6~56@ (Mul a6~50@ b6~52@)))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ a6~50@)) d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1257@ temp_6_1~1318@))) (=> (= temp_6_0~1257@ temp_6_1~1318@) (=> (= temp_7_0~1395@ (Mul (Mul b7~60@ (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@))) (Add (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Add (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1448@ (Mul (Mul b7~60@ (Mul b7~60@ (Mul b7~60@ (Mul a7~58@ c7~62@)))) (Add (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Add (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1395@ temp_7_1~1448@))) (=> (= temp_7_0~1395@ temp_7_1~1448@) (=> (= temp_8_0~1537@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1602@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1537@ temp_8_1~1602@))) (=> (= temp_8_0~1537@ temp_8_1~1602@) (=> (= temp_9_0~1687@ (Mul (Sub (Mul (Sub d9~80@ a9~74@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))) (Add (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ c9~78@) d9~80@)))) (=> (= temp_9_1~1748@ (Mul (Sub (Mul (Mul d9~80@ c9~78@) (Sub d9~80@ a9~74@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))) (Add (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ c9~78@) d9~80@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1687@ temp_9_1~1748@))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
