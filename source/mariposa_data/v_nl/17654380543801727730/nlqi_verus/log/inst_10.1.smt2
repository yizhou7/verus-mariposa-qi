...
(set-info :comment ";; mariposa_data/v_nl//17654380543801727730/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_5_1~1336@ Int)
(declare-const temp_6_0~1417@ Int)
(declare-const temp_6_1~1478@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ b0~4@))))) (and (=> (= tmp%1@ (Mul d0~8@ d0~8@)) (=> (= tmp%2@ (Mul d0~8@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~467@ (Mul (Mul (Mul (Sub b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) b1~12@)))) (=> (= temp_1_1~528@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) b1~12@)) (Mul (Mul (Sub b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@))))) (and (=> (= tmp%3@ (Mul (Mul (Sub b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@)))) (=> (= tmp%4@ (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ b1~12@) b1~12@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~467@ temp_1_1~528@))))) (=> (= temp_1_0~467@ temp_1_1~528@) (=> (= temp_2_0~685@ (Mul (Mul (Add (Sub c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Sub a2~18@ d2~24@) (Sub a2~18@ c2~22@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ d2~24@)) (Mul (Mul 97 b2~20@) (Mul a2~18@ b2~20@))))) (=> (= temp_2_1~762@ (Mul (Mul (Mul (Add (Sub c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Sub a2~18@ d2~24@)) (Sub a2~18@ c2~22@)) (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ d2~24@)) (Mul (Mul 97 b2~20@) (Mul a2~18@ b2~20@))))) (and (=> (= tmp%5@ (Add (Sub c2~22@ c2~22@) (Mul a2~18@ a2~18@))) (=> (= tmp%6@ (Sub a2~18@ d2~24@)) (=> (= tmp%7@ (Sub a2~18@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~685@ temp_2_1~762@)))))) (=> (= temp_2_0~685@ temp_2_1~762@) (=> (= temp_3_0~877@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Add d3~32@ a3~26@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~942@ (Mul (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Add d3~32@ a3~26@) (Mul b3~28@ d3~32@))) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@))) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)))) (and (=> (= tmp%8@ (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Add d3~32@ a3~26@) (Mul b3~28@ d3~32@)))) (=> (= tmp%9@ (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@))) (=> (= tmp%10@ (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%3 (= temp_3_0~877@ temp_3_1~942@)))))) (=> (= temp_3_0~877@ temp_3_1~942@) (=> (= temp_4_0~1089@ (Mul (Mul (Mul (Sub d4~40@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Sub c4~38@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~1154@ (Mul (Mul (Mul (Sub d4~40@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Sub c4~38@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ a4~34@) (=> %%location_label%%4 (= temp_4_0~1089@ temp_4_1~1154@))) (=> (= temp_4_0~1089@ temp_4_1~1154@) (=> (= temp_5_0~1259@ (Add (Mul (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (Mul (Sub (Mul d5~48@ c5~46@) (Mul 86 d5~48@)) (Add (Add c5~46@ d5~48@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~1336@ (Add (Mul (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (Mul (Sub (Mul d5~48@ c5~46@) (Mul 86 d5~48@)) (Add (Add c5~46@ d5~48@) (Mul a5~42@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ d5~48@) (=> %%location_label%%5 (= temp_5_0~1259@ temp_5_1~1336@))) (=> (= temp_5_0~1259@ temp_5_1~1336@) (=> (= temp_6_0~1417@ (Add (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@)) (Mul (Add c6~54@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ a6~50@)) d6~56@))) (=> (= temp_6_1~1478@ (Add (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@)) (Add (Mul c6~54@ (Mul a6~50@ b6~52@)) (Mul d6~56@ (Mul a6~50@ b6~52@)))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ a6~50@)) d6~56@))) (and (=> (= tmp%11@ (Mul a6~50@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c6~54@ d6~56@ tmp%11@) (=> %%location_label%%6 (= temp_6_0~1417@ temp_6_1~1478@)))) (=> (= temp_6_0~1417@ temp_6_1~1478@) (=> (= temp_7_0~1565@ (Mul (Mul b7~60@ (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@))) (Add (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Add (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1618@ (Mul (Mul b7~60@ (Mul b7~60@ (Mul b7~60@ (Mul a7~58@ c7~62@)))) (Add (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Add (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))))) (and (=> (= tmp%12@ (Mul a7~58@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b7~60@ b7~60@ tmp%12@) (=> %%location_label%%7 (= temp_7_0~1565@ temp_7_1~1618@)))) (=> (= temp_7_0~1565@ temp_7_1~1618@) (=> (= temp_8_0~1717@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1782@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d8~72@ c8~70@) (=> %%location_label%%8 (= temp_8_0~1717@ temp_8_1~1782@))) (=> (= temp_8_0~1717@ temp_8_1~1782@) (=> (= temp_9_0~1871@ (Mul (Sub (Mul (Sub d9~80@ a9~74@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))) (Add (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ c9~78@) d9~80@)))) (=> (= temp_9_1~1932@ (Mul (Sub (Mul (Mul d9~80@ c9~78@) (Sub d9~80@ a9~74@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))) (Add (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ c9~78@) d9~80@)))) (=> (= tmp%13@ (Sub d9~80@ a9~74@)) (=> (= tmp%14@ (Mul d9~80@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%9 (= temp_9_0~1871@ temp_9_1~1932@))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
