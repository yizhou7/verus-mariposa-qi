...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Sub b0~4@ c0~6@) (Mul 96 d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ a0~2@))) (Mul (Mul (Sub b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Sub b0~4@ c0~6@) (Mul 96 d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ a0~2@))) (Mul (Mul (Sub b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul (Add b0~4@ b0~4@) d0~8@) a0~2@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~483@ (Mul (Mul (Sub (Mul d1~16@ a1~10@) (Sub c1~14@ c1~14@)) (Add (Sub b1~12@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~548@ (Mul (Mul (Sub (Mul d1~16@ a1~10@) (Sub c1~14@ c1~14@)) (Add (Sub b1~12@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~483@ temp_1_1~548@))) (=> (= temp_1_0~483@ temp_1_1~548@) (=> (= temp_2_0~633@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) d2~24@) (Mul (Sub d2~24@ c2~22@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ 94)) c2~22@))) (=> (= temp_2_1~694@ (Mul (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ (Mul (Sub d2~24@ c2~22@) (Mul d2~24@ c2~22@)))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ 94)) c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~633@ temp_2_1~694@))) (=> (= temp_2_0~633@ temp_2_1~694@) (=> (= temp_3_0~755@ (Mul (Mul (Mul (Sub b3~28@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@))) b3~28@)) (=> (= temp_3_1~792@ (Mul (Mul (Mul (Sub b3~28@ b3~28@) (Mul d3~32@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@))) b3~28@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~755@ temp_3_1~792@))) (=> (= temp_3_0~755@ temp_3_1~792@) (=> (= temp_4_0~881@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@))) (Mul (Sub (Sub d4~40@ c4~38@) (Mul b4~36@ a4~34@)) (Add (Mul b4~36@ a4~34@) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~946@ (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@))) (Mul (Sub (Sub d4~40@ c4~38@) (Mul b4~36@ a4~34@)) (Add (Mul b4~36@ a4~34@) (Mul c4~38@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~881@ temp_4_1~946@))) (=> (= temp_4_0~881@ temp_4_1~946@) (=> (= temp_5_0~1043@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) c5~46@) (Mul (Add d5~48@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Add d5~48@ 40) (Mul a5~42@ c5~46@))))) (=> (= temp_5_1~1116@ (Mul (Mul (Mul c5~46@ (Mul b5~44@ b5~44@)) (Mul (Add d5~48@ c5~46@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Add d5~48@ 40) (Mul a5~42@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1043@ temp_5_1~1116@))) (=> (= temp_5_0~1043@ temp_5_1~1116@) (=> (= temp_6_0~1205@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Sub c6~54@ c6~54@) (Mul c6~54@ c6~54@))) (Mul (Sub (Mul a6~50@ b6~52@) (Add b6~52@ d6~56@)) (Add (Mul a6~50@ b6~52@) (Add a6~50@ a6~50@))))) (=> (= temp_6_1~1270@ (Mul (Mul (Sub (Mul a6~50@ b6~52@) (Add b6~52@ d6~56@)) (Add (Mul a6~50@ b6~52@) (Add a6~50@ a6~50@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Sub c6~54@ c6~54@) (Mul c6~54@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1205@ temp_6_1~1270@))) (=> (= temp_6_0~1205@ temp_6_1~1270@) (=> (= temp_7_0~1367@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@))) (Add (Mul b7~60@ (Mul c7~62@ c7~62@)) (Mul (Sub c7~62@ 6) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1440@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ c7~62@)) (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@))) (Add (Mul b7~60@ (Mul c7~62@ c7~62@)) (Mul (Sub c7~62@ 6) (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1367@ temp_7_1~1440@))) (=> (= temp_7_0~1367@ temp_7_1~1440@) (=> (= temp_8_0~1529@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@)) (Add (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ c8~70@))))) (=> (= temp_8_1~1594@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@)) (Add (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1529@ temp_8_1~1594@))) (=> (= temp_8_0~1529@ temp_8_1~1594@) (=> (= temp_9_0~1695@ (Add (Mul (Mul (Mul c9~78@ d9~80@) (Add c9~78@ a9~74@)) (Mul (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Sub (Mul d9~80@ a9~74@) (Mul a9~74@ 54)) (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~1772@ (Add (Mul (Mul (Mul c9~78@ d9~80@) (Add c9~78@ a9~74@)) (Mul (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Sub (Mul d9~80@ a9~74@) (Mul a9~74@ 54)) (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1695@ temp_9_1~1772@))) (=> (= temp_9_0~1695@ temp_9_1~1772@) (=> (= temp_10_0~1857@ (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ a10~82@)) (Mul (Mul d10~88@ d10~88@) b10~84@)) (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ a10~82@))))) (=> (= temp_10_1~1918@ (Mul (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ a10~82@)) (Mul (Mul d10~88@ d10~88@) b10~84@)) (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1857@ temp_10_1~1918@))) (=> (= temp_10_0~1857@ temp_10_1~1918@) (=> (= temp_11_0~2003@ (Mul (Add (Add (Mul d11~96@ b11~92@) (Mul d11~96@ d11~96@)) (Mul b11~92@ (Sub a11~90@ a11~90@))) (Mul (Sub (Mul b11~92@ a11~90@) (Sub a11~90@ d11~96@)) (Mul (Mul d11~96@ b11~92@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2064@ (Mul (Add (Add (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)) (Mul b11~92@ (Sub a11~90@ a11~90@))) (Mul (Sub (Mul b11~92@ a11~90@) (Sub a11~90@ d11~96@)) (Mul (Mul d11~96@ b11~92@) (Mul d11~96@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2003@ temp_11_1~2064@))) (=> (= temp_11_0~2003@ temp_11_1~2064@) (=> (= temp_12_0~2153@ (Mul (Mul (Mul (Mul a12~98@ d12~104@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ d12~104@))) (Sub (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ b12~100@)) (Mul (Sub d12~104@ a12~98@) (Mul d12~104@ b12~100@))))) (=> (= temp_12_1~2218@ (Mul (Mul (Mul (Mul a12~98@ d12~104@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ d12~104@))) (Sub (Mul (Mul (Mul d12~104@ a12~98@) b12~100@) b12~100@) (Mul (Sub d12~104@ a12~98@) (Mul d12~104@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2153@ temp_12_1~2218@))) (=> (= temp_12_0~2153@ temp_12_1~2218@) (=> (= temp_13_0~2307@ (Mul (Add (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ b13~108@)) (Sub (Mul d13~112@ d13~112@) (Mul b13~108@ b13~108@))) (Mul (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ c13~110@)) (Mul (Mul b13~108@ b13~108@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2372@ (Mul (Mul (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ c13~110@)) (Mul (Mul b13~108@ b13~108@) (Mul d13~112@ a13~106@))) (Add (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ b13~108@)) (Sub (Mul d13~112@ d13~112@) (Mul b13~108@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2307@ temp_13_1~2372@))) (=> (= temp_13_0~2307@ temp_13_1~2372@) (=> (= temp_14_0~2457@ (Mul (Add (Mul (Mul c14~118@ a14~114@) (Mul c14~118@ c14~118@)) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ b14~116@))) (Mul (Mul d14~120@ (Mul b14~116@ b14~116@)) (Mul (Add a14~114@ d14~120@) (Mul d14~120@ d14~120@))))) (=> (= temp_14_1~2518@ (Mul (Mul (Add (Mul (Mul c14~118@ a14~114@) (Mul c14~118@ c14~118@)) (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ b14~116@))) (Mul d14~120@ (Mul b14~116@ b14~116@))) (Mul (Add a14~114@ d14~120@) (Mul d14~120@ d14~120@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2457@ temp_14_1~2518@))) (=> (= temp_14_0~2457@ temp_14_1~2518@) (=> (= temp_15_0~2615@ (Mul (Mul (Add (Mul a15~122@ 61) (Mul b15~124@ b15~124@)) (Mul (Mul b15~124@ c15~126@) (Mul c15~126@ a15~122@))) (Sub (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ a15~122@)) (Mul (Mul a15~122@ b15~124@) d15~128@)))) (=> (= temp_15_1~2688@ (Mul (Mul (Mul (Mul b15~124@ c15~126@) (Mul c15~126@ a15~122@)) (Add (Mul a15~122@ 61) (Mul b15~124@ b15~124@))) (Sub (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ a15~122@)) (Mul (Mul a15~122@ b15~124@) d15~128@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2615@ temp_15_1~2688@))) (=> (= temp_15_0~2615@ temp_15_1~2688@) (=> (= temp_16_0~2773@ (Mul (Mul (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ d16~136@)) (Mul (Mul b16~132@ b16~132@) a16~130@)) (Mul (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@))))) (=> (= temp_16_1~2834@ (Mul (Mul (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ d16~136@)) (Mul (Mul b16~132@ b16~132@) a16~130@)) (Mul (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2773@ temp_16_1~2834@))) (=> (= temp_16_0~2773@ temp_16_1~2834@) (=> (= temp_17_0~2935@ (Mul (Mul (Mul (Sub d17~144@ c17~142@) (Mul b17~140@ b17~140@)) (Add (Mul a17~138@ c17~142@) (Mul d17~144@ b17~140@))) (Sub (Mul (Mul d17~144@ b17~140@) (Mul b17~140@ c17~142@)) (Mul (Mul d17~144@ d17~144@) (Mul 44 b17~140@))))) (=> (= temp_17_1~3020@ (Mul (Mul (Sub (Mul d17~144@ (Mul b17~140@ b17~140@)) (Mul c17~142@ (Mul b17~140@ b17~140@))) (Add (Mul a17~138@ c17~142@) (Mul d17~144@ b17~140@))) (Sub (Mul (Mul d17~144@ b17~140@) (Mul b17~140@ c17~142@)) (Mul (Mul d17~144@ d17~144@) (Mul 44 b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2935@ temp_17_1~3020@))) (=> (= temp_17_0~2935@ temp_17_1~3020@) (=> (= temp_18_0~3105@ (Add (Mul (Mul (Mul a18~146@ d18~152@) (Add d18~152@ c18~150@)) (Mul d18~152@ (Mul c18~150@ d18~152@))) (Mul (Mul (Add d18~152@ d18~152@) (Mul a18~146@ d18~152@)) (Mul (Mul a18~146@ a18~146@) (Add a18~146@ b18~148@))))) (=> (= temp_18_1~3166@ (Add (Mul (Mul (Mul a18~146@ d18~152@) (Add d18~152@ c18~150@)) (Mul (Mul d18~152@ c18~150@) d18~152@)) (Mul (Mul (Add d18~152@ d18~152@) (Mul a18~146@ d18~152@)) (Mul (Mul a18~146@ a18~146@) (Add a18~146@ b18~148@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3105@ temp_18_1~3166@))) (=> (= temp_18_0~3105@ temp_18_1~3166@) (=> (= temp_19_0~3251@ (Mul (Mul (Add c19~158@ (Mul b19~156@ d19~160@)) (Mul (Mul c19~158@ b19~156@) (Mul d19~160@ d19~160@))) (Mul (Mul (Mul a19~154@ d19~160@) (Mul a19~154@ a19~154@)) (Sub (Mul d19~160@ c19~158@) (Mul a19~154@ c19~158@))))) (=> (= temp_19_1~3312@ (Mul (Mul (Mul (Add c19~158@ (Mul b19~156@ d19~160@)) (Mul (Mul c19~158@ b19~156@) (Mul d19~160@ d19~160@))) (Mul (Mul a19~154@ d19~160@) (Mul a19~154@ a19~154@))) (Sub (Mul d19~160@ c19~158@) (Mul a19~154@ c19~158@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3251@ temp_19_1~3312@))) (=> (= temp_19_0~3251@ temp_19_1~3312@) (=> (= temp_20_0~3401@ (Sub (Mul (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ a20~162@)) (Add (Mul a20~162@ a20~162@) (Mul c20~166@ c20~166@))) (Mul (Mul (Mul d20~168@ c20~166@) (Add b20~164@ d20~168@)) (Mul (Mul a20~162@ c20~166@) (Mul c20~166@ b20~164@))))) (=> (= temp_20_1~3466@ (Sub (Mul (Mul (Mul d20~168@ b20~164@) (Mul c20~166@ a20~162@)) (Add (Mul a20~162@ a20~162@) (Mul c20~166@ c20~166@))) (Mul (Mul (Mul c20~166@ d20~168@) (Add b20~164@ d20~168@)) (Mul (Mul a20~162@ c20~166@) (Mul c20~166@ b20~164@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3401@ temp_20_1~3466@))) (=> (= temp_20_0~3401@ temp_20_1~3466@) (=> (= temp_21_0~3563@ (Mul (Mul (Mul (Add a21~170@ b21~172@) (Add b21~172@ a21~170@)) (Mul (Mul a21~170@ a21~170@) (Mul c21~174@ a21~170@))) (Mul (Add (Mul d21~176@ 44) (Mul d21~176@ c21~174@)) (Mul (Mul d21~176@ c21~174@) c21~174@)))) (=> (= temp_21_1~3636@ (Mul (Mul (Mul (Mul a21~170@ a21~170@) (Mul c21~174@ a21~170@)) (Mul (Add a21~170@ b21~172@) (Add b21~172@ a21~170@))) (Mul (Add (Mul d21~176@ 44) (Mul d21~176@ c21~174@)) (Mul (Mul d21~176@ c21~174@) c21~174@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3563@ temp_21_1~3636@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
