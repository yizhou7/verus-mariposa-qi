...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))) (Mul (Mul (Add c0~6@ c0~6@) (Add d0~8@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Add c0~6@ c0~6@) (Add d0~8@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~471@ (Sub (Mul (Mul (Mul b1~12@ c1~14@) (Sub a1~10@ d1~16@)) (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ 46))) (Mul (Mul (Mul d1~16@ d1~16@) (Sub b1~12@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~548@ (Sub (Mul (Mul (Mul b1~12@ c1~14@) (Sub a1~10@ d1~16@)) (Mul (Mul a1~10@ c1~14@) (Mul a1~10@ 46))) (Mul (Mul (Mul d1~16@ d1~16@) (Sub b1~12@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~471@ temp_1_1~548@))) (=> (= temp_1_0~471@ temp_1_1~548@) (=> (= temp_2_0~633@ (Mul (Sub (Add c2~22@ (Mul a2~18@ c2~22@)) (Mul (Add c2~22@ c2~22@) (Mul d2~24@ b2~20@))) (Mul (Add (Mul b2~20@ d2~24@) (Mul a2~18@ b2~20@)) (Sub (Mul c2~22@ c2~22@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~694@ (Mul (Sub (Add c2~22@ (Mul a2~18@ c2~22@)) (Mul (Add c2~22@ c2~22@) (Mul d2~24@ b2~20@))) (Mul (Add (Mul b2~20@ d2~24@) (Mul a2~18@ b2~20@)) (Sub (Mul c2~22@ c2~22@) (Mul c2~22@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~633@ temp_2_1~694@))) (=> (= temp_2_0~633@ temp_2_1~694@) (=> (= temp_3_0~771@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ d3~32@)) (Mul (Sub a3~26@ b3~28@) (Mul b3~28@ b3~28@))) (Mul d3~32@ (Mul (Add d3~32@ d3~32@) (Sub c3~30@ a3~26@))))) (=> (= temp_3_1~824@ (Mul (Mul d3~32@ (Mul (Add d3~32@ d3~32@) (Sub c3~30@ a3~26@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ d3~32@)) (Mul (Sub a3~26@ b3~28@) (Mul b3~28@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~771@ temp_3_1~824@))) (=> (= temp_3_0~771@ temp_3_1~824@) (=> (= temp_4_0~901@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Add a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ b4~36@)) d4~40@))) (=> (= temp_4_1~954@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Add a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Mul a4~34@ c4~38@) (Mul (Mul a4~34@ b4~36@) d4~40@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~901@ temp_4_1~954@))) (=> (= temp_4_0~901@ temp_4_1~954@) (=> (= temp_5_0~1055@ (Mul (Mul (Mul (Mul 94 c5~46@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ b5~44@) (Add b5~44@ b5~44@))))) (=> (= temp_5_1~1132@ (Mul (Mul (Mul (Mul 94 c5~46@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Add b5~44@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1055@ temp_5_1~1132@))) (=> (= temp_5_0~1055@ temp_5_1~1132@) (=> (= temp_6_0~1233@ (Sub (Add (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ c6~54@)) (Mul (Mul 99 c6~54@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1310@ (Sub (Add (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ c6~54@)) (Mul (Mul 99 c6~54@) (Mul b6~52@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1233@ temp_6_1~1310@))) (=> (= temp_6_0~1233@ temp_6_1~1310@) (=> (= temp_7_0~1399@ (Mul (Mul (Mul (Add d7~64@ d7~64@) (Mul c7~62@ a7~58@)) (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Mul (Add c7~62@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@ b7~60@) (Sub c7~62@ d7~64@))))) (=> (= temp_7_1~1464@ (Mul (Mul (Mul (Add d7~64@ d7~64@) (Mul c7~62@ a7~58@)) (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul (Add c7~62@ a7~58@) (Mul d7~64@ b7~60@)) (Mul c7~62@ b7~60@)) (Sub c7~62@ d7~64@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1399@ temp_7_1~1464@))) (=> (= temp_7_0~1399@ temp_7_1~1464@) (=> (= temp_8_0~1525@ (Mul (Mul (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ b8~68@)) (Mul (Add d8~72@ a8~66@) (Mul c8~70@ a8~66@))) a8~66@)) (=> (= temp_8_1~1562@ (Mul (Mul (Mul b8~68@ b8~68@) (Mul (Mul a8~66@ b8~68@) (Mul (Add d8~72@ a8~66@) (Mul c8~70@ a8~66@)))) a8~66@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1525@ temp_8_1~1562@))) (=> (= temp_8_0~1525@ temp_8_1~1562@) (=> (= temp_9_0~1611@ (Add (Mul (Mul (Mul d9~80@ b9~76@) (Mul c9~78@ b9~76@)) b9~76@) b9~76@)) (=> (= temp_9_1~1636@ (Add (Mul (Mul (Mul b9~76@ d9~80@) (Mul c9~78@ b9~76@)) b9~76@) b9~76@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1611@ temp_9_1~1636@))) (=> (= temp_9_0~1611@ temp_9_1~1636@) (=> (= temp_10_0~1721@ (Mul (Mul (Mul (Sub b10~84@ b10~84@) (Mul d10~88@ b10~84@)) (Mul c10~86@ (Mul d10~88@ d10~88@))) (Sub (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ a10~82@))))) (=> (= temp_10_1~1810@ (Sub (Mul (Mul (Mul (Sub b10~84@ b10~84@) (Mul d10~88@ b10~84@)) (Mul c10~86@ (Mul d10~88@ d10~88@))) (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ d10~88@))) (Mul (Mul (Mul (Sub b10~84@ b10~84@) (Mul d10~88@ b10~84@)) (Mul c10~86@ (Mul d10~88@ d10~88@))) (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1721@ temp_10_1~1810@))) (=> (= temp_10_0~1721@ temp_10_1~1810@) (=> (= temp_11_0~1899@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)) (Add (Mul a11~90@ a11~90@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ b11~92@) (Mul c11~94@ a11~90@))))) (=> (= temp_11_1~1964@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ d11~96@)) (Add (Mul a11~90@ a11~90@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1899@ temp_11_1~1964@))) (=> (= temp_11_0~1899@ temp_11_1~1964@) (=> (= temp_12_0~2053@ (Mul (Sub (Add (Mul d12~104@ b12~100@) (Mul b12~100@ a12~98@)) (Add (Mul a12~98@ c12~102@) (Sub c12~102@ a12~98@))) (Mul (Sub (Mul d12~104@ b12~100@) (Mul a12~98@ c12~102@)) (Mul (Mul d12~104@ a12~98@) (Sub a12~98@ d12~104@))))) (=> (= temp_12_1~2118@ (Mul (Sub (Add (Mul d12~104@ b12~100@) (Mul b12~100@ a12~98@)) (Add (Mul c12~102@ a12~98@) (Sub c12~102@ a12~98@))) (Mul (Sub (Mul d12~104@ b12~100@) (Mul a12~98@ c12~102@)) (Mul (Mul d12~104@ a12~98@) (Sub a12~98@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2053@ temp_12_1~2118@))) (=> (= temp_12_0~2053@ temp_12_1~2118@) (=> (= temp_13_0~2203@ (Sub (Add (Add (Mul c13~110@ b13~108@) (Mul a13~106@ d13~112@)) (Mul (Add a13~106@ a13~106@) (Mul c13~110@ c13~110@))) (Mul (Mul b13~108@ (Add d13~112@ a13~106@)) (Mul (Mul d13~112@ d13~112@) (Add c13~110@ a13~106@))))) (=> (= temp_13_1~2264@ (Sub (Add (Add (Mul c13~110@ b13~108@) (Mul a13~106@ d13~112@)) (Mul (Add a13~106@ a13~106@) (Mul c13~110@ c13~110@))) (Mul (Mul (Mul d13~112@ d13~112@) (Add c13~110@ a13~106@)) (Mul b13~108@ (Add d13~112@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2203@ temp_13_1~2264@))) (=> (= temp_13_0~2203@ temp_13_1~2264@) (=> (= temp_14_0~2353@ (Mul (Sub (Mul (Mul c14~118@ a14~114@) (Mul d14~120@ b14~116@)) (Sub (Mul c14~118@ a14~114@) (Mul a14~114@ a14~114@))) (Sub (Add (Add b14~116@ c14~118@) (Mul a14~114@ a14~114@)) (Mul (Mul c14~118@ a14~114@) (Add a14~114@ d14~120@))))) (=> (= temp_14_1~2418@ (Mul (Sub (Mul (Mul (Mul c14~118@ a14~114@) d14~120@) b14~116@) (Sub (Mul c14~118@ a14~114@) (Mul a14~114@ a14~114@))) (Sub (Add (Add b14~116@ c14~118@) (Mul a14~114@ a14~114@)) (Mul (Mul c14~118@ a14~114@) (Add a14~114@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2353@ temp_14_1~2418@))) (=> (= temp_14_0~2353@ temp_14_1~2418@) (=> (= temp_15_0~2503@ (Mul (Mul (Mul (Sub a15~122@ d15~128@) (Mul b15~124@ d15~128@)) (Mul (Mul c15~126@ c15~126@) c15~126@)) (Mul (Mul (Mul b15~124@ c15~126@) (Mul c15~126@ a15~122@)) (Mul (Mul d15~128@ d15~128@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2564@ (Mul (Mul (Mul (Sub a15~122@ d15~128@) (Mul b15~124@ d15~128@)) (Mul (Mul c15~126@ c15~126@) c15~126@)) (Mul (Mul (Mul c15~126@ b15~124@) (Mul c15~126@ a15~122@)) (Mul (Mul d15~128@ d15~128@) (Mul c15~126@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2503@ temp_15_1~2564@))) (=> (= temp_15_0~2503@ temp_15_1~2564@) (=> (= temp_16_0~2653@ (Mul (Mul (Add (Mul d16~136@ a16~130@) (Mul d16~136@ a16~130@)) (Mul (Mul c16~134@ b16~132@) (Mul a16~130@ b16~132@))) (Mul (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ c16~134@)) (Mul (Mul b16~132@ a16~130@) (Add a16~130@ c16~134@))))) (=> (= temp_16_1~2718@ (Mul (Mul (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ c16~134@)) (Mul (Mul b16~132@ a16~130@) (Add a16~130@ c16~134@))) (Mul (Add (Mul d16~136@ a16~130@) (Mul d16~136@ a16~130@)) (Mul (Mul c16~134@ b16~132@) (Mul a16~130@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2653@ temp_16_1~2718@))) (=> (= temp_16_0~2653@ temp_16_1~2718@) (=> (= temp_17_0~2803@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ a17~138@)) (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ c17~142@))) (Mul (Mul (Sub c17~142@ a17~138@) a17~138@) (Mul (Mul b17~140@ d17~144@) (Add c17~142@ a17~138@))))) (=> (= temp_17_1~2864@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ a17~138@)) (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ c17~142@))) (Mul (Mul (Sub c17~142@ a17~138@) a17~138@) (Mul b17~140@ (Mul d17~144@ (Add c17~142@ a17~138@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2803@ temp_17_1~2864@))) (=> (= temp_17_0~2803@ temp_17_1~2864@) (=> (= temp_18_0~2925@ (Mul (Add (Mul (Mul c18~150@ d18~152@) (Mul a18~146@ b18~148@)) (Mul (Mul a18~146@ c18~150@) (Mul a18~146@ c18~150@))) c18~150@)) (=> (= temp_18_1~2962@ (Mul (Add (Mul (Mul a18~146@ b18~148@) (Mul c18~150@ d18~152@)) (Mul (Mul a18~146@ c18~150@) (Mul a18~146@ c18~150@))) c18~150@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2925@ temp_18_1~2962@))) (=> (= temp_18_0~2925@ temp_18_1~2962@) (=> (= temp_19_0~3023@ (Mul (Mul (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ d19~160@)) (Add (Add d19~160@ c19~158@) (Mul a19~154@ c19~158@))) c19~158@)) (=> (= temp_19_1~3060@ (Mul (Mul (Mul d19~160@ (Mul c19~158@ (Mul c19~158@ d19~160@))) (Add (Add d19~160@ c19~158@) (Mul a19~154@ c19~158@))) c19~158@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3023@ temp_19_1~3060@))) (=> (= temp_19_0~3023@ temp_19_1~3060@) (=> (= temp_20_0~3149@ (Mul (Mul (Mul (Add a20~162@ b20~164@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Mul d20~168@ d20~168@))) (Mul (Mul (Mul d20~168@ a20~162@) (Mul c20~166@ c20~166@)) (Mul (Mul d20~168@ c20~166@) (Mul a20~162@ c20~166@))))) (=> (= temp_20_1~3222@ (Mul (Mul (Add (Mul a20~162@ (Mul d20~168@ c20~166@)) (Mul b20~164@ (Mul d20~168@ c20~166@))) (Mul (Mul b20~164@ a20~162@) (Mul d20~168@ d20~168@))) (Mul (Mul (Mul d20~168@ a20~162@) (Mul c20~166@ c20~166@)) (Mul (Mul d20~168@ c20~166@) (Mul a20~162@ c20~166@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3149@ temp_20_1~3222@))) (=> (= temp_20_0~3149@ temp_20_1~3222@) (=> (= temp_21_0~3307@ (Add (Mul (Sub a21~170@ (Mul d21~176@ c21~174@)) (Mul (Mul d21~176@ b21~172@) (Mul a21~170@ d21~176@))) (Mul (Mul (Mul c21~174@ c21~174@) (Sub a21~170@ b21~172@)) (Mul (Add a21~170@ d21~176@) (Add a21~170@ b21~172@))))) (=> (= temp_21_1~3368@ (Add (Mul (Sub a21~170@ (Mul d21~176@ c21~174@)) (Mul (Mul b21~172@ d21~176@) (Mul a21~170@ d21~176@))) (Mul (Mul (Mul c21~174@ c21~174@) (Sub a21~170@ b21~172@)) (Mul (Add a21~170@ d21~176@) (Add a21~170@ b21~172@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3307@ temp_21_1~3368@))) (=> (= temp_21_0~3307@ temp_21_1~3368@) (=> (= temp_22_0~3453@ (Mul (Mul (Add (Mul c22~182@ c22~182@) (Add d22~184@ d22~184@)) (Mul b22~180@ (Mul d22~184@ a22~178@))) (Mul (Mul (Mul b22~180@ c22~182@) (Mul a22~178@ a22~178@)) (Mul (Sub d22~184@ c22~182@) (Mul b22~180@ d22~184@))))) (=> (= temp_22_1~3514@ (Mul (Mul (Add (Mul c22~182@ c22~182@) (Add d22~184@ d22~184@)) (Mul b22~180@ (Mul d22~184@ a22~178@))) (Mul (Mul (Mul c22~182@ b22~180@) (Mul a22~178@ a22~178@)) (Mul (Sub d22~184@ c22~182@) (Mul b22~180@ d22~184@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3453@ temp_22_1~3514@))) (=> (= temp_22_0~3453@ temp_22_1~3514@) (=> (= temp_23_0~3611@ (Sub (Mul (Mul (Mul b23~188@ d23~192@) (Mul 18 d23~192@)) (Add (Mul a23~186@ b23~188@) (Mul d23~192@ c23~190@))) (Mul (Mul (Mul a23~186@ c23~190@) (Mul c23~190@ a23~186@)) (Mul d23~192@ (Mul a23~186@ b23~188@))))) (=> (= temp_23_1~3684@ (Sub (Mul (Mul (Mul b23~188@ d23~192@) (Mul d23~192@ 18)) (Add (Mul a23~186@ b23~188@) (Mul d23~192@ c23~190@))) (Mul (Mul (Mul a23~186@ c23~190@) (Mul c23~190@ a23~186@)) (Mul d23~192@ (Mul a23~186@ b23~188@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3611@ temp_23_1~3684@))) (=> (= temp_23_0~3611@ temp_23_1~3684@) (=> (= temp_24_0~3773@ (Mul (Mul (Mul (Sub c24~198@ a24~194@) (Mul b24~196@ a24~194@)) (Mul (Mul a24~194@ d24~200@) (Mul a24~194@ a24~194@))) (Mul (Mul (Mul a24~194@ b24~196@) (Mul a24~194@ a24~194@)) (Mul (Mul b24~196@ a24~194@) (Mul a24~194@ a24~194@))))) (=> (= temp_24_1~3838@ (Mul (Mul (Mul (Sub c24~198@ a24~194@) (Mul a24~194@ b24~196@)) (Mul (Mul a24~194@ d24~200@) (Mul a24~194@ a24~194@))) (Mul (Mul (Mul a24~194@ b24~196@) (Mul a24~194@ a24~194@)) (Mul (Mul b24~196@ a24~194@) (Mul a24~194@ a24~194@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3773@ temp_24_1~3838@))) (=> (= temp_24_0~3773@ temp_24_1~3838@) (=> (= temp_25_0~3939@ (Mul (Mul (Mul (Mul d25~208@ d25~208@) (Sub b25~204@ b25~204@)) (Mul (Mul c25~206@ b25~204@) (Mul a25~202@ 31))) (Add (Mul (Mul d25~208@ b25~204@) (Add b25~204@ b25~204@)) (Mul (Mul c25~206@ b25~204@) (Mul c25~206@ c25~206@))))) (=> (= temp_25_1~4016@ (Mul (Mul (Mul (Mul d25~208@ d25~208@) (Sub b25~204@ b25~204@)) (Mul (Mul c25~206@ b25~204@) (Mul a25~202@ 31))) (Add (Mul d25~208@ (Mul b25~204@ (Add b25~204@ b25~204@))) (Mul (Mul c25~206@ b25~204@) (Mul c25~206@ c25~206@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~3939@ temp_25_1~4016@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
