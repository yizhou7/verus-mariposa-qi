...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul (Mul (Sub d0~8@ c0~6@) (Mul b0~4@ d0~8@)) b0~4@) (Mul (Add (Mul d0~8@ c0~6@) d0~8@) (Mul (Sub d0~8@ c0~6@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~338@ (Mul (Mul (Sub d0~8@ c0~6@) (Mul (Mul b0~4@ d0~8@) b0~4@)) (Mul (Add (Mul d0~8@ c0~6@) d0~8@) (Mul (Sub d0~8@ c0~6@) (Mul b0~4@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~289@ temp_0_1~338@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~430@ (Mul (Mul (Add (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul 22 d1~16@))) (Sub (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ b1~12@)) (Sub (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~551@ (Sub (Mul (Mul (Add (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul 22 d1~16@))) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ b1~12@))) (Mul (Mul (Add (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul 22 d1~16@))) (Sub (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~430@ temp_1_1~551@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~615@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Add c2~22@ d2~24@)) (Sub d2~24@ (Mul d2~24@ b2~20@))) (Mul a2~18@ (Mul (Add c2~22@ d2~24@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~664@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Add c2~22@ d2~24@)) (Sub d2~24@ (Mul d2~24@ b2~20@))) (Mul a2~18@ (Mul (Add c2~22@ d2~24@) (Mul d2~24@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~615@ temp_2_1~664@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~740@ (Mul (Mul (Mul c3~30@ (Mul b3~28@ b3~28@)) (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Add c3~30@ d3~32@))))) (=> (= temp_3_1~801@ (Mul (Mul (Mul c3~30@ (Mul b3~28@ b3~28@)) (Mul (Mul (Mul d3~32@ a3~26@) c3~30@) c3~30@)) (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Add c3~30@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~740@ temp_3_1~801@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~881@ (Add (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@)) (Add (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Sub c4~38@ d4~40@) (Add b4~36@ a4~34@))))) (=> (= temp_4_1~946@ (Add (Mul (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ c4~38@)) (Add (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Sub c4~38@ d4~40@) (Add b4~36@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~881@ temp_4_1~946@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1026@ (Mul (Mul (Add (Sub c5~46@ c5~46@) (Sub b5~44@ b5~44@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))) (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1091@ (Mul (Mul (Add (Sub c5~46@ c5~46@) (Sub b5~44@ b5~44@)) (Mul (Mul (Mul c5~46@ c5~46@) c5~46@) c5~46@)) (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1026@ temp_5_1~1091@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1171@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul a6~50@ d6~56@)) (Mul (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1236@ (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul a6~50@ d6~56@)) (Mul (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Mul (Mul d6~56@ b6~52@) c6~54@) c6~54@)))) (=> (= tmp%7@ (= temp_6_0~1171@ temp_6_1~1236@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1300@ (Add (Mul (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ b7~60@)) (Add a7~58@ (Mul a7~58@ a7~58@))) (Sub (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ a7~58@)) b7~60@))) (=> (= temp_7_1~1349@ (Add (Mul (Mul c7~62@ b7~60@) (Mul (Mul d7~64@ b7~60@) (Add a7~58@ (Mul a7~58@ a7~58@)))) (Sub (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ a7~58@)) b7~60@))) (=> (= tmp%8@ (= temp_7_0~1300@ temp_7_1~1349@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1429@ (Mul (Mul (Mul (Sub b8~68@ c8~70@) (Add c8~70@ b8~68@)) (Mul (Add b8~68@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ d8~72@)) (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))))) (=> (= temp_8_1~1494@ (Mul (Mul (Mul (Sub b8~68@ c8~70@) (Add c8~70@ b8~68@)) (Mul (Add b8~68@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1429@ temp_8_1~1494@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1542@ (Add b9~76@ (Mul (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ c9~78@)) (Mul a9~74@ (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1575@ (Add b9~76@ (Mul (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ c9~78@)) (Mul a9~74@ (Mul a9~74@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1542@ temp_9_1~1575@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1679@ (Add (Mul (Mul (Mul c10~86@ c10~86@) (Sub 10 b10~84@)) (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ c10~86@))) (Add (Mul (Mul b10~84@ b10~84@) (Mul 32 b10~84@)) (Mul (Mul c10~86@ d10~88@) (Sub d10~88@ c10~86@))))) (=> (= temp_10_1~1768@ (Add (Mul (Mul (Mul c10~86@ c10~86@) (Sub 10 b10~84@)) (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ c10~86@))) (Add (Mul (Mul 32 b10~84@) (Mul b10~84@ b10~84@)) (Mul (Mul c10~86@ d10~88@) (Sub d10~88@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1679@ temp_10_1~1768@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1836@ (Mul (Mul c11~94@ (Sub (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@))) (Sub (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ a11~90@))))) (=> (= temp_11_1~1909@ (Sub (Mul (Mul c11~94@ (Sub (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@))) (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Mul c11~94@ (Sub (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@))) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1836@ temp_11_1~1909@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2005@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) a12~98@) (Mul c12~102@ (Sub 68 d12~104@))) (Mul (Mul (Add d12~104@ a12~98@) (Mul b12~100@ c12~102@)) (Mul (Mul b12~100@ 58) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2086@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) a12~98@) (Mul c12~102@ (Sub 68 d12~104@))) (Mul (Mul (Add d12~104@ a12~98@) (Mul b12~100@ c12~102@)) (Mul (Mul (Mul b12~100@ 58) b12~100@) a12~98@)))) (=> (= tmp%13@ (= temp_12_0~2005@ temp_12_1~2086@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2162@ (Mul (Sub (Mul c13~110@ (Mul c13~110@ d13~112@)) (Mul (Mul a13~106@ a13~106@) (Mul d13~112@ a13~106@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ b13~108@)) (Sub (Mul d13~112@ b13~108@) (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~2219@ (Mul (Sub (Mul c13~110@ (Mul c13~110@ d13~112@)) (Mul (Mul a13~106@ a13~106@) (Mul d13~112@ a13~106@))) (Mul (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ b13~108@)) (Mul d13~112@ (Sub b13~108@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2162@ temp_13_1~2219@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2271@ (Mul c14~118@ (Mul (Sub (Mul a14~114@ c14~118@) (Mul b14~116@ d14~120@)) (Mul (Sub b14~116@ c14~118@) (Mul a14~114@ c14~118@))))) (=> (= temp_14_1~2308@ (Mul c14~118@ (Mul (Sub (Mul c14~118@ a14~114@) (Mul b14~116@ d14~120@)) (Mul (Sub b14~116@ c14~118@) (Mul a14~114@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2271@ temp_14_1~2308@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2380@ (Mul (Add (Mul (Mul d15~128@ b15~124@) b15~124@) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ c15~126@))) (Mul (Add (Mul b15~124@ a15~122@) (Mul d15~128@ d15~128@)) (Mul b15~124@ (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~2437@ (Mul (Add (Mul (Mul d15~128@ b15~124@) b15~124@) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ c15~126@))) (Mul (Add (Mul b15~124@ a15~122@) (Mul d15~128@ d15~128@)) (Mul (Mul b15~124@ c15~126@) a15~122@)))) (=> (= tmp%16@ (= temp_15_0~2380@ temp_15_1~2437@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2513@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ c16~134@)) (Sub (Sub a16~130@ c16~134@) (Mul a16~130@ b16~132@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ a16~130@)) (Mul b16~132@ (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~2574@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ c16~134@)) (Sub (Sub a16~130@ c16~134@) (Mul a16~130@ b16~132@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul a16~130@ d16~136@) b16~132@)))) (=> (= tmp%17@ (= temp_16_0~2513@ temp_16_1~2574@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2654@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Sub a17~138@ c17~142@)) (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@))) (Mul (Mul (Mul d17~144@ c17~142@) (Add b17~140@ b17~140@)) (Sub (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@))))) (=> (= temp_17_1~2727@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Sub a17~138@ c17~142@)) (Mul (Mul b17~140@ c17~142@) (Mul a17~138@ d17~144@))) (Mul (Add (Mul (Mul d17~144@ c17~142@) b17~140@) (Mul (Mul d17~144@ c17~142@) b17~140@)) (Sub (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@))))) (=> (= tmp%18@ (= temp_17_0~2654@ temp_17_1~2727@)) (=> %%location_label%%17 tmp%18@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
