...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Add (Mul (Sub (Mul b0~4@ a0~2@) c0~6@) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Add a0~2@ d0~8@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~362@ (Add (Mul (Sub (Mul b0~4@ a0~2@) c0~6@) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Add a0~2@ d0~8@) (Mul d0~8@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~427@ (Mul (Mul (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@)) a1~10@) (Add a1~10@ (Mul (Add a1~10@ a1~10@) (Sub b1~12@ d1~16@))))) (=> (= temp_1_1~468@ (Mul (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@)) (Mul a1~10@ (Add a1~10@ (Mul (Add a1~10@ a1~10@) (Sub b1~12@ d1~16@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~427@ temp_1_1~468@))) (=> (= temp_1_0~427@ temp_1_1~468@) (=> (= temp_2_0~545@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ d2~24@)) a2~18@) (Mul (Add (Sub c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~598@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ d2~24@)) a2~18@) (Mul (Add (Sub c2~22@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~545@ temp_2_1~598@))) (=> (= temp_2_0~545@ temp_2_1~598@) (=> (= temp_3_0~671@ (Mul (Sub (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@ b3~28@) d3~32@)) (Mul b3~28@ (Sub (Mul c3~30@ b3~28@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~740@ (Sub (Mul (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ d3~32@)) (Mul b3~28@ (Sub (Mul c3~30@ b3~28@) (Mul c3~30@ d3~32@)))) (Mul (Mul (Mul c3~30@ b3~28@) d3~32@) (Mul b3~28@ (Sub (Mul c3~30@ b3~28@) (Mul c3~30@ d3~32@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~671@ temp_3_1~740@))) (=> (= temp_3_0~671@ temp_3_1~740@) (=> (= temp_4_0~841@ (Mul (Mul (Mul (Add b4~36@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Sub a4~34@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul (Sub c4~38@ a4~34@) (Sub b4~36@ 46)) (Mul (Add d4~40@ d4~40@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~918@ (Mul (Mul (Mul (Mul (Add b4~36@ b4~36@) (Mul b4~36@ d4~40@)) (Sub a4~34@ a4~34@)) (Mul d4~40@ b4~36@)) (Mul (Mul (Sub c4~38@ a4~34@) (Sub b4~36@ 46)) (Mul (Add d4~40@ d4~40@) (Mul c4~38@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~841@ temp_4_1~918@))) (=> (= temp_4_0~841@ temp_4_1~918@) (=> (= temp_5_0~979@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Sub d5~48@ c5~46@)) (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ b5~44@))) a5~42@)) (=> (= temp_5_1~1016@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Sub d5~48@ c5~46@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@))) a5~42@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~979@ temp_5_1~1016@))) (=> (= temp_5_0~979@ temp_5_1~1016@) (=> (= temp_6_0~1105@ (Mul (Mul (Mul (Sub c6~54@ d6~56@) (Mul a6~50@ b6~52@)) (Add (Sub c6~54@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1170@ (Mul (Mul (Mul (Mul (Sub c6~54@ d6~56@) (Mul a6~50@ b6~52@)) (Add (Sub c6~54@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ b6~52@))) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1105@ temp_6_1~1170@))) (=> (= temp_6_0~1105@ temp_6_1~1170@) (=> (= temp_7_0~1235@ (Mul (Mul c7~62@ c7~62@) (Mul (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@)) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ c7~62@))))) (=> (= temp_7_1~1276@ (Mul (Mul c7~62@ c7~62@) (Mul (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@)) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1235@ temp_7_1~1276@))) (=> (= temp_7_0~1235@ temp_7_1~1276@) (=> (= temp_8_0~1377@ (Add (Mul (Mul (Sub d8~72@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ a8~66@))) (Add (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ c8~70@)) (Add (Mul d8~72@ 17) (Sub a8~66@ a8~66@))))) (=> (= temp_8_1~1454@ (Add (Mul (Mul (Sub d8~72@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@))) (Add (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ c8~70@)) (Add (Mul d8~72@ 17) (Sub a8~66@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1377@ temp_8_1~1454@))) (=> (= temp_8_0~1377@ temp_8_1~1454@) (=> (= temp_9_0~1531@ (Sub (Mul b9~76@ (Mul (Sub d9~80@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~1584@ (Sub (Mul (Mul (Sub d9~80@ c9~78@) (Mul a9~74@ a9~74@)) b9~76@) (Mul (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1531@ temp_9_1~1584@))) (=> (= temp_9_0~1531@ temp_9_1~1584@) (=> (= temp_10_0~1669@ (Mul (Mul (Add (Add b10~84@ b10~84@) (Mul c10~86@ b10~84@)) (Add (Mul d10~88@ d10~88@) d10~88@)) (Add (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ a10~82@)) (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ b10~84@))))) (=> (= temp_10_1~1730@ (Mul (Mul (Add (Add b10~84@ b10~84@) (Mul c10~86@ b10~84@)) (Add (Mul d10~88@ d10~88@) d10~88@)) (Add (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ c10~86@)) (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1669@ temp_10_1~1730@))) (=> (= temp_10_0~1669@ temp_10_1~1730@) (=> (= temp_11_0~1827@ (Mul (Mul (Add (Mul b11~92@ c11~94@) (Mul c11~94@ a11~90@)) (Mul (Mul c11~94@ d11~96@) (Sub b11~92@ c11~94@))) (Mul (Mul (Add b11~92@ c11~94@) (Mul d11~96@ d11~96@)) (Mul (Mul a11~90@ a11~90@) 68)))) (=> (= temp_11_1~1900@ (Mul (Mul (Mul (Add b11~92@ c11~94@) (Mul d11~96@ d11~96@)) (Mul (Mul a11~90@ a11~90@) 68)) (Mul (Add (Mul b11~92@ c11~94@) (Mul c11~94@ a11~90@)) (Mul (Mul c11~94@ d11~96@) (Sub b11~92@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1827@ temp_11_1~1900@))) (=> (= temp_11_0~1827@ temp_11_1~1900@) (=> (= temp_12_0~1989@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Add c12~102@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ d12~104@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul a12~98@ d12~104@)) (Add (Mul c12~102@ a12~98@) (Mul c12~102@ b12~100@))))) (=> (= temp_12_1~2054@ (Mul (Mul (Mul b12~100@ c12~102@) (Add c12~102@ a12~98@)) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ d12~104@)) (Mul (Mul (Mul b12~100@ d12~104@) (Mul a12~98@ d12~104@)) (Add (Mul c12~102@ a12~98@) (Mul c12~102@ b12~100@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~1989@ temp_12_1~2054@))) (=> (= temp_12_0~1989@ temp_12_1~2054@) (=> (= temp_13_0~2143@ (Sub (Mul (Mul (Mul d13~112@ b13~108@) (Add c13~110@ b13~108@)) (Mul (Mul d13~112@ d13~112@) (Add d13~112@ a13~106@))) (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ a13~106@) (Mul c13~110@ c13~110@))))) (=> (= temp_13_1~2208@ (Sub (Mul (Mul (Mul b13~108@ d13~112@) (Add c13~110@ b13~108@)) (Mul (Mul d13~112@ d13~112@) (Add d13~112@ a13~106@))) (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ a13~106@) (Mul c13~110@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2143@ temp_13_1~2208@))) (=> (= temp_13_0~2143@ temp_13_1~2208@) (=> (= temp_14_0~2297@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ d14~120@)) (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ d14~120@))))) (=> (= temp_14_1~2362@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ d14~120@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ d14~120@)) (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2297@ temp_14_1~2362@))) (=> (= temp_14_0~2297@ temp_14_1~2362@) (=> (= temp_15_0~2455@ (Mul (Mul (Sub (Mul c15~126@ d15~128@) (Sub d15~128@ b15~124@)) (Mul (Mul a15~122@ c15~126@) d15~128@)) (Mul (Mul (Mul c15~126@ a15~122@) b15~124@) (Sub (Mul b15~124@ 53) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2524@ (Mul (Mul (Sub (Mul c15~126@ d15~128@) (Sub d15~128@ b15~124@)) (Mul (Mul a15~122@ c15~126@) d15~128@)) (Mul (Mul (Mul c15~126@ a15~122@) b15~124@) (Sub (Mul b15~124@ 53) (Mul d15~128@ d15~128@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2455@ temp_15_1~2524@))) (=> (= temp_15_0~2455@ temp_15_1~2524@) (=> (= temp_16_0~2613@ (Sub (Add (Mul (Mul c16~134@ d16~136@) (Mul c16~134@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Add d16~136@ b16~132@))) (Mul (Mul (Add c16~134@ d16~136@) (Mul c16~134@ a16~130@)) (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ b16~132@))))) (=> (= temp_16_1~2686@ (Sub (Add (Mul (Mul c16~134@ d16~136@) (Mul c16~134@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Add d16~136@ b16~132@))) (Mul (Add (Mul c16~134@ (Mul c16~134@ a16~130@)) (Mul d16~136@ (Mul c16~134@ a16~130@))) (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2613@ temp_16_1~2686@))) (=> (= temp_16_0~2613@ temp_16_1~2686@) (=> (= temp_17_0~2771@ (Mul (Mul (Add (Sub b17~140@ d17~144@) (Mul a17~138@ c17~142@)) (Sub d17~144@ (Mul c17~142@ c17~142@))) (Add (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul c17~142@ b17~140@) (Sub c17~142@ d17~144@))))) (=> (= temp_17_1~2832@ (Mul (Mul (Add (Sub b17~140@ d17~144@) (Mul a17~138@ c17~142@)) (Sub d17~144@ (Mul c17~142@ c17~142@))) (Add (Mul (Mul a17~138@ c17~142@) (Mul a17~138@ b17~140@)) (Mul (Mul c17~142@ b17~140@) (Sub c17~142@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2771@ temp_17_1~2832@))) (=> (= temp_17_0~2771@ temp_17_1~2832@) (=> (= temp_18_0~2937@ (Mul (Add (Mul (Mul 61 c18~150@) c18~150@) (Mul (Mul 50 a18~146@) (Mul c18~150@ b18~148@))) (Sub (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ c18~150@)) (Mul (Mul d18~152@ c18~150@) d18~152@)))) (=> (= temp_18_1~3018@ (Mul (Add (Mul (Mul 61 c18~150@) c18~150@) (Mul (Mul 50 a18~146@) (Mul c18~150@ b18~148@))) (Sub (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ c18~150@)) (Mul d18~152@ (Mul d18~152@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2937@ temp_18_1~3018@))) (=> (= temp_18_0~2937@ temp_18_1~3018@) (=> (= temp_19_0~3091@ (Sub (Mul (Mul (Mul d19~160@ c19~158@) (Mul d19~160@ a19~154@)) (Sub d19~160@ (Add a19~154@ c19~158@))) (Mul (Mul (Mul d19~160@ b19~156@) (Mul b19~156@ b19~156@)) c19~158@))) (=> (= temp_19_1~3140@ (Sub (Mul (Mul (Mul d19~160@ c19~158@) (Mul d19~160@ a19~154@)) (Sub d19~160@ (Add a19~154@ c19~158@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul d19~160@ b19~156@)) c19~158@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3091@ temp_19_1~3140@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
