...
;; mariposa_data/v_nl//10397734997551711464/nlqi_verus/src/main.rs:7:1: 36:40 (#0)
(push)
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~301@ (Mul (Sub (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ d0~8@)
         (Mul a0~2@ d0~8@)
        )
       ) (Mul (Mul b0~4@ (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Add a0~2@ b0~4@)))
     ))
     (=>
      (= temp_0_1~362@ (Mul (Sub (Mul b0~4@ (Mul a0~2@ (Mul d0~8@ d0~8@))) (Mul (Mul b0~4@ d0~8@)
          (Mul a0~2@ d0~8@)
         )
        ) (Mul (Mul b0~4@ (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Add a0~2@ b0~4@)))
      ))
      (and
       ...
       (=>
        (= temp_0_0~301@ temp_0_1~362@)
        (=>
         (= temp_1_0~459@ (Mul (Sub (Mul (Mul a1~10@ b1~12@) (Sub a1~10@ c1~14@)) (Mul (Mul b1~12@
              c1~14@
             ) (Mul 76 d1~16@)
            )
           ) (Mul (Mul (Mul b1~12@ b1~12@) c1~14@) (Add (Mul b1~12@ a1~10@) (Mul c1~14@ b1~12@)))
         ))
         (=>
          (= temp_1_1~532@ (Mul (Sub (Mul (Mul a1~10@ b1~12@) (Sub a1~10@ c1~14@)) (Mul (Mul (Mul
                b1~12@ c1~14@
               ) 76
              ) d1~16@
             )
          ...
          (and
           ...
           (=>
            (= temp_1_0~459@ temp_1_1~532@)
            (=>
             (= temp_2_0~609@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Add d2~24@ b2~20@)) (Mul (Mul a2~18@
                  b2~20@
                 ) (Mul b2~20@ a2~18@)
                )
               ) (Mul (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@)) d2~24@)
             ))
             (=>
              (= temp_2_1~662@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Add d2~24@ b2~20@)) (Mul (Mul a2~18@
                   b2~20@
                  ) (Mul a2~18@ b2~20@)
                 )
                ) (Mul (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@)) d2~24@)
              ...
              (and
               ...
               (=>
                (= temp_2_0~609@ temp_2_1~662@)
                (=>
                 (= temp_3_0~751@ (Mul (Mul (Sub (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Add (Sub b3~28@
                      a3~26@
                     ) (Sub c3~30@ b3~28@)
                    )
                   ) (Mul (Mul (Mul d3~32@ a3~26@) (Sub c3~30@ d3~32@)) (Add (Sub a3~26@ c3~30@) (Mul c3~30@
                      b3~28@
                 )))))
                 (=>
                  (= temp_3_1~816@ (Mul (Mul (Sub (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Add (Sub b3~28@
                       a3~26@
                      ) (Sub c3~30@ b3~28@)
                     )
                    ) (Mul (Mul d3~32@ (Mul a3~26@ (Sub c3~30@ d3~32@))) (Add (Sub a3~26@ c3~30@) (Mul c3~30@
                       b3~28@
                  )))))
                  (and
                   (=>
                   ...
                   (=>
                    (= temp_3_0~751@ temp_3_1~816@)
                    (=>
                     (= temp_4_0~901@ (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Add (Mul a4~34@
                          a4~34@
                         ) (Mul d4~40@ d4~40@)
                        )
                       ) (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ b4~36@) d4~40@))
                     ))
                     (=>
                      (= temp_4_1~978@ (Mul (Add (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul a4~34@
                           a4~34@
                          )
                         ) (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul d4~40@ d4~40@))
                        ) (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ b4~36@) d4~40@))
                      ))
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~901@ temp_4_1~978@)
                       ))
                       (=>
                        (= temp_4_0~901@ temp_4_1~978@)
                        (=>
                         (= temp_5_0~1063@ (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@
                              c5~46@
                             ) a5~42@
                            )
                           ) (Sub (Add (Sub c5~46@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Add a5~42@ d5~48@) (Mul a5~42@
                              a5~42@
                         )))))
                         (=>
                          (= temp_5_1~1124@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@
                               c5~46@
                              ) a5~42@
                             )
                            ) (Sub (Add (Sub c5~46@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Add a5~42@ d5~48@) (Mul a5~42@
                          ...
                          (and
                           ...
                           (=>
                            (= temp_5_0~1063@ temp_5_1~1124@)
                            (=>
                             (= temp_6_0~1213@ (Mul (Mul (Add (Sub b6~52@ b6~52@) (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@
                                  b6~52@
                                 ) (Mul c6~54@ b6~52@)
                                )
                               ) (Mul (Sub (Mul a6~50@ d6~56@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@
                                  d6~56@
                             )))))
                             (=>
                              (= temp_6_1~1278@ (Mul (Mul (Add (Sub b6~52@ b6~52@) (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@
                                   b6~52@
                                  ) (Mul b6~52@ c6~54@)
                                 )
                                ) (Mul (Sub (Mul a6~50@ d6~56@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@
                              ...
                              (and
                               ...
                               (=>
                                (= temp_6_0~1213@ temp_6_1~1278@)
                                (=>
                                 (= temp_7_0~1351@ (Mul (Mul (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul c7~62@
                                      b7~60@
                                     ) a7~58@
                                    )
                                   ) (Mul (Sub (Mul a7~58@ b7~60@) (Add c7~62@ c7~62@)) b7~60@)
                                 ))
                                 (=>
                                  (= temp_7_1~1400@ (Mul (Mul (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul a7~58@
                                      (Mul c7~62@ b7~60@)
                                     )
                                    ) (Mul (Sub (Mul a7~58@ b7~60@) (Add c7~62@ c7~62@)) b7~60@)
                                  ))
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1351@ temp_7_1~1400@)
                                   ))
                                   (=>
                                    (= temp_7_0~1351@ temp_7_1~1400@)
                                    (=>
                                     (= temp_8_0~1489@ (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ d8~72@)) (Add (Mul c8~70@
                                          c8~70@
                                         ) (Mul a8~66@ a8~66@)
                                        )
                                       ) (Mul (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@
                                          b8~68@
                                     )))))
                                     (=>
                                      (= temp_8_1~1554@ (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ a8~66@)) (Add (Mul c8~70@
                                           c8~70@
                                          ) (Mul a8~66@ a8~66@)
                                         )
                                        ) (Mul (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@
                                      ...
                                      (and
                                       ...
                                       (=>
                                        (= temp_8_0~1489@ temp_8_1~1554@)
                                        (=>
                                         (= temp_9_0~1651@ (Mul (Mul (Mul a9~74@ (Mul c9~78@ a9~74@)) (Mul (Mul d9~80@ a9~74@)
                                             (Mul b9~76@ 17)
                                            )
                                           ) (Mul (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@
                                              b9~76@
                                         )))))
                                         (=>
                                          (= temp_9_1~1724@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) a9~74@) (Mul (Mul d9~80@ a9~74@)
                                              (Mul b9~76@ 17)
                                             )
                                            ) (Mul (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@
                                               b9~76@
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1651@ temp_9_1~1724@)
                                           ))
                                           (=>
                                            (= temp_9_0~1651@ temp_9_1~1724@)
                                            (=>
                                             (= temp_10_0~1809@ (Mul (Mul (Mul (Mul a10~82@ b10~84@) (Mul b10~84@ c10~86@)) (Add (
                                                  Mul c10~86@ d10~88@
                                                 ) (Mul d10~88@ a10~82@)
                                                )
                                               ) (Mul (Mul (Mul d10~88@ b10~84@) (Add a10~82@ d10~88@)) (Mul d10~88@ (Mul d10~88@ d10~88@)))
                                             ))
                                             (=>
                                              (= temp_10_1~1870@ (Mul (Mul (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ c10~86@)) (Add (
                                                   Mul c10~86@ d10~88@
                                                  ) (Mul d10~88@ a10~82@)
                                                 )
                                                ) (Mul (Mul (Mul d10~88@ b10~84@) (Add a10~82@ d10~88@)) (Mul d10~88@ (Mul d10~88@ d10~88@)))
                                              ...
                                              (and
                                               ...
                                               (=>
                                                (= temp_10_0~1809@ temp_10_1~1870@)
                                                (=>
                                                 (= temp_11_0~1983@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Add b11~92@ c11~94@)) (Add (
                                                      Mul c11~94@ d11~96@
                                                     ) (Mul 81 c11~94@)
                                                    )
                                                   ) (Mul (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ c11~94@)) (Mul (Mul d11~96@ 18) (Mul
                                                      b11~92@ b11~92@
                                                 )))))
                                                 (=>
                                                  (= temp_11_1~2072@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Add b11~92@ c11~94@)) (Add (
                                                       Mul c11~94@ d11~96@
                                                      ) (Mul 81 c11~94@)
                                                     )
                                                    ) (Mul (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ c11~94@)) (Mul (Mul d11~96@ 18) (Mul
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~1983@ temp_11_1~2072@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~1983@ temp_11_1~2072@)
                                                    (=>
                                                     (= temp_12_0~2149@ (Mul (Mul b12~100@ (Mul (Mul c12~102@ b12~100@) (Add b12~100@ d12~104@)))
                                                       (Mul (Mul (Sub c12~102@ a12~98@) (Add b12~100@ d12~104@)) (Sub (Add b12~100@ c12~102@)
                                                         (Mul c12~102@ a12~98@)
                                                     ))))
                                                     (=>
                                                      (= temp_12_1~2202@ (Mul (Mul (Mul (Mul c12~102@ b12~100@) (Add b12~100@ d12~104@)) b12~100@)
                                                        (Mul (Mul (Sub c12~102@ a12~98@) (Add b12~100@ d12~104@)) (Sub (Add b12~100@ c12~102@)
                                                          (Mul c12~102@ a12~98@)
                                                      ))))
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2149@ temp_12_1~2202@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2149@ temp_12_1~2202@)
                                                        (=>
                                                         (= temp_13_0~2299@ (Sub (Mul (Mul (Mul c13~110@ c13~110@) (Mul d13~112@ b13~108@)) (
                                                             Mul (Mul b13~108@ d13~112@) (Mul d13~112@ a13~106@)
                                                            )
                                                           ) (Sub (Mul (Mul 96 d13~112@) a13~106@) (Mul (Mul a13~106@ c13~110@) (Mul b13~108@ c13~110@)))
                                                         ))
                                                         (=>
                                                          (= temp_13_1~2372@ (Sub (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Mul d13~112@ b13~108@))
                                                              (Mul b13~108@ d13~112@)
                                                             ) (Mul d13~112@ a13~106@)
                                                            ) (Sub (Mul (Mul 96 d13~112@) a13~106@) (Mul (Mul a13~106@ c13~110@) (Mul b13~108@ c13~110@)))
                                                          ))
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2299@ temp_13_1~2372@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2299@ temp_13_1~2372@)
                                                            (=>
                                                             (= temp_14_0~2461@ (Mul (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ c14~118@)) (
                                                                 Mul (Mul d14~120@ a14~114@) (Mul a14~114@ d14~120@)
                                                                )
                                                               ) (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ a14~114@)) (Sub (Mul c14~118@ b14~116@)
                                                                 (Mul d14~120@ b14~116@)
                                                             ))))
                                                             (=>
                                                              (= temp_14_1~2526@ (Mul (Mul (Mul a14~114@ (Mul c14~118@ (Mul d14~120@ c14~118@))) (
                                                                  Mul (Mul d14~120@ a14~114@) (Mul a14~114@ d14~120@)
                                                                 )
                                                                ) (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ a14~114@)) (Sub (Mul c14~118@ b14~116@)
                                                                  (Mul d14~120@ b14~116@)
                                                              ...
                                                              (and
                                                               ...
                                                               (=>
                                                                (= temp_14_0~2461@ temp_14_1~2526@)
                                                                (=>
                                                                 (= temp_15_0~2611@ (Add (Add (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ d15~128@)) (
                                                                     Mul (Mul a15~122@ c15~126@) (Mul a15~122@ b15~124@)
                                                                    )
                                                                   ) (Mul (Mul (Add b15~124@ d15~128@) c15~126@) (Mul (Mul a15~122@ b15~124@) (Mul a15~122@
                                                                      a15~122@
                                                                 )))))
                                                                 (=>
                                                                  (= temp_15_1~2672@ (Add (Add (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ d15~128@)) (
                                                                      Mul (Mul c15~126@ a15~122@) (Mul a15~122@ b15~124@)
                                                                     )
                                                                    ) (Mul (Mul (Add b15~124@ d15~128@) c15~126@) (Mul (Mul a15~122@ b15~124@) (Mul a15~122@
                                                                       a15~122@
                                                                  )))))
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2611@ temp_15_1~2672@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2611@ temp_15_1~2672@)
                                                                    (=>
                                                                     (= temp_16_0~2757@ (Mul (Sub (Mul (Mul a16~130@ d16~136@) (Mul a16~130@ b16~132@)) (
                                                                         Mul (Add b16~132@ a16~130@) (Add c16~134@ d16~136@)
                                                                        )
                                                                       ) (Add (Mul a16~130@ (Mul b16~132@ b16~132@)) (Mul (Mul a16~130@ a16~130@) (Mul d16~136@
                                                                          c16~134@
                                                                     )))))
                                                                     (=>
                                                                      (= temp_16_1~2818@ (Mul (Sub (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ a16~130@)) (
                                                                          Mul (Add b16~132@ a16~130@) (Add c16~134@ d16~136@)
                                                                         )
                                                                        ) (Add (Mul a16~130@ (Mul b16~132@ b16~132@)) (Mul (Mul a16~130@ a16~130@) (Mul d16~136@
                                                                           c16~134@
                                                                      ...
                                                                      (and
                                                                       ...
                                                                       (=>
                                                                        (= temp_16_0~2757@ temp_16_1~2818@)
                                                                        (=>
                                                                         (= temp_17_0~2919@ (Mul (Mul (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ a17~138@)) (
                                                                             Mul (Mul a17~138@ d17~144@) (Sub c17~142@ c17~142@)
                                                                            )
                                                                           ) (Mul (Mul (Mul a17~138@ a17~138@) (Mul c17~142@ d17~144@)) (Mul (Mul c17~142@ 23)
                                                                             (Mul d17~144@ a17~138@)
                                                                         ))))
                                                                         (=>
                                                                          (= temp_17_1~2996@ (Mul (Mul (Mul (Mul a17~138@ d17~144@) (Sub c17~142@ c17~142@)) (
                                                                              Mul (Mul a17~138@ b17~140@) (Mul b17~140@ a17~138@)
                                                                             )
                                                                            ) (Mul (Mul (Mul a17~138@ a17~138@) (Mul c17~142@ d17~144@)) (Mul (Mul c17~142@ 23)
                                                                              (Mul d17~144@ a17~138@)
                                                                          ))))
