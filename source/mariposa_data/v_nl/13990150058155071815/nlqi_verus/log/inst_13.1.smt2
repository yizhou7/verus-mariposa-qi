...
(set-info :comment ";; mariposa_data/v_nl//13990150058155071815/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_10_0~2155@ Int)
(declare-const temp_10_1~2228@ Int)
(declare-const temp_11_0~2311@ Int)
(declare-const temp_11_1~2364@ Int)
(declare-const temp_12_0~2441@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul (Mul c0~6@ a0~2@) b0~4@) a0~2@)))) (and (=> (= tmp%1@ (Mul c0~6@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b0~4@ a0~2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~461@ (Mul (Mul (Mul (Sub b1~12@ a1~10@) (Sub d1~16@ a1~10@)) (Add (Mul d1~16@ a1~10@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul d1~16@ b1~12@) d1~16@) (Mul (Mul c1~14@ b1~12@) c1~14@)))) (=> (= temp_1_1~526@ (Mul (Mul (Sub (Mul b1~12@ (Sub d1~16@ a1~10@)) (Mul a1~10@ (Sub d1~16@ a1~10@))) (Add (Mul d1~16@ a1~10@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul d1~16@ b1~12@) d1~16@) (Mul (Mul c1~14@ b1~12@) c1~14@)))) (and (=> (= tmp%2@ (Sub d1~16@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b1~12@ a1~10@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~461@ temp_1_1~526@)))) (=> (= temp_1_0~461@ temp_1_1~526@) (=> (= temp_2_0~613@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ b2~20@)) d2~24@) (Add (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Sub d2~24@ a2~18@))))) (=> (= temp_2_1~666@ (Mul (Mul (Mul b2~20@ c2~22@) (Mul (Mul c2~22@ b2~20@) d2~24@)) (Add (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Sub d2~24@ a2~18@))))) (and (=> (= tmp%3@ (Mul b2~20@ c2~22@)) (=> (= tmp%4@ (Mul c2~22@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ d2~24@) (=> %%location_label%%2 (= temp_2_0~613@ temp_2_1~666@))))) (=> (= temp_2_0~613@ temp_2_1~666@) (=> (= temp_3_0~789@ (Add (Mul (Add (Mul d3~32@ d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@))) (Mul (Mul a3~26@ (Mul b3~28@ 2)) (Sub (Mul d3~32@ 9) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~874@ (Add (Mul (Mul (Add (Mul d3~32@ d3~32@) (Mul a3~26@ c3~30@)) (Mul a3~26@ c3~30@)) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ (Mul b3~28@ 2)) (Sub (Mul d3~32@ 9) (Mul d3~32@ d3~32@))))) (and (=> (= tmp%5@ (Add (Mul d3~32@ d3~32@) (Mul a3~26@ c3~30@))) (=> (= tmp%6@ (Mul a3~26@ c3~30@)) (=> (= tmp%7@ (Mul c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~789@ temp_3_1~874@)))))) (=> (= temp_3_0~789@ temp_3_1~874@) (=> (= temp_4_0~989@ (Sub (Mul (Mul (Add d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Add c4~38@ d4~40@))) (Mul (Add (Mul c4~38@ b4~36@) (Mul a4~34@ a4~34@)) (Sub (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~1054@ (Sub (Mul (Mul (Add d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul d4~40@ (Mul a4~34@ (Add c4~38@ d4~40@)))) (Mul (Add (Mul c4~38@ b4~36@) (Mul a4~34@ a4~34@)) (Sub (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@))))) (and (=> (= tmp%8@ (Add c4~38@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d4~40@ a4~34@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~989@ temp_4_1~1054@)))) (=> (= temp_4_0~989@ temp_4_1~1054@) (=> (= temp_5_0~1153@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ b5~44@)) (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ d5~48@))) (Add (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ b5~44@)) (Mul (Add d5~48@ c5~46@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1218@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ b5~44@)) (Mul d5~48@ (Mul a5~42@ (Mul c5~46@ d5~48@)))) (Add (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ b5~44@)) (Mul (Add d5~48@ c5~46@) (Mul b5~44@ b5~44@))))) (and (=> (= tmp%9@ (Mul c5~46@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d5~48@ a5~42@ tmp%9@) (=> %%location_label%%5 (= temp_5_0~1153@ temp_5_1~1218@)))) (=> (= temp_5_0~1153@ temp_5_1~1218@) (=> (= temp_6_0~1313@ (Mul (Add (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Add c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ a6~50@)) (Mul a6~50@ (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1374@ (Mul (Add (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Add c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ a6~50@)) (Mul a6~50@ (Mul b6~52@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1313@ temp_6_1~1374@))) (=> (= temp_6_0~1313@ temp_6_1~1374@) (=> (= temp_7_0~1467@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Sub d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Add a7~58@ b7~60@))) (Add (Mul (Mul a7~58@ d7~64@) (Sub c7~62@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Add d7~64@ d7~64@))))) (=> (= temp_7_1~1564@ (Add (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Sub d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Add a7~58@ b7~60@))) (Mul (Mul a7~58@ d7~64@) (Sub c7~62@ b7~60@))) (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Sub d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Add a7~58@ b7~60@))) (Mul (Mul b7~60@ b7~60@) (Add d7~64@ d7~64@))))) (and (=> (= tmp%10@ (Mul (Mul (Mul b7~60@ d7~64@) (Sub d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Add a7~58@ b7~60@)))) (=> (= tmp%11@ (Mul (Mul a7~58@ d7~64@) (Sub c7~62@ b7~60@))) (=> (= tmp%12@ (Mul (Mul b7~60@ b7~60@) (Add d7~64@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%7 (= temp_7_0~1467@ temp_7_1~1564@)))))) (=> (= temp_7_0~1467@ temp_7_1~1564@) (=> (= temp_8_0~1723@ (Mul (Sub (Mul (Mul d8~72@ a8~66@) (Add c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul 16 b8~68@) (Sub a8~66@ c8~70@))))) (=> (= temp_8_1~1800@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul 16 b8~68@) (Sub a8~66@ c8~70@))) (Sub (Mul (Mul d8~72@ a8~66@) (Add c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ b8~68@))))) (and (=> (= tmp%13@ (Sub (Mul (Mul d8~72@ a8~66@) (Add c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ b8~68@)))) (=> (= tmp%14@ (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul 16 b8~68@) (Sub a8~66@ c8~70@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%8 (= temp_8_0~1723@ temp_8_1~1800@))))) (=> (= temp_8_0~1723@ temp_8_1~1800@) (=> (= temp_9_0~1965@ (Add (Mul (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ 61)) (Mul (Mul a9~74@ b9~76@) b9~76@)) (Mul (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ c9~78@)) (Mul b9~76@ (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~2034@ (Add (Mul (Mul (Mul a9~74@ 61) (Mul b9~76@ b9~76@)) (Mul (Mul a9~74@ b9~76@) b9~76@)) (Mul (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ c9~78@)) (Mul b9~76@ (Mul d9~80@ c9~78@))))) (and (=> (= tmp%15@ (Mul b9~76@ b9~76@)) (=> (= tmp%16@ (Mul a9~74@ 61)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%9 (= temp_9_0~1965@ temp_9_1~2034@))))) (=> (= temp_9_0~1965@ temp_9_1~2034@) (=> (= temp_10_0~2155@ (Mul (Mul (Add (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@)) (Mul a10~82@ (Mul c10~86@ c10~86@))) (Mul (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ d10~88@)) (Mul (Mul 92 d10~88@) (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~2228@ (Mul (Mul (Add (Mul a10~82@ c10~86@) (Mul c10~86@ c10~86@)) (Mul (Mul a10~82@ c10~86@) c10~86@)) (Mul (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ d10~88@)) (Mul (Mul 92 d10~88@) (Mul a10~82@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a10~82@ c10~86@ c10~86@) (=> %%location_label%%10 (= temp_10_0~2155@ temp_10_1~2228@))) (=> (= temp_10_0~2155@ temp_10_1~2228@) (=> (= temp_11_0~2311@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Add b11~92@ d11~96@)) (Mul (Add c11~94@ b11~92@) (Mul a11~90@ c11~94@))) (Sub (Mul (Add b11~92@ d11~96@) (Mul a11~90@ b11~92@)) a11~90@))) (=> (= temp_11_1~2364@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Add b11~92@ d11~96@)) (Mul (Add c11~94@ b11~92@) (Mul a11~90@ c11~94@))) (Sub (Mul (Add b11~92@ d11~96@) (Mul b11~92@ a11~90@)) a11~90@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a11~90@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2311@ temp_11_1~2364@))) (=> (= temp_11_0~2311@ temp_11_1~2364@) (=> (= temp_12_0~2441@ (Mul (Add (Sub (Mul a12~98@ c12~102@) (Mul c12~102@ c12~102@)) (Mul d12~104@ (Sub c12~102@ b12~100@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) b12~100@))) (=> (= temp_12_1~2486@ (Mul (Add (Mul (Sub a12~98@ c12~102@) c12~102@) (Mul d12~104@ (Sub c12~102@ b12~100@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a12~98@ c12~102@ c12~102@) (=> %%location_label%%12 (= temp_12_0~2441@ temp_12_1~2486@))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
