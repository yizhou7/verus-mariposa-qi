...
(assert (=> %%query%% (not (=> (= temp_0_0~325@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@)) (Sub (Mul 44 b0~4@) (Add a0~2@ c0~6@))) (Mul (Mul (Mul d0~8@ 33) a0~2@) (Mul (Mul b0~4@ b0~4@) (Sub c0~6@ b0~4@))))) (=> (= temp_0_1~410@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ d0~8@)) (Sub (Mul 44 b0~4@) (Add a0~2@ c0~6@))) (Mul (Mul (Mul d0~8@ 33) a0~2@) (Mul (Mul b0~4@ b0~4@) (Sub c0~6@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~325@ temp_0_1~410@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~478@ (Mul (Add (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ d1~16@)) d1~16@) (Mul (Mul (Mul d1~16@ c1~14@) (Add a1~10@ b1~12@)) (Mul (Add a1~10@ a1~10@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~563@ (Add (Mul (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul (Mul d1~16@ c1~14@) (Add a1~10@ b1~12@)) (Mul (Add a1~10@ a1~10@) (Mul b1~12@ c1~14@)))) (Mul d1~16@ (Mul (Mul (Mul d1~16@ c1~14@) (Add a1~10@ b1~12@)) (Mul (Add a1~10@ a1~10@) (Mul b1~12@ c1~14@)))))) (=> (= tmp%2@ (= temp_1_0~478@ temp_1_1~563@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~643@ (Add (Mul (Mul (Mul c2~22@ 12) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@)) b2~20@))) (=> (= temp_2_1~708@ (Add (Mul (Mul (Mul 12 c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@)) b2~20@))) (=> (= tmp%3@ (= temp_2_0~643@ temp_2_1~708@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~800@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul 85 b3~28@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Add (Mul b3~28@ c3~30@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~877@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul 85 b3~28@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Add (Mul b3~28@ c3~30@) (Mul b3~28@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~800@ temp_3_1~877@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~965@ (Sub (Mul (Mul (Add d4~40@ d4~40@) (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ b4~36@))) (Mul (Mul d4~40@ (Add b4~36@ 79)) (Mul (Mul b4~36@ d4~40@) (Sub a4~34@ b4~36@))))) (=> (= temp_4_1~1038@ (Sub (Mul (Mul (Add d4~40@ d4~40@) (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul b4~36@ d4~40@) (Sub a4~34@ b4~36@)) (Mul d4~40@ (Add b4~36@ 79))))) (=> (= tmp%5@ (= temp_4_0~965@ temp_4_1~1038@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1126@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ 35) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ d5~48@) (Sub c5~46@ c5~46@)) (Mul c5~46@ (Mul a5~42@ c5~46@))))) (=> (= temp_5_1~1207@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ 35) (Mul b5~44@ a5~42@))) (Mul (Sub (Mul (Mul c5~46@ d5~48@) c5~46@) (Mul (Mul c5~46@ d5~48@) c5~46@)) (Mul c5~46@ (Mul a5~42@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1126@ temp_5_1~1207@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1255@ (Mul (Sub (Mul c6~54@ (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Sub c6~54@ b6~52@))) d6~56@)) (=> (= temp_6_1~1288@ (Mul (Sub (Mul c6~54@ (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Sub c6~54@ b6~52@))) d6~56@)) (=> (= tmp%7@ (= temp_6_0~1255@ temp_6_1~1288@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1376@ (Mul (Mul (Mul (Mul a7~58@ d7~64@) 22) (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ 60))) (Mul (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ c7~62@)) b7~60@))) (=> (= temp_7_1~1449@ (Mul (Mul (Mul (Mul a7~58@ d7~64@) 22) (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ 60))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) b7~60@))) (=> (= tmp%8@ (= temp_7_0~1376@ temp_7_1~1449@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1529@ (Mul (Sub b8~68@ (Add (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul d8~72@ 83) (Mul a8~66@ b8~68@)) (Sub (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@))))) (=> (= temp_8_1~1594@ (Mul (Sub b8~68@ (Add (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul d8~72@ 83) (Mul a8~66@ b8~68@)) (Sub (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1529@ temp_8_1~1594@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1674@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Mul d9~80@ b9~76@) (Add b9~76@ a9~74@))) (Mul (Mul (Mul c9~78@ c9~78@) (Add b9~76@ c9~78@)) (Mul (Add b9~76@ a9~74@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~1739@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Mul d9~80@ b9~76@) (Add b9~76@ a9~74@))) (Mul (Mul (Add b9~76@ c9~78@) (Mul c9~78@ c9~78@)) (Mul (Add b9~76@ a9~74@) (Mul d9~80@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1674@ temp_9_1~1739@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1815@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ b10~84@)) (Mul (Sub b10~84@ c10~86@) (Add b10~84@ a10~82@))) (Mul (Mul (Mul b10~84@ d10~88@) (Sub c10~86@ a10~82@)) (Mul (Mul a10~82@ a10~82@) a10~82@)))) (=> (= temp_10_1~1876@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ b10~84@)) (Mul (Sub b10~84@ c10~86@) (Add b10~84@ a10~82@))) (Mul (Mul b10~84@ (Mul d10~88@ (Sub c10~86@ a10~82@))) (Mul (Mul a10~82@ a10~82@) a10~82@)))) (=> (= tmp%11@ (= temp_10_0~1815@ temp_10_1~1876@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1944@ (Mul (Mul c11~94@ (Sub (Add b11~92@ c11~94@) (Add d11~96@ a11~90@))) (Mul (Mul (Mul d11~96@ b11~92@) (Mul b11~92@ c11~94@)) (Mul (Add a11~90@ c11~94@) (Mul d11~96@ a11~90@))))) (=> (= temp_11_1~1997@ (Mul (Mul (Sub (Add b11~92@ c11~94@) (Add d11~96@ a11~90@)) c11~94@) (Mul (Mul (Mul d11~96@ b11~92@) (Mul b11~92@ c11~94@)) (Mul (Add a11~90@ c11~94@) (Mul d11~96@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1944@ temp_11_1~1997@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2077@ (Mul (Add (Mul (Add d12~104@ a12~98@) (Mul a12~98@ c12~102@)) (Mul (Mul c12~102@ c12~102@) (Mul b12~100@ a12~98@))) (Mul (Mul (Mul b12~100@ a12~98@) (Sub b12~100@ d12~104@)) (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2142@ (Mul (Add (Mul (Add d12~104@ a12~98@) (Mul a12~98@ c12~102@)) (Mul (Mul c12~102@ c12~102@) (Mul b12~100@ a12~98@))) (Mul (Mul (Mul b12~100@ a12~98@) (Sub b12~100@ d12~104@)) (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~2077@ temp_12_1~2142@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2222@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Mul c13~110@ a13~106@) (Add a13~106@ b13~108@))) (Sub (Sub (Mul b13~108@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ b13~108@))))) (=> (= temp_13_1~2287@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (Mul c13~110@ (Mul a13~106@ (Add a13~106@ b13~108@)))) (Sub (Sub (Mul b13~108@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ b13~108@))))) (=> (= tmp%14@ (= temp_13_0~2222@ temp_13_1~2287@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2367@ (Sub (Mul (Sub (Mul c14~118@ d14~120@) (Mul b14~116@ c14~118@)) (Mul (Mul b14~116@ c14~118@) (Add c14~118@ d14~120@))) (Mul (Mul (Add a14~114@ a14~114@) (Mul b14~116@ b14~116@)) (Mul (Mul c14~118@ d14~120@) (Sub d14~120@ b14~116@))))) (=> (= temp_14_1~2432@ (Sub (Mul (Sub (Mul c14~118@ d14~120@) (Mul b14~116@ c14~118@)) (Mul b14~116@ (Mul c14~118@ (Add c14~118@ d14~120@)))) (Mul (Mul (Add a14~114@ a14~114@) (Mul b14~116@ b14~116@)) (Mul (Mul c14~118@ d14~120@) (Sub d14~120@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2367@ temp_14_1~2432@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2512@ (Mul (Add (Mul (Mul b15~124@ d15~128@) (Mul d15~128@ a15~122@)) (Mul (Mul d15~128@ c15~126@) (Mul c15~126@ b15~124@))) (Mul (Mul (Mul a15~122@ b15~124@) (Mul c15~126@ b15~124@)) (Mul (Sub c15~126@ b15~124@) (Add b15~124@ a15~122@))))) (=> (= temp_15_1~2577@ (Mul (Add (Mul (Mul b15~124@ d15~128@) (Mul d15~128@ a15~122@)) (Mul (Mul d15~128@ c15~126@) (Mul c15~126@ b15~124@))) (Mul (Mul (Sub c15~126@ b15~124@) (Add b15~124@ a15~122@)) (Mul (Mul a15~122@ b15~124@) (Mul c15~126@ b15~124@))))) (=> (= tmp%16@ (= temp_15_0~2512@ temp_15_1~2577@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2681@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul b16~132@ d16~136@)) (Mul (Mul d16~136@ 37) (Mul c16~134@ d16~136@))) (Add (Mul (Mul b16~132@ 44) (Mul d16~136@ d16~136@)) (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2770@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul b16~132@ d16~136@)) (Mul d16~136@ (Mul 37 (Mul c16~134@ d16~136@)))) (Add (Mul (Mul b16~132@ 44) (Mul d16~136@ d16~136@)) (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2681@ temp_16_1~2770@)) (=> %%location_label%%16 tmp%17@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
