...
(push)
 ...
 (declare-const temp_6_0~1309@ Int)
 ...
 (declare-const temp_8_1~1666@ Int)
 ...
 (declare-const temp_12_1~2250@ Int)
 (declare-const temp_13_0~2339@ Int)
 (declare-const temp_13_1~2404@ Int)
 (declare-const temp_14_0~2493@ Int)
 ...
 (declare-const temp_16_1~2914@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
     ...
     (=>
      ...
      (and
       (=>
        ...
        (=>
         %%location_label%%0
         (= temp_0_0~325@ temp_0_1~410@)
       ))
       (=>
        (= temp_0_0~325@ temp_0_1~410@)
        (=>
         (= temp_1_0~487@ (Mul (Add (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ d1~16@)) d1~16@) (Mul
            (Mul (Mul d1~16@ c1~14@) (Add a1~10@ b1~12@)) (Mul (Add a1~10@ a1~10@) (Mul b1~12@
              c1~14@
         )))))
         (=>
          (= temp_1_1~572@ (Add (Mul (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul (Mul
                d1~16@ c1~14@
               ) (Add a1~10@ b1~12@)
          ...
          (and
           (=>
            ...
            (=>
             %%location_label%%1
             (= temp_1_0~487@ temp_1_1~572@)
           ))
           (=>
            (= temp_1_0~487@ temp_1_1~572@)
            (=>
             (= temp_2_0~661@ (Add (Mul (Mul (Mul c2~22@ 12) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@
                  a2~18@
                 ) (Mul c2~22@ d2~24@)
                )
             ...
             (=>
              (= temp_2_1~726@ (Add (Mul (Mul (Mul 12 c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@
                   a2~18@
                  ) (Mul c2~22@ d2~24@)
                 )
                ) (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@)) b2~20@)
              ...
              (and
               ...
               (=>
                (= temp_2_0~661@ temp_2_1~726@)
                (=>
                 (= temp_3_0~827@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@
                      b3~28@
                     ) (Mul 85 b3~28@)
                    )
                 ...
                 (=>
                  (= temp_3_1~904@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@
                       b3~28@
                      ) (Mul 85 b3~28@)
                     )
                    ) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Add (Mul b3~28@ c3~30@) (Mul b3~28@
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~827@ temp_3_1~904@)
                   ))
                   (=>
                    (= temp_3_0~827@ temp_3_1~904@)
                    (=>
                     (= temp_4_0~1001@ (Sub (Mul (Mul (Add d4~40@ d4~40@) (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@
                          d4~40@
                         ) (Mul a4~34@ b4~36@)
                        )
                     ...
                     (=>
                      (= temp_4_1~1074@ (Sub (Mul (Mul (Add d4~40@ d4~40@) (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@
                           d4~40@
                          ) (Mul a4~34@ b4~36@)
                         )
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~1001@ temp_4_1~1074@)
                       ))
                       (=>
                        (= temp_4_0~1001@ temp_4_1~1074@)
                        (=>
                         (= temp_5_0~1171@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@
                              35
                             ) (Mul b5~44@ a5~42@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1252@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@
                               35
                              ) (Mul b5~44@ a5~42@)
                             )
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1171@ temp_5_1~1252@)
                           ))
                           (=>
                            (= temp_5_0~1171@ temp_5_1~1252@)
                            (=>
                             (= temp_6_0~1309@ (Mul (Sub (Mul c6~54@ (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ c6~54@)
                                 (Sub c6~54@ b6~52@)
                                )
                               ) d6~56@
                             ))
                             (=>
                              (= temp_6_1~1342@ (Mul (Sub (Mul c6~54@ (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ c6~54@)
                                  (Sub c6~54@ b6~52@)
                                 )
                                ) d6~56@
                              ))
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1309@ temp_6_1~1342@)
                               ))
                               (=>
                                (= temp_6_0~1309@ temp_6_1~1342@)
                                (=>
                                 (= temp_7_0~1439@ (Mul (Mul (Mul (Mul a7~58@ d7~64@) 22) (Mul (Mul c7~62@ d7~64@) (Mul
                                      a7~58@ 60
                                    ))
                                   ) (Mul (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ c7~62@)) b7~60@)
                                 ))
                                 (=>
                                  (= temp_7_1~1512@ (Mul (Mul (Mul (Mul a7~58@ d7~64@) 22) (Mul (Mul c7~62@ d7~64@) (Mul
                                       a7~58@ 60
                                     ))
                                  ...
                                  (and
                                   ...
                                   (=>
                                    (= temp_7_0~1439@ temp_7_1~1512@)
                                    (=>
                                     (= temp_8_0~1601@ (Mul (Sub b8~68@ (Add (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))) (
                                        Mul (Mul (Mul d8~72@ 83) (Mul a8~66@ b8~68@)) (Sub (Mul c8~70@ a8~66@) (Mul b8~68@
                                          b8~68@
                                     )))))
                                     (=>
                                      (= temp_8_1~1666@ (Mul (Sub b8~68@ (Add (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@))) (
                                         Mul (Mul (Mul d8~72@ 83) (Mul a8~66@ b8~68@)) (Sub (Mul c8~70@ a8~66@) (Mul b8~68@
                                           b8~68@
                                      )))))
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1601@ temp_8_1~1666@)
                                       ))
                                       (=>
                                        (= temp_8_0~1601@ temp_8_1~1666@)
                                        (=>
                                         (= temp_9_0~1755@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Mul d9~80@
                                              b9~76@
                                             ) (Add b9~76@ a9~74@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1820@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Mul d9~80@
                                               b9~76@
                                              ) (Add b9~76@ a9~74@)
                                             )
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1755@ temp_9_1~1820@)
                                           ))
                                           (=>
                                            (= temp_9_0~1755@ temp_9_1~1820@)
                                            (=>
                                             (= temp_10_0~1905@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ b10~84@)) (Mul (
                                                  Sub b10~84@ c10~86@
                                                 ) (Add b10~84@ a10~82@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1966@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ b10~84@)) (Mul (
                                                   Sub b10~84@ c10~86@
                                                  ) (Add b10~84@ a10~82@)
                                                 )
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1905@ temp_10_1~1966@)
                                               ))
                                               (=>
                                                (= temp_10_0~1905@ temp_10_1~1966@)
                                                (=>
                                                 (= temp_11_0~2043@ (Mul (Mul c11~94@ (Sub (Add b11~92@ c11~94@) (Add d11~96@ a11~90@)))
                                                   (Mul (Mul (Mul d11~96@ b11~92@) (Mul b11~92@ c11~94@)) (Mul (Add a11~90@ c11~94@) (
                                                      Mul d11~96@ a11~90@
                                                 )))))
                                                 (=>
                                                  (= temp_11_1~2096@ (Mul (Mul (Sub (Add b11~92@ c11~94@) (Add d11~96@ a11~90@)) c11~94@)
                                                    (Mul (Mul (Mul d11~96@ b11~92@) (Mul b11~92@ c11~94@)) (Mul (Add a11~90@ c11~94@) (
                                                       Mul d11~96@ a11~90@
                                                  )))))
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~2043@ temp_11_1~2096@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~2043@ temp_11_1~2096@)
                                                    (=>
                                                     (= temp_12_0~2185@ (Mul (Add (Mul (Add d12~104@ a12~98@) (Mul a12~98@ c12~102@)) (Mul
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2250@ (Mul (Add (Mul (Add d12~104@ a12~98@) (Mul a12~98@ c12~102@)) (Mul
                                                          (Mul c12~102@ c12~102@) (Mul b12~100@ a12~98@)
                                                         )
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2185@ temp_12_1~2250@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2185@ temp_12_1~2250@)
                                                        (=>
                                                         (= temp_13_0~2339@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2404@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2339@ temp_13_1~2404@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2339@ temp_13_1~2404@)
                                                            (=>
                                                             (= temp_14_0~2493@ (Sub (Mul (Sub (Mul c14~118@ d14~120@) (Mul b14~116@ c14~118@)) (
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2558@ (Sub (Mul (Sub (Mul c14~118@ d14~120@) (Mul b14~116@ c14~118@)) (
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2493@ temp_14_1~2558@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2493@ temp_14_1~2558@)
                                                                (=>
                                                                 (= temp_15_0~2647@ (Mul (Add (Mul (Mul b15~124@ d15~128@) (Mul d15~128@ a15~122@)) (
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2712@ (Mul (Add (Mul (Mul b15~124@ d15~128@) (Mul d15~128@ a15~122@)) (
                                                                      Mul (Mul d15~128@ c15~126@) (Mul c15~126@ b15~124@)
                                                                     )
                                                                  ...
                                                                  (and
                                                                   ...
                                                                   (=>
                                                                    (= temp_15_0~2647@ temp_15_1~2712@)
                                                                    (=>
                                                                     (= temp_16_0~2825@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul b16~132@ d16~136@)) (
                                                                     ...
                                                                     (=>
                                                                      (= temp_16_1~2914@ (Mul (Mul (Mul (Mul a16~130@ b16~132@) (Mul b16~132@ d16~136@)) (
