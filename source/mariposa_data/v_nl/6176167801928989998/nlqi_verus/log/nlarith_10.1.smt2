...
(declare-const temp_3_0~980@ Int)
(declare-const temp_3_1~1117@ Int)
(declare-const temp_4_0~1237@ Int)
(declare-const temp_4_1~1342@ Int)
(declare-const temp_5_0~1482@ Int)
(declare-const temp_5_1~1607@ Int)
(declare-const temp_6_0~1763@ Int)
(declare-const temp_6_1~1904@ Int)
(declare-const temp_7_0~2036@ Int)
(declare-const temp_7_1~2153@ Int)
(declare-const temp_8_0~2281@ Int)
(declare-const temp_8_1~2402@ Int)
(declare-const temp_9_0~2530@ Int)
(declare-const temp_9_1~2647@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~261@ (Mul (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ d0~8@))) (Add (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ b0~4@)))) (Add (Mul (Mul (Sub b0~4@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ c0~6@))) b0~4@))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Add (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ b0~4@)))) (Add (Mul (Mul (Sub b0~4@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ c0~6@))) b0~4@))) (=> (= tmp%1@ (= temp_0_0~261@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~478@ (Add (Mul a1~10@ (Mul (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@)) (Add (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Sub b1~12@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@)))))) (=> (= temp_1_1~579@ (Add (Mul a1~10@ (Mul (Mul b1~12@ (Mul b1~12@ (Mul b1~12@ d1~16@))) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@)) (Add (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Sub b1~12@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@)))))) (=> (= tmp%2@ (= temp_1_0~478@ temp_1_1~579@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~711@ (Mul (Mul (Mul (Mul d2~24@ (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Add a2~18@ d2~24@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ c2~22@) (Sub a2~18@ b2~20@)))) (Mul (Mul (Mul b2~20@ (Sub a2~18@ a2~18@)) (Mul a2~18@ (Sub d2~24@ b2~20@))) (Mul (Add (Mul c2~22@ a2~18@) (Sub b2~20@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Sub a2~18@ c2~22@)))))) (=> (= temp_2_1~828@ (Mul (Mul (Mul (Mul d2~24@ (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Add a2~18@ d2~24@) (Mul b2~20@ b2~20@)) (Mul c2~22@ (Mul c2~22@ (Sub a2~18@ b2~20@))))) (Mul (Mul (Mul b2~20@ (Sub a2~18@ a2~18@)) (Mul a2~18@ (Sub d2~24@ b2~20@))) (Mul (Add (Mul c2~22@ a2~18@) (Sub b2~20@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Sub a2~18@ c2~22@)))))) (=> (= tmp%3@ (= temp_2_0~711@ temp_2_1~828@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~980@ (Mul (Mul (Sub (Mul a3~26@ (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@))) (Mul (Sub (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Add c3~30@ d3~32@) (Mul c3~30@ b3~28@)))) (Mul (Mul (Mul (Sub a3~26@ b3~28@) (Mul 77 c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@))) (Mul (Mul (Add c3~30@ a3~26@) (Mul d3~32@ a3~26@)) (Add (Mul d3~32@ b3~28@) (Sub c3~30@ d3~32@)))))) (=> (= temp_3_1~1117@ (Mul (Mul (Sub (Mul a3~26@ (Mul d3~32@ b3~28@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ a3~26@))) (Mul (Sub (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Add c3~30@ d3~32@) (Mul c3~30@ b3~28@)))) (Mul (Mul (Mul (Sub a3~26@ b3~28@) (Mul 77 c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@))) (Mul (Mul (Add c3~30@ a3~26@) (Mul d3~32@ a3~26@)) (Add (Mul d3~32@ b3~28@) (Sub c3~30@ d3~32@)))))) (=> (= tmp%4@ (= temp_3_0~980@ temp_3_1~1117@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1237@ (Mul (Mul (Mul (Add (Mul d4~40@ a4~34@) (Mul c4~38@ b4~36@)) (Mul (Mul c4~38@ a4~34@) a4~34@)) (Mul (Add (Mul a4~34@ c4~38@) (Add d4~40@ a4~34@)) (Mul (Add b4~36@ 5) (Mul c4~38@ b4~36@)))) (Mul c4~38@ (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@)) (Add d4~40@ (Mul a4~34@ d4~40@)))))) (=> (= temp_4_1~1342@ (Mul (Mul (Mul (Add (Mul d4~40@ a4~34@) (Mul c4~38@ b4~36@)) (Mul (Mul c4~38@ a4~34@) a4~34@)) (Mul (Add (Mul a4~34@ c4~38@) (Add d4~40@ a4~34@)) (Mul (Add b4~36@ 5) (Mul c4~38@ b4~36@)))) (Mul c4~38@ (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)) (Add d4~40@ (Mul a4~34@ d4~40@)))))) (=> (= tmp%5@ (= temp_4_0~1237@ temp_4_1~1342@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1482@ (Mul (Mul (Mul (Add (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)) (Sub (Mul c5~46@ b5~44@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul b5~44@ a5~42@) (Sub d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) a5~42@))) (Mul (Sub (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Add d5~48@ d5~48@) (Sub c5~46@ b5~44@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Add (Add c5~46@ a5~42@) (Mul a5~42@ d5~48@)))))) (=> (= temp_5_1~1607@ (Mul (Mul (Mul (Mul (Add (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)) (Sub (Mul c5~46@ b5~44@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul b5~44@ a5~42@) (Sub d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) a5~42@))) (Sub (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Add d5~48@ d5~48@) (Sub c5~46@ b5~44@)))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Add (Add c5~46@ a5~42@) (Mul a5~42@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1482@ temp_5_1~1607@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1763@ (Mul (Mul (Mul (Mul (Sub b6~52@ c6~54@) (Add b6~52@ a6~50@)) (Add (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ 10) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ d6~56@)))) (Add (Sub (Add (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Add a6~50@ d6~56@))) (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ c6~54@)) (Sub (Mul d6~56@ a6~50@) (Mul d6~56@ b6~52@)))))) (=> (= temp_6_1~1904@ (Mul (Mul (Mul (Mul (Sub b6~52@ c6~54@) (Add b6~52@ a6~50@)) (Add (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ 10) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ c6~54@)))) (Add (Sub (Add (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Add a6~50@ d6~56@))) (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ c6~54@)) (Sub (Mul d6~56@ a6~50@) (Mul d6~56@ b6~52@)))))) (=> (= tmp%7@ (= temp_6_0~1763@ temp_6_1~1904@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2036@ (Mul (Add (Mul (Mul (Mul d7~64@ c7~62@) (Sub c7~62@ d7~64@)) (Mul (Mul c7~62@ a7~58@) d7~64@)) (Mul (Mul (Mul a7~58@ d7~64@) b7~60@) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ c7~62@)))) (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@)) (Mul (Sub c7~62@ a7~58@) b7~60@)) (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@)) (Mul (Sub c7~62@ a7~58@) (Mul c7~62@ a7~58@)))))) (=> (= temp_7_1~2153@ (Mul (Add (Mul (Mul (Mul d7~64@ c7~62@) (Sub c7~62@ d7~64@)) (Mul (Mul c7~62@ a7~58@) d7~64@)) (Mul (Mul (Mul d7~64@ a7~58@) b7~60@) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ c7~62@)))) (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@)) (Mul (Sub c7~62@ a7~58@) b7~60@)) (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@)) (Mul (Sub c7~62@ a7~58@) (Mul c7~62@ a7~58@)))))) (=> (= tmp%8@ (= temp_7_0~2036@ temp_7_1~2153@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2281@ (Mul (Add (Mul (Add (Sub c8~70@ a8~66@) (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ b8~68@) c8~70@)) (Sub (Mul (Mul c8~70@ d8~72@) a8~66@) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ a8~66@)))) (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Sub a8~66@ b8~68@)) (Mul c8~70@ b8~68@)) (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@)) (Sub (Mul b8~68@ a8~66@) (Sub d8~72@ c8~70@)))))) (=> (= temp_8_1~2402@ (Mul (Add (Mul (Add (Sub c8~70@ a8~66@) (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ b8~68@) c8~70@)) (Sub (Mul (Mul c8~70@ d8~72@) a8~66@) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ a8~66@)))) (Mul (Mul (Sub (Mul (Mul c8~70@ b8~68@) a8~66@) (Mul (Mul c8~70@ b8~68@) b8~68@)) (Mul c8~70@ b8~68@)) (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@)) (Sub (Mul b8~68@ a8~66@) (Sub d8~72@ c8~70@)))))) (=> (= tmp%9@ (= temp_8_0~2281@ temp_8_1~2402@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2530@ (Mul (Add (Mul (Add (Mul b9~76@ a9~74@) (Mul c9~78@ b9~76@)) (Mul (Add a9~74@ c9~78@) (Mul c9~78@ b9~76@))) (Mul (Mul d9~80@ (Sub d9~80@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Sub d9~80@ c9~78@)))) (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ c9~78@)) c9~78@) (Mul (Mul (Mul c9~78@ b9~76@) (Add a9~74@ d9~80@)) (Add (Mul d9~80@ a9~74@) (Add b9~76@ c9~78@)))))) (=> (= temp_9_1~2647@ (Mul (Add (Mul (Add (Mul b9~76@ a9~74@) (Mul c9~78@ b9~76@)) (Mul (Add a9~74@ c9~78@) (Mul c9~78@ b9~76@))) (Mul (Sub (Mul d9~80@ d9~80@) (Mul d9~80@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Sub d9~80@ c9~78@)))) (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ c9~78@)) c9~78@) (Mul (Mul (Mul c9~78@ b9~76@) (Add a9~74@ d9~80@)) (Add (Mul d9~80@ a9~74@) (Add b9~76@ c9~78@)))))) (=> (= tmp%10@ (= temp_9_0~2530@ temp_9_1~2647@)) (=> %%location_label%%9 tmp%10@))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
