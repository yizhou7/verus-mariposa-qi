...
(set-info :comment ";; mariposa_data/v_nl//6176167801928989998/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~261@ (Mul (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ d0~8@))) (Add (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ b0~4@)))) (Add (Mul (Mul (Sub b0~4@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ c0~6@))) b0~4@))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Add (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ b0~4@)))) (Add (Mul (Mul (Sub b0~4@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ c0~6@))) b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ c0~6@) (=> %%location_label%%0 (= temp_0_0~261@ temp_0_1~362@))) (=> (= temp_0_0~261@ temp_0_1~362@) (=> (= temp_1_0~491@ (Add (Mul a1~10@ (Mul (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@)) (Add (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Sub b1~12@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@)))))) (=> (= temp_1_1~592@ (Add (Mul a1~10@ (Mul (Mul b1~12@ (Mul b1~12@ (Mul b1~12@ d1~16@))) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@)) (Add (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Sub b1~12@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@)))))) (and (=> (= tmp%1@ (Mul b1~12@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b1~12@ b1~12@ tmp%1@) (=> %%location_label%%1 (= temp_1_0~491@ temp_1_1~592@)))) (=> (= temp_1_0~491@ temp_1_1~592@) (=> (= temp_2_0~743@ (Mul (Mul (Mul (Mul d2~24@ (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Add a2~18@ d2~24@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ c2~22@) (Sub a2~18@ b2~20@)))) (Mul (Mul (Mul b2~20@ (Sub a2~18@ a2~18@)) (Mul a2~18@ (Sub d2~24@ b2~20@))) (Mul (Add (Mul c2~22@ a2~18@) (Sub b2~20@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Sub a2~18@ c2~22@)))))) (=> (= temp_2_1~860@ (Mul (Mul (Mul (Mul d2~24@ (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Add a2~18@ d2~24@) (Mul b2~20@ b2~20@)) (Mul c2~22@ (Mul c2~22@ (Sub a2~18@ b2~20@))))) (Mul (Mul (Mul b2~20@ (Sub a2~18@ a2~18@)) (Mul a2~18@ (Sub d2~24@ b2~20@))) (Mul (Add (Mul c2~22@ a2~18@) (Sub b2~20@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Sub a2~18@ c2~22@)))))) (and (=> (= tmp%2@ (Sub a2~18@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c2~22@ c2~22@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~743@ temp_2_1~860@)))) (=> (= temp_2_0~743@ temp_2_1~860@) (=> (= temp_3_0~1031@ (Mul (Mul (Sub (Mul a3~26@ (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@))) (Mul (Sub (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Add c3~30@ d3~32@) (Mul c3~30@ b3~28@)))) (Mul (Mul (Mul (Sub a3~26@ b3~28@) (Mul 77 c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@))) (Mul (Mul (Add c3~30@ a3~26@) (Mul d3~32@ a3~26@)) (Add (Mul d3~32@ b3~28@) (Sub c3~30@ d3~32@)))))) (=> (= temp_3_1~1168@ (Mul (Mul (Sub (Mul a3~26@ (Mul d3~32@ b3~28@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ a3~26@))) (Mul (Sub (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Add c3~30@ d3~32@) (Mul c3~30@ b3~28@)))) (Mul (Mul (Mul (Sub a3~26@ b3~28@) (Mul 77 c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@))) (Mul (Mul (Add c3~30@ a3~26@) (Mul d3~32@ a3~26@)) (Add (Mul d3~32@ b3~28@) (Sub c3~30@ d3~32@)))))) (and (=> (= tmp%3@ (Mul b3~28@ a3~26@)) (=> (= tmp%4@ (Mul c3~30@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~1031@ temp_3_1~1168@))))) (=> (= temp_3_0~1031@ temp_3_1~1168@) (=> (= temp_4_0~1309@ (Mul (Mul (Mul (Add (Mul d4~40@ a4~34@) (Mul c4~38@ b4~36@)) (Mul (Mul c4~38@ a4~34@) a4~34@)) (Mul (Add (Mul a4~34@ c4~38@) (Add d4~40@ a4~34@)) (Mul (Add b4~36@ 5) (Mul c4~38@ b4~36@)))) (Mul c4~38@ (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@)) (Add d4~40@ (Mul a4~34@ d4~40@)))))) (=> (= temp_4_1~1414@ (Mul (Mul (Mul (Add (Mul d4~40@ a4~34@) (Mul c4~38@ b4~36@)) (Mul (Mul c4~38@ a4~34@) a4~34@)) (Mul (Add (Mul a4~34@ c4~38@) (Add d4~40@ a4~34@)) (Mul (Add b4~36@ 5) (Mul c4~38@ b4~36@)))) (Mul c4~38@ (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)) (Add d4~40@ (Mul a4~34@ d4~40@)))))) (and (=> (= tmp%5@ (Mul c4~38@ c4~38@)) (=> (= tmp%6@ (Mul d4~40@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~1309@ temp_4_1~1414@))))) (=> (= temp_4_0~1309@ temp_4_1~1414@) (=> (= temp_5_0~1575@ (Mul (Mul (Mul (Add (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)) (Sub (Mul c5~46@ b5~44@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul b5~44@ a5~42@) (Sub d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) a5~42@))) (Mul (Sub (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Add d5~48@ d5~48@) (Sub c5~46@ b5~44@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Add (Add c5~46@ a5~42@) (Mul a5~42@ d5~48@)))))) (=> (= temp_5_1~1700@ (Mul (Mul (Mul (Mul (Add (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)) (Sub (Mul c5~46@ b5~44@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul b5~44@ a5~42@) (Sub d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) a5~42@))) (Sub (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Add d5~48@ d5~48@) (Sub c5~46@ b5~44@)))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Add (Add c5~46@ a5~42@) (Mul a5~42@ d5~48@))))) (and (=> (= tmp%7@ (Mul (Mul (Add (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)) (Sub (Mul c5~46@ b5~44@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul b5~44@ a5~42@) (Sub d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) a5~42@)))) (=> (= tmp%8@ (Sub (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Add d5~48@ d5~48@) (Sub c5~46@ b5~44@)))) (=> (= tmp%9@ (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Add (Add c5~46@ a5~42@) (Mul a5~42@ d5~48@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%5 (= temp_5_0~1575@ temp_5_1~1700@)))))) (=> (= temp_5_0~1575@ temp_5_1~1700@) (=> (= temp_6_0~1983@ (Mul (Mul (Mul (Mul (Sub b6~52@ c6~54@) (Add b6~52@ a6~50@)) (Add (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ 10) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ d6~56@)))) (Add (Sub (Add (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Add a6~50@ d6~56@))) (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ c6~54@)) (Sub (Mul d6~56@ a6~50@) (Mul d6~56@ b6~52@)))))) (=> (= temp_6_1~2124@ (Mul (Mul (Mul (Mul (Sub b6~52@ c6~54@) (Add b6~52@ a6~50@)) (Add (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ 10) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ c6~54@)))) (Add (Sub (Add (Mul b6~52@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Add a6~50@ d6~56@))) (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ c6~54@)) (Sub (Mul d6~56@ a6~50@) (Mul d6~56@ b6~52@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1983@ temp_6_1~2124@))) (=> (= temp_6_0~1983@ temp_6_1~2124@) (=> (= temp_7_0~2269@ (Mul (Add (Mul (Mul (Mul d7~64@ c7~62@) (Sub c7~62@ d7~64@)) (Mul (Mul c7~62@ a7~58@) d7~64@)) (Mul (Mul (Mul a7~58@ d7~64@) b7~60@) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ c7~62@)))) (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@)) (Mul (Sub c7~62@ a7~58@) b7~60@)) (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@)) (Mul (Sub c7~62@ a7~58@) (Mul c7~62@ a7~58@)))))) (=> (= temp_7_1~2386@ (Mul (Add (Mul (Mul (Mul d7~64@ c7~62@) (Sub c7~62@ d7~64@)) (Mul (Mul c7~62@ a7~58@) d7~64@)) (Mul (Mul (Mul d7~64@ a7~58@) b7~60@) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ c7~62@)))) (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@)) (Mul (Sub c7~62@ a7~58@) b7~60@)) (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@)) (Mul (Sub c7~62@ a7~58@) (Mul c7~62@ a7~58@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ d7~64@) (=> %%location_label%%7 (= temp_7_0~2269@ temp_7_1~2386@))) (=> (= temp_7_0~2269@ temp_7_1~2386@) (=> (= temp_8_0~2527@ (Mul (Add (Mul (Add (Sub c8~70@ a8~66@) (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ b8~68@) c8~70@)) (Sub (Mul (Mul c8~70@ d8~72@) a8~66@) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ a8~66@)))) (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Sub a8~66@ b8~68@)) (Mul c8~70@ b8~68@)) (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@)) (Sub (Mul b8~68@ a8~66@) (Sub d8~72@ c8~70@)))))) (=> (= temp_8_1~2648@ (Mul (Add (Mul (Add (Sub c8~70@ a8~66@) (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ b8~68@) c8~70@)) (Sub (Mul (Mul c8~70@ d8~72@) a8~66@) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ a8~66@)))) (Mul (Mul (Sub (Mul (Mul c8~70@ b8~68@) a8~66@) (Mul (Mul c8~70@ b8~68@) b8~68@)) (Mul c8~70@ b8~68@)) (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@)) (Sub (Mul b8~68@ a8~66@) (Sub d8~72@ c8~70@)))))) (and (=> (= tmp%10@ (Mul c8~70@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%10@ a8~66@ b8~68@) (=> %%location_label%%8 (= temp_8_0~2527@ temp_8_1~2648@)))) (=> (= temp_8_0~2527@ temp_8_1~2648@) (=> (= temp_9_0~2795@ (Mul (Add (Mul (Add (Mul b9~76@ a9~74@) (Mul c9~78@ b9~76@)) (Mul (Add a9~74@ c9~78@) (Mul c9~78@ b9~76@))) (Mul (Mul d9~80@ (Sub d9~80@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Sub d9~80@ c9~78@)))) (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ c9~78@)) c9~78@) (Mul (Mul (Mul c9~78@ b9~76@) (Add a9~74@ d9~80@)) (Add (Mul d9~80@ a9~74@) (Add b9~76@ c9~78@)))))) (=> (= temp_9_1~2912@ (Mul (Add (Mul (Add (Mul b9~76@ a9~74@) (Mul c9~78@ b9~76@)) (Mul (Add a9~74@ c9~78@) (Mul c9~78@ b9~76@))) (Mul (Sub (Mul d9~80@ d9~80@) (Mul d9~80@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Sub d9~80@ c9~78@)))) (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ c9~78@)) c9~78@) (Mul (Mul (Mul c9~78@ b9~76@) (Add a9~74@ d9~80@)) (Add (Mul d9~80@ a9~74@) (Add b9~76@ c9~78@)))))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d9~80@ d9~80@ a9~74@) (=> %%location_label%%9 (= temp_9_0~2795@ temp_9_1~2912@))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
