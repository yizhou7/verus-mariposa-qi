...
a19: int, b19: int, c19: int, d19: int)
{
	...
	let temp_7_0 = (((((d7*c7)*(c7-d7))*((c7*a7)*d7))+(((a7*d7)*b7)*((a7*d7)*(d7*c7))))*((((c7*b7)*(b7*d7))*((c7-a7)*b7))*(((d7*b7)*(d7*a7))*((c7-a7)*(c7*a7)))));
	let temp_7_1 = (((((d7*c7)*(c7-d7))*((c7*a7)*d7))+(((d7*a7)*b7)*((a7*d7)*(d7*c7))))*((((c7*b7)*(b7*d7))*((c7-a7)*b7))*(((d7*b7)*(d7*a7))*((c7-a7)*(c7*a7)))));
	assert(temp_7_0 == temp_7_1);
	let temp_8_0 = (((((c8-a8)+(d8*c8))*((d8*b8)*c8))+(((c8*d8)*a8)-((a8*d8)*(a8*a8))))*((((c8*b8)*(a8-b8))*(c8*b8))*(((c8*a8)*(d8*b8))*((b8*a8)-(d8-c8)))));
	let temp_8_1 = (((((c8-a8)+(d8*c8))*((d8*b8)*c8))+(((c8*d8)*a8)-((a8*d8)*(a8*a8))))*(((((c8*b8)*a8)-((c8*b8)*b8))*(c8*b8))*(((c8*a8)*(d8*b8))*((b8*a8)-(d8-c8)))));
	assert(temp_8_0 == temp_8_1);
	let temp_9_0 = (((((b9*a9)+(c9*b9))*((a9+c9)*(c9*b9)))+((d9*(d9-a9))*((d9*c9)*(d9-c9))))*((((a9*b9)*(c9*c9))*c9)*(((c9*b9)*(a9+d9))*((d9*a9)+(b9+c9)))));
	let temp_9_1 = (((((b9*a9)+(c9*b9))*((a9+c9)*(c9*b9)))+(((d9*d9)-(d9*a9))*((d9*c9)*(d9-c9))))*((((a9*b9)*(c9*c9))*c9)*(((c9*b9)*(a9+d9))*((d9*a9)+(b9+c9)))));
