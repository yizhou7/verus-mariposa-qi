...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ b0~4@)) (Mul (Sub b0~4@ a0~2@) (Mul c0~6@ d0~8@))) (Mul (Add (Mul d0~8@ 53) (Mul d0~8@ d0~8@)) (Mul (Sub a0~2@ a0~2@) (Sub a0~2@ b0~4@))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ b0~4@)) (Mul (Sub b0~4@ a0~2@) (Mul c0~6@ d0~8@))) (Add (Mul d0~8@ 53) (Mul d0~8@ d0~8@))) (Mul (Sub a0~2@ a0~2@) (Sub a0~2@ b0~4@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~471@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Add a1~10@ c1~14@)) (Mul (Add d1~16@ b1~12@) (Sub b1~12@ b1~12@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) b1~12@))) (=> (= temp_1_1~524@ (Mul (Mul (Mul (Add d1~16@ b1~12@) (Sub b1~12@ b1~12@)) (Mul (Mul a1~10@ d1~16@) (Add a1~10@ c1~14@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) b1~12@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~471@ temp_1_1~524@))) (=> (= temp_1_0~471@ temp_1_1~524@) (=> (= temp_2_0~613@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~678@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~613@ temp_2_1~678@))) (=> (= temp_2_0~613@ temp_2_1~678@) (=> (= temp_3_0~759@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ a3~26@)) (Mul (Mul b3~28@ a3~26@) d3~32@)))) (=> (= temp_3_1~816@ (Mul (Mul (Mul d3~32@ d3~32@) c3~30@) (Mul (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ b3~28@)) (Mul (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ a3~26@)) (Mul (Mul b3~28@ a3~26@) d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~759@ temp_3_1~816@))) (=> (= temp_3_0~759@ temp_3_1~816@) (=> (= temp_4_0~905@ (Sub (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Sub c4~38@ a4~34@))) (Add (Mul (Add d4~40@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~970@ (Sub (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@)) (Mul c4~38@ (Mul a4~34@ (Sub c4~38@ a4~34@)))) (Add (Mul (Add d4~40@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~905@ temp_4_1~970@))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
