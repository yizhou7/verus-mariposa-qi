...
(set-info :comment ";; mariposa_data/v_nl//14040977382153817238/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ b0~4@)) (Mul (Sub b0~4@ a0~2@) (Mul c0~6@ d0~8@))) (Mul (Add (Mul d0~8@ 53) (Mul d0~8@ d0~8@)) (Mul (Sub a0~2@ a0~2@) (Sub a0~2@ b0~4@))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ b0~4@)) (Mul (Sub b0~4@ a0~2@) (Mul c0~6@ d0~8@))) (Add (Mul d0~8@ 53) (Mul d0~8@ d0~8@))) (Mul (Sub a0~2@ a0~2@) (Sub a0~2@ b0~4@)))) (and (=> (= tmp%1@ (Mul (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ b0~4@)) (Mul (Sub b0~4@ a0~2@) (Mul c0~6@ d0~8@)))) (=> (= tmp%2@ (Add (Mul d0~8@ 53) (Mul d0~8@ d0~8@))) (=> (= tmp%3@ (Mul (Sub a0~2@ a0~2@) (Sub a0~2@ b0~4@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@)))))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~541@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Add a1~10@ c1~14@)) (Mul (Add d1~16@ b1~12@) (Sub b1~12@ b1~12@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) b1~12@))) (=> (= temp_1_1~594@ (Mul (Mul (Mul (Add d1~16@ b1~12@) (Sub b1~12@ b1~12@)) (Mul (Mul a1~10@ d1~16@) (Add a1~10@ c1~14@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) b1~12@))) (and (=> (= tmp%4@ (Mul (Mul a1~10@ d1~16@) (Add a1~10@ c1~14@))) (=> (= tmp%5@ (Mul (Add d1~16@ b1~12@) (Sub b1~12@ b1~12@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~541@ temp_1_1~594@))))) (=> (= temp_1_0~541@ temp_1_1~594@) (=> (= temp_2_0~711@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~776@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ b2~20@))))) (and (=> (= tmp%6@ (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ b2~20@)))) (=> (= tmp%7@ (Mul (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~711@ temp_2_1~776@))))) (=> (= temp_2_0~711@ temp_2_1~776@) (=> (= temp_3_0~917@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ a3~26@)) (Mul (Mul b3~28@ a3~26@) d3~32@)))) (=> (= temp_3_1~974@ (Mul (Mul (Mul d3~32@ d3~32@) c3~30@) (Mul (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ b3~28@)) (Mul (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ a3~26@)) (Mul (Mul b3~28@ a3~26@) d3~32@))))) (and (=> (= tmp%8@ (Mul (Mul d3~32@ d3~32@) c3~30@)) (=> (= tmp%9@ (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ b3~28@))) (=> (= tmp%10@ (Mul (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ a3~26@)) (Mul (Mul b3~28@ a3~26@) d3~32@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%3 (= temp_3_0~917@ temp_3_1~974@)))))) (=> (= temp_3_0~917@ temp_3_1~974@) (=> (= temp_4_0~1113@ (Sub (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Sub c4~38@ a4~34@))) (Add (Mul (Add d4~40@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~1178@ (Sub (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@)) (Mul c4~38@ (Mul a4~34@ (Sub c4~38@ a4~34@)))) (Add (Mul (Add d4~40@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@))))) (=> (= tmp%11@ (Sub c4~38@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c4~38@ a4~34@ tmp%11@) (=> %%location_label%%4 (= temp_4_0~1113@ temp_4_1~1178@)))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
