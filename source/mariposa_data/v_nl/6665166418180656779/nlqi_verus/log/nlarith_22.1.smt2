...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul (Mul b0~4@ a0~2@) a0~2@) a0~2@) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~422@ (Sub (Mul (Sub (Add a1~10@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ a1~10@))) c1~14@)) (=> (= temp_1_1~459@ (Sub (Mul (Sub (Add a1~10@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ a1~10@))) c1~14@)) (=> (= tmp%2@ (= temp_1_0~422@ temp_1_1~459@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~551@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Mul 77 b2~20@) (Add a2~18@ a2~18@))) (Sub (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) (Sub (Mul a2~18@ d2~24@) (Sub b2~20@ b2~20@))))) (=> (= temp_2_1~628@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@)) (Mul 77 (Mul b2~20@ (Add a2~18@ a2~18@)))) (Sub (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) (Sub (Mul a2~18@ d2~24@) (Sub b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~551@ temp_2_1~628@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~708@ (Sub (Mul (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~773@ (Sub (Mul (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~708@ temp_3_1~773@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~853@ (Mul (Mul (Add (Sub b4~36@ a4~34@) (Sub a4~34@ a4~34@)) (Sub (Mul a4~34@ a4~34@) (Add d4~40@ b4~36@))) (Add (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~918@ (Mul (Mul (Sub (Mul a4~34@ a4~34@) (Add d4~40@ b4~36@)) (Add (Sub b4~36@ a4~34@) (Sub a4~34@ a4~34@))) (Add (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~853@ temp_4_1~918@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~966@ (Mul a5~42@ (Mul (Mul c5~46@ (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~999@ (Mul a5~42@ (Mul (Mul c5~46@ (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~966@ temp_5_1~999@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1079@ (Add (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Add (Mul c6~54@ c6~54@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul d6~56@ a6~50@) (Add c6~54@ b6~52@)) (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ c6~54@))))) (=> (= temp_6_1~1144@ (Add (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Add (Mul c6~54@ c6~54@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul d6~56@ a6~50@) (Add c6~54@ b6~52@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1079@ temp_6_1~1144@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1236@ (Mul (Add (Mul (Sub a7~58@ a7~58@) (Sub b7~60@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ b7~60@))) (Sub (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul 79 d7~64@))))) (=> (= temp_7_1~1321@ (Mul (Add (Sub (Mul a7~58@ (Sub b7~60@ a7~58@)) (Mul a7~58@ (Sub b7~60@ a7~58@))) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ b7~60@))) (Sub (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul 79 d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1236@ temp_7_1~1321@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1397@ (Mul (Mul (Mul (Sub a8~66@ a8~66@) (Mul d8~72@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ d8~72@)) (Mul (Mul c8~70@ b8~68@) d8~72@)))) (=> (= temp_8_1~1458@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Sub a8~66@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ d8~72@)) (Mul (Mul c8~70@ b8~68@) d8~72@)))) (=> (= tmp%9@ (= temp_8_0~1397@ temp_8_1~1458@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1546@ (Mul (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ a9~74@) (Mul a9~74@ b9~76@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul 75 b9~76@)) (Mul (Mul c9~78@ a9~74@) a9~74@)))) (=> (= temp_9_1~1619@ (Mul (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ a9~74@) (Mul a9~74@ b9~76@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul 75 b9~76@)) (Mul (Mul a9~74@ c9~78@) a9~74@)))) (=> (= tmp%10@ (= temp_9_0~1546@ temp_9_1~1619@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1711@ (Mul (Mul (Mul (Mul b10~84@ d10~88@) (Add 12 b10~84@)) (Mul (Mul d10~88@ b10~84@) (Sub d10~88@ d10~88@))) (Mul (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ d10~88@))))) (=> (= temp_10_1~1796@ (Mul (Mul (Mul (Mul b10~84@ d10~88@) (Add 12 b10~84@)) (Sub (Mul (Mul d10~88@ b10~84@) d10~88@) (Mul (Mul d10~88@ b10~84@) d10~88@))) (Mul (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1711@ temp_10_1~1796@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1876@ (Mul (Mul (Mul (Sub d11~96@ c11~94@) (Add a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@))) (Add (Mul (Mul d11~96@ b11~92@) (Mul d11~96@ a11~90@)) (Add (Sub c11~94@ a11~90@) (Add d11~96@ c11~94@))))) (=> (= temp_11_1~1941@ (Mul (Mul (Mul (Sub d11~96@ c11~94@) (Add a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@))) (Add (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@)) (Add (Sub c11~94@ a11~90@) (Add d11~96@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1876@ temp_11_1~1941@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2033@ (Mul (Add (Mul (Mul a12~98@ d12~104@) (Mul d12~104@ 70)) (Mul (Sub c12~102@ d12~104@) (Mul c12~102@ c12~102@))) (Add (Sub (Add d12~104@ c12~102@) (Mul c12~102@ b12~100@)) (Add (Mul a12~98@ a12~98@) (Mul d12~104@ c12~102@))))) (=> (= temp_12_1~2110@ (Mul (Add (Mul a12~98@ (Mul d12~104@ (Mul d12~104@ 70))) (Mul (Sub c12~102@ d12~104@) (Mul c12~102@ c12~102@))) (Add (Sub (Add d12~104@ c12~102@) (Mul c12~102@ b12~100@)) (Add (Mul a12~98@ a12~98@) (Mul d12~104@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~2033@ temp_12_1~2110@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2190@ (Mul (Mul (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ d13~112@))) (Mul (Add (Add d13~112@ c13~110@) (Mul c13~110@ d13~112@)) (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ b13~108@))))) (=> (= temp_13_1~2255@ (Mul (Mul (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ d13~112@))) (Mul (Mul (Add (Add d13~112@ c13~110@) (Mul c13~110@ d13~112@)) (Mul d13~112@ d13~112@)) (Mul b13~108@ b13~108@)))) (=> (= tmp%14@ (= temp_13_0~2190@ temp_13_1~2255@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2347@ (Mul (Mul (Sub (Mul c14~118@ a14~114@) (Mul c14~118@ b14~116@)) (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ a14~114@))) (Add (Mul (Mul c14~118@ 74) (Add b14~116@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ a14~114@))))) (=> (= temp_14_1~2424@ (Mul (Add (Mul (Mul c14~118@ 74) (Add b14~116@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ a14~114@))) (Mul (Sub (Mul c14~118@ a14~114@) (Mul c14~118@ b14~116@)) (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2347@ temp_14_1~2424@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2504@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Add a15~122@ a15~122@)) (Mul (Mul a15~122@ c15~126@) (Add b15~124@ c15~126@))) (Sub (Mul (Sub b15~124@ d15~128@) (Mul c15~126@ c15~126@)) (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~2569@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Add a15~122@ a15~122@)) (Mul (Mul a15~122@ c15~126@) (Add b15~124@ c15~126@))) (Sub (Mul (Sub b15~124@ d15~128@) (Mul c15~126@ c15~126@)) (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ a15~122@))))) (=> (= tmp%16@ (= temp_15_0~2504@ temp_15_1~2569@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2649@ (Mul (Mul (Mul (Mul a16~130@ a16~130@) (Sub b16~132@ c16~134@)) (Mul (Mul a16~130@ a16~130@) (Mul b16~132@ d16~136@))) (Mul (Mul (Mul d16~136@ c16~134@) (Mul a16~130@ a16~130@)) (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2722@ (Mul (Mul (Sub (Mul (Mul a16~130@ a16~130@) b16~132@) (Mul (Mul a16~130@ a16~130@) c16~134@)) (Mul (Mul a16~130@ a16~130@) (Mul b16~132@ d16~136@))) (Mul (Mul (Mul d16~136@ c16~134@) (Mul a16~130@ a16~130@)) (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2649@ temp_16_1~2722@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2794@ (Mul (Mul (Add (Mul b17~140@ a17~138@) d17~144@) (Mul b17~140@ (Mul b17~140@ c17~142@))) (Mul (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@)) (Mul (Mul c17~142@ c17~142@) (Mul c17~142@ b17~140@))))) (=> (= temp_17_1~2851@ (Mul (Mul (Mul b17~140@ (Mul b17~140@ c17~142@)) (Add (Mul b17~140@ a17~138@) d17~144@)) (Mul (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@)) (Mul (Mul c17~142@ c17~142@) (Mul c17~142@ b17~140@))))) (=> (= tmp%18@ (= temp_17_0~2794@ temp_17_1~2851@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2931@ (Mul (Mul (Mul (Mul d18~152@ b18~148@) (Mul d18~152@ d18~152@)) (Mul (Mul c18~150@ b18~148@) (Mul d18~152@ c18~150@))) (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ d18~152@)) (Mul (Sub c18~150@ d18~152@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~2996@ (Mul (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ d18~152@)) (Mul (Mul c18~150@ b18~148@) (Mul d18~152@ c18~150@))) (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ d18~152@)) (Mul (Sub c18~150@ d18~152@) (Mul a18~146@ d18~152@))))) (=> (= tmp%19@ (= temp_18_0~2931@ temp_18_1~2996@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3088@ (Mul (Mul (Mul (Mul 7 d19~160@) (Mul b19~156@ b19~156@)) (Add (Mul d19~160@ d19~160@) (Mul d19~160@ a19~154@))) (Add (Mul (Add d19~160@ b19~156@) (Mul a19~154@ d19~160@)) (Add (Mul c19~158@ a19~154@) (Mul b19~156@ d19~160@))))) (=> (= temp_19_1~3165@ (Mul (Mul (Mul (Mul 7 d19~160@) (Mul b19~156@ b19~156@)) (Add (Mul d19~160@ d19~160@) (Mul d19~160@ a19~154@))) (Add (Mul (Mul a19~154@ d19~160@) (Add d19~160@ b19~156@)) (Add (Mul c19~158@ a19~154@) (Mul b19~156@ d19~160@))))) (=> (= tmp%20@ (= temp_19_0~3088@ temp_19_1~3165@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3249@ (Mul (Mul (Mul 95 (Mul d20~168@ d20~168@)) (Sub (Mul a20~162@ a20~162@) (Mul a20~162@ c20~166@))) (Mul (Mul (Mul b20~164@ b20~164@) d20~168@) (Mul (Sub b20~164@ c20~166@) (Mul d20~168@ d20~168@))))) (=> (= temp_20_1~3318@ (Mul (Mul (Mul 95 (Mul d20~168@ d20~168@)) (Sub (Mul a20~162@ a20~162@) (Mul a20~162@ c20~166@))) (Mul (Mul (Mul b20~164@ b20~164@) d20~168@) (Mul (Sub b20~164@ c20~166@) (Mul d20~168@ d20~168@))))) (=> (= tmp%21@ (= temp_20_0~3249@ temp_20_1~3318@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3398@ (Add (Add (Mul (Mul b21~172@ b21~172@) (Sub a21~170@ b21~172@)) (Mul (Mul b21~172@ b21~172@) (Mul d21~176@ d21~176@))) (Mul (Mul (Mul a21~170@ c21~174@) (Mul d21~176@ a21~170@)) (Mul (Mul c21~174@ c21~174@) (Mul d21~176@ c21~174@))))) (=> (= temp_21_1~3463@ (Add (Add (Mul (Mul b21~172@ b21~172@) (Sub a21~170@ b21~172@)) (Mul (Mul (Mul b21~172@ b21~172@) d21~176@) d21~176@)) (Mul (Mul (Mul a21~170@ c21~174@) (Mul d21~176@ a21~170@)) (Mul (Mul c21~174@ c21~174@) (Mul d21~176@ c21~174@))))) (=> (= tmp%22@ (= temp_21_0~3398@ temp_21_1~3463@)) (=> %%location_label%%21 tmp%22@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
