...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Add a0~2@ 36)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Add (Add c0~6@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Add a0~2@ 36)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@)) (Add (Add c0~6@ c0~6@) (Mul c0~6@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~483@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Add (Mul c1~14@ b1~12@) (Sub a1~10@ b1~12@))) (Mul (Sub (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@)) (Add (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~548@ (Mul (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Add (Mul c1~14@ b1~12@) (Sub a1~10@ b1~12@))) (Sub (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@))) (Add (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~483@ temp_1_1~548@))) (=> (= temp_1_0~483@ temp_1_1~548@) (=> (= temp_2_0~633@ (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ a2~18@)) (Add (Mul d2~24@ c2~22@) (Mul a2~18@ b2~20@))) (Mul (Add (Mul a2~18@ d2~24@) (Add b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) d2~24@)))) (=> (= temp_2_1~694@ (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ b2~20@)) (Add (Mul d2~24@ c2~22@) (Mul a2~18@ b2~20@))) (Mul (Add (Mul a2~18@ d2~24@) (Add b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) d2~24@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~633@ temp_2_1~694@))) (=> (= temp_2_0~633@ temp_2_1~694@) (=> (= temp_3_0~775@ (Add (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@))) (Mul (Add (Mul b3~28@ d3~32@) c3~30@) (Mul (Mul c3~30@ d3~32@) a3~26@)))) (=> (= temp_3_1~832@ (Add (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Add (Mul b3~28@ d3~32@) c3~30@) (Mul (Mul c3~30@ d3~32@) a3~26@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~775@ temp_3_1~832@))) (=> (= temp_3_0~775@ temp_3_1~832@) (=> (= temp_4_0~917@ (Mul (Sub (Mul a4~34@ (Mul a4~34@ d4~40@)) (Mul (Mul a4~34@ d4~40@) (Sub b4~36@ a4~34@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ c4~38@)) (Sub (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~994@ (Mul (Sub (Mul a4~34@ (Mul a4~34@ d4~40@)) (Mul (Mul a4~34@ d4~40@) (Sub b4~36@ a4~34@))) (Sub (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ c4~38@)) (Mul c4~38@ d4~40@)) (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ c4~38@)) (Mul b4~36@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~917@ temp_4_1~994@))) (=> (= temp_4_0~917@ temp_4_1~994@) (=> (= temp_5_0~1087@ (Mul (Add (Mul (Mul d5~48@ a5~42@) (Add c5~46@ b5~44@)) (Mul (Mul a5~42@ d5~48@) d5~48@)) (Mul (Mul (Sub 60 c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ b5~44@) b5~44@)))) (=> (= temp_5_1~1156@ (Mul (Add (Mul (Add c5~46@ b5~44@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ d5~48@) d5~48@)) (Mul (Mul (Sub 60 c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ b5~44@) b5~44@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1087@ temp_5_1~1156@))) (=> (= temp_5_0~1087@ temp_5_1~1156@) (=> (= temp_6_0~1245@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@))) (Sub (Mul (Mul a6~50@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1310@ (Mul (Mul (Mul (Mul (Mul b6~52@ a6~50@) a6~50@) a6~50@) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@))) (Sub (Mul (Mul a6~50@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1245@ temp_6_1~1310@))) (=> (= temp_6_0~1245@ temp_6_1~1310@) (=> (= temp_7_0~1399@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@)) (Sub (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@))) (Mul (Mul (Sub b7~60@ b7~60@) (Mul d7~64@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1464@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@)) (Sub (Mul b7~60@ a7~58@) (Mul a7~58@ a7~58@))) (Mul (Mul (Sub b7~60@ b7~60@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1399@ temp_7_1~1464@))) (=> (= temp_7_0~1399@ temp_7_1~1464@) (=> (= temp_8_0~1565@ (Mul (Add (Add (Mul b8~68@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Sub b8~68@ b8~68@))) (Add (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ 73)) 28))) (=> (= temp_8_1~1642@ (Mul (Add (Add (Mul b8~68@ d8~72@) (Mul b8~68@ c8~70@)) (Mul c8~70@ (Mul c8~70@ (Sub b8~68@ b8~68@)))) (Add (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ 73)) 28))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1565@ temp_8_1~1642@))) (=> (= temp_8_0~1565@ temp_8_1~1642@) (=> (= temp_9_0~1739@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ c9~78@)) 30) (Mul (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ c9~78@)) (Mul (Mul d9~80@ d9~80@) 46)))) (=> (= temp_9_1~1812@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ c9~78@)) 30) (Mul (Mul (Mul b9~76@ d9~80@) (Mul c9~78@ d9~80@)) (Mul (Mul d9~80@ d9~80@) 46)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1739@ temp_9_1~1812@))) (=> (= temp_9_0~1739@ temp_9_1~1812@) (=> (= temp_10_0~1905@ (Mul (Mul (Sub (Mul c10~86@ b10~84@) (Mul d10~88@ b10~84@)) (Mul d10~88@ d10~88@)) (Mul (Mul (Mul b10~84@ a10~82@) (Add d10~88@ c10~86@)) (Sub (Mul d10~88@ a10~82@) (Mul c10~86@ 18))))) (=> (= temp_10_1~1974@ (Mul (Mul (Sub (Mul c10~86@ b10~84@) (Mul d10~88@ b10~84@)) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ a10~82@) (Mul (Add d10~88@ c10~86@) (Sub (Mul d10~88@ a10~82@) (Mul c10~86@ 18)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1905@ temp_10_1~1974@))) (=> (= temp_10_0~1905@ temp_10_1~1974@) (=> (= temp_11_0~2063@ (Mul (Mul (Add (Mul d11~96@ c11~94@) (Mul c11~94@ a11~90@)) (Add (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@))) (Sub (Mul (Sub c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2128@ (Mul (Mul (Add (Mul d11~96@ c11~94@) (Mul c11~94@ a11~90@)) (Add (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@))) (Sub (Mul (Sub c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Mul b11~92@ c11~94@) (Mul d11~96@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2063@ temp_11_1~2128@))) (=> (= temp_11_0~2063@ temp_11_1~2128@) (=> (= temp_12_0~2213@ (Mul (Mul (Mul (Add d12~104@ c12~102@) (Mul a12~98@ a12~98@)) (Mul (Add d12~104@ b12~100@) d12~104@)) (Add (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@)) (Add (Mul c12~102@ b12~100@) (Mul a12~98@ a12~98@))))) (=> (= temp_12_1~2274@ (Mul (Mul (Mul (Add d12~104@ c12~102@) (Mul a12~98@ a12~98@)) (Mul (Add d12~104@ b12~100@) d12~104@)) (Add (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@)) (Add (Mul c12~102@ b12~100@) (Mul a12~98@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2213@ temp_12_1~2274@))) (=> (= temp_12_0~2213@ temp_12_1~2274@) (=> (= temp_13_0~2359@ (Mul (Mul (Mul (Add b13~108@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ c13~110@))) (Mul a13~106@ (Add (Mul a13~106@ 9) b13~108@)))) (=> (= temp_13_1~2420@ (Mul (Mul a13~106@ (Add (Mul a13~106@ 9) b13~108@)) (Mul (Mul (Add b13~108@ a13~106@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Mul b13~108@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2359@ temp_13_1~2420@))) (=> (= temp_13_0~2359@ temp_13_1~2420@) (=> (= temp_14_0~2509@ (Mul (Mul (Mul (Mul a14~114@ b14~116@) (Add c14~118@ c14~118@)) (Mul (Mul d14~120@ c14~118@) (Mul b14~116@ c14~118@))) (Add (Mul (Sub c14~118@ b14~116@) (Mul a14~114@ d14~120@)) (Mul (Add c14~118@ d14~120@) (Mul c14~118@ a14~114@))))) (=> (= temp_14_1~2574@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Add c14~118@ c14~118@)) (Mul (Mul d14~120@ c14~118@) (Mul b14~116@ c14~118@))) (Add (Mul (Sub c14~118@ b14~116@) (Mul a14~114@ d14~120@)) (Mul (Add c14~118@ d14~120@) (Mul c14~118@ a14~114@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2509@ temp_14_1~2574@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
