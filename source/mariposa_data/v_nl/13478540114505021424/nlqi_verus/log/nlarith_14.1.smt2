...
(declare-const temp_1_0~570@ Int)
(declare-const temp_1_1~691@ Int)
(declare-const temp_2_0~827@ Int)
(declare-const temp_2_1~948@ Int)
(declare-const temp_3_0~1116@ Int)
(declare-const temp_3_1~1269@ Int)
(declare-const temp_4_0~1405@ Int)
(declare-const temp_4_1~1526@ Int)
(declare-const temp_5_0~1630@ Int)
(declare-const temp_5_1~1719@ Int)
(declare-const temp_6_0~1823@ Int)
(declare-const temp_6_1~1912@ Int)
(declare-const temp_7_0~1984@ Int)
(declare-const temp_7_1~2041@ Int)
(declare-const temp_8_0~2185@ Int)
(declare-const temp_8_1~2314@ Int)
(declare-const temp_9_0~2442@ Int)
(declare-const temp_9_1~2555@ Int)
(declare-const temp_10_0~2699@ Int)
(declare-const temp_10_1~2828@ Int)
(declare-const temp_11_0~2964@ Int)
(declare-const temp_11_1~3085@ Int)
(declare-const temp_12_0~3269@ Int)
(declare-const temp_12_1~3438@ Int)
(declare-const temp_13_0~3566@ Int)
(declare-const temp_13_1~3679@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Sub (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ d0~8@))) (Add (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@)) (Sub (Add a0~2@ b0~4@) (Mul d0~8@ a0~2@)))) (Mul (Mul (Sub (Add d0~8@ a0~2@) (Sub d0~8@ c0~6@)) (Mul (Sub c0~6@ a0~2@) (Mul c0~6@ 59))) (Mul (Mul d0~8@ (Mul a0~2@ a0~2@)) (Sub (Sub a0~2@ b0~4@) (Mul b0~4@ d0~8@)))))) (=> (= temp_0_1~434@ (Sub (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ d0~8@))) (Add (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@)) (Sub (Add a0~2@ b0~4@) (Mul d0~8@ a0~2@)))) (Mul (Mul (Sub (Add d0~8@ a0~2@) (Sub d0~8@ c0~6@)) (Mul (Sub c0~6@ a0~2@) (Mul c0~6@ 59))) (Mul (Mul (Mul a0~2@ a0~2@) d0~8@) (Sub (Sub a0~2@ b0~4@) (Mul b0~4@ d0~8@)))))) (=> (= tmp%1@ (= temp_0_0~297@ temp_0_1~434@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~570@ (Mul (Mul (Mul (Mul (Mul c1~14@ b1~12@) c1~14@) (Mul (Add b1~12@ c1~14@) (Sub b1~12@ b1~12@))) (Add b1~12@ (Mul (Mul b1~12@ a1~10@) (Sub b1~12@ b1~12@)))) (Mul (Add (Mul (Mul a1~10@ b1~12@) (Sub c1~14@ b1~12@)) (Mul (Add d1~16@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Mul c1~14@ (Mul d1~16@ 4)) (Sub (Mul a1~10@ d1~16@) (Mul b1~12@ a1~10@)))))) (=> (= temp_1_1~691@ (Mul (Mul (Add (Mul (Mul a1~10@ b1~12@) (Sub c1~14@ b1~12@)) (Mul (Add d1~16@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Mul c1~14@ (Mul d1~16@ 4)) (Sub (Mul a1~10@ d1~16@) (Mul b1~12@ a1~10@)))) (Mul (Mul (Mul (Mul c1~14@ b1~12@) c1~14@) (Mul (Add b1~12@ c1~14@) (Sub b1~12@ b1~12@))) (Add b1~12@ (Mul (Mul b1~12@ a1~10@) (Sub b1~12@ b1~12@)))))) (=> (= tmp%2@ (= temp_1_0~570@ temp_1_1~691@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~827@ (Mul (Add (Mul (Mul (Mul b2~20@ d2~24@) (Add d2~24@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul b2~20@ 89) (Mul c2~22@ b2~20@)) b2~20@)) (Mul (Mul (Add (Sub c2~22@ b2~20@) (Mul c2~22@ a2~18@)) (Sub c2~22@ b2~20@)) (Mul (Mul (Sub b2~20@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Add c2~22@ a2~18@)))))) (=> (= temp_2_1~948@ (Mul (Add (Mul (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Add d2~24@ d2~24@))) (Mul (Mul (Mul b2~20@ 89) (Mul c2~22@ b2~20@)) b2~20@)) (Mul (Mul (Add (Sub c2~22@ b2~20@) (Mul c2~22@ a2~18@)) (Sub c2~22@ b2~20@)) (Mul (Mul (Sub b2~20@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Add c2~22@ a2~18@)))))) (=> (= tmp%3@ (= temp_2_0~827@ temp_2_1~948@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1116@ (Sub (Mul (Mul c3~30@ (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Mul 6 a3~26@) (Mul 28 a3~26@)))) (Mul (Mul (Mul (Add d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Mul 49 b3~28@))) (Add (Mul (Mul d3~32@ d3~32@) (Sub a3~26@ b3~28@)) (Sub (Mul c3~30@ c3~30@) (Mul c3~30@ c3~30@)))))) (=> (= temp_3_1~1269@ (Sub (Mul (Mul c3~30@ (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Mul 6 a3~26@) (Mul 28 a3~26@)))) (Mul (Mul (Mul (Add d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Mul 49 b3~28@))) (Add (Mul (Sub a3~26@ b3~28@) (Mul d3~32@ d3~32@)) (Sub (Mul c3~30@ c3~30@) (Mul c3~30@ c3~30@)))))) (=> (= tmp%4@ (= temp_3_0~1116@ temp_3_1~1269@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1405@ (Add (Mul (Mul (Mul (Add b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ d4~40@) c4~38@)) (Mul (Add (Mul a4~34@ a4~34@) (Mul b4~36@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@)))) (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ c4~38@)) (Mul (Sub b4~36@ c4~38@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul a4~34@ b4~36@) c4~38@) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@)))))) (=> (= temp_4_1~1526@ (Add (Mul (Mul (Add (Mul a4~34@ a4~34@) (Mul b4~36@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@))) (Mul (Mul (Add b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ d4~40@) c4~38@))) (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ c4~38@)) (Mul (Sub b4~36@ c4~38@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul a4~34@ b4~36@) c4~38@) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@)))))) (=> (= tmp%5@ (= temp_4_0~1405@ temp_4_1~1526@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1630@ (Mul (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (Sub d5~48@ (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@)))) (Mul (Mul a5~42@ (Mul c5~46@ (Mul d5~48@ c5~46@))) (Add c5~46@ (Mul (Sub b5~44@ d5~48@) (Sub d5~48@ d5~48@)))))) (=> (= temp_5_1~1719@ (Mul (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (Sub d5~48@ (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@)))) (Mul (Mul a5~42@ (Mul c5~46@ (Mul d5~48@ c5~46@))) (Add c5~46@ (Mul (Sub b5~44@ d5~48@) (Sub d5~48@ d5~48@)))))) (=> (= tmp%6@ (= temp_5_0~1630@ temp_5_1~1719@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1823@ (Mul (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Sub c6~54@ a6~50@)) (Add (Mul a6~50@ d6~56@) (Mul d6~56@ a6~50@))) (Mul d6~56@ (Sub (Mul a6~50@ c6~54@) (Mul b6~52@ b6~52@)))) (Mul (Mul (Sub (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@))) a6~50@))) (=> (= temp_6_1~1912@ (Mul (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Sub c6~54@ a6~50@)) (Add (Mul a6~50@ d6~56@) (Mul a6~50@ d6~56@))) (Mul d6~56@ (Sub (Mul a6~50@ c6~54@) (Mul b6~52@ b6~52@)))) (Mul (Mul (Sub (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@))) a6~50@))) (=> (= tmp%7@ (= temp_6_0~1823@ temp_6_1~1912@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1984@ (Mul b7~60@ (Mul (Mul (Add (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ a7~58@))) (Mul c7~62@ (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ d7~64@)))))) (=> (= temp_7_1~2041@ (Mul b7~60@ (Mul (Mul (Add (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ a7~58@))) (Mul c7~62@ (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ d7~64@)))))) (=> (= tmp%8@ (= temp_7_0~1984@ temp_7_1~2041@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2185@ (Sub (Mul (Mul b8~68@ (Mul (Sub a8~66@ b8~68@) (Mul 71 a8~66@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ d8~72@)) (Sub (Mul b8~68@ b8~68@) (Add b8~68@ c8~70@)))) (Sub (Mul (Mul (Mul c8~70@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@ d8~72@) (Sub d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)))))) (=> (= temp_8_1~2314@ (Sub (Mul (Mul b8~68@ (Mul (Sub a8~66@ b8~68@) (Mul a8~66@ 71))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ d8~72@)) (Sub (Mul b8~68@ b8~68@) (Add b8~68@ c8~70@)))) (Sub (Mul (Mul (Mul c8~70@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@ d8~72@) (Sub d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)))))) (=> (= tmp%9@ (= temp_8_0~2185@ temp_8_1~2314@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2442@ (Mul (Mul (Sub (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ d9~80@))) (Sub (Mul (Sub c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ b9~76@)))) (Mul (Mul (Mul (Sub a9~74@ d9~80@) (Mul d9~80@ d9~80@)) (Mul (Mul b9~76@ a9~74@) d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ (Mul d9~80@ d9~80@)))))) (=> (= temp_9_1~2555@ (Mul (Mul (Sub (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ d9~80@))) (Sub (Mul (Sub c9~78@ d9~80@) (Mul b9~76@ c9~78@)) (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ b9~76@)))) (Mul (Mul (Mul (Sub a9~74@ d9~80@) (Mul d9~80@ d9~80@)) (Mul (Mul b9~76@ a9~74@) d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ (Mul d9~80@ d9~80@)))))) (=> (= tmp%10@ (= temp_9_0~2442@ temp_9_1~2555@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~2699@ (Mul (Mul (Mul (Mul (Sub a10~82@ b10~84@) (Mul a10~82@ b10~84@)) (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (Sub c10~86@ d10~88@) (Mul c10~86@ b10~84@)))) (Mul (Mul (Sub (Mul b10~84@ a10~82@) (Mul a10~82@ a10~82@)) (Add (Mul d10~88@ c10~86@) (Mul d10~88@ d10~88@))) (Mul (Mul (Add a10~82@ a10~82@) (Mul b10~84@ c10~86@)) (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ c10~86@)))))) (=> (= temp_10_1~2828@ (Mul (Mul (Mul (Mul (Mul a10~82@ b10~84@) (Sub a10~82@ b10~84@)) (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (Sub c10~86@ d10~88@) (Mul c10~86@ b10~84@)))) (Mul (Mul (Sub (Mul b10~84@ a10~82@) (Mul a10~82@ a10~82@)) (Add (Mul d10~88@ c10~86@) (Mul d10~88@ d10~88@))) (Mul (Mul (Add a10~82@ a10~82@) (Mul b10~84@ c10~86@)) (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ c10~86@)))))) (=> (= tmp%11@ (= temp_10_0~2699@ temp_10_1~2828@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~2964@ (Mul (Mul (Mul (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ a11~90@)) (Mul (Mul b11~92@ b11~92@) (Add c11~94@ a11~90@))) (Mul (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@)) (Add (Mul c11~94@ d11~96@) (Mul d11~96@ c11~94@)))) (Add (Mul (Mul (Mul b11~92@ b11~92@) (Sub d11~96@ a11~90@)) (Mul b11~92@ (Sub b11~92@ b11~92@))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul d11~96@ c11~94@)) (Mul b11~92@ (Mul b11~92@ b11~92@)))))) (=> (= temp_11_1~3085@ (Mul (Mul (Mul (Mul (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ a11~90@)) (Mul b11~92@ b11~92@)) (Add c11~94@ a11~90@)) (Mul (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@)) (Add (Mul c11~94@ d11~96@) (Mul d11~96@ c11~94@)))) (Add (Mul (Mul (Mul b11~92@ b11~92@) (Sub d11~96@ a11~90@)) (Mul b11~92@ (Sub b11~92@ b11~92@))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul d11~96@ c11~94@)) (Mul b11~92@ (Mul b11~92@ b11~92@)))))) (=> (= tmp%12@ (= temp_11_0~2964@ temp_11_1~3085@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~3269@ (Mul (Add (Mul (Mul c12~102@ (Add c12~102@ a12~98@)) (Mul (Add d12~104@ c12~102@) (Add c12~102@ b12~100@))) (Sub (Mul (Mul c12~102@ 31) (Mul 40 a12~98@)) (Mul (Mul 86 a12~98@) (Mul c12~102@ b12~100@)))) (Mul (Mul (Mul (Mul d12~104@ a12~98@) b12~100@) (Mul (Add d12~104@ c12~102@) (Add a12~98@ a12~98@))) (Mul (Mul (Sub c12~102@ 5) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@)))))) (=> (= temp_12_1~3438@ (Mul (Add (Mul (Mul c12~102@ (Add c12~102@ a12~98@)) (Mul (Add d12~104@ c12~102@) (Add c12~102@ b12~100@))) (Sub (Mul (Mul c12~102@ 31) (Mul 40 a12~98@)) (Mul (Mul c12~102@ b12~100@) (Mul 86 a12~98@)))) (Mul (Mul (Mul (Mul d12~104@ a12~98@) b12~100@) (Mul (Add d12~104@ c12~102@) (Add a12~98@ a12~98@))) (Mul (Mul (Sub c12~102@ 5) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@)))))) (=> (= tmp%13@ (= temp_12_0~3269@ temp_12_1~3438@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~3566@ (Mul (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ b13~108@)) (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul a13~106@ b13~108@) c13~110@) (Mul (Sub d13~112@ c13~110@) (Mul a13~106@ d13~112@)))) (Mul (Add (Mul (Mul a13~106@ c13~110@) a13~106@) (Mul (Mul d13~112@ a13~106@) (Mul c13~110@ d13~112@))) (Mul (Mul d13~112@ a13~106@) (Mul (Mul a13~106@ c13~110@) (Sub c13~110@ a13~106@)))))) (=> (= temp_13_1~3679@ (Mul (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ b13~108@)) (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ d13~112@))) (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ (Mul (Sub d13~112@ c13~110@) (Mul a13~106@ d13~112@))))) (Mul (Add (Mul (Mul a13~106@ c13~110@) a13~106@) (Mul (Mul d13~112@ a13~106@) (Mul c13~110@ d13~112@))) (Mul (Mul d13~112@ a13~106@) (Mul (Mul a13~106@ c13~110@) (Sub c13~110@ a13~106@)))))) (=> (= tmp%14@ (= temp_13_0~3566@ temp_13_1~3679@)) (=> %%location_label%%13 tmp%14@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
