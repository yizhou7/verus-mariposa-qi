...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Sub (Mul b0~4@ c0~6@) c0~6@)) (Mul (Add (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ a0~2@)) (Sub (Mul b0~4@ c0~6@) c0~6@)) (Mul (Add (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~442@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ a1~10@) (Add a1~10@ d1~16@))) (Add (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Sub a1~10@ b1~12@) (Add d1~16@ a1~10@))))) (=> (= temp_1_1~507@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Mul a1~10@ (Mul a1~10@ (Add a1~10@ d1~16@)))) (Add (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Sub a1~10@ b1~12@) (Add d1~16@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~442@ temp_1_1~507@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~595@ (Mul (Mul (Sub (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Add d2~24@ a2~18@) (Mul b2~20@ c2~22@))) (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Add (Mul 79 d2~24@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~668@ (Mul (Mul (Sub (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul (Add d2~24@ a2~18@) b2~20@) c2~22@)) (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Add (Mul 79 d2~24@) (Mul b2~20@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~595@ temp_2_1~668@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~748@ (Mul (Sub (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@)) (Sub (Mul a3~26@ a3~26@) (Add b3~28@ a3~26@))) (Mul (Mul (Sub c3~30@ a3~26@) (Sub c3~30@ b3~28@)) (Mul (Sub c3~30@ b3~28@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~813@ (Mul (Sub (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@)) (Sub (Mul a3~26@ a3~26@) (Add b3~28@ a3~26@))) (Mul (Mul (Sub c3~30@ a3~26@) (Sub c3~30@ b3~28@)) (Mul (Mul b3~28@ d3~32@) (Sub c3~30@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~748@ temp_3_1~813@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~893@ (Mul (Sub (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ 96) (Add d4~40@ a4~34@))) (Add a4~34@ (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~958@ (Mul (Sub (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ 96) (Add d4~40@ a4~34@))) (Add a4~34@ (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~893@ temp_4_1~958@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1034@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Mul (Add a5~42@ a5~42@) (Mul b5~44@ c5~46@))) (Mul (Mul b5~44@ (Sub c5~46@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1095@ (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ a5~42@)) (Mul (Add a5~42@ a5~42@) (Mul b5~44@ c5~46@))) (Mul (Mul b5~44@ (Sub c5~46@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1034@ temp_5_1~1095@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1175@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@)) (Add (Mul d6~56@ d6~56@) (Sub d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1240@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@)) (Add (Mul d6~56@ d6~56@) (Sub d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1175@ temp_6_1~1240@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1316@ (Sub (Mul (Mul (Sub a7~58@ c7~62@) (Mul c7~62@ a7~58@)) (Add d7~64@ (Mul c7~62@ a7~58@))) (Mul (Add (Add a7~58@ c7~62@) (Mul c7~62@ d7~64@)) (Add (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1377@ (Sub (Mul (Sub a7~58@ c7~62@) (Mul (Mul c7~62@ a7~58@) (Add d7~64@ (Mul c7~62@ a7~58@)))) (Mul (Add (Add a7~58@ c7~62@) (Mul c7~62@ d7~64@)) (Add (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1316@ temp_7_1~1377@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1453@ (Sub (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Sub c8~70@ b8~68@))) (Mul (Mul (Mul a8~66@ a8~66@) b8~68@) (Mul (Mul a8~66@ d8~72@) (Add a8~66@ a8~66@))))) (=> (= temp_8_1~1514@ (Sub (Mul (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Sub c8~70@ b8~68@))) (Mul (Mul (Mul a8~66@ a8~66@) b8~68@) (Mul (Mul a8~66@ d8~72@) (Add a8~66@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1453@ temp_8_1~1514@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1582@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ c9~78@)) (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@))) (Mul b9~76@ (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1635@ (Mul (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ c9~78@)) (Mul a9~74@ c9~78@)) (Mul b9~76@ b9~76@)) (Mul b9~76@ (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1582@ temp_9_1~1635@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1723@ (Sub (Add (Mul (Sub c10~86@ b10~84@) (Add c10~86@ b10~84@)) (Mul (Mul b10~84@ a10~82@) (Sub c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ c10~86@) b10~84@) (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ 8))))) (=> (= temp_10_1~1804@ (Sub (Add (Mul (Sub c10~86@ b10~84@) (Add c10~86@ b10~84@)) (Sub (Mul (Mul b10~84@ a10~82@) c10~86@) (Mul (Mul b10~84@ a10~82@) b10~84@))) (Mul (Mul (Mul d10~88@ c10~86@) b10~84@) (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ 8))))) (=> (= tmp%11@ (= temp_10_0~1723@ temp_10_1~1804@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1880@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul a11~90@ (Mul b11~92@ b11~92@))) (Mul (Mul (Add b11~92@ a11~90@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~1941@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul a11~90@ (Mul b11~92@ b11~92@))) (Mul (Mul (Add b11~92@ a11~90@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1880@ temp_11_1~1941@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2021@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@))) (Mul (Mul (Sub a12~98@ d12~104@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ d12~104@) (Sub b12~100@ d12~104@))))) (=> (= temp_12_1~2086@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@))) (Mul (Mul (Sub a12~98@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ d12~104@) (Sub b12~100@ d12~104@))))) (=> (= tmp%13@ (= temp_12_0~2021@ temp_12_1~2086@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2162@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Add b13~108@ d13~112@)) (Mul (Sub d13~112@ c13~110@) (Mul b13~108@ c13~110@))) (Mul (Mul (Sub a13~106@ b13~108@) d13~112@) (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ b13~108@))))) (=> (= temp_13_1~2223@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Add b13~108@ d13~112@)) (Mul (Sub d13~112@ c13~110@) (Mul b13~108@ c13~110@))) (Mul (Mul (Sub a13~106@ b13~108@) d13~112@) (Mul c13~110@ (Mul d13~112@ (Mul c13~110@ b13~108@)))))) (=> (= tmp%14@ (= temp_13_0~2162@ temp_13_1~2223@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2315@ (Sub (Add (Mul (Mul 82 a14~114@) (Mul a14~114@ b14~116@)) (Sub (Mul c14~118@ b14~116@) (Mul a14~114@ c14~118@))) (Mul (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2392@ (Sub (Add (Mul (Mul 82 a14~114@) (Mul a14~114@ b14~116@)) (Sub (Mul c14~118@ b14~116@) (Mul a14~114@ c14~118@))) (Mul (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2315@ temp_14_1~2392@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2472@ (Mul (Mul (Add (Mul c15~126@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Sub c15~126@ c15~126@) (Mul b15~124@ b15~124@))) (Add (Mul (Sub b15~124@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul b15~124@ a15~122@) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~2537@ (Mul (Mul (Add (Mul c15~126@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Sub c15~126@ c15~126@) (Mul b15~124@ b15~124@))) (Add (Mul (Sub b15~124@ c15~126@) (Mul d15~128@ a15~122@)) (Mul b15~124@ (Mul a15~122@ (Mul a15~122@ d15~128@)))))) (=> (= tmp%16@ (= temp_15_0~2472@ temp_15_1~2537@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2613@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul b16~132@ b16~132@)) (Mul d16~136@ (Mul d16~136@ b16~132@))) (Mul (Mul (Mul a16~130@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ c16~134@))))) (=> (= temp_16_1~2674@ (Mul (Mul (Mul b16~132@ d16~136@) (Mul b16~132@ b16~132@)) (Mul (Mul d16~136@ (Mul d16~136@ b16~132@)) (Mul (Mul (Mul a16~130@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ c16~134@)))))) (=> (= tmp%17@ (= temp_16_0~2613@ temp_16_1~2674@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2750@ (Add (Add (Sub (Mul d17~144@ b17~140@) a17~138@) (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ a17~138@))) (Mul (Sub (Mul b17~140@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~2811@ (Add (Add (Sub (Mul b17~140@ d17~144@) a17~138@) (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ a17~138@))) (Mul (Sub (Mul b17~140@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ c17~142@))))) (=> (= tmp%18@ (= temp_17_0~2750@ temp_17_1~2811@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2883@ (Mul (Add (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ a18~146@)) (Mul (Sub d18~152@ a18~146@) (Mul b18~148@ a18~146@))) (Mul (Mul (Mul a18~146@ a18~146@) b18~148@) (Mul b18~148@ (Add b18~148@ c18~150@))))) (=> (= temp_18_1~2940@ (Mul (Add (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ a18~146@)) (Mul (Sub d18~152@ a18~146@) (Mul b18~148@ a18~146@))) (Mul (Mul (Mul a18~146@ a18~146@) b18~148@) (Mul b18~148@ (Add b18~148@ c18~150@))))) (=> (= tmp%19@ (= temp_18_0~2883@ temp_18_1~2940@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3016@ (Mul (Mul (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ c19~158@)) (Add (Sub c19~158@ c19~158@) (Mul b19~156@ d19~160@))) (Mul (Mul b19~156@ (Mul c19~158@ d19~160@)) (Mul (Mul b19~156@ b19~156@) (Mul c19~158@ c19~158@))))) (=> (= temp_19_1~3077@ (Mul (Mul (Mul b19~156@ (Mul c19~158@ d19~160@)) (Mul (Mul b19~156@ b19~156@) (Mul c19~158@ c19~158@))) (Mul (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ c19~158@)) (Add (Sub c19~158@ c19~158@) (Mul b19~156@ d19~160@))))) (=> (= tmp%20@ (= temp_19_0~3016@ temp_19_1~3077@)) (=> %%location_label%%19 tmp%20@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
