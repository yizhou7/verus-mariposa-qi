...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Sub (Mul b0~4@ c0~6@) c0~6@)) (Mul (Add (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ a0~2@)) (Sub (Mul b0~4@ c0~6@) c0~6@)) (Mul (Add (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~451@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ a1~10@) (Add a1~10@ d1~16@))) (Add (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Sub a1~10@ b1~12@) (Add d1~16@ a1~10@))))) (=> (= temp_1_1~516@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Mul a1~10@ (Mul a1~10@ (Add a1~10@ d1~16@)))) (Add (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Sub a1~10@ b1~12@) (Add d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~451@ temp_1_1~516@))) (=> (= temp_1_0~451@ temp_1_1~516@) (=> (= temp_2_0~613@ (Mul (Mul (Sub (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Add d2~24@ a2~18@) (Mul b2~20@ c2~22@))) (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Add (Mul 79 d2~24@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~686@ (Mul (Mul (Sub (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul (Add d2~24@ a2~18@) b2~20@) c2~22@)) (Mul (Mul c2~22@ (Mul b2~20@ a2~18@)) (Add (Mul 79 d2~24@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~613@ temp_2_1~686@))) (=> (= temp_2_0~613@ temp_2_1~686@) (=> (= temp_3_0~775@ (Mul (Sub (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@)) (Sub (Mul a3~26@ a3~26@) (Add b3~28@ a3~26@))) (Mul (Mul (Sub c3~30@ a3~26@) (Sub c3~30@ b3~28@)) (Mul (Sub c3~30@ b3~28@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~840@ (Mul (Sub (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@)) (Sub (Mul a3~26@ a3~26@) (Add b3~28@ a3~26@))) (Mul (Mul (Sub c3~30@ a3~26@) (Sub c3~30@ b3~28@)) (Mul (Mul b3~28@ d3~32@) (Sub c3~30@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~775@ temp_3_1~840@))) (=> (= temp_3_0~775@ temp_3_1~840@) (=> (= temp_4_0~929@ (Mul (Sub (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ 96) (Add d4~40@ a4~34@))) (Add a4~34@ (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~994@ (Mul (Sub (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ 96) (Add d4~40@ a4~34@))) (Add a4~34@ (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~929@ temp_4_1~994@))) (=> (= temp_4_0~929@ temp_4_1~994@) (=> (= temp_5_0~1079@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Mul (Add a5~42@ a5~42@) (Mul b5~44@ c5~46@))) (Mul (Mul b5~44@ (Sub c5~46@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1140@ (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ a5~42@)) (Mul (Add a5~42@ a5~42@) (Mul b5~44@ c5~46@))) (Mul (Mul b5~44@ (Sub c5~46@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1079@ temp_5_1~1140@))) (=> (= temp_5_0~1079@ temp_5_1~1140@) (=> (= temp_6_0~1229@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@)) (Add (Mul d6~56@ d6~56@) (Sub d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1294@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@)) (Add (Mul d6~56@ d6~56@) (Sub d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1229@ temp_6_1~1294@))) (=> (= temp_6_0~1229@ temp_6_1~1294@) (=> (= temp_7_0~1379@ (Sub (Mul (Mul (Sub a7~58@ c7~62@) (Mul c7~62@ a7~58@)) (Add d7~64@ (Mul c7~62@ a7~58@))) (Mul (Add (Add a7~58@ c7~62@) (Mul c7~62@ d7~64@)) (Add (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1440@ (Sub (Mul (Sub a7~58@ c7~62@) (Mul (Mul c7~62@ a7~58@) (Add d7~64@ (Mul c7~62@ a7~58@)))) (Mul (Add (Add a7~58@ c7~62@) (Mul c7~62@ d7~64@)) (Add (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1379@ temp_7_1~1440@))) (=> (= temp_7_0~1379@ temp_7_1~1440@) (=> (= temp_8_0~1525@ (Sub (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Sub c8~70@ b8~68@))) (Mul (Mul (Mul a8~66@ a8~66@) b8~68@) (Mul (Mul a8~66@ d8~72@) (Add a8~66@ a8~66@))))) (=> (= temp_8_1~1586@ (Sub (Mul (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Sub c8~70@ b8~68@))) (Mul (Mul (Mul a8~66@ a8~66@) b8~68@) (Mul (Mul a8~66@ d8~72@) (Add a8~66@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1525@ temp_8_1~1586@))) (=> (= temp_8_0~1525@ temp_8_1~1586@) (=> (= temp_9_0~1663@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ c9~78@)) (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@))) (Mul b9~76@ (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1716@ (Mul (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ c9~78@)) (Mul a9~74@ c9~78@)) (Mul b9~76@ b9~76@)) (Mul b9~76@ (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1663@ temp_9_1~1716@))) (=> (= temp_9_0~1663@ temp_9_1~1716@) (=> (= temp_10_0~1813@ (Sub (Add (Mul (Sub c10~86@ b10~84@) (Add c10~86@ b10~84@)) (Mul (Mul b10~84@ a10~82@) (Sub c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ c10~86@) b10~84@) (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ 8))))) (=> (= temp_10_1~1894@ (Sub (Add (Mul (Sub c10~86@ b10~84@) (Add c10~86@ b10~84@)) (Sub (Mul (Mul b10~84@ a10~82@) c10~86@) (Mul (Mul b10~84@ a10~82@) b10~84@))) (Mul (Mul (Mul d10~88@ c10~86@) b10~84@) (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ 8))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1813@ temp_10_1~1894@))) (=> (= temp_10_0~1813@ temp_10_1~1894@) (=> (= temp_11_0~1979@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul a11~90@ (Mul b11~92@ b11~92@))) (Mul (Mul (Add b11~92@ a11~90@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2040@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul a11~90@ (Mul b11~92@ b11~92@))) (Mul (Mul (Add b11~92@ a11~90@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1979@ temp_11_1~2040@))) (=> (= temp_11_0~1979@ temp_11_1~2040@) (=> (= temp_12_0~2129@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@))) (Mul (Mul (Sub a12~98@ d12~104@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ d12~104@) (Sub b12~100@ d12~104@))))) (=> (= temp_12_1~2194@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@))) (Mul (Mul (Sub a12~98@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ d12~104@) (Sub b12~100@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2129@ temp_12_1~2194@))) (=> (= temp_12_0~2129@ temp_12_1~2194@) (=> (= temp_13_0~2279@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Add b13~108@ d13~112@)) (Mul (Sub d13~112@ c13~110@) (Mul b13~108@ c13~110@))) (Mul (Mul (Sub a13~106@ b13~108@) d13~112@) (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ b13~108@))))) (=> (= temp_13_1~2340@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Add b13~108@ d13~112@)) (Mul (Sub d13~112@ c13~110@) (Mul b13~108@ c13~110@))) (Mul (Mul (Sub a13~106@ b13~108@) d13~112@) (Mul c13~110@ (Mul d13~112@ (Mul c13~110@ b13~108@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2279@ temp_13_1~2340@))) (=> (= temp_13_0~2279@ temp_13_1~2340@) (=> (= temp_14_0~2441@ (Sub (Add (Mul (Mul 82 a14~114@) (Mul a14~114@ b14~116@)) (Sub (Mul c14~118@ b14~116@) (Mul a14~114@ c14~118@))) (Mul (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2518@ (Sub (Add (Mul (Mul 82 a14~114@) (Mul a14~114@ b14~116@)) (Sub (Mul c14~118@ b14~116@) (Mul a14~114@ c14~118@))) (Mul (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2441@ temp_14_1~2518@))) (=> (= temp_14_0~2441@ temp_14_1~2518@) (=> (= temp_15_0~2607@ (Mul (Mul (Add (Mul c15~126@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Sub c15~126@ c15~126@) (Mul b15~124@ b15~124@))) (Add (Mul (Sub b15~124@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul b15~124@ a15~122@) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~2672@ (Mul (Mul (Add (Mul c15~126@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Sub c15~126@ c15~126@) (Mul b15~124@ b15~124@))) (Add (Mul (Sub b15~124@ c15~126@) (Mul d15~128@ a15~122@)) (Mul b15~124@ (Mul a15~122@ (Mul a15~122@ d15~128@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2607@ temp_15_1~2672@))) (=> (= temp_15_0~2607@ temp_15_1~2672@) (=> (= temp_16_0~2757@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul b16~132@ b16~132@)) (Mul d16~136@ (Mul d16~136@ b16~132@))) (Mul (Mul (Mul a16~130@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ c16~134@))))) (=> (= temp_16_1~2818@ (Mul (Mul (Mul b16~132@ d16~136@) (Mul b16~132@ b16~132@)) (Mul (Mul d16~136@ (Mul d16~136@ b16~132@)) (Mul (Mul (Mul a16~130@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ c16~134@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2757@ temp_16_1~2818@))) (=> (= temp_16_0~2757@ temp_16_1~2818@) (=> (= temp_17_0~2903@ (Add (Add (Sub (Mul d17~144@ b17~140@) a17~138@) (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ a17~138@))) (Mul (Sub (Mul b17~140@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~2964@ (Add (Add (Sub (Mul b17~140@ d17~144@) a17~138@) (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ a17~138@))) (Mul (Sub (Mul b17~140@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2903@ temp_17_1~2964@))) (=> (= temp_17_0~2903@ temp_17_1~2964@) (=> (= temp_18_0~3045@ (Mul (Add (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ a18~146@)) (Mul (Sub d18~152@ a18~146@) (Mul b18~148@ a18~146@))) (Mul (Mul (Mul a18~146@ a18~146@) b18~148@) (Mul b18~148@ (Add b18~148@ c18~150@))))) (=> (= temp_18_1~3102@ (Mul (Add (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ a18~146@)) (Mul (Sub d18~152@ a18~146@) (Mul b18~148@ a18~146@))) (Mul (Mul (Mul a18~146@ a18~146@) b18~148@) (Mul b18~148@ (Add b18~148@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3045@ temp_18_1~3102@))) (=> (= temp_18_0~3045@ temp_18_1~3102@) (=> (= temp_19_0~3187@ (Mul (Mul (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ c19~158@)) (Add (Sub c19~158@ c19~158@) (Mul b19~156@ d19~160@))) (Mul (Mul b19~156@ (Mul c19~158@ d19~160@)) (Mul (Mul b19~156@ b19~156@) (Mul c19~158@ c19~158@))))) (=> (= temp_19_1~3248@ (Mul (Mul (Mul b19~156@ (Mul c19~158@ d19~160@)) (Mul (Mul b19~156@ b19~156@) (Mul c19~158@ c19~158@))) (Mul (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ c19~158@)) (Add (Sub c19~158@ c19~158@) (Mul b19~156@ d19~160@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3187@ temp_19_1~3248@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
