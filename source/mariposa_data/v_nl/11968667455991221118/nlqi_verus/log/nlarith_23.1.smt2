...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Add (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ d0~8@) b0~4@)) (Sub (Mul (Sub b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul 2 b0~4@))))) (=> (= temp_0_1~386@ (Mul (Add (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ d0~8@) b0~4@)) (Sub (Mul (Sub b0~4@ a0~2@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul 2 b0~4@))))) (=> (= tmp%1@ (= temp_0_0~313@ temp_0_1~386@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~438@ (Mul (Mul (Mul (Add b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Add c1~14@ a1~10@) (Mul c1~14@ a1~10@))) c1~14@)) (=> (= temp_1_1~475@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Add b1~12@ b1~12@)) (Mul (Add c1~14@ a1~10@) (Mul c1~14@ a1~10@))) c1~14@)) (=> (= tmp%2@ (= temp_1_0~438@ temp_1_1~475@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~563@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Mul d2~24@ (Mul c2~22@ c2~22@))) (Mul (Mul (Add d2~24@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Add a2~18@ 9) (Add c2~22@ c2~22@))))) (=> (= temp_2_1~636@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ b2~20@)) (Mul d2~24@ (Mul c2~22@ c2~22@))) (Mul (Mul (Add d2~24@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Add a2~18@ 9) (Add c2~22@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~563@ temp_2_1~636@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~704@ (Add (Add (Mul a3~26@ a3~26@) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul c3~30@ b3~28@) (Sub b3~28@ d3~32@)) (Mul (Mul d3~32@ a3~26@) c3~30@)))) (=> (= temp_3_1~757@ (Add (Add (Mul a3~26@ a3~26@) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Sub b3~28@ d3~32@)) (Mul d3~32@ a3~26@)) c3~30@))) (=> (= tmp%4@ (= temp_3_0~704@ temp_3_1~757@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~849@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul 12 c4~38@)) (Add (Sub b4~36@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~926@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul 12 c4~38@)) (Add (Sub b4~36@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~849@ temp_4_1~926@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~994@ (Mul (Mul (Sub (Sub b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@))) (Add c5~46@ (Add (Mul d5~48@ b5~44@) (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1063@ (Mul (Sub (Mul (Sub b5~44@ b5~44@) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@))) (Mul (Mul c5~46@ b5~44@) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@)))) (Add c5~46@ (Add (Mul d5~48@ b5~44@) (Mul c5~46@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~994@ temp_5_1~1063@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1139@ (Mul (Mul (Add (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@)) (Mul c6~54@ (Mul d6~56@ b6~52@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ a6~50@))))) (=> (= temp_6_1~1200@ (Mul (Mul (Add (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@)) (Mul c6~54@ (Mul d6~56@ b6~52@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1139@ temp_6_1~1200@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1300@ (Add (Mul (Mul (Mul 26 d7~64@) (Mul c7~62@ 40)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ c7~62@))) (Mul (Mul c7~62@ (Mul a7~58@ a7~58@)) (Sub (Sub a7~58@ a7~58@) (Add b7~60@ d7~64@))))) (=> (= temp_7_1~1385@ (Add (Mul (Mul 26 (Mul d7~64@ (Mul c7~62@ 40))) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ c7~62@))) (Mul (Mul c7~62@ (Mul a7~58@ a7~58@)) (Sub (Sub a7~58@ a7~58@) (Add b7~60@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1300@ temp_7_1~1385@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1477@ (Mul (Sub (Add (Mul c8~70@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ a8~66@))) (Mul (Mul (Sub c8~70@ 63) (Mul a8~66@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ b8~68@))))) (=> (= temp_8_1~1554@ (Mul (Sub (Add (Mul c8~70@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ a8~66@))) (Mul (Mul (Mul a8~66@ c8~70@) (Sub c8~70@ 63)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1477@ temp_8_1~1554@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1606@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Add c9~78@ d9~80@)) (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@))) c9~78@)) (=> (= temp_9_1~1643@ (Mul (Mul (Mul c9~78@ (Mul d9~80@ (Add c9~78@ d9~80@))) (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@))) c9~78@)) (=> (= tmp%10@ (= temp_9_0~1606@ temp_9_1~1643@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1723@ (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ d10~88@))) (Mul (Mul (Add c10~86@ a10~82@) (Mul b10~84@ b10~84@)) (Mul (Sub a10~82@ b10~84@) (Mul a10~82@ d10~88@))))) (=> (= temp_10_1~1788@ (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ d10~88@))) (Mul (Mul (Add c10~86@ a10~82@) (Mul b10~84@ b10~84@)) (Mul (Sub a10~82@ b10~84@) (Mul a10~82@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1723@ temp_10_1~1788@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1880@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Add b11~92@ d11~96@)) (Sub (Sub d11~96@ a11~90@) (Mul a11~90@ c11~94@))) (Mul (Mul (Mul 46 a11~90@) (Mul c11~94@ a11~90@)) (Mul (Add a11~90@ d11~96@) (Mul c11~94@ b11~92@))))) (=> (= temp_11_1~1957@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Add b11~92@ d11~96@)) (Sub (Sub d11~96@ a11~90@) (Mul a11~90@ c11~94@))) (Mul (Mul (Mul (Mul 46 a11~90@) (Mul c11~94@ a11~90@)) (Add a11~90@ d11~96@)) (Mul c11~94@ b11~92@)))) (=> (= tmp%12@ (= temp_11_0~1880@ temp_11_1~1957@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2049@ (Mul (Mul (Mul (Add d12~104@ c12~102@) (Mul c12~102@ b12~100@)) (Mul (Mul d12~104@ a12~98@) (Mul d12~104@ a12~98@))) (Mul (Sub (Mul 49 a12~98@) (Sub d12~104@ a12~98@)) (Mul (Sub a12~98@ a12~98@) (Sub b12~100@ a12~98@))))) (=> (= temp_12_1~2126@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Mul d12~104@ a12~98@)) (Mul (Add d12~104@ c12~102@) (Mul c12~102@ b12~100@))) (Mul (Sub (Mul 49 a12~98@) (Sub d12~104@ a12~98@)) (Mul (Sub a12~98@ a12~98@) (Sub b12~100@ a12~98@))))) (=> (= tmp%13@ (= temp_12_0~2049@ temp_12_1~2126@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2202@ (Sub (Mul (Mul (Mul d13~112@ d13~112@) (Mul a13~106@ d13~112@)) (Mul (Mul b13~108@ c13~110@) (Sub d13~112@ d13~112@))) (Mul (Mul (Mul b13~108@ d13~112@) d13~112@) (Mul (Mul d13~112@ c13~110@) (Add d13~112@ c13~110@))))) (=> (= temp_13_1~2263@ (Sub (Mul (Mul (Mul d13~112@ d13~112@) (Mul a13~106@ d13~112@)) (Mul (Mul b13~108@ c13~110@) (Sub d13~112@ d13~112@))) (Mul (Mul (Mul (Mul b13~108@ d13~112@) d13~112@) (Mul d13~112@ c13~110@)) (Add d13~112@ c13~110@)))) (=> (= tmp%14@ (= temp_13_0~2202@ temp_13_1~2263@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2351@ (Mul (Mul (Sub (Mul b14~116@ c14~118@) (Mul b14~116@ c14~118@)) (Mul (Mul c14~118@ b14~116@) 54)) (Mul (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@))))) (=> (= temp_14_1~2424@ (Mul (Mul (Sub (Mul b14~116@ c14~118@) (Mul b14~116@ c14~118@)) (Mul 54 (Mul c14~118@ b14~116@))) (Mul (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2351@ temp_14_1~2424@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2492@ (Mul (Mul (Mul (Sub a15~122@ c15~126@) (Mul a15~122@ d15~128@)) (Mul (Sub c15~126@ a15~122@) (Mul d15~128@ b15~124@))) (Mul a15~122@ (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ b15~124@))))) (=> (= temp_15_1~2545@ (Mul (Mul (Mul (Sub a15~122@ c15~126@) (Mul a15~122@ d15~128@)) (Mul (Sub c15~126@ a15~122@) (Mul d15~128@ b15~124@))) (Mul a15~122@ (Mul b15~124@ (Mul b15~124@ (Mul d15~128@ b15~124@)))))) (=> (= tmp%16@ (= temp_15_0~2492@ temp_15_1~2545@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2625@ (Mul (Mul (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@))) (Sub (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ a16~130@)) (Sub (Add b16~132@ a16~130@) (Mul b16~132@ d16~136@))))) (=> (= temp_16_1~2690@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ c16~134@))) (Sub (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ a16~130@)) (Sub (Add b16~132@ a16~130@) (Mul b16~132@ d16~136@))))) (=> (= tmp%17@ (= temp_16_0~2625@ temp_16_1~2690@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2794@ (Mul (Mul (Add (Mul d17~144@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ a17~138@))) (Add (Mul (Mul 94 b17~140@) (Mul a17~138@ 20)) (Mul (Mul c17~142@ b17~140@) (Mul d17~144@ c17~142@))))) (=> (= temp_17_1~2883@ (Mul (Mul (Add (Mul d17~144@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ a17~138@))) (Add (Mul (Mul 94 b17~140@) (Mul a17~138@ 20)) (Mul (Mul b17~140@ c17~142@) (Mul d17~144@ c17~142@))))) (=> (= tmp%18@ (= temp_17_0~2794@ temp_17_1~2883@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2975@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ c18~150@)) (Mul (Sub d18~152@ d18~152@) (Mul a18~146@ 76))) (Mul (Mul (Mul b18~148@ a18~146@) (Mul d18~152@ c18~150@)) (Add (Mul b18~148@ a18~146@) (Sub d18~152@ c18~150@))))) (=> (= temp_18_1~3052@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ c18~150@)) (Mul (Mul a18~146@ 76) (Sub d18~152@ d18~152@))) (Mul (Mul (Mul b18~148@ a18~146@) (Mul d18~152@ c18~150@)) (Add (Mul b18~148@ a18~146@) (Sub d18~152@ c18~150@))))) (=> (= tmp%19@ (= temp_18_0~2975@ temp_18_1~3052@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3108@ (Add (Mul b19~156@ (Mul (Mul a19~154@ a19~154@) (Mul b19~156@ c19~158@))) (Mul (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ b19~156@)) b19~156@))) (=> (= temp_19_1~3149@ (Add (Mul b19~156@ (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ a19~154@))) (Mul (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ b19~156@)) b19~156@))) (=> (= tmp%20@ (= temp_19_0~3108@ temp_19_1~3149@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3229@ (Mul (Mul (Mul (Mul a20~162@ b20~164@) (Sub d20~168@ c20~166@)) (Sub (Add b20~164@ a20~162@) (Mul c20~166@ b20~164@))) (Mul (Add (Mul d20~168@ d20~168@) (Mul b20~164@ a20~162@)) (Sub (Add c20~166@ d20~168@) (Mul a20~162@ d20~168@))))) (=> (= temp_20_1~3294@ (Mul (Mul (Mul (Mul a20~162@ b20~164@) (Sub d20~168@ c20~166@)) (Sub (Add b20~164@ a20~162@) (Mul c20~166@ b20~164@))) (Mul (Sub (Add c20~166@ d20~168@) (Mul a20~162@ d20~168@)) (Add (Mul d20~168@ d20~168@) (Mul b20~164@ a20~162@))))) (=> (= tmp%21@ (= temp_20_0~3229@ temp_20_1~3294@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3374@ (Add (Mul (Mul (Mul a21~170@ a21~170@) (Sub c21~174@ d21~176@)) (Add (Mul a21~170@ d21~176@) (Sub a21~170@ d21~176@))) (Mul (Add (Mul b21~172@ d21~176@) (Add a21~170@ c21~174@)) (Add (Mul c21~174@ b21~172@) (Mul d21~176@ b21~172@))))) (=> (= temp_21_1~3455@ (Add (Mul (Mul (Mul a21~170@ a21~170@) (Sub c21~174@ d21~176@)) (Add (Mul a21~170@ d21~176@) (Sub a21~170@ d21~176@))) (Add (Mul (Add (Mul b21~172@ d21~176@) (Add a21~170@ c21~174@)) (Mul c21~174@ b21~172@)) (Mul (Add (Mul b21~172@ d21~176@) (Add a21~170@ c21~174@)) (Mul d21~176@ b21~172@))))) (=> (= tmp%22@ (= temp_21_0~3374@ temp_21_1~3455@)) (and (=> %%location_label%%21 tmp%22@) (=> tmp%22@ (=> (= temp_22_0~3547@ (Sub (Mul (Sub (Mul d22~184@ a22~178@) (Sub b22~180@ a22~178@)) (Mul (Mul d22~184@ a22~178@) (Mul a22~178@ 10))) (Mul (Sub (Mul c22~182@ b22~180@) (Mul d22~184@ a22~178@)) (Mul (Mul d22~184@ c22~182@) (Sub c22~182@ c22~182@))))) (=> (= temp_22_1~3632@ (Sub (Mul (Sub (Mul d22~184@ a22~178@) (Sub b22~180@ a22~178@)) (Mul (Mul d22~184@ a22~178@) (Mul a22~178@ 10))) (Mul (Sub (Mul c22~182@ b22~180@) (Mul d22~184@ a22~178@)) (Sub (Mul (Mul d22~184@ c22~182@) c22~182@) (Mul (Mul d22~184@ c22~182@) c22~182@))))) (=> (= tmp%23@ (= temp_22_0~3547@ temp_22_1~3632@)) (=> %%location_label%%22 tmp%23@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
