...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Add (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ d0~8@) b0~4@)) (Sub (Mul (Sub b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul 2 b0~4@))))) (=> (= temp_0_1~386@ (Mul (Add (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ d0~8@) b0~4@)) (Sub (Mul (Sub b0~4@ a0~2@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul 2 b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~386@))) (=> (= temp_0_0~313@ temp_0_1~386@) (=> (= temp_1_0~447@ (Mul (Mul (Mul (Add b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Add c1~14@ a1~10@) (Mul c1~14@ a1~10@))) c1~14@)) (=> (= temp_1_1~484@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Add b1~12@ b1~12@)) (Mul (Add c1~14@ a1~10@) (Mul c1~14@ a1~10@))) c1~14@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~484@))) (=> (= temp_1_0~447@ temp_1_1~484@) (=> (= temp_2_0~581@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Mul d2~24@ (Mul c2~22@ c2~22@))) (Mul (Mul (Add d2~24@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Add a2~18@ 9) (Add c2~22@ c2~22@))))) (=> (= temp_2_1~654@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ b2~20@)) (Mul d2~24@ (Mul c2~22@ c2~22@))) (Mul (Mul (Add d2~24@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Add a2~18@ 9) (Add c2~22@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~581@ temp_2_1~654@))) (=> (= temp_2_0~581@ temp_2_1~654@) (=> (= temp_3_0~731@ (Add (Add (Mul a3~26@ a3~26@) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul c3~30@ b3~28@) (Sub b3~28@ d3~32@)) (Mul (Mul d3~32@ a3~26@) c3~30@)))) (=> (= temp_3_1~784@ (Add (Add (Mul a3~26@ a3~26@) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Sub b3~28@ d3~32@)) (Mul d3~32@ a3~26@)) c3~30@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~731@ temp_3_1~784@))) (=> (= temp_3_0~731@ temp_3_1~784@) (=> (= temp_4_0~885@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul 12 c4~38@)) (Add (Sub b4~36@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~962@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul 12 c4~38@)) (Add (Sub b4~36@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~885@ temp_4_1~962@))) (=> (= temp_4_0~885@ temp_4_1~962@) (=> (= temp_5_0~1039@ (Mul (Mul (Sub (Sub b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@))) (Add c5~46@ (Add (Mul d5~48@ b5~44@) (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1108@ (Mul (Sub (Mul (Sub b5~44@ b5~44@) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@))) (Mul (Mul c5~46@ b5~44@) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@)))) (Add c5~46@ (Add (Mul d5~48@ b5~44@) (Mul c5~46@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1039@ temp_5_1~1108@))) (=> (= temp_5_0~1039@ temp_5_1~1108@) (=> (= temp_6_0~1193@ (Mul (Mul (Add (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@)) (Mul c6~54@ (Mul d6~56@ b6~52@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ a6~50@))))) (=> (= temp_6_1~1254@ (Mul (Mul (Add (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@)) (Mul c6~54@ (Mul d6~56@ b6~52@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1193@ temp_6_1~1254@))) (=> (= temp_6_0~1193@ temp_6_1~1254@) (=> (= temp_7_0~1363@ (Add (Mul (Mul (Mul 26 d7~64@) (Mul c7~62@ 40)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ c7~62@))) (Mul (Mul c7~62@ (Mul a7~58@ a7~58@)) (Sub (Sub a7~58@ a7~58@) (Add b7~60@ d7~64@))))) (=> (= temp_7_1~1448@ (Add (Mul (Mul 26 (Mul d7~64@ (Mul c7~62@ 40))) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ c7~62@))) (Mul (Mul c7~62@ (Mul a7~58@ a7~58@)) (Sub (Sub a7~58@ a7~58@) (Add b7~60@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1363@ temp_7_1~1448@))) (=> (= temp_7_0~1363@ temp_7_1~1448@) (=> (= temp_8_0~1549@ (Mul (Sub (Add (Mul c8~70@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ a8~66@))) (Mul (Mul (Sub c8~70@ 63) (Mul a8~66@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ b8~68@))))) (=> (= temp_8_1~1626@ (Mul (Sub (Add (Mul c8~70@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ a8~66@))) (Mul (Mul (Mul a8~66@ c8~70@) (Sub c8~70@ 63)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1549@ temp_8_1~1626@))) (=> (= temp_8_0~1549@ temp_8_1~1626@) (=> (= temp_9_0~1687@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Add c9~78@ d9~80@)) (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@))) c9~78@)) (=> (= temp_9_1~1724@ (Mul (Mul (Mul c9~78@ (Mul d9~80@ (Add c9~78@ d9~80@))) (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@))) c9~78@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1687@ temp_9_1~1724@))) (=> (= temp_9_0~1687@ temp_9_1~1724@) (=> (= temp_10_0~1813@ (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ d10~88@))) (Mul (Mul (Add c10~86@ a10~82@) (Mul b10~84@ b10~84@)) (Mul (Sub a10~82@ b10~84@) (Mul a10~82@ d10~88@))))) (=> (= temp_10_1~1878@ (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ d10~88@))) (Mul (Mul (Add c10~86@ a10~82@) (Mul b10~84@ b10~84@)) (Mul (Sub a10~82@ b10~84@) (Mul a10~82@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1813@ temp_10_1~1878@))) (=> (= temp_10_0~1813@ temp_10_1~1878@) (=> (= temp_11_0~1979@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Add b11~92@ d11~96@)) (Sub (Sub d11~96@ a11~90@) (Mul a11~90@ c11~94@))) (Mul (Mul (Mul 46 a11~90@) (Mul c11~94@ a11~90@)) (Mul (Add a11~90@ d11~96@) (Mul c11~94@ b11~92@))))) (=> (= temp_11_1~2056@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Add b11~92@ d11~96@)) (Sub (Sub d11~96@ a11~90@) (Mul a11~90@ c11~94@))) (Mul (Mul (Mul (Mul 46 a11~90@) (Mul c11~94@ a11~90@)) (Add a11~90@ d11~96@)) (Mul c11~94@ b11~92@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1979@ temp_11_1~2056@))) (=> (= temp_11_0~1979@ temp_11_1~2056@) (=> (= temp_12_0~2157@ (Mul (Mul (Mul (Add d12~104@ c12~102@) (Mul c12~102@ b12~100@)) (Mul (Mul d12~104@ a12~98@) (Mul d12~104@ a12~98@))) (Mul (Sub (Mul 49 a12~98@) (Sub d12~104@ a12~98@)) (Mul (Sub a12~98@ a12~98@) (Sub b12~100@ a12~98@))))) (=> (= temp_12_1~2234@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Mul d12~104@ a12~98@)) (Mul (Add d12~104@ c12~102@) (Mul c12~102@ b12~100@))) (Mul (Sub (Mul 49 a12~98@) (Sub d12~104@ a12~98@)) (Mul (Sub a12~98@ a12~98@) (Sub b12~100@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2157@ temp_12_1~2234@))) (=> (= temp_12_0~2157@ temp_12_1~2234@) (=> (= temp_13_0~2319@ (Sub (Mul (Mul (Mul d13~112@ d13~112@) (Mul a13~106@ d13~112@)) (Mul (Mul b13~108@ c13~110@) (Sub d13~112@ d13~112@))) (Mul (Mul (Mul b13~108@ d13~112@) d13~112@) (Mul (Mul d13~112@ c13~110@) (Add d13~112@ c13~110@))))) (=> (= temp_13_1~2380@ (Sub (Mul (Mul (Mul d13~112@ d13~112@) (Mul a13~106@ d13~112@)) (Mul (Mul b13~108@ c13~110@) (Sub d13~112@ d13~112@))) (Mul (Mul (Mul (Mul b13~108@ d13~112@) d13~112@) (Mul d13~112@ c13~110@)) (Add d13~112@ c13~110@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2319@ temp_13_1~2380@))) (=> (= temp_13_0~2319@ temp_13_1~2380@) (=> (= temp_14_0~2477@ (Mul (Mul (Sub (Mul b14~116@ c14~118@) (Mul b14~116@ c14~118@)) (Mul (Mul c14~118@ b14~116@) 54)) (Mul (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@))))) (=> (= temp_14_1~2550@ (Mul (Mul (Sub (Mul b14~116@ c14~118@) (Mul b14~116@ c14~118@)) (Mul 54 (Mul c14~118@ b14~116@))) (Mul (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2477@ temp_14_1~2550@))) (=> (= temp_14_0~2477@ temp_14_1~2550@) (=> (= temp_15_0~2627@ (Mul (Mul (Mul (Sub a15~122@ c15~126@) (Mul a15~122@ d15~128@)) (Mul (Sub c15~126@ a15~122@) (Mul d15~128@ b15~124@))) (Mul a15~122@ (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ b15~124@))))) (=> (= temp_15_1~2680@ (Mul (Mul (Mul (Sub a15~122@ c15~126@) (Mul a15~122@ d15~128@)) (Mul (Sub c15~126@ a15~122@) (Mul d15~128@ b15~124@))) (Mul a15~122@ (Mul b15~124@ (Mul b15~124@ (Mul d15~128@ b15~124@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2627@ temp_15_1~2680@))) (=> (= temp_15_0~2627@ temp_15_1~2680@) (=> (= temp_16_0~2769@ (Mul (Mul (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@))) (Sub (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ a16~130@)) (Sub (Add b16~132@ a16~130@) (Mul b16~132@ d16~136@))))) (=> (= temp_16_1~2834@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@)) (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ c16~134@))) (Sub (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ a16~130@)) (Sub (Add b16~132@ a16~130@) (Mul b16~132@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2769@ temp_16_1~2834@))) (=> (= temp_16_0~2769@ temp_16_1~2834@) (=> (= temp_17_0~2947@ (Mul (Mul (Add (Mul d17~144@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ a17~138@))) (Add (Mul (Mul 94 b17~140@) (Mul a17~138@ 20)) (Mul (Mul c17~142@ b17~140@) (Mul d17~144@ c17~142@))))) (=> (= temp_17_1~3036@ (Mul (Mul (Add (Mul d17~144@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ a17~138@))) (Add (Mul (Mul 94 b17~140@) (Mul a17~138@ 20)) (Mul (Mul b17~140@ c17~142@) (Mul d17~144@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2947@ temp_17_1~3036@))) (=> (= temp_17_0~2947@ temp_17_1~3036@) (=> (= temp_18_0~3137@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ c18~150@)) (Mul (Sub d18~152@ d18~152@) (Mul a18~146@ 76))) (Mul (Mul (Mul b18~148@ a18~146@) (Mul d18~152@ c18~150@)) (Add (Mul b18~148@ a18~146@) (Sub d18~152@ c18~150@))))) (=> (= temp_18_1~3214@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ c18~150@)) (Mul (Mul a18~146@ 76) (Sub d18~152@ d18~152@))) (Mul (Mul (Mul b18~148@ a18~146@) (Mul d18~152@ c18~150@)) (Add (Mul b18~148@ a18~146@) (Sub d18~152@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3137@ temp_18_1~3214@))) (=> (= temp_18_0~3137@ temp_18_1~3214@) (=> (= temp_19_0~3279@ (Add (Mul b19~156@ (Mul (Mul a19~154@ a19~154@) (Mul b19~156@ c19~158@))) (Mul (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ b19~156@)) b19~156@))) (=> (= temp_19_1~3320@ (Add (Mul b19~156@ (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ a19~154@))) (Mul (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ b19~156@)) b19~156@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3279@ temp_19_1~3320@))) (=> (= temp_19_0~3279@ temp_19_1~3320@) (=> (= temp_20_0~3409@ (Mul (Mul (Mul (Mul a20~162@ b20~164@) (Sub d20~168@ c20~166@)) (Sub (Add b20~164@ a20~162@) (Mul c20~166@ b20~164@))) (Mul (Add (Mul d20~168@ d20~168@) (Mul b20~164@ a20~162@)) (Sub (Add c20~166@ d20~168@) (Mul a20~162@ d20~168@))))) (=> (= temp_20_1~3474@ (Mul (Mul (Mul (Mul a20~162@ b20~164@) (Sub d20~168@ c20~166@)) (Sub (Add b20~164@ a20~162@) (Mul c20~166@ b20~164@))) (Mul (Sub (Add c20~166@ d20~168@) (Mul a20~162@ d20~168@)) (Add (Mul d20~168@ d20~168@) (Mul b20~164@ a20~162@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3409@ temp_20_1~3474@))) (=> (= temp_20_0~3409@ temp_20_1~3474@) (=> (= temp_21_0~3563@ (Add (Mul (Mul (Mul a21~170@ a21~170@) (Sub c21~174@ d21~176@)) (Add (Mul a21~170@ d21~176@) (Sub a21~170@ d21~176@))) (Mul (Add (Mul b21~172@ d21~176@) (Add a21~170@ c21~174@)) (Add (Mul c21~174@ b21~172@) (Mul d21~176@ b21~172@))))) (=> (= temp_21_1~3644@ (Add (Mul (Mul (Mul a21~170@ a21~170@) (Sub c21~174@ d21~176@)) (Add (Mul a21~170@ d21~176@) (Sub a21~170@ d21~176@))) (Add (Mul (Add (Mul b21~172@ d21~176@) (Add a21~170@ c21~174@)) (Mul c21~174@ b21~172@)) (Mul (Add (Mul b21~172@ d21~176@) (Add a21~170@ c21~174@)) (Mul d21~176@ b21~172@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3563@ temp_21_1~3644@))) (=> (= temp_21_0~3563@ temp_21_1~3644@) (=> (= temp_22_0~3745@ (Sub (Mul (Sub (Mul d22~184@ a22~178@) (Sub b22~180@ a22~178@)) (Mul (Mul d22~184@ a22~178@) (Mul a22~178@ 10))) (Mul (Sub (Mul c22~182@ b22~180@) (Mul d22~184@ a22~178@)) (Mul (Mul d22~184@ c22~182@) (Sub c22~182@ c22~182@))))) (=> (= temp_22_1~3830@ (Sub (Mul (Sub (Mul d22~184@ a22~178@) (Sub b22~180@ a22~178@)) (Mul (Mul d22~184@ a22~178@) (Mul a22~178@ 10))) (Mul (Sub (Mul c22~182@ b22~180@) (Mul d22~184@ a22~178@)) (Sub (Mul (Mul d22~184@ c22~182@) c22~182@) (Mul (Mul d22~184@ c22~182@) c22~182@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3745@ temp_22_1~3830@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
