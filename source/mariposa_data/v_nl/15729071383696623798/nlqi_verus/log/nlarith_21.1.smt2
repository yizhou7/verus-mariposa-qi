...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Sub b0~4@ c0~6@)) (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@)) (Sub d0~8@ (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ c0~6@)) (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@)) (Sub d0~8@ (Mul b0~4@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~442@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul d1~16@ d1~16@)) (Mul (Sub (Add 72 c1~14@) (Add b1~12@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~507@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul d1~16@ d1~16@)) (Mul (Sub (Add 72 c1~14@) (Add b1~12@ b1~12@)) (Mul d1~16@ (Mul c1~14@ (Mul d1~16@ c1~14@)))))) (=> (= tmp%2@ (= temp_1_0~442@ temp_1_1~507@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~599@ (Add (Mul (Sub (Mul c2~22@ b2~20@) (Mul 40 b2~20@)) (Add (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Add (Add a2~18@ c2~22@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~676@ (Add (Mul (Sub (Mul c2~22@ b2~20@) (Mul 40 b2~20@)) (Add (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ d2~24@)) (Add (Add a2~18@ c2~22@) (Mul c2~22@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~599@ temp_2_1~676@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~744@ (Mul (Mul a3~26@ (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))) (Mul (Add (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Add d3~32@ b3~28@))))) (=> (= temp_3_1~797@ (Mul (Mul a3~26@ (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul d3~32@ b3~28@) (Add d3~32@ b3~28@)) (Add (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~744@ temp_3_1~797@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~873@ (Mul (Mul (Add (Add c4~38@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Mul a4~34@ a4~34@) c4~38@)))) (=> (= temp_4_1~934@ (Mul (Mul (Mul (Add (Add c4~38@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ c4~38@))) (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@))) (Mul (Mul a4~34@ a4~34@) c4~38@))) (=> (= tmp%5@ (= temp_4_0~873@ temp_4_1~934@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1014@ (Mul (Mul (Add (Mul a5~42@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1079@ (Mul (Mul (Add (Mul a5~42@ b5~44@) (Mul c5~46@ a5~42@)) (Mul d5~48@ (Mul c5~46@ (Mul c5~46@ a5~42@)))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~1014@ temp_5_1~1079@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1183@ (Sub (Sub (Mul (Mul 11 c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul d6~56@ c6~54@) (Add c6~54@ d6~56@))) (Mul (Mul (Sub c6~54@ a6~50@) (Add b6~52@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ 93))))) (=> (= temp_6_1~1280@ (Sub (Sub (Mul (Mul 11 c6~54@) (Mul a6~50@ d6~56@)) (Add (Mul (Mul d6~56@ c6~54@) c6~54@) (Mul (Mul d6~56@ c6~54@) d6~56@))) (Mul (Mul (Sub c6~54@ a6~50@) (Add b6~52@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ 93))))) (=> (= tmp%7@ (= temp_6_0~1183@ temp_6_1~1280@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1352@ (Mul (Mul (Sub a7~58@ (Mul d7~64@ b7~60@)) (Mul (Sub a7~58@ a7~58@) (Sub c7~62@ b7~60@))) (Mul (Sub b7~60@ (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1409@ (Mul (Mul (Sub a7~58@ (Mul b7~60@ d7~64@)) (Mul (Sub a7~58@ a7~58@) (Sub c7~62@ b7~60@))) (Mul (Sub b7~60@ (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1352@ temp_7_1~1409@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1477@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Add c8~70@ c8~70@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ b8~68@)) d8~72@))) (=> (= temp_8_1~1530@ (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Add c8~70@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ b8~68@)) d8~72@))) (=> (= tmp%9@ (= temp_8_0~1477@ temp_8_1~1530@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1610@ (Mul (Add (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ b9~76@)) (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ a9~74@))) (Mul (Mul (Sub c9~78@ b9~76@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~1707@ (Add (Mul (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ b9~76@)) (Mul (Mul (Sub c9~78@ b9~76@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ c9~78@)))) (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ a9~74@)) (Mul (Mul (Sub c9~78@ b9~76@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ c9~78@)))))) (=> (= tmp%10@ (= temp_9_0~1610@ temp_9_1~1707@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1783@ (Mul (Sub (Mul (Add a10~82@ a10~82@) (Add c10~86@ b10~84@)) (Mul c10~86@ (Mul d10~88@ a10~82@))) (Sub (Mul (Add b10~84@ a10~82@) (Mul b10~84@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~1844@ (Mul (Sub (Mul (Add a10~82@ a10~82@) (Add c10~86@ b10~84@)) (Mul c10~86@ (Mul d10~88@ a10~82@))) (Sub (Mul (Add b10~84@ a10~82@) (Mul b10~84@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1783@ temp_10_1~1844@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1920@ (Add (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ d11~96@)) (Mul (Mul b11~92@ a11~90@) (Mul d11~96@ d11~96@))) (Add (Add (Mul a11~90@ a11~90@) (Add a11~90@ b11~92@)) (Mul a11~90@ (Mul b11~92@ b11~92@))))) (=> (= temp_11_1~1981@ (Add (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ d11~96@)) (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ d11~96@))) (Add (Add (Mul a11~90@ a11~90@) (Add a11~90@ b11~92@)) (Mul a11~90@ (Mul b11~92@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1920@ temp_11_1~1981@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2061@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Sub b12~100@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Add (Mul b12~100@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Sub a12~98@ c12~102@) (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2126@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Sub b12~100@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Mul (Add (Mul b12~100@ a12~98@) (Mul b12~100@ a12~98@)) (Sub a12~98@ c12~102@)) (Mul a12~98@ d12~104@)))) (=> (= tmp%13@ (= temp_12_0~2061@ temp_12_1~2126@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2198@ (Mul (Mul (Mul (Add c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Sub (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@))) (Sub (Mul b13~108@ c13~110@) (Mul (Add d13~112@ a13~106@) (Mul a13~106@ b13~108@))))) (=> (= temp_13_1~2287@ (Sub (Mul (Mul (Mul (Add c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Sub (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@))) (Mul b13~108@ c13~110@)) (Mul (Mul (Mul (Add c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Sub (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@))) (Mul (Add d13~112@ a13~106@) (Mul a13~106@ b13~108@))))) (=> (= tmp%14@ (= temp_13_0~2198@ temp_13_1~2287@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2363@ (Mul (Mul (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ b14~116@)) (Sub d14~120@ (Mul d14~120@ c14~118@))) (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ d14~120@)) (Mul (Sub c14~118@ d14~120@) (Mul c14~118@ a14~114@))))) (=> (= temp_14_1~2424@ (Mul (Mul (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ b14~116@)) (Sub d14~120@ (Mul d14~120@ c14~118@))) (Mul (Mul a14~114@ (Mul a14~114@ (Mul c14~118@ d14~120@))) (Mul (Sub c14~118@ d14~120@) (Mul c14~118@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2363@ temp_14_1~2424@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2500@ (Mul (Sub (Mul d15~128@ (Sub a15~122@ c15~126@)) (Add (Add c15~126@ a15~122@) (Mul c15~126@ b15~124@))) (Mul (Sub (Mul a15~122@ c15~126@) (Mul c15~126@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~2561@ (Mul (Sub (Mul d15~128@ (Sub a15~122@ c15~126@)) (Add (Add c15~126@ a15~122@) (Mul c15~126@ b15~124@))) (Mul (Sub (Mul a15~122@ c15~126@) (Mul c15~126@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul d15~128@ a15~122@))))) (=> (= tmp%16@ (= temp_15_0~2500@ temp_15_1~2561@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2629@ (Add (Mul (Mul (Mul d16~136@ a16~130@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@))) (Mul c16~134@ (Mul (Mul a16~130@ d16~136@) (Sub d16~136@ a16~130@))))) (=> (= temp_16_1~2682@ (Add (Mul (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@))) (Mul c16~134@ (Mul (Mul a16~130@ d16~136@) (Sub d16~136@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2629@ temp_16_1~2682@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2762@ (Mul (Mul (Mul (Mul a17~138@ c17~142@) (Mul d17~144@ d17~144@)) (Sub (Mul d17~144@ b17~140@) (Mul d17~144@ a17~138@))) (Mul (Mul (Mul b17~140@ b17~140@) (Mul c17~142@ a17~138@)) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~2827@ (Mul (Mul (Mul (Mul a17~138@ c17~142@) (Mul d17~144@ d17~144@)) (Sub (Mul d17~144@ b17~140@) (Mul d17~144@ a17~138@))) (Mul (Mul b17~140@ b17~140@) (Mul (Mul c17~142@ a17~138@) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ b17~140@)))))) (=> (= tmp%18@ (= temp_17_0~2762@ temp_17_1~2827@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2907@ (Mul (Mul (Mul (Mul b18~148@ b18~148@) (Add a18~146@ a18~146@)) (Mul (Mul a18~146@ b18~148@) (Sub b18~148@ b18~148@))) (Add (Mul (Mul c18~150@ c18~150@) (Mul a18~146@ c18~150@)) (Mul (Mul d18~152@ d18~152@) (Sub b18~148@ b18~148@))))) (=> (= temp_18_1~3004@ (Add (Mul (Mul (Mul (Mul b18~148@ b18~148@) (Add a18~146@ a18~146@)) (Mul (Mul a18~146@ b18~148@) (Sub b18~148@ b18~148@))) (Mul (Mul c18~150@ c18~150@) (Mul a18~146@ c18~150@))) (Mul (Mul (Mul (Mul b18~148@ b18~148@) (Add a18~146@ a18~146@)) (Mul (Mul a18~146@ b18~148@) (Sub b18~148@ b18~148@))) (Mul (Mul d18~152@ d18~152@) (Sub b18~148@ b18~148@))))) (=> (= tmp%19@ (= temp_18_0~2907@ temp_18_1~3004@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3084@ (Mul (Mul (Mul (Add b19~156@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ d19~160@))) (Add (Mul (Mul b19~156@ d19~160@) (Mul c19~158@ d19~160@)) (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ c19~158@))))) (=> (= temp_19_1~3149@ (Mul (Mul (Mul (Add b19~156@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ d19~160@))) (Add (Mul (Mul b19~156@ d19~160@) (Mul c19~158@ d19~160@)) (Mul (Mul (Mul a19~154@ d19~160@) d19~160@) c19~158@)))) (=> (= tmp%20@ (= temp_19_0~3084@ temp_19_1~3149@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3253@ (Mul (Sub (Mul (Sub b20~164@ b20~164@) (Mul 77 a20~162@)) (Mul (Mul d20~168@ d20~168@) (Mul c20~166@ a20~162@))) (Sub (Mul (Mul a20~162@ d20~168@) (Mul d20~168@ a20~162@)) (Mul (Sub d20~168@ c20~166@) (Sub 44 a20~162@))))) (=> (= temp_20_1~3342@ (Mul (Sub (Mul (Sub b20~164@ b20~164@) (Mul 77 a20~162@)) (Mul (Mul d20~168@ d20~168@) (Mul c20~166@ a20~162@))) (Sub (Mul (Mul (Mul a20~162@ d20~168@) d20~168@) a20~162@) (Mul (Sub d20~168@ c20~166@) (Sub 44 a20~162@))))) (=> (= tmp%21@ (= temp_20_0~3253@ temp_20_1~3342@)) (=> %%location_label%%20 tmp%21@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
