...
(set-info :comment ";; mariposa_data/v_nl//15729071383696623798/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_3_0~789@ Int)
...
(declare-const temp_6_0~1347@ Int)
(declare-const temp_6_1~1444@ Int)
(declare-const temp_7_0~1535@ Int)
(declare-const temp_7_1~1592@ Int)
...
(declare-const temp_10_0~2083@ Int)
(declare-const temp_10_1~2144@ Int)
(declare-const temp_11_0~2233@ Int)
(declare-const temp_11_1~2294@ Int)
(declare-const temp_12_0~2387@ Int)
(declare-const temp_12_1~2452@ Int)
(declare-const temp_13_0~2559@ Int)
(declare-const temp_13_1~2648@ Int)
(declare-const temp_14_0~2783@ Int)
(declare-const temp_14_1~2844@ Int)
(declare-const temp_15_0~2939@ Int)
(declare-const temp_15_1~3000@ Int)
(declare-const temp_16_0~3081@ Int)
(declare-const temp_16_1~3134@ Int)
(declare-const temp_17_0~3227@ Int)
(declare-const temp_17_1~3292@ Int)
(declare-const temp_18_0~3407@ Int)
(declare-const temp_18_1~3504@ Int)
(declare-const temp_19_0~3651@ Int)
(declare-const temp_19_1~3716@ Int)
(declare-const temp_20_0~3839@ Int)
(declare-const temp_20_1~3928@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Sub b0~4@ c0~6@)) (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@)) (Sub d0~8@ (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ c0~6@)) (Mul (Sub b0~4@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@)) (Sub d0~8@ (Mul b0~4@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ d0~8@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~455@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul d1~16@ d1~16@)) (Mul (Sub (Add 72 c1~14@) (Add b1~12@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~520@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul d1~16@ d1~16@)) (Mul (Sub (Add 72 c1~14@) (Add b1~12@ b1~12@)) (Mul d1~16@ (Mul c1~14@ (Mul d1~16@ c1~14@)))))) (and (=> (= tmp%1@ (Mul d1~16@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d1~16@ c1~14@ tmp%1@) (=> %%location_label%%1 (= temp_1_0~455@ temp_1_1~520@)))) (=> (= temp_1_0~455@ temp_1_1~520@) (=> (= temp_2_0~631@ (Add (Mul (Sub (Mul c2~22@ b2~20@) (Mul 40 b2~20@)) (Add (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@)) (Add (Add a2~18@ c2~22@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~708@ (Add (Mul (Sub (Mul c2~22@ b2~20@) (Mul 40 b2~20@)) (Add (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ d2~24@)) (Add (Add a2~18@ c2~22@) (Mul c2~22@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ a2~18@) (=> %%location_label%%2 (= temp_2_0~631@ temp_2_1~708@))) (=> (= temp_2_0~631@ temp_2_1~708@) (=> (= temp_3_0~789@ (Mul (Mul a3~26@ (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))) (Mul (Add (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Add d3~32@ b3~28@))))) (=> (= temp_3_1~842@ (Mul (Mul a3~26@ (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul d3~32@ b3~28@) (Add d3~32@ b3~28@)) (Add (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@))))) (and (=> (= tmp%2@ (Add (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@))) (=> (= tmp%3@ (Mul (Mul d3~32@ b3~28@) (Add d3~32@ b3~28@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~789@ temp_3_1~842@))))) (=> (= temp_3_0~789@ temp_3_1~842@) (=> (= temp_4_0~955@ (Mul (Mul (Add (Add c4~38@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Mul a4~34@ a4~34@) c4~38@)))) (=> (= temp_4_1~1016@ (Mul (Mul (Mul (Add (Add c4~38@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ c4~38@))) (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@))) (Mul (Mul a4~34@ a4~34@) c4~38@))) (and (=> (= tmp%4@ (Mul (Add (Add c4~38@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ c4~38@)))) (=> (= tmp%5@ (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@))) (=> (= tmp%6@ (Mul (Mul a4~34@ a4~34@) c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~955@ temp_4_1~1016@)))))) (=> (= temp_4_0~955@ temp_4_1~1016@) (=> (= temp_5_0~1159@ (Mul (Mul (Add (Mul a5~42@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1224@ (Mul (Mul (Add (Mul a5~42@ b5~44@) (Mul c5~46@ a5~42@)) (Mul d5~48@ (Mul c5~46@ (Mul c5~46@ a5~42@)))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ a5~42@))))) (and (=> (= tmp%7@ (Mul c5~46@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d5~48@ c5~46@ tmp%7@) (=> %%location_label%%5 (= temp_5_0~1159@ temp_5_1~1224@)))) (=> (= temp_5_0~1159@ temp_5_1~1224@) (=> (= temp_6_0~1347@ (Sub (Sub (Mul (Mul 11 c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul d6~56@ c6~54@) (Add c6~54@ d6~56@))) (Mul (Mul (Sub c6~54@ a6~50@) (Add b6~52@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ 93))))) (=> (= temp_6_1~1444@ (Sub (Sub (Mul (Mul 11 c6~54@) (Mul a6~50@ d6~56@)) (Add (Mul (Mul d6~56@ c6~54@) c6~54@) (Mul (Mul d6~56@ c6~54@) d6~56@))) (Mul (Mul (Sub c6~54@ a6~50@) (Add b6~52@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ 93))))) (and (=> (= tmp%8@ (Mul d6~56@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%8@ c6~54@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1347@ temp_6_1~1444@)))) (=> (= temp_6_0~1347@ temp_6_1~1444@) (=> (= temp_7_0~1535@ (Mul (Mul (Sub a7~58@ (Mul d7~64@ b7~60@)) (Mul (Sub a7~58@ a7~58@) (Sub c7~62@ b7~60@))) (Mul (Sub b7~60@ (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1592@ (Mul (Mul (Sub a7~58@ (Mul b7~60@ d7~64@)) (Mul (Sub a7~58@ a7~58@) (Sub c7~62@ b7~60@))) (Mul (Sub b7~60@ (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1535@ temp_7_1~1592@))) (=> (= temp_7_0~1535@ temp_7_1~1592@) (=> (= temp_8_0~1673@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Add c8~70@ c8~70@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ b8~68@)) d8~72@))) (=> (= temp_8_1~1726@ (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Add c8~70@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ b8~68@)) d8~72@))) (and (=> (= tmp%9@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@))) (=> (= tmp%10@ (Mul (Mul a8~66@ c8~70@) (Add c8~70@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%8 (= temp_8_0~1673@ temp_8_1~1726@))))) (=> (= temp_8_0~1673@ temp_8_1~1726@) (=> (= temp_9_0~1843@ (Mul (Add (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ b9~76@)) (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ a9~74@))) (Mul (Mul (Sub c9~78@ b9~76@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~1940@ (Add (Mul (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ b9~76@)) (Mul (Mul (Sub c9~78@ b9~76@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ c9~78@)))) (Mul (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ a9~74@)) (Mul (Mul (Sub c9~78@ b9~76@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ c9~78@)))))) (and (=> (= tmp%11@ (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ b9~76@))) (=> (= tmp%12@ (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ a9~74@))) (=> (= tmp%13@ (Mul (Mul (Sub c9~78@ b9~76@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@ c9~78@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%9 (= temp_9_0~1843@ temp_9_1~1940@)))))) (=> (= temp_9_0~1843@ temp_9_1~1940@) (=> (= temp_10_0~2083@ (Mul (Sub (Mul (Add a10~82@ a10~82@) (Add c10~86@ b10~84@)) (Mul c10~86@ (Mul d10~88@ a10~82@))) (Sub (Mul (Add b10~84@ a10~82@) (Mul b10~84@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~2144@ (Mul (Sub (Mul (Add a10~82@ a10~82@) (Add c10~86@ b10~84@)) (Mul c10~86@ (Mul d10~88@ a10~82@))) (Sub (Mul (Add b10~84@ a10~82@) (Mul b10~84@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ d10~88@) (=> %%location_label%%10 (= temp_10_0~2083@ temp_10_1~2144@))) (=> (= temp_10_0~2083@ temp_10_1~2144@) (=> (= temp_11_0~2233@ (Add (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ d11~96@)) (Mul (Mul b11~92@ a11~90@) (Mul d11~96@ d11~96@))) (Add (Add (Mul a11~90@ a11~90@) (Add a11~90@ b11~92@)) (Mul a11~90@ (Mul b11~92@ b11~92@))))) (=> (= temp_11_1~2294@ (Add (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ d11~96@)) (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ d11~96@))) (Add (Add (Mul a11~90@ a11~90@) (Add a11~90@ b11~92@)) (Mul a11~90@ (Mul b11~92@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b11~92@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2233@ temp_11_1~2294@))) (=> (= temp_11_0~2233@ temp_11_1~2294@) (=> (= temp_12_0~2387@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Sub b12~100@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Add (Mul b12~100@ a12~98@) (Mul b12~100@ a12~98@)) (Mul (Sub a12~98@ c12~102@) (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2452@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Sub b12~100@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Mul (Add (Mul b12~100@ a12~98@) (Mul b12~100@ a12~98@)) (Sub a12~98@ c12~102@)) (Mul a12~98@ d12~104@)))) (and (=> (= tmp%14@ (Add (Mul b12~100@ a12~98@) (Mul b12~100@ a12~98@))) (=> (= tmp%15@ (Sub a12~98@ c12~102@)) (=> (= tmp%16@ (Mul a12~98@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%12 (= temp_12_0~2387@ temp_12_1~2452@)))))) (=> (= temp_12_0~2387@ temp_12_1~2452@) (=> (= temp_13_0~2559@ (Mul (Mul (Mul (Add c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Sub (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@))) (Sub (Mul b13~108@ c13~110@) (Mul (Add d13~112@ a13~106@) (Mul a13~106@ b13~108@))))) (=> (= temp_13_1~2648@ (Sub (Mul (Mul (Mul (Add c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Sub (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@))) (Mul b13~108@ c13~110@)) (Mul (Mul (Mul (Add c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Sub (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@))) (Mul (Add d13~112@ a13~106@) (Mul a13~106@ b13~108@))))) (and (=> (= tmp%17@ (Mul (Mul (Add c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Sub (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@)))) (=> (= tmp%18@ (Mul b13~108@ c13~110@)) (=> (= tmp%19@ (Mul (Add d13~112@ a13~106@) (Mul a13~106@ b13~108@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%13 (= temp_13_0~2559@ temp_13_1~2648@)))))) (=> (= temp_13_0~2559@ temp_13_1~2648@) (=> (= temp_14_0~2783@ (Mul (Mul (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ b14~116@)) (Sub d14~120@ (Mul d14~120@ c14~118@))) (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ d14~120@)) (Mul (Sub c14~118@ d14~120@) (Mul c14~118@ a14~114@))))) (=> (= temp_14_1~2844@ (Mul (Mul (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ b14~116@)) (Sub d14~120@ (Mul d14~120@ c14~118@))) (Mul (Mul a14~114@ (Mul a14~114@ (Mul c14~118@ d14~120@))) (Mul (Sub c14~118@ d14~120@) (Mul c14~118@ a14~114@))))) (and (=> (= tmp%20@ (Mul c14~118@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a14~114@ a14~114@ tmp%20@) (=> %%location_label%%14 (= temp_14_0~2783@ temp_14_1~2844@)))) (=> (= temp_14_0~2783@ temp_14_1~2844@) (=> (= temp_15_0~2939@ (Mul (Sub (Mul d15~128@ (Sub a15~122@ c15~126@)) (Add (Add c15~126@ a15~122@) (Mul c15~126@ b15~124@))) (Mul (Sub (Mul a15~122@ c15~126@) (Mul c15~126@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~3000@ (Mul (Sub (Mul d15~128@ (Sub a15~122@ c15~126@)) (Add (Add c15~126@ a15~122@) (Mul c15~126@ b15~124@))) (Mul (Sub (Mul a15~122@ c15~126@) (Mul c15~126@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul d15~128@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a15~122@ d15~128@) (=> %%location_label%%15 (= temp_15_0~2939@ temp_15_1~3000@))) (=> (= temp_15_0~2939@ temp_15_1~3000@) (=> (= temp_16_0~3081@ (Add (Mul (Mul (Mul d16~136@ a16~130@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@))) (Mul c16~134@ (Mul (Mul a16~130@ d16~136@) (Sub d16~136@ a16~130@))))) (=> (= temp_16_1~3134@ (Add (Mul (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ b16~132@)) (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@))) (Mul c16~134@ (Mul (Mul a16~130@ d16~136@) (Sub d16~136@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d16~136@ a16~130@) (=> %%location_label%%16 (= temp_16_0~3081@ temp_16_1~3134@))) (=> (= temp_16_0~3081@ temp_16_1~3134@) (=> (= temp_17_0~3227@ (Mul (Mul (Mul (Mul a17~138@ c17~142@) (Mul d17~144@ d17~144@)) (Sub (Mul d17~144@ b17~140@) (Mul d17~144@ a17~138@))) (Mul (Mul (Mul b17~140@ b17~140@) (Mul c17~142@ a17~138@)) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~3292@ (Mul (Mul (Mul (Mul a17~138@ c17~142@) (Mul d17~144@ d17~144@)) (Sub (Mul d17~144@ b17~140@) (Mul d17~144@ a17~138@))) (Mul (Mul b17~140@ b17~140@) (Mul (Mul c17~142@ a17~138@) (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ b17~140@)))))) (and (=> (= tmp%21@ (Mul b17~140@ b17~140@)) (=> (= tmp%22@ (Mul c17~142@ a17~138@)) (=> (= tmp%23@ (Mul (Mul a17~138@ b17~140@) (Mul a17~138@ b17~140@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%17 (= temp_17_0~3227@ temp_17_1~3292@)))))) (=> (= temp_17_0~3227@ temp_17_1~3292@) (=> (= temp_18_0~3407@ (Mul (Mul (Mul (Mul b18~148@ b18~148@) (Add a18~146@ a18~146@)) (Mul (Mul a18~146@ b18~148@) (Sub b18~148@ b18~148@))) (Add (Mul (Mul c18~150@ c18~150@) (Mul a18~146@ c18~150@)) (Mul (Mul d18~152@ d18~152@) (Sub b18~148@ b18~148@))))) (=> (= temp_18_1~3504@ (Add (Mul (Mul (Mul (Mul b18~148@ b18~148@) (Add a18~146@ a18~146@)) (Mul (Mul a18~146@ b18~148@) (Sub b18~148@ b18~148@))) (Mul (Mul c18~150@ c18~150@) (Mul a18~146@ c18~150@))) (Mul (Mul (Mul (Mul b18~148@ b18~148@) (Add a18~146@ a18~146@)) (Mul (Mul a18~146@ b18~148@) (Sub b18~148@ b18~148@))) (Mul (Mul d18~152@ d18~152@) (Sub b18~148@ b18~148@))))) (and (=> (= tmp%24@ (Mul (Mul (Mul b18~148@ b18~148@) (Add a18~146@ a18~146@)) (Mul (Mul a18~146@ b18~148@) (Sub b18~148@ b18~148@)))) (=> (= tmp%25@ (Mul (Mul c18~150@ c18~150@) (Mul a18~146@ c18~150@))) (=> (= tmp%26@ (Mul (Mul d18~152@ d18~152@) (Sub b18~148@ b18~148@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%18 (= temp_18_0~3407@ temp_18_1~3504@)))))) (=> (= temp_18_0~3407@ temp_18_1~3504@) (=> (= temp_19_0~3651@ (Mul (Mul (Mul (Add b19~156@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ d19~160@))) (Add (Mul (Mul b19~156@ d19~160@) (Mul c19~158@ d19~160@)) (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ c19~158@))))) (=> (= temp_19_1~3716@ (Mul (Mul (Mul (Add b19~156@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Mul d19~160@ c19~158@) (Mul c19~158@ d19~160@))) (Add (Mul (Mul b19~156@ d19~160@) (Mul c19~158@ d19~160@)) (Mul (Mul (Mul a19~154@ d19~160@) d19~160@) c19~158@)))) (and (=> (= tmp%27@ (Mul a19~154@ d19~160@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ d19~160@ c19~158@) (=> %%location_label%%19 (= temp_19_0~3651@ temp_19_1~3716@)))) (=> (= temp_19_0~3651@ temp_19_1~3716@) (=> (= temp_20_0~3839@ (Mul (Sub (Mul (Sub b20~164@ b20~164@) (Mul 77 a20~162@)) (Mul (Mul d20~168@ d20~168@) (Mul c20~166@ a20~162@))) (Sub (Mul (Mul a20~162@ d20~168@) (Mul d20~168@ a20~162@)) (Mul (Sub d20~168@ c20~166@) (Sub 44 a20~162@))))) (=> (= temp_20_1~3928@ (Mul (Sub (Mul (Sub b20~164@ b20~164@) (Mul 77 a20~162@)) (Mul (Mul d20~168@ d20~168@) (Mul c20~166@ a20~162@))) (Sub (Mul (Mul (Mul a20~162@ d20~168@) d20~168@) a20~162@) (Mul (Sub d20~168@ c20~166@) (Sub 44 a20~162@))))) (=> (= tmp%28@ (Mul a20~162@ d20~168@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ d20~168@ a20~162@) (=> %%location_label%%20 (= temp_20_0~3839@ temp_20_1~3928@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
