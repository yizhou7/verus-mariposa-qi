...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ d0~8@))) (Sub b0~4@ (Mul (Mul 59 a0~2@) (Sub b0~4@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul c0~6@ (Mul d0~8@ (Mul c0~6@ d0~8@))) (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ d0~8@))) (Sub b0~4@ (Mul (Mul 59 a0~2@) (Sub b0~4@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~462@ (Mul (Add (Mul (Mul c1~14@ a1~10@) (Sub a1~10@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@))) (Sub (Mul (Mul 32 a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~539@ (Mul (Add (Mul (Mul c1~14@ a1~10@) (Sub a1~10@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ b1~12@))) (Sub (Mul (Mul 32 a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~462@ temp_1_1~539@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~631@ (Mul (Sub (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul a2~18@ a2~18@) (Sub 78 c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~708@ (Mul (Sub (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul a2~18@ a2~18@) (Sub 78 c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~631@ temp_2_1~708@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~784@ (Mul (Mul (Mul c3~30@ (Mul a3~26@ a3~26@)) (Mul (Add a3~26@ b3~28@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~853@ (Mul (Mul (Mul c3~30@ (Mul a3~26@ a3~26@)) (Add (Mul a3~26@ (Mul c3~30@ b3~28@)) (Mul b3~28@ (Mul c3~30@ b3~28@)))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~784@ temp_3_1~853@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~933@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Add (Sub d4~40@ d4~40@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Add b4~36@ a4~34@)) (Mul (Sub b4~36@ a4~34@) (Add a4~34@ d4~40@))))) (=> (= temp_4_1~1006@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Add (Sub d4~40@ d4~40@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Add b4~36@ a4~34@)) (Sub (Mul b4~36@ (Add a4~34@ d4~40@)) (Mul a4~34@ (Add a4~34@ d4~40@)))))) (=> (= tmp%5@ (= temp_4_0~933@ temp_4_1~1006@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1098@ (Sub (Mul (Mul (Mul 97 a5~42@) (Sub d5~48@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ c5~46@))) (Add (Add (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@)) (Add (Mul d5~48@ b5~44@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1175@ (Sub (Mul (Mul 97 (Mul a5~42@ (Sub d5~48@ b5~44@))) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ c5~46@))) (Add (Add (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@)) (Add (Mul d5~48@ b5~44@) (Mul b5~44@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~1098@ temp_5_1~1175@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1239@ (Sub (Mul (Mul (Sub d6~56@ c6~54@) (Mul c6~54@ b6~52@)) (Sub (Mul 71 d6~56@) (Mul d6~56@ b6~52@))) c6~54@)) (=> (= temp_6_1~1296@ (Sub (Mul (Sub (Mul d6~56@ (Mul c6~54@ b6~52@)) (Mul c6~54@ (Mul c6~54@ b6~52@))) (Sub (Mul 71 d6~56@) (Mul d6~56@ b6~52@))) c6~54@)) (=> (= tmp%7@ (= temp_6_0~1239@ temp_6_1~1296@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1384@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul b7~60@ c7~62@)) (Mul (Mul 99 d7~64@) (Sub a7~58@ b7~60@))) (Mul (Mul (Mul d7~64@ a7~58@) (Add c7~62@ a7~58@)) (Mul (Mul c7~62@ c7~62@) c7~62@)))) (=> (= temp_7_1~1457@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul b7~60@ c7~62@)) (Mul (Mul 99 d7~64@) (Sub a7~58@ b7~60@))) (Mul (Mul (Add c7~62@ a7~58@) (Mul d7~64@ a7~58@)) (Mul (Mul c7~62@ c7~62@) c7~62@)))) (=> (= tmp%8@ (= temp_7_0~1384@ temp_7_1~1457@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1533@ (Sub (Mul (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ b8~68@)) (Mul c8~70@ (Add d8~72@ a8~66@))) (Mul (Mul (Sub a8~66@ c8~70@) (Sub b8~68@ a8~66@)) 93))) (=> (= temp_8_1~1594@ (Sub (Mul (Mul (Mul c8~70@ a8~66@) (Mul a8~66@ b8~68@)) (Mul c8~70@ (Add d8~72@ a8~66@))) (Mul (Mul (Sub a8~66@ c8~70@) (Sub b8~68@ a8~66@)) 93))) (=> (= tmp%9@ (= temp_8_0~1533@ temp_8_1~1594@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1682@ (Mul (Mul (Add (Mul d9~80@ 22) (Mul a9~74@ d9~80@)) (Mul d9~80@ (Mul b9~76@ d9~80@))) (Sub (Mul (Mul b9~76@ c9~78@) (Add b9~76@ c9~78@)) (Add (Mul d9~80@ c9~78@) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1755@ (Mul (Mul (Add (Mul d9~80@ 22) (Mul a9~74@ d9~80@)) (Mul d9~80@ (Mul b9~76@ d9~80@))) (Sub (Mul (Mul b9~76@ c9~78@) (Add b9~76@ c9~78@)) (Add (Mul c9~78@ d9~80@) (Mul a9~74@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1682@ temp_9_1~1755@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1835@ (Add (Mul (Mul (Mul b10~84@ a10~82@) (Mul c10~86@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))) (Mul (Sub (Mul c10~86@ a10~82@) (Add c10~86@ d10~88@)) (Mul (Mul d10~88@ d10~88@) (Sub a10~82@ c10~86@))))) (=> (= temp_10_1~1900@ (Add (Mul (Mul (Mul b10~84@ a10~82@) (Mul c10~86@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))) (Mul (Mul (Sub (Mul c10~86@ a10~82@) (Add c10~86@ d10~88@)) (Mul d10~88@ d10~88@)) (Sub a10~82@ c10~86@)))) (=> (= tmp%11@ (= temp_10_0~1835@ temp_10_1~1900@)) (=> %%location_label%%10 tmp%11@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
