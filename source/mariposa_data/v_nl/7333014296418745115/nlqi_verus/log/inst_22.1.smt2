...
(set-info :comment ";; mariposa_data/v_nl//7333014296418745115/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_15_0~2745@ Int)
(declare-const temp_15_1~2810@ Int)
(declare-const temp_16_0~2911@ Int)
(declare-const temp_16_1~2960@ Int)
(declare-const temp_17_0~3051@ Int)
(declare-const temp_17_1~3112@ Int)
(declare-const temp_18_0~3217@ Int)
(declare-const temp_18_1~3294@ Int)
(declare-const temp_19_0~3387@ Int)
(declare-const temp_19_1~3452@ Int)
(declare-const temp_20_0~3539@ Int)
(declare-const temp_20_1~3592@ Int)
(declare-const temp_21_0~3691@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Sub (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Add (Mul d0~8@ a0~2@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@)) d0~8@))) (=> (= temp_0_1~342@ (Mul (Sub (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul d0~8@ (Add a0~2@ c0~6@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@)) d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d0~8@ a0~2@ c0~6@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~342@))) (=> (= temp_0_0~293@ temp_0_1~342@) (=> (= temp_1_0~429@ (Mul (Mul (Mul b1~12@ (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Mul d1~16@ (Mul d1~16@ b1~12@)) (Sub (Mul b1~12@ c1~14@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~486@ (Mul (Mul (Mul b1~12@ (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul d1~16@ b1~12@) d1~16@) (Sub (Mul b1~12@ c1~14@) (Mul c1~14@ b1~12@))))) (and (=> (= tmp%1@ (Mul d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ tmp%1@) (=> %%location_label%%1 (= temp_1_0~429@ temp_1_1~486@)))) (=> (= temp_1_0~429@ temp_1_1~486@) (=> (= temp_2_0~579@ (Mul (Mul (Mul (Add b2~20@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@))) (Sub (Mul d2~24@ (Mul c2~22@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~640@ (Mul (Mul (Mul (Add b2~20@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@))) (Sub (Mul d2~24@ (Mul c2~22@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ b2~20@) (=> %%location_label%%2 (= temp_2_0~579@ temp_2_1~640@))) (=> (= temp_2_0~579@ temp_2_1~640@) (=> (= temp_3_0~721@ (Sub (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ c3~30@)) d3~32@))) (=> (= temp_3_1~774@ (Sub (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Mul c3~30@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ c3~30@)) d3~32@))) (and (=> (= tmp%2@ (Mul d3~32@ b3~28@)) (=> (= tmp%3@ (Mul c3~30@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~721@ temp_3_1~774@))))) (=> (= temp_3_0~721@ temp_3_1~774@) (=> (= temp_4_0~875@ (Mul (Sub (Mul (Sub a4~34@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ c4~38@))) (Add (Mul (Sub b4~36@ a4~34@) (Sub d4~40@ d4~40@)) (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~940@ (Mul (Sub (Mul (Sub a4~34@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ a4~34@))) (Add (Mul (Sub b4~36@ a4~34@) (Sub d4~40@ d4~40@)) (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ c4~38@) (=> %%location_label%%4 (= temp_4_0~875@ temp_4_1~940@))) (=> (= temp_4_0~875@ temp_4_1~940@) (=> (= temp_5_0~1045@ (Mul (Sub (Mul (Sub d5~48@ d5~48@) (Mul a5~42@ b5~44@)) (Sub (Mul d5~48@ d5~48@) (Mul d5~48@ c5~46@))) (Add (Mul (Mul d5~48@ d5~48@) (Sub 13 a5~42@)) (Mul (Mul a5~42@ b5~44@) (Sub a5~42@ c5~46@))))) (=> (= temp_5_1~1122@ (Mul (Sub (Mul (Sub d5~48@ d5~48@) (Mul a5~42@ b5~44@)) (Sub (Mul d5~48@ d5~48@) (Mul d5~48@ c5~46@))) (Add (Mul (Mul d5~48@ d5~48@) (Sub 13 a5~42@)) (Mul (Mul a5~42@ b5~44@) (Sub a5~42@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ d5~48@) (=> %%location_label%%5 (= temp_5_0~1045@ temp_5_1~1122@))) (=> (= temp_5_0~1045@ temp_5_1~1122@) (=> (= temp_6_0~1215@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ d6~56@)) (Mul (Sub a6~50@ a6~50@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1280@ (Mul (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ d6~56@)) (Sub a6~50@ a6~50@)) (Mul d6~56@ a6~50@)) (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@))))) (and (=> (= tmp%4@ (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ d6~56@))) (=> (= tmp%5@ (Sub a6~50@ a6~50@)) (=> (= tmp%6@ (Mul d6~56@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%6 (= temp_6_0~1215@ temp_6_1~1280@)))))) (=> (= temp_6_0~1215@ temp_6_1~1280@) (=> (= temp_7_0~1395@ (Mul (Add (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ a7~58@)) (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Sub (Mul b7~60@ d7~64@) (Mul b7~60@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1460@ (Mul (Add (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ a7~58@)) (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ b7~60@)) (Sub (Mul b7~60@ d7~64@) (Mul b7~60@ c7~62@))))) (and (=> (= tmp%7@ (Sub (Mul b7~60@ d7~64@) (Mul b7~60@ c7~62@))) (=> (= tmp%8@ (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ b7~60@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%7 (= temp_7_0~1395@ temp_7_1~1460@))))) (=> (= temp_7_0~1395@ temp_7_1~1460@) (=> (= temp_8_0~1565@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Add d8~72@ a8~66@)) (Sub (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Add a8~66@ (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ b8~68@))))) (=> (= temp_8_1~1618@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Add d8~72@ a8~66@)) (Sub (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Add a8~66@ (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1565@ temp_8_1~1618@))) (=> (= temp_8_0~1565@ temp_8_1~1618@) (=> (= temp_9_0~1707@ (Mul (Add (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ d9~80@)) (Mul (Mul b9~76@ c9~78@) d9~80@)) (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~1768@ (Mul (Add (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ d9~80@)) (Mul (Mul b9~76@ c9~78@) d9~80@)) (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ d9~80@))))) (and (=> (= tmp%9@ (Mul c9~78@ b9~76@)) (=> (= tmp%10@ (Mul a9~74@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%9 (= temp_9_0~1707@ temp_9_1~1768@))))) (=> (= temp_9_0~1707@ temp_9_1~1768@) (=> (= temp_10_0~1877@ (Mul (Sub (Add (Sub c10~86@ b10~84@) (Sub a10~82@ c10~86@)) (Mul (Sub c10~86@ a10~82@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ 5)) (Mul b10~84@ (Add a10~82@ d10~88@))))) (=> (= temp_10_1~1950@ (Mul (Sub (Add (Sub c10~86@ b10~84@) (Sub a10~82@ c10~86@)) (Mul (Mul c10~86@ a10~82@) (Sub c10~86@ a10~82@))) (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ 5)) (Mul b10~84@ (Add a10~82@ d10~88@))))) (and (=> (= tmp%11@ (Sub c10~86@ a10~82@)) (=> (= tmp%12@ (Mul c10~86@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%10 (= temp_10_0~1877@ temp_10_1~1950@))))) (=> (= temp_10_0~1877@ temp_10_1~1950@) (=> (= temp_11_0~2051@ (Mul (Mul (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul d11~96@ b11~92@) (Mul d11~96@ a11~90@))) (Sub (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ a11~90@)) (Add (Mul a11~90@ d11~96@) (Mul c11~94@ b11~92@))))) (=> (= temp_11_1~2116@ (Mul (Mul (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (Sub (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ a11~90@)) (Add (Mul a11~90@ d11~96@) (Mul c11~94@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d11~96@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2051@ temp_11_1~2116@))) (=> (= temp_11_0~2051@ temp_11_1~2116@) (=> (= temp_12_0~2221@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ a12~98@)) (Mul (Mul d12~104@ d12~104@) (Add b12~100@ d12~104@))) (Add (Mul (Mul c12~102@ a12~98@) (Add b12~100@ b12~100@)) (Mul (Mul c12~102@ 1) (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2298@ (Mul (Mul (Mul (Mul d12~104@ d12~104@) (Add b12~100@ d12~104@)) (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ a12~98@))) (Add (Mul (Mul c12~102@ a12~98@) (Add b12~100@ b12~100@)) (Mul (Mul c12~102@ 1) (Mul a12~98@ d12~104@))))) (and (=> (= tmp%13@ (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ a12~98@))) (=> (= tmp%14@ (Mul (Mul d12~104@ d12~104@) (Add b12~100@ d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%12 (= temp_12_0~2221@ temp_12_1~2298@))))) (=> (= temp_12_0~2221@ temp_12_1~2298@) (=> (= temp_13_0~2415@ (Mul (Mul (Mul (Add c13~110@ b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul c13~110@ a13~106@) (Mul a13~106@ c13~110@))) (Mul (Mul (Sub a13~106@ d13~112@) (Add b13~108@ d13~112@)) (Mul (Mul b13~108@ c13~110@) (Sub b13~108@ a13~106@))))) (=> (= temp_13_1~2488@ (Mul (Mul (Mul (Add c13~110@ b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul c13~110@ a13~106@) (Mul a13~106@ c13~110@))) (Mul (Sub (Mul a13~106@ (Add b13~108@ d13~112@)) (Mul d13~112@ (Add b13~108@ d13~112@))) (Mul (Mul b13~108@ c13~110@) (Sub b13~108@ a13~106@))))) (and (=> (= tmp%15@ (Add b13~108@ d13~112@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a13~106@ d13~112@ tmp%15@) (=> %%location_label%%13 (= temp_13_0~2415@ temp_13_1~2488@)))) (=> (= temp_13_0~2415@ temp_13_1~2488@) (=> (= temp_14_0~2587@ (Mul (Add (Mul (Mul a14~114@ a14~114@) (Sub b14~116@ a14~114@)) (Mul (Mul b14~116@ a14~114@) (Mul c14~118@ b14~116@))) (Mul (Mul (Mul a14~114@ a14~114@) (Add b14~116@ d14~120@)) (Mul (Mul b14~116@ a14~114@) (Mul a14~114@ a14~114@))))) (=> (= temp_14_1~2652@ (Mul (Add (Mul (Mul a14~114@ a14~114@) (Sub b14~116@ a14~114@)) (Mul (Mul a14~114@ b14~116@) (Mul c14~118@ b14~116@))) (Mul (Mul (Mul a14~114@ a14~114@) (Add b14~116@ d14~120@)) (Mul (Mul b14~116@ a14~114@) (Mul a14~114@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b14~116@ a14~114@) (=> %%location_label%%14 (= temp_14_0~2587@ temp_14_1~2652@))) (=> (= temp_14_0~2587@ temp_14_1~2652@) (=> (= temp_15_0~2745@ (Sub (Mul (Mul (Mul c15~126@ a15~122@) (Mul c15~126@ b15~124@)) (Mul (Mul b15~124@ a15~122@) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ a15~122@)) (Mul (Mul b15~124@ a15~122@) (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~2810@ (Sub (Mul (Mul (Mul c15~126@ a15~122@) (Mul c15~126@ b15~124@)) (Mul (Mul b15~124@ a15~122@) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul b15~124@ a15~122@) (Mul a15~122@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ a15~122@))))) (and (=> (= tmp%16@ (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ a15~122@))) (=> (= tmp%17@ (Mul (Mul b15~124@ a15~122@) (Mul a15~122@ c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%15 (= temp_15_0~2745@ temp_15_1~2810@))))) (=> (= temp_15_0~2745@ temp_15_1~2810@) (=> (= temp_16_0~2911@ (Add (Mul (Mul (Add b16~132@ a16~130@) (Mul c16~134@ b16~132@)) c16~134@) (Sub (Mul a16~130@ (Mul c16~134@ d16~136@)) (Mul (Mul a16~130@ d16~136@) (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~2960@ (Add (Mul (Mul (Add b16~132@ a16~130@) (Mul c16~134@ b16~132@)) c16~134@) (Sub (Mul (Mul a16~130@ c16~134@) d16~136@) (Mul (Mul a16~130@ d16~136@) (Mul a16~130@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a16~130@ c16~134@ d16~136@) (=> %%location_label%%16 (= temp_16_0~2911@ temp_16_1~2960@))) (=> (= temp_16_0~2911@ temp_16_1~2960@) (=> (= temp_17_0~3051@ (Mul (Sub (Add (Sub d17~144@ b17~140@) (Sub d17~144@ b17~140@)) (Add (Mul b17~140@ d17~144@) (Mul c17~142@ b17~140@))) (Mul (Mul c17~142@ (Mul a17~138@ a17~138@)) (Mul (Mul d17~144@ c17~142@) (Add d17~144@ b17~140@))))) (=> (= temp_17_1~3112@ (Mul (Sub (Add (Sub d17~144@ b17~140@) (Sub d17~144@ b17~140@)) (Add (Mul b17~140@ d17~144@) (Mul b17~140@ c17~142@))) (Mul (Mul c17~142@ (Mul a17~138@ a17~138@)) (Mul (Mul d17~144@ c17~142@) (Add d17~144@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c17~142@ b17~140@) (=> %%location_label%%17 (= temp_17_0~3051@ temp_17_1~3112@))) (=> (= temp_17_0~3051@ temp_17_1~3112@) (=> (= temp_18_0~3217@ (Mul (Mul (Mul (Mul 76 c18~150@) (Mul c18~150@ a18~146@)) (Mul (Mul b18~148@ d18~152@) (Mul a18~146@ c18~150@))) (Sub (Sub (Mul c18~150@ c18~150@) (Sub a18~146@ b18~148@)) (Add (Mul a18~146@ a18~146@) (Sub d18~152@ c18~150@))))) (=> (= temp_18_1~3294@ (Mul (Mul (Mul (Mul 76 c18~150@) (Mul c18~150@ a18~146@)) (Mul (Mul d18~152@ b18~148@) (Mul a18~146@ c18~150@))) (Sub (Sub (Mul c18~150@ c18~150@) (Sub a18~146@ b18~148@)) (Add (Mul a18~146@ a18~146@) (Sub d18~152@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b18~148@ d18~152@) (=> %%location_label%%18 (= temp_18_0~3217@ temp_18_1~3294@))) (=> (= temp_18_0~3217@ temp_18_1~3294@) (=> (= temp_19_0~3387@ (Add (Mul (Mul (Mul a19~154@ c19~158@) (Add d19~160@ c19~158@)) (Mul (Mul d19~160@ a19~154@) (Add c19~158@ c19~158@))) (Sub (Mul (Sub b19~156@ c19~158@) (Mul d19~160@ d19~160@)) (Mul (Mul c19~158@ a19~154@) (Mul d19~160@ b19~156@))))) (=> (= temp_19_1~3452@ (Add (Mul (Mul (Mul a19~154@ c19~158@) (Add d19~160@ c19~158@)) (Mul (Mul d19~160@ a19~154@) (Add c19~158@ c19~158@))) (Sub (Mul (Sub b19~156@ c19~158@) (Mul d19~160@ d19~160@)) (Mul c19~158@ (Mul a19~154@ (Mul d19~160@ b19~156@)))))) (and (=> (= tmp%18@ (Mul d19~160@ b19~156@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c19~158@ a19~154@ tmp%18@) (=> %%location_label%%19 (= temp_19_0~3387@ temp_19_1~3452@)))) (=> (= temp_19_0~3387@ temp_19_1~3452@) (=> (= temp_20_0~3539@ (Mul (Mul (Mul (Mul b20~164@ d20~168@) (Mul d20~168@ a20~162@)) (Mul (Add d20~168@ b20~164@) (Mul a20~162@ d20~168@))) (Mul (Sub (Mul a20~162@ b20~164@) (Sub d20~168@ d20~168@)) a20~162@))) (=> (= temp_20_1~3592@ (Mul (Mul (Mul b20~164@ d20~168@) (Mul (Mul d20~168@ a20~162@) (Mul (Add d20~168@ b20~164@) (Mul a20~162@ d20~168@)))) (Mul (Sub (Mul a20~162@ b20~164@) (Sub d20~168@ d20~168@)) a20~162@))) (and (=> (= tmp%19@ (Mul b20~164@ d20~168@)) (=> (= tmp%20@ (Mul d20~168@ a20~162@)) (=> (= tmp%21@ (Mul (Add d20~168@ b20~164@) (Mul a20~162@ d20~168@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%20 (= temp_20_0~3539@ temp_20_1~3592@)))))) (=> (= temp_20_0~3539@ temp_20_1~3592@) (=> (= temp_21_0~3691@ (Add (Mul (Mul (Mul b21~172@ b21~172@) (Mul a21~170@ b21~172@)) (Mul (Mul a21~170@ b21~172@) (Mul a21~170@ b21~172@))) (Mul a21~170@ (Mul c21~174@ (Sub c21~174@ a21~170@))))) (=> (= temp_21_1~3740@ (Add (Mul (Mul (Mul b21~172@ b21~172@) (Mul a21~170@ b21~172@)) (Mul (Mul a21~170@ b21~172@) (Mul b21~172@ a21~170@))) (Mul a21~170@ (Mul c21~174@ (Sub c21~174@ a21~170@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a21~170@ b21~172@) (=> %%location_label%%21 (= temp_21_0~3691@ temp_21_1~3740@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
