...
(set-info :comment ";; mariposa_data/v_nl//2428745912322874132/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_8_0~1729@ Int)
(declare-const temp_8_1~1794@ Int)
(declare-const temp_9_0~1883@ Int)
(declare-const temp_9_1~1944@ Int)
(declare-const temp_10_0~2055@ Int)
(declare-const temp_10_1~2120@ Int)
(declare-const temp_11_0~2269@ Int)
(declare-const temp_11_1~2334@ Int)
(declare-const temp_12_0~2447@ Int)
(declare-const temp_12_1~2524@ Int)
(declare-const temp_13_0~2631@ Int)
(declare-const temp_13_1~2704@ Int)
(declare-const temp_14_0~2801@ Int)
(declare-const temp_14_1~2862@ Int)
(declare-const temp_15_0~2975@ Int)
(declare-const temp_15_1~3052@ Int)
(declare-const temp_16_0~3213@ Int)
(declare-const temp_16_1~3278@ Int)
(declare-const temp_17_0~3385@ Int)
(declare-const temp_17_1~3458@ Int)
(declare-const temp_18_0~3547@ Int)
(declare-const temp_18_1~3608@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Sub (Mul d0~8@ d0~8@) (Add b0~4@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Sub (Mul d0~8@ d0~8@) (Add b0~4@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul a0~2@ (Mul b0~4@ (Mul c0~6@ a0~2@)))))) (and (=> (= tmp%1@ (Mul c0~6@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a0~2@ b0~4@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~481@ (Add (Mul (Mul (Mul a1~10@ 23) (Mul c1~14@ d1~16@)) (Mul (Sub a1~10@ c1~14@) (Mul b1~12@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Add a1~10@ b1~12@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~558@ (Add (Mul (Mul (Mul 23 a1~10@) (Mul c1~14@ d1~16@)) (Mul (Sub a1~10@ c1~14@) (Mul b1~12@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Add a1~10@ b1~12@) (Mul d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ 23) (=> %%location_label%%1 (= temp_1_0~481@ temp_1_1~558@))) (=> (= temp_1_0~481@ temp_1_1~558@) (=> (= temp_2_0~647@ (Add (Mul (Mul (Sub d2~24@ d2~24@) (Sub c2~22@ d2~24@)) (Mul (Add b2~20@ a2~18@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul d2~24@ c2~22@) c2~22@) d2~24@))) (=> (= temp_2_1~696@ (Add (Mul (Mul (Sub d2~24@ d2~24@) (Sub c2~22@ d2~24@)) (Mul (Add b2~20@ a2~18@) (Mul c2~22@ d2~24@))) (Mul (Mul c2~22@ (Mul d2~24@ c2~22@)) d2~24@))) (and (=> (= tmp%2@ (Mul d2~24@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ c2~22@) (=> %%location_label%%2 (= temp_2_0~647@ temp_2_1~696@)))) (=> (= temp_2_0~647@ temp_2_1~696@) (=> (= temp_3_0~793@ (Add (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul (Add a3~26@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~858@ (Add (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul (Add a3~26@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ d3~32@))))) (and (=> (= tmp%3@ (Mul b3~28@ d3~32@)) (=> (= tmp%4@ (Mul b3~28@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~793@ temp_3_1~858@))))) (=> (= temp_3_0~793@ temp_3_1~858@) (=> (= temp_4_0~955@ (Add (Mul (Sub a4~34@ (Mul b4~36@ b4~36@)) c4~38@) (Mul (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ 45))))) (=> (= temp_4_1~1016@ (Add (Mul (Sub a4~34@ (Mul b4~36@ b4~36@)) c4~38@) (Mul (Sub (Mul b4~36@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ 45))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ d4~40@) (=> %%location_label%%4 (= temp_4_0~955@ temp_4_1~1016@))) (=> (= temp_4_0~955@ temp_4_1~1016@) (=> (= temp_5_0~1121@ (Mul (Mul (Mul (Add b5~44@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ b5~44@)) (Sub (Mul 56 a5~42@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1198@ (Mul (Mul (Mul (Add b5~44@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul c5~46@ (Mul c5~46@ (Mul c5~46@ b5~44@))) (Sub (Mul 56 a5~42@) (Mul a5~42@ d5~48@))))) (and (=> (= tmp%5@ (Mul c5~46@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c5~46@ c5~46@ tmp%5@) (=> %%location_label%%5 (= temp_5_0~1121@ temp_5_1~1198@)))) (=> (= temp_5_0~1121@ temp_5_1~1198@) (=> (= temp_6_0~1297@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Add (Sub a6~50@ a6~50@) (Mul c6~54@ c6~54@))) (Sub (Mul (Add a6~50@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1394@ (Sub (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Add (Sub a6~50@ a6~50@) (Mul c6~54@ c6~54@))) (Mul (Add a6~50@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Add (Sub a6~50@ a6~50@) (Mul c6~54@ c6~54@))) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (and (=> (= tmp%6@ (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Add (Sub a6~50@ a6~50@) (Mul c6~54@ c6~54@)))) (=> (= tmp%7@ (Mul (Add a6~50@ d6~56@) (Mul d6~56@ b6~52@))) (=> (= tmp%8@ (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~1297@ temp_6_1~1394@)))))) (=> (= temp_6_0~1297@ temp_6_1~1394@) (=> (= temp_7_0~1537@ (Mul (Mul (Sub (Add b7~60@ b7~60@) (Sub a7~58@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@)) (Add (Mul c7~62@ d7~64@) a7~58@)))) (=> (= temp_7_1~1614@ (Mul (Sub (Mul (Add b7~60@ b7~60@) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ b7~60@))) (Mul (Sub a7~58@ b7~60@) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ b7~60@)))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@)) (Add (Mul c7~62@ d7~64@) a7~58@)))) (and (=> (= tmp%9@ (Add b7~60@ b7~60@)) (=> (= tmp%10@ (Sub a7~58@ b7~60@)) (=> (= tmp%11@ (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ b7~60@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%7 (= temp_7_0~1537@ temp_7_1~1614@)))))) (=> (= temp_7_0~1537@ temp_7_1~1614@) (=> (= temp_8_0~1729@ (Add (Mul (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ b8~68@)) (Sub (Sub d8~72@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul 12 a8~66@) (Mul d8~72@ b8~68@)) a8~66@))) (=> (= temp_8_1~1794@ (Add (Mul (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ c8~70@)) (Sub (Sub d8~72@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul 12 a8~66@) (Mul d8~72@ b8~68@)) a8~66@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1729@ temp_8_1~1794@))) (=> (= temp_8_0~1729@ temp_8_1~1794@) (=> (= temp_9_0~1883@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ c9~78@)) (Mul a9~74@ (Mul a9~74@ b9~76@))) (Mul (Mul (Mul c9~78@ c9~78@) (Add b9~76@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1944@ (Mul (Mul (Mul b9~76@ a9~74@) (Mul (Mul d9~80@ c9~78@) (Mul a9~74@ (Mul a9~74@ b9~76@)))) (Mul (Mul (Mul c9~78@ c9~78@) (Add b9~76@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ a9~74@))))) (and (=> (= tmp%12@ (Mul b9~76@ a9~74@)) (=> (= tmp%13@ (Mul d9~80@ c9~78@)) (=> (= tmp%14@ (Mul a9~74@ (Mul a9~74@ b9~76@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%9 (= temp_9_0~1883@ temp_9_1~1944@)))))) (=> (= temp_9_0~1883@ temp_9_1~1944@) (=> (= temp_10_0~2055@ (Mul (Mul (Mul (Add d10~88@ c10~86@) (Mul a10~82@ a10~82@)) (Mul (Mul d10~88@ d10~88@) (Add d10~88@ d10~88@))) (Mul (Sub (Mul a10~82@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~2120@ (Mul (Mul (Sub (Mul a10~82@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ d10~88@))) (Mul (Mul (Add d10~88@ c10~86@) (Mul a10~82@ a10~82@)) (Mul (Mul d10~88@ d10~88@) (Add d10~88@ d10~88@))))) (and (=> (= tmp%15@ (Mul (Mul (Add d10~88@ c10~86@) (Mul a10~82@ a10~82@)) (Mul (Mul d10~88@ d10~88@) (Add d10~88@ d10~88@)))) (=> (= tmp%16@ (Mul (Sub (Mul a10~82@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ d10~88@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%10 (= temp_10_0~2055@ temp_10_1~2120@))))) (=> (= temp_10_0~2055@ temp_10_1~2120@) (=> (= temp_11_0~2269@ (Mul (Mul (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ b11~92@)) (Add (Mul d11~96@ c11~94@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul a11~90@ b11~92@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Sub c11~94@ c11~94@))))) (=> (= temp_11_1~2334@ (Mul (Mul (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ a11~90@)) (Add (Mul d11~96@ c11~94@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul a11~90@ b11~92@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Sub c11~94@ c11~94@))))) (and (=> (= tmp%17@ (Mul c11~94@ a11~90@)) (=> (= tmp%18@ (Mul a11~90@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%11 (= temp_11_0~2269@ temp_11_1~2334@))))) (=> (= temp_11_0~2269@ temp_11_1~2334@) (=> (= temp_12_0~2447@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Mul a12~98@ a12~98@)) (Mul (Add d12~104@ d12~104@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul b12~100@ 66) (Mul d12~104@ c12~102@))))) (=> (= temp_12_1~2524@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Mul a12~98@ a12~98@)) (Mul (Add d12~104@ d12~104@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul (Mul b12~100@ d12~104@) b12~100@) b12~100@) (Mul (Mul b12~100@ 66) (Mul d12~104@ c12~102@))))) (and (=> (= tmp%19@ (Mul b12~100@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ b12~100@ b12~100@) (=> %%location_label%%12 (= temp_12_0~2447@ temp_12_1~2524@)))) (=> (= temp_12_0~2447@ temp_12_1~2524@) (=> (= temp_13_0~2631@ (Mul (Mul (Add (Mul a13~106@ 39) (Mul b13~108@ a13~106@)) (Add (Mul a13~106@ d13~112@) (Mul a13~106@ a13~106@))) (Mul (Mul a13~106@ (Mul a13~106@ d13~112@)) (Mul (Sub c13~110@ b13~108@) (Mul d13~112@ d13~112@))))) (=> (= temp_13_1~2704@ (Mul (Mul (Add (Mul a13~106@ 39) (Mul b13~108@ a13~106@)) (Add (Mul a13~106@ d13~112@) (Mul a13~106@ a13~106@))) (Mul (Mul a13~106@ (Mul a13~106@ d13~112@)) (Mul (Mul d13~112@ d13~112@) (Sub c13~110@ b13~108@))))) (and (=> (= tmp%20@ (Sub c13~110@ b13~108@)) (=> (= tmp%21@ (Mul d13~112@ d13~112@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%13 (= temp_13_0~2631@ temp_13_1~2704@))))) (=> (= temp_13_0~2631@ temp_13_1~2704@) (=> (= temp_14_0~2801@ (Sub (Mul (Mul (Add d14~120@ c14~118@) (Mul a14~114@ d14~120@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@))) (Sub (Mul (Mul b14~116@ b14~116@) (Mul c14~118@ d14~120@)) (Mul (Mul c14~118@ a14~114@) b14~116@)))) (=> (= temp_14_1~2862@ (Sub (Mul (Mul (Add d14~120@ c14~118@) (Mul a14~114@ d14~120@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@))) (Sub (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ b14~116@)) (Mul (Mul c14~118@ a14~114@) b14~116@)))) (and (=> (= tmp%22@ (Mul b14~116@ b14~116@)) (=> (= tmp%23@ (Mul c14~118@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%14 (= temp_14_0~2801@ temp_14_1~2862@))))) (=> (= temp_14_0~2801@ temp_14_1~2862@) (=> (= temp_15_0~2975@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Add b15~124@ 72))) (Add a15~122@ (Mul (Mul 91 a15~122@) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~3052@ (Mul (Add a15~122@ (Mul (Mul 91 a15~122@) (Mul a15~122@ d15~128@))) (Mul (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Add b15~124@ 72))))) (and (=> (= tmp%24@ (Mul (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Add b15~124@ 72)))) (=> (= tmp%25@ (Add a15~122@ (Mul (Mul 91 a15~122@) (Mul a15~122@ d15~128@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%24@ tmp%25@) (=> %%location_label%%15 (= temp_15_0~2975@ temp_15_1~3052@))))) (=> (= temp_15_0~2975@ temp_15_1~3052@) (=> (= temp_16_0~3213@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Add a16~130@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Sub b16~132@ a16~130@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~3278@ (Mul (Mul (Mul d16~136@ (Mul b16~132@ (Add a16~130@ d16~136@))) (Mul (Mul d16~136@ d16~136@) (Sub b16~132@ a16~130@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul b16~132@ a16~130@))))) (and (=> (= tmp%26@ (Add a16~130@ d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d16~136@ b16~132@ tmp%26@) (=> %%location_label%%16 (= temp_16_0~3213@ temp_16_1~3278@)))) (=> (= temp_16_0~3213@ temp_16_1~3278@) (=> (= temp_17_0~3385@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)) (Mul 56 (Mul a17~138@ d17~144@))) (Mul (Mul (Mul d17~144@ d17~144@) (Add b17~140@ d17~144@)) (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~3458@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)) (Mul 56 (Mul a17~138@ d17~144@))) (Mul (Mul (Mul d17~144@ d17~144@) (Add b17~140@ d17~144@)) (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d17~144@ d17~144@) (=> %%location_label%%17 (= temp_17_0~3385@ temp_17_1~3458@))) (=> (= temp_17_0~3385@ temp_17_1~3458@) (=> (= temp_18_0~3547@ (Mul (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ c18~150@)) (Mul (Sub c18~150@ d18~152@) d18~152@)) (Mul (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Sub b18~148@ a18~146@) (Sub b18~148@ c18~150@))))) (=> (= temp_18_1~3608@ (Mul (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ c18~150@)) (Mul (Sub c18~150@ d18~152@) d18~152@)) (Mul (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Sub b18~148@ c18~150@) (Sub b18~148@ a18~146@))))) (=> (= tmp%27@ (Sub b18~148@ a18~146@)) (=> (= tmp%28@ (Sub b18~148@ c18~150@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%18 (= temp_18_0~3547@ temp_18_1~3608@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
