...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Sub (Mul d0~8@ d0~8@) (Add b0~4@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Sub (Mul d0~8@ d0~8@) (Add b0~4@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul a0~2@ (Mul b0~4@ (Mul c0~6@ a0~2@)))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~462@ (Add (Mul (Mul (Mul a1~10@ 23) (Mul c1~14@ d1~16@)) (Mul (Sub a1~10@ c1~14@) (Mul b1~12@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Add a1~10@ b1~12@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~539@ (Add (Mul (Mul (Mul 23 a1~10@) (Mul c1~14@ d1~16@)) (Mul (Sub a1~10@ c1~14@) (Mul b1~12@ c1~14@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Add a1~10@ b1~12@) (Mul d1~16@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~462@ temp_1_1~539@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~603@ (Add (Mul (Mul (Sub d2~24@ d2~24@) (Sub c2~22@ d2~24@)) (Mul (Add b2~20@ a2~18@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul d2~24@ c2~22@) c2~22@) d2~24@))) (=> (= temp_2_1~652@ (Add (Mul (Mul (Sub d2~24@ d2~24@) (Sub c2~22@ d2~24@)) (Mul (Add b2~20@ a2~18@) (Mul c2~22@ d2~24@))) (Mul (Mul c2~22@ (Mul d2~24@ c2~22@)) d2~24@))) (=> (= tmp%3@ (= temp_2_0~603@ temp_2_1~652@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~732@ (Add (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul (Add a3~26@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~797@ (Add (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul (Add a3~26@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~732@ temp_3_1~797@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~873@ (Add (Mul (Sub a4~34@ (Mul b4~36@ b4~36@)) c4~38@) (Mul (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ 45))))) (=> (= temp_4_1~934@ (Add (Mul (Sub a4~34@ (Mul b4~36@ b4~36@)) c4~38@) (Mul (Sub (Mul b4~36@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ 45))))) (=> (= tmp%5@ (= temp_4_0~873@ temp_4_1~934@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1026@ (Mul (Mul (Mul (Add b5~44@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ b5~44@)) (Sub (Mul 56 a5~42@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1103@ (Mul (Mul (Mul (Add b5~44@ d5~48@) (Add c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul c5~46@ (Mul c5~46@ (Mul c5~46@ b5~44@))) (Sub (Mul 56 a5~42@) (Mul a5~42@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1026@ temp_5_1~1103@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1183@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Add (Sub a6~50@ a6~50@) (Mul c6~54@ c6~54@))) (Sub (Mul (Add a6~50@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1280@ (Sub (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Add (Sub a6~50@ a6~50@) (Mul c6~54@ c6~54@))) (Mul (Add a6~50@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Add (Sub a6~50@ a6~50@) (Mul c6~54@ c6~54@))) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~1183@ temp_6_1~1280@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1356@ (Mul (Mul (Sub (Add b7~60@ b7~60@) (Sub a7~58@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@)) (Add (Mul c7~62@ d7~64@) a7~58@)))) (=> (= temp_7_1~1433@ (Mul (Sub (Mul (Add b7~60@ b7~60@) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ b7~60@))) (Mul (Sub a7~58@ b7~60@) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ b7~60@)))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@)) (Add (Mul c7~62@ d7~64@) a7~58@)))) (=> (= tmp%8@ (= temp_7_0~1356@ temp_7_1~1433@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1513@ (Add (Mul (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ b8~68@)) (Sub (Sub d8~72@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul 12 a8~66@) (Mul d8~72@ b8~68@)) a8~66@))) (=> (= temp_8_1~1578@ (Add (Mul (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ c8~70@)) (Sub (Sub d8~72@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul 12 a8~66@) (Mul d8~72@ b8~68@)) a8~66@))) (=> (= tmp%9@ (= temp_8_0~1513@ temp_8_1~1578@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1654@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ c9~78@)) (Mul a9~74@ (Mul a9~74@ b9~76@))) (Mul (Mul (Mul c9~78@ c9~78@) (Add b9~76@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1715@ (Mul (Mul (Mul b9~76@ a9~74@) (Mul (Mul d9~80@ c9~78@) (Mul a9~74@ (Mul a9~74@ b9~76@)))) (Mul (Mul (Mul c9~78@ c9~78@) (Add b9~76@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1654@ temp_9_1~1715@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1795@ (Mul (Mul (Mul (Add d10~88@ c10~86@) (Mul a10~82@ a10~82@)) (Mul (Mul d10~88@ d10~88@) (Add d10~88@ d10~88@))) (Mul (Sub (Mul a10~82@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~1860@ (Mul (Mul (Sub (Mul a10~82@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ d10~88@))) (Mul (Mul (Add d10~88@ c10~86@) (Mul a10~82@ a10~82@)) (Mul (Mul d10~88@ d10~88@) (Add d10~88@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1795@ temp_10_1~1860@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1940@ (Mul (Mul (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ b11~92@)) (Add (Mul d11~96@ c11~94@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul a11~90@ b11~92@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Sub c11~94@ c11~94@))))) (=> (= temp_11_1~2005@ (Mul (Mul (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ a11~90@)) (Add (Mul d11~96@ c11~94@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul a11~90@ b11~92@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Sub c11~94@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1940@ temp_11_1~2005@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2097@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Mul a12~98@ a12~98@)) (Mul (Add d12~104@ d12~104@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul b12~100@ 66) (Mul d12~104@ c12~102@))))) (=> (= temp_12_1~2174@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Mul a12~98@ a12~98@)) (Mul (Add d12~104@ d12~104@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul (Mul b12~100@ d12~104@) b12~100@) b12~100@) (Mul (Mul b12~100@ 66) (Mul d12~104@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~2097@ temp_12_1~2174@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2262@ (Mul (Mul (Add (Mul a13~106@ 39) (Mul b13~108@ a13~106@)) (Add (Mul a13~106@ d13~112@) (Mul a13~106@ a13~106@))) (Mul (Mul a13~106@ (Mul a13~106@ d13~112@)) (Mul (Sub c13~110@ b13~108@) (Mul d13~112@ d13~112@))))) (=> (= temp_13_1~2335@ (Mul (Mul (Add (Mul a13~106@ 39) (Mul b13~108@ a13~106@)) (Add (Mul a13~106@ d13~112@) (Mul a13~106@ a13~106@))) (Mul (Mul a13~106@ (Mul a13~106@ d13~112@)) (Mul (Mul d13~112@ d13~112@) (Sub c13~110@ b13~108@))))) (=> (= tmp%14@ (= temp_13_0~2262@ temp_13_1~2335@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2411@ (Sub (Mul (Mul (Add d14~120@ c14~118@) (Mul a14~114@ d14~120@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@))) (Sub (Mul (Mul b14~116@ b14~116@) (Mul c14~118@ d14~120@)) (Mul (Mul c14~118@ a14~114@) b14~116@)))) (=> (= temp_14_1~2472@ (Sub (Mul (Mul (Add d14~120@ c14~118@) (Mul a14~114@ d14~120@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@))) (Sub (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ b14~116@)) (Mul (Mul c14~118@ a14~114@) b14~116@)))) (=> (= tmp%15@ (= temp_14_0~2411@ temp_14_1~2472@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2564@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Add b15~124@ 72))) (Add a15~122@ (Mul (Mul 91 a15~122@) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~2641@ (Mul (Add a15~122@ (Mul (Mul 91 a15~122@) (Mul a15~122@ d15~128@))) (Mul (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ b15~124@)) (Mul (Mul c15~126@ b15~124@) (Add b15~124@ 72))))) (=> (= tmp%16@ (= temp_15_0~2564@ temp_15_1~2641@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2721@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Add a16~130@ d16~136@)) (Mul (Mul d16~136@ d16~136@) (Sub b16~132@ a16~130@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~2786@ (Mul (Mul (Mul d16~136@ (Mul b16~132@ (Add a16~130@ d16~136@))) (Mul (Mul d16~136@ d16~136@) (Sub b16~132@ a16~130@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul b16~132@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2721@ temp_16_1~2786@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2874@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)) (Mul 56 (Mul a17~138@ d17~144@))) (Mul (Mul (Mul d17~144@ d17~144@) (Add b17~140@ d17~144@)) (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~2947@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)) (Mul 56 (Mul a17~138@ d17~144@))) (Mul (Mul (Mul d17~144@ d17~144@) (Add b17~140@ d17~144@)) (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ b17~140@))))) (=> (= tmp%18@ (= temp_17_0~2874@ temp_17_1~2947@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~3023@ (Mul (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ c18~150@)) (Mul (Sub c18~150@ d18~152@) d18~152@)) (Mul (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Sub b18~148@ a18~146@) (Sub b18~148@ c18~150@))))) (=> (= temp_18_1~3084@ (Mul (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ c18~150@)) (Mul (Sub c18~150@ d18~152@) d18~152@)) (Mul (Sub (Mul a18~146@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Sub b18~148@ c18~150@) (Sub b18~148@ a18~146@))))) (=> (= tmp%19@ (= temp_18_0~3023@ temp_18_1~3084@)) (=> %%location_label%%18 tmp%19@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
