...
;; mariposa_data/v_nl//2441780815452041506/nlqi_verus/src/main.rs:7:1: 26:40 (#0)
(push)
 ...
 (declare-const temp_0_1~446@ Int)
 (declare-const temp_1_0~677@ Int)
 (declare-const temp_1_1~806@ Int)
 (declare-const temp_2_0~973@ Int)
 (declare-const temp_2_1~1106@ Int)
 (declare-const temp_3_0~1239@ Int)
 (declare-const temp_3_1~1344@ Int)
 (declare-const temp_4_0~1485@ Int)
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~281@ (Mul (Mul (Mul (Mul (Sub a0~2@ a0~2@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@
           b0~4@
          ) (Mul d0~8@ b0~4@)
         )
        ) d0~8@
       ) (Mul (Mul (Add (Mul d0~8@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul 91 d0~8@) (Mul d0~8@
           a0~2@
         ))
        ) (Sub (Mul d0~8@ (Mul b0~4@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul 19 c0~6@)))
     )))
     (=>
      (= temp_0_1~446@ (Mul (Mul (Mul (Mul (Sub a0~2@ a0~2@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@
            b0~4@
           ) (Mul d0~8@ b0~4@)
          )
         ) d0~8@
        ) (Sub (Mul (Mul (Add (Mul d0~8@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul 91 d0~8@) (Mul d0~8@
             a0~2@
           ))
          ) (Mul d0~8@ (Mul b0~4@ c0~6@))
         ) (Mul (Mul (Add (Mul d0~8@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul 91 d0~8@) (Mul d0~8@
             a0~2@
           ))
          ) (Mul (Mul c0~6@ d0~8@) (Mul 19 c0~6@))
      ))))
      (and
       (=>
        (= tmp%1@ (Mul (Add (Mul d0~8@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul 91 d0~8@) (Mul d0~8@
            a0~2@
        ))))
        (=>
         (= tmp%2@ (Mul d0~8@ (Mul b0~4@ c0~6@)))
         (=>
          (= tmp%3@ (Mul (Mul c0~6@ d0~8@) (Mul 19 c0~6@)))
          (=>
           (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@)
           (=>
            %%location_label%%0
            (= temp_0_0~281@ temp_0_1~446@)
       )))))
       (=>
        (= temp_0_0~281@ temp_0_1~446@)
        (=>
         (= temp_1_0~677@ (Mul (Mul (Add (Mul (Mul d1~16@ a1~10@) 32) (Mul (Mul d1~16@ a1~10@)
              (Mul c1~14@ d1~16@)
             )
            ) (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)) (Mul d1~16@ (Mul b1~12@ c1~14@)))
           ) (Mul (Mul (Mul (Sub d1~16@ c1~14@) c1~14@) (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ c1~14@)))
            (Sub (Mul (Add d1~16@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Mul a1~10@
               b1~12@
         ))))))
         (=>
          (= temp_1_1~806@ (Mul (Mul (Add (Mul (Mul d1~16@ a1~10@) 32) (Mul (Mul d1~16@ a1~10@)
               (Mul c1~14@ d1~16@)
              )
             ) (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)) (Mul d1~16@ (Mul b1~12@ c1~14@)))
            ) (Mul (Mul (Mul (Sub d1~16@ c1~14@) c1~14@) (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ c1~14@)))
             (Sub (Mul (Add d1~16@ c1~14@) (Mul c1~14@ d1~16@)) (Mul a1~10@ (Mul b1~12@ (Mul a1~10@
                 b1~12@
          )))))))
          (and
           (=>
            (= tmp%4@ (Mul a1~10@ b1~12@))
            (=>
             (ens%main!nl_basics.lemma_mul_is_associative. a1~10@ b1~12@ tmp%4@)
             (=>
              %%location_label%%1
              (= temp_1_0~677@ temp_1_1~806@)
           )))
           (=>
            (= temp_1_0~677@ temp_1_1~806@)
            (=>
             (= temp_2_0~973@ (Mul (Mul (Add (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ c2~22@)) (Mul c2~22@
                  (Mul d2~24@ d2~24@)
                 )
                ) (Add (Mul (Mul c2~22@ 88) (Mul b2~20@ d2~24@)) (Mul (Add c2~22@ d2~24@) (Mul a2~18@
                   b2~20@
                )))
               ) (Sub (Mul (Mul (Mul d2~24@ a2~18@) (Add b2~20@ c2~22@)) (Mul c2~22@ (Mul a2~18@ c2~22@)))
                (Mul (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@
                   d2~24@
             ))))))
             (=>
              (= temp_2_1~1106@ (Mul (Mul (Add (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ c2~22@)) (Mul c2~22@
                   (Mul d2~24@ d2~24@)
                  )
                 ) (Add (Mul (Mul c2~22@ 88) (Mul b2~20@ d2~24@)) (Mul (Add c2~22@ d2~24@) (Mul a2~18@
                    b2~20@
                 )))
                ) (Sub (Mul (Mul (Mul a2~18@ d2~24@) (Add b2~20@ c2~22@)) (Mul c2~22@ (Mul a2~18@ c2~22@)))
                 (Mul (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@
                    d2~24@
              ))))))
              (and
               (=>
                (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ a2~18@)
                (=>
                 %%location_label%%2
                 (= temp_2_0~973@ temp_2_1~1106@)
               ))
               (=>
                (= temp_2_0~973@ temp_2_1~1106@)
                (=>
                 (= temp_3_0~1239@ (Mul (Mul a3~26@ (Mul (Add (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@))
                     (Mul (Mul a3~26@ 91) (Sub c3~30@ a3~26@))
                    )
                   ) (Mul (Mul (Add (Mul d3~32@ a3~26@) (Mul d3~32@ c3~30@)) (Add (Mul a3~26@ b3~28@) (
                       Mul c3~30@ d3~32@
                     ))
                    ) (Mul (Mul (Mul b3~28@ b3~28@) c3~30@) (Mul c3~30@ (Mul a3~26@ a3~26@)))
                 )))
                 (=>
                  (= temp_3_1~1344@ (Mul (Mul a3~26@ (Mul (Add (Mul d3~32@ c3~30@) (Mul d3~32@ b3~28@))
                      (Mul (Mul a3~26@ 91) (Sub c3~30@ a3~26@))
                     )
                    ) (Mul (Mul (Add (Mul d3~32@ a3~26@) (Mul d3~32@ c3~30@)) (Add (Mul a3~26@ b3~28@) (
                        Mul c3~30@ d3~32@
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~1239@ temp_3_1~1344@)
                   ))
                   (=>
                    (= temp_3_0~1239@ temp_3_1~1344@)
                    (=>
                     (= temp_4_0~1485@ (Sub (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ a4~34@)) (Mul (Mul
                           a4~34@ a4~34@
                          ) (Mul c4~38@ d4~40@)
                         )
                        ) (Mul (Sub (Mul d4~40@ c4~38@) d4~40@) (Add (Add b4~36@ d4~40@) (Add d4~40@ a4~34@)))
                       ) (Mul (Add (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ b4~36@)) (Mul (Mul a4~34@ b4~36@) (
                           Mul a4~34@ c4~38@
                         ))
                        ) (Mul a4~34@ (Mul (Mul a4~34@ a4~34@) (Add c4~38@ b4~36@)))
                     )))
                     (=>
                      (= temp_4_1~1598@ (Sub (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ a4~34@)) (Mul (Mul
                            a4~34@ a4~34@
                           ) (Mul d4~40@ c4~38@)
                          )
                         ) (Mul (Sub (Mul d4~40@ c4~38@) d4~40@) (Add (Add b4~36@ d4~40@) (Add d4~40@ a4~34@)))
                      ...
                      (and
                       (=>
                        (ens%main!nl_basics.lemma_mul_is_commutative. c4~38@ d4~40@)
                        (=>
                         %%location_label%%4
                         (= temp_4_0~1485@ temp_4_1~1598@)
                       ))
                       (=>
                        (= temp_4_0~1485@ temp_4_1~1598@)
                        (=>
                         (= temp_5_0~1747@ (Mul (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Add (Mul
                               c5~46@ c5~46@
                              ) (Mul a5~42@ b5~44@)
                             )
                            ) (Mul (Mul (Mul a5~42@ a5~42@) a5~42@) (Mul (Add c5~46@ a5~42@) (Mul d5~48@ c5~46@)))
                           ) (Add (Mul (Mul (Add c5~46@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (
                               Sub b5~44@ d5~48@
                             ))
                            ) (Mul (Mul (Mul b5~44@ b5~44@) c5~46@) (Mul (Mul c5~46@ a5~42@) (Sub c5~46@ d5~48@)))
                         )))
                         (=>
                          (= temp_5_1~1868@ (Mul (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Add (Mul
                                c5~46@ c5~46@
                               ) (Mul a5~42@ b5~44@)
                              )
                             ) (Mul (Mul (Mul a5~42@ a5~42@) a5~42@) (Mul (Add c5~46@ a5~42@) (Mul d5~48@ c5~46@)))
                             ...
                             ) (Mul (Mul (Mul b5~44@ b5~44@) c5~46@) (Mul c5~46@ (Mul a5~42@ (Sub c5~46@ d5~48@))))
                          )))
                          (=>
                           (= tmp%5@ (Sub c5~46@ d5~48@))
                           (=>
                            (ens%main!nl_basics.lemma_mul_is_associative. c5~46@ a5~42@ tmp%5@)
                            (=>
                             %%location_label%%5
