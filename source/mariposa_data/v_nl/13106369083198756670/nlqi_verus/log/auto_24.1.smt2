...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Sub c0~6@ a0~2@))) (Mul a0~2@ (Mul (Mul d0~8@ b0~4@) (Add c0~6@ a0~2@))))) (=> (= temp_0_1~346@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Sub c0~6@ a0~2@))) (Mul a0~2@ (Mul (Mul d0~8@ b0~4@) (Add c0~6@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~427@ (Mul (Add (Mul a1~10@ (Mul d1~16@ b1~12@)) (Mul (Sub b1~12@ c1~14@) (Mul b1~12@ d1~16@))) (Sub (Mul (Add d1~16@ b1~12@) b1~12@) (Add (Mul c1~14@ b1~12@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~484@ (Mul (Sub (Mul (Add d1~16@ b1~12@) b1~12@) (Add (Mul c1~14@ b1~12@) (Mul d1~16@ d1~16@))) (Add (Mul a1~10@ (Mul d1~16@ b1~12@)) (Mul (Sub b1~12@ c1~14@) (Mul b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~427@ temp_1_1~484@))) (=> (= temp_1_0~427@ temp_1_1~484@) (=> (= temp_2_0~573@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul c2~22@ b2~20@) (Add d2~24@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ d2~24@))))) (=> (= temp_2_1~638@ (Mul (Mul (Mul (Mul (Mul c2~22@ b2~20@) a2~18@) a2~18@) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul c2~22@ b2~20@) (Add d2~24@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~573@ temp_2_1~638@))) (=> (= temp_2_0~573@ temp_2_1~638@) (=> (= temp_3_0~739@ (Add (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ b3~28@)) (Add (Mul d3~32@ d3~32@) (Mul 99 c3~30@))) (Add (Add (Mul b3~28@ c3~30@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~816@ (Add (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ b3~28@)) (Add (Mul d3~32@ d3~32@) (Mul 99 c3~30@))) (Add (Add (Mul b3~28@ c3~30@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~739@ temp_3_1~816@))) (=> (= temp_3_0~739@ temp_3_1~816@) (=> (= temp_4_0~905@ (Mul (Mul (Sub (Mul d4~40@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ c4~38@))) (Add (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Sub b4~36@ c4~38@) (Sub c4~38@ a4~34@))))) (=> (= temp_4_1~970@ (Mul (Mul (Sub (Mul d4~40@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ a4~34@))) (Add (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Sub b4~36@ c4~38@) (Sub c4~38@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~905@ temp_4_1~970@))) (=> (= temp_4_0~905@ temp_4_1~970@) (=> (= temp_5_0~1031@ (Mul (Mul (Add (Mul b5~44@ c5~46@) (Mul c5~46@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Sub c5~46@ c5~46@))) a5~42@)) (=> (= temp_5_1~1068@ (Mul (Mul (Add (Mul b5~44@ c5~46@) (Mul c5~46@ a5~42@)) (Mul c5~46@ (Mul c5~46@ (Sub c5~46@ c5~46@)))) a5~42@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1031@ temp_5_1~1068@))) (=> (= temp_5_0~1031@ temp_5_1~1068@) (=> (= temp_6_0~1153@ (Mul (Add (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ d6~56@)) (Mul (Mul a6~50@ a6~50@) b6~52@)) (Mul (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ b6~52@)) (Sub (Mul c6~54@ d6~56@) (Mul c6~54@ a6~50@))))) (=> (= temp_6_1~1214@ (Mul (Add (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ d6~56@)) (Mul b6~52@ (Mul a6~50@ a6~50@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ b6~52@)) (Sub (Mul c6~54@ d6~56@) (Mul c6~54@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1153@ temp_6_1~1214@))) (=> (= temp_6_0~1153@ temp_6_1~1214@) (=> (= temp_7_0~1327@ (Mul (Mul (Add (Sub 80 c7~62@) (Mul c7~62@ d7~64@)) (Add (Mul d7~64@ b7~60@) (Mul c7~62@ a7~58@))) (Mul (Sub (Mul d7~64@ d7~64@) (Mul b7~60@ d7~64@)) (Mul (Mul 41 b7~60@) (Sub a7~58@ d7~64@))))) (=> (= temp_7_1~1416@ (Mul (Mul (Add (Sub 80 c7~62@) (Mul c7~62@ d7~64@)) (Add (Mul d7~64@ b7~60@) (Mul c7~62@ a7~58@))) (Mul (Mul (Sub (Mul d7~64@ d7~64@) (Mul b7~60@ d7~64@)) (Mul 41 b7~60@)) (Sub a7~58@ d7~64@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1327@ temp_7_1~1416@))) (=> (= temp_7_0~1327@ temp_7_1~1416@) (=> (= temp_8_0~1501@ (Add (Mul (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ b8~68@)) (Mul (Add d8~72@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Sub (Mul a8~66@ d8~72@) (Mul a8~66@ a8~66@)) (Mul d8~72@ (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1562@ (Add (Mul (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ b8~68@)) (Mul (Add d8~72@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Sub (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@)) (Mul d8~72@ (Mul a8~66@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1501@ temp_8_1~1562@))) (=> (= temp_8_0~1501@ temp_8_1~1562@) (=> (= temp_9_0~1639@ (Sub (Mul (Sub (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@)) b9~76@) (Mul (Add (Mul a9~74@ b9~76@) (Add c9~78@ b9~76@)) (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ b9~76@))))) (=> (= temp_9_1~1696@ (Sub (Sub (Mul (Mul a9~74@ c9~78@) b9~76@) (Mul (Mul c9~78@ b9~76@) b9~76@)) (Mul (Add (Mul a9~74@ b9~76@) (Add c9~78@ b9~76@)) (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1639@ temp_9_1~1696@))) (=> (= temp_9_0~1639@ temp_9_1~1696@) (=> (= temp_10_0~1781@ (Mul (Mul (Mul (Add c10~86@ b10~84@) b10~84@) (Add (Add a10~82@ d10~88@) (Mul a10~82@ c10~86@))) (Mul (Mul (Sub d10~88@ a10~82@) (Mul b10~84@ b10~84@)) (Mul (Mul b10~84@ b10~84@) (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~1842@ (Mul (Mul (Mul (Add c10~86@ b10~84@) b10~84@) (Add (Add a10~82@ d10~88@) (Mul a10~82@ c10~86@))) (Mul (Mul (Mul b10~84@ b10~84@) (Sub d10~88@ a10~82@)) (Mul (Mul b10~84@ b10~84@) (Mul a10~82@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1781@ temp_10_1~1842@))) (=> (= temp_10_0~1781@ temp_10_1~1842@) (=> (= temp_11_0~1931@ (Mul (Mul (Add (Mul b11~92@ d11~96@) (Add a11~90@ d11~96@)) (Sub (Add c11~94@ d11~96@) (Mul b11~92@ b11~92@))) (Mul (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ b11~92@)) (Sub (Mul c11~94@ b11~92@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~1996@ (Mul (Mul (Add (Mul b11~92@ d11~96@) (Add a11~90@ d11~96@)) (Sub (Add c11~94@ d11~96@) (Mul b11~92@ b11~92@))) (Mul (Sub (Mul c11~94@ b11~92@) (Mul a11~90@ d11~96@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1931@ temp_11_1~1996@))) (=> (= temp_11_0~1931@ temp_11_1~1996@) (=> (= temp_12_0~2073@ (Mul (Add (Mul (Mul b12~100@ b12~100@) (Mul c12~102@ a12~98@)) (Mul (Mul d12~104@ b12~100@) (Add a12~98@ d12~104@))) (Add b12~100@ (Mul (Mul a12~98@ d12~104@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2126@ (Mul (Add (Mul (Mul b12~100@ b12~100@) (Mul c12~102@ a12~98@)) (Mul (Add a12~98@ d12~104@) (Mul d12~104@ b12~100@))) (Add b12~100@ (Mul (Mul a12~98@ d12~104@) (Mul d12~104@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2073@ temp_12_1~2126@))) (=> (= temp_12_0~2073@ temp_12_1~2126@) (=> (= temp_13_0~2215@ (Mul (Mul (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ b13~108@)) (Mul (Sub a13~106@ a13~106@) (Add d13~112@ a13~106@))) (Add (Mul (Mul d13~112@ c13~110@) (Add a13~106@ a13~106@)) (Add (Add d13~112@ d13~112@) (Sub b13~108@ a13~106@))))) (=> (= temp_13_1~2280@ (Mul (Mul (Mul (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ b13~108@)) (Sub a13~106@ a13~106@)) (Add d13~112@ a13~106@)) (Add (Mul (Mul d13~112@ c13~110@) (Add a13~106@ a13~106@)) (Add (Add d13~112@ d13~112@) (Sub b13~108@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2215@ temp_13_1~2280@))) (=> (= temp_13_0~2215@ temp_13_1~2280@) (=> (= temp_14_0~2357@ (Mul (Mul (Mul (Mul b14~116@ c14~118@) (Sub b14~116@ c14~118@)) a14~114@) (Mul (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ b14~116@)) (Mul (Mul b14~116@ a14~114@) (Mul a14~114@ b14~116@))))) (=> (= temp_14_1~2418@ (Mul (Mul (Sub (Mul (Mul b14~116@ c14~118@) b14~116@) (Mul (Mul b14~116@ c14~118@) c14~118@)) a14~114@) (Mul (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ b14~116@)) (Mul (Mul b14~116@ a14~114@) (Mul a14~114@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2357@ temp_14_1~2418@))) (=> (= temp_14_0~2357@ temp_14_1~2418@) (=> (= temp_15_0~2507@ (Mul (Sub (Add (Add d15~128@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Mul d15~128@ a15~122@) (Mul a15~122@ b15~124@))) (Sub (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ c15~126@)) (Mul (Mul c15~126@ a15~122@) (Mul b15~124@ d15~128@))))) (=> (= temp_15_1~2572@ (Mul (Sub (Add (Add d15~128@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Mul d15~128@ a15~122@) (Mul a15~122@ b15~124@))) (Sub (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ c15~126@)) (Mul (Mul c15~126@ a15~122@) (Mul b15~124@ d15~128@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2507@ temp_15_1~2572@))) (=> (= temp_15_0~2507@ temp_15_1~2572@) (=> (= temp_16_0~2669@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul 26 b16~132@)) (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@))) (Add (Add a16~130@ (Mul d16~136@ b16~132@)) (Add (Mul a16~130@ c16~134@) (Add a16~130@ a16~130@))))) (=> (= temp_16_1~2742@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul 26 b16~132@)) (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@))) (Add (Add a16~130@ (Mul b16~132@ d16~136@)) (Add (Mul a16~130@ c16~134@) (Add a16~130@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2669@ temp_16_1~2742@))) (=> (= temp_16_0~2669@ temp_16_1~2742@) (=> (= temp_17_0~2827@ (Mul (Sub (Sub a17~138@ (Mul d17~144@ b17~140@)) (Mul (Sub b17~140@ d17~144@) (Add a17~138@ a17~138@))) (Mul (Mul (Mul d17~144@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ d17~144@))))) (=> (= temp_17_1~2888@ (Mul (Sub (Sub a17~138@ (Mul d17~144@ b17~140@)) (Mul (Sub b17~140@ d17~144@) (Add a17~138@ a17~138@))) (Mul (Mul (Mul d17~144@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Mul d17~144@ d17~144@) (Mul a17~138@ a17~138@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2827@ temp_17_1~2888@))) (=> (= temp_17_0~2827@ temp_17_1~2888@) (=> (= temp_18_0~2985@ (Sub (Mul (Mul (Add d18~152@ d18~152@) (Sub a18~146@ a18~146@)) (Sub (Sub c18~150@ a18~146@) (Mul d18~152@ c18~150@))) (Sub (Mul (Mul 4 b18~148@) (Add c18~150@ b18~148@)) (Sub (Mul a18~146@ b18~148@) b18~148@)))) (=> (= temp_18_1~3066@ (Sub (Mul (Add (Mul d18~152@ (Sub a18~146@ a18~146@)) (Mul d18~152@ (Sub a18~146@ a18~146@))) (Sub (Sub c18~150@ a18~146@) (Mul d18~152@ c18~150@))) (Sub (Mul (Mul 4 b18~148@) (Add c18~150@ b18~148@)) (Sub (Mul a18~146@ b18~148@) b18~148@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2985@ temp_18_1~3066@))) (=> (= temp_18_0~2985@ temp_18_1~3066@) (=> (= temp_19_0~3163@ (Mul (Mul (Mul (Mul c19~158@ 95) (Mul a19~154@ c19~158@)) (Mul a19~154@ (Mul d19~160@ b19~156@))) (Mul (Mul (Mul c19~158@ b19~156@) (Mul d19~160@ c19~158@)) (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ b19~156@))))) (=> (= temp_19_1~3236@ (Mul (Mul (Mul (Mul c19~158@ 95) (Mul a19~154@ c19~158@)) (Mul a19~154@ (Mul d19~160@ b19~156@))) (Mul (Mul (Mul b19~156@ c19~158@) (Mul d19~160@ c19~158@)) (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ b19~156@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3163@ temp_19_1~3236@))) (=> (= temp_19_0~3163@ temp_19_1~3236@) (=> (= temp_20_0~3349@ (Sub (Mul (Mul (Mul a20~162@ a20~162@) (Sub 94 d20~168@)) (Mul (Mul a20~162@ b20~164@) (Mul d20~168@ d20~168@))) (Mul (Add (Mul a20~162@ c20~166@) (Mul b20~164@ d20~168@)) (Mul (Mul c20~166@ c20~166@) (Mul 65 a20~162@))))) (=> (= temp_20_1~3438@ (Sub (Mul (Mul (Mul a20~162@ a20~162@) (Sub 94 d20~168@)) (Mul (Mul a20~162@ b20~164@) (Mul d20~168@ d20~168@))) (Mul (Add (Mul a20~162@ c20~166@) (Mul b20~164@ d20~168@)) (Mul c20~166@ (Mul c20~166@ (Mul 65 a20~162@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3349@ temp_20_1~3438@))) (=> (= temp_20_0~3349@ temp_20_1~3438@) (=> (= temp_21_0~3535@ (Sub (Mul (Mul (Mul d21~176@ d21~176@) (Mul b21~172@ a21~170@)) (Mul d21~176@ (Mul b21~172@ b21~172@))) (Sub (Add (Mul c21~174@ b21~172@) (Mul c21~174@ c21~174@)) (Mul (Mul a21~170@ c21~174@) (Mul d21~176@ 94))))) (=> (= temp_21_1~3608@ (Sub (Mul (Mul (Mul d21~176@ d21~176@) (Mul b21~172@ a21~170@)) (Mul d21~176@ (Mul b21~172@ b21~172@))) (Sub (Add (Mul b21~172@ c21~174@) (Mul c21~174@ c21~174@)) (Mul (Mul a21~170@ c21~174@) (Mul d21~176@ 94))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3535@ temp_21_1~3608@))) (=> (= temp_21_0~3535@ temp_21_1~3608@) (=> (= temp_22_0~3697@ (Mul (Mul (Mul (Mul a22~178@ c22~182@) (Mul a22~178@ a22~178@)) (Mul (Add d22~184@ b22~180@) (Mul d22~184@ c22~182@))) (Mul (Sub (Mul d22~184@ c22~182@) (Mul b22~180@ a22~178@)) (Mul (Sub b22~180@ b22~180@) (Mul b22~180@ b22~180@))))) (=> (= temp_22_1~3762@ (Mul (Mul (Mul (Mul a22~178@ a22~178@) (Mul a22~178@ c22~182@)) (Mul (Add d22~184@ b22~180@) (Mul d22~184@ c22~182@))) (Mul (Sub (Mul d22~184@ c22~182@) (Mul b22~180@ a22~178@)) (Mul (Sub b22~180@ b22~180@) (Mul b22~180@ b22~180@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3697@ temp_22_1~3762@))) (=> (= temp_22_0~3697@ temp_22_1~3762@) (=> (= temp_23_0~3847@ (Mul (Mul (Mul (Mul c23~190@ c23~190@) (Add d23~192@ c23~190@)) (Mul (Mul d23~192@ c23~190@) (Mul b23~188@ d23~192@))) (Mul (Mul b23~188@ (Sub c23~190@ a23~186@)) (Mul (Mul a23~186@ b23~188@) (Add c23~190@ d23~192@))))) (=> (= temp_23_1~3908@ (Mul (Mul (Mul (Mul (Mul c23~190@ c23~190@) (Add d23~192@ c23~190@)) (Mul (Mul d23~192@ c23~190@) (Mul b23~188@ d23~192@))) (Mul b23~188@ (Sub c23~190@ a23~186@))) (Mul (Mul a23~186@ b23~188@) (Add c23~190@ d23~192@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3847@ temp_23_1~3908@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
