...
(set-info :comment ";; mariposa_data/v_nl//12550485510917026464/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_7_1~1458@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Add (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Sub d0~8@ c0~6@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul b0~4@ d0~8@) b0~4@) (Mul (Add c0~6@ c0~6@) (Sub a0~2@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Sub d0~8@ c0~6@) (Mul c0~6@ c0~6@)) (Add (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul b0~4@ d0~8@) b0~4@) (Mul (Add c0~6@ c0~6@) (Sub a0~2@ b0~4@))))) (and (=> (= tmp%1@ (Add (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@))) (=> (= tmp%2@ (Mul (Sub d0~8@ c0~6@) (Mul c0~6@ c0~6@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~475@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ d1~16@) a1~10@)))) (=> (= temp_1_1~536@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ d1~16@) a1~10@)))) (and (=> (= tmp%3@ (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ d1~16@))) (=> (= tmp%4@ (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~475@ temp_1_1~536@))))) (=> (= temp_1_0~475@ temp_1_1~536@) (=> (= temp_2_0~625@ (Sub (Mul (Mul (Add d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ d2~24@))) b2~20@)) (=> (= temp_2_1~662@ (Sub (Mul (Mul (Mul a2~18@ a2~18@) (Add d2~24@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ d2~24@))) b2~20@)) (and (=> (= tmp%5@ (Add d2~24@ b2~20@)) (=> (= tmp%6@ (Mul a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%2 (= temp_2_0~625@ temp_2_1~662@))))) (=> (= temp_2_0~625@ temp_2_1~662@) (=> (= temp_3_0~775@ (Mul (Add (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Mul 80 a3~26@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~852@ (Mul (Add (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Mul 80 a3~26@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ a3~26@) (=> %%location_label%%3 (= temp_3_0~775@ temp_3_1~852@))) (=> (= temp_3_0~775@ temp_3_1~852@) (=> (= temp_4_0~929@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ c4~38@)) (Add (Mul b4~36@ d4~40@) d4~40@)) (Mul a4~34@ (Sub (Mul a4~34@ c4~38@) (Mul d4~40@ d4~40@))))) (=> (= temp_4_1~978@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ c4~38@)) (Add (Mul b4~36@ d4~40@) d4~40@)) (Mul a4~34@ (Sub (Mul a4~34@ c4~38@) (Mul d4~40@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ d4~40@) (=> %%location_label%%4 (= temp_4_0~929@ temp_4_1~978@))) (=> (= temp_4_0~929@ temp_4_1~978@) (=> (= temp_5_0~1071@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ c5~46@)) (Mul (Sub b5~44@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1136@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Sub b5~44@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))))) (and (=> (= tmp%7@ (Mul b5~44@ b5~44@)) (=> (= tmp%8@ (Mul b5~44@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~1071@ temp_5_1~1136@))))) (=> (= temp_5_0~1071@ temp_5_1~1136@) (=> (= temp_6_0~1233@ (Add (Mul (Mul (Mul d6~56@ a6~50@) (Add c6~54@ c6~54@)) (Mul (Mul c6~54@ d6~56@) b6~52@)) (Add (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1294@ (Add (Mul (Mul d6~56@ (Mul a6~50@ (Add c6~54@ c6~54@))) (Mul (Mul c6~54@ d6~56@) b6~52@)) (Add (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ a6~50@))))) (and (=> (= tmp%9@ (Add c6~54@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d6~56@ a6~50@ tmp%9@) (=> %%location_label%%6 (= temp_6_0~1233@ temp_6_1~1294@)))) (=> (= temp_6_0~1233@ temp_6_1~1294@) (=> (= temp_7_0~1393@ (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ b7~60@)) (Add (Sub a7~58@ d7~64@) (Mul c7~62@ a7~58@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1458@ (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ b7~60@)) (Add (Sub a7~58@ d7~64@) (Mul a7~58@ c7~62@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul b7~60@ a7~58@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1393@ temp_7_1~1458@))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
