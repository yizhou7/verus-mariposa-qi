...
(set-info :comment ";; mariposa_data/v_nl//9858311102561624313/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_8_1~1620@ Int)
(declare-const temp_9_0~1735@ Int)
(declare-const temp_9_1~1800@ Int)
(declare-const temp_10_0~1901@ Int)
(declare-const temp_10_1~1974@ Int)
(declare-const temp_11_0~2073@ Int)
(declare-const temp_11_1~2138@ Int)
(declare-const temp_12_0~2217@ Int)
(declare-const temp_12_1~2262@ Int)
(declare-const temp_13_0~2385@ Int)
(declare-const temp_13_1~2478@ Int)
(declare-const temp_14_0~2593@ Int)
(declare-const temp_14_1~2658@ Int)
(declare-const temp_15_0~2747@ Int)
(declare-const temp_15_1~2808@ Int)
(declare-const temp_16_0~2919@ Int)
(declare-const temp_16_1~2988@ Int)
(declare-const temp_17_0~3079@ Int)
(declare-const temp_17_1~3132@ Int)
(declare-const temp_18_0~3227@ Int)
(declare-const temp_18_1~3292@ Int)
(declare-const temp_19_0~3381@ Int)
(declare-const temp_19_1~3442@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Sub (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@)) (Mul b0~4@ (Sub d0~8@ a0~2@))) (Mul (Add d0~8@ (Mul c0~6@ a0~2@)) (Sub (Mul d0~8@ a0~2@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~354@ (Mul (Mul (Mul (Sub (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@)) b0~4@) (Sub d0~8@ a0~2@)) (Mul (Add d0~8@ (Mul c0~6@ a0~2@)) (Sub (Mul d0~8@ a0~2@) (Mul a0~2@ d0~8@))))) (and (=> (= tmp%1@ (Sub (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= tmp%2@ (Sub d0~8@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b0~4@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~354@))))) (=> (= temp_0_0~297@ temp_0_1~354@) (=> (= temp_1_0~457@ (Sub (Mul (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@)) (Mul a1~10@ (Mul c1~14@ d1~16@))) (Mul (Mul (Sub a1~10@ a1~10@) (Sub c1~14@ c1~14@)) (Sub a1~10@ (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~514@ (Sub (Mul (Mul a1~10@ (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@))) (Mul (Mul (Sub a1~10@ a1~10@) (Sub c1~14@ c1~14@)) (Sub a1~10@ (Mul a1~10@ c1~14@))))) (and (=> (= tmp%3@ (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@))) (=> (= tmp%4@ (Mul a1~10@ (Mul c1~14@ d1~16@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~457@ temp_1_1~514@))))) (=> (= temp_1_0~457@ temp_1_1~514@) (=> (= temp_2_0~623@ (Sub (Mul (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Sub b2~20@ c2~22@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Mul c2~22@ d2~24@) a2~18@)))) (=> (= temp_2_1~684@ (Sub (Mul (Mul (Mul (Mul c2~22@ b2~20@) d2~24@) c2~22@) (Mul (Sub b2~20@ c2~22@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Mul c2~22@ d2~24@) a2~18@)))) (and (=> (= tmp%5@ (Mul c2~22@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ d2~24@ c2~22@) (=> %%location_label%%2 (= temp_2_0~623@ temp_2_1~684@)))) (=> (= temp_2_0~623@ temp_2_1~684@) (=> (= temp_3_0~775@ (Sub (Mul (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ c3~30@))) (Sub (Mul d3~32@ (Sub b3~28@ d3~32@)) (Add (Sub b3~28@ b3~28@) c3~30@)))) (=> (= temp_3_1~832@ (Sub (Mul (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ c3~30@))) (Sub (Mul (Sub b3~28@ d3~32@) d3~32@) (Add (Sub b3~28@ b3~28@) c3~30@)))) (and (=> (= tmp%6@ (Sub b3~28@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~775@ temp_3_1~832@)))) (=> (= temp_3_0~775@ temp_3_1~832@) (=> (= temp_4_0~925@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) c4~38@) (Mul (Mul c4~38@ a4~34@) (Sub b4~36@ b4~36@))) (Sub (Mul (Add b4~36@ d4~40@) (Add c4~38@ b4~36@)) (Mul (Mul b4~36@ a4~34@) (Add a4~34@ a4~34@))))) (=> (= temp_4_1~986@ (Mul (Mul (Mul c4~38@ (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Sub b4~36@ b4~36@))) (Sub (Mul (Add b4~36@ d4~40@) (Add c4~38@ b4~36@)) (Mul (Mul b4~36@ a4~34@) (Add a4~34@ a4~34@))))) (and (=> (= tmp%7@ (Mul b4~36@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ c4~38@) (=> %%location_label%%4 (= temp_4_0~925@ temp_4_1~986@)))) (=> (= temp_4_0~925@ temp_4_1~986@) (=> (= temp_5_0~1071@ (Mul (Mul b5~44@ (Mul (Sub d5~48@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Sub d5~48@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@))))) (=> (= temp_5_1~1124@ (Mul (Mul b5~44@ (Mul (Sub d5~48@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Sub d5~48@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1071@ temp_5_1~1124@))) (=> (= temp_5_0~1071@ temp_5_1~1124@) (=> (= temp_6_0~1229@ (Mul (Mul (Mul (Mul 79 b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Sub b6~52@ c6~54@))) (Mul (Mul (Sub a6~50@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1306@ (Mul (Mul (Mul (Mul 79 b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Sub b6~52@ c6~54@))) (Mul (Mul (Sub a6~50@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1229@ temp_6_1~1306@))) (=> (= temp_6_0~1229@ temp_6_1~1306@) (=> (= temp_7_0~1395@ (Mul (Mul (Sub (Mul b7~60@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Add a7~58@ a7~58@) a7~58@)) (Mul (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ b7~60@)) (Mul (Sub d7~64@ b7~60@) (Mul b7~60@ d7~64@))))) (=> (= temp_7_1~1456@ (Mul (Mul (Sub (Mul b7~60@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Add a7~58@ a7~58@) a7~58@)) (Mul (Mul a7~58@ (Mul c7~62@ (Mul a7~58@ b7~60@))) (Mul (Sub d7~64@ b7~60@) (Mul b7~60@ d7~64@))))) (and (=> (= tmp%8@ (Mul a7~58@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a7~58@ c7~62@ tmp%8@) (=> %%location_label%%7 (= temp_7_0~1395@ temp_7_1~1456@)))) (=> (= temp_7_0~1395@ temp_7_1~1456@) (=> (= temp_8_0~1555@ (Mul (Mul (Sub (Mul a8~66@ d8~72@) (Mul b8~68@ d8~72@)) (Mul (Add c8~70@ d8~72@) (Mul c8~70@ a8~66@))) (Mul (Mul (Sub c8~70@ a8~66@) (Mul a8~66@ d8~72@)) (Mul (Sub d8~72@ c8~70@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1620@ (Mul (Mul (Mul (Sub (Mul a8~66@ d8~72@) (Mul b8~68@ d8~72@)) (Add c8~70@ d8~72@)) (Mul c8~70@ a8~66@)) (Mul (Mul (Sub c8~70@ a8~66@) (Mul a8~66@ d8~72@)) (Mul (Sub d8~72@ c8~70@) (Mul a8~66@ c8~70@))))) (and (=> (= tmp%9@ (Sub (Mul a8~66@ d8~72@) (Mul b8~68@ d8~72@))) (=> (= tmp%10@ (Add c8~70@ d8~72@)) (=> (= tmp%11@ (Mul c8~70@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~1555@ temp_8_1~1620@)))))) (=> (= temp_8_0~1555@ temp_8_1~1620@) (=> (= temp_9_0~1735@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Sub a9~74@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Add c9~78@ a9~74@))) (Mul (Mul (Mul a9~74@ a9~74@) (Add b9~76@ c9~78@)) (Mul (Mul c9~78@ a9~74@) (Mul c9~78@ b9~76@))))) (=> (= temp_9_1~1800@ (Mul (Mul (Mul (Sub a9~74@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Add c9~78@ a9~74@))) (Mul (Mul (Mul a9~74@ a9~74@) (Add b9~76@ c9~78@)) (Mul (Mul c9~78@ a9~74@) (Mul c9~78@ b9~76@))))) (and (=> (= tmp%12@ (Mul d9~80@ b9~76@)) (=> (= tmp%13@ (Sub a9~74@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%9 (= temp_9_0~1735@ temp_9_1~1800@))))) (=> (= temp_9_0~1735@ temp_9_1~1800@) (=> (= temp_10_0~1901@ (Mul (Mul (Mul (Add a10~82@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Add d10~88@ d10~88@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Add c10~86@ d10~88@))))) (=> (= temp_10_1~1974@ (Mul (Mul (Mul (Add a10~82@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Add d10~88@ d10~88@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ a10~82@)) (Add (Mul (Mul a10~82@ c10~86@) c10~86@) (Mul (Mul a10~82@ c10~86@) d10~88@))))) (and (=> (= tmp%14@ (Mul a10~82@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%14@ c10~86@ d10~88@) (=> %%location_label%%10 (= temp_10_0~1901@ temp_10_1~1974@)))) (=> (= temp_10_0~1901@ temp_10_1~1974@) (=> (= temp_11_0~2073@ (Mul (Sub (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul d11~96@ c11~94@) (Add b11~92@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Sub d11~96@ c11~94@))))) (=> (= temp_11_1~2138@ (Mul (Sub (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@)) (Mul d11~96@ (Mul c11~94@ (Mul d11~96@ b11~92@)))) (Mul (Mul (Mul d11~96@ c11~94@) (Add b11~92@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Sub d11~96@ c11~94@))))) (and (=> (= tmp%15@ (Mul d11~96@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d11~96@ c11~94@ tmp%15@) (=> %%location_label%%11 (= temp_11_0~2073@ temp_11_1~2138@)))) (=> (= temp_11_0~2073@ temp_11_1~2138@) (=> (= temp_12_0~2217@ (Mul (Mul b12~100@ (Mul d12~104@ (Mul c12~102@ c12~102@))) (Mul (Sub (Mul d12~104@ d12~104@) (Mul c12~102@ d12~104@)) (Mul d12~104@ (Sub d12~104@ d12~104@))))) (=> (= temp_12_1~2262@ (Mul (Mul b12~100@ (Mul d12~104@ (Mul c12~102@ c12~102@))) (Mul (Mul (Sub (Mul d12~104@ d12~104@) (Mul c12~102@ d12~104@)) d12~104@) (Sub d12~104@ d12~104@)))) (and (=> (= tmp%16@ (Sub (Mul d12~104@ d12~104@) (Mul c12~102@ d12~104@))) (=> (= tmp%17@ (Sub d12~104@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ d12~104@ tmp%17@) (=> %%location_label%%12 (= temp_12_0~2217@ temp_12_1~2262@))))) (=> (= temp_12_0~2217@ temp_12_1~2262@) (=> (= temp_13_0~2385@ (Mul (Mul (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ c13~110@)) (Add (Add 96 d13~112@) (Mul a13~106@ b13~108@))) (Mul (Add (Mul b13~108@ d13~112@) (Mul b13~108@ c13~110@)) (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@))))) (=> (= temp_13_1~2478@ (Mul (Mul (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ c13~110@)) (Add (Add 96 d13~112@) (Mul a13~106@ b13~108@))) (Add (Mul (Mul b13~108@ d13~112@) (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@))) (Mul (Mul b13~108@ c13~110@) (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@)))))) (and (=> (= tmp%18@ (Mul b13~108@ d13~112@)) (=> (= tmp%19@ (Mul b13~108@ c13~110@)) (=> (= tmp%20@ (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%13 (= temp_13_0~2385@ temp_13_1~2478@)))))) (=> (= temp_13_0~2385@ temp_13_1~2478@) (=> (= temp_14_0~2593@ (Mul (Mul (Add (Mul c14~118@ d14~120@) (Mul a14~114@ a14~114@)) (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ b14~116@))) (Sub (Mul (Mul d14~120@ a14~114@) (Mul d14~120@ c14~118@)) (Mul (Mul b14~116@ a14~114@) (Mul a14~114@ b14~116@))))) (=> (= temp_14_1~2658@ (Mul (Mul (Add (Mul d14~120@ c14~118@) (Mul a14~114@ a14~114@)) (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ b14~116@))) (Sub (Mul (Mul d14~120@ a14~114@) (Mul d14~120@ c14~118@)) (Mul (Mul b14~116@ a14~114@) (Mul a14~114@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c14~118@ d14~120@) (=> %%location_label%%14 (= temp_14_0~2593@ temp_14_1~2658@))) (=> (= temp_14_0~2593@ temp_14_1~2658@) (=> (= temp_15_0~2747@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul c15~126@ b15~124@)) (Mul (Mul d15~128@ c15~126@) (Mul b15~124@ d15~128@))) (Sub (Mul (Mul b15~124@ b15~124@) d15~128@) (Add (Mul d15~128@ c15~126@) (Mul c15~126@ d15~128@))))) (=> (= temp_15_1~2808@ (Mul (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul c15~126@ b15~124@)) (Mul d15~128@ c15~126@)) (Mul b15~124@ d15~128@)) (Sub (Mul (Mul b15~124@ b15~124@) d15~128@) (Add (Mul d15~128@ c15~126@) (Mul c15~126@ d15~128@))))) (and (=> (= tmp%21@ (Mul (Mul c15~126@ c15~126@) (Mul c15~126@ b15~124@))) (=> (= tmp%22@ (Mul d15~128@ c15~126@)) (=> (= tmp%23@ (Mul b15~124@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ tmp%22@ tmp%23@) (=> %%location_label%%15 (= temp_15_0~2747@ temp_15_1~2808@)))))) (=> (= temp_15_0~2747@ temp_15_1~2808@) (=> (= temp_16_0~2919@ (Add (Mul (Mul (Mul a16~130@ d16~136@) (Mul c16~134@ d16~136@)) (Mul (Add d16~136@ b16~132@) (Mul c16~134@ c16~134@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul c16~134@ c16~134@)) (Add a16~130@ (Add a16~130@ b16~132@))))) (=> (= temp_16_1~2988@ (Add (Mul (Mul (Mul a16~130@ d16~136@) (Mul c16~134@ d16~136@)) (Add (Mul d16~136@ (Mul c16~134@ c16~134@)) (Mul b16~132@ (Mul c16~134@ c16~134@)))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul c16~134@ c16~134@)) (Add a16~130@ (Add a16~130@ b16~132@))))) (and (=> (= tmp%24@ (Mul c16~134@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d16~136@ b16~132@ tmp%24@) (=> %%location_label%%16 (= temp_16_0~2919@ temp_16_1~2988@)))) (=> (= temp_16_0~2919@ temp_16_1~2988@) (=> (= temp_17_0~3079@ (Mul (Add (Add (Mul c17~142@ c17~142@) (Mul c17~142@ c17~142@)) (Mul d17~144@ (Mul b17~140@ d17~144@))) (Mul (Mul (Mul d17~144@ a17~138@) b17~140@) (Mul (Add d17~144@ c17~142@) (Mul d17~144@ c17~142@))))) (=> (= temp_17_1~3132@ (Mul (Add (Mul (Add c17~142@ c17~142@) c17~142@) (Mul d17~144@ (Mul b17~140@ d17~144@))) (Mul (Mul (Mul d17~144@ a17~138@) b17~140@) (Mul (Add d17~144@ c17~142@) (Mul d17~144@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. c17~142@ c17~142@ c17~142@) (=> %%location_label%%17 (= temp_17_0~3079@ temp_17_1~3132@))) (=> (= temp_17_0~3079@ temp_17_1~3132@) (=> (= temp_18_0~3227@ (Mul (Mul (Add (Add a18~146@ a18~146@) (Mul b18~148@ c18~150@)) (Mul (Mul b18~148@ a18~146@) (Mul d18~152@ b18~148@))) (Sub (Mul (Mul a18~146@ c18~150@) (Mul c18~150@ b18~148@)) (Sub (Sub c18~150@ d18~152@) (Mul b18~148@ d18~152@))))) (=> (= temp_18_1~3292@ (Mul (Mul (Add (Add a18~146@ a18~146@) (Mul b18~148@ c18~150@)) (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ b18~148@))) (Sub (Mul (Mul a18~146@ c18~150@) (Mul c18~150@ b18~148@)) (Sub (Sub c18~150@ d18~152@) (Mul b18~148@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b18~148@ a18~146@) (=> %%location_label%%18 (= temp_18_0~3227@ temp_18_1~3292@))) (=> (= temp_18_0~3227@ temp_18_1~3292@) (=> (= temp_19_0~3381@ (Mul (Mul (Sub (Mul b19~156@ d19~160@) (Mul c19~158@ c19~158@)) (Mul (Mul d19~160@ b19~156@) (Mul c19~158@ c19~158@))) (Mul (Sub (Mul c19~158@ a19~154@) (Sub d19~160@ b19~156@)) (Mul (Mul d19~160@ b19~156@) c19~158@)))) (=> (= temp_19_1~3442@ (Mul (Mul (Sub (Mul b19~156@ d19~160@) (Mul c19~158@ c19~158@)) (Mul (Mul d19~160@ b19~156@) (Mul c19~158@ c19~158@))) (Mul (Sub (Mul c19~158@ a19~154@) (Sub d19~160@ b19~156@)) (Mul (Mul b19~156@ d19~160@) c19~158@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d19~160@ b19~156@) (=> %%location_label%%19 (= temp_19_0~3381@ temp_19_1~3442@))) (=> (= temp_19_0~3381@ temp_19_1~3442@) (=> (= temp_20_0~3535@ (Sub (Mul (Mul (Mul b20~164@ c20~166@) (Mul a20~162@ c20~166@)) (Mul (Sub d20~168@ d20~168@) (Mul b20~164@ d20~168@))) (Sub (Add (Mul d20~168@ a20~162@) (Mul d20~168@ d20~168@)) (Mul (Mul a20~162@ c20~166@) (Add d20~168@ b20~164@))))) (=> (= temp_20_1~3608@ (Sub (Mul (Mul (Mul b20~164@ c20~166@) (Mul a20~162@ c20~166@)) (Mul (Sub d20~168@ d20~168@) (Mul b20~164@ d20~168@))) (Sub (Add (Mul d20~168@ a20~162@) (Mul d20~168@ d20~168@)) (Add (Mul (Mul a20~162@ c20~166@) d20~168@) (Mul (Mul a20~162@ c20~166@) b20~164@))))) (and (=> (= tmp%25@ (Mul a20~162@ c20~166@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%25@ d20~168@ b20~164@) (=> %%location_label%%20 (= temp_20_0~3535@ temp_20_1~3608@)))) (=> (= temp_20_0~3535@ temp_20_1~3608@) (=> (= temp_21_0~3703@ (Mul (Sub (Mul (Mul b21~172@ a21~170@) (Mul a21~170@ a21~170@)) (Mul (Mul b21~172@ d21~176@) (Sub d21~176@ d21~176@))) (Mul (Mul (Sub b21~172@ a21~170@) (Mul c21~174@ c21~174@)) (Mul (Mul a21~170@ b21~172@) c21~174@)))) (=> (= temp_21_1~3764@ (Mul (Sub (Mul (Mul b21~172@ a21~170@) (Mul a21~170@ a21~170@)) (Mul (Mul b21~172@ d21~176@) (Sub d21~176@ d21~176@))) (Mul (Sub b21~172@ a21~170@) (Mul (Mul c21~174@ c21~174@) (Mul (Mul a21~170@ b21~172@) c21~174@))))) (=> (= tmp%26@ (Sub b21~172@ a21~170@)) (=> (= tmp%27@ (Mul c21~174@ c21~174@)) (=> (= tmp%28@ (Mul (Mul a21~170@ b21~172@) c21~174@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%26@ tmp%27@ tmp%28@) (=> %%location_label%%21 (= temp_21_0~3703@ temp_21_1~3764@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
