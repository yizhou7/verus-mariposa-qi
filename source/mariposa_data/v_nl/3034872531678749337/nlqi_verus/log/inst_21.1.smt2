...
(set-info :comment ";; mariposa_data/v_nl//3034872531678749337/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_2_0~683@ Int)
...
(declare-const temp_7_0~1549@ Int)
(declare-const temp_7_1~1614@ Int)
(declare-const temp_8_0~1685@ Int)
(declare-const temp_8_1~1722@ Int)
(declare-const temp_9_0~1793@ Int)
(declare-const temp_9_1~1830@ Int)
(declare-const temp_10_0~1915@ Int)
(declare-const temp_10_1~1968@ Int)
(declare-const temp_11_0~2041@ Int)
(declare-const temp_11_1~2078@ Int)
(declare-const temp_12_0~2169@ Int)
(declare-const temp_12_1~2238@ Int)
(declare-const temp_13_0~2313@ Int)
(declare-const temp_13_1~2354@ Int)
(declare-const temp_14_0~2447@ Int)
(declare-const temp_14_1~2512@ Int)
(declare-const temp_15_0~2609@ Int)
(declare-const temp_15_1~2670@ Int)
...
(declare-const temp_19_0~3233@ Int)
(declare-const temp_19_1~3298@ Int)
(declare-const temp_20_0~3411@ Int)
(declare-const temp_20_1~3488@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@)) (Add d0~8@ a0~2@)) (Mul (Mul (Mul d0~8@ a0~2@) (Sub d0~8@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@)) (Add d0~8@ a0~2@)) (Mul (Sub (Mul (Mul d0~8@ a0~2@) d0~8@) (Mul (Mul d0~8@ a0~2@) a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ c0~6@))))) (and (=> (= tmp%1@ (Mul d0~8@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ d0~8@ a0~2@) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~362@)))) (=> (= temp_0_0~297@ temp_0_1~362@) (=> (= temp_1_0~481@ (Mul (Mul (Mul a1~10@ (Sub b1~12@ b1~12@)) (Add (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ 0) (Add c1~14@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul 1 d1~16@))))) (=> (= temp_1_1~566@ (Mul (Mul (Mul a1~10@ (Sub b1~12@ b1~12@)) (Add (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ 0) (Add c1~14@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul 1 d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ b1~12@) (=> %%location_label%%1 (= temp_1_0~481@ temp_1_1~566@))) (=> (= temp_1_0~481@ temp_1_1~566@) (=> (= temp_2_0~683@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ 2)) (Mul (Add b2~20@ d2~24@) (Mul a2~18@ 21))))) (=> (= temp_2_1~772@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ 2)) (Mul (Add b2~20@ d2~24@) (Mul a2~18@ 21))))) (and (=> (= tmp%2@ (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@))) (=> (= tmp%3@ (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~683@ temp_2_1~772@))))) (=> (= temp_2_0~683@ temp_2_1~772@) (=> (= temp_3_0~873@ (Mul (Mul b3~28@ (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ b3~28@))) (Mul (Mul (Add a3~26@ b3~28@) c3~30@) (Mul (Add d3~32@ d3~32@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~922@ (Mul (Mul b3~28@ (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ b3~28@))) (Mul (Mul (Add a3~26@ b3~28@) c3~30@) (Mul (Mul (Add d3~32@ d3~32@) d3~32@) b3~28@)))) (and (=> (= tmp%4@ (Add d3~32@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ d3~32@ b3~28@) (=> %%location_label%%3 (= temp_3_0~873@ temp_3_1~922@)))) (=> (= temp_3_0~873@ temp_3_1~922@) (=> (= temp_4_0~1021@ (Mul (Mul (Add (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Add c4~38@ a4~34@))) (Sub (Mul (Sub a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Sub a4~34@ a4~34@) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~1086@ (Mul (Mul (Add (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ b4~36@) (Add c4~38@ a4~34@))) (Sub (Mul (Sub a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Sub a4~34@ a4~34@) (Mul c4~38@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ d4~40@) (=> %%location_label%%4 (= temp_4_0~1021@ temp_4_1~1086@))) (=> (= temp_4_0~1021@ temp_4_1~1086@) (=> (= temp_5_0~1179@ (Add (Mul (Mul (Mul c5~46@ a5~42@) (Add b5~44@ b5~44@)) (Mul (Sub d5~48@ d5~48@) (Sub d5~48@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ c5~46@))))) (=> (= temp_5_1~1244@ (Add (Mul (Mul c5~46@ (Mul a5~42@ (Add b5~44@ b5~44@))) (Mul (Sub d5~48@ d5~48@) (Sub d5~48@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ c5~46@))))) (and (=> (= tmp%5@ (Add b5~44@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c5~46@ a5~42@ tmp%5@) (=> %%location_label%%5 (= temp_5_0~1179@ temp_5_1~1244@)))) (=> (= temp_5_0~1179@ temp_5_1~1244@) (=> (= temp_6_0~1367@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul 31 c6~54@)) (Mul (Mul c6~54@ 82) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul d6~56@ a6~50@) (Sub b6~52@ a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1456@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul 31 c6~54@)) (Mul (Mul c6~54@ 82) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul d6~56@ a6~50@) (Sub b6~52@ a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1367@ temp_6_1~1456@))) (=> (= temp_6_0~1367@ temp_6_1~1456@) (=> (= temp_7_0~1549@ (Sub (Sub (Mul (Mul c7~62@ d7~64@) (Add d7~64@ a7~58@)) (Sub (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@))) (Add (Sub (Sub a7~58@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1614@ (Sub (Sub (Mul c7~62@ (Mul d7~64@ (Add d7~64@ a7~58@))) (Sub (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@))) (Add (Sub (Sub a7~58@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@))))) (and (=> (= tmp%6@ (Add d7~64@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c7~62@ d7~64@ tmp%6@) (=> %%location_label%%7 (= temp_7_0~1549@ temp_7_1~1614@)))) (=> (= temp_7_0~1549@ temp_7_1~1614@) (=> (= temp_8_0~1685@ (Mul (Mul (Add (Mul b8~68@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Add a8~66@ d8~72@) (Mul b8~68@ a8~66@))) c8~70@)) (=> (= temp_8_1~1722@ (Mul (Mul (Add (Mul b8~68@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Mul (Add a8~66@ d8~72@) b8~68@) a8~66@)) c8~70@)) (and (=> (= tmp%7@ (Add a8~66@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ b8~68@ a8~66@) (=> %%location_label%%8 (= temp_8_0~1685@ temp_8_1~1722@)))) (=> (= temp_8_0~1685@ temp_8_1~1722@) (=> (= temp_9_0~1793@ (Mul (Mul b9~76@ (Mul (Mul a9~74@ d9~80@) b9~76@)) (Mul (Mul (Mul c9~78@ c9~78@) (Mul a9~74@ a9~74@)) b9~76@))) (=> (= temp_9_1~1830@ (Mul (Mul b9~76@ (Mul b9~76@ (Mul a9~74@ d9~80@))) (Mul (Mul (Mul c9~78@ c9~78@) (Mul a9~74@ a9~74@)) b9~76@))) (and (=> (= tmp%8@ (Mul a9~74@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ b9~76@) (=> %%location_label%%9 (= temp_9_0~1793@ temp_9_1~1830@)))) (=> (= temp_9_0~1793@ temp_9_1~1830@) (=> (= temp_10_0~1915@ (Mul (Mul c10~86@ (Sub (Mul b10~84@ a10~82@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ c10~86@))))) (=> (= temp_10_1~1968@ (Mul (Mul c10~86@ (Sub (Mul b10~84@ a10~82@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ c10~86@))))) (and (=> (= tmp%9@ (Mul d10~88@ d10~88@)) (=> (= tmp%10@ (Mul c10~86@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%10 (= temp_10_0~1915@ temp_10_1~1968@))))) (=> (= temp_10_0~1915@ temp_10_1~1968@) (=> (= temp_11_0~2041@ (Mul (Mul (Mul (Sub d11~96@ a11~90@) (Sub a11~90@ a11~90@)) (Mul c11~94@ (Mul d11~96@ c11~94@))) (Mul c11~94@ c11~94@))) (=> (= temp_11_1~2078@ (Mul (Mul (Mul (Sub d11~96@ a11~90@) (Sub a11~90@ a11~90@)) (Mul (Mul c11~94@ d11~96@) c11~94@)) (Mul c11~94@ c11~94@))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. c11~94@ d11~96@ c11~94@) (=> %%location_label%%11 (= temp_11_0~2041@ temp_11_1~2078@))) (=> (= temp_11_0~2041@ temp_11_1~2078@) (=> (= temp_12_0~2169@ (Mul (Mul (Mul (Mul b12~100@ b12~100@) (Sub b12~100@ a12~98@)) (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ d12~104@))) (Mul (Mul (Mul b12~100@ b12~100@) (Add c12~102@ b12~100@)) (Mul (Mul a12~98@ a12~98@) b12~100@)))) (=> (= temp_12_1~2238@ (Mul (Mul (Sub (Mul (Mul b12~100@ b12~100@) b12~100@) (Mul (Mul b12~100@ b12~100@) a12~98@)) (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ d12~104@))) (Mul (Mul (Mul b12~100@ b12~100@) (Add c12~102@ b12~100@)) (Mul (Mul a12~98@ a12~98@) b12~100@)))) (and (=> (= tmp%11@ (Mul b12~100@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ b12~100@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2169@ temp_12_1~2238@)))) (=> (= temp_12_0~2169@ temp_12_1~2238@) (=> (= temp_13_0~2313@ (Mul (Mul b13~108@ b13~108@) (Mul (Mul (Mul c13~110@ b13~108@) (Mul a13~106@ a13~106@)) (Mul (Mul b13~108@ a13~106@) (Sub d13~112@ c13~110@))))) (=> (= temp_13_1~2354@ (Mul (Mul b13~108@ b13~108@) (Mul (Mul (Mul c13~110@ b13~108@) (Mul a13~106@ a13~106@)) (Mul (Mul a13~106@ b13~108@) (Sub d13~112@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b13~108@ a13~106@) (=> %%location_label%%13 (= temp_13_0~2313@ temp_13_1~2354@))) (=> (= temp_13_0~2313@ temp_13_1~2354@) (=> (= temp_14_0~2447@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ b14~116@) (Mul d14~120@ d14~120@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Add a14~114@ b14~116@) (Mul a14~114@ c14~118@))))) (=> (= temp_14_1~2512@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ b14~116@) (Mul d14~120@ d14~120@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Mul a14~114@ c14~118@) (Add a14~114@ b14~116@))))) (and (=> (= tmp%12@ (Add a14~114@ b14~116@)) (=> (= tmp%13@ (Mul a14~114@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%14 (= temp_14_0~2447@ temp_14_1~2512@))))) (=> (= temp_14_0~2447@ temp_14_1~2512@) (=> (= temp_15_0~2609@ (Sub (Mul (Mul a15~122@ (Mul d15~128@ c15~126@)) (Add (Sub c15~126@ a15~122@) (Add b15~124@ a15~122@))) (Mul (Mul (Sub d15~128@ d15~128@) (Mul c15~126@ a15~122@)) (Add (Mul b15~124@ d15~128@) (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~2670@ (Sub (Mul (Mul a15~122@ (Mul d15~128@ c15~126@)) (Add (Sub c15~126@ a15~122@) (Add b15~124@ a15~122@))) (Mul (Sub d15~128@ d15~128@) (Mul (Mul c15~126@ a15~122@) (Add (Mul b15~124@ d15~128@) (Mul a15~122@ c15~126@)))))) (and (=> (= tmp%14@ (Sub d15~128@ d15~128@)) (=> (= tmp%15@ (Mul c15~126@ a15~122@)) (=> (= tmp%16@ (Add (Mul b15~124@ d15~128@) (Mul a15~122@ c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%15 (= temp_15_0~2609@ temp_15_1~2670@)))))) (=> (= temp_15_0~2609@ temp_15_1~2670@) (=> (= temp_16_0~2773@ (Mul (Mul (Mul (Mul c16~134@ c16~134@) (Add a16~130@ d16~136@)) (Add (Mul d16~136@ d16~136@) a16~130@)) (Mul (Mul (Mul b16~132@ c16~134@) d16~136@) (Mul a16~130@ (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2826@ (Mul (Mul (Mul (Add a16~130@ d16~136@) (Mul c16~134@ c16~134@)) (Add (Mul d16~136@ d16~136@) a16~130@)) (Mul (Mul (Mul b16~132@ c16~134@) d16~136@) (Mul a16~130@ (Mul c16~134@ a16~130@))))) (and (=> (= tmp%17@ (Mul c16~134@ c16~134@)) (=> (= tmp%18@ (Add a16~130@ d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%16 (= temp_16_0~2773@ temp_16_1~2826@))))) (=> (= temp_16_0~2773@ temp_16_1~2826@) (=> (= temp_17_0~2915@ (Sub (Mul c17~142@ (Sub (Mul b17~140@ c17~142@) (Mul a17~138@ a17~138@))) (Mul (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ a17~138@)) (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ a17~138@))))) (=> (= temp_17_1~2968@ (Sub (Mul c17~142@ (Sub (Mul b17~140@ c17~142@) (Mul a17~138@ a17~138@))) (Mul (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ a17~138@)) (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ c17~142@))))) (and (=> (= tmp%19@ (Mul a17~138@ c17~142@)) (=> (= tmp%20@ (Mul b17~140@ a17~138@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%17 (= temp_17_0~2915@ temp_17_1~2968@))))) (=> (= temp_17_0~2915@ temp_17_1~2968@) (=> (= temp_18_0~3069@ (Mul (Mul (Mul (Mul d18~152@ b18~148@) (Mul a18~146@ c18~150@)) (Mul (Mul d18~152@ a18~146@) (Mul a18~146@ c18~150@))) (Sub (Mul (Add b18~148@ a18~146@) (Mul a18~146@ d18~152@)) (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~3134@ (Mul (Mul (Mul d18~152@ (Mul b18~148@ (Mul a18~146@ c18~150@))) (Mul (Mul d18~152@ a18~146@) (Mul a18~146@ c18~150@))) (Sub (Mul (Add b18~148@ a18~146@) (Mul a18~146@ d18~152@)) (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ d18~152@))))) (and (=> (= tmp%21@ (Mul a18~146@ c18~150@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d18~152@ b18~148@ tmp%21@) (=> %%location_label%%18 (= temp_18_0~3069@ temp_18_1~3134@)))) (=> (= temp_18_0~3069@ temp_18_1~3134@) (=> (= temp_19_0~3233@ (Mul (Mul (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ b19~156@)) (Add (Add d19~160@ d19~160@) (Mul b19~156@ c19~158@))) (Mul (Mul (Mul a19~154@ a19~154@) (Sub a19~154@ a19~154@)) (Mul (Mul c19~158@ d19~160@) (Mul a19~154@ c19~158@))))) (=> (= temp_19_1~3298@ (Mul (Mul (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ b19~156@)) (Add (Add d19~160@ d19~160@) (Mul b19~156@ c19~158@))) (Mul (Mul (Mul a19~154@ a19~154@) (Sub a19~154@ a19~154@)) (Mul (Mul a19~154@ c19~158@) (Mul c19~158@ d19~160@))))) (and (=> (= tmp%22@ (Mul c19~158@ d19~160@)) (=> (= tmp%23@ (Mul a19~154@ c19~158@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%19 (= temp_19_0~3233@ temp_19_1~3298@))))) (=> (= temp_19_0~3233@ temp_19_1~3298@) (=> (= temp_20_0~3411@ (Mul (Mul (Mul (Mul b20~164@ c20~166@) (Mul a20~162@ a20~162@)) (Mul (Mul d20~168@ b20~164@) (Mul 16 c20~166@))) (Sub d20~168@ (Mul (Mul 68 c20~166@) (Mul b20~164@ b20~164@))))) (=> (= temp_20_1~3488@ (Mul (Mul (Mul (Mul b20~164@ c20~166@) (Mul a20~162@ a20~162@)) (Mul (Mul d20~168@ b20~164@) (Mul 16 c20~166@))) (Sub d20~168@ (Mul (Mul (Mul 68 c20~166@) b20~164@) b20~164@)))) (=> (= tmp%24@ (Mul 68 c20~166@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ b20~164@ b20~164@) (=> %%location_label%%20 (= temp_20_0~3411@ temp_20_1~3488@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
