...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@)) (Add d0~8@ a0~2@)) (Mul (Mul (Mul d0~8@ a0~2@) (Sub d0~8@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@)) (Add d0~8@ a0~2@)) (Mul (Sub (Mul (Mul d0~8@ a0~2@) d0~8@) (Mul (Mul d0~8@ a0~2@) a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~297@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~462@ (Mul (Mul (Mul a1~10@ (Sub b1~12@ b1~12@)) (Add (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ 0) (Add c1~14@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul 1 d1~16@))))) (=> (= temp_1_1~547@ (Mul (Mul (Mul a1~10@ (Sub b1~12@ b1~12@)) (Add (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ 0) (Add c1~14@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul 1 d1~16@))))) (=> (= tmp%2@ (= temp_1_0~462@ temp_1_1~547@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~651@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ 2)) (Mul (Add b2~20@ d2~24@) (Mul a2~18@ 21))))) (=> (= temp_2_1~740@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ 2)) (Mul (Add b2~20@ d2~24@) (Mul a2~18@ 21))))) (=> (= tmp%3@ (= temp_2_0~651@ temp_2_1~740@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~804@ (Mul (Mul b3~28@ (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ b3~28@))) (Mul (Mul (Add a3~26@ b3~28@) c3~30@) (Mul (Add d3~32@ d3~32@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~853@ (Mul (Mul b3~28@ (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ b3~28@))) (Mul (Mul (Add a3~26@ b3~28@) c3~30@) (Mul (Mul (Add d3~32@ d3~32@) d3~32@) b3~28@)))) (=> (= tmp%4@ (= temp_3_0~804@ temp_3_1~853@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~933@ (Mul (Mul (Add (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Add c4~38@ a4~34@))) (Sub (Mul (Sub a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Sub a4~34@ a4~34@) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~998@ (Mul (Mul (Add (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ b4~36@) (Add c4~38@ a4~34@))) (Sub (Mul (Sub a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Sub a4~34@ a4~34@) (Mul c4~38@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~933@ temp_4_1~998@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1078@ (Add (Mul (Mul (Mul c5~46@ a5~42@) (Add b5~44@ b5~44@)) (Mul (Sub d5~48@ d5~48@) (Sub d5~48@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ c5~46@))))) (=> (= temp_5_1~1143@ (Add (Mul (Mul c5~46@ (Mul a5~42@ (Add b5~44@ b5~44@))) (Mul (Sub d5~48@ d5~48@) (Sub d5~48@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1078@ temp_5_1~1143@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1247@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul 31 c6~54@)) (Mul (Mul c6~54@ 82) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul d6~56@ a6~50@) (Sub b6~52@ a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1336@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul 31 c6~54@)) (Mul (Mul c6~54@ 82) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul d6~56@ a6~50@) (Sub b6~52@ a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~1247@ temp_6_1~1336@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1416@ (Sub (Sub (Mul (Mul c7~62@ d7~64@) (Add d7~64@ a7~58@)) (Sub (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@))) (Add (Sub (Sub a7~58@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1481@ (Sub (Sub (Mul c7~62@ (Mul d7~64@ (Add d7~64@ a7~58@))) (Sub (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@))) (Add (Sub (Sub a7~58@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1416@ temp_7_1~1481@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1533@ (Mul (Mul (Add (Mul b8~68@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Add a8~66@ d8~72@) (Mul b8~68@ a8~66@))) c8~70@)) (=> (= temp_8_1~1570@ (Mul (Mul (Add (Mul b8~68@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Mul (Add a8~66@ d8~72@) b8~68@) a8~66@)) c8~70@)) (=> (= tmp%9@ (= temp_8_0~1533@ temp_8_1~1570@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1622@ (Mul (Mul b9~76@ (Mul (Mul a9~74@ d9~80@) b9~76@)) (Mul (Mul (Mul c9~78@ c9~78@) (Mul a9~74@ a9~74@)) b9~76@))) (=> (= temp_9_1~1659@ (Mul (Mul b9~76@ (Mul b9~76@ (Mul a9~74@ d9~80@))) (Mul (Mul (Mul c9~78@ c9~78@) (Mul a9~74@ a9~74@)) b9~76@))) (=> (= tmp%10@ (= temp_9_0~1622@ temp_9_1~1659@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1727@ (Mul (Mul c10~86@ (Sub (Mul b10~84@ a10~82@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ c10~86@))))) (=> (= temp_10_1~1780@ (Mul (Mul c10~86@ (Sub (Mul b10~84@ a10~82@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1727@ temp_10_1~1780@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1832@ (Mul (Mul (Mul (Sub d11~96@ a11~90@) (Sub a11~90@ a11~90@)) (Mul c11~94@ (Mul d11~96@ c11~94@))) (Mul c11~94@ c11~94@))) (=> (= temp_11_1~1869@ (Mul (Mul (Mul (Sub d11~96@ a11~90@) (Sub a11~90@ a11~90@)) (Mul (Mul c11~94@ d11~96@) c11~94@)) (Mul c11~94@ c11~94@))) (=> (= tmp%12@ (= temp_11_0~1832@ temp_11_1~1869@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1945@ (Mul (Mul (Mul (Mul b12~100@ b12~100@) (Sub b12~100@ a12~98@)) (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ d12~104@))) (Mul (Mul (Mul b12~100@ b12~100@) (Add c12~102@ b12~100@)) (Mul (Mul a12~98@ a12~98@) b12~100@)))) (=> (= temp_12_1~2014@ (Mul (Mul (Sub (Mul (Mul b12~100@ b12~100@) b12~100@) (Mul (Mul b12~100@ b12~100@) a12~98@)) (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ d12~104@))) (Mul (Mul (Mul b12~100@ b12~100@) (Add c12~102@ b12~100@)) (Mul (Mul a12~98@ a12~98@) b12~100@)))) (=> (= tmp%13@ (= temp_12_0~1945@ temp_12_1~2014@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2070@ (Mul (Mul b13~108@ b13~108@) (Mul (Mul (Mul c13~110@ b13~108@) (Mul a13~106@ a13~106@)) (Mul (Mul b13~108@ a13~106@) (Sub d13~112@ c13~110@))))) (=> (= temp_13_1~2111@ (Mul (Mul b13~108@ b13~108@) (Mul (Mul (Mul c13~110@ b13~108@) (Mul a13~106@ a13~106@)) (Mul (Mul a13~106@ b13~108@) (Sub d13~112@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2070@ temp_13_1~2111@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2191@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ b14~116@) (Mul d14~120@ d14~120@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Add a14~114@ b14~116@) (Mul a14~114@ c14~118@))))) (=> (= temp_14_1~2256@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ b14~116@) (Mul d14~120@ d14~120@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Mul a14~114@ c14~118@) (Add a14~114@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2191@ temp_14_1~2256@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2332@ (Sub (Mul (Mul a15~122@ (Mul d15~128@ c15~126@)) (Add (Sub c15~126@ a15~122@) (Add b15~124@ a15~122@))) (Mul (Mul (Sub d15~128@ d15~128@) (Mul c15~126@ a15~122@)) (Add (Mul b15~124@ d15~128@) (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~2393@ (Sub (Mul (Mul a15~122@ (Mul d15~128@ c15~126@)) (Add (Sub c15~126@ a15~122@) (Add b15~124@ a15~122@))) (Mul (Sub d15~128@ d15~128@) (Mul (Mul c15~126@ a15~122@) (Add (Mul b15~124@ d15~128@) (Mul a15~122@ c15~126@)))))) (=> (= tmp%16@ (= temp_15_0~2332@ temp_15_1~2393@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2461@ (Mul (Mul (Mul (Mul c16~134@ c16~134@) (Add a16~130@ d16~136@)) (Add (Mul d16~136@ d16~136@) a16~130@)) (Mul (Mul (Mul b16~132@ c16~134@) d16~136@) (Mul a16~130@ (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2514@ (Mul (Mul (Mul (Add a16~130@ d16~136@) (Mul c16~134@ c16~134@)) (Add (Mul d16~136@ d16~136@) a16~130@)) (Mul (Mul (Mul b16~132@ c16~134@) d16~136@) (Mul a16~130@ (Mul c16~134@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2461@ temp_16_1~2514@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2582@ (Sub (Mul c17~142@ (Sub (Mul b17~140@ c17~142@) (Mul a17~138@ a17~138@))) (Mul (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ a17~138@)) (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ a17~138@))))) (=> (= temp_17_1~2635@ (Sub (Mul c17~142@ (Sub (Mul b17~140@ c17~142@) (Mul a17~138@ a17~138@))) (Mul (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ a17~138@)) (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ c17~142@))))) (=> (= tmp%18@ (= temp_17_0~2582@ temp_17_1~2635@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2715@ (Mul (Mul (Mul (Mul d18~152@ b18~148@) (Mul a18~146@ c18~150@)) (Mul (Mul d18~152@ a18~146@) (Mul a18~146@ c18~150@))) (Sub (Mul (Add b18~148@ a18~146@) (Mul a18~146@ d18~152@)) (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~2780@ (Mul (Mul (Mul d18~152@ (Mul b18~148@ (Mul a18~146@ c18~150@))) (Mul (Mul d18~152@ a18~146@) (Mul a18~146@ c18~150@))) (Sub (Mul (Add b18~148@ a18~146@) (Mul a18~146@ d18~152@)) (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ d18~152@))))) (=> (= tmp%19@ (= temp_18_0~2715@ temp_18_1~2780@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2860@ (Mul (Mul (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ b19~156@)) (Add (Add d19~160@ d19~160@) (Mul b19~156@ c19~158@))) (Mul (Mul (Mul a19~154@ a19~154@) (Sub a19~154@ a19~154@)) (Mul (Mul c19~158@ d19~160@) (Mul a19~154@ c19~158@))))) (=> (= temp_19_1~2925@ (Mul (Mul (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ b19~156@)) (Add (Add d19~160@ d19~160@) (Mul b19~156@ c19~158@))) (Mul (Mul (Mul a19~154@ a19~154@) (Sub a19~154@ a19~154@)) (Mul (Mul a19~154@ c19~158@) (Mul c19~158@ d19~160@))))) (=> (= tmp%20@ (= temp_19_0~2860@ temp_19_1~2925@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3017@ (Mul (Mul (Mul (Mul b20~164@ c20~166@) (Mul a20~162@ a20~162@)) (Mul (Mul d20~168@ b20~164@) (Mul 16 c20~166@))) (Sub d20~168@ (Mul (Mul 68 c20~166@) (Mul b20~164@ b20~164@))))) (=> (= temp_20_1~3094@ (Mul (Mul (Mul (Mul b20~164@ c20~166@) (Mul a20~162@ a20~162@)) (Mul (Mul d20~168@ b20~164@) (Mul 16 c20~166@))) (Sub d20~168@ (Mul (Mul (Mul 68 c20~166@) b20~164@) b20~164@)))) (=> (= tmp%21@ (= temp_20_0~3017@ temp_20_1~3094@)) (=> %%location_label%%20 tmp%21@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
