...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) c0~6@) (Mul (Mul c0~6@ b0~4@) (Add d0~8@ 29))) (Mul (Add (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@)) (Sub (Mul d0~8@ d0~8@) (Add c0~6@ a0~2@))))) (=> (= temp_0_1~386@ (Mul (Mul (Mul (Mul (Mul b0~4@ a0~2@) c0~6@) (Mul (Mul c0~6@ b0~4@) (Add d0~8@ 29))) (Add (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Sub (Mul d0~8@ d0~8@) (Add c0~6@ a0~2@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~386@))) (=> (= temp_0_0~313@ temp_0_1~386@) (=> (= temp_1_0~467@ (Mul (Add (Mul (Add c1~14@ b1~12@) a1~10@) (Mul (Mul a1~10@ b1~12@) (Sub b1~12@ a1~10@))) (Sub (Mul (Mul a1~10@ a1~10@) (Add d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) d1~16@)))) (=> (= temp_1_1~524@ (Mul (Add (Mul (Add c1~14@ b1~12@) a1~10@) (Mul (Mul a1~10@ b1~12@) (Sub b1~12@ a1~10@))) (Sub (Mul a1~10@ (Mul a1~10@ (Add d1~16@ c1~14@))) (Mul (Mul a1~10@ d1~16@) d1~16@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~467@ temp_1_1~524@))) (=> (= temp_1_0~467@ temp_1_1~524@) (=> (= temp_2_0~601@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@)) a2~18@) (Sub (Mul (Mul d2~24@ a2~18@) (Sub b2~20@ d2~24@)) (Mul (Sub d2~24@ a2~18@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~654@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ a2~18@)) a2~18@) (Sub (Mul (Mul d2~24@ a2~18@) (Sub b2~20@ d2~24@)) (Mul (Sub d2~24@ a2~18@) (Mul c2~22@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~601@ temp_2_1~654@))) (=> (= temp_2_0~601@ temp_2_1~654@) (=> (= temp_3_0~739@ (Mul (Mul (Mul (Sub b3~28@ a3~26@) (Add b3~28@ a3~26@)) (Sub (Sub c3~30@ b3~28@) (Mul a3~26@ c3~30@))) (Mul (Add (Mul c3~30@ c3~30@) b3~28@) (Sub (Add b3~28@ a3~26@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~800@ (Mul (Mul (Mul (Sub b3~28@ a3~26@) (Add b3~28@ a3~26@)) (Sub (Sub c3~30@ b3~28@) (Mul a3~26@ c3~30@))) (Mul (Add (Mul c3~30@ c3~30@) b3~28@) (Sub (Add b3~28@ a3~26@) (Mul d3~32@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~739@ temp_3_1~800@))) (=> (= temp_3_0~739@ temp_3_1~800@) (=> (= temp_4_0~877@ (Add (Mul (Sub (Sub a4~34@ a4~34@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ c4~38@))) (Add (Sub (Mul c4~38@ c4~38@) (Mul d4~40@ a4~34@)) d4~40@))) (=> (= temp_4_1~930@ (Add (Mul (Sub (Sub a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ c4~38@))) (Add (Sub (Mul c4~38@ c4~38@) (Mul d4~40@ a4~34@)) d4~40@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~877@ temp_4_1~930@))) (=> (= temp_4_0~877@ temp_4_1~930@) (=> (= temp_5_0~1019@ (Mul (Mul (Mul (Sub d5~48@ d5~48@) (Sub a5~42@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~1084@ (Mul (Mul (Mul (Sub d5~48@ d5~48@) (Sub a5~42@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1019@ temp_5_1~1084@))) (=> (= temp_5_0~1019@ temp_5_1~1084@) (=> (= temp_6_0~1169@ (Sub (Mul (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ d6~56@)) (Sub b6~52@ (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1230@ (Sub (Mul (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ d6~56@))) (Mul (Sub b6~52@ (Mul c6~54@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1169@ temp_6_1~1230@))) (=> (= temp_6_0~1169@ temp_6_1~1230@) (=> (= temp_7_0~1319@ (Mul (Mul (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Sub c7~62@ b7~60@) (Add d7~64@ d7~64@))) (Sub (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ a7~58@)) (Add (Mul c7~62@ c7~62@) (Add c7~62@ a7~58@))))) (=> (= temp_7_1~1384@ (Mul (Mul (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Sub c7~62@ b7~60@) (Add d7~64@ d7~64@))) (Sub (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ a7~58@)) (Add (Mul c7~62@ c7~62@) (Add c7~62@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1319@ temp_7_1~1384@))) (=> (= temp_7_0~1319@ temp_7_1~1384@) (=> (= temp_8_0~1481@ (Mul (Mul (Mul b8~68@ (Mul c8~70@ c8~70@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ a8~66@))) (Mul (Sub (Mul 95 b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Add c8~70@ c8~70@))))) (=> (= temp_8_1~1554@ (Mul (Mul (Mul b8~68@ (Mul c8~70@ c8~70@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ a8~66@))) (Mul (Sub (Mul 95 b8~68@) (Mul b8~68@ b8~68@)) (Mul (Add c8~70@ c8~70@) (Mul d8~72@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1481@ temp_8_1~1554@))) (=> (= temp_8_0~1481@ temp_8_1~1554@) (=> (= temp_9_0~1639@ (Mul (Mul (Mul (Sub a9~74@ d9~80@) c9~78@) (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ a9~74@))) (Mul (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~1700@ (Mul (Mul (Mul (Sub a9~74@ d9~80@) c9~78@) (Mul (Mul c9~78@ b9~76@) (Mul c9~78@ a9~74@))) (Mul (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1639@ temp_9_1~1700@))) (=> (= temp_9_0~1639@ temp_9_1~1700@) (=> (= temp_10_0~1809@ (Mul (Mul (Mul (Add d10~88@ c10~86@) b10~84@) (Add (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))) (Mul (Mul (Mul 42 c10~86@) (Mul c10~86@ c10~86@)) (Mul (Mul c10~86@ b10~84@) (Sub 13 d10~88@))))) (=> (= temp_10_1~1894@ (Mul (Mul (Mul (Add d10~88@ c10~86@) b10~84@) (Add (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))) (Mul (Mul (Mul 42 c10~86@) (Mul c10~86@ c10~86@)) (Mul (Sub 13 d10~88@) (Mul c10~86@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1809@ temp_10_1~1894@))) (=> (= temp_10_0~1809@ temp_10_1~1894@) (=> (= temp_11_0~1983@ (Mul (Mul (Mul (Mul b11~92@ a11~90@) (Sub c11~94@ c11~94@)) (Sub (Mul b11~92@ a11~90@) (Add d11~96@ a11~90@))) (Mul (Sub (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Add d11~96@ c11~94@) (Mul b11~92@ d11~96@))))) (=> (= temp_11_1~2048@ (Mul (Mul (Sub (Mul b11~92@ a11~90@) (Add d11~96@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Sub c11~94@ c11~94@))) (Mul (Sub (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Add d11~96@ c11~94@) (Mul b11~92@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1983@ temp_11_1~2048@))) (=> (= temp_11_0~1983@ temp_11_1~2048@) (=> (= temp_12_0~2133@ (Mul (Mul (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ d12~104@)) (Mul (Add d12~104@ c12~102@) (Mul b12~100@ c12~102@))) (Mul (Mul (Sub d12~104@ b12~100@) (Mul d12~104@ a12~98@)) (Add c12~102@ (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2194@ (Mul (Mul (Mul (Mul d12~104@ d12~104@) (Mul d12~104@ c12~102@)) (Mul (Add d12~104@ c12~102@) (Mul b12~100@ c12~102@))) (Mul (Mul (Sub d12~104@ b12~100@) (Mul d12~104@ a12~98@)) (Add c12~102@ (Mul a12~98@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2133@ temp_12_1~2194@))) (=> (= temp_12_0~2133@ temp_12_1~2194@) (=> (= temp_13_0~2267@ (Mul (Mul (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@)) (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ a13~106@))) (Sub c13~110@ (Add d13~112@ (Add c13~110@ c13~110@))))) (=> (= temp_13_1~2316@ (Mul (Sub c13~110@ (Add d13~112@ (Add c13~110@ c13~110@))) (Mul (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@)) (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2267@ temp_13_1~2316@))) (=> (= temp_13_0~2267@ temp_13_1~2316@) (=> (= temp_14_0~2405@ (Mul (Sub (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@)) (Mul (Mul a14~114@ b14~116@) (Mul a14~114@ b14~116@))) (Mul (Mul (Add c14~118@ b14~116@) (Mul c14~118@ a14~114@)) (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ b14~116@))))) (=> (= temp_14_1~2470@ (Mul (Mul (Sub (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@)) (Mul (Mul a14~114@ b14~116@) (Mul a14~114@ b14~116@))) (Mul (Add c14~118@ b14~116@) (Mul c14~118@ a14~114@))) (Mul (Mul d14~120@ d14~120@) (Mul d14~120@ b14~116@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2405@ temp_14_1~2470@))) (=> (= temp_14_0~2405@ temp_14_1~2470@) (=> (= temp_15_0~2583@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Sub a15~122@ d15~128@)) (Mul (Mul c15~126@ a15~122@) (Mul b15~124@ 64))) (Mul (Mul (Mul a15~122@ b15~124@) (Sub c15~126@ d15~128@)) (Mul (Sub 92 d15~128@) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~2672@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Sub a15~122@ d15~128@)) (Mul (Mul c15~126@ a15~122@) (Mul b15~124@ 64))) (Mul (Mul (Mul a15~122@ b15~124@) (Sub c15~126@ d15~128@)) (Mul (Sub 92 d15~128@) (Mul a15~122@ d15~128@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2583@ temp_15_1~2672@))) (=> (= temp_15_0~2583@ temp_15_1~2672@) (=> (= temp_16_0~2761@ (Mul (Mul (Add (Mul c16~134@ b16~132@) (Mul a16~130@ d16~136@)) (Sub (Mul d16~136@ b16~132@) (Mul d16~136@ c16~134@))) (Mul (Mul (Sub c16~134@ a16~130@) (Mul d16~136@ a16~130@)) (Mul (Mul a16~130@ d16~136@) (Mul a16~130@ b16~132@))))) (=> (= temp_16_1~2826@ (Mul (Mul (Add (Mul c16~134@ b16~132@) (Mul a16~130@ d16~136@)) (Sub (Mul d16~136@ b16~132@) (Mul d16~136@ c16~134@))) (Mul (Mul (Mul (Sub c16~134@ a16~130@) d16~136@) a16~130@) (Mul (Mul a16~130@ d16~136@) (Mul a16~130@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2761@ temp_16_1~2826@))) (=> (= temp_16_0~2761@ temp_16_1~2826@) (=> (= temp_17_0~2915@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ c17~142@)) (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ c17~142@))) (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ (Mul b17~140@ 90))))) (=> (= temp_17_1~2980@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ c17~142@)) (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ c17~142@))) (Mul (Mul c17~142@ (Mul b17~140@ 90)) (Mul b17~140@ a17~138@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2915@ temp_17_1~2980@))) (=> (= temp_17_0~2915@ temp_17_1~2980@) (=> (= temp_18_0~3081@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ c18~150@)) (Mul (Mul a18~146@ d18~152@) (Mul c18~150@ b18~148@))) (Mul (Mul (Mul b18~148@ a18~146@) (Mul a18~146@ 9)) (Mul (Mul b18~148@ b18~148@) (Mul d18~152@ a18~146@))))) (=> (= temp_18_1~3158@ (Mul (Mul (Mul (Mul b18~148@ a18~146@) (Mul a18~146@ 9)) (Mul (Mul b18~148@ b18~148@) (Mul d18~152@ a18~146@))) (Mul (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ c18~150@)) (Mul (Mul a18~146@ d18~152@) (Mul c18~150@ b18~148@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3081@ temp_18_1~3158@))) (=> (= temp_18_0~3081@ temp_18_1~3158@) (=> (= temp_19_0~3235@ (Mul (Mul a19~154@ (Mul (Mul d19~160@ a19~154@) (Mul d19~160@ a19~154@))) (Mul (Mul (Mul d19~160@ b19~156@) (Mul d19~160@ b19~156@)) (Mul (Sub d19~160@ a19~154@) (Mul a19~154@ a19~154@))))) (=> (= temp_19_1~3288@ (Mul (Mul a19~154@ (Mul (Mul d19~160@ a19~154@) (Mul d19~160@ a19~154@))) (Mul (Mul (Mul d19~160@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Sub d19~160@ a19~154@) (Mul a19~154@ a19~154@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3235@ temp_19_1~3288@))) (=> (= temp_19_0~3235@ temp_19_1~3288@) (=> (= temp_20_0~3377@ (Mul (Mul (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ a20~162@)) (Sub (Add c20~166@ d20~168@) (Sub a20~162@ c20~166@))) (Mul (Mul (Mul d20~168@ a20~162@) (Mul a20~162@ a20~162@)) (Mul (Mul a20~162@ b20~164@) (Sub b20~164@ b20~164@))))) (=> (= temp_20_1~3442@ (Mul (Mul (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ a20~162@)) (Sub (Add c20~166@ d20~168@) (Sub a20~162@ c20~166@))) (Mul (Mul (Mul d20~168@ a20~162@) (Mul a20~162@ a20~162@)) (Mul (Sub b20~164@ b20~164@) (Mul a20~162@ b20~164@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3377@ temp_20_1~3442@))) (=> (= temp_20_0~3377@ temp_20_1~3442@) (=> (= temp_21_0~3527@ (Mul (Mul (Mul (Add a21~170@ b21~172@) (Mul b21~172@ d21~176@)) (Mul (Mul b21~172@ a21~170@) (Mul c21~174@ b21~172@))) (Mul (Add (Mul a21~170@ a21~170@) c21~174@) (Mul (Mul a21~170@ b21~172@) (Add c21~174@ a21~170@))))) (=> (= temp_21_1~3588@ (Mul (Mul (Mul (Mul (Add a21~170@ b21~172@) (Mul b21~172@ d21~176@)) (Mul (Mul b21~172@ a21~170@) (Mul c21~174@ b21~172@))) (Add (Mul a21~170@ a21~170@) c21~174@)) (Mul (Mul a21~170@ b21~172@) (Add c21~174@ a21~170@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3527@ temp_21_1~3588@))) (=> (= temp_21_0~3527@ temp_21_1~3588@) (=> (= temp_22_0~3677@ (Mul (Mul (Mul (Mul b22~180@ a22~178@) (Mul b22~180@ d22~184@)) (Mul (Mul c22~182@ a22~178@) (Mul c22~182@ b22~180@))) (Mul (Mul (Mul c22~182@ d22~184@) (Add a22~178@ a22~178@)) (Mul (Mul d22~184@ c22~182@) (Mul c22~182@ d22~184@))))) (=> (= temp_22_1~3742@ (Mul (Mul (Mul (Mul b22~180@ a22~178@) (Mul b22~180@ d22~184@)) (Mul (Mul a22~178@ c22~182@) (Mul c22~182@ b22~180@))) (Mul (Mul (Mul c22~182@ d22~184@) (Add a22~178@ a22~178@)) (Mul (Mul d22~184@ c22~182@) (Mul c22~182@ d22~184@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3677@ temp_22_1~3742@))) (=> (= temp_22_0~3677@ temp_22_1~3742@) (=> (= temp_23_0~3827@ (Mul (Mul (Mul (Mul b23~188@ b23~188@) (Add c23~190@ c23~190@)) (Mul (Mul a23~186@ a23~186@) c23~190@)) (Mul (Mul (Add b23~188@ c23~190@) (Mul d23~192@ d23~192@)) (Mul (Mul d23~192@ b23~188@) (Mul a23~186@ d23~192@))))) (=> (= temp_23_1~3888@ (Mul (Mul (Mul (Add b23~188@ c23~190@) (Mul d23~192@ d23~192@)) (Mul (Mul d23~192@ b23~188@) (Mul a23~186@ d23~192@))) (Mul (Mul (Mul b23~188@ b23~188@) (Add c23~190@ c23~190@)) (Mul (Mul a23~186@ a23~186@) c23~190@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3827@ temp_23_1~3888@))) (=> (= temp_23_0~3827@ temp_23_1~3888@) (=> (= temp_24_0~3977@ (Mul (Sub (Mul (Mul c24~198@ d24~200@) (Mul c24~198@ d24~200@)) (Mul (Sub d24~200@ c24~198@) (Mul a24~194@ c24~198@))) (Mul (Mul (Mul d24~200@ b24~196@) (Add a24~194@ d24~200@)) (Mul (Mul a24~194@ d24~200@) (Mul c24~198@ d24~200@))))) (=> (= temp_24_1~4042@ (Mul (Sub (Mul (Mul c24~198@ d24~200@) (Mul c24~198@ d24~200@)) (Mul (Sub d24~200@ c24~198@) (Mul a24~194@ c24~198@))) (Mul (Mul (Mul d24~200@ b24~196@) (Add a24~194@ d24~200@)) (Mul (Mul c24~198@ d24~200@) (Mul a24~194@ d24~200@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3977@ temp_24_1~4042@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
