...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Mul a0~2@ 99) (Mul d0~8@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@))) (Sub (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Add d0~8@ b0~4@) (Sub c0~6@ b0~4@))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul a0~2@ 99) (Mul d0~8@ a0~2@)) (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@)) (Sub (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Add d0~8@ b0~4@) (Sub c0~6@ b0~4@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~475@ (Mul (Mul (Mul (Add d1~16@ a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@ a1~10@) c1~14@)) (Mul (Mul c1~14@ (Add a1~10@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~532@ (Mul (Mul (Mul (Add d1~16@ a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@ a1~10@) c1~14@)) (Mul (Mul c1~14@ (Add a1~10@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~475@ temp_1_1~532@))) (=> (= temp_1_0~475@ temp_1_1~532@) (=> (= temp_2_0~625@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ a2~18@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))) (Mul (Add (Mul 26 b2~20@) (Mul a2~18@ b2~20@)) (Mul d2~24@ c2~22@)))) (=> (= temp_2_1~694@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))) (Mul (Add (Mul 26 b2~20@) (Mul a2~18@ b2~20@)) (Mul d2~24@ c2~22@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~625@ temp_2_1~694@))) (=> (= temp_2_0~625@ temp_2_1~694@) (=> (= temp_3_0~783@ (Add (Add (Sub (Mul c3~30@ c3~30@) (Mul c3~30@ a3~26@)) (Mul (Add a3~26@ a3~26@) (Add b3~28@ c3~30@))) (Mul (Mul (Sub a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Sub (Mul c3~30@ c3~30@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~844@ (Add (Add (Sub (Mul c3~30@ c3~30@) (Mul c3~30@ a3~26@)) (Mul (Add a3~26@ a3~26@) (Add b3~28@ c3~30@))) (Mul (Mul (Sub a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Mul c3~30@ (Sub c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~783@ temp_3_1~844@))) (=> (= temp_3_0~783@ temp_3_1~844@) (=> (= temp_4_0~901@ (Mul c4~38@ (Mul (Sub (Mul a4~34@ c4~38@) (Mul d4~40@ b4~36@)) (Sub d4~40@ (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~934@ (Mul c4~38@ (Mul (Sub (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@)) (Sub d4~40@ (Mul a4~34@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~901@ temp_4_1~934@))) (=> (= temp_4_0~901@ temp_4_1~934@) (=> (= temp_5_0~1035@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@)) (Sub (Mul c5~46@ a5~42@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ 23))))) (=> (= temp_5_1~1112@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@)) (Sub (Mul c5~46@ a5~42@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ 23))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1035@ temp_5_1~1112@))) (=> (= temp_5_0~1035@ temp_5_1~1112@) (=> (= temp_6_0~1213@ (Mul (Mul (Add (Mul a6~50@ c6~54@) (Mul b6~52@ b6~52@)) (Add (Mul a6~50@ b6~52@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ 61)) (Sub (Mul a6~50@ d6~56@) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1290@ (Mul (Mul (Add (Mul a6~50@ c6~54@) (Mul b6~52@ b6~52@)) (Add (Mul a6~50@ b6~52@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul b6~52@ 61) (Mul d6~56@ d6~56@)) (Sub (Mul a6~50@ d6~56@) (Mul d6~56@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1213@ temp_6_1~1290@))) (=> (= temp_6_0~1213@ temp_6_1~1290@) (=> (= temp_7_0~1379@ (Sub (Mul (Sub (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@)) (Add (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@))) (Add (Mul (Add d7~64@ a7~58@) (Add b7~60@ c7~62@)) (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1444@ (Sub (Mul (Add (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@)) (Sub (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@))) (Add (Mul (Add d7~64@ a7~58@) (Add b7~60@ c7~62@)) (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1379@ temp_7_1~1444@))) (=> (= temp_7_0~1379@ temp_7_1~1444@) (=> (= temp_8_0~1529@ (Mul (Add (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Sub a8~66@ c8~70@) d8~72@)))) (=> (= temp_8_1~1590@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Sub a8~66@ c8~70@) d8~72@)) (Add (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1529@ temp_8_1~1590@))) (=> (= temp_8_0~1529@ temp_8_1~1590@) (=> (= temp_9_0~1667@ (Mul (Sub (Mul (Mul a9~74@ a9~74@) d9~80@) (Mul (Mul c9~78@ c9~78@) d9~80@)) (Mul (Sub (Mul a9~74@ d9~80@) c9~78@) (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~1720@ (Mul (Sub (Mul d9~80@ (Mul a9~74@ a9~74@)) (Mul (Mul c9~78@ c9~78@) d9~80@)) (Mul (Sub (Mul a9~74@ d9~80@) c9~78@) (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1667@ temp_9_1~1720@))) (=> (= temp_9_0~1667@ temp_9_1~1720@) (=> (= temp_10_0~1809@ (Mul (Sub (Mul (Sub b10~84@ d10~88@) (Add d10~88@ c10~86@)) (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ c10~86@))) (Mul (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Add c10~86@ b10~84@))))) (=> (= temp_10_1~1874@ (Mul (Sub (Mul (Sub b10~84@ d10~88@) (Add d10~88@ c10~86@)) (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ c10~86@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul b10~84@ b10~84@)) (Mul (Mul a10~82@ d10~88@) (Add c10~86@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1809@ temp_10_1~1874@))) (=> (= temp_10_0~1809@ temp_10_1~1874@) (=> (= temp_11_0~1975@ (Mul (Mul (Mul (Sub b11~92@ d11~96@) (Sub d11~96@ a11~90@)) (Sub (Mul 33 b11~92@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ d11~96@)) (Sub (Sub b11~92@ a11~90@) (Mul c11~94@ a11~90@))))) (=> (= temp_11_1~2052@ (Mul (Mul (Mul (Sub b11~92@ d11~96@) (Sub d11~96@ a11~90@)) (Sub (Mul 33 b11~92@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ c11~94@)) (Sub (Sub b11~92@ a11~90@) (Mul c11~94@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1975@ temp_11_1~2052@))) (=> (= temp_11_0~1975@ temp_11_1~2052@) (=> (= temp_12_0~2165@ (Mul (Add (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ d12~104@)) (Mul (Mul b12~100@ 40) (Mul b12~100@ c12~102@))) (Mul (Mul (Sub d12~104@ c12~102@) (Mul c12~102@ d12~104@)) (Sub (Mul b12~100@ d12~104@) (Sub 71 d12~104@))))) (=> (= temp_12_1~2254@ (Mul (Add (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ d12~104@)) (Mul (Mul 40 b12~100@) (Mul b12~100@ c12~102@))) (Mul (Mul (Sub d12~104@ c12~102@) (Mul c12~102@ d12~104@)) (Sub (Mul b12~100@ d12~104@) (Sub 71 d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2165@ temp_12_1~2254@))) (=> (= temp_12_0~2165@ temp_12_1~2254@) (=> (= temp_13_0~2355@ (Mul (Mul (Add (Sub 8 b13~108@) (Mul c13~110@ c13~110@)) (Mul (Mul d13~112@ c13~110@) (Mul d13~112@ b13~108@))) (Mul (Mul (Sub d13~112@ d13~112@) (Mul b13~108@ c13~110@)) (Sub (Mul b13~108@ b13~108@) (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~2448@ (Mul (Mul (Add (Sub 8 b13~108@) (Mul c13~110@ c13~110@)) (Mul (Mul d13~112@ c13~110@) (Mul d13~112@ b13~108@))) (Sub (Mul (Mul (Sub d13~112@ d13~112@) (Mul b13~108@ c13~110@)) (Mul b13~108@ b13~108@)) (Mul (Mul (Sub d13~112@ d13~112@) (Mul b13~108@ c13~110@)) (Mul d13~112@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2355@ temp_13_1~2448@))) (=> (= temp_13_0~2355@ temp_13_1~2448@) (=> (= temp_14_0~2509@ (Mul b14~116@ (Mul a14~114@ (Mul (Mul c14~118@ c14~118@) (Sub 74 d14~120@))))) (=> (= temp_14_1~2546@ (Mul (Mul a14~114@ (Mul (Mul c14~118@ c14~118@) (Sub 74 d14~120@))) b14~116@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2509@ temp_14_1~2546@))) (=> (= temp_14_0~2509@ temp_14_1~2546@) (=> (= temp_15_0~2631@ (Mul (Mul b15~124@ (Mul (Mul b15~124@ a15~122@) (Mul 28 d15~128@))) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ a15~122@)) (Mul (Mul d15~128@ b15~124@) b15~124@)))) (=> (= temp_15_1~2692@ (Mul (Mul b15~124@ (Mul (Mul b15~124@ a15~122@) (Mul d15~128@ 28))) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ a15~122@)) (Mul (Mul d15~128@ b15~124@) b15~124@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2631@ temp_15_1~2692@))) (=> (= temp_15_0~2631@ temp_15_1~2692@) (=> (= temp_16_0~2777@ (Mul (Mul (Sub (Mul d16~136@ d16~136@) (Mul d16~136@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ a16~130@))) (Mul (Sub (Sub d16~136@ d16~136@) (Mul b16~132@ b16~132@)) (Mul (Add a16~130@ b16~132@) d16~136@)))) (=> (= temp_16_1~2838@ (Mul (Mul (Sub (Sub d16~136@ d16~136@) (Mul b16~132@ b16~132@)) (Mul (Add a16~130@ b16~132@) d16~136@)) (Mul (Sub (Mul d16~136@ d16~136@) (Mul d16~136@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2777@ temp_16_1~2838@))) (=> (= temp_16_0~2777@ temp_16_1~2838@) (=> (= temp_17_0~2939@ (Mul (Mul (Mul (Sub c17~142@ c17~142@) (Mul c17~142@ 88)) (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ a17~138@))) (Mul (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul b17~140@ d17~144@))))) (=> (= temp_17_1~3016@ (Mul (Mul (Mul (Mul c17~142@ a17~138@) (Mul c17~142@ a17~138@)) (Mul (Sub c17~142@ c17~142@) (Mul c17~142@ 88))) (Mul (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul b17~140@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2939@ temp_17_1~3016@))) (=> (= temp_17_0~2939@ temp_17_1~3016@) (=> (= temp_18_0~3105@ (Mul (Mul (Mul (Sub d18~152@ c18~150@) (Mul a18~146@ d18~152@)) (Mul (Mul a18~146@ b18~148@) (Mul b18~148@ a18~146@))) (Mul (Mul (Mul b18~148@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ c18~150@))))) (=> (= temp_18_1~3178@ (Mul (Mul (Sub (Mul d18~152@ (Mul a18~146@ d18~152@)) (Mul c18~150@ (Mul a18~146@ d18~152@))) (Mul (Mul a18~146@ b18~148@) (Mul b18~148@ a18~146@))) (Mul (Mul (Mul b18~148@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3105@ temp_18_1~3178@))) (=> (= temp_18_0~3105@ temp_18_1~3178@) (=> (= temp_19_0~3255@ (Mul (Mul (Add (Sub a19~154@ c19~158@) (Mul a19~154@ c19~158@)) a19~154@) (Mul (Add (Sub c19~158@ b19~156@) (Mul d19~160@ d19~160@)) (Sub (Sub c19~158@ d19~160@) (Mul b19~156@ d19~160@))))) (=> (= temp_19_1~3308@ (Mul (Mul (Add (Sub a19~154@ c19~158@) (Mul a19~154@ c19~158@)) a19~154@) (Mul (Sub (Sub c19~158@ d19~160@) (Mul b19~156@ d19~160@)) (Add (Sub c19~158@ b19~156@) (Mul d19~160@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3255@ temp_19_1~3308@))) (=> (= temp_19_0~3255@ temp_19_1~3308@) (=> (= temp_20_0~3393@ (Sub (Mul (Add (Mul d20~168@ c20~166@) (Mul c20~166@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Sub a20~162@ b20~164@))) (Mul (Sub c20~166@ (Mul d20~168@ a20~162@)) (Add (Mul a20~162@ c20~166@) (Mul b20~164@ a20~162@))))) (=> (= temp_20_1~3470@ (Sub (Add (Mul (Mul d20~168@ c20~166@) (Mul (Mul b20~164@ a20~162@) (Sub a20~162@ b20~164@))) (Mul (Mul c20~166@ c20~166@) (Mul (Mul b20~164@ a20~162@) (Sub a20~162@ b20~164@)))) (Mul (Sub c20~166@ (Mul d20~168@ a20~162@)) (Add (Mul a20~162@ c20~166@) (Mul b20~164@ a20~162@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3393@ temp_20_1~3470@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
