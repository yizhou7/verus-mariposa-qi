...
(assert (=> %%query%% (not (=> (= temp_0_0~309@ (Mul (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ a0~2@))) (Sub (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ b0~4@)) (Mul b0~4@ (Add a0~2@ d0~8@)))) (Mul (Mul (Mul (Sub b0~4@ d0~8@) (Sub c0~6@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Sub b0~4@ c0~6@))) (Add (Mul (Sub 87 a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ 80) (Mul c0~6@ b0~4@)))))) (=> (= temp_0_1~458@ (Mul (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ a0~2@))) (Sub (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ b0~4@)) (Mul b0~4@ (Add a0~2@ d0~8@)))) (Mul (Mul (Mul (Sub b0~4@ d0~8@) (Sub c0~6@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Sub b0~4@ c0~6@))) (Add (Mul (Sub 87 a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ 80) (Mul b0~4@ c0~6@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~309@ temp_0_1~458@))) (=> (= temp_0_0~309@ temp_0_1~458@) (=> (= temp_1_0~607@ (Mul (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ b1~12@)) (Mul (Sub b1~12@ a1~10@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul 75 a1~10@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ b1~12@)))) (Mul (Mul d1~16@ (Sub (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@))) (Sub (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@)) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~728@ (Mul (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ b1~12@)) (Mul (Sub b1~12@ a1~10@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul 75 a1~10@) (Mul c1~14@ b1~12@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@)))) (Mul (Mul d1~16@ (Sub (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@))) (Sub (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@)) (Mul c1~14@ a1~10@))))) (and (=> (= tmp%1@ (Mul c1~14@ c1~14@)) (=> (= tmp%2@ (Mul d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~607@ temp_1_1~728@))))) (=> (= temp_1_0~607@ temp_1_1~728@) (=> (= temp_2_0~865@ (Mul (Add (Sub (Mul (Sub c2~22@ b2~20@) (Mul b2~20@ c2~22@)) (Mul (Add c2~22@ a2~18@) b2~20@)) (Mul (Mul (Add c2~22@ b2~20@) (Mul b2~20@ b2~20@)) d2~24@)) (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Add d2~24@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@))) (Mul a2~18@ (Mul (Mul b2~20@ b2~20@) (Add a2~18@ c2~22@)))))) (=> (= temp_2_1~966@ (Mul (Add (Sub (Mul (Sub c2~22@ b2~20@) (Mul b2~20@ c2~22@)) (Mul (Add c2~22@ a2~18@) b2~20@)) (Mul (Mul (Add c2~22@ b2~20@) (Mul b2~20@ b2~20@)) d2~24@)) (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Add d2~24@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@))) (Mul a2~18@ (Mul (Mul b2~20@ b2~20@) (Add a2~18@ c2~22@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ b2~20@) (=> %%location_label%%2 (= temp_2_0~865@ temp_2_1~966@))) (=> (= temp_2_0~865@ temp_2_1~966@) (=> (= temp_3_0~1111@ (Mul (Sub (Mul (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ d3~32@)) (Sub (Mul a3~26@ d3~32@) (Mul d3~32@ b3~28@))) (Mul (Mul (Add a3~26@ d3~32@) (Mul c3~30@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul d3~32@ c3~30@)))) (Mul (Mul (Sub (Mul c3~30@ c3~30@) a3~26@) (Mul d3~32@ (Mul d3~32@ d3~32@))) (Mul (Mul b3~28@ (Mul b3~28@ b3~28@)) (Mul (Add d3~32@ a3~26@) (Add b3~28@ b3~28@)))))) (=> (= temp_3_1~1244@ (Mul (Sub (Mul (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ d3~32@)) (Sub (Mul a3~26@ d3~32@) (Mul d3~32@ b3~28@))) (Add (Mul (Mul (Add a3~26@ d3~32@) (Mul c3~30@ a3~26@)) (Mul d3~32@ a3~26@)) (Mul (Mul (Add a3~26@ d3~32@) (Mul c3~30@ a3~26@)) (Mul d3~32@ c3~30@)))) (Mul (Mul (Sub (Mul c3~30@ c3~30@) a3~26@) (Mul d3~32@ (Mul d3~32@ d3~32@))) (Mul (Mul b3~28@ (Mul b3~28@ b3~28@)) (Mul (Add d3~32@ a3~26@) (Add b3~28@ b3~28@)))))) (and (=> (= tmp%3@ (Mul (Add a3~26@ d3~32@) (Mul c3~30@ a3~26@))) (=> (= tmp%4@ (Mul d3~32@ a3~26@)) (=> (= tmp%5@ (Mul d3~32@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~1111@ temp_3_1~1244@)))))) (=> (= temp_3_0~1111@ temp_3_1~1244@) (=> (= temp_4_0~1431@ (Mul (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ c4~38@)) (Sub (Mul b4~36@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ b4~36@)) (Add (Mul b4~36@ a4~34@) (Mul d4~40@ b4~36@)))) (Mul (Mul (Mul (Mul c4~38@ 98) (Mul d4~40@ a4~34@)) (Mul c4~38@ (Mul d4~40@ a4~34@))) (Mul (Sub (Mul d4~40@ d4~40@) (Add a4~34@ d4~40@)) (Mul (Sub a4~34@ c4~38@) (Add c4~38@ b4~36@)))))) (=> (= temp_4_1~1568@ (Mul (Mul (Mul (Mul (Mul c4~38@ 98) (Mul d4~40@ a4~34@)) (Mul c4~38@ (Mul d4~40@ a4~34@))) (Mul (Sub (Mul d4~40@ d4~40@) (Add a4~34@ d4~40@)) (Mul (Sub a4~34@ c4~38@) (Add c4~38@ b4~36@)))) (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ c4~38@)) (Sub (Mul b4~36@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ b4~36@)) (Add (Mul b4~36@ a4~34@) (Mul d4~40@ b4~36@)))))) (and (=> (= tmp%6@ (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ c4~38@)) (Sub (Mul b4~36@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ b4~36@)) (Add (Mul b4~36@ a4~34@) (Mul d4~40@ b4~36@))))) (=> (= tmp%7@ (Mul (Mul (Mul (Mul c4~38@ 98) (Mul d4~40@ a4~34@)) (Mul c4~38@ (Mul d4~40@ a4~34@))) (Mul (Sub (Mul d4~40@ d4~40@) (Add a4~34@ d4~40@)) (Mul (Sub a4~34@ c4~38@) (Add c4~38@ b4~36@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%4 (= temp_4_0~1431@ temp_4_1~1568@))))) (=> (= temp_4_0~1431@ temp_4_1~1568@) (=> (= temp_5_0~1841@ (Mul (Mul (Mul (Mul (Sub d5~48@ c5~46@) (Mul d5~48@ a5~42@)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ c5~46@))) (Mul a5~42@ (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@)))) (Sub (Mul (Mul (Mul d5~48@ b5~44@) (Add d5~48@ c5~46@)) (Mul (Sub a5~42@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Sub (Sub c5~46@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Add c5~46@ a5~42@) (Mul a5~42@ a5~42@)))))) (=> (= temp_5_1~1966@ (Mul (Mul (Mul (Mul (Sub d5~48@ c5~46@) (Mul d5~48@ a5~42@)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ c5~46@))) (Mul a5~42@ (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@)))) (Sub (Mul (Add (Mul (Mul d5~48@ b5~44@) d5~48@) (Mul (Mul d5~48@ b5~44@) c5~46@)) (Mul (Sub a5~42@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Sub (Sub c5~46@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Add c5~46@ a5~42@) (Mul a5~42@ a5~42@)))))) (and (=> (= tmp%8@ (Mul d5~48@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%8@ d5~48@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1841@ temp_5_1~1966@)))) (=> (= temp_5_0~1841@ temp_5_1~1966@) (=> (= temp_6_0~2121@ (Mul (Mul (Mul (Mul (Add b6~52@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Add c6~54@ a6~50@) (Sub c6~54@ d6~56@))) (Mul (Mul a6~50@ d6~56@) (Mul (Mul a6~50@ d6~56@) (Add c6~54@ a6~50@)))) (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Sub d6~56@ a6~50@)) (Mul (Add c6~54@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ c6~54@)))))) (=> (= temp_6_1~2242@ (Mul (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Sub d6~56@ a6~50@)) (Mul (Add c6~54@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ c6~54@)))) (Mul (Mul (Mul (Add b6~52@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Add c6~54@ a6~50@) (Sub c6~54@ d6~56@))) (Mul (Mul a6~50@ d6~56@) (Mul (Mul a6~50@ d6~56@) (Add c6~54@ a6~50@)))))) (and (=> (= tmp%9@ (Mul (Mul (Mul (Add b6~52@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Add c6~54@ a6~50@) (Sub c6~54@ d6~56@))) (Mul (Mul a6~50@ d6~56@) (Mul (Mul a6~50@ d6~56@) (Add c6~54@ a6~50@))))) (=> (= tmp%10@ (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Sub d6~56@ a6~50@)) (Mul (Add c6~54@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ c6~54@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~2121@ temp_6_1~2242@))))) (=> (= temp_6_0~2121@ temp_6_1~2242@) (=> (= temp_7_0~2511@ (Add (Mul (Add (Add (Mul d7~64@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul c7~62@ c7~62@))) (Mul (Mul (Add a7~58@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)))) (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Add b7~60@ a7~58@)) (Mul (Sub d7~64@ c7~62@) (Mul a7~58@ c7~62@))) (Mul (Mul (Add b7~60@ d7~64@) (Mul c7~62@ a7~58@)) (Sub (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@)))))) (=> (= temp_7_1~2640@ (Add (Mul (Add (Add (Mul d7~64@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul c7~62@ c7~62@))) (Mul (Mul (Add a7~58@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)))) (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Add b7~60@ a7~58@)) (Mul (Sub d7~64@ c7~62@) (Mul a7~58@ c7~62@))) (Mul (Mul (Add b7~60@ d7~64@) (Mul c7~62@ a7~58@)) (Sub (Mul c7~62@ d7~64@) (Mul b7~60@ b7~60@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ c7~62@) (=> %%location_label%%7 (= temp_7_0~2511@ temp_7_1~2640@))) (=> (= temp_7_0~2511@ temp_7_1~2640@) (=> (= temp_8_0~2793@ (Mul (Mul (Add (Mul c8~70@ (Sub b8~68@ a8~66@)) (Sub (Mul a8~66@ c8~70@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ c8~70@)))) (Mul (Mul (Sub (Mul a8~66@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Sub c8~70@ b8~68@))) (Add (Add (Mul a8~66@ b8~68@) (Add d8~72@ c8~70@)) (Mul (Mul b8~68@ d8~72@) (Sub a8~66@ c8~70@)))))) (=> (= temp_8_1~2918@ (Mul (Mul (Add (Mul c8~70@ (Sub b8~68@ a8~66@)) (Sub (Mul a8~66@ c8~70@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ c8~70@)))) (Mul (Sub (Mul a8~66@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul (Mul c8~70@ d8~72@) (Sub c8~70@ b8~68@)) (Add (Add (Mul a8~66@ b8~68@) (Add d8~72@ c8~70@)) (Mul (Mul b8~68@ d8~72@) (Sub a8~66@ c8~70@))))))) (and (=> (= tmp%11@ (Sub (Mul a8~66@ b8~68@) (Mul d8~72@ a8~66@))) (=> (= tmp%12@ (Mul (Mul c8~70@ d8~72@) (Sub c8~70@ b8~68@))) (=> (= tmp%13@ (Add (Add (Mul a8~66@ b8~68@) (Add d8~72@ c8~70@)) (Mul (Mul b8~68@ d8~72@) (Sub a8~66@ c8~70@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%8 (= temp_8_0~2793@ temp_8_1~2918@)))))) (=> (= temp_8_0~2793@ temp_8_1~2918@) (=> (= temp_9_0~3109@ (Mul (Mul (Mul (Mul (Sub a9~74@ d9~80@) (Mul b9~76@ a9~74@)) (Mul (Sub b9~76@ d9~80@) (Mul d9~80@ b9~76@))) (Mul (Mul (Add c9~78@ b9~76@) b9~76@) (Mul (Sub b9~76@ d9~80@) (Mul b9~76@ b9~76@)))) (Mul (Mul d9~80@ (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ c9~78@))) (Add (Mul (Mul c9~78@ d9~80@) (Add d9~80@ c9~78@)) (Mul (Mul c9~78@ c9~78@) d9~80@))))) (=> (= temp_9_1~3218@ (Mul (Mul (Mul (Mul (Sub a9~74@ d9~80@) (Mul b9~76@ a9~74@)) (Mul (Sub b9~76@ d9~80@) (Mul d9~80@ b9~76@))) (Mul (Mul (Add c9~78@ b9~76@) b9~76@) (Mul (Sub b9~76@ d9~80@) (Mul b9~76@ b9~76@)))) (Mul (Mul d9~80@ (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ c9~78@))) (Add (Mul (Mul c9~78@ d9~80@) (Add d9~80@ c9~78@)) (Mul (Mul c9~78@ c9~78@) d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b9~76@ b9~76@) (=> %%location_label%%9 (= temp_9_0~3109@ temp_9_1~3218@))) (=> (= temp_9_0~3109@ temp_9_1~3218@) (=> (= temp_10_0~3371@ (Mul (Mul (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ c10~86@)) (Sub (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@))) (Mul (Mul (Mul a10~82@ c10~86@) b10~84@) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ a10~82@)))) (Mul (Mul (Add (Mul a10~82@ d10~88@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ b10~84@) (Mul b10~84@ c10~86@))) (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Add a10~82@ b10~84@)))))) (=> (= temp_10_1~3496@ (Mul (Mul (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ c10~86@)) (Sub (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@))) (Mul (Mul a10~82@ (Mul c10~86@ b10~84@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ a10~82@)))) (Mul (Mul (Add (Mul a10~82@ d10~88@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ b10~84@) (Mul b10~84@ c10~86@))) (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Add a10~82@ b10~84@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a10~82@ c10~86@ b10~84@) (=> %%location_label%%10 (= temp_10_0~3371@ temp_10_1~3496@))) (=> (= temp_10_0~3371@ temp_10_1~3496@) (=> (= temp_11_0~3615@ (Mul (Mul (Add d11~96@ b11~92@) b11~92@) (Mul (Add (Add (Sub c11~94@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ a11~90@))) (Mul (Sub (Mul a11~90@ 84) (Add b11~92@ d11~96@)) (Mul (Mul c11~94@ d11~96@) (Add c11~94@ d11~96@)))))) (=> (= temp_11_1~3704@ (Mul (Mul (Add d11~96@ b11~92@) b11~92@) (Mul (Add (Add (Sub c11~94@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ a11~90@))) (Mul (Sub (Mul a11~90@ 84) (Add b11~92@ d11~96@)) (Mul (Mul c11~94@ d11~96@) (Add c11~94@ d11~96@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a11~90@ a11~90@) (=> %%location_label%%11 (= temp_11_0~3615@ temp_11_1~3704@))) (=> (= temp_11_0~3615@ temp_11_1~3704@) (=> (= temp_12_0~3865@ (Mul (Mul (Mul (Sub (Mul c12~102@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Mul c12~102@ d12~104@) c12~102@)) (Mul (Mul (Mul b12~100@ a12~98@) (Mul b12~100@ d12~104@)) (Mul (Mul d12~104@ c12~102@) (Sub b12~100@ d12~104@)))) (Sub (Mul (Sub a12~98@ (Mul 4 b12~100@)) c12~102@) (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ b12~100@)) (Mul (Mul a12~98@ c12~102@) (Add a12~98@ 76)))))) (=> (= temp_12_1~3998@ (Mul (Mul (Mul (Mul (Sub (Mul c12~102@ b12~100@) (Mul c12~102@ c12~102@)) (Mul c12~102@ d12~104@)) c12~102@) (Mul (Mul (Mul b12~100@ a12~98@) (Mul b12~100@ d12~104@)) (Mul (Mul d12~104@ c12~102@) (Sub b12~100@ d12~104@)))) (Sub (Mul (Sub a12~98@ (Mul 4 b12~100@)) c12~102@) (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ b12~100@)) (Mul (Mul a12~98@ c12~102@) (Add a12~98@ 76)))))) (and (=> (= tmp%14@ (Sub (Mul c12~102@ b12~100@) (Mul c12~102@ c12~102@))) (=> (= tmp%15@ (Mul c12~102@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ c12~102@) (=> %%location_label%%12 (= temp_12_0~3865@ temp_12_1~3998@))))) (=> (= temp_12_0~3865@ temp_12_1~3998@) (=> (= temp_13_0~4165@ (Mul (Mul c13~110@ (Mul (Add (Mul d13~112@ b13~108@) (Mul c13~110@ d13~112@)) (Sub a13~106@ (Mul a13~106@ c13~110@)))) (Sub (Mul (Mul (Sub d13~112@ 34) (Mul b13~108@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul 48 d13~112@))) (Mul (Add (Mul c13~110@ d13~112@) (Mul a13~106@ b13~108@)) (Mul (Add c13~110@ d13~112@) (Mul a13~106@ c13~110@)))))) (=> (= temp_13_1~4286@ (Mul (Mul c13~110@ (Mul (Add (Mul d13~112@ b13~108@) (Mul c13~110@ d13~112@)) (Sub a13~106@ (Mul a13~106@ c13~110@)))) (Sub (Mul (Mul (Sub d13~112@ 34) (Mul b13~108@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul 48 d13~112@))) (Mul (Add (Mul c13~110@ d13~112@) (Mul a13~106@ b13~108@)) (Mul (Mul a13~106@ c13~110@) (Add c13~110@ d13~112@)))))) (and (=> (= tmp%16@ (Add c13~110@ d13~112@)) (=> (= tmp%17@ (Mul a13~106@ c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%13 (= temp_13_0~4165@ temp_13_1~4286@))))) (=> (= temp_13_0~4165@ temp_13_1~4286@) (=> (= temp_14_0~4419@ (Mul (Sub (Sub (Add (Mul d14~120@ c14~118@) (Mul d14~120@ d14~120@)) (Mul (Mul b14~116@ b14~116@) (Mul a14~114@ b14~116@))) (Mul (Sub c14~118@ (Mul c14~118@ a14~114@)) (Mul d14~120@ (Mul a14~114@ c14~118@)))) (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ c14~118@)) (Mul (Sub d14~120@ a14~114@) (Mul a14~114@ a14~114@))) (Sub c14~118@ c14~118@)))) (=> (= temp_14_1~4524@ (Mul (Sub (Sub (Add (Mul d14~120@ c14~118@) (Mul d14~120@ d14~120@)) (Mul (Mul b14~116@ b14~116@) (Mul a14~114@ b14~116@))) (Mul (Sub c14~118@ (Mul c14~118@ a14~114@)) (Mul d14~120@ (Mul a14~114@ c14~118@)))) (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ c14~118@)) (Sub (Mul d14~120@ (Mul a14~114@ a14~114@)) (Mul a14~114@ (Mul a14~114@ a14~114@)))) (Sub c14~118@ c14~118@)))) (and (=> (= tmp%18@ (Mul a14~114@ a14~114@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d14~120@ a14~114@ tmp%18@) (=> %%location_label%%14 (= temp_14_0~4419@ temp_14_1~4524@)))) (=> (= temp_14_0~4419@ temp_14_1~4524@) (=> (= temp_15_0~4687@ (Mul (Mul (Mul (Mul (Add c15~126@ a15~122@) (Sub c15~126@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ a15~122@))) (Add (Mul (Mul a15~122@ d15~128@) (Add a15~122@ a15~122@)) (Sub (Mul a15~122@ c15~126@) (Mul d15~128@ b15~124@)))) (Mul (Mul (Mul (Mul c15~126@ d15~128@) (Mul d15~128@ b15~124@)) (Sub (Mul b15~124@ d15~128@) (Mul d15~128@ d15~128@))) (Mul (Mul (Mul b15~124@ b15~124@) (Mul a15~122@ a15~122@)) (Mul (Mul c15~126@ d15~128@) (Mul d15~128@ b15~124@)))))) (=> (= temp_15_1~4816@ (Mul (Mul (Mul (Mul (Add c15~126@ a15~122@) (Sub c15~126@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ a15~122@))) (Add (Mul (Mul a15~122@ d15~128@) (Add a15~122@ a15~122@)) (Sub (Mul a15~122@ c15~126@) (Mul d15~128@ b15~124@)))) (Mul (Mul (Mul (Mul c15~126@ d15~128@) (Mul b15~124@ d15~128@)) (Sub (Mul b15~124@ d15~128@) (Mul d15~128@ d15~128@))) (Mul (Mul (Mul b15~124@ b15~124@) (Mul a15~122@ a15~122@)) (Mul (Mul c15~126@ d15~128@) (Mul d15~128@ b15~124@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d15~128@ b15~124@) (=> %%location_label%%15 (= temp_15_0~4687@ temp_15_1~4816@))) (=> (= temp_15_0~4687@ temp_15_1~4816@) (=> (= temp_16_0~4969@ (Mul (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Mul b16~132@ a16~130@)) (Sub (Mul a16~130@ a16~130@) (Mul a16~130@ b16~132@))) (Sub (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ c16~134@)) (Mul (Sub d16~136@ b16~132@) (Mul c16~134@ c16~134@)))) (Mul (Mul (Sub (Add d16~136@ a16~130@) (Mul d16~136@ b16~132@)) (Mul (Sub c16~134@ a16~130@) a16~130@)) (Mul (Sub (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@)) (Mul (Mul a16~130@ c16~134@) (Add d16~136@ c16~134@)))))) (=> (= temp_16_1~5094@ (Mul (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul d16~136@ b16~132@)) (Sub (Mul a16~130@ a16~130@) (Mul a16~130@ b16~132@))) (Sub (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ c16~134@)) (Mul (Sub d16~136@ b16~132@) (Mul c16~134@ c16~134@)))) (Mul (Mul (Sub (Add d16~136@ a16~130@) (Mul d16~136@ b16~132@)) (Mul (Sub c16~134@ a16~130@) a16~130@)) (Mul (Sub (Mul b16~132@ d16~136@) (Mul c16~134@ b16~132@)) (Mul (Mul a16~130@ c16~134@) (Add d16~136@ c16~134@)))))) (=> (= tmp%19@ (Mul d16~136@ b16~132@)) (=> (= tmp%20@ (Mul b16~132@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%16 (= temp_16_0~4969@ temp_16_1~5094@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
