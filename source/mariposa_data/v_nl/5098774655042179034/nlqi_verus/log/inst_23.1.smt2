...
(set-info :comment ";; mariposa_data/v_nl//5098774655042179034/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_10_1~2104@ Int)
(declare-const temp_11_0~2171@ Int)
(declare-const temp_11_1~2204@ Int)
(declare-const temp_12_0~2315@ Int)
(declare-const temp_12_1~2380@ Int)
(declare-const temp_13_0~2475@ Int)
(declare-const temp_13_1~2536@ Int)
(declare-const temp_14_0~2661@ Int)
(declare-const temp_14_1~2738@ Int)
(declare-const temp_15_0~2823@ Int)
(declare-const temp_15_1~2872@ Int)
(declare-const temp_16_0~2969@ Int)
(declare-const temp_16_1~3030@ Int)
(declare-const temp_17_0~3099@ Int)
...
(declare-const temp_19_1~3414@ Int)
(declare-const temp_20_0~3563@ Int)
(declare-const temp_20_1~3676@ Int)
(declare-const temp_21_0~3741@ Int)
(declare-const temp_21_1~3778@ Int)
(declare-const temp_22_0~3899@ Int)
(declare-const temp_22_1~3964@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Sub (Mul (Mul d0~8@ a0~2@) a0~2@) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@)) (Sub (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~378@ (Mul (Sub (Mul (Mul d0~8@ a0~2@) a0~2@) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (Sub (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@)) (Mul d0~8@ d0~8@)) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@)) (Mul d0~8@ b0~4@))))) (and (=> (= tmp%1@ (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (=> (= tmp%2@ (Mul d0~8@ d0~8@)) (=> (= tmp%3@ (Mul d0~8@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~378@)))))) (=> (= temp_0_0~301@ temp_0_1~378@) (=> (= temp_1_0~489@ (Mul (Sub (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Sub d1~16@ d1~16@) b1~12@)) (Mul (Sub (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~550@ (Mul (Sub (Mul (Mul (Mul c1~14@ c1~14@) b1~12@) c1~14@) (Mul (Sub d1~16@ d1~16@) b1~12@)) (Mul (Sub (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ b1~12@))))) (and (=> (= tmp%4@ (Mul c1~14@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ b1~12@ c1~14@) (=> %%location_label%%1 (= temp_1_0~489@ temp_1_1~550@)))) (=> (= temp_1_0~489@ temp_1_1~550@) (=> (= temp_2_0~649@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@)) (Sub (Mul b2~20@ c2~22@) (Sub c2~22@ c2~22@))) (Mul (Mul (Add d2~24@ a2~18@) (Mul d2~24@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Add d2~24@ d2~24@))))) (=> (= temp_2_1~714@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@)) (Sub (Mul b2~20@ c2~22@) (Sub c2~22@ c2~22@))) (Mul (Mul (Mul d2~24@ d2~24@) (Add d2~24@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Add d2~24@ d2~24@))))) (and (=> (= tmp%5@ (Add d2~24@ a2~18@)) (=> (= tmp%6@ (Mul d2~24@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%2 (= temp_2_0~649@ temp_2_1~714@))))) (=> (= temp_2_0~649@ temp_2_1~714@) (=> (= temp_3_0~803@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ c3~30@) (Add c3~30@ d3~32@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ c3~30@)) b3~28@))) (=> (= temp_3_1~856@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ c3~30@) (Add c3~30@ d3~32@))) (Mul b3~28@ (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ c3~30@))))) (and (=> (= tmp%7@ (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ b3~28@) (=> %%location_label%%3 (= temp_3_0~803@ temp_3_1~856@)))) (=> (= temp_3_0~803@ temp_3_1~856@) (=> (= temp_4_0~945@ (Mul (Sub (Mul (Sub d4~40@ c4~38@) (Mul c4~38@ b4~36@)) d4~40@) (Add (Mul a4~34@ (Mul d4~40@ d4~40@)) (Sub (Sub c4~38@ a4~34@) (Sub d4~40@ d4~40@))))) (=> (= temp_4_1~994@ (Mul (Add (Mul a4~34@ (Mul d4~40@ d4~40@)) (Sub (Sub c4~38@ a4~34@) (Sub d4~40@ d4~40@))) (Sub (Mul (Sub d4~40@ c4~38@) (Mul c4~38@ b4~36@)) d4~40@))) (and (=> (= tmp%8@ (Sub (Mul (Sub d4~40@ c4~38@) (Mul c4~38@ b4~36@)) d4~40@)) (=> (= tmp%9@ (Add (Mul a4~34@ (Mul d4~40@ d4~40@)) (Sub (Sub c4~38@ a4~34@) (Sub d4~40@ d4~40@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%4 (= temp_4_0~945@ temp_4_1~994@))))) (=> (= temp_4_0~945@ temp_4_1~994@) (=> (= temp_5_0~1123@ (Add (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ d5~48@))) (Mul (Mul (Sub b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Mul a5~42@ (Mul b5~44@ d5~48@))))) (=> (= temp_5_1~1184@ (Add (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ d5~48@))) (Mul (Mul a5~42@ (Mul b5~44@ d5~48@)) (Mul (Sub b5~44@ c5~46@) (Mul a5~42@ d5~48@))))) (and (=> (= tmp%10@ (Mul (Sub b5~44@ c5~46@) (Mul a5~42@ d5~48@))) (=> (= tmp%11@ (Mul a5~42@ (Mul b5~44@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%5 (= temp_5_0~1123@ temp_5_1~1184@))))) (=> (= temp_5_0~1123@ temp_5_1~1184@) (=> (= temp_6_0~1305@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ 32)) (Add (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@))) (Mul (Add c6~54@ (Mul c6~54@ b6~52@)) (Mul (Mul b6~52@ d6~56@) (Sub a6~50@ a6~50@))))) (=> (= temp_6_1~1378@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ 32)) (Add (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul b6~52@ d6~56@) (Sub a6~50@ a6~50@)) (Add c6~54@ (Mul c6~54@ b6~52@))))) (and (=> (= tmp%12@ (Add c6~54@ (Mul c6~54@ b6~52@))) (=> (= tmp%13@ (Mul (Mul b6~52@ d6~56@) (Sub a6~50@ a6~50@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%6 (= temp_6_0~1305@ temp_6_1~1378@))))) (=> (= temp_6_0~1305@ temp_6_1~1378@) (=> (= temp_7_0~1487@ (Mul (Mul (Mul b7~60@ (Mul b7~60@ b7~60@)) (Mul (Add b7~60@ c7~62@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul c7~62@ a7~58@) (Sub b7~60@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1548@ (Mul (Mul (Mul b7~60@ (Mul b7~60@ b7~60@)) (Mul (Mul (Add b7~60@ c7~62@) d7~64@) a7~58@)) (Mul (Mul (Mul c7~62@ a7~58@) (Sub b7~60@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ d7~64@))))) (and (=> (= tmp%14@ (Add b7~60@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ d7~64@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1487@ temp_7_1~1548@)))) (=> (= temp_7_0~1487@ temp_7_1~1548@) (=> (= temp_8_0~1631@ (Mul (Mul c8~70@ (Mul (Add a8~66@ c8~70@) (Mul c8~70@ a8~66@))) (Mul (Mul c8~70@ (Mul c8~70@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~1680@ (Mul (Mul (Mul c8~70@ (Mul c8~70@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@))) (Mul c8~70@ (Mul (Add a8~66@ c8~70@) (Mul c8~70@ a8~66@))))) (and (=> (= tmp%15@ (Mul c8~70@ (Mul (Add a8~66@ c8~70@) (Mul c8~70@ a8~66@)))) (=> (= tmp%16@ (Mul (Mul c8~70@ (Mul c8~70@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%8 (= temp_8_0~1631@ temp_8_1~1680@))))) (=> (= temp_8_0~1631@ temp_8_1~1680@) (=> (= temp_9_0~1825@ (Sub (Mul (Mul (Mul 7 c9~78@) (Mul b9~76@ c9~78@)) (Mul (Mul a9~74@ b9~76@) (Sub c9~78@ b9~76@))) (Mul (Mul (Add d9~80@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1902@ (Sub (Mul (Mul (Mul a9~74@ b9~76@) (Sub c9~78@ b9~76@)) (Mul (Mul 7 c9~78@) (Mul b9~76@ c9~78@))) (Mul (Mul (Add d9~80@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ c9~78@))))) (and (=> (= tmp%17@ (Mul (Mul 7 c9~78@) (Mul b9~76@ c9~78@))) (=> (= tmp%18@ (Mul (Mul a9~74@ b9~76@) (Sub c9~78@ b9~76@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%9 (= temp_9_0~1825@ temp_9_1~1902@))))) (=> (= temp_9_0~1825@ temp_9_1~1902@) (=> (= temp_10_0~2031@ (Mul (Mul (Mul (Add c10~86@ a10~82@) (Mul a10~82@ b10~84@)) (Mul (Sub a10~82@ d10~88@) (Mul b10~84@ c10~86@))) (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~2104@ (Mul (Mul (Mul (Add c10~86@ a10~82@) (Mul a10~82@ b10~84@)) (Sub (Mul a10~82@ (Mul b10~84@ c10~86@)) (Mul d10~88@ (Mul b10~84@ c10~86@)))) (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ b10~84@))))) (and (=> (= tmp%19@ (Mul b10~84@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a10~82@ d10~88@ tmp%19@) (=> %%location_label%%10 (= temp_10_0~2031@ temp_10_1~2104@)))) (=> (= temp_10_0~2031@ temp_10_1~2104@) (=> (= temp_11_0~2171@ (Mul d11~96@ (Mul (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ c11~94@)) (Mul c11~94@ (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2204@ (Mul d11~96@ (Mul (Mul (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ c11~94@)) c11~94@) (Mul b11~92@ c11~94@)))) (and (=> (= tmp%20@ (Mul (Mul c11~94@ a11~90@) (Mul a11~90@ c11~94@))) (=> (= tmp%21@ (Mul b11~92@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ c11~94@ tmp%21@) (=> %%location_label%%11 (= temp_11_0~2171@ temp_11_1~2204@))))) (=> (= temp_11_0~2171@ temp_11_1~2204@) (=> (= temp_12_0~2315@ (Add (Mul (Mul (Mul b12~100@ c12~102@) (Mul b12~100@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ d12~104@))) (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ c12~102@)) (Add (Mul a12~98@ c12~102@) (Add b12~100@ a12~98@))))) (=> (= temp_12_1~2380@ (Add (Mul (Mul (Mul (Mul b12~100@ c12~102@) b12~100@) a12~98@) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ d12~104@))) (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ c12~102@)) (Add (Mul a12~98@ c12~102@) (Add b12~100@ a12~98@))))) (and (=> (= tmp%22@ (Mul b12~100@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ b12~100@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2315@ temp_12_1~2380@)))) (=> (= temp_12_0~2315@ temp_12_1~2380@) (=> (= temp_13_0~2475@ (Add (Mul (Sub (Mul c13~110@ b13~108@) (Mul a13~106@ c13~110@)) (Mul (Mul c13~110@ c13~110@) a13~106@)) (Mul (Mul (Mul a13~106@ c13~110@) (Mul d13~112@ d13~112@)) (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ b13~108@))))) (=> (= temp_13_1~2536@ (Add (Mul (Mul (Mul c13~110@ c13~110@) a13~106@) (Sub (Mul c13~110@ b13~108@) (Mul a13~106@ c13~110@))) (Mul (Mul (Mul a13~106@ c13~110@) (Mul d13~112@ d13~112@)) (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ b13~108@))))) (and (=> (= tmp%23@ (Sub (Mul c13~110@ b13~108@) (Mul a13~106@ c13~110@))) (=> (= tmp%24@ (Mul (Mul c13~110@ c13~110@) a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> %%location_label%%13 (= temp_13_0~2475@ temp_13_1~2536@))))) (=> (= temp_13_0~2475@ temp_13_1~2536@) (=> (= temp_14_0~2661@ (Add (Add (Mul (Add a14~114@ a14~114@) (Sub c14~118@ d14~120@)) (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul b14~116@ 63)) (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@))))) (=> (= temp_14_1~2738@ (Add (Add (Mul (Sub c14~118@ d14~120@) (Add a14~114@ a14~114@)) (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul b14~116@ 63)) (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ d14~120@))))) (and (=> (= tmp%25@ (Add a14~114@ a14~114@)) (=> (= tmp%26@ (Sub c14~118@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%25@ tmp%26@) (=> %%location_label%%14 (= temp_14_0~2661@ temp_14_1~2738@))))) (=> (= temp_14_0~2661@ temp_14_1~2738@) (=> (= temp_15_0~2823@ (Mul (Mul (Mul (Add a15~122@ c15~126@) d15~128@) (Mul (Mul a15~122@ b15~124@) (Mul d15~128@ a15~122@))) (Sub b15~124@ (Mul (Add c15~126@ c15~126@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2872@ (Mul (Mul (Mul (Add a15~122@ c15~126@) d15~128@) (Mul (Mul a15~122@ b15~124@) (Mul d15~128@ a15~122@))) (Sub b15~124@ (Mul (Mul d15~128@ d15~128@) (Add c15~126@ c15~126@))))) (and (=> (= tmp%27@ (Add c15~126@ c15~126@)) (=> (= tmp%28@ (Mul d15~128@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%15 (= temp_15_0~2823@ temp_15_1~2872@))))) (=> (= temp_15_0~2823@ temp_15_1~2872@) (=> (= temp_16_0~2969@ (Add (Mul (Sub (Sub a16~130@ d16~136@) (Mul d16~136@ a16~130@)) (Mul (Mul c16~134@ a16~130@) (Mul d16~136@ b16~132@))) (Add (Mul (Mul b16~132@ d16~136@) (Mul a16~130@ d16~136@)) (Add b16~132@ (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~3030@ (Add (Mul (Sub (Sub a16~130@ d16~136@) (Mul d16~136@ a16~130@)) (Mul (Mul c16~134@ a16~130@) (Mul d16~136@ b16~132@))) (Add (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ a16~130@)) (Add b16~132@ (Mul b16~132@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a16~130@ d16~136@) (=> %%location_label%%16 (= temp_16_0~2969@ temp_16_1~3030@))) (=> (= temp_16_0~2969@ temp_16_1~3030@) (=> (= temp_17_0~3099@ (Sub (Mul (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ c17~142@)) (Mul (Mul d17~144@ a17~138@) (Mul c17~142@ b17~140@))) (Sub d17~144@ d17~144@))) (=> (= temp_17_1~3140@ (Sub (Mul (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ c17~142@)) (Mul (Mul (Mul d17~144@ a17~138@) c17~142@) b17~140@)) (Sub d17~144@ d17~144@))) (and (=> (= tmp%29@ (Mul d17~144@ a17~138@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%29@ c17~142@ b17~140@) (=> %%location_label%%17 (= temp_17_0~3099@ temp_17_1~3140@)))) (=> (= temp_17_0~3099@ temp_17_1~3140@) (=> (= temp_18_0~3235@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ d18~152@)) (Mul c18~150@ (Mul b18~148@ b18~148@))) (Mul (Mul (Mul b18~148@ b18~148@) (Mul c18~150@ d18~152@)) (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ d18~152@))))) (=> (= temp_18_1~3296@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ d18~152@)) (Mul c18~150@ (Mul b18~148@ b18~148@))) (Mul (Mul (Mul b18~148@ b18~148@) (Mul c18~150@ d18~152@)) (Mul (Mul b18~148@ a18~146@) (Mul d18~152@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a18~146@ b18~148@) (=> %%location_label%%18 (= temp_18_0~3235@ temp_18_1~3296@))) (=> (= temp_18_0~3235@ temp_18_1~3296@) (=> (= temp_19_0~3369@ (Mul (Mul (Mul (Sub d19~160@ b19~156@) (Mul b19~156@ d19~160@)) (Mul c19~158@ c19~158@)) (Mul a19~154@ (Mul (Mul d19~160@ d19~160@) (Mul b19~156@ a19~154@))))) (=> (= temp_19_1~3414@ (Mul (Mul (Mul (Sub d19~160@ b19~156@) (Mul b19~156@ d19~160@)) (Mul c19~158@ c19~158@)) (Mul a19~154@ (Mul (Mul b19~156@ a19~154@) (Mul d19~160@ d19~160@))))) (and (=> (= tmp%30@ (Mul d19~160@ d19~160@)) (=> (= tmp%31@ (Mul b19~156@ a19~154@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%30@ tmp%31@) (=> %%location_label%%19 (= temp_19_0~3369@ temp_19_1~3414@))))) (=> (= temp_19_0~3369@ temp_19_1~3414@) (=> (= temp_20_0~3563@ (Sub (Mul (Mul (Mul c20~166@ 69) (Mul b20~164@ d20~168@)) (Sub (Sub 40 a20~162@) (Mul c20~166@ a20~162@))) (Sub (Mul (Mul a20~162@ b20~164@) (Mul 9 c20~166@)) (Sub (Mul a20~162@ c20~166@) (Mul 28 d20~168@))))) (=> (= temp_20_1~3676@ (Sub (Mul (Mul (Mul c20~166@ 69) (Mul b20~164@ d20~168@)) (Sub (Sub 40 a20~162@) (Mul c20~166@ a20~162@))) (Sub (Mul (Mul b20~164@ a20~162@) (Mul 9 c20~166@)) (Sub (Mul a20~162@ c20~166@) (Mul 28 d20~168@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a20~162@ b20~164@) (=> %%location_label%%20 (= temp_20_0~3563@ temp_20_1~3676@))) (=> (= temp_20_0~3563@ temp_20_1~3676@) (=> (= temp_21_0~3741@ (Mul c21~174@ (Mul (Mul (Mul b21~172@ a21~170@) (Mul c21~174@ a21~170@)) (Mul (Mul d21~176@ a21~170@) (Add a21~170@ b21~172@))))) (=> (= temp_21_1~3778@ (Mul (Mul (Mul (Mul b21~172@ a21~170@) (Mul c21~174@ a21~170@)) (Mul (Mul d21~176@ a21~170@) (Add a21~170@ b21~172@))) c21~174@)) (and (=> (= tmp%32@ (Mul (Mul (Mul b21~172@ a21~170@) (Mul c21~174@ a21~170@)) (Mul (Mul d21~176@ a21~170@) (Add a21~170@ b21~172@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c21~174@ tmp%32@) (=> %%location_label%%21 (= temp_21_0~3741@ temp_21_1~3778@)))) (=> (= temp_21_0~3741@ temp_21_1~3778@) (=> (= temp_22_0~3899@ (Mul (Mul (Mul (Mul c22~182@ a22~178@) (Add d22~184@ b22~180@)) (Mul (Mul c22~182@ b22~180@) (Sub b22~180@ c22~182@))) (Mul (Mul (Mul a22~178@ d22~184@) (Mul c22~182@ d22~184@)) (Mul (Mul d22~184@ d22~184@) (Sub b22~180@ a22~178@))))) (=> (= temp_22_1~3964@ (Mul (Mul (Mul (Mul c22~182@ a22~178@) (Add d22~184@ b22~180@)) (Mul (Mul c22~182@ b22~180@) (Sub b22~180@ c22~182@))) (Mul (Mul (Mul a22~178@ d22~184@) (Mul c22~182@ d22~184@)) (Mul (Mul d22~184@ d22~184@) (Sub b22~180@ a22~178@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d22~184@ d22~184@) (=> %%location_label%%22 (= temp_22_0~3899@ temp_22_1~3964@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
