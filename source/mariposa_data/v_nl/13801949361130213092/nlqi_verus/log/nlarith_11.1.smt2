...
(declare-const temp_3_0~1016@ Int)
(declare-const temp_3_1~1125@ Int)
(declare-const temp_4_0~1265@ Int)
(declare-const temp_4_1~1390@ Int)
(declare-const temp_5_0~1526@ Int)
(declare-const temp_5_1~1647@ Int)
(declare-const temp_6_0~1755@ Int)
(declare-const temp_6_1~1848@ Int)
(declare-const temp_7_0~1976@ Int)
(declare-const temp_7_1~2089@ Int)
(declare-const temp_8_0~2201@ Int)
(declare-const temp_8_1~2298@ Int)
(declare-const temp_9_0~2438@ Int)
(declare-const temp_9_1~2563@ Int)
(declare-const temp_10_0~2695@ Int)
(declare-const temp_10_1~2812@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Add (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul c0~6@ (Mul d0~8@ c0~6@))) (Mul (Mul (Mul d0~8@ a0~2@) (Sub c0~6@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ b0~4@)))) (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Add a0~2@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Add a0~2@ d0~8@))) (Mul b0~4@ (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@)))))) (=> (= temp_0_1~386@ (Add (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul c0~6@ (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Sub c0~6@ c0~6@)))) (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Add a0~2@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Add a0~2@ d0~8@))) (Mul b0~4@ (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@)))))) (=> (= tmp%1@ (= temp_0_0~273@ temp_0_1~386@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~506@ (Mul (Mul (Sub (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ d1~16@)) a1~10@) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ a1~10@)) (Sub (Add d1~16@ c1~14@) (Mul c1~14@ b1~12@)))) (Mul (Mul (Mul (Add c1~14@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Add a1~10@ b1~12@) c1~14@)) (Mul (Mul b1~12@ (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ c1~14@) a1~10@))))) (=> (= temp_1_1~611@ (Mul (Mul (Sub (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ d1~16@)) a1~10@) (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ c1~14@)) (Sub (Add d1~16@ c1~14@) (Mul c1~14@ b1~12@)))) (Mul (Mul (Mul (Add c1~14@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Add a1~10@ b1~12@) c1~14@)) (Mul (Mul b1~12@ (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ c1~14@) a1~10@))))) (=> (= tmp%2@ (= temp_1_0~506@ temp_1_1~611@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~759@ (Mul (Mul (Mul (Sub (Sub c2~22@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))) (Mul (Mul d2~24@ (Mul 38 c2~22@)) (Sub (Mul c2~22@ b2~20@) (Mul d2~24@ a2~18@)))) (Mul (Mul (Mul (Mul 94 b2~20@) (Add d2~24@ b2~20@)) (Mul a2~18@ (Mul d2~24@ a2~18@))) (Mul (Add (Mul c2~22@ d2~24@) (Mul b2~20@ c2~22@)) a2~18@)))) (=> (= temp_2_1~892@ (Mul (Mul (Mul (Sub (Sub c2~22@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul d2~24@ (Mul 38 c2~22@)) (Sub (Mul c2~22@ b2~20@) (Mul d2~24@ a2~18@)))) (Mul (Mul (Mul (Mul 94 b2~20@) (Add d2~24@ b2~20@)) (Mul a2~18@ (Mul d2~24@ a2~18@))) (Mul (Add (Mul c2~22@ d2~24@) (Mul b2~20@ c2~22@)) a2~18@)))) (=> (= tmp%3@ (= temp_2_0~759@ temp_2_1~892@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1016@ (Add (Mul (Mul (Add (Mul b3~28@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Sub b3~28@ c3~30@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul d3~32@ d3~32@) c3~30@) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ c3~30@)))) (Mul (Mul (Mul (Add d3~32@ b3~28@) d3~32@) a3~26@) (Mul (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ d3~32@)))))) (=> (= temp_3_1~1125@ (Add (Mul (Mul (Add (Mul b3~28@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Sub b3~28@ c3~30@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul d3~32@ d3~32@) c3~30@) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ c3~30@)))) (Mul (Mul (Mul (Add d3~32@ b3~28@) d3~32@) a3~26@) (Mul (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul (Mul b3~28@ b3~28@) b3~28@) d3~32@))))) (=> (= tmp%4@ (= temp_3_0~1016@ temp_3_1~1125@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1265@ (Mul (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Sub b4~36@ b4~36@)) (Sub (Mul a4~34@ d4~40@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul c4~38@ a4~34@) a4~34@) (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)))) (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul b4~36@ c4~38@) (Add b4~36@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ c4~38@)))))) (=> (= temp_4_1~1390@ (Mul (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Sub b4~36@ b4~36@)) (Sub (Mul a4~34@ d4~40@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul c4~38@ a4~34@) a4~34@) (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ c4~38@)))) (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul c4~38@ b4~36@) (Add b4~36@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ c4~38@)))))) (=> (= tmp%5@ (= temp_4_0~1265@ temp_4_1~1390@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1526@ (Mul (Mul (Mul (Mul b5~44@ (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ c5~46@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ d5~48@)))) (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@)) (Mul d5~48@ (Add a5~42@ d5~48@)))))) (=> (= temp_5_1~1647@ (Mul (Mul (Mul (Mul b5~44@ (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ c5~46@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ d5~48@)))) (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@)) (Mul d5~48@ (Add a5~42@ d5~48@)))))) (=> (= tmp%6@ (= temp_5_0~1526@ temp_5_1~1647@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1755@ (Mul (Mul (Mul (Add (Mul b6~52@ d6~56@) (Mul d6~56@ b6~52@)) c6~54@) (Mul (Sub (Sub a6~50@ d6~56@) c6~54@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ d6~56@)) (Mul (Add d6~56@ a6~50@) (Mul a6~50@ c6~54@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ c6~54@)) b6~52@)))) (=> (= temp_6_1~1848@ (Mul (Mul (Mul (Add (Mul b6~52@ d6~56@) (Mul d6~56@ b6~52@)) c6~54@) (Mul (Sub (Sub a6~50@ d6~56@) c6~54@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) (Mul (Add d6~56@ a6~50@) (Mul a6~50@ c6~54@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ c6~54@)) b6~52@)))) (=> (= tmp%7@ (= temp_6_0~1755@ temp_6_1~1848@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1976@ (Mul (Mul c7~62@ (Mul (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Add 10 d7~64@) (Mul c7~62@ a7~58@)))) (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Sub d7~64@ d7~64@)) (Sub (Add b7~60@ a7~58@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul d7~64@ a7~58@) (Sub 76 d7~64@)) c7~62@)))) (=> (= temp_7_1~2089@ (Mul (Mul c7~62@ (Mul (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Add 10 d7~64@) (Mul c7~62@ a7~58@)))) (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Sub d7~64@ d7~64@)) (Sub (Add b7~60@ a7~58@) (Mul b7~60@ d7~64@))) (Mul (Mul d7~64@ a7~58@) (Mul (Sub 76 d7~64@) c7~62@))))) (=> (= tmp%8@ (= temp_7_0~1976@ temp_7_1~2089@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2201@ (Add (Mul a8~66@ (Mul (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ c8~70@)) (Sub (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@)))) (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ b8~68@))) (Sub (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@)) (Add (Mul c8~70@ c8~70@) d8~72@))))) (=> (= temp_8_1~2298@ (Add (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ c8~70@)) (Sub (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@))) a8~66@) (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ b8~68@))) (Sub (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@)) (Add (Mul c8~70@ c8~70@) d8~72@))))) (=> (= tmp%9@ (= temp_8_0~2201@ temp_8_1~2298@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2438@ (Mul (Sub (Mul (Mul (Mul c9~78@ a9~74@) (Mul c9~78@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ c9~78@))) (Add (Mul (Mul a9~74@ 57) c9~78@) (Mul d9~80@ (Sub b9~76@ c9~78@)))) (Add (Mul (Mul (Mul d9~80@ a9~74@) a9~74@) (Mul (Mul d9~80@ a9~74@) (Sub c9~78@ b9~76@))) (Mul (Add (Mul c9~78@ b9~76@) b9~76@) (Mul (Mul a9~74@ b9~76@) (Sub d9~80@ d9~80@)))))) (=> (= temp_9_1~2563@ (Mul (Sub (Mul (Mul (Mul c9~78@ a9~74@) (Mul c9~78@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ c9~78@))) (Add (Mul (Mul a9~74@ 57) c9~78@) (Mul d9~80@ (Sub b9~76@ c9~78@)))) (Add (Mul (Mul (Mul d9~80@ a9~74@) (Sub c9~78@ b9~76@)) (Mul (Mul d9~80@ a9~74@) a9~74@)) (Mul (Add (Mul c9~78@ b9~76@) b9~76@) (Mul (Mul a9~74@ b9~76@) (Sub d9~80@ d9~80@)))))) (=> (= tmp%10@ (= temp_9_0~2438@ temp_9_1~2563@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~2695@ (Sub (Mul (Mul (Mul (Mul d10~88@ b10~84@) a10~82@) (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ 76))) (Mul (Mul (Mul a10~82@ c10~86@) d10~88@) (Mul (Mul a10~82@ b10~84@) (Sub a10~82@ b10~84@)))) (Mul (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ b10~84@)) b10~84@) (Mul (Add (Mul c10~86@ a10~82@) (Mul d10~88@ a10~82@)) (Mul (Mul d10~88@ a10~82@) d10~88@))))) (=> (= temp_10_1~2812@ (Sub (Mul (Mul (Mul (Mul d10~88@ b10~84@) a10~82@) (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ 76))) (Mul (Mul (Mul a10~82@ c10~86@) d10~88@) (Mul (Mul a10~82@ b10~84@) (Sub a10~82@ b10~84@)))) (Mul (Mul (Mul b10~84@ (Mul d10~88@ (Mul b10~84@ b10~84@))) b10~84@) (Mul (Add (Mul c10~86@ a10~82@) (Mul d10~88@ a10~82@)) (Mul (Mul d10~88@ a10~82@) d10~88@))))) (=> (= tmp%11@ (= temp_10_0~2695@ temp_10_1~2812@)) (=> %%location_label%%10 tmp%11@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
