...
(set-info :comment ";; mariposa_data/v_nl//18328614174984404072/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul c0~6@ (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul a0~2@ c0~6@) (Sub a0~2@ c0~6@)) (Add (Mul c0~6@ b0~4@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~346@ (Mul (Mul c0~6@ (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ c0~6@))) (Mul (Mul a0~2@ (Mul c0~6@ (Sub a0~2@ c0~6@))) (Add (Mul c0~6@ b0~4@) (Mul a0~2@ d0~8@))))) (and (=> (= tmp%1@ (Sub a0~2@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a0~2@ c0~6@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@)))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~441@ (Add (Add (Mul (Mul b1~12@ d1~16@) c1~14@) (Add (Mul a1~10@ d1~16@) (Add b1~12@ b1~12@))) (Mul (Mul (Mul b1~12@ a1~10@) (Sub b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~510@ (Add (Add (Mul (Mul b1~12@ d1~16@) c1~14@) (Add (Mul a1~10@ d1~16@) (Add b1~12@ b1~12@))) (Mul (Sub (Mul (Mul b1~12@ a1~10@) b1~12@) (Mul (Mul b1~12@ a1~10@) c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))))) (=> (= tmp%2@ (Mul b1~12@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%2@ b1~12@ c1~14@) (=> %%location_label%%1 (= temp_1_0~441@ temp_1_1~510@)))))))))))))
(assert %%query%%)
(check-sat)
