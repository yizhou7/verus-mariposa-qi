...
(set-info :comment ";; mariposa_data/v_nl//5371622301465886433/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~269@ (Mul (Add (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Mul a0~2@ (Add a0~2@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@)))) (Sub (Mul (Mul (Mul b0~4@ 67) (Mul d0~8@ a0~2@)) (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ b0~4@))) c0~6@))) (=> (= temp_0_1~378@ (Mul (Add (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@)) (Mul a0~2@ (Add a0~2@ a0~2@)))) (Sub (Mul (Mul (Mul b0~4@ 67) (Mul d0~8@ a0~2@)) (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ b0~4@))) c0~6@))) (and (=> (= tmp%1@ (Mul a0~2@ (Add a0~2@ a0~2@))) (=> (= tmp%2@ (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~269@ temp_0_1~378@))))) (=> (= temp_0_0~269@ temp_0_1~378@) (=> (= temp_1_0~547@ (Mul (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ b1~12@)) (Mul d1~16@ (Mul d1~16@ d1~16@))) (Mul (Mul b1~12@ (Sub d1~16@ c1~14@)) (Add (Mul d1~16@ a1~10@) (Mul a1~10@ a1~10@)))) (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul 91 a1~10@) (Mul c1~14@ b1~12@))) (Mul c1~14@ (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@)))))) (=> (= temp_1_1~668@ (Mul (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ b1~12@)) (Mul d1~16@ (Mul d1~16@ d1~16@))) (Mul (Mul b1~12@ (Sub d1~16@ c1~14@)) (Add (Mul d1~16@ a1~10@) (Mul a1~10@ a1~10@)))) (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul 91 a1~10@) (Mul c1~14@ b1~12@))) (Mul c1~14@ (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~547@ temp_1_1~668@))) (=> (= temp_1_0~547@ temp_1_1~668@) (=> (= temp_2_0~805@ (Mul (Sub (Mul (Mul a2~18@ (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))) (Add a2~18@ (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ b2~20@)))) (Sub (Mul c2~22@ (Mul d2~24@ (Mul c2~22@ b2~20@))) (Mul (Mul (Add c2~22@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Sub 44 a2~18@) (Mul d2~24@ b2~20@)))))) (=> (= temp_2_1~914@ (Mul (Sub (Mul (Mul a2~18@ (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))) (Add a2~18@ (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ b2~20@)))) (Sub (Mul c2~22@ (Mul (Mul c2~22@ b2~20@) d2~24@)) (Mul (Mul (Add c2~22@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Sub 44 a2~18@) (Mul d2~24@ b2~20@)))))) (and (=> (= tmp%3@ (Mul c2~22@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~805@ temp_2_1~914@)))) (=> (= temp_2_0~805@ temp_2_1~914@) (=> (= temp_3_0~1063@ (Mul (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@)) a3~26@) (Mul b3~28@ (Mul (Mul d3~32@ a3~26@) (Sub a3~26@ a3~26@)))) (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Add a3~26@ c3~30@) (Add a3~26@ d3~32@))) (Add (Mul (Mul 69 a3~26@) (Mul a3~26@ d3~32@)) (Add (Mul a3~26@ c3~30@) (Mul a3~26@ d3~32@)))))) (=> (= temp_3_1~1180@ (Mul (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@)) a3~26@) (Mul b3~28@ (Mul (Mul d3~32@ a3~26@) (Sub a3~26@ a3~26@)))) (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Add a3~26@ c3~30@) (Add a3~26@ d3~32@))) (Add (Mul (Mul 69 a3~26@) (Mul a3~26@ d3~32@)) (Add (Mul a3~26@ c3~30@) (Mul a3~26@ d3~32@)))))) (and (=> (= tmp%4@ (Mul d3~32@ b3~28@)) (=> (= tmp%5@ (Mul c3~30@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~1063@ temp_3_1~1180@))))) (=> (= temp_3_0~1063@ temp_3_1~1180@) (=> (= temp_4_0~1337@ (Mul (Mul (Sub (Sub (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@)) (Mul a4~34@ (Mul a4~34@ b4~36@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ a4~34@) b4~36@))) (Mul (Mul (Sub (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ c4~38@))) (Add (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ c4~38@)))))) (=> (= temp_4_1~1458@ (Mul (Mul (Sub (Sub (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@)) (Mul a4~34@ (Mul a4~34@ b4~36@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ a4~34@) b4~36@))) (Mul (Mul (Sub (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ c4~38@))) (Add (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ c4~38@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ b4~36@) (=> %%location_label%%4 (= temp_4_0~1337@ temp_4_1~1458@))) (=> (= temp_4_0~1337@ temp_4_1~1458@) (=> (= temp_5_0~1603@ (Mul (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ a5~42@)) a5~42@) (Mul (Mul (Mul d5~48@ a5~42@) (Sub c5~46@ b5~44@)) (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@)))) (Mul (Mul (Add (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ b5~44@) (Sub a5~42@ a5~42@))) (Mul (Mul (Add a5~42@ c5~46@) (Mul d5~48@ a5~42@)) (Add (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@)))))) (=> (= temp_5_1~1720@ (Mul (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ a5~42@)) a5~42@) (Mul (Mul (Mul d5~48@ a5~42@) (Sub c5~46@ b5~44@)) (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@)))) (Mul (Mul (Add (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Sub a5~42@ a5~42@) (Mul c5~46@ b5~44@))) (Mul (Mul (Add a5~42@ c5~46@) (Mul d5~48@ a5~42@)) (Add (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@)))))) (and (=> (= tmp%6@ (Mul c5~46@ b5~44@)) (=> (= tmp%7@ (Sub a5~42@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%5 (= temp_5_0~1603@ temp_5_1~1720@))))) (=> (= temp_5_0~1603@ temp_5_1~1720@) (=> (= temp_6_0~1877@ (Add (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ a6~50@)) (Sub (Mul b6~52@ d6~56@) (Add c6~54@ a6~50@)))) (Mul (Mul (Add (Mul b6~52@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@))) (Mul (Mul (Mul a6~50@ a6~50@) c6~54@) (Mul (Mul b6~52@ d6~56@) b6~52@))))) (=> (= temp_6_1~1998@ (Add (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ a6~50@)) (Sub (Mul b6~52@ d6~56@) (Add c6~54@ a6~50@)))) (Mul (Mul (Add (Mul b6~52@ c6~54@) (Mul a6~50@ c6~54@)) (Mul (Add b6~52@ d6~56@) (Mul d6~56@ d6~56@))) (Mul (Mul (Mul (Mul a6~50@ a6~50@) c6~54@) (Mul b6~52@ d6~56@)) b6~52@)))) (and (=> (= tmp%8@ (Mul (Mul a6~50@ a6~50@) c6~54@)) (=> (= tmp%9@ (Mul b6~52@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1877@ temp_6_1~1998@))))) (=> (= temp_6_0~1877@ temp_6_1~1998@) (=> (= temp_7_0~2137@ (Add (Sub (Mul (Mul c7~62@ (Mul c7~62@ d7~64@)) (Mul (Sub b7~60@ d7~64@) (Mul d7~64@ b7~60@))) (Mul (Mul (Mul b7~60@ c7~62@) (Add b7~60@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@)))) (Mul (Sub (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ b7~60@))) a7~58@))) (=> (= temp_7_1~2234@ (Add (Sub (Mul (Mul c7~62@ (Mul c7~62@ d7~64@)) (Mul (Sub b7~60@ d7~64@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul b7~60@ c7~62@) (Add b7~60@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@)))) (Mul (Sub (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ b7~60@))) a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ b7~60@) (=> %%location_label%%7 (= temp_7_0~2137@ temp_7_1~2234@))) (=> (= temp_7_0~2137@ temp_7_1~2234@) (=> (= temp_8_0~2375@ (Mul (Mul (Mul (Mul c8~70@ (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@))) (Sub (Mul (Mul a8~66@ b8~68@) (Add d8~72@ d8~72@)) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ c8~70@)))) (Mul (Add (Sub (Mul a8~66@ d8~72@) (Mul c8~70@ b8~68@)) d8~72@) (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@)) (Sub (Mul d8~72@ b8~68@) (Mul b8~68@ d8~72@)))))) (=> (= temp_8_1~2488@ (Mul (Mul (Mul (Mul c8~70@ (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@))) (Sub (Mul (Mul b8~68@ a8~66@) (Add d8~72@ d8~72@)) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ c8~70@)))) (Mul (Add (Sub (Mul a8~66@ d8~72@) (Mul c8~70@ b8~68@)) d8~72@) (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@)) (Sub (Mul d8~72@ b8~68@) (Mul b8~68@ d8~72@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ b8~68@) (=> %%location_label%%8 (= temp_8_0~2375@ temp_8_1~2488@))) (=> (= temp_8_0~2375@ temp_8_1~2488@) (=> (= temp_9_0~2649@ (Mul (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul c9~78@ c9~78@)) (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ c9~78@))) (Mul (Mul (Mul a9~74@ d9~80@) (Sub a9~74@ d9~80@)) (Mul c9~78@ (Mul d9~80@ b9~76@)))) (Mul (Mul (Mul c9~78@ (Mul c9~78@ b9~76@)) (Add (Mul b9~76@ d9~80@) (Add a9~74@ c9~78@))) (Mul (Add (Mul a9~74@ b9~76@) (Mul b9~76@ 33)) (Mul (Mul a9~74@ a9~74@) (Sub a9~74@ a9~74@)))))) (=> (= temp_9_1~2782@ (Mul (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ c9~78@)) (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ c9~78@))) (Mul (Mul (Mul a9~74@ d9~80@) (Sub a9~74@ d9~80@)) (Mul c9~78@ (Mul d9~80@ b9~76@)))) (Mul (Mul (Mul c9~78@ (Mul c9~78@ b9~76@)) (Add (Mul b9~76@ d9~80@) (Add a9~74@ c9~78@))) (Mul (Add (Mul a9~74@ b9~76@) (Mul b9~76@ 33)) (Mul (Mul a9~74@ a9~74@) (Sub a9~74@ a9~74@)))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b9~76@ a9~74@) (=> %%location_label%%9 (= temp_9_0~2649@ temp_9_1~2782@))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
