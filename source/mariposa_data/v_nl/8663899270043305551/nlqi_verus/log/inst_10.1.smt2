...
(set-info :comment ";; mariposa_data/v_nl//8663899270043305551/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Sub (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Sub c0~6@ b0~4@))) (Sub (Mul (Mul d0~8@ d0~8@) (Add d0~8@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@)))) (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ d0~8@)) (Mul (Mul a0~2@ c0~6@) (Sub b0~4@ d0~8@))) (Mul d0~8@ (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@)))))) (=> (= temp_0_1~394@ (Sub (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Sub c0~6@ b0~4@))) (Sub (Mul (Mul d0~8@ d0~8@) (Add d0~8@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@)))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ d0~8@)) (Mul (Mul (Mul a0~2@ c0~6@) (Sub b0~4@ d0~8@)) (Mul d0~8@ (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@))))))) (and (=> (= tmp%1@ (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ d0~8@))) (=> (= tmp%2@ (Mul (Mul a0~2@ c0~6@) (Sub b0~4@ d0~8@))) (=> (= tmp%3@ (Mul d0~8@ (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~277@ temp_0_1~394@)))))) (=> (= temp_0_0~277@ temp_0_1~394@) (=> (= temp_1_0~589@ (Mul (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ c1~14@))) (Mul (Sub (Mul d1~16@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@)))) (Add (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ b1~12@)) (Add (Mul c1~14@ a1~10@) (Mul d1~16@ a1~10@))) (Sub (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@)))))) (=> (= temp_1_1~714@ (Mul (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ c1~14@))) (Mul (Sub (Mul d1~16@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@)))) (Add (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ b1~12@)) (Add (Mul c1~14@ a1~10@) (Mul a1~10@ d1~16@))) (Sub (Mul (Mul a1~10@ b1~12@) a1~10@) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ a1~10@) (=> %%location_label%%1 (= temp_1_0~589@ temp_1_1~714@))) (=> (= temp_1_0~589@ temp_1_1~714@) (=> (= temp_2_0~839@ (Mul (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul d2~24@ d2~24@)) a2~18@) (Sub (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ d2~24@)))) (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Sub c2~22@ a2~18@)) b2~20@) (Mul (Mul (Mul d2~24@ a2~18@) d2~24@) (Mul (Mul a2~18@ d2~24@) c2~22@))))) (=> (= temp_2_1~936@ (Mul (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul d2~24@ d2~24@)) a2~18@) (Sub (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ d2~24@)))) (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Sub c2~22@ a2~18@)) b2~20@) (Mul (Mul (Mul d2~24@ a2~18@) d2~24@) (Mul c2~22@ (Mul a2~18@ d2~24@)))))) (and (=> (= tmp%4@ (Mul a2~18@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ c2~22@) (=> %%location_label%%2 (= temp_2_0~839@ temp_2_1~936@)))) (=> (= temp_2_0~839@ temp_2_1~936@) (=> (= temp_3_0~1041@ (Mul (Add (Mul (Mul a3~26@ (Mul c3~30@ c3~30@)) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ c3~30@) a3~26@))) 3)) (=> (= temp_3_1~1114@ (Mul (Add (Mul (Mul a3~26@ (Mul c3~30@ c3~30@)) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul b3~28@ c3~30@) a3~26@) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ b3~28@)))) 3)) (and (=> (= tmp%5@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ b3~28@))) (=> (= tmp%6@ (Mul (Mul b3~28@ c3~30@) a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~1041@ temp_3_1~1114@))))) (=> (= temp_3_0~1041@ temp_3_1~1114@) (=> (= temp_4_0~1303@ (Mul (Mul (Mul (Add (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Add (Mul b4~36@ c4~38@) (Mul a4~34@ a4~34@))) (Sub (Mul (Mul c4~38@ 82) (Mul c4~38@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Add a4~34@ d4~40@)))) (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Add c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ d4~40@)))))) (=> (= temp_4_1~1452@ (Mul (Mul (Mul (Add (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Add (Mul b4~36@ c4~38@) (Mul a4~34@ a4~34@))) (Sub (Mul (Mul c4~38@ 82) (Mul c4~38@ c4~38@)) (Add (Mul (Mul c4~38@ a4~34@) a4~34@) (Mul (Mul c4~38@ a4~34@) d4~40@)))) (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Add c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ d4~40@)))))) (and (=> (= tmp%7@ (Mul c4~38@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%7@ a4~34@ d4~40@) (=> %%location_label%%4 (= temp_4_0~1303@ temp_4_1~1452@)))) (=> (= temp_4_0~1303@ temp_4_1~1452@) (=> (= temp_5_0~1639@ (Sub (Mul (Add (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ b5~44@)) (Mul (Add b5~44@ 86) (Mul d5~48@ a5~42@))) (Add (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@)))) (Add (Mul (Mul (Mul a5~42@ d5~48@) (Add d5~48@ c5~46@)) (Sub (Mul a5~42@ b5~44@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ 83)) (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ c5~46@)))))) (=> (= temp_5_1~1792@ (Sub (Mul (Add (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ b5~44@)) (Mul (Add b5~44@ 86) (Mul d5~48@ a5~42@))) (Add (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@)))) (Add (Mul (Mul (Mul a5~42@ d5~48@) (Add d5~48@ c5~46@)) (Sub (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ 83)) (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ c5~46@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1639@ temp_5_1~1792@))) (=> (= temp_5_0~1639@ temp_5_1~1792@) (=> (= temp_6_0~1949@ (Mul (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ d6~56@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul a6~50@ c6~54@) a6~50@))) (Add (Mul (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ 91))) (Mul (Mul (Mul a6~50@ a6~50@) a6~50@) (Add c6~54@ (Mul d6~56@ d6~56@)))))) (=> (= temp_6_1~2078@ (Mul (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ d6~56@))) (Mul (Mul (Mul a6~50@ c6~54@) a6~50@) (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ a6~50@)))) (Add (Mul (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ 91))) (Mul (Mul (Mul a6~50@ a6~50@) a6~50@) (Add c6~54@ (Mul d6~56@ d6~56@)))))) (and (=> (= tmp%8@ (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ a6~50@))) (=> (= tmp%9@ (Mul (Mul a6~50@ c6~54@) a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%6 (= temp_6_0~1949@ temp_6_1~2078@))))) (=> (= temp_6_0~1949@ temp_6_1~2078@) (=> (= temp_7_0~2271@ (Mul (Mul (Mul (Add (Sub c7~62@ d7~64@) (Mul d7~64@ a7~58@)) (Mul (Sub d7~64@ a7~58@) (Mul d7~64@ c7~62@))) (Mul (Mul c7~62@ (Add d7~64@ d7~64@)) (Mul (Add a7~58@ a7~58@) (Mul a7~58@ c7~62@)))) (Mul (Mul (Mul (Mul d7~64@ d7~64@) 59) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@))) (Add (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@)) (Sub (Mul a7~58@ a7~58@) (Sub 80 d7~64@)))))) (=> (= temp_7_1~2416@ (Mul (Mul (Mul (Add (Sub c7~62@ d7~64@) (Mul d7~64@ a7~58@)) (Mul (Sub d7~64@ a7~58@) (Mul d7~64@ c7~62@))) (Mul (Mul c7~62@ (Add d7~64@ d7~64@)) (Mul (Add a7~58@ a7~58@) (Mul a7~58@ c7~62@)))) (Mul (Mul (Mul 59 (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@))) (Add (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@)) (Sub (Mul a7~58@ a7~58@) (Sub 80 d7~64@)))))) (and (=> (= tmp%10@ (Mul d7~64@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ 59) (=> %%location_label%%7 (= temp_7_0~2271@ temp_7_1~2416@)))) (=> (= temp_7_0~2271@ temp_7_1~2416@) (=> (= temp_8_0~2565@ (Mul (Mul (Add (Mul (Sub d8~72@ d8~72@) c8~70@) (Mul (Mul b8~68@ d8~72@) (Add a8~66@ d8~72@))) (Sub (Mul (Mul c8~70@ b8~68@) d8~72@) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@)))) (Sub (Mul d8~72@ (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ a8~66@))) (Mul (Mul (Mul a8~66@ b8~68@) a8~66@) (Sub (Mul b8~68@ a8~66@) (Mul d8~72@ b8~68@)))))) (=> (= temp_8_1~2670@ (Mul (Mul (Add (Mul (Sub d8~72@ d8~72@) c8~70@) (Mul (Mul b8~68@ d8~72@) (Add a8~66@ d8~72@))) (Sub (Mul (Mul b8~68@ c8~70@) d8~72@) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@)))) (Sub (Mul d8~72@ (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ a8~66@))) (Mul (Mul (Mul a8~66@ b8~68@) a8~66@) (Sub (Mul b8~68@ a8~66@) (Mul d8~72@ b8~68@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ b8~68@) (=> %%location_label%%8 (= temp_8_0~2565@ temp_8_1~2670@))) (=> (= temp_8_0~2565@ temp_8_1~2670@) (=> (= temp_9_0~2815@ (Mul (Mul (Mul (Mul (Add d9~80@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Add b9~76@ d9~80@) (Mul a9~74@ d9~80@))) (Mul a9~74@ (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ b9~76@)))) (Mul (Mul (Mul (Sub c9~78@ b9~76@) (Add b9~76@ b9~76@)) (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ b9~76@))) (Add (Add (Mul a9~74@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul a9~74@ d9~80@) (Add c9~78@ c9~78@)))))) (=> (= temp_9_1~2932@ (Mul (Mul (Mul (Mul (Add d9~80@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Add b9~76@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul a9~74@ (Mul d9~80@ a9~74@)) (Mul c9~78@ b9~76@))) (Mul (Mul (Mul (Sub c9~78@ b9~76@) (Add b9~76@ b9~76@)) (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ b9~76@))) (Add (Add (Mul a9~74@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul a9~74@ d9~80@) (Add c9~78@ c9~78@)))))) (=> (= tmp%11@ (Mul d9~80@ a9~74@)) (=> (= tmp%12@ (Mul c9~78@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a9~74@ tmp%11@ tmp%12@) (=> %%location_label%%9 (= temp_9_0~2815@ temp_9_1~2932@))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
