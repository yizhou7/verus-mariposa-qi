...
(declare-const temp_1_0~558@ Int)
(declare-const temp_1_1~667@ Int)
(declare-const temp_2_0~791@ Int)
(declare-const temp_2_1~900@ Int)
(declare-const temp_3_0~1044@ Int)
(declare-const temp_3_1~1173@ Int)
(declare-const temp_4_0~1277@ Int)
(declare-const temp_4_1~1366@ Int)
(declare-const temp_5_0~1534@ Int)
(declare-const temp_5_1~1687@ Int)
(declare-const temp_6_0~1803@ Int)
(declare-const temp_6_1~1904@ Int)
(declare-const temp_7_0~2028@ Int)
(declare-const temp_7_1~2137@ Int)
(declare-const temp_8_0~2285@ Int)
(declare-const temp_8_1~2418@ Int)
(declare-const temp_9_0~2494@ Int)
(declare-const temp_9_1~2555@ Int)
(declare-const temp_10_0~2643@ Int)
(declare-const temp_10_1~2716@ Int)
(declare-const temp_11_0~2792@ Int)
(declare-const temp_11_1~2853@ Int)
(declare-const temp_12_0~2989@ Int)
(declare-const temp_12_1~3142@ Int)
(declare-const temp_13_0~3290@ Int)
(declare-const temp_13_1~3463@ Int)
(declare-const temp_14_0~3603@ Int)
(declare-const temp_14_1~3728@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@)) (Mul (Mul c0~6@ 84) c0~6@))) (Mul (Mul (Add (Mul a0~2@ d0~8@) (Mul d0~8@ c0~6@)) (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ b0~4@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ a0~2@)))))) (=> (= temp_0_1~434@ (Mul (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@)) (Mul (Mul c0~6@ 84) c0~6@))) (Mul (Mul (Add (Mul a0~2@ d0~8@) (Mul d0~8@ c0~6@)) (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ b0~4@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ a0~2@)))))) (=> (= tmp%1@ (= temp_0_0~297@ temp_0_1~434@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~558@ (Mul (Mul (Mul (Mul (Mul a1~10@ a1~10@) c1~14@) c1~14@) (Mul (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ b1~12@)))) (Mul (Mul (Mul (Mul d1~16@ a1~10@) d1~16@) (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ a1~10@)))))) (=> (= temp_1_1~667@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) c1~14@) (Mul c1~14@ (Mul (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ b1~12@))))) (Mul (Mul (Mul (Mul d1~16@ a1~10@) d1~16@) (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ a1~10@)))))) (=> (= tmp%2@ (= temp_1_0~558@ temp_1_1~667@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~791@ (Mul (Mul (Mul (Mul (Add c2~22@ a2~18@) (Mul a2~18@ c2~22@)) (Mul b2~20@ d2~24@)) (Mul (Mul (Add a2~18@ d2~24@) (Mul d2~24@ d2~24@)) (Add (Mul b2~20@ c2~22@) (Sub a2~18@ b2~20@)))) (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ b2~20@)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@))) (Mul d2~24@ (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@)))))) (=> (= temp_2_1~900@ (Mul (Mul (Mul (Mul (Add c2~22@ a2~18@) (Mul a2~18@ c2~22@)) (Mul b2~20@ d2~24@)) (Mul (Mul (Add a2~18@ d2~24@) (Mul d2~24@ d2~24@)) (Add (Mul b2~20@ c2~22@) (Sub a2~18@ b2~20@)))) (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ b2~20@)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@))) (Mul d2~24@ (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ c2~22@)))))) (=> (= tmp%3@ (= temp_2_0~791@ temp_2_1~900@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1044@ (Mul (Mul (Add (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@))) (Mul (Sub (Mul c3~30@ b3~28@) (Mul d3~32@ b3~28@)) (Add (Mul c3~30@ c3~30@) (Mul d3~32@ a3~26@)))) (Sub (Mul (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ c3~30@)))))) (=> (= temp_3_1~1173@ (Mul (Mul (Add (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@))) (Mul (Sub (Mul c3~30@ b3~28@) (Mul d3~32@ b3~28@)) (Add (Mul c3~30@ c3~30@) (Mul d3~32@ a3~26@)))) (Sub (Mul (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ c3~30@)))))) (=> (= tmp%4@ (= temp_3_0~1044@ temp_3_1~1173@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1277@ (Mul (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Sub d4~40@ b4~36@) (Mul b4~36@ c4~38@))) b4~36@) (Add (Mul (Mul (Mul b4~36@ c4~38@) d4~40@) (Mul (Mul a4~34@ a4~34@) a4~34@)) (Mul (Mul b4~36@ (Mul a4~34@ b4~36@)) (Sub (Mul c4~38@ d4~40@) (Sub b4~36@ b4~36@)))))) (=> (= temp_4_1~1366@ (Mul (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Sub d4~40@ b4~36@) (Mul b4~36@ c4~38@))) b4~36@) (Add (Mul (Mul (Mul c4~38@ b4~36@) d4~40@) (Mul (Mul a4~34@ a4~34@) a4~34@)) (Mul (Mul b4~36@ (Mul a4~34@ b4~36@)) (Sub (Mul c4~38@ d4~40@) (Sub b4~36@ b4~36@)))))) (=> (= tmp%5@ (= temp_4_0~1277@ temp_4_1~1366@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1534@ (Mul (Add (Mul (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ b5~44@)) (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ c5~46@)))) (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Sub b5~44@ 13))) (Mul (Add (Mul d5~48@ 64) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ b5~44@)))))) (=> (= temp_5_1~1687@ (Mul (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Sub b5~44@ 13))) (Mul (Add (Mul d5~48@ 64) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ b5~44@)))) (Add (Mul (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ b5~44@)) (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ c5~46@)))))) (=> (= tmp%6@ (= temp_5_0~1534@ temp_5_1~1687@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1803@ (Mul (Mul b6~52@ (Mul (Add (Mul d6~56@ a6~50@) (Mul c6~54@ c6~54@)) (Mul (Mul a6~50@ a6~50@) d6~56@))) (Mul (Mul (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ d6~56@)) (Mul (Mul d6~56@ a6~50@) (Mul 35 d6~56@))) (Mul (Mul (Add b6~52@ a6~50@) a6~50@) (Mul (Mul c6~54@ c6~54@) d6~56@))))) (=> (= temp_6_1~1904@ (Mul (Mul b6~52@ (Mul (Add (Mul d6~56@ a6~50@) (Mul c6~54@ c6~54@)) (Mul (Mul a6~50@ a6~50@) d6~56@))) (Mul (Mul (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ d6~56@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ 35))) (Mul (Mul (Add b6~52@ a6~50@) a6~50@) (Mul (Mul c6~54@ c6~54@) d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1803@ temp_6_1~1904@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2028@ (Mul (Mul (Mul (Mul a7~58@ (Mul c7~62@ 20)) d7~64@) (Sub (Mul (Mul d7~64@ a7~58@) (Sub b7~60@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ c7~62@)))) (Mul (Mul b7~60@ (Mul c7~62@ (Mul d7~64@ c7~62@))) (Mul (Mul (Sub c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@)))))) (=> (= temp_7_1~2137@ (Mul (Mul (Mul (Mul (Mul c7~62@ 20) a7~58@) d7~64@) (Sub (Mul (Mul d7~64@ a7~58@) (Sub b7~60@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Sub a7~58@ c7~62@)))) (Mul (Mul b7~60@ (Mul c7~62@ (Mul d7~64@ c7~62@))) (Mul (Mul (Sub c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@)))))) (=> (= tmp%8@ (= temp_7_0~2028@ temp_7_1~2137@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2285@ (Mul (Mul (Mul (Mul (Mul c8~70@ 43) (Sub b8~68@ d8~72@)) (Add (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))) (Mul (Add (Mul a8~66@ c8~70@) b8~68@) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)))) (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ c8~70@))) (Mul (Mul (Sub d8~72@ a8~66@) (Add d8~72@ a8~66@)) (Mul (Mul a8~66@ d8~72@) c8~70@))))) (=> (= temp_8_1~2418@ (Mul (Mul (Mul (Mul (Mul c8~70@ 43) (Sub b8~68@ d8~72@)) (Add (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))) (Mul (Add (Mul a8~66@ c8~70@) b8~68@) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)))) (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ a8~66@))) (Mul (Mul (Sub d8~72@ a8~66@) (Add d8~72@ a8~66@)) (Mul (Mul a8~66@ d8~72@) c8~70@))))) (=> (= tmp%9@ (= temp_8_0~2285@ temp_8_1~2418@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2494@ (Mul (Mul (Mul (Sub b9~76@ (Mul a9~74@ b9~76@)) (Sub (Mul c9~78@ a9~74@) d9~80@)) a9~74@) (Mul (Mul (Mul (Mul b9~76@ a9~74@) a9~74@) (Sub (Mul d9~80@ d9~80@) (Sub a9~74@ a9~74@))) d9~80@))) (=> (= temp_9_1~2555@ (Mul (Mul (Mul (Sub b9~76@ (Mul a9~74@ b9~76@)) (Sub (Mul c9~78@ a9~74@) d9~80@)) a9~74@) (Mul (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ (Sub (Mul d9~80@ d9~80@) (Sub a9~74@ a9~74@)))) d9~80@))) (=> (= tmp%10@ (= temp_9_0~2494@ temp_9_1~2555@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~2643@ (Mul (Mul (Mul (Mul (Sub a10~82@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Mul c10~86@ a10~82@) (Sub a10~82@ c10~86@))) d10~88@) (Mul d10~88@ (Mul (Mul (Mul d10~88@ d10~88@) (Sub c10~86@ b10~84@)) (Mul (Mul d10~88@ b10~84@) (Add c10~86@ c10~86@)))))) (=> (= temp_10_1~2716@ (Mul (Mul (Mul (Mul (Sub a10~82@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Mul c10~86@ a10~82@) (Sub a10~82@ c10~86@))) d10~88@) (Mul d10~88@ (Mul (Mul (Mul d10~88@ b10~84@) (Add c10~86@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Sub c10~86@ b10~84@)))))) (=> (= tmp%11@ (= temp_10_0~2643@ temp_10_1~2716@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~2792@ (Mul (Mul (Mul b11~92@ (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ b11~92@))) c11~94@) (Mul c11~94@ (Mul (Mul (Add a11~90@ d11~96@) (Mul a11~90@ a11~90@)) (Sub (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@)))))) (=> (= temp_11_1~2853@ (Mul (Mul c11~94@ (Mul b11~92@ (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ b11~92@)))) (Mul c11~94@ (Mul (Mul (Add a11~90@ d11~96@) (Mul a11~90@ a11~90@)) (Sub (Mul d11~96@ a11~90@) (Mul b11~92@ c11~94@)))))) (=> (= tmp%12@ (= temp_11_0~2792@ temp_11_1~2853@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2989@ (Add (Mul (Add (Add (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ a12~98@) (Mul a12~98@ b12~100@))) (Add (Mul (Mul d12~104@ c12~102@) b12~100@) a12~98@)) (Mul (Sub (Add (Mul c12~102@ a12~98@) (Mul c12~102@ d12~104@)) (Mul (Mul a12~98@ b12~100@) c12~102@)) (Mul (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ c12~102@)) (Mul (Mul 69 a12~98@) (Mul c12~102@ c12~102@)))))) (=> (= temp_12_1~3142@ (Add (Add (Mul (Add (Add (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ a12~98@) (Mul a12~98@ b12~100@))) (Mul (Mul d12~104@ c12~102@) b12~100@)) (Mul (Add (Add (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ a12~98@) (Mul a12~98@ b12~100@))) a12~98@)) (Mul (Sub (Add (Mul c12~102@ a12~98@) (Mul c12~102@ d12~104@)) (Mul (Mul a12~98@ b12~100@) c12~102@)) (Mul (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ c12~102@)) (Mul (Mul 69 a12~98@) (Mul c12~102@ c12~102@)))))) (=> (= tmp%13@ (= temp_12_0~2989@ temp_12_1~3142@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~3290@ (Mul (Mul (Sub (Mul (Mul b13~108@ c13~110@) a13~106@) (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ a13~106@))) (Mul (Mul (Mul 51 d13~112@) a13~106@) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ a13~106@)))) (Mul (Mul b13~108@ (Sub (Add b13~108@ d13~112@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ d13~112@)) (Mul (Mul 48 a13~106@) (Mul c13~110@ d13~112@)))))) (=> (= temp_13_1~3463@ (Mul (Sub (Mul (Mul (Mul b13~108@ c13~110@) a13~106@) (Mul (Mul (Mul 51 d13~112@) a13~106@) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ a13~106@)))) (Mul (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ a13~106@)) (Mul (Mul (Mul 51 d13~112@) a13~106@) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ a13~106@))))) (Mul (Mul b13~108@ (Sub (Add b13~108@ d13~112@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ d13~112@)) (Mul (Mul 48 a13~106@) (Mul c13~110@ d13~112@)))))) (=> (= tmp%14@ (= temp_13_0~3290@ temp_13_1~3463@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~3603@ (Mul (Mul (Sub (Mul (Sub c14~118@ b14~116@) d14~120@) (Mul (Add a14~114@ a14~114@) (Mul b14~116@ b14~116@))) (Mul (Add (Mul d14~120@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Mul a14~114@ 47) (Mul a14~114@ d14~120@)))) (Mul (Mul 97 (Mul (Mul b14~116@ d14~120@) a14~114@)) (Mul (Mul (Mul b14~116@ d14~120@) d14~120@) (Mul (Mul d14~120@ a14~114@) a14~114@))))) (=> (= temp_14_1~3728@ (Mul (Mul (Sub (Mul (Sub c14~118@ b14~116@) d14~120@) (Mul (Add a14~114@ a14~114@) (Mul b14~116@ b14~116@))) (Mul (Add (Mul d14~120@ b14~116@) (Mul a14~114@ d14~120@)) (Mul (Mul a14~114@ 47) (Mul a14~114@ d14~120@)))) (Mul (Mul 97 (Mul (Mul b14~116@ d14~120@) a14~114@)) (Mul (Mul (Mul b14~116@ d14~120@) d14~120@) (Mul (Mul d14~120@ a14~114@) a14~114@))))) (=> (= tmp%15@ (= temp_14_0~3603@ temp_14_1~3728@)) (=> %%location_label%%14 tmp%15@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
