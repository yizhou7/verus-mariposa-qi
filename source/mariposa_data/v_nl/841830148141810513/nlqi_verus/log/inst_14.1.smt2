...
(set-info :comment ";; mariposa_data/v_nl//841830148141810513/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~285@ (Mul (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ 26)))) (Mul (Mul (Sub (Mul b0~4@ b0~4@) d0~8@) (Mul (Sub b0~4@ b0~4@) a0~2@)) (Add (Sub (Add b0~4@ c0~6@) c0~6@) (Mul (Mul d0~8@ b0~4@) c0~6@))))) (=> (= temp_0_1~410@ (Mul (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ c0~6@)) (Mul c0~6@ (Mul c0~6@ (Mul d0~8@ a0~2@)))) (Mul (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ 26)))) (Mul (Mul (Sub (Mul b0~4@ b0~4@) d0~8@) (Mul (Sub b0~4@ b0~4@) a0~2@)) (Add (Sub (Add b0~4@ c0~6@) c0~6@) (Mul (Mul d0~8@ b0~4@) c0~6@))))) (and (=> (= tmp%1@ (Mul d0~8@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c0~6@ c0~6@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~285@ temp_0_1~410@)))) (=> (= temp_0_0~285@ temp_0_1~410@) (=> (= temp_1_0~557@ (Mul (Add (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) b1~12@) (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@)))) (Mul (Sub (Add (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Sub b1~12@ d1~16@))) (Mul (Mul (Mul b1~12@ a1~10@) c1~14@) (Mul (Add b1~12@ b1~12@) (Add d1~16@ d1~16@)))))) (=> (= temp_1_1~670@ (Mul (Add (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) b1~12@) (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ b1~12@)) (Mul a1~10@ (Mul b1~12@ (Mul c1~14@ c1~14@))))) (Mul (Sub (Add (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Sub b1~12@ d1~16@))) (Mul (Mul (Mul b1~12@ a1~10@) c1~14@) (Mul (Add b1~12@ b1~12@) (Add d1~16@ d1~16@)))))) (and (=> (= tmp%2@ (Mul c1~14@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a1~10@ b1~12@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~557@ temp_1_1~670@)))) (=> (= temp_1_0~557@ temp_1_1~670@) (=> (= temp_2_0~809@ (Mul (Add (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@)) (Add (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Sub c2~22@ d2~24@)))) (Sub (Mul (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ a2~18@))) (Mul d2~24@ d2~24@)))) (=> (= temp_2_1~914@ (Mul (Add (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@)) (Add (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Sub c2~22@ d2~24@)))) (Sub (Mul (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ a2~18@))) (Mul d2~24@ d2~24@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ a2~18@) (=> %%location_label%%2 (= temp_2_0~809@ temp_2_1~914@))) (=> (= temp_2_0~809@ temp_2_1~914@) (=> (= temp_3_0~1063@ (Mul (Sub (Mul (Mul (Mul d3~32@ d3~32@) (Sub c3~30@ c3~30@)) (Mul (Sub d3~32@ c3~30@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ c3~30@)))) (Mul (Sub (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul d3~32@ c3~30@) d3~32@) (Sub d3~32@ (Mul b3~28@ a3~26@)))))) (=> (= temp_3_1~1208@ (Mul (Sub (Mul (Mul (Mul d3~32@ d3~32@) (Sub c3~30@ c3~30@)) (Mul (Sub d3~32@ c3~30@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ c3~30@)))) (Sub (Mul (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul (Mul d3~32@ c3~30@) d3~32@) (Sub d3~32@ (Mul b3~28@ a3~26@)))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul (Mul d3~32@ c3~30@) d3~32@) (Sub d3~32@ (Mul b3~28@ a3~26@))))))) (and (=> (= tmp%3@ (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ c3~30@))) (=> (= tmp%4@ (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@))) (=> (= tmp%5@ (Mul (Mul (Mul d3~32@ c3~30@) d3~32@) (Sub d3~32@ (Mul b3~28@ a3~26@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~1063@ temp_3_1~1208@)))))) (=> (= temp_3_0~1063@ temp_3_1~1208@) (=> (= temp_4_0~1379@ (Mul (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ b4~36@)) (Mul (Sub b4~36@ a4~34@) (Mul c4~38@ d4~40@))) (Mul (Add (Mul c4~38@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ a4~34@)))) (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ d4~40@) c4~38@)) d4~40@))) (=> (= temp_4_1~1476@ (Mul (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ b4~36@)) (Mul (Sub b4~36@ a4~34@) (Mul c4~38@ d4~40@))) (Mul (Mul (Add (Mul c4~38@ b4~36@) (Mul b4~36@ c4~38@)) (Mul a4~34@ b4~36@)) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ d4~40@) c4~38@)) d4~40@))) (and (=> (= tmp%6@ (Add (Mul c4~38@ b4~36@) (Mul b4~36@ c4~38@))) (=> (= tmp%7@ (Mul a4~34@ b4~36@)) (=> (= tmp%8@ (Mul b4~36@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~1379@ temp_4_1~1476@)))))) (=> (= temp_4_0~1379@ temp_4_1~1476@) (=> (= temp_5_0~1663@ (Mul (Mul (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ b5~44@)) (Mul (Mul d5~48@ a5~42@) (Add d5~48@ a5~42@))) (Mul (Mul (Add d5~48@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul c5~46@ d5~48@) c5~46@))) (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Sub a5~42@ c5~46@) (Mul d5~48@ a5~42@))) (Mul (Sub (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Add (Mul 51 a5~42@) (Mul a5~42@ c5~46@)))))) (=> (= temp_5_1~1800@ (Mul (Mul (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ b5~44@)) (Mul (Add d5~48@ a5~42@) (Mul d5~48@ a5~42@))) (Mul (Mul (Add d5~48@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul c5~46@ d5~48@) c5~46@))) (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Sub a5~42@ c5~46@) (Mul d5~48@ a5~42@))) (Mul (Sub (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Add (Mul 51 a5~42@) (Mul a5~42@ c5~46@)))))) (and (=> (= tmp%9@ (Mul d5~48@ a5~42@)) (=> (= tmp%10@ (Add d5~48@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%5 (= temp_5_0~1663@ temp_5_1~1800@))))) (=> (= temp_5_0~1663@ temp_5_1~1800@) (=> (= temp_6_0~1953@ (Mul (Mul (Mul (Mul (Mul b6~52@ b6~52@) a6~50@) (Mul (Sub b6~52@ b6~52@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Sub b6~52@ c6~54@) (Mul b6~52@ d6~56@)))) (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Add c6~54@ c6~54@)) (Mul c6~54@ (Mul c6~54@ a6~50@))) (Add (Sub b6~52@ (Mul c6~54@ d6~56@)) (Add (Mul d6~56@ b6~52@) (Mul d6~56@ b6~52@)))))) (=> (= temp_6_1~2070@ (Mul (Mul (Mul (Mul (Mul b6~52@ b6~52@) a6~50@) (Mul (Sub b6~52@ b6~52@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Sub b6~52@ c6~54@) (Mul b6~52@ d6~56@)))) (Mul (Mul (Mul (Add c6~54@ c6~54@) (Mul b6~52@ d6~56@)) (Mul c6~54@ (Mul c6~54@ a6~50@))) (Add (Sub b6~52@ (Mul c6~54@ d6~56@)) (Add (Mul d6~56@ b6~52@) (Mul d6~56@ b6~52@)))))) (and (=> (= tmp%11@ (Mul b6~52@ d6~56@)) (=> (= tmp%12@ (Add c6~54@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%6 (= temp_6_0~1953@ temp_6_1~2070@))))) (=> (= temp_6_0~1953@ temp_6_1~2070@) (=> (= temp_7_0~2243@ (Mul (Mul (Mul (Mul (Sub b7~60@ 84) c7~62@) (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@))) (Add (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ a7~58@)) (Sub (Mul a7~58@ a7~58@) (Add c7~62@ b7~60@)))) (Sub (Sub (Mul (Add c7~62@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Add b7~60@ d7~64@) (Add a7~58@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ a7~58@)))))) (=> (= temp_7_1~2380@ (Mul (Mul (Mul (Mul (Sub b7~60@ 84) c7~62@) (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@))) (Add (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ a7~58@)) (Sub (Mul a7~58@ a7~58@) (Add c7~62@ b7~60@)))) (Sub (Sub (Mul (Add c7~62@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Add b7~60@ d7~64@) (Add a7~58@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ a7~58@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ b7~60@) (=> %%location_label%%7 (= temp_7_0~2243@ temp_7_1~2380@))) (=> (= temp_7_0~2243@ temp_7_1~2380@) (=> (= temp_8_0~2521@ (Mul (Mul (Add (Mul (Mul b8~68@ 53) (Mul d8~72@ d8~72@)) b8~68@) (Sub a8~66@ (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)))) (Mul (Mul (Mul (Add b8~68@ c8~70@) (Mul b8~68@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ b8~68@))) (Mul (Mul a8~66@ (Mul a8~66@ a8~66@)) (Add (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@)))))) (=> (= temp_8_1~2634@ (Mul (Mul (Add (Mul (Mul b8~68@ 53) (Mul d8~72@ d8~72@)) b8~68@) (Sub a8~66@ (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)))) (Mul (Mul (Mul (Add b8~68@ c8~70@) (Mul b8~68@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul a8~66@ a8~66@) a8~66@) (Add (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a8~66@ a8~66@ a8~66@) (=> %%location_label%%8 (= temp_8_0~2521@ temp_8_1~2634@))) (=> (= temp_8_0~2521@ temp_8_1~2634@) (=> (= temp_9_0~2793@ (Mul (Add (Sub (Mul (Mul c9~78@ d9~80@) (Sub c9~78@ b9~76@)) (Add (Mul a9~74@ c9~78@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ a9~74@)) (Mul (Add d9~80@ a9~74@) (Mul a9~74@ b9~76@)))) (Mul (Mul (Add (Mul c9~78@ d9~80@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Sub d9~80@ d9~80@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ c9~78@)))))) (=> (= temp_9_1~2922@ (Mul (Add (Sub (Mul (Mul c9~78@ d9~80@) (Sub c9~78@ b9~76@)) (Add (Mul a9~74@ c9~78@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ a9~74@)) (Mul (Add d9~80@ a9~74@) (Mul a9~74@ b9~76@)))) (Mul (Mul (Add (Mul c9~78@ d9~80@) (Mul d9~80@ b9~76@)) (Mul (Sub d9~80@ d9~80@) (Mul d9~80@ d9~80@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ c9~78@)))))) (and (=> (= tmp%13@ (Mul d9~80@ d9~80@)) (=> (= tmp%14@ (Sub d9~80@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%9 (= temp_9_0~2793@ temp_9_1~2922@))))) (=> (= temp_9_0~2793@ temp_9_1~2922@) (=> (= temp_10_0~3087@ (Mul (Mul (Mul (Mul (Mul d10~88@ a10~82@) (Sub d10~88@ d10~88@)) (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ c10~86@)) (Mul 21 (Sub b10~84@ a10~82@)))) (Mul (Sub (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ a10~82@)) (Mul b10~84@ (Mul a10~82@ a10~82@))) (Sub (Mul b10~84@ (Mul c10~86@ b10~84@)) (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ d10~88@)))))) (=> (= temp_10_1~3216@ (Mul (Mul (Mul (Mul d10~88@ (Mul a10~82@ (Sub d10~88@ d10~88@))) (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ c10~86@)) (Mul 21 (Sub b10~84@ a10~82@)))) (Mul (Sub (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ a10~82@)) (Mul b10~84@ (Mul a10~82@ a10~82@))) (Sub (Mul b10~84@ (Mul c10~86@ b10~84@)) (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ d10~88@)))))) (and (=> (= tmp%15@ (Sub d10~88@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d10~88@ a10~82@ tmp%15@) (=> %%location_label%%10 (= temp_10_0~3087@ temp_10_1~3216@)))) (=> (= temp_10_0~3087@ temp_10_1~3216@) (=> (= temp_11_0~3363@ (Add (Mul (Mul (Sub (Mul c11~94@ d11~96@) a11~90@) (Mul (Sub c11~94@ b11~92@) (Add c11~94@ a11~90@))) (Sub (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ c11~94@)) c11~94@)) (Mul (Sub (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ d11~96@)) (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@))) (Sub (Add (Add d11~96@ a11~90@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ a11~90@)))))) (=> (= temp_11_1~3476@ (Add (Mul (Mul (Sub (Mul c11~94@ d11~96@) a11~90@) (Mul (Sub c11~94@ b11~92@) (Add c11~94@ a11~90@))) (Sub (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ c11~94@)) c11~94@)) (Mul (Sub (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ d11~96@)) (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@))) (Sub (Add (Add d11~96@ a11~90@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ a11~90@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d11~96@ d11~96@) (=> %%location_label%%11 (= temp_11_0~3363@ temp_11_1~3476@))) (=> (= temp_11_0~3363@ temp_11_1~3476@) (=> (= temp_12_0~3621@ (Mul (Mul (Mul (Mul (Mul a12~98@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ c12~102@) a12~98@)) (Mul (Mul (Mul d12~104@ a12~98@) (Mul a12~98@ c12~102@)) (Sub (Mul d12~104@ c12~102@) (Mul d12~104@ c12~102@)))) (Mul (Mul (Mul (Mul d12~104@ d12~104@) (Sub c12~102@ b12~100@)) (Mul b12~100@ (Mul c12~102@ b12~100@))) (Mul (Mul (Mul d12~104@ a12~98@) d12~104@) (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ c12~102@)))))) (=> (= temp_12_1~3738@ (Mul (Mul (Mul (Mul (Mul a12~98@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ c12~102@) a12~98@)) (Mul (Mul (Mul d12~104@ a12~98@) (Mul a12~98@ c12~102@)) (Sub (Mul d12~104@ c12~102@) (Mul d12~104@ c12~102@)))) (Mul (Mul (Mul (Mul d12~104@ d12~104@) (Sub c12~102@ b12~100@)) (Mul b12~100@ (Mul c12~102@ b12~100@))) (Mul (Mul (Mul d12~104@ a12~98@) d12~104@) (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@)))))) (and (=> (= tmp%16@ (Mul d12~104@ a12~98@)) (=> (= tmp%17@ (Mul b12~100@ c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%12 (= temp_12_0~3621@ temp_12_1~3738@))))) (=> (= temp_12_0~3621@ temp_12_1~3738@) (=> (= temp_13_0~3903@ (Mul (Mul (Mul (Mul (Mul b13~108@ b13~108@) (Add d13~112@ d13~112@)) (Mul (Mul a13~106@ 29) b13~108@)) (Mul (Mul (Mul b13~108@ c13~110@) (Mul c13~110@ b13~108@)) (Mul (Sub d13~112@ b13~108@) (Mul c13~110@ b13~108@)))) (Mul (Mul (Sub (Mul c13~110@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@))) (Add (Mul b13~108@ b13~108@) (Mul (Mul a13~106@ a13~106@) (Sub b13~108@ a13~106@)))))) (=> (= temp_13_1~4032@ (Mul (Mul (Mul (Mul (Mul b13~108@ b13~108@) (Add d13~112@ d13~112@)) (Mul (Mul a13~106@ 29) b13~108@)) (Mul (Mul b13~108@ (Mul c13~110@ (Mul c13~110@ b13~108@))) (Mul (Sub d13~112@ b13~108@) (Mul c13~110@ b13~108@)))) (Mul (Mul (Sub (Mul c13~110@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@))) (Add (Mul b13~108@ b13~108@) (Mul (Mul a13~106@ a13~106@) (Sub b13~108@ a13~106@)))))) (=> (= tmp%18@ (Mul c13~110@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b13~108@ c13~110@ tmp%18@) (=> %%location_label%%13 (= temp_13_0~3903@ temp_13_1~4032@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
