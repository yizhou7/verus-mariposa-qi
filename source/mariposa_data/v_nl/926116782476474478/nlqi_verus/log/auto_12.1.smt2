...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Add (Mul (Add d0~8@ a0~2@) (Mul a0~2@ b0~4@)) (Add (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul d0~8@ (Mul b0~4@ b0~4@)) (Mul (Sub a0~2@ d0~8@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Add (Mul (Add d0~8@ a0~2@) (Mul a0~2@ b0~4@)) (Add (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul (Sub a0~2@ d0~8@) (Mul c0~6@ c0~6@)) (Mul d0~8@ (Mul b0~4@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~451@ (Add (Mul (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Add d1~16@ d1~16@) (Mul a1~10@ c1~14@))) (Mul (Mul (Sub d1~16@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~524@ (Add (Mul (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ b1~12@)) (Add (Mul d1~16@ (Mul a1~10@ c1~14@)) (Mul d1~16@ (Mul a1~10@ c1~14@)))) (Mul (Mul (Sub d1~16@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~451@ temp_1_1~524@))) (=> (= temp_1_0~451@ temp_1_1~524@) (=> (= temp_2_0~613@ (Mul (Add (Sub (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Add (Mul c2~22@ c2~22@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Sub d2~24@ c2~22@) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~678@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Sub d2~24@ c2~22@) (Mul c2~22@ a2~18@))) (Add (Sub (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Add (Mul c2~22@ c2~22@) (Mul d2~24@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~613@ temp_2_1~678@))) (=> (= temp_2_0~613@ temp_2_1~678@) (=> (= temp_3_0~763@ (Mul (Mul (Mul b3~28@ (Mul a3~26@ c3~30@)) (Mul (Sub a3~26@ c3~30@) (Mul d3~32@ d3~32@))) (Mul (Sub (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~824@ (Mul (Mul (Mul b3~28@ (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Sub a3~26@ c3~30@))) (Mul (Sub (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~763@ temp_3_1~824@))) (=> (= temp_3_0~763@ temp_3_1~824@) (=> (= temp_4_0~909@ (Mul (Mul (Mul a4~34@ (Mul a4~34@ d4~40@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@))) (Sub (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Add b4~36@ d4~40@))))) (=> (= temp_4_1~970@ (Mul (Mul (Mul a4~34@ (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@))) (Sub (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Add b4~36@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~909@ temp_4_1~970@))) (=> (= temp_4_0~909@ temp_4_1~970@) (=> (= temp_5_0~1051@ (Add (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@)) (Add (Sub b5~44@ d5~48@) (Sub a5~42@ c5~46@))) (Sub (Add (Mul d5~48@ b5~44@) (Sub a5~42@ c5~46@)) (Mul a5~42@ c5~46@)))) (=> (= temp_5_1~1108@ (Add (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@)) (Add (Sub b5~44@ d5~48@) (Sub a5~42@ c5~46@))) (Sub (Add (Mul d5~48@ b5~44@) (Sub a5~42@ c5~46@)) (Mul c5~46@ a5~42@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1051@ temp_5_1~1108@))) (=> (= temp_5_0~1051@ temp_5_1~1108@) (=> (= temp_6_0~1197@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Add b6~52@ b6~52@))) (Mul (Mul (Add d6~56@ d6~56@) (Add d6~56@ a6~50@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1262@ (Mul (Mul (Mul (Add d6~56@ d6~56@) (Add d6~56@ a6~50@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Add b6~52@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1197@ temp_6_1~1262@))) (=> (= temp_6_0~1197@ temp_6_1~1262@) (=> (= temp_7_0~1351@ (Mul (Add (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Mul 24 b7~60@) (Mul b7~60@ c7~62@))) (Mul (Mul (Mul d7~64@ d7~64@) (Sub b7~60@ c7~62@)) c7~62@))) (=> (= temp_7_1~1416@ (Mul (Add (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul 24 b7~60@) (Mul b7~60@ c7~62@))) (Mul (Mul (Mul d7~64@ d7~64@) (Sub b7~60@ c7~62@)) c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1351@ temp_7_1~1416@))) (=> (= temp_7_0~1351@ temp_7_1~1416@) (=> (= temp_8_0~1501@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Add b8~68@ a8~66@)) (Mul d8~72@ (Sub a8~66@ b8~68@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1566@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Add b8~68@ a8~66@)) (Sub (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1501@ temp_8_1~1566@))) (=> (= temp_8_0~1501@ temp_8_1~1566@) (=> (= temp_9_0~1651@ (Mul (Mul (Mul (Mul a9~74@ a9~74@) (Sub d9~80@ b9~76@)) (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ a9~74@))) (Add (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) b9~76@)))) (=> (= temp_9_1~1712@ (Mul (Mul (Mul a9~74@ a9~74@) (Sub d9~80@ b9~76@)) (Mul (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ a9~74@)) (Add (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1651@ temp_9_1~1712@))) (=> (= temp_9_0~1651@ temp_9_1~1712@) (=> (= temp_10_0~1789@ (Sub (Mul b10~84@ (Mul (Add b10~84@ a10~82@) (Mul a10~82@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ a10~82@)) (Sub (Mul a10~82@ b10~84@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~1842@ (Sub (Mul b10~84@ (Mul (Add b10~84@ a10~82@) (Mul a10~82@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ a10~82@)) (Sub (Mul a10~82@ b10~84@) (Mul d10~88@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1789@ temp_10_1~1842@))) (=> (= temp_10_0~1789@ temp_10_1~1842@) (=> (= temp_11_0~1967@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ d11~96@)) (Mul (Mul d11~96@ 1) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul b11~92@ a11~90@) (Add 45 a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ 74))))) (=> (= temp_11_1~2068@ (Mul (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ d11~96@)) (Mul (Mul (Mul d11~96@ 1) (Mul c11~94@ d11~96@)) (Mul (Mul (Mul b11~92@ a11~90@) (Add 45 a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ 74)))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1967@ temp_11_1~2068@))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
