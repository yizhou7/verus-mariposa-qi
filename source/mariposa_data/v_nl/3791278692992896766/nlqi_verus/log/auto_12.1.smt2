...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Add (Mul (Mul (Sub b0~4@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@)) (Add (Mul b0~4@ b0~4@) (Mul b0~4@ 38))))) (=> (= temp_0_1~394@ (Add (Mul (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Sub b0~4@ a0~2@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@)) (Add (Mul b0~4@ b0~4@) (Mul b0~4@ 38))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~491@ (Mul (Mul (Add (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul 56 a1~10@))) (Mul (Mul (Mul c1~14@ b1~12@) a1~10@) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~564@ (Mul (Add (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul (Mul d1~16@ d1~16@) (Mul 56 a1~10@)) (Mul (Mul (Mul c1~14@ b1~12@) a1~10@) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~491@ temp_1_1~564@))) (=> (= temp_1_0~491@ temp_1_1~564@) (=> (= temp_2_0~653@ (Mul (Sub (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ c2~22@))) (Mul (Mul (Sub c2~22@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Add b2~20@ b2~20@) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~718@ (Mul (Sub (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@))) (Mul (Mul (Sub c2~22@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Add b2~20@ b2~20@) (Mul c2~22@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~653@ temp_2_1~718@))) (=> (= temp_2_0~653@ temp_2_1~718@) (=> (= temp_3_0~819@ (Mul (Mul (Sub (Mul a3~26@ 70) (Mul b3~28@ b3~28@)) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@)) (Add (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~896@ (Mul (Mul (Sub (Mul a3~26@ 70) (Mul b3~28@ b3~28@)) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@)) (Add (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~819@ temp_3_1~896@))) (=> (= temp_3_0~819@ temp_3_1~896@) (=> (= temp_4_0~997@ (Mul (Mul (Mul (Mul 86 b4~36@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Add (Mul (Mul c4~38@ d4~40@) (Sub c4~38@ b4~36@)) (Mul (Add c4~38@ b4~36@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~1074@ (Mul (Mul (Mul (Mul b4~36@ 86) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Add (Mul (Mul c4~38@ d4~40@) (Sub c4~38@ b4~36@)) (Mul (Add c4~38@ b4~36@) (Mul a4~34@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~997@ temp_4_1~1074@))) (=> (= temp_4_0~997@ temp_4_1~1074@) (=> (= temp_5_0~1163@ (Mul (Mul (Sub (Mul d5~48@ a5~42@) (Sub d5~48@ a5~42@)) (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1228@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@)) (Sub (Mul d5~48@ a5~42@) (Sub d5~48@ a5~42@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1163@ temp_5_1~1228@))) (=> (= temp_5_0~1163@ temp_5_1~1228@) (=> (= temp_6_0~1281@ (Add (Mul (Mul d6~56@ (Mul d6~56@ b6~52@)) (Mul a6~50@ (Add a6~50@ c6~54@))) d6~56@)) (=> (= temp_6_1~1310@ (Add (Mul (Mul d6~56@ (Mul d6~56@ b6~52@)) (Mul (Add a6~50@ c6~54@) a6~50@)) d6~56@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1281@ temp_6_1~1310@))) (=> (= temp_6_0~1281@ temp_6_1~1310@) (=> (= temp_7_0~1399@ (Mul (Mul (Sub (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ b7~60@))) (Mul (Sub (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Sub b7~60@ b7~60@) (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1480@ (Mul (Sub (Mul (Mul d7~64@ c7~62@) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ b7~60@))) (Mul (Mul b7~60@ a7~58@) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ b7~60@)))) (Mul (Sub (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Sub b7~60@ b7~60@) (Mul d7~64@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1399@ temp_7_1~1480@))) (=> (= temp_7_0~1399@ temp_7_1~1480@) (=> (= temp_8_0~1581@ (Mul (Mul (Mul (Sub d8~72@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul 64 a8~66@) (Sub b8~68@ c8~70@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1658@ (Mul (Mul (Mul (Mul 64 a8~66@) (Sub b8~68@ c8~70@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@))) (Mul (Mul (Sub d8~72@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1581@ temp_8_1~1658@))) (=> (= temp_8_0~1581@ temp_8_1~1658@) (=> (= temp_9_0~1743@ (Mul (Add (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ c9~78@)) (Mul b9~76@ (Mul d9~80@ c9~78@))) (Mul (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ c9~78@)) (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1804@ (Mul (Add (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ d9~80@) c9~78@)) (Mul (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ c9~78@)) (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1743@ temp_9_1~1804@))) (=> (= temp_9_0~1743@ temp_9_1~1804@) (=> (= temp_10_0~1893@ (Mul (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ a10~82@))) (Mul (Mul (Add c10~86@ c10~86@) (Sub b10~84@ b10~84@)) (Sub (Add a10~82@ b10~84@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1958@ (Mul (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ a10~82@))) (Mul (Mul (Add c10~86@ c10~86@) (Sub b10~84@ b10~84@)) (Sub (Add a10~82@ b10~84@) (Mul d10~88@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1893@ temp_10_1~1958@))) (=> (= temp_10_0~1893@ temp_10_1~1958@) (=> (= temp_11_0~2047@ (Mul (Mul (Sub (Mul c11~94@ c11~94@) (Mul d11~96@ d11~96@)) (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ a11~90@))) (Mul (Mul (Mul a11~90@ b11~92@) (Add b11~92@ d11~96@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@))))) (=> (= temp_11_1~2112@ (Mul (Mul (Sub (Mul c11~94@ c11~94@) (Mul d11~96@ d11~96@)) (Mul b11~92@ (Mul a11~90@ (Mul a11~90@ a11~90@)))) (Mul (Mul (Mul a11~90@ b11~92@) (Add b11~92@ d11~96@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2047@ temp_11_1~2112@))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
