...
(set-info :comment ";; mariposa_data/v_nl//3791278692992896766/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_3_1~1002@ Int)
(declare-const temp_4_0~1107@ Int)
(declare-const temp_4_1~1184@ Int)
(declare-const temp_5_0~1289@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Add (Mul (Mul (Sub b0~4@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@)) (Add (Mul b0~4@ b0~4@) (Mul b0~4@ 38))))) (=> (= temp_0_1~394@ (Add (Mul (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Sub b0~4@ a0~2@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@)) (Add (Mul b0~4@ b0~4@) (Mul b0~4@ 38))))) (and (=> (= tmp%1@ (Mul (Sub b0~4@ a0~2@) (Mul b0~4@ c0~6@))) (=> (= tmp%2@ (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ d0~8@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~519@ (Mul (Mul (Add (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul 56 a1~10@))) (Mul (Mul (Mul c1~14@ b1~12@) a1~10@) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~592@ (Mul (Add (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul (Mul d1~16@ d1~16@) (Mul 56 a1~10@)) (Mul (Mul (Mul c1~14@ b1~12@) a1~10@) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@)))))) (and (=> (= tmp%3@ (Add (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@))) (=> (= tmp%4@ (Mul (Mul d1~16@ d1~16@) (Mul 56 a1~10@))) (=> (= tmp%5@ (Mul (Mul (Mul c1~14@ b1~12@) a1~10@) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~519@ temp_1_1~592@)))))) (=> (= temp_1_0~519@ temp_1_1~592@) (=> (= temp_2_0~747@ (Mul (Sub (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ c2~22@))) (Mul (Mul (Sub c2~22@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Add b2~20@ b2~20@) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~812@ (Mul (Sub (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@))) (Mul (Mul (Sub c2~22@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Add b2~20@ b2~20@) (Mul c2~22@ d2~24@))))) (and (=> (= tmp%6@ (Mul b2~20@ a2~18@)) (=> (= tmp%7@ (Mul b2~20@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~747@ temp_2_1~812@))))) (=> (= temp_2_0~747@ temp_2_1~812@) (=> (= temp_3_0~925@ (Mul (Mul (Sub (Mul a3~26@ 70) (Mul b3~28@ b3~28@)) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@)) (Add (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~1002@ (Mul (Mul (Sub (Mul a3~26@ 70) (Mul b3~28@ b3~28@)) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@)) (Add (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ b3~28@) (=> %%location_label%%3 (= temp_3_0~925@ temp_3_1~1002@))) (=> (= temp_3_0~925@ temp_3_1~1002@) (=> (= temp_4_0~1107@ (Mul (Mul (Mul (Mul 86 b4~36@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Add (Mul (Mul c4~38@ d4~40@) (Sub c4~38@ b4~36@)) (Mul (Add c4~38@ b4~36@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~1184@ (Mul (Mul (Mul (Mul b4~36@ 86) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Add (Mul (Mul c4~38@ d4~40@) (Sub c4~38@ b4~36@)) (Mul (Add c4~38@ b4~36@) (Mul a4~34@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 86 b4~36@) (=> %%location_label%%4 (= temp_4_0~1107@ temp_4_1~1184@))) (=> (= temp_4_0~1107@ temp_4_1~1184@) (=> (= temp_5_0~1289@ (Mul (Mul (Sub (Mul d5~48@ a5~42@) (Sub d5~48@ a5~42@)) (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1354@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@)) (Sub (Mul d5~48@ a5~42@) (Sub d5~48@ a5~42@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ d5~48@))))) (and (=> (= tmp%8@ (Sub (Mul d5~48@ a5~42@) (Sub d5~48@ a5~42@))) (=> (= tmp%9@ (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%5 (= temp_5_0~1289@ temp_5_1~1354@))))) (=> (= temp_5_0~1289@ temp_5_1~1354@) (=> (= temp_6_0~1435@ (Add (Mul (Mul d6~56@ (Mul d6~56@ b6~52@)) (Mul a6~50@ (Add a6~50@ c6~54@))) d6~56@)) (=> (= temp_6_1~1464@ (Add (Mul (Mul d6~56@ (Mul d6~56@ b6~52@)) (Mul (Add a6~50@ c6~54@) a6~50@)) d6~56@)) (and (=> (= tmp%10@ (Add a6~50@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~1435@ temp_6_1~1464@)))) (=> (= temp_6_0~1435@ temp_6_1~1464@) (=> (= temp_7_0~1561@ (Mul (Mul (Sub (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ b7~60@))) (Mul (Sub (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Sub b7~60@ b7~60@) (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1642@ (Mul (Sub (Mul (Mul d7~64@ c7~62@) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ b7~60@))) (Mul (Mul b7~60@ a7~58@) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ b7~60@)))) (Mul (Sub (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Sub b7~60@ b7~60@) (Mul d7~64@ d7~64@))))) (and (=> (= tmp%11@ (Mul d7~64@ c7~62@)) (=> (= tmp%12@ (Mul b7~60@ a7~58@)) (=> (= tmp%13@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ b7~60@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%7 (= temp_7_0~1561@ temp_7_1~1642@)))))) (=> (= temp_7_0~1561@ temp_7_1~1642@) (=> (= temp_8_0~1769@ (Mul (Mul (Mul (Sub d8~72@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul 64 a8~66@) (Sub b8~68@ c8~70@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1846@ (Mul (Mul (Mul (Mul 64 a8~66@) (Sub b8~68@ c8~70@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@))) (Mul (Mul (Sub d8~72@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ b8~68@))))) (and (=> (= tmp%14@ (Mul (Mul (Sub d8~72@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ b8~68@)))) (=> (= tmp%15@ (Mul (Mul (Mul 64 a8~66@) (Sub b8~68@ c8~70@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%8 (= temp_8_0~1769@ temp_8_1~1846@))))) (=> (= temp_8_0~1769@ temp_8_1~1846@) (=> (= temp_9_0~2003@ (Mul (Add (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ c9~78@)) (Mul b9~76@ (Mul d9~80@ c9~78@))) (Mul (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ c9~78@)) (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~2064@ (Mul (Add (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ d9~80@) c9~78@)) (Mul (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ c9~78@)) (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b9~76@ d9~80@ c9~78@) (=> %%location_label%%9 (= temp_9_0~2003@ temp_9_1~2064@))) (=> (= temp_9_0~2003@ temp_9_1~2064@) (=> (= temp_10_0~2159@ (Mul (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ a10~82@))) (Mul (Mul (Add c10~86@ c10~86@) (Sub b10~84@ b10~84@)) (Sub (Add a10~82@ b10~84@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~2224@ (Mul (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ a10~82@))) (Mul (Mul (Add c10~86@ c10~86@) (Sub b10~84@ b10~84@)) (Sub (Add a10~82@ b10~84@) (Mul d10~88@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ a10~82@) (=> %%location_label%%10 (= temp_10_0~2159@ temp_10_1~2224@))) (=> (= temp_10_0~2159@ temp_10_1~2224@) (=> (= temp_11_0~2317@ (Mul (Mul (Sub (Mul c11~94@ c11~94@) (Mul d11~96@ d11~96@)) (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ a11~90@))) (Mul (Mul (Mul a11~90@ b11~92@) (Add b11~92@ d11~96@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@))))) (=> (= temp_11_1~2382@ (Mul (Mul (Sub (Mul c11~94@ c11~94@) (Mul d11~96@ d11~96@)) (Mul b11~92@ (Mul a11~90@ (Mul a11~90@ a11~90@)))) (Mul (Mul (Mul a11~90@ b11~92@) (Add b11~92@ d11~96@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@))))) (=> (= tmp%16@ (Mul a11~90@ a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b11~92@ a11~90@ tmp%16@) (=> %%location_label%%11 (= temp_11_0~2317@ temp_11_1~2382@)))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
