...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Mul d0~8@ (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~314@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@))) d0~8@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~277@ temp_0_1~314@))) (=> (= temp_0_0~277@ temp_0_1~314@) (=> (= temp_1_0~399@ (Mul (Mul (Mul c1~14@ (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ d1~16@))) (Mul (Add (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~460@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) c1~14@) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ d1~16@))) (Mul (Add (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~399@ temp_1_1~460@))) (=> (= temp_1_0~399@ temp_1_1~460@) (=> (= temp_2_0~545@ (Add (Add (Mul (Mul d2~24@ d2~24@) (Add a2~18@ d2~24@)) (Mul (Sub d2~24@ c2~22@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ a2~18@) a2~18@)))) (=> (= temp_2_1~614@ (Add (Add (Mul (Mul d2~24@ d2~24@) (Add a2~18@ d2~24@)) (Sub (Mul d2~24@ (Mul b2~20@ a2~18@)) (Mul c2~22@ (Mul b2~20@ a2~18@)))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ a2~18@) a2~18@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~545@ temp_2_1~614@))) (=> (= temp_2_0~545@ temp_2_1~614@) (=> (= temp_3_0~723@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) 91) (Mul (Mul a3~26@ d3~32@) (Add b3~28@ 82))) (Mul (Mul (Sub c3~30@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~808@ (Mul (Mul (Mul (Mul (Mul b3~28@ d3~32@) 91) (Mul a3~26@ d3~32@)) (Add b3~28@ 82)) (Mul (Mul (Sub c3~30@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~723@ temp_3_1~808@))) (=> (= temp_3_0~723@ temp_3_1~808@) (=> (= temp_4_0~917@ (Mul (Sub (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul 49 d4~40@) (Mul 32 b4~36@))) (Add (Mul (Mul c4~38@ b4~36@) d4~40@) (Mul (Add a4~34@ c4~38@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~1002@ (Mul (Sub (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul 49 d4~40@) (Mul 32 b4~36@))) (Add (Mul (Mul c4~38@ b4~36@) d4~40@) (Mul (Mul (Add a4~34@ c4~38@) d4~40@) c4~38@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~917@ temp_4_1~1002@))) (=> (= temp_4_0~917@ temp_4_1~1002@) (=> (= temp_5_0~1087@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) b5~44@) (Sub (Mul a5~42@ b5~44@) (Mul c5~46@ 19))) (Mul d5~48@ (Sub (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@))))) (=> (= temp_5_1~1148@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) b5~44@) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ 19))) (Mul d5~48@ (Sub (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1087@ temp_5_1~1148@))) (=> (= temp_5_0~1087@ temp_5_1~1148@) (=> (= temp_6_0~1285@ (Mul (Mul (Mul (Add c6~54@ a6~50@) (Mul c6~54@ 55)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ b6~52@))) (Mul (Mul (Sub c6~54@ a6~50@) (Add d6~56@ d6~56@)) (Mul (Mul 35 12) (Mul 20 a6~50@))))) (=> (= temp_6_1~1398@ (Mul (Mul (Mul (Mul (Add c6~54@ a6~50@) (Mul c6~54@ 55)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ b6~52@))) (Mul (Sub c6~54@ a6~50@) (Add d6~56@ d6~56@))) (Mul (Mul 35 12) (Mul 20 a6~50@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1285@ temp_6_1~1398@))) (=> (= temp_6_0~1285@ temp_6_1~1398@) (=> (= temp_7_0~1475@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Sub d7~64@ a7~58@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@)) b7~60@))) (=> (= temp_7_1~1536@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ d7~64@)) (Sub (Mul (Mul b7~60@ b7~60@) d7~64@) (Mul (Mul b7~60@ b7~60@) a7~58@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@)) b7~60@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1475@ temp_7_1~1536@))) (=> (= temp_7_0~1475@ temp_7_1~1536@) (=> (= temp_8_0~1633@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ b8~68@)) (Add a8~66@ (Mul d8~72@ c8~70@))) (Sub (Add (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ 36))))) (=> (= temp_8_1~1706@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ b8~68@)) (Add a8~66@ (Mul d8~72@ c8~70@))) (Sub (Add (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul a8~66@ 36) (Mul d8~72@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1633@ temp_8_1~1706@))) (=> (= temp_8_0~1633@ temp_8_1~1706@) (=> (= temp_9_0~1807@ (Sub (Mul (Sub (Mul c9~78@ a9~74@) (Mul c9~78@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@))) (Mul (Mul (Sub d9~80@ a9~74@) (Mul a9~74@ b9~76@)) (Mul (Mul b9~76@ 88) (Mul a9~74@ d9~80@))))) (=> (= temp_9_1~1884@ (Sub (Mul (Sub (Mul c9~78@ a9~74@) (Mul c9~78@ a9~74@)) (Mul b9~76@ (Mul b9~76@ (Mul d9~80@ b9~76@)))) (Mul (Mul (Sub d9~80@ a9~74@) (Mul a9~74@ b9~76@)) (Mul (Mul b9~76@ 88) (Mul a9~74@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1807@ temp_9_1~1884@))) (=> (= temp_9_0~1807@ temp_9_1~1884@) (=> (= temp_10_0~1973@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ a10~82@) (Add c10~86@ b10~84@))) (Mul (Mul (Mul c10~86@ d10~88@) (Sub b10~84@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~2038@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ a10~82@) (Add c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ c10~86@) (Sub b10~84@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1973@ temp_10_1~2038@))) (=> (= temp_10_0~1973@ temp_10_1~2038@) (=> (= temp_11_0~2123@ (Sub (Mul (Sub (Mul b11~92@ a11~90@) (Sub c11~94@ a11~90@)) (Add d11~96@ (Mul c11~94@ b11~92@))) (Mul (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ a11~90@)) (Add (Mul a11~90@ a11~90@) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~2196@ (Sub (Sub (Mul (Mul b11~92@ a11~90@) (Add d11~96@ (Mul c11~94@ b11~92@))) (Mul (Sub c11~94@ a11~90@) (Add d11~96@ (Mul c11~94@ b11~92@)))) (Mul (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ a11~90@)) (Add (Mul a11~90@ a11~90@) (Mul a11~90@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2123@ temp_11_1~2196@))) (=> (= temp_11_0~2123@ temp_11_1~2196@) (=> (= temp_12_0~2269@ (Mul (Add (Sub (Mul c12~102@ b12~100@) (Sub c12~102@ 31)) (Mul (Mul b12~100@ b12~100@) (Add d12~104@ b12~100@))) c12~102@)) (=> (= temp_12_1~2322@ (Add (Mul (Sub (Mul c12~102@ b12~100@) (Sub c12~102@ 31)) c12~102@) (Mul (Mul (Mul b12~100@ b12~100@) (Add d12~104@ b12~100@)) c12~102@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2269@ temp_12_1~2322@))) (=> (= temp_12_0~2269@ temp_12_1~2322@) (=> (= temp_13_0~2383@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Sub a13~106@ c13~110@)) (Mul (Mul a13~106@ d13~112@) (Mul a13~106@ b13~108@))) a13~106@)) (=> (= temp_13_1~2420@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Sub a13~106@ c13~110@)) (Mul a13~106@ (Mul d13~112@ (Mul a13~106@ b13~108@)))) a13~106@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2383@ temp_13_1~2420@))) (=> (= temp_13_0~2383@ temp_13_1~2420@) (=> (= temp_14_0~2505@ (Sub (Sub (Mul (Mul d14~120@ b14~116@) c14~118@) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul a14~114@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@))))) (=> (= temp_14_1~2566@ (Sub (Sub (Mul (Mul d14~120@ b14~116@) c14~118@) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ a14~114@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul a14~114@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2505@ temp_14_1~2566@))) (=> (= temp_14_0~2505@ temp_14_1~2566@) (=> (= temp_15_0~2651@ (Mul (Mul a15~122@ (Mul (Mul b15~124@ d15~128@) d15~128@)) (Mul (Mul (Sub d15~128@ a15~122@) (Mul d15~128@ 75)) (Mul (Mul c15~126@ a15~122@) (Sub a15~122@ c15~126@))))) (=> (= temp_15_1~2712@ (Mul (Mul a15~122@ (Mul d15~128@ (Mul b15~124@ d15~128@))) (Mul (Mul (Sub d15~128@ a15~122@) (Mul d15~128@ 75)) (Mul (Mul c15~126@ a15~122@) (Sub a15~122@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2651@ temp_15_1~2712@))) (=> (= temp_15_0~2651@ temp_15_1~2712@) (=> (= temp_16_0~2809@ (Mul (Mul (Mul (Mul c16~134@ 18) (Mul c16~134@ d16~136@)) (Mul d16~136@ (Mul b16~132@ b16~132@))) (Mul (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul a16~130@ d16~136@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2882@ (Mul (Mul (Mul (Mul c16~134@ 18) (Mul c16~134@ d16~136@)) (Mul d16~136@ (Mul b16~132@ b16~132@))) (Mul (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul d16~136@ a16~130@) (Mul c16~134@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2809@ temp_16_1~2882@))) (=> (= temp_16_0~2809@ temp_16_1~2882@) (=> (= temp_17_0~2967@ (Mul (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ c17~142@)) (Mul c17~142@ (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~3028@ (Mul (Mul (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ c17~142@)) (Mul c17~142@ (Mul a17~138@ b17~140@))) (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2967@ temp_17_1~3028@))) (=> (= temp_17_0~2967@ temp_17_1~3028@) (=> (= temp_18_0~3105@ (Mul (Mul (Mul (Mul d18~152@ b18~148@) (Mul d18~152@ b18~148@)) (Mul (Mul c18~150@ a18~146@) (Add d18~152@ d18~152@))) (Mul b18~148@ (Mul (Sub d18~152@ d18~152@) (Sub d18~152@ a18~146@))))) (=> (= temp_18_1~3158@ (Mul (Mul (Mul (Mul d18~152@ b18~148@) (Mul d18~152@ b18~148@)) (Mul (Mul c18~150@ a18~146@) (Add d18~152@ d18~152@))) (Mul b18~148@ (Mul (Sub d18~152@ a18~146@) (Sub d18~152@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3105@ temp_18_1~3158@))) (=> (= temp_18_0~3105@ temp_18_1~3158@) (=> (= temp_19_0~3231@ (Add (Mul d19~160@ (Sub (Mul d19~160@ b19~156@) (Mul c19~158@ b19~156@))) (Mul (Mul (Add d19~160@ d19~160@) c19~158@) (Mul (Add a19~154@ c19~158@) (Mul b19~156@ b19~156@))))) (=> (= temp_19_1~3280@ (Add (Mul d19~160@ (Sub (Mul b19~156@ d19~160@) (Mul c19~158@ b19~156@))) (Mul (Mul (Add d19~160@ d19~160@) c19~158@) (Mul (Add a19~154@ c19~158@) (Mul b19~156@ b19~156@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3231@ temp_19_1~3280@))) (=> (= temp_19_0~3231@ temp_19_1~3280@) (=> (= temp_20_0~3369@ (Mul (Add (Mul (Mul b20~164@ a20~162@) (Mul d20~168@ d20~168@)) (Mul (Mul c20~166@ b20~164@) (Mul c20~166@ b20~164@))) (Mul (Mul (Mul d20~168@ b20~164@) (Mul d20~168@ b20~164@)) (Mul (Mul b20~164@ b20~164@) (Mul d20~168@ a20~162@))))) (=> (= temp_20_1~3434@ (Mul (Add (Mul (Mul b20~164@ a20~162@) (Mul d20~168@ d20~168@)) (Mul (Mul c20~166@ b20~164@) (Mul c20~166@ b20~164@))) (Mul (Mul (Mul b20~164@ b20~164@) (Mul d20~168@ a20~162@)) (Mul (Mul d20~168@ b20~164@) (Mul d20~168@ b20~164@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3369@ temp_20_1~3434@))) (=> (= temp_20_0~3369@ temp_20_1~3434@) (=> (= temp_21_0~3519@ (Mul (Sub (Mul d21~176@ (Mul c21~174@ c21~174@)) (Mul (Mul d21~176@ a21~170@) (Mul d21~176@ b21~172@))) (Mul (Mul (Mul a21~170@ a21~170@) (Mul d21~176@ c21~174@)) (Mul (Mul d21~176@ c21~174@) (Mul b21~172@ c21~174@))))) (=> (= temp_21_1~3580@ (Mul (Sub (Mul d21~176@ (Mul c21~174@ c21~174@)) (Mul (Mul d21~176@ a21~170@) (Mul d21~176@ b21~172@))) (Mul (Mul (Mul a21~170@ a21~170@) (Mul d21~176@ c21~174@)) (Mul (Mul b21~172@ c21~174@) (Mul d21~176@ c21~174@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3519@ temp_21_1~3580@))) (=> (= temp_21_0~3519@ temp_21_1~3580@) (=> (= temp_22_0~3677@ (Mul (Mul (Mul (Mul c22~182@ d22~184@) (Mul 0 c22~182@)) (Add d22~184@ (Add b22~180@ c22~182@))) (Mul (Mul (Mul b22~180@ a22~178@) (Mul b22~180@ b22~180@)) (Mul (Mul a22~178@ b22~180@) (Mul a22~178@ b22~180@))))) (=> (= temp_22_1~3750@ (Mul (Mul (Add d22~184@ (Add b22~180@ c22~182@)) (Mul (Mul c22~182@ d22~184@) (Mul 0 c22~182@))) (Mul (Mul (Mul b22~180@ a22~178@) (Mul b22~180@ b22~180@)) (Mul (Mul a22~178@ b22~180@) (Mul a22~178@ b22~180@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3677@ temp_22_1~3750@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
