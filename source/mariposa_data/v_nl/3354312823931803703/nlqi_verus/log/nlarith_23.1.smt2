...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Mul d0~8@ (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~314@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@))) d0~8@)) (=> (= tmp%1@ (= temp_0_0~277@ temp_0_1~314@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~390@ (Mul (Mul (Mul c1~14@ (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ d1~16@))) (Mul (Add (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~451@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) c1~14@) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ d1~16@))) (Mul (Add (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~390@ temp_1_1~451@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~527@ (Add (Add (Mul (Mul d2~24@ d2~24@) (Add a2~18@ d2~24@)) (Mul (Sub d2~24@ c2~22@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ a2~18@) a2~18@)))) (=> (= temp_2_1~596@ (Add (Add (Mul (Mul d2~24@ d2~24@) (Add a2~18@ d2~24@)) (Sub (Mul d2~24@ (Mul b2~20@ a2~18@)) (Mul c2~22@ (Mul b2~20@ a2~18@)))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ a2~18@) a2~18@)))) (=> (= tmp%3@ (= temp_2_0~527@ temp_2_1~596@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~696@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) 91) (Mul (Mul a3~26@ d3~32@) (Add b3~28@ 82))) (Mul (Mul (Sub c3~30@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~781@ (Mul (Mul (Mul (Mul (Mul b3~28@ d3~32@) 91) (Mul a3~26@ d3~32@)) (Add b3~28@ 82)) (Mul (Mul (Sub c3~30@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~696@ temp_3_1~781@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~881@ (Mul (Sub (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul 49 d4~40@) (Mul 32 b4~36@))) (Add (Mul (Mul c4~38@ b4~36@) d4~40@) (Mul (Add a4~34@ c4~38@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~966@ (Mul (Sub (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul 49 d4~40@) (Mul 32 b4~36@))) (Add (Mul (Mul c4~38@ b4~36@) d4~40@) (Mul (Mul (Add a4~34@ c4~38@) d4~40@) c4~38@)))) (=> (= tmp%5@ (= temp_4_0~881@ temp_4_1~966@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1042@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) b5~44@) (Sub (Mul a5~42@ b5~44@) (Mul c5~46@ 19))) (Mul d5~48@ (Sub (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@))))) (=> (= temp_5_1~1103@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) b5~44@) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ 19))) (Mul d5~48@ (Sub (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1042@ temp_5_1~1103@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1231@ (Mul (Mul (Mul (Add c6~54@ a6~50@) (Mul c6~54@ 55)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ b6~52@))) (Mul (Mul (Sub c6~54@ a6~50@) (Add d6~56@ d6~56@)) (Mul (Mul 35 12) (Mul 20 a6~50@))))) (=> (= temp_6_1~1344@ (Mul (Mul (Mul (Mul (Add c6~54@ a6~50@) (Mul c6~54@ 55)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ b6~52@))) (Mul (Sub c6~54@ a6~50@) (Add d6~56@ d6~56@))) (Mul (Mul 35 12) (Mul 20 a6~50@)))) (=> (= tmp%7@ (= temp_6_0~1231@ temp_6_1~1344@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1412@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Sub d7~64@ a7~58@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@)) b7~60@))) (=> (= temp_7_1~1473@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ d7~64@)) (Sub (Mul (Mul b7~60@ b7~60@) d7~64@) (Mul (Mul b7~60@ b7~60@) a7~58@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@)) b7~60@))) (=> (= tmp%8@ (= temp_7_0~1412@ temp_7_1~1473@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1561@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ b8~68@)) (Add a8~66@ (Mul d8~72@ c8~70@))) (Sub (Add (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ 36))))) (=> (= temp_8_1~1634@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ b8~68@)) (Add a8~66@ (Mul d8~72@ c8~70@))) (Sub (Add (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul a8~66@ 36) (Mul d8~72@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1561@ temp_8_1~1634@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1726@ (Sub (Mul (Sub (Mul c9~78@ a9~74@) (Mul c9~78@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@))) (Mul (Mul (Sub d9~80@ a9~74@) (Mul a9~74@ b9~76@)) (Mul (Mul b9~76@ 88) (Mul a9~74@ d9~80@))))) (=> (= temp_9_1~1803@ (Sub (Mul (Sub (Mul c9~78@ a9~74@) (Mul c9~78@ a9~74@)) (Mul b9~76@ (Mul b9~76@ (Mul d9~80@ b9~76@)))) (Mul (Mul (Sub d9~80@ a9~74@) (Mul a9~74@ b9~76@)) (Mul (Mul b9~76@ 88) (Mul a9~74@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1726@ temp_9_1~1803@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1883@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ a10~82@) (Add c10~86@ b10~84@))) (Mul (Mul (Mul c10~86@ d10~88@) (Sub b10~84@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1948@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ a10~82@) (Add c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ c10~86@) (Sub b10~84@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1883@ temp_10_1~1948@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~2024@ (Sub (Mul (Sub (Mul b11~92@ a11~90@) (Sub c11~94@ a11~90@)) (Add d11~96@ (Mul c11~94@ b11~92@))) (Mul (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ a11~90@)) (Add (Mul a11~90@ a11~90@) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~2097@ (Sub (Sub (Mul (Mul b11~92@ a11~90@) (Add d11~96@ (Mul c11~94@ b11~92@))) (Mul (Sub c11~94@ a11~90@) (Add d11~96@ (Mul c11~94@ b11~92@)))) (Mul (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ a11~90@)) (Add (Mul a11~90@ a11~90@) (Mul a11~90@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~2024@ temp_11_1~2097@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2161@ (Mul (Add (Sub (Mul c12~102@ b12~100@) (Sub c12~102@ 31)) (Mul (Mul b12~100@ b12~100@) (Add d12~104@ b12~100@))) c12~102@)) (=> (= temp_12_1~2214@ (Add (Mul (Sub (Mul c12~102@ b12~100@) (Sub c12~102@ 31)) c12~102@) (Mul (Mul (Mul b12~100@ b12~100@) (Add d12~104@ b12~100@)) c12~102@))) (=> (= tmp%13@ (= temp_12_0~2161@ temp_12_1~2214@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2266@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Sub a13~106@ c13~110@)) (Mul (Mul a13~106@ d13~112@) (Mul a13~106@ b13~108@))) a13~106@)) (=> (= temp_13_1~2303@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Sub a13~106@ c13~110@)) (Mul a13~106@ (Mul d13~112@ (Mul a13~106@ b13~108@)))) a13~106@)) (=> (= tmp%14@ (= temp_13_0~2266@ temp_13_1~2303@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2379@ (Sub (Sub (Mul (Mul d14~120@ b14~116@) c14~118@) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul a14~114@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@))))) (=> (= temp_14_1~2440@ (Sub (Sub (Mul (Mul d14~120@ b14~116@) c14~118@) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ a14~114@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul a14~114@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2379@ temp_14_1~2440@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2516@ (Mul (Mul a15~122@ (Mul (Mul b15~124@ d15~128@) d15~128@)) (Mul (Mul (Sub d15~128@ a15~122@) (Mul d15~128@ 75)) (Mul (Mul c15~126@ a15~122@) (Sub a15~122@ c15~126@))))) (=> (= temp_15_1~2577@ (Mul (Mul a15~122@ (Mul d15~128@ (Mul b15~124@ d15~128@))) (Mul (Mul (Sub d15~128@ a15~122@) (Mul d15~128@ 75)) (Mul (Mul c15~126@ a15~122@) (Sub a15~122@ c15~126@))))) (=> (= tmp%16@ (= temp_15_0~2516@ temp_15_1~2577@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2665@ (Mul (Mul (Mul (Mul c16~134@ 18) (Mul c16~134@ d16~136@)) (Mul d16~136@ (Mul b16~132@ b16~132@))) (Mul (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul a16~130@ d16~136@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2738@ (Mul (Mul (Mul (Mul c16~134@ 18) (Mul c16~134@ d16~136@)) (Mul d16~136@ (Mul b16~132@ b16~132@))) (Mul (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul d16~136@ a16~130@) (Mul c16~134@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2665@ temp_16_1~2738@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2814@ (Mul (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ c17~142@)) (Mul c17~142@ (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~2875@ (Mul (Mul (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ c17~142@)) (Mul c17~142@ (Mul a17~138@ b17~140@))) (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ c17~142@))))) (=> (= tmp%18@ (= temp_17_0~2814@ temp_17_1~2875@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2943@ (Mul (Mul (Mul (Mul d18~152@ b18~148@) (Mul d18~152@ b18~148@)) (Mul (Mul c18~150@ a18~146@) (Add d18~152@ d18~152@))) (Mul b18~148@ (Mul (Sub d18~152@ d18~152@) (Sub d18~152@ a18~146@))))) (=> (= temp_18_1~2996@ (Mul (Mul (Mul (Mul d18~152@ b18~148@) (Mul d18~152@ b18~148@)) (Mul (Mul c18~150@ a18~146@) (Add d18~152@ d18~152@))) (Mul b18~148@ (Mul (Sub d18~152@ a18~146@) (Sub d18~152@ d18~152@))))) (=> (= tmp%19@ (= temp_18_0~2943@ temp_18_1~2996@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3060@ (Add (Mul d19~160@ (Sub (Mul d19~160@ b19~156@) (Mul c19~158@ b19~156@))) (Mul (Mul (Add d19~160@ d19~160@) c19~158@) (Mul (Add a19~154@ c19~158@) (Mul b19~156@ b19~156@))))) (=> (= temp_19_1~3109@ (Add (Mul d19~160@ (Sub (Mul b19~156@ d19~160@) (Mul c19~158@ b19~156@))) (Mul (Mul (Add d19~160@ d19~160@) c19~158@) (Mul (Add a19~154@ c19~158@) (Mul b19~156@ b19~156@))))) (=> (= tmp%20@ (= temp_19_0~3060@ temp_19_1~3109@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3189@ (Mul (Add (Mul (Mul b20~164@ a20~162@) (Mul d20~168@ d20~168@)) (Mul (Mul c20~166@ b20~164@) (Mul c20~166@ b20~164@))) (Mul (Mul (Mul d20~168@ b20~164@) (Mul d20~168@ b20~164@)) (Mul (Mul b20~164@ b20~164@) (Mul d20~168@ a20~162@))))) (=> (= temp_20_1~3254@ (Mul (Add (Mul (Mul b20~164@ a20~162@) (Mul d20~168@ d20~168@)) (Mul (Mul c20~166@ b20~164@) (Mul c20~166@ b20~164@))) (Mul (Mul (Mul b20~164@ b20~164@) (Mul d20~168@ a20~162@)) (Mul (Mul d20~168@ b20~164@) (Mul d20~168@ b20~164@))))) (=> (= tmp%21@ (= temp_20_0~3189@ temp_20_1~3254@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3330@ (Mul (Sub (Mul d21~176@ (Mul c21~174@ c21~174@)) (Mul (Mul d21~176@ a21~170@) (Mul d21~176@ b21~172@))) (Mul (Mul (Mul a21~170@ a21~170@) (Mul d21~176@ c21~174@)) (Mul (Mul d21~176@ c21~174@) (Mul b21~172@ c21~174@))))) (=> (= temp_21_1~3391@ (Mul (Sub (Mul d21~176@ (Mul c21~174@ c21~174@)) (Mul (Mul d21~176@ a21~170@) (Mul d21~176@ b21~172@))) (Mul (Mul (Mul a21~170@ a21~170@) (Mul d21~176@ c21~174@)) (Mul (Mul b21~172@ c21~174@) (Mul d21~176@ c21~174@))))) (=> (= tmp%22@ (= temp_21_0~3330@ temp_21_1~3391@)) (and (=> %%location_label%%21 tmp%22@) (=> tmp%22@ (=> (= temp_22_0~3479@ (Mul (Mul (Mul (Mul c22~182@ d22~184@) (Mul 0 c22~182@)) (Add d22~184@ (Add b22~180@ c22~182@))) (Mul (Mul (Mul b22~180@ a22~178@) (Mul b22~180@ b22~180@)) (Mul (Mul a22~178@ b22~180@) (Mul a22~178@ b22~180@))))) (=> (= temp_22_1~3552@ (Mul (Mul (Add d22~184@ (Add b22~180@ c22~182@)) (Mul (Mul c22~182@ d22~184@) (Mul 0 c22~182@))) (Mul (Mul (Mul b22~180@ a22~178@) (Mul b22~180@ b22~180@)) (Mul (Mul a22~178@ b22~180@) (Mul a22~178@ b22~180@))))) (=> (= tmp%23@ (= temp_22_0~3479@ temp_22_1~3552@)) (=> %%location_label%%22 tmp%23@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
