...
(set-info :comment ";; mariposa_data/v_nl//3354312823931803703/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_5_0~1193@ Int)
(declare-const temp_5_1~1254@ Int)
(declare-const temp_6_0~1395@ Int)
(declare-const temp_6_1~1508@ Int)
(declare-const temp_7_0~1691@ Int)
(declare-const temp_7_1~1752@ Int)
(declare-const temp_8_0~1859@ Int)
(declare-const temp_8_1~1932@ Int)
(declare-const temp_9_0~2057@ Int)
(declare-const temp_9_1~2134@ Int)
(declare-const temp_10_0~2233@ Int)
(declare-const temp_10_1~2298@ Int)
(declare-const temp_11_0~2387@ Int)
(declare-const temp_11_1~2460@ Int)
(declare-const temp_12_0~2555@ Int)
(declare-const temp_12_1~2608@ Int)
(declare-const temp_13_0~2711@ Int)
(declare-const temp_13_1~2748@ Int)
(declare-const temp_14_0~2843@ Int)
(declare-const temp_14_1~2904@ Int)
(declare-const temp_15_0~3001@ Int)
(declare-const temp_15_1~3062@ Int)
(declare-const temp_16_0~3167@ Int)
(declare-const temp_16_1~3240@ Int)
(declare-const temp_17_0~3329@ Int)
(declare-const temp_17_1~3390@ Int)
(declare-const temp_18_0~3523@ Int)
(declare-const temp_18_1~3576@ Int)
(declare-const temp_19_0~3661@ Int)
(declare-const temp_19_1~3710@ Int)
(declare-const temp_20_0~3803@ Int)
(declare-const temp_20_1~3868@ Int)
(declare-const temp_21_0~3981@ Int)
(declare-const temp_21_1~4042@ Int)
(declare-const temp_22_0~4151@ Int)
(declare-const temp_22_1~4224@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Mul d0~8@ (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~314@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@))) d0~8@)) (and (=> (= tmp%1@ (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~277@ temp_0_1~314@)))) (=> (= temp_0_0~277@ temp_0_1~314@) (=> (= temp_1_0~431@ (Mul (Mul (Mul c1~14@ (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ d1~16@))) (Mul (Add (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~492@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) c1~14@) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ d1~16@))) (Mul (Add (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@))))) (and (=> (= tmp%2@ (Mul a1~10@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~431@ temp_1_1~492@)))) (=> (= temp_1_0~431@ temp_1_1~492@) (=> (= temp_2_0~585@ (Add (Add (Mul (Mul d2~24@ d2~24@) (Add a2~18@ d2~24@)) (Mul (Sub d2~24@ c2~22@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ a2~18@) a2~18@)))) (=> (= temp_2_1~654@ (Add (Add (Mul (Mul d2~24@ d2~24@) (Add a2~18@ d2~24@)) (Sub (Mul d2~24@ (Mul b2~20@ a2~18@)) (Mul c2~22@ (Mul b2~20@ a2~18@)))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ a2~18@) a2~18@)))) (and (=> (= tmp%3@ (Mul b2~20@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d2~24@ c2~22@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~585@ temp_2_1~654@)))) (=> (= temp_2_0~585@ temp_2_1~654@) (=> (= temp_3_0~773@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) 91) (Mul (Mul a3~26@ d3~32@) (Add b3~28@ 82))) (Mul (Mul (Sub c3~30@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~858@ (Mul (Mul (Mul (Mul (Mul b3~28@ d3~32@) 91) (Mul a3~26@ d3~32@)) (Add b3~28@ 82)) (Mul (Mul (Sub c3~30@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@))))) (and (=> (= tmp%4@ (Mul (Mul b3~28@ d3~32@) 91)) (=> (= tmp%5@ (Mul a3~26@ d3~32@)) (=> (= tmp%6@ (Add b3~28@ 82)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~773@ temp_3_1~858@)))))) (=> (= temp_3_0~773@ temp_3_1~858@) (=> (= temp_4_0~1013@ (Mul (Sub (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul 49 d4~40@) (Mul 32 b4~36@))) (Add (Mul (Mul c4~38@ b4~36@) d4~40@) (Mul (Add a4~34@ c4~38@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~1098@ (Mul (Sub (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul 49 d4~40@) (Mul 32 b4~36@))) (Add (Mul (Mul c4~38@ b4~36@) d4~40@) (Mul (Mul (Add a4~34@ c4~38@) d4~40@) c4~38@)))) (and (=> (= tmp%7@ (Add a4~34@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ d4~40@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1013@ temp_4_1~1098@)))) (=> (= temp_4_0~1013@ temp_4_1~1098@) (=> (= temp_5_0~1193@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) b5~44@) (Sub (Mul a5~42@ b5~44@) (Mul c5~46@ 19))) (Mul d5~48@ (Sub (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@))))) (=> (= temp_5_1~1254@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) b5~44@) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ 19))) (Mul d5~48@ (Sub (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1193@ temp_5_1~1254@))) (=> (= temp_5_0~1193@ temp_5_1~1254@) (=> (= temp_6_0~1395@ (Mul (Mul (Mul (Add c6~54@ a6~50@) (Mul c6~54@ 55)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ b6~52@))) (Mul (Mul (Sub c6~54@ a6~50@) (Add d6~56@ d6~56@)) (Mul (Mul 35 12) (Mul 20 a6~50@))))) (=> (= temp_6_1~1508@ (Mul (Mul (Mul (Mul (Add c6~54@ a6~50@) (Mul c6~54@ 55)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ b6~52@))) (Mul (Sub c6~54@ a6~50@) (Add d6~56@ d6~56@))) (Mul (Mul 35 12) (Mul 20 a6~50@)))) (and (=> (= tmp%8@ (Mul (Mul (Add c6~54@ a6~50@) (Mul c6~54@ 55)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ b6~52@)))) (=> (= tmp%9@ (Mul (Sub c6~54@ a6~50@) (Add d6~56@ d6~56@))) (=> (= tmp%10@ (Mul (Mul 35 12) (Mul 20 a6~50@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~1395@ temp_6_1~1508@)))))) (=> (= temp_6_0~1395@ temp_6_1~1508@) (=> (= temp_7_0~1691@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Sub d7~64@ a7~58@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@)) b7~60@))) (=> (= temp_7_1~1752@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ d7~64@)) (Sub (Mul (Mul b7~60@ b7~60@) d7~64@) (Mul (Mul b7~60@ b7~60@) a7~58@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@)) b7~60@))) (and (=> (= tmp%11@ (Mul b7~60@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ d7~64@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1691@ temp_7_1~1752@)))) (=> (= temp_7_0~1691@ temp_7_1~1752@) (=> (= temp_8_0~1859@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ b8~68@)) (Add a8~66@ (Mul d8~72@ c8~70@))) (Sub (Add (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ 36))))) (=> (= temp_8_1~1932@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ b8~68@)) (Add a8~66@ (Mul d8~72@ c8~70@))) (Sub (Add (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul a8~66@ 36) (Mul d8~72@ d8~72@))))) (and (=> (= tmp%12@ (Mul d8~72@ d8~72@)) (=> (= tmp%13@ (Mul a8~66@ 36)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%8 (= temp_8_0~1859@ temp_8_1~1932@))))) (=> (= temp_8_0~1859@ temp_8_1~1932@) (=> (= temp_9_0~2057@ (Sub (Mul (Sub (Mul c9~78@ a9~74@) (Mul c9~78@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@))) (Mul (Mul (Sub d9~80@ a9~74@) (Mul a9~74@ b9~76@)) (Mul (Mul b9~76@ 88) (Mul a9~74@ d9~80@))))) (=> (= temp_9_1~2134@ (Sub (Mul (Sub (Mul c9~78@ a9~74@) (Mul c9~78@ a9~74@)) (Mul b9~76@ (Mul b9~76@ (Mul d9~80@ b9~76@)))) (Mul (Mul (Sub d9~80@ a9~74@) (Mul a9~74@ b9~76@)) (Mul (Mul b9~76@ 88) (Mul a9~74@ d9~80@))))) (and (=> (= tmp%14@ (Mul d9~80@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b9~76@ b9~76@ tmp%14@) (=> %%location_label%%9 (= temp_9_0~2057@ temp_9_1~2134@)))) (=> (= temp_9_0~2057@ temp_9_1~2134@) (=> (= temp_10_0~2233@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ a10~82@) (Add c10~86@ b10~84@))) (Mul (Mul (Mul c10~86@ d10~88@) (Sub b10~84@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~2298@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ a10~82@) (Add c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ c10~86@) (Sub b10~84@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ d10~88@) (=> %%location_label%%10 (= temp_10_0~2233@ temp_10_1~2298@))) (=> (= temp_10_0~2233@ temp_10_1~2298@) (=> (= temp_11_0~2387@ (Sub (Mul (Sub (Mul b11~92@ a11~90@) (Sub c11~94@ a11~90@)) (Add d11~96@ (Mul c11~94@ b11~92@))) (Mul (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ a11~90@)) (Add (Mul a11~90@ a11~90@) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~2460@ (Sub (Sub (Mul (Mul b11~92@ a11~90@) (Add d11~96@ (Mul c11~94@ b11~92@))) (Mul (Sub c11~94@ a11~90@) (Add d11~96@ (Mul c11~94@ b11~92@)))) (Mul (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ a11~90@)) (Add (Mul a11~90@ a11~90@) (Mul a11~90@ c11~94@))))) (and (=> (= tmp%15@ (Mul b11~92@ a11~90@)) (=> (= tmp%16@ (Sub c11~94@ a11~90@)) (=> (= tmp%17@ (Add d11~96@ (Mul c11~94@ b11~92@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%11 (= temp_11_0~2387@ temp_11_1~2460@)))))) (=> (= temp_11_0~2387@ temp_11_1~2460@) (=> (= temp_12_0~2555@ (Mul (Add (Sub (Mul c12~102@ b12~100@) (Sub c12~102@ 31)) (Mul (Mul b12~100@ b12~100@) (Add d12~104@ b12~100@))) c12~102@)) (=> (= temp_12_1~2608@ (Add (Mul (Sub (Mul c12~102@ b12~100@) (Sub c12~102@ 31)) c12~102@) (Mul (Mul (Mul b12~100@ b12~100@) (Add d12~104@ b12~100@)) c12~102@))) (and (=> (= tmp%18@ (Sub (Mul c12~102@ b12~100@) (Sub c12~102@ 31))) (=> (= tmp%19@ (Mul (Mul b12~100@ b12~100@) (Add d12~104@ b12~100@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%18@ tmp%19@ c12~102@) (=> %%location_label%%12 (= temp_12_0~2555@ temp_12_1~2608@))))) (=> (= temp_12_0~2555@ temp_12_1~2608@) (=> (= temp_13_0~2711@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Sub a13~106@ c13~110@)) (Mul (Mul a13~106@ d13~112@) (Mul a13~106@ b13~108@))) a13~106@)) (=> (= temp_13_1~2748@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Sub a13~106@ c13~110@)) (Mul a13~106@ (Mul d13~112@ (Mul a13~106@ b13~108@)))) a13~106@)) (and (=> (= tmp%20@ (Mul a13~106@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a13~106@ d13~112@ tmp%20@) (=> %%location_label%%13 (= temp_13_0~2711@ temp_13_1~2748@)))) (=> (= temp_13_0~2711@ temp_13_1~2748@) (=> (= temp_14_0~2843@ (Sub (Sub (Mul (Mul d14~120@ b14~116@) c14~118@) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul a14~114@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@))))) (=> (= temp_14_1~2904@ (Sub (Sub (Mul (Mul d14~120@ b14~116@) c14~118@) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ a14~114@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul a14~114@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ c14~118@))))) (and (=> (= tmp%21@ (Mul a14~114@ a14~114@)) (=> (= tmp%22@ (Mul d14~120@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%14 (= temp_14_0~2843@ temp_14_1~2904@))))) (=> (= temp_14_0~2843@ temp_14_1~2904@) (=> (= temp_15_0~3001@ (Mul (Mul a15~122@ (Mul (Mul b15~124@ d15~128@) d15~128@)) (Mul (Mul (Sub d15~128@ a15~122@) (Mul d15~128@ 75)) (Mul (Mul c15~126@ a15~122@) (Sub a15~122@ c15~126@))))) (=> (= temp_15_1~3062@ (Mul (Mul a15~122@ (Mul d15~128@ (Mul b15~124@ d15~128@))) (Mul (Mul (Sub d15~128@ a15~122@) (Mul d15~128@ 75)) (Mul (Mul c15~126@ a15~122@) (Sub a15~122@ c15~126@))))) (and (=> (= tmp%23@ (Mul b15~124@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ d15~128@) (=> %%location_label%%15 (= temp_15_0~3001@ temp_15_1~3062@)))) (=> (= temp_15_0~3001@ temp_15_1~3062@) (=> (= temp_16_0~3167@ (Mul (Mul (Mul (Mul c16~134@ 18) (Mul c16~134@ d16~136@)) (Mul d16~136@ (Mul b16~132@ b16~132@))) (Mul (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul a16~130@ d16~136@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~3240@ (Mul (Mul (Mul (Mul c16~134@ 18) (Mul c16~134@ d16~136@)) (Mul d16~136@ (Mul b16~132@ b16~132@))) (Mul (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ b16~132@)) (Mul (Mul d16~136@ a16~130@) (Mul c16~134@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a16~130@ d16~136@) (=> %%location_label%%16 (= temp_16_0~3167@ temp_16_1~3240@))) (=> (= temp_16_0~3167@ temp_16_1~3240@) (=> (= temp_17_0~3329@ (Mul (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ c17~142@)) (Mul c17~142@ (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~3390@ (Mul (Mul (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ c17~142@)) (Mul c17~142@ (Mul a17~138@ b17~140@))) (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ c17~142@))))) (and (=> (= tmp%24@ (Mul (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ d17~144@) (Mul b17~140@ c17~142@)))) (=> (= tmp%25@ (Mul (Mul (Mul b17~140@ b17~140@) (Mul d17~144@ c17~142@)) (Mul c17~142@ (Mul a17~138@ b17~140@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%24@ tmp%25@) (=> %%location_label%%17 (= temp_17_0~3329@ temp_17_1~3390@))))) (=> (= temp_17_0~3329@ temp_17_1~3390@) (=> (= temp_18_0~3523@ (Mul (Mul (Mul (Mul d18~152@ b18~148@) (Mul d18~152@ b18~148@)) (Mul (Mul c18~150@ a18~146@) (Add d18~152@ d18~152@))) (Mul b18~148@ (Mul (Sub d18~152@ d18~152@) (Sub d18~152@ a18~146@))))) (=> (= temp_18_1~3576@ (Mul (Mul (Mul (Mul d18~152@ b18~148@) (Mul d18~152@ b18~148@)) (Mul (Mul c18~150@ a18~146@) (Add d18~152@ d18~152@))) (Mul b18~148@ (Mul (Sub d18~152@ a18~146@) (Sub d18~152@ d18~152@))))) (and (=> (= tmp%26@ (Sub d18~152@ d18~152@)) (=> (= tmp%27@ (Sub d18~152@ a18~146@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%26@ tmp%27@) (=> %%location_label%%18 (= temp_18_0~3523@ temp_18_1~3576@))))) (=> (= temp_18_0~3523@ temp_18_1~3576@) (=> (= temp_19_0~3661@ (Add (Mul d19~160@ (Sub (Mul d19~160@ b19~156@) (Mul c19~158@ b19~156@))) (Mul (Mul (Add d19~160@ d19~160@) c19~158@) (Mul (Add a19~154@ c19~158@) (Mul b19~156@ b19~156@))))) (=> (= temp_19_1~3710@ (Add (Mul d19~160@ (Sub (Mul b19~156@ d19~160@) (Mul c19~158@ b19~156@))) (Mul (Mul (Add d19~160@ d19~160@) c19~158@) (Mul (Add a19~154@ c19~158@) (Mul b19~156@ b19~156@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d19~160@ b19~156@) (=> %%location_label%%19 (= temp_19_0~3661@ temp_19_1~3710@))) (=> (= temp_19_0~3661@ temp_19_1~3710@) (=> (= temp_20_0~3803@ (Mul (Add (Mul (Mul b20~164@ a20~162@) (Mul d20~168@ d20~168@)) (Mul (Mul c20~166@ b20~164@) (Mul c20~166@ b20~164@))) (Mul (Mul (Mul d20~168@ b20~164@) (Mul d20~168@ b20~164@)) (Mul (Mul b20~164@ b20~164@) (Mul d20~168@ a20~162@))))) (=> (= temp_20_1~3868@ (Mul (Add (Mul (Mul b20~164@ a20~162@) (Mul d20~168@ d20~168@)) (Mul (Mul c20~166@ b20~164@) (Mul c20~166@ b20~164@))) (Mul (Mul (Mul b20~164@ b20~164@) (Mul d20~168@ a20~162@)) (Mul (Mul d20~168@ b20~164@) (Mul d20~168@ b20~164@))))) (and (=> (= tmp%28@ (Mul (Mul d20~168@ b20~164@) (Mul d20~168@ b20~164@))) (=> (= tmp%29@ (Mul (Mul b20~164@ b20~164@) (Mul d20~168@ a20~162@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%28@ tmp%29@) (=> %%location_label%%20 (= temp_20_0~3803@ temp_20_1~3868@))))) (=> (= temp_20_0~3803@ temp_20_1~3868@) (=> (= temp_21_0~3981@ (Mul (Sub (Mul d21~176@ (Mul c21~174@ c21~174@)) (Mul (Mul d21~176@ a21~170@) (Mul d21~176@ b21~172@))) (Mul (Mul (Mul a21~170@ a21~170@) (Mul d21~176@ c21~174@)) (Mul (Mul d21~176@ c21~174@) (Mul b21~172@ c21~174@))))) (=> (= temp_21_1~4042@ (Mul (Sub (Mul d21~176@ (Mul c21~174@ c21~174@)) (Mul (Mul d21~176@ a21~170@) (Mul d21~176@ b21~172@))) (Mul (Mul (Mul a21~170@ a21~170@) (Mul d21~176@ c21~174@)) (Mul (Mul b21~172@ c21~174@) (Mul d21~176@ c21~174@))))) (and (=> (= tmp%30@ (Mul d21~176@ c21~174@)) (=> (= tmp%31@ (Mul b21~172@ c21~174@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%30@ tmp%31@) (=> %%location_label%%21 (= temp_21_0~3981@ temp_21_1~4042@))))) (=> (= temp_21_0~3981@ temp_21_1~4042@) (=> (= temp_22_0~4151@ (Mul (Mul (Mul (Mul c22~182@ d22~184@) (Mul 0 c22~182@)) (Add d22~184@ (Add b22~180@ c22~182@))) (Mul (Mul (Mul b22~180@ a22~178@) (Mul b22~180@ b22~180@)) (Mul (Mul a22~178@ b22~180@) (Mul a22~178@ b22~180@))))) (=> (= temp_22_1~4224@ (Mul (Mul (Add d22~184@ (Add b22~180@ c22~182@)) (Mul (Mul c22~182@ d22~184@) (Mul 0 c22~182@))) (Mul (Mul (Mul b22~180@ a22~178@) (Mul b22~180@ b22~180@)) (Mul (Mul a22~178@ b22~180@) (Mul a22~178@ b22~180@))))) (=> (= tmp%32@ (Mul (Mul c22~182@ d22~184@) (Mul 0 c22~182@))) (=> (= tmp%33@ (Add d22~184@ (Add b22~180@ c22~182@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%32@ tmp%33@) (=> %%location_label%%22 (= temp_22_0~4151@ temp_22_1~4224@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
