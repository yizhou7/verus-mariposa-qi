...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Sub (Add d0~8@ (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@))) (Mul (Sub (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~394@ (Sub (Mul (Add d0~8@ (Mul d0~8@ c0~6@)) (Mul (Sub (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@)) (Mul (Sub (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~394@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~474@ (Add (Mul (Add (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~539@ (Add (Mul (Add (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~474@ temp_1_1~539@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~619@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))) (Mul (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@)) (Sub (Add a2~18@ b2~20@) (Sub b2~20@ a2~18@))))) (=> (= temp_2_1~684@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))) (Mul (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@)) (Sub (Add a2~18@ b2~20@) (Sub b2~20@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~619@ temp_2_1~684@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~764@ (Mul (Sub (Add (Mul d3~32@ a3~26@) (Add d3~32@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ c3~30@))) (Mul (Add (Mul a3~26@ a3~26@) (Mul c3~30@ b3~28@)) (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~829@ (Mul (Sub (Add (Mul d3~32@ a3~26@) (Add d3~32@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ c3~30@))) (Mul (Add (Mul a3~26@ a3~26@) (Mul b3~28@ c3~30@)) (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~764@ temp_3_1~829@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~905@ (Mul (Mul (Add d4~40@ (Sub c4~38@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ b4~36@))) (Mul (Sub (Add 12 a4~34@) (Mul c4~38@ d4~40@)) b4~36@))) (=> (= temp_4_1~982@ (Mul (Add (Mul d4~40@ (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ b4~36@))) (Mul (Sub c4~38@ a4~34@) (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ b4~36@)))) (Mul (Sub (Add 12 a4~34@) (Mul c4~38@ d4~40@)) b4~36@))) (=> (= tmp%5@ (= temp_4_0~905@ temp_4_1~982@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1062@ (Sub (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ c5~46@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1127@ (Sub (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ c5~46@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1062@ temp_5_1~1127@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1207@ (Mul (Sub (Mul (Mul b6~52@ d6~56@) (Add c6~54@ d6~56@)) (Mul (Mul a6~50@ d6~56@) (Mul 98 a6~50@))) (Mul b6~52@ (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ d6~56@))))) (=> (= temp_6_1~1272@ (Mul (Sub (Mul (Mul b6~52@ d6~56@) (Add c6~54@ d6~56@)) (Mul (Mul 98 a6~50@) (Mul a6~50@ d6~56@))) (Mul b6~52@ (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1207@ temp_6_1~1272@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1372@ (Sub (Mul (Mul (Mul b7~60@ a7~58@) (Add b7~60@ a7~58@)) (Mul (Mul a7~58@ 35) b7~60@)) (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Sub a7~58@ 18) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1457@ (Sub (Mul (Mul (Mul b7~60@ a7~58@) (Add b7~60@ a7~58@)) (Mul (Mul a7~58@ 35) b7~60@)) (Mul (Mul (Add c7~62@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Sub a7~58@ 18) (Mul d7~64@ c7~62@))))) (=> (= tmp%8@ (= temp_7_0~1372@ temp_7_1~1457@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1525@ (Mul (Mul a8~66@ (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ d8~72@) (Add d8~72@ c8~70@)) (Mul (Sub c8~70@ a8~66@) (Mul a8~66@ b8~68@))))) (=> (= temp_8_1~1578@ (Mul (Mul (Mul a8~66@ (Mul a8~66@ b8~68@)) (Mul c8~70@ d8~72@)) (Mul (Mul (Mul d8~72@ d8~72@) (Add d8~72@ c8~70@)) (Mul (Sub c8~70@ a8~66@) (Mul a8~66@ b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1525@ temp_8_1~1578@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1654@ (Mul (Add (Mul (Mul b9~76@ a9~74@) (Sub a9~74@ b9~76@)) (Mul (Mul b9~76@ c9~78@) c9~78@)) (Mul (Add (Mul d9~80@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~1715@ (Mul (Add (Mul b9~76@ (Mul a9~74@ (Sub a9~74@ b9~76@))) (Mul (Mul b9~76@ c9~78@) c9~78@)) (Mul (Add (Mul d9~80@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1654@ temp_9_1~1715@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1787@ (Mul (Mul (Mul c10~86@ (Mul b10~84@ c10~86@)) (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ a10~82@))) (Mul (Sub (Mul b10~84@ d10~88@) a10~82@) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~1844@ (Mul (Mul (Mul c10~86@ (Mul b10~84@ c10~86@)) (Mul (Mul b10~84@ c10~86@) (Mul a10~82@ a10~82@))) (Mul (Sub (Mul b10~84@ d10~88@) a10~82@) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1787@ temp_10_1~1844@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1920@ (Mul (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ c11~94@) c11~94@)) (Mul (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ a11~90@)) (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ a11~90@))))) (=> (= temp_11_1~1981@ (Mul (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ c11~94@) c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul (Mul c11~94@ a11~90@) (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ a11~90@)))))) (=> (= tmp%12@ (= temp_11_0~1920@ temp_11_1~1981@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2085@ (Add (Sub (Mul (Mul c12~102@ d12~104@) (Mul 57 b12~100@)) (Mul (Add d12~104@ a12~98@) (Mul b12~100@ 95))) (Mul (Sub (Mul c12~102@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul b12~100@ c12~102@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2174@ (Add (Sub (Mul (Mul c12~102@ d12~104@) (Mul 57 b12~100@)) (Mul (Mul b12~100@ 95) (Add d12~104@ a12~98@))) (Mul (Sub (Mul c12~102@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul b12~100@ c12~102@) (Mul a12~98@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~2085@ temp_12_1~2174@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2250@ (Mul (Mul (Sub a13~106@ (Mul b13~108@ b13~108@)) (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ b13~108@))) (Mul (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ b13~108@) (Mul a13~106@ a13~106@))))) (=> (= temp_13_1~2311@ (Mul (Sub a13~106@ (Mul b13~108@ b13~108@)) (Mul (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ b13~108@)) (Mul (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ b13~108@) (Mul a13~106@ a13~106@)))))) (=> (= tmp%14@ (= temp_13_0~2250@ temp_13_1~2311@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2391@ (Mul (Mul (Mul (Mul b14~116@ c14~118@) (Mul a14~114@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul d14~120@ d14~120@))) (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ d14~120@)) (Sub (Sub b14~116@ c14~118@) (Add d14~120@ a14~114@))))) (=> (= temp_14_1~2456@ (Mul (Mul (Mul (Mul b14~116@ c14~118@) (Mul a14~114@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul d14~120@ d14~120@))) (Mul (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ b14~116@)) (Sub (Sub b14~116@ c14~118@) (Add d14~120@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2391@ temp_14_1~2456@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2532@ (Sub (Mul (Add (Sub a15~122@ a15~122@) (Mul a15~122@ d15~128@)) (Mul (Add c15~126@ b15~124@) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul b15~124@ b15~124@) d15~128@) (Add (Mul a15~122@ d15~128@) (Mul b15~124@ d15~128@))))) (=> (= temp_15_1~2589@ (Sub (Mul (Add (Sub a15~122@ a15~122@) (Mul a15~122@ d15~128@)) (Mul (Add c15~126@ b15~124@) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul b15~124@ b15~124@) d15~128@) (Mul (Add a15~122@ b15~124@) d15~128@)))) (=> (= tmp%16@ (= temp_15_0~2532@ temp_15_1~2589@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2681@ (Add (Sub (Mul (Mul a16~130@ a16~130@) (Mul 51 b16~132@)) (Sub (Add a16~130@ d16~136@) (Mul a16~130@ a16~130@))) (Mul (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ d16~136@)) (Sub (Mul d16~136@ b16~132@) (Mul b16~132@ b16~132@))))) (=> (= temp_16_1~2758@ (Add (Sub (Mul (Mul a16~130@ a16~130@) (Mul 51 b16~132@)) (Sub (Add a16~130@ d16~136@) (Mul a16~130@ a16~130@))) (Mul (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ d16~136@)) (Sub (Mul b16~132@ d16~136@) (Mul b16~132@ b16~132@))))) (=> (= tmp%17@ (= temp_16_0~2681@ temp_16_1~2758@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2838@ (Mul (Add (Mul (Mul c17~142@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ a17~138@))) (Sub (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@)) (Mul (Mul c17~142@ a17~138@) (Mul b17~140@ c17~142@))))) (=> (= temp_17_1~2903@ (Mul (Add (Mul (Mul c17~142@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ a17~138@))) (Sub (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ c17~142@)) (Mul (Mul c17~142@ a17~138@) (Mul b17~140@ c17~142@))))) (=> (= tmp%18@ (= temp_17_0~2838@ temp_17_1~2903@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2983@ (Mul (Add (Add (Add c18~150@ a18~146@) (Mul c18~150@ d18~152@)) (Mul (Mul d18~152@ d18~152@) (Mul c18~150@ b18~148@))) (Mul (Mul (Mul b18~148@ c18~150@) (Mul b18~148@ b18~148@)) (Mul (Mul d18~152@ a18~146@) (Mul a18~146@ b18~148@))))) (=> (= temp_18_1~3048@ (Mul (Add (Add (Add c18~150@ a18~146@) (Mul c18~150@ d18~152@)) (Mul (Mul (Mul d18~152@ d18~152@) c18~150@) b18~148@)) (Mul (Mul (Mul b18~148@ c18~150@) (Mul b18~148@ b18~148@)) (Mul (Mul d18~152@ a18~146@) (Mul a18~146@ b18~148@))))) (=> (= tmp%19@ (= temp_18_0~2983@ temp_18_1~3048@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3124@ (Mul (Mul (Mul (Sub b19~156@ b19~156@) (Mul a19~154@ c19~158@)) (Mul (Mul a19~154@ b19~156@) (Mul b19~156@ a19~154@))) (Mul (Mul (Mul a19~154@ c19~158@) a19~154@) (Sub (Add d19~160@ d19~160@) (Add a19~154@ b19~156@))))) (=> (= temp_19_1~3185@ (Mul (Mul (Mul (Sub b19~156@ b19~156@) (Mul a19~154@ c19~158@)) (Mul (Mul a19~154@ b19~156@) (Mul b19~156@ a19~154@))) (Mul (Mul a19~154@ (Mul a19~154@ c19~158@)) (Sub (Add d19~160@ d19~160@) (Add a19~154@ b19~156@))))) (=> (= tmp%20@ (= temp_19_0~3124@ temp_19_1~3185@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3277@ (Mul (Mul (Mul (Mul d20~168@ b20~164@) (Add d20~168@ b20~164@)) (Mul (Mul b20~164@ d20~168@) (Mul c20~166@ c20~166@))) (Mul (Mul (Add d20~168@ d20~168@) (Mul 14 d20~168@)) (Mul (Mul d20~168@ a20~162@) (Mul c20~166@ b20~164@))))) (=> (= temp_20_1~3354@ (Mul (Mul (Mul (Mul d20~168@ b20~164@) (Add d20~168@ b20~164@)) (Mul (Mul b20~164@ d20~168@) (Mul c20~166@ c20~166@))) (Mul (Mul (Add d20~168@ d20~168@) (Mul d20~168@ 14)) (Mul (Mul d20~168@ a20~162@) (Mul c20~166@ b20~164@))))) (=> (= tmp%21@ (= temp_20_0~3277@ temp_20_1~3354@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3430@ (Add (Mul (Mul (Mul b21~172@ a21~170@) (Mul d21~176@ b21~172@)) (Mul c21~174@ (Mul a21~170@ c21~174@))) (Mul (Mul (Mul b21~172@ d21~176@) (Sub b21~172@ b21~172@)) (Mul (Mul d21~176@ a21~170@) (Mul d21~176@ c21~174@))))) (=> (= temp_21_1~3499@ (Add (Mul (Mul (Mul b21~172@ a21~170@) (Mul d21~176@ b21~172@)) (Mul c21~174@ (Mul a21~170@ c21~174@))) (Mul (Sub (Mul (Mul b21~172@ d21~176@) b21~172@) (Mul (Mul b21~172@ d21~176@) b21~172@)) (Mul (Mul d21~176@ a21~170@) (Mul d21~176@ c21~174@))))) (=> (= tmp%22@ (= temp_21_0~3430@ temp_21_1~3499@)) (=> %%location_label%%21 tmp%22@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
