...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ b0~4@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ c0~6@) (Sub d0~8@ b0~4@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~479@ (Mul (Mul (Mul c1~14@ (Sub b1~12@ c1~14@)) (Add (Sub c1~14@ b1~12@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ 50) (Mul 86 c1~14@))))) (=> (= temp_1_1~564@ (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ 50) (Mul 86 c1~14@))) (Mul (Mul c1~14@ (Sub b1~12@ c1~14@)) (Add (Sub c1~14@ b1~12@) (Mul d1~16@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~479@ temp_1_1~564@))) (=> (= temp_1_0~479@ temp_1_1~564@) (=> (= temp_2_0~649@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ a2~18@)) (Sub (Sub b2~20@ b2~20@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@)) (Mul c2~22@ (Mul a2~18@ a2~18@))))) (=> (= temp_2_1~710@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ a2~18@)) (Sub (Sub b2~20@ b2~20@) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@)) (Mul c2~22@ (Mul a2~18@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~649@ temp_2_1~710@))) (=> (= temp_2_0~649@ temp_2_1~710@) (=> (= temp_3_0~799@ (Add (Mul (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@)) (Sub (Mul c3~30@ b3~28@) (Sub d3~32@ d3~32@))) (Sub (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Sub c3~30@ d3~32@))))) (=> (= temp_3_1~864@ (Add (Mul (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@)) (Sub (Mul c3~30@ b3~28@) (Sub d3~32@ d3~32@))) (Sub (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Sub c3~30@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~799@ temp_3_1~864@))) (=> (= temp_3_0~799@ temp_3_1~864@) (=> (= temp_4_0~949@ (Mul (Mul (Sub (Add a4~34@ c4~38@) (Mul c4~38@ d4~40@)) (Mul b4~36@ (Mul a4~34@ b4~36@))) (Mul (Mul (Mul d4~40@ d4~40@) (Sub a4~34@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~1010@ (Mul (Mul (Mul b4~36@ (Mul a4~34@ b4~36@)) (Sub (Add a4~34@ c4~38@) (Mul c4~38@ d4~40@))) (Mul (Mul (Mul d4~40@ d4~40@) (Sub a4~34@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~949@ temp_4_1~1010@))) (=> (= temp_4_0~949@ temp_4_1~1010@) (=> (= temp_5_0~1071@ (Add a5~42@ (Mul (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Add d5~48@ a5~42@))))) (=> (= temp_5_1~1108@ (Add a5~42@ (Mul (Mul c5~46@ (Mul d5~48@ (Mul a5~42@ a5~42@))) (Mul (Mul c5~46@ d5~48@) (Add d5~48@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1071@ temp_5_1~1108@))) (=> (= temp_5_0~1071@ temp_5_1~1108@) (=> (= temp_6_0~1193@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ b6~52@)) (Mul (Add b6~52@ c6~54@) c6~54@)) (Mul (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1254@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ b6~52@)) (Mul (Add b6~52@ c6~54@) c6~54@)) (Mul (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1193@ temp_6_1~1254@))) (=> (= temp_6_0~1193@ temp_6_1~1254@) (=> (= temp_7_0~1367@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Add d7~64@ b7~60@)) (Add (Mul a7~58@ 69) (Add b7~60@ 9))) (Add (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1456@ (Mul (Mul (Add (Mul a7~58@ 69) (Add b7~60@ 9)) (Mul (Mul c7~62@ d7~64@) (Add d7~64@ b7~60@))) (Add (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1367@ temp_7_1~1456@))) (=> (= temp_7_0~1367@ temp_7_1~1456@) (=> (= temp_8_0~1545@ (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@))) (Sub (Mul (Mul a8~66@ d8~72@) (Add b8~68@ d8~72@)) (Mul (Mul c8~70@ a8~66@) (Add c8~70@ a8~66@))))) (=> (= temp_8_1~1610@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@))) (Sub (Mul (Mul a8~66@ d8~72@) (Add b8~68@ d8~72@)) (Mul (Mul c8~70@ a8~66@) (Add c8~70@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1545@ temp_8_1~1610@))) (=> (= temp_8_0~1545@ temp_8_1~1610@) (=> (= temp_9_0~1699@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Sub c9~78@ d9~80@)) (Mul (Mul c9~78@ a9~74@) (Mul d9~80@ b9~76@))) (Sub (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ 74)) c9~78@))) (=> (= temp_9_1~1764@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Sub c9~78@ d9~80@)) (Mul (Mul c9~78@ a9~74@) (Mul d9~80@ b9~76@))) (Sub (Mul (Mul b9~76@ b9~76@) (Mul 74 d9~80@)) c9~78@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1699@ temp_9_1~1764@))) (=> (= temp_9_0~1699@ temp_9_1~1764@) (=> (= temp_10_0~1853@ (Mul (Add (Mul (Mul a10~82@ d10~88@) (Sub d10~88@ a10~82@)) (Mul (Mul b10~84@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@))))) (=> (= temp_10_1~1918@ (Mul (Add (Mul (Mul a10~82@ d10~88@) (Sub d10~88@ a10~82@)) (Mul (Mul b10~84@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1853@ temp_10_1~1918@))) (=> (= temp_10_0~1853@ temp_10_1~1918@) (=> (= temp_11_0~2007@ (Add (Mul (Mul (Sub a11~90@ a11~90@) (Add c11~94@ a11~90@)) (Mul (Mul a11~90@ c11~94@) (Sub c11~94@ d11~96@))) (Mul (Add (Mul d11~96@ b11~92@) (Mul c11~94@ b11~92@)) (Sub (Mul c11~94@ b11~92@) (Mul c11~94@ d11~96@))))) (=> (= temp_11_1~2068@ (Add (Mul (Mul (Sub a11~90@ a11~90@) (Add c11~94@ a11~90@)) (Mul (Mul a11~90@ c11~94@) (Sub c11~94@ d11~96@))) (Mul (Add (Mul d11~96@ b11~92@) (Mul c11~94@ b11~92@)) (Mul c11~94@ (Sub b11~92@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2007@ temp_11_1~2068@))) (=> (= temp_11_0~2007@ temp_11_1~2068@) (=> (= temp_12_0~2157@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ c12~102@))) (Mul (Add (Mul b12~100@ c12~102@) (Mul a12~98@ c12~102@)) (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2222@ (Mul (Mul (Mul b12~100@ a12~98@) (Mul (Mul d12~104@ b12~100@) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ c12~102@)))) (Mul (Add (Mul b12~100@ c12~102@) (Mul a12~98@ c12~102@)) (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2157@ temp_12_1~2222@))) (=> (= temp_12_0~2157@ temp_12_1~2222@) (=> (= temp_13_0~2307@ (Add (Sub (Mul (Mul a13~106@ c13~110@) (Mul d13~112@ c13~110@)) (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul d13~112@ b13~108@) c13~110@) (Mul (Mul a13~106@ a13~106@) (Mul c13~110@ b13~108@))))) (=> (= temp_13_1~2368@ (Add (Sub (Mul (Mul a13~106@ c13~110@) (Mul d13~112@ c13~110@)) (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul d13~112@ b13~108@) c13~110@) (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2307@ temp_13_1~2368@))) (=> (= temp_13_0~2307@ temp_13_1~2368@) (=> (= temp_14_0~2453@ (Mul (Mul (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ b14~116@)) (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ b14~116@))) (Mul (Mul (Mul c14~118@ d14~120@) a14~114@) (Mul (Mul a14~114@ d14~120@) (Sub a14~114@ c14~118@))))) (=> (= temp_14_1~2514@ (Mul (Mul (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ b14~116@)) (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ b14~116@))) (Mul (Mul a14~114@ (Mul c14~118@ d14~120@)) (Mul (Mul a14~114@ d14~120@) (Sub a14~114@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2453@ temp_14_1~2514@))) (=> (= temp_14_0~2453@ temp_14_1~2514@) (=> (= temp_15_0~2615@ (Mul (Mul (Add (Mul c15~126@ a15~122@) (Add c15~126@ b15~124@)) (Add (Mul c15~126@ c15~126@) (Mul b15~124@ a15~122@))) (Mul (Add (Mul d15~128@ 24) (Mul c15~126@ a15~122@)) (Mul (Mul c15~126@ b15~124@) (Mul a15~122@ a15~122@))))) (=> (= temp_15_1~2692@ (Mul (Mul (Add (Mul c15~126@ a15~122@) (Add c15~126@ b15~124@)) (Add (Mul c15~126@ c15~126@) (Mul b15~124@ a15~122@))) (Mul (Mul (Mul c15~126@ b15~124@) (Mul a15~122@ a15~122@)) (Add (Mul d15~128@ 24) (Mul c15~126@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2615@ temp_15_1~2692@))) (=> (= temp_15_0~2615@ temp_15_1~2692@) (=> (= temp_16_0~2805@ (Mul (Mul (Mul (Add 97 c16~134@) (Mul a16~130@ a16~130@)) (Add (Sub a16~130@ a16~130@) (Mul c16~134@ c16~134@))) (Mul (Add (Mul c16~134@ 29) (Mul c16~134@ c16~134@)) (Sub (Add d16~136@ b16~132@) (Mul b16~132@ d16~136@))))) (=> (= temp_16_1~2894@ (Mul (Mul (Mul (Add 97 c16~134@) (Mul a16~130@ a16~130@)) (Add (Sub a16~130@ a16~130@) (Mul c16~134@ c16~134@))) (Mul (Add (Mul c16~134@ 29) (Mul c16~134@ c16~134@)) (Sub (Add d16~136@ b16~132@) (Mul b16~132@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2805@ temp_16_1~2894@))) (=> (= temp_16_0~2805@ temp_16_1~2894@) (=> (= temp_17_0~2983@ (Mul (Mul (Mul (Mul b17~140@ d17~144@) (Mul a17~138@ a17~138@)) (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ c17~142@))) (Mul (Mul (Mul a17~138@ c17~142@) (Add a17~138@ b17~140@)) (Add (Mul c17~142@ a17~138@) (Mul b17~140@ c17~142@))))) (=> (= temp_17_1~3048@ (Mul (Mul (Mul (Mul b17~140@ d17~144@) (Mul a17~138@ a17~138@)) (Mul a17~138@ (Mul a17~138@ (Mul a17~138@ c17~142@)))) (Mul (Mul (Mul a17~138@ c17~142@) (Add a17~138@ b17~140@)) (Add (Mul c17~142@ a17~138@) (Mul b17~140@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2983@ temp_17_1~3048@))) (=> (= temp_17_0~2983@ temp_17_1~3048@) (=> (= temp_18_0~3133@ (Mul (Mul (Mul (Sub a18~146@ d18~152@) (Mul a18~146@ d18~152@)) (Mul (Mul d18~152@ b18~148@) (Mul a18~146@ a18~146@))) (Mul (Mul (Mul a18~146@ a18~146@) c18~150@) (Mul (Mul c18~150@ d18~152@) (Mul b18~148@ d18~152@))))) (=> (= temp_18_1~3194@ (Mul (Mul (Mul (Sub a18~146@ d18~152@) (Mul a18~146@ d18~152@)) (Mul (Mul d18~152@ b18~148@) (Mul a18~146@ a18~146@))) (Mul (Mul (Mul a18~146@ a18~146@) c18~150@) (Mul (Mul c18~150@ d18~152@) (Mul b18~148@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3133@ temp_18_1~3194@))) (=> (= temp_18_0~3133@ temp_18_1~3194@) (=> (= temp_19_0~3255@ (Add c19~158@ (Mul (Mul (Mul c19~158@ c19~158@) (Add a19~154@ b19~156@)) (Mul (Mul b19~156@ c19~158@) (Mul b19~156@ d19~160@))))) (=> (= temp_19_1~3292@ (Add c19~158@ (Mul (Mul (Mul c19~158@ c19~158@) (Add a19~154@ b19~156@)) (Mul (Mul c19~158@ b19~156@) (Mul b19~156@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3255@ temp_19_1~3292@))) (=> (= temp_19_0~3255@ temp_19_1~3292@) (=> (= temp_20_0~3357@ (Mul (Mul b20~164@ b20~164@) (Mul (Mul (Mul b20~164@ c20~166@) (Mul b20~164@ d20~168@)) (Mul (Sub c20~166@ c20~166@) (Mul c20~166@ d20~168@))))) (=> (= temp_20_1~3398@ (Mul (Mul b20~164@ b20~164@) (Mul (Mul (Mul b20~164@ c20~166@) (Mul b20~164@ d20~168@)) (Mul (Mul c20~166@ d20~168@) (Sub c20~166@ c20~166@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3357@ temp_20_1~3398@))) (=> (= temp_20_0~3357@ temp_20_1~3398@) (=> (= temp_21_0~3499@ (Mul (Mul (Sub (Mul d21~176@ a21~170@) (Mul d21~176@ b21~172@)) (Mul (Mul b21~172@ c21~174@) (Mul d21~176@ a21~170@))) (Add (Mul (Mul c21~174@ c21~174@) (Mul b21~172@ d21~176@)) (Mul (Mul a21~170@ 5) (Mul a21~170@ d21~176@))))) (=> (= temp_21_1~3576@ (Mul (Mul (Sub (Mul d21~176@ a21~170@) (Mul d21~176@ b21~172@)) (Mul (Mul b21~172@ c21~174@) (Mul d21~176@ a21~170@))) (Add (Mul (Mul b21~172@ d21~176@) (Mul c21~174@ c21~174@)) (Mul (Mul a21~170@ 5) (Mul a21~170@ d21~176@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3499@ temp_21_1~3576@))) (=> (= temp_21_0~3499@ temp_21_1~3576@) (=> (= temp_22_0~3677@ (Mul (Add (Mul (Mul 24 c22~182@) (Mul a22~178@ b22~180@)) (Mul (Mul c22~182@ d22~184@) (Mul c22~182@ c22~182@))) (Add (Sub (Mul a22~178@ c22~182@) (Mul c22~182@ d22~184@)) (Mul (Sub b22~180@ b22~180@) (Mul a22~178@ b22~180@))))) (=> (= temp_22_1~3762@ (Mul (Add (Mul (Mul 24 c22~182@) (Mul a22~178@ b22~180@)) (Mul (Mul c22~182@ d22~184@) (Mul c22~182@ c22~182@))) (Add (Sub (Mul a22~178@ c22~182@) (Mul c22~182@ d22~184@)) (Sub (Mul b22~180@ (Mul a22~178@ b22~180@)) (Mul b22~180@ (Mul a22~178@ b22~180@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3677@ temp_22_1~3762@))) (=> (= temp_22_0~3677@ temp_22_1~3762@) (=> (= temp_23_0~3847@ (Mul (Mul (Mul (Mul d23~192@ c23~190@) (Mul c23~190@ b23~188@)) (Mul b23~188@ (Mul b23~188@ c23~190@))) (Mul (Mul (Mul c23~190@ c23~190@) (Mul c23~190@ b23~188@)) (Sub (Sub d23~192@ d23~192@) (Sub a23~186@ b23~188@))))) (=> (= temp_23_1~3908@ (Mul (Mul (Mul (Mul d23~192@ c23~190@) (Mul c23~190@ b23~188@)) (Mul b23~188@ (Mul b23~188@ c23~190@))) (Mul (Mul c23~190@ c23~190@) (Mul (Mul c23~190@ b23~188@) (Sub (Sub d23~192@ d23~192@) (Sub a23~186@ b23~188@)))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3847@ temp_23_1~3908@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
