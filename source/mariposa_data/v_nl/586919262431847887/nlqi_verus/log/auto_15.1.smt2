...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul (Mul (Add d0~8@ a0~2@) d0~8@) d0~8@) (Mul (Mul (Add b0~4@ a0~2@) (Sub d0~8@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~338@ (Mul (Mul d0~8@ (Mul (Add d0~8@ a0~2@) d0~8@)) (Mul (Mul (Add b0~4@ a0~2@) (Sub d0~8@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~338@))) (=> (= temp_0_0~289@ temp_0_1~338@) (=> (= temp_1_0~427@ (Mul (Sub (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ d1~16@))) (Mul (Add (Mul b1~12@ a1~10@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Add a1~10@ c1~14@))))) (=> (= temp_1_1~492@ (Mul (Sub (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (Mul (Add (Mul b1~12@ a1~10@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Add a1~10@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~427@ temp_1_1~492@))) (=> (= temp_1_0~427@ temp_1_1~492@) (=> (= temp_2_0~557@ (Add (Mul d2~24@ (Mul (Mul c2~22@ a2~18@) (Add d2~24@ a2~18@))) (Mul d2~24@ (Mul (Sub d2~24@ c2~22@) (Mul d2~24@ c2~22@))))) (=> (= temp_2_1~598@ (Add (Mul d2~24@ (Mul (Mul c2~22@ a2~18@) (Add d2~24@ a2~18@))) (Mul (Mul d2~24@ (Sub d2~24@ c2~22@)) (Mul d2~24@ c2~22@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~557@ temp_2_1~598@))) (=> (= temp_2_0~557@ temp_2_1~598@) (=> (= temp_3_0~699@ (Mul (Mul (Mul (Add d3~32@ d3~32@) (Mul b3~28@ b3~28@)) (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ d3~32@))) (Mul (Mul (Sub c3~30@ a3~26@) (Mul a3~26@ a3~26@)) (Sub (Mul a3~26@ a3~26@) (Mul d3~32@ 63))))) (=> (= temp_3_1~776@ (Mul (Mul (Mul (Add d3~32@ d3~32@) (Mul b3~28@ b3~28@)) (Mul c3~30@ (Mul c3~30@ (Mul c3~30@ d3~32@)))) (Mul (Mul (Sub c3~30@ a3~26@) (Mul a3~26@ a3~26@)) (Sub (Mul a3~26@ a3~26@) (Mul d3~32@ 63))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~699@ temp_3_1~776@))) (=> (= temp_3_0~699@ temp_3_1~776@) (=> (= temp_4_0~861@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Sub b4~36@ d4~40@))) (Mul (Add a4~34@ (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~922@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Sub b4~36@ d4~40@))) (Mul (Add a4~34@ (Mul a4~34@ c4~38@)) (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~861@ temp_4_1~922@))) (=> (= temp_4_0~861@ temp_4_1~922@) (=> (= temp_5_0~983@ (Mul b5~44@ (Add (Sub (Mul d5~48@ b5~44@) (Mul d5~48@ a5~42@)) (Add (Mul b5~44@ c5~46@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1020@ (Mul b5~44@ (Add (Sub (Mul d5~48@ b5~44@) (Mul d5~48@ a5~42@)) (Add (Mul b5~44@ c5~46@) (Mul b5~44@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~983@ temp_5_1~1020@))) (=> (= temp_5_0~983@ temp_5_1~1020@) (=> (= temp_6_0~1121@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Add b6~52@ a6~50@)) a6~50@) (Mul (Mul (Mul b6~52@ 91) (Mul b6~52@ 30)) (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1198@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Add b6~52@ a6~50@)) a6~50@) (Mul (Mul (Mul b6~52@ 30) (Mul b6~52@ 91)) (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1121@ temp_6_1~1198@))) (=> (= temp_6_0~1121@ temp_6_1~1198@) (=> (= temp_7_0~1299@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ 85) (Mul c7~62@ c7~62@))) (Mul (Sub (Add c7~62@ a7~58@) (Mul d7~64@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1376@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ 85) (Mul c7~62@ c7~62@))) (Mul (Mul (Sub (Add c7~62@ a7~58@) (Mul d7~64@ d7~64@)) (Mul b7~60@ b7~60@)) (Mul a7~58@ a7~58@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1299@ temp_7_1~1376@))) (=> (= temp_7_0~1299@ temp_7_1~1376@) (=> (= temp_8_0~1457@ (Add (Mul (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ b8~68@)) 15) (Mul (Mul c8~70@ (Mul d8~72@ d8~72@)) (Mul (Add c8~70@ d8~72@) c8~70@)))) (=> (= temp_8_1~1514@ (Add (Mul (Mul (Mul (Mul a8~66@ b8~68@) d8~72@) b8~68@) 15) (Mul (Mul c8~70@ (Mul d8~72@ d8~72@)) (Mul (Add c8~70@ d8~72@) c8~70@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1457@ temp_8_1~1514@))) (=> (= temp_8_0~1457@ temp_8_1~1514@) (=> (= temp_9_0~1603@ (Mul (Mul (Sub (Sub b9~76@ b9~76@) (Mul b9~76@ b9~76@)) (Mul (Mul c9~78@ d9~80@) (Sub b9~76@ a9~74@))) (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~1684@ (Mul (Sub (Mul (Sub b9~76@ b9~76@) (Mul (Mul c9~78@ d9~80@) (Sub b9~76@ a9~74@))) (Mul (Mul b9~76@ b9~76@) (Mul (Mul c9~78@ d9~80@) (Sub b9~76@ a9~74@)))) (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Mul a9~74@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1603@ temp_9_1~1684@))) (=> (= temp_9_0~1603@ temp_9_1~1684@) (=> (= temp_10_0~1773@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)) (Sub (Mul c10~86@ d10~88@) (Mul c10~86@ a10~82@))) (Add (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@)) (Mul (Mul b10~84@ d10~88@) (Mul a10~82@ b10~84@))))) (=> (= temp_10_1~1838@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)) (Sub (Mul c10~86@ d10~88@) (Mul c10~86@ a10~82@))) (Add (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@)) (Mul (Mul (Mul b10~84@ d10~88@) a10~82@) b10~84@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1773@ temp_10_1~1838@))) (=> (= temp_10_0~1773@ temp_10_1~1838@) (=> (= temp_11_0~1951@ (Mul (Mul (Add (Mul c11~94@ d11~96@) (Mul c11~94@ 1)) (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul a11~90@ 54) (Mul b11~92@ b11~92@)) (Mul (Add b11~92@ b11~92@) (Sub b11~92@ a11~90@))))) (=> (= temp_11_1~2040@ (Mul (Mul (Add (Mul c11~94@ d11~96@) (Mul c11~94@ 1)) (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ 54)) (Mul (Add b11~92@ b11~92@) (Sub b11~92@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1951@ temp_11_1~2040@))) (=> (= temp_11_0~1951@ temp_11_1~2040@) (=> (= temp_12_0~2129@ (Mul (Sub (Mul (Mul d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Sub b12~100@ c12~102@) (Mul c12~102@ b12~100@))) (Sub (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ d12~104@)) (Sub (Mul b12~100@ a12~98@) (Mul b12~100@ d12~104@))))) (=> (= temp_12_1~2194@ (Mul (Sub (Mul (Mul d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Sub b12~100@ c12~102@) (Mul c12~102@ b12~100@))) (Sub (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ d12~104@)) (Sub (Mul b12~100@ a12~98@) (Mul b12~100@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2129@ temp_12_1~2194@))) (=> (= temp_12_0~2129@ temp_12_1~2194@) (=> (= temp_13_0~2279@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@)) (Add (Add d13~112@ b13~108@) (Mul b13~108@ d13~112@))) (Mul (Sub b13~108@ (Mul b13~108@ c13~110@)) (Add (Mul c13~110@ d13~112@) (Sub c13~110@ a13~106@))))) (=> (= temp_13_1~2340@ (Mul (Mul (Mul a13~106@ c13~110@) (Mul (Mul c13~110@ a13~106@) (Add (Add d13~112@ b13~108@) (Mul b13~108@ d13~112@)))) (Mul (Sub b13~108@ (Mul b13~108@ c13~110@)) (Add (Mul c13~110@ d13~112@) (Sub c13~110@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2279@ temp_13_1~2340@))) (=> (= temp_13_0~2279@ temp_13_1~2340@) (=> (= temp_14_0~2421@ (Sub (Mul (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ b14~116@)) (Sub (Mul a14~114@ b14~116@) b14~116@)) (Mul (Mul (Mul c14~118@ a14~114@) (Mul c14~118@ a14~114@)) (Mul c14~118@ (Add a14~114@ a14~114@))))) (=> (= temp_14_1~2478@ (Sub (Mul (Mul c14~118@ (Mul c14~118@ (Mul b14~116@ b14~116@))) (Sub (Mul a14~114@ b14~116@) b14~116@)) (Mul (Mul (Mul c14~118@ a14~114@) (Mul c14~118@ a14~114@)) (Mul c14~118@ (Add a14~114@ a14~114@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2421@ temp_14_1~2478@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
