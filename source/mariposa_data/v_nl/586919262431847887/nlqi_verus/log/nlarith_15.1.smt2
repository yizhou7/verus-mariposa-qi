...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul (Mul (Add d0~8@ a0~2@) d0~8@) d0~8@) (Mul (Mul (Add b0~4@ a0~2@) (Sub d0~8@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~338@ (Mul (Mul d0~8@ (Mul (Add d0~8@ a0~2@) d0~8@)) (Mul (Mul (Add b0~4@ a0~2@) (Sub d0~8@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~289@ temp_0_1~338@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~418@ (Mul (Sub (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ d1~16@))) (Mul (Add (Mul b1~12@ a1~10@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Add a1~10@ c1~14@))))) (=> (= temp_1_1~483@ (Mul (Sub (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (Mul (Add (Mul b1~12@ a1~10@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Add a1~10@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~418@ temp_1_1~483@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~539@ (Add (Mul d2~24@ (Mul (Mul c2~22@ a2~18@) (Add d2~24@ a2~18@))) (Mul d2~24@ (Mul (Sub d2~24@ c2~22@) (Mul d2~24@ c2~22@))))) (=> (= temp_2_1~580@ (Add (Mul d2~24@ (Mul (Mul c2~22@ a2~18@) (Add d2~24@ a2~18@))) (Mul (Mul d2~24@ (Sub d2~24@ c2~22@)) (Mul d2~24@ c2~22@)))) (=> (= tmp%3@ (= temp_2_0~539@ temp_2_1~580@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~672@ (Mul (Mul (Mul (Add d3~32@ d3~32@) (Mul b3~28@ b3~28@)) (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ d3~32@))) (Mul (Mul (Sub c3~30@ a3~26@) (Mul a3~26@ a3~26@)) (Sub (Mul a3~26@ a3~26@) (Mul d3~32@ 63))))) (=> (= temp_3_1~749@ (Mul (Mul (Mul (Add d3~32@ d3~32@) (Mul b3~28@ b3~28@)) (Mul c3~30@ (Mul c3~30@ (Mul c3~30@ d3~32@)))) (Mul (Mul (Sub c3~30@ a3~26@) (Mul a3~26@ a3~26@)) (Sub (Mul a3~26@ a3~26@) (Mul d3~32@ 63))))) (=> (= tmp%4@ (= temp_3_0~672@ temp_3_1~749@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~825@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Sub b4~36@ d4~40@))) (Mul (Add a4~34@ (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~886@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Sub b4~36@ d4~40@))) (Mul (Add a4~34@ (Mul a4~34@ c4~38@)) (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~825@ temp_4_1~886@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~938@ (Mul b5~44@ (Add (Sub (Mul d5~48@ b5~44@) (Mul d5~48@ a5~42@)) (Add (Mul b5~44@ c5~46@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~975@ (Mul b5~44@ (Add (Sub (Mul d5~48@ b5~44@) (Mul d5~48@ a5~42@)) (Add (Mul b5~44@ c5~46@) (Mul b5~44@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~938@ temp_5_1~975@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1067@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Add b6~52@ a6~50@)) a6~50@) (Mul (Mul (Mul b6~52@ 91) (Mul b6~52@ 30)) (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1144@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Add b6~52@ a6~50@)) a6~50@) (Mul (Mul (Mul b6~52@ 30) (Mul b6~52@ 91)) (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1067@ temp_6_1~1144@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1236@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ 85) (Mul c7~62@ c7~62@))) (Mul (Sub (Add c7~62@ a7~58@) (Mul d7~64@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1313@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ 85) (Mul c7~62@ c7~62@))) (Mul (Mul (Sub (Add c7~62@ a7~58@) (Mul d7~64@ d7~64@)) (Mul b7~60@ b7~60@)) (Mul a7~58@ a7~58@)))) (=> (= tmp%8@ (= temp_7_0~1236@ temp_7_1~1313@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1385@ (Add (Mul (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ b8~68@)) 15) (Mul (Mul c8~70@ (Mul d8~72@ d8~72@)) (Mul (Add c8~70@ d8~72@) c8~70@)))) (=> (= temp_8_1~1442@ (Add (Mul (Mul (Mul (Mul a8~66@ b8~68@) d8~72@) b8~68@) 15) (Mul (Mul c8~70@ (Mul d8~72@ d8~72@)) (Mul (Add c8~70@ d8~72@) c8~70@)))) (=> (= tmp%9@ (= temp_8_0~1385@ temp_8_1~1442@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1522@ (Mul (Mul (Sub (Sub b9~76@ b9~76@) (Mul b9~76@ b9~76@)) (Mul (Mul c9~78@ d9~80@) (Sub b9~76@ a9~74@))) (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~1603@ (Mul (Sub (Mul (Sub b9~76@ b9~76@) (Mul (Mul c9~78@ d9~80@) (Sub b9~76@ a9~74@))) (Mul (Mul b9~76@ b9~76@) (Mul (Mul c9~78@ d9~80@) (Sub b9~76@ a9~74@)))) (Mul (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Mul a9~74@ b9~76@))))) (=> (= tmp%10@ (= temp_9_0~1522@ temp_9_1~1603@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1683@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)) (Sub (Mul c10~86@ d10~88@) (Mul c10~86@ a10~82@))) (Add (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@)) (Mul (Mul b10~84@ d10~88@) (Mul a10~82@ b10~84@))))) (=> (= temp_10_1~1748@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)) (Sub (Mul c10~86@ d10~88@) (Mul c10~86@ a10~82@))) (Add (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@)) (Mul (Mul (Mul b10~84@ d10~88@) a10~82@) b10~84@)))) (=> (= tmp%11@ (= temp_10_0~1683@ temp_10_1~1748@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1852@ (Mul (Mul (Add (Mul c11~94@ d11~96@) (Mul c11~94@ 1)) (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul a11~90@ 54) (Mul b11~92@ b11~92@)) (Mul (Add b11~92@ b11~92@) (Sub b11~92@ a11~90@))))) (=> (= temp_11_1~1941@ (Mul (Mul (Add (Mul c11~94@ d11~96@) (Mul c11~94@ 1)) (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ 54)) (Mul (Add b11~92@ b11~92@) (Sub b11~92@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1852@ temp_11_1~1941@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2021@ (Mul (Sub (Mul (Mul d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Sub b12~100@ c12~102@) (Mul c12~102@ b12~100@))) (Sub (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ d12~104@)) (Sub (Mul b12~100@ a12~98@) (Mul b12~100@ d12~104@))))) (=> (= temp_12_1~2086@ (Mul (Sub (Mul (Mul d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Sub b12~100@ c12~102@) (Mul c12~102@ b12~100@))) (Sub (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ d12~104@)) (Sub (Mul b12~100@ a12~98@) (Mul b12~100@ d12~104@))))) (=> (= tmp%13@ (= temp_12_0~2021@ temp_12_1~2086@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2162@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@)) (Add (Add d13~112@ b13~108@) (Mul b13~108@ d13~112@))) (Mul (Sub b13~108@ (Mul b13~108@ c13~110@)) (Add (Mul c13~110@ d13~112@) (Sub c13~110@ a13~106@))))) (=> (= temp_13_1~2223@ (Mul (Mul (Mul a13~106@ c13~110@) (Mul (Mul c13~110@ a13~106@) (Add (Add d13~112@ b13~108@) (Mul b13~108@ d13~112@)))) (Mul (Sub b13~108@ (Mul b13~108@ c13~110@)) (Add (Mul c13~110@ d13~112@) (Sub c13~110@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2162@ temp_13_1~2223@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2295@ (Sub (Mul (Mul (Mul c14~118@ c14~118@) (Mul b14~116@ b14~116@)) (Sub (Mul a14~114@ b14~116@) b14~116@)) (Mul (Mul (Mul c14~118@ a14~114@) (Mul c14~118@ a14~114@)) (Mul c14~118@ (Add a14~114@ a14~114@))))) (=> (= temp_14_1~2352@ (Sub (Mul (Mul c14~118@ (Mul c14~118@ (Mul b14~116@ b14~116@))) (Sub (Mul a14~114@ b14~116@) b14~116@)) (Mul (Mul (Mul c14~118@ a14~114@) (Mul c14~118@ a14~114@)) (Mul c14~118@ (Add a14~114@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2295@ temp_14_1~2352@)) (=> %%location_label%%14 tmp%15@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
