     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~301@ temp_0_1~362@)
        (=>
         (= temp_1_0~463@ (Mul (Mul (Sub (Mul b1~12@ a1~10@) (Sub d1~16@ d1~16@)) (Mul (Mul c1~14@
              b1~12@
             ) (Mul b1~12@ a1~10@)
            )
         ...
         (=>
          (= temp_1_1~540@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ a1~10@)) (Sub (Mul b1~12@
               a1~10@
              ) (Sub d1~16@ d1~16@)
             )
            ) (Mul (Mul (Mul c1~14@ b1~12@) (Mul 61 d1~16@)) (Sub (Mul a1~10@ c1~14@) (Add c1~14@
          ...
          (and
           ...
           (=>
            (= temp_1_0~463@ temp_1_1~540@)
            (=>
             (= temp_2_0~637@ (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@
                  c2~22@
                 ) b2~20@
                )
             ...
             (=>
              (= temp_2_1~710@ (Mul (Sub (Mul (Sub 83 c2~22@) (Mul a2~18@ c2~22@)) (Mul (Mul d2~24@
                   a2~18@
                  ) (Mul a2~18@ d2~24@)
                 )
              ...
              (and
               ...
               (=>
                (= temp_2_0~637@ temp_2_1~710@)
                (=>
                 (= temp_3_0~795@ (Mul (Mul (Add c3~30@ (Mul b3~28@ b3~28@)) (Mul (Mul c3~30@ d3~32@)
                     (Mul a3~26@ d3~32@)
                    )
                 ...
                 (=>
                  (= temp_3_1~856@ (Mul (Mul (Mul (Add d3~32@ a3~26@) (Sub b3~28@ d3~32@)) (Mul (Add a3~26@
                       a3~26@
                      ) (Mul a3~26@ b3~28@)
                     )
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~795@ temp_3_1~856@)
                    (=>
                     (= temp_4_0~941@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ c4~38@)) (Add (Sub d4~40@
                          a4~34@
                         ) (Mul d4~40@ b4~36@)
                        )
                     ...
                     (=>
                      (= temp_4_1~1002@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ c4~38@)) (Add (Sub d4~40@
                           a4~34@
                          ) (Mul d4~40@ b4~36@)
                         )
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~941@ temp_4_1~1002@)
                        (=>
                         (= temp_5_0~1091@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@
                              d5~48@
                             ) (Mul c5~46@ c5~46@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1156@ (Mul (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul
                                d5~48@ d5~48@
                               ) (Mul c5~46@ c5~46@)
                              )
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1091@ temp_5_1~1156@)
                           ))
                           (=>
                            (= temp_5_0~1091@ temp_5_1~1156@)
                            (=>
                             (= temp_6_0~1241@ (Mul (Sub (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@
                                  a6~50@
                                 ) (Mul a6~50@ c6~54@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1302@ (Mul (Sub (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@
                                   a6~50@
                                  ) (Mul c6~54@ a6~50@)
                                 )
                                ) (Mul (Add (Sub d6~56@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul c6~54@ c6~54@) a6~50@))
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1241@ temp_6_1~1302@)
                               ))
                               (=>
                                (= temp_6_0~1241@ temp_6_1~1302@)
                                (=>
                                 (= temp_7_0~1387@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Add d7~64@ b7~60@)) (Mul (Mul b7~60@
                                      d7~64@
                                     ) (Mul d7~64@ c7~62@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1448@ (Mul (Mul (Mul d7~64@ (Mul b7~60@ (Add d7~64@ b7~60@))) (Mul (Mul b7~60@
                                       d7~64@
                                      ) (Mul d7~64@ c7~62@)
                                     )
                                    ) (Mul (Mul c7~62@ (Mul a7~58@ a7~58@)) (Add (Mul c7~62@ d7~64@) (Mul c7~62@ b7~60@)))
                                  ...
                                  (and
                                   ...
                                   (=>
                                    (= temp_7_0~1387@ temp_7_1~1448@)
                                    (=>
                                     (= temp_8_0~1533@ (Mul (Mul (Mul b8~68@ (Add b8~68@ a8~66@)) (Sub (Mul a8~66@ a8~66@)
                                         (Mul d8~72@ c8~70@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1594@ (Mul (Mul (Sub (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@)) (Mul b8~68@
                                          (Add b8~68@ a8~66@)
                                         )
                                        ) (Mul (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@
                                           b8~68@
