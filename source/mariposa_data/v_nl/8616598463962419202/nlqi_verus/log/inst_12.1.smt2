...
(set-info :comment ";; mariposa_data/v_nl//8616598463962419202/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_9_0~1765@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Add d0~8@ a0~2@)) b0~4@) (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~346@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Add d0~8@ a0~2@)) b0~4@) (Mul (Mul (Mul (Mul c0~6@ a0~2@) b0~4@) b0~4@) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ d0~8@))))) (and (=> (= tmp%1@ (Mul c0~6@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b0~4@ b0~4@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@)))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~441@ (Mul (Sub (Add (Sub b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Sub (Add c1~14@ d1~16@) (Mul c1~14@ b1~12@))) (Sub (Mul (Add c1~14@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ a1~10@) b1~12@)))) (=> (= temp_1_1~502@ (Mul (Sub (Add (Sub b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Sub (Add c1~14@ d1~16@) (Mul c1~14@ b1~12@))) (Sub (Mul (Add c1~14@ a1~10@) (Mul a1~10@ b1~12@)) (Mul b1~12@ (Mul a1~10@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b1~12@ a1~10@ b1~12@) (=> %%location_label%%1 (= temp_1_0~441@ temp_1_1~502@))) (=> (= temp_1_0~441@ temp_1_1~502@) (=> (= temp_2_0~609@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub d2~24@ b2~20@)) (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ c2~22@))) (Sub (Mul (Mul 44 b2~20@) (Mul d2~24@ c2~22@)) (Mul (Sub c2~22@ c2~22@) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~686@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub d2~24@ b2~20@)) (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ c2~22@))) (Sub (Mul (Mul 44 b2~20@) (Mul c2~22@ d2~24@)) (Mul (Sub c2~22@ c2~22@) (Mul c2~22@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ c2~22@) (=> %%location_label%%2 (= temp_2_0~609@ temp_2_1~686@))) (=> (= temp_2_0~609@ temp_2_1~686@) (=> (= temp_3_0~791@ (Mul (Sub (Mul (Mul 10 c3~30@) (Mul a3~26@ a3~26@)) d3~32@) (Mul (Mul (Mul d3~32@ 0) (Sub c3~30@ d3~32@)) (Mul (Sub c3~30@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~868@ (Mul (Sub (Mul (Mul 10 c3~30@) (Mul a3~26@ a3~26@)) d3~32@) (Mul (Mul (Sub c3~30@ d3~32@) (Mul d3~32@ 0)) (Mul (Sub c3~30@ c3~30@) (Mul d3~32@ c3~30@))))) (and (=> (= tmp%2@ (Mul d3~32@ 0)) (=> (= tmp%3@ (Sub c3~30@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~791@ temp_3_1~868@))))) (=> (= temp_3_0~791@ temp_3_1~868@) (=> (= temp_4_0~981@ (Add (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@)) (Sub (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ b4~36@)) (Sub (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~1046@ (Add (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@)) (Sub (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ b4~36@)) (Sub (Mul c4~38@ a4~34@) (Mul b4~36@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ c4~38@) (=> %%location_label%%4 (= temp_4_0~981@ temp_4_1~1046@))) (=> (= temp_4_0~981@ temp_4_1~1046@) (=> (= temp_5_0~1131@ (Mul (Sub (Mul d5~48@ (Mul d5~48@ a5~42@)) (Add (Mul c5~46@ c5~46@) (Add c5~46@ d5~48@))) (Mul (Mul d5~48@ (Mul a5~42@ c5~46@)) (Mul (Add b5~44@ d5~48@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1188@ (Mul (Sub (Mul d5~48@ (Mul d5~48@ a5~42@)) (Add (Mul c5~46@ c5~46@) (Add c5~46@ d5~48@))) (Mul (Mul (Mul d5~48@ (Mul a5~42@ c5~46@)) (Add b5~44@ d5~48@)) (Mul c5~46@ c5~46@)))) (and (=> (= tmp%4@ (Mul d5~48@ (Mul a5~42@ c5~46@))) (=> (= tmp%5@ (Add b5~44@ d5~48@)) (=> (= tmp%6@ (Mul c5~46@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~1131@ temp_5_1~1188@)))))) (=> (= temp_5_0~1131@ temp_5_1~1188@) (=> (= temp_6_0~1283@ (Sub (Mul (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@)) c6~54@) (Mul (Mul a6~50@ (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@ c6~54@) (Add a6~50@ b6~52@))))) (=> (= temp_6_1~1332@ (Sub (Mul (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@)) c6~54@) (Mul a6~50@ (Mul (Mul c6~54@ d6~56@) (Mul (Mul c6~54@ c6~54@) (Add a6~50@ b6~52@)))))) (and (=> (= tmp%7@ (Mul c6~54@ d6~56@)) (=> (= tmp%8@ (Mul (Mul c6~54@ c6~54@) (Add a6~50@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. a6~50@ tmp%7@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~1283@ temp_6_1~1332@))))) (=> (= temp_6_0~1283@ temp_6_1~1332@) (=> (= temp_7_0~1447@ (Mul (Mul (Add (Mul d7~64@ d7~64@) (Mul d7~64@ d7~64@)) (Mul b7~60@ (Mul d7~64@ d7~64@))) (Add (Sub (Mul d7~64@ d7~64@) (Mul 86 b7~60@)) (Mul d7~64@ (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1516@ (Mul (Mul (Add (Mul d7~64@ d7~64@) (Mul d7~64@ d7~64@)) (Mul b7~60@ (Mul d7~64@ d7~64@))) (Add (Sub (Mul d7~64@ d7~64@) (Mul b7~60@ 86)) (Mul d7~64@ (Mul b7~60@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 86 b7~60@) (=> %%location_label%%7 (= temp_7_0~1447@ temp_7_1~1516@))) (=> (= temp_7_0~1447@ temp_7_1~1516@) (=> (= temp_8_0~1601@ (Mul (Add (Mul d8~72@ (Add d8~72@ b8~68@)) (Sub (Mul c8~70@ c8~70@) (Mul a8~66@ 34))) d8~72@)) (=> (= temp_8_1~1650@ (Add (Mul (Mul d8~72@ (Add d8~72@ b8~68@)) d8~72@) (Mul (Sub (Mul c8~70@ c8~70@) (Mul a8~66@ 34)) d8~72@))) (and (=> (= tmp%9@ (Mul d8~72@ (Add d8~72@ b8~68@))) (=> (= tmp%10@ (Sub (Mul c8~70@ c8~70@) (Mul a8~66@ 34))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ tmp%10@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1601@ temp_8_1~1650@))))) (=> (= temp_8_0~1601@ temp_8_1~1650@) (=> (= temp_9_0~1765@ (Mul (Mul (Mul (Mul c9~78@ c9~78@) (Sub d9~80@ a9~74@)) (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Sub a9~74@ b9~76@) (Mul c9~78@ a9~74@)) d9~80@))) (=> (= temp_9_1~1818@ (Mul (Mul (Mul (Sub a9~74@ b9~76@) (Mul c9~78@ a9~74@)) d9~80@) (Mul (Mul (Mul c9~78@ c9~78@) (Sub d9~80@ a9~74@)) (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ d9~80@))))) (and (=> (= tmp%11@ (Mul (Mul (Mul c9~78@ c9~78@) (Sub d9~80@ a9~74@)) (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ d9~80@)))) (=> (= tmp%12@ (Mul (Mul (Sub a9~74@ b9~76@) (Mul c9~78@ a9~74@)) d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%9 (= temp_9_0~1765@ temp_9_1~1818@))))) (=> (= temp_9_0~1765@ temp_9_1~1818@) (=> (= temp_10_0~1963@ (Add (Mul (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ 66)) (Mul (Add a10~82@ c10~86@) b10~84@)) (Mul (Mul (Mul d10~88@ c10~86@) (Mul b10~84@ c10~86@)) (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ c10~86@))))) (=> (= temp_10_1~2036@ (Add (Mul (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ 66)) (Mul (Add a10~82@ c10~86@) b10~84@)) (Mul (Mul (Mul d10~88@ c10~86@) (Mul b10~84@ c10~86@)) (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b10~84@ b10~84@) (=> %%location_label%%10 (= temp_10_0~1963@ temp_10_1~2036@))) (=> (= temp_10_0~1963@ temp_10_1~2036@) (=> (= temp_11_0~2141@ (Mul (Sub (Mul (Sub 85 a11~90@) (Add d11~96@ c11~94@)) (Mul (Add a11~90@ d11~96@) (Mul c11~94@ a11~90@))) (Mul (Mul (Sub b11~92@ d11~96@) (Mul b11~92@ a11~90@)) (Mul (Add a11~90@ b11~92@) (Mul c11~94@ d11~96@))))) (=> (= temp_11_1~2218@ (Mul (Sub (Mul (Sub 85 a11~90@) (Add d11~96@ c11~94@)) (Mul (Add a11~90@ d11~96@) (Mul c11~94@ a11~90@))) (Mul (Mul (Sub b11~92@ d11~96@) (Mul b11~92@ a11~90@)) (Mul (Mul (Add a11~90@ b11~92@) c11~94@) d11~96@)))) (=> (= tmp%13@ (Add a11~90@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ c11~94@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2141@ temp_11_1~2218@)))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
