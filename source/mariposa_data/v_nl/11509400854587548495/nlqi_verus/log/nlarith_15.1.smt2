...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Add a0~2@ c0~6@) (Mul d0~8@ a0~2@)) (Mul (Mul b0~4@ d0~8@) b0~4@)) (Mul (Add (Mul a0~2@ a0~2@) (Add d0~8@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul (Add a0~2@ c0~6@) (Mul d0~8@ a0~2@)) (Mul b0~4@ d0~8@)) b0~4@) (Mul (Add (Mul a0~2@ a0~2@) (Add d0~8@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~442@ (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Add c1~14@ d1~16@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ d1~16@))) (Mul (Add (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~507@ (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Add c1~14@ d1~16@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ d1~16@))) (Mul (Add (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~442@ temp_1_1~507@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~587@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Add a2~18@ c2~22@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ a2~18@))))) (=> (= temp_2_1~652@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Add a2~18@ c2~22@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~587@ temp_2_1~652@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~740@ (Mul (Add (Mul (Add c3~30@ d3~32@) (Mul b3~28@ 31)) (Sub (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@))) (Mul (Mul (Sub c3~30@ c3~30@) c3~30@) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~813@ (Mul (Add (Mul (Add c3~30@ d3~32@) (Mul b3~28@ 31)) (Sub (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@))) (Mul (Mul (Sub c3~30@ c3~30@) c3~30@) (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~740@ temp_3_1~813@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~893@ (Mul (Add (Mul (Mul c4~38@ c4~38@) (Add a4~34@ c4~38@)) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@)) (Sub (Mul b4~36@ b4~36@) (Add b4~36@ b4~36@))))) (=> (= temp_4_1~958@ (Mul (Add (Mul (Mul c4~38@ c4~38@) (Add a4~34@ c4~38@)) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ a4~34@))) (Mul (Mul c4~38@ d4~40@) (Mul (Mul b4~36@ b4~36@) (Sub (Mul b4~36@ b4~36@) (Add b4~36@ b4~36@)))))) (=> (= tmp%5@ (= temp_4_0~893@ temp_4_1~958@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1022@ (Add (Mul (Add (Add d5~48@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Mul a5~42@ d5~48@) (Add d5~48@ d5~48@))) (Mul c5~46@ (Mul d5~48@ (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1071@ (Add (Mul (Add (Add d5~48@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Mul a5~42@ d5~48@) (Add d5~48@ d5~48@))) (Mul c5~46@ (Mul (Mul d5~48@ c5~46@) a5~42@)))) (=> (= tmp%6@ (= temp_5_0~1022@ temp_5_1~1071@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1163@ (Add (Mul (Mul (Mul a6~50@ a6~50@) (Sub a6~50@ c6~54@)) (Add (Mul d6~56@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul d6~56@ c6~54@) (Sub 86 d6~56@))))) (=> (= temp_6_1~1240@ (Add (Mul (Mul (Mul a6~50@ a6~50@) (Sub a6~50@ c6~54@)) (Add (Mul d6~56@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul (Mul d6~56@ d6~56@) b6~52@) b6~52@) (Mul (Mul d6~56@ c6~54@) (Sub 86 d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1163@ temp_6_1~1240@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1332@ (Mul (Add (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Add d7~64@ d7~64@))) (Mul (Mul (Mul c7~62@ a7~58@) (Sub b7~60@ 45)) (Add (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1409@ (Mul (Add (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@)) (Mul a7~58@ (Mul d7~64@ (Add d7~64@ d7~64@)))) (Mul (Mul (Mul c7~62@ a7~58@) (Sub b7~60@ 45)) (Add (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1332@ temp_7_1~1409@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1461@ (Mul c8~70@ (Mul (Sub (Mul c8~70@ c8~70@) (Add a8~66@ b8~68@)) (Mul (Mul a8~66@ c8~70@) (Sub c8~70@ b8~68@))))) (=> (= temp_8_1~1498@ (Mul c8~70@ (Mul (Sub (Mul c8~70@ c8~70@) (Add a8~66@ b8~68@)) (Mul (Sub c8~70@ b8~68@) (Mul a8~66@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1461@ temp_8_1~1498@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1590@ (Mul (Mul (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ b9~76@))) (Mul (Mul (Add d9~80@ b9~76@) (Add b9~76@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Mul 44 b9~76@))))) (=> (= temp_9_1~1667@ (Mul (Mul (Mul (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ a9~74@)) (Mul d9~80@ c9~78@)) (Mul d9~80@ b9~76@)) (Mul (Mul (Add d9~80@ b9~76@) (Add b9~76@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Mul 44 b9~76@))))) (=> (= tmp%10@ (= temp_9_0~1590@ temp_9_1~1667@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1739@ (Sub (Mul (Mul c10~86@ (Mul b10~84@ a10~82@)) (Mul (Mul d10~88@ d10~88@) (Sub a10~82@ a10~82@))) (Mul (Mul d10~88@ (Mul c10~86@ d10~88@)) (Add (Mul d10~88@ c10~86@) (Mul b10~84@ b10~84@))))) (=> (= temp_10_1~1796@ (Sub (Mul (Mul c10~86@ (Mul a10~82@ b10~84@)) (Mul (Mul d10~88@ d10~88@) (Sub a10~82@ a10~82@))) (Mul (Mul d10~88@ (Mul c10~86@ d10~88@)) (Add (Mul d10~88@ c10~86@) (Mul b10~84@ b10~84@))))) (=> (= tmp%11@ (= temp_10_0~1739@ temp_10_1~1796@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1844@ (Mul a11~90@ (Mul (Mul (Mul a11~90@ c11~94@) b11~92@) (Add (Add b11~92@ a11~90@) (Mul c11~94@ c11~94@))))) (=> (= temp_11_1~1877@ (Mul (Mul (Mul (Mul a11~90@ c11~94@) b11~92@) (Add (Add b11~92@ a11~90@) (Mul c11~94@ c11~94@))) a11~90@)) (=> (= tmp%12@ (= temp_11_0~1844@ temp_11_1~1877@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1969@ (Mul (Sub (Mul (Add 37 a12~98@) (Mul c12~102@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ a12~98@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) (Add (Mul c12~102@ b12~100@) (Mul c12~102@ c12~102@))))) (=> (= temp_12_1~2046@ (Mul (Sub (Mul (Add 37 a12~98@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ a12~98@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) (Add (Mul c12~102@ b12~100@) (Mul c12~102@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~1969@ temp_12_1~2046@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2122@ (Mul (Sub (Mul (Mul a13~106@ a13~106@) (Mul c13~110@ b13~108@)) (Mul (Mul b13~108@ a13~106@) (Mul a13~106@ c13~110@))) (Mul (Mul d13~112@ (Mul d13~112@ b13~108@)) (Mul (Mul c13~110@ a13~106@) (Add c13~110@ a13~106@))))) (=> (= temp_13_1~2183@ (Mul (Sub (Mul (Mul (Mul a13~106@ a13~106@) c13~110@) b13~108@) (Mul (Mul b13~108@ a13~106@) (Mul a13~106@ c13~110@))) (Mul (Mul d13~112@ (Mul d13~112@ b13~108@)) (Mul (Mul c13~110@ a13~106@) (Add c13~110@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2122@ temp_13_1~2183@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2263@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ d14~120@)) (Mul (Sub a14~114@ c14~118@) (Mul c14~118@ c14~118@))) (Mul (Mul (Mul a14~114@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2328@ (Mul (Mul (Mul (Sub a14~114@ c14~118@) (Mul c14~118@ c14~118@)) (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ d14~120@))) (Mul (Mul (Mul a14~114@ b14~116@) (Mul c14~118@ c14~118@)) (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ d14~120@))))) (=> (= tmp%15@ (= temp_14_0~2263@ temp_14_1~2328@)) (=> %%location_label%%14 tmp%15@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
