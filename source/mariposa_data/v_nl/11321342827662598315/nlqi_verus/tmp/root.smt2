...
(push)
 ...
 (declare-const temp_1_0~395@ Int)
 (declare-const temp_1_1~460@ Int)
 (declare-const temp_2_0~549@ Int)
 (declare-const temp_2_1~614@ Int)
 (declare-const temp_3_0~699@ Int)
 ...
 (declare-const temp_6_0~1165@ Int)
 ...
 (declare-const temp_13_1~2332@ Int)
 ...
 (declare-const temp_17_1~2988@ Int)
     ...
     (=>
      ...
      (and
       (=>
        ...
        (=>
         %%location_label%%0
         (= temp_0_0~273@ temp_0_1~306@)
       ))
       (=>
        (= temp_0_0~273@ temp_0_1~306@)
        (=>
         (= temp_1_0~395@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Sub b1~12@
              a1~10@
             ) (Mul b1~12@ d1~16@)
            )
         ...
         (=>
          (= temp_1_1~460@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Sub b1~12@
               a1~10@
              ) (Mul b1~12@ d1~16@)
             )
          ...
          (and
           (=>
            ...
            (=>
             %%location_label%%1
             (= temp_1_0~395@ temp_1_1~460@)
           ))
           (=>
            (= temp_1_0~395@ temp_1_1~460@)
            (=>
             (= temp_2_0~549@ (Mul (Mul (Add (Mul c2~22@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Sub d2~24@
                  d2~24@
                 ) (Mul d2~24@ c2~22@)
                )
             ...
             (=>
              (= temp_2_1~614@ (Mul (Mul (Add (Mul c2~22@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Sub d2~24@
                   d2~24@
                  ) (Mul d2~24@ c2~22@)
                 )
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~549@ temp_2_1~614@)
               ))
               (=>
                (= temp_2_0~549@ temp_2_1~614@)
                (=>
                 (= temp_3_0~699@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@
                      c3~30@
                     ) b3~28@
                    )
                 ...
                 (=>
                  (= temp_3_1~752@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@
                       c3~30@
                      ) b3~28@
                     )
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~699@ temp_3_1~752@)
                   ))
                   (=>
                    (= temp_3_0~699@ temp_3_1~752@)
                    (=>
                     (= temp_4_0~841@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) (Add (Mul a4~34@
                          d4~40@
                         ) (Add a4~34@ d4~40@)
                        )
                     ...
                     (=>
                      (= temp_4_1~922@ (Mul (Add (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) (Mul a4~34@
                           d4~40@
                          )
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~841@ temp_4_1~922@)
                       ))
                       (=>
                        (= temp_4_0~841@ temp_4_1~922@)
                        (=>
                         (= temp_5_0~1011@ (Sub (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ b5~44@)) (Mul (Sub d5~48@
                              97
                             ) (Mul d5~48@ b5~44@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1076@ (Sub (Mul (Mul (Sub d5~48@ 97) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@
                               a5~42@
                              ) (Mul b5~44@ b5~44@)
                             )
                            ) (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ b5~44@)) c5~46@)
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1011@ temp_5_1~1076@)
                           ))
                           (=>
                            (= temp_5_0~1011@ temp_5_1~1076@)
                            (=>
                             (= temp_6_0~1165@ (Mul (Mul (Add (Mul b6~52@ b6~52@) (Mul c6~54@ d6~56@)) (Sub (Sub c6~54@
                                  a6~50@
                                 ) (Mul d6~56@ b6~52@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1246@ (Mul (Mul (Add (Mul b6~52@ b6~52@) (Mul c6~54@ d6~56@)) (Sub (Sub c6~54@
                                   a6~50@
                                  ) (Mul d6~56@ b6~52@)
                                 )
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1165@ temp_6_1~1246@)
                               ))
                               (=>
                                (= temp_6_0~1165@ temp_6_1~1246@)
                                (=>
                                 (= temp_7_0~1335@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@
                                      a7~58@
                                     ) (Mul a7~58@ b7~60@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1400@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@
                                       d7~64@
                                      ) (Mul a7~58@ b7~60@)
                                     )
                                    ) (Mul (Add (Mul a7~58@ d7~64@) (Mul d7~64@ c7~62@)) (Sub (Mul d7~64@ d7~64@) (Mul d7~64@
                                  ...
                                  (and
                                   ...
                                   (=>
                                    (= temp_7_0~1335@ temp_7_1~1400@)
                                    (=>
                                     (= temp_8_0~1493@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul 87 a8~66@)) (Mul a8~66@ (Mul
                                          a8~66@ b8~68@
                                        ))
                                       ) (Mul (Mul c8~70@ (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@)))
                                     ))
                                     (=>
                                      (= temp_8_1~1562@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul 87 a8~66@)) (Mul (Mul a8~66@
                                           a8~66@
                                          ) b8~68@
                                         )
                                        ) (Mul (Mul c8~70@ (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ d8~72@)))
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1493@ temp_8_1~1562@)
                                       ))
                                       (=>
                                        (= temp_8_0~1493@ temp_8_1~1562@)
                                        (=>
                                         (= temp_9_0~1639@ (Mul (Mul d9~80@ (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ a9~74@))) (
                                            Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Add a9~74@ d9~80@) (Mul d9~80@
                                              c9~78@
                                         )))))
                                         (=>
                                          (= temp_9_1~1692@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Add a9~74@
                                               d9~80@
                                              ) (Mul d9~80@ c9~78@)
                                             )
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1639@ temp_9_1~1692@)
                                           ))
                                           (=>
                                            (= temp_9_0~1639@ temp_9_1~1692@)
                                            (=>
                                             (= temp_10_0~1777@ (Sub (Sub (Mul (Mul d10~88@ b10~84@) b10~84@) (Mul (Mul b10~84@ c10~86@)
                                                 (Mul a10~82@ b10~84@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1838@ (Sub (Sub (Mul (Mul d10~88@ b10~84@) b10~84@) (Mul (Mul b10~84@ c10~86@)
                                                  (Mul a10~82@ b10~84@)
                                                 )
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1777@ temp_10_1~1838@)
                                               ))
                                               (=>
                                                (= temp_10_0~1777@ temp_10_1~1838@)
                                                (=>
                                                 (= temp_11_0~1927@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ b11~92@)) (Mul (
                                                      Mul a11~90@ b11~92@
                                                     ) (Mul b11~92@ a11~90@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~1992@ (Mul (Mul (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ b11~92@)) (Mul (
                                                       Mul a11~90@ b11~92@
                                                      ) (Mul b11~92@ a11~90@)
                                                     )
                                                    ) (Mul (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@)
                                                  ...
                                                  (and
                                                   ...
                                                   (=>
                                                    (= temp_11_0~1927@ temp_11_1~1992@)
                                                    (=>
                                                     (= temp_12_0~2093@ (Mul (Add (Add (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@)) (
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2178@ (Mul (Add (Add (Mul b12~100@ c12~102@) (Mul d12~104@ b12~100@)) (
                                                          Mul (Mul c12~102@ c12~102@) (Mul a12~98@ a12~98@)
                                                         )
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2093@ temp_12_1~2178@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2093@ temp_12_1~2178@)
                                                        (=>
                                                         (= temp_13_0~2267@ (Mul (Add (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2332@ (Mul (Add (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (
                                                              Mul (Mul b13~108@ a13~106@) (Add d13~112@ c13~110@)
                                                             )
                                                            ) (Add (Mul (Mul a13~106@ d13~112@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ a13~106@)
                                                              (Mul d13~112@ a13~106@)
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2267@ temp_13_1~2332@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2267@ temp_13_1~2332@)
                                                            (=>
                                                             (= temp_14_0~2429@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ d14~120@)) (
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2518@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ d14~120@)) (
                                                                  Mul (Mul c14~118@ a14~114@) c14~118@
                                                                 )
                                                              ...
                                                              (and
                                                               ...
                                                               (=>
                                                                (= temp_14_0~2429@ temp_14_1~2518@)
                                                                (=>
                                                                 (= temp_15_0~2603@ (Mul (Mul (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ d15~128@)) (
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2664@ (Mul (Mul (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ d15~128@)) (
                                                                      Mul (Mul a15~122@ a15~122@) (Add b15~124@ c15~126@)
                                                                     )
                                                                    ) (Add (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ c15~126@)) (Mul d15~128@ (Mul d15~128@
                                                                       b15~124@
                                                                  ...
                                                                  (and
                                                                   ...
                                                                   (=>
                                                                    (= temp_15_0~2603@ temp_15_1~2664@)
                                                                    (=>
                                                                     (= temp_16_0~2761@ (Mul (Add (Mul (Mul a16~130@ c16~134@) (Sub d16~136@ b16~132@)) (
                                                                     ...
                                                                     (=>
                                                                      (= temp_16_1~2834@ (Mul (Add (Mul (Mul a16~130@ c16~134@) (Sub d16~136@ b16~132@)) (
                                                                          Mul (Mul b16~132@ a16~130@) (Mul a16~130@ d16~136@)
                                                                         )
                                                                      ...
                                                                      (and
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         %%location_label%%16
                                                                         (= temp_16_0~2761@ temp_16_1~2834@)
                                                                       ))
                                                                       (=>
                                                                        (= temp_16_0~2761@ temp_16_1~2834@)
                                                                        (=>
                                                                         (= temp_17_0~2923@ (Mul (Mul (Mul (Mul a17~138@ d17~144@) (Mul b17~140@ d17~144@)) (
                                                                         ...
                                                                         (=>
                                                                          (= temp_17_1~2988@ (Mul (Mul (Mul (Mul a17~138@ d17~144@) (Mul b17~140@ d17~144@)) (
                                                                              Mul (Add c17~142@ d17~144@) (Mul a17~138@ c17~142@)
                                                                             )
                                                                          ...
                                                                          (and
                                                                           (=>
                                                                            ...
                                                                            (=>
                                                                             %%location_label%%17
                                                                             (= temp_17_0~2923@ temp_17_1~2988@)
                                                                           ))
                                                                           (=>
                                                                            (= temp_17_0~2923@ temp_17_1~2988@)
                                                                            (=>
                                                                             (= temp_18_0~3077@ (Mul (Add (Mul (Mul c18~150@ a18~146@) (Add c18~150@ a18~146@)) (
                                                                             ...
                                                                             (=>
                                                                              (= temp_18_1~3142@ (Mul (Add (Mul (Mul c18~150@ a18~146@) (Add c18~150@ a18~146@)) (
                                                                                  Mul (Mul d18~152@ d18~152@) (Mul d18~152@ d18~152@)
                                                                                 )
