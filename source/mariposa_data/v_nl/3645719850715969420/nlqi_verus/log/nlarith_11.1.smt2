...
(declare-const temp_2_1~884@ Int)
(declare-const temp_3_0~996@ Int)
(declare-const temp_3_1~1093@ Int)
(declare-const temp_4_0~1261@ Int)
(declare-const temp_4_1~1414@ Int)
(declare-const temp_5_0~1566@ Int)
(declare-const temp_5_1~1703@ Int)
(declare-const temp_6_0~1831@ Int)
(declare-const temp_6_1~1944@ Int)
(declare-const temp_7_0~2076@ Int)
(declare-const temp_7_1~2189@ Int)
(declare-const temp_8_0~2349@ Int)
(declare-const temp_8_1~2494@ Int)
(declare-const temp_9_0~2650@ Int)
(declare-const temp_9_1~2791@ Int)
(declare-const temp_10_0~2959@ Int)
(declare-const temp_10_1~3112@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~229@ (Mul (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Add a0~2@ b0~4@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ a0~2@)))) c0~6@)) (=> (= temp_0_1~298@ (Mul (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Add a0~2@ b0~4@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ a0~2@)))) c0~6@)) (=> (= tmp%1@ (= temp_0_0~229@ temp_0_1~298@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~454@ (Mul (Sub (Mul (Mul (Sub d1~16@ c1~14@) (Mul a1~10@ c1~14@)) d1~16@) (Add (Add (Mul c1~14@ c1~14@) (Sub a1~10@ a1~10@)) (Mul (Mul c1~14@ 15) (Mul a1~10@ b1~12@)))) (Add (Mul (Add (Mul b1~12@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Add c1~14@ d1~16@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul 4 d1~16@) (Mul c1~14@ d1~16@)))))) (=> (= temp_1_1~595@ (Mul (Sub (Mul (Sub d1~16@ c1~14@) (Mul (Mul a1~10@ c1~14@) d1~16@)) (Add (Add (Mul c1~14@ c1~14@) (Sub a1~10@ a1~10@)) (Mul (Mul c1~14@ 15) (Mul a1~10@ b1~12@)))) (Add (Mul (Add (Mul b1~12@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Add c1~14@ d1~16@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul 4 d1~16@) (Mul c1~14@ d1~16@)))))) (=> (= tmp%2@ (= temp_1_0~454@ temp_1_1~595@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~747@ (Add (Mul (Mul (Mul d2~24@ (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Sub b2~20@ b2~20@))) (Sub (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul c2~22@ c2~22@) (Sub d2~24@ b2~20@)))) (Mul (Mul (Sub (Mul d2~24@ a2~18@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Add a2~18@ a2~18@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul 16 c2~22@)) (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ d2~24@)))))) (=> (= temp_2_1~884@ (Add (Mul (Mul (Mul d2~24@ (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Sub b2~20@ b2~20@))) (Sub (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul c2~22@ c2~22@) (Sub d2~24@ b2~20@)))) (Mul (Mul (Mul (Sub (Mul d2~24@ a2~18@) (Mul d2~24@ d2~24@)) (Mul a2~18@ a2~18@)) (Add a2~18@ a2~18@)) (Mul (Mul (Mul c2~22@ a2~18@) (Mul 16 c2~22@)) (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ d2~24@)))))) (=> (= tmp%3@ (= temp_2_0~747@ temp_2_1~884@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~996@ (Mul (Mul (Mul (Mul a3~26@ (Mul d3~32@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ a3~26@))) d3~32@) (Sub (Mul (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ a3~26@) (Add b3~28@ d3~32@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Sub a3~26@ d3~32@) (Mul c3~30@ c3~30@)))))) (=> (= temp_3_1~1093@ (Mul (Mul (Mul (Mul a3~26@ (Mul d3~32@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ a3~26@))) d3~32@) (Sub (Mul (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ a3~26@) (Add b3~28@ d3~32@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Sub a3~26@ d3~32@) (Mul c3~30@ c3~30@)))))) (=> (= tmp%4@ (= temp_3_0~996@ temp_3_1~1093@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1261@ (Add (Sub (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Add (Mul c4~38@ d4~40@) (Mul d4~40@ b4~36@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)))) (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Sub c4~38@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul 65 c4~38@)) (Mul (Mul 48 c4~38@) (Sub c4~38@ d4~40@)))))) (=> (= temp_4_1~1414@ (Add (Sub (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Add (Mul c4~38@ d4~40@) (Mul d4~40@ b4~36@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)))) (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Sub c4~38@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul 65 c4~38@)) (Mul (Mul 48 c4~38@) (Sub c4~38@ d4~40@)))))) (=> (= tmp%5@ (= temp_4_0~1261@ temp_4_1~1414@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1566@ (Mul (Mul (Mul (Add (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul c5~46@ b5~44@) (Add b5~44@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@)))) (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul 2 d5~48@)) (Add (Mul c5~46@ c5~46@) (Sub c5~46@ d5~48@))) (Mul (Sub d5~48@ (Sub d5~48@ d5~48@)) (Mul (Add b5~44@ d5~48@) (Add a5~42@ d5~48@)))))) (=> (= temp_5_1~1703@ (Mul (Mul (Mul (Add (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul c5~46@ b5~44@) (Add b5~44@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@)))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul (Mul 2 d5~48@) (Add (Mul c5~46@ c5~46@) (Sub c5~46@ d5~48@)))) (Mul (Sub d5~48@ (Sub d5~48@ d5~48@)) (Mul (Add b5~44@ d5~48@) (Add a5~42@ d5~48@)))))) (=> (= tmp%6@ (= temp_5_0~1566@ temp_5_1~1703@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1831@ (Mul (Mul (Mul (Add (Sub c6~54@ a6~50@) a6~50@) (Mul (Sub c6~54@ c6~54@) (Mul a6~50@ c6~54@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)))) (Sub (Mul (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ b6~52@)) b6~52@) (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Add c6~54@ b6~52@)))))) (=> (= temp_6_1~1944@ (Mul (Mul (Mul (Add (Sub c6~54@ a6~50@) a6~50@) (Mul (Sub c6~54@ c6~54@) (Mul a6~50@ c6~54@))) (Mul (Mul a6~50@ (Mul c6~54@ (Mul b6~52@ c6~54@))) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)))) (Sub (Mul (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ b6~52@)) b6~52@) (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Add c6~54@ b6~52@)))))) (=> (= tmp%7@ (= temp_6_0~1831@ temp_6_1~1944@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2076@ (Mul (Mul (Mul (Mul (Mul d7~64@ d7~64@) b7~60@) (Mul (Add a7~58@ d7~64@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)))) (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ a7~58@)) (Mul c7~62@ d7~64@)) (Mul (Add (Mul b7~60@ b7~60@) (Sub d7~64@ d7~64@)) (Add (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@)))))) (=> (= temp_7_1~2189@ (Mul (Mul (Mul (Mul (Mul d7~64@ d7~64@) b7~60@) (Mul (Add a7~58@ d7~64@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)))) (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ a7~58@)) (Mul c7~62@ d7~64@)) (Mul (Add (Mul b7~60@ b7~60@) (Sub d7~64@ d7~64@)) (Mul c7~62@ (Add a7~58@ d7~64@)))))) (=> (= tmp%8@ (= temp_7_0~2076@ temp_7_1~2189@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2349@ (Mul (Mul (Mul (Sub (Mul b8~68@ 89) (Mul a8~66@ d8~72@)) (Mul (Add a8~66@ b8~68@) (Mul a8~66@ b8~68@))) (Add (Mul (Mul b8~68@ c8~70@) (Sub d8~72@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ c8~70@)))) (Mul (Mul (Mul (Sub c8~70@ d8~72@) (Mul b8~68@ a8~66@)) (Mul (Mul 32 c8~70@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Mul d8~72@ c8~70@) c8~70@))))) (=> (= temp_8_1~2494@ (Mul (Mul (Mul (Sub (Mul b8~68@ 89) (Mul a8~66@ d8~72@)) (Mul (Add a8~66@ b8~68@) (Mul a8~66@ b8~68@))) (Add (Mul (Sub d8~72@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ c8~70@)))) (Mul (Mul (Mul (Sub c8~70@ d8~72@) (Mul b8~68@ a8~66@)) (Mul (Mul 32 c8~70@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Mul d8~72@ c8~70@) c8~70@))))) (=> (= tmp%9@ (= temp_8_0~2349@ temp_8_1~2494@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2650@ (Mul (Mul (Add (Mul (Mul a9~74@ d9~80@) (Add c9~78@ b9~76@)) (Mul (Sub a9~74@ a9~74@) (Mul c9~78@ a9~74@))) (Sub (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Add c9~78@ c9~78@) (Add b9~76@ c9~78@)))) (Mul (Sub (Mul (Add d9~80@ 15) (Mul a9~74@ b9~76@)) (Mul (Add c9~78@ a9~74@) (Mul d9~80@ a9~74@))) (Add (Mul (Add a9~74@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ b9~76@)))))) (=> (= temp_9_1~2791@ (Mul (Mul (Add (Mul (Mul a9~74@ d9~80@) (Add c9~78@ b9~76@)) (Mul (Mul (Sub a9~74@ a9~74@) c9~78@) a9~74@)) (Sub (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Add c9~78@ c9~78@) (Add b9~76@ c9~78@)))) (Mul (Sub (Mul (Add d9~80@ 15) (Mul a9~74@ b9~76@)) (Mul (Add c9~78@ a9~74@) (Mul d9~80@ a9~74@))) (Add (Mul (Add a9~74@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ b9~76@)))))) (=> (= tmp%10@ (= temp_9_0~2650@ temp_9_1~2791@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~2959@ (Mul (Mul (Mul d10~88@ (Add (Mul b10~84@ a10~82@) (Sub 81 d10~88@))) (Mul (Mul (Mul 14 c10~86@) (Mul b10~84@ b10~84@)) (Mul (Mul d10~88@ a10~82@) (Sub c10~86@ d10~88@)))) (Mul (Mul (Mul (Mul a10~82@ 26) (Sub c10~86@ a10~82@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ b10~84@) (Add a10~82@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul a10~82@ c10~86@)))))) (=> (= temp_10_1~3112@ (Mul (Mul (Mul d10~88@ (Add (Mul b10~84@ a10~82@) (Sub 81 d10~88@))) (Mul (Mul 14 c10~86@) (Mul (Mul b10~84@ b10~84@) (Mul (Mul d10~88@ a10~82@) (Sub c10~86@ d10~88@))))) (Mul (Mul (Mul (Mul a10~82@ 26) (Sub c10~86@ a10~82@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ b10~84@) (Add a10~82@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul a10~82@ c10~86@)))))) (=> (= tmp%11@ (= temp_10_0~2959@ temp_10_1~3112@)) (=> %%location_label%%10 tmp%11@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
