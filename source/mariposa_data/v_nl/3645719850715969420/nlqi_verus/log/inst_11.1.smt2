...
(set-info :comment ";; mariposa_data/v_nl//3645719850715969420/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~229@ (Mul (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Add a0~2@ b0~4@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ a0~2@)))) c0~6@)) (=> (= temp_0_1~298@ (Mul (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Add a0~2@ b0~4@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ a0~2@)))) c0~6@)) (and (=> (= tmp%1@ (Mul d0~8@ d0~8@)) (=> (= tmp%2@ (Mul d0~8@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~229@ temp_0_1~298@))))) (=> (= temp_0_0~229@ temp_0_1~298@) (=> (= temp_1_0~475@ (Mul (Sub (Mul (Mul (Sub d1~16@ c1~14@) (Mul a1~10@ c1~14@)) d1~16@) (Add (Add (Mul c1~14@ c1~14@) (Sub a1~10@ a1~10@)) (Mul (Mul c1~14@ 15) (Mul a1~10@ b1~12@)))) (Add (Mul (Add (Mul b1~12@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Add c1~14@ d1~16@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul 4 d1~16@) (Mul c1~14@ d1~16@)))))) (=> (= temp_1_1~616@ (Mul (Sub (Mul (Sub d1~16@ c1~14@) (Mul (Mul a1~10@ c1~14@) d1~16@)) (Add (Add (Mul c1~14@ c1~14@) (Sub a1~10@ a1~10@)) (Mul (Mul c1~14@ 15) (Mul a1~10@ b1~12@)))) (Add (Mul (Add (Mul b1~12@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Add c1~14@ d1~16@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul 4 d1~16@) (Mul c1~14@ d1~16@)))))) (and (=> (= tmp%3@ (Sub d1~16@ c1~14@)) (=> (= tmp%4@ (Mul a1~10@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ d1~16@) (=> %%location_label%%1 (= temp_1_0~475@ temp_1_1~616@))))) (=> (= temp_1_0~475@ temp_1_1~616@) (=> (= temp_2_0~791@ (Add (Mul (Mul (Mul d2~24@ (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Sub b2~20@ b2~20@))) (Sub (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul c2~22@ c2~22@) (Sub d2~24@ b2~20@)))) (Mul (Mul (Sub (Mul d2~24@ a2~18@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Add a2~18@ a2~18@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul 16 c2~22@)) (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ d2~24@)))))) (=> (= temp_2_1~928@ (Add (Mul (Mul (Mul d2~24@ (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Sub b2~20@ b2~20@))) (Sub (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul c2~22@ c2~22@) (Sub d2~24@ b2~20@)))) (Mul (Mul (Mul (Sub (Mul d2~24@ a2~18@) (Mul d2~24@ d2~24@)) (Mul a2~18@ a2~18@)) (Add a2~18@ a2~18@)) (Mul (Mul (Mul c2~22@ a2~18@) (Mul 16 c2~22@)) (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ d2~24@)))))) (and (=> (= tmp%5@ (Sub (Mul d2~24@ a2~18@) (Mul d2~24@ d2~24@))) (=> (= tmp%6@ (Mul a2~18@ a2~18@)) (=> (= tmp%7@ (Add a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~791@ temp_2_1~928@)))))) (=> (= temp_2_0~791@ temp_2_1~928@) (=> (= temp_3_0~1075@ (Mul (Mul (Mul (Mul a3~26@ (Mul d3~32@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ a3~26@))) d3~32@) (Sub (Mul (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ a3~26@) (Add b3~28@ d3~32@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Sub a3~26@ d3~32@) (Mul c3~30@ c3~30@)))))) (=> (= temp_3_1~1172@ (Mul (Mul (Mul (Mul a3~26@ (Mul d3~32@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ a3~26@))) d3~32@) (Sub (Mul (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ a3~26@) (Add b3~28@ d3~32@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Sub a3~26@ d3~32@) (Mul c3~30@ c3~30@)))))) (and (=> (= tmp%8@ (Mul b3~28@ d3~32@)) (=> (= tmp%9@ (Mul c3~30@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%3 (= temp_3_0~1075@ temp_3_1~1172@))))) (=> (= temp_3_0~1075@ temp_3_1~1172@) (=> (= temp_4_0~1361@ (Add (Sub (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Add (Mul c4~38@ d4~40@) (Mul d4~40@ b4~36@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)))) (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Sub c4~38@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul 65 c4~38@)) (Mul (Mul 48 c4~38@) (Sub c4~38@ d4~40@)))))) (=> (= temp_4_1~1514@ (Add (Sub (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Add (Mul c4~38@ d4~40@) (Mul d4~40@ b4~36@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)))) (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Sub c4~38@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul 65 c4~38@)) (Mul (Mul 48 c4~38@) (Sub c4~38@ d4~40@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1361@ temp_4_1~1514@))) (=> (= temp_4_0~1361@ temp_4_1~1514@) (=> (= temp_5_0~1679@ (Mul (Mul (Mul (Add (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul c5~46@ b5~44@) (Add b5~44@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@)))) (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul 2 d5~48@)) (Add (Mul c5~46@ c5~46@) (Sub c5~46@ d5~48@))) (Mul (Sub d5~48@ (Sub d5~48@ d5~48@)) (Mul (Add b5~44@ d5~48@) (Add a5~42@ d5~48@)))))) (=> (= temp_5_1~1816@ (Mul (Mul (Mul (Add (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul c5~46@ b5~44@) (Add b5~44@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@)))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul (Mul 2 d5~48@) (Add (Mul c5~46@ c5~46@) (Sub c5~46@ d5~48@)))) (Mul (Sub d5~48@ (Sub d5~48@ d5~48@)) (Mul (Add b5~44@ d5~48@) (Add a5~42@ d5~48@)))))) (and (=> (= tmp%10@ (Mul b5~44@ d5~48@)) (=> (= tmp%11@ (Mul 2 d5~48@)) (=> (= tmp%12@ (Add (Mul c5~46@ c5~46@) (Sub c5~46@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%5 (= temp_5_0~1679@ temp_5_1~1816@)))))) (=> (= temp_5_0~1679@ temp_5_1~1816@) (=> (= temp_6_0~1991@ (Mul (Mul (Mul (Add (Sub c6~54@ a6~50@) a6~50@) (Mul (Sub c6~54@ c6~54@) (Mul a6~50@ c6~54@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)))) (Sub (Mul (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ b6~52@)) b6~52@) (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Add c6~54@ b6~52@)))))) (=> (= temp_6_1~2104@ (Mul (Mul (Mul (Add (Sub c6~54@ a6~50@) a6~50@) (Mul (Sub c6~54@ c6~54@) (Mul a6~50@ c6~54@))) (Mul (Mul a6~50@ (Mul c6~54@ (Mul b6~52@ c6~54@))) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)))) (Sub (Mul (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ b6~52@)) b6~52@) (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Add c6~54@ b6~52@)))))) (and (=> (= tmp%13@ (Mul b6~52@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a6~50@ c6~54@ tmp%13@) (=> %%location_label%%6 (= temp_6_0~1991@ temp_6_1~2104@)))) (=> (= temp_6_0~1991@ temp_6_1~2104@) (=> (= temp_7_0~2255@ (Mul (Mul (Mul (Mul (Mul d7~64@ d7~64@) b7~60@) (Mul (Add a7~58@ d7~64@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)))) (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ a7~58@)) (Mul c7~62@ d7~64@)) (Mul (Add (Mul b7~60@ b7~60@) (Sub d7~64@ d7~64@)) (Add (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@)))))) (=> (= temp_7_1~2368@ (Mul (Mul (Mul (Mul (Mul d7~64@ d7~64@) b7~60@) (Mul (Add a7~58@ d7~64@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)))) (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ a7~58@)) (Mul c7~62@ d7~64@)) (Mul (Add (Mul b7~60@ b7~60@) (Sub d7~64@ d7~64@)) (Mul c7~62@ (Add a7~58@ d7~64@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. c7~62@ a7~58@ d7~64@) (=> %%location_label%%7 (= temp_7_0~2255@ temp_7_1~2368@))) (=> (= temp_7_0~2255@ temp_7_1~2368@) (=> (= temp_8_0~2543@ (Mul (Mul (Mul (Sub (Mul b8~68@ 89) (Mul a8~66@ d8~72@)) (Mul (Add a8~66@ b8~68@) (Mul a8~66@ b8~68@))) (Add (Mul (Mul b8~68@ c8~70@) (Sub d8~72@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ c8~70@)))) (Mul (Mul (Mul (Sub c8~70@ d8~72@) (Mul b8~68@ a8~66@)) (Mul (Mul 32 c8~70@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Mul d8~72@ c8~70@) c8~70@))))) (=> (= temp_8_1~2688@ (Mul (Mul (Mul (Sub (Mul b8~68@ 89) (Mul a8~66@ d8~72@)) (Mul (Add a8~66@ b8~68@) (Mul a8~66@ b8~68@))) (Add (Mul (Sub d8~72@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ c8~70@)))) (Mul (Mul (Mul (Sub c8~70@ d8~72@) (Mul b8~68@ a8~66@)) (Mul (Mul 32 c8~70@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Mul d8~72@ c8~70@) c8~70@))))) (and (=> (= tmp%14@ (Mul b8~68@ c8~70@)) (=> (= tmp%15@ (Sub d8~72@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%8 (= temp_8_0~2543@ temp_8_1~2688@))))) (=> (= temp_8_0~2543@ temp_8_1~2688@) (=> (= temp_9_0~2865@ (Mul (Mul (Add (Mul (Mul a9~74@ d9~80@) (Add c9~78@ b9~76@)) (Mul (Sub a9~74@ a9~74@) (Mul c9~78@ a9~74@))) (Sub (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Add c9~78@ c9~78@) (Add b9~76@ c9~78@)))) (Mul (Sub (Mul (Add d9~80@ 15) (Mul a9~74@ b9~76@)) (Mul (Add c9~78@ a9~74@) (Mul d9~80@ a9~74@))) (Add (Mul (Add a9~74@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ b9~76@)))))) (=> (= temp_9_1~3006@ (Mul (Mul (Add (Mul (Mul a9~74@ d9~80@) (Add c9~78@ b9~76@)) (Mul (Mul (Sub a9~74@ a9~74@) c9~78@) a9~74@)) (Sub (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Add c9~78@ c9~78@) (Add b9~76@ c9~78@)))) (Mul (Sub (Mul (Add d9~80@ 15) (Mul a9~74@ b9~76@)) (Mul (Add c9~78@ a9~74@) (Mul d9~80@ a9~74@))) (Add (Mul (Add a9~74@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ b9~76@)))))) (and (=> (= tmp%16@ (Sub a9~74@ a9~74@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ c9~78@ a9~74@) (=> %%location_label%%9 (= temp_9_0~2865@ temp_9_1~3006@)))) (=> (= temp_9_0~2865@ temp_9_1~3006@) (=> (= temp_10_0~3193@ (Mul (Mul (Mul d10~88@ (Add (Mul b10~84@ a10~82@) (Sub 81 d10~88@))) (Mul (Mul (Mul 14 c10~86@) (Mul b10~84@ b10~84@)) (Mul (Mul d10~88@ a10~82@) (Sub c10~86@ d10~88@)))) (Mul (Mul (Mul (Mul a10~82@ 26) (Sub c10~86@ a10~82@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ b10~84@) (Add a10~82@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul a10~82@ c10~86@)))))) (=> (= temp_10_1~3346@ (Mul (Mul (Mul d10~88@ (Add (Mul b10~84@ a10~82@) (Sub 81 d10~88@))) (Mul (Mul 14 c10~86@) (Mul (Mul b10~84@ b10~84@) (Mul (Mul d10~88@ a10~82@) (Sub c10~86@ d10~88@))))) (Mul (Mul (Mul (Mul a10~82@ 26) (Sub c10~86@ a10~82@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ b10~84@) (Add a10~82@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul a10~82@ c10~86@)))))) (=> (= tmp%17@ (Mul 14 c10~86@)) (=> (= tmp%18@ (Mul b10~84@ b10~84@)) (=> (= tmp%19@ (Mul (Mul d10~88@ a10~82@) (Sub c10~86@ d10~88@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%10 (= temp_10_0~3193@ temp_10_1~3346@)))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
