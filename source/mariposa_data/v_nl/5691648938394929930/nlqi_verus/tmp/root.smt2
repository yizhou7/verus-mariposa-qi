...
(push)
 ...
 (declare-const temp_1_1~463@ Int)
 (declare-const temp_2_0~531@ Int)
 (declare-const temp_2_1~584@ Int)
 ...
 (declare-const temp_8_1~1462@ Int)
 (declare-const temp_9_0~1514@ Int)
 (declare-const temp_9_1~1551@ Int)
 (declare-const temp_10_0~1627@ Int)
 (declare-const temp_10_1~1688@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
      ...
      (=>
       ...
       (and
        ...
        (=>
         tmp%1@
         (=>
          (= temp_1_0~390@ (Sub (Mul (Mul (Mul a1~10@ c1~14@) c1~14@) (Sub (Add d1~16@ b1~12@)
              (Mul c1~14@ a1~10@)
             )
          ...
          (=>
           (= temp_1_1~463@ (Sub (Sub (Mul (Mul (Mul a1~10@ c1~14@) c1~14@) (Add d1~16@ b1~12@))
              (Mul (Mul (Mul a1~10@ c1~14@) c1~14@) (Mul c1~14@ a1~10@))
             ) (Sub (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Add d1~16@ a1~10@) (Mul a1~10@
                c1~14@
           )))))
           (=>
            (= tmp%2@ (= temp_1_0~390@ temp_1_1~463@))
            (and
             (=>
              %%location_label%%1
              tmp%2@
             ...
             (=>
              tmp%2@
              (=>
               (= temp_2_0~531@ (Mul (Mul c2~22@ (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ d2~24@))) (Mul
                  (Mul (Mul c2~22@ c2~22@) (Sub b2~20@ c2~22@)) (Mul (Add b2~20@ b2~20@) (Mul c2~22@
                    c2~22@
               )))))
               (=>
                (= temp_2_1~584@ (Mul (Mul c2~22@ (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ d2~24@))) (Mul
                   (Mul (Mul c2~22@ c2~22@) (Sub b2~20@ c2~22@)) (Mul (Add b2~20@ b2~20@) (Mul c2~22@
                     c2~22@
                )))))
                (=>
                 (= tmp%3@ (= temp_2_0~531@ temp_2_1~584@))
                 (and
                  (=>
                   %%location_label%%2
                   tmp%3@
                  ...
                  (=>
                   tmp%3@
                   (=>
                    (= temp_3_0~672@ (Add (Mul (Mul (Mul c3~30@ c3~30@) a3~26@) (Add (Mul d3~32@ d3~32@)
                        (Mul d3~32@ b3~28@)
                       )
                    ...
                    (=>
                     (= temp_3_1~745@ (Add (Mul (Mul (Mul c3~30@ c3~30@) a3~26@) (Add (Mul d3~32@ d3~32@)
                         (Mul d3~32@ b3~28@)
                        )
                       ) (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ 22)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@
                          c3~30@
                     ...
                     (=>
                      (= tmp%4@ (= temp_3_0~672@ temp_3_1~745@))
                      (and
                       (=>
                        %%location_label%%3
                        tmp%4@
                       ...
                       (=>
                        tmp%4@
                        (=>
                         (= temp_4_0~837@ (Mul (Add (Mul (Add c4~38@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul 34
                              c4~38@
                             ) (Mul d4~40@ b4~36@)
                            )
                         ...
                         (=>
                          (= temp_4_1~914@ (Mul (Add (Mul (Add c4~38@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@
                               b4~36@
                              ) (Mul 34 c4~38@)
                             )
                            ) (Add (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul a4~34@
                          ...
                          (=>
                           (= tmp%5@ (= temp_4_0~837@ temp_4_1~914@))
                           (and
                            (=>
                             %%location_label%%4
                             tmp%5@
                            ...
                            (=>
                             tmp%5@
                             (=>
                              (= temp_5_0~1002@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ 31)) (Sub (Mul c5~46@
                                   d5~48@
                                  ) (Mul b5~44@ b5~44@)
                                 )
                              ...
                              (=>
                               (= temp_5_1~1075@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ 31)) (Sub (Mul c5~46@
                                    d5~48@
                                   ) (Mul b5~44@ b5~44@)
                                  )
                                 ) (Sub (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@)) (Mul c5~46@ (Mul a5~42@ a5~42@)))
                               ...
                               (=>
                                ...
                                (and
                                 ...
                                 (=>
                                  tmp%6@
                                  (=>
                                   (= temp_6_0~1155@ (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul a6~50@
                                        a6~50@
                                       ) (Mul c6~54@ d6~56@)
                                      )
                                   ...
                                   (=>
                                    (= temp_6_1~1220@ (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul c6~54@
                                         d6~56@
                                        ) (Mul a6~50@ a6~50@)
                                       )
                                      ) (Mul (Sub (Mul d6~56@ c6~54@) (Add d6~56@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@
                                    ...
                                    (=>
                                     (= tmp%7@ (= temp_6_0~1155@ temp_6_1~1220@))
                                     (and
                                      (=>
                                       %%location_label%%6
                                       tmp%7@
                                      ...
                                      (=>
                                       tmp%7@
                                       (=>
                                        (= temp_7_0~1288@ (Mul (Mul (Mul (Sub b7~60@ b7~60@) (Sub b7~60@ a7~58@)) (Mul d7~64@
                                            (Mul b7~60@ c7~62@)
                                           )
                                          ) (Mul (Mul (Mul d7~64@ a7~58@) b7~60@) (Mul c7~62@ (Mul d7~64@ c7~62@)))
                                        ))
                                        (=>
                                         (= temp_7_1~1341@ (Mul (Mul (Mul (Sub b7~60@ b7~60@) (Sub b7~60@ a7~58@)) (Mul d7~64@
                                             (Mul b7~60@ c7~62@)
                                            )
                                           ) (Mul (Mul b7~60@ (Mul d7~64@ a7~58@)) (Mul c7~62@ (Mul d7~64@ c7~62@)))
                                         ))
                                         (=>
                                          (= tmp%8@ (= temp_7_0~1288@ temp_7_1~1341@))
                                          (and
                                           (=>
                                            %%location_label%%7
                                            tmp%8@
                                           ...
                                           (=>
                                            tmp%8@
                                            (=>
                                             (= temp_8_0~1409@ (Mul (Add (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) c8~70@) (
                                                Mul (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@
                                                  c8~70@
                                             )))))
                                             (=>
                                              (= temp_8_1~1462@ (Mul (Add (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) c8~70@) (
                                                 Mul (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@
                                                   c8~70@
                                              )))))
                                              (=>
                                               (= tmp%9@ (= temp_8_0~1409@ temp_8_1~1462@))
                                               (and
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
                                                ...
                                                (=>
                                                 tmp%9@
                                                 (=>
                                                  (= temp_9_0~1514@ (Mul d9~80@ (Mul (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ d9~80@)) (Mul
                                                      (Sub a9~74@ a9~74@) (Mul a9~74@ d9~80@)
                                                  ))))
                                                  (=>
                                                   (= temp_9_1~1551@ (Mul d9~80@ (Mul (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ d9~80@)) (Mul
                                                       (Mul (Sub a9~74@ a9~74@) a9~74@) d9~80@
                                                   ))))
                                                   (=>
                                                    (= tmp%10@ (= temp_9_0~1514@ temp_9_1~1551@))
                                                    (and
                                                     (=>
                                                      %%location_label%%9
                                                      tmp%10@
                                                     ...
                                                     (=>
                                                      tmp%10@
                                                      (=>
                                                       (= temp_10_0~1627@ (Mul (Sub (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (
                                                            Mul c10~86@ d10~88@
                                                           ) (Mul c10~86@ c10~86@)
                                                          )
                                                       ...
                                                       (=>
                                                        (= temp_10_1~1688@ (Mul (Mul (Sub (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@)) (
                                                        ...
                                                        (=>
                                                         (= tmp%11@ (= temp_10_0~1627@ temp_10_1~1688@))
                                                         (=>
                                                          %%location_label%%10
                                                          tmp%11@
 )))))))))))))))))))))))))))))))))))))))))))))))))))))))))
