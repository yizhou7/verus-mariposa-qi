...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Mul c0~6@ (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@)) (Sub (Sub d0~8@ d0~8@) (Sub c0~6@ a0~2@))))) (=> (= temp_0_1~314@ (Mul c0~6@ (Mul (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ b0~4@)) (Sub (Sub d0~8@ d0~8@) (Sub c0~6@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~277@ temp_0_1~314@))) (=> (= temp_0_0~277@ temp_0_1~314@) (=> (= temp_1_0~399@ (Sub (Mul (Mul (Mul a1~10@ c1~14@) c1~14@) (Sub (Add d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Sub (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Add d1~16@ a1~10@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~472@ (Sub (Sub (Mul (Mul (Mul a1~10@ c1~14@) c1~14@) (Add d1~16@ b1~12@)) (Mul (Mul (Mul a1~10@ c1~14@) c1~14@) (Mul c1~14@ a1~10@))) (Sub (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Add d1~16@ a1~10@) (Mul a1~10@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~399@ temp_1_1~472@))) (=> (= temp_1_0~399@ temp_1_1~472@) (=> (= temp_2_0~549@ (Mul (Mul c2~22@ (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul c2~22@ c2~22@) (Sub b2~20@ c2~22@)) (Mul (Add b2~20@ b2~20@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~602@ (Mul (Mul c2~22@ (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul c2~22@ c2~22@) (Sub b2~20@ c2~22@)) (Mul (Add b2~20@ b2~20@) (Mul c2~22@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~549@ temp_2_1~602@))) (=> (= temp_2_0~549@ temp_2_1~602@) (=> (= temp_3_0~699@ (Add (Mul (Mul (Mul c3~30@ c3~30@) a3~26@) (Add (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ 22)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~772@ (Add (Mul (Mul (Mul c3~30@ c3~30@) a3~26@) (Add (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ 22)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~699@ temp_3_1~772@))) (=> (= temp_3_0~699@ temp_3_1~772@) (=> (= temp_4_0~873@ (Mul (Add (Mul (Add c4~38@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul 34 c4~38@) (Mul d4~40@ b4~36@))) (Add (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ a4~34@))))) (=> (= temp_4_1~950@ (Mul (Add (Mul (Add c4~38@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Mul 34 c4~38@))) (Add (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~873@ temp_4_1~950@))) (=> (= temp_4_0~873@ temp_4_1~950@) (=> (= temp_5_0~1047@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ 31)) (Sub (Mul c5~46@ d5~48@) (Mul b5~44@ b5~44@))) (Sub (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@)) (Mul c5~46@ (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1120@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ 31)) (Sub (Mul c5~46@ d5~48@) (Mul b5~44@ b5~44@))) (Sub (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@)) (Mul c5~46@ (Mul a5~42@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1047@ temp_5_1~1120@))) (=> (= temp_5_0~1047@ temp_5_1~1120@) (=> (= temp_6_0~1209@ (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Sub (Mul d6~56@ c6~54@) (Add d6~56@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1274@ (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Sub (Mul d6~56@ c6~54@) (Add d6~56@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1209@ temp_6_1~1274@))) (=> (= temp_6_0~1209@ temp_6_1~1274@) (=> (= temp_7_0~1351@ (Mul (Mul (Mul (Sub b7~60@ b7~60@) (Sub b7~60@ a7~58@)) (Mul d7~64@ (Mul b7~60@ c7~62@))) (Mul (Mul (Mul d7~64@ a7~58@) b7~60@) (Mul c7~62@ (Mul d7~64@ c7~62@))))) (=> (= temp_7_1~1404@ (Mul (Mul (Mul (Sub b7~60@ b7~60@) (Sub b7~60@ a7~58@)) (Mul d7~64@ (Mul b7~60@ c7~62@))) (Mul (Mul b7~60@ (Mul d7~64@ a7~58@)) (Mul c7~62@ (Mul d7~64@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1351@ temp_7_1~1404@))) (=> (= temp_7_0~1351@ temp_7_1~1404@) (=> (= temp_8_0~1481@ (Mul (Add (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) c8~70@) (Mul (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1534@ (Mul (Add (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) c8~70@) (Mul (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1481@ temp_8_1~1534@))) (=> (= temp_8_0~1481@ temp_8_1~1534@) (=> (= temp_9_0~1595@ (Mul d9~80@ (Mul (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ d9~80@)) (Mul (Sub a9~74@ a9~74@) (Mul a9~74@ d9~80@))))) (=> (= temp_9_1~1632@ (Mul d9~80@ (Mul (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ d9~80@)) (Mul (Mul (Sub a9~74@ a9~74@) a9~74@) d9~80@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1595@ temp_9_1~1632@))) (=> (= temp_9_0~1595@ temp_9_1~1632@) (=> (= temp_10_0~1717@ (Mul (Sub (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul b10~84@ d10~88@)) (Mul b10~84@ (Mul a10~82@ d10~88@))))) (=> (= temp_10_1~1778@ (Mul (Mul (Sub (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ c10~86@))) (Mul (Mul a10~82@ a10~82@) (Mul b10~84@ d10~88@))) (Mul b10~84@ (Mul a10~82@ d10~88@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1717@ temp_10_1~1778@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
