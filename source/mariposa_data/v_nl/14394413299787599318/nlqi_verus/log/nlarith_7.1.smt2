...
(declare-const temp_3_1~1005@ Int)
(declare-const temp_4_0~1145@ Int)
(declare-const temp_4_1~1270@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~217@ (Mul d0~8@ (Mul (Mul (Mul c0~6@ (Mul c0~6@ d0~8@)) (Mul (Sub b0~4@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@)) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~274@ (Mul d0~8@ (Mul (Mul c0~6@ (Mul c0~6@ d0~8@)) (Mul (Mul (Sub b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@)) (Mul d0~8@ c0~6@)))))) (=> (= tmp%1@ (= temp_0_0~217@ temp_0_1~274@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~414@ (Mul (Mul (Add (Mul (Mul a1~10@ b1~12@) (Add d1~16@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@))) (Mul (Mul (Add b1~12@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ c1~14@)))) (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ b1~12@))) (Sub (Mul (Mul b1~12@ b1~12@) (Add b1~12@ b1~12@)) (Mul (Add a1~10@ c1~14@) b1~12@))))) (=> (= temp_1_1~539@ (Mul (Mul (Add (Mul (Mul a1~10@ b1~12@) (Add d1~16@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@))) (Mul (Mul (Add b1~12@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul (Mul a1~10@ c1~14@) b1~12@) c1~14@))) (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ b1~12@))) (Sub (Mul (Mul b1~12@ b1~12@) (Add b1~12@ b1~12@)) (Mul (Add a1~10@ c1~14@) b1~12@))))) (=> (= tmp%2@ (= temp_1_0~414@ temp_1_1~539@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~687@ (Add (Mul (Sub (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ b2~20@)) (Add d2~24@ (Mul c2~22@ c2~22@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ a2~18@)))) (Mul (Mul (Sub (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ b2~20@))) (Add (Mul b2~20@ (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ 0) (Mul a2~18@ a2~18@)))))) (=> (= temp_2_1~820@ (Add (Mul (Sub (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ b2~20@)) (Add d2~24@ (Mul c2~22@ c2~22@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ a2~18@)))) (Mul (Mul (Sub (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@))) (Add (Mul b2~20@ (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ 0) (Mul a2~18@ a2~18@)))))) (=> (= tmp%3@ (= temp_2_0~687@ temp_2_1~820@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~920@ (Add (Mul d3~32@ (Mul (Sub (Mul c3~30@ c3~30@) d3~32@) (Sub (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@)))) (Mul (Mul c3~30@ (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ b3~28@))) (Mul (Sub (Mul d3~32@ a3~26@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@)))))) (=> (= temp_3_1~1005@ (Add (Mul d3~32@ (Mul (Sub (Mul c3~30@ c3~30@) d3~32@) (Sub (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@)))) (Mul (Mul (Mul c3~30@ (Mul b3~28@ a3~26@)) (Mul a3~26@ b3~28@)) (Mul (Sub (Mul d3~32@ a3~26@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@)))))) (=> (= tmp%4@ (= temp_3_0~920@ temp_3_1~1005@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1145@ (Mul (Mul (Add (Sub (Mul a4~34@ a4~34@) (Mul b4~36@ d4~40@)) (Add (Mul b4~36@ c4~38@) (Mul b4~36@ a4~34@))) (Sub (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@)) (Sub (Add c4~38@ a4~34@) (Mul d4~40@ a4~34@)))) (Mul (Sub (Mul d4~40@ (Mul a4~34@ c4~38@)) (Add (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@))) (Mul (Mul (Add d4~40@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Add c4~38@ c4~38@) (Mul c4~38@ c4~38@)))))) (=> (= temp_4_1~1270@ (Mul (Mul (Add (Sub (Mul a4~34@ a4~34@) (Mul b4~36@ d4~40@)) (Add (Mul b4~36@ c4~38@) (Mul b4~36@ a4~34@))) (Sub (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@)) (Sub (Add c4~38@ a4~34@) (Mul d4~40@ a4~34@)))) (Mul (Mul (Mul (Add d4~40@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Add c4~38@ c4~38@) (Mul c4~38@ c4~38@))) (Sub (Mul d4~40@ (Mul a4~34@ c4~38@)) (Add (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@)))))) (=> (= tmp%5@ (= temp_4_0~1145@ temp_4_1~1270@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1446@ (Mul (Mul (Mul (Sub (Mul c5~46@ c5~46@) (Mul 75 a5~42@)) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@))) (Mul (Mul (Sub a5~42@ b5~44@) b5~44@) (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)))) (Mul (Sub (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ 0)) (Mul (Mul 86 a5~42@) (Mul d5~48@ a5~42@))) (Mul (Sub (Mul a5~42@ b5~44@) (Sub b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Add b5~44@ c5~46@)))))) (=> (= temp_5_1~1607@ (Mul (Mul (Mul (Sub (Mul c5~46@ c5~46@) (Mul 75 a5~42@)) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@))) (Mul (Mul (Sub a5~42@ b5~44@) b5~44@) (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)))) (Mul (Sub (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ 0)) (Mul (Mul 86 a5~42@) (Mul d5~48@ a5~42@))) (Mul (Sub (Mul a5~42@ b5~44@) (Sub b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Add b5~44@ c5~46@)))))) (=> (= tmp%6@ (= temp_5_0~1446@ temp_5_1~1607@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1707@ (Add (Mul (Mul (Mul b6~52@ (Mul c6~54@ b6~52@)) (Mul (Add c6~54@ b6~52@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ c6~54@)) d6~56@)) (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ c6~54@)) (Add (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@))) d6~56@))) (=> (= temp_6_1~1792@ (Add (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ c6~54@)) d6~56@) (Mul (Mul b6~52@ (Mul c6~54@ b6~52@)) (Mul (Add c6~54@ b6~52@) (Mul c6~54@ b6~52@)))) (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ c6~54@)) (Add (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@))) d6~56@))) (=> (= tmp%7@ (= temp_6_0~1707@ temp_6_1~1792@)) (=> %%location_label%%6 tmp%7@)))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
