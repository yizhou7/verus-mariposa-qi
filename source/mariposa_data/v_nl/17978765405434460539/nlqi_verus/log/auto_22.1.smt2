...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Sub b0~4@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Add (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Add c0~6@ c0~6@))))) (=> (= temp_0_1~370@ (Sub (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Sub b0~4@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Add (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Add c0~6@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~483@ (Add (Mul (Mul (Sub d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Add c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (Sub (Sub (Mul b1~12@ b1~12@) (Sub d1~16@ 27)) (Mul (Mul 16 c1~14@) (Mul a1~10@ d1~16@))))) (=> (= temp_1_1~580@ (Add (Mul (Mul (Sub d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Add (Mul c1~14@ (Mul d1~16@ b1~12@)) (Mul a1~10@ (Mul d1~16@ b1~12@)))) (Sub (Sub (Mul b1~12@ b1~12@) (Sub d1~16@ 27)) (Mul (Mul 16 c1~14@) (Mul a1~10@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~483@ temp_1_1~580@))) (=> (= temp_1_0~483@ temp_1_1~580@) (=> (= temp_2_0~681@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Add (Sub a2~18@ c2~22@) (Mul d2~24@ 3)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~758@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul (Mul d2~24@ d2~24@) b2~20@) c2~22@)) (Mul (Add (Sub a2~18@ c2~22@) (Mul d2~24@ 3)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~681@ temp_2_1~758@))) (=> (= temp_2_0~681@ temp_2_1~758@) (=> (= temp_3_0~847@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Add d3~32@ a3~26@))) (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~912@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)) (Mul c3~30@ (Mul a3~26@ (Add d3~32@ a3~26@)))) (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~847@ temp_3_1~912@))) (=> (= temp_3_0~847@ temp_3_1~912@) (=> (= temp_4_0~997@ (Mul (Mul (Mul (Add b4~36@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Sub d4~40@ (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~1058@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Add b4~36@ a4~34@) (Mul d4~40@ a4~34@))) (Mul (Sub d4~40@ (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~997@ temp_4_1~1058@))) (=> (= temp_4_0~997@ temp_4_1~1058@) (=> (= temp_5_0~1131@ (Sub (Mul (Mul d5~48@ (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ d5~48@))) (Mul d5~48@ (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ d5~48@))))) (=> (= temp_5_1~1180@ (Sub (Mul (Mul (Mul d5~48@ d5~48@) a5~42@) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ d5~48@))) (Mul d5~48@ (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1131@ temp_5_1~1180@))) (=> (= temp_5_0~1131@ temp_5_1~1180@) (=> (= temp_6_0~1269@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Add (Mul b6~52@ c6~54@) (Mul c6~54@ c6~54@))) (Mul (Mul (Sub c6~54@ b6~52@) (Mul c6~54@ c6~54@)) (Sub (Mul b6~52@ d6~56@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1342@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Add (Mul b6~52@ c6~54@) (Mul c6~54@ c6~54@))) (Mul (Sub (Mul c6~54@ (Mul c6~54@ c6~54@)) (Mul b6~52@ (Mul c6~54@ c6~54@))) (Sub (Mul b6~52@ d6~56@) (Mul b6~52@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1269@ temp_6_1~1342@))) (=> (= temp_6_0~1269@ temp_6_1~1342@) (=> (= temp_7_0~1427@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Sub d7~64@ b7~60@)) (Mul c7~62@ (Mul a7~58@ a7~58@))) (Mul (Sub (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Add d7~64@ c7~62@) (Sub c7~62@ b7~60@))))) (=> (= temp_7_1~1488@ (Mul (Mul (Mul (Sub d7~64@ b7~60@) (Mul c7~62@ d7~64@)) (Mul c7~62@ (Mul a7~58@ a7~58@))) (Mul (Sub (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Add d7~64@ c7~62@) (Sub c7~62@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1427@ temp_7_1~1488@))) (=> (= temp_7_0~1427@ temp_7_1~1488@) (=> (= temp_8_0~1573@ (Mul (Mul (Mul d8~72@ (Mul c8~70@ b8~68@)) (Mul (Add a8~66@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1634@ (Mul (Mul (Mul d8~72@ (Mul c8~70@ b8~68@)) (Mul (Add a8~66@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul (Mul a8~66@ c8~70@) a8~66@) b8~68@) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1573@ temp_8_1~1634@))) (=> (= temp_8_0~1573@ temp_8_1~1634@) (=> (= temp_9_0~1723@ (Mul (Mul (Mul (Sub c9~78@ c9~78@) (Mul d9~80@ c9~78@)) (Mul d9~80@ d9~80@)) (Mul (Mul (Sub d9~80@ b9~76@) (Mul c9~78@ b9~76@)) (Mul b9~76@ (Add d9~80@ 37))))) (=> (= temp_9_1~1788@ (Mul (Mul (Mul (Sub c9~78@ c9~78@) (Mul d9~80@ c9~78@)) (Mul d9~80@ d9~80@)) (Mul (Mul (Sub d9~80@ b9~76@) (Mul c9~78@ b9~76@)) (Mul b9~76@ (Add d9~80@ 37))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1723@ temp_9_1~1788@))) (=> (= temp_9_0~1723@ temp_9_1~1788@) (=> (= temp_10_0~1861@ (Mul (Mul b10~84@ (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Add (Sub (Mul d10~88@ a10~82@) (Mul d10~88@ a10~82@)) (Sub (Mul c10~86@ b10~84@) c10~86@)))) (=> (= temp_10_1~1910@ (Mul (Mul b10~84@ (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Add (Sub (Mul d10~88@ a10~82@) (Mul a10~82@ d10~88@)) (Sub (Mul c10~86@ b10~84@) c10~86@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1861@ temp_10_1~1910@))) (=> (= temp_10_0~1861@ temp_10_1~1910@) (=> (= temp_11_0~2011@ (Mul (Mul (Add (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul b11~92@ b11~92@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ 25) (Mul a11~90@ b11~92@))))) (=> (= temp_11_1~2088@ (Mul (Mul (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ 25) (Mul a11~90@ b11~92@))) (Mul (Add (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul b11~92@ b11~92@) (Mul c11~94@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2011@ temp_11_1~2088@))) (=> (= temp_11_0~2011@ temp_11_1~2088@) (=> (= temp_12_0~2173@ (Mul (Add (Mul (Sub c12~102@ b12~100@) (Mul c12~102@ d12~104@)) (Sub (Mul d12~104@ b12~100@) (Mul b12~100@ a12~98@))) (Add (Mul (Mul d12~104@ c12~102@) a12~98@) (Sub (Mul b12~100@ b12~100@) (Mul b12~100@ c12~102@))))) (=> (= temp_12_1~2234@ (Mul (Add (Mul (Sub c12~102@ b12~100@) (Mul c12~102@ d12~104@)) (Sub (Mul d12~104@ b12~100@) (Mul a12~98@ b12~100@))) (Add (Mul (Mul d12~104@ c12~102@) a12~98@) (Sub (Mul b12~100@ b12~100@) (Mul b12~100@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2173@ temp_12_1~2234@))) (=> (= temp_12_0~2173@ temp_12_1~2234@) (=> (= temp_13_0~2307@ (Mul (Mul (Mul c13~110@ (Mul d13~112@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ c13~110@))) (Add d13~112@ (Add (Sub c13~110@ c13~110@) (Mul b13~108@ c13~110@))))) (=> (= temp_13_1~2356@ (Mul (Add d13~112@ (Add (Sub c13~110@ c13~110@) (Mul b13~108@ c13~110@))) (Mul (Mul c13~110@ (Mul d13~112@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2307@ temp_13_1~2356@))) (=> (= temp_13_0~2307@ temp_13_1~2356@) (=> (= temp_14_0~2441@ (Sub (Mul (Sub (Mul b14~116@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Mul c14~118@ d14~120@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul c14~118@ d14~120@)) (Mul b14~116@ (Mul a14~114@ d14~120@))))) (=> (= temp_14_1~2498@ (Sub (Mul (Mul (Sub b14~116@ c14~118@) b14~116@) (Mul (Mul a14~114@ b14~116@) (Mul c14~118@ d14~120@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul c14~118@ d14~120@)) (Mul b14~116@ (Mul a14~114@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2441@ temp_14_1~2498@))) (=> (= temp_14_0~2441@ temp_14_1~2498@) (=> (= temp_15_0~2583@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ a15~122@) d15~128@)) (Mul (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2644@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ a15~122@) d15~128@)) (Mul (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2583@ temp_15_1~2644@))) (=> (= temp_15_0~2583@ temp_15_1~2644@) (=> (= temp_16_0~2741@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ 41)) (Mul a16~130@ (Add d16~136@ b16~132@))) (Mul (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Sub a16~130@ d16~136@) (Sub a16~130@ c16~134@))))) (=> (= temp_16_1~2814@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ 41)) (Mul a16~130@ (Add d16~136@ b16~132@))) (Mul (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Sub a16~130@ c16~134@) (Sub a16~130@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2741@ temp_16_1~2814@))) (=> (= temp_16_0~2741@ temp_16_1~2814@) (=> (= temp_17_0~2899@ (Mul (Mul a17~138@ (Mul (Sub d17~144@ d17~144@) (Mul b17~140@ a17~138@))) (Mul (Sub (Mul c17~142@ d17~144@) c17~142@) (Mul (Mul b17~140@ d17~144@) (Mul 30 d17~144@))))) (=> (= temp_17_1~2960@ (Mul (Mul a17~138@ (Mul (Sub d17~144@ d17~144@) (Mul a17~138@ b17~140@))) (Mul (Sub (Mul c17~142@ d17~144@) c17~142@) (Mul (Mul b17~140@ d17~144@) (Mul 30 d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2899@ temp_17_1~2960@))) (=> (= temp_17_0~2899@ temp_17_1~2960@) (=> (= temp_18_0~3037@ (Sub (Mul (Add (Mul a18~146@ d18~152@) (Mul b18~148@ d18~152@)) d18~152@) (Mul (Mul (Mul c18~150@ a18~146@) (Sub c18~150@ d18~152@)) (Mul (Sub a18~146@ b18~148@) (Mul b18~148@ d18~152@))))) (=> (= temp_18_1~3090@ (Sub (Mul (Add (Mul a18~146@ d18~152@) (Mul d18~152@ b18~148@)) d18~152@) (Mul (Mul (Mul c18~150@ a18~146@) (Sub c18~150@ d18~152@)) (Mul (Sub a18~146@ b18~148@) (Mul b18~148@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3037@ temp_18_1~3090@))) (=> (= temp_18_0~3037@ temp_18_1~3090@) (=> (= temp_19_0~3179@ (Mul (Mul (Mul (Sub d19~160@ b19~156@) (Mul d19~160@ d19~160@)) (Mul (Mul d19~160@ b19~156@) (Sub b19~156@ c19~158@))) (Mul (Mul (Mul a19~154@ c19~158@) (Mul a19~154@ a19~154@)) (Sub (Mul b19~156@ d19~160@) (Mul a19~154@ a19~154@))))) (=> (= temp_19_1~3244@ (Mul (Mul (Mul (Sub d19~160@ b19~156@) (Mul d19~160@ d19~160@)) (Mul (Mul d19~160@ b19~156@) (Sub b19~156@ c19~158@))) (Mul (Mul (Mul a19~154@ c19~158@) (Mul a19~154@ a19~154@)) (Sub (Mul b19~156@ d19~160@) (Mul a19~154@ a19~154@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3179@ temp_19_1~3244@))) (=> (= temp_19_0~3179@ temp_19_1~3244@) (=> (= temp_20_0~3321@ (Mul (Mul (Add (Mul a20~162@ d20~168@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ d20~168@))) (Mul a20~162@ (Mul (Mul a20~162@ b20~164@) (Mul a20~162@ d20~168@))))) (=> (= temp_20_1~3374@ (Mul (Mul (Mul (Add (Mul a20~162@ d20~168@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ d20~168@))) a20~162@) (Mul (Mul a20~162@ b20~164@) (Mul a20~162@ d20~168@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3321@ temp_20_1~3374@))) (=> (= temp_20_0~3321@ temp_20_1~3374@) (=> (= temp_21_0~3451@ (Mul (Mul (Mul (Mul c21~174@ c21~174@) (Mul b21~172@ a21~170@)) d21~176@) (Add (Mul (Mul d21~176@ d21~176@) (Add b21~172@ c21~174@)) (Mul (Mul c21~174@ d21~176@) (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~3504@ (Mul (Mul (Mul (Mul c21~174@ c21~174@) (Mul b21~172@ a21~170@)) d21~176@) (Add (Mul d21~176@ (Mul d21~176@ (Add b21~172@ c21~174@))) (Mul (Mul c21~174@ d21~176@) (Mul a21~170@ b21~172@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3451@ temp_21_1~3504@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
