...
(declare-const temp_1_0~495@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Sub b0~4@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Add (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Add c0~6@ c0~6@))))) (=> (= temp_0_1~370@ (Sub (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Sub b0~4@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Add (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Add c0~6@ c0~6@))))) (and (=> (= tmp%1@ (Mul c0~6@ a0~2@)) (=> (= tmp%2@ (Mul c0~6@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~495@ (Add (Mul (Mul (Sub d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Add c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (Sub (Sub (Mul b1~12@ b1~12@) (Sub d1~16@ 27)) (Mul (Mul 16 c1~14@) (Mul a1~10@ d1~16@))))) (=> (= temp_1_1~592@ (Add (Mul (Mul (Sub d1~16@ c1~14@) (Mul d1~16@ c1~14@)) (Add (Mul c1~14@ (Mul d1~16@ b1~12@)) (Mul a1~10@ (Mul d1~16@ b1~12@)))) (Sub (Sub (Mul b1~12@ b1~12@) (Sub d1~16@ 27)) (Mul (Mul 16 c1~14@) (Mul a1~10@ d1~16@))))) (and (=> (= tmp%3@ (Mul d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c1~14@ a1~10@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~495@ temp_1_1~592@)))) (=> (= temp_1_0~495@ temp_1_1~592@) (=> (= temp_2_0~703@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Add (Sub a2~18@ c2~22@) (Mul d2~24@ 3)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~780@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul (Mul d2~24@ d2~24@) b2~20@) c2~22@)) (Mul (Add (Sub a2~18@ c2~22@) (Mul d2~24@ 3)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@))))) (and (=> (= tmp%4@ (Mul d2~24@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ b2~20@ c2~22@) (=> %%location_label%%2 (= temp_2_0~703@ temp_2_1~780@)))) (=> (= temp_2_0~703@ temp_2_1~780@) (=> (= temp_3_0~879@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Add d3~32@ a3~26@))) (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~944@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)) (Mul c3~30@ (Mul a3~26@ (Add d3~32@ a3~26@)))) (Mul (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ d3~32@))))) (and (=> (= tmp%5@ (Add d3~32@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c3~30@ a3~26@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~879@ temp_3_1~944@)))) (=> (= temp_3_0~879@ temp_3_1~944@) (=> (= temp_4_0~1039@ (Mul (Mul (Mul (Add b4~36@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Sub d4~40@ (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~1100@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Add b4~36@ a4~34@) (Mul d4~40@ a4~34@))) (Mul (Sub d4~40@ (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ b4~36@))))) (and (=> (= tmp%6@ (Mul (Add b4~36@ a4~34@) (Mul d4~40@ a4~34@))) (=> (= tmp%7@ (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ c4~38@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%4 (= temp_4_0~1039@ temp_4_1~1100@))))) (=> (= temp_4_0~1039@ temp_4_1~1100@) (=> (= temp_5_0~1201@ (Sub (Mul (Mul d5~48@ (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ d5~48@))) (Mul d5~48@ (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ d5~48@))))) (=> (= temp_5_1~1250@ (Sub (Mul (Mul (Mul d5~48@ d5~48@) a5~42@) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ d5~48@))) (Mul d5~48@ (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. d5~48@ d5~48@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1201@ temp_5_1~1250@))) (=> (= temp_5_0~1201@ temp_5_1~1250@) (=> (= temp_6_0~1345@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Add (Mul b6~52@ c6~54@) (Mul c6~54@ c6~54@))) (Mul (Mul (Sub c6~54@ b6~52@) (Mul c6~54@ c6~54@)) (Sub (Mul b6~52@ d6~56@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1418@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Add (Mul b6~52@ c6~54@) (Mul c6~54@ c6~54@))) (Mul (Sub (Mul c6~54@ (Mul c6~54@ c6~54@)) (Mul b6~52@ (Mul c6~54@ c6~54@))) (Sub (Mul b6~52@ d6~56@) (Mul b6~52@ c6~54@))))) (and (=> (= tmp%8@ (Mul c6~54@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c6~54@ b6~52@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~1345@ temp_6_1~1418@)))) (=> (= temp_6_0~1345@ temp_6_1~1418@) (=> (= temp_7_0~1513@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Sub d7~64@ b7~60@)) (Mul c7~62@ (Mul a7~58@ a7~58@))) (Mul (Sub (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Add d7~64@ c7~62@) (Sub c7~62@ b7~60@))))) (=> (= temp_7_1~1574@ (Mul (Mul (Mul (Sub d7~64@ b7~60@) (Mul c7~62@ d7~64@)) (Mul c7~62@ (Mul a7~58@ a7~58@))) (Mul (Sub (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Add d7~64@ c7~62@) (Sub c7~62@ b7~60@))))) (and (=> (= tmp%9@ (Mul c7~62@ d7~64@)) (=> (= tmp%10@ (Sub d7~64@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~1513@ temp_7_1~1574@))))) (=> (= temp_7_0~1513@ temp_7_1~1574@) (=> (= temp_8_0~1671@ (Mul (Mul (Mul d8~72@ (Mul c8~70@ b8~68@)) (Mul (Add a8~66@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1732@ (Mul (Mul (Mul d8~72@ (Mul c8~70@ b8~68@)) (Mul (Add a8~66@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul (Mul a8~66@ c8~70@) a8~66@) b8~68@) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@))))) (and (=> (= tmp%11@ (Mul a8~66@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ a8~66@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1671@ temp_8_1~1732@)))) (=> (= temp_8_0~1671@ temp_8_1~1732@) (=> (= temp_9_0~1831@ (Mul (Mul (Mul (Sub c9~78@ c9~78@) (Mul d9~80@ c9~78@)) (Mul d9~80@ d9~80@)) (Mul (Mul (Sub d9~80@ b9~76@) (Mul c9~78@ b9~76@)) (Mul b9~76@ (Add d9~80@ 37))))) (=> (= temp_9_1~1896@ (Mul (Mul (Mul (Sub c9~78@ c9~78@) (Mul d9~80@ c9~78@)) (Mul d9~80@ d9~80@)) (Mul (Mul (Sub d9~80@ b9~76@) (Mul c9~78@ b9~76@)) (Mul b9~76@ (Add d9~80@ 37))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ d9~80@) (=> %%location_label%%9 (= temp_9_0~1831@ temp_9_1~1896@))) (=> (= temp_9_0~1831@ temp_9_1~1896@) (=> (= temp_10_0~1973@ (Mul (Mul b10~84@ (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Add (Sub (Mul d10~88@ a10~82@) (Mul d10~88@ a10~82@)) (Sub (Mul c10~86@ b10~84@) c10~86@)))) (=> (= temp_10_1~2022@ (Mul (Mul b10~84@ (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Add (Sub (Mul d10~88@ a10~82@) (Mul a10~82@ d10~88@)) (Sub (Mul c10~86@ b10~84@) c10~86@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d10~88@ a10~82@) (=> %%location_label%%10 (= temp_10_0~1973@ temp_10_1~2022@))) (=> (= temp_10_0~1973@ temp_10_1~2022@) (=> (= temp_11_0~2127@ (Mul (Mul (Add (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul b11~92@ b11~92@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ 25) (Mul a11~90@ b11~92@))))) (=> (= temp_11_1~2204@ (Mul (Mul (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ 25) (Mul a11~90@ b11~92@))) (Mul (Add (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul b11~92@ b11~92@) (Mul c11~94@ b11~92@))))) (and (=> (= tmp%12@ (Mul (Add (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@)) (Mul (Mul b11~92@ b11~92@) (Mul c11~94@ b11~92@)))) (=> (= tmp%13@ (Mul (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ 25) (Mul a11~90@ b11~92@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%11 (= temp_11_0~2127@ temp_11_1~2204@))))) (=> (= temp_11_0~2127@ temp_11_1~2204@) (=> (= temp_12_0~2361@ (Mul (Add (Mul (Sub c12~102@ b12~100@) (Mul c12~102@ d12~104@)) (Sub (Mul d12~104@ b12~100@) (Mul b12~100@ a12~98@))) (Add (Mul (Mul d12~104@ c12~102@) a12~98@) (Sub (Mul b12~100@ b12~100@) (Mul b12~100@ c12~102@))))) (=> (= temp_12_1~2422@ (Mul (Add (Mul (Sub c12~102@ b12~100@) (Mul c12~102@ d12~104@)) (Sub (Mul d12~104@ b12~100@) (Mul a12~98@ b12~100@))) (Add (Mul (Mul d12~104@ c12~102@) a12~98@) (Sub (Mul b12~100@ b12~100@) (Mul b12~100@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2361@ temp_12_1~2422@))) (=> (= temp_12_0~2361@ temp_12_1~2422@) (=> (= temp_13_0~2499@ (Mul (Mul (Mul c13~110@ (Mul d13~112@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ c13~110@))) (Add d13~112@ (Add (Sub c13~110@ c13~110@) (Mul b13~108@ c13~110@))))) (=> (= temp_13_1~2548@ (Mul (Add d13~112@ (Add (Sub c13~110@ c13~110@) (Mul b13~108@ c13~110@))) (Mul (Mul c13~110@ (Mul d13~112@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ c13~110@))))) (and (=> (= tmp%14@ (Mul (Mul c13~110@ (Mul d13~112@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ c13~110@)))) (=> (= tmp%15@ (Add d13~112@ (Add (Sub c13~110@ c13~110@) (Mul b13~108@ c13~110@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%13 (= temp_13_0~2499@ temp_13_1~2548@))))) (=> (= temp_13_0~2499@ temp_13_1~2548@) (=> (= temp_14_0~2677@ (Sub (Mul (Sub (Mul b14~116@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Mul c14~118@ d14~120@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul c14~118@ d14~120@)) (Mul b14~116@ (Mul a14~114@ d14~120@))))) (=> (= temp_14_1~2734@ (Sub (Mul (Mul (Sub b14~116@ c14~118@) b14~116@) (Mul (Mul a14~114@ b14~116@) (Mul c14~118@ d14~120@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul c14~118@ d14~120@)) (Mul b14~116@ (Mul a14~114@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b14~116@ c14~118@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2677@ temp_14_1~2734@))) (=> (= temp_14_0~2677@ temp_14_1~2734@) (=> (= temp_15_0~2825@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ a15~122@) d15~128@)) (Mul (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2886@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ d15~128@)) (Mul (Mul a15~122@ a15~122@) d15~128@)) (Mul (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d15~128@ d15~128@) (=> %%location_label%%15 (= temp_15_0~2825@ temp_15_1~2886@))) (=> (= temp_15_0~2825@ temp_15_1~2886@) (=> (= temp_16_0~2987@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ 41)) (Mul a16~130@ (Add d16~136@ b16~132@))) (Mul (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Sub a16~130@ d16~136@) (Sub a16~130@ c16~134@))))) (=> (= temp_16_1~3060@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ 41)) (Mul a16~130@ (Add d16~136@ b16~132@))) (Mul (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Sub a16~130@ c16~134@) (Sub a16~130@ d16~136@))))) (and (=> (= tmp%16@ (Sub a16~130@ d16~136@)) (=> (= tmp%17@ (Sub a16~130@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%16 (= temp_16_0~2987@ temp_16_1~3060@))))) (=> (= temp_16_0~2987@ temp_16_1~3060@) (=> (= temp_17_0~3157@ (Mul (Mul a17~138@ (Mul (Sub d17~144@ d17~144@) (Mul b17~140@ a17~138@))) (Mul (Sub (Mul c17~142@ d17~144@) c17~142@) (Mul (Mul b17~140@ d17~144@) (Mul 30 d17~144@))))) (=> (= temp_17_1~3218@ (Mul (Mul a17~138@ (Mul (Sub d17~144@ d17~144@) (Mul a17~138@ b17~140@))) (Mul (Sub (Mul c17~142@ d17~144@) c17~142@) (Mul (Mul b17~140@ d17~144@) (Mul 30 d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b17~140@ a17~138@) (=> %%location_label%%17 (= temp_17_0~3157@ temp_17_1~3218@))) (=> (= temp_17_0~3157@ temp_17_1~3218@) (=> (= temp_18_0~3299@ (Sub (Mul (Add (Mul a18~146@ d18~152@) (Mul b18~148@ d18~152@)) d18~152@) (Mul (Mul (Mul c18~150@ a18~146@) (Sub c18~150@ d18~152@)) (Mul (Sub a18~146@ b18~148@) (Mul b18~148@ d18~152@))))) (=> (= temp_18_1~3352@ (Sub (Mul (Add (Mul a18~146@ d18~152@) (Mul d18~152@ b18~148@)) d18~152@) (Mul (Mul (Mul c18~150@ a18~146@) (Sub c18~150@ d18~152@)) (Mul (Sub a18~146@ b18~148@) (Mul b18~148@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b18~148@ d18~152@) (=> %%location_label%%18 (= temp_18_0~3299@ temp_18_1~3352@))) (=> (= temp_18_0~3299@ temp_18_1~3352@) (=> (= temp_19_0~3445@ (Mul (Mul (Mul (Sub d19~160@ b19~156@) (Mul d19~160@ d19~160@)) (Mul (Mul d19~160@ b19~156@) (Sub b19~156@ c19~158@))) (Mul (Mul (Mul a19~154@ c19~158@) (Mul a19~154@ a19~154@)) (Sub (Mul b19~156@ d19~160@) (Mul a19~154@ a19~154@))))) (=> (= temp_19_1~3510@ (Mul (Mul (Mul (Sub d19~160@ b19~156@) (Mul d19~160@ d19~160@)) (Mul (Mul d19~160@ b19~156@) (Sub b19~156@ c19~158@))) (Mul (Mul (Mul a19~154@ c19~158@) (Mul a19~154@ a19~154@)) (Sub (Mul b19~156@ d19~160@) (Mul a19~154@ a19~154@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a19~154@ a19~154@) (=> %%location_label%%19 (= temp_19_0~3445@ temp_19_1~3510@))) (=> (= temp_19_0~3445@ temp_19_1~3510@) (=> (= temp_20_0~3591@ (Mul (Mul (Add (Mul a20~162@ d20~168@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ d20~168@))) (Mul a20~162@ (Mul (Mul a20~162@ b20~164@) (Mul a20~162@ d20~168@))))) (=> (= temp_20_1~3644@ (Mul (Mul (Mul (Add (Mul a20~162@ d20~168@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ d20~168@))) a20~162@) (Mul (Mul a20~162@ b20~164@) (Mul a20~162@ d20~168@)))) (and (=> (= tmp%18@ (Mul (Add (Mul a20~162@ d20~168@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ d20~168@)))) (=> (= tmp%19@ (Mul (Mul a20~162@ b20~164@) (Mul a20~162@ d20~168@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ a20~162@ tmp%19@) (=> %%location_label%%20 (= temp_20_0~3591@ temp_20_1~3644@))))) (=> (= temp_20_0~3591@ temp_20_1~3644@) (=> (= temp_21_0~3767@ (Mul (Mul (Mul (Mul c21~174@ c21~174@) (Mul b21~172@ a21~170@)) d21~176@) (Add (Mul (Mul d21~176@ d21~176@) (Add b21~172@ c21~174@)) (Mul (Mul c21~174@ d21~176@) (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~3820@ (Mul (Mul (Mul (Mul c21~174@ c21~174@) (Mul b21~172@ a21~170@)) d21~176@) (Add (Mul d21~176@ (Mul d21~176@ (Add b21~172@ c21~174@))) (Mul (Mul c21~174@ d21~176@) (Mul a21~170@ b21~172@))))) (=> (= tmp%20@ (Add b21~172@ c21~174@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d21~176@ d21~176@ tmp%20@) (=> %%location_label%%21 (= temp_21_0~3767@ temp_21_1~3820@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
