...
(set-info :comment ";; mariposa_data/v_nl//3892246039421652627/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_6_0~1371@ Int)
(declare-const temp_6_1~1496@ Int)
(declare-const temp_7_0~1675@ Int)
...
(declare-const temp_9_1~2050@ Int)
(declare-const temp_10_0~2143@ Int)
(declare-const temp_10_1~2208@ Int)
(declare-const temp_11_0~2315@ Int)
(declare-const temp_11_1~2372@ Int)
...
(declare-const temp_14_1~2800@ Int)
(declare-const temp_15_0~2895@ Int)
(declare-const temp_15_1~2956@ Int)
(declare-const temp_16_0~3051@ Int)
(declare-const temp_16_1~3112@ Int)
(declare-const temp_17_0~3201@ Int)
(declare-const temp_17_1~3262@ Int)
(declare-const temp_18_0~3371@ Int)
(declare-const temp_18_1~3448@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Add (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Add c0~6@ b0~4@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Sub a0~2@ b0~4@) d0~8@)))) (=> (= temp_0_1~362@ (Add (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Add c0~6@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Sub a0~2@ b0~4@) d0~8@)))) (and (=> (= tmp%1@ (Mul d0~8@ d0~8@)) (=> (= tmp%2@ (Add c0~6@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~463@ (Mul (Mul (Add (Mul d1~16@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Add a1~10@ d1~16@) (Mul a1~10@ b1~12@))))) (=> (= temp_1_1~528@ (Mul (Mul (Add (Mul a1~10@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Add a1~10@ d1~16@) (Mul a1~10@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ a1~10@) (=> %%location_label%%1 (= temp_1_0~463@ temp_1_1~528@))) (=> (= temp_1_0~463@ temp_1_1~528@) (=> (= temp_2_0~621@ (Add (Mul (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Mul a2~18@ b2~20@) (Sub c2~22@ a2~18@))) (Mul (Mul (Mul b2~20@ d2~24@) (Add c2~22@ c2~22@)) (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~686@ (Add (Mul (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Mul a2~18@ b2~20@) (Sub c2~22@ a2~18@))) (Mul (Mul b2~20@ (Mul d2~24@ (Add c2~22@ c2~22@))) (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@))))) (and (=> (= tmp%3@ (Add c2~22@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b2~20@ d2~24@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~621@ temp_2_1~686@)))) (=> (= temp_2_0~621@ temp_2_1~686@) (=> (= temp_3_0~809@ (Mul (Mul (Sub (Mul d3~32@ d3~32@) (Mul 25 a3~26@)) (Mul (Sub d3~32@ a3~26@) (Mul a3~26@ c3~30@))) (Add (Mul (Mul 27 d3~32@) (Mul b3~28@ d3~32@)) (Sub (Add b3~28@ a3~26@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~906@ (Mul (Mul (Sub (Mul d3~32@ d3~32@) (Mul 25 a3~26@)) (Sub (Mul d3~32@ (Mul a3~26@ c3~30@)) (Mul a3~26@ (Mul a3~26@ c3~30@)))) (Add (Mul (Mul 27 d3~32@) (Mul b3~28@ d3~32@)) (Sub (Add b3~28@ a3~26@) (Mul d3~32@ c3~30@))))) (and (=> (= tmp%4@ (Mul a3~26@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d3~32@ a3~26@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~809@ temp_3_1~906@)))) (=> (= temp_3_0~809@ temp_3_1~906@) (=> (= temp_4_0~1017@ (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Add d4~40@ 45)) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ c4~38@))) (Mul (Mul (Sub d4~40@ b4~36@) (Mul c4~38@ b4~36@)) (Sub (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~1090@ (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Add d4~40@ 45)) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ c4~38@))) (Mul (Mul (Sub d4~40@ b4~36@) (Mul c4~38@ b4~36@)) (Mul a4~34@ (Sub a4~34@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. a4~34@ a4~34@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1017@ temp_4_1~1090@))) (=> (= temp_4_0~1017@ temp_4_1~1090@) (=> (= temp_5_0~1185@ (Mul (Add (Mul (Mul c5~46@ c5~46@) (Add a5~42@ a5~42@)) (Mul (Add b5~44@ b5~44@) (Mul a5~42@ c5~46@))) (Mul (Mul (Add a5~42@ c5~46@) (Add b5~44@ b5~44@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1250@ (Mul (Add (Mul (Mul c5~46@ c5~46@) (Add a5~42@ a5~42@)) (Mul (Add b5~44@ b5~44@) (Mul a5~42@ c5~46@))) (Mul (Mul (Add b5~44@ b5~44@) (Add a5~42@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ c5~46@))))) (and (=> (= tmp%5@ (Add a5~42@ c5~46@)) (=> (= tmp%6@ (Add b5~44@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~1185@ temp_5_1~1250@))))) (=> (= temp_5_0~1185@ temp_5_1~1250@) (=> (= temp_6_0~1371@ (Mul (Sub (Mul (Add a6~50@ c6~54@) (Mul b6~52@ b6~52@)) (Add (Mul b6~52@ b6~52@) (Mul 64 d6~56@))) (Mul (Mul a6~50@ (Mul a6~50@ a6~50@)) (Sub (Sub a6~50@ d6~56@) (Mul 33 b6~52@))))) (=> (= temp_6_1~1496@ (Sub (Mul (Mul (Add a6~50@ c6~54@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ (Mul a6~50@ a6~50@)) (Sub (Sub a6~50@ d6~56@) (Mul 33 b6~52@)))) (Mul (Add (Mul b6~52@ b6~52@) (Mul 64 d6~56@)) (Mul (Mul a6~50@ (Mul a6~50@ a6~50@)) (Sub (Sub a6~50@ d6~56@) (Mul 33 b6~52@)))))) (and (=> (= tmp%7@ (Mul (Add a6~50@ c6~54@) (Mul b6~52@ b6~52@))) (=> (= tmp%8@ (Add (Mul b6~52@ b6~52@) (Mul 64 d6~56@))) (=> (= tmp%9@ (Mul (Mul a6~50@ (Mul a6~50@ a6~50@)) (Sub (Sub a6~50@ d6~56@) (Mul 33 b6~52@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%6 (= temp_6_0~1371@ temp_6_1~1496@)))))) (=> (= temp_6_0~1371@ temp_6_1~1496@) (=> (= temp_7_0~1675@ (Mul (Mul (Mul (Sub d7~64@ b7~60@) (Add c7~62@ b7~60@)) (Mul (Mul c7~62@ b7~60@) (Sub c7~62@ d7~64@))) (Mul (Add (Mul d7~64@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Mul a7~58@ 27) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1752@ (Mul (Mul (Mul (Sub d7~64@ b7~60@) (Add c7~62@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Sub c7~62@ d7~64@))) (Mul (Add (Mul d7~64@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Mul a7~58@ 27) (Mul a7~58@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1675@ temp_7_1~1752@))) (=> (= temp_7_0~1675@ temp_7_1~1752@) (=> (= temp_8_0~1845@ (Sub (Add (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ c8~70@)) (Mul (Sub c8~70@ c8~70@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1910@ (Sub (Add (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ c8~70@)) (Mul (Mul (Sub c8~70@ c8~70@) b8~68@) c8~70@)) (Mul (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ d8~72@))))) (and (=> (= tmp%10@ (Sub c8~70@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ b8~68@ c8~70@) (=> %%location_label%%8 (= temp_8_0~1845@ temp_8_1~1910@)))) (=> (= temp_8_0~1845@ temp_8_1~1910@) (=> (= temp_9_0~1997@ (Mul (Mul (Mul b9~76@ (Mul c9~78@ a9~74@)) (Sub d9~80@ (Mul a9~74@ b9~76@))) (Mul (Mul b9~76@ (Sub c9~78@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~2050@ (Mul (Mul (Mul b9~76@ (Mul c9~78@ a9~74@)) (Sub d9~80@ (Mul a9~74@ b9~76@))) (Mul (Mul b9~76@ (Sub c9~78@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c9~78@ c9~78@) (=> %%location_label%%9 (= temp_9_0~1997@ temp_9_1~2050@))) (=> (= temp_9_0~1997@ temp_9_1~2050@) (=> (= temp_10_0~2143@ (Add (Mul (Mul (Add a10~82@ b10~84@) (Mul b10~84@ b10~84@)) (Mul (Mul a10~82@ b10~84@) (Mul b10~84@ a10~82@))) (Mul (Mul (Mul d10~88@ b10~84@) (Mul b10~84@ d10~88@)) (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ d10~88@))))) (=> (= temp_10_1~2208@ (Add (Mul (Mul (Add a10~82@ b10~84@) (Mul b10~84@ b10~84@)) (Mul (Mul a10~82@ b10~84@) (Mul b10~84@ a10~82@))) (Mul (Mul d10~88@ b10~84@) (Mul (Mul b10~84@ d10~88@) (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ d10~88@)))))) (and (=> (= tmp%11@ (Mul d10~88@ b10~84@)) (=> (= tmp%12@ (Mul b10~84@ d10~88@)) (=> (= tmp%13@ (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ d10~88@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%10 (= temp_10_0~2143@ temp_10_1~2208@)))))) (=> (= temp_10_0~2143@ temp_10_1~2208@) (=> (= temp_11_0~2315@ (Sub (Sub (Mul (Mul d11~96@ d11~96@) c11~94@) (Mul (Mul c11~94@ b11~92@) d11~96@)) (Sub (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ c11~94@)) (Sub (Sub a11~90@ c11~94@) (Add b11~92@ a11~90@))))) (=> (= temp_11_1~2372@ (Sub (Sub (Mul (Mul d11~96@ d11~96@) c11~94@) (Mul (Mul c11~94@ b11~92@) d11~96@)) (Sub (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ c11~94@)) (Sub (Sub a11~90@ c11~94@) (Add b11~92@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d11~96@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2315@ temp_11_1~2372@))) (=> (= temp_11_0~2315@ temp_11_1~2372@) (=> (= temp_12_0~2457@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ c12~102@))) (Mul (Sub c12~102@ (Mul d12~104@ c12~102@)) (Add (Mul d12~104@ a12~98@) d12~104@)))) (=> (= temp_12_1~2526@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ c12~102@))) (Add (Mul (Sub c12~102@ (Mul d12~104@ c12~102@)) (Mul d12~104@ a12~98@)) (Mul (Sub c12~102@ (Mul d12~104@ c12~102@)) d12~104@)))) (and (=> (= tmp%14@ (Sub c12~102@ (Mul d12~104@ c12~102@))) (=> (= tmp%15@ (Mul d12~104@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%14@ tmp%15@ d12~104@) (=> %%location_label%%12 (= temp_12_0~2457@ temp_12_1~2526@))))) (=> (= temp_12_0~2457@ temp_12_1~2526@) (=> (= temp_13_0~2605@ (Mul b13~108@ (Mul (Mul (Add b13~108@ c13~110@) (Add b13~108@ b13~108@)) (Mul (Sub a13~106@ d13~112@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2642@ (Mul b13~108@ (Mul (Mul (Add b13~108@ c13~110@) (Add b13~108@ b13~108@)) (Mul (Sub a13~106@ d13~112@) (Mul d13~112@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c13~110@ d13~112@) (=> %%location_label%%13 (= temp_13_0~2605@ temp_13_1~2642@))) (=> (= temp_13_0~2605@ temp_13_1~2642@) (=> (= temp_14_0~2731@ (Sub (Sub (Mul (Mul b14~116@ b14~116@) a14~114@) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@))) (Mul (Mul (Sub d14~120@ d14~120@) (Sub a14~114@ a14~114@)) (Mul (Mul a14~114@ b14~116@) (Add a14~114@ b14~116@))))) (=> (= temp_14_1~2800@ (Sub (Sub (Mul (Mul b14~116@ b14~116@) a14~114@) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@))) (Mul (Mul (Sub d14~120@ d14~120@) (Sub a14~114@ a14~114@)) (Add (Mul (Mul a14~114@ b14~116@) a14~114@) (Mul (Mul a14~114@ b14~116@) b14~116@))))) (and (=> (= tmp%16@ (Mul a14~114@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%16@ a14~114@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2731@ temp_14_1~2800@)))) (=> (= temp_14_0~2731@ temp_14_1~2800@) (=> (= temp_15_0~2895@ (Mul (Mul (Mul (Add d15~128@ b15~124@) (Add b15~124@ c15~126@)) (Mul d15~128@ (Mul b15~124@ b15~124@))) (Mul (Mul (Mul c15~126@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Mul a15~122@ c15~126@) (Mul c15~126@ d15~128@))))) (=> (= temp_15_1~2956@ (Mul (Mul (Mul (Add d15~128@ b15~124@) (Add b15~124@ c15~126@)) (Mul d15~128@ (Mul b15~124@ b15~124@))) (Mul (Mul (Mul (Mul c15~126@ b15~124@) d15~128@) b15~124@) (Mul (Mul a15~122@ c15~126@) (Mul c15~126@ d15~128@))))) (and (=> (= tmp%17@ (Mul c15~126@ b15~124@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ d15~128@ b15~124@) (=> %%location_label%%15 (= temp_15_0~2895@ temp_15_1~2956@)))) (=> (= temp_15_0~2895@ temp_15_1~2956@) (=> (= temp_16_0~3051@ (Mul (Add (Mul (Mul c16~134@ a16~130@) (Mul d16~136@ a16~130@)) (Mul b16~132@ (Mul d16~136@ b16~132@))) (Add (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ a16~130@)) (Sub (Mul d16~136@ b16~132@) (Mul b16~132@ c16~134@))))) (=> (= temp_16_1~3112@ (Mul (Add (Mul (Mul a16~130@ c16~134@) (Mul d16~136@ a16~130@)) (Mul b16~132@ (Mul d16~136@ b16~132@))) (Add (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ a16~130@)) (Sub (Mul d16~136@ b16~132@) (Mul b16~132@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c16~134@ a16~130@) (=> %%location_label%%16 (= temp_16_0~3051@ temp_16_1~3112@))) (=> (= temp_16_0~3051@ temp_16_1~3112@) (=> (= temp_17_0~3201@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Sub c17~142@ b17~140@)) (Mul (Mul a17~138@ c17~142@) (Mul c17~142@ c17~142@))) (Mul (Mul a17~138@ (Sub a17~138@ b17~140@)) (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ d17~144@))))) (=> (= temp_17_1~3262@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Sub c17~142@ b17~140@)) (Mul (Mul a17~138@ c17~142@) (Mul c17~142@ c17~142@))) (Mul (Mul (Sub a17~138@ b17~140@) a17~138@) (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ d17~144@))))) (and (=> (= tmp%18@ (Sub a17~138@ b17~140@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a17~138@ tmp%18@) (=> %%location_label%%17 (= temp_17_0~3201@ temp_17_1~3262@)))) (=> (= temp_17_0~3201@ temp_17_1~3262@) (=> (= temp_18_0~3371@ (Mul (Mul (Mul (Mul 8 d18~152@) (Mul b18~148@ d18~152@)) (Mul (Add b18~148@ c18~150@) (Mul c18~150@ b18~148@))) (Mul (Mul (Mul b18~148@ b18~148@) (Mul b18~148@ d18~152@)) (Sub (Mul d18~152@ c18~150@) (Sub b18~148@ c18~150@))))) (=> (= temp_18_1~3448@ (Mul (Mul (Mul (Mul b18~148@ b18~148@) (Mul b18~148@ d18~152@)) (Sub (Mul d18~152@ c18~150@) (Sub b18~148@ c18~150@))) (Mul (Mul (Mul 8 d18~152@) (Mul b18~148@ d18~152@)) (Mul (Add b18~148@ c18~150@) (Mul c18~150@ b18~148@))))) (=> (= tmp%19@ (Mul (Mul (Mul 8 d18~152@) (Mul b18~148@ d18~152@)) (Mul (Add b18~148@ c18~150@) (Mul c18~150@ b18~148@)))) (=> (= tmp%20@ (Mul (Mul (Mul b18~148@ b18~148@) (Mul b18~148@ d18~152@)) (Sub (Mul d18~152@ c18~150@) (Sub b18~148@ c18~150@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%18 (= temp_18_0~3371@ temp_18_1~3448@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
