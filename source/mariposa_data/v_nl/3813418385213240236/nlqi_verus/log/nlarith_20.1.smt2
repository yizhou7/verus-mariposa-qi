...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Add c0~6@ b0~4@))) (Sub (Mul (Mul b0~4@ c0~6@) (Sub d0~8@ d0~8@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~378@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ b0~4@)) (Add (Mul (Mul a0~2@ b0~4@) c0~6@) (Mul (Mul a0~2@ b0~4@) b0~4@))) (Sub (Mul (Mul b0~4@ c0~6@) (Sub d0~8@ d0~8@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~378@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~474@ (Mul (Mul (Sub (Add b1~12@ a1~10@) (Mul c1~14@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul c1~14@ 99) (Mul c1~14@ a1~10@)) (Sub d1~16@ 43)))) (=> (= temp_1_1~555@ (Mul (Mul (Sub (Add b1~12@ a1~10@) (Mul c1~14@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ 99)) (Sub d1~16@ 43)))) (=> (= tmp%2@ (= temp_1_0~474@ temp_1_1~555@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~635@ (Mul (Sub (Sub (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Add (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@))) (Sub (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ b2~20@))))) (=> (= temp_2_1~700@ (Mul (Sub (Sub (Mul d2~24@ d2~24@) (Mul c2~22@ b2~20@)) (Add (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@))) (Sub (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~635@ temp_2_1~700@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~788@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Add c3~30@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) 76) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~861@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Add c3~30@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul b3~28@ d3~32@) 76) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~788@ temp_3_1~861@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~953@ (Mul (Add (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul 59 b4~36@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~1030@ (Mul (Add (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ 59)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~953@ temp_4_1~1030@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1122@ (Mul (Sub (Mul (Mul c5~46@ 36) (Mul c5~46@ b5~44@)) (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ c5~46@))) (Mul (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1199@ (Mul (Sub (Mul (Mul c5~46@ 36) (Mul c5~46@ b5~44@)) (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ c5~46@))) (Mul (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1122@ temp_5_1~1199@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1291@ (Sub (Mul (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@))) (Mul (Add (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ 88) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1368@ (Sub (Mul (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@))) (Mul (Add (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ 88))))) (=> (= tmp%7@ (= temp_6_0~1291@ temp_6_1~1368@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1432@ (Mul (Mul (Mul (Sub c7~62@ a7~58@) (Add a7~58@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ c7~62@))) (Mul a7~58@ (Mul d7~64@ (Mul b7~60@ d7~64@))))) (=> (= temp_7_1~1481@ (Mul (Mul (Mul (Sub c7~62@ a7~58@) (Add a7~58@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ c7~62@))) (Mul a7~58@ (Mul d7~64@ (Mul b7~60@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1432@ temp_7_1~1481@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1561@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ d8~72@))) (Mul (Mul (Add b8~68@ b8~68@) (Sub d8~72@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Sub d8~72@ c8~70@))))) (=> (= temp_8_1~1626@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ d8~72@))) (Mul (Mul (Sub d8~72@ a8~66@) (Add b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Sub d8~72@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1561@ temp_8_1~1626@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1718@ (Mul (Mul (Sub (Sub c9~78@ b9~76@) (Mul c9~78@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ 0)) (Sub (Mul c9~78@ c9~78@) (Mul a9~74@ d9~80@))))) (=> (= temp_9_1~1795@ (Mul (Mul (Sub (Sub c9~78@ b9~76@) (Mul c9~78@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ 0)) (Sub (Mul c9~78@ c9~78@) (Mul a9~74@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1718@ temp_9_1~1795@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1867@ (Add (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ b10~84@) b10~84@)) (Sub (Mul c10~86@ (Mul a10~82@ c10~86@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1924@ (Add (Mul (Mul a10~82@ b10~84@) (Mul (Mul d10~88@ d10~88@) (Mul (Mul b10~84@ b10~84@) b10~84@))) (Sub (Mul c10~86@ (Mul a10~82@ c10~86@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1867@ temp_10_1~1924@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~2008@ (Mul (Mul (Sub (Mul d11~96@ d11~96@) (Mul a11~90@ d11~96@)) (Mul c11~94@ (Mul d11~96@ a11~90@))) (Mul (Mul (Mul 50 a11~90@) (Mul b11~92@ c11~94@)) (Mul (Mul a11~90@ d11~96@) a11~90@)))) (=> (= temp_11_1~2077@ (Mul (Mul (Sub (Mul d11~96@ d11~96@) (Mul a11~90@ d11~96@)) (Mul c11~94@ (Mul d11~96@ a11~90@))) (Mul (Mul (Mul 50 a11~90@) (Mul b11~92@ c11~94@)) (Mul a11~90@ (Mul a11~90@ d11~96@))))) (=> (= tmp%12@ (= temp_11_0~2008@ temp_11_1~2077@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2165@ (Mul (Mul (Mul b12~100@ (Sub b12~100@ d12~104@)) (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@))) (Mul (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ 12)) (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ c12~102@))))) (=> (= temp_12_1~2238@ (Mul (Mul (Mul b12~100@ (Sub b12~100@ d12~104@)) (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@))) (Mul (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ 12)) (Mul (Mul (Mul d12~104@ c12~102@) c12~102@) c12~102@)))) (=> (= tmp%13@ (= temp_12_0~2165@ temp_12_1~2238@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2318@ (Mul (Mul (Mul (Add a13~106@ c13~110@) (Mul d13~112@ a13~106@)) (Mul (Sub a13~106@ c13~110@) (Mul a13~106@ b13~108@))) (Mul (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Sub d13~112@ a13~106@) (Mul a13~106@ d13~112@))))) (=> (= temp_13_1~2383@ (Mul (Mul (Add a13~106@ c13~110@) (Mul d13~112@ a13~106@)) (Mul (Mul (Sub a13~106@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Sub d13~112@ a13~106@) (Mul a13~106@ d13~112@)))))) (=> (= tmp%14@ (= temp_13_0~2318@ temp_13_1~2383@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2463@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul d14~120@ d14~120@) (Mul a14~114@ a14~114@)) (Mul (Add c14~118@ d14~120@) (Mul d14~120@ a14~114@))))) (=> (= temp_14_1~2528@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul (Mul d14~120@ d14~120@) a14~114@) a14~114@) (Mul (Add c14~118@ d14~120@) (Mul d14~120@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2463@ temp_14_1~2528@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2608@ (Sub (Mul (Mul (Mul a15~122@ b15~124@) (Mul c15~126@ a15~122@)) (Mul (Mul d15~128@ c15~126@) (Mul a15~122@ b15~124@))) (Mul (Mul (Mul d15~128@ a15~122@) (Add c15~126@ c15~126@)) (Mul (Mul a15~122@ c15~126@) (Mul a15~122@ c15~126@))))) (=> (= temp_15_1~2673@ (Sub (Mul (Mul (Mul a15~122@ b15~124@) (Mul c15~126@ a15~122@)) (Mul (Mul d15~128@ c15~126@) (Mul a15~122@ b15~124@))) (Mul (Mul (Mul d15~128@ a15~122@) (Add c15~126@ c15~126@)) (Mul (Mul c15~126@ a15~122@) (Mul a15~122@ c15~126@))))) (=> (= tmp%16@ (= temp_15_0~2608@ temp_15_1~2673@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2745@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) (Mul d16~136@ c16~134@)) (Mul (Mul d16~136@ b16~132@) c16~134@)) (Mul (Sub (Mul b16~132@ d16~136@) (Mul a16~130@ b16~132@)) (Mul (Mul d16~136@ c16~134@) a16~130@)))) (=> (= temp_16_1~2802@ (Mul (Mul (Mul (Mul d16~136@ b16~132@) c16~134@) (Mul (Mul d16~136@ b16~132@) (Mul d16~136@ c16~134@))) (Mul (Sub (Mul b16~132@ d16~136@) (Mul a16~130@ b16~132@)) (Mul (Mul d16~136@ c16~134@) a16~130@)))) (=> (= tmp%17@ (= temp_16_0~2745@ temp_16_1~2802@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2878@ (Mul (Mul (Add b17~140@ (Mul c17~142@ d17~144@)) (Mul (Mul d17~144@ a17~138@) (Sub c17~142@ c17~142@))) (Add (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)) (Mul (Mul d17~144@ a17~138@) (Mul d17~144@ d17~144@))))) (=> (= temp_17_1~2939@ (Mul (Mul (Mul (Mul d17~144@ a17~138@) (Sub c17~142@ c17~142@)) (Add b17~140@ (Mul c17~142@ d17~144@))) (Add (Mul (Mul d17~144@ b17~140@) (Mul a17~138@ b17~140@)) (Mul (Mul d17~144@ a17~138@) (Mul d17~144@ d17~144@))))) (=> (= tmp%18@ (= temp_17_0~2878@ temp_17_1~2939@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~3019@ (Mul (Mul (Mul (Mul d18~152@ a18~146@) (Add c18~150@ b18~148@)) (Add (Mul c18~150@ a18~146@) (Mul c18~150@ b18~148@))) (Mul (Mul (Mul c18~150@ a18~146@) (Mul c18~150@ b18~148@)) (Mul (Add b18~148@ d18~152@) (Mul d18~152@ c18~150@))))) (=> (= temp_18_1~3100@ (Mul (Add (Mul (Mul (Mul d18~152@ a18~146@) (Add c18~150@ b18~148@)) (Mul c18~150@ a18~146@)) (Mul (Mul (Mul d18~152@ a18~146@) (Add c18~150@ b18~148@)) (Mul c18~150@ b18~148@))) (Mul (Mul (Mul c18~150@ a18~146@) (Mul c18~150@ b18~148@)) (Mul (Add b18~148@ d18~152@) (Mul d18~152@ c18~150@))))) (=> (= tmp%19@ (= temp_18_0~3019@ temp_18_1~3100@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3180@ (Sub (Mul (Mul (Add b19~156@ d19~160@) (Mul c19~158@ b19~156@)) (Mul (Mul c19~158@ c19~158@) (Mul b19~156@ d19~160@))) (Add (Mul (Add a19~154@ a19~154@) (Mul a19~154@ b19~156@)) (Mul (Mul c19~158@ b19~156@) (Mul c19~158@ c19~158@))))) (=> (= temp_19_1~3245@ (Sub (Mul (Mul (Mul c19~158@ b19~156@) (Add b19~156@ d19~160@)) (Mul (Mul c19~158@ c19~158@) (Mul b19~156@ d19~160@))) (Add (Mul (Add a19~154@ a19~154@) (Mul a19~154@ b19~156@)) (Mul (Mul c19~158@ b19~156@) (Mul c19~158@ c19~158@))))) (=> (= tmp%20@ (= temp_19_0~3180@ temp_19_1~3245@)) (=> %%location_label%%19 tmp%20@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
