...
(declare-const temp_3_0~968@ Int)
...
(declare-const temp_5_1~1631@ Int)
(declare-const temp_6_0~1767@ Int)
(declare-const temp_6_1~1888@ Int)
(declare-const temp_7_0~2020@ Int)
(declare-const temp_7_1~2193@ Int)
(declare-const temp_8_0~2337@ Int)
(declare-const temp_8_1~2466@ Int)
(declare-const temp_9_0~2574@ Int)
(declare-const temp_9_1~2667@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~265@ (Mul (Sub (Mul (Mul c0~6@ (Mul b0~4@ b0~4@)) (Mul (Sub b0~4@ c0~6@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ a0~2@)) d0~8@)) (Add (Mul (Mul (Sub d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Sub a0~2@ b0~4@))) (Sub (Mul d0~8@ (Mul c0~6@ b0~4@)) (Mul (Sub c0~6@ d0~8@) b0~4@))))) (=> (= temp_0_1~370@ (Mul (Sub (Mul (Mul c0~6@ (Mul b0~4@ b0~4@)) (Mul (Sub b0~4@ c0~6@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ a0~2@)) d0~8@)) (Add (Mul (Mul (Sub d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Sub a0~2@ b0~4@) (Mul b0~4@ b0~4@))) (Sub (Mul d0~8@ (Mul c0~6@ b0~4@)) (Mul (Sub c0~6@ d0~8@) b0~4@))))) (=> (= tmp%1@ (= temp_0_0~265@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~490@ (Add (Add (Mul (Mul (Sub c1~14@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Sub a1~10@ d1~16@) (Mul a1~10@ b1~12@))) (Mul (Add (Mul b1~12@ c1~14@) (Mul c1~14@ d1~16@)) a1~10@)) (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Add b1~12@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ a1~10@)) b1~12@)))) (=> (= temp_1_1~595@ (Add (Add (Mul (Mul (Sub c1~14@ b1~12@) (Mul a1~10@ b1~12@)) (Mul (Sub a1~10@ d1~16@) (Mul a1~10@ b1~12@))) (Mul (Add (Mul b1~12@ c1~14@) (Mul c1~14@ d1~16@)) a1~10@)) (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Add b1~12@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul d1~16@ b1~12@) (Mul (Mul b1~12@ a1~10@) b1~12@))))) (=> (= tmp%2@ (= temp_1_0~490@ temp_1_1~595@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~719@ (Mul (Mul (Mul (Mul b2~20@ (Mul a2~18@ c2~22@)) (Mul b2~20@ (Add d2~24@ b2~20@))) (Mul b2~20@ (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@)))) (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul c2~22@ a2~18@) (Sub c2~22@ d2~24@))) (Mul (Mul (Add c2~22@ a2~18@) (Mul b2~20@ a2~18@)) (Sub (Sub d2~24@ b2~20@) (Mul a2~18@ d2~24@)))))) (=> (= temp_2_1~828@ (Mul (Mul (Mul (Mul b2~20@ (Add d2~24@ b2~20@)) (Mul b2~20@ (Mul a2~18@ c2~22@))) (Mul b2~20@ (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@)))) (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul c2~22@ a2~18@) (Sub c2~22@ d2~24@))) (Mul (Mul (Add c2~22@ a2~18@) (Mul b2~20@ a2~18@)) (Sub (Sub d2~24@ b2~20@) (Mul a2~18@ d2~24@)))))) (=> (= tmp%3@ (= temp_2_0~719@ temp_2_1~828@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~968@ (Mul (Sub (Mul (Mul b3~28@ (Mul a3~26@ a3~26@)) (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul b3~28@ 8) (Mul b3~28@ a3~26@)) (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)))) (Sub (Mul (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ a3~26@)) (Add (Mul a3~26@ c3~30@) (Sub c3~30@ a3~26@))) (Mul c3~30@ (Add (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@)))))) (=> (= temp_3_1~1093@ (Mul (Sub (Mul (Mul b3~28@ (Mul a3~26@ a3~26@)) (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul b3~28@ 8) (Mul b3~28@ a3~26@)) (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)))) (Sub (Mul (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ a3~26@)) (Add (Mul a3~26@ c3~30@) (Sub c3~30@ a3~26@))) (Mul (Add (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@)) c3~30@)))) (=> (= tmp%4@ (= temp_3_0~968@ temp_3_1~1093@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1237@ (Mul (Mul (Sub (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@)) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ b4~36@)))) (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ b4~36@)) (Mul (Sub a4~34@ c4~38@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul a4~34@ b4~36@) (Add d4~40@ d4~40@)) (Mul (Sub b4~36@ b4~36@) (Mul c4~38@ b4~36@)))))) (=> (= temp_4_1~1366@ (Mul (Mul (Sub (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ b4~36@)))) (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ b4~36@)) (Mul (Sub a4~34@ c4~38@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul a4~34@ b4~36@) (Add d4~40@ d4~40@)) (Mul (Sub b4~36@ b4~36@) (Mul c4~38@ b4~36@)))))) (=> (= tmp%5@ (= temp_4_0~1237@ temp_4_1~1366@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1506@ (Sub (Mul (Sub (Mul (Mul b5~44@ c5~46@) c5~46@) (Mul (Mul b5~44@ b5~44@) (Sub d5~48@ b5~44@))) (Mul (Mul (Mul b5~44@ b5~44@) (Sub b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ b5~44@)))) (Add (Mul (Mul (Mul b5~44@ d5~48@) (Mul b5~44@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@)))))) (=> (= temp_5_1~1631@ (Sub (Mul (Sub (Mul (Mul b5~44@ c5~46@) c5~46@) (Mul (Mul b5~44@ b5~44@) (Sub d5~48@ b5~44@))) (Mul (Mul (Mul b5~44@ b5~44@) (Sub b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ b5~44@)))) (Add (Mul (Mul (Mul b5~44@ d5~48@) (Mul b5~44@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ c5~46@)) (Mul (Mul (Mul c5~46@ c5~46@) c5~46@) d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1506@ temp_5_1~1631@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1767@ (Mul (Mul (Mul (Mul (Add b6~52@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul c6~54@ c6~54@) (Sub d6~56@ 22))) (Mul (Mul (Mul c6~54@ a6~50@) a6~50@) (Mul d6~56@ (Mul d6~56@ c6~54@)))) (Sub (Mul (Sub (Mul c6~54@ d6~56@) (Add b6~52@ d6~56@)) (Add (Mul a6~50@ c6~54@) (Mul c6~54@ b6~52@))) (Mul a6~50@ (Add (Mul d6~56@ a6~50@) (Mul a6~50@ b6~52@)))))) (=> (= temp_6_1~1888@ (Mul (Mul (Mul (Mul (Mul (Add b6~52@ d6~56@) d6~56@) a6~50@) (Mul (Mul c6~54@ c6~54@) (Sub d6~56@ 22))) (Mul (Mul (Mul c6~54@ a6~50@) a6~50@) (Mul d6~56@ (Mul d6~56@ c6~54@)))) (Sub (Mul (Sub (Mul c6~54@ d6~56@) (Add b6~52@ d6~56@)) (Add (Mul a6~50@ c6~54@) (Mul c6~54@ b6~52@))) (Mul a6~50@ (Add (Mul d6~56@ a6~50@) (Mul a6~50@ b6~52@)))))) (=> (= tmp%7@ (= temp_6_0~1767@ temp_6_1~1888@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2020@ (Mul (Sub (Mul (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ a7~58@))) (Add (Mul d7~64@ (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ c7~62@)))) (Sub (Mul (Mul (Mul a7~58@ d7~64@) d7~64@) (Sub (Mul c7~62@ d7~64@) (Add a7~58@ d7~64@))) (Mul (Add (Add b7~60@ a7~58@) c7~62@) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)))))) (=> (= temp_7_1~2193@ (Sub (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ a7~58@))) (Sub (Mul (Mul (Mul a7~58@ d7~64@) d7~64@) (Sub (Mul c7~62@ d7~64@) (Add a7~58@ d7~64@))) (Mul (Add (Add b7~60@ a7~58@) c7~62@) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))))) (Mul (Add (Mul d7~64@ (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ c7~62@))) (Sub (Mul (Mul (Mul a7~58@ d7~64@) d7~64@) (Sub (Mul c7~62@ d7~64@) (Add a7~58@ d7~64@))) (Mul (Add (Add b7~60@ a7~58@) c7~62@) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))))))) (=> (= tmp%8@ (= temp_7_0~2020@ temp_7_1~2193@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2337@ (Mul (Add (Mul (Add (Mul b8~68@ a8~66@) (Add a8~66@ c8~70@)) (Mul d8~72@ (Mul d8~72@ d8~72@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@)) (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ a8~66@)))) (Sub (Mul (Mul (Add a8~66@ c8~70@) (Mul 2 c8~70@)) (Sub (Mul b8~68@ d8~72@) d8~72@)) (Mul (Mul (Mul a8~66@ b8~68@) (Add a8~66@ d8~72@)) (Mul c8~70@ (Mul b8~68@ a8~66@)))))) (=> (= temp_8_1~2466@ (Mul (Add (Mul (Add (Mul b8~68@ a8~66@) (Add a8~66@ c8~70@)) (Mul d8~72@ (Mul d8~72@ d8~72@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@)) (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ a8~66@)))) (Sub (Mul (Mul (Add a8~66@ c8~70@) (Mul 2 c8~70@)) (Sub (Mul b8~68@ d8~72@) d8~72@)) (Mul (Mul (Add a8~66@ d8~72@) (Mul a8~66@ b8~68@)) (Mul c8~70@ (Mul b8~68@ a8~66@)))))) (=> (= tmp%9@ (= temp_8_0~2337@ temp_8_1~2466@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2574@ (Mul (Sub (Mul (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ a9~74@)) (Add (Mul d9~80@ b9~76@) (Mul b9~76@ c9~78@))) (Add b9~76@ c9~78@)) (Mul (Mul b9~76@ (Mul (Add c9~78@ d9~80@) (Mul d9~80@ b9~76@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ c9~78@)) (Add (Mul c9~78@ c9~78@) (Add a9~74@ c9~78@)))))) (=> (= temp_9_1~2667@ (Mul (Sub (Mul (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ a9~74@)) (Add (Mul b9~76@ d9~80@) (Mul b9~76@ c9~78@))) (Add b9~76@ c9~78@)) (Mul (Mul b9~76@ (Mul (Add c9~78@ d9~80@) (Mul d9~80@ b9~76@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ c9~78@)) (Add (Mul c9~78@ c9~78@) (Add a9~74@ c9~78@)))))) (=> (= tmp%10@ (= temp_9_0~2574@ temp_9_1~2667@)) (=> %%location_label%%9 tmp%10@))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
