...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Sub a0~2@ a0~2@)) (Mul (Add d0~8@ d0~8@) (Add c0~6@ d0~8@))) (Mul (Mul (Add a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Add d0~8@ d0~8@) (Sub d0~8@ 9))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Sub a0~2@ a0~2@)) (Mul (Add d0~8@ d0~8@) (Add c0~6@ d0~8@))) (Mul (Mul (Mul a0~2@ c0~6@) (Add a0~2@ b0~4@)) (Mul (Add d0~8@ d0~8@) (Sub d0~8@ 9))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~479@ (Add (Sub (Mul (Sub c1~14@ d1~16@) (Mul c1~14@ d1~16@)) (Sub (Mul c1~14@ b1~12@) (Mul c1~14@ d1~16@))) (Add (Mul (Sub b1~12@ d1~16@) (Mul d1~16@ c1~14@)) (Add (Mul c1~14@ c1~14@) c1~14@)))) (=> (= temp_1_1~540@ (Add (Sub (Mul (Sub c1~14@ d1~16@) (Mul c1~14@ d1~16@)) (Sub (Mul b1~12@ c1~14@) (Mul c1~14@ d1~16@))) (Add (Mul (Sub b1~12@ d1~16@) (Mul d1~16@ c1~14@)) (Add (Mul c1~14@ c1~14@) c1~14@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~479@ temp_1_1~540@))) (=> (= temp_1_0~479@ temp_1_1~540@) (=> (= temp_2_0~629@ (Mul (Sub c2~22@ (Mul (Mul c2~22@ c2~22@) (Mul 97 d2~24@))) (Mul (Mul (Add c2~22@ d2~24@) (Mul c2~22@ c2~22@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~694@ (Mul (Sub c2~22@ (Mul (Mul c2~22@ c2~22@) (Mul 97 d2~24@))) (Mul (Mul (Mul c2~22@ c2~22@) (Add c2~22@ d2~24@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~629@ temp_2_1~694@))) (=> (= temp_2_0~629@ temp_2_1~694@) (=> (= temp_3_0~771@ (Mul (Sub (Mul (Mul a3~26@ d3~32@) (Sub d3~32@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ d3~32@))) (Mul d3~32@ (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ a3~26@))))) (=> (= temp_3_1~832@ (Mul (Sub (Sub (Mul (Mul a3~26@ d3~32@) d3~32@) (Mul (Mul a3~26@ d3~32@) b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ d3~32@))) (Mul d3~32@ (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~771@ temp_3_1~832@))) (=> (= temp_3_0~771@ temp_3_1~832@) (=> (= temp_4_0~917@ (Mul (Mul (Mul a4~34@ (Mul c4~38@ c4~38@)) (Sub (Add d4~40@ a4~34@) (Mul b4~36@ a4~34@))) (Mul (Sub (Sub d4~40@ d4~40@) (Mul c4~38@ c4~38@)) (Sub (Mul b4~36@ c4~38@) (Add d4~40@ a4~34@))))) (=> (= temp_4_1~978@ (Mul (Mul (Sub (Add d4~40@ a4~34@) (Mul b4~36@ a4~34@)) (Mul a4~34@ (Mul c4~38@ c4~38@))) (Mul (Sub (Sub d4~40@ d4~40@) (Mul c4~38@ c4~38@)) (Sub (Mul b4~36@ c4~38@) (Add d4~40@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~917@ temp_4_1~978@))) (=> (= temp_4_0~917@ temp_4_1~978@) (=> (= temp_5_0~1067@ (Sub (Sub (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ d5~48@)) (Sub (Mul a5~42@ b5~44@) (Sub b5~44@ d5~48@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@)) (Sub (Mul d5~48@ b5~44@) (Sub c5~46@ c5~46@))))) (=> (= temp_5_1~1132@ (Sub (Sub (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ b5~44@)) (Sub (Mul a5~42@ b5~44@) (Sub b5~44@ d5~48@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@)) (Sub (Mul d5~48@ b5~44@) (Sub c5~46@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1067@ temp_5_1~1132@))) (=> (= temp_5_0~1067@ temp_5_1~1132@) (=> (= temp_6_0~1205@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ a6~50@)) c6~54@) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ b6~52@)) (Mul b6~52@ (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1254@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ a6~50@)) c6~54@) (Mul (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@)) (Mul b6~52@ (Mul c6~54@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1205@ temp_6_1~1254@))) (=> (= temp_6_0~1205@ temp_6_1~1254@) (=> (= temp_7_0~1339@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ c7~62@))) (Mul (Mul (Mul c7~62@ c7~62@) a7~58@) (Add (Mul b7~60@ c7~62@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1400@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul c7~62@ c7~62@) a7~58@) (Add (Mul b7~60@ c7~62@) (Mul d7~64@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1339@ temp_7_1~1400@))) (=> (= temp_7_0~1339@ temp_7_1~1400@) (=> (= temp_8_0~1489@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@)) (Sub (Add d8~72@ d8~72@) (Add b8~68@ d8~72@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@))))) (=> (= temp_8_1~1554@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@)) (Sub (Add d8~72@ d8~72@) (Add b8~68@ d8~72@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1489@ temp_8_1~1554@))) (=> (= temp_8_0~1489@ temp_8_1~1554@) (=> (= temp_9_0~1643@ (Mul (Mul (Sub (Mul d9~80@ a9~74@) (Mul c9~78@ a9~74@)) d9~80@) (Mul (Mul (Mul b9~76@ a9~74@) (Mul 47 b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1704@ (Mul (Mul (Mul (Sub d9~80@ c9~78@) a9~74@) d9~80@) (Mul (Mul (Mul b9~76@ a9~74@) (Mul 47 b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul c9~78@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1643@ temp_9_1~1704@))) (=> (= temp_9_0~1643@ temp_9_1~1704@) (=> (= temp_10_0~1793@ (Mul (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@)) (Mul (Mul b10~84@ c10~86@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul c10~86@ b10~84@)) (Add (Mul b10~84@ a10~82@) (Mul d10~88@ a10~82@))))) (=> (= temp_10_1~1858@ (Mul (Mul (Mul (Mul a10~82@ b10~84@) (Mul c10~86@ b10~84@)) (Add (Mul b10~84@ a10~82@) (Mul d10~88@ a10~82@))) (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@)) (Mul (Mul b10~84@ c10~86@) (Mul a10~82@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1793@ temp_10_1~1858@))) (=> (= temp_10_0~1793@ temp_10_1~1858@) (=> (= temp_11_0~1955@ (Mul (Mul (Mul (Mul b11~92@ a11~90@) (Sub a11~90@ a11~90@)) (Add (Mul c11~94@ 69) (Mul c11~94@ c11~94@))) (Mul (Mul c11~94@ (Mul b11~92@ b11~92@)) (Mul (Add c11~94@ b11~92@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~2028@ (Mul (Mul (Mul (Mul b11~92@ a11~90@) (Sub a11~90@ a11~90@)) (Add (Mul c11~94@ 69) (Mul c11~94@ c11~94@))) (Mul (Mul c11~94@ (Mul b11~92@ b11~92@)) (Mul (Mul (Add c11~94@ b11~92@) a11~90@) d11~96@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1955@ temp_11_1~2028@))) (=> (= temp_11_0~1955@ temp_11_1~2028@) (=> (= temp_12_0~2113@ (Mul (Mul (Mul (Add c12~102@ b12~100@) (Mul c12~102@ b12~100@)) (Sub (Mul d12~104@ a12~98@) (Sub b12~100@ a12~98@))) (Sub (Add a12~98@ (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ d12~104@) (Add a12~98@ b12~100@))))) (=> (= temp_12_1~2174@ (Mul (Mul (Mul (Add c12~102@ b12~100@) (Mul c12~102@ b12~100@)) (Sub (Mul d12~104@ a12~98@) (Sub b12~100@ a12~98@))) (Sub (Add a12~98@ (Mul d12~104@ c12~102@)) (Mul (Add a12~98@ b12~100@) (Mul a12~98@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2113@ temp_12_1~2174@))) (=> (= temp_12_0~2113@ temp_12_1~2174@) (=> (= temp_13_0~2259@ (Mul (Mul (Mul (Add a13~106@ c13~110@) (Mul b13~108@ b13~108@)) (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ b13~108@))) (Mul (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ b13~108@)) (Mul d13~112@ (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2320@ (Mul (Mul (Mul (Add a13~106@ c13~110@) (Mul b13~108@ b13~108@)) (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ b13~108@))) (Mul (Mul (Mul c13~110@ d13~112@) (Mul c13~110@ b13~108@)) (Mul (Mul d13~112@ b13~108@) d13~112@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2259@ temp_13_1~2320@))) (=> (= temp_13_0~2259@ temp_13_1~2320@) (=> (= temp_14_0~2405@ (Add (Mul (Add (Add d14~120@ a14~114@) (Mul b14~116@ d14~120@)) (Mul (Mul d14~120@ a14~114@) (Mul d14~120@ c14~118@))) (Sub (Add (Mul d14~120@ d14~120@) (Mul c14~118@ b14~116@)) (Mul (Sub a14~114@ d14~120@) b14~116@)))) (=> (= temp_14_1~2466@ (Add (Mul (Add (Add d14~120@ a14~114@) (Mul b14~116@ d14~120@)) (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ a14~114@))) (Sub (Add (Mul d14~120@ d14~120@) (Mul c14~118@ b14~116@)) (Mul (Sub a14~114@ d14~120@) b14~116@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2405@ temp_14_1~2466@))) (=> (= temp_14_0~2405@ temp_14_1~2466@) (=> (= temp_15_0~2551@ (Sub (Sub (Sub (Add a15~122@ c15~126@) (Mul a15~122@ a15~122@)) (Mul (Mul b15~124@ a15~122@) d15~128@)) (Mul (Mul (Mul a15~122@ c15~126@) (Mul a15~122@ c15~126@)) (Add (Mul a15~122@ a15~122@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2612@ (Sub (Sub (Sub (Add a15~122@ c15~126@) (Mul a15~122@ a15~122@)) (Mul d15~128@ (Mul b15~124@ a15~122@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul a15~122@ c15~126@)) (Add (Mul a15~122@ a15~122@) (Mul c15~126@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2551@ temp_15_1~2612@))) (=> (= temp_15_0~2551@ temp_15_1~2612@) (=> (= temp_16_0~2701@ (Mul (Mul (Sub (Mul c16~134@ c16~134@) (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ a16~130@) (Mul d16~136@ b16~132@))) (Add (Mul (Mul b16~132@ b16~132@) (Mul d16~136@ b16~132@)) (Add (Add d16~136@ b16~132@) (Add d16~136@ d16~136@))))) (=> (= temp_16_1~2766@ (Mul (Mul (Sub (Mul c16~134@ c16~134@) (Mul a16~130@ d16~136@)) (Mul (Mul a16~130@ c16~134@) (Mul d16~136@ b16~132@))) (Add (Mul (Mul b16~132@ b16~132@) (Mul d16~136@ b16~132@)) (Add (Add d16~136@ b16~132@) (Add d16~136@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2701@ temp_16_1~2766@))) (=> (= temp_16_0~2701@ temp_16_1~2766@) (=> (= temp_17_0~2855@ (Mul (Mul (Mul (Add d17~144@ c17~142@) (Add d17~144@ d17~144@)) (Sub (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@))) (Add (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ a17~138@) (Add c17~142@ c17~142@))))) (=> (= temp_17_1~2920@ (Mul (Mul (Add d17~144@ c17~142@) (Add d17~144@ d17~144@)) (Mul (Sub (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Add (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ a17~138@) (Add c17~142@ c17~142@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2855@ temp_17_1~2920@))) (=> (= temp_17_0~2855@ temp_17_1~2920@) (=> (= temp_18_0~2997@ (Mul (Mul d18~152@ b18~148@) (Mul (Mul (Add a18~146@ b18~148@) (Mul c18~150@ a18~146@)) (Mul (Mul b18~148@ d18~152@) (Mul 23 b18~148@))))) (=> (= temp_18_1~3050@ (Mul (Mul d18~152@ b18~148@) (Mul (Mul (Add a18~146@ b18~148@) (Mul c18~150@ a18~146@)) (Mul b18~148@ (Mul d18~152@ (Mul 23 b18~148@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2997@ temp_18_1~3050@))) (=> (= temp_18_0~2997@ temp_18_1~3050@) (=> (= temp_19_0~3139@ (Add (Mul (Mul (Mul b19~156@ b19~156@) (Mul d19~160@ a19~154@)) (Mul (Mul d19~160@ c19~158@) (Mul b19~156@ b19~156@))) (Mul (Mul (Mul a19~154@ d19~160@) (Mul b19~156@ d19~160@)) (Mul (Mul d19~160@ a19~154@) (Sub d19~160@ a19~154@))))) (=> (= temp_19_1~3204@ (Add (Mul (Mul (Mul b19~156@ b19~156@) (Mul d19~160@ a19~154@)) (Mul (Mul d19~160@ c19~158@) (Mul b19~156@ b19~156@))) (Mul (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ b19~156@)) (Mul (Mul d19~160@ a19~154@) (Sub d19~160@ a19~154@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3139@ temp_19_1~3204@))) (=> (= temp_19_0~3139@ temp_19_1~3204@) (=> (= temp_20_0~3293@ (Mul (Mul (Mul (Mul a20~162@ d20~168@) (Mul b20~164@ c20~166@)) (Mul (Mul d20~168@ d20~168@) (Mul c20~166@ d20~168@))) (Mul (Sub (Sub d20~168@ c20~166@) (Mul d20~168@ a20~162@)) (Mul (Add a20~162@ b20~164@) (Sub d20~168@ b20~164@))))) (=> (= temp_20_1~3358@ (Mul (Mul (Mul (Mul (Mul a20~162@ d20~168@) (Mul b20~164@ c20~166@)) (Mul (Mul d20~168@ d20~168@) (Mul c20~166@ d20~168@))) (Sub (Sub d20~168@ c20~166@) (Mul d20~168@ a20~162@))) (Mul (Add a20~162@ b20~164@) (Sub d20~168@ b20~164@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3293@ temp_20_1~3358@))) (=> (= temp_20_0~3293@ temp_20_1~3358@) (=> (= temp_21_0~3451@ (Mul (Mul (Mul (Mul d21~176@ c21~174@) b21~172@) (Mul (Mul c21~174@ a21~170@) (Mul d21~176@ b21~172@))) (Mul (Mul (Sub a21~170@ c21~174@) a21~170@) (Mul (Mul b21~172@ 6) (Mul b21~172@ b21~172@))))) (=> (= temp_21_1~3520@ (Mul (Mul (Mul d21~176@ (Mul c21~174@ b21~172@)) (Mul (Mul c21~174@ a21~170@) (Mul d21~176@ b21~172@))) (Mul (Mul (Sub a21~170@ c21~174@) a21~170@) (Mul (Mul b21~172@ 6) (Mul b21~172@ b21~172@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3451@ temp_21_1~3520@))) (=> (= temp_21_0~3451@ temp_21_1~3520@) (=> (= temp_22_0~3605@ (Mul (Mul (Add (Mul a22~178@ a22~178@) (Mul d22~184@ a22~178@)) (Add (Mul d22~184@ d22~184@) a22~178@)) (Add (Mul (Mul b22~180@ a22~178@) (Mul d22~184@ d22~184@)) (Sub (Mul d22~184@ a22~178@) (Mul b22~180@ d22~184@))))) (=> (= temp_22_1~3666@ (Mul (Add (Mul a22~178@ a22~178@) (Mul d22~184@ a22~178@)) (Mul (Add (Mul d22~184@ d22~184@) a22~178@) (Add (Mul (Mul b22~180@ a22~178@) (Mul d22~184@ d22~184@)) (Sub (Mul d22~184@ a22~178@) (Mul b22~180@ d22~184@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3605@ temp_22_1~3666@))) (=> (= temp_22_0~3605@ temp_22_1~3666@) (=> (= temp_23_0~3755@ (Sub (Mul (Mul (Mul a23~186@ d23~192@) (Mul d23~192@ d23~192@)) b23~188@) (Mul (Mul (Mul d23~192@ b23~188@) (Mul b23~188@ 92)) (Mul (Mul d23~192@ c23~190@) (Add a23~186@ d23~192@))))) (=> (= temp_23_1~3820@ (Sub (Mul (Mul (Mul a23~186@ d23~192@) (Mul d23~192@ d23~192@)) b23~188@) (Mul (Mul d23~192@ (Mul b23~188@ (Mul b23~188@ 92))) (Mul (Mul d23~192@ c23~190@) (Add a23~186@ d23~192@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3755@ temp_23_1~3820@))) (=> (= temp_23_0~3755@ temp_23_1~3820@) (=> (= temp_24_0~3881@ (Mul c24~198@ (Mul (Mul (Mul b24~196@ b24~196@) (Mul b24~196@ c24~198@)) (Mul (Mul d24~200@ d24~200@) (Mul d24~200@ b24~196@))))) (=> (= temp_24_1~3918@ (Mul c24~198@ (Mul (Mul (Mul b24~196@ c24~198@) (Mul b24~196@ b24~196@)) (Mul (Mul d24~200@ d24~200@) (Mul d24~200@ b24~196@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3881@ temp_24_1~3918@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
