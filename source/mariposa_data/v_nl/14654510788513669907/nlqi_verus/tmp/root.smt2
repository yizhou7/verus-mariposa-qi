...
(push)
 ...
 (declare-const temp_2_0~647@ Int)
 ...
 (declare-const temp_5_0~1066@ Int)
      ...
      (=>
       ...
       (and
        ...
        (=>
         tmp%1@
         (=>
          (= temp_1_0~490@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@
               b1~12@
              ) (Mul d1~16@ a1~10@)
             )
          ...
          (=>
           (= temp_1_1~555@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@
                c1~14@
               ) (Mul d1~16@ a1~10@)
              )
             ) (Mul (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@
           ...
           (=>
            ...
            (and
             ...
             (=>
              tmp%2@
              (=>
               (= temp_2_0~647@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub c2~22@ d2~24@)) (Mul (Mul d2~24@
                    b2~20@
                   ) (Mul 23 b2~20@)
                  )
               ...
               (=>
                (= temp_2_1~724@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub c2~22@ d2~24@)) (Mul (Mul (Mul
                      d2~24@ b2~20@
                     ) 23
                    ) b2~20@
                   )
                ...
                (=>
                 (= tmp%3@ (= temp_2_0~647@ temp_2_1~724@))
                 (and
                  (=>
                   %%location_label%%2
                   tmp%3@
                  ...
                  (=>
                   tmp%3@
                   (=>
                    (= temp_3_0~788@ (Sub (Mul (Add (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@
                         b3~28@
                        ) (Mul b3~28@ d3~32@)
                       )
                    ...
                    (=>
                     (= temp_3_1~837@ (Sub (Mul (Add (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@
                          d3~32@
                         ) (Mul b3~28@ b3~28@)
                        )
                       ) (Mul (Mul a3~26@ (Mul a3~26@ a3~26@)) c3~30@)
                     ...
                     (=>
                      (= tmp%4@ (= temp_3_0~788@ temp_3_1~837@))
                      (and
                       (=>
                        %%location_label%%3
                        tmp%4@
                       ...
                       (=>
                        tmp%4@
                        (=>
                         (= temp_4_0~913@ (Mul (Sub (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@)) (Mul a4~34@
                             (Mul b4~36@ b4~36@)
                            )
                         ...
                         (=>
                          (= temp_4_1~974@ (Mul (Sub (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@
                               b4~36@
                              ) b4~36@
                             )
                            ) (Mul (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Add c4~38@
                          ...
                          (=>
                           ...
                           (and
                            ...
                            (=>
                             tmp%5@
                             (=>
                              (= temp_5_0~1066@ (Mul (Add (Mul (Add a5~42@ d5~48@) (Mul c5~46@ 13)) (Mul (Mul b5~44@
                                   a5~42@
                                  ) (Mul b5~44@ c5~46@)
                                 )
                              ...
                              (=>
                               (= temp_5_1~1143@ (Mul (Add (Mul (Mul c5~46@ 13) (Add a5~42@ d5~48@)) (Mul (Mul b5~44@
                                    a5~42@
                                   ) (Mul b5~44@ c5~46@)
                                  )
                                 ) (Add (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul b5~44@
                               ...
                               (=>
                                (= tmp%6@ (= temp_5_0~1066@ temp_5_1~1143@))
                                (and
                                 (=>
                                  %%location_label%%5
                                  tmp%6@
                                 ...
                                 (=>
                                  tmp%6@
                                  (=>
                                   (= temp_6_0~1219@ (Add (Mul (Mul d6~56@ (Mul b6~52@ b6~52@)) (Add (Mul a6~50@ d6~56@)
                                       (Mul c6~54@ d6~56@)
                                      )
                                   ...
                                   (=>
                                    (= temp_6_1~1280@ (Add (Mul (Mul d6~56@ (Mul b6~52@ b6~52@)) (Add (Mul a6~50@ d6~56@)
                                        (Mul c6~54@ d6~56@)
                                       )
                                    ...
                                    (=>
                                     (= tmp%7@ (= temp_6_0~1219@ temp_6_1~1280@))
                                     (and
                                      (=>
                                       %%location_label%%6
                                       tmp%7@
                                      ...
                                      (=>
                                       tmp%7@
                                       (=>
                                        (= temp_7_0~1368@ (Mul (Sub (Sub (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Mul c7~62@
                                            (Mul b7~60@ b7~60@)
                                           )
                                        ...
                                        (=>
                                         (= temp_7_1~1441@ (Mul (Sub (Sub (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Mul c7~62@
                                             (Mul b7~60@ b7~60@)
                                            )
                                         ...
                                         (=>
                                          (= tmp%8@ (= temp_7_0~1368@ temp_7_1~1441@))
                                          (=>
                                           %%location_label%%7
                                           tmp%8@
 ))))))))))))))))))))))))))))))))))))))))))
