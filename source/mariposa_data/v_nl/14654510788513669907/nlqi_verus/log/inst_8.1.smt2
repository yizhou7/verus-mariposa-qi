...
(set-info :comment ";; mariposa_data/v_nl//14654510788513669907/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_6_1~1420@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~325@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ 89) b0~4@)) (Mul (Mul (Add b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ 29) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~410@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@)) (Mul b0~4@ (Mul 89 b0~4@))) (Mul (Mul (Add b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ 29) (Mul a0~2@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ 89 b0~4@) (=> %%location_label%%0 (= temp_0_0~325@ temp_0_1~410@))) (=> (= temp_0_0~325@ temp_0_1~410@) (=> (= temp_1_0~517@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@))))) (=> (= temp_1_1~582@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ b1~12@) (=> %%location_label%%1 (= temp_1_0~517@ temp_1_1~582@))) (=> (= temp_1_0~517@ temp_1_1~582@) (=> (= temp_2_0~687@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub c2~22@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul 23 b2~20@))) (Mul (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Add c2~22@ c2~22@))))) (=> (= temp_2_1~764@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub c2~22@ d2~24@)) (Mul (Mul (Mul d2~24@ b2~20@) 23) b2~20@)) (Mul (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Add c2~22@ c2~22@))))) (and (=> (= tmp%1@ (Mul d2~24@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ 23 b2~20@) (=> %%location_label%%2 (= temp_2_0~687@ temp_2_1~764@)))) (=> (= temp_2_0~687@ temp_2_1~764@) (=> (= temp_3_0~859@ (Sub (Mul (Add (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ d3~32@))) (Mul (Mul a3~26@ (Mul a3~26@ a3~26@)) c3~30@))) (=> (= temp_3_1~908@ (Sub (Mul (Add (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ b3~28@))) (Mul (Mul a3~26@ (Mul a3~26@ a3~26@)) c3~30@))) (and (=> (= tmp%2@ (Mul b3~28@ b3~28@)) (=> (= tmp%3@ (Mul b3~28@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~859@ temp_3_1~908@))))) (=> (= temp_3_0~859@ temp_3_1~908@) (=> (= temp_4_0~1005@ (Mul (Sub (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@)) (Mul a4~34@ (Mul b4~36@ b4~36@))) (Mul (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Add c4~38@ b4~36@))))) (=> (= temp_4_1~1066@ (Mul (Sub (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ b4~36@) b4~36@)) (Mul (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Add c4~38@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a4~34@ b4~36@ b4~36@) (=> %%location_label%%4 (= temp_4_0~1005@ temp_4_1~1066@))) (=> (= temp_4_0~1005@ temp_4_1~1066@) (=> (= temp_5_0~1173@ (Mul (Add (Mul (Add a5~42@ d5~48@) (Mul c5~46@ 13)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ c5~46@))) (Add (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1250@ (Mul (Add (Mul (Mul c5~46@ 13) (Add a5~42@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ c5~46@))) (Add (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@))))) (and (=> (= tmp%4@ (Add a5~42@ d5~48@)) (=> (= tmp%5@ (Mul c5~46@ 13)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%5 (= temp_5_0~1173@ temp_5_1~1250@))))) (=> (= temp_5_0~1173@ temp_5_1~1250@) (=> (= temp_6_0~1359@ (Add (Mul (Mul d6~56@ (Mul b6~52@ b6~52@)) (Add (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@))) (Mul (Add (Sub d6~56@ a6~50@) (Mul c6~54@ c6~54@)) (Mul (Sub b6~52@ c6~54@) (Mul b6~52@ a6~50@))))) (=> (= temp_6_1~1420@ (Add (Mul (Mul d6~56@ (Mul b6~52@ b6~52@)) (Add (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@))) (Mul (Add (Sub d6~56@ a6~50@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Sub b6~52@ c6~54@))))) (and (=> (= tmp%6@ (Sub b6~52@ c6~54@)) (=> (= tmp%7@ (Mul b6~52@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%6 (= temp_6_0~1359@ temp_6_1~1420@))))) (=> (= temp_6_0~1359@ temp_6_1~1420@) (=> (= temp_7_0~1529@ (Mul (Sub (Sub (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Mul c7~62@ (Mul b7~60@ b7~60@))) (Add (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul a7~58@ c7~62@) (Mul 17 a7~58@))))) (=> (= temp_7_1~1602@ (Mul (Sub (Sub (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Mul c7~62@ (Mul b7~60@ b7~60@))) (Add (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul (Mul a7~58@ c7~62@) 17) a7~58@)))) (=> (= tmp%8@ (Mul a7~58@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ 17 a7~58@) (=> %%location_label%%7 (= temp_7_0~1529@ temp_7_1~1602@)))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
