...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@))) (Add (Add (Mul a0~2@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Add b0~4@ d0~8@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~402@ (Add (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@))) (Add (Mul a0~2@ c0~6@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@))) (Mul (Add b0~4@ d0~8@) (Mul d0~8@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~402@))) (=> (= temp_0_0~305@ temp_0_1~402@) (=> (= temp_1_0~515@ (Mul (Mul (Mul (Mul 69 d1~16@) (Mul c1~14@ a1~10@)) (Sub (Mul b1~12@ 50) (Add d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@))))) (=> (= temp_1_1~604@ (Mul (Mul (Mul 69 d1~16@) (Mul c1~14@ a1~10@)) (Mul (Sub (Mul b1~12@ 50) (Add d1~16@ c1~14@)) (Mul (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~515@ temp_1_1~604@))) (=> (= temp_1_0~515@ temp_1_1~604@) (=> (= temp_2_0~689@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@))) (Mul (Mul a2~18@ (Mul b2~20@ b2~20@)) (Mul (Sub d2~24@ c2~22@) (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~750@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ c2~22@)) (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ c2~22@))) (Mul (Mul a2~18@ (Mul b2~20@ b2~20@)) (Mul (Sub d2~24@ c2~22@) (Mul b2~20@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~689@ temp_2_1~750@))) (=> (= temp_2_0~689@ temp_2_1~750@) (=> (= temp_3_0~839@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)) (Mul (Sub a3~26@ b3~28@) (Sub b3~28@ c3~30@))) (Mul (Sub (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~904@ (Mul (Mul (Mul c3~30@ c3~30@) (Mul (Mul a3~26@ d3~32@) (Mul (Sub a3~26@ b3~28@) (Sub b3~28@ c3~30@)))) (Mul (Sub (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~839@ temp_3_1~904@))) (=> (= temp_3_0~839@ temp_3_1~904@) (=> (= temp_4_0~997@ (Sub (Mul (Mul (Mul d4~40@ b4~36@) d4~40@) (Mul (Mul 80 a4~34@) (Mul b4~36@ b4~36@))) (Add (Mul (Sub a4~34@ b4~36@) a4~34@) (Add (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~1066@ (Sub (Mul (Mul (Mul d4~40@ b4~36@) d4~40@) (Mul (Mul a4~34@ 80) (Mul b4~36@ b4~36@))) (Add (Mul (Sub a4~34@ b4~36@) a4~34@) (Add (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~997@ temp_4_1~1066@))) (=> (= temp_4_0~997@ temp_4_1~1066@) (=> (= temp_5_0~1147@ (Mul (Add (Mul a5~42@ (Mul c5~46@ c5~46@)) (Mul (Mul b5~44@ a5~42@) a5~42@)) (Mul (Mul (Sub c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Add (Sub c5~46@ d5~48@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1204@ (Mul (Add (Mul a5~42@ (Mul c5~46@ c5~46@)) (Mul (Mul b5~44@ a5~42@) a5~42@)) (Mul (Sub c5~46@ a5~42@) (Mul (Mul b5~44@ a5~42@) (Add (Sub c5~46@ d5~48@) (Mul d5~48@ d5~48@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1147@ temp_5_1~1204@))) (=> (= temp_5_0~1147@ temp_5_1~1204@) (=> (= temp_6_0~1289@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Add b6~52@ c6~54@)) (Sub b6~52@ (Mul b6~52@ d6~56@))) (Mul (Sub (Sub d6~56@ d6~56@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@))))) (=> (= temp_6_1~1350@ (Mul (Mul (Mul b6~52@ d6~56@) (Mul (Add b6~52@ c6~54@) (Sub b6~52@ (Mul b6~52@ d6~56@)))) (Mul (Sub (Sub d6~56@ d6~56@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1289@ temp_6_1~1350@))) (=> (= temp_6_0~1289@ temp_6_1~1350@) (=> (= temp_7_0~1475@ (Add (Mul (Mul (Mul d7~64@ b7~60@) (Mul 43 88)) (Mul (Sub b7~60@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Sub (Sub c7~62@ a7~58@) (Mul d7~64@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Mul 1 d7~64@))))) (=> (= temp_7_1~1576@ (Add (Mul (Mul (Mul d7~64@ b7~60@) (Mul 43 88)) (Mul (Mul (Sub b7~60@ d7~64@) a7~58@) d7~64@)) (Mul (Sub (Sub c7~62@ a7~58@) (Mul d7~64@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Mul 1 d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1475@ temp_7_1~1576@))) (=> (= temp_7_0~1475@ temp_7_1~1576@) (=> (= temp_8_0~1661@ (Mul (Mul a8~66@ (Sub a8~66@ (Mul a8~66@ c8~70@))) (Sub (Mul (Sub a8~66@ a8~66@) (Mul 91 a8~66@)) (Add (Mul b8~68@ a8~66@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1722@ (Mul (Mul a8~66@ (Sub a8~66@ (Mul a8~66@ c8~70@))) (Sub (Mul (Sub a8~66@ a8~66@) (Mul a8~66@ 91)) (Add (Mul b8~68@ a8~66@) (Mul d8~72@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1661@ temp_8_1~1722@))) (=> (= temp_8_0~1661@ temp_8_1~1722@) (=> (= temp_9_0~1823@ (Mul (Add (Mul (Mul a9~74@ a9~74@) (Add c9~78@ d9~80@)) (Add (Mul b9~76@ d9~80@) (Mul d9~80@ d9~80@))) (Mul (Add (Mul a9~74@ d9~80@) (Mul a9~74@ 92)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~1900@ (Mul (Add (Mul (Mul a9~74@ a9~74@) (Add c9~78@ d9~80@)) (Add (Mul b9~76@ d9~80@) (Mul d9~80@ d9~80@))) (Mul (Add (Mul a9~74@ d9~80@) (Mul 92 a9~74@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1823@ temp_9_1~1900@))) (=> (= temp_9_0~1823@ temp_9_1~1900@) (=> (= temp_10_0~2001@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ d10~88@)) (Sub (Add b10~84@ 96) (Mul a10~82@ a10~82@))) (Mul (Add (Mul c10~86@ c10~86@) (Mul c10~86@ a10~82@)) (Mul (Add d10~88@ d10~88@) (Add d10~88@ d10~88@))))) (=> (= temp_10_1~2078@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ d10~88@)) (Sub (Add b10~84@ 96) (Mul a10~82@ a10~82@))) (Mul (Add (Mul c10~86@ c10~86@) (Mul c10~86@ a10~82@)) (Mul (Add d10~88@ d10~88@) (Add d10~88@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~2001@ temp_10_1~2078@))) (=> (= temp_10_0~2001@ temp_10_1~2078@) (=> (= temp_11_0~2139@ (Mul 79 (Mul (Mul (Add c11~94@ c11~94@) (Mul b11~92@ d11~96@)) d11~96@))) (=> (= temp_11_1~2176@ (Mul 79 (Mul (Mul (Add c11~94@ c11~94@) (Mul d11~96@ b11~92@)) d11~96@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2139@ temp_11_1~2176@))) (=> (= temp_11_0~2139@ temp_11_1~2176@) (=> (= temp_12_0~2257@ (Mul (Mul (Sub (Sub d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Sub (Mul a12~98@ d12~104@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul b12~100@ a12~98@) d12~104@) (Mul d12~104@ (Mul a12~98@ b12~100@))))) (=> (= temp_12_1~2314@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) d12~104@) (Mul d12~104@ (Mul a12~98@ b12~100@))) (Mul (Sub (Sub d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Sub (Mul a12~98@ d12~104@) (Mul b12~100@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2257@ temp_12_1~2314@))) (=> (= temp_12_0~2257@ temp_12_1~2314@) (=> (= temp_13_0~2399@ (Mul (Mul (Mul (Mul a13~106@ b13~108@) (Add a13~106@ c13~110@)) (Add b13~108@ (Mul a13~106@ b13~108@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ d13~112@)) (Add (Sub d13~112@ c13~110@) (Mul a13~106@ b13~108@))))) (=> (= temp_13_1~2460@ (Mul (Mul (Mul (Mul a13~106@ b13~108@) (Add a13~106@ c13~110@)) (Add b13~108@ (Mul b13~108@ a13~106@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ d13~112@)) (Add (Sub d13~112@ c13~110@) (Mul a13~106@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2399@ temp_13_1~2460@))) (=> (= temp_13_0~2399@ temp_13_1~2460@) (=> (= temp_14_0~2549@ (Sub (Mul (Mul (Add b14~116@ a14~114@) (Sub b14~116@ a14~114@)) (Add (Mul a14~114@ b14~116@) (Mul a14~114@ c14~118@))) (Mul (Sub (Mul a14~114@ b14~116@) (Mul b14~116@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2614@ (Sub (Mul (Mul (Add b14~116@ a14~114@) (Sub b14~116@ a14~114@)) (Add (Mul b14~116@ a14~114@) (Mul a14~114@ c14~118@))) (Mul (Sub (Mul a14~114@ b14~116@) (Mul b14~116@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2549@ temp_14_1~2614@))) (=> (= temp_14_0~2549@ temp_14_1~2614@) (=> (= temp_15_0~2715@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Mul 46 c15~126@)) (Mul (Add a15~122@ d15~128@) (Mul c15~126@ c15~126@))) (Mul (Mul (Sub d15~128@ a15~122@) (Mul c15~126@ a15~122@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ b15~124@))))) (=> (= temp_15_1~2792@ (Mul (Mul (Mul (Sub d15~128@ a15~122@) (Mul c15~126@ a15~122@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ b15~124@))) (Mul (Mul (Mul b15~124@ d15~128@) (Mul 46 c15~126@)) (Mul (Add a15~122@ d15~128@) (Mul c15~126@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2715@ temp_15_1~2792@))) (=> (= temp_15_0~2715@ temp_15_1~2792@) (=> (= temp_16_0~2893@ (Mul (Mul (Sub (Mul 54 b16~132@) (Mul a16~130@ a16~130@)) (Mul (Mul a16~130@ a16~130@) (Mul b16~132@ c16~134@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ b16~132@)) (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ b16~132@))))) (=> (= temp_16_1~2970@ (Mul (Mul (Sub (Mul 54 b16~132@) (Mul a16~130@ a16~130@)) (Mul (Mul a16~130@ a16~130@) (Mul b16~132@ c16~134@))) (Mul (Mul (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ b16~132@)) (Mul c16~134@ c16~134@)) (Mul c16~134@ b16~132@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2893@ temp_16_1~2970@))) (=> (= temp_16_0~2893@ temp_16_1~2970@) (=> (= temp_17_0~3043@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) d17~144@) (Add (Sub a17~138@ a17~138@) (Mul c17~142@ a17~138@))) (Mul (Mul (Mul d17~144@ d17~144@) (Add d17~144@ c17~142@)) d17~144@))) (=> (= temp_17_1~3092@ (Mul (Mul (Mul (Mul c17~142@ b17~140@) d17~144@) (Add (Sub a17~138@ a17~138@) (Mul c17~142@ a17~138@))) (Mul (Mul (Mul d17~144@ d17~144@) (Add d17~144@ c17~142@)) d17~144@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~3043@ temp_17_1~3092@))) (=> (= temp_17_0~3043@ temp_17_1~3092@) (=> (= temp_18_0~3181@ (Mul (Mul (Mul (Mul a18~146@ b18~148@) (Mul c18~150@ a18~146@)) (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ d18~152@))) (Mul (Add (Mul d18~152@ c18~150@) (Mul b18~148@ b18~148@)) (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ c18~150@))))) (=> (= temp_18_1~3246@ (Mul (Mul (Mul (Mul a18~146@ b18~148@) (Mul c18~150@ a18~146@)) (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ d18~152@))) (Mul (Add (Mul d18~152@ c18~150@) (Mul b18~148@ b18~148@)) (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3181@ temp_18_1~3246@))) (=> (= temp_18_0~3181@ temp_18_1~3246@) (=> (= temp_19_0~3331@ (Mul (Mul (Sub b19~156@ (Add c19~158@ a19~154@)) (Mul (Mul a19~154@ b19~156@) (Add b19~156@ c19~158@))) (Sub (Add (Mul a19~154@ d19~160@) (Mul a19~154@ d19~160@)) (Mul (Sub b19~156@ b19~156@) (Mul b19~156@ a19~154@))))) (=> (= temp_19_1~3392@ (Mul (Sub (Add (Mul a19~154@ d19~160@) (Mul a19~154@ d19~160@)) (Mul (Sub b19~156@ b19~156@) (Mul b19~156@ a19~154@))) (Mul (Sub b19~156@ (Add c19~158@ a19~154@)) (Mul (Mul a19~154@ b19~156@) (Add b19~156@ c19~158@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3331@ temp_19_1~3392@))) (=> (= temp_19_0~3331@ temp_19_1~3392@) (=> (= temp_20_0~3465@ (Mul (Mul c20~166@ (Mul d20~168@ (Mul a20~162@ c20~166@))) (Mul (Add (Mul c20~166@ a20~162@) (Mul b20~164@ d20~168@)) (Mul (Mul a20~162@ b20~164@) (Mul d20~168@ c20~166@))))) (=> (= temp_20_1~3514@ (Mul (Mul (Add (Mul c20~166@ a20~162@) (Mul b20~164@ d20~168@)) (Mul (Mul a20~162@ b20~164@) (Mul d20~168@ c20~166@))) (Mul c20~166@ (Mul d20~168@ (Mul a20~162@ c20~166@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3465@ temp_20_1~3514@))) (=> (= temp_20_0~3465@ temp_20_1~3514@) (=> (= temp_21_0~3611@ (Add (Mul (Mul (Mul a21~170@ a21~170@) c21~174@) (Mul (Mul a21~170@ b21~172@) (Mul d21~176@ d21~176@))) (Mul (Mul (Mul c21~174@ b21~172@) (Add c21~174@ a21~170@)) (Mul (Mul b21~172@ d21~176@) (Mul a21~170@ 98))))) (=> (= temp_21_1~3684@ (Add (Mul (Mul (Mul a21~170@ a21~170@) c21~174@) (Mul (Mul a21~170@ b21~172@) (Mul d21~176@ d21~176@))) (Mul (Mul c21~174@ (Mul b21~172@ (Add c21~174@ a21~170@))) (Mul (Mul b21~172@ d21~176@) (Mul a21~170@ 98))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3611@ temp_21_1~3684@))) (=> (= temp_21_0~3611@ temp_21_1~3684@) (=> (= temp_22_0~3773@ (Mul (Add (Mul (Mul d22~184@ d22~184@) (Sub b22~180@ a22~178@)) (Mul (Mul c22~182@ b22~180@) (Mul a22~178@ b22~180@))) (Mul (Mul (Add b22~180@ a22~178@) (Mul a22~178@ d22~184@)) (Mul (Mul d22~184@ d22~184@) (Mul c22~182@ d22~184@))))) (=> (= temp_22_1~3838@ (Mul (Add (Mul d22~184@ (Mul d22~184@ (Sub b22~180@ a22~178@))) (Mul (Mul c22~182@ b22~180@) (Mul a22~178@ b22~180@))) (Mul (Mul (Add b22~180@ a22~178@) (Mul a22~178@ d22~184@)) (Mul (Mul d22~184@ d22~184@) (Mul c22~182@ d22~184@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3773@ temp_22_1~3838@))) (=> (= temp_22_0~3773@ temp_22_1~3838@) (=> (= temp_23_0~3927@ (Sub (Sub (Mul (Mul c23~190@ c23~190@) (Mul d23~192@ b23~188@)) (Mul (Mul c23~190@ b23~188@) (Mul b23~188@ d23~192@))) (Mul (Mul (Mul c23~190@ d23~192@) (Mul a23~186@ d23~192@)) (Sub (Mul c23~190@ c23~190@) (Add c23~190@ a23~186@))))) (=> (= temp_23_1~3992@ (Sub (Sub (Mul (Mul d23~192@ b23~188@) (Mul c23~190@ c23~190@)) (Mul (Mul c23~190@ b23~188@) (Mul b23~188@ d23~192@))) (Mul (Mul (Mul c23~190@ d23~192@) (Mul a23~186@ d23~192@)) (Sub (Mul c23~190@ c23~190@) (Add c23~190@ a23~186@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3927@ temp_23_1~3992@))) (=> (= temp_23_0~3927@ temp_23_1~3992@) (=> (= temp_24_0~4077@ (Add (Sub (Mul (Mul a24~194@ c24~198@) (Mul a24~194@ c24~198@)) (Sub (Mul d24~200@ a24~194@) d24~200@)) (Mul (Mul (Mul b24~196@ d24~200@) (Mul b24~196@ b24~196@)) (Mul (Mul c24~198@ b24~196@) (Mul b24~196@ b24~196@))))) (=> (= temp_24_1~4138@ (Add (Sub (Mul (Mul c24~198@ a24~194@) (Mul a24~194@ c24~198@)) (Sub (Mul d24~200@ a24~194@) d24~200@)) (Mul (Mul (Mul b24~196@ d24~200@) (Mul b24~196@ b24~196@)) (Mul (Mul c24~198@ b24~196@) (Mul b24~196@ b24~196@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~4077@ temp_24_1~4138@))) (=> (= temp_24_0~4077@ temp_24_1~4138@) (=> (= temp_25_0~4211@ (Mul (Mul (Add (Mul a25~202@ a25~202@) (Mul a25~202@ b25~204@)) (Add (Sub a25~202@ d25~208@) b25~204@)) (Sub a25~202@ (Mul (Mul b25~204@ d25~208@) (Mul b25~204@ d25~208@))))) (=> (= temp_25_1~4260@ (Mul (Mul (Add (Mul a25~202@ a25~202@) (Mul b25~204@ a25~202@)) (Add (Sub a25~202@ d25~208@) b25~204@)) (Sub a25~202@ (Mul (Mul b25~204@ d25~208@) (Mul b25~204@ d25~208@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~4211@ temp_25_1~4260@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
