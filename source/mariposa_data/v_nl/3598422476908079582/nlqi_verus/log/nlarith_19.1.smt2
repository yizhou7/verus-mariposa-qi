...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Add b0~4@ d0~8@)) (Sub a0~2@ (Mul b0~4@ b0~4@))) (Mul (Add (Add 95 a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~394@ (Mul (Mul (Add (Mul (Mul a0~2@ d0~8@) b0~4@) (Mul (Mul a0~2@ d0~8@) d0~8@)) (Sub a0~2@ (Mul b0~4@ b0~4@))) (Mul (Add (Add 95 a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~313@ temp_0_1~394@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~474@ (Sub (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul b1~12@ a1~10@) (Sub b1~12@ a1~10@))))) (=> (= temp_1_1~539@ (Sub (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ b1~12@)) (Mul d1~16@ (Mul d1~16@ (Mul b1~12@ d1~16@)))) (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul b1~12@ a1~10@) (Sub b1~12@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~474@ temp_1_1~539@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~615@ (Mul (Add (Mul (Add c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ a2~18@))) (Mul (Add (Mul a2~18@ a2~18@) (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ a2~18@) d2~24@)))) (=> (= temp_2_1~704@ (Add (Mul (Mul (Add c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Add (Mul a2~18@ a2~18@) (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ a2~18@) d2~24@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Add (Mul a2~18@ a2~18@) (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ a2~18@) d2~24@))))) (=> (= tmp%3@ (= temp_2_0~615@ temp_2_1~704@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~780@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Sub b3~28@ c3~30@) (Mul c3~30@ a3~26@))) (Mul (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ b3~28@)) (Mul b3~28@ (Add d3~32@ b3~28@))))) (=> (= temp_3_1~841@ (Mul (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Sub b3~28@ c3~30@) (Mul c3~30@ a3~26@))) (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ b3~28@))) (Mul b3~28@ (Add d3~32@ b3~28@)))) (=> (= tmp%4@ (= temp_3_0~780@ temp_3_1~841@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~913@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ d4~40@)) (Mul c4~38@ (Mul c4~38@ b4~36@))) (Mul (Mul a4~34@ (Mul a4~34@ d4~40@)) (Mul (Mul b4~36@ a4~34@) (Add b4~36@ d4~40@))))) (=> (= temp_4_1~970@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ d4~40@)) (Mul c4~38@ (Mul c4~38@ b4~36@))) (Mul (Mul a4~34@ (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Add b4~36@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~913@ temp_4_1~970@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1062@ (Mul (Add (Mul (Mul c5~46@ d5~48@) (Mul 26 c5~46@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1139@ (Mul (Add (Mul c5~46@ (Mul d5~48@ (Mul 26 c5~46@))) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1062@ temp_5_1~1139@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1215@ (Mul (Mul (Mul d6~56@ (Mul c6~54@ d6~56@)) (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ a6~50@))) (Sub (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Sub b6~52@ b6~52@))))) (=> (= temp_6_1~1276@ (Mul (Mul (Mul d6~56@ (Mul c6~54@ d6~56@)) (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ a6~50@))) (Sub (Mul (Mul (Mul d6~56@ a6~50@) b6~52@) b6~52@) (Mul (Mul c6~54@ c6~54@) (Sub b6~52@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1215@ temp_6_1~1276@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1356@ (Mul (Mul (Sub (Mul b7~60@ b7~60@) (Mul b7~60@ b7~60@)) (Add (Mul b7~60@ c7~62@) (Mul a7~58@ d7~64@))) (Add (Sub (Mul a7~58@ a7~58@) (Add c7~62@ a7~58@)) (Sub (Mul c7~62@ a7~58@) (Sub d7~64@ b7~60@))))) (=> (= temp_7_1~1421@ (Mul (Mul (Sub (Mul b7~60@ b7~60@) (Mul b7~60@ b7~60@)) (Add (Mul b7~60@ c7~62@) (Mul a7~58@ d7~64@))) (Add (Sub (Mul a7~58@ a7~58@) (Add c7~62@ a7~58@)) (Sub (Mul a7~58@ c7~62@) (Sub d7~64@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1356@ temp_7_1~1421@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1509@ (Add (Mul (Add a8~66@ (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul 0 a8~66@)) (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ d8~72@))))) (=> (= temp_8_1~1582@ (Add (Mul (Add a8~66@ (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ a8~66@))) (Mul (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul 0 a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1509@ temp_8_1~1582@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1670@ (Mul (Mul (Mul (Add b9~76@ a9~74@) (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul c9~78@ (Mul b9~76@ d9~80@)) (Mul (Mul 69 a9~74@) (Add c9~78@ d9~80@))))) (=> (= temp_9_1~1743@ (Mul (Mul (Mul c9~78@ (Mul b9~76@ d9~80@)) (Mul (Mul 69 a9~74@) (Add c9~78@ d9~80@))) (Mul (Mul (Add b9~76@ a9~74@) (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1670@ temp_9_1~1743@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1847@ (Mul (Mul (Mul (Add a10~82@ b10~84@) (Mul b10~84@ d10~88@)) (Sub (Mul 31 a10~82@) (Mul b10~84@ a10~82@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul d10~88@ b10~84@) (Sub 50 b10~84@))))) (=> (= temp_10_1~1936@ (Mul (Mul (Mul (Add a10~82@ b10~84@) (Mul d10~88@ b10~84@)) (Sub (Mul 31 a10~82@) (Mul b10~84@ a10~82@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ a10~82@)) (Mul (Mul d10~88@ b10~84@) (Sub 50 b10~84@))))) (=> (= tmp%11@ (= temp_10_0~1847@ temp_10_1~1936@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~2028@ (Mul (Sub (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul 24 a11~90@))) (Mul (Mul (Mul a11~90@ c11~94@) (Add b11~92@ d11~96@)) (Mul (Mul c11~94@ c11~94@) (Sub b11~92@ b11~92@))))) (=> (= temp_11_1~2105@ (Mul (Sub (Mul (Mul d11~96@ a11~90@) (Mul a11~90@ d11~96@)) (Mul (Mul a11~90@ d11~96@) (Mul 24 a11~90@))) (Mul (Mul (Mul a11~90@ c11~94@) (Add b11~92@ d11~96@)) (Mul (Mul c11~94@ c11~94@) (Sub b11~92@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~2028@ temp_11_1~2105@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2193@ (Mul (Mul (Mul (Add 21 d12~104@) (Mul b12~100@ d12~104@)) (Add (Mul b12~100@ c12~102@) (Mul a12~98@ b12~100@))) (Sub (Mul (Mul a12~98@ b12~100@) (Mul b12~100@ a12~98@)) (Mul c12~102@ (Mul c12~102@ c12~102@))))) (=> (= temp_12_1~2266@ (Mul (Sub (Mul (Mul a12~98@ b12~100@) (Mul b12~100@ a12~98@)) (Mul c12~102@ (Mul c12~102@ c12~102@))) (Mul (Mul (Add 21 d12~104@) (Mul b12~100@ d12~104@)) (Add (Mul b12~100@ c12~102@) (Mul a12~98@ b12~100@))))) (=> (= tmp%13@ (= temp_12_0~2193@ temp_12_1~2266@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2330@ (Mul (Mul (Sub (Mul b13~108@ c13~110@) (Mul c13~110@ b13~108@)) (Sub d13~112@ (Mul c13~110@ c13~110@))) (Mul a13~106@ (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ a13~106@))))) (=> (= temp_13_1~2379@ (Mul (Mul (Mul (Sub (Mul b13~108@ c13~110@) (Mul c13~110@ b13~108@)) (Sub d13~112@ (Mul c13~110@ c13~110@))) a13~106@) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ a13~106@)))) (=> (= tmp%14@ (= temp_13_0~2330@ temp_13_1~2379@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2459@ (Add (Mul (Add (Mul b14~116@ d14~120@) (Mul d14~120@ b14~116@)) (Sub (Mul a14~114@ b14~116@) (Mul b14~116@ d14~120@))) (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul c14~118@ a14~114@) (Mul c14~118@ c14~118@))))) (=> (= temp_14_1~2524@ (Add (Mul (Add (Mul b14~116@ d14~120@) (Mul d14~120@ b14~116@)) (Sub (Mul a14~114@ b14~116@) (Mul d14~120@ b14~116@))) (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ a14~114@)) (Mul (Mul c14~118@ a14~114@) (Mul c14~118@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2459@ temp_14_1~2524@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2604@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ c15~126@)) (Mul (Mul c15~126@ d15~128@) (Mul d15~128@ d15~128@))) (Mul (Mul (Mul b15~124@ d15~128@) (Sub d15~128@ d15~128@)) (Sub (Mul c15~126@ b15~124@) (Mul c15~126@ d15~128@))))) (=> (= temp_15_1~2669@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ c15~126@)) (Mul (Mul c15~126@ d15~128@) (Mul d15~128@ d15~128@))) (Mul (Mul (Mul b15~124@ d15~128@) (Sub d15~128@ d15~128@)) (Sub (Mul b15~124@ c15~126@) (Mul c15~126@ d15~128@))))) (=> (= tmp%16@ (= temp_15_0~2604@ temp_15_1~2669@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2749@ (Mul (Mul (Sub (Mul c16~134@ a16~130@) (Add a16~130@ c16~134@)) (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ b16~132@))) (Add (Sub (Mul a16~130@ b16~132@) (Mul b16~132@ c16~134@)) (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2814@ (Mul (Mul (Sub (Mul c16~134@ a16~130@) (Add a16~130@ c16~134@)) (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ b16~132@))) (Add (Sub (Mul a16~130@ b16~132@) (Mul b16~132@ c16~134@)) (Mul (Mul c16~134@ a16~130@) (Mul d16~136@ d16~136@))))) (=> (= tmp%17@ (= temp_16_0~2749@ temp_16_1~2814@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2894@ (Mul (Add (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ b17~140@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul a17~138@ b17~140@) (Mul d17~144@ c17~142@)) (Add (Mul b17~140@ c17~142@) (Mul a17~138@ a17~138@))))) (=> (= temp_17_1~2959@ (Mul (Add (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ b17~140@)) (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul a17~138@ b17~140@)) (Add (Mul b17~140@ c17~142@) (Mul a17~138@ a17~138@))))) (=> (= tmp%18@ (= temp_17_0~2894@ temp_17_1~2959@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~3035@ (Add (Sub (Mul (Mul c18~150@ c18~150@) (Add a18~146@ d18~152@)) (Mul a18~146@ (Mul a18~146@ d18~152@))) (Mul (Mul (Mul c18~150@ d18~152@) (Sub c18~150@ d18~152@)) (Sub (Mul c18~150@ b18~148@) (Mul b18~148@ a18~146@))))) (=> (= temp_18_1~3096@ (Add (Sub (Mul (Mul c18~150@ c18~150@) (Add a18~146@ d18~152@)) (Mul a18~146@ (Mul a18~146@ d18~152@))) (Mul (Mul c18~150@ (Mul d18~152@ (Sub c18~150@ d18~152@))) (Sub (Mul c18~150@ b18~148@) (Mul b18~148@ a18~146@))))) (=> (= tmp%19@ (= temp_18_0~3035@ temp_18_1~3096@)) (=> %%location_label%%18 tmp%19@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
