...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ a0~2@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~370@ (Add (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ a0~2@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~462@ (Sub (Mul (Mul (Add d1~16@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Add 20 a1~10@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Sub (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~539@ (Sub (Mul (Mul (Add 20 a1~10@) (Mul c1~14@ d1~16@)) (Mul (Add d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Sub (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~462@ temp_1_1~539@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~619@ (Sub (Mul (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Add a2~18@ a2~18@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~684@ (Sub (Mul (Mul (Add a2~18@ a2~18@) (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~619@ temp_2_1~684@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~776@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ b3~28@))) (Sub (Mul (Mul b3~28@ a3~26@) (Mul 97 d3~32@)) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~853@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ b3~28@))) (Sub (Mul (Mul b3~28@ a3~26@) (Mul 97 d3~32@)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~776@ temp_3_1~853@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~933@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~998@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~933@ temp_4_1~998@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1114@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ c5~46@)) (Add (Mul a5~42@ a5~42@) (Mul 0 d5~48@))) (Mul (Mul (Mul 73 a5~42@) (Mul c5~46@ a5~42@)) (Mul (Add d5~48@ b5~44@) (Mul 9 b5~44@))))) (=> (= temp_5_1~1215@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ c5~46@)) (Add (Mul a5~42@ a5~42@) (Mul 0 d5~48@))) (Mul (Mul (Mul 73 a5~42@) (Mul c5~46@ a5~42@)) (Mul (Add d5~48@ b5~44@) (Mul 9 b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1114@ temp_5_1~1215@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1287@ (Sub (Mul (Mul (Mul c6~54@ d6~56@) d6~56@) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@)) (Mul a6~50@ (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1344@ (Sub (Mul (Mul (Mul c6~54@ d6~56@) d6~56@) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@)) (Mul a6~50@ (Mul b6~52@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1287@ temp_6_1~1344@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1412@ (Mul (Mul b7~60@ (Mul (Mul b7~60@ a7~58@) (Add d7~64@ c7~62@))) (Sub (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@))))) (=> (= temp_7_1~1465@ (Mul (Mul (Mul b7~60@ (Mul b7~60@ a7~58@)) (Add d7~64@ c7~62@)) (Sub (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@))))) (=> (= tmp%8@ (= temp_7_0~1412@ temp_7_1~1465@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1533@ (Add (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ a8~66@)) c8~70@) (Mul (Mul (Sub a8~66@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1586@ (Add (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ a8~66@)) c8~70@) (Mul (Mul (Mul (Sub a8~66@ b8~68@) d8~72@) a8~66@) (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1533@ temp_8_1~1586@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1662@ (Mul (Mul (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ b9~76@)) (Mul c9~78@ (Mul d9~80@ d9~80@))) (Mul (Add (Mul d9~80@ b9~76@) (Sub b9~76@ a9~74@)) (Add (Mul a9~74@ d9~80@) (Mul d9~80@ b9~76@))))) (=> (= temp_9_1~1723@ (Mul (Mul (Mul (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ b9~76@)) c9~78@) (Mul d9~80@ d9~80@)) (Mul (Add (Mul d9~80@ b9~76@) (Sub b9~76@ a9~74@)) (Add (Mul a9~74@ d9~80@) (Mul d9~80@ b9~76@))))) (=> (= tmp%10@ (= temp_9_0~1662@ temp_9_1~1723@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1815@ (Mul (Mul (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ 34) (Add a10~82@ d10~88@))) (Mul (Add (Mul a10~82@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Sub c10~86@ a10~82@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~1908@ (Mul (Mul (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (Mul d10~88@ 34) (Add a10~82@ d10~88@))) (Add (Mul (Mul a10~82@ a10~82@) (Mul (Sub c10~86@ a10~82@) (Mul b10~84@ d10~88@))) (Mul (Mul a10~82@ a10~82@) (Mul (Sub c10~86@ a10~82@) (Mul b10~84@ d10~88@)))))) (=> (= tmp%11@ (= temp_10_0~1815@ temp_10_1~1908@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~2000@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ b11~92@)) (Sub (Mul 33 c11~94@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~2077@ (Mul (Mul (Mul a11~90@ (Mul a11~90@ (Mul d11~96@ b11~92@))) (Sub (Mul 33 c11~94@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul a11~90@ c11~94@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~2000@ temp_11_1~2077@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2165@ (Mul (Add (Mul (Mul b12~100@ 22) (Mul b12~100@ a12~98@)) (Sub (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)) (Mul b12~100@ (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2238@ (Mul (Add (Mul (Mul b12~100@ 22) (Mul b12~100@ a12~98@)) (Sub (Mul b12~100@ d12~104@) (Mul b12~100@ c12~102@))) (Mul (Mul (Mul (Mul c12~102@ d12~104@) c12~102@) d12~104@) (Mul b12~100@ (Mul b12~100@ a12~98@))))) (=> (= tmp%13@ (= temp_12_0~2165@ temp_12_1~2238@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2318@ (Mul (Add (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ c13~110@))) (Mul (Mul (Add a13~106@ a13~106@) (Add d13~112@ c13~110@)) (Mul (Add d13~112@ a13~106@) (Add b13~108@ a13~106@))))) (=> (= temp_13_1~2383@ (Mul (Add (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (Mul (Mul b13~108@ d13~112@) (Mul a13~106@ c13~110@))) (Mul (Mul (Add a13~106@ a13~106@) (Add d13~112@ c13~110@)) (Mul (Add d13~112@ a13~106@) (Add b13~108@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2318@ temp_13_1~2383@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2467@ (Mul (Mul (Add (Mul c14~118@ a14~114@) (Add a14~114@ a14~114@)) (Mul a14~114@ (Mul a14~114@ b14~116@))) (Sub (Mul (Mul c14~118@ c14~118@) b14~116@) (Mul (Mul 98 d14~120@) (Mul c14~118@ c14~118@))))) (=> (= temp_14_1~2536@ (Mul (Mul (Add (Mul c14~118@ a14~114@) (Add a14~114@ a14~114@)) (Mul a14~114@ (Mul b14~116@ a14~114@))) (Sub (Mul (Mul c14~118@ c14~118@) b14~116@) (Mul (Mul 98 d14~120@) (Mul c14~118@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2467@ temp_14_1~2536@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2604@ (Mul (Mul (Sub (Sub d15~128@ a15~122@) (Add a15~122@ a15~122@)) c15~126@) (Mul (Add (Mul b15~124@ a15~122@) (Mul a15~122@ c15~126@)) (Mul (Mul a15~122@ b15~124@) (Mul a15~122@ b15~124@))))) (=> (= temp_15_1~2657@ (Mul (Mul (Sub (Sub d15~128@ a15~122@) (Add a15~122@ a15~122@)) c15~126@) (Mul (Add (Mul b15~124@ a15~122@) (Mul a15~122@ c15~126@)) (Mul a15~122@ (Mul b15~124@ (Mul a15~122@ b15~124@)))))) (=> (= tmp%16@ (= temp_15_0~2604@ temp_15_1~2657@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2749@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) (Add a16~130@ a16~130@)) (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ b16~132@)) (Mul (Add b16~132@ a16~130@) (Mul d16~136@ 93))))) (=> (= temp_16_1~2826@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) (Add a16~130@ a16~130@)) (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ b16~132@)) (Mul (Add b16~132@ a16~130@) (Mul 93 d16~136@))))) (=> (= tmp%17@ (= temp_16_0~2749@ temp_16_1~2826@)) (=> %%location_label%%16 tmp%17@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
