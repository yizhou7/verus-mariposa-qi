...
(push)
 ...
 (declare-const temp_14_0~2593@ Int)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~471@ (Sub (Mul (Mul (Add d1~16@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Add 20
              a1~10@
             ) (Mul c1~14@ d1~16@)
            )
         ...
         (=>
          (= temp_1_1~548@ (Sub (Mul (Mul (Add 20 a1~10@) (Mul c1~14@ d1~16@)) (Mul (Add d1~16@
               c1~14@
              ) (Mul b1~12@ b1~12@)
             )
            ) (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Sub (Mul d1~16@ d1~16@) (Mul d1~16@
          ...
          (and
           ...
           (=>
            (= temp_1_0~471@ temp_1_1~548@)
            (=>
             (= temp_2_0~637@ (Sub (Mul (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Add a2~18@
                  a2~18@
                 ) (Mul b2~20@ c2~22@)
                )
             ...
             (=>
              (= temp_2_1~702@ (Sub (Mul (Mul (Add a2~18@ a2~18@) (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@
                   b2~20@
                  ) (Mul b2~20@ a2~18@)
                 )
                ) (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@
              ...
              (and
               ...
               (=>
                (= temp_2_0~637@ temp_2_1~702@)
                (=>
                 (= temp_3_0~803@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@
                      b3~28@
                     ) (Mul c3~30@ b3~28@)
                    )
                 ...
                 (=>
                  (= temp_3_1~880@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@
                       b3~28@
                      ) (Mul c3~30@ b3~28@)
                     )
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~803@ temp_3_1~880@)
                   ))
                   (=>
                    (= temp_3_0~803@ temp_3_1~880@)
                    (=>
                     (= temp_4_0~969@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@
                          b4~36@
                         ) (Mul b4~36@ d4~40@)
                        )
                     ...
                     (=>
                      (= temp_4_1~1034@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@
                           b4~36@
                          ) (Mul b4~36@ d4~40@)
                         )
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~969@ temp_4_1~1034@)
                        (=>
                         (= temp_5_0~1159@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ c5~46@)) (Add (Mul a5~42@
                              a5~42@
                             ) (Mul 0 d5~48@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1260@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ c5~46@)) (Add (Mul a5~42@
                               a5~42@
                              ) (Mul 0 d5~48@)
                             )
                            ) (Mul (Mul (Mul 73 a5~42@) (Mul c5~46@ a5~42@)) (Mul (Add d5~48@ b5~44@) (Mul 9 b5~44@)))
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1159@ temp_5_1~1260@)
                           ))
                           (=>
                            (= temp_5_0~1159@ temp_5_1~1260@)
                            (=>
                             (= temp_6_0~1341@ (Sub (Mul (Mul (Mul c6~54@ d6~56@) d6~56@) (Mul (Mul c6~54@ b6~52@)
                                 (Mul d6~56@ a6~50@)
                                )
                               ) (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@)) (Mul a6~50@ (Mul b6~52@ b6~52@)))
                             ))
                             (=>
                              (= temp_6_1~1398@ (Sub (Mul (Mul (Mul c6~54@ d6~56@) d6~56@) (Mul (Mul c6~54@ b6~52@)
                                  (Mul d6~56@ a6~50@)
                                 )
                                ) (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@)) (Mul a6~50@ (Mul b6~52@ b6~52@)))
                              ))
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1341@ temp_6_1~1398@)
                               ))
                               (=>
                                (= temp_6_0~1341@ temp_6_1~1398@)
                                (=>
                                 (= temp_7_0~1475@ (Mul (Mul b7~60@ (Mul (Mul b7~60@ a7~58@) (Add d7~64@ c7~62@))) (
                                    Sub (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Add a7~58@
                                      c7~62@
                                 )))))
                                 (=>
                                  (= temp_7_1~1528@ (Mul (Mul (Mul b7~60@ (Mul b7~60@ a7~58@)) (Add d7~64@ c7~62@)) (
                                     Sub (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Add a7~58@
                                       c7~62@
                                  )))))
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1475@ temp_7_1~1528@)
                                   ))
                                   (=>
                                    (= temp_7_0~1475@ temp_7_1~1528@)
                                    (=>
                                     (= temp_8_0~1605@ (Add (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ a8~66@)) c8~70@) (
                                        Mul (Mul (Sub a8~66@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Mul b8~68@
                                          a8~66@
                                     )))))
                                     (=>
                                      (= temp_8_1~1658@ (Add (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ a8~66@)) c8~70@) (
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1605@ temp_8_1~1658@)
                                       ))
                                       (=>
                                        (= temp_8_0~1605@ temp_8_1~1658@)
                                        (=>
                                         (= temp_9_0~1743@ (Mul (Mul (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ b9~76@)) (Mul c9~78@
                                             (Mul d9~80@ d9~80@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1804@ (Mul (Mul (Mul (Sub (Mul b9~76@ d9~80@) (Mul c9~78@ b9~76@)) c9~78@)
                                             (Mul d9~80@ d9~80@)
                                            ) (Mul (Add (Mul d9~80@ b9~76@) (Sub b9~76@ a9~74@)) (Add (Mul a9~74@ d9~80@) (Mul d9~80@
                                               b9~76@
                                          )))))
                                          (and
                                           ...
                                           (=>
                                            (= temp_9_0~1743@ temp_9_1~1804@)
                                            (=>
                                             (= temp_10_0~1905@ (Mul (Mul (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (
                                                  Mul d10~88@ 34
                                                 ) (Add a10~82@ d10~88@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1998@ (Mul (Mul (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (
                                                   Mul d10~88@ 34
                                                  ) (Add a10~82@ d10~88@)
                                                 )
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1905@ temp_10_1~1998@)
                                               ))
                                               (=>
                                                (= temp_10_0~1905@ temp_10_1~1998@)
                                                (=>
                                                 (= temp_11_0~2099@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ b11~92@)) (Sub (
                                                      Mul 33 c11~94@
                                                     ) (Mul a11~90@ b11~92@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2176@ (Mul (Mul (Mul a11~90@ (Mul a11~90@ (Mul d11~96@ b11~92@))) (Sub (
                                                       Mul 33 c11~94@
                                                      ) (Mul a11~90@ b11~92@)
                                                     )
                                                    ) (Mul (Mul (Mul a11~90@ c11~94@) (Sub b11~92@ d11~96@)) (Mul (Mul b11~92@ d11~96@)
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~2099@ temp_11_1~2176@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~2099@ temp_11_1~2176@)
                                                    (=>
                                                     (= temp_12_0~2273@ (Mul (Add (Mul (Mul b12~100@ 22) (Mul b12~100@ a12~98@)) (Sub (Mul
                                                          b12~100@ d12~104@
                                                         ) (Mul b12~100@ c12~102@)
                                                        )
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2346@ (Mul (Add (Mul (Mul b12~100@ 22) (Mul b12~100@ a12~98@)) (Sub (Mul
                                                           b12~100@ d12~104@
                                                          ) (Mul b12~100@ c12~102@)
                                                         )
                                                      ...
                                                      (and
                                                       ...
                                                       (=>
                                                        (= temp_12_0~2273@ temp_12_1~2346@)
                                                        (=>
                                                         (= temp_13_0~2435@ (Mul (Add (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2500@ (Mul (Add (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ b13~108@)) (
                                                          ...
                                                          (and
                                                           ...
                                                           (=>
                                                            (= temp_13_0~2435@ temp_13_1~2500@)
                                                            (=>
                                                             (= temp_14_0~2593@ (Mul (Mul (Add (Mul c14~118@ a14~114@) (Add a14~114@ a14~114@)) (
                                                                 Mul a14~114@ (Mul a14~114@ b14~116@)
                                                                )
                                                               ) (Sub (Mul (Mul c14~118@ c14~118@) b14~116@) (Mul (Mul 98 d14~120@) (Mul c14~118@ c14~118@)))
                                                             ))
                                                             (=>
                                                              (= temp_14_1~2662@ (Mul (Mul (Add (Mul c14~118@ a14~114@) (Add a14~114@ a14~114@)) (
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2593@ temp_14_1~2662@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2593@ temp_14_1~2662@)
                                                                (=>
                                                                 (= temp_15_0~2739@ (Mul (Mul (Sub (Sub d15~128@ a15~122@) (Add a15~122@ a15~122@)) c15~126@)
                                                                   (Mul (Add (Mul b15~124@ a15~122@) (Mul a15~122@ c15~126@)) (Mul (Mul a15~122@ b15~124@)
                                                                     (Mul a15~122@ b15~124@)
                                                                 ))))
                                                                 (=>
                                                                  (= temp_15_1~2792@ (Mul (Mul (Sub (Sub d15~128@ a15~122@) (Add a15~122@ a15~122@)) c15~126@)
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2739@ temp_15_1~2792@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2739@ temp_15_1~2792@)
                                                                    (=>
                                                                     (= temp_16_0~2893@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) (Add a16~130@ a16~130@)) (
                                                                     ...
                                                                     (=>
                                                                      (= temp_16_1~2970@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) (Add a16~130@ a16~130@)) (
                                                                          Mul (Mul c16~134@ c16~134@) (Mul c16~134@ d16~136@)
                                                                         )
                                                                        ) (Mul (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ b16~132@)) (Mul (Add b16~132@ a16~130@)
                                                                          (Mul 93 d16~136@)
