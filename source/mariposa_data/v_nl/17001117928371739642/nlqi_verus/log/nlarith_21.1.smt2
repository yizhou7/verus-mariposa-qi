...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@)) (Add (Mul b0~4@ a0~2@) (Mul d0~8@ d0~8@))) (Mul (Mul (Sub c0~6@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~370@ (Mul (Mul (Add (Mul b0~4@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))) (Mul (Mul (Sub c0~6@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~454@ (Mul (Mul (Mul d1~16@ (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ c1~14@) a1~10@)) (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ b1~12@)) (Mul (Add c1~14@ 26) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~523@ (Mul (Mul (Mul d1~16@ (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ c1~14@) a1~10@)) (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ b1~12@)) (Mul (Add c1~14@ 26) (Mul c1~14@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~454@ temp_1_1~523@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~603@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Add a2~18@ d2~24@)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ b2~20@)) (Add (Mul a2~18@ d2~24@) (Sub d2~24@ b2~20@))))) (=> (= temp_2_1~668@ (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Add a2~18@ d2~24@)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ b2~20@)) (Add (Mul d2~24@ a2~18@) (Sub d2~24@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~603@ temp_2_1~668@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~760@ (Add (Mul (Sub (Mul d3~32@ a3~26@) (Mul 33 a3~26@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Mul b3~28@ d3~32@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~837@ (Add (Mul (Sub (Mul d3~32@ a3~26@) (Mul 33 a3~26@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Mul b3~28@ d3~32@) (Mul d3~32@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~760@ temp_3_1~837@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~917@ (Mul (Mul (Add (Mul d4~40@ c4~38@) (Sub b4~36@ b4~36@)) (Mul (Add d4~40@ b4~36@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul b4~36@ d4~40@) (Sub c4~38@ b4~36@)) (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~982@ (Mul (Mul (Add (Mul d4~40@ c4~38@) (Sub b4~36@ b4~36@)) (Mul (Add d4~40@ b4~36@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul b4~36@ d4~40@) (Sub c4~38@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~917@ temp_4_1~982@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1074@ (Add (Mul (Mul (Sub d5~48@ a5~42@) (Mul 17 b5~44@)) (Mul (Sub d5~48@ d5~48@) (Mul b5~44@ b5~44@))) (Add (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1151@ (Add (Mul (Mul (Mul (Sub d5~48@ a5~42@) (Mul 17 b5~44@)) (Sub d5~48@ d5~48@)) (Mul b5~44@ b5~44@)) (Add (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1074@ temp_5_1~1151@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1219@ (Mul (Mul (Add (Mul c6~54@ b6~52@) (Sub b6~52@ d6~56@)) (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ c6~54@))) (Mul c6~54@ (Mul (Mul c6~54@ b6~52@) (Add d6~56@ c6~54@))))) (=> (= temp_6_1~1272@ (Mul (Mul (Add (Mul c6~54@ b6~52@) (Sub b6~52@ d6~56@)) (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ b6~52@))) (Mul c6~54@ (Mul (Mul c6~54@ b6~52@) (Add d6~56@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1219@ temp_6_1~1272@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1356@ (Mul (Mul (Mul (Mul d7~64@ d7~64@) b7~60@) (Mul (Mul b7~60@ b7~60@) (Sub d7~64@ a7~58@))) (Mul (Mul (Mul c7~62@ c7~62@) (Sub 43 d7~64@)) (Add c7~62@ (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1425@ (Mul (Mul (Mul (Mul d7~64@ d7~64@) b7~60@) (Mul (Mul b7~60@ b7~60@) (Sub d7~64@ a7~58@))) (Mul (Mul (Mul c7~62@ c7~62@) (Sub 43 d7~64@)) (Add c7~62@ (Mul c7~62@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1356@ temp_7_1~1425@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1505@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ a8~66@)) (Add (Mul b8~68@ a8~66@) (Add a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ b8~68@) (Add a8~66@ c8~70@)) (Mul (Sub d8~72@ a8~66@) (Mul c8~70@ b8~68@))))) (=> (= temp_8_1~1570@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ a8~66@)) (Add (Mul b8~68@ a8~66@) (Add a8~66@ a8~66@))) (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Add a8~66@ c8~70@)) (Sub d8~72@ a8~66@)) (Mul c8~70@ b8~68@)))) (=> (= tmp%9@ (= temp_8_0~1505@ temp_8_1~1570@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1642@ (Mul (Mul (Mul d9~80@ (Mul b9~76@ c9~78@)) (Mul (Mul b9~76@ b9~76@) a9~74@)) (Mul (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ b9~76@) (Sub c9~78@ a9~74@))))) (=> (= temp_9_1~1699@ (Mul (Mul (Mul (Mul d9~80@ (Mul b9~76@ c9~78@)) (Mul (Mul b9~76@ b9~76@) a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ a9~74@))) (Mul (Mul a9~74@ b9~76@) (Sub c9~78@ a9~74@)))) (=> (= tmp%10@ (= temp_9_0~1642@ temp_9_1~1699@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1751@ (Mul (Mul (Mul (Add a10~82@ c10~86@) (Mul a10~82@ a10~82@)) (Sub (Mul c10~86@ b10~84@) (Mul c10~86@ a10~82@))) d10~88@)) (=> (= temp_10_1~1788@ (Mul (Mul (Mul (Add a10~82@ c10~86@) (Mul a10~82@ a10~82@)) (Sub (Mul c10~86@ b10~84@) (Mul c10~86@ a10~82@))) d10~88@)) (=> (= tmp%11@ (= temp_10_0~1751@ temp_10_1~1788@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1868@ (Sub (Mul (Sub (Mul d11~96@ c11~94@) (Mul 31 b11~92@)) d11~96@) (Sub (Mul (Add c11~94@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~1933@ (Sub (Mul (Sub (Mul d11~96@ c11~94@) (Mul 31 b11~92@)) d11~96@) (Sub (Mul (Add c11~94@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1868@ temp_11_1~1933@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2001@ (Mul (Mul (Sub (Mul c12~102@ d12~104@) (Mul a12~98@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul d12~104@ a12~98@) (Add b12~100@ c12~102@)) b12~100@))) (=> (= temp_12_1~2054@ (Mul (Mul (Sub (Mul c12~102@ d12~104@) (Mul a12~98@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul d12~104@ c12~102@))) (Mul (Mul d12~104@ (Mul a12~98@ (Add b12~100@ c12~102@))) b12~100@))) (=> (= tmp%13@ (= temp_12_0~2001@ temp_12_1~2054@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2134@ (Sub (Mul (Mul (Mul c13~110@ a13~106@) (Mul c13~110@ b13~108@)) (Add (Mul b13~108@ c13~110@) (Add c13~110@ a13~106@))) (Mul (Sub (Mul d13~112@ d13~112@) (Mul b13~108@ c13~110@)) (Sub (Add a13~106@ d13~112@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2199@ (Sub (Mul (Add (Mul b13~108@ c13~110@) (Add c13~110@ a13~106@)) (Mul (Mul c13~110@ a13~106@) (Mul c13~110@ b13~108@))) (Mul (Sub (Mul d13~112@ d13~112@) (Mul b13~108@ c13~110@)) (Sub (Add a13~106@ d13~112@) (Mul d13~112@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2134@ temp_13_1~2199@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2275@ (Mul (Sub (Mul (Mul b14~116@ a14~114@) d14~120@) (Mul (Sub d14~120@ d14~120@) (Mul c14~118@ c14~118@))) (Mul (Mul (Mul c14~118@ a14~114@) (Mul d14~120@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Mul d14~120@ a14~114@))))) (=> (= temp_14_1~2336@ (Mul (Sub (Mul (Mul b14~116@ a14~114@) d14~120@) (Mul (Sub d14~120@ d14~120@) (Mul c14~118@ c14~118@))) (Mul (Mul (Mul c14~118@ a14~114@) (Mul d14~120@ b14~116@)) (Mul (Mul d14~120@ a14~114@) (Mul a14~114@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2275@ temp_14_1~2336@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2412@ (Mul (Mul (Add (Add d15~128@ c15~126@) (Mul b15~124@ c15~126@)) (Mul (Mul c15~126@ c15~126@) (Mul c15~126@ a15~122@))) (Mul (Mul (Mul c15~126@ d15~128@) (Mul d15~128@ a15~122@)) (Mul (Mul a15~122@ c15~126@) a15~122@)))) (=> (= temp_15_1~2473@ (Mul (Mul (Add (Add d15~128@ c15~126@) (Mul b15~124@ c15~126@)) (Mul (Mul c15~126@ c15~126@) (Mul c15~126@ a15~122@))) (Mul (Mul (Mul c15~126@ d15~128@) (Mul d15~128@ a15~122@)) (Mul (Mul c15~126@ a15~122@) a15~122@)))) (=> (= tmp%16@ (= temp_15_0~2412@ temp_15_1~2473@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2513@ (Mul d16~136@ (Add b16~132@ (Mul (Mul c16~134@ c16~134@) (Mul b16~132@ d16~136@))))) (=> (= temp_16_1~2538@ (Mul d16~136@ (Add b16~132@ (Mul c16~134@ (Mul c16~134@ (Mul b16~132@ d16~136@)))))) (=> (= tmp%17@ (= temp_16_0~2513@ temp_16_1~2538@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2630@ (Mul (Mul (Mul (Mul c17~142@ c17~142@) (Mul a17~138@ c17~142@)) (Mul (Mul c17~142@ c17~142@) (Mul c17~142@ d17~144@))) (Mul (Mul (Mul d17~144@ 99) (Mul c17~142@ a17~138@)) (Add (Sub a17~138@ b17~140@) (Mul d17~144@ b17~140@))))) (=> (= temp_17_1~2707@ (Mul (Mul (Mul (Mul (Mul c17~142@ c17~142@) (Mul a17~138@ c17~142@)) (Mul c17~142@ c17~142@)) (Mul c17~142@ d17~144@)) (Mul (Mul (Mul d17~144@ 99) (Mul c17~142@ a17~138@)) (Add (Sub a17~138@ b17~140@) (Mul d17~144@ b17~140@))))) (=> (= tmp%18@ (= temp_17_0~2630@ temp_17_1~2707@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2783@ (Add (Sub (Add (Mul b18~148@ d18~152@) (Mul d18~152@ c18~150@)) (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ a18~146@))) (Add (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ a18~146@)) (Mul (Mul c18~150@ d18~152@) d18~152@)))) (=> (= temp_18_1~2844@ (Add (Sub (Add (Mul b18~148@ d18~152@) (Mul d18~152@ c18~150@)) (Mul (Mul c18~150@ c18~150@) (Mul d18~152@ a18~146@))) (Add (Mul (Mul b18~148@ b18~148@) (Mul a18~146@ a18~146@)) (Mul (Mul c18~150@ d18~152@) d18~152@)))) (=> (= tmp%19@ (= temp_18_0~2783@ temp_18_1~2844@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2916@ (Mul (Mul (Mul (Mul b19~156@ b19~156@) (Add b19~156@ b19~156@)) (Sub (Add c19~158@ b19~156@) (Mul b19~156@ c19~158@))) (Mul (Add c19~158@ (Mul b19~156@ a19~154@)) (Mul (Mul c19~158@ a19~154@) c19~158@)))) (=> (= temp_19_1~2973@ (Mul (Mul (Add c19~158@ (Mul b19~156@ a19~154@)) (Mul (Mul c19~158@ a19~154@) c19~158@)) (Mul (Mul (Mul b19~156@ b19~156@) (Add b19~156@ b19~156@)) (Sub (Add c19~158@ b19~156@) (Mul b19~156@ c19~158@))))) (=> (= tmp%20@ (= temp_19_0~2916@ temp_19_1~2973@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3053@ (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Add d20~168@ b20~164@)) (Sub (Mul b20~164@ b20~164@) (Sub b20~164@ b20~164@))) (Mul (Mul (Mul c20~166@ a20~162@) (Mul b20~164@ b20~164@)) (Mul (Sub b20~164@ a20~162@) (Mul c20~166@ d20~168@))))) (=> (= temp_20_1~3118@ (Mul (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Add d20~168@ b20~164@)) (Sub (Mul b20~164@ b20~164@) (Sub b20~164@ b20~164@))) (Mul (Mul c20~166@ a20~162@) (Mul b20~164@ b20~164@))) (Mul (Sub b20~164@ a20~162@) (Mul c20~166@ d20~168@)))) (=> (= tmp%21@ (= temp_20_0~3053@ temp_20_1~3118@)) (=> %%location_label%%20 tmp%21@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
