...
(set-info :comment ";; mariposa_data/v_nl//15296810156270931264/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_12_0~2337@ Int)
...
(declare-const temp_15_0~2849@ Int)
(declare-const temp_15_1~2914@ Int)
(declare-const temp_16_0~3007@ Int)
(declare-const temp_16_1~3072@ Int)
(declare-const temp_17_0~3177@ Int)
(declare-const temp_17_1~3254@ Int)
(declare-const temp_18_0~3377@ Int)
(declare-const temp_18_1~3438@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ a0~2@)) (Sub (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@))) (Mul (Mul (Sub b0~4@ d0~8@) (Sub a0~2@ d0~8@)) (Sub (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ a0~2@)) (Sub (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@))) (Mul (Mul (Sub b0~4@ d0~8@) (Sub a0~2@ d0~8@)) (Sub (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ d0~8@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~455@ (Mul (Mul (Add (Mul b1~12@ c1~14@) (Sub d1~16@ b1~12@)) (Sub c1~14@ (Mul b1~12@ d1~16@))) (Add (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ b1~12@)) (Sub (Add c1~14@ b1~12@) c1~14@)))) (=> (= temp_1_1~512@ (Mul (Mul (Add (Mul b1~12@ c1~14@) (Sub d1~16@ b1~12@)) (Sub c1~14@ (Mul b1~12@ d1~16@))) (Add (Mul d1~16@ (Mul c1~14@ (Mul d1~16@ b1~12@))) (Sub (Add c1~14@ b1~12@) c1~14@)))) (and (=> (= tmp%1@ (Mul d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d1~16@ c1~14@ tmp%1@) (=> %%location_label%%1 (= temp_1_0~455@ temp_1_1~512@)))) (=> (= temp_1_0~455@ temp_1_1~512@) (=> (= temp_2_0~611@ (Mul (Mul (Mul (Add b2~20@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Add (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~676@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Add b2~20@ a2~18@) (Mul a2~18@ c2~22@))) (Mul (Add (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ d2~24@))))) (and (=> (= tmp%2@ (Mul (Add b2~20@ a2~18@) (Mul a2~18@ c2~22@))) (=> (= tmp%3@ (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~611@ temp_2_1~676@))))) (=> (= temp_2_0~611@ temp_2_1~676@) (=> (= temp_3_0~789@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Sub c3~30@ b3~28@)) (Mul (Mul c3~30@ c3~30@) c3~30@)) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~850@ (Mul (Mul (Mul (Sub c3~30@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ c3~30@) c3~30@)) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@))))) (and (=> (= tmp%4@ (Mul d3~32@ d3~32@)) (=> (= tmp%5@ (Sub c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~789@ temp_3_1~850@))))) (=> (= temp_3_0~789@ temp_3_1~850@) (=> (= temp_4_0~951@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@))) (Mul (Sub (Mul d4~40@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Add a4~34@ c4~38@) (Add d4~40@ c4~38@))))) (=> (= temp_4_1~1012@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@))) (Mul (Mul (Sub d4~40@ d4~40@) a4~34@) (Mul (Add a4~34@ c4~38@) (Add d4~40@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d4~40@ d4~40@ a4~34@) (=> %%location_label%%4 (= temp_4_0~951@ temp_4_1~1012@))) (=> (= temp_4_0~951@ temp_4_1~1012@) (=> (= temp_5_0~1103@ (Sub (Mul (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ a5~42@)) (Add (Mul b5~44@ a5~42@) (Mul a5~42@ d5~48@))) (Mul (Add (Mul a5~42@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ c5~46@) a5~42@)))) (=> (= temp_5_1~1164@ (Sub (Mul (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ a5~42@)) (Add (Mul b5~44@ a5~42@) (Mul a5~42@ d5~48@))) (Mul (Add (Mul a5~42@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul c5~46@ d5~48@) a5~42@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1103@ temp_5_1~1164@))) (=> (= temp_5_0~1103@ temp_5_1~1164@) (=> (= temp_6_0~1269@ (Mul (Mul (Sub (Mul b6~52@ c6~54@) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul d6~56@ 73) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1346@ (Mul (Mul (Mul (Mul d6~56@ 73) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@))) (Mul (Sub (Mul b6~52@ c6~54@) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ a6~50@))))) (and (=> (= tmp%6@ (Mul (Sub (Mul b6~52@ c6~54@) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ a6~50@)))) (=> (= tmp%7@ (Mul (Mul (Mul d6~56@ 73) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%6 (= temp_6_0~1269@ temp_6_1~1346@))))) (=> (= temp_6_0~1269@ temp_6_1~1346@) (=> (= temp_7_0~1507@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Sub b7~60@ d7~64@))) (Mul (Mul (Sub d7~64@ d7~64@) (Mul c7~62@ d7~64@)) (Sub (Add a7~58@ b7~60@) (Sub a7~58@ c7~62@))))) (=> (= temp_7_1~1572@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Sub b7~60@ d7~64@))) (Mul (Mul (Mul (Sub d7~64@ d7~64@) c7~62@) d7~64@) (Sub (Add a7~58@ b7~60@) (Sub a7~58@ c7~62@))))) (and (=> (= tmp%8@ (Sub d7~64@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ c7~62@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1507@ temp_7_1~1572@)))) (=> (= temp_7_0~1507@ temp_7_1~1572@) (=> (= temp_8_0~1695@ (Mul (Mul (Mul (Mul 83 a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Sub d8~72@ 16) (Mul a8~66@ b8~68@))))) (=> (= temp_8_1~1784@ (Mul (Mul (Mul (Mul a8~66@ 83) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Sub d8~72@ 16) (Mul a8~66@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 83 a8~66@) (=> %%location_label%%8 (= temp_8_0~1695@ temp_8_1~1784@))) (=> (= temp_8_0~1695@ temp_8_1~1784@) (=> (= temp_9_0~1885@ (Mul (Mul (Mul (Sub d9~80@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Add d9~80@ c9~78@) (Mul b9~76@ c9~78@))) (Mul (Mul d9~80@ (Mul c9~78@ a9~74@)) (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@))))) (=> (= temp_9_1~1946@ (Mul (Mul (Mul (Sub d9~80@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Add d9~80@ c9~78@) (Mul b9~76@ c9~78@))) (Mul (Mul d9~80@ (Mul a9~74@ c9~78@)) (Sub (Mul b9~76@ b9~76@) (Mul c9~78@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c9~78@ a9~74@) (=> %%location_label%%9 (= temp_9_0~1885@ temp_9_1~1946@))) (=> (= temp_9_0~1885@ temp_9_1~1946@) (=> (= temp_10_0~2039@ (Sub (Mul (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ b10~84@))) (Mul (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ a10~82@))))) (=> (= temp_10_1~2104@ (Sub (Mul (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ b10~84@))) (Mul (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ b10~84@)) (Mul c10~86@ (Mul a10~82@ (Mul b10~84@ a10~82@)))))) (and (=> (= tmp%9@ (Mul b10~84@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c10~86@ a10~82@ tmp%9@) (=> %%location_label%%10 (= temp_10_0~2039@ temp_10_1~2104@)))) (=> (= temp_10_0~2039@ temp_10_1~2104@) (=> (= temp_11_0~2187@ (Sub (Mul c11~94@ (Sub (Sub a11~90@ b11~92@) (Add b11~92@ c11~94@))) (Add (Mul (Mul b11~92@ a11~90@) (Sub d11~96@ a11~90@)) (Mul b11~92@ (Add a11~90@ c11~94@))))) (=> (= temp_11_1~2236@ (Sub (Mul c11~94@ (Sub (Sub a11~90@ b11~92@) (Add b11~92@ c11~94@))) (Add (Mul (Sub d11~96@ a11~90@) (Mul b11~92@ a11~90@)) (Mul b11~92@ (Add a11~90@ c11~94@))))) (and (=> (= tmp%10@ (Mul b11~92@ a11~90@)) (=> (= tmp%11@ (Sub d11~96@ a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%11 (= temp_11_0~2187@ temp_11_1~2236@))))) (=> (= temp_11_0~2187@ temp_11_1~2236@) (=> (= temp_12_0~2337@ (Mul (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ b12~100@)) (Add (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@))) (Mul (Sub (Mul b12~100@ d12~104@) (Mul d12~104@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Sub b12~100@ d12~104@))))) (=> (= temp_12_1~2402@ (Mul (Mul (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ d12~104@)) (Add (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@))) (Mul (Sub (Mul b12~100@ d12~104@) (Mul d12~104@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Sub b12~100@ d12~104@))))) (and (=> (= tmp%12@ (Mul a12~98@ d12~104@)) (=> (= tmp%13@ (Mul a12~98@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%12 (= temp_12_0~2337@ temp_12_1~2402@))))) (=> (= temp_12_0~2337@ temp_12_1~2402@) (=> (= temp_13_0~2503@ (Mul (Mul (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ b13~108@)) (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@))) (Mul (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ d13~112@)) (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2568@ (Mul (Mul (Mul d13~112@ d13~112@) (Mul (Mul b13~108@ b13~108@) (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@)))) (Mul (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ d13~112@)) (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ d13~112@))))) (and (=> (= tmp%14@ (Mul d13~112@ d13~112@)) (=> (= tmp%15@ (Mul b13~108@ b13~108@)) (=> (= tmp%16@ (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%13 (= temp_13_0~2503@ temp_13_1~2568@)))))) (=> (= temp_13_0~2503@ temp_13_1~2568@) (=> (= temp_14_0~2683@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ b14~116@)) (Sub (Mul b14~116@ a14~114@) (Mul b14~116@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul c14~118@ a14~114@)) (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2748@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ b14~116@)) (Sub (Mul b14~116@ a14~114@) (Mul b14~116@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul c14~118@ a14~114@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ d14~120@))))) (and (=> (= tmp%17@ (Mul d14~120@ d14~120@)) (=> (= tmp%18@ (Mul b14~116@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%14 (= temp_14_0~2683@ temp_14_1~2748@))))) (=> (= temp_14_0~2683@ temp_14_1~2748@) (=> (= temp_15_0~2849@ (Mul (Mul (Mul (Mul a15~122@ b15~124@) (Sub c15~126@ d15~128@)) (Sub (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@))) (Mul (Mul (Mul d15~128@ c15~126@) (Add d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Mul b15~124@ c15~126@))))) (=> (= temp_15_1~2914@ (Mul (Mul (Mul (Mul a15~122@ b15~124@) (Sub c15~126@ d15~128@)) (Sub (Mul b15~124@ d15~128@) (Mul c15~126@ a15~122@))) (Mul (Mul (Mul d15~128@ c15~126@) (Add d15~128@ d15~128@)) (Mul (Mul a15~122@ a15~122@) (Mul b15~124@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d15~128@ b15~124@) (=> %%location_label%%15 (= temp_15_0~2849@ temp_15_1~2914@))) (=> (= temp_15_0~2849@ temp_15_1~2914@) (=> (= temp_16_0~3007@ (Mul (Mul (Mul (Mul d16~136@ c16~134@) (Mul d16~136@ c16~134@)) (Mul (Mul c16~134@ c16~134@) (Mul b16~132@ b16~132@))) (Mul (Sub (Mul c16~134@ b16~132@) (Mul a16~130@ d16~136@)) (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ c16~134@))))) (=> (= temp_16_1~3072@ (Mul (Mul (Mul (Mul d16~136@ c16~134@) (Mul d16~136@ c16~134@)) (Mul (Mul c16~134@ c16~134@) (Mul b16~132@ b16~132@))) (Mul (Sub (Mul c16~134@ b16~132@) (Mul a16~130@ d16~136@)) (Mul (Mul d16~136@ b16~132@) (Mul d16~136@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b16~132@ d16~136@) (=> %%location_label%%16 (= temp_16_0~3007@ temp_16_1~3072@))) (=> (= temp_16_0~3007@ temp_16_1~3072@) (=> (= temp_17_0~3177@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ a17~138@)) (Mul (Mul c17~142@ a17~138@) (Mul 12 a17~138@))) (Mul (Sub (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul a17~138@ d17~144@) (Mul b17~140@ c17~142@))))) (=> (= temp_17_1~3254@ (Mul (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ a17~138@)) (Mul c17~142@ a17~138@)) (Mul 12 a17~138@)) (Mul (Sub (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul a17~138@ d17~144@) (Mul b17~140@ c17~142@))))) (and (=> (= tmp%19@ (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ a17~138@))) (=> (= tmp%20@ (Mul c17~142@ a17~138@)) (=> (= tmp%21@ (Mul 12 a17~138@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%17 (= temp_17_0~3177@ temp_17_1~3254@)))))) (=> (= temp_17_0~3177@ temp_17_1~3254@) (=> (= temp_18_0~3377@ (Mul (Sub (Mul (Mul c18~150@ a18~146@) (Mul d18~152@ c18~150@)) (Add (Mul a18~146@ b18~148@) c18~150@)) (Mul (Mul (Mul b18~148@ a18~146@) (Mul d18~152@ d18~152@)) (Mul (Mul d18~152@ c18~150@) (Mul c18~150@ b18~148@))))) (=> (= temp_18_1~3438@ (Mul (Sub (Mul (Mul c18~150@ a18~146@) (Mul d18~152@ c18~150@)) (Add (Mul a18~146@ b18~148@) c18~150@)) (Mul (Mul (Mul b18~148@ a18~146@) (Mul d18~152@ d18~152@)) (Mul d18~152@ (Mul c18~150@ (Mul c18~150@ b18~148@)))))) (=> (= tmp%22@ (Mul c18~150@ b18~148@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d18~152@ c18~150@ tmp%22@) (=> %%location_label%%18 (= temp_18_0~3377@ temp_18_1~3438@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
