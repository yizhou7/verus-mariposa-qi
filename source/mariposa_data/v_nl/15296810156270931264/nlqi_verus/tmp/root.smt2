...
(push)
 ...
 (declare-const temp_6_1~1282@ Int)
 ...
 (declare-const temp_9_1~1784@ Int)
 (declare-const temp_10_0~1873@ Int)
 (declare-const temp_10_1~1938@ Int)
 (declare-const temp_11_0~2011@ Int)
 (declare-const temp_11_1~2060@ Int)
 ...
 (declare-const temp_17_0~2931@ Int)
 (declare-const temp_17_1~3008@ Int)
 (declare-const temp_18_0~3093@ Int)
 (declare-const temp_18_1~3154@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~451@ (Mul (Mul (Add (Mul b1~12@ c1~14@) (Sub d1~16@ b1~12@)) (Sub c1~14@
             (Mul b1~12@ d1~16@)
            )
           ) (Add (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ b1~12@)) (Sub (Add c1~14@ b1~12@) c1~14@))
         ))
         (=>
          (= temp_1_1~508@ (Mul (Mul (Add (Mul b1~12@ c1~14@) (Sub d1~16@ b1~12@)) (Sub c1~14@
              (Mul b1~12@ d1~16@)
             )
          ...
          (and
           ...
           (=>
            (= temp_1_0~451@ temp_1_1~508@)
            (=>
             (= temp_2_0~597@ (Mul (Mul (Mul (Add b2~20@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul d2~24@
                  d2~24@
                 ) (Mul b2~20@ c2~22@)
                )
             ...
             (=>
              (= temp_2_1~662@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Add b2~20@
                   a2~18@
                  ) (Mul a2~18@ c2~22@)
                 )
                ) (Mul (Add (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@
              ...
              (and
               ...
               (=>
                (= temp_2_0~597@ temp_2_1~662@)
                (=>
                 (= temp_3_0~747@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Sub c3~30@ b3~28@)) (Mul (Mul c3~30@
                      c3~30@
                     ) c3~30@
                    )
                 ...
                 (=>
                  (= temp_3_1~808@ (Mul (Mul (Mul (Sub c3~30@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@
                       c3~30@
                      ) c3~30@
                     )
                    ) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~747@ temp_3_1~808@)
                   ))
                   (=>
                    (= temp_3_0~747@ temp_3_1~808@)
                    (=>
                     (= temp_4_0~897@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@
                          d4~40@
                         ) (Mul d4~40@ d4~40@)
                        )
                     ...
                     (=>
                      (= temp_4_1~958@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@
                           d4~40@
                          ) (Mul d4~40@ d4~40@)
                         )
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~897@ temp_4_1~958@)
                       ))
                       (=>
                        (= temp_4_0~897@ temp_4_1~958@)
                        (=>
                         (= temp_5_0~1043@ (Sub (Mul (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ a5~42@)) (Add (Mul b5~44@
                              a5~42@
                             ) (Mul a5~42@ d5~48@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1104@ (Sub (Mul (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ a5~42@)) (Add (Mul b5~44@
                               a5~42@
                              ) (Mul a5~42@ d5~48@)
                             )
                          ...
                          (and
                           ...
                           (=>
                            (= temp_5_0~1043@ temp_5_1~1104@)
                            (=>
                             (= temp_6_0~1205@ (Mul (Mul (Sub (Mul b6~52@ c6~54@) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@
                                  d6~56@
                                 ) (Mul a6~50@ a6~50@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1282@ (Mul (Mul (Mul (Mul d6~56@ 73) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@
                                   a6~50@
                                  ) (Mul c6~54@ b6~52@)
                                 )
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1205@ temp_6_1~1282@)
                               ))
                               (=>
                                (= temp_6_0~1205@ temp_6_1~1282@)
                                (=>
                                 (= temp_7_0~1371@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ a7~58@)) (Mul (Mul b7~60@
                                      a7~58@
                                     ) (Sub b7~60@ d7~64@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1436@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ a7~58@)) (Mul (Mul b7~60@
                                       a7~58@
                                      ) (Sub b7~60@ d7~64@)
                                     )
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1371@ temp_7_1~1436@)
                                   ))
                                   (=>
                                    (= temp_7_0~1371@ temp_7_1~1436@)
                                    (=>
                                     (= temp_8_0~1549@ (Mul (Mul (Mul (Mul 83 a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@
                                          b8~68@
                                         ) (Mul b8~68@ b8~68@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1638@ (Mul (Mul (Mul (Mul a8~66@ 83) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@
                                           b8~68@
                                          ) (Mul b8~68@ b8~68@)
                                         )
                                        ) (Mul (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Sub d8~72@ 16) (Mul a8~66@
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1549@ temp_8_1~1638@)
                                       ))
                                       (=>
                                        (= temp_8_0~1549@ temp_8_1~1638@)
                                        (=>
                                         (= temp_9_0~1723@ (Mul (Mul (Mul (Sub d9~80@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Add d9~80@
                                              c9~78@
                                             ) (Mul b9~76@ c9~78@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1784@ (Mul (Mul (Mul (Sub d9~80@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Add d9~80@
                                               c9~78@
                                              ) (Mul b9~76@ c9~78@)
                                             )
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1723@ temp_9_1~1784@)
                                           ))
                                           (=>
                                            (= temp_9_0~1723@ temp_9_1~1784@)
                                            (=>
                                             (= temp_10_0~1873@ (Sub (Mul (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (
                                                  Mul c10~86@ c10~86@
                                                 ) (Mul b10~84@ b10~84@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1938@ (Sub (Mul (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (
                                                   Mul c10~86@ c10~86@
                                                  ) (Mul b10~84@ b10~84@)
                                                 )
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1873@ temp_10_1~1938@)
                                               ))
                                               (=>
                                                (= temp_10_0~1873@ temp_10_1~1938@)
                                                (=>
                                                 (= temp_11_0~2011@ (Sub (Mul c11~94@ (Sub (Sub a11~90@ b11~92@) (Add b11~92@ c11~94@)))
                                                   (Add (Mul (Mul b11~92@ a11~90@) (Sub d11~96@ a11~90@)) (Mul b11~92@ (Add a11~90@ c11~94@)))
                                                 ))
                                                 (=>
                                                  (= temp_11_1~2060@ (Sub (Mul c11~94@ (Sub (Sub a11~90@ b11~92@) (Add b11~92@ c11~94@)))
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~2011@ temp_11_1~2060@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~2011@ temp_11_1~2060@)
                                                    (=>
                                                     (= temp_12_0~2149@ (Mul (Mul (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ b12~100@)) (Add
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2214@ (Mul (Mul (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ d12~104@)) (Add
                                                          (Mul d12~104@ c12~102@) (Mul b12~100@ a12~98@)
                                                         )
                                                        ) (Mul (Sub (Mul b12~100@ d12~104@) (Mul d12~104@ c12~102@)) (Mul (Mul d12~104@ b12~100@)
                                                          (Sub b12~100@ d12~104@)
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2149@ temp_12_1~2214@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2149@ temp_12_1~2214@)
                                                        (=>
                                                         (= temp_13_0~2303@ (Mul (Mul (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ b13~108@)) (
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2368@ (Mul (Mul (Mul d13~112@ d13~112@) (Mul (Mul b13~108@ b13~108@) (Mul
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2303@ temp_13_1~2368@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2303@ temp_13_1~2368@)
                                                            (=>
                                                             (= temp_14_0~2457@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ b14~116@)) (
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2522@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ b14~116@)) (
                                                                  Sub (Mul b14~116@ a14~114@) (Mul b14~116@ c14~118@)
                                                                 )
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2457@ temp_14_1~2522@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2457@ temp_14_1~2522@)
                                                                (=>
                                                                 (= temp_15_0~2611@ (Mul (Mul (Mul (Mul a15~122@ b15~124@) (Sub c15~126@ d15~128@)) (
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2676@ (Mul (Mul (Mul (Mul a15~122@ b15~124@) (Sub c15~126@ d15~128@)) (
                                                                  ...
                                                                  (and
                                                                   ...
                                                                   (=>
                                                                    (= temp_15_0~2611@ temp_15_1~2676@)
                                                                    (=>
                                                                     (= temp_16_0~2765@ (Mul (Mul (Mul (Mul d16~136@ c16~134@) (Mul d16~136@ c16~134@)) (
                                                                     ...
                                                                     (=>
                                                                      (= temp_16_1~2830@ (Mul (Mul (Mul (Mul d16~136@ c16~134@) (Mul d16~136@ c16~134@)) (
                                                                          Mul (Mul c16~134@ c16~134@) (Mul b16~132@ b16~132@)
                                                                         )
                                                                      ...
                                                                      (and
                                                                       ...
                                                                       (=>
                                                                        (= temp_16_0~2765@ temp_16_1~2830@)
                                                                        (=>
                                                                         (= temp_17_0~2931@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ a17~138@)) (
                                                                         ...
                                                                         (=>
                                                                          (= temp_17_1~3008@ (Mul (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ a17~138@))
                                                                              (Mul c17~142@ a17~138@)
                                                                             ) (Mul 12 a17~138@)
                                                                            ) (Mul (Sub (Mul c17~142@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul a17~138@ d17~144@)
                                                                              (Mul b17~140@ c17~142@)
                                                                          ...
                                                                          (and
                                                                           (=>
                                                                            ...
                                                                            (=>
                                                                             %%location_label%%17
                                                                             (= temp_17_0~2931@ temp_17_1~3008@)
                                                                           ))
                                                                           (=>
                                                                            (= temp_17_0~2931@ temp_17_1~3008@)
                                                                            (=>
                                                                             (= temp_18_0~3093@ (Mul (Sub (Mul (Mul c18~150@ a18~146@) (Mul d18~152@ c18~150@)) (
                                                                             ...
                                                                             (=>
                                                                              (= temp_18_1~3154@ (Mul (Sub (Mul (Mul c18~150@ a18~146@) (Mul d18~152@ c18~150@)) (
                                                                                  Add (Mul a18~146@ b18~148@) c18~150@
                                                                                 )
