...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Add a0~2@ 34) (Mul c0~6@ b0~4@))) (Sub b0~4@ (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~378@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Add (Mul a0~2@ (Mul c0~6@ b0~4@)) (Mul 34 (Mul c0~6@ b0~4@)))) (Sub b0~4@ (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~378@))) (=> (= temp_0_0~305@ temp_0_1~378@) (=> (= temp_1_0~467@ (Mul (Add (Mul (Add a1~10@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Sub b1~12@ d1~16@))) (Mul (Mul (Mul c1~14@ b1~12@) (Add d1~16@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~532@ (Mul (Add (Mul (Add a1~10@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Sub b1~12@ d1~16@))) (Mul (Mul c1~14@ (Mul b1~12@ (Add d1~16@ a1~10@))) (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~467@ temp_1_1~532@))) (=> (= temp_1_0~467@ temp_1_1~532@) (=> (= temp_2_0~621@ (Mul (Add (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul c2~22@ b2~20@) (Add c2~22@ b2~20@)) (Sub (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@))))) (=> (= temp_2_1~718@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul (Mul c2~22@ b2~20@) (Add c2~22@ b2~20@)) (Sub (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@)))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ d2~24@)) (Mul (Mul (Mul c2~22@ b2~20@) (Add c2~22@ b2~20@)) (Sub (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~621@ temp_2_1~718@))) (=> (= temp_2_0~621@ temp_2_1~718@) (=> (= temp_3_0~795@ (Sub (Mul d3~32@ (Sub (Mul b3~28@ b3~28@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~848@ (Sub (Mul d3~32@ (Sub (Mul b3~28@ b3~28@) (Mul a3~26@ d3~32@))) (Mul (Mul a3~26@ c3~30@) (Mul (Mul a3~26@ d3~32@) (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~795@ temp_3_1~848@))) (=> (= temp_3_0~795@ temp_3_1~848@) (=> (= temp_4_0~905@ (Mul d4~40@ (Mul (Sub (Sub b4~36@ b4~36@) (Mul c4~38@ b4~36@)) (Mul (Mul c4~38@ d4~40@) b4~36@)))) (=> (= temp_4_1~938@ (Mul d4~40@ (Mul (Mul (Mul c4~38@ d4~40@) b4~36@) (Sub (Sub b4~36@ b4~36@) (Mul c4~38@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~905@ temp_4_1~938@))) (=> (= temp_4_0~905@ temp_4_1~938@) (=> (= temp_5_0~1019@ (Mul (Sub (Mul (Mul b5~44@ a5~42@) d5~48@) (Mul (Mul d5~48@ a5~42@) (Sub b5~44@ b5~44@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@)) (Add c5~46@ (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1104@ (Sub (Mul (Mul (Mul b5~44@ a5~42@) d5~48@) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@)) (Add c5~46@ (Mul a5~42@ a5~42@)))) (Mul (Mul (Mul d5~48@ a5~42@) (Sub b5~44@ b5~44@)) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ c5~46@)) (Add c5~46@ (Mul a5~42@ a5~42@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1019@ temp_5_1~1104@))) (=> (= temp_5_0~1019@ temp_5_1~1104@) (=> (= temp_6_0~1197@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ c6~54@)) (Add (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@))) (Sub (Mul b6~52@ (Mul c6~54@ b6~52@)) (Mul c6~54@ (Mul 0 a6~50@))))) (=> (= temp_6_1~1266@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ c6~54@)) (Add (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@))) (Sub (Mul b6~52@ (Mul c6~54@ b6~52@)) (Mul (Mul c6~54@ 0) a6~50@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1197@ temp_6_1~1266@))) (=> (= temp_6_0~1197@ temp_6_1~1266@) (=> (= temp_7_0~1355@ (Mul (Mul (Add (Mul b7~60@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@))))) (=> (= temp_7_1~1420@ (Mul (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@))) (Mul (Add (Mul b7~60@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Sub c7~62@ a7~58@) (Mul c7~62@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1355@ temp_7_1~1420@))) (=> (= temp_7_0~1355@ temp_7_1~1420@) (=> (= temp_8_0~1505@ (Mul (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ a8~66@))) (Mul (Mul b8~68@ (Mul d8~72@ a8~66@)) (Mul (Sub c8~70@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1566@ (Mul (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ a8~66@))) (Mul (Mul (Sub c8~70@ b8~68@) (Mul c8~70@ d8~72@)) (Mul b8~68@ (Mul d8~72@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1505@ temp_8_1~1566@))) (=> (= temp_8_0~1505@ temp_8_1~1566@) (=> (= temp_9_0~1647@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Mul b9~76@ d9~80@) a9~74@)) (Mul (Mul (Sub b9~76@ b9~76@) (Mul d9~80@ a9~74@)) (Mul d9~80@ (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1704@ (Mul (Mul (Mul (Sub b9~76@ b9~76@) (Mul d9~80@ a9~74@)) (Mul d9~80@ (Mul a9~74@ c9~78@))) (Mul (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Mul b9~76@ d9~80@) a9~74@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1647@ temp_9_1~1704@))) (=> (= temp_9_0~1647@ temp_9_1~1704@) (=> (= temp_10_0~1781@ (Mul (Add b10~84@ (Sub (Mul a10~82@ a10~82@) (Mul b10~84@ c10~86@))) (Mul (Sub (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@)) (Add (Mul d10~88@ c10~86@) (Add b10~84@ b10~84@))))) (=> (= temp_10_1~1834@ (Mul (Add b10~84@ (Sub (Mul a10~82@ a10~82@) (Mul b10~84@ c10~86@))) (Mul (Sub (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@)) (Add (Mul c10~86@ d10~88@) (Add b10~84@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1781@ temp_10_1~1834@))) (=> (= temp_10_0~1781@ temp_10_1~1834@) (=> (= temp_11_0~1911@ (Add (Mul (Mul (Mul c11~94@ d11~96@) (Add c11~94@ b11~92@)) (Mul (Add c11~94@ d11~96@) (Mul c11~94@ d11~96@))) (Mul (Add (Mul d11~96@ b11~92@) (Sub b11~92@ b11~92@)) c11~94@))) (=> (= temp_11_1~1964@ (Add (Mul (Mul c11~94@ (Mul d11~96@ (Add c11~94@ b11~92@))) (Mul (Add c11~94@ d11~96@) (Mul c11~94@ d11~96@))) (Mul (Add (Mul d11~96@ b11~92@) (Sub b11~92@ b11~92@)) c11~94@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1911@ temp_11_1~1964@))) (=> (= temp_11_0~1911@ temp_11_1~1964@) (=> (= temp_12_0~2057@ (Mul (Mul (Mul (Add b12~100@ a12~98@) 83) (Mul (Mul a12~98@ c12~102@) b12~100@)) (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ b12~100@)) (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ a12~98@))))) (=> (= temp_12_1~2126@ (Mul (Mul (Mul (Add b12~100@ a12~98@) 83) (Mul (Mul c12~102@ a12~98@) b12~100@)) (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ b12~100@)) (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2057@ temp_12_1~2126@))) (=> (= temp_12_0~2057@ temp_12_1~2126@) (=> (= temp_13_0~2215@ (Sub (Mul (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ a13~106@)) (Mul (Mul b13~108@ d13~112@) (Mul a13~106@ d13~112@))) (Add (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ a13~106@)) (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ a13~106@))))) (=> (= temp_13_1~2280@ (Sub (Mul (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ a13~106@)) (Mul (Mul b13~108@ d13~112@) (Mul a13~106@ d13~112@))) (Add (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ a13~106@)) (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2215@ temp_13_1~2280@))) (=> (= temp_13_0~2215@ temp_13_1~2280@) (=> (= temp_14_0~2357@ (Sub (Mul (Mul c14~118@ (Mul a14~114@ c14~118@)) (Mul b14~116@ (Sub c14~118@ c14~118@))) (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ b14~116@)) (Mul (Mul a14~114@ a14~114@) d14~120@)))) (=> (= temp_14_1~2410@ (Sub (Mul (Mul c14~118@ (Mul a14~114@ c14~118@)) (Mul b14~116@ (Sub c14~118@ c14~118@))) (Mul (Mul (Mul (Mul b14~116@ a14~114@) b14~116@) b14~116@) (Mul (Mul a14~114@ a14~114@) d14~120@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2357@ temp_14_1~2410@))) (=> (= temp_14_0~2357@ temp_14_1~2410@) (=> (= temp_15_0~2511@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ a15~122@))) (Mul (Mul (Mul 9 a15~122@) (Mul a15~122@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~2588@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ a15~122@))) (Mul (Mul (Mul 9 a15~122@) (Mul a15~122@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2511@ temp_15_1~2588@))) (=> (= temp_15_0~2511@ temp_15_1~2588@) (=> (= temp_16_0~2673@ (Mul (Add (Mul (Mul b16~132@ b16~132@) (Mul d16~136@ c16~134@)) (Mul (Mul b16~132@ b16~132@) b16~132@)) (Mul (Mul (Mul d16~136@ c16~134@) (Mul c16~134@ d16~136@)) (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~2734@ (Mul (Add (Mul (Mul b16~132@ b16~132@) (Mul d16~136@ c16~134@)) (Mul (Mul b16~132@ b16~132@) b16~132@)) (Mul (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ c16~134@)) (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2673@ temp_16_1~2734@))) (=> (= temp_16_0~2673@ temp_16_1~2734@) (=> (= temp_17_0~2831@ (Sub (Mul (Mul (Mul d17~144@ a17~138@) (Mul c17~142@ a17~138@)) (Mul (Mul c17~142@ b17~140@) (Mul b17~140@ a17~138@))) (Sub (Mul (Add c17~142@ d17~144@) (Mul a17~138@ b17~140@)) (Mul b17~140@ (Mul 68 c17~142@))))) (=> (= temp_17_1~2904@ (Sub (Mul (Mul (Mul d17~144@ a17~138@) (Mul c17~142@ a17~138@)) (Mul (Mul c17~142@ b17~140@) (Mul b17~140@ a17~138@))) (Sub (Mul (Mul (Add c17~142@ d17~144@) a17~138@) b17~140@) (Mul b17~140@ (Mul 68 c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2831@ temp_17_1~2904@))) (=> (= temp_17_0~2831@ temp_17_1~2904@) (=> (= temp_18_0~2981@ (Mul (Mul (Mul (Sub a18~146@ c18~150@) (Mul c18~150@ c18~150@)) (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ c18~150@))) (Add (Mul (Mul c18~150@ a18~146@) (Mul d18~152@ b18~148@)) b18~148@))) (=> (= temp_18_1~3042@ (Mul (Mul (Sub (Mul a18~146@ (Mul c18~150@ c18~150@)) (Mul c18~150@ (Mul c18~150@ c18~150@))) (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ c18~150@))) (Add (Mul (Mul c18~150@ a18~146@) (Mul d18~152@ b18~148@)) b18~148@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2981@ temp_18_1~3042@))) (=> (= temp_18_0~2981@ temp_18_1~3042@) (=> (= temp_19_0~3119@ (Mul (Mul (Sub (Mul b19~156@ d19~160@) (Mul b19~156@ b19~156@)) (Sub (Mul b19~156@ d19~160@) (Mul d19~160@ d19~160@))) (Mul (Mul (Mul a19~154@ c19~158@) (Mul b19~156@ b19~156@)) a19~154@))) (=> (= temp_19_1~3172@ (Mul (Mul (Sub (Mul b19~156@ d19~160@) (Mul b19~156@ b19~156@)) (Sub (Mul b19~156@ d19~160@) (Mul d19~160@ d19~160@))) (Mul (Mul (Mul a19~154@ c19~158@) (Mul b19~156@ b19~156@)) a19~154@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3119@ temp_19_1~3172@))) (=> (= temp_19_0~3119@ temp_19_1~3172@) (=> (= temp_20_0~3273@ (Mul (Mul (Mul (Add b20~164@ c20~166@) (Mul c20~166@ a20~162@)) (Mul (Mul b20~164@ b20~164@) (Mul b20~164@ 71))) (Mul (Mul (Mul c20~166@ b20~164@) (Add b20~164@ b20~164@)) (Mul (Mul c20~166@ a20~162@) (Add a20~162@ c20~166@))))) (=> (= temp_20_1~3350@ (Mul (Mul (Mul (Mul c20~166@ b20~164@) (Add b20~164@ b20~164@)) (Mul (Mul c20~166@ a20~162@) (Add a20~162@ c20~166@))) (Mul (Mul (Add b20~164@ c20~166@) (Mul c20~166@ a20~162@)) (Mul (Mul b20~164@ b20~164@) (Mul b20~164@ 71))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3273@ temp_20_1~3350@))) (=> (= temp_20_0~3273@ temp_20_1~3350@) (=> (= temp_21_0~3431@ (Mul (Mul (Sub (Sub c21~174@ a21~170@) (Mul d21~176@ c21~174@)) (Mul (Mul c21~174@ a21~170@) (Add b21~172@ d21~176@))) (Mul (Mul (Mul d21~176@ c21~174@) (Mul c21~174@ a21~170@)) (Mul a21~170@ c21~174@)))) (=> (= temp_21_1~3488@ (Mul (Mul (Mul (Mul c21~174@ a21~170@) (Add b21~172@ d21~176@)) (Sub (Sub c21~174@ a21~170@) (Mul d21~176@ c21~174@))) (Mul (Mul (Mul d21~176@ c21~174@) (Mul c21~174@ a21~170@)) (Mul a21~170@ c21~174@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3431@ temp_21_1~3488@))) (=> (= temp_21_0~3431@ temp_21_1~3488@) (=> (= temp_22_0~3577@ (Mul (Mul (Mul (Mul b22~180@ a22~178@) (Mul d22~184@ d22~184@)) (Mul (Mul d22~184@ d22~184@) (Mul c22~182@ b22~180@))) (Mul (Add (Add a22~178@ d22~184@) (Sub d22~184@ b22~180@)) (Mul (Mul c22~182@ c22~182@) (Sub a22~178@ a22~178@))))) (=> (= temp_22_1~3642@ (Mul (Mul (Mul (Mul b22~180@ a22~178@) (Mul d22~184@ d22~184@)) (Mul (Mul d22~184@ d22~184@) (Mul c22~182@ b22~180@))) (Mul (Add (Add a22~178@ d22~184@) (Sub d22~184@ b22~180@)) (Mul c22~182@ (Mul c22~182@ (Sub a22~178@ a22~178@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3577@ temp_22_1~3642@))) (=> (= temp_22_0~3577@ temp_22_1~3642@) (=> (= temp_23_0~3731@ (Mul (Mul (Mul (Mul b23~188@ b23~188@) (Add d23~192@ d23~192@)) (Mul (Sub a23~186@ b23~188@) (Sub d23~192@ d23~192@))) (Mul (Sub (Mul d23~192@ d23~192@) (Mul d23~192@ d23~192@)) (Mul (Sub d23~192@ a23~186@) (Sub d23~192@ a23~186@))))) (=> (= temp_23_1~3796@ (Mul (Mul (Mul (Mul b23~188@ b23~188@) (Add d23~192@ d23~192@)) (Mul (Sub a23~186@ b23~188@) (Sub d23~192@ d23~192@))) (Mul (Sub (Mul d23~192@ d23~192@) (Mul d23~192@ d23~192@)) (Mul (Sub d23~192@ a23~186@) (Sub d23~192@ a23~186@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3731@ temp_23_1~3796@))) (=> (= temp_23_0~3731@ temp_23_1~3796@) (=> (= temp_24_0~3897@ (Mul (Mul (Mul (Mul c24~198@ a24~194@) (Mul d24~200@ b24~196@)) (Add (Sub 29 c24~198@) (Mul d24~200@ a24~194@))) (Mul (Mul (Mul b24~196@ b24~196@) (Mul c24~198@ c24~198@)) (Mul (Mul a24~194@ d24~200@) (Mul b24~196@ a24~194@))))) (=> (= temp_24_1~3990@ (Mul (Add (Mul (Mul (Mul c24~198@ a24~194@) (Mul d24~200@ b24~196@)) (Sub 29 c24~198@)) (Mul (Mul (Mul c24~198@ a24~194@) (Mul d24~200@ b24~196@)) (Mul d24~200@ a24~194@))) (Mul (Mul (Mul b24~196@ b24~196@) (Mul c24~198@ c24~198@)) (Mul (Mul a24~194@ d24~200@) (Mul b24~196@ a24~194@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3897@ temp_24_1~3990@))) (=> (= temp_24_0~3897@ temp_24_1~3990@) (=> (= temp_25_0~4079@ (Mul (Mul (Mul (Mul d25~208@ d25~208@) (Mul b25~204@ c25~206@)) (Mul (Mul c25~206@ d25~208@) (Mul b25~204@ a25~202@))) (Mul (Mul (Mul c25~206@ c25~206@) (Mul d25~208@ b25~204@)) (Mul (Mul d25~208@ b25~204@) (Mul c25~206@ a25~202@))))) (=> (= temp_25_1~4144@ (Mul (Mul (Mul (Mul d25~208@ d25~208@) (Mul b25~204@ c25~206@)) (Mul (Mul b25~204@ a25~202@) (Mul c25~206@ d25~208@))) (Mul (Mul (Mul c25~206@ c25~206@) (Mul d25~208@ b25~204@)) (Mul (Mul d25~208@ b25~204@) (Mul c25~206@ a25~202@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~4079@ temp_25_1~4144@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
