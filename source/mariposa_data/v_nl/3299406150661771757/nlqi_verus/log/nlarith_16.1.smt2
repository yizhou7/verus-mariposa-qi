...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Add (Mul (Add b0~4@ a0~2@) d0~8@) (Add (Mul b0~4@ a0~2@) (Mul c0~6@ c0~6@))) (Sub (Mul d0~8@ (Sub b0~4@ c0~6@)) (Mul (Mul b0~4@ b0~4@) d0~8@)))) (=> (= temp_0_1~350@ (Mul (Add (Add (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@)) (Add (Mul b0~4@ a0~2@) (Mul c0~6@ c0~6@))) (Sub (Mul d0~8@ (Sub b0~4@ c0~6@)) (Mul (Mul b0~4@ b0~4@) d0~8@)))) (=> (= tmp%1@ (= temp_0_0~293@ temp_0_1~350@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~430@ (Mul (Mul (Mul (Add c1~14@ c1~14@) (Mul a1~10@ a1~10@)) (Add (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Add (Mul b1~12@ a1~10@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~495@ (Mul (Mul (Mul (Add c1~14@ c1~14@) (Mul a1~10@ a1~10@)) (Add (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Add (Mul b1~12@ a1~10@) (Mul c1~14@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~430@ temp_1_1~495@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~571@ (Add (Mul (Sub (Mul 14 b2~20@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Add b2~20@ c2~22@))) (Sub (Mul d2~24@ (Mul d2~24@ d2~24@)) a2~18@))) (=> (= temp_2_1~632@ (Add (Mul (Sub (Mul b2~20@ 14) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Add b2~20@ c2~22@))) (Sub (Mul d2~24@ (Mul d2~24@ d2~24@)) a2~18@))) (=> (= tmp%3@ (= temp_2_0~571@ temp_2_1~632@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~712@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Add c3~30@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul d3~32@ c3~30@) (Sub a3~26@ a3~26@))))) (=> (= temp_3_1~777@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Add c3~30@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul d3~32@ c3~30@) (Sub a3~26@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~712@ temp_3_1~777@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~829@ (Mul a4~34@ (Mul (Mul (Mul b4~36@ a4~34@) (Add a4~34@ d4~40@)) (Mul (Add a4~34@ a4~34@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~866@ (Mul a4~34@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Add a4~34@ d4~40@)) (Add a4~34@ a4~34@)) (Mul c4~38@ b4~36@)))) (=> (= tmp%5@ (= temp_4_0~829@ temp_4_1~866@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~946@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ c5~46@))) (Sub (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1043@ (Sub (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ c5~46@))) (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ c5~46@))) (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~946@ temp_5_1~1043@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1123@ (Mul (Mul (Add (Sub a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Sub d6~56@ b6~52@) (Mul a6~50@ c6~54@))) (Add (Mul (Mul d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1188@ (Mul (Mul (Add (Sub a6~50@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Mul (Sub d6~56@ b6~52@) a6~50@) c6~54@)) (Add (Mul (Mul d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1123@ temp_6_1~1188@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1264@ (Sub (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ a7~58@)) (Add d7~64@ (Mul b7~60@ a7~58@))) (Sub (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ a7~58@)) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1325@ (Sub (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ a7~58@)) (Add d7~64@ (Mul b7~60@ a7~58@))) (Sub (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ a7~58@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1264@ temp_7_1~1325@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1405@ (Sub (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Add (Mul d8~72@ d8~72@) (Add b8~68@ b8~68@))) (Add (Mul (Mul d8~72@ b8~68@) (Sub c8~70@ d8~72@)) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1470@ (Sub (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Add (Mul d8~72@ d8~72@) (Add b8~68@ b8~68@))) (Add (Mul (Mul b8~68@ d8~72@) (Sub c8~70@ d8~72@)) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1405@ temp_8_1~1470@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1550@ (Mul (Mul (Add (Add b9~76@ c9~78@) (Mul c9~78@ a9~74@)) (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ c9~78@))) (Mul (Mul (Add d9~80@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~1615@ (Mul (Mul (Add (Add b9~76@ c9~78@) (Mul c9~78@ a9~74@)) (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ c9~78@))) (Mul (Mul (Mul (Add d9~80@ c9~78@) d9~80@) c9~78@) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1550@ temp_9_1~1615@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1695@ (Mul (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul c10~86@ c10~86@) (Mul a10~82@ d10~88@))) (Mul (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ c10~86@)) (Sub (Sub d10~88@ d10~88@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~1760@ (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul (Mul c10~86@ c10~86@) (Mul a10~82@ d10~88@)) (Mul (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ c10~86@)) (Sub (Sub d10~88@ d10~88@) (Mul b10~84@ d10~88@)))))) (=> (= tmp%11@ (= temp_10_0~1695@ temp_10_1~1760@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1840@ (Add (Mul (Mul (Mul d11~96@ d11~96@) (Mul a11~90@ b11~92@)) (Mul (Sub d11~96@ b11~92@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ d11~96@))))) (=> (= temp_11_1~1905@ (Add (Mul (Mul (Mul d11~96@ d11~96@) (Mul a11~90@ b11~92@)) (Mul (Sub d11~96@ b11~92@) (Mul d11~96@ d11~96@))) (Mul (Mul (Mul (Mul b11~92@ b11~92@) d11~96@) b11~92@) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ d11~96@))))) (=> (= tmp%12@ (= temp_11_0~1840@ temp_11_1~1905@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1981@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ d12~104@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ b12~100@) a12~98@)))) (=> (= temp_12_1~2042@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ b12~100@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul b12~100@ b12~100@) a12~98@)))) (=> (= tmp%13@ (= temp_12_0~1981@ temp_12_1~2042@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2134@ (Mul (Mul (Mul (Mul b13~108@ 20) (Add a13~106@ a13~106@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ d13~112@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Add a13~106@ d13~112@))))) (=> (= temp_13_1~2211@ (Mul (Mul (Mul (Mul b13~108@ 20) (Add a13~106@ a13~106@)) (Mul (Mul c13~110@ c13~110@) (Mul c13~110@ d13~112@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Add a13~106@ d13~112@))))) (=> (= tmp%14@ (= temp_13_0~2134@ temp_13_1~2211@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2283@ (Mul (Mul (Mul a14~114@ (Add d14~120@ b14~116@)) (Mul (Add d14~120@ b14~116@) (Mul d14~120@ a14~114@))) (Mul (Mul (Mul a14~114@ a14~114@) c14~118@) (Mul (Mul b14~116@ c14~118@) (Sub d14~120@ d14~120@))))) (=> (= temp_14_1~2340@ (Mul (Mul (Mul (Mul a14~114@ (Add d14~120@ b14~116@)) (Mul (Add d14~120@ b14~116@) (Mul d14~120@ a14~114@))) (Mul (Mul a14~114@ a14~114@) c14~118@)) (Mul (Mul b14~116@ c14~118@) (Sub d14~120@ d14~120@)))) (=> (= tmp%15@ (= temp_14_0~2283@ temp_14_1~2340@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2420@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ b15~124@)) (Mul (Add b15~124@ b15~124@) (Mul c15~126@ d15~128@))) (Mul (Sub (Mul b15~124@ a15~122@) (Mul b15~124@ d15~128@)) (Mul (Sub a15~122@ a15~122@) (Sub d15~128@ d15~128@))))) (=> (= temp_15_1~2493@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ b15~124@)) (Add (Mul b15~124@ (Mul c15~126@ d15~128@)) (Mul b15~124@ (Mul c15~126@ d15~128@)))) (Mul (Sub (Mul b15~124@ a15~122@) (Mul b15~124@ d15~128@)) (Mul (Sub a15~122@ a15~122@) (Sub d15~128@ d15~128@))))) (=> (= tmp%16@ (= temp_15_0~2420@ temp_15_1~2493@)) (=> %%location_label%%15 tmp%16@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
