...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Sub a0~2@ b0~4@))) (Mul (Mul (Sub a0~2@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Add a0~2@ c0~6@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~370@ (Sub (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Sub a0~2@ b0~4@))) (Mul (Mul (Sub a0~2@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Add a0~2@ c0~6@) (Mul c0~6@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~446@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) b1~12@) (Mul (Add a1~10@ a1~10@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Sub c1~14@ b1~12@))))) (=> (= temp_1_1~507@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) b1~12@) (Mul (Add a1~10@ a1~10@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ b1~12@)) (Mul (Sub c1~14@ b1~12@) (Mul c1~14@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~446@ temp_1_1~507@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~599@ (Mul (Mul (Mul (Add 41 a2~18@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@))) (Mul (Sub (Add d2~24@ b2~20@) (Add d2~24@ b2~20@)) (Sub (Sub c2~22@ c2~22@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~676@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Add 41 a2~18@) (Mul d2~24@ d2~24@))) (Mul (Sub (Add d2~24@ b2~20@) (Add d2~24@ b2~20@)) (Sub (Sub c2~22@ c2~22@) (Mul b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~599@ temp_2_1~676@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~744@ (Add (Mul (Mul (Mul a3~26@ c3~30@) (Sub c3~30@ b3~28@)) (Mul (Mul d3~32@ a3~26@) (Sub d3~32@ d3~32@))) (Sub (Sub (Mul d3~32@ d3~32@) (Sub c3~30@ a3~26@)) c3~30@))) (=> (= temp_3_1~797@ (Add (Mul (Mul (Mul a3~26@ c3~30@) (Sub c3~30@ b3~28@)) (Mul (Sub d3~32@ d3~32@) (Mul d3~32@ a3~26@))) (Sub (Sub (Mul d3~32@ d3~32@) (Sub c3~30@ a3~26@)) c3~30@))) (=> (= tmp%4@ (= temp_3_0~744@ temp_3_1~797@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~877@ (Mul (Sub (Add (Mul a4~34@ b4~36@) (Mul a4~34@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ a4~34@))) (Mul (Mul (Sub a4~34@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~974@ (Sub (Mul (Add (Mul a4~34@ b4~36@) (Mul a4~34@ b4~36@)) (Mul (Mul (Sub a4~34@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ c4~38@)))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul (Sub a4~34@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ c4~38@)))))) (=> (= tmp%5@ (= temp_4_0~877@ temp_4_1~974@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1054@ (Mul (Add (Mul (Mul a5~42@ a5~42@) (Add a5~42@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))) (Sub (Add (Mul a5~42@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1119@ (Mul (Add (Mul (Mul a5~42@ a5~42@) (Add a5~42@ d5~48@)) (Mul (Mul (Mul b5~44@ a5~42@) d5~48@) d5~48@)) (Sub (Add (Mul a5~42@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~1054@ temp_5_1~1119@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1183@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ d6~56@))) (Mul (Mul b6~52@ (Add d6~56@ b6~52@)) b6~52@))) (=> (= temp_6_1~1232@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ d6~56@))) (Mul (Mul b6~52@ (Add d6~56@ b6~52@)) b6~52@))) (=> (= tmp%7@ (= temp_6_0~1183@ temp_6_1~1232@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1304@ (Mul (Mul (Mul a7~58@ b7~60@) (Sub (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))) (Sub (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1361@ (Mul (Mul (Mul a7~58@ b7~60@) (Sub (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))) (Sub (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@))))) (=> (= tmp%8@ (= temp_7_0~1304@ temp_7_1~1361@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1413@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ a8~66@)) (Sub (Add d8~72@ a8~66@) (Mul b8~68@ b8~68@))) b8~68@)) (=> (= temp_8_1~1466@ (Mul (Sub (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ a8~66@)) (Add d8~72@ a8~66@)) (Mul (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ a8~66@)) (Mul b8~68@ b8~68@))) b8~68@)) (=> (= tmp%9@ (= temp_8_0~1413@ temp_8_1~1466@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1546@ (Mul (Mul (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul d9~80@ d9~80@) (Add b9~76@ c9~78@)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~1611@ (Mul (Mul (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul d9~80@ d9~80@) (Add b9~76@ c9~78@)) (Mul (Mul c9~78@ a9~74@) (Mul a9~74@ b9~76@))))) (=> (= tmp%10@ (= temp_9_0~1546@ temp_9_1~1611@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1691@ (Mul (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ a10~82@))) (Mul (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ c10~86@)) (Mul (Mul b10~84@ b10~84@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~1756@ (Mul (Mul (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ d10~88@)) (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ a10~82@))) (Mul (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ c10~86@)) (Mul (Mul b10~84@ b10~84@) (Mul b10~84@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1691@ temp_10_1~1756@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1820@ (Mul (Add (Mul b11~92@ (Mul c11~94@ a11~90@)) (Mul (Mul d11~96@ a11~90@) (Sub a11~90@ c11~94@))) (Sub b11~92@ (Mul (Add c11~94@ a11~90@) (Add b11~92@ b11~92@))))) (=> (= temp_11_1~1877@ (Mul (Add (Mul b11~92@ (Mul c11~94@ a11~90@)) (Mul (Mul d11~96@ a11~90@) (Sub a11~90@ c11~94@))) (Sub b11~92@ (Add (Mul (Add c11~94@ a11~90@) b11~92@) (Mul (Add c11~94@ a11~90@) b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1820@ temp_11_1~1877@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1969@ (Mul (Mul (Mul (Sub b12~100@ b12~100@) (Mul 15 d12~104@)) (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ a12~98@))) (Add (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ a12~98@)) (Add (Add a12~98@ c12~102@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2046@ (Mul (Mul (Mul (Sub b12~100@ b12~100@) (Mul 15 d12~104@)) (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ a12~98@))) (Add (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ a12~98@)) (Add (Add a12~98@ c12~102@) (Mul d12~104@ a12~98@))))) (=> (= tmp%13@ (= temp_12_0~1969@ temp_12_1~2046@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2146@ (Mul (Mul (Mul (Mul 44 c13~110@) (Mul a13~106@ c13~110@)) (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ a13~106@))) (Mul (Mul (Mul d13~112@ b13~108@) 17) (Sub (Mul d13~112@ a13~106@) (Mul c13~110@ a13~106@))))) (=> (= temp_13_1~2231@ (Mul (Mul (Mul 44 c13~110@) (Mul (Mul a13~106@ c13~110@) (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ a13~106@)))) (Mul (Mul (Mul d13~112@ b13~108@) 17) (Sub (Mul d13~112@ a13~106@) (Mul c13~110@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2146@ temp_13_1~2231@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2303@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul c14~118@ d14~120@)) (Mul b14~116@ (Mul a14~114@ b14~116@))) (Mul (Mul (Mul c14~118@ c14~118@) (Mul a14~114@ a14~114@)) (Mul b14~116@ (Mul a14~114@ b14~116@))))) (=> (= temp_14_1~2360@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul c14~118@ d14~120@)) (Mul b14~116@ (Mul a14~114@ b14~116@))) (Mul (Mul (Mul c14~118@ c14~118@) (Mul a14~114@ a14~114@)) (Mul b14~116@ (Mul a14~114@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2303@ temp_14_1~2360@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2440@ (Add (Mul (Sub (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@)) (Mul (Add b15~124@ b15~124@) (Mul 59 d15~128@))) (Mul d15~128@ (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~2505@ (Add (Mul (Sub (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@)) (Mul (Add b15~124@ b15~124@) (Mul 59 d15~128@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ a15~122@)) d15~128@))) (=> (= tmp%16@ (= temp_15_0~2440@ temp_15_1~2505@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2569@ (Mul (Mul b16~132@ (Mul (Mul a16~130@ c16~134@) d16~136@)) (Mul (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2618@ (Mul (Mul b16~132@ (Mul (Mul a16~130@ c16~134@) d16~136@)) (Mul (Mul (Mul d16~136@ d16~136@) (Mul b16~132@ a16~130@)) (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ c16~134@))))) (=> (= tmp%17@ (= temp_16_0~2569@ temp_16_1~2618@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2686@ (Add (Sub (Mul a17~138@ c17~142@) (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ d17~144@))) (Mul (Mul (Mul d17~144@ a17~138@) (Mul b17~140@ b17~140@)) (Mul a17~138@ (Sub d17~144@ d17~144@))))) (=> (= temp_17_1~2739@ (Add (Sub (Mul a17~138@ c17~142@) (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ d17~144@))) (Mul (Mul d17~144@ (Mul a17~138@ (Mul b17~140@ b17~140@))) (Mul a17~138@ (Sub d17~144@ d17~144@))))) (=> (= tmp%18@ (= temp_17_0~2686@ temp_17_1~2739@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2807@ (Mul (Add (Mul (Mul c18~150@ a18~146@) (Mul b18~148@ d18~152@)) (Mul (Add b18~148@ b18~148@) (Mul c18~150@ b18~148@))) (Mul (Sub (Mul a18~146@ d18~152@) (Mul d18~152@ b18~148@)) d18~152@))) (=> (= temp_18_1~2860@ (Mul (Mul (Sub (Mul a18~146@ d18~152@) (Mul d18~152@ b18~148@)) d18~152@) (Add (Mul (Mul c18~150@ a18~146@) (Mul b18~148@ d18~152@)) (Mul (Add b18~148@ b18~148@) (Mul c18~150@ b18~148@))))) (=> (= tmp%19@ (= temp_18_0~2807@ temp_18_1~2860@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2940@ (Mul (Mul (Add (Mul a19~154@ a19~154@) (Mul b19~156@ c19~158@)) (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ c19~158@))) (Mul c19~158@ (Mul (Mul 79 b19~156@) (Mul b19~156@ b19~156@))))) (=> (= temp_19_1~3005@ (Mul (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ c19~158@)) (Add (Mul a19~154@ a19~154@) (Mul b19~156@ c19~158@))) (Mul c19~158@ (Mul (Mul 79 b19~156@) (Mul b19~156@ b19~156@))))) (=> (= tmp%20@ (= temp_19_0~2940@ temp_19_1~3005@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3085@ (Mul (Sub (Sub (Mul a20~162@ d20~168@) (Add b20~164@ b20~164@)) (Mul (Mul c20~166@ b20~164@) (Mul a20~162@ c20~166@))) (Mul (Mul (Add c20~166@ b20~164@) (Mul d20~168@ b20~164@)) (Mul (Mul b20~164@ a20~162@) (Add c20~166@ a20~162@))))) (=> (= temp_20_1~3182@ (Sub (Mul (Sub (Mul a20~162@ d20~168@) (Add b20~164@ b20~164@)) (Mul (Mul (Add c20~166@ b20~164@) (Mul d20~168@ b20~164@)) (Mul (Mul b20~164@ a20~162@) (Add c20~166@ a20~162@)))) (Mul (Mul (Mul c20~166@ b20~164@) (Mul a20~162@ c20~166@)) (Mul (Mul (Add c20~166@ b20~164@) (Mul d20~168@ b20~164@)) (Mul (Mul b20~164@ a20~162@) (Add c20~166@ a20~162@)))))) (=> (= tmp%21@ (= temp_20_0~3085@ temp_20_1~3182@)) (=> %%location_label%%20 tmp%21@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
