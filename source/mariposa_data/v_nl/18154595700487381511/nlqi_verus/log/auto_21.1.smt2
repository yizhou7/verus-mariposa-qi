...
(assert (=> %%query%% (not (=> (= temp_0_0~281@ (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) b0~4@) (Sub c0~6@ (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~322@ (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Mul b0~4@ (Sub c0~6@ (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~281@ temp_0_1~322@))) (=> (= temp_0_0~281@ temp_0_1~322@) (=> (= temp_1_0~411@ (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ c1~14@)) (Mul (Add d1~16@ c1~14@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~484@ (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ c1~14@)) (Add (Mul d1~16@ (Mul a1~10@ a1~10@)) (Mul c1~14@ (Mul a1~10@ a1~10@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~411@ temp_1_1~484@))) (=> (= temp_1_0~411@ temp_1_1~484@) (=> (= temp_2_0~581@ (Sub (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul 13 c2~22@))) (Mul (Add c2~22@ (Add c2~22@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~654@ (Sub (Mul (Mul (Mul b2~20@ a2~18@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ c2~22@) (Mul 13 c2~22@))) (Mul (Add c2~22@ (Add c2~22@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~581@ temp_2_1~654@))) (=> (= temp_2_0~581@ temp_2_1~654@) (=> (= temp_3_0~743@ (Sub (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@)) (Sub (Mul b3~28@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub d3~32@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~808@ (Sub (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@)) (Sub (Mul b3~28@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub d3~32@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul d3~32@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~743@ temp_3_1~808@))) (=> (= temp_3_0~743@ temp_3_1~808@) (=> (= temp_4_0~893@ (Mul (Mul (Mul b4~36@ (Mul c4~38@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ b4~36@))) (Mul (Mul (Add a4~34@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~954@ (Mul (Mul (Mul b4~36@ (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul (Add a4~34@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~893@ temp_4_1~954@))) (=> (= temp_4_0~893@ temp_4_1~954@) (=> (= temp_5_0~1039@ (Mul (Mul (Sub (Mul b5~44@ d5~48@) (Mul 10 b5~44@)) (Mul (Mul b5~44@ d5~48@) a5~42@)) (Mul b5~44@ (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1100@ (Mul (Mul (Sub (Mul b5~44@ d5~48@) (Mul 10 b5~44@)) (Mul (Mul b5~44@ d5~48@) a5~42@)) (Mul b5~44@ (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1039@ temp_5_1~1100@))) (=> (= temp_5_0~1039@ temp_5_1~1100@) (=> (= temp_6_0~1201@ (Mul (Add (Add (Add d6~56@ a6~50@) (Mul d6~56@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul 73 c6~54@) (Mul c6~54@ c6~54@)) (Sub (Add d6~56@ b6~52@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1278@ (Mul (Add (Add (Add d6~56@ a6~50@) (Mul d6~56@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Mul 73 c6~54@) (Mul (Mul c6~54@ c6~54@) (Sub (Add d6~56@ b6~52@) (Mul d6~56@ d6~56@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1201@ temp_6_1~1278@))) (=> (= temp_6_0~1201@ temp_6_1~1278@) (=> (= temp_7_0~1359@ (Mul (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ d7~64@)) (Mul c7~62@ (Mul c7~62@ d7~64@))) (Mul (Add d7~64@ (Mul c7~62@ b7~60@)) (Mul (Add c7~62@ d7~64@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1416@ (Mul (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ d7~64@)) (Mul c7~62@ (Mul c7~62@ d7~64@))) (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ b7~60@)) (Add d7~64@ (Mul c7~62@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1359@ temp_7_1~1416@))) (=> (= temp_7_0~1359@ temp_7_1~1416@) (=> (= temp_8_0~1505@ (Sub (Sub (Mul (Sub c8~70@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@))) (Sub (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Add b8~68@ d8~72@) (Add b8~68@ c8~70@))))) (=> (= temp_8_1~1570@ (Sub (Sub (Mul (Sub c8~70@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@))) (Sub (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Add b8~68@ d8~72@) (Add b8~68@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1505@ temp_8_1~1570@))) (=> (= temp_8_0~1505@ temp_8_1~1570@) (=> (= temp_9_0~1671@ (Mul (Mul (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ a9~74@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ d9~80@)) (Mul (Sub a9~74@ 17) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~1748@ (Mul (Mul (Mul (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ a9~74@) (Mul b9~76@ a9~74@))) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Sub a9~74@ 17) (Mul a9~74@ b9~76@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1671@ temp_9_1~1748@))) (=> (= temp_9_0~1671@ temp_9_1~1748@) (=> (= temp_10_0~1833@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ b10~84@)) (Mul (Sub a10~82@ a10~82@) c10~86@)))) (=> (= temp_10_1~1894@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ d10~88@)) (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ b10~84@)) (Mul (Sub a10~82@ a10~82@) c10~86@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1833@ temp_10_1~1894@))) (=> (= temp_10_0~1833@ temp_10_1~1894@) (=> (= temp_11_0~2003@ (Mul (Mul (Sub (Mul d11~96@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Add 60 17))) (Mul (Mul c11~94@ (Mul b11~92@ c11~94@)) (Mul (Sub a11~90@ c11~94@) (Mul a11~90@ a11~90@))))) (=> (= temp_11_1~2088@ (Mul (Mul (Sub (Mul d11~96@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Add 60 17))) (Mul (Mul c11~94@ (Mul b11~92@ c11~94@)) (Mul (Mul (Sub a11~90@ c11~94@) a11~90@) a11~90@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2003@ temp_11_1~2088@))) (=> (= temp_11_0~2003@ temp_11_1~2088@) (=> (= temp_12_0~2177@ (Mul (Sub (Mul (Add c12~102@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ a12~98@) (Mul c12~102@ a12~98@))) (Add (Sub (Mul c12~102@ a12~98@) (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ a12~98@) (Sub b12~100@ a12~98@))))) (=> (= temp_12_1~2242@ (Mul (Sub (Mul (Add c12~102@ d12~104@) (Mul b12~100@ d12~104@)) (Mul (Mul d12~104@ a12~98@) (Mul c12~102@ a12~98@))) (Add (Sub (Mul c12~102@ a12~98@) (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ a12~98@) (Sub b12~100@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2177@ temp_12_1~2242@))) (=> (= temp_12_0~2177@ temp_12_1~2242@) (=> (= temp_13_0~2331@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Mul d13~112@ c13~110@)) (Mul (Mul d13~112@ c13~110@) (Mul d13~112@ c13~110@))) (Mul (Sub (Mul a13~106@ a13~106@) (Mul d13~112@ d13~112@)) (Mul (Mul a13~106@ c13~110@) (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~2396@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) (Mul d13~112@ c13~110@)) (Mul (Mul d13~112@ c13~110@) (Mul d13~112@ c13~110@))) (Mul (Sub (Mul a13~106@ a13~106@) (Mul d13~112@ d13~112@)) (Mul (Mul c13~110@ a13~106@) (Mul d13~112@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2331@ temp_13_1~2396@))) (=> (= temp_13_0~2331@ temp_13_1~2396@) (=> (= temp_14_0~2481@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ d14~120@)) (Mul d14~120@ (Mul d14~120@ a14~114@))) (Mul (Mul (Mul c14~118@ c14~118@) (Mul a14~114@ d14~120@)) (Add (Mul c14~118@ d14~120@) (Add b14~116@ d14~120@))))) (=> (= temp_14_1~2542@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ d14~120@)) (Mul d14~120@ (Mul d14~120@ a14~114@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ c14~118@)) (Add (Mul c14~118@ d14~120@) (Add b14~116@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2481@ temp_14_1~2542@))) (=> (= temp_14_0~2481@ temp_14_1~2542@) (=> (= temp_15_0~2631@ (Sub (Mul (Mul (Mul b15~124@ a15~122@) (Mul a15~122@ 28)) (Mul (Sub d15~128@ c15~126@) (Mul b15~124@ a15~122@))) (Mul (Add (Mul a15~122@ d15~128@) (Mul d15~128@ b15~124@)) b15~124@))) (=> (= temp_15_1~2696@ (Sub (Mul (Mul (Mul b15~124@ a15~122@) (Mul a15~122@ 28)) (Mul (Mul (Sub d15~128@ c15~126@) b15~124@) a15~122@)) (Mul (Add (Mul a15~122@ d15~128@) (Mul d15~128@ b15~124@)) b15~124@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2631@ temp_15_1~2696@))) (=> (= temp_15_0~2631@ temp_15_1~2696@) (=> (= temp_16_0~2769@ (Mul (Mul (Add (Mul c16~134@ d16~136@) (Sub c16~134@ a16~130@)) (Mul d16~136@ (Mul a16~130@ a16~130@))) (Mul b16~132@ (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~2818@ (Mul (Mul (Add (Mul c16~134@ d16~136@) (Sub c16~134@ a16~130@)) (Mul d16~136@ (Mul a16~130@ a16~130@))) (Mul (Mul b16~132@ (Mul a16~130@ d16~136@)) (Mul b16~132@ a16~130@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2769@ temp_16_1~2818@))) (=> (= temp_16_0~2769@ temp_16_1~2818@) (=> (= temp_17_0~2911@ (Mul (Mul (Add (Mul b17~140@ c17~142@) (Mul 63 d17~144@)) (Mul c17~142@ (Mul c17~142@ c17~142@))) (Sub (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ d17~144@)) (Mul (Mul c17~142@ b17~140@) a17~138@)))) (=> (= temp_17_1~2980@ (Mul (Mul (Add (Mul b17~140@ c17~142@) (Mul 63 d17~144@)) (Mul c17~142@ (Mul c17~142@ c17~142@))) (Sub (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ d17~144@)) (Mul c17~142@ (Mul b17~140@ a17~138@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2911@ temp_17_1~2980@))) (=> (= temp_17_0~2911@ temp_17_1~2980@) (=> (= temp_18_0~3065@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ c18~150@)) (Mul c18~150@ (Mul c18~150@ c18~150@))) (Mul (Mul (Add d18~152@ a18~146@) (Mul c18~150@ d18~152@)) (Mul (Sub d18~152@ b18~148@) (Add b18~148@ d18~152@))))) (=> (= temp_18_1~3126@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ c18~150@)) (Mul c18~150@ (Mul c18~150@ c18~150@))) (Mul (Mul (Add d18~152@ a18~146@) (Mul c18~150@ d18~152@)) (Mul (Add b18~148@ d18~152@) (Sub d18~152@ b18~148@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3065@ temp_18_1~3126@))) (=> (= temp_18_0~3065@ temp_18_1~3126@) (=> (= temp_19_0~3215@ (Mul (Mul (Add (Mul d19~160@ c19~158@) (Mul b19~156@ c19~158@)) (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ a19~154@))) (Sub (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ d19~160@)) (Mul (Mul c19~158@ b19~156@) (Mul c19~158@ d19~160@))))) (=> (= temp_19_1~3276@ (Mul (Mul (Mul (Add d19~160@ b19~156@) c19~158@) (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ a19~154@))) (Sub (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ d19~160@)) (Mul (Mul c19~158@ b19~156@) (Mul c19~158@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3215@ temp_19_1~3276@))) (=> (= temp_19_0~3215@ temp_19_1~3276@) (=> (= temp_20_0~3377@ (Mul (Mul (Mul (Mul b20~164@ a20~162@) (Add d20~168@ c20~166@)) (Mul (Mul d20~168@ b20~164@) (Sub b20~164@ 98))) (Mul (Sub (Mul d20~168@ c20~166@) (Mul d20~168@ b20~164@)) (Mul (Mul d20~168@ a20~162@) (Mul b20~164@ d20~168@))))) (=> (= temp_20_1~3454@ (Mul (Mul (Mul (Mul d20~168@ b20~164@) (Sub b20~164@ 98)) (Mul (Mul b20~164@ a20~162@) (Add d20~168@ c20~166@))) (Mul (Sub (Mul d20~168@ c20~166@) (Mul d20~168@ b20~164@)) (Mul (Mul d20~168@ a20~162@) (Mul b20~164@ d20~168@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3377@ temp_20_1~3454@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
