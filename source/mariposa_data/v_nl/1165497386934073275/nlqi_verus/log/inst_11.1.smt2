...
(set-info :comment ";; mariposa_data/v_nl//1165497386934073275/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~249@ (Mul (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@)) (Add (Sub b0~4@ c0~6@) (Sub d0~8@ c0~6@))) (Mul (Sub (Mul d0~8@ d0~8@) (Sub b0~4@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@)))) (Mul c0~6@ (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ c0~6@)) b0~4@)))) (=> (= temp_0_1~338@ (Mul (Mul (Mul (Mul d0~8@ (Mul d0~8@ (Mul c0~6@ b0~4@))) (Add (Sub b0~4@ c0~6@) (Sub d0~8@ c0~6@))) (Mul (Sub (Mul d0~8@ d0~8@) (Sub b0~4@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@)))) (Mul c0~6@ (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ c0~6@)) b0~4@)))) (and (=> (= tmp%1@ (Mul c0~6@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d0~8@ d0~8@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~249@ temp_0_1~338@)))) (=> (= temp_0_0~249@ temp_0_1~338@) (=> (= temp_1_0~493@ (Mul (Mul (Add (Mul (Mul a1~10@ c1~14@) (Mul a1~10@ b1~12@)) (Add (Add d1~16@ 90) b1~12@)) (Mul (Mul b1~12@ (Add c1~14@ d1~16@)) (Mul (Mul a1~10@ c1~14@) b1~12@))) (Sub (Mul (Mul b1~12@ (Add b1~12@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))) (Sub (Sub (Add b1~12@ c1~14@) d1~16@) (Mul (Mul a1~10@ c1~14@) (Add a1~10@ c1~14@)))))) (=> (= temp_1_1~614@ (Mul (Mul (Add (Mul (Mul a1~10@ c1~14@) (Mul a1~10@ b1~12@)) (Add (Add d1~16@ 90) b1~12@)) (Mul (Mul b1~12@ (Add c1~14@ d1~16@)) (Mul (Mul a1~10@ c1~14@) b1~12@))) (Sub (Mul (Mul b1~12@ (Add b1~12@ a1~10@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@))) (Sub (Sub (Add b1~12@ c1~14@) d1~16@) (Mul (Mul a1~10@ c1~14@) (Add a1~10@ c1~14@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ c1~14@) (=> %%location_label%%1 (= temp_1_0~493@ temp_1_1~614@))) (=> (= temp_1_0~493@ temp_1_1~614@) (=> (= temp_2_0~787@ (Sub (Mul (Mul (Sub (Mul b2~20@ a2~18@) (Mul d2~24@ 77)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ d2~24@))) (Mul (Mul (Sub b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul d2~24@ d2~24@) (Add 95 c2~22@)))) (Mul (Add (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ c2~22@) b2~20@)) (Mul (Sub (Mul c2~22@ c2~22@) b2~20@) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ a2~18@)))))) (=> (= temp_2_1~932@ (Sub (Mul (Mul (Sub (Mul b2~20@ a2~18@) (Mul d2~24@ 77)) (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Mul (Sub b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul d2~24@ d2~24@) (Add 95 c2~22@)))) (Mul (Add (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ c2~22@) b2~20@)) (Mul (Sub (Mul c2~22@ c2~22@) b2~20@) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ a2~18@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ d2~24@) (=> %%location_label%%2 (= temp_2_0~787@ temp_2_1~932@))) (=> (= temp_2_0~787@ temp_2_1~932@) (=> (= temp_3_0~1077@ (Add (Add (Add c3~30@ (Mul (Mul a3~26@ b3~28@) (Sub c3~30@ c3~30@))) (Mul (Sub (Mul d3~32@ b3~28@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Sub c3~30@ a3~26@)))) (Mul (Sub (Mul (Mul b3~28@ d3~32@) (Sub d3~32@ d3~32@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ b3~28@)))))) (=> (= temp_3_1~1194@ (Add (Add (Add c3~30@ (Mul (Mul a3~26@ b3~28@) (Sub c3~30@ c3~30@))) (Mul (Sub (Mul d3~32@ b3~28@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Sub c3~30@ a3~26@)))) (Mul (Sub (Mul (Mul b3~28@ d3~32@) (Sub d3~32@ d3~32@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ d3~32@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ b3~28@) (=> %%location_label%%3 (= temp_3_0~1077@ temp_3_1~1194@))) (=> (= temp_3_0~1077@ temp_3_1~1194@) (=> (= temp_4_0~1339@ (Mul (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@)) (Add (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@))) (Sub (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Sub a4~34@ c4~38@) b4~36@))) (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ b4~36@) (Add a4~34@ b4~36@))) (Mul (Mul (Mul c4~38@ b4~36@) b4~36@) (Mul d4~40@ (Add a4~34@ d4~40@)))))) (=> (= temp_4_1~1472@ (Mul (Mul (Add (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@)) (Mul b4~36@ a4~34@)) (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@)) (Mul d4~40@ d4~40@))) (Sub (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Sub a4~34@ c4~38@) b4~36@))) (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ b4~36@) (Add a4~34@ b4~36@))) (Mul (Mul (Mul c4~38@ b4~36@) b4~36@) (Mul d4~40@ (Add a4~34@ d4~40@)))))) (and (=> (= tmp%2@ (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@))) (=> (= tmp%3@ (Mul b4~36@ a4~34@)) (=> (= tmp%4@ (Mul d4~40@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%2@ tmp%3@ tmp%4@) (=> %%location_label%%4 (= temp_4_0~1339@ temp_4_1~1472@)))))) (=> (= temp_4_0~1339@ temp_4_1~1472@) (=> (= temp_5_0~1591@ (Mul a5~42@ (Mul (Sub (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ c5~46@)) (Add (Mul d5~48@ b5~44@) (Mul a5~42@ b5~44@))) (Sub (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Add a5~42@ d5~48@) (Mul d5~48@ a5~42@)))))) (=> (= temp_5_1~1660@ (Mul a5~42@ (Mul (Sub (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ c5~46@)) (Add (Mul b5~44@ d5~48@) (Mul a5~42@ b5~44@))) (Sub (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Add a5~42@ d5~48@) (Mul d5~48@ a5~42@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1591@ temp_5_1~1660@))) (=> (= temp_5_0~1591@ temp_5_1~1660@) (=> (= temp_6_0~1793@ (Mul (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@))) (Add (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ d6~56@)) a6~50@)) (Mul (Mul c6~54@ (Add (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@))) (Mul (Sub (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ c6~54@)))))) (=> (= temp_6_1~1898@ (Mul (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ a6~50@))) (Add (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ d6~56@)) a6~50@)) (Mul (Mul c6~54@ (Add (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@))) (Mul (Sub (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ c6~54@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1793@ temp_6_1~1898@))) (=> (= temp_6_0~1793@ temp_6_1~1898@) (=> (= temp_7_0~2043@ (Mul (Add (Sub (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@)) (Add (Mul a7~58@ c7~62@) c7~62@)) (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@)))) (Mul (Mul (Mul b7~60@ (Mul c7~62@ c7~62@)) (Mul b7~60@ (Sub c7~62@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Sub b7~60@ a7~58@) (Mul d7~64@ b7~60@)))))) (=> (= temp_7_1~2160@ (Mul (Mul (Mul (Mul b7~60@ (Mul c7~62@ c7~62@)) (Mul b7~60@ (Sub c7~62@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Sub b7~60@ a7~58@) (Mul d7~64@ b7~60@)))) (Add (Sub (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@)) (Add (Mul a7~58@ c7~62@) c7~62@)) (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@)))))) (and (=> (= tmp%5@ (Add (Sub (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@)) (Add (Mul a7~58@ c7~62@) c7~62@)) (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ c7~62@))))) (=> (= tmp%6@ (Mul (Mul (Mul b7~60@ (Mul c7~62@ c7~62@)) (Mul b7~60@ (Sub c7~62@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Sub b7~60@ a7~58@) (Mul d7~64@ b7~60@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%7 (= temp_7_0~2043@ temp_7_1~2160@))))) (=> (= temp_7_0~2043@ temp_7_1~2160@) (=> (= temp_8_0~2389@ (Mul (Mul (Mul a8~66@ (Sub (Add d8~72@ b8~68@) (Mul a8~66@ c8~70@))) (Add (Mul (Mul b8~68@ d8~72@) b8~68@) (Mul d8~72@ (Mul d8~72@ b8~68@)))) (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ a8~66@)) (Sub (Mul c8~70@ c8~70@) (Mul b8~68@ d8~72@))) (Add (Sub (Mul a8~66@ c8~70@) a8~66@) d8~72@)))) (=> (= temp_8_1~2502@ (Mul (Add (Mul (Mul a8~66@ (Sub (Add d8~72@ b8~68@) (Mul a8~66@ c8~70@))) (Mul (Mul b8~68@ d8~72@) b8~68@)) (Mul (Mul a8~66@ (Sub (Add d8~72@ b8~68@) (Mul a8~66@ c8~70@))) (Mul d8~72@ (Mul d8~72@ b8~68@)))) (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ a8~66@)) (Sub (Mul c8~70@ c8~70@) (Mul b8~68@ d8~72@))) (Add (Sub (Mul a8~66@ c8~70@) a8~66@) d8~72@)))) (and (=> (= tmp%7@ (Mul a8~66@ (Sub (Add d8~72@ b8~68@) (Mul a8~66@ c8~70@)))) (=> (= tmp%8@ (Mul (Mul b8~68@ d8~72@) b8~68@)) (=> (= tmp%9@ (Mul d8~72@ (Mul d8~72@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%8 (= temp_8_0~2389@ temp_8_1~2502@)))))) (=> (= temp_8_0~2389@ temp_8_1~2502@) (=> (= temp_9_0~2689@ (Sub (Sub (Sub (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ b9~76@) a9~74@)) (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul a9~74@ d9~80@)))) (Mul (Mul (Add (Mul a9~74@ c9~78@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ a9~74@)) (Add (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@)))))) (=> (= temp_9_1~2814@ (Sub (Sub (Sub (Mul (Mul c9~78@ b9~76@) (Mul d9~80@ c9~78@)) (Mul (Mul a9~74@ b9~76@) a9~74@)) (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul a9~74@ d9~80@)))) (Mul (Mul (Add (Mul a9~74@ c9~78@) (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ a9~74@)) (Add (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@)))))) (and (=> (= tmp%10@ (Mul d9~80@ c9~78@)) (=> (= tmp%11@ (Mul c9~78@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%9 (= temp_9_0~2689@ temp_9_1~2814@))))) (=> (= temp_9_0~2689@ temp_9_1~2814@) (=> (= temp_10_0~2951@ (Mul (Mul (Mul (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ d10~88@) (Add d10~88@ d10~88@))) (Mul (Mul (Mul b10~84@ c10~86@) (Mul a10~82@ b10~84@)) (Mul (Mul d10~88@ b10~84@) (Mul a10~82@ b10~84@)))) (Mul a10~82@ (Mul (Sub (Mul c10~86@ a10~82@) (Add b10~84@ c10~86@)) (Mul (Mul d10~88@ a10~82@) (Mul a10~82@ b10~84@)))))) (=> (= temp_10_1~3052@ (Mul (Mul (Mul (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ d10~88@) (Add d10~88@ d10~88@))) (Mul (Mul b10~84@ (Mul c10~86@ (Mul a10~82@ b10~84@))) (Mul (Mul d10~88@ b10~84@) (Mul a10~82@ b10~84@)))) (Mul a10~82@ (Mul (Sub (Mul c10~86@ a10~82@) (Add b10~84@ c10~86@)) (Mul (Mul d10~88@ a10~82@) (Mul a10~82@ b10~84@)))))) (=> (= tmp%12@ (Mul a10~82@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b10~84@ c10~86@ tmp%12@) (=> %%location_label%%10 (= temp_10_0~2951@ temp_10_1~3052@)))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
