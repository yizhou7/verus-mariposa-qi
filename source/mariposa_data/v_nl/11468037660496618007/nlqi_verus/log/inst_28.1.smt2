...
(declare-const temp_2_1~744@ Int)
(declare-const temp_3_0~887@ Int)
(declare-const temp_3_1~948@ Int)
(declare-const temp_4_0~1015@ Int)
(declare-const temp_4_1~1052@ Int)
(declare-const temp_5_0~1171@ Int)
(declare-const temp_5_1~1236@ Int)
(declare-const temp_6_0~1337@ Int)
(declare-const temp_6_1~1402@ Int)
(declare-const temp_7_0~1483@ Int)
(declare-const temp_7_1~1536@ Int)
(declare-const temp_8_0~1685@ Int)
(declare-const temp_8_1~1762@ Int)
(declare-const temp_9_0~1875@ Int)
(declare-const temp_9_1~1940@ Int)
(declare-const temp_10_0~2021@ Int)
(declare-const temp_10_1~2094@ Int)
(declare-const temp_11_0~2213@ Int)
(declare-const temp_11_1~2262@ Int)
(declare-const temp_12_0~2363@ Int)
(declare-const temp_12_1~2428@ Int)
(declare-const temp_13_0~2527@ Int)
(declare-const temp_13_1~2588@ Int)
(declare-const temp_14_0~2679@ Int)
(declare-const temp_14_1~2740@ Int)
(declare-const temp_15_0~2833@ Int)
(declare-const temp_15_1~2898@ Int)
(declare-const temp_16_0~3033@ Int)
(declare-const temp_16_1~3118@ Int)
(declare-const temp_17_0~3253@ Int)
(declare-const temp_17_1~3318@ Int)
(declare-const temp_18_0~3415@ Int)
(declare-const temp_18_1~3476@ Int)
(declare-const temp_19_0~3583@ Int)
(declare-const temp_19_1~3656@ Int)
(declare-const temp_20_0~3749@ Int)
(declare-const temp_20_1~3806@ Int)
(declare-const temp_21_0~3895@ Int)
(declare-const temp_21_1~3952@ Int)
(declare-const temp_22_0~4041@ Int)
(declare-const temp_22_1~4098@ Int)
(declare-const temp_23_0~4187@ Int)
(declare-const temp_23_1~4240@ Int)
(declare-const temp_24_0~4325@ Int)
(declare-const temp_24_1~4378@ Int)
(declare-const temp_25_0~4471@ Int)
(declare-const temp_25_1~4536@ Int)
(declare-const temp_26_0~4637@ Int)
(declare-const temp_26_1~4702@ Int)
(declare-const temp_27_0~4803@ Int)
(declare-const temp_27_1~4852@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Add c0~6@ c0~6@)) (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ c0~6@))) (Sub (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Add c0~6@ c0~6@)) (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ c0~6@))) (Sub (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Sub b0~4@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ c0~6@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~483@ (Mul (Mul (Mul (Sub c1~14@ b1~12@) (Mul d1~16@ c1~14@)) (Add a1~10@ (Mul b1~12@ c1~14@))) (Mul (Mul (Mul c1~14@ 26) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ a1~10@) (Mul 44 a1~10@))))) (=> (= temp_1_1~568@ (Mul (Mul (Mul (Sub c1~14@ b1~12@) (Mul d1~16@ c1~14@)) (Add a1~10@ (Mul b1~12@ c1~14@))) (Mul (Mul (Mul (Mul c1~14@ 26) a1~10@) a1~10@) (Mul (Mul c1~14@ a1~10@) (Mul 44 a1~10@))))) (and (=> (= tmp%1@ (Mul c1~14@ 26)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ a1~10@ a1~10@) (=> %%location_label%%1 (= temp_1_0~483@ temp_1_1~568@)))) (=> (= temp_1_0~483@ temp_1_1~568@) (=> (= temp_2_0~679@ (Mul (Sub (Sub (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ c2~22@))))) (=> (= temp_2_1~744@ (Mul (Mul (Sub (Sub (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@))) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ c2~22@)))) (and (=> (= tmp%2@ (Sub (Sub (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@)))) (=> (= tmp%3@ (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ b2~20@))) (=> (= tmp%4@ (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~679@ temp_2_1~744@)))))) (=> (= temp_2_0~679@ temp_2_1~744@) (=> (= temp_3_0~887@ (Mul (Mul (Mul (Sub c3~30@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Add a3~26@ c3~30@))) (Add (Mul (Mul a3~26@ c3~30@) (Add b3~28@ b3~28@)) (Mul (Mul b3~28@ a3~26@) a3~26@)))) (=> (= temp_3_1~948@ (Mul (Mul (Mul (Sub c3~30@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Add a3~26@ c3~30@))) (Add (Mul (Mul a3~26@ c3~30@) (Add b3~28@ b3~28@)) (Mul b3~28@ (Mul a3~26@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b3~28@ a3~26@ a3~26@) (=> %%location_label%%3 (= temp_3_0~887@ temp_3_1~948@))) (=> (= temp_3_0~887@ temp_3_1~948@) (=> (= temp_4_0~1015@ (Mul a4~34@ (Mul (Sub (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~1052@ (Mul (Mul a4~34@ (Sub (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@))) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@)))) (and (=> (= tmp%5@ (Sub (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@))) (=> (= tmp%6@ (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. a4~34@ tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~1015@ temp_4_1~1052@))))) (=> (= temp_4_0~1015@ temp_4_1~1052@) (=> (= temp_5_0~1171@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ b5~44@) (Sub d5~48@ a5~42@))))) (=> (= temp_5_1~1236@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ b5~44@) (Sub d5~48@ a5~42@))))) (and (=> (= tmp%7@ (Mul b5~44@ c5~46@)) (=> (= tmp%8@ (Mul b5~44@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~1171@ temp_5_1~1236@))))) (=> (= temp_5_0~1171@ temp_5_1~1236@) (=> (= temp_6_0~1337@ (Sub (Mul (Mul (Sub c6~54@ d6~56@) (Mul b6~52@ d6~56@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1402@ (Sub (Mul (Mul (Sub c6~54@ d6~56@) (Mul b6~52@ d6~56@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1337@ temp_6_1~1402@))) (=> (= temp_6_0~1337@ temp_6_1~1402@) (=> (= temp_7_0~1483@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ b7~60@)) d7~64@) (Mul (Sub (Sub d7~64@ b7~60@) (Mul b7~60@ d7~64@)) (Sub (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1536@ (Mul (Mul (Sub (Sub d7~64@ b7~60@) (Mul b7~60@ d7~64@)) (Sub (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ b7~60@)) d7~64@))) (and (=> (= tmp%9@ (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ b7~60@)) d7~64@)) (=> (= tmp%10@ (Mul (Sub (Sub d7~64@ b7~60@) (Mul b7~60@ d7~64@)) (Sub (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~1483@ temp_7_1~1536@))))) (=> (= temp_7_0~1483@ temp_7_1~1536@) (=> (= temp_8_0~1685@ (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Mul 61 b8~68@))) (Mul (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul d8~72@ b8~68@) (Add d8~72@ b8~68@))))) (=> (= temp_8_1~1762@ (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul 61 b8~68@) (Mul d8~72@ d8~72@))) (Mul (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul d8~72@ b8~68@) (Add d8~72@ b8~68@))))) (and (=> (= tmp%11@ (Mul d8~72@ d8~72@)) (=> (= tmp%12@ (Mul 61 b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%8 (= temp_8_0~1685@ temp_8_1~1762@))))) (=> (= temp_8_0~1685@ temp_8_1~1762@) (=> (= temp_9_0~1875@ (Mul (Mul (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ a9~74@)) (Mul (Mul c9~78@ b9~76@) (Mul d9~80@ b9~76@))) (Mul (Mul (Add b9~76@ d9~80@) (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~1940@ (Mul (Mul (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ a9~74@)) (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Mul (Add b9~76@ d9~80@) (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ b9~76@) (=> %%location_label%%9 (= temp_9_0~1875@ temp_9_1~1940@))) (=> (= temp_9_0~1875@ temp_9_1~1940@) (=> (= temp_10_0~2021@ (Mul (Add (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@))) (Mul (Mul (Add a10~82@ c10~86@) (Mul b10~84@ a10~82@)) a10~82@))) (=> (= temp_10_1~2094@ (Add (Mul (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul (Add a10~82@ c10~86@) (Mul b10~84@ a10~82@)) a10~82@)) (Mul (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul (Add a10~82@ c10~86@) (Mul b10~84@ a10~82@)) a10~82@)))) (and (=> (= tmp%13@ (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ d10~88@))) (=> (= tmp%14@ (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@))) (=> (= tmp%15@ (Mul (Mul (Add a10~82@ c10~86@) (Mul b10~84@ a10~82@)) a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%10 (= temp_10_0~2021@ temp_10_1~2094@)))))) (=> (= temp_10_0~2021@ temp_10_1~2094@) (=> (= temp_11_0~2213@ (Mul (Sub (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ c11~94@) (Mul b11~92@ a11~90@))) (Mul d11~96@ (Add c11~94@ (Mul c11~94@ c11~94@))))) (=> (= temp_11_1~2262@ (Mul (Sub (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul b11~92@ a11~90@) (Mul d11~96@ c11~94@))) (Mul d11~96@ (Add c11~94@ (Mul c11~94@ c11~94@))))) (and (=> (= tmp%16@ (Mul d11~96@ c11~94@)) (=> (= tmp%17@ (Mul b11~92@ a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%11 (= temp_11_0~2213@ temp_11_1~2262@))))) (=> (= temp_11_0~2213@ temp_11_1~2262@) (=> (= temp_12_0~2363@ (Mul (Mul (Mul (Mul a12~98@ a12~98@) (Mul a12~98@ b12~100@)) (Add (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@))) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2428@ (Mul (Mul (Mul (Mul a12~98@ a12~98@) (Mul a12~98@ b12~100@)) (Add (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@))) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ b12~100@)) (Mul b12~100@ (Mul b12~100@ (Mul b12~100@ a12~98@)))))) (and (=> (= tmp%18@ (Mul b12~100@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b12~100@ b12~100@ tmp%18@) (=> %%location_label%%12 (= temp_12_0~2363@ temp_12_1~2428@)))) (=> (= temp_12_0~2363@ temp_12_1~2428@) (=> (= temp_13_0~2527@ (Mul (Mul (Mul (Sub c13~110@ c13~110@) (Add a13~106@ d13~112@)) (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ d13~112@))) (Mul (Sub (Mul d13~112@ c13~110@) (Mul c13~110@ a13~106@)) (Add (Mul d13~112@ b13~108@) (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~2588@ (Mul (Mul (Mul (Sub c13~110@ c13~110@) (Add a13~106@ d13~112@)) (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ d13~112@))) (Mul (Sub (Mul d13~112@ c13~110@) (Mul c13~110@ a13~106@)) (Mul d13~112@ (Add b13~108@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d13~112@ b13~108@ c13~110@) (=> %%location_label%%13 (= temp_13_0~2527@ temp_13_1~2588@))) (=> (= temp_13_0~2527@ temp_13_1~2588@) (=> (= temp_14_0~2679@ (Mul (Mul (Add b14~116@ (Mul a14~114@ b14~116@)) (Mul (Mul c14~118@ b14~116@) (Mul a14~114@ b14~116@))) (Mul (Add (Mul a14~114@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@))))) (=> (= temp_14_1~2740@ (Mul (Mul (Add b14~116@ (Mul a14~114@ b14~116@)) (Mul (Mul b14~116@ c14~118@) (Mul a14~114@ b14~116@))) (Mul (Add (Mul a14~114@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c14~118@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2679@ temp_14_1~2740@))) (=> (= temp_14_0~2679@ temp_14_1~2740@) (=> (= temp_15_0~2833@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Sub d15~128@ a15~122@)) (Add (Mul d15~128@ b15~124@) (Mul d15~128@ a15~122@))) (Add (Sub (Mul d15~128@ b15~124@) (Mul a15~122@ c15~126@)) (Sub (Mul d15~128@ d15~128@) (Add a15~122@ b15~124@))))) (=> (= temp_15_1~2898@ (Mul (Mul (Mul c15~126@ c15~126@) (Mul (Sub d15~128@ a15~122@) (Add (Mul d15~128@ b15~124@) (Mul d15~128@ a15~122@)))) (Add (Sub (Mul d15~128@ b15~124@) (Mul a15~122@ c15~126@)) (Sub (Mul d15~128@ d15~128@) (Add a15~122@ b15~124@))))) (and (=> (= tmp%19@ (Mul c15~126@ c15~126@)) (=> (= tmp%20@ (Sub d15~128@ a15~122@)) (=> (= tmp%21@ (Add (Mul d15~128@ b15~124@) (Mul d15~128@ a15~122@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%15 (= temp_15_0~2833@ temp_15_1~2898@)))))) (=> (= temp_15_0~2833@ temp_15_1~2898@) (=> (= temp_16_0~3033@ (Mul (Add (Mul (Add b16~132@ b16~132@) (Mul b16~132@ c16~134@)) (Add (Mul c16~134@ d16~136@) (Mul d16~136@ d16~136@))) (Mul (Mul (Mul b16~132@ 38) (Mul a16~130@ a16~130@)) (Mul 52 (Add d16~136@ c16~134@))))) (=> (= temp_16_1~3118@ (Mul (Add (Mul (Add b16~132@ b16~132@) (Mul b16~132@ c16~134@)) (Add (Mul c16~134@ d16~136@) (Mul d16~136@ d16~136@))) (Mul (Mul b16~132@ 38) (Mul (Mul a16~130@ a16~130@) (Mul 52 (Add d16~136@ c16~134@)))))) (and (=> (= tmp%22@ (Mul b16~132@ 38)) (=> (= tmp%23@ (Mul a16~130@ a16~130@)) (=> (= tmp%24@ (Mul 52 (Add d16~136@ c16~134@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%16 (= temp_16_0~3033@ temp_16_1~3118@)))))) (=> (= temp_16_0~3033@ temp_16_1~3118@) (=> (= temp_17_0~3253@ (Mul (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul a17~138@ d17~144@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ b17~140@)) (Mul (Mul c17~142@ b17~140@) (Add b17~140@ c17~142@))))) (=> (= temp_17_1~3318@ (Mul (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul a17~138@ d17~144@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul b17~140@ b17~140@) (Mul a17~138@ b17~140@)) (Mul (Mul c17~142@ b17~140@) (Add b17~140@ c17~142@))))) (and (=> (= tmp%25@ (Mul a17~138@ b17~140@)) (=> (= tmp%26@ (Mul b17~140@ b17~140@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%25@ tmp%26@) (=> %%location_label%%17 (= temp_17_0~3253@ temp_17_1~3318@))))) (=> (= temp_17_0~3253@ temp_17_1~3318@) (=> (= temp_18_0~3415@ (Sub (Add (Mul c18~150@ (Mul b18~148@ c18~150@)) (Mul (Sub d18~152@ c18~150@) (Mul b18~148@ c18~150@))) (Mul (Mul (Mul c18~150@ b18~148@) (Mul a18~146@ d18~152@)) (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ b18~148@))))) (=> (= temp_18_1~3476@ (Sub (Add (Mul c18~150@ (Mul b18~148@ c18~150@)) (Mul (Mul (Sub d18~152@ c18~150@) b18~148@) c18~150@)) (Mul (Mul (Mul c18~150@ b18~148@) (Mul a18~146@ d18~152@)) (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ b18~148@))))) (and (=> (= tmp%27@ (Sub d18~152@ c18~150@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ b18~148@ c18~150@) (=> %%location_label%%18 (= temp_18_0~3415@ temp_18_1~3476@)))) (=> (= temp_18_0~3415@ temp_18_1~3476@) (=> (= temp_19_0~3583@ (Sub (Mul (Sub d19~160@ (Mul b19~156@ d19~160@)) (Mul (Add a19~154@ b19~156@) (Add b19~156@ c19~158@))) (Mul (Mul (Mul b19~156@ c19~158@) (Sub 20 d19~160@)) (Mul (Add b19~156@ b19~156@) (Mul a19~154@ c19~158@))))) (=> (= temp_19_1~3656@ (Sub (Mul (Sub d19~160@ (Mul b19~156@ d19~160@)) (Mul (Add a19~154@ b19~156@) (Add b19~156@ c19~158@))) (Mul (Mul (Mul b19~156@ c19~158@) (Sub 20 d19~160@)) (Mul (Mul a19~154@ c19~158@) (Add b19~156@ b19~156@))))) (and (=> (= tmp%28@ (Add b19~156@ b19~156@)) (=> (= tmp%29@ (Mul a19~154@ c19~158@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%28@ tmp%29@) (=> %%location_label%%19 (= temp_19_0~3583@ temp_19_1~3656@))))) (=> (= temp_19_0~3583@ temp_19_1~3656@) (=> (= temp_20_0~3749@ (Sub (Mul (Add (Mul a20~162@ a20~162@) (Mul a20~162@ a20~162@)) (Add b20~164@ (Mul d20~168@ a20~162@))) (Mul (Mul (Mul c20~166@ d20~168@) (Mul c20~166@ a20~162@)) (Mul b20~164@ (Mul c20~166@ a20~162@))))) (=> (= temp_20_1~3806@ (Sub (Mul (Add (Mul a20~162@ a20~162@) (Mul a20~162@ a20~162@)) (Add b20~164@ (Mul d20~168@ a20~162@))) (Mul (Mul (Mul c20~166@ d20~168@) (Mul c20~166@ a20~162@)) (Mul (Mul c20~166@ a20~162@) b20~164@)))) (and (=> (= tmp%30@ (Mul c20~166@ a20~162@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b20~164@ tmp%30@) (=> %%location_label%%20 (= temp_20_0~3749@ temp_20_1~3806@)))) (=> (= temp_20_0~3749@ temp_20_1~3806@) (=> (= temp_21_0~3895@ (Mul (Mul (Mul b21~172@ (Mul b21~172@ a21~170@)) (Mul (Mul d21~176@ c21~174@) (Sub c21~174@ d21~176@))) (Mul (Mul c21~174@ (Sub d21~176@ c21~174@)) (Mul (Mul a21~170@ d21~176@) (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~3952@ (Mul (Mul (Mul b21~172@ (Mul b21~172@ a21~170@)) (Mul (Mul d21~176@ c21~174@) (Sub c21~174@ d21~176@))) (Mul (Mul (Sub d21~176@ c21~174@) c21~174@) (Mul (Mul a21~170@ d21~176@) (Mul a21~170@ b21~172@))))) (and (=> (= tmp%31@ (Sub d21~176@ c21~174@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c21~174@ tmp%31@) (=> %%location_label%%21 (= temp_21_0~3895@ temp_21_1~3952@)))) (=> (= temp_21_0~3895@ temp_21_1~3952@) (=> (= temp_22_0~4041@ (Mul (Add (Mul (Mul b22~180@ b22~180@) d22~184@) (Mul (Mul b22~180@ c22~182@) (Mul d22~184@ d22~184@))) (Add (Mul d22~184@ (Mul c22~182@ a22~178@)) (Mul (Mul d22~184@ c22~182@) (Mul d22~184@ d22~184@))))) (=> (= temp_22_1~4098@ (Mul (Add (Mul (Mul b22~180@ b22~180@) d22~184@) (Mul (Mul b22~180@ c22~182@) (Mul d22~184@ d22~184@))) (Add (Mul d22~184@ (Mul c22~182@ a22~178@)) (Mul (Mul d22~184@ d22~184@) (Mul d22~184@ c22~182@))))) (and (=> (= tmp%32@ (Mul d22~184@ c22~182@)) (=> (= tmp%33@ (Mul d22~184@ d22~184@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%32@ tmp%33@) (=> %%location_label%%22 (= temp_22_0~4041@ temp_22_1~4098@))))) (=> (= temp_22_0~4041@ temp_22_1~4098@) (=> (= temp_23_0~4187@ (Mul (Mul (Add (Sub b23~188@ a23~186@) b23~188@) (Mul (Sub d23~192@ d23~192@) a23~186@)) (Add (Mul a23~186@ (Mul a23~186@ a23~186@)) (Mul (Mul d23~192@ b23~188@) (Mul a23~186@ c23~190@))))) (=> (= temp_23_1~4240@ (Mul (Mul (Add (Sub b23~188@ a23~186@) b23~188@) (Mul (Sub d23~192@ d23~192@) a23~186@)) (Add (Mul (Mul a23~186@ a23~186@) a23~186@) (Mul (Mul d23~192@ b23~188@) (Mul a23~186@ c23~190@))))) (and (=> (= tmp%34@ (Mul a23~186@ a23~186@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a23~186@ tmp%34@) (=> %%location_label%%23 (= temp_23_0~4187@ temp_23_1~4240@)))) (=> (= temp_23_0~4187@ temp_23_1~4240@) (=> (= temp_24_0~4325@ (Sub (Sub (Add (Add c24~198@ d24~200@) (Add c24~198@ d24~200@)) (Mul (Mul d24~200@ d24~200@) (Mul a24~194@ b24~196@))) (Mul c24~198@ (Mul (Mul c24~198@ d24~200@) (Mul c24~198@ c24~198@))))) (=> (= temp_24_1~4378@ (Sub (Sub (Add (Add c24~198@ d24~200@) (Add c24~198@ d24~200@)) (Mul (Mul d24~200@ d24~200@) (Mul b24~196@ a24~194@))) (Mul c24~198@ (Mul (Mul c24~198@ d24~200@) (Mul c24~198@ c24~198@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a24~194@ b24~196@) (=> %%location_label%%24 (= temp_24_0~4325@ temp_24_1~4378@))) (=> (= temp_24_0~4325@ temp_24_1~4378@) (=> (= temp_25_0~4471@ (Mul (Mul (Mul (Mul a25~202@ a25~202@) (Mul a25~202@ d25~208@)) (Mul (Mul a25~202@ b25~204@) (Mul b25~204@ c25~206@))) (Sub (Sub (Mul a25~202@ b25~204@) (Sub a25~202@ d25~208@)) (Mul (Sub d25~208@ d25~208@) (Mul a25~202@ c25~206@))))) (=> (= temp_25_1~4536@ (Mul (Mul (Mul (Mul a25~202@ a25~202@) (Mul a25~202@ d25~208@)) (Mul (Mul b25~204@ c25~206@) (Mul a25~202@ b25~204@))) (Sub (Sub (Mul a25~202@ b25~204@) (Sub a25~202@ d25~208@)) (Mul (Sub d25~208@ d25~208@) (Mul a25~202@ c25~206@))))) (and (=> (= tmp%35@ (Mul a25~202@ b25~204@)) (=> (= tmp%36@ (Mul b25~204@ c25~206@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%35@ tmp%36@) (=> %%location_label%%25 (= temp_25_0~4471@ temp_25_1~4536@))))) (=> (= temp_25_0~4471@ temp_25_1~4536@) (=> (= temp_26_0~4637@ (Mul (Mul (Sub (Mul c26~214@ c26~214@) (Mul a26~210@ b26~212@)) (Mul (Mul c26~214@ c26~214@) (Mul a26~210@ d26~216@))) (Mul (Mul (Mul c26~214@ a26~210@) (Mul c26~214@ c26~214@)) (Mul (Mul b26~212@ d26~216@) (Add c26~214@ a26~210@))))) (=> (= temp_26_1~4702@ (Mul (Mul (Mul (Mul c26~214@ c26~214@) (Mul a26~210@ d26~216@)) (Sub (Mul c26~214@ c26~214@) (Mul a26~210@ b26~212@))) (Mul (Mul (Mul c26~214@ a26~210@) (Mul c26~214@ c26~214@)) (Mul (Mul b26~212@ d26~216@) (Add c26~214@ a26~210@))))) (and (=> (= tmp%37@ (Sub (Mul c26~214@ c26~214@) (Mul a26~210@ b26~212@))) (=> (= tmp%38@ (Mul (Mul c26~214@ c26~214@) (Mul a26~210@ d26~216@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%37@ tmp%38@) (=> %%location_label%%26 (= temp_26_0~4637@ temp_26_1~4702@))))) (=> (= temp_26_0~4637@ temp_26_1~4702@) (=> (= temp_27_0~4803@ (Mul (Mul (Mul d27~224@ (Mul d27~224@ c27~222@)) (Mul (Mul a27~218@ b27~220@) (Sub c27~222@ b27~220@))) (Mul (Mul (Mul d27~224@ c27~222@) (Mul b27~220@ c27~222@)) b27~220@))) (=> (= temp_27_1~4852@ (Mul (Mul (Mul (Mul d27~224@ c27~222@) (Mul b27~220@ c27~222@)) b27~220@) (Mul (Mul d27~224@ (Mul d27~224@ c27~222@)) (Mul (Mul a27~218@ b27~220@) (Sub c27~222@ b27~220@))))) (=> (= tmp%39@ (Mul (Mul d27~224@ (Mul d27~224@ c27~222@)) (Mul (Mul a27~218@ b27~220@) (Sub c27~222@ b27~220@)))) (=> (= tmp%40@ (Mul (Mul (Mul d27~224@ c27~222@) (Mul b27~220@ c27~222@)) b27~220@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%39@ tmp%40@) (=> %%location_label%%27 (= temp_27_0~4803@ temp_27_1~4852@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
