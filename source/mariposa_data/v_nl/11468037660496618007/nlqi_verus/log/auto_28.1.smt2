...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Add c0~6@ c0~6@)) (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ c0~6@))) (Sub (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Add c0~6@ c0~6@)) (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ c0~6@))) (Sub (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Sub b0~4@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~479@ (Mul (Mul (Mul (Sub c1~14@ b1~12@) (Mul d1~16@ c1~14@)) (Add a1~10@ (Mul b1~12@ c1~14@))) (Mul (Mul (Mul c1~14@ 26) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ a1~10@) (Mul 44 a1~10@))))) (=> (= temp_1_1~564@ (Mul (Mul (Mul (Sub c1~14@ b1~12@) (Mul d1~16@ c1~14@)) (Add a1~10@ (Mul b1~12@ c1~14@))) (Mul (Mul (Mul (Mul c1~14@ 26) a1~10@) a1~10@) (Mul (Mul c1~14@ a1~10@) (Mul 44 a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~479@ temp_1_1~564@))) (=> (= temp_1_0~479@ temp_1_1~564@) (=> (= temp_2_0~653@ (Mul (Sub (Sub (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ c2~22@))))) (=> (= temp_2_1~718@ (Mul (Mul (Sub (Sub (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@))) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ c2~22@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~653@ temp_2_1~718@))) (=> (= temp_2_0~653@ temp_2_1~718@) (=> (= temp_3_0~803@ (Mul (Mul (Mul (Sub c3~30@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Add a3~26@ c3~30@))) (Add (Mul (Mul a3~26@ c3~30@) (Add b3~28@ b3~28@)) (Mul (Mul b3~28@ a3~26@) a3~26@)))) (=> (= temp_3_1~864@ (Mul (Mul (Mul (Sub c3~30@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Add a3~26@ c3~30@))) (Add (Mul (Mul a3~26@ c3~30@) (Add b3~28@ b3~28@)) (Mul b3~28@ (Mul a3~26@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~803@ temp_3_1~864@))) (=> (= temp_3_0~803@ temp_3_1~864@) (=> (= temp_4_0~925@ (Mul a4~34@ (Mul (Sub (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~962@ (Mul (Mul a4~34@ (Sub (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@))) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~925@ temp_4_1~962@))) (=> (= temp_4_0~925@ temp_4_1~962@) (=> (= temp_5_0~1051@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ b5~44@) (Sub d5~48@ a5~42@))))) (=> (= temp_5_1~1116@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ b5~44@) (Sub d5~48@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1051@ temp_5_1~1116@))) (=> (= temp_5_0~1051@ temp_5_1~1116@) (=> (= temp_6_0~1205@ (Sub (Mul (Mul (Sub c6~54@ d6~56@) (Mul b6~52@ d6~56@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1270@ (Sub (Mul (Mul (Sub c6~54@ d6~56@) (Mul b6~52@ d6~56@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1205@ temp_6_1~1270@))) (=> (= temp_6_0~1205@ temp_6_1~1270@) (=> (= temp_7_0~1347@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ b7~60@)) d7~64@) (Mul (Sub (Sub d7~64@ b7~60@) (Mul b7~60@ d7~64@)) (Sub (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1400@ (Mul (Mul (Sub (Sub d7~64@ b7~60@) (Mul b7~60@ d7~64@)) (Sub (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ b7~60@)) d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1347@ temp_7_1~1400@))) (=> (= temp_7_0~1347@ temp_7_1~1400@) (=> (= temp_8_0~1501@ (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Mul 61 b8~68@))) (Mul (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul d8~72@ b8~68@) (Add d8~72@ b8~68@))))) (=> (= temp_8_1~1578@ (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul 61 b8~68@) (Mul d8~72@ d8~72@))) (Mul (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul d8~72@ b8~68@) (Add d8~72@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1501@ temp_8_1~1578@))) (=> (= temp_8_0~1501@ temp_8_1~1578@) (=> (= temp_9_0~1667@ (Mul (Mul (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ a9~74@)) (Mul (Mul c9~78@ b9~76@) (Mul d9~80@ b9~76@))) (Mul (Mul (Add b9~76@ d9~80@) (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~1732@ (Mul (Mul (Mul (Mul b9~76@ d9~80@) (Mul b9~76@ a9~74@)) (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Mul (Add b9~76@ d9~80@) (Mul d9~80@ b9~76@)) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1667@ temp_9_1~1732@))) (=> (= temp_9_0~1667@ temp_9_1~1732@) (=> (= temp_10_0~1809@ (Mul (Add (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@))) (Mul (Mul (Add a10~82@ c10~86@) (Mul b10~84@ a10~82@)) a10~82@))) (=> (= temp_10_1~1882@ (Add (Mul (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul (Add a10~82@ c10~86@) (Mul b10~84@ a10~82@)) a10~82@)) (Mul (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul (Add a10~82@ c10~86@) (Mul b10~84@ a10~82@)) a10~82@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1809@ temp_10_1~1882@))) (=> (= temp_10_0~1809@ temp_10_1~1882@) (=> (= temp_11_0~1955@ (Mul (Sub (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ c11~94@) (Mul b11~92@ a11~90@))) (Mul d11~96@ (Add c11~94@ (Mul c11~94@ c11~94@))))) (=> (= temp_11_1~2004@ (Mul (Sub (Mul (Mul a11~90@ b11~92@) (Mul a11~90@ c11~94@)) (Mul (Mul b11~92@ a11~90@) (Mul d11~96@ c11~94@))) (Mul d11~96@ (Add c11~94@ (Mul c11~94@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1955@ temp_11_1~2004@))) (=> (= temp_11_0~1955@ temp_11_1~2004@) (=> (= temp_12_0~2093@ (Mul (Mul (Mul (Mul a12~98@ a12~98@) (Mul a12~98@ b12~100@)) (Add (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@))) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2158@ (Mul (Mul (Mul (Mul a12~98@ a12~98@) (Mul a12~98@ b12~100@)) (Add (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@))) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ b12~100@)) (Mul b12~100@ (Mul b12~100@ (Mul b12~100@ a12~98@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2093@ temp_12_1~2158@))) (=> (= temp_12_0~2093@ temp_12_1~2158@) (=> (= temp_13_0~2247@ (Mul (Mul (Mul (Sub c13~110@ c13~110@) (Add a13~106@ d13~112@)) (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ d13~112@))) (Mul (Sub (Mul d13~112@ c13~110@) (Mul c13~110@ a13~106@)) (Add (Mul d13~112@ b13~108@) (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~2308@ (Mul (Mul (Mul (Sub c13~110@ c13~110@) (Add a13~106@ d13~112@)) (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ d13~112@))) (Mul (Sub (Mul d13~112@ c13~110@) (Mul c13~110@ a13~106@)) (Mul d13~112@ (Add b13~108@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2247@ temp_13_1~2308@))) (=> (= temp_13_0~2247@ temp_13_1~2308@) (=> (= temp_14_0~2393@ (Mul (Mul (Add b14~116@ (Mul a14~114@ b14~116@)) (Mul (Mul c14~118@ b14~116@) (Mul a14~114@ b14~116@))) (Mul (Add (Mul a14~114@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@))))) (=> (= temp_14_1~2454@ (Mul (Mul (Add b14~116@ (Mul a14~114@ b14~116@)) (Mul (Mul b14~116@ c14~118@) (Mul a14~114@ b14~116@))) (Mul (Add (Mul a14~114@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2393@ temp_14_1~2454@))) (=> (= temp_14_0~2393@ temp_14_1~2454@) (=> (= temp_15_0~2543@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Sub d15~128@ a15~122@)) (Add (Mul d15~128@ b15~124@) (Mul d15~128@ a15~122@))) (Add (Sub (Mul d15~128@ b15~124@) (Mul a15~122@ c15~126@)) (Sub (Mul d15~128@ d15~128@) (Add a15~122@ b15~124@))))) (=> (= temp_15_1~2608@ (Mul (Mul (Mul c15~126@ c15~126@) (Mul (Sub d15~128@ a15~122@) (Add (Mul d15~128@ b15~124@) (Mul d15~128@ a15~122@)))) (Add (Sub (Mul d15~128@ b15~124@) (Mul a15~122@ c15~126@)) (Sub (Mul d15~128@ d15~128@) (Add a15~122@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2543@ temp_15_1~2608@))) (=> (= temp_15_0~2543@ temp_15_1~2608@) (=> (= temp_16_0~2717@ (Mul (Add (Mul (Add b16~132@ b16~132@) (Mul b16~132@ c16~134@)) (Add (Mul c16~134@ d16~136@) (Mul d16~136@ d16~136@))) (Mul (Mul (Mul b16~132@ 38) (Mul a16~130@ a16~130@)) (Mul 52 (Add d16~136@ c16~134@))))) (=> (= temp_16_1~2802@ (Mul (Add (Mul (Add b16~132@ b16~132@) (Mul b16~132@ c16~134@)) (Add (Mul c16~134@ d16~136@) (Mul d16~136@ d16~136@))) (Mul (Mul b16~132@ 38) (Mul (Mul a16~130@ a16~130@) (Mul 52 (Add d16~136@ c16~134@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2717@ temp_16_1~2802@))) (=> (= temp_16_0~2717@ temp_16_1~2802@) (=> (= temp_17_0~2891@ (Mul (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul a17~138@ d17~144@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul a17~138@ b17~140@) (Mul b17~140@ b17~140@)) (Mul (Mul c17~142@ b17~140@) (Add b17~140@ c17~142@))))) (=> (= temp_17_1~2956@ (Mul (Mul (Mul (Mul d17~144@ a17~138@) (Mul a17~138@ b17~140@)) (Mul (Mul a17~138@ d17~144@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul b17~140@ b17~140@) (Mul a17~138@ b17~140@)) (Mul (Mul c17~142@ b17~140@) (Add b17~140@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2891@ temp_17_1~2956@))) (=> (= temp_17_0~2891@ temp_17_1~2956@) (=> (= temp_18_0~3041@ (Sub (Add (Mul c18~150@ (Mul b18~148@ c18~150@)) (Mul (Sub d18~152@ c18~150@) (Mul b18~148@ c18~150@))) (Mul (Mul (Mul c18~150@ b18~148@) (Mul a18~146@ d18~152@)) (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ b18~148@))))) (=> (= temp_18_1~3102@ (Sub (Add (Mul c18~150@ (Mul b18~148@ c18~150@)) (Mul (Mul (Sub d18~152@ c18~150@) b18~148@) c18~150@)) (Mul (Mul (Mul c18~150@ b18~148@) (Mul a18~146@ d18~152@)) (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ b18~148@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3041@ temp_18_1~3102@))) (=> (= temp_18_0~3041@ temp_18_1~3102@) (=> (= temp_19_0~3199@ (Sub (Mul (Sub d19~160@ (Mul b19~156@ d19~160@)) (Mul (Add a19~154@ b19~156@) (Add b19~156@ c19~158@))) (Mul (Mul (Mul b19~156@ c19~158@) (Sub 20 d19~160@)) (Mul (Add b19~156@ b19~156@) (Mul a19~154@ c19~158@))))) (=> (= temp_19_1~3272@ (Sub (Mul (Sub d19~160@ (Mul b19~156@ d19~160@)) (Mul (Add a19~154@ b19~156@) (Add b19~156@ c19~158@))) (Mul (Mul (Mul b19~156@ c19~158@) (Sub 20 d19~160@)) (Mul (Mul a19~154@ c19~158@) (Add b19~156@ b19~156@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3199@ temp_19_1~3272@))) (=> (= temp_19_0~3199@ temp_19_1~3272@) (=> (= temp_20_0~3353@ (Sub (Mul (Add (Mul a20~162@ a20~162@) (Mul a20~162@ a20~162@)) (Add b20~164@ (Mul d20~168@ a20~162@))) (Mul (Mul (Mul c20~166@ d20~168@) (Mul c20~166@ a20~162@)) (Mul b20~164@ (Mul c20~166@ a20~162@))))) (=> (= temp_20_1~3410@ (Sub (Mul (Add (Mul a20~162@ a20~162@) (Mul a20~162@ a20~162@)) (Add b20~164@ (Mul d20~168@ a20~162@))) (Mul (Mul (Mul c20~166@ d20~168@) (Mul c20~166@ a20~162@)) (Mul (Mul c20~166@ a20~162@) b20~164@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3353@ temp_20_1~3410@))) (=> (= temp_20_0~3353@ temp_20_1~3410@) (=> (= temp_21_0~3491@ (Mul (Mul (Mul b21~172@ (Mul b21~172@ a21~170@)) (Mul (Mul d21~176@ c21~174@) (Sub c21~174@ d21~176@))) (Mul (Mul c21~174@ (Sub d21~176@ c21~174@)) (Mul (Mul a21~170@ d21~176@) (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~3548@ (Mul (Mul (Mul b21~172@ (Mul b21~172@ a21~170@)) (Mul (Mul d21~176@ c21~174@) (Sub c21~174@ d21~176@))) (Mul (Mul (Sub d21~176@ c21~174@) c21~174@) (Mul (Mul a21~170@ d21~176@) (Mul a21~170@ b21~172@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3491@ temp_21_1~3548@))) (=> (= temp_21_0~3491@ temp_21_1~3548@) (=> (= temp_22_0~3629@ (Mul (Add (Mul (Mul b22~180@ b22~180@) d22~184@) (Mul (Mul b22~180@ c22~182@) (Mul d22~184@ d22~184@))) (Add (Mul d22~184@ (Mul c22~182@ a22~178@)) (Mul (Mul d22~184@ c22~182@) (Mul d22~184@ d22~184@))))) (=> (= temp_22_1~3686@ (Mul (Add (Mul (Mul b22~180@ b22~180@) d22~184@) (Mul (Mul b22~180@ c22~182@) (Mul d22~184@ d22~184@))) (Add (Mul d22~184@ (Mul c22~182@ a22~178@)) (Mul (Mul d22~184@ d22~184@) (Mul d22~184@ c22~182@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3629@ temp_22_1~3686@))) (=> (= temp_22_0~3629@ temp_22_1~3686@) (=> (= temp_23_0~3763@ (Mul (Mul (Add (Sub b23~188@ a23~186@) b23~188@) (Mul (Sub d23~192@ d23~192@) a23~186@)) (Add (Mul a23~186@ (Mul a23~186@ a23~186@)) (Mul (Mul d23~192@ b23~188@) (Mul a23~186@ c23~190@))))) (=> (= temp_23_1~3816@ (Mul (Mul (Add (Sub b23~188@ a23~186@) b23~188@) (Mul (Sub d23~192@ d23~192@) a23~186@)) (Add (Mul (Mul a23~186@ a23~186@) a23~186@) (Mul (Mul d23~192@ b23~188@) (Mul a23~186@ c23~190@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3763@ temp_23_1~3816@))) (=> (= temp_23_0~3763@ temp_23_1~3816@) (=> (= temp_24_0~3893@ (Sub (Sub (Add (Add c24~198@ d24~200@) (Add c24~198@ d24~200@)) (Mul (Mul d24~200@ d24~200@) (Mul a24~194@ b24~196@))) (Mul c24~198@ (Mul (Mul c24~198@ d24~200@) (Mul c24~198@ c24~198@))))) (=> (= temp_24_1~3946@ (Sub (Sub (Add (Add c24~198@ d24~200@) (Add c24~198@ d24~200@)) (Mul (Mul d24~200@ d24~200@) (Mul b24~196@ a24~194@))) (Mul c24~198@ (Mul (Mul c24~198@ d24~200@) (Mul c24~198@ c24~198@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3893@ temp_24_1~3946@))) (=> (= temp_24_0~3893@ temp_24_1~3946@) (=> (= temp_25_0~4035@ (Mul (Mul (Mul (Mul a25~202@ a25~202@) (Mul a25~202@ d25~208@)) (Mul (Mul a25~202@ b25~204@) (Mul b25~204@ c25~206@))) (Sub (Sub (Mul a25~202@ b25~204@) (Sub a25~202@ d25~208@)) (Mul (Sub d25~208@ d25~208@) (Mul a25~202@ c25~206@))))) (=> (= temp_25_1~4100@ (Mul (Mul (Mul (Mul a25~202@ a25~202@) (Mul a25~202@ d25~208@)) (Mul (Mul b25~204@ c25~206@) (Mul a25~202@ b25~204@))) (Sub (Sub (Mul a25~202@ b25~204@) (Sub a25~202@ d25~208@)) (Mul (Sub d25~208@ d25~208@) (Mul a25~202@ c25~206@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~4035@ temp_25_1~4100@))) (=> (= temp_25_0~4035@ temp_25_1~4100@) (=> (= temp_26_0~4189@ (Mul (Mul (Sub (Mul c26~214@ c26~214@) (Mul a26~210@ b26~212@)) (Mul (Mul c26~214@ c26~214@) (Mul a26~210@ d26~216@))) (Mul (Mul (Mul c26~214@ a26~210@) (Mul c26~214@ c26~214@)) (Mul (Mul b26~212@ d26~216@) (Add c26~214@ a26~210@))))) (=> (= temp_26_1~4254@ (Mul (Mul (Mul (Mul c26~214@ c26~214@) (Mul a26~210@ d26~216@)) (Sub (Mul c26~214@ c26~214@) (Mul a26~210@ b26~212@))) (Mul (Mul (Mul c26~214@ a26~210@) (Mul c26~214@ c26~214@)) (Mul (Mul b26~212@ d26~216@) (Add c26~214@ a26~210@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%26 (= temp_26_0~4189@ temp_26_1~4254@))) (=> (= temp_26_0~4189@ temp_26_1~4254@) (=> (= temp_27_0~4327@ (Mul (Mul (Mul d27~224@ (Mul d27~224@ c27~222@)) (Mul (Mul a27~218@ b27~220@) (Sub c27~222@ b27~220@))) (Mul (Mul (Mul d27~224@ c27~222@) (Mul b27~220@ c27~222@)) b27~220@))) (=> (= temp_27_1~4376@ (Mul (Mul (Mul (Mul d27~224@ c27~222@) (Mul b27~220@ c27~222@)) b27~220@) (Mul (Mul d27~224@ (Mul d27~224@ c27~222@)) (Mul (Mul a27~218@ b27~220@) (Sub c27~222@ b27~220@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%27 (= temp_27_0~4327@ temp_27_1~4376@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
