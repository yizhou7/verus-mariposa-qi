...
(declare-const temp_7_1~2177@ Int)
(declare-const temp_8_0~2277@ Int)
(declare-const temp_8_1~2362@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ d0~8@)) (Add (Mul c0~6@ c0~6@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul a0~2@ c0~6@) (Sub a0~2@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@)))) (Mul (Sub (Sub (Sub d0~8@ c0~6@) (Mul b0~4@ c0~6@)) c0~6@) (Sub (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul a0~2@ 97) (Mul d0~8@ a0~2@)))))) (=> (= temp_0_1~418@ (Mul (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ d0~8@)) (Add (Mul c0~6@ c0~6@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul a0~2@ c0~6@) (Sub a0~2@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@)))) (Mul (Sub (Sub (Sub d0~8@ c0~6@) (Mul b0~4@ c0~6@)) c0~6@) (Sub (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul (Mul a0~2@ 97) d0~8@) a0~2@))))) (=> (= tmp%1@ (= temp_0_0~289@ temp_0_1~418@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~558@ (Sub (Sub (Mul (Mul (Mul b1~12@ c1~14@) (Sub d1~16@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ 16))) (Sub (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Add a1~10@ b1~12@) (Mul c1~14@ c1~14@)))) (Mul (Mul d1~16@ (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul d1~16@ d1~16@) c1~14@) (Mul (Sub c1~14@ d1~16@) (Mul d1~16@ a1~10@)))))) (=> (= temp_1_1~683@ (Sub (Sub (Mul (Mul (Mul b1~12@ c1~14@) (Sub d1~16@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ 16))) (Sub (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ c1~14@)) (Mul (Add a1~10@ b1~12@) (Mul c1~14@ c1~14@)))) (Mul (Mul d1~16@ (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul d1~16@ d1~16@) c1~14@) (Mul (Sub c1~14@ d1~16@) (Mul d1~16@ a1~10@)))))) (=> (= tmp%2@ (= temp_1_0~558@ temp_1_1~683@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~803@ (Mul (Mul (Mul (Add (Mul a2~18@ b2~20@) (Add a2~18@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ c2~22@))) (Mul (Add (Mul b2~20@ d2~24@) (Add d2~24@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@)))) (Add (Mul a2~18@ (Add (Mul d2~24@ a2~18@) c2~22@)) (Mul (Add (Add b2~20@ b2~20@) (Mul b2~20@ d2~24@)) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~908@ (Mul (Mul (Mul (Add (Mul a2~18@ b2~20@) (Add a2~18@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ c2~22@))) (Mul (Add (Mul b2~20@ d2~24@) (Add d2~24@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@)))) (Add (Mul (Add (Mul d2~24@ a2~18@) c2~22@) a2~18@) (Mul (Add (Add b2~20@ b2~20@) (Mul b2~20@ d2~24@)) (Mul b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~803@ temp_2_1~908@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1024@ (Mul (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ c3~30@)) a3~26@) (Mul b3~28@ (Sub (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@)))) (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ a3~26@)) b3~28@) (Mul (Mul (Mul d3~32@ a3~26@) 25) (Mul (Mul c3~30@ b3~28@) (Mul d3~32@ a3~26@)))))) (=> (= temp_3_1~1125@ (Mul (Mul (Mul b3~28@ (Sub (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ c3~30@)) a3~26@)) (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ a3~26@)) b3~28@) (Mul (Mul (Mul d3~32@ a3~26@) 25) (Mul (Mul c3~30@ b3~28@) (Mul d3~32@ a3~26@)))))) (=> (= tmp%4@ (= temp_3_0~1024@ temp_3_1~1125@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1249@ (Mul (Sub (Add (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Sub d4~40@ a4~34@) (Sub c4~38@ a4~34@))) (Mul (Mul (Add a4~34@ b4~36@) d4~40@) b4~36@)) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@))) (Mul (Mul b4~36@ (Mul a4~34@ b4~36@)) (Add (Sub a4~34@ c4~38@) (Mul c4~38@ d4~40@)))))) (=> (= temp_4_1~1358@ (Mul (Sub (Add (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Sub d4~40@ a4~34@) (Sub c4~38@ a4~34@))) (Mul (Mul (Add a4~34@ b4~36@) d4~40@) b4~36@)) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@))) (Mul (Mul b4~36@ (Mul a4~34@ b4~36@)) (Add (Sub a4~34@ c4~38@) (Mul c4~38@ d4~40@)))))) (=> (= tmp%5@ (= temp_4_0~1249@ temp_4_1~1358@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1506@ (Add (Mul (Sub (Mul (Sub a5~42@ a5~42@) (Mul c5~46@ c5~46@)) (Sub (Mul a5~42@ c5~46@) (Mul b5~44@ b5~44@))) (Add (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul 48 a5~42@) (Mul a5~42@ d5~48@)))) (Mul (Mul (Mul (Mul b5~44@ c5~46@) a5~42@) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) d5~48@))))) (=> (= temp_5_1~1639@ (Add (Mul (Sub (Mul (Sub a5~42@ a5~42@) (Mul c5~46@ c5~46@)) (Sub (Mul a5~42@ c5~46@) (Mul b5~44@ b5~44@))) (Add (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul 48 a5~42@) (Mul a5~42@ d5~48@)))) (Mul (Mul (Mul (Mul b5~44@ c5~46@) a5~42@) (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1506@ temp_5_1~1639@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1767@ (Mul (Mul (Mul (Add (Mul c6~54@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Sub c6~54@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Mul (Add d6~56@ a6~50@) (Mul c6~54@ d6~56@)) (Add (Mul c6~54@ 63) (Add a6~50@ d6~56@)))) (Mul c6~54@ (Add (Mul (Mul a6~50@ c6~54@) (Sub b6~52@ d6~56@)) (Mul (Sub b6~52@ d6~56@) (Sub b6~52@ b6~52@)))))) (=> (= temp_6_1~1880@ (Mul (Mul (Mul (Mul (Sub c6~54@ d6~56@) (Mul a6~50@ b6~52@)) (Add (Mul c6~54@ b6~52@) (Mul c6~54@ b6~52@))) (Mul (Mul (Add d6~56@ a6~50@) (Mul c6~54@ d6~56@)) (Add (Mul c6~54@ 63) (Add a6~50@ d6~56@)))) (Mul c6~54@ (Add (Mul (Mul a6~50@ c6~54@) (Sub b6~52@ d6~56@)) (Mul (Sub b6~52@ d6~56@) (Sub b6~52@ b6~52@)))))) (=> (= tmp%7@ (= temp_6_0~1767@ temp_6_1~1880@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2020@ (Mul (Mul (Mul (Mul a7~58@ (Mul b7~60@ c7~62@)) (Mul (Sub d7~64@ d7~64@) (Mul a7~58@ c7~62@))) (Mul (Sub (Mul d7~64@ c7~62@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Add c7~62@ a7~58@)))) (Mul (Mul (Mul (Sub c7~62@ c7~62@) (Sub c7~62@ a7~58@)) (Mul (Mul a7~58@ c7~62@) (Add c7~62@ c7~62@))) (Sub (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@)))))) (=> (= temp_7_1~2177@ (Mul (Mul (Mul (Mul a7~58@ (Mul b7~60@ c7~62@)) (Mul (Sub d7~64@ d7~64@) (Mul a7~58@ c7~62@))) (Mul (Sub (Mul d7~64@ c7~62@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Add c7~62@ a7~58@)))) (Sub (Mul (Mul (Mul (Sub c7~62@ c7~62@) (Sub c7~62@ a7~58@)) (Mul (Mul a7~58@ c7~62@) (Add c7~62@ c7~62@))) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul (Sub c7~62@ c7~62@) (Sub c7~62@ a7~58@)) (Mul (Mul a7~58@ c7~62@) (Add c7~62@ c7~62@))) (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ c7~62@)))))) (=> (= tmp%8@ (= temp_7_0~2020@ temp_7_1~2177@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2277@ (Mul (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Add d8~72@ b8~68@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ b8~68@)))) (Add c8~70@ (Mul d8~72@ (Mul (Sub c8~70@ d8~72@) a8~66@))))) (=> (= temp_8_1~2362@ (Mul (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ c8~70@)) (Mul a8~66@ (Mul a8~66@ (Add d8~72@ b8~68@)))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ b8~68@)))) (Add c8~70@ (Mul d8~72@ (Mul (Sub c8~70@ d8~72@) a8~66@))))) (=> (= tmp%9@ (= temp_8_0~2277@ temp_8_1~2362@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
