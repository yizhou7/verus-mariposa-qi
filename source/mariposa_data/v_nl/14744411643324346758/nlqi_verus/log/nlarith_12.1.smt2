...
(assert (=> %%query%% (not (=> (= temp_0_0~325@ (Sub (Mul (Mul (Mul a0~2@ b0~4@) (Sub a0~2@ a0~2@)) (Mul c0~6@ (Mul d0~8@ b0~4@))) (Mul (Mul (Mul a0~2@ 4) (Mul 92 c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~410@ (Sub (Mul (Mul c0~6@ (Mul d0~8@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Sub a0~2@ a0~2@))) (Mul (Mul (Mul a0~2@ 4) (Mul 92 c0~6@)) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~325@ temp_0_1~410@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~478@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ b1~12@)) a1~10@))) (=> (= temp_1_1~531@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ c1~14@))) (Mul a1~10@ (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~478@ temp_1_1~531@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~623@ (Add (Sub (Mul (Mul c2~22@ b2~20@) (Sub b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Add a2~18@ 96) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~700@ (Add (Sub (Mul (Mul c2~22@ b2~20@) (Sub b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul (Mul a2~18@ b2~20@) c2~22@) a2~18@) (Mul (Add a2~18@ 96) (Mul c2~22@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~623@ temp_2_1~700@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~792@ (Mul (Mul (Mul (Sub a3~26@ d3~32@) (Mul a3~26@ 92)) (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ a3~26@))) (Mul (Add (Mul c3~30@ d3~32@) (Add c3~30@ d3~32@)) (Mul (Add d3~32@ d3~32@) (Add a3~26@ d3~32@))))) (=> (= temp_3_1~869@ (Mul (Mul (Mul (Sub a3~26@ d3~32@) (Mul a3~26@ 92)) (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ a3~26@))) (Mul (Add (Mul d3~32@ c3~30@) (Add c3~30@ d3~32@)) (Mul (Add d3~32@ d3~32@) (Add a3~26@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~792@ temp_3_1~869@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~945@ (Mul (Add (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@)) (Mul b4~36@ (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~1006@ (Mul (Add (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ d4~40@))) (Mul (Mul b4~36@ (Mul b4~36@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~945@ temp_4_1~1006@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1086@ (Add (Mul (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ b5~44@)) (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ b5~44@))) (Add (Mul (Sub c5~46@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1151@ (Add (Mul (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ b5~44@)) (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ b5~44@))) (Add (Mul (Sub c5~46@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Mul (Mul d5~48@ d5~48@) a5~42@) a5~42@)))) (=> (= tmp%6@ (= temp_5_0~1086@ temp_5_1~1151@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1227@ (Sub (Mul (Sub (Mul a6~50@ b6~52@) d6~56@) (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul a6~50@ d6~56@) (Sub a6~50@ d6~56@)) (Sub (Mul b6~52@ a6~50@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1288@ (Sub (Mul (Sub (Mul a6~50@ b6~52@) d6~56@) (Mul (Mul (Mul a6~50@ d6~56@) d6~56@) c6~54@)) (Mul (Mul (Mul a6~50@ d6~56@) (Sub a6~50@ d6~56@)) (Sub (Mul b6~52@ a6~50@) (Mul c6~54@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1227@ temp_6_1~1288@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1380@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Add (Mul a7~58@ d7~64@) (Mul d7~64@ d7~64@))) (Mul (Sub (Add d7~64@ a7~58@) (Mul d7~64@ 61)) (Mul (Sub a7~58@ c7~62@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1457@ (Mul (Mul (Mul a7~58@ b7~60@) (Mul (Mul c7~62@ c7~62@) (Add (Mul a7~58@ d7~64@) (Mul d7~64@ d7~64@)))) (Mul (Sub (Add d7~64@ a7~58@) (Mul d7~64@ 61)) (Mul (Sub a7~58@ c7~62@) (Mul a7~58@ c7~62@))))) (=> (= tmp%8@ (= temp_7_0~1380@ temp_7_1~1457@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1537@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul 81 d8~72@) (Add d8~72@ d8~72@))) (Mul (Mul (Mul a8~66@ d8~72@) (Sub c8~70@ d8~72@)) a8~66@))) (=> (= temp_8_1~1602@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ 81) (Add d8~72@ d8~72@))) (Mul (Mul (Mul a8~66@ d8~72@) (Sub c8~70@ d8~72@)) a8~66@))) (=> (= tmp%9@ (= temp_8_0~1537@ temp_8_1~1602@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1678@ (Mul (Mul (Add (Mul d9~80@ c9~78@) (Mul a9~74@ c9~78@)) (Mul (Mul a9~74@ a9~74@) (Mul b9~76@ c9~78@))) (Sub (Add (Mul c9~78@ d9~80@) (Mul a9~74@ b9~76@)) (Mul (Mul b9~76@ b9~76@) a9~74@)))) (=> (= temp_9_1~1739@ (Mul (Mul (Add (Mul d9~80@ c9~78@) (Mul a9~74@ c9~78@)) (Mul (Mul a9~74@ a9~74@) (Mul b9~76@ c9~78@))) (Sub (Add (Mul d9~80@ c9~78@) (Mul a9~74@ b9~76@)) (Mul (Mul b9~76@ b9~76@) a9~74@)))) (=> (= tmp%10@ (= temp_9_0~1678@ temp_9_1~1739@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1807@ (Sub (Mul (Mul (Add d10~88@ d10~88@) (Mul a10~82@ c10~86@)) a10~82@) (Mul (Mul (Mul b10~84@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~1860@ (Sub (Mul (Mul (Add d10~88@ d10~88@) (Mul a10~82@ c10~86@)) a10~82@) (Mul (Mul (Mul b10~84@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1807@ temp_10_1~1860@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1940@ (Mul (Add (Sub (Mul d11~96@ d11~96@) (Add c11~94@ c11~94@)) (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@))) (Mul (Sub (Mul b11~92@ a11~90@) (Sub d11~96@ b11~92@)) (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ b11~92@))))) (=> (= temp_11_1~2005@ (Mul (Mul (Sub (Mul b11~92@ a11~90@) (Sub d11~96@ b11~92@)) (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ b11~92@))) (Add (Sub (Mul d11~96@ d11~96@) (Add c11~94@ c11~94@)) (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1940@ temp_11_1~2005@)) (=> %%location_label%%11 tmp%12@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
