...
(set-info :comment ";; mariposa_data/v_nl//16221891383611739967/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_5_1~1304@ Int)
...
(declare-const temp_12_1~2410@ Int)
(declare-const temp_13_0~2553@ Int)
(declare-const temp_13_1~2618@ Int)
(declare-const temp_14_0~2729@ Int)
(declare-const temp_14_1~2806@ Int)
(declare-const temp_15_0~2933@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ 1) (Mul a0~2@ d0~8@)) b0~4@) (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@)) (Sub (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul d0~8@ 1) (Mul (Mul a0~2@ d0~8@) b0~4@)) (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@)) (Sub (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@))))) (and (=> (= tmp%1@ (Mul d0~8@ 1)) (=> (= tmp%2@ (Mul a0~2@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ b0~4@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~485@ (Mul (Mul (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ a1~10@)) (Add (Mul b1~12@ a1~10@) (Mul d1~16@ a1~10@))) (Sub (Mul (Sub a1~10@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~550@ (Mul (Mul (Mul c1~14@ c1~14@) (Mul (Mul c1~14@ a1~10@) (Add (Mul b1~12@ a1~10@) (Mul d1~16@ a1~10@)))) (Sub (Mul (Sub a1~10@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ d1~16@))))) (and (=> (= tmp%3@ (Mul c1~14@ c1~14@)) (=> (= tmp%4@ (Mul c1~14@ a1~10@)) (=> (= tmp%5@ (Add (Mul b1~12@ a1~10@) (Mul d1~16@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~485@ temp_1_1~550@)))))) (=> (= temp_1_0~485@ temp_1_1~550@) (=> (= temp_2_0~673@ (Mul (Add (Mul (Sub b2~20@ c2~22@) (Mul d2~24@ 26)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ b2~20@) d2~24@) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@))))) (=> (= temp_2_1~766@ (Mul (Add (Sub (Mul b2~20@ (Mul d2~24@ 26)) (Mul c2~22@ (Mul d2~24@ 26))) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ b2~20@) d2~24@) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@))))) (and (=> (= tmp%6@ (Mul d2~24@ 26)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b2~20@ c2~22@ tmp%6@) (=> %%location_label%%2 (= temp_2_0~673@ temp_2_1~766@)))) (=> (= temp_2_0~673@ temp_2_1~766@) (=> (= temp_3_0~873@ (Mul (Mul (Mul (Add b3~28@ b3~28@) (Add c3~30@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@))) (Mul (Mul (Sub c3~30@ b3~28@) b3~28@) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@))))) (=> (= temp_3_1~934@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Add b3~28@ b3~28@) (Add c3~30@ b3~28@))) (Mul (Mul (Sub c3~30@ b3~28@) b3~28@) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@))))) (and (=> (= tmp%7@ (Mul (Add b3~28@ b3~28@) (Add c3~30@ b3~28@))) (=> (= tmp%8@ (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%3 (= temp_3_0~873@ temp_3_1~934@))))) (=> (= temp_3_0~873@ temp_3_1~934@) (=> (= temp_4_0~1051@ (Mul (Add (Mul (Mul d4~40@ c4~38@) (Sub b4~36@ a4~34@)) (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ a4~34@))) (Mul (Add (Mul d4~40@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@))))) (=> (= temp_4_1~1116@ (Mul (Add (Mul (Mul d4~40@ c4~38@) (Sub b4~36@ a4~34@)) (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ a4~34@))) (Mul (Add (Mul d4~40@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul (Mul c4~38@ c4~38@) d4~40@) d4~40@)))) (and (=> (= tmp%9@ (Mul c4~38@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ d4~40@ d4~40@) (=> %%location_label%%4 (= temp_4_0~1051@ temp_4_1~1116@)))) (=> (= temp_4_0~1051@ temp_4_1~1116@) (=> (= temp_5_0~1227@ (Mul (Mul (Mul (Mul a5~42@ 60) (Sub a5~42@ a5~42@)) (Add (Mul d5~48@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Sub (Mul a5~42@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ b5~44@) (Add a5~42@ d5~48@))))) (=> (= temp_5_1~1304@ (Mul (Mul (Mul (Mul a5~42@ 60) (Sub a5~42@ a5~42@)) (Add (Mul c5~46@ d5~48@) (Mul b5~44@ c5~46@))) (Mul (Sub (Mul a5~42@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ b5~44@) (Add a5~42@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1227@ temp_5_1~1304@))) (=> (= temp_5_0~1227@ temp_5_1~1304@) (=> (= temp_6_0~1393@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul d6~56@ a6~50@) d6~56@)) (Add (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1454@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ d6~56@) d6~56@)) (Add (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1393@ temp_6_1~1454@))) (=> (= temp_6_0~1393@ temp_6_1~1454@) (=> (= temp_7_0~1547@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ d7~64@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Add a7~58@ a7~58@))))) (=> (= temp_7_1~1612@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ d7~64@)) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Add a7~58@ a7~58@))))) (and (=> (= tmp%10@ (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@))) (=> (= tmp%11@ (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%7 (= temp_7_0~1547@ temp_7_1~1612@))))) (=> (= temp_7_0~1547@ temp_7_1~1612@) (=> (= temp_8_0~1725@ (Mul (Mul (Mul c8~70@ (Add c8~70@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Sub c8~70@ d8~72@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~1786@ (Mul (Mul (Mul c8~70@ (Add c8~70@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Sub c8~70@ d8~72@) (Mul c8~70@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1725@ temp_8_1~1786@))) (=> (= temp_8_0~1725@ temp_8_1~1786@) (=> (= temp_9_0~1879@ (Mul (Mul (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ a9~74@)) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ b9~76@))) (Mul (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ c9~78@)) (Sub (Mul b9~76@ d9~80@) (Add a9~74@ d9~80@))))) (=> (= temp_9_1~1944@ (Mul (Mul (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ a9~74@)) (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ b9~76@))) (Mul (Mul (Mul b9~76@ d9~80@) (Mul c9~78@ a9~74@)) (Sub (Mul b9~76@ d9~80@) (Add a9~74@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a9~74@ c9~78@) (=> %%location_label%%9 (= temp_9_0~1879@ temp_9_1~1944@))) (=> (= temp_9_0~1879@ temp_9_1~1944@) (=> (= temp_10_0~2037@ (Mul (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Sub c10~86@ a10~82@) (Sub c10~86@ d10~88@))) (Add (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ c10~86@)) (Mul (Mul a10~82@ a10~82@) (Sub b10~84@ d10~88@))))) (=> (= temp_10_1~2102@ (Mul (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Sub c10~86@ a10~82@) (Sub c10~86@ d10~88@))) (Add (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ c10~86@)) (Mul (Mul a10~82@ a10~82@) (Sub b10~84@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ c10~86@) (=> %%location_label%%10 (= temp_10_0~2037@ temp_10_1~2102@))) (=> (= temp_10_0~2037@ temp_10_1~2102@) (=> (= temp_11_0~2167@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Sub c11~94@ a11~90@)) (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@))) a11~90@)) (=> (= temp_11_1~2204@ (Mul a11~90@ (Mul (Mul (Mul a11~90@ a11~90@) (Sub c11~94@ a11~90@)) (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@))))) (and (=> (= tmp%12@ (Mul (Mul (Mul a11~90@ a11~90@) (Sub c11~94@ a11~90@)) (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2167@ temp_11_1~2204@)))) (=> (= temp_11_0~2167@ temp_11_1~2204@) (=> (= temp_12_0~2321@ (Mul (Add (Mul (Sub d12~104@ b12~100@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ d12~104@))) (Add (Mul (Mul a12~98@ c12~102@) a12~98@) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@))))) (=> (= temp_12_1~2410@ (Add (Mul (Mul (Sub d12~104@ b12~100@) (Mul d12~104@ a12~98@)) (Add (Mul (Mul a12~98@ c12~102@) a12~98@) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)))) (Mul (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ d12~104@)) (Add (Mul (Mul a12~98@ c12~102@) a12~98@) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)))))) (and (=> (= tmp%13@ (Mul (Sub d12~104@ b12~100@) (Mul d12~104@ a12~98@))) (=> (= tmp%14@ (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ d12~104@))) (=> (= tmp%15@ (Add (Mul (Mul a12~98@ c12~102@) a12~98@) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%12 (= temp_12_0~2321@ temp_12_1~2410@)))))) (=> (= temp_12_0~2321@ temp_12_1~2410@) (=> (= temp_13_0~2553@ (Add (Add (Sub (Mul d13~112@ a13~106@) (Mul a13~106@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Sub a13~106@ c13~110@))) (Sub (Mul (Mul b13~108@ c13~110@) (Sub a13~106@ c13~110@)) (Mul (Mul c13~110@ a13~106@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2618@ (Add (Add (Sub (Mul d13~112@ a13~106@) (Mul a13~106@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Sub a13~106@ c13~110@))) (Sub (Mul (Mul b13~108@ c13~110@) (Sub a13~106@ c13~110@)) (Mul c13~110@ (Mul a13~106@ (Mul d13~112@ a13~106@)))))) (and (=> (= tmp%16@ (Mul d13~112@ a13~106@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c13~110@ a13~106@ tmp%16@) (=> %%location_label%%13 (= temp_13_0~2553@ temp_13_1~2618@)))) (=> (= temp_13_0~2553@ temp_13_1~2618@) (=> (= temp_14_0~2729@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ d14~120@))) (Mul (Mul (Mul d14~120@ a14~114@) (Mul c14~118@ d14~120@)) (Sub (Mul d14~120@ b14~116@) (Mul a14~114@ 73))))) (=> (= temp_14_1~2806@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ d14~120@))) (Mul (Mul d14~120@ a14~114@) (Mul (Mul c14~118@ d14~120@) (Sub (Mul d14~120@ b14~116@) (Mul a14~114@ 73)))))) (and (=> (= tmp%17@ (Mul d14~120@ a14~114@)) (=> (= tmp%18@ (Mul c14~118@ d14~120@)) (=> (= tmp%19@ (Sub (Mul d14~120@ b14~116@) (Mul a14~114@ 73))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%14 (= temp_14_0~2729@ temp_14_1~2806@)))))) (=> (= temp_14_0~2729@ temp_14_1~2806@) (=> (= temp_15_0~2933@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ a15~122@)) (Mul (Mul c15~126@ a15~122@) (Add c15~126@ b15~124@))) (Mul (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2998@ (Mul (Mul (Mul d15~128@ b15~124@) (Mul (Mul b15~124@ a15~122@) (Mul (Mul c15~126@ a15~122@) (Add c15~126@ b15~124@)))) (Mul (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ c15~126@)) (Mul (Mul d15~128@ a15~122@) (Mul d15~128@ d15~128@))))) (=> (= tmp%20@ (Mul d15~128@ b15~124@)) (=> (= tmp%21@ (Mul b15~124@ a15~122@)) (=> (= tmp%22@ (Mul (Mul c15~126@ a15~122@) (Add c15~126@ b15~124@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%15 (= temp_15_0~2933@ temp_15_1~2998@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
