...
;; mariposa_data/v_nl//16221891383611739967/nlqi_verus/src/main.rs:7:1: 36:40 (#0)
(push)
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ 1) (Mul a0~2@ d0~8@)) b0~4@) (Mul (Mul (Mul
          c0~6@ a0~2@
         ) (Mul c0~6@ b0~4@)
        ) (Sub (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@))
     )))
     (=>
      (= temp_0_1~370@ (Mul (Mul (Mul d0~8@ 1) (Mul (Mul a0~2@ d0~8@) b0~4@)) (Mul (Mul (Mul
           c0~6@ a0~2@
          ) (Mul c0~6@ b0~4@)
         ) (Sub (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@))
      )))
      (and
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~459@ (Mul (Mul (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ a1~10@)) (Add (Mul b1~12@
              a1~10@
             ) (Mul d1~16@ a1~10@)
            )
           ) (Sub (Mul (Sub a1~10@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@
              d1~16@
         )))))
         (=>
          (= temp_1_1~524@ (Mul (Mul (Mul c1~14@ c1~14@) (Mul (Mul c1~14@ a1~10@) (Add (Mul b1~12@
                a1~10@
               ) (Mul d1~16@ a1~10@)
             ))
            ) (Sub (Mul (Sub a1~10@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@
          ...
          (and
           ...
           (=>
            (= temp_1_0~459@ temp_1_1~524@)
            (=>
             (= temp_2_0~621@ (Mul (Add (Mul (Sub b2~20@ c2~22@) (Mul d2~24@ 26)) (Mul (Mul c2~22@
                  b2~20@
                 ) (Mul b2~20@ b2~20@)
                )
               ) (Mul (Mul (Mul c2~22@ b2~20@) d2~24@) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@)))
             ))
             (=>
              (= temp_2_1~714@ (Mul (Add (Sub (Mul b2~20@ (Mul d2~24@ 26)) (Mul c2~22@ (Mul d2~24@ 26)))
                 (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ b2~20@))
                ) (Mul (Mul (Mul c2~22@ b2~20@) d2~24@) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@)))
              ))
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~621@ temp_2_1~714@)
               ))
               (=>
                (= temp_2_0~621@ temp_2_1~714@)
                (=>
                 (= temp_3_0~799@ (Mul (Mul (Mul (Add b3~28@ b3~28@) (Add c3~30@ b3~28@)) (Mul (Mul a3~26@
                      b3~28@
                     ) (Mul a3~26@ c3~30@)
                    )
                   ) (Mul (Mul (Sub c3~30@ b3~28@) b3~28@) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)))
                 ))
                 (=>
                  (= temp_3_1~860@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@)) (Mul (Add b3~28@
                       b3~28@
                      ) (Add c3~30@ b3~28@)
                     )
                    ) (Mul (Mul (Sub c3~30@ b3~28@) b3~28@) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)))
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~799@ temp_3_1~860@)
                    (=>
                     (= temp_4_0~949@ (Mul (Add (Mul (Mul d4~40@ c4~38@) (Sub b4~36@ a4~34@)) (Mul (Mul c4~38@
                          a4~34@
                         ) (Mul c4~38@ a4~34@)
                        )
                       ) (Mul (Add (Mul d4~40@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@
                          d4~40@
                     )))))
                     (=>
                      (= temp_4_1~1014@ (Mul (Add (Mul (Mul d4~40@ c4~38@) (Sub b4~36@ a4~34@)) (Mul (Mul c4~38@
                           a4~34@
                          ) (Mul c4~38@ a4~34@)
                         )
                        ) (Mul (Add (Mul d4~40@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul (Mul c4~38@ c4~38@) d4~40@)
                          d4~40@
                      ))))
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~949@ temp_4_1~1014@)
                       ))
                       (=>
                        (= temp_4_0~949@ temp_4_1~1014@)
                        (=>
                         (= temp_5_0~1115@ (Mul (Mul (Mul (Mul a5~42@ 60) (Sub a5~42@ a5~42@)) (Add (Mul d5~48@
                              c5~46@
                             ) (Mul b5~44@ c5~46@)
                            )
                           ) (Mul (Sub (Mul a5~42@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ b5~44@) (Add a5~42@
                              d5~48@
                         )))))
                         (=>
                          (= temp_5_1~1192@ (Mul (Mul (Mul (Mul a5~42@ 60) (Sub a5~42@ a5~42@)) (Add (Mul c5~46@
                               d5~48@
                              ) (Mul b5~44@ c5~46@)
                             )
                            ) (Mul (Sub (Mul a5~42@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ b5~44@) (Add a5~42@
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1115@ temp_5_1~1192@)
                           ))
                           (=>
                            (= temp_5_0~1115@ temp_5_1~1192@)
                            (=>
                             (= temp_6_0~1277@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul d6~56@
                                  a6~50@
                                 ) d6~56@
                                )
                               ) (Add (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@
                                  b6~52@
                             )))))
                             (=>
                              (= temp_6_1~1338@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@
                                   d6~56@
                                  ) d6~56@
                                 )
                                ) (Add (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Mul d6~56@
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1277@ temp_6_1~1338@)
                               ))
                               (=>
                                (= temp_6_0~1277@ temp_6_1~1338@)
                                (=>
                                 (= temp_7_0~1427@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@
                                      c7~62@
                                     ) (Mul a7~58@ d7~64@)
                                    )
                                   ) (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Add a7~58@
                                      a7~58@
                                 )))))
                                 (=>
                                  (= temp_7_1~1492@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ d7~64@)) (Mul (Mul b7~60@
                                       c7~62@
                                      ) (Mul d7~64@ d7~64@)
                                     )
                                    ) (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Add a7~58@
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1427@ temp_7_1~1492@)
                                   ))
                                   (=>
                                    (= temp_7_0~1427@ temp_7_1~1492@)
                                    (=>
                                     (= temp_8_0~1577@ (Mul (Mul (Mul c8~70@ (Add c8~70@ b8~68@)) (Mul (Mul c8~70@ d8~72@)
                                         (Mul d8~72@ b8~68@)
                                        )
                                       ) (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Sub c8~70@ d8~72@) (Mul c8~70@
                                          c8~70@
                                     )))))
                                     (=>
                                      (= temp_8_1~1638@ (Mul (Mul (Mul c8~70@ (Add c8~70@ b8~68@)) (Mul (Mul d8~72@ c8~70@)
                                          (Mul d8~72@ b8~68@)
                                         )
                                        ) (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Sub c8~70@ d8~72@) (Mul c8~70@
                                           c8~70@
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1577@ temp_8_1~1638@)
                                       ))
                                       (=>
                                        (= temp_8_0~1577@ temp_8_1~1638@)
                                        (=>
                                         (= temp_9_0~1727@ (Mul (Mul (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ a9~74@)) (Mul (Mul c9~78@
                                              a9~74@
                                             ) (Mul b9~76@ b9~76@)
                                            )
                                           ) (Mul (Mul (Mul b9~76@ d9~80@) (Mul a9~74@ c9~78@)) (Sub (Mul b9~76@ d9~80@) (Add a9~74@
                                              d9~80@
                                         )))))
                                         (=>
                                          (= temp_9_1~1792@ (Mul (Mul (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ a9~74@)) (Mul (Mul c9~78@
                                               a9~74@
                                              ) (Mul b9~76@ b9~76@)
                                             )
                                            ) (Mul (Mul (Mul b9~76@ d9~80@) (Mul c9~78@ a9~74@)) (Sub (Mul b9~76@ d9~80@) (Add a9~74@
                                               d9~80@
                                          )))))
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1727@ temp_9_1~1792@)
                                           ))
                                           (=>
                                            (= temp_9_0~1727@ temp_9_1~1792@)
                                            (=>
                                             (= temp_10_0~1881@ (Mul (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (
                                                  Sub c10~86@ a10~82@
                                                 ) (Sub c10~86@ d10~88@)
                                                )
                                               ) (Add (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ c10~86@)) (Mul (Mul a10~82@ a10~82@)
                                                 (Sub b10~84@ d10~88@)
                                             ))))
                                             (=>
                                              (= temp_10_1~1946@ (Mul (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (
                                                   Sub c10~86@ a10~82@
                                                  ) (Sub c10~86@ d10~88@)
                                                 )
                                                ) (Add (Mul (Mul b10~84@ b10~84@) (Mul c10~86@ c10~86@)) (Mul (Mul a10~82@ a10~82@)
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1881@ temp_10_1~1946@)
                                               ))
                                               (=>
                                                (= temp_10_0~1881@ temp_10_1~1946@)
                                                (=>
                                                 (= temp_11_0~2007@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Sub c11~94@ a11~90@)) (Mul (
                                                      Mul a11~90@ b11~92@
                                                     ) (Mul c11~94@ d11~96@)
                                                    )
                                                   ) a11~90@
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2044@ (Mul a11~90@ (Mul (Mul (Mul a11~90@ a11~90@) (Sub c11~94@ a11~90@))
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~2007@ temp_11_1~2044@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~2007@ temp_11_1~2044@)
                                                    (=>
                                                     (= temp_12_0~2129@ (Mul (Add (Mul (Sub d12~104@ b12~100@) (Mul d12~104@ a12~98@)) (Mul
                                                         (Mul d12~104@ a12~98@) (Mul b12~100@ d12~104@)
                                                        )
                                                       ) (Add (Mul (Mul a12~98@ c12~102@) a12~98@) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@
                                                          d12~104@
                                                     )))))
                                                     (=>
                                                      (= temp_12_1~2218@ (Add (Mul (Mul (Sub d12~104@ b12~100@) (Mul d12~104@ a12~98@)) (Add
                                                          (Mul (Mul a12~98@ c12~102@) a12~98@) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@))
                                                         )
                                                        ) (Mul (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ d12~104@)) (Add (Mul (Mul a12~98@ c12~102@)
                                                           a12~98@
                                                          ) (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@))
                                                      ))))
                                                      (and
                                                       (=>
                                                        (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2129@ temp_12_1~2218@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2129@ temp_12_1~2218@)
                                                        (=>
                                                         (= temp_13_0~2307@ (Add (Add (Sub (Mul d13~112@ a13~106@) (Mul a13~106@ a13~106@)) (
                                                             Mul (Mul b13~108@ b13~108@) (Sub a13~106@ c13~110@)
                                                            )
                                                           ) (Sub (Mul (Mul b13~108@ c13~110@) (Sub a13~106@ c13~110@)) (Mul (Mul c13~110@ a13~106@)
                                                             (Mul d13~112@ a13~106@)
                                                         ))))
                                                         (=>
                                                          (= temp_13_1~2372@ (Add (Add (Sub (Mul d13~112@ a13~106@) (Mul a13~106@ a13~106@)) (
                                                              Mul (Mul b13~108@ b13~108@) (Sub a13~106@ c13~110@)
                                                             )
                                                            ) (Sub (Mul (Mul b13~108@ c13~110@) (Sub a13~106@ c13~110@)) (Mul c13~110@ (Mul a13~106@
                                                               (Mul d13~112@ a13~106@)
                                                          )))))
                                                          (and
                                                           (=>
                                                           ...
                                                           (=>
                                                            (= temp_13_0~2307@ temp_13_1~2372@)
                                                            (=>
                                                             (= temp_14_0~2473@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@)) (
                                                                 Mul (Mul d14~120@ b14~116@) (Mul b14~116@ d14~120@)
                                                                )
                                                               ) (Mul (Mul (Mul d14~120@ a14~114@) (Mul c14~118@ d14~120@)) (Sub (Mul d14~120@ b14~116@)
                                                                 (Mul a14~114@ 73)
                                                             ))))
                                                             (=>
                                                              (= temp_14_1~2550@ (Mul (Mul (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@)) (
                                                                  Mul (Mul d14~120@ b14~116@) (Mul b14~116@ d14~120@)
                                                                 )
                                                                ) (Mul (Mul d14~120@ a14~114@) (Mul (Mul c14~118@ d14~120@) (Sub (Mul d14~120@ b14~116@)
                                                                   (Mul a14~114@ 73)
                                                              )))))
                                                              (and
                                                               (=>
                                                               ...
                                                               (=>
                                                                (= temp_14_0~2473@ temp_14_1~2550@)
                                                                (=>
                                                                 (= temp_15_0~2639@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul b15~124@ a15~122@)) (
                                                                     Mul (Mul c15~126@ a15~122@) (Add c15~126@ b15~124@)
                                                                    )
                                                                   ) (Mul (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ c15~126@)) (Mul (Mul d15~128@ a15~122@)
                                                                     (Mul d15~128@ d15~128@)
                                                                 ))))
                                                                 (=>
                                                                  (= temp_15_1~2704@ (Mul (Mul (Mul d15~128@ b15~124@) (Mul (Mul b15~124@ a15~122@) (Mul
                                                                       (Mul c15~126@ a15~122@) (Add c15~126@ b15~124@)
                                                                     ))
                                                                    ) (Mul (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ c15~126@)) (Mul (Mul d15~128@ a15~122@)
                                                                      (Mul d15~128@ d15~128@)
                                                                  ))))
