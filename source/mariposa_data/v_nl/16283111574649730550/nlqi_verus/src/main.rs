...
a19: int, b19: int, c19: int, d19: int)
{
	...
	let temp_10_0 = (((((b10*a10)-(b10*d10))*((d10-d10)+(b10*a10)))*(((b10*d10)*(b10*a10))*((b10*d10)*(a10*d10))))*((((b10-c10)*(b10*a10))*((b10*a10)*d10))*d10));
	let temp_10_1 = (((((b10*a10)-(b10*d10))*((d10-d10)+(b10*a10)))*(((b10*d10)*(b10*a10))*((b10*d10)*(a10*d10))))*((((b10-c10)*(b10*a10))*((a10*b10)*d10))*d10));
	assert(temp_10_0 == temp_10_1);
	let temp_11_0 = (((((a11*a11)+(a11*b11))*((a11*a11)*(d11*d11)))*d11)*a11);
	let temp_11_1 = ((d11*(((a11*a11)+(a11*b11))*((a11*a11)*(d11*d11))))*a11);
	assert(temp_11_0 == temp_11_1);
	let temp_12_0 = (((((b12*a12)*(d12*b12))*((b12*b12)*(c12*a12)))+(((c12*c12)*(b12+c12))*((d12*a12)*b12)))-((((a12*d12)+(b12-c12))*((d12*d12)*(b12*a12)))*(((b12-a12)*b12)+((b12*c12)*(a12*d12)))));
	let temp_12_1 = (((((b12*a12)*(b12*d12))*((b12*b12)*(c12*a12)))+(((c12*c12)*(b12+c12))*((d12*a12)*b12)))-((((a12*d12)+(b12-c12))*((d12*d12)*(b12*a12)))*(((b12-a12)*b12)+((b12*c12)*(a12*d12)))));
	assert(temp_12_0 == temp_12_1);
	let temp_13_0 = (((((b13*a13)*(c13*a13))*((c13*d13)*c13))*d13)*((((a13*a13)*(b13+a13))*((a13*d13)*(d13+b13)))*c13));
	let temp_13_1 = (((((b13*a13)*(c13*a13))*((c13*d13)*c13))*d13)*((((a13*a13)*(b13+a13))*(((a13*d13)*d13)+((a13*d13)*b13)))*c13));
	assert(temp_13_0 == temp_13_1);
	let temp_14_0 = (((((d14-d14)-(d14+b14))*d14)+(((d14+c14)*c14)*((b14*c14)*(b14*d14))))*((((a14*c14)+((46 as int)*d14))*((d14*d14)*(c14*c14)))*(((a14*c14)*(d14*a14))*((c14*a14)*(c14-c14)))));
	let temp_14_1 = (((((d14-d14)-(d14+b14))*d14)+(((d14+c14)*c14)*((b14*c14)*(b14*d14))))*(((((a14*c14)+((46 as int)*d14))*(d14*d14))*(c14*c14))*(((a14*c14)*(d14*a14))*((c14*a14)*(c14-c14)))));
	assert(temp_14_0 == temp_14_1);
	let temp_15_0 = ((((((54 as int)*c15)*(d15*c15))*((a15*a15)*(c15*d15)))+(c15*((b15*c15)*(d15*b15))))+((((a15*c15)+(c15*a15))*((c15+d15)*(a15*d15)))*(((b15-d15)+(a15+c15))+((a15*a15)*(a15*c15)))));
	let temp_15_1 = ((((((54 as int)*c15)*(d15*c15))*((a15*a15)*(c15*d15)))+(((b15*c15)*(d15*b15))*c15))+((((a15*c15)+(c15*a15))*((c15+d15)*(a15*d15)))*(((b15-d15)+(a15+c15))+((a15*a15)*(a15*c15)))));
	assert(temp_15_0 == temp_15_1);
	let temp_16_0 = (((((c16*a16)*(c16*b16))+((d16*a16)-(a16*b16)))*(((c16*a16)*(c16*c16))*((c16*c16)-(b16*c16))))*(((d16*(a16*c16))+((b16*c16)*d16))*(c16+(a16-(a16*d16)))));
	let temp_16_1 = (((((c16*a16)*(c16*b16))+((d16*a16)-(a16*b16)))*(((c16*a16)*(c16*c16))*((c16-b16)*c16)))*(((d16*(a16*c16))+((b16*c16)*d16))*(c16+(a16-(a16*d16)))));
