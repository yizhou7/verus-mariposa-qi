...
(set-info :comment ";; mariposa_data/v_nl//16283111574649730550/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Mul (Mul (Add (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@)) d0~8@) (Mul (Mul (Mul c0~6@ b0~4@) (Sub d0~8@ c0~6@)) (Sub (Mul a0~2@ b0~4@) (Mul d0~8@ a0~2@)))) (Mul (Mul (Mul (Sub d0~8@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Add c0~6@ b0~4@) (Sub a0~2@ b0~4@))) (Mul (Sub (Mul b0~4@ d0~8@) a0~2@) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)))))) (=> (= temp_0_1~386@ (Mul (Mul (Mul (Add (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@)) d0~8@) (Mul (Mul (Mul c0~6@ b0~4@) (Sub d0~8@ c0~6@)) (Sub (Mul a0~2@ b0~4@) (Mul d0~8@ a0~2@)))) (Mul (Mul (Mul (Sub d0~8@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Add c0~6@ b0~4@) (Sub a0~2@ b0~4@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Sub (Mul b0~4@ d0~8@) a0~2@))))) (and (=> (= tmp%1@ (Sub (Mul b0~4@ d0~8@) a0~2@)) (=> (= tmp%2@ (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~386@))))) (=> (= temp_0_0~273@ temp_0_1~386@) (=> (= temp_1_0~563@ (Mul (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Sub (Add d1~16@ b1~12@) (Sub d1~16@ b1~12@)) (Mul (Mul a1~10@ c1~14@) (Add c1~14@ b1~12@)))) (Sub (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Sub c1~14@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ a1~10@)))))) (=> (= temp_1_1~692@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul (Mul a1~10@ d1~16@) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@)))) (Mul (Sub (Add d1~16@ b1~12@) (Sub d1~16@ b1~12@)) (Mul (Mul a1~10@ c1~14@) (Add c1~14@ b1~12@)))) (Sub (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Sub c1~14@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ a1~10@)))))) (and (=> (= tmp%3@ (Mul a1~10@ d1~16@)) (=> (= tmp%4@ (Mul a1~10@ d1~16@)) (=> (= tmp%5@ (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~563@ temp_1_1~692@)))))) (=> (= temp_1_0~563@ temp_1_1~692@) (=> (= temp_2_0~891@ (Mul (Add (Mul (Mul (Mul 59 a2~18@) (Sub b2~20@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))) (Mul (Sub c2~22@ (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)))) (Sub (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Sub a2~18@ b2~20@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul 5 d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ a2~18@)))))) (=> (= temp_2_1~1040@ (Mul (Add (Mul (Mul (Mul 59 a2~18@) (Sub b2~20@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Mul d2~24@ b2~20@))) (Mul (Sub c2~22@ (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)))) (Sub (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Sub a2~18@ b2~20@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul 5 d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ a2~18@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ d2~24@) (=> %%location_label%%2 (= temp_2_0~891@ temp_2_1~1040@))) (=> (= temp_2_0~891@ temp_2_1~1040@) (=> (= temp_3_0~1137@ (Sub b3~28@ (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Add a3~26@ b3~28@))) (Mul (Sub (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ b3~28@)))))) (=> (= temp_3_1~1206@ (Sub b3~28@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Add a3~26@ b3~28@))) (Mul (Sub (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ b3~28@)))))) (and (=> (= tmp%6@ (Mul d3~32@ b3~28@)) (=> (= tmp%7@ (Mul a3~26@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~1137@ temp_3_1~1206@))))) (=> (= temp_3_0~1137@ temp_3_1~1206@) (=> (= temp_4_0~1359@ (Mul (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Sub b4~36@ b4~36@)) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ a4~34@)))) (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ b4~36@)) d4~40@) (Mul (Add (Mul a4~34@ a4~34@) (Mul a4~34@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@)))))) (=> (= temp_4_1~1476@ (Mul (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Sub b4~36@ b4~36@)) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ a4~34@)))) (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ b4~36@)) d4~40@) (Mul (Add (Mul a4~34@ a4~34@) (Mul a4~34@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ a4~34@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1359@ temp_4_1~1476@))) (=> (= temp_4_0~1359@ temp_4_1~1476@) (=> (= temp_5_0~1625@ (Sub (Mul (Mul (Mul (Add d5~48@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Add d5~48@ c5~46@) (Sub c5~46@ d5~48@))) (Mul (Mul (Mul d5~48@ b5~44@) (Add b5~44@ b5~44@)) (Mul a5~42@ (Mul b5~44@ c5~46@)))) (Mul (Sub (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ b5~44@)) (Add (Add c5~46@ b5~44@) (Mul a5~42@ c5~46@))) (Mul (Mul (Sub a5~42@ d5~48@) d5~48@) (Mul (Sub b5~44@ c5~46@) (Mul a5~42@ b5~44@)))))) (=> (= temp_5_1~1754@ (Sub (Mul (Mul (Mul (Add d5~48@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Add d5~48@ c5~46@) (Sub c5~46@ d5~48@))) (Mul (Mul (Mul d5~48@ b5~44@) (Add b5~44@ b5~44@)) (Mul a5~42@ (Mul b5~44@ c5~46@)))) (Mul (Sub (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ b5~44@)) (Add (Add c5~46@ b5~44@) (Mul a5~42@ c5~46@))) (Mul (Mul (Sub a5~42@ d5~48@) d5~48@) (Sub (Mul b5~44@ (Mul a5~42@ b5~44@)) (Mul c5~46@ (Mul a5~42@ b5~44@))))))) (and (=> (= tmp%8@ (Mul a5~42@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b5~44@ c5~46@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~1625@ temp_5_1~1754@)))) (=> (= temp_5_0~1625@ temp_5_1~1754@) (=> (= temp_6_0~1909@ (Sub (Mul (Mul (Mul (Add c6~54@ a6~50@) (Mul b6~52@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@)) (Mul d6~56@ (Mul d6~56@ a6~50@)))) (Mul (Mul (Add (Mul b6~52@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ a6~50@))) (Mul (Mul (Add c6~54@ a6~50@) (Mul b6~52@ d6~56@)) (Sub (Mul c6~54@ a6~50@) c6~54@))))) (=> (= temp_6_1~2030@ (Sub (Mul (Mul (Mul (Add c6~54@ a6~50@) (Mul b6~52@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul d6~56@ b6~52@)) (Mul d6~56@ (Mul d6~56@ a6~50@)))) (Mul (Mul (Add (Mul b6~52@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ a6~50@))) (Mul (Mul (Add c6~54@ a6~50@) (Mul d6~56@ b6~52@)) (Sub (Mul c6~54@ a6~50@) c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b6~52@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1909@ temp_6_1~2030@))) (=> (= temp_6_0~1909@ temp_6_1~2030@) (=> (= temp_7_0~2139@ (Mul (Sub (Mul (Mul c7~62@ (Sub a7~58@ c7~62@)) (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@))) c7~62@) (Add (Sub a7~58@ (Add (Sub d7~64@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ a7~58@)) (Mul (Mul b7~60@ b7~60@) d7~64@))))) (=> (= temp_7_1~2220@ (Mul (Sub (Mul (Mul c7~62@ (Sub a7~58@ c7~62@)) (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ c7~62@))) c7~62@) (Add (Sub a7~58@ (Add (Sub d7~64@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ a7~58@)) (Mul (Mul b7~60@ b7~60@) d7~64@))))) (and (=> (= tmp%9@ (Mul a7~58@ c7~62@)) (=> (= tmp%10@ (Mul c7~62@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~2139@ temp_7_1~2220@))))) (=> (= temp_7_0~2139@ temp_7_1~2220@) (=> (= temp_8_0~2301@ (Add (Mul a8~66@ (Mul (Mul (Mul b8~68@ b8~68@) (Add b8~68@ b8~68@)) (Mul (Sub b8~68@ c8~70@) (Mul d8~72@ d8~72@)))) (Mul c8~70@ a8~66@))) (=> (= temp_8_1~2354@ (Add (Mul a8~66@ (Mul (Add (Mul (Mul b8~68@ b8~68@) b8~68@) (Mul (Mul b8~68@ b8~68@) b8~68@)) (Mul (Sub b8~68@ c8~70@) (Mul d8~72@ d8~72@)))) (Mul c8~70@ a8~66@))) (and (=> (= tmp%11@ (Mul b8~68@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ b8~68@ b8~68@) (=> %%location_label%%8 (= temp_8_0~2301@ temp_8_1~2354@)))) (=> (= temp_8_0~2301@ temp_8_1~2354@) (=> (= temp_9_0~2509@ (Mul (Add (Mul (Add (Mul b9~76@ c9~78@) (Mul b9~76@ c9~78@)) d9~80@) (Mul (Add (Add c9~78@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Sub b9~76@ b9~76@) 49))) (Add (Mul (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ d9~80@))) (Mul (Mul (Sub d9~80@ a9~74@) (Mul a9~74@ c9~78@)) (Mul (Sub c9~78@ a9~74@) c9~78@))))) (=> (= temp_9_1~2634@ (Mul (Add (Add (Mul (Mul b9~76@ c9~78@) d9~80@) (Mul (Mul b9~76@ c9~78@) d9~80@)) (Mul (Add (Add c9~78@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Sub b9~76@ b9~76@) 49))) (Add (Mul (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Mul d9~80@ b9~76@) (Mul d9~80@ d9~80@))) (Mul (Mul (Sub d9~80@ a9~74@) (Mul a9~74@ c9~78@)) (Mul (Sub c9~78@ a9~74@) c9~78@))))) (and (=> (= tmp%12@ (Mul b9~76@ c9~78@)) (=> (= tmp%13@ (Mul b9~76@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%12@ tmp%13@ d9~80@) (=> %%location_label%%9 (= temp_9_0~2509@ temp_9_1~2634@))))) (=> (= temp_9_0~2509@ temp_9_1~2634@) (=> (= temp_10_0~2769@ (Mul (Mul (Mul (Sub (Mul b10~84@ a10~82@) (Mul b10~84@ d10~88@)) (Add (Sub d10~88@ d10~88@) (Mul b10~84@ a10~82@))) (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ a10~82@)) (Mul (Mul b10~84@ d10~88@) (Mul a10~82@ d10~88@)))) (Mul (Mul (Mul (Sub b10~84@ c10~86@) (Mul b10~84@ a10~82@)) (Mul (Mul b10~84@ a10~82@) d10~88@)) d10~88@))) (=> (= temp_10_1~2866@ (Mul (Mul (Mul (Sub (Mul b10~84@ a10~82@) (Mul b10~84@ d10~88@)) (Add (Sub d10~88@ d10~88@) (Mul b10~84@ a10~82@))) (Mul (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ a10~82@)) (Mul (Mul b10~84@ d10~88@) (Mul a10~82@ d10~88@)))) (Mul (Mul (Mul (Sub b10~84@ c10~86@) (Mul b10~84@ a10~82@)) (Mul (Mul a10~82@ b10~84@) d10~88@)) d10~88@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b10~84@ a10~82@) (=> %%location_label%%10 (= temp_10_0~2769@ temp_10_1~2866@))) (=> (= temp_10_0~2769@ temp_10_1~2866@) (=> (= temp_11_0~2935@ (Mul (Mul (Mul (Add (Mul a11~90@ a11~90@) (Mul a11~90@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ d11~96@))) d11~96@) a11~90@)) (=> (= temp_11_1~2976@ (Mul (Mul d11~96@ (Mul (Add (Mul a11~90@ a11~90@) (Mul a11~90@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ d11~96@)))) a11~90@)) (and (=> (= tmp%14@ (Mul (Add (Mul a11~90@ a11~90@) (Mul a11~90@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ d11~96@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2935@ temp_11_1~2976@)))) (=> (= temp_11_0~2935@ temp_11_1~2976@) (=> (= temp_12_0~3153@ (Sub (Add (Mul (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ b12~100@) (Mul c12~102@ a12~98@))) (Mul (Mul (Mul c12~102@ c12~102@) (Add b12~100@ c12~102@)) (Mul (Mul d12~104@ a12~98@) b12~100@))) (Mul (Mul (Add (Mul a12~98@ d12~104@) (Sub b12~100@ c12~102@)) (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ a12~98@))) (Add (Mul (Sub b12~100@ a12~98@) b12~100@) (Mul (Mul b12~100@ c12~102@) (Mul a12~98@ d12~104@)))))) (=> (= temp_12_1~3274@ (Sub (Add (Mul (Mul (Mul b12~100@ a12~98@) (Mul b12~100@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul c12~102@ a12~98@))) (Mul (Mul (Mul c12~102@ c12~102@) (Add b12~100@ c12~102@)) (Mul (Mul d12~104@ a12~98@) b12~100@))) (Mul (Mul (Add (Mul a12~98@ d12~104@) (Sub b12~100@ c12~102@)) (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ a12~98@))) (Add (Mul (Sub b12~100@ a12~98@) b12~100@) (Mul (Mul b12~100@ c12~102@) (Mul a12~98@ d12~104@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d12~104@ b12~100@) (=> %%location_label%%12 (= temp_12_0~3153@ temp_12_1~3274@))) (=> (= temp_12_0~3153@ temp_12_1~3274@) (=> (= temp_13_0~3371@ (Mul (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ a13~106@)) (Mul (Mul c13~110@ d13~112@) c13~110@)) d13~112@) (Mul (Mul (Mul (Mul a13~106@ a13~106@) (Add b13~108@ a13~106@)) (Mul (Mul a13~106@ d13~112@) (Add d13~112@ b13~108@))) c13~110@))) (=> (= temp_13_1~3448@ (Mul (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ a13~106@)) (Mul (Mul c13~110@ d13~112@) c13~110@)) d13~112@) (Mul (Mul (Mul (Mul a13~106@ a13~106@) (Add b13~108@ a13~106@)) (Add (Mul (Mul a13~106@ d13~112@) d13~112@) (Mul (Mul a13~106@ d13~112@) b13~108@))) c13~110@))) (and (=> (= tmp%15@ (Mul a13~106@ d13~112@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%15@ d13~112@ b13~108@) (=> %%location_label%%13 (= temp_13_0~3371@ temp_13_1~3448@)))) (=> (= temp_13_0~3371@ temp_13_1~3448@) (=> (= temp_14_0~3607@ (Mul (Add (Mul (Sub (Sub d14~120@ d14~120@) (Add d14~120@ b14~116@)) d14~120@) (Mul (Mul (Add d14~120@ c14~118@) c14~118@) (Mul (Mul b14~116@ c14~118@) (Mul b14~116@ d14~120@)))) (Mul (Mul (Add (Mul a14~114@ c14~118@) (Mul 46 d14~120@)) (Mul (Mul d14~120@ d14~120@) (Mul c14~118@ c14~118@))) (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ a14~114@) (Sub c14~118@ c14~118@)))))) (=> (= temp_14_1~3732@ (Mul (Add (Mul (Sub (Sub d14~120@ d14~120@) (Add d14~120@ b14~116@)) d14~120@) (Mul (Mul (Add d14~120@ c14~118@) c14~118@) (Mul (Mul b14~116@ c14~118@) (Mul b14~116@ d14~120@)))) (Mul (Mul (Mul (Add (Mul a14~114@ c14~118@) (Mul 46 d14~120@)) (Mul d14~120@ d14~120@)) (Mul c14~118@ c14~118@)) (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ a14~114@) (Sub c14~118@ c14~118@)))))) (and (=> (= tmp%16@ (Add (Mul a14~114@ c14~118@) (Mul 46 d14~120@))) (=> (= tmp%17@ (Mul d14~120@ d14~120@)) (=> (= tmp%18@ (Mul c14~118@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%14 (= temp_14_0~3607@ temp_14_1~3732@)))))) (=> (= temp_14_0~3607@ temp_14_1~3732@) (=> (= temp_15_0~3923@ (Add (Add (Mul (Mul (Mul 54 c15~126@) (Mul d15~128@ c15~126@)) (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ d15~128@))) (Mul c15~126@ (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ b15~124@)))) (Mul (Mul (Add (Mul a15~122@ c15~126@) (Mul c15~126@ a15~122@)) (Mul (Add c15~126@ d15~128@) (Mul a15~122@ d15~128@))) (Add (Add (Sub b15~124@ d15~128@) (Add a15~122@ c15~126@)) (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ c15~126@)))))) (=> (= temp_15_1~4052@ (Add (Add (Mul (Mul (Mul 54 c15~126@) (Mul d15~128@ c15~126@)) (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ d15~128@))) (Mul (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ b15~124@)) c15~126@)) (Mul (Mul (Add (Mul a15~122@ c15~126@) (Mul c15~126@ a15~122@)) (Mul (Add c15~126@ d15~128@) (Mul a15~122@ d15~128@))) (Add (Add (Sub b15~124@ d15~128@) (Add a15~122@ c15~126@)) (Mul (Mul a15~122@ a15~122@) (Mul a15~122@ c15~126@)))))) (and (=> (= tmp%19@ (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ b15~124@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c15~126@ tmp%19@) (=> %%location_label%%15 (= temp_15_0~3923@ temp_15_1~4052@)))) (=> (= temp_15_0~3923@ temp_15_1~4052@) (=> (= temp_16_0~4197@ (Mul (Mul (Add (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ b16~132@)) (Sub (Mul d16~136@ a16~130@) (Mul a16~130@ b16~132@))) (Mul (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ c16~134@)) (Sub (Mul c16~134@ c16~134@) (Mul b16~132@ c16~134@)))) (Mul (Add (Mul d16~136@ (Mul a16~130@ c16~134@)) (Mul (Mul b16~132@ c16~134@) d16~136@)) (Add c16~134@ (Sub a16~130@ (Mul a16~130@ d16~136@)))))) (=> (= temp_16_1~4298@ (Mul (Mul (Add (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ b16~132@)) (Sub (Mul d16~136@ a16~130@) (Mul a16~130@ b16~132@))) (Mul (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ c16~134@)) (Mul (Sub c16~134@ b16~132@) c16~134@))) (Mul (Add (Mul d16~136@ (Mul a16~130@ c16~134@)) (Mul (Mul b16~132@ c16~134@) d16~136@)) (Add c16~134@ (Sub a16~130@ (Mul a16~130@ d16~136@)))))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c16~134@ b16~132@ c16~134@) (=> %%location_label%%16 (= temp_16_0~4197@ temp_16_1~4298@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
