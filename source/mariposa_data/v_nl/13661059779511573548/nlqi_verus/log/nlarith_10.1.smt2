...
(declare-const temp_5_0~1626@ Int)
(declare-const temp_5_1~1755@ Int)
(declare-const temp_6_0~1891@ Int)
(declare-const temp_6_1~2012@ Int)
(declare-const temp_7_0~2176@ Int)
(declare-const temp_7_1~2325@ Int)
(declare-const temp_8_0~2477@ Int)
(declare-const temp_8_1~2614@ Int)
(declare-const temp_9_0~2762@ Int)
(declare-const temp_9_1~2895@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ a0~2@))) (Mul (Mul d0~8@ (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Add b0~4@ a0~2@)))) (Mul (Sub (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@))) (Mul (Mul d0~8@ (Mul a0~2@ b0~4@)) (Mul c0~6@ a0~2@))))) (=> (= temp_0_1~386@ (Mul (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul d0~8@ b0~4@) a0~2@) (Mul (Mul a0~2@ b0~4@) (Add b0~4@ a0~2@)))) (Mul (Sub (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@))) (Mul (Mul d0~8@ (Mul a0~2@ b0~4@)) (Mul c0~6@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~273@ temp_0_1~386@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~498@ (Mul (Mul (Mul (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@)) 4) (Mul (Mul (Add a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@)))) (Mul a1~10@ (Mul (Sub c1~14@ (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@)))))) (=> (= temp_1_1~595@ (Mul (Mul (Mul (Mul (Add a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@)) 4)) (Mul a1~10@ (Mul (Sub c1~14@ (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@)))))) (=> (= tmp%2@ (= temp_1_0~498@ temp_1_1~595@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~739@ (Mul (Mul (Mul (Mul (Sub c2~22@ b2~20@) (Mul d2~24@ 97)) (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Add c2~22@ b2~20@) (Mul a2~18@ d2~24@)))) (Add (Sub (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Add (Mul d2~24@ a2~18@) (Sub d2~24@ d2~24@))) (Mul a2~18@ (Mul (Sub a2~18@ d2~24@) (Sub b2~20@ b2~20@)))))) (=> (= temp_2_1~868@ (Mul (Mul (Mul (Mul (Sub c2~22@ b2~20@) (Mul d2~24@ 97)) (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ c2~22@)) (Mul (Add c2~22@ b2~20@) (Mul a2~18@ d2~24@)))) (Add (Sub (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ a2~18@)) (Add (Mul d2~24@ a2~18@) (Sub d2~24@ d2~24@))) (Mul a2~18@ (Mul (Sub a2~18@ d2~24@) (Sub b2~20@ b2~20@)))))) (=> (= tmp%3@ (= temp_2_0~739@ temp_2_1~868@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1016@ (Sub (Sub (Mul (Mul (Mul b3~28@ c3~30@) c3~30@) (Sub (Mul b3~28@ d3~32@) (Mul a3~26@ c3~30@))) (Mul (Mul (Sub a3~26@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ b3~28@)))) (Mul (Mul (Mul (Mul c3~30@ a3~26@) a3~26@) (Mul (Sub d3~32@ c3~30@) (Mul b3~28@ b3~28@))) (Mul (Sub (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@)) (Add (Mul a3~26@ 88) (Mul c3~30@ c3~30@)))))) (=> (= temp_3_1~1149@ (Sub (Sub (Mul (Mul (Mul b3~28@ c3~30@) c3~30@) (Sub (Mul b3~28@ d3~32@) (Mul a3~26@ c3~30@))) (Mul (Mul (Sub a3~26@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ b3~28@)))) (Mul (Mul (Sub (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@)) (Add (Mul a3~26@ 88) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul c3~30@ a3~26@) a3~26@) (Mul (Sub d3~32@ c3~30@) (Mul b3~28@ b3~28@)))))) (=> (= tmp%4@ (= temp_3_0~1016@ temp_3_1~1149@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1313@ (Mul (Sub (Sub (Mul (Mul d4~40@ 23) (Add b4~36@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ b4~36@))) (Mul (Add (Add d4~40@ 85) d4~40@) (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ b4~36@)))) (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ c4~38@))) (Mul 85 (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ a4~34@)))))) (=> (= temp_4_1~1482@ (Mul (Sub (Sub (Add (Mul (Mul d4~40@ 23) b4~36@) (Mul (Mul d4~40@ 23) c4~38@)) (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ b4~36@))) (Mul (Add (Add d4~40@ 85) d4~40@) (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ b4~36@)))) (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ c4~38@))) (Mul 85 (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ a4~34@)))))) (=> (= tmp%5@ (= temp_4_0~1313@ temp_4_1~1482@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1626@ (Mul (Mul (Add (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@ 12) (Mul a5~42@ c5~46@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul b5~44@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ a5~42@)))) (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ a5~42@)) a5~42@) (Mul (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ c5~46@)))))) (=> (= temp_5_1~1755@ (Mul (Mul (Add (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@ 12) (Mul a5~42@ c5~46@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul b5~44@ c5~46@)) (Mul a5~42@ (Mul b5~44@ (Mul a5~42@ a5~42@))))) (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ a5~42@)) a5~42@) (Mul (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ c5~46@)))))) (=> (= tmp%6@ (= temp_5_0~1626@ temp_5_1~1755@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1891@ (Mul (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Sub d6~56@ c6~54@) (Add a6~50@ 64))) b6~52@) (Sub (Add (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ c6~54@) d6~56@)) (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ 78) (Mul b6~52@ c6~54@)))))) (=> (= temp_6_1~2012@ (Mul (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Sub d6~56@ c6~54@) (Add a6~50@ 64))) b6~52@) (Sub (Add (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ c6~54@) d6~56@)) (Mul (Mul (Mul a6~50@ 78) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@)))))) (=> (= tmp%7@ (= temp_6_0~1891@ temp_6_1~2012@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2176@ (Mul (Mul (Mul (Add (Mul d7~64@ b7~60@) (Mul a7~58@ c7~62@)) (Mul (Add 15 a7~58@) (Mul a7~58@ c7~62@))) (Mul (Mul (Sub b7~60@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Sub d7~64@ b7~60@)))) (Add (Mul (Mul (Add c7~62@ a7~58@) c7~62@) (Mul (Mul c7~62@ b7~60@) (Mul 99 b7~60@))) (Mul (Add (Mul a7~58@ b7~60@) (Sub b7~60@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ c7~62@)))))) (=> (= temp_7_1~2325@ (Mul (Mul (Mul (Mul (Add 15 a7~58@) (Mul a7~58@ c7~62@)) (Add (Mul d7~64@ b7~60@) (Mul a7~58@ c7~62@))) (Mul (Mul (Sub b7~60@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Sub d7~64@ b7~60@)))) (Add (Mul (Mul (Add c7~62@ a7~58@) c7~62@) (Mul (Mul c7~62@ b7~60@) (Mul 99 b7~60@))) (Mul (Add (Mul a7~58@ b7~60@) (Sub b7~60@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ c7~62@)))))) (=> (= tmp%8@ (= temp_7_0~2176@ temp_7_1~2325@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2477@ (Mul (Mul (Mul (Mul (Mul c8~70@ c8~70@) b8~68@) (Mul (Mul 44 a8~66@) (Mul a8~66@ b8~68@))) (Mul (Sub (Mul a8~66@ 8) (Mul b8~68@ d8~72@)) (Add (Mul b8~68@ a8~66@) (Mul d8~72@ d8~72@)))) (Mul (Mul (Sub (Mul a8~66@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ a8~66@))) (Sub (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ a8~66@)) b8~68@)))) (=> (= temp_8_1~2614@ (Mul (Mul (Mul (Mul (Mul c8~70@ c8~70@) b8~68@) (Mul (Mul 44 a8~66@) (Mul a8~66@ b8~68@))) (Mul (Sub (Mul a8~66@ 8) (Mul b8~68@ d8~72@)) (Add (Mul b8~68@ a8~66@) (Mul d8~72@ d8~72@)))) (Mul (Mul (Sub (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ a8~66@))) (Sub (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ a8~66@)) b8~68@)))) (=> (= tmp%9@ (= temp_8_0~2477@ temp_8_1~2614@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2762@ (Mul (Add (Mul (Mul (Add d9~80@ a9~74@) (Mul 48 b9~76@)) (Mul (Sub b9~76@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul c9~78@ a9~74@) (Sub a9~74@ d9~80@)) (Add (Mul a9~74@ b9~76@) (Mul a9~74@ c9~78@)))) (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ c9~78@)) (Mul (Mul a9~74@ b9~76@) (Mul d9~80@ a9~74@))) (Sub (Mul (Mul b9~76@ b9~76@) (Sub a9~74@ b9~76@)) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~2895@ (Mul (Add (Mul (Mul (Add d9~80@ a9~74@) (Mul 48 b9~76@)) (Mul (Sub b9~76@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul c9~78@ a9~74@) (Sub a9~74@ d9~80@)) (Add (Mul a9~74@ b9~76@) (Mul a9~74@ c9~78@)))) (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ c9~78@)) (Mul (Mul (Mul a9~74@ b9~76@) d9~80@) a9~74@)) (Sub (Mul (Mul b9~76@ b9~76@) (Sub a9~74@ b9~76@)) (Mul a9~74@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~2762@ temp_9_1~2895@)) (=> %%location_label%%9 tmp%10@))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
