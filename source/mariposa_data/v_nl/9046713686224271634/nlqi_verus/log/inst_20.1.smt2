...
(set-info :comment ";; mariposa_data/v_nl//9046713686224271634/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_5_1~1360@ Int)
(declare-const temp_6_0~1425@ Int)
(declare-const temp_6_1~1462@ Int)
(declare-const temp_7_0~1583@ Int)
(declare-const temp_7_1~1668@ Int)
(declare-const temp_8_0~1797@ Int)
(declare-const temp_8_1~1862@ Int)
(declare-const temp_9_0~1973@ Int)
(declare-const temp_9_1~2034@ Int)
(declare-const temp_10_0~2177@ Int)
(declare-const temp_10_1~2258@ Int)
(declare-const temp_11_0~2369@ Int)
(declare-const temp_11_1~2430@ Int)
(declare-const temp_12_0~2519@ Int)
(declare-const temp_12_1~2580@ Int)
(declare-const temp_13_0~2693@ Int)
(declare-const temp_13_1~2770@ Int)
(declare-const temp_14_0~2899@ Int)
(declare-const temp_14_1~2964@ Int)
(declare-const temp_15_0~3061@ Int)
(declare-const temp_15_1~3138@ Int)
(declare-const temp_16_0~3241@ Int)
(declare-const temp_16_1~3294@ Int)
(declare-const temp_17_0~3409@ Int)
(declare-const temp_17_1~3474@ Int)
(declare-const temp_18_0~3647@ Int)
(declare-const temp_18_1~3736@ Int)
(declare-const temp_19_0~3825@ Int)
(declare-const temp_19_1~3886@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul d0~8@ (Mul a0~2@ (Sub c0~6@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@))))) (=> (= temp_0_1~338@ (Mul (Mul (Mul d0~8@ a0~2@) (Sub c0~6@ d0~8@)) (Mul (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@))))) (and (=> (= tmp%1@ (Sub c0~6@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d0~8@ a0~2@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~338@)))) (=> (= temp_0_0~289@ temp_0_1~338@) (=> (= temp_1_0~433@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@))) (Sub (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@)) (Add a1~10@ (Sub b1~12@ a1~10@))))) (=> (= temp_1_1~494@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@))) (Sub (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@)) (Add a1~10@ (Sub b1~12@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ d1~16@) (=> %%location_label%%1 (= temp_1_0~433@ temp_1_1~494@))) (=> (= temp_1_0~433@ temp_1_1~494@) (=> (= temp_2_0~607@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul 47 b2~20@)) (Mul (Mul c2~22@ c2~22@) 40)) (Add (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~744@ (Add (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul 47 b2~20@)) (Mul (Mul c2~22@ c2~22@) 40)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul 47 b2~20@)) (Mul (Mul c2~22@ c2~22@) 40)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@))))) (and (=> (= tmp%2@ (Mul (Mul (Mul a2~18@ b2~20@) (Mul 47 b2~20@)) (Mul (Mul c2~22@ c2~22@) 40))) (=> (= tmp%3@ (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (=> (= tmp%4@ (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%2@ tmp%3@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~607@ temp_2_1~744@)))))) (=> (= temp_2_0~607@ temp_2_1~744@) (=> (= temp_3_0~911@ (Mul (Mul (Mul (Sub b3~28@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Sub a3~26@ a3~26@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~976@ (Mul (Mul (Mul (Mul (Sub b3~28@ c3~30@) b3~28@) d3~32@) (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Sub a3~26@ a3~26@) (Mul a3~26@ d3~32@))))) (and (=> (= tmp%5@ (Sub b3~28@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ b3~28@ d3~32@) (=> %%location_label%%3 (= temp_3_0~911@ temp_3_1~976@)))) (=> (= temp_3_0~911@ temp_3_1~976@) (=> (= temp_4_0~1091@ (Mul (Mul (Mul d4~40@ (Add 40 a4~34@)) (Sub (Mul 62 c4~38@) (Mul b4~36@ c4~38@))) (Mul (Mul (Add d4~40@ a4~34@) c4~38@) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~1176@ (Mul (Mul (Mul d4~40@ (Add 40 a4~34@)) (Sub (Mul 62 c4~38@) (Mul b4~36@ c4~38@))) (Mul (Add (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d4~40@ a4~34@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1091@ temp_4_1~1176@))) (=> (= temp_4_0~1091@ temp_4_1~1176@) (=> (= temp_5_0~1283@ (Mul (Mul (Sub (Mul d5~48@ d5~48@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ b5~44@))) (Sub (Sub (Sub 50 a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1360@ (Mul (Mul (Sub (Mul d5~48@ d5~48@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ b5~44@))) (Sub (Sub (Sub 50 a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ d5~48@) (=> %%location_label%%5 (= temp_5_0~1283@ temp_5_1~1360@))) (=> (= temp_5_0~1283@ temp_5_1~1360@) (=> (= temp_6_0~1425@ (Add (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Sub c6~54@ b6~52@) (Mul c6~54@ c6~54@))) c6~54@)) (=> (= temp_6_1~1462@ (Add (Mul (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ b6~52@)) (Mul (Sub c6~54@ b6~52@) (Mul c6~54@ c6~54@))) c6~54@)) (and (=> (= tmp%6@ (Mul c6~54@ b6~52@)) (=> (= tmp%7@ (Mul b6~52@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%6 (= temp_6_0~1425@ temp_6_1~1462@))))) (=> (= temp_6_0~1425@ temp_6_1~1462@) (=> (= temp_7_0~1583@ (Mul (Sub (Mul (Mul c7~62@ d7~64@) c7~62@) (Mul (Mul 15 b7~60@) (Mul b7~60@ d7~64@))) (Mul (Mul (Add c7~62@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Mul 29 b7~60@))))) (=> (= temp_7_1~1668@ (Mul (Sub (Mul (Mul c7~62@ d7~64@) c7~62@) (Mul (Mul 15 b7~60@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul 29 b7~60@)) (Mul (Add c7~62@ d7~64@) (Mul c7~62@ b7~60@))))) (and (=> (= tmp%8@ (Mul (Add c7~62@ d7~64@) (Mul c7~62@ b7~60@))) (=> (= tmp%9@ (Mul (Mul b7~60@ c7~62@) (Mul 29 b7~60@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%7 (= temp_7_0~1583@ temp_7_1~1668@))))) (=> (= temp_7_0~1583@ temp_7_1~1668@) (=> (= temp_8_0~1797@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ a8~66@)) (Add (Mul b8~68@ d8~72@) (Add d8~72@ b8~68@))) (Mul (Mul (Mul d8~72@ c8~70@) (Add b8~68@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1862@ (Mul (Mul (Mul d8~72@ c8~70@) (Mul (Mul d8~72@ a8~66@) (Add (Mul b8~68@ d8~72@) (Add d8~72@ b8~68@)))) (Mul (Mul (Mul d8~72@ c8~70@) (Add b8~68@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@))))) (and (=> (= tmp%10@ (Mul d8~72@ c8~70@)) (=> (= tmp%11@ (Mul d8~72@ a8~66@)) (=> (= tmp%12@ (Add (Mul b8~68@ d8~72@) (Add d8~72@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%8 (= temp_8_0~1797@ temp_8_1~1862@)))))) (=> (= temp_8_0~1797@ temp_8_1~1862@) (=> (= temp_9_0~1973@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Add (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@))) (Mul (Add a9~74@ (Mul c9~78@ a9~74@)) (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~2034@ (Mul (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Add (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@))) (Add a9~74@ (Mul c9~78@ a9~74@))) (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ c9~78@)))) (and (=> (= tmp%13@ (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Add (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@)))) (=> (= tmp%14@ (Add a9~74@ (Mul c9~78@ a9~74@))) (=> (= tmp%15@ (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ c9~78@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%9 (= temp_9_0~1973@ temp_9_1~2034@)))))) (=> (= temp_9_0~1973@ temp_9_1~2034@) (=> (= temp_10_0~2177@ (Mul (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)) (Add (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~2258@ (Mul (Add (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)) (Mul c10~86@ a10~82@)) (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ c10~86@))))) (and (=> (= tmp%16@ (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@))) (=> (= tmp%17@ (Mul c10~86@ a10~82@)) (=> (= tmp%18@ (Mul a10~82@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%10 (= temp_10_0~2177@ temp_10_1~2258@)))))) (=> (= temp_10_0~2177@ temp_10_1~2258@) (=> (= temp_11_0~2369@ (Mul (Add (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ a11~90@)) (Sub (Mul b11~92@ b11~92@) (Mul a11~90@ a11~90@))) (Mul (Mul b11~92@ (Mul b11~92@ b11~92@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2430@ (Mul (Add (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ a11~90@)) (Sub (Mul b11~92@ b11~92@) (Mul a11~90@ a11~90@))) (Mul (Mul b11~92@ (Mul b11~92@ b11~92@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b11~92@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2369@ temp_11_1~2430@))) (=> (= temp_11_0~2369@ temp_11_1~2430@) (=> (= temp_12_0~2519@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Add d12~104@ c12~102@)) (Mul (Sub c12~102@ a12~98@) c12~102@)) (Mul (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2580@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Add d12~104@ c12~102@)) (Mul (Sub c12~102@ a12~98@) c12~102@)) (Mul (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul d12~104@ c12~102@))))) (and (=> (= tmp%19@ (Mul d12~104@ c12~102@)) (=> (= tmp%20@ (Mul d12~104@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%12 (= temp_12_0~2519@ temp_12_1~2580@))))) (=> (= temp_12_0~2519@ temp_12_1~2580@) (=> (= temp_13_0~2693@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul 84 a13~106@)) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2770@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ d13~112@)) (Mul (Mul b13~108@ b13~108@) (Mul 84 a13~106@))))) (and (=> (= tmp%21@ (Mul (Mul b13~108@ b13~108@) (Mul 84 a13~106@))) (=> (= tmp%22@ (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ d13~112@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%13 (= temp_13_0~2693@ temp_13_1~2770@))))) (=> (= temp_13_0~2693@ temp_13_1~2770@) (=> (= temp_14_0~2899@ (Sub (Sub (Mul (Mul d14~120@ a14~114@) (Mul d14~120@ c14~118@)) (Mul (Mul b14~116@ d14~120@) (Sub d14~120@ a14~114@))) (Mul (Mul (Mul c14~118@ c14~118@) (Add c14~118@ c14~118@)) (Add (Mul b14~116@ c14~118@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2964@ (Sub (Sub (Mul (Mul d14~120@ a14~114@) (Mul d14~120@ c14~118@)) (Mul (Sub d14~120@ a14~114@) (Mul b14~116@ d14~120@))) (Mul (Mul (Mul c14~118@ c14~118@) (Add c14~118@ c14~118@)) (Add (Mul b14~116@ c14~118@) (Mul b14~116@ b14~116@))))) (and (=> (= tmp%23@ (Mul b14~116@ d14~120@)) (=> (= tmp%24@ (Sub d14~120@ a14~114@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> %%location_label%%14 (= temp_14_0~2899@ temp_14_1~2964@))))) (=> (= temp_14_0~2899@ temp_14_1~2964@) (=> (= temp_15_0~3061@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) d15~128@) (Mul (Mul d15~128@ b15~124@) (Mul a15~122@ b15~124@))) (Mul (Mul (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@)) (Sub (Mul a15~122@ c15~126@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~3138@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) d15~128@) (Mul (Mul d15~128@ b15~124@) (Mul a15~122@ b15~124@))) (Sub (Mul (Mul (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@)) (Mul a15~122@ c15~126@)) (Mul (Mul (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@)) (Mul c15~126@ c15~126@))))) (and (=> (= tmp%25@ (Mul (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@))) (=> (= tmp%26@ (Mul a15~122@ c15~126@)) (=> (= tmp%27@ (Mul c15~126@ c15~126@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%15 (= temp_15_0~3061@ temp_15_1~3138@)))))) (=> (= temp_15_0~3061@ temp_15_1~3138@) (=> (= temp_16_0~3241@ (Mul (Mul (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ b16~132@)) (Add (Add b16~132@ c16~134@) (Mul d16~136@ a16~130@))) (Add b16~132@ (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ c16~134@))))) (=> (= temp_16_1~3294@ (Mul (Mul (Mul c16~134@ b16~132@) (Mul (Mul c16~134@ b16~132@) (Add (Add b16~132@ c16~134@) (Mul d16~136@ a16~130@)))) (Add b16~132@ (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ c16~134@))))) (and (=> (= tmp%28@ (Mul c16~134@ b16~132@)) (=> (= tmp%29@ (Mul c16~134@ b16~132@)) (=> (= tmp%30@ (Add (Add b16~132@ c16~134@) (Mul d16~136@ a16~130@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%28@ tmp%29@ tmp%30@) (=> %%location_label%%16 (= temp_16_0~3241@ temp_16_1~3294@)))))) (=> (= temp_16_0~3241@ temp_16_1~3294@) (=> (= temp_17_0~3409@ (Mul (Mul (Mul (Mul a17~138@ d17~144@) (Sub d17~144@ a17~138@)) (Mul (Add a17~138@ c17~142@) (Add b17~140@ c17~142@))) (Mul (Mul (Mul c17~142@ d17~144@) (Mul d17~144@ b17~140@)) (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ c17~142@))))) (=> (= temp_17_1~3474@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Mul d17~144@ b17~140@)) (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul a17~138@ d17~144@) (Sub d17~144@ a17~138@)) (Mul (Add a17~138@ c17~142@) (Add b17~140@ c17~142@))))) (and (=> (= tmp%31@ (Mul (Mul (Mul a17~138@ d17~144@) (Sub d17~144@ a17~138@)) (Mul (Add a17~138@ c17~142@) (Add b17~140@ c17~142@)))) (=> (= tmp%32@ (Mul (Mul (Mul c17~142@ d17~144@) (Mul d17~144@ b17~140@)) (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ c17~142@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%31@ tmp%32@) (=> %%location_label%%17 (= temp_17_0~3409@ temp_17_1~3474@))))) (=> (= temp_17_0~3409@ temp_17_1~3474@) (=> (= temp_18_0~3647@ (Add (Mul (Mul (Mul d18~152@ a18~146@) (Mul c18~150@ a18~146@)) (Mul (Mul d18~152@ 24) (Mul b18~148@ b18~148@))) (Mul (Add (Mul d18~152@ a18~146@) (Mul c18~150@ a18~146@)) (Mul (Mul c18~150@ c18~150@) (Mul 84 d18~152@))))) (=> (= temp_18_1~3736@ (Add (Mul (Mul (Mul d18~152@ a18~146@) (Mul a18~146@ c18~150@)) (Mul (Mul d18~152@ 24) (Mul b18~148@ b18~148@))) (Mul (Add (Mul d18~152@ a18~146@) (Mul c18~150@ a18~146@)) (Mul (Mul c18~150@ c18~150@) (Mul 84 d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c18~150@ a18~146@) (=> %%location_label%%18 (= temp_18_0~3647@ temp_18_1~3736@))) (=> (= temp_18_0~3647@ temp_18_1~3736@) (=> (= temp_19_0~3825@ (Sub (Mul (Mul (Mul a19~154@ a19~154@) (Mul c19~158@ a19~154@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ b19~156@))) (Mul (Add c19~158@ (Mul d19~160@ d19~160@)) (Mul (Mul a19~154@ a19~154@) (Mul b19~156@ d19~160@))))) (=> (= temp_19_1~3886@ (Sub (Mul (Mul (Mul a19~154@ a19~154@) (Mul c19~158@ a19~154@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ b19~156@))) (Mul (Add c19~158@ (Mul d19~160@ d19~160@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ a19~154@))))) (=> (= tmp%33@ (Mul a19~154@ a19~154@)) (=> (= tmp%34@ (Mul b19~156@ d19~160@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%33@ tmp%34@) (=> %%location_label%%19 (= temp_19_0~3825@ temp_19_1~3886@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
