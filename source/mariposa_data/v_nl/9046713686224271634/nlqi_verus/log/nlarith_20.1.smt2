...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul d0~8@ (Mul a0~2@ (Sub c0~6@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@))))) (=> (= temp_0_1~338@ (Mul (Mul (Mul d0~8@ a0~2@) (Sub c0~6@ d0~8@)) (Mul (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~289@ temp_0_1~338@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~414@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@))) (Sub (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@)) (Add a1~10@ (Sub b1~12@ a1~10@))))) (=> (= temp_1_1~475@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@))) (Sub (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@)) (Add a1~10@ (Sub b1~12@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~414@ temp_1_1~475@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~575@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul 47 b2~20@)) (Mul (Mul c2~22@ c2~22@) 40)) (Add (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~712@ (Add (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul 47 b2~20@)) (Mul (Mul c2~22@ c2~22@) 40)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul 47 b2~20@)) (Mul (Mul c2~22@ c2~22@) 40)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~575@ temp_2_1~712@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~792@ (Mul (Mul (Mul (Sub b3~28@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Sub a3~26@ a3~26@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~857@ (Mul (Mul (Mul (Mul (Sub b3~28@ c3~30@) b3~28@) d3~32@) (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Sub a3~26@ a3~26@) (Mul a3~26@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~792@ temp_3_1~857@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~953@ (Mul (Mul (Mul d4~40@ (Add 40 a4~34@)) (Sub (Mul 62 c4~38@) (Mul b4~36@ c4~38@))) (Mul (Mul (Add d4~40@ a4~34@) c4~38@) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~1038@ (Mul (Mul (Mul d4~40@ (Add 40 a4~34@)) (Sub (Mul 62 c4~38@) (Mul b4~36@ c4~38@))) (Mul (Add (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~953@ temp_4_1~1038@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1130@ (Mul (Mul (Sub (Mul d5~48@ d5~48@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ b5~44@))) (Sub (Sub (Sub 50 a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1207@ (Mul (Mul (Sub (Mul d5~48@ d5~48@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ b5~44@))) (Sub (Sub (Sub 50 a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1130@ temp_5_1~1207@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1259@ (Add (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Sub c6~54@ b6~52@) (Mul c6~54@ c6~54@))) c6~54@)) (=> (= temp_6_1~1296@ (Add (Mul (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ b6~52@)) (Mul (Sub c6~54@ b6~52@) (Mul c6~54@ c6~54@))) c6~54@)) (=> (= tmp%7@ (= temp_6_0~1259@ temp_6_1~1296@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1396@ (Mul (Sub (Mul (Mul c7~62@ d7~64@) c7~62@) (Mul (Mul 15 b7~60@) (Mul b7~60@ d7~64@))) (Mul (Mul (Add c7~62@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Mul 29 b7~60@))))) (=> (= temp_7_1~1481@ (Mul (Sub (Mul (Mul c7~62@ d7~64@) c7~62@) (Mul (Mul 15 b7~60@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul 29 b7~60@)) (Mul (Add c7~62@ d7~64@) (Mul c7~62@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1396@ temp_7_1~1481@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1561@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ a8~66@)) (Add (Mul b8~68@ d8~72@) (Add d8~72@ b8~68@))) (Mul (Mul (Mul d8~72@ c8~70@) (Add b8~68@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1626@ (Mul (Mul (Mul d8~72@ c8~70@) (Mul (Mul d8~72@ a8~66@) (Add (Mul b8~68@ d8~72@) (Add d8~72@ b8~68@)))) (Mul (Mul (Mul d8~72@ c8~70@) (Add b8~68@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1561@ temp_8_1~1626@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1702@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Add (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@))) (Mul (Add a9~74@ (Mul c9~78@ a9~74@)) (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~1763@ (Mul (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Add (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@))) (Add a9~74@ (Mul c9~78@ a9~74@))) (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ c9~78@)))) (=> (= tmp%10@ (= temp_9_0~1702@ temp_9_1~1763@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1843@ (Mul (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)) (Add (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1924@ (Mul (Add (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)) (Mul c10~86@ a10~82@)) (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1843@ temp_10_1~1924@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~2000@ (Mul (Add (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ a11~90@)) (Sub (Mul b11~92@ b11~92@) (Mul a11~90@ a11~90@))) (Mul (Mul b11~92@ (Mul b11~92@ b11~92@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2061@ (Mul (Add (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ a11~90@)) (Sub (Mul b11~92@ b11~92@) (Mul a11~90@ a11~90@))) (Mul (Mul b11~92@ (Mul b11~92@ b11~92@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~2000@ temp_11_1~2061@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2137@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Add d12~104@ c12~102@)) (Mul (Sub c12~102@ a12~98@) c12~102@)) (Mul (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2198@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Add d12~104@ c12~102@)) (Mul (Sub c12~102@ a12~98@) c12~102@)) (Mul (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul d12~104@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~2137@ temp_12_1~2198@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2290@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul 84 a13~106@)) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2367@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ d13~112@)) (Mul (Mul b13~108@ b13~108@) (Mul 84 a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2290@ temp_13_1~2367@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2447@ (Sub (Sub (Mul (Mul d14~120@ a14~114@) (Mul d14~120@ c14~118@)) (Mul (Mul b14~116@ d14~120@) (Sub d14~120@ a14~114@))) (Mul (Mul (Mul c14~118@ c14~118@) (Add c14~118@ c14~118@)) (Add (Mul b14~116@ c14~118@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2512@ (Sub (Sub (Mul (Mul d14~120@ a14~114@) (Mul d14~120@ c14~118@)) (Mul (Sub d14~120@ a14~114@) (Mul b14~116@ d14~120@))) (Mul (Mul (Mul c14~118@ c14~118@) (Add c14~118@ c14~118@)) (Add (Mul b14~116@ c14~118@) (Mul b14~116@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2447@ temp_14_1~2512@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2588@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) d15~128@) (Mul (Mul d15~128@ b15~124@) (Mul a15~122@ b15~124@))) (Mul (Mul (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@)) (Sub (Mul a15~122@ c15~126@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2665@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) d15~128@) (Mul (Mul d15~128@ b15~124@) (Mul a15~122@ b15~124@))) (Sub (Mul (Mul (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@)) (Mul a15~122@ c15~126@)) (Mul (Mul (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@)) (Mul c15~126@ c15~126@))))) (=> (= tmp%16@ (= temp_15_0~2588@ temp_15_1~2665@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2733@ (Mul (Mul (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ b16~132@)) (Add (Add b16~132@ c16~134@) (Mul d16~136@ a16~130@))) (Add b16~132@ (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ c16~134@))))) (=> (= temp_16_1~2786@ (Mul (Mul (Mul c16~134@ b16~132@) (Mul (Mul c16~134@ b16~132@) (Add (Add b16~132@ c16~134@) (Mul d16~136@ a16~130@)))) (Add b16~132@ (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ c16~134@))))) (=> (= tmp%17@ (= temp_16_0~2733@ temp_16_1~2786@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2866@ (Mul (Mul (Mul (Mul a17~138@ d17~144@) (Sub d17~144@ a17~138@)) (Mul (Add a17~138@ c17~142@) (Add b17~140@ c17~142@))) (Mul (Mul (Mul c17~142@ d17~144@) (Mul d17~144@ b17~140@)) (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ c17~142@))))) (=> (= temp_17_1~2931@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Mul d17~144@ b17~140@)) (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul a17~138@ d17~144@) (Sub d17~144@ a17~138@)) (Mul (Add a17~138@ c17~142@) (Add b17~140@ c17~142@))))) (=> (= tmp%18@ (= temp_17_0~2866@ temp_17_1~2931@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~3035@ (Add (Mul (Mul (Mul d18~152@ a18~146@) (Mul c18~150@ a18~146@)) (Mul (Mul d18~152@ 24) (Mul b18~148@ b18~148@))) (Mul (Add (Mul d18~152@ a18~146@) (Mul c18~150@ a18~146@)) (Mul (Mul c18~150@ c18~150@) (Mul 84 d18~152@))))) (=> (= temp_18_1~3124@ (Add (Mul (Mul (Mul d18~152@ a18~146@) (Mul a18~146@ c18~150@)) (Mul (Mul d18~152@ 24) (Mul b18~148@ b18~148@))) (Mul (Add (Mul d18~152@ a18~146@) (Mul c18~150@ a18~146@)) (Mul (Mul c18~150@ c18~150@) (Mul 84 d18~152@))))) (=> (= tmp%19@ (= temp_18_0~3035@ temp_18_1~3124@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3200@ (Sub (Mul (Mul (Mul a19~154@ a19~154@) (Mul c19~158@ a19~154@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ b19~156@))) (Mul (Add c19~158@ (Mul d19~160@ d19~160@)) (Mul (Mul a19~154@ a19~154@) (Mul b19~156@ d19~160@))))) (=> (= temp_19_1~3261@ (Sub (Mul (Mul (Mul a19~154@ a19~154@) (Mul c19~158@ a19~154@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ b19~156@))) (Mul (Add c19~158@ (Mul d19~160@ d19~160@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ a19~154@))))) (=> (= tmp%20@ (= temp_19_0~3200@ temp_19_1~3261@)) (=> %%location_label%%19 tmp%20@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
