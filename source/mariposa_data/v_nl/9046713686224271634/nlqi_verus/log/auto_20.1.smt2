...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul d0~8@ (Mul a0~2@ (Sub c0~6@ d0~8@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@))))) (=> (= temp_0_1~338@ (Mul (Mul (Mul d0~8@ a0~2@) (Sub c0~6@ d0~8@)) (Mul (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~338@))) (=> (= temp_0_0~289@ temp_0_1~338@) (=> (= temp_1_0~423@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@))) (Sub (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@)) (Add a1~10@ (Sub b1~12@ a1~10@))))) (=> (= temp_1_1~484@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@))) (Sub (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@)) (Add a1~10@ (Sub b1~12@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~423@ temp_1_1~484@))) (=> (= temp_1_0~423@ temp_1_1~484@) (=> (= temp_2_0~593@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul 47 b2~20@)) (Mul (Mul c2~22@ c2~22@) 40)) (Add (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~730@ (Add (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul 47 b2~20@)) (Mul (Mul c2~22@ c2~22@) 40)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul 47 b2~20@)) (Mul (Mul c2~22@ c2~22@) 40)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~593@ temp_2_1~730@))) (=> (= temp_2_0~593@ temp_2_1~730@) (=> (= temp_3_0~819@ (Mul (Mul (Mul (Sub b3~28@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Sub a3~26@ a3~26@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~884@ (Mul (Mul (Mul (Mul (Sub b3~28@ c3~30@) b3~28@) d3~32@) (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Sub a3~26@ a3~26@) (Mul a3~26@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~819@ temp_3_1~884@))) (=> (= temp_3_0~819@ temp_3_1~884@) (=> (= temp_4_0~989@ (Mul (Mul (Mul d4~40@ (Add 40 a4~34@)) (Sub (Mul 62 c4~38@) (Mul b4~36@ c4~38@))) (Mul (Mul (Add d4~40@ a4~34@) c4~38@) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~1074@ (Mul (Mul (Mul d4~40@ (Add 40 a4~34@)) (Sub (Mul 62 c4~38@) (Mul b4~36@ c4~38@))) (Mul (Add (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~989@ temp_4_1~1074@))) (=> (= temp_4_0~989@ temp_4_1~1074@) (=> (= temp_5_0~1175@ (Mul (Mul (Sub (Mul d5~48@ d5~48@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ b5~44@))) (Sub (Sub (Sub 50 a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1252@ (Mul (Mul (Sub (Mul d5~48@ d5~48@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ b5~44@))) (Sub (Sub (Sub 50 a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1175@ temp_5_1~1252@))) (=> (= temp_5_0~1175@ temp_5_1~1252@) (=> (= temp_6_0~1313@ (Add (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Sub c6~54@ b6~52@) (Mul c6~54@ c6~54@))) c6~54@)) (=> (= temp_6_1~1350@ (Add (Mul (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ b6~52@)) (Mul (Sub c6~54@ b6~52@) (Mul c6~54@ c6~54@))) c6~54@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1313@ temp_6_1~1350@))) (=> (= temp_6_0~1313@ temp_6_1~1350@) (=> (= temp_7_0~1459@ (Mul (Sub (Mul (Mul c7~62@ d7~64@) c7~62@) (Mul (Mul 15 b7~60@) (Mul b7~60@ d7~64@))) (Mul (Mul (Add c7~62@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Mul 29 b7~60@))))) (=> (= temp_7_1~1544@ (Mul (Sub (Mul (Mul c7~62@ d7~64@) c7~62@) (Mul (Mul 15 b7~60@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul 29 b7~60@)) (Mul (Add c7~62@ d7~64@) (Mul c7~62@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1459@ temp_7_1~1544@))) (=> (= temp_7_0~1459@ temp_7_1~1544@) (=> (= temp_8_0~1633@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ a8~66@)) (Add (Mul b8~68@ d8~72@) (Add d8~72@ b8~68@))) (Mul (Mul (Mul d8~72@ c8~70@) (Add b8~68@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1698@ (Mul (Mul (Mul d8~72@ c8~70@) (Mul (Mul d8~72@ a8~66@) (Add (Mul b8~68@ d8~72@) (Add d8~72@ b8~68@)))) (Mul (Mul (Mul d8~72@ c8~70@) (Add b8~68@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1633@ temp_8_1~1698@))) (=> (= temp_8_0~1633@ temp_8_1~1698@) (=> (= temp_9_0~1783@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Add (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@))) (Mul (Add a9~74@ (Mul c9~78@ a9~74@)) (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~1844@ (Mul (Mul (Mul (Mul (Mul c9~78@ b9~76@) (Mul a9~74@ b9~76@)) (Add (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@))) (Add a9~74@ (Mul c9~78@ a9~74@))) (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ c9~78@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1783@ temp_9_1~1844@))) (=> (= temp_9_0~1783@ temp_9_1~1844@) (=> (= temp_10_0~1933@ (Mul (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)) (Add (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~2014@ (Mul (Add (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)) (Mul c10~86@ a10~82@)) (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1933@ temp_10_1~2014@))) (=> (= temp_10_0~1933@ temp_10_1~2014@) (=> (= temp_11_0~2099@ (Mul (Add (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ a11~90@)) (Sub (Mul b11~92@ b11~92@) (Mul a11~90@ a11~90@))) (Mul (Mul b11~92@ (Mul b11~92@ b11~92@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2160@ (Mul (Add (Mul (Mul a11~90@ b11~92@) (Mul d11~96@ a11~90@)) (Sub (Mul b11~92@ b11~92@) (Mul a11~90@ a11~90@))) (Mul (Mul b11~92@ (Mul b11~92@ b11~92@)) (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2099@ temp_11_1~2160@))) (=> (= temp_11_0~2099@ temp_11_1~2160@) (=> (= temp_12_0~2245@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Add d12~104@ c12~102@)) (Mul (Sub c12~102@ a12~98@) c12~102@)) (Mul (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2306@ (Mul (Mul (Mul (Mul c12~102@ d12~104@) (Add d12~104@ c12~102@)) (Mul (Sub c12~102@ a12~98@) c12~102@)) (Mul (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul d12~104@ d12~104@) (Mul d12~104@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2245@ temp_12_1~2306@))) (=> (= temp_12_0~2245@ temp_12_1~2306@) (=> (= temp_13_0~2407@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul 84 a13~106@)) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2484@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ c13~110@)) (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ d13~112@)) (Mul (Mul b13~108@ b13~108@) (Mul 84 a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2407@ temp_13_1~2484@))) (=> (= temp_13_0~2407@ temp_13_1~2484@) (=> (= temp_14_0~2573@ (Sub (Sub (Mul (Mul d14~120@ a14~114@) (Mul d14~120@ c14~118@)) (Mul (Mul b14~116@ d14~120@) (Sub d14~120@ a14~114@))) (Mul (Mul (Mul c14~118@ c14~118@) (Add c14~118@ c14~118@)) (Add (Mul b14~116@ c14~118@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2638@ (Sub (Sub (Mul (Mul d14~120@ a14~114@) (Mul d14~120@ c14~118@)) (Mul (Sub d14~120@ a14~114@) (Mul b14~116@ d14~120@))) (Mul (Mul (Mul c14~118@ c14~118@) (Add c14~118@ c14~118@)) (Add (Mul b14~116@ c14~118@) (Mul b14~116@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2573@ temp_14_1~2638@))) (=> (= temp_14_0~2573@ temp_14_1~2638@) (=> (= temp_15_0~2723@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) d15~128@) (Mul (Mul d15~128@ b15~124@) (Mul a15~122@ b15~124@))) (Mul (Mul (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@)) (Sub (Mul a15~122@ c15~126@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2800@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) d15~128@) (Mul (Mul d15~128@ b15~124@) (Mul a15~122@ b15~124@))) (Sub (Mul (Mul (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@)) (Mul a15~122@ c15~126@)) (Mul (Mul (Mul d15~128@ b15~124@) (Mul d15~128@ d15~128@)) (Mul c15~126@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2723@ temp_15_1~2800@))) (=> (= temp_15_0~2723@ temp_15_1~2800@) (=> (= temp_16_0~2877@ (Mul (Mul (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ b16~132@)) (Add (Add b16~132@ c16~134@) (Mul d16~136@ a16~130@))) (Add b16~132@ (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ c16~134@))))) (=> (= temp_16_1~2930@ (Mul (Mul (Mul c16~134@ b16~132@) (Mul (Mul c16~134@ b16~132@) (Add (Add b16~132@ c16~134@) (Mul d16~136@ a16~130@)))) (Add b16~132@ (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2877@ temp_16_1~2930@))) (=> (= temp_16_0~2877@ temp_16_1~2930@) (=> (= temp_17_0~3019@ (Mul (Mul (Mul (Mul a17~138@ d17~144@) (Sub d17~144@ a17~138@)) (Mul (Add a17~138@ c17~142@) (Add b17~140@ c17~142@))) (Mul (Mul (Mul c17~142@ d17~144@) (Mul d17~144@ b17~140@)) (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ c17~142@))))) (=> (= temp_17_1~3084@ (Mul (Mul (Mul (Mul c17~142@ d17~144@) (Mul d17~144@ b17~140@)) (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul a17~138@ d17~144@) (Sub d17~144@ a17~138@)) (Mul (Add a17~138@ c17~142@) (Add b17~140@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~3019@ temp_17_1~3084@))) (=> (= temp_17_0~3019@ temp_17_1~3084@) (=> (= temp_18_0~3197@ (Add (Mul (Mul (Mul d18~152@ a18~146@) (Mul c18~150@ a18~146@)) (Mul (Mul d18~152@ 24) (Mul b18~148@ b18~148@))) (Mul (Add (Mul d18~152@ a18~146@) (Mul c18~150@ a18~146@)) (Mul (Mul c18~150@ c18~150@) (Mul 84 d18~152@))))) (=> (= temp_18_1~3286@ (Add (Mul (Mul (Mul d18~152@ a18~146@) (Mul a18~146@ c18~150@)) (Mul (Mul d18~152@ 24) (Mul b18~148@ b18~148@))) (Mul (Add (Mul d18~152@ a18~146@) (Mul c18~150@ a18~146@)) (Mul (Mul c18~150@ c18~150@) (Mul 84 d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3197@ temp_18_1~3286@))) (=> (= temp_18_0~3197@ temp_18_1~3286@) (=> (= temp_19_0~3371@ (Sub (Mul (Mul (Mul a19~154@ a19~154@) (Mul c19~158@ a19~154@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ b19~156@))) (Mul (Add c19~158@ (Mul d19~160@ d19~160@)) (Mul (Mul a19~154@ a19~154@) (Mul b19~156@ d19~160@))))) (=> (= temp_19_1~3432@ (Sub (Mul (Mul (Mul a19~154@ a19~154@) (Mul c19~158@ a19~154@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ b19~156@))) (Mul (Add c19~158@ (Mul d19~160@ d19~160@)) (Mul (Mul b19~156@ d19~160@) (Mul a19~154@ a19~154@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3371@ temp_19_1~3432@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
