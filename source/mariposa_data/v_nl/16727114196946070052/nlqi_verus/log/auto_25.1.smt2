...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Add (Mul a0~2@ (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul 10 a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ d0~8@))))) (=> (= temp_0_1~386@ (Mul (Add (Mul a0~2@ (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul 10 a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~386@))) (=> (= temp_0_0~313@ temp_0_1~386@) (=> (= temp_1_0~471@ (Mul (Mul (Mul (Mul b1~12@ a1~10@) (Add b1~12@ b1~12@)) (Sub (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul b1~12@ d1~16@) a1~10@) (Sub (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~532@ (Mul (Mul (Mul b1~12@ a1~10@) (Mul (Add b1~12@ b1~12@) (Sub (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@)))) (Mul (Mul (Mul b1~12@ d1~16@) a1~10@) (Sub (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~471@ temp_1_1~532@))) (=> (= temp_1_0~471@ temp_1_1~532@) (=> (= temp_2_0~633@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ 61)) (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ b2~20@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Sub c2~22@ d2~24@))))) (=> (= temp_2_1~710@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ 61)) (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ b2~20@))) (Mul (Mul (Mul (Mul a2~18@ d2~24@) d2~24@) a2~18@) (Mul (Mul d2~24@ b2~20@) (Sub c2~22@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~633@ temp_2_1~710@))) (=> (= temp_2_0~633@ temp_2_1~710@) (=> (= temp_3_0~775@ (Sub (Mul b3~28@ b3~28@) (Mul (Mul (Add c3~30@ c3~30@) (Mul a3~26@ b3~28@)) (Add (Add c3~30@ d3~32@) (Sub a3~26@ a3~26@))))) (=> (= temp_3_1~816@ (Sub (Mul b3~28@ b3~28@) (Mul (Mul (Mul a3~26@ b3~28@) (Add c3~30@ c3~30@)) (Add (Add c3~30@ d3~32@) (Sub a3~26@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~775@ temp_3_1~816@))) (=> (= temp_3_0~775@ temp_3_1~816@) (=> (= temp_4_0~929@ (Add (Add (Mul (Sub 74 d4~40@) (Mul a4~34@ 69)) (Mul (Sub b4~36@ b4~36@) (Sub a4~34@ b4~36@))) (Mul (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~1018@ (Add (Add (Mul (Sub 74 d4~40@) (Mul a4~34@ 69)) (Mul (Sub b4~36@ b4~36@) (Sub a4~34@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~929@ temp_4_1~1018@))) (=> (= temp_4_0~929@ temp_4_1~1018@) (=> (= temp_5_0~1107@ (Mul (Mul (Mul (Add c5~46@ d5~48@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ b5~44@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ b5~44@)) (Mul (Sub a5~42@ d5~48@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1172@ (Mul (Mul (Mul (Add c5~46@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ b5~44@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ b5~44@)) (Mul (Sub a5~42@ d5~48@) (Mul b5~44@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1107@ temp_5_1~1172@))) (=> (= temp_5_0~1107@ temp_5_1~1172@) (=> (= temp_6_0~1273@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ d6~56@))) (Mul (Mul (Mul b6~52@ a6~50@) (Sub 79 a6~50@)) (Mul (Mul a6~50@ b6~52@) (Sub d6~56@ c6~54@))))) (=> (= temp_6_1~1350@ (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ d6~56@))) (Mul (Mul (Mul b6~52@ a6~50@) (Sub 79 a6~50@)) (Mul (Mul a6~50@ b6~52@) (Sub d6~56@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1273@ temp_6_1~1350@))) (=> (= temp_6_0~1273@ temp_6_1~1350@) (=> (= temp_7_0~1439@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ d7~64@))))) (=> (= temp_7_1~1504@ (Mul (Mul (Mul (Mul (Mul b7~60@ d7~64@) b7~60@) d7~64@) (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1439@ temp_7_1~1504@))) (=> (= temp_7_0~1439@ temp_7_1~1504@) (=> (= temp_8_0~1593@ (Add (Mul (Add (Mul a8~66@ c8~70@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ a8~66@))) (Add (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul d8~72@ c8~70@) (Add a8~66@ b8~68@))))) (=> (= temp_8_1~1658@ (Add (Mul (Add (Mul a8~66@ c8~70@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@))) (Add (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul d8~72@ c8~70@) (Add a8~66@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1593@ temp_8_1~1658@))) (=> (= temp_8_0~1593@ temp_8_1~1658@) (=> (= temp_9_0~1759@ (Mul (Mul (Mul (Add b9~76@ d9~80@) (Mul d9~80@ d9~80@)) (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ 75))) (Mul (Mul (Add d9~80@ b9~76@) (Mul c9~78@ a9~74@)) (Mul (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~1836@ (Mul (Mul (Mul (Add b9~76@ d9~80@) (Mul d9~80@ d9~80@)) (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ 75))) (Mul (Mul (Mul c9~78@ a9~74@) (Add d9~80@ b9~76@)) (Mul (Mul b9~76@ d9~80@) (Mul c9~78@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1759@ temp_9_1~1836@))) (=> (= temp_9_0~1759@ temp_9_1~1836@) (=> (= temp_10_0~1937@ (Mul (Mul (Mul (Mul d10~88@ b10~84@) (Sub d10~88@ c10~86@)) (Sub (Sub a10~82@ 8) (Add a10~82@ a10~82@))) (Sub (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ b10~84@)) (Mul (Sub b10~84@ d10~88@) (Mul d10~88@ a10~82@))))) (=> (= temp_10_1~2014@ (Mul (Mul (Mul d10~88@ b10~84@) (Mul (Sub d10~88@ c10~86@) (Sub (Sub a10~82@ 8) (Add a10~82@ a10~82@)))) (Sub (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ b10~84@)) (Mul (Sub b10~84@ d10~88@) (Mul d10~88@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1937@ temp_10_1~2014@))) (=> (= temp_10_0~1937@ temp_10_1~2014@) (=> (= temp_11_0~2111@ (Add (Mul (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ c11~94@)) (Mul b11~92@ (Mul b11~92@ b11~92@))) (Mul (Mul (Mul c11~94@ 36) (Mul b11~92@ c11~94@)) (Mul (Sub c11~94@ d11~96@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~2184@ (Add (Mul (Mul (Mul a11~90@ b11~92@) (Mul b11~92@ c11~94@)) (Mul (Mul b11~92@ b11~92@) b11~92@)) (Mul (Mul (Mul c11~94@ 36) (Mul b11~92@ c11~94@)) (Mul (Sub c11~94@ d11~96@) (Mul a11~90@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2111@ temp_11_1~2184@))) (=> (= temp_11_0~2111@ temp_11_1~2184@) (=> (= temp_12_0~2261@ (Mul (Add a12~98@ (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ d12~104@))) (Mul (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ b12~100@))))) (=> (= temp_12_1~2314@ (Mul (Add a12~98@ (Mul b12~100@ (Mul c12~102@ (Mul d12~104@ d12~104@)))) (Mul (Mul (Mul d12~104@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2261@ temp_12_1~2314@))) (=> (= temp_12_0~2261@ temp_12_1~2314@) (=> (= temp_13_0~2399@ (Mul (Add (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ b13~108@)) (Add (Add c13~110@ c13~110@) (Mul b13~108@ c13~110@))) (Mul (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ b13~108@)) (Mul (Mul d13~112@ b13~108@) c13~110@)))) (=> (= temp_13_1~2460@ (Mul (Add (Mul (Mul a13~106@ d13~112@) (Mul d13~112@ b13~108@)) (Add (Add c13~110@ c13~110@) (Mul b13~108@ c13~110@))) (Mul (Mul (Mul (Mul a13~106@ d13~112@) d13~112@) b13~108@) (Mul (Mul d13~112@ b13~108@) c13~110@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2399@ temp_13_1~2460@))) (=> (= temp_13_0~2399@ temp_13_1~2460@) (=> (= temp_14_0~2545@ (Add (Mul (Mul (Mul b14~116@ b14~116@) (Mul b14~116@ b14~116@)) (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul c14~118@ d14~120@) (Mul a14~114@ c14~118@)) (Mul b14~116@ (Mul b14~116@ a14~114@))))) (=> (= temp_14_1~2606@ (Add (Mul (Mul (Mul b14~116@ b14~116@) (Mul b14~116@ b14~116@)) (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul c14~118@ d14~120@) (Mul a14~114@ c14~118@)) (Mul (Mul b14~116@ b14~116@) a14~114@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2545@ temp_14_1~2606@))) (=> (= temp_14_0~2545@ temp_14_1~2606@) (=> (= temp_15_0~2699@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Mul b15~124@ d15~128@)) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ b15~124@)) (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ 97))))) (=> (= temp_15_1~2768@ (Mul (Mul (Mul a15~122@ c15~126@) (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ d15~128@))) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ b15~124@)) (Mul (Mul a15~122@ a15~122@) (Mul d15~128@ 97))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2699@ temp_15_1~2768@))) (=> (= temp_15_0~2699@ temp_15_1~2768@) (=> (= temp_16_0~2857@ (Add (Mul (Mul (Sub b16~132@ d16~136@) (Mul c16~134@ c16~134@)) (Mul (Mul a16~130@ b16~132@) (Mul d16~136@ c16~134@))) (Add (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ c16~134@)) (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ d16~136@))))) (=> (= temp_16_1~2922@ (Add (Mul (Mul (Sub b16~132@ d16~136@) (Mul c16~134@ c16~134@)) (Mul (Mul b16~132@ a16~130@) (Mul d16~136@ c16~134@))) (Add (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ c16~134@)) (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2857@ temp_16_1~2922@))) (=> (= temp_16_0~2857@ temp_16_1~2922@) (=> (= temp_17_0~3003@ (Add (Add (Mul (Mul c17~142@ a17~138@) (Add b17~140@ a17~138@)) (Sub (Sub d17~144@ c17~142@) (Mul c17~142@ a17~138@))) (Add (Mul (Mul c17~142@ c17~142@) a17~138@) (Mul a17~138@ (Mul d17~144@ c17~142@))))) (=> (= temp_17_1~3060@ (Add (Add (Mul (Mul c17~142@ a17~138@) (Add b17~140@ a17~138@)) (Sub (Sub d17~144@ c17~142@) (Mul c17~142@ a17~138@))) (Add (Mul (Mul c17~142@ c17~142@) a17~138@) (Mul a17~138@ (Mul c17~142@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~3003@ temp_17_1~3060@))) (=> (= temp_17_0~3003@ temp_17_1~3060@) (=> (= temp_18_0~3149@ (Add (Mul (Mul (Mul b18~148@ c18~150@) (Add d18~152@ b18~148@)) (Mul (Mul c18~150@ a18~146@) (Sub c18~150@ a18~146@))) (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ d18~152@)) (Mul (Mul a18~146@ b18~148@) (Mul b18~148@ a18~146@))))) (=> (= temp_18_1~3214@ (Add (Mul (Mul (Mul b18~148@ c18~150@) (Add d18~152@ b18~148@)) (Mul (Mul c18~150@ a18~146@) (Sub c18~150@ a18~146@))) (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ d18~152@)) (Mul (Mul b18~148@ a18~146@) (Mul a18~146@ b18~148@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3149@ temp_18_1~3214@))) (=> (= temp_18_0~3149@ temp_18_1~3214@) (=> (= temp_19_0~3291@ (Mul (Mul (Mul (Mul a19~154@ c19~158@) (Mul d19~160@ b19~156@)) d19~160@) (Mul (Mul (Mul b19~156@ a19~154@) (Mul d19~160@ b19~156@)) (Mul (Mul d19~160@ c19~158@) (Mul d19~160@ b19~156@))))) (=> (= temp_19_1~3344@ (Mul (Mul (Mul (Mul b19~156@ a19~154@) (Mul d19~160@ b19~156@)) (Mul (Mul d19~160@ c19~158@) (Mul d19~160@ b19~156@))) (Mul (Mul (Mul a19~154@ c19~158@) (Mul d19~160@ b19~156@)) d19~160@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3291@ temp_19_1~3344@))) (=> (= temp_19_0~3291@ temp_19_1~3344@) (=> (= temp_20_0~3441@ (Add (Mul (Mul (Mul a20~162@ b20~164@) (Mul d20~168@ c20~166@)) (Mul (Sub c20~166@ c20~166@) (Add c20~166@ c20~166@))) (Sub (Sub (Mul d20~168@ b20~164@) c20~166@) (Mul (Mul 7 d20~168@) (Mul b20~164@ c20~166@))))) (=> (= temp_20_1~3514@ (Add (Mul (Mul a20~162@ b20~164@) (Mul (Mul d20~168@ c20~166@) (Mul (Sub c20~166@ c20~166@) (Add c20~166@ c20~166@)))) (Sub (Sub (Mul d20~168@ b20~164@) c20~166@) (Mul (Mul 7 d20~168@) (Mul b20~164@ c20~166@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3441@ temp_20_1~3514@))) (=> (= temp_20_0~3441@ temp_20_1~3514@) (=> (= temp_21_0~3599@ (Mul (Mul (Add d21~176@ (Sub a21~170@ d21~176@)) (Sub (Sub d21~176@ c21~174@) (Mul c21~174@ b21~172@))) (Sub (Add (Sub b21~172@ c21~174@) (Mul b21~172@ b21~172@)) (Mul (Mul d21~176@ d21~176@) (Mul b21~172@ b21~172@))))) (=> (= temp_21_1~3688@ (Sub (Mul (Mul (Add d21~176@ (Sub a21~170@ d21~176@)) (Sub (Sub d21~176@ c21~174@) (Mul c21~174@ b21~172@))) (Add (Sub b21~172@ c21~174@) (Mul b21~172@ b21~172@))) (Mul (Mul (Add d21~176@ (Sub a21~170@ d21~176@)) (Sub (Sub d21~176@ c21~174@) (Mul c21~174@ b21~172@))) (Mul (Mul d21~176@ d21~176@) (Mul b21~172@ b21~172@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3599@ temp_21_1~3688@))) (=> (= temp_21_0~3599@ temp_21_1~3688@) (=> (= temp_22_0~3777@ (Mul (Mul (Add (Mul d22~184@ c22~182@) (Mul b22~180@ c22~182@)) (Mul (Mul a22~178@ a22~178@) (Sub c22~182@ c22~182@))) (Mul (Mul (Mul a22~178@ d22~184@) (Mul c22~182@ c22~182@)) (Mul (Mul a22~178@ c22~182@) (Mul d22~184@ d22~184@))))) (=> (= temp_22_1~3842@ (Mul (Mul (Add (Mul d22~184@ c22~182@) (Mul c22~182@ b22~180@)) (Mul (Mul a22~178@ a22~178@) (Sub c22~182@ c22~182@))) (Mul (Mul (Mul a22~178@ d22~184@) (Mul c22~182@ c22~182@)) (Mul (Mul a22~178@ c22~182@) (Mul d22~184@ d22~184@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3777@ temp_22_1~3842@))) (=> (= temp_22_0~3777@ temp_22_1~3842@) (=> (= temp_23_0~3927@ (Mul (Add (Add (Mul c23~190@ c23~190@) (Mul d23~192@ d23~192@)) (Add (Sub c23~190@ a23~186@) (Mul b23~188@ a23~186@))) (Add (Mul (Mul b23~188@ d23~192@) b23~188@) (Mul (Mul d23~192@ d23~192@) (Mul b23~188@ a23~186@))))) (=> (= temp_23_1~3988@ (Mul (Add (Add (Mul c23~190@ c23~190@) (Mul d23~192@ d23~192@)) (Add (Sub c23~190@ a23~186@) (Mul b23~188@ a23~186@))) (Add (Mul (Mul d23~192@ b23~188@) b23~188@) (Mul (Mul d23~192@ d23~192@) (Mul b23~188@ a23~186@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3927@ temp_23_1~3988@))) (=> (= temp_23_0~3927@ temp_23_1~3988@) (=> (= temp_24_0~4077@ (Mul (Mul (Add (Sub d24~200@ d24~200@) (Add b24~196@ b24~196@)) (Mul (Mul b24~196@ a24~194@) (Mul d24~200@ a24~194@))) (Mul (Mul (Sub c24~198@ c24~198@) (Mul c24~198@ a24~194@)) (Mul (Mul a24~194@ b24~196@) (Mul c24~198@ a24~194@))))) (=> (= temp_24_1~4142@ (Mul (Mul (Mul (Add (Sub d24~200@ d24~200@) (Add b24~196@ b24~196@)) (Mul b24~196@ a24~194@)) (Mul d24~200@ a24~194@)) (Mul (Mul (Sub c24~198@ c24~198@) (Mul c24~198@ a24~194@)) (Mul (Mul a24~194@ b24~196@) (Mul c24~198@ a24~194@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~4077@ temp_24_1~4142@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
