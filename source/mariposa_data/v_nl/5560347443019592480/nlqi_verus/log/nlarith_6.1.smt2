...
(declare-const temp_3_0~1020@ Int)
(declare-const temp_3_1~1141@ Int)
(declare-const temp_4_0~1297@ Int)
(declare-const temp_4_1~1438@ Int)
(declare-const temp_5_0~1590@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~285@ (Mul (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ c0~6@))) (Mul a0~2@ (Add (Mul b0~4@ c0~6@) (Mul c0~6@ c0~6@)))) (Mul (Add (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ d0~8@)) (Sub (Mul c0~6@ b0~4@) a0~2@)) (Mul (Sub (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul 32 b0~4@)))))) (=> (= temp_0_1~410@ (Mul (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@))) (Mul a0~2@ (Add (Mul b0~4@ c0~6@) (Mul c0~6@ c0~6@)))) (Mul (Add (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ d0~8@)) (Sub (Mul c0~6@ b0~4@) a0~2@)) (Mul (Sub (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul 32 b0~4@)))))) (=> (= tmp%1@ (= temp_0_0~285@ temp_0_1~410@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~530@ (Mul (Mul (Mul (Add (Mul a1~10@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ c1~14@))) (Sub (Sub (Mul d1~16@ d1~16@) 29) (Mul a1~10@ b1~12@))) (Mul (Mul c1~14@ (Mul (Mul d1~16@ b1~12@) (Add c1~14@ c1~14@))) (Sub d1~16@ (Sub (Mul c1~14@ b1~12@) (Mul c1~14@ d1~16@)))))) (=> (= temp_1_1~667@ (Mul (Sub (Mul (Mul (Add (Mul a1~10@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ c1~14@))) (Sub (Mul d1~16@ d1~16@) 29)) (Mul (Mul (Add (Mul a1~10@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ c1~14@))) (Mul a1~10@ b1~12@))) (Mul (Mul c1~14@ (Mul (Mul d1~16@ b1~12@) (Add c1~14@ c1~14@))) (Sub d1~16@ (Sub (Mul c1~14@ b1~12@) (Mul c1~14@ d1~16@)))))) (=> (= tmp%2@ (= temp_1_0~530@ temp_1_1~667@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~783@ (Mul (Mul (Sub (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ a2~18@)) b2~20@) (Mul c2~22@ (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ c2~22@)))) (Mul (Sub (Mul (Mul c2~22@ c2~22@) c2~22@) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@))) (Sub (Sub (Mul c2~22@ d2~24@) (Mul c2~22@ d2~24@)) (Sub (Sub a2~18@ c2~22@) (Add a2~18@ a2~18@)))))) (=> (= temp_2_1~884@ (Mul (Mul (Sub (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ a2~18@)) b2~20@) (Mul c2~22@ (Mul (Mul (Mul c2~22@ c2~22@) d2~24@) c2~22@))) (Mul (Sub (Mul (Mul c2~22@ c2~22@) c2~22@) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@))) (Sub (Sub (Mul c2~22@ d2~24@) (Mul c2~22@ d2~24@)) (Sub (Sub a2~18@ c2~22@) (Add a2~18@ a2~18@)))))) (=> (= tmp%3@ (= temp_2_0~783@ temp_2_1~884@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1020@ (Add (Mul (Sub d3~32@ (Mul (Mul c3~30@ a3~26@) (Add a3~26@ d3~32@))) (Mul (Add (Sub c3~30@ a3~26@) (Mul c3~30@ d3~32@)) (Mul b3~28@ (Mul c3~30@ a3~26@)))) (Mul (Mul (Mul (Mul 21 d3~32@) (Mul c3~30@ a3~26@)) (Mul c3~30@ (Mul a3~26@ b3~28@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ a3~26@)) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@)))))) (=> (= temp_3_1~1141@ (Add (Mul (Sub d3~32@ (Mul (Mul c3~30@ a3~26@) (Add a3~26@ d3~32@))) (Mul (Add (Sub c3~30@ a3~26@) (Mul c3~30@ d3~32@)) (Mul b3~28@ (Mul c3~30@ a3~26@)))) (Mul (Mul (Mul (Mul 21 d3~32@) (Mul c3~30@ a3~26@)) (Mul c3~30@ (Mul a3~26@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@)))))) (=> (= tmp%4@ (= temp_3_0~1020@ temp_3_1~1141@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1297@ (Mul (Mul (Sub (Mul (Mul d4~40@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ d4~40@))) (Mul (Mul d4~40@ b4~36@) (Add (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@)))) (Add (Mul (Mul 18 (Sub d4~40@ 48)) (Mul (Mul a4~34@ d4~40@) (Add c4~38@ a4~34@))) (Sub (Mul (Mul 90 c4~38@) (Add c4~38@ d4~40@)) a4~34@)))) (=> (= temp_4_1~1438@ (Mul (Mul (Sub (Mul (Mul d4~40@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Mul (Mul a4~34@ d4~40@) c4~38@) d4~40@)) (Mul (Mul d4~40@ b4~36@) (Add (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@)))) (Add (Mul (Mul 18 (Sub d4~40@ 48)) (Mul (Mul a4~34@ d4~40@) (Add c4~38@ a4~34@))) (Sub (Mul (Mul 90 c4~38@) (Add c4~38@ d4~40@)) a4~34@)))) (=> (= tmp%5@ (= temp_4_0~1297@ temp_4_1~1438@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1590@ (Mul (Sub (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Sub c5~46@ d5~48@) (Mul a5~42@ c5~46@)))) (Add (Mul (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ b5~44@))) (Sub (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ 99)) (Add b5~44@ (Mul b5~44@ b5~44@)))))) (=> (= temp_5_1~1727@ (Mul (Sub (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Sub c5~46@ d5~48@) (Mul a5~42@ c5~46@)))) (Add (Mul (Mul (Mul (Mul d5~48@ b5~44@) a5~42@) c5~46@) (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ b5~44@))) (Sub (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ 99)) (Add b5~44@ (Mul b5~44@ b5~44@)))))) (=> (= tmp%6@ (= temp_5_0~1590@ temp_5_1~1727@)) (=> %%location_label%%5 tmp%6@))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
