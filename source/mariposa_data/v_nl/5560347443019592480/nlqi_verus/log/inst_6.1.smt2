...
(set-info :comment ";; mariposa_data/v_nl//5560347443019592480/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~285@ (Mul (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ c0~6@))) (Mul a0~2@ (Add (Mul b0~4@ c0~6@) (Mul c0~6@ c0~6@)))) (Mul (Add (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ d0~8@)) (Sub (Mul c0~6@ b0~4@) a0~2@)) (Mul (Sub (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul 32 b0~4@)))))) (=> (= temp_0_1~410@ (Mul (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@))) (Mul a0~2@ (Add (Mul b0~4@ c0~6@) (Mul c0~6@ c0~6@)))) (Mul (Add (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ d0~8@)) (Sub (Mul c0~6@ b0~4@) a0~2@)) (Mul (Sub (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul 32 b0~4@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ c0~6@) (=> %%location_label%%0 (= temp_0_0~285@ temp_0_1~410@))) (=> (= temp_0_0~285@ temp_0_1~410@) (=> (= temp_1_0~543@ (Mul (Mul (Mul (Add (Mul a1~10@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ c1~14@))) (Sub (Sub (Mul d1~16@ d1~16@) 29) (Mul a1~10@ b1~12@))) (Mul (Mul c1~14@ (Mul (Mul d1~16@ b1~12@) (Add c1~14@ c1~14@))) (Sub d1~16@ (Sub (Mul c1~14@ b1~12@) (Mul c1~14@ d1~16@)))))) (=> (= temp_1_1~680@ (Mul (Sub (Mul (Mul (Add (Mul a1~10@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ c1~14@))) (Sub (Mul d1~16@ d1~16@) 29)) (Mul (Mul (Add (Mul a1~10@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ c1~14@))) (Mul a1~10@ b1~12@))) (Mul (Mul c1~14@ (Mul (Mul d1~16@ b1~12@) (Add c1~14@ c1~14@))) (Sub d1~16@ (Sub (Mul c1~14@ b1~12@) (Mul c1~14@ d1~16@)))))) (and (=> (= tmp%1@ (Mul (Add (Mul a1~10@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ c1~14@)))) (=> (= tmp%2@ (Sub (Mul d1~16@ d1~16@) 29)) (=> (= tmp%3@ (Mul a1~10@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~543@ temp_1_1~680@)))))) (=> (= temp_1_0~543@ temp_1_1~680@) (=> (= temp_2_0~863@ (Mul (Mul (Sub (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ a2~18@)) b2~20@) (Mul c2~22@ (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ c2~22@)))) (Mul (Sub (Mul (Mul c2~22@ c2~22@) c2~22@) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@))) (Sub (Sub (Mul c2~22@ d2~24@) (Mul c2~22@ d2~24@)) (Sub (Sub a2~18@ c2~22@) (Add a2~18@ a2~18@)))))) (=> (= temp_2_1~964@ (Mul (Mul (Sub (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ a2~18@)) b2~20@) (Mul c2~22@ (Mul (Mul (Mul c2~22@ c2~22@) d2~24@) c2~22@))) (Mul (Sub (Mul (Mul c2~22@ c2~22@) c2~22@) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@))) (Sub (Sub (Mul c2~22@ d2~24@) (Mul c2~22@ d2~24@)) (Sub (Sub a2~18@ c2~22@) (Add a2~18@ a2~18@)))))) (and (=> (= tmp%4@ (Mul c2~22@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ d2~24@ c2~22@) (=> %%location_label%%2 (= temp_2_0~863@ temp_2_1~964@)))) (=> (= temp_2_0~863@ temp_2_1~964@) (=> (= temp_3_0~1119@ (Add (Mul (Sub d3~32@ (Mul (Mul c3~30@ a3~26@) (Add a3~26@ d3~32@))) (Mul (Add (Sub c3~30@ a3~26@) (Mul c3~30@ d3~32@)) (Mul b3~28@ (Mul c3~30@ a3~26@)))) (Mul (Mul (Mul (Mul 21 d3~32@) (Mul c3~30@ a3~26@)) (Mul c3~30@ (Mul a3~26@ b3~28@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ a3~26@)) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@)))))) (=> (= temp_3_1~1240@ (Add (Mul (Sub d3~32@ (Mul (Mul c3~30@ a3~26@) (Add a3~26@ d3~32@))) (Mul (Add (Sub c3~30@ a3~26@) (Mul c3~30@ d3~32@)) (Mul b3~28@ (Mul c3~30@ a3~26@)))) (Mul (Mul (Mul (Mul 21 d3~32@) (Mul c3~30@ a3~26@)) (Mul c3~30@ (Mul a3~26@ b3~28@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@)))))) (and (=> (= tmp%5@ (Mul a3~26@ a3~26@)) (=> (= tmp%6@ (Mul d3~32@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~1119@ temp_3_1~1240@))))) (=> (= temp_3_0~1119@ temp_3_1~1240@) (=> (= temp_4_0~1417@ (Mul (Mul (Sub (Mul (Mul d4~40@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ d4~40@))) (Mul (Mul d4~40@ b4~36@) (Add (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@)))) (Add (Mul (Mul 18 (Sub d4~40@ 48)) (Mul (Mul a4~34@ d4~40@) (Add c4~38@ a4~34@))) (Sub (Mul (Mul 90 c4~38@) (Add c4~38@ d4~40@)) a4~34@)))) (=> (= temp_4_1~1558@ (Mul (Mul (Sub (Mul (Mul d4~40@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Mul (Mul a4~34@ d4~40@) c4~38@) d4~40@)) (Mul (Mul d4~40@ b4~36@) (Add (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@)))) (Add (Mul (Mul 18 (Sub d4~40@ 48)) (Mul (Mul a4~34@ d4~40@) (Add c4~38@ a4~34@))) (Sub (Mul (Mul 90 c4~38@) (Add c4~38@ d4~40@)) a4~34@)))) (and (=> (= tmp%7@ (Mul a4~34@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ c4~38@ d4~40@) (=> %%location_label%%4 (= temp_4_0~1417@ temp_4_1~1558@)))) (=> (= temp_4_0~1417@ temp_4_1~1558@) (=> (= temp_5_0~1729@ (Mul (Sub (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Sub c5~46@ d5~48@) (Mul a5~42@ c5~46@)))) (Add (Mul (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ b5~44@))) (Sub (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ 99)) (Add b5~44@ (Mul b5~44@ b5~44@)))))) (=> (= temp_5_1~1866@ (Mul (Sub (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Sub c5~46@ d5~48@) (Mul a5~42@ c5~46@)))) (Add (Mul (Mul (Mul (Mul d5~48@ b5~44@) a5~42@) c5~46@) (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ b5~44@))) (Sub (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ 99)) (Add b5~44@ (Mul b5~44@ b5~44@)))))) (=> (= tmp%8@ (Mul d5~48@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ a5~42@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1729@ temp_5_1~1866@)))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
