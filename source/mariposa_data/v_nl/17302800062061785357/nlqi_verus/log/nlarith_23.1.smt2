...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Sub (Mul b0~4@ b0~4@) b0~4@) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Add (Mul (Add a0~2@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Add a0~2@ a0~2@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~362@ (Mul (Mul (Sub (Mul b0~4@ b0~4@) b0~4@) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Add (Mul (Mul (Add a0~2@ b0~4@) c0~6@) b0~4@) (Mul (Add a0~2@ a0~2@) (Mul d0~8@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~434@ (Mul (Add (Mul c1~14@ c1~14@) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@))) (Mul (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~491@ (Mul (Mul (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ b1~12@))) (Add (Mul c1~14@ c1~14@) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~434@ temp_1_1~491@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~559@ (Mul (Sub b2~20@ (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Add b2~20@ c2~22@) (Mul d2~24@ c2~22@))))) (=> (= temp_2_1~612@ (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Add b2~20@ c2~22@) (Mul d2~24@ c2~22@))) (Sub b2~20@ (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~559@ temp_2_1~612@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~676@ (Mul d3~32@ (Mul (Mul (Mul a3~26@ c3~30@) (Mul 99 c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@))))) (=> (= temp_3_1~725@ (Mul d3~32@ (Mul (Mul (Mul a3~26@ c3~30@) (Mul 99 c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~676@ temp_3_1~725@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~805@ (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@)) (Sub (Add a4~34@ b4~36@) (Add a4~34@ b4~36@))) (Mul (Mul (Add c4~38@ b4~36@) (Mul d4~40@ c4~38@)) (Sub (Add c4~38@ c4~38@) (Sub b4~36@ a4~34@))))) (=> (= temp_4_1~878@ (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@)) (Sub (Add a4~34@ b4~36@) (Add a4~34@ b4~36@))) (Mul (Add (Mul c4~38@ (Mul d4~40@ c4~38@)) (Mul b4~36@ (Mul d4~40@ c4~38@))) (Sub (Add c4~38@ c4~38@) (Sub b4~36@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~805@ temp_4_1~878@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~942@ (Mul (Sub d5~48@ (Mul c5~46@ (Mul a5~42@ c5~46@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@)) (Add (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@))))) (=> (= temp_5_1~991@ (Mul (Sub d5~48@ (Mul c5~46@ (Mul a5~42@ c5~46@))) (Mul (Mul c5~46@ b5~44@) (Mul (Mul c5~46@ d5~48@) (Add (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@)))))) (=> (= tmp%6@ (= temp_5_0~942@ temp_5_1~991@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1079@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ b6~52@) c6~54@)) (Mul (Mul (Sub d6~56@ a6~50@) (Mul d6~56@ 30)) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1152@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ b6~52@) c6~54@)) (Mul (Mul (Mul (Sub d6~56@ a6~50@) d6~56@) 30) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1079@ temp_6_1~1152@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1224@ (Mul (Mul (Sub (Mul c7~62@ a7~58@) a7~58@) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@))) (Mul (Sub (Mul a7~58@ b7~60@) (Add a7~58@ b7~60@)) (Sub (Mul d7~64@ c7~62@) b7~60@)))) (=> (= temp_7_1~1281@ (Mul (Mul (Sub (Mul c7~62@ a7~58@) a7~58@) (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ a7~58@))) (Mul (Sub (Mul a7~58@ b7~60@) (Add a7~58@ b7~60@)) (Sub (Mul d7~64@ c7~62@) b7~60@)))) (=> (= tmp%8@ (= temp_7_0~1224@ temp_7_1~1281@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1361@ (Mul (Mul (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)) (Sub (Mul b8~68@ b8~68@) (Mul c8~70@ c8~70@))) (Add (Mul (Sub d8~72@ b8~68@) (Sub d8~72@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1426@ (Mul (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Sub (Mul b8~68@ b8~68@) (Mul c8~70@ c8~70@)) (Add (Mul (Sub d8~72@ b8~68@) (Sub d8~72@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ c8~70@)))))) (=> (= tmp%9@ (= temp_8_0~1361@ temp_8_1~1426@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1502@ (Add (Mul (Mul (Mul b9~76@ d9~80@) d9~80@) (Sub (Mul a9~74@ a9~74@) (Sub a9~74@ a9~74@))) (Mul (Mul (Sub d9~80@ a9~74@) (Add b9~76@ d9~80@)) (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~1563@ (Add (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ (Sub (Mul a9~74@ a9~74@) (Sub a9~74@ a9~74@)))) (Mul (Mul (Sub d9~80@ a9~74@) (Add b9~76@ d9~80@)) (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1502@ temp_9_1~1563@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1675@ (Mul (Mul (Add (Mul 64 c10~86@) (Sub a10~82@ b10~84@)) (Mul (Add c10~86@ d10~88@) (Mul d10~88@ a10~82@))) (Mul (Mul (Mul d10~88@ d10~88@) a10~82@) (Mul (Mul b10~84@ d10~88@) (Sub 29 23))))) (=> (= temp_10_1~1772@ (Mul (Mul (Mul (Add c10~86@ d10~88@) (Mul d10~88@ a10~82@)) (Add (Mul 64 c10~86@) (Sub a10~82@ b10~84@))) (Mul (Mul (Mul d10~88@ d10~88@) a10~82@) (Mul (Mul b10~84@ d10~88@) (Sub 29 23))))) (=> (= tmp%11@ (= temp_10_0~1675@ temp_10_1~1772@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1852@ (Mul (Mul (Sub (Mul d11~96@ c11~94@) (Sub b11~92@ a11~90@)) (Mul (Mul b11~92@ d11~96@) (Add a11~90@ c11~94@))) (Mul (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ c11~94@)) (Sub (Mul a11~90@ a11~90@) (Mul c11~94@ c11~94@))))) (=> (= temp_11_1~1917@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) (Add a11~90@ c11~94@)) (Sub (Mul d11~96@ c11~94@) (Sub b11~92@ a11~90@))) (Mul (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ c11~94@)) (Sub (Mul a11~90@ a11~90@) (Mul c11~94@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1852@ temp_11_1~1917@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2009@ (Mul (Mul (Mul (Add c12~102@ b12~100@) (Mul b12~100@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Sub b12~100@ b12~100@))) (Mul (Mul (Mul d12~104@ a12~98@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ 18) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2086@ (Mul (Mul (Mul (Add c12~102@ b12~100@) (Mul b12~100@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Sub b12~100@ b12~100@))) (Mul (Mul (Mul d12~104@ a12~98@) (Mul d12~104@ a12~98@)) (Mul (Mul (Mul d12~104@ 18) d12~104@) d12~104@)))) (=> (= tmp%13@ (= temp_12_0~2009@ temp_12_1~2086@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2166@ (Mul (Mul (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ b13~108@)) (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ b13~108@))) (Mul (Mul (Mul b13~108@ c13~110@) (Sub d13~112@ b13~108@)) (Sub (Mul a13~106@ a13~106@) (Mul b13~108@ b13~108@))))) (=> (= temp_13_1~2231@ (Mul (Mul (Mul (Mul b13~108@ c13~110@) (Sub d13~112@ b13~108@)) (Sub (Mul a13~106@ a13~106@) (Mul b13~108@ b13~108@))) (Mul (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ b13~108@)) (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ b13~108@))))) (=> (= tmp%14@ (= temp_13_0~2166@ temp_13_1~2231@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2311@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ d14~120@)) (Mul (Mul b14~116@ a14~114@) (Mul c14~118@ b14~116@))) (Mul (Sub (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@)) (Mul (Mul a14~114@ b14~116@) (Add c14~118@ a14~114@))))) (=> (= temp_14_1~2376@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ d14~120@)) (Mul (Mul b14~116@ a14~114@) (Mul c14~118@ b14~116@))) (Mul (Sub (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@)) (Mul (Mul a14~114@ b14~116@) (Add c14~118@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2311@ temp_14_1~2376@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2468@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Add a15~122@ b15~124@)) (Mul (Mul d15~128@ a15~122@) (Add b15~124@ c15~126@))) (Sub (Mul (Add a15~122@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ 53) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~2545@ (Mul (Mul (Mul (Mul d15~128@ a15~122@) (Add b15~124@ c15~126@)) (Mul (Mul b15~124@ a15~122@) (Add a15~122@ b15~124@))) (Sub (Mul (Add a15~122@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ 53) (Mul d15~128@ a15~122@))))) (=> (= tmp%16@ (= temp_15_0~2468@ temp_15_1~2545@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2621@ (Mul (Mul (Mul (Add b16~132@ c16~134@) (Mul a16~130@ b16~132@)) (Sub (Mul b16~132@ c16~134@) (Mul b16~132@ c16~134@))) (Mul (Sub (Sub d16~136@ a16~130@) (Mul d16~136@ c16~134@)) (Mul (Mul d16~136@ d16~136@) b16~132@)))) (=> (= temp_16_1~2682@ (Mul (Mul (Mul (Add b16~132@ c16~134@) (Mul a16~130@ b16~132@)) (Sub (Mul b16~132@ c16~134@) (Mul b16~132@ c16~134@))) (Mul (Mul (Sub (Sub d16~136@ a16~130@) (Mul d16~136@ c16~134@)) (Mul d16~136@ d16~136@)) b16~132@))) (=> (= tmp%17@ (= temp_16_0~2621@ temp_16_1~2682@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2750@ (Mul (Mul (Mul (Sub c17~142@ d17~144@) a17~138@) (Mul (Mul d17~144@ d17~144@) (Sub a17~138@ b17~140@))) (Mul (Mul (Mul d17~144@ c17~142@) b17~140@) (Mul (Mul a17~138@ a17~138@) b17~140@)))) (=> (= temp_17_1~2807@ (Mul (Mul (Sub (Mul c17~142@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul d17~144@ d17~144@) (Sub a17~138@ b17~140@))) (Mul (Mul (Mul d17~144@ c17~142@) b17~140@) (Mul (Mul a17~138@ a17~138@) b17~140@)))) (=> (= tmp%18@ (= temp_17_0~2750@ temp_17_1~2807@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2899@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Mul d18~152@ c18~150@)) (Mul (Mul d18~152@ 51) (Mul d18~152@ d18~152@))) (Mul (Mul (Mul c18~150@ b18~148@) (Mul a18~146@ a18~146@)) (Sub (Mul c18~150@ a18~146@) (Sub a18~146@ d18~152@))))) (=> (= temp_18_1~2976@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Mul d18~152@ c18~150@)) (Mul (Mul d18~152@ 51) (Mul d18~152@ d18~152@))) (Mul (Mul (Mul c18~150@ b18~148@) (Mul a18~146@ a18~146@)) (Sub (Mul a18~146@ c18~150@) (Sub a18~146@ d18~152@))))) (=> (= tmp%19@ (= temp_18_0~2899@ temp_18_1~2976@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3056@ (Sub (Mul (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ c19~158@)) (Mul (Mul b19~156@ c19~158@) (Mul d19~160@ d19~160@))) (Mul (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ a19~154@)) (Mul (Mul d19~160@ b19~156@) (Mul b19~156@ a19~154@))))) (=> (= temp_19_1~3121@ (Sub (Mul (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ c19~158@)) (Mul (Mul b19~156@ c19~158@) (Mul d19~160@ d19~160@))) (Mul (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ a19~154@)) (Mul (Mul (Mul d19~160@ b19~156@) b19~156@) a19~154@)))) (=> (= tmp%20@ (= temp_19_0~3056@ temp_19_1~3121@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3201@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Mul c20~166@ d20~168@)) (Mul (Mul a20~162@ c20~166@) (Mul b20~164@ d20~168@))) (Mul (Mul (Mul d20~168@ d20~168@) (Mul c20~166@ a20~162@)) 56))) (=> (= temp_20_1~3266@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Mul c20~166@ d20~168@)) (Mul (Mul a20~162@ c20~166@) (Mul b20~164@ d20~168@))) (Mul (Mul (Mul d20~168@ d20~168@) (Mul c20~166@ a20~162@)) 56))) (=> (= tmp%21@ (= temp_20_0~3201@ temp_20_1~3266@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3326@ (Mul (Add (Mul (Mul d21~176@ b21~172@) a21~170@) (Mul (Mul 53 a21~170@) (Mul b21~172@ d21~176@))) d21~176@)) (=> (= temp_21_1~3371@ (Mul d21~176@ (Add (Mul (Mul d21~176@ b21~172@) a21~170@) (Mul (Mul 53 a21~170@) (Mul b21~172@ d21~176@))))) (=> (= tmp%22@ (= temp_21_0~3326@ temp_21_1~3371@)) (and (=> %%location_label%%21 tmp%22@) (=> tmp%22@ (=> (= temp_22_0~3451@ (Mul (Mul (Mul (Mul c22~182@ a22~178@) (Mul d22~184@ b22~180@)) (Mul (Mul a22~178@ d22~184@) (Sub d22~184@ a22~178@))) (Mul (Mul (Mul b22~180@ c22~182@) (Mul a22~178@ c22~182@)) (Add (Add c22~182@ b22~180@) (Mul d22~184@ c22~182@))))) (=> (= temp_22_1~3532@ (Mul (Mul (Mul (Mul c22~182@ a22~178@) (Mul d22~184@ b22~180@)) (Mul (Mul a22~178@ d22~184@) (Sub d22~184@ a22~178@))) (Add (Mul (Mul (Mul b22~180@ c22~182@) (Mul a22~178@ c22~182@)) (Add c22~182@ b22~180@)) (Mul (Mul (Mul b22~180@ c22~182@) (Mul a22~178@ c22~182@)) (Mul d22~184@ c22~182@))))) (=> (= tmp%23@ (= temp_22_0~3451@ temp_22_1~3532@)) (=> %%location_label%%22 tmp%23@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
