...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Sub (Mul b0~4@ b0~4@) b0~4@) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Add (Mul (Add a0~2@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Add a0~2@ a0~2@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~362@ (Mul (Mul (Sub (Mul b0~4@ b0~4@) b0~4@) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Add (Mul (Mul (Add a0~2@ b0~4@) c0~6@) b0~4@) (Mul (Add a0~2@ a0~2@) (Mul d0~8@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~443@ (Mul (Add (Mul c1~14@ c1~14@) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@))) (Mul (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~500@ (Mul (Mul (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ b1~12@))) (Add (Mul c1~14@ c1~14@) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~443@ temp_1_1~500@))) (=> (= temp_1_0~443@ temp_1_1~500@) (=> (= temp_2_0~577@ (Mul (Sub b2~20@ (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Add b2~20@ c2~22@) (Mul d2~24@ c2~22@))))) (=> (= temp_2_1~630@ (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Add b2~20@ c2~22@) (Mul d2~24@ c2~22@))) (Sub b2~20@ (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~577@ temp_2_1~630@))) (=> (= temp_2_0~577@ temp_2_1~630@) (=> (= temp_3_0~703@ (Mul d3~32@ (Mul (Mul (Mul a3~26@ c3~30@) (Mul 99 c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@))))) (=> (= temp_3_1~752@ (Mul d3~32@ (Mul (Mul (Mul a3~26@ c3~30@) (Mul 99 c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~703@ temp_3_1~752@))) (=> (= temp_3_0~703@ temp_3_1~752@) (=> (= temp_4_0~841@ (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@)) (Sub (Add a4~34@ b4~36@) (Add a4~34@ b4~36@))) (Mul (Mul (Add c4~38@ b4~36@) (Mul d4~40@ c4~38@)) (Sub (Add c4~38@ c4~38@) (Sub b4~36@ a4~34@))))) (=> (= temp_4_1~914@ (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@)) (Sub (Add a4~34@ b4~36@) (Add a4~34@ b4~36@))) (Mul (Add (Mul c4~38@ (Mul d4~40@ c4~38@)) (Mul b4~36@ (Mul d4~40@ c4~38@))) (Sub (Add c4~38@ c4~38@) (Sub b4~36@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~841@ temp_4_1~914@))) (=> (= temp_4_0~841@ temp_4_1~914@) (=> (= temp_5_0~987@ (Mul (Sub d5~48@ (Mul c5~46@ (Mul a5~42@ c5~46@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@)) (Add (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@))))) (=> (= temp_5_1~1036@ (Mul (Sub d5~48@ (Mul c5~46@ (Mul a5~42@ c5~46@))) (Mul (Mul c5~46@ b5~44@) (Mul (Mul c5~46@ d5~48@) (Add (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~987@ temp_5_1~1036@))) (=> (= temp_5_0~987@ temp_5_1~1036@) (=> (= temp_6_0~1133@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ b6~52@) c6~54@)) (Mul (Mul (Sub d6~56@ a6~50@) (Mul d6~56@ 30)) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1206@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul c6~54@ b6~52@) c6~54@)) (Mul (Mul (Mul (Sub d6~56@ a6~50@) d6~56@) 30) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1133@ temp_6_1~1206@))) (=> (= temp_6_0~1133@ temp_6_1~1206@) (=> (= temp_7_0~1287@ (Mul (Mul (Sub (Mul c7~62@ a7~58@) a7~58@) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@))) (Mul (Sub (Mul a7~58@ b7~60@) (Add a7~58@ b7~60@)) (Sub (Mul d7~64@ c7~62@) b7~60@)))) (=> (= temp_7_1~1344@ (Mul (Mul (Sub (Mul c7~62@ a7~58@) a7~58@) (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ a7~58@))) (Mul (Sub (Mul a7~58@ b7~60@) (Add a7~58@ b7~60@)) (Sub (Mul d7~64@ c7~62@) b7~60@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1287@ temp_7_1~1344@))) (=> (= temp_7_0~1287@ temp_7_1~1344@) (=> (= temp_8_0~1433@ (Mul (Mul (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)) (Sub (Mul b8~68@ b8~68@) (Mul c8~70@ c8~70@))) (Add (Mul (Sub d8~72@ b8~68@) (Sub d8~72@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1498@ (Mul (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Sub (Mul b8~68@ b8~68@) (Mul c8~70@ c8~70@)) (Add (Mul (Sub d8~72@ b8~68@) (Sub d8~72@ b8~68@)) (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ c8~70@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1433@ temp_8_1~1498@))) (=> (= temp_8_0~1433@ temp_8_1~1498@) (=> (= temp_9_0~1583@ (Add (Mul (Mul (Mul b9~76@ d9~80@) d9~80@) (Sub (Mul a9~74@ a9~74@) (Sub a9~74@ a9~74@))) (Mul (Mul (Sub d9~80@ a9~74@) (Add b9~76@ d9~80@)) (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@))))) (=> (= temp_9_1~1644@ (Add (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ (Sub (Mul a9~74@ a9~74@) (Sub a9~74@ a9~74@)))) (Mul (Mul (Sub d9~80@ a9~74@) (Add b9~76@ d9~80@)) (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1583@ temp_9_1~1644@))) (=> (= temp_9_0~1583@ temp_9_1~1644@) (=> (= temp_10_0~1765@ (Mul (Mul (Add (Mul 64 c10~86@) (Sub a10~82@ b10~84@)) (Mul (Add c10~86@ d10~88@) (Mul d10~88@ a10~82@))) (Mul (Mul (Mul d10~88@ d10~88@) a10~82@) (Mul (Mul b10~84@ d10~88@) (Sub 29 23))))) (=> (= temp_10_1~1862@ (Mul (Mul (Mul (Add c10~86@ d10~88@) (Mul d10~88@ a10~82@)) (Add (Mul 64 c10~86@) (Sub a10~82@ b10~84@))) (Mul (Mul (Mul d10~88@ d10~88@) a10~82@) (Mul (Mul b10~84@ d10~88@) (Sub 29 23))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1765@ temp_10_1~1862@))) (=> (= temp_10_0~1765@ temp_10_1~1862@) (=> (= temp_11_0~1951@ (Mul (Mul (Sub (Mul d11~96@ c11~94@) (Sub b11~92@ a11~90@)) (Mul (Mul b11~92@ d11~96@) (Add a11~90@ c11~94@))) (Mul (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ c11~94@)) (Sub (Mul a11~90@ a11~90@) (Mul c11~94@ c11~94@))))) (=> (= temp_11_1~2016@ (Mul (Mul (Mul (Mul b11~92@ d11~96@) (Add a11~90@ c11~94@)) (Sub (Mul d11~96@ c11~94@) (Sub b11~92@ a11~90@))) (Mul (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ c11~94@)) (Sub (Mul a11~90@ a11~90@) (Mul c11~94@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1951@ temp_11_1~2016@))) (=> (= temp_11_0~1951@ temp_11_1~2016@) (=> (= temp_12_0~2117@ (Mul (Mul (Mul (Add c12~102@ b12~100@) (Mul b12~100@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Sub b12~100@ b12~100@))) (Mul (Mul (Mul d12~104@ a12~98@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ 18) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2194@ (Mul (Mul (Mul (Add c12~102@ b12~100@) (Mul b12~100@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Sub b12~100@ b12~100@))) (Mul (Mul (Mul d12~104@ a12~98@) (Mul d12~104@ a12~98@)) (Mul (Mul (Mul d12~104@ 18) d12~104@) d12~104@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2117@ temp_12_1~2194@))) (=> (= temp_12_0~2117@ temp_12_1~2194@) (=> (= temp_13_0~2283@ (Mul (Mul (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ b13~108@)) (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ b13~108@))) (Mul (Mul (Mul b13~108@ c13~110@) (Sub d13~112@ b13~108@)) (Sub (Mul a13~106@ a13~106@) (Mul b13~108@ b13~108@))))) (=> (= temp_13_1~2348@ (Mul (Mul (Mul (Mul b13~108@ c13~110@) (Sub d13~112@ b13~108@)) (Sub (Mul a13~106@ a13~106@) (Mul b13~108@ b13~108@))) (Mul (Mul (Mul a13~106@ a13~106@) (Mul b13~108@ b13~108@)) (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2283@ temp_13_1~2348@))) (=> (= temp_13_0~2283@ temp_13_1~2348@) (=> (= temp_14_0~2437@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ d14~120@)) (Mul (Mul b14~116@ a14~114@) (Mul c14~118@ b14~116@))) (Mul (Sub (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@)) (Mul (Mul a14~114@ b14~116@) (Add c14~118@ a14~114@))))) (=> (= temp_14_1~2502@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ d14~120@)) (Mul (Mul b14~116@ a14~114@) (Mul c14~118@ b14~116@))) (Mul (Sub (Mul b14~116@ b14~116@) (Mul d14~120@ c14~118@)) (Mul (Mul a14~114@ b14~116@) (Add c14~118@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2437@ temp_14_1~2502@))) (=> (= temp_14_0~2437@ temp_14_1~2502@) (=> (= temp_15_0~2603@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Add a15~122@ b15~124@)) (Mul (Mul d15~128@ a15~122@) (Add b15~124@ c15~126@))) (Sub (Mul (Add a15~122@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ 53) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~2680@ (Mul (Mul (Mul (Mul d15~128@ a15~122@) (Add b15~124@ c15~126@)) (Mul (Mul b15~124@ a15~122@) (Add a15~122@ b15~124@))) (Sub (Mul (Add a15~122@ a15~122@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ 53) (Mul d15~128@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2603@ temp_15_1~2680@))) (=> (= temp_15_0~2603@ temp_15_1~2680@) (=> (= temp_16_0~2765@ (Mul (Mul (Mul (Add b16~132@ c16~134@) (Mul a16~130@ b16~132@)) (Sub (Mul b16~132@ c16~134@) (Mul b16~132@ c16~134@))) (Mul (Sub (Sub d16~136@ a16~130@) (Mul d16~136@ c16~134@)) (Mul (Mul d16~136@ d16~136@) b16~132@)))) (=> (= temp_16_1~2826@ (Mul (Mul (Mul (Add b16~132@ c16~134@) (Mul a16~130@ b16~132@)) (Sub (Mul b16~132@ c16~134@) (Mul b16~132@ c16~134@))) (Mul (Mul (Sub (Sub d16~136@ a16~130@) (Mul d16~136@ c16~134@)) (Mul d16~136@ d16~136@)) b16~132@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2765@ temp_16_1~2826@))) (=> (= temp_16_0~2765@ temp_16_1~2826@) (=> (= temp_17_0~2903@ (Mul (Mul (Mul (Sub c17~142@ d17~144@) a17~138@) (Mul (Mul d17~144@ d17~144@) (Sub a17~138@ b17~140@))) (Mul (Mul (Mul d17~144@ c17~142@) b17~140@) (Mul (Mul a17~138@ a17~138@) b17~140@)))) (=> (= temp_17_1~2960@ (Mul (Mul (Sub (Mul c17~142@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul d17~144@ d17~144@) (Sub a17~138@ b17~140@))) (Mul (Mul (Mul d17~144@ c17~142@) b17~140@) (Mul (Mul a17~138@ a17~138@) b17~140@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2903@ temp_17_1~2960@))) (=> (= temp_17_0~2903@ temp_17_1~2960@) (=> (= temp_18_0~3061@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Mul d18~152@ c18~150@)) (Mul (Mul d18~152@ 51) (Mul d18~152@ d18~152@))) (Mul (Mul (Mul c18~150@ b18~148@) (Mul a18~146@ a18~146@)) (Sub (Mul c18~150@ a18~146@) (Sub a18~146@ d18~152@))))) (=> (= temp_18_1~3138@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Mul d18~152@ c18~150@)) (Mul (Mul d18~152@ 51) (Mul d18~152@ d18~152@))) (Mul (Mul (Mul c18~150@ b18~148@) (Mul a18~146@ a18~146@)) (Sub (Mul a18~146@ c18~150@) (Sub a18~146@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3061@ temp_18_1~3138@))) (=> (= temp_18_0~3061@ temp_18_1~3138@) (=> (= temp_19_0~3227@ (Sub (Mul (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ c19~158@)) (Mul (Mul b19~156@ c19~158@) (Mul d19~160@ d19~160@))) (Mul (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ a19~154@)) (Mul (Mul d19~160@ b19~156@) (Mul b19~156@ a19~154@))))) (=> (= temp_19_1~3292@ (Sub (Mul (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ c19~158@)) (Mul (Mul b19~156@ c19~158@) (Mul d19~160@ d19~160@))) (Mul (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ a19~154@)) (Mul (Mul (Mul d19~160@ b19~156@) b19~156@) a19~154@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3227@ temp_19_1~3292@))) (=> (= temp_19_0~3227@ temp_19_1~3292@) (=> (= temp_20_0~3381@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Mul c20~166@ d20~168@)) (Mul (Mul a20~162@ c20~166@) (Mul b20~164@ d20~168@))) (Mul (Mul (Mul d20~168@ d20~168@) (Mul c20~166@ a20~162@)) 56))) (=> (= temp_20_1~3446@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Mul c20~166@ d20~168@)) (Mul (Mul a20~162@ c20~166@) (Mul b20~164@ d20~168@))) (Mul (Mul (Mul d20~168@ d20~168@) (Mul c20~166@ a20~162@)) 56))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3381@ temp_20_1~3446@))) (=> (= temp_20_0~3381@ temp_20_1~3446@) (=> (= temp_21_0~3515@ (Mul (Add (Mul (Mul d21~176@ b21~172@) a21~170@) (Mul (Mul 53 a21~170@) (Mul b21~172@ d21~176@))) d21~176@)) (=> (= temp_21_1~3560@ (Mul d21~176@ (Add (Mul (Mul d21~176@ b21~172@) a21~170@) (Mul (Mul 53 a21~170@) (Mul b21~172@ d21~176@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3515@ temp_21_1~3560@))) (=> (= temp_21_0~3515@ temp_21_1~3560@) (=> (= temp_22_0~3649@ (Mul (Mul (Mul (Mul c22~182@ a22~178@) (Mul d22~184@ b22~180@)) (Mul (Mul a22~178@ d22~184@) (Sub d22~184@ a22~178@))) (Mul (Mul (Mul b22~180@ c22~182@) (Mul a22~178@ c22~182@)) (Add (Add c22~182@ b22~180@) (Mul d22~184@ c22~182@))))) (=> (= temp_22_1~3730@ (Mul (Mul (Mul (Mul c22~182@ a22~178@) (Mul d22~184@ b22~180@)) (Mul (Mul a22~178@ d22~184@) (Sub d22~184@ a22~178@))) (Add (Mul (Mul (Mul b22~180@ c22~182@) (Mul a22~178@ c22~182@)) (Add c22~182@ b22~180@)) (Mul (Mul (Mul b22~180@ c22~182@) (Mul a22~178@ c22~182@)) (Mul d22~184@ c22~182@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3649@ temp_22_1~3730@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
