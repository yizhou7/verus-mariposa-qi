...
a19: int, b19: int, c19: int, d19: int)
{
	...
	let temp_13_0 = ((((b13+(b13*a13))-((b13*d13)*(a13-c13)))*(((b13*c13)*(c13*b13))*((c13+d13)*(c13*a13))))-((((c13*d13)*(d13*c13))*((a13*c13)*(c13*c13)))*(a13+((b13*b13)*(b13*a13)))));
	let temp_13_1 = ((((b13+(a13*b13))-((b13*d13)*(a13-c13)))*(((b13*c13)*(c13*b13))*((c13+d13)*(c13*a13))))-((((c13*d13)*(d13*c13))*((a13*c13)*(c13*c13)))*(a13+((b13*b13)*(b13*a13)))));
	assert(temp_13_0 == temp_13_1);
	let temp_14_0 = (((((c14-a14)+(b14*a14))-(c14-(d14*b14)))*(((d14*c14)-(c14*c14))*((d14*b14)*(b14*c14))))*((((b14*d14)*(d14*b14))*((b14*b14)-(c14+c14)))*(((c14*b14)*(c14+c14))*((d14*b14)*(c14*d14)))));
	let temp_14_1 = (((((c14-a14)+(b14*a14))-(c14-(d14*b14)))*(((d14*c14)-(c14*c14))*((d14*b14)*(b14*c14))))*(((((b14*d14)*(d14*b14))*((b14*b14)-(c14+c14)))*((c14*b14)*(c14+c14)))*((d14*b14)*(c14*d14))));
