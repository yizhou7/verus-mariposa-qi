...
(set-info :comment ";; mariposa_data/v_nl//3322844657195306459/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Mul (Mul a0~2@ (Mul b0~4@ b0~4@)) (Mul (Sub a0~2@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@)) (Add (Mul 21 b0~4@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~386@ (Mul (Mul (Mul a0~2@ (Mul b0~4@ b0~4@)) (Mul (Sub a0~2@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Add b0~4@ b0~4@) (Mul (Mul d0~8@ a0~2@) (Add (Mul 21 b0~4@) (Mul d0~8@ c0~6@)))))) (and (=> (= tmp%1@ (Add b0~4@ b0~4@)) (=> (= tmp%2@ (Mul d0~8@ a0~2@)) (=> (= tmp%3@ (Add (Mul 21 b0~4@) (Mul d0~8@ c0~6@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~386@)))))) (=> (= temp_0_0~313@ temp_0_1~386@) (=> (= temp_1_0~509@ (Mul (Add (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@))) (Sub (Add (Mul b1~12@ a1~10@) b1~12@) (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@))))) (=> (= temp_1_1~570@ (Mul (Add (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@))) (Sub (Add (Mul b1~12@ a1~10@) b1~12@) (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@))))) (and (=> (= tmp%4@ (Mul a1~10@ a1~10@)) (=> (= tmp%5@ (Mul a1~10@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~509@ temp_1_1~570@))))) (=> (= temp_1_0~509@ temp_1_1~570@) (=> (= temp_2_0~683@ (Mul (Sub (Mul (Sub b2~20@ d2~24@) (Mul d2~24@ a2~18@)) (Sub (Mul c2~22@ c2~22@) (Mul a2~18@ 5))) (Mul (Mul (Add b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~760@ (Mul (Sub (Mul (Sub b2~20@ d2~24@) (Mul d2~24@ a2~18@)) (Sub (Mul c2~22@ c2~22@) (Mul a2~18@ 5))) (Mul (Mul (Mul b2~20@ a2~18@) (Add b2~20@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ a2~18@))))) (and (=> (= tmp%6@ (Add b2~20@ a2~18@)) (=> (= tmp%7@ (Mul b2~20@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~683@ temp_2_1~760@))))) (=> (= temp_2_0~683@ temp_2_1~760@) (=> (= temp_3_0~861@ (Add (Mul (Mul (Sub b3~28@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ d3~32@) (Add b3~28@ a3~26@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~926@ (Add (Mul (Mul (Sub b3~28@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ d3~32@) (Add b3~28@ a3~26@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul (Mul d3~32@ a3~26@) d3~32@) c3~30@)))) (and (=> (= tmp%8@ (Mul d3~32@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ d3~32@ c3~30@) (=> %%location_label%%3 (= temp_3_0~861@ temp_3_1~926@)))) (=> (= temp_3_0~861@ temp_3_1~926@) (=> (= temp_4_0~1025@ (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Add a4~34@ c4~38@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul c4~38@ b4~36@) (Add a4~34@ c4~38@)) (Add (Mul b4~36@ b4~36@) (Sub c4~38@ a4~34@))))) (=> (= temp_4_1~1090@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Add a4~34@ c4~38@)) (Add (Mul b4~36@ b4~36@) (Sub c4~38@ a4~34@))) (Mul (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Add a4~34@ c4~38@) (Mul a4~34@ b4~36@))))) (and (=> (= tmp%9@ (Mul (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Add a4~34@ c4~38@) (Mul a4~34@ b4~36@)))) (=> (= tmp%10@ (Mul (Mul (Mul c4~38@ b4~36@) (Add a4~34@ c4~38@)) (Add (Mul b4~36@ b4~36@) (Sub c4~38@ a4~34@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%4 (= temp_4_0~1025@ temp_4_1~1090@))))) (=> (= temp_4_0~1025@ temp_4_1~1090@) (=> (= temp_5_0~1235@ (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ d5~48@)) (Add (Mul d5~48@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul a5~42@ (Mul b5~44@ b5~44@)) (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ a5~42@))))) (=> (= temp_5_1~1296@ (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ d5~48@)) (Add (Mul d5~48@ a5~42@) (Mul c5~46@ d5~48@))) (Mul a5~42@ (Mul (Mul b5~44@ b5~44@) (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ a5~42@)))))) (and (=> (= tmp%11@ (Mul b5~44@ b5~44@)) (=> (= tmp%12@ (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. a5~42@ tmp%11@ tmp%12@) (=> %%location_label%%5 (= temp_5_0~1235@ temp_5_1~1296@))))) (=> (= temp_5_0~1235@ temp_5_1~1296@) (=> (= temp_6_0~1407@ (Sub (Sub (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@)) d6~56@) (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ d6~56@)) (Mul (Sub c6~54@ 66) (Mul a6~50@ c6~54@))))) (=> (= temp_6_1~1472@ (Sub (Sub (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@)) d6~56@) (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ d6~56@)) (Mul (Mul (Sub c6~54@ 66) a6~50@) c6~54@)))) (and (=> (= tmp%13@ (Sub c6~54@ 66)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ a6~50@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1407@ temp_6_1~1472@)))) (=> (= temp_6_0~1407@ temp_6_1~1472@) (=> (= temp_7_0~1595@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@)) (Sub (Mul b7~60@ 79) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1672@ (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ a7~58@)) (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ c7~62@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@)) (Sub (Mul b7~60@ 79) (Mul b7~60@ b7~60@))))) (and (=> (= tmp%14@ (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ c7~62@))) (=> (= tmp%15@ (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ a7~58@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%7 (= temp_7_0~1595@ temp_7_1~1672@))))) (=> (= temp_7_0~1595@ temp_7_1~1672@) (=> (= temp_8_0~1789@ (Mul (Mul (Mul (Add d8~72@ d8~72@) (Mul b8~68@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@))) (Sub (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ b8~68@)) (Sub (Mul d8~72@ a8~66@) (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1854@ (Mul (Mul (Mul (Add d8~72@ d8~72@) (Mul b8~68@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ d8~72@))) (Sub (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ b8~68@)) (Sub (Mul d8~72@ a8~66@) (Mul b8~68@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d8~72@ a8~66@) (=> %%location_label%%8 (= temp_8_0~1789@ temp_8_1~1854@))) (=> (= temp_8_0~1789@ temp_8_1~1854@) (=> (= temp_9_0~1931@ (Mul (Mul (Mul (Mul a9~74@ d9~80@) (Add a9~74@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ d9~80@))) (Mul (Mul b9~76@ (Add c9~78@ d9~80@)) a9~74@))) (=> (= temp_9_1~1980@ (Mul (Mul (Mul (Mul a9~74@ d9~80@) (Add a9~74@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ d9~80@))) (Mul b9~76@ (Mul (Add c9~78@ d9~80@) a9~74@)))) (and (=> (= tmp%16@ (Add c9~78@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b9~76@ tmp%16@ a9~74@) (=> %%location_label%%9 (= temp_9_0~1931@ temp_9_1~1980@)))) (=> (= temp_9_0~1931@ temp_9_1~1980@) (=> (= temp_10_0~2067@ (Mul (Mul (Mul (Add c10~86@ d10~88@) (Mul b10~84@ c10~86@)) (Sub (Sub a10~82@ a10~82@) (Mul c10~86@ b10~84@))) (Mul d10~88@ (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@))))) (=> (= temp_10_1~2120@ (Mul (Mul (Mul (Add c10~86@ d10~88@) (Mul b10~84@ c10~86@)) (Sub (Sub a10~82@ a10~82@) (Mul c10~86@ b10~84@))) (Mul (Mul d10~88@ (Mul c10~86@ b10~84@)) (Mul d10~88@ d10~88@)))) (=> (= tmp%17@ (Mul c10~86@ b10~84@)) (=> (= tmp%18@ (Mul d10~88@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d10~88@ tmp%17@ tmp%18@) (=> %%location_label%%10 (= temp_10_0~2067@ temp_10_1~2120@))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
