...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Sub (Mul c0~6@ d0~8@) (Add a0~2@ d0~8@)) (Add (Mul d0~8@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Add b0~4@ b0~4@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Sub (Mul c0~6@ d0~8@) (Add a0~2@ d0~8@)) (Add (Mul d0~8@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Add b0~4@ b0~4@) (Mul a0~2@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~450@ (Mul (Sub (Mul (Add a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Sub b1~12@ c1~14@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~547@ (Sub (Mul (Mul (Add a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@)))) (Mul (Mul (Sub b1~12@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@)))))) (=> (= tmp%2@ (= temp_1_0~450@ temp_1_1~547@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~627@ (Sub (Mul (Mul (Add a2~18@ b2~20@) (Add a2~18@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Add (Mul c2~22@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Add b2~20@ b2~20@))))) (=> (= temp_2_1~688@ (Sub (Mul (Mul (Add a2~18@ b2~20@) (Add a2~18@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul (Add c2~22@ b2~20@) a2~18@) (Mul (Mul b2~20@ a2~18@) (Add b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~627@ temp_2_1~688@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~740@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@))) b3~28@)) (=> (= temp_3_1~777@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@))) b3~28@)) (=> (= tmp%4@ (= temp_3_0~740@ temp_3_1~777@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~829@ (Sub (Mul (Mul (Mul c4~38@ d4~40@) (Sub c4~38@ d4~40@)) a4~34@) (Mul (Mul b4~36@ (Mul a4~34@ a4~34@)) d4~40@))) (=> (= temp_4_1~874@ (Sub (Mul (Sub (Mul (Mul c4~38@ d4~40@) c4~38@) (Mul (Mul c4~38@ d4~40@) d4~40@)) a4~34@) (Mul (Mul b4~36@ (Mul a4~34@ a4~34@)) d4~40@))) (=> (= tmp%5@ (= temp_4_0~829@ temp_4_1~874@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~938@ (Mul (Sub (Sub (Mul c5~46@ d5~48@) (Mul b5~44@ a5~42@)) (Mul (Mul b5~44@ 40) (Sub d5~48@ b5~44@))) c5~46@)) (=> (= temp_5_1~1007@ (Mul (Sub (Sub (Mul c5~46@ d5~48@) (Mul b5~44@ a5~42@)) (Sub (Mul (Mul b5~44@ 40) d5~48@) (Mul (Mul b5~44@ 40) b5~44@))) c5~46@)) (=> (= tmp%6@ (= temp_5_0~938@ temp_5_1~1007@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1099@ (Add (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ b6~52@)) (Add (Mul 73 a6~50@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1176@ (Add (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ b6~52@)) (Add (Mul 73 a6~50@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1099@ temp_6_1~1176@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1264@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ d7~64@) a7~58@)) (Add (Mul (Mul 49 a7~58@) (Mul c7~62@ d7~64@)) (Add (Sub d7~64@ d7~64@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1365@ (Add (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ d7~64@) a7~58@)) (Mul (Mul 49 a7~58@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ d7~64@) a7~58@)) (Add (Sub d7~64@ d7~64@) (Mul d7~64@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1264@ temp_7_1~1365@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1453@ (Mul (Mul (Mul (Mul a8~66@ 20) (Mul d8~72@ b8~68@)) (Sub (Mul b8~68@ d8~72@) (Add a8~66@ c8~70@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ c8~70@) b8~68@)))) (=> (= temp_8_1~1526@ (Mul (Mul (Mul (Mul a8~66@ 20) (Mul d8~72@ b8~68@)) (Sub (Mul b8~68@ d8~72@) (Add a8~66@ c8~70@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@)) (Mul b8~68@ (Mul a8~66@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1453@ temp_8_1~1526@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1606@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))) (Mul (Sub (Mul b9~76@ d9~80@) (Mul b9~76@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ b9~76@))))) (=> (= temp_9_1~1671@ (Mul (Mul (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))) (Mul (Sub (Mul b9~76@ d9~80@) (Mul b9~76@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ b9~76@))))) (=> (= tmp%10@ (= temp_9_0~1606@ temp_9_1~1671@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1747@ (Mul (Sub (Mul (Mul c10~86@ d10~88@) (Sub b10~84@ b10~84@)) (Mul (Mul c10~86@ c10~86@) d10~88@)) (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ a10~82@)) (Mul (Add d10~88@ a10~82@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~1808@ (Mul (Sub (Mul (Mul c10~86@ d10~88@) (Sub b10~84@ b10~84@)) (Mul c10~86@ (Mul c10~86@ d10~88@))) (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ a10~82@)) (Mul (Add d10~88@ a10~82@) (Mul c10~86@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1747@ temp_10_1~1808@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1872@ (Mul (Mul a11~90@ (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))) (Mul (Mul (Mul b11~92@ a11~90@) d11~96@) (Add (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~1921@ (Mul (Mul a11~90@ (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))) (Mul (Mul b11~92@ (Mul a11~90@ d11~96@)) (Add (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1872@ temp_11_1~1921@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1989@ (Mul (Mul d12~104@ (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ a12~98@))) (Mul (Mul (Add d12~104@ a12~98@) (Mul d12~104@ d12~104@)) (Sub (Mul a12~98@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2042@ (Mul (Mul d12~104@ (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ a12~98@))) (Mul (Mul (Mul d12~104@ d12~104@) (Add d12~104@ a12~98@)) (Sub (Mul a12~98@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= tmp%13@ (= temp_12_0~1989@ temp_12_1~2042@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2094@ (Mul a13~106@ (Mul (Sub (Mul c13~110@ c13~110@) (Mul b13~108@ b13~108@)) (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ a13~106@))))) (=> (= temp_13_1~2147@ (Mul a13~106@ (Sub (Mul (Mul c13~110@ c13~110@) (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ a13~106@))) (Mul (Mul b13~108@ b13~108@) (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ a13~106@)))))) (=> (= tmp%14@ (= temp_13_0~2094@ temp_13_1~2147@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2235@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ b14~116@)) (Mul (Mul d14~120@ a14~114@) (Mul c14~118@ d14~120@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul b14~116@ b14~116@)) (Mul (Mul a14~114@ 8) b14~116@)))) (=> (= temp_14_1~2308@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ b14~116@)) (Mul (Mul d14~120@ a14~114@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul b14~116@ b14~116@)) (Mul (Mul a14~114@ 8) b14~116@)))) (=> (= tmp%15@ (= temp_14_0~2235@ temp_14_1~2308@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2388@ (Mul (Add (Mul (Add b15~124@ c15~126@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ a15~122@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ b15~124@)) (Mul (Sub b15~124@ d15~128@) (Add c15~126@ d15~128@))))) (=> (= temp_15_1~2453@ (Mul (Add (Mul (Add b15~124@ c15~126@) (Mul c15~126@ c15~126@)) (Mul (Mul b15~124@ d15~128@) (Mul c15~126@ a15~122@))) (Mul (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ b15~124@)) (Mul (Sub b15~124@ d15~128@) (Add c15~126@ d15~128@))))) (=> (= tmp%16@ (= temp_15_0~2388@ temp_15_1~2453@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2541@ (Mul (Add (Mul (Sub c16~134@ b16~132@) (Mul c16~134@ b16~132@)) (Mul (Add c16~134@ a16~130@) (Sub a16~130@ 70))) (Mul (Mul b16~132@ (Mul c16~134@ a16~130@)) (Sub (Mul d16~136@ a16~130@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2614@ (Mul (Add (Mul (Sub c16~134@ b16~132@) (Mul c16~134@ b16~132@)) (Mul (Sub a16~130@ 70) (Add c16~134@ a16~130@))) (Mul (Mul b16~132@ (Mul c16~134@ a16~130@)) (Sub (Mul d16~136@ a16~130@) (Mul c16~134@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2541@ temp_16_1~2614@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2706@ (Sub (Mul (Sub (Mul 16 d17~144@) (Mul d17~144@ b17~140@)) (Sub (Add a17~138@ c17~142@) (Mul 21 d17~144@))) (Mul (Mul (Sub a17~138@ b17~140@) (Mul d17~144@ d17~144@)) c17~142@))) (=> (= temp_17_1~2783@ (Sub (Mul (Sub (Mul 16 d17~144@) (Mul d17~144@ b17~140@)) (Sub (Add a17~138@ c17~142@) (Mul 21 d17~144@))) (Mul (Mul (Mul d17~144@ d17~144@) (Sub a17~138@ b17~140@)) c17~142@))) (=> (= tmp%18@ (= temp_17_0~2706@ temp_17_1~2783@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2863@ (Mul (Sub (Mul (Sub b18~148@ a18~146@) (Mul d18~152@ b18~148@)) (Mul (Mul a18~146@ c18~150@) (Sub d18~152@ c18~150@))) (Mul (Add (Sub b18~148@ b18~148@) (Mul b18~148@ d18~152@)) (Mul (Mul c18~150@ d18~152@) (Mul a18~146@ a18~146@))))) (=> (= temp_18_1~2928@ (Mul (Mul (Sub (Mul (Sub b18~148@ a18~146@) (Mul d18~152@ b18~148@)) (Mul (Mul a18~146@ c18~150@) (Sub d18~152@ c18~150@))) (Add (Sub b18~148@ b18~148@) (Mul b18~148@ d18~152@))) (Mul (Mul c18~150@ d18~152@) (Mul a18~146@ a18~146@)))) (=> (= tmp%19@ (= temp_18_0~2863@ temp_18_1~2928@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2996@ (Mul (Mul a19~154@ (Mul (Add d19~160@ b19~156@) (Mul c19~158@ c19~158@))) (Mul (Sub (Mul c19~158@ d19~160@) (Sub d19~160@ a19~154@)) (Add (Mul d19~160@ b19~156@) (Mul c19~158@ a19~154@))))) (=> (= temp_19_1~3049@ (Mul (Mul a19~154@ (Mul (Add d19~160@ b19~156@) (Mul c19~158@ c19~158@))) (Mul (Add (Mul d19~160@ b19~156@) (Mul c19~158@ a19~154@)) (Sub (Mul c19~158@ d19~160@) (Sub d19~160@ a19~154@))))) (=> (= tmp%20@ (= temp_19_0~2996@ temp_19_1~3049@)) (=> %%location_label%%19 tmp%20@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
