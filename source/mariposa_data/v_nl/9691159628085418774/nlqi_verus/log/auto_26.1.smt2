...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Sub (Mul (Mul d0~8@ c0~6@) (Add b0~4@ a0~2@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul c0~6@ c0~6@) (Sub c0~6@ c0~6@)) (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~378@ (Mul (Sub (Add (Mul (Mul d0~8@ c0~6@) b0~4@) (Mul (Mul d0~8@ c0~6@) a0~2@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul c0~6@ c0~6@) (Sub c0~6@ c0~6@)) (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~378@))) (=> (= temp_0_0~305@ temp_0_1~378@) (=> (= temp_1_0~479@ (Mul (Sub (Mul (Sub b1~12@ c1~14@) (Mul c1~14@ c1~14@)) (Add (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul 8 b1~12@) (Sub b1~12@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~564@ (Mul (Sub (Sub (Mul b1~12@ (Mul c1~14@ c1~14@)) (Mul c1~14@ (Mul c1~14@ c1~14@))) (Add (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul 8 b1~12@) (Sub b1~12@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~479@ temp_1_1~564@))) (=> (= temp_1_0~479@ temp_1_1~564@) (=> (= temp_2_0~649@ (Mul (Mul (Sub (Mul d2~24@ d2~24@) (Add b2~20@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Sub (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@)) (Mul (Sub d2~24@ a2~18@) b2~20@)))) (=> (= temp_2_1~710@ (Mul (Mul (Sub (Mul d2~24@ d2~24@) (Add b2~20@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Sub (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ b2~20@)) (Mul (Sub d2~24@ a2~18@) b2~20@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~649@ temp_2_1~710@))) (=> (= temp_2_0~649@ temp_2_1~710@) (=> (= temp_3_0~823@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul 77 c3~30@) (Mul a3~26@ b3~28@))) (Sub (Mul (Mul b3~28@ a3~26@) (Mul 12 c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~912@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul 77 c3~30@))) (Sub (Mul (Mul b3~28@ a3~26@) (Mul 12 c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~823@ temp_3_1~912@))) (=> (= temp_3_0~823@ temp_3_1~912@) (=> (= temp_4_0~1009@ (Add (Mul (Add (Sub b4~36@ b4~36@) d4~40@) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ 40))))) (=> (= temp_4_1~1082@ (Add (Mul (Add (Sub b4~36@ b4~36@) d4~40@) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul (Mul a4~34@ d4~40@) a4~34@) 40)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~1009@ temp_4_1~1082@))) (=> (= temp_4_0~1009@ temp_4_1~1082@) (=> (= temp_5_0~1183@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ 78)) (Sub (Mul a5~42@ d5~48@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1260@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ 78)) (Sub (Mul a5~42@ d5~48@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1183@ temp_5_1~1260@))) (=> (= temp_5_0~1183@ temp_5_1~1260@) (=> (= temp_6_0~1361@ (Mul (Add (Sub (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Sub c6~54@ b6~52@) (Mul a6~50@ c6~54@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ c6~54@)) (Mul (Sub a6~50@ 30) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1438@ (Mul (Add (Sub (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Sub c6~54@ b6~52@) (Mul a6~50@ c6~54@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ c6~54@)) (Mul (Sub a6~50@ 30) (Mul c6~54@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1361@ temp_6_1~1438@))) (=> (= temp_6_0~1361@ temp_6_1~1438@) (=> (= temp_7_0~1515@ (Add (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ a7~58@))) (Add (Mul (Mul d7~64@ b7~60@) (Sub d7~64@ a7~58@)) a7~58@))) (=> (= temp_7_1~1568@ (Add (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ a7~58@))) (Add (Mul d7~64@ (Mul b7~60@ (Sub d7~64@ a7~58@))) a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1515@ temp_7_1~1568@))) (=> (= temp_7_0~1515@ temp_7_1~1568@) (=> (= temp_8_0~1641@ (Add (Mul (Mul a8~66@ (Sub c8~70@ c8~70@)) b8~68@) (Mul (Sub (Mul a8~66@ d8~72@) (Mul b8~68@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1690@ (Add (Mul (Mul a8~66@ (Sub c8~70@ c8~70@)) b8~68@) (Mul (Sub (Mul a8~66@ d8~72@) (Mul a8~66@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1641@ temp_8_1~1690@))) (=> (= temp_8_0~1641@ temp_8_1~1690@) (=> (= temp_9_0~1779@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ c9~78@)) (Add (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@))) (Sub (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1844@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Mul c9~78@ b9~76@)) (Add (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@))) (Sub (Mul (Mul a9~74@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Mul a9~74@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1779@ temp_9_1~1844@))) (=> (= temp_9_0~1779@ temp_9_1~1844@) (=> (= temp_10_0~1925@ (Sub (Mul (Mul a10~82@ (Mul d10~88@ c10~86@)) (Sub (Mul d10~88@ d10~88@) (Mul b10~84@ b10~84@))) (Mul (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Sub a10~82@ b10~84@) b10~84@)))) (=> (= temp_10_1~1982@ (Sub (Mul (Mul a10~82@ (Mul d10~88@ c10~86@)) (Sub (Mul d10~88@ d10~88@) (Mul b10~84@ b10~84@))) (Mul (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Sub a10~82@ b10~84@) b10~84@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1925@ temp_10_1~1982@))) (=> (= temp_10_0~1925@ temp_10_1~1982@) (=> (= temp_11_0~2071@ (Mul (Mul (Mul (Mul d11~96@ d11~96@) (Sub b11~92@ b11~92@)) (Mul (Add c11~94@ b11~92@) (Mul c11~94@ a11~90@))) (Mul (Mul (Mul c11~94@ c11~94@) (Add d11~96@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Sub c11~94@ b11~92@))))) (=> (= temp_11_1~2136@ (Mul (Mul (Mul d11~96@ d11~96@) (Sub b11~92@ b11~92@)) (Mul (Mul (Add c11~94@ b11~92@) (Mul c11~94@ a11~90@)) (Mul (Mul (Mul c11~94@ c11~94@) (Add d11~96@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Sub c11~94@ b11~92@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2071@ temp_11_1~2136@))) (=> (= temp_11_0~2071@ temp_11_1~2136@) (=> (= temp_12_0~2237@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Mul a12~98@ d12~104@)) (Sub (Add c12~102@ b12~100@) (Mul a12~98@ b12~100@))) (Mul (Mul (Sub a12~98@ b12~100@) (Mul d12~104@ 65)) (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ b12~100@))))) (=> (= temp_12_1~2334@ (Mul (Mul (Mul (Mul d12~104@ a12~98@) (Mul a12~98@ d12~104@)) (Sub (Add c12~102@ b12~100@) (Mul a12~98@ b12~100@))) (Mul (Sub (Mul a12~98@ (Mul d12~104@ 65)) (Mul b12~100@ (Mul d12~104@ 65))) (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2237@ temp_12_1~2334@))) (=> (= temp_12_0~2237@ temp_12_1~2334@) (=> (= temp_13_0~2419@ (Add (Mul (Mul (Mul d13~112@ d13~112@) (Sub b13~108@ a13~106@)) (Mul (Mul b13~108@ b13~108@) d13~112@)) (Mul (Mul (Sub c13~110@ b13~108@) (Mul d13~112@ b13~108@)) (Mul (Mul c13~110@ a13~106@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2480@ (Add (Mul (Mul (Mul d13~112@ d13~112@) (Sub b13~108@ a13~106@)) (Mul (Mul b13~108@ b13~108@) d13~112@)) (Mul (Mul (Sub c13~110@ b13~108@) (Mul d13~112@ b13~108@)) (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2419@ temp_13_1~2480@))) (=> (= temp_13_0~2419@ temp_13_1~2480@) (=> (= temp_14_0~2569@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ d14~120@) (Mul a14~114@ a14~114@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ b14~116@))))) (=> (= temp_14_1~2634@ (Mul (Mul (Mul (Mul b14~116@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ b14~116@))) (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ d14~120@) (Mul a14~114@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2569@ temp_14_1~2634@))) (=> (= temp_14_0~2569@ temp_14_1~2634@) (=> (= temp_15_0~2723@ (Sub (Mul (Add (Mul b15~124@ a15~122@) (Mul d15~128@ d15~128@)) (Mul (Sub c15~126@ b15~124@) (Mul c15~126@ b15~124@))) (Mul (Mul (Sub b15~124@ a15~122@) (Mul c15~126@ b15~124@)) (Add (Sub d15~128@ a15~122@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2788@ (Sub (Mul (Mul (Sub c15~126@ b15~124@) (Mul c15~126@ b15~124@)) (Add (Mul b15~124@ a15~122@) (Mul d15~128@ d15~128@))) (Mul (Mul (Sub b15~124@ a15~122@) (Mul c15~126@ b15~124@)) (Add (Sub d15~128@ a15~122@) (Mul d15~128@ d15~128@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2723@ temp_15_1~2788@))) (=> (= temp_15_0~2723@ temp_15_1~2788@) (=> (= temp_16_0~2861@ (Mul (Mul (Mul (Mul c16~134@ c16~134@) c16~134@) (Mul (Add c16~134@ d16~136@) (Mul c16~134@ d16~136@))) (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ b16~132@)) d16~136@))) (=> (= temp_16_1~2910@ (Mul (Mul (Mul (Mul c16~134@ c16~134@) c16~134@) (Mul (Add c16~134@ d16~136@) (Mul c16~134@ d16~136@))) (Mul (Mul (Mul d16~136@ d16~136@) (Mul c16~134@ b16~132@)) d16~136@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2861@ temp_16_1~2910@))) (=> (= temp_16_0~2861@ temp_16_1~2910@) (=> (= temp_17_0~2999@ (Mul (Mul (Mul (Mul b17~140@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Mul c17~142@ a17~138@) (Mul d17~144@ b17~140@))) (Mul (Mul (Add b17~140@ c17~142@) (Sub a17~138@ b17~140@)) (Mul (Mul d17~144@ a17~138@) (Mul b17~140@ a17~138@))))) (=> (= temp_17_1~3064@ (Mul (Mul (Mul (Mul b17~140@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Mul c17~142@ a17~138@) (Mul b17~140@ d17~144@))) (Mul (Mul (Add b17~140@ c17~142@) (Sub a17~138@ b17~140@)) (Mul (Mul d17~144@ a17~138@) (Mul b17~140@ a17~138@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2999@ temp_17_1~3064@))) (=> (= temp_17_0~2999@ temp_17_1~3064@) (=> (= temp_18_0~3145@ (Mul (Mul (Mul (Mul d18~152@ d18~152@) (Mul b18~148@ d18~152@)) (Mul b18~148@ (Mul a18~146@ c18~150@))) (Mul (Sub (Add d18~152@ b18~148@) b18~148@) (Mul (Add b18~148@ a18~146@) (Mul a18~146@ c18~150@))))) (=> (= temp_18_1~3218@ (Mul (Mul (Mul (Mul d18~152@ d18~152@) (Mul b18~148@ d18~152@)) (Mul b18~148@ (Mul a18~146@ c18~150@))) (Sub (Mul (Add d18~152@ b18~148@) (Mul (Add b18~148@ a18~146@) (Mul a18~146@ c18~150@))) (Mul b18~148@ (Mul (Add b18~148@ a18~146@) (Mul a18~146@ c18~150@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3145@ temp_18_1~3218@))) (=> (= temp_18_0~3145@ temp_18_1~3218@) (=> (= temp_19_0~3303@ (Mul (Add (Add (Mul c19~158@ d19~160@) (Sub b19~156@ a19~154@)) (Mul (Mul a19~154@ d19~160@) (Mul b19~156@ b19~156@))) (Add (Mul c19~158@ (Mul a19~154@ a19~154@)) (Mul (Sub b19~156@ b19~156@) (Mul d19~160@ d19~160@))))) (=> (= temp_19_1~3364@ (Mul (Add (Add (Mul c19~158@ d19~160@) (Sub b19~156@ a19~154@)) (Mul (Mul a19~154@ d19~160@) (Mul b19~156@ b19~156@))) (Add (Mul c19~158@ (Mul a19~154@ a19~154@)) (Mul (Mul (Sub b19~156@ b19~156@) d19~160@) d19~160@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3303@ temp_19_1~3364@))) (=> (= temp_19_0~3303@ temp_19_1~3364@) (=> (= temp_20_0~3461@ (Mul (Mul (Mul (Mul b20~164@ a20~162@) (Mul b20~164@ a20~162@)) (Mul (Mul b20~164@ a20~162@) (Mul 75 b20~164@))) (Mul (Mul c20~166@ (Mul a20~162@ d20~168@)) (Mul (Mul d20~168@ a20~162@) (Mul a20~162@ b20~164@))))) (=> (= temp_20_1~3534@ (Mul (Mul (Mul (Mul b20~164@ a20~162@) (Mul b20~164@ a20~162@)) (Mul (Mul b20~164@ a20~162@) (Mul 75 b20~164@))) (Mul (Mul c20~166@ (Mul a20~162@ d20~168@)) (Mul (Mul a20~162@ d20~168@) (Mul a20~162@ b20~164@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3461@ temp_20_1~3534@))) (=> (= temp_20_0~3461@ temp_20_1~3534@) (=> (= temp_21_0~3631@ (Sub (Mul (Mul (Mul b21~172@ a21~170@) (Mul b21~172@ d21~176@)) (Mul (Mul d21~176@ a21~170@) (Mul a21~170@ 13))) (Add (Sub (Mul d21~176@ d21~176@) (Sub a21~170@ d21~176@)) (Sub (Mul c21~174@ b21~172@) a21~170@)))) (=> (= temp_21_1~3704@ (Sub (Mul (Mul (Mul a21~170@ b21~172@) (Mul b21~172@ d21~176@)) (Mul (Mul d21~176@ a21~170@) (Mul a21~170@ 13))) (Add (Sub (Mul d21~176@ d21~176@) (Sub a21~170@ d21~176@)) (Sub (Mul c21~174@ b21~172@) a21~170@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3631@ temp_21_1~3704@))) (=> (= temp_21_0~3631@ temp_21_1~3704@) (=> (= temp_22_0~3789@ (Mul (Mul (Add (Mul c22~182@ c22~182@) (Mul a22~178@ a22~178@)) (Mul (Mul c22~182@ d22~184@) (Mul c22~182@ d22~184@))) (Mul (Mul a22~178@ (Mul b22~180@ a22~178@)) (Mul (Add d22~184@ b22~180@) (Mul b22~180@ d22~184@))))) (=> (= temp_22_1~3850@ (Mul (Mul (Add (Mul c22~182@ c22~182@) (Mul a22~178@ a22~178@)) (Mul (Mul c22~182@ d22~184@) (Mul c22~182@ d22~184@))) (Mul (Mul a22~178@ (Mul b22~180@ a22~178@)) (Mul (Add d22~184@ b22~180@) (Mul b22~180@ d22~184@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3789@ temp_22_1~3850@))) (=> (= temp_22_0~3789@ temp_22_1~3850@) (=> (= temp_23_0~3951@ (Mul (Mul (Mul (Mul c23~190@ b23~188@) (Mul c23~190@ b23~188@)) (Mul (Sub b23~188@ b23~188@) (Mul 45 c23~190@))) (Add (Sub (Mul c23~190@ c23~190@) (Mul b23~188@ a23~186@)) (Mul (Mul b23~188@ d23~192@) (Mul b23~188@ b23~188@))))) (=> (= temp_23_1~4028@ (Mul (Mul (Mul c23~190@ b23~188@) (Mul c23~190@ b23~188@)) (Mul (Mul (Sub b23~188@ b23~188@) (Mul 45 c23~190@)) (Add (Sub (Mul c23~190@ c23~190@) (Mul b23~188@ a23~186@)) (Mul (Mul b23~188@ d23~192@) (Mul b23~188@ b23~188@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3951@ temp_23_1~4028@))) (=> (= temp_23_0~3951@ temp_23_1~4028@) (=> (= temp_24_0~4109@ (Mul (Mul (Mul (Mul c24~198@ a24~194@) a24~194@) (Mul (Mul c24~198@ c24~198@) c24~198@)) (Add (Add (Mul b24~196@ a24~194@) (Mul c24~198@ a24~194@)) (Mul (Mul c24~198@ c24~198@) (Mul c24~198@ a24~194@))))) (=> (= temp_24_1~4162@ (Mul (Mul (Mul (Mul c24~198@ a24~194@) a24~194@) (Mul (Mul c24~198@ c24~198@) c24~198@)) (Add (Mul (Add b24~196@ c24~198@) a24~194@) (Mul (Mul c24~198@ c24~198@) (Mul c24~198@ a24~194@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~4109@ temp_24_1~4162@))) (=> (= temp_24_0~4109@ temp_24_1~4162@) (=> (= temp_25_0~4251@ (Sub (Sub (Mul (Mul c25~206@ d25~208@) (Mul b25~204@ b25~204@)) (Add (Sub c25~206@ a25~202@) (Mul d25~208@ d25~208@))) (Sub (Mul (Mul d25~208@ a25~202@) (Mul b25~204@ c25~206@)) (Add (Mul d25~208@ d25~208@) (Add d25~208@ c25~206@))))) (=> (= temp_25_1~4316@ (Sub (Sub (Mul (Mul c25~206@ d25~208@) (Mul b25~204@ b25~204@)) (Add (Sub c25~206@ a25~202@) (Mul d25~208@ d25~208@))) (Sub (Mul (Mul d25~208@ a25~202@) (Mul c25~206@ b25~204@)) (Add (Mul d25~208@ d25~208@) (Add d25~208@ c25~206@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~4251@ temp_25_1~4316@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
