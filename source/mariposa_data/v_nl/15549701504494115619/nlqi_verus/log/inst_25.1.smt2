...
(set-info :comment ";; mariposa_data/v_nl//15549701504494115619/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_5_0~1101@ Int)
...
(declare-const temp_8_1~1656@ Int)
(declare-const temp_9_0~1733@ Int)
(declare-const temp_9_1~1782@ Int)
(declare-const temp_10_0~1875@ Int)
...
(declare-const temp_13_0~2483@ Int)
(declare-const temp_13_1~2536@ Int)
(declare-const temp_14_0~2629@ Int)
(declare-const temp_14_1~2694@ Int)
(declare-const temp_15_0~2815@ Int)
(declare-const temp_15_1~2884@ Int)
(declare-const temp_16_0~2997@ Int)
(declare-const temp_16_1~3082@ Int)
(declare-const temp_17_0~3267@ Int)
(declare-const temp_17_1~3348@ Int)
(declare-const temp_18_0~3453@ Int)
(declare-const temp_18_1~3518@ Int)
(declare-const temp_19_0~3607@ Int)
(declare-const temp_19_1~3700@ Int)
(declare-const temp_20_0~3835@ Int)
(declare-const temp_20_1~3892@ Int)
(declare-const temp_21_0~3985@ Int)
(declare-const temp_21_1~4050@ Int)
(declare-const temp_22_0~4139@ Int)
(declare-const temp_22_1~4192@ Int)
(declare-const temp_23_0~4291@ Int)
(declare-const temp_23_1~4356@ Int)
(declare-const temp_24_0~4461@ Int)
(declare-const temp_24_1~4514@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Sub a0~2@ d0~8@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Mul (Sub a0~2@ d0~8@) a0~2@) b0~4@)) (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@))))) (and (=> (= tmp%1@ (Sub a0~2@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ a0~2@ b0~4@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~481@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul d1~16@ 91) (Mul b1~12@ a1~10@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~558@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul d1~16@ 91) (Mul a1~10@ b1~12@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ a1~10@) (=> %%location_label%%1 (= temp_1_0~481@ temp_1_1~558@))) (=> (= temp_1_0~481@ temp_1_1~558@) (=> (= temp_2_0~647@ (Mul (Sub (Mul a2~18@ (Add c2~22@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ b2~20@))) (Mul (Add (Mul b2~20@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~708@ (Mul (Sub (Mul a2~18@ (Add c2~22@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ b2~20@))) (Mul (Add (Mul b2~20@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul (Mul a2~18@ a2~18@) b2~20@) c2~22@)))) (and (=> (= tmp%2@ (Mul a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ b2~20@ c2~22@) (=> %%location_label%%2 (= temp_2_0~647@ temp_2_1~708@)))) (=> (= temp_2_0~647@ temp_2_1~708@) (=> (= temp_3_0~795@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Mul a3~26@ d3~32@))) (Sub (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@)) d3~32@))) (=> (= temp_3_1~848@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Mul a3~26@ d3~32@))) (Sub (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@)) d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ a3~26@) (=> %%location_label%%3 (= temp_3_0~795@ temp_3_1~848@))) (=> (= temp_3_0~795@ temp_3_1~848@) (=> (= temp_4_0~941@ (Mul (Mul (Mul (Sub c4~38@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ c4~38@))) (Sub (Mul (Add a4~34@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~1006@ (Mul (Mul (Mul (Sub c4~38@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ c4~38@))) (Sub (Mul (Mul (Add a4~34@ d4~40@) c4~38@) b4~36@) (Mul (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@))))) (and (=> (= tmp%3@ (Add a4~34@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ c4~38@ b4~36@) (=> %%location_label%%4 (= temp_4_0~941@ temp_4_1~1006@)))) (=> (= temp_4_0~941@ temp_4_1~1006@) (=> (= temp_5_0~1101@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul c5~46@ a5~42@) a5~42@)))) (=> (= temp_5_1~1162@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul c5~46@ a5~42@) a5~42@)))) (and (=> (= tmp%4@ (Mul a5~42@ a5~42@)) (=> (= tmp%5@ (Mul c5~46@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%5 (= temp_5_0~1101@ temp_5_1~1162@))))) (=> (= temp_5_0~1101@ temp_5_1~1162@) (=> (= temp_6_0~1255@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) d6~56@) (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ c6~54@))) (Sub (Mul (Sub c6~54@ c6~54@) (Mul b6~52@ a6~50@)) (Mul c6~54@ (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1320@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) d6~56@) (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ c6~54@))) (Sub (Sub (Mul c6~54@ (Mul b6~52@ a6~50@)) (Mul c6~54@ (Mul b6~52@ a6~50@))) (Mul c6~54@ (Mul d6~56@ a6~50@))))) (and (=> (= tmp%6@ (Mul b6~52@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c6~54@ c6~54@ tmp%6@) (=> %%location_label%%6 (= temp_6_0~1255@ temp_6_1~1320@)))) (=> (= temp_6_0~1255@ temp_6_1~1320@) (=> (= temp_7_0~1419@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Sub b7~60@ d7~64@)) (Mul (Add a7~58@ c7~62@) (Mul c7~62@ b7~60@))) (Mul (Sub (Sub d7~64@ c7~62@) (Mul c7~62@ a7~58@)) (Add (Mul a7~58@ c7~62@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1492@ (Mul (Mul (Sub (Mul (Mul b7~60@ d7~64@) b7~60@) (Mul (Mul b7~60@ d7~64@) d7~64@)) (Mul (Add a7~58@ c7~62@) (Mul c7~62@ b7~60@))) (Mul (Sub (Sub d7~64@ c7~62@) (Mul c7~62@ a7~58@)) (Add (Mul a7~58@ c7~62@) (Mul c7~62@ a7~58@))))) (and (=> (= tmp%7@ (Mul b7~60@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%7@ b7~60@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1419@ temp_7_1~1492@)))) (=> (= temp_7_0~1419@ temp_7_1~1492@) (=> (= temp_8_0~1591@ (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ a8~66@)) (Sub (Mul c8~70@ d8~72@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul a8~66@ a8~66@)) (Sub (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1656@ (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Mul a8~66@ c8~70@)) (Sub (Mul c8~70@ d8~72@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul a8~66@ a8~66@)) (Sub (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ a8~66@) (=> %%location_label%%8 (= temp_8_0~1591@ temp_8_1~1656@))) (=> (= temp_8_0~1591@ temp_8_1~1656@) (=> (= temp_9_0~1733@ (Add (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ a9~74@))) (Mul (Mul d9~80@ (Mul a9~74@ d9~80@)) d9~80@))) (=> (= temp_9_1~1782@ (Add (Mul (Mul (Mul b9~76@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ a9~74@))) (Mul (Mul d9~80@ (Mul a9~74@ d9~80@)) d9~80@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ d9~80@) (=> %%location_label%%9 (= temp_9_0~1733@ temp_9_1~1782@))) (=> (= temp_9_0~1733@ temp_9_1~1782@) (=> (= temp_10_0~1875@ (Mul (Add (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ c10~86@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~1972@ (Add (Mul (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@)))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@)))))) (and (=> (= tmp%8@ (Mul (Mul c10~86@ a10~82@) (Mul d10~88@ c10~86@))) (=> (= tmp%9@ (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ c10~86@))) (=> (= tmp%10@ (Mul (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Mul b10~84@ d10~88@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%10 (= temp_10_0~1875@ temp_10_1~1972@)))))) (=> (= temp_10_0~1875@ temp_10_1~1972@) (=> (= temp_11_0~2127@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ a11~90@)) (Sub (Mul d11~96@ b11~92@) 36)) (Mul (Mul (Add d11~96@ c11~94@) (Add b11~92@ d11~96@)) (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@))))) (=> (= temp_11_1~2200@ (Mul (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ a11~90@)) (Sub (Mul d11~96@ b11~92@) 36)) (Mul (Add d11~96@ c11~94@) (Add b11~92@ d11~96@))) (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@)))) (and (=> (= tmp%11@ (Mul (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ a11~90@)) (Sub (Mul d11~96@ b11~92@) 36))) (=> (= tmp%12@ (Mul (Add d11~96@ c11~94@) (Add b11~92@ d11~96@))) (=> (= tmp%13@ (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%11 (= temp_11_0~2127@ temp_11_1~2200@)))))) (=> (= temp_11_0~2127@ temp_11_1~2200@) (=> (= temp_12_0~2343@ (Mul (Mul (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@))) (Mul c12~102@ (Mul (Mul b12~100@ a12~98@) (Sub d12~104@ d12~104@))))) (=> (= temp_12_1~2396@ (Mul (Mul (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ c12~102@)) (Mul a12~98@ (Mul a12~98@ (Mul b12~100@ b12~100@)))) (Mul c12~102@ (Mul (Mul b12~100@ a12~98@) (Sub d12~104@ d12~104@))))) (and (=> (= tmp%14@ (Mul b12~100@ b12~100@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a12~98@ a12~98@ tmp%14@) (=> %%location_label%%12 (= temp_12_0~2343@ temp_12_1~2396@)))) (=> (= temp_12_0~2343@ temp_12_1~2396@) (=> (= temp_13_0~2483@ (Add (Mul (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@)) (Mul (Mul c13~110@ a13~106@) (Sub a13~106@ d13~112@))) (Add d13~112@ (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ d13~112@))))) (=> (= temp_13_1~2536@ (Add (Mul (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ a13~106@)) (Mul (Mul a13~106@ c13~110@) (Sub a13~106@ d13~112@))) (Add d13~112@ (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c13~110@ a13~106@) (=> %%location_label%%13 (= temp_13_0~2483@ temp_13_1~2536@))) (=> (= temp_13_0~2483@ temp_13_1~2536@) (=> (= temp_14_0~2629@ (Mul (Mul (Add (Mul d14~120@ b14~116@) (Mul a14~114@ d14~120@)) (Mul (Mul b14~116@ b14~116@) (Add a14~114@ a14~114@))) (Mul (Sub (Add c14~118@ c14~118@) (Mul c14~118@ d14~120@)) (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ a14~114@))))) (=> (= temp_14_1~2694@ (Mul (Mul (Mul (Mul b14~116@ b14~116@) (Add a14~114@ a14~114@)) (Add (Mul d14~120@ b14~116@) (Mul a14~114@ d14~120@))) (Mul (Sub (Add c14~118@ c14~118@) (Mul c14~118@ d14~120@)) (Mul (Mul a14~114@ a14~114@) (Mul b14~116@ a14~114@))))) (and (=> (= tmp%15@ (Add (Mul d14~120@ b14~116@) (Mul a14~114@ d14~120@))) (=> (= tmp%16@ (Mul (Mul b14~116@ b14~116@) (Add a14~114@ a14~114@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%14 (= temp_14_0~2629@ temp_14_1~2694@))))) (=> (= temp_14_0~2629@ temp_14_1~2694@) (=> (= temp_15_0~2815@ (Mul (Add (Mul (Add a15~122@ c15~126@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ c15~126@) (Mul 94 c15~126@))) (Mul (Mul b15~124@ b15~124@) (Sub (Mul c15~126@ b15~124@) (Mul b15~124@ c15~126@))))) (=> (= temp_15_1~2884@ (Mul (Add (Mul (Add a15~122@ c15~126@) (Mul d15~128@ d15~128@)) (Mul (Mul a15~122@ c15~126@) (Mul 94 c15~126@))) (Mul (Mul b15~124@ b15~124@) (Sub (Mul c15~126@ b15~124@) (Mul c15~126@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b15~124@ c15~126@) (=> %%location_label%%15 (= temp_15_0~2815@ temp_15_1~2884@))) (=> (= temp_15_0~2815@ temp_15_1~2884@) (=> (= temp_16_0~2997@ (Mul (Mul (Mul (Add a16~130@ b16~132@) (Mul 1 b16~132@)) (Sub (Sub d16~136@ c16~134@) (Mul a16~130@ c16~134@))) (Add (Mul (Mul 78 d16~136@) b16~132@) (Mul (Mul b16~132@ d16~136@) (Mul a16~130@ d16~136@))))) (=> (= temp_16_1~3082@ (Mul (Add (Mul (Mul 78 d16~136@) b16~132@) (Mul (Mul b16~132@ d16~136@) (Mul a16~130@ d16~136@))) (Mul (Mul (Add a16~130@ b16~132@) (Mul 1 b16~132@)) (Sub (Sub d16~136@ c16~134@) (Mul a16~130@ c16~134@))))) (and (=> (= tmp%17@ (Mul (Mul (Add a16~130@ b16~132@) (Mul 1 b16~132@)) (Sub (Sub d16~136@ c16~134@) (Mul a16~130@ c16~134@)))) (=> (= tmp%18@ (Add (Mul (Mul 78 d16~136@) b16~132@) (Mul (Mul b16~132@ d16~136@) (Mul a16~130@ d16~136@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%16 (= temp_16_0~2997@ temp_16_1~3082@))))) (=> (= temp_16_0~2997@ temp_16_1~3082@) (=> (= temp_17_0~3267@ (Mul (Add (Mul (Mul d17~144@ d17~144@) c17~142@) (Mul (Mul 48 c17~142@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul b17~140@ d17~144@) b17~140@) (Mul (Sub b17~140@ b17~140@) (Mul d17~144@ 46))))) (=> (= temp_17_1~3348@ (Mul (Add (Mul (Mul d17~144@ d17~144@) c17~142@) (Mul (Mul c17~142@ 48) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul b17~140@ d17~144@) b17~140@) (Mul (Sub b17~140@ b17~140@) (Mul d17~144@ 46))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 48 c17~142@) (=> %%location_label%%17 (= temp_17_0~3267@ temp_17_1~3348@))) (=> (= temp_17_0~3267@ temp_17_1~3348@) (=> (= temp_18_0~3453@ (Mul (Mul (Mul (Mul c18~150@ d18~152@) (Mul c18~150@ b18~148@)) (Mul (Mul b18~148@ a18~146@) (Add b18~148@ b18~148@))) (Mul (Mul (Mul c18~150@ c18~150@) (Mul c18~150@ d18~152@)) (Sub (Mul b18~148@ a18~146@) (Mul a18~146@ d18~152@))))) (=> (= temp_18_1~3518@ (Mul (Mul (Mul (Mul c18~150@ d18~152@) (Mul c18~150@ b18~148@)) (Mul (Mul b18~148@ a18~146@) (Add b18~148@ b18~148@))) (Mul (Mul (Mul c18~150@ c18~150@) (Mul c18~150@ d18~152@)) (Sub (Mul b18~148@ a18~146@) (Mul d18~152@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a18~146@ d18~152@) (=> %%location_label%%18 (= temp_18_0~3453@ temp_18_1~3518@))) (=> (= temp_18_0~3453@ temp_18_1~3518@) (=> (= temp_19_0~3607@ (Mul (Add (Mul (Mul b19~156@ b19~156@) (Mul c19~158@ d19~160@)) (Mul (Mul c19~158@ d19~160@) d19~160@)) (Mul (Mul (Mul d19~160@ b19~156@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ c19~158@) (Mul b19~156@ d19~160@))))) (=> (= temp_19_1~3700@ (Add (Mul (Mul (Mul b19~156@ b19~156@) (Mul c19~158@ d19~160@)) (Mul (Mul (Mul d19~160@ b19~156@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ c19~158@) (Mul b19~156@ d19~160@)))) (Mul (Mul (Mul c19~158@ d19~160@) d19~160@) (Mul (Mul (Mul d19~160@ b19~156@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ c19~158@) (Mul b19~156@ d19~160@)))))) (and (=> (= tmp%19@ (Mul (Mul b19~156@ b19~156@) (Mul c19~158@ d19~160@))) (=> (= tmp%20@ (Mul (Mul c19~158@ d19~160@) d19~160@)) (=> (= tmp%21@ (Mul (Mul (Mul d19~160@ b19~156@) (Mul d19~160@ a19~154@)) (Mul (Mul a19~154@ c19~158@) (Mul b19~156@ d19~160@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%19 (= temp_19_0~3607@ temp_19_1~3700@)))))) (=> (= temp_19_0~3607@ temp_19_1~3700@) (=> (= temp_20_0~3835@ (Mul (Mul (Mul (Add b20~164@ b20~164@) (Mul c20~166@ d20~168@)) (Mul (Mul c20~166@ c20~166@) a20~162@)) (Mul (Add (Mul a20~162@ b20~164@) (Mul c20~166@ c20~166@)) (Mul c20~166@ (Mul b20~164@ a20~162@))))) (=> (= temp_20_1~3892@ (Mul (Mul (Mul (Add b20~164@ b20~164@) (Mul c20~166@ d20~168@)) (Mul (Mul c20~166@ c20~166@) a20~162@)) (Mul (Add (Mul a20~162@ b20~164@) (Mul c20~166@ c20~166@)) (Mul c20~166@ (Mul a20~162@ b20~164@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b20~164@ a20~162@) (=> %%location_label%%20 (= temp_20_0~3835@ temp_20_1~3892@))) (=> (= temp_20_0~3835@ temp_20_1~3892@) (=> (= temp_21_0~3985@ (Mul (Sub (Mul (Mul b21~172@ c21~174@) (Mul b21~172@ c21~174@)) (Sub (Mul c21~174@ a21~170@) (Sub a21~170@ c21~174@))) (Mul (Mul (Add b21~172@ b21~172@) (Mul c21~174@ d21~176@)) (Mul (Mul a21~170@ c21~174@) (Mul a21~170@ a21~170@))))) (=> (= temp_21_1~4050@ (Mul (Sub (Mul (Mul b21~172@ c21~174@) (Mul b21~172@ c21~174@)) (Sub (Mul c21~174@ a21~170@) (Sub a21~170@ c21~174@))) (Mul (Mul (Add b21~172@ b21~172@) (Mul c21~174@ d21~176@)) (Mul (Mul a21~170@ a21~170@) (Mul a21~170@ c21~174@))))) (and (=> (= tmp%22@ (Mul a21~170@ c21~174@)) (=> (= tmp%23@ (Mul a21~170@ a21~170@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%21 (= temp_21_0~3985@ temp_21_1~4050@))))) (=> (= temp_21_0~3985@ temp_21_1~4050@) (=> (= temp_22_0~4139@ (Mul (Mul (Mul (Mul c22~182@ b22~180@) (Mul a22~178@ a22~178@)) a22~178@) (Mul (Mul (Sub a22~178@ a22~178@) (Sub c22~182@ c22~182@)) (Mul (Add d22~184@ c22~182@) (Mul c22~182@ c22~182@))))) (=> (= temp_22_1~4192@ (Mul (Mul (Mul (Mul c22~182@ b22~180@) (Mul a22~178@ a22~178@)) a22~178@) (Mul (Mul (Sub a22~178@ a22~178@) (Sub c22~182@ c22~182@)) (Mul (Mul (Add d22~184@ c22~182@) c22~182@) c22~182@)))) (and (=> (= tmp%24@ (Add d22~184@ c22~182@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ c22~182@ c22~182@) (=> %%location_label%%22 (= temp_22_0~4139@ temp_22_1~4192@)))) (=> (= temp_22_0~4139@ temp_22_1~4192@) (=> (= temp_23_0~4291@ (Mul (Sub (Mul (Mul d23~192@ d23~192@) (Mul a23~186@ a23~186@)) (Mul (Mul c23~190@ a23~186@) (Mul c23~190@ a23~186@))) (Mul (Sub (Mul b23~188@ d23~192@) (Add d23~192@ b23~188@)) (Mul (Sub a23~186@ c23~190@) (Mul d23~192@ c23~190@))))) (=> (= temp_23_1~4356@ (Mul (Sub (Mul (Mul d23~192@ d23~192@) (Mul a23~186@ a23~186@)) (Mul (Mul c23~190@ a23~186@) (Mul c23~190@ a23~186@))) (Mul (Mul (Sub a23~186@ c23~190@) (Mul d23~192@ c23~190@)) (Sub (Mul b23~188@ d23~192@) (Add d23~192@ b23~188@))))) (and (=> (= tmp%25@ (Sub (Mul b23~188@ d23~192@) (Add d23~192@ b23~188@))) (=> (= tmp%26@ (Mul (Sub a23~186@ c23~190@) (Mul d23~192@ c23~190@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%25@ tmp%26@) (=> %%location_label%%23 (= temp_23_0~4291@ temp_23_1~4356@))))) (=> (= temp_23_0~4291@ temp_23_1~4356@) (=> (= temp_24_0~4461@ (Sub (Mul (Mul (Mul d24~200@ c24~198@) (Mul b24~196@ a24~194@)) (Sub (Mul b24~196@ d24~200@) (Mul c24~198@ a24~194@))) (Mul (Mul (Add d24~200@ c24~198@) (Mul b24~196@ b24~196@)) c24~198@))) (=> (= temp_24_1~4514@ (Sub (Mul (Mul (Mul c24~198@ d24~200@) (Mul b24~196@ a24~194@)) (Sub (Mul b24~196@ d24~200@) (Mul c24~198@ a24~194@))) (Mul (Mul (Add d24~200@ c24~198@) (Mul b24~196@ b24~196@)) c24~198@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d24~200@ c24~198@) (=> %%location_label%%24 (= temp_24_0~4461@ temp_24_1~4514@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
