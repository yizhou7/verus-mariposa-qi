...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Sub d0~8@ d0~8@) (Add b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul 76 c0~6@) (Add c0~6@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Sub d0~8@ d0~8@) (Add b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul (Mul 76 c0~6@) (Add c0~6@ c0~6@)) (Mul a0~2@ b0~4@)) (Mul c0~6@ c0~6@)))) (=> (= tmp%1@ (= temp_0_0~317@ temp_0_1~394@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~478@ (Mul (Sub (Mul (Mul d1~16@ a1~10@) a1~10@) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul d1~16@ b1~12@) 22) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~547@ (Mul (Mul (Sub (Mul (Mul d1~16@ a1~10@) a1~10@) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul d1~16@ b1~12@) 22)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ a1~10@)))) (=> (= tmp%2@ (= temp_1_0~478@ temp_1_1~547@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~627@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Add c2~22@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@))) (Sub (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~692@ (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Add c2~22@ d2~24@))) (Sub (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~627@ temp_2_1~692@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~744@ (Mul (Sub b3~28@ (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@))) (Sub (Mul b3~28@ (Mul c3~30@ b3~28@)) d3~32@))) (=> (= temp_3_1~781@ (Mul (Sub b3~28@ (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@))) (Sub (Mul (Mul b3~28@ c3~30@) b3~28@) d3~32@))) (=> (= tmp%4@ (= temp_3_0~744@ temp_3_1~781@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~857@ (Mul (Mul (Add (Mul b4~36@ b4~36@) (Add c4~38@ b4~36@)) (Mul (Sub c4~38@ a4~34@) (Mul a4~34@ d4~40@))) (Sub (Mul (Mul d4~40@ c4~38@) d4~40@) (Mul (Mul c4~38@ c4~38@) (Add d4~40@ a4~34@))))) (=> (= temp_4_1~918@ (Mul (Mul (Add (Mul b4~36@ b4~36@) (Add c4~38@ b4~36@)) (Mul (Sub c4~38@ a4~34@) (Mul a4~34@ d4~40@))) (Sub (Mul d4~40@ (Mul c4~38@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Add d4~40@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~857@ temp_4_1~918@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~998@ (Mul (Mul (Mul (Add a5~42@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ c5~46@)) (Sub (Mul c5~46@ b5~44@) (Sub a5~42@ b5~44@))))) (=> (= temp_5_1~1071@ (Mul (Mul (Add (Mul a5~42@ (Mul b5~44@ a5~42@)) (Mul b5~44@ (Mul b5~44@ a5~42@))) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ c5~46@)) (Sub (Mul c5~46@ b5~44@) (Sub a5~42@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~998@ temp_5_1~1071@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1163@ (Mul (Add (Mul (Add b6~52@ c6~54@) (Mul 10 b6~52@)) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@))) (Mul (Mul (Mul a6~50@ b6~52@) (Sub a6~50@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1272@ (Add (Mul (Mul (Add b6~52@ c6~54@) (Mul 10 b6~52@)) (Mul (Mul (Mul a6~50@ b6~52@) (Sub a6~50@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ d6~56@)))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul (Mul a6~50@ b6~52@) (Sub a6~50@ d6~56@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ d6~56@)))))) (=> (= tmp%7@ (= temp_6_0~1163@ temp_6_1~1272@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1356@ (Sub (Mul (Mul (Mul a7~58@ a7~58@) c7~62@) (Mul c7~62@ (Mul d7~64@ c7~62@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Mul 30 a7~58@) (Add c7~62@ b7~60@))))) (=> (= temp_7_1~1425@ (Sub (Mul (Mul c7~62@ (Mul a7~58@ a7~58@)) (Mul c7~62@ (Mul d7~64@ c7~62@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Mul 30 a7~58@) (Add c7~62@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1356@ temp_7_1~1425@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1505@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1570@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1505@ temp_8_1~1570@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1650@ (Mul (Sub (Mul (Sub c9~78@ c9~78@) (Add d9~80@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@))) (Mul (Add (Add c9~78@ b9~76@) (Mul d9~80@ b9~76@)) (Sub (Mul a9~74@ b9~76@) (Mul d9~80@ b9~76@))))) (=> (= temp_9_1~1715@ (Mul (Sub (Mul (Add d9~80@ d9~80@) (Sub c9~78@ c9~78@)) (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ b9~76@))) (Mul (Add (Add c9~78@ b9~76@) (Mul d9~80@ b9~76@)) (Sub (Mul a9~74@ b9~76@) (Mul d9~80@ b9~76@))))) (=> (= tmp%10@ (= temp_9_0~1650@ temp_9_1~1715@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1795@ (Mul (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ b10~84@)) (Sub (Mul c10~86@ a10~82@) (Mul d10~88@ a10~82@))) (Add (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ c10~86@)) (Add (Add a10~82@ c10~86@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~1892@ (Add (Mul (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ b10~84@)) (Sub (Mul c10~86@ a10~82@) (Mul d10~88@ a10~82@))) (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul (Mul d10~88@ b10~84@) (Mul c10~86@ b10~84@)) (Sub (Mul c10~86@ a10~82@) (Mul d10~88@ a10~82@))) (Add (Add a10~82@ c10~86@) (Mul c10~86@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1795@ temp_10_1~1892@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1984@ (Mul (Mul (Add (Sub c11~94@ b11~92@) (Mul b11~92@ 1)) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@))) (Mul (Mul (Sub d11~96@ a11~90@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ c11~94@))))) (=> (= temp_11_1~2061@ (Mul (Mul (Mul (Add (Sub c11~94@ b11~92@) (Mul b11~92@ 1)) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@))) (Mul (Sub d11~96@ a11~90@) (Mul a11~90@ a11~90@))) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ c11~94@)))) (=> (= tmp%12@ (= temp_11_0~1984@ temp_11_1~2061@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2153@ (Add (Mul (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ c12~102@)) (Add (Mul a12~98@ a12~98@) (Mul d12~104@ 18))) (Add (Mul (Mul a12~98@ a12~98@) (Mul c12~102@ b12~100@)) (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2230@ (Add (Mul (Mul (Mul d12~104@ a12~98@) (Mul b12~100@ c12~102@)) (Add (Mul a12~98@ a12~98@) (Mul d12~104@ 18))) (Add (Mul a12~98@ (Mul a12~98@ (Mul c12~102@ b12~100@))) (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ a12~98@))))) (=> (= tmp%13@ (= temp_12_0~2153@ temp_12_1~2230@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2310@ (Mul (Mul (Add (Mul b13~108@ b13~108@) (Mul b13~108@ c13~110@)) (Mul (Mul a13~106@ c13~110@) (Mul d13~112@ d13~112@))) (Sub (Sub (Mul c13~110@ d13~112@) (Mul a13~106@ c13~110@)) (Mul (Sub c13~110@ a13~106@) (Mul b13~108@ a13~106@))))) (=> (= temp_13_1~2391@ (Mul (Add (Mul (Mul b13~108@ b13~108@) (Mul (Mul a13~106@ c13~110@) (Mul d13~112@ d13~112@))) (Mul (Mul b13~108@ c13~110@) (Mul (Mul a13~106@ c13~110@) (Mul d13~112@ d13~112@)))) (Sub (Sub (Mul c13~110@ d13~112@) (Mul a13~106@ c13~110@)) (Mul (Sub c13~110@ a13~106@) (Mul b13~108@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2310@ temp_13_1~2391@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2471@ (Mul (Mul (Mul (Mul d14~120@ a14~114@) (Mul d14~120@ a14~114@)) (Mul (Mul b14~116@ a14~114@) (Mul d14~120@ a14~114@))) (Mul (Mul (Sub c14~118@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Mul b14~116@ a14~114@) (Add b14~116@ d14~120@))))) (=> (= temp_14_1~2536@ (Mul (Mul (Mul (Mul d14~120@ a14~114@) (Mul d14~120@ a14~114@)) (Mul (Mul d14~120@ a14~114@) (Mul b14~116@ a14~114@))) (Mul (Mul (Sub c14~118@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Mul b14~116@ a14~114@) (Add b14~116@ d14~120@))))) (=> (= tmp%15@ (= temp_14_0~2471@ temp_14_1~2536@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2616@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul a15~122@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ b15~124@))) (Mul d15~128@ (Mul (Mul b15~124@ 6) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2681@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul a15~122@ b15~124@)) (Mul a15~122@ (Mul d15~128@ (Mul a15~122@ b15~124@)))) (Mul d15~128@ (Mul (Mul b15~124@ 6) (Mul c15~126@ c15~126@))))) (=> (= tmp%16@ (= temp_15_0~2616@ temp_15_1~2681@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2729@ (Mul (Add (Mul (Mul a16~130@ b16~132@) (Mul d16~136@ a16~130@)) (Sub (Mul d16~136@ d16~136@) c16~134@)) c16~134@)) (=> (= temp_16_1~2762@ (Mul (Add (Mul (Mul b16~132@ a16~130@) (Mul d16~136@ a16~130@)) (Sub (Mul d16~136@ d16~136@) c16~134@)) c16~134@)) (=> (= tmp%17@ (= temp_16_0~2729@ temp_16_1~2762@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2838@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ b17~140@)) (Mul (Mul c17~142@ c17~142@) (Mul c17~142@ a17~138@))) (Mul (Mul c17~142@ (Add b17~140@ d17~144@)) (Mul (Mul d17~144@ d17~144@) (Mul a17~138@ d17~144@))))) (=> (= temp_17_1~2903@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ b17~140@)) (Mul (Mul c17~142@ c17~142@) (Mul c17~142@ a17~138@))) (Mul (Add (Mul c17~142@ b17~140@) (Mul c17~142@ d17~144@)) (Mul (Mul d17~144@ d17~144@) (Mul a17~138@ d17~144@))))) (=> (= tmp%18@ (= temp_17_0~2838@ temp_17_1~2903@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2955@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ b18~148@)) (Sub (Mul c18~150@ b18~148@) (Mul d18~152@ d18~152@))) a18~146@)) (=> (= temp_18_1~2992@ (Mul (Mul (Mul (Mul (Mul a18~146@ c18~150@) b18~148@) b18~148@) (Sub (Mul c18~150@ b18~148@) (Mul d18~152@ d18~152@))) a18~146@)) (=> (= tmp%19@ (= temp_18_0~2955@ temp_18_1~2992@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3072@ (Add (Mul (Mul (Mul d19~160@ c19~158@) (Mul d19~160@ d19~160@)) (Mul (Mul d19~160@ b19~156@) (Mul c19~158@ a19~154@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ c19~158@)) (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ a19~154@))))) (=> (= temp_19_1~3137@ (Add (Mul (Mul (Mul d19~160@ c19~158@) (Mul d19~160@ d19~160@)) (Mul (Mul d19~160@ b19~156@) (Mul c19~158@ a19~154@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ c19~158@)) (Mul (Mul b19~156@ a19~154@) (Mul b19~156@ b19~156@))))) (=> (= tmp%20@ (= temp_19_0~3072@ temp_19_1~3137@)) (=> %%location_label%%19 tmp%20@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
