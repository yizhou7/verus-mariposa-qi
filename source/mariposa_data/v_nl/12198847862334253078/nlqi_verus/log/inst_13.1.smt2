...
(set-info :comment ";; mariposa_data/v_nl//12198847862334253078/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Sub (Sub (Add c0~6@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ b0~4@)))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@))) (Mul (Mul (Sub d0~8@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Mul 39 b0~4@)))))) (=> (= temp_0_1~474@ (Mul (Sub (Mul (Sub (Add c0~6@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ b0~4@)))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ b0~4@)) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ b0~4@))))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@))) (Mul (Mul (Sub d0~8@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Mul 39 b0~4@)))))) (and (=> (= tmp%1@ (Sub (Add c0~6@ c0~6@) (Mul b0~4@ d0~8@))) (=> (= tmp%2@ (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ b0~4@))) (=> (= tmp%3@ (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ b0~4@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~474@)))))) (=> (= temp_0_0~301@ temp_0_1~474@) (=> (= temp_1_0~625@ (Mul (Mul (Add (Mul b1~12@ (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Add c1~14@ a1~10@))) (Add (Mul (Add b1~12@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ a1~10@)))) (Mul b1~12@ c1~14@))) (=> (= temp_1_1~694@ (Mul (Mul (Add (Mul b1~12@ (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Add c1~14@ a1~10@))) (Add (Mul (Add b1~12@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ a1~10@)))) (Mul b1~12@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ c1~14@) (=> %%location_label%%1 (= temp_1_0~625@ temp_1_1~694@))) (=> (= temp_1_0~625@ temp_1_1~694@) (=> (= temp_2_0~851@ (Mul (Sub (Mul (Sub (Add a2~18@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ c2~22@)) d2~24@)) (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Sub (Sub b2~20@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul b2~20@ 2) (Mul c2~22@ b2~20@)))))) (=> (= temp_2_1~996@ (Mul (Sub (Sub (Mul (Add a2~18@ c2~22@) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@))) (Mul (Mul c2~22@ c2~22@) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@)))) (Mul (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ c2~22@)) d2~24@)) (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Sub (Sub b2~20@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul b2~20@ 2) (Mul c2~22@ b2~20@)))))) (and (=> (= tmp%4@ (Add a2~18@ c2~22@)) (=> (= tmp%5@ (Mul c2~22@ c2~22@)) (=> (= tmp%6@ (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%2 (= temp_2_0~851@ temp_2_1~996@)))))) (=> (= temp_2_0~851@ temp_2_1~996@) (=> (= temp_3_0~1199@ (Mul (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Sub b3~28@ a3~26@)) (Add (Mul d3~32@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ b3~28@)))) (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Add 19 c3~30@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul a3~26@ 4) (Mul a3~26@ c3~30@)) (Mul (Sub d3~32@ c3~30@) (Mul c3~30@ d3~32@)))))) (=> (= temp_3_1~1352@ (Mul (Mul (Mul (Add (Mul d3~32@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Mul d3~32@ a3~26@) (Sub b3~28@ a3~26@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ b3~28@)))) (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Add 19 c3~30@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul a3~26@ 4) (Mul a3~26@ c3~30@)) (Mul (Sub d3~32@ c3~30@) (Mul c3~30@ d3~32@)))))) (and (=> (= tmp%7@ (Mul (Mul d3~32@ a3~26@) (Sub b3~28@ a3~26@))) (=> (= tmp%8@ (Add (Mul d3~32@ b3~28@) (Mul d3~32@ b3~28@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%3 (= temp_3_0~1199@ temp_3_1~1352@))))) (=> (= temp_3_0~1199@ temp_3_1~1352@) (=> (= temp_4_0~1505@ (Mul (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Sub (Sub a4~34@ c4~38@) (Mul c4~38@ b4~36@))) b4~36@) (Mul (Mul (Sub (Mul a4~34@ d4~40@) (Mul b4~36@ d4~40@)) (Sub (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@))) (Add (Add (Mul a4~34@ d4~40@) (Mul 6 b4~36@)) c4~38@)))) (=> (= temp_4_1~1606@ (Mul (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@)) (Sub (Sub a4~34@ c4~38@) (Mul c4~38@ b4~36@))) b4~36@) (Mul (Mul (Sub (Mul a4~34@ d4~40@) (Mul b4~36@ d4~40@)) (Sub (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@))) (Add (Add (Mul a4~34@ d4~40@) (Mul 6 b4~36@)) c4~38@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1505@ temp_4_1~1606@))) (=> (= temp_4_0~1505@ temp_4_1~1606@) (=> (= temp_5_0~1747@ (Add (Mul (Sub (Mul (Mul c5~46@ c5~46@) (Add c5~46@ c5~46@)) (Sub (Mul d5~48@ c5~46@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul a5~42@ b5~44@) (Sub a5~42@ d5~48@)) (Sub (Mul c5~46@ a5~42@) (Mul a5~42@ c5~46@)))) (Mul (Mul c5~46@ (Mul a5~42@ (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Sub c5~46@ c5~46@)))))) (=> (= temp_5_1~1868@ (Add (Mul (Sub (Add (Mul (Mul c5~46@ c5~46@) c5~46@) (Mul (Mul c5~46@ c5~46@) c5~46@)) (Sub (Mul d5~48@ c5~46@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul a5~42@ b5~44@) (Sub a5~42@ d5~48@)) (Sub (Mul c5~46@ a5~42@) (Mul a5~42@ c5~46@)))) (Mul (Mul c5~46@ (Mul a5~42@ (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Sub c5~46@ c5~46@)))))) (and (=> (= tmp%9@ (Mul c5~46@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ c5~46@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1747@ temp_5_1~1868@)))) (=> (= temp_5_0~1747@ temp_5_1~1868@) (=> (= temp_6_0~1967@ (Mul (Sub (Mul (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ a6~50@)) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@))) (Mul (Sub (Mul a6~50@ a6~50@) (Mul d6~56@ b6~52@)) (Add (Mul c6~54@ a6~50@) b6~52@))) d6~56@)) (=> (= temp_6_1~2032@ (Mul d6~56@ (Sub (Mul (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ a6~50@)) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@))) (Mul (Sub (Mul a6~50@ a6~50@) (Mul d6~56@ b6~52@)) (Add (Mul c6~54@ a6~50@) b6~52@))))) (and (=> (= tmp%10@ (Sub (Mul (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ a6~50@)) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@))) (Mul (Sub (Mul a6~50@ a6~50@) (Mul d6~56@ b6~52@)) (Add (Mul c6~54@ a6~50@) b6~52@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1967@ temp_6_1~2032@)))) (=> (= temp_6_0~1967@ temp_6_1~2032@) (=> (= temp_7_0~2265@ (Mul (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ a7~58@) d7~64@)) (Mul (Mul (Mul b7~60@ a7~58@) (Mul 48 a7~58@)) a7~58@)) (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Add c7~62@ 80)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ a7~58@)) (Add (Add b7~60@ a7~58@) (Mul d7~64@ 70)))))) (=> (= temp_7_1~2414@ (Mul (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ a7~58@) d7~64@)) (Mul (Mul (Mul b7~60@ a7~58@) (Mul 48 a7~58@)) a7~58@)) (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ a7~58@)) (Add (Add b7~60@ a7~58@) (Mul d7~64@ 70))) (Mul (Mul (Mul a7~58@ b7~60@) (Add c7~62@ 80)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@)))))) (and (=> (= tmp%11@ (Mul (Mul (Mul a7~58@ b7~60@) (Add c7~62@ 80)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@)))) (=> (= tmp%12@ (Mul (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ a7~58@)) (Add (Add b7~60@ a7~58@) (Mul d7~64@ 70)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%7 (= temp_7_0~2265@ temp_7_1~2414@))))) (=> (= temp_7_0~2265@ temp_7_1~2414@) (=> (= temp_8_0~2651@ (Mul (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@)) (Add (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@))) (Mul (Mul (Sub a8~66@ c8~70@) (Sub d8~72@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ d8~72@)))) (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Add a8~66@ d8~72@)) (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ d8~72@)) (Mul (Mul c8~70@ c8~70@) (Add d8~72@ b8~68@)))))) (=> (= temp_8_1~2788@ (Mul (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@)) (Add (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@))) (Mul (Mul (Sub a8~66@ c8~70@) (Sub d8~72@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ d8~72@)))) (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Add a8~66@ d8~72@)) (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ d8~72@)) (Add (Mul (Mul c8~70@ c8~70@) d8~72@) (Mul (Mul c8~70@ c8~70@) b8~68@)))))) (and (=> (= tmp%13@ (Mul c8~70@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%13@ d8~72@ b8~68@) (=> %%location_label%%8 (= temp_8_0~2651@ temp_8_1~2788@)))) (=> (= temp_8_0~2651@ temp_8_1~2788@) (=> (= temp_9_0~2939@ (Mul (Sub (Mul (Mul (Mul a9~74@ a9~74@) (Add b9~76@ c9~78@)) (Add c9~78@ (Add d9~80@ c9~78@))) (Mul (Mul c9~78@ (Mul d9~80@ b9~76@)) (Mul c9~78@ (Mul a9~74@ b9~76@)))) (Mul (Add (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Sub a9~74@ b9~76@) (Mul b9~76@ d9~80@)))))) (=> (= temp_9_1~3056@ (Mul (Sub (Mul (Mul (Mul a9~74@ a9~74@) (Add b9~76@ c9~78@)) (Add c9~78@ (Add d9~80@ c9~78@))) (Mul (Mul c9~78@ (Mul d9~80@ b9~76@)) (Mul c9~78@ (Mul a9~74@ b9~76@)))) (Mul (Add (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Mul b9~76@ b9~76@) (Mul (Mul c9~78@ d9~80@) (Mul (Sub a9~74@ b9~76@) (Mul b9~76@ d9~80@))))))) (and (=> (= tmp%14@ (Mul b9~76@ b9~76@)) (=> (= tmp%15@ (Mul c9~78@ d9~80@)) (=> (= tmp%16@ (Mul (Sub a9~74@ b9~76@) (Mul b9~76@ d9~80@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%9 (= temp_9_0~2939@ temp_9_1~3056@)))))) (=> (= temp_9_0~2939@ temp_9_1~3056@) (=> (= temp_10_0~3231@ (Mul (Mul (Mul (Sub (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Sub a10~82@ a10~82@) (Mul d10~88@ b10~84@))) (Add (Mul (Add b10~84@ a10~82@) (Mul d10~88@ b10~84@)) (Mul a10~82@ (Mul c10~86@ a10~82@)))) (Mul (Mul (Mul (Sub b10~84@ a10~82@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ d10~88@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Add a10~82@ a10~82@)))))) (=> (= temp_10_1~3364@ (Mul (Mul (Mul (Sub (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Sub a10~82@ a10~82@) (Mul d10~88@ b10~84@))) (Add (Mul (Add b10~84@ a10~82@) (Mul d10~88@ b10~84@)) (Mul a10~82@ (Mul c10~86@ a10~82@)))) (Mul (Mul (Mul (Sub b10~84@ a10~82@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ d10~88@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ b10~84@)) (Add (Mul (Mul b10~84@ d10~88@) a10~82@) (Mul (Mul b10~84@ d10~88@) a10~82@)))))) (and (=> (= tmp%17@ (Mul b10~84@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%17@ a10~82@ a10~82@) (=> %%location_label%%10 (= temp_10_0~3231@ temp_10_1~3364@)))) (=> (= temp_10_0~3231@ temp_10_1~3364@) (=> (= temp_11_0~3487@ (Mul (Mul (Add (Mul (Mul a11~90@ d11~96@) a11~90@) (Mul (Mul d11~96@ b11~92@) (Sub d11~96@ b11~92@))) (Mul (Mul (Mul c11~94@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul c11~94@ a11~90@) a11~90@))) (Add (Mul d11~96@ (Mul (Mul c11~94@ 64) b11~92@)) d11~96@))) (=> (= temp_11_1~3576@ (Mul (Add (Mul (Mul a11~90@ d11~96@) a11~90@) (Mul (Mul d11~96@ b11~92@) (Sub d11~96@ b11~92@))) (Mul (Mul (Mul (Mul c11~94@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul c11~94@ a11~90@) a11~90@)) (Add (Mul d11~96@ (Mul (Mul c11~94@ 64) b11~92@)) d11~96@)))) (and (=> (= tmp%18@ (Add (Mul (Mul a11~90@ d11~96@) a11~90@) (Mul (Mul d11~96@ b11~92@) (Sub d11~96@ b11~92@)))) (=> (= tmp%19@ (Mul (Mul (Mul c11~94@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul c11~94@ a11~90@) a11~90@))) (=> (= tmp%20@ (Add (Mul d11~96@ (Mul (Mul c11~94@ 64) b11~92@)) d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%11 (= temp_11_0~3487@ temp_11_1~3576@)))))) (=> (= temp_11_0~3487@ temp_11_1~3576@) (=> (= temp_12_0~3827@ (Mul (Mul (Mul (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ a12~98@)) (Mul a12~98@ (Mul b12~100@ c12~102@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@)) (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ d12~104@)))) (Mul (Mul (Sub (Mul c12~102@ b12~100@) (Mul b12~100@ b12~100@)) (Mul (Mul d12~104@ c12~102@) (Sub a12~98@ a12~98@))) (Mul (Mul (Mul b12~100@ c12~102@) a12~98@) (Add (Add b12~100@ 43) (Add b12~100@ 32)))))) (=> (= temp_12_1~3972@ (Mul (Mul (Mul (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ a12~98@)) (Mul a12~98@ (Mul b12~100@ c12~102@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@)) (Mul (Mul (Mul b12~100@ d12~104@) c12~102@) d12~104@))) (Mul (Mul (Sub (Mul c12~102@ b12~100@) (Mul b12~100@ b12~100@)) (Mul (Mul d12~104@ c12~102@) (Sub a12~98@ a12~98@))) (Mul (Mul (Mul b12~100@ c12~102@) a12~98@) (Add (Add b12~100@ 43) (Add b12~100@ 32)))))) (=> (= tmp%21@ (Mul b12~100@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%21@ c12~102@ d12~104@) (=> %%location_label%%12 (= temp_12_0~3827@ temp_12_1~3972@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
