...
(declare-const temp_1_1~627@ Int)
(declare-const temp_2_0~771@ Int)
(declare-const temp_2_1~916@ Int)
(declare-const temp_3_0~1084@ Int)
(declare-const temp_3_1~1237@ Int)
(declare-const temp_4_0~1353@ Int)
(declare-const temp_4_1~1454@ Int)
(declare-const temp_5_0~1582@ Int)
(declare-const temp_5_1~1703@ Int)
(declare-const temp_6_0~1783@ Int)
(declare-const temp_6_1~1848@ Int)
(declare-const temp_7_0~2012@ Int)
(declare-const temp_7_1~2161@ Int)
(declare-const temp_8_0~2305@ Int)
(declare-const temp_8_1~2442@ Int)
(declare-const temp_9_0~2574@ Int)
(declare-const temp_9_1~2691@ Int)
(declare-const temp_10_0~2831@ Int)
(declare-const temp_10_1~2964@ Int)
(declare-const temp_11_0~3068@ Int)
(declare-const temp_11_1~3157@ Int)
(declare-const temp_12_0~3317@ Int)
(declare-const temp_12_1~3462@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Sub (Sub (Add c0~6@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ b0~4@)))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@))) (Mul (Mul (Sub d0~8@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Mul 39 b0~4@)))))) (=> (= temp_0_1~474@ (Mul (Sub (Mul (Sub (Add c0~6@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ b0~4@)))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ b0~4@)) (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ b0~4@))))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@))) (Mul (Mul (Sub d0~8@ d0~8@) (Mul a0~2@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Mul 39 b0~4@)))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~474@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~558@ (Mul (Mul (Add (Mul b1~12@ (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Add c1~14@ a1~10@))) (Add (Mul (Add b1~12@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ a1~10@)))) (Mul b1~12@ c1~14@))) (=> (= temp_1_1~627@ (Mul (Mul (Add (Mul b1~12@ (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Add c1~14@ a1~10@))) (Add (Mul (Add b1~12@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ a1~10@)))) (Mul b1~12@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~558@ temp_1_1~627@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~771@ (Mul (Sub (Mul (Sub (Add a2~18@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ c2~22@)) d2~24@)) (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Sub (Sub b2~20@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul b2~20@ 2) (Mul c2~22@ b2~20@)))))) (=> (= temp_2_1~916@ (Mul (Sub (Sub (Mul (Add a2~18@ c2~22@) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@))) (Mul (Mul c2~22@ c2~22@) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@)))) (Mul (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ c2~22@)) d2~24@)) (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Sub (Sub b2~20@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Mul b2~20@ 2) (Mul c2~22@ b2~20@)))))) (=> (= tmp%3@ (= temp_2_0~771@ temp_2_1~916@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1084@ (Mul (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Sub b3~28@ a3~26@)) (Add (Mul d3~32@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ b3~28@)))) (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Add 19 c3~30@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul a3~26@ 4) (Mul a3~26@ c3~30@)) (Mul (Sub d3~32@ c3~30@) (Mul c3~30@ d3~32@)))))) (=> (= temp_3_1~1237@ (Mul (Mul (Mul (Add (Mul d3~32@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Mul d3~32@ a3~26@) (Sub b3~28@ a3~26@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ b3~28@)))) (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Add 19 c3~30@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul a3~26@ 4) (Mul a3~26@ c3~30@)) (Mul (Sub d3~32@ c3~30@) (Mul c3~30@ d3~32@)))))) (=> (= tmp%4@ (= temp_3_0~1084@ temp_3_1~1237@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1353@ (Mul (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Sub (Sub a4~34@ c4~38@) (Mul c4~38@ b4~36@))) b4~36@) (Mul (Mul (Sub (Mul a4~34@ d4~40@) (Mul b4~36@ d4~40@)) (Sub (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@))) (Add (Add (Mul a4~34@ d4~40@) (Mul 6 b4~36@)) c4~38@)))) (=> (= temp_4_1~1454@ (Mul (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@)) (Sub (Sub a4~34@ c4~38@) (Mul c4~38@ b4~36@))) b4~36@) (Mul (Mul (Sub (Mul a4~34@ d4~40@) (Mul b4~36@ d4~40@)) (Sub (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@))) (Add (Add (Mul a4~34@ d4~40@) (Mul 6 b4~36@)) c4~38@)))) (=> (= tmp%5@ (= temp_4_0~1353@ temp_4_1~1454@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1582@ (Add (Mul (Sub (Mul (Mul c5~46@ c5~46@) (Add c5~46@ c5~46@)) (Sub (Mul d5~48@ c5~46@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul a5~42@ b5~44@) (Sub a5~42@ d5~48@)) (Sub (Mul c5~46@ a5~42@) (Mul a5~42@ c5~46@)))) (Mul (Mul c5~46@ (Mul a5~42@ (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Sub c5~46@ c5~46@)))))) (=> (= temp_5_1~1703@ (Add (Mul (Sub (Add (Mul (Mul c5~46@ c5~46@) c5~46@) (Mul (Mul c5~46@ c5~46@) c5~46@)) (Sub (Mul d5~48@ c5~46@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul a5~42@ b5~44@) (Sub a5~42@ d5~48@)) (Sub (Mul c5~46@ a5~42@) (Mul a5~42@ c5~46@)))) (Mul (Mul c5~46@ (Mul a5~42@ (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Sub c5~46@ c5~46@)))))) (=> (= tmp%6@ (= temp_5_0~1582@ temp_5_1~1703@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1783@ (Mul (Sub (Mul (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ a6~50@)) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@))) (Mul (Sub (Mul a6~50@ a6~50@) (Mul d6~56@ b6~52@)) (Add (Mul c6~54@ a6~50@) b6~52@))) d6~56@)) (=> (= temp_6_1~1848@ (Mul d6~56@ (Sub (Mul (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ a6~50@)) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@))) (Mul (Sub (Mul a6~50@ a6~50@) (Mul d6~56@ b6~52@)) (Add (Mul c6~54@ a6~50@) b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1783@ temp_6_1~1848@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2012@ (Mul (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ a7~58@) d7~64@)) (Mul (Mul (Mul b7~60@ a7~58@) (Mul 48 a7~58@)) a7~58@)) (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Add c7~62@ 80)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ a7~58@)) (Add (Add b7~60@ a7~58@) (Mul d7~64@ 70)))))) (=> (= temp_7_1~2161@ (Mul (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ a7~58@) d7~64@)) (Mul (Mul (Mul b7~60@ a7~58@) (Mul 48 a7~58@)) a7~58@)) (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ a7~58@)) (Add (Add b7~60@ a7~58@) (Mul d7~64@ 70))) (Mul (Mul (Mul a7~58@ b7~60@) (Add c7~62@ 80)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@)))))) (=> (= tmp%8@ (= temp_7_0~2012@ temp_7_1~2161@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2305@ (Mul (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@)) (Add (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@))) (Mul (Mul (Sub a8~66@ c8~70@) (Sub d8~72@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ d8~72@)))) (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Add a8~66@ d8~72@)) (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ d8~72@)) (Mul (Mul c8~70@ c8~70@) (Add d8~72@ b8~68@)))))) (=> (= temp_8_1~2442@ (Mul (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@)) (Add (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@))) (Mul (Mul (Sub a8~66@ c8~70@) (Sub d8~72@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ d8~72@)))) (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Add a8~66@ d8~72@)) (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ d8~72@)) (Add (Mul (Mul c8~70@ c8~70@) d8~72@) (Mul (Mul c8~70@ c8~70@) b8~68@)))))) (=> (= tmp%9@ (= temp_8_0~2305@ temp_8_1~2442@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2574@ (Mul (Sub (Mul (Mul (Mul a9~74@ a9~74@) (Add b9~76@ c9~78@)) (Add c9~78@ (Add d9~80@ c9~78@))) (Mul (Mul c9~78@ (Mul d9~80@ b9~76@)) (Mul c9~78@ (Mul a9~74@ b9~76@)))) (Mul (Add (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ d9~80@)) (Mul (Sub a9~74@ b9~76@) (Mul b9~76@ d9~80@)))))) (=> (= temp_9_1~2691@ (Mul (Sub (Mul (Mul (Mul a9~74@ a9~74@) (Add b9~76@ c9~78@)) (Add c9~78@ (Add d9~80@ c9~78@))) (Mul (Mul c9~78@ (Mul d9~80@ b9~76@)) (Mul c9~78@ (Mul a9~74@ b9~76@)))) (Mul (Add (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@))) (Mul (Mul b9~76@ b9~76@) (Mul (Mul c9~78@ d9~80@) (Mul (Sub a9~74@ b9~76@) (Mul b9~76@ d9~80@))))))) (=> (= tmp%10@ (= temp_9_0~2574@ temp_9_1~2691@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~2831@ (Mul (Mul (Mul (Sub (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Sub a10~82@ a10~82@) (Mul d10~88@ b10~84@))) (Add (Mul (Add b10~84@ a10~82@) (Mul d10~88@ b10~84@)) (Mul a10~82@ (Mul c10~86@ a10~82@)))) (Mul (Mul (Mul (Sub b10~84@ a10~82@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ d10~88@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Add a10~82@ a10~82@)))))) (=> (= temp_10_1~2964@ (Mul (Mul (Mul (Sub (Mul b10~84@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Sub a10~82@ a10~82@) (Mul d10~88@ b10~84@))) (Add (Mul (Add b10~84@ a10~82@) (Mul d10~88@ b10~84@)) (Mul a10~82@ (Mul c10~86@ a10~82@)))) (Mul (Mul (Mul (Sub b10~84@ a10~82@) (Mul a10~82@ b10~84@)) (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ d10~88@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ b10~84@)) (Add (Mul (Mul b10~84@ d10~88@) a10~82@) (Mul (Mul b10~84@ d10~88@) a10~82@)))))) (=> (= tmp%11@ (= temp_10_0~2831@ temp_10_1~2964@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~3068@ (Mul (Mul (Add (Mul (Mul a11~90@ d11~96@) a11~90@) (Mul (Mul d11~96@ b11~92@) (Sub d11~96@ b11~92@))) (Mul (Mul (Mul c11~94@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul c11~94@ a11~90@) a11~90@))) (Add (Mul d11~96@ (Mul (Mul c11~94@ 64) b11~92@)) d11~96@))) (=> (= temp_11_1~3157@ (Mul (Add (Mul (Mul a11~90@ d11~96@) a11~90@) (Mul (Mul d11~96@ b11~92@) (Sub d11~96@ b11~92@))) (Mul (Mul (Mul (Mul c11~94@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul c11~94@ a11~90@) a11~90@)) (Add (Mul d11~96@ (Mul (Mul c11~94@ 64) b11~92@)) d11~96@)))) (=> (= tmp%12@ (= temp_11_0~3068@ temp_11_1~3157@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~3317@ (Mul (Mul (Mul (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ a12~98@)) (Mul a12~98@ (Mul b12~100@ c12~102@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@)) (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ d12~104@)))) (Mul (Mul (Sub (Mul c12~102@ b12~100@) (Mul b12~100@ b12~100@)) (Mul (Mul d12~104@ c12~102@) (Sub a12~98@ a12~98@))) (Mul (Mul (Mul b12~100@ c12~102@) a12~98@) (Add (Add b12~100@ 43) (Add b12~100@ 32)))))) (=> (= temp_12_1~3462@ (Mul (Mul (Mul (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ a12~98@)) (Mul a12~98@ (Mul b12~100@ c12~102@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul b12~100@ a12~98@)) (Mul (Mul (Mul b12~100@ d12~104@) c12~102@) d12~104@))) (Mul (Mul (Sub (Mul c12~102@ b12~100@) (Mul b12~100@ b12~100@)) (Mul (Mul d12~104@ c12~102@) (Sub a12~98@ a12~98@))) (Mul (Mul (Mul b12~100@ c12~102@) a12~98@) (Add (Add b12~100@ 43) (Add b12~100@ 32)))))) (=> (= tmp%13@ (= temp_12_0~3317@ temp_12_1~3462@)) (=> %%location_label%%12 tmp%13@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
