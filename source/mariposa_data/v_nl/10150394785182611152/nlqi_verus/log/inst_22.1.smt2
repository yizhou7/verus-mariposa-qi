...
(set-info :comment ";; mariposa_data/v_nl//10150394785182611152/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_6_0~1343@ Int)
...
(declare-const temp_9_1~1968@ Int)
(declare-const temp_10_0~2075@ Int)
(declare-const temp_10_1~2132@ Int)
(declare-const temp_11_0~2229@ Int)
(declare-const temp_11_1~2294@ Int)
(declare-const temp_12_0~2411@ Int)
(declare-const temp_12_1~2476@ Int)
(declare-const temp_13_0~2541@ Int)
(declare-const temp_13_1~2578@ Int)
(declare-const temp_14_0~2671@ Int)
(declare-const temp_14_1~2736@ Int)
(declare-const temp_15_0~2865@ Int)
(declare-const temp_15_1~2942@ Int)
(declare-const temp_16_0~3053@ Int)
(declare-const temp_16_1~3174@ Int)
(declare-const temp_17_0~3321@ Int)
(declare-const temp_17_1~3374@ Int)
(declare-const temp_18_0~3455@ Int)
(declare-const temp_18_1~3508@ Int)
(declare-const temp_19_0~3601@ Int)
(declare-const temp_19_1~3666@ Int)
(declare-const temp_20_0~3763@ Int)
(declare-const temp_20_1~3824@ Int)
(declare-const temp_21_0~3919@ Int)
(declare-const temp_21_1~3988@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~329@ (Mul (Mul (Mul (Add b0~4@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul 45 a0~2@) (Mul a0~2@ c0~6@))) (Sub (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ 68)) (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~426@ (Mul (Mul (Add (Mul b0~4@ (Mul b0~4@ d0~8@)) (Mul a0~2@ (Mul b0~4@ d0~8@))) (Mul (Mul 45 a0~2@) (Mul a0~2@ c0~6@))) (Sub (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ 68)) (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@))))) (and (=> (= tmp%1@ (Mul b0~4@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b0~4@ a0~2@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~329@ temp_0_1~426@)))) (=> (= temp_0_0~329@ temp_0_1~426@) (=> (= temp_1_0~533@ (Mul (Add (Sub (Mul a1~10@ b1~12@) c1~14@) (Sub (Add d1~16@ a1~10@) (Add c1~14@ 64))) (Mul (Mul (Add b1~12@ a1~10@) (Mul d1~16@ c1~14@)) (Sub (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~606@ (Mul (Add (Sub (Mul b1~12@ a1~10@) c1~14@) (Sub (Add d1~16@ a1~10@) (Add c1~14@ 64))) (Mul (Mul (Add b1~12@ a1~10@) (Mul d1~16@ c1~14@)) (Sub (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ b1~12@) (=> %%location_label%%1 (= temp_1_0~533@ temp_1_1~606@))) (=> (= temp_1_0~533@ temp_1_1~606@) (=> (= temp_2_0~695@ (Mul (Mul (Mul (Add a2~18@ b2~20@) (Mul b2~20@ c2~22@)) (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ b2~20@)) (Mul d2~24@ (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~756@ (Mul (Mul (Mul (Add a2~18@ b2~20@) (Mul b2~20@ c2~22@)) (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ b2~20@)) (Mul d2~24@ (Mul b2~20@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ b2~20@) (=> %%location_label%%2 (= temp_2_0~695@ temp_2_1~756@))) (=> (= temp_2_0~695@ temp_2_1~756@) (=> (= temp_3_0~849@ (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Add c3~30@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul a3~26@ b3~28@) (Add d3~32@ c3~30@)) (Mul (Sub b3~28@ c3~30@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~922@ (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Add c3~30@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@))) (Mul (Add (Mul (Mul a3~26@ b3~28@) d3~32@) (Mul (Mul a3~26@ b3~28@) c3~30@)) (Mul (Sub b3~28@ c3~30@) (Mul a3~26@ c3~30@))))) (and (=> (= tmp%2@ (Mul a3~26@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%2@ d3~32@ c3~30@) (=> %%location_label%%3 (= temp_3_0~849@ temp_3_1~922@)))) (=> (= temp_3_0~849@ temp_3_1~922@) (=> (= temp_4_0~1021@ (Sub (Mul (Mul (Sub b4~36@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ a4~34@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@))))) (=> (= temp_4_1~1086@ (Sub (Mul (Mul (Mul a4~34@ a4~34@) (Sub b4~36@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ a4~34@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@))))) (and (=> (= tmp%3@ (Sub b4~36@ c4~38@)) (=> (= tmp%4@ (Mul a4~34@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%4 (= temp_4_0~1021@ temp_4_1~1086@))))) (=> (= temp_4_0~1021@ temp_4_1~1086@) (=> (= temp_5_0~1175@ (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@))) (Add b5~44@ (Add (Mul d5~48@ b5~44@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~1228@ (Mul (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul c5~46@ c5~46@)) (Mul d5~48@ c5~46@)) (Add b5~44@ (Add (Mul d5~48@ b5~44@) (Mul a5~42@ b5~44@))))) (and (=> (= tmp%5@ (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@))) (=> (= tmp%6@ (Mul c5~46@ c5~46@)) (=> (= tmp%7@ (Mul d5~48@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%5 (= temp_5_0~1175@ temp_5_1~1228@)))))) (=> (= temp_5_0~1175@ temp_5_1~1228@) (=> (= temp_6_0~1343@ (Add (Mul b6~52@ 35) (Mul (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul d6~56@ 35) (Sub d6~56@ a6~50@))))) (=> (= temp_6_1~1408@ (Add (Mul b6~52@ 35) (Mul (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul 35 d6~56@) (Sub d6~56@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ 35) (=> %%location_label%%6 (= temp_6_0~1343@ temp_6_1~1408@))) (=> (= temp_6_0~1343@ temp_6_1~1408@) (=> (= temp_7_0~1521@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Sub d7~64@ c7~62@) a7~58@)) (Mul (Mul (Mul c7~62@ 95) (Mul c7~62@ a7~58@)) (Sub (Mul b7~60@ d7~64@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1594@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Sub d7~64@ c7~62@) a7~58@)) (Mul (Mul (Mul c7~62@ 95) (Mul c7~62@ a7~58@)) (Sub (Mul d7~64@ b7~60@) (Mul a7~58@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1521@ temp_7_1~1594@))) (=> (= temp_7_0~1521@ temp_7_1~1594@) (=> (= temp_8_0~1699@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul 19 b8~68@)) (Mul (Sub c8~70@ a8~66@) (Sub b8~68@ b8~68@))) (Mul (Sub (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1776@ (Mul (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul 19 b8~68@)) (Sub c8~70@ a8~66@)) (Sub b8~68@ b8~68@)) (Mul (Sub (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@))))) (and (=> (= tmp%8@ (Mul (Mul b8~68@ d8~72@) (Mul 19 b8~68@))) (=> (= tmp%9@ (Sub c8~70@ a8~66@)) (=> (= tmp%10@ (Sub b8~68@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%8 (= temp_8_0~1699@ temp_8_1~1776@)))))) (=> (= temp_8_0~1699@ temp_8_1~1776@) (=> (= temp_9_0~1903@ (Mul (Mul (Mul (Mul b9~76@ d9~80@) (Add b9~76@ a9~74@)) (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))) (Mul (Mul (Add b9~76@ c9~78@) (Mul c9~78@ a9~74@)) (Mul (Mul d9~80@ c9~78@) (Sub c9~78@ c9~78@))))) (=> (= temp_9_1~1968@ (Mul (Mul (Mul (Mul b9~76@ d9~80@) (Add b9~76@ a9~74@)) (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ d9~80@))) (Mul (Add b9~76@ c9~78@) (Mul (Mul c9~78@ a9~74@) (Mul (Mul d9~80@ c9~78@) (Sub c9~78@ c9~78@)))))) (and (=> (= tmp%11@ (Add b9~76@ c9~78@)) (=> (= tmp%12@ (Mul c9~78@ a9~74@)) (=> (= tmp%13@ (Mul (Mul d9~80@ c9~78@) (Sub c9~78@ c9~78@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%9 (= temp_9_0~1903@ temp_9_1~1968@)))))) (=> (= temp_9_0~1903@ temp_9_1~1968@) (=> (= temp_10_0~2075@ (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul d10~88@ a10~82@) c10~86@) (Mul (Mul d10~88@ c10~86@) a10~82@)))) (=> (= temp_10_1~2132@ (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ c10~86@))) (Mul (Mul (Mul d10~88@ a10~82@) c10~86@) (Mul a10~82@ (Mul d10~88@ c10~86@))))) (and (=> (= tmp%14@ (Mul d10~88@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ a10~82@) (=> %%location_label%%10 (= temp_10_0~2075@ temp_10_1~2132@)))) (=> (= temp_10_0~2075@ temp_10_1~2132@) (=> (= temp_11_0~2229@ (Mul (Mul (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ c11~94@))) (Mul (Mul (Mul a11~90@ a11~90@) (Add c11~94@ d11~96@)) (Add (Mul a11~90@ b11~92@) (Sub c11~94@ b11~92@))))) (=> (= temp_11_1~2294@ (Mul (Mul (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ d11~96@) (Mul d11~96@ c11~94@))) (Mul (Add (Mul a11~90@ b11~92@) (Sub c11~94@ b11~92@)) (Mul (Mul a11~90@ a11~90@) (Add c11~94@ d11~96@))))) (and (=> (= tmp%15@ (Mul (Mul a11~90@ a11~90@) (Add c11~94@ d11~96@))) (=> (= tmp%16@ (Add (Mul a11~90@ b11~92@) (Sub c11~94@ b11~92@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%11 (= temp_11_0~2229@ temp_11_1~2294@))))) (=> (= temp_11_0~2229@ temp_11_1~2294@) (=> (= temp_12_0~2411@ (Mul (Sub (Mul (Sub a12~98@ a12~98@) (Mul a12~98@ c12~102@)) (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ d12~104@))) (Mul (Add (Mul c12~102@ a12~98@) (Mul c12~102@ c12~102@)) (Sub (Add d12~104@ d12~104@) (Mul c12~102@ a12~98@))))) (=> (= temp_12_1~2476@ (Mul (Sub (Mul (Sub a12~98@ a12~98@) (Mul a12~98@ c12~102@)) (Mul (Mul b12~100@ a12~98@) (Mul d12~104@ d12~104@))) (Mul (Add (Mul c12~102@ a12~98@) (Mul c12~102@ c12~102@)) (Sub (Add d12~104@ d12~104@) (Mul c12~102@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d12~104@ d12~104@) (=> %%location_label%%12 (= temp_12_0~2411@ temp_12_1~2476@))) (=> (= temp_12_0~2411@ temp_12_1~2476@) (=> (= temp_13_0~2541@ (Add c13~110@ (Mul (Sub (Mul d13~112@ a13~106@) (Mul d13~112@ a13~106@)) (Mul (Mul b13~108@ a13~106@) (Mul b13~108@ b13~108@))))) (=> (= temp_13_1~2578@ (Add c13~110@ (Mul (Sub (Mul d13~112@ a13~106@) (Mul a13~106@ d13~112@)) (Mul (Mul b13~108@ a13~106@) (Mul b13~108@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d13~112@ a13~106@) (=> %%location_label%%13 (= temp_13_0~2541@ temp_13_1~2578@))) (=> (= temp_13_0~2541@ temp_13_1~2578@) (=> (= temp_14_0~2671@ (Add (Mul (Add (Sub b14~116@ c14~118@) (Mul a14~114@ c14~118@)) (Mul (Mul d14~120@ d14~120@) (Sub b14~116@ b14~116@))) (Mul (Add (Mul a14~114@ b14~116@) (Sub b14~116@ c14~118@)) (Mul (Add a14~114@ b14~116@) (Mul c14~118@ c14~118@))))) (=> (= temp_14_1~2736@ (Add (Mul (Add (Sub b14~116@ c14~118@) (Mul a14~114@ c14~118@)) (Mul (Mul d14~120@ d14~120@) (Sub b14~116@ b14~116@))) (Mul (Mul (Add a14~114@ b14~116@) (Mul c14~118@ c14~118@)) (Add (Mul a14~114@ b14~116@) (Sub b14~116@ c14~118@))))) (and (=> (= tmp%17@ (Add (Mul a14~114@ b14~116@) (Sub b14~116@ c14~118@))) (=> (= tmp%18@ (Mul (Add a14~114@ b14~116@) (Mul c14~118@ c14~118@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%14 (= temp_14_0~2671@ temp_14_1~2736@))))) (=> (= temp_14_0~2671@ temp_14_1~2736@) (=> (= temp_15_0~2865@ (Mul (Mul (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ c15~126@)) (Mul (Mul b15~124@ c15~126@) (Mul c15~126@ b15~124@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ c15~126@)) (Mul (Mul c15~126@ a15~122@) (Mul b15~124@ 27))))) (=> (= temp_15_1~2942@ (Mul (Mul (Mul b15~124@ (Mul c15~126@ (Mul d15~128@ c15~126@))) (Mul (Mul b15~124@ c15~126@) (Mul c15~126@ b15~124@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ c15~126@)) (Mul (Mul c15~126@ a15~122@) (Mul b15~124@ 27))))) (and (=> (= tmp%19@ (Mul d15~128@ c15~126@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b15~124@ c15~126@ tmp%19@) (=> %%location_label%%15 (= temp_15_0~2865@ temp_15_1~2942@)))) (=> (= temp_15_0~2865@ temp_15_1~2942@) (=> (= temp_16_0~3053@ (Mul (Mul (Mul (Mul 79 a16~130@) (Mul a16~130@ d16~136@)) (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ c16~134@))) (Add (Add (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Sub a16~130@ c16~134@) (Mul b16~132@ d16~136@))))) (=> (= temp_16_1~3174@ (Add (Mul (Mul (Mul (Mul 79 a16~130@) (Mul a16~130@ d16~136@)) (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ c16~134@))) (Add (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@))) (Mul (Mul (Mul (Mul 79 a16~130@) (Mul a16~130@ d16~136@)) (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ c16~134@))) (Mul (Sub a16~130@ c16~134@) (Mul b16~132@ d16~136@))))) (and (=> (= tmp%20@ (Mul (Mul (Mul 79 a16~130@) (Mul a16~130@ d16~136@)) (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ c16~134@)))) (=> (= tmp%21@ (Add (Mul d16~136@ d16~136@) (Mul a16~130@ a16~130@))) (=> (= tmp%22@ (Mul (Sub a16~130@ c16~134@) (Mul b16~132@ d16~136@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%16 (= temp_16_0~3053@ temp_16_1~3174@)))))) (=> (= temp_16_0~3053@ temp_16_1~3174@) (=> (= temp_17_0~3321@ (Mul (Sub b17~140@ (Mul (Mul c17~142@ c17~142@) (Add b17~140@ d17~144@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ b17~140@)) (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ c17~142@))))) (=> (= temp_17_1~3374@ (Mul (Sub b17~140@ (Mul (Mul c17~142@ c17~142@) (Add b17~140@ d17~144@))) (Mul (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ b17~140@)) (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d17~144@ c17~142@) (=> %%location_label%%17 (= temp_17_0~3321@ temp_17_1~3374@))) (=> (= temp_17_0~3321@ temp_17_1~3374@) (=> (= temp_18_0~3455@ (Mul (Mul (Mul c18~150@ c18~150@) (Mul (Mul d18~152@ b18~148@) (Mul d18~152@ d18~152@))) (Mul (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ c18~150@)) (Mul a18~146@ (Mul c18~150@ c18~150@))))) (=> (= temp_18_1~3508@ (Mul (Mul (Mul c18~150@ c18~150@) (Mul (Mul d18~152@ b18~148@) (Mul d18~152@ d18~152@))) (Mul (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ c18~150@)) (Mul a18~146@ (Mul c18~150@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c18~150@ c18~150@) (=> %%location_label%%18 (= temp_18_0~3455@ temp_18_1~3508@))) (=> (= temp_18_0~3455@ temp_18_1~3508@) (=> (= temp_19_0~3601@ (Mul (Mul (Mul (Mul b19~156@ b19~156@) (Sub a19~154@ b19~156@)) (Mul (Mul b19~156@ b19~156@) (Add c19~158@ a19~154@))) (Mul (Mul (Mul c19~158@ b19~156@) (Add b19~156@ a19~154@)) (Mul (Mul b19~156@ a19~154@) (Mul c19~158@ a19~154@))))) (=> (= temp_19_1~3666@ (Mul (Mul (Mul (Mul b19~156@ b19~156@) (Sub a19~154@ b19~156@)) (Mul (Add c19~158@ a19~154@) (Mul b19~156@ b19~156@))) (Mul (Mul (Mul c19~158@ b19~156@) (Add b19~156@ a19~154@)) (Mul (Mul b19~156@ a19~154@) (Mul c19~158@ a19~154@))))) (and (=> (= tmp%23@ (Mul b19~156@ b19~156@)) (=> (= tmp%24@ (Add c19~158@ a19~154@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> %%location_label%%19 (= temp_19_0~3601@ temp_19_1~3666@))))) (=> (= temp_19_0~3601@ temp_19_1~3666@) (=> (= temp_20_0~3763@ (Sub (Mul (Mul (Mul a20~162@ b20~164@) (Mul b20~164@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Mul d20~168@ d20~168@))) (Mul (Sub (Mul d20~168@ d20~168@) b20~164@) (Mul (Mul d20~168@ a20~162@) (Mul c20~166@ c20~166@))))) (=> (= temp_20_1~3824@ (Sub (Mul (Mul (Mul a20~162@ b20~164@) (Mul b20~164@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Mul d20~168@ d20~168@))) (Mul (Sub (Mul d20~168@ d20~168@) b20~164@) (Mul (Mul (Mul d20~168@ a20~162@) c20~166@) c20~166@)))) (and (=> (= tmp%25@ (Mul d20~168@ a20~162@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ c20~166@ c20~166@) (=> %%location_label%%20 (= temp_20_0~3763@ temp_20_1~3824@)))) (=> (= temp_20_0~3763@ temp_20_1~3824@) (=> (= temp_21_0~3919@ (Mul (Mul (Mul (Sub a21~170@ d21~176@) (Add d21~176@ a21~170@)) (Mul (Mul b21~172@ a21~170@) (Mul c21~174@ a21~170@))) (Mul (Mul (Mul a21~170@ d21~176@) (Mul d21~176@ a21~170@)) (Mul d21~176@ (Mul c21~174@ d21~176@))))) (=> (= temp_21_1~3988@ (Mul (Mul (Sub (Mul a21~170@ (Add d21~176@ a21~170@)) (Mul d21~176@ (Add d21~176@ a21~170@))) (Mul (Mul b21~172@ a21~170@) (Mul c21~174@ a21~170@))) (Mul (Mul (Mul a21~170@ d21~176@) (Mul d21~176@ a21~170@)) (Mul d21~176@ (Mul c21~174@ d21~176@))))) (=> (= tmp%26@ (Add d21~176@ a21~170@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a21~170@ d21~176@ tmp%26@) (=> %%location_label%%21 (= temp_21_0~3919@ temp_21_1~3988@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
