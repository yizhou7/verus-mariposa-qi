...
(set-info :comment ";; mariposa_data/v_nl//12779935399677393819/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_9_0~1753@ Int)
...
(declare-const temp_13_0~2353@ Int)
(declare-const temp_13_1~2414@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Add (Add (Mul b0~4@ b0~4@) (Sub b0~4@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~370@ (Sub (Add (Add (Mul b0~4@ b0~4@) (Sub b0~4@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ b0~4@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~463@ (Sub (Mul (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Add d1~16@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub a1~10@ a1~10@)) (Mul (Sub c1~14@ c1~14@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~528@ (Sub (Mul (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Add d1~16@ a1~10@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub a1~10@ a1~10@)) (Mul (Sub c1~14@ c1~14@) (Mul d1~16@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ a1~10@) (=> %%location_label%%1 (= temp_1_0~463@ temp_1_1~528@))) (=> (= temp_1_0~463@ temp_1_1~528@) (=> (= temp_2_0~621@ (Sub (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul c2~22@ b2~20@) (Sub a2~18@ d2~24@)) (Add (Mul a2~18@ b2~20@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~686@ (Sub (Mul (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul c2~22@ b2~20@) (Sub a2~18@ d2~24@)) (Add (Mul a2~18@ b2~20@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ c2~22@) (=> %%location_label%%2 (= temp_2_0~621@ temp_2_1~686@))) (=> (= temp_2_0~621@ temp_2_1~686@) (=> (= temp_3_0~791@ (Sub (Mul (Add (Mul 72 d3~32@) (Sub a3~26@ c3~30@)) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@))) (Mul c3~30@ (Mul (Mul d3~32@ d3~32@) (Sub 39 c3~30@))))) (=> (= temp_3_1~884@ (Sub (Add (Mul (Mul 72 d3~32@) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@))) (Mul (Sub a3~26@ c3~30@) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@)))) (Mul c3~30@ (Mul (Mul d3~32@ d3~32@) (Sub 39 c3~30@))))) (and (=> (= tmp%1@ (Mul 72 d3~32@)) (=> (= tmp%2@ (Sub a3~26@ c3~30@)) (=> (= tmp%3@ (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~791@ temp_3_1~884@)))))) (=> (= temp_3_0~791@ temp_3_1~884@) (=> (= temp_4_0~999@ (Sub (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@)) c4~38@) (Mul (Mul (Mul b4~36@ a4~34@) (Add a4~34@ b4~36@)) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@))))) (=> (= temp_4_1~1052@ (Sub (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@)) c4~38@) (Mul (Mul b4~36@ (Mul a4~34@ (Add a4~34@ b4~36@))) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@))))) (and (=> (= tmp%4@ (Add a4~34@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b4~36@ a4~34@ tmp%4@) (=> %%location_label%%4 (= temp_4_0~999@ temp_4_1~1052@)))) (=> (= temp_4_0~999@ temp_4_1~1052@) (=> (= temp_5_0~1147@ (Mul (Mul (Mul (Sub d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Add (Mul c5~46@ c5~46@) (Mul d5~48@ a5~42@))) (Mul (Sub d5~48@ (Mul c5~46@ c5~46@)) (Mul (Sub a5~42@ a5~42@) (Mul d5~48@ b5~44@))))) (=> (= temp_5_1~1208@ (Mul (Mul (Sub d5~48@ c5~46@) (Mul (Mul a5~42@ d5~48@) (Add (Mul c5~46@ c5~46@) (Mul d5~48@ a5~42@)))) (Mul (Sub d5~48@ (Mul c5~46@ c5~46@)) (Mul (Sub a5~42@ a5~42@) (Mul d5~48@ b5~44@))))) (and (=> (= tmp%5@ (Sub d5~48@ c5~46@)) (=> (= tmp%6@ (Mul a5~42@ d5~48@)) (=> (= tmp%7@ (Add (Mul c5~46@ c5~46@) (Mul d5~48@ a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%5 (= temp_5_0~1147@ temp_5_1~1208@)))))) (=> (= temp_5_0~1147@ temp_5_1~1208@) (=> (= temp_6_0~1331@ (Mul (Mul (Mul (Sub b6~52@ b6~52@) (Mul d6~56@ a6~50@)) (Add d6~56@ (Mul 19 c6~54@))) (Add (Sub (Mul a6~50@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@ a6~50@) (Sub c6~54@ b6~52@))))) (=> (= temp_6_1~1404@ (Mul (Mul (Mul (Sub b6~52@ b6~52@) (Mul d6~56@ a6~50@)) (Add d6~56@ (Mul 19 c6~54@))) (Add (Sub (Mul a6~50@ d6~56@) (Mul c6~54@ a6~50@)) (Mul c6~54@ (Mul a6~50@ (Sub c6~54@ b6~52@)))))) (and (=> (= tmp%8@ (Sub c6~54@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c6~54@ a6~50@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~1331@ temp_6_1~1404@)))) (=> (= temp_6_0~1331@ temp_6_1~1404@) (=> (= temp_7_0~1499@ (Add (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ c7~62@)) (Mul (Add a7~58@ a7~58@) d7~64@)) (Sub (Mul (Sub a7~58@ c7~62@) (Mul b7~60@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1564@ (Add (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ c7~62@)) (Add (Mul a7~58@ d7~64@) (Mul a7~58@ d7~64@))) (Sub (Mul (Sub a7~58@ c7~62@) (Mul b7~60@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. a7~58@ a7~58@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1499@ temp_7_1~1564@))) (=> (= temp_7_0~1499@ temp_7_1~1564@) (=> (= temp_8_0~1627@ (Add (Mul b8~68@ (Mul b8~68@ a8~66@)) (Mul (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ c8~70@)) b8~68@))) (=> (= temp_8_1~1660@ (Add (Mul b8~68@ (Mul a8~66@ b8~68@)) (Mul (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ c8~70@)) b8~68@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ a8~66@) (=> %%location_label%%8 (= temp_8_0~1627@ temp_8_1~1660@))) (=> (= temp_8_0~1627@ temp_8_1~1660@) (=> (= temp_9_0~1753@ (Sub (Add (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@)) (Sub (Add d9~80@ d9~80@) (Mul b9~76@ b9~76@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ d9~80@)) (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1818@ (Sub (Add (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@)) (Sub (Add d9~80@ d9~80@) (Mul b9~76@ b9~76@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ d9~80@)) (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b9~76@ b9~76@) (=> %%location_label%%9 (= temp_9_0~1753@ temp_9_1~1818@))) (=> (= temp_9_0~1753@ temp_9_1~1818@) (=> (= temp_10_0~1879@ (Mul c10~86@ (Add (Mul d10~88@ (Mul d10~88@ c10~86@)) (Mul (Add c10~86@ b10~84@) (Sub b10~84@ c10~86@))))) (=> (= temp_10_1~1916@ (Add (Mul c10~86@ (Mul d10~88@ (Mul d10~88@ c10~86@))) (Mul c10~86@ (Mul (Add c10~86@ b10~84@) (Sub b10~84@ c10~86@))))) (and (=> (= tmp%9@ (Mul d10~88@ (Mul d10~88@ c10~86@))) (=> (= tmp%10@ (Mul (Add c10~86@ b10~84@) (Sub b10~84@ c10~86@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c10~86@ tmp%9@ tmp%10@) (=> %%location_label%%10 (= temp_10_0~1879@ temp_10_1~1916@))))) (=> (= temp_10_0~1879@ temp_10_1~1916@) (=> (= temp_11_0~2027@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul c11~94@ a11~90@)) (Mul a11~90@ (Mul c11~94@ c11~94@))) (Mul (Mul (Sub c11~94@ c11~94@) (Mul c11~94@ c11~94@)) (Add (Mul b11~92@ d11~96@) (Mul c11~94@ d11~96@))))) (=> (= temp_11_1~2088@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ c11~94@)) (Mul a11~90@ (Mul c11~94@ c11~94@))) (Mul (Mul (Sub c11~94@ c11~94@) (Mul c11~94@ c11~94@)) (Add (Mul b11~92@ d11~96@) (Mul c11~94@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c11~94@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2027@ temp_11_1~2088@))) (=> (= temp_11_0~2027@ temp_11_1~2088@) (=> (= temp_12_0~2189@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul 91 b12~100@))) (Mul (Mul (Mul b12~100@ b12~100@) (Sub c12~102@ c12~102@)) (Mul d12~104@ (Mul a12~98@ a12~98@))))) (=> (= temp_12_1~2262@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul 91 b12~100@))) (Mul (Mul (Mul b12~100@ b12~100@) (Sub c12~102@ c12~102@)) (Mul (Mul d12~104@ a12~98@) a12~98@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. d12~104@ a12~98@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2189@ temp_12_1~2262@))) (=> (= temp_12_0~2189@ temp_12_1~2262@) (=> (= temp_13_0~2353@ (Mul (Mul (Mul (Add b13~108@ b13~108@) (Mul b13~108@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Sub b13~108@ c13~110@))) (Mul (Add (Mul b13~108@ b13~108@) (Mul d13~112@ b13~108@)) (Mul (Mul a13~106@ d13~112@) d13~112@)))) (=> (= temp_13_1~2414@ (Mul (Mul (Add b13~108@ b13~108@) (Mul (Mul b13~108@ d13~112@) (Mul (Mul c13~110@ c13~110@) (Sub b13~108@ c13~110@)))) (Mul (Add (Mul b13~108@ b13~108@) (Mul d13~112@ b13~108@)) (Mul (Mul a13~106@ d13~112@) d13~112@)))) (=> (= tmp%11@ (Add b13~108@ b13~108@)) (=> (= tmp%12@ (Mul b13~108@ d13~112@)) (=> (= tmp%13@ (Mul (Mul c13~110@ c13~110@) (Sub b13~108@ c13~110@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%13 (= temp_13_0~2353@ temp_13_1~2414@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
