...
(push)
 ...
 (declare-const temp_10_0~1793@ Int)
 ...
 (declare-const temp_13_1~2300@ Int)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~386@)
        (=>
         (= temp_1_0~467@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@
              a1~10@
             ) a1~10@
            )
         ...
         (=>
          (= temp_1_1~524@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@
               a1~10@
              ) a1~10@
             )
            ) (Sub (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Sub b1~12@ c1~14@) a1~10@))
          ...
          (and
           ...
           (=>
            (= temp_1_0~467@ temp_1_1~524@)
            (=>
             (= temp_2_0~597@ (Mul (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@
                  b2~20@
                 ) (Mul d2~24@ a2~18@)
                )
             ...
             (=>
              (= temp_2_1~646@ (Mul (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@
                   b2~20@
                  ) (Mul d2~24@ a2~18@)
                 )
              ...
              (and
               ...
               (=>
                (= temp_2_0~597@ temp_2_1~646@)
                (=>
                 (= temp_3_0~747@ (Sub (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@
                      b3~28@
                     ) (Mul d3~32@ d3~32@)
                    )
                 ...
                 (=>
                  (= temp_3_1~824@ (Sub (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@
                       b3~28@
                      ) (Mul d3~32@ d3~32@)
                     )
                    ) (Mul (Mul (Mul d3~32@ a3~26@) (Mul 89 c3~30@)) (Sub (Mul c3~30@ c3~30@) (Mul a3~26@
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~747@ temp_3_1~824@)
                   ))
                   (=>
                    (= temp_3_0~747@ temp_3_1~824@)
                    (=>
                     (= temp_4_0~909@ (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Sub d4~40@
                          c4~38@
                         ) (Mul b4~36@ c4~38@)
                        )
                     ...
                     (=>
                      (= temp_4_1~970@ (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Sub d4~40@
                           c4~38@
                          ) (Mul b4~36@ c4~38@)
                         )
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~909@ temp_4_1~970@)
                        (=>
                         (= temp_5_0~1059@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@
                              b5~44@
                             ) (Mul b5~44@ c5~46@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1124@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@
                               b5~44@
                              ) (Mul b5~44@ c5~46@)
                             )
                          ...
                          (and
                           ...
                           (=>
                            (= temp_5_0~1059@ temp_5_1~1124@)
                            (=>
                             (= temp_6_0~1209@ (Sub (Mul (Mul (Sub d6~56@ c6~54@) (Add b6~52@ d6~56@)) (Mul (Mul c6~54@
                                  a6~50@
                                 ) (Mul d6~56@ d6~56@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1270@ (Sub (Mul (Mul (Sub d6~56@ c6~54@) (Add b6~52@ d6~56@)) (Mul (Mul c6~54@
                                   a6~50@
                                  ) (Mul d6~56@ d6~56@)
                                 )
                              ...
                              (and
                               ...
                               (=>
                                (= temp_6_0~1209@ temp_6_1~1270@)
                                (=>
                                 (= temp_7_0~1359@ (Mul (Mul (Add (Mul c7~62@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@
                                      a7~58@
                                     ) (Mul d7~64@ b7~60@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1424@ (Mul (Mul (Add (Mul c7~62@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul c7~62@
                                       a7~58@
                                      ) (Mul d7~64@ b7~60@)
                                     )
                                    ) (Mul (Add (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@)) (Add (Mul c7~62@ a7~58@) (Mul a7~58@
                                  ...
                                  (and
                                   ...
                                   (=>
                                    (= temp_7_0~1359@ temp_7_1~1424@)
                                    (=>
                                     (= temp_8_0~1509@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@
                                          b8~68@
                                         ) (Add c8~70@ d8~72@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1570@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@
                                           b8~68@
                                          ) (Add c8~70@ d8~72@)
                                         )
                                      ...
                                      (and
                                       ...
                                       (=>
                                        (= temp_8_0~1509@ temp_8_1~1570@)
                                        (=>
                                         (= temp_9_0~1655@ (Mul (Mul (Mul d9~80@ (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ c9~78@)
                                             (Mul a9~74@ d9~80@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1716@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) d9~80@) (Mul (Mul a9~74@ c9~78@)
                                              (Mul a9~74@ d9~80@)
                                             )
                                            ) (Mul (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@
                                               b9~76@
                                          ...
                                          (and
                                           ...
                                           (=>
                                            (= temp_9_0~1655@ temp_9_1~1716@)
                                            (=>
                                             (= temp_10_0~1793@ (Sub (Add (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (
                                                  Sub c10~86@ c10~86@
                                                 ) (Mul d10~88@ d10~88@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1846@ (Sub (Add (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (
                                                   Sub c10~86@ c10~86@
                                                  ) (Mul d10~88@ d10~88@)
                                                 )
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1793@ temp_10_1~1846@)
                                               ))
                                               (=>
                                                (= temp_10_0~1793@ temp_10_1~1846@)
                                                (=>
                                                 (= temp_11_0~1935@ (Mul (Add (Mul (Mul d11~96@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (
                                                      Mul c11~94@ c11~94@
                                                     ) (Mul d11~96@ a11~90@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2008@ (Mul (Add (Mul (Mul d11~96@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (
                                                       Mul c11~94@ c11~94@
                                                      ) (Mul d11~96@ a11~90@)
                                                     )
                                                  ...
                                                  (and
                                                   ...
                                                   (=>
                                                    (= temp_11_0~1935@ temp_11_1~2008@)
                                                    (=>
                                                     (= temp_12_0~2089@ (Mul (Sub (Mul c12~102@ (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@
                                                          d12~104@
                                                         ) (Mul c12~102@ c12~102@)
                                                        )
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2146@ (Mul (Sub (Mul c12~102@ (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@
                                                           d12~104@
                                                          ) (Mul c12~102@ c12~102@)
                                                         )
                                                      ...
                                                      (and
                                                       ...
                                                       (=>
                                                        (= temp_12_0~2089@ temp_12_1~2146@)
                                                        (=>
                                                         (= temp_13_0~2235@ (Mul (Mul (Mul (Mul b13~108@ b13~108@) (Mul d13~112@ d13~112@)) (
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2300@ (Mul (Mul (Mul (Mul b13~108@ b13~108@) (Mul d13~112@ d13~112@)) (
                                                              Sub (Mul c13~110@ a13~106@) (Mul a13~106@ b13~108@)
                                                             )
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2235@ temp_13_1~2300@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2235@ temp_13_1~2300@)
                                                            (=>
                                                             (= temp_14_0~2397@ (Mul (Mul (Mul (Mul 96 c14~118@) (Mul a14~114@ d14~120@)) (Mul (Sub
                                                                  d14~120@ d14~120@
                                                                 ) (Mul c14~118@ d14~120@)
                                                                )
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2470@ (Mul (Mul (Mul (Mul 96 c14~118@) (Mul a14~114@ d14~120@)) (Mul (Sub
                                                                   d14~120@ d14~120@
                                                                  ) (Mul d14~120@ c14~118@)
                                                                 )
                                                                ) (Mul (Mul (Mul c14~118@ d14~120@) (Mul a14~114@ a14~114@)) (Mul (Add b14~116@ b14~116@)
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2397@ temp_14_1~2470@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2397@ temp_14_1~2470@)
                                                                (=>
                                                                 (= temp_15_0~2551@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Add d15~128@ b15~124@)) (
                                                                     Mul (Sub a15~122@ c15~126@) (Add d15~128@ a15~122@)
                                                                    )
                                                                   ) (Sub (Mul c15~126@ (Mul a15~122@ b15~124@)) (Mul c15~126@ (Mul c15~126@ a15~122@)))
                                                                 ))
                                                                 (=>
                                                                  (= temp_15_1~2616@ (Mul (Mul (Add (Mul (Mul d15~128@ c15~126@) d15~128@) (Mul (Mul d15~128@
                                                                        c15~126@
                                                                       ) b15~124@
                                                                      )
                                                                     ) (Mul (Sub a15~122@ c15~126@) (Add d15~128@ a15~122@))
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2551@ temp_15_1~2616@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2551@ temp_15_1~2616@)
                                                                    (=>
                                                                     (= temp_16_0~2705@ (Mul (Mul (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ d16~136@)) (
                                                                     ...
                                                                     (=>
                                                                      (= temp_16_1~2770@ (Mul (Mul (Mul (Mul b16~132@ c16~134@) (Mul d16~136@ a16~130@)) (
                                                                          Mul (Mul d16~136@ a16~130@) (Mul d16~136@ c16~134@)
                                                                         )
                                                                        ) (Mul (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@)) (Mul (Add c16~134@ c16~134@)
                                                                          (Mul c16~134@ a16~130@)
