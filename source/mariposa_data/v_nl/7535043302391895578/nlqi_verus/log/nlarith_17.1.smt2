...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Mul (Sub (Sub b0~4@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Add b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~386@ (Add (Sub (Mul (Sub b0~4@ c0~6@) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))) (Mul (Mul b0~4@ a0~2@) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@)))) (Mul (Mul (Mul c0~6@ d0~8@) (Add b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~386@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~458@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ a1~10@) a1~10@)) (Sub (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Sub b1~12@ c1~14@) a1~10@)))) (=> (= temp_1_1~515@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ a1~10@) a1~10@)) (Sub (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Sub b1~12@ c1~14@) a1~10@)))) (=> (= tmp%2@ (= temp_1_0~458@ temp_1_1~515@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~579@ (Mul (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@))) (Mul d2~24@ (Mul (Add b2~20@ b2~20@) c2~22@)))) (=> (= temp_2_1~628@ (Mul (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@))) (Mul d2~24@ (Mul c2~22@ (Add b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~579@ temp_2_1~628@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~720@ (Sub (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul 89 c3~30@)) (Sub (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~797@ (Sub (Mul (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul 89 c3~30@)) (Sub (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~720@ temp_3_1~797@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~873@ (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul d4~40@ d4~40@) a4~34@) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~934@ (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul (Mul d4~40@ d4~40@) a4~34@) (Mul c4~38@ c4~38@)) (Mul a4~34@ b4~36@)))) (=> (= tmp%5@ (= temp_4_0~873@ temp_4_1~934@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1014@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ c5~46@))) (Mul (Mul (Add a5~42@ d5~48@) (Mul a5~42@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1079@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul a5~42@ b5~44@) (Add a5~42@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~1014@ temp_5_1~1079@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1155@ (Sub (Mul (Mul (Sub d6~56@ c6~54@) (Add b6~52@ d6~56@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@))) (Add (Mul b6~52@ (Mul c6~54@ a6~50@)) (Mul (Mul b6~52@ d6~56@) (Sub b6~52@ c6~54@))))) (=> (= temp_6_1~1216@ (Sub (Mul (Mul (Sub d6~56@ c6~54@) (Add b6~52@ d6~56@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@))) (Add (Mul b6~52@ (Mul c6~54@ a6~50@)) (Mul b6~52@ (Mul d6~56@ (Sub b6~52@ c6~54@)))))) (=> (= tmp%7@ (= temp_6_0~1155@ temp_6_1~1216@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1296@ (Mul (Mul (Add (Mul c7~62@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@))) (Mul (Add (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@)) (Add (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1361@ (Mul (Mul (Add (Mul c7~62@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@))) (Mul (Add (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@)) (Add (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1296@ temp_7_1~1361@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1437@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ b8~68@) (Add c8~70@ d8~72@))) (Mul (Mul (Mul c8~70@ d8~72@) a8~66@) (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1498@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ b8~68@) (Add c8~70@ d8~72@))) (Mul (Mul (Mul c8~70@ d8~72@) a8~66@) (Mul b8~68@ (Mul b8~68@ (Mul c8~70@ d8~72@)))))) (=> (= tmp%9@ (= temp_8_0~1437@ temp_8_1~1498@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1574@ (Mul (Mul (Mul d9~80@ (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~1635@ (Mul (Mul (Mul (Mul c9~78@ b9~76@) d9~80@) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul a9~74@ b9~76@))))) (=> (= tmp%10@ (= temp_9_0~1574@ temp_9_1~1635@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1703@ (Sub (Add (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Sub c10~86@ c10~86@) (Mul d10~88@ d10~88@))) (Mul (Sub (Mul d10~88@ b10~84@) (Sub d10~88@ b10~84@)) d10~88@))) (=> (= temp_10_1~1756@ (Sub (Add (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Sub c10~86@ c10~86@) (Mul d10~88@ d10~88@))) (Mul (Sub (Mul b10~84@ d10~88@) (Sub d10~88@ b10~84@)) d10~88@))) (=> (= tmp%11@ (= temp_10_0~1703@ temp_10_1~1756@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1836@ (Mul (Add (Mul (Mul d11~96@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul d11~96@ a11~90@))) (Mul (Mul (Mul a11~90@ b11~92@) (Add b11~92@ d11~96@)) (Add (Mul a11~90@ d11~96@) (Mul a11~90@ b11~92@))))) (=> (= temp_11_1~1909@ (Mul (Add (Mul (Mul d11~96@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul d11~96@ a11~90@))) (Mul (Add (Mul (Mul a11~90@ b11~92@) b11~92@) (Mul (Mul a11~90@ b11~92@) d11~96@)) (Add (Mul a11~90@ d11~96@) (Mul a11~90@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1836@ temp_11_1~1909@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1981@ (Mul (Sub (Mul c12~102@ (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) (Mul (Mul b12~100@ b12~100@) c12~102@)))) (=> (= temp_12_1~2038@ (Mul (Sub (Mul c12~102@ (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ d12~104@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) (Mul b12~100@ (Mul b12~100@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~1981@ temp_12_1~2038@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2118@ (Mul (Mul (Mul (Mul b13~108@ b13~108@) (Mul d13~112@ d13~112@)) (Sub (Mul c13~110@ a13~106@) (Mul a13~106@ b13~108@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul d13~112@ a13~106@)) (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ a13~106@))))) (=> (= temp_13_1~2183@ (Mul (Mul (Mul (Mul b13~108@ b13~108@) (Mul d13~112@ d13~112@)) (Sub (Mul c13~110@ a13~106@) (Mul a13~106@ b13~108@))) (Mul (Mul (Mul d13~112@ a13~106@) (Mul d13~112@ c13~110@)) (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2118@ temp_13_1~2183@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2271@ (Mul (Mul (Mul (Mul 96 c14~118@) (Mul a14~114@ d14~120@)) (Mul (Sub d14~120@ d14~120@) (Mul c14~118@ d14~120@))) (Mul (Mul (Mul c14~118@ d14~120@) (Mul a14~114@ a14~114@)) (Mul (Add b14~116@ b14~116@) b14~116@)))) (=> (= temp_14_1~2344@ (Mul (Mul (Mul (Mul 96 c14~118@) (Mul a14~114@ d14~120@)) (Mul (Sub d14~120@ d14~120@) (Mul d14~120@ c14~118@))) (Mul (Mul (Mul c14~118@ d14~120@) (Mul a14~114@ a14~114@)) (Mul (Add b14~116@ b14~116@) b14~116@)))) (=> (= tmp%15@ (= temp_14_0~2271@ temp_14_1~2344@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2416@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Add d15~128@ b15~124@)) (Mul (Sub a15~122@ c15~126@) (Add d15~128@ a15~122@))) (Sub (Mul c15~126@ (Mul a15~122@ b15~124@)) (Mul c15~126@ (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~2481@ (Mul (Mul (Add (Mul (Mul d15~128@ c15~126@) d15~128@) (Mul (Mul d15~128@ c15~126@) b15~124@)) (Mul (Sub a15~122@ c15~126@) (Add d15~128@ a15~122@))) (Sub (Mul c15~126@ (Mul a15~122@ b15~124@)) (Mul c15~126@ (Mul c15~126@ a15~122@))))) (=> (= tmp%16@ (= temp_15_0~2416@ temp_15_1~2481@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2561@ (Mul (Mul (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ d16~136@)) (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ c16~134@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@)) (Mul (Add c16~134@ c16~134@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2626@ (Mul (Mul (Mul (Mul b16~132@ c16~134@) (Mul d16~136@ a16~130@)) (Mul (Mul d16~136@ a16~130@) (Mul d16~136@ c16~134@))) (Mul (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@)) (Mul (Add c16~134@ c16~134@) (Mul c16~134@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2561@ temp_16_1~2626@)) (=> %%location_label%%16 tmp%17@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
