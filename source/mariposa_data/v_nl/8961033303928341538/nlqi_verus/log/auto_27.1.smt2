...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Add (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@))) (Mul a0~2@ (Mul (Sub a0~2@ a0~2@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~366@ (Add (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul a0~2@ (Mul (Sub a0~2@ a0~2@) (Mul c0~6@ c0~6@)))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@)) (Mul a0~2@ (Mul (Sub a0~2@ a0~2@) (Mul c0~6@ c0~6@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~366@))) (=> (= temp_0_0~293@ temp_0_1~366@) (=> (= temp_1_0~443@ (Mul (Mul (Add (Sub a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ b1~12@))) (Mul d1~16@ (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~496@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ b1~12@)) (Add (Sub a1~10@ d1~16@) (Mul d1~16@ c1~14@))) (Mul d1~16@ (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~443@ temp_1_1~496@))) (=> (= temp_1_0~443@ temp_1_1~496@) (=> (= temp_2_0~569@ (Add (Mul (Mul b2~20@ (Mul d2~24@ b2~20@)) (Sub (Add b2~20@ a2~18@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@)) c2~22@))) (=> (= temp_2_1~618@ (Add (Mul (Mul (Mul d2~24@ b2~20@) b2~20@) (Sub (Add b2~20@ a2~18@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@)) c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~569@ temp_2_1~618@))) (=> (= temp_2_0~569@ temp_2_1~618@) (=> (= temp_3_0~703@ (Mul (Mul (Mul (Add a3~26@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul a3~26@ d3~32@) b3~28@) (Mul (Mul c3~30@ c3~30@) (Add c3~30@ d3~32@))))) (=> (= temp_3_1~764@ (Mul (Mul (Mul (Add a3~26@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul a3~26@ d3~32@) b3~28@) (Mul c3~30@ (Mul c3~30@ (Add c3~30@ d3~32@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~703@ temp_3_1~764@))) (=> (= temp_3_0~703@ temp_3_1~764@) (=> (= temp_4_0~833@ (Add (Mul (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ c4~38@) a4~34@)) (Mul c4~38@ (Mul (Mul c4~38@ a4~34@) d4~40@)))) (=> (= temp_4_1~878@ (Add (Mul (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ c4~38@) a4~34@)) (Mul c4~38@ (Mul d4~40@ (Mul c4~38@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~833@ temp_4_1~878@))) (=> (= temp_4_0~833@ temp_4_1~878@) (=> (= temp_5_0~963@ (Add (Add (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ a5~42@)) (Mul (Add c5~46@ b5~44@) (Mul a5~42@ b5~44@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@)) (Mul a5~42@ (Sub a5~42@ b5~44@))))) (=> (= temp_5_1~1024@ (Add (Add (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ d5~48@)) (Mul (Add c5~46@ b5~44@) (Mul a5~42@ b5~44@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ a5~42@)) (Mul a5~42@ (Sub a5~42@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~963@ temp_5_1~1024@))) (=> (= temp_5_0~963@ temp_5_1~1024@) (=> (= temp_6_0~1121@ (Add (Sub (Mul (Add b6~52@ b6~52@) (Mul c6~54@ 86)) (Sub (Sub d6~56@ a6~50@) (Sub c6~54@ c6~54@))) (Sub (Mul b6~52@ (Mul d6~56@ a6~50@)) (Sub (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1194@ (Add (Sub (Mul (Add b6~52@ b6~52@) (Mul c6~54@ 86)) (Sub (Sub d6~56@ a6~50@) (Sub c6~54@ c6~54@))) (Sub (Mul (Mul b6~52@ d6~56@) a6~50@) (Sub (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1121@ temp_6_1~1194@))) (=> (= temp_6_0~1121@ temp_6_1~1194@) (=> (= temp_7_0~1283@ (Sub (Mul (Mul (Mul b7~60@ d7~64@) (Sub b7~60@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@))) (Sub (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@)) (Add (Sub d7~64@ b7~60@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1348@ (Sub (Mul (Mul (Mul b7~60@ d7~64@) (Sub b7~60@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@))) (Sub (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@)) (Add (Sub d7~64@ b7~60@) (Mul a7~58@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1283@ temp_7_1~1348@))) (=> (= temp_7_0~1283@ temp_7_1~1348@) (=> (= temp_8_0~1413@ (Mul (Sub b8~68@ (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@)) d8~72@))) (=> (= temp_8_1~1454@ (Mul (Sub b8~68@ (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@)) d8~72@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1413@ temp_8_1~1454@))) (=> (= temp_8_0~1413@ temp_8_1~1454@) (=> (= temp_9_0~1543@ (Mul (Mul (Mul (Sub b9~76@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ d9~80@))) (Mul (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ a9~74@)) (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ c9~78@))))) (=> (= temp_9_1~1608@ (Mul (Mul (Mul (Sub b9~76@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul c9~78@ d9~80@))) (Mul (Mul a9~74@ (Mul c9~78@ (Mul d9~80@ a9~74@))) (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1543@ temp_9_1~1608@))) (=> (= temp_9_0~1543@ temp_9_1~1608@) (=> (= temp_10_0~1693@ (Sub (Mul (Mul (Mul b10~84@ d10~88@) (Mul a10~82@ d10~88@)) b10~84@) (Mul (Sub (Mul a10~82@ b10~84@) (Mul c10~86@ a10~82@)) (Mul a10~82@ (Mul 30 a10~82@))))) (=> (= temp_10_1~1754@ (Sub (Mul (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ d10~88@)) b10~84@) (Mul (Sub (Mul a10~82@ b10~84@) (Mul c10~86@ a10~82@)) (Mul a10~82@ (Mul 30 a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1693@ temp_10_1~1754@))) (=> (= temp_10_0~1693@ temp_10_1~1754@) (=> (= temp_11_0~1815@ (Add (Mul (Sub (Sub d11~96@ b11~92@) (Mul c11~94@ c11~94@)) (Mul (Mul b11~92@ c11~94@) (Mul a11~90@ a11~90@))) c11~94@)) (=> (= temp_11_1~1852@ (Add (Mul (Sub (Sub d11~96@ b11~92@) (Mul c11~94@ c11~94@)) (Mul (Mul (Mul b11~92@ c11~94@) a11~90@) a11~90@)) c11~94@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1815@ temp_11_1~1852@))) (=> (= temp_11_0~1815@ temp_11_1~1852@) (=> (= temp_12_0~1941@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ a12~98@)) (Sub (Sub d12~104@ b12~100@) (Mul d12~104@ a12~98@))) (Mul (Sub (Mul b12~100@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ a12~98@))))) (=> (= temp_12_1~2006@ (Mul (Mul (Mul a12~98@ c12~102@) (Mul (Mul b12~100@ a12~98@) (Sub (Sub d12~104@ b12~100@) (Mul d12~104@ a12~98@)))) (Mul (Sub (Mul b12~100@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~1941@ temp_12_1~2006@))) (=> (= temp_12_0~1941@ temp_12_1~2006@) (=> (= temp_13_0~2075@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) b13~108@) (Mul (Add c13~110@ c13~110@) (Mul c13~110@ d13~112@))) (Mul b13~108@ (Sub a13~106@ (Mul c13~110@ c13~110@))))) (=> (= temp_13_1~2120@ (Mul (Mul (Mul (Mul c13~110@ c13~110@) b13~108@) (Mul (Mul c13~110@ d13~112@) (Add c13~110@ c13~110@))) (Mul b13~108@ (Sub a13~106@ (Mul c13~110@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2075@ temp_13_1~2120@))) (=> (= temp_13_0~2075@ temp_13_1~2120@) (=> (= temp_14_0~2209@ (Mul (Sub (Sub (Mul c14~118@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Add b14~116@ a14~114@) (Mul b14~116@ d14~120@))) (Mul (Mul (Mul c14~118@ b14~116@) (Mul b14~116@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@))))) (=> (= temp_14_1~2274@ (Mul (Sub (Sub (Mul c14~118@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Add b14~116@ a14~114@) (Mul b14~116@ d14~120@))) (Mul (Mul (Mul b14~116@ b14~116@) (Mul c14~118@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul d14~120@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2209@ temp_14_1~2274@))) (=> (= temp_14_0~2209@ temp_14_1~2274@) (=> (= temp_15_0~2363@ (Mul (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ c15~126@)) (Add (Mul d15~128@ a15~122@) (Mul a15~122@ b15~124@))) (Mul (Sub (Mul b15~124@ d15~128@) (Mul b15~124@ a15~122@)) (Sub (Mul c15~126@ a15~122@) (Mul c15~126@ d15~128@))))) (=> (= temp_15_1~2428@ (Mul (Mul (Mul (Mul b15~124@ c15~126@) (Mul a15~122@ d15~128@)) (Add (Mul d15~128@ a15~122@) (Mul a15~122@ b15~124@))) (Mul (Sub (Mul b15~124@ d15~128@) (Mul b15~124@ a15~122@)) (Sub (Mul c15~126@ a15~122@) (Mul c15~126@ d15~128@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2363@ temp_15_1~2428@))) (=> (= temp_15_0~2363@ temp_15_1~2428@) (=> (= temp_16_0~2505@ (Mul (Sub a16~130@ (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@))) (Mul (Mul (Add b16~132@ c16~134@) (Mul b16~132@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Sub d16~136@ b16~132@))))) (=> (= temp_16_1~2558@ (Mul (Sub a16~130@ (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ a16~130@))) (Mul (Mul (Add b16~132@ c16~134@) (Mul a16~130@ b16~132@)) (Mul (Mul b16~132@ d16~136@) (Sub d16~136@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2505@ temp_16_1~2558@))) (=> (= temp_16_0~2505@ temp_16_1~2558@) (=> (= temp_17_0~2647@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ c17~142@) (Add a17~138@ b17~140@))) (Mul (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ b17~140@)) (Add (Sub b17~140@ d17~144@) (Mul a17~138@ d17~144@))))) (=> (= temp_17_1~2712@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Mul b17~140@ c17~142@) (Add a17~138@ b17~140@))) (Mul (Add (Sub b17~140@ d17~144@) (Mul a17~138@ d17~144@)) (Mul (Mul a17~138@ c17~142@) (Mul b17~140@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2647@ temp_17_1~2712@))) (=> (= temp_17_0~2647@ temp_17_1~2712@) (=> (= temp_18_0~2773@ (Mul (Mul (Mul (Mul b18~148@ b18~148@) (Mul c18~150@ b18~148@)) (Mul (Mul a18~146@ a18~146@) (Mul a18~146@ d18~152@))) d18~152@)) (=> (= temp_18_1~2810@ (Mul (Mul (Mul b18~148@ b18~148@) (Mul c18~150@ b18~148@)) (Mul (Mul (Mul a18~146@ a18~146@) (Mul a18~146@ d18~152@)) d18~152@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2773@ temp_18_1~2810@))) (=> (= temp_18_0~2773@ temp_18_1~2810@) (=> (= temp_19_0~2899@ (Sub (Add (Mul (Mul d19~160@ b19~156@) (Mul d19~160@ b19~156@)) (Add (Mul a19~154@ b19~156@) (Mul c19~158@ a19~154@))) (Add (Add (Sub a19~154@ d19~160@) (Mul b19~156@ a19~154@)) (Mul (Mul b19~156@ b19~156@) (Mul d19~160@ a19~154@))))) (=> (= temp_19_1~2964@ (Sub (Add (Mul (Mul d19~160@ b19~156@) (Mul d19~160@ b19~156@)) (Add (Mul a19~154@ b19~156@) (Mul c19~158@ a19~154@))) (Add (Add (Sub a19~154@ d19~160@) (Mul b19~156@ a19~154@)) (Mul (Mul b19~156@ b19~156@) (Mul d19~160@ a19~154@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~2899@ temp_19_1~2964@))) (=> (= temp_19_0~2899@ temp_19_1~2964@) (=> (= temp_20_0~3029@ (Mul (Sub a20~162@ b20~164@) (Mul (Add (Mul c20~166@ b20~164@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ d20~168@) (Mul c20~166@ a20~162@))))) (=> (= temp_20_1~3070@ (Mul (Sub a20~162@ b20~164@) (Mul (Add (Mul c20~166@ b20~164@) (Mul d20~168@ c20~166@)) (Mul (Mul c20~166@ a20~162@) (Mul b20~164@ d20~168@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3029@ temp_20_1~3070@))) (=> (= temp_20_0~3029@ temp_20_1~3070@) (=> (= temp_21_0~3147@ (Mul (Add (Mul (Mul d21~176@ c21~174@) (Mul d21~176@ a21~170@)) (Mul (Mul c21~174@ c21~174@) (Mul d21~176@ a21~170@))) (Sub b21~172@ (Mul (Mul b21~172@ d21~176@) (Add c21~174@ a21~170@))))) (=> (= temp_21_1~3192@ (Mul (Mul (Add (Mul d21~176@ c21~174@) (Mul c21~174@ c21~174@)) (Mul d21~176@ a21~170@)) (Sub b21~172@ (Mul (Mul b21~172@ d21~176@) (Add c21~174@ a21~170@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3147@ temp_21_1~3192@))) (=> (= temp_21_0~3147@ temp_21_1~3192@) (=> (= temp_22_0~3293@ (Mul (Add (Add (Mul 30 a22~178@) (Mul b22~180@ b22~180@)) (Mul (Mul d22~184@ b22~180@) (Mul c22~182@ c22~182@))) (Add (Mul (Sub d22~184@ d22~184@) (Mul b22~180@ c22~182@)) (Mul (Mul a22~178@ c22~182@) (Mul a22~178@ d22~184@))))) (=> (= temp_22_1~3370@ (Mul (Add (Add (Mul 30 a22~178@) (Mul b22~180@ b22~180@)) (Mul (Mul d22~184@ b22~180@) (Mul c22~182@ c22~182@))) (Add (Mul (Sub d22~184@ d22~184@) (Mul b22~180@ c22~182@)) (Mul (Mul a22~178@ c22~182@) (Mul d22~184@ a22~178@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3293@ temp_22_1~3370@))) (=> (= temp_22_0~3293@ temp_22_1~3370@) (=> (= temp_23_0~3439@ (Mul (Mul (Mul (Mul b23~188@ b23~188@) d23~192@) (Mul (Mul d23~192@ a23~186@) (Add a23~186@ c23~190@))) (Mul a23~186@ (Sub (Add c23~190@ b23~188@) b23~188@)))) (=> (= temp_23_1~3484@ (Mul (Mul (Mul (Mul b23~188@ b23~188@) d23~192@) (Mul (Mul d23~192@ a23~186@) (Add a23~186@ c23~190@))) (Mul (Sub (Add c23~190@ b23~188@) b23~188@) a23~186@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3439@ temp_23_1~3484@))) (=> (= temp_23_0~3439@ temp_23_1~3484@) (=> (= temp_24_0~3561@ (Add (Mul (Mul (Sub b24~196@ b24~196@) (Mul c24~198@ d24~200@)) a24~194@) (Mul (Mul (Sub a24~194@ a24~194@) (Sub c24~198@ d24~200@)) (Mul (Mul c24~198@ d24~200@) (Mul b24~196@ c24~198@))))) (=> (= temp_24_1~3614@ (Add (Mul (Mul (Sub b24~196@ b24~196@) (Mul c24~198@ d24~200@)) a24~194@) (Mul (Mul (Mul c24~198@ d24~200@) (Mul b24~196@ c24~198@)) (Mul (Sub a24~194@ a24~194@) (Sub c24~198@ d24~200@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3561@ temp_24_1~3614@))) (=> (= temp_24_0~3561@ temp_24_1~3614@) (=> (= temp_25_0~3703@ (Mul (Add (Mul (Mul b25~204@ b25~204@) (Mul d25~208@ c25~206@)) (Mul (Mul b25~204@ a25~202@) (Mul b25~204@ c25~206@))) (Mul (Sub (Sub d25~208@ c25~206@) (Mul b25~204@ b25~204@)) (Sub (Mul d25~208@ d25~208@) (Mul c25~206@ d25~208@))))) (=> (= temp_25_1~3768@ (Mul (Add (Mul (Mul b25~204@ b25~204@) (Mul d25~208@ c25~206@)) (Mul (Mul b25~204@ c25~206@) (Mul b25~204@ a25~202@))) (Mul (Sub (Sub d25~208@ c25~206@) (Mul b25~204@ b25~204@)) (Sub (Mul d25~208@ d25~208@) (Mul c25~206@ d25~208@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~3703@ temp_25_1~3768@))) (=> (= temp_25_0~3703@ temp_25_1~3768@) (=> (= temp_26_0~3853@ (Mul (Mul (Mul (Add c26~214@ b26~212@) (Mul d26~216@ d26~216@)) (Sub (Mul d26~216@ d26~216@) (Mul c26~214@ b26~212@))) (Mul (Mul (Mul a26~210@ b26~212@) (Mul d26~216@ c26~214@)) (Mul b26~212@ (Sub d26~216@ c26~214@))))) (=> (= temp_26_1~3914@ (Mul (Mul (Mul (Add c26~214@ b26~212@) (Mul d26~216@ d26~216@)) (Sub (Mul d26~216@ d26~216@) (Mul c26~214@ b26~212@))) (Mul (Mul (Mul d26~216@ c26~214@) (Mul a26~210@ b26~212@)) (Mul b26~212@ (Sub d26~216@ c26~214@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%26 (= temp_26_0~3853@ temp_26_1~3914@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
