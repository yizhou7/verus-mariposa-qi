...
(set-info :comment ";; mariposa_data/v_nl//1636400704764515315/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_9_0~1673@ Int)
(declare-const temp_9_1~1750@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul d0~8@ 93) (Mul c0~6@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ d0~8@))) (Add (Add (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@)) d0~8@))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul d0~8@ 93) (Mul c0~6@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ d0~8@))) (Add (Add (Mul b0~4@ a0~2@) (Mul c0~6@ d0~8@)) d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ c0~6@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~463@ (Add (Sub (Mul (Mul d1~16@ b1~12@) (Add c1~14@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Add b1~12@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~536@ (Add (Sub (Mul (Mul d1~16@ b1~12@) (Add c1~14@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Add (Mul (Mul b1~12@ c1~14@) b1~12@) (Mul (Mul b1~12@ c1~14@) a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@))))) (and (=> (= tmp%1@ (Mul b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ b1~12@ a1~10@) (=> %%location_label%%1 (= temp_1_0~463@ temp_1_1~536@)))) (=> (= temp_1_0~463@ temp_1_1~536@) (=> (= temp_2_0~623@ (Mul (Mul (Mul (Add b2~20@ a2~18@) (Mul a2~18@ d2~24@)) a2~18@) (Mul (Add (Mul d2~24@ d2~24@) (Sub c2~22@ c2~22@)) (Sub (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))))) (=> (= temp_2_1~676@ (Mul (Mul (Mul (Add b2~20@ a2~18@) (Mul a2~18@ d2~24@)) a2~18@) (Mul (Sub (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Add (Mul d2~24@ d2~24@) (Sub c2~22@ c2~22@))))) (and (=> (= tmp%2@ (Add (Mul d2~24@ d2~24@) (Sub c2~22@ c2~22@))) (=> (= tmp%3@ (Sub (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~623@ temp_2_1~676@))))) (=> (= temp_2_0~623@ temp_2_1~676@) (=> (= temp_3_0~765@ (Sub c3~30@ (Mul (Sub (Mul a3~26@ d3~32@) (Sub b3~28@ a3~26@)) (Add (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~802@ (Sub c3~30@ (Mul (Sub (Mul a3~26@ d3~32@) (Sub b3~28@ a3~26@)) (Add (Mul c3~30@ d3~32@) (Mul c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ c3~30@) (=> %%location_label%%3 (= temp_3_0~765@ temp_3_1~802@))) (=> (= temp_3_0~765@ temp_3_1~802@) (=> (= temp_4_0~899@ (Mul (Add (Mul d4~40@ (Mul a4~34@ b4~36@)) (Mul a4~34@ (Mul d4~40@ a4~34@))) (Mul (Mul (Mul c4~38@ a4~34@) (Sub d4~40@ d4~40@)) (Mul (Add 55 c4~38@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~968@ (Mul (Add (Mul d4~40@ (Mul a4~34@ b4~36@)) (Mul a4~34@ (Mul d4~40@ a4~34@))) (Mul (Mul (Sub d4~40@ d4~40@) (Mul c4~38@ a4~34@)) (Mul (Add 55 c4~38@) (Mul b4~36@ b4~36@))))) (and (=> (= tmp%4@ (Mul c4~38@ a4~34@)) (=> (= tmp%5@ (Sub d4~40@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%4 (= temp_4_0~899@ temp_4_1~968@))))) (=> (= temp_4_0~899@ temp_4_1~968@) (=> (= temp_5_0~1077@ (Mul (Add (Mul (Mul a5~42@ d5~48@) b5~44@) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ 44)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1150@ (Mul (Add (Mul (Mul a5~42@ d5~48@) b5~44@) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ 44)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1077@ temp_5_1~1150@))) (=> (= temp_5_0~1077@ temp_5_1~1150@) (=> (= temp_6_0~1223@ (Sub (Mul (Mul a6~50@ (Mul c6~54@ d6~56@)) (Mul d6~56@ (Mul b6~52@ b6~52@))) (Mul c6~54@ 73))) (=> (= temp_6_1~1268@ (Sub (Mul (Mul a6~50@ (Mul c6~54@ d6~56@)) (Mul (Mul b6~52@ b6~52@) d6~56@)) (Mul c6~54@ 73))) (and (=> (= tmp%6@ (Mul b6~52@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ tmp%6@) (=> %%location_label%%6 (= temp_6_0~1223@ temp_6_1~1268@)))) (=> (= temp_6_0~1223@ temp_6_1~1268@) (=> (= temp_7_0~1353@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Add b7~60@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) d7~64@))) (=> (= temp_7_1~1406@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Add b7~60@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@))) (Mul (Mul (Mul (Mul b7~60@ d7~64@) a7~58@) b7~60@) d7~64@))) (and (=> (= tmp%7@ (Mul b7~60@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ a7~58@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1353@ temp_7_1~1406@)))) (=> (= temp_7_0~1353@ temp_7_1~1406@) (=> (= temp_8_0~1505@ (Mul (Add (Sub (Mul c8~70@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul d8~72@ d8~72@) (Sub b8~68@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Sub b8~68@ a8~66@))))) (=> (= temp_8_1~1566@ (Mul (Add (Mul c8~70@ (Sub d8~72@ c8~70@)) (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul d8~72@ d8~72@) (Sub b8~68@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Sub b8~68@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. c8~70@ d8~72@ c8~70@) (=> %%location_label%%8 (= temp_8_0~1505@ temp_8_1~1566@))) (=> (= temp_8_0~1505@ temp_8_1~1566@) (=> (= temp_9_0~1673@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Sub c9~78@ d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ b9~76@))) (Mul (Mul (Mul c9~78@ a9~74@) (Mul 96 b9~76@)) (Mul (Mul c9~78@ a9~74@) (Add a9~74@ a9~74@))))) (=> (= temp_9_1~1750@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Sub c9~78@ d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ b9~76@))) (Mul (Mul (Mul c9~78@ a9~74@) (Add a9~74@ a9~74@)) (Mul (Mul c9~78@ a9~74@) (Mul 96 b9~76@))))) (and (=> (= tmp%8@ (Mul (Mul c9~78@ a9~74@) (Mul 96 b9~76@))) (=> (= tmp%9@ (Mul (Mul c9~78@ a9~74@) (Add a9~74@ a9~74@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%9 (= temp_9_0~1673@ temp_9_1~1750@))))) (=> (= temp_9_0~1673@ temp_9_1~1750@) (=> (= temp_10_0~1879@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) (Sub b10~84@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~1944@ (Mul (Mul (Mul b10~84@ (Mul b10~84@ (Sub b10~84@ a10~82@))) (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul d10~88@ c10~86@))))) (and (=> (= tmp%10@ (Sub b10~84@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b10~84@ b10~84@ tmp%10@) (=> %%location_label%%10 (= temp_10_0~1879@ temp_10_1~1944@)))) (=> (= temp_10_0~1879@ temp_10_1~1944@) (=> (= temp_11_0~2051@ (Mul (Sub (Mul (Mul d11~96@ 51) (Add a11~90@ b11~92@)) (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Add c11~94@ d11~96@) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ c11~94@) b11~92@)))) (=> (= temp_11_1~2124@ (Mul (Sub (Mul (Mul d11~96@ 51) (Add a11~90@ b11~92@)) (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul d11~96@ a11~90@) (Add c11~94@ d11~96@)) (Mul (Mul c11~94@ c11~94@) b11~92@)))) (and (=> (= tmp%11@ (Add c11~94@ d11~96@)) (=> (= tmp%12@ (Mul d11~96@ a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%11 (= temp_11_0~2051@ temp_11_1~2124@))))) (=> (= temp_11_0~2051@ temp_11_1~2124@) (=> (= temp_12_0~2221@ (Mul (Mul (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ c12~102@)) (Add (Mul b12~100@ a12~98@) c12~102@)) (Mul (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Add b12~100@ d12~104@))))) (=> (= temp_12_1~2282@ (Mul (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ c12~102@)) (Mul (Add (Mul b12~100@ a12~98@) c12~102@) (Mul (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Add b12~100@ d12~104@)))))) (and (=> (= tmp%13@ (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ c12~102@))) (=> (= tmp%14@ (Add (Mul b12~100@ a12~98@) c12~102@)) (=> (= tmp%15@ (Mul (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Mul b12~100@ c12~102@) (Add b12~100@ d12~104@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%12 (= temp_12_0~2221@ temp_12_1~2282@)))))) (=> (= temp_12_0~2221@ temp_12_1~2282@) (=> (= temp_13_0~2409@ (Mul (Add (Mul (Mul d13~112@ c13~110@) (Mul b13~108@ d13~112@)) (Mul (Mul a13~106@ c13~110@) d13~112@)) (Mul (Sub (Add d13~112@ d13~112@) (Mul d13~112@ a13~106@)) d13~112@))) (=> (= temp_13_1~2458@ (Mul (Add (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@)) (Mul (Mul a13~106@ c13~110@) d13~112@)) (Mul (Sub (Add d13~112@ d13~112@) (Mul d13~112@ a13~106@)) d13~112@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d13~112@ c13~110@) (=> %%location_label%%13 (= temp_13_0~2409@ temp_13_1~2458@))) (=> (= temp_13_0~2409@ temp_13_1~2458@) (=> (= temp_14_0~2547@ (Mul (Mul (Mul (Add b14~116@ d14~120@) (Mul d14~120@ c14~118@)) (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ a14~114@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ d14~120@)) (Mul (Mul d14~120@ b14~116@) a14~114@)))) (=> (= temp_14_1~2616@ (Mul (Mul (Add (Mul b14~116@ (Mul d14~120@ c14~118@)) (Mul d14~120@ (Mul d14~120@ c14~118@))) (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ a14~114@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ d14~120@)) (Mul (Mul d14~120@ b14~116@) a14~114@)))) (and (=> (= tmp%16@ (Mul d14~120@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b14~116@ d14~120@ tmp%16@) (=> %%location_label%%14 (= temp_14_0~2547@ temp_14_1~2616@)))) (=> (= temp_14_0~2547@ temp_14_1~2616@) (=> (= temp_15_0~2711@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Sub c15~126@ (Mul b15~124@ c15~126@))) (Mul (Mul (Mul c15~126@ a15~122@) (Mul a15~122@ a15~122@)) (Mul (Mul c15~126@ b15~124@) (Add b15~124@ d15~128@))))) (=> (= temp_15_1~2772@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ a15~122@)) (Sub c15~126@ (Mul b15~124@ c15~126@))) (Mul (Mul (Mul c15~126@ a15~122@) (Mul a15~122@ a15~122@)) (Mul (Mul c15~126@ b15~124@) (Add b15~124@ d15~128@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a15~122@ a15~122@) (=> %%location_label%%15 (= temp_15_0~2711@ temp_15_1~2772@))) (=> (= temp_15_0~2711@ temp_15_1~2772@) (=> (= temp_16_0~2857@ (Mul (Mul (Mul (Sub d16~136@ b16~132@) (Mul c16~134@ d16~136@)) (Add (Sub c16~134@ b16~132@) (Add c16~134@ c16~134@))) (Mul (Mul a16~130@ (Mul b16~132@ b16~132@)) (Mul (Add b16~132@ c16~134@) b16~132@)))) (=> (= temp_16_1~2914@ (Mul (Mul (Mul (Sub d16~136@ b16~132@) (Mul c16~134@ d16~136@)) (Add (Sub c16~134@ b16~132@) (Add c16~134@ c16~134@))) (Mul a16~130@ (Mul (Mul b16~132@ b16~132@) (Mul (Add b16~132@ c16~134@) b16~132@))))) (and (=> (= tmp%17@ (Mul b16~132@ b16~132@)) (=> (= tmp%18@ (Mul (Add b16~132@ c16~134@) b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a16~130@ tmp%17@ tmp%18@) (=> %%location_label%%16 (= temp_16_0~2857@ temp_16_1~2914@))))) (=> (= temp_16_0~2857@ temp_16_1~2914@) (=> (= temp_17_0~3033@ (Sub (Sub (Sub (Mul c17~142@ b17~140@) (Mul d17~144@ a17~138@)) (Add (Add d17~144@ d17~144@) (Mul d17~144@ b17~140@))) (Mul (Mul (Mul c17~142@ b17~140@) (Mul a17~138@ a17~138@)) (Add (Mul 64 b17~140@) (Add a17~138@ c17~142@))))) (=> (= temp_17_1~3110@ (Sub (Sub (Sub (Mul c17~142@ b17~140@) (Mul d17~144@ a17~138@)) (Add (Add d17~144@ d17~144@) (Mul d17~144@ b17~140@))) (Mul (Mul (Mul c17~142@ b17~140@) (Mul a17~138@ a17~138@)) (Add (Mul b17~140@ 64) (Add a17~138@ c17~142@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. 64 b17~140@) (=> %%location_label%%17 (= temp_17_0~3033@ temp_17_1~3110@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
