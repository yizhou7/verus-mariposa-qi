...
(push)
 ...
 (declare-const temp_5_0~995@ Int)
 ...
 (declare-const temp_13_1~2252@ Int)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~273@ temp_0_1~306@)
        (=>
         (= temp_1_0~383@ (Mul (Mul (Mul c1~14@ (Mul c1~14@ b1~12@)) (Sub (Mul c1~14@ b1~12@)
             (Add b1~12@ c1~14@)
            )
           ) (Mul (Mul c1~14@ c1~14@) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@)))
         ))
         (=>
          (= temp_1_1~436@ (Mul (Mul (Mul c1~14@ (Mul c1~14@ b1~12@)) (Sub (Mul c1~14@ b1~12@)
              (Add b1~12@ c1~14@)
             )
            ) (Mul (Mul c1~14@ c1~14@) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@)))
          ))
          (and
           ...
           (=>
            (= temp_1_0~383@ temp_1_1~436@)
            (=>
             (= temp_2_0~537@ (Mul (Mul (Add (Sub c2~22@ 8) (Mul a2~18@ b2~20@)) (Mul (Add a2~18@ c2~22@)
                 (Mul d2~24@ d2~24@)
                )
             ...
             (=>
              (= temp_2_1~614@ (Mul (Mul (Add (Sub c2~22@ 8) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ d2~24@)
                  (Add a2~18@ c2~22@)
                 )
                ) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@
                   a2~18@
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~537@ temp_2_1~614@)
               ))
               (=>
                (= temp_2_0~537@ temp_2_1~614@)
                (=>
                 (= temp_3_0~715@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Sub a3~26@
                      c3~30@
                     ) (Mul b3~28@ a3~26@)
                    )
                 ...
                 (=>
                  (= temp_3_1~792@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ a3~26@)) (Mul (Sub a3~26@
                       c3~30@
                      ) (Mul b3~28@ a3~26@)
                     )
                    ) (Add (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Mul 27 a3~26@) (Add b3~28@
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~715@ temp_3_1~792@)
                   ))
                   (=>
                    (= temp_3_0~715@ temp_3_1~792@)
                    (=>
                     (= temp_4_0~869@ (Sub (Mul (Mul (Sub b4~36@ a4~34@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@
                          d4~40@
                         ) (Mul c4~38@ c4~38@)
                        )
                     ...
                     (=>
                      (= temp_4_1~922@ (Sub (Mul (Mul (Sub b4~36@ a4~34@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@
                           d4~40@
                          ) (Mul c4~38@ c4~38@)
                         )
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~869@ temp_4_1~922@)
                       ))
                       (=>
                        (= temp_4_0~869@ temp_4_1~922@)
                        (=>
                         (= temp_5_0~995@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@
                              a5~42@
                             ) (Add d5~48@ b5~44@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1044@ (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@
                               a5~42@
                              ) (Add d5~48@ b5~44@)
                             )
                            ) (Mul b5~44@ (Sub (Mul c5~46@ d5~48@) a5~42@))
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~995@ temp_5_1~1044@)
                           ))
                           (=>
                            (= temp_5_0~995@ temp_5_1~1044@)
                            (=>
                             (= temp_6_0~1145@ (Mul (Mul (Sub (Mul d6~56@ d6~56@) (Mul 3 d6~56@)) (Sub (Mul b6~52@
                                  c6~54@
                                 ) (Add d6~56@ b6~52@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1222@ (Mul (Mul (Sub (Mul d6~56@ d6~56@) (Mul d6~56@ 3)) (Sub (Mul b6~52@
                                   c6~54@
                                  ) (Add d6~56@ b6~52@)
                                 )
                                ) (Sub (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@
                              ...
                              (and
                               ...
                               (=>
                                (= temp_6_0~1145@ temp_6_1~1222@)
                                (=>
                                 (= temp_7_0~1311@ (Mul (Mul (Add (Mul c7~62@ a7~58@) (Sub b7~60@ c7~62@)) b7~60@) (
                                    Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ 21) (Mul d7~64@
                                      a7~58@
                                 )))))
                                 (=>
                                  (= temp_7_1~1376@ (Mul (Mul (Add (Mul c7~62@ a7~58@) (Sub b7~60@ c7~62@)) b7~60@) (
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1311@ temp_7_1~1376@)
                                   ))
                                   (=>
                                    (= temp_7_0~1311@ temp_7_1~1376@)
                                    (=>
                                     (= temp_8_0~1465@ (Mul (Sub (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@
                                          b8~68@
                                         ) (Mul c8~70@ a8~66@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1530@ (Mul (Sub (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@
                                           b8~68@
                                          ) (Mul c8~70@ a8~66@)
                                         )
                                      ...
                                      (and
                                       ...
                                       (=>
                                        (= temp_8_0~1465@ temp_8_1~1530@)
                                        (=>
                                         (= temp_9_0~1619@ (Mul (Mul (Add (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@
                                              b9~76@
                                             ) (Sub a9~74@ c9~78@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1684@ (Mul (Mul (Add (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@)) (Mul (Sub a9~74@
                                               c9~78@
                                              ) (Mul d9~80@ b9~76@)
                                             )
                                            ) (Mul (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul d9~80@
                                          ...
                                          (and
                                           ...
                                           (=>
                                            (= temp_9_0~1619@ temp_9_1~1684@)
                                            (=>
                                             (= temp_10_0~1773@ (Add (Mul (Mul (Add a10~82@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (
                                                  Add d10~88@ b10~84@
                                                 ) (Add d10~88@ a10~82@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1838@ (Add (Mul (Mul (Add d10~88@ b10~84@) (Add d10~88@ a10~82@)) (Mul (
                                                   Add a10~82@ a10~82@
                                                  ) (Mul d10~88@ b10~84@)
                                                 )
                                                ) (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul b10~84@ a10~82@)
                                              ...
                                              (and
                                               ...
                                               (=>
                                                (= temp_10_0~1773@ temp_10_1~1838@)
                                                (=>
                                                 (= temp_11_0~1927@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul (
                                                      Mul b11~92@ d11~96@
                                                     ) (Mul a11~90@ b11~92@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2008@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul (
                                                       Mul b11~92@ d11~96@
                                                      ) (Mul a11~90@ b11~92@)
                                                     )
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~1927@ temp_11_1~2008@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~1927@ temp_11_1~2008@)
                                                    (=>
                                                     (= temp_12_0~2093@ (Sub (Mul (Mul (Mul d12~104@ a12~98@) (Add d12~104@ a12~98@)) (Mul
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2154@ (Sub (Mul (Mul (Mul d12~104@ a12~98@) (Add d12~104@ a12~98@)) (Mul
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2093@ temp_12_1~2154@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2093@ temp_12_1~2154@)
                                                        (=>
                                                         (= temp_13_0~2215@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (
                                                             Mul (Mul b13~108@ b13~108@) (Mul a13~106@ d13~112@)
                                                            )
                                                           ) c13~110@
                                                         ))
                                                         (=>
                                                          (= temp_13_1~2252@ (Mul c13~110@ (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@))
                                                             (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ d13~112@))
                                                          )))
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2215@ temp_13_1~2252@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2215@ temp_13_1~2252@)
                                                            (=>
                                                             (= temp_14_0~2329@ (Mul (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ d14~120@)) a14~114@)
                                                               (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ c14~118@)) (Mul (Mul d14~120@ d14~120@)
                                                                 (Mul b14~116@ d14~120@)
                                                             ))))
                                                             (=>
                                                              (= temp_14_1~2382@ (Mul (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ d14~120@)) a14~114@)
