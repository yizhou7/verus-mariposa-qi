...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul c0~6@ (Mul (Mul (Mul a0~2@ d0~8@) b0~4@) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~306@ (Mul c0~6@ (Mul (Mul (Mul a0~2@ d0~8@) b0~4@) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~273@ temp_0_1~306@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~374@ (Mul (Mul (Mul c1~14@ (Mul c1~14@ b1~12@)) (Sub (Mul c1~14@ b1~12@) (Add b1~12@ c1~14@))) (Mul (Mul c1~14@ c1~14@) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@))))) (=> (= temp_1_1~427@ (Mul (Mul (Mul c1~14@ (Mul c1~14@ b1~12@)) (Sub (Mul c1~14@ b1~12@) (Add b1~12@ c1~14@))) (Mul (Mul c1~14@ c1~14@) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~374@ temp_1_1~427@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~519@ (Mul (Mul (Add (Sub c2~22@ 8) (Mul a2~18@ b2~20@)) (Mul (Add a2~18@ c2~22@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@))))) (=> (= temp_2_1~596@ (Mul (Mul (Add (Sub c2~22@ 8) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Add a2~18@ c2~22@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~519@ temp_2_1~596@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~688@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Sub a3~26@ c3~30@) (Mul b3~28@ a3~26@))) (Add (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Mul 27 a3~26@) (Add b3~28@ d3~32@))))) (=> (= temp_3_1~765@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ a3~26@)) (Mul (Sub a3~26@ c3~30@) (Mul b3~28@ a3~26@))) (Add (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Mul 27 a3~26@) (Add b3~28@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~688@ temp_3_1~765@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~833@ (Sub (Mul (Mul (Sub b4~36@ a4~34@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@))) (Mul b4~36@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~886@ (Sub (Mul (Mul (Sub b4~36@ a4~34@) (Add c4~38@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@))) (Mul (Mul b4~36@ (Mul a4~34@ d4~40@)) (Mul a4~34@ d4~40@)))) (=> (= tmp%5@ (= temp_4_0~833@ temp_4_1~886@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~950@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Add d5~48@ b5~44@))) (Mul b5~44@ (Sub (Mul c5~46@ d5~48@) a5~42@)))) (=> (= temp_5_1~999@ (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Add d5~48@ b5~44@))) (Mul b5~44@ (Sub (Mul c5~46@ d5~48@) a5~42@)))) (=> (= tmp%6@ (= temp_5_0~950@ temp_5_1~999@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1091@ (Mul (Mul (Sub (Mul d6~56@ d6~56@) (Mul 3 d6~56@)) (Sub (Mul b6~52@ c6~54@) (Add d6~56@ b6~52@))) (Sub (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1168@ (Mul (Mul (Sub (Mul d6~56@ d6~56@) (Mul d6~56@ 3)) (Sub (Mul b6~52@ c6~54@) (Add d6~56@ b6~52@))) (Sub (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~1091@ temp_6_1~1168@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1248@ (Mul (Mul (Add (Mul c7~62@ a7~58@) (Sub b7~60@ c7~62@)) b7~60@) (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ 21) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1313@ (Mul (Mul (Add (Mul c7~62@ a7~58@) (Sub b7~60@ c7~62@)) b7~60@) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ d7~64@)) (Mul (Mul d7~64@ 21) (Mul d7~64@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1248@ temp_7_1~1313@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1393@ (Mul (Sub (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ a8~66@))) (Add (Mul (Mul a8~66@ c8~70@) (Add a8~66@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1458@ (Mul (Sub (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ a8~66@))) (Add (Mul (Mul a8~66@ c8~70@) (Add a8~66@ d8~72@)) (Mul (Mul (Mul a8~66@ b8~68@) a8~66@) c8~70@)))) (=> (= tmp%9@ (= temp_8_0~1393@ temp_8_1~1458@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1538@ (Mul (Mul (Add (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Sub a9~74@ c9~78@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~1603@ (Mul (Mul (Add (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@)) (Mul (Sub a9~74@ c9~78@) (Mul d9~80@ b9~76@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul d9~80@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1538@ temp_9_1~1603@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1683@ (Add (Mul (Mul (Add a10~82@ a10~82@) (Mul d10~88@ b10~84@)) (Mul (Add d10~88@ b10~84@) (Add d10~88@ a10~82@))) (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~1748@ (Add (Mul (Mul (Add d10~88@ b10~84@) (Add d10~88@ a10~82@)) (Mul (Add a10~82@ a10~82@) (Mul d10~88@ b10~84@))) (Mul (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ c10~86@))))) (=> (= tmp%11@ (= temp_10_0~1683@ temp_10_1~1748@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1828@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ b11~92@))) (Mul (Add (Mul b11~92@ a11~90@) (Mul b11~92@ c11~94@)) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~1909@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ b11~92@))) (Add (Mul (Mul b11~92@ a11~90@) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@))) (Mul (Mul b11~92@ c11~94@) (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ a11~90@)))))) (=> (= tmp%12@ (= temp_11_0~1828@ temp_11_1~1909@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1985@ (Sub (Mul (Mul (Mul d12~104@ a12~98@) (Add d12~104@ a12~98@)) (Mul (Mul d12~104@ b12~100@) (Mul c12~102@ d12~104@))) (Mul (Mul b12~100@ (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ a12~98@) (Add a12~98@ c12~102@))))) (=> (= temp_12_1~2046@ (Sub (Mul (Mul (Mul d12~104@ a12~98@) (Add d12~104@ a12~98@)) (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ b12~100@))) (Mul (Mul b12~100@ (Mul d12~104@ b12~100@)) (Mul (Mul d12~104@ a12~98@) (Add a12~98@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~1985@ temp_12_1~2046@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2098@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ d13~112@))) c13~110@)) (=> (= temp_13_1~2135@ (Mul c13~110@ (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ d13~112@))))) (=> (= tmp%14@ (= temp_13_0~2098@ temp_13_1~2135@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2203@ (Mul (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ d14~120@)) a14~114@) (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ c14~118@)) (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ d14~120@))))) (=> (= temp_14_1~2256@ (Mul (Mul (Mul (Mul a14~114@ c14~118@) (Mul d14~120@ d14~120@)) a14~114@) (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ c14~118@)) (Mul (Mul (Mul d14~120@ d14~120@) b14~116@) d14~120@)))) (=> (= tmp%15@ (= temp_14_0~2203@ temp_14_1~2256@)) (=> %%location_label%%14 tmp%15@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
