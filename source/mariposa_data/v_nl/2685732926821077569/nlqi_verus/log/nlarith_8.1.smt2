...
(declare-const temp_3_0~940@ Int)
(declare-const temp_3_1~1045@ Int)
...
(declare-const temp_6_0~1731@ Int)
(declare-const temp_6_1~1824@ Int)
(declare-const temp_7_0~1968@ Int)
(declare-const temp_7_1~2097@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~237@ (Mul (Mul (Mul (Mul (Mul 12 a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Add a0~2@ a0~2@))) (Mul (Mul (Add d0~8@ b0~4@) a0~2@) (Add (Mul c0~6@ c0~6@) (Add b0~4@ d0~8@)))) a0~2@)) (=> (= temp_0_1~314@ (Mul (Mul (Mul (Mul 12 a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Add a0~2@ a0~2@))) (Mul (Mul (Mul (Add d0~8@ b0~4@) a0~2@) (Add (Mul c0~6@ c0~6@) (Add b0~4@ d0~8@))) a0~2@))) (=> (= tmp%1@ (= temp_0_0~237@ temp_0_1~314@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~458@ (Mul (Sub (Mul (Sub (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@)) (Add (Mul a1~10@ a1~10@) (Mul c1~14@ b1~12@)))) (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ c1~14@)) (Sub (Sub c1~14@ b1~12@) (Mul d1~16@ d1~16@))) (Mul (Mul (Sub a1~10@ d1~16@) (Add a1~10@ c1~14@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ b1~12@)))))) (=> (= temp_1_1~587@ (Mul (Sub (Mul (Sub (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@)) (Add (Mul a1~10@ a1~10@) (Mul c1~14@ b1~12@)))) (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ c1~14@)) (Sub (Sub c1~14@ b1~12@) (Mul d1~16@ d1~16@))) (Mul (Mul (Sub a1~10@ d1~16@) (Add a1~10@ c1~14@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ b1~12@)))))) (=> (= tmp%2@ (= temp_1_0~458@ temp_1_1~587@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~711@ (Mul (Mul (Mul (Mul (Add b2~20@ d2~24@) (Add b2~20@ c2~22@)) (Sub a2~18@ (Sub a2~18@ c2~22@))) (Mul (Sub (Mul d2~24@ b2~20@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ b2~20@)))) (Mul (Mul c2~22@ (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ a2~18@))) (Mul (Sub b2~20@ (Sub b2~20@ d2~24@)) (Add (Mul b2~20@ a2~18@) (Mul d2~24@ d2~24@)))))) (=> (= temp_2_1~820@ (Mul (Mul (Mul (Mul (Add b2~20@ d2~24@) (Add b2~20@ c2~22@)) (Sub a2~18@ (Sub a2~18@ c2~22@))) (Mul (Sub (Mul d2~24@ b2~20@) (Add a2~18@ a2~18@)) (Mul b2~20@ (Mul c2~22@ (Mul b2~20@ b2~20@))))) (Mul (Mul c2~22@ (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ a2~18@))) (Mul (Sub b2~20@ (Sub b2~20@ d2~24@)) (Add (Mul b2~20@ a2~18@) (Mul d2~24@ d2~24@)))))) (=> (= tmp%3@ (= temp_2_0~711@ temp_2_1~820@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~940@ (Mul (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)) d3~32@) (Mul (Sub d3~32@ (Add a3~26@ d3~32@)) (Mul (Mul c3~30@ 34) (Mul b3~28@ 1)))) (Mul c3~30@ (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@)) (Mul c3~30@ (Mul a3~26@ c3~30@)))))) (=> (= temp_3_1~1045@ (Mul (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)) d3~32@) (Mul (Sub d3~32@ (Add a3~26@ d3~32@)) (Mul (Mul c3~30@ 34) (Mul b3~28@ 1)))) (Mul (Mul c3~30@ (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@))) (Mul c3~30@ (Mul a3~26@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~940@ temp_3_1~1045@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1201@ (Mul (Mul (Mul (Mul (Sub 45 d4~40@) (Mul a4~34@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul 60 b4~36@))) (Mul (Add (Mul d4~40@ c4~38@) (Add a4~34@ c4~38@)) c4~38@)) (Mul (Mul (Sub (Mul b4~36@ b4~36@) (Mul c4~38@ d4~40@)) (Mul (Sub a4~34@ a4~34@) (Sub b4~36@ a4~34@))) (Sub (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ a4~34@)) (Sub (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@)))))) (=> (= temp_4_1~1374@ (Mul (Mul (Mul (Mul (Sub 45 d4~40@) (Mul a4~34@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul 60 b4~36@))) (Mul (Add (Mul d4~40@ c4~38@) (Add a4~34@ c4~38@)) c4~38@)) (Sub (Mul (Mul (Sub (Mul b4~36@ b4~36@) (Mul c4~38@ d4~40@)) (Mul (Sub a4~34@ a4~34@) (Sub b4~36@ a4~34@))) (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ a4~34@))) (Mul (Mul (Sub (Mul b4~36@ b4~36@) (Mul c4~38@ d4~40@)) (Mul (Sub a4~34@ a4~34@) (Sub b4~36@ a4~34@))) (Sub (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@)))))) (=> (= tmp%5@ (= temp_4_0~1201@ temp_4_1~1374@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1506@ (Mul (Add (Mul (Add (Mul b5~44@ 47) (Mul b5~44@ c5~46@)) (Mul (Mul d5~48@ b5~44@) d5~48@)) (Mul (Mul d5~48@ (Mul a5~42@ a5~42@)) (Mul d5~48@ (Mul c5~46@ d5~48@)))) (Mul (Mul a5~42@ (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ d5~48@))) (Mul (Mul (Add b5~44@ a5~42@) (Sub c5~46@ b5~44@)) (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ c5~46@)))))) (=> (= temp_5_1~1623@ (Mul (Add (Mul (Add (Mul b5~44@ 47) (Mul b5~44@ c5~46@)) (Mul (Mul d5~48@ b5~44@) d5~48@)) (Mul (Mul d5~48@ (Mul a5~42@ a5~42@)) (Mul d5~48@ (Mul c5~46@ d5~48@)))) (Mul (Mul (Mul a5~42@ (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ d5~48@))) (Mul (Add b5~44@ a5~42@) (Sub c5~46@ b5~44@))) (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1506@ temp_5_1~1623@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1731@ (Sub (Sub (Mul (Mul (Mul c6~54@ c6~54@) (Sub a6~50@ a6~50@)) d6~56@) (Mul a6~50@ (Mul (Mul c6~54@ d6~56@) (Sub c6~54@ c6~54@)))) (Mul (Sub (Mul (Add d6~56@ b6~52@) (Mul d6~56@ b6~52@)) c6~54@) (Mul (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ d6~56@)) (Sub (Add d6~56@ d6~56@) (Mul d6~56@ d6~56@)))))) (=> (= temp_6_1~1824@ (Sub (Sub (Mul (Mul (Mul c6~54@ c6~54@) (Sub a6~50@ a6~50@)) d6~56@) (Mul a6~50@ (Mul (Mul c6~54@ d6~56@) (Sub c6~54@ c6~54@)))) (Mul (Sub (Mul (Add d6~56@ b6~52@) (Mul d6~56@ b6~52@)) c6~54@) (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ a6~50@)) (Sub (Add d6~56@ d6~56@) (Mul d6~56@ d6~56@)))))) (=> (= tmp%7@ (= temp_6_0~1731@ temp_6_1~1824@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1968@ (Mul (Mul (Mul (Mul (Sub b7~60@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ b7~60@)) (Sub (Mul b7~60@ d7~64@) (Mul b7~60@ a7~58@)))) (Add (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ b7~60@))) (Sub (Mul (Sub d7~64@ b7~60@) (Mul c7~62@ a7~58@)) (Mul (Add c7~62@ b7~60@) (Mul b7~60@ a7~58@)))))) (=> (= temp_7_1~2097@ (Mul (Mul (Mul (Mul (Sub b7~60@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ b7~60@)) (Sub (Mul b7~60@ d7~64@) (Mul b7~60@ a7~58@)))) (Add (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ b7~60@))) (Sub (Mul (Mul (Sub d7~64@ b7~60@) c7~62@) a7~58@) (Mul (Add c7~62@ b7~60@) (Mul b7~60@ a7~58@)))))) (=> (= tmp%8@ (= temp_7_0~1968@ temp_7_1~2097@)) (=> %%location_label%%7 tmp%8@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
