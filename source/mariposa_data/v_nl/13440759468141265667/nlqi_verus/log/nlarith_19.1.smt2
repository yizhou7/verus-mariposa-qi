...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Add (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ a0~2@) a0~2@)) (Mul (Sub (Add d0~8@ 3) (Mul b0~4@ c0~6@)) (Sub (Mul c0~6@ d0~8@) (Sub a0~2@ b0~4@))))) (=> (= temp_0_1~386@ (Mul (Mul (Sub (Add d0~8@ 3) (Mul b0~4@ c0~6@)) (Sub (Mul c0~6@ d0~8@) (Sub a0~2@ b0~4@))) (Add (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ a0~2@) a0~2@)))) (=> (= tmp%1@ (= temp_0_0~313@ temp_0_1~386@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~466@ (Mul (Mul (Mul (Mul d1~16@ 69) (Mul b1~12@ d1~16@)) (Sub (Mul b1~12@ b1~12@) (Mul b1~12@ d1~16@))) (Mul d1~16@ (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ b1~12@))))) (=> (= temp_1_1~559@ (Mul (Sub (Mul (Mul (Mul d1~16@ 69) (Mul b1~12@ d1~16@)) (Mul b1~12@ b1~12@)) (Mul (Mul (Mul d1~16@ 69) (Mul b1~12@ d1~16@)) (Mul b1~12@ d1~16@))) (Mul d1~16@ (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~466@ temp_1_1~559@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~639@ (Mul (Sub (Sub (Sub c2~22@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ a2~18@))) (Mul (Sub (Mul b2~20@ c2~22@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Add c2~22@ b2~20@))))) (=> (= temp_2_1~704@ (Mul (Sub (Sub (Sub c2~22@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ a2~18@))) (Mul (Sub (Mul b2~20@ c2~22@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Add c2~22@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~639@ temp_2_1~704@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~784@ (Mul (Mul (Mul (Add b3~28@ b3~28@) (Add b3~28@ a3~26@)) (Mul (Add a3~26@ d3~32@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Add b3~28@ d3~32@))))) (=> (= temp_3_1~849@ (Mul (Mul (Mul (Add a3~26@ d3~32@) (Mul d3~32@ d3~32@)) (Mul (Add b3~28@ b3~28@) (Add b3~28@ a3~26@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Add b3~28@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~784@ temp_3_1~849@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~929@ (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ b4~36@) (Sub c4~38@ b4~36@))) (Mul (Sub (Mul d4~40@ d4~40@) (Mul b4~36@ d4~40@)) (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~994@ (Mul (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ b4~36@) (Sub c4~38@ b4~36@))) (Mul (Mul (Sub (Mul d4~40@ d4~40@) (Mul b4~36@ d4~40@)) (Mul d4~40@ b4~36@)) (Mul a4~34@ c4~38@)))) (=> (= tmp%5@ (= temp_4_0~929@ temp_4_1~994@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1074@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ b5~44@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ c5~46@))))) (=> (= temp_5_1~1139@ (Mul (Mul (Mul d5~48@ d5~48@) (Mul (Mul b5~44@ b5~44@) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@)))) (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ c5~46@)) (Add (Mul d5~48@ c5~46@) (Mul a5~42@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1074@ temp_5_1~1139@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1219@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Add b6~52@ a6~50@)) (Mul (Add c6~54@ d6~56@) (Mul d6~56@ d6~56@))) (Mul (Mul (Mul a6~50@ c6~54@) (Add b6~52@ b6~52@)) (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1284@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Add b6~52@ a6~50@)) (Mul (Add c6~54@ d6~56@) (Mul d6~56@ d6~56@))) (Mul (Mul (Mul a6~50@ c6~54@) (Add b6~52@ b6~52@)) (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1219@ temp_6_1~1284@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1372@ (Mul (Mul (Mul (Add d7~64@ a7~58@) (Add b7~60@ d7~64@)) (Mul (Mul 24 a7~58@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul c7~62@ b7~60@) b7~60@) (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1445@ (Mul (Mul (Mul (Mul 24 a7~58@) (Mul a7~58@ b7~60@)) (Mul (Add d7~64@ a7~58@) (Add b7~60@ d7~64@))) (Mul (Mul (Mul c7~62@ b7~60@) b7~60@) (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1372@ temp_7_1~1445@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1521@ (Mul (Sub (Add c8~70@ (Mul c8~70@ a8~66@)) (Sub (Add a8~66@ b8~68@) (Mul d8~72@ b8~68@))) (Mul (Add (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1582@ (Mul (Sub (Add c8~70@ (Mul c8~70@ a8~66@)) (Sub (Add a8~66@ b8~68@) (Mul d8~72@ b8~68@))) (Mul (Add (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1521@ temp_8_1~1582@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1662@ (Mul (Sub (Sub (Mul a9~74@ b9~76@) (Mul c9~78@ b9~76@)) (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ d9~80@))) (Sub (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ c9~78@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~1723@ (Mul (Sub (Mul (Sub a9~74@ c9~78@) b9~76@) (Mul (Mul d9~80@ c9~78@) (Mul d9~80@ d9~80@))) (Sub (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ c9~78@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1662@ temp_9_1~1723@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1799@ (Mul (Mul (Mul (Mul c10~86@ b10~84@) (Add d10~88@ d10~88@)) (Mul (Mul b10~84@ c10~86@) b10~84@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul a10~82@ c10~86@)) (Add (Mul b10~84@ d10~88@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~1868@ (Mul (Mul (Add (Mul (Mul c10~86@ b10~84@) d10~88@) (Mul (Mul c10~86@ b10~84@) d10~88@)) (Mul (Mul b10~84@ c10~86@) b10~84@)) (Mul (Mul (Mul b10~84@ d10~88@) (Mul a10~82@ c10~86@)) (Add (Mul b10~84@ d10~88@) (Mul c10~86@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1799@ temp_10_1~1868@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1952@ (Mul (Mul (Sub (Mul a11~90@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ c11~94@) a11~90@)) (Mul (Mul (Mul 4 c11~94@) a11~90@) (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2021@ (Mul (Mul (Sub (Mul a11~90@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul d11~96@ c11~94@) a11~90@)) (Mul (Mul (Mul (Mul 4 c11~94@) a11~90@) (Mul a11~90@ d11~96@)) (Mul d11~96@ b11~92@)))) (=> (= tmp%12@ (= temp_11_0~1952@ temp_11_1~2021@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2081@ (Sub (Add d12~104@ (Sub (Mul a12~98@ d12~104@) d12~104@)) (Mul (Mul (Sub a12~98@ b12~100@) (Mul c12~102@ c12~102@)) (Add (Mul a12~98@ a12~98@) b12~100@)))) (=> (= temp_12_1~2126@ (Sub (Add d12~104@ (Sub (Mul a12~98@ d12~104@) d12~104@)) (Mul (Add (Mul a12~98@ a12~98@) b12~100@) (Mul (Sub a12~98@ b12~100@) (Mul c12~102@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~2081@ temp_12_1~2126@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2202@ (Mul (Mul (Mul (Sub c13~110@ b13~108@) (Mul c13~110@ a13~106@)) (Sub (Sub d13~112@ c13~110@) d13~112@)) (Mul (Mul (Mul c13~110@ b13~108@) (Add a13~106@ d13~112@)) (Sub (Mul c13~110@ a13~106@) (Add a13~106@ c13~110@))))) (=> (= temp_13_1~2263@ (Mul (Mul (Sub (Sub d13~112@ c13~110@) d13~112@) (Mul (Sub c13~110@ b13~108@) (Mul c13~110@ a13~106@))) (Mul (Mul (Mul c13~110@ b13~108@) (Add a13~106@ d13~112@)) (Sub (Mul c13~110@ a13~106@) (Add a13~106@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2202@ temp_13_1~2263@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2311@ (Mul a14~114@ (Mul (Mul (Mul a14~114@ c14~118@) d14~120@) (Mul (Add a14~114@ b14~116@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2344@ (Mul a14~114@ (Mul (Mul (Add a14~114@ b14~116@) (Mul b14~116@ c14~118@)) (Mul (Mul a14~114@ c14~118@) d14~120@)))) (=> (= tmp%15@ (= temp_14_0~2311@ temp_14_1~2344@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2416@ (Mul (Mul (Mul d15~128@ (Mul b15~124@ a15~122@)) (Mul (Mul b15~124@ a15~122@) (Mul c15~126@ c15~126@))) (Mul (Mul b15~124@ (Sub d15~128@ a15~122@)) (Mul (Sub d15~128@ d15~128@) (Mul d15~128@ b15~124@))))) (=> (= temp_15_1~2473@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul c15~126@ c15~126@)) (Mul d15~128@ (Mul b15~124@ a15~122@))) (Mul (Mul b15~124@ (Sub d15~128@ a15~122@)) (Mul (Sub d15~128@ d15~128@) (Mul d15~128@ b15~124@))))) (=> (= tmp%16@ (= temp_15_0~2416@ temp_15_1~2473@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2553@ (Mul (Mul (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ a16~130@)) (Mul (Mul a16~130@ b16~132@) (Mul b16~132@ d16~136@))) (Mul (Mul (Mul b16~132@ a16~130@) (Mul d16~136@ a16~130@)) (Mul (Mul b16~132@ a16~130@) (Mul a16~130@ a16~130@))))) (=> (= temp_16_1~2618@ (Mul (Mul (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ a16~130@)) (Mul (Mul a16~130@ b16~132@) (Mul b16~132@ d16~136@))) (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul d16~136@ a16~130@)) (Mul b16~132@ a16~130@)) (Mul a16~130@ a16~130@)))) (=> (= tmp%17@ (= temp_16_0~2553@ temp_16_1~2618@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2694@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) (Sub d17~144@ b17~140@)) (Mul (Mul d17~144@ b17~140@) (Mul c17~142@ a17~138@))) (Sub (Mul (Mul a17~138@ d17~144@) c17~142@) (Mul (Add d17~144@ a17~138@) (Mul d17~144@ d17~144@))))) (=> (= temp_17_1~2755@ (Mul (Mul (Mul (Sub d17~144@ b17~140@) (Mul d17~144@ b17~140@)) (Mul (Mul d17~144@ b17~140@) (Mul c17~142@ a17~138@))) (Sub (Mul (Mul a17~138@ d17~144@) c17~142@) (Mul (Add d17~144@ a17~138@) (Mul d17~144@ d17~144@))))) (=> (= tmp%18@ (= temp_17_0~2694@ temp_17_1~2755@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2843@ (Mul (Mul (Mul (Mul c18~150@ b18~148@) (Mul b18~148@ b18~148@)) (Add (Mul a18~146@ d18~152@) 63)) (Sub (Add (Add c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul (Mul d18~152@ c18~150@) (Add b18~148@ a18~146@))))) (=> (= temp_18_1~2916@ (Mul (Mul (Mul (Mul c18~150@ b18~148@) (Mul b18~148@ b18~148@)) (Add (Mul a18~146@ d18~152@) 63)) (Sub (Add (Add c18~150@ b18~148@) (Mul b18~148@ c18~150@)) (Mul d18~152@ (Mul c18~150@ (Add b18~148@ a18~146@)))))) (=> (= tmp%19@ (= temp_18_0~2843@ temp_18_1~2916@)) (=> %%location_label%%18 tmp%19@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
