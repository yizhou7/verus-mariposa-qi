...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Sub (Sub (Sub b0~4@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul c0~6@ b0~4@) (Add c0~6@ b0~4@))) (Mul (Mul (Sub a0~2@ d0~8@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ b0~4@) (Add d0~8@ c0~6@))))) (=> (= temp_0_1~370@ (Sub (Sub (Sub (Sub b0~4@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul c0~6@ b0~4@) (Add c0~6@ b0~4@))) (Mul (Mul (Sub a0~2@ d0~8@) (Mul c0~6@ c0~6@)) (Mul b0~4@ (Mul b0~4@ (Add d0~8@ c0~6@)))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~446@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ 23))) 6)) (=> (= temp_1_1~507@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@ 23) (Mul a1~10@ d1~16@))) 6)) (=> (= tmp%2@ (= temp_1_0~446@ temp_1_1~507@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~611@ (Mul (Sub (Mul (Mul a2~18@ 99) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul 23 a2~18@) (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~700@ (Mul (Sub (Mul a2~18@ (Mul 99 (Mul c2~22@ d2~24@))) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul 23 a2~18@) (Mul b2~20@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~611@ temp_2_1~700@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~764@ (Sub b3~28@ (Mul (Mul (Mul 40 b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~813@ (Sub b3~28@ (Mul (Mul (Mul 40 b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~764@ temp_3_1~813@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~905@ (Add (Mul (Mul (Sub c4~38@ 94) (Mul c4~38@ d4~40@)) (Mul (Add d4~40@ a4~34@) (Add a4~34@ d4~40@))) (Mul (Add (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~982@ (Add (Mul (Mul (Mul (Sub c4~38@ 94) c4~38@) d4~40@) (Mul (Add d4~40@ a4~34@) (Add a4~34@ d4~40@))) (Mul (Add (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~905@ temp_4_1~982@)) (=> %%location_label%%4 tmp%5@)))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
