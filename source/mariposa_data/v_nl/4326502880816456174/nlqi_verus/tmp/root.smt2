...
;; mariposa_data/v_nl//4326502880816456174/nlqi_verus/src/main.rs:7:1: 36:40 (#0)
(push)
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~305@ (Sub (Sub (Sub (Sub b0~4@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul c0~6@ b0~4@)
         (Add c0~6@ b0~4@)
        )
       ) (Mul (Mul (Sub a0~2@ d0~8@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ b0~4@) (Add d0~8@ c0~6@)))
     ))
     (=>
      (= temp_0_1~370@ (Sub (Sub (Sub (Sub b0~4@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul c0~6@ b0~4@)
          (Add c0~6@ b0~4@)
         )
        ) (Mul (Mul (Sub a0~2@ d0~8@) (Mul c0~6@ c0~6@)) (Mul b0~4@ (Mul b0~4@ (Add d0~8@ c0~6@))))
      ))
      (and
       (=>
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~455@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@
              d1~16@
             ) (Mul a1~10@ 23)
            )
           ) 6
         ...
         (=>
          (= temp_1_1~516@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@
               23
              ) (Mul a1~10@ d1~16@)
             )
            ) 6
          ...
          (and
           ...
           (=>
            (= temp_1_0~455@ temp_1_1~516@)
            (=>
             (= temp_2_0~629@ (Mul (Sub (Mul (Mul a2~18@ 99) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@
                  c2~22@
                 ) (Mul b2~20@ a2~18@)
                )
               ) (Mul (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul 23 a2~18@) (Mul b2~20@
                  c2~22@
             )))))
             (=>
              (= temp_2_1~718@ (Mul (Sub (Mul a2~18@ (Mul 99 (Mul c2~22@ d2~24@))) (Mul (Mul a2~18@
                   c2~22@
                  ) (Mul b2~20@ a2~18@)
                 )
                ) (Mul (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul 23 a2~18@) (Mul b2~20@
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~629@ temp_2_1~718@)
               ))
               (=>
                (= temp_2_0~629@ temp_2_1~718@)
                (=>
                 (= temp_3_0~791@ (Sub b3~28@ (Mul (Mul (Mul 40 b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul
                      b3~28@ b3~28@
                     ) (Mul b3~28@ d3~32@)
                 ))))
                 (=>
                  (= temp_3_1~840@ (Sub b3~28@ (Mul (Mul (Mul 40 b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul
                       b3~28@ b3~28@
                      ) (Mul b3~28@ d3~32@)
                  ))))
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~791@ temp_3_1~840@)
                   ))
                   (=>
                    (= temp_3_0~791@ temp_3_1~840@)
                    (=>
                     (= temp_4_0~941@ (Add (Mul (Mul (Sub c4~38@ 94) (Mul c4~38@ d4~40@)) (Mul (Add d4~40@
                          a4~34@
                         ) (Add a4~34@ d4~40@)
                        )
                       ) (Mul (Add (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@
                          a4~34@
                     )))))
                     (=>
                      (= temp_4_1~1018@ (Add (Mul (Mul (Mul (Sub c4~38@ 94) c4~38@) d4~40@) (Mul (Add d4~40@
                           a4~34@
                          ) (Add a4~34@ d4~40@)
                         )
                        ) (Mul (Add (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@
