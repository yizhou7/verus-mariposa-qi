...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Add (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ a0~2@))) (Mul a0~2@ (Mul (Sub a0~2@ c0~6@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~346@ (Mul (Add (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ a0~2@))) (Mul a0~2@ (Mul (Sub a0~2@ c0~6@) (Mul a0~2@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~293@ temp_0_1~346@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~398@ (Sub c1~14@ (Mul (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Add d1~16@ a1~10@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~435@ (Sub c1~14@ (Mul (Mul a1~10@ d1~16@) (Mul (Mul c1~14@ c1~14@) (Mul (Add d1~16@ a1~10@) (Mul a1~10@ a1~10@)))))) (=> (= tmp%2@ (= temp_1_0~398@ temp_1_1~435@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~547@ (Add (Mul (Add (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ 63) (Sub a2~18@ c2~22@))) (Mul (Mul (Mul 86 d2~24@) (Mul 20 b2~20@)) (Sub (Sub b2~20@ b2~20@) a2~18@)))) (=> (= temp_2_1~644@ (Add (Mul (Add (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ 63) (Sub a2~18@ c2~22@))) (Mul (Mul (Mul 86 d2~24@) (Mul b2~20@ 20)) (Sub (Sub b2~20@ b2~20@) a2~18@)))) (=> (= tmp%3@ (= temp_2_0~547@ temp_2_1~644@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~736@ (Mul (Sub (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@)) (Add (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (Sub (Mul (Mul c3~30@ c3~30@) (Mul 43 b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~813@ (Mul (Sub (Mul (Mul (Mul d3~32@ c3~30@) d3~32@) a3~26@) (Add (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (Sub (Mul (Mul c3~30@ c3~30@) (Mul 43 b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~736@ temp_3_1~813@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~893@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Add b4~36@ a4~34@))) (Mul (Sub (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~958@ (Mul (Mul (Sub (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Add b4~36@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~893@ temp_4_1~958@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1050@ (Mul (Mul (Mul (Mul a5~42@ 13) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1127@ (Mul (Mul (Mul (Mul a5~42@ 13) (Mul d5~48@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1050@ temp_5_1~1127@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1207@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@)) (Add (Mul d6~56@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ a6~50@)) (Mul (Mul b6~52@ c6~54@) (Sub b6~52@ d6~56@))))) (=> (= temp_6_1~1272@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@)) (Add (Mul d6~56@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul b6~52@ c6~54@) (Sub b6~52@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1207@ temp_6_1~1272@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1364@ (Mul (Add (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))) (Mul (Sub (Sub a7~58@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Add 58 c7~62@))))) (=> (= temp_7_1~1469@ (Mul (Add (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))) (Sub (Mul (Sub a7~58@ d7~64@) (Mul (Mul b7~60@ c7~62@) (Add 58 c7~62@))) (Mul (Mul c7~62@ b7~60@) (Mul (Mul b7~60@ c7~62@) (Add 58 c7~62@)))))) (=> (= tmp%8@ (= temp_7_0~1364@ temp_7_1~1469@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1537@ (Mul (Mul (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ c8~70@))) (Mul d8~72@ (Add (Sub d8~72@ a8~66@) (Mul c8~70@ b8~68@))))) (=> (= temp_8_1~1590@ (Mul (Mul (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ c8~70@))) (Mul (Add (Sub d8~72@ a8~66@) (Mul c8~70@ b8~68@)) d8~72@))) (=> (= tmp%9@ (= temp_8_0~1537@ temp_8_1~1590@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1642@ (Mul c9~78@ (Mul (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ d9~80@)) (Sub (Sub c9~78@ a9~74@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1679@ (Mul c9~78@ (Mul (Sub (Sub c9~78@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1642@ temp_9_1~1679@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1747@ (Mul (Mul (Mul (Mul d10~88@ a10~82@) (Mul c10~86@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Sub c10~86@ b10~84@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) c10~86@))) (=> (= temp_10_1~1800@ (Mul (Mul (Mul (Mul (Mul d10~88@ a10~82@) c10~86@) a10~82@) (Mul (Mul a10~82@ c10~86@) (Sub c10~86@ b10~84@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) c10~86@))) (=> (= tmp%11@ (= temp_10_0~1747@ temp_10_1~1800@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1864@ (Mul (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul d11~96@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul a11~90@ a11~90@) c11~94@) a11~90@))) (=> (= temp_11_1~1913@ (Mul (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ a11~90@))) (Mul (Mul (Mul a11~90@ a11~90@) c11~94@) a11~90@))) (=> (= tmp%12@ (= temp_11_0~1864@ temp_11_1~1913@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1985@ (Mul (Mul (Mul b12~100@ (Mul c12~102@ d12~104@)) (Sub (Mul a12~98@ a12~98@) b12~100@)) (Mul (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@)) (Sub (Mul d12~104@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2042@ (Mul (Mul (Mul (Mul b12~100@ (Mul c12~102@ d12~104@)) (Sub (Mul a12~98@ a12~98@) b12~100@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@))) (Sub (Mul d12~104@ a12~98@) (Mul c12~102@ d12~104@)))) (=> (= tmp%13@ (= temp_12_0~1985@ temp_12_1~2042@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2110@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Add a13~106@ c13~110@) (Mul a13~106@ a13~106@))) (Mul b13~108@ (Add (Mul c13~110@ b13~108@) (Mul c13~110@ c13~110@))))) (=> (= temp_13_1~2163@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Add a13~106@ c13~110@) (Mul a13~106@ a13~106@))) (Mul b13~108@ (Add (Mul c13~110@ b13~108@) (Mul c13~110@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2110@ temp_13_1~2163@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2243@ (Mul (Add (Mul (Mul d14~120@ b14~116@) (Mul c14~118@ d14~120@)) (Mul (Mul a14~114@ d14~120@) (Mul a14~114@ b14~116@))) (Mul (Mul (Mul d14~120@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ a14~114@) (Mul d14~120@ c14~118@))))) (=> (= temp_14_1~2308@ (Mul (Add (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul a14~114@ b14~116@))) (Mul (Mul (Mul d14~120@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ a14~114@) (Mul d14~120@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2243@ temp_14_1~2308@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2448@ (Mul (Mul (Mul (Mul c15~126@ 3) (Mul a15~122@ c15~126@)) (Add (Mul a15~122@ b15~124@) (Mul b15~124@ 89))) (Mul (Mul (Add 13 d15~128@) (Mul b15~124@ 73)) (Mul (Mul d15~128@ 47) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~2573@ (Mul (Mul (Add (Mul a15~122@ b15~124@) (Mul b15~124@ 89)) (Mul (Mul c15~126@ 3) (Mul a15~122@ c15~126@))) (Mul (Mul (Add 13 d15~128@) (Mul b15~124@ 73)) (Mul (Mul d15~128@ 47) (Mul d15~128@ a15~122@))))) (=> (= tmp%16@ (= temp_15_0~2448@ temp_15_1~2573@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2649@ (Mul (Mul (Add d16~136@ (Mul b16~132@ c16~134@)) (Mul (Add d16~136@ c16~134@) (Mul d16~136@ b16~132@))) (Add (Add (Mul b16~132@ b16~132@) (Add b16~132@ d16~136@)) (Mul (Sub a16~130@ b16~132@) (Mul c16~134@ c16~134@))))) (=> (= temp_16_1~2718@ (Mul (Mul (Add d16~136@ (Mul b16~132@ c16~134@)) (Mul (Add d16~136@ c16~134@) (Mul d16~136@ b16~132@))) (Add (Add (Mul b16~132@ b16~132@) (Add b16~132@ d16~136@)) (Sub (Mul a16~130@ (Mul c16~134@ c16~134@)) (Mul b16~132@ (Mul c16~134@ c16~134@)))))) (=> (= tmp%17@ (= temp_16_0~2649@ temp_16_1~2718@)) (=> %%location_label%%16 tmp%17@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
