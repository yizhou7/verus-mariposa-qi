...
(set-info :comment ";; mariposa_data/v_nl//7876361007614496636/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_6_1~1446@ Int)
(declare-const temp_7_0~1559@ Int)
(declare-const temp_7_1~1664@ Int)
(declare-const temp_8_0~1779@ Int)
(declare-const temp_8_1~1832@ Int)
(declare-const temp_9_0~1909@ Int)
...
(declare-const temp_12_0~2329@ Int)
(declare-const temp_12_1~2386@ Int)
(declare-const temp_13_0~2513@ Int)
(declare-const temp_13_1~2566@ Int)
(declare-const temp_14_0~2659@ Int)
(declare-const temp_14_1~2724@ Int)
(declare-const temp_15_0~2885@ Int)
(declare-const temp_15_1~3010@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Add (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ a0~2@))) (Mul a0~2@ (Mul (Sub a0~2@ c0~6@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~346@ (Mul (Add (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ a0~2@))) (Mul a0~2@ (Mul (Sub a0~2@ c0~6@) (Mul a0~2@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~411@ (Sub c1~14@ (Mul (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Add d1~16@ a1~10@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~448@ (Sub c1~14@ (Mul (Mul a1~10@ d1~16@) (Mul (Mul c1~14@ c1~14@) (Mul (Add d1~16@ a1~10@) (Mul a1~10@ a1~10@)))))) (and (=> (= tmp%1@ (Mul a1~10@ d1~16@)) (=> (= tmp%2@ (Mul c1~14@ c1~14@)) (=> (= tmp%3@ (Mul (Add d1~16@ a1~10@) (Mul a1~10@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~411@ temp_1_1~448@)))))) (=> (= temp_1_0~411@ temp_1_1~448@) (=> (= temp_2_0~595@ (Add (Mul (Add (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ 63) (Sub a2~18@ c2~22@))) (Mul (Mul (Mul 86 d2~24@) (Mul 20 b2~20@)) (Sub (Sub b2~20@ b2~20@) a2~18@)))) (=> (= temp_2_1~692@ (Add (Mul (Add (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ 63) (Sub a2~18@ c2~22@))) (Mul (Mul (Mul 86 d2~24@) (Mul b2~20@ 20)) (Sub (Sub b2~20@ b2~20@) a2~18@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 20 b2~20@) (=> %%location_label%%2 (= temp_2_0~595@ temp_2_1~692@))) (=> (= temp_2_0~595@ temp_2_1~692@) (=> (= temp_3_0~809@ (Mul (Sub (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@)) (Add (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (Sub (Mul (Mul c3~30@ c3~30@) (Mul 43 b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~886@ (Mul (Sub (Mul (Mul (Mul d3~32@ c3~30@) d3~32@) a3~26@) (Add (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (Sub (Mul (Mul c3~30@ c3~30@) (Mul 43 b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ a3~26@))))) (and (=> (= tmp%4@ (Mul d3~32@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ d3~32@ a3~26@) (=> %%location_label%%3 (= temp_3_0~809@ temp_3_1~886@)))) (=> (= temp_3_0~809@ temp_3_1~886@) (=> (= temp_4_0~985@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Add b4~36@ a4~34@))) (Mul (Sub (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~1050@ (Mul (Mul (Sub (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Add b4~36@ a4~34@))))) (and (=> (= tmp%5@ (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Add b4~36@ a4~34@)))) (=> (= tmp%6@ (Mul (Sub (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~985@ temp_4_1~1050@))))) (=> (= temp_4_0~985@ temp_4_1~1050@) (=> (= temp_5_0~1211@ (Mul (Mul (Mul (Mul a5~42@ 13) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1288@ (Mul (Mul (Mul (Mul a5~42@ 13) (Mul d5~48@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1211@ temp_5_1~1288@))) (=> (= temp_5_0~1211@ temp_5_1~1288@) (=> (= temp_6_0~1381@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@)) (Add (Mul d6~56@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ a6~50@)) (Mul (Mul b6~52@ c6~54@) (Sub b6~52@ d6~56@))))) (=> (= temp_6_1~1446@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@)) (Add (Mul d6~56@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@)) (Mul (Mul b6~52@ c6~54@) (Sub b6~52@ d6~56@))))) (and (=> (= tmp%7@ (Mul b6~52@ b6~52@)) (=> (= tmp%8@ (Mul d6~56@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~1381@ temp_6_1~1446@))))) (=> (= temp_6_0~1381@ temp_6_1~1446@) (=> (= temp_7_0~1559@ (Mul (Add (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))) (Mul (Sub (Sub a7~58@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Add 58 c7~62@))))) (=> (= temp_7_1~1664@ (Mul (Add (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@))) (Sub (Mul (Sub a7~58@ d7~64@) (Mul (Mul b7~60@ c7~62@) (Add 58 c7~62@))) (Mul (Mul c7~62@ b7~60@) (Mul (Mul b7~60@ c7~62@) (Add 58 c7~62@)))))) (and (=> (= tmp%9@ (Sub a7~58@ d7~64@)) (=> (= tmp%10@ (Mul c7~62@ b7~60@)) (=> (= tmp%11@ (Mul (Mul b7~60@ c7~62@) (Add 58 c7~62@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%7 (= temp_7_0~1559@ temp_7_1~1664@)))))) (=> (= temp_7_0~1559@ temp_7_1~1664@) (=> (= temp_8_0~1779@ (Mul (Mul (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ c8~70@))) (Mul d8~72@ (Add (Sub d8~72@ a8~66@) (Mul c8~70@ b8~68@))))) (=> (= temp_8_1~1832@ (Mul (Mul (Sub (Mul d8~72@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ c8~70@))) (Mul (Add (Sub d8~72@ a8~66@) (Mul c8~70@ b8~68@)) d8~72@))) (and (=> (= tmp%12@ (Add (Sub d8~72@ a8~66@) (Mul c8~70@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d8~72@ tmp%12@) (=> %%location_label%%8 (= temp_8_0~1779@ temp_8_1~1832@)))) (=> (= temp_8_0~1779@ temp_8_1~1832@) (=> (= temp_9_0~1909@ (Mul c9~78@ (Mul (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ d9~80@)) (Sub (Sub c9~78@ a9~74@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1946@ (Mul c9~78@ (Mul (Sub (Sub c9~78@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ d9~80@))))) (and (=> (= tmp%13@ (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ d9~80@))) (=> (= tmp%14@ (Sub (Sub c9~78@ a9~74@) (Mul c9~78@ d9~80@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%9 (= temp_9_0~1909@ temp_9_1~1946@))))) (=> (= temp_9_0~1909@ temp_9_1~1946@) (=> (= temp_10_0~2051@ (Mul (Mul (Mul (Mul d10~88@ a10~82@) (Mul c10~86@ a10~82@)) (Mul (Mul a10~82@ c10~86@) (Sub c10~86@ b10~84@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) c10~86@))) (=> (= temp_10_1~2104@ (Mul (Mul (Mul (Mul (Mul d10~88@ a10~82@) c10~86@) a10~82@) (Mul (Mul a10~82@ c10~86@) (Sub c10~86@ b10~84@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) c10~86@))) (and (=> (= tmp%15@ (Mul d10~88@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ c10~86@ a10~82@) (=> %%location_label%%10 (= temp_10_0~2051@ temp_10_1~2104@)))) (=> (= temp_10_0~2051@ temp_10_1~2104@) (=> (= temp_11_0~2187@ (Mul (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul d11~96@ a11~90@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul a11~90@ a11~90@) c11~94@) a11~90@))) (=> (= temp_11_1~2236@ (Mul (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul d11~96@ a11~90@))) (Mul (Mul (Mul a11~90@ a11~90@) c11~94@) a11~90@))) (and (=> (= tmp%16@ (Mul d11~96@ a11~90@)) (=> (= tmp%17@ (Mul a11~90@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%11 (= temp_11_0~2187@ temp_11_1~2236@))))) (=> (= temp_11_0~2187@ temp_11_1~2236@) (=> (= temp_12_0~2329@ (Mul (Mul (Mul b12~100@ (Mul c12~102@ d12~104@)) (Sub (Mul a12~98@ a12~98@) b12~100@)) (Mul (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@)) (Sub (Mul d12~104@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2386@ (Mul (Mul (Mul (Mul b12~100@ (Mul c12~102@ d12~104@)) (Sub (Mul a12~98@ a12~98@) b12~100@)) (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@))) (Sub (Mul d12~104@ a12~98@) (Mul c12~102@ d12~104@)))) (and (=> (= tmp%18@ (Mul (Mul b12~100@ (Mul c12~102@ d12~104@)) (Sub (Mul a12~98@ a12~98@) b12~100@))) (=> (= tmp%19@ (Mul (Mul d12~104@ d12~104@) (Mul c12~102@ a12~98@))) (=> (= tmp%20@ (Sub (Mul d12~104@ a12~98@) (Mul c12~102@ d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%12 (= temp_12_0~2329@ temp_12_1~2386@)))))) (=> (= temp_12_0~2329@ temp_12_1~2386@) (=> (= temp_13_0~2513@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Add a13~106@ c13~110@) (Mul a13~106@ a13~106@))) (Mul b13~108@ (Add (Mul c13~110@ b13~108@) (Mul c13~110@ c13~110@))))) (=> (= temp_13_1~2566@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Add a13~106@ c13~110@) (Mul a13~106@ a13~106@))) (Mul b13~108@ (Add (Mul c13~110@ b13~108@) (Mul c13~110@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c13~110@ c13~110@) (=> %%location_label%%13 (= temp_13_0~2513@ temp_13_1~2566@))) (=> (= temp_13_0~2513@ temp_13_1~2566@) (=> (= temp_14_0~2659@ (Mul (Add (Mul (Mul d14~120@ b14~116@) (Mul c14~118@ d14~120@)) (Mul (Mul a14~114@ d14~120@) (Mul a14~114@ b14~116@))) (Mul (Mul (Mul d14~120@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ a14~114@) (Mul d14~120@ c14~118@))))) (=> (= temp_14_1~2724@ (Mul (Add (Mul (Mul c14~118@ d14~120@) (Mul d14~120@ b14~116@)) (Mul (Mul a14~114@ d14~120@) (Mul a14~114@ b14~116@))) (Mul (Mul (Mul d14~120@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ a14~114@) (Mul d14~120@ c14~118@))))) (and (=> (= tmp%21@ (Mul d14~120@ b14~116@)) (=> (= tmp%22@ (Mul c14~118@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%14 (= temp_14_0~2659@ temp_14_1~2724@))))) (=> (= temp_14_0~2659@ temp_14_1~2724@) (=> (= temp_15_0~2885@ (Mul (Mul (Mul (Mul c15~126@ 3) (Mul a15~122@ c15~126@)) (Add (Mul a15~122@ b15~124@) (Mul b15~124@ 89))) (Mul (Mul (Add 13 d15~128@) (Mul b15~124@ 73)) (Mul (Mul d15~128@ 47) (Mul d15~128@ a15~122@))))) (=> (= temp_15_1~3010@ (Mul (Mul (Add (Mul a15~122@ b15~124@) (Mul b15~124@ 89)) (Mul (Mul c15~126@ 3) (Mul a15~122@ c15~126@))) (Mul (Mul (Add 13 d15~128@) (Mul b15~124@ 73)) (Mul (Mul d15~128@ 47) (Mul d15~128@ a15~122@))))) (and (=> (= tmp%23@ (Mul (Mul c15~126@ 3) (Mul a15~122@ c15~126@))) (=> (= tmp%24@ (Add (Mul a15~122@ b15~124@) (Mul b15~124@ 89))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> %%location_label%%15 (= temp_15_0~2885@ temp_15_1~3010@))))) (=> (= temp_15_0~2885@ temp_15_1~3010@) (=> (= temp_16_0~3147@ (Mul (Mul (Add d16~136@ (Mul b16~132@ c16~134@)) (Mul (Add d16~136@ c16~134@) (Mul d16~136@ b16~132@))) (Add (Add (Mul b16~132@ b16~132@) (Add b16~132@ d16~136@)) (Mul (Sub a16~130@ b16~132@) (Mul c16~134@ c16~134@))))) (=> (= temp_16_1~3216@ (Mul (Mul (Add d16~136@ (Mul b16~132@ c16~134@)) (Mul (Add d16~136@ c16~134@) (Mul d16~136@ b16~132@))) (Add (Add (Mul b16~132@ b16~132@) (Add b16~132@ d16~136@)) (Sub (Mul a16~130@ (Mul c16~134@ c16~134@)) (Mul b16~132@ (Mul c16~134@ c16~134@)))))) (=> (= tmp%25@ (Mul c16~134@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a16~130@ b16~132@ tmp%25@) (=> %%location_label%%16 (= temp_16_0~3147@ temp_16_1~3216@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
