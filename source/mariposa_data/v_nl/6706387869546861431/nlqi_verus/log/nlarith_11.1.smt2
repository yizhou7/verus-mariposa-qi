...
(declare-const temp_3_0~1104@ Int)
(declare-const temp_3_1~1245@ Int)
(declare-const temp_4_0~1349@ Int)
(declare-const temp_4_1~1438@ Int)
(declare-const temp_5_0~1538@ Int)
(declare-const temp_5_1~1623@ Int)
(declare-const temp_6_0~1739@ Int)
(declare-const temp_6_1~1840@ Int)
(declare-const temp_7_0~2012@ Int)
(declare-const temp_7_1~2169@ Int)
(declare-const temp_8_0~2313@ Int)
(declare-const temp_8_1~2442@ Int)
(declare-const temp_9_0~2598@ Int)
(declare-const temp_9_1~2739@ Int)
(declare-const temp_10_0~2851@ Int)
(declare-const temp_10_1~2948@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Sub (Mul (Mul (Mul c0~6@ b0~4@) (Mul 98 b0~4@)) (Sub (Mul c0~6@ c0~6@) (Mul d0~8@ b0~4@))) (Mul (Mul b0~4@ (Add d0~8@ a0~2@)) (Mul c0~6@ b0~4@))) (Add (Mul (Mul (Mul b0~4@ b0~4@) b0~4@) a0~2@) (Mul (Mul (Add d0~8@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ b0~4@)))))) (=> (= temp_0_1~386@ (Mul (Sub (Mul (Mul (Mul c0~6@ b0~4@) (Mul 98 b0~4@)) (Sub (Mul c0~6@ c0~6@) (Mul d0~8@ b0~4@))) (Mul (Mul (Mul b0~4@ (Add d0~8@ a0~2@)) c0~6@) b0~4@)) (Add (Mul (Mul (Mul b0~4@ b0~4@) b0~4@) a0~2@) (Mul (Mul (Add d0~8@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ b0~4@)))))) (=> (= tmp%1@ (= temp_0_0~273@ temp_0_1~386@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~526@ (Mul (Mul (Sub (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ a1~10@)) (Sub d1~16@ (Mul d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub d1~16@ b1~12@)) (Mul (Mul d1~16@ 69) (Mul d1~16@ c1~14@)))) (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@))) (Mul d1~16@ (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@)))))) (=> (= temp_1_1~651@ (Mul (Mul (Sub (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ a1~10@)) (Sub d1~16@ (Mul d1~16@ c1~14@))) (Mul (Mul (Mul c1~14@ d1~16@) (Sub d1~16@ b1~12@)) (Mul (Mul d1~16@ 69) (Mul d1~16@ c1~14@)))) (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@))) (Mul d1~16@ (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@)))))) (=> (= tmp%2@ (= temp_1_0~526@ temp_1_1~651@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~807@ (Mul (Mul (Mul (Mul (Add d2~24@ d2~24@) c2~22@) (Mul (Mul c2~22@ d2~24@) b2~20@)) (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@)) (Add (Mul a2~18@ a2~18@) (Add d2~24@ d2~24@)))) (Sub (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ 34)) (Mul (Mul a2~18@ c2~22@) (Mul 63 a2~18@))) (Mul (Add (Mul a2~18@ a2~18@) (Mul b2~20@ c2~22@)) (Add b2~20@ (Mul c2~22@ a2~18@)))))) (=> (= temp_2_1~948@ (Mul (Sub (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ 34)) (Mul (Mul a2~18@ c2~22@) (Mul 63 a2~18@))) (Mul (Add (Mul a2~18@ a2~18@) (Mul b2~20@ c2~22@)) (Add b2~20@ (Mul c2~22@ a2~18@)))) (Mul (Mul (Mul (Add d2~24@ d2~24@) c2~22@) (Mul (Mul c2~22@ d2~24@) b2~20@)) (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@)) (Add (Mul a2~18@ a2~18@) (Add d2~24@ d2~24@)))))) (=> (= tmp%3@ (= temp_2_0~807@ temp_2_1~948@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1104@ (Mul (Mul (Mul (Mul (Mul 66 c3~30@) (Add 58 d3~32@)) (Sub d3~32@ (Sub d3~32@ d3~32@))) (Mul (Mul (Mul b3~28@ a3~26@) d3~32@) c3~30@)) (Sub (Mul (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul 8 b3~28@) (Mul b3~28@ c3~30@)) (Sub (Mul d3~32@ b3~28@) b3~28@))))) (=> (= temp_3_1~1245@ (Mul (Mul (Mul (Mul (Mul 66 c3~30@) (Add 58 d3~32@)) (Sub d3~32@ (Sub d3~32@ d3~32@))) (Mul (Mul (Mul b3~28@ a3~26@) d3~32@) c3~30@)) (Sub (Mul (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul 8 b3~28@) (Mul b3~28@ c3~30@)) (Sub (Mul b3~28@ d3~32@) b3~28@))))) (=> (= tmp%4@ (= temp_3_0~1104@ temp_3_1~1245@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1349@ (Mul (Mul c4~38@ (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) d4~40@)) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@)) (Add (Mul c4~38@ c4~38@) (Add a4~34@ b4~36@))) (Add (Mul (Sub c4~38@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)))))) (=> (= temp_4_1~1438@ (Mul (Mul c4~38@ (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) d4~40@)) (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ a4~34@)) (Add (Mul c4~38@ c4~38@) (Add a4~34@ b4~36@))) (Add (Mul (Sub c4~38@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)))))) (=> (= tmp%5@ (= temp_4_0~1349@ temp_4_1~1438@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1538@ (Mul (Add (Mul b5~44@ (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ b5~44@))) b5~44@) (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ b5~44@) a5~42@) (Add (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@)))))) (=> (= temp_5_1~1623@ (Mul (Add (Mul b5~44@ (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ b5~44@))) b5~44@) (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Add (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Mul c5~46@ b5~44@) a5~42@))))) (=> (= tmp%6@ (= temp_5_0~1538@ temp_5_1~1623@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1739@ (Mul (Mul (Sub (Mul (Mul b6~52@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ d6~56@))) d6~56@) (Mul (Mul (Sub (Mul c6~54@ a6~50@) (Add a6~50@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Sub d6~56@ a6~50@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ d6~56@)))))) (=> (= temp_6_1~1840@ (Mul (Mul (Sub (Mul (Mul b6~52@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ d6~56@))) d6~56@) (Mul (Mul (Sub (Mul c6~54@ a6~50@) (Add a6~50@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Sub d6~56@ a6~50@))) (Mul (Mul a6~50@ c6~54@) (Mul (Mul b6~52@ a6~50@) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ d6~56@))))))) (=> (= tmp%7@ (= temp_6_0~1739@ temp_6_1~1840@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2012@ (Mul (Mul (Add (Mul (Add d7~64@ d7~64@) (Sub b7~60@ d7~64@)) (Mul b7~60@ (Mul c7~62@ b7~60@))) (Mul (Mul (Mul 27 a7~58@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ a7~58@)))) (Mul (Mul (Sub (Mul a7~58@ c7~62@) (Mul 1 a7~58@)) (Add c7~62@ (Mul b7~60@ c7~62@))) (Mul (Mul (Mul d7~64@ 4) (Add c7~62@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)))))) (=> (= temp_7_1~2169@ (Mul (Mul (Add (Mul (Add d7~64@ d7~64@) (Sub b7~60@ d7~64@)) (Mul b7~60@ (Mul c7~62@ b7~60@))) (Mul (Mul (Mul 27 a7~58@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ a7~58@)))) (Mul (Mul (Sub (Mul a7~58@ c7~62@) (Mul 1 a7~58@)) (Add c7~62@ (Mul b7~60@ c7~62@))) (Mul (Mul (Mul d7~64@ 4) (Add c7~62@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)))))) (=> (= tmp%8@ (= temp_7_0~2012@ temp_7_1~2169@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2313@ (Mul (Mul (Mul (Sub (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@)) (Add (Mul d8~72@ a8~66@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul d8~72@ 19) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@)))) (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@)) b8~68@) (Mul (Add (Sub d8~72@ a8~66@) (Mul a8~66@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ a8~66@)))))) (=> (= temp_8_1~2442@ (Mul (Mul (Mul (Sub (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@)) (Add (Mul d8~72@ a8~66@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul d8~72@ 19) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@)))) (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@)) b8~68@) (Mul (Add (Sub d8~72@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ a8~66@)))))) (=> (= tmp%9@ (= temp_8_0~2313@ temp_8_1~2442@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2598@ (Mul (Sub (Mul (Add (Mul d9~80@ c9~78@) (Mul a9~74@ b9~76@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ 33))) (Mul (Sub (Mul c9~78@ b9~76@) (Sub d9~80@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ b9~76@)))) (Mul (Sub (Mul (Mul c9~78@ c9~78@) (Sub a9~74@ c9~78@)) (Mul (Sub b9~76@ c9~78@) (Mul c9~78@ d9~80@))) (Sub (Sub (Add d9~80@ b9~76@) (Add a9~74@ d9~80@)) (Mul (Add b9~76@ d9~80@) (Mul d9~80@ a9~74@)))))) (=> (= temp_9_1~2739@ (Mul (Sub (Mul (Add (Mul d9~80@ c9~78@) (Mul a9~74@ b9~76@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ 33))) (Mul (Sub (Mul c9~78@ b9~76@) (Sub d9~80@ b9~76@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@)))) (Mul (Sub (Mul (Mul c9~78@ c9~78@) (Sub a9~74@ c9~78@)) (Mul (Sub b9~76@ c9~78@) (Mul c9~78@ d9~80@))) (Sub (Sub (Add d9~80@ b9~76@) (Add a9~74@ d9~80@)) (Mul (Add b9~76@ d9~80@) (Mul d9~80@ a9~74@)))))) (=> (= tmp%10@ (= temp_9_0~2598@ temp_9_1~2739@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~2851@ (Mul (Mul (Mul d10~88@ c10~86@) (Mul (Mul a10~82@ (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)))) (Mul (Sub c10~86@ (Mul (Mul b10~84@ c10~86@) (Mul 53 b10~84@))) (Mul (Mul (Mul a10~82@ c10~86@) (Add a10~82@ c10~86@)) (Mul b10~84@ (Add a10~82@ d10~88@)))))) (=> (= temp_10_1~2948@ (Mul (Mul (Mul d10~88@ c10~86@) (Mul (Mul (Mul a10~82@ d10~88@) d10~88@) (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)))) (Mul (Sub c10~86@ (Mul (Mul b10~84@ c10~86@) (Mul 53 b10~84@))) (Mul (Mul (Mul a10~82@ c10~86@) (Add a10~82@ c10~86@)) (Mul b10~84@ (Add a10~82@ d10~88@)))))) (=> (= tmp%11@ (= temp_10_0~2851@ temp_10_1~2948@)) (=> %%location_label%%10 tmp%11@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
