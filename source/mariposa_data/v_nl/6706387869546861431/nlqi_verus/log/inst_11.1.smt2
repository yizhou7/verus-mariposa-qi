...
(set-info :comment ";; mariposa_data/v_nl//6706387869546861431/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Sub (Mul (Mul (Mul c0~6@ b0~4@) (Mul 98 b0~4@)) (Sub (Mul c0~6@ c0~6@) (Mul d0~8@ b0~4@))) (Mul (Mul b0~4@ (Add d0~8@ a0~2@)) (Mul c0~6@ b0~4@))) (Add (Mul (Mul (Mul b0~4@ b0~4@) b0~4@) a0~2@) (Mul (Mul (Add d0~8@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ b0~4@)))))) (=> (= temp_0_1~386@ (Mul (Sub (Mul (Mul (Mul c0~6@ b0~4@) (Mul 98 b0~4@)) (Sub (Mul c0~6@ c0~6@) (Mul d0~8@ b0~4@))) (Mul (Mul (Mul b0~4@ (Add d0~8@ a0~2@)) c0~6@) b0~4@)) (Add (Mul (Mul (Mul b0~4@ b0~4@) b0~4@) a0~2@) (Mul (Mul (Add d0~8@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ b0~4@)))))) (and (=> (= tmp%1@ (Mul b0~4@ (Add d0~8@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~386@)))) (=> (= temp_0_0~273@ temp_0_1~386@) (=> (= temp_1_0~549@ (Mul (Mul (Sub (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ a1~10@)) (Sub d1~16@ (Mul d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub d1~16@ b1~12@)) (Mul (Mul d1~16@ 69) (Mul d1~16@ c1~14@)))) (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@))) (Mul d1~16@ (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@)))))) (=> (= temp_1_1~674@ (Mul (Mul (Sub (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ a1~10@)) (Sub d1~16@ (Mul d1~16@ c1~14@))) (Mul (Mul (Mul c1~14@ d1~16@) (Sub d1~16@ b1~12@)) (Mul (Mul d1~16@ 69) (Mul d1~16@ c1~14@)))) (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@))) (Mul d1~16@ (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~549@ temp_1_1~674@))) (=> (= temp_1_0~549@ temp_1_1~674@) (=> (= temp_2_0~843@ (Mul (Mul (Mul (Mul (Add d2~24@ d2~24@) c2~22@) (Mul (Mul c2~22@ d2~24@) b2~20@)) (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@)) (Add (Mul a2~18@ a2~18@) (Add d2~24@ d2~24@)))) (Sub (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ 34)) (Mul (Mul a2~18@ c2~22@) (Mul 63 a2~18@))) (Mul (Add (Mul a2~18@ a2~18@) (Mul b2~20@ c2~22@)) (Add b2~20@ (Mul c2~22@ a2~18@)))))) (=> (= temp_2_1~984@ (Mul (Sub (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ 34)) (Mul (Mul a2~18@ c2~22@) (Mul 63 a2~18@))) (Mul (Add (Mul a2~18@ a2~18@) (Mul b2~20@ c2~22@)) (Add b2~20@ (Mul c2~22@ a2~18@)))) (Mul (Mul (Mul (Add d2~24@ d2~24@) c2~22@) (Mul (Mul c2~22@ d2~24@) b2~20@)) (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@)) (Add (Mul a2~18@ a2~18@) (Add d2~24@ d2~24@)))))) (and (=> (= tmp%2@ (Mul (Mul (Mul (Add d2~24@ d2~24@) c2~22@) (Mul (Mul c2~22@ d2~24@) b2~20@)) (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@)) (Add (Mul a2~18@ a2~18@) (Add d2~24@ d2~24@))))) (=> (= tmp%3@ (Sub (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ 34)) (Mul (Mul a2~18@ c2~22@) (Mul 63 a2~18@))) (Mul (Add (Mul a2~18@ a2~18@) (Mul b2~20@ c2~22@)) (Add b2~20@ (Mul c2~22@ a2~18@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~843@ temp_2_1~984@))))) (=> (= temp_2_0~843@ temp_2_1~984@) (=> (= temp_3_0~1285@ (Mul (Mul (Mul (Mul (Mul 66 c3~30@) (Add 58 d3~32@)) (Sub d3~32@ (Sub d3~32@ d3~32@))) (Mul (Mul (Mul b3~28@ a3~26@) d3~32@) c3~30@)) (Sub (Mul (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul 8 b3~28@) (Mul b3~28@ c3~30@)) (Sub (Mul d3~32@ b3~28@) b3~28@))))) (=> (= temp_3_1~1426@ (Mul (Mul (Mul (Mul (Mul 66 c3~30@) (Add 58 d3~32@)) (Sub d3~32@ (Sub d3~32@ d3~32@))) (Mul (Mul (Mul b3~28@ a3~26@) d3~32@) c3~30@)) (Sub (Mul (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul 8 b3~28@) (Mul b3~28@ c3~30@)) (Sub (Mul b3~28@ d3~32@) b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ b3~28@) (=> %%location_label%%3 (= temp_3_0~1285@ temp_3_1~1426@))) (=> (= temp_3_0~1285@ temp_3_1~1426@) (=> (= temp_4_0~1543@ (Mul (Mul c4~38@ (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) d4~40@)) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@)) (Add (Mul c4~38@ c4~38@) (Add a4~34@ b4~36@))) (Add (Mul (Sub c4~38@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)))))) (=> (= temp_4_1~1632@ (Mul (Mul c4~38@ (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@)) d4~40@)) (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ a4~34@)) (Add (Mul c4~38@ c4~38@) (Add a4~34@ b4~36@))) (Add (Mul (Sub c4~38@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)))))) (and (=> (= tmp%4@ (Mul d4~40@ a4~34@)) (=> (= tmp%5@ (Mul b4~36@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%4 (= temp_4_0~1543@ temp_4_1~1632@))))) (=> (= temp_4_0~1543@ temp_4_1~1632@) (=> (= temp_5_0~1753@ (Mul (Add (Mul b5~44@ (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ b5~44@))) b5~44@) (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ b5~44@) a5~42@) (Add (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@)))))) (=> (= temp_5_1~1838@ (Mul (Add (Mul b5~44@ (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ b5~44@))) b5~44@) (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Add (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Mul (Mul c5~46@ b5~44@) a5~42@))))) (and (=> (= tmp%6@ (Mul (Mul c5~46@ b5~44@) a5~42@)) (=> (= tmp%7@ (Add (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%5 (= temp_5_0~1753@ temp_5_1~1838@))))) (=> (= temp_5_0~1753@ temp_5_1~1838@) (=> (= temp_6_0~1987@ (Mul (Mul (Sub (Mul (Mul b6~52@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ d6~56@))) d6~56@) (Mul (Mul (Sub (Mul c6~54@ a6~50@) (Add a6~50@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Sub d6~56@ a6~50@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ d6~56@)))))) (=> (= temp_6_1~2088@ (Mul (Mul (Sub (Mul (Mul b6~52@ a6~50@) (Sub d6~56@ a6~50@)) (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ d6~56@))) d6~56@) (Mul (Mul (Sub (Mul c6~54@ a6~50@) (Add a6~50@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Sub d6~56@ a6~50@))) (Mul (Mul a6~50@ c6~54@) (Mul (Mul b6~52@ a6~50@) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ d6~56@))))))) (and (=> (= tmp%8@ (Mul a6~50@ c6~54@)) (=> (= tmp%9@ (Mul b6~52@ a6~50@)) (=> (= tmp%10@ (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ d6~56@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~1987@ temp_6_1~2088@)))))) (=> (= temp_6_0~1987@ temp_6_1~2088@) (=> (= temp_7_0~2295@ (Mul (Mul (Add (Mul (Add d7~64@ d7~64@) (Sub b7~60@ d7~64@)) (Mul b7~60@ (Mul c7~62@ b7~60@))) (Mul (Mul (Mul 27 a7~58@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ a7~58@)))) (Mul (Mul (Sub (Mul a7~58@ c7~62@) (Mul 1 a7~58@)) (Add c7~62@ (Mul b7~60@ c7~62@))) (Mul (Mul (Mul d7~64@ 4) (Add c7~62@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)))))) (=> (= temp_7_1~2452@ (Mul (Mul (Add (Mul (Add d7~64@ d7~64@) (Sub b7~60@ d7~64@)) (Mul b7~60@ (Mul c7~62@ b7~60@))) (Mul (Mul (Mul 27 a7~58@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ a7~58@)))) (Mul (Mul (Sub (Mul a7~58@ c7~62@) (Mul 1 a7~58@)) (Add c7~62@ (Mul b7~60@ c7~62@))) (Mul (Mul (Mul d7~64@ 4) (Add c7~62@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ c7~62@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ d7~64@) (=> %%location_label%%7 (= temp_7_0~2295@ temp_7_1~2452@))) (=> (= temp_7_0~2295@ temp_7_1~2452@) (=> (= temp_8_0~2609@ (Mul (Mul (Mul (Sub (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@)) (Add (Mul d8~72@ a8~66@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul d8~72@ 19) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@)))) (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@)) b8~68@) (Mul (Add (Sub d8~72@ a8~66@) (Mul a8~66@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ a8~66@)))))) (=> (= temp_8_1~2738@ (Mul (Mul (Mul (Sub (Mul d8~72@ c8~70@) (Mul c8~70@ c8~70@)) (Add (Mul d8~72@ a8~66@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul d8~72@ 19) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@)))) (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@)) b8~68@) (Mul (Add (Sub d8~72@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ a8~66@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ c8~70@) (=> %%location_label%%8 (= temp_8_0~2609@ temp_8_1~2738@))) (=> (= temp_8_0~2609@ temp_8_1~2738@) (=> (= temp_9_0~2907@ (Mul (Sub (Mul (Add (Mul d9~80@ c9~78@) (Mul a9~74@ b9~76@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ 33))) (Mul (Sub (Mul c9~78@ b9~76@) (Sub d9~80@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ b9~76@)))) (Mul (Sub (Mul (Mul c9~78@ c9~78@) (Sub a9~74@ c9~78@)) (Mul (Sub b9~76@ c9~78@) (Mul c9~78@ d9~80@))) (Sub (Sub (Add d9~80@ b9~76@) (Add a9~74@ d9~80@)) (Mul (Add b9~76@ d9~80@) (Mul d9~80@ a9~74@)))))) (=> (= temp_9_1~3048@ (Mul (Sub (Mul (Add (Mul d9~80@ c9~78@) (Mul a9~74@ b9~76@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ 33))) (Mul (Sub (Mul c9~78@ b9~76@) (Sub d9~80@ b9~76@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@)))) (Mul (Sub (Mul (Mul c9~78@ c9~78@) (Sub a9~74@ c9~78@)) (Mul (Sub b9~76@ c9~78@) (Mul c9~78@ d9~80@))) (Sub (Sub (Add d9~80@ b9~76@) (Add a9~74@ d9~80@)) (Mul (Add b9~76@ d9~80@) (Mul d9~80@ a9~74@)))))) (and (=> (= tmp%11@ (Mul b9~76@ c9~78@)) (=> (= tmp%12@ (Mul b9~76@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%9 (= temp_9_0~2907@ temp_9_1~3048@))))) (=> (= temp_9_0~2907@ temp_9_1~3048@) (=> (= temp_10_0~3181@ (Mul (Mul (Mul d10~88@ c10~86@) (Mul (Mul a10~82@ (Mul d10~88@ d10~88@)) (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)))) (Mul (Sub c10~86@ (Mul (Mul b10~84@ c10~86@) (Mul 53 b10~84@))) (Mul (Mul (Mul a10~82@ c10~86@) (Add a10~82@ c10~86@)) (Mul b10~84@ (Add a10~82@ d10~88@)))))) (=> (= temp_10_1~3278@ (Mul (Mul (Mul d10~88@ c10~86@) (Mul (Mul (Mul a10~82@ d10~88@) d10~88@) (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ c10~86@)))) (Mul (Sub c10~86@ (Mul (Mul b10~84@ c10~86@) (Mul 53 b10~84@))) (Mul (Mul (Mul a10~82@ c10~86@) (Add a10~82@ c10~86@)) (Mul b10~84@ (Add a10~82@ d10~88@)))))) (=> (ens%main!nl_basics.lemma_mul_is_associative. a10~82@ d10~88@ d10~88@) (=> %%location_label%%10 (= temp_10_0~3181@ temp_10_1~3278@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
