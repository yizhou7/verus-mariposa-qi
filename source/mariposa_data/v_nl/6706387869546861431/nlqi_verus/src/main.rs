...
a19: int, b19: int, c19: int, d19: int)
{
	...
	let temp_7_0 = (((((d7+d7)*(b7-d7))+(b7*(c7*b7)))*((((27 as int)*a7)*(d7*d7))*((d7*b7)*(b7*a7))))*((((a7*c7)-((1 as int)*a7))*(c7+(b7*c7)))*(((d7*(4 as int))*(c7+c7))*((b7*b7)*(b7*c7)))));
	let temp_7_1 = (((((d7+d7)*(b7-d7))+(b7*(c7*b7)))*((((27 as int)*a7)*(d7*d7))*((d7*b7)*(b7*a7))))*((((a7*c7)-((1 as int)*a7))*(c7+(b7*c7)))*(((d7*(4 as int))*(c7+c7))*((b7*b7)*(b7*c7)))));
	assert(temp_7_0 == temp_7_1);
	let temp_8_0 = (((((d8*c8)-(c8*c8))*((d8*a8)+(a8*b8)))*(((d8*(19 as int))*(c8*a8))*((d8*b8)*(d8*d8))))*((((b8*d8)*(d8*b8))*b8)*(((d8-a8)+(a8*c8))*((a8*a8)*(b8*a8)))));
	let temp_8_1 = (((((d8*c8)-(c8*c8))*((d8*a8)+(a8*b8)))*(((d8*(19 as int))*(c8*a8))*((d8*b8)*(d8*d8))))*((((b8*d8)*(d8*b8))*b8)*(((d8-a8)+(c8*a8))*((a8*a8)*(b8*a8)))));
	assert(temp_8_0 == temp_8_1);
	let temp_9_0 = (((((d9*c9)+(a9*b9))*((d9*b9)*(a9*(33 as int))))-(((c9*b9)-(d9-b9))*((b9*c9)*(b9*b9))))*((((c9*c9)*(a9-c9))-((b9-c9)*(c9*d9)))*(((d9+b9)-(a9+d9))-((b9+d9)*(d9*a9)))));
	let temp_9_1 = (((((d9*c9)+(a9*b9))*((d9*b9)*(a9*(33 as int))))-(((c9*b9)-(d9-b9))*((b9*b9)*(b9*c9))))*((((c9*c9)*(a9-c9))-((b9-c9)*(c9*d9)))*(((d9+b9)-(a9+d9))-((b9+d9)*(d9*a9)))));
	assert(temp_9_0 == temp_9_1);
	let temp_10_0 = (((d10*c10)*((a10*(d10*d10))*((d10*d10)*(d10*c10))))*((c10-((b10*c10)*((53 as int)*b10)))*(((a10*c10)*(a10+c10))*(b10*(a10+d10)))));
	let temp_10_1 = (((d10*c10)*(((a10*d10)*d10)*((d10*d10)*(d10*c10))))*((c10-((b10*c10)*((53 as int)*b10)))*(((a10*c10)*(a10+c10))*(b10*(a10+d10)))));
