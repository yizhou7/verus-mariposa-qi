...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Sub b0~4@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul c0~6@ a0~2@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Sub b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul c0~6@ a0~2@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~447@ (Mul (Mul c1~14@ (Mul (Mul d1~16@ a1~10@) (Sub c1~14@ a1~10@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~500@ (Mul (Mul c1~14@ (Mul d1~16@ (Mul a1~10@ (Sub c1~14@ a1~10@)))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~500@))) (=> (= temp_1_0~447@ temp_1_1~500@) (=> (= temp_2_0~597@ (Mul (Mul (Sub (Mul d2~24@ 75) a2~18@) (Mul (Sub d2~24@ c2~22@) (Add d2~24@ c2~22@))) (Mul (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~670@ (Mul (Mul (Sub (Mul d2~24@ 75) a2~18@) (Mul (Sub d2~24@ c2~22@) (Add d2~24@ c2~22@))) (Mul (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul (Mul b2~20@ a2~18@) b2~20@) d2~24@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~597@ temp_2_1~670@))) (=> (= temp_2_0~597@ temp_2_1~670@) (=> (= temp_3_0~767@ (Mul (Add (Mul (Mul 90 b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))) (Mul (Add (Mul b3~28@ b3~28@) (Mul a3~26@ d3~32@)) (Mul c3~30@ (Sub c3~30@ d3~32@))))) (=> (= temp_3_1~852@ (Mul (Add (Mul (Mul 90 b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))) (Add (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ (Sub c3~30@ d3~32@))) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ (Sub c3~30@ d3~32@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~767@ temp_3_1~852@))) (=> (= temp_3_0~767@ temp_3_1~852@) (=> (= temp_4_0~909@ (Mul (Mul (Mul a4~34@ (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Sub a4~34@ c4~38@))) b4~36@)) (=> (= temp_4_1~942@ (Mul b4~36@ (Mul (Mul a4~34@ (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Sub a4~34@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~909@ temp_4_1~942@))) (=> (= temp_4_0~909@ temp_4_1~942@) (=> (= temp_5_0~1015@ (Add (Mul (Mul (Add c5~46@ d5~48@) (Add a5~42@ d5~48@)) (Sub (Add a5~42@ c5~46@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul d5~48@ d5~48@) a5~42@) d5~48@))) (=> (= temp_5_1~1064@ (Add (Mul (Mul (Add c5~46@ d5~48@) (Add a5~42@ d5~48@)) (Sub (Add a5~42@ c5~46@) (Mul b5~44@ b5~44@))) (Mul d5~48@ (Mul (Mul d5~48@ d5~48@) a5~42@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1015@ temp_5_1~1064@))) (=> (= temp_5_0~1015@ temp_5_1~1064@) (=> (= temp_6_0~1141@ (Mul (Mul (Mul (Add c6~54@ c6~54@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add b6~52@ d6~56@) (Add d6~56@ c6~54@)) a6~50@))) (=> (= temp_6_1~1194@ (Mul (Mul (Mul (Add c6~54@ c6~54@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add d6~56@ c6~54@) (Add b6~52@ d6~56@)) a6~50@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1141@ temp_6_1~1194@))) (=> (= temp_6_0~1141@ temp_6_1~1194@) (=> (= temp_7_0~1295@ (Mul (Add (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ c7~62@)) (Sub (Mul c7~62@ 34) (Mul a7~58@ c7~62@))) (Mul (Add (Mul a7~58@ a7~58@) (Sub c7~62@ c7~62@)) (Mul (Mul d7~64@ c7~62@) (Add b7~60@ b7~60@))))) (=> (= temp_7_1~1380@ (Mul (Add (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ c7~62@)) (Sub (Mul c7~62@ 34) (Mul a7~58@ c7~62@))) (Mul (Add (Mul a7~58@ a7~58@) (Sub c7~62@ c7~62@)) (Add (Mul (Mul d7~64@ c7~62@) b7~60@) (Mul (Mul d7~64@ c7~62@) b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1295@ temp_7_1~1380@))) (=> (= temp_7_0~1295@ temp_7_1~1380@) (=> (= temp_8_0~1481@ (Add (Mul (Mul (Sub b8~68@ d8~72@) (Sub b8~68@ d8~72@)) (Add (Mul c8~70@ b8~68@) (Add c8~70@ a8~66@))) (Mul (Mul (Mul b8~68@ d8~72@) (Sub a8~66@ a8~66@)) (Mul (Mul 77 d8~72@) (Mul d8~72@ d8~72@))))) (=> (= temp_8_1~1558@ (Add (Mul (Mul (Sub b8~68@ d8~72@) (Sub b8~68@ d8~72@)) (Add (Mul c8~70@ b8~68@) (Add c8~70@ a8~66@))) (Mul (Mul (Mul b8~68@ d8~72@) (Sub a8~66@ a8~66@)) (Mul (Mul d8~72@ 77) (Mul d8~72@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1481@ temp_8_1~1558@))) (=> (= temp_8_0~1481@ temp_8_1~1558@) (=> (= temp_9_0~1659@ (Mul (Mul (Mul (Mul b9~76@ b9~76@) (Sub d9~80@ d9~80@)) (Sub (Mul c9~78@ c9~78@) (Add a9~74@ c9~78@))) (Sub (Add (Mul d9~80@ b9~76@) (Mul b9~76@ 12)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1744@ (Mul (Mul (Sub (Mul (Mul b9~76@ b9~76@) d9~80@) (Mul (Mul b9~76@ b9~76@) d9~80@)) (Sub (Mul c9~78@ c9~78@) (Add a9~74@ c9~78@))) (Sub (Add (Mul d9~80@ b9~76@) (Mul b9~76@ 12)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1659@ temp_9_1~1744@))) (=> (= temp_9_0~1659@ temp_9_1~1744@) (=> (= temp_10_0~1845@ (Mul (Mul (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ a10~82@)) d10~88@) (Mul (Sub (Mul d10~88@ d10~88@) (Mul a10~82@ 70)) (Sub (Sub a10~82@ b10~84@) (Mul 82 a10~82@))))) (=> (= temp_10_1~1922@ (Mul (Mul d10~88@ (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ a10~82@))) (Mul (Sub (Mul d10~88@ d10~88@) (Mul a10~82@ 70)) (Sub (Sub a10~82@ b10~84@) (Mul 82 a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1845@ temp_10_1~1922@))) (=> (= temp_10_0~1845@ temp_10_1~1922@) (=> (= temp_11_0~2019@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ c11~94@) a11~90@)) (Mul (Mul (Mul d11~96@ 24) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ d11~96@) (Sub a11~90@ b11~92@))))) (=> (= temp_11_1~2092@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ c11~94@) a11~90@)) (Mul (Mul (Mul d11~96@ 24) (Mul d11~96@ a11~90@)) (Mul (Mul d11~96@ c11~94@) (Sub a11~90@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2019@ temp_11_1~2092@))) (=> (= temp_11_0~2019@ temp_11_1~2092@) (=> (= temp_12_0~2181@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ a12~98@) (Mul d12~104@ a12~98@))) (Mul (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2246@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul (Mul a12~98@ a12~98@) d12~104@) a12~98@)) (Mul (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2181@ temp_12_1~2246@))) (=> (= temp_12_0~2181@ temp_12_1~2246@) (=> (= temp_13_0~2327@ (Mul (Mul (Mul b13~108@ (Sub d13~112@ d13~112@)) (Mul (Mul b13~108@ a13~106@) (Sub d13~112@ b13~108@))) (Add (Sub (Sub d13~112@ d13~112@) (Mul d13~112@ d13~112@)) (Mul (Sub a13~106@ c13~110@) c13~110@)))) (=> (= temp_13_1~2384@ (Mul (Mul (Mul b13~108@ (Sub d13~112@ d13~112@)) (Mul (Sub d13~112@ b13~108@) (Mul b13~108@ a13~106@))) (Add (Sub (Sub d13~112@ d13~112@) (Mul d13~112@ d13~112@)) (Mul (Sub a13~106@ c13~110@) c13~110@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2327@ temp_13_1~2384@))) (=> (= temp_13_0~2327@ temp_13_1~2384@) (=> (= temp_14_0~2473@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ b14~116@)) (Mul (Mul d14~120@ d14~120@) (Mul a14~114@ c14~118@))) (Add (Add (Mul a14~114@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2538@ (Mul (Mul (Mul a14~114@ (Mul a14~114@ (Mul a14~114@ b14~116@))) (Mul (Mul d14~120@ d14~120@) (Mul a14~114@ c14~118@))) (Add (Add (Mul a14~114@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2473@ temp_14_1~2538@))) (=> (= temp_14_0~2473@ temp_14_1~2538@) (=> (= temp_15_0~2615@ (Mul (Mul b15~124@ (Sub (Mul c15~126@ b15~124@) (Mul b15~124@ d15~128@))) (Add c15~126@ (Sub (Mul b15~124@ b15~124@) (Mul b15~124@ 20))))) (=> (= temp_15_1~2672@ (Mul (Sub (Mul b15~124@ (Mul c15~126@ b15~124@)) (Mul b15~124@ (Mul b15~124@ d15~128@))) (Add c15~126@ (Sub (Mul b15~124@ b15~124@) (Mul b15~124@ 20))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2615@ temp_15_1~2672@))) (=> (= temp_15_0~2615@ temp_15_1~2672@) (=> (= temp_16_0~2753@ (Sub (Mul (Mul a16~130@ (Mul b16~132@ a16~130@)) (Sub (Mul a16~130@ d16~136@) (Mul b16~132@ b16~132@))) (Add (Mul (Sub d16~136@ a16~130@) b16~132@) (Mul (Mul d16~136@ b16~132@) (Add b16~132@ a16~130@))))) (=> (= temp_16_1~2810@ (Sub (Mul (Mul a16~130@ (Mul a16~130@ b16~132@)) (Sub (Mul a16~130@ d16~136@) (Mul b16~132@ b16~132@))) (Add (Mul (Sub d16~136@ a16~130@) b16~132@) (Mul (Mul d16~136@ b16~132@) (Add b16~132@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2753@ temp_16_1~2810@))) (=> (= temp_16_0~2753@ temp_16_1~2810@) (=> (= temp_17_0~2871@ (Mul c17~142@ (Sub (Sub (Mul c17~142@ d17~144@) (Mul d17~144@ c17~142@)) (Sub (Mul c17~142@ d17~144@) (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~2912@ (Sub (Mul c17~142@ (Sub (Mul c17~142@ d17~144@) (Mul d17~144@ c17~142@))) (Mul c17~142@ (Sub (Mul c17~142@ d17~144@) (Mul a17~138@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2871@ temp_17_1~2912@))) (=> (= temp_17_0~2871@ temp_17_1~2912@) (=> (= temp_18_0~2989@ (Mul (Mul (Mul (Mul d18~152@ d18~152@) (Add a18~146@ a18~146@)) b18~148@) (Mul (Sub (Mul c18~150@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ a18~146@) (Mul d18~152@ c18~150@))))) (=> (= temp_18_1~3042@ (Mul (Mul (Mul (Mul d18~152@ d18~152@) (Add a18~146@ a18~146@)) b18~148@) (Mul (Sub (Mul c18~150@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2989@ temp_18_1~3042@))) (=> (= temp_18_0~2989@ temp_18_1~3042@) (=> (= temp_19_0~3131@ (Mul (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ b19~156@)) (Sub (Mul b19~156@ a19~154@) (Mul c19~158@ c19~158@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ d19~160@))))) (=> (= temp_19_1~3196@ (Mul (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ b19~156@)) (Sub (Mul a19~154@ b19~156@) (Mul c19~158@ c19~158@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3131@ temp_19_1~3196@))) (=> (= temp_19_0~3131@ temp_19_1~3196@) (=> (= temp_20_0~3285@ (Mul (Mul (Mul (Add c20~166@ c20~166@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Mul b20~164@ d20~168@))) (Mul (Add (Mul c20~166@ a20~162@) (Mul c20~166@ a20~162@)) (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ a20~162@))))) (=> (= temp_20_1~3350@ (Mul (Mul (Mul (Add c20~166@ c20~166@) (Mul d20~168@ c20~166@)) (Mul b20~164@ (Mul a20~162@ (Mul b20~164@ d20~168@)))) (Mul (Add (Mul c20~166@ a20~162@) (Mul c20~166@ a20~162@)) (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ a20~162@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3285@ temp_20_1~3350@))) (=> (= temp_20_0~3285@ temp_20_1~3350@) (=> (= temp_21_0~3435@ (Mul (Add b21~172@ (Mul (Mul a21~170@ d21~176@) (Add d21~176@ c21~174@))) (Mul (Mul c21~174@ (Add b21~172@ 56)) (Mul (Mul d21~176@ a21~170@) (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~3536@ (Add (Mul b21~172@ (Mul (Mul c21~174@ (Add b21~172@ 56)) (Mul (Mul d21~176@ a21~170@) (Mul a21~170@ b21~172@)))) (Mul (Mul (Mul a21~170@ d21~176@) (Add d21~176@ c21~174@)) (Mul (Mul c21~174@ (Add b21~172@ 56)) (Mul (Mul d21~176@ a21~170@) (Mul a21~170@ b21~172@)))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3435@ temp_21_1~3536@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
