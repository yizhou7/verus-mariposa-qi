...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Sub b0~4@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul c0~6@ a0~2@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Sub b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul c0~6@ a0~2@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~438@ (Mul (Mul c1~14@ (Mul (Mul d1~16@ a1~10@) (Sub c1~14@ a1~10@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~491@ (Mul (Mul c1~14@ (Mul d1~16@ (Mul a1~10@ (Sub c1~14@ a1~10@)))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~438@ temp_1_1~491@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~579@ (Mul (Mul (Sub (Mul d2~24@ 75) a2~18@) (Mul (Sub d2~24@ c2~22@) (Add d2~24@ c2~22@))) (Mul (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~652@ (Mul (Mul (Sub (Mul d2~24@ 75) a2~18@) (Mul (Sub d2~24@ c2~22@) (Add d2~24@ c2~22@))) (Mul (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul (Mul b2~20@ a2~18@) b2~20@) d2~24@)))) (=> (= tmp%3@ (= temp_2_0~579@ temp_2_1~652@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~740@ (Mul (Add (Mul (Mul 90 b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))) (Mul (Add (Mul b3~28@ b3~28@) (Mul a3~26@ d3~32@)) (Mul c3~30@ (Sub c3~30@ d3~32@))))) (=> (= temp_3_1~825@ (Mul (Add (Mul (Mul 90 b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))) (Add (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ (Sub c3~30@ d3~32@))) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ (Sub c3~30@ d3~32@)))))) (=> (= tmp%4@ (= temp_3_0~740@ temp_3_1~825@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~873@ (Mul (Mul (Mul a4~34@ (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Sub a4~34@ c4~38@))) b4~36@)) (=> (= temp_4_1~906@ (Mul b4~36@ (Mul (Mul a4~34@ (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Sub a4~34@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~873@ temp_4_1~906@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~970@ (Add (Mul (Mul (Add c5~46@ d5~48@) (Add a5~42@ d5~48@)) (Sub (Add a5~42@ c5~46@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul d5~48@ d5~48@) a5~42@) d5~48@))) (=> (= temp_5_1~1019@ (Add (Mul (Mul (Add c5~46@ d5~48@) (Add a5~42@ d5~48@)) (Sub (Add a5~42@ c5~46@) (Mul b5~44@ b5~44@))) (Mul d5~48@ (Mul (Mul d5~48@ d5~48@) a5~42@)))) (=> (= tmp%6@ (= temp_5_0~970@ temp_5_1~1019@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1087@ (Mul (Mul (Mul (Add c6~54@ c6~54@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add b6~52@ d6~56@) (Add d6~56@ c6~54@)) a6~50@))) (=> (= temp_6_1~1140@ (Mul (Mul (Mul (Add c6~54@ c6~54@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add d6~56@ c6~54@) (Add b6~52@ d6~56@)) a6~50@))) (=> (= tmp%7@ (= temp_6_0~1087@ temp_6_1~1140@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1232@ (Mul (Add (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ c7~62@)) (Sub (Mul c7~62@ 34) (Mul a7~58@ c7~62@))) (Mul (Add (Mul a7~58@ a7~58@) (Sub c7~62@ c7~62@)) (Mul (Mul d7~64@ c7~62@) (Add b7~60@ b7~60@))))) (=> (= temp_7_1~1317@ (Mul (Add (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ c7~62@)) (Sub (Mul c7~62@ 34) (Mul a7~58@ c7~62@))) (Mul (Add (Mul a7~58@ a7~58@) (Sub c7~62@ c7~62@)) (Add (Mul (Mul d7~64@ c7~62@) b7~60@) (Mul (Mul d7~64@ c7~62@) b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1232@ temp_7_1~1317@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1409@ (Add (Mul (Mul (Sub b8~68@ d8~72@) (Sub b8~68@ d8~72@)) (Add (Mul c8~70@ b8~68@) (Add c8~70@ a8~66@))) (Mul (Mul (Mul b8~68@ d8~72@) (Sub a8~66@ a8~66@)) (Mul (Mul 77 d8~72@) (Mul d8~72@ d8~72@))))) (=> (= temp_8_1~1486@ (Add (Mul (Mul (Sub b8~68@ d8~72@) (Sub b8~68@ d8~72@)) (Add (Mul c8~70@ b8~68@) (Add c8~70@ a8~66@))) (Mul (Mul (Mul b8~68@ d8~72@) (Sub a8~66@ a8~66@)) (Mul (Mul d8~72@ 77) (Mul d8~72@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1409@ temp_8_1~1486@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1578@ (Mul (Mul (Mul (Mul b9~76@ b9~76@) (Sub d9~80@ d9~80@)) (Sub (Mul c9~78@ c9~78@) (Add a9~74@ c9~78@))) (Sub (Add (Mul d9~80@ b9~76@) (Mul b9~76@ 12)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1663@ (Mul (Mul (Sub (Mul (Mul b9~76@ b9~76@) d9~80@) (Mul (Mul b9~76@ b9~76@) d9~80@)) (Sub (Mul c9~78@ c9~78@) (Add a9~74@ c9~78@))) (Sub (Add (Mul d9~80@ b9~76@) (Mul b9~76@ 12)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1578@ temp_9_1~1663@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1755@ (Mul (Mul (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ a10~82@)) d10~88@) (Mul (Sub (Mul d10~88@ d10~88@) (Mul a10~82@ 70)) (Sub (Sub a10~82@ b10~84@) (Mul 82 a10~82@))))) (=> (= temp_10_1~1832@ (Mul (Mul d10~88@ (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ a10~82@))) (Mul (Sub (Mul d10~88@ d10~88@) (Mul a10~82@ 70)) (Sub (Sub a10~82@ b10~84@) (Mul 82 a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1755@ temp_10_1~1832@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1920@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ c11~94@) a11~90@)) (Mul (Mul (Mul d11~96@ 24) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ d11~96@) (Sub a11~90@ b11~92@))))) (=> (= temp_11_1~1993@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ c11~94@) a11~90@)) (Mul (Mul (Mul d11~96@ 24) (Mul d11~96@ a11~90@)) (Mul (Mul d11~96@ c11~94@) (Sub a11~90@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1920@ temp_11_1~1993@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2073@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ a12~98@) (Mul d12~104@ a12~98@))) (Mul (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2138@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul (Mul a12~98@ a12~98@) d12~104@) a12~98@)) (Mul (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ a12~98@))))) (=> (= tmp%13@ (= temp_12_0~2073@ temp_12_1~2138@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2210@ (Mul (Mul (Mul b13~108@ (Sub d13~112@ d13~112@)) (Mul (Mul b13~108@ a13~106@) (Sub d13~112@ b13~108@))) (Add (Sub (Sub d13~112@ d13~112@) (Mul d13~112@ d13~112@)) (Mul (Sub a13~106@ c13~110@) c13~110@)))) (=> (= temp_13_1~2267@ (Mul (Mul (Mul b13~108@ (Sub d13~112@ d13~112@)) (Mul (Sub d13~112@ b13~108@) (Mul b13~108@ a13~106@))) (Add (Sub (Sub d13~112@ d13~112@) (Mul d13~112@ d13~112@)) (Mul (Sub a13~106@ c13~110@) c13~110@)))) (=> (= tmp%14@ (= temp_13_0~2210@ temp_13_1~2267@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2347@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ b14~116@)) (Mul (Mul d14~120@ d14~120@) (Mul a14~114@ c14~118@))) (Add (Add (Mul a14~114@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2412@ (Mul (Mul (Mul a14~114@ (Mul a14~114@ (Mul a14~114@ b14~116@))) (Mul (Mul d14~120@ d14~120@) (Mul a14~114@ c14~118@))) (Add (Add (Mul a14~114@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2347@ temp_14_1~2412@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2480@ (Mul (Mul b15~124@ (Sub (Mul c15~126@ b15~124@) (Mul b15~124@ d15~128@))) (Add c15~126@ (Sub (Mul b15~124@ b15~124@) (Mul b15~124@ 20))))) (=> (= temp_15_1~2537@ (Mul (Sub (Mul b15~124@ (Mul c15~126@ b15~124@)) (Mul b15~124@ (Mul b15~124@ d15~128@))) (Add c15~126@ (Sub (Mul b15~124@ b15~124@) (Mul b15~124@ 20))))) (=> (= tmp%16@ (= temp_15_0~2480@ temp_15_1~2537@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2609@ (Sub (Mul (Mul a16~130@ (Mul b16~132@ a16~130@)) (Sub (Mul a16~130@ d16~136@) (Mul b16~132@ b16~132@))) (Add (Mul (Sub d16~136@ a16~130@) b16~132@) (Mul (Mul d16~136@ b16~132@) (Add b16~132@ a16~130@))))) (=> (= temp_16_1~2666@ (Sub (Mul (Mul a16~130@ (Mul a16~130@ b16~132@)) (Sub (Mul a16~130@ d16~136@) (Mul b16~132@ b16~132@))) (Add (Mul (Sub d16~136@ a16~130@) b16~132@) (Mul (Mul d16~136@ b16~132@) (Add b16~132@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2609@ temp_16_1~2666@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2718@ (Mul c17~142@ (Sub (Sub (Mul c17~142@ d17~144@) (Mul d17~144@ c17~142@)) (Sub (Mul c17~142@ d17~144@) (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~2759@ (Sub (Mul c17~142@ (Sub (Mul c17~142@ d17~144@) (Mul d17~144@ c17~142@))) (Mul c17~142@ (Sub (Mul c17~142@ d17~144@) (Mul a17~138@ b17~140@))))) (=> (= tmp%18@ (= temp_17_0~2718@ temp_17_1~2759@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2827@ (Mul (Mul (Mul (Mul d18~152@ d18~152@) (Add a18~146@ a18~146@)) b18~148@) (Mul (Sub (Mul c18~150@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ a18~146@) (Mul d18~152@ c18~150@))))) (=> (= temp_18_1~2880@ (Mul (Mul (Mul (Mul d18~152@ d18~152@) (Add a18~146@ a18~146@)) b18~148@) (Mul (Sub (Mul c18~150@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ d18~152@))))) (=> (= tmp%19@ (= temp_18_0~2827@ temp_18_1~2880@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2960@ (Mul (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ b19~156@)) (Sub (Mul b19~156@ a19~154@) (Mul c19~158@ c19~158@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ d19~160@))))) (=> (= temp_19_1~3025@ (Mul (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ b19~156@)) (Sub (Mul a19~154@ b19~156@) (Mul c19~158@ c19~158@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ d19~160@))))) (=> (= tmp%20@ (= temp_19_0~2960@ temp_19_1~3025@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3105@ (Mul (Mul (Mul (Add c20~166@ c20~166@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Mul b20~164@ d20~168@))) (Mul (Add (Mul c20~166@ a20~162@) (Mul c20~166@ a20~162@)) (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ a20~162@))))) (=> (= temp_20_1~3170@ (Mul (Mul (Mul (Add c20~166@ c20~166@) (Mul d20~168@ c20~166@)) (Mul b20~164@ (Mul a20~162@ (Mul b20~164@ d20~168@)))) (Mul (Add (Mul c20~166@ a20~162@) (Mul c20~166@ a20~162@)) (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ a20~162@))))) (=> (= tmp%21@ (= temp_20_0~3105@ temp_20_1~3170@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3246@ (Mul (Add b21~172@ (Mul (Mul a21~170@ d21~176@) (Add d21~176@ c21~174@))) (Mul (Mul c21~174@ (Add b21~172@ 56)) (Mul (Mul d21~176@ a21~170@) (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~3347@ (Add (Mul b21~172@ (Mul (Mul c21~174@ (Add b21~172@ 56)) (Mul (Mul d21~176@ a21~170@) (Mul a21~170@ b21~172@)))) (Mul (Mul (Mul a21~170@ d21~176@) (Add d21~176@ c21~174@)) (Mul (Mul c21~174@ (Add b21~172@ 56)) (Mul (Mul d21~176@ a21~170@) (Mul a21~170@ b21~172@)))))) (=> (= tmp%22@ (= temp_21_0~3246@ temp_21_1~3347@)) (=> %%location_label%%21 tmp%22@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
