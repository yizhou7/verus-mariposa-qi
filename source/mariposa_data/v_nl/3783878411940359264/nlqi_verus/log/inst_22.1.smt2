...
(set-info :comment ";; mariposa_data/v_nl//3783878411940359264/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_5_0~1097@ Int)
(declare-const temp_5_1~1146@ Int)
...
(declare-const temp_10_1~2064@ Int)
(declare-const temp_11_0~2177@ Int)
(declare-const temp_11_1~2250@ Int)
(declare-const temp_12_0~2343@ Int)
(declare-const temp_12_1~2408@ Int)
(declare-const temp_13_0~2499@ Int)
(declare-const temp_13_1~2556@ Int)
(declare-const temp_14_0~2657@ Int)
(declare-const temp_14_1~2722@ Int)
(declare-const temp_15_0~2809@ Int)
(declare-const temp_15_1~2866@ Int)
(declare-const temp_16_0~2961@ Int)
(declare-const temp_16_1~3018@ Int)
(declare-const temp_17_0~3083@ Int)
(declare-const temp_17_1~3124@ Int)
(declare-const temp_18_0~3231@ Int)
(declare-const temp_18_1~3284@ Int)
(declare-const temp_19_0~3377@ Int)
(declare-const temp_19_1~3442@ Int)
(declare-const temp_20_0~3535@ Int)
(declare-const temp_20_1~3600@ Int)
(declare-const temp_21_0~3695@ Int)
(declare-const temp_21_1~3796@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Sub b0~4@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul c0~6@ a0~2@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Sub b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul c0~6@ a0~2@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))))) (and (=> (= tmp%1@ (Mul a0~2@ d0~8@)) (=> (= tmp%2@ (Sub b0~4@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~459@ (Mul (Mul c1~14@ (Mul (Mul d1~16@ a1~10@) (Sub c1~14@ a1~10@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~512@ (Mul (Mul c1~14@ (Mul d1~16@ (Mul a1~10@ (Sub c1~14@ a1~10@)))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ a1~10@))))) (and (=> (= tmp%3@ (Sub c1~14@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d1~16@ a1~10@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~459@ temp_1_1~512@)))) (=> (= temp_1_0~459@ temp_1_1~512@) (=> (= temp_2_0~619@ (Mul (Mul (Sub (Mul d2~24@ 75) a2~18@) (Mul (Sub d2~24@ c2~22@) (Add d2~24@ c2~22@))) (Mul (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~692@ (Mul (Mul (Sub (Mul d2~24@ 75) a2~18@) (Mul (Sub d2~24@ c2~22@) (Add d2~24@ c2~22@))) (Mul (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul (Mul b2~20@ a2~18@) b2~20@) d2~24@)))) (and (=> (= tmp%4@ (Mul b2~20@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ b2~20@ d2~24@) (=> %%location_label%%2 (= temp_2_0~619@ temp_2_1~692@)))) (=> (= temp_2_0~619@ temp_2_1~692@) (=> (= temp_3_0~799@ (Mul (Add (Mul (Mul 90 b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))) (Mul (Add (Mul b3~28@ b3~28@) (Mul a3~26@ d3~32@)) (Mul c3~30@ (Sub c3~30@ d3~32@))))) (=> (= temp_3_1~884@ (Mul (Add (Mul (Mul 90 b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))) (Add (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ (Sub c3~30@ d3~32@))) (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ (Sub c3~30@ d3~32@)))))) (and (=> (= tmp%5@ (Mul b3~28@ b3~28@)) (=> (= tmp%6@ (Mul a3~26@ d3~32@)) (=> (= tmp%7@ (Mul c3~30@ (Sub c3~30@ d3~32@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~799@ temp_3_1~884@)))))) (=> (= temp_3_0~799@ temp_3_1~884@) (=> (= temp_4_0~963@ (Mul (Mul (Mul a4~34@ (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Sub a4~34@ c4~38@))) b4~36@)) (=> (= temp_4_1~996@ (Mul b4~36@ (Mul (Mul a4~34@ (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Sub a4~34@ c4~38@))))) (and (=> (= tmp%8@ (Mul (Mul a4~34@ (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Sub a4~34@ c4~38@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ b4~36@) (=> %%location_label%%4 (= temp_4_0~963@ temp_4_1~996@)))) (=> (= temp_4_0~963@ temp_4_1~996@) (=> (= temp_5_0~1097@ (Add (Mul (Mul (Add c5~46@ d5~48@) (Add a5~42@ d5~48@)) (Sub (Add a5~42@ c5~46@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul d5~48@ d5~48@) a5~42@) d5~48@))) (=> (= temp_5_1~1146@ (Add (Mul (Mul (Add c5~46@ d5~48@) (Add a5~42@ d5~48@)) (Sub (Add a5~42@ c5~46@) (Mul b5~44@ b5~44@))) (Mul d5~48@ (Mul (Mul d5~48@ d5~48@) a5~42@)))) (and (=> (= tmp%9@ (Mul (Mul d5~48@ d5~48@) a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ d5~48@) (=> %%location_label%%5 (= temp_5_0~1097@ temp_5_1~1146@)))) (=> (= temp_5_0~1097@ temp_5_1~1146@) (=> (= temp_6_0~1235@ (Mul (Mul (Mul (Add c6~54@ c6~54@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add b6~52@ d6~56@) (Add d6~56@ c6~54@)) a6~50@))) (=> (= temp_6_1~1288@ (Mul (Mul (Mul (Add c6~54@ c6~54@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add d6~56@ c6~54@) (Add b6~52@ d6~56@)) a6~50@))) (and (=> (= tmp%10@ (Add b6~52@ d6~56@)) (=> (= tmp%11@ (Add d6~56@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%6 (= temp_6_0~1235@ temp_6_1~1288@))))) (=> (= temp_6_0~1235@ temp_6_1~1288@) (=> (= temp_7_0~1401@ (Mul (Add (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ c7~62@)) (Sub (Mul c7~62@ 34) (Mul a7~58@ c7~62@))) (Mul (Add (Mul a7~58@ a7~58@) (Sub c7~62@ c7~62@)) (Mul (Mul d7~64@ c7~62@) (Add b7~60@ b7~60@))))) (=> (= temp_7_1~1486@ (Mul (Add (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ c7~62@)) (Sub (Mul c7~62@ 34) (Mul a7~58@ c7~62@))) (Mul (Add (Mul a7~58@ a7~58@) (Sub c7~62@ c7~62@)) (Add (Mul (Mul d7~64@ c7~62@) b7~60@) (Mul (Mul d7~64@ c7~62@) b7~60@))))) (and (=> (= tmp%12@ (Mul d7~64@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%12@ b7~60@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1401@ temp_7_1~1486@)))) (=> (= temp_7_0~1401@ temp_7_1~1486@) (=> (= temp_8_0~1597@ (Add (Mul (Mul (Sub b8~68@ d8~72@) (Sub b8~68@ d8~72@)) (Add (Mul c8~70@ b8~68@) (Add c8~70@ a8~66@))) (Mul (Mul (Mul b8~68@ d8~72@) (Sub a8~66@ a8~66@)) (Mul (Mul 77 d8~72@) (Mul d8~72@ d8~72@))))) (=> (= temp_8_1~1674@ (Add (Mul (Mul (Sub b8~68@ d8~72@) (Sub b8~68@ d8~72@)) (Add (Mul c8~70@ b8~68@) (Add c8~70@ a8~66@))) (Mul (Mul (Mul b8~68@ d8~72@) (Sub a8~66@ a8~66@)) (Mul (Mul d8~72@ 77) (Mul d8~72@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 77 d8~72@) (=> %%location_label%%8 (= temp_8_0~1597@ temp_8_1~1674@))) (=> (= temp_8_0~1597@ temp_8_1~1674@) (=> (= temp_9_0~1791@ (Mul (Mul (Mul (Mul b9~76@ b9~76@) (Sub d9~80@ d9~80@)) (Sub (Mul c9~78@ c9~78@) (Add a9~74@ c9~78@))) (Sub (Add (Mul d9~80@ b9~76@) (Mul b9~76@ 12)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1876@ (Mul (Mul (Sub (Mul (Mul b9~76@ b9~76@) d9~80@) (Mul (Mul b9~76@ b9~76@) d9~80@)) (Sub (Mul c9~78@ c9~78@) (Add a9~74@ c9~78@))) (Sub (Add (Mul d9~80@ b9~76@) (Mul b9~76@ 12)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ d9~80@))))) (and (=> (= tmp%13@ (Mul b9~76@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%13@ d9~80@ d9~80@) (=> %%location_label%%9 (= temp_9_0~1791@ temp_9_1~1876@)))) (=> (= temp_9_0~1791@ temp_9_1~1876@) (=> (= temp_10_0~1987@ (Mul (Mul (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ a10~82@)) d10~88@) (Mul (Sub (Mul d10~88@ d10~88@) (Mul a10~82@ 70)) (Sub (Sub a10~82@ b10~84@) (Mul 82 a10~82@))))) (=> (= temp_10_1~2064@ (Mul (Mul d10~88@ (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ a10~82@))) (Mul (Sub (Mul d10~88@ d10~88@) (Mul a10~82@ 70)) (Sub (Sub a10~82@ b10~84@) (Mul 82 a10~82@))))) (and (=> (= tmp%14@ (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ a10~82@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ d10~88@) (=> %%location_label%%10 (= temp_10_0~1987@ temp_10_1~2064@)))) (=> (= temp_10_0~1987@ temp_10_1~2064@) (=> (= temp_11_0~2177@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ c11~94@) a11~90@)) (Mul (Mul (Mul d11~96@ 24) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ d11~96@) (Sub a11~90@ b11~92@))))) (=> (= temp_11_1~2250@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Mul a11~90@ c11~94@) a11~90@)) (Mul (Mul (Mul d11~96@ 24) (Mul d11~96@ a11~90@)) (Mul (Mul d11~96@ c11~94@) (Sub a11~90@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c11~94@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2177@ temp_11_1~2250@))) (=> (= temp_11_0~2177@ temp_11_1~2250@) (=> (= temp_12_0~2343@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul a12~98@ a12~98@) (Mul d12~104@ a12~98@))) (Mul (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ a12~98@))))) (=> (= temp_12_1~2408@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@)) (Mul (Mul (Mul a12~98@ a12~98@) d12~104@) a12~98@)) (Mul (Mul (Mul d12~104@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul b12~100@ a12~98@))))) (and (=> (= tmp%15@ (Mul a12~98@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ d12~104@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2343@ temp_12_1~2408@)))) (=> (= temp_12_0~2343@ temp_12_1~2408@) (=> (= temp_13_0~2499@ (Mul (Mul (Mul b13~108@ (Sub d13~112@ d13~112@)) (Mul (Mul b13~108@ a13~106@) (Sub d13~112@ b13~108@))) (Add (Sub (Sub d13~112@ d13~112@) (Mul d13~112@ d13~112@)) (Mul (Sub a13~106@ c13~110@) c13~110@)))) (=> (= temp_13_1~2556@ (Mul (Mul (Mul b13~108@ (Sub d13~112@ d13~112@)) (Mul (Sub d13~112@ b13~108@) (Mul b13~108@ a13~106@))) (Add (Sub (Sub d13~112@ d13~112@) (Mul d13~112@ d13~112@)) (Mul (Sub a13~106@ c13~110@) c13~110@)))) (and (=> (= tmp%16@ (Mul b13~108@ a13~106@)) (=> (= tmp%17@ (Sub d13~112@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%13 (= temp_13_0~2499@ temp_13_1~2556@))))) (=> (= temp_13_0~2499@ temp_13_1~2556@) (=> (= temp_14_0~2657@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ b14~116@)) (Mul (Mul d14~120@ d14~120@) (Mul a14~114@ c14~118@))) (Add (Add (Mul a14~114@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ b14~116@))))) (=> (= temp_14_1~2722@ (Mul (Mul (Mul a14~114@ (Mul a14~114@ (Mul a14~114@ b14~116@))) (Mul (Mul d14~120@ d14~120@) (Mul a14~114@ c14~118@))) (Add (Add (Mul a14~114@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ b14~116@))))) (and (=> (= tmp%18@ (Mul a14~114@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a14~114@ a14~114@ tmp%18@) (=> %%location_label%%14 (= temp_14_0~2657@ temp_14_1~2722@)))) (=> (= temp_14_0~2657@ temp_14_1~2722@) (=> (= temp_15_0~2809@ (Mul (Mul b15~124@ (Sub (Mul c15~126@ b15~124@) (Mul b15~124@ d15~128@))) (Add c15~126@ (Sub (Mul b15~124@ b15~124@) (Mul b15~124@ 20))))) (=> (= temp_15_1~2866@ (Mul (Sub (Mul b15~124@ (Mul c15~126@ b15~124@)) (Mul b15~124@ (Mul b15~124@ d15~128@))) (Add c15~126@ (Sub (Mul b15~124@ b15~124@) (Mul b15~124@ 20))))) (and (=> (= tmp%19@ (Mul c15~126@ b15~124@)) (=> (= tmp%20@ (Mul b15~124@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b15~124@ tmp%19@ tmp%20@) (=> %%location_label%%15 (= temp_15_0~2809@ temp_15_1~2866@))))) (=> (= temp_15_0~2809@ temp_15_1~2866@) (=> (= temp_16_0~2961@ (Sub (Mul (Mul a16~130@ (Mul b16~132@ a16~130@)) (Sub (Mul a16~130@ d16~136@) (Mul b16~132@ b16~132@))) (Add (Mul (Sub d16~136@ a16~130@) b16~132@) (Mul (Mul d16~136@ b16~132@) (Add b16~132@ a16~130@))))) (=> (= temp_16_1~3018@ (Sub (Mul (Mul a16~130@ (Mul a16~130@ b16~132@)) (Sub (Mul a16~130@ d16~136@) (Mul b16~132@ b16~132@))) (Add (Mul (Sub d16~136@ a16~130@) b16~132@) (Mul (Mul d16~136@ b16~132@) (Add b16~132@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b16~132@ a16~130@) (=> %%location_label%%16 (= temp_16_0~2961@ temp_16_1~3018@))) (=> (= temp_16_0~2961@ temp_16_1~3018@) (=> (= temp_17_0~3083@ (Mul c17~142@ (Sub (Sub (Mul c17~142@ d17~144@) (Mul d17~144@ c17~142@)) (Sub (Mul c17~142@ d17~144@) (Mul a17~138@ b17~140@))))) (=> (= temp_17_1~3124@ (Sub (Mul c17~142@ (Sub (Mul c17~142@ d17~144@) (Mul d17~144@ c17~142@))) (Mul c17~142@ (Sub (Mul c17~142@ d17~144@) (Mul a17~138@ b17~140@))))) (and (=> (= tmp%21@ (Sub (Mul c17~142@ d17~144@) (Mul d17~144@ c17~142@))) (=> (= tmp%22@ (Sub (Mul c17~142@ d17~144@) (Mul a17~138@ b17~140@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c17~142@ tmp%21@ tmp%22@) (=> %%location_label%%17 (= temp_17_0~3083@ temp_17_1~3124@))))) (=> (= temp_17_0~3083@ temp_17_1~3124@) (=> (= temp_18_0~3231@ (Mul (Mul (Mul (Mul d18~152@ d18~152@) (Add a18~146@ a18~146@)) b18~148@) (Mul (Sub (Mul c18~150@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ a18~146@) (Mul d18~152@ c18~150@))))) (=> (= temp_18_1~3284@ (Mul (Mul (Mul (Mul d18~152@ d18~152@) (Add a18~146@ a18~146@)) b18~148@) (Mul (Sub (Mul c18~150@ c18~150@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ d18~152@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d18~152@ c18~150@) (=> %%location_label%%18 (= temp_18_0~3231@ temp_18_1~3284@))) (=> (= temp_18_0~3231@ temp_18_1~3284@) (=> (= temp_19_0~3377@ (Mul (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ b19~156@)) (Sub (Mul b19~156@ a19~154@) (Mul c19~158@ c19~158@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ d19~160@))))) (=> (= temp_19_1~3442@ (Mul (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ b19~156@)) (Sub (Mul a19~154@ b19~156@) (Mul c19~158@ c19~158@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Mul a19~154@ d19~160@) (Mul d19~160@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b19~156@ a19~154@) (=> %%location_label%%19 (= temp_19_0~3377@ temp_19_1~3442@))) (=> (= temp_19_0~3377@ temp_19_1~3442@) (=> (= temp_20_0~3535@ (Mul (Mul (Mul (Add c20~166@ c20~166@) (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Mul b20~164@ d20~168@))) (Mul (Add (Mul c20~166@ a20~162@) (Mul c20~166@ a20~162@)) (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ a20~162@))))) (=> (= temp_20_1~3600@ (Mul (Mul (Mul (Add c20~166@ c20~166@) (Mul d20~168@ c20~166@)) (Mul b20~164@ (Mul a20~162@ (Mul b20~164@ d20~168@)))) (Mul (Add (Mul c20~166@ a20~162@) (Mul c20~166@ a20~162@)) (Mul (Mul b20~164@ c20~166@) (Mul c20~166@ a20~162@))))) (and (=> (= tmp%23@ (Mul b20~164@ d20~168@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b20~164@ a20~162@ tmp%23@) (=> %%location_label%%20 (= temp_20_0~3535@ temp_20_1~3600@)))) (=> (= temp_20_0~3535@ temp_20_1~3600@) (=> (= temp_21_0~3695@ (Mul (Add b21~172@ (Mul (Mul a21~170@ d21~176@) (Add d21~176@ c21~174@))) (Mul (Mul c21~174@ (Add b21~172@ 56)) (Mul (Mul d21~176@ a21~170@) (Mul a21~170@ b21~172@))))) (=> (= temp_21_1~3796@ (Add (Mul b21~172@ (Mul (Mul c21~174@ (Add b21~172@ 56)) (Mul (Mul d21~176@ a21~170@) (Mul a21~170@ b21~172@)))) (Mul (Mul (Mul a21~170@ d21~176@) (Add d21~176@ c21~174@)) (Mul (Mul c21~174@ (Add b21~172@ 56)) (Mul (Mul d21~176@ a21~170@) (Mul a21~170@ b21~172@)))))) (=> (= tmp%24@ (Mul (Mul a21~170@ d21~176@) (Add d21~176@ c21~174@))) (=> (= tmp%25@ (Mul (Mul c21~174@ (Add b21~172@ 56)) (Mul (Mul d21~176@ a21~170@) (Mul a21~170@ b21~172@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b21~172@ tmp%24@ tmp%25@) (=> %%location_label%%21 (= temp_21_0~3695@ temp_21_1~3796@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
