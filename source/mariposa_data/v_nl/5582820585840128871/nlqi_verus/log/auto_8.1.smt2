...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Add (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Sub b0~4@ 42))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~426@ (Add (Mul (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@)))) (Mul (Mul (Mul b0~4@ b0~4@) (Sub b0~4@ 42)) (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~426@))) (=> (= temp_0_0~317@ temp_0_1~426@) (=> (= temp_1_0~515@ (Mul (Mul (Mul (Add c1~14@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ c1~14@) (Add b1~12@ b1~12@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~580@ (Mul (Mul (Mul (Add c1~14@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Add b1~12@ b1~12@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~515@ temp_1_1~580@))) (=> (= temp_1_0~515@ temp_1_1~580@) (=> (= temp_2_0~669@ (Mul (Mul (Sub (Mul c2~22@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Add a2~18@ a2~18@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Sub d2~24@ b2~20@) (Mul a2~18@ c2~22@))))) (=> (= temp_2_1~734@ (Mul (Mul (Sub (Mul c2~22@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Add a2~18@ a2~18@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Sub d2~24@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~669@ temp_2_1~734@))) (=> (= temp_2_0~669@ temp_2_1~734@) (=> (= temp_3_0~823@ (Mul (Mul (Mul (Add b3~28@ c3~30@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ b3~28@)) (Add (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~904@ (Mul (Mul (Mul (Add b3~28@ c3~30@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ a3~26@))) (Add (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ b3~28@)) (Mul a3~26@ d3~32@)) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ b3~28@)) (Mul a3~26@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~823@ temp_3_1~904@))) (=> (= temp_3_0~823@ temp_3_1~904@) (=> (= temp_4_0~993@ (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ a4~34@))) (Add (Mul (Add b4~36@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Add c4~38@ b4~36@) (Sub c4~38@ d4~40@))))) (=> (= temp_4_1~1058@ (Mul (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ a4~34@)) (Add (Mul (Add b4~36@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Add c4~38@ b4~36@) (Sub c4~38@ d4~40@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~993@ temp_4_1~1058@))) (=> (= temp_4_0~993@ temp_4_1~1058@) (=> (= temp_5_0~1127@ (Mul c5~46@ (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ d5~48@)) (Mul a5~42@ (Sub 10 a5~42@))))) (=> (= temp_5_1~1176@ (Mul c5~46@ (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ d5~48@)) (Sub (Mul a5~42@ 10) (Mul a5~42@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1127@ temp_5_1~1176@))) (=> (= temp_5_0~1127@ temp_5_1~1176@) (=> (= temp_6_0~1261@ (Mul (Mul (Mul (Sub d6~56@ a6~50@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ c6~54@))) (Sub (Add (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@)) (Sub (Mul a6~50@ b6~52@) c6~54@)))) (=> (= temp_6_1~1322@ (Mul (Mul (Mul (Mul (Sub d6~56@ a6~50@) a6~50@) d6~56@) (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ c6~54@))) (Sub (Add (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@)) (Sub (Mul a6~50@ b6~52@) c6~54@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1261@ temp_6_1~1322@))) (=> (= temp_6_0~1261@ temp_6_1~1322@) (=> (= temp_7_0~1407@ (Mul (Mul (Mul d7~64@ (Mul a7~58@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Sub b7~60@ c7~62@))) (Mul (Mul (Mul d7~64@ b7~60@) (Sub c7~62@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1468@ (Mul (Mul (Mul d7~64@ (Mul a7~58@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Sub b7~60@ c7~62@))) (Mul (Mul d7~64@ (Mul b7~60@ (Sub c7~62@ b7~60@))) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1407@ temp_7_1~1468@))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
