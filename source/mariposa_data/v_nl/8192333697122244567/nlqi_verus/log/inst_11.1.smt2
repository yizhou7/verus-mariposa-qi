...
(set-info :comment ";; mariposa_data/v_nl//8192333697122244567/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Add (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Sub a0~2@ c0~6@)))) (Mul (Add (Mul (Add c0~6@ a0~2@) (Mul b0~4@ b0~4@)) (Sub (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@)))))) (=> (= temp_0_1~434@ (Mul (Mul (Add (Mul (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul a0~2@ b0~4@)) (Mul (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Sub a0~2@ c0~6@)))) (Mul (Add (Mul (Add c0~6@ a0~2@) (Mul b0~4@ b0~4@)) (Sub (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@)))))) (and (=> (= tmp%1@ (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@))) (=> (= tmp%2@ (Mul a0~2@ b0~4@)) (=> (= tmp%3@ (Mul d0~8@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~434@)))))) (=> (= temp_0_0~289@ temp_0_1~434@) (=> (= temp_1_0~617@ (Mul (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ c1~14@)) (Mul (Add c1~14@ a1~10@) (Mul d1~16@ 63)))) (Mul (Sub (Mul (Add b1~12@ c1~14@) c1~14@) (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ b1~12@))) (Mul (Add (Sub c1~14@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ b1~12@) b1~12@))))) (=> (= temp_1_1~750@ (Mul (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ c1~14@)) (Mul (Add c1~14@ a1~10@) (Mul d1~16@ 63)))) (Mul (Sub (Mul (Add b1~12@ c1~14@) c1~14@) (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ b1~12@))) (Mul (Add (Sub c1~14@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Mul b1~12@ b1~12@) b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ d1~16@) (=> %%location_label%%1 (= temp_1_0~617@ temp_1_1~750@))) (=> (= temp_1_0~617@ temp_1_1~750@) (=> (= temp_2_0~895@ (Sub (Mul (Sub (Mul (Mul b2~20@ b2~20@) (Add c2~22@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul c2~22@ b2~20@) (Sub c2~22@ d2~24@)) (Sub (Mul c2~22@ d2~24@) d2~24@))) (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ a2~18@))) (Mul (Sub a2~18@ (Sub d2~24@ b2~20@)) (Add c2~22@ (Mul d2~24@ a2~18@)))))) (=> (= temp_2_1~1012@ (Sub (Mul (Sub (Mul (Mul b2~20@ b2~20@) (Add c2~22@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul c2~22@ b2~20@) (Sub c2~22@ d2~24@)) (Sub (Mul c2~22@ d2~24@) d2~24@))) (Mul (Mul (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ a2~18@))) (Mul (Sub a2~18@ (Sub d2~24@ b2~20@)) (Add c2~22@ (Mul d2~24@ a2~18@)))))) (and (=> (= tmp%4@ (Mul a2~18@ d2~24@)) (=> (= tmp%5@ (Mul c2~22@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~895@ temp_2_1~1012@))))) (=> (= temp_2_0~895@ temp_2_1~1012@) (=> (= temp_3_0~1185@ (Mul (Mul (Mul (Mul (Mul a3~26@ b3~28@) c3~30@) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul (Sub d3~32@ d3~32@) (Mul c3~30@ b3~28@)) (Add (Add b3~28@ a3~26@) (Add d3~32@ b3~28@)))) (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@)) (Sub (Mul b3~28@ c3~30@) (Mul 29 a3~26@))) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Add (Mul a3~26@ a3~26@) (Mul d3~32@ b3~28@)))))) (=> (= temp_3_1~1338@ (Mul (Mul (Mul (Mul (Mul a3~26@ b3~28@) c3~30@) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul (Sub d3~32@ d3~32@) (Mul c3~30@ b3~28@)) (Add (Add b3~28@ a3~26@) (Add d3~32@ b3~28@)))) (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@)) (Sub (Mul b3~28@ c3~30@) (Mul 29 a3~26@))) (Add (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul a3~26@ a3~26@)) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul d3~32@ b3~28@)))))) (and (=> (= tmp%6@ (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@))) (=> (= tmp%7@ (Mul a3~26@ a3~26@)) (=> (= tmp%8@ (Mul d3~32@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%3 (= temp_3_0~1185@ temp_3_1~1338@)))))) (=> (= temp_3_0~1185@ temp_3_1~1338@) (=> (= temp_4_0~1529@ (Mul (Mul (Sub (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Add a4~34@ c4~38@) (Add c4~38@ b4~36@))) (Mul (Add (Mul d4~40@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul 16 d4~40@) (Mul d4~40@ a4~34@)))) (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Sub d4~40@ d4~40@)) (Mul (Mul d4~40@ b4~36@) (Sub b4~36@ c4~38@))) (Sub (Sub (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Add c4~38@ b4~36@) (Mul c4~38@ c4~38@)))))) (=> (= temp_4_1~1670@ (Mul (Mul (Sub (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Add a4~34@ c4~38@) (Add c4~38@ b4~36@))) (Mul (Add (Mul d4~40@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul 16 d4~40@) (Mul d4~40@ a4~34@)))) (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Sub d4~40@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Sub b4~36@ c4~38@))) (Sub (Sub (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Add c4~38@ b4~36@) (Mul c4~38@ c4~38@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ b4~36@) (=> %%location_label%%4 (= temp_4_0~1529@ temp_4_1~1670@))) (=> (= temp_4_0~1529@ temp_4_1~1670@) (=> (= temp_5_0~1819@ (Mul (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Sub b5~44@ c5~46@)) (Mul b5~44@ (Mul b5~44@ d5~48@))) (Mul (Mul (Mul b5~44@ d5~48@) (Add b5~44@ b5~44@)) (Sub (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@)))) (Mul (Mul (Mul d5~48@ (Mul a5~42@ b5~44@)) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ b5~44@)) (Mul (Sub a5~42@ d5~48@) (Mul a5~42@ a5~42@)))))) (=> (= temp_5_1~1940@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul (Sub b5~44@ c5~46@) (Mul b5~44@ (Mul b5~44@ d5~48@)))) (Mul (Mul (Mul b5~44@ d5~48@) (Add b5~44@ b5~44@)) (Sub (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@)))) (Mul (Mul (Mul d5~48@ (Mul a5~42@ b5~44@)) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ b5~44@)) (Mul (Sub a5~42@ d5~48@) (Mul a5~42@ a5~42@)))))) (and (=> (= tmp%9@ (Mul a5~42@ a5~42@)) (=> (= tmp%10@ (Sub b5~44@ c5~46@)) (=> (= tmp%11@ (Mul b5~44@ (Mul b5~44@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%5 (= temp_5_0~1819@ temp_5_1~1940@)))))) (=> (= temp_5_0~1819@ temp_5_1~1940@) (=> (= temp_6_0~2119@ (Add (Sub c6~54@ (Mul (Mul (Sub b6~52@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Add c6~54@ c6~54@) (Mul 13 a6~50@)))) (Mul (Sub (Add (Add b6~52@ a6~50@) (Add a6~50@ b6~52@)) (Sub (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ 58) a6~50@) (Mul (Mul c6~54@ a6~50@) (Mul 97 c6~54@)))))) (=> (= temp_6_1~2252@ (Add (Sub c6~54@ (Mul (Mul (Sub b6~52@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Add c6~54@ c6~54@) (Mul 13 a6~50@)))) (Mul (Sub (Add (Add b6~52@ a6~50@) (Add a6~50@ b6~52@)) (Sub (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@))) (Mul (Mul a6~50@ (Mul a6~50@ 58)) (Mul (Mul c6~54@ a6~50@) (Mul 97 c6~54@)))))) (and (=> (= tmp%12@ (Mul a6~50@ 58)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ a6~50@) (=> %%location_label%%6 (= temp_6_0~2119@ temp_6_1~2252@)))) (=> (= temp_6_0~2119@ temp_6_1~2252@) (=> (= temp_7_0~2437@ (Mul (Mul (Mul (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ 92))) (Add c7~62@ (Mul (Sub a7~58@ b7~60@) (Mul c7~62@ a7~58@)))) (Mul (Mul (Mul (Mul b7~60@ 67) (Mul d7~64@ b7~60@)) (Sub (Mul a7~58@ a7~58@) (Mul b7~60@ b7~60@))) (Mul (Sub (Add b7~60@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ c7~62@)))))) (=> (= temp_7_1~2578@ (Mul (Mul (Mul (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul d7~64@ b7~60@) (Mul 92 c7~62@))) (Add c7~62@ (Mul (Sub a7~58@ b7~60@) (Mul c7~62@ a7~58@)))) (Mul (Mul (Mul (Mul b7~60@ 67) (Mul d7~64@ b7~60@)) (Sub (Mul a7~58@ a7~58@) (Mul b7~60@ b7~60@))) (Mul (Sub (Add b7~60@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ c7~62@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ 92) (=> %%location_label%%7 (= temp_7_0~2437@ temp_7_1~2578@))) (=> (= temp_7_0~2437@ temp_7_1~2578@) (=> (= temp_8_0~2771@ (Add (Mul (Mul (Mul (Sub a8~66@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ d8~72@)) (Sub (Mul 85 d8~72@) (Mul a8~66@ 7)))) (Sub (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@)))))) (=> (= temp_8_1~2924@ (Add (Mul (Mul (Mul (Sub a8~66@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ d8~72@)) (Sub (Mul 85 d8~72@) (Mul 7 a8~66@)))) (Sub (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ 7) (=> %%location_label%%8 (= temp_8_0~2771@ temp_8_1~2924@))) (=> (= temp_8_0~2771@ temp_8_1~2924@) (=> (= temp_9_0~3101@ (Mul (Mul (Mul (Mul (Mul d9~80@ 40) (Mul b9~76@ b9~76@)) (Mul (Mul d9~80@ c9~78@) (Add a9~74@ b9~76@))) (Mul (Mul (Sub d9~80@ c9~78@) c9~78@) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ a9~74@)))) (Mul (Mul (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ d9~80@)) (Mul (Sub d9~80@ d9~80@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ d9~80@)))))) (=> (= temp_9_1~3238@ (Mul (Mul (Mul (Mul (Mul d9~80@ 40) (Mul b9~76@ b9~76@)) (Mul (Mul d9~80@ c9~78@) (Add a9~74@ b9~76@))) (Mul (Mul (Sub d9~80@ c9~78@) c9~78@) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ a9~74@)))) (Mul (Mul (Mul a9~74@ c9~78@) (Mul (Mul d9~80@ d9~80@) (Mul (Sub d9~80@ d9~80@) (Mul c9~78@ c9~78@)))) (Mul (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Mul c9~78@ d9~80@)))))) (and (=> (= tmp%13@ (Mul a9~74@ c9~78@)) (=> (= tmp%14@ (Mul d9~80@ d9~80@)) (=> (= tmp%15@ (Mul (Sub d9~80@ d9~80@) (Mul c9~78@ c9~78@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%9 (= temp_9_0~3101@ temp_9_1~3238@)))))) (=> (= temp_9_0~3101@ temp_9_1~3238@) (=> (= temp_10_0~3417@ (Sub (Mul (Mul c10~86@ (Mul (Sub d10~88@ c10~86@) (Sub c10~86@ d10~88@))) (Add (Mul (Add c10~86@ c10~86@) (Sub c10~86@ d10~88@)) (Mul (Mul d10~88@ c10~86@) (Mul b10~84@ c10~86@)))) (Sub (Add (Sub (Mul b10~84@ d10~88@) (Sub a10~82@ a10~82@)) (Sub (Mul c10~86@ c10~86@) (Add c10~86@ b10~84@))) (Mul (Mul (Mul a10~82@ 11) (Mul a10~82@ c10~86@)) (Mul (Sub a10~82@ b10~84@) (Add a10~82@ c10~86@)))))) (=> (= temp_10_1~3546@ (Sub (Mul (Mul c10~86@ (Mul (Sub d10~88@ c10~86@) (Sub c10~86@ d10~88@))) (Add (Mul (Add c10~86@ c10~86@) (Sub c10~86@ d10~88@)) (Mul (Mul d10~88@ c10~86@) (Mul b10~84@ c10~86@)))) (Sub (Add (Sub (Mul b10~84@ d10~88@) (Sub a10~82@ a10~82@)) (Sub (Mul c10~86@ c10~86@) (Add c10~86@ b10~84@))) (Mul (Mul (Mul (Mul a10~82@ 11) (Mul a10~82@ c10~86@)) (Sub a10~82@ b10~84@)) (Add a10~82@ c10~86@))))) (=> (= tmp%16@ (Mul (Mul a10~82@ 11) (Mul a10~82@ c10~86@))) (=> (= tmp%17@ (Sub a10~82@ b10~84@)) (=> (= tmp%18@ (Add a10~82@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%10 (= temp_10_0~3417@ temp_10_1~3546@)))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
