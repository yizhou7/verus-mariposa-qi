...
(declare-const temp_4_1~1012@ Int)
...
(declare-const temp_8_0~1623@ Int)
(declare-const temp_8_1~1724@ Int)
(declare-const temp_9_0~1879@ Int)
(declare-const temp_9_1~1944@ Int)
(declare-const temp_10_0~2041@ Int)
(declare-const temp_10_1~2110@ Int)
(declare-const temp_11_0~2197@ Int)
(declare-const temp_11_1~2254@ Int)
(declare-const temp_12_0~2343@ Int)
(declare-const temp_12_1~2404@ Int)
(declare-const temp_13_0~2543@ Int)
(declare-const temp_13_1~2604@ Int)
(declare-const temp_14_0~2697@ Int)
(declare-const temp_14_1~2762@ Int)
(declare-const temp_15_0~2857@ Int)
(declare-const temp_15_1~2918@ Int)
(declare-const temp_16_0~3035@ Int)
(declare-const temp_16_1~3124@ Int)
(declare-const temp_17_0~3209@ Int)
(declare-const temp_17_1~3266@ Int)
(declare-const temp_18_0~3359@ Int)
(declare-const temp_18_1~3424@ Int)
(declare-const temp_19_0~3519@ Int)
(declare-const temp_19_1~3580@ Int)
(declare-const temp_20_0~3689@ Int)
(declare-const temp_20_1~3762@ Int)
(declare-const temp_21_0~3867@ Int)
(declare-const temp_21_1~3972@ Int)
(declare-const temp_22_0~4099@ Int)
(declare-const temp_22_1~4164@ Int)
(declare-const temp_23_0~4261@ Int)
(declare-const temp_23_1~4322@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Sub (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul b0~4@ a0~2@) (Sub d0~8@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~370@ (Sub (Sub (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul a0~2@ b0~4@) (Sub d0~8@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ a0~2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~459@ (Sub (Mul (Mul (Add b1~12@ b1~12@) (Add c1~14@ c1~14@)) (Sub (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@))) (Mul (Sub (Mul b1~12@ c1~14@) (Mul c1~14@ b1~12@)) (Mul d1~16@ (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~532@ (Sub (Mul (Mul (Add b1~12@ b1~12@) (Add c1~14@ c1~14@)) (Sub (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@))) (Sub (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ (Mul a1~10@ a1~10@))) (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ (Mul a1~10@ a1~10@)))))) (and (=> (= tmp%1@ (Mul b1~12@ c1~14@)) (=> (= tmp%2@ (Mul c1~14@ b1~12@)) (=> (= tmp%3@ (Mul d1~16@ (Mul a1~10@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~459@ temp_1_1~532@)))))) (=> (= temp_1_0~459@ temp_1_1~532@) (=> (= temp_2_0~643@ (Mul (Add (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul b2~20@ d2~24@) (Sub a2~18@ b2~20@)) (Mul (Add a2~18@ c2~22@) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~708@ (Mul (Add (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul b2~20@ d2~24@) (Sub a2~18@ b2~20@)) (Mul (Mul (Add a2~18@ c2~22@) c2~22@) d2~24@)))) (and (=> (= tmp%4@ (Add a2~18@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ c2~22@ d2~24@) (=> %%location_label%%2 (= temp_2_0~643@ temp_2_1~708@)))) (=> (= temp_2_0~643@ temp_2_1~708@) (=> (= temp_3_0~795@ (Mul (Mul (Mul (Add c3~30@ d3~32@) (Mul d3~32@ d3~32@)) b3~28@) (Mul (Mul (Add b3~28@ d3~32@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~848@ (Mul (Mul (Mul (Add c3~30@ d3~32@) (Mul d3~32@ d3~32@)) b3~28@) (Mul (Mul (Add b3~28@ d3~32@) (Mul b3~28@ c3~30@)) (Mul d3~32@ (Mul d3~32@ (Mul b3~28@ b3~28@)))))) (and (=> (= tmp%5@ (Mul b3~28@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d3~32@ d3~32@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~795@ temp_3_1~848@)))) (=> (= temp_3_0~795@ temp_3_1~848@) (=> (= temp_4_0~947@ (Add (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ a4~34@) (Add d4~40@ a4~34@))) (Add (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~1012@ (Add (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ a4~34@) (Add d4~40@ a4~34@))) (Add (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ c4~38@)) (Mul b4~36@ (Mul c4~38@ (Mul b4~36@ d4~40@)))))) (and (=> (= tmp%6@ (Mul b4~36@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b4~36@ c4~38@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~947@ temp_4_1~1012@)))) (=> (= temp_4_0~947@ temp_4_1~1012@) (=> (= temp_5_0~1095@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Sub c5~46@ d5~48@)) c5~46@) (Mul (Sub a5~42@ (Mul b5~44@ a5~42@)) (Sub (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@))))) (=> (= temp_5_1~1144@ (Mul (Mul (Sub a5~42@ (Mul b5~44@ a5~42@)) (Sub (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul b5~44@ b5~44@) (Sub c5~46@ d5~48@)) c5~46@))) (and (=> (= tmp%7@ (Mul (Mul (Mul b5~44@ b5~44@) (Sub c5~46@ d5~48@)) c5~46@)) (=> (= tmp%8@ (Mul (Sub a5~42@ (Mul b5~44@ a5~42@)) (Sub (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~1095@ temp_5_1~1144@))))) (=> (= temp_5_0~1095@ temp_5_1~1144@) (=> (= temp_6_0~1277@ (Mul (Add (Mul (Sub d6~56@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@))) (Mul (Add (Add a6~50@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ a6~50@) (Sub a6~50@ d6~56@))))) (=> (= temp_6_1~1342@ (Mul (Add (Mul (Sub d6~56@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@))) (Mul (Add (Add a6~50@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ a6~50@) (Sub a6~50@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1277@ temp_6_1~1342@))) (=> (= temp_6_0~1277@ temp_6_1~1342@) (=> (= temp_7_0~1435@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@)) (Mul (Sub c7~62@ d7~64@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1500@ (Mul (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@)) (Sub c7~62@ d7~64@)) (Mul a7~58@ b7~60@)) (Mul (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ b7~60@))))) (and (=> (= tmp%9@ (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@))) (=> (= tmp%10@ (Sub c7~62@ d7~64@)) (=> (= tmp%11@ (Mul a7~58@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%7 (= temp_7_0~1435@ temp_7_1~1500@)))))) (=> (= temp_7_0~1435@ temp_7_1~1500@) (=> (= temp_8_0~1623@ (Mul (Sub (Add (Mul d8~72@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul 82 c8~70@) (Add c8~70@ b8~68@))) (Mul (Mul d8~72@ (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1724@ (Sub (Mul (Add (Mul d8~72@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ a8~66@)))) (Mul (Mul (Mul 82 c8~70@) (Add c8~70@ b8~68@)) (Mul (Mul d8~72@ (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ a8~66@)))))) (and (=> (= tmp%12@ (Add (Mul d8~72@ d8~72@) (Mul d8~72@ a8~66@))) (=> (= tmp%13@ (Mul (Mul 82 c8~70@) (Add c8~70@ b8~68@))) (=> (= tmp%14@ (Mul (Mul d8~72@ (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ a8~66@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%8 (= temp_8_0~1623@ temp_8_1~1724@)))))) (=> (= temp_8_0~1623@ temp_8_1~1724@) (=> (= temp_9_0~1879@ (Mul (Add (Sub (Mul d9~80@ c9~78@) (Sub a9~74@ a9~74@)) (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ a9~74@))) (Mul (Mul (Add a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ b9~76@))))) (=> (= temp_9_1~1944@ (Mul (Add (Sub (Mul d9~80@ c9~78@) (Sub a9~74@ a9~74@)) (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ b9~76@))) (Mul (Mul (Add a9~74@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b9~76@ a9~74@) (=> %%location_label%%9 (= temp_9_0~1879@ temp_9_1~1944@))) (=> (= temp_9_0~1879@ temp_9_1~1944@) (=> (= temp_10_0~2041@ (Mul (Mul (Mul (Mul a10~82@ 98) (Mul b10~84@ b10~84@)) (Mul b10~84@ (Mul b10~84@ c10~86@))) (Mul (Add (Mul a10~82@ d10~88@) (Mul a10~82@ d10~88@)) (Sub (Mul a10~82@ d10~88@) d10~88@)))) (=> (= temp_10_1~2110@ (Mul (Mul (Mul (Mul a10~82@ 98) (Mul b10~84@ b10~84@)) (Mul (Mul b10~84@ b10~84@) c10~86@)) (Mul (Add (Mul a10~82@ d10~88@) (Mul a10~82@ d10~88@)) (Sub (Mul a10~82@ d10~88@) d10~88@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b10~84@ b10~84@ c10~86@) (=> %%location_label%%10 (= temp_10_0~2041@ temp_10_1~2110@))) (=> (= temp_10_0~2041@ temp_10_1~2110@) (=> (= temp_11_0~2197@ (Mul (Mul (Mul c11~94@ (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul d11~96@ b11~92@) (Sub d11~96@ d11~96@)) (Mul c11~94@ (Mul d11~96@ c11~94@))))) (=> (= temp_11_1~2254@ (Mul (Mul (Mul c11~94@ (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul d11~96@ b11~92@) (Sub d11~96@ d11~96@)) (Mul c11~94@ (Mul d11~96@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b11~92@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2197@ temp_11_1~2254@))) (=> (= temp_11_0~2197@ temp_11_1~2254@) (=> (= temp_12_0~2343@ (Mul (Mul (Add (Sub b12~100@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ a12~98@))) (Mul (Add (Mul c12~102@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ d12~104@) c12~102@)))) (=> (= temp_12_1~2404@ (Mul (Mul (Mul (Add (Sub b12~100@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ a12~98@))) (Add (Mul c12~102@ d12~104@) (Mul d12~104@ b12~100@))) (Mul (Mul c12~102@ d12~104@) c12~102@))) (and (=> (= tmp%15@ (Mul (Add (Sub b12~100@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul a12~98@ d12~104@) (Mul a12~98@ a12~98@)))) (=> (= tmp%16@ (Add (Mul c12~102@ d12~104@) (Mul d12~104@ b12~100@))) (=> (= tmp%17@ (Mul (Mul c12~102@ d12~104@) c12~102@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%12 (= temp_12_0~2343@ temp_12_1~2404@)))))) (=> (= temp_12_0~2343@ temp_12_1~2404@) (=> (= temp_13_0~2543@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ c13~110@)) (Add (Mul b13~108@ c13~110@) (Add c13~110@ c13~110@))) (Mul (Mul (Mul a13~106@ c13~110@) c13~110@) (Mul (Mul d13~112@ b13~108@) (Add a13~106@ b13~108@))))) (=> (= temp_13_1~2604@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ c13~110@)) (Add (Mul b13~108@ c13~110@) (Add c13~110@ c13~110@))) (Mul (Mul (Mul c13~110@ a13~106@) c13~110@) (Mul (Mul d13~112@ b13~108@) (Add a13~106@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a13~106@ c13~110@) (=> %%location_label%%13 (= temp_13_0~2543@ temp_13_1~2604@))) (=> (= temp_13_0~2543@ temp_13_1~2604@) (=> (= temp_14_0~2697@ (Sub (Mul (Mul (Sub c14~118@ c14~118@) (Mul d14~120@ d14~120@)) (Mul (Sub d14~120@ b14~116@) (Mul b14~116@ c14~118@))) (Mul (Mul (Mul c14~118@ c14~118@) (Mul d14~120@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2762@ (Sub (Mul (Mul (Sub c14~118@ c14~118@) (Mul d14~120@ d14~120@)) (Mul (Mul (Sub d14~120@ b14~116@) b14~116@) c14~118@)) (Mul (Mul (Mul c14~118@ c14~118@) (Mul d14~120@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul c14~118@ d14~120@))))) (and (=> (= tmp%18@ (Sub d14~120@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ b14~116@ c14~118@) (=> %%location_label%%14 (= temp_14_0~2697@ temp_14_1~2762@)))) (=> (= temp_14_0~2697@ temp_14_1~2762@) (=> (= temp_15_0~2857@ (Add (Mul (Sub (Mul a15~122@ a15~122@) (Mul a15~122@ d15~128@)) (Mul (Mul c15~126@ d15~128@) b15~124@)) (Mul (Mul (Mul d15~128@ d15~128@) (Add d15~128@ a15~122@)) (Mul (Mul d15~128@ c15~126@) (Mul c15~126@ b15~124@))))) (=> (= temp_15_1~2918@ (Add (Mul (Sub (Mul a15~122@ a15~122@) (Mul a15~122@ d15~128@)) (Mul (Mul c15~126@ d15~128@) b15~124@)) (Mul (Mul (Mul d15~128@ d15~128@) (Add d15~128@ a15~122@)) (Mul (Mul c15~126@ d15~128@) (Mul c15~126@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d15~128@ c15~126@) (=> %%location_label%%15 (= temp_15_0~2857@ temp_15_1~2918@))) (=> (= temp_15_0~2857@ temp_15_1~2918@) (=> (= temp_16_0~3035@ (Add (Mul (Add (Mul c16~134@ d16~136@) (Mul c16~134@ c16~134@)) (Add (Mul b16~132@ 79) (Mul c16~134@ a16~130@))) (Mul (Sub (Mul a16~130@ b16~132@) (Sub 18 b16~132@)) (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ c16~134@))))) (=> (= temp_16_1~3124@ (Add (Mul (Add (Mul c16~134@ d16~136@) (Mul c16~134@ c16~134@)) (Add (Mul b16~132@ 79) (Mul c16~134@ a16~130@))) (Mul (Sub (Mul b16~132@ a16~130@) (Sub 18 b16~132@)) (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a16~130@ b16~132@) (=> %%location_label%%16 (= temp_16_0~3035@ temp_16_1~3124@))) (=> (= temp_16_0~3035@ temp_16_1~3124@) (=> (= temp_17_0~3209@ (Mul (Mul (Mul b17~140@ (Mul d17~144@ b17~140@)) (Add b17~140@ (Mul b17~140@ a17~138@))) (Mul (Add (Sub b17~140@ d17~144@) (Add c17~142@ b17~140@)) (Mul (Add c17~142@ a17~138@) (Mul c17~142@ b17~140@))))) (=> (= temp_17_1~3266@ (Mul (Mul (Mul b17~140@ (Mul b17~140@ d17~144@)) (Add b17~140@ (Mul b17~140@ a17~138@))) (Mul (Add (Sub b17~140@ d17~144@) (Add c17~142@ b17~140@)) (Mul (Add c17~142@ a17~138@) (Mul c17~142@ b17~140@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d17~144@ b17~140@) (=> %%location_label%%17 (= temp_17_0~3209@ temp_17_1~3266@))) (=> (= temp_17_0~3209@ temp_17_1~3266@) (=> (= temp_18_0~3359@ (Mul (Add (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ c18~150@)) (Add (Mul c18~150@ d18~152@) (Sub b18~148@ d18~152@))) (Add (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ a18~146@)) (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ c18~150@))))) (=> (= temp_18_1~3424@ (Mul (Add (Mul (Mul (Mul b18~148@ d18~152@) d18~152@) c18~150@) (Add (Mul c18~150@ d18~152@) (Sub b18~148@ d18~152@))) (Add (Mul (Mul a18~146@ a18~146@) (Mul c18~150@ a18~146@)) (Mul (Mul a18~146@ b18~148@) (Mul d18~152@ c18~150@))))) (and (=> (= tmp%19@ (Mul b18~148@ d18~152@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ d18~152@ c18~150@) (=> %%location_label%%18 (= temp_18_0~3359@ temp_18_1~3424@)))) (=> (= temp_18_0~3359@ temp_18_1~3424@) (=> (= temp_19_0~3519@ (Sub (Mul (Mul b19~156@ (Mul b19~156@ c19~158@)) (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ c19~158@))) (Mul (Mul (Mul d19~160@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Mul d19~160@ b19~156@) (Sub d19~160@ b19~156@))))) (=> (= temp_19_1~3580@ (Sub (Mul (Mul b19~156@ (Mul b19~156@ c19~158@)) (Mul (Mul c19~158@ c19~158@) (Mul a19~154@ c19~158@))) (Mul (Mul (Mul d19~160@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Sub d19~160@ b19~156@) (Mul d19~160@ b19~156@))))) (and (=> (= tmp%20@ (Mul d19~160@ b19~156@)) (=> (= tmp%21@ (Sub d19~160@ b19~156@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%19 (= temp_19_0~3519@ temp_19_1~3580@))))) (=> (= temp_19_0~3519@ temp_19_1~3580@) (=> (= temp_20_0~3689@ (Mul (Mul (Mul (Mul c20~166@ c20~166@) (Mul b20~164@ a20~162@)) (Mul (Mul 35 b20~164@) (Mul a20~162@ b20~164@))) (Mul (Mul (Mul b20~164@ b20~164@) (Mul a20~162@ a20~162@)) (Sub (Mul b20~164@ a20~162@) b20~164@)))) (=> (= temp_20_1~3762@ (Mul (Mul (Mul (Mul c20~166@ c20~166@) (Mul b20~164@ a20~162@)) (Mul (Mul 35 b20~164@) (Mul a20~162@ b20~164@))) (Mul (Mul (Mul b20~164@ b20~164@) (Mul a20~162@ a20~162@)) (Sub (Mul b20~164@ a20~162@) b20~164@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c20~166@ c20~166@) (=> %%location_label%%20 (= temp_20_0~3689@ temp_20_1~3762@))) (=> (= temp_20_0~3689@ temp_20_1~3762@) (=> (= temp_21_0~3867@ (Mul (Mul (Mul (Mul b21~172@ b21~172@) (Mul d21~176@ b21~172@)) (Mul (Mul d21~176@ a21~170@) (Mul c21~174@ d21~176@))) (Mul (Mul (Mul b21~172@ 42) (Sub c21~174@ c21~174@)) (Add (Mul a21~170@ c21~174@) (Sub b21~172@ d21~176@))))) (=> (= temp_21_1~3972@ (Mul (Mul (Mul (Mul b21~172@ b21~172@) (Mul d21~176@ b21~172@)) (Mul (Mul d21~176@ a21~170@) (Mul c21~174@ d21~176@))) (Add (Mul (Mul (Mul b21~172@ 42) (Sub c21~174@ c21~174@)) (Mul a21~170@ c21~174@)) (Mul (Mul (Mul b21~172@ 42) (Sub c21~174@ c21~174@)) (Sub b21~172@ d21~176@))))) (and (=> (= tmp%22@ (Mul (Mul b21~172@ 42) (Sub c21~174@ c21~174@))) (=> (= tmp%23@ (Mul a21~170@ c21~174@)) (=> (= tmp%24@ (Sub b21~172@ d21~176@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%21 (= temp_21_0~3867@ temp_21_1~3972@)))))) (=> (= temp_21_0~3867@ temp_21_1~3972@) (=> (= temp_22_0~4099@ (Mul (Mul (Mul (Sub c22~182@ c22~182@) (Mul b22~180@ c22~182@)) (Mul (Mul a22~178@ c22~182@) (Mul b22~180@ a22~178@))) (Mul (Mul (Mul c22~182@ b22~180@) (Mul b22~180@ d22~184@)) (Add (Mul d22~184@ d22~184@) (Mul c22~182@ d22~184@))))) (=> (= temp_22_1~4164@ (Mul (Mul (Mul (Mul b22~180@ c22~182@) (Sub c22~182@ c22~182@)) (Mul (Mul a22~178@ c22~182@) (Mul b22~180@ a22~178@))) (Mul (Mul (Mul c22~182@ b22~180@) (Mul b22~180@ d22~184@)) (Add (Mul d22~184@ d22~184@) (Mul c22~182@ d22~184@))))) (and (=> (= tmp%25@ (Sub c22~182@ c22~182@)) (=> (= tmp%26@ (Mul b22~180@ c22~182@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%25@ tmp%26@) (=> %%location_label%%22 (= temp_22_0~4099@ temp_22_1~4164@))))) (=> (= temp_22_0~4099@ temp_22_1~4164@) (=> (= temp_23_0~4261@ (Mul (Mul (Mul (Mul b23~188@ b23~188@) (Mul c23~190@ a23~186@)) (Mul (Mul b23~188@ c23~190@) d23~192@)) (Add (Mul (Sub d23~192@ a23~186@) (Mul a23~186@ b23~188@)) (Add (Sub c23~190@ d23~192@) (Add a23~186@ b23~188@))))) (=> (= temp_23_1~4322@ (Mul (Mul (Mul (Mul b23~188@ b23~188@) (Mul c23~190@ a23~186@)) (Mul (Mul b23~188@ c23~190@) d23~192@)) (Add (Mul (Mul a23~186@ b23~188@) (Sub d23~192@ a23~186@)) (Add (Sub c23~190@ d23~192@) (Add a23~186@ b23~188@))))) (=> (= tmp%27@ (Sub d23~192@ a23~186@)) (=> (= tmp%28@ (Mul a23~186@ b23~188@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%23 (= temp_23_0~4261@ temp_23_1~4322@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
