...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Add (Sub (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Mul a0~2@ c0~6@) (Sub a0~2@ c0~6@))) (Sub (Add (Mul b0~4@ b0~4@) (Mul a0~2@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~370@ (Add (Add (Sub (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@)) (Mul a0~2@ (Mul c0~6@ (Sub a0~2@ c0~6@)))) (Sub (Add (Mul b0~4@ b0~4@) (Mul a0~2@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~462@ (Mul (Add (Sub (Mul a1~10@ c1~14@) (Sub a1~10@ b1~12@)) (Sub (Sub c1~14@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul a1~10@ c1~14@) (Sub a1~10@ d1~16@)) (Sub (Mul c1~14@ b1~12@) (Mul c1~14@ 40))))) (=> (= temp_1_1~555@ (Mul (Add (Sub (Mul a1~10@ c1~14@) (Sub a1~10@ b1~12@)) (Sub (Sub c1~14@ b1~12@) (Mul c1~14@ a1~10@))) (Sub (Mul (Mul (Mul a1~10@ c1~14@) (Sub a1~10@ d1~16@)) (Mul c1~14@ b1~12@)) (Mul (Mul (Mul a1~10@ c1~14@) (Sub a1~10@ d1~16@)) (Mul c1~14@ 40))))) (=> (= tmp%2@ (= temp_1_0~462@ temp_1_1~555@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~635@ (Add (Mul (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ d2~24@)) (Sub (Mul c2~22@ d2~24@) (Sub b2~20@ d2~24@))))) (=> (= temp_2_1~700@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ d2~24@)) (Sub (Mul c2~22@ d2~24@) (Sub b2~20@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~635@ temp_2_1~700@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~800@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) b3~28@) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul b3~28@ 4) (Mul b3~28@ 53)) (Mul (Mul c3~30@ b3~28@) (Sub a3~26@ b3~28@))))) (=> (= temp_3_1~885@ (Mul (Mul (Mul (Mul b3~28@ 4) (Mul b3~28@ 53)) (Mul (Mul c3~30@ b3~28@) (Sub a3~26@ b3~28@))) (Mul (Mul (Mul b3~28@ d3~32@) b3~28@) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~800@ temp_3_1~885@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~961@ (Mul (Mul (Mul d4~40@ (Mul a4~34@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Add b4~36@ d4~40@))))) (=> (= temp_4_1~1022@ (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@)) (Mul d4~40@ (Mul a4~34@ b4~36@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Add b4~36@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~961@ temp_4_1~1022@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1114@ (Mul (Mul (Mul (Add c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Add b5~44@ b5~44@))) (Mul (Add (Mul c5~46@ 28) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1191@ (Mul (Mul (Mul (Add c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Add b5~44@ b5~44@))) (Mul (Add (Mul c5~46@ 28) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1114@ temp_5_1~1191@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1279@ (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ d6~56@)) (Mul (Add d6~56@ a6~50@) (Mul c6~54@ b6~52@))) (Sub (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul c6~54@ 41) a6~50@)))) (=> (= temp_6_1~1352@ (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ d6~56@)) (Mul (Add d6~56@ a6~50@) (Mul c6~54@ b6~52@))) (Sub (Mul d6~56@ (Mul d6~56@ (Mul d6~56@ a6~50@))) (Mul (Mul c6~54@ 41) a6~50@)))) (=> (= tmp%7@ (= temp_6_0~1279@ temp_6_1~1352@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1432@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@)) (Mul (Add b7~60@ b7~60@) (Mul a7~58@ a7~58@))) (Add (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1497@ (Mul (Mul (Mul (Add b7~60@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@))) (Add (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1432@ temp_7_1~1497@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1549@ (Add c8~70@ (Mul (Sub (Mul a8~66@ b8~68@) (Mul a8~66@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ c8~70@))))) (=> (= temp_8_1~1586@ (Add c8~70@ (Mul (Sub (Mul a8~66@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1549@ temp_8_1~1586@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1666@ (Mul (Mul (Sub (Mul c9~78@ d9~80@) (Add d9~80@ b9~76@)) (Mul (Sub a9~74@ d9~80@) (Mul c9~78@ d9~80@))) (Mul (Mul (Sub a9~74@ b9~76@) (Mul b9~76@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ b9~76@))))) (=> (= temp_9_1~1739@ (Mul (Mul (Sub (Mul c9~78@ d9~80@) (Add d9~80@ b9~76@)) (Sub (Mul a9~74@ (Mul c9~78@ d9~80@)) (Mul d9~80@ (Mul c9~78@ d9~80@)))) (Mul (Mul (Sub a9~74@ b9~76@) (Mul b9~76@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ b9~76@))))) (=> (= tmp%10@ (= temp_9_0~1666@ temp_9_1~1739@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1827@ (Sub (Mul (Mul (Mul a10~82@ d10~88@) b10~84@) (Mul (Mul d10~88@ c10~86@) (Mul b10~84@ a10~82@))) (Mul (Mul (Mul c10~86@ d10~88@) (Sub 47 c10~86@)) (Add (Add a10~82@ b10~84@) (Mul b10~84@ a10~82@))))) (=> (= temp_10_1~1900@ (Sub (Mul (Mul (Mul d10~88@ c10~86@) (Mul b10~84@ a10~82@)) (Mul (Mul a10~82@ d10~88@) b10~84@)) (Mul (Mul (Mul c10~86@ d10~88@) (Sub 47 c10~86@)) (Add (Add a10~82@ b10~84@) (Mul b10~84@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1827@ temp_10_1~1900@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1972@ (Mul (Mul (Mul (Sub a11~90@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ c11~94@) d11~96@)) (Mul (Add (Mul b11~92@ a11~90@) d11~96@) (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~2029@ (Mul (Mul (Add (Mul b11~92@ a11~90@) d11~96@) (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ c11~94@))) (Mul (Mul (Sub a11~90@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ c11~94@) d11~96@)))) (=> (= tmp%12@ (= temp_11_0~1972@ temp_11_1~2029@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2105@ (Mul (Mul (Add (Mul a12~98@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul b12~100@ a12~98@) (Mul b12~100@ d12~104@)) (Mul c12~102@ (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2166@ (Mul (Mul (Mul (Add (Mul a12~98@ a12~98@) (Mul c12~102@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ c12~102@))) (Mul (Mul b12~100@ a12~98@) (Mul b12~100@ d12~104@))) (Mul c12~102@ (Mul a12~98@ d12~104@)))) (=> (= tmp%13@ (= temp_12_0~2105@ temp_12_1~2166@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2246@ (Mul (Mul (Sub (Add b13~108@ d13~112@) (Mul a13~106@ c13~110@)) (Add (Mul d13~112@ b13~108@) (Mul a13~106@ a13~106@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ b13~108@)) (Mul (Mul a13~106@ a13~106@) (Mul c13~110@ a13~106@))))) (=> (= temp_13_1~2327@ (Mul (Sub (Mul (Add b13~108@ d13~112@) (Add (Mul d13~112@ b13~108@) (Mul a13~106@ a13~106@))) (Mul (Mul a13~106@ c13~110@) (Add (Mul d13~112@ b13~108@) (Mul a13~106@ a13~106@)))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ b13~108@)) (Mul (Mul a13~106@ a13~106@) (Mul c13~110@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2246@ temp_13_1~2327@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2387@ (Mul (Mul (Mul b14~116@ (Mul a14~114@ b14~116@)) b14~116@) (Mul (Sub (Mul d14~120@ d14~120@) (Mul a14~114@ b14~116@)) (Sub c14~118@ (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~2448@ (Mul (Mul (Mul b14~116@ (Mul a14~114@ b14~116@)) b14~116@) (Sub (Mul (Sub (Mul d14~120@ d14~120@) (Mul a14~114@ b14~116@)) c14~118@) (Mul (Sub (Mul d14~120@ d14~120@) (Mul a14~114@ b14~116@)) (Mul c14~118@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2387@ temp_14_1~2448@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2524@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ d15~128@)) (Mul (Sub d15~128@ c15~126@) (Mul a15~122@ c15~126@))) (Mul (Mul c15~126@ (Mul a15~122@ a15~122@)) (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ a15~122@))))) (=> (= temp_15_1~2585@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ d15~128@)) (Mul (Mul a15~122@ c15~126@) (Sub d15~128@ c15~126@))) (Mul (Mul c15~126@ (Mul a15~122@ a15~122@)) (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ a15~122@))))) (=> (= tmp%16@ (= temp_15_0~2524@ temp_15_1~2585@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2665@ (Mul (Add (Mul (Mul d16~136@ c16~134@) (Mul d16~136@ b16~132@)) (Mul (Mul c16~134@ d16~136@) (Mul d16~136@ c16~134@))) (Mul (Sub (Mul a16~130@ c16~134@) (Mul c16~134@ c16~134@)) (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ b16~132@))))) (=> (= temp_16_1~2730@ (Mul (Add (Mul (Mul d16~136@ c16~134@) (Mul d16~136@ b16~132@)) (Mul c16~134@ (Mul d16~136@ (Mul d16~136@ c16~134@)))) (Mul (Sub (Mul a16~130@ c16~134@) (Mul c16~134@ c16~134@)) (Mul (Mul a16~130@ d16~136@) (Mul b16~132@ b16~132@))))) (=> (= tmp%17@ (= temp_16_0~2665@ temp_16_1~2730@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2818@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) (Sub a17~138@ c17~142@)) (Sub (Mul d17~144@ d17~144@) (Mul b17~140@ d17~144@))) (Mul (Add (Mul d17~144@ 66) (Mul b17~140@ b17~140@)) (Mul a17~138@ (Mul b17~140@ a17~138@))))) (=> (= temp_17_1~2891@ (Mul (Mul (Add (Mul d17~144@ 66) (Mul b17~140@ b17~140@)) (Mul a17~138@ (Mul b17~140@ a17~138@))) (Mul (Mul (Mul b17~140@ c17~142@) (Sub a17~138@ c17~142@)) (Sub (Mul d17~144@ d17~144@) (Mul b17~140@ d17~144@))))) (=> (= tmp%18@ (= temp_17_0~2818@ temp_17_1~2891@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2967@ (Sub (Mul (Mul (Mul c18~150@ b18~148@) c18~150@) (Mul (Mul d18~152@ c18~150@) (Mul c18~150@ b18~148@))) (Sub (Mul (Mul d18~152@ a18~146@) (Mul b18~148@ d18~152@)) (Mul (Add a18~146@ c18~150@) (Mul a18~146@ a18~146@))))) (=> (= temp_18_1~3028@ (Sub (Mul (Mul (Mul c18~150@ b18~148@) c18~150@) (Mul d18~152@ (Mul c18~150@ (Mul c18~150@ b18~148@)))) (Sub (Mul (Mul d18~152@ a18~146@) (Mul b18~148@ d18~152@)) (Mul (Add a18~146@ c18~150@) (Mul a18~146@ a18~146@))))) (=> (= tmp%19@ (= temp_18_0~2967@ temp_18_1~3028@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3104@ (Mul (Add (Mul (Mul a19~154@ b19~156@) (Mul d19~160@ a19~154@)) (Mul a19~154@ (Mul d19~160@ c19~158@))) (Mul (Mul (Sub a19~154@ d19~160@) (Add a19~154@ a19~154@)) (Mul (Mul c19~158@ d19~160@) (Add d19~160@ d19~160@))))) (=> (= temp_19_1~3165@ (Mul (Add (Mul (Mul a19~154@ b19~156@) (Mul d19~160@ a19~154@)) (Mul a19~154@ (Mul d19~160@ c19~158@))) (Mul (Mul (Mul c19~158@ d19~160@) (Add d19~160@ d19~160@)) (Mul (Sub a19~154@ d19~160@) (Add a19~154@ a19~154@))))) (=> (= tmp%20@ (= temp_19_0~3104@ temp_19_1~3165@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3245@ (Mul (Mul (Add (Sub a20~162@ d20~168@) (Mul b20~164@ d20~168@)) (Mul (Mul c20~166@ c20~166@) (Mul a20~162@ a20~162@))) (Mul (Mul (Mul c20~166@ d20~168@) (Mul b20~164@ c20~166@)) (Mul (Add a20~162@ a20~162@) (Sub a20~162@ d20~168@))))) (=> (= temp_20_1~3310@ (Mul (Mul (Mul (Add (Sub a20~162@ d20~168@) (Mul b20~164@ d20~168@)) (Mul (Mul c20~166@ c20~166@) (Mul a20~162@ a20~162@))) (Mul (Mul c20~166@ d20~168@) (Mul b20~164@ c20~166@))) (Mul (Add a20~162@ a20~162@) (Sub a20~162@ d20~168@)))) (=> (= tmp%21@ (= temp_20_0~3245@ temp_20_1~3310@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3382@ (Sub (Mul (Mul (Mul b21~172@ d21~176@) (Mul d21~176@ d21~176@)) (Mul (Mul a21~170@ a21~170@) (Mul d21~176@ a21~170@))) (Mul (Mul b21~172@ (Mul c21~174@ a21~170@)) (Add (Mul c21~174@ a21~170@) c21~174@)))) (=> (= temp_21_1~3439@ (Sub (Mul (Mul (Mul b21~172@ d21~176@) (Mul d21~176@ d21~176@)) (Mul (Mul d21~176@ a21~170@) (Mul a21~170@ a21~170@))) (Mul (Mul b21~172@ (Mul c21~174@ a21~170@)) (Add (Mul c21~174@ a21~170@) c21~174@)))) (=> (= tmp%22@ (= temp_21_0~3382@ temp_21_1~3439@)) (and (=> %%location_label%%21 tmp%22@) (=> tmp%22@ (=> (= temp_22_0~3507@ (Sub (Add (Mul (Mul d22~184@ b22~180@) (Mul d22~184@ d22~184@)) (Mul (Mul a22~178@ a22~178@) (Mul a22~178@ d22~184@))) (Mul d22~184@ (Sub (Mul d22~184@ d22~184@) (Mul d22~184@ c22~182@))))) (=> (= temp_22_1~3560@ (Sub (Add (Mul (Mul d22~184@ b22~180@) (Mul d22~184@ d22~184@)) (Mul (Mul a22~178@ a22~178@) (Mul a22~178@ d22~184@))) (Mul (Sub (Mul d22~184@ d22~184@) (Mul d22~184@ c22~182@)) d22~184@))) (=> (= tmp%23@ (= temp_22_0~3507@ temp_22_1~3560@)) (=> %%location_label%%22 tmp%23@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
