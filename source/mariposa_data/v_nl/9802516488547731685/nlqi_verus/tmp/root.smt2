...
;; mariposa_data/v_nl//9802516488547731685/nlqi_verus/src/main.rs:7:1: 36:40 (#0)
(push)
 ...
 (declare-const temp_15_1~2620@ Int)
 ...
 (declare-const temp_18_0~2997@ Int)
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Add b0~4@ d0~8@)
         (Sub a0~2@ b0~4@)
        )
       ) (Mul (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ c0~6@)))
     ))
     (=>
      (= temp_0_1~370@ (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Add b0~4@ d0~8@)
          (Sub a0~2@ b0~4@)
         )
        ) (Mul (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul (Mul d0~8@ c0~6@) a0~2@)
          c0~6@
      ))))
      (and
       (=>
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~463@ (Sub (Mul (Mul d1~16@ (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@)
             (Add b1~12@ 13)
            )
           ) (Add (Mul (Add c1~14@ a1~10@) (Add b1~12@ c1~14@)) (Mul d1~16@ (Mul b1~12@ d1~16@)))
         ))
         (=>
          (= temp_1_1~532@ (Sub (Mul (Mul (Mul d1~16@ c1~14@) d1~16@) (Mul (Mul c1~14@ c1~14@)
              (Add b1~12@ 13)
             )
            ) (Add (Mul (Add c1~14@ a1~10@) (Add b1~12@ c1~14@)) (Mul d1~16@ (Mul b1~12@ d1~16@)))
          ))
          (and
           ...
           (=>
            (= temp_1_0~463@ temp_1_1~532@)
            (=>
             (= temp_2_0~617@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@
                  a2~18@
                 ) c2~22@
                )
               ) (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Add (Mul b2~20@ b2~20@) (Mul d2~24@
                  b2~20@
             )))))
             (=>
              (= temp_2_1~678@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@
                   a2~18@
                  ) c2~22@
                 )
                ) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)) (Add (Mul b2~20@ b2~20@) (Mul d2~24@
                   b2~20@
              )))))
              (and
               (=>
               ...
               (=>
                (= temp_2_0~617@ temp_2_1~678@)
                (=>
                 (= temp_3_0~767@ (Mul (Sub (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul d3~32@
                      c3~30@
                     ) (Mul a3~26@ a3~26@)
                    )
                   ) (Mul (Add (Mul c3~30@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul c3~30@
                      b3~28@
                 )))))
                 (=>
                  (= temp_3_1~832@ (Mul (Sub (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul d3~32@
                       c3~30@
                      ) (Mul a3~26@ a3~26@)
                     )
                    ) (Mul (Add (Mul c3~30@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Mul c3~30@
                       d3~32@
                  )))))
                  (and
                   (=>
                   ...
                   (=>
                    (= temp_3_0~767@ temp_3_1~832@)
                    (=>
                     (= temp_4_0~917@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Add b4~36@ c4~38@)) (Mul (Mul b4~36@
                          a4~34@
                         ) a4~34@
                        )
                       ) (Add (Sub (Mul c4~38@ a4~34@) (Add a4~34@ c4~38@)) (Add (Mul d4~40@ d4~40@) (Mul d4~40@
                          c4~38@
                     )))))
                     (=>
                      (= temp_4_1~974@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Add b4~36@ c4~38@)) (Mul (Mul b4~36@
                           a4~34@
                          ) a4~34@
                         )
                        ) (Add (Sub (Mul c4~38@ a4~34@) (Add a4~34@ c4~38@)) (Mul d4~40@ (Add d4~40@ c4~38@)))
                      ))
                      (and
                       (=>
                        (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                        (=>
                         %%location_label%%4
                         (= temp_4_0~917@ temp_4_1~974@)
                       ))
                       (=>
                        (= temp_4_0~917@ temp_4_1~974@)
                        (=>
                         (= temp_5_0~1063@ (Mul (Sub (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@
                              d5~48@
                             ) (Mul d5~48@ a5~42@)
                            )
                           ) (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@)) (Sub (Mul b5~44@ c5~46@) (Add d5~48@
                              b5~44@
                         )))))
                         (=>
                          (= temp_5_1~1128@ (Mul (Sub (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@
                               d5~48@
                              ) (Mul d5~48@ a5~42@)
                             )
                            ) (Mul (Mul c5~46@ b5~44@) (Mul (Mul c5~46@ d5~48@) (Sub (Mul b5~44@ c5~46@) (Add d5~48@
                                b5~44@
                          ))))))
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1063@ temp_5_1~1128@)
                           ))
                           (=>
                            (= temp_5_0~1063@ temp_5_1~1128@)
                            (=>
                             (= temp_6_0~1217@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@
                                  b6~52@
                                 ) (Mul b6~52@ d6~56@)
                                )
                               ) (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@
                                  d6~56@
                             )))))
                             (=>
                              (= temp_6_1~1282@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@
                                   b6~52@
                                  ) (Mul b6~52@ d6~56@)
                                 )
                                ) (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@
                                   d6~56@
                              )))))
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1217@ temp_6_1~1282@)
                               ))
                               (=>
                                (= temp_6_0~1217@ temp_6_1~1282@)
                                (=>
                                 (= temp_7_0~1359@ (Mul (Mul (Sub (Add b7~60@ a7~58@) (Mul d7~64@ b7~60@)) b7~60@) (
                                    Mul (Add (Mul b7~60@ d7~64@) (Sub a7~58@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@
                                      a7~58@
                                 )))))
                                 (=>
                                  (= temp_7_1~1428@ (Mul (Mul (Sub (Add b7~60@ a7~58@) (Mul d7~64@ b7~60@)) b7~60@) (
                                     Add (Mul (Mul b7~60@ d7~64@) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ a7~58@))) (Mul (
                                       Sub a7~58@ b7~60@
                                      ) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ a7~58@))
                                  ))))
                                  (and
                                   (=>
                                    (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1359@ temp_7_1~1428@)
                                   ))
                                   (=>
                                    (= temp_7_0~1359@ temp_7_1~1428@)
                                    (=>
                                     (= temp_8_0~1529@ (Add (Mul (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ d8~72@)) (Sub (Mul b8~68@
                                          c8~70@
                                         ) (Add d8~72@ a8~66@)
                                        )
                                       ) (Mul (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Mul b8~68@
                                          19
                                     )))))
                                     (=>
                                      (= temp_8_1~1606@ (Add (Mul (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ d8~72@)) (Sub (Mul b8~68@
                                           c8~70@
                                          ) (Add d8~72@ a8~66@)
                                         )
                                        ) (Mul (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Mul 19
                                           b8~68@
                                      )))))
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1529@ temp_8_1~1606@)
                                       ))
                                       (=>
                                        (= temp_8_0~1529@ temp_8_1~1606@)
                                        (=>
                                         (= temp_9_0~1671@ (Mul (Mul (Mul (Mul a9~74@ d9~80@) (Mul d9~80@ a9~74@)) b9~76@) (
                                            Add (Mul c9~78@ d9~80@) (Mul d9~80@ (Mul d9~80@ c9~78@))
                                         )))
                                         (=>
                                          (= temp_9_1~1712@ (Mul (Mul (Mul (Mul a9~74@ d9~80@) (Mul d9~80@ a9~74@)) b9~76@) (
                                             Add (Mul d9~80@ c9~78@) (Mul d9~80@ (Mul d9~80@ c9~78@))
                                          )))
                                          (and
                                           (=>
                                            (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1671@ temp_9_1~1712@)
                                           ))
                                           (=>
                                            (= temp_9_0~1671@ temp_9_1~1712@)
                                            (=>
                                             (= temp_10_0~1797@ (Mul (Mul (Mul b10~84@ (Mul a10~82@ a10~82@)) (Mul (Add d10~88@ d10~88@)
                                                 (Mul a10~82@ b10~84@)
                                                )
                                               ) (Mul (Sub (Add a10~82@ c10~86@) (Mul c10~86@ a10~82@)) (Mul (Mul c10~86@ a10~82@)
                                                 (Mul a10~82@ b10~84@)
                                             ))))
                                             (=>
                                              (= temp_10_1~1858@ (Mul (Mul (Mul b10~84@ (Mul a10~82@ a10~82@)) (Mul (Add d10~88@ d10~88@)
                                                  (Mul b10~84@ a10~82@)
                                                 )
                                                ) (Mul (Sub (Add a10~82@ c10~86@) (Mul c10~86@ a10~82@)) (Mul (Mul c10~86@ a10~82@)
                                                  (Mul a10~82@ b10~84@)
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1797@ temp_10_1~1858@)
                                               ))
                                               (=>
                                                (= temp_10_0~1797@ temp_10_1~1858@)
                                                (=>
                                                 (= temp_11_0~1959@ (Mul (Sub (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (
                                                      Add c11~94@ a11~90@
                                                     ) (Mul d11~96@ 57)
                                                    )
                                                   ) (Sub (Mul (Add a11~90@ c11~94@) (Mul c11~94@ b11~92@)) (Mul (Sub a11~90@ b11~92@)
                                                     (Mul b11~92@ d11~96@)
                                                 ))))
                                                 (=>
                                                  (= temp_11_1~2036@ (Mul (Sub (Mul (Mul b11~92@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (
                                                       Add c11~94@ a11~90@
                                                      ) (Mul d11~96@ 57)
                                                     )
                                                    ) (Sub (Mul (Add a11~90@ c11~94@) (Mul c11~94@ b11~92@)) (Mul (Mul b11~92@ d11~96@)
                                                      (Sub a11~90@ b11~92@)
                                                  ))))
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~1959@ temp_11_1~2036@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~1959@ temp_11_1~2036@)
                                                    (=>
                                                     (= temp_12_0~2125@ (Sub (Add (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@)) (
                                                         Mul (Add b12~100@ d12~104@) (Mul d12~104@ c12~102@)
                                                        )
                                                       ) (Mul (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ a12~98@)) (Mul (Mul a12~98@ c12~102@)
                                                         (Mul b12~100@ b12~100@)
                                                     ))))
                                                     (=>
                                                      (= temp_12_1~2190@ (Sub (Add (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@)) (
                                                          Mul (Add b12~100@ d12~104@) (Mul d12~104@ c12~102@)
                                                         )
                                                        ) (Mul (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ a12~98@)) (Mul a12~98@ (Mul c12~102@
                                                           (Mul b12~100@ b12~100@)
                                                      )))))
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2125@ temp_12_1~2190@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2125@ temp_12_1~2190@)
                                                        (=>
                                                         (= temp_13_0~2279@ (Mul (Mul (Add (Sub a13~106@ b13~108@) (Mul c13~110@ c13~110@)) (
                                                             Mul (Sub b13~108@ c13~110@) (Mul a13~106@ b13~108@)
                                                            )
                                                           ) (Mul (Mul (Mul c13~110@ d13~112@) (Add d13~112@ c13~110@)) (Mul (Sub a13~106@ b13~108@)
                                                             (Mul c13~110@ b13~108@)
                                                         ))))
                                                         (=>
                                                          (= temp_13_1~2344@ (Mul (Mul (Add (Sub a13~106@ b13~108@) (Mul c13~110@ c13~110@)) (
                                                              Mul (Sub b13~108@ c13~110@) (Mul b13~108@ a13~106@)
                                                             )
                                                            ) (Mul (Mul (Mul c13~110@ d13~112@) (Add d13~112@ c13~110@)) (Mul (Sub a13~106@ b13~108@)
                                                              (Mul c13~110@ b13~108@)
                                                          ))))
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2279@ temp_13_1~2344@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2279@ temp_13_1~2344@)
                                                            (=>
                                                             (= temp_14_0~2405@ (Add b14~116@ (Mul (Sub (Mul c14~118@ d14~120@) (Add c14~118@ c14~118@))
                                                                (Mul (Mul c14~118@ c14~118@) (Mul a14~114@ d14~120@))
                                                             )))
                                                             (=>
                                                              (= temp_14_1~2442@ (Add b14~116@ (Mul (Sub (Mul c14~118@ d14~120@) (Add c14~118@ c14~118@))
                                                                 (Mul (Mul (Mul c14~118@ c14~118@) a14~114@) d14~120@)
                                                              )))
                                                              (and
                                                               (=>
                                                                (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2405@ temp_14_1~2442@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2405@ temp_14_1~2442@)
                                                                (=>
                                                                 (= temp_15_0~2543@ (Sub (Mul (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ b15~124@)) (
                                                                     Mul (Mul a15~122@ c15~126@) (Mul a15~122@ c15~126@)
                                                                    )
                                                                   ) (Mul (Mul (Mul c15~126@ c15~126@) (Add d15~128@ b15~124@)) (Sub (Mul b15~124@ b15~124@)
                                                                     (Mul 5 b15~124@)
                                                                 ))))
                                                                 (=>
                                                                  (= temp_15_1~2620@ (Sub (Mul (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ b15~124@)) (
                                                                      Mul (Mul c15~126@ a15~122@) (Mul a15~122@ c15~126@)
                                                                     )
                                                                    ) (Mul (Mul (Mul c15~126@ c15~126@) (Add d15~128@ b15~124@)) (Sub (Mul b15~124@ b15~124@)
                                                                      (Mul 5 b15~124@)
                                                                  ))))
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2543@ temp_15_1~2620@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2543@ temp_15_1~2620@)
                                                                    (=>
                                                                     (= temp_16_0~2701@ (Mul (Add (Add (Mul c16~134@ d16~136@) d16~136@) (Mul (Mul a16~130@
                                                                          b16~132@
                                                                         ) b16~132@
                                                                        )
                                                                       ) (Mul (Add (Mul d16~136@ b16~132@) (Mul d16~136@ c16~134@)) (Add (Mul a16~130@ d16~136@)
                                                                         (Mul a16~130@ b16~132@)
                                                                     ))))
                                                                     (=>
                                                                      (= temp_16_1~2758@ (Mul (Add (Add (Mul c16~134@ d16~136@) d16~136@) (Mul b16~132@ (Mul
                                                                           a16~130@ b16~132@
                                                                         ))
                                                                        ) (Mul (Add (Mul d16~136@ b16~132@) (Mul d16~136@ c16~134@)) (Add (Mul a16~130@ d16~136@)
                                                                          (Mul a16~130@ b16~132@)
                                                                      ...
                                                                      (and
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         %%location_label%%16
                                                                         (= temp_16_0~2701@ temp_16_1~2758@)
                                                                       ))
                                                                       (=>
                                                                        (= temp_16_0~2701@ temp_16_1~2758@)
                                                                        (=>
                                                                         (= temp_17_0~2847@ (Mul (Mul (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@)) (
                                                                             Mul (Mul d17~144@ d17~144@) (Mul c17~142@ b17~140@)
                                                                            )
                                                                           ) (Mul (Sub (Mul b17~140@ a17~138@) (Add c17~142@ a17~138@)) (Mul (Add d17~144@ d17~144@)
                                                                             (Mul d17~144@ a17~138@)
                                                                         ))))
                                                                         (=>
                                                                          (= temp_17_1~2912@ (Mul (Mul (Sub (Mul b17~140@ a17~138@) (Add c17~142@ a17~138@)) (
                                                                              Mul (Add d17~144@ d17~144@) (Mul d17~144@ a17~138@)
                                                                             )
                                                                            ) (Mul (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul d17~144@ d17~144@)
                                                                              (Mul c17~142@ b17~140@)
                                                                          ))))
                                                                          (and
                                                                           (=>
                                                                            ...
                                                                            (=>
                                                                             %%location_label%%17
                                                                             (= temp_17_0~2847@ temp_17_1~2912@)
                                                                           ))
                                                                           (=>
                                                                            (= temp_17_0~2847@ temp_17_1~2912@)
                                                                            (=>
                                                                             (= temp_18_0~2997@ (Mul (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ b18~148@)) (
                                                                                 Mul (Mul a18~146@ c18~150@) (Mul d18~152@ d18~152@)
                                                                                )
                                                                               ) (Mul (Mul (Mul d18~152@ a18~146@) (Mul d18~152@ c18~150@)) (Mul (Sub c18~150@ a18~146@)
                                                                                 a18~146@
                                                                             ))))
                                                                             (=>
                                                                              (= temp_18_1~3058@ (Mul (Mul (Mul b18~148@ a18~146@) (Mul c18~150@ b18~148@)) (Mul (
                                                                                  Mul (Mul a18~146@ c18~150@) (Mul d18~152@ d18~152@)
                                                                                 ) (Mul (Mul (Mul d18~152@ a18~146@) (Mul d18~152@ c18~150@)) (Mul (Sub c18~150@ a18~146@)
                                                                                   a18~146@
                                                                              )))))
