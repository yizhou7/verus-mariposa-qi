...
(declare-const temp_1_0~502@ Int)
...
(declare-const temp_6_0~1819@ Int)
(declare-const temp_6_1~1928@ Int)
(declare-const temp_7_0~2068@ Int)
(declare-const temp_7_1~2201@ Int)
(declare-const temp_8_0~2333@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~257@ (Mul (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul a0~2@ b0~4@) d0~8@) c0~6@)) (Mul (Sub d0~8@ (Add a0~2@ (Mul b0~4@ a0~2@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@)))))) (=> (= temp_0_1~354@ (Mul (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul a0~2@ b0~4@) d0~8@) c0~6@)) (Mul (Sub d0~8@ (Add a0~2@ (Mul b0~4@ a0~2@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)))))) (=> (= tmp%1@ (= temp_0_0~257@ temp_0_1~354@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~502@ (Mul (Mul b1~12@ (Mul (Add (Mul 99 a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)))) (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Add a1~10@ b1~12@)) (Mul (Mul 22 90) (Sub d1~16@ c1~14@))) (Mul (Add (Mul d1~16@ a1~10@) b1~12@) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@)))))) (=> (= temp_1_1~635@ (Mul (Mul b1~12@ (Mul (Add (Mul 99 a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)))) (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Add a1~10@ b1~12@)) (Mul 22 (Mul 90 (Sub d1~16@ c1~14@)))) (Mul (Add (Mul d1~16@ a1~10@) b1~12@) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@)))))) (=> (= tmp%2@ (= temp_1_0~502@ temp_1_1~635@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~759@ (Mul (Mul (Mul (Add d2~24@ (Mul b2~20@ d2~24@)) (Sub (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@))) (Add (Mul (Add a2~18@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Add b2~20@ a2~18@) (Mul d2~24@ a2~18@)))) (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ c2~22@)) (Mul d2~24@ (Mul d2~24@ a2~18@))) (Mul d2~24@ (Mul (Mul d2~24@ c2~22@) (Add b2~20@ a2~18@)))))) (=> (= temp_2_1~876@ (Mul (Mul (Mul (Add d2~24@ (Mul b2~20@ d2~24@)) (Sub (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@))) (Add (Mul (Add a2~18@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Add b2~20@ a2~18@) (Mul d2~24@ a2~18@)))) (Mul (Mul (Sub (Mul (Mul a2~18@ b2~20@) b2~20@) (Mul (Mul a2~18@ b2~20@) c2~22@)) (Mul d2~24@ (Mul d2~24@ a2~18@))) (Mul d2~24@ (Mul (Mul d2~24@ c2~22@) (Add b2~20@ a2~18@)))))) (=> (= tmp%3@ (= temp_2_0~759@ temp_2_1~876@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1024@ (Mul (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ b3~28@))) (Sub (Sub (Sub c3~30@ b3~28@) b3~28@) (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)))) (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul 64 c3~30@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ d3~32@)) (Sub d3~32@ (Mul b3~28@ b3~28@)))))) (=> (= temp_3_1~1157@ (Mul (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ b3~28@))) (Sub (Sub (Sub c3~30@ b3~28@) b3~28@) (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)))) (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul 64 c3~30@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ d3~32@)) (Sub d3~32@ (Mul b3~28@ b3~28@)))))) (=> (= tmp%4@ (= temp_3_0~1024@ temp_3_1~1157@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1309@ (Sub (Mul (Mul c4~38@ (Add (Mul a4~34@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul d4~40@ c4~38@) (Add c4~38@ a4~34@)) 88)) (Mul (Sub (Mul (Mul b4~36@ b4~36@) a4~34@) (Add (Mul d4~40@ 70) (Mul c4~38@ b4~36@))) (Mul (Mul (Add b4~36@ a4~34@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ 8)))))) (=> (= temp_4_1~1454@ (Sub (Mul (Mul c4~38@ (Add (Mul a4~34@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Add (Mul (Mul d4~40@ c4~38@) c4~38@) (Mul (Mul d4~40@ c4~38@) a4~34@)) 88)) (Mul (Sub (Mul (Mul b4~36@ b4~36@) a4~34@) (Add (Mul d4~40@ 70) (Mul c4~38@ b4~36@))) (Mul (Mul (Add b4~36@ a4~34@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ 8)))))) (=> (= tmp%5@ (= temp_4_0~1309@ temp_4_1~1454@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1582@ (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ c5~46@))) (Sub (Add (Mul a5~42@ b5~44@) (Sub d5~48@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)))) (Mul (Mul (Mul c5~46@ (Mul d5~48@ d5~48@)) (Mul (Mul c5~46@ a5~42@) d5~48@)) (Sub (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ c5~46@)))))) (=> (= temp_5_1~1695@ (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ c5~46@))) (Sub (Add (Mul a5~42@ b5~44@) (Sub d5~48@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)))) (Mul (Mul (Mul c5~46@ (Mul d5~48@ d5~48@)) (Mul (Mul c5~46@ a5~42@) d5~48@)) (Sub (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ a5~42@)) (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@)))))) (=> (= tmp%6@ (= temp_5_0~1582@ temp_5_1~1695@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1819@ (Add (Add (Mul (Mul (Add a6~50@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ d6~56@))) (Mul (Add (Mul b6~52@ d6~56@) b6~52@) (Mul (Add c6~54@ c6~54@) (Add b6~52@ d6~56@)))) (Mul (Mul (Sub (Mul d6~56@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ b6~52@))) (Mul (Mul d6~56@ (Add a6~50@ a6~50@)) b6~52@)))) (=> (= temp_6_1~1928@ (Add (Add (Mul (Mul (Add a6~50@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ d6~56@))) (Mul (Add (Mul b6~52@ d6~56@) b6~52@) (Mul (Add c6~54@ c6~54@) (Add b6~52@ d6~56@)))) (Mul (Mul (Sub (Mul d6~56@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ b6~52@))) (Mul (Mul (Add a6~50@ a6~50@) d6~56@) b6~52@)))) (=> (= tmp%7@ (= temp_6_0~1819@ temp_6_1~1928@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2068@ (Mul (Mul (Sub a7~58@ (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ c7~62@))) (Sub (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ b7~60@)) (Mul (Add a7~58@ c7~62@) (Add d7~64@ 63)))) (Add (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@)) (Sub (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@))) (Mul (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ c7~62@) b7~60@))))) (=> (= temp_7_1~2201@ (Mul (Mul (Sub a7~58@ (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ c7~62@))) (Sub (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ b7~60@)) (Add (Mul (Add a7~58@ c7~62@) d7~64@) (Mul (Add a7~58@ c7~62@) 63)))) (Add (Mul (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ d7~64@)) (Sub (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@))) (Mul (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ c7~62@) b7~60@))))) (=> (= tmp%8@ (= temp_7_0~2068@ temp_7_1~2201@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2333@ (Mul (Mul (Mul (Mul (Add a8~66@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@)) d8~72@)) (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul 81 d8~72@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul a8~66@ d8~72@) (Add a8~66@ b8~68@)) a8~66@)))) (=> (= temp_8_1~2458@ (Mul (Mul (Mul (Mul (Add a8~66@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@)) d8~72@)) (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul 81 d8~72@) (Mul b8~68@ d8~72@))) (Mul (Add (Mul (Mul a8~66@ d8~72@) a8~66@) (Mul (Mul a8~66@ d8~72@) b8~68@)) a8~66@)))) (=> (= tmp%9@ (= temp_8_0~2333@ temp_8_1~2458@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
