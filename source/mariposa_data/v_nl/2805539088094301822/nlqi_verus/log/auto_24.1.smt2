...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Add b0~4@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul b0~4@ a0~2@) (Sub c0~6@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Add c0~6@ b0~4@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Add b0~4@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@))) (Mul (Mul (Sub c0~6@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Mul c0~6@ d0~8@) (Add c0~6@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~463@ (Mul (Mul (Mul (Mul b1~12@ a1~10@) d1~16@) (Mul (Add d1~16@ c1~14@) (Mul c1~14@ d1~16@))) (Mul (Mul (Add d1~16@ 16) (Add a1~10@ a1~10@)) (Sub a1~10@ (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~532@ (Mul (Mul (Mul (Mul b1~12@ a1~10@) d1~16@) (Mul (Add d1~16@ c1~14@) (Mul d1~16@ c1~14@))) (Mul (Mul (Add d1~16@ 16) (Add a1~10@ a1~10@)) (Sub a1~10@ (Mul b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~463@ temp_1_1~532@))) (=> (= temp_1_0~463@ temp_1_1~532@) (=> (= temp_2_0~633@ (Mul (Add (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ d2~24@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ a2~18@))) (Add (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ 61))))) (=> (= temp_2_1~710@ (Mul (Add (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ d2~24@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ a2~18@))) (Add (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ 61))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~633@ temp_2_1~710@))) (=> (= temp_2_0~633@ temp_2_1~710@) (=> (= temp_3_0~783@ (Mul (Add (Sub (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@ c3~30@) c3~30@)) (Mul (Mul (Sub c3~30@ c3~30@) (Mul a3~26@ a3~26@)) a3~26@))) (=> (= temp_3_1~832@ (Mul (Add (Sub (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul c3~30@ c3~30@) c3~30@)) (Mul (Sub c3~30@ c3~30@) (Mul (Mul a3~26@ a3~26@) a3~26@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~783@ temp_3_1~832@))) (=> (= temp_3_0~783@ temp_3_1~832@) (=> (= temp_4_0~945@ (Sub (Mul (Sub (Add 38 52) (Mul a4~34@ c4~38@)) (Sub (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Sub d4~40@ a4~34@))))) (=> (= temp_4_1~1034@ (Sub (Mul (Sub (Add 38 52) (Mul a4~34@ c4~38@)) (Sub (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Mul c4~38@ d4~40@) (Mul (Mul b4~36@ b4~36@) (Mul (Mul d4~40@ b4~36@) (Sub d4~40@ a4~34@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~945@ temp_4_1~1034@))) (=> (= temp_4_0~945@ temp_4_1~1034@) (=> (= temp_5_0~1123@ (Mul (Add (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ a5~42@)) (Sub (Mul d5~48@ a5~42@) (Mul d5~48@ b5~44@))) (Mul (Add (Mul b5~44@ d5~48@) (Sub d5~48@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1188@ (Mul (Add (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ a5~42@)) (Sub (Mul d5~48@ a5~42@) (Mul d5~48@ b5~44@))) (Mul (Add (Mul b5~44@ d5~48@) (Sub d5~48@ d5~48@)) (Mul (Mul (Mul a5~42@ b5~44@) b5~44@) a5~42@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1123@ temp_5_1~1188@))) (=> (= temp_5_0~1123@ temp_5_1~1188@) (=> (= temp_6_0~1285@ (Sub (Mul (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ a6~50@)) (Add c6~54@ (Mul b6~52@ a6~50@))) (Sub (Mul (Mul a6~50@ 45) (Sub c6~54@ d6~56@)) (Mul (Add b6~52@ c6~54@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1374@ (Sub (Add (Mul (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ a6~50@)) c6~54@) (Mul (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ a6~50@)) (Mul b6~52@ a6~50@))) (Sub (Mul (Mul a6~50@ 45) (Sub c6~54@ d6~56@)) (Mul (Add b6~52@ c6~54@) (Mul c6~54@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1285@ temp_6_1~1374@))) (=> (= temp_6_0~1285@ temp_6_1~1374@) (=> (= temp_7_0~1435@ (Add (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Add c7~62@ d7~64@))) d7~64@)) (=> (= temp_7_1~1472@ (Add (Mul (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Add c7~62@ d7~64@))) d7~64@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1435@ temp_7_1~1472@))) (=> (= temp_7_0~1435@ temp_7_1~1472@) (=> (= temp_8_0~1561@ (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Add b8~68@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Add c8~70@ c8~70@))))) (=> (= temp_8_1~1626@ (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Add b8~68@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Add c8~70@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1561@ temp_8_1~1626@))) (=> (= temp_8_0~1561@ temp_8_1~1626@) (=> (= temp_9_0~1707@ (Mul (Mul (Mul a9~74@ (Mul a9~74@ a9~74@)) (Mul d9~80@ (Mul a9~74@ c9~78@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Add b9~76@ d9~80@))))) (=> (= temp_9_1~1764@ (Mul (Mul (Mul a9~74@ (Mul a9~74@ a9~74@)) (Mul (Mul a9~74@ c9~78@) d9~80@)) (Mul (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ d9~80@) (Add b9~76@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1707@ temp_9_1~1764@))) (=> (= temp_9_0~1707@ temp_9_1~1764@) (=> (= temp_10_0~1833@ (Add (Mul a10~82@ (Add b10~84@ (Sub b10~84@ a10~82@))) (Mul (Add (Mul b10~84@ a10~82@) (Mul c10~86@ b10~84@)) (Add (Mul d10~88@ c10~86@) b10~84@)))) (=> (= temp_10_1~1878@ (Add (Mul a10~82@ (Add b10~84@ (Sub b10~84@ a10~82@))) (Mul (Add (Mul a10~82@ b10~84@) (Mul c10~86@ b10~84@)) (Add (Mul d10~88@ c10~86@) b10~84@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1833@ temp_10_1~1878@))) (=> (= temp_10_0~1833@ temp_10_1~1878@) (=> (= temp_11_0~1975@ (Add (Mul (Mul (Mul 98 d11~96@) (Sub d11~96@ d11~96@)) (Mul (Mul d11~96@ c11~94@) d11~96@)) (Mul (Mul (Add a11~90@ d11~96@) (Sub c11~94@ d11~96@)) (Mul (Mul d11~96@ d11~96@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2048@ (Add (Mul (Mul (Mul 98 d11~96@) (Sub d11~96@ d11~96@)) (Mul (Mul d11~96@ c11~94@) d11~96@)) (Mul (Mul (Add a11~90@ d11~96@) (Sub c11~94@ d11~96@)) (Mul (Mul b11~92@ c11~94@) (Mul d11~96@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1975@ temp_11_1~2048@))) (=> (= temp_11_0~1975@ temp_11_1~2048@) (=> (= temp_12_0~2137@ (Mul (Mul (Mul a12~98@ (Mul d12~104@ a12~98@)) (Sub 49 (Mul b12~100@ c12~102@))) (Mul (Mul a12~98@ (Mul c12~102@ b12~100@)) (Mul (Mul b12~100@ b12~100@) (Mul a12~98@ a12~98@))))) (=> (= temp_12_1~2202@ (Mul (Mul (Mul a12~98@ (Mul d12~104@ a12~98@)) (Sub 49 (Mul b12~100@ c12~102@))) (Mul (Mul a12~98@ (Mul c12~102@ b12~100@)) (Mul (Mul a12~98@ a12~98@) (Mul b12~100@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2137@ temp_12_1~2202@))) (=> (= temp_12_0~2137@ temp_12_1~2202@) (=> (= temp_13_0~2283@ (Mul (Mul (Mul b13~108@ (Mul d13~112@ c13~110@)) (Mul (Mul a13~106@ a13~106@) (Mul d13~112@ a13~106@))) (Mul (Mul (Mul d13~112@ a13~106@) b13~108@) (Mul (Mul d13~112@ b13~108@) (Add b13~108@ c13~110@))))) (=> (= temp_13_1~2340@ (Mul (Mul (Mul b13~108@ (Mul d13~112@ c13~110@)) (Mul (Mul a13~106@ a13~106@) (Mul d13~112@ a13~106@))) (Mul (Mul (Mul d13~112@ a13~106@) b13~108@) (Mul (Mul d13~112@ b13~108@) (Add b13~108@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2283@ temp_13_1~2340@))) (=> (= temp_13_0~2283@ temp_13_1~2340@) (=> (= temp_14_0~2425@ (Add (Mul (Mul b14~116@ (Mul d14~120@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ b14~116@))) (Sub (Mul (Add c14~118@ b14~116@) (Sub d14~120@ d14~120@)) (Sub (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~2486@ (Add (Mul (Mul b14~116@ (Mul b14~116@ d14~120@)) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ b14~116@))) (Sub (Mul (Add c14~118@ b14~116@) (Sub d14~120@ d14~120@)) (Sub (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2425@ temp_14_1~2486@))) (=> (= temp_14_0~2425@ temp_14_1~2486@) (=> (= temp_15_0~2571@ (Mul (Sub (Mul (Sub d15~128@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Mul b15~124@ b15~124@) (Mul a15~122@ c15~126@))) (Mul (Mul (Mul c15~126@ a15~122@) a15~122@) (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ b15~124@))))) (=> (= temp_15_1~2632@ (Mul (Sub (Mul (Sub d15~128@ b15~124@) (Mul d15~128@ b15~124@)) (Mul (Mul b15~124@ b15~124@) (Mul a15~122@ c15~126@))) (Mul (Mul (Mul a15~122@ c15~126@) a15~122@) (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2571@ temp_15_1~2632@))) (=> (= temp_15_0~2571@ temp_15_1~2632@) (=> (= temp_16_0~2713@ (Mul (Sub (Mul (Sub d16~136@ d16~136@) (Mul c16~134@ d16~136@)) (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@))) (Mul (Mul (Mul a16~130@ c16~134@) c16~134@) (Mul b16~132@ (Mul d16~136@ a16~130@))))) (=> (= temp_16_1~2770@ (Mul (Sub (Mul (Sub d16~136@ d16~136@) (Mul c16~134@ d16~136@)) (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ a16~130@))) (Mul (Mul a16~130@ (Mul c16~134@ c16~134@)) (Mul b16~132@ (Mul d16~136@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2713@ temp_16_1~2770@))) (=> (= temp_16_0~2713@ temp_16_1~2770@) (=> (= temp_17_0~2847@ (Add (Add (Mul (Sub a17~138@ b17~140@) (Mul a17~138@ b17~140@)) (Mul (Mul b17~140@ a17~138@) (Mul c17~142@ c17~142@))) (Mul c17~142@ (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ c17~142@))))) (=> (= temp_17_1~2900@ (Add (Add (Mul (Sub a17~138@ b17~140@) (Mul a17~138@ b17~140@)) (Mul (Mul c17~142@ c17~142@) (Mul b17~140@ a17~138@))) (Mul c17~142@ (Mul (Mul b17~140@ d17~144@) (Mul b17~140@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2847@ temp_17_1~2900@))) (=> (= temp_17_0~2847@ temp_17_1~2900@) (=> (= temp_18_0~3013@ (Mul (Mul (Add (Mul b18~148@ d18~152@) (Mul c18~150@ a18~146@)) (Mul (Mul d18~152@ b18~148@) (Sub c18~150@ 68))) (Mul (Mul (Mul c18~150@ d18~152@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ c18~150@) (Mul 68 b18~148@))))) (=> (= temp_18_1~3102@ (Mul (Mul (Mul (Add (Mul b18~148@ d18~152@) (Mul c18~150@ a18~146@)) (Mul d18~152@ b18~148@)) (Sub c18~150@ 68)) (Mul (Mul (Mul c18~150@ d18~152@) (Mul b18~148@ a18~146@)) (Mul (Mul a18~146@ c18~150@) (Mul 68 b18~148@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3013@ temp_18_1~3102@))) (=> (= temp_18_0~3013@ temp_18_1~3102@) (=> (= temp_19_0~3191@ (Mul (Mul (Sub (Mul d19~160@ c19~158@) (Add c19~158@ c19~158@)) (Sub (Mul d19~160@ c19~158@) (Mul b19~156@ d19~160@))) (Mul (Mul (Add b19~156@ a19~154@) (Add d19~160@ d19~160@)) (Mul (Mul b19~156@ d19~160@) (Add a19~154@ d19~160@))))) (=> (= temp_19_1~3256@ (Mul (Mul (Sub (Mul d19~160@ c19~158@) (Add c19~158@ c19~158@)) (Sub (Mul d19~160@ c19~158@) (Mul b19~156@ d19~160@))) (Mul (Mul (Add b19~156@ a19~154@) (Add d19~160@ d19~160@)) (Mul b19~156@ (Mul d19~160@ (Add a19~154@ d19~160@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3191@ temp_19_1~3256@))) (=> (= temp_19_0~3191@ temp_19_1~3256@) (=> (= temp_20_0~3345@ (Sub (Mul (Mul (Mul a20~162@ b20~164@) (Mul c20~166@ c20~166@)) (Mul (Mul a20~162@ b20~164@) (Mul c20~166@ c20~166@))) (Mul (Mul (Sub a20~162@ c20~166@) (Mul b20~164@ d20~168@)) (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ c20~166@))))) (=> (= temp_20_1~3410@ (Sub (Mul (Mul (Mul b20~164@ a20~162@) (Mul c20~166@ c20~166@)) (Mul (Mul a20~162@ b20~164@) (Mul c20~166@ c20~166@))) (Mul (Mul (Sub a20~162@ c20~166@) (Mul b20~164@ d20~168@)) (Mul (Mul b20~164@ d20~168@) (Mul a20~162@ c20~166@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3345@ temp_20_1~3410@))) (=> (= temp_20_0~3345@ temp_20_1~3410@) (=> (= temp_21_0~3499@ (Mul (Mul (Mul (Mul b21~172@ b21~172@) (Mul b21~172@ a21~170@)) (Add (Mul a21~170@ a21~170@) (Mul a21~170@ c21~174@))) (Mul (Mul (Mul d21~176@ a21~170@) (Sub b21~172@ d21~176@)) (Mul (Add d21~176@ a21~170@) (Mul b21~172@ b21~172@))))) (=> (= temp_21_1~3564@ (Mul (Mul (Mul (Mul b21~172@ b21~172@) (Mul b21~172@ a21~170@)) (Add (Mul a21~170@ a21~170@) (Mul a21~170@ c21~174@))) (Mul (Mul (Sub b21~172@ d21~176@) (Mul d21~176@ a21~170@)) (Mul (Add d21~176@ a21~170@) (Mul b21~172@ b21~172@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3499@ temp_21_1~3564@))) (=> (= temp_21_0~3499@ temp_21_1~3564@) (=> (= temp_22_0~3649@ (Mul (Sub (Sub (Mul c22~182@ a22~178@) (Mul d22~184@ a22~178@)) (Mul (Mul a22~178@ c22~182@) (Mul b22~180@ c22~182@))) (Mul (Mul a22~178@ (Mul d22~184@ b22~180@)) (Sub (Mul a22~178@ a22~178@) (Mul b22~180@ a22~178@))))) (=> (= temp_22_1~3710@ (Mul (Sub (Sub (Mul c22~182@ a22~178@) (Mul d22~184@ a22~178@)) (Mul (Mul a22~178@ c22~182@) (Mul b22~180@ c22~182@))) (Mul (Mul a22~178@ (Mul d22~184@ b22~180@)) (Sub (Mul a22~178@ a22~178@) (Mul b22~180@ a22~178@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3649@ temp_22_1~3710@))) (=> (= temp_22_0~3649@ temp_22_1~3710@) (=> (= temp_23_0~3799@ (Mul (Mul (Mul (Mul b23~188@ a23~186@) (Mul b23~188@ c23~190@)) (Mul (Mul c23~190@ d23~192@) (Mul c23~190@ c23~190@))) (Mul (Sub (Mul d23~192@ a23~186@) (Mul a23~186@ d23~192@)) (Mul (Mul c23~190@ a23~186@) (Mul c23~190@ a23~186@))))) (=> (= temp_23_1~3864@ (Mul (Mul (Mul (Mul b23~188@ a23~186@) (Mul b23~188@ c23~190@)) (Mul (Mul c23~190@ d23~192@) (Mul c23~190@ c23~190@))) (Mul (Sub (Mul d23~192@ a23~186@) (Mul a23~186@ d23~192@)) (Mul (Mul (Mul c23~190@ a23~186@) c23~190@) a23~186@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3799@ temp_23_1~3864@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
