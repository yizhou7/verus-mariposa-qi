...
(declare-const temp_1_0~598@ Int)
(declare-const temp_1_1~731@ Int)
(declare-const temp_2_0~827@ Int)
(declare-const temp_2_1~908@ Int)
(declare-const temp_3_0~1072@ Int)
(declare-const temp_3_1~1221@ Int)
(declare-const temp_4_0~1353@ Int)
(declare-const temp_4_1~1470@ Int)
(declare-const temp_5_0~1586@ Int)
(declare-const temp_5_1~1687@ Int)
(declare-const temp_6_0~1787@ Int)
(declare-const temp_6_1~1872@ Int)
(declare-const temp_7_0~2000@ Int)
(declare-const temp_7_1~2113@ Int)
(declare-const temp_8_0~2213@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Add (Mul (Mul (Mul (Sub d0~8@ a0~2@) (Mul b0~4@ d0~8@)) (Add (Mul c0~6@ d0~8@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul d0~8@ a0~2@) (Add a0~2@ c0~6@)) (Mul (Mul c0~6@ c0~6@) (Add a0~2@ c0~6@)))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Add d0~8@ d0~8@))) (Add (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)) (Mul (Sub d0~8@ 63) (Sub a0~2@ c0~6@)))))) (=> (= temp_0_1~450@ (Add (Mul (Mul (Mul (Sub d0~8@ a0~2@) (Mul b0~4@ d0~8@)) (Add (Mul c0~6@ d0~8@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul d0~8@ a0~2@) (Add a0~2@ c0~6@)) (Mul (Mul c0~6@ c0~6@) (Add a0~2@ c0~6@)))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Add d0~8@ d0~8@))) (Add (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)) (Sub (Mul d0~8@ (Sub a0~2@ c0~6@)) (Mul 63 (Sub a0~2@ c0~6@))))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~450@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~598@ (Mul (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ d1~16@)) (Add (Mul a1~10@ c1~14@) b1~12@)) (Mul (Add (Mul b1~12@ a1~10@) (Mul b1~12@ b1~12@)) (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ a1~10@)))) (Mul (Mul (Mul (Add a1~10@ b1~12@) d1~16@) (Mul (Mul c1~14@ 8) (Sub d1~16@ d1~16@))) (Mul (Mul (Sub a1~10@ a1~10@) (Mul b1~12@ b1~12@)) (Sub (Mul c1~14@ c1~14@) (Sub a1~10@ c1~14@)))))) (=> (= temp_1_1~731@ (Mul (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ d1~16@)) (Add (Mul a1~10@ c1~14@) b1~12@)) (Mul (Add (Mul b1~12@ a1~10@) (Mul b1~12@ b1~12@)) (Mul (Mul (Mul b1~12@ b1~12@) b1~12@) a1~10@))) (Mul (Mul (Mul (Add a1~10@ b1~12@) d1~16@) (Mul (Mul c1~14@ 8) (Sub d1~16@ d1~16@))) (Mul (Mul (Sub a1~10@ a1~10@) (Mul b1~12@ b1~12@)) (Sub (Mul c1~14@ c1~14@) (Sub a1~10@ c1~14@)))))) (=> (= tmp%2@ (= temp_1_0~598@ temp_1_1~731@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~827@ (Mul a2~18@ (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ 87)) (Sub (Mul a2~18@ a2~18@) (Mul c2~22@ d2~24@))) (Sub (Sub (Mul c2~22@ c2~22@) (Mul a2~18@ b2~20@)) (Add (Mul a2~18@ c2~22@) (Sub a2~18@ a2~18@)))))) (=> (= temp_2_1~908@ (Mul (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ 87)) (Sub (Mul a2~18@ a2~18@) (Mul c2~22@ d2~24@))) (Sub (Sub (Mul c2~22@ c2~22@) (Mul a2~18@ b2~20@)) (Add (Mul a2~18@ c2~22@) (Sub a2~18@ a2~18@)))) a2~18@)) (=> (= tmp%3@ (= temp_2_0~827@ temp_2_1~908@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1072@ (Mul (Add (Sub (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Add b3~28@ c3~30@))) (Mul (Add (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ c3~30@) c3~30@))) (Mul (Mul (Mul (Mul a3~26@ 15) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ d3~32@))) (Mul (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Mul 1 b3~28@) (Mul a3~26@ d3~32@)))))) (=> (= temp_3_1~1221@ (Mul (Add (Sub (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Add b3~28@ c3~30@))) (Mul (Add (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ c3~30@) c3~30@))) (Mul (Mul (Mul (Mul 15 a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ d3~32@))) (Mul (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Mul 1 b3~28@) (Mul a3~26@ d3~32@)))))) (=> (= tmp%4@ (= temp_3_0~1072@ temp_3_1~1221@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1353@ (Mul (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ d4~40@))) (Sub (Mul (Sub b4~36@ a4~34@) (Mul d4~40@ a4~34@)) b4~36@)) (Mul (Mul (Mul (Add a4~34@ a4~34@) (Mul a4~34@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Sub c4~38@ b4~36@))) (Mul (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ b4~36@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ d4~40@)))))) (=> (= temp_4_1~1470@ (Mul (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ d4~40@))) (Sub (Mul (Sub b4~36@ a4~34@) (Mul d4~40@ a4~34@)) b4~36@)) (Mul (Mul (Mul (Add a4~34@ a4~34@) (Mul a4~34@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Sub c4~38@ b4~36@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ d4~40@)) (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ b4~36@)))))) (=> (= tmp%5@ (= temp_4_0~1353@ temp_4_1~1470@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1586@ (Mul (Sub (Sub (Mul (Mul d5~48@ d5~48@) d5~48@) (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ a5~42@))) (Mul a5~42@ (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ a5~42@)))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul (Mul c5~46@ d5~48@) (Add b5~44@ d5~48@))) (Mul (Mul d5~48@ (Mul d5~48@ a5~42@)) (Sub (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@)))))) (=> (= temp_5_1~1687@ (Mul (Sub (Sub (Mul (Mul d5~48@ d5~48@) d5~48@) (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ a5~42@))) (Mul a5~42@ (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ a5~42@)))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul (Mul c5~46@ d5~48@) (Add b5~44@ d5~48@))) (Mul (Mul d5~48@ (Mul d5~48@ a5~42@)) (Sub (Mul c5~46@ c5~46@) (Mul d5~48@ a5~42@)))))) (=> (= tmp%6@ (= temp_5_0~1586@ temp_5_1~1687@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1787@ (Mul (Mul (Mul d6~56@ (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@))) c6~54@) (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul d6~56@ b6~52@) b6~52@) (Sub (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@)))))) (=> (= temp_6_1~1872@ (Mul (Mul (Mul (Mul d6~56@ (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@))) c6~54@) (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@)))) (Mul (Mul (Mul d6~56@ b6~52@) b6~52@) (Sub (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~1787@ temp_6_1~1872@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2000@ (Sub (Sub (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ d7~64@) (Mul d7~64@ d7~64@))) (Mul (Mul (Sub c7~62@ a7~58@) a7~58@) d7~64@)) (Add (Sub (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Sub c7~62@ d7~64@) (Mul d7~64@ b7~60@))) (Add (Mul (Add b7~60@ b7~60@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ b7~60@)))))) (=> (= temp_7_1~2113@ (Sub (Sub (Mul (Mul (Mul b7~60@ d7~64@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ d7~64@))) (Mul (Mul (Sub c7~62@ a7~58@) a7~58@) d7~64@)) (Add (Sub (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Sub c7~62@ d7~64@) (Mul d7~64@ b7~60@))) (Add (Mul (Add b7~60@ b7~60@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ b7~60@)))))) (=> (= tmp%8@ (= temp_7_0~2000@ temp_7_1~2113@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2213@ (Mul (Mul (Mul (Mul (Mul b8~68@ d8~72@) c8~70@) (Sub (Mul d8~72@ b8~68@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul a8~66@ d8~72@) (Add a8~66@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@)))) (Mul a8~66@ (Mul b8~68@ (Mul (Mul d8~72@ a8~66@) (Add a8~66@ c8~70@)))))) (=> (= temp_8_1~2298@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ (Sub (Mul d8~72@ b8~68@) (Mul a8~66@ b8~68@)))) (Mul (Mul (Mul a8~66@ d8~72@) (Add a8~66@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@)))) (Mul a8~66@ (Mul b8~68@ (Mul (Mul d8~72@ a8~66@) (Add a8~66@ c8~70@)))))) (=> (= tmp%9@ (= temp_8_0~2213@ temp_8_1~2298@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
