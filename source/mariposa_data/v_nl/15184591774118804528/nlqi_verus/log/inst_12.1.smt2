...
(set-info :comment ";; mariposa_data/v_nl//15184591774118804528/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~257@ (Add (Mul (Mul a0~2@ (Mul (Mul d0~8@ c0~6@) b0~4@)) (Mul (Sub (Mul c0~6@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@)))) (Add (Mul (Mul (Add a0~2@ c0~6@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ a0~2@) d0~8@)) (Mul b0~4@ (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ c0~6@)))))) (=> (= temp_0_1~354@ (Add (Mul (Mul a0~2@ (Mul (Mul d0~8@ c0~6@) b0~4@)) (Mul (Sub (Mul c0~6@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@)))) (Add (Mul (Mul (Add a0~2@ c0~6@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ a0~2@) d0~8@)) (Mul b0~4@ (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ a0~2@)))))) (and (=> (= tmp%1@ (Mul d0~8@ a0~2@)) (=> (= tmp%2@ (Mul c0~6@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~257@ temp_0_1~354@))))) (=> (= temp_0_0~257@ temp_0_1~354@) (=> (= temp_1_0~519@ (Mul (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Add c1~14@ a1~10@)) (Mul (Add d1~16@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Sub (Mul b1~12@ 67) (Mul d1~16@ d1~16@)) b1~12@)) (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@)))))) (=> (= temp_1_1~648@ (Mul (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Add c1~14@ a1~10@)) (Mul (Add d1~16@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Sub (Mul b1~12@ 67) (Mul d1~16@ d1~16@)) b1~12@)) (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~519@ temp_1_1~648@))) (=> (= temp_1_0~519@ temp_1_1~648@) (=> (= temp_2_0~793@ (Mul (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Sub b2~20@ 36) (Mul b2~20@ c2~22@))) (Mul c2~22@ (Add (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)))) (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Sub d2~24@ a2~18@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ a2~18@)) b2~20@)))) (=> (= temp_2_1~910@ (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Sub b2~20@ 36) (Mul b2~20@ c2~22@))) (Mul (Mul c2~22@ (Add (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Sub d2~24@ a2~18@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ a2~18@)) b2~20@))))) (and (=> (= tmp%3@ (Mul (Mul (Sub b2~20@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Sub b2~20@ 36) (Mul b2~20@ c2~22@)))) (=> (= tmp%4@ (Mul c2~22@ (Add (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)))) (=> (= tmp%5@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Sub d2~24@ a2~18@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ a2~18@)) b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~793@ temp_2_1~910@)))))) (=> (= temp_2_0~793@ temp_2_1~910@) (=> (= temp_3_0~1157@ (Mul (Mul (Mul a3~26@ (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ d3~32@)) (Mul b3~28@ (Mul a3~26@ a3~26@)))) (Mul (Add (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ d3~32@))) (Add (Sub (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@)) (Sub (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@)))))) (=> (= temp_3_1~1266@ (Mul (Mul (Mul a3~26@ (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ d3~32@)) (Mul b3~28@ (Mul a3~26@ a3~26@)))) (Mul (Add (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ d3~32@))) (Add (Sub (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@)) (Mul b3~28@ (Sub b3~28@ c3~30@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b3~28@ b3~28@ c3~30@) (=> %%location_label%%3 (= temp_3_0~1157@ temp_3_1~1266@))) (=> (= temp_3_0~1157@ temp_3_1~1266@) (=> (= temp_4_0~1377@ (Mul (Mul (Mul (Mul (Add b4~36@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Add d4~40@ 17) (Add d4~40@ b4~36@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ a4~34@)))) c4~38@)) (=> (= temp_4_1~1458@ (Mul (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ a4~34@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Add d4~40@ 17) (Add d4~40@ b4~36@)))) c4~38@)) (and (=> (= tmp%6@ (Mul (Mul (Add b4~36@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Add d4~40@ 17) (Add d4~40@ b4~36@)))) (=> (= tmp%7@ (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ a4~34@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%4 (= temp_4_0~1377@ temp_4_1~1458@))))) (=> (= temp_4_0~1377@ temp_4_1~1458@) (=> (= temp_5_0~1611@ (Sub b5~44@ (Mul (Sub (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ c5~46@)) d5~48@) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ a5~42@)))))) (=> (= temp_5_1~1668@ (Sub b5~44@ (Mul (Sub (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ c5~46@)) d5~48@) (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ a5~42@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1611@ temp_5_1~1668@))) (=> (= temp_5_0~1611@ temp_5_1~1668@) (=> (= temp_6_0~1825@ (Add (Mul (Mul (Mul (Sub c6~54@ c6~54@) (Sub d6~56@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@))) (Mul b6~52@ d6~56@)) (Add (Mul (Mul (Mul c6~54@ a6~50@) (Add a6~50@ 67)) (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ d6~56@))) (Mul (Mul (Add a6~50@ c6~54@) (Mul a6~50@ c6~54@)) (Add (Mul a6~50@ c6~54@) (Mul d6~56@ 79)))))) (=> (= temp_6_1~1954@ (Add (Mul (Mul (Mul (Sub c6~54@ c6~54@) (Sub d6~56@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@))) (Mul b6~52@ d6~56@)) (Add (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Add a6~50@ 67)) (Mul d6~56@ c6~54@)) (Mul b6~52@ d6~56@)) (Mul (Mul (Add a6~50@ c6~54@) (Mul a6~50@ c6~54@)) (Add (Mul a6~50@ c6~54@) (Mul d6~56@ 79)))))) (and (=> (= tmp%8@ (Mul (Mul c6~54@ a6~50@) (Add a6~50@ 67))) (=> (= tmp%9@ (Mul d6~56@ c6~54@)) (=> (= tmp%10@ (Mul b6~52@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~1825@ temp_6_1~1954@)))))) (=> (= temp_6_0~1825@ temp_6_1~1954@) (=> (= temp_7_0~2133@ (Mul (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ c7~62@) (Mul 11 a7~58@))) (Mul (Sub (Add a7~58@ b7~60@) a7~58@) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ c7~62@)))) (Add a7~58@ (Mul (Mul (Add 62 c7~62@) c7~62@) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@)))))) (=> (= temp_7_1~2250@ (Mul (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ c7~62@) (Mul 11 a7~58@))) (Mul (Sub (Add a7~58@ b7~60@) a7~58@) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ c7~62@)))) (Add a7~58@ (Mul (Mul (Add 62 c7~62@) c7~62@) (Mul (Mul (Mul d7~64@ b7~60@) d7~64@) a7~58@))))) (and (=> (= tmp%11@ (Mul d7~64@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ d7~64@ a7~58@) (=> %%location_label%%7 (= temp_7_0~2133@ temp_7_1~2250@)))) (=> (= temp_7_0~2133@ temp_7_1~2250@) (=> (= temp_8_0~2429@ (Mul (Add (Mul (Mul (Mul 37 a8~66@) (Mul d8~72@ a8~66@)) (Sub a8~66@ (Mul c8~70@ b8~68@))) (Mul (Add (Mul 4 c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ b8~68@) (Sub a8~66@ d8~72@)))) (Mul (Mul (Mul d8~72@ (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul c8~70@ a8~66@) (Add c8~70@ d8~72@)) (Add (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)))))) (=> (= temp_8_1~2590@ (Mul (Add (Mul (Mul (Mul 37 a8~66@) (Mul d8~72@ a8~66@)) (Sub a8~66@ (Mul c8~70@ b8~68@))) (Add (Mul (Mul 4 c8~70@) (Mul (Mul b8~68@ b8~68@) (Sub a8~66@ d8~72@))) (Mul (Mul c8~70@ b8~68@) (Mul (Mul b8~68@ b8~68@) (Sub a8~66@ d8~72@))))) (Mul (Mul (Mul d8~72@ (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul c8~70@ a8~66@) (Add c8~70@ d8~72@)) (Add (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)))))) (and (=> (= tmp%12@ (Mul 4 c8~70@)) (=> (= tmp%13@ (Mul c8~70@ b8~68@)) (=> (= tmp%14@ (Mul (Mul b8~68@ b8~68@) (Sub a8~66@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%8 (= temp_8_0~2429@ temp_8_1~2590@)))))) (=> (= temp_8_0~2429@ temp_8_1~2590@) (=> (= temp_9_0~2725@ (Mul (Mul a9~74@ (Add c9~78@ (Mul d9~80@ (Mul a9~74@ b9~76@)))) (Mul (Mul c9~78@ (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ c9~78@))) (Sub (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ c9~78@)))))) (=> (= temp_9_1~2798@ (Mul (Mul (Mul c9~78@ (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ c9~78@))) (Sub (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ c9~78@)))) (Mul a9~74@ (Add c9~78@ (Mul d9~80@ (Mul a9~74@ b9~76@)))))) (and (=> (= tmp%15@ (Mul a9~74@ (Add c9~78@ (Mul d9~80@ (Mul a9~74@ b9~76@))))) (=> (= tmp%16@ (Mul (Mul c9~78@ (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ c9~78@))) (Sub (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ c9~78@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%9 (= temp_9_0~2725@ temp_9_1~2798@))))) (=> (= temp_9_0~2725@ temp_9_1~2798@) (=> (= temp_10_0~2947@ (Mul d10~88@ (Mul (Mul (Add (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Add (Mul d10~88@ d10~88@) (Mul a10~82@ c10~86@)) b10~84@)))) (=> (= temp_10_1~3004@ (Mul d10~88@ (Mul (Mul (Add (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Add (Mul d10~88@ d10~88@) (Mul a10~82@ c10~86@)) b10~84@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d10~88@ d10~88@) (=> %%location_label%%10 (= temp_10_0~2947@ temp_10_1~3004@))) (=> (= temp_10_0~2947@ temp_10_1~3004@) (=> (= temp_11_0~3157@ (Mul (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ a11~90@))) (Mul (Sub (Sub b11~92@ c11~94@) (Sub c11~94@ a11~90@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ b11~92@)))) (Mul (Mul (Mul (Mul b11~92@ b11~92@) a11~90@) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ a11~90@))) (Mul (Mul (Add d11~96@ a11~90@) (Mul b11~92@ c11~94@)) (Mul (Sub a11~90@ c11~94@) (Mul d11~96@ d11~96@)))))) (=> (= temp_11_1~3282@ (Mul (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ a11~90@))) (Mul (Sub (Sub b11~92@ c11~94@) (Sub c11~94@ a11~90@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ b11~92@)))) (Mul (Mul (Mul b11~92@ (Mul b11~92@ a11~90@)) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ a11~90@))) (Mul (Mul (Add d11~96@ a11~90@) (Mul b11~92@ c11~94@)) (Mul (Sub a11~90@ c11~94@) (Mul d11~96@ d11~96@)))))) (=> (ens%main!nl_basics.lemma_mul_is_associative. b11~92@ b11~92@ a11~90@) (=> %%location_label%%11 (= temp_11_0~3157@ temp_11_1~3282@))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
