...
(declare-const temp_3_0~1004@ Int)
(declare-const temp_3_1~1113@ Int)
(declare-const temp_4_0~1209@ Int)
(declare-const temp_4_1~1290@ Int)
(declare-const temp_5_0~1362@ Int)
(declare-const temp_5_1~1419@ Int)
(declare-const temp_6_0~1563@ Int)
(declare-const temp_6_1~1692@ Int)
(declare-const temp_7_0~1824@ Int)
(declare-const temp_7_1~1941@ Int)
(declare-const temp_8_0~2101@ Int)
(declare-const temp_8_1~2262@ Int)
(declare-const temp_9_0~2350@ Int)
(declare-const temp_9_1~2423@ Int)
(declare-const temp_10_0~2495@ Int)
(declare-const temp_10_1~2552@ Int)
(declare-const temp_11_0~2692@ Int)
(declare-const temp_11_1~2817@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~257@ (Add (Mul (Mul a0~2@ (Mul (Mul d0~8@ c0~6@) b0~4@)) (Mul (Sub (Mul c0~6@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@)))) (Add (Mul (Mul (Add a0~2@ c0~6@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ a0~2@) d0~8@)) (Mul b0~4@ (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ c0~6@)))))) (=> (= temp_0_1~354@ (Add (Mul (Mul a0~2@ (Mul (Mul d0~8@ c0~6@) b0~4@)) (Mul (Sub (Mul c0~6@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@)))) (Add (Mul (Mul (Add a0~2@ c0~6@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ a0~2@) d0~8@)) (Mul b0~4@ (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ a0~2@)))))) (=> (= tmp%1@ (= temp_0_0~257@ temp_0_1~354@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~498@ (Mul (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Add c1~14@ a1~10@)) (Mul (Add d1~16@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Sub (Mul b1~12@ 67) (Mul d1~16@ d1~16@)) b1~12@)) (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@)))))) (=> (= temp_1_1~627@ (Mul (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Add c1~14@ a1~10@)) (Mul (Add d1~16@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Sub (Mul b1~12@ 67) (Mul d1~16@ d1~16@)) b1~12@)) (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@)))))) (=> (= tmp%2@ (= temp_1_0~498@ temp_1_1~627@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~759@ (Mul (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Sub b2~20@ 36) (Mul b2~20@ c2~22@))) (Mul c2~22@ (Add (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)))) (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Sub d2~24@ a2~18@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ a2~18@)) b2~20@)))) (=> (= temp_2_1~876@ (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Sub b2~20@ 36) (Mul b2~20@ c2~22@))) (Mul (Mul c2~22@ (Add (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Sub d2~24@ a2~18@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ a2~18@)) b2~20@))))) (=> (= tmp%3@ (= temp_2_0~759@ temp_2_1~876@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1004@ (Mul (Mul (Mul a3~26@ (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ d3~32@)) (Mul b3~28@ (Mul a3~26@ a3~26@)))) (Mul (Add (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ d3~32@))) (Add (Sub (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@)) (Sub (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@)))))) (=> (= temp_3_1~1113@ (Mul (Mul (Mul a3~26@ (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ d3~32@)) (Mul b3~28@ (Mul a3~26@ a3~26@)))) (Mul (Add (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ d3~32@))) (Add (Sub (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@)) (Mul b3~28@ (Sub b3~28@ c3~30@)))))) (=> (= tmp%4@ (= temp_3_0~1004@ temp_3_1~1113@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1209@ (Mul (Mul (Mul (Mul (Add b4~36@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Add d4~40@ 17) (Add d4~40@ b4~36@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ a4~34@)))) c4~38@)) (=> (= temp_4_1~1290@ (Mul (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ a4~34@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Add d4~40@ 17) (Add d4~40@ b4~36@)))) c4~38@)) (=> (= tmp%5@ (= temp_4_0~1209@ temp_4_1~1290@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1362@ (Sub b5~44@ (Mul (Sub (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ c5~46@)) d5~48@) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ a5~42@)))))) (=> (= temp_5_1~1419@ (Sub b5~44@ (Mul (Sub (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ c5~46@)) d5~48@) (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ a5~42@)))))) (=> (= tmp%6@ (= temp_5_0~1362@ temp_5_1~1419@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1563@ (Add (Mul (Mul (Mul (Sub c6~54@ c6~54@) (Sub d6~56@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@))) (Mul b6~52@ d6~56@)) (Add (Mul (Mul (Mul c6~54@ a6~50@) (Add a6~50@ 67)) (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ d6~56@))) (Mul (Mul (Add a6~50@ c6~54@) (Mul a6~50@ c6~54@)) (Add (Mul a6~50@ c6~54@) (Mul d6~56@ 79)))))) (=> (= temp_6_1~1692@ (Add (Mul (Mul (Mul (Sub c6~54@ c6~54@) (Sub d6~56@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@))) (Mul b6~52@ d6~56@)) (Add (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Add a6~50@ 67)) (Mul d6~56@ c6~54@)) (Mul b6~52@ d6~56@)) (Mul (Mul (Add a6~50@ c6~54@) (Mul a6~50@ c6~54@)) (Add (Mul a6~50@ c6~54@) (Mul d6~56@ 79)))))) (=> (= tmp%7@ (= temp_6_0~1563@ temp_6_1~1692@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1824@ (Mul (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ c7~62@) (Mul 11 a7~58@))) (Mul (Sub (Add a7~58@ b7~60@) a7~58@) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ c7~62@)))) (Add a7~58@ (Mul (Mul (Add 62 c7~62@) c7~62@) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@)))))) (=> (= temp_7_1~1941@ (Mul (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ c7~62@) (Mul 11 a7~58@))) (Mul (Sub (Add a7~58@ b7~60@) a7~58@) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ c7~62@)))) (Add a7~58@ (Mul (Mul (Add 62 c7~62@) c7~62@) (Mul (Mul (Mul d7~64@ b7~60@) d7~64@) a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1824@ temp_7_1~1941@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2101@ (Mul (Add (Mul (Mul (Mul 37 a8~66@) (Mul d8~72@ a8~66@)) (Sub a8~66@ (Mul c8~70@ b8~68@))) (Mul (Add (Mul 4 c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ b8~68@) (Sub a8~66@ d8~72@)))) (Mul (Mul (Mul d8~72@ (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul c8~70@ a8~66@) (Add c8~70@ d8~72@)) (Add (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)))))) (=> (= temp_8_1~2262@ (Mul (Add (Mul (Mul (Mul 37 a8~66@) (Mul d8~72@ a8~66@)) (Sub a8~66@ (Mul c8~70@ b8~68@))) (Add (Mul (Mul 4 c8~70@) (Mul (Mul b8~68@ b8~68@) (Sub a8~66@ d8~72@))) (Mul (Mul c8~70@ b8~68@) (Mul (Mul b8~68@ b8~68@) (Sub a8~66@ d8~72@))))) (Mul (Mul (Mul d8~72@ (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul c8~70@ a8~66@) (Add c8~70@ d8~72@)) (Add (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)))))) (=> (= tmp%9@ (= temp_8_0~2101@ temp_8_1~2262@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2350@ (Mul (Mul a9~74@ (Add c9~78@ (Mul d9~80@ (Mul a9~74@ b9~76@)))) (Mul (Mul c9~78@ (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ c9~78@))) (Sub (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ c9~78@)))))) (=> (= temp_9_1~2423@ (Mul (Mul (Mul c9~78@ (Mul (Mul d9~80@ c9~78@) (Mul b9~76@ c9~78@))) (Sub (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ c9~78@)))) (Mul a9~74@ (Add c9~78@ (Mul d9~80@ (Mul a9~74@ b9~76@)))))) (=> (= tmp%10@ (= temp_9_0~2350@ temp_9_1~2423@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~2495@ (Mul d10~88@ (Mul (Mul (Add (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Add (Mul d10~88@ d10~88@) (Mul a10~82@ c10~86@)) b10~84@)))) (=> (= temp_10_1~2552@ (Mul d10~88@ (Mul (Mul (Add (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul (Mul d10~88@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Add (Mul d10~88@ d10~88@) (Mul a10~82@ c10~86@)) b10~84@)))) (=> (= tmp%11@ (= temp_10_0~2495@ temp_10_1~2552@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~2692@ (Mul (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ a11~90@))) (Mul (Sub (Sub b11~92@ c11~94@) (Sub c11~94@ a11~90@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ b11~92@)))) (Mul (Mul (Mul (Mul b11~92@ b11~92@) a11~90@) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ a11~90@))) (Mul (Mul (Add d11~96@ a11~90@) (Mul b11~92@ c11~94@)) (Mul (Sub a11~90@ c11~94@) (Mul d11~96@ d11~96@)))))) (=> (= temp_11_1~2817@ (Mul (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul c11~94@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Mul b11~92@ a11~90@))) (Mul (Sub (Sub b11~92@ c11~94@) (Sub c11~94@ a11~90@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ b11~92@)))) (Mul (Mul (Mul b11~92@ (Mul b11~92@ a11~90@)) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ a11~90@))) (Mul (Mul (Add d11~96@ a11~90@) (Mul b11~92@ c11~94@)) (Mul (Sub a11~90@ c11~94@) (Mul d11~96@ d11~96@)))))) (=> (= tmp%12@ (= temp_11_0~2692@ temp_11_1~2817@)) (=> %%location_label%%11 tmp%12@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
