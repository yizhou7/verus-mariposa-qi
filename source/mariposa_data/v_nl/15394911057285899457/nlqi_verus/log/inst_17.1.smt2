...
(set-info :comment ";; mariposa_data/v_nl//15394911057285899457/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_8_0~1677@ Int)
(declare-const temp_8_1~1730@ Int)
(declare-const temp_9_0~1831@ Int)
(declare-const temp_9_1~1912@ Int)
(declare-const temp_10_0~2011@ Int)
(declare-const temp_10_1~2084@ Int)
...
(declare-const temp_15_0~2843@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Add c0~6@ c0~6@) b0~4@)) (Mul (Add (Mul c0~6@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Add d0~8@ b0~4@) d0~8@)))) (=> (= temp_0_1~354@ (Mul (Mul (Mul (Add c0~6@ c0~6@) b0~4@) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ a0~2@))) (Mul (Add (Mul c0~6@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Add d0~8@ b0~4@) d0~8@)))) (and (=> (= tmp%1@ (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ a0~2@))) (=> (= tmp%2@ (Mul (Add c0~6@ c0~6@) b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~354@))))) (=> (= temp_0_0~297@ temp_0_1~354@) (=> (= temp_1_0~467@ (Mul (Sub (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Add b1~12@ c1~14@) (Mul b1~12@ a1~10@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)) (Sub (Mul a1~10@ c1~14@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~540@ (Mul (Sub (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@)) (Add (Mul b1~12@ (Mul b1~12@ a1~10@)) (Mul c1~14@ (Mul b1~12@ a1~10@)))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@)) (Sub (Mul a1~10@ c1~14@) (Mul c1~14@ c1~14@))))) (and (=> (= tmp%3@ (Mul b1~12@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b1~12@ c1~14@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~467@ temp_1_1~540@)))) (=> (= temp_1_0~467@ temp_1_1~540@) (=> (= temp_2_0~647@ (Mul (Mul (Mul (Mul c2~22@ c2~22@) a2~18@) (Mul (Sub b2~20@ a2~18@) (Mul d2~24@ c2~22@))) (Sub (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ 73)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~720@ (Mul (Mul (Mul (Mul c2~22@ c2~22@) a2~18@) (Mul (Mul (Sub b2~20@ a2~18@) d2~24@) c2~22@)) (Sub (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ 73)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ b2~20@))))) (and (=> (= tmp%4@ (Sub b2~20@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ d2~24@ c2~22@) (=> %%location_label%%2 (= temp_2_0~647@ temp_2_1~720@)))) (=> (= temp_2_0~647@ temp_2_1~720@) (=> (= temp_3_0~807@ (Mul (Mul (Mul (Add b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ b3~28@))) (Mul (Mul (Add c3~30@ b3~28@) (Mul a3~26@ b3~28@)) b3~28@))) (=> (= temp_3_1~860@ (Mul (Mul (Mul (Add b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ b3~28@))) (Mul b3~28@ (Mul (Add c3~30@ b3~28@) (Mul a3~26@ b3~28@))))) (and (=> (= tmp%5@ (Mul (Add c3~30@ b3~28@) (Mul a3~26@ b3~28@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ b3~28@) (=> %%location_label%%3 (= temp_3_0~807@ temp_3_1~860@)))) (=> (= temp_3_0~807@ temp_3_1~860@) (=> (= temp_4_0~933@ (Mul (Mul (Add (Mul a4~34@ d4~40@) (Sub a4~34@ a4~34@)) (Mul c4~38@ (Mul d4~40@ b4~36@))) d4~40@)) (=> (= temp_4_1~966@ (Mul (Mul (Add (Mul a4~34@ d4~40@) (Sub a4~34@ a4~34@)) (Mul c4~38@ (Mul b4~36@ d4~40@))) d4~40@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ b4~36@) (=> %%location_label%%4 (= temp_4_0~933@ temp_4_1~966@))) (=> (= temp_4_0~933@ temp_4_1~966@) (=> (= temp_5_0~1071@ (Mul (Sub (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Add d5~48@ a5~42@))) (Mul (Mul (Sub d5~48@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul 41 b5~44@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1148@ (Mul (Sub (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Add d5~48@ a5~42@))) (Mul (Mul (Sub d5~48@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul 41 b5~44@) (Mul a5~42@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1071@ temp_5_1~1148@))) (=> (= temp_5_0~1071@ temp_5_1~1148@) (=> (= temp_6_0~1261@ (Mul (Mul (Mul (Sub c6~54@ b6~52@) (Add c6~54@ 0)) (Mul 68 (Add b6~52@ c6~54@))) (Sub (Sub (Mul a6~50@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@))))) (=> (= temp_6_1~1346@ (Mul (Sub (Sub (Mul a6~50@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@))) (Mul (Mul (Sub c6~54@ b6~52@) (Add c6~54@ 0)) (Mul 68 (Add b6~52@ c6~54@))))) (and (=> (= tmp%6@ (Mul (Mul (Sub c6~54@ b6~52@) (Add c6~54@ 0)) (Mul 68 (Add b6~52@ c6~54@)))) (=> (= tmp%7@ (Sub (Sub (Mul a6~50@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%6 (= temp_6_0~1261@ temp_6_1~1346@))))) (=> (= temp_6_0~1261@ temp_6_1~1346@) (=> (= temp_7_0~1511@ (Mul (Mul (Sub (Mul c7~62@ b7~60@) (Add c7~62@ a7~58@)) (Add (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Sub b7~60@ a7~58@)) (Mul (Mul b7~60@ b7~60@) d7~64@)))) (=> (= temp_7_1~1572@ (Mul (Mul (Add (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)) (Sub (Mul c7~62@ b7~60@) (Add c7~62@ a7~58@))) (Mul (Mul (Mul a7~58@ d7~64@) (Sub b7~60@ a7~58@)) (Mul (Mul b7~60@ b7~60@) d7~64@)))) (and (=> (= tmp%8@ (Sub (Mul c7~62@ b7~60@) (Add c7~62@ a7~58@))) (=> (= tmp%9@ (Add (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%7 (= temp_7_0~1511@ temp_7_1~1572@))))) (=> (= temp_7_0~1511@ temp_7_1~1572@) (=> (= temp_8_0~1677@ (Mul (Add (Mul b8~68@ (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ b8~68@))) (Mul (Add (Add a8~66@ d8~72@) (Mul c8~70@ d8~72@)) (Mul c8~70@ b8~68@)))) (=> (= temp_8_1~1730@ (Mul (Add (Mul b8~68@ (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ b8~68@))) (Mul (Add (Add a8~66@ d8~72@) (Mul c8~70@ d8~72@)) (Mul c8~70@ b8~68@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ a8~66@) (=> %%location_label%%8 (= temp_8_0~1677@ temp_8_1~1730@))) (=> (= temp_8_0~1677@ temp_8_1~1730@) (=> (= temp_9_0~1831@ (Mul (Mul (Sub a9~74@ (Mul a9~74@ a9~74@)) (Mul (Mul d9~80@ b9~76@) (Add b9~76@ a9~74@))) (Mul (Mul (Mul d9~80@ b9~76@) (Add d9~80@ b9~76@)) (Add (Mul 70 d9~80@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1912@ (Mul (Mul (Sub a9~74@ (Mul a9~74@ a9~74@)) (Add (Mul (Mul d9~80@ b9~76@) b9~76@) (Mul (Mul d9~80@ b9~76@) a9~74@))) (Mul (Mul (Mul d9~80@ b9~76@) (Add d9~80@ b9~76@)) (Add (Mul 70 d9~80@) (Mul c9~78@ d9~80@))))) (and (=> (= tmp%10@ (Mul d9~80@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%10@ b9~76@ a9~74@) (=> %%location_label%%9 (= temp_9_0~1831@ temp_9_1~1912@)))) (=> (= temp_9_0~1831@ temp_9_1~1912@) (=> (= temp_10_0~2011@ (Mul (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@)) (Mul (Mul b10~84@ b10~84@) (Mul a10~82@ a10~82@))) (Add (Mul (Mul c10~86@ b10~84@) (Add a10~82@ b10~84@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ c10~86@))))) (=> (= temp_10_1~2084@ (Mul (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ b10~84@)) (Mul (Mul b10~84@ b10~84@) (Mul a10~82@ a10~82@))) (Add (Add (Mul (Mul c10~86@ b10~84@) a10~82@) (Mul (Mul c10~86@ b10~84@) b10~84@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ c10~86@))))) (and (=> (= tmp%11@ (Mul c10~86@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ a10~82@ b10~84@) (=> %%location_label%%10 (= temp_10_0~2011@ temp_10_1~2084@)))) (=> (= temp_10_0~2011@ temp_10_1~2084@) (=> (= temp_11_0~2171@ (Sub (Mul (Mul (Mul a11~90@ d11~96@) (Add d11~96@ d11~96@)) (Add (Mul d11~96@ a11~90@) (Mul c11~94@ a11~90@))) (Mul c11~94@ (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~2224@ (Sub (Mul (Mul (Mul d11~96@ a11~90@) (Add d11~96@ d11~96@)) (Add (Mul d11~96@ a11~90@) (Mul c11~94@ a11~90@))) (Mul c11~94@ (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a11~90@ d11~96@) (=> %%location_label%%11 (= temp_11_0~2171@ temp_11_1~2224@))) (=> (= temp_11_0~2171@ temp_11_1~2224@) (=> (= temp_12_0~2329@ (Mul (Sub (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ 64)) (Mul (Mul a12~98@ d12~104@) (Mul b12~100@ b12~100@))) (Add (Mul (Sub b12~100@ a12~98@) (Mul c12~102@ b12~100@)) (Mul (Mul b12~100@ d12~104@) (Mul a12~98@ a12~98@))))) (=> (= temp_12_1~2406@ (Mul (Sub (Mul (Mul d12~104@ d12~104@) (Mul a12~98@ 64)) (Mul (Mul a12~98@ d12~104@) (Mul b12~100@ b12~100@))) (Add (Mul (Sub b12~100@ a12~98@) (Mul c12~102@ b12~100@)) (Mul (Mul d12~104@ b12~100@) (Mul a12~98@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ d12~104@) (=> %%location_label%%12 (= temp_12_0~2329@ temp_12_1~2406@))) (=> (= temp_12_0~2329@ temp_12_1~2406@) (=> (= temp_13_0~2507@ (Mul (Add (Mul (Mul a13~106@ c13~110@) (Mul b13~108@ d13~112@)) (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ a13~106@))) (Mul (Mul (Mul b13~108@ 66) (Mul b13~108@ c13~110@)) (Sub (Mul b13~108@ a13~106@) d13~112@)))) (=> (= temp_13_1~2580@ (Mul (Add (Mul (Mul b13~108@ d13~112@) (Mul a13~106@ c13~110@)) (Mul (Mul c13~110@ b13~108@) (Mul c13~110@ a13~106@))) (Mul (Mul (Mul b13~108@ 66) (Mul b13~108@ c13~110@)) (Sub (Mul b13~108@ a13~106@) d13~112@)))) (and (=> (= tmp%12@ (Mul a13~106@ c13~110@)) (=> (= tmp%13@ (Mul b13~108@ d13~112@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%13 (= temp_13_0~2507@ temp_13_1~2580@))))) (=> (= temp_13_0~2507@ temp_13_1~2580@) (=> (= temp_14_0~2681@ (Mul (Sub (Sub (Mul b14~116@ b14~116@) (Mul b14~116@ c14~118@)) (Sub (Mul c14~118@ c14~118@) (Mul c14~118@ b14~116@))) (Mul (Sub (Mul c14~118@ d14~120@) (Mul d14~120@ d14~120@)) (Mul (Mul c14~118@ d14~120@) (Sub b14~116@ c14~118@))))) (=> (= temp_14_1~2746@ (Mul (Sub (Sub (Mul b14~116@ b14~116@) (Mul b14~116@ c14~118@)) (Sub (Mul c14~118@ c14~118@) (Mul c14~118@ b14~116@))) (Mul (Sub (Mul c14~118@ d14~120@) (Mul d14~120@ d14~120@)) (Mul (Sub b14~116@ c14~118@) (Mul c14~118@ d14~120@))))) (and (=> (= tmp%14@ (Mul c14~118@ d14~120@)) (=> (= tmp%15@ (Sub b14~116@ c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%14 (= temp_14_0~2681@ temp_14_1~2746@))))) (=> (= temp_14_0~2681@ temp_14_1~2746@) (=> (= temp_15_0~2843@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul a15~122@ d15~128@)) (Mul (Add d15~128@ a15~122@) (Add b15~124@ b15~124@))) (Sub (Mul (Mul c15~126@ d15~128@) d15~128@) (Mul (Mul d15~128@ d15~128@) (Sub d15~128@ a15~122@))))) (=> (= temp_15_1~2912@ (Mul (Mul (Mul (Mul a15~122@ c15~126@) (Mul a15~122@ d15~128@)) (Add (Mul (Add d15~128@ a15~122@) b15~124@) (Mul (Add d15~128@ a15~122@) b15~124@))) (Sub (Mul (Mul c15~126@ d15~128@) d15~128@) (Mul (Mul d15~128@ d15~128@) (Sub d15~128@ a15~122@))))) (and (=> (= tmp%16@ (Add d15~128@ a15~122@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%16@ b15~124@ b15~124@) (=> %%location_label%%15 (= temp_15_0~2843@ temp_15_1~2912@)))) (=> (= temp_15_0~2843@ temp_15_1~2912@) (=> (= temp_16_0~2983@ (Mul (Mul (Mul (Mul b16~132@ b16~132@) (Mul d16~136@ a16~130@)) (Mul (Add d16~136@ c16~134@) (Mul b16~132@ d16~136@))) b16~132@)) (=> (= temp_16_1~3020@ (Mul (Mul (Mul (Mul b16~132@ b16~132@) (Mul d16~136@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Add d16~136@ c16~134@))) b16~132@)) (=> (= tmp%17@ (Add d16~136@ c16~134@)) (=> (= tmp%18@ (Mul b16~132@ d16~136@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%16 (= temp_16_0~2983@ temp_16_1~3020@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
