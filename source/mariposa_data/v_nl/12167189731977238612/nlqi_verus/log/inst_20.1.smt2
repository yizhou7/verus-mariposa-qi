...
(set-info :comment ";; mariposa_data/v_nl//12167189731977238612/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_12_0~2243@ Int)
(declare-const temp_12_1~2296@ Int)
(declare-const temp_13_0~2387@ Int)
(declare-const temp_13_1~2440@ Int)
(declare-const temp_14_0~2545@ Int)
(declare-const temp_14_1~2622@ Int)
(declare-const temp_15_0~2765@ Int)
(declare-const temp_15_1~2814@ Int)
(declare-const temp_16_0~2933@ Int)
(declare-const temp_16_1~2990@ Int)
(declare-const temp_17_0~3131@ Int)
(declare-const temp_17_1~3204@ Int)
(declare-const temp_18_0~3303@ Int)
(declare-const temp_18_1~3368@ Int)
(declare-const temp_19_0~3521@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ 40)) (Mul (Mul c0~6@ d0~8@) (Sub d0~8@ a0~2@))) (Mul (Sub (Mul d0~8@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Add a0~2@ a0~2@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ 40)) (Mul (Mul c0~6@ d0~8@) (Sub d0~8@ a0~2@))) (Mul (Mul (Add a0~2@ a0~2@) (Mul d0~8@ a0~2@)) (Sub (Mul d0~8@ a0~2@) (Mul b0~4@ a0~2@))))) (and (=> (= tmp%1@ (Sub (Mul d0~8@ a0~2@) (Mul b0~4@ a0~2@))) (=> (= tmp%2@ (Mul (Add a0~2@ a0~2@) (Mul d0~8@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~511@ (Mul (Mul (Add (Add b1~12@ b1~12@) (Mul a1~10@ b1~12@)) c1~14@) (Mul (Mul (Mul d1~16@ d1~16@) (Mul 64 a1~10@)) (Mul (Sub c1~14@ c1~14@) (Add c1~14@ d1~16@))))) (=> (= temp_1_1~576@ (Mul (Mul (Add (Add b1~12@ b1~12@) (Mul a1~10@ b1~12@)) c1~14@) (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul 64 a1~10@)) (Sub c1~14@ c1~14@)) (Add c1~14@ d1~16@)))) (and (=> (= tmp%3@ (Mul (Mul d1~16@ d1~16@) (Mul 64 a1~10@))) (=> (= tmp%4@ (Sub c1~14@ c1~14@)) (=> (= tmp%5@ (Add c1~14@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~511@ temp_1_1~576@)))))) (=> (= temp_1_0~511@ temp_1_1~576@) (=> (= temp_2_0~703@ (Add (Mul (Mul (Sub b2~20@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@))) (Mul (Add (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~764@ (Add (Mul (Mul (Sub b2~20@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@))) (Mul (Mul d2~24@ (Add a2~18@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d2~24@ a2~18@ c2~22@) (=> %%location_label%%2 (= temp_2_0~703@ temp_2_1~764@))) (=> (= temp_2_0~703@ temp_2_1~764@) (=> (= temp_3_0~867@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Add c3~30@ d3~32@)) (Mul (Mul 98 b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ b3~28@) d3~32@)))) (=> (= temp_3_1~940@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Add c3~30@ d3~32@)) (Mul (Mul 98 b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ d3~32@)) (Mul c3~30@ b3~28@)) d3~32@))) (and (=> (= tmp%6@ (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ d3~32@))) (=> (= tmp%7@ (Mul c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ d3~32@) (=> %%location_label%%3 (= temp_3_0~867@ temp_3_1~940@))))) (=> (= temp_3_0~867@ temp_3_1~940@) (=> (= temp_4_0~1023@ (Mul d4~40@ (Mul (Add (Mul a4~34@ b4~36@) (Mul a4~34@ c4~38@)) (Sub (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~1076@ (Mul d4~40@ (Add (Mul (Mul a4~34@ b4~36@) (Sub (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@))) (Mul (Mul a4~34@ c4~38@) (Sub (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@)))))) (and (=> (= tmp%8@ (Mul a4~34@ b4~36@)) (=> (= tmp%9@ (Mul a4~34@ c4~38@)) (=> (= tmp%10@ (Sub (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%4 (= temp_4_0~1023@ temp_4_1~1076@)))))) (=> (= temp_4_0~1023@ temp_4_1~1076@) (=> (= temp_5_0~1179@ (Add (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ b5~44@))) (Add c5~46@ (Add (Mul c5~46@ d5~48@) (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1232@ (Add (Mul (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ b5~44@))) (Add c5~46@ (Add (Mul c5~46@ d5~48@) (Mul c5~46@ d5~48@))))) (and (=> (= tmp%11@ (Mul a5~42@ c5~46@)) (=> (= tmp%12@ (Mul b5~44@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%5 (= temp_5_0~1179@ temp_5_1~1232@))))) (=> (= temp_5_0~1179@ temp_5_1~1232@) (=> (= temp_6_0~1305@ (Add (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ d6~56@)) (Add (Mul c6~54@ c6~54@) (Mul b6~52@ c6~54@))) d6~56@)) (=> (= temp_6_1~1342@ (Add (Mul (Add (Mul c6~54@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ d6~56@))) d6~56@)) (and (=> (= tmp%13@ (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ d6~56@))) (=> (= tmp%14@ (Add (Mul c6~54@ c6~54@) (Mul b6~52@ c6~54@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%6 (= temp_6_0~1305@ temp_6_1~1342@))))) (=> (= temp_6_0~1305@ temp_6_1~1342@) (=> (= temp_7_0~1431@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ d7~64@)) (Sub (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))) d7~64@)) (=> (= temp_7_1~1468@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ b7~60@)) (Sub (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@))) d7~64@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1431@ temp_7_1~1468@))) (=> (= temp_7_0~1431@ temp_7_1~1468@) (=> (= temp_8_0~1573@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul c8~70@ 60) (Mul a8~66@ d8~72@))) (Add (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Add d8~72@ b8~68@))))) (=> (= temp_8_1~1650@ (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul c8~70@ 60) (Mul a8~66@ d8~72@))) (Add (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ d8~72@)) (Mul (Add d8~72@ b8~68@) (Mul a8~66@ d8~72@))))) (and (=> (= tmp%15@ (Mul a8~66@ d8~72@)) (=> (= tmp%16@ (Add d8~72@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%8 (= temp_8_0~1573@ temp_8_1~1650@))))) (=> (= temp_8_0~1573@ temp_8_1~1650@) (=> (= temp_9_0~1751@ (Mul (Mul (Mul (Sub a9~74@ c9~78@) (Add b9~76@ a9~74@)) (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ b9~76@))) (Mul (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ a9~74@)) (Mul (Mul d9~80@ a9~74@) (Sub a9~74@ b9~76@))))) (=> (= temp_9_1~1816@ (Mul (Mul (Mul (Sub a9~74@ c9~78@) (Add b9~76@ a9~74@)) (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ b9~76@))) (Mul (Mul (Mul d9~80@ a9~74@) (Sub a9~74@ b9~76@)) (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ a9~74@))))) (and (=> (= tmp%17@ (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ a9~74@))) (=> (= tmp%18@ (Mul (Mul d9~80@ a9~74@) (Sub a9~74@ b9~76@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%9 (= temp_9_0~1751@ temp_9_1~1816@))))) (=> (= temp_9_0~1751@ temp_9_1~1816@) (=> (= temp_10_0~1933@ (Mul (Mul (Mul (Mul d10~88@ c10~86@) (Sub d10~88@ d10~88@)) (Add (Mul a10~82@ c10~86@) (Mul a10~82@ a10~82@))) (Mul (Mul (Mul c10~86@ c10~86@) (Mul a10~82@ d10~88@)) (Mul (Mul a10~82@ b10~84@) (Add a10~82@ d10~88@))))) (=> (= temp_10_1~1998@ (Mul (Mul (Mul (Mul d10~88@ c10~86@) (Sub d10~88@ d10~88@)) (Add (Mul a10~82@ c10~86@) (Mul a10~82@ a10~82@))) (Mul (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ b10~84@) (Add a10~82@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a10~82@ d10~88@) (=> %%location_label%%10 (= temp_10_0~1933@ temp_10_1~1998@))) (=> (= temp_10_0~1933@ temp_10_1~1998@) (=> (= temp_11_0~2091@ (Mul (Mul (Mul (Add c11~94@ c11~94@) (Sub b11~92@ c11~94@)) (Mul (Add b11~92@ d11~96@) (Mul a11~90@ a11~90@))) (Mul (Sub (Sub d11~96@ c11~94@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@))))) (=> (= temp_11_1~2156@ (Mul (Mul (Mul (Add c11~94@ c11~94@) (Sub b11~92@ c11~94@)) (Mul (Mul (Add b11~92@ d11~96@) a11~90@) a11~90@)) (Mul (Sub (Sub d11~96@ c11~94@) (Mul a11~90@ b11~92@)) (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@))))) (and (=> (= tmp%19@ (Add b11~92@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ a11~90@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2091@ temp_11_1~2156@)))) (=> (= temp_11_0~2091@ temp_11_1~2156@) (=> (= temp_12_0~2243@ (Sub (Mul (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ b12~100@))) (Mul (Mul (Mul b12~100@ c12~102@) (Add b12~100@ d12~104@)) c12~102@))) (=> (= temp_12_1~2296@ (Sub (Mul (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ b12~100@))) (Mul (Mul b12~100@ c12~102@) (Mul (Add b12~100@ d12~104@) c12~102@)))) (and (=> (= tmp%20@ (Mul b12~100@ c12~102@)) (=> (= tmp%21@ (Add b12~100@ d12~104@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ c12~102@) (=> %%location_label%%12 (= temp_12_0~2243@ temp_12_1~2296@))))) (=> (= temp_12_0~2243@ temp_12_1~2296@) (=> (= temp_13_0~2387@ (Mul (Mul (Mul (Sub b13~108@ d13~112@) (Mul c13~110@ c13~110@)) c13~110@) (Mul (Mul (Mul b13~108@ a13~106@) (Mul a13~106@ c13~110@)) (Mul (Mul c13~110@ b13~108@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2440@ (Mul (Mul (Mul (Sub b13~108@ d13~112@) (Mul c13~110@ c13~110@)) c13~110@) (Mul (Mul (Mul b13~108@ a13~106@) (Mul a13~106@ c13~110@)) (Mul (Mul c13~110@ b13~108@) (Mul b13~108@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d13~112@ b13~108@) (=> %%location_label%%13 (= temp_13_0~2387@ temp_13_1~2440@))) (=> (= temp_13_0~2387@ temp_13_1~2440@) (=> (= temp_14_0~2545@ (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Add a14~114@ d14~120@) (Mul b14~116@ c14~118@))) (Mul (Mul (Mul c14~118@ 96) (Mul a14~114@ b14~116@)) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ a14~114@))))) (=> (= temp_14_1~2622@ (Mul (Mul (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Add a14~114@ d14~120@) (Mul b14~116@ c14~118@))) (Mul (Mul c14~118@ 96) (Mul a14~114@ b14~116@))) (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ a14~114@)))) (and (=> (= tmp%22@ (Mul (Mul (Mul a14~114@ a14~114@) (Mul c14~118@ a14~114@)) (Mul (Add a14~114@ d14~120@) (Mul b14~116@ c14~118@)))) (=> (= tmp%23@ (Mul (Mul c14~118@ 96) (Mul a14~114@ b14~116@))) (=> (= tmp%24@ (Mul (Mul d14~120@ b14~116@) (Mul a14~114@ a14~114@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%22@ tmp%23@ tmp%24@) (=> %%location_label%%14 (= temp_14_0~2545@ temp_14_1~2622@)))))) (=> (= temp_14_0~2545@ temp_14_1~2622@) (=> (= temp_15_0~2765@ (Mul d15~128@ (Mul (Add (Add c15~126@ a15~122@) (Mul c15~126@ 90)) (Mul (Mul a15~122@ d15~128@) (Sub b15~124@ d15~128@))))) (=> (= temp_15_1~2814@ (Mul d15~128@ (Mul (Mul (Add (Add c15~126@ a15~122@) (Mul c15~126@ 90)) (Mul a15~122@ d15~128@)) (Sub b15~124@ d15~128@)))) (and (=> (= tmp%25@ (Add (Add c15~126@ a15~122@) (Mul c15~126@ 90))) (=> (= tmp%26@ (Mul a15~122@ d15~128@)) (=> (= tmp%27@ (Sub b15~124@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%15 (= temp_15_0~2765@ temp_15_1~2814@)))))) (=> (= temp_15_0~2765@ temp_15_1~2814@) (=> (= temp_16_0~2933@ (Mul (Mul (Mul c16~134@ (Mul a16~130@ d16~136@)) (Mul (Mul a16~130@ b16~132@) b16~132@)) (Add (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ c16~134@)) (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ d16~136@))))) (=> (= temp_16_1~2990@ (Mul (Add (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ c16~134@)) (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ d16~136@))) (Mul (Mul c16~134@ (Mul a16~130@ d16~136@)) (Mul (Mul a16~130@ b16~132@) b16~132@)))) (and (=> (= tmp%28@ (Mul (Mul c16~134@ (Mul a16~130@ d16~136@)) (Mul (Mul a16~130@ b16~132@) b16~132@))) (=> (= tmp%29@ (Add (Mul (Mul b16~132@ b16~132@) (Mul c16~134@ c16~134@)) (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ d16~136@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%28@ tmp%29@) (=> %%location_label%%16 (= temp_16_0~2933@ temp_16_1~2990@))))) (=> (= temp_16_0~2933@ temp_16_1~2990@) (=> (= temp_17_0~3131@ (Sub (Mul (Mul (Add d17~144@ b17~140@) (Add b17~140@ b17~140@)) (Mul (Add b17~140@ a17~138@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul b17~140@ b17~140@) (Mul a17~138@ d17~144@)) (Mul (Mul d17~144@ a17~138@) (Add b17~140@ a17~138@))))) (=> (= temp_17_1~3204@ (Sub (Mul (Add (Mul d17~144@ (Add b17~140@ b17~140@)) (Mul b17~140@ (Add b17~140@ b17~140@))) (Mul (Add b17~140@ a17~138@) (Mul b17~140@ c17~142@))) (Mul (Mul (Mul b17~140@ b17~140@) (Mul a17~138@ d17~144@)) (Mul (Mul d17~144@ a17~138@) (Add b17~140@ a17~138@))))) (and (=> (= tmp%30@ (Add b17~140@ b17~140@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d17~144@ b17~140@ tmp%30@) (=> %%location_label%%17 (= temp_17_0~3131@ temp_17_1~3204@)))) (=> (= temp_17_0~3131@ temp_17_1~3204@) (=> (= temp_18_0~3303@ (Mul (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ b18~148@)) (Mul (Mul d18~152@ a18~146@) (Mul d18~152@ a18~146@))) (Sub (Mul (Mul c18~150@ a18~146@) (Mul c18~150@ c18~150@)) (Add (Mul b18~148@ b18~148@) (Mul d18~152@ d18~152@))))) (=> (= temp_18_1~3368@ (Mul (Sub (Mul (Mul c18~150@ a18~146@) (Mul c18~150@ c18~150@)) (Add (Mul b18~148@ b18~148@) (Mul d18~152@ d18~152@))) (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ b18~148@)) (Mul (Mul d18~152@ a18~146@) (Mul d18~152@ a18~146@))))) (and (=> (= tmp%31@ (Mul (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ b18~148@)) (Mul (Mul d18~152@ a18~146@) (Mul d18~152@ a18~146@)))) (=> (= tmp%32@ (Sub (Mul (Mul c18~150@ a18~146@) (Mul c18~150@ c18~150@)) (Add (Mul b18~148@ b18~148@) (Mul d18~152@ d18~152@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%31@ tmp%32@) (=> %%location_label%%18 (= temp_18_0~3303@ temp_18_1~3368@))))) (=> (= temp_18_0~3303@ temp_18_1~3368@) (=> (= temp_19_0~3521@ (Mul (Mul (Mul (Mul a19~154@ a19~154@) (Mul a19~154@ 0)) (Mul (Mul a19~154@ a19~154@) (Mul a19~154@ d19~160@))) (Sub (Sub d19~160@ d19~160@) (Sub (Mul d19~160@ d19~160@) (Mul a19~154@ d19~160@))))) (=> (= temp_19_1~3590@ (Mul (Mul (Mul a19~154@ a19~154@) (Mul (Mul a19~154@ 0) (Mul (Mul a19~154@ a19~154@) (Mul a19~154@ d19~160@)))) (Sub (Sub d19~160@ d19~160@) (Sub (Mul d19~160@ d19~160@) (Mul a19~154@ d19~160@))))) (=> (= tmp%33@ (Mul a19~154@ a19~154@)) (=> (= tmp%34@ (Mul a19~154@ 0)) (=> (= tmp%35@ (Mul (Mul a19~154@ a19~154@) (Mul a19~154@ d19~160@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%33@ tmp%34@ tmp%35@) (=> %%location_label%%19 (= temp_19_0~3521@ temp_19_1~3590@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
