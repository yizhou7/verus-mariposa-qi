...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Add (Mul (Mul (Mul b0~4@ b0~4@) (Sub c0~6@ d0~8@)) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ a0~2@))) b0~4@)) (=> (= temp_0_1~314@ (Add (Mul (Mul b0~4@ (Mul b0~4@ (Sub c0~6@ d0~8@))) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ a0~2@))) b0~4@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~277@ temp_0_1~314@))) (=> (= temp_0_0~277@ temp_0_1~314@) (=> (= temp_1_0~395@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ d1~16@) c1~14@)) (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ a1~10@)) (Mul b1~12@ (Mul a1~10@ b1~12@))))) (=> (= temp_1_1~452@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ d1~16@) c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ (Mul a1~10@ b1~12@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~395@ temp_1_1~452@))) (=> (= temp_1_0~395@ temp_1_1~452@) (=> (= temp_2_0~529@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) a2~18@) (Mul (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Sub (Mul d2~24@ d2~24@) (Sub c2~22@ d2~24@))))) (=> (= temp_2_1~582@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) a2~18@) (Mul (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Sub (Mul d2~24@ d2~24@) (Sub c2~22@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~529@ temp_2_1~582@))) (=> (= temp_2_0~529@ temp_2_1~582@) (=> (= temp_3_0~679@ (Mul (Mul (Mul a3~26@ (Mul c3~30@ 69)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)) (Add (Mul d3~32@ a3~26@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~752@ (Mul (Mul (Mul a3~26@ (Mul c3~30@ 69)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)) (Add (Mul d3~32@ a3~26@) (Mul d3~32@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~679@ temp_3_1~752@))) (=> (= temp_3_0~679@ temp_3_1~752@) (=> (= temp_4_0~829@ (Mul (Mul (Mul (Sub a4~34@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Add d4~40@ d4~40@))) (Mul c4~38@ (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~882@ (Mul (Mul (Mul (Mul (Sub a4~34@ d4~40@) d4~40@) c4~38@) (Mul (Mul a4~34@ a4~34@) (Add d4~40@ d4~40@))) (Mul c4~38@ (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~829@ temp_4_1~882@))) (=> (= temp_4_0~829@ temp_4_1~882@) (=> (= temp_5_0~971@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@))) (Sub (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1036@ (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@)) (Sub (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ d5~48@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~971@ temp_5_1~1036@))) (=> (= temp_5_0~971@ temp_5_1~1036@) (=> (= temp_6_0~1125@ (Add (Mul (Sub (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ a6~50@))) (Add (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Add b6~52@ a6~50@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1190@ (Add (Mul (Sub (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ c6~54@))) (Add (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Add b6~52@ a6~50@) (Mul a6~50@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1125@ temp_6_1~1190@))) (=> (= temp_6_0~1125@ temp_6_1~1190@) (=> (= temp_7_0~1279@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Add a7~58@ d7~64@) (Mul d7~64@ c7~62@))) (Sub (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@))))) (=> (= temp_7_1~1344@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Add a7~58@ d7~64@) (Mul d7~64@ c7~62@))) (Sub (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1279@ temp_7_1~1344@))) (=> (= temp_7_0~1279@ temp_7_1~1344@) (=> (= temp_8_0~1433@ (Add (Mul (Mul (Mul d8~72@ c8~70@) (Add c8~70@ d8~72@)) (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ d8~72@)) (Mul (Mul b8~68@ b8~68@) (Sub b8~68@ d8~72@))))) (=> (= temp_8_1~1498@ (Add (Mul (Mul (Mul d8~72@ c8~70@) (Add c8~70@ d8~72@)) (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ d8~72@)) (Mul b8~68@ (Mul b8~68@ (Sub b8~68@ d8~72@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1433@ temp_8_1~1498@))) (=> (= temp_8_0~1433@ temp_8_1~1498@) (=> (= temp_9_0~1575@ (Mul (Mul (Mul (Mul d9~80@ d9~80@) (Add d9~80@ d9~80@)) (Add (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@))) (Add c9~78@ (Mul (Mul a9~74@ a9~74@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~1628@ (Mul (Mul (Add (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Add d9~80@ d9~80@))) (Add c9~78@ (Mul (Mul a9~74@ a9~74@) (Mul d9~80@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1575@ temp_9_1~1628@))) (=> (= temp_9_0~1575@ temp_9_1~1628@) (=> (= temp_10_0~1717@ (Mul (Sub a10~82@ (Sub (Sub b10~84@ a10~82@) (Mul 75 a10~82@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ b10~84@)) (Sub (Mul d10~88@ d10~88@) (Sub b10~84@ d10~88@))))) (=> (= temp_10_1~1798@ (Mul (Sub a10~82@ (Sub (Sub b10~84@ a10~82@) (Mul 75 a10~82@))) (Sub (Mul (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ b10~84@)) (Mul d10~88@ d10~88@)) (Mul (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ b10~84@)) (Sub b10~84@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1717@ temp_10_1~1798@))) (=> (= temp_10_0~1717@ temp_10_1~1798@) (=> (= temp_11_0~1883@ (Mul (Mul (Add (Mul b11~92@ d11~96@) (Mul a11~90@ d11~96@)) (Mul (Mul d11~96@ c11~94@) a11~90@)) (Mul (Mul (Mul b11~92@ c11~94@) (Mul d11~96@ a11~90@)) (Mul (Add a11~90@ a11~90@) (Add c11~94@ c11~94@))))) (=> (= temp_11_1~1944@ (Mul (Mul (Add (Mul b11~92@ d11~96@) (Mul a11~90@ d11~96@)) (Mul (Mul d11~96@ c11~94@) a11~90@)) (Mul (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ a11~90@)) (Mul (Add a11~90@ a11~90@) (Add c11~94@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1883@ temp_11_1~1944@))) (=> (= temp_11_0~1883@ temp_11_1~1944@) (=> (= temp_12_0~2029@ (Add (Mul (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2090@ (Add (Mul (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@)) (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@))) (Mul (Mul (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2029@ temp_12_1~2090@))) (=> (= temp_12_0~2029@ temp_12_1~2090@) (=> (= temp_13_0~2175@ (Mul (Mul (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ b13~108@))) (Mul (Sub (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul b13~108@ b13~108@) c13~110@)))) (=> (= temp_13_1~2248@ (Mul (Mul (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ b13~108@))) (Sub (Mul (Mul d13~112@ b13~108@) (Mul (Mul b13~108@ b13~108@) c13~110@)) (Mul (Mul c13~110@ a13~106@) (Mul (Mul b13~108@ b13~108@) c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2175@ temp_13_1~2248@))) (=> (= temp_13_0~2175@ temp_13_1~2248@) (=> (= temp_14_0~2337@ (Mul (Mul c14~118@ (Mul (Mul c14~118@ a14~114@) (Add d14~120@ c14~118@))) (Mul (Mul (Mul 14 c14~118@) (Mul a14~114@ b14~116@)) (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~2402@ (Mul (Mul (Mul (Mul 14 c14~118@) (Mul a14~114@ b14~116@)) (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@))) (Mul c14~118@ (Mul (Mul c14~118@ a14~114@) (Add d14~120@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2337@ temp_14_1~2402@))) (=> (= temp_14_0~2337@ temp_14_1~2402@) (=> (= temp_15_0~2491@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Add d15~128@ a15~122@)) (Mul (Sub c15~126@ c15~126@) (Mul a15~122@ b15~124@))) (Add (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ c15~126@)) (Sub (Mul b15~124@ c15~126@) (Mul b15~124@ b15~124@))))) (=> (= temp_15_1~2556@ (Mul (Mul (Mul b15~124@ d15~128@) (Add d15~128@ a15~122@)) (Mul (Mul (Sub c15~126@ c15~126@) (Mul a15~122@ b15~124@)) (Add (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ c15~126@)) (Sub (Mul b15~124@ c15~126@) (Mul b15~124@ b15~124@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2491@ temp_15_1~2556@))) (=> (= temp_15_0~2491@ temp_15_1~2556@) (=> (= temp_16_0~2653@ (Mul (Add (Mul a16~130@ (Mul a16~130@ 5)) (Mul (Sub c16~134@ a16~130@) (Mul c16~134@ c16~134@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul d16~136@ c16~134@)) (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ b16~132@))))) (=> (= temp_16_1~2726@ (Mul (Add (Mul a16~130@ (Mul a16~130@ 5)) (Mul (Sub c16~134@ a16~130@) (Mul c16~134@ c16~134@))) (Mul (Mul (Mul (Mul a16~130@ c16~134@) d16~136@) c16~134@) (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2653@ temp_16_1~2726@))) (=> (= temp_16_0~2653@ temp_16_1~2726@) (=> (= temp_17_0~2823@ (Sub (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ c17~142@) c17~142@)) (Sub (Mul (Mul 55 c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ b17~140@))))) (=> (= temp_17_1~2896@ (Sub (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul d17~144@ (Mul c17~142@ c17~142@))) (Sub (Mul (Mul 55 c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ b17~140@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2823@ temp_17_1~2896@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
