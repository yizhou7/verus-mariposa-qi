...
(set-info :comment ";; mariposa_data/v_nl//2697211439849746383/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_3_1~788@ Int)
(declare-const temp_4_0~869@ Int)
(declare-const temp_4_1~922@ Int)
(declare-const temp_5_0~1021@ Int)
(declare-const temp_5_1~1086@ Int)
...
(declare-const temp_9_0~1709@ Int)
(declare-const temp_9_1~1762@ Int)
(declare-const temp_10_0~1879@ Int)
(declare-const temp_10_1~1960@ Int)
...
(declare-const temp_13_1~2468@ Int)
(declare-const temp_14_0~2579@ Int)
(declare-const temp_14_1~2644@ Int)
(declare-const temp_15_0~2793@ Int)
(declare-const temp_15_1~2858@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Add (Mul (Mul (Mul b0~4@ b0~4@) (Sub c0~6@ d0~8@)) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ a0~2@))) b0~4@)) (=> (= temp_0_1~314@ (Add (Mul (Mul b0~4@ (Mul b0~4@ (Sub c0~6@ d0~8@))) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ a0~2@))) b0~4@)) (and (=> (= tmp%1@ (Sub c0~6@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ b0~4@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~277@ temp_0_1~314@)))) (=> (= temp_0_0~277@ temp_0_1~314@) (=> (= temp_1_0~405@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ d1~16@) c1~14@)) (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ a1~10@)) (Mul b1~12@ (Mul a1~10@ b1~12@))))) (=> (= temp_1_1~462@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ d1~16@) c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ (Mul a1~10@ b1~12@)))))) (and (=> (= tmp%2@ (Mul c1~14@ d1~16@)) (=> (= tmp%3@ (Mul a1~10@ a1~10@)) (=> (= tmp%4@ (Mul b1~12@ (Mul a1~10@ b1~12@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~405@ temp_1_1~462@)))))) (=> (= temp_1_0~405@ temp_1_1~462@) (=> (= temp_2_0~561@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) a2~18@) (Mul (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Sub (Mul d2~24@ d2~24@) (Sub c2~22@ d2~24@))))) (=> (= temp_2_1~614@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) a2~18@) (Mul (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Sub (Mul d2~24@ d2~24@) (Sub c2~22@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ a2~18@) (=> %%location_label%%2 (= temp_2_0~561@ temp_2_1~614@))) (=> (= temp_2_0~561@ temp_2_1~614@) (=> (= temp_3_0~715@ (Mul (Mul (Mul a3~26@ (Mul c3~30@ 69)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)) (Add (Mul d3~32@ a3~26@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~788@ (Mul (Mul (Mul a3~26@ (Mul c3~30@ 69)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)) (Add (Mul d3~32@ a3~26@) (Mul d3~32@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ d3~32@) (=> %%location_label%%3 (= temp_3_0~715@ temp_3_1~788@))) (=> (= temp_3_0~715@ temp_3_1~788@) (=> (= temp_4_0~869@ (Mul (Mul (Mul (Sub a4~34@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Add d4~40@ d4~40@))) (Mul c4~38@ (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~922@ (Mul (Mul (Mul (Mul (Sub a4~34@ d4~40@) d4~40@) c4~38@) (Mul (Mul a4~34@ a4~34@) (Add d4~40@ d4~40@))) (Mul c4~38@ (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@))))) (and (=> (= tmp%5@ (Sub a4~34@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ d4~40@ c4~38@) (=> %%location_label%%4 (= temp_4_0~869@ temp_4_1~922@)))) (=> (= temp_4_0~869@ temp_4_1~922@) (=> (= temp_5_0~1021@ (Mul (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@))) (Sub (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1086@ (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@)) (Sub (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ d5~48@)))))) (and (=> (= tmp%6@ (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (=> (= tmp%7@ (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@))) (=> (= tmp%8@ (Sub (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ d5~48@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~1021@ temp_5_1~1086@)))))) (=> (= temp_5_0~1021@ temp_5_1~1086@) (=> (= temp_6_0~1233@ (Add (Mul (Sub (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ a6~50@))) (Add (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Add b6~52@ a6~50@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1298@ (Add (Mul (Sub (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ c6~54@))) (Add (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@)) (Mul (Add b6~52@ a6~50@) (Mul a6~50@ b6~52@))))) (and (=> (= tmp%9@ (Mul c6~54@ c6~54@)) (=> (= tmp%10@ (Mul b6~52@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~1233@ temp_6_1~1298@))))) (=> (= temp_6_0~1233@ temp_6_1~1298@) (=> (= temp_7_0~1399@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Add a7~58@ d7~64@) (Mul d7~64@ c7~62@))) (Sub (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@))))) (=> (= temp_7_1~1464@ (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Add a7~58@ d7~64@) (Mul d7~64@ c7~62@))) (Sub (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1399@ temp_7_1~1464@))) (=> (= temp_7_0~1399@ temp_7_1~1464@) (=> (= temp_8_0~1557@ (Add (Mul (Mul (Mul d8~72@ c8~70@) (Add c8~70@ d8~72@)) (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ d8~72@)) (Mul (Mul b8~68@ b8~68@) (Sub b8~68@ d8~72@))))) (=> (= temp_8_1~1622@ (Add (Mul (Mul (Mul d8~72@ c8~70@) (Add c8~70@ d8~72@)) (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ d8~72@)) (Mul b8~68@ (Mul b8~68@ (Sub b8~68@ d8~72@)))))) (and (=> (= tmp%11@ (Sub b8~68@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b8~68@ b8~68@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~1557@ temp_8_1~1622@)))) (=> (= temp_8_0~1557@ temp_8_1~1622@) (=> (= temp_9_0~1709@ (Mul (Mul (Mul (Mul d9~80@ d9~80@) (Add d9~80@ d9~80@)) (Add (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@))) (Add c9~78@ (Mul (Mul a9~74@ a9~74@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~1762@ (Mul (Mul (Add (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Add d9~80@ d9~80@))) (Add c9~78@ (Mul (Mul a9~74@ a9~74@) (Mul d9~80@ a9~74@))))) (and (=> (= tmp%12@ (Mul (Mul d9~80@ d9~80@) (Add d9~80@ d9~80@))) (=> (= tmp%13@ (Add (Mul a9~74@ c9~78@) (Mul c9~78@ b9~76@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%9 (= temp_9_0~1709@ temp_9_1~1762@))))) (=> (= temp_9_0~1709@ temp_9_1~1762@) (=> (= temp_10_0~1879@ (Mul (Sub a10~82@ (Sub (Sub b10~84@ a10~82@) (Mul 75 a10~82@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ b10~84@)) (Sub (Mul d10~88@ d10~88@) (Sub b10~84@ d10~88@))))) (=> (= temp_10_1~1960@ (Mul (Sub a10~82@ (Sub (Sub b10~84@ a10~82@) (Mul 75 a10~82@))) (Sub (Mul (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ b10~84@)) (Mul d10~88@ d10~88@)) (Mul (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ b10~84@)) (Sub b10~84@ d10~88@))))) (and (=> (= tmp%14@ (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ b10~84@))) (=> (= tmp%15@ (Mul d10~88@ d10~88@)) (=> (= tmp%16@ (Sub b10~84@ d10~88@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%10 (= temp_10_0~1879@ temp_10_1~1960@)))))) (=> (= temp_10_0~1879@ temp_10_1~1960@) (=> (= temp_11_0~2071@ (Mul (Mul (Add (Mul b11~92@ d11~96@) (Mul a11~90@ d11~96@)) (Mul (Mul d11~96@ c11~94@) a11~90@)) (Mul (Mul (Mul b11~92@ c11~94@) (Mul d11~96@ a11~90@)) (Mul (Add a11~90@ a11~90@) (Add c11~94@ c11~94@))))) (=> (= temp_11_1~2132@ (Mul (Mul (Add (Mul b11~92@ d11~96@) (Mul a11~90@ d11~96@)) (Mul (Mul d11~96@ c11~94@) a11~90@)) (Mul (Mul (Mul c11~94@ b11~92@) (Mul d11~96@ a11~90@)) (Mul (Add a11~90@ a11~90@) (Add c11~94@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b11~92@ c11~94@) (=> %%location_label%%11 (= temp_11_0~2071@ temp_11_1~2132@))) (=> (= temp_11_0~2071@ temp_11_1~2132@) (=> (= temp_12_0~2221@ (Add (Mul (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2282@ (Add (Mul (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@)) (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@))) (Mul (Mul (Mul a12~98@ a12~98@) b12~100@) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ d12~104@))))) (and (=> (= tmp%17@ (Add (Mul a12~98@ d12~104@) (Mul d12~104@ a12~98@))) (=> (= tmp%18@ (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%12 (= temp_12_0~2221@ temp_12_1~2282@))))) (=> (= temp_12_0~2221@ temp_12_1~2282@) (=> (= temp_13_0~2395@ (Mul (Mul (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ b13~108@))) (Mul (Sub (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Mul (Mul b13~108@ b13~108@) c13~110@)))) (=> (= temp_13_1~2468@ (Mul (Mul (Mul (Mul a13~106@ b13~108@) (Mul c13~110@ d13~112@)) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ b13~108@))) (Sub (Mul (Mul d13~112@ b13~108@) (Mul (Mul b13~108@ b13~108@) c13~110@)) (Mul (Mul c13~110@ a13~106@) (Mul (Mul b13~108@ b13~108@) c13~110@))))) (and (=> (= tmp%19@ (Mul d13~112@ b13~108@)) (=> (= tmp%20@ (Mul c13~110@ a13~106@)) (=> (= tmp%21@ (Mul (Mul b13~108@ b13~108@) c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%19@ tmp%20@ tmp%21@) (=> %%location_label%%13 (= temp_13_0~2395@ temp_13_1~2468@)))))) (=> (= temp_13_0~2395@ temp_13_1~2468@) (=> (= temp_14_0~2579@ (Mul (Mul c14~118@ (Mul (Mul c14~118@ a14~114@) (Add d14~120@ c14~118@))) (Mul (Mul (Mul 14 c14~118@) (Mul a14~114@ b14~116@)) (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~2644@ (Mul (Mul (Mul (Mul 14 c14~118@) (Mul a14~114@ b14~116@)) (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@))) (Mul c14~118@ (Mul (Mul c14~118@ a14~114@) (Add d14~120@ c14~118@))))) (and (=> (= tmp%22@ (Mul c14~118@ (Mul (Mul c14~118@ a14~114@) (Add d14~120@ c14~118@)))) (=> (= tmp%23@ (Mul (Mul (Mul 14 c14~118@) (Mul a14~114@ b14~116@)) (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ b14~116@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%14 (= temp_14_0~2579@ temp_14_1~2644@))))) (=> (= temp_14_0~2579@ temp_14_1~2644@) (=> (= temp_15_0~2793@ (Mul (Mul (Mul (Mul b15~124@ d15~128@) (Add d15~128@ a15~122@)) (Mul (Sub c15~126@ c15~126@) (Mul a15~122@ b15~124@))) (Add (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ c15~126@)) (Sub (Mul b15~124@ c15~126@) (Mul b15~124@ b15~124@))))) (=> (= temp_15_1~2858@ (Mul (Mul (Mul b15~124@ d15~128@) (Add d15~128@ a15~122@)) (Mul (Mul (Sub c15~126@ c15~126@) (Mul a15~122@ b15~124@)) (Add (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ c15~126@)) (Sub (Mul b15~124@ c15~126@) (Mul b15~124@ b15~124@)))))) (and (=> (= tmp%24@ (Mul (Mul b15~124@ d15~128@) (Add d15~128@ a15~122@))) (=> (= tmp%25@ (Mul (Sub c15~126@ c15~126@) (Mul a15~122@ b15~124@))) (=> (= tmp%26@ (Add (Mul (Mul c15~126@ b15~124@) (Mul b15~124@ c15~126@)) (Sub (Mul b15~124@ c15~126@) (Mul b15~124@ b15~124@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%15 (= temp_15_0~2793@ temp_15_1~2858@)))))) (=> (= temp_15_0~2793@ temp_15_1~2858@) (=> (= temp_16_0~3013@ (Mul (Add (Mul a16~130@ (Mul a16~130@ 5)) (Mul (Sub c16~134@ a16~130@) (Mul c16~134@ c16~134@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul d16~136@ c16~134@)) (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ b16~132@))))) (=> (= temp_16_1~3086@ (Mul (Add (Mul a16~130@ (Mul a16~130@ 5)) (Mul (Sub c16~134@ a16~130@) (Mul c16~134@ c16~134@))) (Mul (Mul (Mul (Mul a16~130@ c16~134@) d16~136@) c16~134@) (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ b16~132@))))) (and (=> (= tmp%27@ (Mul a16~130@ c16~134@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%27@ d16~136@ c16~134@) (=> %%location_label%%16 (= temp_16_0~3013@ temp_16_1~3086@)))) (=> (= temp_16_0~3013@ temp_16_1~3086@) (=> (= temp_17_0~3193@ (Sub (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ c17~142@) c17~142@)) (Sub (Mul (Mul 55 c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ b17~140@))))) (=> (= temp_17_1~3266@ (Sub (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul d17~144@ (Mul c17~142@ c17~142@))) (Sub (Mul (Mul 55 c17~142@) (Mul a17~138@ d17~144@)) (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ b17~140@))))) (=> (ens%main!nl_basics.lemma_mul_is_associative. d17~144@ c17~142@ c17~142@) (=> %%location_label%%17 (= temp_17_0~3193@ temp_17_1~3266@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
