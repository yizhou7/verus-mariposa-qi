...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Add a0~2@ d0~8@)) (Sub (Mul a0~2@ c0~6@) (Mul 69 c0~6@))) (Add (Add (Mul d0~8@ d0~8@) (Add b0~4@ b0~4@)) (Add (Add a0~2@ c0~6@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~410@ (Mul (Sub (Mul (Mul (Mul d0~8@ a0~2@) (Add a0~2@ d0~8@)) (Mul a0~2@ c0~6@)) (Mul (Mul (Mul d0~8@ a0~2@) (Add a0~2@ d0~8@)) (Mul 69 c0~6@))) (Add (Add (Mul d0~8@ d0~8@) (Add b0~4@ b0~4@)) (Add (Add a0~2@ c0~6@) (Mul d0~8@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~410@))) (=> (= temp_0_0~317@ temp_0_1~410@) (=> (= temp_1_0~499@ (Add (Mul (Sub (Mul a1~10@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ b1~12@))) (Sub (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Add a1~10@ d1~16@))))) (=> (= temp_1_1~564@ (Add (Mul (Sub (Mul a1~10@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ b1~12@))) (Sub (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ b1~12@)) (Mul c1~14@ (Mul a1~10@ (Add a1~10@ d1~16@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~499@ temp_1_1~564@))) (=> (= temp_1_0~499@ temp_1_1~564@) (=> (= temp_2_0~649@ (Add (Mul (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@))) (Add (Add c2~22@ (Mul b2~20@ b2~20@)) (Add (Mul a2~18@ c2~22@) (Mul a2~18@ a2~18@))))) (=> (= temp_2_1~710@ (Add (Mul (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ c2~22@))) (Add (Add c2~22@ (Mul b2~20@ b2~20@)) (Add (Mul a2~18@ c2~22@) (Mul a2~18@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~649@ temp_2_1~710@))) (=> (= temp_2_0~649@ temp_2_1~710@) (=> (= temp_3_0~799@ (Mul (Mul (Mul (Add c3~30@ c3~30@) (Mul c3~30@ d3~32@)) (Add (Mul b3~28@ d3~32@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul b3~28@ d3~32@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~864@ (Mul (Mul (Add c3~30@ c3~30@) (Mul (Mul c3~30@ d3~32@) (Add (Mul b3~28@ d3~32@) (Mul c3~30@ c3~30@)))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul b3~28@ d3~32@) (Mul d3~32@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~799@ temp_3_1~864@))) (=> (= temp_3_0~799@ temp_3_1~864@) (=> (= temp_4_0~953@ (Sub (Mul (Mul (Mul c4~38@ d4~40@) (Add c4~38@ d4~40@)) (Mul (Add c4~38@ b4~36@) (Sub b4~36@ b4~36@))) (Mul (Add (Mul a4~34@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~1018@ (Sub (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Add c4~38@ d4~40@)) (Add c4~38@ b4~36@)) (Sub b4~36@ b4~36@)) (Mul (Add (Mul a4~34@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~953@ temp_4_1~1018@))) (=> (= temp_4_0~953@ temp_4_1~1018@) (=> (= temp_5_0~1107@ (Sub (Mul (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ b5~44@))) (Mul (Add (Mul b5~44@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Add c5~46@ c5~46@))))) (=> (= temp_5_1~1172@ (Sub (Mul (Mul (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ d5~48@)) (Mul c5~46@ c5~46@)) (Mul b5~44@ b5~44@)) (Mul (Add (Mul b5~44@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Add c5~46@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1107@ temp_5_1~1172@))) (=> (= temp_5_0~1107@ temp_5_1~1172@) (=> (= temp_6_0~1253@ (Add (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul c6~54@ c6~54@) b6~52@) (Mul (Mul a6~50@ c6~54@) c6~54@)))) (=> (= temp_6_1~1310@ (Add (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Mul b6~52@ (Mul c6~54@ c6~54@)) (Mul (Mul a6~50@ c6~54@) c6~54@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1253@ temp_6_1~1310@))) (=> (= temp_6_0~1253@ temp_6_1~1310@) (=> (= temp_7_0~1395@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Sub b7~60@ b7~60@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul d7~64@ c7~62@) a7~58@) (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1456@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Sub b7~60@ b7~60@) (Mul a7~58@ b7~60@))) (Mul (Mul a7~58@ (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1395@ temp_7_1~1456@))) (=> (= temp_7_0~1395@ temp_7_1~1456@) (=> (= temp_8_0~1541@ (Mul (Mul (Sub (Mul d8~72@ b8~68@) (Mul b8~68@ a8~66@)) (Mul a8~66@ (Mul d8~72@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul a8~66@ c8~70@)) (Add (Mul c8~70@ d8~72@) (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1602@ (Mul (Mul (Sub (Mul d8~72@ b8~68@) (Mul b8~68@ a8~66@)) (Mul a8~66@ (Mul a8~66@ d8~72@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul a8~66@ c8~70@)) (Add (Mul c8~70@ d8~72@) (Mul b8~68@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1541@ temp_8_1~1602@))) (=> (= temp_8_0~1541@ temp_8_1~1602@) (=> (= temp_9_0~1671@ (Mul (Mul (Sub b9~76@ (Mul b9~76@ a9~74@)) (Mul d9~80@ (Add c9~78@ c9~78@))) (Mul (Mul (Mul c9~78@ a9~74@) (Add d9~80@ a9~74@)) c9~78@))) (=> (= temp_9_1~1716@ (Mul (Mul (Sub b9~76@ (Mul b9~76@ a9~74@)) (Mul d9~80@ (Add c9~78@ c9~78@))) (Mul c9~78@ (Mul (Mul c9~78@ a9~74@) (Add d9~80@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1671@ temp_9_1~1716@))) (=> (= temp_9_0~1671@ temp_9_1~1716@) (=> (= temp_10_0~1789@ (Mul (Mul (Mul (Mul b10~84@ a10~82@) (Mul c10~86@ d10~88@)) (Mul b10~84@ (Mul c10~86@ c10~86@))) (Add (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ b10~84@)) b10~84@))) (=> (= temp_10_1~1838@ (Mul (Add (Mul (Mul b10~84@ b10~84@) (Mul d10~88@ b10~84@)) b10~84@) (Mul (Mul (Mul b10~84@ a10~82@) (Mul c10~86@ d10~88@)) (Mul b10~84@ (Mul c10~86@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1789@ temp_10_1~1838@))) (=> (= temp_10_0~1789@ temp_10_1~1838@) (=> (= temp_11_0~1923@ (Mul (Mul (Sub (Add c11~94@ d11~96@) (Mul a11~90@ d11~96@)) (Add (Mul b11~92@ c11~94@) d11~96@)) (Mul (Mul (Mul c11~94@ a11~90@) (Mul b11~92@ a11~90@)) (Mul (Mul c11~94@ d11~96@) (Mul d11~96@ d11~96@))))) (=> (= temp_11_1~1984@ (Mul (Mul (Sub (Add c11~94@ d11~96@) (Mul a11~90@ d11~96@)) (Add (Mul b11~92@ c11~94@) d11~96@)) (Mul (Mul (Mul a11~90@ c11~94@) (Mul b11~92@ a11~90@)) (Mul (Mul c11~94@ d11~96@) (Mul d11~96@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1923@ temp_11_1~1984@))) (=> (= temp_11_0~1923@ temp_11_1~1984@) (=> (= temp_12_0~2085@ (Mul (Mul (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ a12~98@)) (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ c12~102@))) (Mul (Sub (Mul 76 d12~104@) (Mul b12~100@ b12~100@)) (Sub (Mul d12~104@ c12~102@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2162@ (Mul (Mul (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ a12~98@)) (Mul (Mul c12~102@ b12~100@) (Mul d12~104@ c12~102@))) (Mul (Sub (Mul d12~104@ 76) (Mul b12~100@ b12~100@)) (Sub (Mul d12~104@ c12~102@) (Mul d12~104@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2085@ temp_12_1~2162@))) (=> (= temp_12_0~2085@ temp_12_1~2162@) (=> (= temp_13_0~2251@ (Mul (Mul (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ a13~106@)) (Mul (Add c13~110@ b13~108@) (Mul c13~110@ d13~112@))) (Sub (Sub (Mul b13~108@ d13~112@) (Mul a13~106@ c13~110@)) (Add (Sub b13~108@ d13~112@) (Mul a13~106@ a13~106@))))) (=> (= temp_13_1~2316@ (Mul (Mul (Mul (Mul d13~112@ d13~112@) (Mul c13~110@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Add c13~110@ b13~108@))) (Sub (Sub (Mul b13~108@ d13~112@) (Mul a13~106@ c13~110@)) (Add (Sub b13~108@ d13~112@) (Mul a13~106@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2251@ temp_13_1~2316@))) (=> (= temp_13_0~2251@ temp_13_1~2316@) (=> (= temp_14_0~2429@ (Mul (Mul (Mul (Sub b14~116@ d14~120@) (Mul a14~114@ a14~114@)) (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@))) (Mul (Sub (Add a14~114@ c14~118@) (Add a14~114@ d14~120@)) (Mul (Mul 53 c14~118@) (Mul a14~114@ 22))))) (=> (= temp_14_1~2518@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul b14~116@ c14~118@)) (Mul (Sub b14~116@ d14~120@) (Mul a14~114@ a14~114@))) (Mul (Sub (Add a14~114@ c14~118@) (Add a14~114@ d14~120@)) (Mul (Mul 53 c14~118@) (Mul a14~114@ 22))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2429@ temp_14_1~2518@))) (=> (= temp_14_0~2429@ temp_14_1~2518@) (=> (= temp_15_0~2631@ (Mul (Mul (Mul (Mul c15~126@ a15~122@) (Add a15~122@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Mul a15~122@ d15~128@))) (Mul (Mul (Mul 47 b15~124@) (Mul a15~122@ a15~122@)) (Sub (Mul 33 d15~128@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2720@ (Mul (Mul (Mul (Mul (Mul c15~126@ a15~122@) (Add a15~122@ b15~124@)) (Mul a15~122@ d15~128@)) (Mul a15~122@ d15~128@)) (Mul (Mul (Mul 47 b15~124@) (Mul a15~122@ a15~122@)) (Sub (Mul 33 d15~128@) (Mul d15~128@ d15~128@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2631@ temp_15_1~2720@))) (=> (= temp_15_0~2631@ temp_15_1~2720@) (=> (= temp_16_0~2809@ (Mul (Mul (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ c16~134@)) (Mul (Sub d16~136@ b16~132@) (Mul b16~132@ a16~130@))) (Sub (Mul (Mul a16~130@ a16~130@) (Mul a16~130@ a16~130@)) (Mul (Mul a16~130@ d16~136@) (Mul a16~130@ b16~132@))))) (=> (= temp_16_1~2874@ (Mul (Mul (Mul (Mul b16~132@ c16~134@) (Mul c16~134@ a16~130@)) (Mul (Sub d16~136@ b16~132@) (Mul b16~132@ a16~130@))) (Sub (Mul (Mul a16~130@ a16~130@) (Mul a16~130@ a16~130@)) (Mul (Mul a16~130@ d16~136@) (Mul a16~130@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2809@ temp_16_1~2874@))) (=> (= temp_16_0~2809@ temp_16_1~2874@) (=> (= temp_17_0~2947@ (Mul (Mul (Mul (Mul b17~140@ b17~140@) (Mul c17~142@ a17~138@)) a17~138@) (Mul (Mul c17~142@ (Mul b17~140@ a17~138@)) (Sub (Mul d17~144@ b17~140@) (Mul b17~140@ d17~144@))))) (=> (= temp_17_1~3008@ (Mul (Mul (Mul (Mul b17~140@ b17~140@) (Mul c17~142@ a17~138@)) a17~138@) (Sub (Mul (Mul c17~142@ (Mul b17~140@ a17~138@)) (Mul d17~144@ b17~140@)) (Mul (Mul c17~142@ (Mul b17~140@ a17~138@)) (Mul b17~140@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2947@ temp_17_1~3008@))) (=> (= temp_17_0~2947@ temp_17_1~3008@) (=> (= temp_18_0~3089@ (Mul (Add (Mul (Mul c18~150@ c18~150@) (Mul c18~150@ b18~148@)) (Mul (Mul d18~152@ b18~148@) b18~148@)) (Mul (Mul (Mul a18~146@ a18~146@) b18~148@) (Mul (Mul d18~152@ d18~152@) (Mul c18~150@ c18~150@))))) (=> (= temp_18_1~3146@ (Mul (Add (Mul (Mul c18~150@ c18~150@) (Mul c18~150@ b18~148@)) (Mul (Mul d18~152@ b18~148@) b18~148@)) (Mul (Mul b18~148@ (Mul a18~146@ a18~146@)) (Mul (Mul d18~152@ d18~152@) (Mul c18~150@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3089@ temp_18_1~3146@))) (=> (= temp_18_0~3089@ temp_18_1~3146@) (=> (= temp_19_0~3227@ (Mul (Add (Mul d19~160@ (Mul c19~158@ b19~156@)) (Sub a19~154@ (Mul b19~156@ a19~154@))) (Mul (Mul (Mul c19~158@ d19~160@) (Mul b19~156@ c19~158@)) (Mul (Add a19~154@ c19~158@) (Mul a19~154@ a19~154@))))) (=> (= temp_19_1~3284@ (Mul (Add (Mul d19~160@ (Mul c19~158@ b19~156@)) (Sub a19~154@ (Mul b19~156@ a19~154@))) (Mul (Mul (Mul c19~158@ d19~160@) (Mul b19~156@ c19~158@)) (Mul (Mul a19~154@ a19~154@) (Add a19~154@ c19~158@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3227@ temp_19_1~3284@))) (=> (= temp_19_0~3227@ temp_19_1~3284@) (=> (= temp_20_0~3373@ (Mul (Mul (Mul (Mul c20~166@ a20~162@) (Mul c20~166@ a20~162@)) (Mul (Mul d20~168@ d20~168@) (Mul d20~168@ b20~164@))) (Mul (Mul (Mul a20~162@ c20~166@) (Mul d20~168@ c20~166@)) (Mul (Mul d20~168@ d20~168@) (Add c20~166@ c20~166@))))) (=> (= temp_20_1~3438@ (Mul (Mul (Mul (Mul c20~166@ a20~162@) (Mul c20~166@ a20~162@)) (Mul (Mul d20~168@ d20~168@) (Mul b20~164@ d20~168@))) (Mul (Mul (Mul a20~162@ c20~166@) (Mul d20~168@ c20~166@)) (Mul (Mul d20~168@ d20~168@) (Add c20~166@ c20~166@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3373@ temp_20_1~3438@))) (=> (= temp_20_0~3373@ temp_20_1~3438@) (=> (= temp_21_0~3515@ (Mul (Sub (Mul (Mul d21~176@ d21~176@) (Mul d21~176@ c21~174@)) (Add (Mul c21~174@ b21~172@) (Mul d21~176@ a21~170@))) (Sub (Mul (Mul b21~172@ a21~170@) (Mul b21~172@ b21~172@)) d21~176@))) (=> (= temp_21_1~3568@ (Mul (Sub (Mul (Mul d21~176@ c21~174@) (Mul d21~176@ d21~176@)) (Add (Mul c21~174@ b21~172@) (Mul d21~176@ a21~170@))) (Sub (Mul (Mul b21~172@ a21~170@) (Mul b21~172@ b21~172@)) d21~176@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3515@ temp_21_1~3568@))) (=> (= temp_21_0~3515@ temp_21_1~3568@) (=> (= temp_22_0~3657@ (Add (Mul (Sub (Mul b22~180@ b22~180@) (Mul d22~184@ c22~182@)) (Add (Sub c22~182@ b22~180@) (Mul c22~182@ a22~178@))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul b22~180@ d22~184@)) (Mul (Sub a22~178@ a22~178@) (Add b22~180@ a22~178@))))) (=> (= temp_22_1~3738@ (Add (Sub (Mul (Mul b22~180@ b22~180@) (Add (Sub c22~182@ b22~180@) (Mul c22~182@ a22~178@))) (Mul (Mul d22~184@ c22~182@) (Add (Sub c22~182@ b22~180@) (Mul c22~182@ a22~178@)))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul b22~180@ d22~184@)) (Mul (Sub a22~178@ a22~178@) (Add b22~180@ a22~178@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3657@ temp_22_1~3738@))) (=> (= temp_22_0~3657@ temp_22_1~3738@) (=> (= temp_23_0~3823@ (Mul (Mul (Sub (Sub b23~188@ c23~190@) (Mul a23~186@ a23~186@)) (Mul (Mul b23~188@ b23~188@) (Mul d23~192@ b23~188@))) (Mul (Sub (Mul c23~190@ c23~190@) c23~190@) (Sub (Add d23~192@ d23~192@) (Mul d23~192@ b23~188@))))) (=> (= temp_23_1~3884@ (Mul (Mul (Mul (Sub (Sub b23~188@ c23~190@) (Mul a23~186@ a23~186@)) (Mul b23~188@ b23~188@)) (Mul d23~192@ b23~188@)) (Mul (Sub (Mul c23~190@ c23~190@) c23~190@) (Sub (Add d23~192@ d23~192@) (Mul d23~192@ b23~188@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3823@ temp_23_1~3884@))) (=> (= temp_23_0~3823@ temp_23_1~3884@) (=> (= temp_24_0~3961@ (Mul (Mul (Add b24~196@ (Sub a24~194@ a24~194@)) (Sub (Mul d24~200@ d24~200@) d24~200@)) (Mul (Mul (Mul c24~198@ c24~198@) (Mul c24~198@ c24~198@)) (Mul d24~200@ (Mul d24~200@ d24~200@))))) (=> (= temp_24_1~4014@ (Mul (Mul (Sub (Mul d24~200@ d24~200@) d24~200@) (Add b24~196@ (Sub a24~194@ a24~194@))) (Mul (Mul (Mul c24~198@ c24~198@) (Mul c24~198@ c24~198@)) (Mul d24~200@ (Mul d24~200@ d24~200@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3961@ temp_24_1~4014@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
