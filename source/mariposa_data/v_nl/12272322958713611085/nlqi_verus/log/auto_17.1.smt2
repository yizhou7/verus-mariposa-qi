...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Add (Mul (Sub a0~2@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Add c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ b0~4@) c0~6@)))) (=> (= temp_0_1~362@ (Mul (Add (Mul (Sub a0~2@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Add c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ b0~4@) c0~6@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~447@ (Mul (Mul (Mul (Add d1~16@ b1~12@) a1~10@) (Mul (Sub c1~14@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Mul (Sub b1~12@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~508@ (Mul (Mul (Mul (Add d1~16@ b1~12@) a1~10@) (Mul (Sub c1~14@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Mul (Sub b1~12@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~508@))) (=> (= temp_1_0~447@ temp_1_1~508@) (=> (= temp_2_0~597@ (Mul (Sub (Add (Mul d2~24@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~662@ (Mul (Sub (Add (Mul d2~24@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~597@ temp_2_1~662@))) (=> (= temp_2_0~597@ temp_2_1~662@) (=> (= temp_3_0~763@ (Mul (Mul (Add (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (Add (Sub (Mul a3~26@ c3~30@) (Mul d3~32@ 19)) (Mul (Sub b3~28@ d3~32@) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~840@ (Mul (Mul (Add (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (Add (Sub (Mul a3~26@ c3~30@) (Mul d3~32@ 19)) (Mul (Mul c3~30@ c3~30@) (Sub b3~28@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~763@ temp_3_1~840@))) (=> (= temp_3_0~763@ temp_3_1~840@) (=> (= temp_4_0~929@ (Mul (Mul (Add (Add a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Add (Add d4~40@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Sub c4~38@ b4~36@)) (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~994@ (Mul (Mul (Add (Add a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Add (Add d4~40@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul a4~34@ c4~38@) (Mul (Sub c4~38@ b4~36@) (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ b4~36@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~929@ temp_4_1~994@))) (=> (= temp_4_0~929@ temp_4_1~994@) (=> (= temp_5_0~1067@ (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ d5~48@)) (Mul b5~44@ (Mul c5~46@ a5~42@))) (Mul c5~46@ (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1116@ (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ d5~48@)) (Mul b5~44@ (Mul c5~46@ a5~42@))) (Mul c5~46@ (Mul (Mul (Sub d5~48@ b5~44@) c5~46@) b5~44@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1067@ temp_5_1~1116@))) (=> (= temp_5_0~1067@ temp_5_1~1116@) (=> (= temp_6_0~1189@ (Mul (Mul (Add (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@)) a6~50@) (Mul (Sub (Add a6~50@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Add a6~50@ c6~54@) b6~52@)))) (=> (= temp_6_1~1238@ (Mul (Mul (Sub (Add a6~50@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Add a6~50@ c6~54@) b6~52@)) (Mul (Add (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@)) a6~50@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1189@ temp_6_1~1238@))) (=> (= temp_6_0~1189@ temp_6_1~1238@) (=> (= temp_7_0~1315@ (Mul (Mul c7~62@ (Sub (Mul c7~62@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1368@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@))) (Mul c7~62@ (Sub (Mul c7~62@ b7~60@) (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1315@ temp_7_1~1368@))) (=> (= temp_7_0~1315@ temp_7_1~1368@) (=> (= temp_8_0~1469@ (Mul (Mul (Mul (Add b8~68@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Mul 91 d8~72@) (Add d8~72@ d8~72@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@))))) (=> (= temp_8_1~1546@ (Mul (Mul (Mul (Add b8~68@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Mul 91 d8~72@) (Add d8~72@ d8~72@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul b8~68@ (Mul d8~72@ (Mul b8~68@ d8~72@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1469@ temp_8_1~1546@))) (=> (= temp_8_0~1469@ temp_8_1~1546@) (=> (= temp_9_0~1627@ (Add (Mul (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ d9~80@)) (Mul d9~80@ (Mul c9~78@ b9~76@))) (Mul (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ d9~80@) a9~74@)))) (=> (= temp_9_1~1684@ (Add (Mul (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ d9~80@)) (Mul d9~80@ (Mul c9~78@ b9~76@))) (Mul (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) a9~74@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1627@ temp_9_1~1684@))) (=> (= temp_9_0~1627@ temp_9_1~1684@) (=> (= temp_10_0~1773@ (Mul (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul a10~82@ a10~82@)) (Mul (Mul d10~88@ (Mul b10~84@ d10~88@)) (Mul (Mul b10~84@ 40) (Mul b10~84@ a10~82@))))) (=> (= temp_10_1~1838@ (Mul (Mul (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul a10~82@ a10~82@)) (Mul d10~88@ (Mul b10~84@ d10~88@))) (Mul (Mul b10~84@ 40) (Mul b10~84@ a10~82@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1773@ temp_10_1~1838@))) (=> (= temp_10_0~1773@ temp_10_1~1838@) (=> (= temp_11_0~1923@ (Mul (Add (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ b11~92@) (Add a11~90@ d11~96@))) (Mul (Mul (Add a11~90@ a11~90@) (Mul a11~90@ b11~92@)) (Mul (Add a11~90@ a11~90@) b11~92@)))) (=> (= temp_11_1~1984@ (Mul (Add (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (Mul c11~94@ b11~92@) (Add a11~90@ d11~96@))) (Mul (Mul (Add a11~90@ a11~90@) (Mul a11~90@ b11~92@)) (Mul (Add a11~90@ a11~90@) b11~92@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1923@ temp_11_1~1984@))) (=> (= temp_11_0~1923@ temp_11_1~1984@) (=> (= temp_12_0~2085@ (Sub (Mul (Mul (Sub d12~104@ d12~104@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul 45 a12~98@))) (Sub (Mul (Mul b12~100@ c12~102@) (Add d12~104@ c12~102@)) (Sub (Mul c12~102@ c12~102@) (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2162@ (Sub (Mul (Mul (Sub d12~104@ d12~104@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul 45 a12~98@))) (Sub (Mul (Mul c12~102@ b12~100@) (Add d12~104@ c12~102@)) (Sub (Mul c12~102@ c12~102@) (Mul a12~98@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2085@ temp_12_1~2162@))) (=> (= temp_12_0~2085@ temp_12_1~2162@) (=> (= temp_13_0~2247@ (Sub (Add (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ c13~110@)) (Sub (Mul d13~112@ c13~110@) d13~112@)) (Mul (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@)) (Mul (Add a13~106@ c13~110@) (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2308@ (Sub (Add (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ c13~110@)) (Sub (Mul d13~112@ c13~110@) d13~112@)) (Mul (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@)) (Mul (Mul (Add a13~106@ c13~110@) b13~108@) d13~112@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2247@ temp_13_1~2308@))) (=> (= temp_13_0~2247@ temp_13_1~2308@) (=> (= temp_14_0~2409@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul 21 c14~118@)) (Mul (Mul b14~116@ a14~114@) (Mul a14~114@ a14~114@))) (Mul (Mul (Sub c14~118@ b14~116@) (Add d14~120@ d14~120@)) (Mul (Mul a14~114@ a14~114@) (Sub d14~120@ d14~120@))))) (=> (= temp_14_1~2486@ (Mul (Mul (Mul b14~116@ (Mul a14~114@ (Mul 21 c14~118@))) (Mul (Mul b14~116@ a14~114@) (Mul a14~114@ a14~114@))) (Mul (Mul (Sub c14~118@ b14~116@) (Add d14~120@ d14~120@)) (Mul (Mul a14~114@ a14~114@) (Sub d14~120@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2409@ temp_14_1~2486@))) (=> (= temp_14_0~2409@ temp_14_1~2486@) (=> (= temp_15_0~2575@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ b15~124@)) (Mul (Sub d15~128@ d15~128@) (Add c15~126@ c15~126@))) (Mul (Mul (Mul c15~126@ d15~128@) (Mul b15~124@ c15~126@)) (Add (Mul b15~124@ d15~128@) (Mul a15~122@ a15~122@))))) (=> (= temp_15_1~2640@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ c15~126@)) (Mul (Sub d15~128@ d15~128@) (Add c15~126@ c15~126@))) (Mul (Mul (Mul c15~126@ d15~128@) (Mul b15~124@ c15~126@)) (Add (Mul b15~124@ d15~128@) (Mul a15~122@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2575@ temp_15_1~2640@))) (=> (= temp_15_0~2575@ temp_15_1~2640@) (=> (= temp_16_0~2729@ (Mul (Mul a16~130@ (Mul (Mul 8 b16~132@) (Mul b16~132@ b16~132@))) (Add (Mul (Mul a16~130@ c16~134@) (Add d16~136@ c16~134@)) (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ a16~130@))))) (=> (= temp_16_1~2794@ (Mul (Mul a16~130@ (Mul (Mul (Mul 8 b16~132@) b16~132@) b16~132@)) (Add (Mul (Mul a16~130@ c16~134@) (Add d16~136@ c16~134@)) (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ a16~130@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2729@ temp_16_1~2794@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
