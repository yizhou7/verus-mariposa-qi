...
(set-info :comment ";; mariposa_data/v_nl//12272322958713611085/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_13_0~2479@ Int)
(declare-const temp_13_1~2540@ Int)
(declare-const temp_14_0~2651@ Int)
(declare-const temp_14_1~2728@ Int)
(declare-const temp_15_0~2839@ Int)
(declare-const temp_15_1~2904@ Int)
(declare-const temp_16_0~3005@ Int)
(declare-const temp_16_1~3070@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Add (Mul (Sub a0~2@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Add c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ b0~4@) c0~6@)))) (=> (= temp_0_1~362@ (Mul (Add (Mul (Sub a0~2@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Add c0~6@ a0~2@) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ b0~4@) c0~6@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ d0~8@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~451@ (Mul (Mul (Mul (Add d1~16@ b1~12@) a1~10@) (Mul (Sub c1~14@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Mul (Sub b1~12@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~512@ (Mul (Mul (Mul (Add d1~16@ b1~12@) a1~10@) (Mul (Sub c1~14@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Mul (Sub b1~12@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ b1~12@) (=> %%location_label%%1 (= temp_1_0~451@ temp_1_1~512@))) (=> (= temp_1_0~451@ temp_1_1~512@) (=> (= temp_2_0~605@ (Mul (Sub (Add (Mul d2~24@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~670@ (Mul (Sub (Add (Mul d2~24@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ b2~20@) (=> %%location_label%%2 (= temp_2_0~605@ temp_2_1~670@))) (=> (= temp_2_0~605@ temp_2_1~670@) (=> (= temp_3_0~775@ (Mul (Mul (Add (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (Add (Sub (Mul a3~26@ c3~30@) (Mul d3~32@ 19)) (Mul (Sub b3~28@ d3~32@) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~852@ (Mul (Mul (Add (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (Add (Sub (Mul a3~26@ c3~30@) (Mul d3~32@ 19)) (Mul (Mul c3~30@ c3~30@) (Sub b3~28@ d3~32@))))) (and (=> (= tmp%1@ (Sub b3~28@ d3~32@)) (=> (= tmp%2@ (Mul c3~30@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%3 (= temp_3_0~775@ temp_3_1~852@))))) (=> (= temp_3_0~775@ temp_3_1~852@) (=> (= temp_4_0~953@ (Mul (Mul (Add (Add a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Add (Add d4~40@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ c4~38@) (Sub c4~38@ b4~36@)) (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~1018@ (Mul (Mul (Add (Add a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Add (Add d4~40@ a4~34@) (Mul d4~40@ b4~36@))) (Mul (Mul a4~34@ c4~38@) (Mul (Sub c4~38@ b4~36@) (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ b4~36@)))))) (and (=> (= tmp%3@ (Mul a4~34@ c4~38@)) (=> (= tmp%4@ (Sub c4~38@ b4~36@)) (=> (= tmp%5@ (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ b4~36@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%4 (= temp_4_0~953@ temp_4_1~1018@)))))) (=> (= temp_4_0~953@ temp_4_1~1018@) (=> (= temp_5_0~1117@ (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ d5~48@)) (Mul b5~44@ (Mul c5~46@ a5~42@))) (Mul c5~46@ (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1166@ (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ d5~48@)) (Mul b5~44@ (Mul c5~46@ a5~42@))) (Mul c5~46@ (Mul (Mul (Sub d5~48@ b5~44@) c5~46@) b5~44@)))) (and (=> (= tmp%6@ (Sub d5~48@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ c5~46@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1117@ temp_5_1~1166@)))) (=> (= temp_5_0~1117@ temp_5_1~1166@) (=> (= temp_6_0~1249@ (Mul (Mul (Add (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@)) a6~50@) (Mul (Sub (Add a6~50@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Add a6~50@ c6~54@) b6~52@)))) (=> (= temp_6_1~1298@ (Mul (Mul (Sub (Add a6~50@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Add a6~50@ c6~54@) b6~52@)) (Mul (Add (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@)) a6~50@))) (and (=> (= tmp%7@ (Mul (Add (Mul a6~50@ a6~50@) (Mul c6~54@ b6~52@)) a6~50@)) (=> (= tmp%8@ (Mul (Sub (Add a6~50@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Add a6~50@ c6~54@) b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~1249@ temp_6_1~1298@))))) (=> (= temp_6_0~1249@ temp_6_1~1298@) (=> (= temp_7_0~1419@ (Mul (Mul c7~62@ (Sub (Mul c7~62@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1472@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@))) (Mul c7~62@ (Sub (Mul c7~62@ b7~60@) (Mul a7~58@ a7~58@))))) (and (=> (= tmp%9@ (Mul c7~62@ (Sub (Mul c7~62@ b7~60@) (Mul a7~58@ a7~58@)))) (=> (= tmp%10@ (Mul (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~1419@ temp_7_1~1472@))))) (=> (= temp_7_0~1419@ temp_7_1~1472@) (=> (= temp_8_0~1621@ (Mul (Mul (Mul (Add b8~68@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Mul 91 d8~72@) (Add d8~72@ d8~72@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@))))) (=> (= temp_8_1~1698@ (Mul (Mul (Mul (Add b8~68@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Mul 91 d8~72@) (Add d8~72@ d8~72@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ d8~72@)) (Mul b8~68@ (Mul d8~72@ (Mul b8~68@ d8~72@)))))) (and (=> (= tmp%11@ (Mul b8~68@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b8~68@ d8~72@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~1621@ temp_8_1~1698@)))) (=> (= temp_8_0~1621@ temp_8_1~1698@) (=> (= temp_9_0~1789@ (Add (Mul (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ d9~80@)) (Mul d9~80@ (Mul c9~78@ b9~76@))) (Mul (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ d9~80@)) (Mul (Mul c9~78@ d9~80@) a9~74@)))) (=> (= temp_9_1~1846@ (Add (Mul (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ d9~80@)) (Mul d9~80@ (Mul c9~78@ b9~76@))) (Mul (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) a9~74@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c9~78@ d9~80@) (=> %%location_label%%9 (= temp_9_0~1789@ temp_9_1~1846@))) (=> (= temp_9_0~1789@ temp_9_1~1846@) (=> (= temp_10_0~1939@ (Mul (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul a10~82@ a10~82@)) (Mul (Mul d10~88@ (Mul b10~84@ d10~88@)) (Mul (Mul b10~84@ 40) (Mul b10~84@ a10~82@))))) (=> (= temp_10_1~2004@ (Mul (Mul (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul a10~82@ a10~82@)) (Mul d10~88@ (Mul b10~84@ d10~88@))) (Mul (Mul b10~84@ 40) (Mul b10~84@ a10~82@)))) (and (=> (= tmp%12@ (Add (Mul (Mul a10~82@ d10~88@) (Mul d10~88@ c10~86@)) (Mul a10~82@ a10~82@))) (=> (= tmp%13@ (Mul d10~88@ (Mul b10~84@ d10~88@))) (=> (= tmp%14@ (Mul (Mul b10~84@ 40) (Mul b10~84@ a10~82@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%10 (= temp_10_0~1939@ temp_10_1~2004@)))))) (=> (= temp_10_0~1939@ temp_10_1~2004@) (=> (= temp_11_0~2147@ (Mul (Add (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ b11~92@) (Add a11~90@ d11~96@))) (Mul (Mul (Add a11~90@ a11~90@) (Mul a11~90@ b11~92@)) (Mul (Add a11~90@ a11~90@) b11~92@)))) (=> (= temp_11_1~2208@ (Mul (Add (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ d11~96@)) (Mul (Mul c11~94@ b11~92@) (Add a11~90@ d11~96@))) (Mul (Mul (Add a11~90@ a11~90@) (Mul a11~90@ b11~92@)) (Mul (Add a11~90@ a11~90@) b11~92@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d11~96@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2147@ temp_11_1~2208@))) (=> (= temp_11_0~2147@ temp_11_1~2208@) (=> (= temp_12_0~2313@ (Sub (Mul (Mul (Sub d12~104@ d12~104@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul 45 a12~98@))) (Sub (Mul (Mul b12~100@ c12~102@) (Add d12~104@ c12~102@)) (Sub (Mul c12~102@ c12~102@) (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2390@ (Sub (Mul (Mul (Sub d12~104@ d12~104@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ c12~102@) (Mul 45 a12~98@))) (Sub (Mul (Mul c12~102@ b12~100@) (Add d12~104@ c12~102@)) (Sub (Mul c12~102@ c12~102@) (Mul a12~98@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ c12~102@) (=> %%location_label%%12 (= temp_12_0~2313@ temp_12_1~2390@))) (=> (= temp_12_0~2313@ temp_12_1~2390@) (=> (= temp_13_0~2479@ (Sub (Add (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ c13~110@)) (Sub (Mul d13~112@ c13~110@) d13~112@)) (Mul (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@)) (Mul (Add a13~106@ c13~110@) (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2540@ (Sub (Add (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ c13~110@)) (Sub (Mul d13~112@ c13~110@) d13~112@)) (Mul (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ a13~106@)) (Mul (Mul (Add a13~106@ c13~110@) b13~108@) d13~112@)))) (and (=> (= tmp%15@ (Add a13~106@ c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%15@ b13~108@ d13~112@) (=> %%location_label%%13 (= temp_13_0~2479@ temp_13_1~2540@)))) (=> (= temp_13_0~2479@ temp_13_1~2540@) (=> (= temp_14_0~2651@ (Mul (Mul (Mul (Mul b14~116@ a14~114@) (Mul 21 c14~118@)) (Mul (Mul b14~116@ a14~114@) (Mul a14~114@ a14~114@))) (Mul (Mul (Sub c14~118@ b14~116@) (Add d14~120@ d14~120@)) (Mul (Mul a14~114@ a14~114@) (Sub d14~120@ d14~120@))))) (=> (= temp_14_1~2728@ (Mul (Mul (Mul b14~116@ (Mul a14~114@ (Mul 21 c14~118@))) (Mul (Mul b14~116@ a14~114@) (Mul a14~114@ a14~114@))) (Mul (Mul (Sub c14~118@ b14~116@) (Add d14~120@ d14~120@)) (Mul (Mul a14~114@ a14~114@) (Sub d14~120@ d14~120@))))) (and (=> (= tmp%16@ (Mul 21 c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b14~116@ a14~114@ tmp%16@) (=> %%location_label%%14 (= temp_14_0~2651@ temp_14_1~2728@)))) (=> (= temp_14_0~2651@ temp_14_1~2728@) (=> (= temp_15_0~2839@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul d15~128@ b15~124@)) (Mul (Sub d15~128@ d15~128@) (Add c15~126@ c15~126@))) (Mul (Mul (Mul c15~126@ d15~128@) (Mul b15~124@ c15~126@)) (Add (Mul b15~124@ d15~128@) (Mul a15~122@ a15~122@))))) (=> (= temp_15_1~2904@ (Mul (Mul (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ c15~126@)) (Mul (Sub d15~128@ d15~128@) (Add c15~126@ c15~126@))) (Mul (Mul (Mul c15~126@ d15~128@) (Mul b15~124@ c15~126@)) (Add (Mul b15~124@ d15~128@) (Mul a15~122@ a15~122@))))) (and (=> (= tmp%17@ (Mul c15~126@ c15~126@)) (=> (= tmp%18@ (Mul d15~128@ b15~124@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%17@ tmp%18@) (=> %%location_label%%15 (= temp_15_0~2839@ temp_15_1~2904@))))) (=> (= temp_15_0~2839@ temp_15_1~2904@) (=> (= temp_16_0~3005@ (Mul (Mul a16~130@ (Mul (Mul 8 b16~132@) (Mul b16~132@ b16~132@))) (Add (Mul (Mul a16~130@ c16~134@) (Add d16~136@ c16~134@)) (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ a16~130@))))) (=> (= temp_16_1~3070@ (Mul (Mul a16~130@ (Mul (Mul (Mul 8 b16~132@) b16~132@) b16~132@)) (Add (Mul (Mul a16~130@ c16~134@) (Add d16~136@ c16~134@)) (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ a16~130@))))) (=> (= tmp%19@ (Mul 8 b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%19@ b16~132@ b16~132@) (=> %%location_label%%16 (= temp_16_0~3005@ temp_16_1~3070@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
