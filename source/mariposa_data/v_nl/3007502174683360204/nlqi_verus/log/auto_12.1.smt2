...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Mul d0~8@ (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul 77 a0~2@)) (Sub (Mul a0~2@ d0~8@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~398@ (Sub (Mul d0~8@ (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Sub (Mul (Mul (Mul b0~4@ d0~8@) (Mul 77 a0~2@)) (Mul a0~2@ d0~8@)) (Mul (Mul (Mul b0~4@ d0~8@) (Mul 77 a0~2@)) (Mul a0~2@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~398@))) (=> (= temp_0_0~305@ temp_0_1~398@) (=> (= temp_1_0~487@ (Mul (Mul (Sub (Sub b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Sub c1~14@ c1~14@) (Add b1~12@ a1~10@))) (Mul (Mul (Add d1~16@ a1~10@) (Mul c1~14@ d1~16@)) (Add (Mul c1~14@ a1~10@) (Add b1~12@ a1~10@))))) (=> (= temp_1_1~552@ (Mul (Mul (Mul (Add d1~16@ a1~10@) (Mul c1~14@ d1~16@)) (Add (Mul c1~14@ a1~10@) (Add b1~12@ a1~10@))) (Mul (Sub (Sub b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Sub c1~14@ c1~14@) (Add b1~12@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~487@ temp_1_1~552@))) (=> (= temp_1_0~487@ temp_1_1~552@) (=> (= temp_2_0~657@ (Mul (Mul (Sub (Mul b2~20@ 70) (Add c2~22@ a2~18@)) (Mul (Mul a2~18@ c2~22@) a2~18@)) (Mul (Mul (Mul a2~18@ c2~22@) (Mul 29 b2~20@)) (Mul (Mul c2~22@ d2~24@) c2~22@)))) (=> (= temp_2_1~750@ (Mul (Sub (Mul (Mul b2~20@ 70) (Mul (Mul a2~18@ c2~22@) a2~18@)) (Mul (Add c2~22@ a2~18@) (Mul (Mul a2~18@ c2~22@) a2~18@))) (Mul (Mul (Mul a2~18@ c2~22@) (Mul 29 b2~20@)) (Mul (Mul c2~22@ d2~24@) c2~22@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~657@ temp_2_1~750@))) (=> (= temp_2_0~657@ temp_2_1~750@) (=> (= temp_3_0~839@ (Mul (Sub (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ d3~32@) (Add b3~28@ d3~32@))) (Mul (Sub (Add b3~28@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Add d3~32@ c3~30@) (Add c3~30@ d3~32@))))) (=> (= temp_3_1~904@ (Mul (Sub (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ d3~32@) (Add b3~28@ d3~32@))) (Mul (Sub (Add b3~28@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Add d3~32@ c3~30@) (Add c3~30@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~839@ temp_3_1~904@))) (=> (= temp_3_0~839@ temp_3_1~904@) (=> (= temp_4_0~989@ (Mul (Mul (Mul (Add 10 a4~34@) b4~36@) (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ b4~36@))) (Mul d4~40@ (Mul (Sub d4~40@ d4~40@) (Add a4~34@ b4~36@))))) (=> (= temp_4_1~1058@ (Mul (Mul (Mul (Add 10 a4~34@) b4~36@) (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ b4~36@))) (Mul d4~40@ (Add (Mul (Sub d4~40@ d4~40@) a4~34@) (Mul (Sub d4~40@ d4~40@) b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~989@ temp_4_1~1058@))) (=> (= temp_4_0~989@ temp_4_1~1058@) (=> (= temp_5_0~1147@ (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Sub d5~48@ c5~46@))) (Mul (Add (Mul a5~42@ c5~46@) (Add c5~46@ d5~48@)) (Mul (Sub d5~48@ c5~46@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1212@ (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Sub d5~48@ c5~46@))) (Mul (Add (Mul c5~46@ a5~42@) (Add c5~46@ d5~48@)) (Mul (Sub d5~48@ c5~46@) (Mul a5~42@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1147@ temp_5_1~1212@))) (=> (= temp_5_0~1147@ temp_5_1~1212@) (=> (= temp_6_0~1313@ (Add (Add (Sub (Add c6~54@ c6~54@) (Mul 55 a6~50@)) (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ a6~50@))) (Sub (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@))))) (=> (= temp_6_1~1390@ (Add (Add (Sub (Add c6~54@ c6~54@) (Mul 55 a6~50@)) (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ a6~50@))) (Sub (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1313@ temp_6_1~1390@))) (=> (= temp_6_0~1313@ temp_6_1~1390@) (=> (= temp_7_0~1487@ (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul 33 a7~58@) (Mul b7~60@ c7~62@))) (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ c7~62@) d7~64@)))) (=> (= temp_7_1~1560@ (Mul (Mul (Mul (Mul (Mul d7~64@ d7~64@) c7~62@) c7~62@) (Mul (Mul 33 a7~58@) (Mul b7~60@ c7~62@))) (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ c7~62@) d7~64@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1487@ temp_7_1~1560@))) (=> (= temp_7_0~1487@ temp_7_1~1560@) (=> (= temp_8_0~1649@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ d8~72@)) (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ d8~72@))) (Sub (Sub (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@))))) (=> (= temp_8_1~1714@ (Mul (Sub (Sub (Mul a8~66@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ d8~72@)) (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1649@ temp_8_1~1714@))) (=> (= temp_8_0~1649@ temp_8_1~1714@) (=> (= temp_9_0~1815@ (Mul (Add (Mul (Mul a9~74@ c9~78@) (Mul d9~80@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ a9~74@))) (Mul (Add (Mul a9~74@ a9~74@) (Mul 9 a9~74@)) (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~1892@ (Mul (Add (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ c9~78@)) (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ a9~74@))) (Mul (Add (Mul a9~74@ a9~74@) (Mul 9 a9~74@)) (Mul (Mul a9~74@ c9~78@) (Mul b9~76@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1815@ temp_9_1~1892@))) (=> (= temp_9_0~1815@ temp_9_1~1892@) (=> (= temp_10_0~1981@ (Mul (Mul (Mul (Mul a10~82@ b10~84@) (Mul d10~88@ a10~82@)) d10~88@) (Mul (Mul (Mul c10~86@ 48) (Mul a10~82@ a10~82@)) (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~2046@ (Mul (Mul (Mul a10~82@ (Mul b10~84@ (Mul d10~88@ a10~82@))) d10~88@) (Mul (Mul (Mul c10~86@ 48) (Mul a10~82@ a10~82@)) (Mul (Mul a10~82@ a10~82@) (Mul c10~86@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1981@ temp_10_1~2046@))) (=> (= temp_10_0~1981@ temp_10_1~2046@) (=> (= temp_11_0~2135@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ c11~94@)) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ d11~96@)) (Add (Mul b11~92@ c11~94@) (Mul c11~94@ c11~94@))))) (=> (= temp_11_1~2200@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Mul c11~94@ c11~94@)) (Mul (Mul c11~94@ c11~94@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ d11~96@)) (Add (Mul b11~92@ c11~94@) (Mul c11~94@ c11~94@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2135@ temp_11_1~2200@))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
