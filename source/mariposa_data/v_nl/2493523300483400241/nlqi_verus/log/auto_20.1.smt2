...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Add (Mul (Mul (Add b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Add c0~6@ b0~4@) (Mul a0~2@ d0~8@))) (Mul c0~6@ (Mul c0~6@ (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~338@ (Add (Mul (Mul (Add b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Add c0~6@ b0~4@) (Mul a0~2@ d0~8@))) (Mul c0~6@ (Mul (Mul b0~4@ b0~4@) c0~6@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~338@))) (=> (= temp_0_0~289@ temp_0_1~338@) (=> (= temp_1_0~423@ (Add (Mul (Mul b1~12@ (Mul a1~10@ a1~10@)) (Mul (Add a1~10@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~484@ (Add (Mul (Mul b1~12@ (Mul a1~10@ a1~10@)) (Mul (Add a1~10@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~423@ temp_1_1~484@))) (=> (= temp_1_0~423@ temp_1_1~484@) (=> (= temp_2_0~561@ (Mul (Mul (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ a2~18@)) b2~20@) (Mul (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@)) (Add (Mul c2~22@ a2~18@) (Sub c2~22@ a2~18@))))) (=> (= temp_2_1~614@ (Mul (Mul (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ a2~18@)) b2~20@) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ c2~22@)) (Add (Mul c2~22@ a2~18@) (Sub c2~22@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~561@ temp_2_1~614@))) (=> (= temp_2_0~561@ temp_2_1~614@) (=> (= temp_3_0~703@ (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))) (Add (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Sub c3~30@ a3~26@))))) (=> (= temp_3_1~768@ (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ d3~32@))) (Add (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Sub c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~703@ temp_3_1~768@))) (=> (= temp_3_0~703@ temp_3_1~768@) (=> (= temp_4_0~853@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ a4~34@)) (Mul d4~40@ (Mul a4~34@ c4~38@))) (Sub (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~914@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ a4~34@)) (Mul d4~40@ (Mul a4~34@ c4~38@))) (Sub (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~853@ temp_4_1~914@))) (=> (= temp_4_0~853@ temp_4_1~914@) (=> (= temp_5_0~1003@ (Add (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Sub b5~44@ b5~44@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1068@ (Add (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1003@ temp_5_1~1068@))) (=> (= temp_5_0~1003@ temp_5_1~1068@) (=> (= temp_6_0~1157@ (Add (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Sub a6~50@ b6~52@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ d6~56@) (Add b6~52@ a6~50@))))) (=> (= temp_6_1~1222@ (Add (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Sub a6~50@ b6~52@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Mul a6~50@ (Mul d6~56@ (Add b6~52@ a6~50@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1157@ temp_6_1~1222@))) (=> (= temp_6_0~1157@ temp_6_1~1222@) (=> (= temp_7_0~1299@ (Mul (Sub (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Sub a7~58@ a7~58@) (Mul a7~58@ a7~58@))) (Add (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ c7~62@)) d7~64@))) (=> (= temp_7_1~1352@ (Mul (Sub (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Sub a7~58@ a7~58@) (Mul a7~58@ a7~58@))) (Add (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ d7~64@)) d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1299@ temp_7_1~1352@))) (=> (= temp_7_0~1299@ temp_7_1~1352@) (=> (= temp_8_0~1441@ (Mul (Mul (Mul (Sub b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Add c8~70@ c8~70@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Sub d8~72@ b8~68@))))) (=> (= temp_8_1~1506@ (Mul (Mul (Mul (Sub b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Add c8~70@ c8~70@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Sub d8~72@ b8~68@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1441@ temp_8_1~1506@))) (=> (= temp_8_0~1441@ temp_8_1~1506@) (=> (= temp_9_0~1595@ (Mul (Mul d9~80@ (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ a9~74@))) (Mul (Sub (Sub d9~80@ a9~74@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Sub b9~76@ 5))))) (=> (= temp_9_1~1660@ (Mul (Mul d9~80@ (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ a9~74@))) (Mul (Sub (Sub d9~80@ a9~74@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Sub b9~76@ 5))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1595@ temp_9_1~1660@))) (=> (= temp_9_0~1595@ temp_9_1~1660@) (=> (= temp_10_0~1737@ (Sub (Add a10~82@ (Add (Mul d10~88@ a10~82@) (Mul b10~84@ b10~84@))) (Mul (Mul (Add b10~84@ b10~84@) (Mul b10~84@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@))))) (=> (= temp_10_1~1790@ (Sub (Add a10~82@ (Add (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))) (Mul (Mul (Add b10~84@ b10~84@) (Mul b10~84@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1737@ temp_10_1~1790@))) (=> (= temp_10_0~1737@ temp_10_1~1790@) (=> (= temp_11_0~1891@ (Mul (Mul (Sub (Mul b11~92@ c11~94@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul b11~92@ d11~96@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ 32) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~1968@ (Mul (Mul (Sub (Mul b11~92@ c11~94@) (Mul b11~92@ b11~92@)) (Mul (Mul (Mul b11~92@ d11~96@) c11~94@) b11~92@)) (Mul (Mul (Mul b11~92@ d11~96@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ 32) (Mul a11~90@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1891@ temp_11_1~1968@))) (=> (= temp_11_0~1891@ temp_11_1~1968@) (=> (= temp_12_0~2069@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul 68 d12~104@) (Mul d12~104@ d12~104@))) (Mul (Mul (Mul a12~98@ c12~102@) (Sub b12~100@ a12~98@)) (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2146@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul 68 d12~104@) (Mul d12~104@ d12~104@))) (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Sub b12~100@ a12~98@)) (Mul b12~100@ c12~102@)) (Mul d12~104@ a12~98@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2069@ temp_12_1~2146@))) (=> (= temp_12_0~2069@ temp_12_1~2146@) (=> (= temp_13_0~2251@ (Mul (Mul (Mul a13~106@ (Mul d13~112@ c13~110@)) (Mul (Sub b13~108@ 91) (Mul b13~108@ b13~108@))) (Mul (Add (Mul c13~110@ 5) (Mul a13~106@ d13~112@)) (Sub d13~112@ (Mul a13~106@ a13~106@))))) (=> (= temp_13_1~2344@ (Mul (Mul (Mul a13~106@ (Mul d13~112@ c13~110@)) (Mul (Sub b13~108@ 91) (Mul b13~108@ b13~108@))) (Add (Mul (Mul c13~110@ 5) (Sub d13~112@ (Mul a13~106@ a13~106@))) (Mul (Mul a13~106@ d13~112@) (Sub d13~112@ (Mul a13~106@ a13~106@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2251@ temp_13_1~2344@))) (=> (= temp_13_0~2251@ temp_13_1~2344@) (=> (= temp_14_0~2429@ (Sub (Mul (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ b14~116@))) (Mul (Mul (Sub c14~118@ d14~120@) c14~118@) (Mul (Add b14~116@ b14~116@) (Sub a14~114@ a14~114@))))) (=> (= temp_14_1~2490@ (Sub (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ b14~116@)) (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ a14~114@))) (Mul (Mul (Sub c14~118@ d14~120@) c14~118@) (Mul (Add b14~116@ b14~116@) (Sub a14~114@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2429@ temp_14_1~2490@))) (=> (= temp_14_0~2429@ temp_14_1~2490@) (=> (= temp_15_0~2615@ (Mul (Mul (Add (Sub d15~128@ 40) (Mul a15~122@ a15~122@)) (Mul (Sub b15~124@ 49) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul d15~128@ c15~126@) (Mul 64 d15~128@)) (Mul (Add a15~122@ a15~122@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2716@ (Mul (Mul (Mul (Add (Sub d15~128@ 40) (Mul a15~122@ a15~122@)) (Sub b15~124@ 49)) (Mul c15~126@ c15~126@)) (Mul (Mul (Mul d15~128@ c15~126@) (Mul 64 d15~128@)) (Mul (Add a15~122@ a15~122@) (Mul c15~126@ c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2615@ temp_15_1~2716@))) (=> (= temp_15_0~2615@ temp_15_1~2716@) (=> (= temp_16_0~2801@ (Mul (Mul (Mul a16~130@ (Mul a16~130@ b16~132@)) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ d16~136@))) (Mul (Sub (Mul a16~130@ d16~136@) (Mul a16~130@ d16~136@)) (Mul (Sub c16~134@ a16~130@) (Mul d16~136@ a16~130@))))) (=> (= temp_16_1~2862@ (Mul (Mul (Mul a16~130@ (Mul a16~130@ b16~132@)) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ d16~136@))) (Mul (Sub (Mul a16~130@ d16~136@) (Mul a16~130@ d16~136@)) (Mul (Mul (Sub c16~134@ a16~130@) d16~136@) a16~130@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2801@ temp_16_1~2862@))) (=> (= temp_16_0~2801@ temp_16_1~2862@) (=> (= temp_17_0~2959@ (Mul (Add (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@)) (Mul (Mul a17~138@ c17~142@) (Mul a17~138@ a17~138@))) (Mul (Mul (Add d17~144@ a17~138@) (Mul c17~142@ 40)) (Mul (Mul b17~140@ a17~138@) d17~144@)))) (=> (= temp_17_1~3032@ (Mul (Add (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@)) (Mul (Mul a17~138@ c17~142@) (Mul a17~138@ a17~138@))) (Mul (Mul (Mul (Add d17~144@ a17~138@) c17~142@) 40) (Mul (Mul b17~140@ a17~138@) d17~144@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2959@ temp_17_1~3032@))) (=> (= temp_17_0~2959@ temp_17_1~3032@) (=> (= temp_18_0~3133@ (Mul (Mul (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ b18~148@)) (Mul (Add d18~152@ 23) (Mul b18~148@ b18~148@))) (Mul (Add (Add a18~146@ d18~152@) (Sub a18~146@ d18~152@)) (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ a18~146@))))) (=> (= temp_18_1~3210@ (Mul (Mul (Mul (Add d18~152@ 23) (Mul b18~148@ b18~148@)) (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ b18~148@))) (Mul (Add (Add a18~146@ d18~152@) (Sub a18~146@ d18~152@)) (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3133@ temp_18_1~3210@))) (=> (= temp_18_0~3133@ temp_18_1~3210@) (=> (= temp_19_0~3279@ (Mul (Sub (Sub d19~160@ (Mul c19~158@ b19~156@)) (Sub (Mul a19~154@ d19~160@) a19~154@)) (Mul a19~154@ (Mul (Sub a19~154@ c19~158@) (Mul b19~156@ a19~154@))))) (=> (= temp_19_1~3344@ (Sub (Mul (Sub d19~160@ (Mul c19~158@ b19~156@)) (Mul a19~154@ (Mul (Sub a19~154@ c19~158@) (Mul b19~156@ a19~154@)))) (Mul (Sub (Mul a19~154@ d19~160@) a19~154@) (Mul a19~154@ (Mul (Sub a19~154@ c19~158@) (Mul b19~156@ a19~154@)))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3279@ temp_19_1~3344@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
