...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Add (Mul (Mul (Add b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Add c0~6@ b0~4@) (Mul a0~2@ d0~8@))) (Mul c0~6@ (Mul c0~6@ (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~338@ (Add (Mul (Mul (Add b0~4@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Add c0~6@ b0~4@) (Mul a0~2@ d0~8@))) (Mul c0~6@ (Mul (Mul b0~4@ b0~4@) c0~6@)))) (=> (= tmp%1@ (= temp_0_0~289@ temp_0_1~338@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~414@ (Add (Mul (Mul b1~12@ (Mul a1~10@ a1~10@)) (Mul (Add a1~10@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~475@ (Add (Mul (Mul b1~12@ (Mul a1~10@ a1~10@)) (Mul (Add a1~10@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~414@ temp_1_1~475@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~543@ (Mul (Mul (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ a2~18@)) b2~20@) (Mul (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@)) (Add (Mul c2~22@ a2~18@) (Sub c2~22@ a2~18@))))) (=> (= temp_2_1~596@ (Mul (Mul (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ a2~18@)) b2~20@) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ c2~22@)) (Add (Mul c2~22@ a2~18@) (Sub c2~22@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~543@ temp_2_1~596@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~676@ (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))) (Add (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Sub c3~30@ a3~26@))))) (=> (= temp_3_1~741@ (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ d3~32@))) (Add (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Sub c3~30@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~676@ temp_3_1~741@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~817@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ a4~34@)) (Mul d4~40@ (Mul a4~34@ c4~38@))) (Sub (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~878@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ a4~34@)) (Mul d4~40@ (Mul a4~34@ c4~38@))) (Sub (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~817@ temp_4_1~878@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~958@ (Add (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Sub b5~44@ b5~44@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1023@ (Add (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~958@ temp_5_1~1023@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1103@ (Add (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Sub a6~50@ b6~52@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ d6~56@) (Add b6~52@ a6~50@))))) (=> (= temp_6_1~1168@ (Add (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Sub a6~50@ b6~52@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Mul a6~50@ (Mul d6~56@ (Add b6~52@ a6~50@)))))) (=> (= tmp%7@ (= temp_6_0~1103@ temp_6_1~1168@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1236@ (Mul (Sub (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Sub a7~58@ a7~58@) (Mul a7~58@ a7~58@))) (Add (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ c7~62@)) d7~64@))) (=> (= temp_7_1~1289@ (Mul (Sub (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Sub a7~58@ a7~58@) (Mul a7~58@ a7~58@))) (Add (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ d7~64@)) d7~64@))) (=> (= tmp%8@ (= temp_7_0~1236@ temp_7_1~1289@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1369@ (Mul (Mul (Mul (Sub b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Add c8~70@ c8~70@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Sub d8~72@ b8~68@))))) (=> (= temp_8_1~1434@ (Mul (Mul (Mul (Sub b8~68@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Add c8~70@ c8~70@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Sub d8~72@ b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1369@ temp_8_1~1434@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1514@ (Mul (Mul d9~80@ (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ a9~74@))) (Mul (Sub (Sub d9~80@ a9~74@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Sub b9~76@ 5))))) (=> (= temp_9_1~1579@ (Mul (Mul d9~80@ (Mul (Mul d9~80@ d9~80@) (Mul b9~76@ a9~74@))) (Mul (Sub (Sub d9~80@ a9~74@) (Mul d9~80@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Sub b9~76@ 5))))) (=> (= tmp%10@ (= temp_9_0~1514@ temp_9_1~1579@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1647@ (Sub (Add a10~82@ (Add (Mul d10~88@ a10~82@) (Mul b10~84@ b10~84@))) (Mul (Mul (Add b10~84@ b10~84@) (Mul b10~84@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@))))) (=> (= temp_10_1~1700@ (Sub (Add a10~82@ (Add (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))) (Mul (Mul (Add b10~84@ b10~84@) (Mul b10~84@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@))))) (=> (= tmp%11@ (= temp_10_0~1647@ temp_10_1~1700@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1792@ (Mul (Mul (Sub (Mul b11~92@ c11~94@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul b11~92@ d11~96@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ 32) (Mul a11~90@ c11~94@))))) (=> (= temp_11_1~1869@ (Mul (Mul (Sub (Mul b11~92@ c11~94@) (Mul b11~92@ b11~92@)) (Mul (Mul (Mul b11~92@ d11~96@) c11~94@) b11~92@)) (Mul (Mul (Mul b11~92@ d11~96@) (Mul b11~92@ b11~92@)) (Mul (Mul b11~92@ 32) (Mul a11~90@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1792@ temp_11_1~1869@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1961@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul 68 d12~104@) (Mul d12~104@ d12~104@))) (Mul (Mul (Mul a12~98@ c12~102@) (Sub b12~100@ a12~98@)) (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ a12~98@))))) (=> (= temp_12_1~2038@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ c12~102@)) (Mul (Mul 68 d12~104@) (Mul d12~104@ d12~104@))) (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Sub b12~100@ a12~98@)) (Mul b12~100@ c12~102@)) (Mul d12~104@ a12~98@)))) (=> (= tmp%13@ (= temp_12_0~1961@ temp_12_1~2038@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2134@ (Mul (Mul (Mul a13~106@ (Mul d13~112@ c13~110@)) (Mul (Sub b13~108@ 91) (Mul b13~108@ b13~108@))) (Mul (Add (Mul c13~110@ 5) (Mul a13~106@ d13~112@)) (Sub d13~112@ (Mul a13~106@ a13~106@))))) (=> (= temp_13_1~2227@ (Mul (Mul (Mul a13~106@ (Mul d13~112@ c13~110@)) (Mul (Sub b13~108@ 91) (Mul b13~108@ b13~108@))) (Add (Mul (Mul c13~110@ 5) (Sub d13~112@ (Mul a13~106@ a13~106@))) (Mul (Mul a13~106@ d13~112@) (Sub d13~112@ (Mul a13~106@ a13~106@)))))) (=> (= tmp%14@ (= temp_13_0~2134@ temp_13_1~2227@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2303@ (Sub (Mul (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ b14~116@))) (Mul (Mul (Sub c14~118@ d14~120@) c14~118@) (Mul (Add b14~116@ b14~116@) (Sub a14~114@ a14~114@))))) (=> (= temp_14_1~2364@ (Sub (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ b14~116@)) (Mul (Mul d14~120@ c14~118@) (Mul d14~120@ a14~114@))) (Mul (Mul (Sub c14~118@ d14~120@) c14~118@) (Mul (Add b14~116@ b14~116@) (Sub a14~114@ a14~114@))))) (=> (= tmp%15@ (= temp_14_0~2303@ temp_14_1~2364@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2480@ (Mul (Mul (Add (Sub d15~128@ 40) (Mul a15~122@ a15~122@)) (Mul (Sub b15~124@ 49) (Mul c15~126@ c15~126@))) (Mul (Mul (Mul d15~128@ c15~126@) (Mul 64 d15~128@)) (Mul (Add a15~122@ a15~122@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2581@ (Mul (Mul (Mul (Add (Sub d15~128@ 40) (Mul a15~122@ a15~122@)) (Sub b15~124@ 49)) (Mul c15~126@ c15~126@)) (Mul (Mul (Mul d15~128@ c15~126@) (Mul 64 d15~128@)) (Mul (Add a15~122@ a15~122@) (Mul c15~126@ c15~126@))))) (=> (= tmp%16@ (= temp_15_0~2480@ temp_15_1~2581@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2657@ (Mul (Mul (Mul a16~130@ (Mul a16~130@ b16~132@)) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ d16~136@))) (Mul (Sub (Mul a16~130@ d16~136@) (Mul a16~130@ d16~136@)) (Mul (Sub c16~134@ a16~130@) (Mul d16~136@ a16~130@))))) (=> (= temp_16_1~2718@ (Mul (Mul (Mul a16~130@ (Mul a16~130@ b16~132@)) (Mul (Mul d16~136@ d16~136@) (Mul d16~136@ d16~136@))) (Mul (Sub (Mul a16~130@ d16~136@) (Mul a16~130@ d16~136@)) (Mul (Mul (Sub c16~134@ a16~130@) d16~136@) a16~130@)))) (=> (= tmp%17@ (= temp_16_0~2657@ temp_16_1~2718@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2806@ (Mul (Add (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@)) (Mul (Mul a17~138@ c17~142@) (Mul a17~138@ a17~138@))) (Mul (Mul (Add d17~144@ a17~138@) (Mul c17~142@ 40)) (Mul (Mul b17~140@ a17~138@) d17~144@)))) (=> (= temp_17_1~2879@ (Mul (Add (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ a17~138@)) (Mul (Mul a17~138@ c17~142@) (Mul a17~138@ a17~138@))) (Mul (Mul (Mul (Add d17~144@ a17~138@) c17~142@) 40) (Mul (Mul b17~140@ a17~138@) d17~144@)))) (=> (= tmp%18@ (= temp_17_0~2806@ temp_17_1~2879@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2971@ (Mul (Mul (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ b18~148@)) (Mul (Add d18~152@ 23) (Mul b18~148@ b18~148@))) (Mul (Add (Add a18~146@ d18~152@) (Sub a18~146@ d18~152@)) (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ a18~146@))))) (=> (= temp_18_1~3048@ (Mul (Mul (Mul (Add d18~152@ 23) (Mul b18~148@ b18~148@)) (Mul (Mul c18~150@ b18~148@) (Mul c18~150@ b18~148@))) (Mul (Add (Add a18~146@ d18~152@) (Sub a18~146@ d18~152@)) (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ a18~146@))))) (=> (= tmp%19@ (= temp_18_0~2971@ temp_18_1~3048@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3108@ (Mul (Sub (Sub d19~160@ (Mul c19~158@ b19~156@)) (Sub (Mul a19~154@ d19~160@) a19~154@)) (Mul a19~154@ (Mul (Sub a19~154@ c19~158@) (Mul b19~156@ a19~154@))))) (=> (= temp_19_1~3173@ (Sub (Mul (Sub d19~160@ (Mul c19~158@ b19~156@)) (Mul a19~154@ (Mul (Sub a19~154@ c19~158@) (Mul b19~156@ a19~154@)))) (Mul (Sub (Mul a19~154@ d19~160@) a19~154@) (Mul a19~154@ (Mul (Sub a19~154@ c19~158@) (Mul b19~156@ a19~154@)))))) (=> (= tmp%20@ (= temp_19_0~3108@ temp_19_1~3173@)) (=> %%location_label%%19 tmp%20@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
