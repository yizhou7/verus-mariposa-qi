...
(declare-const temp_1_1~603@ Int)
(declare-const temp_2_0~747@ Int)
(declare-const temp_2_1~876@ Int)
(declare-const temp_3_0~1032@ Int)
(declare-const temp_3_1~1173@ Int)
(declare-const temp_4_0~1313@ Int)
(declare-const temp_4_1~1438@ Int)
(declare-const temp_5_0~1574@ Int)
(declare-const temp_5_1~1695@ Int)
(declare-const temp_6_0~1835@ Int)
(declare-const temp_6_1~1960@ Int)
(declare-const temp_7_0~2088@ Int)
(declare-const temp_7_1~2233@ Int)
(declare-const temp_8_0~2341@ Int)
(declare-const temp_8_1~2434@ Int)
(declare-const temp_9_0~2566@ Int)
(declare-const temp_9_1~2683@ Int)
(declare-const temp_10_0~2819@ Int)
(declare-const temp_10_1~2940@ Int)
(declare-const temp_11_0~3052@ Int)
(declare-const temp_11_1~3149@ Int)
(declare-const temp_12_0~3289@ Int)
(declare-const temp_12_1~3414@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~253@ (Mul (Sub (Add (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul d0~8@ 70) (Mul a0~2@ b0~4@))) (Mul (Add d0~8@ a0~2@) (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ d0~8@)))) (Mul (Mul b0~4@ (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ a0~2@))) b0~4@))) (=> (= temp_0_1~346@ (Mul (Sub (Add (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul d0~8@ 70) (Mul a0~2@ b0~4@))) (Mul (Add d0~8@ a0~2@) (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ d0~8@)))) (Mul (Mul b0~4@ (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ c0~6@))) b0~4@))) (=> (= tmp%1@ (= temp_0_0~253@ temp_0_1~346@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~482@ (Mul (Mul (Mul (Mul (Add b1~12@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Sub a1~10@ c1~14@) (Add c1~14@ c1~14@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ c1~14@) d1~16@) (Mul b1~12@ (Mul a1~10@ d1~16@))) (Sub (Add (Mul d1~16@ b1~12@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Add d1~16@ c1~14@)))))) (=> (= temp_1_1~603@ (Mul (Mul (Mul (Mul (Add b1~12@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Sub a1~10@ c1~14@) (Add c1~14@ c1~14@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ c1~14@) d1~16@) (Mul b1~12@ (Mul d1~16@ a1~10@))) (Sub (Add (Mul d1~16@ b1~12@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Add d1~16@ c1~14@)))))) (=> (= tmp%2@ (= temp_1_0~482@ temp_1_1~603@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~747@ (Add (Sub (Sub (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@)) (Mul (Mul d2~24@ d2~24@) d2~24@)) (Sub (Mul (Sub b2~20@ d2~24@) (Add d2~24@ c2~22@)) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul (Mul d2~24@ 6) (Mul d2~24@ b2~20@)) (Sub (Mul b2~20@ c2~22@) (Mul a2~18@ b2~20@))) (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ a2~18@)))))) (=> (= temp_2_1~876@ (Add (Sub (Sub (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@)) (Mul (Mul d2~24@ d2~24@) d2~24@)) (Sub (Mul (Sub b2~20@ d2~24@) (Add d2~24@ c2~22@)) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul (Mul d2~24@ 6) (Mul d2~24@ b2~20@)) (Sub (Mul b2~20@ c2~22@) (Mul a2~18@ b2~20@))) (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ a2~18@)))))) (=> (= tmp%3@ (= temp_2_0~747@ temp_2_1~876@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1032@ (Add (Mul (Mul (Mul (Mul a3~26@ 50) (Mul b3~28@ a3~26@)) (Mul (Add b3~28@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul c3~30@ d3~32@) (Sub a3~26@ a3~26@)) (Mul (Add a3~26@ b3~28@) (Mul a3~26@ b3~28@)))) (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Sub (Mul c3~30@ a3~26@) (Mul d3~32@ c3~30@))) (Add (Add (Mul b3~28@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Sub c3~30@ c3~30@) (Mul c3~30@ b3~28@)))))) (=> (= temp_3_1~1173@ (Add (Mul (Mul (Mul (Mul a3~26@ 50) (Mul b3~28@ a3~26@)) (Mul (Add b3~28@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul c3~30@ (Mul d3~32@ (Sub a3~26@ a3~26@))) (Mul (Add a3~26@ b3~28@) (Mul a3~26@ b3~28@)))) (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Sub (Mul c3~30@ a3~26@) (Mul d3~32@ c3~30@))) (Add (Add (Mul b3~28@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Sub c3~30@ c3~30@) (Mul c3~30@ b3~28@)))))) (=> (= tmp%4@ (= temp_3_0~1032@ temp_3_1~1173@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1313@ (Mul (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ c4~38@)) (Mul c4~38@ (Mul d4~40@ b4~36@))) (Mul (Mul (Mul c4~38@ 18) (Mul a4~34@ b4~36@)) a4~34@)) (Mul (Mul (Sub (Mul c4~38@ b4~36@) (Sub b4~36@ d4~40@)) (Mul (Add d4~40@ d4~40@) (Mul b4~36@ d4~40@))) (Sub (Mul (Mul d4~40@ c4~38@) (Add c4~38@ c4~38@)) (Mul (Sub a4~34@ d4~40@) (Mul a4~34@ d4~40@)))))) (=> (= temp_4_1~1438@ (Mul (Mul (Mul (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ c4~38@)) (Mul c4~38@ (Mul d4~40@ b4~36@))) (Mul (Mul (Mul c4~38@ 18) (Mul a4~34@ b4~36@)) a4~34@)) (Mul (Mul (Sub (Mul c4~38@ b4~36@) (Sub b4~36@ d4~40@)) (Mul (Add d4~40@ d4~40@) (Mul b4~36@ d4~40@))) (Sub (Mul (Mul d4~40@ c4~38@) (Add c4~38@ c4~38@)) (Mul (Sub a4~34@ d4~40@) (Mul a4~34@ d4~40@)))))) (=> (= tmp%5@ (= temp_4_0~1313@ temp_4_1~1438@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1574@ (Mul (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Add b5~44@ a5~42@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@)))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@)))))) (=> (= temp_5_1~1695@ (Mul (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Add b5~44@ a5~42@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@)))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@)))))) (=> (= tmp%6@ (= temp_5_0~1574@ temp_5_1~1695@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1835@ (Mul (Mul (Mul (Sub (Sub b6~52@ d6~56@) (Add d6~56@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ b6~52@))) (Mul (Mul b6~52@ (Mul c6~54@ d6~56@)) c6~54@)) (Add (Mul (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Add d6~56@ b6~52@))) (Mul (Mul (Sub c6~54@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ d6~56@) (Mul 92 d6~56@)))))) (=> (= temp_6_1~1960@ (Mul (Mul (Mul (Sub (Sub b6~52@ d6~56@) (Add d6~56@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ b6~52@))) (Mul (Mul b6~52@ (Mul c6~54@ d6~56@)) c6~54@)) (Add (Mul (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Add d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul 92 d6~56@)) (Mul (Sub c6~54@ c6~54@) (Mul a6~50@ d6~56@)))))) (=> (= tmp%7@ (= temp_6_0~1835@ temp_6_1~1960@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2088@ (Mul (Mul b7~60@ (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@)) (Mul (Sub a7~58@ a7~58@) (Sub d7~64@ c7~62@)))) (Mul (Sub (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@)) (Mul (Mul b7~60@ 53) (Sub c7~62@ c7~62@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ a7~58@)))))) (=> (= temp_7_1~2233@ (Mul (Mul b7~60@ (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@)) (Mul (Sub a7~58@ a7~58@) (Sub d7~64@ c7~62@)))) (Sub (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@)) (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ a7~58@)))) (Mul (Mul (Mul b7~60@ 53) (Sub c7~62@ c7~62@)) (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul c7~62@ a7~58@))))))) (=> (= tmp%8@ (= temp_7_0~2088@ temp_7_1~2233@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2341@ (Mul (Mul (Mul (Mul c8~70@ (Mul c8~70@ c8~70@)) (Mul (Add d8~72@ a8~66@) (Sub d8~72@ b8~68@))) (Mul (Sub (Add c8~70@ c8~70@) (Mul d8~72@ b8~68@)) (Add (Mul c8~70@ d8~72@) (Mul c8~70@ a8~66@)))) (Sub (Mul (Mul (Mul b8~68@ b8~68@) (Mul b8~68@ d8~72@)) (Mul a8~66@ (Sub c8~70@ c8~70@))) c8~70@))) (=> (= temp_8_1~2434@ (Mul (Mul (Mul c8~70@ (Mul (Mul c8~70@ c8~70@) (Mul (Add d8~72@ a8~66@) (Sub d8~72@ b8~68@)))) (Mul (Sub (Add c8~70@ c8~70@) (Mul d8~72@ b8~68@)) (Add (Mul c8~70@ d8~72@) (Mul c8~70@ a8~66@)))) (Sub (Mul (Mul (Mul b8~68@ b8~68@) (Mul b8~68@ d8~72@)) (Mul a8~66@ (Sub c8~70@ c8~70@))) c8~70@))) (=> (= tmp%9@ (= temp_8_0~2341@ temp_8_1~2434@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2566@ (Mul (Mul (Mul (Mul (Mul a9~74@ a9~74@) c9~78@) (Mul (Mul c9~78@ 47) (Mul a9~74@ b9~76@))) (Add (Add (Mul c9~78@ c9~78@) (Mul b9~76@ a9~74@)) (Mul (Sub b9~76@ c9~78@) b9~76@))) (Mul (Mul (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ a9~74@)) d9~80@) (Mul (Mul d9~80@ (Mul b9~76@ d9~80@)) (Mul (Mul a9~74@ d9~80@) (Sub a9~74@ a9~74@)))))) (=> (= temp_9_1~2683@ (Mul (Mul (Mul (Mul (Mul a9~74@ a9~74@) c9~78@) (Mul (Mul c9~78@ 47) (Mul a9~74@ b9~76@))) (Add (Add (Mul c9~78@ c9~78@) (Mul b9~76@ a9~74@)) (Mul (Sub b9~76@ c9~78@) b9~76@))) (Mul (Mul (Mul (Mul a9~74@ a9~74@) (Mul c9~78@ a9~74@)) d9~80@) (Mul (Mul (Mul a9~74@ d9~80@) (Sub a9~74@ a9~74@)) (Mul d9~80@ (Mul b9~76@ d9~80@)))))) (=> (= tmp%10@ (= temp_9_0~2566@ temp_9_1~2683@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~2819@ (Mul (Mul (Mul (Mul (Add b10~84@ a10~82@) (Mul c10~86@ c10~86@)) (Sub (Mul b10~84@ b10~84@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul b10~84@ c10~86@) a10~82@) (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ b10~84@)))) (Mul (Add (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ a10~82@)) c10~86@) (Mul (Mul (Sub d10~88@ d10~88@) (Mul 94 a10~82@)) (Mul (Mul a10~82@ b10~84@) a10~82@))))) (=> (= temp_10_1~2940@ (Mul (Mul (Mul (Mul (Add b10~84@ a10~82@) (Mul c10~86@ c10~86@)) (Sub (Mul b10~84@ b10~84@) (Mul b10~84@ a10~82@))) (Mul (Mul (Mul b10~84@ c10~86@) a10~82@) (Mul (Mul d10~88@ d10~88@) (Mul d10~88@ b10~84@)))) (Mul (Add (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ a10~82@)) c10~86@) (Mul (Mul (Sub d10~88@ d10~88@) (Mul 94 a10~82@)) (Mul (Mul a10~82@ b10~84@) a10~82@))))) (=> (= tmp%11@ (= temp_10_0~2819@ temp_10_1~2940@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~3052@ (Mul (Sub (Mul (Mul (Mul c11~94@ a11~90@) (Mul d11~96@ b11~92@)) (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul a11~90@ c11~94@) b11~92@) (Mul (Mul c11~94@ c11~94@) (Mul a11~90@ a11~90@)))) (Sub (Mul (Mul (Sub b11~92@ c11~94@) (Add a11~90@ d11~96@)) (Add (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@))) b11~92@))) (=> (= temp_11_1~3149@ (Mul (Sub (Mul (Mul (Mul c11~94@ a11~90@) (Mul d11~96@ b11~92@)) (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul c11~94@ a11~90@) b11~92@) (Mul (Mul c11~94@ c11~94@) (Mul a11~90@ a11~90@)))) (Sub (Mul (Mul (Sub b11~92@ c11~94@) (Add a11~90@ d11~96@)) (Add (Mul a11~90@ d11~96@) (Mul b11~92@ a11~90@))) b11~92@))) (=> (= tmp%12@ (= temp_11_0~3052@ temp_11_1~3149@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~3289@ (Mul (Mul (Mul (Sub (Mul b12~100@ a12~98@) (Mul b12~100@ c12~102@)) (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ b12~100@))) (Mul (Mul (Add b12~100@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Add b12~100@ a12~98@) (Mul d12~104@ a12~98@)))) (Sub (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ d12~104@)) (Mul (Mul c12~102@ b12~100@) b12~100@)) (Sub (Mul (Add b12~100@ c12~102@) (Add a12~98@ d12~104@)) (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ c12~102@)))))) (=> (= temp_12_1~3414@ (Mul (Mul (Mul (Sub (Mul b12~100@ a12~98@) (Mul b12~100@ c12~102@)) (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ b12~100@))) (Mul (Mul (Add b12~100@ d12~104@) (Mul d12~104@ d12~104@)) (Mul (Add b12~100@ a12~98@) (Mul d12~104@ a12~98@)))) (Sub (Mul (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ d12~104@)) (Mul (Mul c12~102@ b12~100@) b12~100@)) (Sub (Mul (Add b12~100@ c12~102@) (Add a12~98@ d12~104@)) (Mul (Mul (Mul c12~102@ a12~98@) d12~104@) c12~102@))))) (=> (= tmp%13@ (= temp_12_0~3289@ temp_12_1~3414@)) (=> %%location_label%%12 tmp%13@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
