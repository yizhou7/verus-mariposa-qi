...
(set-info :comment ";; mariposa_data/v_nl//1903720889099580400/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_11_1~2264@ Int)
(declare-const temp_12_0~2377@ Int)
(declare-const temp_12_1~2438@ Int)
(declare-const temp_13_0~2531@ Int)
(declare-const temp_13_1~2592@ Int)
(declare-const temp_14_0~2723@ Int)
(declare-const temp_14_1~2824@ Int)
(declare-const temp_15_0~2951@ Int)
(declare-const temp_15_1~3016@ Int)
(declare-const temp_16_0~3105@ Int)
(declare-const temp_16_1~3158@ Int)
(declare-const temp_17_0~3259@ Int)
(declare-const temp_17_1~3324@ Int)
(declare-const temp_18_0~3413@ Int)
(declare-const temp_18_1~3474@ Int)
(declare-const temp_19_0~3579@ Int)
(declare-const temp_19_1~3672@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~309@ (Mul (Mul (Mul (Sub d0~8@ d0~8@) (Sub d0~8@ b0~4@)) (Mul b0~4@ (Mul a0~2@ b0~4@))) (Mul (Mul (Mul 29 d0~8@) (Mul a0~2@ d0~8@)) (Add (Sub b0~4@ b0~4@) c0~6@)))) (=> (= temp_0_1~378@ (Mul (Mul (Mul (Sub d0~8@ d0~8@) (Sub d0~8@ b0~4@)) (Mul b0~4@ (Mul a0~2@ b0~4@))) (Mul (Mul 29 (Mul d0~8@ (Mul a0~2@ d0~8@))) (Add (Sub b0~4@ b0~4@) c0~6@)))) (and (=> (= tmp%1@ (Mul a0~2@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. 29 d0~8@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~309@ temp_0_1~378@)))) (=> (= temp_0_0~309@ temp_0_1~378@) (=> (= temp_1_0~485@ (Mul (Mul (Mul d1~16@ (Mul d1~16@ d1~16@)) (Add (Add b1~12@ d1~16@) (Mul b1~12@ c1~14@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ b1~12@))))) (=> (= temp_1_1~546@ (Mul (Mul (Mul d1~16@ (Mul d1~16@ d1~16@)) (Add (Add b1~12@ d1~16@) (Mul b1~12@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ b1~12@))))) (and (=> (= tmp%2@ (Mul c1~14@ c1~14@)) (=> (= tmp%3@ (Mul d1~16@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~485@ temp_1_1~546@))))) (=> (= temp_1_0~485@ temp_1_1~546@) (=> (= temp_2_0~623@ (Mul (Mul c2~22@ (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ c2~22@))) (Mul a2~18@ (Mul (Add a2~18@ a2~18@) (Add d2~24@ a2~18@))))) (=> (= temp_2_1~664@ (Mul (Mul c2~22@ (Mul c2~22@ (Mul a2~18@ (Mul a2~18@ c2~22@)))) (Mul a2~18@ (Mul (Add a2~18@ a2~18@) (Add d2~24@ a2~18@))))) (and (=> (= tmp%4@ (Mul a2~18@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c2~22@ a2~18@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~623@ temp_2_1~664@)))) (=> (= temp_2_0~623@ temp_2_1~664@) (=> (= temp_3_0~775@ (Sub (Mul (Mul (Sub a3~26@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul b3~28@ 87) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~852@ (Sub (Mul (Mul (Sub a3~26@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ 87)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ d3~32@))))) (and (=> (= tmp%5@ (Mul b3~28@ 87)) (=> (= tmp%6@ (Mul a3~26@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~775@ temp_3_1~852@))))) (=> (= temp_3_0~775@ temp_3_1~852@) (=> (= temp_4_0~961@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@))) (Mul (Sub (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ b4~36@) d4~40@)))) (=> (= temp_4_1~1022@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@))) (Mul (Mul (Sub (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@)) (Mul c4~38@ b4~36@)) d4~40@))) (and (=> (= tmp%7@ (Sub (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@))) (=> (= tmp%8@ (Mul c4~38@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ d4~40@) (=> %%location_label%%4 (= temp_4_0~961@ temp_4_1~1022@))))) (=> (= temp_4_0~961@ temp_4_1~1022@) (=> (= temp_5_0~1133@ (Mul (Sub (Mul (Mul d5~48@ a5~42@) (Sub a5~42@ a5~42@)) (Mul (Sub d5~48@ a5~42@) (Sub c5~46@ d5~48@))) (Mul (Mul (Mul c5~46@ d5~48@) (Add a5~42@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1198@ (Mul (Sub (Mul d5~48@ (Mul a5~42@ (Sub a5~42@ a5~42@))) (Mul (Sub d5~48@ a5~42@) (Sub c5~46@ d5~48@))) (Mul (Mul (Mul c5~46@ d5~48@) (Add a5~42@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ b5~44@))))) (and (=> (= tmp%9@ (Sub a5~42@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d5~48@ a5~42@ tmp%9@) (=> %%location_label%%5 (= temp_5_0~1133@ temp_5_1~1198@)))) (=> (= temp_5_0~1133@ temp_5_1~1198@) (=> (= temp_6_0~1309@ (Mul (Sub (Sub (Mul d6~56@ c6~54@) (Mul d6~56@ c6~54@)) (Mul (Add b6~52@ a6~50@) (Sub d6~56@ a6~50@))) (Mul (Add (Mul 90 a6~50@) (Mul d6~56@ a6~50@)) (Mul (Add c6~54@ a6~50@) (Add d6~56@ a6~50@))))) (=> (= temp_6_1~1386@ (Mul (Sub (Sub (Mul d6~56@ c6~54@) (Mul d6~56@ c6~54@)) (Mul (Add b6~52@ a6~50@) (Sub d6~56@ a6~50@))) (Mul (Mul (Add c6~54@ a6~50@) (Add d6~56@ a6~50@)) (Add (Mul 90 a6~50@) (Mul d6~56@ a6~50@))))) (and (=> (= tmp%10@ (Add (Mul 90 a6~50@) (Mul d6~56@ a6~50@))) (=> (= tmp%11@ (Mul (Add c6~54@ a6~50@) (Add d6~56@ a6~50@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%6 (= temp_6_0~1309@ temp_6_1~1386@))))) (=> (= temp_6_0~1309@ temp_6_1~1386@) (=> (= temp_7_0~1519@ (Mul (Mul (Add (Mul c7~62@ c7~62@) (Add b7~60@ b7~60@)) (Mul c7~62@ (Add a7~58@ a7~58@))) (Mul (Mul (Mul a7~58@ c7~62@) a7~58@) (Mul (Mul b7~60@ 69) (Mul c7~62@ d7~64@))))) (=> (= temp_7_1~1588@ (Mul (Mul (Add (Mul c7~62@ c7~62@) (Add b7~60@ b7~60@)) (Mul c7~62@ (Add a7~58@ a7~58@))) (Mul (Mul (Mul b7~60@ 69) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ c7~62@) a7~58@)))) (and (=> (= tmp%12@ (Mul (Mul a7~58@ c7~62@) a7~58@)) (=> (= tmp%13@ (Mul (Mul b7~60@ 69) (Mul c7~62@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%7 (= temp_7_0~1519@ temp_7_1~1588@))))) (=> (= temp_7_0~1519@ temp_7_1~1588@) (=> (= temp_8_0~1701@ (Mul (Add b8~68@ (Mul (Mul b8~68@ d8~72@) (Add c8~70@ b8~68@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Add a8~66@ b8~68@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~1754@ (Mul (Add b8~68@ (Mul b8~68@ (Mul d8~72@ (Add c8~70@ b8~68@)))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Add a8~66@ b8~68@) (Mul c8~70@ c8~70@))))) (and (=> (= tmp%14@ (Add c8~70@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b8~68@ d8~72@ tmp%14@) (=> %%location_label%%8 (= temp_8_0~1701@ temp_8_1~1754@)))) (=> (= temp_8_0~1701@ temp_8_1~1754@) (=> (= temp_9_0~1853@ (Sub (Add (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ b9~76@)) (Sub (Mul d9~80@ c9~78@) (Mul c9~78@ a9~74@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul d9~80@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Add d9~80@ b9~76@))))) (=> (= temp_9_1~1918@ (Sub (Add (Mul (Mul d9~80@ c9~78@) (Mul c9~78@ b9~76@)) (Sub (Mul c9~78@ d9~80@) (Mul c9~78@ a9~74@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul d9~80@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Add d9~80@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ c9~78@) (=> %%location_label%%9 (= temp_9_0~1853@ temp_9_1~1918@))) (=> (= temp_9_0~1853@ temp_9_1~1918@) (=> (= temp_10_0~2023@ (Mul (Mul (Mul (Mul c10~86@ 5) (Mul d10~88@ d10~88@)) (Add (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@))) (Mul (Mul (Mul b10~84@ b10~84@) (Sub d10~88@ a10~82@)) (Mul (Mul c10~86@ b10~84@) (Sub b10~84@ d10~88@))))) (=> (= temp_10_1~2108@ (Mul (Mul (Mul (Mul c10~86@ 5) (Mul d10~88@ d10~88@)) (Add (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@))) (Mul (Sub (Mul (Mul b10~84@ b10~84@) d10~88@) (Mul (Mul b10~84@ b10~84@) a10~82@)) (Mul (Mul c10~86@ b10~84@) (Sub b10~84@ d10~88@))))) (and (=> (= tmp%15@ (Mul b10~84@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%15@ d10~88@ a10~82@) (=> %%location_label%%10 (= temp_10_0~2023@ temp_10_1~2108@)))) (=> (= temp_10_0~2023@ temp_10_1~2108@) (=> (= temp_11_0~2203@ (Mul (Mul (Mul b11~92@ (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul d11~96@ c11~94@) (Mul b11~92@ c11~94@)) (Sub (Mul d11~96@ c11~94@) (Mul b11~92@ c11~94@))))) (=> (= temp_11_1~2264@ (Mul (Mul (Mul b11~92@ (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ d11~96@))) (Mul (Sub (Mul d11~96@ c11~94@) (Mul b11~92@ c11~94@)) (Mul (Mul d11~96@ c11~94@) (Mul b11~92@ c11~94@))))) (and (=> (= tmp%16@ (Mul (Mul d11~96@ c11~94@) (Mul b11~92@ c11~94@))) (=> (= tmp%17@ (Sub (Mul d11~96@ c11~94@) (Mul b11~92@ c11~94@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%11 (= temp_11_0~2203@ temp_11_1~2264@))))) (=> (= temp_11_0~2203@ temp_11_1~2264@) (=> (= temp_12_0~2377@ (Sub (Mul (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ b12~100@)) (Mul a12~98@ (Add d12~104@ b12~100@))) (Mul (Mul (Sub b12~100@ d12~104@) (Mul b12~100@ d12~104@)) (Mul (Mul a12~98@ c12~102@) (Mul d12~104@ c12~102@))))) (=> (= temp_12_1~2438@ (Sub (Mul (Mul (Mul d12~104@ c12~102@) (Mul b12~100@ b12~100@)) (Mul a12~98@ (Add d12~104@ b12~100@))) (Mul (Mul (Sub b12~100@ d12~104@) (Mul b12~100@ d12~104@)) (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a12~98@ c12~102@) (=> %%location_label%%12 (= temp_12_0~2377@ temp_12_1~2438@))) (=> (= temp_12_0~2377@ temp_12_1~2438@) (=> (= temp_13_0~2531@ (Mul (Mul (Add (Mul a13~106@ a13~106@) (Mul a13~106@ b13~108@)) (Mul (Mul a13~106@ b13~108@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul a13~106@ a13~106@) (Mul a13~106@ a13~106@)) (Mul (Mul b13~108@ a13~106@) (Mul a13~106@ d13~112@))))) (=> (= temp_13_1~2592@ (Mul (Mul (Mul a13~106@ (Add a13~106@ b13~108@)) (Mul (Mul a13~106@ b13~108@) (Mul d13~112@ d13~112@))) (Mul (Mul (Mul a13~106@ a13~106@) (Mul a13~106@ a13~106@)) (Mul (Mul b13~108@ a13~106@) (Mul a13~106@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. a13~106@ a13~106@ b13~108@) (=> %%location_label%%13 (= temp_13_0~2531@ temp_13_1~2592@))) (=> (= temp_13_0~2531@ temp_13_1~2592@) (=> (= temp_14_0~2723@ (Add (Mul (Add (Mul d14~120@ d14~120@) (Mul c14~118@ 82)) (Mul (Add d14~120@ a14~114@) (Add c14~118@ b14~116@))) (Mul (Sub (Add c14~118@ a14~114@) (Sub 4 b14~116@)) (Sub (Sub a14~114@ a14~114@) (Mul 89 d14~120@))))) (=> (= temp_14_1~2824@ (Add (Mul (Mul (Add (Mul d14~120@ d14~120@) (Mul c14~118@ 82)) (Add d14~120@ a14~114@)) (Add c14~118@ b14~116@)) (Mul (Sub (Add c14~118@ a14~114@) (Sub 4 b14~116@)) (Sub (Sub a14~114@ a14~114@) (Mul 89 d14~120@))))) (and (=> (= tmp%18@ (Add (Mul d14~120@ d14~120@) (Mul c14~118@ 82))) (=> (= tmp%19@ (Add d14~120@ a14~114@)) (=> (= tmp%20@ (Add c14~118@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%14 (= temp_14_0~2723@ temp_14_1~2824@)))))) (=> (= temp_14_0~2723@ temp_14_1~2824@) (=> (= temp_15_0~2951@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul c15~126@ c15~126@)) 20) (Add (Mul (Mul d15~128@ a15~122@) (Sub d15~128@ d15~128@)) (Mul (Mul b15~124@ d15~128@) (Add c15~126@ a15~122@))))) (=> (= temp_15_1~3016@ (Mul (Mul (Mul (Mul c15~126@ c15~126@) (Mul c15~126@ c15~126@)) 20) (Add (Mul (Mul d15~128@ a15~122@) (Sub d15~128@ d15~128@)) (Mul (Add c15~126@ a15~122@) (Mul b15~124@ d15~128@))))) (and (=> (= tmp%21@ (Mul b15~124@ d15~128@)) (=> (= tmp%22@ (Add c15~126@ a15~122@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%15 (= temp_15_0~2951@ temp_15_1~3016@))))) (=> (= temp_15_0~2951@ temp_15_1~3016@) (=> (= temp_16_0~3105@ (Mul (Sub b16~132@ (Mul (Add b16~132@ a16~130@) (Mul d16~136@ a16~130@))) (Mul (Mul (Sub c16~134@ c16~134@) (Mul d16~136@ b16~132@)) (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ b16~132@))))) (=> (= temp_16_1~3158@ (Mul (Sub b16~132@ (Mul (Mul d16~136@ a16~130@) (Add b16~132@ a16~130@))) (Mul (Mul (Sub c16~134@ c16~134@) (Mul d16~136@ b16~132@)) (Mul (Mul c16~134@ c16~134@) (Mul c16~134@ b16~132@))))) (and (=> (= tmp%23@ (Add b16~132@ a16~130@)) (=> (= tmp%24@ (Mul d16~136@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> %%location_label%%16 (= temp_16_0~3105@ temp_16_1~3158@))))) (=> (= temp_16_0~3105@ temp_16_1~3158@) (=> (= temp_17_0~3259@ (Mul (Mul (Add (Sub d17~144@ b17~140@) (Mul b17~140@ c17~142@)) (Mul (Add a17~138@ b17~140@) (Mul c17~142@ b17~140@))) (Mul (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ c17~142@)) (Sub (Mul c17~142@ a17~138@) (Mul c17~142@ d17~144@))))) (=> (= temp_17_1~3324@ (Mul (Mul (Add (Sub d17~144@ b17~140@) (Mul b17~140@ c17~142@)) (Mul (Add a17~138@ b17~140@) (Mul c17~142@ b17~140@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul b17~140@ c17~142@)) (Sub (Mul c17~142@ a17~138@) (Mul c17~142@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c17~142@ d17~144@) (=> %%location_label%%17 (= temp_17_0~3259@ temp_17_1~3324@))) (=> (= temp_17_0~3259@ temp_17_1~3324@) (=> (= temp_18_0~3413@ (Add (Mul (Mul (Mul d18~152@ a18~146@) (Mul b18~148@ c18~150@)) (Mul (Mul b18~148@ c18~150@) (Mul a18~146@ b18~148@))) (Mul (Mul (Mul a18~146@ b18~148@) d18~152@) (Mul (Mul d18~152@ a18~146@) (Mul b18~148@ a18~146@))))) (=> (= temp_18_1~3474@ (Add (Mul (Mul (Mul d18~152@ a18~146@) (Mul b18~148@ c18~150@)) (Mul (Mul b18~148@ c18~150@) (Mul b18~148@ a18~146@))) (Mul (Mul (Mul a18~146@ b18~148@) d18~152@) (Mul (Mul d18~152@ a18~146@) (Mul b18~148@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a18~146@ b18~148@) (=> %%location_label%%18 (= temp_18_0~3413@ temp_18_1~3474@))) (=> (= temp_18_0~3413@ temp_18_1~3474@) (=> (= temp_19_0~3579@ (Sub (Mul (Mul (Mul d19~160@ a19~154@) (Mul c19~158@ a19~154@)) (Sub (Sub d19~160@ 3) (Mul a19~154@ d19~160@))) (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ d19~160@)) (Add (Mul b19~156@ b19~156@) (Mul d19~160@ b19~156@))))) (=> (= temp_19_1~3672@ (Sub (Sub (Mul (Mul (Mul d19~160@ a19~154@) (Mul c19~158@ a19~154@)) (Sub d19~160@ 3)) (Mul (Mul (Mul d19~160@ a19~154@) (Mul c19~158@ a19~154@)) (Mul a19~154@ d19~160@))) (Mul (Mul (Mul d19~160@ d19~160@) (Mul d19~160@ d19~160@)) (Add (Mul b19~156@ b19~156@) (Mul d19~160@ b19~156@))))) (=> (= tmp%25@ (Mul (Mul d19~160@ a19~154@) (Mul c19~158@ a19~154@))) (=> (= tmp%26@ (Sub d19~160@ 3)) (=> (= tmp%27@ (Mul a19~154@ d19~160@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%25@ tmp%26@ tmp%27@) (=> %%location_label%%19 (= temp_19_0~3579@ temp_19_1~3672@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
