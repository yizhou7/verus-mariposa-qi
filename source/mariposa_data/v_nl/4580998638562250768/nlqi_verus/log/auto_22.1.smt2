...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Add (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@)) (Sub b0~4@ (Mul a0~2@ c0~6@))) (Mul (Mul b0~4@ (Mul d0~8@ a0~2@)) (Mul (Sub c0~6@ a0~2@) c0~6@)))) (=> (= temp_0_1~362@ (Add (Sub (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@)) b0~4@) (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@)) (Mul a0~2@ c0~6@))) (Mul (Mul b0~4@ (Mul d0~8@ a0~2@)) (Mul (Sub c0~6@ a0~2@) c0~6@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~362@))) (=> (= temp_0_0~293@ temp_0_1~362@) (=> (= temp_1_0~447@ (Mul (Mul (Add c1~14@ (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Add d1~16@ c1~14@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~508@ (Mul (Mul (Add c1~14@ (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Add d1~16@ c1~14@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~508@))) (=> (= temp_1_0~447@ temp_1_1~508@) (=> (= temp_2_0~605@ (Sub (Mul (Mul (Mul a2~18@ 83) (Mul b2~20@ d2~24@)) (Mul b2~20@ (Mul d2~24@ a2~18@))) (Mul (Mul (Add c2~22@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~678@ (Sub (Mul (Mul (Mul a2~18@ 83) (Mul b2~20@ d2~24@)) (Mul b2~20@ (Mul d2~24@ a2~18@))) (Mul (Mul (Add c2~22@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~605@ temp_2_1~678@))) (=> (= temp_2_0~605@ temp_2_1~678@) (=> (= temp_3_0~779@ (Mul (Sub (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ a3~26@) (Sub d3~32@ c3~30@))) (Mul (Mul (Sub a3~26@ c3~30@) (Mul c3~30@ d3~32@)) (Sub (Mul b3~28@ 51) (Add b3~28@ b3~28@))))) (=> (= temp_3_1~856@ (Mul (Mul (Mul (Sub a3~26@ c3~30@) (Mul c3~30@ d3~32@)) (Sub (Mul b3~28@ 51) (Add b3~28@ b3~28@))) (Sub (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ a3~26@) (Sub d3~32@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~779@ temp_3_1~856@))) (=> (= temp_3_0~779@ temp_3_1~856@) (=> (= temp_4_0~957@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))) (Mul (Add (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ 15))))) (=> (= temp_4_1~1034@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))) (Mul (Add (Mul c4~38@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ 15))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~957@ temp_4_1~1034@))) (=> (= temp_4_0~957@ temp_4_1~1034@) (=> (= temp_5_0~1115@ (Mul (Mul (Mul (Sub c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul c5~46@ (Mul c5~46@ b5~44@))) (Add (Add (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)) (Mul c5~46@ (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1172@ (Mul (Mul (Sub c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ (Mul c5~46@ b5~44@)) (Add (Add (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)) (Mul c5~46@ (Mul d5~48@ a5~42@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1115@ temp_5_1~1172@))) (=> (= temp_5_0~1115@ temp_5_1~1172@) (=> (= temp_6_0~1257@ (Mul (Mul (Mul (Sub d6~56@ b6~52@) (Mul b6~52@ d6~56@)) (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul c6~54@ (Mul d6~56@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1318@ (Mul (Mul (Mul (Sub d6~56@ b6~52@) (Mul b6~52@ d6~56@)) (Mul (Mul (Mul c6~54@ b6~52@) a6~50@) a6~50@)) (Mul (Mul c6~54@ (Mul d6~56@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1257@ temp_6_1~1318@))) (=> (= temp_6_0~1257@ temp_6_1~1318@) (=> (= temp_7_0~1419@ (Mul (Mul (Add (Mul c7~62@ b7~60@) (Sub a7~58@ c7~62@)) (Add (Add a7~58@ b7~60@) (Sub b7~60@ c7~62@))) (Mul (Mul (Mul a7~58@ 79) (Add d7~64@ d7~64@)) (Sub (Sub b7~60@ d7~64@) (Sub a7~58@ c7~62@))))) (=> (= temp_7_1~1496@ (Mul (Mul (Add (Mul c7~62@ b7~60@) (Sub a7~58@ c7~62@)) (Add (Add a7~58@ b7~60@) (Sub b7~60@ c7~62@))) (Mul (Sub (Sub b7~60@ d7~64@) (Sub a7~58@ c7~62@)) (Mul (Mul a7~58@ 79) (Add d7~64@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1419@ temp_7_1~1496@))) (=> (= temp_7_0~1419@ temp_7_1~1496@) (=> (= temp_8_0~1597@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ c8~70@)) (Add (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@))) (Mul (Mul (Add c8~70@ c8~70@) (Mul 65 d8~72@)) (Add (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@))))) (=> (= temp_8_1~1674@ (Mul (Mul (Mul (Add c8~70@ c8~70@) (Mul 65 d8~72@)) (Add (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ c8~70@)) (Add (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1597@ temp_8_1~1674@))) (=> (= temp_8_0~1597@ temp_8_1~1674@) (=> (= temp_9_0~1727@ (Mul d9~80@ (Mul (Add d9~80@ (Sub a9~74@ b9~76@)) (Add (Mul d9~80@ c9~78@) d9~80@)))) (=> (= temp_9_1~1768@ (Mul d9~80@ (Add (Mul (Add d9~80@ (Sub a9~74@ b9~76@)) (Mul d9~80@ c9~78@)) (Mul (Add d9~80@ (Sub a9~74@ b9~76@)) d9~80@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1727@ temp_9_1~1768@))) (=> (= temp_9_0~1727@ temp_9_1~1768@) (=> (= temp_10_0~1869@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Add (Mul b10~84@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul 33 a10~82@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~1946@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Add (Mul b10~84@ c10~86@) (Mul b10~84@ c10~86@)) (Mul (Mul 33 a10~82@) (Mul b10~84@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1869@ temp_10_1~1946@))) (=> (= temp_10_0~1869@ temp_10_1~1946@) (=> (= temp_11_0~2035@ (Mul (Sub d11~96@ (Mul (Mul a11~90@ c11~94@) (Add c11~94@ c11~94@))) (Mul (Mul (Add c11~94@ a11~90@) (Sub 53 a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))))) (=> (= temp_11_1~2100@ (Mul (Sub d11~96@ (Mul (Add c11~94@ c11~94@) (Mul a11~90@ c11~94@))) (Mul (Mul (Add c11~94@ a11~90@) (Sub 53 a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2035@ temp_11_1~2100@))) (=> (= temp_11_0~2035@ temp_11_1~2100@) (=> (= temp_12_0~2189@ (Sub (Mul (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ d12~104@)) (Mul (Add d12~104@ a12~98@) (Sub b12~100@ a12~98@))) (Mul (Add (Sub c12~102@ b12~100@) (Mul b12~100@ a12~98@)) (Sub (Mul d12~104@ a12~98@) (Mul a12~98@ b12~100@))))) (=> (= temp_12_1~2262@ (Sub (Mul (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ d12~104@)) (Sub (Mul (Add d12~104@ a12~98@) b12~100@) (Mul (Add d12~104@ a12~98@) a12~98@))) (Mul (Add (Sub c12~102@ b12~100@) (Mul b12~100@ a12~98@)) (Sub (Mul d12~104@ a12~98@) (Mul a12~98@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2189@ temp_12_1~2262@))) (=> (= temp_12_0~2189@ temp_12_1~2262@) (=> (= temp_13_0~2351@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ d13~112@) (Mul a13~106@ d13~112@))) (Mul (Mul (Sub d13~112@ b13~108@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~2416@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ d13~112@) (Mul a13~106@ d13~112@))) (Mul (Mul (Sub d13~112@ b13~108@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ c13~110@) (Mul c13~110@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2351@ temp_13_1~2416@))) (=> (= temp_13_0~2351@ temp_13_1~2416@) (=> (= temp_14_0~2505@ (Sub (Add (Sub (Mul b14~116@ a14~114@) (Mul a14~114@ a14~114@)) (Sub (Mul c14~118@ d14~120@) (Sub b14~116@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul c14~118@ b14~116@)) (Mul (Mul c14~118@ d14~120@) (Add a14~114@ b14~116@))))) (=> (= temp_14_1~2570@ (Sub (Add (Sub (Mul b14~116@ a14~114@) (Mul a14~114@ a14~114@)) (Sub (Mul c14~118@ d14~120@) (Sub b14~116@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul b14~116@ c14~118@)) (Mul (Mul c14~118@ d14~120@) (Add a14~114@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2505@ temp_14_1~2570@))) (=> (= temp_14_0~2505@ temp_14_1~2570@) (=> (= temp_15_0~2671@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ 43)) (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ b15~124@))) (Mul (Mul (Mul b15~124@ c15~126@) (Mul b15~124@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~2748@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ 43)) (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ b15~124@))) (Mul (Mul b15~124@ c15~126@) (Mul (Mul b15~124@ b15~124@) (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ c15~126@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2671@ temp_15_1~2748@))) (=> (= temp_15_0~2671@ temp_15_1~2748@) (=> (= temp_16_0~2849@ (Add (Mul (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ d16~136@)) (Mul (Sub c16~134@ a16~130@) (Mul b16~132@ 40))) (Mul (Mul (Mul b16~132@ c16~134@) (Mul d16~136@ b16~132@)) (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~2926@ (Add (Mul (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ d16~136@)) (Mul (Sub c16~134@ a16~130@) (Mul b16~132@ 40))) (Mul (Mul (Mul b16~132@ c16~134@) (Mul d16~136@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Mul c16~134@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2849@ temp_16_1~2926@))) (=> (= temp_16_0~2849@ temp_16_1~2926@) (=> (= temp_17_0~3015@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ c17~142@)) (Add (Mul c17~142@ a17~138@) (Mul d17~144@ a17~138@))) (Sub (Mul (Mul b17~140@ d17~144@) (Mul d17~144@ b17~140@)) (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ c17~142@))))) (=> (= temp_17_1~3080@ (Mul (Mul (Add (Mul c17~142@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ c17~142@))) (Sub (Mul (Mul b17~140@ d17~144@) (Mul d17~144@ b17~140@)) (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~3015@ temp_17_1~3080@))) (=> (= temp_17_0~3015@ temp_17_1~3080@) (=> (= temp_18_0~3181@ (Mul (Mul (Sub (Mul a18~146@ c18~150@) (Mul a18~146@ a18~146@)) (Mul (Sub c18~150@ d18~152@) (Mul b18~148@ 34))) (Mul (Mul (Mul a18~146@ d18~152@) (Mul d18~152@ a18~146@)) (Mul (Sub b18~148@ b18~148@) (Mul d18~152@ a18~146@))))) (=> (= temp_18_1~3258@ (Mul (Mul (Mul (Sub c18~150@ d18~152@) (Mul b18~148@ 34)) (Sub (Mul a18~146@ c18~150@) (Mul a18~146@ a18~146@))) (Mul (Mul (Mul a18~146@ d18~152@) (Mul d18~152@ a18~146@)) (Mul (Sub b18~148@ b18~148@) (Mul d18~152@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3181@ temp_18_1~3258@))) (=> (= temp_18_0~3181@ temp_18_1~3258@) (=> (= temp_19_0~3347@ (Mul (Mul (Mul (Mul c19~158@ b19~156@) (Mul b19~156@ a19~154@)) (Mul (Mul b19~156@ d19~160@) (Mul b19~156@ a19~154@))) (Mul (Add (Mul a19~154@ a19~154@) (Mul d19~160@ d19~160@)) (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ c19~158@))))) (=> (= temp_19_1~3412@ (Mul (Mul (Mul (Mul c19~158@ b19~156@) (Mul b19~156@ a19~154@)) (Mul (Mul b19~156@ d19~160@) (Mul b19~156@ a19~154@))) (Mul (Add (Mul a19~154@ a19~154@) (Mul d19~160@ d19~160@)) (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ c19~158@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3347@ temp_19_1~3412@))) (=> (= temp_19_0~3347@ temp_19_1~3412@) (=> (= temp_20_0~3497@ (Mul (Mul (Sub (Mul a20~162@ d20~168@) (Sub d20~168@ c20~166@)) (Mul c20~166@ (Mul a20~162@ c20~166@))) (Mul (Mul (Mul a20~162@ a20~162@) (Mul c20~166@ b20~164@)) (Sub (Sub d20~168@ c20~166@) (Mul c20~166@ d20~168@))))) (=> (= temp_20_1~3558@ (Mul (Mul (Sub (Mul a20~162@ d20~168@) (Sub d20~168@ c20~166@)) (Mul c20~166@ (Mul a20~162@ c20~166@))) (Mul (Mul a20~162@ (Mul a20~162@ (Mul c20~166@ b20~164@))) (Sub (Sub d20~168@ c20~166@) (Mul c20~166@ d20~168@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3497@ temp_20_1~3558@))) (=> (= temp_20_0~3497@ temp_20_1~3558@) (=> (= temp_21_0~3655@ (Mul (Mul (Mul (Mul b21~172@ d21~176@) (Mul b21~172@ 38)) (Mul (Sub b21~172@ d21~176@) (Mul c21~174@ b21~172@))) (Mul (Mul b21~172@ (Mul d21~176@ c21~174@)) (Mul (Mul c21~174@ d21~176@) (Mul b21~172@ d21~176@))))) (=> (= temp_21_1~3728@ (Mul (Mul (Mul (Mul b21~172@ d21~176@) (Mul b21~172@ 38)) (Mul (Sub b21~172@ d21~176@) (Mul c21~174@ b21~172@))) (Mul (Mul (Mul b21~172@ d21~176@) c21~174@) (Mul (Mul c21~174@ d21~176@) (Mul b21~172@ d21~176@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3655@ temp_21_1~3728@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
