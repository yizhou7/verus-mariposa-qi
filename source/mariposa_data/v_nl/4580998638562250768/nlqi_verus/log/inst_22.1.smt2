...
(set-info :comment ";; mariposa_data/v_nl//4580998638562250768/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_5_0~1221@ Int)
(declare-const temp_5_1~1278@ Int)
(declare-const temp_6_0~1413@ Int)
(declare-const temp_6_1~1474@ Int)
(declare-const temp_7_0~1585@ Int)
...
(declare-const temp_10_0~2165@ Int)
(declare-const temp_10_1~2242@ Int)
(declare-const temp_11_0~2335@ Int)
(declare-const temp_11_1~2400@ Int)
(declare-const temp_12_0~2501@ Int)
(declare-const temp_12_1~2574@ Int)
(declare-const temp_13_0~2673@ Int)
(declare-const temp_13_1~2738@ Int)
(declare-const temp_14_0~2839@ Int)
(declare-const temp_14_1~2904@ Int)
(declare-const temp_15_0~3009@ Int)
(declare-const temp_15_1~3086@ Int)
(declare-const temp_16_0~3213@ Int)
(declare-const temp_16_1~3290@ Int)
(declare-const temp_17_0~3391@ Int)
(declare-const temp_17_1~3456@ Int)
(declare-const temp_18_0~3585@ Int)
(declare-const temp_18_1~3662@ Int)
(declare-const temp_19_0~3791@ Int)
(declare-const temp_19_1~3856@ Int)
(declare-const temp_20_0~3945@ Int)
(declare-const temp_20_1~4006@ Int)
(declare-const temp_21_0~4113@ Int)
(declare-const temp_21_1~4186@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Add (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@)) (Sub b0~4@ (Mul a0~2@ c0~6@))) (Mul (Mul b0~4@ (Mul d0~8@ a0~2@)) (Mul (Sub c0~6@ a0~2@) c0~6@)))) (=> (= temp_0_1~362@ (Add (Sub (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@)) b0~4@) (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@)) (Mul a0~2@ c0~6@))) (Mul (Mul b0~4@ (Mul d0~8@ a0~2@)) (Mul (Sub c0~6@ a0~2@) c0~6@)))) (and (=> (= tmp%1@ (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ a0~2@))) (=> (= tmp%2@ (Mul a0~2@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ b0~4@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~362@))))) (=> (= temp_0_0~293@ temp_0_1~362@) (=> (= temp_1_0~469@ (Mul (Mul (Add c1~14@ (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Add d1~16@ c1~14@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~530@ (Mul (Mul (Add c1~14@ (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Add d1~16@ c1~14@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ b1~12@) (=> %%location_label%%1 (= temp_1_0~469@ temp_1_1~530@))) (=> (= temp_1_0~469@ temp_1_1~530@) (=> (= temp_2_0~631@ (Sub (Mul (Mul (Mul a2~18@ 83) (Mul b2~20@ d2~24@)) (Mul b2~20@ (Mul d2~24@ a2~18@))) (Mul (Mul (Add c2~22@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~704@ (Sub (Mul (Mul (Mul a2~18@ 83) (Mul b2~20@ d2~24@)) (Mul b2~20@ (Mul d2~24@ a2~18@))) (Mul (Mul (Add c2~22@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ b2~20@) (=> %%location_label%%2 (= temp_2_0~631@ temp_2_1~704@))) (=> (= temp_2_0~631@ temp_2_1~704@) (=> (= temp_3_0~809@ (Mul (Sub (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ a3~26@) (Sub d3~32@ c3~30@))) (Mul (Mul (Sub a3~26@ c3~30@) (Mul c3~30@ d3~32@)) (Sub (Mul b3~28@ 51) (Add b3~28@ b3~28@))))) (=> (= temp_3_1~886@ (Mul (Mul (Mul (Sub a3~26@ c3~30@) (Mul c3~30@ d3~32@)) (Sub (Mul b3~28@ 51) (Add b3~28@ b3~28@))) (Sub (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ a3~26@) (Sub d3~32@ c3~30@))))) (and (=> (= tmp%3@ (Sub (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ a3~26@) (Sub d3~32@ c3~30@)))) (=> (= tmp%4@ (Mul (Mul (Sub a3~26@ c3~30@) (Mul c3~30@ d3~32@)) (Sub (Mul b3~28@ 51) (Add b3~28@ b3~28@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~809@ temp_3_1~886@))))) (=> (= temp_3_0~809@ temp_3_1~886@) (=> (= temp_4_0~1059@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))) (Mul (Add (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ 15))))) (=> (= temp_4_1~1136@ (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))) (Mul (Add (Mul c4~38@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ 15))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ c4~38@) (=> %%location_label%%4 (= temp_4_0~1059@ temp_4_1~1136@))) (=> (= temp_4_0~1059@ temp_4_1~1136@) (=> (= temp_5_0~1221@ (Mul (Mul (Mul (Sub c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul c5~46@ (Mul c5~46@ b5~44@))) (Add (Add (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)) (Mul c5~46@ (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1278@ (Mul (Mul (Sub c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ (Mul c5~46@ b5~44@)) (Add (Add (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)) (Mul c5~46@ (Mul d5~48@ a5~42@)))))) (and (=> (= tmp%5@ (Mul (Sub c5~46@ a5~42@) (Mul a5~42@ d5~48@))) (=> (= tmp%6@ (Mul c5~46@ (Mul c5~46@ b5~44@))) (=> (= tmp%7@ (Add (Add (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)) (Mul c5~46@ (Mul d5~48@ a5~42@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%5 (= temp_5_0~1221@ temp_5_1~1278@)))))) (=> (= temp_5_0~1221@ temp_5_1~1278@) (=> (= temp_6_0~1413@ (Mul (Mul (Mul (Sub d6~56@ b6~52@) (Mul b6~52@ d6~56@)) (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@))) (Mul (Mul c6~54@ (Mul d6~56@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1474@ (Mul (Mul (Mul (Sub d6~56@ b6~52@) (Mul b6~52@ d6~56@)) (Mul (Mul (Mul c6~54@ b6~52@) a6~50@) a6~50@)) (Mul (Mul c6~54@ (Mul d6~56@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ d6~56@))))) (and (=> (= tmp%8@ (Mul c6~54@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ a6~50@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1413@ temp_6_1~1474@)))) (=> (= temp_6_0~1413@ temp_6_1~1474@) (=> (= temp_7_0~1585@ (Mul (Mul (Add (Mul c7~62@ b7~60@) (Sub a7~58@ c7~62@)) (Add (Add a7~58@ b7~60@) (Sub b7~60@ c7~62@))) (Mul (Mul (Mul a7~58@ 79) (Add d7~64@ d7~64@)) (Sub (Sub b7~60@ d7~64@) (Sub a7~58@ c7~62@))))) (=> (= temp_7_1~1662@ (Mul (Mul (Add (Mul c7~62@ b7~60@) (Sub a7~58@ c7~62@)) (Add (Add a7~58@ b7~60@) (Sub b7~60@ c7~62@))) (Mul (Sub (Sub b7~60@ d7~64@) (Sub a7~58@ c7~62@)) (Mul (Mul a7~58@ 79) (Add d7~64@ d7~64@))))) (and (=> (= tmp%9@ (Mul (Mul a7~58@ 79) (Add d7~64@ d7~64@))) (=> (= tmp%10@ (Sub (Sub b7~60@ d7~64@) (Sub a7~58@ c7~62@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~1585@ temp_7_1~1662@))))) (=> (= temp_7_0~1585@ temp_7_1~1662@) (=> (= temp_8_0~1803@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ c8~70@)) (Add (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@))) (Mul (Mul (Add c8~70@ c8~70@) (Mul 65 d8~72@)) (Add (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@))))) (=> (= temp_8_1~1880@ (Mul (Mul (Mul (Add c8~70@ c8~70@) (Mul 65 d8~72@)) (Add (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ c8~70@)) (Add (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@))))) (and (=> (= tmp%11@ (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ c8~70@)) (Add (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@)))) (=> (= tmp%12@ (Mul (Mul (Add c8~70@ c8~70@) (Mul 65 d8~72@)) (Add (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%8 (= temp_8_0~1803@ temp_8_1~1880@))))) (=> (= temp_8_0~1803@ temp_8_1~1880@) (=> (= temp_9_0~2005@ (Mul d9~80@ (Mul (Add d9~80@ (Sub a9~74@ b9~76@)) (Add (Mul d9~80@ c9~78@) d9~80@)))) (=> (= temp_9_1~2046@ (Mul d9~80@ (Add (Mul (Add d9~80@ (Sub a9~74@ b9~76@)) (Mul d9~80@ c9~78@)) (Mul (Add d9~80@ (Sub a9~74@ b9~76@)) d9~80@)))) (and (=> (= tmp%13@ (Add d9~80@ (Sub a9~74@ b9~76@))) (=> (= tmp%14@ (Mul d9~80@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%13@ tmp%14@ d9~80@) (=> %%location_label%%9 (= temp_9_0~2005@ temp_9_1~2046@))))) (=> (= temp_9_0~2005@ temp_9_1~2046@) (=> (= temp_10_0~2165@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Add (Mul b10~84@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul 33 a10~82@) (Mul b10~84@ d10~88@))))) (=> (= temp_10_1~2242@ (Mul (Mul (Mul (Mul a10~82@ d10~88@) (Mul c10~86@ a10~82@)) (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ b10~84@))) (Mul (Add (Mul b10~84@ c10~86@) (Mul b10~84@ c10~86@)) (Mul (Mul 33 a10~82@) (Mul b10~84@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ b10~84@) (=> %%location_label%%10 (= temp_10_0~2165@ temp_10_1~2242@))) (=> (= temp_10_0~2165@ temp_10_1~2242@) (=> (= temp_11_0~2335@ (Mul (Sub d11~96@ (Mul (Mul a11~90@ c11~94@) (Add c11~94@ c11~94@))) (Mul (Mul (Add c11~94@ a11~90@) (Sub 53 a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))))) (=> (= temp_11_1~2400@ (Mul (Sub d11~96@ (Mul (Add c11~94@ c11~94@) (Mul a11~90@ c11~94@))) (Mul (Mul (Add c11~94@ a11~90@) (Sub 53 a11~90@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ c11~94@))))) (and (=> (= tmp%15@ (Mul a11~90@ c11~94@)) (=> (= tmp%16@ (Add c11~94@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%11 (= temp_11_0~2335@ temp_11_1~2400@))))) (=> (= temp_11_0~2335@ temp_11_1~2400@) (=> (= temp_12_0~2501@ (Sub (Mul (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ d12~104@)) (Mul (Add d12~104@ a12~98@) (Sub b12~100@ a12~98@))) (Mul (Add (Sub c12~102@ b12~100@) (Mul b12~100@ a12~98@)) (Sub (Mul d12~104@ a12~98@) (Mul a12~98@ b12~100@))))) (=> (= temp_12_1~2574@ (Sub (Mul (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ d12~104@)) (Sub (Mul (Add d12~104@ a12~98@) b12~100@) (Mul (Add d12~104@ a12~98@) a12~98@))) (Mul (Add (Sub c12~102@ b12~100@) (Mul b12~100@ a12~98@)) (Sub (Mul d12~104@ a12~98@) (Mul a12~98@ b12~100@))))) (and (=> (= tmp%17@ (Add d12~104@ a12~98@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%17@ b12~100@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2501@ temp_12_1~2574@)))) (=> (= temp_12_0~2501@ temp_12_1~2574@) (=> (= temp_13_0~2673@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ d13~112@) (Mul a13~106@ d13~112@))) (Mul (Mul (Sub d13~112@ b13~108@) (Mul b13~108@ a13~106@)) (Mul (Mul c13~110@ d13~112@) (Mul d13~112@ c13~110@))))) (=> (= temp_13_1~2738@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ d13~112@) (Mul a13~106@ d13~112@))) (Mul (Mul (Sub d13~112@ b13~108@) (Mul b13~108@ a13~106@)) (Mul (Mul d13~112@ c13~110@) (Mul c13~110@ d13~112@))))) (and (=> (= tmp%18@ (Mul c13~110@ d13~112@)) (=> (= tmp%19@ (Mul d13~112@ c13~110@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%13 (= temp_13_0~2673@ temp_13_1~2738@))))) (=> (= temp_13_0~2673@ temp_13_1~2738@) (=> (= temp_14_0~2839@ (Sub (Add (Sub (Mul b14~116@ a14~114@) (Mul a14~114@ a14~114@)) (Sub (Mul c14~118@ d14~120@) (Sub b14~116@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul c14~118@ b14~116@)) (Mul (Mul c14~118@ d14~120@) (Add a14~114@ b14~116@))))) (=> (= temp_14_1~2904@ (Sub (Add (Sub (Mul b14~116@ a14~114@) (Mul a14~114@ a14~114@)) (Sub (Mul c14~118@ d14~120@) (Sub b14~116@ c14~118@))) (Mul (Mul (Mul b14~116@ d14~120@) (Mul b14~116@ c14~118@)) (Mul (Mul c14~118@ d14~120@) (Add a14~114@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c14~118@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2839@ temp_14_1~2904@))) (=> (= temp_14_0~2839@ temp_14_1~2904@) (=> (= temp_15_0~3009@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ 43)) (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ b15~124@))) (Mul (Mul (Mul b15~124@ c15~126@) (Mul b15~124@ b15~124@)) (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ c15~126@))))) (=> (= temp_15_1~3086@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ 43)) (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ b15~124@))) (Mul (Mul b15~124@ c15~126@) (Mul (Mul b15~124@ b15~124@) (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ c15~126@)))))) (and (=> (= tmp%20@ (Mul b15~124@ c15~126@)) (=> (= tmp%21@ (Mul b15~124@ b15~124@)) (=> (= tmp%22@ (Mul (Mul a15~122@ d15~128@) (Mul c15~126@ c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%20@ tmp%21@ tmp%22@) (=> %%location_label%%15 (= temp_15_0~3009@ temp_15_1~3086@)))))) (=> (= temp_15_0~3009@ temp_15_1~3086@) (=> (= temp_16_0~3213@ (Add (Mul (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ d16~136@)) (Mul (Sub c16~134@ a16~130@) (Mul b16~132@ 40))) (Mul (Mul (Mul b16~132@ c16~134@) (Mul d16~136@ b16~132@)) (Mul (Mul c16~134@ d16~136@) (Mul b16~132@ a16~130@))))) (=> (= temp_16_1~3290@ (Add (Mul (Mul (Mul c16~134@ a16~130@) (Mul a16~130@ d16~136@)) (Mul (Sub c16~134@ a16~130@) (Mul b16~132@ 40))) (Mul (Mul (Mul b16~132@ c16~134@) (Mul d16~136@ b16~132@)) (Mul (Mul b16~132@ a16~130@) (Mul c16~134@ d16~136@))))) (and (=> (= tmp%23@ (Mul c16~134@ d16~136@)) (=> (= tmp%24@ (Mul b16~132@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%23@ tmp%24@) (=> %%location_label%%16 (= temp_16_0~3213@ temp_16_1~3290@))))) (=> (= temp_16_0~3213@ temp_16_1~3290@) (=> (= temp_17_0~3391@ (Mul (Mul (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ c17~142@)) (Add (Mul c17~142@ a17~138@) (Mul d17~144@ a17~138@))) (Sub (Mul (Mul b17~140@ d17~144@) (Mul d17~144@ b17~140@)) (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ c17~142@))))) (=> (= temp_17_1~3456@ (Mul (Mul (Add (Mul c17~142@ a17~138@) (Mul d17~144@ a17~138@)) (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ c17~142@))) (Sub (Mul (Mul b17~140@ d17~144@) (Mul d17~144@ b17~140@)) (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ c17~142@))))) (and (=> (= tmp%25@ (Mul (Mul b17~140@ c17~142@) (Mul c17~142@ c17~142@))) (=> (= tmp%26@ (Add (Mul c17~142@ a17~138@) (Mul d17~144@ a17~138@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%25@ tmp%26@) (=> %%location_label%%17 (= temp_17_0~3391@ temp_17_1~3456@))))) (=> (= temp_17_0~3391@ temp_17_1~3456@) (=> (= temp_18_0~3585@ (Mul (Mul (Sub (Mul a18~146@ c18~150@) (Mul a18~146@ a18~146@)) (Mul (Sub c18~150@ d18~152@) (Mul b18~148@ 34))) (Mul (Mul (Mul a18~146@ d18~152@) (Mul d18~152@ a18~146@)) (Mul (Sub b18~148@ b18~148@) (Mul d18~152@ a18~146@))))) (=> (= temp_18_1~3662@ (Mul (Mul (Mul (Sub c18~150@ d18~152@) (Mul b18~148@ 34)) (Sub (Mul a18~146@ c18~150@) (Mul a18~146@ a18~146@))) (Mul (Mul (Mul a18~146@ d18~152@) (Mul d18~152@ a18~146@)) (Mul (Sub b18~148@ b18~148@) (Mul d18~152@ a18~146@))))) (and (=> (= tmp%27@ (Sub (Mul a18~146@ c18~150@) (Mul a18~146@ a18~146@))) (=> (= tmp%28@ (Mul (Sub c18~150@ d18~152@) (Mul b18~148@ 34))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%18 (= temp_18_0~3585@ temp_18_1~3662@))))) (=> (= temp_18_0~3585@ temp_18_1~3662@) (=> (= temp_19_0~3791@ (Mul (Mul (Mul (Mul c19~158@ b19~156@) (Mul b19~156@ a19~154@)) (Mul (Mul b19~156@ d19~160@) (Mul b19~156@ a19~154@))) (Mul (Add (Mul a19~154@ a19~154@) (Mul d19~160@ d19~160@)) (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ c19~158@))))) (=> (= temp_19_1~3856@ (Mul (Mul (Mul (Mul c19~158@ b19~156@) (Mul b19~156@ a19~154@)) (Mul (Mul b19~156@ d19~160@) (Mul b19~156@ a19~154@))) (Mul (Add (Mul a19~154@ a19~154@) (Mul d19~160@ d19~160@)) (Mul (Mul c19~158@ d19~160@) (Mul c19~158@ c19~158@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a19~154@ a19~154@) (=> %%location_label%%19 (= temp_19_0~3791@ temp_19_1~3856@))) (=> (= temp_19_0~3791@ temp_19_1~3856@) (=> (= temp_20_0~3945@ (Mul (Mul (Sub (Mul a20~162@ d20~168@) (Sub d20~168@ c20~166@)) (Mul c20~166@ (Mul a20~162@ c20~166@))) (Mul (Mul (Mul a20~162@ a20~162@) (Mul c20~166@ b20~164@)) (Sub (Sub d20~168@ c20~166@) (Mul c20~166@ d20~168@))))) (=> (= temp_20_1~4006@ (Mul (Mul (Sub (Mul a20~162@ d20~168@) (Sub d20~168@ c20~166@)) (Mul c20~166@ (Mul a20~162@ c20~166@))) (Mul (Mul a20~162@ (Mul a20~162@ (Mul c20~166@ b20~164@))) (Sub (Sub d20~168@ c20~166@) (Mul c20~166@ d20~168@))))) (and (=> (= tmp%29@ (Mul c20~166@ b20~164@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a20~162@ a20~162@ tmp%29@) (=> %%location_label%%20 (= temp_20_0~3945@ temp_20_1~4006@)))) (=> (= temp_20_0~3945@ temp_20_1~4006@) (=> (= temp_21_0~4113@ (Mul (Mul (Mul (Mul b21~172@ d21~176@) (Mul b21~172@ 38)) (Mul (Sub b21~172@ d21~176@) (Mul c21~174@ b21~172@))) (Mul (Mul b21~172@ (Mul d21~176@ c21~174@)) (Mul (Mul c21~174@ d21~176@) (Mul b21~172@ d21~176@))))) (=> (= temp_21_1~4186@ (Mul (Mul (Mul (Mul b21~172@ d21~176@) (Mul b21~172@ 38)) (Mul (Sub b21~172@ d21~176@) (Mul c21~174@ b21~172@))) (Mul (Mul (Mul b21~172@ d21~176@) c21~174@) (Mul (Mul c21~174@ d21~176@) (Mul b21~172@ d21~176@))))) (=> (ens%main!nl_basics.lemma_mul_is_associative. b21~172@ d21~176@ c21~174@) (=> %%location_label%%21 (= temp_21_0~4113@ temp_21_1~4186@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
