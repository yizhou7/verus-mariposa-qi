...
(set-info :comment ";; mariposa_data/v_nl//11709536676746098393/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~281@ (Mul (Mul (Sub (Sub (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@)) (Add d0~8@ (Mul a0~2@ b0~4@)))) (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ a0~2@)) (Sub (Mul d0~8@ c0~6@) d0~8@)) (Mul (Mul (Add d0~8@ b0~4@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)))))) (=> (= temp_0_1~402@ (Mul (Mul (Sub (Sub (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@)) (Add d0~8@ (Mul a0~2@ b0~4@)))) (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ a0~2@)) (Sub (Mul d0~8@ c0~6@) d0~8@)) (Mul (Mul (Add d0~8@ b0~4@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ a0~2@) (=> %%location_label%%0 (= temp_0_0~281@ temp_0_1~402@))) (=> (= temp_0_0~281@ temp_0_1~402@) (=> (= temp_1_0~543@ (Mul (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul c1~14@ d1~16@) (Sub c1~14@ d1~16@)) (Mul b1~12@ (Mul a1~10@ c1~14@)))) (Mul (Mul d1~16@ (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@))) (Add (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Add (Mul d1~16@ d1~16@) (Mul a1~10@ c1~14@)))))) (=> (= temp_1_1~656@ (Mul (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub c1~14@ d1~16@)) (Mul b1~12@ (Mul a1~10@ c1~14@)))) (Mul (Mul d1~16@ (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@))) (Add (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)) (Add (Mul d1~16@ d1~16@) (Mul a1~10@ c1~14@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ d1~16@) (=> %%location_label%%1 (= temp_1_0~543@ temp_1_1~656@))) (=> (= temp_1_0~543@ temp_1_1~656@) (=> (= temp_2_0~797@ (Mul (Sub (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Sub c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ a2~18@) (Sub b2~20@ b2~20@)) (Mul b2~20@ (Mul c2~22@ a2~18@)))) (Mul (Mul b2~20@ (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ d2~24@)))))) (=> (= temp_2_1~910@ (Mul (Sub (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Sub c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ a2~18@) (Sub b2~20@ b2~20@)) (Mul b2~20@ (Mul c2~22@ a2~18@)))) (Mul (Mul b2~20@ (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ d2~24@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ d2~24@) (=> %%location_label%%2 (= temp_2_0~797@ temp_2_1~910@))) (=> (= temp_2_0~797@ temp_2_1~910@) (=> (= temp_3_0~1063@ (Mul (Mul (Mul (Sub (Mul d3~32@ b3~28@) (Mul d3~32@ b3~28@)) b3~28@) (Mul (Add d3~32@ (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@)))) (Mul (Mul (Add (Sub 82 b3~28@) (Mul d3~32@ b3~28@)) (Add (Mul d3~32@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ d3~32@)) (Mul (Sub b3~28@ a3~26@) (Sub c3~30@ a3~26@)))))) (=> (= temp_3_1~1188@ (Mul (Mul (Sub (Mul d3~32@ b3~28@) (Mul d3~32@ b3~28@)) (Mul b3~28@ (Mul (Add d3~32@ (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@))))) (Mul (Mul (Add (Sub 82 b3~28@) (Mul d3~32@ b3~28@)) (Add (Mul d3~32@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ d3~32@)) (Mul (Sub b3~28@ a3~26@) (Sub c3~30@ a3~26@)))))) (and (=> (= tmp%1@ (Sub (Mul d3~32@ b3~28@) (Mul d3~32@ b3~28@))) (=> (= tmp%2@ (Mul (Add d3~32@ (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b3~28@ tmp%2@) (=> %%location_label%%3 (= temp_3_0~1063@ temp_3_1~1188@))))) (=> (= temp_3_0~1063@ temp_3_1~1188@) (=> (= temp_4_0~1387@ (Mul (Mul (Mul (Mul (Add d4~40@ c4~38@) (Add a4~34@ c4~38@)) (Mul (Mul d4~40@ 84) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Add b4~36@ a4~34@) (Mul b4~36@ d4~40@)))) (Mul (Add (Add (Mul c4~38@ a4~34@) c4~38@) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ a4~34@))) (Mul (Mul b4~36@ (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ d4~40@)))))) (=> (= temp_4_1~1520@ (Mul (Mul (Mul (Mul (Add d4~40@ c4~38@) (Add a4~34@ c4~38@)) (Mul (Mul d4~40@ 84) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Add b4~36@ a4~34@) (Mul b4~36@ d4~40@)))) (Mul (Add (Add (Mul c4~38@ a4~34@) c4~38@) (Mul (Mul (Mul b4~36@ d4~40@) c4~38@) a4~34@)) (Mul (Mul b4~36@ (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ d4~40@)))))) (=> (= tmp%3@ (Mul b4~36@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ c4~38@ a4~34@) (=> %%location_label%%4 (= temp_4_0~1387@ temp_4_1~1520@)))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
