...
(set-info :comment ";; mariposa_data/v_nl//18057393037062890410/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_4_1~1060@ Int)
(declare-const temp_5_0~1171@ Int)
(declare-const temp_5_1~1248@ Int)
(declare-const temp_6_0~1409@ Int)
...
(declare-const temp_8_1~1828@ Int)
(declare-const temp_9_0~1967@ Int)
(declare-const temp_9_1~2044@ Int)
(declare-const temp_10_0~2149@ Int)
(declare-const temp_10_1~2214@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ b0~4@))) (Add (Mul (Mul a0~2@ a0~2@) (Sub c0~6@ d0~8@)) b0~4@))) (=> (= temp_0_1~346@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ a0~2@)) (Mul a0~2@ (Mul d0~8@ (Mul c0~6@ b0~4@)))) (Add (Mul (Mul a0~2@ a0~2@) (Sub c0~6@ d0~8@)) b0~4@))) (and (=> (= tmp%1@ (Mul c0~6@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a0~2@ d0~8@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~346@)))) (=> (= temp_0_0~293@ temp_0_1~346@) (=> (= temp_1_0~445@ (Add (Mul (Sub (Sub a1~10@ b1~12@) (Mul d1~16@ d1~16@)) c1~14@) (Mul (Mul (Mul 14 c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~510@ (Add (Mul (Sub (Sub a1~10@ b1~12@) (Mul d1~16@ d1~16@)) c1~14@) (Mul (Mul (Mul (Mul 14 c1~14@) (Mul d1~16@ c1~14@)) (Mul c1~14@ d1~16@)) (Mul b1~12@ c1~14@)))) (and (=> (= tmp%2@ (Mul (Mul 14 c1~14@) (Mul d1~16@ c1~14@))) (=> (= tmp%3@ (Mul c1~14@ d1~16@)) (=> (= tmp%4@ (Mul b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~445@ temp_1_1~510@)))))) (=> (= temp_1_0~445@ temp_1_1~510@) (=> (= temp_2_0~637@ (Mul (Mul (Add (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ b2~20@)) (Mul (Add a2~18@ b2~20@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~702@ (Mul (Mul (Add (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@))) (Mul (Mul c2~22@ (Mul a2~18@ (Mul d2~24@ b2~20@))) (Mul (Add a2~18@ b2~20@) (Mul a2~18@ d2~24@))))) (and (=> (= tmp%5@ (Mul d2~24@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c2~22@ a2~18@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~637@ temp_2_1~702@)))) (=> (= temp_2_0~637@ temp_2_1~702@) (=> (= temp_3_0~797@ (Mul (Mul (Add (Add b3~28@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Add b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ a3~26@) a3~26@) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~858@ (Mul (Mul (Add (Add b3~28@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Add b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ a3~26@) a3~26@)))) (and (=> (= tmp%6@ (Mul (Mul c3~30@ a3~26@) a3~26@)) (=> (= tmp%7@ (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ d3~32@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~797@ temp_3_1~858@))))) (=> (= temp_3_0~797@ temp_3_1~858@) (=> (= temp_4_0~983@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul 23 d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~1060@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul 23 d4~40@) (Mul d4~40@ d4~40@)) (Mul c4~38@ (Mul b4~36@ (Mul d4~40@ c4~38@)))))) (and (=> (= tmp%8@ (Mul d4~40@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c4~38@ b4~36@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~983@ temp_4_1~1060@)))) (=> (= temp_4_0~983@ temp_4_1~1060@) (=> (= temp_5_0~1171@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ 3) (Mul c5~46@ c5~46@))) (Mul (Mul (Add c5~46@ c5~46@) (Sub d5~48@ a5~42@)) (Sub (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1248@ (Mul (Mul (Mul (Add c5~46@ c5~46@) (Sub d5~48@ a5~42@)) (Sub (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ 3) (Mul c5~46@ c5~46@))))) (and (=> (= tmp%9@ (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ 3) (Mul c5~46@ c5~46@)))) (=> (= tmp%10@ (Mul (Mul (Add c5~46@ c5~46@) (Sub d5~48@ a5~42@)) (Sub (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%5 (= temp_5_0~1171@ temp_5_1~1248@))))) (=> (= temp_5_0~1171@ temp_5_1~1248@) (=> (= temp_6_0~1409@ (Mul (Mul (Sub (Mul a6~50@ d6~56@) (Mul d6~56@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ b6~52@))) (Add (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1474@ (Mul (Add (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ c6~54@))) (Mul (Sub (Mul a6~50@ d6~56@) (Mul d6~56@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ b6~52@))))) (and (=> (= tmp%11@ (Mul (Sub (Mul a6~50@ d6~56@) (Mul d6~56@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ b6~52@)))) (=> (= tmp%12@ (Add (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ c6~54@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%6 (= temp_6_0~1409@ temp_6_1~1474@))))) (=> (= temp_6_0~1409@ temp_6_1~1474@) (=> (= temp_7_0~1599@ (Add (Mul c7~62@ (Mul (Mul d7~64@ a7~58@) (Add a7~58@ b7~60@))) (Add c7~62@ (Mul (Sub b7~60@ c7~62@) (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1640@ (Add (Mul c7~62@ (Mul d7~64@ (Mul a7~58@ (Add a7~58@ b7~60@)))) (Add c7~62@ (Mul (Sub b7~60@ c7~62@) (Mul d7~64@ d7~64@))))) (and (=> (= tmp%13@ (Add a7~58@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d7~64@ a7~58@ tmp%13@) (=> %%location_label%%7 (= temp_7_0~1599@ temp_7_1~1640@)))) (=> (= temp_7_0~1599@ temp_7_1~1640@) (=> (= temp_8_0~1751@ (Mul (Mul (Add (Add b8~68@ c8~70@) (Mul b8~68@ d8~72@)) (Mul (Sub a8~66@ c8~70@) (Mul 98 c8~70@))) (Mul (Mul (Sub c8~70@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1828@ (Mul (Mul (Mul (Add (Add b8~68@ c8~70@) (Mul b8~68@ d8~72@)) (Sub a8~66@ c8~70@)) (Mul 98 c8~70@)) (Mul (Mul (Sub c8~70@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ d8~72@))))) (and (=> (= tmp%14@ (Add (Add b8~68@ c8~70@) (Mul b8~68@ d8~72@))) (=> (= tmp%15@ (Sub a8~66@ c8~70@)) (=> (= tmp%16@ (Mul 98 c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%8 (= temp_8_0~1751@ temp_8_1~1828@)))))) (=> (= temp_8_0~1751@ temp_8_1~1828@) (=> (= temp_9_0~1967@ (Mul (Sub (Mul (Sub b9~76@ c9~78@) (Mul 87 d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ c9~78@)) (Add (Mul a9~74@ b9~76@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~2044@ (Mul (Sub (Mul (Sub b9~76@ c9~78@) (Mul d9~80@ 87)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ c9~78@)) (Add (Mul a9~74@ b9~76@) (Mul c9~78@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 87 d9~80@) (=> %%location_label%%9 (= temp_9_0~1967@ temp_9_1~2044@))) (=> (= temp_9_0~1967@ temp_9_1~2044@) (=> (= temp_10_0~2149@ (Mul (Sub (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ 18) (Mul a10~82@ c10~86@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul b10~84@ a10~82@)) d10~88@))) (=> (= temp_10_1~2214@ (Mul (Sub (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ 18) (Mul a10~82@ c10~86@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ a10~82@)) d10~88@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a10~82@ b10~84@) (=> %%location_label%%10 (= temp_10_0~2149@ temp_10_1~2214@))) (=> (= temp_10_0~2149@ temp_10_1~2214@) (=> (= temp_11_0~2319@ (Mul (Mul (Add (Mul b11~92@ d11~96@) (Mul c11~94@ d11~96@)) (Mul (Mul b11~92@ 41) (Add c11~94@ d11~96@))) (Mul (Add (Mul a11~90@ c11~94@) (Mul a11~90@ b11~92@)) (Sub (Mul d11~96@ a11~90@) (Sub c11~94@ b11~92@))))) (=> (= temp_11_1~2392@ (Mul (Mul (Add (Mul b11~92@ d11~96@) (Mul c11~94@ d11~96@)) (Mul (Mul b11~92@ 41) (Add c11~94@ d11~96@))) (Mul (Mul a11~90@ (Add c11~94@ b11~92@)) (Sub (Mul d11~96@ a11~90@) (Sub c11~94@ b11~92@))))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a11~90@ c11~94@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2319@ temp_11_1~2392@))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
