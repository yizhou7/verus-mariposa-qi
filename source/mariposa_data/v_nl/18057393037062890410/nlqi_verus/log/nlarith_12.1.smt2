...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ b0~4@))) (Add (Mul (Mul a0~2@ a0~2@) (Sub c0~6@ d0~8@)) b0~4@))) (=> (= temp_0_1~346@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ a0~2@)) (Mul a0~2@ (Mul d0~8@ (Mul c0~6@ b0~4@)))) (Add (Mul (Mul a0~2@ a0~2@) (Sub c0~6@ d0~8@)) b0~4@))) (=> (= tmp%1@ (= temp_0_0~293@ temp_0_1~346@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~426@ (Add (Mul (Sub (Sub a1~10@ b1~12@) (Mul d1~16@ d1~16@)) c1~14@) (Mul (Mul (Mul 14 c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~491@ (Add (Mul (Sub (Sub a1~10@ b1~12@) (Mul d1~16@ d1~16@)) c1~14@) (Mul (Mul (Mul (Mul 14 c1~14@) (Mul d1~16@ c1~14@)) (Mul c1~14@ d1~16@)) (Mul b1~12@ c1~14@)))) (=> (= tmp%2@ (= temp_1_0~426@ temp_1_1~491@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~571@ (Mul (Mul (Add (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@))) (Mul (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ b2~20@)) (Mul (Add a2~18@ b2~20@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~636@ (Mul (Mul (Add (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ d2~24@))) (Mul (Mul c2~22@ (Mul a2~18@ (Mul d2~24@ b2~20@))) (Mul (Add a2~18@ b2~20@) (Mul a2~18@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~571@ temp_2_1~636@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~712@ (Mul (Mul (Add (Add b3~28@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Add b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ a3~26@) a3~26@) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~773@ (Mul (Mul (Add (Add b3~28@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Add b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ a3~26@) a3~26@)))) (=> (= tmp%4@ (= temp_3_0~712@ temp_3_1~773@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~865@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul 23 d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ c4~38@))))) (=> (= temp_4_1~942@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul 23 d4~40@) (Mul d4~40@ d4~40@)) (Mul c4~38@ (Mul b4~36@ (Mul d4~40@ c4~38@)))))) (=> (= tmp%5@ (= temp_4_0~865@ temp_4_1~942@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1034@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ 3) (Mul c5~46@ c5~46@))) (Mul (Mul (Add c5~46@ c5~46@) (Sub d5~48@ a5~42@)) (Sub (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1111@ (Mul (Mul (Mul (Add c5~46@ c5~46@) (Sub d5~48@ a5~42@)) (Sub (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ 3) (Mul c5~46@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1034@ temp_5_1~1111@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1191@ (Mul (Mul (Sub (Mul a6~50@ d6~56@) (Mul d6~56@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ b6~52@))) (Add (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1256@ (Mul (Add (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ c6~54@))) (Mul (Sub (Mul a6~50@ d6~56@) (Mul d6~56@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1191@ temp_6_1~1256@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1312@ (Add (Mul c7~62@ (Mul (Mul d7~64@ a7~58@) (Add a7~58@ b7~60@))) (Add c7~62@ (Mul (Sub b7~60@ c7~62@) (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1353@ (Add (Mul c7~62@ (Mul d7~64@ (Mul a7~58@ (Add a7~58@ b7~60@)))) (Add c7~62@ (Mul (Sub b7~60@ c7~62@) (Mul d7~64@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1312@ temp_7_1~1353@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1445@ (Mul (Mul (Add (Add b8~68@ c8~70@) (Mul b8~68@ d8~72@)) (Mul (Sub a8~66@ c8~70@) (Mul 98 c8~70@))) (Mul (Mul (Sub c8~70@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1522@ (Mul (Mul (Mul (Add (Add b8~68@ c8~70@) (Mul b8~68@ d8~72@)) (Sub a8~66@ c8~70@)) (Mul 98 c8~70@)) (Mul (Mul (Sub c8~70@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1445@ temp_8_1~1522@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1614@ (Mul (Sub (Mul (Sub b9~76@ c9~78@) (Mul 87 d9~80@)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ c9~78@)) (Add (Mul a9~74@ b9~76@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1691@ (Mul (Sub (Mul (Sub b9~76@ c9~78@) (Mul d9~80@ 87)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul d9~80@ d9~80@) (Mul a9~74@ c9~78@)) (Add (Mul a9~74@ b9~76@) (Mul c9~78@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1614@ temp_9_1~1691@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1771@ (Mul (Sub (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ 18) (Mul a10~82@ c10~86@))) (Mul (Mul (Mul a10~82@ b10~84@) (Mul b10~84@ a10~82@)) d10~88@))) (=> (= temp_10_1~1836@ (Mul (Sub (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ 18) (Mul a10~82@ c10~86@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul b10~84@ a10~82@)) d10~88@))) (=> (= tmp%11@ (= temp_10_0~1771@ temp_10_1~1836@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1928@ (Mul (Mul (Add (Mul b11~92@ d11~96@) (Mul c11~94@ d11~96@)) (Mul (Mul b11~92@ 41) (Add c11~94@ d11~96@))) (Mul (Add (Mul a11~90@ c11~94@) (Mul a11~90@ b11~92@)) (Sub (Mul d11~96@ a11~90@) (Sub c11~94@ b11~92@))))) (=> (= temp_11_1~2001@ (Mul (Mul (Add (Mul b11~92@ d11~96@) (Mul c11~94@ d11~96@)) (Mul (Mul b11~92@ 41) (Add c11~94@ d11~96@))) (Mul (Mul a11~90@ (Add c11~94@ b11~92@)) (Sub (Mul d11~96@ a11~90@) (Sub c11~94@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1928@ temp_11_1~2001@)) (=> %%location_label%%11 tmp%12@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
