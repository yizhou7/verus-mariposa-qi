...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Sub c0~6@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Sub c0~6@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~459@ (Mul (Sub (Mul (Mul a1~10@ 28) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Sub d1~16@ a1~10@))) (Mul (Add (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@)) (Mul b1~12@ (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~532@ (Mul (Mul (Add (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@)) (Mul b1~12@ (Mul c1~14@ b1~12@))) (Sub (Mul (Mul a1~10@ 28) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Sub d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~459@ temp_1_1~532@))) (=> (= temp_1_0~459@ temp_1_1~532@) (=> (= temp_2_0~621@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ b2~20@)) (Add (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@))) (Sub (Mul (Mul a2~18@ c2~22@) (Sub a2~18@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~686@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ b2~20@)) (Add (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@))) (Sub (Mul (Sub a2~18@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~621@ temp_2_1~686@))) (=> (= temp_2_0~621@ temp_2_1~686@) (=> (= temp_3_0~771@ (Add (Mul (Mul d3~32@ (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul (Sub d3~32@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@))))) (=> (= temp_3_1~832@ (Add (Mul d3~32@ (Mul (Mul b3~28@ c3~30@) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@)))) (Mul (Mul (Sub d3~32@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~771@ temp_3_1~832@))) (=> (= temp_3_0~771@ temp_3_1~832@) (=> (= temp_4_0~917@ (Mul (Add (Mul (Add d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Add (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ b4~36@) c4~38@)))) (=> (= temp_4_1~978@ (Mul (Add (Mul (Add d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul b4~36@ b4~36@) c4~38@) (Add (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~917@ temp_4_1~978@))) (=> (= temp_4_0~917@ temp_4_1~978@) (=> (= temp_5_0~1055@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ a5~42@))) (Mul c5~46@ (Add (Mul c5~46@ a5~42@) (Sub b5~44@ c5~46@))))) (=> (= temp_5_1~1112@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ a5~42@))) (Add (Mul c5~46@ (Mul c5~46@ a5~42@)) (Mul c5~46@ (Sub b5~44@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1055@ temp_5_1~1112@))) (=> (= temp_5_0~1055@ temp_5_1~1112@) (=> (= temp_6_0~1197@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Sub a6~50@ a6~50@)) (Sub c6~54@ (Mul d6~56@ a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1258@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Sub a6~50@ a6~50@)) (Sub c6~54@ (Mul d6~56@ a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1197@ temp_6_1~1258@))) (=> (= temp_6_0~1197@ temp_6_1~1258@) (=> (= temp_7_0~1339@ (Mul (Mul (Add (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)) (Mul a7~58@ (Mul d7~64@ c7~62@))) (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ c7~62@) d7~64@)))) (=> (= temp_7_1~1396@ (Mul (Mul (Add (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)) (Mul (Mul d7~64@ c7~62@) a7~58@)) (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ c7~62@) d7~64@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1339@ temp_7_1~1396@))) (=> (= temp_7_0~1339@ temp_7_1~1396@) (=> (= temp_8_0~1481@ (Mul (Sub (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Sub b8~68@ a8~66@))) (Add (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ d8~72@) c8~70@)))) (=> (= temp_8_1~1542@ (Mul (Sub (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Sub b8~68@ a8~66@))) (Add (Mul c8~70@ (Mul c8~70@ (Mul b8~68@ c8~70@))) (Mul (Mul c8~70@ d8~72@) c8~70@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1481@ temp_8_1~1542@))) (=> (= temp_8_0~1481@ temp_8_1~1542@) (=> (= temp_9_0~1651@ (Mul (Add (Sub (Sub b9~76@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul b9~76@ 37) (Mul 58 d9~80@)) (Mul b9~76@ (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~1788@ (Add (Mul (Sub (Sub b9~76@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Mul (Mul b9~76@ 37) (Mul 58 d9~80@)) (Mul b9~76@ (Mul b9~76@ d9~80@)))) (Mul (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@)) (Mul (Mul (Mul b9~76@ 37) (Mul 58 d9~80@)) (Mul b9~76@ (Mul b9~76@ d9~80@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1651@ temp_9_1~1788@))) (=> (= temp_9_0~1651@ temp_9_1~1788@) (=> (= temp_10_0~1885@ (Mul (Sub (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ d10~88@))) (Mul (Mul (Mul c10~86@ a10~82@) 95) (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~1958@ (Mul (Sub (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@)) (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ d10~88@))) (Mul (Mul (Mul c10~86@ a10~82@) 95) (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1885@ temp_10_1~1958@))) (=> (= temp_10_0~1885@ temp_10_1~1958@) (=> (= temp_11_0~2047@ (Mul (Mul (Mul (Add c11~94@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@)) (Mul (Mul c11~94@ a11~90@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2112@ (Mul (Mul (Mul (Add c11~94@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2047@ temp_11_1~2112@))) (=> (= temp_11_0~2047@ temp_11_1~2112@) (=> (= temp_12_0~2213@ (Mul (Mul (Add (Mul a12~98@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul b12~100@ c12~102@) (Add b12~100@ b12~100@)) (Mul (Mul 75 a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2290@ (Mul (Mul (Add (Mul a12~98@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul c12~102@ b12~100@) (Add b12~100@ b12~100@)) (Mul (Mul 75 a12~98@) (Mul c12~102@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2213@ temp_12_1~2290@))) (=> (= temp_12_0~2213@ temp_12_1~2290@) (=> (= temp_13_0~2367@ (Mul (Sub (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ c13~110@)) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@))) (Add (Mul (Mul b13~108@ b13~108@) (Add d13~112@ c13~110@)) d13~112@))) (=> (= temp_13_1~2420@ (Mul (Sub (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ c13~110@)) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@))) (Add (Mul (Mul b13~108@ b13~108@) (Add d13~112@ c13~110@)) d13~112@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2367@ temp_13_1~2420@))) (=> (= temp_13_0~2367@ temp_13_1~2420@) (=> (= temp_14_0~2509@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ b14~116@)) (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ b14~116@))) (Add (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ d14~120@)) (Sub (Mul a14~114@ a14~114@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~2574@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ b14~116@)) (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ b14~116@))) (Add (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ d14~120@)) (Sub (Mul a14~114@ a14~114@) (Mul c14~118@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2509@ temp_14_1~2574@))) (=> (= temp_14_0~2509@ temp_14_1~2574@) (=> (= temp_15_0~2687@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@)) (Mul (Sub c15~126@ d15~128@) (Mul c15~126@ 27))) (Mul (Sub (Mul a15~122@ d15~128@) (Mul d15~128@ a15~122@)) (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ 54))))) (=> (= temp_15_1~2776@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@)) (Mul (Sub c15~126@ d15~128@) (Mul c15~126@ 27))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ 54)) (Sub (Mul a15~122@ d15~128@) (Mul d15~128@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2687@ temp_15_1~2776@))) (=> (= temp_15_0~2687@ temp_15_1~2776@) (=> (= temp_16_0~2865@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@)) (Add (Mul d16~136@ d16~136@) (Mul b16~132@ d16~136@))) (Mul (Mul (Mul c16~134@ c16~134@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ a16~130@) (Sub c16~134@ b16~132@))))) (=> (= temp_16_1~2930@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@)) (Add (Mul d16~136@ d16~136@) (Mul b16~132@ d16~136@))) (Mul (Mul (Mul a16~130@ a16~130@) (Mul c16~134@ c16~134@)) (Mul (Mul b16~132@ a16~130@) (Sub c16~134@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2865@ temp_16_1~2930@))) (=> (= temp_16_0~2865@ temp_16_1~2930@) (=> (= temp_17_0~3027@ (Mul (Mul (Mul (Sub c17~142@ b17~140@) (Mul b17~140@ a17~138@)) (Mul (Sub c17~142@ b17~140@) (Add c17~142@ d17~144@))) (Mul (Mul d17~144@ (Mul b17~140@ a17~138@)) (Add (Add c17~142@ 93) (Add b17~140@ d17~144@))))) (=> (= temp_17_1~3100@ (Mul (Mul (Mul (Sub c17~142@ b17~140@) (Mul b17~140@ a17~138@)) (Mul (Sub c17~142@ b17~140@) (Add c17~142@ d17~144@))) (Mul (Mul d17~144@ (Mul a17~138@ b17~140@)) (Add (Add c17~142@ 93) (Add b17~140@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~3027@ temp_17_1~3100@))) (=> (= temp_17_0~3027@ temp_17_1~3100@) (=> (= temp_18_0~3173@ (Add (Mul (Mul a18~146@ (Sub c18~150@ a18~146@)) (Add (Add b18~148@ a18~146@) (Mul b18~148@ c18~150@))) (Mul (Mul (Add b18~148@ b18~148@) (Mul a18~146@ c18~150@)) a18~146@))) (=> (= temp_18_1~3234@ (Add (Add (Mul (Mul a18~146@ (Sub c18~150@ a18~146@)) (Add b18~148@ a18~146@)) (Mul (Mul a18~146@ (Sub c18~150@ a18~146@)) (Mul b18~148@ c18~150@))) (Mul (Mul (Add b18~148@ b18~148@) (Mul a18~146@ c18~150@)) a18~146@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3173@ temp_18_1~3234@))) (=> (= temp_18_0~3173@ temp_18_1~3234@) (=> (= temp_19_0~3311@ (Mul (Mul (Mul (Sub c19~158@ d19~160@) (Mul a19~154@ a19~154@)) (Mul (Sub c19~158@ b19~156@) (Add d19~160@ d19~160@))) (Mul d19~160@ (Mul (Sub a19~154@ c19~158@) (Mul a19~154@ c19~158@))))) (=> (= temp_19_1~3364@ (Mul (Mul d19~160@ (Mul (Sub a19~154@ c19~158@) (Mul a19~154@ c19~158@))) (Mul (Mul (Sub c19~158@ d19~160@) (Mul a19~154@ a19~154@)) (Mul (Sub c19~158@ b19~156@) (Add d19~160@ d19~160@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3311@ temp_19_1~3364@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
