...
(set-info :comment ";; mariposa_data/v_nl//8601151044767494818/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_5_1~1250@ Int)
...
(declare-const temp_10_0~2137@ Int)
(declare-const temp_10_1~2210@ Int)
(declare-const temp_11_0~2311@ Int)
(declare-const temp_11_1~2376@ Int)
(declare-const temp_12_0~2481@ Int)
(declare-const temp_12_1~2558@ Int)
(declare-const temp_13_0~2639@ Int)
(declare-const temp_13_1~2692@ Int)
(declare-const temp_14_0~2785@ Int)
(declare-const temp_14_1~2850@ Int)
(declare-const temp_15_0~2967@ Int)
(declare-const temp_15_1~3056@ Int)
(declare-const temp_16_0~3185@ Int)
(declare-const temp_16_1~3250@ Int)
(declare-const temp_17_0~3359@ Int)
(declare-const temp_17_1~3432@ Int)
(declare-const temp_18_0~3509@ Int)
(declare-const temp_18_1~3570@ Int)
(declare-const temp_19_0~3669@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Sub c0~6@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Sub c0~6@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ a0~2@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (and (=> (= tmp%1@ (Mul d0~8@ a0~2@)) (=> (= tmp%2@ (Mul b0~4@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~471@ (Mul (Sub (Mul (Mul a1~10@ 28) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Sub d1~16@ a1~10@))) (Mul (Add (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@)) (Mul b1~12@ (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~544@ (Mul (Mul (Add (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@)) (Mul b1~12@ (Mul c1~14@ b1~12@))) (Sub (Mul (Mul a1~10@ 28) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Sub d1~16@ a1~10@))))) (and (=> (= tmp%3@ (Sub (Mul (Mul a1~10@ 28) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Sub d1~16@ a1~10@)))) (=> (= tmp%4@ (Mul (Add (Mul a1~10@ b1~12@) (Mul c1~14@ c1~14@)) (Mul b1~12@ (Mul c1~14@ b1~12@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~471@ temp_1_1~544@))))) (=> (= temp_1_0~471@ temp_1_1~544@) (=> (= temp_2_0~701@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ b2~20@)) (Add (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@))) (Sub (Mul (Mul a2~18@ c2~22@) (Sub a2~18@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@))))) (=> (= temp_2_1~766@ (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ b2~20@)) (Add (Mul b2~20@ c2~22@) (Mul b2~20@ a2~18@))) (Sub (Mul (Sub a2~18@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ a2~18@))))) (and (=> (= tmp%5@ (Mul a2~18@ c2~22@)) (=> (= tmp%6@ (Sub a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%2 (= temp_2_0~701@ temp_2_1~766@))))) (=> (= temp_2_0~701@ temp_2_1~766@) (=> (= temp_3_0~863@ (Add (Mul (Mul d3~32@ (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul (Sub d3~32@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@))))) (=> (= temp_3_1~924@ (Add (Mul d3~32@ (Mul (Mul b3~28@ c3~30@) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@)))) (Mul (Mul (Sub d3~32@ b3~28@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@))))) (and (=> (= tmp%7@ (Mul b3~28@ c3~30@)) (=> (= tmp%8@ (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. d3~32@ tmp%7@ tmp%8@) (=> %%location_label%%3 (= temp_3_0~863@ temp_3_1~924@))))) (=> (= temp_3_0~863@ temp_3_1~924@) (=> (= temp_4_0~1031@ (Mul (Add (Mul (Add d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Add (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ b4~36@) c4~38@)))) (=> (= temp_4_1~1092@ (Mul (Add (Mul (Add d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul b4~36@ b4~36@) c4~38@) (Add (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@))))) (and (=> (= tmp%9@ (Add (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@))) (=> (= tmp%10@ (Mul (Mul b4~36@ b4~36@) c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%4 (= temp_4_0~1031@ temp_4_1~1092@))))) (=> (= temp_4_0~1031@ temp_4_1~1092@) (=> (= temp_5_0~1193@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ a5~42@))) (Mul c5~46@ (Add (Mul c5~46@ a5~42@) (Sub b5~44@ c5~46@))))) (=> (= temp_5_1~1250@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ a5~42@))) (Add (Mul c5~46@ (Mul c5~46@ a5~42@)) (Mul c5~46@ (Sub b5~44@ c5~46@))))) (and (=> (= tmp%11@ (Mul c5~46@ a5~42@)) (=> (= tmp%12@ (Sub b5~44@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c5~46@ tmp%11@ tmp%12@) (=> %%location_label%%5 (= temp_5_0~1193@ temp_5_1~1250@))))) (=> (= temp_5_0~1193@ temp_5_1~1250@) (=> (= temp_6_0~1349@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Sub a6~50@ a6~50@)) (Sub c6~54@ (Mul d6~56@ a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1410@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Sub a6~50@ a6~50@)) (Sub c6~54@ (Mul d6~56@ a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1349@ temp_6_1~1410@))) (=> (= temp_6_0~1349@ temp_6_1~1410@) (=> (= temp_7_0~1495@ (Mul (Mul (Add (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)) (Mul a7~58@ (Mul d7~64@ c7~62@))) (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ c7~62@) d7~64@)))) (=> (= temp_7_1~1552@ (Mul (Mul (Add (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)) (Mul (Mul d7~64@ c7~62@) a7~58@)) (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ c7~62@) d7~64@)))) (and (=> (= tmp%13@ (Mul d7~64@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ tmp%13@) (=> %%location_label%%7 (= temp_7_0~1495@ temp_7_1~1552@)))) (=> (= temp_7_0~1495@ temp_7_1~1552@) (=> (= temp_8_0~1645@ (Mul (Sub (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Sub b8~68@ a8~66@))) (Add (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ d8~72@) c8~70@)))) (=> (= temp_8_1~1706@ (Mul (Sub (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Sub b8~68@ a8~66@))) (Add (Mul c8~70@ (Mul c8~70@ (Mul b8~68@ c8~70@))) (Mul (Mul c8~70@ d8~72@) c8~70@)))) (and (=> (= tmp%14@ (Mul b8~68@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c8~70@ c8~70@ tmp%14@) (=> %%location_label%%8 (= temp_8_0~1645@ temp_8_1~1706@)))) (=> (= temp_8_0~1645@ temp_8_1~1706@) (=> (= temp_9_0~1825@ (Mul (Add (Sub (Sub b9~76@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul b9~76@ 37) (Mul 58 d9~80@)) (Mul b9~76@ (Mul b9~76@ d9~80@))))) (=> (= temp_9_1~1962@ (Add (Mul (Sub (Sub b9~76@ a9~74@) (Mul a9~74@ a9~74@)) (Mul (Mul (Mul b9~76@ 37) (Mul 58 d9~80@)) (Mul b9~76@ (Mul b9~76@ d9~80@)))) (Mul (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@)) (Mul (Mul (Mul b9~76@ 37) (Mul 58 d9~80@)) (Mul b9~76@ (Mul b9~76@ d9~80@)))))) (and (=> (= tmp%15@ (Sub (Sub b9~76@ a9~74@) (Mul a9~74@ a9~74@))) (=> (= tmp%16@ (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@))) (=> (= tmp%17@ (Mul (Mul (Mul b9~76@ 37) (Mul 58 d9~80@)) (Mul b9~76@ (Mul b9~76@ d9~80@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%15@ tmp%16@ tmp%17@) (=> %%location_label%%9 (= temp_9_0~1825@ temp_9_1~1962@)))))) (=> (= temp_9_0~1825@ temp_9_1~1962@) (=> (= temp_10_0~2137@ (Mul (Sub (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ d10~88@))) (Mul (Mul (Mul c10~86@ a10~82@) 95) (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~2210@ (Mul (Sub (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@)) (Mul (Mul d10~88@ b10~84@) (Mul d10~88@ d10~88@))) (Mul (Mul (Mul c10~86@ a10~82@) 95) (Mul (Mul b10~84@ c10~86@) (Mul c10~86@ a10~82@))))) (and (=> (= tmp%18@ (Mul a10~82@ c10~86@)) (=> (= tmp%19@ (Mul c10~86@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%10 (= temp_10_0~2137@ temp_10_1~2210@))))) (=> (= temp_10_0~2137@ temp_10_1~2210@) (=> (= temp_11_0~2311@ (Mul (Mul (Mul (Add c11~94@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@)) (Mul (Mul c11~94@ a11~90@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2376@ (Mul (Mul (Mul (Add c11~94@ b11~92@) (Mul b11~92@ b11~92@)) (Mul (Mul c11~94@ d11~96@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul a11~90@ b11~92@) (Mul c11~94@ d11~96@)) (Mul (Mul a11~90@ c11~94@) (Mul d11~96@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c11~94@ a11~90@) (=> %%location_label%%11 (= temp_11_0~2311@ temp_11_1~2376@))) (=> (= temp_11_0~2311@ temp_11_1~2376@) (=> (= temp_12_0~2481@ (Mul (Mul (Add (Mul a12~98@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul b12~100@ c12~102@) (Add b12~100@ b12~100@)) (Mul (Mul 75 a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2558@ (Mul (Mul (Add (Mul a12~98@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul c12~102@ d12~104@) (Mul d12~104@ c12~102@))) (Mul (Mul (Mul c12~102@ b12~100@) (Add b12~100@ b12~100@)) (Mul (Mul 75 a12~98@) (Mul c12~102@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ c12~102@) (=> %%location_label%%12 (= temp_12_0~2481@ temp_12_1~2558@))) (=> (= temp_12_0~2481@ temp_12_1~2558@) (=> (= temp_13_0~2639@ (Mul (Sub (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ c13~110@)) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@))) (Add (Mul (Mul b13~108@ b13~108@) (Add d13~112@ c13~110@)) d13~112@))) (=> (= temp_13_1~2692@ (Mul (Sub (Mul (Mul d13~112@ a13~106@) (Mul a13~106@ c13~110@)) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@))) (Add (Mul (Mul b13~108@ b13~108@) (Add d13~112@ c13~110@)) d13~112@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b13~108@ b13~108@) (=> %%location_label%%13 (= temp_13_0~2639@ temp_13_1~2692@))) (=> (= temp_13_0~2639@ temp_13_1~2692@) (=> (= temp_14_0~2785@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ b14~116@)) (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ b14~116@))) (Add (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ d14~120@)) (Sub (Mul a14~114@ a14~114@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~2850@ (Mul (Mul (Mul (Mul d14~120@ c14~118@) (Mul a14~114@ b14~116@)) (Mul (Sub d14~120@ a14~114@) (Mul d14~120@ b14~116@))) (Add (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ d14~120@)) (Sub (Mul a14~114@ a14~114@) (Mul c14~118@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d14~120@ d14~120@) (=> %%location_label%%14 (= temp_14_0~2785@ temp_14_1~2850@))) (=> (= temp_14_0~2785@ temp_14_1~2850@) (=> (= temp_15_0~2967@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@)) (Mul (Sub c15~126@ d15~128@) (Mul c15~126@ 27))) (Mul (Sub (Mul a15~122@ d15~128@) (Mul d15~128@ a15~122@)) (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ 54))))) (=> (= temp_15_1~3056@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul d15~128@ d15~128@)) (Mul (Sub c15~126@ d15~128@) (Mul c15~126@ 27))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ 54)) (Sub (Mul a15~122@ d15~128@) (Mul d15~128@ a15~122@))))) (and (=> (= tmp%20@ (Sub (Mul a15~122@ d15~128@) (Mul d15~128@ a15~122@))) (=> (= tmp%21@ (Mul (Mul a15~122@ c15~126@) (Mul b15~124@ 54))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%15 (= temp_15_0~2967@ temp_15_1~3056@))))) (=> (= temp_15_0~2967@ temp_15_1~3056@) (=> (= temp_16_0~3185@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@)) (Add (Mul d16~136@ d16~136@) (Mul b16~132@ d16~136@))) (Mul (Mul (Mul c16~134@ c16~134@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ a16~130@) (Sub c16~134@ b16~132@))))) (=> (= temp_16_1~3250@ (Mul (Mul (Mul (Mul b16~132@ d16~136@) (Mul c16~134@ d16~136@)) (Add (Mul d16~136@ d16~136@) (Mul b16~132@ d16~136@))) (Mul (Mul (Mul a16~130@ a16~130@) (Mul c16~134@ c16~134@)) (Mul (Mul b16~132@ a16~130@) (Sub c16~134@ b16~132@))))) (and (=> (= tmp%22@ (Mul c16~134@ c16~134@)) (=> (= tmp%23@ (Mul a16~130@ a16~130@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%16 (= temp_16_0~3185@ temp_16_1~3250@))))) (=> (= temp_16_0~3185@ temp_16_1~3250@) (=> (= temp_17_0~3359@ (Mul (Mul (Mul (Sub c17~142@ b17~140@) (Mul b17~140@ a17~138@)) (Mul (Sub c17~142@ b17~140@) (Add c17~142@ d17~144@))) (Mul (Mul d17~144@ (Mul b17~140@ a17~138@)) (Add (Add c17~142@ 93) (Add b17~140@ d17~144@))))) (=> (= temp_17_1~3432@ (Mul (Mul (Mul (Sub c17~142@ b17~140@) (Mul b17~140@ a17~138@)) (Mul (Sub c17~142@ b17~140@) (Add c17~142@ d17~144@))) (Mul (Mul d17~144@ (Mul a17~138@ b17~140@)) (Add (Add c17~142@ 93) (Add b17~140@ d17~144@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b17~140@ a17~138@) (=> %%location_label%%17 (= temp_17_0~3359@ temp_17_1~3432@))) (=> (= temp_17_0~3359@ temp_17_1~3432@) (=> (= temp_18_0~3509@ (Add (Mul (Mul a18~146@ (Sub c18~150@ a18~146@)) (Add (Add b18~148@ a18~146@) (Mul b18~148@ c18~150@))) (Mul (Mul (Add b18~148@ b18~148@) (Mul a18~146@ c18~150@)) a18~146@))) (=> (= temp_18_1~3570@ (Add (Add (Mul (Mul a18~146@ (Sub c18~150@ a18~146@)) (Add b18~148@ a18~146@)) (Mul (Mul a18~146@ (Sub c18~150@ a18~146@)) (Mul b18~148@ c18~150@))) (Mul (Mul (Add b18~148@ b18~148@) (Mul a18~146@ c18~150@)) a18~146@))) (and (=> (= tmp%24@ (Mul a18~146@ (Sub c18~150@ a18~146@))) (=> (= tmp%25@ (Add b18~148@ a18~146@)) (=> (= tmp%26@ (Mul b18~148@ c18~150@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%18 (= temp_18_0~3509@ temp_18_1~3570@)))))) (=> (= temp_18_0~3509@ temp_18_1~3570@) (=> (= temp_19_0~3669@ (Mul (Mul (Mul (Sub c19~158@ d19~160@) (Mul a19~154@ a19~154@)) (Mul (Sub c19~158@ b19~156@) (Add d19~160@ d19~160@))) (Mul d19~160@ (Mul (Sub a19~154@ c19~158@) (Mul a19~154@ c19~158@))))) (=> (= temp_19_1~3722@ (Mul (Mul d19~160@ (Mul (Sub a19~154@ c19~158@) (Mul a19~154@ c19~158@))) (Mul (Mul (Sub c19~158@ d19~160@) (Mul a19~154@ a19~154@)) (Mul (Sub c19~158@ b19~156@) (Add d19~160@ d19~160@))))) (=> (= tmp%27@ (Mul (Mul (Sub c19~158@ d19~160@) (Mul a19~154@ a19~154@)) (Mul (Sub c19~158@ b19~156@) (Add d19~160@ d19~160@)))) (=> (= tmp%28@ (Mul d19~160@ (Mul (Sub a19~154@ c19~158@) (Mul a19~154@ c19~158@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%19 (= temp_19_0~3669@ temp_19_1~3722@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
