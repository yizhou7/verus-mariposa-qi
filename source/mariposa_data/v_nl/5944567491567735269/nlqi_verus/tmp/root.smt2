...
(push)
 ...
 (declare-const temp_2_1~666@ Int)
 ...
 (declare-const temp_5_1~1144@ Int)
 ...
 (declare-const temp_8_1~1614@ Int)
 ...
 (declare-const temp_13_0~2235@ Int)
 (declare-const temp_13_1~2272@ Int)
 (declare-const temp_14_0~2381@ Int)
 (declare-const temp_14_1~2466@ Int)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~455@ (Mul (Mul (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@
              c1~14@
             ) (Mul a1~10@ d1~16@)
            )
         ...
         (=>
          (= temp_1_1~516@ (Mul (Mul (Mul c1~14@ (Mul c1~14@ (Mul b1~12@ b1~12@))) (Mul (Mul a1~10@
               c1~14@
              ) (Mul a1~10@ d1~16@)
             )
            ) (Mul (Sub (Mul b1~12@ a1~10@) (Add c1~14@ b1~12@)) (Mul (Mul b1~12@ b1~12@) d1~16@))
          ...
          (and
           ...
           (=>
            (= temp_1_0~455@ temp_1_1~516@)
            (=>
             (= temp_2_0~605@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@
                  c2~22@
                 ) (Mul b2~20@ d2~24@)
                )
             ...
             (=>
              (= temp_2_1~666@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@
                   c2~22@
                  ) (Mul b2~20@ d2~24@)
                 )
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~605@ temp_2_1~666@)
               ))
               (=>
                (= temp_2_0~605@ temp_2_1~666@)
                (=>
                 (= temp_3_0~755@ (Mul (Mul (Mul (Add d3~32@ b3~28@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@
                      c3~30@
                     ) (Mul a3~26@ c3~30@)
                    )
                 ...
                 (=>
                  (= temp_3_1~828@ (Mul (Mul (Add (Mul d3~32@ (Mul b3~28@ d3~32@)) (Mul b3~28@ (Mul b3~28@
                        d3~32@
                      ))
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~755@ temp_3_1~828@)
                   ))
                   (=>
                    (= temp_3_0~755@ temp_3_1~828@)
                    (=>
                     (= temp_4_0~917@ (Mul (Add (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Mul b4~36@
                          d4~40@
                         ) (Mul a4~34@ a4~34@)
                        )
                     ...
                     (=>
                      (= temp_4_1~998@ (Mul (Add (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Mul b4~36@
                           d4~40@
                          ) (Mul a4~34@ a4~34@)
                         )
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~917@ temp_4_1~998@)
                       ))
                       (=>
                        (= temp_4_0~917@ temp_4_1~998@)
                        (=>
                         (= temp_5_0~1083@ (Sub (Mul (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@
                              c5~46@
                             ) (Add d5~48@ d5~48@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1144@ (Sub (Mul (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@)) (Mul c5~46@
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1083@ temp_5_1~1144@)
                           ))
                           (=>
                            (= temp_5_0~1083@ temp_5_1~1144@)
                            (=>
                             (= temp_6_0~1229@ (Mul (Mul d6~56@ (Mul (Mul d6~56@ c6~54@) c6~54@)) (Mul (Sub (Mul c6~54@
                                  d6~56@
                                 ) (Mul 75 c6~54@)
                                ) (Mul (Sub b6~52@ c6~54@) (Mul a6~50@ a6~50@))
                             )))
                             (=>
                              (= temp_6_1~1290@ (Mul (Mul d6~56@ (Mul (Mul d6~56@ c6~54@) c6~54@)) (Mul (Sub (Mul c6~54@
                                   d6~56@
                                  ) (Mul c6~54@ 75)
                                 ) (Mul (Sub b6~52@ c6~54@) (Mul a6~50@ a6~50@))
                              )))
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1229@ temp_6_1~1290@)
                               ))
                               (=>
                                (= temp_6_0~1229@ temp_6_1~1290@)
                                (=>
                                 (= temp_7_0~1387@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@
                                      a7~58@
                                     ) (Mul a7~58@ b7~60@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1460@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@
                                       a7~58@
                                      ) (Mul a7~58@ b7~60@)
                                     )
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1387@ temp_7_1~1460@)
                                   ))
                                   (=>
                                    (= temp_7_0~1387@ temp_7_1~1460@)
                                    (=>
                                     (= temp_8_0~1545@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) b8~68@) (Mul (Sub c8~70@ b8~68@)
                                         (Mul a8~66@ b8~68@)
                                        )
                                     ...
                                     (=>
                                      (= temp_8_1~1614@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) b8~68@) (Sub (Mul c8~70@ (Mul a8~66@
                                            b8~68@
                                           )
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1545@ temp_8_1~1614@)
                                       ))
                                       (=>
                                        (= temp_8_0~1545@ temp_8_1~1614@)
                                        (=>
                                         (= temp_9_0~1675@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Add c9~78@ c9~78@)) (Mul (Mul b9~76@
                                              b9~76@
                                             ) (Mul d9~80@ a9~74@)
                                            )
                                           ) a9~74@
                                         ...
                                         (=>
                                          (= temp_9_1~1712@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Add c9~78@ c9~78@)) (Mul (Mul (Mul
                                                b9~76@ b9~76@
                                               ) d9~80@
                                              ) a9~74@
                                             )
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1675@ temp_9_1~1712@)
                                           ))
                                           (=>
                                            (= temp_9_0~1675@ temp_9_1~1712@)
                                            (=>
                                             (= temp_10_0~1801@ (Sub (Mul (Mul (Sub c10~86@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (
                                                  Mul a10~82@ c10~86@
                                                 ) (Mul d10~88@ b10~84@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1866@ (Sub (Mul (Mul (Sub c10~86@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (
                                                   Mul a10~82@ c10~86@
                                                  ) (Mul d10~88@ b10~84@)
                                                 )
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1801@ temp_10_1~1866@)
                                               ))
                                               (=>
                                                (= temp_10_0~1801@ temp_10_1~1866@)
                                                (=>
                                                 (= temp_11_0~1955@ (Mul (Mul (Mul (Add a11~90@ a11~90@) (Sub a11~90@ d11~96@)) (Mul (
                                                      Mul d11~96@ c11~94@
                                                     ) (Mul a11~90@ a11~90@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2020@ (Mul (Mul (Mul (Add a11~90@ a11~90@) (Sub a11~90@ d11~96@)) (Mul (
                                                       Mul d11~96@ c11~94@
                                                      ) (Mul a11~90@ a11~90@)
                                                     )
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~1955@ temp_11_1~2020@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~1955@ temp_11_1~2020@)
                                                    (=>
                                                     (= temp_12_0~2109@ (Mul (Add (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ a12~98@)) (Mul
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2174@ (Mul (Mul (Add (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ a12~98@))
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2109@ temp_12_1~2174@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2109@ temp_12_1~2174@)
                                                        (=>
                                                         (= temp_13_0~2235@ (Sub (Mul (Mul (Sub b13~108@ d13~112@) (Sub c13~110@ c13~110@)) (
                                                             Mul (Mul b13~108@ d13~112@) (Mul a13~106@ a13~106@)
                                                            )
                                                           ) a13~106@
                                                         ))
                                                         (=>
                                                          (= temp_13_1~2272@ (Sub (Mul (Mul (Sub b13~108@ d13~112@) (Sub c13~110@ c13~110@)) (
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2235@ temp_13_1~2272@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2235@ temp_13_1~2272@)
                                                            (=>
                                                             (= temp_14_0~2381@ (Sub (Mul (Mul (Mul c14~118@ d14~120@) (Mul c14~118@ 8)) (Mul 59 (
                                                                  Mul b14~116@ d14~120@
                                                                ))
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2466@ (Sub (Mul (Mul (Mul c14~118@ d14~120@) (Mul c14~118@ 8)) (Mul (Mul
                                                                   59 b14~116@
                                                                  ) d14~120@
                                                                 )
                                                                ) (Mul (Mul (Mul a14~114@ b14~116@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ c14~118@)
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2381@ temp_14_1~2466@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2381@ temp_14_1~2466@)
                                                                (=>
                                                                 (= temp_15_0~2543@ (Mul (Mul d15~128@ (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ c15~126@)))
                                                                   (Mul (Sub (Add d15~128@ b15~124@) (Mul d15~128@ a15~122@)) (Add (Mul d15~128@ b15~124@)
                                                                     (Mul a15~122@ d15~128@)
                                                                 ))))
                                                                 (=>
                                                                  (= temp_15_1~2596@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ c15~126@)) d15~128@)
                                                                    (Mul (Sub (Add d15~128@ b15~124@) (Mul d15~128@ a15~122@)) (Add (Mul d15~128@ b15~124@)
                                                                      (Mul a15~122@ d15~128@)
                                                                  ))))
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2543@ temp_15_1~2596@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2543@ temp_15_1~2596@)
                                                                    (=>
                                                                     (= temp_16_0~2677@ (Mul (Mul (Mul a16~130@ (Mul c16~134@ d16~136@)) (Mul (Mul b16~132@
                                                                          b16~132@
                                                                         ) (Mul a16~130@ d16~136@)
                                                                        )
                                                                     ...
                                                                     (=>
                                                                      (= temp_16_1~2734@ (Mul (Mul (Mul a16~130@ (Mul c16~134@ d16~136@)) (Mul (Mul b16~132@
                                                                           b16~132@
                                                                          ) (Mul a16~130@ d16~136@)
                                                                         )
                                                                      ...
                                                                      (and
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         %%location_label%%16
                                                                         (= temp_16_0~2677@ temp_16_1~2734@)
                                                                       ))
                                                                       (=>
                                                                        (= temp_16_0~2677@ temp_16_1~2734@)
                                                                        (=>
                                                                         (= temp_17_0~2823@ (Mul (Mul (Sub (Mul b17~140@ c17~142@) (Mul c17~142@ c17~142@)) (
                                                                         ...
                                                                         (=>
                                                                          (= temp_17_1~2888@ (Mul (Mul (Sub (Mul b17~140@ c17~142@) (Mul c17~142@ c17~142@)) (
                                                                              Mul (Mul a17~138@ d17~144@) (Mul c17~142@ c17~142@)
                                                                             )
