...
(set-info :comment ";; mariposa_data/v_nl//5944567491567735269/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_6_0~1303@ Int)
(declare-const temp_6_1~1364@ Int)
(declare-const temp_7_0~1477@ Int)
(declare-const temp_7_1~1550@ Int)
...
(declare-const temp_12_0~2265@ Int)
(declare-const temp_12_1~2330@ Int)
(declare-const temp_13_0~2449@ Int)
(declare-const temp_13_1~2486@ Int)
(declare-const temp_14_0~2599@ Int)
(declare-const temp_14_1~2684@ Int)
(declare-const temp_15_0~2779@ Int)
(declare-const temp_15_1~2832@ Int)
(declare-const temp_16_0~2929@ Int)
(declare-const temp_16_1~2986@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Mul (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Add d0~8@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~370@ (Sub (Mul (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ d0~8@) (Add d0~8@ b0~4@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@))))) (and (=> (= tmp%1@ (Add d0~8@ b0~4@)) (=> (= tmp%2@ (Mul d0~8@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~467@ (Mul (Mul (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@ c1~14@) (Mul a1~10@ d1~16@))) (Mul (Sub (Mul b1~12@ a1~10@) (Add c1~14@ b1~12@)) (Mul (Mul b1~12@ b1~12@) d1~16@)))) (=> (= temp_1_1~528@ (Mul (Mul (Mul c1~14@ (Mul c1~14@ (Mul b1~12@ b1~12@))) (Mul (Mul a1~10@ c1~14@) (Mul a1~10@ d1~16@))) (Mul (Sub (Mul b1~12@ a1~10@) (Add c1~14@ b1~12@)) (Mul (Mul b1~12@ b1~12@) d1~16@)))) (and (=> (= tmp%3@ (Mul b1~12@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c1~14@ c1~14@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~467@ temp_1_1~528@)))) (=> (= temp_1_0~467@ temp_1_1~528@) (=> (= temp_2_0~627@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@))) (Mul (Add (Mul c2~22@ a2~18@) (Mul d2~24@ c2~22@)) (Add (Mul d2~24@ a2~18@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~688@ (Add (Mul (Mul (Mul d2~24@ d2~24@) (Add a2~18@ a2~18@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@))) (Mul (Add (Mul c2~22@ a2~18@) (Mul d2~24@ c2~22@)) (Mul d2~24@ (Add a2~18@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d2~24@ a2~18@ b2~20@) (=> %%location_label%%2 (= temp_2_0~627@ temp_2_1~688@))) (=> (= temp_2_0~627@ temp_2_1~688@) (=> (= temp_3_0~783@ (Mul (Mul (Mul (Add d3~32@ b3~28@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)) (Add (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~856@ (Mul (Mul (Add (Mul d3~32@ (Mul b3~28@ d3~32@)) (Mul b3~28@ (Mul b3~28@ d3~32@))) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)) (Add (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@))))) (and (=> (= tmp%4@ (Mul b3~28@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d3~32@ b3~28@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~783@ temp_3_1~856@)))) (=> (= temp_3_0~783@ temp_3_1~856@) (=> (= temp_4_0~955@ (Mul (Add (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ d4~40@)) (Sub (Mul b4~36@ a4~34@) (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~1036@ (Mul (Add (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ a4~34@))) (Sub (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ d4~40@)) (Mul b4~36@ a4~34@)) (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ d4~40@)) (Mul c4~38@ c4~38@))))) (and (=> (= tmp%5@ (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ d4~40@))) (=> (= tmp%6@ (Mul b4~36@ a4~34@)) (=> (= tmp%7@ (Mul c4~38@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%4 (= temp_4_0~955@ temp_4_1~1036@)))))) (=> (= temp_4_0~955@ temp_4_1~1036@) (=> (= temp_5_0~1147@ (Sub (Mul (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Add d5~48@ d5~48@))) (Mul (Add (Add d5~48@ d5~48@) (Mul b5~44@ a5~42@)) (Mul a5~42@ (Mul c5~46@ d5~48@))))) (=> (= temp_5_1~1208@ (Sub (Mul (Mul (Mul c5~46@ c5~46@) (Mul a5~42@ d5~48@)) (Mul c5~46@ (Mul c5~46@ (Add d5~48@ d5~48@)))) (Mul (Add (Add d5~48@ d5~48@) (Mul b5~44@ a5~42@)) (Mul a5~42@ (Mul c5~46@ d5~48@))))) (and (=> (= tmp%8@ (Add d5~48@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c5~46@ c5~46@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~1147@ temp_5_1~1208@)))) (=> (= temp_5_0~1147@ temp_5_1~1208@) (=> (= temp_6_0~1303@ (Mul (Mul d6~56@ (Mul (Mul d6~56@ c6~54@) c6~54@)) (Mul (Sub (Mul c6~54@ d6~56@) (Mul 75 c6~54@)) (Mul (Sub b6~52@ c6~54@) (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1364@ (Mul (Mul d6~56@ (Mul (Mul d6~56@ c6~54@) c6~54@)) (Mul (Sub (Mul c6~54@ d6~56@) (Mul c6~54@ 75)) (Mul (Sub b6~52@ c6~54@) (Mul a6~50@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 75 c6~54@) (=> %%location_label%%6 (= temp_6_0~1303@ temp_6_1~1364@))) (=> (= temp_6_0~1303@ temp_6_1~1364@) (=> (= temp_7_0~1477@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ b7~60@))) (Mul (Mul a7~58@ (Sub b7~60@ c7~62@)) (Mul (Add d7~64@ d7~64@) (Sub d7~64@ 79))))) (=> (= temp_7_1~1550@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ b7~60@))) (Mul (Mul a7~58@ (Sub b7~60@ c7~62@)) (Mul (Sub d7~64@ 79) (Add d7~64@ d7~64@))))) (and (=> (= tmp%9@ (Add d7~64@ d7~64@)) (=> (= tmp%10@ (Sub d7~64@ 79)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~1477@ temp_7_1~1550@))))) (=> (= temp_7_0~1477@ temp_7_1~1550@) (=> (= temp_8_0~1659@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) b8~68@) (Mul (Sub c8~70@ b8~68@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1728@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) b8~68@) (Sub (Mul c8~70@ (Mul a8~66@ b8~68@)) (Mul b8~68@ (Mul a8~66@ b8~68@)))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ a8~66@))))) (and (=> (= tmp%11@ (Mul a8~66@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c8~70@ b8~68@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~1659@ temp_8_1~1728@)))) (=> (= temp_8_0~1659@ temp_8_1~1728@) (=> (= temp_9_0~1799@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Add c9~78@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ a9~74@))) a9~74@)) (=> (= temp_9_1~1836@ (Mul (Mul (Mul (Mul c9~78@ d9~80@) (Add c9~78@ c9~78@)) (Mul (Mul (Mul b9~76@ b9~76@) d9~80@) a9~74@)) a9~74@)) (and (=> (= tmp%12@ (Mul b9~76@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ d9~80@ a9~74@) (=> %%location_label%%9 (= temp_9_0~1799@ temp_9_1~1836@)))) (=> (= temp_9_0~1799@ temp_9_1~1836@) (=> (= temp_10_0~1935@ (Sub (Mul (Mul (Sub c10~86@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@))) (Mul (Mul (Sub a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ b10~84@))))) (=> (= temp_10_1~2000@ (Sub (Mul (Mul (Sub c10~86@ c10~86@) (Mul c10~86@ d10~88@)) (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ b10~84@))) (Mul (Mul (Mul (Sub a10~82@ c10~86@) d10~88@) d10~88@) (Mul (Mul a10~82@ a10~82@) (Mul d10~88@ b10~84@))))) (and (=> (= tmp%13@ (Sub a10~82@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ d10~88@ d10~88@) (=> %%location_label%%10 (= temp_10_0~1935@ temp_10_1~2000@)))) (=> (= temp_10_0~1935@ temp_10_1~2000@) (=> (= temp_11_0~2099@ (Mul (Mul (Mul (Add a11~90@ a11~90@) (Sub a11~90@ d11~96@)) (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ a11~90@))) (Mul (Mul (Sub a11~90@ d11~96@) (Mul c11~94@ c11~94@)) (Add (Mul c11~94@ d11~96@) (Mul d11~96@ c11~94@))))) (=> (= temp_11_1~2164@ (Mul (Mul (Mul (Add a11~90@ a11~90@) (Sub a11~90@ d11~96@)) (Mul (Mul d11~96@ c11~94@) (Mul a11~90@ a11~90@))) (Mul (Mul (Mul c11~94@ c11~94@) (Sub a11~90@ d11~96@)) (Add (Mul c11~94@ d11~96@) (Mul d11~96@ c11~94@))))) (and (=> (= tmp%14@ (Sub a11~90@ d11~96@)) (=> (= tmp%15@ (Mul c11~94@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%11 (= temp_11_0~2099@ temp_11_1~2164@))))) (=> (= temp_11_0~2099@ temp_11_1~2164@) (=> (= temp_12_0~2265@ (Mul (Add (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ a12~98@)) (Mul (Mul a12~98@ a12~98@) (Mul c12~102@ a12~98@))) (Mul (Mul (Mul c12~102@ c12~102@) (Mul b12~100@ c12~102@)) (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2330@ (Mul (Mul (Add (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ a12~98@)) (Mul (Mul a12~98@ a12~98@) (Mul c12~102@ a12~98@))) (Mul (Mul c12~102@ c12~102@) (Mul b12~100@ c12~102@))) (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ d12~104@)))) (and (=> (= tmp%16@ (Add (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ a12~98@)) (Mul (Mul a12~98@ a12~98@) (Mul c12~102@ a12~98@)))) (=> (= tmp%17@ (Mul (Mul c12~102@ c12~102@) (Mul b12~100@ c12~102@))) (=> (= tmp%18@ (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ d12~104@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%12 (= temp_12_0~2265@ temp_12_1~2330@)))))) (=> (= temp_12_0~2265@ temp_12_1~2330@) (=> (= temp_13_0~2449@ (Sub (Mul (Mul (Sub b13~108@ d13~112@) (Sub c13~110@ c13~110@)) (Mul (Mul b13~108@ d13~112@) (Mul a13~106@ a13~106@))) a13~106@)) (=> (= temp_13_1~2486@ (Sub (Mul (Mul (Sub b13~108@ d13~112@) (Sub c13~110@ c13~110@)) (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ a13~106@))) a13~106@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b13~108@ d13~112@) (=> %%location_label%%13 (= temp_13_0~2449@ temp_13_1~2486@))) (=> (= temp_13_0~2449@ temp_13_1~2486@) (=> (= temp_14_0~2599@ (Sub (Mul (Mul (Mul c14~118@ d14~120@) (Mul c14~118@ 8)) (Mul 59 (Mul b14~116@ d14~120@))) (Mul (Mul (Mul a14~114@ b14~116@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2684@ (Sub (Mul (Mul (Mul c14~118@ d14~120@) (Mul c14~118@ 8)) (Mul (Mul 59 b14~116@) d14~120@)) (Mul (Mul (Mul a14~114@ b14~116@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. 59 b14~116@ d14~120@) (=> %%location_label%%14 (= temp_14_0~2599@ temp_14_1~2684@))) (=> (= temp_14_0~2599@ temp_14_1~2684@) (=> (= temp_15_0~2779@ (Mul (Mul d15~128@ (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ c15~126@))) (Mul (Sub (Add d15~128@ b15~124@) (Mul d15~128@ a15~122@)) (Add (Mul d15~128@ b15~124@) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~2832@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ c15~126@)) d15~128@) (Mul (Sub (Add d15~128@ b15~124@) (Mul d15~128@ a15~122@)) (Add (Mul d15~128@ b15~124@) (Mul a15~122@ d15~128@))))) (and (=> (= tmp%19@ (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ c15~126@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d15~128@ tmp%19@) (=> %%location_label%%15 (= temp_15_0~2779@ temp_15_1~2832@)))) (=> (= temp_15_0~2779@ temp_15_1~2832@) (=> (= temp_16_0~2929@ (Mul (Mul (Mul a16~130@ (Mul c16~134@ d16~136@)) (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ d16~136@))) (Mul (Mul b16~132@ (Mul c16~134@ b16~132@)) (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ b16~132@))))) (=> (= temp_16_1~2986@ (Mul (Mul (Mul a16~130@ (Mul c16~134@ d16~136@)) (Mul (Mul b16~132@ b16~132@) (Mul a16~130@ d16~136@))) (Mul (Mul (Mul c16~134@ b16~132@) b16~132@) (Mul (Mul b16~132@ b16~132@) (Mul b16~132@ b16~132@))))) (and (=> (= tmp%20@ (Mul c16~134@ b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b16~132@ tmp%20@) (=> %%location_label%%16 (= temp_16_0~2929@ temp_16_1~2986@)))) (=> (= temp_16_0~2929@ temp_16_1~2986@) (=> (= temp_17_0~3083@ (Mul (Mul (Sub (Mul b17~140@ c17~142@) (Mul c17~142@ c17~142@)) (Mul (Mul a17~138@ d17~144@) (Mul c17~142@ c17~142@))) (Mul (Add (Mul a17~138@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~3148@ (Mul (Mul (Sub (Mul b17~140@ c17~142@) (Mul c17~142@ c17~142@)) (Mul (Mul a17~138@ d17~144@) (Mul c17~142@ c17~142@))) (Mul (Add (Mul a17~138@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ c17~142@))))) (=> (= tmp%21@ (Mul d17~144@ c17~142@)) (=> (= tmp%22@ (Mul c17~142@ c17~142@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%17 (= temp_17_0~3083@ temp_17_1~3148@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
