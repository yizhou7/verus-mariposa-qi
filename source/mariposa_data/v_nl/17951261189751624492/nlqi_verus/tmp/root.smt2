...
(push)
 ...
 (declare-const temp_11_1~1932@ Int)
 ...
 (declare-const temp_14_1~2426@ Int)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~301@ temp_0_1~362@)
        (=>
         (= temp_1_0~447@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) b1~12@) (Mul (Mul d1~16@ b1~12@)
             (Mul c1~14@ a1~10@)
            )
         ...
         (=>
          (= temp_1_1~508@ (Mul (Mul (Mul (Mul a1~10@ d1~16@) b1~12@) (Mul (Mul d1~16@ b1~12@)
              (Mul c1~14@ a1~10@)
             )
          ...
          (and
           ...
           (=>
            (= temp_1_0~447@ temp_1_1~508@)
            (=>
             (= temp_2_0~585@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@)) (Add (Mul a2~18@
                  c2~22@
                 ) (Add b2~20@ a2~18@)
                )
             ...
             (=>
              (= temp_2_1~638@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@)) (Add (Mul a2~18@
                   c2~22@
                  ) (Add b2~20@ a2~18@)
                 )
              ...
              (and
               ...
               (=>
                (= temp_2_0~585@ temp_2_1~638@)
                (=>
                 (= temp_3_0~715@ (Mul (Mul a3~26@ (Mul (Add c3~30@ b3~28@) (Mul a3~26@ a3~26@))) (Sub
                    (Add (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ a3~26@) (Sub c3~30@
                      c3~30@
                 )))))
                 (=>
                  (= temp_3_1~764@ (Mul (Mul a3~26@ (Mul (Add c3~30@ b3~28@) (Mul a3~26@ a3~26@))) (Sub
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= temp_3_0~715@ temp_3_1~764@)
                   ))
                   (=>
                    (= temp_3_0~715@ temp_3_1~764@)
                    (=>
                     (= temp_4_0~845@ (Mul (Mul (Mul a4~34@ (Mul b4~36@ c4~38@)) (Sub (Mul c4~38@ c4~38@)
                         (Mul c4~38@ b4~36@)
                        )
                       ) (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ d4~40@)) (Add (Mul c4~38@ d4~40@) d4~40@))
                     ))
                     (=>
                      (= temp_4_1~902@ (Mul (Mul (Mul a4~34@ (Mul b4~36@ c4~38@)) (Sub (Mul c4~38@ c4~38@)
                          (Mul c4~38@ b4~36@)
                         )
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= temp_4_0~845@ temp_4_1~902@)
                       ))
                       (=>
                        (= temp_4_0~845@ temp_4_1~902@)
                        (=>
                         (= temp_5_0~975@ (Mul (Sub c5~46@ (Mul (Sub c5~46@ d5~48@) d5~48@)) (Mul (Mul (Mul a5~42@
                              c5~46@
                             ) (Mul a5~42@ c5~46@)
                            ) (Mul (Sub d5~48@ d5~48@) (Mul a5~42@ b5~44@))
                         )))
                         (=>
                          (= temp_5_1~1024@ (Mul (Sub c5~46@ (Mul (Sub c5~46@ d5~48@) d5~48@)) (Mul (Mul (Mul a5~42@
                               c5~46@
                              ) (Mul a5~42@ c5~46@)
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~975@ temp_5_1~1024@)
                           ))
                           (=>
                            (= temp_5_0~975@ temp_5_1~1024@)
                            (=>
                             (= temp_6_0~1121@ (Mul (Mul (Mul (Mul b6~52@ c6~54@) (Mul 25 d6~56@)) (Mul (Mul c6~54@
                                  c6~54@
                                 ) (Mul d6~56@ a6~50@)
                                )
                             ...
                             (=>
                              (= temp_6_1~1194@ (Mul (Mul (Mul (Mul (Mul b6~52@ c6~54@) 25) d6~56@) (Mul (Mul c6~54@
                                   c6~54@
                                  ) (Mul d6~56@ a6~50@)
                                 )
                                ) (Mul (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@)) (Sub d6~56@ (Mul c6~54@ c6~54@)))
                              ...
                              (and
                               ...
                               (=>
                                (= temp_6_0~1121@ temp_6_1~1194@)
                                (=>
                                 (= temp_7_0~1295@ (Sub (Mul (Mul (Add a7~58@ c7~62@) (Mul c7~62@ a7~58@)) (Mul (Mul d7~64@
                                      a7~58@
                                     ) (Mul a7~58@ a7~58@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1380@ (Sub (Mul (Add (Mul a7~58@ (Mul c7~62@ a7~58@)) (Mul c7~62@ (Mul c7~62@
                                        a7~58@
                                      ))
                                  ...
                                  (and
                                   ...
                                   (=>
                                    (= temp_7_0~1295@ temp_7_1~1380@)
                                    (=>
                                     (= temp_8_0~1457@ (Mul (Sub (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) c8~70@) (
                                        Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@
                                          d8~72@
                                     )))))
                                     (=>
                                      (= temp_8_1~1510@ (Mul (Sub (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) c8~70@) (
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1457@ temp_8_1~1510@)
                                       ))
                                       (=>
                                        (= temp_8_0~1457@ temp_8_1~1510@)
                                        (=>
                                         (= temp_9_0~1595@ (Mul (Mul (Mul (Sub c9~78@ c9~78@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@
                                              b9~76@
                                             ) (Sub c9~78@ b9~76@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1656@ (Mul (Mul (Mul (Sub c9~78@ c9~78@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@
                                               b9~76@
                                              ) (Sub c9~78@ b9~76@)
                                             )
                                          ...
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1595@ temp_9_1~1656@)
                                           ))
                                           (=>
                                            (= temp_9_0~1595@ temp_9_1~1656@)
                                            (=>
                                             (= temp_10_0~1745@ (Mul (Sub (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (
                                                  Mul d10~88@ c10~86@
                                                 ) (Sub b10~84@ a10~82@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1810@ (Mul (Sub (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ b10~84@)) (Mul (
                                                   Mul d10~88@ c10~86@
                                                  ) (Sub b10~84@ a10~82@)
                                                 )
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1745@ temp_10_1~1810@)
                                               ))
                                               (=>
                                                (= temp_10_0~1745@ temp_10_1~1810@)
                                                (=>
                                                 (= temp_11_0~1883@ (Sub (Mul (Add (Mul c11~94@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (
                                                      Mul c11~94@ a11~90@
                                                     ) a11~90@
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~1932@ (Sub (Mul (Add (Mul c11~94@ c11~94@) (Mul c11~94@ c11~94@)) (Mul (
                                                       Mul c11~94@ a11~90@
                                                      ) a11~90@
                                                     )
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~1883@ temp_11_1~1932@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~1883@ temp_11_1~1932@)
                                                    (=>
                                                     (= temp_12_0~2029@ (Mul (Add (Mul (Sub a12~98@ a12~98@) (Mul b12~100@ b12~100@)) (Mul
                                                         (Mul c12~102@ a12~98@) (Sub d12~104@ d12~104@)
                                                        )
                                                       ) (Mul (Sub (Mul a12~98@ c12~102@) a12~98@) (Mul (Mul c12~102@ 96) (Mul d12~104@ c12~102@)))
                                                     ))
                                                     (=>
                                                      (= temp_12_1~2102@ (Mul (Add (Mul (Sub a12~98@ a12~98@) (Mul b12~100@ b12~100@)) (Mul
                                                          (Mul c12~102@ a12~98@) (Sub d12~104@ d12~104@)
                                                         )
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2029@ temp_12_1~2102@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2029@ temp_12_1~2102@)
                                                        (=>
                                                         (= temp_13_0~2187@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Mul c13~110@ b13~108@)) (
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2248@ (Mul (Mul (Mul a13~106@ (Mul a13~106@ b13~108@)) (Mul (Sub d13~112@
                                                               b13~108@
                                                              ) (Sub b13~108@ b13~108@)
                                                             )
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2187@ temp_13_1~2248@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2187@ temp_13_1~2248@)
                                                            (=>
                                                             (= temp_14_0~2349@ (Add (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ b14~116@)) (
                                                             ...
                                                             (=>
                                                              (= temp_14_1~2426@ (Add (Mul (Mul (Mul b14~116@ a14~114@) (Mul b14~116@ b14~116@)) (
                                                                  Mul (Mul c14~118@ d14~120@) (Mul c14~118@ c14~118@)
                                                                 )
                                                                ) (Sub (Add (Add a14~114@ b14~116@) (Mul d14~120@ b14~116@)) (Mul (Mul b14~116@ c14~118@)
                                                                  (Mul a14~114@ 75)
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2349@ temp_14_1~2426@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2349@ temp_14_1~2426@)
                                                                (=>
                                                                 (= temp_15_0~2511@ (Mul (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ b15~124@)) (
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2572@ (Mul (Mul (Mul (Mul a15~122@ d15~128@) (Mul b15~124@ b15~124@)) (
                                                                      Mul (Mul c15~126@ b15~124@) (Mul d15~128@ a15~122@)
                                                                     )
