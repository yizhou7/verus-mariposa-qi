...
(declare-const temp_4_0~1297@ Int)
(declare-const temp_4_1~1422@ Int)
(declare-const temp_5_0~1558@ Int)
(declare-const temp_5_1~1679@ Int)
(declare-const temp_6_0~1811@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~245@ (Mul (Add 6 (Mul (Sub (Add a0~2@ d0~8@) d0~8@) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ a0~2@)))) (Mul (Mul a0~2@ c0~6@) (Sub (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@)))))) (=> (= temp_0_1~330@ (Mul (Add 6 (Mul (Sub (Add a0~2@ d0~8@) d0~8@) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ a0~2@)))) (Mul (Mul a0~2@ c0~6@) (Sub (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@)))))) (=> (= tmp%1@ (= temp_0_0~245@ temp_0_1~330@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~498@ (Mul (Mul (Add (Mul (Sub d1~16@ c1~14@) (Add a1~10@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Sub c1~14@ d1~16@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@)))) (Mul (Mul (Mul (Add c1~14@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ 38) (Add a1~10@ b1~12@)) (Mul (Mul 98 a1~10@) (Mul c1~14@ c1~14@)))))) (=> (= temp_1_1~659@ (Mul (Mul (Add (Sub (Mul d1~16@ (Add a1~10@ c1~14@)) (Mul c1~14@ (Add a1~10@ c1~14@))) (Mul (Mul c1~14@ a1~10@) (Sub c1~14@ d1~16@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@)))) (Mul (Mul (Mul (Add c1~14@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ 38) (Add a1~10@ b1~12@)) (Mul (Mul 98 a1~10@) (Mul c1~14@ c1~14@)))))) (=> (= tmp%2@ (= temp_1_0~498@ temp_1_1~659@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~807@ (Sub (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ d2~24@))) (Mul (Mul (Add d2~24@ 15) (Mul c2~22@ c2~22@)) (Add (Mul c2~22@ a2~18@) (Add c2~22@ c2~22@)))) (Mul (Mul (Mul (Sub b2~20@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ c2~22@) b2~20@)) (Add (Mul (Add b2~20@ d2~24@) c2~22@) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@)))))) (=> (= temp_2_1~940@ (Sub (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ d2~24@))) (Mul (Mul (Add d2~24@ 15) (Mul c2~22@ c2~22@)) (Add (Mul c2~22@ a2~18@) (Add c2~22@ c2~22@)))) (Mul (Mul (Mul (Sub b2~20@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ b2~20@) b2~20@)) (Add (Mul (Add b2~20@ d2~24@) c2~22@) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@)))))) (=> (= tmp%3@ (= temp_2_0~807@ temp_2_1~940@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1056@ (Mul (Mul d3~32@ (Mul (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Add a3~26@ c3~30@)))) (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ a3~26@)))))) (=> (= temp_3_1~1157@ (Mul (Mul d3~32@ (Mul (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Add a3~26@ c3~30@)))) (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ a3~26@)))))) (=> (= tmp%4@ (= temp_3_0~1056@ temp_3_1~1157@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1297@ (Mul (Mul (Mul d4~40@ (Mul (Sub d4~40@ b4~36@) (Add a4~34@ c4~38@))) (Mul (Mul (Mul b4~36@ d4~40@) (Add d4~40@ c4~38@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ c4~38@)))) (Mul (Mul (Mul b4~36@ (Mul d4~40@ a4~34@)) (Sub (Mul b4~36@ b4~36@) (Mul d4~40@ b4~36@))) (Mul (Add (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ 16)))))) (=> (= temp_4_1~1422@ (Mul (Mul (Mul d4~40@ (Mul (Sub d4~40@ b4~36@) (Add a4~34@ c4~38@))) (Mul (Mul (Mul b4~36@ d4~40@) (Add d4~40@ c4~38@)) (Mul (Mul (Mul c4~38@ b4~36@) a4~34@) c4~38@))) (Mul (Mul (Mul b4~36@ (Mul d4~40@ a4~34@)) (Sub (Mul b4~36@ b4~36@) (Mul d4~40@ b4~36@))) (Mul (Add (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ 16)))))) (=> (= tmp%5@ (= temp_4_0~1297@ temp_4_1~1422@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1558@ (Mul (Mul (Add (Sub (Mul 71 d5~48@) (Mul a5~42@ b5~44@)) (Mul b5~44@ (Mul c5~46@ b5~44@))) (Sub (Mul (Add c5~46@ c5~46@) (Mul d5~48@ b5~44@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ b5~44@)))) (Add (Sub (Mul a5~42@ (Mul a5~42@ a5~42@)) a5~42@) (Mul (Sub (Mul d5~48@ c5~46@) (Mul d5~48@ a5~42@)) 13)))) (=> (= temp_5_1~1679@ (Mul (Add (Sub (Mul 71 d5~48@) (Mul a5~42@ b5~44@)) (Mul b5~44@ (Mul c5~46@ b5~44@))) (Mul (Sub (Mul (Add c5~46@ c5~46@) (Mul d5~48@ b5~44@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ b5~44@))) (Add (Sub (Mul a5~42@ (Mul a5~42@ a5~42@)) a5~42@) (Mul (Sub (Mul d5~48@ c5~46@) (Mul d5~48@ a5~42@)) 13))))) (=> (= tmp%6@ (= temp_5_0~1558@ temp_5_1~1679@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1811@ (Mul (Mul (Mul (Mul (Add d6~56@ a6~50@) a6~50@) (Mul b6~52@ (Add a6~50@ a6~50@))) (Sub (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)))) (Mul (Mul (Mul (Mul a6~50@ c6~54@) a6~50@) (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul c6~54@ c6~54@) (Sub a6~50@ d6~56@)) (Add (Mul c6~54@ a6~50@) (Sub a6~50@ c6~54@)))))) (=> (= temp_6_1~1944@ (Mul (Mul (Mul (Mul (Add d6~56@ a6~50@) a6~50@) (Mul b6~52@ (Add a6~50@ a6~50@))) (Sub (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)))) (Mul (Mul (Mul (Mul a6~50@ c6~54@) a6~50@) (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ d6~56@))) (Add (Mul (Mul (Mul c6~54@ c6~54@) (Sub a6~50@ d6~56@)) (Mul c6~54@ a6~50@)) (Mul (Mul (Mul c6~54@ c6~54@) (Sub a6~50@ d6~56@)) (Sub a6~50@ c6~54@)))))) (=> (= tmp%7@ (= temp_6_0~1811@ temp_6_1~1944@)) (=> %%location_label%%6 tmp%7@)))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
