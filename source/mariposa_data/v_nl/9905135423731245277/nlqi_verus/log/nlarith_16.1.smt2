...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul a0~2@ c0~6@) a0~2@) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ d0~8@) (Add d0~8@ c0~6@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ c0~6@) a0~2@)) (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ d0~8@) (Add d0~8@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~450@ (Mul (Mul (Mul c1~14@ (Mul d1~16@ 66)) (Mul (Mul a1~10@ a1~10@) (Add c1~14@ a1~10@))) (Mul (Mul (Add b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~523@ (Mul (Mul (Mul c1~14@ (Mul d1~16@ 66)) (Mul a1~10@ (Mul a1~10@ (Add c1~14@ a1~10@)))) (Mul (Mul (Add b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~450@ temp_1_1~523@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~603@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Sub b2~20@ d2~24@))) (Mul (Add (Mul b2~20@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~668@ (Mul (Mul (Mul d2~24@ (Mul c2~22@ (Mul d2~24@ d2~24@))) (Mul (Mul c2~22@ b2~20@) (Sub b2~20@ d2~24@))) (Mul (Add (Mul b2~20@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~603@ temp_2_1~668@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~772@ (Mul (Mul (Mul (Sub a3~26@ b3~28@) (Sub d3~32@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Add (Mul a3~26@ 74) (Add 66 b3~28@)) (Sub (Mul a3~26@ d3~32@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~861@ (Mul (Mul (Mul (Sub a3~26@ b3~28@) (Sub d3~32@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Add (Mul a3~26@ 74) (Add 66 b3~28@)) (Sub (Mul d3~32@ a3~26@) (Mul d3~32@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~772@ temp_3_1~861@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~941@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Sub b4~36@ d4~40@) (Mul d4~40@ b4~36@))))) (=> (= temp_4_1~1006@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul (Mul c4~38@ c4~38@) d4~40@) b4~36@)) (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Sub b4~36@ d4~40@) (Mul d4~40@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~941@ temp_4_1~1006@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1074@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@)) c5~46@) (Mul (Add (Mul d5~48@ a5~42@) (Mul b5~44@ b5~44@)) (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1127@ (Mul (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@)) c5~46@) (Add (Mul d5~48@ a5~42@) (Mul b5~44@ b5~44@))) (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ a5~42@)))) (=> (= tmp%6@ (= temp_5_0~1074@ temp_5_1~1127@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1203@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Mul d6~56@ (Sub d6~56@ b6~52@)) (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1264@ (Mul (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ a6~50@))) (Mul d6~56@ (Sub d6~56@ b6~52@))) (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ c6~54@)))) (=> (= tmp%7@ (= temp_6_0~1203@ temp_6_1~1264@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1344@ (Sub (Mul (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Sub b7~60@ b7~60@) (Add c7~62@ a7~58@))) (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1409@ (Sub (Mul (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Sub b7~60@ b7~60@) (Add c7~62@ a7~58@))) (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ d7~64@)) (Mul d7~64@ a7~58@)) (Mul d7~64@ b7~60@)))) (=> (= tmp%8@ (= temp_7_0~1344@ temp_7_1~1409@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1461@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ c8~70@)) (Sub (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@))) c8~70@)) (=> (= temp_8_1~1498@ (Mul (Mul (Mul d8~72@ c8~70@) (Mul (Mul b8~68@ c8~70@) (Sub (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@)))) c8~70@)) (=> (= tmp%9@ (= temp_8_0~1461@ temp_8_1~1498@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1586@ (Mul (Mul (Mul (Add d9~80@ a9~74@) (Mul c9~78@ c9~78@)) (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ a9~74@))) (Mul (Mul a9~74@ (Sub a9~74@ d9~80@)) (Mul (Sub 18 a9~74@) (Mul b9~76@ b9~76@))))) (=> (= temp_9_1~1659@ (Mul (Mul (Add d9~80@ a9~74@) (Mul c9~78@ c9~78@)) (Mul (Mul (Mul d9~80@ b9~76@) (Mul a9~74@ a9~74@)) (Mul (Mul a9~74@ (Sub a9~74@ d9~80@)) (Mul (Sub 18 a9~74@) (Mul b9~76@ b9~76@)))))) (=> (= tmp%10@ (= temp_9_0~1586@ temp_9_1~1659@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1739@ (Mul (Mul (Mul (Mul c10~86@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ c10~86@))) (Mul (Mul (Mul b10~84@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ a10~82@))))) (=> (= temp_10_1~1804@ (Mul (Mul (Mul c10~86@ d10~88@) (Mul (Mul c10~86@ b10~84@) (Mul (Mul c10~86@ c10~86@) (Mul b10~84@ c10~86@)))) (Mul (Mul (Mul b10~84@ c10~86@) (Mul d10~88@ b10~84@)) (Mul (Mul c10~86@ b10~84@) (Mul c10~86@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1739@ temp_10_1~1804@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1852@ (Add (Mul (Mul (Mul c11~94@ c11~94@) b11~92@) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ a11~90@))) a11~90@)) (=> (= temp_11_1~1885@ (Add (Mul (Mul (Mul c11~94@ c11~94@) b11~92@) (Mul (Mul d11~96@ a11~90@) (Mul d11~96@ a11~90@))) a11~90@)) (=> (= tmp%12@ (= temp_11_0~1852@ temp_11_1~1885@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1977@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul a12~98@ b12~100@) (Mul 10 b12~100@))))) (=> (= temp_12_1~2054@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul c12~102@ d12~104@)) (Mul (Mul c12~102@ c12~102@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul c12~102@ d12~104@) (Mul b12~100@ b12~100@)) (Mul (Mul a12~98@ b12~100@) (Mul 10 b12~100@))))) (=> (= tmp%13@ (= temp_12_0~1977@ temp_12_1~2054@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2118@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) b13~108@) (Sub c13~110@ (Sub b13~108@ c13~110@))) (Mul (Mul b13~108@ (Sub b13~108@ a13~106@)) (Mul c13~110@ (Mul a13~106@ a13~106@))))) (=> (= temp_13_1~2167@ (Mul (Mul (Mul (Mul a13~106@ c13~110@) b13~108@) (Sub c13~110@ (Sub b13~108@ c13~110@))) (Mul (Mul (Mul b13~108@ (Sub b13~108@ a13~106@)) c13~110@) (Mul a13~106@ a13~106@)))) (=> (= tmp%14@ (= temp_13_0~2118@ temp_13_1~2167@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2247@ (Add (Mul (Mul (Mul b14~116@ b14~116@) (Add a14~114@ a14~114@)) (Mul (Mul d14~120@ c14~118@) (Add c14~118@ d14~120@))) (Mul (Sub (Add a14~114@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul c14~118@ c14~118@) (Mul d14~120@ c14~118@))))) (=> (= temp_14_1~2312@ (Add (Mul (Mul (Add a14~114@ a14~114@) (Mul b14~116@ b14~116@)) (Mul (Mul d14~120@ c14~118@) (Add c14~118@ d14~120@))) (Mul (Sub (Add a14~114@ c14~118@) (Mul c14~118@ a14~114@)) (Mul (Mul c14~118@ c14~118@) (Mul d14~120@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2247@ temp_14_1~2312@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2376@ (Mul (Mul (Add (Mul c15~126@ b15~124@) (Mul a15~122@ c15~126@)) (Mul b15~124@ (Sub d15~128@ d15~128@))) (Mul b15~124@ (Mul (Sub c15~126@ c15~126@) (Sub c15~126@ a15~122@))))) (=> (= temp_15_1~2433@ (Mul (Mul (Add (Mul c15~126@ b15~124@) (Mul a15~122@ c15~126@)) (Mul b15~124@ (Sub d15~128@ d15~128@))) (Mul b15~124@ (Sub (Mul (Sub c15~126@ c15~126@) c15~126@) (Mul (Sub c15~126@ c15~126@) a15~122@))))) (=> (= tmp%16@ (= temp_15_0~2376@ temp_15_1~2433@)) (=> %%location_label%%15 tmp%16@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
