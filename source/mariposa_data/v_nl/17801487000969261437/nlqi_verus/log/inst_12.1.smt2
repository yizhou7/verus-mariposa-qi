...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul (Add (Mul (Mul 32 d0~8@) (Mul d0~8@ a0~2@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ b0~4@)) (Sub (Mul 30 a0~2@) (Mul c0~6@ c0~6@)))) (Mul (Mul (Sub b0~4@ (Mul a0~2@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) 40))) (=> (= temp_0_1~442@ (Mul (Mul (Add (Mul (Mul 32 d0~8@) (Mul d0~8@ a0~2@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ a0~2@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ b0~4@)) (Sub (Mul 30 a0~2@) (Mul c0~6@ c0~6@)))) (Mul (Sub (Mul b0~4@ (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Mul (Mul a0~2@ b0~4@) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@)))) 40))) (and (=> (= tmp%1@ (Mul a0~2@ b0~4@)) (=> (= tmp%2@ (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b0~4@ tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~442@))))) (=> (= temp_0_0~293@ temp_0_1~442@) (=> (= temp_1_0~605@ (Sub (Mul (Mul (Sub (Mul d1~16@ b1~12@) a1~10@) (Mul (Mul a1~10@ c1~14@) (Add a1~10@ a1~10@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Sub b1~12@ d1~16@) (Sub d1~16@ c1~14@)))) (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Sub b1~12@ a1~10@)) (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ b1~12@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Sub d1~16@ b1~12@))))) (=> (= temp_1_1~730@ (Sub (Mul (Mul (Sub (Mul d1~16@ b1~12@) a1~10@) (Mul (Mul a1~10@ c1~14@) (Add a1~10@ a1~10@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Sub b1~12@ d1~16@) (Sub d1~16@ c1~14@)))) (Mul (Mul (Sub (Mul (Mul a1~10@ d1~16@) b1~12@) (Mul (Mul a1~10@ d1~16@) a1~10@)) (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ b1~12@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Sub d1~16@ b1~12@))))) (and (=> (= tmp%3@ (Mul a1~10@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ b1~12@ a1~10@) (=> %%location_label%%1 (= temp_1_0~605@ temp_1_1~730@)))) (=> (= temp_1_0~605@ temp_1_1~730@) (=> (= temp_2_0~833@ (Mul (Add (Mul (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Sub c2~22@ c2~22@))) (Sub (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ a2~18@)) (Add (Mul d2~24@ d2~24@) (Mul b2~20@ c2~22@)))) b2~20@)) (=> (= temp_2_1~902@ (Mul (Add (Mul (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Sub c2~22@ c2~22@) (Mul b2~20@ d2~24@))) (Sub (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ a2~18@)) (Add (Mul d2~24@ d2~24@) (Mul b2~20@ c2~22@)))) b2~20@)) (and (=> (= tmp%4@ (Mul b2~20@ d2~24@)) (=> (= tmp%5@ (Sub c2~22@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~833@ temp_2_1~902@))))) (=> (= temp_2_0~833@ temp_2_1~902@) (=> (= temp_3_0~1055@ (Mul (Mul (Mul b3~28@ (Mul (Mul a3~26@ a3~26@) (Sub b3~28@ a3~26@))) (Mul (Mul (Sub c3~30@ b3~28@) (Mul b3~28@ d3~32@)) d3~32@)) (Mul (Add (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Sub b3~28@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul 23 c3~30@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ a3~26@)))))) (=> (= temp_3_1~1172@ (Mul (Mul (Add (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Sub b3~28@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul 23 c3~30@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ a3~26@)))) (Mul (Mul b3~28@ (Mul (Mul a3~26@ a3~26@) (Sub b3~28@ a3~26@))) (Mul (Mul (Sub c3~30@ b3~28@) (Mul b3~28@ d3~32@)) d3~32@)))) (and (=> (= tmp%6@ (Mul (Mul b3~28@ (Mul (Mul a3~26@ a3~26@) (Sub b3~28@ a3~26@))) (Mul (Mul (Sub c3~30@ b3~28@) (Mul b3~28@ d3~32@)) d3~32@))) (=> (= tmp%7@ (Mul (Add (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Sub b3~28@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul 23 c3~30@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ a3~26@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~1055@ temp_3_1~1172@))))) (=> (= temp_3_0~1055@ temp_3_1~1172@) (=> (= temp_4_0~1441@ (Add (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Add a4~34@ a4~34@))) (Mul (Mul (Mul d4~40@ a4~34@) 85) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ d4~40@)))) (Mul (Mul (Sub (Mul d4~40@ b4~36@) b4~36@) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ d4~40@)) (Add (Mul d4~40@ b4~36@) (Add b4~36@ d4~40@)))))) (=> (= temp_4_1~1574@ (Add (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ d4~40@) (Add a4~34@ a4~34@))) (Mul (Mul (Mul d4~40@ a4~34@) 85) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ d4~40@)))) (Mul (Mul (Sub (Mul d4~40@ b4~36@) b4~36@) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Mul d4~40@ (Mul a4~34@ (Mul a4~34@ d4~40@))) (Add (Mul d4~40@ b4~36@) (Add b4~36@ d4~40@)))))) (and (=> (= tmp%8@ (Mul a4~34@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d4~40@ a4~34@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~1441@ temp_4_1~1574@)))) (=> (= temp_4_0~1441@ temp_4_1~1574@) (=> (= temp_5_0~1713@ (Add (Mul (Mul d5~48@ (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ c5~46@) c5~46@))) (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@)) (Mul c5~46@ a5~42@)) (Mul (Mul (Sub d5~48@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@)))))) (=> (= temp_5_1~1818@ (Add (Mul (Mul d5~48@ (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ c5~46@) c5~46@))) (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ a5~42@)) (Mul c5~46@ a5~42@)) (Mul (Mul (Sub d5~48@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ a5~42@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1713@ temp_5_1~1818@))) (=> (= temp_5_0~1713@ temp_5_1~1818@) (=> (= temp_6_0~1931@ (Mul (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Add d6~56@ b6~52@)) (Mul c6~54@ b6~52@)) c6~54@) (Mul (Mul (Mul b6~52@ (Sub c6~54@ a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ d6~56@)) (Mul a6~50@ (Mul c6~54@ a6~50@)))))) (=> (= temp_6_1~2016@ (Mul (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Add d6~56@ b6~52@)) (Mul c6~54@ b6~52@)) c6~54@) (Mul (Mul (Mul b6~52@ (Sub c6~54@ a6~50@)) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))) (Mul (Mul a6~50@ (Mul c6~54@ a6~50@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ d6~56@)))))) (and (=> (= tmp%9@ (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ d6~56@))) (=> (= tmp%10@ (Mul a6~50@ (Mul c6~54@ a6~50@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~1931@ temp_6_1~2016@))))) (=> (= temp_6_0~1931@ temp_6_1~2016@) (=> (= temp_7_0~2193@ (Sub (Mul (Mul (Sub (Mul a7~58@ b7~60@) (Mul d7~64@ b7~60@)) (Add (Mul c7~62@ d7~64@) (Mul b7~60@ c7~62@))) (Mul (Mul (Mul d7~64@ d7~64@) (Add b7~60@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Sub a7~58@ a7~58@)))) (Mul (Sub (Mul (Add b7~60@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Add c7~62@ d7~64@) (Sub d7~64@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ b7~60@)))))) (=> (= temp_7_1~2322@ (Sub (Mul (Mul (Sub (Mul a7~58@ b7~60@) (Mul d7~64@ b7~60@)) (Add (Mul c7~62@ d7~64@) (Mul b7~60@ c7~62@))) (Mul (Mul (Mul d7~64@ d7~64@) (Add b7~60@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Sub a7~58@ a7~58@)))) (Mul (Sub (Mul (Add b7~60@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Add c7~62@ d7~64@) (Sub d7~64@ d7~64@))) (Mul (Mul (Mul (Mul a7~58@ d7~64@) a7~58@) b7~60@) (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ b7~60@)))))) (and (=> (= tmp%11@ (Mul a7~58@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ a7~58@ b7~60@) (=> %%location_label%%7 (= temp_7_0~2193@ temp_7_1~2322@)))) (=> (= temp_7_0~2193@ temp_7_1~2322@) (=> (= temp_8_0~2473@ (Mul (Mul (Mul (Mul b8~68@ (Mul a8~66@ b8~68@)) (Mul b8~68@ (Add b8~68@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ 92)))) (Add (Mul (Mul b8~68@ (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ b8~68@) (Sub c8~70@ c8~70@))) (Mul a8~66@ (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ a8~66@)))))) (=> (= temp_8_1~2590@ (Mul (Mul (Mul (Mul b8~68@ (Mul a8~66@ b8~68@)) (Mul b8~68@ (Add b8~68@ c8~70@))) (Mul (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ 92)))) (Add (Mul (Mul b8~68@ (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ b8~68@) (Sub c8~70@ c8~70@))) (Mul a8~66@ (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ a8~66@)))))) (and (=> (= tmp%12@ (Mul b8~68@ c8~70@)) (=> (= tmp%13@ (Mul b8~68@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%8 (= temp_8_0~2473@ temp_8_1~2590@))))) (=> (= temp_8_0~2473@ temp_8_1~2590@) (=> (= temp_9_0~2755@ (Mul (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ d9~80@))) (Mul (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ a9~74@)) (Mul (Mul a9~74@ b9~76@) (Sub a9~74@ b9~76@)))) (Mul (Mul (Add (Mul a9~74@ a9~74@) (Add c9~78@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ b9~76@))) (Mul (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ b9~76@)) (Mul (Mul d9~80@ c9~78@) (Add c9~78@ c9~78@)))))) (=> (= temp_9_1~2884@ (Mul (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ d9~80@) (Mul c9~78@ d9~80@))) (Mul (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ a9~74@)) (Mul (Mul a9~74@ b9~76@) (Sub a9~74@ b9~76@)))) (Mul (Mul (Add (Mul a9~74@ a9~74@) (Add c9~78@ b9~76@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ b9~76@))) (Mul (Mul (Mul c9~78@ a9~74@) (Mul b9~76@ b9~76@)) (Mul (Mul d9~80@ c9~78@) (Add c9~78@ c9~78@)))))) (and (=> (= tmp%14@ (Mul c9~78@ d9~80@)) (=> (= tmp%15@ (Mul c9~78@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%9 (= temp_9_0~2755@ temp_9_1~2884@))))) (=> (= temp_9_0~2755@ temp_9_1~2884@) (=> (= temp_10_0~3081@ (Mul (Mul (Sub (Mul (Add d10~88@ c10~86@) (Mul 72 d10~88@)) (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul a10~82@ a10~82@) (Mul b10~84@ a10~82@)))) (Mul (Mul (Mul d10~88@ (Mul d10~88@ 9)) (Mul (Add c10~86@ b10~84@) (Mul b10~84@ 66))) (Sub (Add (Mul a10~82@ a10~82@) (Mul c10~86@ a10~82@)) (Mul (Sub d10~88@ b10~84@) (Mul c10~86@ d10~88@)))))) (=> (= temp_10_1~3242@ (Mul (Mul (Sub (Mul (Add d10~88@ c10~86@) (Mul 72 d10~88@)) (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ c10~86@)) (Mul (Mul a10~82@ a10~82@) (Mul b10~84@ a10~82@)))) (Mul (Mul (Mul (Mul d10~88@ (Mul d10~88@ 9)) (Add c10~86@ b10~84@)) (Mul b10~84@ 66)) (Sub (Add (Mul a10~82@ a10~82@) (Mul c10~86@ a10~82@)) (Mul (Sub d10~88@ b10~84@) (Mul c10~86@ d10~88@)))))) (and (=> (= tmp%16@ (Mul d10~88@ (Mul d10~88@ 9))) (=> (= tmp%17@ (Add c10~86@ b10~84@)) (=> (= tmp%18@ (Mul b10~84@ 66)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%16@ tmp%17@ tmp%18@) (=> %%location_label%%10 (= temp_10_0~3081@ temp_10_1~3242@)))))) (=> (= temp_10_0~3081@ temp_10_1~3242@) (=> (= temp_11_0~3449@ (Mul (Mul (Mul (Mul (Mul c11~94@ d11~96@) (Mul d11~96@ d11~96@)) (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ a11~90@))) (Mul (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ a11~90@)))) (Mul (Mul (Mul (Mul b11~92@ 70) (Add a11~90@ a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Mul d11~96@ (Mul b11~92@ c11~94@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ b11~92@)))))) (=> (= temp_11_1~3586@ (Mul (Mul (Mul (Mul (Mul c11~94@ d11~96@) (Mul d11~96@ d11~96@)) (Mul (Mul a11~90@ a11~90@) (Mul a11~90@ c11~94@))) (Mul (Mul (Mul c11~94@ b11~92@) (Mul b11~92@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ a11~90@)))) (Mul (Mul (Mul (Mul b11~92@ 70) (Add a11~90@ a11~90@)) (Mul (Mul c11~94@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Mul d11~96@ (Mul b11~92@ c11~94@)) (Mul (Mul a11~90@ a11~90@) (Mul d11~96@ b11~92@)))))) (=> (= tmp%19@ (Mul a11~90@ c11~94@)) (=> (= tmp%20@ (Mul a11~90@ a11~90@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%19@ tmp%20@) (=> %%location_label%%11 (= temp_11_0~3449@ temp_11_1~3586@))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
