...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Sub (Mul (Add a0~2@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~402@ (Sub (Mul (Mul (Add a0~2@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@)))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@)))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~402@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~478@ (Mul (Mul (Mul a1~10@ (Mul c1~14@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@))) (Add (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Add d1~16@ a1~10@))))) (=> (= temp_1_1~539@ (Mul (Mul (Mul a1~10@ (Mul c1~14@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ a1~10@))) (Add (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Add d1~16@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~478@ temp_1_1~539@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~627@ (Mul (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Sub a2~18@ a2~18@) (Mul b2~20@ d2~24@))) (Mul (Add b2~20@ (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ 15))))) (=> (= temp_2_1~700@ (Mul (Mul (Sub (Mul b2~20@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Sub a2~18@ a2~18@) (Mul b2~20@ d2~24@))) (Mul (Add b2~20@ (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ 15))))) (=> (= tmp%3@ (= temp_2_0~627@ temp_2_1~700@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~780@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ c3~30@) (Add c3~30@ d3~32@))) (Add (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ c3~30@))))) (=> (= temp_3_1~845@ (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ c3~30@) (Add c3~30@ d3~32@))) (Add (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~780@ temp_3_1~845@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~921@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ a4~34@)) (Mul (Add c4~38@ c4~38@) (Add d4~40@ d4~40@))) (Mul (Mul d4~40@ (Sub b4~36@ c4~38@)) (Mul (Mul d4~40@ c4~38@) (Sub b4~36@ d4~40@))))) (=> (= temp_4_1~986@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ a4~34@)) (Mul (Add c4~38@ c4~38@) (Add d4~40@ d4~40@))) (Mul (Sub (Mul d4~40@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Mul d4~40@ c4~38@) (Sub b4~36@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~921@ temp_4_1~986@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1054@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Add c5~46@ b5~44@)) c5~46@) (Mul (Mul (Add a5~42@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1107@ (Mul (Mul (Mul (Add c5~46@ b5~44@) (Mul c5~46@ c5~46@)) c5~46@) (Mul (Mul (Add a5~42@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1054@ temp_5_1~1107@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1179@ (Sub (Mul (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ a6~50@)) (Mul (Mul d6~56@ d6~56@) c6~54@)) (Add (Mul (Mul b6~52@ c6~54@) c6~54@) (Sub (Mul d6~56@ c6~54@) (Mul d6~56@ b6~52@))))) (=> (= temp_6_1~1236@ (Sub (Mul (Mul (Mul d6~56@ c6~54@) (Sub b6~52@ a6~50@)) (Mul d6~56@ (Mul d6~56@ c6~54@))) (Add (Mul (Mul b6~52@ c6~54@) c6~54@) (Sub (Mul d6~56@ c6~54@) (Mul d6~56@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1179@ temp_6_1~1236@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1308@ (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul d7~64@ d7~64@) b7~60@)) (Sub (Add (Mul a7~58@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul b7~60@ d7~64@) b7~60@)))) (=> (= temp_7_1~1365@ (Mul (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul (Mul d7~64@ d7~64@) b7~60@) (Sub (Add (Mul a7~58@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul b7~60@ d7~64@) b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1308@ temp_7_1~1365@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1441@ (Mul (Mul (Mul (Add a8~66@ c8~70@) a8~66@) (Mul (Mul b8~68@ d8~72@) (Sub d8~72@ d8~72@))) (Mul (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1502@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ a8~66@))) (Mul (Mul (Add a8~66@ c8~70@) a8~66@) (Mul (Mul b8~68@ d8~72@) (Sub d8~72@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1441@ temp_8_1~1502@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1578@ (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Mul c9~78@ d9~80@)) (Sub (Mul b9~76@ b9~76@) (Add c9~78@ a9~74@))) (Mul (Mul (Sub c9~78@ c9~78@) (Mul c9~78@ c9~78@)) (Mul (Mul b9~76@ b9~76@) d9~80@)))) (=> (= temp_9_1~1639@ (Mul (Mul (Mul (Mul (Mul d9~80@ b9~76@) (Mul c9~78@ d9~80@)) (Sub (Mul b9~76@ b9~76@) (Add c9~78@ a9~74@))) (Mul (Sub c9~78@ c9~78@) (Mul c9~78@ c9~78@))) (Mul (Mul b9~76@ b9~76@) d9~80@))) (=> (= tmp%10@ (= temp_9_0~1578@ temp_9_1~1639@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1723@ (Sub (Mul (Mul (Add d10~88@ b10~84@) a10~82@) (Mul (Mul c10~86@ d10~88@) d10~88@)) (Mul (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Add a10~82@ 14))))) (=> (= temp_10_1~1792@ (Sub (Mul (Mul (Add d10~88@ b10~84@) a10~82@) (Mul (Mul c10~86@ d10~88@) d10~88@)) (Mul (Mul (Mul a10~82@ d10~88@) (Add a10~82@ 14)) (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1723@ temp_10_1~1792@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1872@ (Add (Mul (Mul (Add a11~90@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ a11~90@) (Sub c11~94@ a11~90@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul b11~92@ c11~94@)) (Sub (Mul b11~92@ c11~94@) (Mul d11~96@ c11~94@))))) (=> (= temp_11_1~1937@ (Add (Mul (Mul (Add a11~90@ d11~96@) (Mul b11~92@ d11~96@)) (Mul (Mul c11~94@ a11~90@) (Sub c11~94@ a11~90@))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ b11~92@)) (Sub (Mul b11~92@ c11~94@) (Mul d11~96@ c11~94@))))) (=> (= tmp%12@ (= temp_11_0~1872@ temp_11_1~1937@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2005@ (Mul (Mul (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ b12~100@)) c12~102@) (Mul (Mul (Mul a12~98@ d12~104@) (Mul d12~104@ c12~102@)) (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ b12~100@))))) (=> (= temp_12_1~2058@ (Mul (Mul (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ b12~100@)) c12~102@) (Mul (Mul (Mul d12~104@ c12~102@) (Mul c12~102@ b12~100@)) (Mul (Mul a12~98@ d12~104@) (Mul d12~104@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~2005@ temp_12_1~2058@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2138@ (Sub (Mul (Add (Mul d13~112@ a13~106@) (Add b13~108@ d13~112@)) (Mul (Sub b13~108@ b13~108@) (Add c13~110@ d13~112@))) (Mul (Mul (Mul b13~108@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ a13~106@))))) (=> (= temp_13_1~2203@ (Sub (Mul (Mul (Sub b13~108@ b13~108@) (Add c13~110@ d13~112@)) (Add (Mul d13~112@ a13~106@) (Add b13~108@ d13~112@))) (Mul (Mul (Mul b13~108@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul c13~110@ a13~106@))))) (=> (= tmp%14@ (= temp_13_0~2138@ temp_13_1~2203@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2251@ (Mul (Sub (Mul (Mul c14~118@ a14~114@) (Sub a14~114@ c14~118@)) (Sub (Sub b14~116@ b14~116@) b14~116@)) b14~116@)) (=> (= temp_14_1~2292@ (Mul (Sub (Sub (Mul (Mul c14~118@ a14~114@) a14~114@) (Mul (Mul c14~118@ a14~114@) c14~118@)) (Sub (Sub b14~116@ b14~116@) b14~116@)) b14~116@)) (=> (= tmp%15@ (= temp_14_0~2251@ temp_14_1~2292@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2376@ (Mul (Mul (Mul (Mul a15~122@ b15~124@) (Mul c15~126@ b15~124@)) (Sub c15~126@ (Mul d15~128@ a15~122@))) (Mul (Sub (Mul d15~128@ d15~128@) (Mul c15~126@ c15~126@)) (Mul (Mul c15~126@ c15~126@) 61)))) (=> (= temp_15_1~2461@ (Mul (Sub (Mul (Mul (Mul a15~122@ b15~124@) (Mul c15~126@ b15~124@)) c15~126@) (Mul (Mul (Mul a15~122@ b15~124@) (Mul c15~126@ b15~124@)) (Mul d15~128@ a15~122@))) (Mul (Sub (Mul d15~128@ d15~128@) (Mul c15~126@ c15~126@)) (Mul (Mul c15~126@ c15~126@) 61)))) (=> (= tmp%16@ (= temp_15_0~2376@ temp_15_1~2461@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2525@ (Mul a16~130@ (Mul (Add (Add b16~132@ d16~136@) (Mul 87 a16~130@)) (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ c16~134@))))) (=> (= temp_16_1~2574@ (Mul a16~130@ (Mul (Add (Add b16~132@ d16~136@) (Mul 87 a16~130@)) (Mul (Mul c16~134@ b16~132@) (Mul c16~134@ b16~132@))))) (=> (= tmp%17@ (= temp_16_0~2525@ temp_16_1~2574@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2654@ (Mul (Mul (Add (Mul d17~144@ a17~138@) (Mul b17~140@ a17~138@)) (Mul (Add a17~138@ d17~144@) (Mul a17~138@ a17~138@))) (Mul (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ b17~140@)) (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ c17~142@))))) (=> (= temp_17_1~2719@ (Mul (Mul (Add (Mul d17~144@ a17~138@) (Mul b17~140@ a17~138@)) (Mul (Mul a17~138@ a17~138@) (Add a17~138@ d17~144@))) (Mul (Mul (Mul c17~142@ d17~144@) (Mul b17~140@ b17~140@)) (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ c17~142@))))) (=> (= tmp%18@ (= temp_17_0~2654@ temp_17_1~2719@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2775@ (Mul (Mul (Mul (Mul d18~152@ a18~146@) (Mul c18~150@ d18~152@)) c18~150@) (Sub (Mul (Mul b18~148@ d18~152@) (Mul b18~148@ d18~152@)) a18~146@))) (=> (= temp_18_1~2816@ (Mul (Mul c18~150@ (Mul (Mul d18~152@ a18~146@) (Mul c18~150@ d18~152@))) (Sub (Mul (Mul b18~148@ d18~152@) (Mul b18~148@ d18~152@)) a18~146@))) (=> (= tmp%19@ (= temp_18_0~2775@ temp_18_1~2816@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~2892@ (Mul (Mul (Mul (Mul a19~154@ d19~160@) (Sub c19~158@ b19~156@)) (Mul (Mul d19~160@ b19~156@) d19~160@)) (Mul (Mul (Mul a19~154@ a19~154@) (Mul a19~154@ b19~156@)) (Mul (Mul a19~154@ c19~158@) (Mul c19~158@ b19~156@))))) (=> (= temp_19_1~2953@ (Mul (Mul (Mul (Mul a19~154@ d19~160@) (Sub c19~158@ b19~156@)) (Mul (Mul d19~160@ b19~156@) d19~160@)) (Mul (Mul (Mul a19~154@ a19~154@) (Mul b19~156@ a19~154@)) (Mul (Mul a19~154@ c19~158@) (Mul c19~158@ b19~156@))))) (=> (= tmp%20@ (= temp_19_0~2892@ temp_19_1~2953@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3029@ (Sub (Mul (Add a20~162@ (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Mul c20~166@ a20~162@))) (Mul (Mul (Mul d20~168@ d20~168@) (Mul c20~166@ c20~166@)) (Add (Mul a20~162@ b20~164@) (Mul c20~166@ b20~164@))))) (=> (= temp_20_1~3090@ (Sub (Mul (Add a20~162@ (Mul d20~168@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Mul c20~166@ a20~162@))) (Mul (Mul (Mul c20~166@ c20~166@) (Mul d20~168@ d20~168@)) (Add (Mul a20~162@ b20~164@) (Mul c20~166@ b20~164@))))) (=> (= tmp%21@ (= temp_20_0~3029@ temp_20_1~3090@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3166@ (Mul (Mul (Mul (Mul d21~176@ c21~174@) (Mul b21~172@ b21~172@)) (Mul (Mul c21~174@ b21~172@) (Mul c21~174@ a21~170@))) (Add (Sub (Mul d21~176@ d21~176@) (Mul a21~170@ b21~172@)) (Mul (Mul d21~176@ c21~174@) a21~170@)))) (=> (= temp_21_1~3227@ (Mul (Mul (Mul (Mul d21~176@ c21~174@) (Mul b21~172@ b21~172@)) (Mul (Mul c21~174@ b21~172@) (Mul a21~170@ c21~174@))) (Add (Sub (Mul d21~176@ d21~176@) (Mul a21~170@ b21~172@)) (Mul (Mul d21~176@ c21~174@) a21~170@)))) (=> (= tmp%22@ (= temp_21_0~3166@ temp_21_1~3227@)) (and (=> %%location_label%%21 tmp%22@) (=> tmp%22@ (=> (= temp_22_0~3295@ (Mul (Mul b22~180@ (Sub (Sub b22~180@ d22~184@) (Mul c22~182@ d22~184@))) (Mul (Mul (Mul b22~180@ d22~184@) (Mul c22~182@ c22~182@)) (Mul (Add b22~180@ c22~182@) (Mul c22~182@ d22~184@))))) (=> (= temp_22_1~3356@ (Mul (Mul b22~180@ (Sub (Sub b22~180@ d22~184@) (Mul c22~182@ d22~184@))) (Mul (Mul (Mul b22~180@ d22~184@) (Mul c22~182@ c22~182@)) (Add (Mul b22~180@ (Mul c22~182@ d22~184@)) (Mul c22~182@ (Mul c22~182@ d22~184@)))))) (=> (= tmp%23@ (= temp_22_0~3295@ temp_22_1~3356@)) (=> %%location_label%%22 tmp%23@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
