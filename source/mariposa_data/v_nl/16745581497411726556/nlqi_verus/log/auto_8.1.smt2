...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Add (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul a0~2@ (Mul b0~4@ b0~4@))) (Mul (Mul (Sub d0~8@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Add (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul a0~2@ (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) (Sub d0~8@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~447@ (Mul (Mul (Sub (Mul d1~16@ a1~10@) a1~10@) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Sub b1~12@ d1~16@))))) (=> (= temp_1_1~524@ (Mul (Sub (Mul (Mul d1~16@ a1~10@) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ a1~10@))) (Mul a1~10@ (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ a1~10@)))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Sub b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~524@))) (=> (= temp_1_0~447@ temp_1_1~524@) (=> (= temp_2_0~613@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@)) (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Sub d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~678@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Sub d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~613@ temp_2_1~678@))) (=> (= temp_2_0~613@ temp_2_1~678@) (=> (= temp_3_0~775@ (Mul (Mul (Sub (Sub b3~28@ c3~30@) c3~30@) (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ c3~30@)) (Add (Mul 15 c3~30@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~848@ (Mul (Mul (Mul (Sub (Sub b3~28@ c3~30@) c3~30@) (Mul a3~26@ a3~26@)) (Mul b3~28@ c3~30@)) (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ c3~30@)) (Add (Mul 15 c3~30@) (Mul c3~30@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~775@ temp_3_1~848@))) (=> (= temp_3_0~775@ temp_3_1~848@) (=> (= temp_4_0~937@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Add d4~40@ c4~38@) (Sub b4~36@ c4~38@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@)) (Sub (Add b4~36@ b4~36@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~1002@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Add d4~40@ c4~38@) (Sub b4~36@ c4~38@))) (Mul (Mul d4~40@ a4~34@) (Mul (Mul b4~36@ a4~34@) (Sub (Add b4~36@ b4~36@) (Mul a4~34@ c4~38@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~937@ temp_4_1~1002@))) (=> (= temp_4_0~937@ temp_4_1~1002@) (=> (= temp_5_0~1095@ (Mul (Sub (Sub (Mul a5~42@ b5~44@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul 82 b5~44@))) (Mul (Mul c5~46@ (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ d5~48@) a5~42@)))) (=> (= temp_5_1~1164@ (Mul (Sub (Sub (Mul a5~42@ b5~44@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul 82 b5~44@))) (Mul (Mul c5~46@ (Mul a5~42@ c5~46@)) (Mul a5~42@ (Mul b5~44@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1095@ temp_5_1~1164@))) (=> (= temp_5_0~1095@ temp_5_1~1164@) (=> (= temp_6_0~1249@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Add b6~52@ c6~54@)) (Mul a6~50@ (Mul c6~54@ b6~52@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Add b6~52@ b6~52@))))) (=> (= temp_6_1~1310@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Add b6~52@ c6~54@)) (Mul a6~50@ (Mul c6~54@ b6~52@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Add b6~52@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1249@ temp_6_1~1310@))) (=> (= temp_6_0~1249@ temp_6_1~1310@) (=> (= temp_7_0~1399@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ a7~58@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1464@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ a7~58@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1399@ temp_7_1~1464@))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
