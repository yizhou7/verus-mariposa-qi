...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Add (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul a0~2@ (Mul b0~4@ b0~4@))) (Mul (Mul (Sub d0~8@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Add (Add (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@)) (Mul a0~2@ (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) (Sub d0~8@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~301@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~438@ (Mul (Mul (Sub (Mul d1~16@ a1~10@) a1~10@) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Sub b1~12@ d1~16@))))) (=> (= temp_1_1~515@ (Mul (Sub (Mul (Mul d1~16@ a1~10@) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ a1~10@))) (Mul a1~10@ (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ a1~10@)))) (Mul (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Sub b1~12@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~438@ temp_1_1~515@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~595@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@)) (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Sub d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~660@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Mul (Mul (Sub d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~595@ temp_2_1~660@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~748@ (Mul (Mul (Sub (Sub b3~28@ c3~30@) c3~30@) (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ c3~30@)) (Add (Mul 15 c3~30@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~821@ (Mul (Mul (Mul (Sub (Sub b3~28@ c3~30@) c3~30@) (Mul a3~26@ a3~26@)) (Mul b3~28@ c3~30@)) (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ c3~30@)) (Add (Mul 15 c3~30@) (Mul c3~30@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~748@ temp_3_1~821@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~901@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Add d4~40@ c4~38@) (Sub b4~36@ c4~38@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@)) (Sub (Add b4~36@ b4~36@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~966@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Add d4~40@ c4~38@) (Sub b4~36@ c4~38@))) (Mul (Mul d4~40@ a4~34@) (Mul (Mul b4~36@ a4~34@) (Sub (Add b4~36@ b4~36@) (Mul a4~34@ c4~38@)))))) (=> (= tmp%5@ (= temp_4_0~901@ temp_4_1~966@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1050@ (Mul (Sub (Sub (Mul a5~42@ b5~44@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul 82 b5~44@))) (Mul (Mul c5~46@ (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ d5~48@) a5~42@)))) (=> (= temp_5_1~1119@ (Mul (Sub (Sub (Mul a5~42@ b5~44@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul 82 b5~44@))) (Mul (Mul c5~46@ (Mul a5~42@ c5~46@)) (Mul a5~42@ (Mul b5~44@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~1050@ temp_5_1~1119@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1195@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Add b6~52@ c6~54@)) (Mul a6~50@ (Mul c6~54@ b6~52@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Add b6~52@ b6~52@))))) (=> (= temp_6_1~1256@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Add b6~52@ c6~54@)) (Mul a6~50@ (Mul c6~54@ b6~52@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Add b6~52@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1195@ temp_6_1~1256@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1336@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ a7~58@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1401@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ a7~58@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1336@ temp_7_1~1401@)) (=> %%location_label%%7 tmp%8@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
