...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Add (Mul (Mul c0~6@ d0~8@) (Sub d0~8@ b0~4@)) (Mul (Mul d0~8@ a0~2@) c0~6@)) (Add (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ 0)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ a0~2@))))) (=> (= temp_0_1~386@ (Mul (Add (Mul c0~6@ (Mul d0~8@ (Sub d0~8@ b0~4@))) (Mul (Mul d0~8@ a0~2@) c0~6@)) (Add (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ 0)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~313@ temp_0_1~386@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~474@ (Mul (Add (Mul b1~12@ (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul 95 c1~14@))))) (=> (= temp_1_1~547@ (Mul (Add (Mul (Mul b1~12@ c1~14@) a1~10@) (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul 95 c1~14@))))) (=> (= tmp%2@ (= temp_1_0~474@ temp_1_1~547@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~623@ (Mul (Sub (Mul (Mul c2~22@ a2~18@) d2~24@) (Mul (Mul b2~20@ d2~24@) (Sub a2~18@ c2~22@))) (Add (Mul (Mul a2~18@ b2~20@) (Add b2~20@ d2~24@)) (Sub (Mul b2~20@ b2~20@) (Sub d2~24@ a2~18@))))) (=> (= temp_2_1~684@ (Mul (Sub (Mul (Mul c2~22@ a2~18@) d2~24@) (Mul (Mul b2~20@ d2~24@) (Sub a2~18@ c2~22@))) (Add (Mul a2~18@ (Mul b2~20@ (Add b2~20@ d2~24@))) (Sub (Mul b2~20@ b2~20@) (Sub d2~24@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~623@ temp_2_1~684@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~748@ (Mul (Add (Mul a3~26@ (Mul b3~28@ b3~28@)) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ d3~32@)) b3~28@))) (=> (= temp_3_1~797@ (Mul (Add (Mul (Mul b3~28@ b3~28@) a3~26@) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ d3~32@)) b3~28@))) (=> (= tmp%4@ (= temp_3_0~748@ temp_3_1~797@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~885@ (Mul (Mul (Mul c4~38@ (Mul 65 c4~38@)) (Mul (Add c4~38@ a4~34@) (Mul d4~40@ d4~40@))) (Mul (Add (Mul c4~38@ b4~36@) (Mul b4~36@ a4~34@)) (Add (Mul d4~40@ c4~38@) (Sub b4~36@ c4~38@))))) (=> (= temp_4_1~958@ (Mul (Mul (Mul c4~38@ (Mul 65 c4~38@)) (Mul (Add c4~38@ a4~34@) (Mul d4~40@ d4~40@))) (Mul (Add (Mul c4~38@ b4~36@) (Mul a4~34@ b4~36@)) (Add (Mul d4~40@ c4~38@) (Sub b4~36@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~885@ temp_4_1~958@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1034@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Mul (Sub d5~48@ c5~46@) c5~46@) (Mul (Add b5~44@ d5~48@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1095@ (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Mul (Sub d5~48@ c5~46@) c5~46@) (Mul (Mul (Add b5~44@ d5~48@) d5~48@) d5~48@)))) (=> (= tmp%6@ (= temp_5_0~1034@ temp_5_1~1095@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1171@ (Add (Add (Mul (Sub d6~56@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Sub c6~54@ d6~56@) b6~52@)) (Mul (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ b6~52@)) (Sub (Add a6~50@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1240@ (Add (Add (Sub (Mul d6~56@ (Mul d6~56@ b6~52@)) (Mul a6~50@ (Mul d6~56@ b6~52@))) (Mul (Sub c6~54@ d6~56@) b6~52@)) (Mul (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ b6~52@)) (Sub (Add a6~50@ b6~52@) (Mul c6~54@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1171@ temp_6_1~1240@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1304@ (Mul (Mul d7~64@ (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@))) (Mul (Add c7~62@ (Mul a7~58@ c7~62@)) (Sub (Mul c7~62@ b7~60@) (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1353@ (Mul (Mul d7~64@ (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ b7~60@))) (Mul (Add c7~62@ (Mul a7~58@ c7~62@)) (Sub (Mul c7~62@ b7~60@) (Mul a7~58@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1304@ temp_7_1~1353@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1445@ (Mul (Mul (Add (Mul b8~68@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@))) (Sub (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ 93) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1538@ (Mul (Add (Mul (Mul b8~68@ c8~70@) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@))) (Mul (Mul a8~66@ b8~68@) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ b8~68@)))) (Sub (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ 93) (Mul c8~70@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1445@ temp_8_1~1538@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1614@ (Mul (Mul (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ b9~76@)) (Mul (Mul a9~74@ c9~78@) c9~78@)))) (=> (= temp_9_1~1675@ (Mul (Mul (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ c9~78@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ a9~74@))) (Mul (Mul d9~80@ a9~74@) (Mul (Mul d9~80@ b9~76@) (Mul (Mul a9~74@ c9~78@) c9~78@))))) (=> (= tmp%10@ (= temp_9_0~1614@ temp_9_1~1675@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1759@ (Mul (Mul (Mul (Mul d10~88@ a10~82@) (Mul a10~82@ d10~88@)) (Mul b10~84@ (Mul a10~82@ a10~82@))) (Mul (Mul (Mul b10~84@ a10~82@) (Sub b10~84@ b10~84@)) (Mul (Sub a10~82@ 11) d10~88@)))) (=> (= temp_10_1~1828@ (Mul (Mul (Mul (Mul d10~88@ a10~82@) (Mul d10~88@ a10~82@)) (Mul b10~84@ (Mul a10~82@ a10~82@))) (Mul (Mul (Mul b10~84@ a10~82@) (Sub b10~84@ b10~84@)) (Mul (Sub a10~82@ 11) d10~88@)))) (=> (= tmp%11@ (= temp_10_0~1759@ temp_10_1~1828@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1896@ (Mul (Sub (Mul c11~94@ a11~90@) (Mul (Sub a11~90@ a11~90@) (Mul c11~94@ d11~96@))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul b11~92@ d11~96@)) (Mul c11~94@ (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~1957@ (Mul (Sub (Mul c11~94@ a11~90@) (Sub (Mul a11~90@ (Mul c11~94@ d11~96@)) (Mul a11~90@ (Mul c11~94@ d11~96@)))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul b11~92@ d11~96@)) (Mul c11~94@ (Mul d11~96@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1896@ temp_11_1~1957@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2049@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ d12~104@) (Add d12~104@ 32))))) (=> (= temp_12_1~2126@ (Mul (Mul (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ c12~102@)) (Mul (Mul a12~98@ b12~100@) (Mul c12~102@ c12~102@))) (Mul (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ b12~100@)) (Mul (Add d12~104@ 32) (Mul a12~98@ d12~104@))))) (=> (= tmp%13@ (= temp_12_0~2049@ temp_12_1~2126@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2218@ (Sub (Mul (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ c13~110@)) (Add (Mul a13~106@ c13~110@) (Mul d13~112@ b13~108@))) (Mul (Mul (Mul b13~108@ c13~110@) (Mul a13~106@ c13~110@)) (Mul (Mul d13~112@ 70) (Mul a13~106@ a13~106@))))) (=> (= temp_13_1~2295@ (Sub (Mul (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ c13~110@)) (Add (Mul a13~106@ c13~110@) (Mul d13~112@ b13~108@))) (Mul (Mul (Mul b13~108@ c13~110@) (Mul a13~106@ c13~110@)) (Mul (Mul (Mul d13~112@ 70) a13~106@) a13~106@)))) (=> (= tmp%14@ (= temp_13_0~2218@ temp_13_1~2295@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2387@ (Add (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Mul d14~120@ d14~120@) (Sub c14~118@ d14~120@))) (Add (Mul (Mul b14~116@ c14~118@) (Mul c14~118@ 32)) (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2464@ (Add (Mul (Mul (Mul c14~118@ d14~120@) (Mul b14~116@ d14~120@)) (Mul (Mul d14~120@ d14~120@) (Sub c14~118@ d14~120@))) (Add (Mul (Mul c14~118@ b14~116@) (Mul c14~118@ 32)) (Mul (Mul d14~120@ d14~120@) (Mul b14~116@ c14~118@))))) (=> (= tmp%15@ (= temp_14_0~2387@ temp_14_1~2464@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2560@ (Mul (Mul (Mul c15~126@ (Mul a15~122@ d15~128@)) (Mul (Mul b15~124@ a15~122@) (Mul a15~122@ a15~122@))) (Mul (Mul c15~126@ (Mul c15~126@ a15~122@)) (Add (Add c15~126@ 64) (Mul 90 b15~124@))))) (=> (= temp_15_1~2641@ (Mul (Mul (Mul c15~126@ (Mul a15~122@ d15~128@)) (Mul (Mul (Mul b15~124@ a15~122@) a15~122@) a15~122@)) (Mul (Mul c15~126@ (Mul c15~126@ a15~122@)) (Add (Add c15~126@ 64) (Mul 90 b15~124@))))) (=> (= tmp%16@ (= temp_15_0~2560@ temp_15_1~2641@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2745@ (Mul (Mul (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ d16~136@)) (Add (Mul c16~134@ a16~130@) (Mul b16~132@ a16~130@))) (Add (Mul (Mul c16~134@ d16~136@) (Sub c16~134@ c16~134@)) (Add (Sub 62 38) (Add c16~134@ c16~134@))))) (=> (= temp_16_1~2834@ (Mul (Mul (Add (Mul c16~134@ a16~130@) (Mul b16~132@ a16~130@)) (Mul (Mul c16~134@ b16~132@) (Mul b16~132@ d16~136@))) (Add (Mul (Mul c16~134@ d16~136@) (Sub c16~134@ c16~134@)) (Add (Sub 62 38) (Add c16~134@ c16~134@))))) (=> (= tmp%17@ (= temp_16_0~2745@ temp_16_1~2834@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2926@ (Mul (Mul (Sub (Sub a17~138@ a17~138@) (Mul a17~138@ c17~142@)) (Mul (Sub d17~144@ c17~142@) (Sub a17~138@ b17~140@))) (Mul (Mul (Mul c17~142@ 29) (Mul b17~140@ b17~140@)) (Mul (Sub c17~142@ d17~144@) (Mul c17~142@ d17~144@))))) (=> (= temp_17_1~3003@ (Mul (Mul (Sub (Sub a17~138@ a17~138@) (Mul a17~138@ c17~142@)) (Mul (Sub d17~144@ c17~142@) (Sub a17~138@ b17~140@))) (Mul (Mul (Sub c17~142@ d17~144@) (Mul c17~142@ d17~144@)) (Mul (Mul c17~142@ 29) (Mul b17~140@ b17~140@))))) (=> (= tmp%18@ (= temp_17_0~2926@ temp_17_1~3003@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~3083@ (Mul (Mul (Mul (Mul c18~150@ d18~152@) (Mul a18~146@ c18~150@)) (Mul (Mul c18~150@ c18~150@) (Sub a18~146@ b18~148@))) (Mul (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ b18~148@)) (Sub (Mul c18~150@ b18~148@) (Sub a18~146@ c18~150@))))) (=> (= temp_18_1~3148@ (Mul (Mul (Mul (Mul c18~150@ d18~152@) (Mul a18~146@ c18~150@)) (Mul (Mul c18~150@ c18~150@) (Sub a18~146@ b18~148@))) (Mul (Mul (Mul a18~146@ d18~152@) (Mul a18~146@ b18~148@)) (Sub (Mul c18~150@ b18~148@) (Sub a18~146@ c18~150@))))) (=> (= tmp%19@ (= temp_18_0~3083@ temp_18_1~3148@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3228@ (Mul (Mul (Mul (Mul a19~154@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Sub a19~154@ a19~154@) (Mul c19~158@ d19~160@))) (Mul (Mul (Mul a19~154@ b19~156@) (Sub c19~158@ c19~158@)) (Mul (Mul d19~160@ d19~160@) (Mul a19~154@ b19~156@))))) (=> (= temp_19_1~3293@ (Mul (Mul (Mul (Mul a19~154@ b19~156@) (Mul b19~156@ d19~160@)) (Mul (Sub a19~154@ a19~154@) (Mul c19~158@ d19~160@))) (Mul (Mul (Mul a19~154@ b19~156@) (Sub c19~158@ c19~158@)) (Mul (Mul d19~160@ d19~160@) (Mul b19~156@ a19~154@))))) (=> (= tmp%20@ (= temp_19_0~3228@ temp_19_1~3293@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3345@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Mul c20~166@ c20~166@)) (Add (Mul b20~164@ c20~166@) (Mul b20~164@ a20~162@))) a20~162@)) (=> (= temp_20_1~3382@ (Mul (Mul (Mul (Mul b20~164@ b20~164@) (Mul c20~166@ c20~166@)) (Add (Mul b20~164@ c20~166@) (Mul b20~164@ a20~162@))) a20~162@)) (=> (= tmp%21@ (= temp_20_0~3345@ temp_20_1~3382@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3474@ (Sub (Mul (Mul (Mul a21~170@ a21~170@) (Add a21~170@ 6)) (Mul (Mul d21~176@ c21~174@) (Mul c21~174@ b21~172@))) (Mul (Mul (Mul a21~170@ d21~176@) (Mul c21~174@ d21~176@)) (Add (Mul d21~176@ b21~172@) (Mul d21~176@ d21~176@))))) (=> (= temp_21_1~3551@ (Sub (Mul (Mul a21~170@ a21~170@) (Mul (Add a21~170@ 6) (Mul (Mul d21~176@ c21~174@) (Mul c21~174@ b21~172@)))) (Mul (Mul (Mul a21~170@ d21~176@) (Mul c21~174@ d21~176@)) (Add (Mul d21~176@ b21~172@) (Mul d21~176@ d21~176@))))) (=> (= tmp%22@ (= temp_21_0~3474@ temp_21_1~3551@)) (and (=> %%location_label%%21 tmp%22@) (=> tmp%22@ (=> (= temp_22_0~3631@ (Mul (Mul (Add (Mul a22~178@ c22~182@) (Mul b22~180@ b22~180@)) (Mul (Mul c22~182@ a22~178@) (Mul d22~184@ a22~178@))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul c22~182@ a22~178@)) (Mul (Mul a22~178@ d22~184@) (Mul b22~180@ c22~182@))))) (=> (= temp_22_1~3696@ (Mul (Mul (Add (Mul a22~178@ c22~182@) (Mul b22~180@ b22~180@)) (Mul (Mul c22~182@ a22~178@) (Mul d22~184@ a22~178@))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul c22~182@ a22~178@)) (Mul (Mul d22~184@ a22~178@) (Mul b22~180@ c22~182@))))) (=> (= tmp%23@ (= temp_22_0~3631@ temp_22_1~3696@)) (=> %%location_label%%22 tmp%23@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
