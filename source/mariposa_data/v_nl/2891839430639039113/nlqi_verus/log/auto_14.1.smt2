...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Sub (Mul (Mul (Mul d0~8@ c0~6@) (Add d0~8@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Sub 93 b0~4@))))) (=> (= temp_0_1~394@ (Sub (Mul (Mul (Mul d0~8@ c0~6@) (Add d0~8@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul c0~6@ b0~4@) (Sub 93 b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~455@ (Mul (Add (Sub (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ b1~12@))) a1~10@)) (=> (= temp_1_1~492@ (Mul (Add (Sub (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ b1~12@))) a1~10@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~455@ temp_1_1~492@))) (=> (= temp_1_0~455@ temp_1_1~492@) (=> (= temp_2_0~581@ (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Add a2~18@ b2~20@))) (Add (Mul (Mul b2~20@ d2~24@) (Add c2~22@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~646@ (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Add a2~18@ b2~20@))) (Add (Mul (Mul b2~20@ d2~24@) (Add c2~22@ d2~24@)) (Mul a2~18@ (Mul d2~24@ (Mul c2~22@ a2~18@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~581@ temp_2_1~646@))) (=> (= temp_2_0~581@ temp_2_1~646@) (=> (= temp_3_0~747@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Sub d3~32@ b3~28@)) (Add (Sub c3~30@ d3~32@) (Mul a3~26@ b3~28@))) (Mul (Sub (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ 80) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~840@ (Mul (Add (Mul (Mul (Mul a3~26@ d3~32@) (Sub d3~32@ b3~28@)) (Sub c3~30@ d3~32@)) (Mul (Mul (Mul a3~26@ d3~32@) (Sub d3~32@ b3~28@)) (Mul a3~26@ b3~28@))) (Mul (Sub (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ 80) (Mul d3~32@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~747@ temp_3_1~840@))) (=> (= temp_3_0~747@ temp_3_1~840@) (=> (= temp_4_0~937@ (Mul (Mul (Mul a4~34@ (Add c4~38@ 47)) (Mul (Mul d4~40@ a4~34@) (Add 26 d4~40@))) (Mul c4~38@ (Mul (Add a4~34@ b4~36@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~1014@ (Mul (Mul (Add (Mul a4~34@ c4~38@) (Mul a4~34@ 47)) (Mul (Mul d4~40@ a4~34@) (Add 26 d4~40@))) (Mul c4~38@ (Mul (Add a4~34@ b4~36@) (Mul b4~36@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~937@ temp_4_1~1014@))) (=> (= temp_4_0~937@ temp_4_1~1014@) (=> (= temp_5_0~1103@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ a5~42@) (Sub d5~48@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@))))) (=> (= temp_5_1~1168@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ a5~42@) (Sub d5~48@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1103@ temp_5_1~1168@))) (=> (= temp_5_0~1103@ temp_5_1~1168@) (=> (= temp_6_0~1269@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul 42 c6~54@) (Mul d6~56@ a6~50@))) (Sub 77 (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1346@ (Mul (Sub 77 (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul 42 c6~54@) (Mul d6~56@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1269@ temp_6_1~1346@))) (=> (= temp_6_0~1269@ temp_6_1~1346@) (=> (= temp_7_0~1439@ (Sub (Sub (Mul (Add c7~62@ a7~58@) (Sub d7~64@ b7~60@)) (Mul (Add c7~62@ 32) (Sub d7~64@ b7~60@))) (Mul (Add (Mul b7~60@ b7~60@) d7~64@) (Mul (Mul c7~62@ d7~64@) d7~64@)))) (=> (= temp_7_1~1508@ (Sub (Sub (Mul (Sub d7~64@ b7~60@) (Add c7~62@ a7~58@)) (Mul (Add c7~62@ 32) (Sub d7~64@ b7~60@))) (Mul (Add (Mul b7~60@ b7~60@) d7~64@) (Mul (Mul c7~62@ d7~64@) d7~64@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1439@ temp_7_1~1508@))) (=> (= temp_7_0~1439@ temp_7_1~1508@) (=> (= temp_8_0~1601@ (Mul (Mul (Mul c8~70@ (Mul c8~70@ c8~70@)) (Add (Mul c8~70@ a8~66@) (Sub c8~70@ 15))) (Mul (Mul (Mul d8~72@ d8~72@) b8~68@) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1670@ (Mul (Mul (Mul c8~70@ (Mul c8~70@ c8~70@)) (Add (Mul c8~70@ a8~66@) (Sub c8~70@ 15))) (Mul (Mul d8~72@ (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1601@ temp_8_1~1670@))) (=> (= temp_8_0~1601@ temp_8_1~1670@) (=> (= temp_9_0~1755@ (Mul (Add (Add (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@))) (Mul (Mul (Mul c9~78@ c9~78@) (Mul b9~76@ a9~74@)) (Mul b9~76@ (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1816@ (Mul (Add (Add (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@))) (Mul (Mul c9~78@ (Mul c9~78@ (Mul b9~76@ a9~74@))) (Mul b9~76@ (Mul d9~80@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1755@ temp_9_1~1816@))) (=> (= temp_9_0~1755@ temp_9_1~1816@) (=> (= temp_10_0~1897@ (Add (Mul (Mul (Mul d10~88@ b10~84@) d10~88@) (Mul d10~88@ (Mul c10~86@ d10~88@))) (Mul (Mul (Mul b10~84@ c10~86@) (Sub b10~84@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ c10~86@))))) (=> (= temp_10_1~1954@ (Add (Mul (Mul (Mul d10~88@ b10~84@) d10~88@) (Mul d10~88@ (Mul c10~86@ d10~88@))) (Mul (Mul (Mul b10~84@ c10~86@) (Sub b10~84@ a10~82@)) (Mul c10~86@ (Mul a10~82@ (Mul b10~84@ c10~86@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1897@ temp_10_1~1954@))) (=> (= temp_10_0~1897@ temp_10_1~1954@) (=> (= temp_11_0~2039@ (Mul (Sub (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ a11~90@)) (Mul (Sub a11~90@ a11~90@) (Mul d11~96@ b11~92@))) (Mul (Mul a11~90@ (Sub b11~92@ a11~90@)) (Mul (Add b11~92@ d11~96@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2104@ (Mul (Sub (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ a11~90@)) (Mul (Sub a11~90@ a11~90@) (Mul d11~96@ b11~92@))) (Mul (Sub (Mul a11~90@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (Add b11~92@ d11~96@) (Mul d11~96@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2039@ temp_11_1~2104@))) (=> (= temp_11_0~2039@ temp_11_1~2104@) (=> (= temp_12_0~2181@ (Mul (Mul b12~100@ (Sub (Mul d12~104@ a12~98@) (Mul a12~98@ a12~98@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2234@ (Mul (Mul b12~100@ (Sub (Mul a12~98@ d12~104@) (Mul a12~98@ a12~98@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2181@ temp_12_1~2234@))) (=> (= temp_12_0~2181@ temp_12_1~2234@) (=> (= temp_13_0~2323@ (Mul (Mul (Mul (Add c13~110@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ b13~108@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ c13~110@)) (Add (Mul b13~108@ c13~110@) (Sub b13~108@ c13~110@))))) (=> (= temp_13_1~2388@ (Mul (Mul (Mul (Add c13~110@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ b13~108@))) (Mul (Add (Mul b13~108@ c13~110@) (Sub b13~108@ c13~110@)) (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ c13~110@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2323@ temp_13_1~2388@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
