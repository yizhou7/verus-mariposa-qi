...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Sub (Mul (Mul (Mul d0~8@ c0~6@) (Add d0~8@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Sub 93 b0~4@))))) (=> (= temp_0_1~394@ (Sub (Mul (Mul (Mul d0~8@ c0~6@) (Add d0~8@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul c0~6@ b0~4@) (Sub 93 b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~317@ temp_0_1~394@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~446@ (Mul (Add (Sub (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ b1~12@))) a1~10@)) (=> (= temp_1_1~483@ (Mul (Add (Sub (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ b1~12@))) a1~10@)) (=> (= tmp%2@ (= temp_1_0~446@ temp_1_1~483@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~563@ (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Add a2~18@ b2~20@))) (Add (Mul (Mul b2~20@ d2~24@) (Add c2~22@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~628@ (Mul (Mul (Mul (Sub b2~20@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Add a2~18@ b2~20@))) (Add (Mul (Mul b2~20@ d2~24@) (Add c2~22@ d2~24@)) (Mul a2~18@ (Mul d2~24@ (Mul c2~22@ a2~18@)))))) (=> (= tmp%3@ (= temp_2_0~563@ temp_2_1~628@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~720@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Sub d3~32@ b3~28@)) (Add (Sub c3~30@ d3~32@) (Mul a3~26@ b3~28@))) (Mul (Sub (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ 80) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~813@ (Mul (Add (Mul (Mul (Mul a3~26@ d3~32@) (Sub d3~32@ b3~28@)) (Sub c3~30@ d3~32@)) (Mul (Mul (Mul a3~26@ d3~32@) (Sub d3~32@ b3~28@)) (Mul a3~26@ b3~28@))) (Mul (Sub (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ 80) (Mul d3~32@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~720@ temp_3_1~813@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~901@ (Mul (Mul (Mul a4~34@ (Add c4~38@ 47)) (Mul (Mul d4~40@ a4~34@) (Add 26 d4~40@))) (Mul c4~38@ (Mul (Add a4~34@ b4~36@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~978@ (Mul (Mul (Add (Mul a4~34@ c4~38@) (Mul a4~34@ 47)) (Mul (Mul d4~40@ a4~34@) (Add 26 d4~40@))) (Mul c4~38@ (Mul (Add a4~34@ b4~36@) (Mul b4~36@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~901@ temp_4_1~978@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1058@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ a5~42@) (Sub d5~48@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@))))) (=> (= temp_5_1~1123@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ a5~42@) (Sub d5~48@ d5~48@)) (Sub (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1058@ temp_5_1~1123@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1215@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul 42 c6~54@) (Mul d6~56@ a6~50@))) (Sub 77 (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ b6~52@))))) (=> (= temp_6_1~1292@ (Mul (Sub 77 (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul 42 c6~54@) (Mul d6~56@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~1215@ temp_6_1~1292@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1376@ (Sub (Sub (Mul (Add c7~62@ a7~58@) (Sub d7~64@ b7~60@)) (Mul (Add c7~62@ 32) (Sub d7~64@ b7~60@))) (Mul (Add (Mul b7~60@ b7~60@) d7~64@) (Mul (Mul c7~62@ d7~64@) d7~64@)))) (=> (= temp_7_1~1445@ (Sub (Sub (Mul (Sub d7~64@ b7~60@) (Add c7~62@ a7~58@)) (Mul (Add c7~62@ 32) (Sub d7~64@ b7~60@))) (Mul (Add (Mul b7~60@ b7~60@) d7~64@) (Mul (Mul c7~62@ d7~64@) d7~64@)))) (=> (= tmp%8@ (= temp_7_0~1376@ temp_7_1~1445@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1529@ (Mul (Mul (Mul c8~70@ (Mul c8~70@ c8~70@)) (Add (Mul c8~70@ a8~66@) (Sub c8~70@ 15))) (Mul (Mul (Mul d8~72@ d8~72@) b8~68@) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1598@ (Mul (Mul (Mul c8~70@ (Mul c8~70@ c8~70@)) (Add (Mul c8~70@ a8~66@) (Sub c8~70@ 15))) (Mul (Mul d8~72@ (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1529@ temp_8_1~1598@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1674@ (Mul (Add (Add (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@))) (Mul (Mul (Mul c9~78@ c9~78@) (Mul b9~76@ a9~74@)) (Mul b9~76@ (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1735@ (Mul (Add (Add (Mul b9~76@ d9~80@) (Mul d9~80@ a9~74@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@))) (Mul (Mul c9~78@ (Mul c9~78@ (Mul b9~76@ a9~74@))) (Mul b9~76@ (Mul d9~80@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1674@ temp_9_1~1735@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1807@ (Add (Mul (Mul (Mul d10~88@ b10~84@) d10~88@) (Mul d10~88@ (Mul c10~86@ d10~88@))) (Mul (Mul (Mul b10~84@ c10~86@) (Sub b10~84@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ c10~86@))))) (=> (= temp_10_1~1864@ (Add (Mul (Mul (Mul d10~88@ b10~84@) d10~88@) (Mul d10~88@ (Mul c10~86@ d10~88@))) (Mul (Mul (Mul b10~84@ c10~86@) (Sub b10~84@ a10~82@)) (Mul c10~86@ (Mul a10~82@ (Mul b10~84@ c10~86@)))))) (=> (= tmp%11@ (= temp_10_0~1807@ temp_10_1~1864@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1940@ (Mul (Sub (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ a11~90@)) (Mul (Sub a11~90@ a11~90@) (Mul d11~96@ b11~92@))) (Mul (Mul a11~90@ (Sub b11~92@ a11~90@)) (Mul (Add b11~92@ d11~96@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2005@ (Mul (Sub (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ a11~90@)) (Mul (Sub a11~90@ a11~90@) (Mul d11~96@ b11~92@))) (Mul (Sub (Mul a11~90@ b11~92@) (Mul a11~90@ a11~90@)) (Mul (Add b11~92@ d11~96@) (Mul d11~96@ b11~92@))))) (=> (= tmp%12@ (= temp_11_0~1940@ temp_11_1~2005@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2073@ (Mul (Mul b12~100@ (Sub (Mul d12~104@ a12~98@) (Mul a12~98@ a12~98@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= temp_12_1~2126@ (Mul (Mul b12~100@ (Sub (Mul a12~98@ d12~104@) (Mul a12~98@ a12~98@))) (Mul (Mul (Mul b12~100@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@))))) (=> (= tmp%13@ (= temp_12_0~2073@ temp_12_1~2126@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2206@ (Mul (Mul (Mul (Add c13~110@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ b13~108@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ c13~110@)) (Add (Mul b13~108@ c13~110@) (Sub b13~108@ c13~110@))))) (=> (= temp_13_1~2271@ (Mul (Mul (Mul (Add c13~110@ c13~110@) (Mul a13~106@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ b13~108@))) (Mul (Add (Mul b13~108@ c13~110@) (Sub b13~108@ c13~110@)) (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ c13~110@))))) (=> (= tmp%14@ (= temp_13_0~2206@ temp_13_1~2271@)) (=> %%location_label%%13 tmp%14@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
