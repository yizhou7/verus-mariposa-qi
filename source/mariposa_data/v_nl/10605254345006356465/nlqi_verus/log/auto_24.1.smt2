...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@)) (Sub (Mul c0~6@ c0~6@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@)) (Sub (Mul c0~6@ c0~6@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~467@ (Mul (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ b1~12@)) (Sub (Mul d1~16@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Add b1~12@ d1~16@) a1~10@) (Sub (Mul d1~16@ b1~12@) (Sub a1~10@ 9))))) (=> (= temp_1_1~540@ (Mul (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ b1~12@)) (Sub (Mul d1~16@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul a1~10@ (Add b1~12@ d1~16@)) (Sub (Mul d1~16@ b1~12@) (Sub a1~10@ 9))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~467@ temp_1_1~540@))) (=> (= temp_1_0~467@ temp_1_1~540@) (=> (= temp_2_0~629@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Sub a2~18@ c2~22@) (Add d2~24@ b2~20@))) (Mul (Mul (Mul b2~20@ d2~24@) (Sub c2~22@ c2~22@)) (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~702@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ a2~18@)) (Add (Mul (Sub a2~18@ c2~22@) d2~24@) (Mul (Sub a2~18@ c2~22@) b2~20@))) (Mul (Mul (Mul b2~20@ d2~24@) (Sub c2~22@ c2~22@)) (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~629@ temp_2_1~702@))) (=> (= temp_2_0~629@ temp_2_1~702@) (=> (= temp_3_0~819@ (Mul (Mul (Mul c3~30@ (Mul 38 10)) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul 10 b3~28@) c3~30@) (Mul (Sub c3~30@ a3~26@) (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~912@ (Mul (Mul (Mul c3~30@ (Mul 38 10)) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul 10 b3~28@) c3~30@) (Mul (Mul b3~28@ c3~30@) (Sub c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~819@ temp_3_1~912@))) (=> (= temp_3_0~819@ temp_3_1~912@) (=> (= temp_4_0~1037@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Add c4~38@ 96) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul a4~34@ c4~38@) (Add 3 a4~34@)) (Mul (Add 28 a4~34@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~1146@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@)) (Add (Mul c4~38@ (Mul c4~38@ c4~38@)) (Mul 96 (Mul c4~38@ c4~38@)))) (Mul (Mul (Mul a4~34@ c4~38@) (Add 3 a4~34@)) (Mul (Add 28 a4~34@) (Mul a4~34@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~1037@ temp_4_1~1146@))) (=> (= temp_4_0~1037@ temp_4_1~1146@) (=> (= temp_5_0~1235@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Sub a5~42@ b5~44@)) (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ c5~46@)) (Sub (Mul c5~46@ a5~42@) (Sub b5~44@ b5~44@))))) (=> (= temp_5_1~1300@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Sub a5~42@ b5~44@)) (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ d5~48@))) (Mul (Sub (Mul c5~46@ a5~42@) (Sub b5~44@ b5~44@)) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1235@ temp_5_1~1300@))) (=> (= temp_5_0~1235@ temp_5_1~1300@) (=> (= temp_6_0~1389@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Add a6~50@ b6~52@)) (Mul (Add d6~56@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Mul (Add b6~52@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ b6~52@) (Sub a6~50@ a6~50@))))) (=> (= temp_6_1~1454@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Add a6~50@ b6~52@)) (Mul (Add d6~56@ d6~56@) (Mul c6~54@ d6~56@))) (Mul (Mul (Add b6~52@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ b6~52@) (Sub a6~50@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1389@ temp_6_1~1454@))) (=> (= temp_6_0~1389@ temp_6_1~1454@) (=> (= temp_7_0~1555@ (Sub (Mul (Mul (Mul d7~64@ a7~58@) (Sub c7~62@ c7~62@)) (Sub (Mul a7~58@ c7~62@) (Mul b7~60@ d7~64@))) (Mul (Add (Mul d7~64@ b7~60@) (Mul 61 c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1632@ (Sub (Mul (Mul (Mul d7~64@ a7~58@) (Sub c7~62@ c7~62@)) (Sub (Mul a7~58@ c7~62@) (Mul b7~60@ d7~64@))) (Mul (Add (Mul d7~64@ b7~60@) (Mul 61 c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul b7~60@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1555@ temp_7_1~1632@))) (=> (= temp_7_0~1555@ temp_7_1~1632@) (=> (= temp_8_0~1697@ (Mul (Mul (Mul (Mul c8~70@ a8~66@) (Add a8~66@ a8~66@)) (Add (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@))) (Mul c8~70@ c8~70@))) (=> (= temp_8_1~1754@ (Mul (Add (Mul (Mul (Mul c8~70@ a8~66@) (Add a8~66@ a8~66@)) (Mul d8~72@ b8~68@)) (Mul (Mul (Mul c8~70@ a8~66@) (Add a8~66@ a8~66@)) (Mul c8~70@ c8~70@))) (Mul c8~70@ c8~70@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1697@ temp_8_1~1754@))) (=> (= temp_8_0~1697@ temp_8_1~1754@) (=> (= temp_9_0~1843@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ b9~76@))) (Mul (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1908@ (Mul (Mul (Mul (Mul c9~78@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ b9~76@))) (Mul (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ b9~76@)) (Mul (Mul a9~74@ c9~78@) (Mul a9~74@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1843@ temp_9_1~1908@))) (=> (= temp_9_0~1843@ temp_9_1~1908@) (=> (= temp_10_0~1993@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) a10~82@) (Mul (Add a10~82@ c10~86@) (Add a10~82@ b10~84@))) (Mul (Mul (Add a10~82@ d10~88@) (Mul c10~86@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))))) (=> (= temp_10_1~2054@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) a10~82@) (Mul (Add a10~82@ b10~84@) (Add a10~82@ c10~86@))) (Mul (Mul (Add a10~82@ d10~88@) (Mul c10~86@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Mul b10~84@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1993@ temp_10_1~2054@))) (=> (= temp_10_0~1993@ temp_10_1~2054@) (=> (= temp_11_0~2123@ (Mul (Mul (Mul c11~94@ (Mul d11~96@ c11~94@)) (Sub (Mul a11~90@ b11~92@) a11~90@)) (Mul a11~90@ (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~2168@ (Mul (Mul (Mul c11~94@ (Mul d11~96@ c11~94@)) (Sub (Mul a11~90@ b11~92@) a11~90@)) (Mul a11~90@ (Mul a11~90@ (Mul d11~96@ (Mul a11~90@ d11~96@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2123@ temp_11_1~2168@))) (=> (= temp_11_0~2123@ temp_11_1~2168@) (=> (= temp_12_0~2253@ (Mul (Mul (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ d12~104@)) (Mul (Mul c12~102@ b12~100@) (Add c12~102@ a12~98@))) (Mul (Mul (Mul b12~100@ a12~98@) (Add d12~104@ a12~98@)) (Mul (Mul b12~100@ b12~100@) b12~100@)))) (=> (= temp_12_1~2322@ (Mul (Mul (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ d12~104@)) (Mul (Mul c12~102@ b12~100@) (Add c12~102@ a12~98@))) (Mul (Add (Mul (Mul b12~100@ a12~98@) d12~104@) (Mul (Mul b12~100@ a12~98@) a12~98@)) (Mul (Mul b12~100@ b12~100@) b12~100@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2253@ temp_12_1~2322@))) (=> (= temp_12_0~2253@ temp_12_1~2322@) (=> (= temp_13_0~2411@ (Mul (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ a13~106@)) (Add (Mul d13~112@ d13~112@) (Sub a13~106@ a13~106@))) (Mul (Mul (Sub a13~106@ d13~112@) (Sub d13~112@ c13~110@)) (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2476@ (Mul (Mul (Mul (Mul b13~108@ a13~106@) (Mul c13~110@ a13~106@)) (Add (Mul d13~112@ d13~112@) (Sub a13~106@ a13~106@))) (Mul (Mul (Sub a13~106@ d13~112@) (Sub d13~112@ c13~110@)) (Mul (Mul a13~106@ b13~108@) (Mul b13~108@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2411@ temp_13_1~2476@))) (=> (= temp_13_0~2411@ temp_13_1~2476@) (=> (= temp_14_0~2553@ (Mul (Mul (Mul c14~118@ c14~118@) (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ a14~114@))) (Add (Mul c14~118@ (Mul b14~116@ d14~120@)) (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ c14~118@))))) (=> (= temp_14_1~2606@ (Mul (Mul (Mul c14~118@ c14~118@) (Mul (Mul a14~114@ a14~114@) (Mul a14~114@ a14~114@))) (Add (Mul (Mul b14~116@ d14~120@) c14~118@) (Mul (Mul d14~120@ c14~118@) (Mul c14~118@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2553@ temp_14_1~2606@))) (=> (= temp_14_0~2553@ temp_14_1~2606@) (=> (= temp_15_0~2699@ (Mul (Mul (Add (Mul d15~128@ b15~124@) (Mul a15~122@ d15~128@)) (Mul (Mul d15~128@ a15~122@) a15~122@)) (Mul (Mul (Mul b15~124@ a15~122@) (Add d15~128@ c15~126@)) (Add 30 (Sub b15~124@ b15~124@))))) (=> (= temp_15_1~2784@ (Mul (Mul (Add (Mul d15~128@ b15~124@) (Mul a15~122@ d15~128@)) (Mul (Mul d15~128@ a15~122@) a15~122@)) (Add (Mul (Mul (Mul b15~124@ a15~122@) (Add d15~128@ c15~126@)) 30) (Mul (Mul (Mul b15~124@ a15~122@) (Add d15~128@ c15~126@)) (Sub b15~124@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2699@ temp_15_1~2784@))) (=> (= temp_15_0~2699@ temp_15_1~2784@) (=> (= temp_16_0~2885@ (Sub (Mul (Add (Mul a16~130@ b16~132@) (Mul d16~136@ a16~130@)) (Mul (Mul a16~130@ b16~132@) (Mul b16~132@ c16~134@))) (Mul (Mul (Mul 82 d16~136@) (Sub c16~134@ b16~132@)) (Mul (Sub c16~134@ a16~130@) (Sub a16~130@ c16~134@))))) (=> (= temp_16_1~2962@ (Sub (Mul (Add (Mul a16~130@ b16~132@) (Mul d16~136@ a16~130@)) (Mul (Mul a16~130@ b16~132@) (Mul b16~132@ c16~134@))) (Mul (Mul (Sub c16~134@ b16~132@) (Mul 82 d16~136@)) (Mul (Sub c16~134@ a16~130@) (Sub a16~130@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2885@ temp_16_1~2962@))) (=> (= temp_16_0~2885@ temp_16_1~2962@) (=> (= temp_17_0~3051@ (Mul (Mul (Sub (Mul b17~140@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Sub d17~144@ c17~142@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul a17~138@ c17~142@) (Mul d17~144@ c17~142@)) (Add (Mul a17~138@ b17~140@) (Mul c17~142@ a17~138@))))) (=> (= temp_17_1~3116@ (Mul (Mul (Sub (Mul b17~140@ b17~140@) (Mul d17~144@ d17~144@)) (Mul (Sub d17~144@ c17~142@) (Mul b17~140@ b17~140@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul a17~138@ c17~142@)) (Add (Mul a17~138@ b17~140@) (Mul c17~142@ a17~138@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~3051@ temp_17_1~3116@))) (=> (= temp_17_0~3051@ temp_17_1~3116@) (=> (= temp_18_0~3205@ (Mul (Mul (Mul (Mul c18~150@ a18~146@) (Mul b18~148@ c18~150@)) (Mul (Sub d18~152@ b18~148@) (Mul c18~150@ b18~148@))) (Mul (Mul (Mul d18~152@ b18~148@) (Mul b18~148@ a18~146@)) (Sub (Mul c18~150@ d18~152@) (Add a18~146@ d18~152@))))) (=> (= temp_18_1~3270@ (Mul (Mul (Mul (Mul c18~150@ a18~146@) (Mul b18~148@ c18~150@)) (Mul (Sub d18~152@ b18~148@) (Mul c18~150@ b18~148@))) (Mul (Mul d18~152@ b18~148@) (Mul (Mul b18~148@ a18~146@) (Sub (Mul c18~150@ d18~152@) (Add a18~146@ d18~152@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3205@ temp_18_1~3270@))) (=> (= temp_18_0~3205@ temp_18_1~3270@) (=> (= temp_19_0~3359@ (Sub (Add (Mul (Mul a19~154@ d19~160@) (Sub c19~158@ d19~160@)) (Mul (Mul d19~160@ b19~156@) (Mul b19~156@ d19~160@))) (Mul (Mul (Mul a19~154@ a19~154@) (Sub a19~154@ a19~154@)) (Add (Mul a19~154@ b19~156@) (Mul d19~160@ c19~158@))))) (=> (= temp_19_1~3424@ (Sub (Add (Mul (Mul a19~154@ d19~160@) (Sub c19~158@ d19~160@)) (Mul (Mul d19~160@ b19~156@) (Mul b19~156@ d19~160@))) (Mul (Mul a19~154@ (Mul a19~154@ (Sub a19~154@ a19~154@))) (Add (Mul a19~154@ b19~156@) (Mul d19~160@ c19~158@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3359@ temp_19_1~3424@))) (=> (= temp_19_0~3359@ temp_19_1~3424@) (=> (= temp_20_0~3513@ (Mul (Mul (Mul (Add d20~168@ a20~162@) (Mul b20~164@ c20~166@)) (Mul (Mul b20~164@ b20~164@) (Mul a20~162@ d20~168@))) (Mul (Mul (Mul d20~168@ d20~168@) (Mul b20~164@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Mul d20~168@ d20~168@))))) (=> (= temp_20_1~3586@ (Mul (Mul (Add (Mul d20~168@ (Mul b20~164@ c20~166@)) (Mul a20~162@ (Mul b20~164@ c20~166@))) (Mul (Mul b20~164@ b20~164@) (Mul a20~162@ d20~168@))) (Mul (Mul (Mul d20~168@ d20~168@) (Mul b20~164@ c20~166@)) (Mul (Mul b20~164@ a20~162@) (Mul d20~168@ d20~168@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3513@ temp_20_1~3586@))) (=> (= temp_20_0~3513@ temp_20_1~3586@) (=> (= temp_21_0~3655@ (Mul (Mul a21~170@ (Mul (Mul b21~172@ c21~174@) (Mul c21~174@ a21~170@))) (Mul (Mul b21~172@ (Mul c21~174@ a21~170@)) (Mul (Mul a21~170@ a21~170@) c21~174@)))) (=> (= temp_21_1~3700@ (Mul (Mul a21~170@ (Mul (Mul b21~172@ c21~174@) (Mul c21~174@ a21~170@))) (Mul (Mul b21~172@ (Mul c21~174@ a21~170@)) (Mul a21~170@ (Mul a21~170@ c21~174@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3655@ temp_21_1~3700@))) (=> (= temp_21_0~3655@ temp_21_1~3700@) (=> (= temp_22_0~3777@ (Mul (Sub (Mul (Mul c22~182@ a22~178@) (Sub b22~180@ b22~180@)) (Mul (Mul b22~180@ a22~178@) (Mul a22~178@ b22~180@))) (Mul (Mul (Mul b22~180@ c22~182@) (Mul d22~184@ a22~178@)) a22~178@))) (=> (= temp_22_1~3850@ (Sub (Mul (Mul (Mul c22~182@ a22~178@) (Sub b22~180@ b22~180@)) (Mul (Mul (Mul b22~180@ c22~182@) (Mul d22~184@ a22~178@)) a22~178@)) (Mul (Mul (Mul b22~180@ a22~178@) (Mul a22~178@ b22~180@)) (Mul (Mul (Mul b22~180@ c22~182@) (Mul d22~184@ a22~178@)) a22~178@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3777@ temp_22_1~3850@))) (=> (= temp_22_0~3777@ temp_22_1~3850@) (=> (= temp_23_0~3931@ (Mul (Mul (Sub d23~192@ (Add c23~190@ a23~186@)) (Sub (Mul b23~188@ c23~190@) (Sub a23~186@ a23~186@))) (Mul (Mul (Mul a23~186@ a23~186@) a23~186@) (Mul (Mul a23~186@ b23~188@) (Mul c23~190@ d23~192@))))) (=> (= temp_23_1~3988@ (Mul (Mul (Sub d23~192@ (Add c23~190@ a23~186@)) (Sub (Mul c23~190@ b23~188@) (Sub a23~186@ a23~186@))) (Mul (Mul (Mul a23~186@ a23~186@) a23~186@) (Mul (Mul a23~186@ b23~188@) (Mul c23~190@ d23~192@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3931@ temp_23_1~3988@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
