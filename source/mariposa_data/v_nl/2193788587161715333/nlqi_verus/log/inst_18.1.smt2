...
(set-info :comment ";; mariposa_data/v_nl//2193788587161715333/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_6_1~1356@ Int)
...
(declare-const temp_12_0~2231@ Int)
(declare-const temp_12_1~2296@ Int)
(declare-const temp_13_0~2361@ Int)
(declare-const temp_13_1~2398@ Int)
(declare-const temp_14_0~2513@ Int)
(declare-const temp_14_1~2574@ Int)
(declare-const temp_15_0~2679@ Int)
(declare-const temp_15_1~2756@ Int)
(declare-const temp_16_0~2833@ Int)
(declare-const temp_16_1~2882@ Int)
(declare-const temp_17_0~2993@ Int)
(declare-const temp_17_1~3038@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul c0~6@ (Mul (Mul 4 a0~2@) (Mul b0~4@ c0~6@))) (Sub (Add b0~4@ (Mul d0~8@ c0~6@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ d0~8@))))) (=> (= temp_0_1~362@ (Mul (Mul c0~6@ (Mul (Mul 4 a0~2@) (Mul b0~4@ c0~6@))) (Sub (Add b0~4@ (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ a0~2@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~439@ (Mul (Add b1~12@ (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul b1~12@ d1~16@) b1~12@) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~488@ (Mul (Add b1~12@ (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul b1~12@ d1~16@) b1~12@) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ b1~12@) (=> %%location_label%%1 (= temp_1_0~439@ temp_1_1~488@))) (=> (= temp_1_0~439@ temp_1_1~488@) (=> (= temp_2_0~581@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Sub b2~20@ c2~22@) (Mul a2~18@ a2~18@))) (Mul (Mul (Add a2~18@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Add b2~20@ c2~22@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~646@ (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ d2~24@)) (Mul (Sub b2~20@ c2~22@) (Mul a2~18@ a2~18@))) (Mul (Mul (Add a2~18@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Add b2~20@ c2~22@) (Mul c2~22@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ c2~22@) (=> %%location_label%%2 (= temp_2_0~581@ temp_2_1~646@))) (=> (= temp_2_0~581@ temp_2_1~646@) (=> (= temp_3_0~747@ (Sub (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@)) (Mul (Sub b3~28@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Add 98 (Mul d3~32@ b3~28@)) (Mul (Sub b3~28@ c3~30@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~820@ (Sub (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@)) (Mul (Mul b3~28@ d3~32@) (Sub b3~28@ d3~32@))) (Mul (Add 98 (Mul d3~32@ b3~28@)) (Mul (Sub b3~28@ c3~30@) (Mul b3~28@ b3~28@))))) (and (=> (= tmp%1@ (Sub b3~28@ d3~32@)) (=> (= tmp%2@ (Mul b3~28@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%3 (= temp_3_0~747@ temp_3_1~820@))))) (=> (= temp_3_0~747@ temp_3_1~820@) (=> (= temp_4_0~921@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Add (Mul b4~36@ d4~40@) (Add b4~36@ d4~40@))) (Mul (Mul (Mul d4~40@ d4~40@) (Add c4~38@ b4~36@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~986@ (Mul (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Add (Mul b4~36@ d4~40@) (Add b4~36@ d4~40@))) (Mul (Mul (Mul d4~40@ d4~40@) (Add c4~38@ b4~36@)) (Mul (Mul (Mul d4~40@ a4~34@) b4~36@) d4~40@)))) (and (=> (= tmp%3@ (Mul d4~40@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ b4~36@ d4~40@) (=> %%location_label%%4 (= temp_4_0~921@ temp_4_1~986@)))) (=> (= temp_4_0~921@ temp_4_1~986@) (=> (= temp_5_0~1085@ (Mul (Mul (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Add a5~42@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1150@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ c5~46@))) (Mul (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Add a5~42@ d5~48@) (Mul c5~46@ c5~46@))))) (and (=> (= tmp%4@ (Mul (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Add a5~42@ d5~48@) (Mul c5~46@ c5~46@)))) (=> (= tmp%5@ (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ c5~46@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%5 (= temp_5_0~1085@ temp_5_1~1150@))))) (=> (= temp_5_0~1085@ temp_5_1~1150@) (=> (= temp_6_0~1295@ (Mul (Mul (Mul c6~54@ (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@)) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1356@ (Mul (Mul (Mul c6~54@ (Mul a6~50@ d6~56@)) (Mul (Mul (Mul b6~52@ d6~56@) b6~52@) d6~56@)) (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@)) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ a6~50@))))) (and (=> (= tmp%6@ (Mul b6~52@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ b6~52@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1295@ temp_6_1~1356@)))) (=> (= temp_6_0~1295@ temp_6_1~1356@) (=> (= temp_7_0~1463@ (Mul (Mul (Sub (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@)) (Mul d7~64@ (Mul c7~62@ 77))) (Mul (Add (Add c7~62@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@))))) (=> (= temp_7_1~1536@ (Mul (Mul (Sub (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@)) (Mul d7~64@ (Mul c7~62@ 77))) (Mul (Add (Add c7~62@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ c7~62@) (=> %%location_label%%7 (= temp_7_0~1463@ temp_7_1~1536@))) (=> (= temp_7_0~1463@ temp_7_1~1536@) (=> (= temp_8_0~1625@ (Mul (Add (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ d8~72@)) (Mul (Sub d8~72@ c8~70@) (Mul d8~72@ b8~68@))) (Mul (Mul c8~70@ (Mul d8~72@ b8~68@)) (Sub (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1686@ (Mul (Add (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ d8~72@)) (Mul (Sub d8~72@ c8~70@) (Mul d8~72@ b8~68@))) (Mul (Sub (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@)) (Mul c8~70@ (Mul d8~72@ b8~68@))))) (and (=> (= tmp%7@ (Mul c8~70@ (Mul d8~72@ b8~68@))) (=> (= tmp%8@ (Sub (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%8 (= temp_8_0~1625@ temp_8_1~1686@))))) (=> (= temp_8_0~1625@ temp_8_1~1686@) (=> (= temp_9_0~1779@ (Mul (Sub (Mul (Mul d9~80@ b9~76@) (Add d9~80@ d9~80@)) (Sub d9~80@ (Mul d9~80@ c9~78@))) (Sub (Mul d9~80@ (Mul d9~80@ d9~80@)) b9~76@))) (=> (= temp_9_1~1832@ (Mul (Sub (Add (Mul (Mul d9~80@ b9~76@) d9~80@) (Mul (Mul d9~80@ b9~76@) d9~80@)) (Sub d9~80@ (Mul d9~80@ c9~78@))) (Sub (Mul d9~80@ (Mul d9~80@ d9~80@)) b9~76@))) (and (=> (= tmp%9@ (Mul d9~80@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ d9~80@ d9~80@) (=> %%location_label%%9 (= temp_9_0~1779@ temp_9_1~1832@)))) (=> (= temp_9_0~1779@ temp_9_1~1832@) (=> (= temp_10_0~1927@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) b10~84@) (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ b10~84@)) (Add (Mul b10~84@ c10~86@) (Sub a10~82@ c10~86@))))) (=> (= temp_10_1~1988@ (Mul (Mul (Mul (Mul b10~84@ b10~84@) b10~84@) (Mul (Mul b10~84@ a10~82@) (Mul a10~82@ b10~84@))) (Mul (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ b10~84@)) (Add (Mul b10~84@ c10~86@) (Sub a10~82@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b10~84@ b10~84@) (=> %%location_label%%10 (= temp_10_0~1927@ temp_10_1~1988@))) (=> (= temp_10_0~1927@ temp_10_1~1988@) (=> (= temp_11_0~2077@ (Mul (Sub a11~90@ (Mul (Mul b11~92@ c11~94@) (Mul c11~94@ b11~92@))) (Mul (Mul (Mul c11~94@ d11~96@) d11~96@) (Add (Add 48 a11~90@) (Sub c11~94@ a11~90@))))) (=> (= temp_11_1~2138@ (Mul (Sub a11~90@ (Mul (Mul b11~92@ c11~94@) (Mul b11~92@ c11~94@))) (Mul (Mul (Mul c11~94@ d11~96@) d11~96@) (Add (Add 48 a11~90@) (Sub c11~94@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c11~94@ b11~92@) (=> %%location_label%%11 (= temp_11_0~2077@ temp_11_1~2138@))) (=> (= temp_11_0~2077@ temp_11_1~2138@) (=> (= temp_12_0~2231@ (Mul (Mul (Add (Mul c12~102@ c12~102@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ a12~98@) (Mul c12~102@ d12~104@))) (Sub (Mul (Mul a12~98@ b12~100@) (Mul b12~100@ d12~104@)) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2296@ (Mul (Mul (Add (Mul c12~102@ c12~102@) (Mul d12~104@ a12~98@)) (Mul (Mul a12~98@ d12~104@) (Mul c12~102@ d12~104@))) (Sub (Mul (Mul a12~98@ b12~100@) (Mul b12~100@ d12~104@)) (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d12~104@ a12~98@) (=> %%location_label%%12 (= temp_12_0~2231@ temp_12_1~2296@))) (=> (= temp_12_0~2231@ temp_12_1~2296@) (=> (= temp_13_0~2361@ (Mul a13~106@ (Mul (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ d13~112@)) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@))))) (=> (= temp_13_1~2398@ (Mul (Mul a13~106@ (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ d13~112@))) (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@)))) (and (=> (= tmp%10@ (Mul (Mul c13~110@ a13~106@) (Mul b13~108@ d13~112@))) (=> (= tmp%11@ (Mul (Mul b13~108@ c13~110@) (Mul b13~108@ b13~108@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. a13~106@ tmp%10@ tmp%11@) (=> %%location_label%%13 (= temp_13_0~2361@ temp_13_1~2398@))))) (=> (= temp_13_0~2361@ temp_13_1~2398@) (=> (= temp_14_0~2513@ (Mul (Mul (Mul c14~118@ (Mul a14~114@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Mul d14~120@ c14~118@))) (Mul (Add (Mul d14~120@ a14~114@) (Mul b14~116@ d14~120@)) (Mul (Mul c14~118@ c14~118@) (Mul a14~114@ d14~120@))))) (=> (= temp_14_1~2574@ (Mul (Mul (Mul c14~118@ (Mul a14~114@ b14~116@)) (Mul (Mul a14~114@ b14~116@) (Mul d14~120@ c14~118@))) (Mul (Add (Mul d14~120@ a14~114@) (Mul d14~120@ b14~116@)) (Mul (Mul c14~118@ c14~118@) (Mul a14~114@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b14~116@ d14~120@) (=> %%location_label%%14 (= temp_14_0~2513@ temp_14_1~2574@))) (=> (= temp_14_0~2513@ temp_14_1~2574@) (=> (= temp_15_0~2679@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ c15~126@)) (Sub (Mul b15~124@ a15~122@) (Mul a15~122@ d15~128@))) (Sub (Add (Add c15~126@ b15~124@) (Mul a15~122@ 15)) (Mul (Add b15~124@ b15~124@) (Mul b15~124@ a15~122@))))) (=> (= temp_15_1~2756@ (Mul (Mul (Mul (Mul b15~124@ b15~124@) (Mul c15~126@ c15~126@)) (Sub (Mul b15~124@ a15~122@) (Mul a15~122@ d15~128@))) (Sub (Add (Add c15~126@ b15~124@) (Mul a15~122@ 15)) (Mul (Add b15~124@ b15~124@) (Mul b15~124@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b15~124@ b15~124@) (=> %%location_label%%15 (= temp_15_0~2679@ temp_15_1~2756@))) (=> (= temp_15_0~2679@ temp_15_1~2756@) (=> (= temp_16_0~2833@ (Mul (Mul (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ d16~136@)) (Sub (Mul a16~130@ a16~130@) (Mul d16~136@ a16~130@))) (Sub (Mul a16~130@ (Mul a16~130@ b16~132@)) b16~132@))) (=> (= temp_16_1~2882@ (Mul (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ d16~136@)) (Mul (Sub (Mul a16~130@ a16~130@) (Mul d16~136@ a16~130@)) (Sub (Mul a16~130@ (Mul a16~130@ b16~132@)) b16~132@)))) (and (=> (= tmp%12@ (Mul (Mul b16~132@ a16~130@) (Mul b16~132@ d16~136@))) (=> (= tmp%13@ (Sub (Mul a16~130@ a16~130@) (Mul d16~136@ a16~130@))) (=> (= tmp%14@ (Sub (Mul a16~130@ (Mul a16~130@ b16~132@)) b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%12@ tmp%13@ tmp%14@) (=> %%location_label%%16 (= temp_16_0~2833@ temp_16_1~2882@)))))) (=> (= temp_16_0~2833@ temp_16_1~2882@) (=> (= temp_17_0~2993@ (Mul (Mul (Mul (Mul a17~138@ a17~138@) (Mul d17~144@ b17~140@)) a17~138@) (Mul (Mul b17~140@ 93) d17~144@))) (=> (= temp_17_1~3038@ (Mul (Mul (Mul a17~138@ (Mul a17~138@ (Mul d17~144@ b17~140@))) a17~138@) (Mul (Mul b17~140@ 93) d17~144@))) (=> (= tmp%15@ (Mul d17~144@ b17~140@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a17~138@ a17~138@ tmp%15@) (=> %%location_label%%17 (= temp_17_0~2993@ temp_17_1~3038@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
