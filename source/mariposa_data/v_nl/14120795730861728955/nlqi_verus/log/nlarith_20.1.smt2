...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Add (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Sub a0~2@ d0~8@) (Mul a0~2@ a0~2@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Add c0~6@ a0~2@) (Sub d0~8@ b0~4@))))) (=> (= temp_0_1~370@ (Mul (Mul (Add (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Sub a0~2@ d0~8@) (Mul a0~2@ a0~2@))) (Mul (Mul (Add c0~6@ a0~2@) (Sub d0~8@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~450@ (Mul (Mul (Mul (Add b1~12@ c1~14@) (Add a1~10@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Mul (Mul d1~16@ d1~16@) (Add a1~10@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Sub c1~14@ b1~12@))))) (=> (= temp_1_1~515@ (Mul (Mul (Mul (Add b1~12@ c1~14@) (Add a1~10@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Mul d1~16@ (Mul d1~16@ (Add a1~10@ d1~16@))) (Mul (Mul b1~12@ a1~10@) (Sub c1~14@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~450@ temp_1_1~515@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~607@ (Mul (Mul (Add (Mul b2~20@ c2~22@) (Sub c2~22@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ c2~22@))) (Mul (Add (Mul a2~18@ d2~24@) (Mul d2~24@ d2~24@)) (Add (Mul d2~24@ d2~24@) (Mul d2~24@ 25))))) (=> (= temp_2_1~684@ (Mul (Mul (Add (Mul b2~20@ c2~22@) (Sub c2~22@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ b2~20@))) (Mul (Add (Mul a2~18@ d2~24@) (Mul d2~24@ d2~24@)) (Add (Mul d2~24@ d2~24@) (Mul d2~24@ 25))))) (=> (= tmp%3@ (= temp_2_0~607@ temp_2_1~684@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~764@ (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Sub d3~32@ a3~26@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Add b3~28@ c3~30@) (Mul a3~26@ a3~26@))))) (=> (= temp_3_1~837@ (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ d3~32@)) (Sub (Mul (Mul d3~32@ c3~30@) d3~32@) (Mul (Mul d3~32@ c3~30@) a3~26@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Add b3~28@ c3~30@) (Mul a3~26@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~764@ temp_3_1~837@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~901@ (Mul (Add (Mul a4~34@ a4~34@) (Mul b4~36@ (Mul b4~36@ b4~36@))) (Mul (Mul (Add b4~36@ b4~36@) a4~34@) (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~950@ (Mul (Add (Mul a4~34@ a4~34@) (Mul b4~36@ (Mul b4~36@ b4~36@))) (Mul (Mul (Add b4~36@ b4~36@) a4~34@) (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~901@ temp_4_1~950@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1030@ (Add (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@)) (Mul (Sub d5~48@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1095@ (Add (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ c5~46@)) (Mul (Sub d5~48@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~1030@ temp_5_1~1095@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1171@ (Add (Mul (Add (Mul c6~54@ a6~50@) (Add a6~50@ b6~52@)) (Mul c6~54@ (Mul a6~50@ d6~56@))) (Mul (Mul (Add a6~50@ b6~52@) (Add b6~52@ d6~56@)) (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1232@ (Add (Mul (Add (Mul c6~54@ a6~50@) (Add a6~50@ b6~52@)) (Mul c6~54@ (Mul a6~50@ d6~56@))) (Mul (Mul (Add b6~52@ d6~56@) (Add a6~50@ b6~52@)) (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1171@ temp_6_1~1232@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1312@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Add d7~64@ d7~64@) (Mul b7~60@ d7~64@))) (Mul (Sub (Mul b7~60@ b7~60@) (Add a7~58@ b7~60@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1377@ (Mul (Mul (Mul (Add d7~64@ d7~64@) (Mul b7~60@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ d7~64@))) (Mul (Sub (Mul b7~60@ b7~60@) (Add a7~58@ b7~60@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1312@ temp_7_1~1377@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1453@ (Mul (Mul (Mul (Sub b8~68@ a8~66@) (Mul d8~72@ c8~70@)) (Sub (Mul b8~68@ c8~70@) (Mul d8~72@ d8~72@))) (Mul (Mul c8~70@ (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1514@ (Mul (Mul (Sub (Mul b8~68@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Sub b8~68@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Mul c8~70@ (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1453@ temp_8_1~1514@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1594@ (Sub (Mul (Sub (Mul c9~78@ a9~74@) (Sub c9~78@ d9~80@)) (Mul (Mul c9~78@ c9~78@) (Mul c9~78@ c9~78@))) (Sub (Add (Mul b9~76@ a9~74@) (Sub a9~74@ d9~80@)) (Mul (Mul c9~78@ c9~78@) (Mul d9~80@ a9~74@))))) (=> (= temp_9_1~1659@ (Sub (Mul (Sub (Mul c9~78@ a9~74@) (Sub c9~78@ d9~80@)) (Mul (Mul c9~78@ c9~78@) (Mul c9~78@ c9~78@))) (Sub (Add (Mul b9~76@ a9~74@) (Sub a9~74@ d9~80@)) (Mul c9~78@ (Mul c9~78@ (Mul d9~80@ a9~74@)))))) (=> (= tmp%10@ (= temp_9_0~1594@ temp_9_1~1659@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1739@ (Mul (Mul d10~88@ (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ d10~88@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul b10~84@ a10~82@) (Mul 22 a10~82@))))) (=> (= temp_10_1~1804@ (Mul (Mul d10~88@ (Mul (Mul d10~88@ c10~86@) (Mul d10~88@ d10~88@))) (Mul (Mul (Mul c10~86@ b10~84@) (Mul d10~88@ d10~88@)) (Mul (Mul (Mul b10~84@ a10~82@) 22) a10~82@)))) (=> (= tmp%11@ (= temp_10_0~1739@ temp_10_1~1804@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1896@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Mul 80 c11~94@)) (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ a11~90@))) (Mul (Mul (Add c11~94@ c11~94@) (Add d11~96@ b11~92@)) (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ b11~92@))))) (=> (= temp_11_1~1973@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Mul 80 c11~94@)) (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ a11~90@))) (Mul (Mul (Add c11~94@ c11~94@) (Add d11~96@ b11~92@)) (Mul c11~94@ (Mul a11~90@ (Mul c11~94@ b11~92@)))))) (=> (= tmp%12@ (= temp_11_0~1896@ temp_11_1~1973@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2053@ (Add (Add (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ a12~98@)) (Add (Mul d12~104@ a12~98@) (Mul a12~98@ a12~98@))) (Mul (Mul (Mul b12~100@ b12~100@) (Mul a12~98@ b12~100@)) (Sub (Mul d12~104@ a12~98@) (Mul a12~98@ d12~104@))))) (=> (= temp_12_1~2118@ (Add (Add (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ a12~98@)) (Add (Mul d12~104@ a12~98@) (Mul a12~98@ a12~98@))) (Mul (Sub (Mul d12~104@ a12~98@) (Mul a12~98@ d12~104@)) (Mul (Mul b12~100@ b12~100@) (Mul a12~98@ b12~100@))))) (=> (= tmp%13@ (= temp_12_0~2053@ temp_12_1~2118@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2190@ (Mul (Sub (Mul (Mul d13~112@ a13~106@) (Sub b13~108@ b13~108@)) (Add (Mul b13~108@ b13~108@) (Sub d13~112@ a13~106@))) (Mul (Mul (Mul b13~108@ c13~110@) (Mul a13~106@ b13~108@)) (Mul a13~106@ a13~106@)))) (=> (= temp_13_1~2247@ (Mul (Sub (Mul (Mul d13~112@ a13~106@) (Sub b13~108@ b13~108@)) (Add (Mul b13~108@ b13~108@) (Sub d13~112@ a13~106@))) (Mul (Mul (Mul (Mul b13~108@ c13~110@) a13~106@) b13~108@) (Mul a13~106@ a13~106@)))) (=> (= tmp%14@ (= temp_13_0~2190@ temp_13_1~2247@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2307@ (Sub (Mul (Mul (Mul c14~118@ a14~114@) (Mul c14~118@ d14~120@)) (Mul (Sub a14~114@ a14~114@) a14~114@)) 69)) (=> (= temp_14_1~2352@ (Sub (Mul (Mul (Mul c14~118@ d14~120@) (Mul c14~118@ a14~114@)) (Mul (Sub a14~114@ a14~114@) a14~114@)) 69)) (=> (= tmp%15@ (= temp_14_0~2307@ temp_14_1~2352@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2456@ (Mul (Sub (Sub (Add 71 c15~126@) (Mul c15~126@ b15~124@)) (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ c15~126@))) (Mul (Mul (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@)) (Mul (Mul a15~122@ 42) (Mul a15~122@ d15~128@))))) (=> (= temp_15_1~2545@ (Mul (Mul (Mul (Mul c15~126@ b15~124@) (Mul c15~126@ c15~126@)) (Mul (Mul a15~122@ 42) (Mul a15~122@ d15~128@))) (Sub (Sub (Add 71 c15~126@) (Mul c15~126@ b15~124@)) (Mul (Mul a15~122@ c15~126@) (Mul d15~128@ c15~126@))))) (=> (= tmp%16@ (= temp_15_0~2456@ temp_15_1~2545@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2625@ (Mul (Mul (Add (Mul d16~136@ b16~132@) (Mul c16~134@ b16~132@)) (Add (Mul d16~136@ c16~134@) (Add d16~136@ c16~134@))) (Mul (Mul (Mul b16~132@ c16~134@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ a16~130@) (Sub d16~136@ a16~130@))))) (=> (= temp_16_1~2690@ (Mul (Mul (Add (Mul d16~136@ b16~132@) (Mul c16~134@ b16~132@)) (Add (Mul d16~136@ c16~134@) (Add d16~136@ c16~134@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul a16~130@ a16~130@)) (Mul (Mul b16~132@ a16~130@) (Sub d16~136@ a16~130@))))) (=> (= tmp%17@ (= temp_16_0~2625@ temp_16_1~2690@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2754@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ a17~138@)) (Mul (Mul d17~144@ c17~142@) (Add d17~144@ b17~140@))) (Mul c17~142@ (Mul (Mul a17~138@ d17~144@) c17~142@)))) (=> (= temp_17_1~2803@ (Mul (Mul (Mul (Mul d17~144@ b17~140@) (Mul d17~144@ a17~138@)) (Mul d17~144@ (Mul c17~142@ (Add d17~144@ b17~140@)))) (Mul c17~142@ (Mul (Mul a17~138@ d17~144@) c17~142@)))) (=> (= tmp%18@ (= temp_17_0~2754@ temp_17_1~2803@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2891@ (Add (Mul (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ b18~148@)) (Mul (Mul c18~150@ c18~150@) (Sub b18~148@ b18~148@))) (Mul (Mul d18~152@ (Mul c18~150@ c18~150@)) (Mul (Mul 31 d18~152@) (Mul c18~150@ d18~152@))))) (=> (= temp_18_1~2964@ (Add (Mul (Mul (Mul d18~152@ c18~150@) (Mul a18~146@ b18~148@)) (Mul (Mul c18~150@ c18~150@) (Sub b18~148@ b18~148@))) (Mul (Mul (Mul c18~150@ c18~150@) d18~152@) (Mul (Mul 31 d18~152@) (Mul c18~150@ d18~152@))))) (=> (= tmp%19@ (= temp_18_0~2891@ temp_18_1~2964@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3044@ (Mul (Mul (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Sub a19~154@ d19~160@) (Mul b19~156@ 78))) (Sub (Mul (Mul c19~158@ a19~154@) (Mul a19~154@ a19~154@)) d19~160@))) (=> (= temp_19_1~3109@ (Mul (Sub (Mul (Mul c19~158@ a19~154@) (Mul a19~154@ a19~154@)) d19~160@) (Mul (Mul (Mul c19~158@ c19~158@) (Mul d19~160@ a19~154@)) (Mul (Sub a19~154@ d19~160@) (Mul b19~156@ 78))))) (=> (= tmp%20@ (= temp_19_0~3044@ temp_19_1~3109@)) (=> %%location_label%%19 tmp%20@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
