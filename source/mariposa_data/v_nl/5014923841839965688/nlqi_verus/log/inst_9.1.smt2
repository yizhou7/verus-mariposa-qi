...
(set-info :comment ";; mariposa_data/v_nl//5014923841839965688/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ d0~8@))) (Mul (Mul (Sub a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Mul c0~6@ c0~6@) (Sub b0~4@ d0~8@)))) (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@))) (Add c0~6@ (Mul d0~8@ (Mul c0~6@ b0~4@)))))) (=> (= temp_0_1~386@ (Mul (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ d0~8@))) (Mul (Mul (Sub a0~2@ c0~6@) (Mul b0~4@ c0~6@)) (Mul (Mul c0~6@ c0~6@) (Sub b0~4@ d0~8@)))) (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@))) (Add c0~6@ (Mul (Mul c0~6@ b0~4@) d0~8@))))) (and (=> (= tmp%1@ (Mul c0~6@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~386@)))) (=> (= temp_0_0~273@ temp_0_1~386@) (=> (= temp_1_0~531@ (Mul (Sub (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Sub (Mul d1~16@ c1~14@) (Mul d1~16@ d1~16@)))) (Sub (Mul (Mul (Add b1~12@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Mul 31 d1~16@) (Mul c1~14@ d1~16@))) b1~12@))) (=> (= temp_1_1~640@ (Mul (Sub (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) (Mul d1~16@ (Sub c1~14@ d1~16@)))) (Sub (Mul (Mul (Add b1~12@ c1~14@) (Mul d1~16@ b1~12@)) (Mul (Mul 31 d1~16@) (Mul c1~14@ d1~16@))) b1~12@))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d1~16@ c1~14@ d1~16@) (=> %%location_label%%1 (= temp_1_0~531@ temp_1_1~640@))) (=> (= temp_1_0~531@ temp_1_1~640@) (=> (= temp_2_0~779@ (Mul (Mul b2~20@ (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ 5) (Mul c2~22@ b2~20@)))) (Mul (Add (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ a2~18@)) (Mul (Mul a2~18@ b2~20@) d2~24@)) (Mul (Add (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@)) (Mul (Add c2~22@ c2~22@) (Mul d2~24@ c2~22@)))))) (=> (= temp_2_1~888@ (Mul (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ 5) (Mul c2~22@ b2~20@))) b2~20@) (Mul (Add (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ a2~18@)) (Mul (Mul a2~18@ b2~20@) d2~24@)) (Mul (Add (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@)) (Mul (Add c2~22@ c2~22@) (Mul d2~24@ c2~22@)))))) (and (=> (= tmp%2@ (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ 5) (Mul c2~22@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~779@ temp_2_1~888@)))) (=> (= temp_2_0~779@ temp_2_1~888@) (=> (= temp_3_0~1077@ (Add (Mul (Mul (Mul b3~28@ (Mul c3~30@ 21)) (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ c3~30@))) (Mul (Mul a3~26@ (Mul d3~32@ b3~28@)) (Mul (Sub a3~26@ c3~30@) (Mul c3~30@ b3~28@)))) (Mul (Mul d3~32@ (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ b3~28@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@)))))) (=> (= temp_3_1~1198@ (Add (Mul (Mul (Mul b3~28@ (Mul c3~30@ 21)) (Mul (Sub a3~26@ b3~28@) (Mul a3~26@ c3~30@))) (Mul (Mul a3~26@ (Mul d3~32@ b3~28@)) (Mul (Mul c3~30@ b3~28@) (Sub a3~26@ c3~30@)))) (Mul (Mul d3~32@ (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ b3~28@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@)))))) (and (=> (= tmp%3@ (Sub a3~26@ c3~30@)) (=> (= tmp%4@ (Mul c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~1077@ temp_3_1~1198@))))) (=> (= temp_3_0~1077@ temp_3_1~1198@) (=> (= temp_4_0~1355@ (Mul (Mul (Mul (Mul (Mul c4~38@ c4~38@) c4~38@) (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@)) (Mul a4~34@ (Mul a4~34@ c4~38@)))) (Mul (Mul (Mul (Add b4~36@ d4~40@) (Sub b4~36@ b4~36@)) (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul d4~40@ c4~38@) (Add a4~34@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ d4~40@)))))) (=> (= temp_4_1~1476@ (Mul (Mul (Mul (Mul (Mul c4~38@ c4~38@) c4~38@) (Mul d4~40@ (Mul d4~40@ (Mul a4~34@ b4~36@)))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@)) (Mul a4~34@ (Mul a4~34@ c4~38@)))) (Mul (Mul (Mul (Add b4~36@ d4~40@) (Sub b4~36@ b4~36@)) (Mul (Mul d4~40@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul d4~40@ c4~38@) (Add a4~34@ b4~36@)) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ d4~40@)))))) (and (=> (= tmp%5@ (Mul a4~34@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d4~40@ d4~40@ tmp%5@) (=> %%location_label%%4 (= temp_4_0~1355@ temp_4_1~1476@)))) (=> (= temp_4_0~1355@ temp_4_1~1476@) (=> (= temp_5_0~1615@ (Sub (Mul (Mul c5~46@ (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@))) (Mul d5~48@ (Add (Mul d5~48@ a5~42@) (Sub b5~44@ b5~44@)))) (Mul (Mul (Mul (Add c5~46@ a5~42@) (Sub c5~46@ c5~46@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ b5~44@))) (Mul (Mul (Sub c5~46@ b5~44@) (Add b5~44@ a5~42@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@)))))) (=> (= temp_5_1~1724@ (Sub (Mul (Mul c5~46@ (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@))) (Add (Mul d5~48@ (Mul d5~48@ a5~42@)) (Mul d5~48@ (Sub b5~44@ b5~44@)))) (Mul (Mul (Mul (Add c5~46@ a5~42@) (Sub c5~46@ c5~46@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ b5~44@))) (Mul (Mul (Sub c5~46@ b5~44@) (Add b5~44@ a5~42@)) (Sub (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@)))))) (and (=> (= tmp%6@ (Mul d5~48@ a5~42@)) (=> (= tmp%7@ (Sub b5~44@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d5~48@ tmp%6@ tmp%7@) (=> %%location_label%%5 (= temp_5_0~1615@ temp_5_1~1724@))))) (=> (= temp_5_0~1615@ temp_5_1~1724@) (=> (= temp_6_0~1847@ (Mul (Sub (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)) (Mul a6~50@ (Mul b6~52@ c6~54@))) (Mul c6~54@ a6~50@)) (Mul (Mul (Sub (Mul d6~56@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul d6~56@ a6~50@) (Add c6~54@ a6~50@))) (Mul c6~54@ (Mul (Mul a6~50@ c6~54@) c6~54@))))) (=> (= temp_6_1~1932@ (Mul (Sub (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul b6~52@ c6~54@) a6~50@)) (Mul c6~54@ a6~50@)) (Mul (Mul (Sub (Mul d6~56@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul d6~56@ a6~50@) (Add c6~54@ a6~50@))) (Mul c6~54@ (Mul (Mul a6~50@ c6~54@) c6~54@))))) (and (=> (= tmp%8@ (Mul b6~52@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~1847@ temp_6_1~1932@)))) (=> (= temp_6_0~1847@ temp_6_1~1932@) (=> (= temp_7_0~2081@ (Mul (Mul (Mul (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Add c7~62@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ d7~64@)) (Add (Sub d7~64@ c7~62@) (Mul c7~62@ d7~64@)))) (Mul (Mul a7~58@ (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ a7~58@))) (Add (Mul (Mul b7~60@ d7~64@) (Mul d7~64@ d7~64@)) (Mul (Sub b7~60@ a7~58@) (Mul c7~62@ d7~64@)))))) (=> (= temp_7_1~2198@ (Mul (Mul (Mul (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Add c7~62@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ d7~64@)) (Add (Sub d7~64@ c7~62@) (Mul c7~62@ d7~64@)))) (Mul (Mul a7~58@ (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ a7~58@))) (Add (Mul (Mul b7~60@ d7~64@) (Mul d7~64@ d7~64@)) (Mul (Sub b7~60@ a7~58@) (Mul d7~64@ c7~62@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ d7~64@) (=> %%location_label%%7 (= temp_7_0~2081@ temp_7_1~2198@))) (=> (= temp_7_0~2081@ temp_7_1~2198@) (=> (= temp_8_0~2355@ (Mul (Mul (Add (Sub (Mul a8~66@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ c8~70@))) (Mul (Sub (Mul b8~68@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Sub c8~70@ b8~68@) (Mul a8~66@ b8~68@)))) (Mul (Mul (Add (Mul d8~72@ d8~72@) (Mul b8~68@ 51)) (Mul (Mul a8~66@ d8~72@) a8~66@)) (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@)) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~2484@ (Mul (Mul (Add (Sub (Mul a8~66@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul (Mul c8~70@ d8~72@) a8~66@) c8~70@)) (Mul (Sub (Mul b8~68@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Sub c8~70@ b8~68@) (Mul a8~66@ b8~68@)))) (Mul (Mul (Add (Mul d8~72@ d8~72@) (Mul b8~68@ 51)) (Mul (Mul a8~66@ d8~72@) a8~66@)) (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@)) (Mul a8~66@ d8~72@))))) (=> (= tmp%9@ (Mul c8~70@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ a8~66@ c8~70@) (=> %%location_label%%8 (= temp_8_0~2355@ temp_8_1~2484@)))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
