...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Sub (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))) a0~2@)) (=> (= temp_0_1~314@ (Sub (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))) a0~2@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~277@ temp_0_1~314@))) (=> (= temp_0_0~277@ temp_0_1~314@) (=> (= temp_1_0~399@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Sub c1~14@ (Mul d1~16@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ b1~12@))))) (=> (= temp_1_1~460@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Mul (Sub c1~14@ (Mul d1~16@ a1~10@)) (Mul d1~16@ a1~10@)) (Mul a1~10@ b1~12@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~399@ temp_1_1~460@))) (=> (= temp_1_0~399@ temp_1_1~460@) (=> (= temp_2_0~553@ (Mul (Add (Mul (Mul a2~18@ b2~20@) (Add c2~22@ d2~24@)) (Add (Sub a2~18@ c2~22@) c2~22@)) (Mul (Mul (Mul d2~24@ 10) (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ c2~22@) a2~18@)))) (=> (= temp_2_1~622@ (Mul (Add (Mul (Mul a2~18@ b2~20@) (Add c2~22@ d2~24@)) (Add (Sub a2~18@ c2~22@) c2~22@)) (Mul (Mul d2~24@ 10) (Mul (Mul d2~24@ a2~18@) (Mul (Mul c2~22@ c2~22@) a2~18@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~553@ temp_2_1~622@))))))))))))))))
(assert %%query%%)
(check-sat)
