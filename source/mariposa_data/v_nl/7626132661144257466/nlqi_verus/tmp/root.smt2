...
(push)
 ...
 (declare-const temp_2_1~604@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
      ...
      (=>
       ...
       (and
        ...
        (=>
         tmp%1@
         (=>
          (= temp_1_0~390@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@
               c1~14@
              ) (Mul a1~10@ a1~10@)
             )
          ...
          (=>
           (= temp_1_1~451@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@
                c1~14@
               ) (Mul a1~10@ a1~10@)
              )
           ...
           (=>
            ...
            (and
             ...
             (=>
              tmp%2@
              (=>
               (= temp_2_0~535@ (Mul (Add (Mul (Mul a2~18@ b2~20@) (Add c2~22@ d2~24@)) (Add (Sub a2~18@
                    c2~22@
                   ) c2~22@
                  )
               ...
               (=>
                (= temp_2_1~604@ (Mul (Add (Mul (Mul a2~18@ b2~20@) (Add c2~22@ d2~24@)) (Add (Sub a2~18@
                     c2~22@
                    ) c2~22@
                   )
                ...
                (=>
                 (= tmp%3@ (= temp_2_0~535@ temp_2_1~604@))
                 (=>
                  %%location_label%%2
                  tmp%3@
 )))))))))))))))))
