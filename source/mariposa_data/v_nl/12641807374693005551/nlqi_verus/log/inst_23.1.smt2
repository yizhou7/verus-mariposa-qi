...
(set-info :comment ";; mariposa_data/v_nl//12641807374693005551/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_2_1~754@ Int)
...
(declare-const temp_6_1~1332@ Int)
...
(declare-const temp_13_0~2445@ Int)
(declare-const temp_13_1~2510@ Int)
(declare-const temp_14_0~2615@ Int)
(declare-const temp_14_1~2692@ Int)
(declare-const temp_15_0~2805@ Int)
(declare-const temp_15_1~2878@ Int)
(declare-const temp_16_0~2977@ Int)
(declare-const temp_16_1~3042@ Int)
(declare-const temp_17_0~3203@ Int)
(declare-const temp_17_1~3280@ Int)
(declare-const temp_18_0~3381@ Int)
(declare-const temp_18_1~3446@ Int)
(declare-const temp_19_0~3545@ Int)
(declare-const temp_19_1~3610@ Int)
(declare-const temp_20_0~3703@ Int)
(declare-const temp_20_1~3768@ Int)
(declare-const temp_21_0~3861@ Int)
(declare-const temp_21_1~3926@ Int)
(declare-const temp_22_0~4033@ Int)
(declare-const temp_22_1~4106@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Add (Mul (Mul b0~4@ c0~6@) (Add b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) c0~6@)) (Mul (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ 30)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~386@ (Mul (Add (Mul (Mul b0~4@ c0~6@) (Add b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) c0~6@)) (Mul (Mul (Mul b0~4@ 30) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ d0~8@))))) (and (=> (= tmp%1@ (Mul b0~4@ c0~6@)) (=> (= tmp%2@ (Mul b0~4@ 30)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~386@))))) (=> (= temp_0_0~313@ temp_0_1~386@) (=> (= temp_1_0~499@ (Mul (Sub (Mul (Sub b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Sub d1~16@ b1~12@))) (Add (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~564@ (Mul (Sub (Mul (Mul d1~16@ b1~12@) (Sub b1~12@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Sub d1~16@ b1~12@))) (Add (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ d1~16@))))) (and (=> (= tmp%3@ (Sub b1~12@ b1~12@)) (=> (= tmp%4@ (Mul d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~499@ temp_1_1~564@))))) (=> (= temp_1_0~499@ temp_1_1~564@) (=> (= temp_2_0~677@ (Add (Mul (Add (Mul b2~20@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul 19 d2~24@))) (Add (Mul (Mul d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~754@ (Add (Mul (Add (Mul b2~20@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul 19 d2~24@))) (Add (Mul (Mul d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ b2~20@) (=> %%location_label%%2 (= temp_2_0~677@ temp_2_1~754@))) (=> (= temp_2_0~677@ temp_2_1~754@) (=> (= temp_3_0~839@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (Mul (Mul c3~30@ (Add a3~26@ d3~32@)) (Mul c3~30@ (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~896@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (Mul (Mul (Add a3~26@ d3~32@) c3~30@) (Mul c3~30@ (Mul c3~30@ b3~28@))))) (and (=> (= tmp%5@ (Add a3~26@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~839@ temp_3_1~896@)))) (=> (= temp_3_0~839@ temp_3_1~896@) (=> (= temp_4_0~981@ (Mul (Mul (Sub (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) b4~36@) (Mul (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Sub a4~34@ a4~34@))))) (=> (= temp_4_1~1034@ (Mul (Mul (Sub (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) b4~36@) (Mul (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Sub a4~34@ a4~34@))))) (and (=> (= tmp%6@ (Mul a4~34@ b4~36@)) (=> (= tmp%7@ (Mul c4~38@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%4 (= temp_4_0~981@ temp_4_1~1034@))))) (=> (= temp_4_0~981@ temp_4_1~1034@) (=> (= temp_5_0~1135@ (Mul (Mul (Mul (Add a5~42@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@))) (Sub (Sub (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1200@ (Mul (Mul (Mul (Add a5~42@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@))) (Sub (Sub (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Mul b5~44@ (Mul d5~48@ (Mul a5~42@ d5~48@)))))) (and (=> (= tmp%8@ (Mul a5~42@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b5~44@ d5~48@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~1135@ temp_5_1~1200@)))) (=> (= temp_5_0~1135@ temp_5_1~1200@) (=> (= temp_6_0~1283@ (Mul (Mul c6~54@ (Add (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@))) (Sub (Sub b6~52@ (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1332@ (Mul (Mul c6~54@ (Add (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@))) (Sub (Sub b6~52@ (Mul d6~56@ b6~52@)) (Mul c6~54@ (Mul b6~52@ (Mul c6~54@ d6~56@)))))) (and (=> (= tmp%9@ (Mul c6~54@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c6~54@ b6~52@ tmp%9@) (=> %%location_label%%6 (= temp_6_0~1283@ temp_6_1~1332@)))) (=> (= temp_6_0~1283@ temp_6_1~1332@) (=> (= temp_7_0~1423@ (Sub (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ a7~58@) d7~64@)) (Mul (Add (Mul c7~62@ c7~62@) (Mul b7~60@ b7~60@)) (Sub b7~60@ (Add c7~62@ c7~62@))))) (=> (= temp_7_1~1480@ (Sub (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ a7~58@) d7~64@)) (Mul (Add (Mul c7~62@ c7~62@) (Mul b7~60@ b7~60@)) (Sub b7~60@ (Add c7~62@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ c7~62@) (=> %%location_label%%7 (= temp_7_0~1423@ temp_7_1~1480@))) (=> (= temp_7_0~1423@ temp_7_1~1480@) (=> (= temp_8_0~1573@ (Mul (Sub (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@)) (Add (Mul d8~72@ b8~68@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1638@ (Mul (Sub (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) (Add (Mul d8~72@ b8~68@) (Mul a8~66@ c8~70@))))) (and (=> (= tmp%10@ (Mul c8~70@ d8~72@)) (=> (= tmp%11@ (Mul d8~72@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~1573@ temp_8_1~1638@))))) (=> (= temp_8_0~1573@ temp_8_1~1638@) (=> (= temp_9_0~1727@ (Mul (Mul (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ b9~76@))) (Mul a9~74@ (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1780@ (Mul (Mul (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ b9~76@))) (Mul a9~74@ (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ d9~80@) (=> %%location_label%%9 (= temp_9_0~1727@ temp_9_1~1780@))) (=> (= temp_9_0~1727@ temp_9_1~1780@) (=> (= temp_10_0~1873@ (Mul (Mul (Mul (Mul b10~84@ d10~88@) (Mul d10~88@ a10~82@)) (Add (Mul b10~84@ a10~82@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul d10~88@ d10~88@) (Sub d10~88@ b10~84@)) (Sub (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@))))) (=> (= temp_10_1~1938@ (Mul (Mul (Mul (Mul b10~84@ d10~88@) (Mul d10~88@ a10~82@)) (Add (Mul b10~84@ a10~82@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul d10~88@ d10~88@) (Sub d10~88@ b10~84@)) (Sub (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d10~88@ d10~88@) (=> %%location_label%%10 (= temp_10_0~1873@ temp_10_1~1938@))) (=> (= temp_10_0~1873@ temp_10_1~1938@) (=> (= temp_11_0~2031@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@)) (Mul (Sub c11~94@ c11~94@) (Mul a11~90@ a11~90@))) (Mul (Sub (Mul b11~92@ a11~90@) (Sub a11~90@ c11~94@)) (Sub (Mul d11~96@ d11~96@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~2096@ (Mul (Mul (Sub (Mul b11~92@ a11~90@) (Sub a11~90@ c11~94@)) (Sub (Mul d11~96@ d11~96@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@)) (Mul (Sub c11~94@ c11~94@) (Mul a11~90@ a11~90@))))) (and (=> (= tmp%12@ (Mul (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@)) (Mul (Sub c11~94@ c11~94@) (Mul a11~90@ a11~90@)))) (=> (= tmp%13@ (Mul (Sub (Mul b11~92@ a11~90@) (Sub a11~90@ c11~94@)) (Sub (Mul d11~96@ d11~96@) (Mul d11~96@ b11~92@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%11 (= temp_11_0~2031@ temp_11_1~2096@))))) (=> (= temp_11_0~2031@ temp_11_1~2096@) (=> (= temp_12_0~2257@ (Mul (Sub (Mul (Mul b12~100@ c12~102@) (Add a12~98@ 61)) (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ c12~102@))) (Mul (Sub (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) (Mul (Mul b12~100@ b12~100@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2334@ (Mul (Sub (Mul b12~100@ (Mul c12~102@ (Add a12~98@ 61))) (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ c12~102@))) (Mul (Sub (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) (Mul (Mul b12~100@ b12~100@) (Mul d12~104@ d12~104@))))) (and (=> (= tmp%14@ (Add a12~98@ 61)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b12~100@ c12~102@ tmp%14@) (=> %%location_label%%12 (= temp_12_0~2257@ temp_12_1~2334@)))) (=> (= temp_12_0~2257@ temp_12_1~2334@) (=> (= temp_13_0~2445@ (Mul (Mul (Sub (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Add (Add c13~110@ a13~106@) (Mul c13~110@ d13~112@))) (Mul (Mul (Mul b13~108@ d13~112@) (Mul d13~112@ d13~112@)) (Add (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2510@ (Mul (Mul (Sub (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Add (Add c13~110@ a13~106@) (Mul d13~112@ c13~110@))) (Mul (Mul (Mul b13~108@ d13~112@) (Mul d13~112@ d13~112@)) (Add (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c13~110@ d13~112@) (=> %%location_label%%13 (= temp_13_0~2445@ temp_13_1~2510@))) (=> (= temp_13_0~2445@ temp_13_1~2510@) (=> (= temp_14_0~2615@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)) (Add (Mul b14~116@ c14~118@) (Mul a14~114@ c14~118@))) (Sub (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ c14~118@)) (Mul (Mul d14~120@ b14~116@) (Mul 43 c14~118@))))) (=> (= temp_14_1~2692@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)) (Add (Mul b14~116@ c14~118@) (Mul a14~114@ c14~118@))) (Sub (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ c14~118@)) (Mul (Mul 43 c14~118@) (Mul d14~120@ b14~116@))))) (and (=> (= tmp%15@ (Mul d14~120@ b14~116@)) (=> (= tmp%16@ (Mul 43 c14~118@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%14 (= temp_14_0~2615@ temp_14_1~2692@))))) (=> (= temp_14_0~2615@ temp_14_1~2692@) (=> (= temp_15_0~2805@ (Mul (Mul (Mul (Mul c15~126@ d15~128@) (Add d15~128@ a15~122@)) (Mul (Mul c15~126@ d15~128@) (Add a15~122@ d15~128@))) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ d15~128@)) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ b15~124@))))) (=> (= temp_15_1~2878@ (Mul (Mul (Mul (Mul c15~126@ d15~128@) (Add d15~128@ a15~122@)) (Add (Mul (Mul c15~126@ d15~128@) a15~122@) (Mul (Mul c15~126@ d15~128@) d15~128@))) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ d15~128@)) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ b15~124@))))) (and (=> (= tmp%17@ (Mul c15~126@ d15~128@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%17@ a15~122@ d15~128@) (=> %%location_label%%15 (= temp_15_0~2805@ temp_15_1~2878@)))) (=> (= temp_15_0~2805@ temp_15_1~2878@) (=> (= temp_16_0~2977@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) (Mul a16~130@ c16~134@)) (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ b16~132@))) (Add (Mul (Sub d16~136@ c16~134@) (Mul d16~136@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Sub b16~132@ a16~130@))))) (=> (= temp_16_1~3042@ (Mul (Add (Mul (Sub d16~136@ c16~134@) (Mul d16~136@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Sub b16~132@ a16~130@))) (Mul (Mul (Mul d16~136@ a16~130@) (Mul a16~130@ c16~134@)) (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ b16~132@))))) (and (=> (= tmp%18@ (Mul (Mul (Mul d16~136@ a16~130@) (Mul a16~130@ c16~134@)) (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ b16~132@)))) (=> (= tmp%19@ (Add (Mul (Sub d16~136@ c16~134@) (Mul d16~136@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Sub b16~132@ a16~130@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%16 (= temp_16_0~2977@ temp_16_1~3042@))))) (=> (= temp_16_0~2977@ temp_16_1~3042@) (=> (= temp_17_0~3203@ (Mul (Sub (Mul (Add d17~144@ 62) (Mul c17~142@ c17~142@)) (Mul (Mul d17~144@ d17~144@) (Mul c17~142@ a17~138@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~3280@ (Mul (Sub (Mul (Add d17~144@ 62) (Mul c17~142@ c17~142@)) (Mul (Mul d17~144@ d17~144@) (Mul c17~142@ a17~138@))) (Mul (Mul (Mul d17~144@ d17~144@) (Mul d17~144@ c17~142@)) (Mul (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@))))) (and (=> (= tmp%20@ (Mul d17~144@ c17~142@)) (=> (= tmp%21@ (Mul d17~144@ d17~144@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%17 (= temp_17_0~3203@ temp_17_1~3280@))))) (=> (= temp_17_0~3203@ temp_17_1~3280@) (=> (= temp_18_0~3381@ (Sub (Sub (Mul (Mul b18~148@ b18~148@) (Sub c18~150@ d18~152@)) 45) (Mul (Add (Mul a18~146@ d18~152@) (Mul b18~148@ a18~146@)) (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ b18~148@))))) (=> (= temp_18_1~3446@ (Sub (Sub (Mul b18~148@ (Mul b18~148@ (Sub c18~150@ d18~152@))) 45) (Mul (Add (Mul a18~146@ d18~152@) (Mul b18~148@ a18~146@)) (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ b18~148@))))) (and (=> (= tmp%22@ (Sub c18~150@ d18~152@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b18~148@ b18~148@ tmp%22@) (=> %%location_label%%18 (= temp_18_0~3381@ temp_18_1~3446@)))) (=> (= temp_18_0~3381@ temp_18_1~3446@) (=> (= temp_19_0~3545@ (Mul (Mul (Add (Mul a19~154@ b19~156@) (Sub c19~158@ d19~160@)) (Mul (Mul c19~158@ d19~160@) (Sub b19~156@ d19~160@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul a19~154@ b19~156@)) (Mul (Mul a19~154@ d19~160@) (Mul c19~158@ c19~158@))))) (=> (= temp_19_1~3610@ (Mul (Mul (Add (Mul a19~154@ b19~156@) (Sub c19~158@ d19~160@)) (Mul (Mul c19~158@ d19~160@) (Sub b19~156@ d19~160@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul a19~154@ b19~156@)) (Mul (Mul a19~154@ d19~160@) (Mul c19~158@ c19~158@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c19~158@ c19~158@) (=> %%location_label%%19 (= temp_19_0~3545@ temp_19_1~3610@))) (=> (= temp_19_0~3545@ temp_19_1~3610@) (=> (= temp_20_0~3703@ (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Mul (Mul a20~162@ c20~166@) (Mul b20~164@ d20~168@))) (Mul (Add (Mul c20~166@ d20~168@) (Mul c20~166@ c20~166@)) (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ d20~168@))))) (=> (= temp_20_1~3768@ (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Mul (Mul a20~162@ c20~166@) (Mul b20~164@ d20~168@))) (Mul (Add (Mul d20~168@ c20~166@) (Mul c20~166@ c20~166@)) (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ d20~168@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c20~166@ d20~168@) (=> %%location_label%%20 (= temp_20_0~3703@ temp_20_1~3768@))) (=> (= temp_20_0~3703@ temp_20_1~3768@) (=> (= temp_21_0~3861@ (Mul (Mul (Mul (Mul d21~176@ b21~172@) (Mul a21~170@ c21~174@)) (Mul (Mul b21~172@ c21~174@) (Sub d21~176@ d21~176@))) (Mul (Mul (Mul a21~170@ b21~172@) (Mul d21~176@ c21~174@)) (Mul (Add a21~170@ d21~176@) (Add c21~174@ c21~174@))))) (=> (= temp_21_1~3926@ (Mul (Mul (Mul (Mul (Mul d21~176@ b21~172@) a21~170@) c21~174@) (Mul (Mul b21~172@ c21~174@) (Sub d21~176@ d21~176@))) (Mul (Mul (Mul a21~170@ b21~172@) (Mul d21~176@ c21~174@)) (Mul (Add a21~170@ d21~176@) (Add c21~174@ c21~174@))))) (and (=> (= tmp%23@ (Mul d21~176@ b21~172@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ a21~170@ c21~174@) (=> %%location_label%%21 (= temp_21_0~3861@ temp_21_1~3926@)))) (=> (= temp_21_0~3861@ temp_21_1~3926@) (=> (= temp_22_0~4033@ (Mul (Mul (Add (Mul d22~184@ c22~182@) (Mul c22~182@ c22~182@)) (Mul (Mul a22~178@ 74) (Mul d22~184@ a22~178@))) (Mul (Mul c22~182@ (Mul a22~178@ a22~178@)) (Sub (Mul b22~180@ b22~180@) (Sub c22~182@ d22~184@))))) (=> (= temp_22_1~4106@ (Mul (Mul (Add (Mul d22~184@ c22~182@) (Mul c22~182@ c22~182@)) (Mul (Mul a22~178@ 74) (Mul d22~184@ a22~178@))) (Mul (Mul c22~182@ (Mul a22~178@ a22~178@)) (Sub (Mul b22~180@ b22~180@) (Sub c22~182@ d22~184@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a22~178@ a22~178@) (=> %%location_label%%22 (= temp_22_0~4033@ temp_22_1~4106@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
