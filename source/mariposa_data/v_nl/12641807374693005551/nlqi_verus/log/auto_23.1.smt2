...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Add (Mul (Mul b0~4@ c0~6@) (Add b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) c0~6@)) (Mul (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ 30)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~386@ (Mul (Add (Mul (Mul b0~4@ c0~6@) (Add b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) c0~6@)) (Mul (Mul (Mul b0~4@ 30) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~386@))) (=> (= temp_0_0~313@ temp_0_1~386@) (=> (= temp_1_0~475@ (Mul (Sub (Mul (Sub b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Sub d1~16@ b1~12@))) (Add (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~540@ (Mul (Sub (Mul (Mul d1~16@ b1~12@) (Sub b1~12@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Sub d1~16@ b1~12@))) (Add (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~475@ temp_1_1~540@))) (=> (= temp_1_0~475@ temp_1_1~540@) (=> (= temp_2_0~641@ (Add (Mul (Add (Mul b2~20@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul 19 d2~24@))) (Add (Mul (Mul d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~718@ (Add (Mul (Add (Mul b2~20@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul 19 d2~24@))) (Add (Mul (Mul d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~641@ temp_2_1~718@))) (=> (= temp_2_0~641@ temp_2_1~718@) (=> (= temp_3_0~799@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (Mul (Mul c3~30@ (Add a3~26@ d3~32@)) (Mul c3~30@ (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~856@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (Mul (Mul (Add a3~26@ d3~32@) c3~30@) (Mul c3~30@ (Mul c3~30@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~799@ temp_3_1~856@))) (=> (= temp_3_0~799@ temp_3_1~856@) (=> (= temp_4_0~933@ (Mul (Mul (Sub (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) b4~36@) (Mul (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Sub a4~34@ a4~34@))))) (=> (= temp_4_1~986@ (Mul (Mul (Sub (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) b4~36@) (Mul (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Sub a4~34@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~933@ temp_4_1~986@))) (=> (= temp_4_0~933@ temp_4_1~986@) (=> (= temp_5_0~1075@ (Mul (Mul (Mul (Add a5~42@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@))) (Sub (Sub (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1140@ (Mul (Mul (Mul (Add a5~42@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@))) (Sub (Sub (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Mul b5~44@ (Mul d5~48@ (Mul a5~42@ d5~48@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1075@ temp_5_1~1140@))) (=> (= temp_5_0~1075@ temp_5_1~1140@) (=> (= temp_6_0~1213@ (Mul (Mul c6~54@ (Add (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@))) (Sub (Sub b6~52@ (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1262@ (Mul (Mul c6~54@ (Add (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@))) (Sub (Sub b6~52@ (Mul d6~56@ b6~52@)) (Mul c6~54@ (Mul b6~52@ (Mul c6~54@ d6~56@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1213@ temp_6_1~1262@))) (=> (= temp_6_0~1213@ temp_6_1~1262@) (=> (= temp_7_0~1343@ (Sub (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ a7~58@) d7~64@)) (Mul (Add (Mul c7~62@ c7~62@) (Mul b7~60@ b7~60@)) (Sub b7~60@ (Add c7~62@ c7~62@))))) (=> (= temp_7_1~1400@ (Sub (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ a7~58@) d7~64@)) (Mul (Add (Mul c7~62@ c7~62@) (Mul b7~60@ b7~60@)) (Sub b7~60@ (Add c7~62@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1343@ temp_7_1~1400@))) (=> (= temp_7_0~1343@ temp_7_1~1400@) (=> (= temp_8_0~1489@ (Mul (Sub (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@)) (Add (Mul d8~72@ b8~68@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1554@ (Mul (Sub (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) (Add (Mul d8~72@ b8~68@) (Mul a8~66@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1489@ temp_8_1~1554@))) (=> (= temp_8_0~1489@ temp_8_1~1554@) (=> (= temp_9_0~1631@ (Mul (Mul (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ b9~76@))) (Mul a9~74@ (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1684@ (Mul (Mul (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ b9~76@))) (Mul a9~74@ (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1631@ temp_9_1~1684@))) (=> (= temp_9_0~1631@ temp_9_1~1684@) (=> (= temp_10_0~1773@ (Mul (Mul (Mul (Mul b10~84@ d10~88@) (Mul d10~88@ a10~82@)) (Add (Mul b10~84@ a10~82@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul d10~88@ d10~88@) (Sub d10~88@ b10~84@)) (Sub (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@))))) (=> (= temp_10_1~1838@ (Mul (Mul (Mul (Mul b10~84@ d10~88@) (Mul d10~88@ a10~82@)) (Add (Mul b10~84@ a10~82@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul d10~88@ d10~88@) (Sub d10~88@ b10~84@)) (Sub (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1773@ temp_10_1~1838@))) (=> (= temp_10_0~1773@ temp_10_1~1838@) (=> (= temp_11_0~1927@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@)) (Mul (Sub c11~94@ c11~94@) (Mul a11~90@ a11~90@))) (Mul (Sub (Mul b11~92@ a11~90@) (Sub a11~90@ c11~94@)) (Sub (Mul d11~96@ d11~96@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~1992@ (Mul (Mul (Sub (Mul b11~92@ a11~90@) (Sub a11~90@ c11~94@)) (Sub (Mul d11~96@ d11~96@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@)) (Mul (Sub c11~94@ c11~94@) (Mul a11~90@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1927@ temp_11_1~1992@))) (=> (= temp_11_0~1927@ temp_11_1~1992@) (=> (= temp_12_0~2093@ (Mul (Sub (Mul (Mul b12~100@ c12~102@) (Add a12~98@ 61)) (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ c12~102@))) (Mul (Sub (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) (Mul (Mul b12~100@ b12~100@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2170@ (Mul (Sub (Mul b12~100@ (Mul c12~102@ (Add a12~98@ 61))) (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ c12~102@))) (Mul (Sub (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) (Mul (Mul b12~100@ b12~100@) (Mul d12~104@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2093@ temp_12_1~2170@))) (=> (= temp_12_0~2093@ temp_12_1~2170@) (=> (= temp_13_0~2259@ (Mul (Mul (Sub (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Add (Add c13~110@ a13~106@) (Mul c13~110@ d13~112@))) (Mul (Mul (Mul b13~108@ d13~112@) (Mul d13~112@ d13~112@)) (Add (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2324@ (Mul (Mul (Sub (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Add (Add c13~110@ a13~106@) (Mul d13~112@ c13~110@))) (Mul (Mul (Mul b13~108@ d13~112@) (Mul d13~112@ d13~112@)) (Add (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2259@ temp_13_1~2324@))) (=> (= temp_13_0~2259@ temp_13_1~2324@) (=> (= temp_14_0~2425@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)) (Add (Mul b14~116@ c14~118@) (Mul a14~114@ c14~118@))) (Sub (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ c14~118@)) (Mul (Mul d14~120@ b14~116@) (Mul 43 c14~118@))))) (=> (= temp_14_1~2502@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)) (Add (Mul b14~116@ c14~118@) (Mul a14~114@ c14~118@))) (Sub (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ c14~118@)) (Mul (Mul 43 c14~118@) (Mul d14~120@ b14~116@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2425@ temp_14_1~2502@))) (=> (= temp_14_0~2425@ temp_14_1~2502@) (=> (= temp_15_0~2591@ (Mul (Mul (Mul (Mul c15~126@ d15~128@) (Add d15~128@ a15~122@)) (Mul (Mul c15~126@ d15~128@) (Add a15~122@ d15~128@))) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ d15~128@)) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ b15~124@))))) (=> (= temp_15_1~2664@ (Mul (Mul (Mul (Mul c15~126@ d15~128@) (Add d15~128@ a15~122@)) (Add (Mul (Mul c15~126@ d15~128@) a15~122@) (Mul (Mul c15~126@ d15~128@) d15~128@))) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ d15~128@)) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2591@ temp_15_1~2664@))) (=> (= temp_15_0~2591@ temp_15_1~2664@) (=> (= temp_16_0~2753@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) (Mul a16~130@ c16~134@)) (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ b16~132@))) (Add (Mul (Sub d16~136@ c16~134@) (Mul d16~136@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Sub b16~132@ a16~130@))))) (=> (= temp_16_1~2818@ (Mul (Add (Mul (Sub d16~136@ c16~134@) (Mul d16~136@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Sub b16~132@ a16~130@))) (Mul (Mul (Mul d16~136@ a16~130@) (Mul a16~130@ c16~134@)) (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2753@ temp_16_1~2818@))) (=> (= temp_16_0~2753@ temp_16_1~2818@) (=> (= temp_17_0~2919@ (Mul (Sub (Mul (Add d17~144@ 62) (Mul c17~142@ c17~142@)) (Mul (Mul d17~144@ d17~144@) (Mul c17~142@ a17~138@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~2996@ (Mul (Sub (Mul (Add d17~144@ 62) (Mul c17~142@ c17~142@)) (Mul (Mul d17~144@ d17~144@) (Mul c17~142@ a17~138@))) (Mul (Mul (Mul d17~144@ d17~144@) (Mul d17~144@ c17~142@)) (Mul (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2919@ temp_17_1~2996@))) (=> (= temp_17_0~2919@ temp_17_1~2996@) (=> (= temp_18_0~3085@ (Sub (Sub (Mul (Mul b18~148@ b18~148@) (Sub c18~150@ d18~152@)) 45) (Mul (Add (Mul a18~146@ d18~152@) (Mul b18~148@ a18~146@)) (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ b18~148@))))) (=> (= temp_18_1~3150@ (Sub (Sub (Mul b18~148@ (Mul b18~148@ (Sub c18~150@ d18~152@))) 45) (Mul (Add (Mul a18~146@ d18~152@) (Mul b18~148@ a18~146@)) (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ b18~148@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3085@ temp_18_1~3150@))) (=> (= temp_18_0~3085@ temp_18_1~3150@) (=> (= temp_19_0~3239@ (Mul (Mul (Add (Mul a19~154@ b19~156@) (Sub c19~158@ d19~160@)) (Mul (Mul c19~158@ d19~160@) (Sub b19~156@ d19~160@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul a19~154@ b19~156@)) (Mul (Mul a19~154@ d19~160@) (Mul c19~158@ c19~158@))))) (=> (= temp_19_1~3304@ (Mul (Mul (Add (Mul a19~154@ b19~156@) (Sub c19~158@ d19~160@)) (Mul (Mul c19~158@ d19~160@) (Sub b19~156@ d19~160@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul a19~154@ b19~156@)) (Mul (Mul a19~154@ d19~160@) (Mul c19~158@ c19~158@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3239@ temp_19_1~3304@))) (=> (= temp_19_0~3239@ temp_19_1~3304@) (=> (= temp_20_0~3393@ (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Mul (Mul a20~162@ c20~166@) (Mul b20~164@ d20~168@))) (Mul (Add (Mul c20~166@ d20~168@) (Mul c20~166@ c20~166@)) (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ d20~168@))))) (=> (= temp_20_1~3458@ (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Mul (Mul a20~162@ c20~166@) (Mul b20~164@ d20~168@))) (Mul (Add (Mul d20~168@ c20~166@) (Mul c20~166@ c20~166@)) (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ d20~168@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3393@ temp_20_1~3458@))) (=> (= temp_20_0~3393@ temp_20_1~3458@) (=> (= temp_21_0~3547@ (Mul (Mul (Mul (Mul d21~176@ b21~172@) (Mul a21~170@ c21~174@)) (Mul (Mul b21~172@ c21~174@) (Sub d21~176@ d21~176@))) (Mul (Mul (Mul a21~170@ b21~172@) (Mul d21~176@ c21~174@)) (Mul (Add a21~170@ d21~176@) (Add c21~174@ c21~174@))))) (=> (= temp_21_1~3612@ (Mul (Mul (Mul (Mul (Mul d21~176@ b21~172@) a21~170@) c21~174@) (Mul (Mul b21~172@ c21~174@) (Sub d21~176@ d21~176@))) (Mul (Mul (Mul a21~170@ b21~172@) (Mul d21~176@ c21~174@)) (Mul (Add a21~170@ d21~176@) (Add c21~174@ c21~174@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3547@ temp_21_1~3612@))) (=> (= temp_21_0~3547@ temp_21_1~3612@) (=> (= temp_22_0~3709@ (Mul (Mul (Add (Mul d22~184@ c22~182@) (Mul c22~182@ c22~182@)) (Mul (Mul a22~178@ 74) (Mul d22~184@ a22~178@))) (Mul (Mul c22~182@ (Mul a22~178@ a22~178@)) (Sub (Mul b22~180@ b22~180@) (Sub c22~182@ d22~184@))))) (=> (= temp_22_1~3782@ (Mul (Mul (Add (Mul d22~184@ c22~182@) (Mul c22~182@ c22~182@)) (Mul (Mul a22~178@ 74) (Mul d22~184@ a22~178@))) (Mul (Mul c22~182@ (Mul a22~178@ a22~178@)) (Sub (Mul b22~180@ b22~180@) (Sub c22~182@ d22~184@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3709@ temp_22_1~3782@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
