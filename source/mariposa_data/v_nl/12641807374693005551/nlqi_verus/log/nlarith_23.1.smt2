...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Add (Mul (Mul b0~4@ c0~6@) (Add b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) c0~6@)) (Mul (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ 30)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~386@ (Mul (Add (Mul (Mul b0~4@ c0~6@) (Add b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) c0~6@)) (Mul (Mul (Mul b0~4@ 30) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~313@ temp_0_1~386@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~466@ (Mul (Sub (Mul (Sub b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Sub d1~16@ b1~12@))) (Add (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~531@ (Mul (Sub (Mul (Mul d1~16@ b1~12@) (Sub b1~12@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Sub d1~16@ b1~12@))) (Add (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~466@ temp_1_1~531@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~623@ (Add (Mul (Add (Mul b2~20@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul 19 d2~24@))) (Add (Mul (Mul d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~700@ (Add (Mul (Add (Mul b2~20@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul 19 d2~24@))) (Add (Mul (Mul d2~24@ a2~18@) (Add b2~20@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~623@ temp_2_1~700@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~772@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (Mul (Mul c3~30@ (Add a3~26@ d3~32@)) (Mul c3~30@ (Mul c3~30@ b3~28@))))) (=> (= temp_3_1~829@ (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul d3~32@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (Mul (Mul (Add a3~26@ d3~32@) c3~30@) (Mul c3~30@ (Mul c3~30@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~772@ temp_3_1~829@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~897@ (Mul (Mul (Sub (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) b4~36@) (Mul (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Sub a4~34@ a4~34@))))) (=> (= temp_4_1~950@ (Mul (Mul (Sub (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) b4~36@) (Mul (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Mul c4~38@ c4~38@) (Sub a4~34@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~897@ temp_4_1~950@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1030@ (Mul (Mul (Mul (Add a5~42@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@))) (Sub (Sub (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1095@ (Mul (Mul (Mul (Add a5~42@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@))) (Sub (Sub (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Mul b5~44@ (Mul d5~48@ (Mul a5~42@ d5~48@)))))) (=> (= tmp%6@ (= temp_5_0~1030@ temp_5_1~1095@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1159@ (Mul (Mul c6~54@ (Add (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@))) (Sub (Sub b6~52@ (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1208@ (Mul (Mul c6~54@ (Add (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@))) (Sub (Sub b6~52@ (Mul d6~56@ b6~52@)) (Mul c6~54@ (Mul b6~52@ (Mul c6~54@ d6~56@)))))) (=> (= tmp%7@ (= temp_6_0~1159@ temp_6_1~1208@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1280@ (Sub (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ a7~58@) d7~64@)) (Mul (Add (Mul c7~62@ c7~62@) (Mul b7~60@ b7~60@)) (Sub b7~60@ (Add c7~62@ c7~62@))))) (=> (= temp_7_1~1337@ (Sub (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ a7~58@) d7~64@)) (Mul (Add (Mul c7~62@ c7~62@) (Mul b7~60@ b7~60@)) (Sub b7~60@ (Add c7~62@ c7~62@))))) (=> (= tmp%8@ (= temp_7_0~1280@ temp_7_1~1337@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1417@ (Mul (Sub (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@)) (Add (Mul d8~72@ b8~68@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1482@ (Mul (Sub (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)) (Add (Mul d8~72@ b8~68@) (Mul a8~66@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1417@ temp_8_1~1482@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1550@ (Mul (Mul (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ b9~76@))) (Mul a9~74@ (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@))))) (=> (= temp_9_1~1603@ (Mul (Mul (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul d9~80@ b9~76@))) (Mul a9~74@ (Mul (Mul d9~80@ a9~74@) (Mul d9~80@ d9~80@))))) (=> (= tmp%10@ (= temp_9_0~1550@ temp_9_1~1603@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1683@ (Mul (Mul (Mul (Mul b10~84@ d10~88@) (Mul d10~88@ a10~82@)) (Add (Mul b10~84@ a10~82@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul d10~88@ d10~88@) (Sub d10~88@ b10~84@)) (Sub (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@))))) (=> (= temp_10_1~1748@ (Mul (Mul (Mul (Mul b10~84@ d10~88@) (Mul d10~88@ a10~82@)) (Add (Mul b10~84@ a10~82@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul d10~88@ d10~88@) (Sub d10~88@ b10~84@)) (Sub (Mul a10~82@ d10~88@) (Mul b10~84@ a10~82@))))) (=> (= tmp%11@ (= temp_10_0~1683@ temp_10_1~1748@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1828@ (Mul (Mul (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@)) (Mul (Sub c11~94@ c11~94@) (Mul a11~90@ a11~90@))) (Mul (Sub (Mul b11~92@ a11~90@) (Sub a11~90@ c11~94@)) (Sub (Mul d11~96@ d11~96@) (Mul d11~96@ b11~92@))))) (=> (= temp_11_1~1893@ (Mul (Mul (Sub (Mul b11~92@ a11~90@) (Sub a11~90@ c11~94@)) (Sub (Mul d11~96@ d11~96@) (Mul d11~96@ b11~92@))) (Mul (Mul (Mul d11~96@ c11~94@) (Mul d11~96@ c11~94@)) (Mul (Sub c11~94@ c11~94@) (Mul a11~90@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1828@ temp_11_1~1893@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1985@ (Mul (Sub (Mul (Mul b12~100@ c12~102@) (Add a12~98@ 61)) (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ c12~102@))) (Mul (Sub (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) (Mul (Mul b12~100@ b12~100@) (Mul d12~104@ d12~104@))))) (=> (= temp_12_1~2062@ (Mul (Sub (Mul b12~100@ (Mul c12~102@ (Add a12~98@ 61))) (Mul (Mul c12~102@ c12~102@) (Mul d12~104@ c12~102@))) (Mul (Sub (Mul b12~100@ d12~104@) (Mul c12~102@ b12~100@)) (Mul (Mul b12~100@ b12~100@) (Mul d12~104@ d12~104@))))) (=> (= tmp%13@ (= temp_12_0~1985@ temp_12_1~2062@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2142@ (Mul (Mul (Sub (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Add (Add c13~110@ a13~106@) (Mul c13~110@ d13~112@))) (Mul (Mul (Mul b13~108@ d13~112@) (Mul d13~112@ d13~112@)) (Add (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2207@ (Mul (Mul (Sub (Mul d13~112@ b13~108@) (Mul c13~110@ a13~106@)) (Add (Add c13~110@ a13~106@) (Mul d13~112@ c13~110@))) (Mul (Mul (Mul b13~108@ d13~112@) (Mul d13~112@ d13~112@)) (Add (Mul c13~110@ d13~112@) (Mul b13~108@ d13~112@))))) (=> (= tmp%14@ (= temp_13_0~2142@ temp_13_1~2207@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~2299@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)) (Add (Mul b14~116@ c14~118@) (Mul a14~114@ c14~118@))) (Sub (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ c14~118@)) (Mul (Mul d14~120@ b14~116@) (Mul 43 c14~118@))))) (=> (= temp_14_1~2376@ (Mul (Mul (Mul (Mul d14~120@ b14~116@) (Mul c14~118@ c14~118@)) (Add (Mul b14~116@ c14~118@) (Mul a14~114@ c14~118@))) (Sub (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ c14~118@)) (Mul (Mul 43 c14~118@) (Mul d14~120@ b14~116@))))) (=> (= tmp%15@ (= temp_14_0~2299@ temp_14_1~2376@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~2456@ (Mul (Mul (Mul (Mul c15~126@ d15~128@) (Add d15~128@ a15~122@)) (Mul (Mul c15~126@ d15~128@) (Add a15~122@ d15~128@))) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ d15~128@)) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ b15~124@))))) (=> (= temp_15_1~2529@ (Mul (Mul (Mul (Mul c15~126@ d15~128@) (Add d15~128@ a15~122@)) (Add (Mul (Mul c15~126@ d15~128@) a15~122@) (Mul (Mul c15~126@ d15~128@) d15~128@))) (Mul (Mul (Mul d15~128@ a15~122@) (Mul b15~124@ d15~128@)) (Mul (Mul d15~128@ d15~128@) (Mul a15~122@ b15~124@))))) (=> (= tmp%16@ (= temp_15_0~2456@ temp_15_1~2529@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~2609@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) (Mul a16~130@ c16~134@)) (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ b16~132@))) (Add (Mul (Sub d16~136@ c16~134@) (Mul d16~136@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Sub b16~132@ a16~130@))))) (=> (= temp_16_1~2674@ (Mul (Add (Mul (Sub d16~136@ c16~134@) (Mul d16~136@ a16~130@)) (Mul (Mul b16~132@ b16~132@) (Sub b16~132@ a16~130@))) (Mul (Mul (Mul d16~136@ a16~130@) (Mul a16~130@ c16~134@)) (Mul (Mul d16~136@ c16~134@) (Mul b16~132@ b16~132@))))) (=> (= tmp%17@ (= temp_16_0~2609@ temp_16_1~2674@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~2766@ (Mul (Sub (Mul (Add d17~144@ 62) (Mul c17~142@ c17~142@)) (Mul (Mul d17~144@ d17~144@) (Mul c17~142@ a17~138@))) (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ d17~144@)) (Mul (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@))))) (=> (= temp_17_1~2843@ (Mul (Sub (Mul (Add d17~144@ 62) (Mul c17~142@ c17~142@)) (Mul (Mul d17~144@ d17~144@) (Mul c17~142@ a17~138@))) (Mul (Mul (Mul d17~144@ d17~144@) (Mul d17~144@ c17~142@)) (Mul (Mul d17~144@ c17~142@) (Mul c17~142@ c17~142@))))) (=> (= tmp%18@ (= temp_17_0~2766@ temp_17_1~2843@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~2923@ (Sub (Sub (Mul (Mul b18~148@ b18~148@) (Sub c18~150@ d18~152@)) 45) (Mul (Add (Mul a18~146@ d18~152@) (Mul b18~148@ a18~146@)) (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ b18~148@))))) (=> (= temp_18_1~2988@ (Sub (Sub (Mul b18~148@ (Mul b18~148@ (Sub c18~150@ d18~152@))) 45) (Mul (Add (Mul a18~146@ d18~152@) (Mul b18~148@ a18~146@)) (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ b18~148@))))) (=> (= tmp%19@ (= temp_18_0~2923@ temp_18_1~2988@)) (and (=> %%location_label%%18 tmp%19@) (=> tmp%19@ (=> (= temp_19_0~3068@ (Mul (Mul (Add (Mul a19~154@ b19~156@) (Sub c19~158@ d19~160@)) (Mul (Mul c19~158@ d19~160@) (Sub b19~156@ d19~160@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul a19~154@ b19~156@)) (Mul (Mul a19~154@ d19~160@) (Mul c19~158@ c19~158@))))) (=> (= temp_19_1~3133@ (Mul (Mul (Add (Mul a19~154@ b19~156@) (Sub c19~158@ d19~160@)) (Mul (Mul c19~158@ d19~160@) (Sub b19~156@ d19~160@))) (Mul (Mul (Mul b19~156@ b19~156@) (Mul a19~154@ b19~156@)) (Mul (Mul a19~154@ d19~160@) (Mul c19~158@ c19~158@))))) (=> (= tmp%20@ (= temp_19_0~3068@ temp_19_1~3133@)) (and (=> %%location_label%%19 tmp%20@) (=> tmp%20@ (=> (= temp_20_0~3213@ (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Mul (Mul a20~162@ c20~166@) (Mul b20~164@ d20~168@))) (Mul (Add (Mul c20~166@ d20~168@) (Mul c20~166@ c20~166@)) (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ d20~168@))))) (=> (= temp_20_1~3278@ (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ b20~164@)) (Mul (Mul a20~162@ c20~166@) (Mul b20~164@ d20~168@))) (Mul (Add (Mul d20~168@ c20~166@) (Mul c20~166@ c20~166@)) (Mul (Mul a20~162@ a20~162@) (Mul b20~164@ d20~168@))))) (=> (= tmp%21@ (= temp_20_0~3213@ temp_20_1~3278@)) (and (=> %%location_label%%20 tmp%21@) (=> tmp%21@ (=> (= temp_21_0~3358@ (Mul (Mul (Mul (Mul d21~176@ b21~172@) (Mul a21~170@ c21~174@)) (Mul (Mul b21~172@ c21~174@) (Sub d21~176@ d21~176@))) (Mul (Mul (Mul a21~170@ b21~172@) (Mul d21~176@ c21~174@)) (Mul (Add a21~170@ d21~176@) (Add c21~174@ c21~174@))))) (=> (= temp_21_1~3423@ (Mul (Mul (Mul (Mul (Mul d21~176@ b21~172@) a21~170@) c21~174@) (Mul (Mul b21~172@ c21~174@) (Sub d21~176@ d21~176@))) (Mul (Mul (Mul a21~170@ b21~172@) (Mul d21~176@ c21~174@)) (Mul (Add a21~170@ d21~176@) (Add c21~174@ c21~174@))))) (=> (= tmp%22@ (= temp_21_0~3358@ temp_21_1~3423@)) (and (=> %%location_label%%21 tmp%22@) (=> tmp%22@ (=> (= temp_22_0~3511@ (Mul (Mul (Add (Mul d22~184@ c22~182@) (Mul c22~182@ c22~182@)) (Mul (Mul a22~178@ 74) (Mul d22~184@ a22~178@))) (Mul (Mul c22~182@ (Mul a22~178@ a22~178@)) (Sub (Mul b22~180@ b22~180@) (Sub c22~182@ d22~184@))))) (=> (= temp_22_1~3584@ (Mul (Mul (Add (Mul d22~184@ c22~182@) (Mul c22~182@ c22~182@)) (Mul (Mul a22~178@ 74) (Mul d22~184@ a22~178@))) (Mul (Mul c22~182@ (Mul a22~178@ a22~178@)) (Sub (Mul b22~180@ b22~180@) (Sub c22~182@ d22~184@))))) (=> (= tmp%23@ (= temp_22_0~3511@ temp_22_1~3584@)) (=> %%location_label%%22 tmp%23@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
