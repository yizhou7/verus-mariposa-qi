...
(declare-const temp_5_0~1522@ Int)
(declare-const temp_5_1~1647@ Int)
(declare-const temp_6_0~1767@ Int)
(declare-const temp_6_1~1876@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~261@ (Mul (Mul (Mul (Mul (Sub a0~2@ d0~8@) b0~4@) a0~2@) (Mul (Mul (Add d0~8@ b0~4@) (Mul d0~8@ a0~2@)) c0~6@)) (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ d0~8@)) (Sub (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Mul (Sub (Mul d0~8@ d0~8@) (Sub c0~6@ b0~4@)) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@)))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul (Sub a0~2@ d0~8@) b0~4@) a0~2@) (Mul (Mul (Add d0~8@ b0~4@) (Mul d0~8@ a0~2@)) c0~6@)) (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ d0~8@)) (Sub (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Mul (Sub (Mul d0~8@ d0~8@) (Sub c0~6@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ c0~6@)))))) (=> (= tmp%1@ (= temp_0_0~261@ temp_0_1~362@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~514@ (Mul (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul 89 b1~12@) (Mul b1~12@ d1~16@))) (Sub (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Add a1~10@ c1~14@) (Mul b1~12@ d1~16@)))) (Add (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@))) (Mul (Mul a1~10@ (Add d1~16@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ c1~14@)))))) (=> (= temp_1_1~651@ (Mul (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul 89 b1~12@) (Mul b1~12@ d1~16@))) (Sub (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Add a1~10@ c1~14@) (Mul b1~12@ d1~16@)))) (Add (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@))) (Mul (Mul a1~10@ (Add d1~16@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ c1~14@)))))) (=> (= tmp%2@ (= temp_1_0~514@ temp_1_1~651@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~803@ (Mul (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ c2~22@))) (Mul (Mul (Sub b2~20@ b2~20@) (Add c2~22@ a2~18@)) (Add a2~18@ (Mul c2~22@ a2~18@)))) (Mul (Mul (Add (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@)) (Sub (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ d2~24@)) (Sub (Sub 1 d2~24@) (Mul b2~20@ a2~18@)))))) (=> (= temp_2_1~940@ (Mul (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ c2~22@))) (Mul (Mul (Sub b2~20@ b2~20@) (Add c2~22@ a2~18@)) (Add a2~18@ (Mul c2~22@ a2~18@)))) (Mul (Mul (Add (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@)) (Sub (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Sub (Sub 1 d2~24@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ d2~24@)))))) (=> (= tmp%3@ (= temp_2_0~803@ temp_2_1~940@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1056@ (Mul (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@))) (Mul a3~26@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)))) (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ a3~26@)) b3~28@) (Mul (Mul (Add d3~32@ a3~26@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ b3~28@) a3~26@))))) (=> (= temp_3_1~1157@ (Mul (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@))) (Mul a3~26@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)))) (Mul (Mul (Mul a3~26@ (Mul c3~30@ (Mul a3~26@ a3~26@))) b3~28@) (Mul (Mul (Add d3~32@ a3~26@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ b3~28@) a3~26@))))) (=> (= tmp%4@ (= temp_3_0~1056@ temp_3_1~1157@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1281@ (Mul (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Add d4~40@ d4~40@) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul a4~34@ a4~34@) d4~40@) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)))) (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@)) d4~40@) (Mul (Mul (Mul c4~38@ a4~34@) c4~38@) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@)))))) (=> (= temp_4_1~1390@ (Mul (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Add d4~40@ d4~40@) (Mul c4~38@ a4~34@))) (Mul (Mul a4~34@ (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)))) (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@)) d4~40@) (Mul (Mul (Mul c4~38@ a4~34@) c4~38@) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@)))))) (=> (= tmp%5@ (= temp_4_0~1281@ temp_4_1~1390@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1522@ (Mul (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Add a5~42@ d5~48@)) (Mul (Mul c5~46@ 84) (Add b5~44@ d5~48@))) (Mul (Add (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)) d5~48@)) (Sub (Mul (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@))) (Add a5~42@ (Mul (Add a5~42@ d5~48@) (Mul c5~46@ d5~48@)))))) (=> (= temp_5_1~1647@ (Mul (Mul (Mul (Add (Mul (Mul b5~44@ a5~42@) a5~42@) (Mul (Mul b5~44@ a5~42@) d5~48@)) (Mul (Mul c5~46@ 84) (Add b5~44@ d5~48@))) (Mul (Add (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)) d5~48@)) (Sub (Mul (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@))) (Add a5~42@ (Mul (Add a5~42@ d5~48@) (Mul c5~46@ d5~48@)))))) (=> (= tmp%6@ (= temp_5_0~1522@ temp_5_1~1647@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1767@ (Mul (Mul (Mul (Mul (Sub d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Mul a6~50@ (Mul d6~56@ d6~56@))) (Add (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ c6~54@) d6~56@))) (Mul (Mul b6~52@ (Mul (Add b6~52@ a6~50@) a6~50@)) (Mul (Add (Add a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@)))))) (=> (= temp_6_1~1876@ (Mul (Mul (Mul (Mul (Sub d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Mul a6~50@ (Mul d6~56@ d6~56@))) (Add (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ c6~54@) d6~56@))) (Mul (Mul b6~52@ (Add (Mul b6~52@ a6~50@) (Mul a6~50@ a6~50@))) (Mul (Add (Add a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@)))))) (=> (= tmp%7@ (= temp_6_0~1767@ temp_6_1~1876@)) (=> %%location_label%%6 tmp%7@)))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
