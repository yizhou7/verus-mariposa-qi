...
(set-info :comment ";; mariposa_data/v_nl//8327440968382509070/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~261@ (Mul (Mul (Mul (Mul (Sub a0~2@ d0~8@) b0~4@) a0~2@) (Mul (Mul (Add d0~8@ b0~4@) (Mul d0~8@ a0~2@)) c0~6@)) (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ d0~8@)) (Sub (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Mul (Sub (Mul d0~8@ d0~8@) (Sub c0~6@ b0~4@)) (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@)))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul (Sub a0~2@ d0~8@) b0~4@) a0~2@) (Mul (Mul (Add d0~8@ b0~4@) (Mul d0~8@ a0~2@)) c0~6@)) (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ d0~8@)) (Sub (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Mul (Sub (Mul d0~8@ d0~8@) (Sub c0~6@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ c0~6@)))))) (and (=> (= tmp%1@ (Mul d0~8@ c0~6@)) (=> (= tmp%2@ (Mul a0~2@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~261@ temp_0_1~362@))))) (=> (= temp_0_0~261@ temp_0_1~362@) (=> (= temp_1_0~535@ (Mul (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul 89 b1~12@) (Mul b1~12@ d1~16@))) (Sub (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Add a1~10@ c1~14@) (Mul b1~12@ d1~16@)))) (Add (Mul (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@))) (Mul (Mul a1~10@ (Add d1~16@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ c1~14@)))))) (=> (= temp_1_1~672@ (Mul (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)) (Mul (Mul 89 b1~12@) (Mul b1~12@ d1~16@))) (Sub (Sub (Mul c1~14@ c1~14@) (Mul b1~12@ d1~16@)) (Mul (Add a1~10@ c1~14@) (Mul b1~12@ d1~16@)))) (Add (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@))) (Mul (Mul a1~10@ (Add d1~16@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ c1~14@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ c1~14@) (=> %%location_label%%1 (= temp_1_0~535@ temp_1_1~672@))) (=> (= temp_1_0~535@ temp_1_1~672@) (=> (= temp_2_0~837@ (Mul (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ c2~22@))) (Mul (Mul (Sub b2~20@ b2~20@) (Add c2~22@ a2~18@)) (Add a2~18@ (Mul c2~22@ a2~18@)))) (Mul (Mul (Add (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@)) (Sub (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ d2~24@)) (Sub (Sub 1 d2~24@) (Mul b2~20@ a2~18@)))))) (=> (= temp_2_1~974@ (Mul (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ c2~22@))) (Mul (Mul (Sub b2~20@ b2~20@) (Add c2~22@ a2~18@)) (Add a2~18@ (Mul c2~22@ a2~18@)))) (Mul (Mul (Add (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@)) (Sub (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Sub (Sub 1 d2~24@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ d2~24@)))))) (and (=> (= tmp%3@ (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ d2~24@))) (=> (= tmp%4@ (Sub (Sub 1 d2~24@) (Mul b2~20@ a2~18@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~837@ temp_2_1~974@))))) (=> (= temp_2_0~837@ temp_2_1~974@) (=> (= temp_3_0~1139@ (Mul (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@))) (Mul a3~26@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)))) (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ a3~26@)) b3~28@) (Mul (Mul (Add d3~32@ a3~26@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ b3~28@) a3~26@))))) (=> (= temp_3_1~1240@ (Mul (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ b3~28@))) (Mul a3~26@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)))) (Mul (Mul (Mul a3~26@ (Mul c3~30@ (Mul a3~26@ a3~26@))) b3~28@) (Mul (Mul (Add d3~32@ a3~26@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ b3~28@) a3~26@))))) (and (=> (= tmp%5@ (Mul a3~26@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a3~26@ c3~30@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~1139@ temp_3_1~1240@)))) (=> (= temp_3_0~1139@ temp_3_1~1240@) (=> (= temp_4_0~1383@ (Mul (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Add d4~40@ d4~40@) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul a4~34@ a4~34@) d4~40@) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)))) (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@)) d4~40@) (Mul (Mul (Mul c4~38@ a4~34@) c4~38@) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@)))))) (=> (= temp_4_1~1492@ (Mul (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Add d4~40@ d4~40@) (Mul c4~38@ a4~34@))) (Mul (Mul a4~34@ (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)))) (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@)) d4~40@) (Mul (Mul (Mul c4~38@ a4~34@) c4~38@) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a4~34@ a4~34@ d4~40@) (=> %%location_label%%4 (= temp_4_0~1383@ temp_4_1~1492@))) (=> (= temp_4_0~1383@ temp_4_1~1492@) (=> (= temp_5_0~1639@ (Mul (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Add a5~42@ d5~48@)) (Mul (Mul c5~46@ 84) (Add b5~44@ d5~48@))) (Mul (Add (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)) d5~48@)) (Sub (Mul (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@))) (Add a5~42@ (Mul (Add a5~42@ d5~48@) (Mul c5~46@ d5~48@)))))) (=> (= temp_5_1~1764@ (Mul (Mul (Mul (Add (Mul (Mul b5~44@ a5~42@) a5~42@) (Mul (Mul b5~44@ a5~42@) d5~48@)) (Mul (Mul c5~46@ 84) (Add b5~44@ d5~48@))) (Mul (Add (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)) d5~48@)) (Sub (Mul (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@))) (Add a5~42@ (Mul (Add a5~42@ d5~48@) (Mul c5~46@ d5~48@)))))) (and (=> (= tmp%6@ (Mul b5~44@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%6@ a5~42@ d5~48@) (=> %%location_label%%5 (= temp_5_0~1639@ temp_5_1~1764@)))) (=> (= temp_5_0~1639@ temp_5_1~1764@) (=> (= temp_6_0~1903@ (Mul (Mul (Mul (Mul (Sub d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Mul a6~50@ (Mul d6~56@ d6~56@))) (Add (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ c6~54@) d6~56@))) (Mul (Mul b6~52@ (Mul (Add b6~52@ a6~50@) a6~50@)) (Mul (Add (Add a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@)))))) (=> (= temp_6_1~2012@ (Mul (Mul (Mul (Mul (Sub d6~56@ c6~54@) (Add a6~50@ c6~54@)) (Mul a6~50@ (Mul d6~56@ d6~56@))) (Add (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ c6~54@) d6~56@))) (Mul (Mul b6~52@ (Add (Mul b6~52@ a6~50@) (Mul a6~50@ a6~50@))) (Mul (Add (Add a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@)))))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b6~52@ a6~50@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1903@ temp_6_1~2012@))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
