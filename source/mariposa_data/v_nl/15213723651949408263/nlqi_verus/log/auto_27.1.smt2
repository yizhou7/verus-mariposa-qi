...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ b0~4@))) (Mul (Add (Mul c0~6@ c0~6@) d0~8@) (Mul (Mul d0~8@ b0~4@) (Add c0~6@ a0~2@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ b0~4@))) (Mul (Add (Mul c0~6@ c0~6@) d0~8@) (Mul d0~8@ (Mul b0~4@ (Add c0~6@ a0~2@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~443@ (Mul (Mul (Mul a1~10@ (Mul c1~14@ b1~12@)) (Sub (Mul c1~14@ c1~14@) (Add a1~10@ d1~16@))) (Mul (Add (Mul a1~10@ c1~14@) a1~10@) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@))))) (=> (= temp_1_1~500@ (Mul (Mul (Mul a1~10@ (Mul c1~14@ b1~12@)) (Sub (Mul c1~14@ c1~14@) (Add a1~10@ d1~16@))) (Mul (Add (Mul c1~14@ a1~10@) a1~10@) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~443@ temp_1_1~500@))) (=> (= temp_1_0~443@ temp_1_1~500@) (=> (= temp_2_0~585@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) d2~24@) (Add (Mul d2~24@ b2~20@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Add d2~24@ d2~24@))))) (=> (= temp_2_1~646@ (Mul (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ (Add (Mul d2~24@ b2~20@) (Mul c2~22@ a2~18@)))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Add d2~24@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~585@ temp_2_1~646@))) (=> (= temp_2_0~585@ temp_2_1~646@) (=> (= temp_3_0~735@ (Add (Mul (Sub (Mul c3~30@ b3~28@) (Mul d3~32@ a3~26@)) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@))) (Mul c3~30@ (Mul (Mul b3~28@ 89) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~816@ (Add (Sub (Mul (Mul c3~30@ b3~28@) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@))) (Mul (Mul d3~32@ a3~26@) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@)))) (Mul c3~30@ (Mul (Mul b3~28@ 89) (Mul c3~30@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~735@ temp_3_1~816@))) (=> (= temp_3_0~735@ temp_3_1~816@) (=> (= temp_4_0~901@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ b4~36@)) (Mul d4~40@ (Mul d4~40@ c4~38@))) (Add (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~962@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ b4~36@)) (Mul d4~40@ (Mul d4~40@ c4~38@))) (Add (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul a4~34@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~901@ temp_4_1~962@))) (=> (= temp_4_0~901@ temp_4_1~962@) (=> (= temp_5_0~1051@ (Mul (Mul (Sub (Mul d5~48@ c5~46@) (Mul b5~44@ c5~46@)) (Mul (Add a5~42@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~1116@ (Mul (Mul (Sub (Mul d5~48@ c5~46@) (Mul b5~44@ c5~46@)) (Mul (Add a5~42@ b5~44@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1051@ temp_5_1~1116@))) (=> (= temp_5_0~1051@ temp_5_1~1116@) (=> (= temp_6_0~1205@ (Mul (Add (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ d6~56@)) (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@))) (Sub (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ a6~50@)) (Sub (Mul b6~52@ d6~56@) (Sub d6~56@ d6~56@))))) (=> (= temp_6_1~1270@ (Mul (Add (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ d6~56@)) (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@))) (Sub (Mul (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)) (Sub (Mul b6~52@ d6~56@) (Sub d6~56@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1205@ temp_6_1~1270@))) (=> (= temp_6_0~1205@ temp_6_1~1270@) (=> (= temp_7_0~1359@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ b7~60@))) (Mul (Mul (Add c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Add d7~64@ a7~58@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1424@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ b7~60@))) (Mul (Mul (Add c7~62@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Add d7~64@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1359@ temp_7_1~1424@))) (=> (= temp_7_0~1359@ temp_7_1~1424@) (=> (= temp_8_0~1525@ (Mul (Mul (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ d8~72@)) (Sub (Sub b8~68@ a8~66@) (Mul b8~68@ d8~72@))) (Add (Mul (Sub b8~68@ d8~72@) (Mul a8~66@ 28)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1602@ (Mul (Mul (Mul c8~70@ a8~66@) (Mul (Mul c8~70@ d8~72@) (Sub (Sub b8~68@ a8~66@) (Mul b8~68@ d8~72@)))) (Add (Mul (Sub b8~68@ d8~72@) (Mul a8~66@ 28)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1525@ temp_8_1~1602@))) (=> (= temp_8_0~1525@ temp_8_1~1602@) (=> (= temp_9_0~1691@ (Mul (Mul (Add (Sub d9~80@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ a9~74@))) (Sub (Mul (Mul c9~78@ b9~76@) (Add c9~78@ a9~74@)) (Add (Mul b9~76@ a9~74@) (Mul b9~76@ b9~76@))))) (=> (= temp_9_1~1756@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ a9~74@)) (Add (Sub d9~80@ a9~74@) (Mul d9~80@ d9~80@))) (Sub (Mul (Mul c9~78@ b9~76@) (Add c9~78@ a9~74@)) (Add (Mul b9~76@ a9~74@) (Mul b9~76@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1691@ temp_9_1~1756@))) (=> (= temp_9_0~1691@ temp_9_1~1756@) (=> (= temp_10_0~1833@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ a10~82@)) a10~82@) (Mul (Mul (Mul b10~84@ d10~88@) (Mul d10~88@ d10~88@)) (Mul (Add d10~88@ a10~82@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~1886@ (Mul (Mul (Mul (Mul d10~88@ d10~88@) (Mul b10~84@ a10~82@)) a10~82@) (Mul (Mul (Add d10~88@ a10~82@) (Mul c10~86@ b10~84@)) (Mul (Mul b10~84@ d10~88@) (Mul d10~88@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1833@ temp_10_1~1886@))) (=> (= temp_10_0~1833@ temp_10_1~1886@) (=> (= temp_11_0~1987@ (Mul (Add (Mul (Mul c11~94@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ 52))) (Mul (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ b11~92@)) (Mul (Add d11~96@ d11~96@) (Mul d11~96@ c11~94@))))) (=> (= temp_11_1~2064@ (Mul (Add (Mul (Mul c11~94@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul d11~96@ 52))) (Mul (Mul (Add d11~96@ d11~96@) (Mul d11~96@ c11~94@)) (Mul (Mul a11~90@ c11~94@) (Mul a11~90@ b11~92@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1987@ temp_11_1~2064@))) (=> (= temp_11_0~1987@ temp_11_1~2064@) (=> (= temp_12_0~2149@ (Mul (Mul (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ a12~98@)) (Mul (Mul a12~98@ b12~100@) (Add c12~102@ c12~102@))) (Mul (Mul (Mul d12~104@ a12~98@) (Sub b12~100@ d12~104@)) (Mul c12~102@ (Mul a12~98@ b12~100@))))) (=> (= temp_12_1~2210@ (Mul (Mul (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ a12~98@)) (Mul (Mul a12~98@ b12~100@) (Add c12~102@ c12~102@))) (Mul (Mul (Mul a12~98@ d12~104@) (Sub b12~100@ d12~104@)) (Mul c12~102@ (Mul a12~98@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2149@ temp_12_1~2210@))) (=> (= temp_12_0~2149@ temp_12_1~2210@) (=> (= temp_13_0~2299@ (Mul (Mul (Mul (Mul a13~106@ d13~112@) (Sub b13~108@ c13~110@)) (Mul (Mul c13~110@ a13~106@) (Mul a13~106@ b13~108@))) (Sub (Mul (Add a13~106@ a13~106@) (Mul d13~112@ d13~112@)) (Mul (Add d13~112@ b13~108@) (Mul c13~110@ a13~106@))))) (=> (= temp_13_1~2364@ (Mul (Mul (Mul (Mul a13~106@ d13~112@) (Sub b13~108@ c13~110@)) (Mul (Mul a13~106@ c13~110@) (Mul a13~106@ b13~108@))) (Sub (Mul (Add a13~106@ a13~106@) (Mul d13~112@ d13~112@)) (Mul (Add d13~112@ b13~108@) (Mul c13~110@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2299@ temp_13_1~2364@))) (=> (= temp_13_0~2299@ temp_13_1~2364@) (=> (= temp_14_0~2453@ (Add (Add (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ d14~120@)) (Mul (Mul a14~114@ d14~120@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ a14~114@)) (Mul (Mul d14~120@ a14~114@) (Add c14~118@ c14~118@))))) (=> (= temp_14_1~2518@ (Add (Add (Mul (Mul b14~116@ c14~118@) (Mul d14~120@ d14~120@)) (Mul (Mul a14~114@ d14~120@) (Mul a14~114@ c14~118@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul a14~114@ c14~118@)) (Mul (Mul d14~120@ a14~114@) (Add c14~118@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2453@ temp_14_1~2518@))) (=> (= temp_14_0~2453@ temp_14_1~2518@) (=> (= temp_15_0~2619@ (Sub (Mul (Mul (Mul d15~128@ a15~122@) (Add d15~128@ c15~126@)) (Mul (Mul a15~122@ a15~122@) (Mul b15~124@ d15~128@))) (Mul (Mul (Add b15~124@ d15~128@) (Mul a15~122@ a15~122@)) (Mul (Mul a15~122@ a15~122@) (Mul 81 c15~126@))))) (=> (= temp_15_1~2696@ (Sub (Mul (Mul (Mul a15~122@ a15~122@) (Mul b15~124@ d15~128@)) (Mul (Mul d15~128@ a15~122@) (Add d15~128@ c15~126@))) (Mul (Mul (Add b15~124@ d15~128@) (Mul a15~122@ a15~122@)) (Mul (Mul a15~122@ a15~122@) (Mul 81 c15~126@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2619@ temp_15_1~2696@))) (=> (= temp_15_0~2619@ temp_15_1~2696@) (=> (= temp_16_0~2781@ (Mul (Mul (Mul d16~136@ (Mul c16~134@ b16~132@)) (Mul (Mul c16~134@ c16~134@) (Mul d16~136@ b16~132@))) (Add (Add (Add b16~132@ a16~130@) (Mul c16~134@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ c16~134@))))) (=> (= temp_16_1~2842@ (Mul (Mul (Mul d16~136@ (Mul c16~134@ b16~132@)) (Mul (Mul c16~134@ c16~134@) (Mul d16~136@ b16~132@))) (Add (Add (Add b16~132@ a16~130@) (Mul c16~134@ c16~134@)) (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2781@ temp_16_1~2842@))) (=> (= temp_16_0~2781@ temp_16_1~2842@) (=> (= temp_17_0~2923@ (Mul (Mul (Add (Mul b17~140@ a17~138@) b17~140@) (Mul (Sub c17~142@ a17~138@) (Mul d17~144@ c17~142@))) (Mul (Mul (Mul b17~140@ b17~140@) (Add a17~138@ c17~142@)) (Mul (Mul c17~142@ d17~144@) d17~144@)))) (=> (= temp_17_1~2980@ (Mul (Mul (Mul (Sub c17~142@ a17~138@) (Mul d17~144@ c17~142@)) (Add (Mul b17~140@ a17~138@) b17~140@)) (Mul (Mul (Mul b17~140@ b17~140@) (Add a17~138@ c17~142@)) (Mul (Mul c17~142@ d17~144@) d17~144@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2923@ temp_17_1~2980@))) (=> (= temp_17_0~2923@ temp_17_1~2980@) (=> (= temp_18_0~3069@ (Mul (Mul (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ a18~146@)) (Mul (Mul b18~148@ d18~152@) (Mul d18~152@ a18~146@))) (Mul (Mul (Sub d18~152@ d18~152@) (Mul c18~150@ d18~152@)) (Mul (Mul d18~152@ c18~150@) (Add d18~152@ c18~150@))))) (=> (= temp_18_1~3134@ (Mul (Mul (Mul (Mul (Mul d18~152@ d18~152@) (Mul d18~152@ a18~146@)) (Mul b18~148@ d18~152@)) (Mul d18~152@ a18~146@)) (Mul (Mul (Sub d18~152@ d18~152@) (Mul c18~150@ d18~152@)) (Mul (Mul d18~152@ c18~150@) (Add d18~152@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3069@ temp_18_1~3134@))) (=> (= temp_18_0~3069@ temp_18_1~3134@) (=> (= temp_19_0~3211@ (Mul (Mul (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ a19~154@)) (Add (Sub c19~158@ a19~154@) (Mul a19~154@ c19~158@))) (Sub c19~158@ (Mul (Mul b19~156@ d19~160@) (Mul c19~158@ d19~160@))))) (=> (= temp_19_1~3296@ (Sub (Mul (Mul (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ a19~154@)) (Add (Sub c19~158@ a19~154@) (Mul a19~154@ c19~158@))) c19~158@) (Mul (Mul (Mul (Mul b19~156@ c19~158@) (Mul a19~154@ a19~154@)) (Add (Sub c19~158@ a19~154@) (Mul a19~154@ c19~158@))) (Mul (Mul b19~156@ d19~160@) (Mul c19~158@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3211@ temp_19_1~3296@))) (=> (= temp_19_0~3211@ temp_19_1~3296@) (=> (= temp_20_0~3385@ (Mul (Mul (Mul (Mul c20~166@ c20~166@) (Sub d20~168@ c20~166@)) (Add (Mul b20~164@ b20~164@) (Add c20~166@ b20~164@))) (Add (Mul (Mul d20~168@ c20~166@) (Sub d20~168@ d20~168@)) (Mul (Add b20~164@ b20~164@) (Mul c20~166@ d20~168@))))) (=> (= temp_20_1~3450@ (Mul (Mul (Add (Mul b20~164@ b20~164@) (Add c20~166@ b20~164@)) (Mul (Mul c20~166@ c20~166@) (Sub d20~168@ c20~166@))) (Add (Mul (Mul d20~168@ c20~166@) (Sub d20~168@ d20~168@)) (Mul (Add b20~164@ b20~164@) (Mul c20~166@ d20~168@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3385@ temp_20_1~3450@))) (=> (= temp_20_0~3385@ temp_20_1~3450@) (=> (= temp_21_0~3539@ (Sub (Mul (Mul (Add a21~170@ b21~172@) (Mul a21~170@ d21~176@)) (Mul (Mul b21~172@ b21~172@) (Mul d21~176@ a21~170@))) (Mul (Mul (Mul b21~172@ b21~172@) (Mul c21~174@ d21~176@)) (Mul (Mul d21~176@ a21~170@) (Mul b21~172@ a21~170@))))) (=> (= temp_21_1~3604@ (Sub (Mul (Mul (Add a21~170@ b21~172@) (Mul a21~170@ d21~176@)) (Mul (Mul b21~172@ b21~172@) (Mul d21~176@ a21~170@))) (Mul (Mul (Mul (Mul b21~172@ b21~172@) c21~174@) d21~176@) (Mul (Mul d21~176@ a21~170@) (Mul b21~172@ a21~170@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3539@ temp_21_1~3604@))) (=> (= temp_21_0~3539@ temp_21_1~3604@) (=> (= temp_22_0~3677@ (Mul (Mul (Mul (Sub b22~180@ 75) (Mul d22~184@ d22~184@)) (Mul (Mul a22~178@ a22~178@) (Mul d22~184@ b22~180@))) a22~178@)) (=> (= temp_22_1~3726@ (Mul (Mul (Mul (Mul d22~184@ d22~184@) (Sub b22~180@ 75)) (Mul (Mul a22~178@ a22~178@) (Mul d22~184@ b22~180@))) a22~178@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3677@ temp_22_1~3726@))) (=> (= temp_22_0~3677@ temp_22_1~3726@) (=> (= temp_23_0~3815@ (Mul (Mul (Mul (Mul b23~188@ c23~190@) (Mul b23~188@ b23~188@)) (Add (Mul c23~190@ b23~188@) (Mul b23~188@ d23~192@))) (Sub (Mul (Add b23~188@ a23~186@) (Sub a23~186@ c23~190@)) (Mul (Mul b23~188@ d23~192@) (Mul c23~190@ a23~186@))))) (=> (= temp_23_1~3880@ (Mul (Mul (Mul (Mul b23~188@ c23~190@) (Mul b23~188@ b23~188@)) (Add (Mul c23~190@ b23~188@) (Mul b23~188@ d23~192@))) (Sub (Mul (Add b23~188@ a23~186@) (Sub a23~186@ c23~190@)) (Mul (Mul b23~188@ d23~192@) (Mul a23~186@ c23~190@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~3815@ temp_23_1~3880@))) (=> (= temp_23_0~3815@ temp_23_1~3880@) (=> (= temp_24_0~3969@ (Sub (Add (Add (Mul a24~194@ b24~196@) (Mul c24~198@ b24~196@)) (Mul (Mul b24~196@ d24~200@) (Mul b24~196@ c24~198@))) (Mul (Mul (Sub c24~198@ c24~198@) (Mul b24~196@ c24~198@)) (Add (Mul c24~198@ d24~200@) (Mul c24~198@ a24~194@))))) (=> (= temp_24_1~4034@ (Sub (Add (Add (Mul b24~196@ a24~194@) (Mul c24~198@ b24~196@)) (Mul (Mul b24~196@ d24~200@) (Mul b24~196@ c24~198@))) (Mul (Mul (Sub c24~198@ c24~198@) (Mul b24~196@ c24~198@)) (Add (Mul c24~198@ d24~200@) (Mul c24~198@ a24~194@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~3969@ temp_24_1~4034@))) (=> (= temp_24_0~3969@ temp_24_1~4034@) (=> (= temp_25_0~4123@ (Mul (Mul (Mul (Mul b25~204@ a25~202@) (Mul d25~208@ d25~208@)) (Mul (Mul a25~202@ b25~204@) (Mul b25~204@ b25~204@))) (Mul (Add (Mul d25~208@ d25~208@) (Mul a25~202@ b25~204@)) (Mul (Mul a25~202@ c25~206@) (Mul c25~206@ d25~208@))))) (=> (= temp_25_1~4188@ (Mul (Mul (Mul (Mul b25~204@ a25~202@) (Mul d25~208@ d25~208@)) (Mul (Mul a25~202@ b25~204@) (Mul b25~204@ b25~204@))) (Mul (Add (Mul d25~208@ d25~208@) (Mul a25~202@ b25~204@)) (Mul (Mul a25~202@ c25~206@) (Mul d25~208@ c25~206@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~4123@ temp_25_1~4188@))) (=> (= temp_25_0~4123@ temp_25_1~4188@) (=> (= temp_26_0~4245@ (Mul (Mul (Sub (Mul a26~210@ b26~212@) (Mul d26~216@ a26~210@)) (Mul (Mul d26~216@ a26~210@) d26~216@)) c26~214@)) (=> (= temp_26_1~4278@ (Mul (Mul (Mul (Mul d26~216@ a26~210@) d26~216@) (Sub (Mul a26~210@ b26~212@) (Mul d26~216@ a26~210@))) c26~214@)) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%26 (= temp_26_0~4245@ temp_26_1~4278@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
