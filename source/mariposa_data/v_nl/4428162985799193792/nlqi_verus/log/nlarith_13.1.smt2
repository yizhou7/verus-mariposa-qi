...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Mul (Sub d0~8@ (Mul a0~2@ b0~4@)) (Mul d0~8@ (Mul a0~2@ d0~8@))) (Mul (Mul (Mul c0~6@ d0~8@) b0~4@) (Add (Mul 5 c0~6@) (Mul b0~4@ a0~2@))))) (=> (= temp_0_1~370@ (Mul (Mul (Sub d0~8@ (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ a0~2@) d0~8@)) (Mul (Mul (Mul c0~6@ d0~8@) b0~4@) (Add (Mul 5 c0~6@) (Mul b0~4@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~370@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~446@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ d1~16@)) (Mul b1~12@ (Sub c1~14@ c1~14@))) (Mul (Add (Mul b1~12@ a1~10@) (Mul b1~12@ d1~16@)) (Mul (Sub a1~10@ d1~16@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~507@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@)) (Mul b1~12@ (Sub c1~14@ c1~14@))) (Mul (Add (Mul b1~12@ a1~10@) (Mul b1~12@ d1~16@)) (Mul (Sub a1~10@ d1~16@) (Mul b1~12@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~446@ temp_1_1~507@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~591@ (Mul (Mul (Mul (Mul 59 c2~22@) d2~24@) (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ a2~18@)) (Mul b2~20@ (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~660@ (Mul (Mul (Mul d2~24@ (Mul 59 c2~22@)) (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ a2~18@)) (Mul b2~20@ (Mul d2~24@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~591@ temp_2_1~660@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~732@ (Mul (Sub (Mul a3~26@ (Sub d3~32@ a3~26@)) (Mul (Mul a3~26@ a3~26@) b3~28@)) (Mul (Mul (Mul a3~26@ 20) (Mul a3~26@ a3~26@)) b3~28@))) (=> (= temp_3_1~789@ (Mul (Sub (Mul a3~26@ (Sub d3~32@ a3~26@)) (Mul (Mul a3~26@ a3~26@) b3~28@)) (Mul (Mul (Mul (Mul a3~26@ 20) a3~26@) a3~26@) b3~28@))) (=> (= tmp%4@ (= temp_3_0~732@ temp_3_1~789@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~869@ (Sub (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Add d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Sub (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~934@ (Sub (Mul (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Add d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Sub (Mul b4~36@ (Mul c4~38@ (Mul a4~34@ d4~40@))) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~869@ temp_4_1~934@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1002@ (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ b5~44@))) (Mul d5~48@ (Add (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1055@ (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ b5~44@))) (Mul d5~48@ (Add (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~1002@ temp_5_1~1055@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1135@ (Sub (Mul (Mul (Mul a6~50@ 75) (Mul b6~52@ a6~50@)) (Mul (Add d6~56@ d6~56@) (Mul c6~54@ d6~56@))) (Mul c6~54@ (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1200@ (Sub (Mul (Mul (Mul a6~50@ 75) (Mul b6~52@ a6~50@)) (Mul (Add d6~56@ d6~56@) (Mul c6~54@ d6~56@))) (Mul c6~54@ (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1135@ temp_6_1~1200@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1268@ (Mul (Mul a7~58@ (Mul (Add a7~58@ d7~64@) (Mul d7~64@ c7~62@))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ d7~64@))))) (=> (= temp_7_1~1321@ (Mul (Mul a7~58@ (Mul (Add a7~58@ d7~64@) (Mul d7~64@ c7~62@))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1268@ temp_7_1~1321@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1401@ (Mul (Mul (Mul (Sub c8~70@ d8~72@) (Mul a8~66@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Sub d8~72@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ d8~72@))))) (=> (= temp_8_1~1474@ (Mul (Mul (Mul (Sub c8~70@ d8~72@) (Mul a8~66@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Sub (Mul d8~72@ (Mul c8~70@ b8~68@)) (Mul a8~66@ (Mul c8~70@ b8~68@))) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1401@ temp_8_1~1474@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1526@ (Mul (Mul d9~80@ (Sub (Mul c9~78@ a9~74@) (Add c9~78@ d9~80@))) (Mul (Mul (Mul b9~76@ c9~78@) b9~76@) a9~74@))) (=> (= temp_9_1~1563@ (Mul (Mul d9~80@ (Sub (Mul c9~78@ a9~74@) (Add c9~78@ d9~80@))) (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ a9~74@)))) (=> (= tmp%10@ (= temp_9_0~1526@ temp_9_1~1563@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1643@ (Mul (Add (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ c10~86@)) (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul b10~84@ d10~88@) (Add b10~84@ a10~82@)) (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ a10~82@))))) (=> (= temp_10_1~1708@ (Mul (Mul (Add (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ c10~86@)) (Mul (Mul c10~86@ d10~88@) (Mul a10~82@ d10~88@))) (Mul (Mul b10~84@ d10~88@) (Add b10~84@ a10~82@))) (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ a10~82@)))) (=> (= tmp%11@ (= temp_10_0~1643@ temp_10_1~1708@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1788@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@)) (Add (Mul d11~96@ a11~90@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ d11~96@)) (Mul (Mul a11~90@ d11~96@) (Mul a11~90@ b11~92@))))) (=> (= temp_11_1~1853@ (Mul (Mul (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ c11~94@)) (Add (Mul d11~96@ a11~90@) (Mul a11~90@ b11~92@))) (Mul (Mul (Mul (Mul b11~92@ a11~90@) (Mul a11~90@ d11~96@)) (Mul a11~90@ d11~96@)) (Mul a11~90@ b11~92@)))) (=> (= tmp%12@ (= temp_11_0~1788@ temp_11_1~1853@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~1929@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) (Mul a12~98@ c12~102@)) (Mul d12~104@ (Mul a12~98@ c12~102@))) (Mul (Mul (Add d12~104@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ d12~104@) (Mul d12~104@ c12~102@))))) (=> (= temp_12_1~1990@ (Mul (Mul (Mul (Mul b12~100@ d12~104@) (Mul a12~98@ c12~102@)) (Mul (Mul a12~98@ c12~102@) d12~104@)) (Mul (Mul (Add d12~104@ d12~104@) (Mul d12~104@ a12~98@)) (Mul (Mul d12~104@ d12~104@) (Mul d12~104@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~1929@ temp_12_1~1990@)) (=> %%location_label%%12 tmp%13@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
