...
(set-info :comment ";; mariposa_data/v_nl//6878346404358128900/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_3_0~891@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Sub (Add (Add (Mul b0~4@ c0~6@) (Mul c0~6@ d0~8@)) a0~2@) (Add (Mul (Sub d0~8@ b0~4@) (Mul b0~4@ b0~4@)) (Sub (Mul d0~8@ c0~6@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~342@ (Sub (Add (Add (Mul b0~4@ c0~6@) (Mul c0~6@ d0~8@)) a0~2@) (Add (Mul (Sub d0~8@ b0~4@) (Mul b0~4@ b0~4@)) (Mul (Sub d0~8@ b0~4@) c0~6@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d0~8@ b0~4@ c0~6@) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~342@))) (=> (= temp_0_0~293@ temp_0_1~342@) (=> (= temp_1_0~433@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Add a1~10@ c1~14@) (Mul a1~10@ c1~14@))) (Mul (Add a1~10@ (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Add d1~16@ b1~12@))))) (=> (= temp_1_1~494@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Add a1~10@ c1~14@) (Mul a1~10@ c1~14@))) (Mul (Add a1~10@ (Mul c1~14@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Add d1~16@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~433@ temp_1_1~494@))) (=> (= temp_1_0~433@ temp_1_1~494@) (=> (= temp_2_0~607@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@))) (Add (Mul (Mul c2~22@ b2~20@) (Mul 76 a2~18@)) (Mul (Add 94 a2~18@) a2~18@)))) (=> (= temp_2_1~724@ (Add (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul c2~22@ b2~20@) (Mul 76 a2~18@))) (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Add 94 a2~18@) a2~18@)))) (and (=> (= tmp%1@ (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ b2~20@)))) (=> (= tmp%2@ (Mul (Mul c2~22@ b2~20@) (Mul 76 a2~18@))) (=> (= tmp%3@ (Mul (Add 94 a2~18@) a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~607@ temp_2_1~724@)))))) (=> (= temp_2_0~607@ temp_2_1~724@) (=> (= temp_3_0~891@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ a3~26@))) (Mul (Add (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@)) (Sub (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@))))) (=> (= temp_3_1~952@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ a3~26@))) (Mul (Mul d3~32@ (Add c3~30@ d3~32@)) (Sub (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d3~32@ c3~30@ d3~32@) (=> %%location_label%%3 (= temp_3_0~891@ temp_3_1~952@))) (=> (= temp_3_0~891@ temp_3_1~952@) (=> (= temp_4_0~1047@ (Mul (Mul (Mul (Add a4~34@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Add (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~1112@ (Mul (Mul (Mul (Mul (Add a4~34@ a4~34@) c4~38@) d4~40@) (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ a4~34@)) (Add (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@))))) (and (=> (= tmp%4@ (Add a4~34@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ c4~38@ d4~40@) (=> %%location_label%%4 (= temp_4_0~1047@ temp_4_1~1112@)))) (=> (= temp_4_0~1047@ temp_4_1~1112@) (=> (= temp_5_0~1183@ (Mul (Mul a5~42@ (Mul (Mul c5~46@ c5~46@) (Sub a5~42@ d5~48@))) (Sub (Mul (Mul c5~46@ a5~42@) b5~44@) c5~46@))) (=> (= temp_5_1~1240@ (Sub (Mul (Mul a5~42@ (Mul (Mul c5~46@ c5~46@) (Sub a5~42@ d5~48@))) (Mul (Mul c5~46@ a5~42@) b5~44@)) (Mul (Mul a5~42@ (Mul (Mul c5~46@ c5~46@) (Sub a5~42@ d5~48@))) c5~46@))) (and (=> (= tmp%5@ (Mul a5~42@ (Mul (Mul c5~46@ c5~46@) (Sub a5~42@ d5~48@)))) (=> (= tmp%6@ (Mul (Mul c5~46@ a5~42@) b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%5@ tmp%6@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1183@ temp_5_1~1240@))))) (=> (= temp_5_0~1183@ temp_5_1~1240@) (=> (= temp_6_0~1367@ (Mul (Add (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ 3)) (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Sub b6~52@ d6~56@) a6~50@) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1468@ (Add (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ 3)) (Mul (Mul (Sub b6~52@ d6~56@) a6~50@) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@)))) (Mul (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Mul (Sub b6~52@ d6~56@) a6~50@) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@)))))) (and (=> (= tmp%7@ (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ 3))) (=> (= tmp%8@ (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ a6~50@))) (=> (= tmp%9@ (Mul (Mul (Sub b6~52@ d6~56@) a6~50@) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%6 (= temp_6_0~1367@ temp_6_1~1468@)))))) (=> (= temp_6_0~1367@ temp_6_1~1468@) (=> (= temp_7_0~1623@ (Add (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Sub d7~64@ b7~60@))) (Mul (Add (Mul a7~58@ c7~62@) (Sub b7~60@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1696@ (Add (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Sub (Mul (Mul d7~64@ b7~60@) d7~64@) (Mul (Mul d7~64@ b7~60@) b7~60@))) (Mul (Add (Mul a7~58@ c7~62@) (Sub b7~60@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ a7~58@))))) (and (=> (= tmp%10@ (Mul d7~64@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%10@ d7~64@ b7~60@) (=> %%location_label%%7 (= temp_7_0~1623@ temp_7_1~1696@)))) (=> (= temp_7_0~1623@ temp_7_1~1696@) (=> (= temp_8_0~1791@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ b8~68@)) (Mul c8~70@ (Mul c8~70@ a8~66@))) (Mul (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1852@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ b8~68@)) (Mul c8~70@ (Mul c8~70@ a8~66@))))) (and (=> (= tmp%11@ (Mul (Mul (Mul c8~70@ d8~72@) (Sub a8~66@ b8~68@)) (Mul c8~70@ (Mul c8~70@ a8~66@)))) (=> (= tmp%12@ (Mul (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ b8~68@)) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ d8~72@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%8 (= temp_8_0~1791@ temp_8_1~1852@))))) (=> (= temp_8_0~1791@ temp_8_1~1852@) (=> (= temp_9_0~1997@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul c9~78@ c9~78@)) (Mul (Sub c9~78@ a9~74@) (Sub b9~76@ a9~74@))) (Add (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ b9~76@)) (Sub (Mul a9~74@ b9~76@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~2062@ (Mul (Mul (Mul a9~74@ b9~76@) (Mul (Mul c9~78@ c9~78@) (Mul (Sub c9~78@ a9~74@) (Sub b9~76@ a9~74@)))) (Add (Mul (Mul b9~76@ c9~78@) (Mul b9~76@ b9~76@)) (Sub (Mul a9~74@ b9~76@) (Mul b9~76@ c9~78@))))) (and (=> (= tmp%13@ (Mul a9~74@ b9~76@)) (=> (= tmp%14@ (Mul c9~78@ c9~78@)) (=> (= tmp%15@ (Mul (Sub c9~78@ a9~74@) (Sub b9~76@ a9~74@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%9 (= temp_9_0~1997@ temp_9_1~2062@)))))) (=> (= temp_9_0~1997@ temp_9_1~2062@) (=> (= temp_10_0~2177@ (Mul (Mul (Add (Mul b10~84@ c10~86@) (Add d10~88@ b10~84@)) (Mul (Mul d10~88@ a10~82@) (Mul a10~82@ a10~82@))) (Add (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ b10~84@)) (Sub (Mul d10~88@ a10~82@) (Mul c10~86@ b10~84@))))) (=> (= temp_10_1~2242@ (Mul (Mul (Add (Mul b10~84@ c10~86@) (Add d10~88@ b10~84@)) (Mul (Mul d10~88@ a10~82@) (Mul a10~82@ a10~82@))) (Add (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ b10~84@)) (Sub (Mul a10~82@ d10~88@) (Mul c10~86@ b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d10~88@ a10~82@) (=> %%location_label%%10 (= temp_10_0~2177@ temp_10_1~2242@))) (=> (= temp_10_0~2177@ temp_10_1~2242@) (=> (= temp_11_0~2335@ (Mul (Add (Mul (Sub b11~92@ d11~96@) (Mul c11~94@ d11~96@)) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Add c11~94@ c11~94@) (Sub b11~92@ a11~90@))))) (=> (= temp_11_1~2408@ (Mul (Add (Sub (Mul b11~92@ (Mul c11~94@ d11~96@)) (Mul d11~96@ (Mul c11~94@ d11~96@))) (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (Mul (Mul (Mul c11~94@ a11~90@) (Mul c11~94@ a11~90@)) (Mul (Add c11~94@ c11~94@) (Sub b11~92@ a11~90@))))) (and (=> (= tmp%16@ (Mul c11~94@ d11~96@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b11~92@ d11~96@ tmp%16@) (=> %%location_label%%11 (= temp_11_0~2335@ temp_11_1~2408@)))) (=> (= temp_11_0~2335@ temp_11_1~2408@) (=> (= temp_12_0~2491@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@)) (Mul (Add d12~104@ d12~104@) (Mul a12~98@ c12~102@))) (Mul a12~98@ (Add d12~104@ (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2540@ (Mul (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ d12~104@)) (Mul (Add d12~104@ d12~104@) (Mul c12~102@ a12~98@))) (Mul a12~98@ (Add d12~104@ (Mul a12~98@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a12~98@ c12~102@) (=> %%location_label%%12 (= temp_12_0~2491@ temp_12_1~2540@))) (=> (= temp_12_0~2491@ temp_12_1~2540@) (=> (= temp_13_0~2629@ (Mul (Mul (Mul b13~108@ (Mul d13~112@ c13~110@)) (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@))) (Mul (Add (Mul c13~110@ d13~112@) (Mul d13~112@ d13~112@)) (Mul (Add a13~106@ b13~108@) (Mul a13~106@ c13~110@))))) (=> (= temp_13_1~2690@ (Mul (Mul (Mul b13~108@ (Mul d13~112@ c13~110@)) (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@))) (Mul (Add (Mul c13~110@ d13~112@) (Mul d13~112@ d13~112@)) (Mul (Add a13~106@ b13~108@) (Mul c13~110@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a13~106@ c13~110@) (=> %%location_label%%13 (= temp_13_0~2629@ temp_13_1~2690@))) (=> (= temp_13_0~2629@ temp_13_1~2690@) (=> (= temp_14_0~2783@ (Mul (Sub (Sub (Sub d14~120@ c14~118@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@))) (Mul (Mul (Mul c14~118@ b14~116@) (Sub c14~118@ b14~116@)) (Mul (Add d14~120@ a14~114@) (Sub a14~114@ b14~116@))))) (=> (= temp_14_1~2856@ (Mul (Sub (Sub (Sub d14~120@ c14~118@) (Mul b14~116@ a14~114@)) (Mul (Mul a14~114@ a14~114@) (Mul d14~120@ a14~114@))) (Mul (Sub (Mul (Mul c14~118@ b14~116@) c14~118@) (Mul (Mul c14~118@ b14~116@) b14~116@)) (Mul (Add d14~120@ a14~114@) (Sub a14~114@ b14~116@))))) (and (=> (= tmp%17@ (Mul c14~118@ b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%17@ c14~118@ b14~116@) (=> %%location_label%%14 (= temp_14_0~2783@ temp_14_1~2856@)))) (=> (= temp_14_0~2783@ temp_14_1~2856@) (=> (= temp_15_0~2939@ (Sub d15~128@ (Add (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul 53 a15~122@))))) (=> (= temp_15_1~2988@ (Sub d15~128@ (Add (Mul (Mul a15~122@ a15~122@) (Mul c15~126@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul a15~122@ 53))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. 53 a15~122@) (=> %%location_label%%15 (= temp_15_0~2939@ temp_15_1~2988@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
