...
(set-info :comment ";; mariposa_data/v_nl//12514867484698418045/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~249@ (Add (Mul (Mul a0~2@ (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@))) (Mul d0~8@ (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@)))) (Mul (Mul c0~6@ (Add (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@))) (Mul (Mul a0~2@ (Mul c0~6@ c0~6@)) (Mul (Sub d0~8@ d0~8@) (Mul a0~2@ a0~2@)))))) (=> (= temp_0_1~338@ (Add (Mul (Mul d0~8@ (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@))) (Mul a0~2@ (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@)))) (Mul (Mul c0~6@ (Add (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@))) (Mul (Mul a0~2@ (Mul c0~6@ c0~6@)) (Mul (Sub d0~8@ d0~8@) (Mul a0~2@ a0~2@)))))) (and (=> (= tmp%1@ (Mul a0~2@ (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@)))) (=> (= tmp%2@ (Mul d0~8@ (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~249@ temp_0_1~338@))))) (=> (= temp_0_0~249@ temp_0_1~338@) (=> (= temp_1_0~527@ (Add (Mul (Mul (Sub (Mul a1~10@ d1~16@) (Add d1~16@ a1~10@)) (Mul (Add a1~10@ b1~12@) (Mul c1~14@ c1~14@))) (Mul (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Sub (Mul d1~16@ a1~10@) (Add d1~16@ b1~12@)))) (Sub (Mul (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ b1~12@)) (Sub (Sub d1~16@ b1~12@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@)))))) (=> (= temp_1_1~656@ (Add (Mul (Mul (Sub (Mul a1~10@ d1~16@) (Add d1~16@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Add a1~10@ b1~12@))) (Mul (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Sub (Mul d1~16@ a1~10@) (Add d1~16@ b1~12@)))) (Sub (Mul (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ b1~12@)) (Sub (Sub d1~16@ b1~12@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@)))))) (and (=> (= tmp%3@ (Add a1~10@ b1~12@)) (=> (= tmp%4@ (Mul c1~14@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~527@ temp_1_1~656@))))) (=> (= temp_1_0~527@ temp_1_1~656@) (=> (= temp_2_0~813@ (Mul (Mul (Mul (Sub c2~22@ (Mul a2~18@ d2~24@)) (Sub (Mul a2~18@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Sub a2~18@ a2~18@) (Mul b2~20@ b2~20@)))) (Mul (Mul (Mul (Add b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Add b2~20@ (Mul d2~24@ b2~20@))) (Mul (Add (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@)))))) (=> (= temp_2_1~934@ (Mul (Mul (Mul (Sub c2~22@ (Mul a2~18@ d2~24@)) (Sub (Mul a2~18@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Sub a2~18@ a2~18@)) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul (Add b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Add b2~20@ (Mul d2~24@ b2~20@))) (Mul (Add (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@)))))) (and (=> (= tmp%5@ (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@))) (=> (= tmp%6@ (Sub a2~18@ a2~18@)) (=> (= tmp%7@ (Mul b2~20@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~813@ temp_2_1~934@)))))) (=> (= temp_2_0~813@ temp_2_1~934@) (=> (= temp_3_0~1021@ (Mul b3~28@ (Mul d3~32@ (Mul (Add d3~32@ (Mul a3~26@ a3~26@)) (Sub (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@)))))) (=> (= temp_3_1~1074@ (Mul b3~28@ (Mul d3~32@ (Add (Mul d3~32@ (Sub (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@))) (Mul (Mul a3~26@ a3~26@) (Sub (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@))))))) (and (=> (= tmp%8@ (Mul a3~26@ a3~26@)) (=> (= tmp%9@ (Sub (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d3~32@ tmp%8@ tmp%9@) (=> %%location_label%%3 (= temp_3_0~1021@ temp_3_1~1074@))))) (=> (= temp_3_0~1021@ temp_3_1~1074@) (=> (= temp_4_0~1265@ (Mul (Mul (Mul (Mul a4~34@ (Mul b4~36@ b4~36@)) (Sub b4~36@ (Mul a4~34@ b4~36@))) (Sub (Mul 23 (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul 32 a4~34@)))) (Mul (Mul (Mul (Sub c4~38@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Sub c4~38@ (Add b4~36@ 8)) (Mul c4~38@ (Mul c4~38@ a4~34@)))))) (=> (= temp_4_1~1434@ (Mul (Sub (Mul (Mul (Mul a4~34@ (Mul b4~36@ b4~36@)) (Sub b4~36@ (Mul a4~34@ b4~36@))) (Mul 23 (Mul d4~40@ d4~40@))) (Mul (Mul (Mul a4~34@ (Mul b4~36@ b4~36@)) (Sub b4~36@ (Mul a4~34@ b4~36@))) (Mul (Mul b4~36@ d4~40@) (Mul 32 a4~34@)))) (Mul (Mul (Mul (Sub c4~38@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Sub c4~38@ (Add b4~36@ 8)) (Mul c4~38@ (Mul c4~38@ a4~34@)))))) (and (=> (= tmp%10@ (Mul (Mul a4~34@ (Mul b4~36@ b4~36@)) (Sub b4~36@ (Mul a4~34@ b4~36@)))) (=> (= tmp%11@ (Mul 23 (Mul d4~40@ d4~40@))) (=> (= tmp%12@ (Mul (Mul b4~36@ d4~40@) (Mul 32 a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%4 (= temp_4_0~1265@ temp_4_1~1434@)))))) (=> (= temp_4_0~1265@ temp_4_1~1434@) (=> (= temp_5_0~1641@ (Mul (Mul (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ b5~44@) c5~46@) (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ d5~48@)))) (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@)) d5~48@) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ a5~42@)) (Mul (Mul b5~44@ c5~46@) (Sub a5~42@ d5~48@)))))) (=> (= temp_5_1~1754@ (Mul (Mul (Mul (Mul (Mul c5~46@ b5~44@) c5~46@) (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@)))) (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@)) d5~48@) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ a5~42@)) (Mul (Mul b5~44@ c5~46@) (Sub a5~42@ d5~48@)))))) (and (=> (= tmp%13@ (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@)))) (=> (= tmp%14@ (Mul (Mul (Mul c5~46@ b5~44@) c5~46@) (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ d5~48@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%5 (= temp_5_0~1641@ temp_5_1~1754@))))) (=> (= temp_5_0~1641@ temp_5_1~1754@) (=> (= temp_6_0~1955@ (Mul (Mul (Sub (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)) (Add b6~52@ (Mul a6~50@ c6~54@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ c6~54@) (Add a6~50@ a6~50@)))) (Mul (Mul (Mul a6~50@ (Mul c6~54@ d6~56@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Sub d6~56@ d6~56@)) (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ d6~56@)))))) (=> (= temp_6_1~2076@ (Mul (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ c6~54@) (Add a6~50@ a6~50@))) (Sub (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)) (Add b6~52@ (Mul a6~50@ c6~54@)))) (Mul (Mul (Mul a6~50@ (Mul c6~54@ d6~56@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Sub d6~56@ d6~56@)) (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ d6~56@)))))) (and (=> (= tmp%15@ (Sub (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)) (Add b6~52@ (Mul a6~50@ c6~54@)))) (=> (= tmp%16@ (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ c6~54@) (Add a6~50@ a6~50@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%6 (= temp_6_0~1955@ temp_6_1~2076@))))) (=> (= temp_6_0~1955@ temp_6_1~2076@) (=> (= temp_7_0~2293@ (Mul (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Add 16 a7~58@))) (Mul (Mul c7~62@ (Add d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ a7~58@)))) (Mul (Mul d7~64@ (Mul (Mul b7~60@ 66) (Sub b7~60@ b7~60@))) (Mul (Sub (Mul a7~58@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ a7~58@)))))) (=> (= temp_7_1~2430@ (Mul (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Add 16 a7~58@))) (Mul (Mul c7~62@ (Add d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ a7~58@)))) (Mul (Mul d7~64@ (Mul (Mul b7~60@ 66) (Sub b7~60@ b7~60@))) (Mul (Sub (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ a7~58@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ d7~64@) (=> %%location_label%%7 (= temp_7_0~2293@ temp_7_1~2430@))) (=> (= temp_7_0~2293@ temp_7_1~2430@) (=> (= temp_8_0~2559@ (Mul (Sub a8~66@ (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ b8~68@)))) (Mul (Add (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ a8~66@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Add b8~68@ b8~68@) (Mul a8~66@ c8~70@)))))) (=> (= temp_8_1~2692@ (Mul (Sub a8~66@ (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ b8~68@)))) (Add (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Add b8~68@ b8~68@) (Mul a8~66@ c8~70@)))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Add b8~68@ b8~68@) (Mul a8~66@ c8~70@))))))) (and (=> (= tmp%17@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ d8~72@))) (=> (= tmp%18@ (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ a8~66@))) (=> (= tmp%19@ (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Add b8~68@ b8~68@) (Mul a8~66@ c8~70@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%8 (= temp_8_0~2559@ temp_8_1~2692@)))))) (=> (= temp_8_0~2559@ temp_8_1~2692@) (=> (= temp_9_0~2899@ (Sub (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Sub d9~80@ b9~76@) b9~76@) (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ a9~74@)))) (Mul (Add (Mul (Sub a9~74@ c9~78@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@)))))) (=> (= temp_9_1~3024@ (Sub (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Sub d9~80@ b9~76@) b9~76@) (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ a9~74@)))) (Mul (Add (Mul (Sub a9~74@ c9~78@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@)))))) (and (=> (= tmp%20@ (Mul a9~74@ d9~80@)) (=> (= tmp%21@ (Mul a9~74@ d9~80@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%9 (= temp_9_0~2899@ temp_9_1~3024@))))) (=> (= temp_9_0~2899@ temp_9_1~3024@) (=> (= temp_10_0~3197@ (Sub (Mul (Add (Mul (Mul d10~88@ c10~86@) (Sub d10~88@ c10~86@)) (Add (Add d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Sub b10~84@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ d10~88@)))) (Mul (Sub (Sub a10~82@ (Mul b10~84@ c10~86@)) (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@))) (Mul (Mul (Mul d10~88@ a10~82@) (Mul 36 d10~88@)) (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ d10~88@)))))) (=> (= temp_10_1~3334@ (Sub (Mul (Add (Mul (Mul d10~88@ c10~86@) (Sub d10~88@ c10~86@)) (Add (Add d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Sub b10~84@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ d10~88@)))) (Mul (Sub (Sub a10~82@ (Mul b10~84@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ a10~82@) (Mul 36 d10~88@)) (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ d10~88@)))))) (and (=> (= tmp%22@ (Mul c10~86@ b10~84@)) (=> (= tmp%23@ (Mul a10~82@ c10~86@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%22@ tmp%23@) (=> %%location_label%%10 (= temp_10_0~3197@ temp_10_1~3334@))))) (=> (= temp_10_0~3197@ temp_10_1~3334@) (=> (= temp_11_0~3467@ (Sub (Mul (Mul (Mul b11~92@ (Mul a11~90@ a11~90@)) (Mul (Sub c11~94@ c11~94@) a11~90@)) (Add (Mul (Add a11~90@ b11~92@) a11~90@) (Sub a11~90@ (Mul d11~96@ b11~92@)))) (Mul (Mul (Add (Mul b11~92@ b11~92@) (Add c11~94@ d11~96@)) (Sub (Mul d11~96@ c11~94@) (Sub a11~90@ b11~92@))) (Sub (Sub b11~92@ (Mul a11~90@ a11~90@)) c11~94@)))) (=> (= temp_11_1~3564@ (Sub (Mul (Mul b11~92@ (Mul a11~90@ a11~90@)) (Mul (Mul (Sub c11~94@ c11~94@) a11~90@) (Add (Mul (Add a11~90@ b11~92@) a11~90@) (Sub a11~90@ (Mul d11~96@ b11~92@))))) (Mul (Mul (Add (Mul b11~92@ b11~92@) (Add c11~94@ d11~96@)) (Sub (Mul d11~96@ c11~94@) (Sub a11~90@ b11~92@))) (Sub (Sub b11~92@ (Mul a11~90@ a11~90@)) c11~94@)))) (and (=> (= tmp%24@ (Mul b11~92@ (Mul a11~90@ a11~90@))) (=> (= tmp%25@ (Mul (Sub c11~94@ c11~94@) a11~90@)) (=> (= tmp%26@ (Add (Mul (Add a11~90@ b11~92@) a11~90@) (Sub a11~90@ (Mul d11~96@ b11~92@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%24@ tmp%25@ tmp%26@) (=> %%location_label%%11 (= temp_11_0~3467@ temp_11_1~3564@)))))) (=> (= temp_11_0~3467@ temp_11_1~3564@) (=> (= temp_12_0~3763@ (Mul (Mul b12~100@ (Mul (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ d12~104@)) (Mul c12~102@ (Mul b12~100@ a12~98@)))) (Mul (Mul (Sub (Mul d12~104@ b12~100@) (Sub b12~100@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ 12))) (Add (Mul (Sub c12~102@ 92) (Mul b12~100@ b12~100@)) (Mul (Mul a12~98@ a12~98@) (Mul c12~102@ 78)))))) (=> (= temp_12_1~3896@ (Mul (Mul (Mul b12~100@ (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ d12~104@))) (Mul c12~102@ (Mul b12~100@ a12~98@))) (Mul (Mul (Sub (Mul d12~104@ b12~100@) (Sub b12~100@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ 12))) (Add (Mul (Sub c12~102@ 92) (Mul b12~100@ b12~100@)) (Mul (Mul a12~98@ a12~98@) (Mul c12~102@ 78)))))) (=> (= tmp%27@ (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ d12~104@))) (=> (= tmp%28@ (Mul c12~102@ (Mul b12~100@ a12~98@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. b12~100@ tmp%27@ tmp%28@) (=> %%location_label%%12 (= temp_12_0~3763@ temp_12_1~3896@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
