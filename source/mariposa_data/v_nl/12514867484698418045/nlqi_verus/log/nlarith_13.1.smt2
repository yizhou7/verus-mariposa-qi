...
(declare-const temp_1_1~611@ Int)
(declare-const temp_2_0~747@ Int)
(declare-const temp_2_1~868@ Int)
(declare-const temp_3_0~920@ Int)
(declare-const temp_3_1~973@ Int)
(declare-const temp_4_0~1133@ Int)
(declare-const temp_4_1~1302@ Int)
(declare-const temp_5_0~1430@ Int)
(declare-const temp_5_1~1543@ Int)
(declare-const temp_6_0~1679@ Int)
(declare-const temp_6_1~1800@ Int)
(declare-const temp_7_0~1952@ Int)
(declare-const temp_7_1~2089@ Int)
(declare-const temp_8_0~2205@ Int)
(declare-const temp_8_1~2338@ Int)
(declare-const temp_9_0~2478@ Int)
(declare-const temp_9_1~2603@ Int)
(declare-const temp_10_0~2755@ Int)
(declare-const temp_10_1~2892@ Int)
(declare-const temp_11_0~3004@ Int)
(declare-const temp_11_1~3101@ Int)
(declare-const temp_12_0~3249@ Int)
(declare-const temp_12_1~3382@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~249@ (Add (Mul (Mul a0~2@ (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@))) (Mul d0~8@ (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@)))) (Mul (Mul c0~6@ (Add (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@))) (Mul (Mul a0~2@ (Mul c0~6@ c0~6@)) (Mul (Sub d0~8@ d0~8@) (Mul a0~2@ a0~2@)))))) (=> (= temp_0_1~338@ (Add (Mul (Mul d0~8@ (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@))) (Mul a0~2@ (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ b0~4@)))) (Mul (Mul c0~6@ (Add (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@))) (Mul (Mul a0~2@ (Mul c0~6@ c0~6@)) (Mul (Sub d0~8@ d0~8@) (Mul a0~2@ a0~2@)))))) (=> (= tmp%1@ (= temp_0_0~249@ temp_0_1~338@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~482@ (Add (Mul (Mul (Sub (Mul a1~10@ d1~16@) (Add d1~16@ a1~10@)) (Mul (Add a1~10@ b1~12@) (Mul c1~14@ c1~14@))) (Mul (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Sub (Mul d1~16@ a1~10@) (Add d1~16@ b1~12@)))) (Sub (Mul (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ b1~12@)) (Sub (Sub d1~16@ b1~12@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@)))))) (=> (= temp_1_1~611@ (Add (Mul (Mul (Sub (Mul a1~10@ d1~16@) (Add d1~16@ a1~10@)) (Mul (Mul c1~14@ c1~14@) (Add a1~10@ b1~12@))) (Mul (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Sub (Mul d1~16@ a1~10@) (Add d1~16@ b1~12@)))) (Sub (Mul (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ b1~12@)) (Sub (Sub d1~16@ b1~12@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@)))))) (=> (= tmp%2@ (= temp_1_0~482@ temp_1_1~611@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~747@ (Mul (Mul (Mul (Sub c2~22@ (Mul a2~18@ d2~24@)) (Sub (Mul a2~18@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Sub a2~18@ a2~18@) (Mul b2~20@ b2~20@)))) (Mul (Mul (Mul (Add b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Add b2~20@ (Mul d2~24@ b2~20@))) (Mul (Add (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@)))))) (=> (= temp_2_1~868@ (Mul (Mul (Mul (Sub c2~22@ (Mul a2~18@ d2~24@)) (Sub (Mul a2~18@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)) (Sub a2~18@ a2~18@)) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul (Add b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Add b2~20@ (Mul d2~24@ b2~20@))) (Mul (Add (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@)))))) (=> (= tmp%3@ (= temp_2_0~747@ temp_2_1~868@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~920@ (Mul b3~28@ (Mul d3~32@ (Mul (Add d3~32@ (Mul a3~26@ a3~26@)) (Sub (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@)))))) (=> (= temp_3_1~973@ (Mul b3~28@ (Mul d3~32@ (Add (Mul d3~32@ (Sub (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@))) (Mul (Mul a3~26@ a3~26@) (Sub (Mul d3~32@ c3~30@) (Mul c3~30@ a3~26@))))))) (=> (= tmp%4@ (= temp_3_0~920@ temp_3_1~973@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1133@ (Mul (Mul (Mul (Mul a4~34@ (Mul b4~36@ b4~36@)) (Sub b4~36@ (Mul a4~34@ b4~36@))) (Sub (Mul 23 (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul 32 a4~34@)))) (Mul (Mul (Mul (Sub c4~38@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Sub c4~38@ (Add b4~36@ 8)) (Mul c4~38@ (Mul c4~38@ a4~34@)))))) (=> (= temp_4_1~1302@ (Mul (Sub (Mul (Mul (Mul a4~34@ (Mul b4~36@ b4~36@)) (Sub b4~36@ (Mul a4~34@ b4~36@))) (Mul 23 (Mul d4~40@ d4~40@))) (Mul (Mul (Mul a4~34@ (Mul b4~36@ b4~36@)) (Sub b4~36@ (Mul a4~34@ b4~36@))) (Mul (Mul b4~36@ d4~40@) (Mul 32 a4~34@)))) (Mul (Mul (Mul (Sub c4~38@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Sub c4~38@ (Add b4~36@ 8)) (Mul c4~38@ (Mul c4~38@ a4~34@)))))) (=> (= tmp%5@ (= temp_4_0~1133@ temp_4_1~1302@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1430@ (Mul (Mul (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ b5~44@) c5~46@) (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ d5~48@)))) (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@)) d5~48@) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ a5~42@)) (Mul (Mul b5~44@ c5~46@) (Sub a5~42@ d5~48@)))))) (=> (= temp_5_1~1543@ (Mul (Mul (Mul (Mul (Mul c5~46@ b5~44@) c5~46@) (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@)))) (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@)) d5~48@) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ a5~42@)) (Mul (Mul b5~44@ c5~46@) (Sub a5~42@ d5~48@)))))) (=> (= tmp%6@ (= temp_5_0~1430@ temp_5_1~1543@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1679@ (Mul (Mul (Sub (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)) (Add b6~52@ (Mul a6~50@ c6~54@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ c6~54@) (Add a6~50@ a6~50@)))) (Mul (Mul (Mul a6~50@ (Mul c6~54@ d6~56@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Sub d6~56@ d6~56@)) (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ d6~56@)))))) (=> (= temp_6_1~1800@ (Mul (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul a6~50@ c6~54@) (Add a6~50@ a6~50@))) (Sub (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)) (Add b6~52@ (Mul a6~50@ c6~54@)))) (Mul (Mul (Mul a6~50@ (Mul c6~54@ d6~56@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Sub d6~56@ d6~56@)) (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ d6~56@)))))) (=> (= tmp%7@ (= temp_6_0~1679@ temp_6_1~1800@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1952@ (Mul (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Add 16 a7~58@))) (Mul (Mul c7~62@ (Add d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ a7~58@)))) (Mul (Mul d7~64@ (Mul (Mul b7~60@ 66) (Sub b7~60@ b7~60@))) (Mul (Sub (Mul a7~58@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ a7~58@)))))) (=> (= temp_7_1~2089@ (Mul (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Add 16 a7~58@))) (Mul (Mul c7~62@ (Add d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ a7~58@)))) (Mul (Mul d7~64@ (Mul (Mul b7~60@ 66) (Sub b7~60@ b7~60@))) (Mul (Sub (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ a7~58@)))))) (=> (= tmp%8@ (= temp_7_0~1952@ temp_7_1~2089@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2205@ (Mul (Sub a8~66@ (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ b8~68@)))) (Mul (Add (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ a8~66@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Add b8~68@ b8~68@) (Mul a8~66@ c8~70@)))))) (=> (= temp_8_1~2338@ (Mul (Sub a8~66@ (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ b8~68@)))) (Add (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Add b8~68@ b8~68@) (Mul a8~66@ c8~70@)))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Add b8~68@ b8~68@) (Mul a8~66@ c8~70@))))))) (=> (= tmp%9@ (= temp_8_0~2205@ temp_8_1~2338@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2478@ (Sub (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Sub d9~80@ b9~76@) b9~76@) (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ a9~74@)))) (Mul (Add (Mul (Sub a9~74@ c9~78@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@)))))) (=> (= temp_9_1~2603@ (Sub (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul c9~78@ d9~80@)) (Mul (Mul c9~78@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Sub d9~80@ b9~76@) b9~76@) (Mul (Mul c9~78@ d9~80@) (Mul b9~76@ a9~74@)))) (Mul (Add (Mul (Sub a9~74@ c9~78@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ d9~80@))) (Mul (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@)))))) (=> (= tmp%10@ (= temp_9_0~2478@ temp_9_1~2603@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~2755@ (Sub (Mul (Add (Mul (Mul d10~88@ c10~86@) (Sub d10~88@ c10~86@)) (Add (Add d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Sub b10~84@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ d10~88@)))) (Mul (Sub (Sub a10~82@ (Mul b10~84@ c10~86@)) (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ c10~86@))) (Mul (Mul (Mul d10~88@ a10~82@) (Mul 36 d10~88@)) (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ d10~88@)))))) (=> (= temp_10_1~2892@ (Sub (Mul (Add (Mul (Mul d10~88@ c10~86@) (Sub d10~88@ c10~86@)) (Add (Add d10~88@ b10~84@) (Mul c10~86@ a10~82@))) (Mul (Mul (Mul c10~86@ a10~82@) (Sub b10~84@ d10~88@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ d10~88@)))) (Mul (Sub (Sub a10~82@ (Mul b10~84@ c10~86@)) (Mul (Mul a10~82@ c10~86@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul d10~88@ a10~82@) (Mul 36 d10~88@)) (Mul (Mul a10~82@ b10~84@) (Mul a10~82@ d10~88@)))))) (=> (= tmp%11@ (= temp_10_0~2755@ temp_10_1~2892@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~3004@ (Sub (Mul (Mul (Mul b11~92@ (Mul a11~90@ a11~90@)) (Mul (Sub c11~94@ c11~94@) a11~90@)) (Add (Mul (Add a11~90@ b11~92@) a11~90@) (Sub a11~90@ (Mul d11~96@ b11~92@)))) (Mul (Mul (Add (Mul b11~92@ b11~92@) (Add c11~94@ d11~96@)) (Sub (Mul d11~96@ c11~94@) (Sub a11~90@ b11~92@))) (Sub (Sub b11~92@ (Mul a11~90@ a11~90@)) c11~94@)))) (=> (= temp_11_1~3101@ (Sub (Mul (Mul b11~92@ (Mul a11~90@ a11~90@)) (Mul (Mul (Sub c11~94@ c11~94@) a11~90@) (Add (Mul (Add a11~90@ b11~92@) a11~90@) (Sub a11~90@ (Mul d11~96@ b11~92@))))) (Mul (Mul (Add (Mul b11~92@ b11~92@) (Add c11~94@ d11~96@)) (Sub (Mul d11~96@ c11~94@) (Sub a11~90@ b11~92@))) (Sub (Sub b11~92@ (Mul a11~90@ a11~90@)) c11~94@)))) (=> (= tmp%12@ (= temp_11_0~3004@ temp_11_1~3101@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~3249@ (Mul (Mul b12~100@ (Mul (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ d12~104@)) (Mul c12~102@ (Mul b12~100@ a12~98@)))) (Mul (Mul (Sub (Mul d12~104@ b12~100@) (Sub b12~100@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ 12))) (Add (Mul (Sub c12~102@ 92) (Mul b12~100@ b12~100@)) (Mul (Mul a12~98@ a12~98@) (Mul c12~102@ 78)))))) (=> (= temp_12_1~3382@ (Mul (Mul (Mul b12~100@ (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ d12~104@))) (Mul c12~102@ (Mul b12~100@ a12~98@))) (Mul (Mul (Sub (Mul d12~104@ b12~100@) (Sub b12~100@ a12~98@)) (Mul (Mul c12~102@ c12~102@) (Mul a12~98@ 12))) (Add (Mul (Sub c12~102@ 92) (Mul b12~100@ b12~100@)) (Mul (Mul a12~98@ a12~98@) (Mul c12~102@ 78)))))) (=> (= tmp%13@ (= temp_12_0~3249@ temp_12_1~3382@)) (=> %%location_label%%12 tmp%13@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
