...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ d0~8@) b0~4@)) (Mul (Add (Mul d0~8@ b0~4@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~362@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ a0~2@) b0~4@)) (Mul (Add (Mul d0~8@ b0~4@) (Mul d0~8@ c0~6@)) (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~439@ (Add (Add (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Add a1~10@ d1~16@) (Mul d1~16@ d1~16@))) (Mul (Add (Add a1~10@ b1~12@) (Mul b1~12@ d1~16@)) b1~12@))) (=> (= temp_1_1~492@ (Add (Add (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Add a1~10@ d1~16@) (Mul d1~16@ d1~16@))) (Mul (Add (Add a1~10@ b1~12@) (Mul b1~12@ d1~16@)) b1~12@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~439@ temp_1_1~492@))) (=> (= temp_1_0~439@ temp_1_1~492@) (=> (= temp_2_0~593@ (Mul (Sub (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ 54)) (Mul (Mul b2~20@ d2~24@) (Sub b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ c2~22@)) (Add (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~702@ (Sub (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ 54)) (Mul (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ c2~22@)) (Add (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@)))) (Mul (Mul (Mul b2~20@ d2~24@) (Sub b2~20@ c2~22@)) (Mul (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ c2~22@)) (Add (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~593@ temp_2_1~702@))) (=> (= temp_2_0~593@ temp_2_1~702@) (=> (= temp_3_0~791@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ a3~26@)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~856@ (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ d3~32@))) (Mul (Mul a3~26@ (Mul a3~26@ (Mul d3~32@ a3~26@))) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~791@ temp_3_1~856@))) (=> (= temp_3_0~791@ temp_3_1~856@) (=> (= temp_4_0~945@ (Mul (Add (Mul (Mul b4~36@ b4~36@) (Sub a4~34@ b4~36@)) (Mul (Sub a4~34@ b4~36@) (Mul a4~34@ d4~40@))) (Add (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Sub d4~40@ c4~38@))))) (=> (= temp_4_1~1018@ (Mul (Add (Mul (Mul b4~36@ b4~36@) (Sub a4~34@ b4~36@)) (Sub (Mul a4~34@ (Mul a4~34@ d4~40@)) (Mul b4~36@ (Mul a4~34@ d4~40@)))) (Add (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Sub d4~40@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~945@ temp_4_1~1018@))) (=> (= temp_4_0~945@ temp_4_1~1018@) (=> (= temp_5_0~1131@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@)) (Add (Mul d5~48@ 21) (Mul b5~44@ a5~42@))) (Mul (Mul (Add d5~48@ a5~42@) (Sub d5~48@ 32)) (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1220@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@)) (Add (Mul d5~48@ 21) (Mul b5~44@ a5~42@))) (Mul (Mul (Add d5~48@ a5~42@) (Sub d5~48@ 32)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1131@ temp_5_1~1220@))) (=> (= temp_5_0~1131@ temp_5_1~1220@) (=> (= temp_6_0~1297@ (Mul (Mul b6~52@ (Mul (Sub c6~54@ b6~52@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ d6~56@)) (Mul (Sub c6~54@ a6~50@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1350@ (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ d6~56@)) (Mul (Sub c6~54@ a6~50@) (Mul b6~52@ d6~56@))) (Mul b6~52@ (Mul (Sub c6~54@ b6~52@) (Mul b6~52@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1297@ temp_6_1~1350@))) (=> (= temp_6_0~1297@ temp_6_1~1350@) (=> (= temp_7_0~1439@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Add b7~60@ a7~58@)) (Sub (Sub b7~60@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul c7~62@ a7~58@) (Sub a7~58@ a7~58@)) (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1504@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) (Add b7~60@ a7~58@)) (Sub (Sub b7~60@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul c7~62@ a7~58@) (Sub a7~58@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1439@ temp_7_1~1504@))) (=> (= temp_7_0~1439@ temp_7_1~1504@) (=> (= temp_8_0~1581@ (Mul (Sub (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ d8~72@) (Add d8~72@ d8~72@))) (Mul c8~70@ (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1634@ (Mul (Sub (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Add d8~72@ d8~72@) (Mul a8~66@ d8~72@))) (Mul c8~70@ (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1581@ temp_8_1~1634@))) (=> (= temp_8_0~1581@ temp_8_1~1634@) (=> (= temp_9_0~1719@ (Mul (Mul (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ a9~74@) (Mul d9~80@ d9~80@))) (Mul (Mul (Mul c9~78@ d9~80@) (Add b9~76@ a9~74@)) (Mul c9~78@ (Sub b9~76@ a9~74@))))) (=> (= temp_9_1~1780@ (Mul (Mul (Mul (Mul a9~74@ a9~74@) (Mul d9~80@ d9~80@)) (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ a9~74@))) (Mul (Mul (Mul c9~78@ d9~80@) (Add b9~76@ a9~74@)) (Mul c9~78@ (Sub b9~76@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1719@ temp_9_1~1780@))) (=> (= temp_9_0~1719@ temp_9_1~1780@) (=> (= temp_10_0~1869@ (Add (Mul (Mul (Mul d10~88@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Mul c10~86@ d10~88@) (Mul b10~84@ d10~88@))) (Mul (Add (Mul a10~82@ d10~88@) (Mul c10~86@ a10~82@)) (Sub (Sub a10~82@ b10~84@) (Add b10~84@ d10~88@))))) (=> (= temp_10_1~1934@ (Add (Mul (Mul (Mul d10~88@ a10~82@) (Mul d10~88@ c10~86@)) (Mul (Mul c10~86@ d10~88@) (Mul b10~84@ d10~88@))) (Mul (Sub (Sub a10~82@ b10~84@) (Add b10~84@ d10~88@)) (Add (Mul a10~82@ d10~88@) (Mul c10~86@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1869@ temp_10_1~1934@))) (=> (= temp_10_0~1869@ temp_10_1~1934@) (=> (= temp_11_0~2035@ (Mul (Add (Sub (Mul c11~94@ a11~90@) (Mul c11~94@ d11~96@)) (Sub (Mul b11~92@ b11~92@) (Sub c11~94@ 10))) (Mul (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ d11~96@))))) (=> (= temp_11_1~2112@ (Mul (Add (Sub (Mul c11~94@ a11~90@) (Mul d11~96@ c11~94@)) (Sub (Mul b11~92@ b11~92@) (Sub c11~94@ 10))) (Mul (Mul (Mul d11~96@ b11~92@) (Mul a11~90@ b11~92@)) (Mul (Mul a11~90@ d11~96@) (Mul c11~94@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2035@ temp_11_1~2112@))) (=> (= temp_11_0~2035@ temp_11_1~2112@) (=> (= temp_12_0~2201@ (Mul (Mul (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ c12~102@)) (Mul (Add b12~100@ d12~104@) (Mul b12~100@ a12~98@))) (Mul (Mul (Mul c12~102@ a12~98@) (Mul b12~100@ c12~102@)) (Mul (Mul b12~100@ c12~102@) (Mul b12~100@ d12~104@))))) (=> (= temp_12_1~2266@ (Mul (Mul (Mul (Add b12~100@ d12~104@) (Mul b12~100@ a12~98@)) (Mul (Mul c12~102@ b12~100@) (Mul a12~98@ c12~102@))) (Mul (Mul (Mul c12~102@ a12~98@) (Mul b12~100@ c12~102@)) (Mul (Mul b12~100@ c12~102@) (Mul b12~100@ d12~104@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2201@ temp_12_1~2266@))) (=> (= temp_12_0~2201@ temp_12_1~2266@) (=> (= temp_13_0~2339@ (Sub (Mul (Mul (Mul a13~106@ b13~108@) (Mul d13~112@ c13~110@)) c13~110@) (Mul (Mul (Mul a13~106@ c13~110@) (Mul a13~106@ b13~108@)) (Add d13~112@ (Add c13~110@ b13~108@))))) (=> (= temp_13_1~2388@ (Sub (Mul (Mul (Mul a13~106@ b13~108@) (Mul d13~112@ c13~110@)) c13~110@) (Mul (Add d13~112@ (Add c13~110@ b13~108@)) (Mul (Mul a13~106@ c13~110@) (Mul a13~106@ b13~108@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2339@ temp_13_1~2388@))) (=> (= temp_13_0~2339@ temp_13_1~2388@) (=> (= temp_14_0~2465@ (Sub (Mul (Mul (Mul c14~118@ b14~116@) (Mul d14~120@ a14~114@)) d14~120@) (Mul (Mul (Mul c14~118@ a14~114@) (Mul a14~114@ c14~118@)) (Mul (Mul a14~114@ d14~120@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2518@ (Sub (Mul (Mul (Mul c14~118@ b14~116@) (Mul d14~120@ a14~114@)) d14~120@) (Mul (Mul (Mul c14~118@ a14~114@) (Mul a14~114@ c14~118@)) (Mul a14~114@ (Mul d14~120@ (Mul c14~118@ d14~120@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2465@ temp_14_1~2518@))) (=> (= temp_14_0~2465@ temp_14_1~2518@) (=> (= temp_15_0~2603@ (Mul (Mul (Mul (Mul a15~122@ b15~124@) (Mul c15~126@ b15~124@)) (Add a15~122@ (Mul a15~122@ a15~122@))) (Mul (Mul (Add d15~128@ b15~124@) (Sub b15~124@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ b15~124@))))) (=> (= temp_15_1~2680@ (Mul (Add (Mul (Mul (Mul a15~122@ b15~124@) (Mul c15~126@ b15~124@)) a15~122@) (Mul (Mul (Mul a15~122@ b15~124@) (Mul c15~126@ b15~124@)) (Mul a15~122@ a15~122@))) (Mul (Mul (Add d15~128@ b15~124@) (Sub b15~124@ c15~126@)) (Mul (Mul b15~124@ b15~124@) (Mul b15~124@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2603@ temp_15_1~2680@))) (=> (= temp_15_0~2603@ temp_15_1~2680@) (=> (= temp_16_0~2753@ (Mul (Mul d16~136@ (Mul (Sub b16~132@ b16~132@) (Mul c16~134@ b16~132@))) (Mul (Mul c16~134@ (Mul b16~132@ a16~130@)) (Mul (Mul c16~134@ a16~130@) (Sub d16~136@ d16~136@))))) (=> (= temp_16_1~2802@ (Mul (Mul (Mul d16~136@ (Sub b16~132@ b16~132@)) (Mul c16~134@ b16~132@)) (Mul (Mul c16~134@ (Mul b16~132@ a16~130@)) (Mul (Mul c16~134@ a16~130@) (Sub d16~136@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2753@ temp_16_1~2802@))) (=> (= temp_16_0~2753@ temp_16_1~2802@) (=> (= temp_17_0~2891@ (Add (Mul (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ a17~138@)) (Mul (Mul d17~144@ c17~142@) (Mul a17~138@ b17~140@))) (Mul (Mul (Mul b17~140@ b17~140@) (Mul c17~142@ d17~144@)) (Sub (Mul c17~142@ c17~142@) (Add a17~138@ a17~138@))))) (=> (= temp_17_1~2956@ (Add (Mul (Mul (Mul b17~140@ c17~142@) (Mul b17~140@ a17~138@)) (Mul (Mul d17~144@ c17~142@) (Mul a17~138@ b17~140@))) (Mul (Mul b17~140@ b17~140@) (Mul (Mul c17~142@ d17~144@) (Sub (Mul c17~142@ c17~142@) (Add a17~138@ a17~138@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2891@ temp_17_1~2956@))) (=> (= temp_17_0~2891@ temp_17_1~2956@) (=> (= temp_18_0~3029@ (Sub a18~146@ (Mul (Mul (Mul d18~152@ b18~148@) (Mul b18~148@ a18~146@)) (Mul (Mul c18~150@ b18~148@) (Mul 14 c18~150@))))) (=> (= temp_18_1~3078@ (Sub a18~146@ (Mul (Mul (Mul c18~150@ b18~148@) (Mul 14 c18~150@)) (Mul (Mul d18~152@ b18~148@) (Mul b18~148@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3029@ temp_18_1~3078@))) (=> (= temp_18_0~3029@ temp_18_1~3078@) (=> (= temp_19_0~3179@ (Mul (Add (Sub (Mul a19~154@ c19~158@) (Mul b19~156@ c19~158@)) (Sub (Mul d19~160@ c19~158@) (Mul c19~158@ b19~156@))) (Mul (Mul (Mul 54 c19~158@) (Mul b19~156@ b19~156@)) (Mul (Mul d19~160@ b19~156@) (Mul b19~156@ d19~160@))))) (=> (= temp_19_1~3256@ (Mul (Add (Sub (Mul a19~154@ c19~158@) (Mul b19~156@ c19~158@)) (Sub (Mul d19~160@ c19~158@) (Mul c19~158@ b19~156@))) (Mul (Mul (Mul (Mul 54 c19~158@) b19~156@) b19~156@) (Mul (Mul d19~160@ b19~156@) (Mul b19~156@ d19~160@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3179@ temp_19_1~3256@))) (=> (= temp_19_0~3179@ temp_19_1~3256@) (=> (= temp_20_0~3321@ (Mul (Mul (Mul a20~162@ (Mul c20~166@ a20~162@)) (Mul a20~162@ (Mul b20~164@ 60))) d20~168@)) (=> (= temp_20_1~3362@ (Mul (Mul (Mul (Mul c20~166@ a20~162@) a20~162@) (Mul a20~162@ (Mul b20~164@ 60))) d20~168@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3321@ temp_20_1~3362@))) (=> (= temp_20_0~3321@ temp_20_1~3362@) (=> (= temp_21_0~3459@ (Mul (Add (Mul (Mul d21~176@ d21~176@) (Mul c21~174@ d21~176@)) (Mul (Mul b21~172@ a21~170@) c21~174@)) (Mul (Mul (Mul a21~170@ b21~172@) (Mul a21~170@ 95)) (Mul (Mul d21~176@ a21~170@) (Mul c21~174@ b21~172@))))) (=> (= temp_21_1~3532@ (Mul (Add (Mul (Mul d21~176@ d21~176@) (Mul c21~174@ d21~176@)) (Mul (Mul b21~172@ a21~170@) c21~174@)) (Mul (Mul (Mul a21~170@ b21~172@) (Mul a21~170@ 95)) (Mul (Mul d21~176@ a21~170@) (Mul b21~172@ c21~174@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3459@ temp_21_1~3532@))) (=> (= temp_21_0~3459@ temp_21_1~3532@) (=> (= temp_22_0~3617@ (Mul (Add (Mul (Mul d22~184@ c22~182@) (Sub b22~180@ a22~178@)) (Mul b22~180@ (Mul c22~182@ b22~180@))) (Mul (Mul (Add c22~182@ c22~182@) (Mul a22~178@ b22~180@)) (Mul (Mul a22~178@ b22~180@) (Mul c22~182@ b22~180@))))) (=> (= temp_22_1~3710@ (Add (Mul (Mul (Mul d22~184@ c22~182@) (Sub b22~180@ a22~178@)) (Mul (Mul (Add c22~182@ c22~182@) (Mul a22~178@ b22~180@)) (Mul (Mul a22~178@ b22~180@) (Mul c22~182@ b22~180@)))) (Mul (Mul b22~180@ (Mul c22~182@ b22~180@)) (Mul (Mul (Add c22~182@ c22~182@) (Mul a22~178@ b22~180@)) (Mul (Mul a22~178@ b22~180@) (Mul c22~182@ b22~180@)))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3617@ temp_22_1~3710@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
