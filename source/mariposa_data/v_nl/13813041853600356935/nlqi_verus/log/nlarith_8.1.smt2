...
(declare-const temp_7_0~2084@ Int)
(declare-const temp_7_1~2225@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~285@ (Mul (Mul (Mul (Sub (Mul a0~2@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Add (Mul b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Sub (Mul d0~8@ b0~4@) (Sub a0~2@ d0~8@)))) (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@)) (Mul d0~8@ (Mul c0~6@ c0~6@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Add c0~6@ b0~4@)))))) (=> (= temp_0_1~410@ (Mul (Mul (Mul (Sub (Mul a0~2@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Add (Mul b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Sub (Mul d0~8@ b0~4@) (Sub a0~2@ d0~8@)))) (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Add c0~6@ b0~4@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@)) (Mul d0~8@ (Mul c0~6@ c0~6@)))))) (=> (= tmp%1@ (= temp_0_0~285@ temp_0_1~410@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~598@ (Mul (Sub (Mul (Mul (Mul 27 d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Add d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ 66) (Mul c1~14@ c1~14@)) (Mul (Mul 94 b1~12@) c1~14@))) (Mul (Mul (Sub (Mul c1~14@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@))) (Mul (Mul (Add 23 c1~14@) (Mul c1~14@ d1~16@)) (Sub (Mul c1~14@ b1~12@) (Mul c1~14@ d1~16@)))))) (=> (= temp_1_1~771@ (Mul (Sub (Mul (Mul (Mul 27 d1~16@) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Add d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ 66) (Mul c1~14@ c1~14@)) (Mul (Mul 94 b1~12@) c1~14@))) (Mul (Mul (Sub (Mul c1~14@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@))) (Mul (Mul (Add 23 c1~14@) (Mul c1~14@ d1~16@)) (Sub (Mul c1~14@ b1~12@) (Mul c1~14@ d1~16@)))))) (=> (= tmp%2@ (= temp_1_0~598@ temp_1_1~771@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~895@ (Mul (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Sub b2~20@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ b2~20@))) (Sub d2~24@ (Mul (Add b2~20@ c2~22@) (Mul d2~24@ d2~24@)))) (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul a2~18@ (Mul c2~22@ b2~20@)) (Mul (Mul c2~22@ d2~24@) b2~20@))))) (=> (= temp_2_1~1004@ (Mul (Mul (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Sub b2~20@ d2~24@)) (Mul d2~24@ b2~20@)) (Mul c2~22@ b2~20@)) (Sub d2~24@ (Mul (Add b2~20@ c2~22@) (Mul d2~24@ d2~24@)))) (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul a2~18@ (Mul c2~22@ b2~20@)) (Mul (Mul c2~22@ d2~24@) b2~20@))))) (=> (= tmp%3@ (= temp_2_0~895@ temp_2_1~1004@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1128@ (Mul (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@)) d3~32@) (Mul (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ c3~30@)))) (Mul (Mul (Sub (Mul a3~26@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ c3~30@) d3~32@)) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)) (Mul b3~28@ (Mul d3~32@ d3~32@)))))) (=> (= temp_3_1~1237@ (Mul (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@)) d3~32@) (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@)))) (Mul (Mul (Sub (Mul a3~26@ d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul a3~26@ c3~30@) d3~32@)) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)) (Mul b3~28@ (Mul d3~32@ d3~32@)))))) (=> (= tmp%4@ (= temp_3_0~1128@ temp_3_1~1237@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1349@ (Mul (Mul (Add (Mul (Sub a4~34@ d4~40@) c4~38@) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ d4~40@))) c4~38@) (Mul (Mul c4~38@ (Mul (Mul a4~34@ 86) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul d4~40@ a4~34@) (Sub a4~34@ b4~36@)) (Add (Mul a4~34@ c4~38@) (Mul a4~34@ c4~38@)))))) (=> (= temp_4_1~1446@ (Mul (Mul (Add (Mul (Sub a4~34@ d4~40@) c4~38@) (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ d4~40@))) c4~38@) (Mul (Mul c4~38@ (Mul (Mul a4~34@ 86) (Mul a4~34@ c4~38@))) (Mul (Mul (Sub a4~34@ b4~36@) (Mul d4~40@ a4~34@)) (Add (Mul a4~34@ c4~38@) (Mul a4~34@ c4~38@)))))) (=> (= tmp%5@ (= temp_4_0~1349@ temp_4_1~1446@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1534@ (Mul (Sub (Mul (Mul (Mul b5~44@ c5~46@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ c5~46@))) (Mul (Mul (Add d5~48@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ b5~44@)))) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~1607@ (Mul (Sub (Mul (Mul (Mul c5~46@ b5~44@) (Add d5~48@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ c5~46@))) (Mul (Mul (Add d5~48@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ b5~44@)))) (Mul b5~44@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~1534@ temp_5_1~1607@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1775@ (Mul (Mul (Add (Sub (Mul c6~54@ d6~56@) (Mul 60 c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ d6~56@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ c6~54@)) (Sub (Mul d6~56@ d6~56@) (Mul a6~50@ b6~52@)))) (Mul (Mul (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ c6~54@)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ 57))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ d6~56@)))))) (=> (= temp_6_1~1928@ (Mul (Mul (Add (Sub (Mul c6~54@ d6~56@) (Mul 60 c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ d6~56@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ c6~54@)) (Sub (Mul d6~56@ d6~56@) (Mul a6~50@ b6~52@)))) (Mul (Mul (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ c6~54@)) (Mul d6~56@ (Mul c6~54@ (Mul d6~56@ 57)))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ d6~56@)))))) (=> (= tmp%7@ (= temp_6_0~1775@ temp_6_1~1928@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2084@ (Mul (Mul (Mul (Add (Mul b7~60@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul a7~58@ a7~58@) (Sub c7~62@ c7~62@)) (Sub (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)))) (Mul (Sub (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ d7~64@)) (Sub (Mul b7~60@ 35) (Sub b7~60@ a7~58@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@)) (Mul (Mul c7~62@ b7~60@) (Add d7~64@ a7~58@)))))) (=> (= temp_7_1~2225@ (Mul (Mul (Mul (Add (Mul b7~60@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul a7~58@ a7~58@) (Sub c7~62@ c7~62@)) (Sub (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)))) (Mul (Sub (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ d7~64@)) (Sub (Mul b7~60@ 35) (Sub b7~60@ a7~58@))) (Mul (Mul d7~64@ (Mul b7~60@ (Mul b7~60@ d7~64@))) (Mul (Mul c7~62@ b7~60@) (Add d7~64@ a7~58@)))))) (=> (= tmp%8@ (= temp_7_0~2084@ temp_7_1~2225@)) (=> %%location_label%%7 tmp%8@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
