...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Add (Add b0~4@ a0~2@) (Sub c0~6@ c0~6@)) (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ b0~4@))) (Mul (Sub d0~8@ (Sub b0~4@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~378@ (Mul (Add (Mul (Add b0~4@ a0~2@) (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ b0~4@))) (Mul (Sub c0~6@ c0~6@) (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ b0~4@)))) (Mul (Sub d0~8@ (Sub b0~4@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~378@))) (=> (= temp_0_0~301@ temp_0_1~378@) (=> (= temp_1_0~467@ (Mul (Mul (Mul (Add a1~10@ c1~14@) (Add a1~10@ b1~12@)) (Mul (Mul d1~16@ a1~10@) (Sub d1~16@ d1~16@))) (Sub (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Sub (Add c1~14@ c1~14@) (Mul b1~12@ c1~14@))))) (=> (= temp_1_1~532@ (Mul (Sub (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Sub (Add c1~14@ c1~14@) (Mul b1~12@ c1~14@))) (Mul (Mul (Add a1~10@ c1~14@) (Add a1~10@ b1~12@)) (Mul (Mul d1~16@ a1~10@) (Sub d1~16@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~467@ temp_1_1~532@))) (=> (= temp_1_0~467@ temp_1_1~532@) (=> (= temp_2_0~621@ (Sub (Sub (Sub (Mul a2~18@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul c2~22@ c2~22@) (Add c2~22@ b2~20@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~686@ (Sub (Sub (Sub (Mul a2~18@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul c2~22@ c2~22@) (Add c2~22@ b2~20@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~621@ temp_2_1~686@))) (=> (= temp_2_0~621@ temp_2_1~686@) (=> (= temp_3_0~771@ (Mul (Sub (Sub (Mul c3~30@ b3~28@) (Add b3~28@ c3~30@)) (Sub (Mul c3~30@ a3~26@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@)) (Mul d3~32@ (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~832@ (Mul (Sub (Sub (Mul c3~30@ b3~28@) (Add b3~28@ c3~30@)) (Sub (Mul c3~30@ a3~26@) (Mul d3~32@ a3~26@))) (Mul (Mul d3~32@ (Mul c3~30@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~771@ temp_3_1~832@))) (=> (= temp_3_0~771@ temp_3_1~832@) (=> (= temp_4_0~929@ (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ b4~36@)) (Add 79 (Sub d4~40@ a4~34@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~1002@ (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ b4~36@)) (Add 79 (Sub d4~40@ a4~34@))) (Mul (Mul (Add b4~36@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~929@ temp_4_1~1002@))) (=> (= temp_4_0~929@ temp_4_1~1002@) (=> (= temp_5_0~1063@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Add b5~44@ d5~48@) (Mul b5~44@ a5~42@))) a5~42@)) (=> (= temp_5_1~1108@ (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Add (Mul b5~44@ (Mul b5~44@ a5~42@)) (Mul d5~48@ (Mul b5~44@ a5~42@)))) a5~42@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1063@ temp_5_1~1108@))) (=> (= temp_5_0~1063@ temp_5_1~1108@) (=> (= temp_6_0~1197@ (Sub (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Sub (Mul d6~56@ d6~56@) (Mul a6~50@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1262@ (Sub (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Sub (Mul d6~56@ d6~56@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1197@ temp_6_1~1262@))) (=> (= temp_6_0~1197@ temp_6_1~1262@) (=> (= temp_7_0~1351@ (Mul (Mul (Mul (Add c7~62@ b7~60@) (Mul d7~64@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ d7~64@))) (Sub (Mul (Mul a7~58@ c7~62@) (Sub d7~64@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ c7~62@))))) (=> (= temp_7_1~1424@ (Mul (Mul (Add (Mul c7~62@ (Mul d7~64@ b7~60@)) (Mul b7~60@ (Mul d7~64@ b7~60@))) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ d7~64@))) (Sub (Mul (Mul a7~58@ c7~62@) (Sub d7~64@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1351@ temp_7_1~1424@))) (=> (= temp_7_0~1351@ temp_7_1~1424@) (=> (= temp_8_0~1521@ (Mul (Sub (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ 16)) (Sub (Mul c8~70@ a8~66@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@)) (Mul d8~72@ (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1594@ (Mul (Sub (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ 16)) (Sub (Mul a8~66@ c8~70@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ b8~68@)) (Mul d8~72@ (Mul b8~68@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1521@ temp_8_1~1594@))) (=> (= temp_8_0~1521@ temp_8_1~1594@) (=> (= temp_9_0~1683@ (Sub (Mul (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ b9~76@))) (Mul (Mul (Mul c9~78@ b9~76@) (Mul b9~76@ c9~78@)) (Mul (Mul c9~78@ b9~76@) (Mul d9~80@ c9~78@))))) (=> (= temp_9_1~1748@ (Sub (Mul (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ b9~76@)) (Mul (Mul b9~76@ c9~78@) (Mul a9~74@ b9~76@))) (Mul (Mul (Mul (Mul c9~78@ b9~76@) b9~76@) c9~78@) (Mul (Mul c9~78@ b9~76@) (Mul d9~80@ c9~78@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1683@ temp_9_1~1748@))) (=> (= temp_9_0~1683@ temp_9_1~1748@) (=> (= temp_10_0~1833@ (Mul (Add (Mul b10~84@ (Add c10~86@ d10~88@)) (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ a10~82@))) (Mul (Mul (Sub a10~82@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Sub d10~88@ a10~82@) (Mul a10~82@ c10~86@))))) (=> (= temp_10_1~1894@ (Mul (Add (Mul b10~84@ (Add c10~86@ d10~88@)) (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ a10~82@))) (Mul (Mul (Sub a10~82@ d10~88@) (Mul c10~86@ b10~84@)) (Mul (Sub d10~88@ a10~82@) (Mul a10~82@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1833@ temp_10_1~1894@))) (=> (= temp_10_0~1833@ temp_10_1~1894@) (=> (= temp_11_0~1983@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Add b11~92@ d11~96@)) (Mul (Mul b11~92@ a11~90@) (Add d11~96@ b11~92@))) (Mul (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ b11~92@)) (Add (Mul d11~96@ b11~92@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2056@ (Mul (Mul (Mul (Mul d11~96@ a11~90@) (Add b11~92@ d11~96@)) (Add (Mul (Mul b11~92@ a11~90@) d11~96@) (Mul (Mul b11~92@ a11~90@) b11~92@))) (Mul (Mul (Mul d11~96@ b11~92@) (Mul c11~94@ b11~92@)) (Add (Mul d11~96@ b11~92@) (Mul b11~92@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1983@ temp_11_1~2056@))) (=> (= temp_11_0~1983@ temp_11_1~2056@) (=> (= temp_12_0~2145@ (Mul (Sub (Sub (Mul c12~102@ c12~102@) (Mul a12~98@ d12~104@)) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ b12~100@))) (Mul (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2210@ (Mul (Sub (Sub (Mul c12~102@ c12~102@) (Mul a12~98@ d12~104@)) (Mul (Mul c12~102@ b12~100@) (Mul c12~102@ b12~100@))) (Mul (Mul (Mul b12~100@ c12~102@) (Mul d12~104@ d12~104@)) (Mul (Mul a12~98@ b12~100@) (Mul a12~98@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2145@ temp_12_1~2210@))) (=> (= temp_12_0~2145@ temp_12_1~2210@) (=> (= temp_13_0~2311@ (Mul (Add (Mul (Mul d13~112@ a13~106@) (Mul b13~108@ b13~108@)) (Mul (Mul 99 a13~106@) (Add b13~108@ d13~112@))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul d13~112@ c13~110@)) (Add (Mul d13~112@ a13~106@) (Mul b13~108@ d13~112@))))) (=> (= temp_13_1~2388@ (Mul (Add (Mul (Mul d13~112@ a13~106@) (Mul b13~108@ b13~108@)) (Mul 99 (Mul a13~106@ (Add b13~108@ d13~112@)))) (Mul (Mul (Mul b13~108@ b13~108@) (Mul d13~112@ c13~110@)) (Add (Mul d13~112@ a13~106@) (Mul b13~108@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2311@ temp_13_1~2388@))) (=> (= temp_13_0~2311@ temp_13_1~2388@) (=> (= temp_14_0~2485@ (Mul (Mul (Mul d14~120@ (Sub c14~118@ a14~114@)) (Sub (Mul c14~118@ a14~114@) (Mul d14~120@ d14~120@))) (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ 59)) (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ c14~118@))))) (=> (= temp_14_1~2558@ (Mul (Mul (Mul (Mul a14~114@ d14~120@) (Mul b14~116@ 59)) (Mul (Mul c14~118@ a14~114@) (Mul b14~116@ c14~118@))) (Mul (Mul d14~120@ (Sub c14~118@ a14~114@)) (Sub (Mul c14~118@ a14~114@) (Mul d14~120@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2485@ temp_14_1~2558@))) (=> (= temp_14_0~2485@ temp_14_1~2558@) (=> (= temp_15_0~2643@ (Mul (Mul (Mul (Add c15~126@ d15~128@) (Mul b15~124@ c15~126@)) (Add (Mul c15~126@ b15~124@) (Mul c15~126@ b15~124@))) (Sub (Mul b15~124@ (Mul b15~124@ b15~124@)) (Mul (Add d15~128@ a15~122@) (Mul b15~124@ b15~124@))))) (=> (= temp_15_1~2720@ (Mul (Add (Mul (Mul (Add c15~126@ d15~128@) (Mul b15~124@ c15~126@)) (Mul c15~126@ b15~124@)) (Mul (Mul (Add c15~126@ d15~128@) (Mul b15~124@ c15~126@)) (Mul c15~126@ b15~124@))) (Sub (Mul b15~124@ (Mul b15~124@ b15~124@)) (Mul (Add d15~128@ a15~122@) (Mul b15~124@ b15~124@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2643@ temp_15_1~2720@))) (=> (= temp_15_0~2643@ temp_15_1~2720@) (=> (= temp_16_0~2805@ (Mul (Add (Mul (Sub b16~132@ b16~132@) (Add d16~136@ d16~136@)) (Mul (Add b16~132@ a16~130@) (Mul d16~136@ c16~134@))) (Sub (Mul (Mul c16~134@ d16~136@) (Mul c16~134@ b16~132@)) (Mul a16~130@ (Mul d16~136@ c16~134@))))) (=> (= temp_16_1~2866@ (Mul (Add (Mul (Sub b16~132@ b16~132@) (Add d16~136@ d16~136@)) (Mul (Mul (Add b16~132@ a16~130@) d16~136@) c16~134@)) (Sub (Mul (Mul c16~134@ d16~136@) (Mul c16~134@ b16~132@)) (Mul a16~130@ (Mul d16~136@ c16~134@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2805@ temp_16_1~2866@))) (=> (= temp_16_0~2805@ temp_16_1~2866@) (=> (= temp_17_0~2963@ (Mul (Mul (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ d17~144@)) (Mul (Mul a17~138@ d17~144@) (Mul c17~142@ 56))) (Mul (Mul (Add b17~140@ d17~144@) a17~138@) (Mul (Mul b17~140@ a17~138@) (Mul b17~140@ c17~142@))))) (=> (= temp_17_1~3036@ (Mul (Mul (Mul (Mul c17~142@ a17~138@) (Mul a17~138@ d17~144@)) (Mul (Mul a17~138@ d17~144@) (Mul 56 c17~142@))) (Mul (Mul (Add b17~140@ d17~144@) a17~138@) (Mul (Mul b17~140@ a17~138@) (Mul b17~140@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2963@ temp_17_1~3036@))) (=> (= temp_17_0~2963@ temp_17_1~3036@) (=> (= temp_18_0~3121@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ d18~152@)) (Mul (Mul c18~150@ d18~152@) d18~152@)) (Add (Mul (Mul d18~152@ c18~150@) (Mul b18~148@ d18~152@)) (Add (Mul b18~148@ d18~152@) (Mul b18~148@ c18~150@))))) (=> (= temp_18_1~3182@ (Mul (Mul (Mul (Mul a18~146@ c18~150@) (Mul b18~148@ d18~152@)) (Mul c18~150@ (Mul d18~152@ d18~152@))) (Add (Mul (Mul d18~152@ c18~150@) (Mul b18~148@ d18~152@)) (Add (Mul b18~148@ d18~152@) (Mul b18~148@ c18~150@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3121@ temp_18_1~3182@))) (=> (= temp_18_0~3121@ temp_18_1~3182@) (=> (= temp_19_0~3255@ (Mul (Mul (Mul (Mul b19~156@ b19~156@) (Mul a19~154@ a19~154@)) (Mul c19~158@ (Mul a19~154@ a19~154@))) (Mul a19~154@ (Sub (Mul c19~158@ d19~160@) (Mul c19~158@ c19~158@))))) (=> (= temp_19_1~3304@ (Mul (Mul (Mul (Mul b19~156@ b19~156@) (Mul a19~154@ a19~154@)) (Mul c19~158@ (Mul a19~154@ a19~154@))) (Mul a19~154@ (Sub (Mul c19~158@ d19~160@) (Mul c19~158@ c19~158@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3255@ temp_19_1~3304@))) (=> (= temp_19_0~3255@ temp_19_1~3304@) (=> (= temp_20_0~3401@ (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul d20~168@ d20~168@)) (Mul (Sub b20~164@ a20~162@) (Mul a20~162@ a20~162@))) (Mul (Mul (Add a20~162@ d20~168@) (Mul d20~168@ b20~164@)) (Mul (Mul 2 b20~164@) b20~164@)))) (=> (= temp_20_1~3474@ (Mul (Mul (Mul (Mul a20~162@ a20~162@) (Mul d20~168@ d20~168@)) (Mul (Sub b20~164@ a20~162@) (Mul a20~162@ a20~162@))) (Mul (Mul (Add a20~162@ d20~168@) (Mul d20~168@ b20~164@)) (Mul (Mul 2 b20~164@) b20~164@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3401@ temp_20_1~3474@))) (=> (= temp_20_0~3401@ temp_20_1~3474@) (=> (= temp_21_0~3587@ (Add (Mul (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ a21~170@)) (Mul (Mul d21~176@ c21~174@) (Mul b21~172@ 6))) (Add (Mul (Mul d21~176@ d21~176@) (Mul c21~174@ b21~172@)) (Mul (Mul c21~174@ d21~176@) (Mul c21~174@ 70))))) (=> (= temp_21_1~3676@ (Add (Mul (Mul (Mul d21~176@ b21~172@) (Mul d21~176@ a21~170@)) (Mul (Mul d21~176@ c21~174@) (Mul b21~172@ 6))) (Add (Mul (Mul d21~176@ d21~176@) (Mul c21~174@ b21~172@)) (Mul (Mul c21~174@ d21~176@) (Mul 70 c21~174@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3587@ temp_21_1~3676@))) (=> (= temp_21_0~3587@ temp_21_1~3676@) (=> (= temp_22_0~3765@ (Mul (Mul (Add (Mul d22~184@ b22~180@) (Mul b22~180@ a22~178@)) (Mul (Mul a22~178@ c22~182@) (Mul b22~180@ a22~178@))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul b22~180@ d22~184@)) (Mul (Mul a22~178@ a22~178@) (Mul c22~182@ d22~184@))))) (=> (= temp_22_1~3830@ (Mul (Mul (Add (Mul d22~184@ b22~180@) (Mul b22~180@ a22~178@)) (Mul (Mul b22~180@ a22~178@) (Mul a22~178@ c22~182@))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul b22~180@ d22~184@)) (Mul (Mul a22~178@ a22~178@) (Mul c22~182@ d22~184@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3765@ temp_22_1~3830@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
