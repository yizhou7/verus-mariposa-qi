...
;; mariposa_data/v_nl//15197645479909712552/nlqi_verus/src/main.rs:7:1: 36:40 (#0)
(push)
 ...
 (declare-const temp_6_0~1281@ Int)
 ...
 (declare-const temp_8_1~1662@ Int)
 (declare-const temp_9_0~1775@ Int)
 (declare-const temp_9_1~1864@ Int)
 (declare-const temp_10_0~1945@ Int)
 (declare-const temp_10_1~2014@ Int)
 (declare-const temp_11_0~2103@ Int)
 (declare-const temp_11_1~2176@ Int)
 (declare-const temp_12_0~2261@ Int)
 (declare-const temp_12_1~2322@ Int)
 (declare-const temp_13_0~2431@ Int)
 (declare-const temp_13_1~2516@ Int)
 (declare-const temp_14_0~2605@ Int)
 (declare-const temp_14_1~2670@ Int)
 (declare-const temp_15_0~2759@ Int)
 (declare-const temp_15_1~2824@ Int)
 (declare-const temp_16_0~2913@ Int)
 ...
 (assert
  (=>
   %%query%%
   (not (=>
     (= temp_0_0~313@ (Mul (Add (Mul c0~6@ (Mul d0~8@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@
          d0~8@
        ))
       ) (Mul (Mul (Add c0~6@ b0~4@) (Sub 37 c0~6@)) (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ d0~8@)))
     ))
     (=>
      (= temp_0_1~386@ (Mul (Add (Mul c0~6@ (Mul d0~8@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@
           d0~8@
         ))
        ) (Mul (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Add c0~6@ b0~4@) (Sub 37 c0~6@)))
      ))
      (and
       (=>
       ...
       (=>
        (= temp_0_0~313@ temp_0_1~386@)
        (=>
         (= temp_1_0~483@ (Sub (Mul (Sub (Mul c1~14@ b1~12@) c1~14@) (Add (Mul a1~10@ b1~12@)
             (Mul b1~12@ b1~12@)
            )
           ) (Add (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@
              66
         )))))
         (=>
          (= temp_1_1~556@ (Sub (Mul (Sub (Mul c1~14@ b1~12@) c1~14@) (Add (Mul a1~10@ b1~12@)
              (Mul b1~12@ b1~12@)
             )
            ) (Add (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Mul (Mul c1~14@ c1~14@) a1~10@)
              66
          ))))
          (and
           (=>
           ...
           (=>
            (= temp_1_0~483@ temp_1_1~556@)
            (=>
             (= temp_2_0~637@ (Mul (Sub (Mul a2~18@ (Mul c2~22@ b2~20@)) (Mul (Mul c2~22@ d2~24@)
                 (Mul c2~22@ b2~20@)
                )
               ) (Mul (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul b2~20@ c2~22@) b2~20@))
             ))
             (=>
              (= temp_2_1~694@ (Mul (Sub (Mul a2~18@ (Mul c2~22@ b2~20@)) (Mul (Mul c2~22@ d2~24@)
                  (Mul c2~22@ b2~20@)
                 )
                ) (Mul (Mul (Mul b2~20@ c2~22@) b2~20@) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ b2~20@)))
              ))
              (and
               (=>
                (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                (=>
                 %%location_label%%2
                 (= temp_2_0~637@ temp_2_1~694@)
               ))
               (=>
                (= temp_2_0~637@ temp_2_1~694@)
                (=>
                 (= temp_3_0~783@ (Mul (Add (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@
                      b3~28@
                     ) (Mul a3~26@ b3~28@)
                    )
                   ) (Sub (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@)) (Add (Sub d3~32@ b3~28@) (Mul d3~32@
                      a3~26@
                 )))))
                 (=>
                  (= temp_3_1~848@ (Mul (Add (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@)) (Mul (Mul a3~26@
                       b3~28@
                      ) (Mul a3~26@ b3~28@)
                     )
                    ) (Sub (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@)) (Add (Sub d3~32@ b3~28@) (Mul d3~32@
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~783@ temp_3_1~848@)
                    (=>
                     (= temp_4_0~949@ (Mul (Mul (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Mul (Mul b4~36@
                          92
                         ) (Mul d4~40@ a4~34@)
                        )
                       ) (Mul (Mul (Sub d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Sub c4~38@
                          b4~36@
                     )))))
                     (=>
                      (= temp_4_1~1026@ (Mul (Mul (Mul (Sub d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Mul (Mul b4~36@
                           92
                          ) (Mul d4~40@ a4~34@)
                         )
                        ) (Mul (Mul (Sub d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Sub c4~38@ b4~36@) (Mul d4~40@
                           d4~40@
                      )))))
                      (and
                       (=>
                       ...
                       (=>
                        (= temp_4_0~949@ temp_4_1~1026@)
                        (=>
                         (= temp_5_0~1115@ (Mul (Sub (Mul (Add a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@
                              d5~48@
                             ) (Mul a5~42@ 19)
                            )
                           ) (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ a5~42@)) d5~48@)
                         ))
                         (=>
                          (= temp_5_1~1180@ (Mul (Sub (Mul (Mul c5~46@ a5~42@) (Add a5~42@ d5~48@)) (Mul (Mul a5~42@
                               d5~48@
                              ) (Mul a5~42@ 19)
                             )
                            ) (Mul (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ a5~42@)) d5~48@)
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%5
                             (= temp_5_0~1115@ temp_5_1~1180@)
                           ))
                           (=>
                            (= temp_5_0~1115@ temp_5_1~1180@)
                            (=>
                             (= temp_6_0~1281@ (Mul (Mul (Mul (Sub c6~54@ b6~52@) (Mul b6~52@ a6~50@)) (Mul (Mul b6~52@
                                  c6~54@
                                 ) (Mul d6~56@ d6~56@)
                                )
                               ) (Mul (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ 13)) (Mul (Mul b6~52@ b6~52@) (Mul c6~54@
                                  d6~56@
                             )))))
                             (=>
                              (= temp_6_1~1358@ (Mul (Mul (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ 13)) (Mul (Mul b6~52@
                                   b6~52@
                                  ) (Mul c6~54@ d6~56@)
                                 )
                                ) (Mul (Mul (Sub c6~54@ b6~52@) (Mul b6~52@ a6~50@)) (Mul (Mul b6~52@ c6~54@) (Mul d6~56@
                                   d6~56@
                              )))))
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1281@ temp_6_1~1358@)
                               ))
                               (=>
                                (= temp_6_0~1281@ temp_6_1~1358@)
                                (=>
                                 (= temp_7_0~1443@ (Sub (Mul (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ b7~60@)) (Mul (Mul d7~64@
                                      a7~58@
                                     ) c7~62@
                                    )
                                   ) (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Mul d7~64@
                                      a7~58@
                                 )))))
                                 (=>
                                  (= temp_7_1~1504@ (Sub (Mul (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ b7~60@)) (Mul (Mul a7~58@
                                       d7~64@
                                      ) c7~62@
                                     )
                                    ) (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Mul d7~64@
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1443@ temp_7_1~1504@)
                                   ))
                                   (=>
                                    (= temp_7_0~1443@ temp_7_1~1504@)
                                    (=>
                                     (= temp_8_0~1589@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@
                                          b8~68@
                                         ) (Mul a8~66@ b8~68@)
                                        )
                                       ) (Mul (Sub (Mul c8~70@ d8~72@) (Mul a8~66@ c8~70@)) (Mul b8~68@ (Mul b8~68@ a8~66@)))
                                     ))
                                     (=>
                                      (= temp_8_1~1662@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@
                                           b8~68@
                                          ) (Mul a8~66@ b8~68@)
                                         )
                                        ) (Sub (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ (Mul b8~68@ a8~66@))) (Mul (Mul a8~66@ c8~70@)
                                          (Mul b8~68@ (Mul b8~68@ a8~66@))
                                      ))))
                                      (and
                                       (=>
                                        (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1589@ temp_8_1~1662@)
                                       ))
                                       (=>
                                        (= temp_8_0~1589@ temp_8_1~1662@)
                                        (=>
                                         (= temp_9_0~1775@ (Mul (Mul (Add (Mul d9~80@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Add 54
                                              b9~76@
                                             ) (Mul b9~76@ c9~78@)
                                            )
                                           ) (Add (Mul (Sub d9~80@ 99) (Mul b9~76@ d9~80@)) (Mul (Mul c9~78@ d9~80@) (Mul a9~74@
                                              d9~80@
                                         )))))
                                         (=>
                                          (= temp_9_1~1864@ (Mul (Mul (Add (Mul d9~80@ c9~78@) (Mul c9~78@ b9~76@)) (Mul (Add 54
                                               b9~76@
                                              ) (Mul b9~76@ c9~78@)
                                             )
                                            ) (Add (Mul (Sub d9~80@ 99) (Mul b9~76@ d9~80@)) (Mul (Mul c9~78@ d9~80@) (Mul d9~80@
                                               a9~74@
                                          )))))
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1775@ temp_9_1~1864@)
                                           ))
                                           (=>
                                            (= temp_9_0~1775@ temp_9_1~1864@)
                                            (=>
                                             (= temp_10_0~1945@ (Mul (Mul (Add (Mul a10~82@ a10~82@) (Mul c10~86@ c10~86@)) (Mul (
                                                  Sub b10~84@ c10~86@
                                                 ) b10~84@
                                                )
                                               ) (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ c10~86@)) (Mul a10~82@ (Mul a10~82@ d10~88@)))
                                             ))
                                             (=>
                                              (= temp_10_1~2014@ (Mul (Add (Mul (Mul a10~82@ a10~82@) (Mul (Sub b10~84@ c10~86@) b10~84@))
                                                 (Mul (Mul c10~86@ c10~86@) (Mul (Sub b10~84@ c10~86@) b10~84@))
                                                ) (Mul (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ c10~86@)) (Mul a10~82@ (Mul a10~82@ d10~88@)))
                                              ))
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1945@ temp_10_1~2014@)
                                               ))
                                               (=>
                                                (= temp_10_0~1945@ temp_10_1~2014@)
                                                (=>
                                                 (= temp_11_0~2103@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Add c11~94@ c11~94@)) (Mul (
                                                      Sub a11~90@ a11~90@
                                                     ) (Mul d11~96@ d11~96@)
                                                    )
                                                   ) (Sub (Sub (Mul d11~96@ b11~92@) (Sub a11~90@ d11~96@)) (Mul (Mul d11~96@ d11~96@)
                                                     (Mul c11~94@ b11~92@)
                                                 ))))
                                                 (=>
                                                  (= temp_11_1~2176@ (Mul (Mul (Mul (Mul a11~90@ a11~90@) (Add c11~94@ c11~94@)) (Sub (
                                                       Mul a11~90@ (Mul d11~96@ d11~96@)
                                                      ) (Mul a11~90@ (Mul d11~96@ d11~96@))
                                                     )
                                                    ) (Sub (Sub (Mul d11~96@ b11~92@) (Sub a11~90@ d11~96@)) (Mul (Mul d11~96@ d11~96@)
                                                      (Mul c11~94@ b11~92@)
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~2103@ temp_11_1~2176@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~2103@ temp_11_1~2176@)
                                                    (=>
                                                     (= temp_12_0~2261@ (Mul (Add (Mul (Mul d12~104@ c12~102@) (Mul a12~98@ d12~104@)) (Sub
                                                         (Mul c12~102@ b12~100@) (Mul a12~98@ b12~100@)
                                                        )
                                                       ) (Add (Mul (Mul a12~98@ c12~102@) (Sub d12~104@ c12~102@)) (Mul (Mul a12~98@ b12~100@)
                                                         c12~102@
                                                     ))))
                                                     (=>
                                                      (= temp_12_1~2322@ (Mul (Add (Mul (Mul c12~102@ d12~104@) (Mul a12~98@ d12~104@)) (Sub
                                                          (Mul c12~102@ b12~100@) (Mul a12~98@ b12~100@)
                                                         )
                                                        ) (Add (Mul (Mul a12~98@ c12~102@) (Sub d12~104@ c12~102@)) (Mul (Mul a12~98@ b12~100@)
                                                          c12~102@
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2261@ temp_12_1~2322@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2261@ temp_12_1~2322@)
                                                        (=>
                                                         (= temp_13_0~2431@ (Sub (Mul (Mul b13~108@ (Mul c13~110@ a13~106@)) (Add (Mul b13~108@
                                                              c13~110@
                                                             ) (Mul 63 a13~106@)
                                                            )
                                                           ) (Mul (Mul (Mul d13~112@ c13~110@) (Sub a13~106@ 48)) (Mul (Mul a13~106@ b13~108@)
                                                             (Mul d13~112@ c13~110@)
                                                         ))))
                                                         (=>
                                                          (= temp_13_1~2516@ (Sub (Mul (Mul b13~108@ (Mul c13~110@ a13~106@)) (Add (Mul b13~108@
                                                               c13~110@
                                                              ) (Mul 63 a13~106@)
                                                             )
                                                            ) (Mul (Mul (Mul d13~112@ c13~110@) (Sub a13~106@ 48)) (Mul (Mul (Mul a13~106@ b13~108@)
                                                               d13~112@
                                                              ) c13~110@
                                                          ))))
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2431@ temp_13_1~2516@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2431@ temp_13_1~2516@)
                                                            (=>
                                                             (= temp_14_0~2605@ (Mul (Mul (Mul (Mul c14~118@ d14~120@) (Mul c14~118@ c14~118@)) (
                                                                 Mul (Mul a14~114@ c14~118@) (Mul c14~118@ a14~114@)
                                                                )
                                                               ) (Mul (Sub (Mul a14~114@ b14~116@) (Sub b14~116@ b14~116@)) (Add (Mul b14~116@ b14~116@)
                                                                 (Mul d14~120@ c14~118@)
                                                             ))))
                                                             (=>
                                                              (= temp_14_1~2670@ (Mul (Mul (Mul c14~118@ d14~120@) (Mul (Mul c14~118@ c14~118@) (Mul
                                                                   (Mul a14~114@ c14~118@) (Mul c14~118@ a14~114@)
                                                                 ))
                                                                ) (Mul (Sub (Mul a14~114@ b14~116@) (Sub b14~116@ b14~116@)) (Add (Mul b14~116@ b14~116@)
                                                                  (Mul d14~120@ c14~118@)
                                                              ))))
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2605@ temp_14_1~2670@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2605@ temp_14_1~2670@)
                                                                (=>
                                                                 (= temp_15_0~2759@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Sub c15~126@ b15~124@)) (
                                                                     Mul (Mul c15~126@ c15~126@) (Mul d15~128@ c15~126@)
                                                                    )
                                                                   ) (Mul (Mul (Mul b15~124@ b15~124@) (Add a15~122@ a15~122@)) (Add (Mul b15~124@ b15~124@)
                                                                     (Mul c15~126@ d15~128@)
                                                                 ))))
                                                                 (=>
                                                                  (= temp_15_1~2824@ (Mul (Mul (Mul (Mul a15~122@ a15~122@) (Sub c15~126@ b15~124@)) (
                                                                      Mul (Mul c15~126@ c15~126@) (Mul d15~128@ c15~126@)
                                                                     )
                                                                    ) (Mul (Mul b15~124@ b15~124@) (Mul (Add a15~122@ a15~122@) (Add (Mul b15~124@ b15~124@)
                                                                       (Mul c15~126@ d15~128@)
                                                                  )))))
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2759@ temp_15_1~2824@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2759@ temp_15_1~2824@)
                                                                    (=>
                                                                     (= temp_16_0~2913@ (Mul (Mul (Mul (Add a16~130@ d16~136@) (Mul d16~136@ c16~134@)) (
                                                                         Mul (Mul a16~130@ d16~136@) (Mul a16~130@ c16~134@)
                                                                        )
                                                                       ) (Mul (Sub (Sub a16~130@ c16~134@) (Sub c16~134@ d16~136@)) (Mul (Mul a16~130@ d16~136@)
                                                                         (Sub b16~132@ a16~130@)
                                                                     ))))
                                                                     (=>
                                                                      (= temp_16_1~2978@ (Mul (Mul (Mul (Add a16~130@ d16~136@) (Mul d16~136@ c16~134@)) (
                                                                          Mul (Mul a16~130@ d16~136@) (Mul a16~130@ c16~134@)
                                                                         )
                                                                        ) (Mul (Sub (Sub a16~130@ c16~134@) (Sub c16~134@ d16~136@)) (Mul (Sub b16~132@ a16~130@)
                                                                          (Mul a16~130@ d16~136@)
                                                                      ))))
                                                                      (=>
                                                                       (ens%main!nl_basics.lemma_mul_properties_auto_1. 0)
