...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@)) (Sub (Mul a0~2@ c0~6@) (Mul c0~6@ b0~4@))) (Mul (Sub (Mul c0~6@ d0~8@) c0~6@) (Add (Mul c0~6@ d0~8@) c0~6@)))) (=> (= temp_0_1~354@ (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Sub (Mul a0~2@ c0~6@) (Mul c0~6@ b0~4@)) (Mul (Sub (Mul c0~6@ d0~8@) c0~6@) (Add (Mul c0~6@ d0~8@) c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~354@))) (=> (= temp_0_0~297@ temp_0_1~354@) (=> (= temp_1_0~443@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@))) (Mul (Add (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@)) (Add (Sub d1~16@ c1~14@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~508@ (Mul (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ b1~12@))) (Mul (Add (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@)) (Add (Sub d1~16@ c1~14@) (Mul b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~443@ temp_1_1~508@))) (=> (= temp_1_0~443@ temp_1_1~508@) (=> (= temp_2_0~593@ (Mul (Mul (Sub (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@))) (Mul (Mul a2~18@ (Mul a2~18@ d2~24@)) (Mul (Sub c2~22@ b2~20@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~654@ (Mul (Mul (Sub (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@))) (Mul (Mul a2~18@ (Mul d2~24@ a2~18@)) (Mul (Sub c2~22@ b2~20@) (Mul b2~20@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~593@ temp_2_1~654@))) (=> (= temp_2_0~593@ temp_2_1~654@) (=> (= temp_3_0~743@ (Mul (Sub (Mul (Mul c3~30@ c3~30@) (Sub b3~28@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Sub a3~26@ b3~28@))) (Mul (Add (Mul a3~26@ a3~26@) (Add c3~30@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Add a3~26@ a3~26@))))) (=> (= temp_3_1~808@ (Mul (Sub (Mul (Mul c3~30@ c3~30@) (Sub b3~28@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Sub a3~26@ b3~28@))) (Mul (Add (Mul a3~26@ a3~26@) (Add c3~30@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Add a3~26@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~743@ temp_3_1~808@))) (=> (= temp_3_0~743@ temp_3_1~808@) (=> (= temp_4_0~933@ (Mul (Mul (Mul (Mul b4~36@ 64) (Mul d4~40@ b4~36@)) (Mul (Mul 61 b4~36@) (Mul b4~36@ 11))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~1034@ (Mul (Mul (Mul (Mul b4~36@ 64) (Mul d4~40@ b4~36@)) (Mul (Mul b4~36@ 11) (Mul 61 b4~36@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~933@ temp_4_1~1034@))) (=> (= temp_4_0~933@ temp_4_1~1034@) (=> (= temp_5_0~1135@ (Mul (Add (Mul (Mul a5~42@ 66) (Mul b5~44@ c5~46@)) (Sub (Add a5~42@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Sub b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1212@ (Mul (Add (Mul (Mul (Mul a5~42@ 66) b5~44@) c5~46@) (Sub (Add a5~42@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Sub b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1135@ temp_5_1~1212@))) (=> (= temp_5_0~1135@ temp_5_1~1212@) (=> (= temp_6_0~1305@ (Mul (Sub (Mul (Mul d6~56@ d6~56@) b6~52@) (Sub (Mul 11 b6~52@) (Mul c6~54@ a6~50@))) (Mul (Mul c6~54@ (Mul d6~56@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1374@ (Mul (Sub (Mul (Mul d6~56@ d6~56@) b6~52@) (Sub (Mul 11 b6~52@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul d6~56@ b6~52@) c6~54@) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1305@ temp_6_1~1374@))) (=> (= temp_6_0~1305@ temp_6_1~1374@) (=> (= temp_7_0~1479@ (Mul (Mul (Mul (Sub b7~60@ a7~58@) a7~58@) (Mul (Mul c7~62@ d7~64@) (Sub c7~62@ c7~62@))) (Mul (Mul (Add a7~58@ 38) c7~62@) (Mul (Add c7~62@ 34) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1560@ (Mul (Mul (Mul (Sub b7~60@ a7~58@) a7~58@) (Mul (Mul d7~64@ c7~62@) (Sub c7~62@ c7~62@))) (Mul (Mul (Add a7~58@ 38) c7~62@) (Mul (Add c7~62@ 34) (Mul a7~58@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1479@ temp_7_1~1560@))) (=> (= temp_7_0~1479@ temp_7_1~1560@) (=> (= temp_8_0~1637@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@)) a8~66@) (Mul (Mul (Sub b8~68@ a8~66@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1690@ (Mul (Mul (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@)) a8~66@) (Mul (Mul (Sub b8~68@ a8~66@) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1637@ temp_8_1~1690@))) (=> (= temp_8_0~1637@ temp_8_1~1690@) (=> (= temp_9_0~1779@ (Mul (Mul (Mul (Sub c9~78@ b9~76@) (Mul d9~80@ b9~76@)) (Sub (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@))) (Mul (Mul (Mul a9~74@ a9~74@) (Mul a9~74@ d9~80@)) (Mul (Add d9~80@ c9~78@) (Mul b9~76@ a9~74@))))) (=> (= temp_9_1~1844@ (Mul (Mul (Mul (Sub c9~78@ b9~76@) (Mul d9~80@ b9~76@)) (Sub (Mul a9~74@ d9~80@) (Mul b9~76@ d9~80@))) (Mul (Mul (Add d9~80@ c9~78@) (Mul b9~76@ a9~74@)) (Mul (Mul a9~74@ a9~74@) (Mul a9~74@ d9~80@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1779@ temp_9_1~1844@))) (=> (= temp_9_0~1779@ temp_9_1~1844@) (=> (= temp_10_0~1917@ (Mul (Mul (Sub (Mul b10~84@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul b10~84@ c10~86@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul b10~84@ c10~86@) b10~84@) b10~84@))) (=> (= temp_10_1~1966@ (Mul (Mul (Sub (Mul b10~84@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul c10~86@ b10~84@) (Mul a10~82@ d10~88@))) (Mul (Mul (Mul b10~84@ c10~86@) b10~84@) b10~84@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1917@ temp_10_1~1966@))) (=> (= temp_10_0~1917@ temp_10_1~1966@) (=> (= temp_11_0~2027@ (Mul a11~90@ (Mul (Sub (Sub b11~92@ a11~90@) (Mul a11~90@ c11~94@)) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ b11~92@))))) (=> (= temp_11_1~2080@ (Mul a11~90@ (Sub (Mul (Sub b11~92@ a11~90@) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ b11~92@))) (Mul (Mul a11~90@ c11~94@) (Mul (Mul b11~92@ d11~96@) (Mul a11~90@ b11~92@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2027@ temp_11_1~2080@))) (=> (= temp_11_0~2027@ temp_11_1~2080@) (=> (= temp_12_0~2165@ (Mul (Mul (Mul b12~100@ (Mul a12~98@ b12~100@)) (Mul (Mul d12~104@ d12~104@) (Add d12~104@ d12~104@))) (Mul (Mul (Mul a12~98@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@))))) (=> (= temp_12_1~2226@ (Mul (Mul (Mul (Mul d12~104@ d12~104@) (Add d12~104@ d12~104@)) (Mul b12~100@ (Mul a12~98@ b12~100@))) (Mul (Mul (Mul a12~98@ d12~104@) (Mul b12~100@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Mul b12~100@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2165@ temp_12_1~2226@))) (=> (= temp_12_0~2165@ temp_12_1~2226@) (=> (= temp_13_0~2303@ (Mul (Mul (Mul (Mul d13~112@ b13~108@) (Mul a13~106@ b13~108@)) (Mul (Mul d13~112@ a13~106@) (Add c13~110@ c13~110@))) (Add (Mul (Mul b13~108@ b13~108@) (Sub b13~108@ b13~108@)) b13~108@))) (=> (= temp_13_1~2356@ (Mul (Mul (Mul d13~112@ (Mul b13~108@ (Mul a13~106@ b13~108@))) (Mul (Mul d13~112@ a13~106@) (Add c13~110@ c13~110@))) (Add (Mul (Mul b13~108@ b13~108@) (Sub b13~108@ b13~108@)) b13~108@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2303@ temp_13_1~2356@))) (=> (= temp_13_0~2303@ temp_13_1~2356@) (=> (= temp_14_0~2469@ (Mul (Mul (Mul (Sub a14~114@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ c14~118@) (Add b14~116@ d14~120@))) (Mul (Mul (Mul 15 d14~120@) (Mul a14~114@ b14~116@)) (Mul (Mul 19 b14~116@) (Mul c14~118@ b14~116@))))) (=> (= temp_14_1~2558@ (Mul (Mul (Mul (Sub a14~114@ b14~116@) (Mul d14~120@ a14~114@)) (Mul (Mul c14~118@ c14~118@) (Add b14~116@ d14~120@))) (Mul (Mul (Mul 15 d14~120@) (Mul a14~114@ b14~116@)) (Mul (Mul (Mul 19 b14~116@) c14~118@) b14~116@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2469@ temp_14_1~2558@))) (=> (= temp_14_0~2469@ temp_14_1~2558@) (=> (= temp_15_0~2643@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ b15~124@)) (Mul b15~124@ (Mul b15~124@ c15~126@))) (Mul (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ a15~122@)) (Mul (Mul c15~126@ a15~122@) (Sub c15~126@ d15~128@))))) (=> (= temp_15_1~2704@ (Mul (Mul (Mul (Mul b15~124@ a15~122@) (Mul b15~124@ b15~124@)) (Mul b15~124@ (Mul b15~124@ c15~126@))) (Mul (Mul (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ a15~122@)) (Mul c15~126@ a15~122@)) (Sub c15~126@ d15~128@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2643@ temp_15_1~2704@))) (=> (= temp_15_0~2643@ temp_15_1~2704@) (=> (= temp_16_0~2781@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) b16~132@) (Mul (Add c16~134@ b16~132@) a16~130@)) (Mul (Mul d16~136@ (Mul a16~130@ a16~130@)) (Mul (Add c16~134@ c16~134@) (Mul c16~134@ c16~134@))))) (=> (= temp_16_1~2834@ (Mul (Mul (Mul (Mul d16~136@ a16~130@) b16~132@) (Mul (Add c16~134@ b16~132@) a16~130@)) (Mul (Mul (Mul d16~136@ (Mul a16~130@ a16~130@)) (Add c16~134@ c16~134@)) (Mul c16~134@ c16~134@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2781@ temp_16_1~2834@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
