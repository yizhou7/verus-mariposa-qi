...
(set-info :comment ";; mariposa_data/v_nl//15878960253708145026/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_2_0~699@ Int)
(declare-const temp_2_1~764@ Int)
(declare-const temp_3_0~879@ Int)
(declare-const temp_3_1~944@ Int)
(declare-const temp_4_0~1043@ Int)
(declare-const temp_4_1~1108@ Int)
(declare-const temp_5_0~1191@ Int)
(declare-const temp_5_1~1232@ Int)
(declare-const temp_6_0~1319@ Int)
(declare-const temp_6_1~1372@ Int)
...
(declare-const temp_9_0~1841@ Int)
(declare-const temp_9_1~1902@ Int)
(declare-const temp_10_0~1989@ Int)
(declare-const temp_10_1~2026@ Int)
(declare-const temp_11_0~2125@ Int)
(declare-const temp_11_1~2190@ Int)
(declare-const temp_12_0~2291@ Int)
(declare-const temp_12_1~2356@ Int)
(declare-const temp_13_0~2449@ Int)
(declare-const temp_13_1~2514@ Int)
(declare-const temp_14_0~2607@ Int)
(declare-const temp_14_1~2672@ Int)
(declare-const temp_15_0~2773@ Int)
(declare-const temp_15_1~2846@ Int)
...
(declare-const temp_18_0~3235@ Int)
(declare-const temp_18_1~3296@ Int)
(declare-const temp_19_0~3413@ Int)
(declare-const temp_19_1~3494@ Int)
(declare-const temp_20_0~3589@ Int)
(declare-const temp_20_1~3654@ Int)
(declare-const temp_21_0~3755@ Int)
(declare-const temp_21_1~3820@ Int)
(declare-const temp_22_0~3925@ Int)
(declare-const temp_22_1~4002@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~317@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Add 66 a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ d0~8@))) (Mul (Mul (Sub a0~2@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~394@ (Mul (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Add 66 a0~2@)) (Mul b0~4@ d0~8@)) (Mul d0~8@ d0~8@)) (Mul (Mul (Sub a0~2@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ b0~4@))))) (and (=> (= tmp%1@ (Mul (Mul b0~4@ d0~8@) (Add 66 a0~2@))) (=> (= tmp%2@ (Mul b0~4@ d0~8@)) (=> (= tmp%3@ (Mul d0~8@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~317@ temp_0_1~394@)))))) (=> (= temp_0_0~317@ temp_0_1~394@) (=> (= temp_1_0~509@ (Mul (Mul c1~14@ (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ b1~12@))) (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ c1~14@)) (Add (Mul d1~16@ a1~10@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~562@ (Mul (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ c1~14@)) (Add (Mul d1~16@ a1~10@) (Mul d1~16@ a1~10@))) (Mul c1~14@ (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ b1~12@))))) (and (=> (= tmp%4@ (Mul c1~14@ (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ b1~12@)))) (=> (= tmp%5@ (Mul (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ c1~14@)) (Add (Mul d1~16@ a1~10@) (Mul d1~16@ a1~10@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~509@ temp_1_1~562@))))) (=> (= temp_1_0~509@ temp_1_1~562@) (=> (= temp_2_0~699@ (Mul (Mul (Mul (Mul c2~22@ 84) (Add c2~22@ c2~22@)) d2~24@) (Mul (Mul (Sub c2~22@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Sub b2~20@ c2~22@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~764@ (Mul (Mul (Mul c2~22@ 84) (Mul (Add c2~22@ c2~22@) d2~24@)) (Mul (Mul (Sub c2~22@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Sub b2~20@ c2~22@) (Mul b2~20@ d2~24@))))) (and (=> (= tmp%6@ (Mul c2~22@ 84)) (=> (= tmp%7@ (Add c2~22@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ d2~24@) (=> %%location_label%%2 (= temp_2_0~699@ temp_2_1~764@))))) (=> (= temp_2_0~699@ temp_2_1~764@) (=> (= temp_3_0~879@ (Mul (Mul (Mul (Sub a3~26@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Add b3~28@ a3~26@) (Mul d3~32@ c3~30@))))) (=> (= temp_3_1~944@ (Mul (Mul (Mul (Mul (Sub a3~26@ b3~28@) d3~32@) b3~28@) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Add b3~28@ a3~26@) (Mul d3~32@ c3~30@))))) (and (=> (= tmp%8@ (Sub a3~26@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ d3~32@ b3~28@) (=> %%location_label%%3 (= temp_3_0~879@ temp_3_1~944@)))) (=> (= temp_3_0~879@ temp_3_1~944@) (=> (= temp_4_0~1043@ (Add (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ a4~34@)) (Add (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Sub b4~36@ a4~34@))))) (=> (= temp_4_1~1108@ (Add (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ a4~34@)) (Add (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@))) (Mul (Mul a4~34@ d4~40@) (Mul (Mul b4~36@ b4~36@) (Mul (Mul c4~38@ d4~40@) (Sub b4~36@ a4~34@)))))) (and (=> (= tmp%9@ (Mul a4~34@ d4~40@)) (=> (= tmp%10@ (Mul b4~36@ b4~36@)) (=> (= tmp%11@ (Mul (Mul c4~38@ d4~40@) (Sub b4~36@ a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%4 (= temp_4_0~1043@ temp_4_1~1108@)))))) (=> (= temp_4_0~1043@ temp_4_1~1108@) (=> (= temp_5_0~1191@ (Sub d5~48@ (Mul (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ b5~44@)) (Sub (Mul b5~44@ b5~44@) c5~46@)))) (=> (= temp_5_1~1232@ (Sub d5~48@ (Mul (Sub (Mul d5~48@ (Mul c5~46@ b5~44@)) (Mul b5~44@ (Mul c5~46@ b5~44@))) (Sub (Mul b5~44@ b5~44@) c5~46@)))) (and (=> (= tmp%12@ (Mul c5~46@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d5~48@ b5~44@ tmp%12@) (=> %%location_label%%5 (= temp_5_0~1191@ temp_5_1~1232@)))) (=> (= temp_5_0~1191@ temp_5_1~1232@) (=> (= temp_6_0~1319@ (Mul (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ c6~54@)) d6~56@) (Mul (Mul (Mul a6~50@ b6~52@) (Add a6~50@ c6~54@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1372@ (Mul (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ c6~54@)) d6~56@) (Mul (Mul (Add a6~50@ c6~54@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (and (=> (= tmp%13@ (Mul a6~50@ b6~52@)) (=> (= tmp%14@ (Add a6~50@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%6 (= temp_6_0~1319@ temp_6_1~1372@))))) (=> (= temp_6_0~1319@ temp_6_1~1372@) (=> (= temp_7_0~1485@ (Mul (Add (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Mul 65 c7~62@))) (Mul (Sub (Add d7~64@ c7~62@) (Add a7~58@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ c7~62@))))) (=> (= temp_7_1~1562@ (Mul (Add (Mul (Mul a7~58@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Mul b7~60@ b7~60@) (Mul 65 c7~62@))) (Mul (Sub (Add d7~64@ c7~62@) (Add a7~58@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1485@ temp_7_1~1562@))) (=> (= temp_7_0~1485@ temp_7_1~1562@) (=> (= temp_8_0~1667@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ 71)) (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ b8~68@))) (Add (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@))))) (=> (= temp_8_1~1744@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ 71)) (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ c8~70@))) (Add (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ b8~68@))))) (and (=> (= tmp%15@ (Mul a8~66@ c8~70@)) (=> (= tmp%16@ (Mul c8~70@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%8 (= temp_8_0~1667@ temp_8_1~1744@))))) (=> (= temp_8_0~1667@ temp_8_1~1744@) (=> (= temp_9_0~1841@ (Sub (Add 15 (Mul b9~76@ (Mul d9~80@ a9~74@))) (Mul (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ b9~76@)) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@))))) (=> (= temp_9_1~1902@ (Sub (Add 15 (Mul b9~76@ (Mul d9~80@ a9~74@))) (Mul (Mul b9~76@ a9~74@) (Mul (Mul a9~74@ b9~76@) (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@)))))) (and (=> (= tmp%17@ (Mul b9~76@ a9~74@)) (=> (= tmp%18@ (Mul a9~74@ b9~76@)) (=> (= tmp%19@ (Mul (Mul b9~76@ b9~76@) (Mul b9~76@ c9~78@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%9 (= temp_9_0~1841@ temp_9_1~1902@)))))) (=> (= temp_9_0~1841@ temp_9_1~1902@) (=> (= temp_10_0~1989@ (Mul b10~84@ (Sub (Mul (Mul d10~88@ b10~84@) (Mul b10~84@ a10~82@)) (Mul (Mul b10~84@ a10~82@) (Add c10~86@ a10~82@))))) (=> (= temp_10_1~2026@ (Mul b10~84@ (Sub (Mul (Mul d10~88@ b10~84@) (Mul b10~84@ a10~82@)) (Mul b10~84@ (Mul a10~82@ (Add c10~86@ a10~82@)))))) (and (=> (= tmp%20@ (Add c10~86@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b10~84@ a10~82@ tmp%20@) (=> %%location_label%%10 (= temp_10_0~1989@ temp_10_1~2026@)))) (=> (= temp_10_0~1989@ temp_10_1~2026@) (=> (= temp_11_0~2125@ (Add (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ d11~96@) (Mul b11~92@ a11~90@))) (Mul (Mul (Mul a11~90@ c11~94@) (Add c11~94@ c11~94@)) (Mul (Sub c11~94@ a11~90@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2190@ (Add (Mul (Mul (Mul b11~92@ b11~92@) (Mul d11~96@ a11~90@)) (Mul (Mul c11~94@ d11~96@) (Mul b11~92@ a11~90@))) (Mul (Mul (Add c11~94@ c11~94@) (Mul a11~90@ c11~94@)) (Mul (Sub c11~94@ a11~90@) (Mul b11~92@ a11~90@))))) (and (=> (= tmp%21@ (Mul a11~90@ c11~94@)) (=> (= tmp%22@ (Add c11~94@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%11 (= temp_11_0~2125@ temp_11_1~2190@))))) (=> (= temp_11_0~2125@ temp_11_1~2190@) (=> (= temp_12_0~2291@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul c12~102@ d12~104@)) (Sub (Mul b12~100@ c12~102@) (Mul b12~100@ c12~102@))) (Mul (Sub (Mul a12~98@ a12~98@) (Sub d12~104@ d12~104@)) (Mul (Mul c12~102@ a12~98@) (Mul b12~100@ d12~104@))))) (=> (= temp_12_1~2356@ (Mul (Mul (Mul (Mul d12~104@ b12~100@) (Mul c12~102@ d12~104@)) (Sub (Mul b12~100@ c12~102@) (Mul b12~100@ c12~102@))) (Mul (Sub (Mul a12~98@ a12~98@) (Sub d12~104@ d12~104@)) (Mul (Mul c12~102@ a12~98@) (Mul d12~104@ b12~100@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b12~100@ d12~104@) (=> %%location_label%%12 (= temp_12_0~2291@ temp_12_1~2356@))) (=> (= temp_12_0~2291@ temp_12_1~2356@) (=> (= temp_13_0~2449@ (Mul (Mul (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@)) (Mul (Mul d13~112@ d13~112@) (Mul d13~112@ b13~108@))) (Mul (Mul (Mul d13~112@ c13~110@) (Mul b13~108@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ c13~110@))))) (=> (= temp_13_1~2514@ (Mul (Mul (Mul (Mul b13~108@ c13~110@) (Mul d13~112@ b13~108@)) (Mul (Mul d13~112@ d13~112@) (Mul d13~112@ b13~108@))) (Mul (Mul (Mul c13~110@ d13~112@) (Mul b13~108@ b13~108@)) (Mul (Mul b13~108@ b13~108@) (Mul b13~108@ c13~110@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d13~112@ c13~110@) (=> %%location_label%%13 (= temp_13_0~2449@ temp_13_1~2514@))) (=> (= temp_13_0~2449@ temp_13_1~2514@) (=> (= temp_14_0~2607@ (Mul (Add (Mul (Sub d14~120@ a14~114@) (Mul a14~114@ d14~120@)) (Sub (Mul c14~118@ d14~120@) (Mul b14~116@ c14~118@))) (Mul (Add (Add c14~118@ a14~114@) (Add d14~120@ a14~114@)) (Mul (Mul b14~116@ d14~120@) (Mul c14~118@ d14~120@))))) (=> (= temp_14_1~2672@ (Mul (Add (Mul (Sub d14~120@ a14~114@) (Mul a14~114@ d14~120@)) (Sub (Mul d14~120@ c14~118@) (Mul b14~116@ c14~118@))) (Mul (Add (Add c14~118@ a14~114@) (Add d14~120@ a14~114@)) (Mul (Mul b14~116@ d14~120@) (Mul c14~118@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c14~118@ d14~120@) (=> %%location_label%%14 (= temp_14_0~2607@ temp_14_1~2672@))) (=> (= temp_14_0~2607@ temp_14_1~2672@) (=> (= temp_15_0~2773@ (Mul (Mul (Mul (Mul 24 c15~126@) (Sub c15~126@ b15~124@)) (Mul a15~122@ (Mul d15~128@ a15~122@))) (Mul (Mul (Sub c15~126@ d15~128@) (Add c15~126@ d15~128@)) (Sub (Sub c15~126@ b15~124@) (Mul d15~128@ d15~128@))))) (=> (= temp_15_1~2846@ (Mul (Mul (Mul 24 (Mul c15~126@ (Sub c15~126@ b15~124@))) (Mul a15~122@ (Mul d15~128@ a15~122@))) (Mul (Mul (Sub c15~126@ d15~128@) (Add c15~126@ d15~128@)) (Sub (Sub c15~126@ b15~124@) (Mul d15~128@ d15~128@))))) (and (=> (= tmp%23@ (Sub c15~126@ b15~124@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. 24 c15~126@ tmp%23@) (=> %%location_label%%15 (= temp_15_0~2773@ temp_15_1~2846@)))) (=> (= temp_15_0~2773@ temp_15_1~2846@) (=> (= temp_16_0~2941@ (Mul (Mul (Add b16~132@ (Mul b16~132@ d16~136@)) (Sub (Mul b16~132@ d16~136@) (Mul a16~130@ c16~134@))) (Mul a16~130@ (Mul (Mul a16~130@ a16~130@) (Mul c16~134@ a16~130@))))) (=> (= temp_16_1~2990@ (Mul (Mul (Add b16~132@ (Mul b16~132@ d16~136@)) (Sub (Mul d16~136@ b16~132@) (Mul a16~130@ c16~134@))) (Mul a16~130@ (Mul (Mul a16~130@ a16~130@) (Mul c16~134@ a16~130@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b16~132@ d16~136@) (=> %%location_label%%16 (= temp_16_0~2941@ temp_16_1~2990@))) (=> (= temp_16_0~2941@ temp_16_1~2990@) (=> (= temp_17_0~3079@ (Mul (Mul (Mul (Sub d17~144@ a17~138@) (Mul d17~144@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ a17~138@))) (Mul (Mul c17~142@ (Mul b17~140@ d17~144@)) (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ a17~138@))))) (=> (= temp_17_1~3140@ (Mul (Mul (Mul (Sub d17~144@ a17~138@) (Mul d17~144@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul d17~144@ a17~138@))) (Mul (Mul c17~142@ (Mul b17~140@ d17~144@)) (Mul b17~140@ (Mul a17~138@ (Mul d17~144@ a17~138@)))))) (and (=> (= tmp%24@ (Mul d17~144@ a17~138@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b17~140@ a17~138@ tmp%24@) (=> %%location_label%%17 (= temp_17_0~3079@ temp_17_1~3140@)))) (=> (= temp_17_0~3079@ temp_17_1~3140@) (=> (= temp_18_0~3235@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ a18~146@)) (Mul (Add c18~150@ c18~150@) (Mul a18~146@ c18~150@))) (Mul (Mul (Add d18~152@ c18~150@) (Mul c18~150@ a18~146@)) (Sub (Mul a18~146@ b18~148@) a18~146@)))) (=> (= temp_18_1~3296@ (Mul (Mul (Mul (Mul d18~152@ c18~150@) (Mul d18~152@ a18~146@)) (Mul (Mul a18~146@ c18~150@) (Add c18~150@ c18~150@))) (Mul (Mul (Add d18~152@ c18~150@) (Mul c18~150@ a18~146@)) (Sub (Mul a18~146@ b18~148@) a18~146@)))) (and (=> (= tmp%25@ (Add c18~150@ c18~150@)) (=> (= tmp%26@ (Mul a18~146@ c18~150@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%25@ tmp%26@) (=> %%location_label%%18 (= temp_18_0~3235@ temp_18_1~3296@))))) (=> (= temp_18_0~3235@ temp_18_1~3296@) (=> (= temp_19_0~3413@ (Sub (Mul (Mul b19~156@ (Mul b19~156@ c19~158@)) (Mul (Mul c19~158@ 3) (Mul 58 c19~158@))) (Mul (Mul a19~154@ (Mul c19~158@ c19~158@)) (Mul (Mul d19~160@ a19~154@) (Mul b19~156@ a19~154@))))) (=> (= temp_19_1~3494@ (Sub (Mul (Mul (Mul b19~156@ b19~156@) c19~158@) (Mul (Mul c19~158@ 3) (Mul 58 c19~158@))) (Mul (Mul a19~154@ (Mul c19~158@ c19~158@)) (Mul (Mul d19~160@ a19~154@) (Mul b19~156@ a19~154@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b19~156@ b19~156@ c19~158@) (=> %%location_label%%19 (= temp_19_0~3413@ temp_19_1~3494@))) (=> (= temp_19_0~3413@ temp_19_1~3494@) (=> (= temp_20_0~3589@ (Add (Mul (Add (Mul d20~168@ b20~164@) (Mul c20~166@ b20~164@)) (Mul (Mul c20~166@ c20~166@) (Sub a20~162@ a20~162@))) (Sub (Mul (Mul d20~168@ d20~168@) (Mul c20~166@ d20~168@)) (Mul (Mul d20~168@ a20~162@) (Mul c20~166@ a20~162@))))) (=> (= temp_20_1~3654@ (Add (Mul (Add (Mul d20~168@ b20~164@) (Mul c20~166@ b20~164@)) (Mul (Mul c20~166@ c20~166@) (Sub a20~162@ a20~162@))) (Sub (Mul (Mul d20~168@ d20~168@) (Mul c20~166@ d20~168@)) (Mul (Mul c20~166@ a20~162@) (Mul d20~168@ a20~162@))))) (and (=> (= tmp%27@ (Mul d20~168@ a20~162@)) (=> (= tmp%28@ (Mul c20~166@ a20~162@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%27@ tmp%28@) (=> %%location_label%%20 (= temp_20_0~3589@ temp_20_1~3654@))))) (=> (= temp_20_0~3589@ temp_20_1~3654@) (=> (= temp_21_0~3755@ (Mul (Add (Mul (Mul a21~170@ b21~172@) (Mul b21~172@ a21~170@)) (Add (Mul b21~172@ d21~176@) (Mul b21~172@ a21~170@))) (Sub 50 (Mul (Mul b21~172@ a21~170@) (Mul d21~176@ a21~170@))))) (=> (= temp_21_1~3820@ (Mul (Add (Mul (Mul b21~172@ a21~170@) (Mul b21~172@ a21~170@)) (Add (Mul b21~172@ d21~176@) (Mul b21~172@ a21~170@))) (Sub 50 (Mul (Mul b21~172@ a21~170@) (Mul d21~176@ a21~170@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a21~170@ b21~172@) (=> %%location_label%%21 (= temp_21_0~3755@ temp_21_1~3820@))) (=> (= temp_21_0~3755@ temp_21_1~3820@) (=> (= temp_22_0~3925@ (Mul (Add (Mul (Add b22~180@ b22~180@) (Sub a22~178@ b22~180@)) (Mul (Mul b22~180@ c22~182@) (Mul c22~182@ a22~178@))) (Mul (Mul (Mul d22~184@ c22~182@) (Mul 85 c22~182@)) (Mul (Mul b22~180@ b22~180@) (Mul c22~182@ a22~178@))))) (=> (= temp_22_1~4002@ (Mul (Add (Mul (Add b22~180@ b22~180@) (Sub a22~178@ b22~180@)) (Mul (Mul b22~180@ c22~182@) (Mul c22~182@ a22~178@))) (Mul (Mul (Mul b22~180@ b22~180@) (Mul c22~182@ a22~178@)) (Mul (Mul d22~184@ c22~182@) (Mul 85 c22~182@))))) (=> (= tmp%29@ (Mul (Mul d22~184@ c22~182@) (Mul 85 c22~182@))) (=> (= tmp%30@ (Mul (Mul b22~180@ b22~180@) (Mul c22~182@ a22~178@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%29@ tmp%30@) (=> %%location_label%%22 (= temp_22_0~3925@ temp_22_1~4002@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
