...
(set-info :comment ";; mariposa_data/v_nl//11244479749294734584/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Sub (Mul (Mul (Mul b0~4@ d0~8@) (Sub a0~2@ d0~8@)) (Mul (Mul a0~2@ 74) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@)) (Add (Mul c0~6@ b0~4@) (Mul a0~2@ b0~4@)))) (Sub (Sub (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ a0~2@)) (Mul c0~6@ (Sub d0~8@ 78))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@)) (Mul d0~8@ (Mul a0~2@ d0~8@)))))) (=> (= temp_0_1~450@ (Sub (Sub (Mul (Mul (Mul b0~4@ d0~8@) (Sub a0~2@ d0~8@)) (Mul (Mul a0~2@ 74) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@)) (Add (Mul c0~6@ b0~4@) (Mul a0~2@ b0~4@)))) (Sub (Sub (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ a0~2@)) (Mul c0~6@ (Sub d0~8@ 78))) (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@)) d0~8@) (Mul a0~2@ d0~8@))))) (and (=> (= tmp%1@ (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@))) (=> (= tmp%2@ (Mul a0~2@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ d0~8@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~450@))))) (=> (= temp_0_0~305@ temp_0_1~450@) (=> (= temp_1_0~613@ (Mul (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Sub d1~16@ a1~10@) (Add d1~16@ a1~10@))) (Sub (Add (Mul a1~10@ c1~14@) (Add b1~12@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@)))) (Add (Mul (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@)) c1~14@) (Mul (Mul (Add d1~16@ c1~14@) (Add b1~12@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ c1~14@)))))) (=> (= temp_1_1~730@ (Mul (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Add d1~16@ a1~10@) (Sub d1~16@ a1~10@))) (Sub (Add (Mul a1~10@ c1~14@) (Add b1~12@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@)))) (Add (Mul (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@)) c1~14@) (Mul (Mul (Add d1~16@ c1~14@) (Add b1~12@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ c1~14@)))))) (and (=> (= tmp%3@ (Sub d1~16@ a1~10@)) (=> (= tmp%4@ (Add d1~16@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~613@ temp_1_1~730@))))) (=> (= temp_1_0~613@ temp_1_1~730@) (=> (= temp_2_0~915@ (Mul (Mul (Mul (Mul (Add d2~24@ c2~22@) (Mul 50 d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@))) (Sub (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ c2~22@)))) (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ 25) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ c2~22@) a2~18@) (Add (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@)))))) (=> (= temp_2_1~1064@ (Mul (Mul (Mul (Mul (Add d2~24@ c2~22@) (Mul 50 d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@))) (Sub (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ c2~22@)))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul (Mul c2~22@ a2~18@) (Mul (Mul b2~20@ 25) (Mul c2~22@ b2~20@)))) (Mul (Mul (Mul c2~22@ c2~22@) a2~18@) (Add (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@)))))) (and (=> (= tmp%5@ (Mul a2~18@ b2~20@)) (=> (= tmp%6@ (Mul c2~22@ a2~18@)) (=> (= tmp%7@ (Mul (Mul b2~20@ 25) (Mul c2~22@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~915@ temp_2_1~1064@)))))) (=> (= temp_2_0~915@ temp_2_1~1064@) (=> (= temp_3_0~1235@ (Mul (Add (Add (Mul (Mul c3~30@ d3~32@) (Add c3~30@ b3~28@)) (Add (Sub b3~28@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Sub a3~26@ a3~26@) (Mul d3~32@ d3~32@)))) (Mul (Mul (Add (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@)) (Mul c3~30@ c3~30@)) (Mul (Mul (Add c3~30@ b3~28@) (Mul a3~26@ d3~32@)) c3~30@)))) (=> (= temp_3_1~1344@ (Mul (Add (Add (Mul (Mul c3~30@ d3~32@) (Add c3~30@ b3~28@)) (Add (Sub b3~28@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Sub a3~26@ a3~26@) (Mul d3~32@ d3~32@)))) (Mul (Mul (Add (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@)) (Mul c3~30@ c3~30@)) (Mul (Mul (Add c3~30@ b3~28@) (Mul a3~26@ d3~32@)) c3~30@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ d3~32@) (=> %%location_label%%3 (= temp_3_0~1235@ temp_3_1~1344@))) (=> (= temp_3_0~1235@ temp_3_1~1344@) (=> (= temp_4_0~1509@ (Mul (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Sub (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@))) (Sub (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ d4~40@)))) (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Add b4~36@ d4~40@) (Mul a4~34@ d4~40@))) (Sub (Mul a4~34@ (Sub c4~38@ a4~34@)) (Mul (Mul 52 c4~38@) (Mul b4~36@ a4~34@)))))) (=> (= temp_4_1~1654@ (Mul (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Sub (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@))) (Sub (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ d4~40@)))) (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@)) (Add (Mul b4~36@ (Mul a4~34@ d4~40@)) (Mul d4~40@ (Mul a4~34@ d4~40@)))) (Sub (Mul a4~34@ (Sub c4~38@ a4~34@)) (Mul (Mul 52 c4~38@) (Mul b4~36@ a4~34@)))))) (and (=> (= tmp%8@ (Mul a4~34@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b4~36@ d4~40@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~1509@ temp_4_1~1654@)))) (=> (= temp_4_0~1509@ temp_4_1~1654@) (=> (= temp_5_0~1817@ (Mul (Mul (Mul a5~42@ (Mul (Add a5~42@ 39) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ b5~44@) d5~48@))) (Mul (Mul (Sub (Mul c5~46@ a5~42@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) b5~44@)) (Mul (Sub (Mul a5~42@ a5~42@) (Mul 83 b5~44@)) (Mul c5~46@ (Mul d5~48@ a5~42@)))))) (=> (= temp_5_1~1946@ (Mul (Mul (Mul a5~42@ (Mul (Add a5~42@ 39) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ b5~44@) d5~48@))) (Mul (Mul (Mul (Sub (Mul c5~46@ a5~42@) (Mul c5~46@ b5~44@)) (Mul b5~44@ c5~46@)) b5~44@) (Mul (Sub (Mul a5~42@ a5~42@) (Mul 83 b5~44@)) (Mul c5~46@ (Mul d5~48@ a5~42@)))))) (and (=> (= tmp%9@ (Sub (Mul c5~46@ a5~42@) (Mul c5~46@ b5~44@))) (=> (= tmp%10@ (Mul b5~44@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1817@ temp_5_1~1946@))))) (=> (= temp_5_0~1817@ temp_5_1~1946@) (=> (= temp_6_0~2113@ (Mul (Add (Mul (Mul d6~56@ (Mul d6~56@ c6~54@)) (Mul a6~50@ (Mul c6~54@ c6~54@))) (Mul (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ a6~50@)) (Add (Mul a6~50@ b6~52@) (Mul d6~56@ a6~50@)))) (Mul (Mul (Mul (Sub b6~52@ b6~52@) (Add a6~50@ c6~54@)) (Mul (Sub c6~54@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Sub c6~54@ b6~52@) (Add c6~54@ b6~52@)))))) (=> (= temp_6_1~2234@ (Mul (Add (Mul (Mul d6~56@ (Mul d6~56@ c6~54@)) (Mul a6~50@ (Mul c6~54@ c6~54@))) (Mul (Mul b6~52@ d6~56@) (Mul (Mul b6~52@ a6~50@) (Add (Mul a6~50@ b6~52@) (Mul d6~56@ a6~50@))))) (Mul (Mul (Mul (Sub b6~52@ b6~52@) (Add a6~50@ c6~54@)) (Mul (Sub c6~54@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Sub c6~54@ b6~52@) (Add c6~54@ b6~52@)))))) (and (=> (= tmp%11@ (Mul b6~52@ d6~56@)) (=> (= tmp%12@ (Mul b6~52@ a6~50@)) (=> (= tmp%13@ (Add (Mul a6~50@ b6~52@) (Mul d6~56@ a6~50@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%6 (= temp_6_0~2113@ temp_6_1~2234@)))))) (=> (= temp_6_0~2113@ temp_6_1~2234@) (=> (= temp_7_0~2417@ (Mul (Mul (Mul (Mul (Mul a7~58@ a7~58@) b7~60@) (Mul b7~60@ (Mul b7~60@ b7~60@))) (Mul (Sub (Mul b7~60@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Mul 44 a7~58@) (Mul a7~58@ c7~62@)))) (Sub (Mul (Mul (Mul d7~64@ d7~64@) (Add d7~64@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ c7~62@)))))) (=> (= temp_7_1~2550@ (Mul (Mul (Mul (Mul (Mul a7~58@ a7~58@) b7~60@) (Mul b7~60@ (Mul b7~60@ b7~60@))) (Mul (Sub (Mul b7~60@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Mul 44 a7~58@) (Mul a7~58@ c7~62@)))) (Sub (Mul (Mul (Mul d7~64@ d7~64@) (Add d7~64@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ c7~62@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ b7~60@) (=> %%location_label%%7 (= temp_7_0~2417@ temp_7_1~2550@))) (=> (= temp_7_0~2417@ temp_7_1~2550@) (=> (= temp_8_0~2715@ (Mul (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ a8~66@))) (Mul (Mul a8~66@ (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ b8~68@)))) (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ 79)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Add b8~68@ a8~66@)))))) (=> (= temp_8_1~2852@ (Mul (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ a8~66@))) (Mul (Mul a8~66@ (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ b8~68@)))) (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ 79)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Add b8~68@ a8~66@) (Mul b8~68@ a8~66@)))))) (and (=> (= tmp%14@ (Mul b8~68@ a8~66@)) (=> (= tmp%15@ (Add b8~68@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%8 (= temp_8_0~2715@ temp_8_1~2852@))))) (=> (= temp_8_0~2715@ temp_8_1~2852@) (=> (= temp_9_0~2953@ (Mul d9~80@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ d9~80@) (Mul d9~80@ b9~76@))) (Mul (Mul (Mul a9~74@ c9~78@) (Add c9~78@ c9~78@)) (Mul (Mul c9~78@ c9~78@) b9~76@))))) (=> (= temp_9_1~3018@ (Mul d9~80@ (Mul (Mul (Mul (Mul a9~74@ c9~78@) (Add c9~78@ c9~78@)) (Mul (Mul c9~78@ c9~78@) b9~76@)) (Mul (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ d9~80@) (Mul d9~80@ b9~76@)))))) (and (=> (= tmp%16@ (Mul (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ d9~80@) (Mul d9~80@ b9~76@)))) (=> (= tmp%17@ (Mul (Mul (Mul a9~74@ c9~78@) (Add c9~78@ c9~78@)) (Mul (Mul c9~78@ c9~78@) b9~76@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ tmp%17@) (=> %%location_label%%9 (= temp_9_0~2953@ temp_9_1~3018@))))) (=> (= temp_9_0~2953@ temp_9_1~3018@) (=> (= temp_10_0~3227@ (Sub (Mul (Add (Sub a10~82@ (Sub d10~88@ d10~88@)) (Add b10~84@ (Mul b10~84@ a10~82@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ d10~88@)) (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ c10~86@)))) (Mul (Sub (Sub c10~86@ (Mul c10~86@ b10~84@)) (Sub (Sub d10~88@ 37) (Mul c10~86@ a10~82@))) (Add (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ c10~86@)))))) (=> (= temp_10_1~3356@ (Sub (Mul (Mul (Add (Sub a10~82@ (Sub d10~88@ d10~88@)) (Add b10~84@ (Mul b10~84@ a10~82@))) (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ d10~88@))) (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ c10~86@))) (Mul (Sub (Sub c10~86@ (Mul c10~86@ b10~84@)) (Sub (Sub d10~88@ 37) (Mul c10~86@ a10~82@))) (Add (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ c10~86@)))))) (and (=> (= tmp%18@ (Add (Sub a10~82@ (Sub d10~88@ d10~88@)) (Add b10~84@ (Mul b10~84@ a10~82@)))) (=> (= tmp%19@ (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ d10~88@))) (=> (= tmp%20@ (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ c10~86@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%18@ tmp%19@ tmp%20@) (=> %%location_label%%10 (= temp_10_0~3227@ temp_10_1~3356@)))))) (=> (= temp_10_0~3227@ temp_10_1~3356@) (=> (= temp_11_0~3551@ (Mul (Mul (Mul (Mul (Add c11~94@ d11~96@) (Mul a11~90@ c11~94@)) (Mul b11~92@ (Mul c11~94@ d11~96@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ d11~96@) c11~94@))) (Mul (Mul (Sub (Add a11~90@ a11~90@) (Sub b11~92@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Add a11~90@ d11~96@))) (Mul (Sub (Mul c11~94@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul c11~94@ c11~94@) (Mul a11~90@ c11~94@)))))) (=> (= temp_11_1~3672@ (Mul (Mul (Mul (Mul (Add c11~94@ d11~96@) (Mul a11~90@ c11~94@)) (Mul b11~92@ (Mul c11~94@ d11~96@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ d11~96@) c11~94@))) (Mul (Mul (Sub (Add a11~90@ a11~90@) (Sub b11~92@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Add a11~90@ d11~96@))) (Mul (Sub (Mul c11~94@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ c11~94@)))))) (and (=> (= tmp%21@ (Mul c11~94@ c11~94@)) (=> (= tmp%22@ (Mul a11~90@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%11 (= temp_11_0~3551@ temp_11_1~3672@))))) (=> (= temp_11_0~3551@ temp_11_1~3672@) (=> (= temp_12_0~3777@ (Mul (Mul (Add (Mul (Sub d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Add d12~104@ b12~100@))) (Mul (Mul (Mul a12~98@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ a12~98@)))) c12~102@)) (=> (= temp_12_1~3846@ (Mul (Mul (Add (Mul (Sub d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Add d12~104@ b12~100@))) (Mul (Mul (Mul a12~98@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ c12~102@) (Mul a12~98@ c12~102@)))) c12~102@)) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c12~102@ a12~98@) (=> %%location_label%%12 (= temp_12_0~3777@ temp_12_1~3846@))) (=> (= temp_12_0~3777@ temp_12_1~3846@) (=> (= temp_13_0~3991@ (Mul (Mul (Add (Mul (Add b13~108@ d13~112@) (Mul a13~106@ b13~108@)) (Mul (Mul d13~112@ a13~106@) (Add a13~106@ c13~110@))) (Mul (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@)) (Mul (Mul c13~110@ a13~106@) (Add b13~108@ c13~110@)))) (Mul (Sub c13~110@ (Mul (Add d13~112@ d13~112@) (Mul d13~112@ b13~108@))) (Mul (Mul (Add c13~110@ c13~110@) (Mul b13~108@ d13~112@)) (Sub (Mul b13~108@ c13~110@) (Add c13~110@ b13~108@)))))) (=> (= temp_13_1~4108@ (Mul (Mul (Add (Mul (Add b13~108@ d13~112@) (Mul a13~106@ b13~108@)) (Mul (Mul d13~112@ a13~106@) (Add a13~106@ c13~110@))) (Mul (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@)) (Mul (Mul c13~110@ a13~106@) (Add b13~108@ c13~110@)))) (Mul (Mul (Sub c13~110@ (Mul (Add d13~112@ d13~112@) (Mul d13~112@ b13~108@))) (Mul (Add c13~110@ c13~110@) (Mul b13~108@ d13~112@))) (Sub (Mul b13~108@ c13~110@) (Add c13~110@ b13~108@))))) (=> (= tmp%23@ (Sub c13~110@ (Mul (Add d13~112@ d13~112@) (Mul d13~112@ b13~108@)))) (=> (= tmp%24@ (Mul (Add c13~110@ c13~110@) (Mul b13~108@ d13~112@))) (=> (= tmp%25@ (Sub (Mul b13~108@ c13~110@) (Add c13~110@ b13~108@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%23@ tmp%24@ tmp%25@) (=> %%location_label%%13 (= temp_13_0~3991@ temp_13_1~4108@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
