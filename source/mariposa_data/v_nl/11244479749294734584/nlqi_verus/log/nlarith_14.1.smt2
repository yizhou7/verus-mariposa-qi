...
(declare-const temp_1_0~582@ Int)
(declare-const temp_1_1~699@ Int)
(declare-const temp_2_0~863@ Int)
(declare-const temp_2_1~1012@ Int)
(declare-const temp_3_0~1136@ Int)
(declare-const temp_3_1~1245@ Int)
(declare-const temp_4_0~1397@ Int)
(declare-const temp_4_1~1542@ Int)
(declare-const temp_5_0~1686@ Int)
(declare-const temp_5_1~1815@ Int)
(declare-const temp_6_0~1951@ Int)
(declare-const temp_6_1~2072@ Int)
(declare-const temp_7_0~2220@ Int)
(declare-const temp_7_1~2353@ Int)
(declare-const temp_8_0~2505@ Int)
(declare-const temp_8_1~2642@ Int)
(declare-const temp_9_0~2722@ Int)
(declare-const temp_9_1~2787@ Int)
(declare-const temp_10_0~2931@ Int)
(declare-const temp_10_1~3060@ Int)
(declare-const temp_11_0~3196@ Int)
(declare-const temp_11_1~3317@ Int)
(declare-const temp_12_0~3401@ Int)
(declare-const temp_12_1~3470@ Int)
(declare-const temp_13_0~3602@ Int)
(declare-const temp_13_1~3719@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Sub (Sub (Mul (Mul (Mul b0~4@ d0~8@) (Sub a0~2@ d0~8@)) (Mul (Mul a0~2@ 74) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@)) (Add (Mul c0~6@ b0~4@) (Mul a0~2@ b0~4@)))) (Sub (Sub (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ a0~2@)) (Mul c0~6@ (Sub d0~8@ 78))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@)) (Mul d0~8@ (Mul a0~2@ d0~8@)))))) (=> (= temp_0_1~450@ (Sub (Sub (Mul (Mul (Mul b0~4@ d0~8@) (Sub a0~2@ d0~8@)) (Mul (Mul a0~2@ 74) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@)) (Add (Mul c0~6@ b0~4@) (Mul a0~2@ b0~4@)))) (Sub (Sub (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ a0~2@)) (Mul c0~6@ (Sub d0~8@ 78))) (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ a0~2@)) d0~8@) (Mul a0~2@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~450@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~582@ (Mul (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Sub d1~16@ a1~10@) (Add d1~16@ a1~10@))) (Sub (Add (Mul a1~10@ c1~14@) (Add b1~12@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@)))) (Add (Mul (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@)) c1~14@) (Mul (Mul (Add d1~16@ c1~14@) (Add b1~12@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ c1~14@)))))) (=> (= temp_1_1~699@ (Mul (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Add d1~16@ a1~10@) (Sub d1~16@ a1~10@))) (Sub (Add (Mul a1~10@ c1~14@) (Add b1~12@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@)))) (Add (Mul (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@)) c1~14@) (Mul (Mul (Add d1~16@ c1~14@) (Add b1~12@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ c1~14@)))))) (=> (= tmp%2@ (= temp_1_0~582@ temp_1_1~699@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~863@ (Mul (Mul (Mul (Mul (Add d2~24@ c2~22@) (Mul 50 d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@))) (Sub (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ c2~22@)))) (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ a2~18@)) (Mul (Mul b2~20@ 25) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul c2~22@ c2~22@) a2~18@) (Add (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@)))))) (=> (= temp_2_1~1012@ (Mul (Mul (Mul (Mul (Add d2~24@ c2~22@) (Mul 50 d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@))) (Sub (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ c2~22@)))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul (Mul c2~22@ a2~18@) (Mul (Mul b2~20@ 25) (Mul c2~22@ b2~20@)))) (Mul (Mul (Mul c2~22@ c2~22@) a2~18@) (Add (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@)))))) (=> (= tmp%3@ (= temp_2_0~863@ temp_2_1~1012@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1136@ (Mul (Add (Add (Mul (Mul c3~30@ d3~32@) (Add c3~30@ b3~28@)) (Add (Sub b3~28@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Sub a3~26@ a3~26@) (Mul d3~32@ d3~32@)))) (Mul (Mul (Add (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@)) (Mul c3~30@ c3~30@)) (Mul (Mul (Add c3~30@ b3~28@) (Mul a3~26@ d3~32@)) c3~30@)))) (=> (= temp_3_1~1245@ (Mul (Add (Add (Mul (Mul c3~30@ d3~32@) (Add c3~30@ b3~28@)) (Add (Sub b3~28@ d3~32@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Sub a3~26@ a3~26@) (Mul d3~32@ d3~32@)))) (Mul (Mul (Add (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@)) (Mul c3~30@ c3~30@)) (Mul (Mul (Add c3~30@ b3~28@) (Mul a3~26@ d3~32@)) c3~30@)))) (=> (= tmp%4@ (= temp_3_0~1136@ temp_3_1~1245@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1397@ (Mul (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Sub (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@))) (Sub (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ d4~40@)))) (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Add b4~36@ d4~40@) (Mul a4~34@ d4~40@))) (Sub (Mul a4~34@ (Sub c4~38@ a4~34@)) (Mul (Mul 52 c4~38@) (Mul b4~36@ a4~34@)))))) (=> (= temp_4_1~1542@ (Mul (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Sub (Mul d4~40@ b4~36@) (Mul b4~36@ c4~38@))) (Sub (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul a4~34@ d4~40@)))) (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@)) (Add (Mul b4~36@ (Mul a4~34@ d4~40@)) (Mul d4~40@ (Mul a4~34@ d4~40@)))) (Sub (Mul a4~34@ (Sub c4~38@ a4~34@)) (Mul (Mul 52 c4~38@) (Mul b4~36@ a4~34@)))))) (=> (= tmp%5@ (= temp_4_0~1397@ temp_4_1~1542@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1686@ (Mul (Mul (Mul a5~42@ (Mul (Add a5~42@ 39) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ b5~44@) d5~48@))) (Mul (Mul (Sub (Mul c5~46@ a5~42@) (Mul c5~46@ b5~44@)) (Mul (Mul b5~44@ c5~46@) b5~44@)) (Mul (Sub (Mul a5~42@ a5~42@) (Mul 83 b5~44@)) (Mul c5~46@ (Mul d5~48@ a5~42@)))))) (=> (= temp_5_1~1815@ (Mul (Mul (Mul a5~42@ (Mul (Add a5~42@ 39) (Mul b5~44@ c5~46@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ b5~44@) d5~48@))) (Mul (Mul (Mul (Sub (Mul c5~46@ a5~42@) (Mul c5~46@ b5~44@)) (Mul b5~44@ c5~46@)) b5~44@) (Mul (Sub (Mul a5~42@ a5~42@) (Mul 83 b5~44@)) (Mul c5~46@ (Mul d5~48@ a5~42@)))))) (=> (= tmp%6@ (= temp_5_0~1686@ temp_5_1~1815@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1951@ (Mul (Add (Mul (Mul d6~56@ (Mul d6~56@ c6~54@)) (Mul a6~50@ (Mul c6~54@ c6~54@))) (Mul (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ a6~50@)) (Add (Mul a6~50@ b6~52@) (Mul d6~56@ a6~50@)))) (Mul (Mul (Mul (Sub b6~52@ b6~52@) (Add a6~50@ c6~54@)) (Mul (Sub c6~54@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Sub c6~54@ b6~52@) (Add c6~54@ b6~52@)))))) (=> (= temp_6_1~2072@ (Mul (Add (Mul (Mul d6~56@ (Mul d6~56@ c6~54@)) (Mul a6~50@ (Mul c6~54@ c6~54@))) (Mul (Mul b6~52@ d6~56@) (Mul (Mul b6~52@ a6~50@) (Add (Mul a6~50@ b6~52@) (Mul d6~56@ a6~50@))))) (Mul (Mul (Mul (Sub b6~52@ b6~52@) (Add a6~50@ c6~54@)) (Mul (Sub c6~54@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Sub c6~54@ b6~52@) (Add c6~54@ b6~52@)))))) (=> (= tmp%7@ (= temp_6_0~1951@ temp_6_1~2072@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2220@ (Mul (Mul (Mul (Mul (Mul a7~58@ a7~58@) b7~60@) (Mul b7~60@ (Mul b7~60@ b7~60@))) (Mul (Sub (Mul b7~60@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Mul 44 a7~58@) (Mul a7~58@ c7~62@)))) (Sub (Mul (Mul (Mul d7~64@ d7~64@) (Add d7~64@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ c7~62@)))))) (=> (= temp_7_1~2353@ (Mul (Mul (Mul (Mul (Mul a7~58@ a7~58@) b7~60@) (Mul b7~60@ (Mul b7~60@ b7~60@))) (Mul (Sub (Mul b7~60@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Mul 44 a7~58@) (Mul a7~58@ c7~62@)))) (Sub (Mul (Mul (Mul d7~64@ d7~64@) (Add d7~64@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ c7~62@)))))) (=> (= tmp%8@ (= temp_7_0~2220@ temp_7_1~2353@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~2505@ (Mul (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ a8~66@))) (Mul (Mul a8~66@ (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ b8~68@)))) (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ 79)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Add b8~68@ a8~66@)))))) (=> (= temp_8_1~2642@ (Mul (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ a8~66@))) (Mul (Mul a8~66@ (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ b8~68@)))) (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ 79)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Add b8~68@ a8~66@) (Mul b8~68@ a8~66@)))))) (=> (= tmp%9@ (= temp_8_0~2505@ temp_8_1~2642@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~2722@ (Mul d9~80@ (Mul (Mul (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ d9~80@) (Mul d9~80@ b9~76@))) (Mul (Mul (Mul a9~74@ c9~78@) (Add c9~78@ c9~78@)) (Mul (Mul c9~78@ c9~78@) b9~76@))))) (=> (= temp_9_1~2787@ (Mul d9~80@ (Mul (Mul (Mul (Mul a9~74@ c9~78@) (Add c9~78@ c9~78@)) (Mul (Mul c9~78@ c9~78@) b9~76@)) (Mul (Mul (Mul a9~74@ b9~76@) (Mul a9~74@ b9~76@)) (Mul (Mul a9~74@ d9~80@) (Mul d9~80@ b9~76@)))))) (=> (= tmp%10@ (= temp_9_0~2722@ temp_9_1~2787@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~2931@ (Sub (Mul (Add (Sub a10~82@ (Sub d10~88@ d10~88@)) (Add b10~84@ (Mul b10~84@ a10~82@))) (Mul (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ d10~88@)) (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ c10~86@)))) (Mul (Sub (Sub c10~86@ (Mul c10~86@ b10~84@)) (Sub (Sub d10~88@ 37) (Mul c10~86@ a10~82@))) (Add (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ c10~86@)))))) (=> (= temp_10_1~3060@ (Sub (Mul (Mul (Add (Sub a10~82@ (Sub d10~88@ d10~88@)) (Add b10~84@ (Mul b10~84@ a10~82@))) (Mul (Mul b10~84@ a10~82@) (Mul d10~88@ d10~88@))) (Mul (Sub d10~88@ b10~84@) (Mul b10~84@ c10~86@))) (Mul (Sub (Sub c10~86@ (Mul c10~86@ b10~84@)) (Sub (Sub d10~88@ 37) (Mul c10~86@ a10~82@))) (Add (Mul (Mul c10~86@ a10~82@) (Mul a10~82@ a10~82@)) (Mul (Mul c10~86@ a10~82@) (Mul c10~86@ c10~86@)))))) (=> (= tmp%11@ (= temp_10_0~2931@ temp_10_1~3060@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~3196@ (Mul (Mul (Mul (Mul (Add c11~94@ d11~96@) (Mul a11~90@ c11~94@)) (Mul b11~92@ (Mul c11~94@ d11~96@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ d11~96@) c11~94@))) (Mul (Mul (Sub (Add a11~90@ a11~90@) (Sub b11~92@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Add a11~90@ d11~96@))) (Mul (Sub (Mul c11~94@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul c11~94@ c11~94@) (Mul a11~90@ c11~94@)))))) (=> (= temp_11_1~3317@ (Mul (Mul (Mul (Mul (Add c11~94@ d11~96@) (Mul a11~90@ c11~94@)) (Mul b11~92@ (Mul c11~94@ d11~96@))) (Mul (Mul (Mul d11~96@ d11~96@) (Mul c11~94@ c11~94@)) (Mul (Mul d11~96@ d11~96@) c11~94@))) (Mul (Mul (Sub (Add a11~90@ a11~90@) (Sub b11~92@ d11~96@)) (Mul (Mul d11~96@ a11~90@) (Add a11~90@ d11~96@))) (Mul (Sub (Mul c11~94@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ c11~94@)))))) (=> (= tmp%12@ (= temp_11_0~3196@ temp_11_1~3317@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~3401@ (Mul (Mul (Add (Mul (Sub d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Add d12~104@ b12~100@))) (Mul (Mul (Mul a12~98@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ c12~102@) (Mul c12~102@ a12~98@)))) c12~102@)) (=> (= temp_12_1~3470@ (Mul (Mul (Add (Mul (Sub d12~104@ b12~100@) (Mul c12~102@ c12~102@)) (Mul (Mul d12~104@ b12~100@) (Add d12~104@ b12~100@))) (Mul (Mul (Mul a12~98@ d12~104@) (Mul d12~104@ b12~100@)) (Mul (Mul a12~98@ c12~102@) (Mul a12~98@ c12~102@)))) c12~102@)) (=> (= tmp%13@ (= temp_12_0~3401@ temp_12_1~3470@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~3602@ (Mul (Mul (Add (Mul (Add b13~108@ d13~112@) (Mul a13~106@ b13~108@)) (Mul (Mul d13~112@ a13~106@) (Add a13~106@ c13~110@))) (Mul (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@)) (Mul (Mul c13~110@ a13~106@) (Add b13~108@ c13~110@)))) (Mul (Sub c13~110@ (Mul (Add d13~112@ d13~112@) (Mul d13~112@ b13~108@))) (Mul (Mul (Add c13~110@ c13~110@) (Mul b13~108@ d13~112@)) (Sub (Mul b13~108@ c13~110@) (Add c13~110@ b13~108@)))))) (=> (= temp_13_1~3719@ (Mul (Mul (Add (Mul (Add b13~108@ d13~112@) (Mul a13~106@ b13~108@)) (Mul (Mul d13~112@ a13~106@) (Add a13~106@ c13~110@))) (Mul (Mul (Mul a13~106@ c13~110@) (Mul c13~110@ a13~106@)) (Mul (Mul c13~110@ a13~106@) (Add b13~108@ c13~110@)))) (Mul (Mul (Sub c13~110@ (Mul (Add d13~112@ d13~112@) (Mul d13~112@ b13~108@))) (Mul (Add c13~110@ c13~110@) (Mul b13~108@ d13~112@))) (Sub (Mul b13~108@ c13~110@) (Add c13~110@ b13~108@))))) (=> (= tmp%14@ (= temp_13_0~3602@ temp_13_1~3719@)) (=> %%location_label%%13 tmp%14@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
