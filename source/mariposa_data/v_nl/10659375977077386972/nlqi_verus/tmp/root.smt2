...
(push)
 ...
 (declare-const temp_1_1~476@ Int)
 ...
 (declare-const temp_11_0~1947@ Int)
 ...
 (declare-const temp_21_0~3335@ Int)
 (declare-const temp_21_1~3396@ Int)
 (declare-const temp_22_0~3485@ Int)
 (declare-const temp_22_1~3550@ Int)
 (declare-const temp_23_0~3651@ Int)
 (declare-const temp_23_1~3728@ Int)
 (declare-const temp_24_0~3805@ Int)
 (declare-const temp_24_1~3858@ Int)
 (declare-const temp_25_0~3931@ Int)
 (declare-const temp_25_1~3980@ Int)
 (declare-const temp_26_0~4077@ Int)
 (declare-const temp_26_1~4150@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= temp_0_0~305@ temp_0_1~370@)
        (=>
         (= temp_1_0~431@ (Mul (Sub (Mul (Add b1~12@ b1~12@) (Mul c1~14@ a1~10@)) (Add (Mul b1~12@
              b1~12@
             ) (Mul c1~14@ b1~12@)
            )
           ) b1~12@
         ...
         (=>
          (= temp_1_1~476@ (Mul (Sub (Add (Mul b1~12@ (Mul c1~14@ a1~10@)) (Mul b1~12@ (Mul c1~14@
                a1~10@
              ))
          ...
          (and
           (=>
            ...
            (=>
             %%location_label%%1
             (= temp_1_0~431@ temp_1_1~476@)
           ))
           (=>
            (= temp_1_0~431@ temp_1_1~476@)
            (=>
             (= temp_2_0~577@ (Mul (Mul (Sub (Mul 81 b2~20@) (Add a2~18@ b2~20@)) b2~20@) (Mul (Sub
                 (Mul c2~22@ 29) (Add c2~22@ a2~18@)
                ) (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@))
             )))
             (=>
              (= temp_2_1~654@ (Mul (Mul (Sub (Mul 81 b2~20@) (Add a2~18@ b2~20@)) b2~20@) (Mul (Sub
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= temp_2_0~577@ temp_2_1~654@)
               ))
               (=>
                (= temp_2_0~577@ temp_2_1~654@)
                (=>
                 (= temp_3_0~743@ (Add (Sub (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@
                      b3~28@
                     ) (Mul d3~32@ b3~28@)
                    )
                 ...
                 (=>
                  (= temp_3_1~808@ (Add (Sub (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@
                       b3~28@
                      ) (Mul d3~32@ b3~28@)
                     )
                    ) (Mul (Add (Mul b3~28@ d3~32@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Add c3~30@
                  ...
                  (and
                   ...
                   (=>
                    (= temp_3_0~743@ temp_3_1~808@)
                    (=>
                     (= temp_4_0~885@ (Mul (Mul (Sub (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul a4~34@
                          a4~34@
                         ) (Mul c4~38@ d4~40@)
                        )
                     ...
                     (=>
                      (= temp_4_1~938@ (Mul (Mul (Sub (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul a4~34@
                           a4~34@
                          ) (Mul c4~38@ d4~40@)
                         )
                        ) (Sub b4~36@ (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ d4~40@)))
                      ...
                      (and
                       ...
                       (=>
                        (= temp_4_0~885@ temp_4_1~938@)
                        (=>
                         (= temp_5_0~1023@ (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@
                              c5~46@
                             ) (Mul b5~44@ b5~44@)
                            )
                         ...
                         (=>
                          (= temp_5_1~1084@ (Mul (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ b5~44@)) (Mul (Mul
                                d5~48@ c5~46@
                               ) (Mul b5~44@ b5~44@)
                              )
                          ...
                          (and
                           ...
                           (=>
                            (= temp_5_0~1023@ temp_5_1~1084@)
                            (=>
                             (= temp_6_0~1177@ (Mul (Mul (Mul (Mul c6~54@ b6~52@) (Add c6~54@ b6~52@)) (Mul a6~50@
                                 (Sub a6~50@ 38)
                                )
                               ) (Mul (Mul a6~50@ (Mul c6~54@ b6~52@)) (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@)))
                             ))
                             (=>
                              (= temp_6_1~1254@ (Mul (Mul (Add (Mul (Mul c6~54@ b6~52@) c6~54@) (Mul (Mul c6~54@ b6~52@)
                                   b6~52@
                                  )
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 %%location_label%%6
                                 (= temp_6_0~1177@ temp_6_1~1254@)
                               ))
                               (=>
                                (= temp_6_0~1177@ temp_6_1~1254@)
                                (=>
                                 (= temp_7_0~1355@ (Mul (Mul (Mul (Add b7~60@ b7~60@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@
                                      c7~62@
                                     ) (Mul a7~58@ d7~64@)
                                    )
                                 ...
                                 (=>
                                  (= temp_7_1~1440@ (Mul (Mul (Add (Mul b7~60@ (Mul c7~62@ c7~62@)) (Mul b7~60@ (Mul c7~62@
                                        c7~62@
                                      ))
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%7
                                     (= temp_7_0~1355@ temp_7_1~1440@)
                                   ))
                                   (=>
                                    (= temp_7_0~1355@ temp_7_1~1440@)
                                    (=>
                                     (= temp_8_0~1513@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Add d8~72@ c8~70@)) a8~66@) (
                                        Sub (Mul b8~68@ (Mul a8~66@ c8~70@)) (Mul (Sub b8~68@ a8~66@) (Add a8~66@ b8~68@))
                                     )))
                                     (=>
                                      (= temp_8_1~1562@ (Mul (Mul (Mul d8~72@ (Mul a8~66@ (Add d8~72@ c8~70@))) a8~66@) (
                                         Sub (Mul b8~68@ (Mul a8~66@ c8~70@)) (Mul (Sub b8~68@ a8~66@) (Add a8~66@ b8~68@))
                                      )))
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%8
                                         (= temp_8_0~1513@ temp_8_1~1562@)
                                       ))
                                       (=>
                                        (= temp_8_0~1513@ temp_8_1~1562@)
                                        (=>
                                         (= temp_9_0~1647@ (Mul (Mul (Mul d9~80@ (Mul c9~78@ d9~80@)) (Mul (Mul b9~76@ c9~78@)
                                             (Add a9~74@ d9~80@)
                                            )
                                         ...
                                         (=>
                                          (= temp_9_1~1708@ (Mul (Mul (Mul (Mul d9~80@ (Mul c9~78@ d9~80@)) (Mul b9~76@ c9~78@))
                                             (Add a9~74@ d9~80@)
                                            ) (Mul (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ d9~80@)) (Sub (Mul b9~76@ d9~80@) (Add d9~80@
                                               c9~78@
                                          )))))
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%9
                                             (= temp_9_0~1647@ temp_9_1~1708@)
                                           ))
                                           (=>
                                            (= temp_9_0~1647@ temp_9_1~1708@)
                                            (=>
                                             (= temp_10_0~1797@ (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (
                                                  Sub d10~88@ d10~88@
                                                 ) (Mul a10~82@ d10~88@)
                                                )
                                             ...
                                             (=>
                                              (= temp_10_1~1862@ (Mul (Mul (Mul (Sub d10~88@ d10~88@) (Mul a10~82@ d10~88@)) (Mul (
                                                   Mul a10~82@ c10~86@
                                                  ) (Mul d10~88@ d10~88@)
                                                 )
                                                ) (Mul (Sub (Mul c10~86@ b10~84@) (Add a10~82@ d10~88@)) (Mul (Add d10~88@ b10~84@)
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%10
                                                 (= temp_10_0~1797@ temp_10_1~1862@)
                                               ))
                                               (=>
                                                (= temp_10_0~1797@ temp_10_1~1862@)
                                                (=>
                                                 (= temp_11_0~1947@ (Mul (Mul (Mul (Mul a11~90@ d11~96@) (Sub b11~92@ b11~92@)) (Mul d11~96@
                                                     (Mul b11~92@ d11~96@)
                                                    )
                                                 ...
                                                 (=>
                                                  (= temp_11_1~2008@ (Mul (Mul (Mul d11~96@ (Mul b11~92@ d11~96@)) (Mul (Mul a11~90@ d11~96@)
                                                      (Sub b11~92@ b11~92@)
                                                     )
                                                    ) (Mul (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ d11~96@)) (Mul (Mul a11~90@ c11~94@)
                                                      (Mul c11~94@ c11~94@)
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%11
                                                     (= temp_11_0~1947@ temp_11_1~2008@)
                                                   ))
                                                   (=>
                                                    (= temp_11_0~1947@ temp_11_1~2008@)
                                                    (=>
                                                     (= temp_12_0~2105@ (Add (Mul (Mul a12~98@ (Mul b12~100@ d12~104@)) (Mul (Mul b12~100@
                                                          b12~100@
                                                         ) (Mul b12~100@ c12~102@)
                                                        )
                                                     ...
                                                     (=>
                                                      (= temp_12_1~2178@ (Add (Mul (Mul (Mul b12~100@ b12~100@) (Mul b12~100@ c12~102@)) (
                                                      ...
                                                      (and
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%12
                                                         (= temp_12_0~2105@ temp_12_1~2178@)
                                                       ))
                                                       (=>
                                                        (= temp_12_0~2105@ temp_12_1~2178@)
                                                        (=>
                                                         (= temp_13_0~2263@ (Add (Mul (Mul (Sub a13~106@ c13~110@) d13~112@) (Mul (Mul d13~112@
                                                              a13~106@
                                                             ) (Mul c13~110@ c13~110@)
                                                            )
                                                         ...
                                                         (=>
                                                          (= temp_13_1~2324@ (Add (Mul (Mul (Sub a13~106@ c13~110@) d13~112@) (Mul (Mul d13~112@
                                                               a13~106@
                                                              ) (Mul c13~110@ c13~110@)
                                                             )
                                                          ...
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             %%location_label%%13
                                                             (= temp_13_0~2263@ temp_13_1~2324@)
                                                           ))
                                                           (=>
                                                            (= temp_13_0~2263@ temp_13_1~2324@)
                                                            (=>
                                                             (= temp_14_0~2397@ (Mul (Add b14~116@ (Mul (Mul d14~120@ b14~116@) (Add a14~114@ a14~114@)))
                                                               (Mul (Sub a14~114@ (Mul b14~116@ a14~114@)) (Add (Mul c14~118@ b14~116@) (Mul a14~114@
                                                                  d14~120@
                                                             )))))
                                                             (=>
                                                              (= temp_14_1~2446@ (Mul (Add b14~116@ (Mul (Mul d14~120@ b14~116@) (Add a14~114@ a14~114@)))
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%14
                                                                 (= temp_14_0~2397@ temp_14_1~2446@)
                                                               ))
                                                               (=>
                                                                (= temp_14_0~2397@ temp_14_1~2446@)
                                                                (=>
                                                                 (= temp_15_0~2535@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Add c15~126@ b15~124@)) (
                                                                 ...
                                                                 (=>
                                                                  (= temp_15_1~2600@ (Mul (Mul (Mul (Mul d15~128@ c15~126@) (Add c15~126@ b15~124@)) (
                                                                      Mul (Mul b15~124@ b15~124@) (Add c15~126@ a15~122@)
                                                                     )
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%15
                                                                     (= temp_15_0~2535@ temp_15_1~2600@)
                                                                   ))
                                                                   (=>
                                                                    (= temp_15_0~2535@ temp_15_1~2600@)
                                                                    (=>
                                                                     (= temp_16_0~2661@ (Mul (Mul (Mul b16~132@ (Mul b16~132@ c16~134@)) a16~130@) (Mul b16~132@
                                                                        (Mul (Mul b16~132@ d16~136@) (Mul b16~132@ d16~136@))
                                                                     )))
                                                                     (=>
                                                                      (= temp_16_1~2698@ (Mul (Mul b16~132@ (Mul (Mul b16~132@ d16~136@) (Mul b16~132@ d16~136@)))
                                                                      ...
                                                                      (and
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         %%location_label%%16
                                                                         (= temp_16_0~2661@ temp_16_1~2698@)
                                                                       ))
                                                                       (=>
                                                                        (= temp_16_0~2661@ temp_16_1~2698@)
                                                                        (=>
                                                                         (= temp_17_0~2763@ (Mul (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ a17~138@)) d17~144@)
                                                                           (Mul d17~144@ (Mul (Mul b17~140@ d17~144@) (Mul a17~138@ c17~142@)))
                                                                         ))
                                                                         (=>
                                                                          (= temp_17_1~2804@ (Mul (Mul (Mul (Mul d17~144@ c17~142@) (Mul d17~144@ a17~138@)) d17~144@)
                                                                          ...
                                                                          (and
                                                                           (=>
                                                                            ...
                                                                            (=>
                                                                             %%location_label%%17
                                                                             (= temp_17_0~2763@ temp_17_1~2804@)
                                                                           ))
                                                                           (=>
                                                                            (= temp_17_0~2763@ temp_17_1~2804@)
                                                                            (=>
                                                                             (= temp_18_0~2885@ (Mul (Add (Mul (Mul d18~152@ b18~148@) (Mul c18~150@ c18~150@)) (
                                                                             ...
                                                                             (=>
                                                                              (= temp_18_1~2942@ (Mul (Add (Mul (Mul d18~152@ b18~148@) (Mul c18~150@ c18~150@)) (
                                                                              ...
                                                                              (and
                                                                               (=>
                                                                                ...
                                                                                (=>
                                                                                 %%location_label%%18
                                                                                 (= temp_18_0~2885@ temp_18_1~2942@)
                                                                               ))
                                                                               (=>
                                                                                (= temp_18_0~2885@ temp_18_1~2942@)
                                                                                (=>
                                                                                 (= temp_19_0~3043@ (Mul (Mul (Mul (Add c19~158@ d19~160@) (Mul b19~156@ d19~160@)) (
                                                                                 ...
                                                                                 (=>
                                                                                  (= temp_19_1~3120@ (Mul (Mul (Add (Mul b19~156@ d19~160@) (Mul b19~156@ d19~160@)) (
                                                                                  ...
                                                                                  (and
                                                                                   ...
                                                                                   (=>
                                                                                    (= temp_19_0~3043@ temp_19_1~3120@)
                                                                                    (=>
                                                                                     (= temp_20_0~3201@ (Mul (Mul (Mul (Mul c20~166@ a20~162@) (Mul a20~162@ d20~168@)) (
                                                                                     ...
                                                                                     (=>
                                                                                      (= temp_20_1~3258@ (Mul (Mul (Mul (Mul c20~166@ d20~168@) d20~168@) (Mul (Mul c20~166@
                                                                                           a20~162@
                                                                                          ) (Mul a20~162@ d20~168@)
                                                                                         )
                                                                                        ) (Mul (Mul (Sub b20~164@ c20~166@) (Mul a20~162@ a20~162@)) (Mul (Mul b20~164@ c20~166@)
                                                                                      ...
                                                                                      (and
                                                                                       (=>
                                                                                        ...
                                                                                        (=>
                                                                                         %%location_label%%20
                                                                                         (= temp_20_0~3201@ temp_20_1~3258@)
                                                                                       ))
                                                                                       (=>
                                                                                        (= temp_20_0~3201@ temp_20_1~3258@)
                                                                                        (=>
                                                                                         (= temp_21_0~3335@ (Mul (Sub (Mul (Sub b21~172@ b21~172@) (Mul b21~172@ a21~170@)) (
                                                                                             Mul (Mul b21~172@ b21~172@) (Mul c21~174@ a21~170@)
                                                                                            )
                                                                                           ) (Mul c21~174@ (Mul (Mul d21~176@ a21~170@) (Mul c21~174@ c21~174@)))
                                                                                         ))
                                                                                         (=>
                                                                                          (= temp_21_1~3396@ (Mul (Sub (Sub (Mul b21~172@ (Mul b21~172@ a21~170@)) (Mul b21~172@
                                                                                               (Mul b21~172@ a21~170@)
                                                                                              )
                                                                                             ) (Mul (Mul b21~172@ b21~172@) (Mul c21~174@ a21~170@))
                                                                                            ) (Mul c21~174@ (Mul (Mul d21~176@ a21~170@) (Mul c21~174@ c21~174@)))
                                                                                          ...
                                                                                          (and
                                                                                           (=>
                                                                                            ...
                                                                                            (=>
                                                                                             %%location_label%%21
                                                                                             (= temp_21_0~3335@ temp_21_1~3396@)
                                                                                           ))
                                                                                           (=>
                                                                                            (= temp_21_0~3335@ temp_21_1~3396@)
                                                                                            (=>
                                                                                             (= temp_22_0~3485@ (Mul (Add (Mul (Sub c22~182@ c22~182@) (Mul a22~178@ d22~184@)) (
                                                                                             ...
                                                                                             (=>
                                                                                              (= temp_22_1~3550@ (Mul (Add (Mul (Mul a22~178@ d22~184@) (Sub c22~182@ c22~182@)) (
                                                                                                  Mul (Mul a22~178@ d22~184@) (Mul a22~178@ c22~182@)
                                                                                                 )
                                                                                                ) (Mul (Mul (Mul a22~178@ a22~178@) (Mul c22~182@ c22~182@)) (Mul (Mul c22~182@ b22~180@)
                                                                                                  (Mul a22~178@ c22~182@)
                                                                                              ...
                                                                                              (and
                                                                                               (=>
                                                                                                ...
                                                                                                (=>
                                                                                                 %%location_label%%22
                                                                                                 (= temp_22_0~3485@ temp_22_1~3550@)
                                                                                               ))
                                                                                               (=>
                                                                                                (= temp_22_0~3485@ temp_22_1~3550@)
                                                                                                (=>
                                                                                                 (= temp_23_0~3651@ (Mul (Mul (Mul (Mul d23~192@ c23~190@) (Mul 75 a23~186@)) (Add (Mul
                                                                                                      d23~192@ d23~192@
                                                                                                     ) (Mul b23~188@ b23~188@)
                                                                                                    )
                                                                                                 ...
                                                                                                 (=>
                                                                                                  (= temp_23_1~3728@ (Mul (Mul (Mul (Mul c23~190@ d23~192@) (Mul 75 a23~186@)) (Add (Mul
                                                                                                       d23~192@ d23~192@
                                                                                                      ) (Mul b23~188@ b23~188@)
                                                                                                     )
                                                                                                    ) (Mul (Mul (Mul a23~186@ b23~188@) (Mul d23~192@ a23~186@)) (Sub (Mul d23~192@ d23~192@)
                                                                                                  ...
                                                                                                  (and
                                                                                                   (=>
                                                                                                    ...
                                                                                                    (=>
                                                                                                     %%location_label%%23
                                                                                                     (= temp_23_0~3651@ temp_23_1~3728@)
                                                                                                   ))
                                                                                                   (=>
                                                                                                    (= temp_23_0~3651@ temp_23_1~3728@)
                                                                                                    (=>
                                                                                                     (= temp_24_0~3805@ (Mul (Sub (Mul (Mul a24~194@ c24~198@) (Mul b24~196@ a24~194@)) c24~198@)
                                                                                                       (Mul (Mul (Mul d24~200@ d24~200@) (Mul d24~200@ c24~198@)) (Mul (Mul a24~194@ b24~196@)
                                                                                                         (Mul c24~198@ c24~198@)
                                                                                                     ))))
                                                                                                     (=>
                                                                                                      (= temp_24_1~3858@ (Mul (Sub (Mul (Mul a24~194@ c24~198@) (Mul b24~196@ a24~194@)) c24~198@)
                                                                                                      ...
                                                                                                      (and
                                                                                                       (=>
                                                                                                        ...
                                                                                                        (=>
                                                                                                         %%location_label%%24
                                                                                                         (= temp_24_0~3805@ temp_24_1~3858@)
                                                                                                       ))
                                                                                                       (=>
                                                                                                        (= temp_24_0~3805@ temp_24_1~3858@)
                                                                                                        (=>
                                                                                                         (= temp_25_0~3931@ (Mul (Mul a25~202@ (Mul a25~202@ (Mul b25~204@ b25~204@))) (Mul (
                                                                                                             Mul (Mul b25~204@ b25~204@) (Mul d25~208@ a25~202@)
                                                                                                            ) (Mul (Sub b25~204@ a25~202@) (Mul d25~208@ a25~202@))
                                                                                                         )))
                                                                                                         (=>
                                                                                                          (= temp_25_1~3980@ (Mul (Mul a25~202@ (Mul a25~202@ (Mul b25~204@ b25~204@))) (Mul (
                                                                                                              Mul (Mul b25~204@ b25~204@) (Mul d25~208@ a25~202@)
                                                                                                             ) (Mul (Sub b25~204@ a25~202@) (Mul d25~208@ a25~202@))
                                                                                                          )))
                                                                                                          (and
                                                                                                           (=>
                                                                                                            ...
                                                                                                            (=>
                                                                                                             %%location_label%%25
                                                                                                             (= temp_25_0~3931@ temp_25_1~3980@)
                                                                                                           ))
                                                                                                           (=>
                                                                                                            (= temp_25_0~3931@ temp_25_1~3980@)
                                                                                                            (=>
                                                                                                             (= temp_26_0~4077@ (Add (Mul (Mul (Mul b26~212@ a26~210@) (Mul b26~212@ a26~210@)) (
                                                                                                             ...
                                                                                                             (=>
                                                                                                              (= temp_26_1~4150@ (Add (Mul (Mul (Mul b26~212@ a26~210@) (Mul b26~212@ a26~210@)) (
