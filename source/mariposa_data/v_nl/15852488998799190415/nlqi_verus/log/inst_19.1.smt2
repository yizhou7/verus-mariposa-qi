...
(set-info :comment ";; mariposa_data/v_nl//15852488998799190415/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_9_0~1813@ Int)
(declare-const temp_9_1~1878@ Int)
(declare-const temp_10_0~1979@ Int)
(declare-const temp_10_1~2040@ Int)
(declare-const temp_11_0~2137@ Int)
(declare-const temp_11_1~2198@ Int)
...
(declare-const temp_14_0~2673@ Int)
(declare-const temp_14_1~2746@ Int)
(declare-const temp_15_0~2853@ Int)
(declare-const temp_15_1~2926@ Int)
(declare-const temp_16_0~3051@ Int)
(declare-const temp_16_1~3116@ Int)
(declare-const temp_17_0~3241@ Int)
(declare-const temp_17_1~3314@ Int)
(declare-const temp_18_0~3407@ Int)
(declare-const temp_18_1~3480@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Sub (Sub (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@)) (Mul d0~8@ (Mul c0~6@ a0~2@))) (Mul (Add (Mul d0~8@ d0~8@) (Add b0~4@ c0~6@)) (Add (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~362@ (Sub (Sub (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul c0~6@ a0~2@))) (Mul (Add (Mul d0~8@ d0~8@) (Add b0~4@ c0~6@)) (Add (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ d0~8@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~451@ (Mul (Mul (Mul (Add c1~14@ d1~16@) (Sub b1~12@ d1~16@)) (Mul (Mul b1~12@ a1~10@) a1~10@)) (Sub (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~512@ (Mul (Mul (Mul (Add c1~14@ d1~16@) (Sub b1~12@ d1~16@)) (Mul (Mul b1~12@ a1~10@) a1~10@)) (Sub (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ a1~10@) (=> %%location_label%%1 (= temp_1_0~451@ temp_1_1~512@))) (=> (= temp_1_0~451@ temp_1_1~512@) (=> (= temp_2_0~605@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@))) (Mul (Add (Add c2~22@ c2~22@) (Mul a2~18@ b2~20@)) (Add (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~670@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ d2~24@))) (Mul (Add (Add c2~22@ c2~22@) (Mul a2~18@ b2~20@)) (Add (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@))))) (and (=> (= tmp%1@ (Mul c2~22@ d2~24@)) (=> (= tmp%2@ (Mul a2~18@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~605@ temp_2_1~670@))))) (=> (= temp_2_0~605@ temp_2_1~670@) (=> (= temp_3_0~771@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul a3~26@ b3~28@) (Add b3~28@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ b3~28@))))) (=> (= temp_3_1~836@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul b3~28@ a3~26@) (Add b3~28@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ b3~28@) (=> %%location_label%%3 (= temp_3_0~771@ temp_3_1~836@))) (=> (= temp_3_0~771@ temp_3_1~836@) (=> (= temp_4_0~929@ (Mul (Add (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ c4~38@)) (Add (Mul b4~36@ a4~34@) (Sub b4~36@ c4~38@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~994@ (Mul (Add (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ c4~38@)) (Add (Mul b4~36@ a4~34@) (Sub b4~36@ c4~38@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@))))) (and (=> (= tmp%3@ (Mul b4~36@ b4~36@)) (=> (= tmp%4@ (Mul a4~34@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%4 (= temp_4_0~929@ temp_4_1~994@))))) (=> (= temp_4_0~929@ temp_4_1~994@) (=> (= temp_5_0~1091@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ a5~42@) b5~44@)) (Mul (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ a5~42@)) (Mul (Sub c5~46@ a5~42@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1152@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ a5~42@) b5~44@)) (Mul (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ a5~42@)) (Mul (Sub c5~46@ a5~42@) (Mul c5~46@ c5~46@))))) (and (=> (= tmp%5@ (Mul c5~46@ a5~42@)) (=> (= tmp%6@ (Mul d5~48@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~1091@ temp_5_1~1152@))))) (=> (= temp_5_0~1091@ temp_5_1~1152@) (=> (= temp_6_0~1253@ (Mul (Sub (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ b6~52@)) (Mul (Mul 70 d6~56@) (Mul d6~56@ d6~56@))) (Mul c6~54@ (Mul (Add b6~52@ c6~54@) (Mul c6~54@ a6~50@))))) (=> (= temp_6_1~1338@ (Sub (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ b6~52@)) (Mul c6~54@ (Mul (Add b6~52@ c6~54@) (Mul c6~54@ a6~50@)))) (Mul (Mul (Mul 70 d6~56@) (Mul d6~56@ d6~56@)) (Mul c6~54@ (Mul (Add b6~52@ c6~54@) (Mul c6~54@ a6~50@)))))) (and (=> (= tmp%7@ (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ b6~52@))) (=> (= tmp%8@ (Mul (Mul 70 d6~56@) (Mul d6~56@ d6~56@))) (=> (= tmp%9@ (Mul c6~54@ (Mul (Add b6~52@ c6~54@) (Mul c6~54@ a6~50@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%6 (= temp_6_0~1253@ temp_6_1~1338@)))))) (=> (= temp_6_0~1253@ temp_6_1~1338@) (=> (= temp_7_0~1469@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) b7~60@) a7~58@) (Mul (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ a7~58@)) (Add (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1518@ (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ a7~58@)) (Add (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@))))) (and (=> (= tmp%10@ (Mul b7~60@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ b7~60@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1469@ temp_7_1~1518@)))) (=> (= temp_7_0~1469@ temp_7_1~1518@) (=> (= temp_8_0~1617@ (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ a8~66@)) (Sub (Mul a8~66@ a8~66@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@)) (Add (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1698@ (Mul (Sub (Mul (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ a8~66@)) (Mul a8~66@ a8~66@)) (Mul (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ a8~66@)) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@)) (Add (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))))) (and (=> (= tmp%11@ (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ a8~66@))) (=> (= tmp%12@ (Mul a8~66@ a8~66@)) (=> (= tmp%13@ (Mul a8~66@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%8 (= temp_8_0~1617@ temp_8_1~1698@)))))) (=> (= temp_8_0~1617@ temp_8_1~1698@) (=> (= temp_9_0~1813@ (Mul (Mul (Mul (Mul 76 a9~74@) (Mul b9~76@ d9~80@)) (Mul (Add b9~76@ d9~80@) (Mul d9~80@ a9~74@))) (Mul d9~80@ (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1878@ (Mul (Mul (Mul (Mul 76 a9~74@) (Mul b9~76@ d9~80@)) (Mul (Add b9~76@ d9~80@) (Mul d9~80@ a9~74@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ d9~80@)) d9~80@))) (and (=> (= tmp%14@ (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ d9~80@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d9~80@ tmp%14@) (=> %%location_label%%9 (= temp_9_0~1813@ temp_9_1~1878@)))) (=> (= temp_9_0~1813@ temp_9_1~1878@) (=> (= temp_10_0~1979@ (Mul (Mul (Mul (Mul d10~88@ b10~84@) c10~86@) (Mul (Mul a10~82@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ a10~82@)) (Mul (Add d10~88@ a10~82@) (Sub d10~88@ a10~82@))))) (=> (= temp_10_1~2040@ (Mul (Mul (Mul (Mul d10~88@ b10~84@) c10~86@) (Mul (Mul a10~82@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ d10~88@)) (Mul (Add d10~88@ a10~82@) (Sub d10~88@ a10~82@))))) (and (=> (= tmp%15@ (Mul a10~82@ d10~88@)) (=> (= tmp%16@ (Mul a10~82@ a10~82@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%10 (= temp_10_0~1979@ temp_10_1~2040@))))) (=> (= temp_10_0~1979@ temp_10_1~2040@) (=> (= temp_11_0~2137@ (Mul (Mul (Mul (Sub c11~94@ d11~96@) (Mul d11~96@ a11~90@)) (Sub (Mul d11~96@ b11~92@) d11~96@)) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ c11~94@)) (Sub (Sub d11~96@ b11~92@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~2198@ (Mul (Mul (Mul (Sub c11~94@ d11~96@) (Mul d11~96@ a11~90@)) (Sub (Mul d11~96@ b11~92@) d11~96@)) (Mul (Mul a11~90@ c11~94@) (Mul (Mul c11~94@ c11~94@) (Sub (Sub d11~96@ b11~92@) (Mul a11~90@ d11~96@)))))) (and (=> (= tmp%17@ (Mul a11~90@ c11~94@)) (=> (= tmp%18@ (Mul c11~94@ c11~94@)) (=> (= tmp%19@ (Sub (Sub d11~96@ b11~92@) (Mul a11~90@ d11~96@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%11 (= temp_11_0~2137@ temp_11_1~2198@)))))) (=> (= temp_11_0~2137@ temp_11_1~2198@) (=> (= temp_12_0~2301@ (Mul (Mul a12~98@ (Mul (Sub d12~104@ b12~100@) (Mul a12~98@ a12~98@))) (Mul (Mul (Add d12~104@ b12~100@) (Mul b12~100@ a12~98@)) (Mul (Sub b12~100@ d12~104@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2354@ (Mul (Mul (Mul (Sub d12~104@ b12~100@) (Mul a12~98@ a12~98@)) a12~98@) (Mul (Mul (Add d12~104@ b12~100@) (Mul b12~100@ a12~98@)) (Mul (Sub b12~100@ d12~104@) (Mul a12~98@ c12~102@))))) (and (=> (= tmp%20@ (Mul (Sub d12~104@ b12~100@) (Mul a12~98@ a12~98@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a12~98@ tmp%20@) (=> %%location_label%%12 (= temp_12_0~2301@ temp_12_1~2354@)))) (=> (= temp_12_0~2301@ temp_12_1~2354@) (=> (= temp_13_0~2459@ (Mul (Add (Mul (Sub d13~112@ d13~112@) (Sub c13~110@ d13~112@)) (Sub (Mul c13~110@ b13~108@) (Mul b13~108@ a13~106@))) (Mul (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@)) (Sub (Add d13~112@ b13~108@) (Sub c13~110@ d13~112@))))) (=> (= temp_13_1~2524@ (Mul (Mul (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@)) (Sub (Add d13~112@ b13~108@) (Sub c13~110@ d13~112@))) (Add (Mul (Sub d13~112@ d13~112@) (Sub c13~110@ d13~112@)) (Sub (Mul c13~110@ b13~108@) (Mul b13~108@ a13~106@))))) (and (=> (= tmp%21@ (Add (Mul (Sub d13~112@ d13~112@) (Sub c13~110@ d13~112@)) (Sub (Mul c13~110@ b13~108@) (Mul b13~108@ a13~106@)))) (=> (= tmp%22@ (Mul (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@)) (Sub (Add d13~112@ b13~108@) (Sub c13~110@ d13~112@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%21@ tmp%22@) (=> %%location_label%%13 (= temp_13_0~2459@ temp_13_1~2524@))))) (=> (= temp_13_0~2459@ temp_13_1~2524@) (=> (= temp_14_0~2673@ (Sub (Mul d14~120@ (Mul (Sub a14~114@ a14~114@) (Add a14~114@ d14~120@))) (Add (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ d14~120@)) (Mul (Mul b14~116@ 50) (Mul d14~120@ d14~120@))))) (=> (= temp_14_1~2746@ (Sub (Mul d14~120@ (Sub (Mul a14~114@ (Add a14~114@ d14~120@)) (Mul a14~114@ (Add a14~114@ d14~120@)))) (Add (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ d14~120@)) (Mul (Mul b14~116@ 50) (Mul d14~120@ d14~120@))))) (and (=> (= tmp%23@ (Add a14~114@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a14~114@ a14~114@ tmp%23@) (=> %%location_label%%14 (= temp_14_0~2673@ temp_14_1~2746@)))) (=> (= temp_14_0~2673@ temp_14_1~2746@) (=> (= temp_15_0~2853@ (Mul (Mul (Mul (Mul d15~128@ a15~122@) c15~126@) (Mul (Mul 40 d15~128@) (Mul a15~122@ a15~122@))) (Mul (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~2926@ (Mul (Mul (Mul (Mul 40 d15~128@) (Mul a15~122@ a15~122@)) (Mul (Mul d15~128@ a15~122@) c15~126@)) (Mul (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@))))) (and (=> (= tmp%24@ (Mul (Mul d15~128@ a15~122@) c15~126@)) (=> (= tmp%25@ (Mul (Mul 40 d15~128@) (Mul a15~122@ a15~122@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%24@ tmp%25@) (=> %%location_label%%15 (= temp_15_0~2853@ temp_15_1~2926@))))) (=> (= temp_15_0~2853@ temp_15_1~2926@) (=> (= temp_16_0~3051@ (Mul (Mul (Mul (Mul a16~130@ c16~134@) (Mul b16~132@ c16~134@)) (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ c16~134@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@))))) (=> (= temp_16_1~3116@ (Mul (Mul (Mul (Mul a16~130@ c16~134@) (Mul b16~132@ c16~134@)) (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ c16~134@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ d16~136@))))) (and (=> (= tmp%26@ (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ d16~136@))) (=> (= tmp%27@ (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%26@ tmp%27@) (=> %%location_label%%16 (= temp_16_0~3051@ temp_16_1~3116@))))) (=> (= temp_16_0~3051@ temp_16_1~3116@) (=> (= temp_17_0~3241@ (Mul (Mul (Sub (Mul a17~138@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul 55 a17~138@))) (Mul (Mul d17~144@ (Sub b17~140@ b17~140@)) (Mul (Mul c17~142@ c17~142@) (Mul c17~142@ d17~144@))))) (=> (= temp_17_1~3314@ (Mul (Mul (Sub (Mul a17~138@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul 55 a17~138@))) (Mul (Mul d17~144@ (Sub b17~140@ b17~140@)) (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c17~142@ d17~144@) (=> %%location_label%%17 (= temp_17_0~3241@ temp_17_1~3314@))) (=> (= temp_17_0~3241@ temp_17_1~3314@) (=> (= temp_18_0~3407@ (Mul (Mul (Mul (Mul b18~148@ d18~152@) (Mul a18~146@ c18~150@)) (Mul (Sub d18~152@ b18~148@) (Mul a18~146@ a18~146@))) (Mul (Mul (Mul a18~146@ a18~146@) (Mul d18~152@ c18~150@)) (Mul (Mul d18~152@ a18~146@) (Mul c18~150@ b18~148@))))) (=> (= temp_18_1~3480@ (Mul (Mul (Mul (Mul b18~148@ d18~152@) (Mul a18~146@ c18~150@)) (Sub (Mul d18~152@ (Mul a18~146@ a18~146@)) (Mul b18~148@ (Mul a18~146@ a18~146@)))) (Mul (Mul (Mul a18~146@ a18~146@) (Mul d18~152@ c18~150@)) (Mul (Mul d18~152@ a18~146@) (Mul c18~150@ b18~148@))))) (=> (= tmp%28@ (Mul a18~146@ a18~146@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d18~152@ b18~148@ tmp%28@) (=> %%location_label%%18 (= temp_18_0~3407@ temp_18_1~3480@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
