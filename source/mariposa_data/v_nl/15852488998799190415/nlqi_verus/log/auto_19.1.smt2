...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Sub (Sub (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@)) (Mul d0~8@ (Mul c0~6@ a0~2@))) (Mul (Add (Mul d0~8@ d0~8@) (Add b0~4@ c0~6@)) (Add (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~362@ (Sub (Sub (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul c0~6@ a0~2@))) (Mul (Add (Mul d0~8@ d0~8@) (Add b0~4@ c0~6@)) (Add (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~362@))) (=> (= temp_0_0~301@ temp_0_1~362@) (=> (= temp_1_0~447@ (Mul (Mul (Mul (Add c1~14@ d1~16@) (Sub b1~12@ d1~16@)) (Mul (Mul b1~12@ a1~10@) a1~10@)) (Sub (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~508@ (Mul (Mul (Mul (Add c1~14@ d1~16@) (Sub b1~12@ d1~16@)) (Mul (Mul b1~12@ a1~10@) a1~10@)) (Sub (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~447@ temp_1_1~508@))) (=> (= temp_1_0~447@ temp_1_1~508@) (=> (= temp_2_0~597@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ b2~20@))) (Mul (Add (Add c2~22@ c2~22@) (Mul a2~18@ b2~20@)) (Add (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~662@ (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ d2~24@))) (Mul (Add (Add c2~22@ c2~22@) (Mul a2~18@ b2~20@)) (Add (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~597@ temp_2_1~662@))) (=> (= temp_2_0~597@ temp_2_1~662@) (=> (= temp_3_0~751@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul a3~26@ b3~28@) (Add b3~28@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ b3~28@))))) (=> (= temp_3_1~816@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul b3~28@ a3~26@) (Add b3~28@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~751@ temp_3_1~816@))) (=> (= temp_3_0~751@ temp_3_1~816@) (=> (= temp_4_0~905@ (Mul (Add (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ c4~38@)) (Add (Mul b4~36@ a4~34@) (Sub b4~36@ c4~38@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~970@ (Mul (Add (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ c4~38@)) (Add (Mul b4~36@ a4~34@) (Sub b4~36@ c4~38@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~905@ temp_4_1~970@))) (=> (= temp_4_0~905@ temp_4_1~970@) (=> (= temp_5_0~1055@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ a5~42@) b5~44@)) (Mul (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ a5~42@)) (Mul (Sub c5~46@ a5~42@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1116@ (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ a5~42@) b5~44@)) (Mul (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ a5~42@)) (Mul (Sub c5~46@ a5~42@) (Mul c5~46@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1055@ temp_5_1~1116@))) (=> (= temp_5_0~1055@ temp_5_1~1116@) (=> (= temp_6_0~1205@ (Mul (Sub (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ b6~52@)) (Mul (Mul 70 d6~56@) (Mul d6~56@ d6~56@))) (Mul c6~54@ (Mul (Add b6~52@ c6~54@) (Mul c6~54@ a6~50@))))) (=> (= temp_6_1~1290@ (Sub (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ b6~52@)) (Mul c6~54@ (Mul (Add b6~52@ c6~54@) (Mul c6~54@ a6~50@)))) (Mul (Mul (Mul 70 d6~56@) (Mul d6~56@ d6~56@)) (Mul c6~54@ (Mul (Add b6~52@ c6~54@) (Mul c6~54@ a6~50@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1205@ temp_6_1~1290@))) (=> (= temp_6_0~1205@ temp_6_1~1290@) (=> (= temp_7_0~1363@ (Mul (Mul (Mul (Mul b7~60@ d7~64@) b7~60@) a7~58@) (Mul (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ a7~58@)) (Add (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1412@ (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Mul (Mul b7~60@ a7~58@) (Sub d7~64@ a7~58@)) (Add (Mul a7~58@ b7~60@) (Mul c7~62@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1363@ temp_7_1~1412@))) (=> (= temp_7_0~1363@ temp_7_1~1412@) (=> (= temp_8_0~1501@ (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ a8~66@)) (Sub (Mul a8~66@ a8~66@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@)) (Add (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1582@ (Mul (Sub (Mul (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ a8~66@)) (Mul a8~66@ a8~66@)) (Mul (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ a8~66@)) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@)) (Add (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1501@ temp_8_1~1582@))) (=> (= temp_8_0~1501@ temp_8_1~1582@) (=> (= temp_9_0~1671@ (Mul (Mul (Mul (Mul 76 a9~74@) (Mul b9~76@ d9~80@)) (Mul (Add b9~76@ d9~80@) (Mul d9~80@ a9~74@))) (Mul d9~80@ (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ d9~80@))))) (=> (= temp_9_1~1736@ (Mul (Mul (Mul (Mul 76 a9~74@) (Mul b9~76@ d9~80@)) (Mul (Add b9~76@ d9~80@) (Mul d9~80@ a9~74@))) (Mul (Mul (Mul a9~74@ d9~80@) (Mul c9~78@ d9~80@)) d9~80@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1671@ temp_9_1~1736@))) (=> (= temp_9_0~1671@ temp_9_1~1736@) (=> (= temp_10_0~1821@ (Mul (Mul (Mul (Mul d10~88@ b10~84@) c10~86@) (Mul (Mul a10~82@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ a10~82@)) (Mul (Add d10~88@ a10~82@) (Sub d10~88@ a10~82@))))) (=> (= temp_10_1~1882@ (Mul (Mul (Mul (Mul d10~88@ b10~84@) c10~86@) (Mul (Mul a10~82@ b10~84@) (Mul c10~86@ b10~84@))) (Mul (Mul (Mul a10~82@ a10~82@) (Mul a10~82@ d10~88@)) (Mul (Add d10~88@ a10~82@) (Sub d10~88@ a10~82@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1821@ temp_10_1~1882@))) (=> (= temp_10_0~1821@ temp_10_1~1882@) (=> (= temp_11_0~1967@ (Mul (Mul (Mul (Sub c11~94@ d11~96@) (Mul d11~96@ a11~90@)) (Sub (Mul d11~96@ b11~92@) d11~96@)) (Mul (Mul (Mul a11~90@ c11~94@) (Mul c11~94@ c11~94@)) (Sub (Sub d11~96@ b11~92@) (Mul a11~90@ d11~96@))))) (=> (= temp_11_1~2028@ (Mul (Mul (Mul (Sub c11~94@ d11~96@) (Mul d11~96@ a11~90@)) (Sub (Mul d11~96@ b11~92@) d11~96@)) (Mul (Mul a11~90@ c11~94@) (Mul (Mul c11~94@ c11~94@) (Sub (Sub d11~96@ b11~92@) (Mul a11~90@ d11~96@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1967@ temp_11_1~2028@))) (=> (= temp_11_0~1967@ temp_11_1~2028@) (=> (= temp_12_0~2105@ (Mul (Mul a12~98@ (Mul (Sub d12~104@ b12~100@) (Mul a12~98@ a12~98@))) (Mul (Mul (Add d12~104@ b12~100@) (Mul b12~100@ a12~98@)) (Mul (Sub b12~100@ d12~104@) (Mul a12~98@ c12~102@))))) (=> (= temp_12_1~2158@ (Mul (Mul (Mul (Sub d12~104@ b12~100@) (Mul a12~98@ a12~98@)) a12~98@) (Mul (Mul (Add d12~104@ b12~100@) (Mul b12~100@ a12~98@)) (Mul (Sub b12~100@ d12~104@) (Mul a12~98@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2105@ temp_12_1~2158@))) (=> (= temp_12_0~2105@ temp_12_1~2158@) (=> (= temp_13_0~2247@ (Mul (Add (Mul (Sub d13~112@ d13~112@) (Sub c13~110@ d13~112@)) (Sub (Mul c13~110@ b13~108@) (Mul b13~108@ a13~106@))) (Mul (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@)) (Sub (Add d13~112@ b13~108@) (Sub c13~110@ d13~112@))))) (=> (= temp_13_1~2312@ (Mul (Mul (Mul (Mul b13~108@ d13~112@) (Mul b13~108@ d13~112@)) (Sub (Add d13~112@ b13~108@) (Sub c13~110@ d13~112@))) (Add (Mul (Sub d13~112@ d13~112@) (Sub c13~110@ d13~112@)) (Sub (Mul c13~110@ b13~108@) (Mul b13~108@ a13~106@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2247@ temp_13_1~2312@))) (=> (= temp_13_0~2247@ temp_13_1~2312@) (=> (= temp_14_0~2401@ (Sub (Mul d14~120@ (Mul (Sub a14~114@ a14~114@) (Add a14~114@ d14~120@))) (Add (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ d14~120@)) (Mul (Mul b14~116@ 50) (Mul d14~120@ d14~120@))))) (=> (= temp_14_1~2474@ (Sub (Mul d14~120@ (Sub (Mul a14~114@ (Add a14~114@ d14~120@)) (Mul a14~114@ (Add a14~114@ d14~120@)))) (Add (Mul (Mul b14~116@ d14~120@) (Mul a14~114@ d14~120@)) (Mul (Mul b14~116@ 50) (Mul d14~120@ d14~120@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2401@ temp_14_1~2474@))) (=> (= temp_14_0~2401@ temp_14_1~2474@) (=> (= temp_15_0~2571@ (Mul (Mul (Mul (Mul d15~128@ a15~122@) c15~126@) (Mul (Mul 40 d15~128@) (Mul a15~122@ a15~122@))) (Mul (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@))))) (=> (= temp_15_1~2644@ (Mul (Mul (Mul (Mul 40 d15~128@) (Mul a15~122@ a15~122@)) (Mul (Mul d15~128@ a15~122@) c15~126@)) (Mul (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ d15~128@)) (Mul (Mul d15~128@ b15~124@) (Mul c15~126@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2571@ temp_15_1~2644@))) (=> (= temp_15_0~2571@ temp_15_1~2644@) (=> (= temp_16_0~2733@ (Mul (Mul (Mul (Mul a16~130@ c16~134@) (Mul b16~132@ c16~134@)) (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ c16~134@))) (Mul (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ d16~136@)) (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@))))) (=> (= temp_16_1~2798@ (Mul (Mul (Mul (Mul a16~130@ c16~134@) (Mul b16~132@ c16~134@)) (Mul (Mul d16~136@ d16~136@) (Mul a16~130@ c16~134@))) (Mul (Mul (Mul c16~134@ d16~136@) (Mul a16~130@ a16~130@)) (Mul (Mul a16~130@ c16~134@) (Mul a16~130@ d16~136@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2733@ temp_16_1~2798@))) (=> (= temp_16_0~2733@ temp_16_1~2798@) (=> (= temp_17_0~2895@ (Mul (Mul (Sub (Mul a17~138@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul 55 a17~138@))) (Mul (Mul d17~144@ (Sub b17~140@ b17~140@)) (Mul (Mul c17~142@ c17~142@) (Mul c17~142@ d17~144@))))) (=> (= temp_17_1~2968@ (Mul (Mul (Sub (Mul a17~138@ a17~138@) (Mul c17~142@ c17~142@)) (Mul (Mul b17~140@ a17~138@) (Mul 55 a17~138@))) (Mul (Mul d17~144@ (Sub b17~140@ b17~140@)) (Mul (Mul c17~142@ c17~142@) (Mul d17~144@ c17~142@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2895@ temp_17_1~2968@))) (=> (= temp_17_0~2895@ temp_17_1~2968@) (=> (= temp_18_0~3057@ (Mul (Mul (Mul (Mul b18~148@ d18~152@) (Mul a18~146@ c18~150@)) (Mul (Sub d18~152@ b18~148@) (Mul a18~146@ a18~146@))) (Mul (Mul (Mul a18~146@ a18~146@) (Mul d18~152@ c18~150@)) (Mul (Mul d18~152@ a18~146@) (Mul c18~150@ b18~148@))))) (=> (= temp_18_1~3130@ (Mul (Mul (Mul (Mul b18~148@ d18~152@) (Mul a18~146@ c18~150@)) (Sub (Mul d18~152@ (Mul a18~146@ a18~146@)) (Mul b18~148@ (Mul a18~146@ a18~146@)))) (Mul (Mul (Mul a18~146@ a18~146@) (Mul d18~152@ c18~150@)) (Mul (Mul d18~152@ a18~146@) (Mul c18~150@ b18~148@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3057@ temp_18_1~3130@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
