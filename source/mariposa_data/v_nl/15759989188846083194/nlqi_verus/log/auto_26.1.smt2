...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Add (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Add a0~2@ c0~6@))) (Add (Mul (Mul a0~2@ b0~4@) d0~8@) (Mul (Mul b0~4@ 66) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~386@ (Add (Mul (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Add a0~2@ c0~6@))) (Add (Mul a0~2@ (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ 66) (Mul c0~6@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~386@))) (=> (= temp_0_0~313@ temp_0_1~386@) (=> (= temp_1_0~471@ (Mul (Mul (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ b1~12@)) (Mul (Mul d1~16@ b1~12@) a1~10@)) (Sub (Sub (Mul c1~14@ c1~14@) (Mul c1~14@ a1~10@)) (Add (Mul b1~12@ c1~14@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~528@ (Mul (Mul (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ b1~12@)) (Mul (Mul d1~16@ b1~12@) a1~10@)) (Sub (Sub (Mul c1~14@ c1~14@) (Mul c1~14@ a1~10@)) (Mul (Add b1~12@ a1~10@) c1~14@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~471@ temp_1_1~528@))) (=> (= temp_1_0~471@ temp_1_1~528@) (=> (= temp_2_0~629@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ a2~18@)) (Sub (Sub d2~24@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul b2~20@ a2~18@) (Mul 64 d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~706@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ a2~18@)) (Sub (Sub d2~24@ a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul 64 d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~629@ temp_2_1~706@))) (=> (= temp_2_0~629@ temp_2_1~706@) (=> (= temp_3_0~791@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) (Mul (Sub d3~32@ 83) d3~32@)) (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)) c3~30@))) (=> (= temp_3_1~852@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) (Mul d3~32@ (Sub d3~32@ 83))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@)) c3~30@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~791@ temp_3_1~852@))) (=> (= temp_3_0~791@ temp_3_1~852@) (=> (= temp_4_0~937@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Mul b4~36@ (Sub c4~38@ b4~36@))) (Mul (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ c4~38@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ c4~38@))))) (=> (= temp_4_1~998@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Mul b4~36@ (Sub c4~38@ b4~36@))) (Mul (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ c4~38@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~937@ temp_4_1~998@))) (=> (= temp_4_0~937@ temp_4_1~998@) (=> (= temp_5_0~1087@ (Mul (Sub (Mul (Add c5~46@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@)) (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1152@ (Mul (Sub (Mul (Add c5~46@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1087@ temp_5_1~1152@))) (=> (= temp_5_0~1087@ temp_5_1~1152@) (=> (= temp_6_0~1253@ (Mul (Mul (Sub (Mul c6~54@ c6~54@) (Sub b6~52@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Sub d6~56@ b6~52@))) (Mul (Sub (Add b6~52@ c6~54@) (Mul 17 c6~54@)) (Mul (Add a6~50@ b6~52@) (Add c6~54@ a6~50@))))) (=> (= temp_6_1~1330@ (Mul (Mul (Sub (Mul c6~54@ c6~54@) (Sub b6~52@ d6~56@)) (Mul (Sub d6~56@ b6~52@) (Mul d6~56@ d6~56@))) (Mul (Sub (Add b6~52@ c6~54@) (Mul 17 c6~54@)) (Mul (Add a6~50@ b6~52@) (Add c6~54@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1253@ temp_6_1~1330@))) (=> (= temp_6_0~1253@ temp_6_1~1330@) (=> (= temp_7_0~1427@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Mul a7~58@ d7~64@) d7~64@)) (Sub (Mul (Add 85 d7~64@) (Mul c7~62@ a7~58@)) (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1500@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Mul a7~58@ d7~64@) d7~64@)) (Sub (Mul (Add 85 d7~64@) (Mul c7~62@ a7~58@)) (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1427@ temp_7_1~1500@))) (=> (= temp_7_0~1427@ temp_7_1~1500@) (=> (= temp_8_0~1597@ (Mul (Mul (Mul (Add b8~68@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ b8~68@) (Mul a8~66@ c8~70@))) (Mul (Mul (Mul b8~68@ 39) b8~68@) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ a8~66@))))) (=> (= temp_8_1~1670@ (Mul (Mul (Mul (Add b8~68@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ b8~68@) (Mul a8~66@ c8~70@))) (Mul (Mul b8~68@ (Mul b8~68@ 39)) (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ a8~66@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1597@ temp_8_1~1670@))) (=> (= temp_8_0~1597@ temp_8_1~1670@) (=> (= temp_9_0~1759@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul d9~80@ b9~76@) (Mul b9~76@ d9~80@)) (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@))))) (=> (= temp_9_1~1824@ (Mul (Mul (Mul (Mul b9~76@ a9~74@) (Mul a9~74@ d9~80@)) (Mul (Mul d9~80@ c9~78@) (Mul a9~74@ a9~74@))) (Mul (Mul (Mul b9~76@ d9~80@) (Mul d9~80@ b9~76@)) (Mul (Mul d9~80@ d9~80@) (Mul c9~78@ b9~76@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1759@ temp_9_1~1824@))) (=> (= temp_9_0~1759@ temp_9_1~1824@) (=> (= temp_10_0~1933@ (Mul (Mul (Add (Mul d10~88@ d10~88@) (Sub d10~88@ c10~86@)) (Mul (Mul 77 b10~84@) (Mul 1 b10~84@))) (Mul (Mul (Mul b10~84@ c10~86@) (Sub b10~84@ d10~88@)) (Mul (Mul d10~88@ c10~86@) d10~88@)))) (=> (= temp_10_1~2018@ (Mul (Mul (Mul (Mul b10~84@ c10~86@) (Sub b10~84@ d10~88@)) (Mul (Mul d10~88@ c10~86@) d10~88@)) (Mul (Add (Mul d10~88@ d10~88@) (Sub d10~88@ c10~86@)) (Mul (Mul 77 b10~84@) (Mul 1 b10~84@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1933@ temp_10_1~2018@))) (=> (= temp_10_0~1933@ temp_10_1~2018@) (=> (= temp_11_0~2115@ (Mul (Mul (Mul c11~94@ (Mul a11~90@ c11~94@)) (Mul (Mul 86 b11~92@) (Mul b11~92@ c11~94@))) (Sub (Sub (Mul c11~94@ d11~96@) (Sub a11~90@ c11~94@)) (Add (Mul a11~90@ c11~94@) (Add a11~90@ a11~90@))))) (=> (= temp_11_1~2188@ (Mul (Mul (Mul c11~94@ (Mul a11~90@ c11~94@)) (Mul (Mul (Mul 86 b11~92@) b11~92@) c11~94@)) (Sub (Sub (Mul c11~94@ d11~96@) (Sub a11~90@ c11~94@)) (Add (Mul a11~90@ c11~94@) (Add a11~90@ a11~90@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~2115@ temp_11_1~2188@))) (=> (= temp_11_0~2115@ temp_11_1~2188@) (=> (= temp_12_0~2273@ (Mul (Mul (Mul a12~98@ (Mul b12~100@ c12~102@)) (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ d12~104@))) (Mul (Add (Mul a12~98@ b12~100@) (Mul d12~104@ d12~104@)) (Sub (Mul a12~98@ d12~104@) (Add b12~100@ c12~102@))))) (=> (= temp_12_1~2334@ (Mul (Mul (Mul a12~98@ (Mul b12~100@ c12~102@)) (Mul (Mul b12~100@ d12~104@) (Mul c12~102@ d12~104@))) (Mul (Add (Mul a12~98@ b12~100@) (Mul d12~104@ d12~104@)) (Sub (Mul d12~104@ a12~98@) (Add b12~100@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2273@ temp_12_1~2334@))) (=> (= temp_12_0~2273@ temp_12_1~2334@) (=> (= temp_13_0~2419@ (Mul (Add (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ b13~108@)) (Sub (Add a13~106@ a13~106@) (Mul a13~106@ d13~112@))) (Mul (Mul c13~110@ (Mul d13~112@ c13~110@)) (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ d13~112@))))) (=> (= temp_13_1~2480@ (Mul (Add (Mul (Mul b13~108@ b13~108@) (Mul a13~106@ b13~108@)) (Sub (Add a13~106@ a13~106@) (Mul a13~106@ d13~112@))) (Mul (Mul (Mul c13~110@ d13~112@) c13~110@) (Mul (Mul b13~108@ d13~112@) (Mul c13~110@ d13~112@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2419@ temp_13_1~2480@))) (=> (= temp_13_0~2419@ temp_13_1~2480@) (=> (= temp_14_0~2569@ (Mul (Add (Mul (Mul a14~114@ b14~116@) (Mul a14~114@ d14~120@)) (Mul (Add d14~120@ d14~120@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul c14~118@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul c14~118@ a14~114@) (Mul c14~118@ a14~114@))))) (=> (= temp_14_1~2634@ (Mul (Add (Mul (Mul a14~114@ b14~116@) (Mul a14~114@ d14~120@)) (Mul (Add d14~120@ d14~120@) (Mul b14~116@ a14~114@))) (Mul (Mul (Mul c14~118@ a14~114@) (Mul d14~120@ d14~120@)) (Mul (Mul a14~114@ c14~118@) (Mul c14~118@ a14~114@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2569@ temp_14_1~2634@))) (=> (= temp_14_0~2569@ temp_14_1~2634@) (=> (= temp_15_0~2735@ (Sub (Mul (Sub (Mul c15~126@ a15~122@) (Add c15~126@ c15~126@)) (Mul (Mul a15~122@ 23) (Sub b15~124@ b15~124@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul c15~126@ d15~128@)) (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ a15~122@))))) (=> (= temp_15_1~2812@ (Sub (Mul (Sub (Mul c15~126@ a15~122@) (Add c15~126@ c15~126@)) (Mul (Mul 23 a15~122@) (Sub b15~124@ b15~124@))) (Mul (Mul (Mul a15~122@ c15~126@) (Mul c15~126@ d15~128@)) (Mul (Mul c15~126@ c15~126@) (Mul a15~122@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2735@ temp_15_1~2812@))) (=> (= temp_15_0~2735@ temp_15_1~2812@) (=> (= temp_16_0~2921@ (Sub (Mul (Sub (Mul b16~132@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Add 11 d16~136@) (Mul 35 b16~132@))) (Mul (Mul (Mul d16~136@ b16~132@) (Mul c16~134@ b16~132@)) (Sub (Mul a16~130@ b16~132@) c16~134@)))) (=> (= temp_16_1~3006@ (Sub (Mul (Sub (Mul b16~132@ d16~136@) (Mul d16~136@ d16~136@)) (Mul (Add 11 d16~136@) (Mul 35 b16~132@))) (Mul (Mul (Mul c16~134@ b16~132@) (Mul d16~136@ b16~132@)) (Sub (Mul a16~130@ b16~132@) c16~134@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2921@ temp_16_1~3006@))) (=> (= temp_16_0~2921@ temp_16_1~3006@) (=> (= temp_17_0~3083@ (Mul (Mul (Mul (Mul d17~144@ a17~138@) (Add b17~140@ c17~142@)) a17~138@) (Mul (Add (Add d17~144@ a17~138@) (Sub d17~144@ b17~140@)) (Add (Mul c17~142@ b17~140@) (Mul d17~144@ c17~142@))))) (=> (= temp_17_1~3136@ (Mul (Mul (Mul d17~144@ a17~138@) (Add b17~140@ c17~142@)) (Mul a17~138@ (Mul (Add (Add d17~144@ a17~138@) (Sub d17~144@ b17~140@)) (Add (Mul c17~142@ b17~140@) (Mul d17~144@ c17~142@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~3083@ temp_17_1~3136@))) (=> (= temp_17_0~3083@ temp_17_1~3136@) (=> (= temp_18_0~3225@ (Mul (Mul (Mul (Mul a18~146@ b18~148@) (Add c18~150@ d18~152@)) (Mul (Mul b18~148@ c18~150@) (Mul d18~152@ d18~152@))) (Mul (Mul (Mul b18~148@ d18~152@) (Mul c18~150@ c18~150@)) (Mul (Mul b18~148@ b18~148@) (Add d18~152@ a18~146@))))) (=> (= temp_18_1~3290@ (Mul (Mul (Mul (Mul a18~146@ b18~148@) (Add c18~150@ d18~152@)) (Mul (Mul b18~148@ c18~150@) (Mul d18~152@ d18~152@))) (Mul (Mul (Mul d18~152@ b18~148@) (Mul c18~150@ c18~150@)) (Mul (Mul b18~148@ b18~148@) (Add d18~152@ a18~146@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~3225@ temp_18_1~3290@))) (=> (= temp_18_0~3225@ temp_18_1~3290@) (=> (= temp_19_0~3379@ (Mul (Mul (Sub (Mul b19~156@ a19~154@) (Sub d19~160@ a19~154@)) (Mul (Mul a19~154@ d19~160@) (Mul b19~156@ a19~154@))) (Mul (Sub (Mul c19~158@ b19~156@) (Add a19~154@ a19~154@)) (Mul (Mul b19~156@ b19~156@) (Mul c19~158@ a19~154@))))) (=> (= temp_19_1~3444@ (Mul (Mul (Mul (Sub (Mul b19~156@ a19~154@) (Sub d19~160@ a19~154@)) (Mul (Mul a19~154@ d19~160@) (Mul b19~156@ a19~154@))) (Sub (Mul c19~158@ b19~156@) (Add a19~154@ a19~154@))) (Mul (Mul b19~156@ b19~156@) (Mul c19~158@ a19~154@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%19 (= temp_19_0~3379@ temp_19_1~3444@))) (=> (= temp_19_0~3379@ temp_19_1~3444@) (=> (= temp_20_0~3525@ (Mul (Mul (Mul (Mul b20~164@ a20~162@) b20~164@) (Mul b20~164@ (Mul a20~162@ b20~164@))) (Mul (Sub (Mul a20~162@ a20~162@) (Mul d20~168@ d20~168@)) (Mul (Mul d20~168@ c20~166@) (Mul d20~168@ d20~168@))))) (=> (= temp_20_1~3582@ (Mul (Mul (Mul (Mul b20~164@ a20~162@) b20~164@) (Mul b20~164@ (Mul a20~162@ b20~164@))) (Mul (Sub (Mul a20~162@ a20~162@) (Mul d20~168@ d20~168@)) (Mul (Mul d20~168@ c20~166@) (Mul d20~168@ d20~168@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%20 (= temp_20_0~3525@ temp_20_1~3582@))) (=> (= temp_20_0~3525@ temp_20_1~3582@) (=> (= temp_21_0~3671@ (Mul (Mul (Mul (Mul d21~176@ a21~170@) (Mul c21~174@ 6)) b21~172@) (Mul a21~170@ (Add (Mul d21~176@ a21~170@) (Mul 98 b21~172@))))) (=> (= temp_21_1~3736@ (Mul (Mul (Mul (Mul d21~176@ a21~170@) (Mul 6 c21~174@)) b21~172@) (Mul a21~170@ (Add (Mul d21~176@ a21~170@) (Mul 98 b21~172@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%21 (= temp_21_0~3671@ temp_21_1~3736@))) (=> (= temp_21_0~3671@ temp_21_1~3736@) (=> (= temp_22_0~3837@ (Sub (Add (Sub (Sub d22~184@ b22~180@) (Mul a22~178@ d22~184@)) (Mul (Sub c22~182@ b22~180@) (Sub 6 d22~184@))) (Mul (Mul (Mul b22~180@ c22~182@) (Mul a22~178@ d22~184@)) (Sub (Mul d22~184@ c22~182@) (Mul d22~184@ c22~182@))))) (=> (= temp_22_1~3914@ (Sub (Add (Sub (Sub d22~184@ b22~180@) (Mul a22~178@ d22~184@)) (Mul (Sub c22~182@ b22~180@) (Sub 6 d22~184@))) (Mul (Sub (Mul d22~184@ c22~182@) (Mul d22~184@ c22~182@)) (Mul (Mul b22~180@ c22~182@) (Mul a22~178@ d22~184@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%22 (= temp_22_0~3837@ temp_22_1~3914@))) (=> (= temp_22_0~3837@ temp_22_1~3914@) (=> (= temp_23_0~4003@ (Sub (Mul (Mul (Mul c23~190@ c23~190@) (Mul d23~192@ a23~186@)) (Sub (Mul d23~192@ c23~190@) (Mul a23~186@ b23~188@))) (Mul (Mul (Mul a23~186@ c23~190@) (Mul b23~188@ a23~186@)) (Mul (Mul d23~192@ b23~188@) (Mul b23~188@ c23~190@))))) (=> (= temp_23_1~4068@ (Sub (Mul (Mul (Mul c23~190@ c23~190@) (Mul a23~186@ d23~192@)) (Sub (Mul d23~192@ c23~190@) (Mul a23~186@ b23~188@))) (Mul (Mul (Mul a23~186@ c23~190@) (Mul b23~188@ a23~186@)) (Mul (Mul d23~192@ b23~188@) (Mul b23~188@ c23~190@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%23 (= temp_23_0~4003@ temp_23_1~4068@))) (=> (= temp_23_0~4003@ temp_23_1~4068@) (=> (= temp_24_0~4153@ (Mul (Add b24~196@ (Mul (Mul c24~198@ a24~194@) (Add 37 c24~198@))) (Mul (Mul b24~196@ (Mul c24~198@ c24~198@)) (Mul (Add c24~198@ d24~200@) (Mul c24~198@ b24~196@))))) (=> (= temp_24_1~4214@ (Mul (Add b24~196@ (Mul (Mul a24~194@ c24~198@) (Add 37 c24~198@))) (Mul (Mul b24~196@ (Mul c24~198@ c24~198@)) (Mul (Add c24~198@ d24~200@) (Mul c24~198@ b24~196@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%24 (= temp_24_0~4153@ temp_24_1~4214@))) (=> (= temp_24_0~4153@ temp_24_1~4214@) (=> (= temp_25_0~4303@ (Add (Mul (Mul (Mul c25~206@ d25~208@) (Mul d25~208@ c25~206@)) (Mul (Mul c25~206@ b25~204@) (Mul c25~206@ b25~204@))) (Mul (Mul (Mul d25~208@ c25~206@) (Mul b25~204@ a25~202@)) (Mul (Mul c25~206@ c25~206@) (Mul d25~208@ b25~204@))))) (=> (= temp_25_1~4368@ (Add (Mul (Mul (Mul c25~206@ d25~208@) (Mul d25~208@ c25~206@)) (Mul (Mul c25~206@ b25~204@) (Mul b25~204@ c25~206@))) (Mul (Mul (Mul d25~208@ c25~206@) (Mul b25~204@ a25~202@)) (Mul (Mul c25~206@ c25~206@) (Mul d25~208@ b25~204@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%25 (= temp_25_0~4303@ temp_25_1~4368@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
