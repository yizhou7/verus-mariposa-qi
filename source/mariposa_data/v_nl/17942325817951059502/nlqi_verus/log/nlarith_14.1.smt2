...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Mul (Mul (Sub d0~8@ d0~8@) (Mul 42 d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ c0~6@))) (Sub (Mul (Mul b0~4@ a0~2@) (Add b0~4@ b0~4@)) d0~8@))) (=> (= temp_0_1~390@ (Add (Mul (Sub (Mul d0~8@ (Mul 42 d0~8@)) (Mul d0~8@ (Mul 42 d0~8@))) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ c0~6@))) (Sub (Mul (Mul b0~4@ a0~2@) (Add b0~4@ b0~4@)) d0~8@))) (=> (= tmp%1@ (= temp_0_0~305@ temp_0_1~390@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~470@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ a1~10@))) (Mul (Add (Mul c1~14@ c1~14@) (Add b1~12@ b1~12@)) (Add (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~535@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ a1~10@))) (Mul (Add (Mul c1~14@ c1~14@) (Add b1~12@ b1~12@)) (Add (Mul c1~14@ b1~12@) (Mul d1~16@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~470@ temp_1_1~535@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~615@ (Sub (Mul (Mul (Add a2~18@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ a2~18@))) (Mul (Mul (Mul b2~20@ c2~22@) (Sub a2~18@ d2~24@)) (Add (Mul d2~24@ b2~20@) (Mul d2~24@ d2~24@))))) (=> (= temp_2_1~680@ (Sub (Mul (Mul (Add a2~18@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ a2~18@))) (Mul (Mul (Mul b2~20@ c2~22@) (Sub a2~18@ d2~24@)) (Add (Mul d2~24@ b2~20@) (Mul d2~24@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~615@ temp_2_1~680@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~752@ (Mul (Mul (Add d3~32@ (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ d3~32@))) (Mul (Mul d3~32@ (Mul a3~26@ a3~26@)) (Mul (Add d3~32@ c3~30@) (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~825@ (Mul (Add (Mul d3~32@ (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ d3~32@))) (Mul (Mul b3~28@ d3~32@) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ d3~32@)))) (Mul (Mul d3~32@ (Mul a3~26@ a3~26@)) (Mul (Add d3~32@ c3~30@) (Mul b3~28@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~752@ temp_3_1~825@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~913@ (Sub (Mul (Mul (Mul a4~34@ d4~40@) a4~34@) (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ c4~38@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Mul d4~40@ 42) (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~986@ (Sub (Mul (Mul a4~34@ (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ c4~38@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Mul d4~40@ 42) (Mul c4~38@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~913@ temp_4_1~986@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~1038@ (Mul b5~44@ (Mul (Add (Mul b5~44@ a5~42@) (Mul d5~48@ c5~46@)) (Sub (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@))))) (=> (= temp_5_1~1075@ (Mul (Mul b5~44@ (Add (Mul b5~44@ a5~42@) (Mul d5~48@ c5~46@))) (Sub (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@)))) (=> (= tmp%6@ (= temp_5_0~1038@ temp_5_1~1075@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1187@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ 31)) (Mul (Mul 32 b6~52@) (Mul b6~52@ 73))) (Mul (Sub c6~54@ (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ a6~50@))))) (=> (= temp_6_1~1284@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ 31)) (Mul (Mul 32 b6~52@) (Mul b6~52@ 73))) (Mul (Sub c6~54@ (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1187@ temp_6_1~1284@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1364@ (Mul (Mul (Mul (Sub c7~62@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Add d7~64@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Mul (Add c7~62@ b7~60@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1429@ (Mul (Mul (Mul (Sub c7~62@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Add d7~64@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Add c7~62@ b7~60@) (Mul d7~64@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1364@ temp_7_1~1429@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1497@ (Add (Mul (Mul (Add b8~68@ a8~66@) (Mul c8~70@ d8~72@)) (Sub c8~70@ a8~66@)) (Add (Sub (Add d8~72@ c8~70@) c8~70@) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1550@ (Add (Mul (Sub c8~70@ a8~66@) (Mul (Add b8~68@ a8~66@) (Mul c8~70@ d8~72@))) (Add (Sub (Add d8~72@ c8~70@) c8~70@) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1497@ temp_8_1~1550@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~1618@ (Add (Mul (Mul d9~80@ (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ c9~78@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul b9~76@ b9~76@) c9~78@) (Mul d9~80@ (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1671@ (Add (Mul (Mul d9~80@ (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ c9~78@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul b9~76@ b9~76@) c9~78@) (Mul d9~80@ (Mul a9~74@ a9~74@))))) (=> (= tmp%10@ (= temp_9_0~1618@ temp_9_1~1671@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~1763@ (Mul (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ b10~84@))) (Sub (Mul (Sub a10~82@ b10~84@) (Mul b10~84@ 68)) (Mul (Sub a10~82@ a10~82@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~1840@ (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ b10~84@))) (Sub (Mul (Sub a10~82@ b10~84@) (Mul b10~84@ 68)) (Mul (Sub a10~82@ a10~82@) (Mul c10~86@ d10~88@))))) (=> (= tmp%11@ (= temp_10_0~1763@ temp_10_1~1840@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~1932@ (Add (Sub (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ b11~92@)) (Mul (Mul d11~96@ 0) (Mul a11~90@ d11~96@))) (Sub (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2009@ (Add (Sub (Mul d11~96@ (Mul a11~90@ (Mul b11~92@ b11~92@))) (Mul (Mul d11~96@ 0) (Mul a11~90@ d11~96@))) (Sub (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Mul b11~92@ a11~90@))))) (=> (= tmp%12@ (= temp_11_0~1932@ temp_11_1~2009@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~2101@ (Mul (Mul (Mul (Mul b12~100@ 66) (Mul a12~98@ a12~98@)) (Mul (Mul d12~104@ a12~98@) (Sub d12~104@ a12~98@))) (Mul (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@)) (Mul (Sub a12~98@ a12~98@) (Sub d12~104@ c12~102@))))) (=> (= temp_12_1~2178@ (Mul (Mul (Mul (Mul b12~100@ 66) (Mul a12~98@ a12~98@)) (Mul (Mul d12~104@ a12~98@) (Sub d12~104@ a12~98@))) (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ a12~98@)) (Mul (Sub a12~98@ a12~98@) (Sub d12~104@ c12~102@))))) (=> (= tmp%13@ (= temp_12_0~2101@ temp_12_1~2178@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~2266@ (Mul (Mul (Mul (Mul d13~112@ 86) b13~108@) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ c13~110@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ d13~112@)) (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2339@ (Mul (Mul (Mul (Mul d13~112@ 86) b13~108@) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ c13~110@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ d13~112@)) (Mul (Mul (Mul d13~112@ b13~108@) d13~112@) b13~108@)))) (=> (= tmp%14@ (= temp_13_0~2266@ temp_13_1~2339@)) (=> %%location_label%%13 tmp%14@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
