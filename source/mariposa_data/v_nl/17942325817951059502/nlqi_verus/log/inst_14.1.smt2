...
(set-info :comment ";; mariposa_data/v_nl//17942325817951059502/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Add (Mul (Mul (Sub d0~8@ d0~8@) (Mul 42 d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ c0~6@))) (Sub (Mul (Mul b0~4@ a0~2@) (Add b0~4@ b0~4@)) d0~8@))) (=> (= temp_0_1~390@ (Add (Mul (Sub (Mul d0~8@ (Mul 42 d0~8@)) (Mul d0~8@ (Mul 42 d0~8@))) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ c0~6@))) (Sub (Mul (Mul b0~4@ a0~2@) (Add b0~4@ b0~4@)) d0~8@))) (and (=> (= tmp%1@ (Mul 42 d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d0~8@ d0~8@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~390@)))) (=> (= temp_0_0~305@ temp_0_1~390@) (=> (= temp_1_0~501@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ a1~10@))) (Mul (Add (Mul c1~14@ c1~14@) (Add b1~12@ b1~12@)) (Add (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~566@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ a1~10@))) (Mul (Add (Mul c1~14@ c1~14@) (Add b1~12@ b1~12@)) (Add (Mul c1~14@ b1~12@) (Mul d1~16@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ c1~14@) (=> %%location_label%%1 (= temp_1_0~501@ temp_1_1~566@))) (=> (= temp_1_0~501@ temp_1_1~566@) (=> (= temp_2_0~659@ (Sub (Mul (Mul (Add a2~18@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ a2~18@))) (Mul (Mul (Mul b2~20@ c2~22@) (Sub a2~18@ d2~24@)) (Add (Mul d2~24@ b2~20@) (Mul d2~24@ d2~24@))))) (=> (= temp_2_1~724@ (Sub (Mul (Mul (Add a2~18@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ a2~18@))) (Mul (Mul (Mul b2~20@ c2~22@) (Sub a2~18@ d2~24@)) (Add (Mul d2~24@ b2~20@) (Mul d2~24@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ c2~22@) (=> %%location_label%%2 (= temp_2_0~659@ temp_2_1~724@))) (=> (= temp_2_0~659@ temp_2_1~724@) (=> (= temp_3_0~809@ (Mul (Mul (Add d3~32@ (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ d3~32@))) (Mul (Mul d3~32@ (Mul a3~26@ a3~26@)) (Mul (Add d3~32@ c3~30@) (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~882@ (Mul (Add (Mul d3~32@ (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ d3~32@))) (Mul (Mul b3~28@ d3~32@) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ d3~32@)))) (Mul (Mul d3~32@ (Mul a3~26@ a3~26@)) (Mul (Add d3~32@ c3~30@) (Mul b3~28@ c3~30@))))) (and (=> (= tmp%2@ (Mul b3~28@ d3~32@)) (=> (= tmp%3@ (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ d3~32@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d3~32@ tmp%2@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~809@ temp_3_1~882@))))) (=> (= temp_3_0~809@ temp_3_1~882@) (=> (= temp_4_0~1001@ (Sub (Mul (Mul (Mul a4~34@ d4~40@) a4~34@) (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ c4~38@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Mul d4~40@ 42) (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~1074@ (Sub (Mul (Mul a4~34@ (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ c4~38@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Mul d4~40@ 42) (Mul c4~38@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a4~34@ d4~40@ a4~34@) (=> %%location_label%%4 (= temp_4_0~1001@ temp_4_1~1074@))) (=> (= temp_4_0~1001@ temp_4_1~1074@) (=> (= temp_5_0~1141@ (Mul b5~44@ (Mul (Add (Mul b5~44@ a5~42@) (Mul d5~48@ c5~46@)) (Sub (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@))))) (=> (= temp_5_1~1178@ (Mul (Mul b5~44@ (Add (Mul b5~44@ a5~42@) (Mul d5~48@ c5~46@))) (Sub (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@)))) (and (=> (= tmp%4@ (Add (Mul b5~44@ a5~42@) (Mul d5~48@ c5~46@))) (=> (= tmp%5@ (Sub (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. b5~44@ tmp%4@ tmp%5@) (=> %%location_label%%5 (= temp_5_0~1141@ temp_5_1~1178@))))) (=> (= temp_5_0~1141@ temp_5_1~1178@) (=> (= temp_6_0~1329@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ 31)) (Mul (Mul 32 b6~52@) (Mul b6~52@ 73))) (Mul (Sub c6~54@ (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ a6~50@))))) (=> (= temp_6_1~1426@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ 31)) (Mul (Mul 32 b6~52@) (Mul b6~52@ 73))) (Mul (Sub c6~54@ (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ b6~52@))))) (and (=> (= tmp%6@ (Mul c6~54@ b6~52@)) (=> (= tmp%7@ (Mul c6~54@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%6 (= temp_6_0~1329@ temp_6_1~1426@))))) (=> (= temp_6_0~1329@ temp_6_1~1426@) (=> (= temp_7_0~1527@ (Mul (Mul (Mul (Sub c7~62@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Add d7~64@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Mul (Add c7~62@ b7~60@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1592@ (Mul (Mul (Mul (Sub c7~62@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Add d7~64@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@)) (Mul (Add c7~62@ b7~60@) (Mul d7~64@ b7~60@))))) (and (=> (= tmp%8@ (Mul (Add c7~62@ b7~60@) (Mul d7~64@ b7~60@))) (=> (= tmp%9@ (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%7 (= temp_7_0~1527@ temp_7_1~1592@))))) (=> (= temp_7_0~1527@ temp_7_1~1592@) (=> (= temp_8_0~1697@ (Add (Mul (Mul (Add b8~68@ a8~66@) (Mul c8~70@ d8~72@)) (Sub c8~70@ a8~66@)) (Add (Sub (Add d8~72@ c8~70@) c8~70@) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1750@ (Add (Mul (Sub c8~70@ a8~66@) (Mul (Add b8~68@ a8~66@) (Mul c8~70@ d8~72@))) (Add (Sub (Add d8~72@ c8~70@) c8~70@) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@))))) (and (=> (= tmp%10@ (Mul (Add b8~68@ a8~66@) (Mul c8~70@ d8~72@))) (=> (= tmp%11@ (Sub c8~70@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~1697@ temp_8_1~1750@))))) (=> (= temp_8_0~1697@ temp_8_1~1750@) (=> (= temp_9_0~1847@ (Add (Mul (Mul d9~80@ (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ c9~78@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul b9~76@ b9~76@) c9~78@) (Mul d9~80@ (Mul a9~74@ a9~74@))))) (=> (= temp_9_1~1900@ (Add (Mul (Mul d9~80@ (Mul a9~74@ c9~78@)) (Mul (Mul c9~78@ c9~78@) (Mul c9~78@ c9~78@))) (Mul (Mul (Mul b9~76@ b9~76@) c9~78@) (Mul d9~80@ (Mul a9~74@ a9~74@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c9~78@ c9~78@) (=> %%location_label%%9 (= temp_9_0~1847@ temp_9_1~1900@))) (=> (= temp_9_0~1847@ temp_9_1~1900@) (=> (= temp_10_0~2005@ (Mul (Mul (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ b10~84@))) (Sub (Mul (Sub a10~82@ b10~84@) (Mul b10~84@ 68)) (Mul (Sub a10~82@ a10~82@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~2082@ (Mul (Mul (Mul (Mul a10~82@ c10~86@) (Mul b10~84@ d10~88@)) (Mul (Mul c10~86@ a10~82@) (Mul b10~84@ b10~84@))) (Sub (Mul (Sub a10~82@ b10~84@) (Mul b10~84@ 68)) (Mul (Sub a10~82@ a10~82@) (Mul c10~86@ d10~88@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c10~86@ a10~82@) (=> %%location_label%%10 (= temp_10_0~2005@ temp_10_1~2082@))) (=> (= temp_10_0~2005@ temp_10_1~2082@) (=> (= temp_11_0~2187@ (Add (Sub (Mul (Mul d11~96@ a11~90@) (Mul b11~92@ b11~92@)) (Mul (Mul d11~96@ 0) (Mul a11~90@ d11~96@))) (Sub (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Mul b11~92@ a11~90@))))) (=> (= temp_11_1~2264@ (Add (Sub (Mul d11~96@ (Mul a11~90@ (Mul b11~92@ b11~92@))) (Mul (Mul d11~96@ 0) (Mul a11~90@ d11~96@))) (Sub (Mul (Mul c11~94@ d11~96@) (Mul a11~90@ a11~90@)) (Mul (Mul b11~92@ a11~90@) (Mul b11~92@ a11~90@))))) (and (=> (= tmp%12@ (Mul b11~92@ b11~92@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d11~96@ a11~90@ tmp%12@) (=> %%location_label%%11 (= temp_11_0~2187@ temp_11_1~2264@)))) (=> (= temp_11_0~2187@ temp_11_1~2264@) (=> (= temp_12_0~2375@ (Mul (Mul (Mul (Mul b12~100@ 66) (Mul a12~98@ a12~98@)) (Mul (Mul d12~104@ a12~98@) (Sub d12~104@ a12~98@))) (Mul (Mul (Mul b12~100@ a12~98@) (Mul a12~98@ c12~102@)) (Mul (Sub a12~98@ a12~98@) (Sub d12~104@ c12~102@))))) (=> (= temp_12_1~2452@ (Mul (Mul (Mul (Mul b12~100@ 66) (Mul a12~98@ a12~98@)) (Mul (Mul d12~104@ a12~98@) (Sub d12~104@ a12~98@))) (Mul (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ a12~98@)) (Mul (Sub a12~98@ a12~98@) (Sub d12~104@ c12~102@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a12~98@ c12~102@) (=> %%location_label%%12 (= temp_12_0~2375@ temp_12_1~2452@))) (=> (= temp_12_0~2375@ temp_12_1~2452@) (=> (= temp_13_0~2553@ (Mul (Mul (Mul (Mul d13~112@ 86) b13~108@) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ c13~110@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ d13~112@)) (Mul (Mul d13~112@ b13~108@) (Mul d13~112@ b13~108@))))) (=> (= temp_13_1~2626@ (Mul (Mul (Mul (Mul d13~112@ 86) b13~108@) (Mul (Mul c13~110@ c13~110@) (Mul a13~106@ c13~110@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul b13~108@ d13~112@)) (Mul (Mul (Mul d13~112@ b13~108@) d13~112@) b13~108@)))) (=> (= tmp%13@ (Mul d13~112@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ d13~112@ b13~108@) (=> %%location_label%%13 (= temp_13_0~2553@ temp_13_1~2626@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
