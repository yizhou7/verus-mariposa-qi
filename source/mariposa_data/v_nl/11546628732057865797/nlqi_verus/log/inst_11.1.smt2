...
(set-info :comment ";; mariposa_data/v_nl//11546628732057865797/nlqi_verus/src/main.rs:7:1: 36:40 (#0)")
(push 1)
...
(declare-const temp_7_0~1437@ Int)
(declare-const temp_7_1~1490@ Int)
(declare-const temp_8_0~1575@ Int)
(declare-const temp_8_1~1632@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~305@ (Mul (Sub (Mul (Sub d0~8@ b0~4@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Add a0~2@ c0~6@))) (Sub (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~370@ (Mul (Sub (Mul (Mul (Sub d0~8@ b0~4@) b0~4@) a0~2@) (Mul (Mul b0~4@ c0~6@) (Add a0~2@ c0~6@))) (Sub (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@))))) (and (=> (= tmp%1@ (Sub d0~8@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b0~4@ a0~2@) (=> %%location_label%%0 (= temp_0_0~305@ temp_0_1~370@)))) (=> (= temp_0_0~305@ temp_0_1~370@) (=> (= temp_1_0~481@ (Sub (Sub (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Add a1~10@ a1~10@) (Mul b1~12@ d1~16@))) (Add (Add (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Sub (Mul 89 a1~10@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~554@ (Sub (Sub (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Add a1~10@ a1~10@) (Mul b1~12@ d1~16@))) (Add (Add (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Sub 89 b1~12@) a1~10@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. 89 b1~12@ a1~10@) (=> %%location_label%%1 (= temp_1_0~481@ temp_1_1~554@))) (=> (= temp_1_0~481@ temp_1_1~554@) (=> (= temp_2_0~649@ (Mul (Mul (Mul (Add b2~20@ b2~20@) (Mul c2~22@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Sub b2~20@ c2~22@))) (Mul d2~24@ (Add (Mul a2~18@ d2~24@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~702@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Sub b2~20@ c2~22@)) (Mul (Add b2~20@ b2~20@) (Mul c2~22@ b2~20@))) (Mul d2~24@ (Add (Mul a2~18@ d2~24@) (Mul b2~20@ d2~24@))))) (and (=> (= tmp%2@ (Mul (Add b2~20@ b2~20@) (Mul c2~22@ b2~20@))) (=> (= tmp%3@ (Mul (Mul b2~20@ a2~18@) (Sub b2~20@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~649@ temp_2_1~702@))))) (=> (= temp_2_0~649@ temp_2_1~702@) (=> (= temp_3_0~807@ (Sub (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@)) c3~30@) (Mul (Sub (Mul c3~30@ a3~26@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~860@ (Sub (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@)) c3~30@) (Mul (Sub (Mul a3~26@ c3~30@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ a3~26@) (=> %%location_label%%3 (= temp_3_0~807@ temp_3_1~860@))) (=> (= temp_3_0~807@ temp_3_1~860@) (=> (= temp_4_0~949@ (Mul (Sub (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@)) (Mul b4~36@ (Mul d4~40@ a4~34@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ a4~34@))))) (=> (= temp_4_1~1010@ (Mul (Sub (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@)) (Mul b4~36@ (Mul d4~40@ a4~34@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ b4~36@) (=> %%location_label%%4 (= temp_4_0~949@ temp_4_1~1010@))) (=> (= temp_4_0~949@ temp_4_1~1010@) (=> (= temp_5_0~1111@ (Mul (Mul (Mul a5~42@ (Mul a5~42@ 46)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ c5~46@))) (Mul (Mul (Sub a5~42@ a5~42@) (Mul c5~46@ d5~48@)) (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ c5~46@))))) (=> (= temp_5_1~1184@ (Mul (Mul (Mul a5~42@ (Mul a5~42@ 46)) (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@))) (Mul (Mul (Sub a5~42@ a5~42@) (Mul c5~46@ d5~48@)) (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ b5~44@) (=> %%location_label%%5 (= temp_5_0~1111@ temp_5_1~1184@))) (=> (= temp_5_0~1111@ temp_5_1~1184@) (=> (= temp_6_0~1277@ (Mul (Mul (Mul (Add c6~54@ d6~56@) (Mul d6~56@ a6~50@)) (Sub (Mul c6~54@ c6~54@) (Mul b6~52@ c6~54@))) (Sub (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@ a6~50@) (Sub d6~56@ d6~56@))))) (=> (= temp_6_1~1350@ (Mul (Mul (Mul (Add c6~54@ d6~56@) (Mul d6~56@ a6~50@)) (Sub (Mul c6~54@ c6~54@) (Mul b6~52@ c6~54@))) (Sub (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ d6~56@)) (Sub (Mul (Mul c6~54@ a6~50@) d6~56@) (Mul (Mul c6~54@ a6~50@) d6~56@))))) (and (=> (= tmp%4@ (Mul c6~54@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ d6~56@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1277@ temp_6_1~1350@)))) (=> (= temp_6_0~1277@ temp_6_1~1350@) (=> (= temp_7_0~1437@ (Add (Mul (Mul (Mul b7~60@ d7~64@) a7~58@) (Mul (Add d7~64@ b7~60@) (Mul b7~60@ c7~62@))) (Mul (Mul (Mul a7~58@ c7~62@) b7~60@) (Mul (Mul a7~58@ a7~58@) c7~62@)))) (=> (= temp_7_1~1490@ (Add (Mul (Mul (Mul b7~60@ d7~64@) a7~58@) (Mul (Add d7~64@ b7~60@) (Mul b7~60@ c7~62@))) (Mul (Mul (Mul a7~58@ c7~62@) b7~60@) (Mul (Mul a7~58@ a7~58@) c7~62@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1437@ temp_7_1~1490@))) (=> (= temp_7_0~1437@ temp_7_1~1490@) (=> (= temp_8_0~1575@ (Mul (Mul (Mul (Sub a8~66@ b8~68@) (Mul c8~70@ a8~66@)) (Add (Mul a8~66@ c8~70@) (Mul d8~72@ a8~66@))) (Mul (Mul (Mul a8~66@ c8~70@) d8~72@) (Sub a8~66@ (Mul b8~68@ c8~70@))))) (=> (= temp_8_1~1632@ (Mul (Mul (Mul (Sub a8~66@ b8~68@) (Mul c8~70@ a8~66@)) (Add (Mul a8~66@ c8~70@) (Mul d8~72@ a8~66@))) (Mul (Mul (Mul c8~70@ a8~66@) d8~72@) (Sub a8~66@ (Mul b8~68@ c8~70@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ c8~70@) (=> %%location_label%%8 (= temp_8_0~1575@ temp_8_1~1632@))) (=> (= temp_8_0~1575@ temp_8_1~1632@) (=> (= temp_9_0~1697@ (Mul (Mul (Add (Mul d9~80@ b9~76@) (Mul d9~80@ a9~74@)) (Mul (Mul a9~74@ c9~78@) (Add a9~74@ b9~76@))) b9~76@)) (=> (= temp_9_1~1730@ (Mul (Mul (Mul d9~80@ (Add b9~76@ a9~74@)) (Mul (Mul a9~74@ c9~78@) (Add a9~74@ b9~76@))) b9~76@)) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d9~80@ b9~76@ a9~74@) (=> %%location_label%%9 (= temp_9_0~1697@ temp_9_1~1730@))) (=> (= temp_9_0~1697@ temp_9_1~1730@) (=> (= temp_10_0~1821@ (Mul (Sub (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ d10~88@)) (Sub (Mul a10~82@ b10~84@) (Mul a10~82@ d10~88@))) (Mul (Mul c10~86@ (Mul d10~88@ b10~84@)) (Mul (Add d10~88@ b10~84@) (Mul d10~88@ d10~88@))))) (=> (= temp_10_1~1882@ (Mul (Sub (Mul (Mul d10~88@ d10~88@) (Mul c10~86@ d10~88@)) (Sub (Mul a10~82@ b10~84@) (Mul a10~82@ d10~88@))) (Mul (Mul c10~86@ (Mul d10~88@ b10~84@)) (Mul (Mul (Add d10~88@ b10~84@) d10~88@) d10~88@)))) (=> (= tmp%5@ (Add d10~88@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ d10~88@ d10~88@) (=> %%location_label%%10 (= temp_10_0~1821@ temp_10_1~1882@)))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
