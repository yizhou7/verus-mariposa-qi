...
(declare-const temp_2_0~525@ Int)
...
(declare-const temp_7_0~1259@ Int)
(declare-const temp_7_1~1320@ Int)
(declare-const temp_8_0~1389@ Int)
(declare-const temp_8_1~1434@ Int)
(declare-const temp_9_0~1519@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~225@ (Mul (Mul (Sub (Mul b0~4@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)) (Add (Mul a0~2@ d0~8@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~306@ (Mul (Mul (Sub (Mul b0~4@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ b0~4@))) (Add (Mul (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)) (Mul a0~2@ d0~8@)) (Mul (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ a0~2@)) (Mul d0~8@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~225@ temp_0_1~306@))) (=> (= temp_0_0~225@ temp_0_1~306@) (=> (= temp_1_0~383@ (Add (Mul (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ c1~14@)) c1~14@) (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~436@ (Add (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@)) c1~14@) (Mul (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~383@ temp_1_1~436@))) (=> (= temp_1_0~383@ temp_1_1~436@) (=> (= temp_2_0~525@ (Add (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul d2~24@ d2~24@) (Add c2~22@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~590@ (Add (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul d2~24@ d2~24@) (Add c2~22@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~525@ temp_2_1~590@))) (=> (= temp_2_0~525@ temp_2_1~590@) (=> (= temp_3_0~691@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)) (Mul (Add c3~30@ 29) (Add b3~28@ d3~32@))) (Mul (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~768@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@)) (Mul (Add c3~30@ 29) (Add b3~28@ d3~32@))) (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~691@ temp_3_1~768@))) (=> (= temp_3_0~691@ temp_3_1~768@) (=> (= temp_4_0~853@ (Mul (Add (Mul (Mul c4~38@ b4~36@) (Add d4~40@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Sub c4~38@ d4~40@))) (Mul (Mul (Mul d4~40@ b4~36@) b4~36@) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~922@ (Mul (Add (Mul (Mul c4~38@ b4~36@) (Add d4~40@ c4~38@)) (Sub (Mul (Mul a4~34@ a4~34@) c4~38@) (Mul (Mul a4~34@ a4~34@) d4~40@))) (Mul (Mul (Mul d4~40@ b4~36@) b4~36@) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~853@ temp_4_1~922@))) (=> (= temp_4_0~853@ temp_4_1~922@) (=> (= temp_5_0~983@ (Sub b5~44@ (Mul (Mul (Add d5~48@ b5~44@) (Mul b5~44@ b5~44@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1028@ (Sub b5~44@ (Mul (Add (Mul d5~48@ (Mul b5~44@ b5~44@)) (Mul b5~44@ (Mul b5~44@ b5~44@))) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~983@ temp_5_1~1028@))) (=> (= temp_5_0~983@ temp_5_1~1028@) (=> (= temp_6_0~1113@ (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ a6~50@))) (Mul (Mul d6~56@ (Add b6~52@ c6~54@)) (Mul (Add c6~54@ a6~50@) (Mul b6~52@ d6~56@))))) (=> (= temp_6_1~1174@ (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ b6~52@))) (Mul (Mul d6~56@ (Add b6~52@ c6~54@)) (Mul (Add c6~54@ a6~50@) (Mul b6~52@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1113@ temp_6_1~1174@))) (=> (= temp_6_0~1113@ temp_6_1~1174@) (=> (= temp_7_0~1259@ (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ c7~62@))) (Sub (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@)) (Sub a7~58@ (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1320@ (Mul (Mul (Mul b7~60@ c7~62@) (Mul (Mul d7~64@ d7~64@) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ c7~62@)))) (Sub (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@)) (Sub a7~58@ (Mul b7~60@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1259@ temp_7_1~1320@))) (=> (= temp_7_0~1259@ temp_7_1~1320@) (=> (= temp_8_0~1389@ (Mul (Add (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ c8~70@))) (Mul b8~68@ (Mul d8~72@ d8~72@)))) (=> (= temp_8_1~1434@ (Mul (Add (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ a8~66@))) (Mul b8~68@ (Mul d8~72@ d8~72@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1389@ temp_8_1~1434@))) (=> (= temp_8_0~1389@ temp_8_1~1434@) (=> (= temp_9_0~1519@ (Add (Add (Mul (Mul d9~80@ a9~74@) (Mul b9~76@ b9~76@)) a9~74@) (Add (Mul (Add c9~78@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul 72 c9~78@) c9~78@)))) (=> (= temp_9_1~1580@ (Add (Add (Mul (Mul b9~76@ b9~76@) (Mul d9~80@ a9~74@)) a9~74@) (Add (Mul (Add c9~78@ c9~78@) (Mul b9~76@ b9~76@)) (Mul (Mul 72 c9~78@) c9~78@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~1519@ temp_9_1~1580@))) (=> (= temp_9_0~1519@ temp_9_1~1580@) (=> (= temp_10_0~1681@ (Add (Mul (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul a10~82@ d10~88@) (Mul 8 a10~82@))) (Add (Mul (Add d10~88@ a10~82@) (Sub a10~82@ b10~84@)) (Mul (Mul c10~86@ c10~86@) (Mul c10~86@ d10~88@))))) (=> (= temp_10_1~1758@ (Add (Mul (Mul (Mul a10~82@ c10~86@) (Mul d10~88@ d10~88@)) (Mul (Mul a10~82@ d10~88@) (Mul 8 a10~82@))) (Add (Mul (Add d10~88@ a10~82@) (Sub a10~82@ b10~84@)) (Mul (Mul c10~86@ c10~86@) (Mul d10~88@ c10~86@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~1681@ temp_10_1~1758@))) (=> (= temp_10_0~1681@ temp_10_1~1758@) (=> (= temp_11_0~1847@ (Add (Mul (Mul (Mul b11~92@ b11~92@) (Mul c11~94@ b11~92@)) (Mul (Sub c11~94@ a11~90@) (Mul b11~92@ c11~94@))) (Mul (Sub (Mul a11~90@ d11~96@) (Mul d11~96@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Add c11~94@ d11~96@))))) (=> (= temp_11_1~1912@ (Add (Mul (Mul (Sub c11~94@ a11~90@) (Mul b11~92@ c11~94@)) (Mul (Mul b11~92@ b11~92@) (Mul c11~94@ b11~92@))) (Mul (Sub (Mul a11~90@ d11~96@) (Mul d11~96@ b11~92@)) (Mul (Mul c11~94@ c11~94@) (Add c11~94@ d11~96@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~1847@ temp_11_1~1912@))) (=> (= temp_11_0~1847@ temp_11_1~1912@) (=> (= temp_12_0~2001@ (Mul (Mul (Mul (Mul a12~98@ c12~102@) (Mul b12~100@ d12~104@)) (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ a12~98@))) (Sub (Mul (Mul c12~102@ a12~98@) (Mul a12~98@ b12~100@)) (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ a12~98@))))) (=> (= temp_12_1~2066@ (Mul (Mul (Mul a12~98@ (Mul c12~102@ (Mul b12~100@ d12~104@))) (Mul (Mul d12~104@ b12~100@) (Mul d12~104@ a12~98@))) (Sub (Mul (Mul c12~102@ a12~98@) (Mul a12~98@ b12~100@)) (Mul (Mul b12~100@ a12~98@) (Mul c12~102@ a12~98@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~2001@ temp_12_1~2066@))) (=> (= temp_12_0~2001@ temp_12_1~2066@) (=> (= temp_13_0~2155@ (Mul (Add (Mul (Add a13~106@ b13~108@) (Mul d13~112@ d13~112@)) (Sub (Mul a13~106@ b13~108@) (Add d13~112@ b13~108@))) (Mul (Mul (Mul d13~112@ d13~112@) (Mul a13~106@ a13~106@)) (Mul (Add b13~108@ c13~110@) (Mul d13~112@ d13~112@))))) (=> (= temp_13_1~2252@ (Add (Mul (Mul (Add a13~106@ b13~108@) (Mul d13~112@ d13~112@)) (Mul (Mul (Mul d13~112@ d13~112@) (Mul a13~106@ a13~106@)) (Mul (Add b13~108@ c13~110@) (Mul d13~112@ d13~112@)))) (Mul (Sub (Mul a13~106@ b13~108@) (Add d13~112@ b13~108@)) (Mul (Mul (Mul d13~112@ d13~112@) (Mul a13~106@ a13~106@)) (Mul (Add b13~108@ c13~110@) (Mul d13~112@ d13~112@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~2155@ temp_13_1~2252@))) (=> (= temp_13_0~2155@ temp_13_1~2252@) (=> (= temp_14_0~2353@ (Mul (Mul (Mul (Mul d14~120@ d14~120@) (Mul a14~114@ a14~114@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ d14~120@))) (Add (Mul (Mul a14~114@ a14~114@) (Mul 97 d14~120@)) (Add (Mul b14~116@ a14~114@) (Add c14~118@ c14~118@))))) (=> (= temp_14_1~2430@ (Mul (Mul (Mul (Mul d14~120@ d14~120@) (Mul a14~114@ a14~114@)) (Mul (Mul b14~116@ b14~116@) (Mul d14~120@ d14~120@))) (Add (Mul (Mul a14~114@ a14~114@) (Mul 97 d14~120@)) (Add (Mul b14~116@ a14~114@) (Add c14~118@ c14~118@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~2353@ temp_14_1~2430@))) (=> (= temp_14_0~2353@ temp_14_1~2430@) (=> (= temp_15_0~2515@ (Mul (Add (Mul (Mul c15~126@ c15~126@) (Mul c15~126@ a15~122@)) (Mul (Mul b15~124@ c15~126@) (Sub d15~128@ a15~122@))) (Mul (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ d15~128@)) (Mul d15~128@ (Mul a15~122@ a15~122@))))) (=> (= temp_15_1~2576@ (Mul (Add (Mul (Mul c15~126@ c15~126@) (Mul c15~126@ a15~122@)) (Mul (Mul b15~124@ c15~126@) (Sub d15~128@ a15~122@))) (Mul (Mul (Mul b15~124@ c15~126@) (Mul d15~128@ d15~128@)) (Mul d15~128@ (Mul a15~122@ a15~122@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~2515@ temp_15_1~2576@))) (=> (= temp_15_0~2515@ temp_15_1~2576@) (=> (= temp_16_0~2665@ (Mul (Mul (Mul (Add c16~134@ c16~134@) (Add d16~136@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ b16~132@))) (Mul (Mul (Mul c16~134@ d16~136@) (Add c16~134@ b16~132@)) (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ c16~134@))))) (=> (= temp_16_1~2730@ (Mul (Mul (Mul (Add c16~134@ c16~134@) (Add d16~136@ a16~130@)) (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ b16~132@))) (Mul (Mul (Mul b16~132@ d16~136@) (Mul d16~136@ c16~134@)) (Mul (Mul c16~134@ d16~136@) (Add c16~134@ b16~132@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~2665@ temp_16_1~2730@))) (=> (= temp_16_0~2665@ temp_16_1~2730@) (=> (= temp_17_0~2795@ (Mul (Mul d17~144@ (Mul (Mul d17~144@ b17~140@) (Add c17~142@ b17~140@))) (Add c17~142@ (Mul (Add c17~142@ d17~144@) (Mul a17~138@ a17~138@))))) (=> (= temp_17_1~2836@ (Mul (Mul (Mul d17~144@ (Mul d17~144@ b17~140@)) (Add c17~142@ b17~140@)) (Add c17~142@ (Mul (Add c17~142@ d17~144@) (Mul a17~138@ a17~138@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~2795@ temp_17_1~2836@))) (=> (= temp_17_0~2795@ temp_17_1~2836@) (=> (= temp_18_0~2925@ (Mul (Mul (Mul (Mul a18~146@ d18~152@) (Mul c18~150@ b18~148@)) (Mul (Mul d18~152@ a18~146@) (Mul d18~152@ b18~148@))) (Mul (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ d18~152@)) (Mul (Add c18~150@ d18~152@) (Mul a18~146@ b18~148@))))) (=> (= temp_18_1~2990@ (Mul (Mul (Mul (Mul (Mul a18~146@ d18~152@) c18~150@) b18~148@) (Mul (Mul d18~152@ a18~146@) (Mul d18~152@ b18~148@))) (Mul (Mul (Mul b18~148@ c18~150@) (Mul c18~150@ d18~152@)) (Mul (Add c18~150@ d18~152@) (Mul a18~146@ b18~148@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~2925@ temp_18_1~2990@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
