...
(set-info :comment ";; mariposa_data/2//16170644153679370714/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ b0~4@) (Add a0~2@ c0~6@))) (=> (= temp_0_1~122@ (Add (Mul (Mul d0~8@ b0~4@) a0~2@) (Mul (Mul d0~8@ b0~4@) c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@))) (=> (= temp_0_0~97@ temp_0_1~122@) (=> (= temp_1_0~163@ (Mul (Mul a1~10@ d1~16@) (Sub d1~16@ b1~12@))) (=> (= temp_1_1~180@ (Mul (Sub d1~16@ b1~12@) (Mul a1~10@ d1~16@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~163@ temp_1_1~180@))))))))))))
(assert %%query%%)
(check-sat)
