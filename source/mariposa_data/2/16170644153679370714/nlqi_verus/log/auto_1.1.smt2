...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ b0~4@) (Add a0~2@ c0~6@))) (=> (= temp_0_1~122@ (Add (Mul (Mul d0~8@ b0~4@) a0~2@) (Mul (Mul d0~8@ b0~4@) c0~6@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@))))))))
(assert %%query%%)
(check-sat)
