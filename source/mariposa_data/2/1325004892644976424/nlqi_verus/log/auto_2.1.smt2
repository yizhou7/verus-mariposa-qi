...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~172@ (Mul d1~16@ (Mul c1~14@ (Mul b1~12@ b1~12@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))))))))))))
(assert %%query%%)
(check-sat)
