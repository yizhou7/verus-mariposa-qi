...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@))) (=> (= temp_0_1~118@ (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~150@ (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~167@ (Mul d1~16@ (Mul c1~14@ (Mul b1~12@ b1~12@)))) (=> (= tmp%2@ (= temp_1_0~150@ temp_1_1~167@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~211@ (Mul (Mul 52 d2~24@) (Mul b2~20@ c2~22@))) (=> (= temp_2_1~240@ (Mul 52 (Mul d2~24@ (Mul b2~20@ c2~22@)))) (=> (= tmp%3@ (= temp_2_0~211@ temp_2_1~240@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~272@ (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@))) (=> (= temp_3_1~289@ (Mul (Mul (Mul d3~32@ c3~30@) b3~28@) d3~32@)) (=> (= tmp%4@ (= temp_3_0~272@ temp_3_1~289@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~321@ (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ c4~38@))) (=> (= temp_4_1~338@ (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ c4~38@))) (=> (= tmp%5@ (= temp_4_0~321@ temp_4_1~338@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~382@ (Mul (Sub d5~48@ c5~46@) (Add c5~46@ 78))) (=> (= temp_5_1~411@ (Mul (Add c5~46@ 78) (Sub d5~48@ c5~46@))) (=> (= tmp%6@ (= temp_5_0~382@ temp_5_1~411@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~443@ (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))) (=> (= temp_6_1~460@ (Mul c6~54@ (Mul b6~52@ (Mul d6~56@ a6~50@)))) (=> (= tmp%7@ (= temp_6_0~443@ temp_6_1~460@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~492@ (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@))) (=> (= temp_7_1~509@ (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ c7~62@))) (=> (= tmp%8@ (= temp_7_0~492@ temp_7_1~509@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~541@ (Mul (Mul d8~72@ b8~68@) (Sub c8~70@ d8~72@))) (=> (= temp_8_1~566@ (Sub (Mul (Mul d8~72@ b8~68@) c8~70@) (Mul (Mul d8~72@ b8~68@) d8~72@))) (=> (= tmp%9@ (= temp_8_0~541@ temp_8_1~566@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
