...
(declare-const temp_3_0~268@ Int)
(declare-const temp_3_1~285@ Int)
(declare-const temp_4_0~317@ Int)
(declare-const temp_4_1~334@ Int)
(declare-const temp_5_0~378@ Int)
(declare-const temp_5_1~407@ Int)
(declare-const temp_6_0~439@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~163@ (Mul d1~16@ (Mul c1~14@ (Mul b1~12@ b1~12@)))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~207@ (Mul (Mul 52 d2~24@) (Mul b2~20@ c2~22@))) (=> (= temp_2_1~236@ (Mul 52 (Mul d2~24@ (Mul b2~20@ c2~22@)))) (=> (= tmp%3@ (= temp_2_0~207@ temp_2_1~236@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~268@ (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@))) (=> (= temp_3_1~285@ (Mul (Mul (Mul d3~32@ c3~30@) b3~28@) d3~32@)) (=> (= tmp%4@ (= temp_3_0~268@ temp_3_1~285@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~317@ (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ c4~38@))) (=> (= temp_4_1~334@ (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ c4~38@))) (=> (= tmp%5@ (= temp_4_0~317@ temp_4_1~334@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~378@ (Mul (Sub d5~48@ c5~46@) (Add c5~46@ 78))) (=> (= temp_5_1~407@ (Mul (Add c5~46@ 78) (Sub d5~48@ c5~46@))) (=> (= tmp%6@ (= temp_5_0~378@ temp_5_1~407@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~439@ (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))) (=> (= temp_6_1~456@ (Mul c6~54@ (Mul b6~52@ (Mul d6~56@ a6~50@)))) (=> (= tmp%7@ (= temp_6_0~439@ temp_6_1~456@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~488@ (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@))) (=> (= temp_7_1~505@ (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ c7~62@))) (=> (= tmp%8@ (= temp_7_0~488@ temp_7_1~505@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~537@ (Mul (Mul d8~72@ b8~68@) (Sub c8~70@ d8~72@))) (=> (= temp_8_1~562@ (Sub (Mul (Mul d8~72@ b8~68@) c8~70@) (Mul (Mul d8~72@ b8~68@) d8~72@))) (=> (= tmp%9@ (= temp_8_0~537@ temp_8_1~562@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
