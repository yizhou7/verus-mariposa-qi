...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@))) (and (=> (= tmp%1@ (Mul a0~2@ b0~4@)) (=> (= tmp%2@ (Mul b0~4@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~184@ (Mul d1~16@ (Mul c1~14@ (Mul b1~12@ b1~12@)))) (and (=> (= tmp%3@ (Mul b1~12@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d1~16@ c1~14@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@)))) (=> (= temp_1_0~167@ temp_1_1~184@) (=> (= temp_2_0~247@ (Mul (Mul 52 d2~24@) (Mul b2~20@ c2~22@))) (=> (= temp_2_1~276@ (Mul 52 (Mul d2~24@ (Mul b2~20@ c2~22@)))) (=> (= tmp%4@ (Mul b2~20@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. 52 d2~24@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~247@ temp_2_1~276@)))))))))))))))))
(assert %%query%%)
(check-sat)
