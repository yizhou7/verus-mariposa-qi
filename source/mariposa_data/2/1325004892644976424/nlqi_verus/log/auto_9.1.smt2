...
(declare-const temp_2_0~225@ Int)
...
(declare-const temp_5_0~423@ Int)
(declare-const temp_5_1~452@ Int)
(declare-const temp_6_0~493@ Int)
(declare-const temp_6_1~510@ Int)
(declare-const temp_7_0~551@ Int)
(declare-const temp_7_1~568@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~172@ (Mul d1~16@ (Mul c1~14@ (Mul b1~12@ b1~12@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~225@ (Mul (Mul 52 d2~24@) (Mul b2~20@ c2~22@))) (=> (= temp_2_1~254@ (Mul 52 (Mul d2~24@ (Mul b2~20@ c2~22@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~225@ temp_2_1~254@))) (=> (= temp_2_0~225@ temp_2_1~254@) (=> (= temp_3_0~295@ (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@))) (=> (= temp_3_1~312@ (Mul (Mul (Mul d3~32@ c3~30@) b3~28@) d3~32@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~295@ temp_3_1~312@))) (=> (= temp_3_0~295@ temp_3_1~312@) (=> (= temp_4_0~353@ (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ c4~38@))) (=> (= temp_4_1~370@ (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~353@ temp_4_1~370@))) (=> (= temp_4_0~353@ temp_4_1~370@) (=> (= temp_5_0~423@ (Mul (Sub d5~48@ c5~46@) (Add c5~46@ 78))) (=> (= temp_5_1~452@ (Mul (Add c5~46@ 78) (Sub d5~48@ c5~46@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~423@ temp_5_1~452@))) (=> (= temp_5_0~423@ temp_5_1~452@) (=> (= temp_6_0~493@ (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))) (=> (= temp_6_1~510@ (Mul c6~54@ (Mul b6~52@ (Mul d6~56@ a6~50@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~493@ temp_6_1~510@))) (=> (= temp_6_0~493@ temp_6_1~510@) (=> (= temp_7_0~551@ (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@))) (=> (= temp_7_1~568@ (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~551@ temp_7_1~568@))) (=> (= temp_7_0~551@ temp_7_1~568@) (=> (= temp_8_0~609@ (Mul (Mul d8~72@ b8~68@) (Sub c8~70@ d8~72@))) (=> (= temp_8_1~634@ (Sub (Mul (Mul d8~72@ b8~68@) c8~70@) (Mul (Mul d8~72@ b8~68@) d8~72@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~609@ temp_8_1~634@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
