...
(set-info :comment ";; mariposa_data/2//1325004892644976424/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_2_0~247@ Int)
(declare-const temp_2_1~276@ Int)
(declare-const temp_3_0~339@ Int)
(declare-const temp_3_1~356@ Int)
(declare-const temp_4_0~407@ Int)
(declare-const temp_4_1~424@ Int)
(declare-const temp_5_0~481@ Int)
(declare-const temp_5_1~510@ Int)
(declare-const temp_6_0~575@ Int)
(declare-const temp_6_1~592@ Int)
(declare-const temp_7_0~643@ Int)
(declare-const temp_7_1~660@ Int)
(declare-const temp_8_0~713@ Int)
(declare-const temp_8_1~738@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@))) (and (=> (= tmp%1@ (Mul a0~2@ b0~4@)) (=> (= tmp%2@ (Mul b0~4@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~184@ (Mul d1~16@ (Mul c1~14@ (Mul b1~12@ b1~12@)))) (and (=> (= tmp%3@ (Mul b1~12@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d1~16@ c1~14@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@)))) (=> (= temp_1_0~167@ temp_1_1~184@) (=> (= temp_2_0~247@ (Mul (Mul 52 d2~24@) (Mul b2~20@ c2~22@))) (=> (= temp_2_1~276@ (Mul 52 (Mul d2~24@ (Mul b2~20@ c2~22@)))) (and (=> (= tmp%4@ (Mul b2~20@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. 52 d2~24@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~247@ temp_2_1~276@)))) (=> (= temp_2_0~247@ temp_2_1~276@) (=> (= temp_3_0~339@ (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@))) (=> (= temp_3_1~356@ (Mul (Mul (Mul d3~32@ c3~30@) b3~28@) d3~32@)) (and (=> (= tmp%5@ (Mul d3~32@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ b3~28@ d3~32@) (=> %%location_label%%3 (= temp_3_0~339@ temp_3_1~356@)))) (=> (= temp_3_0~339@ temp_3_1~356@) (=> (= temp_4_0~407@ (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ c4~38@))) (=> (= temp_4_1~424@ (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ d4~40@) (=> %%location_label%%4 (= temp_4_0~407@ temp_4_1~424@))) (=> (= temp_4_0~407@ temp_4_1~424@) (=> (= temp_5_0~481@ (Mul (Sub d5~48@ c5~46@) (Add c5~46@ 78))) (=> (= temp_5_1~510@ (Mul (Add c5~46@ 78) (Sub d5~48@ c5~46@))) (and (=> (= tmp%6@ (Sub d5~48@ c5~46@)) (=> (= tmp%7@ (Add c5~46@ 78)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%5 (= temp_5_0~481@ temp_5_1~510@))))) (=> (= temp_5_0~481@ temp_5_1~510@) (=> (= temp_6_0~575@ (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ a6~50@))) (=> (= temp_6_1~592@ (Mul c6~54@ (Mul b6~52@ (Mul d6~56@ a6~50@)))) (and (=> (= tmp%8@ (Mul d6~56@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c6~54@ b6~52@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~575@ temp_6_1~592@)))) (=> (= temp_6_0~575@ temp_6_1~592@) (=> (= temp_7_0~643@ (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ b7~60@))) (=> (= temp_7_1~660@ (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ c7~62@))) (and (=> (= tmp%9@ (Mul c7~62@ c7~62@)) (=> (= tmp%10@ (Mul d7~64@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~643@ temp_7_1~660@))))) (=> (= temp_7_0~643@ temp_7_1~660@) (=> (= temp_8_0~713@ (Mul (Mul d8~72@ b8~68@) (Sub c8~70@ d8~72@))) (=> (= temp_8_1~738@ (Sub (Mul (Mul d8~72@ b8~68@) c8~70@) (Mul (Mul d8~72@ b8~68@) d8~72@))) (=> (= tmp%11@ (Mul d8~72@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%11@ c8~70@ d8~72@) (=> %%location_label%%8 (= temp_8_0~713@ temp_8_1~738@)))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
