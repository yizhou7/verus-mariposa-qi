...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (=> (= temp_0_1~118@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (=> %%location_label%%0 tmp%1@))))))))
(assert %%query%%)
(check-sat)
