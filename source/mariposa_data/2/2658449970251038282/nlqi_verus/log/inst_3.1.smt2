...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ a0~2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Add d1~16@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~176@ (Mul (Mul (Add d1~16@ b1~12@) b1~12@) b1~12@)) (and (=> (= tmp%1@ (Add d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b1~12@ b1~12@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@)))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~227@ (Mul (Mul a2~18@ a2~18@) (Add d2~24@ a2~18@))) (=> (= temp_2_1~252@ (Add (Mul (Mul a2~18@ a2~18@) d2~24@) (Mul (Mul a2~18@ a2~18@) a2~18@))) (=> (= tmp%2@ (Mul a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%2@ d2~24@ a2~18@) (=> %%location_label%%2 (= temp_2_0~227@ temp_2_1~252@)))))))))))))))))
(assert %%query%%)
(check-sat)
