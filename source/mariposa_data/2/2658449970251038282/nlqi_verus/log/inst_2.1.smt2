...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ a0~2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Add d1~16@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~176@ (Mul (Mul (Add d1~16@ b1~12@) b1~12@) b1~12@)) (=> (= tmp%1@ (Add d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b1~12@ b1~12@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@)))))))))))))
(assert %%query%%)
(check-sat)
