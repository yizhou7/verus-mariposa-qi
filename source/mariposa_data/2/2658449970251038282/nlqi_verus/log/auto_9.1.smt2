...
(declare-const temp_5_0~403@ Int)
(declare-const temp_5_1~420@ Int)
(declare-const temp_6_0~461@ Int)
(declare-const temp_6_1~478@ Int)
(declare-const temp_7_0~519@ Int)
(declare-const temp_7_1~536@ Int)
(declare-const temp_8_0~577@ Int)
(declare-const temp_8_1~594@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Add d1~16@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~172@ (Mul (Mul (Add d1~16@ b1~12@) b1~12@) b1~12@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Mul a2~18@ a2~18@) (Add d2~24@ a2~18@))) (=> (= temp_2_1~238@ (Add (Mul (Mul a2~18@ a2~18@) d2~24@) (Mul (Mul a2~18@ a2~18@) a2~18@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~238@))) (=> (= temp_2_0~213@ temp_2_1~238@) (=> (= temp_3_0~279@ (Mul (Add d3~32@ b3~28@) (Mul c3~30@ c3~30@))) (=> (= temp_3_1~304@ (Add (Mul d3~32@ (Mul c3~30@ c3~30@)) (Mul b3~28@ (Mul c3~30@ c3~30@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~279@ temp_3_1~304@))) (=> (= temp_3_0~279@ temp_3_1~304@) (=> (= temp_4_0~345@ (Add (Sub a4~34@ d4~40@) (Mul d4~40@ a4~34@))) (=> (= temp_4_1~362@ (Add (Sub a4~34@ d4~40@) (Mul a4~34@ d4~40@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~345@ temp_4_1~362@))) (=> (= temp_4_0~345@ temp_4_1~362@) (=> (= temp_5_0~403@ (Mul (Sub a5~42@ a5~42@) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~420@ (Mul (Mul (Sub a5~42@ a5~42@) b5~44@) d5~48@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~403@ temp_5_1~420@))) (=> (= temp_5_0~403@ temp_5_1~420@) (=> (= temp_6_0~461@ (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ d6~56@))) (=> (= temp_6_1~478@ (Mul (Mul (Mul b6~52@ d6~56@) d6~56@) d6~56@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~461@ temp_6_1~478@))) (=> (= temp_6_0~461@ temp_6_1~478@) (=> (= temp_7_0~519@ (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ d7~64@))) (=> (= temp_7_1~536@ (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~519@ temp_7_1~536@))) (=> (= temp_7_0~519@ temp_7_1~536@) (=> (= temp_8_0~577@ (Mul (Add d8~72@ d8~72@) (Mul d8~72@ d8~72@))) (=> (= temp_8_1~594@ (Mul (Mul d8~72@ d8~72@) (Add d8~72@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~577@ temp_8_1~594@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
