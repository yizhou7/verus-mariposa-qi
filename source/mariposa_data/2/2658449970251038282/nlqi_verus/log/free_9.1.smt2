...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (=> (= temp_0_1~118@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~150@ (Mul (Add d1~16@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~167@ (Mul (Mul (Add d1~16@ b1~12@) b1~12@) b1~12@)) (=> (= tmp%2@ (= temp_1_0~150@ temp_1_1~167@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~199@ (Mul (Mul a2~18@ a2~18@) (Add d2~24@ a2~18@))) (=> (= temp_2_1~224@ (Add (Mul (Mul a2~18@ a2~18@) d2~24@) (Mul (Mul a2~18@ a2~18@) a2~18@))) (=> (= tmp%3@ (= temp_2_0~199@ temp_2_1~224@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~256@ (Mul (Add d3~32@ b3~28@) (Mul c3~30@ c3~30@))) (=> (= temp_3_1~281@ (Add (Mul d3~32@ (Mul c3~30@ c3~30@)) (Mul b3~28@ (Mul c3~30@ c3~30@)))) (=> (= tmp%4@ (= temp_3_0~256@ temp_3_1~281@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~313@ (Add (Sub a4~34@ d4~40@) (Mul d4~40@ a4~34@))) (=> (= temp_4_1~330@ (Add (Sub a4~34@ d4~40@) (Mul a4~34@ d4~40@))) (=> (= tmp%5@ (= temp_4_0~313@ temp_4_1~330@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~362@ (Mul (Sub a5~42@ a5~42@) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~379@ (Mul (Mul (Sub a5~42@ a5~42@) b5~44@) d5~48@)) (=> (= tmp%6@ (= temp_5_0~362@ temp_5_1~379@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~411@ (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ d6~56@))) (=> (= temp_6_1~428@ (Mul (Mul (Mul b6~52@ d6~56@) d6~56@) d6~56@)) (=> (= tmp%7@ (= temp_6_0~411@ temp_6_1~428@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~460@ (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ d7~64@))) (=> (= temp_7_1~477@ (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ d7~64@))) (=> (= tmp%8@ (= temp_7_0~460@ temp_7_1~477@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~509@ (Mul (Add d8~72@ d8~72@) (Mul d8~72@ d8~72@))) (=> (= temp_8_1~526@ (Mul (Mul d8~72@ d8~72@) (Add d8~72@ d8~72@))) (=> (= tmp%9@ (= temp_8_0~509@ temp_8_1~526@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
