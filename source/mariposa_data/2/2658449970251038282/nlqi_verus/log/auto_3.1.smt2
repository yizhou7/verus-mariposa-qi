...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Add d1~16@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~172@ (Mul (Mul (Add d1~16@ b1~12@) b1~12@) b1~12@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Mul a2~18@ a2~18@) (Add d2~24@ a2~18@))) (=> (= temp_2_1~238@ (Add (Mul (Mul a2~18@ a2~18@) d2~24@) (Mul (Mul a2~18@ a2~18@) a2~18@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~238@))))))))))))))))
(assert %%query%%)
(check-sat)
