...
(set-info :comment ";; mariposa_data/2//2658449970251038282/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_2_0~227@ Int)
(declare-const temp_2_1~252@ Int)
(declare-const temp_3_0~303@ Int)
(declare-const temp_3_1~328@ Int)
(declare-const temp_4_0~379@ Int)
(declare-const temp_4_1~396@ Int)
(declare-const temp_5_0~441@ Int)
(declare-const temp_5_1~458@ Int)
(declare-const temp_6_0~509@ Int)
(declare-const temp_6_1~526@ Int)
(declare-const temp_7_0~577@ Int)
(declare-const temp_7_1~594@ Int)
(declare-const temp_8_0~647@ Int)
(declare-const temp_8_1~664@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Sub b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ a0~2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Add d1~16@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~176@ (Mul (Mul (Add d1~16@ b1~12@) b1~12@) b1~12@)) (and (=> (= tmp%1@ (Add d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b1~12@ b1~12@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@)))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~227@ (Mul (Mul a2~18@ a2~18@) (Add d2~24@ a2~18@))) (=> (= temp_2_1~252@ (Add (Mul (Mul a2~18@ a2~18@) d2~24@) (Mul (Mul a2~18@ a2~18@) a2~18@))) (and (=> (= tmp%2@ (Mul a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%2@ d2~24@ a2~18@) (=> %%location_label%%2 (= temp_2_0~227@ temp_2_1~252@)))) (=> (= temp_2_0~227@ temp_2_1~252@) (=> (= temp_3_0~303@ (Mul (Add d3~32@ b3~28@) (Mul c3~30@ c3~30@))) (=> (= temp_3_1~328@ (Add (Mul d3~32@ (Mul c3~30@ c3~30@)) (Mul b3~28@ (Mul c3~30@ c3~30@)))) (and (=> (= tmp%3@ (Mul c3~30@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d3~32@ b3~28@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~303@ temp_3_1~328@)))) (=> (= temp_3_0~303@ temp_3_1~328@) (=> (= temp_4_0~379@ (Add (Sub a4~34@ d4~40@) (Mul d4~40@ a4~34@))) (=> (= temp_4_1~396@ (Add (Sub a4~34@ d4~40@) (Mul a4~34@ d4~40@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ a4~34@) (=> %%location_label%%4 (= temp_4_0~379@ temp_4_1~396@))) (=> (= temp_4_0~379@ temp_4_1~396@) (=> (= temp_5_0~441@ (Mul (Sub a5~42@ a5~42@) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~458@ (Mul (Mul (Sub a5~42@ a5~42@) b5~44@) d5~48@)) (and (=> (= tmp%4@ (Sub a5~42@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ b5~44@ d5~48@) (=> %%location_label%%5 (= temp_5_0~441@ temp_5_1~458@)))) (=> (= temp_5_0~441@ temp_5_1~458@) (=> (= temp_6_0~509@ (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ d6~56@))) (=> (= temp_6_1~526@ (Mul (Mul (Mul b6~52@ d6~56@) d6~56@) d6~56@)) (and (=> (= tmp%5@ (Mul b6~52@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ d6~56@ d6~56@) (=> %%location_label%%6 (= temp_6_0~509@ temp_6_1~526@)))) (=> (= temp_6_0~509@ temp_6_1~526@) (=> (= temp_7_0~577@ (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ d7~64@))) (=> (= temp_7_1~594@ (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ d7~64@))) (and (=> (= tmp%6@ (Mul b7~60@ d7~64@)) (=> (= tmp%7@ (Mul c7~62@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%7 (= temp_7_0~577@ temp_7_1~594@))))) (=> (= temp_7_0~577@ temp_7_1~594@) (=> (= temp_8_0~647@ (Mul (Add d8~72@ d8~72@) (Mul d8~72@ d8~72@))) (=> (= temp_8_1~664@ (Mul (Mul d8~72@ d8~72@) (Add d8~72@ d8~72@))) (=> (= tmp%8@ (Add d8~72@ d8~72@)) (=> (= tmp%9@ (Mul d8~72@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%8 (= temp_8_0~647@ temp_8_1~664@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
