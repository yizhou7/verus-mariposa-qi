...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))) (=> (= temp_1_1~163@ (Mul (Mul (Mul b1~12@ c1~14@) d1~16@) a1~10@)) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ a2~18@))) (=> (= temp_2_1~212@ (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ b2~20@))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~212@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~256@ (Mul (Mul c3~30@ 74) (Mul d3~32@ c3~30@))) (=> (= temp_3_1~285@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ 74))) (=> (= tmp%4@ (= temp_3_0~256@ temp_3_1~285@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~317@ (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@))) (=> (= temp_4_1~334@ (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ c4~38@))) (=> (= tmp%5@ (= temp_4_0~317@ temp_4_1~334@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~366@ (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))) (=> (= temp_5_1~383@ (Mul (Mul (Mul b5~44@ d5~48@) c5~46@) b5~44@)) (=> (= tmp%6@ (= temp_5_0~366@ temp_5_1~383@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~415@ (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ b6~52@))) (=> (= temp_6_1~432@ (Mul d6~56@ (Mul b6~52@ (Mul c6~54@ b6~52@)))) (=> (= tmp%7@ (= temp_6_0~415@ temp_6_1~432@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~476@ (Mul (Mul c7~62@ d7~64@) (Add 53 b7~60@))) (=> (= temp_7_1~505@ (Mul c7~62@ (Mul d7~64@ (Add 53 b7~60@)))) (=> (= tmp%8@ (= temp_7_0~476@ temp_7_1~505@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~537@ (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~554@ (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@))) (=> (= tmp%9@ (= temp_8_0~537@ temp_8_1~554@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
