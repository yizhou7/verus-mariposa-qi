...
(set-info :comment ";; mariposa_data/2//16955958038872963367/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_2_1~244@ Int)
(declare-const temp_3_0~309@ Int)
(declare-const temp_3_1~338@ Int)
(declare-const temp_4_0~403@ Int)
(declare-const temp_4_1~420@ Int)
(declare-const temp_5_0~465@ Int)
(declare-const temp_5_1~482@ Int)
(declare-const temp_6_0~533@ Int)
(declare-const temp_6_1~550@ Int)
(declare-const temp_7_0~613@ Int)
(declare-const temp_7_1~642@ Int)
(declare-const temp_8_0~705@ Int)
(declare-const temp_8_1~722@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ c0~6@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))) (=> (= temp_1_1~176@ (Mul (Mul (Mul b1~12@ c1~14@) d1~16@) a1~10@)) (and (=> (= tmp%1@ (Mul b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ d1~16@ a1~10@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@)))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~227@ (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ a2~18@))) (=> (= temp_2_1~244@ (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ b2~20@))) (and (=> (= tmp%2@ (Mul a2~18@ b2~20@)) (=> (= tmp%3@ (Mul d2~24@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~227@ temp_2_1~244@))))) (=> (= temp_2_0~227@ temp_2_1~244@) (=> (= temp_3_0~309@ (Mul (Mul c3~30@ 74) (Mul d3~32@ c3~30@))) (=> (= temp_3_1~338@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ 74))) (and (=> (= tmp%4@ (Mul c3~30@ 74)) (=> (= tmp%5@ (Mul d3~32@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~309@ temp_3_1~338@))))) (=> (= temp_3_0~309@ temp_3_1~338@) (=> (= temp_4_0~403@ (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@))) (=> (= temp_4_1~420@ (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c4~38@ d4~40@) (=> %%location_label%%4 (= temp_4_0~403@ temp_4_1~420@))) (=> (= temp_4_0~403@ temp_4_1~420@) (=> (= temp_5_0~465@ (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))) (=> (= temp_5_1~482@ (Mul (Mul (Mul b5~44@ d5~48@) c5~46@) b5~44@)) (and (=> (= tmp%6@ (Mul b5~44@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ c5~46@ b5~44@) (=> %%location_label%%5 (= temp_5_0~465@ temp_5_1~482@)))) (=> (= temp_5_0~465@ temp_5_1~482@) (=> (= temp_6_0~533@ (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ b6~52@))) (=> (= temp_6_1~550@ (Mul d6~56@ (Mul b6~52@ (Mul c6~54@ b6~52@)))) (and (=> (= tmp%7@ (Mul c6~54@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d6~56@ b6~52@ tmp%7@) (=> %%location_label%%6 (= temp_6_0~533@ temp_6_1~550@)))) (=> (= temp_6_0~533@ temp_6_1~550@) (=> (= temp_7_0~613@ (Mul (Mul c7~62@ d7~64@) (Add 53 b7~60@))) (=> (= temp_7_1~642@ (Mul c7~62@ (Mul d7~64@ (Add 53 b7~60@)))) (and (=> (= tmp%8@ (Add 53 b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c7~62@ d7~64@ tmp%8@) (=> %%location_label%%7 (= temp_7_0~613@ temp_7_1~642@)))) (=> (= temp_7_0~613@ temp_7_1~642@) (=> (= temp_8_0~705@ (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~722@ (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@))) (=> (= tmp%9@ (Mul d8~72@ a8~66@)) (=> (= tmp%10@ (Mul a8~66@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%8 (= temp_8_0~705@ temp_8_1~722@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
