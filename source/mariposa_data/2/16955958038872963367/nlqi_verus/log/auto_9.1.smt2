...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))) (=> (= temp_1_1~172@ (Mul (Mul (Mul b1~12@ c1~14@) d1~16@) a1~10@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ a2~18@))) (=> (= temp_2_1~230@ (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ b2~20@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~283@ (Mul (Mul c3~30@ 74) (Mul d3~32@ c3~30@))) (=> (= temp_3_1~312@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ 74))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~283@ temp_3_1~312@))) (=> (= temp_3_0~283@ temp_3_1~312@) (=> (= temp_4_0~353@ (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@))) (=> (= temp_4_1~370@ (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~353@ temp_4_1~370@))) (=> (= temp_4_0~353@ temp_4_1~370@) (=> (= temp_5_0~411@ (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))) (=> (= temp_5_1~428@ (Mul (Mul (Mul b5~44@ d5~48@) c5~46@) b5~44@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~411@ temp_5_1~428@))) (=> (= temp_5_0~411@ temp_5_1~428@) (=> (= temp_6_0~469@ (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ b6~52@))) (=> (= temp_6_1~486@ (Mul d6~56@ (Mul b6~52@ (Mul c6~54@ b6~52@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~469@ temp_6_1~486@))) (=> (= temp_6_0~469@ temp_6_1~486@) (=> (= temp_7_0~539@ (Mul (Mul c7~62@ d7~64@) (Add 53 b7~60@))) (=> (= temp_7_1~568@ (Mul c7~62@ (Mul d7~64@ (Add 53 b7~60@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~539@ temp_7_1~568@))) (=> (= temp_7_0~539@ temp_7_1~568@) (=> (= temp_8_0~609@ (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~626@ (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~609@ temp_8_1~626@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
