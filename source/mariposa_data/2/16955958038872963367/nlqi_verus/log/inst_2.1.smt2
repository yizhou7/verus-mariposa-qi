...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ c0~6@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))) (=> (= temp_1_1~176@ (Mul (Mul (Mul b1~12@ c1~14@) d1~16@) a1~10@)) (=> (= tmp%1@ (Mul b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ d1~16@ a1~10@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@)))))))))))))
(assert %%query%%)
(check-sat)
