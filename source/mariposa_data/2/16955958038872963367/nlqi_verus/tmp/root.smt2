...
;; mariposa_data/2//16955958038872963367/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_7_0~480@ Int)
 (declare-const temp_7_1~509@ Int)
 (declare-const temp_8_0~541@ Int)
 (declare-const temp_8_1~558@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@)))
      (=>
       (= temp_0_1~118@ (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@)))
           (=>
            (= temp_1_1~167@ (Mul (Mul (Mul b1~12@ c1~14@) d1~16@) a1~10@))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~199@ (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ a2~18@)))
                (=>
                 (= temp_2_1~216@ (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ b2~20@)))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~260@ (Mul (Mul c3~30@ 74) (Mul d3~32@ c3~30@)))
                     (=>
                      (= temp_3_1~289@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ 74)))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~321@ (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@)))
                          (=>
                           (= temp_4_1~338@ (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ c4~38@)))
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~370@ (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@)))
                               (=>
                                (= temp_5_1~387@ (Mul (Mul (Mul b5~44@ d5~48@) c5~46@) b5~44@))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~419@ (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ b6~52@)))
                                    (=>
                                     (= temp_6_1~436@ (Mul d6~56@ (Mul b6~52@ (Mul c6~54@ b6~52@))))
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~480@ (Mul (Mul c7~62@ d7~64@) (Add 53 b7~60@)))
                                         (=>
                                          (= temp_7_1~509@ (Mul c7~62@ (Mul d7~64@ (Add 53 b7~60@))))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~480@ temp_7_1~509@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~541@ (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@)))
                                              (=>
                                               (= temp_8_1~558@ (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ a8~66@)))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~541@ temp_8_1~558@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
