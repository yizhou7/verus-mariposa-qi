...
;; mariposa_data/2//15301622446142432283/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_6_0~415@ Int)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@)))
      (=>
       (= temp_0_1~118@ (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Mul (Mul d1~16@ c1~14@) (Add d1~16@ c1~14@)))
           (=>
            (= temp_1_1~175@ (Add (Mul (Mul d1~16@ c1~14@) d1~16@) (Mul (Mul d1~16@ c1~14@) c1~14@)))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~207@ (Add (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@)))
                (=>
                 (= temp_2_1~224@ (Add (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@)))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~256@ (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@)))
                     (=>
                      (= temp_3_1~273@ (Mul (Mul (Mul d3~32@ a3~26@) a3~26@) c3~30@))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~305@ (Add (Sub c4~38@ d4~40@) (Mul a4~34@ c4~38@)))
                          (=>
                           (= temp_4_1~322@ (Add (Sub c4~38@ d4~40@) (Mul c4~38@ a4~34@)))
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~354@ (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ d5~48@)))
                               (=>
                                (= temp_5_1~371@ (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ d5~48@)))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~415@ (Mul (Mul a6~50@ a6~50@) (Mul 26 a6~50@)))
                                    (=>
                                     (= temp_6_1~444@ (Mul (Mul a6~50@ a6~50@) (Mul 26 a6~50@)))
                                     (=>
                                      (= tmp%7@ (= temp_6_0~415@ temp_6_1~444@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~476@ (Add (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@)))
                                         (=>
                                          (= temp_7_1~493@ (Add (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@)))
                                          (=>
                                           ...
                                           (and
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~525@ (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ c8~70@)))
                                              (=>
                                               (= temp_8_1~542@ (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ a8~66@)))
                                               (=>
