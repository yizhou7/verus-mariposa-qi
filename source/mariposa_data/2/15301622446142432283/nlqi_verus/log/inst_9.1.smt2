...
(declare-const temp_6_1~538@ Int)
(declare-const temp_7_0~583@ Int)
(declare-const temp_7_1~600@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ b0~4@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul d1~16@ c1~14@) (Add d1~16@ c1~14@))) (=> (= temp_1_1~184@ (Add (Mul (Mul d1~16@ c1~14@) d1~16@) (Mul (Mul d1~16@ c1~14@) c1~14@))) (and (=> (= tmp%1@ (Mul d1~16@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~184@)))) (=> (= temp_1_0~159@ temp_1_1~184@) (=> (= temp_2_0~235@ (Add (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@))) (=> (= temp_2_1~252@ (Add (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ a2~18@) (=> %%location_label%%2 (= temp_2_0~235@ temp_2_1~252@))) (=> (= temp_2_0~235@ temp_2_1~252@) (=> (= temp_3_0~297@ (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@))) (=> (= temp_3_1~314@ (Mul (Mul (Mul d3~32@ a3~26@) a3~26@) c3~30@)) (and (=> (= tmp%2@ (Mul d3~32@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ a3~26@ c3~30@) (=> %%location_label%%3 (= temp_3_0~297@ temp_3_1~314@)))) (=> (= temp_3_0~297@ temp_3_1~314@) (=> (= temp_4_0~365@ (Add (Sub c4~38@ d4~40@) (Mul a4~34@ c4~38@))) (=> (= temp_4_1~382@ (Add (Sub c4~38@ d4~40@) (Mul c4~38@ a4~34@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ c4~38@) (=> %%location_label%%4 (= temp_4_0~365@ temp_4_1~382@))) (=> (= temp_4_0~365@ temp_4_1~382@) (=> (= temp_5_0~427@ (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ d5~48@))) (=> (= temp_5_1~444@ (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ d5~48@))) (and (=> (= tmp%3@ (Mul d5~48@ d5~48@)) (=> (= tmp%4@ (Mul d5~48@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%5 (= temp_5_0~427@ temp_5_1~444@))))) (=> (= temp_5_0~427@ temp_5_1~444@) (=> (= temp_6_0~509@ (Mul (Mul a6~50@ a6~50@) (Mul 26 a6~50@))) (=> (= temp_6_1~538@ (Mul (Mul a6~50@ a6~50@) (Mul 26 a6~50@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ a6~50@) (=> %%location_label%%6 (= temp_6_0~509@ temp_6_1~538@))) (=> (= temp_6_0~509@ temp_6_1~538@) (=> (= temp_7_0~583@ (Add (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@))) (=> (= temp_7_1~600@ (Add (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ c7~62@) (=> %%location_label%%7 (= temp_7_0~583@ temp_7_1~600@))) (=> (= temp_7_0~583@ temp_7_1~600@) (=> (= temp_8_0~645@ (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ c8~70@))) (=> (= temp_8_1~662@ (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ c8~70@) (=> %%location_label%%8 (= temp_8_0~645@ temp_8_1~662@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
