...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Mul d1~16@ c1~14@) (Add d1~16@ c1~14@))) (=> (= temp_1_1~171@ (Add (Mul (Mul d1~16@ c1~14@) d1~16@) (Mul (Mul d1~16@ c1~14@) c1~14@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~171@)) (=> %%location_label%%1 tmp%2@))))))))))))
(assert %%query%%)
(check-sat)
