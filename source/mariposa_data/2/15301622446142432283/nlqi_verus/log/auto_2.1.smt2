...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul d1~16@ c1~14@) (Add d1~16@ c1~14@))) (=> (= temp_1_1~180@ (Add (Mul (Mul d1~16@ c1~14@) d1~16@) (Mul (Mul d1~16@ c1~14@) c1~14@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~180@))))))))))))
(assert %%query%%)
(check-sat)
