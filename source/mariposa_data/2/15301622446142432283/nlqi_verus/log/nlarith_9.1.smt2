...
(declare-const temp_4_1~318@ Int)
(declare-const temp_5_0~350@ Int)
(declare-const temp_5_1~367@ Int)
(declare-const temp_6_0~411@ Int)
(declare-const temp_6_1~440@ Int)
(declare-const temp_7_0~472@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Mul d1~16@ c1~14@) (Add d1~16@ c1~14@))) (=> (= temp_1_1~171@ (Add (Mul (Mul d1~16@ c1~14@) d1~16@) (Mul (Mul d1~16@ c1~14@) c1~14@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~171@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~203@ (Add (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@))) (=> (= temp_2_1~220@ (Add (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@))) (=> (= tmp%3@ (= temp_2_0~203@ temp_2_1~220@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~252@ (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@))) (=> (= temp_3_1~269@ (Mul (Mul (Mul d3~32@ a3~26@) a3~26@) c3~30@)) (=> (= tmp%4@ (= temp_3_0~252@ temp_3_1~269@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~301@ (Add (Sub c4~38@ d4~40@) (Mul a4~34@ c4~38@))) (=> (= temp_4_1~318@ (Add (Sub c4~38@ d4~40@) (Mul c4~38@ a4~34@))) (=> (= tmp%5@ (= temp_4_0~301@ temp_4_1~318@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~350@ (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ d5~48@))) (=> (= temp_5_1~367@ (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~350@ temp_5_1~367@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~411@ (Mul (Mul a6~50@ a6~50@) (Mul 26 a6~50@))) (=> (= temp_6_1~440@ (Mul (Mul a6~50@ a6~50@) (Mul 26 a6~50@))) (=> (= tmp%7@ (= temp_6_0~411@ temp_6_1~440@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~472@ (Add (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@))) (=> (= temp_7_1~489@ (Add (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@))) (=> (= tmp%8@ (= temp_7_0~472@ temp_7_1~489@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~521@ (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ c8~70@))) (=> (= temp_8_1~538@ (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ a8~66@))) (=> (= tmp%9@ (= temp_8_0~521@ temp_8_1~538@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
