...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ b0~4@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul d1~16@ c1~14@) (Add d1~16@ c1~14@))) (=> (= temp_1_1~184@ (Add (Mul (Mul d1~16@ c1~14@) d1~16@) (Mul (Mul d1~16@ c1~14@) c1~14@))) (=> (= tmp%1@ (Mul d1~16@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~184@)))))))))))))
(assert %%query%%)
(check-sat)
