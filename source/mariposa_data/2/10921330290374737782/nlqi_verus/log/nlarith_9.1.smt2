...
(declare-const temp_2_0~231@ Int)
(declare-const temp_2_1~260@ Int)
(declare-const temp_3_0~292@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~158@ (Mul (Mul a1~10@ a1~10@) (Mul 8 c1~14@))) (=> (= temp_1_1~187@ (Mul (Mul 8 c1~14@) (Mul a1~10@ a1~10@))) (=> (= tmp%2@ (= temp_1_0~158@ temp_1_1~187@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~231@ (Mul (Add 25 c2~22@) (Mul a2~18@ b2~20@))) (=> (= temp_2_1~260@ (Mul (Mul (Add 25 c2~22@) a2~18@) b2~20@)) (=> (= tmp%3@ (= temp_2_0~231@ temp_2_1~260@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~292@ (Add (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (=> (= temp_3_1~309@ (Add (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (=> (= tmp%4@ (= temp_3_0~292@ temp_3_1~309@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~341@ (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (=> (= temp_4_1~358@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@))) (=> (= tmp%5@ (= temp_4_0~341@ temp_4_1~358@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~390@ (Mul (Add d5~48@ b5~44@) (Mul b5~44@ b5~44@))) (=> (= temp_5_1~407@ (Mul (Mul b5~44@ b5~44@) (Add d5~48@ b5~44@))) (=> (= tmp%6@ (= temp_5_0~390@ temp_5_1~407@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~439@ (Mul (Mul d6~56@ d6~56@) (Add b6~52@ a6~50@))) (=> (= temp_6_1~456@ (Mul d6~56@ (Mul d6~56@ (Add b6~52@ a6~50@)))) (=> (= tmp%7@ (= temp_6_0~439@ temp_6_1~456@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~488@ (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@))) (=> (= temp_7_1~505@ (Mul b7~60@ (Mul c7~62@ (Mul a7~58@ b7~60@)))) (=> (= tmp%8@ (= temp_7_0~488@ temp_7_1~505@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~549@ (Add (Mul a8~66@ c8~70@) (Add 5 c8~70@))) (=> (= temp_8_1~578@ (Add (Mul c8~70@ a8~66@) (Add 5 c8~70@))) (=> (= tmp%9@ (= temp_8_0~549@ temp_8_1~578@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
