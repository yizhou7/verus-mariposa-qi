...
(set-info :comment ";; mariposa_data/2//10921330290374737782/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_2_0~285@ Int)
(declare-const temp_2_1~314@ Int)
(declare-const temp_3_0~377@ Int)
(declare-const temp_3_1~394@ Int)
(declare-const temp_4_0~439@ Int)
(declare-const temp_4_1~456@ Int)
(declare-const temp_5_0~501@ Int)
(declare-const temp_5_1~518@ Int)
(declare-const temp_6_0~571@ Int)
(declare-const temp_6_1~588@ Int)
(declare-const temp_7_0~639@ Int)
(declare-const temp_7_1~656@ Int)
(declare-const temp_8_0~719@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@))) (and (=> (= tmp%1@ (Mul b0~4@ d0~8@)) (=> (= tmp%2@ (Mul d0~8@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~179@ (Mul (Mul a1~10@ a1~10@) (Mul 8 c1~14@))) (=> (= temp_1_1~208@ (Mul (Mul 8 c1~14@) (Mul a1~10@ a1~10@))) (and (=> (= tmp%3@ (Mul a1~10@ a1~10@)) (=> (= tmp%4@ (Mul 8 c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~179@ temp_1_1~208@))))) (=> (= temp_1_0~179@ temp_1_1~208@) (=> (= temp_2_0~285@ (Mul (Add 25 c2~22@) (Mul a2~18@ b2~20@))) (=> (= temp_2_1~314@ (Mul (Mul (Add 25 c2~22@) a2~18@) b2~20@)) (and (=> (= tmp%5@ (Add 25 c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ a2~18@ b2~20@) (=> %%location_label%%2 (= temp_2_0~285@ temp_2_1~314@)))) (=> (= temp_2_0~285@ temp_2_1~314@) (=> (= temp_3_0~377@ (Add (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (=> (= temp_3_1~394@ (Add (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ b3~28@) (=> %%location_label%%3 (= temp_3_0~377@ temp_3_1~394@))) (=> (= temp_3_0~377@ temp_3_1~394@) (=> (= temp_4_0~439@ (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (=> (= temp_4_1~456@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ a4~34@) (=> %%location_label%%4 (= temp_4_0~439@ temp_4_1~456@))) (=> (= temp_4_0~439@ temp_4_1~456@) (=> (= temp_5_0~501@ (Mul (Add d5~48@ b5~44@) (Mul b5~44@ b5~44@))) (=> (= temp_5_1~518@ (Mul (Mul b5~44@ b5~44@) (Add d5~48@ b5~44@))) (and (=> (= tmp%6@ (Add d5~48@ b5~44@)) (=> (= tmp%7@ (Mul b5~44@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%5 (= temp_5_0~501@ temp_5_1~518@))))) (=> (= temp_5_0~501@ temp_5_1~518@) (=> (= temp_6_0~571@ (Mul (Mul d6~56@ d6~56@) (Add b6~52@ a6~50@))) (=> (= temp_6_1~588@ (Mul d6~56@ (Mul d6~56@ (Add b6~52@ a6~50@)))) (and (=> (= tmp%8@ (Add b6~52@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d6~56@ d6~56@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~571@ temp_6_1~588@)))) (=> (= temp_6_0~571@ temp_6_1~588@) (=> (= temp_7_0~639@ (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@))) (=> (= temp_7_1~656@ (Mul b7~60@ (Mul c7~62@ (Mul a7~58@ b7~60@)))) (and (=> (= tmp%9@ (Mul a7~58@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b7~60@ c7~62@ tmp%9@) (=> %%location_label%%7 (= temp_7_0~639@ temp_7_1~656@)))) (=> (= temp_7_0~639@ temp_7_1~656@) (=> (= temp_8_0~719@ (Add (Mul a8~66@ c8~70@) (Add 5 c8~70@))) (=> (= temp_8_1~748@ (Add (Mul c8~70@ a8~66@) (Add 5 c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ c8~70@) (=> %%location_label%%8 (= temp_8_0~719@ temp_8_1~748@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
