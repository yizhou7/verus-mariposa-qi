...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@))) (and (=> (= tmp%1@ (Mul b0~4@ d0~8@)) (=> (= tmp%2@ (Mul d0~8@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~179@ (Mul (Mul a1~10@ a1~10@) (Mul 8 c1~14@))) (=> (= temp_1_1~208@ (Mul (Mul 8 c1~14@) (Mul a1~10@ a1~10@))) (=> (= tmp%3@ (Mul a1~10@ a1~10@)) (=> (= tmp%4@ (Mul 8 c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~179@ temp_1_1~208@))))))))))))))
(assert %%query%%)
(check-sat)
