...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@))) (=> (= temp_0_1~118@ (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~162@ (Mul (Mul a1~10@ a1~10@) (Mul 8 c1~14@))) (=> (= temp_1_1~191@ (Mul (Mul 8 c1~14@) (Mul a1~10@ a1~10@))) (=> (= tmp%2@ (= temp_1_0~162@ temp_1_1~191@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~235@ (Mul (Add 25 c2~22@) (Mul a2~18@ b2~20@))) (=> (= temp_2_1~264@ (Mul (Mul (Add 25 c2~22@) a2~18@) b2~20@)) (=> (= tmp%3@ (= temp_2_0~235@ temp_2_1~264@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~296@ (Add (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (=> (= temp_3_1~313@ (Add (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (=> (= tmp%4@ (= temp_3_0~296@ temp_3_1~313@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~345@ (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (=> (= temp_4_1~362@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@))) (=> (= tmp%5@ (= temp_4_0~345@ temp_4_1~362@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~394@ (Mul (Add d5~48@ b5~44@) (Mul b5~44@ b5~44@))) (=> (= temp_5_1~411@ (Mul (Mul b5~44@ b5~44@) (Add d5~48@ b5~44@))) (=> (= tmp%6@ (= temp_5_0~394@ temp_5_1~411@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~443@ (Mul (Mul d6~56@ d6~56@) (Add b6~52@ a6~50@))) (=> (= temp_6_1~460@ (Mul d6~56@ (Mul d6~56@ (Add b6~52@ a6~50@)))) (=> (= tmp%7@ (= temp_6_0~443@ temp_6_1~460@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~492@ (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@))) (=> (= temp_7_1~509@ (Mul b7~60@ (Mul c7~62@ (Mul a7~58@ b7~60@)))) (=> (= tmp%8@ (= temp_7_0~492@ temp_7_1~509@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~553@ (Add (Mul a8~66@ c8~70@) (Add 5 c8~70@))) (=> (= temp_8_1~582@ (Add (Mul c8~70@ a8~66@) (Add 5 c8~70@))) (=> (= tmp%9@ (= temp_8_0~553@ temp_8_1~582@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
