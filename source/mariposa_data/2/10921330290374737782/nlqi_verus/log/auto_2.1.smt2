...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Mul a1~10@ a1~10@) (Mul 8 c1~14@))) (=> (= temp_1_1~196@ (Mul (Mul 8 c1~14@) (Mul a1~10@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~196@))))))))))))
(assert %%query%%)
(check-sat)
