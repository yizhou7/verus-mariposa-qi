...
(declare-const temp_2_0~249@ Int)
(declare-const temp_2_1~278@ Int)
(declare-const temp_3_0~319@ Int)
...
(declare-const temp_8_0~621@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Mul a1~10@ a1~10@) (Mul 8 c1~14@))) (=> (= temp_1_1~196@ (Mul (Mul 8 c1~14@) (Mul a1~10@ a1~10@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~196@))) (=> (= temp_1_0~167@ temp_1_1~196@) (=> (= temp_2_0~249@ (Mul (Add 25 c2~22@) (Mul a2~18@ b2~20@))) (=> (= temp_2_1~278@ (Mul (Mul (Add 25 c2~22@) a2~18@) b2~20@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~249@ temp_2_1~278@))) (=> (= temp_2_0~249@ temp_2_1~278@) (=> (= temp_3_0~319@ (Add (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (=> (= temp_3_1~336@ (Add (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~319@ temp_3_1~336@))) (=> (= temp_3_0~319@ temp_3_1~336@) (=> (= temp_4_0~377@ (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (=> (= temp_4_1~394@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~377@ temp_4_1~394@))) (=> (= temp_4_0~377@ temp_4_1~394@) (=> (= temp_5_0~435@ (Mul (Add d5~48@ b5~44@) (Mul b5~44@ b5~44@))) (=> (= temp_5_1~452@ (Mul (Mul b5~44@ b5~44@) (Add d5~48@ b5~44@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~435@ temp_5_1~452@))) (=> (= temp_5_0~435@ temp_5_1~452@) (=> (= temp_6_0~493@ (Mul (Mul d6~56@ d6~56@) (Add b6~52@ a6~50@))) (=> (= temp_6_1~510@ (Mul d6~56@ (Mul d6~56@ (Add b6~52@ a6~50@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~493@ temp_6_1~510@))) (=> (= temp_6_0~493@ temp_6_1~510@) (=> (= temp_7_0~551@ (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@))) (=> (= temp_7_1~568@ (Mul b7~60@ (Mul c7~62@ (Mul a7~58@ b7~60@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~551@ temp_7_1~568@))) (=> (= temp_7_0~551@ temp_7_1~568@) (=> (= temp_8_0~621@ (Add (Mul a8~66@ c8~70@) (Add 5 c8~70@))) (=> (= temp_8_1~650@ (Add (Mul c8~70@ a8~66@) (Add 5 c8~70@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~621@ temp_8_1~650@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
