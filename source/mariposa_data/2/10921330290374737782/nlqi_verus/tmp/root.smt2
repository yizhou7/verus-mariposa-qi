...
;; mariposa_data/2//10921330290374737782/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_2_0~235@ Int)
 (declare-const temp_2_1~264@ Int)
 (declare-const temp_3_0~296@ Int)
 ...
 (declare-const temp_8_0~553@ Int)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@)))
      (=>
       (= temp_0_1~118@ (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~162@ (Mul (Mul a1~10@ a1~10@) (Mul 8 c1~14@)))
           (=>
            (= temp_1_1~191@ (Mul (Mul 8 c1~14@) (Mul a1~10@ a1~10@)))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~235@ (Mul (Add 25 c2~22@) (Mul a2~18@ b2~20@)))
                (=>
                 (= temp_2_1~264@ (Mul (Mul (Add 25 c2~22@) a2~18@) b2~20@))
                 (=>
                  (= tmp%3@ (= temp_2_0~235@ temp_2_1~264@))
                  (and
                   (=>
                    %%location_label%%2
                    tmp%3@
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~296@ (Add (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@)))
                     (=>
                      (= temp_3_1~313@ (Add (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@)))
                      (=>
                       (= tmp%4@ (= temp_3_0~296@ temp_3_1~313@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~345@ (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@)))
                          (=>
                           (= temp_4_1~362@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@)))
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~394@ (Mul (Add d5~48@ b5~44@) (Mul b5~44@ b5~44@)))
                               (=>
                                (= temp_5_1~411@ (Mul (Mul b5~44@ b5~44@) (Add d5~48@ b5~44@)))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~443@ (Mul (Mul d6~56@ d6~56@) (Add b6~52@ a6~50@)))
                                    (=>
                                     (= temp_6_1~460@ (Mul d6~56@ (Mul d6~56@ (Add b6~52@ a6~50@))))
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~492@ (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@)))
                                         (=>
                                          (= temp_7_1~509@ (Mul b7~60@ (Mul c7~62@ (Mul a7~58@ b7~60@))))
                                          (=>
                                           ...
                                           (and
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~553@ (Add (Mul a8~66@ c8~70@) (Add 5 c8~70@)))
                                              (=>
                                               (= temp_8_1~582@ (Add (Mul c8~70@ a8~66@) (Add 5 c8~70@)))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~553@ temp_8_1~582@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
