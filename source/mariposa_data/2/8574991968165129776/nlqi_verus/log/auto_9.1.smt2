...
(declare-const temp_6_0~453@ Int)
(declare-const temp_6_1~470@ Int)
(declare-const temp_7_0~511@ Int)
(declare-const temp_7_1~528@ Int)
(declare-const temp_8_0~569@ Int)
(declare-const temp_8_1~586@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ a0~2@) (Sub b0~4@ c0~6@))) (=> (= temp_0_1~122@ (Sub (Mul (Mul a0~2@ a0~2@) b0~4@) (Mul (Mul a0~2@ a0~2@) c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@))) (=> (= temp_0_0~97@ temp_0_1~122@) (=> (= temp_1_0~163@ (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ b1~12@))) (=> (= temp_1_1~180@ (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ d1~16@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~163@ temp_1_1~180@))) (=> (= temp_1_0~163@ temp_1_1~180@) (=> (= temp_2_0~221@ (Add (Mul c2~22@ a2~18@) (Mul c2~22@ d2~24@))) (=> (= temp_2_1~238@ (Add (Mul c2~22@ a2~18@) (Mul d2~24@ c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~221@ temp_2_1~238@))) (=> (= temp_2_0~221@ temp_2_1~238@) (=> (= temp_3_0~279@ (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~296@ (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ c3~30@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~279@ temp_3_1~296@))) (=> (= temp_3_0~279@ temp_3_1~296@) (=> (= temp_4_0~337@ (Mul (Mul d4~40@ c4~38@) (Sub d4~40@ d4~40@))) (=> (= temp_4_1~354@ (Mul d4~40@ (Mul c4~38@ (Sub d4~40@ d4~40@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~337@ temp_4_1~354@))) (=> (= temp_4_0~337@ temp_4_1~354@) (=> (= temp_5_0~395@ (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ a5~42@))) (=> (= temp_5_1~412@ (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~395@ temp_5_1~412@))) (=> (= temp_5_0~395@ temp_5_1~412@) (=> (= temp_6_0~453@ (Sub (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@))) (=> (= temp_6_1~470@ (Sub (Mul b6~52@ b6~52@) (Mul c6~54@ a6~50@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~453@ temp_6_1~470@))) (=> (= temp_6_0~453@ temp_6_1~470@) (=> (= temp_7_0~511@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (=> (= temp_7_1~528@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~511@ temp_7_1~528@))) (=> (= temp_7_0~511@ temp_7_1~528@) (=> (= temp_8_0~569@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@))) (=> (= temp_8_1~586@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~569@ temp_8_1~586@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
