...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ a0~2@) (Sub b0~4@ c0~6@))) (=> (= temp_0_1~122@ (Sub (Mul (Mul a0~2@ a0~2@) b0~4@) (Mul (Mul a0~2@ a0~2@) c0~6@))) (and (=> (= tmp%1@ (Mul a0~2@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ b0~4@ c0~6@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@)))) (=> (= temp_0_0~97@ temp_0_1~122@) (=> (= temp_1_0~173@ (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ b1~12@))) (=> (= temp_1_1~190@ (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ d1~16@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ b1~12@) (=> %%location_label%%1 (= temp_1_0~173@ temp_1_1~190@))))))))))))
(assert %%query%%)
(check-sat)
