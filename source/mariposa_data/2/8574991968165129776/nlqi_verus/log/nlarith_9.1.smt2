...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ a0~2@) (Sub b0~4@ c0~6@))) (=> (= temp_0_1~122@ (Sub (Mul (Mul a0~2@ a0~2@) b0~4@) (Mul (Mul a0~2@ a0~2@) c0~6@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~122@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~154@ (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ b1~12@))) (=> (= temp_1_1~171@ (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ d1~16@))) (=> (= tmp%2@ (= temp_1_0~154@ temp_1_1~171@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~203@ (Add (Mul c2~22@ a2~18@) (Mul c2~22@ d2~24@))) (=> (= temp_2_1~220@ (Add (Mul c2~22@ a2~18@) (Mul d2~24@ c2~22@))) (=> (= tmp%3@ (= temp_2_0~203@ temp_2_1~220@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~252@ (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~269@ (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ c3~30@))) (=> (= tmp%4@ (= temp_3_0~252@ temp_3_1~269@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~301@ (Mul (Mul d4~40@ c4~38@) (Sub d4~40@ d4~40@))) (=> (= temp_4_1~318@ (Mul d4~40@ (Mul c4~38@ (Sub d4~40@ d4~40@)))) (=> (= tmp%5@ (= temp_4_0~301@ temp_4_1~318@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~350@ (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ a5~42@))) (=> (= temp_5_1~367@ (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~350@ temp_5_1~367@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~399@ (Sub (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@))) (=> (= temp_6_1~416@ (Sub (Mul b6~52@ b6~52@) (Mul c6~54@ a6~50@))) (=> (= tmp%7@ (= temp_6_0~399@ temp_6_1~416@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~448@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (=> (= temp_7_1~465@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (=> (= tmp%8@ (= temp_7_0~448@ temp_7_1~465@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~497@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@))) (=> (= temp_8_1~514@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@))) (=> (= tmp%9@ (= temp_8_0~497@ temp_8_1~514@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
