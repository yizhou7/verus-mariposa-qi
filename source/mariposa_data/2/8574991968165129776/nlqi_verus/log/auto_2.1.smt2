...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ a0~2@) (Sub b0~4@ c0~6@))) (=> (= temp_0_1~122@ (Sub (Mul (Mul a0~2@ a0~2@) b0~4@) (Mul (Mul a0~2@ a0~2@) c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@))) (=> (= temp_0_0~97@ temp_0_1~122@) (=> (= temp_1_0~163@ (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ b1~12@))) (=> (= temp_1_1~180@ (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ d1~16@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~163@ temp_1_1~180@))))))))))))
(assert %%query%%)
(check-sat)
