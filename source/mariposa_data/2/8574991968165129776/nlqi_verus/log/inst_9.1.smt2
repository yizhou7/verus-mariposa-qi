...
(set-info :comment ";; mariposa_data/2//8574991968165129776/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~173@ Int)
(declare-const temp_1_1~190@ Int)
...
(declare-const temp_5_0~435@ Int)
(declare-const temp_5_1~452@ Int)
(declare-const temp_6_0~505@ Int)
(declare-const temp_6_1~522@ Int)
(declare-const temp_7_0~567@ Int)
(declare-const temp_7_1~584@ Int)
(declare-const temp_8_0~629@ Int)
(declare-const temp_8_1~646@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ a0~2@) (Sub b0~4@ c0~6@))) (=> (= temp_0_1~122@ (Sub (Mul (Mul a0~2@ a0~2@) b0~4@) (Mul (Mul a0~2@ a0~2@) c0~6@))) (and (=> (= tmp%1@ (Mul a0~2@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ b0~4@ c0~6@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@)))) (=> (= temp_0_0~97@ temp_0_1~122@) (=> (= temp_1_0~173@ (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ b1~12@))) (=> (= temp_1_1~190@ (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ d1~16@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ b1~12@) (=> %%location_label%%1 (= temp_1_0~173@ temp_1_1~190@))) (=> (= temp_1_0~173@ temp_1_1~190@) (=> (= temp_2_0~235@ (Add (Mul c2~22@ a2~18@) (Mul c2~22@ d2~24@))) (=> (= temp_2_1~252@ (Add (Mul c2~22@ a2~18@) (Mul d2~24@ c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ d2~24@) (=> %%location_label%%2 (= temp_2_0~235@ temp_2_1~252@))) (=> (= temp_2_0~235@ temp_2_1~252@) (=> (= temp_3_0~297@ (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~314@ (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ c3~30@))) (and (=> (= tmp%2@ (Mul a3~26@ c3~30@)) (=> (= tmp%3@ (Mul a3~26@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~297@ temp_3_1~314@))))) (=> (= temp_3_0~297@ temp_3_1~314@) (=> (= temp_4_0~367@ (Mul (Mul d4~40@ c4~38@) (Sub d4~40@ d4~40@))) (=> (= temp_4_1~384@ (Mul d4~40@ (Mul c4~38@ (Sub d4~40@ d4~40@)))) (and (=> (= tmp%4@ (Sub d4~40@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d4~40@ c4~38@ tmp%4@) (=> %%location_label%%4 (= temp_4_0~367@ temp_4_1~384@)))) (=> (= temp_4_0~367@ temp_4_1~384@) (=> (= temp_5_0~435@ (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ a5~42@))) (=> (= temp_5_1~452@ (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))) (and (=> (= tmp%5@ (Mul d5~48@ d5~48@)) (=> (= tmp%6@ (Mul b5~44@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~435@ temp_5_1~452@))))) (=> (= temp_5_0~435@ temp_5_1~452@) (=> (= temp_6_0~505@ (Sub (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@))) (=> (= temp_6_1~522@ (Sub (Mul b6~52@ b6~52@) (Mul c6~54@ a6~50@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ c6~54@) (=> %%location_label%%6 (= temp_6_0~505@ temp_6_1~522@))) (=> (= temp_6_0~505@ temp_6_1~522@) (=> (= temp_7_0~567@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (=> (= temp_7_1~584@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ d7~64@) (=> %%location_label%%7 (= temp_7_0~567@ temp_7_1~584@))) (=> (= temp_7_0~567@ temp_7_1~584@) (=> (= temp_8_0~629@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@))) (=> (= temp_8_1~646@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d8~72@ d8~72@) (=> %%location_label%%8 (= temp_8_0~629@ temp_8_1~646@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
