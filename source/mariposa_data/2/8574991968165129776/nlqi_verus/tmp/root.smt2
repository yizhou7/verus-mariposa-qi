...
;; mariposa_data/2//8574991968165129776/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_6_1~420@ Int)
 (declare-const temp_7_0~452@ Int)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul a0~2@ a0~2@) (Sub b0~4@ c0~6@)))
      (=>
       (= temp_0_1~126@ (Sub (Mul (Mul a0~2@ a0~2@) b0~4@) (Mul (Mul a0~2@ a0~2@) c0~6@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~158@ (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ b1~12@)))
           (=>
            (= temp_1_1~175@ (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ d1~16@)))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~207@ (Add (Mul c2~22@ a2~18@) (Mul c2~22@ d2~24@)))
                (=>
                 (= temp_2_1~224@ (Add (Mul c2~22@ a2~18@) (Mul d2~24@ c2~22@)))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      (= temp_3_1~273@ (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ c3~30@)))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~305@ (Mul (Mul d4~40@ c4~38@) (Sub d4~40@ d4~40@)))
                          (=>
                           (= temp_4_1~322@ (Mul d4~40@ (Mul c4~38@ (Sub d4~40@ d4~40@))))
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~354@ (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ a5~42@)))
                               (=>
                                (= temp_5_1~371@ (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@)))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~403@ (Sub (Mul b6~52@ b6~52@) (Mul a6~50@ c6~54@)))
                                    (=>
                                     (= temp_6_1~420@ (Sub (Mul b6~52@ b6~52@) (Mul c6~54@ a6~50@)))
                                     (=>
                                      (= tmp%7@ (= temp_6_0~403@ temp_6_1~420@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~452@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@)))
                                         (=>
                                          (= temp_7_1~469@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@)))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~452@ temp_7_1~469@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~501@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@)))
                                              (=>
                                               (= temp_8_1~518@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@)))
                                               (=>
