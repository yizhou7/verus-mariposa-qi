...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub d0~8@ b0~4@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul (Sub d0~8@ b0~4@) c0~6@) b0~4@)) (=> (= tmp%1@ (Sub d0~8@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@)))))))))
(assert %%query%%)
(check-sat)
