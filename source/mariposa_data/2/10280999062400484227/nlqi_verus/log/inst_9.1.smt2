...
(set-info :comment ";; mariposa_data/2//10280999062400484227/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~177@ Int)
(declare-const temp_1_1~206@ Int)
(declare-const temp_2_0~267@ Int)
(declare-const temp_2_1~280@ Int)
(declare-const temp_3_0~327@ Int)
(declare-const temp_3_1~344@ Int)
(declare-const temp_4_0~389@ Int)
(declare-const temp_4_1~414@ Int)
(declare-const temp_5_0~465@ Int)
(declare-const temp_5_1~482@ Int)
(declare-const temp_6_0~527@ Int)
(declare-const temp_6_1~544@ Int)
(declare-const temp_7_0~595@ Int)
(declare-const temp_7_1~612@ Int)
(declare-const temp_8_0~657@ Int)
(declare-const temp_8_1~674@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub d0~8@ b0~4@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul (Sub d0~8@ b0~4@) c0~6@) b0~4@)) (and (=> (= tmp%1@ (Sub d0~8@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@)))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~177@ (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ 89))) (=> (= temp_1_1~206@ (Mul (Mul b1~12@ 89) (Mul a1~10@ a1~10@))) (and (=> (= tmp%2@ (Mul a1~10@ a1~10@)) (=> (= tmp%3@ (Mul b1~12@ 89)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~177@ temp_1_1~206@))))) (=> (= temp_1_0~177@ temp_1_1~206@) (=> (= temp_2_0~267@ (Mul a2~18@ (Mul b2~20@ d2~24@))) (=> (= temp_2_1~280@ (Mul (Mul a2~18@ b2~20@) d2~24@)) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a2~18@ b2~20@ d2~24@) (=> %%location_label%%2 (= temp_2_0~267@ temp_2_1~280@))) (=> (= temp_2_0~267@ temp_2_1~280@) (=> (= temp_3_0~327@ (Sub (Mul c3~30@ d3~32@) (Mul c3~30@ b3~28@))) (=> (= temp_3_1~344@ (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ b3~28@) (=> %%location_label%%3 (= temp_3_0~327@ temp_3_1~344@))) (=> (= temp_3_0~327@ temp_3_1~344@) (=> (= temp_4_0~389@ (Mul (Sub a4~34@ a4~34@) (Mul b4~36@ b4~36@))) (=> (= temp_4_1~414@ (Sub (Mul a4~34@ (Mul b4~36@ b4~36@)) (Mul a4~34@ (Mul b4~36@ b4~36@)))) (and (=> (= tmp%4@ (Mul b4~36@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a4~34@ a4~34@ tmp%4@) (=> %%location_label%%4 (= temp_4_0~389@ temp_4_1~414@)))) (=> (= temp_4_0~389@ temp_4_1~414@) (=> (= temp_5_0~465@ (Sub (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~482@ (Sub (Mul b5~44@ a5~42@) (Mul b5~44@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ b5~44@) (=> %%location_label%%5 (= temp_5_0~465@ temp_5_1~482@))) (=> (= temp_5_0~465@ temp_5_1~482@) (=> (= temp_6_0~527@ (Mul (Add a6~50@ b6~52@) (Mul d6~56@ d6~56@))) (=> (= temp_6_1~544@ (Mul (Mul (Add a6~50@ b6~52@) d6~56@) d6~56@)) (and (=> (= tmp%5@ (Add a6~50@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ d6~56@ d6~56@) (=> %%location_label%%6 (= temp_6_0~527@ temp_6_1~544@)))) (=> (= temp_6_0~527@ temp_6_1~544@) (=> (= temp_7_0~595@ (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~612@ (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ c7~62@) (=> %%location_label%%7 (= temp_7_0~595@ temp_7_1~612@))) (=> (= temp_7_0~595@ temp_7_1~612@) (=> (= temp_8_0~657@ (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~674@ (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ d8~72@) (=> %%location_label%%8 (= temp_8_0~657@ temp_8_1~674@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
