...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub d0~8@ b0~4@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul (Sub d0~8@ b0~4@) c0~6@) b0~4@)) (and (=> (= tmp%1@ (Sub d0~8@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@)))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~177@ (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ 89))) (=> (= temp_1_1~206@ (Mul (Mul b1~12@ 89) (Mul a1~10@ a1~10@))) (and (=> (= tmp%2@ (Mul a1~10@ a1~10@)) (=> (= tmp%3@ (Mul b1~12@ 89)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~177@ temp_1_1~206@))))) (=> (= temp_1_0~177@ temp_1_1~206@) (=> (= temp_2_0~267@ (Mul a2~18@ (Mul b2~20@ d2~24@))) (=> (= temp_2_1~280@ (Mul (Mul a2~18@ b2~20@) d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a2~18@ b2~20@ d2~24@) (=> %%location_label%%2 (= temp_2_0~267@ temp_2_1~280@))))))))))))))))
(assert %%query%%)
(check-sat)
