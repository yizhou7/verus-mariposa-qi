...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub d0~8@ b0~4@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul (Sub d0~8@ b0~4@) c0~6@) b0~4@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ 89))) (=> (= temp_1_1~196@ (Mul (Mul b1~12@ 89) (Mul a1~10@ a1~10@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~196@))) (=> (= temp_1_0~167@ temp_1_1~196@) (=> (= temp_2_0~233@ (Mul a2~18@ (Mul b2~20@ d2~24@))) (=> (= temp_2_1~246@ (Mul (Mul a2~18@ b2~20@) d2~24@)) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~233@ temp_2_1~246@))))))))))))))))
(assert %%query%%)
(check-sat)
