...
(declare-const temp_1_1~187@ Int)
(declare-const temp_2_0~215@ Int)
(declare-const temp_2_1~228@ Int)
...
(declare-const temp_5_1~383@ Int)
(declare-const temp_6_0~415@ Int)
(declare-const temp_6_1~432@ Int)
(declare-const temp_7_0~464@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub d0~8@ b0~4@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul (Sub d0~8@ b0~4@) c0~6@) b0~4@)) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~158@ (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ 89))) (=> (= temp_1_1~187@ (Mul (Mul b1~12@ 89) (Mul a1~10@ a1~10@))) (=> (= tmp%2@ (= temp_1_0~158@ temp_1_1~187@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~215@ (Mul a2~18@ (Mul b2~20@ d2~24@))) (=> (= temp_2_1~228@ (Mul (Mul a2~18@ b2~20@) d2~24@)) (=> (= tmp%3@ (= temp_2_0~215@ temp_2_1~228@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~260@ (Sub (Mul c3~30@ d3~32@) (Mul c3~30@ b3~28@))) (=> (= temp_3_1~277@ (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@))) (=> (= tmp%4@ (= temp_3_0~260@ temp_3_1~277@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~309@ (Mul (Sub a4~34@ a4~34@) (Mul b4~36@ b4~36@))) (=> (= temp_4_1~334@ (Sub (Mul a4~34@ (Mul b4~36@ b4~36@)) (Mul a4~34@ (Mul b4~36@ b4~36@)))) (=> (= tmp%5@ (= temp_4_0~309@ temp_4_1~334@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~366@ (Sub (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~383@ (Sub (Mul b5~44@ a5~42@) (Mul b5~44@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~366@ temp_5_1~383@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~415@ (Mul (Add a6~50@ b6~52@) (Mul d6~56@ d6~56@))) (=> (= temp_6_1~432@ (Mul (Mul (Add a6~50@ b6~52@) d6~56@) d6~56@)) (=> (= tmp%7@ (= temp_6_0~415@ temp_6_1~432@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~464@ (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~481@ (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@))) (=> (= tmp%8@ (= temp_7_0~464@ temp_7_1~481@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~513@ (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~530@ (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ a8~66@))) (=> (= tmp%9@ (= temp_8_0~513@ temp_8_1~530@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
