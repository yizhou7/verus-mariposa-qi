...
(declare-const temp_5_0~411@ Int)
(declare-const temp_5_1~428@ Int)
(declare-const temp_6_0~469@ Int)
(declare-const temp_6_1~486@ Int)
(declare-const temp_7_0~527@ Int)
(declare-const temp_7_1~544@ Int)
(declare-const temp_8_0~585@ Int)
(declare-const temp_8_1~602@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub d0~8@ b0~4@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul (Sub d0~8@ b0~4@) c0~6@) b0~4@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ 89))) (=> (= temp_1_1~196@ (Mul (Mul b1~12@ 89) (Mul a1~10@ a1~10@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~196@))) (=> (= temp_1_0~167@ temp_1_1~196@) (=> (= temp_2_0~233@ (Mul a2~18@ (Mul b2~20@ d2~24@))) (=> (= temp_2_1~246@ (Mul (Mul a2~18@ b2~20@) d2~24@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~233@ temp_2_1~246@))) (=> (= temp_2_0~233@ temp_2_1~246@) (=> (= temp_3_0~287@ (Sub (Mul c3~30@ d3~32@) (Mul c3~30@ b3~28@))) (=> (= temp_3_1~304@ (Sub (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~287@ temp_3_1~304@))) (=> (= temp_3_0~287@ temp_3_1~304@) (=> (= temp_4_0~345@ (Mul (Sub a4~34@ a4~34@) (Mul b4~36@ b4~36@))) (=> (= temp_4_1~370@ (Sub (Mul a4~34@ (Mul b4~36@ b4~36@)) (Mul a4~34@ (Mul b4~36@ b4~36@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~345@ temp_4_1~370@))) (=> (= temp_4_0~345@ temp_4_1~370@) (=> (= temp_5_0~411@ (Sub (Mul a5~42@ b5~44@) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~428@ (Sub (Mul b5~44@ a5~42@) (Mul b5~44@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~411@ temp_5_1~428@))) (=> (= temp_5_0~411@ temp_5_1~428@) (=> (= temp_6_0~469@ (Mul (Add a6~50@ b6~52@) (Mul d6~56@ d6~56@))) (=> (= temp_6_1~486@ (Mul (Mul (Add a6~50@ b6~52@) d6~56@) d6~56@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~469@ temp_6_1~486@))) (=> (= temp_6_0~469@ temp_6_1~486@) (=> (= temp_7_0~527@ (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~544@ (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~527@ temp_7_1~544@))) (=> (= temp_7_0~527@ temp_7_1~544@) (=> (= temp_8_0~585@ (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~602@ (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~585@ temp_8_1~602@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
