...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Mul b1~12@ c1~14@) (Sub 83 a1~10@))) (=> (= temp_1_1~196@ (Mul (Sub 83 a1~10@) (Mul b1~12@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~196@))) (=> (= temp_1_0~167@ temp_1_1~196@) (=> (= temp_2_0~237@ (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@))) (=> (= temp_2_1~254@ (Sub (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~237@ temp_2_1~254@))) (=> (= temp_2_0~237@ temp_2_1~254@) (=> (= temp_3_0~295@ (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@))) (=> (= temp_3_1~312@ (Mul c3~30@ (Mul d3~32@ (Mul b3~28@ a3~26@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~295@ temp_3_1~312@))) (=> (= temp_3_0~295@ temp_3_1~312@) (=> (= temp_4_0~353@ (Mul (Mul a4~34@ b4~36@) (Sub d4~40@ d4~40@))) (=> (= temp_4_1~378@ (Sub (Mul (Mul a4~34@ b4~36@) d4~40@) (Mul (Mul a4~34@ b4~36@) d4~40@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~353@ temp_4_1~378@))) (=> (= temp_4_0~353@ temp_4_1~378@) (=> (= temp_5_0~419@ (Add (Mul c5~46@ a5~42@) (Sub a5~42@ c5~46@))) (=> (= temp_5_1~436@ (Add (Mul a5~42@ c5~46@) (Sub a5~42@ c5~46@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~419@ temp_5_1~436@))) (=> (= temp_5_0~419@ temp_5_1~436@) (=> (= temp_6_0~477@ (Sub (Mul d6~56@ d6~56@) (Add b6~52@ d6~56@))) (=> (= temp_6_1~494@ (Sub (Mul d6~56@ d6~56@) (Add b6~52@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~477@ temp_6_1~494@))) (=> (= temp_6_0~477@ temp_6_1~494@) (=> (= temp_7_0~535@ (Mul (Sub c7~62@ d7~64@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~552@ (Mul (Mul d7~64@ c7~62@) (Sub c7~62@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~535@ temp_7_1~552@))) (=> (= temp_7_0~535@ temp_7_1~552@) (=> (= temp_8_0~605@ (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ 22))) (=> (= temp_8_1~634@ (Mul (Mul b8~68@ c8~70@) (Mul 22 d8~72@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~605@ temp_8_1~634@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
