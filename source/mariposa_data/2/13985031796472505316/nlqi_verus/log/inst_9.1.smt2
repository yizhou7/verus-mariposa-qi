...
(set-info :comment ";; mariposa_data/2//13985031796472505316/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~179@ Int)
(declare-const temp_1_1~208@ Int)
(declare-const temp_2_0~273@ Int)
(declare-const temp_2_1~290@ Int)
(declare-const temp_3_0~335@ Int)
(declare-const temp_3_1~352@ Int)
(declare-const temp_4_0~403@ Int)
(declare-const temp_4_1~428@ Int)
(declare-const temp_5_0~479@ Int)
(declare-const temp_5_1~496@ Int)
(declare-const temp_6_0~541@ Int)
(declare-const temp_6_1~558@ Int)
(declare-const temp_7_0~603@ Int)
(declare-const temp_7_1~620@ Int)
(declare-const temp_8_0~685@ Int)
(declare-const temp_8_1~714@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ b0~4@))) (and (=> (= tmp%1@ (Mul c0~6@ b0~4@)) (=> (= tmp%2@ (Mul a0~2@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~179@ (Mul (Mul b1~12@ c1~14@) (Sub 83 a1~10@))) (=> (= temp_1_1~208@ (Mul (Sub 83 a1~10@) (Mul b1~12@ c1~14@))) (and (=> (= tmp%3@ (Mul b1~12@ c1~14@)) (=> (= tmp%4@ (Sub 83 a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~179@ temp_1_1~208@))))) (=> (= temp_1_0~179@ temp_1_1~208@) (=> (= temp_2_0~273@ (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@))) (=> (= temp_2_1~290@ (Sub (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ c2~22@) (=> %%location_label%%2 (= temp_2_0~273@ temp_2_1~290@))) (=> (= temp_2_0~273@ temp_2_1~290@) (=> (= temp_3_0~335@ (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@))) (=> (= temp_3_1~352@ (Mul c3~30@ (Mul d3~32@ (Mul b3~28@ a3~26@)))) (and (=> (= tmp%5@ (Mul b3~28@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c3~30@ d3~32@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~335@ temp_3_1~352@)))) (=> (= temp_3_0~335@ temp_3_1~352@) (=> (= temp_4_0~403@ (Mul (Mul a4~34@ b4~36@) (Sub d4~40@ d4~40@))) (=> (= temp_4_1~428@ (Sub (Mul (Mul a4~34@ b4~36@) d4~40@) (Mul (Mul a4~34@ b4~36@) d4~40@))) (and (=> (= tmp%6@ (Mul a4~34@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%6@ d4~40@ d4~40@) (=> %%location_label%%4 (= temp_4_0~403@ temp_4_1~428@)))) (=> (= temp_4_0~403@ temp_4_1~428@) (=> (= temp_5_0~479@ (Add (Mul c5~46@ a5~42@) (Sub a5~42@ c5~46@))) (=> (= temp_5_1~496@ (Add (Mul a5~42@ c5~46@) (Sub a5~42@ c5~46@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ a5~42@) (=> %%location_label%%5 (= temp_5_0~479@ temp_5_1~496@))) (=> (= temp_5_0~479@ temp_5_1~496@) (=> (= temp_6_0~541@ (Sub (Mul d6~56@ d6~56@) (Add b6~52@ d6~56@))) (=> (= temp_6_1~558@ (Sub (Mul d6~56@ d6~56@) (Add b6~52@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ d6~56@) (=> %%location_label%%6 (= temp_6_0~541@ temp_6_1~558@))) (=> (= temp_6_0~541@ temp_6_1~558@) (=> (= temp_7_0~603@ (Mul (Sub c7~62@ d7~64@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~620@ (Mul (Mul d7~64@ c7~62@) (Sub c7~62@ d7~64@))) (and (=> (= tmp%7@ (Sub c7~62@ d7~64@)) (=> (= tmp%8@ (Mul d7~64@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%7 (= temp_7_0~603@ temp_7_1~620@))))) (=> (= temp_7_0~603@ temp_7_1~620@) (=> (= temp_8_0~685@ (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ 22))) (=> (= temp_8_1~714@ (Mul (Mul b8~68@ c8~70@) (Mul 22 d8~72@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d8~72@ 22) (=> %%location_label%%8 (= temp_8_0~685@ temp_8_1~714@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
