...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ b0~4@))) (=> (= tmp%1@ (Mul c0~6@ b0~4@)) (=> (= tmp%2@ (Mul a0~2@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))))))))
(assert %%query%%)
(check-sat)
