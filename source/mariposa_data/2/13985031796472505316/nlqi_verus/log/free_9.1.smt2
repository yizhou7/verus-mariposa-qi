...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= temp_0_1~118@ (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ b0~4@))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~162@ (Mul (Mul b1~12@ c1~14@) (Sub 83 a1~10@))) (=> (= temp_1_1~191@ (Mul (Sub 83 a1~10@) (Mul b1~12@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~162@ temp_1_1~191@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~223@ (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@))) (=> (= temp_2_1~240@ (Sub (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@))) (=> (= tmp%3@ (= temp_2_0~223@ temp_2_1~240@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~272@ (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@))) (=> (= temp_3_1~289@ (Mul c3~30@ (Mul d3~32@ (Mul b3~28@ a3~26@)))) (=> (= tmp%4@ (= temp_3_0~272@ temp_3_1~289@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~321@ (Mul (Mul a4~34@ b4~36@) (Sub d4~40@ d4~40@))) (=> (= temp_4_1~346@ (Sub (Mul (Mul a4~34@ b4~36@) d4~40@) (Mul (Mul a4~34@ b4~36@) d4~40@))) (=> (= tmp%5@ (= temp_4_0~321@ temp_4_1~346@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~378@ (Add (Mul c5~46@ a5~42@) (Sub a5~42@ c5~46@))) (=> (= temp_5_1~395@ (Add (Mul a5~42@ c5~46@) (Sub a5~42@ c5~46@))) (=> (= tmp%6@ (= temp_5_0~378@ temp_5_1~395@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~427@ (Sub (Mul d6~56@ d6~56@) (Add b6~52@ d6~56@))) (=> (= temp_6_1~444@ (Sub (Mul d6~56@ d6~56@) (Add b6~52@ d6~56@))) (=> (= tmp%7@ (= temp_6_0~427@ temp_6_1~444@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~476@ (Mul (Sub c7~62@ d7~64@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~493@ (Mul (Mul d7~64@ c7~62@) (Sub c7~62@ d7~64@))) (=> (= tmp%8@ (= temp_7_0~476@ temp_7_1~493@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~537@ (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ 22))) (=> (= temp_8_1~566@ (Mul (Mul b8~68@ c8~70@) (Mul 22 d8~72@))) (=> (= tmp%9@ (= temp_8_0~537@ temp_8_1~566@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
