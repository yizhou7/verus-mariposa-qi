...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ b0~4@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~158@ (Mul (Mul b1~12@ c1~14@) (Sub 83 a1~10@))) (=> (= temp_1_1~187@ (Mul (Sub 83 a1~10@) (Mul b1~12@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~158@ temp_1_1~187@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~219@ (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ c2~22@))) (=> (= temp_2_1~236@ (Sub (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@))) (=> (= tmp%3@ (= temp_2_0~219@ temp_2_1~236@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~268@ (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@))) (=> (= temp_3_1~285@ (Mul c3~30@ (Mul d3~32@ (Mul b3~28@ a3~26@)))) (=> (= tmp%4@ (= temp_3_0~268@ temp_3_1~285@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~317@ (Mul (Mul a4~34@ b4~36@) (Sub d4~40@ d4~40@))) (=> (= temp_4_1~342@ (Sub (Mul (Mul a4~34@ b4~36@) d4~40@) (Mul (Mul a4~34@ b4~36@) d4~40@))) (=> (= tmp%5@ (= temp_4_0~317@ temp_4_1~342@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~374@ (Add (Mul c5~46@ a5~42@) (Sub a5~42@ c5~46@))) (=> (= temp_5_1~391@ (Add (Mul a5~42@ c5~46@) (Sub a5~42@ c5~46@))) (=> (= tmp%6@ (= temp_5_0~374@ temp_5_1~391@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~423@ (Sub (Mul d6~56@ d6~56@) (Add b6~52@ d6~56@))) (=> (= temp_6_1~440@ (Sub (Mul d6~56@ d6~56@) (Add b6~52@ d6~56@))) (=> (= tmp%7@ (= temp_6_0~423@ temp_6_1~440@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~472@ (Mul (Sub c7~62@ d7~64@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~489@ (Mul (Mul d7~64@ c7~62@) (Sub c7~62@ d7~64@))) (=> (= tmp%8@ (= temp_7_0~472@ temp_7_1~489@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~533@ (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ 22))) (=> (= temp_8_1~562@ (Mul (Mul b8~68@ c8~70@) (Mul 22 d8~72@))) (=> (= tmp%9@ (= temp_8_0~533@ temp_8_1~562@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
