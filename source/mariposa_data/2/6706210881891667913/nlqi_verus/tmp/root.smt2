...
;; mariposa_data/2//6706210881891667913/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_3_0~260@ Int)
 (declare-const temp_3_1~289@ Int)
 (declare-const temp_4_0~321@ Int)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ d0~8@)))
      (=>
       (= temp_0_1~118@ (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Add (Mul c1~14@ d1~16@) (Add c1~14@ b1~12@)))
           (=>
            (= temp_1_1~167@ (Add (Mul d1~16@ c1~14@) (Add c1~14@ b1~12@)))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~199@ (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@)))
                (=>
                 (= temp_2_1~216@ (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@)))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~260@ (Add (Mul 28 b3~28@) (Mul c3~30@ c3~30@)))
                     (=>
                      (= temp_3_1~289@ (Add (Mul b3~28@ 28) (Mul c3~30@ c3~30@)))
                      (=>
                       (= tmp%4@ (= temp_3_0~260@ temp_3_1~289@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~321@ (Mul (Add c4~38@ c4~38@) (Mul a4~34@ c4~38@)))
                          (=>
                           (= temp_4_1~346@ (Add (Mul c4~38@ (Mul a4~34@ c4~38@)) (Mul c4~38@ (Mul a4~34@ c4~38@))))
                           (=>
                            (= tmp%5@ (= temp_4_0~321@ temp_4_1~346@))
                            (and
                             (=>
                              %%location_label%%4
                              tmp%5@
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~378@ (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ b5~44@)))
                               (=>
                                (= temp_5_1~395@ (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@)))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~427@ (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)))
                                    (=>
                                     (= temp_6_1~444@ (Mul c6~54@ (Mul b6~52@ (Mul b6~52@ c6~54@))))
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~476@ (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ b7~60@)))
                                         (=>
                                          (= temp_7_1~493@ (Mul (Mul (Mul c7~62@ b7~60@) a7~58@) b7~60@))
                                          (=>
                                           ...
                                           (and
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~525@ (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@)))
                                              (=>
                                               (= temp_8_1~542@ (Mul (Mul (Mul a8~66@ a8~66@) a8~66@) b8~68@))
                                               (=>
