...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~118@ (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~150@ (Add (Mul c1~14@ d1~16@) (Add c1~14@ b1~12@))) (=> (= temp_1_1~167@ (Add (Mul d1~16@ c1~14@) (Add c1~14@ b1~12@))) (=> (= tmp%2@ (= temp_1_0~150@ temp_1_1~167@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~199@ (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@))) (=> (= temp_2_1~216@ (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@))) (=> (= tmp%3@ (= temp_2_0~199@ temp_2_1~216@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~260@ (Add (Mul 28 b3~28@) (Mul c3~30@ c3~30@))) (=> (= temp_3_1~289@ (Add (Mul b3~28@ 28) (Mul c3~30@ c3~30@))) (=> (= tmp%4@ (= temp_3_0~260@ temp_3_1~289@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~321@ (Mul (Add c4~38@ c4~38@) (Mul a4~34@ c4~38@))) (=> (= temp_4_1~346@ (Add (Mul c4~38@ (Mul a4~34@ c4~38@)) (Mul c4~38@ (Mul a4~34@ c4~38@)))) (=> (= tmp%5@ (= temp_4_0~321@ temp_4_1~346@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~378@ (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ b5~44@))) (=> (= temp_5_1~395@ (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@))) (=> (= tmp%6@ (= temp_5_0~378@ temp_5_1~395@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~427@ (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@))) (=> (= temp_6_1~444@ (Mul c6~54@ (Mul b6~52@ (Mul b6~52@ c6~54@)))) (=> (= tmp%7@ (= temp_6_0~427@ temp_6_1~444@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~476@ (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ b7~60@))) (=> (= temp_7_1~493@ (Mul (Mul (Mul c7~62@ b7~60@) a7~58@) b7~60@)) (=> (= tmp%8@ (= temp_7_0~476@ temp_7_1~493@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~525@ (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@))) (=> (= temp_8_1~542@ (Mul (Mul (Mul a8~66@ a8~66@) a8~66@) b8~68@)) (=> (= tmp%9@ (= temp_8_0~525@ temp_8_1~542@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
