...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@))) (and (=> (= tmp%1@ (Mul c0~6@ b0~4@)) (=> (= tmp%2@ (Mul d0~8@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Add (Mul c1~14@ d1~16@) (Add c1~14@ b1~12@))) (=> (= temp_1_1~184@ (Add (Mul d1~16@ c1~14@) (Add c1~14@ b1~12@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ d1~16@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@))) (=> (= temp_1_0~167@ temp_1_1~184@) (=> (= temp_2_0~229@ (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@))) (=> (= temp_2_1~246@ (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ a2~18@) (=> %%location_label%%2 (= temp_2_0~229@ temp_2_1~246@))))))))))))))))
(assert %%query%%)
(check-sat)
