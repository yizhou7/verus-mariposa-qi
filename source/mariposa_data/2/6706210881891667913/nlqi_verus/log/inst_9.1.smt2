...
(set-info :comment ";; mariposa_data/2//6706210881891667913/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_3_1~332@ Int)
...
(declare-const temp_8_1~680@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@))) (and (=> (= tmp%1@ (Mul c0~6@ b0~4@)) (=> (= tmp%2@ (Mul d0~8@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Add (Mul c1~14@ d1~16@) (Add c1~14@ b1~12@))) (=> (= temp_1_1~184@ (Add (Mul d1~16@ c1~14@) (Add c1~14@ b1~12@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ d1~16@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@))) (=> (= temp_1_0~167@ temp_1_1~184@) (=> (= temp_2_0~229@ (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@))) (=> (= temp_2_1~246@ (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ a2~18@) (=> %%location_label%%2 (= temp_2_0~229@ temp_2_1~246@))) (=> (= temp_2_0~229@ temp_2_1~246@) (=> (= temp_3_0~303@ (Add (Mul 28 b3~28@) (Mul c3~30@ c3~30@))) (=> (= temp_3_1~332@ (Add (Mul b3~28@ 28) (Mul c3~30@ c3~30@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 28 b3~28@) (=> %%location_label%%3 (= temp_3_0~303@ temp_3_1~332@))) (=> (= temp_3_0~303@ temp_3_1~332@) (=> (= temp_4_0~389@ (Mul (Add c4~38@ c4~38@) (Mul a4~34@ c4~38@))) (=> (= temp_4_1~414@ (Add (Mul c4~38@ (Mul a4~34@ c4~38@)) (Mul c4~38@ (Mul a4~34@ c4~38@)))) (and (=> (= tmp%3@ (Mul a4~34@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c4~38@ c4~38@ tmp%3@) (=> %%location_label%%4 (= temp_4_0~389@ temp_4_1~414@)))) (=> (= temp_4_0~389@ temp_4_1~414@) (=> (= temp_5_0~465@ (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ b5~44@))) (=> (= temp_5_1~482@ (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ b5~44@) (=> %%location_label%%5 (= temp_5_0~465@ temp_5_1~482@))) (=> (= temp_5_0~465@ temp_5_1~482@) (=> (= temp_6_0~527@ (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@))) (=> (= temp_6_1~544@ (Mul c6~54@ (Mul b6~52@ (Mul b6~52@ c6~54@)))) (and (=> (= tmp%4@ (Mul b6~52@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c6~54@ b6~52@ tmp%4@) (=> %%location_label%%6 (= temp_6_0~527@ temp_6_1~544@)))) (=> (= temp_6_0~527@ temp_6_1~544@) (=> (= temp_7_0~595@ (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ b7~60@))) (=> (= temp_7_1~612@ (Mul (Mul (Mul c7~62@ b7~60@) a7~58@) b7~60@)) (and (=> (= tmp%5@ (Mul c7~62@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ a7~58@ b7~60@) (=> %%location_label%%7 (= temp_7_0~595@ temp_7_1~612@)))) (=> (= temp_7_0~595@ temp_7_1~612@) (=> (= temp_8_0~663@ (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@))) (=> (= temp_8_1~680@ (Mul (Mul (Mul a8~66@ a8~66@) a8~66@) b8~68@)) (=> (= tmp%6@ (Mul a8~66@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ a8~66@ b8~68@) (=> %%location_label%%8 (= temp_8_0~663@ temp_8_1~680@)))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
