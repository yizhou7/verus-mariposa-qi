...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Add (Mul c1~14@ d1~16@) (Add c1~14@ b1~12@))) (=> (= temp_1_1~172@ (Add (Mul d1~16@ c1~14@) (Add c1~14@ b1~12@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@))) (=> (= temp_2_1~230@ (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~283@ (Add (Mul 28 b3~28@) (Mul c3~30@ c3~30@))) (=> (= temp_3_1~312@ (Add (Mul b3~28@ 28) (Mul c3~30@ c3~30@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~283@ temp_3_1~312@))) (=> (= temp_3_0~283@ temp_3_1~312@) (=> (= temp_4_0~353@ (Mul (Add c4~38@ c4~38@) (Mul a4~34@ c4~38@))) (=> (= temp_4_1~378@ (Add (Mul c4~38@ (Mul a4~34@ c4~38@)) (Mul c4~38@ (Mul a4~34@ c4~38@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~353@ temp_4_1~378@))) (=> (= temp_4_0~353@ temp_4_1~378@) (=> (= temp_5_0~419@ (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ b5~44@))) (=> (= temp_5_1~436@ (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~419@ temp_5_1~436@))) (=> (= temp_5_0~419@ temp_5_1~436@) (=> (= temp_6_0~477@ (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@))) (=> (= temp_6_1~494@ (Mul c6~54@ (Mul b6~52@ (Mul b6~52@ c6~54@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~477@ temp_6_1~494@))) (=> (= temp_6_0~477@ temp_6_1~494@) (=> (= temp_7_0~535@ (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ b7~60@))) (=> (= temp_7_1~552@ (Mul (Mul (Mul c7~62@ b7~60@) a7~58@) b7~60@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~535@ temp_7_1~552@))) (=> (= temp_7_0~535@ temp_7_1~552@) (=> (= temp_8_0~593@ (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@))) (=> (= temp_8_1~610@ (Mul (Mul (Mul a8~66@ a8~66@) a8~66@) b8~68@)) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~593@ temp_8_1~610@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
