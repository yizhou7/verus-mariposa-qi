...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Add (Mul c1~14@ d1~16@) (Add c1~14@ b1~12@))) (=> (= temp_1_1~163@ (Add (Mul d1~16@ c1~14@) (Add c1~14@ b1~12@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@))) (=> (= temp_2_1~212@ (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~212@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~256@ (Add (Mul 28 b3~28@) (Mul c3~30@ c3~30@))) (=> (= temp_3_1~285@ (Add (Mul b3~28@ 28) (Mul c3~30@ c3~30@))) (=> (= tmp%4@ (= temp_3_0~256@ temp_3_1~285@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~317@ (Mul (Add c4~38@ c4~38@) (Mul a4~34@ c4~38@))) (=> (= temp_4_1~342@ (Add (Mul c4~38@ (Mul a4~34@ c4~38@)) (Mul c4~38@ (Mul a4~34@ c4~38@)))) (=> (= tmp%5@ (= temp_4_0~317@ temp_4_1~342@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~374@ (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ b5~44@))) (=> (= temp_5_1~391@ (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@))) (=> (= tmp%6@ (= temp_5_0~374@ temp_5_1~391@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~423@ (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@))) (=> (= temp_6_1~440@ (Mul c6~54@ (Mul b6~52@ (Mul b6~52@ c6~54@)))) (=> (= tmp%7@ (= temp_6_0~423@ temp_6_1~440@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~472@ (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ b7~60@))) (=> (= temp_7_1~489@ (Mul (Mul (Mul c7~62@ b7~60@) a7~58@) b7~60@)) (=> (= tmp%8@ (= temp_7_0~472@ temp_7_1~489@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~521@ (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@))) (=> (= temp_8_1~538@ (Mul (Mul (Mul a8~66@ a8~66@) a8~66@) b8~68@)) (=> (= tmp%9@ (= temp_8_0~521@ temp_8_1~538@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
