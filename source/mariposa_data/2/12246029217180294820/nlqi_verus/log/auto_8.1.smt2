...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~172@ (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Add (Add d2~24@ a2~18@) (Mul b2~20@ a2~18@))) (=> (= temp_2_1~230@ (Add (Add d2~24@ a2~18@) (Mul a2~18@ b2~20@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Mul (Mul b3~28@ c3~30@) (Sub c3~30@ d3~32@))) (=> (= temp_3_1~288@ (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ c3~30@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~288@))) (=> (= temp_3_0~271@ temp_3_1~288@) (=> (= temp_4_0~329@ (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~346@ (Mul a4~34@ (Mul c4~38@ (Mul d4~40@ b4~36@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~329@ temp_4_1~346@))) (=> (= temp_4_0~329@ temp_4_1~346@) (=> (= temp_5_0~387@ (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@))) (=> (= temp_5_1~404@ (Mul (Mul (Mul d5~48@ d5~48@) b5~44@) c5~46@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~387@ temp_5_1~404@))) (=> (= temp_5_0~387@ temp_5_1~404@) (=> (= temp_6_0~445@ (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@))) (=> (= temp_6_1~462@ (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~445@ temp_6_1~462@))) (=> (= temp_6_0~445@ temp_6_1~462@) (=> (= temp_7_0~503@ (Mul (Mul a7~58@ d7~64@) (Sub b7~60@ d7~64@))) (=> (= temp_7_1~520@ (Mul a7~58@ (Mul d7~64@ (Sub b7~60@ d7~64@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~503@ temp_7_1~520@))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
