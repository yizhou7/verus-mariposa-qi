...
(set-info :comment ";; mariposa_data/2//12246029217180294820/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_3_1~308@ Int)
(declare-const temp_4_0~361@ Int)
(declare-const temp_4_1~378@ Int)
(declare-const temp_5_0~429@ Int)
(declare-const temp_5_1~446@ Int)
(declare-const temp_6_0~497@ Int)
(declare-const temp_6_1~514@ Int)
(declare-const temp_7_0~567@ Int)
(declare-const temp_7_1~584@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (and (=> (= tmp%1@ (Mul b0~4@ d0~8@)) (=> (= tmp%2@ (Mul c0~6@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~184@ (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@))) (=> (= temp_1_0~167@ temp_1_1~184@) (=> (= temp_2_0~229@ (Add (Add d2~24@ a2~18@) (Mul b2~20@ a2~18@))) (=> (= temp_2_1~246@ (Add (Add d2~24@ a2~18@) (Mul a2~18@ b2~20@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ a2~18@) (=> %%location_label%%2 (= temp_2_0~229@ temp_2_1~246@))) (=> (= temp_2_0~229@ temp_2_1~246@) (=> (= temp_3_0~291@ (Mul (Mul b3~28@ c3~30@) (Sub c3~30@ d3~32@))) (=> (= temp_3_1~308@ (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ c3~30@))) (and (=> (= tmp%3@ (Mul b3~28@ c3~30@)) (=> (= tmp%4@ (Sub c3~30@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~291@ temp_3_1~308@))))) (=> (= temp_3_0~291@ temp_3_1~308@) (=> (= temp_4_0~361@ (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~378@ (Mul a4~34@ (Mul c4~38@ (Mul d4~40@ b4~36@)))) (and (=> (= tmp%5@ (Mul d4~40@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a4~34@ c4~38@ tmp%5@) (=> %%location_label%%4 (= temp_4_0~361@ temp_4_1~378@)))) (=> (= temp_4_0~361@ temp_4_1~378@) (=> (= temp_5_0~429@ (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@))) (=> (= temp_5_1~446@ (Mul (Mul (Mul d5~48@ d5~48@) b5~44@) c5~46@)) (and (=> (= tmp%6@ (Mul d5~48@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ b5~44@ c5~46@) (=> %%location_label%%5 (= temp_5_0~429@ temp_5_1~446@)))) (=> (= temp_5_0~429@ temp_5_1~446@) (=> (= temp_6_0~497@ (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@))) (=> (= temp_6_1~514@ (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@))) (and (=> (= tmp%7@ (Mul b6~52@ b6~52@)) (=> (= tmp%8@ (Mul b6~52@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~497@ temp_6_1~514@))))) (=> (= temp_6_0~497@ temp_6_1~514@) (=> (= temp_7_0~567@ (Mul (Mul a7~58@ d7~64@) (Sub b7~60@ d7~64@))) (=> (= temp_7_1~584@ (Mul a7~58@ (Mul d7~64@ (Sub b7~60@ d7~64@)))) (and (=> (= tmp%9@ (Sub b7~60@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a7~58@ d7~64@ tmp%9@) (=> %%location_label%%7 (= temp_7_0~567@ temp_7_1~584@)))) (=> (= temp_7_0~567@ temp_7_1~584@) (=> (= temp_8_0~635@ (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (=> (= temp_8_1~652@ (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ d8~72@) (=> %%location_label%%8 (= temp_8_0~635@ temp_8_1~652@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
