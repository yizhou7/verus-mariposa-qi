...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~118@ (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~150@ (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~167@ (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~150@ temp_1_1~167@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~199@ (Add (Add d2~24@ a2~18@) (Mul b2~20@ a2~18@))) (=> (= temp_2_1~216@ (Add (Add d2~24@ a2~18@) (Mul a2~18@ b2~20@))) (=> (= tmp%3@ (= temp_2_0~199@ temp_2_1~216@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~248@ (Mul (Mul b3~28@ c3~30@) (Sub c3~30@ d3~32@))) (=> (= temp_3_1~265@ (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ c3~30@))) (=> (= tmp%4@ (= temp_3_0~248@ temp_3_1~265@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~297@ (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~314@ (Mul a4~34@ (Mul c4~38@ (Mul d4~40@ b4~36@)))) (=> (= tmp%5@ (= temp_4_0~297@ temp_4_1~314@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~346@ (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@))) (=> (= temp_5_1~363@ (Mul (Mul (Mul d5~48@ d5~48@) b5~44@) c5~46@)) (=> (= tmp%6@ (= temp_5_0~346@ temp_5_1~363@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~395@ (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@))) (=> (= temp_6_1~412@ (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@))) (=> (= tmp%7@ (= temp_6_0~395@ temp_6_1~412@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~444@ (Mul (Mul a7~58@ d7~64@) (Sub b7~60@ d7~64@))) (=> (= temp_7_1~461@ (Mul a7~58@ (Mul d7~64@ (Sub b7~60@ d7~64@)))) (=> (= tmp%8@ (= temp_7_0~444@ temp_7_1~461@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~493@ (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (=> (= temp_8_1~510@ (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@))) (=> (= tmp%9@ (= temp_8_0~493@ temp_8_1~510@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
