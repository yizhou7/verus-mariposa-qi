...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (and (=> (= tmp%1@ (Mul b0~4@ d0~8@)) (=> (= tmp%2@ (Mul c0~6@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~184@ (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@))) (=> (= temp_1_0~167@ temp_1_1~184@) (=> (= temp_2_0~229@ (Add (Add d2~24@ a2~18@) (Mul b2~20@ a2~18@))) (=> (= temp_2_1~246@ (Add (Add d2~24@ a2~18@) (Mul a2~18@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ a2~18@) (=> %%location_label%%2 (= temp_2_0~229@ temp_2_1~246@))))))))))))))))
(assert %%query%%)
(check-sat)
