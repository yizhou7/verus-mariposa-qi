...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~163@ (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Add (Add d2~24@ a2~18@) (Mul b2~20@ a2~18@))) (=> (= temp_2_1~212@ (Add (Add d2~24@ a2~18@) (Mul a2~18@ b2~20@))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~212@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~244@ (Mul (Mul b3~28@ c3~30@) (Sub c3~30@ d3~32@))) (=> (= temp_3_1~261@ (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ c3~30@))) (=> (= tmp%4@ (= temp_3_0~244@ temp_3_1~261@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~293@ (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~310@ (Mul a4~34@ (Mul c4~38@ (Mul d4~40@ b4~36@)))) (=> (= tmp%5@ (= temp_4_0~293@ temp_4_1~310@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~342@ (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@))) (=> (= temp_5_1~359@ (Mul (Mul (Mul d5~48@ d5~48@) b5~44@) c5~46@)) (=> (= tmp%6@ (= temp_5_0~342@ temp_5_1~359@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~391@ (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@))) (=> (= temp_6_1~408@ (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@))) (=> (= tmp%7@ (= temp_6_0~391@ temp_6_1~408@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~440@ (Mul (Mul a7~58@ d7~64@) (Sub b7~60@ d7~64@))) (=> (= temp_7_1~457@ (Mul a7~58@ (Mul d7~64@ (Sub b7~60@ d7~64@)))) (=> (= tmp%8@ (= temp_7_0~440@ temp_7_1~457@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~489@ (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (=> (= temp_8_1~506@ (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@))) (=> (= tmp%9@ (= temp_8_0~489@ temp_8_1~506@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
