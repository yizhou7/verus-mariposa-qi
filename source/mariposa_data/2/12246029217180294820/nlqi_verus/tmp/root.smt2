...
;; mariposa_data/2//12246029217180294820/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_7_1~461@ Int)
 (declare-const temp_8_0~493@ Int)
 (declare-const temp_8_1~510@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@)))
      (=>
       (= temp_0_1~118@ (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@)))
           (=>
            (= temp_1_1~167@ (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@)))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~199@ (Add (Add d2~24@ a2~18@) (Mul b2~20@ a2~18@)))
                (=>
                 (= temp_2_1~216@ (Add (Add d2~24@ a2~18@) (Mul a2~18@ b2~20@)))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~248@ (Mul (Mul b3~28@ c3~30@) (Sub c3~30@ d3~32@)))
                     (=>
                      (= temp_3_1~265@ (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ c3~30@)))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~297@ (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ b4~36@)))
                          (=>
                           (= temp_4_1~314@ (Mul a4~34@ (Mul c4~38@ (Mul d4~40@ b4~36@))))
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~346@ (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)))
                               (=>
                                (= temp_5_1~363@ (Mul (Mul (Mul d5~48@ d5~48@) b5~44@) c5~46@))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~395@ (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@)))
                                    (=>
                                     (= temp_6_1~412@ (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@)))
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~444@ (Mul (Mul a7~58@ d7~64@) (Sub b7~60@ d7~64@)))
                                         (=>
                                          (= temp_7_1~461@ (Mul a7~58@ (Mul d7~64@ (Sub b7~60@ d7~64@))))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~444@ temp_7_1~461@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~493@ (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ d8~72@)))
                                              (=>
                                               (= temp_8_1~510@ (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@)))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~493@ temp_8_1~510@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
