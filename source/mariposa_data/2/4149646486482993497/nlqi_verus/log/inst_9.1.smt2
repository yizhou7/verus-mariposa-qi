...
(set-info :comment ";; mariposa_data/2//4149646486482993497/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_2_0~245@ Int)
(declare-const temp_2_1~270@ Int)
(declare-const temp_3_0~329@ Int)
(declare-const temp_3_1~354@ Int)
(declare-const temp_4_0~405@ Int)
(declare-const temp_4_1~430@ Int)
(declare-const temp_5_0~481@ Int)
(declare-const temp_5_1~498@ Int)
(declare-const temp_6_0~551@ Int)
(declare-const temp_6_1~568@ Int)
(declare-const temp_7_0~619@ Int)
(declare-const temp_7_1~632@ Int)
(declare-const temp_8_0~679@ Int)
(declare-const temp_8_1~696@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add d0~8@ a0~2@) (Add c0~6@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Add c0~6@ a0~2@) (Add d0~8@ a0~2@))) (and (=> (= tmp%1@ (Add d0~8@ a0~2@)) (=> (= tmp%2@ (Add c0~6@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~184@ (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))) (and (=> (= tmp%3@ (Mul b1~12@ b1~12@)) (=> (= tmp%4@ (Mul b1~12@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@))))) (=> (= temp_1_0~167@ temp_1_1~184@) (=> (= temp_2_0~245@ (Mul a2~18@ (Mul b2~20@ 88))) (=> (= temp_2_1~270@ (Mul (Mul a2~18@ b2~20@) 88)) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a2~18@ b2~20@ 88) (=> %%location_label%%2 (= temp_2_0~245@ temp_2_1~270@))) (=> (= temp_2_0~245@ temp_2_1~270@) (=> (= temp_3_0~329@ (Mul (Mul c3~30@ a3~26@) (Sub d3~32@ b3~28@))) (=> (= temp_3_1~354@ (Sub (Mul (Mul c3~30@ a3~26@) d3~32@) (Mul (Mul c3~30@ a3~26@) b3~28@))) (and (=> (= tmp%5@ (Mul c3~30@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%5@ d3~32@ b3~28@) (=> %%location_label%%3 (= temp_3_0~329@ temp_3_1~354@)))) (=> (= temp_3_0~329@ temp_3_1~354@) (=> (= temp_4_0~405@ (Mul (Mul d4~40@ c4~38@) (Add c4~38@ b4~36@))) (=> (= temp_4_1~430@ (Add (Mul (Mul d4~40@ c4~38@) c4~38@) (Mul (Mul d4~40@ c4~38@) b4~36@))) (and (=> (= tmp%6@ (Mul d4~40@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%6@ c4~38@ b4~36@) (=> %%location_label%%4 (= temp_4_0~405@ temp_4_1~430@)))) (=> (= temp_4_0~405@ temp_4_1~430@) (=> (= temp_5_0~481@ (Mul (Add d5~48@ c5~46@) (Mul b5~44@ a5~42@))) (=> (= temp_5_1~498@ (Mul (Mul b5~44@ a5~42@) (Add d5~48@ c5~46@))) (and (=> (= tmp%7@ (Add d5~48@ c5~46@)) (=> (= tmp%8@ (Mul b5~44@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~481@ temp_5_1~498@))))) (=> (= temp_5_0~481@ temp_5_1~498@) (=> (= temp_6_0~551@ (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ a6~50@))) (=> (= temp_6_1~568@ (Mul c6~54@ (Mul a6~50@ (Mul b6~52@ a6~50@)))) (and (=> (= tmp%9@ (Mul b6~52@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c6~54@ a6~50@ tmp%9@) (=> %%location_label%%6 (= temp_6_0~551@ temp_6_1~568@)))) (=> (= temp_6_0~551@ temp_6_1~568@) (=> (= temp_7_0~619@ (Add (Mul d7~64@ d7~64@) (Mul d7~64@ d7~64@))) (=> (= temp_7_1~632@ (Mul (Add d7~64@ d7~64@) d7~64@)) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d7~64@ d7~64@ d7~64@) (=> %%location_label%%7 (= temp_7_0~619@ temp_7_1~632@))) (=> (= temp_7_0~619@ temp_7_1~632@) (=> (= temp_8_0~679@ (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ c8~70@))) (=> (= temp_8_1~696@ (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d8~72@ b8~68@) (=> %%location_label%%8 (= temp_8_0~679@ temp_8_1~696@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
