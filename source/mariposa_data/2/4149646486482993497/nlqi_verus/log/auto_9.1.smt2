...
(declare-const temp_8_1~606@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add d0~8@ a0~2@) (Add c0~6@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Add c0~6@ a0~2@) (Add d0~8@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~172@ (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~221@ (Mul a2~18@ (Mul b2~20@ 88))) (=> (= temp_2_1~246@ (Mul (Mul a2~18@ b2~20@) 88)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~221@ temp_2_1~246@))) (=> (= temp_2_0~221@ temp_2_1~246@) (=> (= temp_3_0~287@ (Mul (Mul c3~30@ a3~26@) (Sub d3~32@ b3~28@))) (=> (= temp_3_1~312@ (Sub (Mul (Mul c3~30@ a3~26@) d3~32@) (Mul (Mul c3~30@ a3~26@) b3~28@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~287@ temp_3_1~312@))) (=> (= temp_3_0~287@ temp_3_1~312@) (=> (= temp_4_0~353@ (Mul (Mul d4~40@ c4~38@) (Add c4~38@ b4~36@))) (=> (= temp_4_1~378@ (Add (Mul (Mul d4~40@ c4~38@) c4~38@) (Mul (Mul d4~40@ c4~38@) b4~36@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~353@ temp_4_1~378@))) (=> (= temp_4_0~353@ temp_4_1~378@) (=> (= temp_5_0~419@ (Mul (Add d5~48@ c5~46@) (Mul b5~44@ a5~42@))) (=> (= temp_5_1~436@ (Mul (Mul b5~44@ a5~42@) (Add d5~48@ c5~46@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~419@ temp_5_1~436@))) (=> (= temp_5_0~419@ temp_5_1~436@) (=> (= temp_6_0~477@ (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ a6~50@))) (=> (= temp_6_1~494@ (Mul c6~54@ (Mul a6~50@ (Mul b6~52@ a6~50@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~477@ temp_6_1~494@))) (=> (= temp_6_0~477@ temp_6_1~494@) (=> (= temp_7_0~535@ (Add (Mul d7~64@ d7~64@) (Mul d7~64@ d7~64@))) (=> (= temp_7_1~548@ (Mul (Add d7~64@ d7~64@) d7~64@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~535@ temp_7_1~548@))) (=> (= temp_7_0~535@ temp_7_1~548@) (=> (= temp_8_0~589@ (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ c8~70@))) (=> (= temp_8_1~606@ (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~589@ temp_8_1~606@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
