...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add d0~8@ a0~2@) (Add c0~6@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Add c0~6@ a0~2@) (Add d0~8@ a0~2@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~163@ (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~203@ (Mul a2~18@ (Mul b2~20@ 88))) (=> (= temp_2_1~228@ (Mul (Mul a2~18@ b2~20@) 88)) (=> (= tmp%3@ (= temp_2_0~203@ temp_2_1~228@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~260@ (Mul (Mul c3~30@ a3~26@) (Sub d3~32@ b3~28@))) (=> (= temp_3_1~285@ (Sub (Mul (Mul c3~30@ a3~26@) d3~32@) (Mul (Mul c3~30@ a3~26@) b3~28@))) (=> (= tmp%4@ (= temp_3_0~260@ temp_3_1~285@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~317@ (Mul (Mul d4~40@ c4~38@) (Add c4~38@ b4~36@))) (=> (= temp_4_1~342@ (Add (Mul (Mul d4~40@ c4~38@) c4~38@) (Mul (Mul d4~40@ c4~38@) b4~36@))) (=> (= tmp%5@ (= temp_4_0~317@ temp_4_1~342@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~374@ (Mul (Add d5~48@ c5~46@) (Mul b5~44@ a5~42@))) (=> (= temp_5_1~391@ (Mul (Mul b5~44@ a5~42@) (Add d5~48@ c5~46@))) (=> (= tmp%6@ (= temp_5_0~374@ temp_5_1~391@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~423@ (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ a6~50@))) (=> (= temp_6_1~440@ (Mul c6~54@ (Mul a6~50@ (Mul b6~52@ a6~50@)))) (=> (= tmp%7@ (= temp_6_0~423@ temp_6_1~440@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~472@ (Add (Mul d7~64@ d7~64@) (Mul d7~64@ d7~64@))) (=> (= temp_7_1~485@ (Mul (Add d7~64@ d7~64@) d7~64@)) (=> (= tmp%8@ (= temp_7_0~472@ temp_7_1~485@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~517@ (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ c8~70@))) (=> (= temp_8_1~534@ (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ c8~70@))) (=> (= tmp%9@ (= temp_8_0~517@ temp_8_1~534@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
