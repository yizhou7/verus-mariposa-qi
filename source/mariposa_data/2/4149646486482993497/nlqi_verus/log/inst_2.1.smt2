...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add d0~8@ a0~2@) (Add c0~6@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Add c0~6@ a0~2@) (Add d0~8@ a0~2@))) (and (=> (= tmp%1@ (Add d0~8@ a0~2@)) (=> (= tmp%2@ (Add c0~6@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~184@ (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= tmp%3@ (Mul b1~12@ b1~12@)) (=> (= tmp%4@ (Mul b1~12@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@))))))))))))))
(assert %%query%%)
(check-sat)
