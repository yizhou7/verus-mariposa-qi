...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add d0~8@ a0~2@) (Add c0~6@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Add c0~6@ a0~2@) (Add d0~8@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~172@ (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ b1~12@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~221@ (Mul a2~18@ (Mul b2~20@ 88))) (=> (= temp_2_1~246@ (Mul (Mul a2~18@ b2~20@) 88)) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~221@ temp_2_1~246@))))))))))))))))
(assert %%query%%)
(check-sat)
