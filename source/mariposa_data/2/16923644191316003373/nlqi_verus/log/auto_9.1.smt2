...
(declare-const temp_4_0~341@ Int)
...
(declare-const temp_8_0~581@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ a0~2@) (Add d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Add d0~8@ c0~6@) (Mul a0~2@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Add (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))) (=> (= temp_1_1~172@ (Add (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Add (Mul b2~20@ a2~18@) (Mul d2~24@ b2~20@))) (=> (= temp_2_1~230@ (Add (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@))) (=> (= temp_3_1~288@ (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~288@))) (=> (= temp_3_0~271@ temp_3_1~288@) (=> (= temp_4_0~341@ (Add (Mul 2 d4~40@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~370@ (Add (Mul d4~40@ 2) (Mul d4~40@ b4~36@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~341@ temp_4_1~370@))) (=> (= temp_4_0~341@ temp_4_1~370@) (=> (= temp_5_0~411@ (Mul (Mul b5~44@ a5~42@) (Add c5~46@ a5~42@))) (=> (= temp_5_1~428@ (Mul (Mul a5~42@ b5~44@) (Add c5~46@ a5~42@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~411@ temp_5_1~428@))) (=> (= temp_5_0~411@ temp_5_1~428@) (=> (= temp_6_0~469@ (Mul (Add b6~52@ b6~52@) (Add b6~52@ a6~50@))) (=> (= temp_6_1~486@ (Mul (Add b6~52@ a6~50@) (Add b6~52@ b6~52@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~469@ temp_6_1~486@))) (=> (= temp_6_0~469@ temp_6_1~486@) (=> (= temp_7_0~527@ (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@))) (=> (= temp_7_1~544@ (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~527@ temp_7_1~544@))) (=> (= temp_7_0~527@ temp_7_1~544@) (=> (= temp_8_0~581@ (Mul c8~70@ (Sub a8~66@ c8~70@))) (=> (= temp_8_1~598@ (Sub (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~581@ temp_8_1~598@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
