...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Mul a0~2@ a0~2@) (Add d0~8@ c0~6@))) (=> (= temp_0_1~118@ (Mul (Add d0~8@ c0~6@) (Mul a0~2@ a0~2@))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~150@ (Add (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))) (=> (= temp_1_1~167@ (Add (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~150@ temp_1_1~167@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~199@ (Add (Mul b2~20@ a2~18@) (Mul d2~24@ b2~20@))) (=> (= temp_2_1~216@ (Add (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))) (=> (= tmp%3@ (= temp_2_0~199@ temp_2_1~216@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~248@ (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@))) (=> (= temp_3_1~265@ (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@))) (=> (= tmp%4@ (= temp_3_0~248@ temp_3_1~265@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~309@ (Add (Mul 2 d4~40@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~338@ (Add (Mul d4~40@ 2) (Mul d4~40@ b4~36@))) (=> (= tmp%5@ (= temp_4_0~309@ temp_4_1~338@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~370@ (Mul (Mul b5~44@ a5~42@) (Add c5~46@ a5~42@))) (=> (= temp_5_1~387@ (Mul (Mul a5~42@ b5~44@) (Add c5~46@ a5~42@))) (=> (= tmp%6@ (= temp_5_0~370@ temp_5_1~387@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~419@ (Mul (Add b6~52@ b6~52@) (Add b6~52@ a6~50@))) (=> (= temp_6_1~436@ (Mul (Add b6~52@ a6~50@) (Add b6~52@ b6~52@))) (=> (= tmp%7@ (= temp_6_0~419@ temp_6_1~436@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~468@ (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@))) (=> (= temp_7_1~485@ (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ c7~62@))) (=> (= tmp%8@ (= temp_7_0~468@ temp_7_1~485@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~513@ (Mul c8~70@ (Sub a8~66@ c8~70@))) (=> (= temp_8_1~530@ (Sub (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@))) (=> (= tmp%9@ (= temp_8_0~513@ temp_8_1~530@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
