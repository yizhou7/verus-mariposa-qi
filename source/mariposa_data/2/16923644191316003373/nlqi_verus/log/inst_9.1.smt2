...
(set-info :comment ";; mariposa_data/2//16923644191316003373/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_4_1~402@ Int)
(declare-const temp_5_0~459@ Int)
(declare-const temp_5_1~476@ Int)
(declare-const temp_6_0~521@ Int)
(declare-const temp_6_1~538@ Int)
(declare-const temp_7_0~591@ Int)
(declare-const temp_7_1~608@ Int)
(declare-const temp_8_0~649@ Int)
(declare-const temp_8_1~666@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ a0~2@) (Add d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Add d0~8@ c0~6@) (Mul a0~2@ a0~2@))) (and (=> (= tmp%1@ (Mul a0~2@ a0~2@)) (=> (= tmp%2@ (Add d0~8@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Add (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))) (=> (= temp_1_1~184@ (Add (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ c1~14@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@))) (=> (= temp_1_0~167@ temp_1_1~184@) (=> (= temp_2_0~229@ (Add (Mul b2~20@ a2~18@) (Mul d2~24@ b2~20@))) (=> (= temp_2_1~246@ (Add (Mul b2~20@ a2~18@) (Mul b2~20@ d2~24@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ b2~20@) (=> %%location_label%%2 (= temp_2_0~229@ temp_2_1~246@))) (=> (= temp_2_0~229@ temp_2_1~246@) (=> (= temp_3_0~291@ (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@))) (=> (= temp_3_1~308@ (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ a3~26@))) (and (=> (= tmp%3@ (Mul d3~32@ a3~26@)) (=> (= tmp%4@ (Mul a3~26@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~291@ temp_3_1~308@))))) (=> (= temp_3_0~291@ temp_3_1~308@) (=> (= temp_4_0~373@ (Add (Mul 2 d4~40@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~402@ (Add (Mul d4~40@ 2) (Mul d4~40@ b4~36@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 2 d4~40@) (=> %%location_label%%4 (= temp_4_0~373@ temp_4_1~402@))) (=> (= temp_4_0~373@ temp_4_1~402@) (=> (= temp_5_0~459@ (Mul (Mul b5~44@ a5~42@) (Add c5~46@ a5~42@))) (=> (= temp_5_1~476@ (Mul (Mul a5~42@ b5~44@) (Add c5~46@ a5~42@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b5~44@ a5~42@) (=> %%location_label%%5 (= temp_5_0~459@ temp_5_1~476@))) (=> (= temp_5_0~459@ temp_5_1~476@) (=> (= temp_6_0~521@ (Mul (Add b6~52@ b6~52@) (Add b6~52@ a6~50@))) (=> (= temp_6_1~538@ (Mul (Add b6~52@ a6~50@) (Add b6~52@ b6~52@))) (and (=> (= tmp%5@ (Add b6~52@ b6~52@)) (=> (= tmp%6@ (Add b6~52@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%6 (= temp_6_0~521@ temp_6_1~538@))))) (=> (= temp_6_0~521@ temp_6_1~538@) (=> (= temp_7_0~591@ (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@))) (=> (= temp_7_1~608@ (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ d7~64@) (=> %%location_label%%7 (= temp_7_0~591@ temp_7_1~608@))) (=> (= temp_7_0~591@ temp_7_1~608@) (=> (= temp_8_0~649@ (Mul c8~70@ (Sub a8~66@ c8~70@))) (=> (= temp_8_1~666@ (Sub (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c8~70@ a8~66@ c8~70@) (=> %%location_label%%8 (= temp_8_0~649@ temp_8_1~666@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
