...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ a0~2@) (Add d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Add d0~8@ c0~6@) (Mul a0~2@ a0~2@))) (and (=> (= tmp%1@ (Mul a0~2@ a0~2@)) (=> (= tmp%2@ (Add d0~8@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Add (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))) (=> (= temp_1_1~184@ (Add (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ c1~14@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@))))))))))))
(assert %%query%%)
(check-sat)
