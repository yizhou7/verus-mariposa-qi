...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ d0~8@) (Sub b0~4@ c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ c0~6@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@))) (=> (= temp_1_1~176@ (Mul (Mul (Mul b1~12@ b1~12@) a1~10@) a1~10@)) (and (=> (= tmp%1@ (Mul b1~12@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ a1~10@ a1~10@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@)))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~223@ (Mul d2~24@ (Mul a2~18@ d2~24@))) (=> (= temp_2_1~236@ (Mul (Mul a2~18@ d2~24@) d2~24@)) (=> (= tmp%2@ (Mul a2~18@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~223@ temp_2_1~236@)))))))))))))))))
(assert %%query%%)
(check-sat)
