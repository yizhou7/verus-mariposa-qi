...
(set-info :comment ";; mariposa_data/2//4822858098783119856/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_2_1~236@ Int)
(declare-const temp_3_0~285@ Int)
(declare-const temp_3_1~302@ Int)
(declare-const temp_4_0~353@ Int)
(declare-const temp_4_1~370@ Int)
(declare-const temp_5_0~421@ Int)
(declare-const temp_5_1~438@ Int)
(declare-const temp_6_0~483@ Int)
(declare-const temp_6_1~500@ Int)
(declare-const temp_7_0~553@ Int)
(declare-const temp_7_1~570@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ d0~8@) (Sub b0~4@ c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ c0~6@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@))) (=> (= temp_1_1~176@ (Mul (Mul (Mul b1~12@ b1~12@) a1~10@) a1~10@)) (and (=> (= tmp%1@ (Mul b1~12@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ a1~10@ a1~10@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@)))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~223@ (Mul d2~24@ (Mul a2~18@ d2~24@))) (=> (= temp_2_1~236@ (Mul (Mul a2~18@ d2~24@) d2~24@)) (and (=> (= tmp%2@ (Mul a2~18@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~223@ temp_2_1~236@)))) (=> (= temp_2_0~223@ temp_2_1~236@) (=> (= temp_3_0~285@ (Mul (Mul d3~32@ a3~26@) (Sub d3~32@ d3~32@))) (=> (= temp_3_1~302@ (Mul d3~32@ (Mul a3~26@ (Sub d3~32@ d3~32@)))) (and (=> (= tmp%3@ (Sub d3~32@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d3~32@ a3~26@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~285@ temp_3_1~302@)))) (=> (= temp_3_0~285@ temp_3_1~302@) (=> (= temp_4_0~353@ (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@))) (=> (= temp_4_1~370@ (Mul d4~40@ (Mul b4~36@ (Mul b4~36@ d4~40@)))) (and (=> (= tmp%4@ (Mul b4~36@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d4~40@ b4~36@ tmp%4@) (=> %%location_label%%4 (= temp_4_0~353@ temp_4_1~370@)))) (=> (= temp_4_0~353@ temp_4_1~370@) (=> (= temp_5_0~421@ (Add (Sub b5~44@ b5~44@) (Mul b5~44@ a5~42@))) (=> (= temp_5_1~438@ (Add (Sub b5~44@ b5~44@) (Mul a5~42@ b5~44@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b5~44@ a5~42@) (=> %%location_label%%5 (= temp_5_0~421@ temp_5_1~438@))) (=> (= temp_5_0~421@ temp_5_1~438@) (=> (= temp_6_0~483@ (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ a6~50@))) (=> (= temp_6_1~500@ (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ d6~56@))) (and (=> (= tmp%5@ (Mul d6~56@ d6~56@)) (=> (= tmp%6@ (Mul b6~52@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%6 (= temp_6_0~483@ temp_6_1~500@))))) (=> (= temp_6_0~483@ temp_6_1~500@) (=> (= temp_7_0~553@ (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@))) (=> (= temp_7_1~570@ (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ c7~62@) (=> %%location_label%%7 (= temp_7_0~553@ temp_7_1~570@))) (=> (= temp_7_0~553@ temp_7_1~570@) (=> (= temp_8_0~615@ (Mul (Sub c8~70@ c8~70@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~632@ (Mul (Mul (Sub c8~70@ c8~70@) a8~66@) d8~72@)) (=> (= tmp%7@ (Sub c8~70@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ a8~66@ d8~72@) (=> %%location_label%%8 (= temp_8_0~615@ temp_8_1~632@)))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
