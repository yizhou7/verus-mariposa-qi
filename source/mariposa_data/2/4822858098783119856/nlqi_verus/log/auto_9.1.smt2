...
(declare-const temp_2_0~209@ Int)
(declare-const temp_2_1~222@ Int)
(declare-const temp_3_0~263@ Int)
(declare-const temp_3_1~280@ Int)
(declare-const temp_4_0~321@ Int)
(declare-const temp_4_1~338@ Int)
(declare-const temp_5_0~379@ Int)
(declare-const temp_5_1~396@ Int)
(declare-const temp_6_0~437@ Int)
(declare-const temp_6_1~454@ Int)
(declare-const temp_7_0~495@ Int)
(declare-const temp_7_1~512@ Int)
(declare-const temp_8_0~553@ Int)
(declare-const temp_8_1~570@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ d0~8@) (Sub b0~4@ c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@))) (=> (= temp_1_1~172@ (Mul (Mul (Mul b1~12@ b1~12@) a1~10@) a1~10@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~209@ (Mul d2~24@ (Mul a2~18@ d2~24@))) (=> (= temp_2_1~222@ (Mul (Mul a2~18@ d2~24@) d2~24@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~209@ temp_2_1~222@))) (=> (= temp_2_0~209@ temp_2_1~222@) (=> (= temp_3_0~263@ (Mul (Mul d3~32@ a3~26@) (Sub d3~32@ d3~32@))) (=> (= temp_3_1~280@ (Mul d3~32@ (Mul a3~26@ (Sub d3~32@ d3~32@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~263@ temp_3_1~280@))) (=> (= temp_3_0~263@ temp_3_1~280@) (=> (= temp_4_0~321@ (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@))) (=> (= temp_4_1~338@ (Mul d4~40@ (Mul b4~36@ (Mul b4~36@ d4~40@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~321@ temp_4_1~338@))) (=> (= temp_4_0~321@ temp_4_1~338@) (=> (= temp_5_0~379@ (Add (Sub b5~44@ b5~44@) (Mul b5~44@ a5~42@))) (=> (= temp_5_1~396@ (Add (Sub b5~44@ b5~44@) (Mul a5~42@ b5~44@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~379@ temp_5_1~396@))) (=> (= temp_5_0~379@ temp_5_1~396@) (=> (= temp_6_0~437@ (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ a6~50@))) (=> (= temp_6_1~454@ (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~437@ temp_6_1~454@))) (=> (= temp_6_0~437@ temp_6_1~454@) (=> (= temp_7_0~495@ (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@))) (=> (= temp_7_1~512@ (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~495@ temp_7_1~512@))) (=> (= temp_7_0~495@ temp_7_1~512@) (=> (= temp_8_0~553@ (Mul (Sub c8~70@ c8~70@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~570@ (Mul (Mul (Sub c8~70@ c8~70@) a8~66@) d8~72@)) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~553@ temp_8_1~570@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
