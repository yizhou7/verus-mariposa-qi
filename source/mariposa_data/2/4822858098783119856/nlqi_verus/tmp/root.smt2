...
;; mariposa_data/2//4822858098783119856/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_2_0~195@ Int)
 (declare-const temp_2_1~208@ Int)
 (declare-const temp_3_0~240@ Int)
 (declare-const temp_3_1~257@ Int)
 (declare-const temp_4_0~289@ Int)
 (declare-const temp_4_1~306@ Int)
 (declare-const temp_5_0~338@ Int)
 (declare-const temp_5_1~355@ Int)
 (declare-const temp_6_0~387@ Int)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ c0~6@)))
      (=>
       (= temp_0_1~118@ (Mul (Mul c0~6@ d0~8@) (Sub b0~4@ c0~6@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@)))
           (=>
            (= temp_1_1~167@ (Mul (Mul (Mul b1~12@ b1~12@) a1~10@) a1~10@))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~195@ (Mul d2~24@ (Mul a2~18@ d2~24@)))
                (=>
                 (= temp_2_1~208@ (Mul (Mul a2~18@ d2~24@) d2~24@))
                 (=>
                  (= tmp%3@ (= temp_2_0~195@ temp_2_1~208@))
                  (and
                   (=>
                    %%location_label%%2
                    tmp%3@
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~240@ (Mul (Mul d3~32@ a3~26@) (Sub d3~32@ d3~32@)))
                     (=>
                      (= temp_3_1~257@ (Mul d3~32@ (Mul a3~26@ (Sub d3~32@ d3~32@))))
                      (=>
                       (= tmp%4@ (= temp_3_0~240@ temp_3_1~257@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~289@ (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ d4~40@)))
                          (=>
                           (= temp_4_1~306@ (Mul d4~40@ (Mul b4~36@ (Mul b4~36@ d4~40@))))
                           (=>
                            (= tmp%5@ (= temp_4_0~289@ temp_4_1~306@))
                            (and
                             (=>
                              %%location_label%%4
                              tmp%5@
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~338@ (Add (Sub b5~44@ b5~44@) (Mul b5~44@ a5~42@)))
                               (=>
                                (= temp_5_1~355@ (Add (Sub b5~44@ b5~44@) (Mul a5~42@ b5~44@)))
                                (=>
                                 (= tmp%6@ (= temp_5_0~338@ temp_5_1~355@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~387@ (Mul (Mul d6~56@ d6~56@) (Mul b6~52@ a6~50@)))
                                    (=>
                                     (= temp_6_1~404@ (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ d6~56@)))
                                     (=>
                                      (= tmp%7@ (= temp_6_0~387@ temp_6_1~404@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~436@ (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@)))
                                         (=>
                                          (= temp_7_1~453@ (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@)))
                                          (=>
                                           ...
                                           (and
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~485@ (Mul (Sub c8~70@ c8~70@) (Mul a8~66@ d8~72@)))
                                              (=>
                                               (= temp_8_1~502@ (Mul (Mul (Sub c8~70@ c8~70@) a8~66@) d8~72@))
                                               (=>
