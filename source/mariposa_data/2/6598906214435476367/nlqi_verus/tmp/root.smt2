...
;; mariposa_data/2//6598906214435476367/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_6_0~407@ Int)
 (declare-const temp_6_1~456@ Int)
 (declare-const temp_7_0~488@ Int)
 (declare-const temp_7_1~505@ Int)
 (declare-const temp_8_0~537@ Int)
 (declare-const temp_8_1~554@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ b0~4@)))
      (=>
       (= temp_0_1~118@ (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) b0~4@))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Mul (Sub d1~16@ d1~16@) (Mul c1~14@ a1~10@)))
           (=>
            (= temp_1_1~167@ (Mul (Sub d1~16@ d1~16@) (Mul a1~10@ c1~14@)))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~199@ (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@)))
                (=>
                 (= temp_2_1~216@ (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@)))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~248@ (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@)))
                     (=>
                      (= temp_3_1~265@ (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@)))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~297@ (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@)))
                          (=>
                           (= temp_4_1~314@ (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ c4~38@)))
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~346@ (Mul (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@)))
                               (=>
                                (= temp_5_1~363@ (Mul (Mul a5~42@ b5~44@) (Sub b5~44@ d5~48@)))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~407@ (Mul (Sub a6~50@ d6~56@) (Mul 54 b6~52@)))
                                    (=>
                                     (= temp_6_1~456@ (Sub (Mul a6~50@ (Mul 54 b6~52@)) (Mul d6~56@ (Mul 54 b6~52@))))
                                     (=>
                                      (= tmp%7@ (= temp_6_0~407@ temp_6_1~456@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~488@ (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ d7~64@)))
                                         (=>
                                          (= temp_7_1~505@ (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ d7~64@)))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~488@ temp_7_1~505@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~537@ (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ b8~68@)))
                                              (=>
                                               (= temp_8_1~554@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@)))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~537@ temp_8_1~554@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
