...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) b0~4@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Sub d1~16@ d1~16@) (Mul c1~14@ a1~10@))) (=> (= temp_1_1~172@ (Mul (Sub d1~16@ d1~16@) (Mul a1~10@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@))) (=> (= temp_2_1~230@ (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@))) (=> (= temp_3_1~288@ (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~288@))) (=> (= temp_3_0~271@ temp_3_1~288@) (=> (= temp_4_0~329@ (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@))) (=> (= temp_4_1~346@ (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~329@ temp_4_1~346@))) (=> (= temp_4_0~329@ temp_4_1~346@) (=> (= temp_5_0~387@ (Mul (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@))) (=> (= temp_5_1~404@ (Mul (Mul a5~42@ b5~44@) (Sub b5~44@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~387@ temp_5_1~404@))) (=> (= temp_5_0~387@ temp_5_1~404@) (=> (= temp_6_0~457@ (Mul (Sub a6~50@ d6~56@) (Mul 54 b6~52@))) (=> (= temp_6_1~506@ (Sub (Mul a6~50@ (Mul 54 b6~52@)) (Mul d6~56@ (Mul 54 b6~52@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~457@ temp_6_1~506@))) (=> (= temp_6_0~457@ temp_6_1~506@) (=> (= temp_7_0~547@ (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ d7~64@))) (=> (= temp_7_1~564@ (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~547@ temp_7_1~564@))) (=> (= temp_7_0~547@ temp_7_1~564@) (=> (= temp_8_0~605@ (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ b8~68@))) (=> (= temp_8_1~622@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~605@ temp_8_1~622@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
