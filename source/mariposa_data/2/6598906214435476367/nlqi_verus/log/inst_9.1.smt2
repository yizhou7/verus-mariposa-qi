...
(set-info :comment ";; mariposa_data/2//6598906214435476367/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_3_0~289@ Int)
(declare-const temp_3_1~306@ Int)
(declare-const temp_4_0~359@ Int)
(declare-const temp_4_1~376@ Int)
(declare-const temp_5_0~421@ Int)
(declare-const temp_5_1~438@ Int)
(declare-const temp_6_0~503@ Int)
(declare-const temp_6_1~552@ Int)
(declare-const temp_7_0~615@ Int)
(declare-const temp_7_1~632@ Int)
(declare-const temp_8_0~677@ Int)
(declare-const temp_8_1~694@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) b0~4@)) (and (=> (= tmp%1@ (Mul d0~8@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@)))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~165@ (Mul (Sub d1~16@ d1~16@) (Mul c1~14@ a1~10@))) (=> (= temp_1_1~182@ (Mul (Sub d1~16@ d1~16@) (Mul a1~10@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ a1~10@) (=> %%location_label%%1 (= temp_1_0~165@ temp_1_1~182@))) (=> (= temp_1_0~165@ temp_1_1~182@) (=> (= temp_2_0~227@ (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@))) (=> (= temp_2_1~244@ (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ c2~22@) (=> %%location_label%%2 (= temp_2_0~227@ temp_2_1~244@))) (=> (= temp_2_0~227@ temp_2_1~244@) (=> (= temp_3_0~289@ (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@))) (=> (= temp_3_1~306@ (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@))) (and (=> (= tmp%2@ (Mul c3~30@ d3~32@)) (=> (= tmp%3@ (Mul b3~28@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~289@ temp_3_1~306@))))) (=> (= temp_3_0~289@ temp_3_1~306@) (=> (= temp_4_0~359@ (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@))) (=> (= temp_4_1~376@ (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ c4~38@) (=> %%location_label%%4 (= temp_4_0~359@ temp_4_1~376@))) (=> (= temp_4_0~359@ temp_4_1~376@) (=> (= temp_5_0~421@ (Mul (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@))) (=> (= temp_5_1~438@ (Mul (Mul a5~42@ b5~44@) (Sub b5~44@ d5~48@))) (and (=> (= tmp%4@ (Sub b5~44@ d5~48@)) (=> (= tmp%5@ (Mul a5~42@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%5 (= temp_5_0~421@ temp_5_1~438@))))) (=> (= temp_5_0~421@ temp_5_1~438@) (=> (= temp_6_0~503@ (Mul (Sub a6~50@ d6~56@) (Mul 54 b6~52@))) (=> (= temp_6_1~552@ (Sub (Mul a6~50@ (Mul 54 b6~52@)) (Mul d6~56@ (Mul 54 b6~52@)))) (and (=> (= tmp%6@ (Mul 54 b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a6~50@ d6~56@ tmp%6@) (=> %%location_label%%6 (= temp_6_0~503@ temp_6_1~552@)))) (=> (= temp_6_0~503@ temp_6_1~552@) (=> (= temp_7_0~615@ (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ d7~64@))) (=> (= temp_7_1~632@ (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ d7~64@) (=> %%location_label%%7 (= temp_7_0~615@ temp_7_1~632@))) (=> (= temp_7_0~615@ temp_7_1~632@) (=> (= temp_8_0~677@ (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ b8~68@))) (=> (= temp_8_1~694@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ b8~68@) (=> %%location_label%%8 (= temp_8_0~677@ temp_8_1~694@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
