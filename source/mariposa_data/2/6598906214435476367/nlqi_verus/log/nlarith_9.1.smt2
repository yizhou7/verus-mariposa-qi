...
(declare-const temp_6_1~452@ Int)
(declare-const temp_7_0~484@ Int)
(declare-const temp_7_1~501@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) b0~4@)) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Sub d1~16@ d1~16@) (Mul c1~14@ a1~10@))) (=> (= temp_1_1~163@ (Mul (Sub d1~16@ d1~16@) (Mul a1~10@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@))) (=> (= temp_2_1~212@ (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ c2~22@))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~212@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~244@ (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ c3~30@))) (=> (= temp_3_1~261@ (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@))) (=> (= tmp%4@ (= temp_3_0~244@ temp_3_1~261@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~293@ (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@))) (=> (= temp_4_1~310@ (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ c4~38@))) (=> (= tmp%5@ (= temp_4_0~293@ temp_4_1~310@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~342@ (Mul (Sub b5~44@ d5~48@) (Mul a5~42@ b5~44@))) (=> (= temp_5_1~359@ (Mul (Mul a5~42@ b5~44@) (Sub b5~44@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~342@ temp_5_1~359@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~403@ (Mul (Sub a6~50@ d6~56@) (Mul 54 b6~52@))) (=> (= temp_6_1~452@ (Sub (Mul a6~50@ (Mul 54 b6~52@)) (Mul d6~56@ (Mul 54 b6~52@)))) (=> (= tmp%7@ (= temp_6_0~403@ temp_6_1~452@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~484@ (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ d7~64@))) (=> (= temp_7_1~501@ (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ d7~64@))) (=> (= tmp%8@ (= temp_7_0~484@ temp_7_1~501@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~533@ (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ b8~68@))) (=> (= temp_8_1~550@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))) (=> (= tmp%9@ (= temp_8_0~533@ temp_8_1~550@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
