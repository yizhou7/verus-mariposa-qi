...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ a0~2@) (Sub d0~8@ a0~2@))) (=> (= temp_0_1~122@ (Sub (Mul (Mul a0~2@ a0~2@) d0~8@) (Mul (Mul a0~2@ a0~2@) a0~2@))) (=> (= tmp%1@ (Mul a0~2@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ d0~8@ a0~2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@)))))))))
(assert %%query%%)
(check-sat)
