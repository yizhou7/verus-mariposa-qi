...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ a0~2@) (Sub d0~8@ a0~2@))) (=> (= temp_0_1~122@ (Sub (Mul (Mul a0~2@ a0~2@) d0~8@) (Mul (Mul a0~2@ a0~2@) a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@))) (=> (= temp_0_0~97@ temp_0_1~122@) (=> (= temp_1_0~163@ (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ d1~16@))) (=> (= temp_1_1~180@ (Mul b1~12@ (Mul c1~14@ (Mul a1~10@ d1~16@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~163@ temp_1_1~180@))) (=> (= temp_1_0~163@ temp_1_1~180@) (=> (= temp_2_0~221@ (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ b2~20@))) (=> (= temp_2_1~238@ (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~221@ temp_2_1~238@))) (=> (= temp_2_0~221@ temp_2_1~238@) (=> (= temp_3_0~279@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ b3~28@))) (=> (= temp_3_1~296@ (Mul (Mul (Mul a3~26@ a3~26@) d3~32@) b3~28@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~279@ temp_3_1~296@))) (=> (= temp_3_0~279@ temp_3_1~296@) (=> (= temp_4_0~337@ (Mul (Add b4~36@ a4~34@) (Mul c4~38@ b4~36@))) (=> (= temp_4_1~354@ (Mul (Add b4~36@ a4~34@) (Mul b4~36@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~337@ temp_4_1~354@))) (=> (= temp_4_0~337@ temp_4_1~354@) (=> (= temp_5_0~395@ (Add (Mul c5~46@ b5~44@) (Mul d5~48@ a5~42@))) (=> (= temp_5_1~412@ (Add (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~395@ temp_5_1~412@))) (=> (= temp_5_0~395@ temp_5_1~412@) (=> (= temp_6_0~453@ (Mul (Add b6~52@ d6~56@) (Mul b6~52@ c6~54@))) (=> (= temp_6_1~470@ (Mul (Mul (Add b6~52@ d6~56@) b6~52@) c6~54@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~453@ temp_6_1~470@))) (=> (= temp_6_0~453@ temp_6_1~470@) (=> (= temp_7_0~511@ (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ b7~60@))) (=> (= temp_7_1~528@ (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~511@ temp_7_1~528@))) (=> (= temp_7_0~511@ temp_7_1~528@) (=> (= temp_8_0~569@ (Mul (Mul a8~66@ d8~72@) (Add b8~68@ b8~68@))) (=> (= temp_8_1~586@ (Mul a8~66@ (Mul d8~72@ (Add b8~68@ b8~68@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~569@ temp_8_1~586@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
