...
(set-info :comment ";; mariposa_data/2//8726730770022699892/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_2_0~241@ Int)
(declare-const temp_2_1~258@ Int)
(declare-const temp_3_0~303@ Int)
(declare-const temp_3_1~320@ Int)
(declare-const temp_4_0~371@ Int)
(declare-const temp_4_1~388@ Int)
(declare-const temp_5_0~433@ Int)
(declare-const temp_5_1~450@ Int)
(declare-const temp_6_0~495@ Int)
(declare-const temp_6_1~512@ Int)
(declare-const temp_7_0~563@ Int)
(declare-const temp_7_1~580@ Int)
(declare-const temp_8_0~625@ Int)
(declare-const temp_8_1~642@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ a0~2@) (Sub d0~8@ a0~2@))) (=> (= temp_0_1~122@ (Sub (Mul (Mul a0~2@ a0~2@) d0~8@) (Mul (Mul a0~2@ a0~2@) a0~2@))) (and (=> (= tmp%1@ (Mul a0~2@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ d0~8@ a0~2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@)))) (=> (= temp_0_0~97@ temp_0_1~122@) (=> (= temp_1_0~173@ (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ d1~16@))) (=> (= temp_1_1~190@ (Mul b1~12@ (Mul c1~14@ (Mul a1~10@ d1~16@)))) (and (=> (= tmp%2@ (Mul a1~10@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b1~12@ c1~14@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~173@ temp_1_1~190@)))) (=> (= temp_1_0~173@ temp_1_1~190@) (=> (= temp_2_0~241@ (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ b2~20@))) (=> (= temp_2_1~258@ (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ c2~22@) (=> %%location_label%%2 (= temp_2_0~241@ temp_2_1~258@))) (=> (= temp_2_0~241@ temp_2_1~258@) (=> (= temp_3_0~303@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ b3~28@))) (=> (= temp_3_1~320@ (Mul (Mul (Mul a3~26@ a3~26@) d3~32@) b3~28@)) (and (=> (= tmp%3@ (Mul a3~26@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ d3~32@ b3~28@) (=> %%location_label%%3 (= temp_3_0~303@ temp_3_1~320@)))) (=> (= temp_3_0~303@ temp_3_1~320@) (=> (= temp_4_0~371@ (Mul (Add b4~36@ a4~34@) (Mul c4~38@ b4~36@))) (=> (= temp_4_1~388@ (Mul (Add b4~36@ a4~34@) (Mul b4~36@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c4~38@ b4~36@) (=> %%location_label%%4 (= temp_4_0~371@ temp_4_1~388@))) (=> (= temp_4_0~371@ temp_4_1~388@) (=> (= temp_5_0~433@ (Add (Mul c5~46@ b5~44@) (Mul d5~48@ a5~42@))) (=> (= temp_5_1~450@ (Add (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ a5~42@) (=> %%location_label%%5 (= temp_5_0~433@ temp_5_1~450@))) (=> (= temp_5_0~433@ temp_5_1~450@) (=> (= temp_6_0~495@ (Mul (Add b6~52@ d6~56@) (Mul b6~52@ c6~54@))) (=> (= temp_6_1~512@ (Mul (Mul (Add b6~52@ d6~56@) b6~52@) c6~54@)) (and (=> (= tmp%4@ (Add b6~52@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ b6~52@ c6~54@) (=> %%location_label%%6 (= temp_6_0~495@ temp_6_1~512@)))) (=> (= temp_6_0~495@ temp_6_1~512@) (=> (= temp_7_0~563@ (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ b7~60@))) (=> (= temp_7_1~580@ (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ b7~60@) (=> %%location_label%%7 (= temp_7_0~563@ temp_7_1~580@))) (=> (= temp_7_0~563@ temp_7_1~580@) (=> (= temp_8_0~625@ (Mul (Mul a8~66@ d8~72@) (Add b8~68@ b8~68@))) (=> (= temp_8_1~642@ (Mul a8~66@ (Mul d8~72@ (Add b8~68@ b8~68@)))) (=> (= tmp%5@ (Add b8~68@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a8~66@ d8~72@ tmp%5@) (=> %%location_label%%8 (= temp_8_0~625@ temp_8_1~642@)))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
