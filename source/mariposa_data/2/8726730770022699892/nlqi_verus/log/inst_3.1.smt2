...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ a0~2@) (Sub d0~8@ a0~2@))) (=> (= temp_0_1~122@ (Sub (Mul (Mul a0~2@ a0~2@) d0~8@) (Mul (Mul a0~2@ a0~2@) a0~2@))) (and (=> (= tmp%1@ (Mul a0~2@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ d0~8@ a0~2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@)))) (=> (= temp_0_0~97@ temp_0_1~122@) (=> (= temp_1_0~173@ (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ d1~16@))) (=> (= temp_1_1~190@ (Mul b1~12@ (Mul c1~14@ (Mul a1~10@ d1~16@)))) (and (=> (= tmp%2@ (Mul a1~10@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b1~12@ c1~14@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~173@ temp_1_1~190@)))) (=> (= temp_1_0~173@ temp_1_1~190@) (=> (= temp_2_0~241@ (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ b2~20@))) (=> (= temp_2_1~258@ (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ c2~22@) (=> %%location_label%%2 (= temp_2_0~241@ temp_2_1~258@))))))))))))))))
(assert %%query%%)
(check-sat)
