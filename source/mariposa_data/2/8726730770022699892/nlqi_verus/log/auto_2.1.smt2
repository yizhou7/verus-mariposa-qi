...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ a0~2@) (Sub d0~8@ a0~2@))) (=> (= temp_0_1~122@ (Sub (Mul (Mul a0~2@ a0~2@) d0~8@) (Mul (Mul a0~2@ a0~2@) a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@))) (=> (= temp_0_0~97@ temp_0_1~122@) (=> (= temp_1_0~163@ (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ d1~16@))) (=> (= temp_1_1~180@ (Mul b1~12@ (Mul c1~14@ (Mul a1~10@ d1~16@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~163@ temp_1_1~180@))))))))))))
(assert %%query%%)
(check-sat)
