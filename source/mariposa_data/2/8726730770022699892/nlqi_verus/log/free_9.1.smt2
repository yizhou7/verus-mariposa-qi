...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Mul a0~2@ a0~2@) (Sub d0~8@ a0~2@))) (=> (= temp_0_1~126@ (Sub (Mul (Mul a0~2@ a0~2@) d0~8@) (Mul (Mul a0~2@ a0~2@) a0~2@))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~126@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~158@ (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ d1~16@))) (=> (= temp_1_1~175@ (Mul b1~12@ (Mul c1~14@ (Mul a1~10@ d1~16@)))) (=> (= tmp%2@ (= temp_1_0~158@ temp_1_1~175@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~207@ (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ b2~20@))) (=> (= temp_2_1~224@ (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (=> (= tmp%3@ (= temp_2_0~207@ temp_2_1~224@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~256@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ b3~28@))) (=> (= temp_3_1~273@ (Mul (Mul (Mul a3~26@ a3~26@) d3~32@) b3~28@)) (=> (= tmp%4@ (= temp_3_0~256@ temp_3_1~273@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~305@ (Mul (Add b4~36@ a4~34@) (Mul c4~38@ b4~36@))) (=> (= temp_4_1~322@ (Mul (Add b4~36@ a4~34@) (Mul b4~36@ c4~38@))) (=> (= tmp%5@ (= temp_4_0~305@ temp_4_1~322@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~354@ (Add (Mul c5~46@ b5~44@) (Mul d5~48@ a5~42@))) (=> (= temp_5_1~371@ (Add (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~354@ temp_5_1~371@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~403@ (Mul (Add b6~52@ d6~56@) (Mul b6~52@ c6~54@))) (=> (= temp_6_1~420@ (Mul (Mul (Add b6~52@ d6~56@) b6~52@) c6~54@)) (=> (= tmp%7@ (= temp_6_0~403@ temp_6_1~420@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~452@ (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ b7~60@))) (=> (= temp_7_1~469@ (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@))) (=> (= tmp%8@ (= temp_7_0~452@ temp_7_1~469@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~501@ (Mul (Mul a8~66@ d8~72@) (Add b8~68@ b8~68@))) (=> (= temp_8_1~518@ (Mul a8~66@ (Mul d8~72@ (Add b8~68@ b8~68@)))) (=> (= tmp%9@ (= temp_8_0~501@ temp_8_1~518@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
