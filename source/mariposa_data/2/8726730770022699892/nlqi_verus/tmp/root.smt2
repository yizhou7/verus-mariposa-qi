...
;; mariposa_data/2//8726730770022699892/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul a0~2@ a0~2@) (Sub d0~8@ a0~2@)))
      (=>
       (= temp_0_1~126@ (Sub (Mul (Mul a0~2@ a0~2@) d0~8@) (Mul (Mul a0~2@ a0~2@) a0~2@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~158@ (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ d1~16@)))
           (=>
            (= temp_1_1~175@ (Mul b1~12@ (Mul c1~14@ (Mul a1~10@ d1~16@))))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~207@ (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ b2~20@)))
                (=>
                 (= temp_2_1~224@ (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ b2~20@)))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~256@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ b3~28@)))
                     (=>
                      (= temp_3_1~273@ (Mul (Mul (Mul a3~26@ a3~26@) d3~32@) b3~28@))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~305@ (Mul (Add b4~36@ a4~34@) (Mul c4~38@ b4~36@)))
                          (=>
                           (= temp_4_1~322@ (Mul (Add b4~36@ a4~34@) (Mul b4~36@ c4~38@)))
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~354@ (Add (Mul c5~46@ b5~44@) (Mul d5~48@ a5~42@)))
                               (=>
                                (= temp_5_1~371@ (Add (Mul c5~46@ b5~44@) (Mul a5~42@ d5~48@)))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~403@ (Mul (Add b6~52@ d6~56@) (Mul b6~52@ c6~54@)))
                                    (=>
                                     (= temp_6_1~420@ (Mul (Mul (Add b6~52@ d6~56@) b6~52@) c6~54@))
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~452@ (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ b7~60@)))
                                         (=>
                                          (= temp_7_1~469@ (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@)))
                                          (=>
                                           ...
                                           (and
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~501@ (Mul (Mul a8~66@ d8~72@) (Add b8~68@ b8~68@)))
                                              (=>
                                               (= temp_8_1~518@ (Mul a8~66@ (Mul d8~72@ (Add b8~68@ b8~68@))))
                                               (=>
