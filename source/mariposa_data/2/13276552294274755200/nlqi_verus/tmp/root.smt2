...
;; mariposa_data/2//13276552294274755200/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_4_1~346@ Int)
 (declare-const temp_5_0~378@ Int)
 (declare-const temp_5_1~395@ Int)
 (declare-const temp_6_0~427@ Int)
 (declare-const temp_6_1~444@ Int)
 (declare-const temp_7_0~476@ Int)
 (declare-const temp_7_1~493@ Int)
 (declare-const temp_8_0~525@ Int)
 (declare-const temp_8_1~542@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Sub d0~8@ b0~4@) (Mul a0~2@ d0~8@)))
      (=>
       (= temp_0_1~118@ (Mul (Sub d0~8@ b0~4@) (Mul d0~8@ a0~2@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Mul (Mul b1~12@ b1~12@) (Add d1~16@ a1~10@)))
           (=>
            (= temp_1_1~175@ (Add (Mul (Mul b1~12@ b1~12@) d1~16@) (Mul (Mul b1~12@ b1~12@) a1~10@)))
            (=>
             (= tmp%2@ (= temp_1_0~150@ temp_1_1~175@))
             (and
              (=>
               %%location_label%%1
               tmp%2@
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~207@ (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ c2~22@)))
                (=>
                 (= temp_2_1~224@ (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ a2~18@)))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~256@ (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@)))
                     (=>
                      (= temp_3_1~273@ (Mul (Mul (Mul d3~32@ b3~28@) c3~30@) c3~30@))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~317@ (Mul (Mul d4~40@ 16) (Mul a4~34@ a4~34@)))
                          (=>
                           (= temp_4_1~346@ (Mul d4~40@ (Mul 16 (Mul a4~34@ a4~34@))))
                           (=>
                            (= tmp%5@ (= temp_4_0~317@ temp_4_1~346@))
                            (and
                             (=>
                              %%location_label%%4
                              tmp%5@
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~378@ (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@)))
                               (=>
                                (= temp_5_1~395@ (Mul b5~44@ (Mul a5~42@ (Mul c5~46@ b5~44@))))
                                (=>
                                 (= tmp%6@ (= temp_5_0~378@ temp_5_1~395@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~427@ (Add (Mul a6~50@ b6~52@) (Mul d6~56@ a6~50@)))
                                    (=>
                                     (= temp_6_1~444@ (Add (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@)))
                                     (=>
                                      (= tmp%7@ (= temp_6_0~427@ temp_6_1~444@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~476@ (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ a7~58@)))
                                         (=>
                                          (= temp_7_1~493@ (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ b7~60@)))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~476@ temp_7_1~493@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~525@ (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@)))
                                              (=>
                                               (= temp_8_1~542@ (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ b8~68@)))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~525@ temp_8_1~542@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
