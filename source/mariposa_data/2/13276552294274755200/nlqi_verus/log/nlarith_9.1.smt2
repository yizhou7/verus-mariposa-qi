...
(declare-const temp_5_0~374@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub d0~8@ b0~4@) (Mul a0~2@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Sub d0~8@ b0~4@) (Mul d0~8@ a0~2@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Mul b1~12@ b1~12@) (Add d1~16@ a1~10@))) (=> (= temp_1_1~171@ (Add (Mul (Mul b1~12@ b1~12@) d1~16@) (Mul (Mul b1~12@ b1~12@) a1~10@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~171@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~203@ (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ c2~22@))) (=> (= temp_2_1~220@ (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ a2~18@))) (=> (= tmp%3@ (= temp_2_0~203@ temp_2_1~220@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~252@ (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@))) (=> (= temp_3_1~269@ (Mul (Mul (Mul d3~32@ b3~28@) c3~30@) c3~30@)) (=> (= tmp%4@ (= temp_3_0~252@ temp_3_1~269@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~313@ (Mul (Mul d4~40@ 16) (Mul a4~34@ a4~34@))) (=> (= temp_4_1~342@ (Mul d4~40@ (Mul 16 (Mul a4~34@ a4~34@)))) (=> (= tmp%5@ (= temp_4_0~313@ temp_4_1~342@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~374@ (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))) (=> (= temp_5_1~391@ (Mul b5~44@ (Mul a5~42@ (Mul c5~46@ b5~44@)))) (=> (= tmp%6@ (= temp_5_0~374@ temp_5_1~391@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~423@ (Add (Mul a6~50@ b6~52@) (Mul d6~56@ a6~50@))) (=> (= temp_6_1~440@ (Add (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@))) (=> (= tmp%7@ (= temp_6_0~423@ temp_6_1~440@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~472@ (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ a7~58@))) (=> (= temp_7_1~489@ (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ b7~60@))) (=> (= tmp%8@ (= temp_7_0~472@ temp_7_1~489@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~521@ (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))) (=> (= temp_8_1~538@ (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ b8~68@))) (=> (= tmp%9@ (= temp_8_0~521@ temp_8_1~538@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
