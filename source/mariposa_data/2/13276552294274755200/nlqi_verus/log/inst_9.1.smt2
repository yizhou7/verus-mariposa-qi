...
(set-info :comment ";; mariposa_data/2//13276552294274755200/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_1~184@ Int)
(declare-const temp_2_0~235@ Int)
(declare-const temp_2_1~252@ Int)
(declare-const temp_3_0~305@ Int)
(declare-const temp_3_1~322@ Int)
(declare-const temp_4_0~385@ Int)
(declare-const temp_4_1~414@ Int)
(declare-const temp_5_0~477@ Int)
(declare-const temp_5_1~494@ Int)
(declare-const temp_6_0~545@ Int)
(declare-const temp_6_1~562@ Int)
(declare-const temp_7_0~607@ Int)
(declare-const temp_7_1~624@ Int)
(declare-const temp_8_0~669@ Int)
(declare-const temp_8_1~686@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub d0~8@ b0~4@) (Mul a0~2@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Sub d0~8@ b0~4@) (Mul d0~8@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ d0~8@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul b1~12@ b1~12@) (Add d1~16@ a1~10@))) (=> (= temp_1_1~184@ (Add (Mul (Mul b1~12@ b1~12@) d1~16@) (Mul (Mul b1~12@ b1~12@) a1~10@))) (and (=> (= tmp%1@ (Mul b1~12@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ d1~16@ a1~10@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~184@)))) (=> (= temp_1_0~159@ temp_1_1~184@) (=> (= temp_2_0~235@ (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ c2~22@))) (=> (= temp_2_1~252@ (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ a2~18@))) (and (=> (= tmp%2@ (Mul c2~22@ a2~18@)) (=> (= tmp%3@ (Mul a2~18@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~235@ temp_2_1~252@))))) (=> (= temp_2_0~235@ temp_2_1~252@) (=> (= temp_3_0~305@ (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@))) (=> (= temp_3_1~322@ (Mul (Mul (Mul d3~32@ b3~28@) c3~30@) c3~30@)) (and (=> (= tmp%4@ (Mul d3~32@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ c3~30@ c3~30@) (=> %%location_label%%3 (= temp_3_0~305@ temp_3_1~322@)))) (=> (= temp_3_0~305@ temp_3_1~322@) (=> (= temp_4_0~385@ (Mul (Mul d4~40@ 16) (Mul a4~34@ a4~34@))) (=> (= temp_4_1~414@ (Mul d4~40@ (Mul 16 (Mul a4~34@ a4~34@)))) (and (=> (= tmp%5@ (Mul a4~34@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d4~40@ 16 tmp%5@) (=> %%location_label%%4 (= temp_4_0~385@ temp_4_1~414@)))) (=> (= temp_4_0~385@ temp_4_1~414@) (=> (= temp_5_0~477@ (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))) (=> (= temp_5_1~494@ (Mul b5~44@ (Mul a5~42@ (Mul c5~46@ b5~44@)))) (and (=> (= tmp%6@ (Mul c5~46@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b5~44@ a5~42@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~477@ temp_5_1~494@)))) (=> (= temp_5_0~477@ temp_5_1~494@) (=> (= temp_6_0~545@ (Add (Mul a6~50@ b6~52@) (Mul d6~56@ a6~50@))) (=> (= temp_6_1~562@ (Add (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ a6~50@) (=> %%location_label%%6 (= temp_6_0~545@ temp_6_1~562@))) (=> (= temp_6_0~545@ temp_6_1~562@) (=> (= temp_7_0~607@ (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ a7~58@))) (=> (= temp_7_1~624@ (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ b7~60@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ a7~58@) (=> %%location_label%%7 (= temp_7_0~607@ temp_7_1~624@))) (=> (= temp_7_0~607@ temp_7_1~624@) (=> (= temp_8_0~669@ (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))) (=> (= temp_8_1~686@ (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ b8~68@))) (=> (= tmp%7@ (Mul a8~66@ b8~68@)) (=> (= tmp%8@ (Mul a8~66@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%8 (= temp_8_0~669@ temp_8_1~686@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
