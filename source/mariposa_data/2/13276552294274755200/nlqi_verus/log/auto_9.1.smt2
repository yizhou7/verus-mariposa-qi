...
(declare-const temp_5_1~436@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub d0~8@ b0~4@) (Mul a0~2@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Sub d0~8@ b0~4@) (Mul d0~8@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul b1~12@ b1~12@) (Add d1~16@ a1~10@))) (=> (= temp_1_1~180@ (Add (Mul (Mul b1~12@ b1~12@) d1~16@) (Mul (Mul b1~12@ b1~12@) a1~10@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~180@))) (=> (= temp_1_0~155@ temp_1_1~180@) (=> (= temp_2_0~221@ (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ c2~22@))) (=> (= temp_2_1~238@ (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ a2~18@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~221@ temp_2_1~238@))) (=> (= temp_2_0~221@ temp_2_1~238@) (=> (= temp_3_0~279@ (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@))) (=> (= temp_3_1~296@ (Mul (Mul (Mul d3~32@ b3~28@) c3~30@) c3~30@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~279@ temp_3_1~296@))) (=> (= temp_3_0~279@ temp_3_1~296@) (=> (= temp_4_0~349@ (Mul (Mul d4~40@ 16) (Mul a4~34@ a4~34@))) (=> (= temp_4_1~378@ (Mul d4~40@ (Mul 16 (Mul a4~34@ a4~34@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~349@ temp_4_1~378@))) (=> (= temp_4_0~349@ temp_4_1~378@) (=> (= temp_5_0~419@ (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))) (=> (= temp_5_1~436@ (Mul b5~44@ (Mul a5~42@ (Mul c5~46@ b5~44@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~419@ temp_5_1~436@))) (=> (= temp_5_0~419@ temp_5_1~436@) (=> (= temp_6_0~477@ (Add (Mul a6~50@ b6~52@) (Mul d6~56@ a6~50@))) (=> (= temp_6_1~494@ (Add (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~477@ temp_6_1~494@))) (=> (= temp_6_0~477@ temp_6_1~494@) (=> (= temp_7_0~535@ (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ a7~58@))) (=> (= temp_7_1~552@ (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ b7~60@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~535@ temp_7_1~552@))) (=> (= temp_7_0~535@ temp_7_1~552@) (=> (= temp_8_0~593@ (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))) (=> (= temp_8_1~610@ (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~593@ temp_8_1~610@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
