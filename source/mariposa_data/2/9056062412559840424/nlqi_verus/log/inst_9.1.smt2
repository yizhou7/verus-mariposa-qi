...
(set-info :comment ";; mariposa_data/2//9056062412559840424/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_3_0~287@ Int)
(declare-const temp_3_1~304@ Int)
(declare-const temp_4_0~357@ Int)
(declare-const temp_4_1~374@ Int)
(declare-const temp_5_0~427@ Int)
(declare-const temp_5_1~452@ Int)
(declare-const temp_6_0~503@ Int)
(declare-const temp_6_1~520@ Int)
(declare-const temp_7_0~565@ Int)
(declare-const temp_7_1~582@ Int)
(declare-const temp_8_0~635@ Int)
(declare-const temp_8_1~652@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ a0~2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ d1~16@))) (=> (= temp_1_1~176@ (Mul (Mul (Mul d1~16@ b1~12@) c1~14@) d1~16@)) (and (=> (= tmp%1@ (Mul d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ c1~14@ d1~16@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@)))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~227@ (Sub (Mul c2~22@ d2~24@) (Mul c2~22@ d2~24@))) (=> (= temp_2_1~240@ (Mul (Sub c2~22@ c2~22@) d2~24@)) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. c2~22@ c2~22@ d2~24@) (=> %%location_label%%2 (= temp_2_0~227@ temp_2_1~240@))) (=> (= temp_2_0~227@ temp_2_1~240@) (=> (= temp_3_0~287@ (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ d3~32@))) (=> (= temp_3_1~304@ (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ d3~32@))) (and (=> (= tmp%2@ (Mul a3~26@ d3~32@)) (=> (= tmp%3@ (Mul c3~30@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%3 (= temp_3_0~287@ temp_3_1~304@))))) (=> (= temp_3_0~287@ temp_3_1~304@) (=> (= temp_4_0~357@ (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@))) (=> (= temp_4_1~374@ (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ c4~38@))) (and (=> (= tmp%4@ (Mul c4~38@ c4~38@)) (=> (= tmp%5@ (Mul b4~36@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%4 (= temp_4_0~357@ temp_4_1~374@))))) (=> (= temp_4_0~357@ temp_4_1~374@) (=> (= temp_5_0~427@ (Mul (Add a5~42@ a5~42@) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~452@ (Add (Mul a5~42@ (Mul b5~44@ d5~48@)) (Mul a5~42@ (Mul b5~44@ d5~48@)))) (and (=> (= tmp%6@ (Mul b5~44@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a5~42@ a5~42@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~427@ temp_5_1~452@)))) (=> (= temp_5_0~427@ temp_5_1~452@) (=> (= temp_6_0~503@ (Mul (Mul d6~56@ c6~54@) (Sub d6~56@ b6~52@))) (=> (= temp_6_1~520@ (Mul (Mul c6~54@ d6~56@) (Sub d6~56@ b6~52@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ c6~54@) (=> %%location_label%%6 (= temp_6_0~503@ temp_6_1~520@))) (=> (= temp_6_0~503@ temp_6_1~520@) (=> (= temp_7_0~565@ (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ c7~62@))) (=> (= temp_7_1~582@ (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@))) (and (=> (= tmp%7@ (Mul b7~60@ d7~64@)) (=> (= tmp%8@ (Mul b7~60@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%7 (= temp_7_0~565@ temp_7_1~582@))))) (=> (= temp_7_0~565@ temp_7_1~582@) (=> (= temp_8_0~635@ (Add (Mul b8~68@ a8~66@) (Mul c8~70@ a8~66@))) (=> (= temp_8_1~652@ (Add (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ a8~66@) (=> %%location_label%%8 (= temp_8_0~635@ temp_8_1~652@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
