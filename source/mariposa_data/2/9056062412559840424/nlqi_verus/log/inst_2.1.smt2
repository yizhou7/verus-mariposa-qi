...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ a0~2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ d1~16@))) (=> (= temp_1_1~176@ (Mul (Mul (Mul d1~16@ b1~12@) c1~14@) d1~16@)) (=> (= tmp%1@ (Mul d1~16@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ c1~14@ d1~16@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@)))))))))))))
(assert %%query%%)
(check-sat)
