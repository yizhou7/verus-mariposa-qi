...
(declare-const temp_2_1~226@ Int)
(declare-const temp_3_0~267@ Int)
(declare-const temp_3_1~284@ Int)
(declare-const temp_4_0~325@ Int)
(declare-const temp_4_1~342@ Int)
(declare-const temp_5_0~383@ Int)
(declare-const temp_5_1~408@ Int)
(declare-const temp_6_0~449@ Int)
(declare-const temp_6_1~466@ Int)
(declare-const temp_7_0~507@ Int)
(declare-const temp_7_1~524@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ d1~16@))) (=> (= temp_1_1~172@ (Mul (Mul (Mul d1~16@ b1~12@) c1~14@) d1~16@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Sub (Mul c2~22@ d2~24@) (Mul c2~22@ d2~24@))) (=> (= temp_2_1~226@ (Mul (Sub c2~22@ c2~22@) d2~24@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~226@))) (=> (= temp_2_0~213@ temp_2_1~226@) (=> (= temp_3_0~267@ (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ d3~32@))) (=> (= temp_3_1~284@ (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~267@ temp_3_1~284@))) (=> (= temp_3_0~267@ temp_3_1~284@) (=> (= temp_4_0~325@ (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@))) (=> (= temp_4_1~342@ (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~325@ temp_4_1~342@))) (=> (= temp_4_0~325@ temp_4_1~342@) (=> (= temp_5_0~383@ (Mul (Add a5~42@ a5~42@) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~408@ (Add (Mul a5~42@ (Mul b5~44@ d5~48@)) (Mul a5~42@ (Mul b5~44@ d5~48@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~383@ temp_5_1~408@))) (=> (= temp_5_0~383@ temp_5_1~408@) (=> (= temp_6_0~449@ (Mul (Mul d6~56@ c6~54@) (Sub d6~56@ b6~52@))) (=> (= temp_6_1~466@ (Mul (Mul c6~54@ d6~56@) (Sub d6~56@ b6~52@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~449@ temp_6_1~466@))) (=> (= temp_6_0~449@ temp_6_1~466@) (=> (= temp_7_0~507@ (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ c7~62@))) (=> (= temp_7_1~524@ (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~507@ temp_7_1~524@))) (=> (= temp_7_0~507@ temp_7_1~524@) (=> (= temp_8_0~565@ (Add (Mul b8~68@ a8~66@) (Mul c8~70@ a8~66@))) (=> (= temp_8_1~582@ (Add (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~565@ temp_8_1~582@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
