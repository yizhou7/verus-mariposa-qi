...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ b0~4@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ d1~16@))) (=> (= temp_1_1~163@ (Mul (Mul (Mul d1~16@ b1~12@) c1~14@) d1~16@)) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Sub (Mul c2~22@ d2~24@) (Mul c2~22@ d2~24@))) (=> (= temp_2_1~208@ (Mul (Sub c2~22@ c2~22@) d2~24@)) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~208@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~240@ (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ d3~32@))) (=> (= temp_3_1~257@ (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ d3~32@))) (=> (= tmp%4@ (= temp_3_0~240@ temp_3_1~257@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~289@ (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@))) (=> (= temp_4_1~306@ (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ c4~38@))) (=> (= tmp%5@ (= temp_4_0~289@ temp_4_1~306@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~338@ (Mul (Add a5~42@ a5~42@) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~363@ (Add (Mul a5~42@ (Mul b5~44@ d5~48@)) (Mul a5~42@ (Mul b5~44@ d5~48@)))) (=> (= tmp%6@ (= temp_5_0~338@ temp_5_1~363@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~395@ (Mul (Mul d6~56@ c6~54@) (Sub d6~56@ b6~52@))) (=> (= temp_6_1~412@ (Mul (Mul c6~54@ d6~56@) (Sub d6~56@ b6~52@))) (=> (= tmp%7@ (= temp_6_0~395@ temp_6_1~412@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~444@ (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ c7~62@))) (=> (= temp_7_1~461@ (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@))) (=> (= tmp%8@ (= temp_7_0~444@ temp_7_1~461@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~493@ (Add (Mul b8~68@ a8~66@) (Mul c8~70@ a8~66@))) (=> (= temp_8_1~510@ (Add (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@))) (=> (= tmp%9@ (= temp_8_0~493@ temp_8_1~510@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
