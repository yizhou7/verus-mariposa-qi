...
;; mariposa_data/2//9056062412559840424/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_2_1~212@ Int)
 (declare-const temp_3_0~244@ Int)
 (declare-const temp_3_1~261@ Int)
 (declare-const temp_4_0~293@ Int)
 (declare-const temp_4_1~310@ Int)
 (declare-const temp_5_0~342@ Int)
 (declare-const temp_5_1~367@ Int)
 (declare-const temp_6_0~399@ Int)
 (declare-const temp_6_1~416@ Int)
 (declare-const temp_7_0~448@ Int)
 (declare-const temp_7_1~465@ Int)
 (declare-const temp_8_0~497@ Int)
 (declare-const temp_8_1~514@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@)))
      (=>
       (= temp_0_1~118@ (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ b0~4@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ d1~16@)))
           (=>
            (= temp_1_1~167@ (Mul (Mul (Mul d1~16@ b1~12@) c1~14@) d1~16@))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~199@ (Sub (Mul c2~22@ d2~24@) (Mul c2~22@ d2~24@)))
                (=>
                 (= temp_2_1~212@ (Mul (Sub c2~22@ c2~22@) d2~24@))
                 (=>
                  (= tmp%3@ (= temp_2_0~199@ temp_2_1~212@))
                  (and
                   (=>
                    %%location_label%%2
                    tmp%3@
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~244@ (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ d3~32@)))
                     (=>
                      (= temp_3_1~261@ (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ d3~32@)))
                      (=>
                       (= tmp%4@ (= temp_3_0~244@ temp_3_1~261@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~293@ (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@)))
                          (=>
                           (= temp_4_1~310@ (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ c4~38@)))
                           (=>
                            (= tmp%5@ (= temp_4_0~293@ temp_4_1~310@))
                            (and
                             (=>
                              %%location_label%%4
                              tmp%5@
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~342@ (Mul (Add a5~42@ a5~42@) (Mul b5~44@ d5~48@)))
                               (=>
                                (= temp_5_1~367@ (Add (Mul a5~42@ (Mul b5~44@ d5~48@)) (Mul a5~42@ (Mul b5~44@ d5~48@))))
                                (=>
                                 (= tmp%6@ (= temp_5_0~342@ temp_5_1~367@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~399@ (Mul (Mul d6~56@ c6~54@) (Sub d6~56@ b6~52@)))
                                    (=>
                                     (= temp_6_1~416@ (Mul (Mul c6~54@ d6~56@) (Sub d6~56@ b6~52@)))
                                     (=>
                                      (= tmp%7@ (= temp_6_0~399@ temp_6_1~416@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~448@ (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ c7~62@)))
                                         (=>
                                          (= temp_7_1~465@ (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@)))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~448@ temp_7_1~465@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~497@ (Add (Mul b8~68@ a8~66@) (Mul c8~70@ a8~66@)))
                                              (=>
                                               (= temp_8_1~514@ (Add (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@)))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~497@ temp_8_1~514@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
