...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~113@ (Mul (Mul a0~2@ a0~2@) (Mul 36 d0~8@))) (=> (= temp_0_1~142@ (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ 36))) (=> (= tmp%1@ (= temp_0_0~113@ temp_0_1~142@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~174@ (Add (Add c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (=> (= temp_1_1~191@ (Add (Add c1~14@ a1~10@) (Mul b1~12@ d1~16@))) (=> (= tmp%2@ (= temp_1_0~174@ temp_1_1~191@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~223@ (Mul (Sub d2~24@ a2~18@) (Sub a2~18@ d2~24@))) (=> (= temp_2_1~240@ (Mul (Sub a2~18@ d2~24@) (Sub d2~24@ a2~18@))) (=> (= tmp%3@ (= temp_2_0~223@ temp_2_1~240@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~284@ (Mul (Mul d3~32@ 84) (Mul d3~32@ d3~32@))) (=> (= temp_3_1~313@ (Mul (Mul 84 d3~32@) (Mul d3~32@ d3~32@))) (=> (= tmp%4@ (= temp_3_0~284@ temp_3_1~313@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~345@ (Mul (Sub c4~38@ a4~34@) (Mul c4~38@ d4~40@))) (=> (= temp_4_1~362@ (Mul (Mul (Sub c4~38@ a4~34@) c4~38@) d4~40@)) (=> (= tmp%5@ (= temp_4_0~345@ temp_4_1~362@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~394@ (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~411@ (Mul d5~48@ (Mul b5~44@ (Mul b5~44@ d5~48@)))) (=> (= tmp%6@ (= temp_5_0~394@ temp_5_1~411@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~455@ (Mul (Mul c6~54@ 34) (Mul b6~52@ d6~56@))) (=> (= temp_6_1~484@ (Mul (Mul 34 c6~54@) (Mul b6~52@ d6~56@))) (=> (= tmp%7@ (= temp_6_0~455@ temp_6_1~484@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~516@ (Add (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@))) (=> (= temp_7_1~533@ (Add (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@))) (=> (= tmp%8@ (= temp_7_0~516@ temp_7_1~533@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~565@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@))) (=> (= temp_8_1~582@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@))) (=> (= tmp%9@ (= temp_8_0~565@ temp_8_1~582@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
