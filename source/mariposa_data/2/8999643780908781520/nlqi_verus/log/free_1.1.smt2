...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~113@ (Mul (Mul a0~2@ a0~2@) (Mul 36 d0~8@))) (=> (= temp_0_1~142@ (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ 36))) (=> (= tmp%1@ (= temp_0_0~113@ temp_0_1~142@)) (=> %%location_label%%0 tmp%1@))))))))
(assert %%query%%)
(check-sat)
