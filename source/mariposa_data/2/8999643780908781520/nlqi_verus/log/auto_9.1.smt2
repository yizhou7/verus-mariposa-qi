...
(declare-const temp_3_0~307@ Int)
(declare-const temp_3_1~336@ Int)
...
(declare-const temp_8_1~650@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~109@ (Mul (Mul a0~2@ a0~2@) (Mul 36 d0~8@))) (=> (= temp_0_1~138@ (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ 36))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~109@ temp_0_1~138@))) (=> (= temp_0_0~109@ temp_0_1~138@) (=> (= temp_1_0~179@ (Add (Add c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (=> (= temp_1_1~196@ (Add (Add c1~14@ a1~10@) (Mul b1~12@ d1~16@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~179@ temp_1_1~196@))) (=> (= temp_1_0~179@ temp_1_1~196@) (=> (= temp_2_0~237@ (Mul (Sub d2~24@ a2~18@) (Sub a2~18@ d2~24@))) (=> (= temp_2_1~254@ (Mul (Sub a2~18@ d2~24@) (Sub d2~24@ a2~18@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~237@ temp_2_1~254@))) (=> (= temp_2_0~237@ temp_2_1~254@) (=> (= temp_3_0~307@ (Mul (Mul d3~32@ 84) (Mul d3~32@ d3~32@))) (=> (= temp_3_1~336@ (Mul (Mul 84 d3~32@) (Mul d3~32@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~307@ temp_3_1~336@))) (=> (= temp_3_0~307@ temp_3_1~336@) (=> (= temp_4_0~377@ (Mul (Sub c4~38@ a4~34@) (Mul c4~38@ d4~40@))) (=> (= temp_4_1~394@ (Mul (Mul (Sub c4~38@ a4~34@) c4~38@) d4~40@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~377@ temp_4_1~394@))) (=> (= temp_4_0~377@ temp_4_1~394@) (=> (= temp_5_0~435@ (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~452@ (Mul d5~48@ (Mul b5~44@ (Mul b5~44@ d5~48@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~435@ temp_5_1~452@))) (=> (= temp_5_0~435@ temp_5_1~452@) (=> (= temp_6_0~505@ (Mul (Mul c6~54@ 34) (Mul b6~52@ d6~56@))) (=> (= temp_6_1~534@ (Mul (Mul 34 c6~54@) (Mul b6~52@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~505@ temp_6_1~534@))) (=> (= temp_6_0~505@ temp_6_1~534@) (=> (= temp_7_0~575@ (Add (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@))) (=> (= temp_7_1~592@ (Add (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~575@ temp_7_1~592@))) (=> (= temp_7_0~575@ temp_7_1~592@) (=> (= temp_8_0~633@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@))) (=> (= temp_8_1~650@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~633@ temp_8_1~650@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
