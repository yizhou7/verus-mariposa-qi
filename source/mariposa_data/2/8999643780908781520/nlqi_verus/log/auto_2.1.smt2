...
(assert (=> %%query%% (not (=> (= temp_0_0~109@ (Mul (Mul a0~2@ a0~2@) (Mul 36 d0~8@))) (=> (= temp_0_1~138@ (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ 36))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~109@ temp_0_1~138@))) (=> (= temp_0_0~109@ temp_0_1~138@) (=> (= temp_1_0~179@ (Add (Add c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (=> (= temp_1_1~196@ (Add (Add c1~14@ a1~10@) (Mul b1~12@ d1~16@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~179@ temp_1_1~196@))))))))))))
(assert %%query%%)
(check-sat)
