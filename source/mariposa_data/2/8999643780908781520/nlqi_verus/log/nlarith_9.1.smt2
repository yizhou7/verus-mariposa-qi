...
(assert (=> %%query%% (not (=> (= temp_0_0~109@ (Mul (Mul a0~2@ a0~2@) (Mul 36 d0~8@))) (=> (= temp_0_1~138@ (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ 36))) (=> (= tmp%1@ (= temp_0_0~109@ temp_0_1~138@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~170@ (Add (Add c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (=> (= temp_1_1~187@ (Add (Add c1~14@ a1~10@) (Mul b1~12@ d1~16@))) (=> (= tmp%2@ (= temp_1_0~170@ temp_1_1~187@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~219@ (Mul (Sub d2~24@ a2~18@) (Sub a2~18@ d2~24@))) (=> (= temp_2_1~236@ (Mul (Sub a2~18@ d2~24@) (Sub d2~24@ a2~18@))) (=> (= tmp%3@ (= temp_2_0~219@ temp_2_1~236@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~280@ (Mul (Mul d3~32@ 84) (Mul d3~32@ d3~32@))) (=> (= temp_3_1~309@ (Mul (Mul 84 d3~32@) (Mul d3~32@ d3~32@))) (=> (= tmp%4@ (= temp_3_0~280@ temp_3_1~309@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~341@ (Mul (Sub c4~38@ a4~34@) (Mul c4~38@ d4~40@))) (=> (= temp_4_1~358@ (Mul (Mul (Sub c4~38@ a4~34@) c4~38@) d4~40@)) (=> (= tmp%5@ (= temp_4_0~341@ temp_4_1~358@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~390@ (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~407@ (Mul d5~48@ (Mul b5~44@ (Mul b5~44@ d5~48@)))) (=> (= tmp%6@ (= temp_5_0~390@ temp_5_1~407@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~451@ (Mul (Mul c6~54@ 34) (Mul b6~52@ d6~56@))) (=> (= temp_6_1~480@ (Mul (Mul 34 c6~54@) (Mul b6~52@ d6~56@))) (=> (= tmp%7@ (= temp_6_0~451@ temp_6_1~480@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~512@ (Add (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@))) (=> (= temp_7_1~529@ (Add (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@))) (=> (= tmp%8@ (= temp_7_0~512@ temp_7_1~529@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~561@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@))) (=> (= temp_8_1~578@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@))) (=> (= tmp%9@ (= temp_8_0~561@ temp_8_1~578@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
