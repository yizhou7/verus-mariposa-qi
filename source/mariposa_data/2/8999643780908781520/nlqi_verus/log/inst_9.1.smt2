...
(set-info :comment ";; mariposa_data/2//8999643780908781520/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_0_0~109@ Int)
(declare-const temp_0_1~138@ Int)
(declare-const temp_1_0~195@ Int)
(declare-const temp_1_1~212@ Int)
(declare-const temp_2_0~257@ Int)
(declare-const temp_2_1~274@ Int)
(declare-const temp_3_0~339@ Int)
(declare-const temp_3_1~368@ Int)
(declare-const temp_4_0~425@ Int)
(declare-const temp_4_1~442@ Int)
(declare-const temp_5_0~493@ Int)
(declare-const temp_5_1~510@ Int)
(declare-const temp_6_0~573@ Int)
(declare-const temp_6_1~602@ Int)
(declare-const temp_7_0~659@ Int)
(declare-const temp_7_1~676@ Int)
(declare-const temp_8_0~721@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~109@ (Mul (Mul a0~2@ a0~2@) (Mul 36 d0~8@))) (=> (= temp_0_1~138@ (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ 36))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 36 d0~8@) (=> %%location_label%%0 (= temp_0_0~109@ temp_0_1~138@))) (=> (= temp_0_0~109@ temp_0_1~138@) (=> (= temp_1_0~195@ (Add (Add c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (=> (= temp_1_1~212@ (Add (Add c1~14@ a1~10@) (Mul b1~12@ d1~16@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ b1~12@) (=> %%location_label%%1 (= temp_1_0~195@ temp_1_1~212@))) (=> (= temp_1_0~195@ temp_1_1~212@) (=> (= temp_2_0~257@ (Mul (Sub d2~24@ a2~18@) (Sub a2~18@ d2~24@))) (=> (= temp_2_1~274@ (Mul (Sub a2~18@ d2~24@) (Sub d2~24@ a2~18@))) (and (=> (= tmp%1@ (Sub d2~24@ a2~18@)) (=> (= tmp%2@ (Sub a2~18@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~257@ temp_2_1~274@))))) (=> (= temp_2_0~257@ temp_2_1~274@) (=> (= temp_3_0~339@ (Mul (Mul d3~32@ 84) (Mul d3~32@ d3~32@))) (=> (= temp_3_1~368@ (Mul (Mul 84 d3~32@) (Mul d3~32@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ 84) (=> %%location_label%%3 (= temp_3_0~339@ temp_3_1~368@))) (=> (= temp_3_0~339@ temp_3_1~368@) (=> (= temp_4_0~425@ (Mul (Sub c4~38@ a4~34@) (Mul c4~38@ d4~40@))) (=> (= temp_4_1~442@ (Mul (Mul (Sub c4~38@ a4~34@) c4~38@) d4~40@)) (and (=> (= tmp%3@ (Sub c4~38@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ c4~38@ d4~40@) (=> %%location_label%%4 (= temp_4_0~425@ temp_4_1~442@)))) (=> (= temp_4_0~425@ temp_4_1~442@) (=> (= temp_5_0~493@ (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@))) (=> (= temp_5_1~510@ (Mul d5~48@ (Mul b5~44@ (Mul b5~44@ d5~48@)))) (and (=> (= tmp%4@ (Mul b5~44@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d5~48@ b5~44@ tmp%4@) (=> %%location_label%%5 (= temp_5_0~493@ temp_5_1~510@)))) (=> (= temp_5_0~493@ temp_5_1~510@) (=> (= temp_6_0~573@ (Mul (Mul c6~54@ 34) (Mul b6~52@ d6~56@))) (=> (= temp_6_1~602@ (Mul (Mul 34 c6~54@) (Mul b6~52@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ 34) (=> %%location_label%%6 (= temp_6_0~573@ temp_6_1~602@))) (=> (= temp_6_0~573@ temp_6_1~602@) (=> (= temp_7_0~659@ (Add (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@))) (=> (= temp_7_1~676@ (Add (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ c7~62@) (=> %%location_label%%7 (= temp_7_0~659@ temp_7_1~676@))) (=> (= temp_7_0~659@ temp_7_1~676@) (=> (= temp_8_0~721@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@))) (=> (= temp_8_1~738@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ c8~70@) (=> %%location_label%%8 (= temp_8_0~721@ temp_8_1~738@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
