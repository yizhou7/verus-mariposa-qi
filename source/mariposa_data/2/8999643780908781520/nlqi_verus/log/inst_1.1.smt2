...
(assert (=> %%query%% (not (=> (= temp_0_0~109@ (Mul (Mul a0~2@ a0~2@) (Mul 36 d0~8@))) (=> (= temp_0_1~138@ (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ 36))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. 36 d0~8@) (=> %%location_label%%0 (= temp_0_0~109@ temp_0_1~138@))))))))
(assert %%query%%)
(check-sat)
