...
(assert (=> %%query%% (not (=> (= temp_0_0~109@ (Mul (Mul a0~2@ a0~2@) (Mul 36 d0~8@))) (=> (= temp_0_1~138@ (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ 36))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 36 d0~8@) (=> %%location_label%%0 (= temp_0_0~109@ temp_0_1~138@))) (=> (= temp_0_0~109@ temp_0_1~138@) (=> (= temp_1_0~195@ (Add (Add c1~14@ a1~10@) (Mul d1~16@ b1~12@))) (=> (= temp_1_1~212@ (Add (Add c1~14@ a1~10@) (Mul b1~12@ d1~16@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ b1~12@) (=> %%location_label%%1 (= temp_1_0~195@ temp_1_1~212@))))))))))))
(assert %%query%%)
(check-sat)
