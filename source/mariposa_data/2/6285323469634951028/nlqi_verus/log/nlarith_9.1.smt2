...
(declare-const temp_3_1~293@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Add (Mul a0~2@ c0~6@) (Mul b0~4@ d0~8@))) (=> (= temp_0_1~114@ (Add (Mul c0~6@ a0~2@) (Mul b0~4@ d0~8@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~158@ (Mul (Mul a1~10@ 35) (Mul d1~16@ c1~14@))) (=> (= temp_1_1~187@ (Mul a1~10@ (Mul 35 (Mul d1~16@ c1~14@)))) (=> (= tmp%2@ (= temp_1_0~158@ temp_1_1~187@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~219@ (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@))) (=> (= temp_2_1~236@ (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ d2~24@))) (=> (= tmp%3@ (= temp_2_0~219@ temp_2_1~236@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~268@ (Mul (Mul d3~32@ b3~28@) (Sub a3~26@ a3~26@))) (=> (= temp_3_1~293@ (Sub (Mul (Mul d3~32@ b3~28@) a3~26@) (Mul (Mul d3~32@ b3~28@) a3~26@))) (=> (= tmp%4@ (= temp_3_0~268@ temp_3_1~293@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~325@ (Mul (Mul b4~36@ a4~34@) (Sub c4~38@ b4~36@))) (=> (= temp_4_1~342@ (Mul b4~36@ (Mul a4~34@ (Sub c4~38@ b4~36@)))) (=> (= tmp%5@ (= temp_4_0~325@ temp_4_1~342@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~374@ (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@))) (=> (= temp_5_1~391@ (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~374@ temp_5_1~391@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~423@ (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@))) (=> (= temp_6_1~440@ (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ b6~52@))) (=> (= tmp%7@ (= temp_6_0~423@ temp_6_1~440@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~472@ (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ d7~64@))) (=> (= temp_7_1~489@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@))) (=> (= tmp%8@ (= temp_7_0~472@ temp_7_1~489@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~521@ (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~538@ (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ d8~72@))) (=> (= tmp%9@ (= temp_8_0~521@ temp_8_1~538@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
