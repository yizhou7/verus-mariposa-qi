...
(set-info :comment ";; mariposa_data/2//6285323469634951028/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~171@ Int)
(declare-const temp_1_1~200@ Int)
(declare-const temp_2_0~263@ Int)
(declare-const temp_2_1~280@ Int)
(declare-const temp_3_0~333@ Int)
(declare-const temp_3_1~358@ Int)
(declare-const temp_4_0~409@ Int)
(declare-const temp_4_1~426@ Int)
(declare-const temp_5_0~477@ Int)
(declare-const temp_5_1~494@ Int)
(declare-const temp_6_0~539@ Int)
(declare-const temp_6_1~556@ Int)
(declare-const temp_7_0~609@ Int)
(declare-const temp_7_1~626@ Int)
(declare-const temp_8_0~671@ Int)
(declare-const temp_8_1~688@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Add (Mul a0~2@ c0~6@) (Mul b0~4@ d0~8@))) (=> (= temp_0_1~114@ (Add (Mul c0~6@ a0~2@) (Mul b0~4@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ c0~6@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~171@ (Mul (Mul a1~10@ 35) (Mul d1~16@ c1~14@))) (=> (= temp_1_1~200@ (Mul a1~10@ (Mul 35 (Mul d1~16@ c1~14@)))) (and (=> (= tmp%1@ (Mul d1~16@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a1~10@ 35 tmp%1@) (=> %%location_label%%1 (= temp_1_0~171@ temp_1_1~200@)))) (=> (= temp_1_0~171@ temp_1_1~200@) (=> (= temp_2_0~263@ (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@))) (=> (= temp_2_1~280@ (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ d2~24@))) (and (=> (= tmp%2@ (Mul c2~22@ d2~24@)) (=> (= tmp%3@ (Mul d2~24@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~263@ temp_2_1~280@))))) (=> (= temp_2_0~263@ temp_2_1~280@) (=> (= temp_3_0~333@ (Mul (Mul d3~32@ b3~28@) (Sub a3~26@ a3~26@))) (=> (= temp_3_1~358@ (Sub (Mul (Mul d3~32@ b3~28@) a3~26@) (Mul (Mul d3~32@ b3~28@) a3~26@))) (and (=> (= tmp%4@ (Mul d3~32@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ a3~26@ a3~26@) (=> %%location_label%%3 (= temp_3_0~333@ temp_3_1~358@)))) (=> (= temp_3_0~333@ temp_3_1~358@) (=> (= temp_4_0~409@ (Mul (Mul b4~36@ a4~34@) (Sub c4~38@ b4~36@))) (=> (= temp_4_1~426@ (Mul b4~36@ (Mul a4~34@ (Sub c4~38@ b4~36@)))) (and (=> (= tmp%5@ (Sub c4~38@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b4~36@ a4~34@ tmp%5@) (=> %%location_label%%4 (= temp_4_0~409@ temp_4_1~426@)))) (=> (= temp_4_0~409@ temp_4_1~426@) (=> (= temp_5_0~477@ (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@))) (=> (= temp_5_1~494@ (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ c5~46@) (=> %%location_label%%5 (= temp_5_0~477@ temp_5_1~494@))) (=> (= temp_5_0~477@ temp_5_1~494@) (=> (= temp_6_0~539@ (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@))) (=> (= temp_6_1~556@ (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ b6~52@))) (and (=> (= tmp%6@ (Mul c6~54@ b6~52@)) (=> (= tmp%7@ (Mul b6~52@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%6 (= temp_6_0~539@ temp_6_1~556@))))) (=> (= temp_6_0~539@ temp_6_1~556@) (=> (= temp_7_0~609@ (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ d7~64@))) (=> (= temp_7_1~626@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ d7~64@) (=> %%location_label%%7 (= temp_7_0~609@ temp_7_1~626@))) (=> (= temp_7_0~609@ temp_7_1~626@) (=> (= temp_8_0~671@ (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~688@ (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ a8~66@) (=> %%location_label%%8 (= temp_8_0~671@ temp_8_1~688@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
