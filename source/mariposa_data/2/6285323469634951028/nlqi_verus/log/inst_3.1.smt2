...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Add (Mul a0~2@ c0~6@) (Mul b0~4@ d0~8@))) (=> (= temp_0_1~114@ (Add (Mul c0~6@ a0~2@) (Mul b0~4@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ c0~6@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~171@ (Mul (Mul a1~10@ 35) (Mul d1~16@ c1~14@))) (=> (= temp_1_1~200@ (Mul a1~10@ (Mul 35 (Mul d1~16@ c1~14@)))) (and (=> (= tmp%1@ (Mul d1~16@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a1~10@ 35 tmp%1@) (=> %%location_label%%1 (= temp_1_0~171@ temp_1_1~200@)))) (=> (= temp_1_0~171@ temp_1_1~200@) (=> (= temp_2_0~263@ (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@))) (=> (= temp_2_1~280@ (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ d2~24@))) (=> (= tmp%2@ (Mul c2~22@ d2~24@)) (=> (= tmp%3@ (Mul d2~24@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~263@ temp_2_1~280@))))))))))))))))))
(assert %%query%%)
(check-sat)
