...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Add (Mul a0~2@ c0~6@) (Mul b0~4@ d0~8@))) (=> (= temp_0_1~118@ (Add (Mul c0~6@ a0~2@) (Mul b0~4@ d0~8@))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~162@ (Mul (Mul a1~10@ 35) (Mul d1~16@ c1~14@))) (=> (= temp_1_1~191@ (Mul a1~10@ (Mul 35 (Mul d1~16@ c1~14@)))) (=> (= tmp%2@ (= temp_1_0~162@ temp_1_1~191@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~223@ (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@))) (=> (= temp_2_1~240@ (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ d2~24@))) (=> (= tmp%3@ (= temp_2_0~223@ temp_2_1~240@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~272@ (Mul (Mul d3~32@ b3~28@) (Sub a3~26@ a3~26@))) (=> (= temp_3_1~297@ (Sub (Mul (Mul d3~32@ b3~28@) a3~26@) (Mul (Mul d3~32@ b3~28@) a3~26@))) (=> (= tmp%4@ (= temp_3_0~272@ temp_3_1~297@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~329@ (Mul (Mul b4~36@ a4~34@) (Sub c4~38@ b4~36@))) (=> (= temp_4_1~346@ (Mul b4~36@ (Mul a4~34@ (Sub c4~38@ b4~36@)))) (=> (= tmp%5@ (= temp_4_0~329@ temp_4_1~346@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~378@ (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@))) (=> (= temp_5_1~395@ (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~378@ temp_5_1~395@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~427@ (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@))) (=> (= temp_6_1~444@ (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ b6~52@))) (=> (= tmp%7@ (= temp_6_0~427@ temp_6_1~444@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~476@ (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ d7~64@))) (=> (= temp_7_1~493@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@))) (=> (= tmp%8@ (= temp_7_0~476@ temp_7_1~493@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~525@ (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~542@ (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ d8~72@))) (=> (= tmp%9@ (= temp_8_0~525@ temp_8_1~542@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
