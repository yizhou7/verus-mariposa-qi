...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Add (Mul a0~2@ c0~6@) (Mul b0~4@ d0~8@))) (=> (= temp_0_1~114@ (Add (Mul c0~6@ a0~2@) (Mul b0~4@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Mul a1~10@ 35) (Mul d1~16@ c1~14@))) (=> (= temp_1_1~196@ (Mul a1~10@ (Mul 35 (Mul d1~16@ c1~14@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~196@))))))))))))
(assert %%query%%)
(check-sat)
