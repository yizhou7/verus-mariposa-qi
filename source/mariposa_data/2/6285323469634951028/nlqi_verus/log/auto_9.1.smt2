...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Add (Mul a0~2@ c0~6@) (Mul b0~4@ d0~8@))) (=> (= temp_0_1~114@ (Add (Mul c0~6@ a0~2@) (Mul b0~4@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Mul a1~10@ 35) (Mul d1~16@ c1~14@))) (=> (= temp_1_1~196@ (Mul a1~10@ (Mul 35 (Mul d1~16@ c1~14@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~196@))) (=> (= temp_1_0~167@ temp_1_1~196@) (=> (= temp_2_0~237@ (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ a2~18@))) (=> (= temp_2_1~254@ (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ d2~24@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~237@ temp_2_1~254@))) (=> (= temp_2_0~237@ temp_2_1~254@) (=> (= temp_3_0~295@ (Mul (Mul d3~32@ b3~28@) (Sub a3~26@ a3~26@))) (=> (= temp_3_1~320@ (Sub (Mul (Mul d3~32@ b3~28@) a3~26@) (Mul (Mul d3~32@ b3~28@) a3~26@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~295@ temp_3_1~320@))) (=> (= temp_3_0~295@ temp_3_1~320@) (=> (= temp_4_0~361@ (Mul (Mul b4~36@ a4~34@) (Sub c4~38@ b4~36@))) (=> (= temp_4_1~378@ (Mul b4~36@ (Mul a4~34@ (Sub c4~38@ b4~36@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~361@ temp_4_1~378@))) (=> (= temp_4_0~361@ temp_4_1~378@) (=> (= temp_5_0~419@ (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@))) (=> (= temp_5_1~436@ (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~419@ temp_5_1~436@))) (=> (= temp_5_0~419@ temp_5_1~436@) (=> (= temp_6_0~477@ (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@))) (=> (= temp_6_1~494@ (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ b6~52@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~477@ temp_6_1~494@))) (=> (= temp_6_0~477@ temp_6_1~494@) (=> (= temp_7_0~535@ (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ d7~64@))) (=> (= temp_7_1~552@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~535@ temp_7_1~552@))) (=> (= temp_7_0~535@ temp_7_1~552@) (=> (= temp_8_0~593@ (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~610@ (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~593@ temp_8_1~610@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
