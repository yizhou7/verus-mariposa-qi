...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Add (Mul a0~2@ c0~6@) (Mul b0~4@ d0~8@))) (=> (= temp_0_1~114@ (Add (Mul c0~6@ a0~2@) (Mul b0~4@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ c0~6@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~171@ (Mul (Mul a1~10@ 35) (Mul d1~16@ c1~14@))) (=> (= temp_1_1~200@ (Mul a1~10@ (Mul 35 (Mul d1~16@ c1~14@)))) (=> (= tmp%1@ (Mul d1~16@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a1~10@ 35 tmp%1@) (=> %%location_label%%1 (= temp_1_0~171@ temp_1_1~200@)))))))))))))
(assert %%query%%)
(check-sat)
