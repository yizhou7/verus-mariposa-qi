...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ c0~6@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ a1~10@))) (=> (= temp_1_1~176@ (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ a1~10@))) (and (=> (= tmp%1@ (Mul c1~14@ a1~10@)) (=> (= tmp%2@ (Mul d1~16@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@))))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~229@ (Add (Sub c2~22@ c2~22@) (Mul b2~20@ a2~18@))) (=> (= temp_2_1~246@ (Add (Sub c2~22@ c2~22@) (Mul a2~18@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ a2~18@) (=> %%location_label%%2 (= temp_2_0~229@ temp_2_1~246@))))))))))))))))
(assert %%query%%)
(check-sat)
