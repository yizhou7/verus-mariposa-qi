...
(set-info :comment ";; mariposa_data/2//14585490337137866398/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_4_1~376@ Int)
(declare-const temp_5_0~421@ Int)
(declare-const temp_5_1~438@ Int)
(declare-const temp_6_0~479@ Int)
(declare-const temp_6_1~496@ Int)
(declare-const temp_7_0~543@ Int)
(declare-const temp_7_1~560@ Int)
(declare-const temp_8_0~625@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ c0~6@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ a1~10@))) (=> (= temp_1_1~176@ (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ a1~10@))) (and (=> (= tmp%1@ (Mul c1~14@ a1~10@)) (=> (= tmp%2@ (Mul d1~16@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@))))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~229@ (Add (Sub c2~22@ c2~22@) (Mul b2~20@ a2~18@))) (=> (= temp_2_1~246@ (Add (Sub c2~22@ c2~22@) (Mul a2~18@ b2~20@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ a2~18@) (=> %%location_label%%2 (= temp_2_0~229@ temp_2_1~246@))) (=> (= temp_2_0~229@ temp_2_1~246@) (=> (= temp_3_0~291@ (Mul (Mul a3~26@ a3~26@) (Add d3~32@ c3~30@))) (=> (= temp_3_1~316@ (Add (Mul (Mul a3~26@ a3~26@) d3~32@) (Mul (Mul a3~26@ a3~26@) c3~30@))) (and (=> (= tmp%3@ (Mul a3~26@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ d3~32@ c3~30@) (=> %%location_label%%3 (= temp_3_0~291@ temp_3_1~316@)))) (=> (= temp_3_0~291@ temp_3_1~316@) (=> (= temp_4_0~363@ (Mul b4~36@ (Mul b4~36@ a4~34@))) (=> (= temp_4_1~376@ (Mul b4~36@ (Mul a4~34@ b4~36@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ a4~34@) (=> %%location_label%%4 (= temp_4_0~363@ temp_4_1~376@))) (=> (= temp_4_0~363@ temp_4_1~376@) (=> (= temp_5_0~421@ (Mul (Mul c5~46@ a5~42@) (Sub c5~46@ b5~44@))) (=> (= temp_5_1~438@ (Mul (Mul a5~42@ c5~46@) (Sub c5~46@ b5~44@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ a5~42@) (=> %%location_label%%5 (= temp_5_0~421@ temp_5_1~438@))) (=> (= temp_5_0~421@ temp_5_1~438@) (=> (= temp_6_0~479@ (Mul (Add d6~56@ a6~50@) d6~56@)) (=> (= temp_6_1~496@ (Add (Mul d6~56@ d6~56@) (Mul a6~50@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d6~56@ a6~50@ d6~56@) (=> %%location_label%%6 (= temp_6_0~479@ temp_6_1~496@))) (=> (= temp_6_0~479@ temp_6_1~496@) (=> (= temp_7_0~543@ (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@))) (=> (= temp_7_1~560@ (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ d7~64@))) (and (=> (= tmp%4@ (Mul a7~58@ d7~64@)) (=> (= tmp%5@ (Mul a7~58@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%7 (= temp_7_0~543@ temp_7_1~560@))))) (=> (= temp_7_0~543@ temp_7_1~560@) (=> (= temp_8_0~625@ (Mul (Mul d8~72@ 48) (Mul b8~68@ a8~66@))) (=> (= temp_8_1~654@ (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ 48))) (=> (= tmp%6@ (Mul d8~72@ 48)) (=> (= tmp%7@ (Mul b8~68@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%8 (= temp_8_0~625@ temp_8_1~654@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
