...
(declare-const temp_8_1~598@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ a1~10@))) (=> (= temp_1_1~172@ (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ a1~10@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Add (Sub c2~22@ c2~22@) (Mul b2~20@ a2~18@))) (=> (= temp_2_1~230@ (Add (Sub c2~22@ c2~22@) (Mul a2~18@ b2~20@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Mul (Mul a3~26@ a3~26@) (Add d3~32@ c3~30@))) (=> (= temp_3_1~296@ (Add (Mul (Mul a3~26@ a3~26@) d3~32@) (Mul (Mul a3~26@ a3~26@) c3~30@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~296@))) (=> (= temp_3_0~271@ temp_3_1~296@) (=> (= temp_4_0~333@ (Mul b4~36@ (Mul b4~36@ a4~34@))) (=> (= temp_4_1~346@ (Mul b4~36@ (Mul a4~34@ b4~36@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~333@ temp_4_1~346@))) (=> (= temp_4_0~333@ temp_4_1~346@) (=> (= temp_5_0~387@ (Mul (Mul c5~46@ a5~42@) (Sub c5~46@ b5~44@))) (=> (= temp_5_1~404@ (Mul (Mul a5~42@ c5~46@) (Sub c5~46@ b5~44@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~387@ temp_5_1~404@))) (=> (= temp_5_0~387@ temp_5_1~404@) (=> (= temp_6_0~441@ (Mul (Add d6~56@ a6~50@) d6~56@)) (=> (= temp_6_1~458@ (Add (Mul d6~56@ d6~56@) (Mul a6~50@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~441@ temp_6_1~458@))) (=> (= temp_6_0~441@ temp_6_1~458@) (=> (= temp_7_0~499@ (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@))) (=> (= temp_7_1~516@ (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~499@ temp_7_1~516@))) (=> (= temp_7_0~499@ temp_7_1~516@) (=> (= temp_8_0~569@ (Mul (Mul d8~72@ 48) (Mul b8~68@ a8~66@))) (=> (= temp_8_1~598@ (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ 48))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~569@ temp_8_1~598@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
