...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ a1~10@))) (=> (= temp_1_1~172@ (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ a1~10@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Add (Sub c2~22@ c2~22@) (Mul b2~20@ a2~18@))) (=> (= temp_2_1~230@ (Add (Sub c2~22@ c2~22@) (Mul a2~18@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))))))))))))))))
(assert %%query%%)
(check-sat)
