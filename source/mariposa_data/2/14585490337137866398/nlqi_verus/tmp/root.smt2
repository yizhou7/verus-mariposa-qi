...
;; mariposa_data/2//14585490337137866398/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_4_0~301@ Int)
 ...
 (declare-const temp_8_1~530@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ c0~6@)))
      (=>
       (= temp_0_1~118@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ d0~8@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ a1~10@)))
           (=>
            (= temp_1_1~167@ (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ a1~10@)))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~199@ (Add (Sub c2~22@ c2~22@) (Mul b2~20@ a2~18@)))
                (=>
                 (= temp_2_1~216@ (Add (Sub c2~22@ c2~22@) (Mul a2~18@ b2~20@)))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~248@ (Mul (Mul a3~26@ a3~26@) (Add d3~32@ c3~30@)))
                     (=>
                      (= temp_3_1~273@ (Add (Mul (Mul a3~26@ a3~26@) d3~32@) (Mul (Mul a3~26@ a3~26@) c3~30@)))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~301@ (Mul b4~36@ (Mul b4~36@ a4~34@)))
                          (=>
                           (= temp_4_1~314@ (Mul b4~36@ (Mul a4~34@ b4~36@)))
                           (=>
                            (= tmp%5@ (= temp_4_0~301@ temp_4_1~314@))
                            (and
                             (=>
                              %%location_label%%4
                              tmp%5@
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~346@ (Mul (Mul c5~46@ a5~42@) (Sub c5~46@ b5~44@)))
                               (=>
                                (= temp_5_1~363@ (Mul (Mul a5~42@ c5~46@) (Sub c5~46@ b5~44@)))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~391@ (Mul (Add d6~56@ a6~50@) d6~56@))
                                    (=>
                                     (= temp_6_1~408@ (Add (Mul d6~56@ d6~56@) (Mul a6~50@ d6~56@)))
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~440@ (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)))
                                         (=>
                                          (= temp_7_1~457@ (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ d7~64@)))
                                          (=>
                                           ...
                                           (and
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~501@ (Mul (Mul d8~72@ 48) (Mul b8~68@ a8~66@)))
                                              (=>
                                               (= temp_8_1~530@ (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ 48)))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~501@ temp_8_1~530@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
