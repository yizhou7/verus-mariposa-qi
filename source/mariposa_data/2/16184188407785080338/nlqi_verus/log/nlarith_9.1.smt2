...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@))) (=> (= temp_1_1~163@ (Mul (Mul (Mul a1~10@ d1~16@) c1~14@) a1~10@)) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Mul (Mul b2~20@ b2~20@) (Sub d2~24@ b2~20@))) (=> (= temp_2_1~212@ (Mul b2~20@ (Mul b2~20@ (Sub d2~24@ b2~20@)))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~212@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~244@ (Add (Mul c3~30@ c3~30@) (Mul d3~32@ a3~26@))) (=> (= temp_3_1~261@ (Add (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@))) (=> (= tmp%4@ (= temp_3_0~244@ temp_3_1~261@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~293@ (Mul (Sub c4~38@ d4~40@) (Mul a4~34@ b4~36@))) (=> (= temp_4_1~310@ (Mul (Mul (Sub c4~38@ d4~40@) a4~34@) b4~36@)) (=> (= tmp%5@ (= temp_4_0~293@ temp_4_1~310@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~342@ (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ d5~48@))) (=> (= temp_5_1~359@ (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~342@ temp_5_1~359@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~387@ (Mul (Sub c6~54@ d6~56@) b6~52@)) (=> (= temp_6_1~404@ (Sub (Mul c6~54@ b6~52@) (Mul d6~56@ b6~52@))) (=> (= tmp%7@ (= temp_6_0~387@ temp_6_1~404@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~436@ (Mul (Sub b7~60@ a7~58@) (Mul c7~62@ a7~58@))) (=> (= temp_7_1~453@ (Mul (Sub b7~60@ a7~58@) (Mul a7~58@ c7~62@))) (=> (= tmp%8@ (= temp_7_0~436@ temp_7_1~453@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~485@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))) (=> (= temp_8_1~502@ (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ c8~70@))) (=> (= tmp%9@ (= temp_8_0~485@ temp_8_1~502@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
