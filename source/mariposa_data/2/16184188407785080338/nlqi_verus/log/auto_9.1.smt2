...
(declare-const temp_6_0~441@ Int)
(declare-const temp_6_1~458@ Int)
(declare-const temp_7_0~499@ Int)
(declare-const temp_7_1~516@ Int)
(declare-const temp_8_0~557@ Int)
(declare-const temp_8_1~574@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@))) (=> (= temp_1_1~172@ (Mul (Mul (Mul a1~10@ d1~16@) c1~14@) a1~10@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Mul b2~20@ b2~20@) (Sub d2~24@ b2~20@))) (=> (= temp_2_1~230@ (Mul b2~20@ (Mul b2~20@ (Sub d2~24@ b2~20@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Add (Mul c3~30@ c3~30@) (Mul d3~32@ a3~26@))) (=> (= temp_3_1~288@ (Add (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~288@))) (=> (= temp_3_0~271@ temp_3_1~288@) (=> (= temp_4_0~329@ (Mul (Sub c4~38@ d4~40@) (Mul a4~34@ b4~36@))) (=> (= temp_4_1~346@ (Mul (Mul (Sub c4~38@ d4~40@) a4~34@) b4~36@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~329@ temp_4_1~346@))) (=> (= temp_4_0~329@ temp_4_1~346@) (=> (= temp_5_0~387@ (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ d5~48@))) (=> (= temp_5_1~404@ (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~387@ temp_5_1~404@))) (=> (= temp_5_0~387@ temp_5_1~404@) (=> (= temp_6_0~441@ (Mul (Sub c6~54@ d6~56@) b6~52@)) (=> (= temp_6_1~458@ (Sub (Mul c6~54@ b6~52@) (Mul d6~56@ b6~52@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~441@ temp_6_1~458@))) (=> (= temp_6_0~441@ temp_6_1~458@) (=> (= temp_7_0~499@ (Mul (Sub b7~60@ a7~58@) (Mul c7~62@ a7~58@))) (=> (= temp_7_1~516@ (Mul (Sub b7~60@ a7~58@) (Mul a7~58@ c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~499@ temp_7_1~516@))) (=> (= temp_7_0~499@ temp_7_1~516@) (=> (= temp_8_0~557@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))) (=> (= temp_8_1~574@ (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~557@ temp_8_1~574@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
