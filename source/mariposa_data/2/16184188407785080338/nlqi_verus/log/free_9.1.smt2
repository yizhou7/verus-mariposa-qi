...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (=> (= temp_0_1~118@ (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~150@ (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@))) (=> (= temp_1_1~167@ (Mul (Mul (Mul a1~10@ d1~16@) c1~14@) a1~10@)) (=> (= tmp%2@ (= temp_1_0~150@ temp_1_1~167@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~199@ (Mul (Mul b2~20@ b2~20@) (Sub d2~24@ b2~20@))) (=> (= temp_2_1~216@ (Mul b2~20@ (Mul b2~20@ (Sub d2~24@ b2~20@)))) (=> (= tmp%3@ (= temp_2_0~199@ temp_2_1~216@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~248@ (Add (Mul c3~30@ c3~30@) (Mul d3~32@ a3~26@))) (=> (= temp_3_1~265@ (Add (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@))) (=> (= tmp%4@ (= temp_3_0~248@ temp_3_1~265@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~297@ (Mul (Sub c4~38@ d4~40@) (Mul a4~34@ b4~36@))) (=> (= temp_4_1~314@ (Mul (Mul (Sub c4~38@ d4~40@) a4~34@) b4~36@)) (=> (= tmp%5@ (= temp_4_0~297@ temp_4_1~314@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~346@ (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ d5~48@))) (=> (= temp_5_1~363@ (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~346@ temp_5_1~363@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~391@ (Mul (Sub c6~54@ d6~56@) b6~52@)) (=> (= temp_6_1~408@ (Sub (Mul c6~54@ b6~52@) (Mul d6~56@ b6~52@))) (=> (= tmp%7@ (= temp_6_0~391@ temp_6_1~408@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~440@ (Mul (Sub b7~60@ a7~58@) (Mul c7~62@ a7~58@))) (=> (= temp_7_1~457@ (Mul (Sub b7~60@ a7~58@) (Mul a7~58@ c7~62@))) (=> (= tmp%8@ (= temp_7_0~440@ temp_7_1~457@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~489@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))) (=> (= temp_8_1~506@ (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ c8~70@))) (=> (= tmp%9@ (= temp_8_0~489@ temp_8_1~506@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
