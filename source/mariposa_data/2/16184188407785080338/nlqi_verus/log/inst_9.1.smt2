...
(set-info :comment ";; mariposa_data/2//16184188407785080338/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_8_1~626@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ d0~8@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@))) (=> (= temp_1_1~176@ (Mul (Mul (Mul a1~10@ d1~16@) c1~14@) a1~10@)) (and (=> (= tmp%1@ (Mul a1~10@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ c1~14@ a1~10@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@)))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~227@ (Mul (Mul b2~20@ b2~20@) (Sub d2~24@ b2~20@))) (=> (= temp_2_1~244@ (Mul b2~20@ (Mul b2~20@ (Sub d2~24@ b2~20@)))) (and (=> (= tmp%2@ (Sub d2~24@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b2~20@ b2~20@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~227@ temp_2_1~244@)))) (=> (= temp_2_0~227@ temp_2_1~244@) (=> (= temp_3_0~295@ (Add (Mul c3~30@ c3~30@) (Mul d3~32@ a3~26@))) (=> (= temp_3_1~312@ (Add (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ a3~26@) (=> %%location_label%%3 (= temp_3_0~295@ temp_3_1~312@))) (=> (= temp_3_0~295@ temp_3_1~312@) (=> (= temp_4_0~357@ (Mul (Sub c4~38@ d4~40@) (Mul a4~34@ b4~36@))) (=> (= temp_4_1~374@ (Mul (Mul (Sub c4~38@ d4~40@) a4~34@) b4~36@)) (and (=> (= tmp%3@ (Sub c4~38@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ a4~34@ b4~36@) (=> %%location_label%%4 (= temp_4_0~357@ temp_4_1~374@)))) (=> (= temp_4_0~357@ temp_4_1~374@) (=> (= temp_5_0~425@ (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ d5~48@))) (=> (= temp_5_1~442@ (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ b5~44@) (=> %%location_label%%5 (= temp_5_0~425@ temp_5_1~442@))) (=> (= temp_5_0~425@ temp_5_1~442@) (=> (= temp_6_0~483@ (Mul (Sub c6~54@ d6~56@) b6~52@)) (=> (= temp_6_1~500@ (Sub (Mul c6~54@ b6~52@) (Mul d6~56@ b6~52@))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. c6~54@ d6~56@ b6~52@) (=> %%location_label%%6 (= temp_6_0~483@ temp_6_1~500@))) (=> (= temp_6_0~483@ temp_6_1~500@) (=> (= temp_7_0~547@ (Mul (Sub b7~60@ a7~58@) (Mul c7~62@ a7~58@))) (=> (= temp_7_1~564@ (Mul (Sub b7~60@ a7~58@) (Mul a7~58@ c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ a7~58@) (=> %%location_label%%7 (= temp_7_0~547@ temp_7_1~564@))) (=> (= temp_7_0~547@ temp_7_1~564@) (=> (= temp_8_0~609@ (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))) (=> (= temp_8_1~626@ (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d8~72@ b8~68@) (=> %%location_label%%8 (= temp_8_0~609@ temp_8_1~626@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
