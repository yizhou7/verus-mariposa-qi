...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ d0~8@) (Sub b0~4@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ d0~8@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@))) (=> (= temp_1_1~176@ (Mul (Mul (Mul a1~10@ d1~16@) c1~14@) a1~10@)) (=> (= tmp%1@ (Mul a1~10@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ c1~14@ a1~10@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@)))))))))))))
(assert %%query%%)
(check-sat)
