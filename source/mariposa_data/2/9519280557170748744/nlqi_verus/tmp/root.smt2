...
;; mariposa_data/2//9519280557170748744/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Add b0~4@ c0~6@) (Sub c0~6@ c0~6@)))
      (=>
       (= temp_0_1~118@ (Mul (Sub c0~6@ c0~6@) (Add b0~4@ c0~6@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Add (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@)))
           (=>
            (= temp_1_1~167@ (Add (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@)))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~199@ (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@)))
                (=>
                 (= temp_2_1~216@ (Mul b2~20@ (Mul d2~24@ (Mul a2~18@ a2~18@))))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~248@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@)))
                     (=>
                      (= temp_3_1~265@ (Mul (Mul (Mul a3~26@ a3~26@) d3~32@) c3~30@))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~297@ (Sub (Mul b4~36@ d4~40@) (Mul c4~38@ d4~40@)))
                          (=>
                           (= temp_4_1~314@ (Sub (Mul d4~40@ b4~36@) (Mul c4~38@ d4~40@)))
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~346@ (Mul (Sub d5~48@ b5~44@) (Mul d5~48@ b5~44@)))
                               (=>
                                (= temp_5_1~363@ (Mul (Mul d5~48@ b5~44@) (Sub d5~48@ b5~44@)))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~391@ (Mul c6~54@ (Mul b6~52@ a6~50@)))
                                    (=>
                                     (= temp_6_1~404@ (Mul (Mul b6~52@ a6~50@) c6~54@))
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~436@ (Sub (Mul c7~62@ b7~60@) (Mul d7~64@ c7~62@)))
                                         (=>
                                          (= temp_7_1~453@ (Sub (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@)))
                                          (=>
                                           ...
                                           (and
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~497@ (Mul (Mul 26 b8~68@) (Mul a8~66@ d8~72@)))
                                              (=>
                                               (= temp_8_1~526@ (Mul (Mul a8~66@ d8~72@) (Mul 26 b8~68@)))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~497@ temp_8_1~526@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
