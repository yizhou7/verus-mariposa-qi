...
(declare-const temp_6_1~454@ Int)
(declare-const temp_7_0~495@ Int)
(declare-const temp_7_1~512@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add b0~4@ c0~6@) (Sub c0~6@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Sub c0~6@ c0~6@) (Add b0~4@ c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Add (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@))) (=> (= temp_1_1~172@ (Add (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@))) (=> (= temp_2_1~230@ (Mul b2~20@ (Mul d2~24@ (Mul a2~18@ a2~18@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))) (=> (= temp_3_1~288@ (Mul (Mul (Mul a3~26@ a3~26@) d3~32@) c3~30@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~288@))) (=> (= temp_3_0~271@ temp_3_1~288@) (=> (= temp_4_0~329@ (Sub (Mul b4~36@ d4~40@) (Mul c4~38@ d4~40@))) (=> (= temp_4_1~346@ (Sub (Mul d4~40@ b4~36@) (Mul c4~38@ d4~40@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~329@ temp_4_1~346@))) (=> (= temp_4_0~329@ temp_4_1~346@) (=> (= temp_5_0~387@ (Mul (Sub d5~48@ b5~44@) (Mul d5~48@ b5~44@))) (=> (= temp_5_1~404@ (Mul (Mul d5~48@ b5~44@) (Sub d5~48@ b5~44@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~387@ temp_5_1~404@))) (=> (= temp_5_0~387@ temp_5_1~404@) (=> (= temp_6_0~441@ (Mul c6~54@ (Mul b6~52@ a6~50@))) (=> (= temp_6_1~454@ (Mul (Mul b6~52@ a6~50@) c6~54@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~441@ temp_6_1~454@))) (=> (= temp_6_0~441@ temp_6_1~454@) (=> (= temp_7_0~495@ (Sub (Mul c7~62@ b7~60@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~512@ (Sub (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~495@ temp_7_1~512@))) (=> (= temp_7_0~495@ temp_7_1~512@) (=> (= temp_8_0~565@ (Mul (Mul 26 b8~68@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~594@ (Mul (Mul a8~66@ d8~72@) (Mul 26 b8~68@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~565@ temp_8_1~594@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
