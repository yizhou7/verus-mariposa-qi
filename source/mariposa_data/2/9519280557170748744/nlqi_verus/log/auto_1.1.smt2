...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add b0~4@ c0~6@) (Sub c0~6@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Sub c0~6@ c0~6@) (Add b0~4@ c0~6@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))))))
(assert %%query%%)
(check-sat)
