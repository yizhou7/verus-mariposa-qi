...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add b0~4@ c0~6@) (Sub c0~6@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Sub c0~6@ c0~6@) (Add b0~4@ c0~6@))) (and (=> (= tmp%1@ (Add b0~4@ c0~6@)) (=> (= tmp%2@ (Sub c0~6@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Add (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@))) (=> (= temp_1_1~184@ (Add (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ b1~12@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@))) (=> (= temp_1_0~167@ temp_1_1~184@) (=> (= temp_2_0~229@ (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@))) (=> (= temp_2_1~246@ (Mul b2~20@ (Mul d2~24@ (Mul a2~18@ a2~18@)))) (=> (= tmp%3@ (Mul a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b2~20@ d2~24@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~229@ temp_2_1~246@)))))))))))))))))
(assert %%query%%)
(check-sat)
