...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add b0~4@ c0~6@) (Sub c0~6@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Sub c0~6@ c0~6@) (Add b0~4@ c0~6@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Add (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@))) (=> (= temp_1_1~163@ (Add (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@))) (=> (= temp_2_1~212@ (Mul b2~20@ (Mul d2~24@ (Mul a2~18@ a2~18@)))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~212@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~244@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))) (=> (= temp_3_1~261@ (Mul (Mul (Mul a3~26@ a3~26@) d3~32@) c3~30@)) (=> (= tmp%4@ (= temp_3_0~244@ temp_3_1~261@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~293@ (Sub (Mul b4~36@ d4~40@) (Mul c4~38@ d4~40@))) (=> (= temp_4_1~310@ (Sub (Mul d4~40@ b4~36@) (Mul c4~38@ d4~40@))) (=> (= tmp%5@ (= temp_4_0~293@ temp_4_1~310@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~342@ (Mul (Sub d5~48@ b5~44@) (Mul d5~48@ b5~44@))) (=> (= temp_5_1~359@ (Mul (Mul d5~48@ b5~44@) (Sub d5~48@ b5~44@))) (=> (= tmp%6@ (= temp_5_0~342@ temp_5_1~359@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~387@ (Mul c6~54@ (Mul b6~52@ a6~50@))) (=> (= temp_6_1~400@ (Mul (Mul b6~52@ a6~50@) c6~54@)) (=> (= tmp%7@ (= temp_6_0~387@ temp_6_1~400@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~432@ (Sub (Mul c7~62@ b7~60@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~449@ (Sub (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@))) (=> (= tmp%8@ (= temp_7_0~432@ temp_7_1~449@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~493@ (Mul (Mul 26 b8~68@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~522@ (Mul (Mul a8~66@ d8~72@) (Mul 26 b8~68@))) (=> (= tmp%9@ (= temp_8_0~493@ temp_8_1~522@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
