...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add b0~4@ c0~6@) (Sub c0~6@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Sub c0~6@ c0~6@) (Add b0~4@ c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Add (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@))) (=> (= temp_1_1~172@ (Add (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@))) (=> (= temp_2_1~230@ (Mul b2~20@ (Mul d2~24@ (Mul a2~18@ a2~18@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))))))))))))))))
(assert %%query%%)
(check-sat)
