...
(set-info :comment ";; mariposa_data/2//9519280557170748744/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_3_0~297@ Int)
(declare-const temp_3_1~314@ Int)
(declare-const temp_4_0~365@ Int)
(declare-const temp_4_1~382@ Int)
(declare-const temp_5_0~427@ Int)
(declare-const temp_5_1~444@ Int)
(declare-const temp_6_0~493@ Int)
(declare-const temp_6_1~506@ Int)
(declare-const temp_7_0~555@ Int)
(declare-const temp_7_1~572@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add b0~4@ c0~6@) (Sub c0~6@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Sub c0~6@ c0~6@) (Add b0~4@ c0~6@))) (and (=> (= tmp%1@ (Add b0~4@ c0~6@)) (=> (= tmp%2@ (Sub c0~6@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Add (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@))) (=> (= temp_1_1~184@ (Add (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ b1~12@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@))) (=> (= temp_1_0~167@ temp_1_1~184@) (=> (= temp_2_0~229@ (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@))) (=> (= temp_2_1~246@ (Mul b2~20@ (Mul d2~24@ (Mul a2~18@ a2~18@)))) (and (=> (= tmp%3@ (Mul a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b2~20@ d2~24@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~229@ temp_2_1~246@)))) (=> (= temp_2_0~229@ temp_2_1~246@) (=> (= temp_3_0~297@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ c3~30@))) (=> (= temp_3_1~314@ (Mul (Mul (Mul a3~26@ a3~26@) d3~32@) c3~30@)) (and (=> (= tmp%4@ (Mul a3~26@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ d3~32@ c3~30@) (=> %%location_label%%3 (= temp_3_0~297@ temp_3_1~314@)))) (=> (= temp_3_0~297@ temp_3_1~314@) (=> (= temp_4_0~365@ (Sub (Mul b4~36@ d4~40@) (Mul c4~38@ d4~40@))) (=> (= temp_4_1~382@ (Sub (Mul d4~40@ b4~36@) (Mul c4~38@ d4~40@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ d4~40@) (=> %%location_label%%4 (= temp_4_0~365@ temp_4_1~382@))) (=> (= temp_4_0~365@ temp_4_1~382@) (=> (= temp_5_0~427@ (Mul (Sub d5~48@ b5~44@) (Mul d5~48@ b5~44@))) (=> (= temp_5_1~444@ (Mul (Mul d5~48@ b5~44@) (Sub d5~48@ b5~44@))) (and (=> (= tmp%5@ (Sub d5~48@ b5~44@)) (=> (= tmp%6@ (Mul d5~48@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~427@ temp_5_1~444@))))) (=> (= temp_5_0~427@ temp_5_1~444@) (=> (= temp_6_0~493@ (Mul c6~54@ (Mul b6~52@ a6~50@))) (=> (= temp_6_1~506@ (Mul (Mul b6~52@ a6~50@) c6~54@)) (and (=> (= tmp%7@ (Mul b6~52@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ tmp%7@) (=> %%location_label%%6 (= temp_6_0~493@ temp_6_1~506@)))) (=> (= temp_6_0~493@ temp_6_1~506@) (=> (= temp_7_0~555@ (Sub (Mul c7~62@ b7~60@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~572@ (Sub (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ c7~62@) (=> %%location_label%%7 (= temp_7_0~555@ temp_7_1~572@))) (=> (= temp_7_0~555@ temp_7_1~572@) (=> (= temp_8_0~629@ (Mul (Mul 26 b8~68@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~658@ (Mul (Mul a8~66@ d8~72@) (Mul 26 b8~68@))) (=> (= tmp%8@ (Mul 26 b8~68@)) (=> (= tmp%9@ (Mul a8~66@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%8 (= temp_8_0~629@ temp_8_1~658@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
