...
;; mariposa_data/2//6713532082305598616/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_5_1~359@ Int)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@)))
      (=>
       (= temp_0_1~118@ (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@)))
           (=>
            (= temp_1_1~167@ (Mul (Mul (Mul b1~12@ d1~16@) b1~12@) d1~16@))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~199@ (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@)))
                (=>
                 (= temp_2_1~216@ (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ d2~24@)))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~248@ (Sub (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)))
                     (=>
                      (= temp_3_1~261@ (Mul (Sub b3~28@ a3~26@) c3~30@))
                      (=>
                       (= tmp%4@ (= temp_3_0~248@ temp_3_1~261@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~293@ (Mul (Add d4~40@ a4~34@) (Mul b4~36@ d4~40@)))
                          (=>
                           (= temp_4_1~310@ (Mul (Mul (Add d4~40@ a4~34@) b4~36@) d4~40@))
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~342@ (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ a5~42@)))
                               (=>
                                (= temp_5_1~359@ (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ a5~42@)))
                                (=>
                                 (= tmp%6@ (= temp_5_0~342@ temp_5_1~359@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~391@ (Mul (Mul a6~50@ b6~52@) (Sub d6~56@ d6~56@)))
                                    (=>
                                     (= temp_6_1~408@ (Mul a6~50@ (Mul b6~52@ (Sub d6~56@ d6~56@))))
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~436@ (Mul (Add b7~60@ d7~64@) b7~60@))
                                         (=>
                                          (= temp_7_1~453@ (Add (Mul b7~60@ b7~60@) (Mul d7~64@ b7~60@)))
                                          (=>
                                           ...
                                           (and
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~485@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@)))
                                              (=>
                                               (= temp_8_1~502@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@)))
                                               (=>
