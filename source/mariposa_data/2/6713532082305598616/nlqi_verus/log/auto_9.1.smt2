...
(declare-const temp_5_1~400@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@))) (=> (= temp_1_1~172@ (Mul (Mul (Mul b1~12@ d1~16@) b1~12@) d1~16@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@))) (=> (= temp_2_1~230@ (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ d2~24@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Sub (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@))) (=> (= temp_3_1~284@ (Mul (Sub b3~28@ a3~26@) c3~30@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~284@))) (=> (= temp_3_0~271@ temp_3_1~284@) (=> (= temp_4_0~325@ (Mul (Add d4~40@ a4~34@) (Mul b4~36@ d4~40@))) (=> (= temp_4_1~342@ (Mul (Mul (Add d4~40@ a4~34@) b4~36@) d4~40@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~325@ temp_4_1~342@))) (=> (= temp_4_0~325@ temp_4_1~342@) (=> (= temp_5_0~383@ (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ a5~42@))) (=> (= temp_5_1~400@ (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ a5~42@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~383@ temp_5_1~400@))) (=> (= temp_5_0~383@ temp_5_1~400@) (=> (= temp_6_0~441@ (Mul (Mul a6~50@ b6~52@) (Sub d6~56@ d6~56@))) (=> (= temp_6_1~458@ (Mul a6~50@ (Mul b6~52@ (Sub d6~56@ d6~56@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~441@ temp_6_1~458@))) (=> (= temp_6_0~441@ temp_6_1~458@) (=> (= temp_7_0~495@ (Mul (Add b7~60@ d7~64@) b7~60@)) (=> (= temp_7_1~512@ (Add (Mul b7~60@ b7~60@) (Mul d7~64@ b7~60@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~495@ temp_7_1~512@))) (=> (= temp_7_0~495@ temp_7_1~512@) (=> (= temp_8_0~553@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@))) (=> (= temp_8_1~570@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~553@ temp_8_1~570@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
