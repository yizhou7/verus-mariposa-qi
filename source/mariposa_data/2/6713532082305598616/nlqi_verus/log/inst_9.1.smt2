...
(set-info :comment ";; mariposa_data/2//6713532082305598616/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_3_1~310@ Int)
(declare-const temp_4_0~357@ Int)
(declare-const temp_4_1~374@ Int)
(declare-const temp_5_0~425@ Int)
(declare-const temp_5_1~442@ Int)
(declare-const temp_6_0~495@ Int)
(declare-const temp_6_1~512@ Int)
(declare-const temp_7_0~559@ Int)
(declare-const temp_7_1~576@ Int)
(declare-const temp_8_0~623@ Int)
(declare-const temp_8_1~640@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ d0~8@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@))) (=> (= temp_1_1~176@ (Mul (Mul (Mul b1~12@ d1~16@) b1~12@) d1~16@)) (and (=> (= tmp%1@ (Mul b1~12@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ b1~12@ d1~16@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@)))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~227@ (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@))) (=> (= temp_2_1~244@ (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ d2~24@))) (and (=> (= tmp%2@ (Mul d2~24@ d2~24@)) (=> (= tmp%3@ (Mul d2~24@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~227@ temp_2_1~244@))))) (=> (= temp_2_0~227@ temp_2_1~244@) (=> (= temp_3_0~297@ (Sub (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@))) (=> (= temp_3_1~310@ (Mul (Sub b3~28@ a3~26@) c3~30@)) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b3~28@ a3~26@ c3~30@) (=> %%location_label%%3 (= temp_3_0~297@ temp_3_1~310@))) (=> (= temp_3_0~297@ temp_3_1~310@) (=> (= temp_4_0~357@ (Mul (Add d4~40@ a4~34@) (Mul b4~36@ d4~40@))) (=> (= temp_4_1~374@ (Mul (Mul (Add d4~40@ a4~34@) b4~36@) d4~40@)) (and (=> (= tmp%4@ (Add d4~40@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ b4~36@ d4~40@) (=> %%location_label%%4 (= temp_4_0~357@ temp_4_1~374@)))) (=> (= temp_4_0~357@ temp_4_1~374@) (=> (= temp_5_0~425@ (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ a5~42@))) (=> (= temp_5_1~442@ (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ a5~42@))) (and (=> (= tmp%5@ (Mul d5~48@ a5~42@)) (=> (= tmp%6@ (Mul b5~44@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~425@ temp_5_1~442@))))) (=> (= temp_5_0~425@ temp_5_1~442@) (=> (= temp_6_0~495@ (Mul (Mul a6~50@ b6~52@) (Sub d6~56@ d6~56@))) (=> (= temp_6_1~512@ (Mul a6~50@ (Mul b6~52@ (Sub d6~56@ d6~56@)))) (and (=> (= tmp%7@ (Sub d6~56@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a6~50@ b6~52@ tmp%7@) (=> %%location_label%%6 (= temp_6_0~495@ temp_6_1~512@)))) (=> (= temp_6_0~495@ temp_6_1~512@) (=> (= temp_7_0~559@ (Mul (Add b7~60@ d7~64@) b7~60@)) (=> (= temp_7_1~576@ (Add (Mul b7~60@ b7~60@) (Mul d7~64@ b7~60@))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b7~60@ d7~64@ b7~60@) (=> %%location_label%%7 (= temp_7_0~559@ temp_7_1~576@))) (=> (= temp_7_0~559@ temp_7_1~576@) (=> (= temp_8_0~623@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@))) (=> (= temp_8_1~640@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ c8~70@) (=> %%location_label%%8 (= temp_8_0~623@ temp_8_1~640@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
