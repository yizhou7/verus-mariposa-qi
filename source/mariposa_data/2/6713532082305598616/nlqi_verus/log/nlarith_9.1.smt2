...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@))) (=> (= temp_1_1~163@ (Mul (Mul (Mul b1~12@ d1~16@) b1~12@) d1~16@)) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@))) (=> (= temp_2_1~212@ (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ d2~24@))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~212@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~244@ (Sub (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@))) (=> (= temp_3_1~257@ (Mul (Sub b3~28@ a3~26@) c3~30@)) (=> (= tmp%4@ (= temp_3_0~244@ temp_3_1~257@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~289@ (Mul (Add d4~40@ a4~34@) (Mul b4~36@ d4~40@))) (=> (= temp_4_1~306@ (Mul (Mul (Add d4~40@ a4~34@) b4~36@) d4~40@)) (=> (= tmp%5@ (= temp_4_0~289@ temp_4_1~306@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~338@ (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ a5~42@))) (=> (= temp_5_1~355@ (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ a5~42@))) (=> (= tmp%6@ (= temp_5_0~338@ temp_5_1~355@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~387@ (Mul (Mul a6~50@ b6~52@) (Sub d6~56@ d6~56@))) (=> (= temp_6_1~404@ (Mul a6~50@ (Mul b6~52@ (Sub d6~56@ d6~56@)))) (=> (= tmp%7@ (= temp_6_0~387@ temp_6_1~404@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~432@ (Mul (Add b7~60@ d7~64@) b7~60@)) (=> (= temp_7_1~449@ (Add (Mul b7~60@ b7~60@) (Mul d7~64@ b7~60@))) (=> (= tmp%8@ (= temp_7_0~432@ temp_7_1~449@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~481@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@))) (=> (= temp_8_1~498@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ c8~70@))) (=> (= tmp%9@ (= temp_8_0~481@ temp_8_1~498@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
