...
(declare-const temp_1_0~142@ Int)
(declare-const temp_1_1~155@ Int)
(declare-const temp_2_0~187@ Int)
...
(declare-const temp_8_1~546@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul b0~4@ (Mul a0~2@ (Mul d0~8@ c0~6@)))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~142@ (Mul c1~14@ (Mul c1~14@ d1~16@))) (=> (= temp_1_1~155@ (Mul (Mul c1~14@ c1~14@) d1~16@)) (=> (= tmp%2@ (= temp_1_0~142@ temp_1_1~155@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~187@ (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@))) (=> (= temp_2_1~204@ (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@))) (=> (= tmp%3@ (= temp_2_0~187@ temp_2_1~204@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~236@ (Add (Mul b3~28@ a3~26@) (Mul d3~32@ d3~32@))) (=> (= temp_3_1~253@ (Add (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@))) (=> (= tmp%4@ (= temp_3_0~236@ temp_3_1~253@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~285@ (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@))) (=> (= temp_4_1~302@ (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ a4~34@))) (=> (= tmp%5@ (= temp_4_0~285@ temp_4_1~302@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~334@ (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ d5~48@))) (=> (= temp_5_1~351@ (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~334@ temp_5_1~351@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~383@ (Mul (Sub d6~56@ d6~56@) (Add b6~52@ d6~56@))) (=> (= temp_6_1~400@ (Mul (Add b6~52@ d6~56@) (Sub d6~56@ d6~56@))) (=> (= tmp%7@ (= temp_6_0~383@ temp_6_1~400@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~444@ (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ 36))) (=> (= temp_7_1~473@ (Mul (Mul (Mul d7~64@ a7~58@) d7~64@) 36)) (=> (= tmp%8@ (= temp_7_0~444@ temp_7_1~473@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~517@ (Mul (Mul 69 c8~70@) (Mul b8~68@ b8~68@))) (=> (= temp_8_1~546@ (Mul 69 (Mul c8~70@ (Mul b8~68@ b8~68@)))) (=> (= tmp%9@ (= temp_8_0~517@ temp_8_1~546@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
