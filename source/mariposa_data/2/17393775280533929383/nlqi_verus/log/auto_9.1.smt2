...
(declare-const temp_1_0~151@ Int)
(declare-const temp_1_1~164@ Int)
(declare-const temp_2_0~205@ Int)
...
(declare-const temp_8_0~589@ Int)
(declare-const temp_8_1~618@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul b0~4@ (Mul a0~2@ (Mul d0~8@ c0~6@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~151@ (Mul c1~14@ (Mul c1~14@ d1~16@))) (=> (= temp_1_1~164@ (Mul (Mul c1~14@ c1~14@) d1~16@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~151@ temp_1_1~164@))) (=> (= temp_1_0~151@ temp_1_1~164@) (=> (= temp_2_0~205@ (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@))) (=> (= temp_2_1~222@ (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~205@ temp_2_1~222@))) (=> (= temp_2_0~205@ temp_2_1~222@) (=> (= temp_3_0~263@ (Add (Mul b3~28@ a3~26@) (Mul d3~32@ d3~32@))) (=> (= temp_3_1~280@ (Add (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~263@ temp_3_1~280@))) (=> (= temp_3_0~263@ temp_3_1~280@) (=> (= temp_4_0~321@ (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@))) (=> (= temp_4_1~338@ (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ a4~34@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~321@ temp_4_1~338@))) (=> (= temp_4_0~321@ temp_4_1~338@) (=> (= temp_5_0~379@ (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ d5~48@))) (=> (= temp_5_1~396@ (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~379@ temp_5_1~396@))) (=> (= temp_5_0~379@ temp_5_1~396@) (=> (= temp_6_0~437@ (Mul (Sub d6~56@ d6~56@) (Add b6~52@ d6~56@))) (=> (= temp_6_1~454@ (Mul (Add b6~52@ d6~56@) (Sub d6~56@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~437@ temp_6_1~454@))) (=> (= temp_6_0~437@ temp_6_1~454@) (=> (= temp_7_0~507@ (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ 36))) (=> (= temp_7_1~536@ (Mul (Mul (Mul d7~64@ a7~58@) d7~64@) 36)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~507@ temp_7_1~536@))) (=> (= temp_7_0~507@ temp_7_1~536@) (=> (= temp_8_0~589@ (Mul (Mul 69 c8~70@) (Mul b8~68@ b8~68@))) (=> (= temp_8_1~618@ (Mul 69 (Mul c8~70@ (Mul b8~68@ b8~68@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~589@ temp_8_1~618@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
