...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul b0~4@ (Mul a0~2@ (Mul d0~8@ c0~6@)))) (and (=> (= tmp%1@ (Mul d0~8@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ a0~2@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@)))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~161@ (Mul c1~14@ (Mul c1~14@ d1~16@))) (=> (= temp_1_1~174@ (Mul (Mul c1~14@ c1~14@) d1~16@)) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. c1~14@ c1~14@ d1~16@) (=> %%location_label%%1 (= temp_1_0~161@ temp_1_1~174@))) (=> (= temp_1_0~161@ temp_1_1~174@) (=> (= temp_2_0~221@ (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@))) (=> (= temp_2_1~238@ (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ a2~18@) (=> %%location_label%%2 (= temp_2_0~221@ temp_2_1~238@))))))))))))))))
(assert %%query%%)
(check-sat)
