...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul b0~4@ (Mul a0~2@ (Mul d0~8@ c0~6@)))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~142@ (Mul c1~14@ (Mul c1~14@ d1~16@))) (=> (= temp_1_1~155@ (Mul (Mul c1~14@ c1~14@) d1~16@)) (=> (= tmp%2@ (= temp_1_0~142@ temp_1_1~155@)) (=> %%location_label%%1 tmp%2@))))))))))))
(assert %%query%%)
(check-sat)
