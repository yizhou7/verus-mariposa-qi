...
(set-info :comment ";; mariposa_data/2//17393775280533929383/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~161@ Int)
(declare-const temp_1_1~174@ Int)
(declare-const temp_2_0~221@ Int)
(declare-const temp_2_1~238@ Int)
(declare-const temp_3_0~283@ Int)
(declare-const temp_3_1~300@ Int)
(declare-const temp_4_0~345@ Int)
(declare-const temp_4_1~362@ Int)
(declare-const temp_5_0~415@ Int)
(declare-const temp_5_1~432@ Int)
(declare-const temp_6_0~477@ Int)
(declare-const temp_6_1~494@ Int)
(declare-const temp_7_0~559@ Int)
(declare-const temp_7_1~588@ Int)
(declare-const temp_8_0~663@ Int)
(declare-const temp_8_1~692@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul b0~4@ (Mul a0~2@ (Mul d0~8@ c0~6@)))) (and (=> (= tmp%1@ (Mul d0~8@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ a0~2@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@)))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~161@ (Mul c1~14@ (Mul c1~14@ d1~16@))) (=> (= temp_1_1~174@ (Mul (Mul c1~14@ c1~14@) d1~16@)) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. c1~14@ c1~14@ d1~16@) (=> %%location_label%%1 (= temp_1_0~161@ temp_1_1~174@))) (=> (= temp_1_0~161@ temp_1_1~174@) (=> (= temp_2_0~221@ (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@))) (=> (= temp_2_1~238@ (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ a2~18@) (=> %%location_label%%2 (= temp_2_0~221@ temp_2_1~238@))) (=> (= temp_2_0~221@ temp_2_1~238@) (=> (= temp_3_0~283@ (Add (Mul b3~28@ a3~26@) (Mul d3~32@ d3~32@))) (=> (= temp_3_1~300@ (Add (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ a3~26@) (=> %%location_label%%3 (= temp_3_0~283@ temp_3_1~300@))) (=> (= temp_3_0~283@ temp_3_1~300@) (=> (= temp_4_0~345@ (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@))) (=> (= temp_4_1~362@ (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ a4~34@))) (and (=> (= tmp%2@ (Mul d4~40@ a4~34@)) (=> (= tmp%3@ (Mul a4~34@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%4 (= temp_4_0~345@ temp_4_1~362@))))) (=> (= temp_4_0~345@ temp_4_1~362@) (=> (= temp_5_0~415@ (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ d5~48@))) (=> (= temp_5_1~432@ (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ a5~42@) (=> %%location_label%%5 (= temp_5_0~415@ temp_5_1~432@))) (=> (= temp_5_0~415@ temp_5_1~432@) (=> (= temp_6_0~477@ (Mul (Sub d6~56@ d6~56@) (Add b6~52@ d6~56@))) (=> (= temp_6_1~494@ (Mul (Add b6~52@ d6~56@) (Sub d6~56@ d6~56@))) (and (=> (= tmp%4@ (Sub d6~56@ d6~56@)) (=> (= tmp%5@ (Add b6~52@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%6 (= temp_6_0~477@ temp_6_1~494@))))) (=> (= temp_6_0~477@ temp_6_1~494@) (=> (= temp_7_0~559@ (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ 36))) (=> (= temp_7_1~588@ (Mul (Mul (Mul d7~64@ a7~58@) d7~64@) 36)) (and (=> (= tmp%6@ (Mul d7~64@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ d7~64@ 36) (=> %%location_label%%7 (= temp_7_0~559@ temp_7_1~588@)))) (=> (= temp_7_0~559@ temp_7_1~588@) (=> (= temp_8_0~663@ (Mul (Mul 69 c8~70@) (Mul b8~68@ b8~68@))) (=> (= temp_8_1~692@ (Mul 69 (Mul c8~70@ (Mul b8~68@ b8~68@)))) (=> (= tmp%7@ (Mul b8~68@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. 69 c8~70@ tmp%7@) (=> %%location_label%%8 (= temp_8_0~663@ temp_8_1~692@)))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
