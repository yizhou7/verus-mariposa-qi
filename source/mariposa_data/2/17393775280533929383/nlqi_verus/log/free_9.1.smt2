...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~118@ (Mul b0~4@ (Mul a0~2@ (Mul d0~8@ c0~6@)))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul c1~14@ (Mul c1~14@ d1~16@))) (=> (= temp_1_1~159@ (Mul (Mul c1~14@ c1~14@) d1~16@)) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~159@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~191@ (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@))) (=> (= temp_2_1~208@ (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@))) (=> (= tmp%3@ (= temp_2_0~191@ temp_2_1~208@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~240@ (Add (Mul b3~28@ a3~26@) (Mul d3~32@ d3~32@))) (=> (= temp_3_1~257@ (Add (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@))) (=> (= tmp%4@ (= temp_3_0~240@ temp_3_1~257@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~289@ (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@))) (=> (= temp_4_1~306@ (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ a4~34@))) (=> (= tmp%5@ (= temp_4_0~289@ temp_4_1~306@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~338@ (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ d5~48@))) (=> (= temp_5_1~355@ (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~338@ temp_5_1~355@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~387@ (Mul (Sub d6~56@ d6~56@) (Add b6~52@ d6~56@))) (=> (= temp_6_1~404@ (Mul (Add b6~52@ d6~56@) (Sub d6~56@ d6~56@))) (=> (= tmp%7@ (= temp_6_0~387@ temp_6_1~404@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~448@ (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ 36))) (=> (= temp_7_1~477@ (Mul (Mul (Mul d7~64@ a7~58@) d7~64@) 36)) (=> (= tmp%8@ (= temp_7_0~448@ temp_7_1~477@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~521@ (Mul (Mul 69 c8~70@) (Mul b8~68@ b8~68@))) (=> (= temp_8_1~550@ (Mul 69 (Mul c8~70@ (Mul b8~68@ b8~68@)))) (=> (= tmp%9@ (= temp_8_0~521@ temp_8_1~550@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
