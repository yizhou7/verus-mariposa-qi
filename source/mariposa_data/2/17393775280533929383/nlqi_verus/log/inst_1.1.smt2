...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul b0~4@ (Mul a0~2@ (Mul d0~8@ c0~6@)))) (=> (= tmp%1@ (Mul d0~8@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ a0~2@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@)))))))))
(assert %%query%%)
(check-sat)
