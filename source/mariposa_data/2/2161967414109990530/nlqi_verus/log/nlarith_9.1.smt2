...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub a0~2@ a0~2@) (Mul c0~6@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul (Sub a0~2@ a0~2@) c0~6@) d0~8@)) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Add (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@))) (=> (= temp_1_1~163@ (Add (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@))) (=> (= temp_2_1~212@ (Mul d2~24@ (Mul a2~18@ (Mul d2~24@ c2~22@)))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~212@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~244@ (Sub (Add a3~26@ d3~32@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~261@ (Sub (Add a3~26@ d3~32@) (Mul d3~32@ a3~26@))) (=> (= tmp%4@ (= temp_3_0~244@ temp_3_1~261@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~293@ (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@))) (=> (= temp_4_1~310@ (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@))) (=> (= tmp%5@ (= temp_4_0~293@ temp_4_1~310@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~342@ (Mul (Add b5~44@ b5~44@) (Mul d5~48@ a5~42@))) (=> (= temp_5_1~359@ (Mul (Add b5~44@ b5~44@) (Mul a5~42@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~342@ temp_5_1~359@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~387@ (Mul b6~52@ (Mul a6~50@ b6~52@))) (=> (= temp_6_1~400@ (Mul (Mul a6~50@ b6~52@) b6~52@)) (=> (= tmp%7@ (= temp_6_0~387@ temp_6_1~400@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~432@ (Mul (Mul a7~58@ c7~62@) (Sub d7~64@ b7~60@))) (=> (= temp_7_1~449@ (Mul a7~58@ (Mul c7~62@ (Sub d7~64@ b7~60@)))) (=> (= tmp%8@ (= temp_7_0~432@ temp_7_1~449@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~481@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))) (=> (= temp_8_1~498@ (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ d8~72@))) (=> (= tmp%9@ (= temp_8_0~481@ temp_8_1~498@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
