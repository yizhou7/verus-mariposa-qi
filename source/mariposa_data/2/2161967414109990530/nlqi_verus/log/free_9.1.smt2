...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Sub a0~2@ a0~2@) (Mul c0~6@ d0~8@))) (=> (= temp_0_1~118@ (Mul (Mul (Sub a0~2@ a0~2@) c0~6@) d0~8@)) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~150@ (Add (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@))) (=> (= temp_1_1~167@ (Add (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@))) (=> (= tmp%2@ (= temp_1_0~150@ temp_1_1~167@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~199@ (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@))) (=> (= temp_2_1~216@ (Mul d2~24@ (Mul a2~18@ (Mul d2~24@ c2~22@)))) (=> (= tmp%3@ (= temp_2_0~199@ temp_2_1~216@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~248@ (Sub (Add a3~26@ d3~32@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~265@ (Sub (Add a3~26@ d3~32@) (Mul d3~32@ a3~26@))) (=> (= tmp%4@ (= temp_3_0~248@ temp_3_1~265@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~297@ (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@))) (=> (= temp_4_1~314@ (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@))) (=> (= tmp%5@ (= temp_4_0~297@ temp_4_1~314@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~346@ (Mul (Add b5~44@ b5~44@) (Mul d5~48@ a5~42@))) (=> (= temp_5_1~363@ (Mul (Add b5~44@ b5~44@) (Mul a5~42@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~346@ temp_5_1~363@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~391@ (Mul b6~52@ (Mul a6~50@ b6~52@))) (=> (= temp_6_1~404@ (Mul (Mul a6~50@ b6~52@) b6~52@)) (=> (= tmp%7@ (= temp_6_0~391@ temp_6_1~404@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~436@ (Mul (Mul a7~58@ c7~62@) (Sub d7~64@ b7~60@))) (=> (= temp_7_1~453@ (Mul a7~58@ (Mul c7~62@ (Sub d7~64@ b7~60@)))) (=> (= tmp%8@ (= temp_7_0~436@ temp_7_1~453@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~485@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))) (=> (= temp_8_1~502@ (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ d8~72@))) (=> (= tmp%9@ (= temp_8_0~485@ temp_8_1~502@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
