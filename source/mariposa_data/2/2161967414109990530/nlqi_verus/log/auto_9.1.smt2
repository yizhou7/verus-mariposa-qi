...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub a0~2@ a0~2@) (Mul c0~6@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul (Sub a0~2@ a0~2@) c0~6@) d0~8@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Add (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@))) (=> (= temp_1_1~172@ (Add (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@))) (=> (= temp_2_1~230@ (Mul d2~24@ (Mul a2~18@ (Mul d2~24@ c2~22@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Sub (Add a3~26@ d3~32@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~288@ (Sub (Add a3~26@ d3~32@) (Mul d3~32@ a3~26@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~288@))) (=> (= temp_3_0~271@ temp_3_1~288@) (=> (= temp_4_0~329@ (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@))) (=> (= temp_4_1~346@ (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~329@ temp_4_1~346@))) (=> (= temp_4_0~329@ temp_4_1~346@) (=> (= temp_5_0~387@ (Mul (Add b5~44@ b5~44@) (Mul d5~48@ a5~42@))) (=> (= temp_5_1~404@ (Mul (Add b5~44@ b5~44@) (Mul a5~42@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~387@ temp_5_1~404@))) (=> (= temp_5_0~387@ temp_5_1~404@) (=> (= temp_6_0~441@ (Mul b6~52@ (Mul a6~50@ b6~52@))) (=> (= temp_6_1~454@ (Mul (Mul a6~50@ b6~52@) b6~52@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~441@ temp_6_1~454@))) (=> (= temp_6_0~441@ temp_6_1~454@) (=> (= temp_7_0~495@ (Mul (Mul a7~58@ c7~62@) (Sub d7~64@ b7~60@))) (=> (= temp_7_1~512@ (Mul a7~58@ (Mul c7~62@ (Sub d7~64@ b7~60@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~495@ temp_7_1~512@))) (=> (= temp_7_0~495@ temp_7_1~512@) (=> (= temp_8_0~553@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))) (=> (= temp_8_1~570@ (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~553@ temp_8_1~570@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
