...
(set-info :comment ";; mariposa_data/2//2161967414109990530/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~165@ Int)
(declare-const temp_1_1~182@ Int)
(declare-const temp_2_0~227@ Int)
(declare-const temp_2_1~244@ Int)
(declare-const temp_3_0~295@ Int)
(declare-const temp_3_1~312@ Int)
(declare-const temp_4_0~357@ Int)
(declare-const temp_4_1~374@ Int)
(declare-const temp_5_0~427@ Int)
(declare-const temp_5_1~444@ Int)
(declare-const temp_6_0~485@ Int)
(declare-const temp_6_1~498@ Int)
(declare-const temp_7_0~547@ Int)
(declare-const temp_7_1~564@ Int)
(declare-const temp_8_0~615@ Int)
(declare-const temp_8_1~632@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub a0~2@ a0~2@) (Mul c0~6@ d0~8@))) (=> (= temp_0_1~114@ (Mul (Mul (Sub a0~2@ a0~2@) c0~6@) d0~8@)) (and (=> (= tmp%1@ (Sub a0~2@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ c0~6@ d0~8@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@)))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~165@ (Add (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@))) (=> (= temp_1_1~182@ (Add (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ d1~16@) (=> %%location_label%%1 (= temp_1_0~165@ temp_1_1~182@))) (=> (= temp_1_0~165@ temp_1_1~182@) (=> (= temp_2_0~227@ (Mul (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@))) (=> (= temp_2_1~244@ (Mul d2~24@ (Mul a2~18@ (Mul d2~24@ c2~22@)))) (and (=> (= tmp%2@ (Mul d2~24@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d2~24@ a2~18@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~227@ temp_2_1~244@)))) (=> (= temp_2_0~227@ temp_2_1~244@) (=> (= temp_3_0~295@ (Sub (Add a3~26@ d3~32@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~312@ (Sub (Add a3~26@ d3~32@) (Mul d3~32@ a3~26@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ d3~32@) (=> %%location_label%%3 (= temp_3_0~295@ temp_3_1~312@))) (=> (= temp_3_0~295@ temp_3_1~312@) (=> (= temp_4_0~357@ (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ a4~34@))) (=> (= temp_4_1~374@ (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ c4~38@))) (and (=> (= tmp%3@ (Mul d4~40@ c4~38@)) (=> (= tmp%4@ (Mul a4~34@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%4 (= temp_4_0~357@ temp_4_1~374@))))) (=> (= temp_4_0~357@ temp_4_1~374@) (=> (= temp_5_0~427@ (Mul (Add b5~44@ b5~44@) (Mul d5~48@ a5~42@))) (=> (= temp_5_1~444@ (Mul (Add b5~44@ b5~44@) (Mul a5~42@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ a5~42@) (=> %%location_label%%5 (= temp_5_0~427@ temp_5_1~444@))) (=> (= temp_5_0~427@ temp_5_1~444@) (=> (= temp_6_0~485@ (Mul b6~52@ (Mul a6~50@ b6~52@))) (=> (= temp_6_1~498@ (Mul (Mul a6~50@ b6~52@) b6~52@)) (and (=> (= tmp%5@ (Mul a6~50@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b6~52@ tmp%5@) (=> %%location_label%%6 (= temp_6_0~485@ temp_6_1~498@)))) (=> (= temp_6_0~485@ temp_6_1~498@) (=> (= temp_7_0~547@ (Mul (Mul a7~58@ c7~62@) (Sub d7~64@ b7~60@))) (=> (= temp_7_1~564@ (Mul a7~58@ (Mul c7~62@ (Sub d7~64@ b7~60@)))) (and (=> (= tmp%6@ (Sub d7~64@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a7~58@ c7~62@ tmp%6@) (=> %%location_label%%7 (= temp_7_0~547@ temp_7_1~564@)))) (=> (= temp_7_0~547@ temp_7_1~564@) (=> (= temp_8_0~615@ (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@))) (=> (= temp_8_1~632@ (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ d8~72@))) (=> (= tmp%7@ (Mul c8~70@ d8~72@)) (=> (= tmp%8@ (Mul d8~72@ b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%8 (= temp_8_0~615@ temp_8_1~632@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
