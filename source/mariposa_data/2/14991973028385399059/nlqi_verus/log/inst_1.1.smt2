...
(assert (=> %%query%% (not (=> (= temp_0_0~93@ (Mul (Mul b0~4@ a0~2@) b0~4@)) (=> (= temp_0_1~106@ (Mul b0~4@ (Mul b0~4@ a0~2@))) (=> (= tmp%1@ (Mul b0~4@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ b0~4@) (=> %%location_label%%0 (= temp_0_0~93@ temp_0_1~106@)))))))))
(assert %%query%%)
(check-sat)
