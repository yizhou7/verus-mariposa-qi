...
(assert (=> %%query%% (not (=> (= temp_0_0~93@ (Mul (Mul b0~4@ a0~2@) b0~4@)) (=> (= temp_0_1~106@ (Mul b0~4@ (Mul b0~4@ a0~2@))) (=> (= tmp%1@ (= temp_0_0~93@ temp_0_1~106@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~150@ (Mul (Sub d1~16@ 1) (Mul d1~16@ c1~14@))) (=> (= temp_1_1~179@ (Mul (Mul d1~16@ c1~14@) (Sub d1~16@ 1))) (=> (= tmp%2@ (= temp_1_0~150@ temp_1_1~179@)) (=> %%location_label%%1 tmp%2@))))))))))))
(assert %%query%%)
(check-sat)
