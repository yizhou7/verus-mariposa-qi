...
(set-info :comment ";; mariposa_data/2//14991973028385399059/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_0_0~93@ Int)
(declare-const temp_0_1~106@ Int)
(declare-const temp_1_0~167@ Int)
(declare-const temp_1_1~196@ Int)
(declare-const temp_2_0~261@ Int)
(declare-const temp_2_1~286@ Int)
(declare-const temp_3_0~337@ Int)
(declare-const temp_3_1~354@ Int)
(declare-const temp_4_0~419@ Int)
(declare-const temp_4_1~448@ Int)
(declare-const temp_5_0~517@ Int)
(declare-const temp_5_1~546@ Int)
(declare-const temp_6_0~591@ Int)
(declare-const temp_6_1~608@ Int)
(declare-const temp_7_0~661@ Int)
(declare-const temp_7_1~678@ Int)
(declare-const temp_8_0~723@ Int)
(declare-const temp_8_1~748@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~93@ (Mul (Mul b0~4@ a0~2@) b0~4@)) (=> (= temp_0_1~106@ (Mul b0~4@ (Mul b0~4@ a0~2@))) (and (=> (= tmp%1@ (Mul b0~4@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ b0~4@) (=> %%location_label%%0 (= temp_0_0~93@ temp_0_1~106@)))) (=> (= temp_0_0~93@ temp_0_1~106@) (=> (= temp_1_0~167@ (Mul (Sub d1~16@ 1) (Mul d1~16@ c1~14@))) (=> (= temp_1_1~196@ (Mul (Mul d1~16@ c1~14@) (Sub d1~16@ 1))) (and (=> (= tmp%2@ (Sub d1~16@ 1)) (=> (= tmp%3@ (Mul d1~16@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~196@))))) (=> (= temp_1_0~167@ temp_1_1~196@) (=> (= temp_2_0~261@ (Mul (Mul d2~24@ d2~24@) (Sub b2~20@ d2~24@))) (=> (= temp_2_1~286@ (Sub (Mul (Mul d2~24@ d2~24@) b2~20@) (Mul (Mul d2~24@ d2~24@) d2~24@))) (and (=> (= tmp%4@ (Mul d2~24@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ b2~20@ d2~24@) (=> %%location_label%%2 (= temp_2_0~261@ temp_2_1~286@)))) (=> (= temp_2_0~261@ temp_2_1~286@) (=> (= temp_3_0~337@ (Mul (Sub d3~32@ d3~32@) (Sub c3~30@ a3~26@))) (=> (= temp_3_1~354@ (Mul (Sub c3~30@ a3~26@) (Sub d3~32@ d3~32@))) (and (=> (= tmp%5@ (Sub d3~32@ d3~32@)) (=> (= tmp%6@ (Sub c3~30@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~337@ temp_3_1~354@))))) (=> (= temp_3_0~337@ temp_3_1~354@) (=> (= temp_4_0~419@ (Mul (Mul 49 d4~40@) (Mul b4~36@ c4~38@))) (=> (= temp_4_1~448@ (Mul (Mul d4~40@ 49) (Mul b4~36@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 49 d4~40@) (=> %%location_label%%4 (= temp_4_0~419@ temp_4_1~448@))) (=> (= temp_4_0~419@ temp_4_1~448@) (=> (= temp_5_0~517@ (Sub (Mul c5~46@ c5~46@) (Add 37 d5~48@))) (=> (= temp_5_1~546@ (Sub (Mul c5~46@ c5~46@) (Add 37 d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ c5~46@) (=> %%location_label%%5 (= temp_5_0~517@ temp_5_1~546@))) (=> (= temp_5_0~517@ temp_5_1~546@) (=> (= temp_6_0~591@ (Mul (Mul c6~54@ d6~56@) (Add a6~50@ c6~54@))) (=> (= temp_6_1~608@ (Mul (Add a6~50@ c6~54@) (Mul c6~54@ d6~56@))) (and (=> (= tmp%7@ (Mul c6~54@ d6~56@)) (=> (= tmp%8@ (Add a6~50@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~591@ temp_6_1~608@))))) (=> (= temp_6_0~591@ temp_6_1~608@) (=> (= temp_7_0~661@ (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ d7~64@))) (=> (= temp_7_1~678@ (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ b7~60@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ d7~64@) (=> %%location_label%%7 (= temp_7_0~661@ temp_7_1~678@))) (=> (= temp_7_0~661@ temp_7_1~678@) (=> (= temp_8_0~723@ (Mul (Add b8~68@ c8~70@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~748@ (Add (Mul b8~68@ (Mul a8~66@ d8~72@)) (Mul c8~70@ (Mul a8~66@ d8~72@)))) (=> (= tmp%9@ (Mul a8~66@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b8~68@ c8~70@ tmp%9@) (=> %%location_label%%8 (= temp_8_0~723@ temp_8_1~748@)))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
