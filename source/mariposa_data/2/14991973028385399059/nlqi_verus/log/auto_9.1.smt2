...
(declare-const temp_1_1~188@ Int)
...
(declare-const temp_5_0~447@ Int)
(declare-const temp_5_1~476@ Int)
(declare-const temp_6_0~517@ Int)
(declare-const temp_6_1~534@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~93@ (Mul (Mul b0~4@ a0~2@) b0~4@)) (=> (= temp_0_1~106@ (Mul b0~4@ (Mul b0~4@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~93@ temp_0_1~106@))) (=> (= temp_0_0~93@ temp_0_1~106@) (=> (= temp_1_0~159@ (Mul (Sub d1~16@ 1) (Mul d1~16@ c1~14@))) (=> (= temp_1_1~188@ (Mul (Mul d1~16@ c1~14@) (Sub d1~16@ 1))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~188@))) (=> (= temp_1_0~159@ temp_1_1~188@) (=> (= temp_2_0~229@ (Mul (Mul d2~24@ d2~24@) (Sub b2~20@ d2~24@))) (=> (= temp_2_1~254@ (Sub (Mul (Mul d2~24@ d2~24@) b2~20@) (Mul (Mul d2~24@ d2~24@) d2~24@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~229@ temp_2_1~254@))) (=> (= temp_2_0~229@ temp_2_1~254@) (=> (= temp_3_0~295@ (Mul (Sub d3~32@ d3~32@) (Sub c3~30@ a3~26@))) (=> (= temp_3_1~312@ (Mul (Sub c3~30@ a3~26@) (Sub d3~32@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~295@ temp_3_1~312@))) (=> (= temp_3_0~295@ temp_3_1~312@) (=> (= temp_4_0~365@ (Mul (Mul 49 d4~40@) (Mul b4~36@ c4~38@))) (=> (= temp_4_1~394@ (Mul (Mul d4~40@ 49) (Mul b4~36@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~365@ temp_4_1~394@))) (=> (= temp_4_0~365@ temp_4_1~394@) (=> (= temp_5_0~447@ (Sub (Mul c5~46@ c5~46@) (Add 37 d5~48@))) (=> (= temp_5_1~476@ (Sub (Mul c5~46@ c5~46@) (Add 37 d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~447@ temp_5_1~476@))) (=> (= temp_5_0~447@ temp_5_1~476@) (=> (= temp_6_0~517@ (Mul (Mul c6~54@ d6~56@) (Add a6~50@ c6~54@))) (=> (= temp_6_1~534@ (Mul (Add a6~50@ c6~54@) (Mul c6~54@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~517@ temp_6_1~534@))) (=> (= temp_6_0~517@ temp_6_1~534@) (=> (= temp_7_0~575@ (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ d7~64@))) (=> (= temp_7_1~592@ (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ b7~60@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~575@ temp_7_1~592@))) (=> (= temp_7_0~575@ temp_7_1~592@) (=> (= temp_8_0~633@ (Mul (Add b8~68@ c8~70@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~658@ (Add (Mul b8~68@ (Mul a8~66@ d8~72@)) (Mul c8~70@ (Mul a8~66@ d8~72@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~633@ temp_8_1~658@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
