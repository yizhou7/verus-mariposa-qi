...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~97@ (Mul (Mul b0~4@ a0~2@) b0~4@)) (=> (= temp_0_1~110@ (Mul b0~4@ (Mul b0~4@ a0~2@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~110@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~154@ (Mul (Sub d1~16@ 1) (Mul d1~16@ c1~14@))) (=> (= temp_1_1~183@ (Mul (Mul d1~16@ c1~14@) (Sub d1~16@ 1))) (=> (= tmp%2@ (= temp_1_0~154@ temp_1_1~183@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~215@ (Mul (Mul d2~24@ d2~24@) (Sub b2~20@ d2~24@))) (=> (= temp_2_1~240@ (Sub (Mul (Mul d2~24@ d2~24@) b2~20@) (Mul (Mul d2~24@ d2~24@) d2~24@))) (=> (= tmp%3@ (= temp_2_0~215@ temp_2_1~240@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~272@ (Mul (Sub d3~32@ d3~32@) (Sub c3~30@ a3~26@))) (=> (= temp_3_1~289@ (Mul (Sub c3~30@ a3~26@) (Sub d3~32@ d3~32@))) (=> (= tmp%4@ (= temp_3_0~272@ temp_3_1~289@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~333@ (Mul (Mul 49 d4~40@) (Mul b4~36@ c4~38@))) (=> (= temp_4_1~362@ (Mul (Mul d4~40@ 49) (Mul b4~36@ c4~38@))) (=> (= tmp%5@ (= temp_4_0~333@ temp_4_1~362@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~406@ (Sub (Mul c5~46@ c5~46@) (Add 37 d5~48@))) (=> (= temp_5_1~435@ (Sub (Mul c5~46@ c5~46@) (Add 37 d5~48@))) (=> (= tmp%6@ (= temp_5_0~406@ temp_5_1~435@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~467@ (Mul (Mul c6~54@ d6~56@) (Add a6~50@ c6~54@))) (=> (= temp_6_1~484@ (Mul (Add a6~50@ c6~54@) (Mul c6~54@ d6~56@))) (=> (= tmp%7@ (= temp_6_0~467@ temp_6_1~484@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~516@ (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ d7~64@))) (=> (= temp_7_1~533@ (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ b7~60@))) (=> (= tmp%8@ (= temp_7_0~516@ temp_7_1~533@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~565@ (Mul (Add b8~68@ c8~70@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~590@ (Add (Mul b8~68@ (Mul a8~66@ d8~72@)) (Mul c8~70@ (Mul a8~66@ d8~72@)))) (=> (= tmp%9@ (= temp_8_0~565@ temp_8_1~590@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
