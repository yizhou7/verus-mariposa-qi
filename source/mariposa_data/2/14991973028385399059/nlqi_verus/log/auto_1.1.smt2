...
(assert (=> %%query%% (not (=> (= temp_0_0~93@ (Mul (Mul b0~4@ a0~2@) b0~4@)) (=> (= temp_0_1~106@ (Mul b0~4@ (Mul b0~4@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~93@ temp_0_1~106@))))))))
(assert %%query%%)
(check-sat)
