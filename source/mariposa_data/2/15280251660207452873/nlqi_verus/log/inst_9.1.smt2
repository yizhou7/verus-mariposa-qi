...
(set-info :comment ";; mariposa_data/2//15280251660207452873/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_4_0~371@ Int)
(declare-const temp_4_1~420@ Int)
(declare-const temp_5_0~483@ Int)
(declare-const temp_5_1~500@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add a0~2@ d0~8@) (Mul d0~8@ a0~2@))) (=> (= temp_0_1~122@ (Add (Mul a0~2@ (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul d0~8@ a0~2@)))) (and (=> (= tmp%1@ (Mul d0~8@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a0~2@ d0~8@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@)))) (=> (= temp_0_0~97@ temp_0_1~122@) (=> (= temp_1_0~173@ (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@))) (=> (= temp_1_1~190@ (Mul (Mul b1~12@ a1~10@) (Mul c1~14@ a1~10@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ b1~12@) (=> %%location_label%%1 (= temp_1_0~173@ temp_1_1~190@))) (=> (= temp_1_0~173@ temp_1_1~190@) (=> (= temp_2_0~235@ (Add (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@))) (=> (= temp_2_1~252@ (Add (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ d2~24@) (=> %%location_label%%2 (= temp_2_0~235@ temp_2_1~252@))) (=> (= temp_2_0~235@ temp_2_1~252@) (=> (= temp_3_0~297@ (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~314@ (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ c3~30@) (=> %%location_label%%3 (= temp_3_0~297@ temp_3_1~314@))) (=> (= temp_3_0~297@ temp_3_1~314@) (=> (= temp_4_0~371@ (Mul (Add b4~36@ 27) (Add b4~36@ d4~40@))) (=> (= temp_4_1~420@ (Add (Mul (Add b4~36@ 27) b4~36@) (Mul (Add b4~36@ 27) d4~40@))) (and (=> (= tmp%2@ (Add b4~36@ 27)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%2@ b4~36@ d4~40@) (=> %%location_label%%4 (= temp_4_0~371@ temp_4_1~420@)))) (=> (= temp_4_0~371@ temp_4_1~420@) (=> (= temp_5_0~483@ (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (=> (= temp_5_1~500@ (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ d5~48@) (=> %%location_label%%5 (= temp_5_0~483@ temp_5_1~500@))) (=> (= temp_5_0~483@ temp_5_1~500@) (=> (= temp_6_0~545@ (Add (Sub c6~54@ a6~50@) (Mul c6~54@ d6~56@))) (=> (= temp_6_1~562@ (Add (Sub c6~54@ a6~50@) (Mul d6~56@ c6~54@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ d6~56@) (=> %%location_label%%6 (= temp_6_0~545@ temp_6_1~562@))) (=> (= temp_6_0~545@ temp_6_1~562@) (=> (= temp_7_0~607@ (Sub (Mul b7~60@ b7~60@) (Mul a7~58@ d7~64@))) (=> (= temp_7_1~624@ (Sub (Mul b7~60@ b7~60@) (Mul a7~58@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ b7~60@) (=> %%location_label%%7 (= temp_7_0~607@ temp_7_1~624@))) (=> (= temp_7_0~607@ temp_7_1~624@) (=> (= temp_8_0~669@ (Mul (Mul a8~66@ a8~66@) (Add c8~70@ d8~72@))) (=> (= temp_8_1~686@ (Mul (Mul a8~66@ a8~66@) (Add c8~70@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ a8~66@) (=> %%location_label%%8 (= temp_8_0~669@ temp_8_1~686@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
