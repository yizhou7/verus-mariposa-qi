...
(declare-const temp_4_0~349@ Int)
(declare-const temp_4_1~398@ Int)
(declare-const temp_5_0~439@ Int)
(declare-const temp_5_1~456@ Int)
(declare-const temp_6_0~497@ Int)
(declare-const temp_6_1~514@ Int)
(declare-const temp_7_0~555@ Int)
(declare-const temp_7_1~572@ Int)
(declare-const temp_8_0~613@ Int)
(declare-const temp_8_1~630@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add a0~2@ d0~8@) (Mul d0~8@ a0~2@))) (=> (= temp_0_1~122@ (Add (Mul a0~2@ (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul d0~8@ a0~2@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@))) (=> (= temp_0_0~97@ temp_0_1~122@) (=> (= temp_1_0~163@ (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@))) (=> (= temp_1_1~180@ (Mul (Mul b1~12@ a1~10@) (Mul c1~14@ a1~10@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~163@ temp_1_1~180@))) (=> (= temp_1_0~163@ temp_1_1~180@) (=> (= temp_2_0~221@ (Add (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@))) (=> (= temp_2_1~238@ (Add (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~221@ temp_2_1~238@))) (=> (= temp_2_0~221@ temp_2_1~238@) (=> (= temp_3_0~279@ (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~296@ (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~279@ temp_3_1~296@))) (=> (= temp_3_0~279@ temp_3_1~296@) (=> (= temp_4_0~349@ (Mul (Add b4~36@ 27) (Add b4~36@ d4~40@))) (=> (= temp_4_1~398@ (Add (Mul (Add b4~36@ 27) b4~36@) (Mul (Add b4~36@ 27) d4~40@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~349@ temp_4_1~398@))) (=> (= temp_4_0~349@ temp_4_1~398@) (=> (= temp_5_0~439@ (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (=> (= temp_5_1~456@ (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~439@ temp_5_1~456@))) (=> (= temp_5_0~439@ temp_5_1~456@) (=> (= temp_6_0~497@ (Add (Sub c6~54@ a6~50@) (Mul c6~54@ d6~56@))) (=> (= temp_6_1~514@ (Add (Sub c6~54@ a6~50@) (Mul d6~56@ c6~54@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~497@ temp_6_1~514@))) (=> (= temp_6_0~497@ temp_6_1~514@) (=> (= temp_7_0~555@ (Sub (Mul b7~60@ b7~60@) (Mul a7~58@ d7~64@))) (=> (= temp_7_1~572@ (Sub (Mul b7~60@ b7~60@) (Mul a7~58@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~555@ temp_7_1~572@))) (=> (= temp_7_0~555@ temp_7_1~572@) (=> (= temp_8_0~613@ (Mul (Mul a8~66@ a8~66@) (Add c8~70@ d8~72@))) (=> (= temp_8_1~630@ (Mul (Mul a8~66@ a8~66@) (Add c8~70@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~613@ temp_8_1~630@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
