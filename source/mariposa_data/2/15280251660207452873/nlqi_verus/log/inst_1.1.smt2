...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add a0~2@ d0~8@) (Mul d0~8@ a0~2@))) (=> (= temp_0_1~122@ (Add (Mul a0~2@ (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul d0~8@ a0~2@)))) (=> (= tmp%1@ (Mul d0~8@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a0~2@ d0~8@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~122@)))))))))
(assert %%query%%)
(check-sat)
