...
(declare-const temp_1_1~171@ Int)
(declare-const temp_2_0~203@ Int)
(declare-const temp_2_1~220@ Int)
(declare-const temp_3_0~252@ Int)
(declare-const temp_3_1~269@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add a0~2@ d0~8@) (Mul d0~8@ a0~2@))) (=> (= temp_0_1~122@ (Add (Mul a0~2@ (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul d0~8@ a0~2@)))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~122@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~154@ (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@))) (=> (= temp_1_1~171@ (Mul (Mul b1~12@ a1~10@) (Mul c1~14@ a1~10@))) (=> (= tmp%2@ (= temp_1_0~154@ temp_1_1~171@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~203@ (Add (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@))) (=> (= temp_2_1~220@ (Add (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@))) (=> (= tmp%3@ (= temp_2_0~203@ temp_2_1~220@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~252@ (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~269@ (Mul (Mul c3~30@ a3~26@) (Mul a3~26@ d3~32@))) (=> (= tmp%4@ (= temp_3_0~252@ temp_3_1~269@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~313@ (Mul (Add b4~36@ 27) (Add b4~36@ d4~40@))) (=> (= temp_4_1~362@ (Add (Mul (Add b4~36@ 27) b4~36@) (Mul (Add b4~36@ 27) d4~40@))) (=> (= tmp%5@ (= temp_4_0~313@ temp_4_1~362@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~394@ (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (=> (= temp_5_1~411@ (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~394@ temp_5_1~411@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~443@ (Add (Sub c6~54@ a6~50@) (Mul c6~54@ d6~56@))) (=> (= temp_6_1~460@ (Add (Sub c6~54@ a6~50@) (Mul d6~56@ c6~54@))) (=> (= tmp%7@ (= temp_6_0~443@ temp_6_1~460@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~492@ (Sub (Mul b7~60@ b7~60@) (Mul a7~58@ d7~64@))) (=> (= temp_7_1~509@ (Sub (Mul b7~60@ b7~60@) (Mul a7~58@ d7~64@))) (=> (= tmp%8@ (= temp_7_0~492@ temp_7_1~509@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~541@ (Mul (Mul a8~66@ a8~66@) (Add c8~70@ d8~72@))) (=> (= temp_8_1~558@ (Mul (Mul a8~66@ a8~66@) (Add c8~70@ d8~72@))) (=> (= tmp%9@ (= temp_8_0~541@ temp_8_1~558@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
