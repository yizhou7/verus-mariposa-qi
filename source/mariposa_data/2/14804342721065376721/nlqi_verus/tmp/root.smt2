...
;; mariposa_data/2//14804342721065376721/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_7_1~449@ Int)
 (declare-const temp_8_0~481@ Int)
 (declare-const temp_8_1~498@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@)))
      (=>
       (= temp_0_1~118@ (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ a0~2@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Mul (Sub d1~16@ d1~16@) (Add a1~10@ c1~14@)))
           (=>
            (= temp_1_1~167@ (Mul (Add a1~10@ c1~14@) (Sub d1~16@ d1~16@)))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~199@ (Sub (Mul b2~20@ d2~24@) (Mul c2~22@ c2~22@)))
                (=>
                 (= temp_2_1~216@ (Sub (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@)))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~248@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@)))
                     (=>
                      (= temp_3_1~265@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@)))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~297@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@)))
                          (=>
                           (= temp_4_1~314@ (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)))
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~342@ (Mul (Mul c5~46@ d5~48@) b5~44@))
                               (=>
                                (= temp_5_1~355@ (Mul b5~44@ (Mul c5~46@ d5~48@)))
                                (=>
                                 (= tmp%6@ (= temp_5_0~342@ temp_5_1~355@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~387@ (Sub (Sub c6~54@ b6~52@) (Mul d6~56@ b6~52@)))
                                    (=>
                                     (= temp_6_1~404@ (Sub (Sub c6~54@ b6~52@) (Mul b6~52@ d6~56@)))
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~436@ (Sub (Mul d7~64@ a7~58@) (Mul d7~64@ c7~62@)))
                                         (=>
                                          (= temp_7_1~449@ (Mul d7~64@ (Sub a7~58@ c7~62@)))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~436@ temp_7_1~449@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~481@ (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ a8~66@)))
                                              (=>
                                               (= temp_8_1~498@ (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@)))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~481@ temp_8_1~498@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
