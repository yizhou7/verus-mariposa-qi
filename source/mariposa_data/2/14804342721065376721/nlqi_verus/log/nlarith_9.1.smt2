...
(declare-const temp_7_1~445@ Int)
(declare-const temp_8_0~477@ Int)
(declare-const temp_8_1~494@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ a0~2@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Sub d1~16@ d1~16@) (Add a1~10@ c1~14@))) (=> (= temp_1_1~163@ (Mul (Add a1~10@ c1~14@) (Sub d1~16@ d1~16@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Sub (Mul b2~20@ d2~24@) (Mul c2~22@ c2~22@))) (=> (= temp_2_1~212@ (Sub (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~212@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~244@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@))) (=> (= temp_3_1~261@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@))) (=> (= tmp%4@ (= temp_3_0~244@ temp_3_1~261@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~293@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@))) (=> (= temp_4_1~310@ (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@))) (=> (= tmp%5@ (= temp_4_0~293@ temp_4_1~310@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~338@ (Mul (Mul c5~46@ d5~48@) b5~44@)) (=> (= temp_5_1~351@ (Mul b5~44@ (Mul c5~46@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~338@ temp_5_1~351@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~383@ (Sub (Sub c6~54@ b6~52@) (Mul d6~56@ b6~52@))) (=> (= temp_6_1~400@ (Sub (Sub c6~54@ b6~52@) (Mul b6~52@ d6~56@))) (=> (= tmp%7@ (= temp_6_0~383@ temp_6_1~400@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~432@ (Sub (Mul d7~64@ a7~58@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~445@ (Mul d7~64@ (Sub a7~58@ c7~62@))) (=> (= tmp%8@ (= temp_7_0~432@ temp_7_1~445@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~477@ (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ a8~66@))) (=> (= temp_8_1~494@ (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@))) (=> (= tmp%9@ (= temp_8_0~477@ temp_8_1~494@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
