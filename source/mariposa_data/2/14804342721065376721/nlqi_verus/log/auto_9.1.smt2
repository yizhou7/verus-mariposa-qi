...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Sub d1~16@ d1~16@) (Add a1~10@ c1~14@))) (=> (= temp_1_1~172@ (Mul (Add a1~10@ c1~14@) (Sub d1~16@ d1~16@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Sub (Mul b2~20@ d2~24@) (Mul c2~22@ c2~22@))) (=> (= temp_2_1~230@ (Sub (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@))) (=> (= temp_3_1~288@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~288@))) (=> (= temp_3_0~271@ temp_3_1~288@) (=> (= temp_4_0~329@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@))) (=> (= temp_4_1~346@ (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~329@ temp_4_1~346@))) (=> (= temp_4_0~329@ temp_4_1~346@) (=> (= temp_5_0~383@ (Mul (Mul c5~46@ d5~48@) b5~44@)) (=> (= temp_5_1~396@ (Mul b5~44@ (Mul c5~46@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~383@ temp_5_1~396@))) (=> (= temp_5_0~383@ temp_5_1~396@) (=> (= temp_6_0~437@ (Sub (Sub c6~54@ b6~52@) (Mul d6~56@ b6~52@))) (=> (= temp_6_1~454@ (Sub (Sub c6~54@ b6~52@) (Mul b6~52@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~437@ temp_6_1~454@))) (=> (= temp_6_0~437@ temp_6_1~454@) (=> (= temp_7_0~495@ (Sub (Mul d7~64@ a7~58@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~508@ (Mul d7~64@ (Sub a7~58@ c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~495@ temp_7_1~508@))) (=> (= temp_7_0~495@ temp_7_1~508@) (=> (= temp_8_0~549@ (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ a8~66@))) (=> (= temp_8_1~566@ (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~549@ temp_8_1~566@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
