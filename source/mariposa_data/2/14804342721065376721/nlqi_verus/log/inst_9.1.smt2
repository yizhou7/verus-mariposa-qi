...
(set-info :comment ";; mariposa_data/2//14804342721065376721/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_2_0~237@ Int)
...
(declare-const temp_5_0~419@ Int)
(declare-const temp_5_1~432@ Int)
(declare-const temp_6_0~481@ Int)
(declare-const temp_6_1~498@ Int)
(declare-const temp_7_0~543@ Int)
(declare-const temp_7_1~556@ Int)
(declare-const temp_8_0~603@ Int)
(declare-const temp_8_1~620@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ a0~2@))) (and (=> (= tmp%1@ (Mul c0~6@ a0~2@)) (=> (= tmp%2@ (Mul d0~8@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Mul (Sub d1~16@ d1~16@) (Add a1~10@ c1~14@))) (=> (= temp_1_1~184@ (Mul (Add a1~10@ c1~14@) (Sub d1~16@ d1~16@))) (and (=> (= tmp%3@ (Sub d1~16@ d1~16@)) (=> (= tmp%4@ (Add a1~10@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@))))) (=> (= temp_1_0~167@ temp_1_1~184@) (=> (= temp_2_0~237@ (Sub (Mul b2~20@ d2~24@) (Mul c2~22@ c2~22@))) (=> (= temp_2_1~254@ (Sub (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ d2~24@) (=> %%location_label%%2 (= temp_2_0~237@ temp_2_1~254@))) (=> (= temp_2_0~237@ temp_2_1~254@) (=> (= temp_3_0~299@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@))) (=> (= temp_3_1~316@ (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ a3~26@) (=> %%location_label%%3 (= temp_3_0~299@ temp_3_1~316@))) (=> (= temp_3_0~299@ temp_3_1~316@) (=> (= temp_4_0~361@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ b4~36@))) (=> (= temp_4_1~378@ (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ d4~40@) (=> %%location_label%%4 (= temp_4_0~361@ temp_4_1~378@))) (=> (= temp_4_0~361@ temp_4_1~378@) (=> (= temp_5_0~419@ (Mul (Mul c5~46@ d5~48@) b5~44@)) (=> (= temp_5_1~432@ (Mul b5~44@ (Mul c5~46@ d5~48@))) (and (=> (= tmp%5@ (Mul c5~46@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ b5~44@) (=> %%location_label%%5 (= temp_5_0~419@ temp_5_1~432@)))) (=> (= temp_5_0~419@ temp_5_1~432@) (=> (= temp_6_0~481@ (Sub (Sub c6~54@ b6~52@) (Mul d6~56@ b6~52@))) (=> (= temp_6_1~498@ (Sub (Sub c6~54@ b6~52@) (Mul b6~52@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ b6~52@) (=> %%location_label%%6 (= temp_6_0~481@ temp_6_1~498@))) (=> (= temp_6_0~481@ temp_6_1~498@) (=> (= temp_7_0~543@ (Sub (Mul d7~64@ a7~58@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~556@ (Mul d7~64@ (Sub a7~58@ c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d7~64@ a7~58@ c7~62@) (=> %%location_label%%7 (= temp_7_0~543@ temp_7_1~556@))) (=> (= temp_7_0~543@ temp_7_1~556@) (=> (= temp_8_0~603@ (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ a8~66@))) (=> (= temp_8_1~620@ (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ c8~70@) (=> %%location_label%%8 (= temp_8_0~603@ temp_8_1~620@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
