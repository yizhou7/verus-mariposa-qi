...
(declare-const temp_5_1~391@ Int)
(declare-const temp_6_0~423@ Int)
(declare-const temp_6_1~440@ Int)
(declare-const temp_7_0~472@ Int)
(declare-const temp_7_1~489@ Int)
(declare-const temp_8_0~533@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add b0~4@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Add b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Sub c1~14@ c1~14@) (Add c1~14@ b1~12@))) (=> (= temp_1_1~163@ (Mul (Add c1~14@ b1~12@) (Sub c1~14@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ b2~20@))) (=> (= temp_2_1~212@ (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ c2~22@))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~212@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~244@ (Mul (Sub b3~28@ d3~32@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~269@ (Sub (Mul b3~28@ (Mul a3~26@ d3~32@)) (Mul d3~32@ (Mul a3~26@ d3~32@)))) (=> (= tmp%4@ (= temp_3_0~244@ temp_3_1~269@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~301@ (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ c4~38@))) (=> (= temp_4_1~318@ (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ c4~38@))) (=> (= tmp%5@ (= temp_4_0~301@ temp_4_1~318@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~362@ (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ 92))) (=> (= temp_5_1~391@ (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ 92))) (=> (= tmp%6@ (= temp_5_0~362@ temp_5_1~391@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~423@ (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ c6~54@))) (=> (= temp_6_1~440@ (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ c6~54@))) (=> (= tmp%7@ (= temp_6_0~423@ temp_6_1~440@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~472@ (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@))) (=> (= temp_7_1~489@ (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ c7~62@))) (=> (= tmp%8@ (= temp_7_0~472@ temp_7_1~489@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~533@ (Mul (Mul 38 d8~72@) (Mul b8~68@ b8~68@))) (=> (= temp_8_1~562@ (Mul (Mul 38 d8~72@) (Mul b8~68@ b8~68@))) (=> (= tmp%9@ (= temp_8_0~533@ temp_8_1~562@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
