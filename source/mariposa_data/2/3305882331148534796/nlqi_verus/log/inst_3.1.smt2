...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add b0~4@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Add b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ c0~6@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Sub c1~14@ c1~14@) (Add c1~14@ b1~12@))) (=> (= temp_1_1~176@ (Mul (Add c1~14@ b1~12@) (Sub c1~14@ c1~14@))) (and (=> (= tmp%1@ (Sub c1~14@ c1~14@)) (=> (= tmp%2@ (Add c1~14@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@))))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~229@ (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ b2~20@))) (=> (= temp_2_1~246@ (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ c2~22@))) (=> (= tmp%3@ (Mul b2~20@ c2~22@)) (=> (= tmp%4@ (Mul a2~18@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~229@ temp_2_1~246@))))))))))))))))))
(assert %%query%%)
(check-sat)
