...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Add b0~4@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= temp_0_1~118@ (Mul (Add b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~150@ (Mul (Sub c1~14@ c1~14@) (Add c1~14@ b1~12@))) (=> (= temp_1_1~167@ (Mul (Add c1~14@ b1~12@) (Sub c1~14@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~150@ temp_1_1~167@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~199@ (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ b2~20@))) (=> (= temp_2_1~216@ (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ c2~22@))) (=> (= tmp%3@ (= temp_2_0~199@ temp_2_1~216@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~248@ (Mul (Sub b3~28@ d3~32@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~273@ (Sub (Mul b3~28@ (Mul a3~26@ d3~32@)) (Mul d3~32@ (Mul a3~26@ d3~32@)))) (=> (= tmp%4@ (= temp_3_0~248@ temp_3_1~273@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~305@ (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ c4~38@))) (=> (= temp_4_1~322@ (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ c4~38@))) (=> (= tmp%5@ (= temp_4_0~305@ temp_4_1~322@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~366@ (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ 92))) (=> (= temp_5_1~395@ (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ 92))) (=> (= tmp%6@ (= temp_5_0~366@ temp_5_1~395@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~427@ (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ c6~54@))) (=> (= temp_6_1~444@ (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ c6~54@))) (=> (= tmp%7@ (= temp_6_0~427@ temp_6_1~444@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~476@ (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@))) (=> (= temp_7_1~493@ (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ c7~62@))) (=> (= tmp%8@ (= temp_7_0~476@ temp_7_1~493@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~537@ (Mul (Mul 38 d8~72@) (Mul b8~68@ b8~68@))) (=> (= temp_8_1~566@ (Mul (Mul 38 d8~72@) (Mul b8~68@ b8~68@))) (=> (= tmp%9@ (= temp_8_0~537@ temp_8_1~566@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
