...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Add b0~4@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Add b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Sub c1~14@ c1~14@) (Add c1~14@ b1~12@))) (=> (= temp_1_1~172@ (Mul (Add c1~14@ b1~12@) (Sub c1~14@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ b2~20@))) (=> (= temp_2_1~230@ (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Mul (Sub b3~28@ d3~32@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~296@ (Sub (Mul b3~28@ (Mul a3~26@ d3~32@)) (Mul d3~32@ (Mul a3~26@ d3~32@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~296@))) (=> (= temp_3_0~271@ temp_3_1~296@) (=> (= temp_4_0~337@ (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ c4~38@))) (=> (= temp_4_1~354@ (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~337@ temp_4_1~354@))) (=> (= temp_4_0~337@ temp_4_1~354@) (=> (= temp_5_0~407@ (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ 92))) (=> (= temp_5_1~436@ (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ 92))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~407@ temp_5_1~436@))) (=> (= temp_5_0~407@ temp_5_1~436@) (=> (= temp_6_0~477@ (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ c6~54@))) (=> (= temp_6_1~494@ (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ c6~54@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~477@ temp_6_1~494@))) (=> (= temp_6_0~477@ temp_6_1~494@) (=> (= temp_7_0~535@ (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@))) (=> (= temp_7_1~552@ (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~535@ temp_7_1~552@))) (=> (= temp_7_0~535@ temp_7_1~552@) (=> (= temp_8_0~605@ (Mul (Mul 38 d8~72@) (Mul b8~68@ b8~68@))) (=> (= temp_8_1~634@ (Mul (Mul 38 d8~72@) (Mul b8~68@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~605@ temp_8_1~634@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
