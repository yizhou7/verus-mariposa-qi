...
;; mariposa_data/2//8643362838370700739/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Sub (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)))
      (=>
       (= temp_0_1~118@ (Sub (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@)))
           (=>
            (= temp_1_1~167@ (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@)))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~199@ (Sub (Mul c2~22@ c2~22@) (Sub d2~24@ b2~20@)))
                (=>
                 (= temp_2_1~216@ (Sub (Mul c2~22@ c2~22@) (Sub d2~24@ b2~20@)))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~248@ (Sub (Mul d3~32@ d3~32@) (Sub c3~30@ b3~28@)))
                     (=>
                      (= temp_3_1~265@ (Sub (Mul d3~32@ d3~32@) (Sub c3~30@ b3~28@)))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~297@ (Add (Mul b4~36@ c4~38@) (Mul b4~36@ d4~40@)))
                          (=>
                           (= temp_4_1~314@ (Add (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@)))
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~346@ (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ c5~46@)))
                               (=>
                                (= temp_5_1~363@ (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ d5~48@)))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~395@ (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ d6~56@)))
                                    (=>
                                     (= temp_6_1~412@ (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ d6~56@)))
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~444@ (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ a7~58@)))
                                         (=>
                                          (= temp_7_1~461@ (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ a7~58@)))
                                          (=>
                                           ...
                                           (and
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~493@ (Sub (Add c8~70@ a8~66@) (Mul a8~66@ a8~66@)))
                                              (=>
                                               (= temp_8_1~510@ (Sub (Add c8~70@ a8~66@) (Mul a8~66@ a8~66@)))
                                               (=>
