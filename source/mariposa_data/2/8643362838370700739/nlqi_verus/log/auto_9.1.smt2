...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Sub (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~114@ (Sub (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@))) (=> (= temp_1_1~172@ (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Sub (Mul c2~22@ c2~22@) (Sub d2~24@ b2~20@))) (=> (= temp_2_1~230@ (Sub (Mul c2~22@ c2~22@) (Sub d2~24@ b2~20@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Sub (Mul d3~32@ d3~32@) (Sub c3~30@ b3~28@))) (=> (= temp_3_1~288@ (Sub (Mul d3~32@ d3~32@) (Sub c3~30@ b3~28@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~288@))) (=> (= temp_3_0~271@ temp_3_1~288@) (=> (= temp_4_0~329@ (Add (Mul b4~36@ c4~38@) (Mul b4~36@ d4~40@))) (=> (= temp_4_1~346@ (Add (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~329@ temp_4_1~346@))) (=> (= temp_4_0~329@ temp_4_1~346@) (=> (= temp_5_0~387@ (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ c5~46@))) (=> (= temp_5_1~404@ (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~387@ temp_5_1~404@))) (=> (= temp_5_0~387@ temp_5_1~404@) (=> (= temp_6_0~445@ (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ d6~56@))) (=> (= temp_6_1~462@ (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~445@ temp_6_1~462@))) (=> (= temp_6_0~445@ temp_6_1~462@) (=> (= temp_7_0~503@ (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ a7~58@))) (=> (= temp_7_1~520@ (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~503@ temp_7_1~520@))) (=> (= temp_7_0~503@ temp_7_1~520@) (=> (= temp_8_0~561@ (Sub (Add c8~70@ a8~66@) (Mul a8~66@ a8~66@))) (=> (= temp_8_1~578@ (Sub (Add c8~70@ a8~66@) (Mul a8~66@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~561@ temp_8_1~578@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
