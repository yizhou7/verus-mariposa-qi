...
(set-info :comment ";; mariposa_data/2//8643362838370700739/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_7_0~531@ Int)
(declare-const temp_7_1~548@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Sub (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~114@ (Sub (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ d0~8@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@))) (=> (= temp_1_1~176@ (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ d1~16@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~221@ (Sub (Mul c2~22@ c2~22@) (Sub d2~24@ b2~20@))) (=> (= temp_2_1~238@ (Sub (Mul c2~22@ c2~22@) (Sub d2~24@ b2~20@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ c2~22@) (=> %%location_label%%2 (= temp_2_0~221@ temp_2_1~238@))) (=> (= temp_2_0~221@ temp_2_1~238@) (=> (= temp_3_0~283@ (Sub (Mul d3~32@ d3~32@) (Sub c3~30@ b3~28@))) (=> (= temp_3_1~300@ (Sub (Mul d3~32@ d3~32@) (Sub c3~30@ b3~28@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ d3~32@) (=> %%location_label%%3 (= temp_3_0~283@ temp_3_1~300@))) (=> (= temp_3_0~283@ temp_3_1~300@) (=> (= temp_4_0~345@ (Add (Mul b4~36@ c4~38@) (Mul b4~36@ d4~40@))) (=> (= temp_4_1~362@ (Add (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ c4~38@) (=> %%location_label%%4 (= temp_4_0~345@ temp_4_1~362@))) (=> (= temp_4_0~345@ temp_4_1~362@) (=> (= temp_5_0~407@ (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ c5~46@))) (=> (= temp_5_1~424@ (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ c5~46@) (=> %%location_label%%5 (= temp_5_0~407@ temp_5_1~424@))) (=> (= temp_5_0~407@ temp_5_1~424@) (=> (= temp_6_0~469@ (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ d6~56@))) (=> (= temp_6_1~486@ (Mul (Mul c6~54@ b6~52@) (Mul c6~54@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b6~52@ c6~54@) (=> %%location_label%%6 (= temp_6_0~469@ temp_6_1~486@))) (=> (= temp_6_0~469@ temp_6_1~486@) (=> (= temp_7_0~531@ (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ a7~58@))) (=> (= temp_7_1~548@ (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ a7~58@) (=> %%location_label%%7 (= temp_7_0~531@ temp_7_1~548@))) (=> (= temp_7_0~531@ temp_7_1~548@) (=> (= temp_8_0~593@ (Sub (Add c8~70@ a8~66@) (Mul a8~66@ a8~66@))) (=> (= temp_8_1~610@ (Sub (Add c8~70@ a8~66@) (Mul a8~66@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ a8~66@) (=> %%location_label%%8 (= temp_8_0~593@ temp_8_1~610@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
