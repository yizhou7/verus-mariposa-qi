...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~172@ (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Add (Add c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (=> (= temp_2_1~230@ (Add (Add c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))))))))))))))))
(assert %%query%%)
(check-sat)
