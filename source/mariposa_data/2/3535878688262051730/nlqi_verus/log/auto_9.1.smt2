...
(declare-const temp_1_1~172@ Int)
(declare-const temp_2_0~213@ Int)
(declare-const temp_2_1~230@ Int)
(declare-const temp_3_0~271@ Int)
(declare-const temp_3_1~288@ Int)
(declare-const temp_4_0~329@ Int)
(declare-const temp_4_1~346@ Int)
(declare-const temp_5_0~387@ Int)
(declare-const temp_5_1~404@ Int)
(declare-const temp_6_0~445@ Int)
(declare-const temp_6_1~462@ Int)
(declare-const temp_7_0~503@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~172@ (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Add (Add c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (=> (= temp_2_1~230@ (Add (Add c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~288@ (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~288@))) (=> (= temp_3_0~271@ temp_3_1~288@) (=> (= temp_4_0~329@ (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (=> (= temp_4_1~346@ (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~329@ temp_4_1~346@))) (=> (= temp_4_0~329@ temp_4_1~346@) (=> (= temp_5_0~387@ (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (=> (= temp_5_1~404@ (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ c5~46@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~387@ temp_5_1~404@))) (=> (= temp_5_0~387@ temp_5_1~404@) (=> (= temp_6_0~445@ (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@))) (=> (= temp_6_1~462@ (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~445@ temp_6_1~462@))) (=> (= temp_6_0~445@ temp_6_1~462@) (=> (= temp_7_0~503@ (Mul (Sub d7~64@ c7~62@) (Mul d7~64@ b7~60@))) (=> (= temp_7_1~528@ (Sub (Mul d7~64@ (Mul d7~64@ b7~60@)) (Mul c7~62@ (Mul d7~64@ b7~60@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~503@ temp_7_1~528@))) (=> (= temp_7_0~503@ temp_7_1~528@) (=> (= temp_8_0~569@ (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~586@ (Mul d8~72@ (Mul a8~66@ (Mul a8~66@ d8~72@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~569@ temp_8_1~586@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
