...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~163@ (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Add (Add c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (=> (= temp_2_1~212@ (Add (Add c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~212@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~244@ (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~261@ (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (=> (= tmp%4@ (= temp_3_0~244@ temp_3_1~261@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~293@ (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (=> (= temp_4_1~310@ (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@))) (=> (= tmp%5@ (= temp_4_0~293@ temp_4_1~310@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~342@ (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (=> (= temp_5_1~359@ (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ c5~46@))) (=> (= tmp%6@ (= temp_5_0~342@ temp_5_1~359@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~391@ (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@))) (=> (= temp_6_1~408@ (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@))) (=> (= tmp%7@ (= temp_6_0~391@ temp_6_1~408@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~440@ (Mul (Sub d7~64@ c7~62@) (Mul d7~64@ b7~60@))) (=> (= temp_7_1~465@ (Sub (Mul d7~64@ (Mul d7~64@ b7~60@)) (Mul c7~62@ (Mul d7~64@ b7~60@)))) (=> (= tmp%8@ (= temp_7_0~440@ temp_7_1~465@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~497@ (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~514@ (Mul d8~72@ (Mul a8~66@ (Mul a8~66@ d8~72@)))) (=> (= tmp%9@ (= temp_8_0~497@ temp_8_1~514@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
