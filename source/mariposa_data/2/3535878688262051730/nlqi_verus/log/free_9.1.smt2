...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~101@ (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@))) (=> (= temp_0_1~118@ (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))) (=> (= tmp%1@ (= temp_0_0~101@ temp_0_1~118@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~150@ (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~167@ (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~150@ temp_1_1~167@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~199@ (Add (Add c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (=> (= temp_2_1~216@ (Add (Add c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (=> (= tmp%3@ (= temp_2_0~199@ temp_2_1~216@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~248@ (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~265@ (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (=> (= tmp%4@ (= temp_3_0~248@ temp_3_1~265@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~297@ (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (=> (= temp_4_1~314@ (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@))) (=> (= tmp%5@ (= temp_4_0~297@ temp_4_1~314@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~346@ (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (=> (= temp_5_1~363@ (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ c5~46@))) (=> (= tmp%6@ (= temp_5_0~346@ temp_5_1~363@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~395@ (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@))) (=> (= temp_6_1~412@ (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@))) (=> (= tmp%7@ (= temp_6_0~395@ temp_6_1~412@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~444@ (Mul (Sub d7~64@ c7~62@) (Mul d7~64@ b7~60@))) (=> (= temp_7_1~469@ (Sub (Mul d7~64@ (Mul d7~64@ b7~60@)) (Mul c7~62@ (Mul d7~64@ b7~60@)))) (=> (= tmp%8@ (= temp_7_0~444@ temp_7_1~469@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~501@ (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~518@ (Mul d8~72@ (Mul a8~66@ (Mul a8~66@ d8~72@)))) (=> (= tmp%9@ (= temp_8_0~501@ temp_8_1~518@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
