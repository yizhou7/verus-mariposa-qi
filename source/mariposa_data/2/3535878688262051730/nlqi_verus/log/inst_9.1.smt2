...
(set-info :comment ";; mariposa_data/2//3535878688262051730/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_5_0~407@ Int)
(declare-const temp_5_1~424@ Int)
(declare-const temp_6_0~469@ Int)
(declare-const temp_6_1~486@ Int)
(declare-const temp_7_0~539@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ c0~6@))) (=> (= temp_0_1~114@ (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ b0~4@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~176@ (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ c1~14@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~221@ (Add (Add c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (=> (= temp_2_1~238@ (Add (Add c2~22@ d2~24@) (Mul b2~20@ b2~20@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ b2~20@) (=> %%location_label%%2 (= temp_2_0~221@ temp_2_1~238@))) (=> (= temp_2_0~221@ temp_2_1~238@) (=> (= temp_3_0~283@ (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))) (=> (= temp_3_1~300@ (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ d3~32@) (=> %%location_label%%3 (= temp_3_0~283@ temp_3_1~300@))) (=> (= temp_3_0~283@ temp_3_1~300@) (=> (= temp_4_0~345@ (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (=> (= temp_4_1~362@ (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ d4~40@) (=> %%location_label%%4 (= temp_4_0~345@ temp_4_1~362@))) (=> (= temp_4_0~345@ temp_4_1~362@) (=> (= temp_5_0~407@ (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (=> (= temp_5_1~424@ (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ c5~46@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ a5~42@) (=> %%location_label%%5 (= temp_5_0~407@ temp_5_1~424@))) (=> (= temp_5_0~407@ temp_5_1~424@) (=> (= temp_6_0~469@ (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ d6~56@))) (=> (= temp_6_1~486@ (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@))) (and (=> (= tmp%1@ (Mul a6~50@ b6~52@)) (=> (= tmp%2@ (Mul a6~50@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%6 (= temp_6_0~469@ temp_6_1~486@))))) (=> (= temp_6_0~469@ temp_6_1~486@) (=> (= temp_7_0~539@ (Mul (Sub d7~64@ c7~62@) (Mul d7~64@ b7~60@))) (=> (= temp_7_1~564@ (Sub (Mul d7~64@ (Mul d7~64@ b7~60@)) (Mul c7~62@ (Mul d7~64@ b7~60@)))) (and (=> (= tmp%3@ (Mul d7~64@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d7~64@ c7~62@ tmp%3@) (=> %%location_label%%7 (= temp_7_0~539@ temp_7_1~564@)))) (=> (= temp_7_0~539@ temp_7_1~564@) (=> (= temp_8_0~615@ (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~632@ (Mul d8~72@ (Mul a8~66@ (Mul a8~66@ d8~72@)))) (=> (= tmp%4@ (Mul a8~66@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d8~72@ a8~66@ tmp%4@) (=> %%location_label%%8 (= temp_8_0~615@ temp_8_1~632@)))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
