...
;; mariposa_data/2//17609195579966620225/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Sub d0~8@ b0~4@) (Add d0~8@ a0~2@)))
      (=>
       (= temp_0_1~118@ (Mul (Add d0~8@ a0~2@) (Sub d0~8@ b0~4@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@)))
           (=>
            (= temp_1_1~167@ (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@)))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~199@ (Mul (Add c2~22@ a2~18@) (Mul b2~20@ b2~20@)))
                (=>
                 (= temp_2_1~224@ (Add (Mul c2~22@ (Mul b2~20@ b2~20@)) (Mul a2~18@ (Mul b2~20@ b2~20@))))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~256@ (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@)))
                     (=>
                      (= temp_3_1~273@ (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ b3~28@)))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~305@ (Add (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@)))
                          (=>
                           (= temp_4_1~322@ (Add (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@)))
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~354@ (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@)))
                               (=>
                                (= temp_5_1~371@ (Mul (Mul (Mul b5~44@ a5~42@) c5~46@) a5~42@))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~403@ (Add (Mul c6~54@ d6~56@) (Sub a6~50@ a6~50@)))
                                    (=>
                                     (= temp_6_1~420@ (Add (Mul d6~56@ c6~54@) (Sub a6~50@ a6~50@)))
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~452@ (Add (Mul c7~62@ a7~58@) (Mul d7~64@ c7~62@)))
                                         (=>
                                          (= temp_7_1~469@ (Add (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@)))
                                          (=>
                                           ...
                                           (and
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~497@ (Mul (Mul d8~72@ c8~70@) d8~72@))
                                              (=>
                                               (= temp_8_1~510@ (Mul (Mul c8~70@ d8~72@) d8~72@))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~497@ temp_8_1~510@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
