...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub d0~8@ b0~4@) (Add d0~8@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Add d0~8@ a0~2@) (Sub d0~8@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (=> (= temp_1_1~172@ (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))))))))))))
(assert %%query%%)
(check-sat)
