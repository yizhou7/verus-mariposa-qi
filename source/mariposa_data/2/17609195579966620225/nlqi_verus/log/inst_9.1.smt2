...
(set-info :comment ";; mariposa_data/2//17609195579966620225/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_2_1~254@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub d0~8@ b0~4@) (Add d0~8@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Add d0~8@ a0~2@) (Sub d0~8@ b0~4@))) (and (=> (= tmp%1@ (Sub d0~8@ b0~4@)) (=> (= tmp%2@ (Add d0~8@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~167@ (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (=> (= temp_1_1~184@ (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ c1~14@) (=> %%location_label%%1 (= temp_1_0~167@ temp_1_1~184@))) (=> (= temp_1_0~167@ temp_1_1~184@) (=> (= temp_2_0~229@ (Mul (Add c2~22@ a2~18@) (Mul b2~20@ b2~20@))) (=> (= temp_2_1~254@ (Add (Mul c2~22@ (Mul b2~20@ b2~20@)) (Mul a2~18@ (Mul b2~20@ b2~20@)))) (and (=> (= tmp%3@ (Mul b2~20@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c2~22@ a2~18@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~229@ temp_2_1~254@)))) (=> (= temp_2_0~229@ temp_2_1~254@) (=> (= temp_3_0~305@ (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@))) (=> (= temp_3_1~322@ (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ b3~28@))) (and (=> (= tmp%4@ (Mul a3~26@ b3~28@)) (=> (= tmp%5@ (Mul a3~26@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~305@ temp_3_1~322@))))) (=> (= temp_3_0~305@ temp_3_1~322@) (=> (= temp_4_0~375@ (Add (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))) (=> (= temp_4_1~392@ (Add (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ d4~40@) (=> %%location_label%%4 (= temp_4_0~375@ temp_4_1~392@))) (=> (= temp_4_0~375@ temp_4_1~392@) (=> (= temp_5_0~437@ (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))) (=> (= temp_5_1~454@ (Mul (Mul (Mul b5~44@ a5~42@) c5~46@) a5~42@)) (and (=> (= tmp%6@ (Mul b5~44@ a5~42@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ c5~46@ a5~42@) (=> %%location_label%%5 (= temp_5_0~437@ temp_5_1~454@)))) (=> (= temp_5_0~437@ temp_5_1~454@) (=> (= temp_6_0~505@ (Add (Mul c6~54@ d6~56@) (Sub a6~50@ a6~50@))) (=> (= temp_6_1~522@ (Add (Mul d6~56@ c6~54@) (Sub a6~50@ a6~50@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ d6~56@) (=> %%location_label%%6 (= temp_6_0~505@ temp_6_1~522@))) (=> (= temp_6_0~505@ temp_6_1~522@) (=> (= temp_7_0~567@ (Add (Mul c7~62@ a7~58@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~584@ (Add (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ c7~62@) (=> %%location_label%%7 (= temp_7_0~567@ temp_7_1~584@))) (=> (= temp_7_0~567@ temp_7_1~584@) (=> (= temp_8_0~625@ (Mul (Mul d8~72@ c8~70@) d8~72@)) (=> (= temp_8_1~638@ (Mul (Mul c8~70@ d8~72@) d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d8~72@ c8~70@) (=> %%location_label%%8 (= temp_8_0~625@ temp_8_1~638@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
