...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub d0~8@ b0~4@) (Add d0~8@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Add d0~8@ a0~2@) (Sub d0~8@ b0~4@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (=> (= temp_1_1~163@ (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Mul (Add c2~22@ a2~18@) (Mul b2~20@ b2~20@))) (=> (= temp_2_1~220@ (Add (Mul c2~22@ (Mul b2~20@ b2~20@)) (Mul a2~18@ (Mul b2~20@ b2~20@)))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~220@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~252@ (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@))) (=> (= temp_3_1~269@ (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ b3~28@))) (=> (= tmp%4@ (= temp_3_0~252@ temp_3_1~269@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~301@ (Add (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))) (=> (= temp_4_1~318@ (Add (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@))) (=> (= tmp%5@ (= temp_4_0~301@ temp_4_1~318@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~350@ (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))) (=> (= temp_5_1~367@ (Mul (Mul (Mul b5~44@ a5~42@) c5~46@) a5~42@)) (=> (= tmp%6@ (= temp_5_0~350@ temp_5_1~367@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~399@ (Add (Mul c6~54@ d6~56@) (Sub a6~50@ a6~50@))) (=> (= temp_6_1~416@ (Add (Mul d6~56@ c6~54@) (Sub a6~50@ a6~50@))) (=> (= tmp%7@ (= temp_6_0~399@ temp_6_1~416@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~448@ (Add (Mul c7~62@ a7~58@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~465@ (Add (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@))) (=> (= tmp%8@ (= temp_7_0~448@ temp_7_1~465@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~493@ (Mul (Mul d8~72@ c8~70@) d8~72@)) (=> (= temp_8_1~506@ (Mul (Mul c8~70@ d8~72@) d8~72@)) (=> (= tmp%9@ (= temp_8_0~493@ temp_8_1~506@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
