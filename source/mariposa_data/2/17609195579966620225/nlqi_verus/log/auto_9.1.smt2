...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Sub d0~8@ b0~4@) (Add d0~8@ a0~2@))) (=> (= temp_0_1~114@ (Mul (Add d0~8@ a0~2@) (Sub d0~8@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (=> (= temp_1_1~172@ (Add (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Add c2~22@ a2~18@) (Mul b2~20@ b2~20@))) (=> (= temp_2_1~238@ (Add (Mul c2~22@ (Mul b2~20@ b2~20@)) (Mul a2~18@ (Mul b2~20@ b2~20@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~238@))) (=> (= temp_2_0~213@ temp_2_1~238@) (=> (= temp_3_0~279@ (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ c3~30@))) (=> (= temp_3_1~296@ (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ b3~28@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~279@ temp_3_1~296@))) (=> (= temp_3_0~279@ temp_3_1~296@) (=> (= temp_4_0~337@ (Add (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))) (=> (= temp_4_1~354@ (Add (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~337@ temp_4_1~354@))) (=> (= temp_4_0~337@ temp_4_1~354@) (=> (= temp_5_0~395@ (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ a5~42@))) (=> (= temp_5_1~412@ (Mul (Mul (Mul b5~44@ a5~42@) c5~46@) a5~42@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~395@ temp_5_1~412@))) (=> (= temp_5_0~395@ temp_5_1~412@) (=> (= temp_6_0~453@ (Add (Mul c6~54@ d6~56@) (Sub a6~50@ a6~50@))) (=> (= temp_6_1~470@ (Add (Mul d6~56@ c6~54@) (Sub a6~50@ a6~50@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~453@ temp_6_1~470@))) (=> (= temp_6_0~453@ temp_6_1~470@) (=> (= temp_7_0~511@ (Add (Mul c7~62@ a7~58@) (Mul d7~64@ c7~62@))) (=> (= temp_7_1~528@ (Add (Mul c7~62@ a7~58@) (Mul c7~62@ d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~511@ temp_7_1~528@))) (=> (= temp_7_0~511@ temp_7_1~528@) (=> (= temp_8_0~565@ (Mul (Mul d8~72@ c8~70@) d8~72@)) (=> (= temp_8_1~578@ (Mul (Mul c8~70@ d8~72@) d8~72@)) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~565@ temp_8_1~578@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
