...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ c0~6@) (Add c0~6@ d0~8@))) (=> (= temp_0_1~114@ (Mul a0~2@ (Mul c0~6@ (Add c0~6@ d0~8@)))) (and (=> (= tmp%1@ (Add c0~6@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a0~2@ c0~6@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@)))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~165@ (Mul (Add d1~16@ a1~10@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~182@ (Mul (Mul (Add d1~16@ a1~10@) b1~12@) b1~12@)) (=> (= tmp%2@ (Add d1~16@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ b1~12@ b1~12@) (=> %%location_label%%1 (= temp_1_0~165@ temp_1_1~182@)))))))))))))
(assert %%query%%)
(check-sat)
