...
(declare-const temp_7_1~481@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ c0~6@) (Add c0~6@ d0~8@))) (=> (= temp_0_1~114@ (Mul a0~2@ (Mul c0~6@ (Add c0~6@ d0~8@)))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Add d1~16@ a1~10@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~163@ (Mul (Mul (Add d1~16@ a1~10@) b1~12@) b1~12@)) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@))) (=> (= temp_2_1~212@ (Mul c2~22@ (Mul b2~20@ (Mul b2~20@ d2~24@)))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~212@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~244@ (Sub (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@))) (=> (= temp_3_1~261@ (Sub (Mul a3~26@ c3~30@) (Mul a3~26@ b3~28@))) (=> (= tmp%4@ (= temp_3_0~244@ temp_3_1~261@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~293@ (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~310@ (Mul (Mul d4~40@ b4~36@) (Sub c4~38@ c4~38@))) (=> (= tmp%5@ (= temp_4_0~293@ temp_4_1~310@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~342@ (Sub (Mul d5~48@ d5~48@) (Sub c5~46@ d5~48@))) (=> (= temp_5_1~359@ (Sub (Mul d5~48@ d5~48@) (Sub c5~46@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~342@ temp_5_1~359@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~391@ (Mul (Mul c6~54@ d6~56@) (Add a6~50@ d6~56@))) (=> (= temp_6_1~408@ (Mul (Mul d6~56@ c6~54@) (Add a6~50@ d6~56@))) (=> (= tmp%7@ (= temp_6_0~391@ temp_6_1~408@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~452@ (Mul (Mul 29 d7~64@) (Mul a7~58@ d7~64@))) (=> (= temp_7_1~481@ (Mul (Mul 29 d7~64@) (Mul d7~64@ a7~58@))) (=> (= tmp%8@ (= temp_7_0~452@ temp_7_1~481@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~513@ (Mul (Add d8~72@ d8~72@) (Mul c8~70@ d8~72@))) (=> (= temp_8_1~530@ (Mul (Mul c8~70@ d8~72@) (Add d8~72@ d8~72@))) (=> (= tmp%9@ (= temp_8_0~513@ temp_8_1~530@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
