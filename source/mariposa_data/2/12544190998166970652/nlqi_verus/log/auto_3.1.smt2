...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ c0~6@) (Add c0~6@ d0~8@))) (=> (= temp_0_1~114@ (Mul a0~2@ (Mul c0~6@ (Add c0~6@ d0~8@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Add d1~16@ a1~10@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~172@ (Mul (Mul (Add d1~16@ a1~10@) b1~12@) b1~12@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@))) (=> (= temp_2_1~230@ (Mul c2~22@ (Mul b2~20@ (Mul b2~20@ d2~24@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))))))))))))))))
(assert %%query%%)
(check-sat)
