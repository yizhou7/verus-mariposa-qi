...
(set-info :comment ";; mariposa_data/2//12544190998166970652/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_2_0~233@ Int)
(declare-const temp_2_1~250@ Int)
(declare-const temp_3_0~301@ Int)
(declare-const temp_3_1~318@ Int)
(declare-const temp_4_0~363@ Int)
(declare-const temp_4_1~380@ Int)
(declare-const temp_5_0~433@ Int)
(declare-const temp_5_1~450@ Int)
(declare-const temp_6_0~495@ Int)
(declare-const temp_6_1~512@ Int)
(declare-const temp_7_0~569@ Int)
(declare-const temp_7_1~598@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ c0~6@) (Add c0~6@ d0~8@))) (=> (= temp_0_1~114@ (Mul a0~2@ (Mul c0~6@ (Add c0~6@ d0~8@)))) (and (=> (= tmp%1@ (Add c0~6@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a0~2@ c0~6@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@)))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~165@ (Mul (Add d1~16@ a1~10@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~182@ (Mul (Mul (Add d1~16@ a1~10@) b1~12@) b1~12@)) (and (=> (= tmp%2@ (Add d1~16@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ b1~12@ b1~12@) (=> %%location_label%%1 (= temp_1_0~165@ temp_1_1~182@)))) (=> (= temp_1_0~165@ temp_1_1~182@) (=> (= temp_2_0~233@ (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@))) (=> (= temp_2_1~250@ (Mul c2~22@ (Mul b2~20@ (Mul b2~20@ d2~24@)))) (and (=> (= tmp%3@ (Mul b2~20@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c2~22@ b2~20@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~233@ temp_2_1~250@)))) (=> (= temp_2_0~233@ temp_2_1~250@) (=> (= temp_3_0~301@ (Sub (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@))) (=> (= temp_3_1~318@ (Sub (Mul a3~26@ c3~30@) (Mul a3~26@ b3~28@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ a3~26@) (=> %%location_label%%3 (= temp_3_0~301@ temp_3_1~318@))) (=> (= temp_3_0~301@ temp_3_1~318@) (=> (= temp_4_0~363@ (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~380@ (Mul (Mul d4~40@ b4~36@) (Sub c4~38@ c4~38@))) (and (=> (= tmp%4@ (Sub c4~38@ c4~38@)) (=> (= tmp%5@ (Mul d4~40@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%4 (= temp_4_0~363@ temp_4_1~380@))))) (=> (= temp_4_0~363@ temp_4_1~380@) (=> (= temp_5_0~433@ (Sub (Mul d5~48@ d5~48@) (Sub c5~46@ d5~48@))) (=> (= temp_5_1~450@ (Sub (Mul d5~48@ d5~48@) (Sub c5~46@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ d5~48@) (=> %%location_label%%5 (= temp_5_0~433@ temp_5_1~450@))) (=> (= temp_5_0~433@ temp_5_1~450@) (=> (= temp_6_0~495@ (Mul (Mul c6~54@ d6~56@) (Add a6~50@ d6~56@))) (=> (= temp_6_1~512@ (Mul (Mul d6~56@ c6~54@) (Add a6~50@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ d6~56@) (=> %%location_label%%6 (= temp_6_0~495@ temp_6_1~512@))) (=> (= temp_6_0~495@ temp_6_1~512@) (=> (= temp_7_0~569@ (Mul (Mul 29 d7~64@) (Mul a7~58@ d7~64@))) (=> (= temp_7_1~598@ (Mul (Mul 29 d7~64@) (Mul d7~64@ a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ d7~64@) (=> %%location_label%%7 (= temp_7_0~569@ temp_7_1~598@))) (=> (= temp_7_0~569@ temp_7_1~598@) (=> (= temp_8_0~643@ (Mul (Add d8~72@ d8~72@) (Mul c8~70@ d8~72@))) (=> (= temp_8_1~660@ (Mul (Mul c8~70@ d8~72@) (Add d8~72@ d8~72@))) (=> (= tmp%6@ (Add d8~72@ d8~72@)) (=> (= tmp%7@ (Mul c8~70@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%8 (= temp_8_0~643@ temp_8_1~660@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
