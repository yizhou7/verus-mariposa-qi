...
(declare-const temp_7_0~515@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul a0~2@ c0~6@) (Add c0~6@ d0~8@))) (=> (= temp_0_1~114@ (Mul a0~2@ (Mul c0~6@ (Add c0~6@ d0~8@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Add d1~16@ a1~10@) (Mul b1~12@ b1~12@))) (=> (= temp_1_1~172@ (Mul (Mul (Add d1~16@ a1~10@) b1~12@) b1~12@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@))) (=> (= temp_2_1~230@ (Mul c2~22@ (Mul b2~20@ (Mul b2~20@ d2~24@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Sub (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@))) (=> (= temp_3_1~288@ (Sub (Mul a3~26@ c3~30@) (Mul a3~26@ b3~28@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~288@))) (=> (= temp_3_0~271@ temp_3_1~288@) (=> (= temp_4_0~329@ (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~346@ (Mul (Mul d4~40@ b4~36@) (Sub c4~38@ c4~38@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~329@ temp_4_1~346@))) (=> (= temp_4_0~329@ temp_4_1~346@) (=> (= temp_5_0~387@ (Sub (Mul d5~48@ d5~48@) (Sub c5~46@ d5~48@))) (=> (= temp_5_1~404@ (Sub (Mul d5~48@ d5~48@) (Sub c5~46@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~387@ temp_5_1~404@))) (=> (= temp_5_0~387@ temp_5_1~404@) (=> (= temp_6_0~445@ (Mul (Mul c6~54@ d6~56@) (Add a6~50@ d6~56@))) (=> (= temp_6_1~462@ (Mul (Mul d6~56@ c6~54@) (Add a6~50@ d6~56@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~445@ temp_6_1~462@))) (=> (= temp_6_0~445@ temp_6_1~462@) (=> (= temp_7_0~515@ (Mul (Mul 29 d7~64@) (Mul a7~58@ d7~64@))) (=> (= temp_7_1~544@ (Mul (Mul 29 d7~64@) (Mul d7~64@ a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~515@ temp_7_1~544@))) (=> (= temp_7_0~515@ temp_7_1~544@) (=> (= temp_8_0~585@ (Mul (Add d8~72@ d8~72@) (Mul c8~70@ d8~72@))) (=> (= temp_8_1~602@ (Mul (Mul c8~70@ d8~72@) (Add d8~72@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~585@ temp_8_1~602@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
