...
;; mariposa_data/2//12544190998166970652/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_7_0~456@ Int)
 (declare-const temp_7_1~485@ Int)
 (declare-const temp_8_0~517@ Int)
 (declare-const temp_8_1~534@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~101@ (Mul (Mul a0~2@ c0~6@) (Add c0~6@ d0~8@)))
      (=>
       (= temp_0_1~118@ (Mul a0~2@ (Mul c0~6@ (Add c0~6@ d0~8@))))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~150@ (Mul (Add d1~16@ a1~10@) (Mul b1~12@ b1~12@)))
           (=>
            (= temp_1_1~167@ (Mul (Mul (Add d1~16@ a1~10@) b1~12@) b1~12@))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~199@ (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ d2~24@)))
                (=>
                 (= temp_2_1~216@ (Mul c2~22@ (Mul b2~20@ (Mul b2~20@ d2~24@))))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~248@ (Sub (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@)))
                     (=>
                      (= temp_3_1~265@ (Sub (Mul a3~26@ c3~30@) (Mul a3~26@ b3~28@)))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~297@ (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ b4~36@)))
                          (=>
                           (= temp_4_1~314@ (Mul (Mul d4~40@ b4~36@) (Sub c4~38@ c4~38@)))
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~346@ (Sub (Mul d5~48@ d5~48@) (Sub c5~46@ d5~48@)))
                               (=>
                                (= temp_5_1~363@ (Sub (Mul d5~48@ d5~48@) (Sub c5~46@ d5~48@)))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~395@ (Mul (Mul c6~54@ d6~56@) (Add a6~50@ d6~56@)))
                                    (=>
                                     (= temp_6_1~412@ (Mul (Mul d6~56@ c6~54@) (Add a6~50@ d6~56@)))
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~456@ (Mul (Mul 29 d7~64@) (Mul a7~58@ d7~64@)))
                                         (=>
                                          (= temp_7_1~485@ (Mul (Mul 29 d7~64@) (Mul d7~64@ a7~58@)))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~456@ temp_7_1~485@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~517@ (Mul (Add d8~72@ d8~72@) (Mul c8~70@ d8~72@)))
                                              (=>
                                               (= temp_8_1~534@ (Mul (Mul c8~70@ d8~72@) (Add d8~72@ d8~72@)))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~517@ temp_8_1~534@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
