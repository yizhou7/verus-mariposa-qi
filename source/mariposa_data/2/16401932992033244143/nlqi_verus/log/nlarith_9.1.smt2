...
(declare-const temp_1_1~163@ Int)
...
(declare-const temp_6_1~424@ Int)
(declare-const temp_7_0~456@ Int)
(declare-const temp_7_1~473@ Int)
(declare-const temp_8_0~505@ Int)
(declare-const temp_8_1~522@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))) (=> (= tmp%1@ (= temp_0_0~97@ temp_0_1~114@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~146@ (Mul (Mul d1~16@ c1~14@) (Add c1~14@ b1~12@))) (=> (= temp_1_1~163@ (Mul (Add c1~14@ b1~12@) (Mul d1~16@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~146@ temp_1_1~163@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~195@ (Add (Mul c2~22@ b2~20@) (Add a2~18@ c2~22@))) (=> (= temp_2_1~212@ (Add (Mul b2~20@ c2~22@) (Add a2~18@ c2~22@))) (=> (= tmp%3@ (= temp_2_0~195@ temp_2_1~212@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~244@ (Mul (Add a3~26@ a3~26@) (Sub b3~28@ c3~30@))) (=> (= temp_3_1~269@ (Sub (Mul (Add a3~26@ a3~26@) b3~28@) (Mul (Add a3~26@ a3~26@) c3~30@))) (=> (= tmp%4@ (= temp_3_0~244@ temp_3_1~269@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~301@ (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~318@ (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@))) (=> (= tmp%5@ (= temp_4_0~301@ temp_4_1~318@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~350@ (Sub (Mul d5~48@ c5~46@) (Mul a5~42@ b5~44@))) (=> (= temp_5_1~367@ (Sub (Mul c5~46@ d5~48@) (Mul a5~42@ b5~44@))) (=> (= tmp%6@ (= temp_5_0~350@ temp_5_1~367@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~399@ (Mul (Add a6~50@ a6~50@) (Mul a6~50@ c6~54@))) (=> (= temp_6_1~424@ (Add (Mul a6~50@ (Mul a6~50@ c6~54@)) (Mul a6~50@ (Mul a6~50@ c6~54@)))) (=> (= tmp%7@ (= temp_6_0~399@ temp_6_1~424@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~456@ (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ b7~60@))) (=> (= temp_7_1~473@ (Mul (Mul (Mul d7~64@ d7~64@) d7~64@) b7~60@)) (=> (= tmp%8@ (= temp_7_0~456@ temp_7_1~473@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~505@ (Mul (Mul b8~68@ b8~68@) (Mul b8~68@ a8~66@))) (=> (= temp_8_1~522@ (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ b8~68@))) (=> (= tmp%9@ (= temp_8_0~505@ temp_8_1~522@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
