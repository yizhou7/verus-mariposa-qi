...
(set-info :comment ";; mariposa_data/2//16401932992033244143/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_3_0~291@ Int)
(declare-const temp_3_1~316@ Int)
(declare-const temp_4_0~367@ Int)
(declare-const temp_4_1~384@ Int)
(declare-const temp_5_0~437@ Int)
(declare-const temp_5_1~454@ Int)
(declare-const temp_6_0~499@ Int)
(declare-const temp_6_1~524@ Int)
(declare-const temp_7_0~575@ Int)
(declare-const temp_7_1~592@ Int)
(declare-const temp_8_0~643@ Int)
(declare-const temp_8_1~660@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ c0~6@) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~159@ (Mul (Mul d1~16@ c1~14@) (Add c1~14@ b1~12@))) (=> (= temp_1_1~176@ (Mul (Add c1~14@ b1~12@) (Mul d1~16@ c1~14@))) (and (=> (= tmp%1@ (Mul d1~16@ c1~14@)) (=> (= tmp%2@ (Add c1~14@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~159@ temp_1_1~176@))))) (=> (= temp_1_0~159@ temp_1_1~176@) (=> (= temp_2_0~229@ (Add (Mul c2~22@ b2~20@) (Add a2~18@ c2~22@))) (=> (= temp_2_1~246@ (Add (Mul b2~20@ c2~22@) (Add a2~18@ c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ b2~20@) (=> %%location_label%%2 (= temp_2_0~229@ temp_2_1~246@))) (=> (= temp_2_0~229@ temp_2_1~246@) (=> (= temp_3_0~291@ (Mul (Add a3~26@ a3~26@) (Sub b3~28@ c3~30@))) (=> (= temp_3_1~316@ (Sub (Mul (Add a3~26@ a3~26@) b3~28@) (Mul (Add a3~26@ a3~26@) c3~30@))) (and (=> (= tmp%3@ (Add a3~26@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ b3~28@ c3~30@) (=> %%location_label%%3 (= temp_3_0~291@ temp_3_1~316@)))) (=> (= temp_3_0~291@ temp_3_1~316@) (=> (= temp_4_0~367@ (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~384@ (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@))) (and (=> (= tmp%4@ (Mul d4~40@ a4~34@)) (=> (= tmp%5@ (Mul d4~40@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%4 (= temp_4_0~367@ temp_4_1~384@))))) (=> (= temp_4_0~367@ temp_4_1~384@) (=> (= temp_5_0~437@ (Sub (Mul d5~48@ c5~46@) (Mul a5~42@ b5~44@))) (=> (= temp_5_1~454@ (Sub (Mul c5~46@ d5~48@) (Mul a5~42@ b5~44@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ c5~46@) (=> %%location_label%%5 (= temp_5_0~437@ temp_5_1~454@))) (=> (= temp_5_0~437@ temp_5_1~454@) (=> (= temp_6_0~499@ (Mul (Add a6~50@ a6~50@) (Mul a6~50@ c6~54@))) (=> (= temp_6_1~524@ (Add (Mul a6~50@ (Mul a6~50@ c6~54@)) (Mul a6~50@ (Mul a6~50@ c6~54@)))) (and (=> (= tmp%6@ (Mul a6~50@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. a6~50@ a6~50@ tmp%6@) (=> %%location_label%%6 (= temp_6_0~499@ temp_6_1~524@)))) (=> (= temp_6_0~499@ temp_6_1~524@) (=> (= temp_7_0~575@ (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ b7~60@))) (=> (= temp_7_1~592@ (Mul (Mul (Mul d7~64@ d7~64@) d7~64@) b7~60@)) (and (=> (= tmp%7@ (Mul d7~64@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ d7~64@ b7~60@) (=> %%location_label%%7 (= temp_7_0~575@ temp_7_1~592@)))) (=> (= temp_7_0~575@ temp_7_1~592@) (=> (= temp_8_0~643@ (Mul (Mul b8~68@ b8~68@) (Mul b8~68@ a8~66@))) (=> (= temp_8_1~660@ (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ a8~66@) (=> %%location_label%%8 (= temp_8_0~643@ temp_8_1~660@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
