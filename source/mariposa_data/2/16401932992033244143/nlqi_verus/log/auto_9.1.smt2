...
(assert (=> %%query%% (not (=> (= temp_0_0~97@ (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ b0~4@))) (=> (= temp_0_1~114@ (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~97@ temp_0_1~114@))) (=> (= temp_0_0~97@ temp_0_1~114@) (=> (= temp_1_0~155@ (Mul (Mul d1~16@ c1~14@) (Add c1~14@ b1~12@))) (=> (= temp_1_1~172@ (Mul (Add c1~14@ b1~12@) (Mul d1~16@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~155@ temp_1_1~172@))) (=> (= temp_1_0~155@ temp_1_1~172@) (=> (= temp_2_0~213@ (Add (Mul c2~22@ b2~20@) (Add a2~18@ c2~22@))) (=> (= temp_2_1~230@ (Add (Mul b2~20@ c2~22@) (Add a2~18@ c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~213@ temp_2_1~230@))) (=> (= temp_2_0~213@ temp_2_1~230@) (=> (= temp_3_0~271@ (Mul (Add a3~26@ a3~26@) (Sub b3~28@ c3~30@))) (=> (= temp_3_1~296@ (Sub (Mul (Add a3~26@ a3~26@) b3~28@) (Mul (Add a3~26@ a3~26@) c3~30@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~271@ temp_3_1~296@))) (=> (= temp_3_0~271@ temp_3_1~296@) (=> (= temp_4_0~337@ (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~354@ (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~337@ temp_4_1~354@))) (=> (= temp_4_0~337@ temp_4_1~354@) (=> (= temp_5_0~395@ (Sub (Mul d5~48@ c5~46@) (Mul a5~42@ b5~44@))) (=> (= temp_5_1~412@ (Sub (Mul c5~46@ d5~48@) (Mul a5~42@ b5~44@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~395@ temp_5_1~412@))) (=> (= temp_5_0~395@ temp_5_1~412@) (=> (= temp_6_0~453@ (Mul (Add a6~50@ a6~50@) (Mul a6~50@ c6~54@))) (=> (= temp_6_1~478@ (Add (Mul a6~50@ (Mul a6~50@ c6~54@)) (Mul a6~50@ (Mul a6~50@ c6~54@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~453@ temp_6_1~478@))) (=> (= temp_6_0~453@ temp_6_1~478@) (=> (= temp_7_0~519@ (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ b7~60@))) (=> (= temp_7_1~536@ (Mul (Mul (Mul d7~64@ d7~64@) d7~64@) b7~60@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~519@ temp_7_1~536@))) (=> (= temp_7_0~519@ temp_7_1~536@) (=> (= temp_8_0~577@ (Mul (Mul b8~68@ b8~68@) (Mul b8~68@ a8~66@))) (=> (= temp_8_1~594@ (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ b8~68@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~577@ temp_8_1~594@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
