...
(assert (=> %%query%% (not (=> (= temp_0_0~721@ (Mul (Mul (Mul (Sub (Mul (Add (Add (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@)) b0~4@) (Mul c0~6@ (Sub (Mul b0~4@ b0~4@) b0~4@))) (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@)) (Sub c0~6@ (Mul b0~4@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Sub b0~4@ b0~4@)) (Sub (Mul c0~6@ c0~6@) (Mul a0~2@ a0~2@))))) b0~4@) a0~2@) (Mul (Mul d0~8@ (Sub (Add (Mul (Mul c0~6@ (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ d0~8@) d0~8@)) (Mul (Mul (Mul c0~6@ c0~6@) (Add b0~4@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ d0~8@)))) (Mul (Mul (Mul (Mul a0~2@ c0~6@) b0~4@) (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ c0~6@))) (Sub (Add (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ b0~4@)))))) 20))) (=> (= temp_0_1~978@ (Mul (Mul (Mul (Sub (Mul (Add (Add (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@)) b0~4@) (Mul c0~6@ (Sub (Mul b0~4@ b0~4@) b0~4@))) (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@)) (Sub c0~6@ (Mul b0~4@ b0~4@))) (Sub (Mul (Mul (Mul a0~2@ d0~8@) (Sub b0~4@ b0~4@)) (Mul c0~6@ c0~6@)) (Mul (Mul (Mul a0~2@ d0~8@) (Sub b0~4@ b0~4@)) (Mul a0~2@ a0~2@))))) b0~4@) a0~2@) (Mul (Mul d0~8@ (Sub (Add (Mul (Mul c0~6@ (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ d0~8@) d0~8@)) (Mul (Mul (Mul c0~6@ c0~6@) (Add b0~4@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ d0~8@)))) (Mul (Mul (Mul (Mul a0~2@ c0~6@) b0~4@) (Mul (Mul d0~8@ c0~6@) (Sub c0~6@ c0~6@))) (Sub (Add (Mul c0~6@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ b0~4@)))))) 20))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~721@ temp_0_1~978@))))))))
(assert %%query%%)
(check-sat)
