...
;; mariposa_data/all_2//4350009095442659645/nlqi_verus/src/main.rs:7:1: 26:40 (#0)
(push)
 ...
 (declare-const temp_0_0~181@ Int)
 (declare-const temp_0_1~198@ Int)
 (declare-const temp_1_0~230@ Int)
 (declare-const temp_1_1~247@ Int)
 (declare-const temp_2_0~279@ Int)
 (declare-const temp_2_1~296@ Int)
 (declare-const temp_3_0~328@ Int)
 (declare-const temp_3_1~345@ Int)
 (declare-const temp_4_0~389@ Int)
 (declare-const temp_4_1~438@ Int)
 (declare-const temp_5_0~470@ Int)
 (declare-const temp_5_1~487@ Int)
 (declare-const temp_6_0~519@ Int)
 (declare-const temp_6_1~536@ Int)
 (declare-const temp_7_0~576@ Int)
 (declare-const temp_7_1~601@ Int)
 (declare-const temp_8_0~633@ Int)
 (declare-const temp_8_1~658@ Int)
 (declare-const temp_9_0~690@ Int)
 (declare-const temp_9_1~715@ Int)
 (declare-const temp_10_0~747@ Int)
 (declare-const temp_10_1~764@ Int)
 (declare-const temp_11_0~796@ Int)
 (declare-const temp_11_1~813@ Int)
 (declare-const temp_12_0~845@ Int)
 (declare-const temp_12_1~862@ Int)
 (declare-const temp_13_0~894@ Int)
 (declare-const temp_13_1~911@ Int)
 (declare-const temp_14_0~955@ Int)
 (declare-const temp_14_1~984@ Int)
 (declare-const temp_15_0~1016@ Int)
 (declare-const temp_15_1~1033@ Int)
 (declare-const temp_16_0~1065@ Int)
 (declare-const temp_16_1~1082@ Int)
 (declare-const temp_17_0~1114@ Int)
 (declare-const temp_17_1~1131@ Int)
 (declare-const temp_18_0~1163@ Int)
 (declare-const temp_18_1~1180@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~181@ (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ d0~8@)))
      (=>
       (= temp_0_1~198@ (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ c0~6@)))
       (=>
        (= tmp%1@ (= temp_0_0~181@ temp_0_1~198@))
        (and
         (=>
          %%location_label%%0
          tmp%1@
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~230@ (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ d1~16@)))
           (=>
            (= temp_1_1~247@ (Mul b1~12@ (Mul a1~10@ (Mul b1~12@ d1~16@))))
            (=>
             (= tmp%2@ (= temp_1_0~230@ temp_1_1~247@))
             (and
              (=>
               %%location_label%%1
               tmp%2@
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~279@ (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ c2~22@)))
                (=>
                 (= temp_2_1~296@ (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@)))
                 (=>
                  (= tmp%3@ (= temp_2_0~279@ temp_2_1~296@))
                  (and
                   (=>
                    %%location_label%%2
                    tmp%3@
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~328@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@)))
                     (=>
                      (= temp_3_1~345@ (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@)))
                      (=>
                       (= tmp%4@ (= temp_3_0~328@ temp_3_1~345@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~389@ (Mul (Mul 19 c4~38@) (Sub b4~36@ d4~40@)))
                          (=>
                           (= temp_4_1~438@ (Sub (Mul (Mul 19 c4~38@) b4~36@) (Mul (Mul 19 c4~38@) d4~40@)))
                           (=>
                            (= tmp%5@ (= temp_4_0~389@ temp_4_1~438@))
                            (and
                             (=>
                              %%location_label%%4
                              tmp%5@
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~470@ (Add (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@)))
                               (=>
                                (= temp_5_1~487@ (Add (Mul a5~42@ a5~42@) (Mul c5~46@ d5~48@)))
                                (=>
                                 (= tmp%6@ (= temp_5_0~470@ temp_5_1~487@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~519@ (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@)))
                                    (=>
                                     (= temp_6_1~536@ (Mul a6~50@ (Mul b6~52@ (Mul b6~52@ b6~52@))))
                                     (=>
                                      (= tmp%7@ (= temp_6_0~519@ temp_6_1~536@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~576@ (Add 60 (Mul c7~62@ c7~62@)))
                                         (=>
                                          (= temp_7_1~601@ (Add 60 (Mul c7~62@ c7~62@)))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~576@ temp_7_1~601@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~633@ (Mul (Mul c8~70@ c8~70@) (Add b8~68@ d8~72@)))
                                              (=>
                                               (= temp_8_1~658@ (Add (Mul (Mul c8~70@ c8~70@) b8~68@) (Mul (Mul c8~70@ c8~70@) d8~72@)))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~633@ temp_8_1~658@))
                                                (and
                                                 (=>
                                                  %%location_label%%8
                                                  tmp%9@
                                                 ...
                                                 (=>
                                                  tmp%9@
                                                  (=>
                                                   (= temp_9_0~690@ (Mul (Add d9~80@ b9~76@) (Add b9~76@ c9~78@)))
                                                   (=>
                                                    (= temp_9_1~715@ (Add (Mul (Add d9~80@ b9~76@) b9~76@) (Mul (Add d9~80@ b9~76@) c9~78@)))
                                                    (=>
                                                     (= tmp%10@ (= temp_9_0~690@ temp_9_1~715@))
                                                     (and
                                                      (=>
                                                       %%location_label%%9
                                                       tmp%10@
                                                      ...
                                                      (=>
                                                       tmp%10@
                                                       (=>
                                                        (= temp_10_0~747@ (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ b10~84@)))
                                                        (=>
                                                         (= temp_10_1~764@ (Mul a10~82@ (Mul d10~88@ (Mul a10~82@ b10~84@))))
                                                         (=>
                                                          (= tmp%11@ (= temp_10_0~747@ temp_10_1~764@))
                                                          (and
                                                           (=>
                                                            %%location_label%%10
                                                            tmp%11@
                                                           ...
                                                           (=>
                                                            tmp%11@
                                                            (=>
                                                             (= temp_11_0~796@ (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ c11~94@)))
                                                             (=>
                                                              (= temp_11_1~813@ (Mul a11~90@ (Mul a11~90@ (Mul b11~92@ c11~94@))))
                                                              (=>
                                                               (= tmp%12@ (= temp_11_0~796@ temp_11_1~813@))
                                                               (and
                                                                (=>
                                                                 %%location_label%%11
                                                                 tmp%12@
                                                                ...
                                                                (=>
                                                                 tmp%12@
                                                                 (=>
                                                                  (= temp_12_0~845@ (Sub (Mul d12~104@ c12~102@) (Mul c12~102@ d12~104@)))
                                                                  (=>
                                                                   (= temp_12_1~862@ (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@)))
                                                                   (=>
                                                                    (= tmp%13@ (= temp_12_0~845@ temp_12_1~862@))
                                                                    (and
                                                                     (=>
                                                                      %%location_label%%12
                                                                      tmp%13@
                                                                     ...
                                                                     (=>
                                                                      tmp%13@
                                                                      (=>
                                                                       (= temp_13_0~894@ (Mul (Sub b13~108@ a13~106@) (Mul a13~106@ b13~108@)))
                                                                       (=>
                                                                        (= temp_13_1~911@ (Mul (Sub b13~108@ a13~106@) (Mul b13~108@ a13~106@)))
                                                                        (=>
                                                                         (= tmp%14@ (= temp_13_0~894@ temp_13_1~911@))
                                                                         (and
                                                                          (=>
                                                                           %%location_label%%13
                                                                           tmp%14@
                                                                          ...
                                                                          (=>
                                                                           tmp%14@
                                                                           (=>
                                                                            (= temp_14_0~955@ (Mul (Mul d14~120@ d14~120@) (Mul 63 b14~116@)))
                                                                            (=>
                                                                             (= temp_14_1~984@ (Mul (Mul 63 b14~116@) (Mul d14~120@ d14~120@)))
                                                                             (=>
                                                                              (= tmp%15@ (= temp_14_0~955@ temp_14_1~984@))
                                                                              (and
                                                                               (=>
                                                                                %%location_label%%14
                                                                                tmp%15@
                                                                               ...
                                                                               (=>
                                                                                tmp%15@
                                                                                (=>
                                                                                 (= temp_15_0~1016@ (Add (Add d15~128@ d15~128@) (Mul a15~122@ b15~124@)))
                                                                                 (=>
                                                                                  (= temp_15_1~1033@ (Add (Add d15~128@ d15~128@) (Mul b15~124@ a15~122@)))
                                                                                  (=>
                                                                                   (= tmp%16@ (= temp_15_0~1016@ temp_15_1~1033@))
                                                                                   (and
                                                                                    (=>
                                                                                     %%location_label%%15
                                                                                     tmp%16@
                                                                                    ...
                                                                                    (=>
                                                                                     tmp%16@
                                                                                     (=>
                                                                                      (= temp_16_0~1065@ (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ b16~132@)))
                                                                                      (=>
                                                                                       (= temp_16_1~1082@ (Mul c16~134@ (Mul a16~130@ (Mul c16~134@ b16~132@))))
                                                                                       (=>
                                                                                        (= tmp%17@ (= temp_16_0~1065@ temp_16_1~1082@))
                                                                                        (and
                                                                                         (=>
                                                                                          %%location_label%%16
                                                                                          tmp%17@
                                                                                         ...
                                                                                         (=>
                                                                                          tmp%17@
                                                                                          (=>
                                                                                           (= temp_17_0~1114@ (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ b17~140@)))
                                                                                           (=>
                                                                                            (= temp_17_1~1131@ (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ b17~140@)))
                                                                                            (=>
                                                                                             (= tmp%18@ (= temp_17_0~1114@ temp_17_1~1131@))
                                                                                             (and
                                                                                              (=>
                                                                                               %%location_label%%17
                                                                                               tmp%18@
                                                                                              ...
                                                                                              (=>
                                                                                               tmp%18@
                                                                                               (=>
                                                                                                (= temp_18_0~1163@ (Sub (Mul b18~148@ a18~146@) (Mul d18~152@ d18~152@)))
                                                                                                (=>
                                                                                                 (= temp_18_1~1180@ (Sub (Mul b18~148@ a18~146@) (Mul d18~152@ d18~152@)))
                                                                                                 (=>
                                                                                                  (= tmp%19@ (= temp_18_0~1163@ temp_18_1~1180@))
                                                                                                  (=>
                                                                                                   %%location_label%%18
                                                                                                   tmp%19@
 ))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
