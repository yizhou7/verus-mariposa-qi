...
(assert (=> %%query%% (not (=> (= temp_0_0~177@ (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~194@ (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ c0~6@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~177@ temp_0_1~194@))))))))
(assert %%query%%)
(check-sat)
