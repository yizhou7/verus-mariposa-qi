...
(declare-const temp_1_0~235@ Int)
(declare-const temp_1_1~252@ Int)
(declare-const temp_2_0~293@ Int)
(declare-const temp_2_1~310@ Int)
(declare-const temp_3_0~351@ Int)
(declare-const temp_3_1~368@ Int)
(declare-const temp_4_0~421@ Int)
(declare-const temp_4_1~470@ Int)
(declare-const temp_5_0~511@ Int)
(declare-const temp_5_1~528@ Int)
(declare-const temp_6_0~569@ Int)
(declare-const temp_6_1~586@ Int)
(declare-const temp_7_0~635@ Int)
(declare-const temp_7_1~660@ Int)
(declare-const temp_8_0~701@ Int)
(declare-const temp_8_1~726@ Int)
(declare-const temp_9_0~767@ Int)
(declare-const temp_9_1~792@ Int)
(declare-const temp_10_0~833@ Int)
(declare-const temp_10_1~850@ Int)
(declare-const temp_11_0~891@ Int)
(declare-const temp_11_1~908@ Int)
(declare-const temp_12_0~949@ Int)
(declare-const temp_12_1~966@ Int)
(declare-const temp_13_0~1007@ Int)
(declare-const temp_13_1~1024@ Int)
(declare-const temp_14_0~1077@ Int)
(declare-const temp_14_1~1106@ Int)
(declare-const temp_15_0~1147@ Int)
(declare-const temp_15_1~1164@ Int)
(declare-const temp_16_0~1205@ Int)
(declare-const temp_16_1~1222@ Int)
(declare-const temp_17_0~1263@ Int)
(declare-const temp_17_1~1280@ Int)
(declare-const temp_18_0~1321@ Int)
(declare-const temp_18_1~1338@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~177@ (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~194@ (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~177@ temp_0_1~194@))) (=> (= temp_0_0~177@ temp_0_1~194@) (=> (= temp_1_0~235@ (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ d1~16@))) (=> (= temp_1_1~252@ (Mul b1~12@ (Mul a1~10@ (Mul b1~12@ d1~16@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~235@ temp_1_1~252@))) (=> (= temp_1_0~235@ temp_1_1~252@) (=> (= temp_2_0~293@ (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ c2~22@))) (=> (= temp_2_1~310@ (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~293@ temp_2_1~310@))) (=> (= temp_2_0~293@ temp_2_1~310@) (=> (= temp_3_0~351@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@))) (=> (= temp_3_1~368@ (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~351@ temp_3_1~368@))) (=> (= temp_3_0~351@ temp_3_1~368@) (=> (= temp_4_0~421@ (Mul (Mul 19 c4~38@) (Sub b4~36@ d4~40@))) (=> (= temp_4_1~470@ (Sub (Mul (Mul 19 c4~38@) b4~36@) (Mul (Mul 19 c4~38@) d4~40@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~421@ temp_4_1~470@))) (=> (= temp_4_0~421@ temp_4_1~470@) (=> (= temp_5_0~511@ (Add (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@))) (=> (= temp_5_1~528@ (Add (Mul a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~511@ temp_5_1~528@))) (=> (= temp_5_0~511@ temp_5_1~528@) (=> (= temp_6_0~569@ (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@))) (=> (= temp_6_1~586@ (Mul a6~50@ (Mul b6~52@ (Mul b6~52@ b6~52@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~569@ temp_6_1~586@))) (=> (= temp_6_0~569@ temp_6_1~586@) (=> (= temp_7_0~635@ (Add 60 (Mul c7~62@ c7~62@))) (=> (= temp_7_1~660@ (Add 60 (Mul c7~62@ c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~635@ temp_7_1~660@))) (=> (= temp_7_0~635@ temp_7_1~660@) (=> (= temp_8_0~701@ (Mul (Mul c8~70@ c8~70@) (Add b8~68@ d8~72@))) (=> (= temp_8_1~726@ (Add (Mul (Mul c8~70@ c8~70@) b8~68@) (Mul (Mul c8~70@ c8~70@) d8~72@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~701@ temp_8_1~726@))) (=> (= temp_8_0~701@ temp_8_1~726@) (=> (= temp_9_0~767@ (Mul (Add d9~80@ b9~76@) (Add b9~76@ c9~78@))) (=> (= temp_9_1~792@ (Add (Mul (Add d9~80@ b9~76@) b9~76@) (Mul (Add d9~80@ b9~76@) c9~78@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~767@ temp_9_1~792@))) (=> (= temp_9_0~767@ temp_9_1~792@) (=> (= temp_10_0~833@ (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ b10~84@))) (=> (= temp_10_1~850@ (Mul a10~82@ (Mul d10~88@ (Mul a10~82@ b10~84@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~833@ temp_10_1~850@))) (=> (= temp_10_0~833@ temp_10_1~850@) (=> (= temp_11_0~891@ (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ c11~94@))) (=> (= temp_11_1~908@ (Mul a11~90@ (Mul a11~90@ (Mul b11~92@ c11~94@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~891@ temp_11_1~908@))) (=> (= temp_11_0~891@ temp_11_1~908@) (=> (= temp_12_0~949@ (Sub (Mul d12~104@ c12~102@) (Mul c12~102@ d12~104@))) (=> (= temp_12_1~966@ (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~949@ temp_12_1~966@))) (=> (= temp_12_0~949@ temp_12_1~966@) (=> (= temp_13_0~1007@ (Mul (Sub b13~108@ a13~106@) (Mul a13~106@ b13~108@))) (=> (= temp_13_1~1024@ (Mul (Sub b13~108@ a13~106@) (Mul b13~108@ a13~106@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~1007@ temp_13_1~1024@))) (=> (= temp_13_0~1007@ temp_13_1~1024@) (=> (= temp_14_0~1077@ (Mul (Mul d14~120@ d14~120@) (Mul 63 b14~116@))) (=> (= temp_14_1~1106@ (Mul (Mul 63 b14~116@) (Mul d14~120@ d14~120@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~1077@ temp_14_1~1106@))) (=> (= temp_14_0~1077@ temp_14_1~1106@) (=> (= temp_15_0~1147@ (Add (Add d15~128@ d15~128@) (Mul a15~122@ b15~124@))) (=> (= temp_15_1~1164@ (Add (Add d15~128@ d15~128@) (Mul b15~124@ a15~122@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~1147@ temp_15_1~1164@))) (=> (= temp_15_0~1147@ temp_15_1~1164@) (=> (= temp_16_0~1205@ (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ b16~132@))) (=> (= temp_16_1~1222@ (Mul c16~134@ (Mul a16~130@ (Mul c16~134@ b16~132@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~1205@ temp_16_1~1222@))) (=> (= temp_16_0~1205@ temp_16_1~1222@) (=> (= temp_17_0~1263@ (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ b17~140@))) (=> (= temp_17_1~1280@ (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ b17~140@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~1263@ temp_17_1~1280@))) (=> (= temp_17_0~1263@ temp_17_1~1280@) (=> (= temp_18_0~1321@ (Sub (Mul b18~148@ a18~146@) (Mul d18~152@ d18~152@))) (=> (= temp_18_1~1338@ (Sub (Mul b18~148@ a18~146@) (Mul d18~152@ d18~152@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~1321@ temp_18_1~1338@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
