...
(declare-const temp_4_0~385@ Int)
(declare-const temp_4_1~434@ Int)
(declare-const temp_5_0~466@ Int)
(declare-const temp_5_1~483@ Int)
(declare-const temp_6_0~515@ Int)
(declare-const temp_6_1~532@ Int)
(declare-const temp_7_0~572@ Int)
(declare-const temp_7_1~597@ Int)
(declare-const temp_8_0~629@ Int)
(declare-const temp_8_1~654@ Int)
(declare-const temp_9_0~686@ Int)
(declare-const temp_9_1~711@ Int)
(declare-const temp_10_0~743@ Int)
(declare-const temp_10_1~760@ Int)
(declare-const temp_11_0~792@ Int)
(declare-const temp_11_1~809@ Int)
(declare-const temp_12_0~841@ Int)
(declare-const temp_12_1~858@ Int)
(declare-const temp_13_0~890@ Int)
(declare-const temp_13_1~907@ Int)
(declare-const temp_14_0~951@ Int)
(declare-const temp_14_1~980@ Int)
(declare-const temp_15_0~1012@ Int)
(declare-const temp_15_1~1029@ Int)
(declare-const temp_16_0~1061@ Int)
(declare-const temp_16_1~1078@ Int)
(declare-const temp_17_0~1110@ Int)
(declare-const temp_17_1~1127@ Int)
(declare-const temp_18_0~1159@ Int)
(declare-const temp_18_1~1176@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~177@ (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~194@ (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ c0~6@))) (=> (= tmp%1@ (= temp_0_0~177@ temp_0_1~194@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~226@ (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ d1~16@))) (=> (= temp_1_1~243@ (Mul b1~12@ (Mul a1~10@ (Mul b1~12@ d1~16@)))) (=> (= tmp%2@ (= temp_1_0~226@ temp_1_1~243@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~275@ (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ c2~22@))) (=> (= temp_2_1~292@ (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@))) (=> (= tmp%3@ (= temp_2_0~275@ temp_2_1~292@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~324@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@))) (=> (= temp_3_1~341@ (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@))) (=> (= tmp%4@ (= temp_3_0~324@ temp_3_1~341@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~385@ (Mul (Mul 19 c4~38@) (Sub b4~36@ d4~40@))) (=> (= temp_4_1~434@ (Sub (Mul (Mul 19 c4~38@) b4~36@) (Mul (Mul 19 c4~38@) d4~40@))) (=> (= tmp%5@ (= temp_4_0~385@ temp_4_1~434@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~466@ (Add (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@))) (=> (= temp_5_1~483@ (Add (Mul a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (=> (= tmp%6@ (= temp_5_0~466@ temp_5_1~483@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~515@ (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@))) (=> (= temp_6_1~532@ (Mul a6~50@ (Mul b6~52@ (Mul b6~52@ b6~52@)))) (=> (= tmp%7@ (= temp_6_0~515@ temp_6_1~532@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~572@ (Add 60 (Mul c7~62@ c7~62@))) (=> (= temp_7_1~597@ (Add 60 (Mul c7~62@ c7~62@))) (=> (= tmp%8@ (= temp_7_0~572@ temp_7_1~597@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~629@ (Mul (Mul c8~70@ c8~70@) (Add b8~68@ d8~72@))) (=> (= temp_8_1~654@ (Add (Mul (Mul c8~70@ c8~70@) b8~68@) (Mul (Mul c8~70@ c8~70@) d8~72@))) (=> (= tmp%9@ (= temp_8_0~629@ temp_8_1~654@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~686@ (Mul (Add d9~80@ b9~76@) (Add b9~76@ c9~78@))) (=> (= temp_9_1~711@ (Add (Mul (Add d9~80@ b9~76@) b9~76@) (Mul (Add d9~80@ b9~76@) c9~78@))) (=> (= tmp%10@ (= temp_9_0~686@ temp_9_1~711@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~743@ (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ b10~84@))) (=> (= temp_10_1~760@ (Mul a10~82@ (Mul d10~88@ (Mul a10~82@ b10~84@)))) (=> (= tmp%11@ (= temp_10_0~743@ temp_10_1~760@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~792@ (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ c11~94@))) (=> (= temp_11_1~809@ (Mul a11~90@ (Mul a11~90@ (Mul b11~92@ c11~94@)))) (=> (= tmp%12@ (= temp_11_0~792@ temp_11_1~809@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~841@ (Sub (Mul d12~104@ c12~102@) (Mul c12~102@ d12~104@))) (=> (= temp_12_1~858@ (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@))) (=> (= tmp%13@ (= temp_12_0~841@ temp_12_1~858@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~890@ (Mul (Sub b13~108@ a13~106@) (Mul a13~106@ b13~108@))) (=> (= temp_13_1~907@ (Mul (Sub b13~108@ a13~106@) (Mul b13~108@ a13~106@))) (=> (= tmp%14@ (= temp_13_0~890@ temp_13_1~907@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~951@ (Mul (Mul d14~120@ d14~120@) (Mul 63 b14~116@))) (=> (= temp_14_1~980@ (Mul (Mul 63 b14~116@) (Mul d14~120@ d14~120@))) (=> (= tmp%15@ (= temp_14_0~951@ temp_14_1~980@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~1012@ (Add (Add d15~128@ d15~128@) (Mul a15~122@ b15~124@))) (=> (= temp_15_1~1029@ (Add (Add d15~128@ d15~128@) (Mul b15~124@ a15~122@))) (=> (= tmp%16@ (= temp_15_0~1012@ temp_15_1~1029@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~1061@ (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ b16~132@))) (=> (= temp_16_1~1078@ (Mul c16~134@ (Mul a16~130@ (Mul c16~134@ b16~132@)))) (=> (= tmp%17@ (= temp_16_0~1061@ temp_16_1~1078@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~1110@ (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ b17~140@))) (=> (= temp_17_1~1127@ (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ b17~140@))) (=> (= tmp%18@ (= temp_17_0~1110@ temp_17_1~1127@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~1159@ (Sub (Mul b18~148@ a18~146@) (Mul d18~152@ d18~152@))) (=> (= temp_18_1~1176@ (Sub (Mul b18~148@ a18~146@) (Mul d18~152@ d18~152@))) (=> (= tmp%19@ (= temp_18_0~1159@ temp_18_1~1176@)) (=> %%location_label%%18 tmp%19@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
