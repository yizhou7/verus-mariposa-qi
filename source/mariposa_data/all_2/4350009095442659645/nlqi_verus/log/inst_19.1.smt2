...
(set-info :comment ";; mariposa_data/all_2//4350009095442659645/nlqi_verus/src/main.rs:7:1: 26:40 (#0)")
(push 1)
...
(declare-const temp_1_1~264@ Int)
(declare-const temp_2_0~315@ Int)
(declare-const temp_2_1~332@ Int)
(declare-const temp_3_0~377@ Int)
(declare-const temp_3_1~394@ Int)
(declare-const temp_4_0~451@ Int)
(declare-const temp_4_1~500@ Int)
(declare-const temp_5_0~563@ Int)
(declare-const temp_5_1~580@ Int)
(declare-const temp_6_0~625@ Int)
(declare-const temp_6_1~642@ Int)
(declare-const temp_7_0~701@ Int)
(declare-const temp_7_1~726@ Int)
(declare-const temp_8_0~771@ Int)
(declare-const temp_8_1~796@ Int)
(declare-const temp_9_0~847@ Int)
(declare-const temp_9_1~872@ Int)
(declare-const temp_10_0~923@ Int)
(declare-const temp_10_1~940@ Int)
(declare-const temp_11_0~991@ Int)
(declare-const temp_11_1~1008@ Int)
(declare-const temp_12_0~1059@ Int)
(declare-const temp_12_1~1076@ Int)
(declare-const temp_13_0~1121@ Int)
(declare-const temp_13_1~1138@ Int)
(declare-const temp_14_0~1195@ Int)
(declare-const temp_14_1~1224@ Int)
(declare-const temp_15_0~1289@ Int)
(declare-const temp_15_1~1306@ Int)
(declare-const temp_16_0~1351@ Int)
(declare-const temp_16_1~1368@ Int)
(declare-const temp_17_0~1419@ Int)
(declare-const temp_17_1~1436@ Int)
(declare-const temp_18_0~1481@ Int)
(declare-const temp_18_1~1498@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~177@ (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ d0~8@))) (=> (= temp_0_1~194@ (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ c0~6@))) (and (=> (= tmp%1@ (Mul a0~2@ c0~6@)) (=> (= tmp%2@ (Mul d0~8@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~177@ temp_0_1~194@))))) (=> (= temp_0_0~177@ temp_0_1~194@) (=> (= temp_1_0~247@ (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ d1~16@))) (=> (= temp_1_1~264@ (Mul b1~12@ (Mul a1~10@ (Mul b1~12@ d1~16@)))) (and (=> (= tmp%3@ (Mul b1~12@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b1~12@ a1~10@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~247@ temp_1_1~264@)))) (=> (= temp_1_0~247@ temp_1_1~264@) (=> (= temp_2_0~315@ (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ c2~22@))) (=> (= temp_2_1~332@ (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ d2~24@) (=> %%location_label%%2 (= temp_2_0~315@ temp_2_1~332@))) (=> (= temp_2_0~315@ temp_2_1~332@) (=> (= temp_3_0~377@ (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@))) (=> (= temp_3_1~394@ (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ b3~28@) (=> %%location_label%%3 (= temp_3_0~377@ temp_3_1~394@))) (=> (= temp_3_0~377@ temp_3_1~394@) (=> (= temp_4_0~451@ (Mul (Mul 19 c4~38@) (Sub b4~36@ d4~40@))) (=> (= temp_4_1~500@ (Sub (Mul (Mul 19 c4~38@) b4~36@) (Mul (Mul 19 c4~38@) d4~40@))) (and (=> (= tmp%4@ (Mul 19 c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ b4~36@ d4~40@) (=> %%location_label%%4 (= temp_4_0~451@ temp_4_1~500@)))) (=> (= temp_4_0~451@ temp_4_1~500@) (=> (= temp_5_0~563@ (Add (Mul a5~42@ a5~42@) (Mul d5~48@ c5~46@))) (=> (= temp_5_1~580@ (Add (Mul a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ c5~46@) (=> %%location_label%%5 (= temp_5_0~563@ temp_5_1~580@))) (=> (= temp_5_0~563@ temp_5_1~580@) (=> (= temp_6_0~625@ (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@))) (=> (= temp_6_1~642@ (Mul a6~50@ (Mul b6~52@ (Mul b6~52@ b6~52@)))) (and (=> (= tmp%5@ (Mul b6~52@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a6~50@ b6~52@ tmp%5@) (=> %%location_label%%6 (= temp_6_0~625@ temp_6_1~642@)))) (=> (= temp_6_0~625@ temp_6_1~642@) (=> (= temp_7_0~701@ (Add 60 (Mul c7~62@ c7~62@))) (=> (= temp_7_1~726@ (Add 60 (Mul c7~62@ c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ c7~62@) (=> %%location_label%%7 (= temp_7_0~701@ temp_7_1~726@))) (=> (= temp_7_0~701@ temp_7_1~726@) (=> (= temp_8_0~771@ (Mul (Mul c8~70@ c8~70@) (Add b8~68@ d8~72@))) (=> (= temp_8_1~796@ (Add (Mul (Mul c8~70@ c8~70@) b8~68@) (Mul (Mul c8~70@ c8~70@) d8~72@))) (and (=> (= tmp%6@ (Mul c8~70@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%6@ b8~68@ d8~72@) (=> %%location_label%%8 (= temp_8_0~771@ temp_8_1~796@)))) (=> (= temp_8_0~771@ temp_8_1~796@) (=> (= temp_9_0~847@ (Mul (Add d9~80@ b9~76@) (Add b9~76@ c9~78@))) (=> (= temp_9_1~872@ (Add (Mul (Add d9~80@ b9~76@) b9~76@) (Mul (Add d9~80@ b9~76@) c9~78@))) (and (=> (= tmp%7@ (Add d9~80@ b9~76@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%7@ b9~76@ c9~78@) (=> %%location_label%%9 (= temp_9_0~847@ temp_9_1~872@)))) (=> (= temp_9_0~847@ temp_9_1~872@) (=> (= temp_10_0~923@ (Mul (Mul a10~82@ d10~88@) (Mul a10~82@ b10~84@))) (=> (= temp_10_1~940@ (Mul a10~82@ (Mul d10~88@ (Mul a10~82@ b10~84@)))) (and (=> (= tmp%8@ (Mul a10~82@ b10~84@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a10~82@ d10~88@ tmp%8@) (=> %%location_label%%10 (= temp_10_0~923@ temp_10_1~940@)))) (=> (= temp_10_0~923@ temp_10_1~940@) (=> (= temp_11_0~991@ (Mul (Mul a11~90@ a11~90@) (Mul b11~92@ c11~94@))) (=> (= temp_11_1~1008@ (Mul a11~90@ (Mul a11~90@ (Mul b11~92@ c11~94@)))) (and (=> (= tmp%9@ (Mul b11~92@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a11~90@ a11~90@ tmp%9@) (=> %%location_label%%11 (= temp_11_0~991@ temp_11_1~1008@)))) (=> (= temp_11_0~991@ temp_11_1~1008@) (=> (= temp_12_0~1059@ (Sub (Mul d12~104@ c12~102@) (Mul c12~102@ d12~104@))) (=> (= temp_12_1~1076@ (Sub (Mul c12~102@ d12~104@) (Mul c12~102@ d12~104@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d12~104@ c12~102@) (=> %%location_label%%12 (= temp_12_0~1059@ temp_12_1~1076@))) (=> (= temp_12_0~1059@ temp_12_1~1076@) (=> (= temp_13_0~1121@ (Mul (Sub b13~108@ a13~106@) (Mul a13~106@ b13~108@))) (=> (= temp_13_1~1138@ (Mul (Sub b13~108@ a13~106@) (Mul b13~108@ a13~106@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a13~106@ b13~108@) (=> %%location_label%%13 (= temp_13_0~1121@ temp_13_1~1138@))) (=> (= temp_13_0~1121@ temp_13_1~1138@) (=> (= temp_14_0~1195@ (Mul (Mul d14~120@ d14~120@) (Mul 63 b14~116@))) (=> (= temp_14_1~1224@ (Mul (Mul 63 b14~116@) (Mul d14~120@ d14~120@))) (and (=> (= tmp%10@ (Mul d14~120@ d14~120@)) (=> (= tmp%11@ (Mul 63 b14~116@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%14 (= temp_14_0~1195@ temp_14_1~1224@))))) (=> (= temp_14_0~1195@ temp_14_1~1224@) (=> (= temp_15_0~1289@ (Add (Add d15~128@ d15~128@) (Mul a15~122@ b15~124@))) (=> (= temp_15_1~1306@ (Add (Add d15~128@ d15~128@) (Mul b15~124@ a15~122@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a15~122@ b15~124@) (=> %%location_label%%15 (= temp_15_0~1289@ temp_15_1~1306@))) (=> (= temp_15_0~1289@ temp_15_1~1306@) (=> (= temp_16_0~1351@ (Mul (Mul c16~134@ a16~130@) (Mul c16~134@ b16~132@))) (=> (= temp_16_1~1368@ (Mul c16~134@ (Mul a16~130@ (Mul c16~134@ b16~132@)))) (and (=> (= tmp%12@ (Mul c16~134@ b16~132@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c16~134@ a16~130@ tmp%12@) (=> %%location_label%%16 (= temp_16_0~1351@ temp_16_1~1368@)))) (=> (= temp_16_0~1351@ temp_16_1~1368@) (=> (= temp_17_0~1419@ (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ b17~140@))) (=> (= temp_17_1~1436@ (Mul (Mul a17~138@ a17~138@) (Mul a17~138@ b17~140@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a17~138@ a17~138@) (=> %%location_label%%17 (= temp_17_0~1419@ temp_17_1~1436@))) (=> (= temp_17_0~1419@ temp_17_1~1436@) (=> (= temp_18_0~1481@ (Sub (Mul b18~148@ a18~146@) (Mul d18~152@ d18~152@))) (=> (= temp_18_1~1498@ (Sub (Mul b18~148@ a18~146@) (Mul d18~152@ d18~152@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d18~152@ d18~152@) (=> %%location_label%%18 (= temp_18_0~1481@ temp_18_1~1498@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
