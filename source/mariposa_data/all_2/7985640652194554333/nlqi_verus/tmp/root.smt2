...
;; mariposa_data/all_2//7985640652194554333/nlqi_verus/src/main.rs:7:1: 26:40 (#0)
(push)
 ...
 (declare-const temp_4_0~377@ Int)
 (declare-const temp_4_1~394@ Int)
 (declare-const temp_5_0~426@ Int)
 (declare-const temp_5_1~443@ Int)
 (declare-const temp_6_0~487@ Int)
 (declare-const temp_6_1~516@ Int)
 (declare-const temp_7_0~548@ Int)
 (declare-const temp_7_1~565@ Int)
 (declare-const temp_8_0~609@ Int)
 (declare-const temp_8_1~638@ Int)
 (declare-const temp_9_0~670@ Int)
 (declare-const temp_9_1~687@ Int)
 (declare-const temp_10_0~719@ Int)
 (declare-const temp_10_1~736@ Int)
 (declare-const temp_11_0~768@ Int)
 (declare-const temp_11_1~785@ Int)
 (declare-const temp_12_0~817@ Int)
 (declare-const temp_12_1~834@ Int)
 (declare-const temp_13_0~866@ Int)
 (declare-const temp_13_1~883@ Int)
 (declare-const temp_14_0~915@ Int)
 (declare-const temp_14_1~932@ Int)
 (declare-const temp_15_0~964@ Int)
 (declare-const temp_15_1~977@ Int)
 (declare-const temp_16_0~1009@ Int)
 (declare-const temp_16_1~1026@ Int)
 (declare-const temp_17_0~1054@ Int)
 (declare-const temp_17_1~1067@ Int)
 (declare-const temp_18_0~1095@ Int)
 (declare-const temp_18_1~1108@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~181@ (Add (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@)))
      (=>
       (= temp_0_1~198@ (Add (Mul d0~8@ c0~6@) (Mul b0~4@ a0~2@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~230@ (Mul (Mul c1~14@ d1~16@) (Add d1~16@ a1~10@)))
           (=>
            (= temp_1_1~247@ (Mul (Mul d1~16@ c1~14@) (Add d1~16@ a1~10@)))
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~279@ (Mul (Mul b2~20@ a2~18@) (Sub a2~18@ a2~18@)))
                (=>
                 (= temp_2_1~296@ (Mul (Mul a2~18@ b2~20@) (Sub a2~18@ a2~18@)))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~328@ (Add (Mul a3~26@ c3~30@) (Mul c3~30@ d3~32@)))
                     (=>
                      (= temp_3_1~345@ (Add (Mul c3~30@ a3~26@) (Mul c3~30@ d3~32@)))
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~377@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ a4~34@)))
                          (=>
                           (= temp_4_1~394@ (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ a4~34@)))
                           (=>
                            (= tmp%5@ (= temp_4_0~377@ temp_4_1~394@))
                            (and
                             (=>
                              %%location_label%%4
                              tmp%5@
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~426@ (Sub (Mul a5~42@ c5~46@) (Mul d5~48@ c5~46@)))
                               (=>
                                (= temp_5_1~443@ (Sub (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@)))
                                (=>
                                 (= tmp%6@ (= temp_5_0~426@ temp_5_1~443@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~487@ (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ 99)))
                                    (=>
                                     (= temp_6_1~516@ (Mul (Mul d6~56@ 99) (Mul b6~52@ c6~54@)))
                                     (=>
                                      (= tmp%7@ (= temp_6_0~487@ temp_6_1~516@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~548@ (Add (Mul c7~62@ a7~58@) (Mul b7~60@ c7~62@)))
                                         (=>
                                          (= temp_7_1~565@ (Add (Mul c7~62@ a7~58@) (Mul c7~62@ b7~60@)))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~548@ temp_7_1~565@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~609@ (Mul (Mul 50 d8~72@) (Mul a8~66@ d8~72@)))
                                              (=>
                                               (= temp_8_1~638@ (Mul (Mul d8~72@ 50) (Mul a8~66@ d8~72@)))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~609@ temp_8_1~638@))
                                                (and
                                                 (=>
                                                  %%location_label%%8
                                                  tmp%9@
                                                 ...
                                                 (=>
                                                  tmp%9@
                                                  (=>
                                                   (= temp_9_0~670@ (Mul (Mul d9~80@ c9~78@) (Sub b9~76@ c9~78@)))
                                                   (=>
                                                    (= temp_9_1~687@ (Mul d9~80@ (Mul c9~78@ (Sub b9~76@ c9~78@))))
                                                    (=>
                                                     (= tmp%10@ (= temp_9_0~670@ temp_9_1~687@))
                                                     (and
                                                      (=>
                                                       %%location_label%%9
                                                       tmp%10@
                                                      ...
                                                      (=>
                                                       tmp%10@
                                                       (=>
                                                        (= temp_10_0~719@ (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ c10~86@)))
                                                        (=>
                                                         (= temp_10_1~736@ (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@)))
                                                         (=>
                                                          (= tmp%11@ (= temp_10_0~719@ temp_10_1~736@))
                                                          (and
                                                           (=>
                                                            %%location_label%%10
                                                            tmp%11@
                                                           ...
                                                           (=>
                                                            tmp%11@
                                                            (=>
                                                             (= temp_11_0~768@ (Mul (Mul d11~96@ d11~96@) (Sub a11~90@ c11~94@)))
                                                             (=>
                                                              (= temp_11_1~785@ (Mul (Sub a11~90@ c11~94@) (Mul d11~96@ d11~96@)))
                                                              (=>
                                                               (= tmp%12@ (= temp_11_0~768@ temp_11_1~785@))
                                                               (and
                                                                (=>
                                                                 %%location_label%%11
                                                                 tmp%12@
                                                                ...
                                                                (=>
                                                                 tmp%12@
                                                                 (=>
                                                                  (= temp_12_0~817@ (Add (Mul c12~102@ b12~100@) (Add d12~104@ a12~98@)))
                                                                  (=>
                                                                   (= temp_12_1~834@ (Add (Mul b12~100@ c12~102@) (Add d12~104@ a12~98@)))
                                                                   (=>
                                                                    (= tmp%13@ (= temp_12_0~817@ temp_12_1~834@))
                                                                    (and
                                                                     (=>
                                                                      %%location_label%%12
                                                                      tmp%13@
                                                                     ...
                                                                     (=>
                                                                      tmp%13@
                                                                      (=>
                                                                       (= temp_13_0~866@ (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ d13~112@)))
                                                                       (=>
                                                                        (= temp_13_1~883@ (Mul (Mul (Mul a13~106@ b13~108@) a13~106@) d13~112@))
                                                                        (=>
                                                                         (= tmp%14@ (= temp_13_0~866@ temp_13_1~883@))
                                                                         (and
                                                                          (=>
                                                                           %%location_label%%13
                                                                           tmp%14@
                                                                          ...
                                                                          (=>
                                                                           tmp%14@
                                                                           (=>
                                                                            (= temp_14_0~915@ (Mul (Mul b14~116@ d14~120@) (Mul c14~118@ b14~116@)))
                                                                            (=>
                                                                             (= temp_14_1~932@ (Mul (Mul (Mul b14~116@ d14~120@) c14~118@) b14~116@))
                                                                             (=>
                                                                              (= tmp%15@ (= temp_14_0~915@ temp_14_1~932@))
                                                                              (and
                                                                               (=>
                                                                                %%location_label%%14
                                                                                tmp%15@
                                                                               ...
                                                                               (=>
                                                                                tmp%15@
                                                                                (=>
                                                                                 (= temp_15_0~964@ (Add (Mul d15~128@ b15~124@) (Mul d15~128@ a15~122@)))
                                                                                 (=>
                                                                                  (= temp_15_1~977@ (Mul d15~128@ (Add b15~124@ a15~122@)))
                                                                                  (=>
                                                                                   (= tmp%16@ (= temp_15_0~964@ temp_15_1~977@))
                                                                                   (and
                                                                                    (=>
                                                                                     %%location_label%%15
                                                                                     tmp%16@
                                                                                    ...
                                                                                    (=>
                                                                                     tmp%16@
                                                                                     (=>
                                                                                      (= temp_16_0~1009@ (Mul (Mul a16~130@ b16~132@) (Mul b16~132@ a16~130@)))
                                                                                      (=>
                                                                                       (= temp_16_1~1026@ (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ b16~132@)))
                                                                                       (=>
                                                                                        (= tmp%17@ (= temp_16_0~1009@ temp_16_1~1026@))
                                                                                        (and
                                                                                         (=>
                                                                                          %%location_label%%16
                                                                                          tmp%17@
                                                                                         ...
                                                                                         (=>
                                                                                          tmp%17@
                                                                                          (=>
                                                                                           (= temp_17_0~1054@ (Mul (Mul c17~142@ c17~142@) a17~138@))
                                                                                           (=>
                                                                                            (= temp_17_1~1067@ (Mul a17~138@ (Mul c17~142@ c17~142@)))
                                                                                            (=>
                                                                                             (= tmp%18@ (= temp_17_0~1054@ temp_17_1~1067@))
                                                                                             (and
                                                                                              (=>
                                                                                               %%location_label%%17
                                                                                               tmp%18@
                                                                                              ...
                                                                                              (=>
                                                                                               tmp%18@
                                                                                               (=>
                                                                                                (= temp_18_0~1095@ (Mul a18~146@ (Add d18~152@ d18~152@)))
                                                                                                (=>
                                                                                                 (= temp_18_1~1108@ (Mul (Add d18~152@ d18~152@) a18~146@))
                                                                                                 (=>
                                                                                                  (= tmp%19@ (= temp_18_0~1095@ temp_18_1~1108@))
                                                                                                  (=>
                                                                                                   %%location_label%%18
                                                                                                   tmp%19@
 ))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
