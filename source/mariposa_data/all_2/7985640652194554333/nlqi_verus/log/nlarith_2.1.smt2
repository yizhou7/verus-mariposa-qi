...
(assert (=> %%query%% (not (=> (= temp_0_0~177@ (Add (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))) (=> (= temp_0_1~194@ (Add (Mul d0~8@ c0~6@) (Mul b0~4@ a0~2@))) (=> (= tmp%1@ (= temp_0_0~177@ temp_0_1~194@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~226@ (Mul (Mul c1~14@ d1~16@) (Add d1~16@ a1~10@))) (=> (= temp_1_1~243@ (Mul (Mul d1~16@ c1~14@) (Add d1~16@ a1~10@))) (=> (= tmp%2@ (= temp_1_0~226@ temp_1_1~243@)) (=> %%location_label%%1 tmp%2@))))))))))))
(assert %%query%%)
(check-sat)
