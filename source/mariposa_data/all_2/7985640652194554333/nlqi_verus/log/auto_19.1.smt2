...
(declare-const temp_4_0~409@ Int)
(declare-const temp_4_1~426@ Int)
(declare-const temp_5_0~467@ Int)
(declare-const temp_5_1~484@ Int)
(declare-const temp_6_0~537@ Int)
(declare-const temp_6_1~566@ Int)
(declare-const temp_7_0~607@ Int)
(declare-const temp_7_1~624@ Int)
(declare-const temp_8_0~677@ Int)
(declare-const temp_8_1~706@ Int)
(declare-const temp_9_0~747@ Int)
(declare-const temp_9_1~764@ Int)
(declare-const temp_10_0~805@ Int)
(declare-const temp_10_1~822@ Int)
(declare-const temp_11_0~863@ Int)
(declare-const temp_11_1~880@ Int)
(declare-const temp_12_0~921@ Int)
(declare-const temp_12_1~938@ Int)
(declare-const temp_13_0~979@ Int)
(declare-const temp_13_1~996@ Int)
(declare-const temp_14_0~1037@ Int)
(declare-const temp_14_1~1054@ Int)
(declare-const temp_15_0~1095@ Int)
(declare-const temp_15_1~1108@ Int)
(declare-const temp_16_0~1149@ Int)
(declare-const temp_16_1~1166@ Int)
(declare-const temp_17_0~1203@ Int)
(declare-const temp_17_1~1216@ Int)
(declare-const temp_18_0~1253@ Int)
(declare-const temp_18_1~1266@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~177@ (Add (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))) (=> (= temp_0_1~194@ (Add (Mul d0~8@ c0~6@) (Mul b0~4@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~177@ temp_0_1~194@))) (=> (= temp_0_0~177@ temp_0_1~194@) (=> (= temp_1_0~235@ (Mul (Mul c1~14@ d1~16@) (Add d1~16@ a1~10@))) (=> (= temp_1_1~252@ (Mul (Mul d1~16@ c1~14@) (Add d1~16@ a1~10@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~235@ temp_1_1~252@))) (=> (= temp_1_0~235@ temp_1_1~252@) (=> (= temp_2_0~293@ (Mul (Mul b2~20@ a2~18@) (Sub a2~18@ a2~18@))) (=> (= temp_2_1~310@ (Mul (Mul a2~18@ b2~20@) (Sub a2~18@ a2~18@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~293@ temp_2_1~310@))) (=> (= temp_2_0~293@ temp_2_1~310@) (=> (= temp_3_0~351@ (Add (Mul a3~26@ c3~30@) (Mul c3~30@ d3~32@))) (=> (= temp_3_1~368@ (Add (Mul c3~30@ a3~26@) (Mul c3~30@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~351@ temp_3_1~368@))) (=> (= temp_3_0~351@ temp_3_1~368@) (=> (= temp_4_0~409@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ a4~34@))) (=> (= temp_4_1~426@ (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ a4~34@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~409@ temp_4_1~426@))) (=> (= temp_4_0~409@ temp_4_1~426@) (=> (= temp_5_0~467@ (Sub (Mul a5~42@ c5~46@) (Mul d5~48@ c5~46@))) (=> (= temp_5_1~484@ (Sub (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~467@ temp_5_1~484@))) (=> (= temp_5_0~467@ temp_5_1~484@) (=> (= temp_6_0~537@ (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ 99))) (=> (= temp_6_1~566@ (Mul (Mul d6~56@ 99) (Mul b6~52@ c6~54@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~537@ temp_6_1~566@))) (=> (= temp_6_0~537@ temp_6_1~566@) (=> (= temp_7_0~607@ (Add (Mul c7~62@ a7~58@) (Mul b7~60@ c7~62@))) (=> (= temp_7_1~624@ (Add (Mul c7~62@ a7~58@) (Mul c7~62@ b7~60@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~607@ temp_7_1~624@))) (=> (= temp_7_0~607@ temp_7_1~624@) (=> (= temp_8_0~677@ (Mul (Mul 50 d8~72@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~706@ (Mul (Mul d8~72@ 50) (Mul a8~66@ d8~72@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~677@ temp_8_1~706@))) (=> (= temp_8_0~677@ temp_8_1~706@) (=> (= temp_9_0~747@ (Mul (Mul d9~80@ c9~78@) (Sub b9~76@ c9~78@))) (=> (= temp_9_1~764@ (Mul d9~80@ (Mul c9~78@ (Sub b9~76@ c9~78@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~747@ temp_9_1~764@))) (=> (= temp_9_0~747@ temp_9_1~764@) (=> (= temp_10_0~805@ (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ c10~86@))) (=> (= temp_10_1~822@ (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~805@ temp_10_1~822@))) (=> (= temp_10_0~805@ temp_10_1~822@) (=> (= temp_11_0~863@ (Mul (Mul d11~96@ d11~96@) (Sub a11~90@ c11~94@))) (=> (= temp_11_1~880@ (Mul (Sub a11~90@ c11~94@) (Mul d11~96@ d11~96@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~863@ temp_11_1~880@))) (=> (= temp_11_0~863@ temp_11_1~880@) (=> (= temp_12_0~921@ (Add (Mul c12~102@ b12~100@) (Add d12~104@ a12~98@))) (=> (= temp_12_1~938@ (Add (Mul b12~100@ c12~102@) (Add d12~104@ a12~98@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~921@ temp_12_1~938@))) (=> (= temp_12_0~921@ temp_12_1~938@) (=> (= temp_13_0~979@ (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ d13~112@))) (=> (= temp_13_1~996@ (Mul (Mul (Mul a13~106@ b13~108@) a13~106@) d13~112@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~979@ temp_13_1~996@))) (=> (= temp_13_0~979@ temp_13_1~996@) (=> (= temp_14_0~1037@ (Mul (Mul b14~116@ d14~120@) (Mul c14~118@ b14~116@))) (=> (= temp_14_1~1054@ (Mul (Mul (Mul b14~116@ d14~120@) c14~118@) b14~116@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~1037@ temp_14_1~1054@))) (=> (= temp_14_0~1037@ temp_14_1~1054@) (=> (= temp_15_0~1095@ (Add (Mul d15~128@ b15~124@) (Mul d15~128@ a15~122@))) (=> (= temp_15_1~1108@ (Mul d15~128@ (Add b15~124@ a15~122@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~1095@ temp_15_1~1108@))) (=> (= temp_15_0~1095@ temp_15_1~1108@) (=> (= temp_16_0~1149@ (Mul (Mul a16~130@ b16~132@) (Mul b16~132@ a16~130@))) (=> (= temp_16_1~1166@ (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ b16~132@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~1149@ temp_16_1~1166@))) (=> (= temp_16_0~1149@ temp_16_1~1166@) (=> (= temp_17_0~1203@ (Mul (Mul c17~142@ c17~142@) a17~138@)) (=> (= temp_17_1~1216@ (Mul a17~138@ (Mul c17~142@ c17~142@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~1203@ temp_17_1~1216@))) (=> (= temp_17_0~1203@ temp_17_1~1216@) (=> (= temp_18_0~1253@ (Mul a18~146@ (Add d18~152@ d18~152@))) (=> (= temp_18_1~1266@ (Mul (Add d18~152@ d18~152@) a18~146@)) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~1253@ temp_18_1~1266@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
