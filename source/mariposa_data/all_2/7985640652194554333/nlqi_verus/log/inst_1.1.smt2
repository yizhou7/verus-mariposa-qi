...
(assert (=> %%query%% (not (=> (= temp_0_0~177@ (Add (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))) (=> (= temp_0_1~194@ (Add (Mul d0~8@ c0~6@) (Mul b0~4@ a0~2@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ b0~4@) (=> %%location_label%%0 (= temp_0_0~177@ temp_0_1~194@))))))))
(assert %%query%%)
(check-sat)
