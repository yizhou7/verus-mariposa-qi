...
(declare-const temp_1_0~239@ Int)
(declare-const temp_1_1~256@ Int)
(declare-const temp_2_0~301@ Int)
(declare-const temp_2_1~318@ Int)
(declare-const temp_3_0~363@ Int)
(declare-const temp_3_1~380@ Int)
(declare-const temp_4_0~425@ Int)
(declare-const temp_4_1~442@ Int)
(declare-const temp_5_0~487@ Int)
(declare-const temp_5_1~504@ Int)
(declare-const temp_6_0~561@ Int)
(declare-const temp_6_1~590@ Int)
(declare-const temp_7_0~655@ Int)
(declare-const temp_7_1~672@ Int)
(declare-const temp_8_0~729@ Int)
(declare-const temp_8_1~758@ Int)
(declare-const temp_9_0~815@ Int)
(declare-const temp_9_1~832@ Int)
(declare-const temp_10_0~883@ Int)
(declare-const temp_10_1~900@ Int)
(declare-const temp_11_0~945@ Int)
(declare-const temp_11_1~962@ Int)
(declare-const temp_12_0~1015@ Int)
(declare-const temp_12_1~1032@ Int)
(declare-const temp_13_0~1077@ Int)
(declare-const temp_13_1~1094@ Int)
(declare-const temp_14_0~1145@ Int)
(declare-const temp_14_1~1162@ Int)
(declare-const temp_15_0~1213@ Int)
(declare-const temp_15_1~1226@ Int)
(declare-const temp_16_0~1273@ Int)
(declare-const temp_16_1~1290@ Int)
(declare-const temp_17_0~1331@ Int)
(declare-const temp_17_1~1344@ Int)
(declare-const temp_18_0~1389@ Int)
(declare-const temp_18_1~1402@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~177@ (Add (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@))) (=> (= temp_0_1~194@ (Add (Mul d0~8@ c0~6@) (Mul b0~4@ a0~2@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a0~2@ b0~4@) (=> %%location_label%%0 (= temp_0_0~177@ temp_0_1~194@))) (=> (= temp_0_0~177@ temp_0_1~194@) (=> (= temp_1_0~239@ (Mul (Mul c1~14@ d1~16@) (Add d1~16@ a1~10@))) (=> (= temp_1_1~256@ (Mul (Mul d1~16@ c1~14@) (Add d1~16@ a1~10@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ d1~16@) (=> %%location_label%%1 (= temp_1_0~239@ temp_1_1~256@))) (=> (= temp_1_0~239@ temp_1_1~256@) (=> (= temp_2_0~301@ (Mul (Mul b2~20@ a2~18@) (Sub a2~18@ a2~18@))) (=> (= temp_2_1~318@ (Mul (Mul a2~18@ b2~20@) (Sub a2~18@ a2~18@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ a2~18@) (=> %%location_label%%2 (= temp_2_0~301@ temp_2_1~318@))) (=> (= temp_2_0~301@ temp_2_1~318@) (=> (= temp_3_0~363@ (Add (Mul a3~26@ c3~30@) (Mul c3~30@ d3~32@))) (=> (= temp_3_1~380@ (Add (Mul c3~30@ a3~26@) (Mul c3~30@ d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ c3~30@) (=> %%location_label%%3 (= temp_3_0~363@ temp_3_1~380@))) (=> (= temp_3_0~363@ temp_3_1~380@) (=> (= temp_4_0~425@ (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ a4~34@))) (=> (= temp_4_1~442@ (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ a4~34@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ d4~40@) (=> %%location_label%%4 (= temp_4_0~425@ temp_4_1~442@))) (=> (= temp_4_0~425@ temp_4_1~442@) (=> (= temp_5_0~487@ (Sub (Mul a5~42@ c5~46@) (Mul d5~48@ c5~46@))) (=> (= temp_5_1~504@ (Sub (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ c5~46@) (=> %%location_label%%5 (= temp_5_0~487@ temp_5_1~504@))) (=> (= temp_5_0~487@ temp_5_1~504@) (=> (= temp_6_0~561@ (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ 99))) (=> (= temp_6_1~590@ (Mul (Mul d6~56@ 99) (Mul b6~52@ c6~54@))) (and (=> (= tmp%1@ (Mul b6~52@ c6~54@)) (=> (= tmp%2@ (Mul d6~56@ 99)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%6 (= temp_6_0~561@ temp_6_1~590@))))) (=> (= temp_6_0~561@ temp_6_1~590@) (=> (= temp_7_0~655@ (Add (Mul c7~62@ a7~58@) (Mul b7~60@ c7~62@))) (=> (= temp_7_1~672@ (Add (Mul c7~62@ a7~58@) (Mul c7~62@ b7~60@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ c7~62@) (=> %%location_label%%7 (= temp_7_0~655@ temp_7_1~672@))) (=> (= temp_7_0~655@ temp_7_1~672@) (=> (= temp_8_0~729@ (Mul (Mul 50 d8~72@) (Mul a8~66@ d8~72@))) (=> (= temp_8_1~758@ (Mul (Mul d8~72@ 50) (Mul a8~66@ d8~72@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 50 d8~72@) (=> %%location_label%%8 (= temp_8_0~729@ temp_8_1~758@))) (=> (= temp_8_0~729@ temp_8_1~758@) (=> (= temp_9_0~815@ (Mul (Mul d9~80@ c9~78@) (Sub b9~76@ c9~78@))) (=> (= temp_9_1~832@ (Mul d9~80@ (Mul c9~78@ (Sub b9~76@ c9~78@)))) (and (=> (= tmp%3@ (Sub b9~76@ c9~78@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d9~80@ c9~78@ tmp%3@) (=> %%location_label%%9 (= temp_9_0~815@ temp_9_1~832@)))) (=> (= temp_9_0~815@ temp_9_1~832@) (=> (= temp_10_0~883@ (Mul (Mul d10~88@ c10~86@) (Mul a10~82@ c10~86@))) (=> (= temp_10_1~900@ (Mul (Mul d10~88@ c10~86@) (Mul c10~86@ a10~82@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a10~82@ c10~86@) (=> %%location_label%%10 (= temp_10_0~883@ temp_10_1~900@))) (=> (= temp_10_0~883@ temp_10_1~900@) (=> (= temp_11_0~945@ (Mul (Mul d11~96@ d11~96@) (Sub a11~90@ c11~94@))) (=> (= temp_11_1~962@ (Mul (Sub a11~90@ c11~94@) (Mul d11~96@ d11~96@))) (and (=> (= tmp%4@ (Mul d11~96@ d11~96@)) (=> (= tmp%5@ (Sub a11~90@ c11~94@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%11 (= temp_11_0~945@ temp_11_1~962@))))) (=> (= temp_11_0~945@ temp_11_1~962@) (=> (= temp_12_0~1015@ (Add (Mul c12~102@ b12~100@) (Add d12~104@ a12~98@))) (=> (= temp_12_1~1032@ (Add (Mul b12~100@ c12~102@) (Add d12~104@ a12~98@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c12~102@ b12~100@) (=> %%location_label%%12 (= temp_12_0~1015@ temp_12_1~1032@))) (=> (= temp_12_0~1015@ temp_12_1~1032@) (=> (= temp_13_0~1077@ (Mul (Mul a13~106@ b13~108@) (Mul a13~106@ d13~112@))) (=> (= temp_13_1~1094@ (Mul (Mul (Mul a13~106@ b13~108@) a13~106@) d13~112@)) (and (=> (= tmp%6@ (Mul a13~106@ b13~108@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ a13~106@ d13~112@) (=> %%location_label%%13 (= temp_13_0~1077@ temp_13_1~1094@)))) (=> (= temp_13_0~1077@ temp_13_1~1094@) (=> (= temp_14_0~1145@ (Mul (Mul b14~116@ d14~120@) (Mul c14~118@ b14~116@))) (=> (= temp_14_1~1162@ (Mul (Mul (Mul b14~116@ d14~120@) c14~118@) b14~116@)) (and (=> (= tmp%7@ (Mul b14~116@ d14~120@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ c14~118@ b14~116@) (=> %%location_label%%14 (= temp_14_0~1145@ temp_14_1~1162@)))) (=> (= temp_14_0~1145@ temp_14_1~1162@) (=> (= temp_15_0~1213@ (Add (Mul d15~128@ b15~124@) (Mul d15~128@ a15~122@))) (=> (= temp_15_1~1226@ (Mul d15~128@ (Add b15~124@ a15~122@))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. d15~128@ b15~124@ a15~122@) (=> %%location_label%%15 (= temp_15_0~1213@ temp_15_1~1226@))) (=> (= temp_15_0~1213@ temp_15_1~1226@) (=> (= temp_16_0~1273@ (Mul (Mul a16~130@ b16~132@) (Mul b16~132@ a16~130@))) (=> (= temp_16_1~1290@ (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ b16~132@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b16~132@ a16~130@) (=> %%location_label%%16 (= temp_16_0~1273@ temp_16_1~1290@))) (=> (= temp_16_0~1273@ temp_16_1~1290@) (=> (= temp_17_0~1331@ (Mul (Mul c17~142@ c17~142@) a17~138@)) (=> (= temp_17_1~1344@ (Mul a17~138@ (Mul c17~142@ c17~142@))) (and (=> (= tmp%8@ (Mul c17~142@ c17~142@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ a17~138@) (=> %%location_label%%17 (= temp_17_0~1331@ temp_17_1~1344@)))) (=> (= temp_17_0~1331@ temp_17_1~1344@) (=> (= temp_18_0~1389@ (Mul a18~146@ (Add d18~152@ d18~152@))) (=> (= temp_18_1~1402@ (Mul (Add d18~152@ d18~152@) a18~146@)) (=> (= tmp%9@ (Add d18~152@ d18~152@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a18~146@ tmp%9@) (=> %%location_label%%18 (= temp_18_0~1389@ temp_18_1~1402@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
