...
;; mariposa_data/all_2//4072818890308413440/nlqi_verus/src/main.rs:7:1: 26:40 (#0)
(push)
 ...
 (declare-const temp_2_1~300@ Int)
 (declare-const temp_3_0~332@ Int)
 (declare-const temp_3_1~349@ Int)
 (declare-const temp_4_0~381@ Int)
 (declare-const temp_4_1~398@ Int)
 (declare-const temp_5_0~430@ Int)
 (declare-const temp_5_1~447@ Int)
 (declare-const temp_6_0~491@ Int)
 (declare-const temp_6_1~540@ Int)
 (declare-const temp_7_0~584@ Int)
 (declare-const temp_7_1~613@ Int)
 (declare-const temp_8_0~645@ Int)
 (declare-const temp_8_1~662@ Int)
 (declare-const temp_9_0~694@ Int)
 (declare-const temp_9_1~711@ Int)
 (declare-const temp_10_0~755@ Int)
 (declare-const temp_10_1~784@ Int)
 (declare-const temp_11_0~816@ Int)
 (declare-const temp_11_1~833@ Int)
 (declare-const temp_12_0~865@ Int)
 (declare-const temp_12_1~882@ Int)
 (declare-const temp_13_0~914@ Int)
 (declare-const temp_13_1~931@ Int)
 (declare-const temp_14_0~975@ Int)
 (declare-const temp_14_1~1004@ Int)
 (declare-const temp_15_0~1036@ Int)
 (declare-const temp_15_1~1053@ Int)
 (declare-const temp_16_0~1085@ Int)
 (declare-const temp_16_1~1102@ Int)
 (declare-const temp_17_0~1134@ Int)
 (declare-const temp_17_1~1151@ Int)
 (declare-const temp_18_0~1183@ Int)
 (declare-const temp_18_1~1200@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~181@ (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ b0~4@)))
      (=>
       (= temp_0_1~198@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@)))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~230@ (Sub (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@)))
           (=>
            (= temp_1_1~243@ (Mul a1~10@ (Sub d1~16@ c1~14@)))
            (=>
             (= tmp%2@ (= temp_1_0~230@ temp_1_1~243@))
             (and
              (=>
               %%location_label%%1
               tmp%2@
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~275@ (Mul (Mul d2~24@ c2~22@) (Add a2~18@ c2~22@)))
                (=>
                 (= temp_2_1~300@ (Add (Mul (Mul d2~24@ c2~22@) a2~18@) (Mul (Mul d2~24@ c2~22@) c2~22@)))
                 (=>
                  (= tmp%3@ (= temp_2_0~275@ temp_2_1~300@))
                  (and
                   (=>
                    %%location_label%%2
                    tmp%3@
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~332@ (Sub (Mul b3~28@ d3~32@) (Add a3~26@ a3~26@)))
                     (=>
                      (= temp_3_1~349@ (Sub (Mul d3~32@ b3~28@) (Add a3~26@ a3~26@)))
                      (=>
                       (= tmp%4@ (= temp_3_0~332@ temp_3_1~349@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~381@ (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ b4~36@)))
                          (=>
                           (= temp_4_1~398@ (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ b4~36@)))
                           (=>
                            (= tmp%5@ (= temp_4_0~381@ temp_4_1~398@))
                            (and
                             (=>
                              %%location_label%%4
                              tmp%5@
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~430@ (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ a5~42@)))
                               (=>
                                (= temp_5_1~447@ (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ a5~42@)))
                                (=>
                                 (= tmp%6@ (= temp_5_0~430@ temp_5_1~447@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~491@ (Mul (Mul b6~52@ 37) (Add b6~52@ a6~50@)))
                                    (=>
                                     (= temp_6_1~540@ (Add (Mul (Mul b6~52@ 37) b6~52@) (Mul (Mul b6~52@ 37) a6~50@)))
                                     (=>
                                      (= tmp%7@ (= temp_6_0~491@ temp_6_1~540@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~584@ (Add (Mul d7~64@ c7~62@) (Mul a7~58@ 37)))
                                         (=>
                                          (= temp_7_1~613@ (Add (Mul d7~64@ c7~62@) (Mul 37 a7~58@)))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~584@ temp_7_1~613@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~645@ (Sub (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@)))
                                              (=>
                                               (= temp_8_1~662@ (Sub (Mul b8~68@ d8~72@) (Mul d8~72@ d8~72@)))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~645@ temp_8_1~662@))
                                                (and
                                                 (=>
                                                  %%location_label%%8
                                                  tmp%9@
                                                 ...
                                                 (=>
                                                  tmp%9@
                                                  (=>
                                                   (= temp_9_0~694@ (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ b9~76@)))
                                                   (=>
                                                    (= temp_9_1~711@ (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ b9~76@)))
                                                    (=>
                                                     (= tmp%10@ (= temp_9_0~694@ temp_9_1~711@))
                                                     (and
                                                      (=>
                                                       %%location_label%%9
                                                       tmp%10@
                                                      ...
                                                      (=>
                                                       tmp%10@
                                                       (=>
                                                        (= temp_10_0~755@ (Add (Mul a10~82@ d10~88@) (Mul c10~86@ 84)))
                                                        (=>
                                                         (= temp_10_1~784@ (Add (Mul a10~82@ d10~88@) (Mul 84 c10~86@)))
                                                         (=>
                                                          (= tmp%11@ (= temp_10_0~755@ temp_10_1~784@))
                                                          (and
                                                           (=>
                                                            %%location_label%%10
                                                            tmp%11@
                                                           ...
                                                           (=>
                                                            tmp%11@
                                                            (=>
                                                             (= temp_11_0~816@ (Mul (Mul d11~96@ b11~92@) (Sub d11~96@ d11~96@)))
                                                             (=>
                                                              (= temp_11_1~833@ (Mul (Mul b11~92@ d11~96@) (Sub d11~96@ d11~96@)))
                                                              (=>
                                                               (= tmp%12@ (= temp_11_0~816@ temp_11_1~833@))
                                                               (and
                                                                (=>
                                                                 %%location_label%%11
                                                                 tmp%12@
                                                                ...
                                                                (=>
                                                                 tmp%12@
                                                                 (=>
                                                                  (= temp_12_0~865@ (Mul (Mul d12~104@ b12~100@) (Mul c12~102@ c12~102@)))
                                                                  (=>
                                                                   (= temp_12_1~882@ (Mul d12~104@ (Mul b12~100@ (Mul c12~102@ c12~102@))))
                                                                   (=>
                                                                    (= tmp%13@ (= temp_12_0~865@ temp_12_1~882@))
                                                                    (and
                                                                     (=>
                                                                      %%location_label%%12
                                                                      tmp%13@
                                                                     ...
                                                                     (=>
                                                                      tmp%13@
                                                                      (=>
                                                                       (= temp_13_0~914@ (Add (Mul d13~112@ d13~112@) (Mul c13~110@ b13~108@)))
                                                                       (=>
                                                                        (= temp_13_1~931@ (Add (Mul d13~112@ d13~112@) (Mul c13~110@ b13~108@)))
                                                                        (=>
                                                                         (= tmp%14@ (= temp_13_0~914@ temp_13_1~931@))
                                                                         (and
                                                                          (=>
                                                                           %%location_label%%13
                                                                           tmp%14@
                                                                          ...
                                                                          (=>
                                                                           tmp%14@
                                                                           (=>
                                                                            (= temp_14_0~975@ (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ 39)))
                                                                            (=>
                                                                             (= temp_14_1~1004@ (Mul (Mul a14~114@ c14~118@) (Mul 39 b14~116@)))
                                                                             (=>
                                                                              (= tmp%15@ (= temp_14_0~975@ temp_14_1~1004@))
                                                                              (and
                                                                               (=>
                                                                                %%location_label%%14
                                                                                tmp%15@
                                                                               ...
                                                                               (=>
                                                                                tmp%15@
                                                                                (=>
                                                                                 (= temp_15_0~1036@ (Sub (Mul b15~124@ a15~122@) (Mul d15~128@ a15~122@)))
                                                                                 (=>
                                                                                  (= temp_15_1~1053@ (Sub (Mul b15~124@ a15~122@) (Mul a15~122@ d15~128@)))
                                                                                  (=>
                                                                                   (= tmp%16@ (= temp_15_0~1036@ temp_15_1~1053@))
                                                                                   (and
                                                                                    (=>
                                                                                     %%location_label%%15
                                                                                     tmp%16@
                                                                                    ...
                                                                                    (=>
                                                                                     tmp%16@
                                                                                     (=>
                                                                                      (= temp_16_0~1085@ (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ a16~130@)))
                                                                                      (=>
                                                                                       (= temp_16_1~1102@ (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ c16~134@)))
                                                                                       (=>
                                                                                        (= tmp%17@ (= temp_16_0~1085@ temp_16_1~1102@))
                                                                                        (and
                                                                                         (=>
                                                                                          %%location_label%%16
                                                                                          tmp%17@
                                                                                         ...
                                                                                         (=>
                                                                                          tmp%17@
                                                                                          (=>
                                                                                           (= temp_17_0~1134@ (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ a17~138@)))
                                                                                           (=>
                                                                                            (= temp_17_1~1151@ (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ a17~138@)))
                                                                                            (=>
                                                                                             (= tmp%18@ (= temp_17_0~1134@ temp_17_1~1151@))
                                                                                             (and
                                                                                              (=>
                                                                                               %%location_label%%17
                                                                                               tmp%18@
                                                                                              ...
                                                                                              (=>
                                                                                               tmp%18@
                                                                                               (=>
                                                                                                (= temp_18_0~1183@ (Add (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@)))
                                                                                                (=>
                                                                                                 (= temp_18_1~1200@ (Add (Mul a18~146@ b18~148@) (Mul b18~148@ a18~146@)))
                                                                                                 (=>
                                                                                                  (= tmp%19@ (= temp_18_0~1183@ temp_18_1~1200@))
                                                                                                  (=>
                                                                                                   %%location_label%%18
                                                                                                   tmp%19@
 ))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
