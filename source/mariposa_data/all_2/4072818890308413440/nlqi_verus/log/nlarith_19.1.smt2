...
(declare-const temp_1_1~239@ Int)
(declare-const temp_2_0~271@ Int)
...
(declare-const temp_7_0~580@ Int)
(declare-const temp_7_1~609@ Int)
(declare-const temp_8_0~641@ Int)
(declare-const temp_8_1~658@ Int)
(declare-const temp_9_0~690@ Int)
(declare-const temp_9_1~707@ Int)
(declare-const temp_10_0~751@ Int)
(declare-const temp_10_1~780@ Int)
(declare-const temp_11_0~812@ Int)
(declare-const temp_11_1~829@ Int)
(declare-const temp_12_0~861@ Int)
(declare-const temp_12_1~878@ Int)
(declare-const temp_13_0~910@ Int)
(declare-const temp_13_1~927@ Int)
(declare-const temp_14_0~971@ Int)
(declare-const temp_14_1~1000@ Int)
(declare-const temp_15_0~1032@ Int)
(declare-const temp_15_1~1049@ Int)
(declare-const temp_16_0~1081@ Int)
(declare-const temp_16_1~1098@ Int)
(declare-const temp_17_0~1130@ Int)
(declare-const temp_17_1~1147@ Int)
(declare-const temp_18_0~1179@ Int)
(declare-const temp_18_1~1196@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~177@ (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ b0~4@))) (=> (= temp_0_1~194@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@))) (=> (= tmp%1@ (= temp_0_0~177@ temp_0_1~194@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~226@ (Sub (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~239@ (Mul a1~10@ (Sub d1~16@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~226@ temp_1_1~239@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~271@ (Mul (Mul d2~24@ c2~22@) (Add a2~18@ c2~22@))) (=> (= temp_2_1~296@ (Add (Mul (Mul d2~24@ c2~22@) a2~18@) (Mul (Mul d2~24@ c2~22@) c2~22@))) (=> (= tmp%3@ (= temp_2_0~271@ temp_2_1~296@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~328@ (Sub (Mul b3~28@ d3~32@) (Add a3~26@ a3~26@))) (=> (= temp_3_1~345@ (Sub (Mul d3~32@ b3~28@) (Add a3~26@ a3~26@))) (=> (= tmp%4@ (= temp_3_0~328@ temp_3_1~345@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~377@ (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~394@ (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ b4~36@))) (=> (= tmp%5@ (= temp_4_0~377@ temp_4_1~394@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~426@ (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ a5~42@))) (=> (= temp_5_1~443@ (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ a5~42@))) (=> (= tmp%6@ (= temp_5_0~426@ temp_5_1~443@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~487@ (Mul (Mul b6~52@ 37) (Add b6~52@ a6~50@))) (=> (= temp_6_1~536@ (Add (Mul (Mul b6~52@ 37) b6~52@) (Mul (Mul b6~52@ 37) a6~50@))) (=> (= tmp%7@ (= temp_6_0~487@ temp_6_1~536@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~580@ (Add (Mul d7~64@ c7~62@) (Mul a7~58@ 37))) (=> (= temp_7_1~609@ (Add (Mul d7~64@ c7~62@) (Mul 37 a7~58@))) (=> (= tmp%8@ (= temp_7_0~580@ temp_7_1~609@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~641@ (Sub (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@))) (=> (= temp_8_1~658@ (Sub (Mul b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (=> (= tmp%9@ (= temp_8_0~641@ temp_8_1~658@)) (and (=> %%location_label%%8 tmp%9@) (=> tmp%9@ (=> (= temp_9_0~690@ (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ b9~76@))) (=> (= temp_9_1~707@ (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ b9~76@))) (=> (= tmp%10@ (= temp_9_0~690@ temp_9_1~707@)) (and (=> %%location_label%%9 tmp%10@) (=> tmp%10@ (=> (= temp_10_0~751@ (Add (Mul a10~82@ d10~88@) (Mul c10~86@ 84))) (=> (= temp_10_1~780@ (Add (Mul a10~82@ d10~88@) (Mul 84 c10~86@))) (=> (= tmp%11@ (= temp_10_0~751@ temp_10_1~780@)) (and (=> %%location_label%%10 tmp%11@) (=> tmp%11@ (=> (= temp_11_0~812@ (Mul (Mul d11~96@ b11~92@) (Sub d11~96@ d11~96@))) (=> (= temp_11_1~829@ (Mul (Mul b11~92@ d11~96@) (Sub d11~96@ d11~96@))) (=> (= tmp%12@ (= temp_11_0~812@ temp_11_1~829@)) (and (=> %%location_label%%11 tmp%12@) (=> tmp%12@ (=> (= temp_12_0~861@ (Mul (Mul d12~104@ b12~100@) (Mul c12~102@ c12~102@))) (=> (= temp_12_1~878@ (Mul d12~104@ (Mul b12~100@ (Mul c12~102@ c12~102@)))) (=> (= tmp%13@ (= temp_12_0~861@ temp_12_1~878@)) (and (=> %%location_label%%12 tmp%13@) (=> tmp%13@ (=> (= temp_13_0~910@ (Add (Mul d13~112@ d13~112@) (Mul c13~110@ b13~108@))) (=> (= temp_13_1~927@ (Add (Mul d13~112@ d13~112@) (Mul c13~110@ b13~108@))) (=> (= tmp%14@ (= temp_13_0~910@ temp_13_1~927@)) (and (=> %%location_label%%13 tmp%14@) (=> tmp%14@ (=> (= temp_14_0~971@ (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ 39))) (=> (= temp_14_1~1000@ (Mul (Mul a14~114@ c14~118@) (Mul 39 b14~116@))) (=> (= tmp%15@ (= temp_14_0~971@ temp_14_1~1000@)) (and (=> %%location_label%%14 tmp%15@) (=> tmp%15@ (=> (= temp_15_0~1032@ (Sub (Mul b15~124@ a15~122@) (Mul d15~128@ a15~122@))) (=> (= temp_15_1~1049@ (Sub (Mul b15~124@ a15~122@) (Mul a15~122@ d15~128@))) (=> (= tmp%16@ (= temp_15_0~1032@ temp_15_1~1049@)) (and (=> %%location_label%%15 tmp%16@) (=> tmp%16@ (=> (= temp_16_0~1081@ (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ a16~130@))) (=> (= temp_16_1~1098@ (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ c16~134@))) (=> (= tmp%17@ (= temp_16_0~1081@ temp_16_1~1098@)) (and (=> %%location_label%%16 tmp%17@) (=> tmp%17@ (=> (= temp_17_0~1130@ (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ a17~138@))) (=> (= temp_17_1~1147@ (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ a17~138@))) (=> (= tmp%18@ (= temp_17_0~1130@ temp_17_1~1147@)) (and (=> %%location_label%%17 tmp%18@) (=> tmp%18@ (=> (= temp_18_0~1179@ (Add (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@))) (=> (= temp_18_1~1196@ (Add (Mul a18~146@ b18~148@) (Mul b18~148@ a18~146@))) (=> (= tmp%19@ (= temp_18_0~1179@ temp_18_1~1196@)) (=> %%location_label%%18 tmp%19@)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
