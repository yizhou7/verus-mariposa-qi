...
(assert (=> %%query%% (not (=> (= temp_0_0~177@ (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ b0~4@))) (=> (= temp_0_1~194@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@))) (=> (= tmp%1@ (Mul c0~6@ c0~6@)) (=> (= tmp%2@ (Mul d0~8@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~177@ temp_0_1~194@))))))))))
(assert %%query%%)
(check-sat)
