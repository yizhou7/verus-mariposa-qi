...
(assert (=> %%query%% (not (=> (= temp_0_0~177@ (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ b0~4@))) (=> (= temp_0_1~194@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~177@ temp_0_1~194@))) (=> (= temp_0_0~177@ temp_0_1~194@) (=> (= temp_1_0~235@ (Sub (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~248@ (Mul a1~10@ (Sub d1~16@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~235@ temp_1_1~248@))))))))))))
(assert %%query%%)
(check-sat)
