...
(assert (=> %%query%% (not (=> (= temp_0_0~177@ (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ b0~4@))) (=> (= temp_0_1~194@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@))) (=> (= tmp%1@ (= temp_0_0~177@ temp_0_1~194@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~226@ (Sub (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~239@ (Mul a1~10@ (Sub d1~16@ c1~14@))) (=> (= tmp%2@ (= temp_1_0~226@ temp_1_1~239@)) (=> %%location_label%%1 tmp%2@))))))))))))
(assert %%query%%)
(check-sat)
