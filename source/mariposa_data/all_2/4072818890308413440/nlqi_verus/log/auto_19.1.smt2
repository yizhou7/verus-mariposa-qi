...
(declare-const temp_1_1~248@ Int)
(declare-const temp_2_0~289@ Int)
(declare-const temp_2_1~314@ Int)
(declare-const temp_3_0~355@ Int)
(declare-const temp_3_1~372@ Int)
(declare-const temp_4_0~413@ Int)
(declare-const temp_4_1~430@ Int)
(declare-const temp_5_0~471@ Int)
(declare-const temp_5_1~488@ Int)
(declare-const temp_6_0~541@ Int)
(declare-const temp_6_1~590@ Int)
(declare-const temp_7_0~643@ Int)
(declare-const temp_7_1~672@ Int)
(declare-const temp_8_0~713@ Int)
(declare-const temp_8_1~730@ Int)
(declare-const temp_9_0~771@ Int)
(declare-const temp_9_1~788@ Int)
(declare-const temp_10_0~841@ Int)
(declare-const temp_10_1~870@ Int)
(declare-const temp_11_0~911@ Int)
(declare-const temp_11_1~928@ Int)
(declare-const temp_12_0~969@ Int)
(declare-const temp_12_1~986@ Int)
(declare-const temp_13_0~1027@ Int)
(declare-const temp_13_1~1044@ Int)
(declare-const temp_14_0~1097@ Int)
(declare-const temp_14_1~1126@ Int)
(declare-const temp_15_0~1167@ Int)
(declare-const temp_15_1~1184@ Int)
(declare-const temp_16_0~1225@ Int)
(declare-const temp_16_1~1242@ Int)
(declare-const temp_17_0~1283@ Int)
(declare-const temp_17_1~1300@ Int)
(declare-const temp_18_0~1341@ Int)
(declare-const temp_18_1~1358@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~177@ (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ b0~4@))) (=> (= temp_0_1~194@ (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~177@ temp_0_1~194@))) (=> (= temp_0_0~177@ temp_0_1~194@) (=> (= temp_1_0~235@ (Sub (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@))) (=> (= temp_1_1~248@ (Mul a1~10@ (Sub d1~16@ c1~14@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~235@ temp_1_1~248@))) (=> (= temp_1_0~235@ temp_1_1~248@) (=> (= temp_2_0~289@ (Mul (Mul d2~24@ c2~22@) (Add a2~18@ c2~22@))) (=> (= temp_2_1~314@ (Add (Mul (Mul d2~24@ c2~22@) a2~18@) (Mul (Mul d2~24@ c2~22@) c2~22@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~289@ temp_2_1~314@))) (=> (= temp_2_0~289@ temp_2_1~314@) (=> (= temp_3_0~355@ (Sub (Mul b3~28@ d3~32@) (Add a3~26@ a3~26@))) (=> (= temp_3_1~372@ (Sub (Mul d3~32@ b3~28@) (Add a3~26@ a3~26@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~355@ temp_3_1~372@))) (=> (= temp_3_0~355@ temp_3_1~372@) (=> (= temp_4_0~413@ (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ b4~36@))) (=> (= temp_4_1~430@ (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ b4~36@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~413@ temp_4_1~430@))) (=> (= temp_4_0~413@ temp_4_1~430@) (=> (= temp_5_0~471@ (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ a5~42@))) (=> (= temp_5_1~488@ (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ a5~42@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~471@ temp_5_1~488@))) (=> (= temp_5_0~471@ temp_5_1~488@) (=> (= temp_6_0~541@ (Mul (Mul b6~52@ 37) (Add b6~52@ a6~50@))) (=> (= temp_6_1~590@ (Add (Mul (Mul b6~52@ 37) b6~52@) (Mul (Mul b6~52@ 37) a6~50@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~541@ temp_6_1~590@))) (=> (= temp_6_0~541@ temp_6_1~590@) (=> (= temp_7_0~643@ (Add (Mul d7~64@ c7~62@) (Mul a7~58@ 37))) (=> (= temp_7_1~672@ (Add (Mul d7~64@ c7~62@) (Mul 37 a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~643@ temp_7_1~672@))) (=> (= temp_7_0~643@ temp_7_1~672@) (=> (= temp_8_0~713@ (Sub (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@))) (=> (= temp_8_1~730@ (Sub (Mul b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~713@ temp_8_1~730@))) (=> (= temp_8_0~713@ temp_8_1~730@) (=> (= temp_9_0~771@ (Mul (Mul a9~74@ d9~80@) (Mul a9~74@ b9~76@))) (=> (= temp_9_1~788@ (Mul (Mul d9~80@ a9~74@) (Mul a9~74@ b9~76@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%9 (= temp_9_0~771@ temp_9_1~788@))) (=> (= temp_9_0~771@ temp_9_1~788@) (=> (= temp_10_0~841@ (Add (Mul a10~82@ d10~88@) (Mul c10~86@ 84))) (=> (= temp_10_1~870@ (Add (Mul a10~82@ d10~88@) (Mul 84 c10~86@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%10 (= temp_10_0~841@ temp_10_1~870@))) (=> (= temp_10_0~841@ temp_10_1~870@) (=> (= temp_11_0~911@ (Mul (Mul d11~96@ b11~92@) (Sub d11~96@ d11~96@))) (=> (= temp_11_1~928@ (Mul (Mul b11~92@ d11~96@) (Sub d11~96@ d11~96@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%11 (= temp_11_0~911@ temp_11_1~928@))) (=> (= temp_11_0~911@ temp_11_1~928@) (=> (= temp_12_0~969@ (Mul (Mul d12~104@ b12~100@) (Mul c12~102@ c12~102@))) (=> (= temp_12_1~986@ (Mul d12~104@ (Mul b12~100@ (Mul c12~102@ c12~102@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%12 (= temp_12_0~969@ temp_12_1~986@))) (=> (= temp_12_0~969@ temp_12_1~986@) (=> (= temp_13_0~1027@ (Add (Mul d13~112@ d13~112@) (Mul c13~110@ b13~108@))) (=> (= temp_13_1~1044@ (Add (Mul d13~112@ d13~112@) (Mul c13~110@ b13~108@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%13 (= temp_13_0~1027@ temp_13_1~1044@))) (=> (= temp_13_0~1027@ temp_13_1~1044@) (=> (= temp_14_0~1097@ (Mul (Mul a14~114@ c14~118@) (Mul b14~116@ 39))) (=> (= temp_14_1~1126@ (Mul (Mul a14~114@ c14~118@) (Mul 39 b14~116@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%14 (= temp_14_0~1097@ temp_14_1~1126@))) (=> (= temp_14_0~1097@ temp_14_1~1126@) (=> (= temp_15_0~1167@ (Sub (Mul b15~124@ a15~122@) (Mul d15~128@ a15~122@))) (=> (= temp_15_1~1184@ (Sub (Mul b15~124@ a15~122@) (Mul a15~122@ d15~128@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%15 (= temp_15_0~1167@ temp_15_1~1184@))) (=> (= temp_15_0~1167@ temp_15_1~1184@) (=> (= temp_16_0~1225@ (Mul (Mul a16~130@ b16~132@) (Mul c16~134@ a16~130@))) (=> (= temp_16_1~1242@ (Mul (Mul a16~130@ b16~132@) (Mul a16~130@ c16~134@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%16 (= temp_16_0~1225@ temp_16_1~1242@))) (=> (= temp_16_0~1225@ temp_16_1~1242@) (=> (= temp_17_0~1283@ (Mul (Mul b17~140@ a17~138@) (Mul a17~138@ a17~138@))) (=> (= temp_17_1~1300@ (Mul (Mul a17~138@ a17~138@) (Mul b17~140@ a17~138@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%17 (= temp_17_0~1283@ temp_17_1~1300@))) (=> (= temp_17_0~1283@ temp_17_1~1300@) (=> (= temp_18_0~1341@ (Add (Mul a18~146@ b18~148@) (Mul a18~146@ b18~148@))) (=> (= temp_18_1~1358@ (Add (Mul a18~146@ b18~148@) (Mul b18~148@ a18~146@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%18 (= temp_18_0~1341@ temp_18_1~1358@))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
