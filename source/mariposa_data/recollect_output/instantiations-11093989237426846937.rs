...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		...
		lemma_mul_is_associative((b0 * c0) * (c0 * d0), (44 * b0) - (a0 + c0), ((d0 * 33) * a0) * ((b0 * b0) * (c0 - b0)));
		lemma_mul_is_associative((b0 * c0) * (d0 * c0), (44 * b0) - (a0 + c0), ((d0 * 33) * a0) * ((b0 * b0) * (c0 - b0)));
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_distributive((d1 * b1) * (b1 * d1), d1, ((d1 * c1) * (a1 + b1)) * ((a1 + a1) * (b1 * c1)));
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_commutative(12, c2);
		lemma_mul_is_associative(12 * c2, a2 * d2, (c2 * a2) * (c2 * d2));
		lemma_mul_is_associative(c2 * 12, a2 * d2, (c2 * a2) * (c2 * d2));
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_commutative(b3 * d3, a3 * c3);
		lemma_mul_is_associative((b3 * d3) * (a3 * c3), (a3 * b3) * (85 * b3), ((b3 * c3) * (d3 * d3)) * ((b3 * c3) + (b3 * d3)));
		lemma_mul_is_associative((a3 * c3) * (b3 * d3), (a3 * b3) * (85 * b3), ((b3 * c3) * (d3 * d3)) * ((b3 * c3) + (b3 * d3)));
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_commutative((b4 * d4) * (a4 - b4), d4 * (b4 + 79));
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_distributive(c5 * d5, c5, c5);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		...
		lemma_mul_is_associative(a7 * c7, c7 * c7, b7);
		lemma_mul_is_associative(c7 * a7, c7 * c7, b7);
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_commutative(b9 + c9, c9 * c9);
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_associative(b10, d10, c10 - a10);
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_commutative((b11 + c11) - (d11 + a11), c11);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		...
		lemma_mul_is_associative(((d12 + a12) * (a12 * c12)) + ((c12 * c12) * (b12 * a12)), (b12 * a12) * (b12 - d12), (c12 * d12) * (a12 * c12));
		lemma_mul_is_associative(((d12 + a12) * (a12 * c12)) + ((c12 * c12) * (b12 * a12)), (b12 * a12) * (b12 - d12), (d12 * c12) * (a12 * c12));
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_associative(c13, a13, a13 + b13);
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_associative(b14, c14, c14 + d14);
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_commutative((c15 - b15) * (b15 + a15), (a15 * b15) * (c15 * b15));
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_associative(d16, 37, c16 * d16);
	}
