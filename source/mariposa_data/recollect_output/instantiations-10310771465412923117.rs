...
pub proof fn free_0(a: Elem, b: Elem, c: Elem, d: Elem, m: Elem)
{
	...
	assert(eq_(temp_0_0, temp_0_1)) by {
		lemma_mul_comm(add_(d, c), add_(as_elem(77), d));
		cong_mod_(mul_(add_(d, c), add_(as_elem(77), d)), m, mul_(add_(as_elem(77), d), add_(d, c)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_2_0, temp_2_1)) by {
		lemma_mul_comm(mul_(c, d), mul_(b, mod_(c, m)));
	}
	...
	assert(eq_(temp_9_0, temp_9_1)) by {
		...
		lemma_mul_assoc(as_elem(34), b, mul_(b, d));
	}
	...
	assert(eq_(temp_14_0, temp_14_1)) by {
		lemma_mul_dist(mod_(d, m), b, mul_(d, d));
	}
	...
	assert(eq_(temp_17_0, temp_17_1)) by {
		lemma_mul_comm(mul_(a, a), mod_(mul_(b, d), m));
	}
	...
	assert(eq_(temp_21_0, temp_21_1)) by {
		lemma_mul_comm(a, a);
		lemma_mod_mul_vanish(d, sub_(mod_(mul_(a, b), m), mul_(b, mod_(c, m))), m);
		cong_mul_(mul_(a, a), mul_(mod_(d, m), a), mul_(a, a), mul_(mod_(add_(mul_(sub_(mod_(mul_(a, b), m), mul_(b, mod_(c, m))), m), d), m), a));
		cong_mul_(mod_(d, m), a, mod_(add_(mul_(sub_(mod_(mul_(a, b), m), mul_(b, mod_(c, m))), m), d), m), a);
		lemma_eq_ref(a);
	}
	let temp_22_0 = (add_((mul_(a, c)), (add_(c, b))));
	let temp_22_1 = (add_((mul_(c, a)), (add_(c, b))));
	assert(eq_(temp_22_0, temp_22_1)) by {
		cong_add_(mul_(a, c), add_(c, b), mul_(c, a), add_(c, b));
		lemma_mul_comm(a, c);
	...
	assert(eq_(temp_23_0, temp_23_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(as_elem(46), a), mul_(a, a)), mul_(mul_(mod_(b, m), d), mul_(b, a)), m);
	}
	...
	assert(eq_(temp_24_0, temp_24_1)) by {
		lemma_mod_mul_vanish(sub_(mul_(c, a), mul_(b, mod_(b, m))), mul_(mul_(a, c), mul_(c, mod_(c, m))), m);
	}
	...
	assert(eq_(temp_28_0, temp_28_1)) by {
		...
		cong_mod_(mul_(mul_(d, d), mod_(mul_(d, mod_(d, m)), m)), m, mul_(mul_(d, d), mod_(mul_(mod_(d, m), d), m)), m);
		cong_mod_(mul_(d, mod_(d, m)), m, mul_(mod_(d, m), d), m);
		cong_mul_(mul_(d, d), mod_(mul_(d, mod_(d, m)), m), mul_(d, d), mod_(mul_(mod_(d, m), d), m));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_32_0, temp_32_1)) by {
		...
		cong_mul_(mod_(mul_(b, mod_(b, m)), m), mul_(c, a), mod_(mul_(mod_(b, m), b), m), mul_(c, a));
	...
	assert(eq_(temp_33_0, temp_33_1)) by {
		lemma_mul_comm(b, c);
		cong_mul_(mul_(b, c), mul_(mod_(b, m), a), mul_(c, b), mul_(mod_(b, m), a));
	...
	assert(eq_(temp_34_0, temp_34_1)) by {
		lemma_mod_sub_noop(mul_(a, d), mul_(d, mod_(d, m)), m);
	}
	let temp_35_0 = (mul_((mod_((mul_(a, c)), m)), (mul_(a, d))));
	let temp_35_1 = (mul_((mul_((mod_((mul_(a, c)), m)), a)), d));
	assert(eq_(temp_35_0, temp_35_1)) by {
		lemma_mul_assoc(mod_(mul_(a, c), m), a, d);
	}
	let temp_36_0 = (mod_((mul_((mul_(a, a)), (sub_((mod_(b, m)), c)))), m));
	let temp_36_1 = (mod_((mul_(a, (mul_(a, (sub_((mod_(b, m)), c)))))), m));
	assert(eq_(temp_36_0, temp_36_1)) by {
		lemma_mul_assoc(a, a, sub_(mod_(b, m), c));
		cong_mod_(mul_(mul_(a, a), sub_(mod_(b, m), c)), m, mul_(a, mul_(a, sub_(mod_(b, m), c))), m);
		lemma_eq_sym(mul_(a, mul_(a, sub_(mod_(b, m), c))), mul_(mul_(a, a), sub_(mod_(b, m), c)));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_37_0, temp_37_1)) by {
		lemma_mul_comm(a, d);
		cong_add_(add_(mod_(d, m), b), mul_(a, d), add_(mod_(d, m), b), mul_(d, a));
	...
	assert(eq_(temp_38_0, temp_38_1)) by {
		lemma_mod_mul_vanish(a, mod_(mul_(mul_(b, d), add_(c, c)), m), m);
		cong_mul_(mul_(b, mod_(a, m)), mul_(a, b), mul_(b, mod_(add_(a, mul_(mod_(mul_(mul_(b, d), add_(c, c)), m), m)), m)), mul_(a, b));
		lemma_eq_ref(b);
		cong_mul_(b, mod_(a, m), b, mod_(add_(a, mul_(mod_(mul_(mul_(b, d), add_(c, c)), m), m)), m));
		lemma_eq_ref(mul_(a, b));
	}
	...
	assert(eq_(temp_40_0, temp_40_1)) by {
		lemma_add_comm(mul_(c, a), mul_(d, mod_(a, m)));
	}
	...
	assert(eq_(temp_41_0, temp_41_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(b, c), sub_(a, a)), add_(mul_(c, a), mul_(c, c)), m);
	}
	...
	assert(eq_(temp_44_0, temp_44_1)) by {
		lemma_mul_comm(c, d);
		cong_mul_(mod_(mul_(c, d), m), sub_(a, d), mod_(mul_(d, c), m), sub_(a, d));
	...
	assert(eq_(temp_46_0, temp_46_1)) by {
		cong_mul_(mul_(c, b), sub_(a, d), mul_(b, c), sub_(a, d));
		lemma_mul_comm(c, b);
		lemma_eq_ref(sub_(a, d));
	}
	...
	assert(eq_(temp_47_0, temp_47_1)) by {
		lemma_mod_mul_vanish(add_(b, c), mul_(mul_(d, b), mul_(b, d)), m);
		cong_mul_(mul_(as_elem(53), b), mod_(add_(b, c), m), mul_(as_elem(53), b), mod_(add_(mul_(mul_(mul_(d, b), mul_(b, d)), m), add_(b, c)), m));
		lemma_eq_ref(mul_(as_elem(53), b));
	}
	let temp_48_0 = (mul_((sub_(a, d)), (mul_(b, d))));
	let temp_48_1 = (mul_((mul_((sub_(a, d)), b)), d));
	assert(eq_(temp_48_0, temp_48_1)) by {
		lemma_mul_assoc(sub_(a, d), b, d);
	}
	...
	assert(eq_(temp_52_0, temp_52_1)) by {
		lemma_mul_assoc(mod_(add_(mod_(c, m), a), m), c, b);
	}
	let temp_53_0 = (mul_((mod_((mul_(d, c)), m)), (mod_((sub_(b, b)), m))));
	let temp_53_1 = (mul_((mod_((mul_(d, c)), m)), (mod_((sub_(b, (mod_(b, m)))), m))));
	assert(eq_(temp_53_0, temp_53_1)) by {
		cong_mul_(mod_(mul_(d, c), m), mod_(sub_(b, b), m), mod_(mul_(d, c), m), mod_(sub_(b, mod_(b, m)), m));
	...
	assert(eq_(temp_59_0, temp_59_1)) by {
		lemma_mod_mul_vanish(b, mul_(mul_(d, a), mul_(b, a)), m);
		cong_mul_(mul_(a, d), mul_(mod_(b, m), a), mul_(a, d), mul_(mod_(add_(b, mul_(mul_(mul_(d, a), mul_(b, a)), m)), m), a));
		lemma_eq_ref(a);
		lemma_eq_ref(mul_(a, d));
		cong_mul_(mod_(b, m), a, mod_(add_(b, mul_(mul_(mul_(d, a), mul_(b, a)), m)), m), a);
	}
	...
	assert(eq_(temp_61_0, temp_61_1)) by {
		lemma_mul_comm(as_elem(23), b);
		cong_mul_(mul_(c, mod_(c, m)), mul_(as_elem(23), b), mul_(c, mod_(c, m)), mul_(b, as_elem(23)));
	...
	assert(eq_(temp_62_0, temp_62_1)) by {
		lemma_mul_comm(mul_(c, c), sub_(as_elem(64), a));
	}
	...
	assert(eq_(temp_64_0, temp_64_1)) by {
		lemma_mod_mul_vanish(d, mul_(mul_(a, b), mul_(d, a)), m);
		cong_mul_(add_(c, d), mul_(mod_(d, m), c), add_(c, d), mul_(mod_(add_(mul_(mul_(mul_(a, b), mul_(d, a)), m), d), m), c));
		lemma_eq_ref(add_(c, d));
		cong_mul_(mod_(d, m), c, mod_(add_(mul_(mul_(mul_(a, b), mul_(d, a)), m), d), m), c);
		lemma_eq_ref(c);
	}
	...
	assert(eq_(temp_67_0, temp_67_1)) by {
		lemma_mul_comm(mod_(mul_(mod_(d, m), a), m), mul_(c, c));
	}
	...
	assert(eq_(temp_71_0, temp_71_1)) by {
		lemma_mul_comm(c, c);
		lemma_mod_mul_vanish(a, mul_(mul_(c, as_elem(72)), mul_(mod_(b, m), mod_(b, m))), m);
		cong_mul_(mul_(d, mod_(a, m)), mul_(c, c), mul_(d, mod_(add_(a, mul_(mul_(mul_(c, as_elem(72)), mul_(mod_(b, m), mod_(b, m))), m)), m)), mul_(c, c));
		lemma_eq_ref(d);
		cong_mul_(d, mod_(a, m), d, mod_(add_(a, mul_(mul_(mul_(c, as_elem(72)), mul_(mod_(b, m), mod_(b, m))), m)), m));
	}
	let temp_72_0 = (mul_((add_(a, b)), (mul_(b, as_elem(58)))));
	let temp_72_1 = (add_((mul_(a, (mul_(b, as_elem(58))))), (mul_(b, (mul_(b, as_elem(58)))))));
	assert(eq_(temp_72_0, temp_72_1)) by {
		lemma_mul_dist(a, b, mul_(b, as_elem(58)));
	}
	...
	assert(eq_(temp_73_0, temp_73_1)) by {
		lemma_mod_mul_vanish(mul_(b, a), sub_(mul_(a, b), mul_(b, a)), m);
		cong_mul_(mod_(mul_(b, a), m), mul_(c, a), mod_(add_(mul_(b, a), mul_(sub_(mul_(a, b), mul_(b, a)), m)), m), mul_(c, a));
		lemma_eq_ref(mul_(c, a));
	}
	...
	assert(eq_(temp_74_0, temp_74_1)) by {
		lemma_mod_mul_vanish(a, mul_(mul_(b, b), add_(a, a)), m);
		cong_mul_(mul_(mod_(a, m), mod_(b, m)), add_(mod_(d, m), d), mul_(mod_(add_(mul_(mul_(mul_(b, b), add_(a, a)), m), a), m), mod_(b, m)), add_(mod_(d, m), d));
		lemma_eq_ref(mod_(b, m));
		cong_mul_(mod_(a, m), mod_(b, m), mod_(add_(mul_(mul_(mul_(b, b), add_(a, a)), m), a), m), mod_(b, m));
		lemma_eq_ref(add_(mod_(d, m), d));
	}
	...
	assert(eq_(temp_76_0, temp_76_1)) by {
		lemma_mul_comm(c, d);
		cong_mod_(sub_(mul_(c, d), sub_(b, c)), m, sub_(mul_(d, c), sub_(b, c)), m);
		cong_sub_(mul_(c, d), sub_(b, c), mul_(d, c), sub_(b, c));
		lemma_eq_ref(m);
	...
	assert(eq_(temp_77_0, temp_77_1)) by {
		cong_add_(add_(b, d), sub_(b, b), add_(d, b), sub_(b, b));
		lemma_add_comm(b, d);
	...
	assert(eq_(temp_78_0, temp_78_1)) by {
		lemma_mul_assoc(mod_(mul_(d, d), m), a, b);
	}
	...
	assert(eq_(temp_80_0, temp_80_1)) by {
		...
		cong_mul_(mul_(b, b), add_(c, mod_(a, m)), mul_(b, b), add_(mod_(a, m), c));
	}
	let temp_81_0 = (add_((add_(b, b)), (mul_(b, d))));
	let temp_81_1 = (add_((mul_(b, d)), (add_(b, b))));
	assert(eq_(temp_81_0, temp_81_1)) by {
		lemma_add_comm(add_(b, b), mul_(b, d));
	}
	...
	assert(eq_(temp_82_0, temp_82_1)) by {
		lemma_mod_mul_vanish(mul_(d, b), mul_(mod_(mul_(b, d), m), mul_(d, mod_(a, m))), m);
		cong_mul_(mul_(c, b), mod_(mul_(d, b), m), mul_(c, b), mod_(add_(mul_(mul_(mod_(mul_(b, d), m), mul_(d, mod_(a, m))), m), mul_(d, b)), m));
	...
	assert(eq_(temp_83_0, temp_83_1)) by {
		lemma_mul_comm(a, mod_(as_elem(57), m));
		cong_add_(mul_(a, mod_(as_elem(57), m)), mul_(mod_(b, m), mod_(c, m)), mul_(mod_(as_elem(57), m), a), mul_(mod_(b, m), mod_(c, m)));
	...
	assert(eq_(temp_85_0, temp_85_1)) by {
		lemma_mul_assoc(mul_(as_elem(63), c), mod_(a, m), a);
	}
	...
	assert(eq_(temp_88_0, temp_88_1)) by {
		lemma_mul_assoc(mul_(as_elem(62), a), a, a);
	}
	...
	assert(eq_(temp_92_0, temp_92_1)) by {
		lemma_mul_comm(c, b);
		cong_sub_(add_(as_elem(1), d), mul_(c, b), add_(as_elem(1), d), mul_(b, c));
		lemma_eq_ref(add_(as_elem(1), d));
	}
