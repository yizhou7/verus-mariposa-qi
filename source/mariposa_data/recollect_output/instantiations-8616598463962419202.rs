...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_commutative(c3 - d3, d3 * 0);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_associative(d5 * (a5 * c5), b5 + d5, c5 * c5);
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_associative(a6, c6 * d6, (c6 * c6) * (a6 + b6));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_commutative(((a9 - b9) * (c9 * a9)) * d9, ((c9 * c9) * (d9 - a9)) * ((c9 * d9) * (a9 * d9)));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_associative(((85 - a11) * (d11 + c11)) - ((a11 + d11) * (c11 * a11)), (b11 - d11) * (b11 * a11), ((a11 + b11) * c11) * d11);
