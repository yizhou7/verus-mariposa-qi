...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_2_0 == temp_2_1) by {
		...
		lemma_mul_is_associative(((c2 * d2) * (b2 * d2)) * ((d2 * a2) * d2), (c2 * d2) * (d2 * a2), (c2 * d2) * (a2 * c2));
		lemma_mul_is_associative(((c2 * d2) * (b2 * d2)) * ((d2 * a2) * d2), (c2 * d2) * (d2 * a2), (d2 * c2) * (a2 * c2));
	}
	let temp_3_0 = ((((b3*c3)*(c3*d3))*((d3*a3)*(b3*c3)))*(((a3-b3)*(a3*c3))*(d3*(a3*c3))));
	let temp_3_1 = ((((b3*c3)*(c3*d3))*((d3*a3)*(b3*c3)))*(((a3-b3)*(a3*c3))*((d3*a3)*c3)));
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_associative(((b3 * c3) * (c3 * d3)) * ((d3 * a3) * (b3 * c3)), (a3 - b3) * (a3 * c3), (d3 * a3) * c3);
		lemma_mul_is_associative(d3, a3, c3);
		lemma_mul_is_associative(((b3 * c3) * (c3 * d3)) * ((d3 * a3) * (b3 * c3)), (a3 - b3) * (a3 * c3), d3 * (a3 * c3));
	}
