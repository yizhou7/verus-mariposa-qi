...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_commutative(d0 * d0, a0 * a0);
		lemma_mul_is_associative(((d0 * c0) * (c0 - c0)) * ((b0 * a0) + (b0 * c0)), (d0 + c0) + (a0 * d0), (d0 * d0) * (a0 * a0));
		lemma_mul_is_associative(((d0 * c0) * (c0 - c0)) * ((b0 * a0) + (b0 * c0)), (d0 + c0) + (a0 * d0), (a0 * a0) * (d0 * d0));
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_distributive((a4 - c4) + (a4 * a4), c4 * (a4 * a4), ((c4 * c4) * (d4 * a4)) * ((b4 * c4) * (b4 - a4)));
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_associative(a5, d5 * d5, c5 * d5);
	}
