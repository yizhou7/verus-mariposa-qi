...
pub proof fn free_0(a: Elem, b: Elem, c: Elem, d: Elem, m: Elem)
{
	...
	assert(eq_(temp_0_0, temp_0_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(b, c), mul_(c, a)), mul_(mul_(b, d), mul_(c, d)), m);
	}
	...
	assert(eq_(temp_2_0, temp_2_1)) by {
		lemma_mod_mul_vanish(mul_(as_elem(30), d), mul_(mul_(d, c), mul_(as_elem(95), a)), m);
		cong_sub_(mod_(mul_(as_elem(30), d), m), mul_(b, d), mod_(add_(mul_(mul_(mul_(d, c), mul_(as_elem(95), a)), m), mul_(as_elem(30), d)), m), mul_(b, d));
		lemma_eq_ref(mul_(b, d));
	}
	let temp_3_0 = (mod_((mul_((mul_(d, d)), (mul_(d, c)))), m));
	let temp_3_1 = (mod_((mul_((mul_(d, c)), (mul_(d, d)))), m));
	assert(eq_(temp_3_0, temp_3_1)) by {
		cong_mod_(mul_(mul_(d, d), mul_(d, c)), m, mul_(mul_(d, c), mul_(d, d)), m);
	...
	assert(eq_(temp_7_0, temp_7_1)) by {
		lemma_mod_mul_vanish(c, sub_(mul_(b, a), mul_(b, b)), m);
		cong_mul_(mul_(mod_(c, m), mod_(b, m)), mul_(a, b), mul_(mod_(add_(mul_(sub_(mul_(b, a), mul_(b, b)), m), c), m), mod_(b, m)), mul_(a, b));
		lemma_eq_ref(mod_(b, m));
		lemma_eq_ref(mul_(a, b));
		cong_mul_(mod_(c, m), mod_(b, m), mod_(add_(mul_(sub_(mul_(b, a), mul_(b, b)), m), c), m), mod_(b, m));
	}
	let temp_8_0 = (mul_((sub_(d, a)), (mul_(a, d))));
	let temp_8_1 = (sub_((mul_(d, (mul_(a, d)))), (mul_(a, (mul_(a, d))))));
	assert(eq_(temp_8_0, temp_8_1)) by {
		lemma_mul_dist(mul_(a, d), d, a);
	}
	let temp_9_0 = (sub_((mul_((mod_(b, m)), a)), (mul_(a, b))));
	let temp_9_1 = (sub_((mul_(a, (mod_(b, m)))), (mul_(a, b))));
	assert(eq_(temp_9_0, temp_9_1)) by {
		cong_sub_(mul_(mod_(b, m), a), mul_(a, b), mul_(a, mod_(b, m)), mul_(a, b));
	...
	assert(eq_(temp_11_0, temp_11_1)) by {
		cong_mul_(mul_(b, c), mul_(b, mod_(b, m)), mul_(c, b), mul_(b, mod_(b, m)));
		lemma_mul_comm(b, c);
	...
	assert(eq_(temp_15_0, temp_15_1)) by {
		lemma_mul_comm(b, b);
		lemma_add_comm(as_elem(76), c);
		cong_mul_(mod_(add_(c, as_elem(76)), m), mul_(b, b), mod_(add_(as_elem(76), c), m), mul_(b, b));
		lemma_eq_sym(mod_(add_(as_elem(76), c), m), mod_(add_(c, as_elem(76)), m));
		cong_mod_(add_(as_elem(76), c), m, add_(c, as_elem(76)), m);
		lemma_eq_ref(m);
	}
	let temp_16_0 = (sub_((mul_(a, c)), (mul_(a, c))));
	let temp_16_1 = (sub_((mul_(a, c)), (mul_(c, a))));
	assert(eq_(temp_16_0, temp_16_1)) by {
		cong_sub_(mul_(a, c), mul_(a, c), mul_(a, c), mul_(c, a));
		lemma_mul_comm(a, c);
	...
	assert(eq_(temp_17_0, temp_17_1)) by {
		lemma_mul_comm(a, d);
		cong_sub_(sub_(c, mod_(c, m)), mod_(mul_(a, d), m), sub_(c, mod_(c, m)), mod_(mul_(d, a), m));
	...
	assert(eq_(temp_19_0, temp_19_1)) by {
		lemma_mod_mul_vanish(d, mul_(mul_(c, a), mul_(d, a)), m);
		cong_mod_(mul_(mul_(mod_(a, m), a), mul_(b, mod_(d, m))), m, mul_(mul_(mod_(a, m), a), mul_(b, mod_(sub_(d, mul_(mul_(mul_(c, a), mul_(d, a)), m)), m))), m);
		lemma_eq_ref(b);
		lemma_eq_ref(mul_(mod_(a, m), a));
		cong_mul_(mul_(mod_(a, m), a), mul_(b, mod_(d, m)), mul_(mod_(a, m), a), mul_(b, mod_(sub_(d, mul_(mul_(mul_(c, a), mul_(d, a)), m)), m)));
		cong_mul_(b, mod_(d, m), b, mod_(sub_(d, mul_(mul_(mul_(c, a), mul_(d, a)), m)), m));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_21_0, temp_21_1)) by {
		lemma_mod_mul_vanish(sub_(mod_(d, m), d), mul_(mul_(c, a), sub_(a, b)), m);
		cong_mul_(mul_(b, mod_(a, m)), mod_(sub_(mod_(d, m), d), m), mul_(b, mod_(a, m)), mod_(add_(mul_(mul_(mul_(c, a), sub_(a, b)), m), sub_(mod_(d, m), d)), m));
	...
	assert(eq_(temp_22_0, temp_22_1)) by {
		lemma_mul_comm(c, a);
		cong_add_(mul_(c, a), mod_(mul_(mod_(d, m), b), m), mul_(a, c), mod_(mul_(mod_(d, m), b), m));
		lemma_eq_ref(mod_(mul_(mod_(d, m), b), m));
	}
	...
	assert(eq_(temp_23_0, temp_23_1)) by {
		lemma_mod_mul_vanish(a, mul_(mul_(a, a), sub_(a, a)), m);
		cong_mul_(mul_(mod_(a, m), b), mul_(a, b), mul_(mod_(add_(a, mul_(mul_(mul_(a, a), sub_(a, a)), m)), m), b), mul_(a, b));
		lemma_eq_ref(b);
		cong_mul_(mod_(a, m), b, mod_(add_(a, mul_(mul_(mul_(a, a), sub_(a, a)), m)), m), b);
		lemma_eq_ref(mul_(a, b));
	}
	...
	assert(eq_(temp_26_0, temp_26_1)) by {
		cong_add_(mul_(b, b), mod_(sub_(mod_(c, m), b), m), mul_(b, b), mod_(sub_(mod_(mod_(c, m), m), b), m));
	...
	assert(eq_(temp_27_0, temp_27_1)) by {
		lemma_mul_comm(c, c);
		lemma_mod_mul_vanish(mul_(b, c), mul_(sub_(d, c), add_(b, b)), m);
		cong_mul_(mul_(c, c), mod_(mul_(b, c), m), mul_(c, c), mod_(add_(mul_(mul_(sub_(d, c), add_(b, b)), m), mul_(b, c)), m));
	}
	let temp_28_0 = (sub_((mul_(a, b)), (add_((mod_(a, m)), d))));
	let temp_28_1 = (sub_((mul_(b, a)), (add_((mod_(a, m)), d))));
	assert(eq_(temp_28_0, temp_28_1)) by {
		lemma_mul_comm(a, b);
		cong_sub_(mul_(a, b), add_(mod_(a, m), d), mul_(b, a), add_(mod_(a, m), d));
		lemma_eq_ref(add_(mod_(a, m), d));
	}
	let temp_29_0 = (sub_((mul_(a, c)), (mul_(d, b))));
	let temp_29_1 = (sub_((mul_(a, c)), (mul_(b, d))));
	assert(eq_(temp_29_0, temp_29_1)) by {
		cong_sub_(mul_(a, c), mul_(d, b), mul_(a, c), mul_(b, d));
		lemma_mul_comm(d, b);
		lemma_eq_ref(mul_(a, c));
	}
	...
	assert(eq_(temp_30_0, temp_30_1)) by {
		...
		cong_mul_(mul_(mod_(c, m), d), mod_(mul_(b, d), m), mul_(mod_(add_(mul_(mul_(mul_(a, a), mul_(d, b)), m), c), m), d), mod_(mul_(b, d), m));
		lemma_eq_ref(d);
		cong_mul_(mod_(c, m), d, mod_(add_(mul_(mul_(mul_(a, a), mul_(d, b)), m), c), m), d);
	...
	assert(eq_(temp_34_0, temp_34_1)) by {
		lemma_mod_mul_vanish(d, mul_(mul_(mod_(b, m), a), sub_(c, mod_(c, m))), m);
		cong_mul_(mul_(c, mod_(d, m)), mul_(a, d), mul_(c, mod_(add_(mul_(mul_(mul_(mod_(b, m), a), sub_(c, mod_(c, m))), m), d), m)), mul_(a, d));
		lemma_eq_ref(c);
		cong_mul_(c, mod_(d, m), c, mod_(add_(mul_(mul_(mul_(mod_(b, m), a), sub_(c, mod_(c, m))), m), d), m));
		lemma_eq_ref(mul_(a, d));
	}
	let temp_35_0 = (mul_((mul_(b, (mod_(c, m)))), (sub_(d, a))));
	let temp_35_1 = (mul_(b, (mul_((mod_(c, m)), (sub_(d, a))))));
	assert(eq_(temp_35_0, temp_35_1)) by {
		lemma_mul_assoc(b, mod_(c, m), sub_(d, a));
	...
	assert(eq_(temp_37_0, temp_37_1)) by {
		lemma_mul_dist(mod_(mul_(mod_(b, m), d), m), a, c);
	}
	...
	assert(eq_(temp_38_0, temp_38_1)) by {
		lemma_mod_mul_vanish(mul_(d, a), mul_(mul_(a, b), mul_(a, c)), m);
		cong_mul_(mod_(mul_(d, a), m), add_(c, b), mod_(add_(mul_(mul_(mul_(a, b), mul_(a, c)), m), mul_(d, a)), m), add_(c, b));
	...
	assert(eq_(temp_41_0, temp_41_1)) by {
		lemma_mul_dist(mod_(mul_(mod_(d, m), b), m), b, c);
		cong_mod_(mul_(sub_(b, c), mod_(mul_(mod_(d, m), b), m)), m, sub_(mul_(b, mod_(mul_(mod_(d, m), b), m)), mul_(c, mod_(mul_(mod_(d, m), b), m))), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_42_0, temp_42_1)) by {
		lemma_add_comm(b, b);
		lemma_mod_mul_vanish(add_(b, b), mul_(mul_(c, d), mul_(b, c)), m);
		cong_mod_(mul_(mod_(add_(b, b), m), add_(b, b)), m, mul_(mod_(add_(add_(b, b), mul_(mul_(mul_(c, d), mul_(b, c)), m)), m), add_(b, b)), m);
		lemma_eq_ref(m);
		cong_mul_(mod_(add_(b, b), m), add_(b, b), mod_(add_(add_(b, b), mul_(mul_(mul_(c, d), mul_(b, c)), m)), m), add_(b, b));
	}
	...
	assert(eq_(temp_43_0, temp_43_1)) by {
		lemma_mul_comm(c, c);
		lemma_mul_comm(c, d);
		cong_sub_(mul_(c, c), mod_(mul_(c, d), m), mul_(c, c), mod_(mul_(d, c), m));
	...
	assert(eq_(temp_44_0, temp_44_1)) by {
		lemma_mod_mul_vanish(a, mul_(mul_(c, a), mod_(add_(c, a), m)), m);
		cong_sub_(mul_(mod_(a, m), c), mul_(b, a), mul_(mod_(add_(mul_(mul_(mul_(c, a), mod_(add_(c, a), m)), m), a), m), c), mul_(b, a));
		lemma_eq_ref(c);
		cong_mul_(mod_(a, m), c, mod_(add_(mul_(mul_(mul_(c, a), mod_(add_(c, a), m)), m), a), m), c);
		lemma_eq_ref(mul_(b, a));
	}
	let temp_45_0 = (mul_((mul_(as_elem(62), c)), (mul_(d, b))));
	let temp_45_1 = (mul_((mul_(d, b)), (mul_(as_elem(62), c))));
	assert(eq_(temp_45_0, temp_45_1)) by {
		lemma_mul_comm(mul_(as_elem(62), c), mul_(d, b));
	}
	...
	assert(eq_(temp_51_0, temp_51_1)) by {
		lemma_mul_comm(b, d);
		cong_mul_(mul_(b, d), mul_(as_elem(97), a), mul_(d, b), mul_(as_elem(97), a));
		lemma_eq_ref(mul_(as_elem(97), a));
	}
	let temp_52_0 = (mul_((mul_(c, a)), (mod_((mul_(b, d)), m))));
	let temp_52_1 = (mul_((mod_((mul_(b, d)), m)), (mul_(c, a))));
	assert(eq_(temp_52_0, temp_52_1)) by {
		lemma_mul_comm(mul_(c, a), mod_(mul_(b, d), m));
	}
	let temp_53_0 = (mul_((mul_(b, d)), (add_(d, a))));
	let temp_53_1 = (mul_((mul_(b, d)), (add_(a, d))));
	assert(eq_(temp_53_0, temp_53_1)) by {
		cong_mul_(mul_(b, d), add_(d, a), mul_(b, d), add_(a, d));
		lemma_add_comm(d, a);
		lemma_eq_ref(mul_(b, d));
	}
	...
	assert(eq_(temp_55_0, temp_55_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(d, mod_(b, m)), mul_(d, mod_(a, m))), mul_(mul_(d, a), mul_(d, b)), m);
	}
	let temp_56_0 = (mul_((mod_((add_(d, c)), m)), (add_(d, a))));
	let temp_56_1 = (add_((mul_((mod_((add_(d, c)), m)), d)), (mul_((mod_((add_(d, c)), m)), a))));
	assert(eq_(temp_56_0, temp_56_1)) by {
		lemma_mul_dist(mod_(add_(d, c), m), d, a);
	}
	...
	assert(eq_(temp_58_0, temp_58_1)) by {
		cong_mul_(sub_(a, a), mul_(b, as_elem(6)), sub_(a, a), mul_(as_elem(6), b));
		lemma_mul_comm(b, as_elem(6));
		lemma_eq_ref(sub_(a, a));
	}
	let temp_59_0 = (mul_((mul_(c, (mod_(a, m)))), (mul_(d, a))));
	let temp_59_1 = (mul_((mul_((mul_(c, (mod_(a, m)))), d)), a));
	assert(eq_(temp_59_0, temp_59_1)) by {
		lemma_mul_assoc(mul_(c, mod_(a, m)), d, a);
	}
	...
	assert(eq_(temp_63_0, temp_63_1)) by {
		lemma_mod_mul_vanish(c, mul_(mul_(c, a), mul_(d, c)), m);
		cong_mul_(mul_(c, a), mul_(b, mod_(c, m)), mul_(c, a), mul_(b, mod_(add_(mul_(mul_(mul_(c, a), mul_(d, c)), m), c), m)));
		lemma_eq_ref(mul_(c, a));
		lemma_eq_ref(b);
		cong_mul_(b, mod_(c, m), b, mod_(add_(mul_(mul_(mul_(c, a), mul_(d, c)), m), c), m));
	}
	let temp_64_0 = (mul_((mod_((mul_(d, (mod_(c, m)))), m)), (mul_(a, d))));
	let temp_64_1 = (mul_((mod_((mul_(d, (mod_(c, m)))), m)), (mul_(d, a))));
	assert(eq_(temp_64_0, temp_64_1)) by {
		lemma_mul_comm(a, d);
		cong_mul_(mod_(mul_(d, mod_(c, m)), m), mul_(a, d), mod_(mul_(d, mod_(c, m)), m), mul_(d, a));
	...
	assert(eq_(temp_67_0, temp_67_1)) by {
		lemma_add_comm(mod_(mul_(d, b), m), mul_(b, b));
	}
	...
	assert(eq_(temp_71_0, temp_71_1)) by {
		lemma_mul_assoc(d, mod_(b, m), mul_(a, b));
	...
	assert(eq_(temp_73_0, temp_73_1)) by {
		lemma_mod_mul_vanish(mul_(b, mul_(as_elem(49), a)), mul_(mul_(d, mod_(a, m)), a), m);
	}
	...
	assert(eq_(temp_76_0, temp_76_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(b, as_elem(12)), sub_(d, b)), add_(mul_(a, b), mul_(a, mod_(c, m))), m);
	}
	...
	assert(eq_(temp_77_0, temp_77_1)) by {
		lemma_mul_comm(d, d);
		lemma_mod_mul_vanish(d, add_(mul_(mod_(d, m), b), mod_(mul_(c, b), m)), m);
		cong_mul_(mul_(mod_(d, m), b), mul_(d, d), mul_(mod_(add_(d, mul_(add_(mul_(mod_(d, m), b), mod_(mul_(c, b), m)), m)), m), b), mul_(d, d));
		lemma_eq_ref(b);
		cong_mul_(mod_(d, m), b, mod_(add_(d, mul_(add_(mul_(mod_(d, m), b), mod_(mul_(c, b), m)), m)), m), b);
	}
	...
	assert(eq_(temp_78_0, temp_78_1)) by {
		...
		cong_mul_(mod_(add_(c, c), m), mul_(b, mod_(a, m)), mod_(add_(c, c), m), mul_(mod_(a, m), b));
		lemma_eq_ref(mod_(add_(c, c), m));
	}
	let temp_79_0 = (mul_((mul_(a, a)), c));
	let temp_79_1 = (mul_(c, (mul_(a, a))));
	assert(eq_(temp_79_0, temp_79_1)) by {
		lemma_mul_comm(mul_(a, a), c);
	}
	...
	assert(eq_(temp_82_0, temp_82_1)) by {
		lemma_mod_mul_vanish(b, mul_(mul_(a, d), mul_(b, d)), m);
		cong_add_(mul_(a, mod_(b, m)), mul_(as_elem(62), a), mul_(a, mod_(add_(b, mul_(mul_(mul_(a, d), mul_(b, d)), m)), m)), mul_(as_elem(62), a));
		lemma_eq_ref(a);
		cong_mul_(a, mod_(b, m), a, mod_(add_(b, mul_(mul_(mul_(a, d), mul_(b, d)), m)), m));
		lemma_eq_ref(mul_(as_elem(62), a));
	}
	let temp_83_0 = (mul_((sub_(a, d)), (sub_(c, d))));
	let temp_83_1 = (mul_((sub_(c, d)), (sub_(a, d))));
	assert(eq_(temp_83_0, temp_83_1)) by {
		lemma_mul_comm(sub_(a, d), sub_(c, d));
	}
	...
	assert(eq_(temp_86_0, temp_86_1)) by {
		lemma_mod_mul_vanish(a, mul_(mul_(b, c), mul_(d, a)), m);
		cong_mul_(mul_(d, mod_(a, m)), mul_(b, c), mul_(d, mod_(add_(a, mul_(mul_(mul_(b, c), mul_(d, a)), m)), m)), mul_(b, c));
		lemma_eq_ref(d);
		cong_mul_(d, mod_(a, m), d, mod_(add_(a, mul_(mul_(mul_(b, c), mul_(d, a)), m)), m));
	...
	assert(eq_(temp_90_0, temp_90_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(b, c), mul_(b, a)), mul_(sub_(c, b), mul_(d, d)), m);
	}
	let temp_91_0 = (mul_((mul_(b, c)), (mul_(c, (mod_(b, m))))));
	let temp_91_1 = (mul_((mul_(c, b)), (mul_(c, (mod_(b, m))))));
	assert(eq_(temp_91_0, temp_91_1)) by {
		cong_mul_(mul_(b, c), mul_(c, mod_(b, m)), mul_(c, b), mul_(c, mod_(b, m)));
		lemma_mul_comm(b, c);
	...
	assert(eq_(temp_93_0, temp_93_1)) by {
		...
		cong_add_(sub_(b, mod_(c, m)), mul_(d, mod_(b, m)), sub_(b, mod_(add_(mul_(mul_(mul_(d, c), mul_(a, b)), m), c), m)), mul_(d, mod_(b, m)));
		cong_sub_(b, mod_(c, m), b, mod_(add_(mul_(mul_(mul_(d, c), mul_(a, b)), m), c), m));
	...
	assert(eq_(temp_94_0, temp_94_1)) by {
		cong_mul_(mul_(d, c), mul_(mod_(c, m), c), mul_(c, d), mul_(mod_(c, m), c));
		lemma_mul_comm(d, c);
	...
	assert(eq_(temp_95_0, temp_95_1)) by {
		lemma_mul_assoc(b, mod_(d, m), mul_(d, mod_(a, m)));
	...
	assert(eq_(temp_97_0, temp_97_1)) by {
		lemma_mod_mul_vanish(a, mul_(mul_(c, c), mod_(sub_(b, d), m)), m);
		cong_mod_(mul_(mul_(d, b), mul_(d, mod_(a, m))), m, mul_(mul_(d, b), mul_(d, mod_(sub_(a, mul_(mul_(mul_(c, c), mod_(sub_(b, d), m)), m)), m))), m);
		lemma_eq_ref(mul_(d, b));
		lemma_eq_ref(d);
		cong_mul_(mul_(d, b), mul_(d, mod_(a, m)), mul_(d, b), mul_(d, mod_(sub_(a, mul_(mul_(mul_(c, c), mod_(sub_(b, d), m)), m)), m)));
		cong_mul_(d, mod_(a, m), d, mod_(sub_(a, mul_(mul_(mul_(c, c), mod_(sub_(b, d), m)), m)), m));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_98_0, temp_98_1)) by {
		lemma_mul_comm(d, d);
		lemma_mod_mul_vanish(a, mul_(sub_(b, b), mul_(mod_(b, m), a)), m);
		cong_mul_(mul_(d, d), mul_(mod_(a, m), b), mul_(d, d), mul_(mod_(add_(a, mul_(mul_(sub_(b, b), mul_(mod_(b, m), a)), m)), m), b));
		cong_mul_(mod_(a, m), b, mod_(add_(a, mul_(mul_(sub_(b, b), mul_(mod_(b, m), a)), m)), m), b);
		lemma_eq_ref(b);
	}
	...
	assert(eq_(temp_102_0, temp_102_1)) by {
		lemma_mul_assoc(mod_(c, m), b, mul_(as_elem(64), a));
	...
	assert(eq_(temp_104_0, temp_104_1)) by {
		lemma_mul_assoc(mod_(a, m), b, add_(mod_(a, m), mod_(b, m)));
	...
	assert(eq_(temp_105_0, temp_105_1)) by {
		lemma_mod_mul_vanish(mul_(mod_(a, m), mod_(a, m)), mul_(mul_(b, a), mul_(d, mod_(a, m))), m);
		cong_mul_(mul_(b, mod_(as_elem(31), m)), mod_(mul_(mod_(a, m), mod_(a, m)), m), mul_(b, mod_(as_elem(31), m)), mod_(add_(mul_(mod_(a, m), mod_(a, m)), mul_(mul_(mul_(b, a), mul_(d, mod_(a, m))), m)), m));
		lemma_eq_ref(mul_(b, mod_(as_elem(31), m)));
	}
	...
	assert(eq_(temp_107_0, temp_107_1)) by {
		lemma_mul_comm(c, b);
		cong_mul_(mul_(c, b), sub_(d, as_elem(69)), mul_(b, c), sub_(d, as_elem(69)));
