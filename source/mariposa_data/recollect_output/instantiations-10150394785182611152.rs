...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_associative((b0 * (b0 * d0)) + (a0 * (b0 * d0)), (45 * a0) * (a0 * c0), ((d0 * c0) * (b0 * 68)) - ((c0 * c0) * (b0 * d0)));
		lemma_mul_is_distributive(b0, a0, b0 * d0);
		lemma_mul_is_associative((b0 + a0) * (b0 * d0), (45 * a0) * (a0 * c0), ((d0 * c0) * (b0 * 68)) - ((c0 * c0) * (b0 * d0)));
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		...
		lemma_mul_is_associative(((a2 + b2) * (b2 * c2)) * ((c2 * d2) - (a2 * d2)), (b2 * c2) * (c2 * b2), d2 * (b2 * c2));
		lemma_mul_is_associative(((a2 + b2) * (b2 * c2)) * ((c2 * d2) - (a2 * d2)), (b2 * c2) * (c2 * b2), d2 * (c2 * b2));
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_distributive(a3 * b3, d3, c3);
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_commutative(a4 * a4, b4 - c4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_associative((c5 * b5) * (a5 * c5), c5 * c5, d5 * c5);
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_commutative(35, d6);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		...
		lemma_mul_is_associative(((b7 * c7) * (d7 * c7)) * ((d7 - c7) * a7), (c7 * 95) * (c7 * a7), (d7 * b7) - (a7 * c7));
		lemma_mul_is_associative(((b7 * c7) * (d7 * c7)) * ((d7 - c7) * a7), (c7 * 95) * (c7 * a7), (b7 * d7) - (a7 * c7));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_associative((b8 * d8) * (19 * b8), c8 - a8, b8 - b8);
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_associative(b9 + c9, c9 * a9, (d9 * c9) * (c9 - c9));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_commutative(a10, d10 * c10);
		lemma_mul_is_associative(((a10 * c10) * (d10 * d10)) * ((c10 * c10) * (c10 * c10)), (d10 * a10) * c10, a10 * (d10 * c10));
		lemma_mul_is_associative(((a10 * c10) * (d10 * d10)) * ((c10 * c10) * (c10 * c10)), (d10 * a10) * c10, (d10 * c10) * a10);
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_commutative((a11 * b11) + (c11 - b11), (a11 * a11) * (c11 + d11));
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_commutative((a14 + b14) * (c14 * c14), (a14 * b14) + (b14 - c14));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_associative(b15, c15, d15 * c15);
		lemma_mul_is_associative(b15 * (c15 * (d15 * c15)), (b15 * c15) * (c15 * b15), ((a15 * c15) * (b15 * c15)) * ((c15 * a15) * (b15 * 27)));
		lemma_mul_is_associative((b15 * c15) * (d15 * c15), (b15 * c15) * (c15 * b15), ((a15 * c15) * (b15 * c15)) * ((c15 * a15) * (b15 * 27)));
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_distributive(((79 * a16) * (a16 * d16)) * ((d16 * c16) * (b16 * c16)), (d16 * d16) + (a16 * a16), (a16 - c16) * (b16 * d16));
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		...
		lemma_mul_is_associative(c17 * d17, b17 * b17, (c17 * d17) * (b17 * c17));
		lemma_mul_is_associative(d17 * c17, b17 * b17, (c17 * d17) * (b17 * c17));
	}
	...
	assert(temp_19_0 == temp_19_1) by {
		lemma_mul_is_commutative(c19 + a19, b19 * b19);
	}
	...
	assert(temp_20_0 == temp_20_1) by {
		lemma_mul_is_associative(d20 * a20, c20, c20);
	}
	...
	assert(temp_21_0 == temp_21_1) by {
		lemma_mul_is_associative((a21 * (d21 + a21)) - (d21 * (d21 + a21)), (b21 * a21) * (c21 * a21), ((a21 * d21) * (d21 * a21)) * (d21 * (c21 * d21)));
		lemma_mul_is_distributive(a21, d21, d21 + a21);
		lemma_mul_is_associative((a21 - d21) * (d21 + a21), (b21 * a21) * (c21 * a21), ((a21 * d21) * (d21 * a21)) * (d21 * (c21 * d21)));
	}
