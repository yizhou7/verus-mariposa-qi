...
pub proof fn free_0(a: Elem, b: Elem, c: Elem, d: Elem, m: Elem)
{
	...
	assert(eq_(temp_9_0, temp_9_1)) by {
		lemma_mod_mul_vanish(mul_(c, b), mul_(mod_(add_(d, b), m), mul_(a, a)), m);
		cong_add_(mod_(mul_(c, b), m), sub_(c, c), mod_(sub_(mul_(c, b), mul_(mul_(mod_(add_(d, b), m), mul_(a, a)), m)), m), sub_(c, c));
	...
	assert(eq_(temp_12_0, temp_12_1)) by {
		cong_sub_(mul_(d, b), mul_(c, d), mul_(b, d), mul_(c, d));
		lemma_mul_comm(d, b);
	...
	assert(eq_(temp_15_0, temp_15_1)) by {
		cong_mul_(a, mod_(d, m), a, mod_(sub_(d, mul_(mul_(sub_(b, b), mul_(a, c)), m)), m));
		lemma_eq_ref(sub_(c, b));
		lemma_eq_ref(a);
		lemma_mod_mul_vanish(d, mul_(sub_(b, b), mul_(a, c)), m);
		cong_mul_(mul_(a, mod_(d, m)), sub_(c, b), mul_(a, mod_(sub_(d, mul_(mul_(sub_(b, b), mul_(a, c)), m)), m)), sub_(c, b));
	}
	...
	assert(eq_(temp_22_0, temp_22_1)) by {
		lemma_mul_comm(mul_(c, b), mul_(c, mod_(a, m)));
	}
	...
	assert(eq_(temp_23_0, temp_23_1)) by {
		lemma_mul_assoc(mul_(mod_(c, m), a), as_elem(8), d);
		cong_mod_(mul_(mul_(mod_(c, m), a), mul_(as_elem(8), d)), m, mul_(mul_(mul_(mod_(c, m), a), as_elem(8)), d), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_24_0, temp_24_1)) by {
		lemma_mul_comm(d, a);
		cong_mod_(mul_(mul_(a, b), mul_(d, a)), m, mul_(mul_(a, b), mul_(a, d)), m);
	...
	assert(eq_(temp_25_0, temp_25_1)) by {
		lemma_mul_assoc(mod_(mul_(b, d), m), d, b);
	}
	...
	assert(eq_(temp_27_0, temp_27_1)) by {
		lemma_mul_comm(c, a);
		cong_mul_(mul_(c, a), mul_(b, mod_(a, m)), mul_(a, c), mul_(b, mod_(a, m)));
		lemma_eq_ref(mul_(b, mod_(a, m)));
	}
	let temp_28_0 = (mod_((add_((mul_(a, d)), (add_(d, d)))), m));
	let temp_28_1 = (mod_((add_((add_(d, d)), (mul_(a, d)))), m));
	assert(eq_(temp_28_0, temp_28_1)) by {
		lemma_add_comm(mul_(a, d), add_(d, d));
		cong_mod_(add_(mul_(a, d), add_(d, d)), m, add_(add_(d, d), mul_(a, d)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_29_0, temp_29_1)) by {
		...
		cong_mod_(mul_(mul_(c, b), mod_(mul_(b, a), m)), m, mul_(c, mul_(b, mod_(mul_(b, a), m))), m);
		lemma_eq_ref(m);
		lemma_eq_sym(mul_(c, mul_(b, mod_(mul_(b, a), m))), mul_(mul_(c, b), mod_(mul_(b, a), m)));
	}
	let temp_30_0 = (mod_((mul_((mul_(c, c)), b)), m));
	let temp_30_1 = (mod_((mul_(c, (mul_(c, b)))), m));
	assert(eq_(temp_30_0, temp_30_1)) by {
		cong_mod_(mul_(mul_(c, c), b), m, mul_(c, mul_(c, b)), m);
		lemma_mul_assoc(c, c, b);
		lemma_eq_sym(mul_(c, mul_(c, b)), mul_(mul_(c, c), b));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_31_0, temp_31_1)) by {
		lemma_mod_mul_vanish(sub_(mul_(a, d), mul_(as_elem(6), a)), sub_(mul_(a, c), mul_(b, d)), m);
	}
	...
	assert(eq_(temp_32_0, temp_32_1)) by {
		lemma_mul_comm(b, b);
		lemma_mod_mul_vanish(mul_(b, d), mul_(mul_(c, a), mul_(a, d)), m);
		cong_mul_(mod_(mul_(b, d), m), mul_(b, b), mod_(add_(mul_(b, d), mul_(mul_(mul_(c, a), mul_(a, d)), m)), m), mul_(b, b));
	}
	let temp_33_0 = (mul_((add_(c, d)), (mul_((mod_(b, m)), c))));
	let temp_33_1 = (add_((mul_(c, (mul_((mod_(b, m)), c)))), (mul_(d, (mul_((mod_(b, m)), c))))));
	assert(eq_(temp_33_0, temp_33_1)) by {
		lemma_mul_dist(c, d, mul_(mod_(b, m), c));
	}
	...
	assert(eq_(temp_38_0, temp_38_1)) by {
		cong_mul_(mul_(c, mod_(c, m)), mul_(b, c), mul_(c, mod_(c, m)), mul_(c, b));
		lemma_mul_comm(b, c);
	...
	assert(eq_(temp_39_0, temp_39_1)) by {
		cong_mul_(mul_(d, mod_(d, m)), mul_(d, a), mul_(mod_(d, m), d), mul_(d, a));
	...
	assert(eq_(temp_44_0, temp_44_1)) by {
		lemma_mul_dist(add_(b, b), b, as_elem(78));
	}
	let temp_45_0 = (mul_((sub_(c, b)), (mul_(b, a))));
	let temp_45_1 = (mul_((sub_(c, b)), (mul_(a, b))));
	assert(eq_(temp_45_0, temp_45_1)) by {
		cong_mul_(sub_(c, b), mul_(b, a), sub_(c, b), mul_(a, b));
		lemma_mul_comm(b, a);
		lemma_eq_ref(sub_(c, b));
	}
	...
	assert(eq_(temp_46_0, temp_46_1)) by {
		lemma_mul_dist(mul_(mod_(a, m), d), b, a);
	}
	let temp_47_0 = (mul_((sub_(c, d)), (add_(d, a))));
	let temp_47_1 = (mul_((sub_(c, d)), (add_(a, d))));
	assert(eq_(temp_47_0, temp_47_1)) by {
		cong_mul_(sub_(c, d), add_(d, a), sub_(c, d), add_(a, d));
		lemma_add_comm(d, a);
	...
	assert(eq_(temp_49_0, temp_49_1)) by {
		cong_mul_(add_(d, a), mul_(c, a), add_(a, d), mul_(c, a));
		lemma_add_comm(d, a);
	...
	assert(eq_(temp_52_0, temp_52_1)) by {
		...
		cong_mul_(mul_(mod_(c, m), c), mul_(a, b), mul_(c, mod_(c, m)), mul_(a, b));
		lemma_eq_ref(mul_(a, b));
	}
	let temp_53_0 = (sub_((mul_(c, b)), (mul_(a, c))));
	let temp_53_1 = (sub_((mul_(b, c)), (mul_(a, c))));
	assert(eq_(temp_53_0, temp_53_1)) by {
		cong_sub_(mul_(c, b), mul_(a, c), mul_(b, c), mul_(a, c));
		lemma_mul_comm(c, b);
	...
	assert(eq_(temp_54_0, temp_54_1)) by {
		...
		cong_mul_(add_(b, mod_(d, m)), sub_(a, c), add_(b, mod_(sub_(d, mul_(mul_(mul_(c, d), mul_(c, a)), m)), m)), sub_(a, c));
		cong_add_(b, mod_(d, m), b, mod_(sub_(d, mul_(mul_(mul_(c, d), mul_(c, a)), m)), m));
	...
	assert(eq_(temp_55_0, temp_55_1)) by {
		lemma_mod_mul_vanish(mul_(b, c), mul_(mul_(b, d), mod_(mul_(a, b), m)), m);
		cong_mul_(mul_(d, c), mod_(mul_(b, c), m), mul_(d, c), mod_(add_(mul_(mul_(mul_(b, d), mod_(mul_(a, b), m)), m), mul_(b, c)), m));
		lemma_eq_ref(mul_(d, c));
	}
	...
	assert(eq_(temp_57_0, temp_57_1)) by {
		lemma_mod_mul_vanish(mul_(add_(c, a), mul_(d, d)), mul_(mul_(b, c), mul_(b, mod_(d, m))), m);
	}
	...
	assert(eq_(temp_60_0, temp_60_1)) by {
		lemma_mod_mul_vanish(mul_(d, a), mul_(mul_(a, a), mul_(c, b)), m);
		cong_add_(mod_(b, m), mod_(mul_(d, a), m), mod_(b, m), mod_(add_(mul_(d, a), mul_(mul_(mul_(a, a), mul_(c, b)), m)), m));
	...
	assert(eq_(temp_62_0, temp_62_1)) by {
		cong_sub_(mul_(d, c), mul_(a, b), mul_(c, d), mul_(a, b));
		lemma_mul_comm(d, c);
		lemma_eq_ref(mul_(a, b));
	}
	...
	assert(eq_(temp_63_0, temp_63_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(c, a), sub_(d, b)), mul_(mul_(b, a), mul_(mod_(d, m), d)), m);
	}
	...
	assert(eq_(temp_65_0, temp_65_1)) by {
		cong_sub_(add_(b, d), mul_(a, a), add_(d, b), mul_(a, a));
		lemma_add_comm(b, d);
		lemma_mul_comm(a, a);
	}
	...
	assert(eq_(temp_66_0, temp_66_1)) by {
		lemma_mul_assoc(as_elem(81), mod_(c, m), sub_(d, c));
	...
	assert(eq_(temp_67_0, temp_67_1)) by {
		lemma_mul_assoc(mod_(mul_(a, c), m), mod_(d, m), b);
	}
	...
	assert(eq_(temp_68_0, temp_68_1)) by {
		...
		lemma_mod_mul_vanish(c, mul_(mul_(b, d), mul_(b, mod_(c, m))), m);
		cong_mul_(mul_(a, mod_(c, m)), mul_(mod_(a, m), mod_(a, m)), mul_(a, mod_(add_(c, mul_(mul_(mul_(b, d), mul_(b, mod_(c, m))), m)), m)), mul_(mod_(a, m), mod_(a, m)));
		lemma_eq_ref(a);
		cong_mul_(a, mod_(c, m), a, mod_(add_(c, mul_(mul_(mul_(b, d), mul_(b, mod_(c, m))), m)), m));
	}
	let temp_69_0 = (mul_((mul_(d, d)), (mul_(a, (mod_(c, m))))));
	let temp_69_1 = (mul_((mul_(a, (mod_(c, m)))), (mul_(d, d))));
	assert(eq_(temp_69_0, temp_69_1)) by {
		lemma_mul_comm(mul_(d, d), mul_(a, mod_(c, m)));
	}
	...
	assert(eq_(temp_71_0, temp_71_1)) by {
		lemma_eq_ref(c);
		lemma_add_comm(c, c);
		lemma_mod_mul_vanish(b, mul_(mul_(a, a), mul_(a, a)), m);
		cong_mul_(add_(c, c), mul_(mod_(b, m), c), add_(c, c), mul_(mod_(add_(b, mul_(mul_(mul_(a, a), mul_(a, a)), m)), m), c));
		cong_mul_(mod_(b, m), c, mod_(add_(b, mul_(mul_(mul_(a, a), mul_(a, a)), m)), m), c);
	}
	...
	assert(eq_(temp_76_0, temp_76_1)) by {
		...
		cong_mul_(mul_(a, c), mul_(b, mod_(d, m)), mul_(a, c), mul_(mod_(d, m), b));
		lemma_eq_ref(mul_(a, c));
	}
	...
	assert(eq_(temp_83_0, temp_83_1)) by {
		lemma_add_comm(mul_(c, mod_(d, m)), mul_(mod_(c, m), b));
	}
	...
	assert(eq_(temp_84_0, temp_84_1)) by {
		lemma_mod_mul_vanish(c, add_(mul_(a, as_elem(79)), mul_(d, b)), m);
		cong_mul_(mul_(b, mod_(c, m)), mul_(c, b), mul_(b, mod_(add_(mul_(add_(mul_(a, as_elem(79)), mul_(d, b)), m), c), m)), mul_(c, b));
		lemma_eq_ref(b);
		cong_mul_(b, mod_(c, m), b, mod_(add_(mul_(add_(mul_(a, as_elem(79)), mul_(d, b)), m), c), m));
		lemma_eq_ref(mul_(c, b));
	}
	...
	assert(eq_(temp_89_0, temp_89_1)) by {
		lemma_mul_comm(sub_(d, b), sub_(b, a));
	}
	...
	assert(eq_(temp_90_0, temp_90_1)) by {
		lemma_mod_mul_vanish(b, sub_(mul_(a, d), mod_(sub_(c, d), m)), m);
		cong_mul_(mul_(d, as_elem(68)), sub_(mod_(b, m), c), mul_(d, as_elem(68)), sub_(mod_(add_(mul_(sub_(mul_(a, d), mod_(sub_(c, d), m)), m), b), m), c));
		cong_sub_(mod_(b, m), c, mod_(add_(mul_(sub_(mul_(a, d), mod_(sub_(c, d), m)), m), b), m), c);
		lemma_eq_ref(mul_(d, as_elem(68)));
		lemma_eq_ref(c);
	}
	let temp_91_0 = (mul_((sub_(a, d)), (mul_(d, c))));
	let temp_91_1 = (mul_((sub_(a, d)), (mul_(c, d))));
	assert(eq_(temp_91_0, temp_91_1)) by {
		cong_mul_(sub_(a, d), mul_(d, c), sub_(a, d), mul_(c, d));
		lemma_mul_comm(d, c);
	...
	assert(eq_(temp_95_0, temp_95_1)) by {
		cong_mul_(add_(b, a), mul_(d, a), add_(a, b), mul_(d, a));
		lemma_add_comm(b, a);
		lemma_eq_ref(mul_(d, a));
	}
	...
	assert(eq_(temp_96_0, temp_96_1)) by {
		lemma_mul_comm(b, a);
		cong_sub_(mul_(mod_(b, m), c), mul_(b, a), mul_(mod_(b, m), c), mul_(a, b));
	...
	assert(eq_(temp_98_0, temp_98_1)) by {
		lemma_eq_ref(m);
		lemma_mul_assoc(b, b, add_(a, d));
		cong_mod_(mul_(mul_(b, b), add_(a, d)), m, mul_(b, mul_(b, add_(a, d))), m);
		lemma_eq_sym(mul_(b, mul_(b, add_(a, d))), mul_(mul_(b, b), add_(a, d)));
	}
	...
	assert(eq_(temp_101_0, temp_101_1)) by {
		cong_mul_(mul_(c, d), mul_(mod_(b, m), c), mul_(c, d), mul_(mod_(sub_(b, mul_(mod_(mul_(mul_(b, mod_(c, m)), mul_(a, b)), m), m)), m), c));
		lemma_mod_mul_vanish(b, mod_(mul_(mul_(b, mod_(c, m)), mul_(a, b)), m), m);
		lemma_eq_ref(c);
		cong_mul_(mod_(b, m), c, mod_(sub_(b, mul_(mod_(mul_(mul_(b, mod_(c, m)), mul_(a, b)), m), m)), m), c);
		lemma_eq_ref(mul_(c, d));
	}
	...
	assert(eq_(temp_102_0, temp_102_1)) by {
		lemma_mul_assoc(mod_(add_(a, c), m), d, c);
	}
	...
	assert(eq_(temp_106_0, temp_106_1)) by {
		lemma_mul_assoc(mod_(a, m), d, sub_(d, as_elem(54)));
	...
	assert(eq_(temp_107_0, temp_107_1)) by {
		lemma_mod_mul_vanish(b, mod_(mul_(mul_(c, a), b), m), m);
		cong_mul_(mul_(d, mod_(b, m)), mul_(d, c), mul_(d, mod_(add_(b, mul_(mod_(mul_(mul_(c, a), b), m), m)), m)), mul_(d, c));
		lemma_eq_ref(d);
		cong_mul_(d, mod_(b, m), d, mod_(add_(b, mul_(mod_(mul_(mul_(c, a), b), m), m)), m));
		lemma_eq_ref(mul_(d, c));
	}
	...
	assert(eq_(temp_111_0, temp_111_1)) by {
		lemma_mul_assoc(mod_(c, m), as_elem(76), mod_(add_(a, c), m));
	...
	assert(eq_(temp_115_0, temp_115_1)) by {
		cong_add_(mul_(c, b), mul_(d, a), mul_(b, c), mul_(d, a));
		lemma_mul_comm(c, b);
		lemma_eq_ref(mul_(d, a));
	}
	...
	assert(eq_(temp_116_0, temp_116_1)) by {
		lemma_mod_mul_noop(mul_(a, c), mul_(c, a), m);
	...
	assert(eq_(temp_117_0, temp_117_1)) by {
		lemma_mod_mul_vanish(mul_(c, a), add_(mod_(mul_(d, b), m), mul_(d, a)), m);
		cong_sub_(mul_(mod_(d, m), d), mod_(mul_(c, a), m), mul_(mod_(d, m), d), mod_(sub_(mul_(c, a), mul_(add_(mod_(mul_(d, b), m), mul_(d, a)), m)), m));
	...
	assert(eq_(temp_123_0, temp_123_1)) by {
		cong_sub_(mul_(b, a), mul_(d, b), mul_(b, a), mul_(b, d));
		lemma_mul_comm(d, b);
		lemma_eq_ref(mul_(b, a));
	}
	...
	assert(eq_(temp_127_0, temp_127_1)) by {
		lemma_mod_mul_vanish(a, mod_(mul_(mul_(b, c), mod_(sub_(c, c), m)), m), m);
		cong_mod_(mul_(mul_(b, mod_(a, m)), mul_(b, a)), m, mul_(mul_(b, mod_(add_(a, mul_(mod_(mul_(mul_(b, c), mod_(sub_(c, c), m)), m), m)), m)), mul_(b, a)), m);
		cong_mul_(mul_(b, mod_(a, m)), mul_(b, a), mul_(b, mod_(add_(a, mul_(mod_(mul_(mul_(b, c), mod_(sub_(c, c), m)), m), m)), m)), mul_(b, a));
		lemma_eq_ref(b);
		lemma_eq_ref(mul_(b, a));
		cong_mul_(b, mod_(a, m), b, mod_(add_(a, mul_(mod_(mul_(mul_(b, c), mod_(sub_(c, c), m)), m), m)), m));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_128_0, temp_128_1)) by {
		cong_mul_(mul_(d, c), mul_(c, mod_(d, m)), mul_(d, c), mul_(c, mod_(sub_(d, mul_(mul_(mul_(c, mod_(a, m)), sub_(c, mod_(b, m))), m)), m)));
		lemma_mod_mul_vanish(d, mul_(mul_(c, mod_(a, m)), sub_(c, mod_(b, m))), m);
		lemma_eq_ref(c);
		lemma_eq_ref(mul_(d, c));
		cong_mul_(c, mod_(d, m), c, mod_(sub_(d, mul_(mul_(mul_(c, mod_(a, m)), sub_(c, mod_(b, m))), m)), m));
	}
	...
	assert(eq_(temp_129_0, temp_129_1)) by {
		lemma_mod_sub_noop(mul_(c, c), sub_(b, a), m);
	}
	...
	assert(eq_(temp_133_0, temp_133_1)) by {
		lemma_mul_comm(d, d);
		lemma_mod_mul_vanish(mul_(a, d), mul_(mul_(mod_(d, m), d), add_(mod_(a, m), a)), m);
		cong_mul_(mul_(d, d), mod_(mul_(a, d), m), mul_(d, d), mod_(sub_(mul_(a, d), mul_(mul_(mul_(mod_(d, m), d), add_(mod_(a, m), a)), m)), m));
	}
	...
	assert(eq_(temp_134_0, temp_134_1)) by {
		lemma_mod_mul_vanish(a, mul_(add_(d, a), mul_(c, c)), m);
		cong_mul_(mul_(a, as_elem(91)), mul_(mod_(a, m), d), mul_(a, as_elem(91)), mul_(mod_(add_(a, mul_(mul_(add_(d, a), mul_(c, c)), m)), m), d));
		lemma_eq_ref(d);
		lemma_eq_ref(mul_(a, as_elem(91)));
		cong_mul_(mod_(a, m), d, mod_(add_(a, mul_(mul_(add_(d, a), mul_(c, c)), m)), m), d);
	}
	...
	assert(eq_(temp_138_0, temp_138_1)) by {
		lemma_mod_mul_vanish(b, add_(mul_(mod_(b, m), c), mul_(a, b)), m);
		cong_add_(mul_(c, b), mul_(b, mod_(b, m)), mul_(c, b), mul_(b, mod_(sub_(b, mul_(add_(mul_(mod_(b, m), c), mul_(a, b)), m)), m)));
		lemma_eq_ref(b);
		cong_mul_(b, mod_(b, m), b, mod_(sub_(b, mul_(add_(mul_(mod_(b, m), c), mul_(a, b)), m)), m));
		lemma_eq_ref(mul_(c, b));
	}
	...
	assert(eq_(temp_139_0, temp_139_1)) by {
		lemma_mul_comm(d, d);
		lemma_mod_mul_vanish(c, mul_(mul_(c, d), add_(c, d)), m);
		cong_sub_(mul_(d, d), sub_(mod_(c, m), mod_(b, m)), mul_(d, d), sub_(mod_(add_(mul_(mul_(mul_(c, d), add_(c, d)), m), c), m), mod_(b, m)));
		cong_sub_(mod_(c, m), mod_(b, m), mod_(add_(mul_(mul_(mul_(c, d), add_(c, d)), m), c), m), mod_(b, m));
		lemma_eq_ref(mod_(b, m));
	}
	...
	assert(eq_(temp_141_0, temp_141_1)) by {
		lemma_add_comm(mul_(d, a), mul_(mod_(c, m), a));
	}
	...
	assert(eq_(temp_142_0, temp_142_1)) by {
		lemma_mod_mul_vanish(d, mod_(mul_(mul_(c, a), mul_(b, d)), m), m);
		cong_add_(mul_(d, mod_(d, m)), mul_(a, d), mul_(d, mod_(sub_(d, mul_(mod_(mul_(mul_(c, a), mul_(b, d)), m), m)), m)), mul_(a, d));
		lemma_eq_ref(d);
		cong_mul_(d, mod_(d, m), d, mod_(sub_(d, mul_(mod_(mul_(mul_(c, a), mul_(b, d)), m), m)), m));
		lemma_eq_ref(mul_(a, d));
	}
	let temp_143_0 = (mul_((mul_(a, c)), c));
	let temp_143_1 = (mul_(a, (mul_(c, c))));
	assert(eq_(temp_143_0, temp_143_1)) by {
		lemma_eq_sym(temp_143_1, temp_143_0);
	...
	assert(eq_(temp_144_0, temp_144_1)) by {
		cong_add_(mul_(a, b), add_(d, b), mul_(b, a), add_(d, b));
		lemma_mul_comm(a, b);
	...
	assert(eq_(temp_145_0, temp_145_1)) by {
		lemma_mod_mul_vanish(sub_(add_(d, mod_(d, m)), mul_(a, c)), mul_(mul_(d, c), mod_(mul_(d, c), m)), m);
	}
	...
	assert(eq_(temp_149_0, temp_149_1)) by {
		lemma_mod_mul_vanish(b, mul_(mul_(a, a), mod_(add_(a, mod_(b, m)), m)), m);
		cong_mul_(mul_(mod_(b, m), mod_(as_elem(83), m)), mul_(b, c), mul_(mod_(add_(b, mul_(mul_(mul_(a, a), mod_(add_(a, mod_(b, m)), m)), m)), m), mod_(as_elem(83), m)), mul_(b, c));
		lemma_eq_ref(mod_(as_elem(83), m));
		cong_mul_(mod_(b, m), mod_(as_elem(83), m), mod_(add_(b, mul_(mul_(mul_(a, a), mod_(add_(a, mod_(b, m)), m)), m)), m), mod_(as_elem(83), m));
		lemma_eq_ref(mul_(b, c));
	}
	...
	assert(eq_(temp_150_0, temp_150_1)) by {
		...
		cong_mul_(mul_(mod_(c, m), d), add_(c, a), mul_(d, mod_(c, m)), add_(c, a));
	...
	assert(eq_(temp_154_0, temp_154_1)) by {
		lemma_mod_mul_vanish(a, mul_(add_(c, a), mul_(d, c)), m);
		cong_mul_(mul_(c, mod_(a, m)), mul_(d, c), mul_(c, mod_(sub_(a, mul_(mul_(add_(c, a), mul_(d, c)), m)), m)), mul_(d, c));
		lemma_eq_ref(c);
		cong_mul_(c, mod_(a, m), c, mod_(sub_(a, mul_(mul_(add_(c, a), mul_(d, c)), m)), m));
		lemma_eq_ref(mul_(d, c));
	}
	...
	assert(eq_(temp_155_0, temp_155_1)) by {
		...
		lemma_eq_sym(add_(d, mod_(a, m)), add_(mod_(a, m), d));
		lemma_eq_ref(mul_(d, a));
	}
	...
	assert(eq_(temp_157_0, temp_157_1)) by {
		lemma_eq_sym(temp_157_1, temp_157_0);
	...
	assert(eq_(temp_158_0, temp_158_1)) by {
		cong_add_(mul_(a, b), add_(b, a), mul_(b, a), add_(b, a));
		lemma_mul_comm(a, b);
	...
	assert(eq_(temp_159_0, temp_159_1)) by {
		lemma_mod_mul_vanish(b, sub_(mul_(d, b), mul_(mod_(a, m), c)), m);
		cong_mul_(mul_(mod_(b, m), a), sub_(d, b), mul_(mod_(add_(mul_(sub_(mul_(d, b), mul_(mod_(a, m), c)), m), b), m), a), sub_(d, b));
		lemma_eq_ref(a);
		cong_mul_(mod_(b, m), a, mod_(add_(mul_(sub_(mul_(d, b), mul_(mod_(a, m), c)), m), b), m), a);
