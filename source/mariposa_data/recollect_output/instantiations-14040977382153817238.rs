...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_associative(((a0 * b0) * (d0 * b0)) * ((b0 - a0) * (c0 * d0)), (d0 * 53) + (d0 * d0), (a0 - a0) * (a0 - b0));
	}
	let temp_1_0 = ((((a1*d1)*(a1+c1))*((d1+b1)*(b1-b1)))*(((c1*c1)*(d1*c1))*b1));
	let temp_1_1 = ((((d1+b1)*(b1-b1))*((a1*d1)*(a1+c1)))*(((c1*c1)*(d1*c1))*b1));
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_commutative((d1 + b1) * (b1 - b1), (a1 * d1) * (a1 + c1));
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_commutative(((c2 * b2) * (b2 * d2)) * ((a2 * a2) * (d2 * b2)), ((b2 * d2) * (c2 * d2)) * ((a2 * c2) * (d2 * b2)));
	}
	let temp_3_0 = ((((d3*d3)*c3)*((a3*b3)*(c3*b3)))*(((a3*a3)*(c3*a3))*((b3*a3)*d3)));
	let temp_3_1 = (((d3*d3)*c3)*(((a3*b3)*(c3*b3))*(((a3*a3)*(c3*a3))*((b3*a3)*d3))));
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_associative((d3 * d3) * c3, (a3 * b3) * (c3 * b3), ((a3 * a3) * (c3 * a3)) * ((b3 * a3) * d3));
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_associative(c4, a4, c4 - a4);
	}
