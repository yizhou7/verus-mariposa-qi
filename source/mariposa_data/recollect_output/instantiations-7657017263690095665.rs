...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_commutative(d0, c0 - (b0 - a0));
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_commutative(85 * c1, b1 + d1);
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		...
		lemma_mul_is_associative((d2 + d2) - (c2 * b2), (b2 - c2) * (a2 - c2), ((a2 * a2) * (a2 + a2)) - ((b2 * b2) * (b2 * b2)));
		lemma_mul_is_associative((d2 + d2) - (b2 * c2), (b2 - c2) * (a2 - c2), ((a2 * a2) * (a2 + a2)) - ((b2 * b2) * (b2 * b2)));
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_associative((3 * d3) + (a3 * c3), c3 * (a3 * a3), ((b3 * b3) * (d3 * c3)) + ((63 * d3) * (a3 * c3)));
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_associative(a4 * d4, b4 * a4, (a4 * d4) * (a4 + d4));
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_commutative((a5 * b5) * d5, (a5 * d5) * (c5 * c5));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_associative(d6, b6, 8 - b6);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_associative((a7 * c7) * (c7 + b7), (a7 * a7) * (d7 * a7), d7 * ((c7 * c7) - (d7 * a7)));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_commutative(((a8 * a8) + (b8 * c8)) * ((c8 * c8) * (a8 * a8)), ((c8 * c8) * (d8 * b8)) * ((b8 * d8) * (d8 * a8)));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_associative(((b9 + c9) * c9) * b9, (b9 - b9) * b9, ((b9 * b9) - (c9 * b9)) * (a9 * (18 * c9)));
		lemma_mul_is_associative(b9 + c9, c9, b9);
		lemma_mul_is_associative((b9 + c9) * (c9 * b9), (b9 - b9) * b9, ((b9 * b9) - (c9 * b9)) * (a9 * (18 * c9)));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_commutative(d10 * b10, c10 * c10);
		lemma_mul_is_associative(((b10 * b10) * (d10 * c10)) * ((d10 * a10) * c10), (b10 * d10) * (b10 * d10), (d10 * b10) * (c10 * c10));
		lemma_mul_is_associative(((b10 * b10) * (d10 * c10)) * ((d10 * a10) * c10), (b10 * d10) * (b10 * d10), (c10 * c10) * (d10 * b10));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_associative(a11, a11, c11);
		lemma_mul_is_associative(a11 * (a11 * c11), (d11 * c11) + (c11 * b11), (b11 * (c11 * b11)) * ((d11 * c11) * (d11 * a11)));
		lemma_mul_is_associative((a11 * a11) * c11, (d11 * c11) + (c11 * b11), (b11 * (c11 * b11)) * ((d11 * c11) * (d11 * a11)));
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_commutative(d13 + b13, d13 * d13);
		lemma_mul_is_associative(((a13 + a13) * (a13 * c13)) * b13, (a13 * d13) * (a13 - a13), (d13 + b13) * (d13 * d13));
		lemma_mul_is_associative(((a13 + a13) * (a13 * c13)) * b13, (a13 * d13) * (a13 - a13), (d13 * d13) * (d13 + b13));
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_commutative((d14 * a14) * (a14 * a14), b14);
	}
