...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_2_0 == temp_2_1) by {
		...
		lemma_mul_is_associative((b2 * d2) * (c2 * d2), (b2 - c2) * (a2 * a2), ((a2 + b2) * (d2 * a2)) * ((b2 + c2) * (c2 * b2)));
		lemma_mul_is_associative((b2 * d2) * (d2 * c2), (b2 - c2) * (a2 * a2), ((a2 + b2) * (d2 * a2)) * ((b2 + c2) * (c2 * b2)));
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_commutative(b3 * d3, b3 - d3);
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_associative(((d4 * c4) * (d4 * c4)) * ((b4 * d4) + (b4 + d4)), (d4 * d4) * (c4 + b4), ((d4 * a4) * b4) * d4);
		lemma_mul_is_associative(d4 * a4, b4, d4);
		lemma_mul_is_associative(((d4 * c4) * (d4 * c4)) * ((b4 * d4) + (b4 + d4)), (d4 * d4) * (c4 + b4), (d4 * a4) * (b4 * d4));
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_commutative(((c5 * a5) * (a5 * d5)) * ((a5 * b5) * (d5 * c5)), ((c5 * b5) - (b5 * d5)) * ((a5 + d5) * (c5 * c5)));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_associative(b6 * d6, b6, d6);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		...
		lemma_mul_is_associative(((d7 * d7) - (a7 * d7)) * (d7 * (c7 * 77)), (c7 + b7) + (d7 * d7), (c7 * d7) * (b7 * b7));
		lemma_mul_is_associative(((d7 * d7) - (a7 * d7)) * (d7 * (c7 * 77)), (c7 + b7) + (d7 * d7), (d7 * c7) * (b7 * b7));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_commutative((a8 * a8) - (c8 * d8), c8 * (d8 * b8));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_distributive(d9 * b9, d9, d9);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_associative(a13, (c13 * a13) * (b13 * d13), (b13 * c13) * (b13 * b13));
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_associative((b16 * a16) * (b16 * d16), (a16 * a16) - (d16 * a16), (a16 * (a16 * b16)) - b16);
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_associative(a17, a17, d17 * b17);
		lemma_mul_is_associative(a17 * (a17 * (d17 * b17)), a17, (b17 * 93) * d17);
		lemma_mul_is_associative((a17 * a17) * (d17 * b17), a17, (b17 * 93) * d17);
	}
