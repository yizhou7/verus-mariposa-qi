...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_associative(a2 * b2, c2, a2);
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_commutative(b4 * (b4 * a4), (c4 * d4) * (b4 * d4));
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_associative(d5 * d5, a5, a5);
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_associative(a6 * d6, d6, c6);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_associative(a7 * b7, c7 * c7, (a7 * d7) + (d7 * d7));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_commutative(d8, 81);
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_commutative(((b11 * a11) - (d11 - b11)) * ((b11 * c11) * (c11 * b11)), ((d11 * d11) - (c11 + c11)) + ((d11 * b11) * (c11 * c11)));
	}
