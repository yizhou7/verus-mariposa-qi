...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_associative(b0, c0, d0 - c0);
		lemma_mul_is_associative(b0 * (c0 * (d0 - c0)), (d0 * b0) * (c0 * c0), ((d0 * d0) + (b0 * b0)) * ((b0 * b0) * (b0 * c0)));
		lemma_mul_is_associative((b0 * c0) * (d0 - c0), (d0 * b0) * (c0 * c0), ((d0 * d0) + (b0 * b0)) * ((b0 * b0) * (b0 * c0)));
	}
	let temp_1_0 = ((((d1*a1)+(a1*c1))*((a1*a1)*(b1*d1)))*(((c1*d1)-(d1*b1))*a1));
	let temp_1_1 = ((((d1*a1)+(a1*c1))*(((a1*a1)*b1)*d1))*(((c1*d1)-(d1*b1))*a1));
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_associative(a1 * a1, b1, d1);
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		...
		lemma_mul_is_associative(b2 * a2, b2 + a2, (b2 - b2) + (d2 - c2));
		lemma_mul_is_associative(a2 * b2, b2 + a2, (b2 - b2) + (d2 - c2));
	}
	let temp_3_0 = ((((d3*a3)*c3)+((b3*d3)-(a3*d3)))*(((d3*a3)*(b3+d3))*((b3*b3)*(d3-a3))));
	let temp_3_1 = ((((d3*a3)*c3)+((b3*d3)-(a3*d3)))*(((d3*a3)*(b3+d3))*((d3-a3)*(b3*b3))));
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_commutative(d3 - a3, b3 * b3);
		lemma_mul_is_associative(((d3 * a3) * c3) + ((b3 * d3) - (a3 * d3)), (d3 * a3) * (b3 + d3), (d3 - a3) * (b3 * b3));
		lemma_mul_is_associative(((d3 * a3) * c3) + ((b3 * d3) - (a3 * d3)), (d3 * a3) * (b3 + d3), (b3 * b3) * (d3 - a3));
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		...
		lemma_mul_is_associative((a4 * c4) * (c4 * b4), a4 - d4, b4 * d4);
		lemma_mul_is_associative((a4 * c4) * (c4 * b4), a4 - d4, d4 * b4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		...
		lemma_mul_is_associative(d5 * a5, b5 - b5, (c5 * c5) * (a5 * b5));
		lemma_mul_is_associative(a5 * d5, b5 - b5, (c5 * c5) * (a5 * b5));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		...
		lemma_mul_is_associative(a6 * c6, b6 - c6, (d6 * d6) * (b6 * b6));
		lemma_mul_is_associative(c6 * a6, b6 - c6, (d6 * d6) * (b6 * b6));
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_commutative(d7 * b7, d7 * d7);
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_associative(((b8 * d8) * a8) - ((b8 * d8) * a8), (a8 * c8) * (d8 * a8), ((c8 * a8) - (c8 * b8)) * (b8 * (b8 * c8)));
		lemma_mul_is_distributive(b8 * d8, a8, a8);
		lemma_mul_is_associative((b8 * d8) * (a8 - a8), (a8 * c8) * (d8 * a8), ((c8 * a8) - (c8 * b8)) * (b8 * (b8 * c8)));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_commutative(((d10 * d10) * (c10 - c10)) * ((a10 * 71) * d10), ((94 * b10) * (b10 * c10)) + ((c10 * d10) * (a10 + b10)));
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_commutative(c12 + a12, b12 + a12);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_commutative((d13 * a13) * (b13 * a13), a13 + (c13 * c13));
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_associative((d14 * c14) * (d14 * c14), c14 * 4, c14 * a14);
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_associative(a15 * (c15 * a15), c15 * c15, a15 + d15);
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_associative(((b16 * a16) * d16) * c16, (c16 - b16) * (a16 * d16), ((c16 * d16) * (a16 + d16)) * (c16 + (a16 * a16)));
		lemma_mul_is_associative(b16 * a16, d16, c16);
		lemma_mul_is_associative((b16 * a16) * (d16 * c16), (c16 - b16) * (a16 * d16), ((c16 * d16) * (a16 + d16)) * (c16 + (a16 * a16)));
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_associative(((c17 * c17) * (d17 * a17)) * c17, (88 * c17) * c17, ((b17 - d17) * c17) * d17);
		lemma_mul_is_associative(b17 - d17, c17, d17);
		lemma_mul_is_associative(((c17 * c17) * (d17 * a17)) * c17, (88 * c17) * c17, (b17 - d17) * (c17 * d17));
	}
