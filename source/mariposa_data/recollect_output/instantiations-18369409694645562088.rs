...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_associative(d1, a1, b1 * c1);
		lemma_mul_is_associative(((a1 * c1) * (b1 * b1)) * ((a1 * a1) * (c1 * c1)), (a1 * b1) * (b1 * c1), d1 * (a1 * (b1 * c1)));
		lemma_mul_is_associative(((a1 * c1) * (b1 * b1)) * ((a1 * a1) * (c1 * c1)), (a1 * b1) * (b1 * c1), (d1 * a1) * (b1 * c1));
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_associative(((a2 * d2) * (d2 * b2)) * ((a2 * a2) * (a2 * d2)), (d2 * d2) * (c2 * c2), (a2 * d2) * (59 - b2));
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_associative(((d3 * d3) * (c3 * a3)) * ((a3 * a3) * (a3 * d3)), (a3 * c3) * (c3 * d3), (d3 * (a3 * a3)) - (d3 * (a3 * a3)));
		lemma_mul_is_distributive(d3, d3, a3 * a3);
		lemma_mul_is_associative(((d3 * d3) * (c3 * a3)) * ((a3 * a3) * (a3 * d3)), (a3 * c3) * (c3 * d3), (d3 - d3) * (a3 * a3));
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_associative((d4 * a4) * (a4 * b4), a4 * d4, b4 * b4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_associative(c5 * b5, a5 + d5, (b5 * c5) * (c5 * c5));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_commutative(d6 * c6, c6 * d6);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_commutative((a7 * c7) * (a7 * d7), (d7 * b7) - (d7 * c7));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_commutative((d8 * d8) * (a8 + a8), (a8 * b8) * (c8 * a8));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_associative(c10 - b10, d10, a10);
	}
