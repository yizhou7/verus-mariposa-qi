...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_associative(d0 - b0, b0, a0);
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_commutative(b4, a4);
		lemma_mul_is_associative(b4 * a4, d4 * c4, (c4 * d4) * (c4 * a4));
		lemma_mul_is_associative(a4 * b4, d4 * c4, (c4 * d4) * (c4 * a4));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_distributive(c6 * a6, d6, d6);
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		...
		lemma_mul_is_associative(c8 * a8, d8, a8 - (b8 * c8));
		lemma_mul_is_associative(a8 * c8, d8, a8 - (b8 * c8));
	}
	let temp_9_0 = ((((d9*b9)+(d9*a9))*((a9*c9)*(a9+b9)))*b9);
	let temp_9_1 = (((d9*(b9+a9))*((a9*c9)*(a9+b9)))*b9);
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_distributive(d9, b9, a9);
		lemma_mul_is_associative(d9 * (b9 + a9), (a9 * c9) * (a9 + b9), b9);
		lemma_mul_is_associative((d9 * b9) + (d9 * a9), (a9 * c9) * (a9 + b9), b9);
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_associative(((d10 * d10) * (c10 * d10)) - ((a10 * b10) - (a10 * d10)), c10 * (d10 * b10), ((d10 + b10) * d10) * d10);
		lemma_mul_is_associative(d10 + b10, d10, d10);
		lemma_mul_is_associative(((d10 * d10) * (c10 * d10)) - ((a10 * b10) - (a10 * d10)), c10 * (d10 * b10), (d10 + b10) * (d10 * d10));
	}
