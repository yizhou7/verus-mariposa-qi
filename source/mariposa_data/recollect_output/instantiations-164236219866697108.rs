...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_distributive(b0 * a0, c0, a0);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_commutative(a5, 9);
		lemma_mul_is_associative((a5 * 9) * (c5 * b5), (b5 * c5) * (d5 * a5), ((a5 * c5) * (c5 * c5)) * ((d5 * b5) - (b5 * b5)));
		lemma_mul_is_associative((9 * a5) * (c5 * b5), (b5 * c5) * (d5 * a5), ((a5 * c5) * (c5 * c5)) * ((d5 * b5) - (b5 * b5)));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_commutative(d6 * a6, b6);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		...
		lemma_mul_is_associative((d7 * b7) * (b7 * d7), (c7 * c7) - (a7 * a7), ((b7 * b7) * (b7 * c7)) * ((d7 * b7) - (d7 - b7)));
		lemma_mul_is_associative((d7 * b7) * (d7 * b7), (c7 * c7) - (a7 * a7), ((b7 * b7) * (b7 * c7)) * ((d7 * b7) - (d7 - b7)));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_commutative(b8 * c8, a8 * a8);
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		...
		lemma_mul_is_associative((c10 * d10) + (d10 * b10), c10, ((c10 + a10) - (c10 * a10)) + (c10 + (d10 - b10)));
		lemma_mul_is_associative((d10 * c10) + (d10 * b10), c10, ((c10 + a10) - (c10 * a10)) + (c10 + (d10 - b10)));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_commutative(c11 + c11, b11 * d11);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_commutative(d12 * d12, c12 * c12);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_associative(a13 * b13, c13, b13);
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_commutative(c14 * b14, d14 * c14);
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_commutative(57 * b15, d15 * a15);
		lemma_mul_is_associative(((d15 * a15) * (b15 * a15)) * (c15 + (b15 * c15)), (70 * a15) * (c15 * d15), (57 * b15) * (d15 * a15));
		lemma_mul_is_associative(((d15 * a15) * (b15 * a15)) * (c15 + (b15 * c15)), (70 * a15) * (c15 * d15), (d15 * a15) * (57 * b15));
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_associative(a16 - c16, d16, d16);
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_commutative(a17 * c17, c17 * a17);
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_commutative(((b18 * d18) * (d18 * c18)) * (b18 * (b18 * b18)), ((a18 * b18) * (a18 * b18)) * ((a18 + d18) * (c18 * c18)));
	}
	...
	assert(temp_19_0 == temp_19_1) by {
		lemma_mul_is_associative((c19 * b19) * (b19 * c19), (c19 * a19) * b19, ((b19 * d19) * (a19 + b19)) * ((b19 * d19) * (a19 * b19)));
	}
