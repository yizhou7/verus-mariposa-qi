...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_commutative(b0 * c0, c0 * c0);
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		...
		lemma_mul_is_associative(c1 * b1, 32 * c1, (a1 * a1) * (d1 * a1));
		lemma_mul_is_associative(b1 * c1, 32 * c1, (a1 * a1) * (d1 * a1));
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_commutative((d2 * c2) * (c2 * c2), (b2 * a2) * (a2 - b2));
	}
	let temp_3_0 = ((((c3*c3)*(d3*c3))-((b3*c3)*(c3*d3)))*(((a3+d3)+(a3*c3))*a3));
	let temp_3_1 = ((((a3+d3)+(a3*c3))*a3)*(((c3*c3)*(d3*c3))-((b3*c3)*(c3*d3))));
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_commutative(((a3 + d3) + (a3 * c3)) * a3, ((c3 * c3) * (d3 * c3)) - ((b3 * c3) * (c3 * d3)));
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_distributive(a4 * d4, b4, a4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_commutative(c5 + d5, b5 * d5);
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_commutative(b6 + a6, a6 - d6);
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		...
		lemma_mul_is_associative(((b8 * a8) * (d8 * d8)) * b8, c8, (c8 * a8) + (c8 * a8));
		lemma_mul_is_associative(((b8 * a8) * (d8 * d8)) * b8, c8, (c8 * a8) + (a8 * c8));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_distributive(d9, c9, d9 * d9);
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_distributive(c11, b11, c11);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_associative((d13 * d13) * (a13 * d13), c13 * c13, a13 * a13);
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_associative(d14 * d14, a14 * a14, b14 * (c14 * a14));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		...
		lemma_mul_is_associative(d15 * a15, d15 + a15, a15 * (d15 * a15));
		lemma_mul_is_associative(a15 * d15, d15 + a15, a15 * (d15 * a15));
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_commutative((a16 * c16) + (a16 * c16), (d16 + a16) * (a16 * b16));
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_commutative(b18, c18);
	}
	...
	assert(temp_21_0 == temp_21_1) by {
		lemma_mul_is_commutative(c21 * d21, b21 - d21);
		lemma_mul_is_associative(((c21 - a21) * (a21 + d21)) * ((b21 * c21) + (a21 - d21)), d21, (c21 * d21) * (b21 - d21));
		lemma_mul_is_associative(((c21 - a21) * (a21 + d21)) * ((b21 * c21) + (a21 - d21)), d21, (b21 - d21) * (c21 * d21));
	}
	...
	assert(temp_22_0 == temp_22_1) by {
		lemma_mul_is_commutative(c22 * c22, b22 * c22);
	}
	...
	assert(temp_23_0 == temp_23_1) by {
		lemma_mul_is_commutative(a23 - d23, d23 + a23);
	}
	...
	assert(temp_24_0 == temp_24_1) by {
		lemma_mul_is_associative(c24, c24, a24 * d24);
	}
	...
	assert(temp_25_0 == temp_25_1) by {
		lemma_mul_is_commutative(((a25 * a25) * (c25 * b25)) * (d25 * (b25 * a25)), ((b25 * a25) * b25) * ((a25 - c25) * (b25 * a25)));
	}
	...
	assert(temp_26_0 == temp_26_1) by {
		lemma_mul_is_associative(b26, 98, b26);
		lemma_mul_is_associative(((a26 * a26) * d26) * ((c26 - c26) * (d26 * c26)), a26, (b26 * 98) * b26);
		lemma_mul_is_commutative(98 * b26, b26);
		lemma_mul_is_associative(((a26 * a26) * d26) * ((c26 - c26) * (d26 * c26)), a26, (98 * b26) * b26);
	}
