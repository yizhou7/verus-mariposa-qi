...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_associative(a0 - d0, a0, b0);
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		...
		lemma_mul_is_associative((d1 * d1) * (a1 * d1), d1 * 91, a1 * b1);
		lemma_mul_is_associative((d1 * d1) * (a1 * d1), d1 * 91, b1 * a1);
	}
	let temp_2_0 = (((a2*(c2+a2))-((b2*d2)*(d2*b2)))*(((b2*d2)+(c2*b2))*((a2*a2)*(b2*c2))));
	let temp_2_1 = (((a2*(c2+a2))-((b2*d2)*(d2*b2)))*(((b2*d2)+(c2*b2))*(((a2*a2)*b2)*c2)));
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_associative((a2 * (c2 + a2)) - ((b2 * d2) * (d2 * b2)), (b2 * d2) + (c2 * b2), ((a2 * a2) * b2) * c2);
		lemma_mul_is_associative(a2 * a2, b2, c2);
		lemma_mul_is_associative((a2 * (c2 + a2)) - ((b2 * d2) * (d2 * b2)), (b2 * d2) + (c2 * b2), (a2 * a2) * (b2 * c2));
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_associative(a4 + d4, c4, b4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_commutative(c5 * c5, a5 * a5);
		lemma_mul_is_associative((c5 * c5) * (a5 * a5), (a5 * b5) * (c5 * d5), ((b5 * c5) * (d5 * c5)) * ((c5 * a5) * a5));
		lemma_mul_is_associative((a5 * a5) * (c5 * c5), (a5 * b5) * (c5 * d5), ((b5 * c5) * (d5 * c5)) * ((c5 * a5) * a5));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_distributive(c6, c6, b6 * a6);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_associative(((b7 * d7) * b7) - ((b7 * d7) * d7), (a7 + c7) * (c7 * b7), ((d7 - c7) - (c7 * a7)) * ((a7 * c7) + (c7 * a7)));
		lemma_mul_is_distributive(b7 * d7, b7, d7);
		lemma_mul_is_associative((b7 * d7) * (b7 - d7), (a7 + c7) * (c7 * b7), ((d7 - c7) - (c7 * a7)) * ((a7 * c7) + (c7 * a7)));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		...
		lemma_mul_is_associative((d8 * b8) * (a8 * c8), (c8 * d8) - (b8 * b8), ((d8 * b8) * (a8 * a8)) * ((a8 * b8) - (a8 * c8)));
		lemma_mul_is_associative((d8 * b8) * (c8 * a8), (c8 * d8) - (b8 * b8), ((d8 * b8) * (a8 * a8)) * ((a8 * b8) - (a8 * c8)));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_distributive((c10 * a10) * (d10 * c10), (a10 * a10) * (d10 * c10), ((a10 * a10) * (c10 * b10)) * ((b10 * d10) * (b10 * d10)));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_associative(((d11 * b11) * (c11 * a11)) * ((d11 * b11) - 36), (d11 + c11) * (b11 + d11), (a11 * b11) * (c11 * d11));
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_associative(a12, a12, b12 * b12);
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_commutative((b14 * b14) * (a14 + a14), (d14 * b14) + (a14 * d14));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		...
		lemma_mul_is_associative(((a15 + c15) * (d15 * d15)) + ((a15 * c15) * (94 * c15)), b15 * b15, (c15 * b15) - (c15 * b15));
		lemma_mul_is_associative(((a15 + c15) * (d15 * d15)) + ((a15 * c15) * (94 * c15)), b15 * b15, (c15 * b15) - (b15 * c15));
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_commutative(((78 * d16) * b16) + ((b16 * d16) * (a16 * d16)), ((a16 + b16) * (1 * b16)) * ((d16 - c16) - (a16 * c16)));
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_commutative(c17, 48);
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_commutative(d18, a18);
		lemma_mul_is_associative(((c18 * d18) * (c18 * b18)) * ((b18 * a18) * (b18 + b18)), (c18 * c18) * (c18 * d18), (b18 * a18) - (d18 * a18));
		lemma_mul_is_associative(((c18 * d18) * (c18 * b18)) * ((b18 * a18) * (b18 + b18)), (c18 * c18) * (c18 * d18), (b18 * a18) - (a18 * d18));
	}
	...
	assert(temp_19_0 == temp_19_1) by {
		lemma_mul_is_distributive((b19 * b19) * (c19 * d19), (c19 * d19) * d19, ((d19 * b19) * (d19 * a19)) * ((a19 * c19) * (b19 * d19)));
	}
	...
	assert(temp_20_0 == temp_20_1) by {
		...
		lemma_mul_is_associative(((b20 + b20) * (c20 * d20)) * ((c20 * c20) * a20), (a20 * b20) + (c20 * c20), c20 * (a20 * b20));
		lemma_mul_is_associative(((b20 + b20) * (c20 * d20)) * ((c20 * c20) * a20), (a20 * b20) + (c20 * c20), c20 * (b20 * a20));
	}
	...
	assert(temp_21_0 == temp_21_1) by {
		lemma_mul_is_commutative(a21 * a21, a21 * c21);
		lemma_mul_is_associative(((b21 * c21) * (b21 * c21)) - ((c21 * a21) - (a21 - c21)), (b21 + b21) * (c21 * d21), (a21 * a21) * (a21 * c21));
		lemma_mul_is_associative(((b21 * c21) * (b21 * c21)) - ((c21 * a21) - (a21 - c21)), (b21 + b21) * (c21 * d21), (a21 * c21) * (a21 * a21));
	}
	...
	assert(temp_22_0 == temp_22_1) by {
		lemma_mul_is_associative(((c22 * b22) * (a22 * a22)) * a22, (a22 - a22) * (c22 - c22), ((d22 + c22) * c22) * c22);
		lemma_mul_is_associative(d22 + c22, c22, c22);
		lemma_mul_is_associative(((c22 * b22) * (a22 * a22)) * a22, (a22 - a22) * (c22 - c22), (d22 + c22) * (c22 * c22));
	}
	...
	assert(temp_23_0 == temp_23_1) by {
		lemma_mul_is_commutative((a23 - c23) * (d23 * c23), (b23 * d23) - (d23 + b23));
	}
	...
	assert(temp_24_0 == temp_24_1) by {
		lemma_mul_is_commutative(c24, d24);
		lemma_mul_is_associative(c24 * d24, b24 * a24, (b24 * d24) - (c24 * a24));
		lemma_mul_is_associative(d24 * c24, b24 * a24, (b24 * d24) - (c24 * a24));
	}
