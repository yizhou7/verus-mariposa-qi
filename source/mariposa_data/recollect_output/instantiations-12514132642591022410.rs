...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_distributive((c2 * b2) * (d2 * b2), a2 * b2, d2 * b2);
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		...
		lemma_mul_is_associative((d3 * a3) * b3, (d3 * a3) * (d3 * c3), ((a3 * d3) * a3) * ((b3 + 64) + (d3 * c3)));
		lemma_mul_is_associative((a3 * d3) * b3, (d3 * a3) * (d3 * c3), ((a3 * d3) * a3) * ((b3 + 64) + (d3 * c3)));
	}
	let temp_4_0 = ((((d4-d4)*(b4+c4))*(d4*(d4-a4)))*(((d4*c4)-(c4*b4))-((b4*c4)*c4)));
	let temp_4_1 = ((((d4*c4)-(c4*b4))-((b4*c4)*c4))*(((d4-d4)*(b4+c4))*(d4*(d4-a4))));
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_commutative(((d4 * c4) - (c4 * b4)) - ((b4 * c4) * c4), ((d4 - d4) * (b4 + c4)) * (d4 * (d4 - a4)));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_associative((d6 - c6) * (a6 * 62), c6 - b6, a6 * d6);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		...
		lemma_mul_is_associative((c7 * a7) + (b7 * a7), (d7 * b7) * (b7 * d7), ((d7 * a7) * (c7 * c7)) * ((d7 * d7) * (b7 * c7)));
		lemma_mul_is_associative((c7 * a7) + (a7 * b7), (d7 * b7) * (b7 * d7), ((d7 * a7) * (c7 * c7)) * ((d7 * d7) * (b7 * c7)));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_commutative((d8 * c8) + (b8 * b8), (a8 * a8) + (c8 * b8));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_associative((c9 * a9) * (a9 * c9), (a9 + c9) * (a9 * d9), ((a9 * c9) * (d9 * b9)) * (a9 * (c9 * d9)));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_associative(a10 * c10, b10, (a10 * b10) * (d10 - d10));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		...
		lemma_mul_is_associative((b11 * b11) * (c11 * d11), (a11 * d11) * (c11 * b11), ((d11 * c11) * (a11 - a11)) - ((b11 - c11) - (b11 * d11)));
		lemma_mul_is_associative((b11 * b11) * (d11 * c11), (a11 * d11) * (c11 * b11), ((d11 * c11) * (a11 - a11)) - ((b11 - c11) - (b11 * d11)));
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_distributive((a13 * a13) * (86 * b13), (b13 + a13) * (a13 * c13), ((d13 * d13) * (b13 * d13)) * ((a13 * d13) * (a13 * c13)));
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_commutative(((b17 * a17) * (c17 * c17)) - ((a17 * d17) + (a17 * a17)), ((a17 * b17) + (c17 * c17)) - ((96 * a17) * (a17 - a17)));
	}
	...
	assert(temp_19_0 == temp_19_1) by {
		lemma_mul_is_commutative(((a19 * d19) + d19) + ((b19 * a19) * (a19 * b19)), ((a19 * d19) - (a19 * c19)) * ((b19 * c19) * (a19 * d19)));
	}
	...
	assert(temp_20_0 == temp_20_1) by {
		lemma_mul_is_commutative(a20 * b20, d20 * b20);
		lemma_mul_is_associative(((b20 - a20) - (b20 * c20)) * ((d20 * c20) * (a20 * c20)), (b20 * a20) * (c20 * c20), (a20 * b20) * (d20 * b20));
		lemma_mul_is_associative(((b20 - a20) - (b20 * c20)) * ((d20 * c20) * (a20 * c20)), (b20 * a20) * (c20 * c20), (d20 * b20) * (a20 * b20));
	}
	...
	assert(temp_22_0 == temp_22_1) by {
		lemma_mul_is_associative(((b22 + 93) * (d22 * c22)) * ((d22 * a22) * (a22 * d22)), (d22 * c22) * (a22 * a22), ((a22 - a22) * a22) * b22);
		lemma_mul_is_associative(a22 - a22, a22, b22);
		lemma_mul_is_associative(((b22 + 93) * (d22 * c22)) * ((d22 * a22) * (a22 * d22)), (d22 * c22) * (a22 * a22), (a22 - a22) * (a22 * b22));
	}
	...
	assert(temp_23_0 == temp_23_1) by {
		lemma_mul_is_commutative(b23 * b23, c23 - a23);
		lemma_mul_is_associative((b23 * b23) * (c23 - a23), (a23 * a23) * (d23 - d23), ((a23 * c23) * (b23 * a23)) + ((a23 * b23) * (b23 + a23)));
		lemma_mul_is_associative((c23 - a23) * (b23 * b23), (a23 * a23) * (d23 - d23), ((a23 * c23) * (b23 * a23)) + ((a23 * b23) * (b23 + a23)));
	}
	let temp_24_0 = ((d24*((d24*a24)-(c24-d24)))*d24);
	let temp_24_1 = (d24*(((d24*a24)-(c24-d24))*d24));
	assert(temp_24_0 == temp_24_1) by {
		lemma_mul_is_associative(d24, (d24 * a24) - (c24 - d24), d24);
	}
