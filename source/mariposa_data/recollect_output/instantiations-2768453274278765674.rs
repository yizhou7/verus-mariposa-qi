...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_commutative(d0 * d0, c0 - d0);
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_distributive(((85 - c1) * (b1 * c1)) - ((c1 * c1) * (d1 * b1)), (29 * c1) * (c1 * d1), (c1 * c1) * (d1 * c1));
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_commutative(b2 * b2, c2 * b2);
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_commutative(c3 * c3, d3 + d3);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_commutative(a7 * c7, c7 * b7);
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_associative(b8 - c8, a8 * b8, (c8 + d8) * a8);
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_commutative(52 * d9, d9 * a9);
		lemma_mul_is_associative((52 * d9) * (d9 * a9), (c9 * c9) * (d9 * b9), ((a9 * a9) - (c9 * c9)) * ((d9 * a9) * (20 * a9)));
		lemma_mul_is_associative((d9 * a9) * (52 * d9), (c9 * c9) * (d9 * b9), ((a9 * a9) - (c9 * c9)) * ((d9 * a9) * (20 * a9)));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_associative(a11, a11, b11 - b11);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_commutative(a12 * b12, b12 * a12);
		lemma_mul_is_associative(((b12 * c12) + (d12 * a12)) * ((15 * c12) - (d12 * c12)), (b12 * a12) * (b12 + b12), (a12 * b12) * (b12 * a12));
		lemma_mul_is_associative(((b12 * c12) + (d12 * a12)) * ((15 * c12) - (d12 * c12)), (b12 * a12) * (b12 + b12), (b12 * a12) * (a12 * b12));
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_associative(a13 * a13, b13, c13);
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_associative(((d14 * c14) * c14) - ((c14 * c14) + (c14 + c14)), (b14 * d14) * (a14 * c14), ((c14 * d14) * b14) * c14);
		lemma_mul_is_associative(c14 * d14, b14, c14);
		lemma_mul_is_associative(((d14 * c14) * c14) - ((c14 * c14) + (c14 + c14)), (b14 * d14) * (a14 * c14), (c14 * d14) * (b14 * c14));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_associative(c15 * d15, d15, a15);
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_commutative(c16 * (a16 * d16), (c16 * a16) * (a16 + a16));
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_commutative(((d17 - b17) * (d17 * d17)) * ((67 * a17) * (b17 * d17)), ((46 * b17) * (d17 * c17)) + (b17 * (d17 + a17)));
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_commutative((b18 * b18) - (c18 * b18), (d18 + c18) + (d18 - d18));
	}
	...
	assert(temp_19_0 == temp_19_1) by {
		lemma_mul_is_commutative((b19 * c19) - (b19 - d19), (d19 * 48) + (d19 + d19));
	}
	...
	assert(temp_20_0 == temp_20_1) by {
		lemma_mul_is_commutative(b20, c20);
	}
