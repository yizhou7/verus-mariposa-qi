...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_commutative((b0 * b0) * (a0 * c0), (d0 * c0) * (b0 + b0));
	}
	let temp_1_0 = ((((d1+b1)*(d1*b1))*((b1*b1)*(a1*b1)))*(((d1*b1)+(d1-c1))-b1));
	let temp_1_1 = (((((d1+b1)*(d1*b1))*(b1*b1))*(a1*b1))*(((d1*b1)+(d1-c1))-b1));
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_associative((d1 + b1) * (d1 * b1), b1 * b1, a1 * b1);
	}
	let temp_2_0 = ((((b2*a2)*(a2*b2))*((a2*a2)*(a2-d2)))*(((c2*a2)*(c2*a2))*((c2*d2)-d2)));
	let temp_2_1 = ((((b2*a2)*(a2*b2))*((a2*a2)*(a2-d2)))*(((c2*a2)*(c2*a2))*((d2*c2)-d2)));
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_commutative(d2, c2);
		lemma_mul_is_associative(((b2 * a2) * (a2 * b2)) * ((a2 * a2) * (a2 - d2)), (c2 * a2) * (c2 * a2), (d2 * c2) - d2);
		lemma_mul_is_associative(((b2 * a2) * (a2 * b2)) * ((a2 * a2) * (a2 - d2)), (c2 * a2) * (c2 * a2), (c2 * d2) - d2);
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_associative(d4 * c4, d4 * a4, d4 + (d4 + a4));
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_commutative(b5, 58);
		lemma_mul_is_associative((a5 * b5) * (d5 * a5), a5 * c5, b5 * 58);
		lemma_mul_is_associative((a5 * b5) * (d5 * a5), a5 * c5, 58 * b5);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_commutative((d7 + c7) + (a7 * c7), (d7 * d7) - (c7 * 67));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_associative(d8, b8, d8 * d8);
		lemma_mul_is_associative(d8 * (b8 * (d8 * d8)), (d8 * d8) * (c8 * a8), ((a8 * c8) * b8) * ((d8 * a8) * (b8 * a8)));
		lemma_mul_is_associative((d8 * b8) * (d8 * d8), (d8 * d8) * (c8 * a8), ((a8 * c8) * b8) * ((d8 * a8) * (b8 * a8)));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_commutative((a9 + b9) * (a9 * c9), (d9 + b9) * (d9 * c9));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_associative(b10 - a10, a10, a10);
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_distributive(31, d11, d11);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_commutative(d12 * c12, c12 * a12);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_associative(b13, b13, c13);
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_associative(((a14 + b14) * (c14 * c14)) * ((c14 * b14) * (d14 * d14)), (b14 * c14) * (d14 * c14), ((b14 * a14) * c14) * d14);
		lemma_mul_is_associative(b14 * a14, c14, d14);
		lemma_mul_is_associative(((a14 + b14) * (c14 * c14)) * ((c14 * b14) * (d14 * d14)), (b14 * c14) * (d14 * c14), (b14 * a14) * (c14 * d14));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_commutative((b15 * 35) * (b15 * a15), (d15 * d15) * (a15 * c15));
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		...
		lemma_mul_is_associative(((b17 * d17) * (c17 * a17)) * ((b17 * d17) * (93 * d17)), (c17 - 85) - (d17 * d17), b17 * (d17 * (c17 * d17)));
		lemma_mul_is_associative(((b17 * d17) * (c17 * a17)) * ((b17 * d17) * (93 * d17)), (c17 - 85) - (d17 * d17), (b17 * d17) * (c17 * d17));
	}
