...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_commutative(29, c2);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_associative(((d5 * c5) * (a5 * b5)) * ((d5 * c5) * (b5 * b5)), (d5 * a5) * (a5 * b5), (c5 - b5) * d5);
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_associative(((c6 * b6) * c6) + ((c6 * b6) * b6), a6 * (a6 - 38), (a6 * (c6 * b6)) * ((b6 * b6) * (c6 * b6)));
		lemma_mul_is_distributive(c6 * b6, c6, b6);
		lemma_mul_is_associative((c6 * b6) * (c6 + b6), a6 * (a6 - 38), (a6 * (c6 * b6)) * ((b6 * b6) * (c6 * b6)));
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_associative((b7 * (c7 * c7)) + (b7 * (c7 * c7)), (c7 * c7) * (a7 * d7), ((95 * c7) * (a7 + b7)) * ((a7 * b7) * (d7 * b7)));
		lemma_mul_is_distributive(b7, b7, c7 * c7);
		lemma_mul_is_associative((b7 + b7) * (c7 * c7), (c7 * c7) * (a7 * d7), ((95 * c7) * (a7 + b7)) * ((a7 * b7) * (d7 * b7)));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_associative(d8, a8, d8 + c8);
		lemma_mul_is_associative(d8 * (a8 * (d8 + c8)), a8, (b8 * (a8 * c8)) - ((b8 - a8) * (a8 + b8)));
		lemma_mul_is_associative((d8 * a8) * (d8 + c8), a8, (b8 * (a8 * c8)) - ((b8 - a8) * (a8 + b8)));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_associative(d9 * (c9 * d9), b9 * c9, a9 + d9);
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_commutative((d10 - d10) * (a10 * d10), (a10 * c10) * (d10 * d10));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_commutative(d11 * (b11 * d11), (a11 * d11) * (b11 - b11));
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_commutative((b12 * b12) * (b12 * c12), a12 * (b12 * d12));
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_commutative((c14 * b14) + (a14 * d14), a14 - (b14 * a14));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_commutative(d15 + b15, b15 + c15);
		lemma_mul_is_associative(((d15 * c15) * (c15 + b15)) * ((b15 * b15) * (c15 + a15)), (b15 * a15) + (c15 * c15), (d15 + b15) * (b15 + c15));
		lemma_mul_is_associative(((d15 * c15) * (c15 + b15)) * ((b15 * b15) * (c15 + a15)), (b15 * a15) + (c15 * c15), (b15 + c15) * (d15 + b15));
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_commutative(b16 * ((b16 * d16) * (b16 * d16)), (b16 * (b16 * c16)) * a16);
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_commutative(a17 * c17, b17 * d17);
		lemma_mul_is_associative(((d17 * c17) * (d17 * a17)) * d17, d17, (a17 * c17) * (b17 * d17));
		lemma_mul_is_associative(((d17 * c17) * (d17 * a17)) * d17, d17, (b17 * d17) * (a17 * c17));
	}
	...
	assert(temp_19_0 == temp_19_1) by {
		lemma_mul_is_commutative((b19 * d19) + (b19 * d19), (c19 + d19) * (b19 * d19));
	}
	...
	assert(temp_20_0 == temp_20_1) by {
		lemma_mul_is_commutative((c20 * d20) * d20, (c20 * a20) * (a20 * d20));
	}
	...
	assert(temp_21_0 == temp_21_1) by {
		lemma_mul_is_distributive(b21, b21, b21 * a21);
	}
	...
	assert(temp_22_0 == temp_22_1) by {
		lemma_mul_is_commutative(a22 * d22, c22 - c22);
	}
	...
	assert(temp_23_0 == temp_23_1) by {
		...
		lemma_mul_is_associative((c23 * d23) * (75 * a23), (d23 * d23) + (b23 * b23), ((a23 * b23) * (d23 * a23)) * ((d23 * d23) - (b23 * c23)));
		lemma_mul_is_associative((d23 * c23) * (75 * a23), (d23 * d23) + (b23 * b23), ((a23 * b23) * (d23 * a23)) * ((d23 * d23) - (b23 * c23)));
	}
	...
	assert(temp_26_0 == temp_26_1) by {
		lemma_mul_is_commutative(d26 * b26, b26 * 66);
	}
