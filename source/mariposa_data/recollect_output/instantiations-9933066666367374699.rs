...
pub proof fn free_0(a: Elem, b: Elem, c: Elem, d: Elem, m: Elem)
{
	...
	assert(eq_(temp_0_0, temp_0_1)) by {
		...
		lemma_mul_assoc(b, mod_(a, m), mul_(mod_(a, m), b));
	}
	...
	assert(eq_(temp_2_0, temp_2_1)) by {
		lemma_add_comm(mul_(b, d), mul_(b, b));
	}
	let temp_3_0 = (mod_((mul_((add_(d, (mod_(a, m)))), (mul_(b, c)))), m));
	let temp_3_1 = (mod_((mul_((mul_(b, c)), (add_(d, (mod_(a, m)))))), m));
	assert(eq_(temp_3_0, temp_3_1)) by {
		lemma_mul_comm(add_(d, mod_(a, m)), mul_(b, c));
		cong_mod_(mul_(add_(d, mod_(a, m)), mul_(b, c)), m, mul_(mul_(b, c), add_(d, mod_(a, m))), m);
		lemma_eq_ref(m);
	}
	let temp_4_0 = (mod_((mul_((sub_(a, b)), (mul_(a, as_elem(93))))), m));
	let temp_4_1 = (mod_((mul_((mul_(a, as_elem(93))), (sub_(a, b)))), m));
	assert(eq_(temp_4_0, temp_4_1)) by {
		lemma_mul_comm(sub_(a, b), mul_(a, as_elem(93)));
		cong_mod_(mul_(sub_(a, b), mul_(a, as_elem(93))), m, mul_(mul_(a, as_elem(93)), sub_(a, b)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_8_0, temp_8_1)) by {
		lemma_mul_assoc(d, a, mul_(c, mod_(as_elem(54), m)));
	...
	assert(eq_(temp_9_0, temp_9_1)) by {
		lemma_mul_dist(mod_(c, m), d, mul_(c, d));
	}
	...
	assert(eq_(temp_10_0, temp_10_1)) by {
		lemma_mul_comm(mod_(c, m), mod_(as_elem(75), m));
		lemma_add_comm(c, c);
		cong_add_(add_(c, c), mul_(mod_(c, m), mod_(as_elem(75), m)), add_(c, c), mul_(mod_(as_elem(75), m), mod_(c, m)));
	}
	...
	assert(eq_(temp_19_0, temp_19_1)) by {
		lemma_mod_mul_vanish(b, mul_(mul_(c, c), mod_(mul_(c, a), m)), m);
		cong_sub_(mul_(c, d), mul_(c, mod_(b, m)), mul_(c, d), mul_(c, mod_(sub_(b, mul_(mul_(mul_(c, c), mod_(mul_(c, a), m)), m)), m)));
		lemma_eq_ref(c);
		lemma_eq_ref(mul_(c, d));
		cong_mul_(c, mod_(b, m), c, mod_(sub_(b, mul_(mul_(mul_(c, c), mod_(mul_(c, a), m)), m)), m));
	}
	let temp_20_0 = (sub_((mul_(c, (mod_(c, m)))), b));
	let temp_20_1 = (sub_((mul_(c, (mod_((add_((mul_((mul_((mul_(b, b)), (sub_(d, a)))), m)), c)), m)))), b));
	assert(eq_(temp_20_0, temp_20_1)) by {
		lemma_mod_mul_vanish(c, mul_(mul_(b, b), sub_(d, a)), m);
		cong_sub_(mul_(c, mod_(c, m)), b, mul_(c, mod_(add_(mul_(mul_(mul_(b, b), sub_(d, a)), m), c), m)), b);
		lemma_eq_ref(b);
		cong_mul_(c, mod_(c, m), c, mod_(add_(mul_(mul_(mul_(b, b), sub_(d, a)), m), c), m));
		lemma_eq_ref(c);
	}
	let temp_21_0 = (mul_((add_(c, (mod_(a, m)))), (mul_(a, b))));
	let temp_21_1 = (add_((mul_(c, (mul_(a, b)))), (mul_((mod_(a, m)), (mul_(a, b))))));
	assert(eq_(temp_21_0, temp_21_1)) by {
		lemma_mul_dist(c, mod_(a, m), mul_(a, b));
	}
	let temp_22_0 = (add_((mul_(c, a)), (mul_(a, as_elem(6)))));
	let temp_22_1 = (add_((mul_(a, as_elem(6))), (mul_(c, a))));
	assert(eq_(temp_22_0, temp_22_1)) by {
		lemma_add_comm(mul_(c, a), mul_(a, as_elem(6)));
	}
	...
	assert(eq_(temp_23_0, temp_23_1)) by {
		lemma_mod_mul_vanish(b, add_(mul_(c, mod_(c, m)), mul_(a, a)), m);
		cong_mul_(mul_(mod_(b, m), a), mul_(c, b), mul_(mod_(sub_(b, mul_(add_(mul_(c, mod_(c, m)), mul_(a, a)), m)), m), a), mul_(c, b));
		lemma_eq_ref(a);
		cong_mul_(mod_(b, m), a, mod_(sub_(b, mul_(add_(mul_(c, mod_(c, m)), mul_(a, a)), m)), m), a);
		lemma_eq_ref(mul_(c, b));
	}
	let temp_24_0 = (sub_((mul_(c, d)), (mul_(b, as_elem(78)))));
	let temp_24_1 = (sub_((mul_(c, d)), (mul_(as_elem(78), b))));
	assert(eq_(temp_24_0, temp_24_1)) by {
		lemma_mul_comm(b, as_elem(78));
		cong_sub_(mul_(c, d), mul_(b, as_elem(78)), mul_(c, d), mul_(as_elem(78), b));
		lemma_eq_ref(mul_(c, d));
	}
	...
	assert(eq_(temp_26_0, temp_26_1)) by {
		lemma_mul_assoc(b, mod_(b, m), mul_(c, d));
	...
	assert(eq_(temp_28_0, temp_28_1)) by {
		lemma_mul_comm(b, a);
		cong_mul_(mul_(b, a), sub_(mod_(c, m), a), mul_(a, b), sub_(mod_(c, m), a));
	...
	assert(eq_(temp_31_0, temp_31_1)) by {
		lemma_mul_comm(sub_(c, c), mul_(b, mod_(c, m)));
	}
	...
	assert(eq_(temp_33_0, temp_33_1)) by {
		lemma_mul_assoc(b, mod_(d, m), add_(c, mod_(d, m)));
	...
	assert(eq_(temp_34_0, temp_34_1)) by {
		lemma_mul_assoc(mul_(mod_(a, m), a), as_elem(48), a);
	}
	...
	assert(eq_(temp_36_0, temp_36_1)) by {
		lemma_mul_comm(d, b);
		cong_mul_(mul_(d, b), mod_(add_(c, d), m), mul_(b, d), mod_(add_(c, d), m));
	...
	assert(eq_(temp_37_0, temp_37_1)) by {
		cong_mul_(a, mod_(mul_(a, a), m), a, mod_(sub_(mul_(a, a), mul_(mul_(mul_(c, a), mul_(d, c)), m)), m));
		lemma_mod_mul_vanish(mul_(a, a), mul_(mul_(c, a), mul_(d, c)), m);
		lemma_eq_ref(a);
	}
	...
	assert(eq_(temp_41_0, temp_41_1)) by {
		lemma_mod_mul_vanish(a, mul_(sub_(b, d), mul_(a, a)), m);
		cong_mul_(mul_(b, a), mul_(a, mod_(a, m)), mul_(b, a), mul_(a, mod_(sub_(a, mul_(mul_(sub_(b, d), mul_(a, a)), m)), m)));
		lemma_eq_ref(a);
		cong_mul_(a, mod_(a, m), a, mod_(sub_(a, mul_(mul_(sub_(b, d), mul_(a, a)), m)), m));
		lemma_eq_ref(mul_(b, a));
	}
	...
	assert(eq_(temp_42_0, temp_42_1)) by {
		lemma_mul_comm(a, a);
		lemma_mod_mul_vanish(a, mul_(sub_(d, mod_(a, m)), mul_(d, c)), m);
		cong_mul_(mul_(a, mod_(a, m)), mul_(a, a), mul_(a, mod_(add_(mul_(mul_(sub_(d, mod_(a, m)), mul_(d, c)), m), a), m)), mul_(a, a));
		lemma_eq_ref(a);
		cong_mul_(a, mod_(a, m), a, mod_(add_(mul_(mul_(sub_(d, mod_(a, m)), mul_(d, c)), m), a), m));
	}
	...
	assert(eq_(temp_43_0, temp_43_1)) by {
		...
		cong_mul_(mod_(mul_(b, d), m), mod_(mul_(b, mod_(b, m)), m), mod_(mul_(b, d), m), mod_(mod_(mul_(b, b), m), m));
	...
	assert(eq_(temp_44_0, temp_44_1)) by {
		lemma_eq_ref(d);
		lemma_eq_ref(m);
		cong_mul_(mod_(sub_(c, mul_(mul_(add_(a, b), mul_(c, c)), m)), m), d, mod_(c, m), d);
		cong_mul_(mul_(a, a), mod_(mul_(mod_(c, m), d), m), mul_(a, a), mod_(mul_(mod_(sub_(c, mul_(mul_(add_(a, b), mul_(c, c)), m)), m), d), m));
		lemma_mod_mul_vanish(c, mul_(add_(a, b), mul_(c, c)), m);
		lemma_eq_ref(mul_(a, a));
		cong_mod_(mul_(mod_(sub_(c, mul_(mul_(add_(a, b), mul_(c, c)), m)), m), d), m, mul_(mod_(c, m), d), m);
		lemma_eq_sym(mod_(c, m), mod_(sub_(c, mul_(mul_(add_(a, b), mul_(c, c)), m)), m));
		lemma_eq_sym(mod_(mul_(mod_(sub_(c, mul_(mul_(add_(a, b), mul_(c, c)), m)), m), d), m), mod_(mul_(mod_(c, m), d), m));
	}
	let temp_45_0 = (mul_((mul_((mod_(a, m)), c)), (mul_(c, a))));
	let temp_45_1 = (mul_((mul_((mul_((mod_(a, m)), c)), c)), a));
	assert(eq_(temp_45_0, temp_45_1)) by {
		lemma_mul_assoc(mul_(mod_(a, m), c), c, a);
	}
	...
	assert(eq_(temp_47_0, temp_47_1)) by {
		lemma_mul_comm(sub_(c, d), sub_(b, d));
		cong_mod_(mul_(sub_(c, d), sub_(b, d)), m, mul_(sub_(b, d), sub_(c, d)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_50_0, temp_50_1)) by {
		cong_mul_(a, mod_(sub_(b, b), m), a, mod_(sub_(mod_(b, m), mod_(b, m)), m));
	...
	assert(eq_(temp_51_0, temp_51_1)) by {
		cong_add_(add_(c, b), mul_(d, b), add_(c, b), mul_(b, d));
		lemma_mul_comm(d, b);
	...
	assert(eq_(temp_54_0, temp_54_1)) by {
		lemma_add_comm(mul_(mod_(a, m), d), mul_(d, b));
	}
	...
	assert(eq_(temp_56_0, temp_56_1)) by {
		lemma_mod_mul_vanish(a, mul_(mul_(a, b), sub_(mod_(c, m), b)), m);
		cong_mul_(sub_(c, mod_(a, m)), mod_(mul_(mod_(c, m), d), m), sub_(c, mod_(add_(mul_(mul_(mul_(a, b), sub_(mod_(c, m), b)), m), a), m)), mod_(mul_(mod_(c, m), d), m));
		lemma_eq_ref(c);
		cong_sub_(c, mod_(a, m), c, mod_(add_(mul_(mul_(mul_(a, b), sub_(mod_(c, m), b)), m), a), m));
	...
	assert(eq_(temp_61_0, temp_61_1)) by {
		lemma_mod_mul_vanish(c, mul_(mul_(c, a), mul_(c, d)), m);
		cong_sub_(mul_(d, c), add_(mod_(c, m), b), mul_(d, c), add_(mod_(add_(c, mul_(mul_(mul_(c, a), mul_(c, d)), m)), m), b));
		lemma_eq_ref(mul_(d, c));
		lemma_eq_ref(b);
		cong_add_(mod_(c, m), b, mod_(add_(c, mul_(mul_(mul_(c, a), mul_(c, d)), m)), m), b);
	}
	let temp_62_0 = (mul_((mul_(c, a)), (add_(a, a))));
	let temp_62_1 = (mul_((mul_(a, c)), (add_(a, a))));
	assert(eq_(temp_62_0, temp_62_1)) by {
		cong_mul_(mul_(c, a), add_(a, a), mul_(a, c), add_(a, a));
		lemma_add_comm(a, a);
		lemma_mul_comm(c, a);
	}
	...
	assert(eq_(temp_66_0, temp_66_1)) by {
		lemma_mod_mul_vanish(c, mul_(mul_(c, d), mul_(a, c)), m);
		cong_mul_(mul_(d, mod_(c, m)), mul_(d, c), mul_(d, mod_(sub_(c, mul_(mul_(mul_(c, d), mul_(a, c)), m)), m)), mul_(d, c));
		cong_mul_(d, mod_(c, m), d, mod_(sub_(c, mul_(mul_(mul_(c, d), mul_(a, c)), m)), m));
		lemma_eq_ref(d);
		lemma_eq_ref(mul_(d, c));
	}
	...
	assert(eq_(temp_67_0, temp_67_1)) by {
		lemma_mod_mul_vanish(mul_(a, a), mul_(mod_(mul_(b, c), m), mul_(b, d)), m);
		cong_mul_(mod_(mul_(a, a), m), mul_(a, c), mod_(add_(mul_(a, a), mul_(mul_(mod_(mul_(b, c), m), mul_(b, d)), m)), m), mul_(a, c));
		lemma_eq_ref(mul_(a, c));
	}
	let temp_68_0 = (mul_((sub_(d, b)), (mul_(c, b))));
	let temp_68_1 = (sub_((mul_(d, (mul_(c, b)))), (mul_(b, (mul_(c, b))))));
	assert(eq_(temp_68_0, temp_68_1)) by {
		lemma_mul_dist(mul_(c, b), d, b);
	}
	let temp_69_0 = (mul_((mod_((mul_(a, a)), m)), (mul_(b, d))));
	let temp_69_1 = (mul_((mul_((mod_((mul_(a, a)), m)), b)), d));
	assert(eq_(temp_69_0, temp_69_1)) by {
		lemma_mul_assoc(mod_(mul_(a, a), m), b, d);
	}
	...
	assert(eq_(temp_76_0, temp_76_1)) by {
		...
		cong_mod_(mul_(mul_(a, c), mul_(a, d)), m, mul_(mul_(a, d), mul_(a, c)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_77_0, temp_77_1)) by {
		lemma_mod_mul_vanish(mul_(b, d), mod_(mul_(mul_(c, c), mul_(c, b)), m), m);
		cong_mul_(mul_(b, c), mod_(mul_(b, d), m), mul_(b, c), mod_(add_(mul_(b, d), mul_(mod_(mul_(mul_(c, c), mul_(c, b)), m), m)), m));
		lemma_eq_ref(mul_(b, c));
	}
	let temp_78_0 = (mul_((mul_(d, a)), c));
	let temp_78_1 = (mul_(c, (mul_(d, a))));
	assert(eq_(temp_78_0, temp_78_1)) by {
		lemma_mul_comm(mul_(d, a), c);
	}
	let temp_79_0 = (mod_((mul_((sub_(c, a)), (sub_((mod_(d, m)), c)))), m));
	let temp_79_1 = (mod_((mul_((sub_((mod_(d, m)), c)), (sub_(c, a)))), m));
	assert(eq_(temp_79_0, temp_79_1)) by {
		lemma_mul_comm(sub_(c, a), sub_(mod_(d, m), c));
		cong_mod_(mul_(sub_(c, a), sub_(mod_(d, m), c)), m, mul_(sub_(mod_(d, m), c), sub_(c, a)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_80_0, temp_80_1)) by {
		lemma_mul_comm(a, a);
		lemma_mod_mul_vanish(d, mul_(mod_(mul_(c, b), m), mod_(mul_(d, a), m)), m);
		cong_mul_(mul_(a, a), mul_(mod_(d, m), a), mul_(a, a), mul_(mod_(add_(d, mul_(mul_(mod_(mul_(c, b), m), mod_(mul_(d, a), m)), m)), m), a));
		lemma_eq_ref(a);
		cong_mul_(mod_(d, m), a, mod_(add_(d, mul_(mul_(mod_(mul_(c, b), m), mod_(mul_(d, a), m)), m)), m), a);
	}
	...
	assert(eq_(temp_82_0, temp_82_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(d, d), c), mul_(mul_(d, a), sub_(b, b)), m);
	}
	...
	assert(eq_(temp_86_0, temp_86_1)) by {
		lemma_mod_mul_vanish(c, mul_(mul_(d, c), mul_(a, d)), m);
		cong_mul_(mul_(a, b), mul_(a, mod_(c, m)), mul_(a, b), mul_(a, mod_(add_(mul_(mul_(mul_(d, c), mul_(a, d)), m), c), m)));
		lemma_eq_ref(a);
		cong_mul_(a, mod_(c, m), a, mod_(add_(mul_(mul_(mul_(d, c), mul_(a, d)), m), c), m));
	...
	assert(eq_(temp_89_0, temp_89_1)) by {
		lemma_mul_comm(c, d);
		cong_mul_(mul_(c, d), mul_(d, mod_(as_elem(19), m)), mul_(d, c), mul_(d, mod_(as_elem(19), m)));
		lemma_eq_ref(mul_(d, mod_(as_elem(19), m)));
	}
	let temp_90_0 = (mul_((mul_(c, b)), (sub_(c, d))));
	let temp_90_1 = (mul_((mul_(b, c)), (sub_(c, d))));
	assert(eq_(temp_90_0, temp_90_1)) by {
		cong_mul_(mul_(c, b), sub_(c, d), mul_(b, c), sub_(c, d));
		lemma_mul_comm(c, b);
	...
	assert(eq_(temp_95_0, temp_95_1)) by {
		lemma_mul_comm(mul_(a, b), sub_(c, c));
	}
	...
	assert(eq_(temp_96_0, temp_96_1)) by {
		...
		cong_mod_(mul_(mul_(b, b), mul_(c, d)), m, mul_(b, mul_(b, mul_(c, d))), m);
		lemma_eq_sym(mul_(b, mul_(b, mul_(c, d))), mul_(mul_(b, b), mul_(c, d)));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_99_0, temp_99_1)) by {
		lemma_mul_assoc(sub_(as_elem(68), d), b, c);
	}
	...
	assert(eq_(temp_104_0, temp_104_1)) by {
		lemma_mul_comm(d, d);
		lemma_mod_mul_vanish(b, mul_(mul_(b, d), mul_(a, mod_(d, m))), m);
		cong_sub_(mul_(d, d), mul_(mod_(b, m), c), mul_(d, d), mul_(mod_(sub_(b, mul_(mul_(mul_(b, d), mul_(a, mod_(d, m))), m)), m), c));
		cong_mul_(mod_(b, m), c, mod_(sub_(b, mul_(mul_(mul_(b, d), mul_(a, mod_(d, m))), m)), m), c);
		lemma_eq_ref(c);
	}
	...
	assert(eq_(temp_105_0, temp_105_1)) by {
		...
		cong_mod_(mul_(mul_(b, b), add_(d, a)), m, add_(mul_(mul_(b, b), d), mul_(mul_(b, b), a)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_106_0, temp_106_1)) by {
		lemma_mul_comm(mul_(d, c), mul_(mod_(c, m), mod_(b, m)));
	}
	...
	assert(eq_(temp_108_0, temp_108_1)) by {
		lemma_mod_mul_vanish(d, mul_(sub_(d, a), mul_(a, a)), m);
		cong_mul_(mul_(a, c), mul_(mod_(d, m), d), mul_(a, c), mul_(mod_(add_(mul_(mul_(sub_(d, a), mul_(a, a)), m), d), m), d));
		lemma_eq_ref(d);
		lemma_eq_ref(mul_(a, c));
		cong_mul_(mod_(d, m), d, mod_(add_(mul_(mul_(sub_(d, a), mul_(a, a)), m), d), m), d);
	}
	...
	assert(eq_(temp_110_0, temp_110_1)) by {
		lemma_mul_comm(add_(mod_(b, m), b), mul_(mod_(b, m), a));
	}
	...
	assert(eq_(temp_111_0, temp_111_1)) by {
		lemma_mul_assoc(mod_(d, m), d, add_(b, a));
	...
	assert(eq_(temp_112_0, temp_112_1)) by {
		lemma_mul_comm(sub_(b, as_elem(100)), mul_(b, b));
	}
	...
	assert(eq_(temp_115_0, temp_115_1)) by {
		lemma_mod_mul_vanish(mul_(b, mul_(b, b)), add_(mul_(c, a), mul_(d, a)), m);
	}
	...
	assert(eq_(temp_116_0, temp_116_1)) by {
		lemma_mul_comm(a, a);
		cong_sub_(mul_(a, a), mod_(mul_(c, a), m), mul_(a, a), mod_(sub_(mul_(c, a), mul_(mul_(mul_(a, a), mul_(b, b)), m)), m));
		lemma_mod_mul_vanish(mul_(c, a), mul_(mul_(a, a), mul_(b, b)), m);
	}
	...
	assert(eq_(temp_118_0, temp_118_1)) by {
		lemma_mul_assoc(a, as_elem(73), mul_(b, c));
	...
	assert(eq_(temp_120_0, temp_120_1)) by {
		lemma_mod_mul_vanish(b, mul_(sub_(c, mod_(c, m)), sub_(b, a)), m);
		cong_mul_(mul_(mod_(b, m), d), mul_(b, d), mul_(mod_(add_(b, mul_(mul_(sub_(c, mod_(c, m)), sub_(b, a)), m)), m), d), mul_(b, d));
		lemma_eq_ref(d);
		cong_mul_(mod_(b, m), d, mod_(add_(b, mul_(mul_(sub_(c, mod_(c, m)), sub_(b, a)), m)), m), d);
		lemma_eq_ref(mul_(b, d));
	}
	...
	assert(eq_(temp_121_0, temp_121_1)) by {
		lemma_mod_mul_vanish(mul_(b, b), mul_(mul_(c, c), mul_(b, d)), m);
		cong_mul_(mul_(d, b), mod_(mul_(b, b), m), mul_(d, b), mod_(sub_(mul_(b, b), mul_(mul_(mul_(c, c), mul_(b, d)), m)), m));
	...
	assert(eq_(temp_122_0, temp_122_1)) by {
		lemma_mul_assoc(mul_(c, a), c, mod_(c, m));
		cong_mod_(mul_(mul_(c, a), mul_(c, mod_(c, m))), m, mul_(mul_(mul_(c, a), c), mod_(c, m)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_123_0, temp_123_1)) by {
		lemma_mul_comm(mod_(mul_(c, a), m), mod_(a, m));
	}
	...
	assert(eq_(temp_124_0, temp_124_1)) by {
		lemma_add_comm(sub_(a, b), add_(mod_(d, m), d));
	}
	...
	assert(eq_(temp_125_0, temp_125_1)) by {
		lemma_mul_comm(sub_(mod_(b, m), d), mul_(mod_(d, m), d));
	}
	...
	assert(eq_(temp_126_0, temp_126_1)) by {
		lemma_mul_assoc(d, d, mul_(b, mod_(c, m)));
	...
	assert(eq_(temp_127_0, temp_127_1)) by {
		lemma_mul_assoc(a, b, sub_(mod_(c, m), mod_(c, m)));
	...
	assert(eq_(temp_128_0, temp_128_1)) by {
		cong_mul_(mul_(d, mod_(d, m)), mul_(c, d), mul_(mod_(d, m), d), mul_(c, d));
	...
	assert(eq_(temp_129_0, temp_129_1)) by {
		lemma_mul_assoc(mul_(mod_(d, m), b), d, d);
	}
	...
	assert(eq_(temp_130_0, temp_130_1)) by {
		...
		cong_mul_(add_(b, a), sub_(mod_(d, m), c), add_(b, a), sub_(mod_(add_(d, mul_(mul_(mul_(c, c), mul_(a, b)), m)), m), c));
		lemma_eq_ref(add_(b, a));
		cong_sub_(mod_(d, m), c, mod_(add_(d, mul_(mul_(mul_(c, c), mul_(a, b)), m)), m), c);
		lemma_eq_ref(c);
	}
	...
	assert(eq_(temp_131_0, temp_131_1)) by {
		...
		lemma_mul_assoc(c, a, mul_(as_elem(26), a));
	}
	...
	assert(eq_(temp_132_0, temp_132_1)) by {
		lemma_mul_comm(mul_(as_elem(72), c), mul_(b, as_elem(63)));
	}
	...
	assert(eq_(temp_134_0, temp_134_1)) by {
		cong_add_(mul_(d, mod_(c, m)), mul_(c, as_elem(26)), mul_(d, mod_(sub_(c, mul_(mul_(mul_(b, a), mul_(d, d)), m)), m)), mul_(c, as_elem(26)));
		lemma_mod_mul_vanish(c, mul_(mul_(b, a), mul_(d, d)), m);
		lemma_eq_ref(d);
		cong_mul_(d, mod_(c, m), d, mod_(sub_(c, mul_(mul_(mul_(b, a), mul_(d, d)), m)), m));
	...
	assert(eq_(temp_135_0, temp_135_1)) by {
		lemma_mul_comm(d, a);
		cong_sub_(mod_(mul_(d, a), m), mul_(b, a), mod_(mul_(a, d), m), mul_(b, a));
	...
	assert(eq_(temp_138_0, temp_138_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(a, b), mul_(b, c)), mul_(add_(d, c), mul_(c, mod_(b, m))), m);
	}
	...
	assert(eq_(temp_139_0, temp_139_1)) by {
		lemma_mul_comm(c, d);
		cong_mul_(mod_(mul_(c, d), m), mul_(b, c), mod_(mul_(d, c), m), mul_(b, c));
	...
	assert(eq_(temp_140_0, temp_140_1)) by {
		...
		cong_mul_(mul_(a, d), mod_(mul_(d, mod_(a, m)), m), mul_(a, d), mod_(mod_(mul_(a, d), m), m));
		lemma_eq_sym(mod_(mod_(mul_(a, d), m), m), mod_(mul_(d, mod_(a, m)), m));
		lemma_eq_ref(mul_(a, d));
	}
	...
	assert(eq_(temp_144_0, temp_144_1)) by {
		lemma_add_comm(mul_(c, c), mod_(mul_(c, d), m));
	}
	...
	assert(eq_(temp_145_0, temp_145_1)) by {
		lemma_mul_assoc(mul_(c, d), mod_(d, m), b);
	}
	...
	assert(eq_(temp_146_0, temp_146_1)) by {
		cong_mul_(mul_(as_elem(10), d), mul_(d, b), mul_(d, as_elem(10)), mul_(d, b));
	...
	assert(eq_(temp_147_0, temp_147_1)) by {
		lemma_mul_comm(d, c);
		cong_mul_(mul_(d, c), mod_(mul_(a, c), m), mul_(c, d), mod_(mul_(a, c), m));
	...
	assert(eq_(temp_148_0, temp_148_1)) by {
		lemma_mul_comm(mul_(a, c), mod_(mul_(a, c), m));
	}
