...
pub proof fn free_0(a: Elem, b: Elem, c: Elem, d: Elem, m: Elem)
{
	...
	assert(eq_(temp_1_0, temp_1_1)) by {
		lemma_mod_mul_noop(mul_(c, c), mul_(d, d), m);
	...
	assert(eq_(temp_2_0, temp_2_1)) by {
		lemma_mul_assoc(d, c, sub_(mod_(d, m), mod_(b, m)));
	...
	assert(eq_(temp_3_0, temp_3_1)) by {
		...
		cong_mul_(mod_(add_(c, b), m), sub_(c, c), mod_(add_(mod_(c, m), mod_(b, m)), m), sub_(c, c));
	...
	assert(eq_(temp_4_0, temp_4_1)) by {
		...
		cong_mul_(c, mod_(c, m), c, mod_(sub_(c, mul_(mul_(mul_(c, a), mul_(a, b)), m)), m));
		lemma_eq_ref(c);
		lemma_mod_mul_vanish(c, mul_(mul_(c, a), mul_(a, b)), m);
		cong_mul_(mul_(mod_(a, m), d), mul_(c, mod_(c, m)), mul_(mod_(a, m), d), mul_(c, mod_(sub_(c, mul_(mul_(mul_(c, a), mul_(a, b)), m)), m)));
	}
	...
	assert(eq_(temp_8_0, temp_8_1)) by {
		...
		cong_add_(mod_(add_(c, as_elem(84)), m), mul_(mod_(d, m), mod_(b, m)), mod_(add_(c, as_elem(84)), m), mul_(mod_(b, m), mod_(d, m)));
		lemma_eq_ref(mod_(add_(c, as_elem(84)), m));
	}
	...
	assert(eq_(temp_10_0, temp_10_1)) by {
		cong_add_(mul_(a, b), mul_(a, c), mul_(a, b), mul_(c, a));
		lemma_mul_comm(a, c);
	...
	assert(eq_(temp_12_0, temp_12_1)) by {
		lemma_mul_comm(sub_(a, a), mod_(mul_(c, d), m));
	}
	...
	assert(eq_(temp_13_0, temp_13_1)) by {
		lemma_mul_comm(d, d);
		lemma_mod_mul_vanish(d, mul_(add_(c, c), mul_(a, a)), m);
		cong_mul_(sub_(c, mod_(d, m)), mul_(d, d), sub_(c, mod_(sub_(d, mul_(mul_(add_(c, c), mul_(a, a)), m)), m)), mul_(d, d));
		cong_sub_(c, mod_(d, m), c, mod_(sub_(d, mul_(mul_(add_(c, c), mul_(a, a)), m)), m));
		lemma_eq_ref(c);
	}
	...
	assert(eq_(temp_20_0, temp_20_1)) by {
		lemma_mul_comm(sub_(b, d), mod_(mul_(mod_(a, m), c), m));
	}
	...
	assert(eq_(temp_21_0, temp_21_1)) by {
		lemma_mul_assoc(mod_(mul_(a, mod_(a, m)), m), b, mod_(c, m));
		cong_mod_(mul_(mod_(mul_(a, mod_(a, m)), m), mul_(b, mod_(c, m))), m, mul_(mul_(mod_(mul_(a, mod_(a, m)), m), b), mod_(c, m)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_22_0, temp_22_1)) by {
		lemma_mod_mul_vanish(a, mul_(mul_(c, c), add_(d, b)), m);
		cong_mul_(mul_(c, d), mul_(b, mod_(a, m)), mul_(c, d), mul_(b, mod_(sub_(a, mul_(mul_(mul_(c, c), add_(d, b)), m)), m)));
		lemma_eq_ref(mul_(c, d));
		cong_mul_(b, mod_(a, m), b, mod_(sub_(a, mul_(mul_(mul_(c, c), add_(d, b)), m)), m));
		lemma_eq_ref(b);
	}
	...
	assert(eq_(temp_23_0, temp_23_1)) by {
		lemma_mul_comm(c, c);
		lemma_mod_mul_vanish(a, mul_(mod_(mul_(d, b), m), mul_(c, a)), m);
		cong_mul_(mul_(c, c), sub_(mod_(a, m), b), mul_(c, c), sub_(mod_(sub_(a, mul_(mul_(mod_(mul_(d, b), m), mul_(c, a)), m)), m), b));
		cong_sub_(mod_(a, m), b, mod_(sub_(a, mul_(mul_(mod_(mul_(d, b), m), mul_(c, a)), m)), m), b);
		lemma_eq_ref(b);
	}
	...
	assert(eq_(temp_26_0, temp_26_1)) by {
		lemma_mod_mul_noop(c, as_elem(14), m);
		cong_mul_(mul_(a, b), mod_(mul_(c, mod_(as_elem(14), m)), m), mul_(a, b), mod_(mod_(mul_(c, as_elem(14)), m), m));
		lemma_eq_sym(mod_(mod_(mul_(c, as_elem(14)), m), m), mod_(mul_(c, mod_(as_elem(14), m)), m));
		lemma_eq_ref(mul_(a, b));
	}
	...
	assert(eq_(temp_27_0, temp_27_1)) by {
		lemma_mul_comm(c, d);
		cong_mul_(mod_(mul_(c, d), m), sub_(c, a), mod_(mul_(d, c), m), sub_(c, a));
	...
	assert(eq_(temp_28_0, temp_28_1)) by {
		cong_mod_(mul_(mul_(c, a), mul_(a, c)), m, mul_(mul_(a, c), mul_(a, c)), m);
		lemma_mul_comm(c, a);
		lemma_mul_comm(a, c);
		lemma_eq_ref(m);
	...
	assert(eq_(temp_32_0, temp_32_1)) by {
		cong_mul_(mul_(d, a), sub_(mod_(a, m), d), mul_(a, d), sub_(mod_(a, m), d));
		lemma_mul_comm(d, a);
	...
	assert(eq_(temp_34_0, temp_34_1)) by {
		lemma_mul_comm(mod_(add_(mod_(c, m), a), m), add_(a, d));
	}
	let temp_35_0 = (sub_((add_(a, d)), (mul_(c, d))));
	let temp_35_1 = (sub_((add_(a, d)), (mul_(d, c))));
	assert(eq_(temp_35_0, temp_35_1)) by {
		cong_sub_(add_(a, d), mul_(c, d), add_(a, d), mul_(d, c));
		lemma_mul_comm(c, d);
	...
	assert(eq_(temp_36_0, temp_36_1)) by {
		lemma_mod_mul_vanish(add_(add_(a, a), add_(c, b)), mul_(mul_(c, d), mul_(b, a)), m);
	}
	...
	assert(eq_(temp_43_0, temp_43_1)) by {
		lemma_mod_mul_vanish(d, add_(mul_(b, c), mul_(mod_(b, m), d)), m);
		cong_mul_(mul_(mod_(d, m), c), a, mul_(mod_(add_(mul_(add_(mul_(b, c), mul_(mod_(b, m), d)), m), d), m), c), a);
		lemma_eq_ref(c);
		cong_mul_(mod_(d, m), c, mod_(add_(mul_(add_(mul_(b, c), mul_(mod_(b, m), d)), m), d), m), c);
		lemma_eq_ref(a);
	}
	let temp_44_0 = (mul_((add_(a, c)), (mul_(a, b))));
	let temp_44_1 = (mul_((mul_(a, b)), (add_(a, c))));
	assert(eq_(temp_44_0, temp_44_1)) by {
		lemma_mul_comm(add_(a, c), mul_(a, b));
	}
	...
	assert(eq_(temp_47_0, temp_47_1)) by {
		lemma_mod_mul_vanish(mul_(d, a), mul_(add_(d, c), mul_(b, c)), m);
		cong_mul_(mod_(mul_(d, a), m), sub_(c, b), mod_(add_(mul_(mul_(add_(d, c), mul_(b, c)), m), mul_(d, a)), m), sub_(c, b));
	...
	assert(eq_(temp_48_0, temp_48_1)) by {
		cong_add_(mod_(mul_(mod_(b, m), a), m), mul_(c, a), mod_(mul_(mod_(add_(b, mul_(add_(mul_(c, b), mul_(d, mod_(c, m))), m)), m), a), m), mul_(c, a));
		lemma_mod_mul_vanish(b, add_(mul_(c, b), mul_(d, mod_(c, m))), m);
		cong_mod_(mul_(mod_(b, m), a), m, mul_(mod_(add_(b, mul_(add_(mul_(c, b), mul_(d, mod_(c, m))), m)), m), a), m);
		lemma_eq_ref(mul_(c, a));
		lemma_eq_ref(a);
		cong_mul_(mod_(b, m), a, mod_(add_(b, mul_(add_(mul_(c, b), mul_(d, mod_(c, m))), m)), m), a);
		lemma_eq_ref(m);
	}
	let temp_49_0 = (mul_((mul_(a, a)), (sub_(d, b))));
	let temp_49_1 = (mul_((sub_(d, b)), (mul_(a, a))));
	assert(eq_(temp_49_0, temp_49_1)) by {
		lemma_mul_comm(mul_(a, a), sub_(d, b));
	}
	...
	assert(eq_(temp_52_0, temp_52_1)) by {
		lemma_mod_mul_vanish(c, mul_(sub_(c, d), mul_(as_elem(28), a)), m);
		cong_mul_(sub_(c, a), add_(mod_(c, m), b), sub_(c, a), add_(mod_(add_(c, mul_(mul_(sub_(c, d), mul_(as_elem(28), a)), m)), m), b));
		lemma_eq_ref(b);
		lemma_eq_ref(sub_(c, a));
		cong_add_(mod_(c, m), b, mod_(add_(c, mul_(mul_(sub_(c, d), mul_(as_elem(28), a)), m)), m), b);
	}
	let temp_53_0 = (mod_((mul_((mul_(a, c)), (mul_(c, b)))), m));
	let temp_53_1 = (mod_((mul_((mul_((mul_(a, c)), c)), b)), m));
	assert(eq_(temp_53_0, temp_53_1)) by {
		lemma_mul_assoc(mul_(a, c), c, b);
		cong_mod_(mul_(mul_(a, c), mul_(c, b)), m, mul_(mul_(mul_(a, c), c), b), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_54_0, temp_54_1)) by {
		lemma_mul_dist(b, c, mod_(mul_(d, c), m));
		cong_mod_(mul_(add_(b, c), mod_(mul_(d, c), m)), m, add_(mul_(b, mod_(mul_(d, c), m)), mul_(c, mod_(mul_(d, c), m))), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_55_0, temp_55_1)) by {
		...
		cong_mul_(mul_(b, d), mul_(b, mod_(b, m)), mul_(b, d), mul_(b, mod_(sub_(b, mul_(mul_(mul_(d, b), mul_(b, b)), m)), m)));
		lemma_eq_ref(b);
		lemma_eq_ref(mul_(b, d));
		cong_mul_(b, mod_(b, m), b, mod_(sub_(b, mul_(mul_(mul_(d, b), mul_(b, b)), m)), m));
	}
	...
	assert(eq_(temp_57_0, temp_57_1)) by {
		cong_mul_(c, mod_(a, m), c, mod_(add_(a, mul_(mul_(add_(d, d), mul_(d, b)), m)), m));
		lemma_eq_ref(c);
		lemma_mul_comm(c, c);
		lemma_mod_mul_vanish(a, mul_(add_(d, d), mul_(d, b)), m);
		cong_mul_(mul_(c, c), mul_(c, mod_(a, m)), mul_(c, c), mul_(c, mod_(add_(a, mul_(mul_(add_(d, d), mul_(d, b)), m)), m)));
	}
	...
	assert(eq_(temp_63_0, temp_63_1)) by {
		lemma_add_comm(b, d);
		cong_mul_(mod_(add_(b, d), m), mul_(b, d), mod_(add_(d, b), m), mul_(b, d));
	...
	assert(eq_(temp_67_0, temp_67_1)) by {
		lemma_mod_mul_vanish(d, mul_(mul_(b, b), mul_(mod_(a, m), a)), m);
		cong_mul_(add_(d, mod_(d, m)), mul_(b, a), add_(d, mod_(add_(d, mul_(mul_(mul_(b, b), mul_(mod_(a, m), a)), m)), m)), mul_(b, a));
		lemma_eq_ref(d);
		cong_add_(d, mod_(d, m), d, mod_(add_(d, mul_(mul_(mul_(b, b), mul_(mod_(a, m), a)), m)), m));
	...
	assert(eq_(temp_68_0, temp_68_1)) by {
		...
		lemma_mul_comm(a, a);
		cong_sub_(mul_(d, mod_(b, m)), mul_(a, a), mul_(mod_(b, m), d), mul_(a, a));
	}
	...
	assert(eq_(temp_70_0, temp_70_1)) by {
		lemma_mul_comm(mul_(b, c), mul_(a, a));
	}
	...
	assert(eq_(temp_81_0, temp_81_1)) by {
		lemma_mul_assoc(as_elem(39), c, sub_(b, a));
	...
	assert(eq_(temp_82_0, temp_82_1)) by {
		lemma_mul_assoc(c, a, mul_(d, mod_(as_elem(98), m)));
		cong_mod_(mul_(mul_(c, a), mul_(d, mod_(as_elem(98), m))), m, mul_(c, mul_(a, mul_(d, mod_(as_elem(98), m)))), m);
		lemma_eq_ref(m);
		lemma_eq_sym(mul_(c, mul_(a, mul_(d, mod_(as_elem(98), m)))), mul_(mul_(c, a), mul_(d, mod_(as_elem(98), m))));
	}
	...
	assert(eq_(temp_85_0, temp_85_1)) by {
		lemma_mod_mul_vanish(b, mul_(sub_(a, a), add_(c, c)), m);
		cong_mul_(mul_(b, mod_(b, m)), mul_(d, a), mul_(b, mod_(add_(b, mul_(mul_(sub_(a, a), add_(c, c)), m)), m)), mul_(d, a));
		lemma_eq_ref(b);
		cong_mul_(b, mod_(b, m), b, mod_(add_(b, mul_(mul_(sub_(a, a), add_(c, c)), m)), m));
		lemma_eq_ref(mul_(d, a));
	}
	let temp_86_0 = (mul_((mul_((mod_(c, m)), c)), (mul_(a, b))));
	let temp_86_1 = (mul_((mul_((mul_((mod_(c, m)), c)), a)), b));
	assert(eq_(temp_86_0, temp_86_1)) by {
		lemma_mul_assoc(mul_(mod_(c, m), c), a, b);
	}
	...
	assert(eq_(temp_88_0, temp_88_1)) by {
		lemma_mul_comm(b, b);
		lemma_mod_mul_vanish(c, mul_(mul_(a, mod_(b, m)), mul_(a, d)), m);
		cong_mul_(mul_(mod_(c, m), a), mul_(b, b), mul_(mod_(add_(c, mul_(mul_(mul_(a, mod_(b, m)), mul_(a, d)), m)), m), a), mul_(b, b));
		cong_mul_(mod_(c, m), a, mod_(add_(c, mul_(mul_(mul_(a, mod_(b, m)), mul_(a, d)), m)), m), a);
		lemma_eq_ref(a);
	}
	let temp_89_0 = (mul_((mul_(a, c)), (mod_((mul_(d, d)), m))));
	let temp_89_1 = (mul_((mul_(a, c)), (mod_((add_((mul_((mul_((mul_(b, a)), c)), m)), (mul_(d, d)))), m))));
	assert(eq_(temp_89_0, temp_89_1)) by {
		lemma_mod_mul_vanish(mul_(d, d), mul_(mul_(b, a), c), m);
		cong_mul_(mul_(a, c), mod_(mul_(d, d), m), mul_(a, c), mod_(add_(mul_(mul_(mul_(b, a), c), m), mul_(d, d)), m));
		lemma_eq_ref(mul_(a, c));
	}
	let temp_90_0 = (sub_((mul_(b, b)), (mul_(a, c))));
	let temp_90_1 = (sub_((mul_(b, b)), (mul_(c, a))));
	assert(eq_(temp_90_0, temp_90_1)) by {
		cong_sub_(mul_(b, b), mul_(a, c), mul_(b, b), mul_(c, a));
		lemma_mul_comm(a, c);
	...
	assert(eq_(temp_91_0, temp_91_1)) by {
		lemma_mul_assoc(mod_(mul_(b, b), m), b, d);
	}
	...
	assert(eq_(temp_95_0, temp_95_1)) by {
		lemma_mul_comm(c, a);
		cong_sub_(mod_(mul_(d, c), m), mul_(c, a), mod_(mul_(d, c), m), mul_(a, c));
	...
	assert(eq_(temp_97_0, temp_97_1)) by {
		...
		cong_mul_(mul_(d, b), mul_(as_elem(73), c), mul_(d, b), mul_(c, as_elem(73)));
	...
	assert(eq_(temp_98_0, temp_98_1)) by {
		lemma_mul_comm(mul_(a, d), mul_(c, b));
	}
	...
	assert(eq_(temp_100_0, temp_100_1)) by {
		lemma_mod_mul_vanish(mul_(a, a), sub_(add_(b, b), sub_(mod_(b, m), b)), m);
		cong_mul_(mod_(mul_(a, a), m), mul_(b, d), mod_(sub_(mul_(a, a), mul_(sub_(add_(b, b), sub_(mod_(b, m), b)), m)), m), mul_(b, d));
		lemma_eq_ref(mul_(b, d));
	}
	...
	assert(eq_(temp_101_0, temp_101_1)) by {
		...
		cong_mul_(sub_(b, a), mod_(mul_(mod_(d, m), mod_(c, m)), m), sub_(b, a), mod_(mul_(mod_(c, m), mod_(d, m)), m));
		lemma_eq_ref(m);
	...
	assert(eq_(temp_102_0, temp_102_1)) by {
		lemma_mul_assoc(mod_(mul_(b, b), m), c, d);
	}
	...
	assert(eq_(temp_103_0, temp_103_1)) by {
		lemma_mod_mul_vanish(mul_(a, mod_(b, m)), sub_(b, mul_(mod_(c, m), c)), m);
		cong_mul_(mul_(b, d), mod_(mul_(a, mod_(b, m)), m), mul_(b, d), mod_(add_(mul_(a, mod_(b, m)), mul_(sub_(b, mul_(mod_(c, m), c)), m)), m));
		lemma_eq_ref(mul_(b, d));
	}
	...
	assert(eq_(temp_104_0, temp_104_1)) by {
		lemma_mul_comm(b, d);
		cong_add_(sub_(mod_(a, m), b), mul_(b, d), sub_(mod_(a, m), b), mul_(d, b));
	...
	assert(eq_(temp_105_0, temp_105_1)) by {
		cong_add_(b, mul_(d, b), b, mul_(b, d));
		lemma_mul_comm(d, b);
		lemma_eq_ref(b);
	}
	...
	assert(eq_(temp_108_0, temp_108_1)) by {
		cong_mul_(d, mul_(mod_(d, m), d), d, mul_(d, mod_(d, m)));
	...
	assert(eq_(temp_109_0, temp_109_1)) by {
		lemma_mul_assoc(sub_(b, c), c, mod_(d, m));
	}
