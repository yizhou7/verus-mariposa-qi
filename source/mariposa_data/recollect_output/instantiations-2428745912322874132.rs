...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_associative(a0, b0, c0 * a0);
		lemma_mul_is_associative(((d0 * d0) - (b0 + c0)) * ((d0 * d0) * (b0 - d0)), (b0 * b0) * (a0 * d0), a0 * (b0 * (c0 * a0)));
		lemma_mul_is_associative(((d0 * d0) - (b0 + c0)) * ((d0 * d0) * (b0 - d0)), (b0 * b0) * (a0 * d0), (a0 * b0) * (c0 * a0));
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_commutative(23, a1);
		lemma_mul_is_associative(23 * a1, c1 * d1, (a1 - c1) * (b1 * c1));
		lemma_mul_is_associative(a1 * 23, c1 * d1, (a1 - c1) * (b1 * c1));
	}
	let temp_2_0 = ((((d2-d2)*(c2-d2))*((b2+a2)*(c2*d2)))+(((d2*c2)*c2)*d2));
	let temp_2_1 = ((((d2-d2)*(c2-d2))*((b2+a2)*(c2*d2)))+((c2*(d2*c2))*d2));
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_commutative(c2, d2 * c2);
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_commutative(b3 * a3, b3 * d3);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_associative(c5, c5, c5 * b5);
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_distributive(((d6 * d6) * (a6 * c6)) * ((a6 - a6) + (c6 * c6)), (a6 + d6) * (d6 * b6), (a6 * c6) * (a6 * a6));
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_distributive(b7 + b7, a7 - b7, (d7 * b7) * (a7 * b7));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_associative(b9 * a9, d9 * c9, a9 * (a9 * b9));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_commutative(((a10 * b10) - (a10 + b10)) * ((d10 * c10) * (c10 * d10)), ((d10 + c10) * (a10 * a10)) * ((d10 * d10) * (d10 + d10)));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_commutative(a11 * b11, c11 * a11);
		lemma_mul_is_associative((a11 * b11) * (c11 * a11), (d11 * c11) + (a11 * d11), ((a11 * b11) * (b11 - d11)) * ((b11 * d11) * (c11 - c11)));
		lemma_mul_is_associative((c11 * a11) * (a11 * b11), (d11 * c11) + (a11 * d11), ((a11 * b11) * (b11 - d11)) * ((b11 * d11) * (c11 - c11)));
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_associative(b12 * d12, b12, b12);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_commutative(d13 * d13, c13 - b13);
		lemma_mul_is_associative(((a13 * 39) + (b13 * a13)) * ((a13 * d13) + (a13 * a13)), a13 * (a13 * d13), (d13 * d13) * (c13 - b13));
		lemma_mul_is_associative(((a13 * 39) + (b13 * a13)) * ((a13 * d13) + (a13 * a13)), a13 * (a13 * d13), (c13 - b13) * (d13 * d13));
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_commutative(c14 * d14, b14 * b14);
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_commutative(a15 + ((91 * a15) * (a15 * d15)), ((a15 * a15) * (d15 * b15)) * ((c15 * b15) * (b15 + 72)));
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_associative(d16, b16, a16 + d16);
		lemma_mul_is_associative(d16 * (b16 * (a16 + d16)), (d16 * d16) * (b16 - a16), ((c16 * d16) * (b16 * a16)) * ((d16 * a16) * (b16 * a16)));
		lemma_mul_is_associative((d16 * b16) * (a16 + d16), (d16 * d16) * (b16 - a16), ((c16 * d16) * (b16 * a16)) * ((d16 * a16) * (b16 * a16)));
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_commutative(b18 - c18, b18 - a18);
		lemma_mul_is_associative(((b18 * a18) * (c18 * c18)) * ((c18 - d18) * d18), (a18 * c18) - (b18 * a18), (b18 - c18) * (b18 - a18));
		lemma_mul_is_associative(((b18 * a18) * (c18 * c18)) * ((c18 - d18) * d18), (a18 * c18) - (b18 * a18), (b18 - a18) * (b18 - c18));
	}
