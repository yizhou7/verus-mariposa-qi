...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_commutative(a0 * b0, a0 - d0);
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_associative(b3, a3, b3 * a3);
		lemma_mul_is_associative(((d3 + c3) * b3) + ((d3 * a3) * (d3 - 92)), (c3 * d3) * (a3 - c3), b3 * (a3 * (b3 * a3)));
		lemma_mul_is_associative(((d3 + c3) * b3) + ((d3 * a3) * (d3 - 92)), (c3 * d3) * (a3 - c3), (b3 * a3) * (b3 * a3));
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_distributive((b5 * a5) * d5, (b5 * c5) * (c5 * b5), ((b5 + c5) * a5) * (d5 * (b5 - d5)));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_associative(c6 * d6, c6, a6);
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_associative(((a8 * a8) * (b8 * d8)) + (a8 * (b8 * c8)), (a8 * a8) + (c8 * c8), (b8 * d8) * b8);
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		...
		lemma_mul_is_associative(((a9 * c9) * (b9 * b9)) - ((b9 * d9) * (c9 + a9)), (d9 * b9) * (b9 - c9), (c9 * d9) * (d9 * b9));
		lemma_mul_is_associative(((a9 * c9) * (b9 * b9)) - ((b9 * d9) * (c9 + a9)), (d9 * b9) * (b9 - c9), (c9 * d9) * (b9 * d9));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_distributive(a10, 35 * d10, a10 * d10);
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_commutative(a11 * b11, c11 * b11);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		...
		lemma_mul_is_associative((c12 * d12) * (a12 * d12), (c12 * b12) * (a12 * c12), ((a12 * a12) + b12) * ((b12 * a12) * d12));
		lemma_mul_is_associative((c12 * d12) * (d12 * a12), (c12 * b12) * (a12 * c12), ((a12 * a12) + b12) * ((b12 * a12) * d12));
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_associative(d13 * c13, a13, c13);
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_commutative((c14 * c14) - (b14 * a14), (a14 * 67) * (d14 * c14));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_commutative((77 * a15) * (a15 * a15), c15 + (a15 * c15));
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_associative(b16, a16, b16 * c16);
		lemma_mul_is_associative(((d16 * b16) * (c16 - c16)) * ((d16 * b16) * (d16 - d16)), (a16 + d16) * (d16 * d16), b16 * (a16 * (b16 * c16)));
		lemma_mul_is_associative(((d16 * b16) * (c16 - c16)) * ((d16 * b16) * (d16 - d16)), (a16 + d16) * (d16 * d16), (b16 * a16) * (b16 * c16));
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_associative(b17 * a17, b17 * b17, b17 * (19 - d17));
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_associative(a18, d18, a18 + a18);
	}
