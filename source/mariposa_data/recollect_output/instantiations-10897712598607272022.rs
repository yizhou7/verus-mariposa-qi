...
pub proof fn free_0(a: Elem, b: Elem, c: Elem, d: Elem, m: Elem)
{
	...
	assert(eq_(temp_1_0, temp_1_1)) by {
		...
		lemma_mod_mul_vanish(mul_(c, c), mul_(mul_(d, b), mod_(mul_(c, d), m)), m);
		cong_mul_(mul_(a, c), mod_(mul_(c, c), m), mul_(a, c), mod_(add_(mul_(c, c), mul_(mul_(mul_(d, b), mod_(mul_(c, d), m)), m)), m));
	}
	let temp_2_0 = (mod_((mul_((mul_(b, b)), (mul_(a, a)))), m));
	let temp_2_1 = (mod_((mul_(b, (mul_(b, (mul_(a, a)))))), m));
	assert(eq_(temp_2_0, temp_2_1)) by {
		lemma_mul_assoc(b, b, mul_(a, a));
		cong_mod_(mul_(mul_(b, b), mul_(a, a)), m, mul_(b, mul_(b, mul_(a, a))), m);
		lemma_eq_sym(mul_(b, mul_(b, mul_(a, a))), mul_(mul_(b, b), mul_(a, a)));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_3_0, temp_3_1)) by {
		lemma_mul_comm(c, a);
		cong_mul_(mod_(mul_(c, a), m), mul_(d, b), mod_(mul_(a, c), m), mul_(d, b));
	...
	assert(eq_(temp_4_0, temp_4_1)) by {
		lemma_mul_assoc(a, a, add_(d, a));
		cong_mod_(mul_(mul_(a, a), add_(d, a)), m, mul_(a, mul_(a, add_(d, a))), m);
		lemma_eq_sym(mul_(a, mul_(a, add_(d, a))), mul_(mul_(a, a), add_(d, a)));
		lemma_eq_ref(m);
	}
	let temp_5_0 = (mul_((mul_(c, (mod_(b, m)))), (mul_(c, d))));
	let temp_5_1 = (mul_(c, (mul_((mod_(b, m)), (mul_(c, d))))));
	assert(eq_(temp_5_0, temp_5_1)) by {
		lemma_mul_assoc(c, mod_(b, m), mul_(c, d));
	...
	assert(eq_(temp_7_0, temp_7_1)) by {
		...
		cong_mul_(mul_(as_elem(40), a), mul_(b, mod_(b, m)), mul_(as_elem(40), a), mul_(mod_(b, m), b));
		lemma_eq_ref(mul_(as_elem(40), a));
	}
	...
	assert(eq_(temp_9_0, temp_9_1)) by {
		...
		cong_sub_(mul_(a, d), mul_(mod_(b, m), a), mul_(a, d), mul_(mod_(sub_(b, mul_(add_(mul_(b, a), mul_(a, a)), m)), m), a));
		lemma_eq_ref(a);
		lemma_eq_ref(mul_(a, d));
		cong_mul_(mod_(b, m), a, mod_(sub_(b, mul_(add_(mul_(b, a), mul_(a, a)), m)), m), a);
	}
	let temp_10_0 = (mod_((mul_((mul_(a, a)), (sub_(b, d)))), m));
	let temp_10_1 = (mod_((mul_(a, (mul_(a, (sub_(b, d)))))), m));
	assert(eq_(temp_10_0, temp_10_1)) by {
		lemma_mul_assoc(a, a, sub_(b, d));
		cong_mod_(mul_(mul_(a, a), sub_(b, d)), m, mul_(a, mul_(a, sub_(b, d))), m);
		lemma_eq_sym(mul_(a, mul_(a, sub_(b, d))), mul_(mul_(a, a), sub_(b, d)));
		lemma_eq_ref(m);
	}
	let temp_11_0 = (mul_((mul_(as_elem(75), c)), (mul_(b, c))));
	let temp_11_1 = (mul_((mul_(b, c)), (mul_(as_elem(75), c))));
	assert(eq_(temp_11_0, temp_11_1)) by {
		lemma_mul_comm(mul_(as_elem(75), c), mul_(b, c));
	}
	...
	assert(eq_(temp_13_0, temp_13_1)) by {
		cong_mul_(mul_(d, d), add_(b, c), mul_(d, d), add_(c, b));
		lemma_add_comm(b, c);
		lemma_mul_comm(d, d);
	}
	...
	assert(eq_(temp_19_0, temp_19_1)) by {
		lemma_mod_mul_vanish(a, mul_(sub_(mod_(a, m), mod_(c, m)), mul_(mod_(a, m), a)), m);
		cong_mul_(mul_(c, a), add_(mod_(a, m), a), mul_(c, a), add_(mod_(sub_(a, mul_(mul_(sub_(mod_(a, m), mod_(c, m)), mul_(mod_(a, m), a)), m)), m), a));
		lemma_eq_ref(a);
		cong_add_(mod_(a, m), a, mod_(sub_(a, mul_(mul_(sub_(mod_(a, m), mod_(c, m)), mul_(mod_(a, m), a)), m)), m), a);
	...
	assert(eq_(temp_21_0, temp_21_1)) by {
		...
		cong_sub_(mul_(b, mod_(b, m)), mul_(mod_(c, m), c), mul_(b, mod_(b, m)), mul_(c, mod_(c, m)));
	...
	assert(eq_(temp_22_0, temp_22_1)) by {
		lemma_mod_mul_vanish(b, mul_(mul_(mod_(d, m), b), add_(a, mod_(a, m))), m);
		cong_mul_(mul_(c, a), mul_(c, mod_(b, m)), mul_(c, a), mul_(c, mod_(add_(mul_(mul_(mul_(mod_(d, m), b), add_(a, mod_(a, m))), m), b), m)));
		cong_mul_(c, mod_(b, m), c, mod_(add_(mul_(mul_(mul_(mod_(d, m), b), add_(a, mod_(a, m))), m), b), m));
		lemma_eq_ref(c);
		lemma_eq_ref(mul_(c, a));
	}
	...
	assert(eq_(temp_24_0, temp_24_1)) by {
		lemma_add_comm(c, c);
		lemma_add_comm(d, a);
		cong_mul_(add_(c, c), mod_(add_(d, a), m), add_(c, c), mod_(add_(a, d), m));
	...
	assert(eq_(temp_25_0, temp_25_1)) by {
		lemma_mod_mul_vanish(b, mul_(mul_(mod_(c, m), b), sub_(b, b)), m);
		cong_mul_(mul_(b, mod_(b, m)), mul_(b, mod_(c, m)), mul_(b, mod_(add_(b, mul_(mul_(mul_(mod_(c, m), b), sub_(b, b)), m)), m)), mul_(b, mod_(c, m)));
		lemma_eq_ref(mul_(b, mod_(c, m)));
		cong_mul_(b, mod_(b, m), b, mod_(add_(b, mul_(mul_(mul_(mod_(c, m), b), sub_(b, b)), m)), m));
		lemma_eq_ref(b);
	}
	...
	assert(eq_(temp_26_0, temp_26_1)) by {
		lemma_mod_mul_vanish(c, add_(mul_(a, b), mul_(d, b)), m);
		cong_add_(mul_(mod_(c, m), a), mul_(b, c), mul_(mod_(sub_(c, mul_(add_(mul_(a, b), mul_(d, b)), m)), m), a), mul_(b, c));
		lemma_eq_ref(a);
		cong_mul_(mod_(c, m), a, mod_(sub_(c, mul_(add_(mul_(a, b), mul_(d, b)), m)), m), a);
	...
	assert(eq_(temp_28_0, temp_28_1)) by {
		lemma_add_comm(mul_(c, mod_(a, m)), c);
	}
	...
	assert(eq_(temp_30_0, temp_30_1)) by {
		lemma_mod_mul_vanish(mul_(mod_(c, m), d), add_(mul_(c, a), mul_(a, a)), m);
		cong_mul_(mod_(mul_(mod_(c, m), d), m), mul_(b, a), mod_(add_(mul_(add_(mul_(c, a), mul_(a, a)), m), mul_(mod_(c, m), d)), m), mul_(b, a));
	...
	assert(eq_(temp_32_0, temp_32_1)) by {
		lemma_mul_comm(a, a);
		lemma_mod_mul_vanish(c, mul_(mod_(sub_(b, a), m), mul_(b, d)), m);
		cong_mul_(sub_(d, mod_(c, m)), mul_(a, a), sub_(d, mod_(add_(c, mul_(mul_(mod_(sub_(b, a), m), mul_(b, d)), m)), m)), mul_(a, a));
		lemma_eq_ref(d);
		cong_sub_(d, mod_(c, m), d, mod_(add_(c, mul_(mul_(mod_(sub_(b, a), m), mul_(b, d)), m)), m));
	}
	...
	assert(eq_(temp_34_0, temp_34_1)) by {
		cong_sub_(sub_(d, a), mul_(c, b), sub_(d, a), mul_(b, c));
		lemma_mul_comm(c, b);
	...
	assert(eq_(temp_36_0, temp_36_1)) by {
		cong_mul_(mul_(b, d), add_(d, a), mul_(d, b), add_(d, a));
		lemma_mul_comm(b, d);
	...
	assert(eq_(temp_40_0, temp_40_1)) by {
		lemma_mul_comm(mul_(c, d), mul_(c, mod_(b, m)));
	}
	...
	assert(eq_(temp_44_0, temp_44_1)) by {
		cong_mul_(sub_(d, b), add_(a, b), sub_(d, b), add_(b, a));
		lemma_add_comm(a, b);
	...
	assert(eq_(temp_45_0, temp_45_1)) by {
		cong_mul_(add_(a, b), mul_(b, b), add_(b, a), mul_(b, b));
		lemma_add_comm(a, b);
		lemma_mul_comm(b, b);
	}
	...
	assert(eq_(temp_48_0, temp_48_1)) by {
		lemma_mul_assoc(mul_(mod_(as_elem(71), m), c), c, d);
	}
	...
	assert(eq_(temp_51_0, temp_51_1)) by {
		lemma_mul_comm(c, b);
		cong_add_(mul_(c, b), mod_(add_(mod_(d, m), a), m), mul_(b, c), mod_(add_(mod_(d, m), a), m));
		lemma_eq_ref(mod_(add_(mod_(d, m), a), m));
	}
	let temp_52_0 = (mul_((mul_((mod_(b, m)), a)), (mul_(b, (mod_(b, m))))));
	let temp_52_1 = (mul_((mul_(b, (mod_(b, m)))), (mul_((mod_(b, m)), a))));
	assert(eq_(temp_52_0, temp_52_1)) by {
		lemma_mul_comm(mul_(mod_(b, m), a), mul_(b, mod_(b, m)));
	}
	...
	assert(eq_(temp_53_0, temp_53_1)) by {
		...
		lemma_mul_assoc(as_elem(89), d, mul_(d, d));
	}
	...
	assert(eq_(temp_58_0, temp_58_1)) by {
		lemma_mul_comm(mul_(d, mod_(a, m)), mul_(c, c));
	}
	let temp_59_0 = (sub_((mod_((mul_(a, d)), m)), (mul_(b, c))));
	let temp_59_1 = (sub_((mod_((mul_(d, a)), m)), (mul_(b, c))));
	assert(eq_(temp_59_0, temp_59_1)) by {
		lemma_mul_comm(a, d);
		cong_sub_(mod_(mul_(a, d), m), mul_(b, c), mod_(mul_(d, a), m), mul_(b, c));
	...
	assert(eq_(temp_61_0, temp_61_1)) by {
		lemma_mod_mul_vanish(b, sub_(add_(b, b), mul_(b, d)), m);
		cong_mul_(mod_(mul_(a, d), m), mod_(mul_(d, mod_(b, m)), m), mod_(mul_(a, d), m), mod_(mul_(d, mod_(add_(b, mul_(sub_(add_(b, b), mul_(b, d)), m)), m)), m));
		lemma_eq_ref(mod_(mul_(a, d), m));
		cong_mod_(mul_(d, mod_(b, m)), m, mul_(d, mod_(add_(b, mul_(sub_(add_(b, b), mul_(b, d)), m)), m)), m);
		cong_mul_(d, mod_(b, m), d, mod_(add_(b, mul_(sub_(add_(b, b), mul_(b, d)), m)), m));
		lemma_eq_ref(d);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_65_0, temp_65_1)) by {
		lemma_mod_mul_vanish(d, mul_(mul_(d, mod_(b, m)), mul_(b, d)), m);
		cong_mul_(mul_(a, mod_(d, m)), mul_(a, d), mul_(a, mod_(add_(d, mul_(mul_(mul_(d, mod_(b, m)), mul_(b, d)), m)), m)), mul_(a, d));
		lemma_eq_ref(a);
		cong_mul_(a, mod_(d, m), a, mod_(add_(d, mul_(mul_(mul_(d, mod_(b, m)), mul_(b, d)), m)), m));
		lemma_eq_ref(mul_(a, d));
	}
	...
	assert(eq_(temp_67_0, temp_67_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(d, a), mul_(b, mod_(b, m))), add_(mul_(b, d), sub_(b, a)), m);
	}
	...
	assert(eq_(temp_70_0, temp_70_1)) by {
		lemma_mul_assoc(b, b, sub_(mod_(b, m), a));
		cong_mod_(mul_(mul_(b, b), sub_(mod_(b, m), a)), m, mul_(b, mul_(b, sub_(mod_(b, m), a))), m);
		lemma_eq_sym(mul_(b, mul_(b, sub_(mod_(b, m), a))), mul_(mul_(b, b), sub_(mod_(b, m), a)));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_72_0, temp_72_1)) by {
		cong_mul_(mul_(mod_(c, m), a), mul_(a, c), mul_(mod_(c, m), a), mul_(c, a));
		lemma_mul_comm(a, c);
	...
	assert(eq_(temp_73_0, temp_73_1)) by {
		...
		cong_mul_(mul_(c, mod_(a, m)), sub_(mod_(b, m), a), mul_(mod_(a, m), c), sub_(mod_(b, m), a));
	...
	assert(eq_(temp_74_0, temp_74_1)) by {
		lemma_mul_assoc(sub_(mod_(b, m), a), d, d);
		cong_mod_(mul_(sub_(mod_(b, m), a), mul_(d, d)), m, mul_(mul_(sub_(mod_(b, m), a), d), d), m);
		lemma_eq_ref(m);
	}
	let temp_75_0 = (mod_((mul_((mul_(c, a)), (mul_(d, as_elem(93))))), m));
	let temp_75_1 = (mod_((mul_(c, (mul_(a, (mul_(d, as_elem(93))))))), m));
	assert(eq_(temp_75_0, temp_75_1)) by {
		lemma_mul_assoc(c, a, mul_(d, as_elem(93)));
		cong_mod_(mul_(mul_(c, a), mul_(d, as_elem(93))), m, mul_(c, mul_(a, mul_(d, as_elem(93)))), m);
		lemma_eq_sym(mul_(c, mul_(a, mul_(d, as_elem(93)))), mul_(mul_(c, a), mul_(d, as_elem(93))));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_81_0, temp_81_1)) by {
		lemma_mod_mul_vanish(d, add_(mod_(mul_(b, b), m), mul_(d, mod_(d, m))), m);
		cong_mul_(mul_(a, c), mul_(a, mod_(d, m)), mul_(a, c), mul_(a, mod_(sub_(d, mul_(add_(mod_(mul_(b, b), m), mul_(d, mod_(d, m))), m)), m)));
		lemma_eq_ref(a);
		lemma_eq_ref(mul_(a, c));
		cong_mul_(a, mod_(d, m), a, mod_(sub_(d, mul_(add_(mod_(mul_(b, b), m), mul_(d, mod_(d, m))), m)), m));
	}
	let temp_82_0 = (mul_((sub_(d, c)), (mul_(a, a))));
	let temp_82_1 = (mul_((mul_(a, a)), (sub_(d, c))));
	assert(eq_(temp_82_0, temp_82_1)) by {
		lemma_mul_comm(sub_(d, c), mul_(a, a));
	}
	...
	assert(eq_(temp_83_0, temp_83_1)) by {
		lemma_mod_mul_vanish(d, mod_(mul_(mul_(a, b), mul_(d, d)), m), m);
		cong_mul_(mul_(b, a), mul_(mod_(d, m), mod_(b, m)), mul_(b, a), mul_(mod_(add_(d, mul_(mod_(mul_(mul_(a, b), mul_(d, d)), m), m)), m), mod_(b, m)));
		lemma_eq_ref(mod_(b, m));
		lemma_eq_ref(mul_(b, a));
		cong_mul_(mod_(d, m), mod_(b, m), mod_(add_(d, mul_(mod_(mul_(mul_(a, b), mul_(d, d)), m), m)), m), mod_(b, m));
	}
	...
	assert(eq_(temp_85_0, temp_85_1)) by {
		lemma_mul_comm(mul_(b, mod_(b, m)), mul_(c, b));
	}
	...
	assert(eq_(temp_87_0, temp_87_1)) by {
		lemma_mul_comm(d, c);
		cong_mod_(add_(mul_(d, c), mul_(c, c)), m, add_(mul_(c, d), mul_(c, c)), m);
		lemma_eq_ref(mul_(c, c));
		cong_add_(mul_(d, c), mul_(c, c), mul_(c, d), mul_(c, c));
		lemma_eq_ref(m);
	}
	let temp_88_0 = (mul_((mul_(a, (mod_(c, m)))), (mul_(c, b))));
	let temp_88_1 = (mul_(a, (mul_((mod_(c, m)), (mul_(c, b))))));
	assert(eq_(temp_88_0, temp_88_1)) by {
		lemma_mul_assoc(a, mod_(c, m), mul_(c, b));
	...
	assert(eq_(temp_89_0, temp_89_1)) by {
		cong_mod_(mul_(mul_(d, c), mul_(d, c)), m, mul_(mul_(c, d), mul_(d, c)), m);
		lemma_mul_comm(d, c);
		lemma_mul_comm(c, d);
		lemma_eq_ref(m);
		cong_mul_(mul_(d, c), mul_(d, c), mul_(c, d), mul_(d, c));
	...
	assert(eq_(temp_90_0, temp_90_1)) by {
		lemma_mod_mul_vanish(c, mod_(sub_(mul_(a, c), mul_(a, a)), m), m);
		cong_mul_(mul_(mod_(c, m), c), mul_(d, c), mul_(mod_(add_(mul_(mod_(sub_(mul_(a, c), mul_(a, a)), m), m), c), m), c), mul_(d, c));
		cong_mul_(mod_(c, m), c, mod_(add_(mul_(mod_(sub_(mul_(a, c), mul_(a, a)), m), m), c), m), c);
	...
	assert(eq_(temp_91_0, temp_91_1)) by {
		lemma_mul_assoc(mod_(mul_(mod_(c, m), a), m), mod_(a, m), d);
	}
	let temp_92_0 = (mul_((mod_((mul_(c, c)), m)), (mul_(b, c))));
	let temp_92_1 = (mul_((mod_((mul_(c, c)), m)), (mul_(c, b))));
	assert(eq_(temp_92_0, temp_92_1)) by {
		cong_mul_(mod_(mul_(c, c), m), mul_(b, c), mod_(mul_(c, c), m), mul_(c, b));
		lemma_mul_comm(b, c);
	...
	assert(eq_(temp_95_0, temp_95_1)) by {
		cong_mul_(mod_(a, m), b, mod_(sub_(a, mul_(mul_(mul_(b, c), mul_(a, mod_(b, m))), m)), m), b);
		lemma_eq_ref(add_(mod_(d, m), c));
		lemma_eq_ref(b);
		cong_mul_(mul_(mod_(a, m), b), add_(mod_(d, m), c), mul_(mod_(sub_(a, mul_(mul_(mul_(b, c), mul_(a, mod_(b, m))), m)), m), b), add_(mod_(d, m), c));
		lemma_mod_mul_vanish(a, mul_(mul_(b, c), mul_(a, mod_(b, m))), m);
	}
	...
	assert(eq_(temp_96_0, temp_96_1)) by {
		lemma_mul_comm(d, b);
		lemma_mul_comm(d, d);
		cong_mul_(mod_(mul_(d, b), m), mul_(d, d), mod_(mul_(b, d), m), mul_(d, d));
	...
	assert(eq_(temp_97_0, temp_97_1)) by {
		lemma_mul_comm(a, a);
		lemma_mul_comm(a, mod_(as_elem(21), m));
		cong_mul_(mul_(a, a), mul_(a, mod_(as_elem(21), m)), mul_(a, a), mul_(mod_(as_elem(21), m), a));
	}
	...
	assert(eq_(temp_98_0, temp_98_1)) by {
		...
		cong_mul_(mod_(mul_(mod_(d, m), b), m), mul_(a, d), mod_(mul_(b, mod_(d, m)), m), mul_(a, d));
		lemma_eq_sym(mod_(mul_(b, mod_(d, m)), m), mod_(mul_(mod_(d, m), b), m));
	...
	assert(eq_(temp_99_0, temp_99_1)) by {
		lemma_mod_mul_vanish(mul_(c, a), mul_(mul_(b, d), mul_(as_elem(41), b)), m);
		cong_mul_(mul_(c, b), mod_(mul_(c, a), m), mul_(c, b), mod_(sub_(mul_(c, a), mul_(mul_(mul_(b, d), mul_(as_elem(41), b)), m)), m));
	...
	assert(eq_(temp_100_0, temp_100_1)) by {
		lemma_add_comm(b, c);
		cong_mul_(mod_(add_(b, c), m), mul_(c, b), mod_(add_(c, b), m), mul_(c, b));
		lemma_eq_ref(m);
	...
	assert(eq_(temp_103_0, temp_103_1)) by {
		lemma_mul_assoc(mod_(as_elem(45), m), d, sub_(d, mod_(b, m)));
	...
	assert(eq_(temp_104_0, temp_104_1)) by {
		cong_sub_(mul_(d, c), mul_(a, b), mul_(d, c), mul_(b, a));
		lemma_mul_comm(a, b);
		lemma_eq_ref(mul_(d, c));
	}
	...
	assert(eq_(temp_105_0, temp_105_1)) by {
		lemma_mul_comm(b, d);
		cong_mod_(mul_(mul_(a, a), mul_(b, d)), m, mul_(mul_(a, a), mul_(d, b)), m);
	...
	assert(eq_(temp_107_0, temp_107_1)) by {
		lemma_mul_assoc(mul_(b, d), as_elem(92), c);
	}
