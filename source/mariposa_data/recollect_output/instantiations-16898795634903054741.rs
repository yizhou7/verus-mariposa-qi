...
pub proof fn free_0(a: Elem, b: Elem, c: Elem, d: Elem, m: Elem)
{
	...
	assert(eq_(temp_0_0, temp_0_1)) by {
		lemma_mul_dist(d, b, c);
		cong_mod_(mul_(sub_(b, c), d), m, sub_(mul_(b, d), mul_(c, d)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_1_0, temp_1_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(d, a), mul_(c, d)), sub_(mul_(d, d), mul_(b, a)), m);
	}
	...
	assert(eq_(temp_3_0, temp_3_1)) by {
		lemma_mod_mul_vanish(c, mul_(mul_(b, b), mul_(d, mod_(b, m))), m);
		cong_mul_(mul_(mod_(c, m), b), mul_(b, c), mul_(mod_(add_(mul_(mul_(mul_(b, b), mul_(d, mod_(b, m))), m), c), m), b), mul_(b, c));
		lemma_eq_ref(b);
		cong_mul_(mod_(c, m), b, mod_(add_(mul_(mul_(mul_(b, b), mul_(d, mod_(b, m))), m), c), m), b);
	...
	assert(eq_(temp_7_0, temp_7_1)) by {
		lemma_add_comm(mul_(a, as_elem(58)), c);
	}
	let temp_8_0 = (mod_((sub_((mul_(d, c)), (mul_(d, b)))), m));
	let temp_8_1 = (mod_((sub_((mul_(c, d)), (mul_(d, b)))), m));
	assert(eq_(temp_8_0, temp_8_1)) by {
		lemma_mul_comm(d, c);
		cong_mod_(sub_(mul_(d, c), mul_(d, b)), m, sub_(mul_(c, d), mul_(d, b)), m);
		cong_sub_(mul_(d, c), mul_(d, b), mul_(c, d), mul_(d, b));
		lemma_eq_ref(m);
	...
	assert(eq_(temp_11_0, temp_11_1)) by {
		cong_sub_(mul_(a, b), mul_(b, a), mul_(b, a), mul_(b, a));
		lemma_mul_comm(a, b);
	...
	assert(eq_(temp_12_0, temp_12_1)) by {
		lemma_add_comm(b, c);
		cong_sub_(mod_(mul_(d, c), m), add_(b, c), mod_(mul_(d, c), m), add_(c, b));
	...
	assert(eq_(temp_18_0, temp_18_1)) by {
		cong_sub_(mul_(d, mod_(c, m)), mul_(a, as_elem(25)), mul_(d, mod_(add_(mul_(mul_(mul_(d, d), mul_(d, b)), m), c), m)), mul_(a, as_elem(25)));
		lemma_eq_ref(mul_(a, as_elem(25)));
		lemma_eq_ref(m);
		lemma_eq_ref(d);
		cong_mul_(d, mod_(c, m), d, mod_(add_(mul_(mul_(mul_(d, d), mul_(d, b)), m), c), m));
		lemma_mod_mul_vanish(c, mul_(mul_(d, d), mul_(d, b)), m);
		cong_mod_(sub_(mul_(d, mod_(c, m)), mul_(a, as_elem(25))), m, sub_(mul_(d, mod_(add_(mul_(mul_(mul_(d, d), mul_(d, b)), m), c), m)), mul_(a, as_elem(25))), m);
	}
	...
	assert(eq_(temp_20_0, temp_20_1)) by {
		lemma_mul_dist(mul_(c, c), mod_(a, m), c);
	}
	...
	assert(eq_(temp_21_0, temp_21_1)) by {
		...
		lemma_mul_assoc(b, c, mod_(mul_(c, b), m));
	}
	...
	assert(eq_(temp_22_0, temp_22_1)) by {
		lemma_eq_ref(d);
		cong_mul_(mod_(d, m), d, mod_(sub_(d, mul_(mul_(add_(d, c), mul_(c, c)), m)), m), d);
		lemma_eq_ref(m);
		lemma_mod_mul_vanish(d, mul_(add_(d, c), mul_(c, c)), m);
		cong_sub_(mod_(mul_(mod_(d, m), d), m), mul_(b, c), mod_(mul_(mod_(sub_(d, mul_(mul_(add_(d, c), mul_(c, c)), m)), m), d), m), mul_(b, c));
		cong_mod_(mul_(mod_(d, m), d), m, mul_(mod_(sub_(d, mul_(mul_(add_(d, c), mul_(c, c)), m)), m), d), m);
		lemma_eq_ref(mul_(b, c));
	}
	let temp_23_0 = (mul_(c, (mul_(d, (mod_(a, m))))));
	let temp_23_1 = (mul_(c, (mul_(d, (mod_((add_(a, (mul_((add_((mul_(b, a)), (mul_(a, a)))), m)))), m))))));
	assert(eq_(temp_23_0, temp_23_1)) by {
		lemma_mod_mul_vanish(a, add_(mul_(b, a), mul_(a, a)), m);
		cong_mul_(c, mul_(d, mod_(a, m)), c, mul_(d, mod_(add_(a, mul_(add_(mul_(b, a), mul_(a, a)), m)), m)));
		lemma_eq_ref(d);
		cong_mul_(d, mod_(a, m), d, mod_(add_(a, mul_(add_(mul_(b, a), mul_(a, a)), m)), m));
		lemma_eq_ref(c);
	}
	...
	assert(eq_(temp_24_0, temp_24_1)) by {
		lemma_mul_comm(d, b);
		cong_add_(add_(c, a), mod_(mul_(d, b), m), add_(c, a), mod_(mul_(b, d), m));
		lemma_eq_ref(m);
	...
	assert(eq_(temp_25_0, temp_25_1)) by {
		lemma_mod_mul_vanish(as_elem(21), mul_(mul_(d, b), mul_(c, d)), m);
		cong_mul_(mul_(as_elem(58), b), mul_(mod_(as_elem(21), m), b), mul_(as_elem(58), b), mul_(mod_(sub_(as_elem(21), mul_(mul_(mul_(d, b), mul_(c, d)), m)), m), b));
		lemma_eq_ref(b);
		cong_mul_(mod_(as_elem(21), m), b, mod_(sub_(as_elem(21), mul_(mul_(mul_(d, b), mul_(c, d)), m)), m), b);
	...
	assert(eq_(temp_33_0, temp_33_1)) by {
		...
		cong_add_(mul_(d, b), mod_(mul_(a, mod_(c, m)), m), mul_(d, b), mod_(mul_(mod_(c, m), a), m));
		lemma_eq_ref(mul_(d, b));
		lemma_eq_ref(m);
	...
	assert(eq_(temp_34_0, temp_34_1)) by {
		lemma_mod_mul_vanish(b, mul_(mod_(mul_(d, a), m), mul_(b, a)), m);
		cong_mul_(mul_(a, mod_(b, m)), mul_(c, a), mul_(a, mod_(add_(mul_(mul_(mod_(mul_(d, a), m), mul_(b, a)), m), b), m)), mul_(c, a));
		lemma_eq_ref(a);
		cong_mul_(a, mod_(b, m), a, mod_(add_(mul_(mul_(mod_(mul_(d, a), m), mul_(b, a)), m), b), m));
		lemma_eq_ref(mul_(c, a));
	}
	let temp_35_0 = (mul_((add_(d, d)), (mul_(d, c))));
	let temp_35_1 = (add_((mul_(d, (mul_(d, c)))), (mul_(d, (mul_(d, c))))));
	assert(eq_(temp_35_0, temp_35_1)) by {
		lemma_mul_dist(d, d, mul_(d, c));
	}
	...
	assert(eq_(temp_36_0, temp_36_1)) by {
		lemma_eq_ref(mul_(mod_(as_elem(64), m), a));
		lemma_mul_comm(d, mod_(c, m));
		cong_mul_(mul_(mod_(as_elem(64), m), a), mul_(d, mod_(c, m)), mul_(mod_(as_elem(64), m), a), mul_(mod_(c, m), d));
	}
	...
	assert(eq_(temp_37_0, temp_37_1)) by {
		lemma_mod_mul_vanish(mul_(a, c), mul_(mul_(a, b), mul_(c, c)), m);
		cong_mul_(mod_(mul_(a, c), m), mul_(as_elem(80), b), mod_(add_(mul_(a, c), mul_(mul_(mul_(a, b), mul_(c, c)), m)), m), mul_(as_elem(80), b));
	...
	assert(eq_(temp_38_0, temp_38_1)) by {
		...
		cong_mod_(mul_(mul_(c, a), mul_(b, c)), m, mul_(mul_(b, c), mul_(c, a)), m);
		lemma_eq_ref(m);
	}
	let temp_39_0 = (sub_((mul_(a, b)), (add_(b, a))));
	let temp_39_1 = (sub_((mul_(a, b)), (add_(a, b))));
	assert(eq_(temp_39_0, temp_39_1)) by {
		cong_sub_(mul_(a, b), add_(b, a), mul_(a, b), add_(a, b));
		lemma_add_comm(b, a);
	...
	assert(eq_(temp_42_0, temp_42_1)) by {
		lemma_mod_mul_vanish(b, mul_(sub_(mod_(c, m), b), mul_(mod_(c, m), b)), m);
		cong_mod_(mul_(mul_(mod_(b, m), d), mul_(b, a)), m, mul_(mul_(mod_(sub_(b, mul_(mul_(sub_(mod_(c, m), b), mul_(mod_(c, m), b)), m)), m), d), mul_(b, a)), m);
		lemma_eq_ref(mul_(b, a));
		cong_mul_(mul_(mod_(b, m), d), mul_(b, a), mul_(mod_(sub_(b, mul_(mul_(sub_(mod_(c, m), b), mul_(mod_(c, m), b)), m)), m), d), mul_(b, a));
		lemma_eq_ref(d);
		cong_mul_(mod_(b, m), d, mod_(sub_(b, mul_(mul_(sub_(mod_(c, m), b), mul_(mod_(c, m), b)), m)), m), d);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_43_0, temp_43_1)) by {
		lemma_mul_dist(mul_(mod_(a, m), mod_(b, m)), b, d);
	}
	...
	assert(eq_(temp_45_0, temp_45_1)) by {
		cong_mul_(sub_(d, a), mul_(a, c), sub_(d, a), mul_(c, a));
		lemma_mul_comm(a, c);
	...
	assert(eq_(temp_46_0, temp_46_1)) by {
		lemma_mul_comm(d, mod_(c, m));
		cong_mul_(mul_(c, b), mod_(mul_(mod_(c, m), d), m), mul_(c, b), mod_(mul_(d, mod_(c, m)), m));
		lemma_eq_ref(m);
		lemma_eq_ref(mul_(c, b));
		lemma_eq_sym(mod_(mul_(d, mod_(c, m)), m), mod_(mul_(mod_(c, m), d), m));
	...
	assert(eq_(temp_48_0, temp_48_1)) by {
		lemma_mod_mul_vanish(b, mul_(mul_(a, as_elem(13)), sub_(d, c)), m);
		cong_sub_(mul_(c, b), sub_(mod_(b, m), a), mul_(c, b), sub_(mod_(add_(mul_(mul_(mul_(a, as_elem(13)), sub_(d, c)), m), b), m), a));
		cong_sub_(mod_(b, m), a, mod_(add_(mul_(mul_(mul_(a, as_elem(13)), sub_(d, c)), m), b), m), a);
		lemma_eq_ref(a);
		lemma_eq_ref(mul_(c, b));
	}
	...
	assert(eq_(temp_52_0, temp_52_1)) by {
		lemma_mul_comm(a, c);
		cong_mod_(add_(mod_(mul_(a, c), m), mul_(c, b)), m, add_(mod_(mul_(c, a), m), mul_(c, b)), m);
		cong_add_(mod_(mul_(a, c), m), mul_(c, b), mod_(mul_(c, a), m), mul_(c, b));
		lemma_eq_ref(m);
		lemma_eq_ref(mul_(c, b));
	...
	assert(eq_(temp_53_0, temp_53_1)) by {
		lemma_mul_assoc(mod_(mul_(d, b), m), b, b);
	}
	...
	assert(eq_(temp_56_0, temp_56_1)) by {
		lemma_mul_comm(mul_(b, d), mod_(mul_(d, b), m));
	}
	...
	assert(eq_(temp_58_0, temp_58_1)) by {
		...
		cong_mod_(add_(mul_(a, a), mul_(c, a)), m, mul_(add_(a, c), a), m);
		lemma_eq_sym(mul_(add_(a, c), a), add_(mul_(a, a), mul_(c, a)));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_60_0, temp_60_1)) by {
		lemma_add_comm(a, d);
		cong_add_(mod_(add_(a, d), m), sub_(b, b), mod_(add_(d, a), m), sub_(b, b));
	...
	assert(eq_(temp_62_0, temp_62_1)) by {
		lemma_mul_comm(a, b);
		cong_mod_(sub_(mod_(mul_(a, b), m), mul_(d, b)), m, sub_(mod_(mul_(b, a), m), mul_(d, b)), m);
		cong_sub_(mod_(mul_(a, b), m), mul_(d, b), mod_(mul_(b, a), m), mul_(d, b));
		lemma_eq_ref(m);
		lemma_eq_ref(mul_(d, b));
	...
	assert(eq_(temp_64_0, temp_64_1)) by {
		cong_mul_(add_(a, d), mul_(b, c), add_(a, d), mul_(c, b));
		lemma_mul_comm(b, c);
	...
	assert(eq_(temp_65_0, temp_65_1)) by {
		...
		cong_mod_(mul_(mul_(a, a), mul_(b, a)), m, mul_(mul_(mul_(a, a), b), a), m);
		lemma_eq_ref(m);
	}
	let temp_66_0 = (mul_((mul_(d, a)), (mul_(d, b))));
	let temp_66_1 = (mul_((mul_(a, d)), (mul_(d, b))));
	assert(eq_(temp_66_0, temp_66_1)) by {
		cong_mul_(mul_(d, a), mul_(d, b), mul_(a, d), mul_(d, b));
		lemma_mul_comm(d, a);
		lemma_eq_ref(mul_(d, b));
	}
	...
	assert(eq_(temp_68_0, temp_68_1)) by {
		cong_sub_(mul_(c, d), mod_(c, m), mul_(c, d), mod_(sub_(c, mul_(sub_(mul_(a, a), mul_(c, a)), m)), m));
		lemma_mod_mul_vanish(c, sub_(mul_(a, a), mul_(c, a)), m);
		lemma_eq_ref(mul_(c, d));
	}
	...
	assert(eq_(temp_69_0, temp_69_1)) by {
		...
		cong_sub_(mul_(mod_(b, m), a), mul_(b, b), mul_(mod_(add_(b, mul_(mul_(mul_(a, d), mul_(b, b)), m)), m), a), mul_(b, b));
		cong_mul_(mod_(b, m), a, mod_(add_(b, mul_(mul_(mul_(a, d), mul_(b, b)), m)), m), a);
		lemma_eq_ref(a);
	}
	...
	assert(eq_(temp_70_0, temp_70_1)) by {
		...
		cong_mod_(mul_(mul_(d, d), mul_(b, a)), m, mul_(mul_(mul_(d, d), b), a), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_73_0, temp_73_1)) by {
		lemma_mod_mul_vanish(add_(d, d), add_(mul_(mod_(a, m), b), mul_(b, d)), m);
		cong_mul_(mul_(mod_(a, m), c), mod_(add_(d, d), m), mul_(mod_(a, m), c), mod_(add_(mul_(add_(mul_(mod_(a, m), b), mul_(b, d)), m), add_(d, d)), m));
	...
	assert(eq_(temp_78_0, temp_78_1)) by {
		lemma_add_comm(mul_(d, mod_(b, m)), sub_(b, c));
	}
	let temp_79_0 = (mul_((mul_(c, b)), (mul_((mod_(d, m)), b))));
	let temp_79_1 = (mul_((mul_(c, b)), (mul_((mod_((sub_(d, (mul_((mul_((mul_(d, d)), d)), m)))), m)), b))));
	assert(eq_(temp_79_0, temp_79_1)) by {
		lemma_mod_mul_vanish(d, mul_(mul_(d, d), d), m);
		cong_mul_(mul_(c, b), mul_(mod_(d, m), b), mul_(c, b), mul_(mod_(sub_(d, mul_(mul_(mul_(d, d), d), m)), m), b));
		lemma_eq_ref(b);
		lemma_eq_ref(mul_(c, b));
		cong_mul_(mod_(d, m), b, mod_(sub_(d, mul_(mul_(mul_(d, d), d), m)), m), b);
	}
	...
	assert(eq_(temp_81_0, temp_81_1)) by {
		...
		cong_sub_(mul_(a, d), sub_(c, b), mul_(d, a), sub_(c, b));
		lemma_mul_comm(a, d);
	}
	...
	assert(eq_(temp_82_0, temp_82_1)) by {
		lemma_mul_comm(c, d);
		cong_add_(mul_(d, d), mod_(mul_(c, d), m), mul_(d, d), mod_(mul_(d, c), m));
	...
	assert(eq_(temp_83_0, temp_83_1)) by {
		...
		lemma_mul_comm(b, b);
		lemma_mul_comm(a, b);
		cong_mod_(mul_(mul_(b, b), mul_(a, b)), m, mul_(mul_(b, b), mul_(b, a)), m);
	...
	assert(eq_(temp_84_0, temp_84_1)) by {
		cong_mul_(a, mod_(c, m), a, mod_(sub_(c, mul_(mul_(mul_(c, a), add_(c, c)), m)), m));
		lemma_eq_ref(mul_(b, a));
		lemma_eq_ref(a);
		lemma_mod_mul_vanish(c, mul_(mul_(c, a), add_(c, c)), m);
		cong_mul_(mul_(a, mod_(c, m)), mul_(b, a), mul_(a, mod_(sub_(c, mul_(mul_(mul_(c, a), add_(c, c)), m)), m)), mul_(b, a));
	}
	let temp_85_0 = (mul_((mul_(b, a)), (mul_((mod_(c, m)), as_elem(14)))));
	let temp_85_1 = (mul_((mul_((mul_(b, a)), (mod_(c, m)))), as_elem(14)));
	assert(eq_(temp_85_0, temp_85_1)) by {
		lemma_mul_assoc(mul_(b, a), mod_(c, m), as_elem(14));
	}
	let temp_86_0 = (mul_((mul_(d, as_elem(6))), (mul_(b, d))));
	let temp_86_1 = (mul_((mul_(d, as_elem(6))), (mul_(d, b))));
	assert(eq_(temp_86_0, temp_86_1)) by {
		cong_mul_(mul_(d, as_elem(6)), mul_(b, d), mul_(d, as_elem(6)), mul_(d, b));
		lemma_mul_comm(b, d);
		lemma_eq_ref(mul_(d, as_elem(6)));
	}
	let temp_87_0 = (mod_((mul_((mul_(a, b)), (mul_(c, a)))), m));
	let temp_87_1 = (mod_((mul_((mul_(a, b)), (mul_(a, c)))), m));
	assert(eq_(temp_87_0, temp_87_1)) by {
		lemma_mul_comm(c, a);
		cong_mod_(mul_(mul_(a, b), mul_(c, a)), m, mul_(mul_(a, b), mul_(a, c)), m);
		lemma_eq_ref(mul_(a, b));
	...
	assert(eq_(temp_88_0, temp_88_1)) by {
		...
		cong_mul_(mul_(b, mod_(c, m)), mul_(as_elem(55), b), mul_(b, mod_(c, m)), mul_(b, as_elem(55)));
	...
	assert(eq_(temp_90_0, temp_90_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(a, b), mul_(a, c)), mul_(mul_(b, b), mul_(mod_(c, m), d)), m);
	}
	...
	assert(eq_(temp_91_0, temp_91_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(c, d), mul_(d, b)), mod_(sub_(mul_(c, b), add_(a, a)), m), m);
	}
	let temp_92_0 = (mul_((add_(d, b)), (mod_((mul_(c, d)), m))));
	let temp_92_1 = (mul_((add_(b, d)), (mod_((mul_(c, d)), m))));
	assert(eq_(temp_92_0, temp_92_1)) by {
		lemma_add_comm(d, b);
		cong_mul_(add_(d, b), mod_(mul_(c, d), m), add_(b, d), mod_(mul_(c, d), m));
	...
	assert(eq_(temp_94_0, temp_94_1)) by {
		lemma_mul_comm(sub_(d, c), mul_(c, mod_(c, m)));
	}
	...
	assert(eq_(temp_95_0, temp_95_1)) by {
		lemma_mul_comm(c, b);
		cong_mod_(add_(mul_(mod_(d, m), mod_(c, m)), mul_(c, b)), m, add_(mul_(mod_(d, m), mod_(c, m)), mul_(b, c)), m);
		lemma_eq_ref(m);
		lemma_eq_ref(mul_(mod_(d, m), mod_(c, m)));
		cong_add_(mul_(mod_(d, m), mod_(c, m)), mul_(c, b), mul_(mod_(d, m), mod_(c, m)), mul_(b, c));
	}
	...
	assert(eq_(temp_96_0, temp_96_1)) by {
		lemma_mod_sub_noop(mul_(a, d), mul_(a, c), m);
	}
	...
	assert(eq_(temp_101_0, temp_101_1)) by {
		lemma_mod_mul_vanish(d, sub_(add_(b, b), mul_(d, d)), m);
		cong_add_(sub_(mod_(d, m), d), mul_(b, c), sub_(mod_(add_(mul_(sub_(add_(b, b), mul_(d, d)), m), d), m), d), mul_(b, c));
		lemma_eq_ref(d);
		lemma_eq_ref(mul_(b, c));
		cong_sub_(mod_(d, m), d, mod_(add_(mul_(sub_(add_(b, b), mul_(d, d)), m), d), m), d);
	}
	...
	assert(eq_(temp_103_0, temp_103_1)) by {
		lemma_mod_mul_vanish(b, mul_(mul_(d, a), mod_(add_(c, a), m)), m);
		cong_add_(sub_(b, c), mul_(c, mod_(b, m)), sub_(b, c), mul_(c, mod_(add_(b, mul_(mul_(mul_(d, a), mod_(add_(c, a), m)), m)), m)));
		lemma_eq_ref(c);
		cong_mul_(c, mod_(b, m), c, mod_(add_(b, mul_(mul_(mul_(d, a), mod_(add_(c, a), m)), m)), m));
	...
	assert(eq_(temp_104_0, temp_104_1)) by {
		lemma_mul_comm(c, b);
		cong_sub_(mul_(c, b), mul_(d, mod_(a, m)), mul_(b, c), mul_(d, mod_(a, m)));
	...
	assert(eq_(temp_105_0, temp_105_1)) by {
		lemma_mod_mul_noop(mul_(b, b), mul_(c, d), m);
	...
	assert(eq_(temp_106_0, temp_106_1)) by {
		lemma_mod_mul_noop(mul_(c, mod_(c, m)), mul_(c, b), m);
	...
	assert(eq_(temp_108_0, temp_108_1)) by {
		lemma_mul_comm(d, a);
		cong_sub_(mod_(mul_(b, d), m), mul_(d, a), mod_(mul_(b, d), m), mul_(a, d));
	...
	assert(eq_(temp_109_0, temp_109_1)) by {
		cong_mul_(sub_(mod_(d, m), d), mul_(b, mod_(d, m)), sub_(mod_(d, m), d), mul_(mod_(d, m), b));
		lemma_mul_comm(b, mod_(d, m));
	...
	assert(eq_(temp_110_0, temp_110_1)) by {
		lemma_mul_assoc(mod_(a, m), b, add_(mod_(d, m), b));
	...
	assert(eq_(temp_111_0, temp_111_1)) by {
		lemma_mul_comm(a, c);
		cong_mul_(mod_(mul_(a, c), m), mul_(b, c), mod_(mul_(c, a), m), mul_(b, c));
		cong_mod_(mul_(a, c), m, mul_(c, a), m);
		lemma_eq_ref(mul_(b, c));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_112_0, temp_112_1)) by {
		...
		cong_mul_(mul_(a, mod_(as_elem(77), m)), add_(mod_(a, m), c), mul_(a, mod_(as_elem(77), m)), add_(c, mod_(a, m)));
		lemma_eq_ref(mul_(a, mod_(as_elem(77), m)));
	}
	...
	assert(eq_(temp_117_0, temp_117_1)) by {
		lemma_mul_assoc(mul_(b, mod_(d, m)), d, d);
	}
	...
	assert(eq_(temp_118_0, temp_118_1)) by {
		lemma_eq_ref(mul_(d, c));
		lemma_mul_comm(a, d);
		cong_mul_(mul_(d, c), mod_(mul_(d, a), m), mul_(d, c), mod_(mul_(a, d), m));
	...
	assert(eq_(temp_121_0, temp_121_1)) by {
		lemma_eq_ref(d);
		lemma_mod_mul_vanish(c, mul_(mul_(a, c), mul_(d, c)), m);
		cong_mul_(mul_(a, b), sub_(d, mod_(c, m)), mul_(a, b), sub_(d, mod_(sub_(c, mul_(mul_(mul_(a, c), mul_(d, c)), m)), m)));
		cong_sub_(d, mod_(c, m), d, mod_(sub_(c, mul_(mul_(mul_(a, c), mul_(d, c)), m)), m));
		lemma_eq_ref(mul_(a, b));
	}
	...
	assert(eq_(temp_122_0, temp_122_1)) by {
		lemma_mod_mul_vanish(b, mod_(add_(mul_(a, c), mul_(b, b)), m), m);
		cong_sub_(mul_(d, a), mul_(b, mod_(b, m)), mul_(d, a), mul_(b, mod_(add_(b, mul_(mod_(add_(mul_(a, c), mul_(b, b)), m), m)), m)));
		lemma_eq_ref(mul_(d, a));
		cong_mul_(b, mod_(b, m), b, mod_(add_(b, mul_(mod_(add_(mul_(a, c), mul_(b, b)), m), m)), m));
		lemma_eq_ref(b);
	}
	...
	assert(eq_(temp_123_0, temp_123_1)) by {
		...
		cong_mul_(mul_(a, c), add_(d, mod_(d, m)), mul_(a, c), add_(d, mod_(add_(mul_(mul_(mul_(b, d), mul_(mod_(b, m), d)), m), d), m)));
		lemma_eq_ref(d);
		lemma_eq_ref(mul_(a, c));
		cong_add_(d, mod_(d, m), d, mod_(add_(mul_(mul_(mul_(b, d), mul_(mod_(b, m), d)), m), d), m));
	}
	...
	assert(eq_(temp_125_0, temp_125_1)) by {
		lemma_mul_comm(a, mod_(c, m));
		cong_mul_(mul_(a, mod_(c, m)), mul_(c, d), mul_(mod_(c, m), a), mul_(c, d));
		lemma_eq_ref(mul_(c, d));
	}
	...
	assert(eq_(temp_126_0, temp_126_1)) by {
		...
		lemma_mod_mul_vanish(mul_(d, c), mul_(mul_(mod_(d, m), a), mul_(c, a)), m);
		cong_mul_(mod_(mul_(d, c), m), mod_(mul_(d, a), m), mod_(sub_(mul_(d, c), mul_(mul_(mul_(mod_(d, m), a), mul_(c, a)), m)), m), mod_(mul_(d, a), m));
	}
	...
	assert(eq_(temp_127_0, temp_127_1)) by {
		...
		cong_mul_(add_(a, mod_(b, m)), mul_(b, c), add_(mod_(b, m), a), mul_(b, c));
		lemma_eq_ref(mul_(b, c));
	}
	...
	assert(eq_(temp_129_0, temp_129_1)) by {
		lemma_mul_assoc(mul_(mod_(d, m), a), b, c);
	}
	...
	assert(eq_(temp_130_0, temp_130_1)) by {
		lemma_add_comm(mod_(mul_(b, a), m), sub_(d, a));
	}
	...
	assert(eq_(temp_133_0, temp_133_1)) by {
		...
		lemma_mul_assoc(b, b, mod_(mul_(b, b), m));
	}
	...
	assert(eq_(temp_136_0, temp_136_1)) by {
		...
		lemma_mul_assoc(d, c, mul_(as_elem(65), d));
	}
	...
	assert(eq_(temp_138_0, temp_138_1)) by {
		cong_mul_(mul_(c, c), add_(c, as_elem(14)), mul_(c, c), add_(as_elem(14), c));
		lemma_add_comm(c, as_elem(14));
		lemma_mul_comm(c, c);
	}
	...
	assert(eq_(temp_139_0, temp_139_1)) by {
		lemma_mul_assoc(c, a, mul_(b, as_elem(31)));
	...
	assert(eq_(temp_140_0, temp_140_1)) by {
		lemma_mul_comm(as_elem(47), a);
		cong_add_(mul_(as_elem(47), a), add_(a, mod_(b, m)), mul_(a, as_elem(47)), add_(a, mod_(b, m)));
	...
	assert(eq_(temp_141_0, temp_141_1)) by {
		lemma_mul_comm(a, a);
		lemma_mod_mul_vanish(b, mul_(mul_(a, d), mul_(c, b)), m);
		cong_mul_(mul_(a, a), mul_(mod_(b, m), b), mul_(a, a), mul_(mod_(add_(mul_(mul_(mul_(a, d), mul_(c, b)), m), b), m), b));
		lemma_eq_ref(b);
		cong_mul_(mod_(b, m), b, mod_(add_(mul_(mul_(mul_(a, d), mul_(c, b)), m), b), m), b);
	}
	...
	assert(eq_(temp_145_0, temp_145_1)) by {
		lemma_mul_assoc(mod_(b, m), d, mod_(mul_(b, d), m));
