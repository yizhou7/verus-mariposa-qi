...
pub proof fn free_0(a: Elem, b: Elem, c: Elem, d: Elem, m: Elem)
{
	...
	assert(eq_(temp_0_0, temp_0_1)) by {
		lemma_mul_dist(mul_(c, d), mod_(a, m), d);
	}
	let temp_1_0 = (mod_((mul_((mod_(b, m)), (mul_((mod_(a, m)), (mod_(c, m)))))), m));
	let temp_1_1 = (mod_((mul_((mul_((mod_(a, m)), (mod_(c, m)))), (mod_(b, m)))), m));
	assert(eq_(temp_1_0, temp_1_1)) by {
		lemma_mul_comm(mod_(b, m), mul_(mod_(a, m), mod_(c, m)));
		cong_mod_(mul_(mod_(b, m), mul_(mod_(a, m), mod_(c, m))), m, mul_(mul_(mod_(a, m), mod_(c, m)), mod_(b, m)), m);
		lemma_eq_ref(m);
	}
	let temp_2_0 = (mul_((add_(d, c)), (sub_(d, c))));
	let temp_2_1 = (mul_((sub_(d, c)), (add_(d, c))));
	assert(eq_(temp_2_0, temp_2_1)) by {
		lemma_mul_comm(add_(d, c), sub_(d, c));
	}
	...
	assert(eq_(temp_3_0, temp_3_1)) by {
		lemma_mod_mul_vanish(d, mul_(mul_(a, d), mul_(a, a)), m);
		cong_mul_(mul_(a, mod_(d, m)), mul_(c, mod_(b, m)), mul_(a, mod_(add_(mul_(mul_(mul_(a, d), mul_(a, a)), m), d), m)), mul_(c, mod_(b, m)));
		lemma_eq_ref(a);
		cong_mul_(a, mod_(d, m), a, mod_(add_(mul_(mul_(mul_(a, d), mul_(a, a)), m), d), m));
	...
	assert(eq_(temp_4_0, temp_4_1)) by {
		lemma_add_comm(b, c);
		cong_mod_(mul_(add_(b, c), mul_(c, a)), m, mul_(add_(c, b), mul_(c, a)), m);
	...
	assert(eq_(temp_7_0, temp_7_1)) by {
		lemma_mul_comm(add_(c, b), mul_(c, b));
	}
	...
	assert(eq_(temp_8_0, temp_8_1)) by {
		cong_mul_(a, mod_(b, m), a, mod_(add_(mul_(mul_(mul_(mod_(b, m), c), mod_(mul_(c, mod_(c, m)), m)), m), b), m));
		lemma_eq_ref(mul_(c, d));
		lemma_eq_ref(a);
		lemma_mod_mul_vanish(b, mul_(mul_(mod_(b, m), c), mod_(mul_(c, mod_(c, m)), m)), m);
		cong_mul_(mul_(a, mod_(b, m)), mul_(c, d), mul_(a, mod_(add_(mul_(mul_(mul_(mod_(b, m), c), mod_(mul_(c, mod_(c, m)), m)), m), b), m)), mul_(c, d));
	}
	...
	assert(eq_(temp_11_0, temp_11_1)) by {
		lemma_mod_mul_vanish(c, mul_(mul_(c, c), mul_(d, d)), m);
		cong_mul_(mul_(mod_(c, m), d), as_elem(23), mul_(mod_(add_(mul_(mul_(mul_(c, c), mul_(d, d)), m), c), m), d), as_elem(23));
		lemma_eq_ref(d);
		cong_mul_(mod_(c, m), d, mod_(add_(mul_(mul_(mul_(c, c), mul_(d, d)), m), c), m), d);
		lemma_eq_ref(as_elem(23));
	}
	...
	assert(eq_(temp_13_0, temp_13_1)) by {
		cong_sub_(mod_(a, m), c, mod_(sub_(a, mul_(mul_(mul_(d, a), mul_(d, mod_(a, m))), m)), m), c);
		lemma_mul_comm(as_elem(54), d);
		lemma_mul_comm(d, as_elem(54));
		lemma_mod_mul_vanish(a, mul_(mul_(d, a), mul_(d, mod_(a, m))), m);
		cong_mul_(sub_(mod_(a, m), c), mul_(as_elem(54), d), sub_(mod_(sub_(a, mul_(mul_(mul_(d, a), mul_(d, mod_(a, m))), m)), m), c), mul_(as_elem(54), d));
		lemma_eq_trans(mul_(as_elem(54), d), mul_(d, as_elem(54)), mul_(as_elem(54), d));
		lemma_eq_ref(c);
	}
	...
	assert(eq_(temp_14_0, temp_14_1)) by {
		...
		cong_mul_(mul_(c, c), mod_(mul_(mod_(a, m), d), m), mul_(c, c), mod_(mul_(mod_(add_(a, mul_(mul_(mod_(mul_(a, d), m), mul_(c, a)), m)), m), d), m));
		cong_mod_(mul_(mod_(a, m), d), m, mul_(mod_(add_(a, mul_(mul_(mod_(mul_(a, d), m), mul_(c, a)), m)), m), d), m);
		lemma_eq_ref(d);
		cong_mul_(mod_(a, m), d, mod_(add_(a, mul_(mul_(mod_(mul_(a, d), m), mul_(c, a)), m)), m), d);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_25_0, temp_25_1)) by {
		lemma_mul_comm(mul_(b, mod_(a, m)), sub_(b, c));
	}
	...
	assert(eq_(temp_27_0, temp_27_1)) by {
		...
		cong_mul_(mul_(mod_(b, m), mod_(c, m)), mul_(mod_(a, m), d), mul_(mod_(b, m), mod_(c, m)), mul_(d, mod_(a, m)));
	...
	assert(eq_(temp_29_0, temp_29_1)) by {
		lemma_mod_sub_noop(mod_(mul_(a, a), m), mul_(a, d), m);
	}
	let temp_30_0 = (mul_((mod_((sub_(as_elem(33), c)), m)), (add_(a, c))));
	let temp_30_1 = (mul_((mod_((sub_(as_elem(33), c)), m)), (add_(c, a))));
	assert(eq_(temp_30_0, temp_30_1)) by {
		lemma_add_comm(a, c);
		cong_mul_(mod_(sub_(as_elem(33), c), m), add_(a, c), mod_(sub_(as_elem(33), c), m), add_(c, a));
		lemma_eq_ref(mod_(sub_(as_elem(33), c), m));
	}
	let temp_31_0 = (mul_((mod_((mul_(a, c)), m)), (mul_(d, c))));
	let temp_31_1 = (mul_((mod_((mul_(c, a)), m)), (mul_(d, c))));
	assert(eq_(temp_31_0, temp_31_1)) by {
		lemma_mul_comm(a, c);
		cong_mul_(mod_(mul_(a, c), m), mul_(d, c), mod_(mul_(c, a), m), mul_(d, c));
	...
	assert(eq_(temp_33_0, temp_33_1)) by {
		lemma_mul_dist(mul_(a, a), mod_(a, m), c);
	}
	...
	assert(eq_(temp_44_0, temp_44_1)) by {
		lemma_mod_add_noop(mul_(c, d), mul_(b, c), m);
	}
	let temp_45_0 = (mul_((mul_(c, d)), (mod_((mul_(b, b)), m))));
	let temp_45_1 = (mul_((mul_(d, c)), (mod_((mul_(b, b)), m))));
	assert(eq_(temp_45_0, temp_45_1)) by {
		lemma_mul_comm(c, d);
		cong_mul_(mul_(c, d), mod_(mul_(b, b), m), mul_(d, c), mod_(mul_(b, b), m));
	...
	assert(eq_(temp_47_0, temp_47_1)) by {
		lemma_mul_assoc(mod_(mul_(b, b), m), b, a);
	}
	...
	assert(eq_(temp_51_0, temp_51_1)) by {
		cong_mul_(as_elem(9), mod_(d, m), as_elem(9), mod_(add_(d, mul_(mul_(sub_(d, a), mul_(mod_(b, m), d)), m)), m));
		cong_mul_(mod_(d, m), mul_(as_elem(9), mod_(d, m)), mod_(d, m), mul_(as_elem(9), mod_(add_(d, mul_(mul_(sub_(d, a), mul_(mod_(b, m), d)), m)), m)));
		lemma_eq_ref(as_elem(9));
		lemma_eq_ref(m);
		lemma_mod_mul_vanish(d, mul_(sub_(d, a), mul_(mod_(b, m), d)), m);
		cong_mod_(mul_(mod_(d, m), mul_(as_elem(9), mod_(d, m))), m, mul_(mod_(d, m), mul_(as_elem(9), mod_(add_(d, mul_(mul_(sub_(d, a), mul_(mod_(b, m), d)), m)), m))), m);
	...
	assert(eq_(temp_52_0, temp_52_1)) by {
		lemma_mod_mul_vanish(mul_(b, d), mod_(mul_(mul_(b, d), mul_(a, b)), m), m);
		cong_sub_(mod_(mul_(mod_(a, m), a), m), mod_(mul_(b, d), m), mod_(mul_(mod_(a, m), a), m), mod_(sub_(mul_(b, d), mul_(mod_(mul_(mul_(b, d), mul_(a, b)), m), m)), m));
		lemma_eq_ref(mod_(mul_(mod_(a, m), a), m));
	}
	let temp_53_0 = (mul_((mul_(c, c)), (mul_((mod_(d, m)), (mod_(b, m))))));
	let temp_53_1 = (mul_((mul_((mul_(c, c)), (mod_(d, m)))), (mod_(b, m))));
	assert(eq_(temp_53_0, temp_53_1)) by {
		lemma_mul_assoc(mul_(c, c), mod_(d, m), mod_(b, m));
	}
	let temp_54_0 = (mul_((add_(d, d)), (mul_(b, d))));
	let temp_54_1 = (mul_((mul_((add_(d, d)), b)), d));
	assert(eq_(temp_54_0, temp_54_1)) by {
		lemma_mul_assoc(add_(d, d), b, d);
	}
	...
	assert(eq_(temp_55_0, temp_55_1)) by {
		lemma_mul_dist(mod_(add_(mod_(c, m), mod_(d, m)), m), b, d);
		cong_mod_(mul_(sub_(b, d), mod_(add_(mod_(c, m), mod_(d, m)), m)), m, sub_(mul_(b, mod_(add_(mod_(c, m), mod_(d, m)), m)), mul_(d, mod_(add_(mod_(c, m), mod_(d, m)), m))), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_57_0, temp_57_1)) by {
		lemma_mul_comm(c, mod_(as_elem(15), m));
		cong_mul_(mul_(c, d), mul_(c, mod_(as_elem(15), m)), mul_(c, d), mul_(mod_(as_elem(15), m), c));
		lemma_eq_ref(mul_(c, d));
	}
	...
	assert(eq_(temp_58_0, temp_58_1)) by {
		lemma_mod_mul_vanish(a, mul_(mul_(d, b), mul_(d, b)), m);
		cong_mul_(mul_(d, c), add_(b, mod_(a, m)), mul_(d, c), add_(b, mod_(add_(mul_(mul_(mul_(d, b), mul_(d, b)), m), a), m)));
		lemma_eq_ref(b);
		lemma_eq_ref(mul_(d, c));
		cong_add_(b, mod_(a, m), b, mod_(add_(mul_(mul_(mul_(d, b), mul_(d, b)), m), a), m));
	}
	...
	assert(eq_(temp_64_0, temp_64_1)) by {
		...
		cong_mul_(mod_(mul_(a, mod_(c, m)), m), sub_(a, mod_(d, m)), mod_(mul_(mod_(c, m), a), m), sub_(a, mod_(d, m)));
		lemma_eq_ref(m);
	...
	assert(eq_(temp_66_0, temp_66_1)) by {
		lemma_add_comm(mul_(a, d), mul_(mod_(a, m), c));
	}
	let temp_67_0 = (add_((mul_(a, b)), (mul_(as_elem(68), b))));
	let temp_67_1 = (add_((mul_(a, b)), (mul_(b, as_elem(68)))));
	assert(eq_(temp_67_0, temp_67_1)) by {
		cong_add_(mul_(a, b), mul_(as_elem(68), b), mul_(a, b), mul_(b, as_elem(68)));
	...
	assert(eq_(temp_75_0, temp_75_1)) by {
		lemma_mul_assoc(mod_(b, m), d, mul_(c, a));
	...
	assert(eq_(temp_77_0, temp_77_1)) by {
		lemma_mul_comm(mod_(sub_(d, c), m), mul_(d, b));
		cong_mod_(mul_(mod_(sub_(d, c), m), mul_(d, b)), m, mul_(mul_(d, b), mod_(sub_(d, c), m)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_79_0, temp_79_1)) by {
		...
		cong_mul_(sub_(d, a), mul_(a, mod_(d, m)), sub_(d, a), mul_(a, mod_(add_(d, mul_(mul_(mul_(d, b), mul_(c, d)), m)), m)));
		lemma_eq_ref(sub_(d, a));
		cong_mul_(a, mod_(d, m), a, mod_(add_(d, mul_(mul_(mul_(d, b), mul_(c, d)), m)), m));
		lemma_eq_ref(a);
	}
	...
	assert(eq_(temp_81_0, temp_81_1)) by {
		lemma_mod_mul_vanish(sub_(mod_(mul_(d, b), m), add_(d, c)), mul_(mul_(a, mod_(c, m)), mul_(a, c)), m);
	}
	...
	assert(eq_(temp_85_0, temp_85_1)) by {
		lemma_mul_assoc(a, b, mul_(mod_(a, m), c));
	...
	assert(eq_(temp_86_0, temp_86_1)) by {
		lemma_add_comm(mul_(b, mod_(d, m)), mul_(c, a));
	}
	let temp_87_0 = (mul_((mul_(a, d)), (mod_((mul_(c, d)), m))));
	let temp_87_1 = (mul_((mul_(d, a)), (mod_((mul_(c, d)), m))));
	assert(eq_(temp_87_0, temp_87_1)) by {
		lemma_mul_comm(a, d);
		cong_mul_(mul_(a, d), mod_(mul_(c, d), m), mul_(d, a), mod_(mul_(c, d), m));
	...
	assert(eq_(temp_93_0, temp_93_1)) by {
		lemma_mod_mul_vanish(add_(d, a), mul_(mul_(d, a), mul_(b, mod_(c, m))), m);
		lemma_add_comm(d, d);
		cong_mul_(mod_(add_(d, a), m), add_(d, d), mod_(add_(add_(d, a), mul_(mul_(mul_(d, a), mul_(b, mod_(c, m))), m)), m), add_(d, d));
	}
	let temp_94_0 = (add_((sub_(b, d)), (mul_(b, b))));
	let temp_94_1 = (add_((mul_(b, b)), (sub_(b, d))));
	assert(eq_(temp_94_0, temp_94_1)) by {
		lemma_add_comm(sub_(b, d), mul_(b, b));
	}
	...
	assert(eq_(temp_96_0, temp_96_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(a, c), mul_(c, b)), mul_(mod_(mul_(as_elem(68), c), m), sub_(mod_(a, m), b)), m);
	}
	...
	assert(eq_(temp_98_0, temp_98_1)) by {
		lemma_mod_mul_vanish(a, mod_(mul_(mul_(c, b), mod_(c, m)), m), m);
		cong_mul_(mul_(as_elem(73), mod_(a, m)), mul_(d, a), mul_(as_elem(73), mod_(add_(mul_(mod_(mul_(mul_(c, b), mod_(c, m)), m), m), a), m)), mul_(d, a));
		lemma_eq_ref(as_elem(73));
		cong_mul_(as_elem(73), mod_(a, m), as_elem(73), mod_(add_(mul_(mod_(mul_(mul_(c, b), mod_(c, m)), m), m), a), m));
		lemma_eq_ref(mul_(d, a));
	}
	...
	assert(eq_(temp_101_0, temp_101_1)) by {
		cong_mul_(mul_(c, d), mul_(d, b), mul_(c, d), mul_(b, d));
		lemma_mul_comm(d, b);
		lemma_eq_ref(mul_(c, d));
	}
	...
	assert(eq_(temp_102_0, temp_102_1)) by {
		lemma_mul_comm(b, b);
		lemma_mod_mul_vanish(mul_(c, b), mod_(sub_(mul_(c, d), mul_(mod_(a, m), d)), m), m);
		cong_mul_(mod_(mul_(c, b), m), mul_(b, b), mod_(add_(mul_(mod_(sub_(mul_(c, d), mul_(mod_(a, m), d)), m), m), mul_(c, b)), m), mul_(b, b));
	}
	...
	assert(eq_(temp_105_0, temp_105_1)) by {
		lemma_mod_mul_vanish(a, mod_(add_(mul_(b, b), sub_(d, mod_(a, m))), m), m);
		cong_mul_(mul_(d, mod_(a, m)), mul_(a, d), mul_(d, mod_(add_(mul_(mod_(add_(mul_(b, b), sub_(d, mod_(a, m))), m), m), a), m)), mul_(a, d));
		lemma_eq_ref(d);
		cong_mul_(d, mod_(a, m), d, mod_(add_(mul_(mod_(add_(mul_(b, b), sub_(d, mod_(a, m))), m), m), a), m));
	...
	assert(eq_(temp_107_0, temp_107_1)) by {
		...
		cong_mul_(mul_(mod_(c, m), b), mul_(d, c), mul_(b, mod_(c, m)), mul_(d, c));
		lemma_eq_ref(mul_(d, c));
	}
	...
	assert(eq_(temp_108_0, temp_108_1)) by {
		...
		cong_add_(mul_(mod_(b, m), c), mod_(mul_(c, b), m), mul_(c, mod_(b, m)), mod_(mul_(c, b), m));
