...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_distributive(d0, 1, b0 * d0);
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_associative(((b1 * c1) * (b1 * a1)) * ((b1 * c1) * (b1 * d1)), (d1 * b1) * (b1 * a1), ((19 * d1) * c1) * b1);
		lemma_mul_is_associative(19 * d1, c1, b1);
		lemma_mul_is_associative(((b1 * c1) * (b1 * a1)) * ((b1 * c1) * (b1 * d1)), (d1 * b1) * (b1 * a1), (19 * d1) * (c1 * b1));
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_distributive(d7, c7, c7 * d7);
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_distributive((d8 * a8) * (a8 * a8), (a8 * d8) * (14 * a8), d8);
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_distributive(c9 - d9, b9 * c9, a9 * c9);
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		...
		lemma_mul_is_associative(((c10 * d10) * (a10 * c10)) * ((a10 * a10) * d10), (a10 * a10) + (d10 * d10), (b10 * a10) + (c10 * d10));
		lemma_mul_is_associative(((c10 * d10) * (a10 * c10)) * ((a10 * a10) * d10), (a10 * a10) + (d10 * d10), (b10 * a10) + (d10 * c10));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_commutative((a11 + c11) * c11, (d11 * b11) * (a11 * d11));
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		...
		lemma_mul_is_associative((c12 * d12) * (b12 * a12), a12 * (b12 + a12), (a12 + (b12 + b12)) * ((c12 * d12) + (b12 * c12)));
		lemma_mul_is_associative((d12 * c12) * (b12 * a12), a12 * (b12 + a12), (a12 + (b12 + b12)) * ((c12 * d12) + (b12 * c12)));
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_commutative(((b13 + c13) + (a13 * d13)) * ((c13 * b13) - (d13 - c13)), ((b13 + a13) * (b13 + c13)) * ((a13 * c13) * (c13 * a13)));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_associative(b15 * a15, b15, c15);
	}
