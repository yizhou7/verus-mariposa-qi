...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_commutative((d0 - b0) * (a0 * c0), (b0 * b0) * (a0 - c0));
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_distributive((c4 * d4) - (a4 * a4), c4, c4 * b4);
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		...
		lemma_mul_is_associative((b6 * a6) * (d6 * b6), (a6 * b6) * (a6 - b6), ((c6 + b6) * (c6 - a6)) - ((d6 * a6) * (d6 * b6)));
		lemma_mul_is_associative((b6 * a6) * (b6 * d6), (a6 * b6) * (a6 - b6), ((c6 + b6) * (c6 - a6)) - ((d6 * a6) * (d6 * b6)));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_associative(((b8 * b8) * b8) + ((b8 * b8) * b8), (c8 * d8) - (b8 * a8), d8);
		lemma_mul_is_distributive(b8 * b8, b8, b8);
		lemma_mul_is_associative((b8 * b8) * (b8 + b8), (c8 * d8) - (b8 * a8), d8);
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		...
		lemma_mul_is_associative(((a9 * c9) * (a9 * d9)) * ((d9 - d9) * (a9 * a9)), (c9 - b9) * (a9 * d9), (c9 * a9) * (d9 * b9));
		lemma_mul_is_associative(((a9 * c9) * (a9 * d9)) * ((d9 - d9) * (a9 * a9)), (c9 - b9) * (a9 * d9), (d9 * b9) * (c9 * a9));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_commutative(d10, a10 * (d10 - c10));
		lemma_mul_is_associative(d10, a10, d10 - c10);
		lemma_mul_is_associative(d10, a10 * (d10 - c10), d10);
		lemma_mul_is_commutative((d10 * a10) * (d10 - c10), d10);
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_distributive(d11, a11, c11 * b11);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_commutative(a12 * b12, d12 * c12);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_associative(((a13 * a13) * (b13 * a13)) - ((c13 * c13) * (c13 * d13)), (a13 * a13) * (b13 + a13), (a13 * b13) * (a13 * d13));
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_associative(b14 * a14, a14, b14);
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_commutative(c15 * c15, a15 * 71);
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_commutative(b18 * b18, 47 * c18);
	}
	...
	assert(temp_20_0 == temp_20_1) by {
		lemma_mul_is_commutative(c20 * c20, b20 * a20);
	}
	...
	assert(temp_22_0 == temp_22_1) by {
		lemma_mul_is_commutative((d22 + d22) * (b22 * d22), (b22 * c22) * (d22 + c22));
	}
	...
	assert(temp_23_0 == temp_23_1) by {
		lemma_mul_is_associative(((c23 * b23) + (b23 * c23)) - ((b23 * c23) + (d23 * b23)), (d23 * 59) * (c23 * d23), (c23 * b23) * (b23 * a23));
	}
