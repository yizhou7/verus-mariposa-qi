...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_associative(((c0 * b0) * c0) * c0, (a0 * a0) * (c0 * b0), ((c0 * d0) * (b0 * b0)) - ((a0 * c0) + (d0 * d0)));
		lemma_mul_is_associative(c0 * b0, c0, c0);
		lemma_mul_is_associative((c0 * b0) * (c0 * c0), (a0 * a0) * (c0 * b0), ((c0 * d0) * (b0 * b0)) - ((a0 * c0) + (d0 * d0)));
	}
	let temp_1_0 = ((((a1-b1)*(a1*b1))*d1)*(((c1*a1)-(d1*b1))*((a1*d1)*(d1*d1))));
	let temp_1_1 = ((((a1*(a1*b1))-(b1*(a1*b1)))*d1)*(((c1*a1)-(d1*b1))*((a1*d1)*(d1*d1))));
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_associative((a1 * (a1 * b1)) - (b1 * (a1 * b1)), d1, ((c1 * a1) - (d1 * b1)) * ((a1 * d1) * (d1 * d1)));
		lemma_mul_is_distributive(a1, b1, a1 * b1);
		lemma_mul_is_associative((a1 - b1) * (a1 * b1), d1, ((c1 * a1) - (d1 * b1)) * ((a1 * d1) * (d1 * d1)));
	}
	let temp_2_0 = ((((b2*b2)*a2)*(a2*(a2-b2)))*((b2*(b2*a2))*((d2*a2)+(c2*a2))));
	let temp_2_1 = ((((b2*b2)*a2)*((a2*a2)-(a2*b2)))*((b2*(b2*a2))*((d2*a2)+(c2*a2))));
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_distributive(a2, a2, b2);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_associative(((d5 * b5) - (d5 * 40)) * 35, (d5 * b5) - (b5 * a5), (a5 * (c5 * d5)) - (d5 * (c5 * d5)));
		lemma_mul_is_distributive(a5, d5, c5 * d5);
		lemma_mul_is_associative(((d5 * b5) - (d5 * 40)) * 35, (d5 * b5) - (b5 * a5), (a5 - d5) * (c5 * d5));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_commutative((b6 + b6) * (b6 * a6), (a6 + c6) - (b6 + a6));
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_associative((b7 * d7) * (b7 - a7), c7 * b7, c7 - b7);
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_associative(d9 * ((a9 * d9) - (a9 * b9)), (a9 * b9) * (c9 + b9), ((c9 * b9) * c9) * d9);
		lemma_mul_is_associative(c9 * b9, c9, d9);
		lemma_mul_is_associative(d9 * ((a9 * d9) - (a9 * b9)), (a9 * b9) * (c9 + b9), (c9 * b9) * (c9 * d9));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_associative((b10 * d10) * (b10 * b10), (b10 * c10) + (c10 * c10), ((b10 * a10) * (d10 * d10)) * ((c10 * d10) + (d10 * c10)));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_associative(a11, b11 * c11, d11);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_associative(d13, 84, d13 * c13);
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_associative(a14 + d14, 62, b14);
	}
