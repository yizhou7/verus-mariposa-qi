...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_associative((d0 * c0) - (b0 + a0), b0 * d0, c0);
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		...
		lemma_mul_is_associative(((a1 * a1) + (d1 * c1)) * ((c1 - a1) + (d1 * c1)), (a1 * b1) * (a1 * b1), (b1 * c1) * (c1 * d1));
		lemma_mul_is_associative(((a1 * a1) + (d1 * c1)) * ((c1 - a1) + (d1 * c1)), (a1 * b1) * (a1 * b1), (b1 * c1) * (d1 * c1));
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_commutative(d2, 44);
		lemma_mul_is_associative(d2 * 44, d2 * d2, d2);
		lemma_mul_is_associative(44 * d2, d2 * d2, d2);
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_commutative(d3 - b3, b3 * d3);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_commutative(d5, 74);
		lemma_mul_is_associative(d5 * 74, b5 * d5, (b5 - b5) * (c5 + a5));
		lemma_mul_is_associative(74 * d5, b5 * d5, (b5 - b5) * (c5 + a5));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		...
		lemma_mul_is_associative(((b6 - d6) * (61 * b6)) * ((c6 * a6) - (a6 - a6)), (d6 * c6) * (d6 * 85), (a6 + b6) * (c6 * d6));
		lemma_mul_is_associative(((b6 - d6) * (61 * b6)) * ((c6 * a6) - (a6 - a6)), (d6 * c6) * (d6 * 85), (a6 + b6) * (d6 * c6));
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_associative(b7 * c7, b7 * b7, (b7 * b7) + (a7 * a7));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_commutative(((c8 * b8) * (c8 + d8)) * ((c8 * a8) * (b8 * a8)), 47 * c8);
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_commutative((a9 * a9) * (b9 * c9), (c9 * c9) * (a9 - c9));
	}
