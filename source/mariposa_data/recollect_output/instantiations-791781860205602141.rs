...
pub proof fn free_0(a: Elem, b: Elem, c: Elem, d: Elem, m: Elem)
{
	...
	assert(eq_(temp_1_0, temp_1_1)) by {
		lemma_mul_comm(mod_(as_elem(68), m), d);
		cong_mul_(mod_(mul_(b, b), m), mul_(mod_(as_elem(68), m), d), mod_(mul_(b, b), m), mul_(d, mod_(as_elem(68), m)));
	...
	assert(eq_(temp_5_0, temp_5_1)) by {
		cong_mul_(c, mod_(c, m), c, mod_(add_(mul_(mul_(mul_(mod_(c, m), c), mod_(mul_(mod_(a, m), b), m)), m), c), m));
		lemma_eq_ref(mod_(mul_(a, mod_(b, m)), m));
		lemma_eq_ref(c);
		lemma_mod_mul_vanish(c, mul_(mul_(mod_(c, m), c), mod_(mul_(mod_(a, m), b), m)), m);
		cong_mul_(mul_(c, mod_(c, m)), mod_(mul_(a, mod_(b, m)), m), mul_(c, mod_(add_(mul_(mul_(mul_(mod_(c, m), c), mod_(mul_(mod_(a, m), b), m)), m), c), m)), mod_(mul_(a, mod_(b, m)), m));
	}
	let temp_6_0 = (sub_((mul_(d, (mod_(d, m)))), (mul_(b, a))));
	let temp_6_1 = (sub_((mul_((mod_(d, m)), d)), (mul_(b, a))));
	assert(eq_(temp_6_0, temp_6_1)) by {
		lemma_mul_comm(d, mod_(d, m));
		cong_sub_(mul_(d, mod_(d, m)), mul_(b, a), mul_(mod_(d, m), d), mul_(b, a));
	...
	assert(eq_(temp_8_0, temp_8_1)) by {
		cong_mul_(mul_(b, a), mul_(a, mod_(b, m)), mul_(a, b), mul_(a, mod_(b, m)));
		lemma_mul_comm(b, a);
	...
	assert(eq_(temp_10_0, temp_10_1)) by {
		lemma_mod_mul_vanish(a, add_(mul_(mod_(c, m), b), mul_(d, d)), m);
		cong_mul_(mul_(b, c), mul_(mod_(a, m), d), mul_(b, c), mul_(mod_(sub_(a, mul_(add_(mul_(mod_(c, m), b), mul_(d, d)), m)), m), d));
		lemma_eq_ref(mul_(b, c));
		cong_mul_(mod_(a, m), d, mod_(sub_(a, mul_(add_(mul_(mod_(c, m), b), mul_(d, d)), m)), m), d);
		lemma_eq_ref(d);
	}
	...
	assert(eq_(temp_11_0, temp_11_1)) by {
		lemma_add_comm(a, b);
		cong_mul_(add_(a, b), mod_(mul_(d, a), m), add_(b, a), mod_(mul_(d, a), m));
	...
	assert(eq_(temp_12_0, temp_12_1)) by {
		...
		cong_mod_(mul_(mul_(d, a), mul_(d, c)), m, mul_(mul_(mul_(d, a), d), c), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_13_0, temp_13_1)) by {
		cong_mul_(mul_(a, d), mul_(mod_(b, m), mod_(a, m)), mul_(a, d), mul_(mod_(sub_(b, mul_(mod_(sub_(mod_(mul_(a, mod_(d, m)), m), mul_(c, d)), m), m)), m), mod_(a, m)));
		lemma_mod_mul_vanish(b, mod_(sub_(mod_(mul_(a, mod_(d, m)), m), mul_(c, d)), m), m);
		lemma_eq_ref(mul_(a, d));
		cong_mul_(mod_(b, m), mod_(a, m), mod_(sub_(b, mul_(mod_(sub_(mod_(mul_(a, mod_(d, m)), m), mul_(c, d)), m), m)), m), mod_(a, m));
	...
	assert(eq_(temp_16_0, temp_16_1)) by {
		cong_mul_(mul_(mod_(d, m), a), sub_(b, as_elem(23)), mul_(mod_(sub_(d, mul_(mul_(mod_(mul_(b, b), m), mul_(d, a)), m)), m), a), sub_(b, as_elem(23)));
		lemma_mod_mul_vanish(d, mul_(mod_(mul_(b, b), m), mul_(d, a)), m);
		lemma_eq_ref(a);
		lemma_eq_ref(sub_(b, as_elem(23)));
		cong_mul_(mod_(d, m), a, mod_(sub_(d, mul_(mul_(mod_(mul_(b, b), m), mul_(d, a)), m)), m), a);
	}
	let temp_17_0 = (mod_((sub_((mul_(b, c)), (mul_((mod_(b, m)), d)))), m));
	let temp_17_1 = (mod_((sub_((mul_(c, b)), (mul_((mod_(b, m)), d)))), m));
	assert(eq_(temp_17_0, temp_17_1)) by {
		lemma_mul_comm(b, c);
		cong_mod_(sub_(mul_(b, c), mul_(mod_(b, m), d)), m, sub_(mul_(c, b), mul_(mod_(b, m), d)), m);
		cong_sub_(mul_(b, c), mul_(mod_(b, m), d), mul_(c, b), mul_(mod_(b, m), d));
	...
	assert(eq_(temp_18_0, temp_18_1)) by {
		...
		cong_mul_(mul_(a, mod_(a, m)), sub_(b, d), mul_(mod_(a, m), a), sub_(b, d));
	...
	assert(eq_(temp_20_0, temp_20_1)) by {
		cong_mul_(add_(a, d), mul_(c, c), add_(d, a), mul_(c, c));
		lemma_add_comm(a, d);
		lemma_mul_comm(c, c);
	}
	...
	assert(eq_(temp_24_0, temp_24_1)) by {
		lemma_mul_comm(a, d);
		cong_mul_(mod_(mul_(a, d), m), mul_(b, a), mod_(mul_(d, a), m), mul_(b, a));
	...
	assert(eq_(temp_25_0, temp_25_1)) by {
		lemma_mul_comm(b, c);
		cong_mul_(mul_(b, c), mod_(sub_(mod_(d, m), mod_(b, m)), m), mul_(c, b), mod_(sub_(mod_(d, m), mod_(b, m)), m));
		lemma_eq_ref(mod_(sub_(mod_(d, m), mod_(b, m)), m));
	}
	...
	assert(eq_(temp_33_0, temp_33_1)) by {
		lemma_mul_assoc(add_(mod_(c, m), b), b, b);
	}
	...
	assert(eq_(temp_34_0, temp_34_1)) by {
		lemma_mul_assoc(mod_(mul_(mod_(b, m), b), m), mod_(b, m), c);
		cong_mod_(mul_(mod_(mul_(mod_(b, m), b), m), mul_(mod_(b, m), c)), m, mul_(mul_(mod_(mul_(mod_(b, m), b), m), mod_(b, m)), c), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_36_0, temp_36_1)) by {
		lemma_mul_comm(mod_(mul_(mod_(c, m), b), m), sub_(mod_(c, m), d));
	}
	let temp_37_0 = (mul_((mul_(c, (mod_(a, m)))), (add_(c, c))));
	let temp_37_1 = (mul_((mul_((mod_(a, m)), c)), (add_(c, c))));
	assert(eq_(temp_37_0, temp_37_1)) by {
		lemma_add_comm(c, c);
		cong_mul_(mul_(c, mod_(a, m)), add_(c, c), mul_(mod_(a, m), c), add_(c, c));
	...
	assert(eq_(temp_38_0, temp_38_1)) by {
		lemma_mul_comm(d, d);
		lemma_mod_mul_vanish(c, mul_(add_(c, c), mul_(b, mod_(a, m))), m);
		cong_mul_(mul_(d, d), mul_(c, mod_(c, m)), mul_(d, d), mul_(c, mod_(add_(mul_(mul_(add_(c, c), mul_(b, mod_(a, m))), m), c), m)));
		cong_mul_(c, mod_(c, m), c, mod_(add_(mul_(mul_(add_(c, c), mul_(b, mod_(a, m))), m), c), m));
		lemma_eq_ref(c);
	}
	...
	assert(eq_(temp_40_0, temp_40_1)) by {
		lemma_mul_assoc(c, a, mul_(mod_(b, m), d));
	...
	assert(eq_(temp_41_0, temp_41_1)) by {
		lemma_mod_mul_vanish(a, mul_(mul_(a, d), mul_(d, a)), m);
		cong_mul_(mul_(c, mod_(a, m)), mul_(a, c), mul_(c, mod_(sub_(a, mul_(mul_(mul_(a, d), mul_(d, a)), m)), m)), mul_(a, c));
		lemma_eq_ref(c);
		cong_mul_(c, mod_(a, m), c, mod_(sub_(a, mul_(mul_(mul_(a, d), mul_(d, a)), m)), m));
		lemma_eq_ref(mul_(a, c));
	}
	...
	assert(eq_(temp_44_0, temp_44_1)) by {
		lemma_mod_mul_vanish(mul_(d, b), mul_(mul_(c, b), mul_(b, mod_(b, m))), m);
		cong_mul_(mod_(mul_(d, b), m), sub_(c, a), mod_(add_(mul_(d, b), mul_(mul_(mul_(c, b), mul_(b, mod_(b, m))), m)), m), sub_(c, a));
	...
	assert(eq_(temp_45_0, temp_45_1)) by {
		lemma_mod_mul_vanish(mul_(c, b), mul_(mul_(a, a), mul_(c, b)), m);
		cong_mul_(mod_(mul_(c, b), m), mul_(mod_(d, m), b), mod_(sub_(mul_(c, b), mul_(mul_(mul_(a, a), mul_(c, b)), m)), m), mul_(mod_(d, m), b));
	...
	assert(eq_(temp_46_0, temp_46_1)) by {
		lemma_mod_mul_vanish(d, mul_(mul_(a, d), mul_(d, a)), m);
		lemma_add_comm(d, d);
		cong_add_(mul_(mod_(d, m), d), add_(d, d), mul_(mod_(add_(mul_(mul_(mul_(a, d), mul_(d, a)), m), d), m), d), add_(d, d));
		lemma_eq_ref(d);
		cong_mul_(mod_(d, m), d, mod_(add_(mul_(mul_(mul_(a, d), mul_(d, a)), m), d), m), d);
	}
	...
	assert(eq_(temp_48_0, temp_48_1)) by {
		cong_mul_(mul_(d, b), mod_(a, m), mul_(b, d), mod_(a, m));
		lemma_mul_comm(d, b);
		lemma_eq_ref(mod_(a, m));
	}
	...
	assert(eq_(temp_49_0, temp_49_1)) by {
		lemma_mul_comm(c, a);
		cong_mul_(mul_(c, a), mul_(mod_(d, m), b), mul_(a, c), mul_(mod_(d, m), b));
		lemma_eq_ref(mul_(mod_(d, m), b));
	}
	...
	assert(eq_(temp_52_0, temp_52_1)) by {
		lemma_mod_mul_vanish(b, mul_(mul_(c, a), b), m);
		cong_mul_(mul_(d, b), add_(a, mod_(b, m)), mul_(d, b), add_(a, mod_(add_(mul_(mul_(mul_(c, a), b), m), b), m)));
		lemma_eq_ref(a);
		lemma_eq_ref(mul_(d, b));
		cong_add_(a, mod_(b, m), a, mod_(add_(mul_(mul_(mul_(c, a), b), m), b), m));
	}
	...
	assert(eq_(temp_53_0, temp_53_1)) by {
		lemma_mod_mul_vanish(c, mul_(mul_(d, d), mul_(mod_(c, m), d)), m);
		cong_mul_(mul_(d, mod_(b, m)), mul_(mod_(c, m), a), mul_(d, mod_(b, m)), mul_(mod_(sub_(c, mul_(mul_(mul_(d, d), mul_(mod_(c, m), d)), m)), m), a));
		lemma_eq_ref(mul_(d, mod_(b, m)));
		cong_mul_(mod_(c, m), a, mod_(sub_(c, mul_(mul_(mul_(d, d), mul_(mod_(c, m), d)), m)), m), a);
		lemma_eq_ref(a);
	}
	...
	assert(eq_(temp_54_0, temp_54_1)) by {
		lemma_mod_mul_vanish(mul_(a, c), mul_(mul_(d, mod_(c, m)), mod_(add_(mod_(d, m), d), m)), m);
		cong_sub_(mod_(mul_(a, c), m), mul_(b, c), mod_(add_(mul_(mul_(mul_(d, mod_(c, m)), mod_(add_(mod_(d, m), d), m)), m), mul_(a, c)), m), mul_(b, c));
		lemma_eq_ref(mul_(b, c));
	}
	let temp_55_0 = (mod_((mul_((mul_(d, a)), (add_(d, c)))), m));
	let temp_55_1 = (mod_((add_((mul_((mul_(d, a)), d)), (mul_((mul_(d, a)), c)))), m));
	assert(eq_(temp_55_0, temp_55_1)) by {
		lemma_mul_dist(mul_(d, a), d, c);
		cong_mod_(mul_(mul_(d, a), add_(d, c)), m, add_(mul_(mul_(d, a), d), mul_(mul_(d, a), c)), m);
		lemma_eq_ref(m);
	}
	let temp_56_0 = (mul_((mod_((mul_(d, b)), m)), (mul_(b, (mod_(d, m))))));
	let temp_56_1 = (mul_((mul_((mod_((mul_(d, b)), m)), b)), (mod_(d, m))));
	assert(eq_(temp_56_0, temp_56_1)) by {
		lemma_mul_assoc(mod_(mul_(d, b), m), b, mod_(d, m));
	}
	...
	assert(eq_(temp_58_0, temp_58_1)) by {
		cong_mul_(sub_(b, a), mul_(c, a), sub_(b, a), mul_(a, c));
		lemma_mul_comm(c, a);
	...
	assert(eq_(temp_64_0, temp_64_1)) by {
		lemma_mul_comm(c, d);
		cong_mul_(mul_(c, d), add_(c, mod_(a, m)), mul_(d, c), add_(c, mod_(a, m)));
	...
	assert(eq_(temp_65_0, temp_65_1)) by {
		lemma_mul_comm(d, b);
		cong_mul_(sub_(as_elem(44), a), mul_(d, b), sub_(as_elem(44), a), mul_(b, d));
		lemma_eq_ref(sub_(as_elem(44), a));
	}
	let temp_66_0 = (mul_((sub_(d, a)), (mod_((mul_(a, d)), m))));
	let temp_66_1 = (mul_((mod_((mul_(a, d)), m)), (sub_(d, a))));
	assert(eq_(temp_66_0, temp_66_1)) by {
		lemma_mul_comm(sub_(d, a), mod_(mul_(a, d), m));
	}
	...
	assert(eq_(temp_67_0, temp_67_1)) by {
		...
		cong_mul_(mul_(a, c), mod_(mul_(b, a), m), mul_(a, c), mod_(sub_(mul_(b, a), mul_(mul_(mul_(a, d), mul_(d, c)), m)), m));
		lemma_eq_ref(mul_(a, c));
	}
	...
	assert(eq_(temp_68_0, temp_68_1)) by {
		lemma_mod_mul_vanish(b, mul_(mul_(c, b), add_(d, c)), m);
		cong_mul_(mul_(a, d), mul_(c, mod_(b, m)), mul_(a, d), mul_(c, mod_(sub_(b, mul_(mul_(mul_(c, b), add_(d, c)), m)), m)));
		cong_mul_(c, mod_(b, m), c, mod_(sub_(b, mul_(mul_(mul_(c, b), add_(d, c)), m)), m));
		lemma_eq_ref(c);
		lemma_eq_ref(mul_(a, d));
	}
	...
	assert(eq_(temp_69_0, temp_69_1)) by {
		cong_sub_(mul_(d, a), mul_(d, d), mul_(a, d), mul_(d, d));
		lemma_mul_comm(d, a);
		lemma_mul_comm(d, d);
	}
	...
	assert(eq_(temp_72_0, temp_72_1)) by {
		cong_mul_(mul_(as_elem(59), a), mul_(b, a), mul_(a, as_elem(59)), mul_(b, a));
		lemma_mul_comm(as_elem(59), a);
		lemma_eq_ref(mul_(b, a));
	}
	...
	assert(eq_(temp_76_0, temp_76_1)) by {
		lemma_mul_comm(a, mod_(a, m));
		cong_mod_(mul_(add_(a, mod_(c, m)), mul_(a, mod_(a, m))), m, mul_(add_(a, mod_(c, m)), mul_(mod_(a, m), a)), m);
		lemma_eq_ref(add_(a, mod_(c, m)));
		cong_mul_(add_(a, mod_(c, m)), mul_(a, mod_(a, m)), add_(a, mod_(c, m)), mul_(mod_(a, m), a));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_77_0, temp_77_1)) by {
		lemma_mod_mul_vanish(c, add_(mul_(d, d), mul_(b, b)), m);
		cong_mul_(mul_(d, mod_(c, m)), mul_(d, a), mul_(d, mod_(add_(mul_(add_(mul_(d, d), mul_(b, b)), m), c), m)), mul_(d, a));
		lemma_eq_ref(d);
		cong_mul_(d, mod_(c, m), d, mod_(add_(mul_(add_(mul_(d, d), mul_(b, b)), m), c), m));
		lemma_eq_ref(mul_(d, a));
	}
	let temp_78_0 = (mul_((mul_(c, a)), (sub_(as_elem(30), b))));
	let temp_78_1 = (mul_((sub_(as_elem(30), b)), (mul_(c, a))));
	assert(eq_(temp_78_0, temp_78_1)) by {
		lemma_mul_comm(mul_(c, a), sub_(as_elem(30), b));
	}
	...
	assert(eq_(temp_79_0, temp_79_1)) by {
		lemma_add_comm(mod_(sub_(c, mod_(as_elem(89), m)), m), mul_(d, d));
	}
	let temp_80_0 = (sub_((mod_((add_(c, b)), m)), (mod_((mul_(c, a)), m))));
	let temp_80_1 = (sub_((mod_((add_(b, c)), m)), (mod_((mul_(c, a)), m))));
	assert(eq_(temp_80_0, temp_80_1)) by {
		lemma_add_comm(c, b);
		cong_sub_(mod_(add_(c, b), m), mod_(mul_(c, a), m), mod_(add_(b, c), m), mod_(mul_(c, a), m));
	...
	assert(eq_(temp_82_0, temp_82_1)) by {
		lemma_mul_assoc(mul_(d, mod_(a, m)), mod_(a, m), d);
	}
	...
	assert(eq_(temp_83_0, temp_83_1)) by {
		lemma_mod_mul_vanish(d, sub_(mul_(mod_(b, m), b), mod_(mul_(b, mod_(d, m)), m)), m);
		cong_mul_(mod_(add_(d, c), m), mul_(mod_(d, m), d), mod_(add_(d, c), m), mul_(mod_(add_(d, mul_(sub_(mul_(mod_(b, m), b), mod_(mul_(b, mod_(d, m)), m)), m)), m), d));
		lemma_eq_ref(d);
		lemma_eq_ref(mod_(add_(d, c), m));
		cong_mul_(mod_(d, m), d, mod_(add_(d, mul_(sub_(mul_(mod_(b, m), b), mod_(mul_(b, mod_(d, m)), m)), m)), m), d);
	}
	...
	assert(eq_(temp_85_0, temp_85_1)) by {
		...
		lemma_mul_assoc(as_elem(44), a, mul_(a, d));
	}
	let temp_86_0 = (mul_((mul_(d, (mod_(a, m)))), (mul_(d, a))));
	let temp_86_1 = (mul_((mul_((mod_(a, m)), d)), (mul_(d, a))));
	assert(eq_(temp_86_0, temp_86_1)) by {
		cong_mul_(mul_(d, mod_(a, m)), mul_(d, a), mul_(mod_(a, m), d), mul_(d, a));
	...
	assert(eq_(temp_91_0, temp_91_1)) by {
		lemma_mul_comm(a, c);
		cong_mod_(mul_(mod_(mul_(mod_(b, m), d), m), mul_(a, c)), m, mul_(mod_(mul_(mod_(b, m), d), m), mul_(c, a)), m);
		lemma_eq_ref(mod_(mul_(mod_(b, m), d), m));
		cong_mul_(mod_(mul_(mod_(b, m), d), m), mul_(a, c), mod_(mul_(mod_(b, m), d), m), mul_(c, a));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_93_0, temp_93_1)) by {
		lemma_mul_comm(as_elem(97), b);
		cong_mul_(mod_(mul_(c, d), m), mul_(as_elem(97), b), mod_(mul_(c, d), m), mul_(b, as_elem(97)));
	...
	assert(eq_(temp_94_0, temp_94_1)) by {
		lemma_mod_mul_vanish(d, mul_(mul_(b, d), mul_(d, as_elem(94))), m);
		cong_mul_(mul_(mod_(b, m), b), mul_(mod_(d, m), c), mul_(mod_(b, m), b), mul_(mod_(add_(d, mul_(mul_(mul_(b, d), mul_(d, as_elem(94))), m)), m), c));
		cong_mul_(mod_(d, m), c, mod_(add_(d, mul_(mul_(mul_(b, d), mul_(d, as_elem(94))), m)), m), c);
		lemma_eq_ref(c);
	...
	assert(eq_(temp_96_0, temp_96_1)) by {
		lemma_mul_assoc(mul_(b, b), a, mod_(b, m));
		cong_mod_(mul_(mul_(b, b), mul_(a, mod_(b, m))), m, mul_(mul_(mul_(b, b), a), mod_(b, m)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_98_0, temp_98_1)) by {
		lemma_mul_comm(as_elem(26), c);
		cong_mul_(sub_(a, a), mod_(mul_(as_elem(26), c), m), sub_(a, a), mod_(mul_(c, as_elem(26)), m));
		lemma_eq_ref(m);
		cong_mod_(mul_(as_elem(26), c), m, mul_(c, as_elem(26)), m);
	...
	assert(eq_(temp_101_0, temp_101_1)) by {
		lemma_mul_comm(a, a);
		lemma_mod_mul_vanish(mul_(mod_(b, m), c), mul_(mul_(b, c), mul_(b, b)), m);
		cong_sub_(mul_(a, a), mod_(mul_(mod_(b, m), c), m), mul_(a, a), mod_(add_(mul_(mul_(mul_(b, c), mul_(b, b)), m), mul_(mod_(b, m), c)), m));
	}
	...
	assert(eq_(temp_102_0, temp_102_1)) by {
		lemma_mul_assoc(mul_(as_elem(46), b), b, c);
		cong_mod_(mul_(mul_(as_elem(46), b), mul_(b, c)), m, mul_(mul_(mul_(as_elem(46), b), b), c), m);
		lemma_eq_ref(m);
	}
