...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_commutative(((d0 + 3) - (b0 * c0)) * ((c0 * d0) - (a0 - b0)), ((b0 * a0) * (d0 * a0)) + ((a0 * a0) * a0));
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_distributive((d1 * 69) * (b1 * d1), b1 * b1, b1 * d1);
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_commutative((a3 + d3) * (d3 * d3), (b3 + b3) * (b3 + a3));
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_associative((d4 * d4) - (b4 * d4), d4 * b4, a4 * c4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_associative(d5 * d5, b5 * b5, (d5 * d5) * (c5 * c5));
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_commutative((24 * a7) * (a7 * b7), (d7 + a7) * (b7 + d7));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		...
		lemma_mul_is_associative((c8 + (c8 * a8)) - ((a8 + b8) - (d8 * b8)), (b8 * a8) + (b8 * b8), (d8 * c8) * (a8 * a8));
		lemma_mul_is_associative((c8 + (c8 * a8)) - ((a8 + b8) - (d8 * b8)), (b8 * a8) + (b8 * b8), (c8 * d8) * (a8 * a8));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_distributive(a9, c9, b9);
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_associative(((c10 * b10) * d10) + ((c10 * b10) * d10), (b10 * c10) * b10, ((b10 * d10) * (a10 * c10)) * ((b10 * d10) + (c10 * a10)));
		lemma_mul_is_distributive(c10 * b10, d10, d10);
		lemma_mul_is_associative((c10 * b10) * (d10 + d10), (b10 * c10) * b10, ((b10 * d10) * (a10 * c10)) * ((b10 * d10) + (c10 * a10)));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_associative((4 * c11) * a11, a11 * d11, d11 * b11);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_commutative((a12 * a12) + b12, (a12 - b12) * (c12 * c12));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_commutative((b15 * a15) * (c15 * c15), d15 * (b15 * a15));
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_associative((b16 * a16) * (d16 * a16), b16 * a16, a16 * a16);
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_commutative(d17 - b17, d17 * b17);
		lemma_mul_is_associative((d17 - b17) * (d17 * b17), (d17 * b17) * (c17 * a17), ((a17 * d17) * c17) - ((d17 + a17) * (d17 * d17)));
		lemma_mul_is_associative((d17 * b17) * (d17 - b17), (d17 * b17) * (c17 * a17), ((a17 * d17) * c17) - ((d17 + a17) * (d17 * d17)));
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_associative(d18, c18, b18 + a18);
	}
