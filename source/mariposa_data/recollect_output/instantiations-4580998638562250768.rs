...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_distributive((b0 * b0) * (b0 * a0), b0, a0 * c0);
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		...
		lemma_mul_is_associative(b1 * c1, d1 * d1, (c1 * c1) * (b1 * d1));
		lemma_mul_is_associative(c1 * b1, d1 * d1, (c1 * c1) * (b1 * d1));
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		...
		lemma_mul_is_associative((c2 + c2) * (c2 * a2), c2 * a2, b2 * d2);
		lemma_mul_is_associative((c2 + c2) * (c2 * a2), c2 * a2, d2 * b2);
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_commutative(((a3 - c3) * (c3 * d3)) * ((b3 * 51) - (b3 + b3)), ((b3 * c3) * (a3 * c3)) - ((c3 * a3) * (d3 - c3)));
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_commutative(c4, d4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_associative((c5 - a5) * (a5 * d5), c5 * (c5 * b5), ((a5 * c5) + (c5 * a5)) + (c5 * (d5 * a5)));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_associative(c6 * b6, a6, a6);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_commutative((b7 - d7) - (a7 - c7), (a7 * 79) * (d7 + d7));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_commutative(((c8 + c8) * (65 * d8)) * ((c8 * a8) + (d8 * b8)), ((c8 * d8) * (a8 * c8)) * ((d8 * d8) + (b8 * c8)));
	}
	let temp_9_0 = (d9*((d9+(a9-b9))*((d9*c9)+d9)));
	let temp_9_1 = (d9*(((d9+(a9-b9))*(d9*c9))+((d9+(a9-b9))*d9)));
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_distributive(d9 + (a9 - b9), d9 * c9, d9);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_distributive(d12 + a12, b12, a12);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_commutative(d13 * c13, c13 * d13);
		lemma_mul_is_associative(((a13 * c13) * (a13 * b13)) * ((b13 * d13) * (a13 * d13)), (d13 - b13) * (b13 * a13), (d13 * c13) * (c13 * d13));
		lemma_mul_is_associative(((a13 * c13) * (a13 * b13)) * ((b13 * d13) * (a13 * d13)), (d13 - b13) * (b13 * a13), (c13 * d13) * (d13 * c13));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_associative(b15 * c15, b15 * b15, (a15 * d15) * (c15 * c15));
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_commutative(b16 * a16, c16 * d16);
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_commutative((c17 * a17) + (d17 * a17), (b17 * c17) * (c17 * c17));
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_commutative((c18 - d18) * (b18 * 34), (a18 * c18) - (a18 * a18));
	}
	...
	assert(temp_20_0 == temp_20_1) by {
		lemma_mul_is_associative(a20, a20, c20 * b20);
	}
	...
	assert(temp_21_0 == temp_21_1) by {
		lemma_mul_is_associative(b21, d21, c21);
	}
