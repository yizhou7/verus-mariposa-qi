...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_associative(c0, b0 * b0, c0);
		lemma_mul_is_commutative(c0, c0 * (b0 * b0));
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_commutative(d2 * b2, b2 * c2);
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		...
		lemma_mul_is_associative((d3 * c3) * (d3 * a3), a3 * a3, c3 * d3);
		lemma_mul_is_associative((d3 * c3) * (d3 * a3), a3 * a3, d3 * c3);
	}
	let temp_4_0 = ((((d4*c4)*(c4*a4))*(d4*(a4*c4)))*(((c4*a4)*(a4*a4))-((c4*c4)*(b4*b4))));
	let temp_4_1 = ((((d4*c4)*(c4*a4))*(d4*(a4*c4)))*(((a4*a4)*(c4*a4))-((c4*c4)*(b4*b4))));
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_commutative(a4 * a4, c4 * a4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		...
		lemma_mul_is_associative((c5 * b5) * (c5 * d5), b5 - b5, b5 * c5);
		lemma_mul_is_associative((c5 * b5) * (c5 * d5), b5 - b5, c5 * b5);
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_associative(a6, d6, b6 + a6);
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_commutative(a8 * b8, b8 * b8);
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_associative(b11 * d11, c11, b11);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_associative((a12 * c12) * (b12 - a12), b12 * c12, d12 * a12);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_distributive(c13 * 5, a13 * d13, d13 - (a13 * a13));
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_commutative((c14 * d14) * (b14 * b14), (d14 * c14) * (d14 * a14));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_associative((d15 - 40) + (a15 * a15), b15 - 49, c15 * c15);
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_associative((a16 * (a16 * b16)) * ((d16 * d16) * (d16 * d16)), (a16 * d16) - (a16 * d16), ((c16 - a16) * d16) * a16);
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_associative(d17 + a17, c17, 40);
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_commutative((d18 + 23) * (b18 * b18), (c18 * b18) * (c18 * b18));
	}
	...
	assert(temp_19_0 == temp_19_1) by {
		lemma_mul_is_distributive(d19 - (c19 * b19), (a19 * d19) - a19, a19 * ((a19 - c19) * (b19 * a19)));
	}
