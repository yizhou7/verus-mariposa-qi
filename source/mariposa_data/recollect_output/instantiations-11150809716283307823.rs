...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_associative(b0 * 40, c0 * 0, (c0 * c0) * (c0 * d0));
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		...
		lemma_mul_is_associative((c7 * d7) - (c7 * d7), (d7 * b7) * b7, ((a7 * b7) * (d7 * a7)) * ((23 * d7) * (a7 - b7)));
		lemma_mul_is_associative((d7 * c7) - (c7 * d7), (d7 * b7) * b7, ((a7 * b7) * (d7 * a7)) * ((23 * d7) * (a7 - b7)));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_associative(b8 * a8, d8 * c8, (c8 * a8) + (a8 + a8));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_distributive((d9 * c9) + (c9 * b9), (d9 + a9) * (b9 - d9), ((d9 * d9) * (c9 * d9)) * (a9 * (a9 * a9)));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_commutative(d11 - c11, d11 * c11);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_associative((c12 * (c12 - b12)) * ((c12 + c12) * 89), (a12 * a12) * (b12 * d12), (d12 * d12) * (c12 * b12));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		...
		lemma_mul_is_associative((b15 * d15) * (b15 * b15), c15 - d15, b15 * c15);
		lemma_mul_is_associative((b15 * d15) * (b15 * b15), c15 - d15, c15 * b15);
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_associative(((d16 * d16) * (c16 * a16)) * ((d16 + a16) + (d16 * a16)), (b16 * b16) * (a16 * a16), ((b16 * b16) * c16) - ((b16 * b16) * d16));
		lemma_mul_is_distributive(b16 * b16, c16, d16);
		lemma_mul_is_associative(((d16 * d16) * (c16 * a16)) * ((d16 + a16) + (d16 * a16)), (b16 * b16) * (a16 * a16), (b16 * b16) * (c16 - d16));
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_commutative(b17 * ((a17 * b17) + (c17 - b17)), ((c17 * 88) * (d17 * c17)) - ((b17 * d17) * (c17 - c17)));
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_associative(b18, c18, d18 * b18);
	}
	...
	assert(temp_19_0 == temp_19_1) by {
		lemma_mul_is_distributive(d19 * a19, b19, d19);
	}
	...
	assert(temp_20_0 == temp_20_1) by {
		lemma_mul_is_distributive(((b20 * c20) + (a20 * b20)) * ((a20 * a20) * (b20 * a20)), (b20 * a20) - (b20 * d20), (c20 * a20) - b20);
	}
	...
	assert(temp_21_0 == temp_21_1) by {
		lemma_mul_is_commutative(b21 * d21, c21 + a21);
		lemma_mul_is_associative((b21 * d21) * (c21 + a21), (c21 * a21) * (a21 * b21), ((c21 * b21) * (a21 * b21)) * ((18 * a21) * (a21 * b21)));
		lemma_mul_is_associative((c21 + a21) * (b21 * d21), (c21 * a21) * (a21 * b21), ((c21 * b21) * (a21 * b21)) * ((18 * a21) * (a21 * b21)));
	}
