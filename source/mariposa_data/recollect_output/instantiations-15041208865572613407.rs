...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		...
		lemma_mul_is_associative(a0, c0 * b0, b0 * d0);
		lemma_mul_is_associative(a0, c0 * b0, d0 * b0);
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_commutative(b1 * d1, c1 * d1);
		lemma_mul_is_associative(((a1 * b1) * (a1 * b1)) * ((d1 * c1) * (c1 * a1)), (b1 * b1) * (a1 * c1), (b1 * d1) * (c1 * d1));
		lemma_mul_is_associative(((a1 * b1) * (a1 * b1)) * ((d1 * c1) * (c1 * a1)), (b1 * b1) * (a1 * c1), (c1 * d1) * (b1 * d1));
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_commutative(65, d2);
		lemma_mul_is_associative(65 * d2, b2 * d2, (d2 * b2) * (b2 * b2));
		lemma_mul_is_associative(d2 * 65, b2 * d2, (d2 * b2) * (b2 * b2));
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_commutative((b3 * a3) * (a3 - a3), (c3 * a3) * (b3 * d3));
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_associative(((b4 * b4) * a4) + ((b4 * b4) * c4), (b4 * b4) * (a4 * a4), ((b4 * c4) - (a4 * c4)) * ((b4 * c4) - c4));
		lemma_mul_is_distributive(b4 * b4, a4, c4);
		lemma_mul_is_associative((b4 * b4) * (a4 + c4), (b4 * b4) * (a4 * a4), ((b4 * c4) - (a4 * c4)) * ((b4 * c4) - c4));
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_associative(((b5 * d5) * c5) * c5, (c5 * a5) - (a5 * a5), ((c5 * d5) - (d5 * c5)) * ((b5 * b5) * (b5 + b5)));
		lemma_mul_is_associative(b5 * d5, c5, c5);
		lemma_mul_is_associative((b5 * d5) * (c5 * c5), (c5 * a5) - (a5 * a5), ((c5 * d5) - (d5 * c5)) * ((b5 * b5) * (b5 + b5)));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		...
		lemma_mul_is_associative((a6 * c6) * (b6 * c6), c6 * a6, b6 * c6);
		lemma_mul_is_associative((a6 * c6) * (b6 * c6), c6 * a6, c6 * b6);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_associative(c7, a7, b7 * b7);
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_commutative(c9, c9 - c9);
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_commutative((c10 * b10) * (d10 * a10), (d10 * d10) * (c10 + d10));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_associative(c11, a11, a11 * c11);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_commutative(b12, c12);
		lemma_mul_is_associative((c12 - a12) * (b12 * a12), c12 * c12, c12 * b12);
		lemma_mul_is_associative((c12 - a12) * (b12 * a12), c12 * c12, b12 * c12);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_commutative((c13 * d13) * (b13 * d13), (b13 * b13) * (c13 * b13));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_associative(a15, c15, b15);
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		...
		lemma_mul_is_associative((c16 * c16) * (d16 * d16), d16 + d16, d16 * b16);
		lemma_mul_is_associative((c16 * c16) * (d16 * d16), d16 + d16, b16 * d16);
	}
