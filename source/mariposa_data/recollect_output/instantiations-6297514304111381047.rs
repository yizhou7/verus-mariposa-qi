...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_distributive((d2 * a2) * (c2 * 54), (b2 * d2) * (b2 - c2), ((a2 * a2) * (c2 * c2)) * ((d2 * b2) + (b2 * a2)));
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_associative(a3, a3, d3 * a3);
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_distributive(a4, b4, a4 * d4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_commutative(d5 * d5, c5 * d5);
		lemma_mul_is_associative(((a5 * c5) * (c5 * d5)) * ((d5 * 21) + (b5 * a5)), (d5 + a5) * (d5 - 32), (d5 * d5) * (c5 * d5));
		lemma_mul_is_associative(((a5 * c5) * (c5 * d5)) * ((d5 * 21) + (b5 * a5)), (d5 + a5) * (d5 - 32), (c5 * d5) * (d5 * d5));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_commutative(((b6 * d6) * (a6 * d6)) * ((c6 - a6) * (b6 * d6)), b6 * ((c6 - b6) * (b6 * b6)));
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_commutative(a7 * d7, d7 * d7);
		lemma_mul_is_associative(((b7 * d7) * (b7 + a7)) * ((b7 - b7) - (a7 * a7)), (c7 * a7) * (a7 - a7), (a7 * d7) * (d7 * d7));
		lemma_mul_is_associative(((b7 * d7) * (b7 + a7)) * ((b7 - b7) - (a7 * a7)), (c7 * a7) * (a7 - a7), (d7 * d7) * (a7 * d7));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_commutative((a9 * a9) * (d9 * d9), (d9 * a9) * (b9 * a9));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_commutative((a10 - b10) - (b10 + d10), (a10 * d10) + (c10 * a10));
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_commutative((b12 + d12) * (b12 * a12), (c12 * b12) * (a12 * c12));
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_commutative(d13 + (c13 + b13), (a13 * c13) * (a13 * b13));
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_associative(a14, d14, c14 * d14);
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_distributive((a15 * b15) * (c15 * b15), a15, a15 * a15);
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_associative(d16, b16 - b16, c16 * b16);
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_associative(b17 * b17, c17 * d17, (c17 * c17) - (a17 + a17));
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_commutative((c18 * b18) * (14 * c18), (d18 * b18) * (b18 * a18));
	}
	...
	assert(temp_19_0 == temp_19_1) by {
		lemma_mul_is_associative(54 * c19, b19, b19);
	}
	...
	assert(temp_20_0 == temp_20_1) by {
		lemma_mul_is_commutative(c20 * a20, a20);
		lemma_mul_is_associative((c20 * a20) * a20, a20 * (b20 * 60), d20);
		lemma_mul_is_associative(a20 * (c20 * a20), a20 * (b20 * 60), d20);
	}
	...
	assert(temp_21_0 == temp_21_1) by {
		...
		lemma_mul_is_associative(((d21 * d21) * (c21 * d21)) + ((b21 * a21) * c21), (a21 * b21) * (a21 * 95), (d21 * a21) * (b21 * c21));
		lemma_mul_is_associative(((d21 * d21) * (c21 * d21)) + ((b21 * a21) * c21), (a21 * b21) * (a21 * 95), (d21 * a21) * (c21 * b21));
	}
	...
	assert(temp_22_0 == temp_22_1) by {
		lemma_mul_is_distributive((d22 * c22) * (b22 - a22), b22 * (c22 * b22), ((c22 + c22) * (a22 * b22)) * ((a22 * b22) * (c22 * b22)));
	}
