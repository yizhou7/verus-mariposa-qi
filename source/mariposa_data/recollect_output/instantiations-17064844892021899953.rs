...
pub proof fn free_0(a: Elem, b: Elem, c: Elem, d: Elem, m: Elem)
{
	...
	assert(eq_(temp_7_0, temp_7_1)) by {
		...
		cong_mul_(mul_(mod_(c, m), d), mod_(mul_(b, c), m), mul_(d, mod_(c, m)), mod_(mul_(b, c), m));
	...
	assert(eq_(temp_10_0, temp_10_1)) by {
		lemma_mul_comm(a, c);
		cong_sub_(mod_(mul_(a, c), m), add_(c, d), mod_(mul_(c, a), m), add_(c, d));
	...
	assert(eq_(temp_12_0, temp_12_1)) by {
		cong_mul_(mul_(b, b), mul_(a, mod_(a, m)), mul_(b, b), mul_(a, mod_(sub_(a, mul_(mul_(mul_(mod_(d, m), as_elem(7)), mul_(as_elem(48), d)), m)), m)));
		lemma_mod_mul_vanish(a, mul_(mul_(mod_(d, m), as_elem(7)), mul_(as_elem(48), d)), m);
		cong_mul_(a, mod_(a, m), a, mod_(sub_(a, mul_(mul_(mul_(mod_(d, m), as_elem(7)), mul_(as_elem(48), d)), m)), m));
	...
	assert(eq_(temp_13_0, temp_13_1)) by {
		lemma_mul_comm(b, d);
		lemma_mul_comm(a, a);
		cong_mul_(mod_(mul_(b, d), m), mul_(a, a), mod_(mul_(d, b), m), mul_(a, a));
	...
	assert(eq_(temp_15_0, temp_15_1)) by {
		...
		lemma_mod_mul_vanish(mul_(c, c), mul_(mul_(d, a), add_(d, d)), m);
		cong_mul_(mod_(mul_(c, c), m), mul_(b, a), mod_(sub_(mul_(c, c), mul_(mul_(mul_(d, a), add_(d, d)), m)), m), mul_(b, a));
	}
	...
	assert(eq_(temp_22_0, temp_22_1)) by {
		lemma_mul_comm(mul_(c, c), sub_(d, d));
	}
	...
	assert(eq_(temp_23_0, temp_23_1)) by {
		...
		lemma_mod_mul_vanish(mul_(d, c), mul_(sub_(mod_(a, m), a), mul_(a, a)), m);
		cong_add_(mul_(c, d), mod_(mul_(d, c), m), mul_(c, d), mod_(add_(mul_(mul_(sub_(mod_(a, m), a), mul_(a, a)), m), mul_(d, c)), m));
	}
	...
	assert(eq_(temp_24_0, temp_24_1)) by {
		...
		cong_mul_(mul_(a, d), add_(d, mod_(d, m)), mul_(a, d), add_(d, mod_(sub_(d, mul_(mul_(mul_(c, d), mul_(c, d)), m)), m)));
		lemma_eq_ref(d);
		lemma_eq_ref(mul_(a, d));
		cong_add_(d, mod_(d, m), d, mod_(sub_(d, mul_(mul_(mul_(c, d), mul_(c, d)), m)), m));
	}
	...
	assert(eq_(temp_25_0, temp_25_1)) by {
		...
		cong_mul_(mod_(mul_(b, as_elem(11)), m), mod_(mul_(mod_(a, m), mod_(c, m)), m), mod_(mul_(b, as_elem(11)), m), mod_(mul_(mod_(c, m), mod_(a, m)), m));
		lemma_eq_ref(m);
		cong_mod_(mul_(mod_(a, m), mod_(c, m)), m, mul_(mod_(c, m), mod_(a, m)), m);
		lemma_eq_ref(mod_(mul_(b, as_elem(11)), m));
	}
	...
	assert(eq_(temp_27_0, temp_27_1)) by {
		lemma_mul_comm(as_elem(60), c);
		cong_mul_(mod_(sub_(a, d), m), mul_(as_elem(60), c), mod_(sub_(a, d), m), mul_(c, as_elem(60)));
	...
	assert(eq_(temp_28_0, temp_28_1)) by {
		cong_mul_(mod_(b, m), mod_(a, m), mod_(b, m), mod_(add_(a, mul_(mul_(mul_(d, b), mul_(b, mod_(c, m))), m)), m));
		lemma_eq_ref(sub_(d, c));
		lemma_eq_ref(mod_(b, m));
		lemma_mod_mul_vanish(a, mul_(mul_(d, b), mul_(b, mod_(c, m))), m);
		cong_mul_(mul_(mod_(b, m), mod_(a, m)), sub_(d, c), mul_(mod_(b, m), mod_(add_(a, mul_(mul_(mul_(d, b), mul_(b, mod_(c, m))), m)), m)), sub_(d, c));
	}
	...
	assert(eq_(temp_32_0, temp_32_1)) by {
		lemma_mul_assoc(d, c, sub_(as_elem(89), b));
	...
	assert(eq_(temp_39_0, temp_39_1)) by {
		cong_mul_(mul_(d, b), add_(d, a), mul_(d, b), add_(a, d));
		lemma_add_comm(d, a);
	...
	assert(eq_(temp_40_0, temp_40_1)) by {
		lemma_eq_ref(mul_(b, b));
		lemma_mod_mul_vanish(sub_(b, a), mul_(mul_(b, c), mul_(d, b)), m);
		cong_add_(mod_(sub_(b, a), m), mul_(b, b), mod_(add_(mul_(mul_(mul_(b, c), mul_(d, b)), m), sub_(b, a)), m), mul_(b, b));
	}
	let temp_41_0 = (add_((mod_((sub_((mod_(d, m)), b)), m)), (mul_(c, b))));
	let temp_41_1 = (add_((mod_((sub_((mod_(d, m)), b)), m)), (mul_(b, c))));
	assert(eq_(temp_41_0, temp_41_1)) by {
		lemma_mul_comm(c, b);
		cong_add_(mod_(sub_(mod_(d, m), b), m), mul_(c, b), mod_(sub_(mod_(d, m), b), m), mul_(b, c));
		lemma_eq_ref(mod_(sub_(mod_(d, m), b), m));
	}
	let temp_42_0 = (mul_((mul_(c, (mod_(c, m)))), (add_(d, b))));
	let temp_42_1 = (mul_((add_(d, b)), (mul_(c, (mod_(c, m))))));
	assert(eq_(temp_42_0, temp_42_1)) by {
		lemma_mul_comm(mul_(c, mod_(c, m)), add_(d, b));
	}
	...
	assert(eq_(temp_44_0, temp_44_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(a, a), sub_(a, c)), mul_(mul_(c, d), mul_(c, a)), m);
	}
	let temp_45_0 = (mul_(a, (mul_(a, a))));
	let temp_45_1 = (mul_((mul_(a, a)), a));
	assert(eq_(temp_45_0, temp_45_1)) by {
		lemma_mul_assoc(a, a, a);
	}
	...
	assert(eq_(temp_48_0, temp_48_1)) by {
		lemma_mod_add_noop(sub_(d, c), sub_(d, d), m);
	}
	...
	assert(eq_(temp_50_0, temp_50_1)) by {
		cong_mul_(a, mod_(c, m), a, mod_(add_(c, mul_(sub_(mul_(a, b), add_(mod_(b, m), c)), m)), m));
		lemma_eq_ref(mul_(d, c));
		lemma_eq_ref(a);
		lemma_mod_mul_vanish(c, sub_(mul_(a, b), add_(mod_(b, m), c)), m);
		cong_mul_(mul_(a, mod_(c, m)), mul_(d, c), mul_(a, mod_(add_(c, mul_(sub_(mul_(a, b), add_(mod_(b, m), c)), m)), m)), mul_(d, c));
	}
	...
	assert(eq_(temp_54_0, temp_54_1)) by {
		cong_sub_(mul_(d, a), a, mul_(a, d), a);
		lemma_mul_comm(d, a);
		lemma_eq_ref(a);
	}
	...
	assert(eq_(temp_60_0, temp_60_1)) by {
		lemma_mod_mul_vanish(mul_(b, d), mul_(mod_(mul_(as_elem(11), b), m), mul_(c, b)), m);
		cong_sub_(mul_(a, mod_(a, m)), mod_(mul_(b, d), m), mul_(a, mod_(a, m)), mod_(sub_(mul_(b, d), mul_(mul_(mod_(mul_(as_elem(11), b), m), mul_(c, b)), m)), m));
	...
	assert(eq_(temp_63_0, temp_63_1)) by {
		lemma_mod_mul_vanish(mul_(d, b), add_(mul_(b, a), mul_(a, c)), m);
		cong_mul_(mul_(d, c), mod_(mul_(d, b), m), mul_(d, c), mod_(sub_(mul_(d, b), mul_(add_(mul_(b, a), mul_(a, c)), m)), m));
		lemma_eq_ref(mul_(d, c));
	}
	...
	assert(eq_(temp_66_0, temp_66_1)) by {
		lemma_mul_comm(mul_(mod_(d, m), b), mul_(b, d));
	}
	let temp_67_0 = (mul_((mul_(d, (mod_(d, m)))), (mul_(c, b))));
	let temp_67_1 = (mul_((mul_(d, (mod_(d, m)))), (mul_(b, c))));
	assert(eq_(temp_67_0, temp_67_1)) by {
		lemma_mul_comm(c, b);
		cong_mul_(mul_(d, mod_(d, m)), mul_(c, b), mul_(d, mod_(d, m)), mul_(b, c));
	...
	assert(eq_(temp_68_0, temp_68_1)) by {
		lemma_mul_comm(b, b);
		lemma_mod_mul_vanish(mul_(d, c), mul_(mul_(a, b), mul_(c, c)), m);
		cong_mul_(mod_(mul_(d, c), m), mul_(b, b), mod_(add_(mul_(mul_(mul_(a, b), mul_(c, c)), m), mul_(d, c)), m), mul_(b, b));
	}
	...
	assert(eq_(temp_70_0, temp_70_1)) by {
		lemma_mul_comm(a, a);
		lemma_mod_mul_vanish(a, mul_(mul_(a, b), mul_(b, c)), m);
		cong_mul_(mul_(a, a), mul_(b, mod_(a, m)), mul_(a, a), mul_(b, mod_(add_(mul_(mul_(mul_(a, b), mul_(b, c)), m), a), m)));
		lemma_eq_ref(b);
		cong_mul_(b, mod_(a, m), b, mod_(add_(mul_(mul_(mul_(a, b), mul_(b, c)), m), a), m));
	}
	let temp_71_0 = (add_((mul_(b, a)), (mod_((sub_((mod_(a, m)), b)), m))));
	let temp_71_1 = (add_((mod_((sub_((mod_(a, m)), b)), m)), (mul_(b, a))));
	assert(eq_(temp_71_0, temp_71_1)) by {
		lemma_add_comm(mul_(b, a), mod_(sub_(mod_(a, m), b), m));
	}
	...
	assert(eq_(temp_74_0, temp_74_1)) by {
		lemma_mod_mul_vanish(mul_(d, c), mul_(mul_(c, as_elem(61)), mul_(a, a)), m);
		cong_mul_(mul_(b, d), mod_(mul_(d, c), m), mul_(b, d), mod_(add_(mul_(d, c), mul_(mul_(mul_(c, as_elem(61)), mul_(a, a)), m)), m));
		lemma_eq_ref(mul_(b, d));
	}
	...
	assert(eq_(temp_75_0, temp_75_1)) by {
		cong_mul_(mod_(mul_(c, mod_(b, m)), m), mul_(a, b), mod_(mul_(c, mod_(sub_(b, mul_(mul_(add_(d, a), mul_(a, d)), m)), m)), m), mul_(a, b));
		lemma_mod_mul_vanish(b, mul_(add_(d, a), mul_(a, d)), m);
		lemma_eq_ref(c);
		cong_mul_(c, mod_(b, m), c, mod_(sub_(b, mul_(mul_(add_(d, a), mul_(a, d)), m)), m));
		lemma_eq_ref(m);
		cong_mod_(mul_(c, mod_(b, m)), m, mul_(c, mod_(sub_(b, mul_(mul_(add_(d, a), mul_(a, d)), m)), m)), m);
		lemma_eq_ref(mul_(a, b));
	}
	let temp_76_0 = (mul_((sub_(d, b)), (mul_(d, d))));
	let temp_76_1 = (sub_((mul_(d, (mul_(d, d)))), (mul_(b, (mul_(d, d))))));
	assert(eq_(temp_76_0, temp_76_1)) by {
		lemma_mul_dist(mul_(d, d), d, b);
	}
	...
	assert(eq_(temp_82_0, temp_82_1)) by {
		lemma_mul_comm(c, b);
		cong_mul_(mul_(c, b), mul_(mod_(d, m), d), mul_(b, c), mul_(mod_(d, m), d));
	...
	assert(eq_(temp_86_0, temp_86_1)) by {
		cong_mul_(mul_(b, d), sub_(a, a), mul_(d, b), sub_(a, a));
		lemma_mul_comm(b, d);
	...
	assert(eq_(temp_87_0, temp_87_1)) by {
		lemma_mod_mul_vanish(mul_(b, c), mul_(mul_(c, b), sub_(d, a)), m);
		lemma_add_comm(d, d);
		cong_mod_(mul_(mod_(mul_(b, c), m), add_(d, d)), m, mul_(mod_(add_(mul_(mul_(mul_(c, b), sub_(d, a)), m), mul_(b, c)), m), add_(d, d)), m);
		cong_mul_(mod_(mul_(b, c), m), add_(d, d), mod_(add_(mul_(mul_(mul_(c, b), sub_(d, a)), m), mul_(b, c)), m), add_(d, d));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_89_0, temp_89_1)) by {
		cong_mul_(mul_(mod_(a, m), a), mul_(b, b), mul_(a, mod_(a, m)), mul_(b, b));
