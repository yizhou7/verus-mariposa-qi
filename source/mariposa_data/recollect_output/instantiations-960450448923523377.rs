...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_commutative(c0 * a0, c0);
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_distributive(a4 * c4, a4, d4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_distributive(d5 * a5, d5, d5);
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_associative((57 + b6) * (a6 * c6), d6 * b6, b6 * a6);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_distributive((d7 + c7) - (a7 * d7), (a7 * b7) * (a7 * a7), ((a7 * d7) + (a7 * c7)) * ((c7 * a7) * (d7 * b7)));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_associative(c8 * b8, a8, d8);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_associative((d12 * b12) * (a12 - d12), a12 * b12, b12 * d12);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		...
		lemma_mul_is_associative((a13 * d13) * (b13 * d13), c13 * d13, c13 * b13);
		lemma_mul_is_associative((a13 * d13) * (b13 * d13), c13 * d13, b13 * c13);
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_associative(a15, 44, d15 * a15);
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_associative(c16, b16, a16 * c16);
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_commutative(b17 * b17, a17 * c17);
		lemma_mul_is_associative((b17 * b17) * (a17 * c17), (c17 * c17) * b17, ((c17 * a17) * (d17 * a17)) * ((d17 * d17) * (a17 + b17)));
		lemma_mul_is_associative((a17 * c17) * (b17 * b17), (c17 * c17) * b17, ((c17 * a17) * (d17 * a17)) * ((d17 * d17) * (a17 + b17)));
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_commutative(b18 * a18, c18);
	}
	...
	assert(temp_20_0 == temp_20_1) by {
		lemma_mul_is_commutative(b20 - 53, a20 - a20);
	}
	...
	assert(temp_21_0 == temp_21_1) by {
		lemma_mul_is_commutative((d21 * d21) * (c21 * b21), (d21 * b21) * (b21 + b21));
	}
	...
	assert(temp_22_0 == temp_22_1) by {
		lemma_mul_is_associative((c22 + c22) * (c22 * b22), a22, c22 * d22);
	}
	...
	assert(temp_23_0 == temp_23_1) by {
		lemma_mul_is_commutative(26, c23);
		lemma_mul_is_associative(26 * c23, d23 * d23, (b23 * a23) * (b23 * b23));
		lemma_mul_is_associative(c23 * 26, d23 * d23, (b23 * a23) * (b23 * b23));
	}
