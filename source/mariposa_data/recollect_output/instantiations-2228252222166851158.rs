...
pub proof fn free_0(a: Elem, b: Elem, c: Elem, d: Elem, m: Elem)
{
	...
	assert(eq_(temp_0_0, temp_0_1)) by {
		lemma_mod_mul_vanish(a, mod_(add_(a, mul_(a, d)), m), m);
		cong_mul_(mul_(a, mod_(a, m)), mul_(a, c), mul_(a, mod_(add_(mul_(mod_(add_(a, mul_(a, d)), m), m), a), m)), mul_(a, c));
		lemma_eq_ref(a);
		cong_mul_(a, mod_(a, m), a, mod_(add_(mul_(mod_(add_(a, mul_(a, d)), m), m), a), m));
	...
	assert(eq_(temp_1_0, temp_1_1)) by {
		lemma_mul_comm(c, b);
		cong_mod_(mul_(mul_(c, b), mul_(c, mod_(a, m))), m, mul_(mul_(b, c), mul_(c, mod_(a, m))), m);
		lemma_eq_ref(m);
		cong_mul_(mul_(c, b), mul_(c, mod_(a, m)), mul_(b, c), mul_(c, mod_(a, m)));
		lemma_eq_ref(mul_(c, mod_(a, m)));
	}
	let temp_2_0 = (mul_((mod_((add_(a, b)), m)), (mul_(c, d))));
	let temp_2_1 = (mul_((mul_((mod_((add_(a, b)), m)), c)), d));
	assert(eq_(temp_2_0, temp_2_1)) by {
		lemma_mul_assoc(mod_(add_(a, b), m), c, d);
	}
	...
	assert(eq_(temp_4_0, temp_4_1)) by {
		...
		cong_mul_(mul_(d, d), add_(c, mod_(a, m)), mul_(d, d), add_(mod_(a, m), c));
	}
	...
	assert(eq_(temp_6_0, temp_6_1)) by {
		...
		lemma_mod_mul_vanish(d, mul_(mul_(c, d), mul_(c, c)), m);
		cong_mul_(add_(c, a), mul_(b, mod_(d, m)), add_(c, a), mul_(b, mod_(add_(d, mul_(mul_(mul_(c, d), mul_(c, c)), m)), m)));
		lemma_eq_ref(b);
		cong_mul_(b, mod_(d, m), b, mod_(add_(d, mul_(mul_(mul_(c, d), mul_(c, c)), m)), m));
	}
	let temp_7_0 = (mul_((mul_(c, (mod_(c, m)))), (mul_(b, b))));
	let temp_7_1 = (mul_((mul_(b, b)), (mul_(c, (mod_(c, m))))));
	assert(eq_(temp_7_0, temp_7_1)) by {
		lemma_mul_comm(mul_(c, mod_(c, m)), mul_(b, b));
	}
	...
	assert(eq_(temp_9_0, temp_9_1)) by {
		cong_mul_(mod_(mul_(b, d), m), mul_(d, mod_(a, m)), mod_(mul_(b, d), m), mul_(d, mod_(sub_(a, mul_(mul_(mod_(sub_(a, c), m), mul_(a, a)), m)), m)));
		lemma_mod_mul_vanish(a, mul_(mod_(sub_(a, c), m), mul_(a, a)), m);
		cong_mul_(d, mod_(a, m), d, mod_(sub_(a, mul_(mul_(mod_(sub_(a, c), m), mul_(a, a)), m)), m));
		lemma_eq_ref(d);
	...
	assert(eq_(temp_11_0, temp_11_1)) by {
		lemma_add_comm(mul_(d, c), mul_(b, a));
	}
	...
	assert(eq_(temp_14_0, temp_14_1)) by {
		lemma_mod_mul_vanish(sub_(mod_(mul_(b, d), m), sub_(b, a)), mul_(a, mul_(b, c)), m);
	}
	...
	assert(eq_(temp_18_0, temp_18_1)) by {
		lemma_mod_mul_vanish(d, mul_(mul_(d, d), mul_(d, d)), m);
		cong_mul_(mul_(d, mod_(d, m)), mul_(c, a), mul_(d, mod_(sub_(d, mul_(mul_(mul_(d, d), mul_(d, d)), m)), m)), mul_(c, a));
		lemma_eq_ref(d);
		cong_mul_(d, mod_(d, m), d, mod_(sub_(d, mul_(mul_(mul_(d, d), mul_(d, d)), m)), m));
	...
	assert(eq_(temp_24_0, temp_24_1)) by {
		cong_mul_(mul_(b, c), mul_(as_elem(55), mod_(c, m)), mul_(b, c), mul_(as_elem(55), mod_(sub_(c, mul_(sub_(mul_(b, d), mul_(d, mod_(d, m))), m)), m)));
		lemma_mod_mul_vanish(c, sub_(mul_(b, d), mul_(d, mod_(d, m))), m);
		lemma_eq_ref(as_elem(55));
		lemma_eq_ref(mul_(b, c));
		cong_mul_(as_elem(55), mod_(c, m), as_elem(55), mod_(sub_(c, mul_(sub_(mul_(b, d), mul_(d, mod_(d, m))), m)), m));
	}
	let temp_25_0 = (mul_((add_(b, c)), (mul_(a, b))));
	let temp_25_1 = (mul_((add_(c, b)), (mul_(a, b))));
	assert(eq_(temp_25_0, temp_25_1)) by {
		cong_mul_(add_(b, c), mul_(a, b), add_(c, b), mul_(a, b));
		lemma_add_comm(b, c);
	...
	assert(eq_(temp_31_0, temp_31_1)) by {
		lemma_add_comm(mul_(d, b), mod_(b, m));
	}
	...
	assert(eq_(temp_34_0, temp_34_1)) by {
		lemma_mod_mul_vanish(mul_(a, a), add_(mul_(a, b), mul_(d, d)), m);
		cong_mul_(mul_(d, d), mod_(mul_(a, a), m), mul_(d, d), mod_(add_(mul_(add_(mul_(a, b), mul_(d, d)), m), mul_(a, a)), m));
	...
	assert(eq_(temp_35_0, temp_35_1)) by {
		lemma_mod_mul_vanish(add_(a, b), mul_(add_(mod_(a, m), b), mul_(d, c)), m);
		cong_mul_(mod_(add_(a, b), m), sub_(d, c), mod_(add_(add_(a, b), mul_(mul_(add_(mod_(a, m), b), mul_(d, c)), m)), m), sub_(d, c));
	...
	assert(eq_(temp_38_0, temp_38_1)) by {
		lemma_mul_assoc(add_(a, b), mod_(d, m), d);
	}
	...
	assert(eq_(temp_41_0, temp_41_1)) by {
		lemma_mul_comm(a, a);
		lemma_mod_mul_vanish(mul_(d, b), mul_(mul_(c, c), mod_(mul_(b, mod_(d, m)), m)), m);
		cong_mul_(mul_(a, a), mod_(mul_(d, b), m), mul_(a, a), mod_(add_(mul_(d, b), mul_(mul_(mul_(c, c), mod_(mul_(b, mod_(d, m)), m)), m)), m));
	}
	let temp_42_0 = (sub_((mul_(b, c)), (mul_(a, d))));
	let temp_42_1 = (sub_((mul_(c, b)), (mul_(a, d))));
	assert(eq_(temp_42_0, temp_42_1)) by {
		cong_sub_(mul_(b, c), mul_(a, d), mul_(c, b), mul_(a, d));
		lemma_mul_comm(b, c);
	...
	assert(eq_(temp_43_0, temp_43_1)) by {
		cong_mul_(add_(a, d), add_(b, a), add_(d, a), add_(b, a));
		lemma_add_comm(a, d);
	...
	assert(eq_(temp_44_0, temp_44_1)) by {
		lemma_mul_comm(b, c);
		cong_mul_(mul_(a, mod_(a, m)), mul_(b, c), mul_(a, mod_(a, m)), mul_(c, b));
	...
	assert(eq_(temp_57_0, temp_57_1)) by {
		...
		cong_add_(mul_(mod_(a, m), c), mul_(mod_(c, m), a), mul_(c, mod_(a, m)), mul_(mod_(c, m), a));
	...
	assert(eq_(temp_58_0, temp_58_1)) by {
		lemma_mod_mul_vanish(sub_(mul_(b, a), add_(a, b)), mul_(mul_(a, b), mod_(mul_(d, c), m)), m);
	}
	let temp_59_0 = (add_((mod_((mul_(a, c)), m)), (add_(d, d))));
	let temp_59_1 = (add_((add_(d, d)), (mod_((mul_(a, c)), m))));
	assert(eq_(temp_59_0, temp_59_1)) by {
		lemma_add_comm(mod_(mul_(a, c), m), add_(d, d));
	}
	...
	assert(eq_(temp_60_0, temp_60_1)) by {
		...
		cong_mul_(mod_(mul_(b, d), m), add_(c, d), mod_(add_(mul_(mul_(mul_(d, b), mul_(b, a)), m), mul_(b, d)), m), add_(c, d));
	...
	assert(eq_(temp_61_0, temp_61_1)) by {
		lemma_mod_mul_vanish(c, mul_(mul_(b, d), mul_(mod_(d, m), mod_(b, m))), m);
		cong_mul_(mul_(a, c), mul_(mod_(c, m), c), mul_(a, c), mul_(mod_(add_(mul_(mul_(mul_(b, d), mul_(mod_(d, m), mod_(b, m))), m), c), m), c));
		lemma_eq_ref(c);
		lemma_eq_ref(mul_(a, c));
		cong_mul_(mod_(c, m), c, mod_(add_(mul_(mul_(mul_(b, d), mul_(mod_(d, m), mod_(b, m))), m), c), m), c);
	}
	...
	assert(eq_(temp_67_0, temp_67_1)) by {
		...
		cong_mod_(mul_(mul_(b, a), mul_(d, mod_(c, m))), m, mul_(mul_(d, mod_(c, m)), mul_(b, a)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_68_0, temp_68_1)) by {
		lemma_mul_comm(c, b);
		cong_mod_(add_(mul_(c, b), mul_(b, mod_(a, m))), m, add_(mul_(b, c), mul_(b, mod_(a, m))), m);
		lemma_eq_ref(m);
		lemma_eq_ref(mul_(b, mod_(a, m)));
		cong_add_(mul_(c, b), mul_(b, mod_(a, m)), mul_(b, c), mul_(b, mod_(a, m)));
	}
	...
	assert(eq_(temp_69_0, temp_69_1)) by {
		lemma_mod_add_noop(mod_(mul_(mod_(b, m), c), m), mul_(b, c), m);
	}
	...
	assert(eq_(temp_71_0, temp_71_1)) by {
		...
		cong_mod_(mul_(mul_(c, c), mul_(b, d)), m, mul_(mul_(b, d), mul_(c, c)), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_72_0, temp_72_1)) by {
		lemma_mul_comm(b, c);
		cong_mod_(mul_(mul_(c, a), mul_(b, c)), m, mul_(mul_(c, a), mul_(c, b)), m);
		lemma_eq_ref(mul_(c, a));
	...
	assert(eq_(temp_73_0, temp_73_1)) by {
		...
		cong_sub_(mul_(c, a), mul_(b, mod_(c, m)), mul_(c, a), mul_(mod_(c, m), b));
		lemma_eq_ref(mul_(c, a));
	}
	...
	assert(eq_(temp_75_0, temp_75_1)) by {
		lemma_mul_assoc(a, d, mul_(c, mod_(b, m)));
	...
	assert(eq_(temp_76_0, temp_76_1)) by {
		lemma_mul_comm(mul_(c, c), mod_(mul_(b, b), m));
	}
	...
	assert(eq_(temp_78_0, temp_78_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(a, a), mul_(b, d)), mul_(sub_(mod_(c, m), c), add_(a, d)), m);
	}
	...
	assert(eq_(temp_82_0, temp_82_1)) by {
		lemma_mul_comm(b, b);
		lemma_mod_mul_vanish(d, mul_(add_(b, a), mul_(d, c)), m);
		cong_mul_(mul_(b, b), mul_(b, mod_(d, m)), mul_(b, b), mul_(b, mod_(add_(mul_(mul_(add_(b, a), mul_(d, c)), m), d), m)));
		lemma_eq_ref(b);
		cong_mul_(b, mod_(d, m), b, mod_(add_(mul_(mul_(add_(b, a), mul_(d, c)), m), d), m));
	}
	let temp_83_0 = (mod_((mul_((mul_(b, b)), (mul_(d, c)))), m));
	let temp_83_1 = (mod_((mul_(b, (mul_(b, (mul_(d, c)))))), m));
	assert(eq_(temp_83_0, temp_83_1)) by {
		lemma_mul_assoc(b, b, mul_(d, c));
		cong_mod_(mul_(mul_(b, b), mul_(d, c)), m, mul_(b, mul_(b, mul_(d, c))), m);
		lemma_eq_sym(mul_(b, mul_(b, mul_(d, c))), mul_(mul_(b, b), mul_(d, c)));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_87_0, temp_87_1)) by {
		lemma_mul_comm(d, as_elem(63));
		cong_add_(mul_(c, a), mul_(d, as_elem(63)), mul_(c, a), mul_(as_elem(63), d));
		lemma_eq_ref(mul_(c, a));
	}
	...
	assert(eq_(temp_88_0, temp_88_1)) by {
		...
		cong_mul_(mod_(mul_(d, b), m), mul_(a, b), mod_(add_(mul_(d, b), mul_(mul_(mul_(d, a), sub_(b, d)), m)), m), mul_(a, b));
		lemma_eq_ref(mul_(a, b));
	}
	...
	assert(eq_(temp_90_0, temp_90_1)) by {
		lemma_eq_ref(mul_(a, b));
		lemma_mod_mul_vanish(add_(b, b), add_(mul_(d, b), mul_(mod_(a, m), c)), m);
		cong_mul_(mul_(a, b), mod_(add_(b, b), m), mul_(a, b), mod_(sub_(add_(b, b), mul_(add_(mul_(d, b), mul_(mod_(a, m), c)), m)), m));
	}
	let temp_91_0 = (mul_((add_(d, (mod_(a, m)))), (add_(c, d))));
	let temp_91_1 = (add_((mul_((add_(d, (mod_(a, m)))), c)), (mul_((add_(d, (mod_(a, m)))), d))));
	assert(eq_(temp_91_0, temp_91_1)) by {
		lemma_mul_dist(add_(d, mod_(a, m)), c, d);
	}
	let temp_92_0 = (sub_((mul_(c, d)), (mul_((mod_(b, m)), d))));
	let temp_92_1 = (mul_((sub_(c, (mod_(b, m)))), d));
	assert(eq_(temp_92_0, temp_92_1)) by {
		lemma_mul_dist(d, c, mod_(b, m));
	...
	assert(eq_(temp_93_0, temp_93_1)) by {
		cong_sub_(sub_(b, a), mul_(d, a), sub_(b, a), mul_(a, d));
		lemma_mul_comm(d, a);
	...
	assert(eq_(temp_94_0, temp_94_1)) by {
		lemma_mul_assoc(mod_(mul_(b, mod_(b, m)), m), as_elem(100), a);
	}
	...
	assert(eq_(temp_95_0, temp_95_1)) by {
		cong_add_(mul_(mod_(b, m), c), mul_(c, c), mul_(mod_(sub_(b, mul_(sub_(mul_(a, a), mul_(as_elem(40), mod_(d, m))), m)), m), c), mul_(c, c));
		lemma_mod_mul_vanish(b, sub_(mul_(a, a), mul_(as_elem(40), mod_(d, m))), m);
		cong_mul_(mod_(b, m), c, mod_(sub_(b, mul_(sub_(mul_(a, a), mul_(as_elem(40), mod_(d, m))), m)), m), c);
	...
	assert(eq_(temp_97_0, temp_97_1)) by {
		cong_mul_(sub_(a, b), mod_(sub_(d, b), m), sub_(a, b), mod_(sub_(mod_(d, m), mod_(b, m)), m));
	...
	assert(eq_(temp_98_0, temp_98_1)) by {
		lemma_add_comm(add_(c, d), mul_(b, c));
	}
	...
	assert(eq_(temp_99_0, temp_99_1)) by {
		lemma_mul_comm(b, b);
		lemma_mod_mul_vanish(mul_(a, as_elem(67)), mul_(mod_(mul_(d, a), m), mul_(d, a)), m);
		cong_mul_(mul_(b, b), mod_(mul_(a, as_elem(67)), m), mul_(b, b), mod_(add_(mul_(a, as_elem(67)), mul_(mul_(mod_(mul_(d, a), m), mul_(d, a)), m)), m));
	}
	...
	assert(eq_(temp_101_0, temp_101_1)) by {
		lemma_mul_dist(mul_(d, c), a, a);
		cong_mod_(mul_(sub_(a, a), mul_(d, c)), m, sub_(mul_(a, mul_(d, c)), mul_(a, mul_(d, c))), m);
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_103_0, temp_103_1)) by {
		cong_mul_(mul_(c, b), sub_(d, a), mul_(b, c), sub_(d, a));
		lemma_mul_comm(c, b);
	...
	assert(eq_(temp_105_0, temp_105_1)) by {
		...
		lemma_mul_assoc(as_elem(13), b, mul_(c, b));
	}
	...
	assert(eq_(temp_107_0, temp_107_1)) by {
		lemma_mod_mul_vanish(d, mul_(mul_(d, mod_(b, m)), add_(d, d)), m);
		cong_mul_(mul_(mod_(d, m), d), sub_(d, d), mul_(mod_(sub_(d, mul_(mul_(mul_(d, mod_(b, m)), add_(d, d)), m)), m), d), sub_(d, d));
		lemma_eq_ref(d);
		cong_mul_(mod_(d, m), d, mod_(sub_(d, mul_(mul_(mul_(d, mod_(b, m)), add_(d, d)), m)), m), d);
		cong_sub_(d, d, d, d);
	}
	...
	assert(eq_(temp_108_0, temp_108_1)) by {
		lemma_add_comm(mul_(d, d), mul_(as_elem(71), mod_(b, m)));
	}
	...
	assert(eq_(temp_109_0, temp_109_1)) by {
		lemma_mod_mul_vanish(add_(b, a), mul_(mul_(a, b), mul_(b, c)), m);
		cong_mul_(sub_(b, a), mod_(add_(b, a), m), sub_(b, a), mod_(add_(add_(b, a), mul_(mul_(mul_(a, b), mul_(b, c)), m)), m));
		lemma_eq_ref(sub_(b, a));
	}
	...
	assert(eq_(temp_110_0, temp_110_1)) by {
		lemma_mul_comm(c, d);
		cong_mul_(mul_(c, d), mul_(mod_(d, m), b), mul_(d, c), mul_(mod_(d, m), b));
	...
	assert(eq_(temp_113_0, temp_113_1)) by {
		...
		cong_mod_(sub_(mul_(b, c), mul_(a, c)), m, mul_(sub_(b, a), c), m);
		lemma_eq_sym(mul_(sub_(b, a), c), sub_(mul_(b, c), mul_(a, c)));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_117_0, temp_117_1)) by {
		lemma_mul_comm(c, d);
		cong_mul_(mul_(mod_(a, m), c), mul_(c, d), mul_(mod_(a, m), c), mul_(d, c));
	...
	assert(eq_(temp_118_0, temp_118_1)) by {
		lemma_mul_assoc(mul_(c, b), as_elem(62), b);
	}
	...
	assert(eq_(temp_119_0, temp_119_1)) by {
		...
		lemma_mul_assoc(mod_(a, m), a, mul_(b, b));
	}
	...
	assert(eq_(temp_121_0, temp_121_1)) by {
		lemma_mod_mul_noop(d, mod_(b, m), m);
		cong_mul_(sub_(a, c), mod_(mul_(mod_(b, m), mod_(d, m)), m), sub_(a, c), mod_(mod_(mul_(d, mod_(b, m)), m), m));
		lemma_eq_sym(mod_(mod_(mul_(d, mod_(b, m)), m), m), mod_(mul_(mod_(b, m), mod_(d, m)), m));
	...
	assert(eq_(temp_122_0, temp_122_1)) by {
		lemma_mul_comm(sub_(d, b), sub_(a, as_elem(33)));
		cong_mod_(mul_(sub_(d, b), sub_(a, as_elem(33))), m, mul_(sub_(a, as_elem(33)), sub_(d, b)), m);
		lemma_eq_ref(m);
	}
	let temp_123_0 = (sub_((mul_(b, c)), (mul_(a, a))));
	let temp_123_1 = (sub_((mul_(c, b)), (mul_(a, a))));
	assert(eq_(temp_123_0, temp_123_1)) by {
		cong_sub_(mul_(b, c), mul_(a, a), mul_(c, b), mul_(a, a));
		lemma_mul_comm(b, c);
		lemma_mul_comm(a, a);
	}
	...
	assert(eq_(temp_124_0, temp_124_1)) by {
		cong_mul_(mul_(d, c), mul_(c, mod_(d, m)), mul_(d, c), mul_(mod_(d, m), c));
