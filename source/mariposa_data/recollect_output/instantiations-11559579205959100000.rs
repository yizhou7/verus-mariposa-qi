...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_commutative((b0 + c0) - (b0 * b0), (c0 * a0) * (b0 * c0));
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		...
		lemma_mul_is_associative((c1 * b1) * (c1 - a1), b1 * a1, d1 * c1);
		lemma_mul_is_associative((c1 * b1) * (c1 - a1), b1 * a1, c1 * d1);
	}
	let temp_2_0 = ((c2*((d2-d2)*(b2*b2)))*(((b2+d2)*(b2*d2))*b2));
	let temp_2_1 = ((c2*((d2-d2)*(b2*b2)))*((b2+d2)*((b2*d2)*b2)));
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_associative(b2 + d2, b2 * d2, b2);
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_associative((a4 * c4) * (b4 * b4), d4 * b4, b4 - a4);
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_distributive(a6 * c6, a6, a6);
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_associative(b8 + a8, a8 * b8, b8);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_distributive((d12 * a12) * c12, d12 * c12, d12 * c12);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_associative(((d13 * a13) * (d13 * c13)) * ((b13 - a13) * (c13 * d13)), (d13 * c13) * (c13 * d13), (a13 * d13) - (b13 * c13));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_associative(c15, b15 * (d15 * d15), (c15 * b15) * (a15 * b15));
		lemma_mul_is_commutative(b15, a15);
		lemma_mul_is_associative(c15, b15 * (d15 * d15), (c15 * b15) * (b15 * a15));
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_distributive(b18 * b18, a18, b18);
	}
	...
	assert(temp_20_0 == temp_20_1) by {
		lemma_mul_is_associative(((d20 - d20) * a20) * d20, c20 * (a20 * b20), a20);
		lemma_mul_is_associative(d20 - d20, a20, d20);
		lemma_mul_is_associative((d20 - d20) * (a20 * d20), c20 * (a20 * b20), a20);
	}
	...
	assert(temp_21_0 == temp_21_1) by {
		lemma_mul_is_commutative(a21 * d21, c21 * c21);
		lemma_mul_is_associative(((d21 * b21) - (a21 + b21)) - ((d21 * a21) * (d21 * b21)), (b21 * a21) * (d21 + c21), (a21 * d21) * (c21 * c21));
		lemma_mul_is_associative(((d21 * b21) - (a21 + b21)) - ((d21 * a21) * (d21 * b21)), (b21 * a21) * (d21 + c21), (c21 * c21) * (a21 * d21));
	}
	...
	assert(temp_22_0 == temp_22_1) by {
		...
		lemma_mul_is_associative(((b22 * d22) * (b22 * c22)) * ((b22 * b22) * (d22 * a22)), (a22 * d22) * (c22 * b22), (d22 * a22) * (c22 * a22));
		lemma_mul_is_associative(((b22 * d22) * (b22 * c22)) * ((b22 * b22) * (d22 * a22)), (a22 * d22) * (c22 * b22), (d22 * a22) * (a22 * c22));
	}
	...
	assert(temp_23_0 == temp_23_1) by {
		lemma_mul_is_commutative(a23, b23);
		lemma_mul_is_associative((c23 * d23) * (a23 * b23), a23 - c23, a23 * b23);
		lemma_mul_is_associative((c23 * d23) * (a23 * b23), a23 - c23, b23 * a23);
	}
	...
	assert(temp_24_0 == temp_24_1) by {
		lemma_mul_is_associative(b24 + ((b24 * a24) * (d24 - c24)), (a24 * a24) * (b24 * d24), (c24 * c24) * a24);
		lemma_mul_is_associative(c24, c24, a24);
		lemma_mul_is_associative(b24 + ((b24 * a24) * (d24 - c24)), (a24 * a24) * (b24 * d24), c24 * (c24 * a24));
	}
	...
	assert(temp_25_0 == temp_25_1) by {
		lemma_mul_is_associative(d25 * c25, d25 + b25, a25);
	}
	...
	assert(temp_27_0 == temp_27_1) by {
		lemma_mul_is_commutative(c27, a27);
	}
