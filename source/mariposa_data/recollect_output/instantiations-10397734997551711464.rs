...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_associative(b0, a0, d0 * d0);
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_associative(b1 * c1, 76, d1);
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		...
		lemma_mul_is_associative((b2 * c2) * (d2 + b2), a2 * b2, a2 * b2);
		lemma_mul_is_associative((b2 * c2) * (d2 + b2), a2 * b2, b2 * a2);
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_associative(d3, a3, c3 - d3);
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_distributive((a4 * a4) * (d4 * a4), a4 * a4, d4 * d4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		...
		lemma_mul_is_associative((a5 * b5) * (b5 * a5), (d5 * c5) * a5, ((c5 - b5) + (d5 * b5)) - ((a5 + d5) * (a5 * a5)));
		lemma_mul_is_associative((b5 * a5) * (b5 * a5), (d5 * c5) * a5, ((c5 - b5) + (d5 * b5)) - ((a5 + d5) * (a5 * a5)));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		...
		lemma_mul_is_associative((b6 - b6) + (c6 * d6), c6 * b6, b6 * c6);
		lemma_mul_is_associative((b6 - b6) + (c6 * d6), c6 * b6, c6 * b6);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_commutative(a7, c7 * b7);
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		...
		lemma_mul_is_associative((b8 * c8) * (d8 * a8), (c8 * c8) + (a8 * a8), ((a8 * d8) * (b8 * b8)) * ((d8 * c8) * (b8 * b8)));
		lemma_mul_is_associative((b8 * c8) * (a8 * d8), (c8 * c8) + (a8 * a8), ((a8 * d8) * (b8 * b8)) * ((d8 * c8) * (b8 * b8)));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		...
		lemma_mul_is_associative((c9 * a9) * a9, (d9 * a9) * (b9 * 17), ((d9 * a9) * (b9 * d9)) * ((b9 * b9) * (d9 * b9)));
		lemma_mul_is_associative(a9 * (c9 * a9), (d9 * a9) * (b9 * 17), ((d9 * a9) * (b9 * d9)) * ((b9 * b9) * (d9 * b9)));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		...
		lemma_mul_is_associative((b10 * a10) * (b10 * c10), (c10 * d10) + (d10 * a10), ((d10 * b10) * (a10 + d10)) * (d10 * (d10 * d10)));
		lemma_mul_is_associative((a10 * b10) * (b10 * c10), (c10 * d10) + (d10 * a10), ((d10 * b10) * (a10 + d10)) * (d10 * (d10 * d10)));
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_commutative((c12 * b12) * (b12 + d12), b12);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_associative((c13 * c13) * (d13 * b13), b13 * d13, d13 * a13);
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_associative(a14, c14, d14 * c14);
		lemma_mul_is_associative(a14 * (c14 * (d14 * c14)), (d14 * a14) * (a14 * d14), ((d14 * b14) * (b14 * a14)) * ((c14 * b14) - (d14 * b14)));
		lemma_mul_is_associative((a14 * c14) * (d14 * c14), (d14 * a14) * (a14 * d14), ((d14 * b14) * (b14 * a14)) * ((c14 * b14) - (d14 * b14)));
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_commutative((a17 * d17) * (c17 - c17), (a17 * b17) * (b17 * a17));
	}
