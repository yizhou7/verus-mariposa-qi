...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_commutative(((b0 * d0) * (c0 * d0)) * ((a0 * c0) * (d0 - b0)), ((d0 * a0) * (d0 * d0)) * ((b0 * d0) * (b0 * b0)));
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_commutative(((c1 * a1) * (c1 * c1)) * ((b1 * 50) * (86 * c1)), (c1 * (b1 - c1)) * ((c1 - b1) + (d1 * c1)));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		...
		lemma_mul_is_associative(((d6 * d6) * (a6 * b6)) * ((b6 + c6) * c6), (b6 * b6) * (a6 * c6), (c6 * b6) * (b6 * d6));
		lemma_mul_is_associative(((d6 * d6) * (a6 * b6)) * ((b6 + c6) * c6), (b6 * b6) * (a6 * c6), (b6 * d6) * (c6 * b6));
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_commutative((a7 * 69) + (b7 + 9), (c7 * d7) * (d7 + b7));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_commutative(c8 * c8, b8 * c8);
		lemma_mul_is_associative((c8 * c8) * (b8 * c8), (a8 * d8) * (b8 * b8), ((a8 * d8) * (b8 + d8)) - ((c8 * a8) * (c8 + a8)));
		lemma_mul_is_associative((b8 * c8) * (c8 * c8), (a8 * d8) * (b8 * b8), ((a8 * d8) * (b8 + d8)) - ((c8 * a8) * (c8 + a8)));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_commutative(74, d9);
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_commutative(d10 * d10, a10 * c10);
		lemma_mul_is_associative(((a10 * d10) * (d10 - a10)) + ((b10 * d10) * (a10 * b10)), (c10 * a10) * (b10 * d10), (d10 * d10) * (a10 * c10));
		lemma_mul_is_associative(((a10 * d10) * (d10 - a10)) + ((b10 * d10) * (a10 * b10)), (c10 * a10) * (b10 * d10), (a10 * c10) * (d10 * d10));
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_distributive(c11, b11, d11);
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_associative(b12 * a12, d12 * b12, (c12 * b12) * (c12 * c12));
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		...
		lemma_mul_is_associative((d13 * b13) * c13, a13 * a13, b13 * c13);
		lemma_mul_is_associative((d13 * b13) * c13, a13 * a13, c13 * b13);
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_commutative(a14, c14 * d14);
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_commutative((c15 * b15) * (a15 * a15), (d15 * 24) + (c15 * a15));
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_associative(a17, a17, a17 * c17);
	}
	...
	assert(temp_19_0 == temp_19_1) by {
		lemma_mul_is_commutative(c19, b19);
	}
	...
	assert(temp_20_0 == temp_20_1) by {
		lemma_mul_is_commutative(c20 * d20, c20 - c20);
		lemma_mul_is_associative(b20 * b20, (b20 * c20) * (b20 * d20), (c20 * d20) * (c20 - c20));
		lemma_mul_is_associative(b20 * b20, (b20 * c20) * (b20 * d20), (c20 - c20) * (c20 * d20));
	}
	...
	assert(temp_21_0 == temp_21_1) by {
		lemma_mul_is_commutative(b21 * d21, c21 * c21);
	}
	...
	assert(temp_22_0 == temp_22_1) by {
		lemma_mul_is_distributive(b22, b22, a22 * b22);
	}
	...
	assert(temp_23_0 == temp_23_1) by {
		lemma_mul_is_associative(c23 * c23, c23 * b23, (d23 - d23) - (a23 - b23));
	}
