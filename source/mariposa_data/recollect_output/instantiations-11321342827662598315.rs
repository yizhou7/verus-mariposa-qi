...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_associative(c0 - b0, d0 + a0, (b0 - c0) - a0);
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_associative((c1 * b1) * (b1 * b1), b1 * d1, b1 * d1);
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_distributive(b3 * d3, c3 * c3, b3 * d3);
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_distributive((c4 * b4) * (c4 * a4), a4 * d4, a4 + d4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_commutative((d5 - 97) * (d5 * b5), (a5 * a5) * (b5 * b5));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_distributive((d6 * b6) * (d6 * c6), a6 * b6, b6 * a6);
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_associative(a8, a8, b8);
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_commutative(((b9 * a9) * (d9 * b9)) * ((a9 + d9) * (d9 * c9)), d9 * ((d9 * a9) * (a9 * a9)));
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_associative(d10, b10, a10 - c10);
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_commutative(c11 * b11, d11 * b11);
		lemma_mul_is_associative((c11 * b11) * (d11 * b11), (a11 * b11) * (b11 * a11), ((a11 * d11) * (a11 * a11)) * ((a11 * d11) * (c11 * c11)));
		lemma_mul_is_associative((d11 * b11) * (c11 * b11), (a11 * b11) * (b11 * a11), ((a11 * d11) * (a11 * a11)) * ((a11 * d11) * (c11 * c11)));
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_associative(((b12 * c12) + (d12 * b12)) + ((c12 * c12) * (a12 * a12)), (d12 - d12) * (a12 + a12), (32 * (a12 * c12)) + (a12 * (a12 * c12)));
		lemma_mul_is_distributive(32, a12, a12 * c12);
		lemma_mul_is_associative(((b12 * c12) + (d12 * b12)) + ((c12 * c12) * (a12 * a12)), (d12 - d12) * (a12 + a12), (32 + a12) * (a12 * c12));
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_distributive((a14 * a14) * (a14 * b14), 27 * d14, c14 * a14);
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		...
		lemma_mul_is_associative((c15 * b15) * (d15 * d15), (a15 * a15) * (b15 + c15), ((d15 * a15) * (b15 * c15)) + (d15 * (d15 * b15)));
		lemma_mul_is_associative((b15 * c15) * (d15 * d15), (a15 * a15) * (b15 + c15), ((d15 * a15) * (b15 * c15)) + (d15 * (d15 * b15)));
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_commutative(a18, d18);
	}
