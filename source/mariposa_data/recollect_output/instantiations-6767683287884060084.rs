...
pub proof fn free_0(a: Elem, b: Elem, c: Elem, d: Elem, m: Elem)
{
	...
	assert(eq_(temp_5_0, temp_5_1)) by {
		lemma_mod_mul_vanish(mul_(b, d), mul_(mul_(b, d), mod_(mul_(c, a), m)), m);
		cong_mul_(mod_(mul_(b, d), m), mul_(d, a), mod_(add_(mul_(mul_(mul_(b, d), mod_(mul_(c, a), m)), m), mul_(b, d)), m), mul_(d, a));
	...
	assert(eq_(temp_9_0, temp_9_1)) by {
		cong_add_(mul_(a, b), mul_(b, a), mul_(b, a), mul_(b, a));
		lemma_mul_comm(a, b);
	...
	assert(eq_(temp_11_0, temp_11_1)) by {
		cong_add_(mul_(b, c), mul_(a, b), mul_(b, c), mul_(b, a));
		lemma_mul_comm(a, b);
	...
	assert(eq_(temp_13_0, temp_13_1)) by {
		cong_mod_(mul_(mul_(mod_(b, m), b), mul_(c, a)), m, mul_(mul_(mod_(add_(mul_(add_(mod_(mul_(d, a), m), mul_(c, as_elem(79))), m), b), m), b), mul_(c, a)), m);
		lemma_mod_mul_vanish(b, add_(mod_(mul_(d, a), m), mul_(c, as_elem(79))), m);
		cong_mul_(mul_(mod_(b, m), b), mul_(c, a), mul_(mod_(add_(mul_(add_(mod_(mul_(d, a), m), mul_(c, as_elem(79))), m), b), m), b), mul_(c, a));
		lemma_eq_ref(m);
		lemma_eq_ref(b);
		cong_mul_(mod_(b, m), b, mod_(add_(mul_(add_(mod_(mul_(d, a), m), mul_(c, as_elem(79))), m), b), m), b);
		lemma_eq_ref(mul_(c, a));
	}
	let temp_14_0 = (sub_((mul_(as_elem(71), c)), (mul_(b, b))));
	let temp_14_1 = (sub_((mul_(c, as_elem(71))), (mul_(b, b))));
	assert(eq_(temp_14_0, temp_14_1)) by {
		cong_sub_(mul_(as_elem(71), c), mul_(b, b), mul_(c, as_elem(71)), mul_(b, b));
		lemma_mul_comm(as_elem(71), c);
		lemma_mul_comm(b, b);
	}
	...
	assert(eq_(temp_15_0, temp_15_1)) by {
		...
		cong_mul_(mul_(d, mod_(d, m)), add_(mod_(a, m), d), mul_(mod_(d, m), d), add_(mod_(a, m), d));
	...
	assert(eq_(temp_16_0, temp_16_1)) by {
		lemma_mod_mul_vanish(b, sub_(mul_(a, a), mul_(c, d)), m);
		cong_add_(mul_(mod_(b, m), d), mul_(c, a), mul_(mod_(add_(b, mul_(sub_(mul_(a, a), mul_(c, d)), m)), m), d), mul_(c, a));
		lemma_eq_ref(d);
		cong_mul_(mod_(b, m), d, mod_(add_(b, mul_(sub_(mul_(a, a), mul_(c, d)), m)), m), d);
		lemma_eq_ref(mul_(c, a));
	}
	...
	assert(eq_(temp_17_0, temp_17_1)) by {
		lemma_mul_comm(d, d);
		lemma_mod_mul_vanish(sub_(c, b), mul_(mul_(as_elem(11), a), sub_(c, b)), m);
		cong_mul_(mod_(sub_(c, b), m), mul_(d, d), mod_(add_(sub_(c, b), mul_(mul_(mul_(as_elem(11), a), sub_(c, b)), m)), m), mul_(d, d));
	}
	let temp_18_0 = (mul_(b, (mul_(a, a))));
	let temp_18_1 = (mul_((mul_(b, a)), a));
	assert(eq_(temp_18_0, temp_18_1)) by {
		lemma_mul_assoc(b, a, a);
	}
	let temp_19_0 = (sub_((mul_(c, d)), (sub_(c, as_elem(99)))));
	let temp_19_1 = (sub_((mul_(d, c)), (sub_(c, as_elem(99)))));
	assert(eq_(temp_19_0, temp_19_1)) by {
		cong_sub_(mul_(c, d), sub_(c, as_elem(99)), mul_(d, c), sub_(c, as_elem(99)));
		lemma_mul_comm(c, d);
		lemma_eq_ref(sub_(c, as_elem(99)));
	}
	let temp_20_0 = (sub_((mul_(a, b)), (add_(c, d))));
	let temp_20_1 = (sub_((mul_(a, b)), (add_(d, c))));
	assert(eq_(temp_20_0, temp_20_1)) by {
		lemma_add_comm(c, d);
		cong_sub_(mul_(a, b), add_(c, d), mul_(a, b), add_(d, c));
	...
	assert(eq_(temp_21_0, temp_21_1)) by {
		lemma_mul_comm(a, a);
		lemma_mod_mul_vanish(b, sub_(sub_(d, c), add_(mod_(b, m), d)), m);
		cong_mul_(mul_(mod_(b, m), a), mul_(a, a), mul_(mod_(add_(mul_(sub_(sub_(d, c), add_(mod_(b, m), d)), m), b), m), a), mul_(a, a));
		lemma_eq_ref(a);
		cong_mul_(mod_(b, m), a, mod_(add_(mul_(sub_(sub_(d, c), add_(mod_(b, m), d)), m), b), m), a);
	}
	let temp_22_0 = (mul_(a, (sub_(d, c))));
	let temp_22_1 = (mul_((sub_(d, c)), a));
	assert(eq_(temp_22_0, temp_22_1)) by {
		lemma_mul_comm(a, sub_(d, c));
	}
	...
	assert(eq_(temp_28_0, temp_28_1)) by {
		lemma_mul_comm(as_elem(94), d);
		cong_mul_(mul_(b, c), mul_(as_elem(94), d), mul_(b, c), mul_(d, as_elem(94)));
		lemma_eq_ref(mul_(b, c));
	}
	...
	assert(eq_(temp_31_0, temp_31_1)) by {
		lemma_mul_assoc(sub_(b, d), a, a);
	}
	let temp_32_0 = (mul_((mul_(b, d)), (mul_(b, (mod_(a, m))))));
	let temp_32_1 = (mul_((mul_(b, d)), (mul_((mod_(a, m)), b))));
	assert(eq_(temp_32_0, temp_32_1)) by {
		lemma_mul_comm(mod_(a, m), b);
		cong_mul_(mul_(b, d), mul_(b, mod_(a, m)), mul_(b, d), mul_(mod_(a, m), b));
		lemma_eq_sym(mul_(mod_(a, m), b), mul_(b, mod_(a, m)));
	...
	assert(eq_(temp_33_0, temp_33_1)) by {
		lemma_eq_ref(sub_(mod_(c, m), as_elem(82)));
		lemma_mul_comm(a, c);
		cong_add_(mul_(a, c), sub_(mod_(c, m), as_elem(82)), mul_(c, a), sub_(mod_(c, m), as_elem(82)));
	}
	...
	assert(eq_(temp_34_0, temp_34_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(b, d), mul_(c, d)), mul_(mul_(c, a), mod_(sub_(a, c), m)), m);
	}
	...
	assert(eq_(temp_36_0, temp_36_1)) by {
		...
		cong_add_(mul_(mod_(b, m), a), sub_(a, a), mul_(a, mod_(b, m)), sub_(a, a));
	...
	assert(eq_(temp_45_0, temp_45_1)) by {
		cong_add_(mod_(mul_(b, c), m), mul_(d, d), mod_(sub_(mul_(b, c), mul_(mul_(sub_(c, c), mul_(b, c)), m)), m), mul_(d, d));
		lemma_mod_mul_vanish(mul_(b, c), mul_(sub_(c, c), mul_(b, c)), m);
	...
	assert(eq_(temp_47_0, temp_47_1)) by {
		lemma_eq_ref(c);
		cong_mul_(mod_(c, m), c, mod_(add_(mul_(mod_(add_(mul_(d, mod_(d, m)), mul_(a, d)), m), m), c), m), c);
		lemma_mod_mul_vanish(c, mod_(add_(mul_(d, mod_(d, m)), mul_(a, d)), m), m);
		cong_mul_(mul_(mod_(c, m), c), mul_(d, d), mul_(mod_(add_(mul_(mod_(add_(mul_(d, mod_(d, m)), mul_(a, d)), m), m), c), m), c), mul_(d, d));
		lemma_eq_ref(mul_(d, d));
	}
	let temp_48_0 = (mul_((mul_(d, (mod_(b, m)))), (add_(d, c))));
	let temp_48_1 = (mul_((mul_(d, (mod_((add_(b, (mul_((mul_((mul_(d, b)), c)), m)))), m)))), (add_(d, c))));
	assert(eq_(temp_48_0, temp_48_1)) by {
		cong_mul_(d, mod_(b, m), d, mod_(add_(b, mul_(mul_(mul_(d, b), c), m)), m));
		lemma_eq_ref(add_(d, c));
		lemma_eq_ref(d);
		lemma_mod_mul_vanish(b, mul_(mul_(d, b), c), m);
		cong_mul_(mul_(d, mod_(b, m)), add_(d, c), mul_(d, mod_(add_(b, mul_(mul_(mul_(d, b), c), m)), m)), add_(d, c));
	}
	let temp_49_0 = (mul_((mod_((mul_(a, a)), m)), (add_(c, c))));
	let temp_49_1 = (add_((mul_((mod_((mul_(a, a)), m)), c)), (mul_((mod_((mul_(a, a)), m)), c))));
	assert(eq_(temp_49_0, temp_49_1)) by {
		lemma_mul_dist(mod_(mul_(a, a), m), c, c);
	}
	let temp_50_0 = (mul_((mul_(a, b)), (mul_(c, (mod_(c, m))))));
	let temp_50_1 = (mul_(a, (mul_(b, (mul_(c, (mod_(c, m))))))));
	assert(eq_(temp_50_0, temp_50_1)) by {
		lemma_mul_assoc(a, b, mul_(c, mod_(c, m)));
	...
	assert(eq_(temp_54_0, temp_54_1)) by {
		cong_mul_(mod_(a, m), c, mod_(sub_(a, mul_(mul_(mod_(mul_(mod_(d, m), c), m), mul_(c, b)), m)), m), c);
		lemma_eq_ref(mul_(d, c));
		cong_mul_(mul_(mod_(a, m), c), mul_(d, c), mul_(mod_(sub_(a, mul_(mul_(mod_(mul_(mod_(d, m), c), m), mul_(c, b)), m)), m), c), mul_(d, c));
		lemma_mod_mul_vanish(a, mul_(mod_(mul_(mod_(d, m), c), m), mul_(c, b)), m);
		lemma_eq_ref(c);
	}
	...
	assert(eq_(temp_55_0, temp_55_1)) by {
		lemma_eq_ref(m);
		lemma_mul_comm(mod_(mul_(d, d), m), mul_(b, c));
		cong_mod_(mul_(mod_(mul_(d, d), m), mul_(b, c)), m, mul_(mul_(b, c), mod_(mul_(d, d), m)), m);
	}
	...
	assert(eq_(temp_58_0, temp_58_1)) by {
		lemma_mul_comm(mod_(add_(c, d), m), sub_(a, b));
	}
	...
	assert(eq_(temp_62_0, temp_62_1)) by {
		...
		lemma_mul_assoc(mod_(b, m), a, mul_(b, b));
	}
	...
	assert(eq_(temp_63_0, temp_63_1)) by {
		lemma_mod_mul_vanish(mul_(b, d), mul_(mul_(b, d), mul_(c, c)), m);
		cong_mul_(mod_(add_(as_elem(73), c), m), mod_(mul_(b, d), m), mod_(add_(as_elem(73), c), m), mod_(sub_(mul_(b, d), mul_(mul_(mul_(b, d), mul_(c, c)), m)), m));
		lemma_eq_ref(mod_(add_(as_elem(73), c), m));
	}
	...
	assert(eq_(temp_65_0, temp_65_1)) by {
		lemma_mod_mul_vanish(a, add_(mul_(a, b), mul_(mod_(a, m), b)), m);
		cong_add_(mul_(mod_(d, m), b), mul_(mod_(a, m), c), mul_(mod_(d, m), b), mul_(mod_(add_(a, mul_(add_(mul_(a, b), mul_(mod_(a, m), b)), m)), m), c));
		lemma_eq_ref(mul_(mod_(d, m), b));
		cong_mul_(mod_(a, m), c, mod_(add_(a, mul_(add_(mul_(a, b), mul_(mod_(a, m), b)), m)), m), c);
		lemma_eq_ref(c);
	}
	let temp_66_0 = (mul_((mul_(c, (mod_(d, m)))), (mul_(c, a))));
	let temp_66_1 = (mul_(c, (mul_((mod_(d, m)), (mul_(c, a))))));
	assert(eq_(temp_66_0, temp_66_1)) by {
		lemma_mul_assoc(c, mod_(d, m), mul_(c, a));
	...
	assert(eq_(temp_67_0, temp_67_1)) by {
		lemma_mul_assoc(mod_(add_(as_elem(37), c), m), c, d);
	}
	...
	assert(eq_(temp_74_0, temp_74_1)) by {
		lemma_mul_comm(c, d);
		cong_add_(mul_(as_elem(70), a), mul_(c, d), mul_(as_elem(70), a), mul_(d, c));
		lemma_eq_ref(mul_(as_elem(70), a));
	}
	...
	assert(eq_(temp_75_0, temp_75_1)) by {
		lemma_mul_comm(mod_(a, m), mod_(as_elem(97), m));
		cong_mul_(mul_(mod_(a, m), mod_(as_elem(97), m)), mul_(a, d), mul_(mod_(as_elem(97), m), mod_(a, m)), mul_(a, d));
		lemma_eq_ref(mul_(a, d));
	}
	let temp_76_0 = (sub_((mul_(c, d)), (mul_(c, a))));
	let temp_76_1 = (sub_((mul_(d, c)), (mul_(c, a))));
	assert(eq_(temp_76_0, temp_76_1)) by {
		cong_sub_(mul_(c, d), mul_(c, a), mul_(d, c), mul_(c, a));
		lemma_mul_comm(c, d);
		lemma_eq_ref(mul_(c, a));
	}
	...
	assert(eq_(temp_77_0, temp_77_1)) by {
		lemma_add_comm(mul_(d, mod_(a, m)), mul_(mod_(a, m), mod_(d, m)));
	}
	...
	assert(eq_(temp_78_0, temp_78_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(c, d), mod_(mul_(d, c), m)), mul_(mul_(d, d), mul_(a, d)), m);
	}
	...
	assert(eq_(temp_79_0, temp_79_1)) by {
		lemma_mod_mul_vanish(c, mul_(mul_(mod_(c, m), a), mul_(a, d)), m);
		cong_mul_(mul_(d, c), mul_(c, mod_(c, m)), mul_(d, c), mul_(c, mod_(add_(mul_(mul_(mul_(mod_(c, m), a), mul_(a, d)), m), c), m)));
		lemma_eq_ref(c);
		cong_mul_(c, mod_(c, m), c, mod_(add_(mul_(mul_(mul_(mod_(c, m), a), mul_(a, d)), m), c), m));
		lemma_eq_ref(mul_(d, c));
	}
	let temp_80_0 = (mul_((sub_(d, d)), (mul_(d, b))));
	let temp_80_1 = (mul_((mul_((sub_(d, d)), d)), b));
	assert(eq_(temp_80_0, temp_80_1)) by {
		lemma_mul_assoc(sub_(d, d), d, b);
	}
	...
	assert(eq_(temp_83_0, temp_83_1)) by {
		lemma_mod_mul_vanish(b, mul_(mod_(sub_(a, c), m), mul_(mod_(c, m), c)), m);
		cong_mul_(mul_(mod_(b, m), c), mod_(mul_(b, b), m), mul_(mod_(add_(mul_(mul_(mod_(sub_(a, c), m), mul_(mod_(c, m), c)), m), b), m), c), mod_(mul_(b, b), m));
		lemma_eq_ref(c);
		cong_mul_(mod_(b, m), c, mod_(add_(mul_(mul_(mod_(sub_(a, c), m), mul_(mod_(c, m), c)), m), b), m), c);
	...
	assert(eq_(temp_85_0, temp_85_1)) by {
		...
		cong_sub_(mul_(b, c), mul_(b, mod_(c, m)), mul_(b, c), mul_(b, mod_(add_(mul_(mul_(mul_(d, a), mul_(d, d)), m), c), m)));
		lemma_eq_ref(b);
		cong_mul_(b, mod_(c, m), b, mod_(add_(mul_(mul_(mul_(d, a), mul_(d, d)), m), c), m));
		lemma_eq_ref(mul_(b, c));
	}
	let temp_86_0 = (mul_((sub_(c, c)), (mod_((mul_(b, d)), m))));
	let temp_86_1 = (sub_((mul_(c, (mod_((mul_(b, d)), m)))), (mul_(c, (mod_((mul_(b, d)), m))))));
	assert(eq_(temp_86_0, temp_86_1)) by {
		lemma_mul_dist(mod_(mul_(b, d), m), c, c);
	}
	...
	assert(eq_(temp_87_0, temp_87_1)) by {
		lemma_mod_mul_vanish(b, mul_(sub_(mod_(d, m), a), mul_(c, mod_(c, m))), m);
		cong_mul_(mul_(a, mod_(b, m)), sub_(d, d), mul_(a, mod_(add_(mul_(mul_(sub_(mod_(d, m), a), mul_(c, mod_(c, m))), m), b), m)), sub_(d, d));
		lemma_eq_ref(a);
		cong_mul_(a, mod_(b, m), a, mod_(add_(mul_(mul_(sub_(mod_(d, m), a), mul_(c, mod_(c, m))), m), b), m));
		lemma_eq_ref(sub_(d, d));
	}
	let temp_88_0 = (mul_((mul_(d, a)), (add_(c, d))));
	let temp_88_1 = (mul_((mul_(d, a)), (add_(d, c))));
	assert(eq_(temp_88_0, temp_88_1)) by {
		cong_mul_(mul_(d, a), add_(c, d), mul_(d, a), add_(d, c));
		lemma_add_comm(c, d);
		lemma_eq_ref(mul_(d, a));
	}
	...
	assert(eq_(temp_90_0, temp_90_1)) by {
		cong_sub_(mul_(mod_(a, m), c), mul_(a, c), mul_(mod_(a, m), c), mul_(c, a));
		lemma_mul_comm(a, c);
	...
	assert(eq_(temp_91_0, temp_91_1)) by {
		lemma_mul_dist(c, a, mul_(a, mod_(b, m)));
	}
	...
	assert(eq_(temp_92_0, temp_92_1)) by {
		...
		cong_mul_(mod_(add_(a, b), m), sub_(b, c), mod_(add_(a, mod_(b, m)), m), sub_(b, c));
	...
	assert(eq_(temp_94_0, temp_94_1)) by {
		lemma_mul_comm(d, d);
		lemma_mod_mul_vanish(mul_(mod_(d, m), d), sub_(mul_(a, c), mul_(mod_(d, m), b)), m);
		cong_mul_(mod_(mul_(mod_(d, m), d), m), mul_(d, d), mod_(add_(mul_(sub_(mul_(a, c), mul_(mod_(d, m), b)), m), mul_(mod_(d, m), d)), m), mul_(d, d));
	}
	...
	assert(eq_(temp_96_0, temp_96_1)) by {
		...
		cong_sub_(mul_(b, mod_(d, m)), mul_(a, d), mul_(mod_(d, m), b), mul_(a, d));
		lemma_eq_ref(mul_(a, d));
	}
	...
	assert(eq_(temp_98_0, temp_98_1)) by {
		lemma_mul_comm(mul_(d, b), mod_(mul_(mod_(b, m), b), m));
	}
	...
	assert(eq_(temp_99_0, temp_99_1)) by {
		lemma_add_comm(d, b);
		cong_mod_(mul_(mul_(mod_(d, m), b), add_(d, b)), m, mul_(mul_(mod_(d, m), b), add_(b, d)), m);
		lemma_eq_ref(mul_(mod_(d, m), b));
		cong_mul_(mul_(mod_(d, m), b), add_(d, b), mul_(mod_(d, m), b), add_(b, d));
		lemma_eq_ref(m);
	}
	let temp_100_0 = (sub_((mul_(b, c)), (mul_(d, a))));
	let temp_100_1 = (sub_((mul_(b, c)), (mul_(a, d))));
	assert(eq_(temp_100_0, temp_100_1)) by {
		cong_sub_(mul_(b, c), mul_(d, a), mul_(b, c), mul_(a, d));
		lemma_mul_comm(d, a);
		lemma_eq_ref(mul_(b, c));
	}
	...
	assert(eq_(temp_102_0, temp_102_1)) by {
		...
		cong_mod_(mul_(mul_(a, a), mul_(mod_(c, m), b)), m, mul_(mul_(a, a), mul_(b, mod_(c, m))), m);
		lemma_eq_ref(m);
	...
	assert(eq_(temp_103_0, temp_103_1)) by {
		lemma_mul_assoc(mul_(mod_(a, m), b), d, d);
	}
	...
	assert(eq_(temp_105_0, temp_105_1)) by {
		lemma_mul_comm(c, a);
		cong_mod_(sub_(mul_(c, a), mul_(d, c)), m, sub_(mul_(a, c), mul_(d, c)), m);
	...
	assert(eq_(temp_107_0, temp_107_1)) by {
		lemma_mul_dist(mod_(mul_(mod_(d, m), a), m), c, c);
	}
	...
	assert(eq_(temp_108_0, temp_108_1)) by {
		lemma_mod_mul_vanish(mul_(c, c), mul_(mul_(mod_(b, m), b), add_(c, mod_(c, m))), m);
		cong_add_(mul_(a, a), mod_(mul_(c, c), m), mul_(a, a), mod_(sub_(mul_(c, c), mul_(mul_(mul_(mod_(b, m), b), add_(c, mod_(c, m))), m)), m));
	...
	assert(eq_(temp_109_0, temp_109_1)) by {
		...
		cong_mul_(mul_(mod_(b, m), d), mul_(d, c), mul_(mod_(add_(mul_(mul_(mul_(d, a), mul_(c, d)), m), b), m), d), mul_(d, c));
		lemma_eq_ref(d);
		lemma_eq_ref(mul_(d, c));
		cong_mul_(mod_(b, m), d, mod_(add_(mul_(mul_(mul_(d, a), mul_(c, d)), m), b), m), d);
	}
	...
	assert(eq_(temp_110_0, temp_110_1)) by {
		cong_mul_(mul_(d, a), mul_(d, mod_(d, m)), mul_(d, a), mul_(mod_(d, m), d));
		lemma_mul_comm(d, mod_(d, m));
		lemma_eq_ref(mul_(d, a));
	}
	...
	assert(eq_(temp_111_0, temp_111_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(b, c), mod_(mul_(as_elem(56), a), m)), mul_(mul_(a, d), mul_(b, as_elem(46))), m);
	}
	let temp_112_0 = (add_((add_(a, a)), (mul_(c, c))));
	let temp_112_1 = (add_((mul_(c, c)), (add_(a, a))));
	assert(eq_(temp_112_0, temp_112_1)) by {
		lemma_add_comm(add_(a, a), mul_(c, c));
	}
	...
	assert(eq_(temp_113_0, temp_113_1)) by {
		...
		cong_mul_(mul_(d, mod_(b, m)), mul_(c, b), mul_(mod_(b, m), d), mul_(c, b));
	...
	assert(eq_(temp_114_0, temp_114_1)) by {
		cong_mul_(add_(c, a), mul_(a, d), add_(a, c), mul_(a, d));
		lemma_add_comm(c, a);
		lemma_eq_ref(mul_(a, d));
	}
	...
	assert(eq_(temp_116_0, temp_116_1)) by {
		...
		cong_mod_(mul_(mul_(b, b), mul_(a, d)), m, mul_(b, mul_(b, mul_(a, d))), m);
		lemma_eq_sym(mul_(b, mul_(b, mul_(a, d))), mul_(mul_(b, b), mul_(a, d)));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_119_0, temp_119_1)) by {
		lemma_mod_mul_vanish(a, mul_(mul_(b, b), mod_(mul_(c, a), m)), m);
		cong_mul_(mul_(a, c), mul_(mod_(a, m), d), mul_(a, c), mul_(mod_(add_(mul_(mul_(mul_(b, b), mod_(mul_(c, a), m)), m), a), m), d));
		lemma_eq_ref(mul_(a, c));
		lemma_eq_ref(d);
		cong_mul_(mod_(a, m), d, mod_(add_(mul_(mul_(mul_(b, b), mod_(mul_(c, a), m)), m), a), m), d);
	}
	...
	assert(eq_(temp_121_0, temp_121_1)) by {
		lemma_mul_assoc(mod_(mul_(d, d), m), c, c);
	}
	...
	assert(eq_(temp_122_0, temp_122_1)) by {
		lemma_mul_assoc(mod_(mul_(mod_(b, m), b), m), b, a);
	}
	...
	assert(eq_(temp_126_0, temp_126_1)) by {
		...
		cong_mod_(mul_(sub_(d, a), mod_(mul_(a, mod_(a, m)), m)), m, mul_(sub_(d, a), mod_(mod_(mul_(a, a), m), m)), m);
		lemma_eq_ref(sub_(d, a));
		lemma_eq_sym(mod_(mod_(mul_(a, a), m), m), mod_(mul_(a, mod_(a, m)), m));
		cong_mul_(sub_(d, a), mod_(mul_(a, mod_(a, m)), m), sub_(d, a), mod_(mod_(mul_(a, a), m), m));
		lemma_eq_ref(m);
	}
	...
	assert(eq_(temp_128_0, temp_128_1)) by {
		lemma_mod_mul_vanish(add_(mul_(b, mod_(a, m)), mul_(a, c)), mul_(mul_(c, b), mul_(c, mod_(c, m))), m);
	}
	let temp_129_0 = (mul_((add_(b, d)), (mul_(a, b))));
	let temp_129_1 = (mul_((mul_(a, b)), (add_(b, d))));
	assert(eq_(temp_129_0, temp_129_1)) by {
		lemma_mul_comm(add_(b, d), mul_(a, b));
	}
	...
	assert(eq_(temp_132_0, temp_132_1)) by {
		...
		lemma_mul_assoc(as_elem(73), a, b);
	}
