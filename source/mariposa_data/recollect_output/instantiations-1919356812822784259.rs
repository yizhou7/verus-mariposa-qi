...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_distributive((a0 + b0) * (d0 * d0), d0 * b0, b0 * c0);
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_commutative(d4 * c4, d4 + a4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_associative(b5 * c5, d5 * b5, (b5 * d5) - (80 + a5));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_associative(((d6 + b6) * (16 * c6)) * ((b6 * a6) * (c6 * d6)), (d6 * d6) * (c6 * c6), ((b6 * c6) * a6) * b6);
		lemma_mul_is_associative(b6 * c6, a6, b6);
		lemma_mul_is_associative(((d6 + b6) * (16 * c6)) * ((b6 * a6) * (c6 * d6)), (d6 * d6) * (c6 * c6), (b6 * c6) * (a6 * b6));
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_associative(((c7 - d7) * b7) * d7, (b7 * d7) * b7, ((b7 * d7) * (a7 * b7)) * ((a7 + d7) * c7));
		lemma_mul_is_associative(c7 - d7, b7, d7);
		lemma_mul_is_associative((c7 - d7) * (b7 * d7), (b7 * d7) * b7, ((b7 * d7) * (a7 * b7)) * ((a7 + d7) * c7));
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_associative(a8 + a8, b8, b8);
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_distributive(b9 * a9, b9 * d9, (d9 * d9) * 17);
	}
	...
	assert(temp_10_0 == temp_10_1) by {
		lemma_mul_is_associative(c10, a10, c10 * d10);
	}
