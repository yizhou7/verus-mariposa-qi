...
pub proof fn free_0(a: Elem, b: Elem, c: Elem, d: Elem, m: Elem)
{
	...
	assert(eq_(temp_0_0, temp_0_1)) by {
		lemma_add_comm(mul_(a, d), mod_(mul_(c, d), m));
	}
	...
	assert(eq_(temp_2_0, temp_2_1)) by {
		lemma_mod_mul_vanish(d, add_(mul_(c, c), mod_(mul_(b, a), m)), m);
		cong_mul_(mul_(mod_(d, m), b), mul_(mod_(b, m), b), mul_(mod_(add_(d, mul_(add_(mul_(c, c), mod_(mul_(b, a), m)), m)), m), b), mul_(mod_(b, m), b));
		lemma_eq_ref(b);
		cong_mul_(mod_(d, m), b, mod_(add_(d, mul_(add_(mul_(c, c), mod_(mul_(b, a), m)), m)), m), b);
		lemma_eq_ref(mul_(mod_(b, m), b));
	}
	let temp_3_0 = (mul_((sub_(d, d)), (add_(c, c))));
	let temp_3_1 = (mul_((add_(c, c)), (sub_(d, d))));
	assert(eq_(temp_3_0, temp_3_1)) by {
		lemma_mul_comm(sub_(d, d), add_(c, c));
	}
	...
	assert(eq_(temp_6_0, temp_6_1)) by {
		lemma_mul_comm(b, a);
		cong_mod_(mul_(add_(c, a), mul_(b, a)), m, mul_(add_(c, a), mul_(a, b)), m);
	...
	assert(eq_(temp_7_0, temp_7_1)) by {
		lemma_mul_comm(mul_(a, d), add_(d, d));
	}
	...
	assert(eq_(temp_10_0, temp_10_1)) by {
		...
		cong_mul_(mul_(d, mod_(b, m)), mul_(c, c), mul_(mod_(b, m), d), mul_(c, c));
	...
	assert(eq_(temp_11_0, temp_11_1)) by {
		lemma_mul_comm(b, c);
		cong_mod_(mul_(mul_(b, a), mul_(b, c)), m, mul_(mul_(b, a), mul_(c, b)), m);
	...
	assert(eq_(temp_12_0, temp_12_1)) by {
		lemma_mod_mul_vanish(b, mul_(mul_(a, a), mod_(mul_(d, c), m)), m);
		cong_mul_(mul_(b, c), mul_(a, mod_(b, m)), mul_(b, c), mul_(a, mod_(add_(mul_(mul_(mul_(a, a), mod_(mul_(d, c), m)), m), b), m)));
		lemma_eq_ref(a);
		lemma_eq_ref(mul_(b, c));
		cong_mul_(a, mod_(b, m), a, mod_(add_(mul_(mul_(mul_(a, a), mod_(mul_(d, c), m)), m), b), m));
	}
	let temp_13_0 = (mul_((mul_((mod_(b, m)), (mod_(c, m)))), (mod_((mul_(a, d)), m))));
	let temp_13_1 = (mul_((mod_(b, m)), (mul_((mod_(c, m)), (mod_((mul_(a, d)), m))))));
	assert(eq_(temp_13_0, temp_13_1)) by {
		lemma_mul_assoc(mod_(b, m), mod_(c, m), mod_(mul_(a, d), m));
	...
	assert(eq_(temp_14_0, temp_14_1)) by {
		lemma_mod_mul_vanish(b, mul_(mul_(a, d), mul_(c, mod_(a, m))), m);
		cong_sub_(sub_(b, b), mul_(c, mod_(b, m)), sub_(b, b), mul_(c, mod_(add_(b, mul_(mul_(mul_(a, d), mul_(c, mod_(a, m))), m)), m)));
		lemma_eq_ref(c);
		cong_mul_(c, mod_(b, m), c, mod_(add_(b, mul_(mul_(mul_(a, d), mul_(c, mod_(a, m))), m)), m));
	...
	assert(eq_(temp_16_0, temp_16_1)) by {
		lemma_mul_assoc(mod_(mul_(a, c), m), mod_(c, m), b);
	}
	...
	assert(eq_(temp_18_0, temp_18_1)) by {
		lemma_mul_assoc(d, b, mod_(mul_(a, c), m));
	...
	assert(eq_(temp_21_0, temp_21_1)) by {
		lemma_add_comm(mul_(a, c), sub_(mod_(b, m), d));
		cong_mod_(add_(mul_(a, c), sub_(mod_(b, m), d)), m, add_(sub_(mod_(b, m), d), mul_(a, c)), m);
		lemma_eq_ref(m);
	}
	let temp_22_0 = (mul_((mul_(b, (mod_(a, m)))), (mul_(b, c))));
	let temp_22_1 = (mul_((mul_(b, c)), (mul_(b, (mod_(a, m))))));
	assert(eq_(temp_22_0, temp_22_1)) by {
		lemma_mul_comm(mul_(b, mod_(a, m)), mul_(b, c));
	}
	...
	assert(eq_(temp_23_0, temp_23_1)) by {
		cong_mul_(mul_(c, mod_(d, m)), mul_(d, b), mul_(c, mod_(add_(mul_(mul_(mul_(d, a), mul_(c, d)), m), d), m)), mul_(d, b));
		lemma_mod_mul_vanish(d, mul_(mul_(d, a), mul_(c, d)), m);
		cong_mod_(mul_(mul_(c, mod_(d, m)), mul_(d, b)), m, mul_(mul_(c, mod_(add_(mul_(mul_(mul_(d, a), mul_(c, d)), m), d), m)), mul_(d, b)), m);
		cong_mul_(c, mod_(d, m), c, mod_(add_(mul_(mul_(mul_(d, a), mul_(c, d)), m), d), m));
		lemma_eq_ref(c);
	...
	assert(eq_(temp_24_0, temp_24_1)) by {
		cong_mul_(add_(c, d), c, add_(d, c), c);
		lemma_add_comm(c, d);
		lemma_eq_ref(c);
	}
	...
	assert(eq_(temp_26_0, temp_26_1)) by {
		lemma_mul_assoc(mul_(mod_(c, m), d), b, d);
	}
	...
	assert(eq_(temp_27_0, temp_27_1)) by {
		...
		cong_add_(mod_(mul_(d, mod_(c, m)), m), mul_(b, d), mod_(mod_(mul_(c, d), m), m), mul_(b, d));
	...
	assert(eq_(temp_29_0, temp_29_1)) by {
		lemma_mod_mul_vanish(mul_(c, d), mul_(add_(a, mod_(c, m)), mul_(d, mod_(a, m))), m);
		cong_mul_(mul_(c, d), mod_(mul_(c, d), m), mul_(c, d), mod_(sub_(mul_(c, d), mul_(mul_(add_(a, mod_(c, m)), mul_(d, mod_(a, m))), m)), m));
		lemma_eq_ref(mul_(c, d));
	}
	let temp_30_0 = (add_((add_(a, (mod_(b, m)))), (mul_(a, b))));
	let temp_30_1 = (add_((mul_(a, b)), (add_(a, (mod_(b, m))))));
	assert(eq_(temp_30_0, temp_30_1)) by {
		lemma_add_comm(add_(a, mod_(b, m)), mul_(a, b));
	}
	...
	assert(eq_(temp_33_0, temp_33_1)) by {
		lemma_add_comm(mul_(b, c), mod_(mul_(d, b), m));
	}
	...
	assert(eq_(temp_34_0, temp_34_1)) by {
		lemma_eq_ref(a);
		lemma_mul_comm(a, a);
		lemma_mod_mul_vanish(b, mul_(mul_(b, c), mul_(c, b)), m);
		cong_mul_(sub_(mod_(b, m), a), mul_(a, a), sub_(mod_(sub_(b, mul_(mul_(mul_(b, c), mul_(c, b)), m)), m), a), mul_(a, a));
		cong_sub_(mod_(b, m), a, mod_(sub_(b, mul_(mul_(mul_(b, c), mul_(c, b)), m)), m), a);
	}
	...
	assert(eq_(temp_37_0, temp_37_1)) by {
		lemma_mod_mul_vanish(c, mul_(mul_(mod_(d, m), a), mod_(mul_(d, d), m)), m);
		cong_mul_(mul_(mod_(c, m), d), mul_(d, a), mul_(mod_(sub_(c, mul_(mul_(mul_(mod_(d, m), a), mod_(mul_(d, d), m)), m)), m), d), mul_(d, a));
		lemma_eq_ref(d);
		lemma_eq_ref(mul_(d, a));
		cong_mul_(mod_(c, m), d, mod_(sub_(c, mul_(mul_(mul_(mod_(d, m), a), mod_(mul_(d, d), m)), m)), m), d);
	}
	let temp_38_0 = (mul_((mul_(a, a)), (mod_((add_(a, c)), m))));
	let temp_38_1 = (mul_((mod_((add_(a, c)), m)), (mul_(a, a))));
	assert(eq_(temp_38_0, temp_38_1)) by {
		lemma_mul_comm(mul_(a, a), mod_(add_(a, c), m));
	}
	let temp_39_0 = (mul_(a, (sub_(a, b))));
	let temp_39_1 = (mul_((sub_(a, b)), a));
	assert(eq_(temp_39_0, temp_39_1)) by {
		lemma_mul_comm(a, sub_(a, b));
	}
	...
	assert(eq_(temp_49_0, temp_49_1)) by {
		lemma_mul_comm(d, c);
		cong_add_(sub_(mod_(a, m), c), mul_(d, c), sub_(mod_(a, m), c), mul_(c, d));
	...
	assert(eq_(temp_52_0, temp_52_1)) by {
		...
		cong_mod_(mul_(mul_(b, a), mul_(b, d)), m, mul_(mul_(b, d), mul_(b, a)), m);
		lemma_eq_ref(m);
	}
	let temp_53_0 = (mul_((mul_(c, c)), (mul_(b, a))));
	let temp_53_1 = (mul_((mul_((mul_(c, c)), b)), a));
	assert(eq_(temp_53_0, temp_53_1)) by {
		lemma_mul_assoc(mul_(c, c), b, a);
	}
	...
	assert(eq_(temp_55_0, temp_55_1)) by {
		...
		cong_mul_(mul_(c, mod_(d, m)), sub_(c, as_elem(59)), mul_(mod_(d, m), c), sub_(c, as_elem(59)));
		lemma_eq_ref(sub_(c, as_elem(59)));
	}
	...
	assert(eq_(temp_57_0, temp_57_1)) by {
		lemma_mul_comm(a, c);
		lemma_mul_comm(c, c);
		cong_sub_(mod_(mul_(a, c), m), mul_(c, c), mod_(mul_(c, a), m), mul_(c, c));
	...
	assert(eq_(temp_59_0, temp_59_1)) by {
		cong_mul_(mul_(c, a), add_(c, d), mul_(c, a), add_(d, c));
		lemma_add_comm(c, d);
	...
	assert(eq_(temp_60_0, temp_60_1)) by {
		lemma_mul_assoc(mul_(mod_(d, m), c), b, b);
	}
	...
	assert(eq_(temp_61_0, temp_61_1)) by {
		...
		lemma_mul_assoc(c, mod_(c, m), mul_(c, a));
	}
	...
	assert(eq_(temp_64_0, temp_64_1)) by {
		lemma_mul_dist(c, c, add_(c, as_elem(38)));
	}
	...
	assert(eq_(temp_65_0, temp_65_1)) by {
		lemma_mod_mul_vanish(c, mul_(add_(d, c), sub_(a, c)), m);
		cong_add_(mul_(d, b), mul_(a, mod_(c, m)), mul_(d, b), mul_(a, mod_(add_(c, mul_(mul_(add_(d, c), sub_(a, c)), m)), m)));
		lemma_eq_ref(a);
		lemma_eq_ref(mul_(d, b));
		cong_mul_(a, mod_(c, m), a, mod_(add_(c, mul_(mul_(add_(d, c), sub_(a, c)), m)), m));
	}
	let temp_66_0 = (add_(c, (mod_((mul_(b, d)), m))));
	let temp_66_1 = (add_((mod_((mul_(b, d)), m)), c));
	assert(eq_(temp_66_0, temp_66_1)) by {
		lemma_add_comm(c, mod_(mul_(b, d), m));
	}
	let temp_67_0 = (mul_((mul_((mod_(b, m)), b)), (mul_(c, b))));
	let temp_67_1 = (mul_((mul_(c, b)), (mul_((mod_(b, m)), b))));
	assert(eq_(temp_67_0, temp_67_1)) by {
		lemma_mul_comm(mul_(mod_(b, m), b), mul_(c, b));
	}
	...
	assert(eq_(temp_68_0, temp_68_1)) by {
		cong_mul_(c, mod_(d, m), c, mod_(add_(mul_(add_(mul_(b, a), mul_(d, c)), m), d), m));
		lemma_eq_ref(mul_(c, b));
		lemma_eq_ref(c);
		lemma_mod_mul_vanish(d, add_(mul_(b, a), mul_(d, c)), m);
		cong_mul_(mul_(c, mod_(d, m)), mul_(c, b), mul_(c, mod_(add_(mul_(add_(mul_(b, a), mul_(d, c)), m), d), m)), mul_(c, b));
	}
	...
	assert(eq_(temp_70_0, temp_70_1)) by {
		lemma_mod_mul_vanish(mul_(d, b), mul_(add_(b, d), mul_(a, c)), m);
		cong_sub_(mul_(d, b), mod_(mul_(d, b), m), mul_(d, b), mod_(add_(mul_(mul_(add_(b, d), mul_(a, c)), m), mul_(d, b)), m));
		lemma_eq_ref(mul_(d, b));
	}
	...
	assert(eq_(temp_72_0, temp_72_1)) by {
		lemma_add_comm(mul_(b, a), mul_(as_elem(97), c));
	}
	...
	assert(eq_(temp_77_0, temp_77_1)) by {
		lemma_mul_comm(a, a);
		lemma_mod_mul_vanish(d, add_(mul_(mod_(b, m), d), mul_(c, a)), m);
		cong_sub_(mul_(d, mod_(d, m)), mul_(a, a), mul_(d, mod_(add_(d, mul_(add_(mul_(mod_(b, m), d), mul_(c, a)), m)), m)), mul_(a, a));
		lemma_eq_ref(d);
		cong_mul_(d, mod_(d, m), d, mod_(add_(d, mul_(add_(mul_(mod_(b, m), d), mul_(c, a)), m)), m));
	}
	...
	assert(eq_(temp_79_0, temp_79_1)) by {
		lemma_mod_mul_vanish(mul_(b, mod_(a, m)), mul_(mul_(d, b), add_(b, b)), m);
		cong_mul_(mod_(mul_(b, mod_(a, m)), m), mul_(a, b), mod_(sub_(mul_(b, mod_(a, m)), mul_(mul_(mul_(d, b), add_(b, b)), m)), m), mul_(a, b));
	...
	assert(eq_(temp_84_0, temp_84_1)) by {
		cong_mul_(add_(b, a), mul_(d, d), add_(a, b), mul_(d, d));
		lemma_add_comm(b, a);
		lemma_mul_comm(d, d);
	}
	...
	assert(eq_(temp_88_0, temp_88_1)) by {
		lemma_mul_comm(d, a);
		cong_add_(mul_(d, a), mod_(mul_(b, a), m), mul_(a, d), mod_(mul_(b, a), m));
	...
	assert(eq_(temp_89_0, temp_89_1)) by {
		lemma_mul_comm(b, a);
		cong_mul_(mul_(mod_(b, m), c), mul_(b, a), mul_(mod_(b, m), c), mul_(a, b));
	...
	assert(eq_(temp_90_0, temp_90_1)) by {
		...
		lemma_mul_assoc(a, mod_(a, m), mul_(b, b));
	}
	...
	assert(eq_(temp_93_0, temp_93_1)) by {
		lemma_mod_mul_vanish(mul_(mul_(b, a), mul_(d, d)), mul_(add_(mod_(b, m), a), mul_(c, b)), m);
	}
