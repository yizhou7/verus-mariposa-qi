...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_1_0 == temp_1_1) by {
		...
		lemma_mul_is_associative((d1 + c1) * (27 * a1), c1 * c1, b1 * d1);
		lemma_mul_is_associative((d1 + c1) * (27 * a1), c1 * c1, d1 * b1);
	}
	let temp_2_0 = ((((c2*c2)*d2)*(d2*(a2*d2)))*(((b2*b2)*(d2*c2))+((b2-c2)+d2)));
	let temp_2_1 = (((d2*(a2*d2))*((c2*c2)*d2))*(((b2*b2)*(d2*c2))+((b2-c2)+d2)));
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_commutative(d2 * (a2 * d2), (c2 * c2) * d2);
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		lemma_mul_is_commutative((c3 * a3) * (a3 * b3), (c3 * c3) * (a3 * a3));
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_associative((a4 * a4) * (b4 - b4), c4 + b4, c4 - a4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_commutative(97, b5);
		lemma_mul_is_associative((d5 - c5) - (97 * b5), (c5 * c5) + (a5 * d5), ((b5 * a5) * (d5 + a5)) * ((c5 * b5) + (a5 * d5)));
		lemma_mul_is_associative((d5 - c5) - (b5 * 97), (c5 * c5) + (a5 * d5), ((b5 * a5) * (d5 + a5)) * ((c5 * b5) + (a5 * d5)));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_associative(d6 - c6, b6 + d6, (c6 * b6) * (c6 * c6));
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_associative(((a7 * b7) * (d7 * d7)) * ((a7 * a7) * (b7 * d7)), (b7 * c7) * b7, (c7 * c7) * d7);
	}
	...
	assert(temp_8_0 == temp_8_1) by {
		lemma_mul_is_commutative(d8 * a8, a8 - d8);
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_associative((a9 * (d9 + d9)) - (d9 * (d9 + d9)), a9 - (b9 * d9), ((b9 * a9) * (52 * a9)) * ((b9 * d9) * (b9 * d9)));
		lemma_mul_is_distributive(a9, d9, d9 + d9);
		lemma_mul_is_associative((a9 - d9) * (d9 + d9), a9 - (b9 * d9), ((b9 * a9) * (52 * a9)) * ((b9 * d9) * (b9 * d9)));
	}
	...
	assert(temp_12_0 == temp_12_1) by {
		lemma_mul_is_commutative(b12, d12 * (c12 * b12));
		lemma_mul_is_associative(b12, d12, c12 * b12);
		lemma_mul_is_associative(b12, d12 * (c12 * b12), b12);
		lemma_mul_is_commutative((b12 * d12) * (c12 * b12), b12);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_commutative(b13 * c13, b13 * b13);
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		...
		lemma_mul_is_associative(((a14 * a14) * (c14 * b14)) * ((22 * c14) * (d14 * b14)), (b14 * b14) * (c14 * a14), (b14 * a14) * (d14 * d14));
		lemma_mul_is_associative(((a14 * a14) * (c14 * b14)) * ((22 * c14) * (d14 * b14)), (b14 * b14) * (c14 * a14), (a14 * b14) * (d14 * d14));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_distributive(a15 * d15, c15, b15);
	}
	...
	assert(temp_16_0 == temp_16_1) by {
		lemma_mul_is_commutative(a16 * d16, d16 * d16);
	}
