...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_commutative(d0 * (a0 + a0), (b0 + a0) * (c0 * d0));
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_associative(a1 * b1, d1, c1);
	}
	...
	assert(temp_3_0 == temp_3_1) by {
		...
		lemma_mul_is_associative((a3 * c3) * c3, (c3 - c3) * b3, ((a3 * c3) * (b3 * d3)) - ((a3 * a3) * (15 - b3)));
		lemma_mul_is_associative(c3 * (a3 * c3), (c3 - c3) * b3, ((a3 * c3) * (b3 * d3)) - ((a3 * a3) * (15 - b3)));
	}
	...
	assert(temp_6_0 == temp_6_1) by {
		lemma_mul_is_commutative(((b6 * b6) * (a6 * c6)) + ((c6 * d6) * (b6 * a6)), ((c6 * d6) * c6) * ((d6 + d6) * (b6 * b6)));
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_associative(c7, d7 * d7, d7);
	}
