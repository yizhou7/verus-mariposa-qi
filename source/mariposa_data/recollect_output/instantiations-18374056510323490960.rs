...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_distributive(b0 + a0, c0 - c0, (b0 * b0) * (b0 * b0));
	}
	...
	assert(temp_1_0 == temp_1_1) by {
		lemma_mul_is_commutative(((d1 * d1) * (c1 * a1)) - ((c1 + c1) - (b1 * c1)), ((a1 + c1) * (a1 + b1)) * ((d1 * a1) * (d1 - d1)));
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_distributive(b5, d5, b5 * a5);
	}
	...
	assert(temp_7_0 == temp_7_1) by {
		lemma_mul_is_associative((c7 * (d7 * b7)) + (b7 * (d7 * b7)), (d7 * d7) * (d7 * d7), ((a7 * c7) * (d7 - c7)) - ((b7 * b7) * (c7 * c7)));
		lemma_mul_is_distributive(c7, b7, d7 * b7);
		lemma_mul_is_associative((c7 + b7) * (d7 * b7), (d7 * d7) * (d7 * d7), ((a7 * c7) * (d7 - c7)) - ((b7 * b7) * (c7 * c7)));
	}
	...
	assert(temp_9_0 == temp_9_1) by {
		lemma_mul_is_associative(c9 * b9, b9, c9);
	}
	...
	assert(temp_11_0 == temp_11_1) by {
		lemma_mul_is_distributive(b11 * a11, d11, b11);
	}
	...
	assert(temp_13_0 == temp_13_1) by {
		lemma_mul_is_associative(99, a13, b13 + d13);
	}
	...
	assert(temp_14_0 == temp_14_1) by {
		lemma_mul_is_commutative(((a14 * d14) * (b14 * 59)) * ((c14 * a14) * (b14 * c14)), (d14 * (c14 - a14)) * ((c14 * a14) - (d14 * d14)));
	}
	...
	assert(temp_15_0 == temp_15_1) by {
		lemma_mul_is_distributive((c15 + d15) * (b15 * c15), c15 * b15, c15 * b15);
	}
	...
	assert(temp_17_0 == temp_17_1) by {
		lemma_mul_is_commutative(56, c17);
		lemma_mul_is_associative((c17 * a17) * (a17 * d17), a17 * d17, 56 * c17);
		lemma_mul_is_associative((c17 * a17) * (a17 * d17), a17 * d17, c17 * 56);
	}
	...
	assert(temp_18_0 == temp_18_1) by {
		lemma_mul_is_associative(c18, d18, d18);
	}
	...
	assert(temp_21_0 == temp_21_1) by {
		lemma_mul_is_commutative(70, c21);
	}
	...
	assert(temp_22_0 == temp_22_1) by {
		lemma_mul_is_commutative(b22 * a22, a22 * c22);
	}
