...
a29: int, b29: int, c29: int, d29: int)
{
	...
	assert(temp_0_0 == temp_0_1) by {
		lemma_mul_is_commutative((b0 * a0) * c0, (b0 * d0) * b0);
	}
	...
	assert(temp_2_0 == temp_2_1) by {
		lemma_mul_is_commutative(d2 - c2, c2 * b2);
	}
	...
	assert(temp_4_0 == temp_4_1) by {
		lemma_mul_is_associative((a4 * c4) * (a4 * d4), a4 * 29, a4 * b4);
	}
	...
	assert(temp_5_0 == temp_5_1) by {
		lemma_mul_is_associative(b5, d5, d5);
	}
