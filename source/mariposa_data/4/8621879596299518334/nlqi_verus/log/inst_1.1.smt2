...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Add (Mul (Add c0~6@ c0~6@) (Mul a0~2@ b0~4@)) (Sub (Mul b0~4@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~210@ (Mul (Add (Mul (Add c0~6@ c0~6@) (Mul a0~2@ b0~4@)) (Sub (Mul b0~4@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ c0~6@) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@))))))))
(assert %%query%%)
(check-sat)
