...
(declare-const temp_5_0~822@ Int)
...
(declare-const temp_7_1~1121@ Int)
(declare-const temp_8_0~1201@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Add (Mul (Add c0~6@ c0~6@) (Mul a0~2@ b0~4@)) (Sub (Mul b0~4@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~210@ (Mul (Add (Mul (Add c0~6@ c0~6@) (Mul a0~2@ b0~4@)) (Sub (Mul b0~4@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~145@ temp_0_1~210@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~274@ (Sub (Add (Mul (Mul c1~14@ b1~12@) (Mul d1~16@ a1~10@)) (Sub (Add b1~12@ a1~10@) (Mul 27 b1~12@))) a1~10@)) (=> (= temp_1_1~323@ (Sub (Add (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Sub (Add b1~12@ a1~10@) (Mul 27 b1~12@))) a1~10@)) (=> (= tmp%2@ (= temp_1_0~274@ temp_1_1~323@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~415@ (Sub (Mul (Add (Mul d2~24@ c2~22@) (Add c2~22@ c2~22@)) (Sub (Mul a2~18@ 67) (Mul c2~22@ a2~18@))) (Mul (Mul (Sub a2~18@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~492@ (Sub (Mul (Add (Mul d2~24@ c2~22@) (Add c2~22@ c2~22@)) (Sub (Mul a2~18@ 67) (Mul a2~18@ c2~22@))) (Mul (Mul (Sub a2~18@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~415@ temp_2_1~492@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~580@ (Mul (Mul (Add (Sub b3~28@ c3~30@) (Mul c3~30@ b3~28@)) (Mul d3~32@ (Mul 18 b3~28@))) (Mul (Mul (Add b3~28@ a3~26@) (Mul b3~28@ b3~28@)) (Add (Mul c3~30@ b3~28@) (Add d3~32@ d3~32@))))) (=> (= temp_3_1~653@ (Mul (Mul (Add (Sub b3~28@ c3~30@) (Mul c3~30@ b3~28@)) (Mul d3~32@ (Mul 18 b3~28@))) (Mul (Mul (Add b3~28@ a3~26@) (Mul b3~28@ b3~28@)) (Add (Mul b3~28@ c3~30@) (Add d3~32@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~580@ temp_3_1~653@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~705@ (Mul b4~36@ (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ d4~40@))))) (=> (= temp_4_1~742@ (Mul (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ d4~40@))) b4~36@)) (=> (= tmp%5@ (= temp_4_0~705@ temp_4_1~742@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~822@ (Mul (Add (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ d5~48@))) (Mul (Sub (Mul c5~46@ c5~46@) (Mul a5~42@ c5~46@)) (Sub (Mul b5~44@ b5~44@) (Mul a5~42@ c5~46@))))) (=> (= temp_5_1~887@ (Mul (Add (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ d5~48@))) (Mul (Sub (Mul c5~46@ c5~46@) (Mul a5~42@ c5~46@)) (Sub (Mul b5~44@ b5~44@) (Mul a5~42@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~822@ temp_5_1~887@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~967@ (Add (Mul (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ a6~50@)) (Mul (Add d6~56@ b6~52@) (Mul b6~52@ d6~56@))) (Add (Sub (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Add c6~54@ b6~52@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1032@ (Add (Mul (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ a6~50@)) (Mul (Add d6~56@ b6~52@) (Mul b6~52@ d6~56@))) (Add (Sub (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Add c6~54@ b6~52@) (Mul c6~54@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~967@ temp_6_1~1032@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1084@ (Mul (Mul (Mul (Add a7~58@ c7~62@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@))) a7~58@)) (=> (= temp_7_1~1121@ (Mul (Mul (Mul (Mul (Add a7~58@ c7~62@) (Mul c7~62@ d7~64@)) (Mul b7~60@ a7~58@)) (Mul b7~60@ c7~62@)) a7~58@)) (=> (= tmp%8@ (= temp_7_0~1084@ temp_7_1~1121@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1201@ (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Sub a8~66@ c8~70@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Add a8~66@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1274@ (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Sub a8~66@ c8~70@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ a8~66@)) (Add (Mul a8~66@ (Mul a8~66@ d8~72@)) (Mul c8~70@ (Mul a8~66@ d8~72@)))))) (=> (= tmp%9@ (= temp_8_0~1201@ temp_8_1~1274@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
