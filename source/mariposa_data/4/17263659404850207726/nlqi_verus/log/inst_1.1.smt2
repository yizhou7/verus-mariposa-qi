...
(assert (=> %%query%% (not (=> (= temp_0_0~153@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Sub 81 c0~6@)) (Mul (Mul d0~8@ c0~6@) (Add c0~6@ b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~234@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Sub 81 c0~6@)) (Add (Mul (Mul d0~8@ c0~6@) c0~6@) (Mul (Mul d0~8@ c0~6@) b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@))))) (=> (= tmp%1@ (Mul d0~8@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~153@ temp_0_1~234@)))))))))
(assert %%query%%)
(check-sat)
