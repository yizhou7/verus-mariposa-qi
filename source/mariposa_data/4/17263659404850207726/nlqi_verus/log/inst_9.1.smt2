...
(set-info :comment ";; mariposa_data/4//17263659404850207726/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_0_1~234@ Int)
(declare-const temp_1_0~333@ Int)
(declare-const temp_1_1~398@ Int)
(declare-const temp_2_0~485@ Int)
(declare-const temp_2_1~538@ Int)
(declare-const temp_3_0~675@ Int)
(declare-const temp_3_1~740@ Int)
(declare-const temp_4_0~875@ Int)
(declare-const temp_4_1~928@ Int)
(declare-const temp_5_0~1009@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~153@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Sub 81 c0~6@)) (Mul (Mul d0~8@ c0~6@) (Add c0~6@ b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~234@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Sub 81 c0~6@)) (Add (Mul (Mul d0~8@ c0~6@) c0~6@) (Mul (Mul d0~8@ c0~6@) b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@))))) (and (=> (= tmp%1@ (Mul d0~8@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ c0~6@ b0~4@) (=> %%location_label%%0 (= temp_0_0~153@ temp_0_1~234@)))) (=> (= temp_0_0~153@ temp_0_1~234@) (=> (= temp_1_0~333@ (Add (Mul (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ a1~10@))) (Add (Mul (Sub c1~14@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~398@ (Add (Mul (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ a1~10@))) (Add (Mul (Mul (Sub c1~14@ b1~12@) a1~10@) d1~16@) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))))) (and (=> (= tmp%2@ (Sub c1~14@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ a1~10@ d1~16@) (=> %%location_label%%1 (= temp_1_0~333@ temp_1_1~398@)))) (=> (= temp_1_0~333@ temp_1_1~398@) (=> (= temp_2_0~485@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Sub b2~20@ b2~20@)) (Add (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Add (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@)) a2~18@))) (=> (= temp_2_1~538@ (Mul (Mul (Add (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@)) a2~18@) (Mul (Mul (Mul d2~24@ d2~24@) (Sub b2~20@ b2~20@)) (Add (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))))) (and (=> (= tmp%3@ (Mul (Mul (Mul d2~24@ d2~24@) (Sub b2~20@ b2~20@)) (Add (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@)))) (=> (= tmp%4@ (Mul (Add (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@)) a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~485@ temp_2_1~538@))))) (=> (= temp_2_0~485@ temp_2_1~538@) (=> (= temp_3_0~675@ (Mul (Sub (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@))) (Mul (Mul (Sub a3~26@ a3~26@) (Sub c3~30@ a3~26@)) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~740@ (Mul (Mul (Sub (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@))) (Mul (Sub a3~26@ a3~26@) (Sub c3~30@ a3~26@))) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ c3~30@)))) (and (=> (= tmp%5@ (Sub (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@)))) (=> (= tmp%6@ (Mul (Sub a3~26@ a3~26@) (Sub c3~30@ a3~26@))) (=> (= tmp%7@ (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~675@ temp_3_1~740@)))))) (=> (= temp_3_0~675@ temp_3_1~740@) (=> (= temp_4_0~875@ (Sub (Sub (Mul (Mul c4~38@ c4~38@) a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~928@ (Sub (Sub (Mul (Mul c4~38@ c4~38@) a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c4~38@ a4~34@) (=> %%location_label%%4 (= temp_4_0~875@ temp_4_1~928@))) (=> (= temp_4_0~875@ temp_4_1~928@) (=> (= temp_5_0~1009@ (Add (Mul a5~42@ (Mul (Sub b5~44@ d5~48@) (Mul b5~44@ c5~46@))) (Sub (Mul (Mul b5~44@ d5~48@) (Add a5~42@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ b5~44@))))) (=> (= temp_5_1~1062@ (Add (Mul (Mul a5~42@ (Sub b5~44@ d5~48@)) (Mul b5~44@ c5~46@)) (Sub (Mul (Mul b5~44@ d5~48@) (Add a5~42@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ b5~44@))))) (and (=> (= tmp%8@ (Sub b5~44@ d5~48@)) (=> (= tmp%9@ (Mul b5~44@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a5~42@ tmp%8@ tmp%9@) (=> %%location_label%%5 (= temp_5_0~1009@ temp_5_1~1062@))))) (=> (= temp_5_0~1009@ temp_5_1~1062@) (=> (= temp_6_0~1161@ (Mul (Add (Add (Mul c6~54@ a6~50@) (Mul d6~56@ c6~54@)) (Mul b6~52@ (Add c6~54@ b6~52@))) (Sub (Mul (Mul b6~52@ b6~52@) (Add b6~52@ b6~52@)) (Mul (Mul c6~54@ b6~52@) (Sub c6~54@ c6~54@))))) (=> (= temp_6_1~1222@ (Mul (Add (Add (Mul c6~54@ a6~50@) (Mul d6~56@ c6~54@)) (Mul b6~52@ (Add c6~54@ b6~52@))) (Sub (Mul (Mul b6~52@ b6~52@) (Add b6~52@ b6~52@)) (Mul (Mul c6~54@ b6~52@) (Sub c6~54@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b6~52@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1161@ temp_6_1~1222@))) (=> (= temp_6_0~1161@ temp_6_1~1222@) (=> (= temp_7_0~1311@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@))) (Sub (Mul (Mul b7~60@ b7~60@) c7~62@) (Add (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1372@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@))) (Sub (Mul (Mul b7~60@ b7~60@) c7~62@) (Add (Mul a7~58@ b7~60@) (Mul a7~58@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d7~64@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1311@ temp_7_1~1372@))) (=> (= temp_7_0~1311@ temp_7_1~1372@) (=> (= temp_8_0~1465@ (Mul (Mul (Add (Mul c8~70@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Add d8~72@ c8~70@) (Mul d8~72@ c8~70@))) (Sub (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1530@ (Mul (Mul (Add (Mul c8~70@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Add d8~72@ c8~70@) (Mul d8~72@ c8~70@))) (Sub (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1465@ temp_8_1~1530@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
