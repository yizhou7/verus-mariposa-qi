...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~157@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Sub 81 c0~6@)) (Mul (Mul d0~8@ c0~6@) (Add c0~6@ b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~238@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Sub 81 c0~6@)) (Add (Mul (Mul d0~8@ c0~6@) c0~6@) (Mul (Mul d0~8@ c0~6@) b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) c0~6@) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~157@ temp_0_1~238@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~318@ (Add (Mul (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ a1~10@))) (Add (Mul (Sub c1~14@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~383@ (Add (Mul (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ a1~10@))) (Add (Mul (Mul (Sub c1~14@ b1~12@) a1~10@) d1~16@) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~318@ temp_1_1~383@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~451@ (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Sub b2~20@ b2~20@)) (Add (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Add (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@)) a2~18@))) (=> (= temp_2_1~504@ (Mul (Mul (Add (Mul a2~18@ a2~18@) (Mul c2~22@ b2~20@)) a2~18@) (Mul (Mul (Mul d2~24@ d2~24@) (Sub b2~20@ b2~20@)) (Add (Mul d2~24@ b2~20@) (Mul d2~24@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~451@ temp_2_1~504@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~584@ (Mul (Sub (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@))) (Mul (Mul (Sub a3~26@ a3~26@) (Sub c3~30@ a3~26@)) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ c3~30@))))) (=> (= temp_3_1~649@ (Mul (Mul (Sub (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ c3~30@))) (Mul (Sub a3~26@ a3~26@) (Sub c3~30@ a3~26@))) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ c3~30@)))) (=> (= tmp%4@ (= temp_3_0~584@ temp_3_1~649@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~717@ (Sub (Sub (Mul (Mul c4~38@ c4~38@) a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~770@ (Sub (Sub (Mul (Mul c4~38@ c4~38@) a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~717@ temp_4_1~770@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~838@ (Add (Mul a5~42@ (Mul (Sub b5~44@ d5~48@) (Mul b5~44@ c5~46@))) (Sub (Mul (Mul b5~44@ d5~48@) (Add a5~42@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ b5~44@))))) (=> (= temp_5_1~891@ (Add (Mul (Mul a5~42@ (Sub b5~44@ d5~48@)) (Mul b5~44@ c5~46@)) (Sub (Mul (Mul b5~44@ d5~48@) (Add a5~42@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Mul d5~48@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~838@ temp_5_1~891@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~967@ (Mul (Add (Add (Mul c6~54@ a6~50@) (Mul d6~56@ c6~54@)) (Mul b6~52@ (Add c6~54@ b6~52@))) (Sub (Mul (Mul b6~52@ b6~52@) (Add b6~52@ b6~52@)) (Mul (Mul c6~54@ b6~52@) (Sub c6~54@ c6~54@))))) (=> (= temp_6_1~1028@ (Mul (Add (Add (Mul c6~54@ a6~50@) (Mul d6~56@ c6~54@)) (Mul b6~52@ (Add c6~54@ b6~52@))) (Sub (Mul (Mul b6~52@ b6~52@) (Add b6~52@ b6~52@)) (Mul (Mul c6~54@ b6~52@) (Sub c6~54@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~967@ temp_6_1~1028@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1104@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@))) (Sub (Mul (Mul b7~60@ b7~60@) c7~62@) (Add (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1165@ (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@))) (Sub (Mul (Mul b7~60@ b7~60@) c7~62@) (Add (Mul a7~58@ b7~60@) (Mul a7~58@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1104@ temp_7_1~1165@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1245@ (Mul (Mul (Add (Mul c8~70@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Add d8~72@ c8~70@) (Mul d8~72@ c8~70@))) (Sub (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1310@ (Mul (Mul (Add (Mul c8~70@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Add d8~72@ c8~70@) (Mul d8~72@ c8~70@))) (Sub (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1245@ temp_8_1~1310@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
