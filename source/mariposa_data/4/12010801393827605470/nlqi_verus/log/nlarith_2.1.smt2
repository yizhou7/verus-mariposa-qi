...
(assert (=> %%query%% (not (=> (= temp_0_0~141@ (Mul (Mul (Sub (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@))) (Mul (Add b0~4@ (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Add b0~4@ c0~6@))))) (=> (= temp_0_1~202@ (Mul (Mul (Add b0~4@ (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Add b0~4@ c0~6@))) (Mul (Sub (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~141@ temp_0_1~202@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~278@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) c1~14@) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@)) (Sub (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~339@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) c1~14@) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul c1~14@ c1~14@) (Mul (Mul a1~10@ d1~16@) (Sub (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@)))))) (=> (= tmp%2@ (= temp_1_0~278@ temp_1_1~339@)) (=> %%location_label%%1 tmp%2@))))))))))))
(assert %%query%%)
(check-sat)
