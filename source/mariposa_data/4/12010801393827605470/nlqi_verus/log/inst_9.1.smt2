...
(set-info :comment ";; mariposa_data/4//12010801393827605470/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(assert (=> %%query%% (not (=> (= temp_0_0~141@ (Mul (Mul (Sub (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@))) (Mul (Add b0~4@ (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Add b0~4@ c0~6@))))) (=> (= temp_0_1~202@ (Mul (Mul (Add b0~4@ (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Add b0~4@ c0~6@))) (Mul (Sub (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@))))) (and (=> (= tmp%1@ (Mul (Sub (Mul b0~4@ b0~4@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ b0~4@)))) (=> (= tmp%2@ (Mul (Add b0~4@ (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Add b0~4@ c0~6@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~141@ temp_0_1~202@))))) (=> (= temp_0_0~141@ temp_0_1~202@) (=> (= temp_1_0~343@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) c1~14@) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@)) (Sub (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@))))) (=> (= temp_1_1~404@ (Mul (Mul (Mul (Mul b1~12@ b1~12@) c1~14@) (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@))) (Mul (Mul c1~14@ c1~14@) (Mul (Mul a1~10@ d1~16@) (Sub (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@)))))) (and (=> (= tmp%3@ (Mul c1~14@ c1~14@)) (=> (= tmp%4@ (Mul a1~10@ d1~16@)) (=> (= tmp%5@ (Sub (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~343@ temp_1_1~404@)))))) (=> (= temp_1_0~343@ temp_1_1~404@) (=> (= temp_2_0~507@ (Mul (Add (Add d2~24@ d2~24@) (Mul b2~20@ (Mul d2~24@ b2~20@))) (Sub (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@))))) (=> (= temp_2_1~560@ (Mul (Add (Add d2~24@ d2~24@) (Mul b2~20@ (Mul d2~24@ b2~20@))) (Sub (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ a2~18@) (=> %%location_label%%2 (= temp_2_0~507@ temp_2_1~560@))) (=> (= temp_2_0~507@ temp_2_1~560@) (=> (= temp_3_0~637@ (Mul (Sub (Mul (Mul b3~28@ b3~28@) d3~32@) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@))) (Mul b3~28@ (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~686@ (Mul (Sub (Mul (Mul b3~28@ b3~28@) d3~32@) (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ a3~26@))) (Mul (Mul b3~28@ (Mul a3~26@ d3~32@)) (Mul c3~30@ a3~26@)))) (and (=> (= tmp%6@ (Mul a3~26@ d3~32@)) (=> (= tmp%7@ (Mul c3~30@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b3~28@ tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~637@ temp_3_1~686@))))) (=> (= temp_3_0~637@ temp_3_1~686@) (=> (= temp_4_0~789@ (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Sub c4~38@ c4~38@))) (Mul (Mul (Mul b4~36@ b4~36@) (Add d4~40@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~854@ (Mul (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@)) (Mul (Mul (Mul d4~40@ d4~40@) (Sub c4~38@ c4~38@)) (Mul (Mul (Mul b4~36@ b4~36@) (Add d4~40@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@)))))) (and (=> (= tmp%8@ (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@))) (=> (= tmp%9@ (Mul (Mul d4~40@ d4~40@) (Sub c4~38@ c4~38@))) (=> (= tmp%10@ (Mul (Mul (Mul b4~36@ b4~36@) (Add d4~40@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%4 (= temp_4_0~789@ temp_4_1~854@)))))) (=> (= temp_4_0~789@ temp_4_1~854@) (=> (= temp_5_0~989@ (Mul (Sub (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul b5~44@ d5~48@)) a5~42@))) (=> (= temp_5_1~1042@ (Mul (Sub (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul b5~44@ d5~48@)) a5~42@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ b5~44@) (=> %%location_label%%5 (= temp_5_0~989@ temp_5_1~1042@))) (=> (= temp_5_0~989@ temp_5_1~1042@) (=> (= temp_6_0~1143@ (Mul (Mul (Sub (Add a6~50@ b6~52@) (Mul 37 c6~54@)) (Mul (Mul c6~54@ b6~52@) (Add a6~50@ a6~50@))) (Mul (Mul (Sub d6~56@ d6~56@) (Mul d6~56@ c6~54@)) (Mul c6~54@ (Sub b6~52@ a6~50@))))) (=> (= temp_6_1~1216@ (Mul (Mul (Sub (Add a6~50@ b6~52@) (Mul 37 c6~54@)) (Mul (Mul c6~54@ b6~52@) (Add a6~50@ a6~50@))) (Mul (Mul (Sub d6~56@ d6~56@) (Mul c6~54@ d6~56@)) (Mul c6~54@ (Sub b6~52@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1143@ temp_6_1~1216@))) (=> (= temp_6_0~1143@ temp_6_1~1216@) (=> (= temp_7_0~1301@ (Mul (Mul (Add (Sub d7~64@ a7~58@) (Mul a7~58@ d7~64@)) (Add (Mul c7~62@ d7~64@) (Mul a7~58@ b7~60@))) (Add (Mul a7~58@ (Mul a7~58@ a7~58@)) (Mul a7~58@ (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1358@ (Mul (Mul (Add (Sub d7~64@ a7~58@) (Mul a7~58@ d7~64@)) (Add (Mul c7~62@ d7~64@) (Mul a7~58@ b7~60@))) (Add (Mul a7~58@ (Mul a7~58@ a7~58@)) (Mul (Mul a7~58@ d7~64@) a7~58@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a7~58@ d7~64@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1301@ temp_7_1~1358@))) (=> (= temp_7_0~1301@ temp_7_1~1358@) (=> (= temp_8_0~1449@ (Mul (Mul (Mul (Sub d8~72@ d8~72@) (Mul c8~70@ a8~66@)) (Mul d8~72@ (Mul a8~66@ d8~72@))) (Mul (Mul (Add c8~70@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1518@ (Mul (Mul (Sub (Mul d8~72@ (Mul c8~70@ a8~66@)) (Mul d8~72@ (Mul c8~70@ a8~66@))) (Mul d8~72@ (Mul a8~66@ d8~72@))) (Mul (Mul (Add c8~70@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@))))) (=> (= tmp%11@ (Mul c8~70@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d8~72@ d8~72@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~1449@ temp_8_1~1518@)))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
