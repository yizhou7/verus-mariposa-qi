...
;; mariposa_data/4//2459271600413261222/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_1_0~310@ Int)
 ...
 (declare-const temp_5_1~1011@ Int)
 (declare-const temp_6_0~1087@ Int)
 (declare-const temp_6_1~1148@ Int)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~157@ (Mul (Mul (Add (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Mul 47 b0~4@)
          (Sub a0~2@ b0~4@)
         )
        ) (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ d0~8@)) (Mul a0~2@ (Mul b0~4@ b0~4@)))
      ))
      (=>
       (= temp_0_1~230@ (Mul (Mul (Add (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Mul 47 b0~4@)
           (Sub a0~2@ b0~4@)
          )
         ) (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ d0~8@)) (Mul a0~2@ (Mul b0~4@ b0~4@)))
       ))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~310@ (Mul (Mul (Add (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@
                a1~10@
               ) (Mul c1~14@ b1~12@)
              )
             ) (Add (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@
                c1~14@
           )))))
           (=>
            (= temp_1_1~375@ (Mul (Add (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Mul (Mul (Mul c1~14@
                 a1~10@
                ) (Mul c1~14@ b1~12@)
               ) (Add (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@
                  c1~14@
            ...
            (=>
             (= tmp%2@ (= temp_1_0~310@ temp_1_1~375@))
             (and
              (=>
               %%location_label%%1
               tmp%2@
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~487@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ 90)) (Mul (Mul a2~18@
                     b2~20@
                    ) (Mul a2~18@ a2~18@)
                   )
                  ) (Sub (Sub (Mul 0 a2~18@) (Add a2~18@ b2~20@)) (Mul b2~20@ (Mul d2~24@ 90)))
                ))
                (=>
                 (= temp_2_1~584@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ 90)) (Mul (Mul b2~20@
                      a2~18@
                     ) (Mul a2~18@ a2~18@)
                    )
                   ) (Sub (Sub (Mul 0 a2~18@) (Add a2~18@ b2~20@)) (Mul b2~20@ (Mul d2~24@ 90)))
                 ...
                 (=>
                  (= tmp%3@ (= temp_2_0~487@ temp_2_1~584@))
                  (and
                   (=>
                    %%location_label%%2
                    tmp%3@
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~664@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Add d3~32@
                          c3~30@
                         ) (Add b3~28@ b3~28@)
                        )
                       ) (Mul (Mul (Mul c3~30@ b3~28@) (Mul d3~32@ c3~30@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@
                          d3~32@
                     )))))
                     (=>
                      (= temp_3_1~729@ (Mul (Mul (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Add d3~32@
                           c3~30@
                          ) (Add b3~28@ b3~28@)
                         )
                        ) (Mul (Mul c3~30@ (Mul b3~28@ (Mul d3~32@ c3~30@))) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@
                           d3~32@
                      )))))
                      (=>
                       (= tmp%4@ (= temp_3_0~664@ temp_3_1~729@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~809@ (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@
                               b4~36@
                              ) (Mul b4~36@ d4~40@)
                             )
                            ) (Mul (Mul (Add d4~40@ d4~40@) (Sub a4~34@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul b4~36@
                               a4~34@
                          )))))
                          (=>
                           (= temp_4_1~874@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@
                                b4~36@
                               ) (Mul b4~36@ d4~40@)
                              )
                             ) (Mul (Mul (Add d4~40@ d4~40@) (Sub a4~34@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul b4~36@
                           ...
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~950@ (Mul (Mul (Mul (Add a5~42@ a5~42@) (Sub a5~42@ c5~46@)) (Mul (Mul a5~42@
                                    b5~44@
                                   ) (Mul a5~42@ c5~46@)
                                  )
                                 ) (Mul (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Mul c5~46@ (Mul c5~46@ b5~44@)))
                               ))
                               (=>
                                (= temp_5_1~1011@ (Mul (Mul (Mul (Add a5~42@ a5~42@) (Sub a5~42@ c5~46@)) (Mul (Mul a5~42@
                                     b5~44@
                                    ) (Mul a5~42@ c5~46@)
                                   )
                                  ) (Mul (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Mul c5~46@ (Mul b5~44@ c5~46@)))
                                ))
                                (=>
                                 (= tmp%6@ (= temp_5_0~950@ temp_5_1~1011@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~1087@ (Sub (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ b6~52@)) (Mul (Add c6~54@
                                         b6~52@
                                        ) (Add b6~52@ b6~52@)
                                       )
                                      ) (Mul (Sub b6~52@ (Mul b6~52@ b6~52@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ b6~52@)))
                                    ))
                                    (=>
                                     (= temp_6_1~1148@ (Sub (Mul (Mul a6~50@ (Mul c6~54@ (Mul d6~56@ b6~52@))) (Mul (Add c6~54@
                                          b6~52@
                                         ) (Add b6~52@ b6~52@)
                                        )
                                       ) (Mul (Sub b6~52@ (Mul b6~52@ b6~52@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ b6~52@)))
                                     ...
                                     (=>
                                      (= tmp%7@ (= temp_6_0~1087@ temp_6_1~1148@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~1220@ (Mul (Sub (Sub (Mul c7~62@ b7~60@) b7~60@) (Mul (Mul c7~62@ a7~58@)
                                             (Mul c7~62@ c7~62@)
                                            )
                                           ) (Mul (Mul (Mul c7~62@ b7~60@) (Sub c7~62@ d7~64@)) (Mul d7~64@ (Mul a7~58@ c7~62@)))
                                         ))
                                         (=>
                                          (= temp_7_1~1277@ (Mul (Sub (Sub (Mul c7~62@ b7~60@) b7~60@) (Mul (Mul c7~62@ a7~58@)
                                              (Mul c7~62@ c7~62@)
                                             )
                                            ) (Mul (Mul (Sub c7~62@ d7~64@) (Mul c7~62@ b7~60@)) (Mul d7~64@ (Mul a7~58@ c7~62@)))
                                          ))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~1220@ temp_7_1~1277@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~1369@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Sub d8~72@
                                                   b8~68@
                                                  ) (Mul d8~72@ c8~70@)
                                                 )
                                                ) (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Add 36
                                                   a8~66@
                                              )))))
                                              (=>
                                               (= temp_8_1~1446@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@
                                                    c8~70@
                                                   ) (Sub d8~72@ b8~68@)
                                                  )
                                                 ) (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Add 36
