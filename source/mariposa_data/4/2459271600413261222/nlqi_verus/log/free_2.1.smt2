...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~157@ (Mul (Mul (Add (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Mul 47 b0~4@) (Sub a0~2@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ d0~8@)) (Mul a0~2@ (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~230@ (Mul (Mul (Add (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Mul 47 b0~4@) (Sub a0~2@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ d0~8@)) (Mul a0~2@ (Mul b0~4@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~157@ temp_0_1~230@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~310@ (Mul (Mul (Add (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ b1~12@))) (Add (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~375@ (Mul (Add (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ b1~12@)) (Add (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@)))))) (=> (= tmp%2@ (= temp_1_0~310@ temp_1_1~375@)) (=> %%location_label%%1 tmp%2@)))))))))))))
(assert %%query%%)
(check-sat)
