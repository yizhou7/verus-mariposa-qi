...
(assert (=> %%query%% (not (=> (= temp_0_0~153@ (Mul (Mul (Add (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Mul 47 b0~4@) (Sub a0~2@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ d0~8@)) (Mul a0~2@ (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~226@ (Mul (Mul (Add (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Mul 47 b0~4@) (Sub a0~2@ b0~4@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ d0~8@)) (Mul a0~2@ (Mul b0~4@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ b0~4@) (=> %%location_label%%0 (= temp_0_0~153@ temp_0_1~226@))) (=> (= temp_0_0~153@ temp_0_1~226@) (=> (= temp_1_0~319@ (Mul (Mul (Add (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ b1~12@))) (Add (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~384@ (Mul (Add (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ b1~12@)) (Add (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@)))))) (and (=> (= tmp%1@ (Add (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@))) (=> (= tmp%2@ (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ b1~12@))) (=> (= tmp%3@ (Add (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~319@ temp_1_1~384@)))))) (=> (= temp_1_0~319@ temp_1_1~384@) (=> (= temp_2_0~563@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ 90)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ a2~18@))) (Sub (Sub (Mul 0 a2~18@) (Add a2~18@ b2~20@)) (Mul b2~20@ (Mul d2~24@ 90))))) (=> (= temp_2_1~660@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ 90)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ a2~18@))) (Sub (Sub (Mul 0 a2~18@) (Add a2~18@ b2~20@)) (Mul b2~20@ (Mul d2~24@ 90))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ b2~20@) (=> %%location_label%%2 (= temp_2_0~563@ temp_2_1~660@))))))))))))))))
(assert %%query%%)
(check-sat)
