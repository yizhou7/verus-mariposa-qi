...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Sub (Add a0~2@ (Sub (Mul b0~4@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ d0~8@))))) (=> (= temp_0_1~186@ (Sub (Add a0~2@ (Sub (Mul b0~4@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~133@ temp_0_1~186@)) (=> %%location_label%%0 tmp%1@)))))))
(assert %%query%%)
(check-sat)
