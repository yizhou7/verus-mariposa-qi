...
(set-info :comment ";; mariposa_data/4//15994959638818876843/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~275@ Int)
(declare-const temp_1_1~328@ Int)
(declare-const temp_2_0~435@ Int)
(declare-const temp_2_1~496@ Int)
(declare-const temp_3_0~599@ Int)
(declare-const temp_3_1~672@ Int)
(declare-const temp_4_0~777@ Int)
(declare-const temp_4_1~854@ Int)
(declare-const temp_5_0~949@ Int)
(declare-const temp_5_1~1010@ Int)
(declare-const temp_6_0~1157@ Int)
(declare-const temp_6_1~1226@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Sub (Add a0~2@ (Sub (Mul b0~4@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ d0~8@))))) (=> (= temp_0_1~186@ (Sub (Add a0~2@ (Sub (Mul b0~4@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ a0~2@) (=> %%location_label%%0 (= temp_0_0~133@ temp_0_1~186@))) (=> (= temp_0_0~133@ temp_0_1~186@) (=> (= temp_1_0~275@ (Mul (Sub (Mul (Add d1~16@ b1~12@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ b1~12@))) (Mul (Add a1~10@ (Mul d1~16@ a1~10@)) (Mul (Sub a1~10@ b1~12@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~328@ (Mul (Mul (Sub (Add d1~16@ b1~12@) (Mul c1~14@ d1~16@)) (Mul b1~12@ b1~12@)) (Mul (Add a1~10@ (Mul d1~16@ a1~10@)) (Mul (Sub a1~10@ b1~12@) (Mul a1~10@ c1~14@))))) (and (=> (= tmp%1@ (Add d1~16@ b1~12@)) (=> (= tmp%2@ (Mul c1~14@ d1~16@)) (=> (= tmp%3@ (Mul b1~12@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~275@ temp_1_1~328@)))))) (=> (= temp_1_0~275@ temp_1_1~328@) (=> (= temp_2_0~435@ (Sub (Sub (Sub (Mul a2~18@ c2~22@) (Mul d2~24@ c2~22@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@))) (Mul (Add (Mul c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~496@ (Sub (Sub (Mul (Sub a2~18@ d2~24@) c2~22@) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@))) (Mul (Add (Mul c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. a2~18@ d2~24@ c2~22@) (=> %%location_label%%2 (= temp_2_0~435@ temp_2_1~496@))) (=> (= temp_2_0~435@ temp_2_1~496@) (=> (= temp_3_0~599@ (Mul (Sub (Add (Mul a3~26@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ d3~32@))) (Add (Add (Sub a3~26@ 38) (Mul c3~30@ a3~26@)) (Mul (Mul c3~30@ a3~26@) d3~32@)))) (=> (= temp_3_1~672@ (Mul (Sub (Add (Mul a3~26@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ d3~32@))) (Add (Add (Sub a3~26@ 38) (Mul c3~30@ a3~26@)) (Mul (Mul c3~30@ a3~26@) d3~32@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ a3~26@) (=> %%location_label%%3 (= temp_3_0~599@ temp_3_1~672@))) (=> (= temp_3_0~599@ temp_3_1~672@) (=> (= temp_4_0~777@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Sub d4~40@ a4~34@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul a4~34@ b4~36@) (Add d4~40@ b4~36@)) (Mul (Add c4~38@ 51) (Mul a4~34@ a4~34@))))) (=> (= temp_4_1~854@ (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul (Sub d4~40@ a4~34@) b4~36@) d4~40@)) (Mul (Mul (Mul a4~34@ b4~36@) (Add d4~40@ b4~36@)) (Mul (Add c4~38@ 51) (Mul a4~34@ a4~34@))))) (and (=> (= tmp%4@ (Sub d4~40@ a4~34@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ b4~36@ d4~40@) (=> %%location_label%%4 (= temp_4_0~777@ temp_4_1~854@)))) (=> (= temp_4_0~777@ temp_4_1~854@) (=> (= temp_5_0~949@ (Mul (Add (Mul d5~48@ (Mul d5~48@ d5~48@)) (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Add a5~42@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1010@ (Mul (Mul (Add (Mul d5~48@ (Mul d5~48@ d5~48@)) (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Add a5~42@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@)))) (and (=> (= tmp%5@ (Add (Mul d5~48@ (Mul d5~48@ d5~48@)) (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)))) (=> (= tmp%6@ (Mul (Add a5~42@ a5~42@) (Mul b5~44@ a5~42@))) (=> (= tmp%7@ (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%5 (= temp_5_0~949@ temp_5_1~1010@)))))) (=> (= temp_5_0~949@ temp_5_1~1010@) (=> (= temp_6_0~1157@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ a6~50@)) (Mul c6~54@ (Mul b6~52@ 0))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ a6~50@)) (Mul a6~50@ (Mul c6~54@ a6~50@))))) (=> (= temp_6_1~1226@ (Mul (Mul (Mul c6~54@ (Mul b6~52@ 0)) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ a6~50@)) (Mul a6~50@ (Mul c6~54@ a6~50@))))) (and (=> (= tmp%8@ (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ a6~50@))) (=> (= tmp%9@ (Mul c6~54@ (Mul b6~52@ 0))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%6 (= temp_6_0~1157@ temp_6_1~1226@))))) (=> (= temp_6_0~1157@ temp_6_1~1226@) (=> (= temp_7_0~1351@ (Mul (Mul (Mul (Add d7~64@ a7~58@) (Sub a7~58@ a7~58@)) (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1416@ (Mul (Mul (Mul (Add d7~64@ a7~58@) (Sub a7~58@ a7~58@)) (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ a7~58@))) (Mul (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ a7~58@))))) (and (=> (= tmp%10@ (Mul c7~62@ a7~58@)) (=> (= tmp%11@ (Mul d7~64@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%7 (= temp_7_0~1351@ temp_7_1~1416@))))) (=> (= temp_7_0~1351@ temp_7_1~1416@) (=> (= temp_8_0~1501@ (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ d8~72@)) (Mul a8~66@ (Mul b8~68@ a8~66@))) (Add (Mul (Mul b8~68@ c8~70@) (Sub c8~70@ c8~70@)) c8~70@))) (=> (= temp_8_1~1550@ (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ d8~72@)) (Mul (Mul a8~66@ b8~68@) a8~66@)) (Add (Mul (Mul b8~68@ c8~70@) (Sub c8~70@ c8~70@)) c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. a8~66@ b8~68@ a8~66@) (=> %%location_label%%8 (= temp_8_0~1501@ temp_8_1~1550@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
