...
(declare-const temp_1_0~279@ Int)
...
(declare-const temp_5_0~943@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Add (Mul (Mul c0~6@ (Mul d0~8@ b0~4@)) (Mul (Sub a0~2@ b0~4@) (Mul d0~8@ b0~4@))) (Sub (Add c0~6@ a0~2@) (Mul (Add b0~4@ a0~2@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~194@ (Add (Mul (Mul c0~6@ (Mul d0~8@ b0~4@)) (Mul (Sub a0~2@ b0~4@) (Mul d0~8@ b0~4@))) (Sub (Add c0~6@ a0~2@) (Add (Mul b0~4@ (Mul c0~6@ c0~6@)) (Mul a0~2@ (Mul c0~6@ c0~6@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~133@ temp_0_1~194@))) (=> (= temp_0_0~133@ temp_0_1~194@) (=> (= temp_1_0~279@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Add b1~12@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (Mul (Add (Sub d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Mul c1~14@ (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~340@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Add b1~12@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (Mul (Mul c1~14@ (Mul c1~14@ d1~16@)) (Add (Sub d1~16@ d1~16@) (Mul b1~12@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~279@ temp_1_1~340@))) (=> (= temp_1_0~279@ temp_1_1~340@) (=> (= temp_2_0~441@ (Mul (Add (Mul (Add a2~18@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ 50)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~518@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ 50)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ b2~20@))) (Add (Mul (Add a2~18@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~441@ temp_2_1~518@))) (=> (= temp_2_0~441@ temp_2_1~518@) (=> (= temp_3_0~619@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ b3~28@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul d3~32@ 12) (Mul a3~26@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~696@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ b3~28@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul 12 d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~619@ temp_3_1~696@))) (=> (= temp_3_0~619@ temp_3_1~696@) (=> (= temp_4_0~793@ (Mul (Add (Mul (Mul c4~38@ c4~38@) (Mul 21 d4~40@)) (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ a4~34@))) (Mul (Mul d4~40@ (Mul c4~38@ d4~40@)) (Mul (Sub c4~38@ d4~40@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~866@ (Mul (Mul (Add (Mul (Mul c4~38@ c4~38@) (Mul 21 d4~40@)) (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ a4~34@))) (Mul d4~40@ (Mul c4~38@ d4~40@))) (Mul (Sub c4~38@ d4~40@) (Mul c4~38@ b4~36@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~793@ temp_4_1~866@))) (=> (= temp_4_0~793@ temp_4_1~866@) (=> (= temp_5_0~943@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Sub c5~46@ d5~48@) (Mul b5~44@ c5~46@))) (Mul b5~44@ (Add (Mul b5~44@ a5~42@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1004@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Sub (Mul c5~46@ (Mul b5~44@ c5~46@)) (Mul d5~48@ (Mul b5~44@ c5~46@)))) (Mul b5~44@ (Add (Mul b5~44@ a5~42@) (Mul c5~46@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~943@ temp_5_1~1004@))) (=> (= temp_5_0~943@ temp_5_1~1004@) (=> (= temp_6_0~1093@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ b6~52@)) (Sub (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@))) (Mul c6~54@ (Mul (Mul d6~56@ d6~56@) (Mul 10 c6~54@))))) (=> (= temp_6_1~1158@ (Mul (Mul (Mul c6~54@ (Mul a6~50@ (Mul d6~56@ b6~52@))) (Sub (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@))) (Mul c6~54@ (Mul (Mul d6~56@ d6~56@) (Mul 10 c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1093@ temp_6_1~1158@))) (=> (= temp_6_0~1093@ temp_6_1~1158@) (=> (= temp_7_0~1243@ (Add (Add (Mul (Mul b7~60@ d7~64@) (Add d7~64@ d7~64@)) (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ c7~62@))) (Sub (Sub (Mul a7~58@ d7~64@) (Mul a7~58@ a7~58@)) (Add d7~64@ (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1304@ (Add (Add (Mul (Mul b7~60@ d7~64@) (Add d7~64@ d7~64@)) (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ c7~62@))) (Sub (Sub (Mul d7~64@ a7~58@) (Mul a7~58@ a7~58@)) (Add d7~64@ (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1243@ temp_7_1~1304@))) (=> (= temp_7_0~1243@ temp_7_1~1304@) (=> (= temp_8_0~1361@ (Mul d8~72@ (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@)) (Mul (Mul c8~70@ c8~70@) b8~68@)))) (=> (= temp_8_1~1394@ (Mul d8~72@ (Mul (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ c8~70@) b8~68@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1361@ temp_8_1~1394@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
