...
(declare-const temp_3_1~669@ Int)
(declare-const temp_4_0~757@ Int)
(declare-const temp_4_1~830@ Int)
(declare-const temp_5_0~898@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Add (Mul (Mul c0~6@ (Mul d0~8@ b0~4@)) (Mul (Sub a0~2@ b0~4@) (Mul d0~8@ b0~4@))) (Sub (Add c0~6@ a0~2@) (Mul (Add b0~4@ a0~2@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~194@ (Add (Mul (Mul c0~6@ (Mul d0~8@ b0~4@)) (Mul (Sub a0~2@ b0~4@) (Mul d0~8@ b0~4@))) (Sub (Add c0~6@ a0~2@) (Add (Mul b0~4@ (Mul c0~6@ c0~6@)) (Mul a0~2@ (Mul c0~6@ c0~6@)))))) (=> (= tmp%1@ (= temp_0_0~133@ temp_0_1~194@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~270@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Add b1~12@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (Mul (Add (Sub d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Mul c1~14@ (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~331@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Add b1~12@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (Mul (Mul c1~14@ (Mul c1~14@ d1~16@)) (Add (Sub d1~16@ d1~16@) (Mul b1~12@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~270@ temp_1_1~331@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~423@ (Mul (Add (Mul (Add a2~18@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ 50)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~500@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ 50)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ b2~20@))) (Add (Mul (Add a2~18@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~423@ temp_2_1~500@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~592@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ b3~28@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul d3~32@ 12) (Mul a3~26@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~669@ (Mul (Mul (Mul (Mul c3~30@ c3~30@) (Add a3~26@ b3~28@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@))) (Mul (Mul (Mul 12 d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~592@ temp_3_1~669@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~757@ (Mul (Add (Mul (Mul c4~38@ c4~38@) (Mul 21 d4~40@)) (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ a4~34@))) (Mul (Mul d4~40@ (Mul c4~38@ d4~40@)) (Mul (Sub c4~38@ d4~40@) (Mul c4~38@ b4~36@))))) (=> (= temp_4_1~830@ (Mul (Mul (Add (Mul (Mul c4~38@ c4~38@) (Mul 21 d4~40@)) (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ a4~34@))) (Mul d4~40@ (Mul c4~38@ d4~40@))) (Mul (Sub c4~38@ d4~40@) (Mul c4~38@ b4~36@)))) (=> (= tmp%5@ (= temp_4_0~757@ temp_4_1~830@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~898@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Sub c5~46@ d5~48@) (Mul b5~44@ c5~46@))) (Mul b5~44@ (Add (Mul b5~44@ a5~42@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~959@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Sub (Mul c5~46@ (Mul b5~44@ c5~46@)) (Mul d5~48@ (Mul b5~44@ c5~46@)))) (Mul b5~44@ (Add (Mul b5~44@ a5~42@) (Mul c5~46@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~898@ temp_5_1~959@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1039@ (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ b6~52@)) (Sub (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@))) (Mul c6~54@ (Mul (Mul d6~56@ d6~56@) (Mul 10 c6~54@))))) (=> (= temp_6_1~1104@ (Mul (Mul (Mul c6~54@ (Mul a6~50@ (Mul d6~56@ b6~52@))) (Sub (Mul b6~52@ a6~50@) (Mul d6~56@ b6~52@))) (Mul c6~54@ (Mul (Mul d6~56@ d6~56@) (Mul 10 c6~54@))))) (=> (= tmp%7@ (= temp_6_0~1039@ temp_6_1~1104@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1180@ (Add (Add (Mul (Mul b7~60@ d7~64@) (Add d7~64@ d7~64@)) (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ c7~62@))) (Sub (Sub (Mul a7~58@ d7~64@) (Mul a7~58@ a7~58@)) (Add d7~64@ (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1241@ (Add (Add (Mul (Mul b7~60@ d7~64@) (Add d7~64@ d7~64@)) (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ c7~62@))) (Sub (Sub (Mul d7~64@ a7~58@) (Mul a7~58@ a7~58@)) (Add d7~64@ (Mul a7~58@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1180@ temp_7_1~1241@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1289@ (Mul d8~72@ (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@)) (Mul (Mul c8~70@ c8~70@) b8~68@)))) (=> (= temp_8_1~1322@ (Mul d8~72@ (Mul (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ c8~70@) b8~68@)))) (=> (= tmp%9@ (= temp_8_0~1289@ temp_8_1~1322@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
