...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Add (Mul (Mul c0~6@ (Mul d0~8@ b0~4@)) (Mul (Sub a0~2@ b0~4@) (Mul d0~8@ b0~4@))) (Sub (Add c0~6@ a0~2@) (Mul (Add b0~4@ a0~2@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~194@ (Add (Mul (Mul c0~6@ (Mul d0~8@ b0~4@)) (Mul (Sub a0~2@ b0~4@) (Mul d0~8@ b0~4@))) (Sub (Add c0~6@ a0~2@) (Add (Mul b0~4@ (Mul c0~6@ c0~6@)) (Mul a0~2@ (Mul c0~6@ c0~6@)))))) (and (=> (= tmp%1@ (Mul c0~6@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b0~4@ a0~2@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~133@ temp_0_1~194@)))) (=> (= temp_0_0~133@ temp_0_1~194@) (=> (= temp_1_0~289@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Add b1~12@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (Mul (Add (Sub d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Mul c1~14@ (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~350@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Add b1~12@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ b1~12@))) (Mul (Mul c1~14@ (Mul c1~14@ d1~16@)) (Add (Sub d1~16@ d1~16@) (Mul b1~12@ c1~14@))))) (=> (= tmp%2@ (Add (Sub d1~16@ d1~16@) (Mul b1~12@ c1~14@))) (=> (= tmp%3@ (Mul c1~14@ (Mul c1~14@ d1~16@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~289@ temp_1_1~350@))))))))))))))
(assert %%query%%)
(check-sat)
