...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Add (Mul (Mul c0~6@ (Mul d0~8@ b0~4@)) (Mul (Sub a0~2@ b0~4@) (Mul d0~8@ b0~4@))) (Sub (Add c0~6@ a0~2@) (Mul (Add b0~4@ a0~2@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~194@ (Add (Mul (Mul c0~6@ (Mul d0~8@ b0~4@)) (Mul (Sub a0~2@ b0~4@) (Mul d0~8@ b0~4@))) (Sub (Add c0~6@ a0~2@) (Add (Mul b0~4@ (Mul c0~6@ c0~6@)) (Mul a0~2@ (Mul c0~6@ c0~6@)))))) (=> (= tmp%1@ (Mul c0~6@ c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b0~4@ a0~2@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~133@ temp_0_1~194@)))))))))
(assert %%query%%)
(check-sat)
