...
(assert (=> %%query%% (not (=> (= temp_0_0~153@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Add 79 b0~4@) (Mul a0~2@ c0~6@))) (Add (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@)) (Mul b0~4@ (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~226@ (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Add 79 b0~4@) (Mul a0~2@ c0~6@))) (Add (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@)) (Mul b0~4@ (Mul b0~4@ b0~4@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~153@ temp_0_1~226@))))))))
(assert %%query%%)
(check-sat)
