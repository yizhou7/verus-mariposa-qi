...
(declare-const temp_2_0~441@ Int)
...
(declare-const temp_7_1~1296@ Int)
(declare-const temp_8_0~1385@ Int)
(declare-const temp_8_1~1450@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~153@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Add 79 b0~4@) (Mul a0~2@ c0~6@))) (Add (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@)) (Mul b0~4@ (Mul b0~4@ b0~4@))))) (=> (= temp_0_1~226@ (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Add 79 b0~4@) (Mul a0~2@ c0~6@))) (Add (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@)) (Mul b0~4@ (Mul b0~4@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~153@ temp_0_1~226@))) (=> (= temp_0_0~153@ temp_0_1~226@) (=> (= temp_1_0~303@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@)) a1~10@) (Mul (Sub (Mul d1~16@ b1~12@) (Mul c1~14@ d1~16@)) (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ a1~10@))))) (=> (= temp_1_1~356@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@)) a1~10@) (Mul (Sub (Mul d1~16@ b1~12@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~303@ temp_1_1~356@))) (=> (= temp_1_0~303@ temp_1_1~356@) (=> (= temp_2_0~441@ (Mul (Sub (Mul (Add b2~20@ b2~20@) d2~24@) (Add (Mul c2~22@ c2~22@) (Mul b2~20@ b2~20@))) (Mul (Mul (Add d2~24@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Add b2~20@ c2~22@))))) (=> (= temp_2_1~502@ (Mul (Sub (Mul (Add b2~20@ b2~20@) d2~24@) (Add (Mul c2~22@ c2~22@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul b2~20@ b2~20@) (Add d2~24@ c2~22@)) (Mul (Mul b2~20@ b2~20@) (Add b2~20@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~441@ temp_2_1~502@))) (=> (= temp_2_0~441@ temp_2_1~502@) (=> (= temp_3_0~599@ (Mul (Add (Mul b3~28@ (Add a3~26@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul 23 b3~28@))))) (=> (= temp_3_1~672@ (Mul (Add (Mul b3~28@ (Add a3~26@ c3~30@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul 23 b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~599@ temp_3_1~672@))) (=> (= temp_3_0~599@ temp_3_1~672@) (=> (= temp_4_0~761@ (Mul (Sub (Mul (Mul c4~38@ b4~36@) (Sub a4~34@ a4~34@)) (Mul (Mul a4~34@ c4~38@) (Add d4~40@ c4~38@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~826@ (Mul (Sub (Mul (Mul b4~36@ c4~38@) (Sub a4~34@ a4~34@)) (Mul (Mul a4~34@ c4~38@) (Add d4~40@ c4~38@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~761@ temp_4_1~826@))) (=> (= temp_4_0~761@ temp_4_1~826@) (=> (= temp_5_0~923@ (Mul (Mul (Add (Mul a5~42@ c5~46@) (Mul 72 a5~42@)) (Add (Mul a5~42@ d5~48@) (Add b5~44@ a5~42@))) (Mul (Mul (Mul c5~46@ c5~46@) c5~46@) (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ a5~42@))))) (=> (= temp_5_1~1012@ (Mul (Add (Mul (Mul a5~42@ c5~46@) (Add (Mul a5~42@ d5~48@) (Add b5~44@ a5~42@))) (Mul (Mul 72 a5~42@) (Add (Mul a5~42@ d5~48@) (Add b5~44@ a5~42@)))) (Mul (Mul (Mul c5~46@ c5~46@) c5~46@) (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~923@ temp_5_1~1012@))) (=> (= temp_5_0~923@ temp_5_1~1012@) (=> (= temp_6_0~1093@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ b6~52@) b6~52@)) (Add (Mul (Sub c6~54@ b6~52@) (Mul b6~52@ b6~52@)) (Mul a6~50@ (Sub a6~50@ d6~56@))))) (=> (= temp_6_1~1150@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Mul b6~52@ (Mul a6~50@ b6~52@))) (Add (Mul (Sub c6~54@ b6~52@) (Mul b6~52@ b6~52@)) (Mul a6~50@ (Sub a6~50@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1093@ temp_6_1~1150@))) (=> (= temp_6_0~1093@ temp_6_1~1150@) (=> (= temp_7_0~1235@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ d7~64@)) (Mul (Mul a7~58@ a7~58@) (Add c7~62@ d7~64@))) (Mul (Mul (Sub b7~60@ d7~64@) (Mul c7~62@ d7~64@)) (Mul c7~62@ (Mul b7~60@ c7~62@))))) (=> (= temp_7_1~1296@ (Mul (Mul (Mul (Mul (Mul d7~64@ a7~58@) a7~58@) d7~64@) (Mul (Mul a7~58@ a7~58@) (Add c7~62@ d7~64@))) (Mul (Mul (Sub b7~60@ d7~64@) (Mul c7~62@ d7~64@)) (Mul c7~62@ (Mul b7~60@ c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1235@ temp_7_1~1296@))) (=> (= temp_7_0~1235@ temp_7_1~1296@) (=> (= temp_8_0~1385@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Add a8~66@ a8~66@)) (Mul (Sub d8~72@ b8~68@) (Add a8~66@ a8~66@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1450@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Add a8~66@ a8~66@)) (Mul (Sub d8~72@ b8~68@) (Add a8~66@ a8~66@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@)) (Mul (Mul b8~68@ b8~68@) (Mul b8~68@ d8~72@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1385@ temp_8_1~1450@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
