...
;; mariposa_data/4//1510754415653022673/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_1_0~298@ Int)
 (declare-const temp_1_1~351@ Int)
 (declare-const temp_2_0~427@ Int)
 (declare-const temp_2_1~488@ Int)
 (declare-const temp_3_0~576@ Int)
 (declare-const temp_3_1~649@ Int)
 (declare-const temp_4_0~729@ Int)
 (declare-const temp_4_1~794@ Int)
 (declare-const temp_5_0~882@ Int)
 (declare-const temp_5_1~971@ Int)
 (declare-const temp_6_0~1043@ Int)
 (declare-const temp_6_1~1100@ Int)
 (declare-const temp_7_0~1176@ Int)
 (declare-const temp_7_1~1237@ Int)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~157@ (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Add 79 b0~4@)
          (Mul a0~2@ c0~6@)
         )
        ) (Add (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@)) (Mul b0~4@ (Mul b0~4@ b0~4@)))
      ))
      (=>
       (= temp_0_1~230@ (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Add 79 b0~4@)
           (Mul a0~2@ c0~6@)
          )
         ) (Add (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ d0~8@)) (Mul b0~4@ (Mul b0~4@ b0~4@)))
       ))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~298@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@)) a1~10@) (Mul
              (Sub (Mul d1~16@ b1~12@) (Mul c1~14@ d1~16@)) (Mul (Mul d1~16@ a1~10@) (Mul d1~16@
                a1~10@
           )))))
           (=>
            (= temp_1_1~351@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@)) a1~10@) (Mul
               (Sub (Mul d1~16@ b1~12@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul d1~16@
                 a1~10@
            )))))
            (=>
             (= tmp%2@ (= temp_1_0~298@ temp_1_1~351@))
             (and
              (=>
               %%location_label%%1
               tmp%2@
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~427@ (Mul (Sub (Mul (Add b2~20@ b2~20@) d2~24@) (Add (Mul c2~22@ c2~22@)
                    (Mul b2~20@ b2~20@)
                   )
                  ) (Mul (Mul (Add d2~24@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Add b2~20@
                     c2~22@
                )))))
                (=>
                 (= temp_2_1~488@ (Mul (Sub (Mul (Add b2~20@ b2~20@) d2~24@) (Add (Mul c2~22@ c2~22@)
                     (Mul b2~20@ b2~20@)
                    )
                   ) (Mul (Mul (Mul b2~20@ b2~20@) (Add d2~24@ c2~22@)) (Mul (Mul b2~20@ b2~20@) (Add b2~20@
                      c2~22@
                 )))))
                 (=>
                  (= tmp%3@ (= temp_2_0~427@ temp_2_1~488@))
                  (and
                   (=>
                    %%location_label%%2
                    tmp%3@
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~576@ (Mul (Add (Mul b3~28@ (Add a3~26@ c3~30@)) (Mul (Mul a3~26@ b3~28@)
                         (Mul d3~32@ a3~26@)
                        )
                       ) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ b3~28@) (Mul 23
                          b3~28@
                     )))))
                     (=>
                      (= temp_3_1~649@ (Mul (Add (Mul b3~28@ (Add a3~26@ c3~30@)) (Mul (Mul a3~26@ b3~28@)
                          (Mul d3~32@ a3~26@)
                         )
                        ) (Mul (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul 23
                           b3~28@
                      )))))
                      (=>
                       (= tmp%4@ (= temp_3_0~576@ temp_3_1~649@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~729@ (Mul (Sub (Mul (Mul c4~38@ b4~36@) (Sub a4~34@ a4~34@)) (Mul (Mul a4~34@
                               c4~38@
                              ) (Add d4~40@ c4~38@)
                             )
                            ) (Mul (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Mul b4~36@
                               b4~36@
                          )))))
                          (=>
                           (= temp_4_1~794@ (Mul (Sub (Mul (Mul b4~36@ c4~38@) (Sub a4~34@ a4~34@)) (Mul (Mul a4~34@
                                c4~38@
                               ) (Add d4~40@ c4~38@)
                              )
                             ) (Mul (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Mul b4~36@
                           ...
                           (=>
                            (= tmp%5@ (= temp_4_0~729@ temp_4_1~794@))
                            (and
                             (=>
                              %%location_label%%4
                              tmp%5@
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~882@ (Mul (Mul (Add (Mul a5~42@ c5~46@) (Mul 72 a5~42@)) (Add (Mul a5~42@
                                    d5~48@
                                   ) (Add b5~44@ a5~42@)
                                  )
                                 ) (Mul (Mul (Mul c5~46@ c5~46@) c5~46@) (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ a5~42@)))
                               ))
                               (=>
                                (= temp_5_1~971@ (Mul (Add (Mul (Mul a5~42@ c5~46@) (Add (Mul a5~42@ d5~48@) (Add b5~44@
                                      a5~42@
                                    ))
                                   ) (Mul (Mul 72 a5~42@) (Add (Mul a5~42@ d5~48@) (Add b5~44@ a5~42@)))
                                  ) (Mul (Mul (Mul c5~46@ c5~46@) c5~46@) (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ a5~42@)))
                                ))
                                (=>
                                 (= tmp%6@ (= temp_5_0~882@ temp_5_1~971@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~1043@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@
                                         b6~52@
                                        ) b6~52@
                                       )
                                      ) (Add (Mul (Sub c6~54@ b6~52@) (Mul b6~52@ b6~52@)) (Mul a6~50@ (Sub a6~50@ d6~56@)))
                                    ))
                                    (=>
                                     (= temp_6_1~1100@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Mul b6~52@
                                         (Mul a6~50@ b6~52@)
                                        )
                                       ) (Add (Mul (Sub c6~54@ b6~52@) (Mul b6~52@ b6~52@)) (Mul a6~50@ (Sub a6~50@ d6~56@)))
                                     ))
                                     (=>
                                      (= tmp%7@ (= temp_6_0~1043@ temp_6_1~1100@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~1176@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ d7~64@)) (Mul (Mul a7~58@
                                              a7~58@
                                             ) (Add c7~62@ d7~64@)
                                            )
                                           ) (Mul (Mul (Sub b7~60@ d7~64@) (Mul c7~62@ d7~64@)) (Mul c7~62@ (Mul b7~60@ c7~62@)))
                                         ))
                                         (=>
                                          (= temp_7_1~1237@ (Mul (Mul (Mul (Mul (Mul d7~64@ a7~58@) a7~58@) d7~64@) (Mul (Mul a7~58@
                                               a7~58@
                                              ) (Add c7~62@ d7~64@)
                                             )
                                            ) (Mul (Mul (Sub b7~60@ d7~64@) (Mul c7~62@ d7~64@)) (Mul c7~62@ (Mul b7~60@ c7~62@)))
                                          ...
                                          (=>
                                           (= tmp%8@ (= temp_7_0~1176@ temp_7_1~1237@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~1317@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Add a8~66@ a8~66@)) (Mul (Sub d8~72@
                                                   b8~68@
                                                  ) (Add a8~66@ a8~66@)
                                                 )
                                                ) (Mul (Mul (Mul b8~68@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@
                                                   d8~72@
                                              )))))
                                              (=>
                                               (= temp_8_1~1382@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Add a8~66@ a8~66@)) (Mul (Sub d8~72@
                                                    b8~68@
                                                   ) (Add a8~66@ a8~66@)
                                                  )
                                                 ) (Mul (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@)) (Mul (Mul b8~68@ b8~68@) (Mul b8~68@
                                                    d8~72@
                                               )))))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~1317@ temp_8_1~1382@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
