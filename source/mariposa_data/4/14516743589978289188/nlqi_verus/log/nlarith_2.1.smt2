...
(assert (=> %%query%% (not (=> (= temp_0_0~153@ (Add (Mul (Add (Mul c0~6@ c0~6@) (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul d0~8@ c0~6@))) (Add (Sub (Mul a0~2@ b0~4@) (Mul d0~8@ 4)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~226@ (Add (Mul (Add (Mul c0~6@ c0~6@) (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul d0~8@ c0~6@))) (Add (Sub (Mul b0~4@ a0~2@) (Mul d0~8@ 4)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~153@ temp_0_1~226@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~302@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul a1~10@ b1~12@) (Add a1~10@ a1~10@)) (Mul (Mul d1~16@ a1~10@) b1~12@)))) (=> (= temp_1_1~363@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Add a1~10@ a1~10@)) (Mul (Mul d1~16@ a1~10@) b1~12@)) (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~302@ temp_1_1~363@)) (=> %%location_label%%1 tmp%2@))))))))))))
(assert %%query%%)
(check-sat)
