...
(declare-const temp_5_0~854@ Int)
(declare-const temp_5_1~895@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~153@ (Add (Mul (Add (Mul c0~6@ c0~6@) (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul d0~8@ c0~6@))) (Add (Sub (Mul a0~2@ b0~4@) (Mul d0~8@ 4)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~226@ (Add (Mul (Add (Mul c0~6@ c0~6@) (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul d0~8@ c0~6@))) (Add (Sub (Mul b0~4@ a0~2@) (Mul d0~8@ 4)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~153@ temp_0_1~226@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~302@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul a1~10@ b1~12@) (Add a1~10@ a1~10@)) (Mul (Mul d1~16@ a1~10@) b1~12@)))) (=> (= temp_1_1~363@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Add a1~10@ a1~10@)) (Mul (Mul d1~16@ a1~10@) b1~12@)) (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~302@ temp_1_1~363@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~439@ (Mul (Mul (Sub (Mul a2~18@ d2~24@) a2~18@) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul d2~24@ c2~22@) (Add d2~24@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@))))) (=> (= temp_2_1~516@ (Mul (Sub (Mul (Mul a2~18@ d2~24@) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ d2~24@))) (Mul a2~18@ (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ d2~24@)))) (Mul (Mul (Mul d2~24@ c2~22@) (Add d2~24@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~439@ temp_2_1~516@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~596@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Add c3~30@ c3~30@) (Mul c3~30@ a3~26@))) (Mul (Mul (Add c3~30@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@))))) (=> (= temp_3_1~661@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Add c3~30@ c3~30@) (Mul a3~26@ c3~30@))) (Mul (Mul (Add c3~30@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~596@ temp_3_1~661@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~737@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@)) (Mul a4~34@ (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~798@ (Mul (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) (Mul a4~34@ a4~34@)) (Mul a4~34@ b4~36@)) (Mul (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@)) (Mul a4~34@ (Mul c4~38@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~737@ temp_4_1~798@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~854@ (Mul a5~42@ (Sub (Sub (Mul 6 c5~46@) a5~42@) (Mul (Mul a5~42@ b5~44@) d5~48@)))) (=> (= temp_5_1~895@ (Mul a5~42@ (Sub (Sub (Mul 6 c5~46@) a5~42@) (Mul d5~48@ (Mul a5~42@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~854@ temp_5_1~895@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~971@ (Mul (Add (Mul (Mul b6~52@ d6~56@) b6~52@) (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul b6~52@ b6~52@) (Sub c6~54@ b6~52@)) (Mul (Add c6~54@ b6~52@) (Mul a6~50@ c6~54@))))) (=> (= temp_6_1~1032@ (Mul (Add (Mul (Mul b6~52@ d6~56@) b6~52@) (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add c6~54@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ b6~52@) (Sub c6~54@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~971@ temp_6_1~1032@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1096@ (Mul (Sub (Add (Mul b7~60@ d7~64@) b7~60@) c7~62@) (Add (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1145@ (Mul (Sub (Add (Mul b7~60@ d7~64@) b7~60@) c7~62@) (Add (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1096@ temp_7_1~1145@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1225@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Sub c8~70@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Add a8~66@ a8~66@) (Mul c8~70@ b8~68@))))) (=> (= temp_8_1~1290@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Sub c8~70@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul (Add a8~66@ a8~66@) c8~70@) b8~68@)))) (=> (= tmp%9@ (= temp_8_0~1225@ temp_8_1~1290@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
