...
(declare-const temp_2_0~457@ Int)
(declare-const temp_2_1~534@ Int)
(declare-const temp_3_0~623@ Int)
(declare-const temp_3_1~688@ Int)
(declare-const temp_4_0~773@ Int)
(declare-const temp_4_1~834@ Int)
(declare-const temp_5_0~899@ Int)
(declare-const temp_5_1~940@ Int)
(declare-const temp_6_0~1025@ Int)
(declare-const temp_6_1~1086@ Int)
(declare-const temp_7_0~1159@ Int)
(declare-const temp_7_1~1208@ Int)
(declare-const temp_8_0~1297@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~153@ (Add (Mul (Add (Mul c0~6@ c0~6@) (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul d0~8@ c0~6@))) (Add (Sub (Mul a0~2@ b0~4@) (Mul d0~8@ 4)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~226@ (Add (Mul (Add (Mul c0~6@ c0~6@) (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul d0~8@ c0~6@))) (Add (Sub (Mul b0~4@ a0~2@) (Mul d0~8@ 4)) (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~153@ temp_0_1~226@))) (=> (= temp_0_0~153@ temp_0_1~226@) (=> (= temp_1_0~311@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul a1~10@ b1~12@) (Add a1~10@ a1~10@)) (Mul (Mul d1~16@ a1~10@) b1~12@)))) (=> (= temp_1_1~372@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Add a1~10@ a1~10@)) (Mul (Mul d1~16@ a1~10@) b1~12@)) (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~311@ temp_1_1~372@))) (=> (= temp_1_0~311@ temp_1_1~372@) (=> (= temp_2_0~457@ (Mul (Mul (Sub (Mul a2~18@ d2~24@) a2~18@) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul d2~24@ c2~22@) (Add d2~24@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@))))) (=> (= temp_2_1~534@ (Mul (Sub (Mul (Mul a2~18@ d2~24@) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ d2~24@))) (Mul a2~18@ (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ d2~24@)))) (Mul (Mul (Mul d2~24@ c2~22@) (Add d2~24@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul d2~24@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~457@ temp_2_1~534@))) (=> (= temp_2_0~457@ temp_2_1~534@) (=> (= temp_3_0~623@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Add c3~30@ c3~30@) (Mul c3~30@ a3~26@))) (Mul (Mul (Add c3~30@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@))))) (=> (= temp_3_1~688@ (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Add c3~30@ c3~30@) (Mul a3~26@ c3~30@))) (Mul (Mul (Add c3~30@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~623@ temp_3_1~688@))) (=> (= temp_3_0~623@ temp_3_1~688@) (=> (= temp_4_0~773@ (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@)) (Mul a4~34@ (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~834@ (Mul (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) (Mul a4~34@ a4~34@)) (Mul a4~34@ b4~36@)) (Mul (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@)) (Mul a4~34@ (Mul c4~38@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~773@ temp_4_1~834@))) (=> (= temp_4_0~773@ temp_4_1~834@) (=> (= temp_5_0~899@ (Mul a5~42@ (Sub (Sub (Mul 6 c5~46@) a5~42@) (Mul (Mul a5~42@ b5~44@) d5~48@)))) (=> (= temp_5_1~940@ (Mul a5~42@ (Sub (Sub (Mul 6 c5~46@) a5~42@) (Mul d5~48@ (Mul a5~42@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~899@ temp_5_1~940@))) (=> (= temp_5_0~899@ temp_5_1~940@) (=> (= temp_6_0~1025@ (Mul (Add (Mul (Mul b6~52@ d6~56@) b6~52@) (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul b6~52@ b6~52@) (Sub c6~54@ b6~52@)) (Mul (Add c6~54@ b6~52@) (Mul a6~50@ c6~54@))))) (=> (= temp_6_1~1086@ (Mul (Add (Mul (Mul b6~52@ d6~56@) b6~52@) (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ a6~50@))) (Mul (Mul (Add c6~54@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ b6~52@) (Sub c6~54@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1025@ temp_6_1~1086@))) (=> (= temp_6_0~1025@ temp_6_1~1086@) (=> (= temp_7_0~1159@ (Mul (Sub (Add (Mul b7~60@ d7~64@) b7~60@) c7~62@) (Add (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1208@ (Mul (Sub (Add (Mul b7~60@ d7~64@) b7~60@) c7~62@) (Add (Mul (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1159@ temp_7_1~1208@))) (=> (= temp_7_0~1159@ temp_7_1~1208@) (=> (= temp_8_0~1297@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Sub c8~70@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Add a8~66@ a8~66@) (Mul c8~70@ b8~68@))))) (=> (= temp_8_1~1362@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Sub c8~70@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul (Add a8~66@ a8~66@) c8~70@) b8~68@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1297@ temp_8_1~1362@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
