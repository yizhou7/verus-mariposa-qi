...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Sub d0~8@ b0~4@))))) (=> (= temp_0_1~210@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Sub d0~8@ b0~4@))))) (=> (= tmp%1@ (Mul c0~6@ a0~2@)) (=> (= tmp%2@ (Mul b0~4@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@))))))))))
(assert %%query%%)
(check-sat)
