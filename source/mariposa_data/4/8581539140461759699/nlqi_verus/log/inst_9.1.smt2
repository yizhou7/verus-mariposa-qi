...
(set-info :comment ";; mariposa_data/4//8581539140461759699/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~311@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Sub d0~8@ b0~4@))))) (=> (= temp_0_1~210@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Sub d0~8@ b0~4@))))) (and (=> (= tmp%1@ (Mul c0~6@ a0~2@)) (=> (= tmp%2@ (Mul b0~4@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@))))) (=> (= temp_0_0~145@ temp_0_1~210@) (=> (= temp_1_0~311@ (Mul (Add (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@))) (Mul (Mul (Add a1~10@ c1~14@) (Add a1~10@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~376@ (Mul (Mul (Mul (Add a1~10@ c1~14@) (Add a1~10@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ c1~14@))) (Add (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@))))) (and (=> (= tmp%3@ (Add (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@)))) (=> (= tmp%4@ (Mul (Mul (Add a1~10@ c1~14@) (Add a1~10@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ c1~14@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~311@ temp_1_1~376@))))) (=> (= temp_1_0~311@ temp_1_1~376@) (=> (= temp_2_0~517@ (Mul (Mul (Mul c2~22@ (Sub a2~18@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@))) (Mul (Mul a2~18@ (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~574@ (Mul (Mul (Mul c2~22@ (Sub a2~18@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul b2~20@ c2~22@) a2~18@) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ d2~24@))))) (and (=> (= tmp%5@ (Mul b2~20@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a2~18@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~517@ temp_2_1~574@)))) (=> (= temp_2_0~517@ temp_2_1~574@) (=> (= temp_3_0~647@ (Mul (Mul (Mul (Add b3~28@ d3~32@) (Mul d3~32@ c3~30@)) a3~26@) (Mul d3~32@ (Add (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~688@ (Mul (Mul (Mul (Add b3~28@ d3~32@) (Mul d3~32@ c3~30@)) a3~26@) (Mul (Add (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@)) d3~32@))) (and (=> (= tmp%6@ (Add (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~647@ temp_3_1~688@)))) (=> (= temp_3_0~647@ temp_3_1~688@) (=> (= temp_4_0~793@ (Mul (Mul (Add (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ b4~36@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ b4~36@) (Add b4~36@ c4~38@))))) (=> (= temp_4_1~858@ (Mul (Mul (Add (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ b4~36@))) (Sub (Mul (Mul (Mul c4~38@ d4~40@) d4~40@) b4~36@) (Mul (Mul a4~34@ b4~36@) (Add b4~36@ c4~38@))))) (and (=> (= tmp%7@ (Mul c4~38@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ d4~40@ b4~36@) (=> %%location_label%%4 (= temp_4_0~793@ temp_4_1~858@)))) (=> (= temp_4_0~793@ temp_4_1~858@) (=> (= temp_5_0~981@ (Mul (Mul (Mul (Sub c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Sub a5~42@ a5~42@) (Sub b5~44@ 69))) (Mul (Sub (Add a5~42@ c5~46@) (Mul 89 a5~42@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@))))) (=> (= temp_5_1~1070@ (Mul (Mul (Sub (Add a5~42@ c5~46@) (Mul 89 a5~42@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@))) (Mul (Mul (Sub c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Sub a5~42@ a5~42@) (Sub b5~44@ 69))))) (and (=> (= tmp%8@ (Mul (Mul (Sub c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Sub a5~42@ a5~42@) (Sub b5~44@ 69)))) (=> (= tmp%9@ (Mul (Sub (Add a5~42@ c5~46@) (Mul 89 a5~42@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%5 (= temp_5_0~981@ temp_5_1~1070@))))) (=> (= temp_5_0~981@ temp_5_1~1070@) (=> (= temp_6_0~1231@ (Mul (Sub (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@)) a6~50@))) (=> (= temp_6_1~1284@ (Mul (Sub (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@))) (Mul (Mul a6~50@ d6~56@) (Mul (Mul a6~50@ b6~52@) a6~50@)))) (and (=> (= tmp%10@ (Mul a6~50@ d6~56@)) (=> (= tmp%11@ (Mul a6~50@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1231@ temp_6_1~1284@))))) (=> (= temp_6_0~1231@ temp_6_1~1284@) (=> (= temp_7_0~1363@ (Mul (Sub d7~64@ (Add (Mul b7~60@ d7~64@) (Sub a7~58@ a7~58@))) (Mul (Mul (Sub c7~62@ c7~62@) (Mul b7~60@ d7~64@)) d7~64@))) (=> (= temp_7_1~1404@ (Mul (Sub d7~64@ (Add (Mul d7~64@ b7~60@) (Sub a7~58@ a7~58@))) (Mul (Mul (Sub c7~62@ c7~62@) (Mul b7~60@ d7~64@)) d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1363@ temp_7_1~1404@))) (=> (= temp_7_0~1363@ temp_7_1~1404@) (=> (= temp_8_0~1497@ (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@))))) (=> (= temp_8_1~1562@ (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ b8~68@) (=> %%location_label%%8 (= temp_8_0~1497@ temp_8_1~1562@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
