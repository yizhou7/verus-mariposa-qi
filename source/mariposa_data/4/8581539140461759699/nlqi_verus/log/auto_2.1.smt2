...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Sub d0~8@ b0~4@))))) (=> (= temp_0_1~210@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Sub d0~8@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@))) (=> (= temp_0_0~145@ temp_0_1~210@) (=> (= temp_1_0~299@ (Mul (Add (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@))) (Mul (Mul (Add a1~10@ c1~14@) (Add a1~10@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~364@ (Mul (Mul (Mul (Add a1~10@ c1~14@) (Add a1~10@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ c1~14@))) (Add (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~299@ temp_1_1~364@))))))))))))
(assert %%query%%)
(check-sat)
