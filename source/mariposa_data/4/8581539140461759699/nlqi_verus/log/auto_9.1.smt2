...
(declare-const temp_1_1~364@ Int)
...
(declare-const temp_5_0~875@ Int)
(declare-const temp_5_1~964@ Int)
(declare-const temp_6_0~1041@ Int)
(declare-const temp_6_1~1094@ Int)
(declare-const temp_7_0~1159@ Int)
(declare-const temp_7_1~1200@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Sub d0~8@ b0~4@))))) (=> (= temp_0_1~210@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Sub d0~8@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@))) (=> (= temp_0_0~145@ temp_0_1~210@) (=> (= temp_1_0~299@ (Mul (Add (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@))) (Mul (Mul (Add a1~10@ c1~14@) (Add a1~10@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ c1~14@))))) (=> (= temp_1_1~364@ (Mul (Mul (Mul (Add a1~10@ c1~14@) (Add a1~10@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ c1~14@))) (Add (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~299@ temp_1_1~364@))) (=> (= temp_1_0~299@ temp_1_1~364@) (=> (= temp_2_0~445@ (Mul (Mul (Mul c2~22@ (Sub a2~18@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@))) (Mul (Mul a2~18@ (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ d2~24@))))) (=> (= temp_2_1~502@ (Mul (Mul (Mul c2~22@ (Sub a2~18@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul b2~20@ c2~22@) a2~18@) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~445@ temp_2_1~502@))) (=> (= temp_2_0~445@ temp_2_1~502@) (=> (= temp_3_0~567@ (Mul (Mul (Mul (Add b3~28@ d3~32@) (Mul d3~32@ c3~30@)) a3~26@) (Mul d3~32@ (Add (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@))))) (=> (= temp_3_1~608@ (Mul (Mul (Mul (Add b3~28@ d3~32@) (Mul d3~32@ c3~30@)) a3~26@) (Mul (Add (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@)) d3~32@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~567@ temp_3_1~608@))) (=> (= temp_3_0~567@ temp_3_1~608@) (=> (= temp_4_0~697@ (Mul (Mul (Add (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ b4~36@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ b4~36@) (Add b4~36@ c4~38@))))) (=> (= temp_4_1~762@ (Mul (Mul (Add (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ b4~36@))) (Sub (Mul (Mul (Mul c4~38@ d4~40@) d4~40@) b4~36@) (Mul (Mul a4~34@ b4~36@) (Add b4~36@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~697@ temp_4_1~762@))) (=> (= temp_4_0~697@ temp_4_1~762@) (=> (= temp_5_0~875@ (Mul (Mul (Mul (Sub c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Sub a5~42@ a5~42@) (Sub b5~44@ 69))) (Mul (Sub (Add a5~42@ c5~46@) (Mul 89 a5~42@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@))))) (=> (= temp_5_1~964@ (Mul (Mul (Sub (Add a5~42@ c5~46@) (Mul 89 a5~42@)) (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@))) (Mul (Mul (Sub c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Sub a5~42@ a5~42@) (Sub b5~44@ 69))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~875@ temp_5_1~964@))) (=> (= temp_5_0~875@ temp_5_1~964@) (=> (= temp_6_0~1041@ (Mul (Sub (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@)) a6~50@))) (=> (= temp_6_1~1094@ (Mul (Sub (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@))) (Mul (Mul a6~50@ d6~56@) (Mul (Mul a6~50@ b6~52@) a6~50@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1041@ temp_6_1~1094@))) (=> (= temp_6_0~1041@ temp_6_1~1094@) (=> (= temp_7_0~1159@ (Mul (Sub d7~64@ (Add (Mul b7~60@ d7~64@) (Sub a7~58@ a7~58@))) (Mul (Mul (Sub c7~62@ c7~62@) (Mul b7~60@ d7~64@)) d7~64@))) (=> (= temp_7_1~1200@ (Mul (Sub d7~64@ (Add (Mul d7~64@ b7~60@) (Sub a7~58@ a7~58@))) (Mul (Mul (Sub c7~62@ c7~62@) (Mul b7~60@ d7~64@)) d7~64@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1159@ temp_7_1~1200@))) (=> (= temp_7_0~1159@ temp_7_1~1200@) (=> (= temp_8_0~1289@ (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@))))) (=> (= temp_8_1~1354@ (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ d8~72@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1289@ temp_8_1~1354@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
