...
(assert (=> %%query%% (not (=> (= temp_0_0~153@ (Sub (Mul (Add (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul d0~8@ d0~8@) b0~4@)) (Sub (Mul (Mul d0~8@ 13) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~226@ (Sub (Mul (Add (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@)) (Mul b0~4@ (Mul d0~8@ d0~8@))) (Sub (Mul (Mul d0~8@ 13) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~153@ temp_0_1~226@))) (=> (= temp_0_0~153@ temp_0_1~226@) (=> (= temp_1_0~327@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Sub a1~10@ d1~16@))) (Mul (Mul (Mul d1~16@ d1~16@) (Add d1~16@ b1~12@)) (Add (Add c1~14@ b1~12@) (Mul a1~10@ 53))))) (=> (= temp_1_1~420@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Sub a1~10@ d1~16@))) (Add (Mul (Mul (Mul d1~16@ d1~16@) (Add d1~16@ b1~12@)) (Add c1~14@ b1~12@)) (Mul (Mul (Mul d1~16@ d1~16@) (Add d1~16@ b1~12@)) (Mul a1~10@ 53))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~327@ temp_1_1~420@))))))))))))
(assert %%query%%)
(check-sat)
