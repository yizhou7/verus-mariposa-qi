...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~157@ (Sub (Mul (Add (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul d0~8@ d0~8@) b0~4@)) (Sub (Mul (Mul d0~8@ 13) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~230@ (Sub (Mul (Add (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@)) (Mul b0~4@ (Mul d0~8@ d0~8@))) (Sub (Mul (Mul d0~8@ 13) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~157@ temp_0_1~230@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~322@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Sub a1~10@ d1~16@))) (Mul (Mul (Mul d1~16@ d1~16@) (Add d1~16@ b1~12@)) (Add (Add c1~14@ b1~12@) (Mul a1~10@ 53))))) (=> (= temp_1_1~415@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Sub a1~10@ d1~16@))) (Add (Mul (Mul (Mul d1~16@ d1~16@) (Add d1~16@ b1~12@)) (Add c1~14@ b1~12@)) (Mul (Mul (Mul d1~16@ d1~16@) (Add d1~16@ b1~12@)) (Mul a1~10@ 53))))) (=> (= tmp%2@ (= temp_1_0~322@ temp_1_1~415@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~487@ (Mul (Sub (Mul (Mul c2~22@ c2~22@) c2~22@) (Mul a2~18@ (Sub a2~18@ d2~24@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~544@ (Mul (Sub (Mul (Mul c2~22@ c2~22@) c2~22@) (Mul a2~18@ (Sub a2~18@ d2~24@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~487@ temp_2_1~544@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~636@ (Sub (Mul (Mul (Mul b3~28@ 67) (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@))) (Sub (Mul (Sub d3~32@ c3~30@) (Sub a3~26@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~713@ (Sub (Mul (Mul (Mul b3~28@ 67) (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@))) (Sub (Mul (Sub d3~32@ c3~30@) (Sub a3~26@ b3~28@)) (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~636@ temp_3_1~713@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~785@ (Mul (Add (Mul (Sub a4~34@ c4~38@) (Add b4~36@ b4~36@)) (Mul (Add b4~36@ d4~40@) (Mul d4~40@ d4~40@))) (Mul (Mul c4~38@ (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ d4~40@) c4~38@)))) (=> (= temp_4_1~842@ (Mul (Add (Mul (Sub a4~34@ c4~38@) (Add b4~36@ b4~36@)) (Mul (Add b4~36@ d4~40@) (Mul d4~40@ d4~40@))) (Mul (Mul c4~38@ (Mul c4~38@ a4~34@)) (Mul c4~38@ (Mul c4~38@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~785@ temp_4_1~842@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~914@ (Mul (Mul (Add (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul b5~44@ c5~46@) d5~48@)) (Mul (Mul c5~46@ (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~971@ (Mul (Mul (Mul c5~46@ (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ b5~44@))) (Mul (Add (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul b5~44@ c5~46@) d5~48@)))) (=> (= tmp%6@ (= temp_5_0~914@ temp_5_1~971@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1023@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Sub a6~50@ b6~52@) (Mul a6~50@ d6~56@))) c6~54@)) (=> (= temp_6_1~1060@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ d6~56@)) (Mul (Sub a6~50@ b6~52@) (Mul a6~50@ d6~56@))) c6~54@)) (=> (= tmp%7@ (= temp_6_0~1023@ temp_6_1~1060@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1152@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ a7~58@)) (Add (Sub a7~58@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Mul 41 d7~64@))))) (=> (= temp_7_1~1245@ (Mul (Add (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ a7~58@)) (Sub a7~58@ b7~60@)) (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ a7~58@)) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Mul 41 d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1152@ temp_7_1~1245@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1317@ (Mul (Sub (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Add d8~72@ d8~72@) (Sub d8~72@ b8~68@))) (Sub (Mul (Mul b8~68@ b8~68@) a8~66@) (Sub (Mul d8~72@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1402@ (Sub (Mul (Sub (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Add d8~72@ d8~72@) (Sub d8~72@ b8~68@))) (Mul (Mul b8~68@ b8~68@) a8~66@)) (Mul (Sub (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Add d8~72@ d8~72@) (Sub d8~72@ b8~68@))) (Sub (Mul d8~72@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1317@ temp_8_1~1402@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
