...
(declare-const temp_1_0~327@ Int)
(declare-const temp_1_1~420@ Int)
(declare-const temp_2_0~501@ Int)
(declare-const temp_2_1~558@ Int)
(declare-const temp_3_0~659@ Int)
(declare-const temp_3_1~736@ Int)
(declare-const temp_4_0~817@ Int)
(declare-const temp_4_1~874@ Int)
(declare-const temp_5_0~955@ Int)
(declare-const temp_5_1~1012@ Int)
(declare-const temp_6_0~1073@ Int)
(declare-const temp_6_1~1110@ Int)
(declare-const temp_7_0~1211@ Int)
(declare-const temp_7_1~1304@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~153@ (Sub (Mul (Add (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul d0~8@ d0~8@) b0~4@)) (Sub (Mul (Mul d0~8@ 13) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ a0~2@))))) (=> (= temp_0_1~226@ (Sub (Mul (Add (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@)) (Mul b0~4@ (Mul d0~8@ d0~8@))) (Sub (Mul (Mul d0~8@ 13) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~153@ temp_0_1~226@))) (=> (= temp_0_0~153@ temp_0_1~226@) (=> (= temp_1_0~327@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Sub a1~10@ d1~16@))) (Mul (Mul (Mul d1~16@ d1~16@) (Add d1~16@ b1~12@)) (Add (Add c1~14@ b1~12@) (Mul a1~10@ 53))))) (=> (= temp_1_1~420@ (Mul (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Sub a1~10@ d1~16@))) (Add (Mul (Mul (Mul d1~16@ d1~16@) (Add d1~16@ b1~12@)) (Add c1~14@ b1~12@)) (Mul (Mul (Mul d1~16@ d1~16@) (Add d1~16@ b1~12@)) (Mul a1~10@ 53))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~327@ temp_1_1~420@))) (=> (= temp_1_0~327@ temp_1_1~420@) (=> (= temp_2_0~501@ (Mul (Sub (Mul (Mul c2~22@ c2~22@) c2~22@) (Mul a2~18@ (Sub a2~18@ d2~24@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~558@ (Mul (Sub (Mul (Mul c2~22@ c2~22@) c2~22@) (Mul a2~18@ (Sub a2~18@ d2~24@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~501@ temp_2_1~558@))) (=> (= temp_2_0~501@ temp_2_1~558@) (=> (= temp_3_0~659@ (Sub (Mul (Mul (Mul b3~28@ 67) (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@))) (Sub (Mul (Sub d3~32@ c3~30@) (Sub a3~26@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ d3~32@))))) (=> (= temp_3_1~736@ (Sub (Mul (Mul (Mul b3~28@ 67) (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@))) (Sub (Mul (Sub d3~32@ c3~30@) (Sub a3~26@ b3~28@)) (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~659@ temp_3_1~736@))) (=> (= temp_3_0~659@ temp_3_1~736@) (=> (= temp_4_0~817@ (Mul (Add (Mul (Sub a4~34@ c4~38@) (Add b4~36@ b4~36@)) (Mul (Add b4~36@ d4~40@) (Mul d4~40@ d4~40@))) (Mul (Mul c4~38@ (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ d4~40@) c4~38@)))) (=> (= temp_4_1~874@ (Mul (Add (Mul (Sub a4~34@ c4~38@) (Add b4~36@ b4~36@)) (Mul (Add b4~36@ d4~40@) (Mul d4~40@ d4~40@))) (Mul (Mul c4~38@ (Mul c4~38@ a4~34@)) (Mul c4~38@ (Mul c4~38@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~817@ temp_4_1~874@))) (=> (= temp_4_0~817@ temp_4_1~874@) (=> (= temp_5_0~955@ (Mul (Mul (Add (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul b5~44@ c5~46@) d5~48@)) (Mul (Mul c5~46@ (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~1012@ (Mul (Mul (Mul c5~46@ (Mul d5~48@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ b5~44@))) (Mul (Add (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul b5~44@ c5~46@) d5~48@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~955@ temp_5_1~1012@))) (=> (= temp_5_0~955@ temp_5_1~1012@) (=> (= temp_6_0~1073@ (Mul (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Sub a6~50@ b6~52@) (Mul a6~50@ d6~56@))) c6~54@)) (=> (= temp_6_1~1110@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ d6~56@)) (Mul (Sub a6~50@ b6~52@) (Mul a6~50@ d6~56@))) c6~54@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1073@ temp_6_1~1110@))) (=> (= temp_6_0~1073@ temp_6_1~1110@) (=> (= temp_7_0~1211@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ a7~58@)) (Add (Sub a7~58@ b7~60@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Mul 41 d7~64@))))) (=> (= temp_7_1~1304@ (Mul (Add (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ a7~58@)) (Sub a7~58@ b7~60@)) (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ a7~58@)) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul b7~60@ b7~60@) (Mul 41 d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1211@ temp_7_1~1304@))) (=> (= temp_7_0~1211@ temp_7_1~1304@) (=> (= temp_8_0~1385@ (Mul (Sub (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Add d8~72@ d8~72@) (Sub d8~72@ b8~68@))) (Sub (Mul (Mul b8~68@ b8~68@) a8~66@) (Sub (Mul d8~72@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1470@ (Sub (Mul (Sub (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Add d8~72@ d8~72@) (Sub d8~72@ b8~68@))) (Mul (Mul b8~68@ b8~68@) a8~66@)) (Mul (Sub (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Add d8~72@ d8~72@) (Sub d8~72@ b8~68@))) (Sub (Mul d8~72@ c8~70@) (Mul a8~66@ d8~72@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1385@ temp_8_1~1470@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
