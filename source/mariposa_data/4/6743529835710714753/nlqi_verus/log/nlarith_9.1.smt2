...
(declare-const temp_3_0~616@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Sub (Mul (Mul (Sub a0~2@ b0~4@) (Add b0~4@ d0~8@)) d0~8@) (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~186@ (Sub (Mul (Mul (Sub a0~2@ b0~4@) (Add b0~4@ d0~8@)) d0~8@) (Mul (Mul (Mul (Mul b0~4@ a0~2@) c0~6@) a0~2@) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~133@ temp_0_1~186@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~286@ (Mul (Add (Mul (Mul 67 a1~10@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul b1~12@ a1~10@) (Add b1~12@ b1~12@)) (Mul (Mul d1~16@ a1~10@) 4)))) (=> (= temp_1_1~371@ (Mul (Add (Mul (Mul 67 a1~10@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul b1~12@ a1~10@) (Add b1~12@ b1~12@)) (Mul (Mul d1~16@ a1~10@) 4)))) (=> (= tmp%2@ (= temp_1_0~286@ temp_1_1~371@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~463@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Sub c2~22@ a2~18@))) (Sub (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ 75)) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ a2~18@))))) (=> (= temp_2_1~540@ (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Sub c2~22@ a2~18@))) (Sub (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ 75)) (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ d2~24@))))) (=> (= tmp%3@ (= temp_2_0~463@ temp_2_1~540@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~616@ (Mul (Mul (Mul a3~26@ (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@))))) (=> (= temp_3_1~677@ (Mul (Mul (Mul (Mul a3~26@ a3~26@) d3~32@) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~616@ temp_3_1~677@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~765@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ 47))) (Mul (Mul (Mul d4~40@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Mul c4~38@ a4~34@) a4~34@)))) (=> (= temp_4_1~838@ (Mul (Mul (Mul c4~38@ d4~40@) (Mul (Mul a4~34@ b4~36@) (Mul (Mul b4~36@ c4~38@) (Mul d4~40@ 47)))) (Mul (Mul (Mul d4~40@ b4~36@) (Sub d4~40@ a4~34@)) (Mul (Mul c4~38@ a4~34@) a4~34@)))) (=> (= tmp%5@ (= temp_4_0~765@ temp_4_1~838@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~918@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Add b5~44@ c5~46@)) (Add (Sub b5~44@ b5~44@) (Mul d5~48@ c5~46@))) (Add (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ a5~42@))))) (=> (= temp_5_1~983@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Add b5~44@ c5~46@)) (Add (Sub b5~44@ b5~44@) (Mul d5~48@ c5~46@))) (Add (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~918@ temp_5_1~983@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1059@ (Mul (Mul (Mul (Mul b6~52@ c6~54@) (Sub a6~50@ a6~50@)) (Add (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@))) (Mul (Mul (Sub d6~56@ c6~54@) (Add c6~54@ b6~52@)) (Mul d6~56@ (Add d6~56@ b6~52@))))) (=> (= temp_6_1~1120@ (Mul (Mul (Mul (Sub d6~56@ c6~54@) (Add c6~54@ b6~52@)) (Mul d6~56@ (Add d6~56@ b6~52@))) (Mul (Mul (Mul b6~52@ c6~54@) (Sub a6~50@ a6~50@)) (Add (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1059@ temp_6_1~1120@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1212@ (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ 28)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ c7~62@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@)) (Mul (Add a7~58@ c7~62@) (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1289@ (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ 28)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ c7~62@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Add a7~58@ c7~62@) (Mul a7~58@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1212@ temp_7_1~1289@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1369@ (Add (Mul (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ c8~70@) (Sub b8~68@ d8~72@))) (Mul (Sub (Add a8~66@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1434@ (Add (Mul (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ c8~70@) (Sub b8~68@ d8~72@))) (Mul (Sub (Add a8~66@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1369@ temp_8_1~1434@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
