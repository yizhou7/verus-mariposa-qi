...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Sub (Mul (Mul (Sub a0~2@ b0~4@) (Add b0~4@ d0~8@)) d0~8@) (Mul (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (= temp_0_1~186@ (Sub (Mul (Mul (Sub a0~2@ b0~4@) (Add b0~4@ d0~8@)) d0~8@) (Mul (Mul (Mul (Mul b0~4@ a0~2@) c0~6@) a0~2@) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~133@ temp_0_1~186@))))))))
(assert %%query%%)
(check-sat)
