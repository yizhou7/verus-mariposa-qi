...
(assert (=> %%query%% (not (=> (= temp_0_0~165@ (Mul (Mul (Sub (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@)) (Add (Mul 14 d0~8@) a0~2@)) (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Add (Mul 55 b0~4@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~250@ (Mul (Mul (Add (Mul 14 d0~8@) a0~2@) (Sub (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Add (Mul 55 b0~4@) (Mul a0~2@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~165@ temp_0_1~250@))) (=> (= temp_0_0~165@ temp_0_1~250@) (=> (= temp_1_0~335@ (Mul (Mul (Sub (Add c1~14@ b1~12@) (Sub b1~12@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ c1~14@)) (Sub (Mul a1~10@ a1~10@) b1~12@)))) (=> (= temp_1_1~396@ (Mul (Mul (Sub (Add c1~14@ b1~12@) (Sub b1~12@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ c1~14@)) (Sub (Mul a1~10@ a1~10@) b1~12@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~335@ temp_1_1~396@))) (=> (= temp_1_0~335@ temp_1_1~396@) (=> (= temp_2_0~485@ (Mul (Add (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Add b2~20@ b2~20@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ d2~24@) (Add d2~24@ d2~24@)) (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~550@ (Mul (Add (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Add b2~20@ b2~20@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Add d2~24@ d2~24@)) (Mul c2~22@ c2~22@)) (Mul c2~22@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~485@ temp_2_1~550@))))))))))))))))
(assert %%query%%)
(check-sat)
