...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~169@ (Mul (Mul (Sub (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@)) (Add (Mul 14 d0~8@) a0~2@)) (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Add (Mul 55 b0~4@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~254@ (Mul (Mul (Add (Mul 14 d0~8@) a0~2@) (Sub (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Add (Mul 55 b0~4@) (Mul a0~2@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~169@ temp_0_1~254@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~330@ (Mul (Mul (Sub (Add c1~14@ b1~12@) (Sub b1~12@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ c1~14@)) (Sub (Mul a1~10@ a1~10@) b1~12@)))) (=> (= temp_1_1~391@ (Mul (Mul (Sub (Add c1~14@ b1~12@) (Sub b1~12@ c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ c1~14@)) (Sub (Mul a1~10@ a1~10@) b1~12@)))) (=> (= tmp%2@ (= temp_1_0~330@ temp_1_1~391@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~471@ (Mul (Add (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Add b2~20@ b2~20@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ d2~24@) (Add d2~24@ d2~24@)) (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ b2~20@))))) (=> (= temp_2_1~536@ (Mul (Add (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ c2~22@)) (Mul (Add b2~20@ b2~20@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Add d2~24@ d2~24@)) (Mul c2~22@ c2~22@)) (Mul c2~22@ b2~20@)))) (=> (= tmp%3@ (= temp_2_0~471@ temp_2_1~536@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~612@ (Mul (Mul (Mul d3~32@ (Mul c3~30@ a3~26@)) (Mul (Add b3~28@ a3~26@) (Mul c3~30@ b3~28@))) (Mul (Mul (Sub b3~28@ c3~30@) (Sub c3~30@ a3~26@)) (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~673@ (Mul (Mul (Mul d3~32@ (Mul c3~30@ a3~26@)) (Mul (Add b3~28@ a3~26@) (Mul c3~30@ b3~28@))) (Mul (Mul (Sub b3~28@ c3~30@) (Sub c3~30@ a3~26@)) (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~612@ temp_3_1~673@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~777@ (Add (Add (Sub (Sub c4~38@ 88) (Mul b4~36@ c4~38@)) (Mul (Add d4~40@ d4~40@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul b4~36@ c4~38@) (Add b4~36@ a4~34@)) (Add (Mul a4~34@ c4~38@) (Add 35 b4~36@))))) (=> (= temp_4_1~866@ (Add (Add (Sub (Sub c4~38@ 88) (Mul b4~36@ c4~38@)) (Mul (Mul (Add d4~40@ d4~40@) a4~34@) d4~40@)) (Mul (Mul (Mul b4~36@ c4~38@) (Add b4~36@ a4~34@)) (Add (Mul a4~34@ c4~38@) (Add 35 b4~36@))))) (=> (= tmp%5@ (= temp_4_0~777@ temp_4_1~866@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~934@ (Mul (Mul (Mul a5~42@ (Sub b5~44@ a5~42@)) (Mul c5~46@ (Mul c5~46@ a5~42@))) (Add (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ b5~44@)) (Mul a5~42@ (Add b5~44@ c5~46@))))) (=> (= temp_5_1~987@ (Mul (Mul (Mul a5~42@ (Sub b5~44@ a5~42@)) (Mul (Mul c5~46@ a5~42@) c5~46@)) (Add (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ b5~44@)) (Mul a5~42@ (Add b5~44@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~934@ temp_5_1~987@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1063@ (Mul (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul b6~52@ a6~50@) (Sub b6~52@ d6~56@)) (Mul b6~52@ (Add b6~52@ d6~56@))))) (=> (= temp_6_1~1124@ (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Sub b6~52@ d6~56@)) (Mul b6~52@ (Add b6~52@ d6~56@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1063@ temp_6_1~1124@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1200@ (Add (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@)) (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ b7~60@))) (Mul (Add (Mul a7~58@ b7~60@) (Mul d7~64@ b7~60@)) (Sub (Mul a7~58@ d7~64@) c7~62@)))) (=> (= temp_7_1~1261@ (Add (Mul (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@)) (Mul (Mul (Mul b7~60@ d7~64@) c7~62@) b7~60@)) (Mul (Add (Mul a7~58@ b7~60@) (Mul d7~64@ b7~60@)) (Sub (Mul a7~58@ d7~64@) c7~62@)))) (=> (= tmp%8@ (= temp_7_0~1200@ temp_7_1~1261@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1353@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Sub c8~70@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@))) (Mul (Mul (Add c8~70@ b8~68@) (Mul d8~72@ 63)) (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ b8~68@))))) (=> (= temp_8_1~1430@ (Mul (Mul (Mul (Mul a8~66@ d8~72@) (Sub c8~70@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@))) (Mul (Mul (Add c8~70@ b8~68@) (Mul d8~72@ 63)) (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1353@ temp_8_1~1430@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
