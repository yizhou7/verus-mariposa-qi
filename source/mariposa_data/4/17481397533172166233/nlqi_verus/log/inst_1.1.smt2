...
(assert (=> %%query%% (not (=> (= temp_0_0~165@ (Mul (Mul (Sub (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@)) (Add (Mul 14 d0~8@) a0~2@)) (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Add (Mul 55 b0~4@) (Mul a0~2@ c0~6@))))) (=> (= temp_0_1~250@ (Mul (Mul (Add (Mul 14 d0~8@) a0~2@) (Sub (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Add (Mul 55 b0~4@) (Mul a0~2@ c0~6@))))) (=> (= tmp%1@ (Sub (Mul b0~4@ d0~8@) (Mul b0~4@ a0~2@))) (=> (= tmp%2@ (Add (Mul 14 d0~8@) a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~165@ temp_0_1~250@))))))))))
(assert %%query%%)
(check-sat)
