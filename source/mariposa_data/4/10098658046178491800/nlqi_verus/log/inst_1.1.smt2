...
(assert (=> %%query%% (not (=> (= temp_0_0~129@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) b0~4@) (Add (Mul (Mul c0~6@ b0~4@) (Sub b0~4@ c0~6@)) (Mul (Mul a0~2@ c0~6@) c0~6@)))) (=> (= temp_0_1~198@ (Add (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) b0~4@) (Mul (Mul c0~6@ b0~4@) (Sub b0~4@ c0~6@))) (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) b0~4@) (Mul (Mul a0~2@ c0~6@) c0~6@)))) (=> (= tmp%1@ (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) b0~4@)) (=> (= tmp%2@ (Mul (Mul c0~6@ b0~4@) (Sub b0~4@ c0~6@))) (=> (= tmp%3@ (Mul (Mul a0~2@ c0~6@) c0~6@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~129@ temp_0_1~198@)))))))))))
(assert %%query%%)
(check-sat)
