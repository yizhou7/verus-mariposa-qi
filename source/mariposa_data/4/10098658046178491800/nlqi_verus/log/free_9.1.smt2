...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~133@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) b0~4@) (Add (Mul (Mul c0~6@ b0~4@) (Sub b0~4@ c0~6@)) (Mul (Mul a0~2@ c0~6@) c0~6@)))) (=> (= temp_0_1~202@ (Add (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) b0~4@) (Mul (Mul c0~6@ b0~4@) (Sub b0~4@ c0~6@))) (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) b0~4@) (Mul (Mul a0~2@ c0~6@) c0~6@)))) (=> (= tmp%1@ (= temp_0_0~133@ temp_0_1~202@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~282@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Add d1~16@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~347@ (Mul (Mul (Mul c1~14@ (Mul b1~12@ (Add d1~16@ b1~12@))) (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~282@ temp_1_1~347@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~407@ (Add (Mul (Mul 62 (Sub b2~20@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ d2~24@))) d2~24@)) (=> (= temp_2_1~452@ (Add (Mul 62 (Mul (Sub b2~20@ c2~22@) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ d2~24@)))) d2~24@)) (=> (= tmp%3@ (= temp_2_0~407@ temp_2_1~452@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~516@ (Mul (Sub d3~32@ (Mul (Mul d3~32@ d3~32@) d3~32@)) (Mul (Mul (Mul a3~26@ b3~28@) (Add c3~30@ d3~32@)) (Mul (Add b3~28@ b3~28@) (Sub c3~30@ a3~26@))))) (=> (= temp_3_1~565@ (Mul (Sub d3~32@ (Mul (Mul d3~32@ d3~32@) d3~32@)) (Mul (Mul (Mul a3~26@ b3~28@) (Add c3~30@ d3~32@)) (Mul (Sub c3~30@ a3~26@) (Add b3~28@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~516@ temp_3_1~565@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~645@ (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@ a4~34@) (Add d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~710@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@ a4~34@) (Add d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~645@ temp_4_1~710@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~802@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Add b5~44@ a5~42@))) (Mul (Mul (Mul 66 b5~44@) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~887@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Add (Mul (Mul b5~44@ c5~46@) b5~44@) (Mul (Mul b5~44@ c5~46@) a5~42@))) (Mul (Mul (Mul 66 b5~44@) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~802@ temp_5_1~887@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~955@ (Mul (Mul c6~54@ (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ c6~54@))) (Mul (Sub (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1024@ (Mul (Mul c6~54@ (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ c6~54@))) (Sub (Mul (Mul c6~54@ b6~52@) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ b6~52@))) (Mul (Mul b6~52@ c6~54@) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ b6~52@)))))) (=> (= tmp%7@ (= temp_6_0~955@ temp_6_1~1024@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1116@ (Mul (Mul (Mul (Mul a7~58@ d7~64@) (Mul 72 a7~58@)) (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1193@ (Mul (Mul (Mul (Mul a7~58@ d7~64@) (Mul 72 a7~58@)) (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1116@ temp_7_1~1193@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1273@ (Mul (Sub (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ d8~72@)) (Add (Mul a8~66@ d8~72@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul c8~70@ d8~72@) (Sub d8~72@ a8~66@)) (Mul (Sub d8~72@ d8~72@) (Mul c8~70@ a8~66@))))) (=> (= temp_8_1~1338@ (Mul (Sub (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ d8~72@)) (Add (Mul a8~66@ d8~72@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul c8~70@ d8~72@) (Sub d8~72@ a8~66@)) (Mul (Sub d8~72@ d8~72@) (Mul c8~70@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1273@ temp_8_1~1338@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
