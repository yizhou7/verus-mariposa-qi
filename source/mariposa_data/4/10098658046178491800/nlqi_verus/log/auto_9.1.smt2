...
(declare-const temp_1_0~287@ Int)
(declare-const temp_1_1~352@ Int)
(declare-const temp_2_0~421@ Int)
(declare-const temp_2_1~466@ Int)
(declare-const temp_3_0~539@ Int)
(declare-const temp_3_1~588@ Int)
(declare-const temp_4_0~677@ Int)
(declare-const temp_4_1~742@ Int)
(declare-const temp_5_0~843@ Int)
(declare-const temp_5_1~928@ Int)
(declare-const temp_6_0~1005@ Int)
(declare-const temp_6_1~1074@ Int)
(declare-const temp_7_0~1175@ Int)
(declare-const temp_7_1~1252@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~129@ (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) b0~4@) (Add (Mul (Mul c0~6@ b0~4@) (Sub b0~4@ c0~6@)) (Mul (Mul a0~2@ c0~6@) c0~6@)))) (=> (= temp_0_1~198@ (Add (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) b0~4@) (Mul (Mul c0~6@ b0~4@) (Sub b0~4@ c0~6@))) (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ b0~4@)) b0~4@) (Mul (Mul a0~2@ c0~6@) c0~6@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~129@ temp_0_1~198@))) (=> (= temp_0_0~129@ temp_0_1~198@) (=> (= temp_1_0~287@ (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Add d1~16@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ d1~16@))))) (=> (= temp_1_1~352@ (Mul (Mul (Mul c1~14@ (Mul b1~12@ (Add d1~16@ b1~12@))) (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~287@ temp_1_1~352@))) (=> (= temp_1_0~287@ temp_1_1~352@) (=> (= temp_2_0~421@ (Add (Mul (Mul 62 (Sub b2~20@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ d2~24@))) d2~24@)) (=> (= temp_2_1~466@ (Add (Mul 62 (Mul (Sub b2~20@ c2~22@) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ d2~24@)))) d2~24@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~421@ temp_2_1~466@))) (=> (= temp_2_0~421@ temp_2_1~466@) (=> (= temp_3_0~539@ (Mul (Sub d3~32@ (Mul (Mul d3~32@ d3~32@) d3~32@)) (Mul (Mul (Mul a3~26@ b3~28@) (Add c3~30@ d3~32@)) (Mul (Add b3~28@ b3~28@) (Sub c3~30@ a3~26@))))) (=> (= temp_3_1~588@ (Mul (Sub d3~32@ (Mul (Mul d3~32@ d3~32@) d3~32@)) (Mul (Mul (Mul a3~26@ b3~28@) (Add c3~30@ d3~32@)) (Mul (Sub c3~30@ a3~26@) (Add b3~28@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~539@ temp_3_1~588@))) (=> (= temp_3_0~539@ temp_3_1~588@) (=> (= temp_4_0~677@ (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@ a4~34@) (Add d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@))))) (=> (= temp_4_1~742@ (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@ a4~34@) (Add d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~677@ temp_4_1~742@))) (=> (= temp_4_0~677@ temp_4_1~742@) (=> (= temp_5_0~843@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Add b5~44@ a5~42@))) (Mul (Mul (Mul 66 b5~44@) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@))))) (=> (= temp_5_1~928@ (Sub (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@)) (Add (Mul (Mul b5~44@ c5~46@) b5~44@) (Mul (Mul b5~44@ c5~46@) a5~42@))) (Mul (Mul (Mul 66 b5~44@) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~843@ temp_5_1~928@))) (=> (= temp_5_0~843@ temp_5_1~928@) (=> (= temp_6_0~1005@ (Mul (Mul c6~54@ (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ c6~54@))) (Mul (Sub (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1074@ (Mul (Mul c6~54@ (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ c6~54@))) (Sub (Mul (Mul c6~54@ b6~52@) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ b6~52@))) (Mul (Mul b6~52@ c6~54@) (Mul (Add a6~50@ c6~54@) (Mul a6~50@ b6~52@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1005@ temp_6_1~1074@))) (=> (= temp_6_0~1005@ temp_6_1~1074@) (=> (= temp_7_0~1175@ (Mul (Mul (Mul (Mul a7~58@ d7~64@) (Mul 72 a7~58@)) (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1252@ (Mul (Mul (Mul (Mul a7~58@ d7~64@) (Mul 72 a7~58@)) (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1175@ temp_7_1~1252@))) (=> (= temp_7_0~1175@ temp_7_1~1252@) (=> (= temp_8_0~1341@ (Mul (Sub (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ d8~72@)) (Add (Mul a8~66@ d8~72@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul c8~70@ d8~72@) (Sub d8~72@ a8~66@)) (Mul (Sub d8~72@ d8~72@) (Mul c8~70@ a8~66@))))) (=> (= temp_8_1~1406@ (Mul (Sub (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ d8~72@)) (Add (Mul a8~66@ d8~72@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul c8~70@ d8~72@) (Sub d8~72@ a8~66@)) (Mul (Sub d8~72@ d8~72@) (Mul c8~70@ a8~66@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1341@ temp_8_1~1406@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
