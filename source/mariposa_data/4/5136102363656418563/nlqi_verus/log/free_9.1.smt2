...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~141@ (Mul (Sub (Sub a0~2@ (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@))) (Add (Add c0~6@ (Mul b0~4@ d0~8@)) (Add (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~198@ (Mul (Sub (Sub a0~2@ (Mul a0~2@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ c0~6@))) (Add (Add c0~6@ (Mul b0~4@ d0~8@)) (Add (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~141@ temp_0_1~198@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~266@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Add c1~14@ c1~14@)) b1~12@) (Mul (Add (Mul d1~16@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul a1~10@ a1~10@) (Sub b1~12@ b1~12@))))) (=> (= temp_1_1~319@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Add c1~14@ c1~14@)) b1~12@) (Mul (Add (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Sub b1~12@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~266@ temp_1_1~319@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~383@ (Mul (Mul (Mul (Sub c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul c2~22@ (Mul c2~22@ a2~18@))) (Mul b2~20@ (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~432@ (Mul (Mul (Mul (Sub c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul c2~22@ (Mul c2~22@ a2~18@))) (Mul b2~20@ (Mul d2~24@ (Mul b2~20@ (Mul b2~20@ a2~18@)))))) (=> (= tmp%3@ (= temp_2_0~383@ temp_2_1~432@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~512@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ a3~26@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~577@ (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ a3~26@))) (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~512@ temp_3_1~577@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~653@ (Sub (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ a4~34@)) (Mul b4~36@ (Mul a4~34@ a4~34@))) (Add (Sub (Sub b4~36@ b4~36@) (Sub c4~38@ c4~38@)) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~714@ (Sub (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ a4~34@)) (Mul b4~36@ (Mul a4~34@ a4~34@))) (Add (Sub (Sub b4~36@ b4~36@) (Sub c4~38@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~653@ temp_4_1~714@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~794@ (Mul (Sub (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ a5~42@)) (Mul (Sub b5~44@ c5~46@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ d5~48@) (Sub b5~44@ a5~42@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~859@ (Mul (Mul (Mul (Mul c5~46@ d5~48@) (Sub b5~44@ a5~42@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@))) (Sub (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ a5~42@)) (Mul (Sub b5~44@ c5~46@) (Mul c5~46@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~794@ temp_5_1~859@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~939@ (Sub (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@)) (Add (Mul d6~56@ d6~56@) (Sub d6~56@ b6~52@))) (Mul (Mul (Mul a6~50@ d6~56@) (Sub d6~56@ b6~52@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1012@ (Sub (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@)) (Add (Mul d6~56@ d6~56@) (Sub d6~56@ b6~52@))) (Mul (Sub (Mul (Mul a6~50@ d6~56@) d6~56@) (Mul (Mul a6~50@ d6~56@) b6~52@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~939@ temp_6_1~1012@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1088@ (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Add a7~58@ a7~58@)) (Mul c7~62@ (Mul d7~64@ c7~62@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ b7~60@))))) (=> (= temp_7_1~1149@ (Mul (Mul (Mul c7~62@ (Mul d7~64@ c7~62@)) (Mul (Mul c7~62@ c7~62@) (Add a7~58@ a7~58@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1088@ temp_7_1~1149@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1229@ (Mul (Mul (Mul (Sub b8~68@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul c8~70@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ a8~66@)) (Sub (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@))))) (=> (= temp_8_1~1294@ (Mul (Mul (Mul (Sub b8~68@ c8~70@) (Mul a8~66@ c8~70@)) (Mul a8~66@ (Mul d8~72@ (Mul c8~70@ b8~68@)))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ a8~66@)) (Sub (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@))))) (=> (= tmp%9@ (= temp_8_0~1229@ temp_8_1~1294@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
