...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~141@ (Mul (Sub (Sub a0~2@ (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@))) (Add (Add c0~6@ (Mul b0~4@ d0~8@)) (Add (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~198@ (Mul (Sub (Sub a0~2@ (Mul a0~2@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ c0~6@))) (Add (Add c0~6@ (Mul b0~4@ d0~8@)) (Add (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~141@ temp_0_1~198@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~266@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Add c1~14@ c1~14@)) b1~12@) (Mul (Add (Mul d1~16@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul a1~10@ a1~10@) (Sub b1~12@ b1~12@))))) (=> (= temp_1_1~319@ (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Add c1~14@ c1~14@)) b1~12@) (Mul (Add (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Sub b1~12@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~266@ temp_1_1~319@)) (=> %%location_label%%1 tmp%2@)))))))))))))
(assert %%query%%)
(check-sat)
