...
(assert (=> %%query%% (not (=> (= temp_0_0~137@ (Mul (Sub (Sub a0~2@ (Mul a0~2@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@))) (Add (Add c0~6@ (Mul b0~4@ d0~8@)) (Add (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~194@ (Mul (Sub (Sub a0~2@ (Mul a0~2@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ c0~6@))) (Add (Add c0~6@ (Mul b0~4@ d0~8@)) (Add (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@))))) (=> (= tmp%1@ (Mul a0~2@ c0~6@)) (=> (= tmp%2@ (Mul c0~6@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~137@ temp_0_1~194@))))))))))
(assert %%query%%)
(check-sat)
