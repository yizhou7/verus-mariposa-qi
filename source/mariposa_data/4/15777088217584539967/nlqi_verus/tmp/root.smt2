...
;; mariposa_data/4//15777088217584539967/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_2_0~447@ Int)
 (declare-const temp_2_1~512@ Int)
 (declare-const temp_3_0~604@ Int)
 (declare-const temp_3_1~681@ Int)
 (declare-const temp_4_0~761@ Int)
 (declare-const temp_4_1~826@ Int)
 ...
 (declare-const temp_7_0~1164@ Int)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~157@ (Add (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Add d0~8@ b0~4@)
          (Mul b0~4@ a0~2@)
         )
        ) (Mul (Mul (Sub c0~6@ a0~2@) (Sub c0~6@ d0~8@)) (Mul 30 (Mul a0~2@ b0~4@)))
      ))
      (=>
       (= temp_0_1~230@ (Add (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Add d0~8@ b0~4@)
           (Mul b0~4@ a0~2@)
          )
         ) (Mul (Mul (Sub c0~6@ d0~8@) (Sub c0~6@ a0~2@)) (Mul 30 (Mul a0~2@ b0~4@)))
       ))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~306@ (Mul (Sub (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Add b1~12@
                b1~12@
               ) a1~10@
              )
             ) (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@
                a1~10@
           )))))
           (=>
            (= temp_1_1~367@ (Mul (Sub (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ d1~16@)) (Mul (Add b1~12@
                 b1~12@
                ) a1~10@
               )
              ) (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@
            ...
            (=>
             ...
             (and
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~447@ (Mul (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@
                     a2~18@
                    ) (Mul c2~22@ b2~20@)
                   )
                  ) (Mul (Sub (Mul b2~20@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@
                     c2~22@
                )))))
                (=>
                 (= temp_2_1~512@ (Mul (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@
                      a2~18@
                     ) (Mul c2~22@ b2~20@)
                    )
                   ) (Mul (Sub (Mul a2~18@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@
                      c2~22@
                 )))))
                 (=>
                  (= tmp%3@ (= temp_2_0~447@ temp_2_1~512@))
                  (and
                   (=>
                    %%location_label%%2
                    tmp%3@
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~604@ (Mul (Add (Mul (Mul 26 d3~32@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@
                          d3~32@
                         ) (Mul b3~28@ d3~32@)
                        )
                       ) (Mul (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ d3~32@)) (Add (Mul a3~26@ d3~32@) (Mul a3~26@
                          d3~32@
                     )))))
                     (=>
                      (= temp_3_1~681@ (Mul (Add (Mul (Mul 26 d3~32@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@
                           d3~32@
                          ) (Mul b3~28@ d3~32@)
                         )
                        ) (Mul (Mul (Mul (Mul d3~32@ d3~32@) a3~26@) d3~32@) (Add (Mul a3~26@ d3~32@) (Mul a3~26@
                           d3~32@
                      )))))
                      (=>
                       (= tmp%4@ (= temp_3_0~604@ temp_3_1~681@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~761@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@
                               b4~36@
                              ) (Mul b4~36@ b4~36@)
                             )
                            ) (Add (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Add a4~34@
                               c4~38@
                          )))))
                          (=>
                           (= temp_4_1~826@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@
                                b4~36@
                               ) (Mul b4~36@ b4~36@)
                              )
                             ) (Add (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Add a4~34@
                           ...
                           (=>
                            (= tmp%5@ (= temp_4_0~761@ temp_4_1~826@))
                            (and
                             (=>
                              %%location_label%%4
                              tmp%5@
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~914@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@
                                    b5~44@
                                   ) (Mul b5~44@ c5~46@)
                                  )
                                 ) (Mul (Mul c5~46@ (Mul d5~48@ b5~44@)) (Sub (Mul 67 b5~44@) (Mul d5~48@ c5~46@)))
                               ))
                               (=>
                                (= temp_5_1~987@ (Mul (Mul (Mul b5~44@ c5~46@) (Mul (Mul d5~48@ d5~48@) (Mul (Mul a5~42@
                                      b5~44@
                                     ) (Mul b5~44@ c5~46@)
                                   ))
                                  ) (Mul (Mul c5~46@ (Mul d5~48@ b5~44@)) (Sub (Mul 67 b5~44@) (Mul d5~48@ c5~46@)))
                                ...
                                (=>
                                 (= tmp%6@ (= temp_5_0~914@ temp_5_1~987@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~1051@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@
                                         a6~50@
                                        ) (Mul c6~54@ d6~56@)
                                       )
                                      ) (Mul c6~54@ (Add c6~54@ (Mul a6~50@ a6~50@)))
                                    ))
                                    (=>
                                     (= temp_6_1~1100@ (Mul (Mul (Mul a6~50@ d6~56@) (Mul (Mul c6~54@ b6~52@) (Mul (Mul d6~56@
                                           a6~50@
                                          ) (Mul c6~54@ d6~56@)
                                        ))
                                       ) (Mul c6~54@ (Add c6~54@ (Mul a6~50@ a6~50@)))
                                     ...
                                     (=>
                                      (= tmp%7@ (= temp_6_0~1051@ temp_6_1~1100@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~1164@ (Mul 92 (Mul (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ d7~64@)) (Mul (Mul
                                              c7~62@ b7~60@
                                             ) (Mul c7~62@ c7~62@)
                                         ))))
                                         (=>
                                          (= temp_7_1~1213@ (Mul (Mul 92 (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ d7~64@))) (Mul (
                                              Mul c7~62@ b7~60@
                                             ) (Mul c7~62@ c7~62@)
                                          )))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~1164@ temp_7_1~1213@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~1285@ (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@
                                                   a8~66@
                                                  ) (Mul d8~72@ a8~66@)
                                                 )
                                                ) (Mul (Mul c8~70@ (Mul a8~66@ b8~68@)) (Mul c8~70@ (Mul c8~70@ a8~66@)))
                                              ))
                                              (=>
                                               (= temp_8_1~1342@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@
                                                    c8~70@
                                                   ) (Mul a8~66@ b8~68@)
                                                  )
                                                 ) (Mul (Mul c8~70@ (Mul a8~66@ b8~68@)) (Mul c8~70@ (Mul c8~70@ a8~66@)))
                                               ...
                                               (=>
                                                (= tmp%9@ (= temp_8_0~1285@ temp_8_1~1342@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
