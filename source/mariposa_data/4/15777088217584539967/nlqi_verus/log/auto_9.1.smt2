...
(declare-const temp_3_0~627@ Int)
...
(declare-const temp_6_0~1101@ Int)
(declare-const temp_6_1~1150@ Int)
(declare-const temp_7_0~1223@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~153@ (Add (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Add d0~8@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Mul (Sub c0~6@ a0~2@) (Sub c0~6@ d0~8@)) (Mul 30 (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~226@ (Add (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Add d0~8@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Mul (Sub c0~6@ d0~8@) (Sub c0~6@ a0~2@)) (Mul 30 (Mul a0~2@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~153@ temp_0_1~226@))) (=> (= temp_0_0~153@ temp_0_1~226@) (=> (= temp_1_0~311@ (Mul (Sub (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Add b1~12@ b1~12@) a1~10@)) (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~372@ (Mul (Sub (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ d1~16@)) (Mul (Add b1~12@ b1~12@) a1~10@)) (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~311@ temp_1_1~372@))) (=> (= temp_1_0~311@ temp_1_1~372@) (=> (= temp_2_0~461@ (Mul (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ b2~20@))) (Mul (Sub (Mul b2~20@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~526@ (Mul (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ b2~20@))) (Mul (Sub (Mul a2~18@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~461@ temp_2_1~526@))) (=> (= temp_2_0~461@ temp_2_1~526@) (=> (= temp_3_0~627@ (Mul (Add (Mul (Mul 26 d3~32@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ d3~32@)) (Add (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~704@ (Mul (Add (Mul (Mul 26 d3~32@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul (Mul d3~32@ d3~32@) a3~26@) d3~32@) (Add (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~627@ temp_3_1~704@))) (=> (= temp_3_0~627@ temp_3_1~704@) (=> (= temp_4_0~793@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ b4~36@))) (Add (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Add a4~34@ c4~38@))))) (=> (= temp_4_1~858@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ b4~36@))) (Add (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Add a4~34@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~793@ temp_4_1~858@))) (=> (= temp_4_0~793@ temp_4_1~858@) (=> (= temp_5_0~955@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ c5~46@))) (Mul (Mul c5~46@ (Mul d5~48@ b5~44@)) (Sub (Mul 67 b5~44@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1028@ (Mul (Mul (Mul b5~44@ c5~46@) (Mul (Mul d5~48@ d5~48@) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ c5~46@)))) (Mul (Mul c5~46@ (Mul d5~48@ b5~44@)) (Sub (Mul 67 b5~44@) (Mul d5~48@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~955@ temp_5_1~1028@))) (=> (= temp_5_0~955@ temp_5_1~1028@) (=> (= temp_6_0~1101@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ d6~56@))) (Mul c6~54@ (Add c6~54@ (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1150@ (Mul (Mul (Mul a6~50@ d6~56@) (Mul (Mul c6~54@ b6~52@) (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ d6~56@)))) (Mul c6~54@ (Add c6~54@ (Mul a6~50@ a6~50@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1101@ temp_6_1~1150@))) (=> (= temp_6_0~1101@ temp_6_1~1150@) (=> (= temp_7_0~1223@ (Mul 92 (Mul (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ c7~62@))))) (=> (= temp_7_1~1272@ (Mul (Mul 92 (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ d7~64@))) (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ c7~62@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1223@ temp_7_1~1272@))) (=> (= temp_7_0~1223@ temp_7_1~1272@) (=> (= temp_8_0~1353@ (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@))) (Mul (Mul c8~70@ (Mul a8~66@ b8~68@)) (Mul c8~70@ (Mul c8~70@ a8~66@))))) (=> (= temp_8_1~1410@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ b8~68@))) (Mul (Mul c8~70@ (Mul a8~66@ b8~68@)) (Mul c8~70@ (Mul c8~70@ a8~66@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1353@ temp_8_1~1410@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
