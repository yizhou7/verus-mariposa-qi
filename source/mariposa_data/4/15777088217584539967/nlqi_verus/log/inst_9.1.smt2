...
(set-info :comment ";; mariposa_data/4//15777088217584539967/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~323@ Int)
(declare-const temp_1_1~384@ Int)
(declare-const temp_2_0~477@ Int)
(declare-const temp_2_1~542@ Int)
(declare-const temp_3_0~647@ Int)
(declare-const temp_3_1~724@ Int)
(declare-const temp_4_0~823@ Int)
(declare-const temp_4_1~888@ Int)
(declare-const temp_5_0~989@ Int)
(declare-const temp_5_1~1062@ Int)
(declare-const temp_6_0~1161@ Int)
(declare-const temp_6_1~1210@ Int)
(declare-const temp_7_0~1309@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~153@ (Add (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Add d0~8@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Mul (Sub c0~6@ a0~2@) (Sub c0~6@ d0~8@)) (Mul 30 (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~226@ (Add (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Add d0~8@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Mul (Sub c0~6@ d0~8@) (Sub c0~6@ a0~2@)) (Mul 30 (Mul a0~2@ b0~4@))))) (and (=> (= tmp%1@ (Sub c0~6@ a0~2@)) (=> (= tmp%2@ (Sub c0~6@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~153@ temp_0_1~226@))))) (=> (= temp_0_0~153@ temp_0_1~226@) (=> (= temp_1_0~323@ (Mul (Sub (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Add b1~12@ b1~12@) a1~10@)) (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@))))) (=> (= temp_1_1~384@ (Mul (Sub (Mul (Mul c1~14@ d1~16@) (Mul c1~14@ d1~16@)) (Mul (Add b1~12@ b1~12@) a1~10@)) (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~323@ temp_1_1~384@))) (=> (= temp_1_0~323@ temp_1_1~384@) (=> (= temp_2_0~477@ (Mul (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ b2~20@))) (Mul (Sub (Mul b2~20@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ c2~22@))))) (=> (= temp_2_1~542@ (Mul (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ b2~20@))) (Mul (Sub (Mul a2~18@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ a2~18@) (=> %%location_label%%2 (= temp_2_0~477@ temp_2_1~542@))) (=> (= temp_2_0~477@ temp_2_1~542@) (=> (= temp_3_0~647@ (Mul (Add (Mul (Mul 26 d3~32@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ d3~32@)) (Add (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~724@ (Mul (Add (Mul (Mul 26 d3~32@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul (Mul d3~32@ d3~32@) a3~26@) d3~32@) (Add (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@))))) (and (=> (= tmp%3@ (Mul d3~32@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ a3~26@ d3~32@) (=> %%location_label%%3 (= temp_3_0~647@ temp_3_1~724@)))) (=> (= temp_3_0~647@ temp_3_1~724@) (=> (= temp_4_0~823@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ b4~36@))) (Add (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Add a4~34@ c4~38@))))) (=> (= temp_4_1~888@ (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ b4~36@))) (Add (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul c4~38@ d4~40@) (Add a4~34@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ b4~36@) (=> %%location_label%%4 (= temp_4_0~823@ temp_4_1~888@))) (=> (= temp_4_0~823@ temp_4_1~888@) (=> (= temp_5_0~989@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ c5~46@))) (Mul (Mul c5~46@ (Mul d5~48@ b5~44@)) (Sub (Mul 67 b5~44@) (Mul d5~48@ c5~46@))))) (=> (= temp_5_1~1062@ (Mul (Mul (Mul b5~44@ c5~46@) (Mul (Mul d5~48@ d5~48@) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ c5~46@)))) (Mul (Mul c5~46@ (Mul d5~48@ b5~44@)) (Sub (Mul 67 b5~44@) (Mul d5~48@ c5~46@))))) (and (=> (= tmp%4@ (Mul b5~44@ c5~46@)) (=> (= tmp%5@ (Mul d5~48@ d5~48@)) (=> (= tmp%6@ (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ c5~46@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~989@ temp_5_1~1062@)))))) (=> (= temp_5_0~989@ temp_5_1~1062@) (=> (= temp_6_0~1161@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ d6~56@))) (Mul c6~54@ (Add c6~54@ (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1210@ (Mul (Mul (Mul a6~50@ d6~56@) (Mul (Mul c6~54@ b6~52@) (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ d6~56@)))) (Mul c6~54@ (Add c6~54@ (Mul a6~50@ a6~50@))))) (and (=> (= tmp%7@ (Mul a6~50@ d6~56@)) (=> (= tmp%8@ (Mul c6~54@ b6~52@)) (=> (= tmp%9@ (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ d6~56@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%6 (= temp_6_0~1161@ temp_6_1~1210@)))))) (=> (= temp_6_0~1161@ temp_6_1~1210@) (=> (= temp_7_0~1309@ (Mul 92 (Mul (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ c7~62@))))) (=> (= temp_7_1~1358@ (Mul (Mul 92 (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ d7~64@))) (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ c7~62@)))) (and (=> (= tmp%10@ (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ d7~64@))) (=> (= tmp%11@ (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ c7~62@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. 92 tmp%10@ tmp%11@) (=> %%location_label%%7 (= temp_7_0~1309@ temp_7_1~1358@))))) (=> (= temp_7_0~1309@ temp_7_1~1358@) (=> (= temp_8_0~1481@ (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@))) (Mul (Mul c8~70@ (Mul a8~66@ b8~68@)) (Mul c8~70@ (Mul c8~70@ a8~66@))))) (=> (= temp_8_1~1538@ (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ b8~68@))) (Mul (Mul c8~70@ (Mul a8~66@ b8~68@)) (Mul c8~70@ (Mul c8~70@ a8~66@))))) (=> (= tmp%12@ (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ b8~68@))) (=> (= tmp%13@ (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%8 (= temp_8_0~1481@ temp_8_1~1538@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
