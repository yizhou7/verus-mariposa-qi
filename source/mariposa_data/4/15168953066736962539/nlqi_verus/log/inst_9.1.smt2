...
(set-info :comment ";; mariposa_data/4//15168953066736962539/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~267@ Int)
(declare-const temp_1_1~320@ Int)
(declare-const temp_2_0~385@ Int)
(declare-const temp_2_1~422@ Int)
(declare-const temp_3_0~547@ Int)
(declare-const temp_3_1~620@ Int)
(declare-const temp_4_0~727@ Int)
(declare-const temp_4_1~788@ Int)
(declare-const temp_5_0~877@ Int)
(declare-const temp_5_1~938@ Int)
(declare-const temp_6_0~1027@ Int)
(declare-const temp_6_1~1088@ Int)
(declare-const temp_7_0~1217@ Int)
(declare-const temp_7_1~1318@ Int)
(declare-const temp_8_0~1491@ Int)
(declare-const temp_8_1~1544@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Mul (Mul (Add (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@)) b0~4@) (Mul (Mul (Sub c0~6@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~186@ (Mul (Mul (Add (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@)) b0~4@) (Mul (Mul (Sub c0~6@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d0~8@ d0~8@) (=> %%location_label%%0 (= temp_0_0~133@ temp_0_1~186@))) (=> (= temp_0_0~133@ temp_0_1~186@) (=> (= temp_1_0~267@ (Mul (Mul (Add (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ b1~12@))) (Mul b1~12@ (Sub (Mul b1~12@ a1~10@) (Sub b1~12@ b1~12@))))) (=> (= temp_1_1~320@ (Mul (Mul (Add (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ b1~12@))) (Mul b1~12@ (Sub (Mul b1~12@ a1~10@) (Sub b1~12@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ b1~12@) (=> %%location_label%%1 (= temp_1_0~267@ temp_1_1~320@))) (=> (= temp_1_0~267@ temp_1_1~320@) (=> (= temp_2_0~385@ (Sub d2~24@ (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@)) (Sub (Mul b2~20@ b2~20@) (Sub a2~18@ b2~20@))))) (=> (= temp_2_1~422@ (Sub d2~24@ (Mul (Sub (Mul b2~20@ b2~20@) (Sub a2~18@ b2~20@)) (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@))))) (and (=> (= tmp%1@ (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@))) (=> (= tmp%2@ (Sub (Mul b2~20@ b2~20@) (Sub a2~18@ b2~20@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~385@ temp_2_1~422@))))) (=> (= temp_2_0~385@ temp_2_1~422@) (=> (= temp_3_0~547@ (Mul (Mul (Mul a3~26@ (Mul c3~30@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul 67 b3~28@) (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~620@ (Mul (Mul (Mul a3~26@ (Mul c3~30@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul (Mul 67 b3~28@) d3~32@) b3~28@) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ d3~32@))))) (and (=> (= tmp%3@ (Mul 67 b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ d3~32@ b3~28@) (=> %%location_label%%3 (= temp_3_0~547@ temp_3_1~620@)))) (=> (= temp_3_0~547@ temp_3_1~620@) (=> (= temp_4_0~727@ (Mul (Add (Mul d4~40@ (Mul c4~38@ c4~38@)) (Sub (Mul b4~36@ a4~34@) (Mul a4~34@ c4~38@))) (Add (Mul (Sub a4~34@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Sub c4~38@ b4~36@) (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~788@ (Mul (Add (Mul d4~40@ (Mul c4~38@ c4~38@)) (Sub (Mul b4~36@ a4~34@) (Mul a4~34@ c4~38@))) (Add (Mul (Sub a4~34@ a4~34@) (Mul b4~36@ a4~34@)) (Mul (Sub c4~38@ b4~36@) (Mul c4~38@ c4~38@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ b4~36@) (=> %%location_label%%4 (= temp_4_0~727@ temp_4_1~788@))) (=> (= temp_4_0~727@ temp_4_1~788@) (=> (= temp_5_0~877@ (Mul (Mul (Mul (Sub a5~42@ c5~46@) (Mul d5~48@ a5~42@)) (Add (Add c5~46@ c5~46@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul d5~48@ d5~48@) d5~48@) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~938@ (Mul (Mul (Mul (Sub a5~42@ c5~46@) (Mul d5~48@ a5~42@)) (Add (Add c5~46@ c5~46@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul d5~48@ d5~48@) d5~48@) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ d5~48@) (=> %%location_label%%5 (= temp_5_0~877@ temp_5_1~938@))) (=> (= temp_5_0~877@ temp_5_1~938@) (=> (= temp_6_0~1027@ (Mul (Mul (Add (Mul 65 d6~56@) c6~54@) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@))) (Sub (Mul c6~54@ (Sub b6~52@ d6~56@)) (Add d6~56@ c6~54@)))) (=> (= temp_6_1~1088@ (Mul (Mul (Add (Mul 65 d6~56@) c6~54@) (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ b6~52@))) (Sub (Mul c6~54@ (Sub b6~52@ d6~56@)) (Add d6~56@ c6~54@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ d6~56@) (=> %%location_label%%6 (= temp_6_0~1027@ temp_6_1~1088@))) (=> (= temp_6_0~1027@ temp_6_1~1088@) (=> (= temp_7_0~1217@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Sub b7~60@ 84))) (Mul (Mul (Mul d7~64@ 12) (Mul a7~58@ c7~62@)) (Add (Mul 61 d7~64@) (Mul b7~60@ d7~64@))))) (=> (= temp_7_1~1318@ (Mul (Mul (Mul (Mul d7~64@ 12) (Mul a7~58@ c7~62@)) (Add (Mul 61 d7~64@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Sub b7~60@ 84))))) (and (=> (= tmp%4@ (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Sub b7~60@ 84)))) (=> (= tmp%5@ (Mul (Mul (Mul d7~64@ 12) (Mul a7~58@ c7~62@)) (Add (Mul 61 d7~64@) (Mul b7~60@ d7~64@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%7 (= temp_7_0~1217@ temp_7_1~1318@))))) (=> (= temp_7_0~1217@ temp_7_1~1318@) (=> (= temp_8_0~1491@ (Mul (Mul b8~68@ (Mul (Mul d8~72@ b8~68@) (Sub a8~66@ d8~72@))) (Add (Add (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@)) (Sub (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@))))) (=> (= temp_8_1~1544@ (Mul (Add (Add (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@)) (Sub (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@))) (Mul b8~68@ (Mul (Mul d8~72@ b8~68@) (Sub a8~66@ d8~72@))))) (=> (= tmp%6@ (Mul b8~68@ (Mul (Mul d8~72@ b8~68@) (Sub a8~66@ d8~72@)))) (=> (= tmp%7@ (Add (Add (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@)) (Sub (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%8 (= temp_8_0~1491@ temp_8_1~1544@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
