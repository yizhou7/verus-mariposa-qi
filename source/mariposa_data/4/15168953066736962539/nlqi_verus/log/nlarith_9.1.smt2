...
(declare-const temp_1_0~254@ Int)
(declare-const temp_1_1~307@ Int)
(declare-const temp_2_0~359@ Int)
(declare-const temp_2_1~396@ Int)
(declare-const temp_3_0~484@ Int)
(declare-const temp_3_1~557@ Int)
(declare-const temp_4_0~633@ Int)
(declare-const temp_4_1~694@ Int)
(declare-const temp_5_0~770@ Int)
(declare-const temp_5_1~831@ Int)
(declare-const temp_6_0~907@ Int)
(declare-const temp_6_1~968@ Int)
(declare-const temp_7_0~1084@ Int)
(declare-const temp_7_1~1185@ Int)
(declare-const temp_8_0~1253@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Mul (Mul (Add (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@)) b0~4@) (Mul (Mul (Sub c0~6@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ d0~8@))))) (=> (= temp_0_1~186@ (Mul (Mul (Add (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@)) b0~4@) (Mul (Mul (Sub c0~6@ a0~2@) (Mul b0~4@ c0~6@)) (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~133@ temp_0_1~186@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~254@ (Mul (Mul (Add (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ b1~12@))) (Mul b1~12@ (Sub (Mul b1~12@ a1~10@) (Sub b1~12@ b1~12@))))) (=> (= temp_1_1~307@ (Mul (Mul (Add (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ b1~12@))) (Mul b1~12@ (Sub (Mul b1~12@ a1~10@) (Sub b1~12@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~254@ temp_1_1~307@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~359@ (Sub d2~24@ (Mul (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@)) (Sub (Mul b2~20@ b2~20@) (Sub a2~18@ b2~20@))))) (=> (= temp_2_1~396@ (Sub d2~24@ (Mul (Sub (Mul b2~20@ b2~20@) (Sub a2~18@ b2~20@)) (Sub (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~359@ temp_2_1~396@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~484@ (Mul (Mul (Mul a3~26@ (Mul c3~30@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul 67 b3~28@) (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ d3~32@))))) (=> (= temp_3_1~557@ (Mul (Mul (Mul a3~26@ (Mul c3~30@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul (Mul 67 b3~28@) d3~32@) b3~28@) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~484@ temp_3_1~557@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~633@ (Mul (Add (Mul d4~40@ (Mul c4~38@ c4~38@)) (Sub (Mul b4~36@ a4~34@) (Mul a4~34@ c4~38@))) (Add (Mul (Sub a4~34@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Sub c4~38@ b4~36@) (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~694@ (Mul (Add (Mul d4~40@ (Mul c4~38@ c4~38@)) (Sub (Mul b4~36@ a4~34@) (Mul a4~34@ c4~38@))) (Add (Mul (Sub a4~34@ a4~34@) (Mul b4~36@ a4~34@)) (Mul (Sub c4~38@ b4~36@) (Mul c4~38@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~633@ temp_4_1~694@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~770@ (Mul (Mul (Mul (Sub a5~42@ c5~46@) (Mul d5~48@ a5~42@)) (Add (Add c5~46@ c5~46@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul d5~48@ d5~48@) d5~48@) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~831@ (Mul (Mul (Mul (Sub a5~42@ c5~46@) (Mul d5~48@ a5~42@)) (Add (Add c5~46@ c5~46@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul d5~48@ d5~48@) d5~48@) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~770@ temp_5_1~831@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~907@ (Mul (Mul (Add (Mul 65 d6~56@) c6~54@) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@))) (Sub (Mul c6~54@ (Sub b6~52@ d6~56@)) (Add d6~56@ c6~54@)))) (=> (= temp_6_1~968@ (Mul (Mul (Add (Mul 65 d6~56@) c6~54@) (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ b6~52@))) (Sub (Mul c6~54@ (Sub b6~52@ d6~56@)) (Add d6~56@ c6~54@)))) (=> (= tmp%7@ (= temp_6_0~907@ temp_6_1~968@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1084@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Sub b7~60@ 84))) (Mul (Mul (Mul d7~64@ 12) (Mul a7~58@ c7~62@)) (Add (Mul 61 d7~64@) (Mul b7~60@ d7~64@))))) (=> (= temp_7_1~1185@ (Mul (Mul (Mul (Mul d7~64@ 12) (Mul a7~58@ c7~62@)) (Add (Mul 61 d7~64@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Sub b7~60@ 84))))) (=> (= tmp%8@ (= temp_7_0~1084@ temp_7_1~1185@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1253@ (Mul (Mul b8~68@ (Mul (Mul d8~72@ b8~68@) (Sub a8~66@ d8~72@))) (Add (Add (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@)) (Sub (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@))))) (=> (= temp_8_1~1306@ (Mul (Add (Add (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@)) (Sub (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@))) (Mul b8~68@ (Mul (Mul d8~72@ b8~68@) (Sub a8~66@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1253@ temp_8_1~1306@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
