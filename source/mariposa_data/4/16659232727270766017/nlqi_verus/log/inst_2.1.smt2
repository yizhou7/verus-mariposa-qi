...
(assert (=> %%query%% (not (=> (= temp_0_0~141@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) d0~8@) (Mul (Mul d0~8@ a0~2@) (Sub d0~8@ a0~2@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ c0~6@)) (Sub (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@))))) (=> (= temp_0_1~202@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) d0~8@) (Mul (Mul d0~8@ a0~2@) (Sub d0~8@ a0~2@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ c0~6@)) (Sub (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ d0~8@) (=> %%location_label%%0 (= temp_0_0~141@ temp_0_1~202@))) (=> (= temp_0_0~141@ temp_0_1~202@) (=> (= temp_1_0~307@ (Mul (Mul (Add (Mul b1~12@ 22) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Add a1~10@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~384@ (Mul (Mul (Add (Mul b1~12@ 22) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Add a1~10@ b1~12@))))) (=> (= tmp%1@ (Add a1~10@ b1~12@)) (=> (= tmp%2@ (Mul c1~14@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~307@ temp_1_1~384@))))))))))))))
(assert %%query%%)
(check-sat)
