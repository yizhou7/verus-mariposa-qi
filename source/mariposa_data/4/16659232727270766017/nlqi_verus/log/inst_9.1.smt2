...
(set-info :comment ";; mariposa_data/4//16659232727270766017/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_2_0~497@ Int)
(declare-const temp_2_1~574@ Int)
(declare-const temp_3_0~689@ Int)
(declare-const temp_3_1~754@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~141@ (Mul (Mul (Mul (Mul c0~6@ d0~8@) d0~8@) (Mul (Mul d0~8@ a0~2@) (Sub d0~8@ a0~2@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ c0~6@)) (Sub (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@))))) (=> (= temp_0_1~202@ (Mul (Mul (Mul (Mul d0~8@ c0~6@) d0~8@) (Mul (Mul d0~8@ a0~2@) (Sub d0~8@ a0~2@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ c0~6@)) (Sub (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ d0~8@) (=> %%location_label%%0 (= temp_0_0~141@ temp_0_1~202@))) (=> (= temp_0_0~141@ temp_0_1~202@) (=> (= temp_1_0~307@ (Mul (Mul (Add (Mul b1~12@ 22) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Add a1~10@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~384@ (Mul (Mul (Add (Mul b1~12@ 22) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Add a1~10@ b1~12@))))) (and (=> (= tmp%1@ (Add a1~10@ b1~12@)) (=> (= tmp%2@ (Mul c1~14@ d1~16@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~307@ temp_1_1~384@))))) (=> (= temp_1_0~307@ temp_1_1~384@) (=> (= temp_2_0~497@ (Mul (Mul (Add (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Add b2~20@ a2~18@) (Mul c2~22@ b2~20@))) (Sub (Mul (Add b2~20@ b2~20@) (Mul b2~20@ c2~22@)) (Mul (Sub b2~20@ a2~18@) (Mul 50 d2~24@))))) (=> (= temp_2_1~574@ (Mul (Mul (Mul (Add (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@)) (Add b2~20@ a2~18@)) (Mul c2~22@ b2~20@)) (Sub (Mul (Add b2~20@ b2~20@) (Mul b2~20@ c2~22@)) (Mul (Sub b2~20@ a2~18@) (Mul 50 d2~24@))))) (and (=> (= tmp%3@ (Add (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@))) (=> (= tmp%4@ (Add b2~20@ a2~18@)) (=> (= tmp%5@ (Mul c2~22@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~497@ temp_2_1~574@)))))) (=> (= temp_2_0~497@ temp_2_1~574@) (=> (= temp_3_0~689@ (Sub (Mul (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ a3~26@)) d3~32@) (Mul (Add (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ 54))))) (=> (= temp_3_1~754@ (Sub (Mul (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ a3~26@)) d3~32@) (Mul (Mul (Add (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Mul a3~26@ c3~30@)) (Mul d3~32@ 54)))) (and (=> (= tmp%6@ (Add (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@))) (=> (= tmp%7@ (Mul a3~26@ c3~30@)) (=> (= tmp%8@ (Mul d3~32@ 54)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%3 (= temp_3_0~689@ temp_3_1~754@)))))) (=> (= temp_3_0~689@ temp_3_1~754@) (=> (= temp_4_0~893@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ 65))) (Mul (Sub (Mul c4~38@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~970@ (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ 65))) (Mul (Sub (Mul c4~38@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ b4~36@) (=> %%location_label%%4 (= temp_4_0~893@ temp_4_1~970@))) (=> (= temp_4_0~893@ temp_4_1~970@) (=> (= temp_5_0~1075@ (Mul (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ b5~44@))) (Mul (Mul (Sub a5~42@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul a5~42@ c5~46@) (Mul 90 a5~42@))))) (=> (= temp_5_1~1152@ (Mul (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ b5~44@))) (Mul (Mul (Sub a5~42@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Mul 90 a5~42@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ c5~46@) (=> %%location_label%%5 (= temp_5_0~1075@ temp_5_1~1152@))) (=> (= temp_5_0~1075@ temp_5_1~1152@) (=> (= temp_6_0~1269@ (Mul (Mul (Mul (Sub c6~54@ b6~52@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul a6~50@ b6~52@) (Sub a6~50@ 96)) (Mul (Add d6~56@ 59) (Mul d6~56@ d6~56@))))) (=> (= temp_6_1~1358@ (Mul (Mul (Mul (Sub c6~54@ b6~52@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul a6~50@ b6~52@) (Sub a6~50@ 96)) (Mul (Add d6~56@ 59) (Mul d6~56@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1269@ temp_6_1~1358@))) (=> (= temp_6_0~1269@ temp_6_1~1358@) (=> (= temp_7_0~1459@ (Sub (Mul (Sub (Add d7~64@ b7~60@) (Mul c7~62@ c7~62@)) (Mul (Mul b7~60@ 2) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ c7~62@)) (Mul b7~60@ (Mul d7~64@ a7~58@))))) (=> (= temp_7_1~1532@ (Sub (Mul (Sub (Add d7~64@ b7~60@) (Mul c7~62@ c7~62@)) (Mul (Mul 2 b7~60@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul a7~58@ c7~62@) (Add c7~62@ c7~62@)) (Mul b7~60@ (Mul d7~64@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ 2) (=> %%location_label%%7 (= temp_7_0~1459@ temp_7_1~1532@))) (=> (= temp_7_0~1459@ temp_7_1~1532@) (=> (= temp_8_0~1641@ (Mul (Mul (Sub (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@)) (Mul (Add d8~72@ d8~72@) b8~68@)) (Mul (Add (Mul a8~66@ d8~72@) (Mul 23 b8~68@)) (Mul b8~68@ (Mul c8~70@ d8~72@))))) (=> (= temp_8_1~1722@ (Mul (Sub (Mul (Mul b8~68@ a8~66@) (Mul (Add d8~72@ d8~72@) b8~68@)) (Mul (Mul c8~70@ d8~72@) (Mul (Add d8~72@ d8~72@) b8~68@))) (Mul (Add (Mul a8~66@ d8~72@) (Mul 23 b8~68@)) (Mul b8~68@ (Mul c8~70@ d8~72@))))) (=> (= tmp%9@ (Mul b8~68@ a8~66@)) (=> (= tmp%10@ (Mul c8~70@ d8~72@)) (=> (= tmp%11@ (Mul (Add d8~72@ d8~72@) b8~68@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~1641@ temp_8_1~1722@)))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
