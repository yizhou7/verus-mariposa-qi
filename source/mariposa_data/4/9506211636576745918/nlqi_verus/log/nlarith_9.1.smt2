...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Mul (Mul (Sub a0~2@ b0~4@) (Sub a0~2@ d0~8@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Add (Mul d0~8@ d0~8@) (Add c0~6@ d0~8@))))) (=> (= temp_0_1~226@ (Mul (Mul (Mul (Sub a0~2@ b0~4@) (Sub a0~2@ d0~8@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (Add (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Mul d0~8@ d0~8@)) (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Add c0~6@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~145@ temp_0_1~226@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~306@ (Mul (Add (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ b1~12@)) d1~16@) (Mul (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Add (Mul b1~12@ 14) (Mul d1~16@ c1~14@))))) (=> (= temp_1_1~371@ (Mul (Add (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ c1~14@)) d1~16@) (Mul (Sub (Mul b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Add (Mul b1~12@ 14) (Mul d1~16@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~306@ temp_1_1~371@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~471@ (Mul (Mul (Mul (Sub d2~24@ a2~18@) a2~18@) (Mul (Sub b2~20@ 93) (Mul d2~24@ d2~24@))) (Sub (Add (Mul d2~24@ b2~20@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ 35) (Mul a2~18@ a2~18@))))) (=> (= temp_2_1~556@ (Mul (Mul (Mul (Sub d2~24@ a2~18@) a2~18@) (Mul (Sub b2~20@ 93) (Mul d2~24@ d2~24@))) (Sub (Add (Mul b2~20@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ 35) (Mul a2~18@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~471@ temp_2_1~556@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~620@ (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@)) (Mul a3~26@ (Mul c3~30@ b3~28@))) (Mul (Mul (Sub b3~28@ c3~30@) (Mul c3~30@ c3~30@)) d3~32@))) (=> (= temp_3_1~669@ (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@)) (Mul a3~26@ (Mul c3~30@ b3~28@))) (Mul (Mul (Sub b3~28@ c3~30@) (Mul c3~30@ c3~30@)) d3~32@))) (=> (= tmp%4@ (= temp_3_0~620@ temp_3_1~669@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~737@ (Sub (Mul (Mul (Mul c4~38@ c4~38@) (Sub c4~38@ d4~40@)) (Add (Mul a4~34@ c4~38@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@)) d4~40@))) (=> (= temp_4_1~798@ (Sub (Mul (Sub (Mul (Mul c4~38@ c4~38@) c4~38@) (Mul (Mul c4~38@ c4~38@) d4~40@)) (Add (Mul a4~34@ c4~38@) (Mul c4~38@ c4~38@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ a4~34@)) d4~40@))) (=> (= tmp%5@ (= temp_4_0~737@ temp_4_1~798@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~878@ (Mul (Mul b5~44@ (Add (Mul c5~46@ a5~42@) (Mul d5~48@ 81))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~943@ (Mul (Mul b5~44@ (Add (Mul c5~46@ a5~42@) (Mul d5~48@ 81))) (Mul (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~878@ temp_5_1~943@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1023@ (Mul (Mul (Mul (Add c6~54@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul b6~52@ d6~56@) (Sub a6~50@ b6~52@)) (Add (Sub d6~56@ b6~52@) (Mul b6~52@ b6~52@))))) (=> (= temp_6_1~1088@ (Mul (Mul (Mul (Add c6~54@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul b6~52@ d6~56@) (Sub a6~50@ b6~52@)) (Add (Sub d6~56@ b6~52@) (Mul b6~52@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1023@ temp_6_1~1088@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1156@ (Mul (Mul c7~62@ (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Add d7~64@ c7~62@) (Mul b7~60@ d7~64@))))) (=> (= temp_7_1~1209@ (Mul (Mul c7~62@ (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@)) (Mul (Add d7~64@ c7~62@) (Mul b7~60@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1156@ temp_7_1~1209@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1281@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Sub b8~68@ d8~72@)) (Mul (Sub d8~72@ b8~68@) (Mul c8~70@ c8~70@))) (Sub (Mul (Mul b8~68@ c8~70@) b8~68@) (Sub d8~72@ (Mul a8~66@ d8~72@))))) (=> (= temp_8_1~1346@ (Mul (Mul (Sub (Mul (Mul c8~70@ c8~70@) b8~68@) (Mul (Mul c8~70@ c8~70@) d8~72@)) (Mul (Sub d8~72@ b8~68@) (Mul c8~70@ c8~70@))) (Sub (Mul (Mul b8~68@ c8~70@) b8~68@) (Sub d8~72@ (Mul a8~66@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1281@ temp_8_1~1346@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
