...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Mul (Mul (Sub a0~2@ b0~4@) (Sub a0~2@ d0~8@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Add (Mul d0~8@ d0~8@) (Add c0~6@ d0~8@))))) (=> (= temp_0_1~226@ (Mul (Mul (Mul (Sub a0~2@ b0~4@) (Sub a0~2@ d0~8@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (Add (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Mul d0~8@ d0~8@)) (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Add c0~6@ d0~8@))))) (=> (= tmp%1@ (= temp_0_0~145@ temp_0_1~226@)) (=> %%location_label%%0 tmp%1@)))))))
(assert %%query%%)
(check-sat)
