...
(declare-const temp_1_1~388@ Int)
(declare-const temp_2_0~477@ Int)
(declare-const temp_2_1~542@ Int)
(declare-const temp_3_0~643@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Mul (Mul (Add b0~4@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Add a0~2@ b0~4@))))) (=> (= temp_0_1~210@ (Mul (Mul (Mul (Add b0~4@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Add a0~2@ b0~4@) (Mul d0~8@ a0~2@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@))) (=> (= temp_0_0~145@ temp_0_1~210@) (=> (= temp_1_0~311@ (Mul (Mul (Sub (Mul a1~10@ d1~16@) (Sub b1~12@ d1~16@)) (Mul (Mul 79 d1~16@) (Mul c1~14@ c1~14@))) (Mul (Mul (Add b1~12@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~388@ (Mul (Mul (Sub (Mul d1~16@ a1~10@) (Sub b1~12@ d1~16@)) (Mul (Mul 79 d1~16@) (Mul c1~14@ c1~14@))) (Mul (Mul (Add b1~12@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~311@ temp_1_1~388@))) (=> (= temp_1_0~311@ temp_1_1~388@) (=> (= temp_2_0~477@ (Add (Mul (Mul (Sub a2~18@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ b2~20@))) (Mul (Add (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~542@ (Add (Mul (Mul (Sub a2~18@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ d2~24@))) (Mul (Add (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~477@ temp_2_1~542@))) (=> (= temp_2_0~477@ temp_2_1~542@) (=> (= temp_3_0~643@ (Mul (Mul (Add (Mul d3~32@ b3~28@) (Sub d3~32@ c3~30@)) (Mul (Add c3~30@ b3~28@) (Sub d3~32@ c3~30@))) (Mul (Sub (Mul c3~30@ 93) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~720@ (Mul (Mul (Sub (Mul c3~30@ 93) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Add (Mul d3~32@ b3~28@) (Sub d3~32@ c3~30@)) (Mul (Add c3~30@ b3~28@) (Sub d3~32@ c3~30@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~643@ temp_3_1~720@))) (=> (= temp_3_0~643@ temp_3_1~720@) (=> (= temp_4_0~845@ (Mul (Mul (Add (Mul d4~40@ 38) (Mul a4~34@ d4~40@)) (Sub (Add c4~38@ d4~40@) (Add 47 a4~34@))) (Mul (Mul (Mul c4~38@ 37) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~946@ (Mul (Mul (Mul (Mul c4~38@ 37) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@))) (Mul (Add (Mul d4~40@ 38) (Mul a4~34@ d4~40@)) (Sub (Add c4~38@ d4~40@) (Add 47 a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~845@ temp_4_1~946@))) (=> (= temp_4_0~845@ temp_4_1~946@) (=> (= temp_5_0~1055@ (Mul (Mul (Mul c5~46@ (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ 25) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul 18 c5~46@)) (Add (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1140@ (Mul (Mul (Mul c5~46@ (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ 25) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ 18)) (Add (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~1055@ temp_5_1~1140@))) (=> (= temp_5_0~1055@ temp_5_1~1140@) (=> (= temp_6_0~1225@ (Mul (Add (Mul (Mul a6~50@ d6~56@) c6~54@) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ c6~54@))) (Add (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ c6~54@))))) (=> (= temp_6_1~1286@ (Mul (Add (Mul (Mul a6~50@ d6~56@) c6~54@) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@))) (Add (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1225@ temp_6_1~1286@))) (=> (= temp_6_0~1225@ temp_6_1~1286@) (=> (= temp_7_0~1371@ (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ c7~62@) (Sub b7~60@ b7~60@))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul b7~60@ c7~62@) c7~62@)))) (=> (= temp_7_1~1432@ (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ d7~64@)) (Mul c7~62@ (Mul c7~62@ (Sub b7~60@ b7~60@)))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul b7~60@ c7~62@) c7~62@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1371@ temp_7_1~1432@))) (=> (= temp_7_0~1371@ temp_7_1~1432@) (=> (= temp_8_0~1521@ (Add (Mul (Sub (Add a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Sub (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@))) (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ a8~66@))))) (=> (= temp_8_1~1586@ (Add (Mul (Sub (Add a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Sub (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@))) (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ a8~66@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1521@ temp_8_1~1586@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
