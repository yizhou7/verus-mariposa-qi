...
(set-info :comment ";; mariposa_data/4//1687118036349829101/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_1~400@ Int)
(declare-const temp_2_0~493@ Int)
(declare-const temp_2_1~558@ Int)
(declare-const temp_3_0~671@ Int)
(declare-const temp_3_1~748@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Mul (Mul (Add b0~4@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul d0~8@ a0~2@) (Add a0~2@ b0~4@))))) (=> (= temp_0_1~210@ (Mul (Mul (Mul (Add b0~4@ d0~8@) (Mul a0~2@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Add a0~2@ b0~4@) (Mul d0~8@ a0~2@))))) (and (=> (= tmp%1@ (Mul d0~8@ a0~2@)) (=> (= tmp%2@ (Add a0~2@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@))))) (=> (= temp_0_0~145@ temp_0_1~210@) (=> (= temp_1_0~323@ (Mul (Mul (Sub (Mul a1~10@ d1~16@) (Sub b1~12@ d1~16@)) (Mul (Mul 79 d1~16@) (Mul c1~14@ c1~14@))) (Mul (Mul (Add b1~12@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@))))) (=> (= temp_1_1~400@ (Mul (Mul (Sub (Mul d1~16@ a1~10@) (Sub b1~12@ d1~16@)) (Mul (Mul 79 d1~16@) (Mul c1~14@ c1~14@))) (Mul (Mul (Add b1~12@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ d1~16@) (=> %%location_label%%1 (= temp_1_0~323@ temp_1_1~400@))) (=> (= temp_1_0~323@ temp_1_1~400@) (=> (= temp_2_0~493@ (Add (Mul (Mul (Sub a2~18@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ b2~20@))) (Mul (Add (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~558@ (Add (Mul (Mul (Sub a2~18@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ d2~24@))) (Mul (Add (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@))))) (and (=> (= tmp%3@ (Mul b2~20@ d2~24@)) (=> (= tmp%4@ (Mul a2~18@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~493@ temp_2_1~558@))))) (=> (= temp_2_0~493@ temp_2_1~558@) (=> (= temp_3_0~671@ (Mul (Mul (Add (Mul d3~32@ b3~28@) (Sub d3~32@ c3~30@)) (Mul (Add c3~30@ b3~28@) (Sub d3~32@ c3~30@))) (Mul (Sub (Mul c3~30@ 93) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@))))) (=> (= temp_3_1~748@ (Mul (Mul (Sub (Mul c3~30@ 93) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@))) (Mul (Add (Mul d3~32@ b3~28@) (Sub d3~32@ c3~30@)) (Mul (Add c3~30@ b3~28@) (Sub d3~32@ c3~30@))))) (and (=> (= tmp%5@ (Mul (Add (Mul d3~32@ b3~28@) (Sub d3~32@ c3~30@)) (Mul (Add c3~30@ b3~28@) (Sub d3~32@ c3~30@)))) (=> (= tmp%6@ (Mul (Sub (Mul c3~30@ 93) (Mul d3~32@ d3~32@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~671@ temp_3_1~748@))))) (=> (= temp_3_0~671@ temp_3_1~748@) (=> (= temp_4_0~945@ (Mul (Mul (Add (Mul d4~40@ 38) (Mul a4~34@ d4~40@)) (Sub (Add c4~38@ d4~40@) (Add 47 a4~34@))) (Mul (Mul (Mul c4~38@ 37) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@))))) (=> (= temp_4_1~1046@ (Mul (Mul (Mul (Mul c4~38@ 37) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@))) (Mul (Add (Mul d4~40@ 38) (Mul a4~34@ d4~40@)) (Sub (Add c4~38@ d4~40@) (Add 47 a4~34@))))) (and (=> (= tmp%7@ (Mul (Add (Mul d4~40@ 38) (Mul a4~34@ d4~40@)) (Sub (Add c4~38@ d4~40@) (Add 47 a4~34@)))) (=> (= tmp%8@ (Mul (Mul (Mul c4~38@ 37) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~945@ temp_4_1~1046@))))) (=> (= temp_4_0~945@ temp_4_1~1046@) (=> (= temp_5_0~1251@ (Mul (Mul (Mul c5~46@ (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ 25) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul 18 c5~46@)) (Add (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1336@ (Mul (Mul (Mul c5~46@ (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ 25) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ 18)) (Add (Mul b5~44@ a5~42@) (Mul d5~48@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. 18 c5~46@) (=> %%location_label%%5 (= temp_5_0~1251@ temp_5_1~1336@))) (=> (= temp_5_0~1251@ temp_5_1~1336@) (=> (= temp_6_0~1437@ (Mul (Add (Mul (Mul a6~50@ d6~56@) c6~54@) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ c6~54@))) (Add (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ c6~54@))))) (=> (= temp_6_1~1498@ (Mul (Add (Mul (Mul a6~50@ d6~56@) c6~54@) (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@))) (Add (Mul (Mul c6~54@ b6~52@) (Sub a6~50@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b6~52@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1437@ temp_6_1~1498@))) (=> (= temp_6_0~1437@ temp_6_1~1498@) (=> (= temp_7_0~1587@ (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ c7~62@) (Sub b7~60@ b7~60@))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul b7~60@ c7~62@) c7~62@)))) (=> (= temp_7_1~1648@ (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ d7~64@)) (Mul c7~62@ (Mul c7~62@ (Sub b7~60@ b7~60@)))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul b7~60@ c7~62@) c7~62@)))) (and (=> (= tmp%9@ (Sub b7~60@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c7~62@ c7~62@ tmp%9@) (=> %%location_label%%7 (= temp_7_0~1587@ temp_7_1~1648@)))) (=> (= temp_7_0~1587@ temp_7_1~1648@) (=> (= temp_8_0~1747@ (Add (Mul (Sub (Add a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Sub (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@))) (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ a8~66@))))) (=> (= temp_8_1~1812@ (Add (Mul (Sub (Add a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Sub (Mul c8~70@ a8~66@) (Mul b8~68@ b8~68@))) (Add (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ a8~66@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1747@ temp_8_1~1812@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
