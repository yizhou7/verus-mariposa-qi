...
(set-info :comment ";; mariposa_data/4//7774716123002123997/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~307@ Int)
(declare-const temp_1_1~384@ Int)
(declare-const temp_2_0~485@ Int)
(declare-const temp_2_1~550@ Int)
(declare-const temp_3_0~705@ Int)
(declare-const temp_3_1~778@ Int)
...
(declare-const temp_7_0~1429@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~141@ (Mul (Mul (Sub (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Sub b0~4@ d0~8@) (Mul b0~4@ d0~8@))) (Mul (Mul (Add c0~6@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (=> (= temp_0_1~202@ (Mul (Mul (Sub (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ b0~4@))) (Mul (Mul (Add c0~6@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ d0~8@) (=> %%location_label%%0 (= temp_0_0~141@ temp_0_1~202@))) (=> (= temp_0_0~141@ temp_0_1~202@) (=> (= temp_1_0~307@ (Add (Mul (Mul (Sub a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ 84) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~384@ (Add (Mul (Mul (Sub a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ 84) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))))) (and (=> (= tmp%1@ (Mul b1~12@ c1~14@)) (=> (= tmp%2@ (Mul b1~12@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~307@ temp_1_1~384@))))) (=> (= temp_1_0~307@ temp_1_1~384@) (=> (= temp_2_0~485@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~550@ (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@)) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ d2~24@)))))) (and (=> (= tmp%3@ (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@))) (=> (= tmp%4@ (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@))) (=> (= tmp%5@ (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ d2~24@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~485@ temp_2_1~550@)))))) (=> (= temp_2_0~485@ temp_2_1~550@) (=> (= temp_3_0~705@ (Mul (Mul (Mul (Sub c3~30@ c3~30@) (Mul d3~32@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ a3~26@))) (Mul (Mul (Sub b3~28@ c3~30@) (Add d3~32@ a3~26@)) (Sub (Sub d3~32@ 52) d3~32@)))) (=> (= temp_3_1~778@ (Mul (Mul (Mul (Sub c3~30@ c3~30@) (Mul d3~32@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ a3~26@))) (Mul (Sub (Sub d3~32@ 52) d3~32@) (Mul (Sub b3~28@ c3~30@) (Add d3~32@ a3~26@))))) (and (=> (= tmp%6@ (Mul (Sub b3~28@ c3~30@) (Add d3~32@ a3~26@))) (=> (= tmp%7@ (Sub (Sub d3~32@ 52) d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~705@ temp_3_1~778@))))) (=> (= temp_3_0~705@ temp_3_1~778@) (=> (= temp_4_0~915@ (Mul (Mul (Mul (Mul 88 b4~36@) (Mul b4~36@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ b4~36@))) (Mul (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~992@ (Mul (Mul (Mul (Mul 88 b4~36@) (Mul b4~36@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ b4~36@))) (Mul (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ b4~36@))))) (and (=> (= tmp%8@ (Mul a4~34@ b4~36@)) (=> (= tmp%9@ (Mul b4~36@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%4 (= temp_4_0~915@ temp_4_1~992@))))) (=> (= temp_4_0~915@ temp_4_1~992@) (=> (= temp_5_0~1093@ (Sub (Add (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Sub (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Sub d5~48@ d5~48@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1158@ (Sub (Add (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Sub (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@)) (Sub d5~48@ d5~48@)) (Mul a5~42@ d5~48@)))) (and (=> (= tmp%10@ (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@))) (=> (= tmp%11@ (Sub d5~48@ d5~48@)) (=> (= tmp%12@ (Mul a5~42@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%5 (= temp_5_0~1093@ temp_5_1~1158@)))))) (=> (= temp_5_0~1093@ temp_5_1~1158@) (=> (= temp_6_0~1269@ (Mul (Mul (Sub (Mul d6~56@ b6~52@) (Sub a6~50@ b6~52@)) (Mul (Sub c6~54@ b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul d6~56@ (Mul a6~50@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1330@ (Mul (Mul (Sub (Mul d6~56@ b6~52@) (Sub a6~50@ b6~52@)) (Mul (Sub c6~54@ b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul d6~56@ (Mul a6~50@ d6~56@)) (Mul d6~56@ (Mul d6~56@ (Mul a6~50@ a6~50@)))))) (and (=> (= tmp%13@ (Mul a6~50@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d6~56@ d6~56@ tmp%13@) (=> %%location_label%%6 (= temp_6_0~1269@ temp_6_1~1330@)))) (=> (= temp_6_0~1269@ temp_6_1~1330@) (=> (= temp_7_0~1429@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1494@ (Mul (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@)))))) (and (=> (= tmp%14@ (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@))) (=> (= tmp%15@ (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@))) (=> (= tmp%16@ (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%14@ tmp%15@ tmp%16@) (=> %%location_label%%7 (= temp_7_0~1429@ temp_7_1~1494@)))))) (=> (= temp_7_0~1429@ temp_7_1~1494@) (=> (= temp_8_0~1653@ (Add (Sub (Add (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Add b8~68@ d8~72@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul 54 d8~72@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1730@ (Add (Sub (Add (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Add b8~68@ d8~72@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul 54 d8~72@) (Mul a8~66@ a8~66@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ c8~70@) (=> %%location_label%%8 (= temp_8_0~1653@ temp_8_1~1730@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
