...
(assert (=> %%query%% (not (=> (= temp_0_0~141@ (Mul (Mul (Sub (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Sub b0~4@ d0~8@) (Mul b0~4@ d0~8@))) (Mul (Mul (Add c0~6@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (=> (= temp_0_1~202@ (Mul (Mul (Sub (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ b0~4@))) (Mul (Mul (Add c0~6@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~141@ temp_0_1~202@))))))))
(assert %%query%%)
(check-sat)
