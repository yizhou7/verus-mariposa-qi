...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~145@ (Mul (Mul (Sub (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Sub b0~4@ d0~8@) (Mul b0~4@ d0~8@))) (Mul (Mul (Add c0~6@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (=> (= temp_0_1~206@ (Mul (Mul (Sub (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ b0~4@))) (Mul (Mul (Add c0~6@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (=> (= tmp%1@ (= temp_0_0~145@ temp_0_1~206@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~298@ (Add (Mul (Mul (Sub a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ 84) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~375@ (Add (Mul (Mul (Sub a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ 84) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~298@ temp_1_1~375@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~455@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~520@ (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@)) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ d2~24@)))))) (=> (= tmp%3@ (= temp_2_0~455@ temp_2_1~520@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~608@ (Mul (Mul (Mul (Sub c3~30@ c3~30@) (Mul d3~32@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ a3~26@))) (Mul (Mul (Sub b3~28@ c3~30@) (Add d3~32@ a3~26@)) (Sub (Sub d3~32@ 52) d3~32@)))) (=> (= temp_3_1~681@ (Mul (Mul (Mul (Sub c3~30@ c3~30@) (Mul d3~32@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ a3~26@))) (Mul (Sub (Sub d3~32@ 52) d3~32@) (Mul (Sub b3~28@ c3~30@) (Add d3~32@ a3~26@))))) (=> (= tmp%4@ (= temp_3_0~608@ temp_3_1~681@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~773@ (Mul (Mul (Mul (Mul 88 b4~36@) (Mul b4~36@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ b4~36@))) (Mul (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~850@ (Mul (Mul (Mul (Mul 88 b4~36@) (Mul b4~36@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ b4~36@))) (Mul (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~773@ temp_4_1~850@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~930@ (Sub (Add (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Sub (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Sub d5~48@ d5~48@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~995@ (Sub (Add (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Sub (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@)) (Sub d5~48@ d5~48@)) (Mul a5~42@ d5~48@)))) (=> (= tmp%6@ (= temp_5_0~930@ temp_5_1~995@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1071@ (Mul (Mul (Sub (Mul d6~56@ b6~52@) (Sub a6~50@ b6~52@)) (Mul (Sub c6~54@ b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul d6~56@ (Mul a6~50@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1132@ (Mul (Mul (Sub (Mul d6~56@ b6~52@) (Sub a6~50@ b6~52@)) (Mul (Sub c6~54@ b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul d6~56@ (Mul a6~50@ d6~56@)) (Mul d6~56@ (Mul d6~56@ (Mul a6~50@ a6~50@)))))) (=> (= tmp%7@ (= temp_6_0~1071@ temp_6_1~1132@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1212@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1277@ (Mul (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@)))))) (=> (= tmp%8@ (= temp_7_0~1212@ temp_7_1~1277@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1369@ (Add (Sub (Add (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Add b8~68@ d8~72@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul 54 d8~72@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1446@ (Add (Sub (Add (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Add b8~68@ d8~72@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul 54 d8~72@) (Mul a8~66@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1369@ temp_8_1~1446@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
