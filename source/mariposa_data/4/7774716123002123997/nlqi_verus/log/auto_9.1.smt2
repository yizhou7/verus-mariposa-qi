...
(declare-const temp_1_0~303@ Int)
(declare-const temp_1_1~380@ Int)
(declare-const temp_2_0~469@ Int)
(declare-const temp_2_1~534@ Int)
(declare-const temp_3_0~631@ Int)
(declare-const temp_3_1~704@ Int)
...
(declare-const temp_6_1~1182@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~141@ (Mul (Mul (Sub (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Sub b0~4@ d0~8@) (Mul b0~4@ d0~8@))) (Mul (Mul (Add c0~6@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (=> (= temp_0_1~202@ (Mul (Mul (Sub (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)) (Mul (Sub b0~4@ d0~8@) (Mul d0~8@ b0~4@))) (Mul (Mul (Add c0~6@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Add a0~2@ d0~8@) b0~4@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~141@ temp_0_1~202@))) (=> (= temp_0_0~141@ temp_0_1~202@) (=> (= temp_1_0~303@ (Add (Mul (Mul (Sub a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ 84) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~380@ (Add (Mul (Mul (Sub a1~10@ a1~10@) (Mul a1~10@ d1~16@)) (Mul (Mul c1~14@ 84) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~303@ temp_1_1~380@))) (=> (= temp_1_0~303@ temp_1_1~380@) (=> (= temp_2_0~469@ (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ d2~24@))))) (=> (= temp_2_1~534@ (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@)) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ d2~24@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~469@ temp_2_1~534@))) (=> (= temp_2_0~469@ temp_2_1~534@) (=> (= temp_3_0~631@ (Mul (Mul (Mul (Sub c3~30@ c3~30@) (Mul d3~32@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ a3~26@))) (Mul (Mul (Sub b3~28@ c3~30@) (Add d3~32@ a3~26@)) (Sub (Sub d3~32@ 52) d3~32@)))) (=> (= temp_3_1~704@ (Mul (Mul (Mul (Sub c3~30@ c3~30@) (Mul d3~32@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ a3~26@))) (Mul (Sub (Sub d3~32@ 52) d3~32@) (Mul (Sub b3~28@ c3~30@) (Add d3~32@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~631@ temp_3_1~704@))) (=> (= temp_3_0~631@ temp_3_1~704@) (=> (= temp_4_0~805@ (Mul (Mul (Mul (Mul 88 b4~36@) (Mul b4~36@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ b4~36@))) (Mul (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~882@ (Mul (Mul (Mul (Mul 88 b4~36@) (Mul b4~36@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ b4~36@))) (Mul (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~805@ temp_4_1~882@))) (=> (= temp_4_0~805@ temp_4_1~882@) (=> (= temp_5_0~971@ (Sub (Add (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Sub (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Sub d5~48@ d5~48@) (Mul a5~42@ d5~48@))))) (=> (= temp_5_1~1036@ (Sub (Add (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ b5~44@)) (Sub (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))) (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@)) (Sub d5~48@ d5~48@)) (Mul a5~42@ d5~48@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~971@ temp_5_1~1036@))) (=> (= temp_5_0~971@ temp_5_1~1036@) (=> (= temp_6_0~1121@ (Mul (Mul (Sub (Mul d6~56@ b6~52@) (Sub a6~50@ b6~52@)) (Mul (Sub c6~54@ b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul d6~56@ (Mul a6~50@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1182@ (Mul (Mul (Sub (Mul d6~56@ b6~52@) (Sub a6~50@ b6~52@)) (Mul (Sub c6~54@ b6~52@) (Mul d6~56@ d6~56@))) (Mul (Mul d6~56@ (Mul a6~50@ d6~56@)) (Mul d6~56@ (Mul d6~56@ (Mul a6~50@ a6~50@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1121@ temp_6_1~1182@))) (=> (= temp_6_0~1121@ temp_6_1~1182@) (=> (= temp_7_0~1271@ (Mul (Mul (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1336@ (Mul (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@)) (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1271@ temp_7_1~1336@))) (=> (= temp_7_0~1271@ temp_7_1~1336@) (=> (= temp_8_0~1437@ (Add (Sub (Add (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Add b8~68@ d8~72@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul 54 d8~72@) (Mul a8~66@ a8~66@))))) (=> (= temp_8_1~1514@ (Add (Sub (Add (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Add b8~68@ d8~72@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ b8~68@)) (Mul (Mul 54 d8~72@) (Mul a8~66@ a8~66@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1437@ temp_8_1~1514@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
