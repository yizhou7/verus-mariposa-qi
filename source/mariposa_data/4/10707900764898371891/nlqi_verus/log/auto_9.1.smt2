...
(declare-const temp_2_0~453@ Int)
...
(declare-const temp_5_0~959@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Sub (Add (Mul (Mul b0~4@ c0~6@) (Add d0~8@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ b0~4@))) (Mul (Mul (Sub c0~6@ a0~2@) (Mul a0~2@ c0~6@)) (Sub (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~210@ (Sub (Add (Mul (Mul b0~4@ c0~6@) (Add d0~8@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ b0~4@))) (Mul (Sub (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@)) (Mul (Sub c0~6@ a0~2@) (Mul a0~2@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@))) (=> (= temp_0_0~145@ temp_0_1~210@) (=> (= temp_1_0~295@ (Mul (Sub (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ a1~10@)) (Sub (Mul a1~10@ c1~14@) (Mul a1~10@ d1~16@))) (Mul (Mul a1~10@ (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@))))) (=> (= temp_1_1~356@ (Mul (Sub (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ b1~12@)) (Sub (Mul a1~10@ c1~14@) (Mul a1~10@ d1~16@))) (Mul (Mul a1~10@ (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~295@ temp_1_1~356@))) (=> (= temp_1_0~295@ temp_1_1~356@) (=> (= temp_2_0~453@ (Mul (Mul (Mul (Sub d2~24@ a2~18@) (Sub c2~22@ d2~24@)) (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Mul c2~22@ (Mul 96 a2~18@)) (Sub (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~526@ (Mul (Mul (Mul (Sub d2~24@ a2~18@) (Sub c2~22@ d2~24@)) (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Mul c2~22@ (Mul 96 a2~18@)) (Sub (Mul a2~18@ c2~22@) (Mul a2~18@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~453@ temp_2_1~526@))) (=> (= temp_2_0~453@ temp_2_1~526@) (=> (= temp_3_0~627@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ d3~32@)) d3~32@) (Mul (Sub (Mul 22 a3~26@) (Mul c3~30@ d3~32@)) (Mul (Mul b3~28@ 71) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~704@ (Mul (Mul (Mul a3~26@ b3~28@) (Mul (Mul b3~28@ d3~32@) d3~32@)) (Mul (Sub (Mul 22 a3~26@) (Mul c3~30@ d3~32@)) (Mul (Mul b3~28@ 71) (Mul b3~28@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~627@ temp_3_1~704@))) (=> (= temp_3_0~627@ temp_3_1~704@) (=> (= temp_4_0~805@ (Add (Sub (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@)) (Mul (Mul b4~36@ 28) (Add d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~882@ (Add (Sub (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@)) (Mul (Mul b4~36@ 28) (Add d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~805@ temp_4_1~882@))) (=> (= temp_4_0~805@ temp_4_1~882@) (=> (= temp_5_0~959@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ a5~42@)) b5~44@))) (=> (= temp_5_1~1012@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@)) (Mul c5~46@ (Mul d5~48@ (Mul c5~46@ c5~46@)))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ a5~42@)) b5~44@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~959@ temp_5_1~1012@))) (=> (= temp_5_0~959@ temp_5_1~1012@) (=> (= temp_6_0~1097@ (Mul (Mul (Mul b6~52@ (Add d6~56@ c6~54@)) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ b6~52@))) (Mul (Mul (Add c6~54@ a6~50@) (Mul b6~52@ a6~50@)) (Sub (Mul a6~50@ c6~54@) (Sub a6~50@ c6~54@))))) (=> (= temp_6_1~1174@ (Mul (Mul (Mul b6~52@ (Add d6~56@ c6~54@)) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ b6~52@))) (Sub (Mul (Mul (Add c6~54@ a6~50@) (Mul b6~52@ a6~50@)) (Mul a6~50@ c6~54@)) (Mul (Mul (Add c6~54@ a6~50@) (Mul b6~52@ a6~50@)) (Sub a6~50@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1097@ temp_6_1~1174@))) (=> (= temp_6_0~1097@ temp_6_1~1174@) (=> (= temp_7_0~1235@ (Mul d7~64@ (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Sub c7~62@ d7~64@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1272@ (Mul d7~64@ (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Sub c7~62@ d7~64@) (Mul d7~64@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1235@ temp_7_1~1272@))) (=> (= temp_7_0~1235@ temp_7_1~1272@) (=> (= temp_8_0~1361@ (Mul (Mul (Mul (Add d8~72@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1426@ (Mul (Mul (Mul (Add d8~72@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1361@ temp_8_1~1426@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
