...
(set-info :comment ";; mariposa_data/4//10707900764898371891/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_4_0~855@ Int)
(declare-const temp_4_1~932@ Int)
(declare-const temp_5_0~1021@ Int)
(declare-const temp_5_1~1074@ Int)
(declare-const temp_6_0~1169@ Int)
(declare-const temp_6_1~1246@ Int)
(declare-const temp_7_0~1333@ Int)
(declare-const temp_7_1~1370@ Int)
(declare-const temp_8_0~1463@ Int)
(declare-const temp_8_1~1528@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Sub (Add (Mul (Mul b0~4@ c0~6@) (Add d0~8@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ b0~4@))) (Mul (Mul (Sub c0~6@ a0~2@) (Mul a0~2@ c0~6@)) (Sub (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@))))) (=> (= temp_0_1~210@ (Sub (Add (Mul (Mul b0~4@ c0~6@) (Add d0~8@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ b0~4@))) (Mul (Sub (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@)) (Mul (Sub c0~6@ a0~2@) (Mul a0~2@ c0~6@))))) (and (=> (= tmp%1@ (Mul (Sub c0~6@ a0~2@) (Mul a0~2@ c0~6@))) (=> (= tmp%2@ (Sub (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@))))) (=> (= temp_0_0~145@ temp_0_1~210@) (=> (= temp_1_0~323@ (Mul (Sub (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ a1~10@)) (Sub (Mul a1~10@ c1~14@) (Mul a1~10@ d1~16@))) (Mul (Mul a1~10@ (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@))))) (=> (= temp_1_1~384@ (Mul (Sub (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ b1~12@)) (Sub (Mul a1~10@ c1~14@) (Mul a1~10@ d1~16@))) (Mul (Mul a1~10@ (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b1~12@ a1~10@) (=> %%location_label%%1 (= temp_1_0~323@ temp_1_1~384@))) (=> (= temp_1_0~323@ temp_1_1~384@) (=> (= temp_2_0~485@ (Mul (Mul (Mul (Sub d2~24@ a2~18@) (Sub c2~22@ d2~24@)) (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Mul c2~22@ (Mul 96 a2~18@)) (Sub (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@))))) (=> (= temp_2_1~558@ (Mul (Mul (Mul (Sub d2~24@ a2~18@) (Sub c2~22@ d2~24@)) (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ b2~20@))) (Mul (Mul c2~22@ (Mul 96 a2~18@)) (Sub (Mul a2~18@ c2~22@) (Mul a2~18@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ a2~18@) (=> %%location_label%%2 (= temp_2_0~485@ temp_2_1~558@))) (=> (= temp_2_0~485@ temp_2_1~558@) (=> (= temp_3_0~663@ (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ d3~32@)) d3~32@) (Mul (Sub (Mul 22 a3~26@) (Mul c3~30@ d3~32@)) (Mul (Mul b3~28@ 71) (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~740@ (Mul (Mul (Mul a3~26@ b3~28@) (Mul (Mul b3~28@ d3~32@) d3~32@)) (Mul (Sub (Mul 22 a3~26@) (Mul c3~30@ d3~32@)) (Mul (Mul b3~28@ 71) (Mul b3~28@ a3~26@))))) (and (=> (= tmp%3@ (Mul a3~26@ b3~28@)) (=> (= tmp%4@ (Mul b3~28@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ tmp%4@ d3~32@) (=> %%location_label%%3 (= temp_3_0~663@ temp_3_1~740@))))) (=> (= temp_3_0~663@ temp_3_1~740@) (=> (= temp_4_0~855@ (Add (Sub (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@)) (Mul (Mul b4~36@ 28) (Add d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@))))) (=> (= temp_4_1~932@ (Add (Sub (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@)) (Mul (Mul b4~36@ 28) (Add d4~40@ b4~36@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@))))) (and (=> (= tmp%5@ (Mul d4~40@ d4~40@)) (=> (= tmp%6@ (Mul a4~34@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%4 (= temp_4_0~855@ temp_4_1~932@))))) (=> (= temp_4_0~855@ temp_4_1~932@) (=> (= temp_5_0~1021@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ a5~42@)) b5~44@))) (=> (= temp_5_1~1074@ (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Add d5~48@ a5~42@)) (Mul c5~46@ (Mul d5~48@ (Mul c5~46@ c5~46@)))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ a5~42@)) b5~44@))) (and (=> (= tmp%7@ (Mul c5~46@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c5~46@ d5~48@ tmp%7@) (=> %%location_label%%5 (= temp_5_0~1021@ temp_5_1~1074@)))) (=> (= temp_5_0~1021@ temp_5_1~1074@) (=> (= temp_6_0~1169@ (Mul (Mul (Mul b6~52@ (Add d6~56@ c6~54@)) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ b6~52@))) (Mul (Mul (Add c6~54@ a6~50@) (Mul b6~52@ a6~50@)) (Sub (Mul a6~50@ c6~54@) (Sub a6~50@ c6~54@))))) (=> (= temp_6_1~1246@ (Mul (Mul (Mul b6~52@ (Add d6~56@ c6~54@)) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ b6~52@))) (Sub (Mul (Mul (Add c6~54@ a6~50@) (Mul b6~52@ a6~50@)) (Mul a6~50@ c6~54@)) (Mul (Mul (Add c6~54@ a6~50@) (Mul b6~52@ a6~50@)) (Sub a6~50@ c6~54@))))) (and (=> (= tmp%8@ (Mul (Add c6~54@ a6~50@) (Mul b6~52@ a6~50@))) (=> (= tmp%9@ (Mul a6~50@ c6~54@)) (=> (= tmp%10@ (Sub a6~50@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~1169@ temp_6_1~1246@)))))) (=> (= temp_6_0~1169@ temp_6_1~1246@) (=> (= temp_7_0~1333@ (Mul d7~64@ (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Sub c7~62@ d7~64@) (Mul d7~64@ b7~60@))))) (=> (= temp_7_1~1370@ (Mul d7~64@ (Mul (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Sub c7~62@ d7~64@) (Mul d7~64@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ a7~58@) (=> %%location_label%%7 (= temp_7_0~1333@ temp_7_1~1370@))) (=> (= temp_7_0~1333@ temp_7_1~1370@) (=> (= temp_8_0~1463@ (Mul (Mul (Mul (Add d8~72@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1528@ (Mul (Mul (Mul (Add d8~72@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@))))) (=> (= tmp%11@ (Mul b8~68@ d8~72@)) (=> (= tmp%12@ (Mul c8~70@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%8 (= temp_8_0~1463@ temp_8_1~1528@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
