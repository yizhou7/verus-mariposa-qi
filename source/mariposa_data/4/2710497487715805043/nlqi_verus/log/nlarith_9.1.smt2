...
(declare-const temp_6_0~951@ Int)
(declare-const temp_6_1~1016@ Int)
(declare-const temp_7_0~1092@ Int)
(declare-const temp_7_1~1153@ Int)
(declare-const temp_8_0~1229@ Int)
(declare-const temp_8_1~1290@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~137@ (Mul (Sub (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul c0~6@ d0~8@) c0~6@) (Mul (Mul d0~8@ a0~2@) b0~4@)))) (=> (= temp_0_1~194@ (Mul (Sub (Mul d0~8@ (Mul d0~8@ (Mul a0~2@ d0~8@))) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul c0~6@ d0~8@) c0~6@) (Mul (Mul d0~8@ a0~2@) b0~4@)))) (=> (= tmp%1@ (= temp_0_0~137@ temp_0_1~194@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~262@ (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul c1~14@ b1~12@)) d1~16@) (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Add b1~12@ b1~12@) (Mul a1~10@ d1~16@))))) (=> (= temp_1_1~315@ (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul c1~14@ b1~12@)) d1~16@) (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Add b1~12@ b1~12@) (Mul d1~16@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~262@ temp_1_1~315@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~395@ (Add (Add (Add (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Sub c2~22@ d2~24@))))) (=> (= temp_2_1~460@ (Add (Add (Add (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ c2~22@)) (Mul c2~22@ (Mul b2~20@ (Sub c2~22@ d2~24@)))))) (=> (= tmp%3@ (= temp_2_0~395@ temp_2_1~460@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~540@ (Sub (Mul (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Sub a3~26@ b3~28@))))) (=> (= temp_3_1~605@ (Sub (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Sub a3~26@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~540@ temp_3_1~605@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~673@ (Sub (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@))) (Mul a4~34@ (Sub (Mul b4~36@ c4~38@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~726@ (Sub (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@))) (Mul a4~34@ (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~673@ temp_4_1~726@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~806@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Sub (Mul c5~46@ a5~42@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Add a5~42@ b5~44@)) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~871@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Sub (Mul c5~46@ a5~42@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Add a5~42@ b5~44@)) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~806@ temp_5_1~871@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~951@ (Mul (Sub (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ 70)) (Mul (Mul a6~50@ a6~50@) (Sub a6~50@ d6~56@))) (Mul (Add (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) a6~50@))) (=> (= temp_6_1~1016@ (Mul (Sub (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ 70)) (Mul (Sub a6~50@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Add (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) a6~50@))) (=> (= tmp%7@ (= temp_6_0~951@ temp_6_1~1016@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1092@ (Add (Sub (Mul (Sub d7~64@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Sub d7~64@ c7~62@) (Mul b7~60@ d7~64@))) (Add (Mul (Mul c7~62@ d7~64@) (Sub d7~64@ a7~58@)) (Mul c7~62@ (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1153@ (Add (Sub (Mul (Sub d7~64@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Sub d7~64@ c7~62@) (Mul b7~60@ d7~64@))) (Add (Mul (Mul d7~64@ c7~62@) (Sub d7~64@ a7~58@)) (Mul c7~62@ (Mul a7~58@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1092@ temp_7_1~1153@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1229@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@)) (Mul a8~66@ (Sub d8~72@ b8~68@))) (Mul (Add (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1290@ (Mul (Mul (Mul a8~66@ (Sub d8~72@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@))) (Mul (Add (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1229@ temp_8_1~1290@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
