...
(assert (=> %%query%% (not (=> (= temp_0_0~137@ (Mul (Sub (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul c0~6@ d0~8@) c0~6@) (Mul (Mul d0~8@ a0~2@) b0~4@)))) (=> (= temp_0_1~194@ (Mul (Sub (Mul d0~8@ (Mul d0~8@ (Mul a0~2@ d0~8@))) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul c0~6@ d0~8@) c0~6@) (Mul (Mul d0~8@ a0~2@) b0~4@)))) (and (=> (= tmp%1@ (Mul a0~2@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d0~8@ d0~8@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~137@ temp_0_1~194@)))) (=> (= temp_0_0~137@ temp_0_1~194@) (=> (= temp_1_0~281@ (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul c1~14@ b1~12@)) d1~16@) (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Add b1~12@ b1~12@) (Mul a1~10@ d1~16@))))) (=> (= temp_1_1~334@ (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul c1~14@ b1~12@)) d1~16@) (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Add b1~12@ b1~12@) (Mul d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ d1~16@) (=> %%location_label%%1 (= temp_1_0~281@ temp_1_1~334@))) (=> (= temp_1_0~281@ temp_1_1~334@) (=> (= temp_2_0~427@ (Add (Add (Add (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Sub c2~22@ d2~24@))))) (=> (= temp_2_1~492@ (Add (Add (Add (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ c2~22@)) (Mul c2~22@ (Mul b2~20@ (Sub c2~22@ d2~24@)))))) (=> (= tmp%2@ (Sub c2~22@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. c2~22@ b2~20@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~427@ temp_2_1~492@)))))))))))))))))
(assert %%query%%)
(check-sat)
