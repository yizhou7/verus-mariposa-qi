...
(declare-const temp_2_1~478@ Int)
...
(declare-const temp_6_0~1005@ Int)
(declare-const temp_6_1~1070@ Int)
(declare-const temp_7_0~1155@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~137@ (Mul (Sub (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul c0~6@ d0~8@) c0~6@) (Mul (Mul d0~8@ a0~2@) b0~4@)))) (=> (= temp_0_1~194@ (Mul (Sub (Mul d0~8@ (Mul d0~8@ (Mul a0~2@ d0~8@))) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul c0~6@ d0~8@) c0~6@) (Mul (Mul d0~8@ a0~2@) b0~4@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~137@ temp_0_1~194@))) (=> (= temp_0_0~137@ temp_0_1~194@) (=> (= temp_1_0~271@ (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul c1~14@ b1~12@)) d1~16@) (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Add b1~12@ b1~12@) (Mul a1~10@ d1~16@))))) (=> (= temp_1_1~324@ (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul c1~14@ b1~12@)) d1~16@) (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Add b1~12@ b1~12@) (Mul d1~16@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~271@ temp_1_1~324@))) (=> (= temp_1_0~271@ temp_1_1~324@) (=> (= temp_2_0~413@ (Add (Add (Add (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Sub c2~22@ d2~24@))))) (=> (= temp_2_1~478@ (Add (Add (Add (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ c2~22@)) (Mul c2~22@ (Mul b2~20@ (Sub c2~22@ d2~24@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~413@ temp_2_1~478@))) (=> (= temp_2_0~413@ temp_2_1~478@) (=> (= temp_3_0~567@ (Sub (Mul (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Sub a3~26@ b3~28@))))) (=> (= temp_3_1~632@ (Sub (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Sub a3~26@ b3~28@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~567@ temp_3_1~632@))) (=> (= temp_3_0~567@ temp_3_1~632@) (=> (= temp_4_0~709@ (Sub (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@))) (Mul a4~34@ (Sub (Mul b4~36@ c4~38@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~762@ (Sub (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@))) (Mul a4~34@ (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~709@ temp_4_1~762@))) (=> (= temp_4_0~709@ temp_4_1~762@) (=> (= temp_5_0~851@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Sub (Mul c5~46@ a5~42@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Add a5~42@ b5~44@)) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~916@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Sub (Mul c5~46@ a5~42@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Add a5~42@ b5~44@)) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~851@ temp_5_1~916@))) (=> (= temp_5_0~851@ temp_5_1~916@) (=> (= temp_6_0~1005@ (Mul (Sub (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ 70)) (Mul (Mul a6~50@ a6~50@) (Sub a6~50@ d6~56@))) (Mul (Add (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) a6~50@))) (=> (= temp_6_1~1070@ (Mul (Sub (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ 70)) (Mul (Sub a6~50@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Add (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) a6~50@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1005@ temp_6_1~1070@))) (=> (= temp_6_0~1005@ temp_6_1~1070@) (=> (= temp_7_0~1155@ (Add (Sub (Mul (Sub d7~64@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Sub d7~64@ c7~62@) (Mul b7~60@ d7~64@))) (Add (Mul (Mul c7~62@ d7~64@) (Sub d7~64@ a7~58@)) (Mul c7~62@ (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1216@ (Add (Sub (Mul (Sub d7~64@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Sub d7~64@ c7~62@) (Mul b7~60@ d7~64@))) (Add (Mul (Mul d7~64@ c7~62@) (Sub d7~64@ a7~58@)) (Mul c7~62@ (Mul a7~58@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1155@ temp_7_1~1216@))) (=> (= temp_7_0~1155@ temp_7_1~1216@) (=> (= temp_8_0~1301@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@)) (Mul a8~66@ (Sub d8~72@ b8~68@))) (Mul (Add (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1362@ (Mul (Mul (Mul a8~66@ (Sub d8~72@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@))) (Mul (Add (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ c8~70@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1301@ temp_8_1~1362@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
