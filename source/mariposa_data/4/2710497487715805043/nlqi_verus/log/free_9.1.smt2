...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~141@ (Mul (Sub (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul c0~6@ d0~8@) c0~6@) (Mul (Mul d0~8@ a0~2@) b0~4@)))) (=> (= temp_0_1~198@ (Mul (Sub (Mul d0~8@ (Mul d0~8@ (Mul a0~2@ d0~8@))) (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul c0~6@ d0~8@) c0~6@) (Mul (Mul d0~8@ a0~2@) b0~4@)))) (=> (= tmp%1@ (= temp_0_0~141@ temp_0_1~198@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~266@ (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul c1~14@ b1~12@)) d1~16@) (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Add b1~12@ b1~12@) (Mul a1~10@ d1~16@))))) (=> (= temp_1_1~319@ (Mul (Mul (Sub (Mul a1~10@ b1~12@) (Mul c1~14@ b1~12@)) d1~16@) (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Add b1~12@ b1~12@) (Mul d1~16@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~266@ temp_1_1~319@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~399@ (Add (Add (Add (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Sub c2~22@ d2~24@))))) (=> (= temp_2_1~464@ (Add (Add (Add (Mul a2~18@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul a2~18@ b2~20@) (Mul b2~20@ c2~22@)) (Mul c2~22@ (Mul b2~20@ (Sub c2~22@ d2~24@)))))) (=> (= tmp%3@ (= temp_2_0~399@ temp_2_1~464@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~544@ (Sub (Mul (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Sub a3~26@ b3~28@))))) (=> (= temp_3_1~609@ (Sub (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Sub a3~26@ b3~28@))))) (=> (= tmp%4@ (= temp_3_0~544@ temp_3_1~609@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~677@ (Sub (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@))) (Mul a4~34@ (Sub (Mul b4~36@ c4~38@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~730@ (Sub (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@))) (Mul a4~34@ (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@))))) (=> (= tmp%5@ (= temp_4_0~677@ temp_4_1~730@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~810@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Sub (Mul c5~46@ a5~42@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Add a5~42@ b5~44@)) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= temp_5_1~875@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)) (Sub (Mul c5~46@ a5~42@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul c5~46@ d5~48@) (Add a5~42@ b5~44@)) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~810@ temp_5_1~875@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~955@ (Mul (Sub (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ 70)) (Mul (Mul a6~50@ a6~50@) (Sub a6~50@ d6~56@))) (Mul (Add (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) a6~50@))) (=> (= temp_6_1~1020@ (Mul (Sub (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ 70)) (Mul (Sub a6~50@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Add (Mul a6~50@ a6~50@) (Mul b6~52@ c6~54@)) a6~50@))) (=> (= tmp%7@ (= temp_6_0~955@ temp_6_1~1020@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1096@ (Add (Sub (Mul (Sub d7~64@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Sub d7~64@ c7~62@) (Mul b7~60@ d7~64@))) (Add (Mul (Mul c7~62@ d7~64@) (Sub d7~64@ a7~58@)) (Mul c7~62@ (Mul a7~58@ b7~60@))))) (=> (= temp_7_1~1157@ (Add (Sub (Mul (Sub d7~64@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Sub d7~64@ c7~62@) (Mul b7~60@ d7~64@))) (Add (Mul (Mul d7~64@ c7~62@) (Sub d7~64@ a7~58@)) (Mul c7~62@ (Mul a7~58@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1096@ temp_7_1~1157@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1233@ (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@)) (Mul a8~66@ (Sub d8~72@ b8~68@))) (Mul (Add (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ c8~70@))))) (=> (= temp_8_1~1294@ (Mul (Mul (Mul a8~66@ (Sub d8~72@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@))) (Mul (Add (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1233@ temp_8_1~1294@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
