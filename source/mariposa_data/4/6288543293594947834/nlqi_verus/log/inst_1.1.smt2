...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Mul (Add (Mul (Mul d0~8@ c0~6@) (Sub d0~8@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) (Add d0~8@ b0~4@)) a0~2@))) (=> (= temp_0_1~186@ (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Add d0~8@ b0~4@)) a0~2@) (Add (Mul (Mul d0~8@ c0~6@) (Sub d0~8@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@))))) (=> (= tmp%1@ (Add (Mul (Mul d0~8@ c0~6@) (Sub d0~8@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@)))) (=> (= tmp%2@ (Mul (Mul (Mul d0~8@ b0~4@) (Add d0~8@ b0~4@)) a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~133@ temp_0_1~186@))))))))))
(assert %%query%%)
(check-sat)
