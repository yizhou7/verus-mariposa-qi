...
;; mariposa_data/4//6288543293594947834/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_2_0~431@ Int)
 (declare-const temp_2_1~496@ Int)
 (declare-const temp_3_0~584@ Int)
 (declare-const temp_3_1~665@ Int)
 (declare-const temp_4_0~741@ Int)
 (declare-const temp_4_1~802@ Int)
 (declare-const temp_5_0~878@ Int)
 (declare-const temp_5_1~939@ Int)
 (declare-const temp_6_0~1019@ Int)
 (declare-const temp_6_1~1080@ Int)
 (declare-const temp_7_0~1160@ Int)
 (declare-const temp_7_1~1225@ Int)
 (declare-const temp_8_0~1305@ Int)
 (declare-const temp_8_1~1370@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~137@ (Mul (Add (Mul (Mul d0~8@ c0~6@) (Sub d0~8@ d0~8@)) (Mul (Mul a0~2@ a0~2@)
          (Mul a0~2@ b0~4@)
         )
        ) (Mul (Mul (Mul d0~8@ b0~4@) (Add d0~8@ b0~4@)) a0~2@)
      ))
      (=>
       (= temp_0_1~190@ (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Add d0~8@ b0~4@)) a0~2@) (Add (Mul
           (Mul d0~8@ c0~6@) (Sub d0~8@ d0~8@)
          ) (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@))
       )))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~278@ (Mul (Mul (Mul (Mul d1~16@ b1~12@) a1~10@) (Mul (Add c1~14@ b1~12@)
               (Mul a1~10@ a1~10@)
              )
             ) (Mul (Mul (Add b1~12@ b1~12@) (Mul a1~10@ 41)) (Mul (Sub c1~14@ d1~16@) (Mul d1~16@
                b1~12@
           )))))
           (=>
            (= temp_1_1~351@ (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ (Mul (Add c1~14@ b1~12@) (Mul
                  a1~10@ a1~10@
               )))
              ) (Mul (Mul (Add b1~12@ b1~12@) (Mul a1~10@ 41)) (Mul (Sub c1~14@ d1~16@) (Mul d1~16@
                 b1~12@
            ...
            (=>
             (= tmp%2@ (= temp_1_0~278@ temp_1_1~351@))
             (and
              (=>
               %%location_label%%1
               tmp%2@
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~431@ (Add (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@
                     a2~18@
                    ) (Mul d2~24@ a2~18@)
                   )
                  ) (Mul (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ c2~22@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@
                     d2~24@
                )))))
                (=>
                 (= temp_2_1~496@ (Add (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@
                      a2~18@
                     ) (Mul d2~24@ a2~18@)
                    )
                   ) (Mul (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@
                      c2~22@
                 )))))
                 (=>
                  (= tmp%3@ (= temp_2_0~431@ temp_2_1~496@))
                  (and
                   (=>
                    %%location_label%%2
                    tmp%3@
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~584@ (Mul (Mul (Mul (Sub d3~32@ d3~32@) (Mul d3~32@ a3~26@)) (Mul (Mul 1 b3~28@)
                         (Add a3~26@ c3~30@)
                        )
                       ) (Mul (Mul (Sub b3~28@ b3~28@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ b3~28@) c3~30@))
                     ))
                     (=>
                      (= temp_3_1~665@ (Mul (Mul (Sub (Mul d3~32@ (Mul d3~32@ a3~26@)) (Mul d3~32@ (Mul d3~32@
                            a3~26@
                          ))
                         ) (Mul (Mul 1 b3~28@) (Add a3~26@ c3~30@))
                        ) (Mul (Mul (Sub b3~28@ b3~28@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ b3~28@) c3~30@))
                      ))
                      (=>
                       (= tmp%4@ (= temp_3_0~584@ temp_3_1~665@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~741@ (Mul (Mul (Mul (Add a4~34@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Sub d4~40@
                               d4~40@
                              ) (Add c4~38@ d4~40@)
                             )
                            ) (Sub (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ b4~36@)) (Add a4~34@ (Mul d4~40@ d4~40@)))
                          ))
                          (=>
                           (= temp_4_1~802@ (Mul (Sub (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ b4~36@)) (Add a4~34@
                               (Mul d4~40@ d4~40@)
                              )
                             ) (Mul (Mul (Add a4~34@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Sub d4~40@ d4~40@) (Add c4~38@
                                d4~40@
                           )))))
                           (=>
                            (= tmp%5@ (= temp_4_0~741@ temp_4_1~802@))
                            (and
                             (=>
                              %%location_label%%4
                              tmp%5@
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~878@ (Mul (Mul (Mul (Sub d5~48@ c5~46@) (Mul a5~42@ a5~42@)) (Mul d5~48@
                                   (Mul c5~46@ d5~48@)
                                  )
                                 ) (Mul (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ b5~44@)) (Mul (Mul d5~48@ a5~42@) (Mul b5~44@
                                    b5~44@
                               )))))
                               (=>
                                (= temp_5_1~939@ (Mul (Mul (Mul (Mul (Sub d5~48@ c5~46@) a5~42@) a5~42@) (Mul d5~48@
                                    (Mul c5~46@ d5~48@)
                                   )
                                  ) (Mul (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ b5~44@)) (Mul (Mul d5~48@ a5~42@) (Mul b5~44@
                                     b5~44@
                                ...
                                (=>
                                 (= tmp%6@ (= temp_5_0~878@ temp_5_1~939@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~1019@ (Mul (Mul (Sub (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@)) (Mul (Sub c6~54@
                                         b6~52@
                                        ) (Sub d6~56@ b6~52@)
                                       )
                                      ) (Mul (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Mul a6~50@
                                         a6~50@
                                    )))))
                                    (=>
                                     (= temp_6_1~1080@ (Mul (Mul (Mul c6~54@ (Sub c6~54@ b6~52@)) (Mul (Sub c6~54@ b6~52@)
                                         (Sub d6~56@ b6~52@)
                                        )
                                       ) (Mul (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ c6~54@)) (Mul (Mul c6~54@ b6~52@) (Mul a6~50@
                                          a6~50@
                                     ...
                                     (=>
                                      (= tmp%7@ (= temp_6_0~1019@ temp_6_1~1080@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~1160@ (Sub (Mul (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ c7~62@)) (Sub (Mul a7~58@
                                              b7~60@
                                             ) (Mul c7~62@ b7~60@)
                                            )
                                           ) (Mul (Sub (Mul d7~64@ c7~62@) (Mul d7~64@ b7~60@)) (Mul (Add d7~64@ b7~60@) (Add d7~64@
                                              c7~62@
                                         )))))
                                         (=>
                                          (= temp_7_1~1225@ (Sub (Mul (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ c7~62@)) (Sub (Mul a7~58@
                                               b7~60@
                                              ) (Mul b7~60@ c7~62@)
                                             )
                                            ) (Mul (Sub (Mul d7~64@ c7~62@) (Mul d7~64@ b7~60@)) (Mul (Add d7~64@ b7~60@) (Add d7~64@
                                          ...
                                          (=>
                                           (= tmp%8@ (= temp_7_0~1160@ temp_7_1~1225@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~1305@ (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul c8~70@
                                                   b8~68@
                                                  ) (Mul b8~68@ d8~72@)
                                                 )
                                                ) (Mul (Mul (Sub d8~72@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@
                                                   b8~68@
                                              )))))
                                              (=>
                                               (= temp_8_1~1370@ (Mul (Mul (Mul (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul
                                                     c8~70@ b8~68@
                                                    ) (Mul b8~68@ d8~72@)
                                                   )
                                                  ) (Mul (Sub d8~72@ c8~70@) (Mul d8~72@ b8~68@))
                                                 ) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ b8~68@))
                                               ))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~1305@ temp_8_1~1370@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
