...
(set-info :comment ";; mariposa_data/4//8123182363311204711/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~271@ Int)
(declare-const temp_1_1~336@ Int)
(declare-const temp_2_0~437@ Int)
(declare-const temp_2_1~510@ Int)
(declare-const temp_3_0~601@ Int)
(declare-const temp_3_1~642@ Int)
(declare-const temp_4_0~757@ Int)
(declare-const temp_4_1~830@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~129@ (Add (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@)) b0~4@) (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ d0~8@)) (Add c0~6@ (Sub a0~2@ b0~4@))))) (=> (= temp_0_1~178@ (Add (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@)) b0~4@) (Mul (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ d0~8@)) (Add c0~6@ (Sub a0~2@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ a0~2@) (=> %%location_label%%0 (= temp_0_0~129@ temp_0_1~178@))) (=> (= temp_0_0~129@ temp_0_1~178@) (=> (= temp_1_0~271@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Add c1~14@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@))))) (=> (= temp_1_1~336@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Add c1~14@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ c1~14@) (=> %%location_label%%1 (= temp_1_0~271@ temp_1_1~336@))) (=> (= temp_1_0~271@ temp_1_1~336@) (=> (= temp_2_0~437@ (Mul (Mul (Mul a2~18@ (Sub c2~22@ d2~24@)) (Mul (Mul 44 a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ c2~22@)) (Add (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~510@ (Mul (Mul (Mul a2~18@ (Sub c2~22@ d2~24@)) (Mul (Mul 44 a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul b2~20@ b2~20@) (Mul (Mul c2~22@ c2~22@) (Add (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@)))))) (and (=> (= tmp%1@ (Mul b2~20@ b2~20@)) (=> (= tmp%2@ (Mul c2~22@ c2~22@)) (=> (= tmp%3@ (Add (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~437@ temp_2_1~510@)))))) (=> (= temp_2_0~437@ temp_2_1~510@) (=> (= temp_3_0~601@ (Mul (Mul (Mul b3~28@ (Mul c3~30@ b3~28@)) c3~30@) (Mul (Mul (Mul d3~32@ b3~28@) d3~32@) (Mul (Mul d3~32@ c3~30@) a3~26@)))) (=> (= temp_3_1~642@ (Mul (Mul (Mul b3~28@ (Mul c3~30@ b3~28@)) c3~30@) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ (Mul (Mul d3~32@ c3~30@) a3~26@))))) (and (=> (= tmp%4@ (Mul d3~32@ b3~28@)) (=> (= tmp%5@ (Mul (Mul d3~32@ c3~30@) a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ d3~32@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~601@ temp_3_1~642@))))) (=> (= temp_3_0~601@ temp_3_1~642@) (=> (= temp_4_0~757@ (Mul (Mul (Add (Mul a4~34@ d4~40@) b4~36@) (Mul (Mul 79 b4~36@) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~830@ (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ d4~40@))) (Mul (Add (Mul a4~34@ d4~40@) b4~36@) (Mul (Mul 79 b4~36@) (Mul c4~38@ a4~34@))))) (and (=> (= tmp%6@ (Mul (Add (Mul a4~34@ d4~40@) b4~36@) (Mul (Mul 79 b4~36@) (Mul c4~38@ a4~34@)))) (=> (= tmp%7@ (Mul (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ d4~40@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%4 (= temp_4_0~757@ temp_4_1~830@))))) (=> (= temp_4_0~757@ temp_4_1~830@) (=> (= temp_5_0~999@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ 37)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@))) (Add (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Add b5~44@ c5~46@))))) (=> (= temp_5_1~1076@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ 37)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@))) (Add (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ c5~46@)) (Mul (Add b5~44@ c5~46@) (Mul b5~44@ a5~42@))))) (and (=> (= tmp%8@ (Mul b5~44@ a5~42@)) (=> (= tmp%9@ (Add b5~44@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%5 (= temp_5_0~999@ temp_5_1~1076@))))) (=> (= temp_5_0~999@ temp_5_1~1076@) (=> (= temp_6_0~1177@ (Mul (Sub (Add (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Sub a6~50@ d6~56@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Sub c6~54@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1242@ (Mul (Sub (Add (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Sub a6~50@ d6~56@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Sub c6~54@ c6~54@) (Mul c6~54@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1177@ temp_6_1~1242@))) (=> (= temp_6_0~1177@ temp_6_1~1242@) (=> (= temp_7_0~1335@ (Mul (Mul (Mul (Sub c7~62@ a7~58@) (Mul d7~64@ c7~62@)) (Sub (Mul a7~58@ d7~64@) (Mul 30 c7~62@))) (Mul a7~58@ (Mul (Mul d7~64@ c7~62@) (Sub b7~60@ b7~60@))))) (=> (= temp_7_1~1400@ (Mul (Mul (Mul (Sub c7~62@ a7~58@) (Mul d7~64@ c7~62@)) (Sub (Mul d7~64@ a7~58@) (Mul 30 c7~62@))) (Mul a7~58@ (Mul (Mul d7~64@ c7~62@) (Sub b7~60@ b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a7~58@ d7~64@) (=> %%location_label%%7 (= temp_7_0~1335@ temp_7_1~1400@))) (=> (= temp_7_0~1335@ temp_7_1~1400@) (=> (= temp_8_0~1517@ (Mul (Add (Mul (Mul b8~68@ a8~66@) (Mul 96 d8~72@)) (Mul (Mul 32 d8~72@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Sub c8~70@ d8~72@) (Mul b8~68@ d8~72@))))) (=> (= temp_8_1~1606@ (Mul (Add (Mul (Mul b8~68@ a8~66@) (Mul 96 d8~72@)) (Mul (Mul 32 d8~72@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Sub c8~70@ d8~72@))))) (=> (= tmp%10@ (Sub c8~70@ d8~72@)) (=> (= tmp%11@ (Mul b8~68@ d8~72@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~1517@ temp_8_1~1606@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
