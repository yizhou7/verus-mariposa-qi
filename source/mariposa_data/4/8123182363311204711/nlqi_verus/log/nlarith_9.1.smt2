...
(declare-const temp_7_1~1201@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~129@ (Add (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@)) b0~4@) (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ d0~8@)) (Add c0~6@ (Sub a0~2@ b0~4@))))) (=> (= temp_0_1~178@ (Add (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@)) b0~4@) (Mul (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ d0~8@)) (Add c0~6@ (Sub a0~2@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~129@ temp_0_1~178@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~258@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Add c1~14@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@))))) (=> (= temp_1_1~323@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Add c1~14@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~258@ temp_1_1~323@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~411@ (Mul (Mul (Mul a2~18@ (Sub c2~22@ d2~24@)) (Mul (Mul 44 a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ c2~22@)) (Add (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~484@ (Mul (Mul (Mul a2~18@ (Sub c2~22@ d2~24@)) (Mul (Mul 44 a2~18@) (Mul c2~22@ a2~18@))) (Mul (Mul b2~20@ b2~20@) (Mul (Mul c2~22@ c2~22@) (Add (Mul c2~22@ c2~22@) (Mul b2~20@ c2~22@)))))) (=> (= tmp%3@ (= temp_2_0~411@ temp_2_1~484@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~540@ (Mul (Mul (Mul b3~28@ (Mul c3~30@ b3~28@)) c3~30@) (Mul (Mul (Mul d3~32@ b3~28@) d3~32@) (Mul (Mul d3~32@ c3~30@) a3~26@)))) (=> (= temp_3_1~581@ (Mul (Mul (Mul b3~28@ (Mul c3~30@ b3~28@)) c3~30@) (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ (Mul (Mul d3~32@ c3~30@) a3~26@))))) (=> (= tmp%4@ (= temp_3_0~540@ temp_3_1~581@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~669@ (Mul (Mul (Add (Mul a4~34@ d4~40@) b4~36@) (Mul (Mul 79 b4~36@) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ d4~40@))))) (=> (= temp_4_1~742@ (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ d4~40@))) (Mul (Add (Mul a4~34@ d4~40@) b4~36@) (Mul (Mul 79 b4~36@) (Mul c4~38@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~669@ temp_4_1~742@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~834@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ 37)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@))) (Add (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ c5~46@)) (Mul (Mul b5~44@ a5~42@) (Add b5~44@ c5~46@))))) (=> (= temp_5_1~911@ (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ 37)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@))) (Add (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ c5~46@)) (Mul (Add b5~44@ c5~46@) (Mul b5~44@ a5~42@))))) (=> (= tmp%6@ (= temp_5_0~834@ temp_5_1~911@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~991@ (Mul (Sub (Add (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Sub a6~50@ d6~56@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Sub c6~54@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= temp_6_1~1056@ (Mul (Sub (Add (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Sub a6~50@ d6~56@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Sub c6~54@ c6~54@) (Mul c6~54@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~991@ temp_6_1~1056@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1136@ (Mul (Mul (Mul (Sub c7~62@ a7~58@) (Mul d7~64@ c7~62@)) (Sub (Mul a7~58@ d7~64@) (Mul 30 c7~62@))) (Mul a7~58@ (Mul (Mul d7~64@ c7~62@) (Sub b7~60@ b7~60@))))) (=> (= temp_7_1~1201@ (Mul (Mul (Mul (Sub c7~62@ a7~58@) (Mul d7~64@ c7~62@)) (Sub (Mul d7~64@ a7~58@) (Mul 30 c7~62@))) (Mul a7~58@ (Mul (Mul d7~64@ c7~62@) (Sub b7~60@ b7~60@))))) (=> (= tmp%8@ (= temp_7_0~1136@ temp_7_1~1201@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1305@ (Mul (Add (Mul (Mul b8~68@ a8~66@) (Mul 96 d8~72@)) (Mul (Mul 32 d8~72@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Sub c8~70@ d8~72@) (Mul b8~68@ d8~72@))))) (=> (= temp_8_1~1394@ (Mul (Add (Mul (Mul b8~68@ a8~66@) (Mul 96 d8~72@)) (Mul (Mul 32 d8~72@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Sub c8~70@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1305@ temp_8_1~1394@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
