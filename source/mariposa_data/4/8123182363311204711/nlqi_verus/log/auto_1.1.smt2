...
(assert (=> %%query%% (not (=> (= temp_0_0~129@ (Add (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@)) b0~4@) (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ d0~8@)) (Add c0~6@ (Sub a0~2@ b0~4@))))) (=> (= temp_0_1~178@ (Add (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@)) b0~4@) (Mul (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ d0~8@)) (Add c0~6@ (Sub a0~2@ b0~4@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~129@ temp_0_1~178@))))))))
(assert %%query%%)
(check-sat)
