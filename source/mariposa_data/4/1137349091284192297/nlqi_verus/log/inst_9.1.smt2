...
(set-info :comment ";; mariposa_data/4//1137349091284192297/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~291@ Int)
(declare-const temp_1_1~356@ Int)
(declare-const temp_2_0~475@ Int)
(declare-const temp_2_1~540@ Int)
(declare-const temp_3_0~639@ Int)
(declare-const temp_3_1~708@ Int)
(declare-const temp_4_0~815@ Int)
(declare-const temp_4_1~880@ Int)
(declare-const temp_5_0~981@ Int)
(declare-const temp_5_1~1046@ Int)
(declare-const temp_6_0~1151@ Int)
(declare-const temp_6_1~1228@ Int)
(declare-const temp_7_0~1333@ Int)
(declare-const temp_7_1~1390@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Sub a0~2@ b0~4@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@)) c0~6@))) (=> (= temp_0_1~186@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Sub a0~2@ b0~4@))) (Mul c0~6@ (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))))) (and (=> (= tmp%1@ (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ c0~6@) (=> %%location_label%%0 (= temp_0_0~133@ temp_0_1~186@)))) (=> (= temp_0_0~133@ temp_0_1~186@) (=> (= temp_1_0~291@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Add b1~12@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Sub (Add a1~10@ a1~10@) (Sub b1~12@ b1~12@)) (Mul (Add b1~12@ b1~12@) (Sub b1~12@ b1~12@))))) (=> (= temp_1_1~356@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Add b1~12@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Mul (Sub (Add a1~10@ a1~10@) (Sub b1~12@ b1~12@)) (Add b1~12@ b1~12@)) (Sub b1~12@ b1~12@)))) (and (=> (= tmp%2@ (Sub (Add a1~10@ a1~10@) (Sub b1~12@ b1~12@))) (=> (= tmp%3@ (Add b1~12@ b1~12@)) (=> (= tmp%4@ (Sub b1~12@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~291@ temp_1_1~356@)))))) (=> (= temp_1_0~291@ temp_1_1~356@) (=> (= temp_2_0~475@ (Mul (Add (Sub (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Mul a2~18@ (Sub a2~18@ b2~20@))) (Mul (Sub (Add a2~18@ a2~18@) (Sub c2~22@ c2~22@)) (Mul (Mul d2~24@ a2~18@) 11)))) (=> (= temp_2_1~540@ (Mul (Add (Mul (Sub b2~20@ b2~20@) a2~18@) (Mul a2~18@ (Sub a2~18@ b2~20@))) (Mul (Sub (Add a2~18@ a2~18@) (Sub c2~22@ c2~22@)) (Mul (Mul d2~24@ a2~18@) 11)))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. b2~20@ b2~20@ a2~18@) (=> %%location_label%%2 (= temp_2_0~475@ temp_2_1~540@))) (=> (= temp_2_0~475@ temp_2_1~540@) (=> (= temp_3_0~639@ (Mul (Mul (Mul (Add c3~30@ a3~26@) (Mul c3~30@ 19)) (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@))) (Mul (Mul a3~26@ (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ c3~30@) b3~28@)))) (=> (= temp_3_1~708@ (Mul (Mul (Mul (Add c3~30@ a3~26@) (Mul c3~30@ 19)) (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@))) (Mul a3~26@ (Mul (Mul a3~26@ a3~26@) (Mul (Mul a3~26@ c3~30@) b3~28@))))) (and (=> (= tmp%5@ (Mul a3~26@ a3~26@)) (=> (= tmp%6@ (Mul (Mul a3~26@ c3~30@) b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a3~26@ tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~639@ temp_3_1~708@))))) (=> (= temp_3_0~639@ temp_3_1~708@) (=> (= temp_4_0~815@ (Mul (Mul (Add (Mul a4~34@ d4~40@) (Sub c4~38@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ b4~36@))) (Mul (Add (Mul a4~34@ b4~36@) (Add a4~34@ a4~34@)) (Add (Mul a4~34@ c4~38@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~880@ (Mul (Mul (Add (Mul a4~34@ d4~40@) (Sub c4~38@ d4~40@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ a4~34@))) (Mul (Add (Mul a4~34@ b4~36@) (Add a4~34@ a4~34@)) (Add (Mul a4~34@ c4~38@) (Mul b4~36@ a4~34@))))) (and (=> (= tmp%7@ (Mul c4~38@ a4~34@)) (=> (= tmp%8@ (Mul a4~34@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~815@ temp_4_1~880@))))) (=> (= temp_4_0~815@ temp_4_1~880@) (=> (= temp_5_0~981@ (Mul (Add (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Sub d5~48@ b5~44@))) (Add (Sub (Mul b5~44@ c5~46@) (Sub b5~44@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~1046@ (Mul (Add (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Sub d5~48@ b5~44@))) (Add (Sub (Mul c5~46@ b5~44@) (Sub b5~44@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b5~44@ c5~46@) (=> %%location_label%%5 (= temp_5_0~981@ temp_5_1~1046@))) (=> (= temp_5_0~981@ temp_5_1~1046@) (=> (= temp_6_0~1151@ (Mul (Mul (Mul (Mul a6~50@ 83) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Add (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@)) (Sub (Sub c6~54@ c6~54@) (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1228@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ 83)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Add (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@)) (Sub (Sub c6~54@ c6~54@) (Mul c6~54@ d6~56@))))) (and (=> (= tmp%9@ (Mul a6~50@ 83)) (=> (= tmp%10@ (Mul a6~50@ d6~56@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~1151@ temp_6_1~1228@))))) (=> (= temp_6_0~1151@ temp_6_1~1228@) (=> (= temp_7_0~1333@ (Mul (Sub (Mul b7~60@ (Mul c7~62@ a7~58@)) (Add (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@))) (Mul (Mul (Mul c7~62@ c7~62@) (Add c7~62@ d7~64@)) (Mul c7~62@ (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1390@ (Mul (Sub (Mul b7~60@ (Mul c7~62@ a7~58@)) (Add (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@))) (Mul (Mul c7~62@ c7~62@) (Mul (Add c7~62@ d7~64@) (Mul c7~62@ (Mul d7~64@ d7~64@)))))) (and (=> (= tmp%11@ (Mul c7~62@ c7~62@)) (=> (= tmp%12@ (Add c7~62@ d7~64@)) (=> (= tmp%13@ (Mul c7~62@ (Mul d7~64@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%7 (= temp_7_0~1333@ temp_7_1~1390@)))))) (=> (= temp_7_0~1333@ temp_7_1~1390@) (=> (= temp_8_0~1489@ (Mul (Mul (Add (Mul a8~66@ c8~70@) (Mul d8~72@ c8~70@)) (Add (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul d8~72@ a8~66@) (Add a8~66@ d8~72@)) b8~68@))) (=> (= temp_8_1~1542@ (Mul (Mul (Add (Mul a8~66@ c8~70@) (Mul d8~72@ c8~70@)) (Add (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul a8~66@ d8~72@) (Add a8~66@ d8~72@)) b8~68@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d8~72@ a8~66@) (=> %%location_label%%8 (= temp_8_0~1489@ temp_8_1~1542@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
