...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Sub a0~2@ b0~4@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@)) c0~6@))) (=> (= temp_0_1~186@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Sub a0~2@ b0~4@))) (Mul c0~6@ (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~133@ temp_0_1~186@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~266@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Add b1~12@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Sub (Add a1~10@ a1~10@) (Sub b1~12@ b1~12@)) (Mul (Add b1~12@ b1~12@) (Sub b1~12@ b1~12@))))) (=> (= temp_1_1~331@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Add b1~12@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Mul (Sub (Add a1~10@ a1~10@) (Sub b1~12@ b1~12@)) (Add b1~12@ b1~12@)) (Sub b1~12@ b1~12@)))) (=> (= tmp%2@ (= temp_1_0~266@ temp_1_1~331@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~415@ (Mul (Add (Sub (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Mul a2~18@ (Sub a2~18@ b2~20@))) (Mul (Sub (Add a2~18@ a2~18@) (Sub c2~22@ c2~22@)) (Mul (Mul d2~24@ a2~18@) 11)))) (=> (= temp_2_1~480@ (Mul (Add (Mul (Sub b2~20@ b2~20@) a2~18@) (Mul a2~18@ (Sub a2~18@ b2~20@))) (Mul (Sub (Add a2~18@ a2~18@) (Sub c2~22@ c2~22@)) (Mul (Mul d2~24@ a2~18@) 11)))) (=> (= tmp%3@ (= temp_2_0~415@ temp_2_1~480@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~564@ (Mul (Mul (Mul (Add c3~30@ a3~26@) (Mul c3~30@ 19)) (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@))) (Mul (Mul a3~26@ (Mul a3~26@ a3~26@)) (Mul (Mul a3~26@ c3~30@) b3~28@)))) (=> (= temp_3_1~633@ (Mul (Mul (Mul (Add c3~30@ a3~26@) (Mul c3~30@ 19)) (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ d3~32@))) (Mul a3~26@ (Mul (Mul a3~26@ a3~26@) (Mul (Mul a3~26@ c3~30@) b3~28@))))) (=> (= tmp%4@ (= temp_3_0~564@ temp_3_1~633@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~713@ (Mul (Mul (Add (Mul a4~34@ d4~40@) (Sub c4~38@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ b4~36@))) (Mul (Add (Mul a4~34@ b4~36@) (Add a4~34@ a4~34@)) (Add (Mul a4~34@ c4~38@) (Mul b4~36@ a4~34@))))) (=> (= temp_4_1~778@ (Mul (Mul (Add (Mul a4~34@ d4~40@) (Sub c4~38@ d4~40@)) (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ a4~34@))) (Mul (Add (Mul a4~34@ b4~36@) (Add a4~34@ a4~34@)) (Add (Mul a4~34@ c4~38@) (Mul b4~36@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~713@ temp_4_1~778@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~858@ (Mul (Add (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Sub d5~48@ b5~44@))) (Add (Sub (Mul b5~44@ c5~46@) (Sub b5~44@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ b5~44@))))) (=> (= temp_5_1~923@ (Mul (Add (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Sub d5~48@ b5~44@))) (Add (Sub (Mul c5~46@ b5~44@) (Sub b5~44@ b5~44@)) (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~858@ temp_5_1~923@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1015@ (Mul (Mul (Mul (Mul a6~50@ 83) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Add (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@)) (Sub (Sub c6~54@ c6~54@) (Mul c6~54@ d6~56@))))) (=> (= temp_6_1~1092@ (Mul (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ 83)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Add (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@)) (Sub (Sub c6~54@ c6~54@) (Mul c6~54@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~1015@ temp_6_1~1092@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1164@ (Mul (Sub (Mul b7~60@ (Mul c7~62@ a7~58@)) (Add (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@))) (Mul (Mul (Mul c7~62@ c7~62@) (Add c7~62@ d7~64@)) (Mul c7~62@ (Mul d7~64@ d7~64@))))) (=> (= temp_7_1~1221@ (Mul (Sub (Mul b7~60@ (Mul c7~62@ a7~58@)) (Add (Mul d7~64@ c7~62@) (Mul b7~60@ a7~58@))) (Mul (Mul c7~62@ c7~62@) (Mul (Add c7~62@ d7~64@) (Mul c7~62@ (Mul d7~64@ d7~64@)))))) (=> (= tmp%8@ (= temp_7_0~1164@ temp_7_1~1221@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1289@ (Mul (Mul (Add (Mul a8~66@ c8~70@) (Mul d8~72@ c8~70@)) (Add (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul d8~72@ a8~66@) (Add a8~66@ d8~72@)) b8~68@))) (=> (= temp_8_1~1342@ (Mul (Mul (Add (Mul a8~66@ c8~70@) (Mul d8~72@ c8~70@)) (Add (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul a8~66@ d8~72@) (Add a8~66@ d8~72@)) b8~68@))) (=> (= tmp%9@ (= temp_8_0~1289@ temp_8_1~1342@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
