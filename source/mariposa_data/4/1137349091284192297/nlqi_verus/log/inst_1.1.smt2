...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Sub a0~2@ b0~4@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@)) c0~6@))) (=> (= temp_0_1~186@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Sub a0~2@ b0~4@))) (Mul c0~6@ (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))))) (=> (= tmp%1@ (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ c0~6@) (=> %%location_label%%0 (= temp_0_0~133@ temp_0_1~186@)))))))))
(assert %%query%%)
(check-sat)
