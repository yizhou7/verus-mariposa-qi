...
(assert (=> %%query%% (not (=> (= temp_0_0~133@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Sub a0~2@ b0~4@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@)) c0~6@))) (=> (= temp_0_1~186@ (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Sub a0~2@ b0~4@))) (Mul c0~6@ (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~133@ temp_0_1~186@)) (=> %%location_label%%0 tmp%1@)))))))
(assert %%query%%)
(check-sat)
