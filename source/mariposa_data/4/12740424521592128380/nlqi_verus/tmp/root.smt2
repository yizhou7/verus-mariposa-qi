...
;; mariposa_data/4//12740424521592128380/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_6_1~1036@ Int)
 (declare-const temp_7_0~1116@ Int)
 (declare-const temp_7_1~1181@ Int)
 (declare-const temp_8_0~1261@ Int)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~149@ (Mul (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@)
          (Mul d0~8@ c0~6@)
         )
        ) (Add (Add (Mul d0~8@ b0~4@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@)))
      ))
      (=>
       (= temp_0_1~214@ (Mul (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul (Mul b0~4@
             b0~4@
            ) d0~8@
           ) c0~6@
          )
       ...
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~286@ (Mul (Mul (Mul (Mul b1~12@ a1~10@) a1~10@) (Mul (Sub b1~12@ b1~12@)
               b1~12@
              )
             ) (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul b1~12@
                b1~12@
           )))))
           (=>
            (= temp_1_1~343@ (Mul (Mul (Mul (Mul b1~12@ a1~10@) a1~10@) (Mul (Sub b1~12@ b1~12@)
                b1~12@
               )
              ) (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul b1~12@
                 b1~12@
            )))))
            (=>
             (= tmp%2@ (= temp_1_0~286@ temp_1_1~343@))
             (and
              (=>
               %%location_label%%1
               tmp%2@
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~423@ (Mul (Add (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul d2~24@
                     a2~18@
                    ) (Mul b2~20@ b2~20@)
                   )
                  ) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@
                     c2~22@
                )))))
                (=>
                 (= temp_2_1~488@ (Mul (Add (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul d2~24@
                      a2~18@
                     ) (Mul b2~20@ b2~20@)
                    )
                   ) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul c2~22@
                      a2~18@
                 )))))
                 (=>
                  (= tmp%3@ (= temp_2_0~423@ temp_2_1~488@))
                  (and
                   (=>
                    %%location_label%%2
                    tmp%3@
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~556@ (Sub (Sub (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@
                          d3~32@
                         ) (Mul c3~30@ b3~28@)
                        )
                       ) (Sub (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@)) b3~28@)
                     ))
                     (=>
                      (= temp_3_1~609@ (Sub (Sub (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@
                           b3~28@
                          ) (Mul c3~30@ d3~32@)
                         )
                        ) (Sub (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@)) b3~28@)
                      ...
                      (=>
                       (= tmp%4@ (= temp_3_0~556@ temp_3_1~609@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~677@ (Add (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul a4~34@
                              (Mul d4~40@ c4~38@)
                             )
                            ) (Mul (Mul b4~36@ (Mul d4~40@ c4~38@)) (Mul a4~34@ (Mul c4~38@ c4~38@)))
                          ))
                          (=>
                           (= temp_4_1~730@ (Add (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@
                                c4~38@
                               ) a4~34@
                              )
                             ) (Mul (Mul b4~36@ (Mul d4~40@ c4~38@)) (Mul a4~34@ (Mul c4~38@ c4~38@)))
                           ...
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~810@ (Mul (Mul d5~48@ (Mul (Mul 45 a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul
                                   (Mul d5~48@ a5~42@) (Mul c5~46@ b5~44@)
                                  ) (Mul (Mul c5~46@ b5~44@) (Sub a5~42@ b5~44@))
                               )))
                               (=>
                                (= temp_5_1~875@ (Mul (Mul d5~48@ (Mul (Mul 45 a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul
                                    (Mul c5~46@ b5~44@) (Mul d5~48@ a5~42@)
                                   ) (Mul (Mul c5~46@ b5~44@) (Sub a5~42@ b5~44@))
                                )))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~963@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul c6~54@
                                         a6~50@
                                        ) (Sub a6~50@ d6~56@)
                                       )
                                      ) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ 58)) (Mul c6~54@ (Add c6~54@ d6~56@)))
                                    ))
                                    (=>
                                     (= temp_6_1~1036@ (Mul (Mul (Mul a6~50@ a6~50@) (Mul (Mul d6~56@ d6~56@) (Mul (Mul c6~54@
                                           a6~50@
                                          ) (Sub a6~50@ d6~56@)
                                        ))
                                       ) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ 58)) (Mul c6~54@ (Add c6~54@ d6~56@)))
                                     ...
                                     (=>
                                      (= tmp%7@ (= temp_6_0~963@ temp_6_1~1036@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~1116@ (Mul (Mul (Add (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul c7~62@
                                              c7~62@
                                             ) (Mul d7~64@ c7~62@)
                                            )
                                           ) (Sub (Mul (Add b7~60@ c7~62@) (Mul b7~60@ a7~58@)) (Add (Mul b7~60@ d7~64@) (Mul c7~62@
                                              a7~58@
                                         )))))
                                         (=>
                                          (= temp_7_1~1181@ (Mul (Mul (Add (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)) (Mul c7~62@
                                              (Mul c7~62@ (Mul d7~64@ c7~62@))
                                             )
                                            ) (Sub (Mul (Add b7~60@ c7~62@) (Mul b7~60@ a7~58@)) (Add (Mul b7~60@ d7~64@) (Mul c7~62@
                                               a7~58@
                                          )))))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~1116@ temp_7_1~1181@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~1261@ (Mul (Mul (Mul (Mul b8~68@ b8~68@) (Sub d8~72@ b8~68@)) (Sub (Sub a8~66@
                                                   a8~66@
                                                  ) (Mul d8~72@ d8~72@)
                                                 )
                                                ) (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@
                                                   c8~70@
                                              )))))
                                              (=>
                                               (= temp_8_1~1326@ (Mul (Mul (Mul (Mul b8~68@ b8~68@) (Sub d8~72@ b8~68@)) (Sub (Sub a8~66@
                                                    a8~66@
                                                   ) (Mul d8~72@ d8~72@)
                                                  )
                                                 ) (Mul (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) (Mul b8~68@ a8~66@)) (Mul
                                                   d8~72@ c8~70@
                                               ))))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~1261@ temp_8_1~1326@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
