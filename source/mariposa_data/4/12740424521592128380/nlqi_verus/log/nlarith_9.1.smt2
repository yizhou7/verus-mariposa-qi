...
(declare-const temp_1_1~339@ Int)
(declare-const temp_2_0~419@ Int)
(declare-const temp_2_1~484@ Int)
(declare-const temp_3_0~552@ Int)
(declare-const temp_3_1~605@ Int)
(declare-const temp_4_0~673@ Int)
(declare-const temp_4_1~726@ Int)
(declare-const temp_5_0~806@ Int)
(declare-const temp_5_1~871@ Int)
(declare-const temp_6_0~959@ Int)
(declare-const temp_6_1~1032@ Int)
(declare-const temp_7_0~1112@ Int)
(declare-const temp_7_1~1177@ Int)
(declare-const temp_8_0~1257@ Int)
(declare-const temp_8_1~1322@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ c0~6@))) (Add (Add (Mul d0~8@ b0~4@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@))))) (=> (= temp_0_1~210@ (Mul (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul (Mul b0~4@ b0~4@) d0~8@) c0~6@)) (Add (Add (Mul d0~8@ b0~4@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~145@ temp_0_1~210@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~282@ (Mul (Mul (Mul (Mul b1~12@ a1~10@) a1~10@) (Mul (Sub b1~12@ b1~12@) b1~12@)) (Mul (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ b1~12@))))) (=> (= temp_1_1~339@ (Mul (Mul (Mul (Mul b1~12@ a1~10@) a1~10@) (Mul (Sub b1~12@ b1~12@) b1~12@)) (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~282@ temp_1_1~339@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~419@ (Mul (Add (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ c2~22@))))) (=> (= temp_2_1~484@ (Mul (Add (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ a2~18@))))) (=> (= tmp%3@ (= temp_2_0~419@ temp_2_1~484@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~552@ (Sub (Sub (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ b3~28@))) (Sub (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@)) b3~28@))) (=> (= temp_3_1~605@ (Sub (Sub (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ d3~32@))) (Sub (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@)) b3~28@))) (=> (= tmp%4@ (= temp_3_0~552@ temp_3_1~605@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~673@ (Add (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul a4~34@ (Mul d4~40@ c4~38@))) (Mul (Mul b4~36@ (Mul d4~40@ c4~38@)) (Mul a4~34@ (Mul c4~38@ c4~38@))))) (=> (= temp_4_1~726@ (Add (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul d4~40@ c4~38@) a4~34@)) (Mul (Mul b4~36@ (Mul d4~40@ c4~38@)) (Mul a4~34@ (Mul c4~38@ c4~38@))))) (=> (= tmp%5@ (= temp_4_0~673@ temp_4_1~726@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~806@ (Mul (Mul d5~48@ (Mul (Mul 45 a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ b5~44@)) (Mul (Mul c5~46@ b5~44@) (Sub a5~42@ b5~44@))))) (=> (= temp_5_1~871@ (Mul (Mul d5~48@ (Mul (Mul 45 a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ a5~42@)) (Mul (Mul c5~46@ b5~44@) (Sub a5~42@ b5~44@))))) (=> (= tmp%6@ (= temp_5_0~806@ temp_5_1~871@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~959@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul c6~54@ a6~50@) (Sub a6~50@ d6~56@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ 58)) (Mul c6~54@ (Add c6~54@ d6~56@))))) (=> (= temp_6_1~1032@ (Mul (Mul (Mul a6~50@ a6~50@) (Mul (Mul d6~56@ d6~56@) (Mul (Mul c6~54@ a6~50@) (Sub a6~50@ d6~56@)))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ 58)) (Mul c6~54@ (Add c6~54@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~959@ temp_6_1~1032@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1112@ (Mul (Mul (Add (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ c7~62@))) (Sub (Mul (Add b7~60@ c7~62@) (Mul b7~60@ a7~58@)) (Add (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@))))) (=> (= temp_7_1~1177@ (Mul (Mul (Add (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)) (Mul c7~62@ (Mul c7~62@ (Mul d7~64@ c7~62@)))) (Sub (Mul (Add b7~60@ c7~62@) (Mul b7~60@ a7~58@)) (Add (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1112@ temp_7_1~1177@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1257@ (Mul (Mul (Mul (Mul b8~68@ b8~68@) (Sub d8~72@ b8~68@)) (Sub (Sub a8~66@ a8~66@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@))))) (=> (= temp_8_1~1322@ (Mul (Mul (Mul (Mul b8~68@ b8~68@) (Sub d8~72@ b8~68@)) (Sub (Sub a8~66@ a8~66@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@)) (Mul b8~68@ a8~66@)) (Mul d8~72@ c8~70@)))) (=> (= tmp%9@ (= temp_8_0~1257@ temp_8_1~1322@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
