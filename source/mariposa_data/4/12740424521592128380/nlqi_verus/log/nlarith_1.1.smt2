...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ c0~6@))) (Add (Add (Mul d0~8@ b0~4@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@))))) (=> (= temp_0_1~210@ (Mul (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul (Mul b0~4@ b0~4@) d0~8@) c0~6@)) (Add (Add (Mul d0~8@ b0~4@) (Mul b0~4@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@))))) (=> (= tmp%1@ (= temp_0_0~145@ temp_0_1~210@)) (=> %%location_label%%0 tmp%1@)))))))
(assert %%query%%)
(check-sat)
