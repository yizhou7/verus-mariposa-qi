...
(declare-const temp_2_0~405@ Int)
(declare-const temp_2_1~462@ Int)
(declare-const temp_3_0~563@ Int)
(declare-const temp_3_1~640@ Int)
(declare-const temp_4_0~729@ Int)
(declare-const temp_4_1~794@ Int)
(declare-const temp_5_0~871@ Int)
(declare-const temp_5_1~956@ Int)
(declare-const temp_6_0~1045@ Int)
(declare-const temp_6_1~1110@ Int)
(declare-const temp_7_0~1195@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~141@ (Add (Mul (Mul (Mul d0~8@ c0~6@) (Sub a0~2@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ a0~2@))) (Sub (Mul (Mul b0~4@ d0~8@) c0~6@) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~202@ (Add (Mul (Mul (Mul d0~8@ c0~6@) (Sub a0~2@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ a0~2@))) (Sub (Mul b0~4@ (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~141@ temp_0_1~202@))) (=> (= temp_0_0~141@ temp_0_1~202@) (=> (= temp_1_0~275@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul d1~16@ (Add b1~12@ c1~14@))) (Mul d1~16@ (Sub (Add d1~16@ d1~16@) (Mul a1~10@ d1~16@))))) (=> (= temp_1_1~324@ (Mul (Mul d1~16@ (Sub (Add d1~16@ d1~16@) (Mul a1~10@ d1~16@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul d1~16@ (Add b1~12@ c1~14@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~275@ temp_1_1~324@))) (=> (= temp_1_0~275@ temp_1_1~324@) (=> (= temp_2_0~405@ (Mul (Sub (Mul b2~20@ (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ c2~22@) (Sub a2~18@ d2~24@))) (Sub (Mul (Mul c2~22@ b2~20@) b2~20@) (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~462@ (Mul (Sub (Mul b2~20@ (Mul b2~20@ a2~18@)) (Mul (Sub a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Sub (Mul (Mul c2~22@ b2~20@) b2~20@) (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~405@ temp_2_1~462@))) (=> (= temp_2_0~405@ temp_2_1~462@) (=> (= temp_3_0~563@ (Mul (Mul (Mul (Add c3~30@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ 34)) (Sub (Mul b3~28@ b3~28@) (Mul c3~30@ a3~26@))))) (=> (= temp_3_1~640@ (Mul (Mul (Mul (Mul (Add c3~30@ b3~28@) c3~30@) a3~26@) (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ 34)) (Sub (Mul b3~28@ b3~28@) (Mul c3~30@ a3~26@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~563@ temp_3_1~640@))) (=> (= temp_3_0~563@ temp_3_1~640@) (=> (= temp_4_0~729@ (Mul (Sub (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@)) (Add (Mul a4~34@ a4~34@) (Mul a4~34@ d4~40@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@)) (Mul (Sub b4~36@ c4~38@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~794@ (Mul (Sub (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@)) (Add (Mul a4~34@ a4~34@) (Mul a4~34@ d4~40@))) (Sub (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@)) (Mul (Sub b4~36@ c4~38@) (Mul b4~36@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~729@ temp_4_1~794@))) (=> (= temp_4_0~729@ temp_4_1~794@) (=> (= temp_5_0~871@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ b5~44@)) (Mul (Sub d5~48@ c5~46@) (Mul d5~48@ d5~48@))) (Add (Mul (Mul a5~42@ d5~48@) (Add c5~46@ c5~46@)) d5~48@))) (=> (= temp_5_1~956@ (Add (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ b5~44@)) (Mul (Sub d5~48@ c5~46@) (Mul d5~48@ d5~48@))) (Mul (Mul a5~42@ d5~48@) (Add c5~46@ c5~46@))) (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ b5~44@)) (Mul (Sub d5~48@ c5~46@) (Mul d5~48@ d5~48@))) d5~48@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~871@ temp_5_1~956@))) (=> (= temp_5_0~871@ temp_5_1~956@) (=> (= temp_6_0~1045@ (Mul (Sub (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1110@ (Mul (Sub (Mul c6~54@ (Mul a6~50@ (Mul d6~56@ b6~52@))) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1045@ temp_6_1~1110@))) (=> (= temp_6_0~1045@ temp_6_1~1110@) (=> (= temp_7_0~1195@ (Mul (Add (Mul c7~62@ (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ c7~62@))) (Sub (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@))))) (=> (= temp_7_1~1256@ (Mul (Add (Mul c7~62@ (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ c7~62@))) (Sub (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1195@ temp_7_1~1256@))) (=> (= temp_7_0~1195@ temp_7_1~1256@) (=> (= temp_8_0~1353@ (Sub (Mul (Sub d8~72@ (Mul c8~70@ 72)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ 83))) (Mul (Mul (Mul d8~72@ c8~70@) (Sub d8~72@ d8~72@)) d8~72@))) (=> (= temp_8_1~1426@ (Sub (Mul (Sub d8~72@ (Mul c8~70@ 72)) (Mul (Mul a8~66@ a8~66@) (Mul 83 c8~70@))) (Mul (Mul (Mul d8~72@ c8~70@) (Sub d8~72@ d8~72@)) d8~72@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1353@ temp_8_1~1426@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
