...
(assert (=> %%query%% (not (=> (= temp_0_0~141@ (Add (Mul (Mul (Mul d0~8@ c0~6@) (Sub a0~2@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ a0~2@))) (Sub (Mul (Mul b0~4@ d0~8@) c0~6@) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@))))) (=> (= temp_0_1~202@ (Add (Mul (Mul (Mul d0~8@ c0~6@) (Sub a0~2@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ a0~2@))) (Sub (Mul b0~4@ (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~141@ temp_0_1~202@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~266@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul d1~16@ (Add b1~12@ c1~14@))) (Mul d1~16@ (Sub (Add d1~16@ d1~16@) (Mul a1~10@ d1~16@))))) (=> (= temp_1_1~315@ (Mul (Mul d1~16@ (Sub (Add d1~16@ d1~16@) (Mul a1~10@ d1~16@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul d1~16@ (Add b1~12@ c1~14@))))) (=> (= tmp%2@ (= temp_1_0~266@ temp_1_1~315@)) (=> %%location_label%%1 tmp%2@))))))))))))
(assert %%query%%)
(check-sat)
