...
;; mariposa_data/4//5276095804370053296/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_2_0~391@ Int)
 (declare-const temp_2_1~448@ Int)
 (declare-const temp_3_0~540@ Int)
 (declare-const temp_3_1~617@ Int)
 (declare-const temp_4_0~697@ Int)
 (declare-const temp_4_1~762@ Int)
 (declare-const temp_5_0~830@ Int)
 (declare-const temp_5_1~915@ Int)
 (declare-const temp_6_0~995@ Int)
 (declare-const temp_6_1~1060@ Int)
 (declare-const temp_7_0~1136@ Int)
 (declare-const temp_7_1~1197@ Int)
 (declare-const temp_8_0~1285@ Int)
 (declare-const temp_8_1~1358@ Int)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~145@ (Add (Mul (Mul (Mul d0~8@ c0~6@) (Sub a0~2@ d0~8@)) (Mul (Mul d0~8@ d0~8@)
          (Mul d0~8@ a0~2@)
         )
        ) (Sub (Mul (Mul b0~4@ d0~8@) c0~6@) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)))
      ))
      (=>
       (= temp_0_1~206@ (Add (Mul (Mul (Mul d0~8@ c0~6@) (Sub a0~2@ d0~8@)) (Mul (Mul d0~8@ d0~8@)
           (Mul d0~8@ a0~2@)
          )
         ) (Sub (Mul b0~4@ (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)))
       ))
       (=>
        ...
        (and
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~270@ (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul d1~16@
               (Add b1~12@ c1~14@)
              )
             ) (Mul d1~16@ (Sub (Add d1~16@ d1~16@) (Mul a1~10@ d1~16@)))
           ))
           (=>
            (= temp_1_1~319@ (Mul (Mul d1~16@ (Sub (Add d1~16@ d1~16@) (Mul a1~10@ d1~16@))) (Mul
               (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul d1~16@ (Add b1~12@ c1~14@))
            )))
            (=>
             (= tmp%2@ (= temp_1_0~270@ temp_1_1~319@))
             (and
              (=>
               %%location_label%%1
               tmp%2@
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~391@ (Mul (Sub (Mul b2~20@ (Mul b2~20@ a2~18@)) (Mul (Mul b2~20@ c2~22@)
                    (Sub a2~18@ d2~24@)
                   )
                  ) (Sub (Mul (Mul c2~22@ b2~20@) b2~20@) (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@)))
                ))
                (=>
                 (= temp_2_1~448@ (Mul (Sub (Mul b2~20@ (Mul b2~20@ a2~18@)) (Mul (Sub a2~18@ d2~24@)
                     (Mul b2~20@ c2~22@)
                    )
                   ) (Sub (Mul (Mul c2~22@ b2~20@) b2~20@) (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ d2~24@)))
                 ))
                 (=>
                  (= tmp%3@ (= temp_2_0~391@ temp_2_1~448@))
                  (and
                   (=>
                    %%location_label%%2
                    tmp%3@
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~540@ (Mul (Mul (Mul (Add c3~30@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Mul b3~28@
                          c3~30@
                         ) (Mul d3~32@ d3~32@)
                        )
                       ) (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ 34)) (Sub (Mul b3~28@ b3~28@) (Mul c3~30@
                          a3~26@
                     )))))
                     (=>
                      (= temp_3_1~617@ (Mul (Mul (Mul (Mul (Add c3~30@ b3~28@) c3~30@) a3~26@) (Mul (Mul b3~28@
                           c3~30@
                          ) (Mul d3~32@ d3~32@)
                         )
                        ) (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ 34)) (Sub (Mul b3~28@ b3~28@) (Mul c3~30@
                      ...
                      (=>
                       (= tmp%4@ (= temp_3_0~540@ temp_3_1~617@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~697@ (Mul (Sub (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@)) (Add (Mul a4~34@
                               a4~34@
                              ) (Mul a4~34@ d4~40@)
                             )
                            ) (Sub (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@)) (Mul (Sub b4~36@ c4~38@) (Mul b4~36@
                               d4~40@
                          )))))
                          (=>
                           (= temp_4_1~762@ (Mul (Sub (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@)) (Add (Mul a4~34@
                                a4~34@
                               ) (Mul a4~34@ d4~40@)
                              )
                             ) (Sub (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ a4~34@)) (Mul (Sub b4~36@ c4~38@) (Mul b4~36@
                           ...
                           (=>
                            (= tmp%5@ (= temp_4_0~697@ temp_4_1~762@))
                            (and
                             (=>
                              %%location_label%%4
                              tmp%5@
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~830@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ b5~44@)) (Mul (Sub d5~48@
                                    c5~46@
                                   ) (Mul d5~48@ d5~48@)
                                  )
                                 ) (Add (Mul (Mul a5~42@ d5~48@) (Add c5~46@ c5~46@)) d5~48@)
                               ))
                               (=>
                                (= temp_5_1~915@ (Add (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ b5~44@)) (Mul (Sub
                                      d5~48@ c5~46@
                                     ) (Mul d5~48@ d5~48@)
                                    )
                                   ) (Mul (Mul a5~42@ d5~48@) (Add c5~46@ c5~46@))
                                  ) (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ b5~44@)) (Mul (Sub d5~48@ c5~46@) (
                                      Mul d5~48@ d5~48@
                                    ))
                                   ) d5~48@
                                )))
                                (=>
                                 (= tmp%6@ (= temp_5_0~830@ temp_5_1~915@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~995@ (Mul (Sub (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@
                                         d6~56@
                                        ) (Mul a6~50@ a6~50@)
                                       )
                                      ) (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@
                                         b6~52@
                                    )))))
                                    (=>
                                     (= temp_6_1~1060@ (Mul (Sub (Mul c6~54@ (Mul a6~50@ (Mul d6~56@ b6~52@))) (Mul (Mul c6~54@
                                          d6~56@
                                         ) (Mul a6~50@ a6~50@)
                                        )
                                       ) (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) (Mul a6~50@
                                     ...
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~1136@ (Mul (Add (Mul c7~62@ (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ d7~64@)
                                             (Mul a7~58@ c7~62@)
                                            )
                                           ) (Sub (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul a7~58@
                                              a7~58@
                                         )))))
                                         (=>
                                          (= temp_7_1~1197@ (Mul (Add (Mul c7~62@ (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ d7~64@)
                                              (Mul a7~58@ c7~62@)
                                             )
                                            ) (Sub (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul a7~58@
                                               a7~58@
                                          ...
                                          (=>
                                           (= tmp%8@ (= temp_7_0~1136@ temp_7_1~1197@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~1285@ (Sub (Mul (Sub d8~72@ (Mul c8~70@ 72)) (Mul (Mul a8~66@ a8~66@) (Mul
                                                   c8~70@ 83
                                                 ))
                                                ) (Mul (Mul (Mul d8~72@ c8~70@) (Sub d8~72@ d8~72@)) d8~72@)
                                              ))
                                              (=>
                                               (= temp_8_1~1358@ (Sub (Mul (Sub d8~72@ (Mul c8~70@ 72)) (Mul (Mul a8~66@ a8~66@) (Mul
                                                    83 c8~70@
                                                  ))
                                                 ) (Mul (Mul (Mul d8~72@ c8~70@) (Sub d8~72@ d8~72@)) d8~72@)
                                               ))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~1285@ temp_8_1~1358@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
