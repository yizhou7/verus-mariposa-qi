...
(set-info :comment ";; mariposa_data/4//2326505604421628983/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_2_1~500@ Int)
(declare-const temp_3_0~619@ Int)
(declare-const temp_3_1~704@ Int)
(declare-const temp_4_0~803@ Int)
(declare-const temp_4_1~856@ Int)
(declare-const temp_5_0~949@ Int)
(declare-const temp_5_1~1014@ Int)
(declare-const temp_6_0~1111@ Int)
(declare-const temp_6_1~1172@ Int)
(declare-const temp_7_0~1245@ Int)
(declare-const temp_7_1~1290@ Int)
(declare-const temp_8_0~1363@ Int)
(declare-const temp_8_1~1396@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~129@ (Mul (Mul c0~6@ (Sub (Sub d0~8@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Mul c0~6@ (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~178@ (Mul (Mul c0~6@ (Sub (Sub d0~8@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Mul c0~6@ (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ c0~6@) (=> %%location_label%%0 (= temp_0_0~129@ temp_0_1~178@))) (=> (= temp_0_0~129@ temp_0_1~178@) (=> (= temp_1_0~271@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))) (Sub (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~336@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))) (Sub (Mul d1~16@ (Mul d1~16@ (Mul b1~12@ b1~12@))) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@))))) (and (=> (= tmp%1@ (Mul b1~12@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d1~16@ d1~16@ tmp%1@) (=> %%location_label%%1 (= temp_1_0~271@ temp_1_1~336@)))) (=> (= temp_1_0~271@ temp_1_1~336@) (=> (= temp_2_0~435@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@))) (Mul (Mul (Add c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~500@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul (Mul a2~18@ d2~24@) d2~24@) c2~22@)) (Mul (Mul (Add c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@))))) (and (=> (= tmp%2@ (Mul a2~18@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ d2~24@ c2~22@) (=> %%location_label%%2 (= temp_2_0~435@ temp_2_1~500@)))) (=> (= temp_2_0~435@ temp_2_1~500@) (=> (= temp_3_0~619@ (Mul (Mul (Sub (Sub 73 b3~28@) (Mul d3~32@ c3~30@)) (Add (Mul d3~32@ a3~26@) (Add b3~28@ d3~32@))) (Add (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ 10)) (Sub a3~26@ (Add b3~28@ d3~32@))))) (=> (= temp_3_1~704@ (Mul (Mul (Sub (Sub 73 b3~28@) (Mul d3~32@ c3~30@)) (Add (Mul d3~32@ a3~26@) (Add b3~28@ d3~32@))) (Add (Mul (Mul (Mul c3~30@ b3~28@) a3~26@) 10) (Sub a3~26@ (Add b3~28@ d3~32@))))) (and (=> (= tmp%3@ (Mul c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%3@ a3~26@ 10) (=> %%location_label%%3 (= temp_3_0~619@ temp_3_1~704@)))) (=> (= temp_3_0~619@ temp_3_1~704@) (=> (= temp_4_0~803@ (Mul (Sub (Mul (Add c4~38@ c4~38@) (Sub b4~36@ a4~34@)) d4~40@) (Mul (Mul (Sub b4~36@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Add c4~38@ d4~40@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~856@ (Mul (Sub (Mul (Add c4~38@ c4~38@) (Sub b4~36@ a4~34@)) d4~40@) (Mul (Mul (Sub b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Mul (Add c4~38@ d4~40@) (Mul a4~34@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b4~36@ d4~40@) (=> %%location_label%%4 (= temp_4_0~803@ temp_4_1~856@))) (=> (= temp_4_0~803@ temp_4_1~856@) (=> (= temp_5_0~949@ (Sub (Mul (Sub (Mul a5~42@ c5~46@) (Sub b5~44@ c5~46@)) (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@))) (Sub (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~1014@ (Sub (Mul (Sub (Mul a5~42@ c5~46@) (Sub b5~44@ c5~46@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@))) (Sub (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@))))) (and (=> (= tmp%4@ (Mul c5~46@ a5~42@)) (=> (= tmp%5@ (Mul a5~42@ d5~48@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%5 (= temp_5_0~949@ temp_5_1~1014@))))) (=> (= temp_5_0~949@ temp_5_1~1014@) (=> (= temp_6_0~1111@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) c6~54@) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ c6~54@))) (Mul d6~56@ (Mul (Mul b6~52@ 30) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1172@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) c6~54@) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ c6~54@))) (Mul d6~56@ (Mul (Mul b6~52@ 30) (Mul a6~50@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ a6~50@) (=> %%location_label%%6 (= temp_6_0~1111@ temp_6_1~1172@))) (=> (= temp_6_0~1111@ temp_6_1~1172@) (=> (= temp_7_0~1245@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Sub d7~64@ c7~62@)) (Mul c7~62@ d7~64@)) (Mul (Add (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@)) c7~62@))) (=> (= temp_7_1~1290@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Sub d7~64@ c7~62@)) (Mul c7~62@ d7~64@)) (Mul c7~62@ (Add (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@))))) (and (=> (= tmp%6@ (Add (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ c7~62@) (=> %%location_label%%7 (= temp_7_0~1245@ temp_7_1~1290@)))) (=> (= temp_7_0~1245@ temp_7_1~1290@) (=> (= temp_8_0~1363@ (Mul c8~70@ (Mul (Mul b8~68@ (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Sub b8~68@ d8~72@))))) (=> (= temp_8_1~1396@ (Mul c8~70@ (Mul (Mul (Mul c8~70@ a8~66@) (Sub b8~68@ d8~72@)) (Mul b8~68@ (Mul d8~72@ a8~66@))))) (=> (= tmp%7@ (Mul b8~68@ (Mul d8~72@ a8~66@))) (=> (= tmp%8@ (Mul (Mul c8~70@ a8~66@) (Sub b8~68@ d8~72@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%8 (= temp_8_0~1363@ temp_8_1~1396@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
