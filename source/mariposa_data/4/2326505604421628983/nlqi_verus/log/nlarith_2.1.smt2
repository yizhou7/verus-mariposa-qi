...
(assert (=> %%query%% (not (=> (= temp_0_0~129@ (Mul (Mul c0~6@ (Sub (Sub d0~8@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Mul c0~6@ (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~178@ (Mul (Mul c0~6@ (Sub (Sub d0~8@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Mul c0~6@ (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~129@ temp_0_1~178@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~258@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))) (Sub (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~323@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))) (Sub (Mul d1~16@ (Mul d1~16@ (Mul b1~12@ b1~12@))) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~258@ temp_1_1~323@)) (=> %%location_label%%1 tmp%2@))))))))))))
(assert %%query%%)
(check-sat)
