...
(declare-const temp_2_1~468@ Int)
(declare-const temp_3_0~568@ Int)
(declare-const temp_3_1~653@ Int)
(declare-const temp_4_0~721@ Int)
(declare-const temp_4_1~774@ Int)
...
(declare-const temp_8_1~1242@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~129@ (Mul (Mul c0~6@ (Sub (Sub d0~8@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Mul c0~6@ (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~178@ (Mul (Mul c0~6@ (Sub (Sub d0~8@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Mul c0~6@ (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~129@ temp_0_1~178@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~258@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))) (Sub (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~323@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))) (Sub (Mul d1~16@ (Mul d1~16@ (Mul b1~12@ b1~12@))) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@))))) (=> (= tmp%2@ (= temp_1_0~258@ temp_1_1~323@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~403@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@))) (Mul (Mul (Add c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~468@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul (Mul a2~18@ d2~24@) d2~24@) c2~22@)) (Mul (Mul (Add c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~403@ temp_2_1~468@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~568@ (Mul (Mul (Sub (Sub 73 b3~28@) (Mul d3~32@ c3~30@)) (Add (Mul d3~32@ a3~26@) (Add b3~28@ d3~32@))) (Add (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ 10)) (Sub a3~26@ (Add b3~28@ d3~32@))))) (=> (= temp_3_1~653@ (Mul (Mul (Sub (Sub 73 b3~28@) (Mul d3~32@ c3~30@)) (Add (Mul d3~32@ a3~26@) (Add b3~28@ d3~32@))) (Add (Mul (Mul (Mul c3~30@ b3~28@) a3~26@) 10) (Sub a3~26@ (Add b3~28@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~568@ temp_3_1~653@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~721@ (Mul (Sub (Mul (Add c4~38@ c4~38@) (Sub b4~36@ a4~34@)) d4~40@) (Mul (Mul (Sub b4~36@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Add c4~38@ d4~40@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~774@ (Mul (Sub (Mul (Add c4~38@ c4~38@) (Sub b4~36@ a4~34@)) d4~40@) (Mul (Mul (Sub b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Mul (Add c4~38@ d4~40@) (Mul a4~34@ d4~40@))))) (=> (= tmp%5@ (= temp_4_0~721@ temp_4_1~774@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~854@ (Sub (Mul (Sub (Mul a5~42@ c5~46@) (Sub b5~44@ c5~46@)) (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@))) (Sub (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~919@ (Sub (Mul (Sub (Mul a5~42@ c5~46@) (Sub b5~44@ c5~46@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@))) (Sub (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@))))) (=> (= tmp%6@ (= temp_5_0~854@ temp_5_1~919@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~995@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) c6~54@) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ c6~54@))) (Mul d6~56@ (Mul (Mul b6~52@ 30) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1056@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) c6~54@) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ c6~54@))) (Mul d6~56@ (Mul (Mul b6~52@ 30) (Mul a6~50@ d6~56@))))) (=> (= tmp%7@ (= temp_6_0~995@ temp_6_1~1056@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1116@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Sub d7~64@ c7~62@)) (Mul c7~62@ d7~64@)) (Mul (Add (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@)) c7~62@))) (=> (= temp_7_1~1161@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Sub d7~64@ c7~62@)) (Mul c7~62@ d7~64@)) (Mul c7~62@ (Add (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1116@ temp_7_1~1161@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1209@ (Mul c8~70@ (Mul (Mul b8~68@ (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Sub b8~68@ d8~72@))))) (=> (= temp_8_1~1242@ (Mul c8~70@ (Mul (Mul (Mul c8~70@ a8~66@) (Sub b8~68@ d8~72@)) (Mul b8~68@ (Mul d8~72@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1209@ temp_8_1~1242@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
