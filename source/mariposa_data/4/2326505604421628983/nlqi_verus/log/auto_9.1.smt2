...
(declare-const temp_2_1~486@ Int)
(declare-const temp_3_0~595@ Int)
(declare-const temp_3_1~680@ Int)
(declare-const temp_4_0~757@ Int)
(declare-const temp_4_1~810@ Int)
...
(declare-const temp_7_0~1179@ Int)
(declare-const temp_7_1~1224@ Int)
(declare-const temp_8_0~1281@ Int)
(declare-const temp_8_1~1314@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~129@ (Mul (Mul c0~6@ (Sub (Sub d0~8@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Mul c0~6@ (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ c0~6@))))) (=> (= temp_0_1~178@ (Mul (Mul c0~6@ (Sub (Sub d0~8@ c0~6@) (Mul b0~4@ b0~4@))) (Mul (Mul c0~6@ (Mul d0~8@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~129@ temp_0_1~178@))) (=> (= temp_0_0~129@ temp_0_1~178@) (=> (= temp_1_0~267@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))) (Sub (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@))))) (=> (= temp_1_1~332@ (Mul (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))) (Sub (Mul d1~16@ (Mul d1~16@ (Mul b1~12@ b1~12@))) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ b1~12@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~267@ temp_1_1~332@))) (=> (= temp_1_0~267@ temp_1_1~332@) (=> (= temp_2_0~421@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@))) (Mul (Mul (Add c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@))))) (=> (= temp_2_1~486@ (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Mul (Mul a2~18@ d2~24@) d2~24@) c2~22@)) (Mul (Mul (Add c2~22@ a2~18@) (Mul b2~20@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~421@ temp_2_1~486@))) (=> (= temp_2_0~421@ temp_2_1~486@) (=> (= temp_3_0~595@ (Mul (Mul (Sub (Sub 73 b3~28@) (Mul d3~32@ c3~30@)) (Add (Mul d3~32@ a3~26@) (Add b3~28@ d3~32@))) (Add (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ 10)) (Sub a3~26@ (Add b3~28@ d3~32@))))) (=> (= temp_3_1~680@ (Mul (Mul (Sub (Sub 73 b3~28@) (Mul d3~32@ c3~30@)) (Add (Mul d3~32@ a3~26@) (Add b3~28@ d3~32@))) (Add (Mul (Mul (Mul c3~30@ b3~28@) a3~26@) 10) (Sub a3~26@ (Add b3~28@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~595@ temp_3_1~680@))) (=> (= temp_3_0~595@ temp_3_1~680@) (=> (= temp_4_0~757@ (Mul (Sub (Mul (Add c4~38@ c4~38@) (Sub b4~36@ a4~34@)) d4~40@) (Mul (Mul (Sub b4~36@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Add c4~38@ d4~40@) (Mul a4~34@ d4~40@))))) (=> (= temp_4_1~810@ (Mul (Sub (Mul (Add c4~38@ c4~38@) (Sub b4~36@ a4~34@)) d4~40@) (Mul (Mul (Sub b4~36@ c4~38@) (Mul d4~40@ b4~36@)) (Mul (Add c4~38@ d4~40@) (Mul a4~34@ d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~757@ temp_4_1~810@))) (=> (= temp_4_0~757@ temp_4_1~810@) (=> (= temp_5_0~899@ (Sub (Mul (Sub (Mul a5~42@ c5~46@) (Sub b5~44@ c5~46@)) (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@))) (Sub (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@))))) (=> (= temp_5_1~964@ (Sub (Mul (Sub (Mul a5~42@ c5~46@) (Sub b5~44@ c5~46@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@))) (Sub (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~899@ temp_5_1~964@))) (=> (= temp_5_0~899@ temp_5_1~964@) (=> (= temp_6_0~1049@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) c6~54@) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ c6~54@))) (Mul d6~56@ (Mul (Mul b6~52@ 30) (Mul d6~56@ a6~50@))))) (=> (= temp_6_1~1110@ (Mul (Mul (Mul (Mul b6~52@ b6~52@) c6~54@) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ c6~54@))) (Mul d6~56@ (Mul (Mul b6~52@ 30) (Mul a6~50@ d6~56@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1049@ temp_6_1~1110@))) (=> (= temp_6_0~1049@ temp_6_1~1110@) (=> (= temp_7_0~1179@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Sub d7~64@ c7~62@)) (Mul c7~62@ d7~64@)) (Mul (Add (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@)) c7~62@))) (=> (= temp_7_1~1224@ (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Sub d7~64@ c7~62@)) (Mul c7~62@ d7~64@)) (Mul c7~62@ (Add (Mul d7~64@ a7~58@) (Mul d7~64@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1179@ temp_7_1~1224@))) (=> (= temp_7_0~1179@ temp_7_1~1224@) (=> (= temp_8_0~1281@ (Mul c8~70@ (Mul (Mul b8~68@ (Mul d8~72@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Sub b8~68@ d8~72@))))) (=> (= temp_8_1~1314@ (Mul c8~70@ (Mul (Mul (Mul c8~70@ a8~66@) (Sub b8~68@ d8~72@)) (Mul b8~68@ (Mul d8~72@ a8~66@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1281@ temp_8_1~1314@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
