...
(set-info :comment ";; mariposa_data/4//83875760999736797/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~309@ Int)
(declare-const temp_1_1~374@ Int)
(declare-const temp_2_0~479@ Int)
(declare-const temp_2_1~556@ Int)
(declare-const temp_3_0~655@ Int)
(declare-const temp_3_1~736@ Int)
...
(declare-const temp_7_1~1418@ Int)
(declare-const temp_8_0~1519@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Add (Mul (Sub b0~4@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@)) (Add (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~210@ (Mul (Add (Mul (Mul (Sub b0~4@ d0~8@) c0~6@) d0~8@) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@)) (Add (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@))))) (and (=> (= tmp%1@ (Sub b0~4@ d0~8@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ c0~6@ d0~8@) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@)))) (=> (= temp_0_0~145@ temp_0_1~210@) (=> (= temp_1_0~309@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ d1~16@)) (Add (Add d1~16@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Sub d1~16@ d1~16@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~374@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@)) (Add (Add d1~16@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Sub d1~16@ d1~16@) (Mul c1~14@ a1~10@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d1~16@ c1~14@) (=> %%location_label%%1 (= temp_1_0~309@ temp_1_1~374@))) (=> (= temp_1_0~309@ temp_1_1~374@) (=> (= temp_2_0~479@ (Mul (Mul (Sub (Sub 8 a2~18@) (Sub c2~22@ d2~24@)) (Sub (Mul c2~22@ b2~20@) (Mul b2~20@ c2~22@))) (Mul (Mul (Add b2~20@ c2~22@) (Add a2~18@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~556@ (Mul (Mul (Sub (Sub 8 a2~18@) (Sub c2~22@ d2~24@)) (Sub (Mul c2~22@ b2~20@) (Mul b2~20@ c2~22@))) (Mul (Mul (Add b2~20@ c2~22@) (Add a2~18@ d2~24@)) (Mul b2~20@ (Mul d2~24@ (Mul b2~20@ d2~24@)))))) (and (=> (= tmp%2@ (Mul b2~20@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b2~20@ d2~24@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~479@ temp_2_1~556@)))) (=> (= temp_2_0~479@ temp_2_1~556@) (=> (= temp_3_0~655@ (Add (Mul (Mul (Mul c3~30@ b3~28@) (Sub d3~32@ d3~32@)) (Sub (Mul c3~30@ c3~30@) (Mul a3~26@ a3~26@))) (Mul (Mul (Sub b3~28@ a3~26@) (Sub b3~28@ b3~28@)) (Mul (Add a3~26@ d3~32@) (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~736@ (Add (Sub (Mul (Mul (Mul c3~30@ b3~28@) (Sub d3~32@ d3~32@)) (Mul c3~30@ c3~30@)) (Mul (Mul (Mul c3~30@ b3~28@) (Sub d3~32@ d3~32@)) (Mul a3~26@ a3~26@))) (Mul (Mul (Sub b3~28@ a3~26@) (Sub b3~28@ b3~28@)) (Mul (Add a3~26@ d3~32@) (Mul b3~28@ c3~30@))))) (and (=> (= tmp%3@ (Mul (Mul c3~30@ b3~28@) (Sub d3~32@ d3~32@))) (=> (= tmp%4@ (Mul c3~30@ c3~30@)) (=> (= tmp%5@ (Mul a3~26@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%3 (= temp_3_0~655@ temp_3_1~736@)))))) (=> (= temp_3_0~655@ temp_3_1~736@) (=> (= temp_4_0~863@ (Mul (Add (Mul (Mul d4~40@ 59) (Mul c4~38@ a4~34@)) (Mul (Sub a4~34@ c4~38@) (Mul d4~40@ a4~34@))) (Mul (Mul (Sub a4~34@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@))))) (=> (= temp_4_1~940@ (Mul (Add (Mul (Mul d4~40@ 59) (Mul c4~38@ a4~34@)) (Mul (Sub a4~34@ c4~38@) (Mul d4~40@ a4~34@))) (Mul (Sub a4~34@ b4~36@) (Mul (Mul a4~34@ a4~34@) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@)))))) (and (=> (= tmp%6@ (Sub a4~34@ b4~36@)) (=> (= tmp%7@ (Mul a4~34@ a4~34@)) (=> (= tmp%8@ (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~863@ temp_4_1~940@)))))) (=> (= temp_4_0~863@ temp_4_1~940@) (=> (= temp_5_0~1067@ (Mul (Mul (Sub (Mul a5~42@ d5~48@) (Mul a5~42@ a5~42@)) (Mul (Sub b5~44@ d5~48@) (Sub a5~42@ d5~48@))) (Mul (Mul (Mul 73 b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1160@ (Mul (Sub (Mul (Mul a5~42@ d5~48@) (Mul (Sub b5~44@ d5~48@) (Sub a5~42@ d5~48@))) (Mul (Mul a5~42@ a5~42@) (Mul (Sub b5~44@ d5~48@) (Sub a5~42@ d5~48@)))) (Mul (Mul (Mul 73 b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))))) (and (=> (= tmp%9@ (Mul a5~42@ d5~48@)) (=> (= tmp%10@ (Mul a5~42@ a5~42@)) (=> (= tmp%11@ (Mul (Sub b5~44@ d5~48@) (Sub a5~42@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%5 (= temp_5_0~1067@ temp_5_1~1160@)))))) (=> (= temp_5_0~1067@ temp_5_1~1160@) (=> (= temp_6_0~1263@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Add b6~52@ a6~50@))) (Mul a6~50@ (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1316@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@ a6~50@) (Add b6~52@ a6~50@))) (Mul a6~50@ (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ b6~52@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ c6~54@) (=> %%location_label%%6 (= temp_6_0~1263@ temp_6_1~1316@))) (=> (= temp_6_0~1263@ temp_6_1~1316@) (=> (= temp_7_0~1381@ (Mul (Add (Mul (Sub b7~60@ a7~58@) (Sub c7~62@ a7~58@)) (Mul (Add a7~58@ b7~60@) (Mul a7~58@ a7~58@))) a7~58@)) (=> (= temp_7_1~1418@ (Mul (Add (Mul (Sub c7~62@ a7~58@) (Sub b7~60@ a7~58@)) (Mul (Add a7~58@ b7~60@) (Mul a7~58@ a7~58@))) a7~58@)) (and (=> (= tmp%12@ (Sub b7~60@ a7~58@)) (=> (= tmp%13@ (Sub c7~62@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%7 (= temp_7_0~1381@ temp_7_1~1418@))))) (=> (= temp_7_0~1381@ temp_7_1~1418@) (=> (= temp_8_0~1519@ (Mul (Mul (Mul (Add d8~72@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1584@ (Mul (Mul (Mul (Add d8~72@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ a8~66@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ a8~66@))))) (=> (= tmp%14@ (Mul b8~68@ a8~66@)) (=> (= tmp%15@ (Mul a8~66@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ tmp%15@) (=> %%location_label%%8 (= temp_8_0~1519@ temp_8_1~1584@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
