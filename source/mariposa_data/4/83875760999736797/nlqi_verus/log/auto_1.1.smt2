...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Add (Mul (Sub b0~4@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@)) (Add (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~210@ (Mul (Add (Mul (Mul (Sub b0~4@ d0~8@) c0~6@) d0~8@) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@)) (Add (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@))))))))
(assert %%query%%)
(check-sat)
