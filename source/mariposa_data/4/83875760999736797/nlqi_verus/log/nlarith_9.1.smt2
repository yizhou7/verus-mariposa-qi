...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Add (Mul (Sub b0~4@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@)) (Add (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@))))) (=> (= temp_0_1~210@ (Mul (Add (Mul (Mul (Sub b0~4@ d0~8@) c0~6@) d0~8@) (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ d0~8@)) (Add (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@))))) (=> (= tmp%1@ (= temp_0_0~145@ temp_0_1~210@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~290@ (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ d1~16@)) (Add (Add d1~16@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Sub d1~16@ d1~16@) (Mul c1~14@ a1~10@))))) (=> (= temp_1_1~355@ (Mul (Mul (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@)) (Add (Add d1~16@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Sub d1~16@ d1~16@) (Mul c1~14@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~290@ temp_1_1~355@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~447@ (Mul (Mul (Sub (Sub 8 a2~18@) (Sub c2~22@ d2~24@)) (Sub (Mul c2~22@ b2~20@) (Mul b2~20@ c2~22@))) (Mul (Mul (Add b2~20@ c2~22@) (Add a2~18@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ d2~24@))))) (=> (= temp_2_1~524@ (Mul (Mul (Sub (Sub 8 a2~18@) (Sub c2~22@ d2~24@)) (Sub (Mul c2~22@ b2~20@) (Mul b2~20@ c2~22@))) (Mul (Mul (Add b2~20@ c2~22@) (Add a2~18@ d2~24@)) (Mul b2~20@ (Mul d2~24@ (Mul b2~20@ d2~24@)))))) (=> (= tmp%3@ (= temp_2_0~447@ temp_2_1~524@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~604@ (Add (Mul (Mul (Mul c3~30@ b3~28@) (Sub d3~32@ d3~32@)) (Sub (Mul c3~30@ c3~30@) (Mul a3~26@ a3~26@))) (Mul (Mul (Sub b3~28@ a3~26@) (Sub b3~28@ b3~28@)) (Mul (Add a3~26@ d3~32@) (Mul b3~28@ c3~30@))))) (=> (= temp_3_1~685@ (Add (Sub (Mul (Mul (Mul c3~30@ b3~28@) (Sub d3~32@ d3~32@)) (Mul c3~30@ c3~30@)) (Mul (Mul (Mul c3~30@ b3~28@) (Sub d3~32@ d3~32@)) (Mul a3~26@ a3~26@))) (Mul (Mul (Sub b3~28@ a3~26@) (Sub b3~28@ b3~28@)) (Mul (Add a3~26@ d3~32@) (Mul b3~28@ c3~30@))))) (=> (= tmp%4@ (= temp_3_0~604@ temp_3_1~685@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~777@ (Mul (Add (Mul (Mul d4~40@ 59) (Mul c4~38@ a4~34@)) (Mul (Sub a4~34@ c4~38@) (Mul d4~40@ a4~34@))) (Mul (Mul (Sub a4~34@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@))))) (=> (= temp_4_1~854@ (Mul (Add (Mul (Mul d4~40@ 59) (Mul c4~38@ a4~34@)) (Mul (Sub a4~34@ c4~38@) (Mul d4~40@ a4~34@))) (Mul (Sub a4~34@ b4~36@) (Mul (Mul a4~34@ a4~34@) (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@)))))) (=> (= tmp%5@ (= temp_4_0~777@ temp_4_1~854@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~946@ (Mul (Mul (Sub (Mul a5~42@ d5~48@) (Mul a5~42@ a5~42@)) (Mul (Sub b5~44@ d5~48@) (Sub a5~42@ d5~48@))) (Mul (Mul (Mul 73 b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))))) (=> (= temp_5_1~1039@ (Mul (Sub (Mul (Mul a5~42@ d5~48@) (Mul (Sub b5~44@ d5~48@) (Sub a5~42@ d5~48@))) (Mul (Mul a5~42@ a5~42@) (Mul (Sub b5~44@ d5~48@) (Sub a5~42@ d5~48@)))) (Mul (Mul (Mul 73 b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))))) (=> (= tmp%6@ (= temp_5_0~946@ temp_5_1~1039@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1107@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Add b6~52@ a6~50@))) (Mul a6~50@ (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1160@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@ a6~50@) (Add b6~52@ a6~50@))) (Mul a6~50@ (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ b6~52@))))) (=> (= tmp%7@ (= temp_6_0~1107@ temp_6_1~1160@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1212@ (Mul (Add (Mul (Sub b7~60@ a7~58@) (Sub c7~62@ a7~58@)) (Mul (Add a7~58@ b7~60@) (Mul a7~58@ a7~58@))) a7~58@)) (=> (= temp_7_1~1249@ (Mul (Add (Mul (Sub c7~62@ a7~58@) (Sub b7~60@ a7~58@)) (Mul (Add a7~58@ b7~60@) (Mul a7~58@ a7~58@))) a7~58@)) (=> (= tmp%8@ (= temp_7_0~1212@ temp_7_1~1249@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1329@ (Mul (Mul (Mul (Add d8~72@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ a8~66@))))) (=> (= temp_8_1~1394@ (Mul (Mul (Mul (Add d8~72@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ a8~66@))) (Mul (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ a8~66@))))) (=> (= tmp%9@ (= temp_8_0~1329@ temp_8_1~1394@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
