...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Add (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul b0~4@ c0~6@) (Add d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~210@ (Mul (Add (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@)) (Mul d0~8@ (Mul a0~2@ (Mul c0~6@ c0~6@)))) (Mul (Mul (Mul b0~4@ c0~6@) (Add d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@))) (=> (= temp_0_0~145@ temp_0_1~210@) (=> (= temp_1_0~295@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Add a1~10@ a1~10@))) (Add (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@)) (Mul c1~14@ (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~356@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Add a1~10@ a1~10@))) (Add (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@)) (Mul c1~14@ (Mul d1~16@ d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~295@ temp_1_1~356@))) (=> (= temp_1_0~295@ temp_1_1~356@) (=> (= temp_2_0~457@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ 10)) (Mul (Add b2~20@ b2~20@) (Mul a2~18@ b2~20@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~534@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ 10)) (Mul (Mul a2~18@ b2~20@) (Add b2~20@ b2~20@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~457@ temp_2_1~534@))))))))))))))))
(assert %%query%%)
(check-sat)
