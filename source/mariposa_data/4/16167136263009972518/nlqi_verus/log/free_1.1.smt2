...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~149@ (Mul (Add (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul b0~4@ c0~6@) (Add d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~214@ (Mul (Add (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@)) (Mul d0~8@ (Mul a0~2@ (Mul c0~6@ c0~6@)))) (Mul (Mul (Mul b0~4@ c0~6@) (Add d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~149@ temp_0_1~214@)) (=> %%location_label%%0 tmp%1@))))))))
(assert %%query%%)
(check-sat)
