...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Mul (Add (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul b0~4@ c0~6@) (Add d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@))))) (=> (= temp_0_1~210@ (Mul (Add (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@)) (Mul d0~8@ (Mul a0~2@ (Mul c0~6@ c0~6@)))) (Mul (Mul (Mul b0~4@ c0~6@) (Add d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@))))) (=> (= tmp%1@ (= temp_0_0~145@ temp_0_1~210@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~286@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Add a1~10@ a1~10@))) (Add (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@)) (Mul c1~14@ (Mul d1~16@ d1~16@))))) (=> (= temp_1_1~347@ (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Add a1~10@ a1~10@))) (Add (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@)) (Mul c1~14@ (Mul d1~16@ d1~16@))))) (=> (= tmp%2@ (= temp_1_0~286@ temp_1_1~347@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~439@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ 10)) (Mul (Add b2~20@ b2~20@) (Mul a2~18@ b2~20@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))))) (=> (= temp_2_1~516@ (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ 10)) (Mul (Mul a2~18@ b2~20@) (Add b2~20@ b2~20@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))))) (=> (= tmp%3@ (= temp_2_0~439@ temp_2_1~516@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~592@ (Add (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ d3~32@)) (Mul b3~28@ (Mul b3~28@ a3~26@))))) (=> (= temp_3_1~653@ (Add (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@))) (Mul (Mul b3~28@ (Mul b3~28@ a3~26@)) (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~592@ temp_3_1~653@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~733@ (Sub (Mul (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@ c4~38@) (Add a4~34@ b4~36@))) (Sub (Mul (Mul a4~34@ a4~34@) (Add c4~38@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~798@ (Sub (Mul (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@ c4~38@) (Add a4~34@ b4~36@))) (Sub (Mul (Mul a4~34@ a4~34@) (Add c4~38@ d4~40@)) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ a4~34@))))) (=> (= tmp%5@ (= temp_4_0~733@ temp_4_1~798@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~890@ (Mul (Mul (Mul (Add a5~42@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ 4))))) (=> (= temp_5_1~967@ (Mul (Mul (Mul (Add a5~42@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul (Mul d5~48@ b5~44@) a5~42@) a5~42@)) (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ 4))))) (=> (= tmp%6@ (= temp_5_0~890@ temp_5_1~967@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~1043@ (Mul (Add (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Add b6~52@ a6~50@))) (Mul (Add a6~50@ (Mul d6~56@ d6~56@)) (Sub (Mul d6~56@ d6~56@) (Mul a6~50@ a6~50@))))) (=> (= temp_6_1~1104@ (Mul (Mul (Add a6~50@ (Mul d6~56@ d6~56@)) (Sub (Mul d6~56@ d6~56@) (Mul a6~50@ a6~50@))) (Add (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Add b6~52@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~1043@ temp_6_1~1104@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1180@ (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ b7~60@))) (Add (Mul (Mul d7~64@ a7~58@) a7~58@) (Mul (Mul d7~64@ b7~60@) (Add c7~62@ d7~64@))))) (=> (= temp_7_1~1241@ (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@)) (Mul d7~64@ (Mul d7~64@ (Mul d7~64@ b7~60@)))) (Add (Mul (Mul d7~64@ a7~58@) a7~58@) (Mul (Mul d7~64@ b7~60@) (Add c7~62@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1180@ temp_7_1~1241@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1297@ (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ a8~66@)) b8~68@) (Sub (Sub (Add b8~68@ b8~68@) (Mul a8~66@ b8~68@)) b8~68@))) (=> (= temp_8_1~1338@ (Mul (Mul (Mul d8~72@ a8~66@) (Mul (Mul b8~68@ a8~66@) b8~68@)) (Sub (Sub (Add b8~68@ b8~68@) (Mul a8~66@ b8~68@)) b8~68@))) (=> (= tmp%9@ (= temp_8_0~1297@ temp_8_1~1338@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
