...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~145@ (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul d0~8@ (Sub c0~6@ b0~4@))) (Mul (Mul (Mul c0~6@ b0~4@) (Add c0~6@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@))))) (=> (= temp_0_1~206@ (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ (Sub c0~6@ b0~4@)) (Mul (Mul (Mul c0~6@ b0~4@) (Add c0~6@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@)))))) (=> (= tmp%1@ (= temp_0_0~145@ temp_0_1~206@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~294@ (Mul (Mul (Mul a1~10@ (Mul b1~12@ a1~10@)) (Mul (Add a1~10@ 81) (Mul a1~10@ c1~14@))) (Mul (Sub (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~367@ (Mul (Mul (Mul a1~10@ (Mul b1~12@ a1~10@)) (Mul (Add a1~10@ 81) (Mul a1~10@ c1~14@))) (Mul (Sub (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))))) (=> (= tmp%2@ (= temp_1_0~294@ temp_1_1~367@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~447@ (Sub (Mul (Mul (Sub a2~18@ c2~22@) (Mul a2~18@ c2~22@)) (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ d2~24@))) (Mul (Mul (Add a2~18@ c2~22@) (Mul b2~20@ b2~20@)) (Add (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~512@ (Sub (Mul (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Sub a2~18@ c2~22@) (Mul a2~18@ c2~22@))) (Mul (Mul (Add a2~18@ c2~22@) (Mul b2~20@ b2~20@)) (Add (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= tmp%3@ (= temp_2_0~447@ temp_2_1~512@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~592@ (Add (Mul (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ a3~26@) (Add a3~26@ d3~32@))))) (=> (= temp_3_1~657@ (Add (Mul (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ a3~26@) (Add a3~26@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~592@ temp_3_1~657@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~737@ (Add (Add (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ d4~40@)) (Add (Add b4~36@ c4~38@) (Sub a4~34@ d4~40@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~802@ (Add (Add (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ d4~40@)) (Add (Add b4~36@ c4~38@) (Sub a4~34@ d4~40@))) (Mul (Mul b4~36@ b4~36@) (Mul (Mul d4~40@ b4~36@) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@)))))) (=> (= tmp%5@ (= temp_4_0~737@ temp_4_1~802@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~862@ (Mul (Mul (Mul (Add d5~48@ a5~42@) (Mul c5~46@ b5~44@)) (Mul a5~42@ (Mul a5~42@ c5~46@))) (Mul d5~48@ (Add (Mul a5~42@ d5~48@) c5~46@)))) (=> (= temp_5_1~907@ (Mul (Mul (Mul (Mul (Add d5~48@ a5~42@) (Mul c5~46@ b5~44@)) a5~42@) (Mul a5~42@ c5~46@)) (Mul d5~48@ (Add (Mul a5~42@ d5~48@) c5~46@)))) (=> (= tmp%6@ (= temp_5_0~862@ temp_5_1~907@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~987@ (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ d6~56@)) (Mul (Add d6~56@ b6~52@) (Mul c6~54@ d6~56@))) (Mul (Mul (Sub a6~50@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1052@ (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ d6~56@)) (Mul (Add d6~56@ b6~52@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@)) (Mul (Sub a6~50@ d6~56@) (Mul b6~52@ a6~50@))))) (=> (= tmp%7@ (= temp_6_0~987@ temp_6_1~1052@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1132@ (Mul (Mul (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@)) (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1197@ (Mul (Mul (Mul (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@)) (Mul b7~60@ b7~60@)) (Mul c7~62@ b7~60@)) (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@))))) (=> (= tmp%8@ (= temp_7_0~1132@ temp_7_1~1197@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1277@ (Sub (Mul (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Sub b8~68@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) (Add c8~70@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~1342@ (Sub (Mul (Mul (Mul b8~68@ d8~72@) (Sub b8~68@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) (Add c8~70@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ c8~70@))))) (=> (= tmp%9@ (= temp_8_0~1277@ temp_8_1~1342@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
