...
(assert (=> %%query%% (not (=> (= temp_0_0~141@ (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul d0~8@ (Sub c0~6@ b0~4@))) (Mul (Mul (Mul c0~6@ b0~4@) (Add c0~6@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@))))) (=> (= temp_0_1~202@ (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ (Sub c0~6@ b0~4@)) (Mul (Mul (Mul c0~6@ b0~4@) (Add c0~6@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@)))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~141@ temp_0_1~202@))))))))
(assert %%query%%)
(check-sat)
