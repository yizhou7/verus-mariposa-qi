...
(set-info :comment ";; mariposa_data/4//12136879021407394420/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~353@ Int)
(declare-const temp_1_1~426@ Int)
(declare-const temp_2_0~527@ Int)
(declare-const temp_2_1~592@ Int)
(declare-const temp_3_0~709@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~141@ (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul d0~8@ (Sub c0~6@ b0~4@))) (Mul (Mul (Mul c0~6@ b0~4@) (Add c0~6@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@))))) (=> (= temp_0_1~202@ (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@)) (Mul (Mul d0~8@ (Sub c0~6@ b0~4@)) (Mul (Mul (Mul c0~6@ b0~4@) (Add c0~6@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@)))))) (and (=> (= tmp%1@ (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ c0~6@))) (=> (= tmp%2@ (Mul d0~8@ (Sub c0~6@ b0~4@))) (=> (= tmp%3@ (Mul (Mul (Mul c0~6@ b0~4@) (Add c0~6@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~141@ temp_0_1~202@)))))) (=> (= temp_0_0~141@ temp_0_1~202@) (=> (= temp_1_0~353@ (Mul (Mul (Mul a1~10@ (Mul b1~12@ a1~10@)) (Mul (Add a1~10@ 81) (Mul a1~10@ c1~14@))) (Mul (Sub (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ c1~14@))))) (=> (= temp_1_1~426@ (Mul (Mul (Mul a1~10@ (Mul b1~12@ a1~10@)) (Mul (Add a1~10@ 81) (Mul a1~10@ c1~14@))) (Mul (Sub (Mul b1~12@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@))))) (and (=> (= tmp%4@ (Mul c1~14@ a1~10@)) (=> (= tmp%5@ (Mul a1~10@ c1~14@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~353@ temp_1_1~426@))))) (=> (= temp_1_0~353@ temp_1_1~426@) (=> (= temp_2_0~527@ (Sub (Mul (Mul (Sub a2~18@ c2~22@) (Mul a2~18@ c2~22@)) (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ d2~24@))) (Mul (Mul (Add a2~18@ c2~22@) (Mul b2~20@ b2~20@)) (Add (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))))) (=> (= temp_2_1~592@ (Sub (Mul (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Sub a2~18@ c2~22@) (Mul a2~18@ c2~22@))) (Mul (Mul (Add a2~18@ c2~22@) (Mul b2~20@ b2~20@)) (Add (Mul a2~18@ b2~20@) (Mul b2~20@ b2~20@))))) (and (=> (= tmp%6@ (Mul (Sub a2~18@ c2~22@) (Mul a2~18@ c2~22@))) (=> (= tmp%7@ (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ d2~24@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~527@ temp_2_1~592@))))) (=> (= temp_2_0~527@ temp_2_1~592@) (=> (= temp_3_0~709@ (Add (Mul (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ a3~26@) (Add a3~26@ d3~32@))))) (=> (= temp_3_1~774@ (Add (Mul (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ a3~26@) (Add a3~26@ d3~32@))))) (and (=> (= tmp%8@ (Mul b3~28@ b3~28@)) (=> (= tmp%9@ (Mul c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%3 (= temp_3_0~709@ temp_3_1~774@))))) (=> (= temp_3_0~709@ temp_3_1~774@) (=> (= temp_4_0~875@ (Add (Add (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ d4~40@)) (Add (Add b4~36@ c4~38@) (Sub a4~34@ d4~40@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@))))) (=> (= temp_4_1~940@ (Add (Add (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ d4~40@)) (Add (Add b4~36@ c4~38@) (Sub a4~34@ d4~40@))) (Mul (Mul b4~36@ b4~36@) (Mul (Mul d4~40@ b4~36@) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@)))))) (and (=> (= tmp%10@ (Mul b4~36@ b4~36@)) (=> (= tmp%11@ (Mul d4~40@ b4~36@)) (=> (= tmp%12@ (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ tmp%11@ tmp%12@) (=> %%location_label%%4 (= temp_4_0~875@ temp_4_1~940@)))))) (=> (= temp_4_0~875@ temp_4_1~940@) (=> (= temp_5_0~1035@ (Mul (Mul (Mul (Add d5~48@ a5~42@) (Mul c5~46@ b5~44@)) (Mul a5~42@ (Mul a5~42@ c5~46@))) (Mul d5~48@ (Add (Mul a5~42@ d5~48@) c5~46@)))) (=> (= temp_5_1~1080@ (Mul (Mul (Mul (Mul (Add d5~48@ a5~42@) (Mul c5~46@ b5~44@)) a5~42@) (Mul a5~42@ c5~46@)) (Mul d5~48@ (Add (Mul a5~42@ d5~48@) c5~46@)))) (and (=> (= tmp%13@ (Mul (Add d5~48@ a5~42@) (Mul c5~46@ b5~44@))) (=> (= tmp%14@ (Mul a5~42@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%13@ a5~42@ tmp%14@) (=> %%location_label%%5 (= temp_5_0~1035@ temp_5_1~1080@))))) (=> (= temp_5_0~1035@ temp_5_1~1080@) (=> (= temp_6_0~1191@ (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ d6~56@)) (Mul (Add d6~56@ b6~52@) (Mul c6~54@ d6~56@))) (Mul (Mul (Sub a6~50@ d6~56@) (Mul b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@))))) (=> (= temp_6_1~1256@ (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ d6~56@)) (Mul (Add d6~56@ b6~52@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@)) (Mul (Sub a6~50@ d6~56@) (Mul b6~52@ a6~50@))))) (and (=> (= tmp%15@ (Mul (Sub a6~50@ d6~56@) (Mul b6~52@ a6~50@))) (=> (= tmp%16@ (Mul (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%15@ tmp%16@) (=> %%location_label%%6 (= temp_6_0~1191@ temp_6_1~1256@))))) (=> (= temp_6_0~1191@ temp_6_1~1256@) (=> (= temp_7_0~1373@ (Mul (Mul (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@)) (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@))))) (=> (= temp_7_1~1438@ (Mul (Mul (Mul (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@)) (Mul b7~60@ b7~60@)) (Mul c7~62@ b7~60@)) (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ a7~58@))))) (and (=> (= tmp%17@ (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@))) (=> (= tmp%18@ (Mul b7~60@ b7~60@)) (=> (= tmp%19@ (Mul c7~62@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ tmp%18@ tmp%19@) (=> %%location_label%%7 (= temp_7_0~1373@ temp_7_1~1438@)))))) (=> (= temp_7_0~1373@ temp_7_1~1438@) (=> (= temp_8_0~1553@ (Sub (Mul (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Sub b8~68@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) (Add c8~70@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ c8~70@))))) (=> (= temp_8_1~1618@ (Sub (Mul (Mul (Mul b8~68@ d8~72@) (Sub b8~68@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul d8~72@ b8~68@) (Add c8~70@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ c8~70@))))) (=> (= tmp%20@ (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ a8~66@))) (=> (= tmp%21@ (Mul (Mul b8~68@ d8~72@) (Sub b8~68@ a8~66@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%20@ tmp%21@) (=> %%location_label%%8 (= temp_8_0~1553@ temp_8_1~1618@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
