...
;; mariposa_data/4//18390010195970499668/nlqi_verus/src/main.rs:7:1: 16:36 (#0)
(push)
 ...
 (declare-const temp_0_1~206@ Int)
 (declare-const temp_1_0~278@ Int)
 (declare-const temp_1_1~335@ Int)
 (declare-const temp_2_0~423@ Int)
 (declare-const temp_2_1~496@ Int)
 (declare-const temp_3_0~576@ Int)
 (declare-const temp_3_1~673@ Int)
 (declare-const temp_4_0~745@ Int)
 (declare-const temp_4_1~818@ Int)
 (declare-const temp_5_0~874@ Int)
 (declare-const temp_5_1~915@ Int)
 (declare-const temp_6_0~979@ Int)
 (declare-const temp_6_1~1028@ Int)
 (declare-const temp_7_0~1100@ Int)
 (declare-const temp_7_1~1157@ Int)
 (declare-const temp_8_0~1233@ Int)
 ...
 (assert
  (=>
   ...
   (not (=>
     ...
     (=>
      (= temp_0_0~145@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Add a0~2@ c0~6@)) (Mul (Mul c0~6@ d0~8@)
          d0~8@
         )
        ) (Sub d0~8@ (Mul (Sub c0~6@ b0~4@) (Add 65 a0~2@)))
      ))
      (=>
       (= temp_0_1~206@ (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Add a0~2@ c0~6@)) (Mul c0~6@ (Mul d0~8@
            d0~8@
          ))
         ) (Sub d0~8@ (Mul (Sub c0~6@ b0~4@) (Add 65 a0~2@)))
       ))
       (=>
        (= tmp%1@ (= temp_0_0~145@ temp_0_1~206@))
        (and
         (=>
          %%location_label%%0
          tmp%1@
         ...
         (=>
          tmp%1@
          (=>
           (= temp_1_0~278@ (Mul (Mul (Sub (Mul d1~16@ c1~14@) (Sub b1~12@ a1~10@)) (Mul (Mul b1~12@
                b1~12@
               ) (Mul d1~16@ b1~12@)
              )
             ) (Mul (Mul a1~10@ (Mul a1~10@ c1~14@)) (Mul b1~12@ (Add b1~12@ d1~16@)))
           ))
           (=>
            (= temp_1_1~335@ (Mul (Mul (Sub (Mul d1~16@ c1~14@) (Sub b1~12@ a1~10@)) (Mul (Mul b1~12@
                 b1~12@
                ) (Mul d1~16@ b1~12@)
               )
              ) (Mul (Mul (Mul a1~10@ a1~10@) c1~14@) (Mul b1~12@ (Add b1~12@ d1~16@)))
            ))
            (=>
             (= tmp%2@ (= temp_1_0~278@ temp_1_1~335@))
             (and
              (=>
               %%location_label%%1
               tmp%2@
              ...
              (=>
               tmp%2@
               (=>
                (= temp_2_0~423@ (Mul (Mul (Mul b2~20@ (Mul a2~18@ a2~18@)) (Mul (Mul c2~22@ b2~20@)
                    (Mul c2~22@ a2~18@)
                   )
                  ) (Mul (Add (Mul c2~22@ b2~20@) (Mul c2~22@ d2~24@)) (Add (Add b2~20@ 77) (Sub c2~22@
                     a2~18@
                )))))
                (=>
                 (= temp_2_1~496@ (Mul (Mul (Mul (Mul b2~20@ a2~18@) a2~18@) (Mul (Mul c2~22@ b2~20@)
                     (Mul c2~22@ a2~18@)
                    )
                   ) (Mul (Add (Mul c2~22@ b2~20@) (Mul c2~22@ d2~24@)) (Add (Add b2~20@ 77) (Sub c2~22@
                      a2~18@
                 ...
                 (=>
                  (= tmp%3@ (= temp_2_0~423@ temp_2_1~496@))
                  (and
                   (=>
                    %%location_label%%2
                    tmp%3@
                   ...
                   (=>
                    tmp%3@
                    (=>
                     (= temp_3_0~576@ (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@
                          a3~26@
                         ) (Add a3~26@ d3~32@)
                        )
                       ) (Add (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@
                          c3~30@
                     )))))
                     (=>
                      (= temp_3_1~673@ (Add (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@)) (Mul (Mul
                            a3~26@ a3~26@
                           ) (Add a3~26@ d3~32@)
                          )
                         ) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ d3~32@))
                        ) (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (
                            Add a3~26@ d3~32@
                          ))
                         ) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@))
                      )))
                      (=>
                       (= tmp%4@ (= temp_3_0~576@ temp_3_1~673@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%4@
                        ...
                        (=>
                         tmp%4@
                         (=>
                          (= temp_4_0~745@ (Mul (Mul (Sub b4~36@ (Mul c4~38@ c4~38@)) (Add (Mul a4~34@ c4~38@)
                              (Mul d4~40@ a4~34@)
                             )
                            ) (Mul (Add (Mul a4~34@ c4~38@) c4~38@) (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@)))
                          ))
                          (=>
                           (= temp_4_1~818@ (Mul (Mul (Sub b4~36@ (Mul c4~38@ c4~38@)) (Add (Mul a4~34@ c4~38@)
                               (Mul d4~40@ a4~34@)
                              )
                             ) (Add (Mul (Mul a4~34@ c4~38@) (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@))) (Mul
                               c4~38@ (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ d4~40@))
                           ))))
                           (=>
                            (= tmp%5@ (= temp_4_0~745@ temp_4_1~818@))
                            (and
                             (=>
                              %%location_label%%4
                              tmp%5@
                             ...
                             (=>
                              tmp%5@
                              (=>
                               (= temp_5_0~874@ (Mul (Mul a5~42@ (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@))) (Mul
                                  (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ b5~44@)) a5~42@
                               )))
                               (=>
                                (= temp_5_1~915@ (Mul (Mul a5~42@ (Mul (Mul (Mul a5~42@ c5~46@) b5~44@) d5~48@)) (Mul
                                   (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ b5~44@)) a5~42@
                                )))
                                (=>
                                 (= tmp%6@ (= temp_5_0~874@ temp_5_1~915@))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   tmp%6@
                                  ...
                                  (=>
                                   tmp%6@
                                   (=>
                                    (= temp_6_0~979@ (Mul (Mul (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Mul a6~50@
                                         b6~52@
                                        ) b6~52@
                                       )
                                      ) (Mul b6~52@ (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ b6~52@)))
                                    ))
                                    (=>
                                     (= temp_6_1~1028@ (Mul (Mul (Mul (Mul (Mul c6~54@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Mul
                                           a6~50@ b6~52@
                                          ) b6~52@
                                         )
                                        ) b6~52@
                                       ) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ b6~52@))
                                     ))
                                     (=>
                                      (= tmp%7@ (= temp_6_0~979@ temp_6_1~1028@))
                                      (and
                                       (=>
                                        %%location_label%%6
                                        tmp%7@
                                       ...
                                       (=>
                                        tmp%7@
                                        (=>
                                         (= temp_7_0~1100@ (Add (Mul (Mul (Mul d7~64@ c7~62@) (Add d7~64@ 7)) c7~62@) (Mul (Mul
                                             (Mul a7~58@ a7~58@) c7~62@
                                            ) (Sub b7~60@ (Mul d7~64@ c7~62@))
                                         )))
                                         (=>
                                          (= temp_7_1~1157@ (Add (Mul (Mul (Mul d7~64@ c7~62@) (Add d7~64@ 7)) c7~62@) (Mul (Mul
                                              (Mul a7~58@ a7~58@) c7~62@
                                             ) (Sub b7~60@ (Mul c7~62@ d7~64@))
                                          )))
                                          (=>
                                           (= tmp%8@ (= temp_7_0~1100@ temp_7_1~1157@))
                                           (and
                                            (=>
                                             %%location_label%%7
                                             tmp%8@
                                            ...
                                            (=>
                                             tmp%8@
                                             (=>
                                              (= temp_8_0~1233@ (Mul (Mul (Add (Add d8~72@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@
                                                   b8~68@
                                                  ) (Mul b8~68@ c8~70@)
                                                 )
                                                ) (Mul (Mul a8~66@ (Mul c8~70@ c8~70@)) (Mul (Add d8~72@ c8~70@) (Mul a8~66@ a8~66@)))
                                              ))
                                              (=>
                                               (= temp_8_1~1294@ (Mul (Mul (Add (Add d8~72@ c8~70@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@
                                                    b8~68@
                                                   ) (Mul b8~68@ c8~70@)
                                                  )
                                                 ) (Mul (Mul (Add d8~72@ c8~70@) (Mul a8~66@ a8~66@)) (Mul a8~66@ (Mul c8~70@ c8~70@)))
                                               ))
                                               (=>
                                                (= tmp%9@ (= temp_8_0~1233@ temp_8_1~1294@))
                                                (=>
                                                 %%location_label%%8
                                                 tmp%9@
 ))))))))))))))))))))))))))))))))))))))))))))))))
