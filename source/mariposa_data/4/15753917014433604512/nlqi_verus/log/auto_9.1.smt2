...
(declare-const temp_1_1~292@ Int)
(declare-const temp_2_0~377@ Int)
(declare-const temp_2_1~438@ Int)
(declare-const temp_3_0~527@ Int)
(declare-const temp_3_1~592@ Int)
(declare-const temp_4_0~693@ Int)
(declare-const temp_4_1~770@ Int)
(declare-const temp_5_0~859@ Int)
(declare-const temp_5_1~924@ Int)
(declare-const temp_6_0~1013@ Int)
(declare-const temp_6_1~1078@ Int)
(declare-const temp_7_0~1167@ Int)
(declare-const temp_7_1~1232@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~129@ (Mul (Mul (Mul d0~8@ (Sub b0~4@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~178@ (Mul (Mul (Mul d0~8@ (Sub b0~4@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul a0~2@ d0~8@) (Mul (Mul b0~4@ b0~4@) c0~6@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~129@ temp_0_1~178@))) (=> (= temp_0_0~129@ temp_0_1~178@) (=> (= temp_1_0~247@ (Sub (Mul a1~10@ (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@))) (Mul (Mul (Sub c1~14@ c1~14@) (Mul c1~14@ b1~12@)) (Mul b1~12@ d1~16@)))) (=> (= temp_1_1~292@ (Sub (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@)) a1~10@) (Mul (Mul (Sub c1~14@ c1~14@) (Mul c1~14@ b1~12@)) (Mul b1~12@ d1~16@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~247@ temp_1_1~292@))) (=> (= temp_1_0~247@ temp_1_1~292@) (=> (= temp_2_0~377@ (Mul (Mul (Mul a2~18@ (Mul b2~20@ b2~20@)) (Mul (Add b2~20@ a2~18@) (Add b2~20@ d2~24@))) (Add (Mul (Mul a2~18@ c2~22@) (Sub a2~18@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Sub b2~20@ c2~22@))))) (=> (= temp_2_1~438@ (Mul (Mul a2~18@ (Mul b2~20@ b2~20@)) (Mul (Mul (Add b2~20@ a2~18@) (Add b2~20@ d2~24@)) (Add (Mul (Mul a2~18@ c2~22@) (Sub a2~18@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Sub b2~20@ c2~22@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~377@ temp_2_1~438@))) (=> (= temp_2_0~377@ temp_2_1~438@) (=> (= temp_3_0~527@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) (Add (Add d3~32@ d3~32@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul a3~26@ b3~28@) (Add a3~26@ b3~28@))))) (=> (= temp_3_1~592@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul a3~26@ b3~28@) (Add a3~26@ b3~28@))) (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) (Add (Add d3~32@ d3~32@) (Mul d3~32@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~527@ temp_3_1~592@))) (=> (= temp_3_0~527@ temp_3_1~592@) (=> (= temp_4_0~693@ (Mul (Mul (Mul (Sub b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul 46 a4~34@))))) (=> (= temp_4_1~770@ (Mul (Mul (Mul (Sub b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul (Mul c4~38@ c4~38@) a4~34@) c4~38@)) (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul 46 a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~693@ temp_4_1~770@))) (=> (= temp_4_0~693@ temp_4_1~770@) (=> (= temp_5_0~859@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~924@ (Mul (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@))) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@))) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~859@ temp_5_1~924@))) (=> (= temp_5_0~859@ temp_5_1~924@) (=> (= temp_6_0~1013@ (Mul (Add (Mul (Mul c6~54@ a6~50@) (Sub c6~54@ b6~52@)) (Mul (Mul d6~56@ d6~56@) (Add c6~54@ b6~52@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1078@ (Mul (Add (Mul (Mul c6~54@ a6~50@) (Sub c6~54@ b6~52@)) (Mul d6~56@ (Mul d6~56@ (Add c6~54@ b6~52@)))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1013@ temp_6_1~1078@))) (=> (= temp_6_0~1013@ temp_6_1~1078@) (=> (= temp_7_0~1167@ (Add (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@)) (Add (Add d7~64@ d7~64@) (Sub b7~60@ a7~58@))))) (=> (= temp_7_1~1232@ (Add (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Add (Add d7~64@ d7~64@) (Sub b7~60@ a7~58@)) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1167@ temp_7_1~1232@))) (=> (= temp_7_0~1167@ temp_7_1~1232@) (=> (= temp_8_0~1309@ (Add (Mul b8~68@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ d8~72@))) (Mul (Mul (Sub b8~68@ a8~66@) (Add a8~66@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Sub a8~66@ d8~72@))))) (=> (= temp_8_1~1362@ (Add (Mul b8~68@ (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Sub b8~68@ a8~66@) (Add a8~66@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Sub a8~66@ d8~72@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1309@ temp_8_1~1362@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
