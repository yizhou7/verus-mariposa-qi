...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~133@ (Mul (Mul (Mul d0~8@ (Sub b0~4@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~182@ (Mul (Mul (Mul d0~8@ (Sub b0~4@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul a0~2@ d0~8@) (Mul (Mul b0~4@ b0~4@) c0~6@)))) (=> (= tmp%1@ (= temp_0_0~133@ temp_0_1~182@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~242@ (Sub (Mul a1~10@ (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@))) (Mul (Mul (Sub c1~14@ c1~14@) (Mul c1~14@ b1~12@)) (Mul b1~12@ d1~16@)))) (=> (= temp_1_1~287@ (Sub (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@)) a1~10@) (Mul (Mul (Sub c1~14@ c1~14@) (Mul c1~14@ b1~12@)) (Mul b1~12@ d1~16@)))) (=> (= tmp%2@ (= temp_1_0~242@ temp_1_1~287@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~363@ (Mul (Mul (Mul a2~18@ (Mul b2~20@ b2~20@)) (Mul (Add b2~20@ a2~18@) (Add b2~20@ d2~24@))) (Add (Mul (Mul a2~18@ c2~22@) (Sub a2~18@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Sub b2~20@ c2~22@))))) (=> (= temp_2_1~424@ (Mul (Mul a2~18@ (Mul b2~20@ b2~20@)) (Mul (Mul (Add b2~20@ a2~18@) (Add b2~20@ d2~24@)) (Add (Mul (Mul a2~18@ c2~22@) (Sub a2~18@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Sub b2~20@ c2~22@)))))) (=> (= tmp%3@ (= temp_2_0~363@ temp_2_1~424@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~504@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) (Add (Add d3~32@ d3~32@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul a3~26@ b3~28@) (Add a3~26@ b3~28@))))) (=> (= temp_3_1~569@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul a3~26@ b3~28@) (Add a3~26@ b3~28@))) (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) (Add (Add d3~32@ d3~32@) (Mul d3~32@ d3~32@))))) (=> (= tmp%4@ (= temp_3_0~504@ temp_3_1~569@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~661@ (Mul (Mul (Mul (Sub b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul 46 a4~34@))))) (=> (= temp_4_1~738@ (Mul (Mul (Mul (Sub b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul (Mul c4~38@ c4~38@) a4~34@) c4~38@)) (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul 46 a4~34@))))) (=> (= tmp%5@ (= temp_4_0~661@ temp_4_1~738@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~818@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~883@ (Mul (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@))) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@))) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)))) (=> (= tmp%6@ (= temp_5_0~818@ temp_5_1~883@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~963@ (Mul (Add (Mul (Mul c6~54@ a6~50@) (Sub c6~54@ b6~52@)) (Mul (Mul d6~56@ d6~56@) (Add c6~54@ b6~52@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1028@ (Mul (Add (Mul (Mul c6~54@ a6~50@) (Sub c6~54@ b6~52@)) (Mul d6~56@ (Mul d6~56@ (Add c6~54@ b6~52@)))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (= tmp%7@ (= temp_6_0~963@ temp_6_1~1028@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~1108@ (Add (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@)) (Add (Add d7~64@ d7~64@) (Sub b7~60@ a7~58@))))) (=> (= temp_7_1~1173@ (Add (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Add (Add d7~64@ d7~64@) (Sub b7~60@ a7~58@)) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@))))) (=> (= tmp%8@ (= temp_7_0~1108@ temp_7_1~1173@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~1241@ (Add (Mul b8~68@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ d8~72@))) (Mul (Mul (Sub b8~68@ a8~66@) (Add a8~66@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Sub a8~66@ d8~72@))))) (=> (= temp_8_1~1294@ (Add (Mul b8~68@ (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Sub b8~68@ a8~66@) (Add a8~66@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Sub a8~66@ d8~72@))))) (=> (= tmp%9@ (= temp_8_0~1241@ temp_8_1~1294@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
