...
(assert (=> %%query%% (not (=> (= temp_0_0~129@ (Mul (Mul (Mul d0~8@ (Sub b0~4@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~178@ (Mul (Mul (Mul d0~8@ (Sub b0~4@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul a0~2@ d0~8@) (Mul (Mul b0~4@ b0~4@) c0~6@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ b0~4@ c0~6@) (=> %%location_label%%0 (= temp_0_0~129@ temp_0_1~178@))) (=> (= temp_0_0~129@ temp_0_1~178@) (=> (= temp_1_0~253@ (Sub (Mul a1~10@ (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@))) (Mul (Mul (Sub c1~14@ c1~14@) (Mul c1~14@ b1~12@)) (Mul b1~12@ d1~16@)))) (=> (= temp_1_1~298@ (Sub (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@)) a1~10@) (Mul (Mul (Sub c1~14@ c1~14@) (Mul c1~14@ b1~12@)) (Mul b1~12@ d1~16@)))) (and (=> (= tmp%1@ (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ tmp%1@) (=> %%location_label%%1 (= temp_1_0~253@ temp_1_1~298@)))) (=> (= temp_1_0~253@ temp_1_1~298@) (=> (= temp_2_0~399@ (Mul (Mul (Mul a2~18@ (Mul b2~20@ b2~20@)) (Mul (Add b2~20@ a2~18@) (Add b2~20@ d2~24@))) (Add (Mul (Mul a2~18@ c2~22@) (Sub a2~18@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Sub b2~20@ c2~22@))))) (=> (= temp_2_1~460@ (Mul (Mul a2~18@ (Mul b2~20@ b2~20@)) (Mul (Mul (Add b2~20@ a2~18@) (Add b2~20@ d2~24@)) (Add (Mul (Mul a2~18@ c2~22@) (Sub a2~18@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Sub b2~20@ c2~22@)))))) (=> (= tmp%2@ (Mul a2~18@ (Mul b2~20@ b2~20@))) (=> (= tmp%3@ (Mul (Add b2~20@ a2~18@) (Add b2~20@ d2~24@))) (=> (= tmp%4@ (Add (Mul (Mul a2~18@ c2~22@) (Sub a2~18@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Sub b2~20@ c2~22@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~399@ temp_2_1~460@)))))))))))))))))))
(assert %%query%%)
(check-sat)
