...
(set-info :comment ";; mariposa_data/4//15753917014433604512/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_0_0~129@ Int)
(declare-const temp_0_1~178@ Int)
(declare-const temp_1_0~253@ Int)
(declare-const temp_1_1~298@ Int)
(declare-const temp_2_0~399@ Int)
(declare-const temp_2_1~460@ Int)
(declare-const temp_3_0~603@ Int)
(declare-const temp_3_1~668@ Int)
(declare-const temp_4_0~829@ Int)
(declare-const temp_4_1~906@ Int)
(declare-const temp_5_0~1005@ Int)
(declare-const temp_5_1~1070@ Int)
...
(declare-const temp_8_0~1551@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~129@ (Mul (Mul (Mul d0~8@ (Sub b0~4@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ (Mul b0~4@ c0~6@))))) (=> (= temp_0_1~178@ (Mul (Mul (Mul d0~8@ (Sub b0~4@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@))) (Mul (Mul a0~2@ d0~8@) (Mul (Mul b0~4@ b0~4@) c0~6@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b0~4@ b0~4@ c0~6@) (=> %%location_label%%0 (= temp_0_0~129@ temp_0_1~178@))) (=> (= temp_0_0~129@ temp_0_1~178@) (=> (= temp_1_0~253@ (Sub (Mul a1~10@ (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@))) (Mul (Mul (Sub c1~14@ c1~14@) (Mul c1~14@ b1~12@)) (Mul b1~12@ d1~16@)))) (=> (= temp_1_1~298@ (Sub (Mul (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@)) a1~10@) (Mul (Mul (Sub c1~14@ c1~14@) (Mul c1~14@ b1~12@)) (Mul b1~12@ d1~16@)))) (and (=> (= tmp%1@ (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ a1~10@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ tmp%1@) (=> %%location_label%%1 (= temp_1_0~253@ temp_1_1~298@)))) (=> (= temp_1_0~253@ temp_1_1~298@) (=> (= temp_2_0~399@ (Mul (Mul (Mul a2~18@ (Mul b2~20@ b2~20@)) (Mul (Add b2~20@ a2~18@) (Add b2~20@ d2~24@))) (Add (Mul (Mul a2~18@ c2~22@) (Sub a2~18@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Sub b2~20@ c2~22@))))) (=> (= temp_2_1~460@ (Mul (Mul a2~18@ (Mul b2~20@ b2~20@)) (Mul (Mul (Add b2~20@ a2~18@) (Add b2~20@ d2~24@)) (Add (Mul (Mul a2~18@ c2~22@) (Sub a2~18@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Sub b2~20@ c2~22@)))))) (and (=> (= tmp%2@ (Mul a2~18@ (Mul b2~20@ b2~20@))) (=> (= tmp%3@ (Mul (Add b2~20@ a2~18@) (Add b2~20@ d2~24@))) (=> (= tmp%4@ (Add (Mul (Mul a2~18@ c2~22@) (Sub a2~18@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Sub b2~20@ c2~22@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%2@ tmp%3@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~399@ temp_2_1~460@)))))) (=> (= temp_2_0~399@ temp_2_1~460@) (=> (= temp_3_0~603@ (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) (Add (Add d3~32@ d3~32@) (Mul d3~32@ d3~32@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul a3~26@ b3~28@) (Add a3~26@ b3~28@))))) (=> (= temp_3_1~668@ (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul a3~26@ b3~28@) (Add a3~26@ b3~28@))) (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) (Add (Add d3~32@ d3~32@) (Mul d3~32@ d3~32@))))) (and (=> (= tmp%5@ (Mul (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) (Add (Add d3~32@ d3~32@) (Mul d3~32@ d3~32@)))) (=> (= tmp%6@ (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ c3~30@)) (Add (Mul a3~26@ b3~28@) (Add a3~26@ b3~28@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~603@ temp_3_1~668@))))) (=> (= temp_3_0~603@ temp_3_1~668@) (=> (= temp_4_0~829@ (Mul (Mul (Mul (Sub b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul 46 a4~34@))))) (=> (= temp_4_1~906@ (Mul (Mul (Mul (Sub b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul (Mul c4~38@ c4~38@) a4~34@) c4~38@)) (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul 46 a4~34@))))) (and (=> (= tmp%7@ (Mul c4~38@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ a4~34@ c4~38@) (=> %%location_label%%4 (= temp_4_0~829@ temp_4_1~906@)))) (=> (= temp_4_0~829@ temp_4_1~906@) (=> (= temp_5_0~1005@ (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@))))) (=> (= temp_5_1~1070@ (Mul (Mul (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@))) (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@))) (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@)))) (and (=> (= tmp%8@ (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@)))) (=> (= tmp%9@ (Mul (Mul b5~44@ c5~46@) (Mul d5~48@ d5~48@))) (=> (= tmp%10@ (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ a5~42@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%5 (= temp_5_0~1005@ temp_5_1~1070@)))))) (=> (= temp_5_0~1005@ temp_5_1~1070@) (=> (= temp_6_0~1217@ (Mul (Add (Mul (Mul c6~54@ a6~50@) (Sub c6~54@ b6~52@)) (Mul (Mul d6~56@ d6~56@) (Add c6~54@ b6~52@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (= temp_6_1~1282@ (Mul (Add (Mul (Mul c6~54@ a6~50@) (Sub c6~54@ b6~52@)) (Mul d6~56@ (Mul d6~56@ (Add c6~54@ b6~52@)))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@))))) (and (=> (= tmp%11@ (Add c6~54@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d6~56@ d6~56@ tmp%11@) (=> %%location_label%%6 (= temp_6_0~1217@ temp_6_1~1282@)))) (=> (= temp_6_0~1217@ temp_6_1~1282@) (=> (= temp_7_0~1381@ (Add (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@)) (Add (Add d7~64@ d7~64@) (Sub b7~60@ a7~58@))))) (=> (= temp_7_1~1446@ (Add (Mul (Mul (Mul a7~58@ d7~64@) (Add a7~58@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Add (Add d7~64@ d7~64@) (Sub b7~60@ a7~58@)) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@))))) (and (=> (= tmp%12@ (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@))) (=> (= tmp%13@ (Add (Add d7~64@ d7~64@) (Sub b7~60@ a7~58@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%7 (= temp_7_0~1381@ temp_7_1~1446@))))) (=> (= temp_7_0~1381@ temp_7_1~1446@) (=> (= temp_8_0~1551@ (Add (Mul b8~68@ (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ d8~72@))) (Mul (Mul (Sub b8~68@ a8~66@) (Add a8~66@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Sub a8~66@ d8~72@))))) (=> (= temp_8_1~1604@ (Add (Mul b8~68@ (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Sub b8~68@ a8~66@) (Add a8~66@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Sub a8~66@ d8~72@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1551@ temp_8_1~1604@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
