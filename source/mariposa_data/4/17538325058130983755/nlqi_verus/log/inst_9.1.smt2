...
(set-info :comment ";; mariposa_data/4//17538325058130983755/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~333@ Int)
(declare-const temp_1_1~406@ Int)
(declare-const temp_2_0~507@ Int)
(declare-const temp_2_1~572@ Int)
(declare-const temp_3_0~733@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Sub (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@))) (Mul (Sub (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Sub d0~8@ c0~6@))))) (=> (= temp_0_1~210@ (Sub (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ a0~2@)) (Mul d0~8@ d0~8@)) (Mul c0~6@ b0~4@)) (Mul (Sub (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Sub d0~8@ c0~6@))))) (and (=> (= tmp%1@ (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ a0~2@))) (=> (= tmp%2@ (Mul d0~8@ d0~8@)) (=> (= tmp%3@ (Mul c0~6@ b0~4@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@)))))) (=> (= temp_0_0~145@ temp_0_1~210@) (=> (= temp_1_0~333@ (Mul (Mul (Mul (Sub c1~14@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ 56))) (Add (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Sub a1~10@ b1~12@) d1~16@)))) (=> (= temp_1_1~406@ (Mul (Mul (Mul (Sub c1~14@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ 56))) (Add (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Sub a1~10@ b1~12@) d1~16@)))) (and (=> (= tmp%4@ (Mul a1~10@ c1~14@)) (=> (= tmp%5@ (Mul b1~12@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~333@ temp_1_1~406@))))) (=> (= temp_1_0~333@ temp_1_1~406@) (=> (= temp_2_0~507@ (Mul (Add (Add (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@)) (Sub (Sub d2~24@ b2~20@) (Sub b2~20@ d2~24@))))) (=> (= temp_2_1~572@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@)) (Sub (Sub d2~24@ b2~20@) (Sub b2~20@ d2~24@))) (Add (Add (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@))))) (and (=> (= tmp%6@ (Add (Add (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@)))) (=> (= tmp%7@ (Mul (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@)) (Sub (Sub d2~24@ b2~20@) (Sub b2~20@ d2~24@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~507@ temp_2_1~572@))))) (=> (= temp_2_0~507@ temp_2_1~572@) (=> (= temp_3_0~733@ (Mul (Mul (Mul (Add a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ 2) (Mul d3~32@ b3~28@))) (Mul (Mul (Sub c3~30@ c3~30@) (Add d3~32@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~818@ (Mul (Mul (Mul (Add a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ 2) (Mul d3~32@ b3~28@))) (Mul (Add (Mul (Sub c3~30@ c3~30@) d3~32@) (Mul (Sub c3~30@ c3~30@) c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ d3~32@))))) (and (=> (= tmp%8@ (Sub c3~30@ c3~30@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%8@ d3~32@ c3~30@) (=> %%location_label%%3 (= temp_3_0~733@ temp_3_1~818@)))) (=> (= temp_3_0~733@ temp_3_1~818@) (=> (= temp_4_0~913@ (Mul (Mul (Mul (Add a4~34@ b4~36@) (Add b4~36@ b4~36@)) (Mul a4~34@ (Mul c4~38@ a4~34@))) (Mul (Mul (Add d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~974@ (Mul (Mul (Mul (Add a4~34@ b4~36@) (Add b4~36@ b4~36@)) (Mul a4~34@ (Mul c4~38@ a4~34@))) (Mul (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Add d4~40@ b4~36@) (Mul d4~40@ a4~34@))))) (and (=> (= tmp%9@ (Mul (Add d4~40@ b4~36@) (Mul d4~40@ a4~34@))) (=> (= tmp%10@ (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ a4~34@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%4 (= temp_4_0~913@ temp_4_1~974@))))) (=> (= temp_4_0~913@ temp_4_1~974@) (=> (= temp_5_0~1087@ (Sub (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) (Sub (Mul d5~48@ b5~44@) (Add b5~44@ b5~44@))) (Mul (Mul d5~48@ (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Add c5~46@ c5~46@))))) (=> (= temp_5_1~1148@ (Sub (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) (Sub (Mul d5~48@ b5~44@) (Add b5~44@ b5~44@))) (Mul (Mul d5~48@ (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Add c5~46@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ a5~42@) (=> %%location_label%%5 (= temp_5_0~1087@ temp_5_1~1148@))) (=> (= temp_5_0~1087@ temp_5_1~1148@) (=> (= temp_6_0~1229@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@)) c6~54@) (Mul (Mul (Add c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Sub (Mul d6~56@ c6~54@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1282@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@)) c6~54@) (Mul (Mul (Add c6~54@ d6~56@) (Mul b6~52@ d6~56@)) (Sub (Mul d6~56@ c6~54@) (Mul d6~56@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ b6~52@) (=> %%location_label%%6 (= temp_6_0~1229@ temp_6_1~1282@))) (=> (= temp_6_0~1229@ temp_6_1~1282@) (=> (= temp_7_0~1371@ (Mul (Mul (Mul b7~60@ (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Add d7~64@ a7~58@) (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1432@ (Mul (Mul (Mul b7~60@ (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul a7~58@ d7~64@) (Add d7~64@ a7~58@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))))) (and (=> (= tmp%11@ (Add d7~64@ a7~58@)) (=> (= tmp%12@ (Mul a7~58@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%7 (= temp_7_0~1371@ temp_7_1~1432@))))) (=> (= temp_7_0~1371@ temp_7_1~1432@) (=> (= temp_8_0~1541@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Mul 15 d8~72@)) (Sub (Mul b8~68@ d8~72@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) d8~72@) (Mul (Mul d8~72@ d8~72@) (Sub b8~68@ a8~66@))))) (=> (= temp_8_1~1614@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Mul 15 d8~72@)) (Sub (Mul b8~68@ d8~72@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) d8~72@) (Mul (Mul d8~72@ d8~72@) (Sub b8~68@ a8~66@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. d8~72@ d8~72@) (=> %%location_label%%8 (= temp_8_0~1541@ temp_8_1~1614@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
