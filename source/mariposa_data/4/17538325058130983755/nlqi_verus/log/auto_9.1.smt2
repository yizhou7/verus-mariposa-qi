...
(declare-const temp_1_1~380@ Int)
(declare-const temp_2_0~469@ Int)
(declare-const temp_2_1~534@ Int)
(declare-const temp_3_0~635@ Int)
(declare-const temp_3_1~720@ Int)
(declare-const temp_4_0~805@ Int)
(declare-const temp_4_1~866@ Int)
(declare-const temp_5_0~951@ Int)
(declare-const temp_5_1~1012@ Int)
(declare-const temp_6_0~1089@ Int)
(declare-const temp_6_1~1142@ Int)
(declare-const temp_7_0~1227@ Int)
(declare-const temp_7_1~1288@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~145@ (Sub (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@))) (Mul (Sub (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Sub d0~8@ c0~6@))))) (=> (= temp_0_1~210@ (Sub (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ a0~2@)) (Mul d0~8@ d0~8@)) (Mul c0~6@ b0~4@)) (Mul (Sub (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Sub d0~8@ c0~6@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~145@ temp_0_1~210@))) (=> (= temp_0_0~145@ temp_0_1~210@) (=> (= temp_1_0~307@ (Mul (Mul (Mul (Sub c1~14@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ 56))) (Add (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Sub a1~10@ b1~12@) d1~16@)))) (=> (= temp_1_1~380@ (Mul (Mul (Mul (Sub c1~14@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ 56))) (Add (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Sub a1~10@ b1~12@) d1~16@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~307@ temp_1_1~380@))) (=> (= temp_1_0~307@ temp_1_1~380@) (=> (= temp_2_0~469@ (Mul (Add (Add (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@)) (Sub (Sub d2~24@ b2~20@) (Sub b2~20@ d2~24@))))) (=> (= temp_2_1~534@ (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul b2~20@ a2~18@)) (Sub (Sub d2~24@ b2~20@) (Sub b2~20@ d2~24@))) (Add (Add (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~469@ temp_2_1~534@))) (=> (= temp_2_0~469@ temp_2_1~534@) (=> (= temp_3_0~635@ (Mul (Mul (Mul (Add a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ 2) (Mul d3~32@ b3~28@))) (Mul (Mul (Sub c3~30@ c3~30@) (Add d3~32@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ d3~32@))))) (=> (= temp_3_1~720@ (Mul (Mul (Mul (Add a3~26@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ 2) (Mul d3~32@ b3~28@))) (Mul (Add (Mul (Sub c3~30@ c3~30@) d3~32@) (Mul (Sub c3~30@ c3~30@) c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~635@ temp_3_1~720@))) (=> (= temp_3_0~635@ temp_3_1~720@) (=> (= temp_4_0~805@ (Mul (Mul (Mul (Add a4~34@ b4~36@) (Add b4~36@ b4~36@)) (Mul a4~34@ (Mul c4~38@ a4~34@))) (Mul (Mul (Add d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ a4~34@))))) (=> (= temp_4_1~866@ (Mul (Mul (Mul (Add a4~34@ b4~36@) (Add b4~36@ b4~36@)) (Mul a4~34@ (Mul c4~38@ a4~34@))) (Mul (Mul (Sub c4~38@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Add d4~40@ b4~36@) (Mul d4~40@ a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~805@ temp_4_1~866@))) (=> (= temp_4_0~805@ temp_4_1~866@) (=> (= temp_5_0~951@ (Sub (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) (Sub (Mul d5~48@ b5~44@) (Add b5~44@ b5~44@))) (Mul (Mul d5~48@ (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Add c5~46@ c5~46@))))) (=> (= temp_5_1~1012@ (Sub (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ a5~42@)) (Sub (Mul d5~48@ b5~44@) (Add b5~44@ b5~44@))) (Mul (Mul d5~48@ (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Add c5~46@ c5~46@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~951@ temp_5_1~1012@))) (=> (= temp_5_0~951@ temp_5_1~1012@) (=> (= temp_6_0~1089@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@)) c6~54@) (Mul (Mul (Add c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Sub (Mul d6~56@ c6~54@) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~1142@ (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@)) c6~54@) (Mul (Mul (Add c6~54@ d6~56@) (Mul b6~52@ d6~56@)) (Sub (Mul d6~56@ c6~54@) (Mul d6~56@ c6~54@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~1089@ temp_6_1~1142@))) (=> (= temp_6_0~1089@ temp_6_1~1142@) (=> (= temp_7_0~1227@ (Mul (Mul (Mul b7~60@ (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Add d7~64@ a7~58@) (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))))) (=> (= temp_7_1~1288@ (Mul (Mul (Mul b7~60@ (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ b7~60@))) (Mul (Mul (Mul a7~58@ d7~64@) (Add d7~64@ a7~58@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~1227@ temp_7_1~1288@))) (=> (= temp_7_0~1227@ temp_7_1~1288@) (=> (= temp_8_0~1385@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Mul 15 d8~72@)) (Sub (Mul b8~68@ d8~72@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) d8~72@) (Mul (Mul d8~72@ d8~72@) (Sub b8~68@ a8~66@))))) (=> (= temp_8_1~1458@ (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Mul 15 d8~72@)) (Sub (Mul b8~68@ d8~72@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) d8~72@) (Mul (Mul d8~72@ d8~72@) (Sub b8~68@ a8~66@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~1385@ temp_8_1~1458@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
