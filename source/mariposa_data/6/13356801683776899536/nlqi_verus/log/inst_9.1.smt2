...
(set-info :comment ";; mariposa_data/6//13356801683776899536/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~869@ Int)
(declare-const temp_1_1~1106@ Int)
(declare-const temp_2_0~1401@ Int)
(declare-const temp_2_1~1694@ Int)
(declare-const temp_3_0~2009@ Int)
(declare-const temp_3_1~2198@ Int)
(declare-const temp_4_0~2405@ Int)
(declare-const temp_4_1~2494@ Int)
(declare-const temp_5_0~2767@ Int)
(declare-const temp_5_1~3040@ Int)
(declare-const temp_6_0~3355@ Int)
(declare-const temp_6_1~3596@ Int)
(declare-const temp_7_0~3829@ Int)
(declare-const temp_7_1~4030@ Int)
(declare-const temp_8_0~4325@ Int)
(declare-const temp_8_1~4586@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~333@ (Mul (Mul (Mul (Sub (Mul (Mul b0~4@ b0~4@) (Sub a0~2@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Sub d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Add b0~4@ b0~4@) (Mul a0~2@ d0~8@)))) (Mul (Add (Sub d0~8@ (Sub 17 c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ 88))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ a0~2@)) (Mul (Sub b0~4@ b0~4@) (Add b0~4@ a0~2@))))) (Mul (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul b0~4@ b0~4@)) (Mul a0~2@ (Mul d0~8@ d0~8@))) (Mul (Mul (Mul a0~2@ a0~2@) (Sub c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ c0~6@)))) (Mul 52 (Mul (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ b0~4@)) (Mul (Mul b0~4@ b0~4@) b0~4@)))))) (=> (= temp_0_1~586@ (Mul (Mul (Mul (Sub (Mul (Mul b0~4@ b0~4@) (Sub a0~2@ d0~8@)) (Mul (Mul d0~8@ c0~6@) (Sub d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Add b0~4@ b0~4@) (Mul a0~2@ d0~8@)))) (Mul (Add (Sub d0~8@ (Sub 17 c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ 88))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul d0~8@ a0~2@)) (Mul (Sub b0~4@ b0~4@) (Add b0~4@ a0~2@))))) (Mul (Mul (Mul (Mul b0~4@ b0~4@) (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ (Mul d0~8@ d0~8@)))) (Mul (Mul (Mul a0~2@ a0~2@) (Sub c0~6@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul a0~2@ c0~6@)))) (Mul 52 (Mul (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ b0~4@)) (Mul (Mul b0~4@ b0~4@) b0~4@)))))) (and (=> (= tmp%1@ (Mul b0~4@ b0~4@)) (=> (= tmp%2@ (Mul b0~4@ b0~4@)) (=> (= tmp%3@ (Mul a0~2@ (Mul d0~8@ d0~8@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~333@ temp_0_1~586@)))))) (=> (= temp_0_0~333@ temp_0_1~586@) (=> (= temp_1_0~869@ (Sub (Mul (Add (Add (Mul (Add a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Mul a1~10@ 78) (Mul c1~14@ a1~10@))) (Add (Sub (Mul b1~12@ b1~12@) (Mul d1~16@ 81)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ a1~10@)))) (Mul (Mul (Mul (Add c1~14@ d1~16@) b1~12@) (Mul (Mul c1~14@ b1~12@) c1~14@)) (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ c1~14@) c1~14@)))) (Mul (Mul b1~12@ (Mul (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@)))) (Sub (Mul (Mul (Add d1~16@ a1~10@) (Mul d1~16@ c1~14@)) (Mul a1~10@ (Mul a1~10@ b1~12@))) (Mul (Mul (Add a1~10@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Add a1~10@ a1~10@) (Mul b1~12@ d1~16@))))))) (=> (= temp_1_1~1106@ (Sub (Mul (Add (Add (Mul (Add a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul (Mul a1~10@ 78) (Mul c1~14@ a1~10@))) (Add (Sub (Mul b1~12@ b1~12@) (Mul d1~16@ 81)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ a1~10@)))) (Mul (Mul (Mul (Add c1~14@ d1~16@) b1~12@) (Mul (Mul c1~14@ b1~12@) c1~14@)) (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ c1~14@) c1~14@)))) (Mul (Mul (Mul b1~12@ (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ b1~12@))) (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@))) (Sub (Mul (Mul (Add d1~16@ a1~10@) (Mul d1~16@ c1~14@)) (Mul a1~10@ (Mul a1~10@ b1~12@))) (Mul (Mul (Add a1~10@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Add a1~10@ a1~10@) (Mul b1~12@ d1~16@))))))) (and (=> (= tmp%4@ (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ b1~12@))) (=> (= tmp%5@ (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ d1~16@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. b1~12@ tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~869@ temp_1_1~1106@))))) (=> (= temp_1_0~869@ temp_1_1~1106@) (=> (= temp_2_0~1401@ (Mul (Mul (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ c2~22@)) (Sub (Mul b2~20@ a2~18@) (Add b2~20@ a2~18@))) (Mul (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul d2~24@ (Mul b2~20@ b2~20@)))) (Mul (Mul (Mul (Mul b2~20@ 74) (Mul c2~22@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ b2~20@))) (Mul (Mul (Sub b2~20@ a2~18@) (Mul b2~20@ b2~20@)) (Mul a2~18@ (Sub b2~20@ a2~18@))))) (Mul (Mul (Sub (Sub (Add b2~20@ b2~20@) (Mul b2~20@ c2~22@)) c2~22@) (Mul (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ b2~20@)) (Sub (Add d2~24@ b2~20@) (Add a2~18@ a2~18@)))) (Sub (Mul (Mul a2~18@ (Mul c2~22@ d2~24@)) (Mul (Sub d2~24@ c2~22@) (Mul c2~22@ a2~18@))) (Add (Mul a2~18@ (Mul a2~18@ d2~24@)) (Mul (Sub a2~18@ d2~24@) (Sub b2~20@ b2~20@))))))) (=> (= temp_2_1~1694@ (Mul (Mul (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ c2~22@)) (Sub (Mul b2~20@ a2~18@) (Add b2~20@ a2~18@))) (Mul (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)) (Mul d2~24@ (Mul b2~20@ b2~20@)))) (Mul (Mul (Mul (Mul b2~20@ 74) (Mul c2~22@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ b2~20@))) (Mul (Mul (Sub b2~20@ a2~18@) (Mul b2~20@ b2~20@)) (Mul a2~18@ (Sub b2~20@ a2~18@))))) (Sub (Mul (Mul (Sub (Sub (Add b2~20@ b2~20@) (Mul b2~20@ c2~22@)) c2~22@) (Mul (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ b2~20@)) (Sub (Add d2~24@ b2~20@) (Add a2~18@ a2~18@)))) (Mul (Mul a2~18@ (Mul c2~22@ d2~24@)) (Mul (Sub d2~24@ c2~22@) (Mul c2~22@ a2~18@)))) (Mul (Mul (Sub (Sub (Add b2~20@ b2~20@) (Mul b2~20@ c2~22@)) c2~22@) (Mul (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ b2~20@)) (Sub (Add d2~24@ b2~20@) (Add a2~18@ a2~18@)))) (Add (Mul a2~18@ (Mul a2~18@ d2~24@)) (Mul (Sub a2~18@ d2~24@) (Sub b2~20@ b2~20@))))))) (and (=> (= tmp%6@ (Mul (Sub (Sub (Add b2~20@ b2~20@) (Mul b2~20@ c2~22@)) c2~22@) (Mul (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ b2~20@)) (Sub (Add d2~24@ b2~20@) (Add a2~18@ a2~18@))))) (=> (= tmp%7@ (Mul (Mul a2~18@ (Mul c2~22@ d2~24@)) (Mul (Sub d2~24@ c2~22@) (Mul c2~22@ a2~18@)))) (=> (= tmp%8@ (Add (Mul a2~18@ (Mul a2~18@ d2~24@)) (Mul (Sub a2~18@ d2~24@) (Sub b2~20@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%2 (= temp_2_0~1401@ temp_2_1~1694@)))))) (=> (= temp_2_0~1401@ temp_2_1~1694@) (=> (= temp_3_0~2009@ (Mul (Sub (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Add a3~26@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ d3~32@))) (Sub (Sub (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ d3~32@) (Add c3~30@ a3~26@)))) (Mul b3~28@ (Add d3~32@ (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ a3~26@))))) (Mul (Mul (Mul (Mul (Sub d3~32@ b3~28@) (Mul a3~26@ d3~32@)) (Add (Mul 11 d3~32@) (Add d3~32@ b3~28@))) c3~30@) (Mul (Sub c3~30@ (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@))) (Sub (Add (Mul b3~28@ b3~28@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ a3~26@))))))) (=> (= temp_3_1~2198@ (Mul (Sub (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Add a3~26@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ d3~32@))) (Sub (Sub (Mul b3~28@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ d3~32@) (Add c3~30@ a3~26@)))) (Mul b3~28@ (Add d3~32@ (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ a3~26@))))) (Mul (Mul (Mul (Mul (Mul (Sub d3~32@ b3~28@) (Mul a3~26@ d3~32@)) (Add (Mul 11 d3~32@) (Add d3~32@ b3~28@))) c3~30@) (Sub c3~30@ (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@)))) (Sub (Add (Mul b3~28@ b3~28@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ a3~26@)))))) (and (=> (= tmp%9@ (Mul (Mul (Mul (Sub d3~32@ b3~28@) (Mul a3~26@ d3~32@)) (Add (Mul 11 d3~32@) (Add d3~32@ b3~28@))) c3~30@)) (=> (= tmp%10@ (Sub c3~30@ (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@)))) (=> (= tmp%11@ (Sub (Add (Mul b3~28@ b3~28@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ a3~26@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%3 (= temp_3_0~2009@ temp_3_1~2198@)))))) (=> (= temp_3_0~2009@ temp_3_1~2198@) (=> (= temp_4_0~2405@ (Mul c4~38@ (Mul (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ a4~34@)) (Mul a4~34@ (Mul a4~34@ b4~36@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ b4~36@)))) (Mul b4~36@ (Mul (Mul (Add a4~34@ d4~40@) (Add b4~36@ c4~38@)) d4~40@))))) (=> (= temp_4_1~2494@ (Mul c4~38@ (Mul (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Mul a4~34@ b4~36@) a4~34@)) (Mul (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ b4~36@)))) (Mul b4~36@ (Mul (Mul (Add a4~34@ d4~40@) (Add b4~36@ c4~38@)) d4~40@))))) (and (=> (= tmp%12@ (Mul a4~34@ b4~36@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ tmp%12@) (=> %%location_label%%4 (= temp_4_0~2405@ temp_4_1~2494@)))) (=> (= temp_4_0~2405@ temp_4_1~2494@) (=> (= temp_5_0~2767@ (Mul (Mul (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ c5~46@))) (Sub (Sub (Add a5~42@ c5~46@) (Mul a5~42@ a5~42@)) (Mul a5~42@ b5~44@))) (Sub (Add (Add (Mul b5~44@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Sub d5~48@ b5~44@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul c5~46@ c5~46@) (Sub d5~48@ d5~48@)) (Mul (Mul d5~48@ a5~42@) d5~48@)))) (Mul (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Sub b5~44@ 82)) c5~46@) (Mul (Sub (Mul c5~46@ c5~46@) (Mul a5~42@ b5~44@)) (Add (Mul c5~46@ a5~42@) (Sub a5~42@ b5~44@)))) (Mul (Mul (Sub (Sub a5~42@ c5~46@) (Mul c5~46@ b5~44@)) (Mul a5~42@ (Mul b5~44@ a5~42@))) (Sub (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@))))))) (=> (= temp_5_1~3040@ (Mul (Mul (Sub (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ c5~46@))) (Sub (Add a5~42@ c5~46@) (Mul a5~42@ a5~42@))) (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ c5~46@))) (Mul a5~42@ b5~44@))) (Sub (Add (Add (Mul b5~44@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Sub d5~48@ b5~44@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul c5~46@ c5~46@) (Sub d5~48@ d5~48@)) (Mul (Mul d5~48@ a5~42@) d5~48@)))) (Mul (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Sub b5~44@ 82)) c5~46@) (Mul (Sub (Mul c5~46@ c5~46@) (Mul a5~42@ b5~44@)) (Add (Mul c5~46@ a5~42@) (Sub a5~42@ b5~44@)))) (Mul (Mul (Sub (Sub a5~42@ c5~46@) (Mul c5~46@ b5~44@)) (Mul a5~42@ (Mul b5~44@ a5~42@))) (Sub (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ b5~44@))))))) (and (=> (= tmp%13@ (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ c5~46@)))) (=> (= tmp%14@ (Sub (Add a5~42@ c5~46@) (Mul a5~42@ a5~42@))) (=> (= tmp%15@ (Mul a5~42@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%13@ tmp%14@ tmp%15@) (=> %%location_label%%5 (= temp_5_0~2767@ temp_5_1~3040@)))))) (=> (= temp_5_0~2767@ temp_5_1~3040@) (=> (= temp_6_0~3355@ (Mul (Sub (Mul (Mul (Mul (Mul b6~52@ d6~56@) b6~52@) (Mul (Sub b6~52@ a6~50@) (Mul c6~54@ b6~52@))) (Mul a6~50@ (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ c6~54@)))) (Mul (Mul (Mul (Mul 46 d6~56@) (Mul d6~56@ c6~54@)) (Mul (Mul 28 c6~54@) (Add a6~50@ d6~56@))) (Mul (Mul (Mul c6~54@ c6~54@) b6~52@) c6~54@))) (Add (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Sub c6~54@ a6~50@) (Add b6~52@ a6~50@))) (Mul (Sub (Sub b6~52@ a6~50@) (Mul b6~52@ d6~56@)) (Sub (Mul b6~52@ b6~52@) (Mul c6~54@ d6~56@)))) (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Add b6~52@ d6~56@)) (Mul (Add c6~54@ c6~54@) c6~54@)) (Mul (Sub (Mul c6~54@ a6~50@) d6~56@) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ d6~56@))))))) (=> (= temp_6_1~3596@ (Mul (Sub (Mul (Mul (Mul (Mul b6~52@ d6~56@) b6~52@) (Mul (Sub b6~52@ a6~50@) (Mul c6~54@ b6~52@))) (Mul a6~50@ (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ c6~54@)))) (Mul (Mul (Mul (Mul 46 d6~56@) (Mul d6~56@ c6~54@)) (Mul (Mul 28 c6~54@) (Add a6~50@ d6~56@))) (Mul (Mul b6~52@ (Mul c6~54@ c6~54@)) c6~54@))) (Add (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Sub c6~54@ a6~50@) (Add b6~52@ a6~50@))) (Mul (Sub (Sub b6~52@ a6~50@) (Mul b6~52@ d6~56@)) (Sub (Mul b6~52@ b6~52@) (Mul c6~54@ d6~56@)))) (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Add b6~52@ d6~56@)) (Mul (Add c6~54@ c6~54@) c6~54@)) (Mul (Sub (Mul c6~54@ a6~50@) d6~56@) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ d6~56@))))))) (and (=> (= tmp%16@ (Mul c6~54@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%16@ b6~52@) (=> %%location_label%%6 (= temp_6_0~3355@ temp_6_1~3596@)))) (=> (= temp_6_0~3355@ temp_6_1~3596@) (=> (= temp_7_0~3829@ (Mul (Mul (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ a7~58@)) (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ c7~62@)))) (Sub (Sub (Mul (Add a7~58@ d7~64@) (Mul b7~60@ d7~64@)) (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ d7~64@))) (Mul (Mul a7~58@ (Mul c7~62@ b7~60@)) (Mul c7~62@ (Mul b7~60@ b7~60@))))) (Mul (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Sub d7~64@ a7~58@)) (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@))) a7~58@) (Mul (Sub (Add (Mul a7~58@ 32) (Mul d7~64@ c7~62@)) (Mul (Add b7~60@ a7~58@) a7~58@)) d7~64@)))) (=> (= temp_7_1~4030@ (Mul (Mul (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ a7~58@)) (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ c7~62@)))) (Sub (Sub (Mul (Add a7~58@ d7~64@) (Mul b7~60@ d7~64@)) (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ d7~64@))) (Mul (Mul a7~58@ (Mul c7~62@ b7~60@)) (Mul c7~62@ (Mul b7~60@ b7~60@))))) (Mul (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Sub d7~64@ a7~58@)) (Mul (Mul (Mul b7~60@ a7~58@) c7~62@) b7~60@)) a7~58@) (Mul (Sub (Add (Mul a7~58@ 32) (Mul d7~64@ c7~62@)) (Mul (Add b7~60@ a7~58@) a7~58@)) d7~64@)))) (and (=> (= tmp%17@ (Mul b7~60@ a7~58@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%17@ c7~62@ b7~60@) (=> %%location_label%%7 (= temp_7_0~3829@ temp_7_1~4030@)))) (=> (= temp_7_0~3829@ temp_7_1~4030@) (=> (= temp_8_0~4325@ (Mul (Sub (Mul (Mul (Mul (Mul b8~68@ c8~70@) c8~70@) (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Sub b8~68@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Sub b8~68@ b8~68@)))) (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Add 23 c8~70@)) (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@))) (Mul (Mul (Add d8~72@ b8~68@) (Add a8~66@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ b8~68@))))) (Mul (Mul (Mul (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Sub c8~70@ a8~66@) d8~72@)) (Mul (Add d8~72@ (Sub b8~68@ c8~70@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ 70)))) (Mul (Sub (Mul d8~72@ (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@))) (Mul (Sub (Mul d8~72@ d8~72@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ b8~68@) (Sub c8~70@ b8~68@))))))) (=> (= temp_8_1~4586@ (Mul (Sub (Mul (Mul (Mul (Mul b8~68@ c8~70@) c8~70@) (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Sub b8~68@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Sub b8~68@ b8~68@)))) (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul d8~72@ d8~72@) (Add 23 c8~70@))) (Mul (Mul (Add d8~72@ b8~68@) (Add a8~66@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ b8~68@))))) (Mul (Mul (Mul (Mul (Mul a8~66@ c8~70@) b8~68@) (Mul (Sub c8~70@ a8~66@) d8~72@)) (Mul (Add d8~72@ (Sub b8~68@ c8~70@)) (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ 70)))) (Mul (Sub (Mul d8~72@ (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@))) (Mul (Sub (Mul d8~72@ d8~72@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ b8~68@) (Sub c8~70@ b8~68@))))))) (=> (= tmp%18@ (Mul (Mul d8~72@ d8~72@) (Add 23 c8~70@))) (=> (= tmp%19@ (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%18@ tmp%19@) (=> %%location_label%%8 (= temp_8_0~4325@ temp_8_1~4586@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
