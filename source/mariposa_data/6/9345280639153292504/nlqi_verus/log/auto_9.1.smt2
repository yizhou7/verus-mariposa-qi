...
(declare-const temp_1_0~907@ Int)
(declare-const temp_1_1~1180@ Int)
(declare-const temp_2_0~1489@ Int)
(declare-const temp_2_1~1774@ Int)
(declare-const temp_3_0~2027@ Int)
(declare-const temp_3_1~2256@ Int)
(declare-const temp_4_0~2529@ Int)
(declare-const temp_4_1~2778@ Int)
(declare-const temp_5_0~2931@ Int)
(declare-const temp_5_1~3060@ Int)
(declare-const temp_6_0~3269@ Int)
(declare-const temp_6_1~3454@ Int)
(declare-const temp_7_0~3707@ Int)
(declare-const temp_7_1~3936@ Int)
(declare-const temp_8_0~4181@ Int)
(declare-const temp_8_1~4402@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~345@ (Mul (Mul (Add (Add (Add (Mul a0~2@ a0~2@) (Mul d0~8@ a0~2@)) (Add (Mul c0~6@ b0~4@) (Add b0~4@ a0~2@))) (Mul (Sub (Mul a0~2@ b0~4@) (Mul c0~6@ 45)) (Mul (Mul c0~6@ a0~2@) (Sub b0~4@ a0~2@)))) (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ d0~8@))) (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ d0~8@))))) (Mul (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Sub b0~4@ c0~6@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul a0~2@ d0~8@) (Sub a0~2@ c0~6@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)))) (Mul (Mul (Sub (Mul d0~8@ d0~8@) (Add b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) a0~2@)) (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@))))))) (=> (= temp_0_1~610@ (Mul (Mul (Add (Add (Add (Mul a0~2@ a0~2@) (Mul d0~8@ a0~2@)) (Add (Mul c0~6@ b0~4@) (Add b0~4@ a0~2@))) (Mul (Sub (Mul a0~2@ b0~4@) (Mul c0~6@ 45)) (Mul (Mul c0~6@ a0~2@) (Sub b0~4@ a0~2@)))) (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ d0~8@))) (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ d0~8@))))) (Mul (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Sub b0~4@ c0~6@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul a0~2@ d0~8@) (Sub a0~2@ c0~6@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@)))) (Mul (Mul (Sub (Mul d0~8@ d0~8@) (Add b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) a0~2@)) (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~345@ temp_0_1~610@))) (=> (= temp_0_0~345@ temp_0_1~610@) (=> (= temp_1_0~907@ (Mul (Mul (Mul (Mul (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@)) (Mul (Mul d1~16@ 97) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul a1~10@ d1~16@) (Mul 92 b1~12@)) (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)))) (Mul (Sub (Add (Mul a1~10@ c1~14@) (Add c1~14@ d1~16@)) (Mul (Mul b1~12@ b1~12@) (Sub b1~12@ a1~10@))) (Mul (Mul (Add c1~14@ 26) (Mul b1~12@ a1~10@)) (Mul (Sub c1~14@ b1~12@) (Mul b1~12@ d1~16@))))) (Mul (Mul (Sub (Add (Mul d1~16@ b1~12@) (Mul c1~14@ a1~10@)) a1~10@) (Add (Sub (Mul b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Sub b1~12@ b1~12@)))) (Mul (Sub (Mul a1~10@ (Mul d1~16@ d1~16@)) (Mul b1~12@ (Mul d1~16@ b1~12@))) (Mul (Mul (Add c1~14@ d1~16@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ b1~12@))))))) (=> (= temp_1_1~1180@ (Mul (Mul (Mul (Sub (Add (Mul d1~16@ b1~12@) (Mul c1~14@ a1~10@)) a1~10@) (Add (Sub (Mul b1~12@ b1~12@) (Mul d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Sub b1~12@ b1~12@)))) (Mul (Sub (Mul a1~10@ (Mul d1~16@ d1~16@)) (Mul b1~12@ (Mul d1~16@ b1~12@))) (Mul (Mul (Add c1~14@ d1~16@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ b1~12@))))) (Mul (Mul (Mul (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@)) (Mul (Mul d1~16@ 97) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul a1~10@ d1~16@) (Mul 92 b1~12@)) (Sub (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)))) (Mul (Sub (Add (Mul a1~10@ c1~14@) (Add c1~14@ d1~16@)) (Mul (Mul b1~12@ b1~12@) (Sub b1~12@ a1~10@))) (Mul (Mul (Add c1~14@ 26) (Mul b1~12@ a1~10@)) (Mul (Sub c1~14@ b1~12@) (Mul b1~12@ d1~16@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~907@ temp_1_1~1180@))) (=> (= temp_1_0~907@ temp_1_1~1180@) (=> (= temp_2_0~1489@ (Mul (Sub (Mul (Mul (Mul (Mul b2~20@ 92) (Sub b2~20@ a2~18@)) (Sub (Mul c2~22@ c2~22@) (Mul b2~20@ b2~20@))) (Add (Mul (Mul c2~22@ c2~22@) (Sub c2~22@ 5)) (Add (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@)))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ (Mul c2~22@ d2~24@))) (Mul (Mul a2~18@ (Mul d2~24@ b2~20@)) (Mul (Mul b2~20@ c2~22@) (Add d2~24@ d2~24@))))) (Mul (Mul (Mul (Mul c2~22@ (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ a2~18@))) (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ b2~20@)) (Sub (Mul d2~24@ b2~20@) (Mul b2~20@ c2~22@)))) (Mul (Mul a2~18@ (Mul (Mul 30 d2~24@) (Add c2~22@ b2~20@))) (Mul (Sub (Mul a2~18@ a2~18@) (Mul d2~24@ 85)) (Mul (Sub 52 b2~20@) (Sub c2~22@ c2~22@))))))) (=> (= temp_2_1~1774@ (Mul (Sub (Mul (Mul (Mul (Mul b2~20@ 92) (Sub b2~20@ a2~18@)) (Sub (Mul c2~22@ c2~22@) (Mul b2~20@ b2~20@))) (Add (Mul (Mul c2~22@ c2~22@) (Sub c2~22@ 5)) (Add (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@)))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ (Mul c2~22@ d2~24@))) (Mul (Mul a2~18@ (Mul d2~24@ b2~20@)) (Mul (Mul b2~20@ c2~22@) (Add d2~24@ d2~24@))))) (Mul (Mul (Mul (Mul c2~22@ (Mul d2~24@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ a2~18@))) (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ b2~20@)) (Sub (Mul d2~24@ b2~20@) (Mul b2~20@ c2~22@)))) (Mul (Mul a2~18@ (Mul (Mul d2~24@ 30) (Add c2~22@ b2~20@))) (Mul (Sub (Mul a2~18@ a2~18@) (Mul d2~24@ 85)) (Mul (Sub 52 b2~20@) (Sub c2~22@ c2~22@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1489@ temp_2_1~1774@))) (=> (= temp_2_0~1489@ temp_2_1~1774@) (=> (= temp_3_0~2027@ (Mul (Mul (Mul (Mul (Mul b3~28@ (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Add c3~30@ b3~28@))) (Mul (Mul (Mul b3~28@ d3~32@) (Sub a3~26@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Add c3~30@ a3~26@)))) (Mul (Mul (Sub (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Sub 8 d3~32@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ a3~26@)) (Mul (Sub d3~32@ c3~30@) (Sub 85 a3~26@))))) (Mul (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@))) (Add (Mul (Mul a3~26@ b3~28@) (Sub c3~30@ c3~30@)) (Sub (Mul c3~30@ c3~30@) (Mul 50 c3~30@)))) b3~28@))) (=> (= temp_3_1~2256@ (Mul (Mul (Mul (Mul (Mul b3~28@ (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Add c3~30@ b3~28@))) (Mul (Mul (Mul b3~28@ d3~32@) (Sub a3~26@ d3~32@)) (Mul a3~26@ (Mul c3~30@ (Add c3~30@ a3~26@))))) (Mul (Mul (Sub (Mul d3~32@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Sub 8 d3~32@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ a3~26@)) (Mul (Sub d3~32@ c3~30@) (Sub 85 a3~26@))))) (Mul (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ d3~32@))) (Add (Mul (Mul a3~26@ b3~28@) (Sub c3~30@ c3~30@)) (Sub (Mul c3~30@ c3~30@) (Mul 50 c3~30@)))) b3~28@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~2027@ temp_3_1~2256@))) (=> (= temp_3_0~2027@ temp_3_1~2256@) (=> (= temp_4_0~2529@ (Mul (Mul (Mul (Add (Mul (Mul c4~38@ d4~40@) a4~34@) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@))) (Mul (Mul (Add a4~34@ a4~34@) (Mul b4~36@ d4~40@)) (Sub (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)))) (Mul (Sub (Add b4~36@ (Add a4~34@ a4~34@)) (Mul (Mul d4~40@ 56) c4~38@)) (Mul (Mul (Sub c4~38@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ b4~36@) (Sub a4~34@ a4~34@))))) (Add (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@))) (Mul (Mul (Mul b4~36@ d4~40@) (Add c4~38@ d4~40@)) (Sub (Mul c4~38@ c4~38@) (Mul d4~40@ a4~34@)))) (Mul (Mul (Add (Sub a4~34@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Sub a4~34@ c4~38@) (Mul b4~36@ c4~38@))) (Mul (Add d4~40@ (Mul d4~40@ c4~38@)) (Mul b4~36@ (Add b4~36@ a4~34@))))))) (=> (= temp_4_1~2778@ (Mul (Mul (Add (Mul (Mul c4~38@ d4~40@) a4~34@) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ b4~36@))) (Mul (Mul (Add a4~34@ a4~34@) (Mul b4~36@ d4~40@)) (Sub (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)))) (Mul (Mul (Sub (Add b4~36@ (Add a4~34@ a4~34@)) (Mul (Mul d4~40@ 56) c4~38@)) (Mul (Mul (Sub c4~38@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul a4~34@ b4~36@) (Sub a4~34@ a4~34@)))) (Add (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@))) (Mul (Mul (Mul b4~36@ d4~40@) (Add c4~38@ d4~40@)) (Sub (Mul c4~38@ c4~38@) (Mul d4~40@ a4~34@)))) (Mul (Mul (Add (Sub a4~34@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Sub a4~34@ c4~38@) (Mul b4~36@ c4~38@))) (Mul (Add d4~40@ (Mul d4~40@ c4~38@)) (Mul b4~36@ (Add b4~36@ a4~34@)))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~2529@ temp_4_1~2778@))) (=> (= temp_4_0~2529@ temp_4_1~2778@) (=> (= temp_5_0~2931@ (Add (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ (Mul a5~42@ a5~42@))) (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Sub b5~44@ a5~42@)))) (Mul (Sub (Mul a5~42@ (Mul b5~44@ b5~44@)) (Sub (Mul b5~44@ b5~44@) (Sub b5~44@ d5~48@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Sub b5~44@ d5~48@) (Sub c5~46@ c5~46@))))) 10)) (=> (= temp_5_1~3060@ (Add (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ (Mul a5~42@ a5~42@))) (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ b5~44@) (Sub b5~44@ a5~42@)))) (Mul (Sub (Mul a5~42@ (Mul b5~44@ b5~44@)) (Sub (Mul b5~44@ b5~44@) (Sub b5~44@ d5~48@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@)) (Mul (Sub b5~44@ d5~48@) (Sub c5~46@ c5~46@))))) 10)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2931@ temp_5_1~3060@))) (=> (= temp_5_0~2931@ temp_5_1~3060@) (=> (= temp_6_0~3269@ (Mul (Add (Add (Mul (Mul (Mul c6~54@ d6~56@) b6~52@) (Mul (Add c6~54@ a6~50@) (Sub b6~52@ d6~56@))) (Mul (Mul c6~54@ (Sub c6~54@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Add a6~50@ b6~52@)))) (Sub (Mul (Mul c6~54@ (Sub c6~54@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@))) a6~50@)) (Mul (Mul c6~54@ (Mul (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@)))) (Sub (Mul c6~54@ (Mul b6~52@ (Mul b6~52@ a6~50@))) (Mul (Sub (Mul d6~56@ a6~50@) (Mul a6~50@ a6~50@)) (Mul (Mul 11 b6~52@) (Mul a6~50@ d6~56@))))))) (=> (= temp_6_1~3454@ (Mul (Add (Add (Mul (Mul (Mul c6~54@ d6~56@) b6~52@) (Mul (Add c6~54@ a6~50@) (Sub b6~52@ d6~56@))) (Mul (Mul c6~54@ (Sub c6~54@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Add a6~50@ b6~52@)))) (Sub (Mul (Mul c6~54@ (Sub c6~54@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@))) a6~50@)) (Mul (Mul c6~54@ (Mul (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@)))) (Sub (Mul c6~54@ (Mul b6~52@ (Mul b6~52@ a6~50@))) (Mul (Sub (Mul d6~56@ a6~50@) (Mul a6~50@ a6~50@)) (Mul (Mul 11 b6~52@) (Mul a6~50@ d6~56@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~3269@ temp_6_1~3454@))) (=> (= temp_6_0~3269@ temp_6_1~3454@) (=> (= temp_7_0~3707@ (Mul (Mul (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ a7~58@)) (Sub d7~64@ (Add a7~58@ c7~62@))) (Mul (Mul (Mul d7~64@ d7~64@) d7~64@) (Add (Mul c7~62@ d7~64@) (Mul a7~58@ c7~62@)))) (Mul (Sub (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul c7~62@ a7~58@) c7~62@)) (Mul (Mul 84 (Mul c7~62@ c7~62@)) b7~60@))) (Mul (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@)) (Add (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ a7~58@)))) (Mul (Mul c7~62@ (Sub (Mul b7~60@ a7~58@) (Add a7~58@ c7~62@))) (Mul (Mul (Mul c7~62@ d7~64@) (Sub c7~62@ c7~62@)) (Mul (Add b7~60@ a7~58@) (Mul b7~60@ b7~60@))))))) (=> (= temp_7_1~3936@ (Mul (Mul (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ a7~58@)) (Sub d7~64@ (Add a7~58@ c7~62@))) (Mul (Mul (Mul d7~64@ d7~64@) d7~64@) (Add (Mul c7~62@ d7~64@) (Mul a7~58@ c7~62@)))) (Mul (Sub (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Mul c7~62@ a7~58@) c7~62@)) (Mul (Mul 84 (Mul c7~62@ c7~62@)) b7~60@))) (Mul (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ d7~64@)) (Add (Mul c7~62@ b7~60@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ d7~64@)))) (Mul (Mul c7~62@ (Sub (Mul b7~60@ a7~58@) (Add a7~58@ c7~62@))) (Mul (Mul (Mul c7~62@ d7~64@) (Sub c7~62@ c7~62@)) (Mul (Add b7~60@ a7~58@) (Mul b7~60@ b7~60@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3707@ temp_7_1~3936@))) (=> (= temp_7_0~3707@ temp_7_1~3936@) (=> (= temp_8_0~4181@ (Mul (Mul (Mul (Mul (Mul (Add d8~72@ b8~68@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Sub b8~68@ b8~68@) (Mul b8~68@ d8~72@)) a8~66@)) (Mul (Mul (Add (Mul a8~66@ a8~66@) (Mul a8~66@ d8~72@)) (Add (Mul c8~70@ b8~68@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)) a8~66@))) (Add (Add (Mul (Sub d8~72@ (Mul b8~68@ a8~66@)) (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ 6))) (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ c8~70@)) (Mul (Add a8~66@ a8~66@) (Mul c8~70@ b8~68@)))) (Mul (Mul (Mul (Mul c8~70@ 0) (Mul d8~72@ c8~70@)) (Add a8~66@ (Mul c8~70@ a8~66@))) d8~72@)))) (=> (= temp_8_1~4402@ (Mul (Mul (Mul (Mul (Mul (Add d8~72@ b8~68@) (Mul a8~66@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ c8~70@))) (Mul (Mul (Sub b8~68@ b8~68@) (Mul b8~68@ d8~72@)) a8~66@)) (Mul (Mul (Add (Mul a8~66@ a8~66@) (Mul a8~66@ d8~72@)) (Add (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)) a8~66@))) (Add (Add (Mul (Sub d8~72@ (Mul b8~68@ a8~66@)) (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ 6))) (Mul (Mul (Mul d8~72@ c8~70@) (Mul b8~68@ c8~70@)) (Mul (Add a8~66@ a8~66@) (Mul c8~70@ b8~68@)))) (Mul (Mul (Mul (Mul c8~70@ 0) (Mul d8~72@ c8~70@)) (Add a8~66@ (Mul c8~70@ a8~66@))) d8~72@)))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~4181@ temp_8_1~4402@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
