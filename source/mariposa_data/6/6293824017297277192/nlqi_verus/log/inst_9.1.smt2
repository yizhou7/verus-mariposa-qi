...
(set-info :comment ";; mariposa_data/6//6293824017297277192/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~845@ Int)
(declare-const temp_1_1~1190@ Int)
(declare-const temp_2_0~1721@ Int)
(declare-const temp_2_1~2010@ Int)
(declare-const temp_3_0~2171@ Int)
(declare-const temp_3_1~2320@ Int)
(declare-const temp_4_0~2571@ Int)
(declare-const temp_4_1~2800@ Int)
(declare-const temp_5_0~2991@ Int)
(declare-const temp_5_1~3116@ Int)
(declare-const temp_6_0~3373@ Int)
(declare-const temp_6_1~3594@ Int)
(declare-const temp_7_0~3861@ Int)
(declare-const temp_7_1~4094@ Int)
(declare-const temp_8_0~4407@ Int)
(declare-const temp_8_1~4668@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~333@ (Mul (Mul (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Add d0~8@ d0~8@) (Mul b0~4@ d0~8@))) (Add (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ a0~2@)) (Add (Mul d0~8@ c0~6@) (Mul c0~6@ 85)))) (Mul (Mul (Mul (Mul d0~8@ d0~8@) d0~8@) (Mul (Add c0~6@ c0~6@) (Mul a0~2@ d0~8@))) (Sub (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul d0~8@ a0~2@) d0~8@)))) (Mul (Mul (Mul (Mul a0~2@ (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ c0~6@) (Sub a0~2@ c0~6@)) (Mul (Add d0~8@ 1) (Mul c0~6@ d0~8@)))) (Mul (Mul (Mul a0~2@ (Sub b0~4@ a0~2@)) d0~8@) (Mul (Add (Sub c0~6@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ b0~4@))))))) (=> (= temp_0_1~590@ (Mul (Mul (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Add d0~8@ d0~8@) (Mul b0~4@ d0~8@))) (Add (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ a0~2@)) (Add (Mul d0~8@ c0~6@) (Mul c0~6@ 85)))) (Mul (Mul (Mul (Mul d0~8@ d0~8@) d0~8@) (Mul (Add c0~6@ c0~6@) (Mul a0~2@ d0~8@))) (Sub (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Mul d0~8@ a0~2@) d0~8@)))) (Mul (Mul (Mul (Mul a0~2@ (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ c0~6@) (Sub a0~2@ c0~6@)) (Mul (Add d0~8@ 1) (Mul c0~6@ d0~8@)))) (Mul (Mul (Sub (Mul a0~2@ b0~4@) (Mul a0~2@ a0~2@)) d0~8@) (Mul (Add (Sub c0~6@ c0~6@) (Mul a0~2@ a0~2@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ b0~4@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_distributive. a0~2@ b0~4@ a0~2@) (=> %%location_label%%0 (= temp_0_0~333@ temp_0_1~590@))) (=> (= temp_0_0~333@ temp_0_1~590@) (=> (= temp_1_0~845@ (Mul (Sub (Sub (Mul (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ c1~14@)) (Sub d1~16@ (Mul c1~14@ d1~16@))) (Mul d1~16@ (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ b1~12@)))) (Mul (Mul (Mul (Mul c1~14@ c1~14@) a1~10@) (Mul (Mul d1~16@ d1~16@) c1~14@)) (Sub (Add (Mul a1~10@ d1~16@) (Sub c1~14@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ c1~14@))))) (Mul (Sub (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ 84) (Mul a1~10@ a1~10@))) d1~16@) (Mul (Mul (Sub (Mul b1~12@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Sub a1~10@ b1~12@) (Mul c1~14@ b1~12@))) (Sub (Mul a1~10@ (Add d1~16@ 42)) (Mul (Sub c1~14@ a1~10@) (Mul c1~14@ a1~10@))))))) (=> (= temp_1_1~1190@ (Sub (Mul (Sub (Mul (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ c1~14@)) (Sub d1~16@ (Mul c1~14@ d1~16@))) (Mul d1~16@ (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ b1~12@)))) (Mul (Sub (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ 84) (Mul a1~10@ a1~10@))) d1~16@) (Mul (Mul (Sub (Mul b1~12@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Sub a1~10@ b1~12@) (Mul c1~14@ b1~12@))) (Sub (Mul a1~10@ (Add d1~16@ 42)) (Mul (Sub c1~14@ a1~10@) (Mul c1~14@ a1~10@)))))) (Mul (Mul (Mul (Mul (Mul c1~14@ c1~14@) a1~10@) (Mul (Mul d1~16@ d1~16@) c1~14@)) (Sub (Add (Mul a1~10@ d1~16@) (Sub c1~14@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ c1~14@)))) (Mul (Sub (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ 84) (Mul a1~10@ a1~10@))) d1~16@) (Mul (Mul (Sub (Mul b1~12@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Sub a1~10@ b1~12@) (Mul c1~14@ b1~12@))) (Sub (Mul a1~10@ (Add d1~16@ 42)) (Mul (Sub c1~14@ a1~10@) (Mul c1~14@ a1~10@)))))))) (and (=> (= tmp%1@ (Sub (Mul (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ c1~14@)) (Sub d1~16@ (Mul c1~14@ d1~16@))) (Mul d1~16@ (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ b1~12@))))) (=> (= tmp%2@ (Mul (Mul (Mul (Mul c1~14@ c1~14@) a1~10@) (Mul (Mul d1~16@ d1~16@) c1~14@)) (Sub (Add (Mul a1~10@ d1~16@) (Sub c1~14@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ c1~14@))))) (=> (= tmp%3@ (Mul (Sub (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ 84) (Mul a1~10@ a1~10@))) d1~16@) (Mul (Mul (Sub (Mul b1~12@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Sub a1~10@ b1~12@) (Mul c1~14@ b1~12@))) (Sub (Mul a1~10@ (Add d1~16@ 42)) (Mul (Sub c1~14@ a1~10@) (Mul c1~14@ a1~10@)))))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~845@ temp_1_1~1190@)))))) (=> (= temp_1_0~845@ temp_1_1~1190@) (=> (= temp_2_0~1721@ (Sub (Mul (Mul (Mul (Mul (Sub a2~18@ b2~20@) 33) (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@))) (Mul (Sub (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@)))) (Add (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Sub c2~22@ c2~22@) a2~18@)) (Add (Mul d2~24@ (Mul c2~22@ d2~24@)) (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ 44))))) (Sub (Mul (Add (Mul (Mul d2~24@ b2~20@) (Sub b2~20@ b2~20@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ 66)) (Mul (Sub 58 c2~22@) (Sub c2~22@ b2~20@)))) (Add (Mul (Mul (Mul b2~20@ c2~22@) a2~18@) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ c2~22@))) (Sub (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ a2~18@))))))) (=> (= temp_2_1~2010@ (Sub (Mul (Mul (Mul (Mul (Sub a2~18@ b2~20@) 33) (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@))) (Mul (Sub (Mul c2~22@ b2~20@) (Mul d2~24@ b2~20@)) (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@)))) (Add (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ b2~20@)) (Mul (Sub c2~22@ c2~22@) a2~18@)) (Add (Mul d2~24@ (Mul c2~22@ d2~24@)) (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ 44))))) (Sub (Mul (Add (Mul (Mul d2~24@ b2~20@) (Sub b2~20@ b2~20@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ 66)) (Mul (Sub 58 c2~22@) (Sub c2~22@ b2~20@)))) (Add (Mul (Mul (Mul b2~20@ c2~22@) a2~18@) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ c2~22@))) (Sub (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ a2~18@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b2~20@ c2~22@) (=> %%location_label%%2 (= temp_2_0~1721@ temp_2_1~2010@))) (=> (= temp_2_0~1721@ temp_2_1~2010@) (=> (= temp_3_0~2171@ (Sub (Mul b3~28@ a3~26@) (Mul (Mul (Mul (Mul (Add b3~28@ d3~32@) (Mul d3~32@ d3~32@)) (Add (Mul c3~30@ a3~26@) (Mul d3~32@ a3~26@))) (Mul (Mul (Sub d3~32@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ b3~28@)))) (Mul (Mul (Add d3~32@ (Sub b3~28@ a3~26@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ d3~32@))) (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ a3~26@))))))) (=> (= temp_3_1~2320@ (Sub (Mul b3~28@ a3~26@) (Mul (Mul (Add (Mul (Mul (Add b3~28@ d3~32@) (Mul d3~32@ d3~32@)) (Mul c3~30@ a3~26@)) (Mul (Mul (Add b3~28@ d3~32@) (Mul d3~32@ d3~32@)) (Mul d3~32@ a3~26@))) (Mul (Mul (Sub d3~32@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ b3~28@)))) (Mul (Mul (Add d3~32@ (Sub b3~28@ a3~26@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ d3~32@))) (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@)) (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ a3~26@))))))) (and (=> (= tmp%4@ (Mul (Add b3~28@ d3~32@) (Mul d3~32@ d3~32@))) (=> (= tmp%5@ (Mul c3~30@ a3~26@)) (=> (= tmp%6@ (Mul d3~32@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%3 (= temp_3_0~2171@ temp_3_1~2320@)))))) (=> (= temp_3_0~2171@ temp_3_1~2320@) (=> (= temp_4_0~2571@ (Sub (Mul (Mul (Sub (Sub (Sub d4~40@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@)) (Mul a4~34@ (Mul b4~36@ c4~38@)))) (Mul d4~40@ (Mul (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ d4~40@))))) (Mul (Mul (Sub c4~38@ (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@))) (Add (Mul (Mul a4~34@ d4~40@) (Sub b4~36@ b4~36@)) (Mul (Sub d4~40@ c4~38@) d4~40@))) (Mul (Mul (Mul c4~38@ (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul d4~40@ a4~34@) c4~38@) (Add (Mul a4~34@ d4~40@) (Mul c4~38@ a4~34@))))))) (=> (= temp_4_1~2800@ (Sub (Mul (Mul (Sub (Sub (Sub d4~40@ b4~36@) (Mul b4~36@ d4~40@)) (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ d4~40@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@)) (Mul a4~34@ (Mul b4~36@ c4~38@)))) (Mul d4~40@ (Mul (Mul (Mul a4~34@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ d4~40@))))) (Mul (Sub (Mul c4~38@ (Add (Mul (Mul a4~34@ d4~40@) (Sub b4~36@ b4~36@)) (Mul (Sub d4~40@ c4~38@) d4~40@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Add (Mul (Mul a4~34@ d4~40@) (Sub b4~36@ b4~36@)) (Mul (Sub d4~40@ c4~38@) d4~40@)))) (Mul (Mul (Mul c4~38@ (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul d4~40@ a4~34@) c4~38@) (Add (Mul a4~34@ d4~40@) (Mul c4~38@ a4~34@))))))) (and (=> (= tmp%7@ (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ d4~40@))) (=> (= tmp%8@ (Add (Mul (Mul a4~34@ d4~40@) (Sub b4~36@ b4~36@)) (Mul (Sub d4~40@ c4~38@) d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. c4~38@ tmp%7@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~2571@ temp_4_1~2800@))))) (=> (= temp_4_0~2571@ temp_4_1~2800@) (=> (= temp_5_0~2991@ (Sub (Mul (Mul (Sub (Mul (Mul b5~44@ c5~46@) b5~44@) b5~44@) b5~44@) c5~46@) (Add (Mul (Mul (Mul (Add b5~44@ d5~48@) a5~42@) (Mul (Mul b5~44@ d5~48@) a5~42@)) (Sub (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ c5~46@)) d5~48@)) (Mul (Sub (Mul (Mul c5~46@ b5~44@) (Sub d5~48@ d5~48@)) (Mul a5~42@ (Mul d5~48@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) c5~46@) (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ b5~44@))))))) (=> (= temp_5_1~3116@ (Sub (Mul (Mul (Sub (Mul (Mul b5~44@ c5~46@) b5~44@) b5~44@) b5~44@) c5~46@) (Add (Mul (Mul (Mul (Add b5~44@ d5~48@) a5~42@) (Mul (Mul b5~44@ d5~48@) a5~42@)) (Sub (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ b5~44@)) d5~48@)) (Mul (Sub (Mul (Mul c5~46@ b5~44@) (Sub d5~48@ d5~48@)) (Mul a5~42@ (Mul d5~48@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) c5~46@) (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ b5~44@))))))) (and (=> (= tmp%9@ (Mul b5~44@ b5~44@)) (=> (= tmp%10@ (Mul c5~46@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%5 (= temp_5_0~2991@ temp_5_1~3116@))))) (=> (= temp_5_0~2991@ temp_5_1~3116@) (=> (= temp_6_0~3373@ (Mul (Add (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ b6~52@)) (Add (Add b6~52@ c6~54@) (Mul 19 a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) a6~50@) (Sub (Mul a6~50@ c6~54@) 46))) (Mul (Sub b6~52@ (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul d6~56@ b6~52@) (Sub b6~52@ b6~52@))))) (Mul (Mul d6~56@ (Mul (Mul (Mul c6~54@ b6~52@) (Mul 67 d6~56@)) (Sub (Mul a6~50@ d6~56@) (Add c6~54@ b6~52@)))) (Mul (Mul c6~54@ d6~56@) (Mul (Sub (Sub d6~56@ c6~54@) (Mul d6~56@ 14)) d6~56@))))) (=> (= temp_6_1~3594@ (Mul (Add (Mul (Mul (Mul d6~56@ (Mul b6~52@ (Mul d6~56@ b6~52@))) (Add (Add b6~52@ c6~54@) (Mul 19 a6~50@))) (Mul (Mul (Mul c6~54@ b6~52@) a6~50@) (Sub (Mul a6~50@ c6~54@) 46))) (Mul (Sub b6~52@ (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ b6~52@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul d6~56@ b6~52@) (Sub b6~52@ b6~52@))))) (Mul (Mul d6~56@ (Mul (Mul (Mul c6~54@ b6~52@) (Mul 67 d6~56@)) (Sub (Mul a6~50@ d6~56@) (Add c6~54@ b6~52@)))) (Mul (Mul c6~54@ d6~56@) (Mul (Sub (Sub d6~56@ c6~54@) (Mul d6~56@ 14)) d6~56@))))) (and (=> (= tmp%11@ (Mul d6~56@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d6~56@ b6~52@ tmp%11@) (=> %%location_label%%6 (= temp_6_0~3373@ temp_6_1~3594@)))) (=> (= temp_6_0~3373@ temp_6_1~3594@) (=> (= temp_7_0~3861@ (Mul (Sub (Sub (Mul (Add (Mul a7~58@ a7~58@) (Mul c7~62@ b7~60@)) (Sub (Mul a7~58@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ 22)) (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ b7~60@)))) (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Mul d7~64@ c7~62@) (Sub d7~64@ c7~62@))) (Mul (Mul a7~58@ (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ d7~64@))))) (Mul (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ c7~62@)) (Add (Add c7~62@ a7~58@) (Mul c7~62@ c7~62@))) (Mul (Sub (Mul d7~64@ d7~64@) (Mul a7~58@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@)))) (Mul (Add (Add d7~64@ (Mul c7~62@ a7~58@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@))) d7~64@)))) (=> (= temp_7_1~4094@ (Mul (Sub (Sub (Mul (Add (Mul a7~58@ a7~58@) (Mul c7~62@ b7~60@)) (Sub (Mul a7~58@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ 22)) (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ b7~60@)))) (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ a7~58@)) (Mul (Mul d7~64@ c7~62@) (Sub d7~64@ c7~62@))) (Mul (Mul a7~58@ (Mul d7~64@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ d7~64@))))) (Mul (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ c7~62@)) (Add (Add c7~62@ a7~58@) (Mul c7~62@ c7~62@))) (Mul (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@)) (Sub (Mul d7~64@ d7~64@) (Mul a7~58@ b7~60@)))) (Mul (Add (Add d7~64@ (Mul c7~62@ a7~58@)) (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@))) d7~64@)))) (and (=> (= tmp%12@ (Sub (Mul d7~64@ d7~64@) (Mul a7~58@ b7~60@))) (=> (= tmp%13@ (Mul (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%12@ tmp%13@) (=> %%location_label%%7 (= temp_7_0~3861@ temp_7_1~4094@))))) (=> (= temp_7_0~3861@ temp_7_1~4094@) (=> (= temp_8_0~4407@ (Sub (Mul (Mul (Mul a8~66@ (Mul b8~68@ (Add 99 d8~72@))) (Mul (Sub (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul a8~66@ b8~68@) (Sub a8~66@ a8~66@)))) (Mul (Sub a8~66@ (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ a8~66@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ 30)) (Mul (Mul b8~68@ 88) (Mul b8~68@ c8~70@))))) (Mul (Mul (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ a8~66@)) (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@))) (Mul (Mul (Mul b8~68@ a8~66@) b8~68@) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ b8~68@)))) (Mul (Mul (Mul (Sub a8~66@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@))) (Mul (Add (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Sub d8~72@ c8~70@) (Add a8~66@ d8~72@))))))) (=> (= temp_8_1~4668@ (Sub (Mul (Mul (Mul a8~66@ (Mul b8~68@ (Add 99 d8~72@))) (Mul (Sub (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul a8~66@ b8~68@) (Sub a8~66@ a8~66@)))) (Mul (Sub a8~66@ (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ a8~66@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ 30)) (Mul (Mul b8~68@ 88) (Mul b8~68@ c8~70@))))) (Mul (Mul (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ a8~66@)) (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@))) (Mul (Mul b8~68@ (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ b8~68@)))) (Mul (Mul (Mul (Sub a8~66@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@))) (Mul (Add (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Sub d8~72@ c8~70@) (Add a8~66@ d8~72@))))))) (=> (= tmp%14@ (Mul b8~68@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%14@ b8~68@) (=> %%location_label%%8 (= temp_8_0~4407@ temp_8_1~4668@)))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
