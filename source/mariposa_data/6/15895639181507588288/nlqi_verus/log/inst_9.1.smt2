...
(set-info :comment ";; mariposa_data/6//15895639181507588288/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~799@ Int)
(declare-const temp_1_1~960@ Int)
(declare-const temp_2_0~1269@ Int)
(declare-const temp_2_1~1530@ Int)
(declare-const temp_3_0~1713@ Int)
(declare-const temp_3_1~1846@ Int)
(declare-const temp_4_0~2075@ Int)
(declare-const temp_4_1~2276@ Int)
(declare-const temp_5_0~2653@ Int)
(declare-const temp_5_1~2910@ Int)
(declare-const temp_6_0~3191@ Int)
(declare-const temp_6_1~3444@ Int)
(declare-const temp_7_0~3717@ Int)
(declare-const temp_7_1~3954@ Int)
(declare-const temp_8_0~4233@ Int)
(declare-const temp_8_1~4466@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~333@ (Mul (Add (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ 43)) (Add (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul b0~4@ d0~8@) (Add d0~8@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ d0~8@)))) (Mul (Mul (Mul (Add a0~2@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ c0~6@))))) (Add (Mul (Mul (Sub (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ c0~6@)) d0~8@)) (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ c0~6@)) (Sub a0~2@ (Mul a0~2@ a0~2@))) (Mul (Add (Mul c0~6@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ c0~6@))))))) (=> (= temp_0_1~586@ (Mul (Add (Mul (Mul (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ 43)) (Add (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul b0~4@ d0~8@) (Add d0~8@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ d0~8@)))) (Mul (Mul (Mul (Add a0~2@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ c0~6@))))) (Add (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@)) (Sub (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ c0~6@)) d0~8@)) (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ c0~6@)) (Sub a0~2@ (Mul a0~2@ a0~2@))) (Mul (Add (Mul c0~6@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ c0~6@))))))) (and (=> (= tmp%1@ (Sub (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@))) (=> (= tmp%2@ (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ b0~4@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~333@ temp_0_1~586@))))) (=> (= temp_0_0~333@ temp_0_1~586@) (=> (= temp_1_0~799@ (Mul (Mul (Mul (Mul (Mul (Add a1~10@ b1~12@) (Mul c1~14@ c1~14@)) (Mul b1~12@ (Mul c1~14@ c1~14@))) (Mul (Sub (Add a1~10@ b1~12@) (Mul c1~14@ b1~12@)) (Add (Add a1~10@ b1~12@) (Mul d1~16@ a1~10@)))) (Mul (Sub (Add a1~10@ (Mul c1~14@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ d1~16@))) (Mul (Add (Mul d1~16@ d1~16@) (Sub a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@))))) (Add c1~14@ (Sub (Add (Mul (Mul b1~12@ a1~10@) (Sub b1~12@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))) c1~14@)))) (=> (= temp_1_1~960@ (Mul (Mul (Mul (Mul (Mul b1~12@ (Mul c1~14@ c1~14@)) (Mul (Add a1~10@ b1~12@) (Mul c1~14@ c1~14@))) (Mul (Sub (Add a1~10@ b1~12@) (Mul c1~14@ b1~12@)) (Add (Add a1~10@ b1~12@) (Mul d1~16@ a1~10@)))) (Mul (Sub (Add a1~10@ (Mul c1~14@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ d1~16@))) (Mul (Add (Mul d1~16@ d1~16@) (Sub a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul d1~16@ c1~14@))))) (Add c1~14@ (Sub (Add (Mul (Mul b1~12@ a1~10@) (Sub b1~12@ d1~16@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))) c1~14@)))) (and (=> (= tmp%3@ (Mul (Add a1~10@ b1~12@) (Mul c1~14@ c1~14@))) (=> (= tmp%4@ (Mul b1~12@ (Mul c1~14@ c1~14@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%1 (= temp_1_0~799@ temp_1_1~960@))))) (=> (= temp_1_0~799@ temp_1_1~960@) (=> (= temp_2_0~1269@ (Mul (Mul (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Sub c2~22@ d2~24@)) (Add (Mul a2~18@ a2~18@) (Sub b2~20@ c2~22@))) (Sub (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul d2~24@ d2~24@) b2~20@))) (Sub (Mul (Sub (Mul d2~24@ a2~18@) (Mul b2~20@ 64)) (Add (Mul a2~18@ d2~24@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul b2~20@ d2~24@) (Add b2~20@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ a2~18@))))) (Mul (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ d2~24@)) b2~20@) (Mul (Mul (Add c2~22@ 19) (Mul d2~24@ b2~20@)) (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ b2~20@)))) (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Add d2~24@ d2~24@)) (Sub (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@))) (Mul (Mul a2~18@ (Mul c2~22@ b2~20@)) (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ b2~20@))))))) (=> (= temp_2_1~1530@ (Mul (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul (Sub c2~22@ d2~24@) (Add (Mul a2~18@ a2~18@) (Sub b2~20@ c2~22@)))) (Sub (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ c2~22@)) (Mul (Mul d2~24@ d2~24@) b2~20@))) (Sub (Mul (Sub (Mul d2~24@ a2~18@) (Mul b2~20@ 64)) (Add (Mul a2~18@ d2~24@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul b2~20@ d2~24@) (Add b2~20@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ a2~18@))))) (Mul (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ d2~24@)) b2~20@) (Mul (Mul (Add c2~22@ 19) (Mul d2~24@ b2~20@)) (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ b2~20@)))) (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Add d2~24@ d2~24@)) (Sub (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@))) (Mul (Mul a2~18@ (Mul c2~22@ b2~20@)) (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ b2~20@))))))) (and (=> (= tmp%5@ (Mul c2~22@ d2~24@)) (=> (= tmp%6@ (Sub c2~22@ d2~24@)) (=> (= tmp%7@ (Add (Mul a2~18@ a2~18@) (Sub b2~20@ c2~22@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%2 (= temp_2_0~1269@ temp_2_1~1530@)))))) (=> (= temp_2_0~1269@ temp_2_1~1530@) (=> (= temp_3_0~1713@ (Mul (Sub (Mul (Sub (Mul d3~32@ (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@)) a3~26@)) (Add a3~26@ d3~32@)) (Mul (Mul (Mul a3~26@ (Mul a3~26@ b3~28@)) (Mul (Add c3~30@ (Add c3~30@ a3~26@)) (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)))) (Mul d3~32@ (Sub (Mul (Sub d3~32@ c3~30@) (Mul c3~30@ d3~32@)) (Add (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))))))) (=> (= temp_3_1~1846@ (Mul (Sub (Mul (Sub (Mul d3~32@ (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ d3~32@))) (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ c3~30@)) a3~26@)) (Add a3~26@ d3~32@)) (Mul (Mul (Mul a3~26@ (Mul a3~26@ b3~28@)) (Mul (Add c3~30@ (Add c3~30@ a3~26@)) (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)))) (Mul d3~32@ (Sub (Mul (Sub d3~32@ c3~30@) (Mul c3~30@ d3~32@)) (Add (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c3~30@ c3~30@) (=> %%location_label%%3 (= temp_3_0~1713@ temp_3_1~1846@))) (=> (= temp_3_0~1713@ temp_3_1~1846@) (=> (= temp_4_0~2075@ (Mul (Add (Mul (Mul a4~34@ (Mul b4~36@ (Mul b4~36@ c4~38@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Add c4~38@ a4~34@) c4~38@))) (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ d4~40@)) (Add (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@))) (Mul (Mul b4~36@ (Sub a4~34@ c4~38@)) (Mul c4~38@ (Mul b4~36@ a4~34@))))) (Mul (Sub (Mul d4~40@ (Mul (Mul b4~36@ c4~38@) (Add c4~38@ b4~36@))) c4~38@) (Mul (Mul (Add (Sub d4~40@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Sub b4~36@ c4~38@) (Mul c4~38@ b4~36@))) (Mul (Add (Mul d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Add b4~36@ b4~36@) (Mul c4~38@ 71))))))) (=> (= temp_4_1~2276@ (Mul (Add (Mul (Mul a4~34@ (Mul b4~36@ (Mul b4~36@ c4~38@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Add c4~38@ a4~34@) c4~38@))) (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ d4~40@)) (Add (Mul c4~38@ c4~38@) (Mul b4~36@ c4~38@))) (Mul (Mul b4~36@ (Sub a4~34@ c4~38@)) (Mul c4~38@ (Mul b4~36@ a4~34@))))) (Mul (Mul (Mul (Add (Sub d4~40@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Sub b4~36@ c4~38@) (Mul c4~38@ b4~36@))) (Mul (Add (Mul d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Add b4~36@ b4~36@) (Mul c4~38@ 71)))) (Sub (Mul d4~40@ (Mul (Mul b4~36@ c4~38@) (Add c4~38@ b4~36@))) c4~38@)))) (and (=> (= tmp%8@ (Sub (Mul d4~40@ (Mul (Mul b4~36@ c4~38@) (Add c4~38@ b4~36@))) c4~38@)) (=> (= tmp%9@ (Mul (Mul (Add (Sub d4~40@ c4~38@) (Mul b4~36@ d4~40@)) (Mul (Sub b4~36@ c4~38@) (Mul c4~38@ b4~36@))) (Mul (Add (Mul d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Add b4~36@ b4~36@) (Mul c4~38@ 71))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%8@ tmp%9@) (=> %%location_label%%4 (= temp_4_0~2075@ temp_4_1~2276@))))) (=> (= temp_4_0~2075@ temp_4_1~2276@) (=> (= temp_5_0~2653@ (Mul (Mul (Mul (Mul (Mul (Add a5~42@ b5~44@) (Mul d5~48@ b5~44@)) (Mul b5~44@ (Mul d5~48@ c5~46@))) (Sub (Mul (Mul c5~46@ c5~46@) c5~46@) (Sub (Mul a5~42@ d5~48@) (Sub c5~46@ a5~42@)))) (Add (Mul (Add (Mul c5~46@ d5~48@) (Mul c5~46@ d5~48@)) (Mul c5~46@ (Mul c5~46@ a5~42@))) (Sub (Mul (Mul b5~44@ c5~46@) b5~44@) (Add (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@))))) (Mul (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Sub a5~42@ b5~44@)))) (Add (Mul (Mul c5~46@ (Mul a5~42@ b5~44@)) (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@))) (Mul (Sub 73 (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ d5~48@) (Mul 77 a5~42@))))))) (=> (= temp_5_1~2910@ (Mul (Mul (Mul (Mul (Mul (Add a5~42@ b5~44@) (Mul b5~44@ d5~48@)) (Mul b5~44@ (Mul d5~48@ c5~46@))) (Sub (Mul (Mul c5~46@ c5~46@) c5~46@) (Sub (Mul a5~42@ d5~48@) (Sub c5~46@ a5~42@)))) (Add (Mul (Add (Mul c5~46@ d5~48@) (Mul c5~46@ d5~48@)) (Mul c5~46@ (Mul c5~46@ a5~42@))) (Sub (Mul (Mul b5~44@ c5~46@) b5~44@) (Add (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@))))) (Mul (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Sub a5~42@ b5~44@)))) (Add (Mul (Mul c5~46@ (Mul a5~42@ b5~44@)) (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@))) (Mul (Sub 73 (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ d5~48@) (Mul 77 a5~42@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d5~48@ b5~44@) (=> %%location_label%%5 (= temp_5_0~2653@ temp_5_1~2910@))) (=> (= temp_5_0~2653@ temp_5_1~2910@) (=> (= temp_6_0~3191@ (Mul (Mul (Mul (Mul (Mul (Sub d6~56@ a6~50@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Sub c6~54@ c6~54@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ a6~50@)) (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ d6~56@)))) (Mul (Mul (Mul (Sub b6~52@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ d6~56@) c6~54@)))) (Add (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Sub a6~50@ a6~50@)) (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ b6~52@)) (Sub (Mul a6~50@ d6~56@) (Mul a6~50@ a6~50@)))) (Mul (Add (Mul (Sub a6~50@ d6~56@) (Mul b6~52@ d6~56@)) (Mul (Add a6~50@ d6~56@) (Mul 38 d6~56@))) (Mul (Sub (Mul d6~56@ a6~50@) (Mul d6~56@ d6~56@)) c6~54@))))) (=> (= temp_6_1~3444@ (Mul (Mul (Mul (Mul (Mul (Sub d6~56@ a6~50@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Sub c6~54@ c6~54@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ a6~50@)) (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ d6~56@)))) (Mul (Mul (Mul (Sub b6~52@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ d6~56@) c6~54@)))) (Add (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Sub a6~50@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ b6~52@)) (Sub (Mul a6~50@ d6~56@) (Mul a6~50@ a6~50@)))) (Mul (Add (Mul (Sub a6~50@ d6~56@) (Mul b6~52@ d6~56@)) (Mul (Add a6~50@ d6~56@) (Mul 38 d6~56@))) (Mul (Sub (Mul d6~56@ a6~50@) (Mul d6~56@ d6~56@)) c6~54@))))) (and (=> (= tmp%10@ (Mul b6~52@ b6~52@)) (=> (= tmp%11@ (Mul d6~56@ c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%10@ tmp%11@) (=> %%location_label%%6 (= temp_6_0~3191@ temp_6_1~3444@))))) (=> (= temp_6_0~3191@ temp_6_1~3444@) (=> (= temp_7_0~3717@ (Mul (Mul (Sub (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Add (Mul b7~60@ a7~58@) (Sub b7~60@ c7~62@))) (Mul (Add (Mul c7~62@ a7~58@) b7~60@) (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ c7~62@)))) (Sub (Sub (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ c7~62@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ c7~62@)) (Mul d7~64@ (Mul d7~64@ c7~62@))))) (Sub (Mul (Mul (Mul (Mul b7~60@ c7~62@) d7~64@) (Mul (Mul d7~64@ c7~62@) b7~60@)) (Mul c7~62@ (Mul c7~62@ (Mul d7~64@ b7~60@)))) (Mul (Mul (Mul (Mul 30 d7~64@) (Add a7~58@ d7~64@)) (Mul (Mul a7~58@ d7~64@) (Sub b7~60@ d7~64@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@))))))) (=> (= temp_7_1~3954@ (Mul (Mul (Sub (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)) (Add (Mul b7~60@ a7~58@) (Sub b7~60@ c7~62@))) (Mul (Add (Mul c7~62@ a7~58@) b7~60@) (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ c7~62@)))) (Sub (Sub (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ c7~62@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ c7~62@)) (Mul d7~64@ (Mul d7~64@ c7~62@))))) (Sub (Mul (Mul (Mul (Mul b7~60@ c7~62@) d7~64@) (Mul (Mul d7~64@ c7~62@) b7~60@)) (Mul c7~62@ (Mul c7~62@ (Mul d7~64@ b7~60@)))) (Mul (Mul (Mul 30 (Mul d7~64@ (Add a7~58@ d7~64@))) (Mul (Mul a7~58@ d7~64@) (Sub b7~60@ d7~64@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ b7~60@))))))) (and (=> (= tmp%12@ (Add a7~58@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. 30 d7~64@ tmp%12@) (=> %%location_label%%7 (= temp_7_0~3717@ temp_7_1~3954@)))) (=> (= temp_7_0~3717@ temp_7_1~3954@) (=> (= temp_8_0~4233@ (Mul (Mul (Mul (Sub (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Sub c8~70@ c8~70@))) (Add (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ d8~72@)) (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ d8~72@)))) (Mul (Sub (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ a8~66@))) (Mul (Sub (Mul a8~66@ c8~70@) (Sub 90 c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@))))) (Mul (Sub (Mul (Add (Mul a8~66@ b8~68@) (Mul d8~72@ d8~72@)) d8~72@) (Mul (Mul (Sub c8~70@ d8~72@) (Mul c8~70@ c8~70@)) (Mul b8~68@ (Mul c8~70@ b8~68@)))) (Add (Add (Mul c8~70@ d8~72@) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (Mul b8~68@ (Mul (Sub d8~72@ c8~70@) (Sub a8~66@ a8~66@))))))) (=> (= temp_8_1~4466@ (Mul (Mul (Mul (Sub (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Sub c8~70@ c8~70@))) (Add (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ d8~72@)) (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ d8~72@)))) (Mul (Sub (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Mul c8~70@ a8~66@))) (Mul (Sub (Mul a8~66@ c8~70@) (Sub 90 c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@))))) (Mul (Sub (Mul (Add (Mul a8~66@ b8~68@) (Mul d8~72@ d8~72@)) d8~72@) (Mul (Mul (Sub c8~70@ d8~72@) (Mul c8~70@ c8~70@)) (Mul b8~68@ (Mul c8~70@ b8~68@)))) (Add (Add (Mul c8~70@ d8~72@) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul b8~68@ (Sub d8~72@ c8~70@)) (Sub a8~66@ a8~66@)))))) (=> (= tmp%13@ (Sub d8~72@ c8~70@)) (=> (= tmp%14@ (Sub a8~66@ a8~66@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. b8~68@ tmp%13@ tmp%14@) (=> %%location_label%%8 (= temp_8_0~4233@ temp_8_1~4466@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
