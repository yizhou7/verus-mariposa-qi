...
(declare-const temp_1_0~851@ Int)
(declare-const temp_1_1~1068@ Int)
(declare-const temp_2_0~1373@ Int)
(declare-const temp_2_1~1654@ Int)
(declare-const temp_3_0~1907@ Int)
(declare-const temp_3_1~2136@ Int)
(declare-const temp_4_0~2413@ Int)
(declare-const temp_4_1~2666@ Int)
(declare-const temp_5_0~2887@ Int)
(declare-const temp_5_1~3092@ Int)
(declare-const temp_6_0~3333@ Int)
(declare-const temp_6_1~3550@ Int)
(declare-const temp_7_0~3775@ Int)
(declare-const temp_7_1~3976@ Int)
(declare-const temp_8_0~4261@ Int)
(declare-const temp_8_1~4522@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~345@ (Mul (Mul (Add (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ d0~8@)) (Mul d0~8@ b0~4@)) (Mul (Mul (Mul c0~6@ b0~4@) (Sub d0~8@ a0~2@)) (Mul (Sub c0~6@ d0~8@) (Mul c0~6@ b0~4@)))) (Sub (Sub (Mul (Add a0~2@ d0~8@) (Add b0~4@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ a0~2@)) (Mul (Add c0~6@ b0~4@) (Mul b0~4@ b0~4@))))) (Add (Mul (Add (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ d0~8@)) (Mul c0~6@ (Mul b0~4@ a0~2@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul 19 b0~4@)) (Add (Add d0~8@ d0~8@) (Add c0~6@ b0~4@)))) (Mul (Mul (Add (Add d0~8@ a0~2@) d0~8@) (Mul (Mul a0~2@ 72) (Mul b0~4@ b0~4@))) (Mul b0~4@ (Add (Mul d0~8@ 65) (Mul a0~2@ a0~2@))))))) (=> (= temp_0_1~610@ (Mul (Mul (Add (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ d0~8@)) (Mul d0~8@ b0~4@)) (Mul (Mul (Mul c0~6@ b0~4@) (Sub d0~8@ a0~2@)) (Mul (Sub c0~6@ d0~8@) (Mul c0~6@ b0~4@)))) (Sub (Sub (Mul (Add a0~2@ d0~8@) (Add b0~4@ a0~2@)) (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ a0~2@)) (Mul (Add c0~6@ b0~4@) (Mul b0~4@ b0~4@))))) (Add (Mul (Add (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ d0~8@)) (Mul c0~6@ (Mul b0~4@ a0~2@))) (Mul (Mul (Mul (Mul a0~2@ b0~4@) 19) b0~4@) (Add (Add d0~8@ d0~8@) (Add c0~6@ b0~4@)))) (Mul (Mul (Add (Add d0~8@ a0~2@) d0~8@) (Mul (Mul a0~2@ 72) (Mul b0~4@ b0~4@))) (Mul b0~4@ (Add (Mul d0~8@ 65) (Mul a0~2@ a0~2@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~345@ temp_0_1~610@))) (=> (= temp_0_0~345@ temp_0_1~610@) (=> (= temp_1_0~851@ (Mul (Mul (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Sub b1~12@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Add (Mul c1~14@ a1~10@) d1~16@) (Sub (Mul c1~14@ d1~16@) (Mul a1~10@ c1~14@)))) (Add (Mul (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ b1~12@) c1~14@)) (Mul (Mul (Mul a1~10@ b1~12@) b1~12@) (Mul (Mul b1~12@ c1~14@) c1~14@)))) (Mul (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ c1~14@))) (Mul (Sub (Sub b1~12@ d1~16@) (Add b1~12@ b1~12@)) (Mul a1~10@ b1~12@))) (Mul (Mul a1~10@ (Mul (Mul b1~12@ d1~16@) c1~14@)) (Mul (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Sub b1~12@ b1~12@) (Sub a1~10@ d1~16@))))))) (=> (= temp_1_1~1068@ (Mul (Mul (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ c1~14@)) (Mul (Sub b1~12@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Add (Mul c1~14@ a1~10@) d1~16@) (Sub (Mul c1~14@ d1~16@) (Mul c1~14@ a1~10@)))) (Add (Mul (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ b1~12@) c1~14@)) (Mul (Mul (Mul a1~10@ b1~12@) b1~12@) (Mul (Mul b1~12@ c1~14@) c1~14@)))) (Mul (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ c1~14@))) (Mul (Sub (Sub b1~12@ d1~16@) (Add b1~12@ b1~12@)) (Mul a1~10@ b1~12@))) (Mul (Mul a1~10@ (Mul (Mul b1~12@ d1~16@) c1~14@)) (Mul (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Sub b1~12@ b1~12@) (Sub a1~10@ d1~16@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~851@ temp_1_1~1068@))) (=> (= temp_1_0~851@ temp_1_1~1068@) (=> (= temp_2_0~1373@ (Mul (Mul (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Sub d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Add b2~20@ b2~20@))) (Sub (Add (Sub a2~18@ c2~22@) c2~22@) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@)))) (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Add b2~20@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@))) (Mul (Add c2~22@ (Add a2~18@ 58)) (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@))))) (Mul (Sub (Mul (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ d2~24@) a2~18@)) (Mul (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ 75)) (Sub (Mul b2~20@ d2~24@) (Mul c2~22@ b2~20@)))) (Mul (Sub (Sub (Mul a2~18@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@))) (Mul (Mul (Sub b2~20@ a2~18@) (Sub b2~20@ b2~20@)) (Add (Mul b2~20@ 44) (Mul a2~18@ b2~20@))))))) (=> (= temp_2_1~1654@ (Mul (Mul (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Sub d2~24@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Add b2~20@ b2~20@))) (Sub (Add (Sub a2~18@ c2~22@) c2~22@) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ b2~20@)))) (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Add b2~20@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@))) (Mul (Add c2~22@ (Add a2~18@ 58)) (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@))))) (Mul (Sub (Mul (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ d2~24@) a2~18@)) (Mul (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ 75)) (Sub (Mul b2~20@ d2~24@) (Mul c2~22@ b2~20@)))) (Mul (Sub (Sub (Mul a2~18@ b2~20@) (Mul b2~20@ d2~24@)) (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@))) (Mul (Mul (Sub b2~20@ a2~18@) (Sub b2~20@ b2~20@)) (Add (Mul b2~20@ 44) (Mul a2~18@ b2~20@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1373@ temp_2_1~1654@))) (=> (= temp_2_0~1373@ temp_2_1~1654@) (=> (= temp_3_0~1907@ (Mul (Mul (Mul (Mul (Mul d3~32@ (Mul d3~32@ c3~30@)) b3~28@) (Sub (Add (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul 48 d3~32@) (Mul c3~30@ a3~26@)))) (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ 20)) (Mul (Mul a3~26@ b3~28@) a3~26@)))) (Mul (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ d3~32@) b3~28@)) (Sub c3~30@ (Mul (Add d3~32@ b3~28@) (Mul a3~26@ d3~32@)))) (Mul (Sub (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ d3~32@) c3~30@)) (Mul c3~30@ (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ d3~32@))))))) (=> (= temp_3_1~2136@ (Mul (Mul (Mul (Mul (Mul d3~32@ (Mul d3~32@ c3~30@)) b3~28@) (Sub (Add (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul 48 d3~32@) (Mul a3~26@ c3~30@)))) (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ 20)) (Mul (Mul a3~26@ b3~28@) a3~26@)))) (Mul (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ d3~32@) b3~28@)) (Sub c3~30@ (Mul (Add d3~32@ b3~28@) (Mul a3~26@ d3~32@)))) (Mul (Sub (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ d3~32@)) (Mul (Mul b3~28@ d3~32@) c3~30@)) (Mul c3~30@ (Mul (Sub c3~30@ d3~32@) (Mul b3~28@ d3~32@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1907@ temp_3_1~2136@))) (=> (= temp_3_0~1907@ temp_3_1~2136@) (=> (= temp_4_0~2413@ (Mul (Mul (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Sub b4~36@ d4~40@) (Add c4~38@ a4~34@))) (Mul (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ d4~40@)) (Sub (Mul a4~34@ d4~40@) (Sub d4~40@ a4~34@)))) (Mul (Add (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ c4~38@))) (Mul (Mul (Sub a4~34@ b4~36@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ a4~34@))))) (Mul (Mul (Mul (Sub (Mul b4~36@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Sub b4~36@ d4~40@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@)) (Sub (Add d4~40@ d4~40@) (Mul b4~36@ b4~36@)))) (Mul (Mul (Sub (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul d4~40@ d4~40@) a4~34@)))))) (=> (= temp_4_1~2666@ (Mul (Mul (Mul (Mul (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Sub b4~36@ d4~40@) (Add c4~38@ a4~34@))) (Mul (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ d4~40@)) (Sub (Mul a4~34@ d4~40@) (Sub d4~40@ a4~34@)))) (Mul (Add (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Sub a4~34@ b4~36@) (Mul c4~38@ b4~36@))))) (Mul (Mul (Mul (Sub (Mul b4~36@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Sub b4~36@ d4~40@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@)) (Sub (Add d4~40@ d4~40@) (Mul b4~36@ b4~36@)))) (Mul (Mul (Sub (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul d4~40@ d4~40@) a4~34@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~2413@ temp_4_1~2666@))) (=> (= temp_4_0~2413@ temp_4_1~2666@) (=> (= temp_5_0~2887@ (Mul (Mul (Mul c5~46@ (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ c5~46@)))) (Mul (Add (Mul (Mul 26 c5~46@) d5~48@) (Mul c5~46@ (Mul b5~44@ b5~44@))) (Mul (Mul (Mul d5~48@ b5~44@) b5~44@) (Mul (Mul c5~46@ a5~42@) (Sub d5~48@ a5~42@))))) (Mul (Sub (Mul (Mul (Mul d5~48@ b5~44@) a5~42@) (Mul (Mul b5~44@ a5~42@) (Add a5~42@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Sub b5~44@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)))) (Mul a5~42@ (Mul (Sub (Mul a5~42@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ a5~42@))))))) (=> (= temp_5_1~3092@ (Mul (Mul (Mul c5~46@ (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ c5~46@)))) (Mul (Add (Mul (Mul 26 c5~46@) d5~48@) (Mul c5~46@ (Mul b5~44@ b5~44@))) (Mul (Mul (Mul d5~48@ b5~44@) b5~44@) (Sub (Mul (Mul c5~46@ a5~42@) d5~48@) (Mul (Mul c5~46@ a5~42@) a5~42@))))) (Mul (Sub (Mul (Mul (Mul d5~48@ b5~44@) a5~42@) (Mul (Mul b5~44@ a5~42@) (Add a5~42@ c5~46@))) (Mul (Mul (Mul a5~42@ c5~46@) (Sub b5~44@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul b5~44@ c5~46@)))) (Mul a5~42@ (Mul (Sub (Mul a5~42@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ a5~42@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2887@ temp_5_1~3092@))) (=> (= temp_5_0~2887@ temp_5_1~3092@) (=> (= temp_6_0~3333@ (Mul (Mul 78 (Mul (Add (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ a6~50@)) (Mul (Mul c6~54@ d6~56@) a6~50@)) (Mul (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ a6~50@)) (Mul (Sub c6~54@ c6~54@) (Mul d6~56@ b6~52@))))) (Mul (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ a6~50@)) b6~52@) (Mul (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@)))) (Sub (Mul (Mul (Mul b6~52@ b6~52@) (Mul 30 c6~54@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ d6~56@))) (Mul (Mul (Mul c6~54@ b6~52@) (Add b6~52@ b6~52@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ 60))))))) (=> (= temp_6_1~3550@ (Mul (Mul 78 (Mul (Add (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ a6~50@)) (Mul (Mul c6~54@ d6~56@) a6~50@)) (Mul (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Sub c6~54@ c6~54@))))) (Mul (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ a6~50@)) b6~52@) (Mul (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ a6~50@)) (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ d6~56@)))) (Sub (Mul (Mul (Mul b6~52@ b6~52@) (Mul 30 c6~54@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ d6~56@))) (Mul (Mul (Mul c6~54@ b6~52@) (Add b6~52@ b6~52@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ 60))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~3333@ temp_6_1~3550@))) (=> (= temp_6_0~3333@ temp_6_1~3550@) (=> (= temp_7_0~3775@ (Mul (Mul (Mul b7~60@ (Mul b7~60@ (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)))) (Add (Mul (Mul (Add d7~64@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ a7~58@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@))))) (Mul (Mul (Add (Mul (Mul d7~64@ b7~60@) a7~58@) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ a7~58@))) (Mul a7~58@ (Add (Mul b7~60@ a7~58@) (Mul d7~64@ a7~58@)))) (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ c7~62@)) (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ b7~60@))) (Sub (Add (Mul d7~64@ a7~58@) (Add b7~60@ a7~58@)) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ b7~60@))))))) (=> (= temp_7_1~3976@ (Mul (Mul (Mul (Mul b7~60@ (Mul b7~60@ (Mul (Mul b7~60@ a7~58@) (Mul b7~60@ c7~62@)))) (Add (Mul (Mul (Add d7~64@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ a7~58@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@))))) (Mul (Add (Mul (Mul d7~64@ b7~60@) a7~58@) (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ a7~58@))) (Mul a7~58@ (Add (Mul b7~60@ a7~58@) (Mul d7~64@ a7~58@))))) (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ c7~62@)) (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ b7~60@))) (Sub (Add (Mul d7~64@ a7~58@) (Add b7~60@ a7~58@)) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ b7~60@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3775@ temp_7_1~3976@))) (=> (= temp_7_0~3775@ temp_7_1~3976@) (=> (= temp_8_0~4261@ (Mul (Mul (Mul (Mul (Mul c8~70@ (Mul b8~68@ b8~68@)) 24) (Sub (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@)) (Mul (Sub c8~70@ a8~66@) (Mul b8~68@ d8~72@)))) (Mul (Mul (Mul (Mul b8~68@ 15) (Mul d8~72@ b8~68@)) c8~70@) (Mul c8~70@ (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ b8~68@))))) (Mul (Add (Add (Mul (Add b8~68@ d8~72@) a8~66@) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ c8~70@))) (Sub (Mul (Mul c8~70@ d8~72@) (Add c8~70@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Add b8~68@ d8~72@)))) (Mul (Mul (Add (Mul a8~66@ 8) (Sub a8~66@ d8~72@)) (Sub (Mul 92 a8~66@) (Sub d8~72@ b8~68@))) (Add (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@))))))) (=> (= temp_8_1~4522@ (Mul (Mul (Mul (Mul (Mul c8~70@ (Mul b8~68@ b8~68@)) 24) (Sub (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@)) (Mul (Sub c8~70@ a8~66@) (Mul b8~68@ d8~72@)))) (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ 15)) c8~70@) (Mul c8~70@ (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ b8~68@))))) (Mul (Add (Add (Mul (Add b8~68@ d8~72@) a8~66@) (Mul (Mul d8~72@ d8~72@) (Mul c8~70@ c8~70@))) (Sub (Mul (Mul c8~70@ d8~72@) (Add c8~70@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Add b8~68@ d8~72@)))) (Mul (Mul (Add (Mul a8~66@ 8) (Sub a8~66@ d8~72@)) (Sub (Mul 92 a8~66@) (Sub d8~72@ b8~68@))) (Add (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Mul b8~68@ a8~66@))))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~4261@ temp_8_1~4522@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
