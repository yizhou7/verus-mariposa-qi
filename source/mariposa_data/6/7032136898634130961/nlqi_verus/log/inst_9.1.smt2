...
(set-info :comment ";; mariposa_data/6//7032136898634130961/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~1069@ Int)
(declare-const temp_1_1~1378@ Int)
(declare-const temp_2_0~1623@ Int)
(declare-const temp_2_1~1840@ Int)
(declare-const temp_3_0~2065@ Int)
(declare-const temp_3_1~2254@ Int)
(declare-const temp_4_0~2511@ Int)
(declare-const temp_4_1~2740@ Int)
(declare-const temp_5_0~2993@ Int)
(declare-const temp_5_1~3202@ Int)
(declare-const temp_6_0~3449@ Int)
(declare-const temp_6_1~3662@ Int)
(declare-const temp_7_0~3859@ Int)
(declare-const temp_7_1~4020@ Int)
(declare-const temp_8_0~4295@ Int)
(declare-const temp_8_1~4532@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Sub (Mul (Mul (Mul a0~2@ (Mul d0~8@ b0~4@)) (Mul a0~2@ (Mul b0~4@ d0~8@))) (Add (Mul (Mul c0~6@ d0~8@) b0~4@) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@)))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) b0~4@) (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul c0~6@ b0~4@) (Sub (Mul b0~4@ d0~8@) (Mul d0~8@ c0~6@))))) (Mul (Mul (Sub (Sub (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)) a0~2@) (Sub (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@)) (Add (Mul c0~6@ b0~4@) (Mul a0~2@ d0~8@)))) (Mul (Sub (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ c0~6@)) (Sub (Mul b0~4@ b0~4@) (Sub c0~6@ c0~6@))))))) (=> (= temp_0_1~522@ (Mul (Mul (Sub (Mul (Mul (Mul a0~2@ (Mul d0~8@ b0~4@)) (Mul a0~2@ (Mul b0~4@ d0~8@))) (Add (Mul (Mul c0~6@ d0~8@) b0~4@) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@)))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) b0~4@) (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul c0~6@ b0~4@) (Sub (Mul b0~4@ d0~8@) (Mul d0~8@ c0~6@))))) (Mul (Sub (Sub (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)) a0~2@) (Sub (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@)) (Add (Mul c0~6@ b0~4@) (Mul a0~2@ d0~8@))))) (Mul (Sub (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ c0~6@)) (Sub (Mul b0~4@ b0~4@) (Sub c0~6@ c0~6@)))))) (and (=> (= tmp%1@ (Sub (Mul (Mul (Mul a0~2@ (Mul d0~8@ b0~4@)) (Mul a0~2@ (Mul b0~4@ d0~8@))) (Add (Mul (Mul c0~6@ d0~8@) b0~4@) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ d0~8@)))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) b0~4@) (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul c0~6@ b0~4@) (Sub (Mul b0~4@ d0~8@) (Mul d0~8@ c0~6@)))))) (=> (= tmp%2@ (Mul (Sub (Sub (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)) a0~2@) (Sub (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@)) (Add (Mul c0~6@ b0~4@) (Mul a0~2@ d0~8@))))) (=> (= tmp%3@ (Mul (Sub (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ c0~6@)) (Sub (Mul b0~4@ b0~4@) (Sub c0~6@ c0~6@))))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~522@)))))) (=> (= temp_0_0~301@ temp_0_1~522@) (=> (= temp_1_0~1069@ (Mul (Sub (Mul (Mul (Sub (Mul a1~10@ b1~12@) a1~10@) a1~10@) (Mul (Mul (Mul b1~12@ 51) (Mul c1~14@ b1~12@)) (Add (Sub d1~16@ d1~16@) (Mul c1~14@ c1~14@)))) (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Sub d1~16@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Mul 31 6))))) (Mul (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ d1~16@)) (Mul 67 (Mul a1~10@ d1~16@))) (Mul (Mul (Mul c1~14@ a1~10@) (Sub a1~10@ a1~10@)) (Mul (Add d1~16@ a1~10@) (Mul b1~12@ b1~12@)))) (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul 85 40)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ b1~12@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@)) (Add (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@))))))) (=> (= temp_1_1~1378@ (Mul (Sub (Mul (Mul (Sub (Mul b1~12@ a1~10@) a1~10@) a1~10@) (Mul (Mul (Mul b1~12@ 51) (Mul c1~14@ b1~12@)) (Add (Sub d1~16@ d1~16@) (Mul c1~14@ c1~14@)))) (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Sub d1~16@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Mul 31 6))))) (Mul (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ d1~16@)) (Mul 67 (Mul a1~10@ d1~16@))) (Mul (Mul (Mul c1~14@ a1~10@) (Sub a1~10@ a1~10@)) (Mul (Add d1~16@ a1~10@) (Mul b1~12@ b1~12@)))) (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul 85 40)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ b1~12@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@)) (Add (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ b1~12@) (=> %%location_label%%1 (= temp_1_0~1069@ temp_1_1~1378@))) (=> (= temp_1_0~1069@ temp_1_1~1378@) (=> (= temp_2_0~1623@ (Mul (Sub (Sub (Mul c2~22@ (Sub (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ b2~20@)))) (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Add b2~20@ (Mul c2~22@ c2~22@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ a2~18@))))) (Mul (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@)) (Sub (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ a2~18@)))) (Mul (Mul (Mul (Add b2~20@ b2~20@) c2~22@) (Mul (Mul c2~22@ c2~22@) a2~18@)) (Add a2~18@ (Mul (Mul b2~20@ b2~20@) b2~20@)))))) (=> (= temp_2_1~1840@ (Mul (Sub (Sub (Mul c2~22@ (Sub (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ b2~20@)))) (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Add b2~20@ (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ a2~18@))))) (Mul (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@)) (Sub (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ a2~18@)))) (Mul (Mul (Mul (Add b2~20@ b2~20@) c2~22@) (Mul (Mul c2~22@ c2~22@) a2~18@)) (Add a2~18@ (Mul (Mul b2~20@ b2~20@) b2~20@)))))) (and (=> (= tmp%4@ (Mul d2~24@ a2~18@)) (=> (= tmp%5@ (Mul a2~18@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~1623@ temp_2_1~1840@))))) (=> (= temp_2_0~1623@ temp_2_1~1840@) (=> (= temp_3_0~2065@ (Mul (Mul (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul c3~30@ (Mul c3~30@ d3~32@))) (Sub (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) d3~32@)) (Mul (Add (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ c3~30@) c3~30@)) (Mul (Mul (Mul d3~32@ b3~28@) (Sub a3~26@ c3~30@)) (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ c3~30@))))) (Mul (Mul (Add (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ b3~28@)) a3~26@) (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ b3~28@) d3~32@))) (Add b3~28@ (Mul (Mul b3~28@ (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ b3~28@))))))) (=> (= temp_3_1~2254@ (Mul (Mul (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul c3~30@ (Mul c3~30@ d3~32@))) (Sub (Mul (Mul c3~30@ d3~32@) (Mul b3~28@ b3~28@)) d3~32@)) (Mul (Add (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ a3~26@) c3~30@)) (Mul (Mul (Mul d3~32@ b3~28@) (Sub a3~26@ c3~30@)) (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ c3~30@))))) (Mul (Mul (Add (Mul (Mul a3~26@ a3~26@) (Mul d3~32@ b3~28@)) a3~26@) (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ b3~28@) d3~32@))) (Add b3~28@ (Mul (Mul b3~28@ (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ b3~28@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ c3~30@) (=> %%location_label%%3 (= temp_3_0~2065@ temp_3_1~2254@))) (=> (= temp_3_0~2065@ temp_3_1~2254@) (=> (= temp_4_0~2511@ (Mul (Sub (Mul (Mul (Mul (Sub c4~38@ d4~40@) (Mul a4~34@ c4~38@)) (Add (Mul b4~36@ c4~38@) c4~38@)) (Add (Mul (Mul c4~38@ d4~40@) b4~36@) (Mul b4~36@ (Mul c4~38@ b4~36@)))) (Mul (Mul (Add (Add a4~34@ b4~36@) (Mul b4~36@ d4~40@)) (Mul a4~34@ (Mul a4~34@ a4~34@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ d4~40@))))) (Sub (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul d4~40@ b4~36@) (Add b4~36@ d4~40@)) b4~36@)) (Add (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Sub c4~38@ c4~38@) (Mul c4~38@ a4~34@))) (Sub (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@)) (Sub (Mul d4~40@ a4~34@) (Mul a4~34@ a4~34@))))))) (=> (= temp_4_1~2740@ (Mul (Sub (Mul (Mul (Mul (Sub c4~38@ d4~40@) (Mul a4~34@ c4~38@)) (Add (Mul b4~36@ c4~38@) c4~38@)) (Add (Mul (Mul c4~38@ d4~40@) b4~36@) (Mul b4~36@ (Mul c4~38@ b4~36@)))) (Mul (Mul (Add (Add a4~34@ b4~36@) (Mul b4~36@ d4~40@)) (Mul a4~34@ (Mul a4~34@ a4~34@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ d4~40@)) (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ d4~40@))))) (Sub (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul d4~40@ b4~36@) (Add b4~36@ d4~40@)) b4~36@)) (Add (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@)) (Mul (Sub c4~38@ c4~38@) (Mul c4~38@ a4~34@))) (Sub (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ b4~36@)) (Sub (Mul d4~40@ a4~34@) (Mul a4~34@ a4~34@))))))) (and (=> (= tmp%6@ (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ d4~40@))) (=> (= tmp%7@ (Mul (Mul b4~36@ d4~40@) (Mul c4~38@ d4~40@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%4 (= temp_4_0~2511@ temp_4_1~2740@))))) (=> (= temp_4_0~2511@ temp_4_1~2740@) (=> (= temp_5_0~2993@ (Mul (Mul (Mul (Add (Mul (Add b5~44@ a5~42@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul a5~42@ a5~42@) d5~48@) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ b5~44@)))) (Mul (Mul d5~48@ (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@))) (Mul (Mul a5~42@ d5~48@) (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ a5~42@))))) (Mul (Mul (Mul (Sub (Sub d5~48@ d5~48@) (Add b5~44@ c5~46@)) 83) (Mul (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Sub d5~48@ d5~48@) (Mul d5~48@ c5~46@)))) (Sub (Mul (Mul (Mul a5~42@ a5~42@) b5~44@) (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ d5~48@))) a5~42@)))) (=> (= temp_5_1~3202@ (Mul (Mul (Mul (Add (Add (Mul b5~44@ (Mul d5~48@ c5~46@)) (Mul a5~42@ (Mul d5~48@ c5~46@))) (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ b5~44@))) (Mul (Mul (Mul a5~42@ a5~42@) d5~48@) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ b5~44@)))) (Mul (Mul d5~48@ (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ c5~46@))) (Mul (Mul a5~42@ d5~48@) (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ a5~42@))))) (Mul (Mul (Mul (Sub (Sub d5~48@ d5~48@) (Add b5~44@ c5~46@)) 83) (Mul (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Sub d5~48@ d5~48@) (Mul d5~48@ c5~46@)))) (Sub (Mul (Mul (Mul a5~42@ a5~42@) b5~44@) (Mul (Mul c5~46@ b5~44@) (Mul d5~48@ d5~48@))) a5~42@)))) (and (=> (= tmp%8@ (Mul d5~48@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. b5~44@ a5~42@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~2993@ temp_5_1~3202@)))) (=> (= temp_5_0~2993@ temp_5_1~3202@) (=> (= temp_6_0~3449@ (Mul (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Mul (Add c6~54@ d6~56@) (Mul c6~54@ c6~54@))) (Mul b6~52@ (Mul (Mul c6~54@ a6~50@) a6~50@))) (Mul (Add (Add (Mul c6~54@ c6~54@) (Sub b6~52@ 54)) (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@)) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@))))) (Mul (Mul (Mul (Mul (Sub c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul a6~50@ d6~56@) a6~50@) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ b6~52@)))) (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ d6~56@)) (Mul b6~52@ (Mul d6~56@ b6~52@))) (Mul d6~56@ c6~54@))))) (=> (= temp_6_1~3662@ (Mul (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Mul (Add c6~54@ d6~56@) (Mul c6~54@ c6~54@))) (Mul b6~52@ (Mul (Mul c6~54@ a6~50@) a6~50@))) (Mul (Add (Add (Mul c6~54@ c6~54@) (Sub b6~52@ 54)) (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@)) (Mul (Mul a6~50@ d6~56@) (Mul c6~54@ d6~56@))))) (Mul (Mul (Mul (Mul (Sub c6~54@ b6~52@) (Mul a6~50@ b6~52@)) (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul a6~50@ d6~56@) a6~50@) (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ b6~52@)))) (Mul (Mul (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ d6~56@)) (Mul b6~52@ (Mul d6~56@ b6~52@))) (Mul d6~56@ c6~54@))))) (and (=> (= tmp%9@ (Mul b6~52@ b6~52@)) (=> (= tmp%10@ (Mul b6~52@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~3449@ temp_6_1~3662@))))) (=> (= temp_6_0~3449@ temp_6_1~3662@) (=> (= temp_7_0~3859@ (Mul (Mul b7~60@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Sub d7~64@ d7~64@)) (Mul a7~58@ (Mul c7~62@ a7~58@))) (Mul (Add (Mul b7~60@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Sub d7~64@ d7~64@))))) (Mul (Mul (Mul a7~58@ (Mul (Mul c7~62@ d7~64@) (Sub c7~62@ d7~64@))) (Mul (Add (Mul d7~64@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) b7~60@))) (Mul (Mul (Add (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ c7~62@) b7~60@)) (Mul d7~64@ (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ c7~62@))))))) (=> (= temp_7_1~4020@ (Mul (Mul b7~60@ (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Sub d7~64@ d7~64@)) (Mul a7~58@ (Mul c7~62@ a7~58@))) (Mul (Add (Mul b7~60@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul b7~60@ c7~62@) (Sub d7~64@ d7~64@))))) (Mul (Mul (Mul a7~58@ (Mul (Mul c7~62@ d7~64@) (Sub c7~62@ d7~64@))) (Mul (Add (Mul d7~64@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ c7~62@) b7~60@))) (Mul (Mul (Add (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ c7~62@) b7~60@)) (Mul (Mul d7~64@ (Mul c7~62@ d7~64@)) (Mul c7~62@ c7~62@)))))) (and (=> (= tmp%11@ (Mul c7~62@ d7~64@)) (=> (= tmp%12@ (Mul c7~62@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d7~64@ tmp%11@ tmp%12@) (=> %%location_label%%7 (= temp_7_0~3859@ temp_7_1~4020@))))) (=> (= temp_7_0~3859@ temp_7_1~4020@) (=> (= temp_8_0~4295@ (Mul (Mul (Mul (Add (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Sub d8~72@ a8~66@) (Sub c8~70@ d8~72@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Sub d8~72@ b8~68@)))) (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ d8~72@)) (Mul (Mul a8~66@ c8~70@) d8~72@)) (Mul (Add (Mul c8~70@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ d8~72@))))) (Mul (Add (Mul (Mul (Add d8~72@ a8~66@) (Mul d8~72@ d8~72@)) (Add (Mul b8~68@ b8~68@) (Mul d8~72@ d8~72@))) d8~72@) (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Sub c8~70@ c8~70@) (Add b8~68@ c8~70@))) (Sub (Sub (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul a8~66@ c8~70@) (Mul 51 b8~68@))))))) (=> (= temp_8_1~4532@ (Mul (Mul (Mul (Add (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Sub d8~72@ a8~66@) (Sub c8~70@ d8~72@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Sub d8~72@ b8~68@)))) (Mul (Mul (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ d8~72@)) (Mul (Mul a8~66@ c8~70@) d8~72@)) (Mul (Add (Mul c8~70@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ d8~72@))))) (Mul (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Sub c8~70@ c8~70@) (Add b8~68@ c8~70@))) (Sub (Sub (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul a8~66@ c8~70@) (Mul 51 b8~68@)))) (Add (Mul (Mul (Add d8~72@ a8~66@) (Mul d8~72@ d8~72@)) (Add (Mul b8~68@ b8~68@) (Mul d8~72@ d8~72@))) d8~72@)))) (=> (= tmp%13@ (Add (Mul (Mul (Add d8~72@ a8~66@) (Mul d8~72@ d8~72@)) (Add (Mul b8~68@ b8~68@) (Mul d8~72@ d8~72@))) d8~72@)) (=> (= tmp%14@ (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Sub c8~70@ c8~70@) (Add b8~68@ c8~70@))) (Sub (Sub (Mul c8~70@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul a8~66@ c8~70@) (Mul 51 b8~68@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%13@ tmp%14@) (=> %%location_label%%8 (= temp_8_0~4295@ temp_8_1~4532@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
