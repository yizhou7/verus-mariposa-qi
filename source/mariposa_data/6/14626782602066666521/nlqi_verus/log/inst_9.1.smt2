...
(set-info :comment ";; mariposa_data/6//14626782602066666521/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~717@ Int)
(declare-const temp_1_1~894@ Int)
(declare-const temp_2_0~1143@ Int)
(declare-const temp_2_1~1344@ Int)
(declare-const temp_3_0~1557@ Int)
(declare-const temp_3_1~1734@ Int)
(declare-const temp_4_0~2027@ Int)
(declare-const temp_4_1~2244@ Int)
(declare-const temp_5_0~2441@ Int)
(declare-const temp_5_1~2610@ Int)
(declare-const temp_6_0~2775@ Int)
(declare-const temp_6_1~2904@ Int)
(declare-const temp_7_0~3177@ Int)
(declare-const temp_7_1~3414@ Int)
(declare-const temp_8_0~3667@ Int)
(declare-const temp_8_1~3892@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Mul (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Sub c0~6@ d0~8@) c0~6@)) (Mul (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Sub c0~6@ a0~2@)))) (Add (Add (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Add d0~8@ b0~4@) a0~2@)) (Mul (Mul (Mul c0~6@ d0~8@) c0~6@) (Mul (Sub c0~6@ d0~8@) a0~2@)))) (Add (Mul (Mul a0~2@ (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@))) (Mul (Mul (Add d0~8@ c0~6@) (Mul a0~2@ a0~2@)) (Sub (Mul b0~4@ d0~8@) (Mul d0~8@ c0~6@)))) (Mul (Mul b0~4@ (Mul c0~6@ (Sub c0~6@ b0~4@))) (Mul (Mul b0~4@ (Mul a0~2@ b0~4@)) (Mul (Sub b0~4@ c0~6@) (Add c0~6@ b0~4@))))))) (=> (= temp_0_1~506@ (Mul (Mul (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Sub c0~6@ d0~8@) c0~6@)) (Mul (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ c0~6@) (Sub c0~6@ a0~2@)))) (Add (Add (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Add d0~8@ b0~4@) a0~2@)) (Mul (Mul (Mul c0~6@ d0~8@) c0~6@) (Mul (Sub c0~6@ d0~8@) a0~2@)))) (Add (Mul (Mul a0~2@ (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ a0~2@))) (Mul (Add (Mul d0~8@ (Mul a0~2@ a0~2@)) (Mul c0~6@ (Mul a0~2@ a0~2@))) (Sub (Mul b0~4@ d0~8@) (Mul d0~8@ c0~6@)))) (Mul (Mul b0~4@ (Mul c0~6@ (Sub c0~6@ b0~4@))) (Mul (Mul b0~4@ (Mul a0~2@ b0~4@)) (Mul (Sub b0~4@ c0~6@) (Add c0~6@ b0~4@))))))) (and (=> (= tmp%1@ (Mul a0~2@ a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d0~8@ c0~6@ tmp%1@) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~506@)))) (=> (= temp_0_0~289@ temp_0_1~506@) (=> (= temp_1_0~717@ (Add (Mul (Mul d1~16@ (Mul (Mul (Add b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Mul d1~16@ (Mul b1~12@ c1~14@)))) (Mul (Mul (Mul c1~14@ (Sub b1~12@ d1~16@)) (Mul (Mul a1~10@ c1~14@) d1~16@)) (Mul (Sub (Mul a1~10@ c1~14@) a1~10@) (Mul a1~10@ (Mul d1~16@ b1~12@))))) (Mul (Mul (Sub (Mul b1~12@ (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul c1~14@ b1~12@) (Add d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@)))) (Mul d1~16@ (Sub b1~12@ (Mul (Mul 78 a1~10@) (Mul d1~16@ a1~10@))))))) (=> (= temp_1_1~894@ (Add (Mul (Mul d1~16@ (Mul (Mul (Add b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Mul d1~16@ (Mul b1~12@ c1~14@)))) (Mul (Mul (Mul c1~14@ (Sub b1~12@ d1~16@)) (Mul (Mul a1~10@ c1~14@) d1~16@)) (Mul (Sub (Mul a1~10@ c1~14@) a1~10@) (Mul a1~10@ (Mul d1~16@ b1~12@))))) (Mul (Mul (Sub (Mul b1~12@ (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul c1~14@ b1~12@) (Add d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@)))) (Mul d1~16@ (Sub b1~12@ (Mul (Mul d1~16@ a1~10@) (Mul 78 a1~10@))))))) (and (=> (= tmp%2@ (Mul 78 a1~10@)) (=> (= tmp%3@ (Mul d1~16@ a1~10@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%1 (= temp_1_0~717@ temp_1_1~894@))))) (=> (= temp_1_0~717@ temp_1_1~894@) (=> (= temp_2_0~1143@ (Mul (Mul b2~20@ (Mul (Sub (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ 81)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ b2~20@))) (Mul (Mul c2~22@ (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ d2~24@))))) (Mul (Mul (Mul (Add (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@)) (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@))) (Mul (Mul (Sub a2~18@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ b2~20@)))) (Add (Mul (Sub (Mul c2~22@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul c2~22@ b2~20@) (Add c2~22@ b2~20@)) (Mul d2~24@ (Mul b2~20@ c2~22@))))))) (=> (= temp_2_1~1344@ (Mul (Mul b2~20@ (Mul (Sub (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ 81)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ b2~20@))) (Mul (Mul c2~22@ (Mul d2~24@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ d2~24@))))) (Mul (Mul (Mul (Add (Mul d2~24@ a2~18@) (Mul d2~24@ c2~22@)) (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ d2~24@))) (Mul (Mul (Sub a2~18@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ b2~20@)))) (Add (Mul (Sub (Mul c2~22@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul c2~22@ b2~20@) (Add c2~22@ b2~20@)) (Mul d2~24@ (Mul b2~20@ c2~22@))))))) (and (=> (= tmp%4@ (Mul c2~22@ d2~24@)) (=> (= tmp%5@ (Mul d2~24@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~1143@ temp_2_1~1344@))))) (=> (= temp_2_0~1143@ temp_2_1~1344@) (=> (= temp_3_0~1557@ (Mul (Mul (Mul c3~30@ (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ d3~32@)) (Mul (Add d3~32@ c3~30@) (Mul a3~26@ c3~30@)))) (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ a3~26@)) c3~30@) (Mul (Mul (Add c3~30@ a3~26@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Add b3~28@ b3~28@))))) (Sub (Mul (Mul (Mul (Sub c3~30@ b3~28@) (Mul d3~32@ c3~30@)) (Mul c3~30@ (Mul a3~26@ a3~26@))) b3~28@) (Mul (Mul (Sub (Mul a3~26@ c3~30@) c3~30@) (Mul (Mul b3~28@ b3~28@) (Sub c3~30@ b3~28@))) (Mul (Mul (Add c3~30@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ d3~32@) a3~26@)))))) (=> (= temp_3_1~1734@ (Mul (Mul (Mul c3~30@ (Mul (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ d3~32@)) (Mul (Add d3~32@ c3~30@) (Mul a3~26@ c3~30@)))) (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ a3~26@)) c3~30@) (Mul (Mul (Add c3~30@ a3~26@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Add b3~28@ b3~28@))))) (Sub (Mul (Mul (Mul (Sub c3~30@ b3~28@) (Mul d3~32@ c3~30@)) (Mul c3~30@ (Mul a3~26@ a3~26@))) b3~28@) (Mul (Mul (Mul (Add c3~30@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ d3~32@) a3~26@)) (Mul (Sub (Mul a3~26@ c3~30@) c3~30@) (Mul (Mul b3~28@ b3~28@) (Sub c3~30@ b3~28@))))))) (and (=> (= tmp%6@ (Mul (Sub (Mul a3~26@ c3~30@) c3~30@) (Mul (Mul b3~28@ b3~28@) (Sub c3~30@ b3~28@)))) (=> (= tmp%7@ (Mul (Mul (Add c3~30@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ d3~32@) a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~1557@ temp_3_1~1734@))))) (=> (= temp_3_0~1557@ temp_3_1~1734@) (=> (= temp_4_0~2027@ (Mul (Sub (Mul (Mul (Mul d4~40@ (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@))) (Sub (Add (Mul c4~38@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ 36) (Add c4~38@ d4~40@)))) (Mul (Sub (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) c4~38@) (Mul a4~34@ (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ a4~34@))))) (Sub (Mul (Add (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ a4~34@)) (Mul d4~40@ d4~40@)) (Sub a4~34@ (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@)))) (Mul (Mul (Mul (Sub a4~34@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Add (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ d4~40@) a4~34@)))))) (=> (= temp_4_1~2244@ (Mul (Sub (Mul (Mul (Mul d4~40@ (Mul b4~36@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@))) (Sub (Add (Mul c4~38@ c4~38@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ 36) (Add c4~38@ d4~40@)))) (Mul (Sub (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) c4~38@) (Mul a4~34@ (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ a4~34@))))) (Sub (Mul (Add (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ a4~34@)) (Mul d4~40@ d4~40@)) (Sub a4~34@ (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@)))) (Mul (Mul (Mul (Sub a4~34@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Add (Mul c4~38@ c4~38@) (Mul c4~38@ d4~40@)) (Mul (Mul a4~34@ d4~40@) a4~34@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d4~40@ d4~40@) (=> %%location_label%%4 (= temp_4_0~2027@ temp_4_1~2244@))) (=> (= temp_4_0~2027@ temp_4_1~2244@) (=> (= temp_5_0~2441@ (Mul (Mul (Mul (Mul (Mul (Sub b5~44@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ c5~46@))) (Mul a5~42@ (Mul d5~48@ (Mul d5~48@ d5~48@)))) (Mul (Mul a5~42@ b5~44@) (Mul (Add (Add b5~44@ d5~48@) d5~48@) d5~48@))) (Mul (Sub a5~42@ (Mul (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul c5~46@ 22) (Mul a5~42@ d5~48@)))) (Mul (Add (Mul (Mul 21 d5~48@) (Mul a5~42@ a5~42@)) (Add (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@))) c5~46@)))) (=> (= temp_5_1~2610@ (Mul (Mul (Mul (Mul (Mul (Sub b5~44@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ c5~46@))) (Mul (Mul d5~48@ (Mul d5~48@ d5~48@)) a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul (Add (Add b5~44@ d5~48@) d5~48@) d5~48@))) (Mul (Sub a5~42@ (Mul (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul c5~46@ 22) (Mul a5~42@ d5~48@)))) (Mul (Add (Mul (Mul 21 d5~48@) (Mul a5~42@ a5~42@)) (Add (Mul a5~42@ d5~48@) (Mul c5~46@ b5~44@))) c5~46@)))) (and (=> (= tmp%8@ (Mul d5~48@ (Mul d5~48@ d5~48@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ tmp%8@) (=> %%location_label%%5 (= temp_5_0~2441@ temp_5_1~2610@)))) (=> (= temp_5_0~2441@ temp_5_1~2610@) (=> (= temp_6_0~2775@ (Mul (Mul a6~50@ (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Sub a6~50@ a6~50@) (Mul b6~52@ a6~50@))) (Mul (Mul c6~54@ a6~50@) (Mul (Mul 22 b6~52@) (Sub b6~52@ a6~50@))))) (Mul a6~50@ (Mul (Mul d6~56@ (Add (Mul c6~54@ c6~54@) (Mul a6~50@ c6~54@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ b6~52@)) (Add (Mul c6~54@ d6~56@) (Mul a6~50@ d6~56@))))))) (=> (= temp_6_1~2904@ (Mul (Mul a6~50@ (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Sub a6~50@ a6~50@) (Mul b6~52@ a6~50@))) (Mul (Mul c6~54@ a6~50@) (Mul (Mul 22 b6~52@) (Sub b6~52@ a6~50@))))) (Mul a6~50@ (Mul (Mul d6~56@ (Add (Mul c6~54@ c6~54@) (Mul a6~50@ c6~54@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Add (Mul c6~54@ d6~56@) (Mul a6~50@ d6~56@))))))) (and (=> (= tmp%9@ (Mul b6~52@ c6~54@)) (=> (= tmp%10@ (Mul d6~56@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~2775@ temp_6_1~2904@))))) (=> (= temp_6_0~2775@ temp_6_1~2904@) (=> (= temp_7_0~3177@ (Mul (Sub (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Add b7~60@ c7~62@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)))) (Mul (Mul (Mul (Add d7~64@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Add a7~58@ d7~64@) (Mul b7~60@ c7~62@))) (Mul (Mul b7~60@ 65) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ c7~62@))))) (Add (Mul (Add (Mul (Add c7~62@ a7~58@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Mul (Sub b7~60@ c7~62@) (Mul b7~60@ c7~62@)) c7~62@)) (Mul (Sub (Mul (Sub b7~60@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Add c7~62@ d7~64@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ b7~60@)) a7~58@))))) (=> (= temp_7_1~3414@ (Mul (Sub (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul b7~60@ d7~64@)) (Mul (Mul c7~62@ d7~64@) (Add b7~60@ c7~62@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)))) (Mul (Mul (Mul (Add d7~64@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Add a7~58@ d7~64@) (Mul b7~60@ c7~62@))) (Mul (Mul b7~60@ 65) (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ c7~62@))))) (Add (Mul (Add (Mul (Add c7~62@ a7~58@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Mul (Sub b7~60@ c7~62@) (Mul b7~60@ c7~62@)) c7~62@)) (Mul (Sub (Mul (Sub b7~60@ b7~60@) (Mul a7~58@ a7~58@)) (Mul (Add c7~62@ d7~64@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ b7~60@)) a7~58@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ b7~60@) (=> %%location_label%%7 (= temp_7_0~3177@ temp_7_1~3414@))) (=> (= temp_7_0~3177@ temp_7_1~3414@) (=> (= temp_8_0~3667@ (Mul (Mul (Mul (Mul (Sub (Mul b8~68@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Add c8~70@ c8~70@)))) (Mul (Mul (Sub (Mul c8~70@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ c8~70@) (Add d8~72@ c8~70@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul 24 a8~66@) (Mul d8~72@ c8~70@))))) (Mul (Mul (Sub (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ d8~72@)) (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@))) (Add (Add (Mul b8~68@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ a8~66@) c8~70@))) (Mul b8~68@ (Mul (Add (Sub c8~70@ c8~70@) (Mul b8~68@ a8~66@)) d8~72@))))) (=> (= temp_8_1~3892@ (Mul (Mul (Mul (Mul (Sub (Mul b8~68@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul a8~66@ d8~72@) (Add c8~70@ c8~70@)))) (Mul (Mul (Sub (Mul c8~70@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ c8~70@) (Add d8~72@ c8~70@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul 24 a8~66@) (Mul d8~72@ c8~70@))))) (Mul (Mul (Sub (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ d8~72@)) (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@))) (Add (Add (Mul b8~68@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Mul b8~68@ a8~66@) c8~70@))) (Mul b8~68@ (Mul (Add (Sub c8~70@ c8~70@) (Mul b8~68@ a8~66@)) d8~72@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ a8~66@) (=> %%location_label%%8 (= temp_8_0~3667@ temp_8_1~3892@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
