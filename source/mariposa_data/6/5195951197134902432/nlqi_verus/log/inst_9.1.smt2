...
(set-info :comment ";; mariposa_data/6//5195951197134902432/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~805@ Int)
(declare-const temp_1_1~986@ Int)
(declare-const temp_2_0~1387@ Int)
(declare-const temp_2_1~1588@ Int)
(declare-const temp_3_0~1779@ Int)
(declare-const temp_3_1~1924@ Int)
(declare-const temp_4_0~2139@ Int)
(declare-const temp_4_1~2304@ Int)
(declare-const temp_5_0~2409@ Int)
(declare-const temp_5_1~2486@ Int)
(declare-const temp_6_0~2753@ Int)
(declare-const temp_6_1~2990@ Int)
(declare-const temp_7_0~3315@ Int)
(declare-const temp_7_1~3612@ Int)
(declare-const temp_8_0~3871@ Int)
(declare-const temp_8_1~4096@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~321@ (Mul (Mul (Mul (Mul (Mul (Add d0~8@ b0~4@) (Mul c0~6@ c0~6@)) (Add (Mul b0~4@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Add (Sub d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ a0~2@)))) (Mul (Mul b0~4@ (Sub (Sub d0~8@ c0~6@) (Mul d0~8@ c0~6@))) (Mul (Mul (Sub d0~8@ b0~4@) (Mul d0~8@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))))) (Mul (Mul (Add (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ a0~2@))) (Mul d0~8@ (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ a0~2@)))) (Mul (Mul (Sub (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Mul b0~4@ a0~2@) (Mul c0~6@ 84))) (Mul (Sub d0~8@ (Mul b0~4@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ d0~8@))))))) (=> (= temp_0_1~562@ (Mul (Mul (Mul (Mul (Mul (Add d0~8@ b0~4@) (Mul c0~6@ c0~6@)) (Add (Mul b0~4@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Add (Sub d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ a0~2@)))) (Mul (Mul b0~4@ (Sub (Sub d0~8@ c0~6@) (Mul d0~8@ c0~6@))) (Mul (Mul (Sub d0~8@ b0~4@) (Mul d0~8@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))))) (Mul (Mul (Add (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ a0~2@))) (Mul d0~8@ (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ a0~2@)))) (Mul (Mul (Mul (Sub (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@)) (Mul b0~4@ a0~2@)) (Mul c0~6@ 84)) (Mul (Sub d0~8@ (Mul b0~4@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ d0~8@))))))) (and (=> (= tmp%1@ (Sub (Mul a0~2@ a0~2@) (Mul d0~8@ d0~8@))) (=> (= tmp%2@ (Mul b0~4@ a0~2@)) (=> (= tmp%3@ (Mul c0~6@ 84)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~321@ temp_0_1~562@)))))) (=> (= temp_0_0~321@ temp_0_1~562@) (=> (= temp_1_0~805@ (Mul (Mul d1~16@ (Mul (Mul (Add (Mul a1~10@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Add a1~10@ b1~12@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ c1~14@))))) (Mul (Mul (Mul (Sub (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul b1~12@ (Mul c1~14@ b1~12@))) (Mul (Mul (Mul d1~16@ b1~12@) (Sub d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@)))) (Mul (Mul a1~10@ (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ d1~16@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ d1~16@)) (Add (Mul a1~10@ b1~12@) (Mul a1~10@ d1~16@))))))) (=> (= temp_1_1~986@ (Mul (Mul (Mul (Mul (Sub (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul b1~12@ (Mul c1~14@ b1~12@))) (Mul (Mul (Mul d1~16@ b1~12@) (Sub d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@)))) (Mul (Mul a1~10@ (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ d1~16@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ d1~16@)) (Add (Mul a1~10@ b1~12@) (Mul a1~10@ d1~16@))))) (Mul d1~16@ (Mul (Mul (Add (Mul a1~10@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Add a1~10@ b1~12@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ c1~14@))))))) (and (=> (= tmp%4@ (Mul d1~16@ (Mul (Mul (Add (Mul a1~10@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Add a1~10@ b1~12@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ c1~14@)))))) (=> (= tmp%5@ (Mul (Mul (Mul (Sub (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul b1~12@ (Mul c1~14@ b1~12@))) (Mul (Mul (Mul d1~16@ b1~12@) (Sub d1~16@ d1~16@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@)))) (Mul (Mul a1~10@ (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ d1~16@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul d1~16@ d1~16@)) (Add (Mul a1~10@ b1~12@) (Mul a1~10@ d1~16@)))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~805@ temp_1_1~986@))))) (=> (= temp_1_0~805@ temp_1_1~986@) (=> (= temp_2_0~1387@ (Mul (Mul (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Sub 97 d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@))) (Sub (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Add c2~22@ d2~24@) (Mul d2~24@ b2~20@)))) (Sub (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@)) (Add d2~24@ (Mul d2~24@ b2~20@))) (Sub (Mul (Mul b2~20@ b2~20@) (Add d2~24@ d2~24@)) (Mul (Mul a2~18@ 63) (Mul c2~22@ a2~18@))))) (Sub (Mul (Mul (Mul (Sub d2~24@ 28) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ d2~24@) (Add b2~20@ a2~18@))) c2~22@) b2~20@))) (=> (= temp_2_1~1588@ (Mul (Mul (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Sub 97 d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul b2~20@ d2~24@))) (Sub (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Add c2~22@ d2~24@) (Mul d2~24@ b2~20@)))) (Sub (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ d2~24@)) (Add d2~24@ (Mul d2~24@ b2~20@))) (Sub (Mul (Mul b2~20@ b2~20@) (Add d2~24@ d2~24@)) (Mul (Mul a2~18@ 63) (Mul c2~22@ a2~18@))))) (Sub (Mul (Mul (Mul (Mul (Sub d2~24@ 28) b2~20@) b2~20@) (Mul (Mul a2~18@ d2~24@) (Add b2~20@ a2~18@))) c2~22@) b2~20@))) (and (=> (= tmp%6@ (Sub d2~24@ 28)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ b2~20@ b2~20@) (=> %%location_label%%2 (= temp_2_0~1387@ temp_2_1~1588@)))) (=> (= temp_2_0~1387@ temp_2_1~1588@) (=> (= temp_3_0~1779@ (Mul (Mul 86 (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul d3~32@ (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ d3~32@))))) (Mul (Mul (Mul (Mul (Add a3~26@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ c3~30@))) (Mul (Add (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ c3~30@)))) b3~28@))) (=> (= temp_3_1~1924@ (Mul (Mul 86 (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@))) (Mul (Mul d3~32@ (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ d3~32@))))) (Mul (Mul (Mul (Add a3~26@ a3~26@) (Mul (Mul a3~26@ b3~28@) (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ c3~30@)))) (Mul (Add (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ c3~30@)))) b3~28@))) (and (=> (= tmp%7@ (Add a3~26@ a3~26@)) (=> (= tmp%8@ (Mul a3~26@ b3~28@)) (=> (= tmp%9@ (Mul (Mul b3~28@ c3~30@) (Mul b3~28@ c3~30@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%7@ tmp%8@ tmp%9@) (=> %%location_label%%3 (= temp_3_0~1779@ temp_3_1~1924@)))))) (=> (= temp_3_0~1779@ temp_3_1~1924@) (=> (= temp_4_0~2139@ (Mul (Mul a4~34@ (Mul a4~34@ (Mul (Mul (Mul d4~40@ c4~38@) (Add b4~36@ d4~40@)) (Mul (Sub a4~34@ a4~34@) (Sub a4~34@ d4~40@))))) (Mul (Sub (Sub (Mul (Mul c4~38@ d4~40@) (Add b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ c4~38@)) (Add (Mul b4~36@ d4~40@) (Sub a4~34@ d4~40@)))) (Mul (Mul (Add (Mul b4~36@ d4~40@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Sub c4~38@ d4~40@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ d4~40@)) (Sub (Mul c4~38@ a4~34@) b4~36@)))))) (=> (= temp_4_1~2304@ (Mul (Mul a4~34@ (Mul a4~34@ (Mul (Mul (Mul d4~40@ c4~38@) (Add b4~36@ d4~40@)) (Mul (Sub a4~34@ a4~34@) (Sub a4~34@ d4~40@))))) (Mul (Sub (Sub (Mul (Mul c4~38@ d4~40@) (Add b4~36@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ c4~38@)) (Add (Mul b4~36@ d4~40@) (Sub a4~34@ d4~40@)))) (Mul (Mul (Add (Mul b4~36@ d4~40@) (Mul a4~34@ c4~38@)) (Mul (Mul b4~36@ b4~36@) (Sub c4~38@ d4~40@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@)) (Sub (Mul c4~38@ a4~34@) b4~36@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c4~38@ d4~40@) (=> %%location_label%%4 (= temp_4_0~2139@ temp_4_1~2304@))) (=> (= temp_4_0~2139@ temp_4_1~2304@) (=> (= temp_5_0~2409@ (Mul (Mul d5~48@ (Mul (Mul (Mul (Sub b5~44@ b5~44@) (Mul c5~46@ 83)) (Add (Mul c5~46@ b5~44@) (Sub d5~48@ d5~48@))) (Mul (Mul (Mul d5~48@ d5~48@) d5~48@) (Sub (Mul a5~42@ d5~48@) c5~46@)))) a5~42@)) (=> (= temp_5_1~2486@ (Mul (Mul d5~48@ (Mul (Mul (Mul (Sub b5~44@ b5~44@) (Mul c5~46@ 83)) (Add (Mul c5~46@ b5~44@) (Sub d5~48@ d5~48@))) (Mul (Mul d5~48@ (Mul d5~48@ d5~48@)) (Sub (Mul a5~42@ d5~48@) c5~46@)))) a5~42@)) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. d5~48@ d5~48@ d5~48@) (=> %%location_label%%5 (= temp_5_0~2409@ temp_5_1~2486@))) (=> (= temp_5_0~2409@ temp_5_1~2486@) (=> (= temp_6_0~2753@ (Mul (Sub (Mul (Mul (Sub (Mul 91 a6~50@) (Sub a6~50@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Mul (Add b6~52@ d6~56@) (Mul d6~56@ b6~52@)) c6~54@)) (Mul (Add (Mul (Sub b6~52@ a6~50@) (Mul b6~52@ a6~50@)) (Mul (Mul b6~52@ d6~56@) d6~56@)) (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ b6~52@)) (Mul a6~50@ d6~56@)))) (Mul (Mul (Mul (Mul b6~52@ (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ c6~54@))) (Add (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Add a6~50@ b6~52@) (Mul d6~56@ d6~56@)))) (Mul (Mul (Add (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Mul d6~56@ b6~52@) a6~50@)) (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@))))))) (=> (= temp_6_1~2990@ (Mul (Sub (Mul (Mul (Sub (Mul 91 a6~50@) (Sub a6~50@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Mul d6~56@ b6~52@))) (Mul (Mul (Add b6~52@ d6~56@) (Mul d6~56@ b6~52@)) c6~54@)) (Mul (Add (Mul (Sub b6~52@ a6~50@) (Mul b6~52@ a6~50@)) (Mul (Mul b6~52@ d6~56@) d6~56@)) (Mul (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ b6~52@)) (Mul a6~50@ d6~56@)))) (Mul (Mul (Mul (Mul b6~52@ (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ c6~54@))) (Add (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ c6~54@)) (Mul (Add a6~50@ b6~52@) (Mul d6~56@ d6~56@)))) (Mul (Mul (Add (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Mul d6~56@ b6~52@) a6~50@)) (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ d6~56@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d6~56@ d6~56@) (=> %%location_label%%6 (= temp_6_0~2753@ temp_6_1~2990@))) (=> (= temp_6_0~2753@ temp_6_1~2990@) (=> (= temp_7_0~3315@ (Add (Mul (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul 57 c7~62@)) (Mul (Mul 54 c7~62@) (Add b7~60@ d7~64@))) (Mul (Mul (Add d7~64@ 10) (Add b7~60@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ c7~62@)))) (Mul (Mul (Mul (Mul d7~64@ d7~64@) a7~58@) (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@)) (Mul (Mul d7~64@ a7~58@) d7~64@)))) (Mul (Mul (Mul (Add (Mul b7~60@ a7~58@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ b7~60@))) (Mul b7~60@ (Mul (Add c7~62@ b7~60@) (Mul b7~60@ 84)))) (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ c7~62@))) (Sub (Mul (Mul d7~64@ 26) (Mul c7~62@ c7~62@)) (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ c7~62@))))))) (=> (= temp_7_1~3612@ (Add (Mul (Mul (Mul (Mul (Mul c7~62@ b7~60@) (Mul 57 c7~62@)) (Mul (Mul 54 c7~62@) (Add b7~60@ d7~64@))) (Mul (Mul (Add d7~64@ 10) (Add b7~60@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ c7~62@)))) (Mul (Mul (Mul (Mul d7~64@ d7~64@) a7~58@) (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul (Mul a7~58@ c7~62@) c7~62@) d7~64@) (Mul (Mul d7~64@ a7~58@) d7~64@)))) (Mul (Mul (Mul (Add (Mul b7~60@ a7~58@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ b7~60@))) (Mul b7~60@ (Mul (Add c7~62@ b7~60@) (Mul b7~60@ 84)))) (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ c7~62@))) (Sub (Mul (Mul d7~64@ 26) (Mul c7~62@ c7~62@)) (Sub (Mul c7~62@ d7~64@) (Mul c7~62@ c7~62@))))))) (and (=> (= tmp%10@ (Mul a7~58@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%10@ c7~62@ d7~64@) (=> %%location_label%%7 (= temp_7_0~3315@ temp_7_1~3612@)))) (=> (= temp_7_0~3315@ temp_7_1~3612@) (=> (= temp_8_0~3871@ (Mul (Mul (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ a8~66@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ c8~70@)) (Sub (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)))) (Add (Mul b8~68@ (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ c8~70@))) (Add (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ c8~70@)) b8~68@))) (Mul (Sub (Add (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Add c8~70@ a8~66@) (Sub c8~70@ b8~68@))) (Add (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@)))) (Add (Mul (Sub (Mul a8~66@ a8~66@) d8~72@) (Mul (Mul b8~68@ d8~72@) d8~72@)) (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@)) (Add (Mul c8~70@ b8~68@) (Mul c8~70@ a8~66@))))))) (=> (= temp_8_1~4096@ (Mul (Mul (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ a8~66@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ c8~70@)) (Sub (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)))) (Add (Mul b8~68@ (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ c8~70@))) (Add (Mul (Mul a8~66@ c8~70@) (Mul a8~66@ c8~70@)) b8~68@))) (Mul (Sub (Add (Mul (Mul a8~66@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Add c8~70@ a8~66@) (Sub c8~70@ b8~68@))) (Add (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ d8~72@)))) (Add (Mul (Sub (Mul a8~66@ a8~66@) d8~72@) (Mul (Mul b8~68@ d8~72@) d8~72@)) (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ c8~70@)) (Add (Mul c8~70@ b8~68@) (Mul c8~70@ a8~66@))))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ b8~68@) (=> %%location_label%%8 (= temp_8_0~3871@ temp_8_1~4096@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
