...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~297@ (Sub (Mul (Mul (Mul a0~2@ (Add (Mul a0~2@ a0~2@) (Sub a0~2@ d0~8@))) (Mul (Mul (Mul c0~6@ d0~8@) d0~8@) (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@)))) (Sub (Mul (Mul (Add c0~6@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Sub d0~8@ a0~2@) (Mul b0~4@ b0~4@))) (Mul (Mul b0~4@ (Mul d0~8@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ c0~6@))))) (Mul (Mul (Mul (Mul (Add c0~6@ a0~2@) (Mul c0~6@ c0~6@)) b0~4@) (Mul (Mul b0~4@ (Mul a0~2@ b0~4@)) (Add (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@)))) (Sub (Mul (Mul b0~4@ (Mul a0~2@ a0~2@)) (Mul d0~8@ (Mul d0~8@ c0~6@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Sub (Mul c0~6@ a0~2@) (Add d0~8@ a0~2@))))))) (=> (= temp_0_1~510@ (Sub (Mul (Mul (Mul a0~2@ (Add (Mul a0~2@ a0~2@) (Sub a0~2@ d0~8@))) (Mul (Mul (Mul c0~6@ d0~8@) d0~8@) (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@)))) (Sub (Mul (Mul (Add c0~6@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Mul b0~4@ b0~4@) (Sub d0~8@ a0~2@))) (Mul (Mul b0~4@ (Mul d0~8@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ c0~6@))))) (Mul (Mul (Mul (Mul (Add c0~6@ a0~2@) (Mul c0~6@ c0~6@)) b0~4@) (Mul (Mul b0~4@ (Mul a0~2@ b0~4@)) (Add (Mul d0~8@ c0~6@) (Mul a0~2@ b0~4@)))) (Sub (Mul (Mul b0~4@ (Mul a0~2@ a0~2@)) (Mul d0~8@ (Mul d0~8@ c0~6@))) (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Sub (Mul c0~6@ a0~2@) (Add d0~8@ a0~2@))))))) (=> (= tmp%1@ (= temp_0_0~297@ temp_0_1~510@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~762@ (Mul (Mul (Add (Mul c1~14@ (Sub (Mul c1~14@ a1~10@) (Mul a1~10@ b1~12@))) (Mul (Sub (Add d1~16@ c1~14@) (Mul c1~14@ 75)) (Mul (Add c1~14@ c1~14@) (Mul a1~10@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ c1~14@) d1~16@) (Sub (Mul a1~10@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul a1~10@ c1~14@) c1~14@)))) (Mul (Add (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ b1~12@))) (Mul (Mul (Add c1~14@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ a1~10@)))) (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@)) b1~12@))))) (=> (= temp_1_1~1007@ (Mul (Mul (Add (Mul c1~14@ (Sub (Mul c1~14@ a1~10@) (Mul a1~10@ b1~12@))) (Mul (Sub (Add d1~16@ c1~14@) (Mul c1~14@ 75)) (Mul (Add c1~14@ c1~14@) (Mul a1~10@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ c1~14@) d1~16@) (Sub (Mul a1~10@ b1~12@) (Mul a1~10@ c1~14@))) (Mul (Mul (Mul d1~16@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul a1~10@ c1~14@) c1~14@)))) (Mul (Add (Mul (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ b1~12@))) (Mul (Add (Mul c1~14@ (Mul b1~12@ c1~14@)) (Mul c1~14@ (Mul b1~12@ c1~14@))) (Mul (Mul c1~14@ b1~12@) (Mul b1~12@ a1~10@)))) (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@)) b1~12@))))) (=> (= tmp%2@ (= temp_1_0~762@ temp_1_1~1007@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~1263@ (Mul (Mul (Add (Mul (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Add c2~22@ d2~24@))) (Add (Mul (Mul c2~22@ a2~18@) a2~18@) (Mul (Mul d2~24@ d2~24@) (Sub a2~18@ a2~18@)))) (Mul (Mul d2~24@ (Mul (Mul a2~18@ b2~20@) c2~22@)) (Mul (Mul a2~18@ (Mul a2~18@ b2~20@)) (Mul (Mul c2~22@ a2~18@) d2~24@)))) (Mul (Mul (Mul d2~24@ (Sub b2~20@ (Mul a2~18@ b2~20@))) (Mul (Mul (Sub c2~22@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)))) (Mul (Mul (Add (Mul 39 b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ b2~20@) c2~22@)) (Add (Mul (Add c2~22@ a2~18@) (Mul d2~24@ 12)) (Sub d2~24@ (Mul 19 c2~22@))))))) (=> (= temp_2_1~1504@ (Mul (Mul (Add (Mul (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Add c2~22@ d2~24@))) (Add (Mul (Mul c2~22@ a2~18@) a2~18@) (Mul (Mul d2~24@ d2~24@) (Sub a2~18@ a2~18@)))) (Mul (Mul d2~24@ (Mul (Mul a2~18@ b2~20@) c2~22@)) (Mul (Mul a2~18@ (Mul a2~18@ b2~20@)) (Mul (Mul c2~22@ a2~18@) d2~24@)))) (Mul (Mul (Mul d2~24@ (Sub b2~20@ (Mul a2~18@ b2~20@))) (Mul (Mul (Sub c2~22@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)))) (Mul (Mul (Add (Mul b2~20@ 39) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ b2~20@) c2~22@)) (Add (Mul (Add c2~22@ a2~18@) (Mul d2~24@ 12)) (Sub d2~24@ (Mul 19 c2~22@))))))) (=> (= tmp%3@ (= temp_2_0~1263@ temp_2_1~1504@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1756@ (Mul (Sub (Sub (Mul (Add b3~28@ b3~28@) (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ b3~28@))) (Mul (Mul (Mul b3~28@ a3~26@) (Add a3~26@ a3~26@)) (Mul (Mul a3~26@ d3~32@) (Sub d3~32@ d3~32@)))) (Mul (Mul (Add (Mul c3~30@ b3~28@) (Mul a3~26@ a3~26@)) b3~28@) (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ b3~28@)) (Mul b3~28@ (Mul a3~26@ b3~28@))))) (Mul (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Add 56 (Mul b3~28@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Sub b3~28@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@)))) (Mul (Mul (Mul (Sub b3~28@ b3~28@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ b3~28@))))))) (=> (= temp_3_1~1993@ (Mul (Sub (Sub (Mul (Add b3~28@ b3~28@) (Mul (Mul b3~28@ b3~28@) (Sub a3~26@ b3~28@))) (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Add a3~26@ a3~26@)) (Mul a3~26@ d3~32@)) (Sub d3~32@ d3~32@))) (Mul (Mul (Add (Mul c3~30@ b3~28@) (Mul a3~26@ a3~26@)) b3~28@) (Mul (Mul (Mul b3~28@ d3~32@) (Mul b3~28@ b3~28@)) (Mul b3~28@ (Mul a3~26@ b3~28@))))) (Mul (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Add 56 (Mul b3~28@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Sub b3~28@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ d3~32@)))) (Mul (Mul (Mul (Sub b3~28@ b3~28@) c3~30@) (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ b3~28@))))))) (=> (= tmp%4@ (= temp_3_0~1756@ temp_3_1~1993@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~2125@ (Mul a4~34@ (Mul (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Sub c4~38@ c4~38@)))) (Mul (Mul b4~36@ (Sub (Add a4~34@ 58) (Mul a4~34@ a4~34@))) (Mul a4~34@ (Mul (Add c4~38@ c4~38@) b4~36@)))))) (=> (= temp_4_1~2242@ (Mul a4~34@ (Mul (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ d4~40@)) (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Sub c4~38@ c4~38@)))) (Mul (Mul b4~36@ (Sub (Add a4~34@ 58) (Mul a4~34@ a4~34@))) (Mul a4~34@ (Mul (Add c4~38@ c4~38@) b4~36@)))))) (=> (= tmp%5@ (= temp_4_0~2125@ temp_4_1~2242@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~2458@ (Mul (Mul (Mul (Mul b5~44@ (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@)))) (Mul (Mul c5~46@ (Mul (Mul c5~46@ a5~42@) (Mul 75 a5~42@))) (Mul (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@)) (Mul (Add b5~44@ b5~44@) (Mul c5~46@ b5~44@))))) (Mul (Mul (Mul (Add (Add a5~42@ d5~48@) (Sub c5~46@ a5~42@)) (Mul (Sub d5~48@ c5~46@) (Mul 70 b5~44@))) a5~42@) (Mul (Mul (Mul (Mul c5~46@ b5~44@) c5~46@) a5~42@) (Mul c5~46@ (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ c5~46@))))))) (=> (= temp_5_1~2659@ (Mul (Mul (Mul (Mul b5~44@ (Mul (Mul a5~42@ c5~46@) (Mul d5~48@ d5~48@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@)) (Mul (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@)))) (Mul (Mul c5~46@ (Mul (Mul c5~46@ a5~42@) (Mul 75 a5~42@))) (Mul (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@)) (Mul (Add b5~44@ b5~44@) (Mul c5~46@ b5~44@))))) (Mul (Mul a5~42@ (Mul (Add (Add a5~42@ d5~48@) (Sub c5~46@ a5~42@)) (Mul (Sub d5~48@ c5~46@) (Mul 70 b5~44@)))) (Mul (Mul (Mul (Mul c5~46@ b5~44@) c5~46@) a5~42@) (Mul c5~46@ (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ c5~46@))))))) (=> (= tmp%6@ (= temp_5_0~2458@ temp_5_1~2659@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~2923@ (Mul (Mul (Mul (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Sub a6~50@ d6~56@) (Mul c6~54@ a6~50@))) (Mul (Sub d6~56@ (Mul b6~52@ b6~52@)) (Mul d6~56@ (Mul c6~54@ d6~56@)))) (Mul (Mul (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Add c6~54@ a6~50@))) (Mul (Mul (Mul a6~50@ d6~56@) a6~50@) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ d6~56@))))) (Mul (Mul (Mul (Mul (Mul b6~52@ 3) d6~56@) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Add (Mul a6~50@ a6~50@) (Mul d6~56@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Sub a6~50@ b6~52@)))) (Mul (Mul a6~50@ (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ 13))) (Mul (Sub (Mul b6~52@ b6~52@) d6~56@) (Mul (Mul c6~54@ c6~54@) (Add b6~52@ c6~54@))))))) (=> (= temp_6_1~3172@ (Mul (Mul (Mul (Mul (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Add c6~54@ a6~50@))) (Mul (Mul (Mul a6~50@ d6~56@) a6~50@) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ d6~56@)))) (Mul (Mul (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Sub a6~50@ d6~56@) (Mul c6~54@ a6~50@))) (Mul (Sub d6~56@ (Mul b6~52@ b6~52@)) (Mul d6~56@ (Mul c6~54@ d6~56@))))) (Mul (Mul (Mul (Mul (Mul b6~52@ 3) d6~56@) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Add (Mul a6~50@ a6~50@) (Mul d6~56@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Sub a6~50@ b6~52@)))) (Mul (Mul a6~50@ (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ 13))) (Mul (Sub (Mul b6~52@ b6~52@) d6~56@) (Mul (Mul c6~54@ c6~54@) (Add b6~52@ c6~54@))))))) (=> (= tmp%7@ (= temp_6_0~2923@ temp_6_1~3172@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~3316@ (Mul (Mul (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ d7~64@))) (Mul d7~64@ (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ b7~60@)))) (Mul (Sub (Mul (Mul b7~60@ c7~62@) (Mul c7~62@ a7~58@)) (Mul a7~58@ c7~62@)) (Sub (Mul (Mul d7~64@ 8) (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@))))) (Sub c7~62@ c7~62@))) (=> (= temp_7_1~3445@ (Mul (Mul (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul b7~60@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ d7~64@))) (Mul d7~64@ (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ b7~60@)))) (Mul (Sub (Mul (Mul b7~60@ c7~62@) (Mul a7~58@ c7~62@)) (Mul a7~58@ c7~62@)) (Sub (Mul (Mul d7~64@ 8) (Mul a7~58@ d7~64@)) (Mul (Mul c7~62@ b7~60@) (Mul d7~64@ d7~64@))))) (Sub c7~62@ c7~62@))) (=> (= tmp%8@ (= temp_7_0~3316@ temp_7_1~3445@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~3677@ (Sub (Mul (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Sub b8~68@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ c8~70@) (Sub d8~72@ b8~68@)))) (Mul d8~72@ (Mul (Mul (Mul c8~70@ a8~66@) (Add 52 b8~68@)) (Mul b8~68@ (Mul d8~72@ a8~66@))))) (Mul (Mul (Mul (Add a8~66@ (Mul b8~68@ a8~66@)) (Sub (Mul b8~68@ d8~72@) d8~72@)) (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@)))) (Mul (Sub (Mul (Sub c8~70@ b8~68@) (Mul a8~66@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ d8~72@))) (Sub (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ a8~66@)) d8~72@))))) (=> (= temp_8_1~3894@ (Sub (Mul (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Sub b8~68@ d8~72@)) (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul a8~66@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ c8~70@) (Sub d8~72@ b8~68@)))) (Mul d8~72@ (Mul (Mul (Add 52 b8~68@) (Mul c8~70@ a8~66@)) (Mul b8~68@ (Mul d8~72@ a8~66@))))) (Mul (Mul (Mul (Add a8~66@ (Mul b8~68@ a8~66@)) (Sub (Mul b8~68@ d8~72@) d8~72@)) (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@)))) (Mul (Sub (Mul (Sub c8~70@ b8~68@) (Mul a8~66@ c8~70@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ d8~72@))) (Sub (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ a8~66@)) d8~72@))))) (=> (= tmp%9@ (= temp_8_0~3677@ temp_8_1~3894@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
