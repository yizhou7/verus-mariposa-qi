...
(declare-const temp_1_1~1012@ Int)
(declare-const temp_2_0~1301@ Int)
(declare-const temp_2_1~1566@ Int)
(declare-const temp_3_0~1819@ Int)
(declare-const temp_3_1~2048@ Int)
(declare-const temp_4_0~2281@ Int)
(declare-const temp_4_1~2490@ Int)
(declare-const temp_5_0~2787@ Int)
(declare-const temp_5_1~3060@ Int)
(declare-const temp_6_0~3313@ Int)
(declare-const temp_6_1~3542@ Int)
(declare-const temp_7_0~3695@ Int)
(declare-const temp_7_1~3832@ Int)
(declare-const temp_8_0~4109@ Int)
(declare-const temp_8_1~4362@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~329@ (Mul (Mul (Mul (Mul (Sub (Mul a0~2@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ 28))) (Sub d0~8@ (Mul (Mul c0~6@ b0~4@) (Add a0~2@ a0~2@)))) (Sub (Mul (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ c0~6@)) (Sub (Mul b0~4@ b0~4@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul b0~4@ c0~6@) d0~8@) (Mul (Sub d0~8@ c0~6@) (Mul d0~8@ a0~2@))))) (Mul (Mul (Mul (Sub (Mul d0~8@ d0~8@) (Sub a0~2@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Add c0~6@ (Mul d0~8@ b0~4@)) (Mul (Mul a0~2@ c0~6@) (Sub c0~6@ d0~8@)))) (Sub (Mul (Mul (Sub a0~2@ c0~6@) (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ d0~8@))) (Mul (Mul (Sub c0~6@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ b0~4@))))))) (=> (= temp_0_1~578@ (Mul (Mul (Mul (Mul (Sub (Mul a0~2@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ 28))) (Sub d0~8@ (Mul (Mul c0~6@ b0~4@) (Add a0~2@ a0~2@)))) (Sub (Mul (Mul (Mul d0~8@ c0~6@) (Mul b0~4@ c0~6@)) (Sub (Mul b0~4@ b0~4@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul b0~4@ c0~6@) d0~8@) (Mul (Sub d0~8@ c0~6@) (Mul d0~8@ a0~2@))))) (Mul (Mul (Mul (Sub (Mul d0~8@ d0~8@) (Sub a0~2@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ d0~8@))) (Mul (Add c0~6@ (Mul d0~8@ b0~4@)) (Mul (Sub c0~6@ d0~8@) (Mul a0~2@ c0~6@)))) (Sub (Mul (Mul (Sub a0~2@ c0~6@) (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ d0~8@))) (Mul (Mul (Sub c0~6@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ b0~4@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~329@ temp_0_1~578@))) (=> (= temp_0_0~329@ temp_0_1~578@) (=> (= temp_1_0~807@ (Mul (Sub (Mul (Mul (Sub (Sub c1~14@ c1~14@) b1~12@) (Mul (Mul c1~14@ c1~14@) c1~14@)) (Mul (Mul (Sub d1~16@ b1~12@) (Add d1~16@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ d1~16@)))) (Mul (Mul (Sub (Mul b1~12@ c1~14@) (Mul a1~10@ b1~12@)) d1~16@) (Sub (Mul (Add d1~16@ c1~14@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ d1~16@))))) (Mul (Mul (Mul (Mul (Mul d1~16@ b1~12@) a1~10@) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@))) d1~16@) (Mul (Add (Mul (Mul d1~16@ c1~14@) b1~12@) (Mul (Mul c1~14@ b1~12@) a1~10@)) (Mul (Mul a1~10@ (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ 95) (Add c1~14@ c1~14@))))))) (=> (= temp_1_1~1012@ (Mul (Sub (Mul (Mul (Sub (Sub c1~14@ c1~14@) b1~12@) (Mul (Mul c1~14@ c1~14@) c1~14@)) (Mul (Mul (Sub d1~16@ b1~12@) (Add d1~16@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ d1~16@)))) (Mul (Mul (Sub (Mul b1~12@ c1~14@) (Mul a1~10@ b1~12@)) d1~16@) (Sub (Mul (Add d1~16@ c1~14@) (Mul d1~16@ d1~16@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ d1~16@))))) (Mul (Mul (Mul (Mul (Mul d1~16@ b1~12@) a1~10@) (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@))) d1~16@) (Mul (Add (Mul (Mul d1~16@ c1~14@) b1~12@) (Mul a1~10@ (Mul c1~14@ b1~12@))) (Mul (Mul a1~10@ (Mul b1~12@ b1~12@)) (Mul (Mul c1~14@ 95) (Add c1~14@ c1~14@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~807@ temp_1_1~1012@))) (=> (= temp_1_0~807@ temp_1_1~1012@) (=> (= temp_2_0~1301@ (Add (Mul (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Add d2~24@ b2~20@) (Sub c2~22@ c2~22@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul d2~24@ a2~18@) (Add d2~24@ b2~20@)))) (Mul (Mul c2~22@ (Mul (Mul a2~18@ a2~18@) a2~18@)) (Mul (Mul (Add d2~24@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ c2~22@))))) (Add (Mul (Sub (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ b2~20@)) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Sub b2~20@ c2~22@) (Mul b2~20@ d2~24@)))) (Sub (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ 47)) (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ 75)) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@))))))) (=> (= temp_2_1~1566@ (Add (Mul (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Add d2~24@ b2~20@) (Sub c2~22@ c2~22@))) (Mul (Mul b2~20@ b2~20@) (Mul (Mul b2~20@ b2~20@) (Mul (Mul d2~24@ a2~18@) (Add d2~24@ b2~20@))))) (Mul (Mul c2~22@ (Mul (Mul a2~18@ a2~18@) a2~18@)) (Mul (Mul (Add d2~24@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ c2~22@))))) (Add (Mul (Sub (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ b2~20@)) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ a2~18@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Sub b2~20@ c2~22@) (Mul b2~20@ d2~24@)))) (Sub (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ 47)) (Mul (Mul b2~20@ c2~22@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul d2~24@ d2~24@) (Mul c2~22@ 75)) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1301@ temp_2_1~1566@))) (=> (= temp_2_0~1301@ temp_2_1~1566@) (=> (= temp_3_0~1819@ (Mul (Mul (Mul (Sub b3~28@ d3~32@) (Mul (Add (Mul d3~32@ b3~28@) a3~26@) (Mul (Add d3~32@ a3~26@) (Mul a3~26@ a3~26@)))) (Mul (Mul (Add (Sub c3~30@ a3~26@) (Mul b3~28@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul b3~28@ a3~26@))) (Mul (Mul (Sub b3~28@ a3~26@) (Sub a3~26@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Add d3~32@ d3~32@))))) (Mul (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ c3~30@)) (Sub (Mul b3~28@ b3~28@) (Mul b3~28@ 54))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ a3~26@) (Sub b3~28@ d3~32@)))) (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ a3~26@)) d3~32@) (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@))))))) (=> (= temp_3_1~2048@ (Mul (Mul (Mul (Sub b3~28@ d3~32@) (Mul (Add (Mul d3~32@ b3~28@) a3~26@) (Mul (Add d3~32@ a3~26@) (Mul a3~26@ a3~26@)))) (Mul (Mul (Add (Sub c3~30@ a3~26@) (Mul b3~28@ a3~26@)) (Add (Mul d3~32@ a3~26@) (Mul b3~28@ a3~26@))) (Mul (Mul (Sub b3~28@ a3~26@) (Sub a3~26@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Add d3~32@ d3~32@))))) (Mul (Mul (Mul (Sub (Mul b3~28@ b3~28@) (Mul b3~28@ 54)) (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ a3~26@) (Sub b3~28@ d3~32@)))) (Mul (Mul (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ a3~26@)) d3~32@) (Mul (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1819@ temp_3_1~2048@))) (=> (= temp_3_0~1819@ temp_3_1~2048@) (=> (= temp_4_0~2281@ (Mul (Mul (Mul (Add (Mul (Add c4~38@ d4~40@) (Sub d4~40@ b4~36@)) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ c4~38@))) (Mul (Mul (Mul b4~36@ d4~40@) b4~36@) (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ d4~40@)))) (Mul (Mul (Sub b4~36@ (Mul d4~40@ a4~34@)) (Mul (Sub c4~38@ d4~40@) (Sub c4~38@ b4~36@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ d4~40@))))) (Mul (Sub (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@)) a4~34@) (Mul b4~36@ (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@)))) (Mul (Mul b4~36@ (Mul (Add d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Add (Mul d4~40@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul c4~38@ a4~34@) c4~38@)))))) (=> (= temp_4_1~2490@ (Mul (Mul (Mul (Add (Mul (Add c4~38@ d4~40@) (Sub d4~40@ b4~36@)) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ c4~38@))) (Mul (Mul b4~36@ (Mul d4~40@ b4~36@)) (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ d4~40@)))) (Mul (Mul (Sub b4~36@ (Mul d4~40@ a4~34@)) (Mul (Sub c4~38@ d4~40@) (Sub c4~38@ b4~36@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ d4~40@))))) (Mul (Sub (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@)) a4~34@) (Mul b4~36@ (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ a4~34@)))) (Mul (Mul b4~36@ (Mul (Add d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Add (Mul d4~40@ b4~36@) (Mul d4~40@ b4~36@)) (Mul (Mul c4~38@ a4~34@) c4~38@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~2281@ temp_4_1~2490@))) (=> (= temp_4_0~2281@ temp_4_1~2490@) (=> (= temp_5_0~2787@ (Sub (Mul (Mul (Mul (Mul d5~48@ (Sub a5~42@ b5~44@)) (Sub (Mul d5~48@ d5~48@) (Mul d5~48@ c5~46@))) (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@ 18) (Mul d5~48@ c5~46@)))) (Mul (Mul (Add (Sub a5~42@ d5~48@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Add a5~42@ a5~42@))) (Sub (Mul a5~42@ (Mul a5~42@ a5~42@)) (Mul (Add b5~44@ a5~42@) b5~44@)))) (Add (Mul (Mul (Add (Mul d5~48@ d5~48@) (Mul d5~48@ c5~46@)) (Add (Mul d5~48@ b5~44@) (Mul c5~46@ a5~42@))) (Mul (Add c5~46@ (Mul b5~44@ b5~44@)) (Add b5~44@ (Mul d5~48@ a5~42@)))) (Add (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ 39)) (Mul (Mul c5~46@ a5~42@) (Sub d5~48@ a5~42@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul 97 c5~46@)) (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ b5~44@))))))) (=> (= temp_5_1~3060@ (Sub (Mul (Mul (Mul (Mul d5~48@ (Sub a5~42@ b5~44@)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ c5~46@)) (Mul (Mul d5~48@ 18) (Mul d5~48@ c5~46@)))) (Mul (Mul (Add (Sub a5~42@ d5~48@) (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Add a5~42@ a5~42@))) (Sub (Mul a5~42@ (Mul a5~42@ a5~42@)) (Mul (Add b5~44@ a5~42@) b5~44@)))) (Add (Mul (Mul (Add (Mul d5~48@ d5~48@) (Mul d5~48@ c5~46@)) (Add (Mul d5~48@ b5~44@) (Mul c5~46@ a5~42@))) (Mul (Add c5~46@ (Mul b5~44@ b5~44@)) (Add b5~44@ (Mul d5~48@ a5~42@)))) (Add (Mul (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ 39)) (Mul (Mul c5~46@ a5~42@) (Sub d5~48@ a5~42@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul 97 c5~46@)) (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ b5~44@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2787@ temp_5_1~3060@))) (=> (= temp_5_0~2787@ temp_5_1~3060@) (=> (= temp_6_0~3313@ (Mul (Mul (Add (Mul (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ c6~54@)) (Add (Mul a6~50@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Sub d6~56@ a6~50@) d6~56@))) (Mul (Mul (Mul (Mul b6~52@ 75) (Mul d6~56@ d6~56@)) (Add d6~56@ (Sub b6~52@ b6~52@))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ d6~56@))))) (Mul (Mul (Mul (Mul (Mul c6~54@ c6~54@) b6~52@) d6~56@) (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ c6~54@)))) (Mul (Sub (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ b6~52@)) a6~50@) (Mul (Mul (Add b6~52@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) d6~56@)))))) (=> (= temp_6_1~3542@ (Mul (Mul (Add (Mul (Mul (Mul c6~54@ b6~52@) (Mul d6~56@ c6~54@)) (Add (Mul a6~50@ a6~50@) (Mul c6~54@ a6~50@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Sub d6~56@ a6~50@) d6~56@))) (Mul (Mul (Mul (Mul b6~52@ 75) (Mul d6~56@ d6~56@)) (Add d6~56@ (Sub b6~52@ b6~52@))) (Mul (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ d6~56@))))) (Mul (Mul (Mul (Mul (Mul c6~54@ c6~54@) b6~52@) d6~56@) (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Sub d6~56@ c6~54@) (Mul d6~56@ c6~54@)))) (Mul (Sub (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ b6~52@)) a6~50@) (Mul (Mul (Add b6~52@ c6~54@) (Mul c6~54@ b6~52@)) (Mul (Mul c6~54@ d6~56@) d6~56@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~3313@ temp_6_1~3542@))) (=> (= temp_6_0~3313@ temp_6_1~3542@) (=> (= temp_7_0~3695@ (Mul (Mul (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Sub a7~58@ c7~62@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))) (Mul (Mul (Mul b7~60@ a7~58@) (Add c7~62@ d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul b7~60@ d7~64@)))) (Add (Mul (Sub (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Sub c7~62@ b7~60@))) (Mul (Mul b7~60@ (Mul a7~58@ a7~58@)) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@))))) c7~62@)) (=> (= temp_7_1~3832@ (Mul (Mul (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Sub a7~58@ c7~62@)) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ a7~58@))) (Mul (Add (Mul (Mul b7~60@ a7~58@) c7~62@) (Mul (Mul b7~60@ a7~58@) d7~64@)) (Mul (Mul a7~58@ b7~60@) (Mul b7~60@ d7~64@)))) (Add (Mul (Sub (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul b7~60@ d7~64@) (Sub c7~62@ b7~60@))) (Mul (Mul b7~60@ (Mul a7~58@ a7~58@)) (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@))))) c7~62@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3695@ temp_7_1~3832@))) (=> (= temp_7_0~3695@ temp_7_1~3832@) (=> (= temp_8_0~4109@ (Mul (Mul (Mul (Mul (Sub (Sub d8~72@ c8~70@) (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ d8~72@))) (Mul (Mul c8~70@ (Mul a8~66@ a8~66@)) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ d8~72@)))) (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@)) (Sub (Mul 76 c8~70@) (Mul b8~68@ a8~66@))) (Mul (Mul d8~72@ (Mul d8~72@ d8~72@)) (Add (Mul d8~72@ d8~72@) (Mul a8~66@ d8~72@))))) (Mul (Mul (Sub (Mul (Mul d8~72@ b8~68@) (Add c8~70@ a8~66@)) (Sub (Mul d8~72@ b8~68@) b8~68@)) (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ d8~72@)) (Mul (Mul c8~70@ c8~70@) a8~66@))) (Mul (Mul (Sub (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ c8~70@))))))) (=> (= temp_8_1~4362@ (Mul (Mul (Mul (Mul (Sub (Sub d8~72@ c8~70@) (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ d8~72@))) (Mul (Mul c8~70@ (Mul a8~66@ a8~66@)) (Mul (Mul a8~66@ d8~72@) (Mul a8~66@ d8~72@)))) (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@)) (Sub (Mul 76 c8~70@) (Mul b8~68@ a8~66@))) (Mul (Mul d8~72@ (Mul d8~72@ d8~72@)) (Add (Mul d8~72@ d8~72@) (Mul a8~66@ d8~72@))))) (Mul (Mul (Sub (Mul (Mul d8~72@ b8~68@) (Add c8~70@ a8~66@)) (Sub (Mul d8~72@ b8~68@) b8~68@)) (Mul (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ d8~72@)) (Mul (Mul c8~70@ c8~70@) a8~66@))) (Mul (Mul (Sub (Mul b8~68@ b8~68@) (Mul a8~66@ d8~72@)) (Mul (Mul b8~68@ b8~68@) (Mul a8~66@ b8~68@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ c8~70@))))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~4109@ temp_8_1~4362@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
