...
(declare-const temp_1_1~724@ Int)
(declare-const temp_2_0~985@ Int)
(declare-const temp_2_1~1222@ Int)
(declare-const temp_3_0~1431@ Int)
(declare-const temp_3_1~1616@ Int)
(declare-const temp_4_0~1961@ Int)
(declare-const temp_4_1~2282@ Int)
(declare-const temp_5_0~2463@ Int)
(declare-const temp_5_1~2620@ Int)
(declare-const temp_6_0~2849@ Int)
(declare-const temp_6_1~3054@ Int)
(declare-const temp_7_0~3263@ Int)
(declare-const temp_7_1~3448@ Int)
(declare-const temp_8_0~3681@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~197@ (Add (Add (Mul d0~8@ b0~4@) (Mul c0~6@ (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ a0~2@)) (Add (Mul b0~4@ a0~2@) (Add b0~4@ c0~6@))))) (Sub d0~8@ (Mul (Mul (Mul (Add a0~2@ c0~6@) (Mul a0~2@ d0~8@)) (Sub d0~8@ (Mul a0~2@ b0~4@))) (Mul (Mul (Mul 0 b0~4@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ a0~2@) c0~6@)))))) (=> (= temp_0_1~314@ (Add (Add (Mul d0~8@ b0~4@) (Mul c0~6@ (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ a0~2@)) (Add (Mul b0~4@ a0~2@) (Add b0~4@ c0~6@))))) (Sub d0~8@ (Mul (Mul (Add a0~2@ c0~6@) (Mul (Mul a0~2@ d0~8@) (Sub d0~8@ (Mul a0~2@ b0~4@)))) (Mul (Mul (Mul 0 b0~4@) (Mul b0~4@ c0~6@)) (Mul (Mul d0~8@ a0~2@) c0~6@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~197@ temp_0_1~314@))) (=> (= temp_0_0~197@ temp_0_1~314@) (=> (= temp_1_0~531@ (Mul (Mul (Sub (Mul (Mul c1~14@ (Add d1~16@ c1~14@)) d1~16@) (Mul (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Mul a1~10@ a1~10@) b1~12@))) (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@))) (Mul a1~10@ (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@))))) (Mul (Mul (Mul (Mul (Sub c1~14@ c1~14@) (Sub c1~14@ b1~12@)) (Add (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))) (Mul (Mul d1~16@ (Mul c1~14@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ c1~14@))) a1~10@)))) (=> (= temp_1_1~724@ (Mul (Mul (Sub (Mul (Mul c1~14@ (Add d1~16@ c1~14@)) d1~16@) (Mul (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Mul a1~10@ a1~10@) b1~12@))) (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ c1~14@))) (Mul a1~10@ (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@))))) (Mul (Mul (Mul (Mul (Sub c1~14@ c1~14@) (Sub c1~14@ b1~12@)) (Add (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@))) (Mul (Mul d1~16@ (Mul c1~14@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ c1~14@))) a1~10@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~531@ temp_1_1~724@))) (=> (= temp_1_0~531@ temp_1_1~724@) (=> (= temp_2_0~985@ (Mul (Mul (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@)) d2~24@) (Sub (Mul (Sub c2~22@ b2~20@) (Add d2~24@ a2~18@)) (Mul (Add d2~24@ c2~22@) (Mul d2~24@ b2~20@)))) (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ b2~20@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ a2~18@))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ 77))))) (Mul (Mul (Mul (Mul c2~22@ (Mul d2~24@ d2~24@)) (Sub (Mul d2~24@ d2~24@) (Add c2~22@ d2~24@))) (Mul (Mul a2~18@ (Sub c2~22@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ c2~22@)))) (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Sub a2~18@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ d2~24@)) c2~22@))))) (=> (= temp_2_1~1222@ (Mul (Mul (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@)) d2~24@) (Sub (Mul (Sub c2~22@ b2~20@) (Add d2~24@ a2~18@)) (Mul (Add d2~24@ c2~22@) (Mul d2~24@ b2~20@)))) (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Sub b2~20@ b2~20@)) (Mul d2~24@ (Mul b2~20@ (Mul d2~24@ a2~18@)))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ 77))))) (Mul (Mul (Mul (Mul c2~22@ (Mul d2~24@ d2~24@)) (Sub (Mul d2~24@ d2~24@) (Add c2~22@ d2~24@))) (Mul (Mul a2~18@ (Sub c2~22@ a2~18@)) (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ c2~22@)))) (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Sub a2~18@ a2~18@)) (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul a2~18@ d2~24@)) c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~985@ temp_2_1~1222@))) (=> (= temp_2_0~985@ temp_2_1~1222@) (=> (= temp_3_0~1431@ (Mul (Add (Add (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ d3~32@)) (Mul d3~32@ (Mul a3~26@ b3~28@))) (Mul (Sub (Mul a3~26@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ a3~26@) b3~28@))) a3~26@) (Mul (Sub (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ 60) (Mul a3~26@ d3~32@))) (Mul (Mul a3~26@ (Mul d3~32@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@)))) (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Add d3~32@ b3~28@)) c3~30@) (Mul 45 (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@))))))) (=> (= temp_3_1~1616@ (Mul (Add (Add (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ d3~32@)) (Mul d3~32@ (Mul a3~26@ b3~28@))) (Mul (Sub (Mul a3~26@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ a3~26@) b3~28@))) a3~26@) (Mul (Sub (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ 60) (Mul a3~26@ d3~32@))) (Mul (Mul a3~26@ (Mul d3~32@ d3~32@)) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@)))) (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Add d3~32@ b3~28@)) c3~30@) (Mul 45 (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ a3~26@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1431@ temp_3_1~1616@))) (=> (= temp_3_0~1431@ temp_3_1~1616@) (=> (= temp_4_0~1961@ (Sub (Add (Mul (Mul (Mul (Mul c4~38@ a4~34@) d4~40@) (Sub (Add a4~34@ a4~34@) (Add d4~40@ a4~34@))) (Mul (Mul (Add b4~36@ a4~34@) (Mul c4~38@ d4~40@)) (Add (Mul c4~38@ d4~40@) (Mul d4~40@ c4~38@)))) (Mul (Sub (Add c4~38@ (Mul 8 56)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ a4~34@))) (Sub (Mul (Mul a4~34@ b4~36@) (Sub b4~36@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ c4~38@))))) (Mul (Mul (Mul (Add (Mul b4~36@ a4~34@) (Mul d4~40@ 31)) (Mul (Mul c4~38@ b4~36@) (Sub c4~38@ b4~36@))) (Sub (Sub (Mul b4~36@ c4~38@) (Add d4~40@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Add a4~34@ b4~36@)))) (Sub (Mul (Mul (Mul d4~40@ c4~38@) (Mul 38 b4~36@)) (Mul (Mul b4~36@ d4~40@) (Sub d4~40@ b4~36@))) (Add (Mul (Mul b4~36@ a4~34@) (Mul 52 c4~38@)) (Mul (Sub 85 c4~38@) (Mul d4~40@ d4~40@))))))) (=> (= temp_4_1~2282@ (Sub (Add (Mul (Mul (Mul (Mul c4~38@ a4~34@) d4~40@) (Sub (Add a4~34@ a4~34@) (Add d4~40@ a4~34@))) (Mul (Mul (Add b4~36@ a4~34@) (Mul c4~38@ d4~40@)) (Add (Mul c4~38@ d4~40@) (Mul d4~40@ c4~38@)))) (Mul (Sub (Add c4~38@ (Mul 8 56)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ a4~34@))) (Sub (Mul (Mul a4~34@ b4~36@) (Sub b4~36@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ c4~38@))))) (Mul (Mul (Mul (Add (Mul b4~36@ a4~34@) (Mul d4~40@ 31)) (Mul (Mul c4~38@ b4~36@) (Sub c4~38@ b4~36@))) (Sub (Sub (Mul b4~36@ c4~38@) (Add d4~40@ d4~40@)) (Mul (Mul b4~36@ d4~40@) (Add a4~34@ b4~36@)))) (Sub (Mul (Mul (Mul d4~40@ c4~38@) (Mul 38 b4~36@)) (Mul (Mul b4~36@ d4~40@) (Sub d4~40@ b4~36@))) (Add (Mul (Mul b4~36@ a4~34@) (Mul 52 c4~38@)) (Mul (Sub 85 c4~38@) (Mul d4~40@ d4~40@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~1961@ temp_4_1~2282@))) (=> (= temp_4_0~1961@ temp_4_1~2282@) (=> (= temp_5_0~2463@ (Sub (Sub (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ d5~48@)) (Mul (Mul c5~46@ b5~44@) c5~46@)) d5~48@) (Mul (Mul b5~44@ (Add a5~42@ b5~44@)) b5~44@)) (Sub (Mul (Mul (Add d5~48@ (Mul c5~46@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ b5~44@))) (Mul d5~48@ (Mul (Sub c5~46@ c5~46@) (Mul d5~48@ a5~42@)))) (Mul (Mul (Mul (Sub c5~46@ c5~46@) (Mul c5~46@ b5~44@)) (Add (Mul a5~42@ b5~44@) (Sub b5~44@ c5~46@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Sub c5~46@ d5~48@) a5~42@)))))) (=> (= temp_5_1~2620@ (Sub (Sub (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ d5~48@)) (Mul (Mul c5~46@ b5~44@) c5~46@)) d5~48@) (Mul (Mul b5~44@ (Add a5~42@ b5~44@)) b5~44@)) (Sub (Mul (Mul d5~48@ (Mul (Sub c5~46@ c5~46@) (Mul d5~48@ a5~42@))) (Mul (Add d5~48@ (Mul c5~46@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ b5~44@)))) (Mul (Mul (Mul (Sub c5~46@ c5~46@) (Mul c5~46@ b5~44@)) (Add (Mul a5~42@ b5~44@) (Sub b5~44@ c5~46@))) (Mul (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Sub c5~46@ d5~48@) a5~42@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2463@ temp_5_1~2620@))) (=> (= temp_5_0~2463@ temp_5_1~2620@) (=> (= temp_6_0~2849@ (Sub (Sub (Mul (Mul b6~52@ (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul a6~50@ a6~50@) (Sub a6~50@ a6~50@)) (Mul (Mul c6~54@ c6~54@) (Add a6~50@ c6~54@)))) (Mul (Sub a6~50@ (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul a6~50@ 58) (Mul a6~50@ c6~54@)) (Add (Mul c6~54@ a6~50@) (Mul d6~56@ b6~52@))))) (Mul (Add (Add (Add (Mul b6~52@ b6~52@) (Mul b6~52@ c6~54@)) (Mul a6~50@ (Mul b6~52@ c6~54@))) (Mul (Mul (Sub a6~50@ a6~50@) (Sub c6~54@ c6~54@)) (Mul (Sub b6~52@ a6~50@) c6~54@))) (Mul d6~56@ (Mul (Mul (Add b6~52@ d6~56@) b6~52@) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ b6~52@))))))) (=> (= temp_6_1~3054@ (Sub (Sub (Mul (Mul b6~52@ (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul a6~50@ a6~50@) (Sub a6~50@ a6~50@)) (Mul (Mul c6~54@ c6~54@) (Add a6~50@ c6~54@)))) (Mul (Sub a6~50@ (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul a6~50@ 58) (Mul a6~50@ c6~54@)) (Add (Mul c6~54@ a6~50@) (Mul d6~56@ b6~52@))))) (Mul (Add (Add (Add (Mul b6~52@ b6~52@) (Mul b6~52@ c6~54@)) (Mul a6~50@ (Mul b6~52@ c6~54@))) (Mul (Mul (Sub a6~50@ a6~50@) (Sub c6~54@ c6~54@)) (Mul (Sub b6~52@ a6~50@) c6~54@))) (Mul d6~56@ (Mul (Mul (Add b6~52@ d6~56@) b6~52@) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ c6~54@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~2849@ temp_6_1~3054@))) (=> (= temp_6_0~2849@ temp_6_1~3054@) (=> (= temp_7_0~3263@ (Mul (Mul (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul d7~64@ c7~62@) c7~62@)) (Mul (Mul a7~58@ (Mul b7~60@ a7~58@)) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@)))) a7~58@) (Mul (Sub (Sub (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Sub a7~58@ 43))) (Mul (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ d7~64@) a7~58@))) (Sub (Mul (Sub (Mul d7~64@ d7~64@) (Mul c7~62@ c7~62@)) (Sub (Mul a7~58@ a7~58@) (Mul c7~62@ d7~64@))) (Sub (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ c7~62@)) c7~62@))))) (=> (= temp_7_1~3448@ (Mul (Mul (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul d7~64@ c7~62@) c7~62@)) (Mul (Mul (Mul b7~60@ a7~58@) a7~58@) (Mul (Mul a7~58@ b7~60@) (Mul d7~64@ a7~58@)))) a7~58@) (Mul (Sub (Sub (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Sub a7~58@ 43))) (Mul (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ d7~64@) a7~58@))) (Sub (Mul (Sub (Mul d7~64@ d7~64@) (Mul c7~62@ c7~62@)) (Sub (Mul a7~58@ a7~58@) (Mul c7~62@ d7~64@))) (Sub (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ c7~62@)) c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3263@ temp_7_1~3448@))) (=> (= temp_7_0~3263@ temp_7_1~3448@) (=> (= temp_8_0~3681@ (Add (Mul (Sub (Mul (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Add b8~68@ c8~70@))) (Mul (Mul a8~66@ (Add c8~70@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ b8~68@)))) (Mul (Mul (Mul (Sub c8~70@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ d8~72@) d8~72@)) (Mul (Mul (Add b8~68@ d8~72@) (Mul a8~66@ d8~72@)) (Add (Sub c8~70@ d8~72@) c8~70@)))) (Mul (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Sub a8~66@ d8~72@))) (Mul (Sub (Mul b8~68@ a8~66@) (Add c8~70@ a8~66@)) (Mul (Mul c8~70@ d8~72@) b8~68@))) (Mul b8~68@ (Mul (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ d8~72@) c8~70@)))))) (=> (= temp_8_1~3890@ (Add (Mul (Sub (Mul (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Add b8~68@ c8~70@))) (Mul (Mul a8~66@ (Add c8~70@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul c8~70@ b8~68@)))) (Mul (Mul (Mul (Sub c8~70@ a8~66@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ b8~68@) d8~72@)) (Mul (Mul (Add b8~68@ d8~72@) (Mul a8~66@ d8~72@)) (Add (Sub c8~70@ d8~72@) c8~70@)))) (Mul (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ d8~72@) (Sub a8~66@ d8~72@))) (Mul (Sub (Mul b8~68@ a8~66@) (Add c8~70@ a8~66@)) (Mul (Mul c8~70@ d8~72@) b8~68@))) (Mul b8~68@ (Mul (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul d8~72@ d8~72@) c8~70@)))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~3681@ temp_8_1~3890@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
