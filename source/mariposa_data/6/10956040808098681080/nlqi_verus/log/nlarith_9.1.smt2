...
(declare-const temp_1_0~522@ Int)
(declare-const temp_1_1~715@ Int)
(declare-const temp_2_0~967@ Int)
(declare-const temp_2_1~1204@ Int)
(declare-const temp_3_0~1404@ Int)
(declare-const temp_3_1~1589@ Int)
(declare-const temp_4_0~1925@ Int)
(declare-const temp_4_1~2246@ Int)
(declare-const temp_5_0~2418@ Int)
(declare-const temp_5_1~2575@ Int)
(declare-const temp_6_0~2795@ Int)
(declare-const temp_6_1~3000@ Int)
(declare-const temp_7_0~3200@ Int)
(declare-const temp_7_1~3385@ Int)
(declare-const temp_8_0~3609@ Int)
(declare-const temp_8_1~3818@ Int)
