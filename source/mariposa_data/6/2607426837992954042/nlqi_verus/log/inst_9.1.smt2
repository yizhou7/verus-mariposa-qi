...
(set-info :comment ";; mariposa_data/6//2607426837992954042/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~797@ Int)
(declare-const temp_1_1~1006@ Int)
(declare-const temp_2_0~1331@ Int)
(declare-const temp_2_1~1588@ Int)
(declare-const temp_3_0~1845@ Int)
(declare-const temp_3_1~2074@ Int)
(declare-const temp_4_0~2307@ Int)
(declare-const temp_4_1~2544@ Int)
(declare-const temp_5_0~2891@ Int)
(declare-const temp_5_1~3156@ Int)
(declare-const temp_6_0~3429@ Int)
(declare-const temp_6_1~3674@ Int)
(declare-const temp_7_0~3919@ Int)
(declare-const temp_7_1~4148@ Int)
(declare-const temp_8_0~4359@ Int)
(declare-const temp_8_1~4520@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Mul (Mul (Mul 69 (Mul (Add d0~8@ c0~6@) (Mul a0~2@ b0~4@))) (Sub (Add (Add c0~6@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Add b0~4@ c0~6@) (Mul b0~4@ a0~2@)))) (Mul (Mul a0~2@ (Sub (Mul c0~6@ d0~8@) (Sub b0~4@ d0~8@))) 41)) (Mul (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@)) (Sub (Mul c0~6@ b0~4@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@)) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul b0~4@ (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ c0~6@))))))) (=> (= temp_0_1~514@ (Mul (Mul (Mul (Mul 69 (Mul (Add d0~8@ c0~6@) (Mul a0~2@ b0~4@))) (Sub (Add (Add c0~6@ b0~4@) (Mul b0~4@ c0~6@)) (Mul (Add b0~4@ c0~6@) (Mul b0~4@ a0~2@)))) (Mul (Mul a0~2@ (Sub (Mul c0~6@ d0~8@) (Sub b0~4@ d0~8@))) 41)) (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Sub (Mul c0~6@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@)) (Mul c0~6@ c0~6@)))) (Mul (Mul (Mul b0~4@ (Mul b0~4@ d0~8@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@)) (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ c0~6@))))))) (and (=> (= tmp%1@ (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@))) (=> (= tmp%2@ (Sub (Mul c0~6@ b0~4@) (Mul c0~6@ c0~6@))) (=> (= tmp%3@ (Mul (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ c0~6@)) (Mul c0~6@ c0~6@))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~514@)))))) (=> (= temp_0_0~297@ temp_0_1~514@) (=> (= temp_1_0~797@ (Mul (Mul (Mul (Mul b1~12@ (Mul (Add a1~10@ b1~12@) c1~14@)) (Mul a1~10@ (Mul (Mul 59 d1~16@) (Mul d1~16@ b1~12@)))) (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ 18)) (Mul (Sub b1~12@ c1~14@) b1~12@)) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Sub d1~16@ b1~12@) (Mul c1~14@ c1~14@))))) (Mul (Mul (Mul (Mul (Add b1~12@ c1~14@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@))) (Mul a1~10@ (Sub (Mul c1~14@ b1~12@) (Add a1~10@ d1~16@)))) (Mul c1~14@ (Mul (Add (Mul d1~16@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ c1~14@))))))) (=> (= temp_1_1~1006@ (Mul (Mul (Mul (Mul a1~10@ (Mul (Mul 59 d1~16@) (Mul d1~16@ b1~12@))) (Mul b1~12@ (Mul (Add a1~10@ b1~12@) c1~14@))) (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ 18)) (Mul (Sub b1~12@ c1~14@) b1~12@)) (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ a1~10@)) (Mul (Sub d1~16@ b1~12@) (Mul c1~14@ c1~14@))))) (Mul (Mul (Mul (Mul (Add b1~12@ c1~14@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@))) (Mul a1~10@ (Sub (Mul c1~14@ b1~12@) (Add a1~10@ d1~16@)))) (Mul c1~14@ (Mul (Add (Mul d1~16@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ c1~14@))))))) (and (=> (= tmp%4@ (Mul b1~12@ (Mul (Add a1~10@ b1~12@) c1~14@))) (=> (= tmp%5@ (Mul a1~10@ (Mul (Mul 59 d1~16@) (Mul d1~16@ b1~12@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%1 (= temp_1_0~797@ temp_1_1~1006@))))) (=> (= temp_1_0~797@ temp_1_1~1006@) (=> (= temp_2_0~1331@ (Mul (Mul (Add (Mul (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Sub (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Mul 93 c2~22@) (Mul b2~20@ d2~24@)))) (Mul (Mul (Mul (Sub a2~18@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Add b2~20@ b2~20@) (Mul c2~22@ a2~18@))) (Mul (Mul b2~20@ (Mul b2~20@ c2~22@)) (Add a2~18@ (Mul d2~24@ d2~24@))))) (Mul (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul (Sub d2~24@ d2~24@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ b2~20@)))) (Add (Mul (Mul (Add b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ b2~20@))) (Mul (Sub (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Mul a2~18@ (Mul a2~18@ c2~22@))))))) (=> (= temp_2_1~1588@ (Mul (Mul (Add (Mul (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ c2~22@))) (Sub (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ d2~24@)) (Mul (Mul 93 c2~22@) (Mul b2~20@ d2~24@)))) (Mul (Mul (Mul (Sub a2~18@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Add b2~20@ b2~20@) (Mul c2~22@ a2~18@))) (Mul (Mul b2~20@ (Mul b2~20@ c2~22@)) (Add a2~18@ (Mul d2~24@ d2~24@))))) (Mul (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ a2~18@) (Mul d2~24@ a2~18@))) (Mul (Mul (Sub d2~24@ d2~24@) (Mul c2~22@ c2~22@)) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ b2~20@)))) (Add (Mul (Mul (Add b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ b2~20@))) (Mul (Sub (Mul b2~20@ a2~18@) (Mul a2~18@ b2~20@)) (Mul a2~18@ (Mul a2~18@ c2~22@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c2~22@ c2~22@) (=> %%location_label%%2 (= temp_2_0~1331@ temp_2_1~1588@))) (=> (= temp_2_0~1331@ temp_2_1~1588@) (=> (= temp_3_0~1845@ (Mul (Mul (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Sub c3~30@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ c3~30@))) (Mul a3~26@ (Add (Mul c3~30@ a3~26@) (Mul d3~32@ b3~28@)))) (Sub (Mul (Mul (Sub b3~28@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@))))) (Add (Mul (Mul (Sub (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@))) (Mul (Sub c3~30@ (Mul d3~32@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ d3~32@)))) (Mul (Mul (Add (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ a3~26@)) d3~32@))))) (=> (= temp_3_1~2074@ (Mul (Mul (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Sub c3~30@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ c3~30@))) (Mul a3~26@ (Add (Mul c3~30@ a3~26@) (Mul d3~32@ b3~28@)))) (Sub (Mul (Mul (Sub b3~28@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@))))) (Add (Mul (Mul (Sub (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ d3~32@))) (Mul (Sub c3~30@ (Mul d3~32@ a3~26@)) (Mul (Mul a3~26@ b3~28@) (Mul c3~30@ d3~32@)))) (Mul (Mul (Add (Mul d3~32@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul b3~28@ a3~26@)) d3~32@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ c3~30@) (=> %%location_label%%3 (= temp_3_0~1845@ temp_3_1~2074@))) (=> (= temp_3_0~1845@ temp_3_1~2074@) (=> (= temp_4_0~2307@ (Mul (Sub (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Sub a4~34@ b4~36@)) (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@))) (Add (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)))) (Mul (Mul (Mul (Mul b4~36@ c4~38@) b4~36@) (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ b4~36@))) (Mul (Mul (Sub a4~34@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Add d4~40@ a4~34@) (Mul a4~34@ 56))))) (Mul c4~38@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@))) (Add d4~40@ (Mul (Add c4~38@ b4~36@) (Mul a4~34@ 87))))))) (=> (= temp_4_1~2544@ (Mul (Sub (Add (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Sub a4~34@ b4~36@)) (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@))) (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Sub a4~34@ b4~36@)) (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@))) (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@)))) (Mul (Mul (Mul (Mul b4~36@ c4~38@) b4~36@) (Mul (Mul d4~40@ b4~36@) (Mul c4~38@ b4~36@))) (Mul (Mul (Sub a4~34@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Add d4~40@ a4~34@) (Mul a4~34@ 56))))) (Mul c4~38@ (Mul (Mul (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ c4~38@))) (Add d4~40@ (Mul (Add c4~38@ b4~36@) (Mul a4~34@ 87))))))) (and (=> (= tmp%6@ (Mul (Mul (Mul c4~38@ b4~36@) (Sub a4~34@ b4~36@)) (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ d4~40@)))) (=> (= tmp%7@ (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ b4~36@))) (=> (= tmp%8@ (Mul (Mul d4~40@ a4~34@) (Mul a4~34@ b4~36@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%6@ tmp%7@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~2307@ temp_4_1~2544@)))))) (=> (= temp_4_0~2307@ temp_4_1~2544@) (=> (= temp_5_0~2891@ (Mul (Mul (Add (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ b5~44@))) (Mul (Sub (Mul a5~42@ a5~42@) (Mul d5~48@ d5~48@)) (Mul a5~42@ (Sub 18 c5~46@)))) (Mul (Mul (Add (Add a5~42@ c5~46@) b5~44@) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ a5~42@))) (Sub (Mul (Mul d5~48@ c5~46@) (Add b5~44@ c5~46@)) (Add (Mul c5~46@ a5~42@) c5~46@)))) (Add (Mul (Mul (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ b5~44@))) (Sub (Sub (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ 55)))) (Mul (Mul (Mul a5~42@ (Mul 35 c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@))) (Add (Mul (Mul d5~48@ b5~44@) (Sub c5~46@ a5~42@)) b5~44@))))) (=> (= temp_5_1~3156@ (Mul (Mul (Add (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Mul c5~46@ d5~48@) (Mul a5~42@ b5~44@))) (Mul (Sub (Mul a5~42@ a5~42@) (Mul d5~48@ d5~48@)) (Mul a5~42@ (Sub 18 c5~46@)))) (Mul (Mul (Add (Add a5~42@ c5~46@) b5~44@) (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ a5~42@))) (Sub (Mul (Mul d5~48@ c5~46@) (Add b5~44@ c5~46@)) (Add (Mul c5~46@ a5~42@) c5~46@)))) (Add (Mul (Mul (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@)) (Mul (Mul d5~48@ d5~48@) (Mul d5~48@ b5~44@))) (Sub (Sub (Mul a5~42@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ 55)))) (Mul (Mul (Mul a5~42@ (Mul 35 c5~46@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@))) (Add (Mul (Mul d5~48@ b5~44@) (Sub c5~46@ a5~42@)) b5~44@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c5~46@ c5~46@) (=> %%location_label%%5 (= temp_5_0~2891@ temp_5_1~3156@))) (=> (= temp_5_0~2891@ temp_5_1~3156@) (=> (= temp_6_0~3429@ (Mul (Mul (Sub (Mul (Add (Mul c6~54@ a6~50@) d6~56@) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ c6~54@)) (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ b6~52@)))) (Mul (Add (Mul (Mul a6~50@ d6~56@) a6~50@) (Mul (Mul 48 c6~54@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@)) (Mul b6~52@ (Mul a6~50@ a6~50@))))) (Mul (Mul (Add (Add (Add b6~52@ c6~54@) a6~50@) (Mul (Sub d6~56@ a6~50@) (Mul c6~54@ c6~54@))) (Mul (Sub b6~52@ (Mul c6~54@ a6~50@)) (Mul (Add a6~50@ d6~56@) (Mul b6~52@ c6~54@)))) (Sub (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ b6~52@))) (Sub (Mul (Add c6~54@ a6~50@) (Mul b6~52@ a6~50@)) (Add (Mul c6~54@ b6~52@) a6~50@)))))) (=> (= temp_6_1~3674@ (Mul (Mul (Sub (Mul (Add (Mul a6~50@ c6~54@) d6~56@) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ c6~54@)) (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ b6~52@)))) (Mul (Add (Mul (Mul a6~50@ d6~56@) a6~50@) (Mul (Mul 48 c6~54@) (Mul c6~54@ c6~54@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ d6~56@)) (Mul b6~52@ (Mul a6~50@ a6~50@))))) (Mul (Mul (Add (Add (Add b6~52@ c6~54@) a6~50@) (Mul (Sub d6~56@ a6~50@) (Mul c6~54@ c6~54@))) (Mul (Sub b6~52@ (Mul c6~54@ a6~50@)) (Mul (Add a6~50@ d6~56@) (Mul b6~52@ c6~54@)))) (Sub (Mul (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ c6~54@) (Mul b6~52@ b6~52@))) (Sub (Mul (Add c6~54@ a6~50@) (Mul b6~52@ a6~50@)) (Add (Mul c6~54@ b6~52@) a6~50@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c6~54@ a6~50@) (=> %%location_label%%6 (= temp_6_0~3429@ temp_6_1~3674@))) (=> (= temp_6_0~3429@ temp_6_1~3674@) (=> (= temp_7_0~3919@ (Add (Mul (Mul (Mul d7~64@ (Mul c7~62@ a7~58@)) (Sub d7~64@ (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ d7~64@)))) (Mul a7~58@ (Mul (Sub (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@)) (Mul (Sub d7~64@ b7~60@) (Mul c7~62@ c7~62@))))) (Mul (Mul (Add (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ b7~60@) b7~60@)) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ a7~58@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ c7~62@)))) (Mul (Sub (Add (Mul a7~58@ 28) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@))) (Mul (Sub (Mul a7~58@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ b7~60@) (Mul 51 c7~62@))))))) (=> (= temp_7_1~4148@ (Add (Mul (Sub (Mul (Mul d7~64@ (Mul c7~62@ a7~58@)) d7~64@) (Mul (Mul d7~64@ (Mul c7~62@ a7~58@)) (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ d7~64@)))) (Mul a7~58@ (Mul (Sub (Mul a7~58@ a7~58@) (Mul b7~60@ d7~64@)) (Mul (Sub d7~64@ b7~60@) (Mul c7~62@ c7~62@))))) (Mul (Mul (Add (Mul (Mul d7~64@ c7~62@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ b7~60@) b7~60@)) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ a7~58@)) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ c7~62@)))) (Mul (Sub (Add (Mul a7~58@ 28) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@))) (Mul (Sub (Mul a7~58@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Mul a7~58@ b7~60@) (Mul 51 c7~62@))))))) (and (=> (= tmp%9@ (Mul d7~64@ (Mul c7~62@ a7~58@))) (=> (= tmp%10@ (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ d7~64@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ d7~64@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~3919@ temp_7_1~4148@))))) (=> (= temp_7_0~3919@ temp_7_1~4148@) (=> (= temp_8_0~4359@ (Mul (Mul (Mul d8~72@ (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ b8~68@)))) (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ a8~66@)) b8~68@) (Mul (Mul (Mul a8~66@ b8~68@) b8~68@) (Add a8~66@ (Mul d8~72@ a8~66@))))) (Sub (Sub (Sub (Mul (Mul b8~68@ b8~68@) c8~70@) (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul b8~68@ c8~70@) b8~68@) (Mul c8~70@ a8~66@))) (Mul b8~68@ (Mul (Add (Mul a8~66@ c8~70@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ a8~66@) b8~68@)))))) (=> (= temp_8_1~4520@ (Mul (Mul d8~72@ (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ b8~68@)))) (Mul (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ a8~66@)) b8~68@) (Mul (Mul (Mul a8~66@ b8~68@) b8~68@) (Add a8~66@ (Mul d8~72@ a8~66@)))) (Sub (Sub (Sub (Mul (Mul b8~68@ b8~68@) c8~70@) (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul b8~68@ c8~70@) b8~68@) (Mul c8~70@ a8~66@))) (Mul b8~68@ (Mul (Add (Mul a8~66@ c8~70@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ a8~66@) b8~68@))))))) (=> (= tmp%11@ (Mul d8~72@ (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ b8~68@))))) (=> (= tmp%12@ (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ a8~66@)) b8~68@) (Mul (Mul (Mul a8~66@ b8~68@) b8~68@) (Add a8~66@ (Mul d8~72@ a8~66@))))) (=> (= tmp%13@ (Sub (Sub (Sub (Mul (Mul b8~68@ b8~68@) c8~70@) (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul b8~68@ c8~70@) b8~68@) (Mul c8~70@ a8~66@))) (Mul b8~68@ (Mul (Add (Mul a8~66@ c8~70@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ a8~66@) b8~68@))))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%11@ tmp%12@ tmp%13@) (=> %%location_label%%8 (= temp_8_0~4359@ temp_8_1~4520@)))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
