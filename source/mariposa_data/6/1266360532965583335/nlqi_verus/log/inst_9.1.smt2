...
(set-info :comment ";; mariposa_data/6//1266360532965583335/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~853@ Int)
(declare-const temp_1_1~1102@ Int)
(declare-const temp_2_0~1429@ Int)
(declare-const temp_2_1~1718@ Int)
(declare-const temp_3_0~1925@ Int)
(declare-const temp_3_1~2106@ Int)
(declare-const temp_4_0~2349@ Int)
(declare-const temp_4_1~2558@ Int)
(declare-const temp_5_0~2819@ Int)
(declare-const temp_5_1~3052@ Int)
(declare-const temp_6_0~3309@ Int)
(declare-const temp_6_1~3538@ Int)
(declare-const temp_7_0~3737@ Int)
(declare-const temp_7_1~3886@ Int)
(declare-const temp_8_0~4111@ Int)
(declare-const temp_8_1~4380@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Mul (Mul (Mul (Mul (Mul 74 c0~6@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ b0~4@) a0~2@)) (Sub (Add (Sub a0~2@ c0~6@) (Add d0~8@ c0~6@)) (Mul c0~6@ (Add a0~2@ 6)))) (Mul (Mul (Sub (Mul c0~6@ d0~8@) b0~4@) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul c0~6@ b0~4@) a0~2@) (Sub (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@))))) (Mul (Sub (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ a0~2@))) (Mul (Sub (Mul c0~6@ b0~4@) a0~2@) (Sub d0~8@ (Sub a0~2@ d0~8@)))) (Mul (Mul (Mul (Add c0~6@ d0~8@) (Mul a0~2@ b0~4@)) d0~8@) (Mul (Mul (Mul a0~2@ d0~8@) (Sub c0~6@ d0~8@)) b0~4@))))) (=> (= temp_0_1~562@ (Mul (Mul (Mul (Mul (Mul (Mul 74 c0~6@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ b0~4@) a0~2@)) (Sub (Add (Sub a0~2@ c0~6@) (Add d0~8@ c0~6@)) (Mul c0~6@ (Add a0~2@ 6)))) (Mul (Sub (Mul (Mul c0~6@ d0~8@) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))) (Mul b0~4@ (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@)))) (Mul (Mul (Mul c0~6@ b0~4@) a0~2@) (Sub (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@))))) (Mul (Sub (Mul (Mul (Mul a0~2@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ a0~2@))) (Mul (Sub (Mul c0~6@ b0~4@) a0~2@) (Sub d0~8@ (Sub a0~2@ d0~8@)))) (Mul (Mul (Mul (Add c0~6@ d0~8@) (Mul a0~2@ b0~4@)) d0~8@) (Mul (Mul (Mul a0~2@ d0~8@) (Sub c0~6@ d0~8@)) b0~4@))))) (and (=> (= tmp%1@ (Mul c0~6@ d0~8@)) (=> (= tmp%2@ (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ c0~6@))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ b0~4@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~562@))))) (=> (= temp_0_0~313@ temp_0_1~562@) (=> (= temp_1_0~853@ (Mul (Sub (Mul (Mul (Sub (Mul d1~16@ b1~12@) (Mul c1~14@ a1~10@)) (Mul b1~12@ (Add d1~16@ b1~12@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ b1~12@)))) (Mul (Mul (Mul (Sub b1~12@ d1~16@) c1~14@) (Mul (Mul c1~14@ d1~16@) 51)) (Mul (Mul (Mul c1~14@ c1~14@) c1~14@) (Mul (Mul d1~16@ d1~16@) d1~16@)))) (Add (Add (Mul (Add (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ d1~16@))) (Sub (Mul (Mul d1~16@ 13) (Mul a1~10@ a1~10@)) (Mul d1~16@ (Mul b1~12@ c1~14@)))) (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul b1~12@ b1~12@) (Add d1~16@ c1~14@))) (Mul (Sub (Mul d1~16@ d1~16@) (Mul c1~14@ b1~12@)) d1~16@))))) (=> (= temp_1_1~1102@ (Mul (Sub (Mul (Mul (Sub (Mul d1~16@ b1~12@) (Mul c1~14@ a1~10@)) (Mul b1~12@ (Add d1~16@ b1~12@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ b1~12@)))) (Mul (Mul (Mul (Sub b1~12@ d1~16@) c1~14@) (Mul (Mul c1~14@ d1~16@) 51)) (Mul (Mul (Mul c1~14@ c1~14@) c1~14@) (Mul (Mul d1~16@ d1~16@) d1~16@)))) (Add (Add (Mul (Add (Mul a1~10@ d1~16@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ d1~16@))) (Sub (Mul (Mul d1~16@ 13) (Mul a1~10@ a1~10@)) (Mul d1~16@ (Mul b1~12@ c1~14@)))) (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ b1~12@)) (Mul (Mul b1~12@ b1~12@) (Add d1~16@ c1~14@))) (Sub (Mul (Mul d1~16@ d1~16@) d1~16@) (Mul (Mul c1~14@ b1~12@) d1~16@)))))) (and (=> (= tmp%3@ (Mul d1~16@ d1~16@)) (=> (= tmp%4@ (Mul c1~14@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ tmp%4@ d1~16@) (=> %%location_label%%1 (= temp_1_0~853@ temp_1_1~1102@))))) (=> (= temp_1_0~853@ temp_1_1~1102@) (=> (= temp_2_0~1429@ (Mul (Sub (Mul (Mul (Sub (Mul b2~20@ b2~20@) (Sub d2~24@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Add a2~18@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ a2~18@)) (Add (Mul c2~22@ a2~18@) (Mul 60 a2~18@)))) (Mul (Mul (Add (Mul a2~18@ 64) (Add b2~20@ b2~20@)) (Mul (Add b2~20@ b2~20@) (Mul d2~24@ c2~22@))) (Mul (Mul (Sub b2~20@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Sub c2~22@ c2~22@) (Mul c2~22@ b2~20@))))) (Mul (Mul (Mul (Mul (Add b2~20@ d2~24@) (Add c2~22@ a2~18@)) (Add (Sub d2~24@ a2~18@) (Add d2~24@ b2~20@))) (Sub (Mul (Mul a2~18@ c2~22@) (Add b2~20@ a2~18@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ d2~24@)))) (Mul (Mul (Mul (Add c2~22@ b2~20@) (Mul d2~24@ 80)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ b2~20@)) (Add c2~22@ (Mul b2~20@ d2~24@))))))) (=> (= temp_2_1~1718@ (Mul (Sub (Mul (Mul (Sub (Mul b2~20@ b2~20@) (Sub d2~24@ c2~22@)) (Mul (Mul d2~24@ d2~24@) (Add a2~18@ b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ a2~18@)) (Add (Mul c2~22@ a2~18@) (Mul 60 a2~18@)))) (Mul (Mul (Add (Mul a2~18@ 64) (Add b2~20@ b2~20@)) (Mul (Add b2~20@ b2~20@) (Mul d2~24@ c2~22@))) (Mul (Mul (Sub b2~20@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Sub c2~22@ c2~22@) (Mul c2~22@ b2~20@))))) (Mul (Mul (Mul (Mul (Add b2~20@ d2~24@) (Add c2~22@ a2~18@)) (Add (Sub d2~24@ a2~18@) (Add d2~24@ b2~20@))) (Sub (Mul (Mul a2~18@ c2~22@) (Add b2~20@ a2~18@)) (Mul a2~18@ (Mul b2~20@ (Mul a2~18@ d2~24@))))) (Mul (Mul (Mul (Add c2~22@ b2~20@) (Mul d2~24@ 80)) (Mul (Mul a2~18@ d2~24@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ b2~20@)) (Add c2~22@ (Mul b2~20@ d2~24@))))))) (and (=> (= tmp%5@ (Mul a2~18@ d2~24@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. a2~18@ b2~20@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~1429@ temp_2_1~1718@)))) (=> (= temp_2_0~1429@ temp_2_1~1718@) (=> (= temp_3_0~1925@ (Sub (Mul (Add (Sub (Mul (Mul d3~32@ a3~26@) b3~28@) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@))) (Mul c3~30@ (Mul (Mul d3~32@ d3~32@) (Sub a3~26@ c3~30@)))) c3~30@) (Mul (Mul (Sub (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul d3~32@ (Mul d3~32@ a3~26@)) (Mul a3~26@ (Sub c3~30@ d3~32@)))) (Mul (Mul (Mul (Sub c3~30@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@))) (Sub (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ d3~32@) (Add b3~28@ a3~26@))))))) (=> (= temp_3_1~2106@ (Sub (Mul (Add (Sub (Mul (Mul d3~32@ a3~26@) b3~28@) (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ c3~30@))) (Mul c3~30@ (Sub (Mul (Mul d3~32@ d3~32@) a3~26@) (Mul (Mul d3~32@ d3~32@) c3~30@)))) c3~30@) (Mul (Mul (Sub (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul d3~32@ (Mul d3~32@ a3~26@)) (Mul a3~26@ (Sub c3~30@ d3~32@)))) (Mul (Mul (Mul (Sub c3~30@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@))) (Sub (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ c3~30@)) (Add (Mul d3~32@ d3~32@) (Add b3~28@ a3~26@))))))) (and (=> (= tmp%6@ (Mul d3~32@ d3~32@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%6@ a3~26@ c3~30@) (=> %%location_label%%3 (= temp_3_0~1925@ temp_3_1~2106@)))) (=> (= temp_3_0~1925@ temp_3_1~2106@) (=> (= temp_4_0~2349@ (Mul (Sub (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ b4~36@))) (Mul (Mul (Sub b4~36@ d4~40@) (Mul b4~36@ d4~40@)) (Sub (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@)))) (Mul (Sub (Mul c4~38@ (Mul b4~36@ b4~36@)) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ a4~34@) d4~40@) (Mul (Sub d4~40@ b4~36@) (Mul a4~34@ a4~34@))))) (Sub (Mul (Sub c4~38@ (Mul (Sub d4~40@ d4~40@) (Mul d4~40@ c4~38@))) (Mul (Mul (Add d4~40@ a4~34@) (Mul b4~36@ b4~36@)) (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ a4~34@)))) (Mul c4~38@ (Mul (Sub (Mul a4~34@ a4~34@) (Mul a4~34@ a4~34@)) (Sub (Mul a4~34@ d4~40@) (Add a4~34@ a4~34@))))))) (=> (= temp_4_1~2558@ (Mul (Sub (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ d4~40@)) (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ b4~36@))) (Mul (Mul (Sub b4~36@ d4~40@) (Mul b4~36@ d4~40@)) (Sub (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@)))) (Mul (Sub (Mul c4~38@ (Mul b4~36@ b4~36@)) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul d4~40@ a4~34@) d4~40@) (Mul (Sub d4~40@ b4~36@) (Mul a4~34@ a4~34@))))) (Sub (Mul (Sub c4~38@ (Mul (Sub d4~40@ d4~40@) (Mul d4~40@ c4~38@))) (Mul (Mul (Add d4~40@ a4~34@) (Mul b4~36@ b4~36@)) (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ a4~34@)))) (Mul c4~38@ (Mul (Sub (Mul a4~34@ a4~34@) (Mul a4~34@ a4~34@)) (Sub (Mul a4~34@ d4~40@) (Add a4~34@ a4~34@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ a4~34@) (=> %%location_label%%4 (= temp_4_0~2349@ temp_4_1~2558@))) (=> (= temp_4_0~2349@ temp_4_1~2558@) (=> (= temp_5_0~2819@ (Sub (Mul (Mul (Sub (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@))) (Add (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@)) (Sub a5~42@ (Mul b5~44@ a5~42@)))) (Sub (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ 26)) (Mul b5~44@ (Mul b5~44@ c5~46@))) (Mul (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ b5~44@))))) (Mul (Mul (Sub (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ a5~42@)) (Mul (Sub a5~42@ d5~48@) (Mul c5~46@ d5~48@)))) (Sub (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ a5~42@)) (Sub (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@))) d5~48@)))) (=> (= temp_5_1~3052@ (Sub (Mul (Mul (Sub (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@)) (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@))) (Add (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ c5~46@)) (Sub a5~42@ (Mul b5~44@ a5~42@)))) (Sub (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ 26)) (Mul b5~44@ (Mul b5~44@ c5~46@))) (Mul (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ b5~44@))))) (Mul (Mul (Sub (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ a5~42@)) (Mul (Sub a5~42@ d5~48@) (Mul c5~46@ d5~48@)))) (Sub (Mul (Mul (Mul c5~46@ c5~46@) (Mul d5~48@ a5~42@)) (Sub (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@))) d5~48@)))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ b5~44@) (=> %%location_label%%5 (= temp_5_0~2819@ temp_5_1~3052@))) (=> (= temp_5_0~2819@ temp_5_1~3052@) (=> (= temp_6_0~3309@ (Sub (Mul (Mul (Mul d6~56@ (Mul (Mul 17 b6~52@) (Add a6~50@ b6~52@))) (Add (Add (Mul a6~50@ b6~52@) a6~50@) (Add (Mul 68 c6~54@) (Mul a6~50@ d6~56@)))) (Sub (Add (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Sub d6~56@ d6~56@))) (Sub (Mul (Add d6~56@ c6~54@) (Mul a6~50@ a6~50@)) b6~52@))) (Mul (Sub (Mul (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ b6~52@))) (Mul (Add (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@)))) (Mul (Sub (Mul (Mul c6~54@ c6~54@) (Sub a6~50@ b6~52@)) a6~50@) (Mul b6~52@ (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@))))))) (=> (= temp_6_1~3538@ (Sub (Mul (Mul (Mul (Mul d6~56@ (Mul 17 b6~52@)) (Add a6~50@ b6~52@)) (Add (Add (Mul a6~50@ b6~52@) a6~50@) (Add (Mul 68 c6~54@) (Mul a6~50@ d6~56@)))) (Sub (Add (Mul (Mul a6~50@ b6~52@) (Mul a6~50@ c6~54@)) (Mul (Mul c6~54@ c6~54@) (Sub d6~56@ d6~56@))) (Sub (Mul (Add d6~56@ c6~54@) (Mul a6~50@ a6~50@)) b6~52@))) (Mul (Sub (Mul (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ c6~54@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ b6~52@))) (Mul (Add (Mul c6~54@ b6~52@) (Mul a6~50@ a6~50@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@)))) (Mul (Sub (Mul (Mul c6~54@ c6~54@) (Sub a6~50@ b6~52@)) a6~50@) (Mul b6~52@ (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@))))))) (and (=> (= tmp%7@ (Mul 17 b6~52@)) (=> (= tmp%8@ (Add a6~50@ b6~52@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. d6~56@ tmp%7@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~3309@ temp_6_1~3538@))))) (=> (= temp_6_0~3309@ temp_6_1~3538@) (=> (= temp_7_0~3737@ (Mul (Mul (Sub (Mul (Mul b7~60@ b7~60@) (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ c7~62@))) (Mul (Mul (Add a7~58@ a7~58@) (Mul b7~60@ a7~58@)) c7~62@)) c7~62@) (Mul (Mul b7~60@ (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Add c7~62@ b7~60@) (Mul a7~58@ b7~60@)))) (Mul (Mul (Mul (Add b7~60@ a7~58@) (Mul b7~60@ a7~58@)) (Add (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ a7~58@)) (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ c7~62@))))))) (=> (= temp_7_1~3886@ (Mul (Mul (Sub (Mul (Mul b7~60@ b7~60@) (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ c7~62@))) (Mul (Mul (Add a7~58@ a7~58@) (Mul b7~60@ a7~58@)) c7~62@)) c7~62@) (Mul (Mul b7~60@ (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Add c7~62@ b7~60@) (Mul a7~58@ b7~60@)))) (Mul (Mul (Mul (Add b7~60@ a7~58@) (Mul b7~60@ a7~58@)) (Add (Mul a7~58@ c7~62@) (Mul c7~62@ d7~64@))) (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ a7~58@)) (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ c7~62@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b7~60@ b7~60@) (=> %%location_label%%7 (= temp_7_0~3737@ temp_7_1~3886@))) (=> (= temp_7_0~3737@ temp_7_1~3886@) (=> (= temp_8_0~4111@ (Sub (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ a8~66@)))) (Mul (Add (Add b8~68@ (Mul a8~66@ c8~70@)) (Sub (Sub b8~68@ d8~72@) (Mul a8~66@ a8~66@))) (Add (Mul (Mul c8~70@ a8~66@) (Mul a8~66@ d8~72@)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@))))) (Mul (Sub (Mul c8~70@ (Mul a8~66@ (Mul a8~66@ a8~66@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ d8~72@)) a8~66@)) (Mul (Mul (Mul (Sub a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Sub (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))) (Mul (Mul d8~72@ (Mul 96 c8~70@)) (Mul (Mul b8~68@ c8~70@) (Sub b8~68@ a8~66@))))))) (=> (= temp_8_1~4380@ (Sub (Mul (Mul (Mul d8~72@ c8~70@) (Mul d8~72@ (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ a8~66@)))) (Mul (Add (Add b8~68@ (Mul a8~66@ c8~70@)) (Sub (Sub b8~68@ d8~72@) (Mul a8~66@ a8~66@))) (Add (Mul (Mul c8~70@ a8~66@) (Mul a8~66@ d8~72@)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@))))) (Sub (Mul (Mul c8~70@ (Mul a8~66@ (Mul a8~66@ a8~66@))) (Mul (Mul (Mul (Sub a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Sub (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))) (Mul (Mul d8~72@ (Mul 96 c8~70@)) (Mul (Mul b8~68@ c8~70@) (Sub b8~68@ a8~66@))))) (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ d8~72@)) a8~66@) (Mul (Mul (Mul (Sub a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Sub (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))) (Mul (Mul d8~72@ (Mul 96 c8~70@)) (Mul (Mul b8~68@ c8~70@) (Sub b8~68@ a8~66@)))))))) (=> (= tmp%9@ (Mul c8~70@ (Mul a8~66@ (Mul a8~66@ a8~66@)))) (=> (= tmp%10@ (Mul (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ d8~72@)) a8~66@)) (=> (= tmp%11@ (Mul (Mul (Mul (Sub a8~66@ a8~66@) (Mul b8~68@ b8~68@)) (Sub (Mul a8~66@ b8~68@) (Mul a8~66@ c8~70@))) (Mul (Mul d8~72@ (Mul 96 c8~70@)) (Mul (Mul b8~68@ c8~70@) (Sub b8~68@ a8~66@))))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ tmp%10@ tmp%11@) (=> %%location_label%%8 (= temp_8_0~4111@ temp_8_1~4380@)))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
