...
(declare-const temp_1_0~827@ Int)
(declare-const temp_1_1~1056@ Int)
(declare-const temp_2_0~1313@ Int)
(declare-const temp_2_1~1554@ Int)
(declare-const temp_3_0~1813@ Int)
(declare-const temp_3_1~2026@ Int)
(declare-const temp_4_0~2303@ Int)
(declare-const temp_4_1~2544@ Int)
(declare-const temp_5_0~2815@ Int)
(declare-const temp_5_1~3052@ Int)
(declare-const temp_6_0~3293@ Int)
(declare-const temp_6_1~3506@ Int)
(declare-const temp_7_0~3731@ Int)
(declare-const temp_7_1~3904@ Int)
(declare-const temp_8_0~4101@ Int)
(declare-const temp_8_1~4266@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~309@ (Mul (Mul (Mul (Add (Sub (Mul a0~2@ c0~6@) d0~8@) (Sub (Mul d0~8@ b0~4@) (Mul a0~2@ c0~6@))) (Mul (Mul b0~4@ (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ c0~6@)))) (Mul (Mul (Mul d0~8@ (Mul b0~4@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul 88 c0~6@))) (Mul (Sub (Mul c0~6@ b0~4@) (Add a0~2@ c0~6@)) (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ b0~4@))))) (Mul (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ d0~8@)) (Mul b0~4@ (Mul d0~8@ b0~4@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ b0~4@)) (Sub (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@)))) (Mul (Mul (Add (Add d0~8@ c0~6@) (Add d0~8@ c0~6@)) d0~8@) (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@)) b0~4@))))) (=> (= temp_0_1~538@ (Mul (Mul (Mul (Add (Sub (Mul a0~2@ c0~6@) d0~8@) (Sub (Mul d0~8@ b0~4@) (Mul a0~2@ c0~6@))) (Mul (Mul b0~4@ (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ c0~6@)))) (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Mul 88 c0~6@)) (Mul d0~8@ (Mul b0~4@ b0~4@))) (Mul (Sub (Mul c0~6@ b0~4@) (Add a0~2@ c0~6@)) (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ b0~4@))))) (Mul (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ d0~8@)) (Mul b0~4@ (Mul d0~8@ b0~4@))) (Mul (Mul (Mul c0~6@ b0~4@) (Mul a0~2@ b0~4@)) (Sub (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@)))) (Mul (Mul (Add (Add d0~8@ c0~6@) (Add d0~8@ c0~6@)) d0~8@) (Mul (Mul (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@)) b0~4@))))) (and (=> (= tmp%1@ (Mul d0~8@ (Mul b0~4@ b0~4@))) (=> (= tmp%2@ (Mul (Mul d0~8@ b0~4@) (Mul 88 c0~6@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~309@ temp_0_1~538@))))) (=> (= temp_0_0~309@ temp_0_1~538@) (=> (= temp_1_0~827@ (Mul (Mul (Mul (Mul (Sub b1~12@ (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ d1~16@))) (Sub (Mul c1~14@ (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ c1~14@)))) (Mul (Mul (Add c1~14@ (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ a1~10@)) d1~16@))) (Add (Mul (Mul (Mul (Add d1~16@ b1~12@) (Sub b1~12@ a1~10@)) (Mul (Sub a1~10@ c1~14@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ d1~16@) a1~10@))) (Add (Mul (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Add d1~16@ a1~10@) (Add a1~10@ a1~10@))))))) (=> (= temp_1_1~1056@ (Mul (Mul (Mul (Mul (Sub b1~12@ (Mul d1~16@ c1~14@)) (Mul (Mul a1~10@ d1~16@) (Mul a1~10@ d1~16@))) (Sub (Mul c1~14@ (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ c1~14@)))) (Mul (Mul (Add c1~14@ (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ a1~10@)) d1~16@))) (Add (Mul (Mul (Mul (Add d1~16@ b1~12@) (Sub b1~12@ a1~10@)) (Mul (Sub a1~10@ c1~14@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul a1~10@ d1~16@) a1~10@))) (Add (Mul (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Add d1~16@ a1~10@) (Add a1~10@ a1~10@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ d1~16@) (=> %%location_label%%1 (= temp_1_0~827@ temp_1_1~1056@))) (=> (= temp_1_0~827@ temp_1_1~1056@) (=> (= temp_2_0~1313@ (Mul (Mul (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Sub d2~24@ b2~20@)) (Sub (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@))) (Add (Mul (Sub d2~24@ d2~24@) a2~18@) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@)))) (Mul (Mul (Mul (Mul d2~24@ a2~18@) c2~22@) (Add (Mul c2~22@ a2~18@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@)) (Mul (Mul b2~20@ 1) (Mul d2~24@ d2~24@))))) (Mul (Add (Mul d2~24@ (Mul (Add 91 d2~24@) (Mul a2~18@ c2~22@))) d2~24@) (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Add a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@))) (Mul (Mul (Add a2~18@ a2~18@) c2~22@) (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ c2~22@))))))) (=> (= temp_2_1~1554@ (Mul (Mul (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Sub d2~24@ b2~20@)) (Sub (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@))) (Add (Mul (Sub d2~24@ d2~24@) a2~18@) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@)))) (Mul (Add (Mul (Mul (Mul d2~24@ a2~18@) c2~22@) (Mul c2~22@ a2~18@)) (Mul (Mul (Mul d2~24@ a2~18@) c2~22@) (Mul b2~20@ a2~18@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@)) (Mul (Mul b2~20@ 1) (Mul d2~24@ d2~24@))))) (Mul (Add (Mul d2~24@ (Mul (Add 91 d2~24@) (Mul a2~18@ c2~22@))) d2~24@) (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Add a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ a2~18@))) (Mul (Mul (Add a2~18@ a2~18@) c2~22@) (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ c2~22@))))))) (and (=> (= tmp%3@ (Mul (Mul d2~24@ a2~18@) c2~22@)) (=> (= tmp%4@ (Mul c2~22@ a2~18@)) (=> (= tmp%5@ (Mul b2~20@ a2~18@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%3@ tmp%4@ tmp%5@) (=> %%location_label%%2 (= temp_2_0~1313@ temp_2_1~1554@)))))) (=> (= temp_2_0~1313@ temp_2_1~1554@) (=> (= temp_3_0~1813@ (Mul (Sub (Mul (Mul a3~26@ (Add b3~28@ (Sub d3~32@ c3~30@))) (Mul (Mul d3~32@ (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ d3~32@)))) (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Mul c3~30@ c3~30@) (Mul c3~30@ a3~26@))) (Mul d3~32@ (Mul b3~28@ (Mul a3~26@ a3~26@))))) (Add (Mul (Mul (Mul (Mul b3~28@ a3~26@) b3~28@) c3~30@) (Add (Mul b3~28@ (Mul b3~28@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@)))) (Add (Mul (Mul (Sub d3~32@ d3~32@) (Add 53 d3~32@)) (Mul (Mul b3~28@ c3~30@) (Sub c3~30@ b3~28@))) (Mul (Sub (Add a3~26@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Sub b3~28@ a3~26@))))))) (=> (= temp_3_1~2026@ (Mul (Sub (Mul (Mul a3~26@ (Add b3~28@ (Sub d3~32@ c3~30@))) (Mul (Mul d3~32@ (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ d3~32@)))) (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul d3~32@ b3~28@)) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@))) (Mul d3~32@ (Mul b3~28@ (Mul a3~26@ a3~26@))))) (Add (Mul (Mul (Mul (Mul b3~28@ a3~26@) b3~28@) c3~30@) (Add (Mul b3~28@ (Mul b3~28@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@)))) (Add (Mul (Mul (Sub d3~32@ d3~32@) (Add 53 d3~32@)) (Mul (Mul b3~28@ c3~30@) (Sub c3~30@ b3~28@))) (Mul (Sub (Add a3~26@ c3~30@) (Mul d3~32@ d3~32@)) (Mul (Mul c3~30@ a3~26@) (Sub b3~28@ a3~26@))))))) (and (=> (= tmp%6@ (Mul c3~30@ c3~30@)) (=> (= tmp%7@ (Mul c3~30@ a3~26@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~1813@ temp_3_1~2026@))))) (=> (= temp_3_0~1813@ temp_3_1~2026@) (=> (= temp_4_0~2303@ (Mul (Add (Mul (Mul (Mul (Mul a4~34@ c4~38@) b4~36@) c4~38@) (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ a4~34@) (Add d4~40@ c4~38@)))) (Sub (Mul c4~38@ (Mul (Add d4~40@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul 60 a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ c4~38@))))) (Add (Mul (Mul (Sub (Mul d4~40@ b4~36@) (Mul b4~36@ b4~36@)) (Add (Mul c4~38@ b4~36@) (Mul d4~40@ d4~40@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@)))) (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ b4~36@)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ a4~34@)) (Mul (Add a4~34@ d4~40@) (Mul c4~38@ b4~36@))))))) (=> (= temp_4_1~2544@ (Mul (Add (Mul (Mul (Mul (Mul a4~34@ c4~38@) b4~36@) c4~38@) (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ a4~34@) (Add d4~40@ c4~38@)))) (Sub (Mul c4~38@ (Mul (Add d4~40@ a4~34@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul 60 a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ c4~38@))))) (Add (Mul (Mul (Sub (Mul d4~40@ b4~36@) (Mul b4~36@ b4~36@)) (Add (Mul c4~38@ b4~36@) (Mul d4~40@ d4~40@))) (Mul (Mul (Mul (Mul d4~40@ c4~38@) d4~40@) a4~34@) (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@)))) (Mul (Mul (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ b4~36@)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ a4~34@)) (Mul (Add a4~34@ d4~40@) (Mul c4~38@ b4~36@))))))) (and (=> (= tmp%8@ (Mul d4~40@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ d4~40@ a4~34@) (=> %%location_label%%4 (= temp_4_0~2303@ temp_4_1~2544@)))) (=> (= temp_4_0~2303@ temp_4_1~2544@) (=> (= temp_5_0~2815@ (Mul (Sub (Mul (Add (Mul (Sub d5~48@ a5~42@) (Mul d5~48@ c5~46@)) (Add (Sub a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul d5~48@ b5~44@) (Add b5~44@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ c5~46@)))) (Mul (Mul (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Sub b5~44@ a5~42@) a5~42@)) (Mul (Sub (Mul a5~42@ b5~44@) (Mul d5~48@ a5~42@)) (Mul b5~44@ (Mul 19 d5~48@))))) (Mul (Mul 60 (Mul (Mul b5~44@ (Mul a5~42@ d5~48@)) (Mul c5~46@ (Mul a5~42@ b5~44@)))) (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Add d5~48@ c5~46@))) (Add (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Sub b5~44@ c5~46@) (Mul b5~44@ d5~48@))))))) (=> (= temp_5_1~3052@ (Mul (Sub (Mul (Add (Mul (Sub d5~48@ a5~42@) (Mul d5~48@ c5~46@)) (Add (Sub a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul d5~48@ b5~44@) (Add b5~44@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ c5~46@)))) (Mul (Mul (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ a5~42@)) (Mul (Sub b5~44@ a5~42@) a5~42@)) (Mul (Sub (Mul a5~42@ b5~44@) (Mul d5~48@ a5~42@)) (Mul b5~44@ (Mul 19 d5~48@))))) (Mul (Mul 60 (Mul (Mul b5~44@ (Mul a5~42@ d5~48@)) (Mul c5~46@ (Mul a5~42@ b5~44@)))) (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ a5~42@)) (Mul (Mul b5~44@ c5~46@) (Add d5~48@ c5~46@))) (Add (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ a5~42@)) (Mul (Sub b5~44@ c5~46@) (Mul b5~44@ d5~48@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ d5~48@) (=> %%location_label%%5 (= temp_5_0~2815@ temp_5_1~3052@))) (=> (= temp_5_0~2815@ temp_5_1~3052@) (=> (= temp_6_0~3293@ (Mul (Mul (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Mul (Add d6~56@ 90) (Mul b6~52@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ a6~50@)))) (Sub (Mul (Sub (Mul d6~56@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) b6~52@)) b6~52@)) (Mul (Mul (Mul (Mul (Add a6~50@ c6~54@) (Sub b6~52@ b6~52@)) (Mul (Mul b6~52@ c6~54@) (Sub d6~56@ a6~50@))) (Mul (Mul (Mul a6~50@ b6~52@) (Add d6~56@ c6~54@)) (Mul (Mul c6~54@ d6~56@) a6~50@))) (Mul (Add (Mul (Add b6~52@ d6~56@) (Mul c6~54@ 14)) (Mul (Mul a6~50@ b6~52@) d6~56@)) d6~56@)))) (=> (= temp_6_1~3506@ (Mul (Mul (Mul (Mul (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Mul (Add d6~56@ 90) (Mul b6~52@ c6~54@)) (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ a6~50@)))) (Sub (Mul (Sub (Mul d6~56@ c6~54@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ d6~56@) b6~52@)) b6~52@)) (Mul (Mul (Mul (Mul (Mul b6~52@ c6~54@) (Sub d6~56@ a6~50@)) (Mul (Add a6~50@ c6~54@) (Sub b6~52@ b6~52@))) (Mul (Mul (Mul a6~50@ b6~52@) (Add d6~56@ c6~54@)) (Mul (Mul c6~54@ d6~56@) a6~50@))) (Mul (Add (Mul (Add b6~52@ d6~56@) (Mul c6~54@ 14)) (Mul (Mul a6~50@ b6~52@) d6~56@)) d6~56@)))) (and (=> (= tmp%9@ (Mul (Add a6~50@ c6~54@) (Sub b6~52@ b6~52@))) (=> (= tmp%10@ (Mul (Mul b6~52@ c6~54@) (Sub d6~56@ a6~50@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~3293@ temp_6_1~3506@))))) (=> (= temp_6_0~3293@ temp_6_1~3506@) (=> (= temp_7_0~3731@ (Sub (Mul (Mul (Mul (Sub (Add c7~62@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul b7~60@ b7~60@) c7~62@)) b7~60@) (Mul b7~60@ (Mul (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ d7~64@))))) (Mul (Mul (Mul (Sub (Mul d7~64@ d7~64@) (Add a7~58@ a7~58@)) (Mul c7~62@ (Add b7~60@ d7~64@))) (Mul a7~58@ (Mul (Mul b7~60@ b7~60@) (Add a7~58@ c7~62@)))) (Add (Mul (Mul c7~62@ (Add a7~58@ b7~60@)) (Mul c7~62@ (Mul b7~60@ d7~64@))) (Mul (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Sub a7~58@ a7~58@) (Mul c7~62@ d7~64@))))))) (=> (= temp_7_1~3904@ (Sub (Mul (Mul (Mul (Sub (Add c7~62@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul b7~60@ b7~60@) c7~62@)) b7~60@) (Mul b7~60@ (Mul (Sub (Mul c7~62@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ d7~64@))))) (Mul (Mul (Mul (Sub (Mul d7~64@ d7~64@) (Add a7~58@ a7~58@)) (Mul c7~62@ (Add b7~60@ d7~64@))) (Mul a7~58@ (Mul (Mul b7~60@ b7~60@) (Add a7~58@ c7~62@)))) (Add (Mul (Mul (Add a7~58@ b7~60@) c7~62@) (Mul c7~62@ (Mul b7~60@ d7~64@))) (Mul (Mul (Mul d7~64@ d7~64@) (Mul c7~62@ d7~64@)) (Mul (Sub a7~58@ a7~58@) (Mul c7~62@ d7~64@))))))) (and (=> (= tmp%11@ (Add a7~58@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ tmp%11@) (=> %%location_label%%7 (= temp_7_0~3731@ temp_7_1~3904@)))) (=> (= temp_7_0~3731@ temp_7_1~3904@) (=> (= temp_8_0~4101@ (Mul (Mul (Mul (Add (Mul d8~72@ (Mul c8~70@ c8~70@)) (Add (Sub a8~66@ d8~72@) (Sub a8~66@ a8~66@))) (Mul (Mul (Mul b8~68@ a8~66@) (Add d8~72@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ a8~66@)))) c8~70@) (Mul (Mul a8~66@ (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ a8~66@) (Sub d8~72@ c8~70@)))) (Mul (Mul (Mul (Sub d8~72@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ c8~70@)) (Sub (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))))))) (=> (= temp_8_1~4266@ (Mul (Mul (Mul (Add (Mul d8~72@ (Mul c8~70@ c8~70@)) (Add (Sub a8~66@ d8~72@) (Sub a8~66@ a8~66@))) (Mul (Mul (Mul b8~68@ a8~66@) (Add d8~72@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ a8~66@)))) c8~70@) (Mul (Mul a8~66@ (Mul (Add (Mul a8~66@ c8~70@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ a8~66@) (Sub d8~72@ c8~70@)))) (Mul (Mul (Mul (Sub d8~72@ b8~68@) (Mul b8~68@ d8~72@)) (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ c8~70@))) (Mul (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ a8~66@)) (Sub (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@))))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. a8~66@ c8~70@) (=> %%location_label%%8 (= temp_8_0~4101@ temp_8_1~4266@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
