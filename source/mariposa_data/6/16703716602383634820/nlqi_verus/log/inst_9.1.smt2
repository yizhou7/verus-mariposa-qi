...
(set-info :comment ";; mariposa_data/6//16703716602383634820/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_2_0~1197@ Int)
(declare-const temp_2_1~1402@ Int)
(declare-const temp_3_0~1505@ Int)
(declare-const temp_3_1~1574@ Int)
(declare-const temp_4_0~1847@ Int)
(declare-const temp_4_1~2084@ Int)
(declare-const temp_5_0~2363@ Int)
(declare-const temp_5_1~2580@ Int)
(declare-const temp_6_0~2827@ Int)
(declare-const temp_6_1~3040@ Int)
(declare-const temp_7_0~3275@ Int)
(declare-const temp_7_1~3480@ Int)
(declare-const temp_8_0~3777@ Int)
(declare-const temp_8_1~4010@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Mul (Sub (Mul (Mul a0~2@ (Mul d0~8@ a0~2@)) (Mul b0~4@ (Mul b0~4@ d0~8@))) (Mul d0~8@ (Mul (Sub 18 b0~4@) b0~4@))) (Mul (Mul (Mul (Mul b0~4@ c0~6@) c0~6@) (Mul b0~4@ (Mul b0~4@ b0~4@))) (Mul (Mul d0~8@ (Mul c0~6@ a0~2@)) (Mul (Sub c0~6@ c0~6@) (Sub b0~4@ a0~2@))))) (Mul (Mul (Mul (Mul (Sub b0~4@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Sub b0~4@ b0~4@) (Add b0~4@ a0~2@))) (Mul (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ c0~6@)) (Mul (Mul a0~2@ b0~4@) a0~2@))) (Mul (Mul (Mul d0~8@ (Mul a0~2@ a0~2@)) (Mul b0~4@ (Mul c0~6@ d0~8@))) b0~4@)))) (=> (= temp_0_1~466@ (Mul (Mul (Sub (Mul (Mul a0~2@ (Mul d0~8@ a0~2@)) (Mul b0~4@ (Mul b0~4@ d0~8@))) (Mul d0~8@ (Mul (Sub 18 b0~4@) b0~4@))) (Mul (Mul (Mul (Mul b0~4@ c0~6@) c0~6@) (Mul b0~4@ (Mul b0~4@ b0~4@))) (Mul (Mul d0~8@ (Mul c0~6@ a0~2@)) (Mul (Sub c0~6@ c0~6@) (Sub b0~4@ a0~2@))))) (Mul (Mul (Mul (Mul (Sub b0~4@ b0~4@) (Mul b0~4@ d0~8@)) (Mul (Sub b0~4@ b0~4@) (Add b0~4@ a0~2@))) (Mul (Mul (Mul a0~2@ b0~4@) a0~2@) (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ c0~6@)))) (Mul (Mul (Mul d0~8@ (Mul a0~2@ a0~2@)) (Mul b0~4@ (Mul c0~6@ d0~8@))) b0~4@)))) (and (=> (= tmp%1@ (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ c0~6@))) (=> (= tmp%2@ (Mul (Mul a0~2@ b0~4@) a0~2@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~466@))))) (=> (= temp_0_0~273@ temp_0_1~466@) (=> (= temp_1_0~743@ (Mul (Mul (Mul (Add (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@))) (Add c1~14@ (Mul (Mul b1~12@ d1~16@) d1~16@))) (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Sub d1~16@ d1~16@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ c1~14@)) (Mul (Sub c1~14@ b1~12@) (Mul c1~14@ b1~12@))))) (Mul (Mul (Mul b1~12@ (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ c1~14@))) (Mul (Mul d1~16@ (Sub c1~14@ b1~12@)) (Sub (Mul b1~12@ a1~10@) (Mul d1~16@ b1~12@)))) (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ d1~16@)) (Add (Mul d1~16@ b1~12@) (Mul 0 a1~10@))) (Mul (Mul b1~12@ (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ a1~10@) c1~14@)))))) (=> (= temp_1_1~972@ (Mul (Mul (Mul (Add (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ c1~14@)) (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ d1~16@))) (Add c1~14@ (Mul (Mul b1~12@ d1~16@) d1~16@))) (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@)) (Mul (Sub d1~16@ d1~16@) (Mul c1~14@ b1~12@))) (Mul (Mul (Mul b1~12@ b1~12@) (Mul c1~14@ c1~14@)) (Mul (Sub c1~14@ b1~12@) (Mul b1~12@ c1~14@))))) (Mul (Mul (Mul b1~12@ (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ c1~14@))) (Mul (Mul d1~16@ (Sub c1~14@ b1~12@)) (Sub (Mul b1~12@ a1~10@) (Mul d1~16@ b1~12@)))) (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ d1~16@)) (Add (Mul d1~16@ b1~12@) (Mul 0 a1~10@))) (Mul (Mul b1~12@ (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ a1~10@) c1~14@)))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ b1~12@) (=> %%location_label%%1 (= temp_1_0~743@ temp_1_1~972@))) (=> (= temp_1_0~743@ temp_1_1~972@) (=> (= temp_2_0~1197@ (Sub (Mul (Mul (Mul (Mul (Add c2~22@ b2~20@) (Mul a2~18@ a2~18@)) (Add (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@)) (Sub (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@)))) (Add (Mul (Sub (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul c2~22@ (Mul b2~20@ b2~20@))) (Add (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Add a2~18@ c2~22@))))) (Mul (Sub c2~22@ (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ d2~24@)))) (Mul d2~24@ (Mul (Mul (Add d2~24@ a2~18@) (Mul a2~18@ b2~20@)) (Sub (Add b2~20@ c2~22@) (Mul a2~18@ c2~22@))))))) (=> (= temp_2_1~1402@ (Sub (Mul (Mul (Mul (Mul (Add c2~22@ b2~20@) (Mul a2~18@ a2~18@)) (Add (Mul a2~18@ b2~20@) (Mul a2~18@ c2~22@))) (Mul (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ a2~18@)) (Sub (Mul b2~20@ c2~22@) (Mul d2~24@ b2~20@)))) (Add (Mul (Sub (Mul d2~24@ b2~20@) (Mul a2~18@ a2~18@)) (Mul c2~22@ (Mul b2~20@ b2~20@))) (Add (Mul (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul a2~18@ d2~24@) (Add a2~18@ c2~22@))))) (Mul (Sub c2~22@ (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ d2~24@)))) (Mul d2~24@ (Mul (Add (Mul d2~24@ (Mul a2~18@ b2~20@)) (Mul a2~18@ (Mul a2~18@ b2~20@))) (Sub (Add b2~20@ c2~22@) (Mul a2~18@ c2~22@))))))) (and (=> (= tmp%3@ (Mul a2~18@ b2~20@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d2~24@ a2~18@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~1197@ temp_2_1~1402@)))) (=> (= temp_2_0~1197@ temp_2_1~1402@) (=> (= temp_3_0~1505@ (Add (Sub b3~28@ (Mul (Mul b3~28@ (Mul d3~32@ (Sub c3~30@ a3~26@))) (Mul (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@)) a3~26@))) (Mul d3~32@ (Mul c3~30@ (Mul (Sub (Mul d3~32@ d3~32@) (Mul b3~28@ b3~28@)) b3~28@))))) (=> (= temp_3_1~1574@ (Add (Sub b3~28@ (Mul (Mul (Mul d3~32@ (Sub c3~30@ a3~26@)) b3~28@) (Mul (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@)) a3~26@))) (Mul d3~32@ (Mul c3~30@ (Mul (Sub (Mul d3~32@ d3~32@) (Mul b3~28@ b3~28@)) b3~28@))))) (and (=> (= tmp%4@ (Mul d3~32@ (Sub c3~30@ a3~26@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b3~28@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~1505@ temp_3_1~1574@)))) (=> (= temp_3_0~1505@ temp_3_1~1574@) (=> (= temp_4_0~1847@ (Add (Mul (Mul (Mul (Sub (Mul a4~34@ c4~38@) (Add c4~38@ c4~38@)) (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ b4~36@))) (Add (Mul (Sub b4~36@ b4~36@) (Mul b4~36@ d4~40@)) b4~36@)) (Mul (Mul (Mul (Add 51 b4~36@) b4~36@) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ b4~36@))))) (Mul (Mul a4~34@ (Mul (Add (Sub a4~34@ c4~38@) (Mul c4~38@ 38)) (Mul (Sub a4~34@ a4~34@) (Add b4~36@ d4~40@)))) (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@ a4~34@) (Add a4~34@ a4~34@))))))) (=> (= temp_4_1~2084@ (Add (Mul (Mul (Mul (Sub (Mul a4~34@ c4~38@) (Add c4~38@ c4~38@)) (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ b4~36@))) (Add (Mul (Sub b4~36@ b4~36@) (Mul b4~36@ d4~40@)) b4~36@)) (Mul (Mul (Mul (Add 51 b4~36@) b4~36@) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ b4~36@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ b4~36@))))) (Mul (Mul a4~34@ (Mul (Mul (Add (Sub a4~34@ c4~38@) (Mul c4~38@ 38)) (Sub a4~34@ a4~34@)) (Add b4~36@ d4~40@))) (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@ a4~34@) (Add a4~34@ a4~34@))))))) (and (=> (= tmp%5@ (Add (Sub a4~34@ c4~38@) (Mul c4~38@ 38))) (=> (= tmp%6@ (Sub a4~34@ a4~34@)) (=> (= tmp%7@ (Add b4~36@ d4~40@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%4 (= temp_4_0~1847@ temp_4_1~2084@)))))) (=> (= temp_4_0~1847@ temp_4_1~2084@) (=> (= temp_5_0~2363@ (Mul (Mul (Mul (Mul (Add c5~46@ (Mul b5~44@ a5~42@)) (Mul (Add b5~44@ c5~46@) (Mul b5~44@ d5~48@))) (Mul (Mul d5~48@ (Mul c5~46@ c5~46@)) (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ c5~46@)))) (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ c5~46@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ d5~48@))) (Mul (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ d5~48@)) (Mul a5~42@ d5~48@)))) (Mul (Sub (Sub a5~42@ (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ d5~48@))) (Add (Add (Mul a5~42@ d5~48@) (Mul a5~42@ a5~42@)) (Sub (Sub d5~48@ a5~42@) (Mul c5~46@ b5~44@)))) (Mul (Add (Mul (Sub a5~42@ d5~48@) (Mul b5~44@ c5~46@)) b5~44@) (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Sub c5~46@ b5~44@))))))) (=> (= temp_5_1~2580@ (Mul (Mul (Mul (Mul (Add c5~46@ (Mul b5~44@ a5~42@)) (Mul (Add b5~44@ c5~46@) (Mul b5~44@ d5~48@))) (Mul (Mul d5~48@ (Mul c5~46@ c5~46@)) (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ c5~46@)))) (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ c5~46@)) (Mul (Mul (Mul a5~42@ c5~46@) a5~42@) d5~48@)) (Mul (Mul (Mul d5~48@ d5~48@) (Mul a5~42@ d5~48@)) (Mul a5~42@ d5~48@)))) (Mul (Sub (Sub a5~42@ (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ d5~48@))) (Add (Add (Mul a5~42@ d5~48@) (Mul a5~42@ a5~42@)) (Sub (Sub d5~48@ a5~42@) (Mul c5~46@ b5~44@)))) (Mul (Add (Mul (Sub a5~42@ d5~48@) (Mul b5~44@ c5~46@)) b5~44@) (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Sub c5~46@ b5~44@))))))) (and (=> (= tmp%8@ (Mul a5~42@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ a5~42@ d5~48@) (=> %%location_label%%5 (= temp_5_0~2363@ temp_5_1~2580@)))) (=> (= temp_5_0~2363@ temp_5_1~2580@) (=> (= temp_6_0~2827@ (Mul (Mul c6~54@ (Sub (Mul (Mul a6~50@ (Mul c6~54@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Add c6~54@ a6~50@))) (Mul (Mul (Mul 73 d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@))))) (Mul (Mul (Mul (Sub (Mul b6~52@ c6~54@) (Mul d6~56@ c6~54@)) (Sub (Sub b6~52@ d6~56@) (Mul c6~54@ b6~52@))) (Mul (Mul (Sub c6~54@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul d6~56@ c6~54@) (Sub d6~56@ c6~54@)))) (Mul (Mul (Mul (Sub 41 c6~54@) (Mul b6~52@ d6~56@)) (Mul (Mul a6~50@ d6~56@) (Add c6~54@ a6~50@))) (Mul (Mul (Add c6~54@ a6~50@) (Mul a6~50@ d6~56@)) (Mul b6~52@ (Add c6~54@ b6~52@))))))) (=> (= temp_6_1~3040@ (Mul (Mul c6~54@ (Sub (Mul (Mul (Mul a6~50@ c6~54@) b6~52@) (Mul (Mul c6~54@ a6~50@) (Add c6~54@ a6~50@))) (Mul (Mul (Mul 73 d6~56@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ d6~56@) (Mul d6~56@ d6~56@))))) (Mul (Mul (Mul (Sub (Mul b6~52@ c6~54@) (Mul d6~56@ c6~54@)) (Sub (Sub b6~52@ d6~56@) (Mul c6~54@ b6~52@))) (Mul (Mul (Sub c6~54@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Mul d6~56@ c6~54@) (Sub d6~56@ c6~54@)))) (Mul (Mul (Mul (Sub 41 c6~54@) (Mul b6~52@ d6~56@)) (Mul (Mul a6~50@ d6~56@) (Add c6~54@ a6~50@))) (Mul (Mul (Add c6~54@ a6~50@) (Mul a6~50@ d6~56@)) (Mul b6~52@ (Add c6~54@ b6~52@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. a6~50@ c6~54@ b6~52@) (=> %%location_label%%6 (= temp_6_0~2827@ temp_6_1~3040@))) (=> (= temp_6_0~2827@ temp_6_1~3040@) (=> (= temp_7_0~3275@ (Mul (Mul (Sub (Mul (Mul (Mul c7~62@ c7~62@) b7~60@) (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@))) (Mul (Mul (Mul d7~64@ c7~62@) (Add d7~64@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ 75)))) (Sub (Sub (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)) (Mul (Mul d7~64@ d7~64@) a7~58@)) (Mul (Mul a7~58@ (Mul d7~64@ d7~64@)) c7~62@))) (Mul 83 (Add (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ a7~58@) d7~64@)) (Mul (Mul (Mul d7~64@ b7~60@) (Mul 90 d7~64@)) (Sub (Add c7~62@ a7~58@) (Mul a7~58@ c7~62@))))))) (=> (= temp_7_1~3480@ (Mul (Mul (Sub (Mul (Mul (Mul c7~62@ c7~62@) b7~60@) (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@))) (Mul (Mul (Mul d7~64@ c7~62@) (Add d7~64@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ 75)))) (Sub (Sub (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@)) (Mul (Mul d7~64@ d7~64@) a7~58@)) (Mul (Mul a7~58@ (Mul d7~64@ d7~64@)) c7~62@))) (Mul 83 (Add (Mul (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ a7~58@) d7~64@)) (Mul (Sub (Add c7~62@ a7~58@) (Mul a7~58@ c7~62@)) (Mul (Mul d7~64@ b7~60@) (Mul 90 d7~64@))))))) (and (=> (= tmp%9@ (Mul (Mul d7~64@ b7~60@) (Mul 90 d7~64@))) (=> (= tmp%10@ (Sub (Add c7~62@ a7~58@) (Mul a7~58@ c7~62@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~3275@ temp_7_1~3480@))))) (=> (= temp_7_0~3275@ temp_7_1~3480@) (=> (= temp_8_0~3777@ (Mul (Mul (Mul (Mul (Mul (Add c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Sub a8~66@ c8~70@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul 13 c8~70@) (Add d8~72@ b8~68@)) c8~70@)) (Add (Mul (Mul (Mul c8~70@ b8~68@) d8~72@) (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (Sub (Sub (Mul c8~70@ b8~68@) (Mul d8~72@ c8~70@)) b8~68@))) (Mul (Mul (Sub d8~72@ (Mul (Mul 56 b8~68@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Sub b8~68@ b8~68@) (Mul a8~66@ d8~72@)))) (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Sub a8~66@ a8~66@)) (Mul b8~68@ (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) c8~70@) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@))))))) (=> (= temp_8_1~4010@ (Mul (Mul (Mul (Sub d8~72@ (Mul (Mul 56 b8~68@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Sub b8~68@ b8~68@) (Mul a8~66@ d8~72@)))) (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Sub a8~66@ a8~66@)) (Mul b8~68@ (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) c8~70@) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@))))) (Mul (Mul (Mul (Mul (Add c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Sub a8~66@ c8~70@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul 13 c8~70@) (Add d8~72@ b8~68@)) c8~70@)) (Add (Mul (Mul (Mul c8~70@ b8~68@) d8~72@) (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (Sub (Sub (Mul c8~70@ b8~68@) (Mul d8~72@ c8~70@)) b8~68@))))) (=> (= tmp%11@ (Mul (Mul (Mul (Mul (Add c8~70@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Sub a8~66@ c8~70@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul 13 c8~70@) (Add d8~72@ b8~68@)) c8~70@)) (Add (Mul (Mul (Mul c8~70@ b8~68@) d8~72@) (Mul (Sub b8~68@ d8~72@) (Mul d8~72@ d8~72@))) (Sub (Sub (Mul c8~70@ b8~68@) (Mul d8~72@ c8~70@)) b8~68@)))) (=> (= tmp%12@ (Mul (Mul (Sub d8~72@ (Mul (Mul 56 b8~68@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Sub b8~68@ b8~68@) (Mul a8~66@ d8~72@)))) (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Sub a8~66@ a8~66@)) (Mul b8~68@ (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ c8~70@) c8~70@) (Mul (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@)))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%8 (= temp_8_0~3777@ temp_8_1~4010@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
