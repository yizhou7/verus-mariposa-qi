...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~333@ (Mul (Mul (Mul (Mul (Mul (Mul a0~2@ c0~6@) d0~8@) (Mul (Sub c0~6@ d0~8@) (Mul d0~8@ b0~4@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ c0~6@)) (Mul (Mul b0~4@ b0~4@) (Mul 44 a0~2@)))) (Mul (Mul (Add (Mul d0~8@ a0~2@) (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ c0~6@) c0~6@)) (Mul (Mul (Add c0~6@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ b0~4@))))) (Mul (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@))) (Mul (Mul (Mul b0~4@ a0~2@) (Add b0~4@ a0~2@)) (Add (Mul c0~6@ c0~6@) (Sub d0~8@ b0~4@)))) (Mul (Mul (Add (Mul a0~2@ a0~2@) (Mul a0~2@ a0~2@)) c0~6@) (Add (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Sub c0~6@ c0~6@))))))) (=> (= temp_0_1~582@ (Mul (Mul (Mul (Mul (Mul (Mul a0~2@ c0~6@) d0~8@) (Mul (Sub c0~6@ d0~8@) (Mul d0~8@ b0~4@))) (Mul (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ c0~6@)) (Mul (Mul b0~4@ b0~4@) (Mul 44 a0~2@)))) (Mul (Mul (Add (Mul d0~8@ a0~2@) (Mul d0~8@ c0~6@)) (Mul (Mul a0~2@ c0~6@) c0~6@)) (Mul (Mul (Add c0~6@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ b0~4@))))) (Mul (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ d0~8@)) (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@))) (Mul (Mul b0~4@ a0~2@) (Mul (Add b0~4@ a0~2@) (Add (Mul c0~6@ c0~6@) (Sub d0~8@ b0~4@))))) (Mul (Mul (Add (Mul a0~2@ a0~2@) (Mul a0~2@ a0~2@)) c0~6@) (Add (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ b0~4@) (Sub c0~6@ c0~6@))))))) (=> (= tmp%1@ (= temp_0_0~333@ temp_0_1~582@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~738@ (Mul (Sub (Sub c1~14@ (Mul (Mul c1~14@ (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ a1~10@)))) (Mul (Sub (Mul (Mul b1~12@ b1~12@) (Mul a1~10@ b1~12@)) d1~16@) (Add (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@)) a1~10@))) (Mul d1~16@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Add a1~10@ d1~16@))) (Sub (Mul (Mul b1~12@ d1~16@) (Sub d1~16@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ a1~10@))))))) (=> (= temp_1_1~879@ (Mul (Sub (Sub c1~14@ (Mul (Mul c1~14@ (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ a1~10@)))) (Mul (Sub (Mul (Mul b1~12@ b1~12@) (Mul b1~12@ a1~10@)) d1~16@) (Add (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ d1~16@)) a1~10@))) (Mul d1~16@ (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Add a1~10@ d1~16@))) (Sub (Mul (Mul b1~12@ d1~16@) (Sub d1~16@ a1~10@)) (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ a1~10@))))))) (=> (= tmp%2@ (= temp_1_0~738@ temp_1_1~879@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~1099@ (Mul (Mul d2~24@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ c2~22@))) (Mul (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ d2~24@))))) (Add (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ 18))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ c2~22@)) (Mul (Mul b2~20@ d2~24@) b2~20@))) (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Sub b2~20@ b2~20@) (Mul a2~18@ c2~22@))))))) (=> (= temp_2_1~1372@ (Add (Mul (Mul d2~24@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ c2~22@))) (Mul (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ d2~24@))))) (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ 18))) (Mul (Mul (Mul d2~24@ b2~20@) (Mul b2~20@ c2~22@)) (Mul (Mul b2~20@ d2~24@) b2~20@)))) (Mul (Mul d2~24@ (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ c2~22@))) (Mul (Sub (Mul c2~22@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ b2~20@) (Mul a2~18@ d2~24@))))) (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ d2~24@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Sub b2~20@ b2~20@) (Mul a2~18@ c2~22@))))))) (=> (= tmp%3@ (= temp_2_0~1099@ temp_2_1~1372@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1620@ (Mul (Mul (Mul (Mul (Add (Mul d3~32@ c3~30@) (Mul a3~26@ d3~32@)) (Mul (Sub b3~28@ c3~30@) (Mul b3~28@ b3~28@))) (Sub (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ c3~30@)))) (Mul (Sub (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@)) (Mul c3~30@ (Mul b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ b3~28@) (Add c3~30@ d3~32@)) (Sub (Mul b3~28@ d3~32@) (Add c3~30@ c3~30@))))) (Mul (Mul (Mul (Sub (Mul 90 b3~28@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ c3~30@))) (Mul (Mul (Sub d3~32@ a3~26@) (Mul a3~26@ a3~26@)) b3~28@)) (Mul c3~30@ (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@)) (Add a3~26@ (Sub c3~30@ 25))))))) (=> (= temp_3_1~1853@ (Mul (Mul (Mul (Sub (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@)) (Mul c3~30@ (Mul b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ b3~28@) (Add c3~30@ d3~32@)) (Sub (Mul b3~28@ d3~32@) (Add c3~30@ c3~30@)))) (Mul (Mul (Add (Mul d3~32@ c3~30@) (Mul a3~26@ d3~32@)) (Mul (Sub b3~28@ c3~30@) (Mul b3~28@ b3~28@))) (Sub (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@)) (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ c3~30@))))) (Mul (Mul (Mul (Sub (Mul 90 b3~28@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ a3~26@) (Mul d3~32@ c3~30@))) (Mul (Mul (Sub d3~32@ a3~26@) (Mul a3~26@ a3~26@)) b3~28@)) (Mul c3~30@ (Mul (Mul (Mul b3~28@ a3~26@) (Mul c3~30@ b3~28@)) (Add a3~26@ (Sub c3~30@ 25))))))) (=> (= tmp%4@ (= temp_3_0~1620@ temp_3_1~1853@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~2129@ (Mul (Mul (Mul (Mul (Mul c4~38@ (Mul a4~34@ b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@)) (Add (Mul a4~34@ 38) (Sub d4~40@ d4~40@)))) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ b4~36@)) (Sub (Mul d4~40@ b4~36@) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ c4~38@))))) (Mul (Mul (Add (Mul (Mul a4~34@ d4~40@) d4~40@) (Mul (Mul c4~38@ a4~34@) (Add c4~38@ a4~34@))) (Mul (Mul (Add a4~34@ a4~34@) (Mul a4~34@ b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul a4~34@ d4~40@)))) (Mul (Mul (Sub (Mul d4~40@ b4~36@) (Mul d4~40@ d4~40@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ c4~38@))) (Mul (Sub (Mul c4~38@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Add c4~38@ d4~40@) (Mul c4~38@ c4~38@))))))) (=> (= temp_4_1~2390@ (Mul (Mul (Mul (Mul (Mul c4~38@ (Mul a4~34@ b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@)) (Add (Mul a4~34@ 38) (Sub d4~40@ d4~40@)))) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ b4~36@)) (Sub (Mul d4~40@ b4~36@) (Mul c4~38@ a4~34@))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul c4~38@ c4~38@))))) (Mul (Mul (Add (Mul (Mul a4~34@ d4~40@) d4~40@) (Mul (Mul c4~38@ a4~34@) (Add c4~38@ a4~34@))) (Mul (Mul (Add a4~34@ a4~34@) (Mul a4~34@ b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul a4~34@ d4~40@)))) (Mul (Mul (Sub (Mul d4~40@ b4~36@) (Mul d4~40@ d4~40@)) (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ c4~38@))) (Mul (Sub (Mul c4~38@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Add c4~38@ d4~40@) (Mul c4~38@ c4~38@))))))) (=> (= tmp%5@ (= temp_4_0~2129@ temp_4_1~2390@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~2634@ (Mul (Mul (Add b5~44@ (Mul (Mul (Mul a5~42@ d5~48@) (Mul 90 d5~48@)) (Mul (Mul b5~44@ d5~48@) c5~46@))) (Mul (Add (Add (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@)) (Sub (Mul b5~44@ b5~44@) (Add c5~46@ d5~48@))) (Sub (Mul (Mul c5~46@ b5~44@) (Mul 96 d5~48@)) (Sub (Sub d5~48@ c5~46@) (Sub d5~48@ a5~42@))))) (Mul (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ c5~46@)) (Mul c5~46@ (Sub a5~42@ b5~44@))) (Mul (Mul (Add b5~44@ a5~42@) (Sub b5~44@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ d5~48@)))) (Mul (Mul d5~48@ (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) b5~44@) (Mul (Mul b5~44@ c5~46@) (Add b5~44@ a5~42@))))))) (=> (= temp_5_1~2863@ (Mul (Mul (Add b5~44@ (Mul (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ 90)) (Mul (Mul b5~44@ d5~48@) c5~46@))) (Mul (Add (Add (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@)) (Sub (Mul b5~44@ b5~44@) (Add c5~46@ d5~48@))) (Sub (Mul (Mul c5~46@ b5~44@) (Mul 96 d5~48@)) (Sub (Sub d5~48@ c5~46@) (Sub d5~48@ a5~42@))))) (Mul (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul c5~46@ c5~46@)) (Mul c5~46@ (Sub a5~42@ b5~44@))) (Mul (Mul (Add b5~44@ a5~42@) (Sub b5~44@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ d5~48@)))) (Mul (Mul d5~48@ (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) b5~44@) (Mul (Mul b5~44@ c5~46@) (Add b5~44@ a5~42@))))))) (=> (= tmp%6@ (= temp_5_0~2634@ temp_5_1~2863@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~3131@ (Add (Mul (Mul (Mul (Sub (Mul a6~50@ d6~56@) (Mul 68 d6~56@)) (Mul (Add a6~50@ a6~50@) (Mul c6~54@ b6~52@))) (Sub (Sub (Mul a6~50@ a6~50@) (Mul a6~50@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ c6~54@)))) (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Sub d6~56@ c6~54@)) d6~56@) (Mul c6~54@ (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ b6~52@))))) (Mul (Sub (Sub (Mul (Mul c6~54@ b6~52@) c6~54@) (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Add c6~54@ b6~52@)))) (Mul (Mul (Mul (Sub d6~56@ b6~52@) (Sub a6~50@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ 82))) (Mul (Mul (Sub c6~54@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@))))))) (=> (= temp_6_1~3384@ (Add (Mul (Mul (Mul (Sub (Mul a6~50@ d6~56@) (Mul 68 d6~56@)) (Mul (Add a6~50@ a6~50@) (Mul c6~54@ b6~52@))) (Sub (Sub (Mul a6~50@ a6~50@) (Mul a6~50@ a6~50@)) (Mul (Mul d6~56@ c6~54@) (Mul c6~54@ c6~54@)))) (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Sub d6~56@ c6~54@)) d6~56@) (Mul c6~54@ (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ b6~52@))))) (Mul (Sub (Sub (Mul (Mul b6~52@ c6~54@) c6~54@) (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ d6~56@)) (Mul (Mul d6~56@ d6~56@) (Add c6~54@ b6~52@)))) (Mul (Mul (Mul (Sub d6~56@ b6~52@) (Sub a6~50@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ 82))) (Mul (Mul (Sub c6~54@ d6~56@) (Mul a6~50@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@))))))) (=> (= tmp%7@ (= temp_6_0~3131@ temp_6_1~3384@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~3580@ (Sub (Mul c7~62@ (Mul (Add (Sub d7~64@ (Mul d7~64@ b7~60@)) (Mul (Sub a7~58@ b7~60@) (Sub a7~58@ c7~62@))) c7~62@)) (Mul (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul c7~62@ b7~60@)) (Mul c7~62@ (Mul a7~58@ b7~60@))) (Mul (Mul (Add c7~62@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)))) (Mul (Mul (Mul (Mul d7~64@ c7~62@) d7~64@) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ b7~60@))) (Add (Mul (Add c7~62@ a7~58@) (Mul 94 d7~64@)) (Add (Mul a7~58@ b7~60@) (Sub d7~64@ 11))))))) (=> (= temp_7_1~3761@ (Sub (Mul c7~62@ (Mul (Add (Sub d7~64@ (Mul d7~64@ b7~60@)) (Mul (Sub a7~58@ b7~60@) (Sub a7~58@ c7~62@))) c7~62@)) (Mul (Mul (Mul (Mul (Mul c7~62@ c7~62@) (Mul c7~62@ b7~60@)) (Mul c7~62@ (Mul b7~60@ a7~58@))) (Mul (Mul (Add c7~62@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Mul b7~60@ d7~64@) (Mul a7~58@ d7~64@)))) (Mul (Mul (Mul (Mul d7~64@ c7~62@) d7~64@) (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ b7~60@))) (Add (Mul (Add c7~62@ a7~58@) (Mul 94 d7~64@)) (Add (Mul a7~58@ b7~60@) (Sub d7~64@ 11))))))) (=> (= tmp%8@ (= temp_7_0~3580@ temp_7_1~3761@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~3965@ (Mul (Mul (Mul (Add (Mul (Add b8~68@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Sub d8~72@ b8~68@) (Add a8~66@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ c8~70@)))) (Mul (Mul (Mul (Sub a8~66@ c8~70@) a8~66@) (Sub a8~66@ (Mul a8~66@ b8~68@))) (Mul (Mul a8~66@ (Mul c8~70@ a8~66@)) (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@))))) (Mul (Mul (Mul (Mul (Mul 57 a8~66@) a8~66@) (Add (Sub c8~70@ a8~66@) (Add b8~68@ d8~72@))) (Mul (Mul b8~68@ (Mul c8~70@ a8~66@)) (Mul d8~72@ (Mul a8~66@ b8~68@)))) (Mul b8~68@ d8~72@)))) (=> (= temp_8_1~4154@ (Mul (Mul (Mul (Add (Mul (Add b8~68@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ c8~70@))) (Mul (Mul (Sub d8~72@ b8~68@) (Add a8~66@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ c8~70@)))) (Mul (Mul (Mul (Sub a8~66@ c8~70@) a8~66@) (Sub a8~66@ (Mul a8~66@ b8~68@))) (Mul (Mul a8~66@ (Mul c8~70@ a8~66@)) (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ d8~72@))))) (Mul (Mul (Mul (Mul (Mul 57 a8~66@) a8~66@) (Add (Sub c8~70@ a8~66@) (Add b8~68@ d8~72@))) (Mul (Mul b8~68@ (Mul c8~70@ a8~66@)) (Mul d8~72@ (Mul a8~66@ b8~68@)))) (Mul b8~68@ d8~72@)))) (=> (= tmp%9@ (= temp_8_0~3965@ temp_8_1~4154@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
