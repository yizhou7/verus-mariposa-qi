...
(declare-const temp_1_1~1036@ Int)
(declare-const temp_2_0~1161@ Int)
(declare-const temp_2_1~1262@ Int)
(declare-const temp_3_0~1499@ Int)
(declare-const temp_3_1~1712@ Int)
(declare-const temp_4_0~1929@ Int)
(declare-const temp_4_1~2122@ Int)
(declare-const temp_5_0~2391@ Int)
(declare-const temp_5_1~2636@ Int)
(declare-const temp_6_0~2881@ Int)
(declare-const temp_6_1~3102@ Int)
(declare-const temp_7_0~3307@ Int)
(declare-const temp_7_1~3488@ Int)
(declare-const temp_8_0~3737@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ 90)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul c0~6@ d0~8@) b0~4@) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@)))) (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ a0~2@)) 38) c0~6@)) (Mul (Add (Mul (Mul a0~2@ (Add a0~2@ c0~6@)) (Mul b0~4@ (Add d0~8@ b0~4@))) (Mul (Mul (Sub a0~2@ c0~6@) (Mul c0~6@ c0~6@)) (Mul a0~2@ (Sub d0~8@ d0~8@)))) (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ c0~6@) b0~4@)) (Mul (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@)) (Sub (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@))))))) (=> (= temp_0_1~522@ (Mul (Mul (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ 90)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul c0~6@ d0~8@) b0~4@) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ c0~6@)))) (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ a0~2@)) 38) c0~6@)) (Mul (Add (Mul (Mul a0~2@ (Add a0~2@ c0~6@)) (Mul b0~4@ (Add d0~8@ b0~4@))) (Mul (Mul (Sub a0~2@ c0~6@) (Mul c0~6@ c0~6@)) (Mul a0~2@ (Sub d0~8@ d0~8@)))) (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ c0~6@) b0~4@)) (Mul (Mul (Mul b0~4@ c0~6@) (Mul d0~8@ a0~2@)) (Sub (Mul d0~8@ d0~8@) (Mul b0~4@ b0~4@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~522@))) (=> (= temp_0_0~301@ temp_0_1~522@) (=> (= temp_1_0~791@ (Mul (Mul (Add (Add (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@)) c1~14@) (Mul (Sub c1~14@ (Mul c1~14@ a1~10@)) (Mul (Sub b1~12@ c1~14@) (Mul d1~16@ 35)))) (Sub (Sub (Mul (Mul b1~12@ c1~14@) (Add c1~14@ d1~16@)) (Mul (Sub c1~14@ d1~16@) (Mul d1~16@ b1~12@))) (Mul (Mul (Sub c1~14@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Sub d1~16@ d1~16@))))) (Add (Add (Mul (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ b1~12@)) (Mul (Add c1~14@ a1~10@) (Mul d1~16@ d1~16@))) (Mul (Mul (Mul a1~10@ b1~12@) (Sub a1~10@ d1~16@)) b1~12@)) (Sub (Mul (Mul d1~16@ (Mul c1~14@ 70)) (Mul (Mul a1~10@ a1~10@) d1~16@)) (Mul (Mul (Mul c1~14@ b1~12@) (Sub c1~14@ a1~10@)) (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ a1~10@))))))) (=> (= temp_1_1~1036@ (Mul (Mul (Add (Add (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ c1~14@)) c1~14@) (Mul (Sub c1~14@ (Mul c1~14@ a1~10@)) (Mul (Sub b1~12@ c1~14@) (Mul d1~16@ 35)))) (Sub (Sub (Mul (Mul b1~12@ c1~14@) (Add c1~14@ d1~16@)) (Mul (Sub c1~14@ d1~16@) (Mul d1~16@ b1~12@))) (Mul (Mul (Sub c1~14@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Sub d1~16@ d1~16@))))) (Add (Add (Mul (Mul (Mul d1~16@ c1~14@) (Sub b1~12@ b1~12@)) (Mul (Add c1~14@ a1~10@) (Mul d1~16@ d1~16@))) (Mul (Mul (Mul a1~10@ b1~12@) (Sub a1~10@ d1~16@)) b1~12@)) (Sub (Mul (Mul d1~16@ (Mul c1~14@ 70)) (Mul (Mul a1~10@ a1~10@) d1~16@)) (Mul (Mul (Mul c1~14@ b1~12@) (Sub c1~14@ a1~10@)) (Mul (Mul c1~14@ d1~16@) (Mul a1~10@ a1~10@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~791@ temp_1_1~1036@))) (=> (= temp_1_0~791@ temp_1_1~1036@) (=> (= temp_2_0~1161@ (Add (Mul (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ b2~20@)) (Sub (Mul c2~22@ d2~24@) b2~20@)) (Mul (Add (Mul d2~24@ b2~20@) d2~24@) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ a2~18@)))) c2~22@) (Mul d2~24@ (Add (Mul d2~24@ (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ d2~24@))) (Mul b2~20@ (Mul (Mul a2~18@ d2~24@) c2~22@)))))) (=> (= temp_2_1~1262@ (Add (Mul (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ b2~20@)) (Sub (Mul c2~22@ d2~24@) b2~20@)) (Mul (Add (Mul d2~24@ b2~20@) d2~24@) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ d2~24@)))) c2~22@) (Mul d2~24@ (Add (Mul d2~24@ (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ d2~24@))) (Mul b2~20@ (Mul (Mul a2~18@ d2~24@) c2~22@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1161@ temp_2_1~1262@))) (=> (= temp_2_0~1161@ temp_2_1~1262@) (=> (= temp_3_0~1499@ (Mul (Mul (Sub (Mul (Add (Mul a3~26@ d3~32@) (Mul a3~26@ c3~30@)) a3~26@) (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@)) (Mul b3~28@ (Add a3~26@ c3~30@)))) (Sub (Add (Mul (Sub c3~30@ b3~28@) (Mul b3~28@ a3~26@)) (Mul a3~26@ (Mul b3~28@ b3~28@))) (Sub (Mul (Add d3~32@ d3~32@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ b3~28@) b3~28@)))) (Mul (Mul (Mul (Add (Mul c3~30@ b3~28@) (Sub c3~30@ a3~26@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ d3~32@))) (Mul (Mul b3~28@ (Mul c3~30@ b3~28@)) (Mul (Mul b3~28@ d3~32@) (Mul d3~32@ b3~28@)))) (Mul (Add (Mul (Mul 68 a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Sub b3~28@ a3~26@))) d3~32@)))) (=> (= temp_3_1~1712@ (Mul (Mul (Sub (Mul (Add (Mul a3~26@ d3~32@) (Mul a3~26@ c3~30@)) a3~26@) (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@)) (Mul b3~28@ (Add a3~26@ c3~30@)))) (Sub (Add (Mul (Sub c3~30@ b3~28@) (Mul b3~28@ a3~26@)) (Mul a3~26@ (Mul b3~28@ b3~28@))) (Sub (Mul (Add d3~32@ d3~32@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ b3~28@) b3~28@)))) (Mul (Mul (Mul (Add (Mul c3~30@ b3~28@) (Sub c3~30@ a3~26@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ d3~32@))) (Mul (Mul b3~28@ (Mul c3~30@ b3~28@)) (Mul (Mul b3~28@ d3~32@) (Mul d3~32@ b3~28@)))) (Mul (Add (Mul (Mul 68 a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ c3~30@) (Sub b3~28@ a3~26@))) d3~32@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1499@ temp_3_1~1712@))) (=> (= temp_3_0~1499@ temp_3_1~1712@) (=> (= temp_4_0~1929@ (Mul (Mul (Add (Mul a4~34@ (Sub (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@))) (Sub (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ d4~40@)) d4~40@)) (Mul b4~36@ (Add (Mul (Mul b4~36@ c4~38@) b4~36@) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@))))) (Mul (Mul (Mul (Add (Sub a4~34@ d4~40@) (Mul d4~40@ c4~38@)) (Add (Mul c4~38@ a4~34@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul c4~38@ a4~34@) (Mul 96 a4~34@)) (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)))) (Mul (Mul (Add (Mul d4~40@ d4~40@) (Mul a4~34@ b4~36@)) (Mul b4~36@ (Mul c4~38@ a4~34@))) (Mul (Mul (Mul d4~40@ b4~36@) b4~36@) a4~34@))))) (=> (= temp_4_1~2122@ (Mul (Mul (Add (Mul a4~34@ (Sub (Mul b4~36@ b4~36@) (Mul d4~40@ c4~38@))) (Sub (Mul (Mul b4~36@ a4~34@) (Mul a4~34@ d4~40@)) d4~40@)) (Mul b4~36@ (Add (Mul (Mul b4~36@ c4~38@) b4~36@) (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@))))) (Mul (Mul (Mul (Add (Sub a4~34@ d4~40@) (Mul d4~40@ c4~38@)) (Add (Mul c4~38@ a4~34@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul 96 a4~34@)) (Mul (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)))) (Mul (Mul (Add (Mul d4~40@ d4~40@) (Mul a4~34@ b4~36@)) (Mul b4~36@ (Mul c4~38@ a4~34@))) (Mul (Mul (Mul d4~40@ b4~36@) b4~36@) a4~34@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~1929@ temp_4_1~2122@))) (=> (= temp_4_0~1929@ temp_4_1~2122@) (=> (= temp_5_0~2391@ (Mul (Mul (Sub (Add (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@)) (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ b5~44@))) (Sub c5~46@ (Add (Sub b5~44@ c5~46@) (Mul b5~44@ c5~46@)))) (Mul (Mul (Mul b5~44@ b5~44@) (Add (Mul b5~44@ 52) (Sub a5~42@ a5~42@))) (Mul (Sub (Mul d5~48@ d5~48@) (Mul a5~42@ a5~42@)) (Add (Mul c5~46@ d5~48@) (Mul b5~44@ a5~42@))))) (Mul (Mul (Mul a5~42@ (Mul (Mul d5~48@ b5~44@) (Add b5~44@ c5~46@))) (Mul (Mul (Mul b5~44@ b5~44@) (Sub c5~46@ c5~46@)) (Mul (Add a5~42@ d5~48@) (Sub b5~44@ b5~44@)))) (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@)) (Mul (Mul c5~46@ d5~48@) a5~42@)) (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ 97)) (Mul (Mul b5~44@ c5~46@) (Add b5~44@ c5~46@))))))) (=> (= temp_5_1~2636@ (Mul (Mul (Sub (Add (Mul (Mul d5~48@ c5~46@) (Mul c5~46@ c5~46@)) (Mul (Mul a5~42@ a5~42@) (Mul b5~44@ b5~44@))) (Sub c5~46@ (Add (Sub b5~44@ c5~46@) (Mul b5~44@ c5~46@)))) (Mul (Mul (Mul b5~44@ b5~44@) (Add (Mul b5~44@ 52) (Sub a5~42@ a5~42@))) (Mul (Sub (Mul d5~48@ d5~48@) (Mul a5~42@ a5~42@)) (Add (Mul c5~46@ d5~48@) (Mul b5~44@ a5~42@))))) (Mul (Mul (Mul a5~42@ (Mul (Mul d5~48@ b5~44@) (Add b5~44@ c5~46@))) (Mul (Mul (Mul b5~44@ b5~44@) (Sub c5~46@ c5~46@)) (Mul (Add a5~42@ d5~48@) (Sub b5~44@ b5~44@)))) (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ d5~48@) a5~42@)) (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ 97)) (Mul (Mul b5~44@ c5~46@) (Add b5~44@ c5~46@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2391@ temp_5_1~2636@))) (=> (= temp_5_0~2391@ temp_5_1~2636@) (=> (= temp_6_0~2881@ (Mul (Mul (Mul (Mul a6~50@ (Mul (Mul c6~54@ b6~52@) a6~50@)) (Mul (Mul (Add c6~54@ c6~54@) a6~50@) (Mul (Mul b6~52@ a6~50@) (Sub b6~52@ c6~54@)))) (Mul (Sub (Mul (Mul a6~50@ d6~56@) a6~50@) (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ c6~54@))) (Sub (Sub (Mul b6~52@ d6~56@) (Mul a6~50@ b6~52@)) (Mul b6~52@ (Mul a6~50@ a6~50@))))) (Mul (Sub (Mul (Add (Mul b6~52@ b6~52@) (Sub d6~56@ b6~52@)) (Mul (Mul a6~50@ d6~56@) (Add d6~56@ d6~56@))) (Mul (Mul (Add b6~52@ a6~50@) (Mul b6~52@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ d6~56@)))) (Mul (Mul (Add (Mul c6~54@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Add b6~52@ c6~54@))) (Mul (Mul b6~52@ (Mul b6~52@ a6~50@)) (Sub (Mul a6~50@ d6~56@) b6~52@)))))) (=> (= temp_6_1~3102@ (Mul (Mul (Mul (Mul a6~50@ (Mul (Mul c6~54@ b6~52@) a6~50@)) (Mul (Mul (Add c6~54@ c6~54@) a6~50@) (Mul (Mul b6~52@ a6~50@) (Sub b6~52@ c6~54@)))) (Mul (Sub (Mul (Mul a6~50@ d6~56@) a6~50@) (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ c6~54@))) (Sub (Sub (Mul b6~52@ d6~56@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ a6~50@) b6~52@)))) (Mul (Sub (Mul (Add (Mul b6~52@ b6~52@) (Sub d6~56@ b6~52@)) (Mul (Mul a6~50@ d6~56@) (Add d6~56@ d6~56@))) (Mul (Mul (Add b6~52@ a6~50@) (Mul b6~52@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul d6~56@ d6~56@)))) (Mul (Mul (Add (Mul c6~54@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul a6~50@ a6~50@) (Add b6~52@ c6~54@))) (Mul (Mul b6~52@ (Mul b6~52@ a6~50@)) (Sub (Mul a6~50@ d6~56@) b6~52@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~2881@ temp_6_1~3102@))) (=> (= temp_6_0~2881@ temp_6_1~3102@) (=> (= temp_7_0~3307@ (Mul (Mul (Add (Sub (Add (Mul b7~60@ c7~62@) (Add c7~62@ a7~58@)) (Mul d7~64@ (Sub a7~58@ c7~62@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@)))) (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ a7~58@)) (Mul (Mul d7~64@ b7~60@) d7~64@)) (Mul (Mul (Mul a7~58@ a7~58@) d7~64@) (Mul a7~58@ (Mul d7~64@ a7~58@))))) (Mul c7~62@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul 83 c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@)) b7~60@))))) (=> (= temp_7_1~3488@ (Mul (Mul (Add (Sub (Add (Mul b7~60@ c7~62@) (Add c7~62@ a7~58@)) (Mul d7~64@ (Sub a7~58@ c7~62@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)) (Mul (Mul b7~60@ c7~62@) (Mul b7~60@ d7~64@)))) (Mul (Mul (Mul (Mul (Mul b7~60@ b7~60@) d7~64@) a7~58@) (Mul (Mul d7~64@ b7~60@) d7~64@)) (Mul (Mul (Mul a7~58@ a7~58@) d7~64@) (Mul a7~58@ (Mul d7~64@ a7~58@))))) (Mul c7~62@ (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul 83 c7~62@)) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ d7~64@)) b7~60@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3307@ temp_7_1~3488@))) (=> (= temp_7_0~3307@ temp_7_1~3488@) (=> (= temp_8_0~3737@ (Mul (Add (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ c8~70@)) (Sub (Mul a8~66@ d8~72@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ b8~68@)))) (Mul a8~66@ (Mul (Mul b8~68@ (Mul b8~68@ b8~68@)) (Mul (Sub c8~70@ d8~72@) (Sub d8~72@ c8~70@))))) (Sub (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Add a8~66@ 84) (Mul a8~66@ c8~70@))) (Add (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ a8~66@)) (Mul c8~70@ (Mul d8~72@ b8~68@)))) (Mul (Mul (Mul (Sub b8~68@ b8~68@) (Mul a8~66@ c8~70@)) (Sub c8~70@ (Mul b8~68@ b8~68@))) (Mul (Mul d8~72@ (Add a8~66@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@))))))) (=> (= temp_8_1~3962@ (Mul (Add (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul c8~70@ c8~70@)) (Sub (Mul a8~66@ d8~72@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul a8~66@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ b8~68@)))) (Mul a8~66@ (Mul (Mul b8~68@ (Mul b8~68@ b8~68@)) (Mul (Sub c8~70@ d8~72@) (Sub d8~72@ c8~70@))))) (Sub (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul a8~66@ c8~70@)) (Mul (Add a8~66@ 84) (Mul a8~66@ c8~70@))) (Add (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ a8~66@)) (Mul c8~70@ (Mul d8~72@ b8~68@)))) (Mul (Mul (Mul (Sub b8~68@ b8~68@) (Mul a8~66@ c8~70@)) (Sub c8~70@ (Mul b8~68@ b8~68@))) (Mul (Mul d8~72@ (Add a8~66@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ c8~70@))))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~3737@ temp_8_1~3962@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
