...
(declare-const temp_2_1~1454@ Int)
(declare-const temp_3_0~1583@ Int)
(declare-const temp_3_1~1688@ Int)
(declare-const temp_4_0~1933@ Int)
(declare-const temp_4_1~2154@ Int)
(declare-const temp_5_0~2367@ Int)
(declare-const temp_5_1~2556@ Int)
(declare-const temp_6_0~2741@ Int)
(declare-const temp_6_1~2902@ Int)
(declare-const temp_7_0~3179@ Int)
(declare-const temp_7_1~3432@ Int)
(declare-const temp_8_0~3689@ Int)
(declare-const temp_8_1~3922@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Mul (Sub a0~2@ (Mul (Mul (Mul (Mul 23 d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@))))) (Add (Add (Mul (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Sub b0~4@ c0~6@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ c0~6@)))) (Sub (Mul (Sub (Mul a0~2@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Sub 22 c0~6@))) (Mul c0~6@ (Mul (Add a0~2@ d0~8@) (Mul c0~6@ d0~8@))))))) (=> (= temp_0_1~498@ (Mul (Sub a0~2@ (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Mul 23 d0~8@)) (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ a0~2@))) (Mul (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ d0~8@))))) (Add (Add (Mul (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ d0~8@)) (Mul (Sub b0~4@ c0~6@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ c0~6@)))) (Sub (Mul (Sub (Mul a0~2@ b0~4@) (Mul a0~2@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Sub 22 c0~6@))) (Mul c0~6@ (Mul (Add a0~2@ d0~8@) (Mul c0~6@ d0~8@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~498@))) (=> (= temp_0_0~289@ temp_0_1~498@) (=> (= temp_1_0~759@ (Add (Mul (Mul (Mul (Add (Sub c1~14@ b1~12@) (Mul d1~16@ b1~12@)) (Mul c1~14@ (Mul d1~16@ b1~12@))) (Mul b1~12@ (Mul (Sub d1~16@ b1~12@) (Mul a1~10@ d1~16@)))) (Mul (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ d1~16@))) (Add (Mul (Sub a1~10@ b1~12@) c1~14@) (Sub b1~12@ (Mul 44 b1~12@))))) (Sub (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ d1~16@))) (Mul c1~14@ (Mul c1~14@ (Mul a1~10@ d1~16@)))) (Mul (Add (Mul (Mul b1~12@ b1~12@) (Add c1~14@ c1~14@)) (Mul (Mul a1~10@ a1~10@) d1~16@)) (Add (Mul (Sub a1~10@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul 92 d1~16@) (Mul c1~14@ c1~14@))))))) (=> (= temp_1_1~996@ (Add (Mul (Mul (Mul (Add (Sub c1~14@ b1~12@) (Mul d1~16@ b1~12@)) (Mul c1~14@ (Mul d1~16@ b1~12@))) (Mul b1~12@ (Mul (Sub d1~16@ b1~12@) (Mul a1~10@ d1~16@)))) (Mul (Mul (Mul (Mul c1~14@ c1~14@) (Mul d1~16@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ d1~16@))) (Add (Mul (Sub a1~10@ b1~12@) c1~14@) (Sub b1~12@ (Mul 44 b1~12@))))) (Sub (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ d1~16@))) (Mul c1~14@ (Mul c1~14@ (Mul a1~10@ d1~16@)))) (Mul (Add (Mul (Mul b1~12@ b1~12@) (Add c1~14@ c1~14@)) (Mul (Mul a1~10@ a1~10@) d1~16@)) (Add (Mul (Sub a1~10@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul 92 d1~16@) (Mul c1~14@ c1~14@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~759@ temp_1_1~996@))) (=> (= temp_1_0~759@ temp_1_1~996@) (=> (= temp_2_0~1237@ (Sub (Mul (Mul (Mul (Mul (Mul c2~22@ b2~20@) d2~24@) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ b2~20@))) (Sub (Mul (Mul c2~22@ a2~18@) (Add d2~24@ b2~20@)) (Mul (Add a2~18@ a2~18@) (Mul b2~20@ d2~24@)))) (Mul (Mul (Mul b2~20@ (Sub c2~22@ d2~24@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ d2~24@))) (Mul (Mul (Sub b2~20@ 0) d2~24@) (Mul (Add b2~20@ a2~18@) (Mul b2~20@ d2~24@))))) (Mul (Add (Mul (Mul b2~20@ (Sub a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@))) (Mul c2~22@ c2~22@)) (Mul (Sub (Sub (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul a2~18@ a2~18@) a2~18@)) (Mul (Mul (Mul d2~24@ d2~24@) (Mul a2~18@ a2~18@)) (Sub b2~20@ a2~18@)))))) (=> (= temp_2_1~1454@ (Sub (Mul (Mul (Mul (Mul (Mul c2~22@ b2~20@) d2~24@) (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ b2~20@))) (Sub (Mul (Mul c2~22@ a2~18@) (Add d2~24@ b2~20@)) (Mul (Add a2~18@ a2~18@) (Mul b2~20@ d2~24@)))) (Mul (Mul (Mul b2~20@ (Sub c2~22@ d2~24@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ d2~24@))) (Mul (Mul (Sub b2~20@ 0) d2~24@) (Mul (Add b2~20@ a2~18@) (Mul b2~20@ d2~24@))))) (Mul (Add (Mul (Mul b2~20@ (Sub a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Mul d2~24@ b2~20@))) (Mul c2~22@ c2~22@)) (Mul (Sub (Sub (Mul b2~20@ a2~18@) (Mul b2~20@ a2~18@)) (Mul (Mul a2~18@ a2~18@) a2~18@)) (Mul (Mul (Mul (Mul d2~24@ d2~24@) a2~18@) a2~18@) (Sub b2~20@ a2~18@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1237@ temp_2_1~1454@))) (=> (= temp_2_0~1237@ temp_2_1~1454@) (=> (= temp_3_0~1583@ (Mul (Mul (Mul (Mul (Add (Mul d3~32@ a3~26@) (Sub a3~26@ c3~30@)) (Add (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@)) (Add (Sub d3~32@ b3~28@) (Mul c3~30@ a3~26@)))) d3~32@) (Mul c3~30@ (Mul (Mul (Add (Mul b3~28@ a3~26@) d3~32@) (Mul (Add c3~30@ d3~32@) (Mul d3~32@ a3~26@))) a3~26@)))) (=> (= temp_3_1~1688@ (Mul (Mul (Mul (Mul (Add (Mul d3~32@ a3~26@) (Sub a3~26@ c3~30@)) (Add (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@)) (Add (Sub d3~32@ b3~28@) (Mul c3~30@ a3~26@)))) d3~32@) (Mul c3~30@ (Mul (Mul (Mul (Add c3~30@ d3~32@) (Mul d3~32@ a3~26@)) (Add (Mul b3~28@ a3~26@) d3~32@)) a3~26@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1583@ temp_3_1~1688@))) (=> (= temp_3_0~1583@ temp_3_1~1688@) (=> (= temp_4_0~1933@ (Mul (Add (Mul (Mul (Add (Mul d4~40@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Sub d4~40@ a4~34@))) (Mul (Mul (Add c4~38@ d4~40@) (Mul a4~34@ a4~34@)) b4~36@)) (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@)) (Sub (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ d4~40@)) (Mul (Add a4~34@ d4~40@) (Mul b4~36@ a4~34@))))) (Mul (Add (Mul (Mul (Add b4~36@ a4~34@) (Mul a4~34@ b4~36@)) (Mul d4~40@ (Sub b4~36@ a4~34@))) (Add (Mul (Mul 4 b4~36@) d4~40@) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@)))) (Mul (Mul a4~34@ b4~36@) (Mul (Mul (Add a4~34@ d4~40@) a4~34@) (Add (Add b4~36@ c4~38@) (Mul c4~38@ c4~38@))))))) (=> (= temp_4_1~2154@ (Mul (Add (Mul (Mul (Add (Mul d4~40@ b4~36@) (Mul a4~34@ a4~34@)) (Mul (Mul b4~36@ a4~34@) (Sub d4~40@ a4~34@))) (Mul (Mul (Add c4~38@ d4~40@) (Mul a4~34@ a4~34@)) b4~36@)) (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@)) (Sub (Mul c4~38@ d4~40@) (Mul c4~38@ d4~40@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ d4~40@)) (Mul (Add a4~34@ d4~40@) (Mul a4~34@ b4~36@))))) (Mul (Add (Mul (Mul (Add b4~36@ a4~34@) (Mul a4~34@ b4~36@)) (Mul d4~40@ (Sub b4~36@ a4~34@))) (Add (Mul (Mul 4 b4~36@) d4~40@) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@)))) (Mul (Mul a4~34@ b4~36@) (Mul (Mul (Add a4~34@ d4~40@) a4~34@) (Add (Add b4~36@ c4~38@) (Mul c4~38@ c4~38@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~1933@ temp_4_1~2154@))) (=> (= temp_4_0~1933@ temp_4_1~2154@) (=> (= temp_5_0~2367@ (Mul (Mul b5~44@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Add b5~44@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ b5~44@)) (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ b5~44@))))) (Add (Mul (Add (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Sub c5~46@ b5~44@))) (Mul (Mul a5~42@ (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@)))) (Mul (Mul (Mul b5~44@ (Mul b5~44@ b5~44@)) (Mul (Add a5~42@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@)) (Sub (Add b5~44@ c5~46@) (Mul c5~46@ b5~44@))))))) (=> (= temp_5_1~2556@ (Mul (Mul b5~44@ (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Add b5~44@ d5~48@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Mul c5~46@ (Mul d5~48@ (Mul d5~48@ b5~44@))) (Mul (Mul d5~48@ b5~44@) (Mul b5~44@ b5~44@))))) (Add (Mul (Add (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ a5~42@)) (Mul (Mul a5~42@ c5~46@) (Sub c5~46@ b5~44@))) (Mul (Mul a5~42@ (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ a5~42@)))) (Mul (Mul (Mul b5~44@ (Mul b5~44@ b5~44@)) (Mul (Add a5~42@ a5~42@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul d5~48@ d5~48@)) (Sub (Add b5~44@ c5~46@) (Mul c5~46@ b5~44@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2367@ temp_5_1~2556@))) (=> (= temp_5_0~2367@ temp_5_1~2556@) (=> (= temp_6_0~2741@ (Mul (Mul (Sub d6~56@ (Add (Add (Mul b6~52@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Sub a6~50@ b6~52@) (Mul c6~54@ b6~52@)))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ c6~54@))) (Sub (Mul (Add d6~56@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@))))) (Sub (Add (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ d6~56@)) (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ d6~56@))) (Mul (Mul (Add a6~50@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Mul d6~56@ a6~50@)))) a6~50@))) (=> (= temp_6_1~2902@ (Mul (Mul (Sub d6~56@ (Add (Add (Mul b6~52@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Sub a6~50@ b6~52@) (Mul c6~54@ b6~52@)))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul (Mul d6~56@ a6~50@) (Mul c6~54@ a6~50@))) (Sub (Mul (Add d6~56@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@))))) (Sub (Add (Mul (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ d6~56@)) (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ d6~56@))) (Mul (Mul (Add a6~50@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Mul d6~56@ a6~50@)))) a6~50@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~2741@ temp_6_1~2902@))) (=> (= temp_6_0~2741@ temp_6_1~2902@) (=> (= temp_7_0~3179@ (Add (Mul (Mul (Mul (Sub (Mul d7~64@ a7~58@) (Mul b7~60@ b7~60@)) (Add (Mul a7~58@ d7~64@) (Sub d7~64@ d7~64@))) (Add (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@)) (Mul 6 (Mul b7~60@ d7~64@)))) (Add (Add (Sub (Sub a7~58@ a7~58@) (Mul a7~58@ c7~62@)) (Mul a7~58@ (Mul c7~62@ c7~62@))) (Mul (Sub (Mul b7~60@ b7~60@) (Mul d7~64@ c7~62@)) (Mul d7~64@ (Mul d7~64@ b7~60@))))) (Mul (Add (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ 68) (Mul b7~60@ b7~60@))) (Mul (Sub (Mul a7~58@ a7~58@) a7~58@) (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)))) (Sub (Mul (Mul (Sub d7~64@ d7~64@) (Add d7~64@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ d7~64@))) (Mul b7~60@ (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ a7~58@))))))) (=> (= temp_7_1~3432@ (Add (Mul (Mul (Mul (Sub (Mul d7~64@ a7~58@) (Mul b7~60@ b7~60@)) (Add (Mul a7~58@ d7~64@) (Sub d7~64@ d7~64@))) (Add (Mul (Mul a7~58@ b7~60@) (Mul a7~58@ a7~58@)) (Mul 6 (Mul b7~60@ d7~64@)))) (Add (Add (Sub (Sub a7~58@ a7~58@) (Mul a7~58@ c7~62@)) (Mul a7~58@ (Mul c7~62@ c7~62@))) (Mul (Sub (Mul b7~60@ b7~60@) (Mul d7~64@ c7~62@)) (Mul d7~64@ (Mul d7~64@ b7~60@))))) (Mul (Add (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ 68) (Mul b7~60@ b7~60@))) (Mul (Sub (Mul a7~58@ a7~58@) a7~58@) (Sub (Mul b7~60@ a7~58@) (Mul c7~62@ b7~60@)))) (Sub (Mul (Mul (Sub d7~64@ d7~64@) (Add d7~64@ c7~62@)) (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ d7~64@))) (Mul b7~60@ (Mul (Mul c7~62@ d7~64@) (Mul c7~62@ a7~58@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3179@ temp_7_1~3432@))) (=> (= temp_7_0~3179@ temp_7_1~3432@) (=> (= temp_8_0~3689@ (Mul (Mul (Mul (Sub (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Add b8~68@ c8~70@) (Mul a8~66@ b8~68@))) (Mul (Sub (Mul b8~68@ a8~66@) c8~70@) (Mul (Sub c8~70@ b8~68@) (Mul b8~68@ b8~68@)))) (Sub (Mul (Add (Mul c8~70@ b8~68@) (Mul b8~68@ c8~70@)) (Mul a8~66@ (Mul d8~72@ b8~68@))) (Mul (Mul (Add a8~66@ a8~66@) (Mul c8~70@ d8~72@)) b8~68@))) (Mul (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Add b8~68@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@))) (Mul (Mul (Sub c8~70@ c8~70@) c8~70@) (Add (Add b8~68@ b8~68@) (Mul b8~68@ c8~70@)))) (Sub (Mul (Mul (Mul a8~66@ c8~70@) (Add c8~70@ b8~68@)) (Mul (Sub a8~66@ d8~72@) (Mul b8~68@ d8~72@))) (Add (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@))))))) (=> (= temp_8_1~3922@ (Mul (Mul (Mul (Mul (Mul (Mul a8~66@ b8~68@) (Add b8~68@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ d8~72@))) (Mul (Mul (Sub c8~70@ c8~70@) c8~70@) (Add (Add b8~68@ b8~68@) (Mul b8~68@ c8~70@)))) (Sub (Mul (Mul (Mul a8~66@ c8~70@) (Add c8~70@ b8~68@)) (Mul (Sub a8~66@ d8~72@) (Mul b8~68@ d8~72@))) (Add (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ b8~68@))))) (Mul (Mul (Sub (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Add b8~68@ c8~70@) (Mul a8~66@ b8~68@))) (Mul (Sub (Mul b8~68@ a8~66@) c8~70@) (Mul (Sub c8~70@ b8~68@) (Mul b8~68@ b8~68@)))) (Sub (Mul (Add (Mul c8~70@ b8~68@) (Mul b8~68@ c8~70@)) (Mul a8~66@ (Mul d8~72@ b8~68@))) (Mul (Mul (Add a8~66@ a8~66@) (Mul c8~70@ d8~72@)) b8~68@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~3689@ temp_8_1~3922@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
