...
(set-info :comment ";; mariposa_data/6//10345049608418543150/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~743@ Int)
(declare-const temp_1_1~972@ Int)
(declare-const temp_2_0~1225@ Int)
(declare-const temp_2_1~1450@ Int)
(declare-const temp_3_0~1707@ Int)
(declare-const temp_3_1~1936@ Int)
(declare-const temp_4_0~2269@ Int)
(declare-const temp_4_1~2466@ Int)
(declare-const temp_5_0~2733@ Int)
(declare-const temp_5_1~2970@ Int)
(declare-const temp_6_0~3243@ Int)
(declare-const temp_6_1~3480@ Int)
(declare-const temp_7_0~3845@ Int)
(declare-const temp_7_1~4082@ Int)
(declare-const temp_8_0~4253@ Int)
(declare-const temp_8_1~4390@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~257@ (Mul (Mul (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@))) (Mul (Add (Mul d0~8@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Add a0~2@ a0~2@) c0~6@))) (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ b0~4@)) (Mul (Add b0~4@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul a0~2@ (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul a0~2@ d0~8@))))) (Mul (Mul (Sub (Mul d0~8@ (Mul d0~8@ c0~6@)) d0~8@) (Mul c0~6@ (Add (Mul d0~8@ b0~4@) (Sub c0~6@ b0~4@)))) (Sub (Mul (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ c0~6@)) a0~2@) b0~4@)))) (=> (= temp_0_1~434@ (Mul (Mul (Mul (Mul (Add (Mul d0~8@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Add a0~2@ a0~2@) c0~6@)) (Mul (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@)))) (Mul (Mul (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ b0~4@)) (Mul (Add b0~4@ a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul a0~2@ (Mul d0~8@ a0~2@)) (Mul d0~8@ (Mul a0~2@ d0~8@))))) (Mul (Mul (Sub (Mul d0~8@ (Mul d0~8@ c0~6@)) d0~8@) (Mul c0~6@ (Add (Mul d0~8@ b0~4@) (Sub c0~6@ b0~4@)))) (Sub (Mul (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ c0~6@)) a0~2@) b0~4@)))) (and (=> (= tmp%1@ (Mul (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Mul d0~8@ c0~6@)))) (=> (= tmp%2@ (Mul (Add (Mul d0~8@ a0~2@) (Mul b0~4@ b0~4@)) (Mul (Add a0~2@ a0~2@) c0~6@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%0 (= temp_0_0~257@ temp_0_1~434@))))) (=> (= temp_0_0~257@ temp_0_1~434@) (=> (= temp_1_0~743@ (Mul (Mul (Mul (Add a1~10@ (Mul (Add c1~14@ b1~12@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul b1~12@ a1~10@) (Sub a1~10@ c1~14@)) (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ c1~14@)))) (Mul (Mul (Mul 86 (Sub d1~16@ b1~12@)) (Mul (Sub b1~12@ d1~16@) (Mul c1~14@ a1~10@))) (Mul (Mul (Add d1~16@ b1~12@) (Mul a1~10@ a1~10@)) a1~10@))) (Mul (Mul (Add (Mul (Mul 95 c1~14@) b1~12@) (Mul (Mul c1~14@ c1~14@) (Add a1~10@ d1~16@))) (Sub (Sub (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul c1~14@ (Mul d1~16@ d1~16@)))) (Add (Mul (Sub d1~16@ (Add a1~10@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@)) d1~16@))))) (=> (= temp_1_1~972@ (Mul (Mul (Mul (Add a1~10@ (Mul (Add c1~14@ b1~12@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul b1~12@ a1~10@) (Sub a1~10@ c1~14@)) (Mul (Mul b1~12@ a1~10@) (Mul a1~10@ c1~14@)))) (Mul (Mul (Mul 86 (Sub d1~16@ b1~12@)) (Mul (Sub b1~12@ d1~16@) (Mul c1~14@ a1~10@))) (Mul (Mul (Add d1~16@ b1~12@) (Mul a1~10@ a1~10@)) a1~10@))) (Mul (Mul (Add (Mul (Mul 95 c1~14@) b1~12@) (Mul (Mul c1~14@ c1~14@) (Add a1~10@ d1~16@))) (Sub (Sub (Mul b1~12@ b1~12@) (Mul a1~10@ c1~14@)) (Mul c1~14@ (Mul d1~16@ d1~16@)))) (Add (Mul (Sub d1~16@ (Add a1~10@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ b1~12@))) (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@)) d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ b1~12@) (=> %%location_label%%1 (= temp_1_0~743@ temp_1_1~972@))) (=> (= temp_1_0~743@ temp_1_1~972@) (=> (= temp_2_0~1225@ (Mul (Sub (Mul (Mul (Mul (Mul c2~22@ b2~20@) a2~18@) (Mul (Mul c2~22@ c2~22@) a2~18@)) (Mul (Mul (Add b2~20@ c2~22@) (Mul d2~24@ b2~20@)) (Mul d2~24@ (Mul c2~22@ d2~24@)))) (Sub (Mul (Mul a2~18@ b2~20@) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ c2~22@))))) (Mul (Mul (Mul (Mul (Add b2~20@ b2~20@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ (Sub b2~20@ a2~18@)))) (Add (Mul (Mul (Mul b2~20@ d2~24@) (Sub a2~18@ d2~24@)) (Mul (Mul d2~24@ c2~22@) (Sub b2~20@ d2~24@))) (Mul (Mul (Add a2~18@ c2~22@) (Mul 74 b2~20@)) c2~22@))))) (=> (= temp_2_1~1450@ (Mul (Sub (Mul (Mul (Mul (Mul c2~22@ b2~20@) a2~18@) (Mul (Mul c2~22@ c2~22@) a2~18@)) (Mul (Mul (Add b2~20@ c2~22@) (Mul d2~24@ b2~20@)) (Mul d2~24@ (Mul c2~22@ d2~24@)))) (Sub (Mul (Mul a2~18@ b2~20@) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ d2~24@))))) (Mul (Mul (Mul (Mul (Add b2~20@ b2~20@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ (Sub b2~20@ a2~18@)))) (Add (Mul (Mul (Mul b2~20@ d2~24@) (Sub a2~18@ d2~24@)) (Mul (Mul d2~24@ c2~22@) (Sub b2~20@ d2~24@))) (Mul (Mul (Add a2~18@ c2~22@) (Mul 74 b2~20@)) c2~22@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d2~24@ c2~22@) (=> %%location_label%%2 (= temp_2_0~1225@ temp_2_1~1450@))) (=> (= temp_2_0~1225@ temp_2_1~1450@) (=> (= temp_3_0~1707@ (Mul (Mul (Mul (Mul (Sub c3~30@ (Mul d3~32@ a3~26@)) (Mul (Mul a3~26@ b3~28@) d3~32@)) (Add (Mul b3~28@ (Mul a3~26@ c3~30@)) (Mul d3~32@ b3~28@))) (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ 13)) (Mul (Mul a3~26@ c3~30@) (Add d3~32@ a3~26@))) (Mul (Mul (Mul b3~28@ c3~30@) c3~30@) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@))))) (Mul (Mul (Mul a3~26@ (Mul (Add a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (Mul (Mul (Add d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ b3~28@)))) (Mul (Mul (Mul (Sub c3~30@ a3~26@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ a3~26@) c3~30@)) (Mul (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Sub b3~28@ a3~26@) (Add d3~32@ a3~26@))))))) (=> (= temp_3_1~1936@ (Mul (Mul (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ 13)) (Mul (Mul a3~26@ c3~30@) (Add d3~32@ a3~26@))) (Mul (Mul (Mul b3~28@ c3~30@) c3~30@) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@)))) (Mul (Mul (Sub c3~30@ (Mul d3~32@ a3~26@)) (Mul (Mul a3~26@ b3~28@) d3~32@)) (Add (Mul b3~28@ (Mul a3~26@ c3~30@)) (Mul d3~32@ b3~28@)))) (Mul (Mul (Mul a3~26@ (Mul (Add a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (Mul (Mul (Add d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul c3~30@ b3~28@)))) (Mul (Mul (Mul (Sub c3~30@ a3~26@) (Mul c3~30@ d3~32@)) (Mul (Mul d3~32@ a3~26@) c3~30@)) (Mul (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Sub b3~28@ a3~26@) (Add d3~32@ a3~26@))))))) (and (=> (= tmp%3@ (Mul (Mul (Sub c3~30@ (Mul d3~32@ a3~26@)) (Mul (Mul a3~26@ b3~28@) d3~32@)) (Add (Mul b3~28@ (Mul a3~26@ c3~30@)) (Mul d3~32@ b3~28@)))) (=> (= tmp%4@ (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ 13)) (Mul (Mul a3~26@ c3~30@) (Add d3~32@ a3~26@))) (Mul (Mul (Mul b3~28@ c3~30@) c3~30@) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ c3~30@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~1707@ temp_3_1~1936@))))) (=> (= temp_3_0~1707@ temp_3_1~1936@) (=> (= temp_4_0~2269@ (Mul (Mul (Mul (Mul (Mul b4~36@ (Mul d4~40@ d4~40@)) (Mul (Mul a4~34@ b4~36@) a4~34@)) (Sub (Mul (Mul c4~38@ a4~34@) (Sub a4~34@ a4~34@)) (Add (Mul a4~34@ c4~38@) b4~36@))) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Sub d4~40@ a4~34@)) b4~36@) c4~38@)) (Mul (Add (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ a4~34@)) (Add (Mul b4~36@ a4~34@) (Add d4~40@ b4~36@))) (Mul c4~38@ (Mul (Mul d4~40@ 59) (Mul c4~38@ a4~34@)))) (Sub (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ b4~36@)) (Mul b4~36@ (Add a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ c4~38@) b4~36@) (Mul (Sub b4~36@ a4~34@) (Mul a4~34@ d4~40@))))))) (=> (= temp_4_1~2466@ (Mul (Mul (Mul (Mul (Mul (Mul b4~36@ d4~40@) d4~40@) (Mul (Mul a4~34@ b4~36@) a4~34@)) (Sub (Mul (Mul c4~38@ a4~34@) (Sub a4~34@ a4~34@)) (Add (Mul a4~34@ c4~38@) b4~36@))) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Sub d4~40@ a4~34@)) b4~36@) c4~38@)) (Mul (Add (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ a4~34@)) (Add (Mul b4~36@ a4~34@) (Add d4~40@ b4~36@))) (Mul c4~38@ (Mul (Mul d4~40@ 59) (Mul c4~38@ a4~34@)))) (Sub (Mul (Mul (Mul d4~40@ b4~36@) (Mul b4~36@ b4~36@)) (Mul b4~36@ (Add a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ c4~38@) b4~36@) (Mul (Sub b4~36@ a4~34@) (Mul a4~34@ d4~40@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. b4~36@ d4~40@ d4~40@) (=> %%location_label%%4 (= temp_4_0~2269@ temp_4_1~2466@))) (=> (= temp_4_0~2269@ temp_4_1~2466@) (=> (= temp_5_0~2733@ (Mul (Add (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Mul c5~46@ d5~48@) d5~48@)) (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ a5~42@)) (Add (Mul d5~48@ c5~46@) (Mul 53 c5~46@)))) (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ c5~46@)) (Mul (Sub d5~48@ d5~48@) (Add b5~44@ c5~46@))) (Mul (Add (Mul b5~44@ b5~44@) (Mul d5~48@ b5~44@)) (Sub (Sub b5~44@ c5~46@) (Mul a5~42@ b5~44@))))) (Mul (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@)) (Add (Mul a5~42@ d5~48@) (Mul b5~44@ a5~42@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@)) a5~42@)) (Mul (Add (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul c5~46@ c5~46@) (Add d5~48@ c5~46@))) (Mul (Mul (Mul c5~46@ c5~46@) a5~42@) c5~46@))))) (=> (= temp_5_1~2970@ (Mul (Add (Mul (Sub (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ d5~48@)) (Mul (Mul c5~46@ d5~48@) d5~48@)) (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ a5~42@)) (Add (Mul d5~48@ c5~46@) (Mul 53 c5~46@)))) (Mul (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ c5~46@)) (Mul (Sub d5~48@ d5~48@) (Add b5~44@ c5~46@))) (Mul (Add (Mul b5~44@ b5~44@) (Mul d5~48@ b5~44@)) (Sub (Sub b5~44@ c5~46@) (Mul a5~42@ b5~44@))))) (Mul (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@)) (Add (Mul a5~42@ d5~48@) (Mul b5~44@ a5~42@))) (Mul (Sub (Mul b5~44@ c5~46@) (Mul a5~42@ c5~46@)) a5~42@)) (Mul (Add (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Add d5~48@ c5~46@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ c5~46@) a5~42@) c5~46@))))) (and (=> (= tmp%5@ (Mul c5~46@ c5~46@)) (=> (= tmp%6@ (Add d5~48@ c5~46@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%5 (= temp_5_0~2733@ temp_5_1~2970@))))) (=> (= temp_5_0~2733@ temp_5_1~2970@) (=> (= temp_6_0~3243@ (Add (Mul (Add (Mul (Mul (Mul c6~54@ a6~50@) b6~52@) (Mul c6~54@ (Mul b6~52@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ d6~56@)))) (Sub (Mul (Mul (Mul a6~50@ c6~54@) a6~50@) (Sub (Mul a6~50@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@)) (Add (Add b6~52@ a6~50@) (Mul b6~52@ c6~54@))))) (Mul (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul 89 a6~50@)) (Mul d6~56@ (Mul c6~54@ a6~50@))) (Mul (Mul (Mul a6~50@ d6~56@) d6~56@) b6~52@)) (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Sub b6~52@ c6~54@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ d6~56@))))))) (=> (= temp_6_1~3480@ (Add (Mul (Sub (Mul (Mul (Mul a6~50@ c6~54@) a6~50@) (Sub (Mul a6~50@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@)) (Add (Add b6~52@ a6~50@) (Mul b6~52@ c6~54@)))) (Add (Mul (Mul (Mul c6~54@ a6~50@) b6~52@) (Mul c6~54@ (Mul b6~52@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ d6~56@))))) (Mul (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul 89 a6~50@)) (Mul d6~56@ (Mul c6~54@ a6~50@))) (Mul (Mul (Mul a6~50@ d6~56@) d6~56@) b6~52@)) (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@)) (Mul (Sub b6~52@ c6~54@) (Mul b6~52@ a6~50@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ d6~56@))))))) (and (=> (= tmp%7@ (Add (Mul (Mul (Mul c6~54@ a6~50@) b6~52@) (Mul c6~54@ (Mul b6~52@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Mul a6~50@ d6~56@))))) (=> (= tmp%8@ (Sub (Mul (Mul (Mul a6~50@ c6~54@) a6~50@) (Sub (Mul a6~50@ a6~50@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@)) (Add (Add b6~52@ a6~50@) (Mul b6~52@ c6~54@))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~3243@ temp_6_1~3480@))))) (=> (= temp_6_0~3243@ temp_6_1~3480@) (=> (= temp_7_0~3845@ (Mul (Mul (Mul (Mul (Mul a7~58@ (Add a7~58@ d7~64@)) (Add (Mul a7~58@ d7~64@) d7~64@)) (Mul (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ d7~64@)) d7~64@)) (Mul (Mul (Sub (Mul a7~58@ c7~62@) (Mul d7~64@ a7~58@)) (Sub (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@))) (Mul b7~60@ (Mul b7~60@ (Mul d7~64@ d7~64@))))) (Mul (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)) (Sub (Mul b7~60@ a7~58@) (Mul d7~64@ c7~62@))) (Mul (Sub (Mul b7~60@ b7~60@) (Mul d7~64@ 85)) (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@)))) (Mul (Mul (Sub (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@)) (Mul (Add d7~64@ a7~58@) a7~58@)) (Mul (Mul (Mul c7~62@ b7~60@) (Sub d7~64@ d7~64@)) (Sub (Mul d7~64@ d7~64@) (Sub d7~64@ b7~60@))))))) (=> (= temp_7_1~4082@ (Mul (Mul (Mul (Mul (Mul a7~58@ (Add a7~58@ d7~64@)) (Add (Mul a7~58@ d7~64@) d7~64@)) (Mul (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ d7~64@)) d7~64@)) (Mul (Mul (Sub (Mul a7~58@ c7~62@) (Mul d7~64@ a7~58@)) (Sub (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@))) (Mul b7~60@ (Mul b7~60@ (Mul d7~64@ d7~64@))))) (Mul (Mul (Mul (Mul (Mul b7~60@ c7~62@) (Mul d7~64@ d7~64@)) (Sub (Mul b7~60@ a7~58@) (Mul d7~64@ c7~62@))) (Mul (Sub (Mul b7~60@ b7~60@) (Mul d7~64@ 85)) (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ a7~58@)))) (Mul (Mul (Sub (Mul b7~60@ c7~62@) (Mul b7~60@ b7~60@)) (Mul (Add d7~64@ a7~58@) a7~58@)) (Mul (Sub (Mul (Mul c7~62@ b7~60@) d7~64@) (Mul (Mul c7~62@ b7~60@) d7~64@)) (Sub (Mul d7~64@ d7~64@) (Sub d7~64@ b7~60@))))))) (and (=> (= tmp%9@ (Mul c7~62@ b7~60@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%9@ d7~64@ d7~64@) (=> %%location_label%%7 (= temp_7_0~3845@ temp_7_1~4082@)))) (=> (= temp_7_0~3845@ temp_7_1~4082@) (=> (= temp_8_0~4253@ (Mul b8~68@ (Mul (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul d8~72@ c8~70@) (Sub c8~70@ c8~70@))) (Sub (Mul (Mul d8~72@ d8~72@) c8~70@) (Mul (Mul b8~68@ a8~66@) d8~72@))) (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul 36 c8~70@)) (Mul (Add a8~66@ d8~72@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Sub c8~70@ b8~68@) (Mul d8~72@ a8~66@))))))) (=> (= temp_8_1~4390@ (Mul b8~68@ (Mul (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ b8~68@)) (Mul (Mul d8~72@ c8~70@) (Sub c8~70@ c8~70@))) (Sub (Mul (Mul d8~72@ d8~72@) c8~70@) (Mul (Mul b8~68@ a8~66@) d8~72@))) (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul 36 c8~70@)) (Mul (Add a8~66@ d8~72@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Sub c8~70@ b8~68@) (Mul d8~72@ a8~66@))))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. b8~68@ c8~70@) (=> %%location_label%%8 (= temp_8_0~4253@ temp_8_1~4390@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
