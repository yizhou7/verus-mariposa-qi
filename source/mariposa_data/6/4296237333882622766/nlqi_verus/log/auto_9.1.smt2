...
(declare-const temp_1_0~863@ Int)
(declare-const temp_1_1~1100@ Int)
(declare-const temp_2_0~1293@ Int)
(declare-const temp_2_1~1462@ Int)
(declare-const temp_3_0~1719@ Int)
(declare-const temp_3_1~1952@ Int)
(declare-const temp_4_0~2165@ Int)
(declare-const temp_4_1~2354@ Int)
(declare-const temp_5_0~2599@ Int)
(declare-const temp_5_1~2820@ Int)
(declare-const temp_6_0~3089@ Int)
(declare-const temp_6_1~3334@ Int)
(declare-const temp_7_0~3475@ Int)
(declare-const temp_7_1~3592@ Int)
(declare-const temp_8_0~3833@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~341@ (Mul (Mul (Mul (Mul (Sub (Mul a0~2@ c0~6@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Add c0~6@ b0~4@) (Add a0~2@ b0~4@)))) (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ d0~8@)) (Sub (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@))))) (Mul (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Sub b0~4@ b0~4@) (Mul a0~2@ 50))) (Mul (Sub (Mul d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul d0~8@ (Add a0~2@ b0~4@)))) (Add (Mul (Add a0~2@ (Mul 67 b0~4@)) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ c0~6@))))))) (=> (= temp_0_1~602@ (Mul (Mul (Mul (Mul (Sub (Mul a0~2@ c0~6@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ d0~8@) (Mul a0~2@ a0~2@))) (Mul (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Add c0~6@ b0~4@) (Add a0~2@ b0~4@)))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul b0~4@ d0~8@)) (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ c0~6@)) (Mul (Mul (Mul c0~6@ d0~8@) (Mul d0~8@ d0~8@)) (Sub (Mul a0~2@ b0~4@) (Mul b0~4@ c0~6@)))))) (Mul (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ d0~8@)) (Mul (Sub b0~4@ b0~4@) (Mul a0~2@ 50))) (Mul (Sub (Mul d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul d0~8@ (Add a0~2@ b0~4@)))) (Add (Mul (Add a0~2@ (Mul 67 b0~4@)) (Mul a0~2@ b0~4@)) (Mul (Mul a0~2@ (Mul b0~4@ a0~2@)) (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ c0~6@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~341@ temp_0_1~602@))) (=> (= temp_0_0~341@ temp_0_1~602@) (=> (= temp_1_0~863@ (Sub (Mul (Add (Sub (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul 46 d1~16@) (Mul d1~16@ b1~12@))) (Mul (Sub (Mul c1~14@ b1~12@) (Mul b1~12@ a1~10@)) (Sub (Mul c1~14@ a1~10@) d1~16@))) (Sub (Mul (Mul (Mul c1~14@ d1~16@) (Sub c1~14@ c1~14@)) (Add (Mul c1~14@ c1~14@) (Mul a1~10@ b1~12@))) a1~10@)) (Mul (Mul (Mul (Sub (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Add (Mul a1~10@ d1~16@) (Add a1~10@ b1~12@))) (Mul (Sub (Mul a1~10@ d1~16@) (Add c1~14@ a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)))) (Mul (Mul (Mul (Mul d1~16@ b1~12@) (Mul d1~16@ a1~10@)) (Sub (Mul d1~16@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Add b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Sub d1~16@ b1~12@))))))) (=> (= temp_1_1~1100@ (Sub (Mul (Add (Sub (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@)) (Mul (Mul 46 d1~16@) (Mul d1~16@ b1~12@))) (Mul (Sub (Mul c1~14@ b1~12@) (Mul b1~12@ a1~10@)) (Sub (Mul c1~14@ a1~10@) d1~16@))) (Sub (Mul (Mul (Mul c1~14@ d1~16@) (Sub c1~14@ c1~14@)) (Add (Mul c1~14@ c1~14@) (Mul a1~10@ b1~12@))) a1~10@)) (Mul (Mul (Mul (Sub (Mul b1~12@ b1~12@) (Mul d1~16@ b1~12@)) (Add (Mul a1~10@ d1~16@) (Add a1~10@ b1~12@))) (Mul (Sub (Mul a1~10@ d1~16@) (Add c1~14@ a1~10@)) (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ d1~16@)))) (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@)) (Sub (Mul d1~16@ a1~10@) (Mul c1~14@ a1~10@))) (Mul (Mul (Add b1~12@ c1~14@) (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Sub d1~16@ b1~12@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~863@ temp_1_1~1100@))) (=> (= temp_1_0~863@ temp_1_1~1100@) (=> (= temp_2_0~1293@ (Sub (Mul (Mul (Mul a2~18@ (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@))) d2~24@) (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ d2~24@) a2~18@) d2~24@))) (Mul (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@))) b2~20@) (Mul (Mul (Mul (Mul b2~20@ c2~22@) (Mul c2~22@ b2~20@)) (Sub (Mul d2~24@ a2~18@) (Sub a2~18@ d2~24@))) (Mul (Mul a2~18@ (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@))))))) (=> (= temp_2_1~1462@ (Sub (Mul (Mul (Mul a2~18@ (Mul (Mul d2~24@ c2~22@) (Mul d2~24@ d2~24@))) d2~24@) (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@)) (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ d2~24@) a2~18@) d2~24@))) (Mul (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@))) b2~20@) (Mul (Mul (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ b2~20@)) (Sub (Mul d2~24@ a2~18@) (Sub a2~18@ d2~24@))) (Mul (Mul a2~18@ (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1293@ temp_2_1~1462@))) (=> (= temp_2_0~1293@ temp_2_1~1462@) (=> (= temp_3_0~1719@ (Mul (Add (Mul (Mul (Mul (Mul 31 d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (Mul b3~28@ (Mul (Sub c3~30@ a3~26@) (Mul a3~26@ a3~26@)))) (Mul (Sub (Mul (Mul c3~30@ b3~28@) (Add d3~32@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ d3~32@))) (Mul (Sub (Mul d3~32@ b3~28@) (Mul d3~32@ a3~26@)) (Add a3~26@ (Sub d3~32@ a3~26@))))) (Sub (Mul (Sub (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ b3~28@)) (Sub (Mul b3~28@ c3~30@) a3~26@)) (Mul (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@)) (Add (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@)))) (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@)) (Mul c3~30@ (Mul d3~32@ b3~28@))) (Add a3~26@ (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ b3~28@))))))) (=> (= temp_3_1~1952@ (Mul (Add (Mul (Mul (Mul (Mul 31 d3~32@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ b3~28@) (Mul d3~32@ b3~28@))) (Mul b3~28@ (Mul (Sub c3~30@ a3~26@) (Mul a3~26@ a3~26@)))) (Mul (Sub (Mul (Mul c3~30@ b3~28@) (Add d3~32@ d3~32@)) (Mul (Mul d3~32@ a3~26@) (Mul b3~28@ d3~32@))) (Mul (Sub (Mul d3~32@ b3~28@) (Mul d3~32@ a3~26@)) (Add a3~26@ (Sub d3~32@ a3~26@))))) (Sub (Mul (Sub (Mul (Mul d3~32@ a3~26@) (Mul d3~32@ b3~28@)) (Sub (Mul b3~28@ c3~30@) a3~26@)) (Mul (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@)) (Add (Mul c3~30@ d3~32@) (Mul b3~28@ a3~26@)))) (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ a3~26@)) (Mul c3~30@ (Mul d3~32@ b3~28@))) (Add a3~26@ (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ b3~28@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1719@ temp_3_1~1952@))) (=> (= temp_3_0~1719@ temp_3_1~1952@) (=> (= temp_4_0~2165@ (Mul (Mul (Mul b4~36@ (Add (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ a4~34@)) (Add (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@)))) (Sub (Mul (Add (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ a4~34@))) (Mul (Mul b4~36@ (Add d4~40@ c4~38@)) d4~40@))) (Add (Add (Mul (Mul (Sub b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Mul b4~36@ (Mul a4~34@ b4~36@))) (Mul (Mul b4~36@ (Mul a4~34@ c4~38@)) (Mul (Add b4~36@ b4~36@) (Mul b4~36@ c4~38@)))) (Mul (Mul (Add (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Sub d4~40@ (Mul a4~34@ b4~36@))) (Mul d4~40@ (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ a4~34@))))))) (=> (= temp_4_1~2354@ (Mul (Mul (Mul b4~36@ (Add (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ a4~34@)) (Add (Mul c4~38@ c4~38@) (Mul d4~40@ d4~40@)))) (Sub (Mul (Add (Mul d4~40@ c4~38@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ a4~34@))) (Mul (Mul b4~36@ (Add d4~40@ c4~38@)) d4~40@))) (Add (Add (Mul (Mul (Sub b4~36@ c4~38@) (Mul a4~34@ d4~40@)) (Mul b4~36@ (Mul a4~34@ b4~36@))) (Mul (Mul (Mul b4~36@ a4~34@) c4~38@) (Mul (Add b4~36@ b4~36@) (Mul b4~36@ c4~38@)))) (Mul (Mul (Add (Mul a4~34@ c4~38@) (Mul b4~36@ c4~38@)) (Sub d4~40@ (Mul a4~34@ b4~36@))) (Mul d4~40@ (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ a4~34@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~2165@ temp_4_1~2354@))) (=> (= temp_4_0~2165@ temp_4_1~2354@) (=> (= temp_5_0~2599@ (Mul (Mul (Mul (Mul (Mul (Add a5~42@ c5~46@) d5~48@) (Sub (Mul b5~44@ b5~44@) (Mul a5~42@ b5~44@))) (Mul d5~48@ (Sub (Mul b5~44@ 93) (Mul c5~46@ d5~48@)))) (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ a5~42@)) (Mul b5~44@ (Add b5~44@ 46))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)) a5~42@))) (Mul (Mul (Add (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ a5~42@) b5~44@)) (Sub (Sub (Add b5~44@ b5~44@) d5~48@) (Add a5~42@ (Mul a5~42@ d5~48@)))) (Mul d5~48@ (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ a5~42@)) (Mul (Mul 21 d5~48@) (Mul a5~42@ b5~44@))))))) (=> (= temp_5_1~2820@ (Mul (Mul (Mul (Mul (Mul (Add a5~42@ c5~46@) d5~48@) (Sub (Mul b5~44@ b5~44@) (Mul a5~42@ b5~44@))) (Mul d5~48@ (Sub (Mul b5~44@ 93) (Mul c5~46@ d5~48@)))) (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ a5~42@)) (Mul b5~44@ (Add b5~44@ 46))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)) a5~42@))) (Mul (Mul (Add (Mul (Mul b5~44@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ a5~42@) b5~44@)) (Sub (Sub (Add b5~44@ b5~44@) d5~48@) (Add a5~42@ (Mul a5~42@ d5~48@)))) (Mul d5~48@ (Mul (Mul (Mul (Mul b5~44@ d5~48@) a5~42@) a5~42@) (Mul (Mul 21 d5~48@) (Mul a5~42@ b5~44@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2599@ temp_5_1~2820@))) (=> (= temp_5_0~2599@ temp_5_1~2820@) (=> (= temp_6_0~3089@ (Mul (Mul (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@)) (Add b6~52@ (Mul b6~52@ a6~50@))) (Mul (Add (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ a6~50@)))) (Mul (Mul (Add (Mul d6~56@ c6~54@) (Mul b6~52@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ b6~52@))) (Sub (Mul (Mul c6~54@ a6~50@) d6~56@) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@))))) (Sub (Mul (Mul (Mul (Add c6~54@ c6~54@) (Mul b6~52@ b6~52@)) (Mul (Add a6~50@ c6~54@) (Add a6~50@ c6~54@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ b6~52@)))) (Sub (Mul (Sub (Add b6~52@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@))) (Mul (Add (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@)) (Mul d6~56@ (Mul c6~54@ d6~56@))))))) (=> (= temp_6_1~3334@ (Mul (Mul (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@)) (Add b6~52@ (Mul b6~52@ a6~50@))) (Mul (Add (Mul c6~54@ a6~50@) (Mul a6~50@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ a6~50@)))) (Mul (Mul (Add (Mul d6~56@ c6~54@) (Mul b6~52@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ b6~52@))) (Sub (Mul (Mul c6~54@ a6~50@) d6~56@) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@))))) (Sub (Mul (Mul (Mul (Add c6~54@ c6~54@) (Mul b6~52@ b6~52@)) (Mul (Add a6~50@ c6~54@) (Add a6~50@ c6~54@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul b6~52@ a6~50@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ b6~52@)))) (Sub (Mul (Sub (Add b6~52@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@))) (Mul (Add (Mul b6~52@ d6~56@) (Mul b6~52@ b6~52@)) (Mul d6~56@ (Mul c6~54@ d6~56@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~3089@ temp_6_1~3334@))) (=> (= temp_6_0~3089@ temp_6_1~3334@) (=> (= temp_7_0~3475@ (Add a7~58@ (Add (Mul d7~64@ (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@)) (Sub (Mul b7~60@ 95) (Mul c7~62@ b7~60@)))) (Mul (Mul (Sub (Mul b7~60@ b7~60@) (Mul a7~58@ d7~64@)) (Add (Mul b7~60@ d7~64@) (Mul a7~58@ c7~62@))) (Sub (Mul (Mul d7~64@ a7~58@) (Sub b7~60@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ c7~62@))))))) (=> (= temp_7_1~3592@ (Add a7~58@ (Add (Mul d7~64@ (Mul (Mul (Mul b7~60@ d7~64@) (Mul b7~60@ b7~60@)) (Sub (Mul b7~60@ 95) (Mul c7~62@ b7~60@)))) (Mul (Sub (Mul (Mul d7~64@ a7~58@) (Sub b7~60@ a7~58@)) (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ c7~62@))) (Mul (Sub (Mul b7~60@ b7~60@) (Mul a7~58@ d7~64@)) (Add (Mul b7~60@ d7~64@) (Mul a7~58@ c7~62@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3475@ temp_7_1~3592@))) (=> (= temp_7_0~3475@ temp_7_1~3592@) (=> (= temp_8_0~3833@ (Mul (Mul (Add (Add (Mul a8~66@ (Add d8~72@ b8~68@)) (Mul (Sub b8~68@ b8~68@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ b8~68@) c8~70@))) (Mul (Sub (Mul (Mul a8~66@ d8~72@) d8~72@) (Mul (Mul a8~66@ d8~72@) c8~70@)) (Sub (Add d8~72@ (Mul c8~70@ c8~70@)) a8~66@))) (Mul (Mul (Mul (Sub (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@)) (Sub (Sub b8~68@ d8~72@) (Mul c8~70@ c8~70@))) (Sub (Mul c8~70@ (Mul a8~66@ c8~70@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)))) (Mul (Add (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Sub a8~66@ d8~72@) (Mul c8~70@ b8~68@))) (Mul (Mul (Mul b8~68@ d8~72@) c8~70@) (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ d8~72@))))))) (=> (= temp_8_1~4050@ (Mul (Mul (Mul (Mul (Sub (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@)) (Sub (Sub b8~68@ d8~72@) (Mul c8~70@ c8~70@))) (Sub (Mul c8~70@ (Mul a8~66@ c8~70@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ c8~70@)))) (Mul (Add (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Sub a8~66@ d8~72@) (Mul c8~70@ b8~68@))) (Mul (Mul (Mul b8~68@ d8~72@) c8~70@) (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ d8~72@))))) (Mul (Add (Add (Mul a8~66@ (Add d8~72@ b8~68@)) (Mul (Sub b8~68@ b8~68@) (Mul a8~66@ d8~72@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ b8~68@) c8~70@))) (Mul (Sub (Mul (Mul a8~66@ d8~72@) d8~72@) (Mul (Mul a8~66@ d8~72@) c8~70@)) (Sub (Add d8~72@ (Mul c8~70@ c8~70@)) a8~66@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~3833@ temp_8_1~4050@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
