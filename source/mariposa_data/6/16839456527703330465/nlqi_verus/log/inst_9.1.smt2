...
(set-info :comment ";; mariposa_data/6//16839456527703330465/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_1~872@ Int)
(declare-const temp_2_0~1085@ Int)
(declare-const temp_2_1~1270@ Int)
(declare-const temp_3_0~1675@ Int)
(declare-const temp_3_1~1876@ Int)
(declare-const temp_4_0~2157@ Int)
(declare-const temp_4_1~2402@ Int)
(declare-const temp_5_0~2639@ Int)
(declare-const temp_5_1~2848@ Int)
(declare-const temp_6_0~2997@ Int)
(declare-const temp_6_1~3118@ Int)
(declare-const temp_7_0~3387@ Int)
(declare-const temp_7_1~3628@ Int)
(declare-const temp_8_0~3923@ Int)
(declare-const temp_8_1~4184@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~253@ (Mul (Add (Mul (Sub (Mul (Mul c0~6@ c0~6@) b0~4@) (Mul (Add a0~2@ c0~6@) (Add b0~4@ c0~6@))) (Sub (Mul (Add d0~8@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@)))) (Sub (Mul (Mul (Sub a0~2@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Sub b0~4@ a0~2@) c0~6@)) (Mul c0~6@ (Sub (Mul a0~2@ d0~8@) (Mul c0~6@ c0~6@))))) (Mul (Mul a0~2@ (Mul (Add (Mul a0~2@ a0~2@) (Mul b0~4@ a0~2@)) (Mul d0~8@ (Mul c0~6@ d0~8@)))) (Sub b0~4@ (Mul (Mul (Mul 98 c0~6@) b0~4@) d0~8@))))) (=> (= temp_0_1~426@ (Mul (Add (Mul (Sub (Mul (Mul c0~6@ c0~6@) b0~4@) (Mul (Add a0~2@ c0~6@) (Add b0~4@ c0~6@))) (Sub (Mul (Add d0~8@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@)))) (Sub (Mul (Mul (Sub a0~2@ c0~6@) (Mul c0~6@ a0~2@)) (Mul (Sub b0~4@ a0~2@) c0~6@)) (Mul c0~6@ (Sub (Mul a0~2@ d0~8@) (Mul c0~6@ c0~6@))))) (Mul (Mul a0~2@ (Mul (Add (Mul a0~2@ a0~2@) (Mul b0~4@ a0~2@)) (Mul d0~8@ (Mul c0~6@ d0~8@)))) (Sub b0~4@ (Mul (Mul (Mul 98 c0~6@) b0~4@) d0~8@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c0~6@ c0~6@) (=> %%location_label%%0 (= temp_0_0~253@ temp_0_1~426@))) (=> (= temp_0_0~253@ temp_0_1~426@) (=> (= temp_1_0~663@ (Add (Mul (Mul (Mul (Sub (Mul d1~16@ 8) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ b1~12@))) a1~10@) (Sub (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@))))) (Sub (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Sub c1~14@ d1~16@)) (Mul (Add d1~16@ d1~16@) b1~12@)) (Mul b1~12@ (Mul d1~16@ b1~12@))) (Add (Mul (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ a1~10@) d1~16@)) (Sub (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@)) (Mul a1~10@ (Mul c1~14@ c1~14@))))))) (=> (= temp_1_1~872@ (Add (Mul (Mul (Mul (Sub (Mul d1~16@ 8) (Mul a1~10@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ b1~12@))) a1~10@) (Sub (Mul (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul d1~16@ d1~16@) (Mul b1~12@ b1~12@))))) (Sub (Mul (Mul (Mul (Mul d1~16@ d1~16@) (Sub c1~14@ d1~16@)) (Mul (Add d1~16@ d1~16@) b1~12@)) (Mul b1~12@ (Mul d1~16@ b1~12@))) (Add (Mul (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ a1~10@)) (Mul (Mul a1~10@ a1~10@) d1~16@)) (Sub (Mul (Mul a1~10@ d1~16@) (Mul c1~14@ c1~14@)) (Mul a1~10@ (Mul c1~14@ c1~14@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c1~14@ c1~14@) (=> %%location_label%%1 (= temp_1_0~663@ temp_1_1~872@))) (=> (= temp_1_0~663@ temp_1_1~872@) (=> (= temp_2_0~1085@ (Mul (Mul (Mul (Mul (Mul (Mul c2~22@ a2~18@) b2~20@) (Sub (Mul b2~20@ b2~20@) (Mul c2~22@ a2~18@))) (Mul (Mul (Add d2~24@ b2~20@) (Mul c2~22@ c2~22@)) (Sub (Mul d2~24@ d2~24@) (Sub d2~24@ a2~18@)))) b2~20@) (Mul (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Add a2~18@ b2~20@) (Mul c2~22@ a2~18@)))) (Mul (Mul (Sub b2~20@ (Sub d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Sub c2~22@ d2~24@))) (Sub (Mul (Mul b2~20@ b2~20@) a2~18@) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ c2~22@))))))) (=> (= temp_2_1~1270@ (Mul (Mul (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Add a2~18@ b2~20@) (Mul c2~22@ a2~18@)))) (Mul (Mul (Sub b2~20@ (Sub d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Sub c2~22@ d2~24@))) (Sub (Mul (Mul b2~20@ b2~20@) a2~18@) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ c2~22@))))) (Mul (Mul (Mul (Mul (Mul c2~22@ a2~18@) b2~20@) (Sub (Mul b2~20@ b2~20@) (Mul c2~22@ a2~18@))) (Mul (Mul (Add d2~24@ b2~20@) (Mul c2~22@ c2~22@)) (Sub (Mul d2~24@ d2~24@) (Sub d2~24@ a2~18@)))) b2~20@))) (and (=> (= tmp%1@ (Mul (Mul (Mul (Mul (Mul c2~22@ a2~18@) b2~20@) (Sub (Mul b2~20@ b2~20@) (Mul c2~22@ a2~18@))) (Mul (Mul (Add d2~24@ b2~20@) (Mul c2~22@ c2~22@)) (Sub (Mul d2~24@ d2~24@) (Sub d2~24@ a2~18@)))) b2~20@)) (=> (= tmp%2@ (Mul (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ b2~20@) (Mul c2~22@ b2~20@))) (Mul (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ d2~24@)) (Mul (Add a2~18@ b2~20@) (Mul c2~22@ a2~18@)))) (Mul (Mul (Sub b2~20@ (Sub d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Sub c2~22@ d2~24@))) (Sub (Mul (Mul b2~20@ b2~20@) a2~18@) (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ c2~22@)))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%2 (= temp_2_0~1085@ temp_2_1~1270@))))) (=> (= temp_2_0~1085@ temp_2_1~1270@) (=> (= temp_3_0~1675@ (Mul (Sub (Sub (Mul (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ c3~30@)) (Mul (Add d3~32@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul c3~30@ c3~30@) b3~28@) (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ d3~32@)))) (Mul (Mul (Sub (Mul d3~32@ d3~32@) d3~32@) (Mul (Mul c3~30@ b3~28@) d3~32@)) (Mul (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@)) d3~32@))) (Mul (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ c3~30@)) b3~28@) (Mul (Mul b3~28@ (Mul d3~32@ d3~32@)) (Add (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@)))) (Mul (Mul (Mul a3~26@ d3~32@) (Add b3~28@ (Mul a3~26@ b3~28@))) (Add (Mul (Sub a3~26@ c3~30@) (Mul b3~28@ c3~30@)) (Mul b3~28@ (Mul c3~30@ c3~30@))))))) (=> (= temp_3_1~1876@ (Mul (Sub (Sub (Mul (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ c3~30@)) (Mul (Add d3~32@ b3~28@) (Mul a3~26@ b3~28@))) (Mul (Mul (Mul c3~30@ c3~30@) b3~28@) (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ d3~32@)))) (Mul (Mul (Sub (Mul d3~32@ d3~32@) d3~32@) (Mul (Mul c3~30@ b3~28@) d3~32@)) (Mul (Mul (Mul c3~30@ b3~28@) (Mul d3~32@ d3~32@)) d3~32@))) (Mul (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ c3~30@)) b3~28@) (Mul (Mul b3~28@ (Mul d3~32@ d3~32@)) (Add (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@)))) (Mul (Mul (Mul a3~26@ d3~32@) (Add b3~28@ (Mul a3~26@ b3~28@))) (Add (Mul (Sub a3~26@ c3~30@) (Mul b3~28@ c3~30@)) (Mul b3~28@ (Mul c3~30@ c3~30@))))))) (and (=> (= tmp%3@ (Mul d3~32@ d3~32@)) (=> (= tmp%4@ (Mul c3~30@ b3~28@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%3 (= temp_3_0~1675@ temp_3_1~1876@))))) (=> (= temp_3_0~1675@ temp_3_1~1876@) (=> (= temp_4_0~2157@ (Mul (Add (Mul (Mul (Mul (Sub a4~34@ a4~34@) (Mul a4~34@ a4~34@)) (Mul (Add a4~34@ d4~40@) (Sub a4~34@ a4~34@))) (Mul (Sub (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ 70)))) (Sub (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Add c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (Mul c4~38@ (Sub (Mul d4~40@ c4~38@) (Mul b4~36@ c4~38@))))) (Mul (Mul (Add (Sub (Mul d4~40@ b4~36@) (Sub b4~36@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ b4~36@)))) (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ b4~36@))) (Mul b4~36@ (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ d4~40@))))))) (=> (= temp_4_1~2402@ (Mul (Add (Mul (Mul (Mul (Sub a4~34@ a4~34@) (Mul a4~34@ a4~34@)) (Mul (Add a4~34@ d4~40@) (Sub a4~34@ a4~34@))) (Mul (Sub (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)) (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ 70)))) (Sub (Mul (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ b4~36@)) (Mul (Add c4~38@ c4~38@) (Mul a4~34@ a4~34@))) (Mul c4~38@ (Sub (Mul d4~40@ c4~38@) (Mul b4~36@ c4~38@))))) (Mul (Mul (Add (Sub (Mul d4~40@ b4~36@) (Sub b4~36@ b4~36@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ a4~34@) (Mul a4~34@ b4~36@)))) (Mul (Mul (Mul (Mul c4~38@ b4~36@) (Mul d4~40@ c4~38@)) (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ b4~36@))) (Mul b4~36@ (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ d4~40@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ a4~34@) (=> %%location_label%%4 (= temp_4_0~2157@ temp_4_1~2402@))) (=> (= temp_4_0~2157@ temp_4_1~2402@) (=> (= temp_5_0~2639@ (Mul (Mul (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@))) (Mul (Mul (Mul c5~46@ c5~46@) a5~42@) (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ a5~42@)))) (Mul (Mul (Sub (Mul d5~48@ c5~46@) (Mul a5~42@ c5~46@)) (Mul a5~42@ (Mul a5~42@ d5~48@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@)) (Add (Mul d5~48@ c5~46@) (Mul b5~44@ c5~46@))))) (Mul (Mul (Mul (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@)) (Add (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ b5~44@) (Add b5~44@ b5~44@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@)))) (Add c5~46@ (Add a5~42@ (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ d5~48@))))))) (=> (= temp_5_1~2848@ (Mul (Mul (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@))) (Mul (Mul (Mul c5~46@ c5~46@) a5~42@) (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ a5~42@)))) (Mul (Mul (Sub (Mul d5~48@ c5~46@) (Mul a5~42@ c5~46@)) (Mul a5~42@ (Mul a5~42@ d5~48@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ d5~48@)) (Add (Mul d5~48@ c5~46@) (Mul b5~44@ c5~46@))))) (Mul (Mul (Mul (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@)) (Add (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@))) (Mul (Mul (Mul d5~48@ b5~44@) (Add b5~44@ b5~44@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@)))) (Add c5~46@ (Add a5~42@ (Mul (Mul b5~44@ b5~44@) (Mul b5~44@ d5~48@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b5~44@ b5~44@) (=> %%location_label%%5 (= temp_5_0~2639@ temp_5_1~2848@))) (=> (= temp_5_0~2639@ temp_5_1~2848@) (=> (= temp_6_0~2997@ (Mul (Sub (Mul (Mul (Mul (Add b6~52@ a6~50@) (Mul a6~50@ a6~50@)) (Add (Sub d6~56@ b6~52@) (Mul d6~56@ c6~54@))) (Add (Mul (Sub c6~54@ a6~50@) (Mul d6~56@ a6~50@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@)))) (Mul (Mul (Mul (Sub c6~54@ a6~50@) (Mul a6~50@ c6~54@)) d6~56@) (Mul (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ b6~52@)) (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ a6~50@))))) a6~50@)) (=> (= temp_6_1~3118@ (Mul (Sub (Mul (Mul (Mul (Add b6~52@ a6~50@) (Mul a6~50@ a6~50@)) (Add (Sub d6~56@ b6~52@) (Mul d6~56@ c6~54@))) (Add (Mul (Mul d6~56@ a6~50@) (Sub c6~54@ a6~50@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ d6~56@)))) (Mul (Mul (Mul (Sub c6~54@ a6~50@) (Mul a6~50@ c6~54@)) d6~56@) (Mul (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ b6~52@)) (Mul (Mul a6~50@ b6~52@) (Mul c6~54@ a6~50@))))) a6~50@)) (and (=> (= tmp%5@ (Sub c6~54@ a6~50@)) (=> (= tmp%6@ (Mul d6~56@ a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%5@ tmp%6@) (=> %%location_label%%6 (= temp_6_0~2997@ temp_6_1~3118@))))) (=> (= temp_6_0~2997@ temp_6_1~3118@) (=> (= temp_7_0~3387@ (Sub (Add (Mul (Mul (Mul (Sub b7~60@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Add d7~64@ d7~64@) (Add c7~62@ d7~64@))) (Mul 74 (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@)))) (Add (Sub (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ 63) (Mul d7~64@ c7~62@))) (Mul (Add (Mul b7~60@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@ b7~60@) b7~60@)))) (Add (Mul (Mul (Mul (Add c7~62@ d7~64@) (Add c7~62@ b7~60@)) (Mul (Add b7~60@ c7~62@) (Add d7~64@ d7~64@))) c7~62@) (Add (Mul (Mul (Add d7~64@ a7~58@) (Mul b7~60@ d7~64@)) (Add c7~62@ (Mul b7~60@ d7~64@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ a7~58@)) (Add (Add d7~64@ c7~62@) (Mul a7~58@ b7~60@))))))) (=> (= temp_7_1~3628@ (Sub (Add (Mul (Mul (Mul (Sub b7~60@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Add d7~64@ d7~64@) (Add c7~62@ d7~64@))) (Mul 74 (Mul (Mul a7~58@ a7~58@) (Mul a7~58@ c7~62@)))) (Add (Sub (Mul (Mul a7~58@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ 63) (Mul d7~64@ c7~62@))) (Mul (Add (Mul b7~60@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@ b7~60@) b7~60@)))) (Add (Mul (Mul (Mul (Add c7~62@ d7~64@) (Add c7~62@ b7~60@)) (Add (Mul (Add b7~60@ c7~62@) d7~64@) (Mul (Add b7~60@ c7~62@) d7~64@))) c7~62@) (Add (Mul (Mul (Add d7~64@ a7~58@) (Mul b7~60@ d7~64@)) (Add c7~62@ (Mul b7~60@ d7~64@))) (Mul (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ a7~58@)) (Add (Add d7~64@ c7~62@) (Mul a7~58@ b7~60@))))))) (and (=> (= tmp%7@ (Add b7~60@ c7~62@)) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%7@ d7~64@ d7~64@) (=> %%location_label%%7 (= temp_7_0~3387@ temp_7_1~3628@)))) (=> (= temp_7_0~3387@ temp_7_1~3628@) (=> (= temp_8_0~3923@ (Add (Mul (Mul (Mul (Mul (Sub a8~66@ c8~70@) (Mul b8~68@ d8~72@)) (Mul (Sub c8~70@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Add b8~68@ a8~66@) (Mul c8~70@ a8~66@)))) (Mul (Mul (Add (Add a8~66@ a8~66@) (Mul 18 a8~66@)) (Mul (Add c8~70@ b8~68@) (Mul c8~70@ d8~72@))) (Mul (Sub a8~66@ (Sub c8~70@ b8~68@)) (Sub (Sub b8~68@ d8~72@) (Mul a8~66@ d8~72@))))) (Mul (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ d8~72@)) (Mul (Add b8~68@ c8~70@) (Mul b8~68@ a8~66@))) (Mul (Mul (Mul d8~72@ a8~66@) c8~70@) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ a8~66@)))) (Mul (Mul (Mul (Sub c8~70@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Sub d8~72@ b8~68@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ d8~72@))))))) (=> (= temp_8_1~4184@ (Add (Mul (Mul (Mul (Mul (Sub a8~66@ c8~70@) (Mul b8~68@ d8~72@)) (Mul (Sub c8~70@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ d8~72@)) (Mul (Add b8~68@ a8~66@) (Mul c8~70@ a8~66@)))) (Mul (Mul (Add (Add a8~66@ a8~66@) (Mul 18 a8~66@)) (Mul (Add c8~70@ b8~68@) (Mul c8~70@ d8~72@))) (Mul (Sub a8~66@ (Sub c8~70@ b8~68@)) (Sub (Sub b8~68@ d8~72@) (Mul a8~66@ d8~72@))))) (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ d8~72@)) (Mul (Add b8~68@ c8~70@) (Mul b8~68@ a8~66@))) (Mul (Mul (Mul (Mul d8~72@ a8~66@) c8~70@) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ a8~66@))) (Mul (Mul (Mul (Sub c8~70@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Sub d8~72@ b8~68@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ d8~72@)))))))) (=> (= tmp%8@ (Mul (Mul (Mul d8~72@ d8~72@) (Mul a8~66@ d8~72@)) (Mul (Add b8~68@ c8~70@) (Mul b8~68@ a8~66@)))) (=> (= tmp%9@ (Mul (Mul (Mul d8~72@ a8~66@) c8~70@) (Mul (Mul d8~72@ b8~68@) (Mul d8~72@ a8~66@)))) (=> (= tmp%10@ (Mul (Mul (Mul (Sub c8~70@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Sub d8~72@ b8~68@) (Mul b8~68@ d8~72@))) (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ d8~72@))))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%8 (= temp_8_0~3923@ temp_8_1~4184@)))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
