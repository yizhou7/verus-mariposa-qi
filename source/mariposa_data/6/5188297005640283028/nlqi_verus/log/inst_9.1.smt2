...
(set-info :comment ";; mariposa_data/6//5188297005640283028/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~711@ Int)
(declare-const temp_1_1~880@ Int)
(declare-const temp_2_0~1313@ Int)
(declare-const temp_2_1~1558@ Int)
(declare-const temp_3_0~1871@ Int)
(declare-const temp_3_1~2100@ Int)
(declare-const temp_4_0~2395@ Int)
(declare-const temp_4_1~2600@ Int)
(declare-const temp_5_0~2853@ Int)
(declare-const temp_5_1~3078@ Int)
(declare-const temp_6_0~3279@ Int)
(declare-const temp_6_1~3452@ Int)
(declare-const temp_7_0~3759@ Int)
(declare-const temp_7_1~3996@ Int)
(declare-const temp_8_0~4291@ Int)
(declare-const temp_8_1~4556@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~297@ (Mul (Add (Mul (Sub (Sub (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul b0~4@ c0~6@) (Sub d0~8@ b0~4@))) (Mul b0~4@ (Mul (Sub d0~8@ c0~6@) (Mul c0~6@ a0~2@)))) (Mul (Mul d0~8@ (Mul (Mul a0~2@ b0~4@) d0~8@)) (Mul (Mul d0~8@ (Mul a0~2@ a0~2@)) (Sub (Sub c0~6@ a0~2@) (Mul c0~6@ a0~2@))))) (Mul (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Mul 97 a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Add d0~8@ c0~6@) a0~2@) (Mul (Mul d0~8@ a0~2@) (Sub c0~6@ a0~2@)))) (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Add b0~4@ c0~6@) a0~2@)) (Mul (Mul (Mul a0~2@ a0~2@) (Add d0~8@ d0~8@)) b0~4@))))) (=> (= temp_0_1~514@ (Mul (Add (Mul (Sub (Sub (Mul b0~4@ d0~8@) (Mul a0~2@ d0~8@)) (Mul (Mul c0~6@ b0~4@) (Sub d0~8@ b0~4@))) (Mul b0~4@ (Mul (Sub d0~8@ c0~6@) (Mul c0~6@ a0~2@)))) (Mul (Mul d0~8@ (Mul (Mul a0~2@ b0~4@) d0~8@)) (Mul (Mul d0~8@ (Mul a0~2@ a0~2@)) (Sub (Sub c0~6@ a0~2@) (Mul c0~6@ a0~2@))))) (Mul (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Mul a0~2@ c0~6@)) (Mul (Mul 97 a0~2@) (Mul c0~6@ a0~2@))) (Mul (Mul (Add d0~8@ c0~6@) a0~2@) (Mul (Mul d0~8@ a0~2@) (Sub c0~6@ a0~2@)))) (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ d0~8@)) (Mul (Add b0~4@ c0~6@) a0~2@)) (Mul (Mul (Mul a0~2@ a0~2@) (Add d0~8@ d0~8@)) b0~4@))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ c0~6@) (=> %%location_label%%0 (= temp_0_0~297@ temp_0_1~514@))) (=> (= temp_0_0~297@ temp_0_1~514@) (=> (= temp_1_0~711@ (Mul (Mul (Mul d1~16@ (Sub d1~16@ (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@)))) (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) b1~12@) (Mul (Add (Sub b1~12@ c1~14@) (Sub b1~12@ b1~12@)) (Mul c1~14@ (Mul b1~12@ a1~10@))))) (Mul (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Add d1~16@ b1~12@)) (Mul (Mul b1~12@ d1~16@) d1~16@)) (Mul (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ c1~14@)))) (Mul (Mul (Mul (Sub d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))) b1~12@)))) (=> (= temp_1_1~880@ (Mul (Mul (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Add d1~16@ b1~12@)) (Mul (Mul b1~12@ d1~16@) d1~16@)) (Mul (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ c1~14@)))) (Mul (Mul (Mul (Sub d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))) b1~12@)) (Mul (Mul d1~16@ (Sub d1~16@ (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@)))) (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) b1~12@) (Mul (Add (Sub b1~12@ c1~14@) (Sub b1~12@ b1~12@)) (Mul c1~14@ (Mul b1~12@ a1~10@))))))) (and (=> (= tmp%1@ (Mul (Mul d1~16@ (Sub d1~16@ (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@)))) (Mul (Mul (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ c1~14@)) b1~12@) (Mul (Add (Sub b1~12@ c1~14@) (Sub b1~12@ b1~12@)) (Mul c1~14@ (Mul b1~12@ a1~10@)))))) (=> (= tmp%2@ (Mul (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Add d1~16@ b1~12@)) (Mul (Mul b1~12@ d1~16@) d1~16@)) (Mul (Mul (Mul c1~14@ a1~10@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ c1~14@)))) (Mul (Mul (Mul (Sub d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@))) b1~12@))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%1@ tmp%2@) (=> %%location_label%%1 (= temp_1_0~711@ temp_1_1~880@))))) (=> (= temp_1_0~711@ temp_1_1~880@) (=> (= temp_2_0~1313@ (Mul (Mul (Mul (Mul c2~22@ (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ 31) (Mul d2~24@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Add d2~24@ b2~20@)))) (Sub (Mul (Mul (Mul d2~24@ d2~24@) (Sub c2~22@ d2~24@)) (Add (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@))) (Mul (Mul (Mul b2~20@ a2~18@) (Sub d2~24@ d2~24@)) (Mul (Add b2~20@ b2~20@) (Add d2~24@ a2~18@))))) (Mul (Mul (Mul (Add (Sub b2~20@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Add a2~18@ a2~18@) (Add c2~22@ d2~24@))) (Mul (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ b2~20@)) (Mul (Add c2~22@ c2~22@) (Mul a2~18@ a2~18@)))) (Sub (Mul (Sub (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Sub d2~24@ c2~22@))) (Mul c2~22@ (Mul (Sub b2~20@ b2~20@) (Mul b2~20@ a2~18@))))))) (=> (= temp_2_1~1558@ (Mul (Mul (Mul (Mul (Mul (Mul a2~18@ 31) (Mul d2~24@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Add d2~24@ b2~20@))) (Mul c2~22@ (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ c2~22@)))) (Sub (Mul (Mul (Mul d2~24@ d2~24@) (Sub c2~22@ d2~24@)) (Add (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@))) (Mul (Mul (Mul b2~20@ a2~18@) (Sub d2~24@ d2~24@)) (Mul (Add b2~20@ b2~20@) (Add d2~24@ a2~18@))))) (Mul (Mul (Mul (Add (Sub b2~20@ c2~22@) (Mul d2~24@ a2~18@)) (Mul (Add a2~18@ a2~18@) (Add c2~22@ d2~24@))) (Mul (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ b2~20@)) (Mul (Add c2~22@ c2~22@) (Mul a2~18@ a2~18@)))) (Sub (Mul (Sub (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Sub d2~24@ c2~22@))) (Mul c2~22@ (Mul (Sub b2~20@ b2~20@) (Mul b2~20@ a2~18@))))))) (and (=> (= tmp%3@ (Mul c2~22@ (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ c2~22@)))) (=> (= tmp%4@ (Mul (Mul (Mul a2~18@ 31) (Mul d2~24@ b2~20@)) (Mul (Mul b2~20@ b2~20@) (Add d2~24@ b2~20@)))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%3@ tmp%4@) (=> %%location_label%%2 (= temp_2_0~1313@ temp_2_1~1558@))))) (=> (= temp_2_0~1313@ temp_2_1~1558@) (=> (= temp_3_0~1871@ (Mul (Mul (Sub (Mul (Mul (Mul d3~32@ b3~28@) (Sub b3~28@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Add b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ d3~32@) c3~30@) (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@)))) (Mul (Add a3~26@ (Sub c3~30@ (Mul b3~28@ d3~32@))) (Sub (Sub (Add c3~30@ c3~30@) (Mul d3~32@ c3~30@)) (Sub (Mul d3~32@ d3~32@) (Mul b3~28@ d3~32@))))) (Mul (Sub d3~32@ (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ 48)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ c3~30@)))) (Mul (Mul (Mul a3~26@ (Mul d3~32@ 54)) (Mul (Add a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (Add (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ c3~30@)) (Sub (Mul a3~26@ b3~28@) (Mul b3~28@ b3~28@))))))) (=> (= temp_3_1~2100@ (Mul (Mul (Sub (Mul (Mul (Mul d3~32@ b3~28@) (Sub b3~28@ a3~26@)) (Mul (Mul d3~32@ d3~32@) (Add b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ d3~32@) c3~30@) (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ d3~32@)))) (Mul (Add a3~26@ (Sub c3~30@ (Mul b3~28@ d3~32@))) (Sub (Sub (Add c3~30@ c3~30@) (Mul d3~32@ c3~30@)) (Sub (Mul d3~32@ d3~32@) (Mul b3~28@ d3~32@))))) (Mul (Sub d3~32@ (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ 48)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ c3~30@)))) (Mul (Mul a3~26@ (Mul d3~32@ 54)) (Mul (Mul (Add a3~26@ d3~32@) (Mul b3~28@ a3~26@)) (Add (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ c3~30@)) (Sub (Mul a3~26@ b3~28@) (Mul b3~28@ b3~28@)))))))) (and (=> (= tmp%5@ (Mul a3~26@ (Mul d3~32@ 54))) (=> (= tmp%6@ (Mul (Add a3~26@ d3~32@) (Mul b3~28@ a3~26@))) (=> (= tmp%7@ (Add (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ c3~30@)) (Sub (Mul a3~26@ b3~28@) (Mul b3~28@ b3~28@)))) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%5@ tmp%6@ tmp%7@) (=> %%location_label%%3 (= temp_3_0~1871@ temp_3_1~2100@)))))) (=> (= temp_3_0~1871@ temp_3_1~2100@) (=> (= temp_4_0~2395@ (Mul (Mul (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ b4~36@)) (Sub d4~40@ (Mul d4~40@ d4~40@))) (Mul (Sub (Mul c4~38@ c4~38@) (Mul d4~40@ b4~36@)) (Mul (Add c4~38@ d4~40@) (Mul c4~38@ b4~36@)))) (Mul c4~38@ (Mul b4~36@ (Sub (Mul d4~40@ c4~38@) (Add d4~40@ d4~40@))))) (Mul (Mul (Add (Add (Mul b4~36@ d4~40@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Sub b4~36@ d4~40@))) (Mul (Sub (Mul a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Add (Mul b4~36@ c4~38@) (Sub b4~36@ c4~38@)))) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@)) (Add (Mul b4~36@ b4~36@) c4~38@)) (Mul (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ d4~40@)) (Mul c4~38@ (Mul c4~38@ a4~34@))))))) (=> (= temp_4_1~2600@ (Mul (Mul (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ b4~36@)) (Sub d4~40@ (Mul d4~40@ d4~40@))) (Mul (Sub (Mul c4~38@ c4~38@) (Mul d4~40@ b4~36@)) (Mul (Add c4~38@ d4~40@) (Mul c4~38@ b4~36@)))) (Mul c4~38@ (Mul b4~36@ (Sub (Mul d4~40@ c4~38@) (Add d4~40@ d4~40@))))) (Mul (Mul (Add (Add (Mul b4~36@ d4~40@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ d4~40@) (Sub b4~36@ d4~40@))) (Mul (Sub (Mul a4~34@ c4~38@) (Mul c4~38@ b4~36@)) (Add (Mul b4~36@ c4~38@) (Sub b4~36@ c4~38@)))) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ b4~36@)) (Add (Mul b4~36@ b4~36@) c4~38@)) (Mul (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ d4~40@)) (Mul c4~38@ (Mul c4~38@ a4~34@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a4~34@ c4~38@) (=> %%location_label%%4 (= temp_4_0~2395@ temp_4_1~2600@))) (=> (= temp_4_0~2395@ temp_4_1~2600@) (=> (= temp_5_0~2853@ (Sub (Mul (Mul (Add (Mul (Add c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Sub (Mul c5~46@ c5~46@) (Mul c5~46@ 67))) (Mul (Mul (Sub d5~48@ d5~48@) (Mul d5~48@ d5~48@)) (Sub (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@)))) (Mul (Add (Mul (Add c5~46@ c5~46@) (Mul c5~46@ a5~42@)) d5~48@) (Mul (Sub (Mul c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@))))) (Mul (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ b5~44@) c5~46@))) (Mul c5~46@ (Mul (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ b5~44@))))))) (=> (= temp_5_1~3078@ (Sub (Mul (Mul (Add (Mul (Add c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Sub (Mul c5~46@ c5~46@) (Mul c5~46@ 67))) (Mul (Mul (Sub d5~48@ d5~48@) (Mul d5~48@ d5~48@)) (Sub (Mul c5~46@ d5~48@) (Mul c5~46@ b5~44@)))) (Mul (Add (Mul (Add c5~46@ c5~46@) (Mul c5~46@ a5~42@)) d5~48@) (Mul (Sub (Mul c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ c5~46@))))) (Mul (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ b5~44@) c5~46@))) (Mul c5~46@ (Mul (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul b5~44@ b5~44@) (Mul d5~48@ b5~44@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b5~44@ b5~44@) (=> %%location_label%%5 (= temp_5_0~2853@ temp_5_1~3078@))) (=> (= temp_5_0~2853@ temp_5_1~3078@) (=> (= temp_6_0~3279@ (Mul (Mul (Mul (Mul (Mul (Sub d6~56@ b6~52@) (Mul d6~56@ a6~50@)) (Mul (Add a6~50@ a6~50@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)))) (Mul (Mul (Add (Mul b6~52@ d6~56@) b6~52@) (Mul a6~50@ (Mul c6~54@ b6~52@))) (Mul (Mul (Add c6~54@ c6~54@) c6~54@) (Mul (Sub d6~56@ d6~56@) (Add d6~56@ d6~56@))))) (Mul d6~56@ (Mul (Mul (Mul (Sub a6~50@ c6~54@) (Mul c6~54@ c6~54@)) (Add (Mul a6~50@ a6~50@) (Mul d6~56@ a6~50@))) (Sub (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ c6~54@)) c6~54@))))) (=> (= temp_6_1~3452@ (Mul (Mul (Mul (Mul (Mul (Sub d6~56@ b6~52@) (Mul d6~56@ a6~50@)) (Mul (Add a6~50@ a6~50@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul b6~52@ d6~56@) (Mul b6~52@ c6~54@)) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@)))) (Mul (Mul (Add (Mul b6~52@ d6~56@) b6~52@) (Mul a6~50@ (Mul c6~54@ b6~52@))) (Mul (Mul (Add c6~54@ c6~54@) c6~54@) (Mul (Sub d6~56@ d6~56@) (Add d6~56@ d6~56@))))) (Mul d6~56@ (Mul (Mul (Sub a6~50@ c6~54@) (Mul c6~54@ c6~54@)) (Mul (Add (Mul a6~50@ a6~50@) (Mul d6~56@ a6~50@)) (Sub (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ c6~54@)) c6~54@)))))) (and (=> (= tmp%8@ (Mul (Sub a6~50@ c6~54@) (Mul c6~54@ c6~54@))) (=> (= tmp%9@ (Add (Mul a6~50@ a6~50@) (Mul d6~56@ a6~50@))) (=> (= tmp%10@ (Sub (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ c6~54@)) c6~54@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%8@ tmp%9@ tmp%10@) (=> %%location_label%%6 (= temp_6_0~3279@ temp_6_1~3452@)))))) (=> (= temp_6_0~3279@ temp_6_1~3452@) (=> (= temp_7_0~3759@ (Mul (Mul (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul 7 a7~58@)) (Mul (Mul c7~62@ b7~60@) b7~60@)) (Mul (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Sub a7~58@ a7~58@) c7~62@))) (Mul (Mul (Mul (Add d7~64@ b7~60@) a7~58@) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ a7~58@))) (Add (Mul a7~58@ (Mul a7~58@ a7~58@)) (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ a7~58@))))) (Mul (Mul (Mul (Sub (Mul a7~58@ c7~62@) (Sub a7~58@ b7~60@)) (Mul (Mul a7~58@ b7~60@) (Add b7~60@ a7~58@))) (Sub (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@)) (Mul d7~64@ c7~62@))) (Add (Sub (Mul c7~62@ c7~62@) (Mul (Mul b7~60@ a7~58@) (Add c7~62@ b7~60@))) (Mul (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@)) (Mul (Sub c7~62@ d7~64@) (Sub b7~60@ c7~62@))))))) (=> (= temp_7_1~3996@ (Mul (Mul (Mul (Mul (Mul (Mul c7~62@ d7~64@) (Mul 7 a7~58@)) (Mul c7~62@ (Mul b7~60@ b7~60@))) (Mul (Mul (Mul b7~60@ a7~58@) (Mul d7~64@ b7~60@)) (Mul (Sub a7~58@ a7~58@) c7~62@))) (Mul (Mul (Mul (Add d7~64@ b7~60@) a7~58@) (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ a7~58@))) (Add (Mul a7~58@ (Mul a7~58@ a7~58@)) (Mul (Mul d7~64@ a7~58@) (Mul b7~60@ a7~58@))))) (Mul (Mul (Mul (Sub (Mul a7~58@ c7~62@) (Sub a7~58@ b7~60@)) (Mul (Mul a7~58@ b7~60@) (Add b7~60@ a7~58@))) (Sub (Mul (Mul a7~58@ a7~58@) (Mul d7~64@ b7~60@)) (Mul d7~64@ c7~62@))) (Add (Sub (Mul c7~62@ c7~62@) (Mul (Mul b7~60@ a7~58@) (Add c7~62@ b7~60@))) (Mul (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ d7~64@)) (Mul (Sub c7~62@ d7~64@) (Sub b7~60@ c7~62@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_associative. c7~62@ b7~60@ b7~60@) (=> %%location_label%%7 (= temp_7_0~3759@ temp_7_1~3996@))) (=> (= temp_7_0~3759@ temp_7_1~3996@) (=> (= temp_8_0~4291@ (Mul (Mul (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ c8~70@)) (Mul (Add c8~70@ c8~70@) (Mul b8~68@ c8~70@))) (Sub (Mul (Mul b8~68@ a8~66@) b8~68@) (Add (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@)))) (Mul (Mul (Add (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@))) (Mul (Mul (Add b8~68@ c8~70@) (Sub c8~70@ c8~70@)) (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ c8~70@))))) (Mul (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@))) (Mul (Sub (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul c8~70@ d8~72@) (Mul 39 d8~72@)))) (Sub (Add (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@))))))) (=> (= temp_8_1~4556@ (Mul (Mul (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Sub c8~70@ c8~70@)) (Mul (Add c8~70@ c8~70@) (Mul b8~68@ c8~70@))) (Sub (Mul (Mul b8~68@ a8~66@) b8~68@) (Add (Mul c8~70@ c8~70@) (Mul c8~70@ a8~66@)))) (Mul (Mul (Add (Mul c8~70@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ a8~66@))) (Mul (Mul (Sub c8~70@ c8~70@) (Add b8~68@ c8~70@)) (Mul (Mul d8~72@ c8~70@) (Mul a8~66@ c8~70@))))) (Mul (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ a8~66@)) (Mul (Mul c8~70@ d8~72@) (Mul a8~66@ d8~72@))) (Mul (Sub (Mul b8~68@ d8~72@) (Mul c8~70@ c8~70@)) (Mul (Mul c8~70@ d8~72@) (Mul 39 d8~72@)))) (Sub (Add (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ a8~66@) (Mul d8~72@ d8~72@))))))) (=> (= tmp%11@ (Add b8~68@ c8~70@)) (=> (= tmp%12@ (Sub c8~70@ c8~70@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%11@ tmp%12@) (=> %%location_label%%8 (= temp_8_0~4291@ temp_8_1~4556@))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
