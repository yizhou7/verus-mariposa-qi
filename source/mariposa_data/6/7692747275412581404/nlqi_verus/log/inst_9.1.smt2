...
(set-info :comment ";; mariposa_data/6//7692747275412581404/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~825@ Int)
(declare-const temp_1_1~954@ Int)
(declare-const temp_2_0~1143@ Int)
(declare-const temp_2_1~1304@ Int)
(declare-const temp_3_0~1579@ Int)
(declare-const temp_3_1~1808@ Int)
(declare-const temp_4_0~2057@ Int)
(declare-const temp_4_1~2278@ Int)
(declare-const temp_5_0~2475@ Int)
(declare-const temp_5_1~2636@ Int)
(declare-const temp_6_0~2805@ Int)
(declare-const temp_6_1~2946@ Int)
(declare-const temp_7_0~3231@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~281@ (Mul (Mul (Add (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Mul (Sub (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@)) a0~2@)) (Add (Mul (Mul d0~8@ (Mul c0~6@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul 68 a0~2@)) (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ c0~6@))))) (Mul (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Sub c0~6@ b0~4@)) (Mul (Sub b0~4@ b0~4@) (Mul b0~4@ b0~4@))) (Sub (Sub (Mul c0~6@ c0~6@) 28) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@)))) a0~2@))) (=> (= temp_0_1~554@ (Mul (Add (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@))) (Add (Mul (Mul d0~8@ (Mul c0~6@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul 68 a0~2@)) (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ c0~6@))))) (Mul (Mul (Sub (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@)) a0~2@) (Add (Mul (Mul d0~8@ (Mul c0~6@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul 68 a0~2@)) (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ c0~6@)))))) (Mul (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Sub c0~6@ b0~4@)) (Mul (Sub b0~4@ b0~4@) (Mul b0~4@ b0~4@))) (Sub (Sub (Mul c0~6@ c0~6@) 28) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@)))) a0~2@))) (and (=> (= tmp%1@ (Mul (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ c0~6@)) (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ a0~2@)))) (=> (= tmp%2@ (Mul (Sub (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@)) a0~2@)) (=> (= tmp%3@ (Add (Mul (Mul d0~8@ (Mul c0~6@ c0~6@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul 68 a0~2@)) (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ c0~6@))))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. tmp%1@ tmp%2@ tmp%3@) (=> %%location_label%%0 (= temp_0_0~281@ temp_0_1~554@)))))) (=> (= temp_0_0~281@ temp_0_1~554@) (=> (= temp_1_0~825@ (Mul (Mul c1~14@ d1~16@) (Mul (Mul (Mul (Mul a1~10@ (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ c1~14@))) (Mul (Mul (Mul a1~10@ d1~16@) (Mul b1~12@ b1~12@)) (Add (Mul a1~10@ c1~14@) (Mul b1~12@ c1~14@)))) (Sub (Mul (Mul (Sub b1~12@ d1~16@) (Mul b1~12@ b1~12@)) (Sub (Mul c1~14@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Add (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@)) (Mul a1~10@ (Mul d1~16@ a1~10@))))))) (=> (= temp_1_1~954@ (Mul (Mul c1~14@ d1~16@) (Mul (Mul (Mul (Mul a1~10@ (Mul a1~10@ a1~10@)) (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul b1~12@ b1~12@)) (Add (Mul a1~10@ c1~14@) (Mul b1~12@ c1~14@)))) (Sub (Mul (Mul (Sub b1~12@ d1~16@) (Mul b1~12@ b1~12@)) (Sub (Mul c1~14@ c1~14@) (Mul c1~14@ a1~10@))) (Mul (Add (Mul a1~10@ b1~12@) (Mul b1~12@ a1~10@)) (Mul a1~10@ (Mul d1~16@ a1~10@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a1~10@ d1~16@) (=> %%location_label%%1 (= temp_1_0~825@ temp_1_1~954@))) (=> (= temp_1_0~825@ temp_1_1~954@) (=> (= temp_2_0~1143@ (Add (Mul (Mul (Mul c2~22@ b2~20@) (Mul (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ d2~24@)) (Mul (Sub a2~18@ c2~22@) (Mul c2~22@ b2~20@)))) (Mul (Mul (Mul b2~20@ (Mul a2~18@ c2~22@)) (Mul (Mul d2~24@ b2~20@) (Mul c2~22@ c2~22@))) c2~22@)) (Mul (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ c2~22@)) (Mul b2~20@ (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul b2~20@ d2~24@) (Sub a2~18@ c2~22@)))) (Mul (Mul (Mul (Mul b2~20@ b2~20@) c2~22@) (Mul (Sub d2~24@ a2~18@) d2~24@)) a2~18@)))) (=> (= temp_2_1~1304@ (Add (Mul (Mul (Mul c2~22@ b2~20@) (Mul (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ d2~24@)) (Mul (Sub a2~18@ c2~22@) (Mul c2~22@ b2~20@)))) (Mul (Mul (Mul (Mul b2~20@ (Mul a2~18@ c2~22@)) (Mul d2~24@ b2~20@)) (Mul c2~22@ c2~22@)) c2~22@)) (Mul (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ c2~22@)) (Mul b2~20@ (Mul b2~20@ c2~22@))) (Mul (Mul (Mul a2~18@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul b2~20@ d2~24@) (Sub a2~18@ c2~22@)))) (Mul (Mul (Mul (Mul b2~20@ b2~20@) c2~22@) (Mul (Sub d2~24@ a2~18@) d2~24@)) a2~18@)))) (and (=> (= tmp%4@ (Mul b2~20@ (Mul a2~18@ c2~22@))) (=> (= tmp%5@ (Mul d2~24@ b2~20@)) (=> (= tmp%6@ (Mul c2~22@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%4@ tmp%5@ tmp%6@) (=> %%location_label%%2 (= temp_2_0~1143@ temp_2_1~1304@)))))) (=> (= temp_2_0~1143@ temp_2_1~1304@) (=> (= temp_3_0~1579@ (Mul (Mul (Mul (Mul (Mul (Sub c3~30@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ d3~32@))) (Mul d3~32@ (Mul (Mul a3~26@ c3~30@) (Sub b3~28@ c3~30@)))) (Add (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ b3~28@)) (Add (Mul c3~30@ a3~26@) (Sub c3~30@ d3~32@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Add b3~28@ d3~32@) (Mul d3~32@ c3~30@))))) (Mul (Mul (Add (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ c3~30@)) (Add (Mul d3~32@ c3~30@) (Mul b3~28@ a3~26@))) (Add (Mul b3~28@ (Mul c3~30@ d3~32@)) (Mul c3~30@ (Mul d3~32@ a3~26@)))) (Mul (Mul (Add (Mul a3~26@ a3~26@) (Add c3~30@ b3~28@)) (Mul a3~26@ b3~28@)) (Mul (Mul (Add b3~28@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))))))) (=> (= temp_3_1~1808@ (Mul (Mul (Mul (Mul (Mul (Sub c3~30@ c3~30@) (Mul c3~30@ b3~28@)) (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ d3~32@))) (Mul d3~32@ (Mul (Mul a3~26@ c3~30@) (Sub b3~28@ c3~30@)))) (Add (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ b3~28@)) (Add (Mul c3~30@ a3~26@) (Sub c3~30@ d3~32@))) (Mul (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Add b3~28@ d3~32@) (Mul d3~32@ c3~30@))))) (Mul (Mul (Add (Mul (Mul a3~26@ c3~30@) (Mul a3~26@ c3~30@)) (Add (Mul d3~32@ c3~30@) (Mul b3~28@ a3~26@))) (Add (Mul b3~28@ (Mul c3~30@ d3~32@)) (Mul c3~30@ (Mul d3~32@ a3~26@)))) (Mul (Mul (Add (Mul a3~26@ a3~26@) (Add c3~30@ b3~28@)) (Mul a3~26@ b3~28@)) (Mul (Mul (Add b3~28@ b3~28@) (Mul d3~32@ d3~32@)) (Mul (Mul d3~32@ d3~32@) (Mul d3~32@ b3~28@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a3~26@ a3~26@) (=> %%location_label%%3 (= temp_3_0~1579@ temp_3_1~1808@))) (=> (= temp_3_0~1579@ temp_3_1~1808@) (=> (= temp_4_0~2057@ (Mul (Mul (Mul a4~34@ (Mul (Add (Mul b4~36@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@)))) (Add (Mul (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ b4~36@)) (Add (Mul c4~38@ d4~40@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul b4~36@ d4~40@) (Mul d4~40@ c4~38@)) a4~34@))) (Mul (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ c4~38@)) (Sub b4~36@ (Mul d4~40@ d4~40@))) (Mul (Mul d4~40@ (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ c4~38@)))) (Mul (Mul (Sub (Mul d4~40@ d4~40@) (Mul b4~36@ b4~36@)) (Sub (Mul b4~36@ c4~38@) (Mul d4~40@ d4~40@))) (Mul (Mul (Sub b4~36@ a4~34@) (Mul 19 b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul c4~38@ c4~38@))))))) (=> (= temp_4_1~2278@ (Mul (Mul (Mul a4~34@ (Mul (Add (Mul b4~36@ c4~38@) (Mul d4~40@ a4~34@)) (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ d4~40@)))) (Add (Mul (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ b4~36@)) (Add (Mul c4~38@ d4~40@) (Mul a4~34@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ d4~40@)) a4~34@))) (Mul (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ c4~38@)) (Sub b4~36@ (Mul d4~40@ d4~40@))) (Mul (Mul d4~40@ (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ c4~38@)))) (Mul (Mul (Sub (Mul d4~40@ d4~40@) (Mul b4~36@ b4~36@)) (Sub (Mul b4~36@ c4~38@) (Mul d4~40@ d4~40@))) (Mul (Mul (Sub b4~36@ a4~34@) (Mul 19 b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul c4~38@ c4~38@))))))) (and (=> (= tmp%7@ (Mul b4~36@ d4~40@)) (=> (= tmp%8@ (Mul d4~40@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%4 (= temp_4_0~2057@ temp_4_1~2278@))))) (=> (= temp_4_0~2057@ temp_4_1~2278@) (=> (= temp_5_0~2475@ (Mul (Mul (Mul (Mul (Mul b5~44@ (Mul a5~42@ b5~44@)) (Mul (Mul c5~46@ b5~44@) (Sub c5~46@ 27))) (Mul (Mul (Mul a5~42@ b5~44@) d5~48@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul (Add d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Sub d5~48@ (Add b5~44@ d5~48@))) a5~42@)) (Mul (Sub (Add (Add (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul 83 b5~44@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) b5~44@)) c5~46@))) (=> (= temp_5_1~2636@ (Mul (Mul (Mul (Mul (Mul b5~44@ (Mul a5~42@ b5~44@)) (Mul (Mul c5~46@ b5~44@) (Sub c5~46@ 27))) (Mul (Mul (Mul b5~44@ a5~42@) d5~48@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul (Add d5~48@ d5~48@) (Mul c5~46@ a5~42@)) (Sub d5~48@ (Add b5~44@ d5~48@))) a5~42@)) (Mul (Sub (Add (Add (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul 83 b5~44@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) b5~44@)) c5~46@))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a5~42@ b5~44@) (=> %%location_label%%5 (= temp_5_0~2475@ temp_5_1~2636@))) (=> (= temp_5_0~2475@ temp_5_1~2636@) (=> (= temp_6_0~2805@ (Add (Mul (Mul (Mul (Mul (Add d6~56@ d6~56@) c6~54@) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@))) (Add d6~56@ (Mul d6~56@ (Mul d6~56@ c6~54@)))) b6~52@) (Sub (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ b6~52@)) c6~54@) (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ a6~50@)) c6~54@)) (Mul (Mul d6~56@ (Add (Mul b6~52@ a6~50@) (Mul d6~56@ d6~56@))) (Add (Mul (Mul a6~50@ c6~54@) (Sub b6~52@ b6~52@)) (Add (Mul a6~50@ b6~52@) (Mul c6~54@ b6~52@))))))) (=> (= temp_6_1~2946@ (Add (Mul (Mul (Mul (Mul (Add d6~56@ d6~56@) c6~54@) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@))) (Add d6~56@ (Mul d6~56@ (Mul d6~56@ c6~54@)))) b6~52@) (Sub (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ b6~52@)) c6~54@) (Mul (Mul (Mul d6~56@ c6~54@) (Mul a6~50@ a6~50@)) c6~54@)) (Mul (Mul d6~56@ (Add (Mul b6~52@ a6~50@) (Mul d6~56@ d6~56@))) (Add (Mul (Mul c6~54@ a6~50@) (Sub b6~52@ b6~52@)) (Add (Mul a6~50@ b6~52@) (Mul c6~54@ b6~52@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. a6~50@ c6~54@) (=> %%location_label%%6 (= temp_6_0~2805@ temp_6_1~2946@))) (=> (= temp_6_0~2805@ temp_6_1~2946@) (=> (= temp_7_0~3231@ (Mul (Mul (Mul (Sub (Mul (Add d7~64@ b7~60@) (Mul c7~62@ a7~58@)) (Add (Sub d7~64@ b7~60@) (Add c7~62@ d7~64@))) (Mul (Mul (Add c7~62@ b7~60@) (Mul d7~64@ b7~60@)) (Add (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@)))) (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ a7~58@)) (Sub (Mul d7~64@ a7~58@) (Add a7~58@ b7~60@))) (Mul (Mul (Add d7~64@ c7~62@) (Mul b7~60@ a7~58@)) (Add (Mul b7~60@ c7~62@) (Add a7~58@ c7~62@))))) (Mul (Add (Mul (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ d7~64@)) (Add (Add d7~64@ d7~64@) (Mul c7~62@ b7~60@))) (Mul (Mul (Sub c7~62@ b7~60@) (Mul b7~60@ c7~62@)) (Mul c7~62@ (Mul d7~64@ d7~64@)))) (Mul (Mul (Sub (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@)) b7~60@) (Mul (Mul b7~60@ (Mul 32 c7~62@)) (Mul c7~62@ (Mul d7~64@ 72))))))) (=> (= temp_7_1~3488@ (Mul (Mul (Mul (Sub (Mul (Add d7~64@ b7~60@) (Mul a7~58@ c7~62@)) (Add (Sub d7~64@ b7~60@) (Add c7~62@ d7~64@))) (Mul (Mul (Add c7~62@ b7~60@) (Mul d7~64@ b7~60@)) (Add (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@)))) (Mul (Mul (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ a7~58@)) (Sub (Mul d7~64@ a7~58@) (Add a7~58@ b7~60@))) (Mul (Mul (Add d7~64@ c7~62@) (Mul b7~60@ a7~58@)) (Add (Mul b7~60@ c7~62@) (Add a7~58@ c7~62@))))) (Mul (Add (Mul (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ d7~64@)) (Add (Add d7~64@ d7~64@) (Mul c7~62@ b7~60@))) (Mul (Mul (Sub c7~62@ b7~60@) (Mul b7~60@ c7~62@)) (Mul c7~62@ (Mul d7~64@ d7~64@)))) (Mul (Mul (Sub (Mul d7~64@ d7~64@) (Mul c7~62@ b7~60@)) b7~60@) (Mul (Mul b7~60@ (Mul 32 c7~62@)) (Mul c7~62@ (Mul d7~64@ 72))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. c7~62@ a7~58@) (=> %%location_label%%7 (= temp_7_0~3231@ temp_7_1~3488@))) (=> (= temp_7_0~3231@ temp_7_1~3488@) (=> (= temp_8_0~3745@ (Mul (Sub (Mul c8~70@ (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)))) (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@)) (Mul a8~66@ (Mul b8~68@ c8~70@))) (Mul (Mul (Mul b8~68@ d8~72@) (Sub c8~70@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Add a8~66@ b8~68@))))) (Mul (Mul (Sub (Mul (Add d8~72@ b8~68@) c8~70@) (Mul a8~66@ (Mul a8~66@ b8~68@))) (Mul (Add (Mul b8~68@ a8~66@) (Mul b8~68@ c8~70@)) (Sub (Mul c8~70@ d8~72@) (Add c8~70@ c8~70@)))) (Sub (Mul (Sub (Sub b8~68@ b8~68@) (Mul a8~66@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Add a8~66@ c8~70@) (Mul b8~68@ 86)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@))))))) (=> (= temp_8_1~3978@ (Mul (Sub (Mul c8~70@ (Mul (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)))) (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ d8~72@)) (Mul a8~66@ (Mul b8~68@ c8~70@))) (Mul (Mul (Mul b8~68@ d8~72@) (Sub c8~70@ a8~66@)) (Mul (Mul a8~66@ a8~66@) (Add a8~66@ b8~68@))))) (Mul (Mul (Sub (Add (Mul d8~72@ c8~70@) (Mul b8~68@ c8~70@)) (Mul a8~66@ (Mul a8~66@ b8~68@))) (Mul (Add (Mul b8~68@ a8~66@) (Mul b8~68@ c8~70@)) (Sub (Mul c8~70@ d8~72@) (Add c8~70@ c8~70@)))) (Sub (Mul (Sub (Sub b8~68@ b8~68@) (Mul a8~66@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ d8~72@))) (Mul (Mul (Add a8~66@ c8~70@) (Mul b8~68@ 86)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@))))))) (=> (ens%main!nl_basics.lemma_mul_is_distributive. d8~72@ b8~68@ c8~70@) (=> %%location_label%%8 (= temp_8_0~3745@ temp_8_1~3978@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
