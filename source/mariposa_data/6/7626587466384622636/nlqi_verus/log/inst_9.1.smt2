...
(set-info :comment ";; mariposa_data/6//7626587466384622636/nlqi_verus/src/main.rs:7:1: 16:36 (#0)")
(push 1)
...
(declare-const temp_1_0~755@ Int)
(declare-const temp_1_1~920@ Int)
(declare-const temp_2_0~1207@ Int)
(declare-const temp_2_1~1460@ Int)
(declare-const temp_3_0~1733@ Int)
(declare-const temp_3_1~1970@ Int)
(declare-const temp_4_0~2167@ Int)
(declare-const temp_4_1~2336@ Int)
(declare-const temp_5_0~2605@ Int)
(declare-const temp_5_1~2838@ Int)
(declare-const temp_6_0~3001@ Int)
(declare-const temp_6_1~3130@ Int)
(declare-const temp_7_0~3367@ Int)
(declare-const temp_7_1~3556@ Int)
(declare-const temp_8_0~3853@ Int)
(declare-const temp_8_1~4110@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~321@ (Sub (Add (Mul (Sub c0~6@ (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ d0~8@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@)))) (Mul (Mul (Add (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Sub d0~8@ 77) (Mul d0~8@ d0~8@))) (Mul (Add (Mul b0~4@ c0~6@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ a0~2@) c0~6@)))) (Mul (Mul (Mul (Mul (Add d0~8@ b0~4@) b0~4@) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Mul (Add a0~2@ a0~2@) (Mul d0~8@ c0~6@)) (Sub (Mul a0~2@ a0~2@) b0~4@))) (Mul (Mul (Add (Mul a0~2@ d0~8@) (Mul c0~6@ c0~6@)) (Add (Mul a0~2@ b0~4@) (Add a0~2@ b0~4@))) (Mul (Sub (Mul b0~4@ d0~8@) c0~6@) (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ c0~6@))))))) (=> (= temp_0_1~562@ (Sub (Add (Mul (Sub c0~6@ (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ d0~8@))) (Mul (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@)))) (Mul (Mul (Add (Mul c0~6@ a0~2@) (Mul d0~8@ d0~8@)) (Mul (Sub d0~8@ 77) (Mul d0~8@ d0~8@))) (Mul (Add (Mul c0~6@ b0~4@) (Sub b0~4@ a0~2@)) (Mul (Mul b0~4@ a0~2@) c0~6@)))) (Mul (Mul (Mul (Mul (Add d0~8@ b0~4@) b0~4@) (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ a0~2@))) (Mul (Mul (Add a0~2@ a0~2@) (Mul d0~8@ c0~6@)) (Sub (Mul a0~2@ a0~2@) b0~4@))) (Mul (Mul (Add (Mul a0~2@ d0~8@) (Mul c0~6@ c0~6@)) (Add (Mul a0~2@ b0~4@) (Add a0~2@ b0~4@))) (Mul (Sub (Mul b0~4@ d0~8@) c0~6@) (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ c0~6@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. b0~4@ c0~6@) (=> %%location_label%%0 (= temp_0_0~321@ temp_0_1~562@))) (=> (= temp_0_0~321@ temp_0_1~562@) (=> (= temp_1_0~755@ (Sub (Mul (Mul d1~16@ (Sub (Mul (Mul c1~14@ b1~12@) (Add d1~16@ d1~16@)) (Mul (Add d1~16@ c1~14@) (Mul c1~14@ d1~16@)))) (Sub a1~10@ (Mul (Mul (Sub d1~16@ b1~12@) b1~12@) (Mul (Sub a1~10@ b1~12@) (Mul c1~14@ d1~16@))))) (Mul (Sub (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul c1~14@ b1~12@) (Mul a1~10@ c1~14@))) (Sub (Mul (Mul c1~14@ b1~12@) (Add d1~16@ c1~14@)) (Mul (Mul a1~10@ b1~12@) b1~12@))) (Mul (Sub (Mul (Mul a1~10@ a1~10@) (Add a1~10@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ a1~10@))) b1~12@)))) (=> (= temp_1_1~920@ (Sub (Mul (Mul d1~16@ (Sub (Mul (Mul c1~14@ b1~12@) (Add d1~16@ d1~16@)) (Mul (Add d1~16@ c1~14@) (Mul c1~14@ d1~16@)))) (Sub a1~10@ (Mul (Mul (Sub d1~16@ b1~12@) b1~12@) (Mul (Sub a1~10@ b1~12@) (Mul c1~14@ d1~16@))))) (Mul (Sub (Mul (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul (Mul c1~14@ b1~12@) a1~10@) c1~14@)) (Sub (Mul (Mul c1~14@ b1~12@) (Add d1~16@ c1~14@)) (Mul (Mul a1~10@ b1~12@) b1~12@))) (Mul (Sub (Mul (Mul a1~10@ a1~10@) (Add a1~10@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Mul a1~10@ a1~10@))) b1~12@)))) (and (=> (= tmp%1@ (Mul c1~14@ b1~12@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%1@ a1~10@ c1~14@) (=> %%location_label%%1 (= temp_1_0~755@ temp_1_1~920@)))) (=> (= temp_1_0~755@ temp_1_1~920@) (=> (= temp_2_0~1207@ (Mul (Mul (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ b2~20@)) (Sub (Mul a2~18@ b2~20@) b2~20@)) (Mul (Mul b2~20@ (Mul d2~24@ d2~24@)) (Mul (Mul a2~18@ d2~24@) (Add d2~24@ c2~22@)))) (Mul (Mul (Sub (Mul c2~22@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Sub c2~22@ c2~22@))) (Mul (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ d2~24@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ b2~20@))))) (Add (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) (Mul b2~20@ (Mul 47 b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Sub c2~22@ c2~22@) (Mul b2~20@ a2~18@)))) (Mul (Add (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ a2~18@)) (Sub (Sub d2~24@ b2~20@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ b2~20@) d2~24@)))))) (=> (= temp_2_1~1460@ (Mul (Mul (Mul (Mul (Mul (Mul a2~18@ d2~24@) (Mul a2~18@ b2~20@)) (Sub (Mul a2~18@ b2~20@) b2~20@)) (Mul (Mul b2~20@ (Mul d2~24@ d2~24@)) (Mul (Add d2~24@ c2~22@) (Mul a2~18@ d2~24@)))) (Mul (Mul (Sub (Mul c2~22@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul b2~20@ a2~18@) (Sub c2~22@ c2~22@))) (Mul (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ d2~24@)) (Mul (Mul d2~24@ d2~24@) (Mul b2~20@ b2~20@))))) (Add (Mul (Mul (Mul (Mul a2~18@ a2~18@) (Mul b2~20@ a2~18@)) (Mul b2~20@ (Mul 47 b2~20@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ d2~24@)) (Mul (Sub c2~22@ c2~22@) (Mul b2~20@ a2~18@)))) (Mul (Add (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ a2~18@)) (Sub (Sub d2~24@ b2~20@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul c2~22@ d2~24@) (Mul c2~22@ a2~18@)) (Mul (Mul a2~18@ b2~20@) d2~24@)))))) (and (=> (= tmp%2@ (Mul a2~18@ d2~24@)) (=> (= tmp%3@ (Add d2~24@ c2~22@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%2@ tmp%3@) (=> %%location_label%%2 (= temp_2_0~1207@ temp_2_1~1460@))))) (=> (= temp_2_0~1207@ temp_2_1~1460@) (=> (= temp_3_0~1733@ (Mul (Sub (Add (Mul (Sub (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ d3~32@))) b3~28@) (Mul (Add (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ 9)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@))) (Mul (Mul c3~30@ b3~28@) (Sub (Mul a3~26@ c3~30@) (Mul 92 d3~32@))))) (Mul (Add (Mul (Mul (Mul d3~32@ b3~28@) (Sub b3~28@ b3~28@)) (Mul (Mul a3~26@ b3~28@) a3~26@)) (Mul (Mul (Mul d3~32@ b3~28@) (Sub c3~30@ b3~28@)) (Sub (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@)))) (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ b3~28@) d3~32@)) (Mul (Sub (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@))))))) (=> (= temp_3_1~1970@ (Mul (Sub (Add (Mul (Sub (Mul b3~28@ c3~30@) (Mul a3~26@ c3~30@)) (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ d3~32@))) b3~28@) (Mul (Add (Mul (Mul b3~28@ a3~26@) (Mul b3~28@ 9)) (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ d3~32@))) (Mul (Mul c3~30@ b3~28@) (Sub (Mul a3~26@ c3~30@) (Mul 92 d3~32@))))) (Mul (Add (Mul (Mul (Mul d3~32@ b3~28@) (Sub b3~28@ b3~28@)) (Mul (Mul a3~26@ b3~28@) a3~26@)) (Mul (Mul (Mul d3~32@ b3~28@) (Sub c3~30@ b3~28@)) (Sub (Mul a3~26@ c3~30@) (Mul c3~30@ d3~32@)))) (Mul (Mul (Mul (Mul a3~26@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Mul b3~28@ b3~28@) d3~32@)) (Mul (Sub (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ b3~28@))))))) (and (=> (ens%main!nl_basics.lemma_mul_is_commutative. d3~32@ c3~30@) (=> %%location_label%%3 (= temp_3_0~1733@ temp_3_1~1970@))) (=> (= temp_3_0~1733@ temp_3_1~1970@) (=> (= temp_4_0~2167@ (Mul (Mul (Add (Mul (Add (Sub b4~36@ c4~38@) (Sub c4~38@ d4~40@)) (Sub (Sub a4~34@ b4~36@) (Mul 76 d4~40@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ c4~38@)) d4~40@)) (Mul (Mul (Mul (Add b4~36@ a4~34@) (Mul c4~38@ b4~36@)) b4~36@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul a4~34@ (Mul a4~34@ (Mul b4~36@ b4~36@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ b4~36@)) c4~38@)) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ c4~38@)) a4~34@) (Mul b4~36@ (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@))))))) (=> (= temp_4_1~2336@ (Mul (Mul (Add (Mul (Add (Sub b4~36@ c4~38@) (Sub c4~38@ d4~40@)) (Sub (Sub a4~34@ b4~36@) (Mul 76 d4~40@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ a4~34@)) d4~40@)) (Mul (Mul (Mul (Add b4~36@ a4~34@) (Mul c4~38@ b4~36@)) b4~36@) (Mul a4~34@ b4~36@))) (Mul (Mul (Mul a4~34@ (Mul a4~34@ (Mul b4~36@ b4~36@))) (Mul (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ b4~36@)) c4~38@)) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ c4~38@)) a4~34@) (Mul b4~36@ (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@))))))) (and (=> (= tmp%4@ (Mul a4~34@ a4~34@)) (=> (= tmp%5@ (Mul b4~36@ c4~38@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%4@ tmp%5@) (=> %%location_label%%4 (= temp_4_0~2167@ temp_4_1~2336@))))) (=> (= temp_4_0~2167@ temp_4_1~2336@) (=> (= temp_5_0~2605@ (Mul (Mul (Mul (Mul (Mul (Sub a5~42@ d5~48@) (Add a5~42@ d5~48@)) (Mul (Add c5~46@ b5~44@) (Mul c5~46@ a5~42@))) (Sub d5~48@ (Mul (Mul b5~44@ a5~42@) b5~44@))) (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Sub a5~42@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ c5~46@) (Sub b5~44@ d5~48@)) (Mul (Mul a5~42@ c5~46@) c5~46@)))) (Mul (Mul (Add (Mul c5~46@ (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@))) (Mul (Sub (Mul d5~48@ b5~44@) (Mul c5~46@ b5~44@)) (Add (Mul a5~42@ b5~44@) (Mul d5~48@ c5~46@)))) (Mul (Sub (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ b5~44@)) (Add (Mul d5~48@ b5~44@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ d5~48@)) (Sub (Mul a5~42@ a5~42@) (Sub d5~48@ b5~44@))))))) (=> (= temp_5_1~2838@ (Mul (Mul (Mul (Mul (Mul (Sub a5~42@ d5~48@) (Add a5~42@ d5~48@)) (Mul (Mul (Add c5~46@ b5~44@) c5~46@) a5~42@)) (Sub d5~48@ (Mul (Mul b5~44@ a5~42@) b5~44@))) (Mul (Mul (Mul (Mul a5~42@ d5~48@) (Sub a5~42@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul c5~46@ c5~46@) (Sub b5~44@ d5~48@)) (Mul (Mul a5~42@ c5~46@) c5~46@)))) (Mul (Mul (Add (Mul c5~46@ (Mul a5~42@ a5~42@)) (Mul (Mul d5~48@ a5~42@) (Mul a5~42@ d5~48@))) (Mul (Sub (Mul d5~48@ b5~44@) (Mul c5~46@ b5~44@)) (Add (Mul a5~42@ b5~44@) (Mul d5~48@ c5~46@)))) (Mul (Sub (Sub (Mul c5~46@ b5~44@) (Mul b5~44@ b5~44@)) (Add (Mul d5~48@ b5~44@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul c5~46@ d5~48@)) (Sub (Mul a5~42@ a5~42@) (Sub d5~48@ b5~44@))))))) (and (=> (= tmp%6@ (Add c5~46@ b5~44@)) (=> (ens%main!nl_basics.lemma_mul_is_associative. tmp%6@ c5~46@ a5~42@) (=> %%location_label%%5 (= temp_5_0~2605@ temp_5_1~2838@)))) (=> (= temp_5_0~2605@ temp_5_1~2838@) (=> (= temp_6_0~3001@ (Mul (Mul (Mul (Sub (Mul (Mul d6~56@ d6~56@) (Sub d6~56@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@)) (Sub (Mul c6~54@ d6~56@) (Sub c6~54@ a6~50@)))) b6~52@) (Mul (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Mul b6~52@ (Mul d6~56@ d6~56@))) (Mul (Mul (Mul c6~54@ b6~52@) (Add c6~54@ a6~50@)) (Add (Mul a6~50@ b6~52@) a6~50@))) d6~56@))) (=> (= temp_6_1~3130@ (Mul (Mul (Mul (Sub (Mul (Mul d6~56@ d6~56@) (Sub d6~56@ c6~54@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ c6~54@))) (Mul (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@)) (Sub (Mul c6~54@ d6~56@) (Sub c6~54@ a6~50@)))) b6~52@) (Mul (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Mul b6~52@ (Mul d6~56@ d6~56@))) (Mul (Add (Mul a6~50@ b6~52@) a6~50@) (Mul (Mul c6~54@ b6~52@) (Add c6~54@ a6~50@)))) d6~56@))) (and (=> (= tmp%7@ (Mul (Mul c6~54@ b6~52@) (Add c6~54@ a6~50@))) (=> (= tmp%8@ (Add (Mul a6~50@ b6~52@) a6~50@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%7@ tmp%8@) (=> %%location_label%%6 (= temp_6_0~3001@ temp_6_1~3130@))))) (=> (= temp_6_0~3001@ temp_6_1~3130@) (=> (= temp_7_0~3367@ (Mul (Mul (Mul (Mul (Mul b7~60@ c7~62@) b7~60@) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ d7~64@)) (Mul (Sub a7~58@ d7~64@) (Mul a7~58@ c7~62@)))) a7~58@) (Mul (Mul (Sub (Mul (Mul b7~60@ 23) (Mul d7~64@ b7~60@)) (Sub (Mul b7~60@ d7~64@) (Mul d7~64@ 66))) (Sub (Mul (Mul a7~58@ 13) (Mul d7~64@ b7~60@)) d7~64@)) (Sub (Sub (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Sub b7~60@ b7~60@) (Mul d7~64@ d7~64@))) (Mul (Add (Mul d7~64@ a7~58@) c7~62@) (Mul a7~58@ d7~64@)))))) (=> (= temp_7_1~3556@ (Mul (Mul (Mul (Mul (Mul b7~60@ c7~62@) b7~60@) (Mul (Mul (Mul b7~60@ b7~60@) (Mul b7~60@ d7~64@)) (Mul (Sub a7~58@ d7~64@) (Mul a7~58@ c7~62@)))) a7~58@) (Mul (Mul (Sub (Mul (Mul b7~60@ 23) (Mul d7~64@ b7~60@)) (Sub (Mul b7~60@ d7~64@) (Mul d7~64@ 66))) (Sub (Mul (Mul a7~58@ 13) (Mul d7~64@ b7~60@)) d7~64@)) (Sub (Sub (Sub (Mul c7~62@ c7~62@) (Mul c7~62@ b7~60@)) (Mul (Sub b7~60@ b7~60@) (Mul d7~64@ d7~64@))) (Mul (Mul a7~58@ d7~64@) (Add (Mul d7~64@ a7~58@) c7~62@)))))) (and (=> (= tmp%9@ (Add (Mul d7~64@ a7~58@) c7~62@)) (=> (= tmp%10@ (Mul a7~58@ d7~64@)) (=> (ens%main!nl_basics.lemma_mul_is_commutative. tmp%9@ tmp%10@) (=> %%location_label%%7 (= temp_7_0~3367@ temp_7_1~3556@))))) (=> (= temp_7_0~3367@ temp_7_1~3556@) (=> (= temp_8_0~3853@ (Mul (Mul (Mul (Add (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Add a8~66@ b8~68@) (Mul b8~68@ d8~72@))) (Add (Sub b8~68@ (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)))) (Add (Mul (Mul (Sub b8~68@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@))) (Add (Add (Mul c8~70@ d8~72@) (Mul c8~70@ a8~66@)) (Mul (Sub a8~66@ c8~70@) (Add d8~72@ a8~66@))))) (Mul (Mul (Add (Mul (Add 80 a8~66@) a8~66@) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ c8~70@))) (Mul (Sub (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Add b8~68@ a8~66@) a8~66@))) (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Add d8~72@ d8~72@)) (Sub (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul c8~70@ d8~72@) (Sub b8~68@ d8~72@)) (Mul (Mul c8~70@ d8~72@) (Sub c8~70@ d8~72@))))))) (=> (= temp_8_1~4110@ (Mul (Mul (Mul (Add (Mul (Mul c8~70@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Add a8~66@ b8~68@) (Mul b8~68@ d8~72@))) (Add (Sub b8~68@ (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)))) (Add (Mul (Mul (Sub b8~68@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@))) (Add (Add (Mul c8~70@ d8~72@) (Mul c8~70@ a8~66@)) (Mul (Sub a8~66@ c8~70@) (Add d8~72@ a8~66@))))) (Mul (Mul (Add (Mul (Add 80 a8~66@) a8~66@) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ c8~70@))) (Mul (Sub (Mul d8~72@ d8~72@) (Mul d8~72@ d8~72@)) (Mul (Add b8~68@ a8~66@) a8~66@))) (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Add d8~72@ d8~72@)) (Sub (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul d8~72@ c8~70@) (Sub b8~68@ d8~72@)) (Mul (Mul c8~70@ d8~72@) (Sub c8~70@ d8~72@))))))) (=> (ens%main!nl_basics.lemma_mul_is_commutative. c8~70@ d8~72@) (=> %%location_label%%8 (= temp_8_0~3853@ temp_8_1~4110@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
