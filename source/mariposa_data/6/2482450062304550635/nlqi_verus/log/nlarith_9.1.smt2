...
(assert (=> %%query%% (not (=> (= temp_0_0~257@ (Mul (Sub d0~8@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Add d0~8@ b0~4@)) (Mul d0~8@ c0~6@)) (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ c0~6@)) (Mul c0~6@ (Mul c0~6@ d0~8@))))) (Mul (Mul (Mul (Mul c0~6@ (Add c0~6@ a0~2@)) (Add (Sub d0~8@ d0~8@) (Mul c0~6@ c0~6@))) (Mul (Mul (Sub d0~8@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ a0~2@)))) (Mul (Sub (Mul (Mul c0~6@ a0~2@) (Add c0~6@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@))) (Mul (Add (Mul d0~8@ c0~6@) d0~8@) (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ b0~4@))))))) (=> (= temp_0_1~434@ (Mul (Sub d0~8@ (Mul (Mul (Mul (Mul b0~4@ c0~6@) (Add d0~8@ b0~4@)) (Mul d0~8@ c0~6@)) (Mul (Mul (Mul c0~6@ b0~4@) (Mul c0~6@ c0~6@)) (Mul c0~6@ (Mul c0~6@ d0~8@))))) (Mul (Mul (Mul (Mul c0~6@ (Add c0~6@ a0~2@)) (Add (Sub d0~8@ d0~8@) (Mul c0~6@ c0~6@))) (Mul (Mul (Sub d0~8@ b0~4@) (Mul c0~6@ d0~8@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ a0~2@)))) (Mul (Sub (Mul (Mul c0~6@ a0~2@) (Add c0~6@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@))) (Mul (Add (Mul d0~8@ c0~6@) d0~8@) (Mul (Mul c0~6@ c0~6@) (Mul b0~4@ b0~4@))))))) (=> (= tmp%1@ (= temp_0_0~257@ temp_0_1~434@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~718@ (Mul (Mul (Mul (Mul (Mul (Mul d1~16@ d1~16@) b1~12@) (Sub (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ b1~12@)) (Mul a1~10@ (Mul d1~16@ a1~10@)))) (Mul (Mul (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ 86))) (Sub (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@)) (Mul (Add c1~14@ d1~16@) (Mul b1~12@ b1~12@))))) (Mul (Mul (Sub (Mul (Sub c1~14@ a1~10@) (Sub d1~16@ c1~14@)) (Sub (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@))) (Mul (Mul (Add d1~16@ d1~16@) (Mul d1~16@ 87)) (Mul (Mul a1~10@ d1~16@) b1~12@))) (Mul (Sub (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ b1~12@))) (Mul (Mul (Add b1~12@ d1~16@) (Mul b1~12@ b1~12@)) (Add (Sub c1~14@ d1~16@) (Mul d1~16@ d1~16@))))))) (=> (= temp_1_1~987@ (Mul (Mul (Mul (Mul (Mul (Mul d1~16@ d1~16@) b1~12@) (Sub (Mul b1~12@ c1~14@) (Mul d1~16@ a1~10@))) (Mul (Mul (Sub b1~12@ a1~10@) (Mul b1~12@ b1~12@)) (Mul a1~10@ (Mul d1~16@ a1~10@)))) (Mul (Mul (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ 86))) (Sub (Mul (Mul a1~10@ b1~12@) (Mul c1~14@ d1~16@)) (Mul (Add c1~14@ d1~16@) (Mul b1~12@ b1~12@))))) (Mul (Mul (Sub (Mul (Sub c1~14@ a1~10@) (Sub d1~16@ c1~14@)) (Sub (Mul c1~14@ b1~12@) (Mul b1~12@ d1~16@))) (Mul (Mul (Add d1~16@ d1~16@) (Mul d1~16@ 87)) (Mul (Mul a1~10@ d1~16@) b1~12@))) (Mul (Mul (Mul (Add b1~12@ d1~16@) (Mul b1~12@ b1~12@)) (Add (Sub c1~14@ d1~16@) (Mul d1~16@ d1~16@))) (Sub (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ b1~12@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ b1~12@))))))) (=> (= tmp%2@ (= temp_1_0~718@ temp_1_1~987@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~1195@ (Mul (Mul a2~18@ (Mul b2~20@ (Mul (Add (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@)) (Sub (Mul a2~18@ a2~18@) (Mul b2~20@ c2~22@))))) (Mul (Mul (Mul (Mul (Mul c2~22@ c2~22@) (Add c2~22@ b2~20@)) (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ c2~22@))) (Sub (Mul (Add d2~24@ c2~22@) (Mul c2~22@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Mul 39 b2~20@)))) (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul 25 c2~22@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ 73))) (Mul d2~24@ (Add (Add d2~24@ d2~24@) (Mul c2~22@ b2~20@))))))) (=> (= temp_2_1~1388@ (Mul (Mul a2~18@ (Mul b2~20@ (Mul (Add (Mul d2~24@ d2~24@) (Mul b2~20@ d2~24@)) (Sub (Mul a2~18@ a2~18@) (Mul b2~20@ c2~22@))))) (Mul (Mul (Mul (Mul (Add c2~22@ b2~20@) (Mul c2~22@ c2~22@)) (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ c2~22@))) (Sub (Mul (Add d2~24@ c2~22@) (Mul c2~22@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Mul 39 b2~20@)))) (Mul (Mul (Mul (Mul d2~24@ b2~20@) (Mul 25 c2~22@)) (Mul (Mul d2~24@ b2~20@) (Mul d2~24@ 73))) (Mul d2~24@ (Add (Add d2~24@ d2~24@) (Mul c2~22@ b2~20@))))))) (=> (= tmp%3@ (= temp_2_0~1195@ temp_2_1~1388@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1616@ (Mul (Mul (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@)) (Sub (Add c3~30@ d3~32@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ d3~32@)) c3~30@)) (Add (Mul (Sub (Mul c3~30@ b3~28@) (Mul d3~32@ d3~32@)) c3~30@) (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Add d3~32@ a3~26@) (Mul c3~30@ b3~28@))))) (Mul (Sub c3~30@ (Mul (Mul (Mul a3~26@ c3~30@) (Sub c3~30@ c3~30@)) (Mul (Mul b3~28@ d3~32@) (Add c3~30@ d3~32@)))) (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul 7 c3~30@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@))) (Add (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ c3~30@)) (Mul (Sub c3~30@ b3~28@) b3~28@)))))) (=> (= temp_3_1~1829@ (Mul (Mul (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@)) (Sub (Add c3~30@ d3~32@) (Mul b3~28@ b3~28@))) (Mul (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ d3~32@)) c3~30@)) (Add (Mul (Sub (Mul c3~30@ b3~28@) (Mul d3~32@ d3~32@)) c3~30@) (Mul (Mul (Mul b3~28@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Add d3~32@ a3~26@) (Mul c3~30@ b3~28@))))) (Mul (Sub c3~30@ (Mul (Mul (Mul a3~26@ c3~30@) (Sub c3~30@ c3~30@)) (Mul (Mul b3~28@ d3~32@) (Add c3~30@ d3~32@)))) (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Mul 7 c3~30@)) (Mul (Mul c3~30@ d3~32@) (Mul a3~26@ c3~30@))) (Add (Mul (Mul a3~26@ c3~30@) (Mul c3~30@ c3~30@)) (Mul (Sub c3~30@ b3~28@) b3~28@)))))) (=> (= tmp%4@ (= temp_3_0~1616@ temp_3_1~1829@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~2073@ (Mul (Mul (Mul (Mul (Mul b4~36@ (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Add a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Add a4~34@ c4~38@) (Add d4~40@ d4~40@)))) (Mul (Mul (Mul (Mul 20 b4~36@) (Mul c4~38@ c4~38@)) (Add (Mul c4~38@ b4~36@) a4~34@)) (Mul (Mul (Mul b4~36@ a4~34@) (Sub b4~36@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul b4~36@ b4~36@))))) (Mul (Mul (Mul (Mul (Sub a4~34@ b4~36@) d4~40@) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Mul (Add d4~40@ d4~40@) (Add b4~36@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)))) (Mul (Mul (Mul (Add d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Sub (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@))) b4~36@)))) (=> (= temp_4_1~2302@ (Mul (Mul (Mul (Mul (Mul b4~36@ (Mul b4~36@ a4~34@)) (Mul (Mul d4~40@ d4~40@) (Add a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ d4~40@) (Mul d4~40@ b4~36@)) (Mul (Add a4~34@ c4~38@) (Add d4~40@ d4~40@)))) (Mul (Mul (Mul (Mul 20 b4~36@) (Mul c4~38@ c4~38@)) (Add (Mul c4~38@ b4~36@) a4~34@)) (Mul (Mul (Mul b4~36@ a4~34@) (Sub b4~36@ d4~40@)) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ c4~38@))))) (Mul (Mul (Mul (Mul (Sub a4~34@ b4~36@) d4~40@) (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ c4~38@))) (Mul (Mul (Add d4~40@ d4~40@) (Add b4~36@ a4~34@)) (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)))) (Mul (Mul (Mul (Add d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Sub (Mul c4~38@ d4~40@) (Mul c4~38@ b4~36@))) b4~36@)))) (=> (= tmp%5@ (= temp_4_0~2073@ temp_4_1~2302@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~2562@ (Mul (Mul (Sub (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@)) (Mul (Mul 72 c5~46@) (Mul b5~44@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@)))) (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul b5~44@ c5~46@)) (Sub (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul c5~46@ (Mul c5~46@ c5~46@))))) (Mul (Mul (Sub (Mul (Mul c5~46@ d5~48@) (Mul 62 d5~48@)) c5~46@) (Mul (Mul (Sub b5~44@ c5~46@) a5~42@) c5~46@)) (Mul (Mul (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ b5~44@)) (Add (Mul c5~46@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Add a5~42@ (Add d5~48@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@))))))) (=> (= temp_5_1~2807@ (Mul (Mul (Sub (Mul (Mul (Mul d5~48@ a5~42@) (Mul d5~48@ a5~42@)) (Mul (Mul b5~44@ a5~42@) (Mul 72 c5~46@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul d5~48@ b5~44@)) (Mul (Mul d5~48@ c5~46@) (Mul a5~42@ a5~42@)))) (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul b5~44@ c5~46@)) (Sub (Mul a5~42@ a5~42@) (Mul d5~48@ b5~44@))) (Mul (Mul (Mul c5~46@ b5~44@) (Mul a5~42@ c5~46@)) (Mul c5~46@ (Mul c5~46@ c5~46@))))) (Mul (Mul (Sub (Mul (Mul c5~46@ d5~48@) (Mul 62 d5~48@)) c5~46@) (Mul (Mul (Sub b5~44@ c5~46@) a5~42@) c5~46@)) (Mul (Mul (Mul (Sub a5~42@ c5~46@) (Mul a5~42@ b5~44@)) (Add (Mul c5~46@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Add a5~42@ (Add d5~48@ a5~42@)) (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@))))))) (=> (= tmp%6@ (= temp_5_0~2562@ temp_5_1~2807@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~2999@ (Mul (Mul (Mul (Add (Mul (Add d6~56@ b6~52@) (Mul a6~50@ d6~56@)) d6~56@) (Sub (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Mul 32 c6~54@)))) (Mul (Mul c6~54@ (Sub d6~56@ (Mul c6~54@ b6~52@))) (Mul d6~56@ (Add (Sub b6~52@ d6~56@) (Add c6~54@ c6~54@))))) (Mul c6~54@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ c6~54@)) (Sub (Mul a6~50@ c6~54@) (Mul c6~54@ 24))) (Sub (Add (Mul d6~56@ c6~54@) a6~50@) (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@))))))) (=> (= temp_6_1~3196@ (Mul (Mul (Sub (Mul (Add (Mul (Add d6~56@ b6~52@) (Mul a6~50@ d6~56@)) d6~56@) (Mul (Mul b6~52@ b6~52@) (Mul c6~54@ b6~52@))) (Mul (Add (Mul (Add d6~56@ b6~52@) (Mul a6~50@ d6~56@)) d6~56@) (Mul (Mul c6~54@ d6~56@) (Mul 32 c6~54@)))) (Mul (Mul c6~54@ (Sub d6~56@ (Mul c6~54@ b6~52@))) (Mul d6~56@ (Add (Sub b6~52@ d6~56@) (Add c6~54@ c6~54@))))) (Mul c6~54@ (Mul (Mul (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ c6~54@)) (Sub (Mul a6~50@ c6~54@) (Mul c6~54@ 24))) (Sub (Add (Mul d6~56@ c6~54@) a6~50@) (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ c6~54@))))))) (=> (= tmp%7@ (= temp_6_0~2999@ temp_6_1~3196@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~3460@ (Mul (Mul (Mul (Mul (Mul (Mul a7~58@ a7~58@) c7~62@) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ 15))) (Mul (Sub (Mul c7~62@ b7~60@) (Mul d7~64@ a7~58@)) (Add (Mul b7~60@ c7~62@) a7~58@))) (Mul (Mul (Sub (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@)) (Mul c7~62@ (Mul a7~58@ a7~58@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ a7~58@)) (Mul (Mul c7~62@ a7~58@) (Mul 8 c7~62@))))) (Mul (Mul (Mul (Sub (Mul b7~60@ b7~60@) d7~64@) (Sub (Mul c7~62@ b7~60@) (Mul a7~58@ b7~60@))) (Mul (Sub (Mul d7~64@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ c7~62@)))) (Mul (Mul c7~62@ (Sub c7~62@ (Mul c7~62@ b7~60@))) (Mul (Mul (Sub c7~62@ d7~64@) (Mul a7~58@ c7~62@)) (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ a7~58@))))))) (=> (= temp_7_1~3709@ (Mul (Mul (Mul (Mul (Mul (Mul a7~58@ a7~58@) c7~62@) (Mul (Mul d7~64@ b7~60@) (Mul c7~62@ 15))) (Mul (Sub (Mul c7~62@ b7~60@) (Mul d7~64@ a7~58@)) (Add (Mul b7~60@ c7~62@) a7~58@))) (Mul (Mul (Sub (Mul a7~58@ b7~60@) (Mul d7~64@ c7~62@)) (Mul c7~62@ (Mul a7~58@ a7~58@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ a7~58@)) (Mul (Mul c7~62@ a7~58@) (Mul 8 c7~62@))))) (Mul (Mul (Mul (Sub (Mul b7~60@ b7~60@) d7~64@) (Sub (Mul c7~62@ b7~60@) (Mul a7~58@ b7~60@))) (Mul (Sub (Mul d7~64@ c7~62@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ c7~62@)))) (Mul (Mul c7~62@ (Sub c7~62@ (Mul c7~62@ b7~60@))) (Mul (Mul (Mul a7~58@ c7~62@) (Sub c7~62@ d7~64@)) (Mul (Mul c7~62@ b7~60@) (Mul c7~62@ a7~58@))))))) (=> (= tmp%8@ (= temp_7_0~3460@ temp_7_1~3709@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~3925@ (Mul (Mul (Mul c8~70@ b8~68@) (Mul (Mul (Mul (Add c8~70@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Sub a8~66@ d8~72@) (Mul d8~72@ b8~68@))) (Mul (Mul (Sub d8~72@ b8~68@) (Mul a8~66@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ d8~72@))))) (Mul (Mul (Mul (Mul d8~72@ (Mul a8~66@ b8~68@)) (Mul c8~70@ (Mul a8~66@ a8~66@))) (Sub (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul 81 b8~68@) (Mul d8~72@ a8~66@)))) (Sub (Mul (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Sub a8~66@ a8~66@))) (Sub (Mul (Mul c8~70@ c8~70@) b8~68@) (Add (Mul a8~66@ c8~70@) (Mul c8~70@ b8~68@))))))) (=> (= temp_8_1~4134@ (Mul (Mul (Mul c8~70@ b8~68@) (Mul (Mul (Mul (Add c8~70@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Sub a8~66@ d8~72@) (Mul d8~72@ b8~68@))) (Mul (Sub (Mul d8~72@ (Mul a8~66@ c8~70@)) (Mul b8~68@ (Mul a8~66@ c8~70@))) (Mul (Mul a8~66@ a8~66@) (Mul d8~72@ d8~72@))))) (Mul (Mul (Mul (Mul d8~72@ (Mul a8~66@ b8~68@)) (Mul c8~70@ (Mul a8~66@ a8~66@))) (Sub (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul 81 b8~68@) (Mul d8~72@ a8~66@)))) (Sub (Mul (Mul (Mul c8~70@ b8~68@) (Mul b8~68@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Sub a8~66@ a8~66@))) (Sub (Mul (Mul c8~70@ c8~70@) b8~68@) (Add (Mul a8~66@ c8~70@) (Mul c8~70@ b8~68@))))))) (=> (= tmp%9@ (= temp_8_0~3925@ temp_8_1~4134@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
