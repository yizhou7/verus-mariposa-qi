...
(assert (=> %%query%% (not (=> (= temp_0_0~273@ (Mul (Mul (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Add c0~6@ b0~4@))) (Sub (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@)) a0~2@)) (Mul c0~6@ (Mul (Mul (Mul b0~4@ a0~2@) c0~6@) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ d0~8@))))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul (Mul (Add b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Sub (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@)))) (Sub (Add (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Mul d0~8@ (Sub a0~2@ d0~8@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul a0~2@ 11) d0~8@)))))) (=> (= temp_0_1~470@ (Mul (Mul (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ a0~2@)) (Mul (Mul d0~8@ c0~6@) (Add c0~6@ b0~4@))) (Sub (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@)) a0~2@)) (Mul c0~6@ (Mul (Mul (Mul b0~4@ a0~2@) c0~6@) (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ d0~8@))))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul (Mul (Add b0~4@ a0~2@) (Mul c0~6@ d0~8@)) (Sub (Mul d0~8@ d0~8@) (Mul c0~6@ b0~4@)))) (Sub (Add (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Sub (Mul d0~8@ a0~2@) (Mul d0~8@ d0~8@))) (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul a0~2@ 11) d0~8@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~273@ temp_0_1~470@))) (=> (= temp_0_0~273@ temp_0_1~470@) (=> (= temp_1_0~743@ (Mul (Mul (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@ b1~12@) (Sub b1~12@ c1~14@))) (Add (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Add b1~12@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ b1~12@) d1~16@) (Add (Mul d1~16@ d1~16@) (Mul b1~12@ 28))) (Mul b1~12@ (Mul (Mul a1~10@ b1~12@) (Sub b1~12@ b1~12@))))) (Mul (Mul (Mul (Mul a1~10@ (Mul d1~16@ d1~16@)) (Mul (Sub a1~10@ d1~16@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) d1~16@)) (Mul (Sub (Mul (Mul a1~10@ a1~10@) (Sub d1~16@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul a1~10@ a1~10@) (Mul 1 d1~16@)) (Mul (Mul d1~16@ b1~12@) (Sub a1~10@ a1~10@))))))) (=> (= temp_1_1~992@ (Mul (Mul (Mul (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@ b1~12@) (Sub b1~12@ c1~14@))) (Add (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Add b1~12@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ b1~12@) d1~16@) (Add (Mul d1~16@ d1~16@) (Mul b1~12@ 28))) (Mul b1~12@ (Mul (Mul a1~10@ b1~12@) (Sub b1~12@ b1~12@))))) (Mul (Mul (Mul (Mul a1~10@ (Mul d1~16@ d1~16@)) (Mul (Sub a1~10@ d1~16@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul d1~16@ a1~10@) (Mul c1~14@ b1~12@)) d1~16@)) (Mul (Sub (Mul (Mul a1~10@ a1~10@) (Sub d1~16@ d1~16@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul a1~10@ a1~10@) (Mul 1 d1~16@)) (Mul (Mul d1~16@ b1~12@) (Sub a1~10@ a1~10@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~743@ temp_1_1~992@))) (=> (= temp_1_0~743@ temp_1_1~992@) (=> (= temp_2_0~1249@ (Mul (Mul (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Add c2~22@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@))) (Mul (Sub d2~24@ b2~20@) (Mul (Mul a2~18@ a2~18@) (Mul 63 b2~20@)))) (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Sub d2~24@ b2~20@)) c2~22@) (Mul (Mul (Sub c2~22@ d2~24@) b2~20@) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@))))) (Mul (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@)) (Mul c2~22@ a2~18@)) (Sub (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ d2~24@)) (Mul d2~24@ (Mul b2~20@ c2~22@)))) (Mul (Mul (Add (Add c2~22@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ d2~24@))))))) (=> (= temp_2_1~1482@ (Mul (Mul (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Add c2~22@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ a2~18@))) (Mul (Sub d2~24@ b2~20@) (Mul (Mul a2~18@ a2~18@) (Mul 63 b2~20@)))) (Mul (Mul (Mul (Mul d2~24@ c2~22@) (Sub d2~24@ b2~20@)) c2~22@) (Mul (Mul (Sub c2~22@ d2~24@) b2~20@) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@))))) (Mul (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul b2~20@ d2~24@)) (Mul c2~22@ a2~18@)) (Sub (Mul (Mul a2~18@ a2~18@) (Mul c2~22@ d2~24@)) (Mul d2~24@ (Mul b2~20@ c2~22@)))) (Mul (Mul (Add (Add c2~22@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul c2~22@ d2~24@) (Mul d2~24@ c2~22@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1249@ temp_2_1~1482@))) (=> (= temp_2_0~1249@ temp_2_1~1482@) (=> (= temp_3_0~1779@ (Mul (Mul (Mul (Sub (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ a3~26@))) (Mul (Sub (Add d3~32@ b3~28@) (Sub 14 d3~32@)) (Sub (Add a3~26@ a3~26@) (Mul b3~28@ c3~30@)))) (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@)) a3~26@) (Sub (Mul (Mul c3~30@ a3~26@) (Add a3~26@ c3~30@)) (Mul (Sub a3~26@ b3~28@) (Mul d3~32@ b3~28@))))) (Sub (Mul (Mul (Mul (Sub c3~30@ b3~28@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ d3~32@))) (Mul (Mul (Mul d3~32@ 13) d3~32@) (Mul (Mul c3~30@ a3~26@) (Add d3~32@ b3~28@)))) (Mul (Mul (Mul (Sub b3~28@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ 56) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ d3~32@) d3~32@)))))) (=> (= temp_3_1~2072@ (Mul (Mul (Mul (Sub (Mul (Mul b3~28@ c3~30@) (Mul d3~32@ a3~26@)) (Mul (Mul c3~30@ b3~28@) (Mul c3~30@ a3~26@))) (Mul (Sub (Add d3~32@ b3~28@) (Sub 14 d3~32@)) (Sub (Add a3~26@ a3~26@) (Mul b3~28@ c3~30@)))) (Sub (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@)) a3~26@) (Mul (Mul c3~30@ a3~26@) (Add a3~26@ c3~30@))) (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@)) a3~26@) (Mul (Sub a3~26@ b3~28@) (Mul d3~32@ b3~28@))))) (Sub (Mul (Mul (Mul (Sub c3~30@ b3~28@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ d3~32@))) (Mul (Mul (Mul d3~32@ 13) d3~32@) (Mul (Mul c3~30@ a3~26@) (Add d3~32@ b3~28@)))) (Mul (Mul (Mul (Sub b3~28@ a3~26@) (Mul b3~28@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ c3~30@))) (Mul (Mul (Mul c3~30@ 56) (Mul c3~30@ a3~26@)) (Mul (Mul a3~26@ d3~32@) d3~32@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1779@ temp_3_1~2072@))) (=> (= temp_3_0~1779@ temp_3_1~2072@) (=> (= temp_4_0~2237@ (Mul (Mul (Mul c4~38@ (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@)))) (Sub (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Add a4~34@ b4~36@))))) (Mul (Mul a4~34@ (Mul (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ 9)) c4~38@)) d4~40@))) (=> (= temp_4_1~2378@ (Mul (Mul (Sub (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Mul a4~34@ d4~40@))) (Mul (Mul (Mul c4~38@ c4~38@) (Mul c4~38@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Add a4~34@ b4~36@)))) (Mul c4~38@ (Mul (Mul (Mul b4~36@ b4~36@) (Mul a4~34@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@))))) (Mul (Mul a4~34@ (Mul (Mul (Mul c4~38@ a4~34@) (Mul c4~38@ 9)) c4~38@)) d4~40@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~2237@ temp_4_1~2378@))) (=> (= temp_4_0~2237@ temp_4_1~2378@) (=> (= temp_5_0~2579@ (Mul (Mul (Mul (Sub (Add (Mul b5~44@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ d5~48@))) (Add (Mul (Mul c5~46@ b5~44@) a5~42@) (Mul (Mul a5~42@ b5~44@) a5~42@))) (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Add (Mul a5~42@ d5~48@) (Mul b5~44@ b5~44@))) (Add (Mul (Mul b5~44@ a5~42@) c5~46@) (Mul (Mul c5~46@ c5~46@) (Add c5~46@ a5~42@))))) (Mul (Mul (Add (Mul d5~48@ (Mul d5~48@ b5~44@)) (Mul 45 (Mul a5~42@ a5~42@))) (Sub (Sub (Mul a5~42@ b5~44@) (Add a5~42@ c5~46@)) b5~44@)) a5~42@))) (=> (= temp_5_1~2788@ (Mul (Mul (Mul (Sub (Add (Mul b5~44@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Mul b5~44@ a5~42@) (Mul c5~46@ d5~48@))) (Add (Mul (Mul c5~46@ b5~44@) a5~42@) (Mul (Mul a5~42@ b5~44@) a5~42@))) (Add (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Add (Mul a5~42@ d5~48@) (Mul b5~44@ b5~44@))) (Mul (Mul b5~44@ a5~42@) c5~46@)) (Mul (Mul (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Add (Mul a5~42@ d5~48@) (Mul b5~44@ b5~44@))) (Mul (Mul c5~46@ c5~46@) (Add c5~46@ a5~42@))))) (Mul (Mul (Add (Mul d5~48@ (Mul d5~48@ b5~44@)) (Mul 45 (Mul a5~42@ a5~42@))) (Sub (Sub (Mul a5~42@ b5~44@) (Add a5~42@ c5~46@)) b5~44@)) a5~42@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2579@ temp_5_1~2788@))) (=> (= temp_5_0~2579@ temp_5_1~2788@) (=> (= temp_6_0~2977@ (Mul (Mul b6~52@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ d6~56@))) a6~50@)) (Mul (Mul (Mul (Add (Mul a6~50@ d6~56@) (Sub a6~50@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ c6~54@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul 57 c6~54@)) (Mul (Mul c6~54@ c6~54@) d6~56@))) (Mul (Mul c6~54@ (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@))) (Sub (Mul (Add b6~52@ d6~56@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ d6~56@))))))) (=> (= temp_6_1~3142@ (Mul (Mul b6~52@ (Mul (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ b6~52@)) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ d6~56@))) a6~50@)) (Mul (Mul (Mul (Add (Mul a6~50@ d6~56@) (Sub a6~50@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ d6~56@))) (Mul (Mul (Mul d6~56@ c6~54@) (Mul 57 c6~54@)) (Mul (Mul c6~54@ c6~54@) d6~56@))) (Mul (Mul c6~54@ (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@))) (Sub (Mul (Add b6~52@ d6~56@) (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ a6~50@) (Sub b6~52@ d6~56@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~2977@ temp_6_1~3142@))) (=> (= temp_6_0~2977@ temp_6_1~3142@) (=> (= temp_7_0~3323@ (Add (Mul (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Add a7~58@ d7~64@)) (Mul (Sub a7~58@ a7~58@) (Mul a7~58@ d7~64@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Sub c7~62@ a7~58@)))) d7~64@) (Sub (Sub (Sub (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul d7~64@ b7~60@) (Add b7~60@ a7~58@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ d7~64@)) a7~58@)) (Mul d7~64@ (Mul (Mul (Mul a7~58@ a7~58@) (Sub d7~64@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ a7~58@))))))) (=> (= temp_7_1~3480@ (Add (Mul (Mul (Mul (Mul (Mul a7~58@ b7~60@) (Add a7~58@ d7~64@)) (Mul (Sub a7~58@ a7~58@) (Mul a7~58@ d7~64@))) (Mul (Mul (Mul d7~64@ b7~60@) (Mul b7~60@ c7~62@)) (Mul (Mul a7~58@ d7~64@) (Sub c7~62@ a7~58@)))) d7~64@) (Sub (Sub (Sub (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Mul d7~64@ b7~60@) (Add b7~60@ a7~58@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ c7~62@)) a7~58@)) (Mul d7~64@ (Mul (Mul (Mul a7~58@ a7~58@) (Sub d7~64@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ a7~58@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3323@ temp_7_1~3480@))) (=> (= temp_7_0~3323@ temp_7_1~3480@) (=> (= temp_8_0~3741@ (Mul (Mul (Mul (Add (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Sub (Mul b8~68@ b8~68@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ b8~68@)))) (Mul (Mul (Mul (Sub c8~70@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Sub a8~66@ b8~68@))) (Mul (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Add b8~68@ d8~72@))))) (Mul (Mul (Mul (Sub a8~66@ (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@))) (Mul (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ a8~66@)) (Sub a8~66@ (Mul d8~72@ b8~68@)))) (Mul (Mul (Add (Mul d8~72@ c8~70@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@))) (Mul a8~66@ (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ a8~66@))))))) (=> (= temp_8_1~3978@ (Mul (Mul (Mul (Add (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ d8~72@)) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ c8~70@))) (Mul (Sub (Mul b8~68@ b8~68@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ b8~68@)))) (Mul (Mul (Mul (Sub c8~70@ c8~70@) (Mul b8~68@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Sub a8~66@ b8~68@))) (Mul (Mul (Mul d8~72@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Add b8~68@ d8~72@))))) (Mul (Mul (Mul (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ a8~66@)) (Sub a8~66@ (Mul d8~72@ b8~68@))) (Mul (Sub a8~66@ (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ b8~68@)))) (Mul (Mul (Add (Mul d8~72@ c8~70@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@))) (Mul a8~66@ (Mul (Mul c8~70@ d8~72@) (Mul c8~70@ a8~66@))))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~3741@ temp_8_1~3978@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
