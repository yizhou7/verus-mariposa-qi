...
(declare-const temp_2_0~1289@ Int)
(declare-const temp_2_1~1582@ Int)
(declare-const temp_3_0~1823@ Int)
(declare-const temp_3_1~2040@ Int)
(declare-const temp_4_0~2237@ Int)
(declare-const temp_4_1~2410@ Int)
(declare-const temp_5_0~2643@ Int)
(declare-const temp_5_1~2860@ Int)
(declare-const temp_6_0~3145@ Int)
(declare-const temp_6_1~3406@ Int)
(declare-const temp_7_0~3647@ Int)
(declare-const temp_7_1~3864@ Int)
(declare-const temp_8_0~4053@ Int)
(declare-const temp_8_1~4226@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~333@ (Mul (Mul (Mul (Sub (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ 33) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul a0~2@ b0~4@) b0~4@) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ a0~2@)))) (Mul (Add (Mul a0~2@ (Mul b0~4@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Mul 19 b0~4@))) (Mul (Add (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ d0~8@))))) (Sub (Mul (Sub (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ a0~2@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ d0~8@))) (Mul (Mul (Mul b0~4@ c0~6@) (Add d0~8@ a0~2@)) (Mul b0~4@ (Mul d0~8@ b0~4@)))) (Mul (Mul a0~2@ (Mul a0~2@ (Mul c0~6@ a0~2@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ d0~8@))))))) (=> (= temp_0_1~586@ (Mul (Mul (Mul (Sub (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ d0~8@)) (Mul (Mul b0~4@ 33) (Mul a0~2@ d0~8@))) (Mul (Mul (Mul a0~2@ b0~4@) b0~4@) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ a0~2@)))) (Mul (Add (Mul a0~2@ (Mul b0~4@ c0~6@)) (Mul (Mul b0~4@ d0~8@) (Mul 19 b0~4@))) (Mul (Add (Mul b0~4@ c0~6@) (Mul d0~8@ c0~6@)) (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ d0~8@))))) (Sub (Mul (Sub (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ d0~8@)) (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ d0~8@))) (Mul (Mul (Mul b0~4@ c0~6@) (Add d0~8@ a0~2@)) (Mul b0~4@ (Mul d0~8@ b0~4@)))) (Mul (Mul a0~2@ (Mul a0~2@ (Mul c0~6@ a0~2@))) (Mul (Mul (Mul c0~6@ a0~2@) (Mul c0~6@ c0~6@)) (Mul (Mul c0~6@ c0~6@) (Mul d0~8@ d0~8@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~333@ temp_0_1~586@))) (=> (= temp_0_0~333@ temp_0_1~586@) (=> (= temp_1_0~791@ (Mul (Mul (Mul (Mul (Mul (Mul d1~16@ c1~14@) a1~10@) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ a1~10@)) (Mul (Mul b1~12@ d1~16@) d1~16@))) b1~12@) (Mul (Mul (Mul (Mul (Add a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul b1~12@ (Mul b1~12@ a1~10@))) (Add (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)))) (Mul (Mul (Add (Sub d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Add (Mul b1~12@ b1~12@) (Mul b1~12@ c1~14@))) (Mul (Sub c1~14@ (Mul b1~12@ b1~12@)) (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@))))))) (=> (= temp_1_1~972@ (Mul (Mul (Mul (Mul (Mul (Mul d1~16@ c1~14@) a1~10@) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul c1~14@ a1~10@) (Mul b1~12@ a1~10@)) (Mul d1~16@ (Mul b1~12@ d1~16@)))) b1~12@) (Mul (Mul (Mul (Mul (Add a1~10@ b1~12@) (Mul c1~14@ a1~10@)) (Mul b1~12@ (Mul b1~12@ a1~10@))) (Add (Mul (Mul a1~10@ a1~10@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@)))) (Mul (Mul (Add (Sub d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Add (Mul b1~12@ b1~12@) (Mul b1~12@ c1~14@))) (Mul (Sub c1~14@ (Mul b1~12@ b1~12@)) (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ a1~10@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~791@ temp_1_1~972@))) (=> (= temp_1_0~791@ temp_1_1~972@) (=> (= temp_2_0~1289@ (Add (Mul (Mul (Mul (Add (Mul a2~18@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ 16) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul b2~20@ a2~18@) (Add a2~18@ 77)) (Mul (Sub b2~20@ c2~22@) (Mul c2~22@ a2~18@)))) (Mul (Add (Sub (Mul c2~22@ d2~24@) (Mul b2~20@ 15)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ c2~22@))) (Sub (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ 65)) (Mul (Add b2~20@ d2~24@) d2~24@)))) (Mul (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ b2~20@)) d2~24@) (Mul (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Sub d2~24@ b2~20@)))) (Add (Mul (Sub a2~18@ (Mul d2~24@ 90)) (Mul (Mul d2~24@ b2~20@) c2~22@)) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ a2~18@))))))) (=> (= temp_2_1~1582@ (Add (Mul (Mul (Mul (Add (Mul a2~18@ c2~22@) (Mul b2~20@ b2~20@)) (Mul (Mul a2~18@ 16) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul b2~20@ a2~18@) (Add a2~18@ 77)) (Mul (Sub b2~20@ c2~22@) (Mul c2~22@ a2~18@)))) (Mul (Add (Sub (Mul c2~22@ d2~24@) (Mul b2~20@ 15)) (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ c2~22@))) (Sub (Mul (Mul c2~22@ d2~24@) (Mul b2~20@ 65)) (Mul (Add b2~20@ d2~24@) d2~24@)))) (Mul (Mul (Add (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ b2~20@)) d2~24@) (Mul (Mul (Mul c2~22@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Mul d2~24@ a2~18@) (Sub d2~24@ b2~20@)))) (Add (Mul (Sub a2~18@ (Mul d2~24@ 90)) (Mul (Mul b2~20@ d2~24@) c2~22@)) (Mul (Mul (Mul c2~22@ a2~18@) (Add b2~20@ c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul b2~20@ a2~18@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1289@ temp_2_1~1582@))) (=> (= temp_2_0~1289@ temp_2_1~1582@) (=> (= temp_3_0~1823@ (Mul (Mul (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul c3~30@ b3~28@) b3~28@)) (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@)) (Sub (Mul c3~30@ b3~28@) (Mul b3~28@ d3~32@)))) (Mul (Mul a3~26@ (Mul c3~30@ (Add c3~30@ a3~26@))) (Add a3~26@ (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ a3~26@))))) (Mul (Mul (Mul (Sub (Mul b3~28@ b3~28@) (Mul 21 d3~32@)) (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@))) (Mul d3~32@ (Mul (Mul b3~28@ a3~26@) (Sub a3~26@ a3~26@)))) (Add (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ d3~32@)) (Mul (Mul b3~28@ a3~26@) d3~32@)) (Add (Mul (Mul d3~32@ d3~32@) (Sub b3~28@ d3~32@)) (Mul c3~30@ (Mul b3~28@ b3~28@))))))) (=> (= temp_3_1~2040@ (Mul (Mul (Mul (Mul (Mul (Mul a3~26@ d3~32@) (Mul c3~30@ a3~26@)) (Mul (Mul c3~30@ b3~28@) b3~28@)) (Mul (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ c3~30@)) (Sub (Mul c3~30@ b3~28@) (Mul b3~28@ d3~32@)))) (Mul (Mul a3~26@ (Mul c3~30@ (Add c3~30@ a3~26@))) (Add a3~26@ (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ a3~26@))))) (Mul (Mul (Mul (Sub (Mul b3~28@ b3~28@) (Mul 21 d3~32@)) (Mul (Mul c3~30@ c3~30@) (Mul a3~26@ d3~32@))) (Mul d3~32@ (Mul (Mul b3~28@ a3~26@) (Sub a3~26@ a3~26@)))) (Add (Mul (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ d3~32@)) (Mul b3~28@ a3~26@)) d3~32@) (Add (Mul (Mul d3~32@ d3~32@) (Sub b3~28@ d3~32@)) (Mul c3~30@ (Mul b3~28@ b3~28@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1823@ temp_3_1~2040@))) (=> (= temp_3_0~1823@ temp_3_1~2040@) (=> (= temp_4_0~2237@ (Mul (Mul d4~40@ (Mul (Mul (Add (Mul b4~36@ a4~34@) (Add a4~34@ c4~38@)) (Mul (Mul b4~36@ b4~36@) a4~34@)) (Mul (Mul (Sub d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ b4~36@) d4~40@)))) (Mul (Sub (Mul (Mul b4~36@ (Mul c4~38@ a4~34@)) (Mul (Sub d4~40@ b4~36@) (Mul d4~40@ d4~40@))) (Sub (Mul (Sub d4~40@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Sub a4~34@ c4~38@) (Mul d4~40@ a4~34@)))) (Add (Mul a4~34@ (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ c4~38@))))))) (=> (= temp_4_1~2410@ (Mul (Mul d4~40@ (Mul (Mul (Add (Mul b4~36@ a4~34@) (Add a4~34@ c4~38@)) (Mul (Mul b4~36@ b4~36@) a4~34@)) (Mul (Mul (Sub d4~40@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ b4~36@) d4~40@)))) (Mul (Sub (Mul b4~36@ (Mul (Mul c4~38@ a4~34@) (Mul (Sub d4~40@ b4~36@) (Mul d4~40@ d4~40@)))) (Sub (Mul (Sub d4~40@ b4~36@) (Mul b4~36@ c4~38@)) (Mul (Sub a4~34@ c4~38@) (Mul d4~40@ a4~34@)))) (Add (Mul a4~34@ (Mul (Mul a4~34@ c4~38@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul b4~36@ c4~38@) (Mul a4~34@ c4~38@)) (Mul (Mul a4~34@ b4~36@) (Mul b4~36@ c4~38@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~2237@ temp_4_1~2410@))) (=> (= temp_4_0~2237@ temp_4_1~2410@) (=> (= temp_5_0~2643@ (Mul (Mul (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@)) d5~48@) (Sub (Add c5~46@ c5~46@) (Mul (Sub d5~48@ b5~44@) (Mul a5~42@ c5~46@)))) (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Add d5~48@ c5~46@))) (Mul (Mul (Sub b5~44@ c5~46@) (Mul c5~46@ c5~46@)) (Mul (Mul d5~48@ c5~46@) (Add a5~42@ b5~44@))))) (Mul (Mul (Sub (Mul (Add c5~46@ b5~44@) d5~48@) (Mul (Mul c5~46@ d5~48@) (Sub c5~46@ b5~44@))) (Mul (Mul (Mul b5~44@ a5~42@) b5~44@) (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)))) (Mul (Sub a5~42@ (Sub b5~44@ (Add b5~44@ d5~48@))) (Mul (Mul (Sub b5~44@ c5~46@) b5~44@) (Mul (Mul b5~44@ d5~48@) (Sub b5~44@ d5~48@))))))) (=> (= temp_5_1~2860@ (Mul (Mul (Mul (Mul (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ b5~44@)) d5~48@) (Sub (Add c5~46@ c5~46@) (Mul (Sub d5~48@ b5~44@) (Mul a5~42@ c5~46@)))) (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ c5~46@)) (Mul (Mul b5~44@ c5~46@) (Add d5~48@ c5~46@))) (Mul (Mul (Sub b5~44@ c5~46@) (Mul c5~46@ c5~46@)) (Add (Mul (Mul d5~48@ c5~46@) a5~42@) (Mul (Mul d5~48@ c5~46@) b5~44@))))) (Mul (Mul (Sub (Mul (Add c5~46@ b5~44@) d5~48@) (Mul (Mul c5~46@ d5~48@) (Sub c5~46@ b5~44@))) (Mul (Mul (Mul b5~44@ a5~42@) b5~44@) (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ d5~48@)))) (Mul (Sub a5~42@ (Sub b5~44@ (Add b5~44@ d5~48@))) (Mul (Mul (Sub b5~44@ c5~46@) b5~44@) (Mul (Mul b5~44@ d5~48@) (Sub b5~44@ d5~48@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2643@ temp_5_1~2860@))) (=> (= temp_5_0~2643@ temp_5_1~2860@) (=> (= temp_6_0~3145@ (Mul (Mul (Add (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@)) (Mul (Mul c6~54@ a6~50@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ c6~54@)) (Mul b6~52@ (Sub c6~54@ d6~56@)))) (Mul (Mul (Mul (Sub c6~54@ c6~54@) (Mul c6~54@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Mul (Sub c6~54@ b6~52@) (Mul c6~54@ d6~56@)) (Sub (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (Mul (Mul (Mul (Sub (Sub d6~56@ c6~54@) (Sub c6~54@ c6~54@)) (Mul a6~50@ (Mul a6~50@ b6~52@))) (Sub (Sub (Mul b6~52@ c6~54@) (Add c6~54@ b6~52@)) (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ a6~50@)))) (Add (Mul (Mul (Add d6~56@ a6~50@) (Sub 71 d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul b6~52@ b6~52@)) (Mul (Sub d6~56@ a6~50@) (Mul c6~54@ a6~50@))))))) (=> (= temp_6_1~3406@ (Mul (Mul (Add (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ b6~52@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul c6~54@ c6~54@)) (Mul b6~52@ (Sub c6~54@ d6~56@)))) (Mul (Mul (Mul (Sub c6~54@ c6~54@) (Mul c6~54@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ a6~50@))) (Mul (Mul (Sub c6~54@ b6~52@) (Mul c6~54@ d6~56@)) (Sub (Mul a6~50@ c6~54@) (Mul c6~54@ c6~54@))))) (Mul (Mul (Mul (Sub (Sub d6~56@ c6~54@) (Sub c6~54@ c6~54@)) (Mul a6~50@ (Mul a6~50@ b6~52@))) (Sub (Sub (Mul b6~52@ c6~54@) (Add c6~54@ b6~52@)) (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ a6~50@)))) (Add (Mul (Mul (Add d6~56@ a6~50@) (Sub 71 d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul d6~56@ a6~50@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul b6~52@ b6~52@)) (Mul (Sub d6~56@ a6~50@) (Mul c6~54@ a6~50@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~3145@ temp_6_1~3406@))) (=> (= temp_6_0~3145@ temp_6_1~3406@) (=> (= temp_7_0~3647@ (Mul (Mul (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul 4 c7~62@)) (Mul b7~60@ (Mul d7~64@ b7~60@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ a7~58@)))) (Sub (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@)) (Add (Sub c7~62@ c7~62@) (Add a7~58@ b7~60@))) a7~58@)) (Sub (Mul (Mul d7~64@ (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@))) (Mul (Mul (Sub c7~62@ a7~58@) a7~58@) (Sub (Add d7~64@ d7~64@) (Mul 16 c7~62@)))) (Mul (Mul (Mul (Mul c7~62@ b7~60@) c7~62@) (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ c7~62@)) b7~60@))))) (=> (= temp_7_1~3864@ (Mul (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul 4 c7~62@)) (Mul b7~60@ (Mul d7~64@ b7~60@))) (Mul (Mul (Mul d7~64@ c7~62@) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ a7~58@)))) (Mul (Sub (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ a7~58@)) (Add (Sub c7~62@ c7~62@) (Add a7~58@ b7~60@))) a7~58@) (Sub (Mul (Mul d7~64@ (Mul (Mul b7~60@ b7~60@) (Mul a7~58@ c7~62@))) (Mul (Mul (Sub c7~62@ a7~58@) a7~58@) (Sub (Add d7~64@ d7~64@) (Mul 16 c7~62@)))) (Mul (Mul (Mul (Mul c7~62@ b7~60@) c7~62@) (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul b7~60@ b7~60@) (Mul d7~64@ c7~62@)) b7~60@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3647@ temp_7_1~3864@))) (=> (= temp_7_0~3647@ temp_7_1~3864@) (=> (= temp_8_0~4053@ (Mul (Mul (Add (Mul (Mul (Mul a8~66@ d8~72@) (Add b8~68@ b8~68@)) (Add c8~70@ (Mul b8~68@ d8~72@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ d8~72@)) (Sub d8~72@ (Sub a8~66@ d8~72@)))) (Mul (Mul d8~72@ (Mul (Mul c8~70@ c8~70@) (Sub c8~70@ b8~68@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@)) (Mul b8~68@ (Mul d8~72@ a8~66@))))) (Mul c8~70@ (Mul (Mul (Mul c8~70@ (Mul c8~70@ b8~68@)) (Mul c8~70@ (Add a8~66@ d8~72@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ d8~72@))))))) (=> (= temp_8_1~4226@ (Mul (Mul (Add (Mul (Add (Mul (Mul a8~66@ d8~72@) b8~68@) (Mul (Mul a8~66@ d8~72@) b8~68@)) (Add c8~70@ (Mul b8~68@ d8~72@))) (Mul (Mul (Mul d8~72@ d8~72@) (Mul b8~68@ d8~72@)) (Sub d8~72@ (Sub a8~66@ d8~72@)))) (Mul (Mul d8~72@ (Mul (Mul c8~70@ c8~70@) (Sub c8~70@ b8~68@))) (Mul (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ c8~70@)) (Mul b8~68@ (Mul d8~72@ a8~66@))))) (Mul c8~70@ (Mul (Mul (Mul c8~70@ (Mul c8~70@ b8~68@)) (Mul c8~70@ (Add a8~66@ d8~72@))) (Mul (Mul (Mul b8~68@ b8~68@) (Mul b8~68@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ d8~72@))))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~4053@ temp_8_1~4226@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
