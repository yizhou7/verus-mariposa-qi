...
(declare-const temp_3_0~1551@ Int)
(declare-const temp_3_1~1800@ Int)
(declare-const temp_4_0~1929@ Int)
(declare-const temp_4_1~2034@ Int)
(declare-const temp_5_0~2287@ Int)
(declare-const temp_5_1~2516@ Int)
(declare-const temp_6_0~2809@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~337@ (Sub (Mul (Mul (Sub (Mul (Mul c0~6@ b0~4@) (Sub d0~8@ b0~4@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))) (Mul (Sub (Mul b0~4@ c0~6@) (Mul c0~6@ b0~4@)) (Mul d0~8@ (Mul a0~2@ d0~8@)))) (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ c0~6@)) (Mul (Sub a0~2@ c0~6@) (Sub d0~8@ d0~8@))) (Mul (Add (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@)) (Mul 80 a0~2@)))) (Add (Sub (Sub (Mul (Sub 26 c0~6@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ d0~8@) b0~4@))) (Mul (Sub (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@)) (Mul a0~2@ (Mul a0~2@ c0~6@))) (Sub (Add (Sub b0~4@ a0~2@) a0~2@) (Add (Mul a0~2@ c0~6@) (Mul a0~2@ a0~2@))))))) (=> (= temp_0_1~594@ (Sub (Mul (Mul (Sub (Mul (Mul c0~6@ b0~4@) (Sub d0~8@ b0~4@)) (Mul (Mul b0~4@ d0~8@) (Mul c0~6@ b0~4@))) (Mul (Mul d0~8@ (Mul a0~2@ d0~8@)) (Sub (Mul b0~4@ c0~6@) (Mul c0~6@ b0~4@)))) (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ c0~6@)) (Mul (Sub a0~2@ c0~6@) (Sub d0~8@ d0~8@))) (Mul (Add (Mul b0~4@ c0~6@) (Mul a0~2@ d0~8@)) (Mul 80 a0~2@)))) (Add (Sub (Sub (Mul (Sub 26 c0~6@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Mul a0~2@ a0~2@))) (Mul (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Mul b0~4@ d0~8@) b0~4@))) (Mul (Sub (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ a0~2@)) (Mul a0~2@ (Mul a0~2@ c0~6@))) (Sub (Add (Sub b0~4@ a0~2@) a0~2@) (Add (Mul a0~2@ c0~6@) (Mul a0~2@ a0~2@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~337@ temp_0_1~594@))) (=> (= temp_0_0~337@ temp_0_1~594@) (=> (= temp_1_0~819@ (Mul (Mul (Mul (Mul (Add (Mul d1~16@ d1~16@) (Mul 66 c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ d1~16@)))) (Mul (Mul (Add b1~12@ (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Sub d1~16@ a1~10@))) (Mul (Mul (Mul a1~10@ c1~14@) (Mul c1~14@ a1~10@)) d1~16@))) (Sub (Mul d1~16@ (Mul a1~10@ (Mul (Mul a1~10@ b1~12@) d1~16@))) (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@))) (Mul (Mul (Sub b1~12@ a1~10@) a1~10@) (Mul (Mul c1~14@ b1~12@) c1~14@)))))) (=> (= temp_1_1~1020@ (Mul (Mul (Mul (Mul (Add (Mul d1~16@ d1~16@) (Mul 66 c1~14@)) (Mul (Mul b1~12@ b1~12@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ a1~10@)) (Mul (Mul d1~16@ d1~16@) (Mul a1~10@ d1~16@)))) (Mul (Mul (Add b1~12@ (Mul a1~10@ a1~10@)) (Mul (Mul d1~16@ a1~10@) (Sub d1~16@ a1~10@))) (Mul (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ a1~10@)) d1~16@))) (Sub (Mul d1~16@ (Mul a1~10@ (Mul (Mul a1~10@ b1~12@) d1~16@))) (Mul (Mul (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ a1~10@) (Mul d1~16@ d1~16@))) (Mul (Mul (Sub b1~12@ a1~10@) a1~10@) (Mul (Mul c1~14@ b1~12@) c1~14@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~819@ temp_1_1~1020@))) (=> (= temp_1_0~819@ temp_1_1~1020@) (=> (= temp_2_0~1161@ (Mul b2~20@ (Mul (Mul (Add (Add (Sub a2~18@ d2~24@) a2~18@) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))) (Sub (Sub (Mul b2~20@ c2~22@) c2~22@) (Mul a2~18@ (Mul b2~20@ d2~24@)))) (Mul (Add (Add (Mul d2~24@ a2~18@) (Sub d2~24@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ a2~18@))) (Mul (Mul (Sub c2~22@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ c2~22@) c2~22@)))))) (=> (= temp_2_1~1278@ (Mul (Mul (Mul (Add (Add (Sub a2~18@ d2~24@) a2~18@) (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@))) (Sub (Sub (Mul b2~20@ c2~22@) c2~22@) (Mul a2~18@ (Mul b2~20@ d2~24@)))) (Mul (Add (Add (Mul d2~24@ a2~18@) (Sub d2~24@ d2~24@)) (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ a2~18@))) (Mul (Mul (Sub c2~22@ c2~22@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ c2~22@) c2~22@)))) b2~20@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1161@ temp_2_1~1278@))) (=> (= temp_2_0~1161@ temp_2_1~1278@) (=> (= temp_3_0~1551@ (Mul (Mul (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Add a3~26@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Sub b3~28@ d3~32@)))) (Mul (Add (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul d3~32@ d3~32@) b3~28@)) (Sub (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ a3~26@))))) (Mul (Mul (Mul (Mul (Add c3~30@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ b3~28@) (Sub a3~26@ a3~26@))) (Mul (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Add b3~28@ d3~32@) (Mul c3~30@ d3~32@)))) (Sub (Mul (Add (Mul b3~28@ a3~26@) (Add b3~28@ d3~32@)) (Mul (Mul d3~32@ d3~32@) c3~30@)) (Mul (Sub (Mul d3~32@ a3~26@) (Mul b3~28@ c3~30@)) (Sub (Add d3~32@ d3~32@) (Mul a3~26@ b3~28@))))))) (=> (= temp_3_1~1800@ (Mul (Mul (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul d3~32@ c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@))) (Mul (Mul (Mul d3~32@ c3~30@) (Add a3~26@ d3~32@)) (Mul (Mul c3~30@ b3~28@) (Sub b3~28@ d3~32@)))) (Mul (Add (Mul (Mul a3~26@ d3~32@) (Mul a3~26@ d3~32@)) (Mul (Mul d3~32@ d3~32@) b3~28@)) (Sub (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ a3~26@))))) (Mul (Mul (Mul (Mul (Mul (Add c3~30@ a3~26@) (Mul b3~28@ a3~26@)) (Mul (Mul d3~32@ b3~28@) (Sub a3~26@ a3~26@))) (Mul (Mul a3~26@ a3~26@) (Mul a3~26@ b3~28@))) (Mul (Add b3~28@ d3~32@) (Mul c3~30@ d3~32@))) (Sub (Mul (Add (Mul b3~28@ a3~26@) (Add b3~28@ d3~32@)) (Mul (Mul d3~32@ d3~32@) c3~30@)) (Mul (Sub (Mul d3~32@ a3~26@) (Mul b3~28@ c3~30@)) (Sub (Add d3~32@ d3~32@) (Mul a3~26@ b3~28@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1551@ temp_3_1~1800@))) (=> (= temp_3_0~1551@ temp_3_1~1800@) (=> (= temp_4_0~1929@ (Mul (Mul (Mul (Mul (Mul (Sub a4~34@ c4~38@) (Mul a4~34@ d4~40@)) (Add (Mul b4~36@ d4~40@) (Sub a4~34@ b4~36@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Sub (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@)))) (Mul b4~36@ (Sub (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ c4~38@)) (Add (Mul d4~40@ b4~36@) (Mul c4~38@ b4~36@))))) d4~40@)) (=> (= temp_4_1~2034@ (Mul (Mul (Mul (Mul (Sub a4~34@ c4~38@) (Mul a4~34@ d4~40@)) (Add (Mul b4~36@ d4~40@) (Sub a4~34@ b4~36@))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Sub (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@)))) (Mul (Mul b4~36@ (Sub (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ c4~38@)) (Add (Mul d4~40@ b4~36@) (Mul c4~38@ b4~36@)))) d4~40@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~1929@ temp_4_1~2034@))) (=> (= temp_4_0~1929@ temp_4_1~2034@) (=> (= temp_5_0~2287@ (Mul (Mul (Mul (Mul (Sub (Mul d5~48@ d5~48@) b5~44@) (Add (Mul d5~48@ b5~44@) b5~44@)) (Mul (Mul (Mul a5~42@ c5~46@) (Add a5~42@ d5~48@)) (Mul a5~42@ (Sub d5~48@ a5~42@)))) (Mul (Sub (Sub (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@)) (Add (Mul d5~48@ a5~42@) (Mul b5~44@ b5~44@))) (Mul (Mul c5~46@ (Mul a5~42@ c5~46@)) (Mul (Sub c5~46@ d5~48@) (Sub c5~46@ a5~42@))))) (Mul (Mul (Add (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ c5~46@)) (Add (Mul a5~42@ a5~42@) (Add d5~48@ b5~44@))) (Mul (Add (Mul d5~48@ a5~42@) (Add b5~44@ c5~46@)) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ c5~46@)))) (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ b5~44@)) (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ d5~48@))) (Mul d5~48@ (Add (Add d5~48@ d5~48@) (Add b5~44@ c5~46@))))))) (=> (= temp_5_1~2516@ (Mul (Mul (Mul (Mul (Sub (Mul d5~48@ d5~48@) b5~44@) (Add (Mul d5~48@ b5~44@) b5~44@)) (Mul (Mul (Mul a5~42@ c5~46@) (Add a5~42@ d5~48@)) (Mul a5~42@ (Sub d5~48@ a5~42@)))) (Mul (Sub (Sub (Mul a5~42@ b5~44@) (Mul c5~46@ c5~46@)) (Add (Mul d5~48@ a5~42@) (Mul b5~44@ b5~44@))) (Mul (Mul c5~46@ (Mul a5~42@ c5~46@)) (Mul (Sub c5~46@ d5~48@) (Sub c5~46@ a5~42@))))) (Mul (Mul (Add (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ c5~46@)) (Add (Mul a5~42@ a5~42@) (Add d5~48@ b5~44@))) (Mul (Add (Mul d5~48@ a5~42@) (Add b5~44@ c5~46@)) (Mul (Mul c5~46@ d5~48@) (Mul c5~46@ c5~46@)))) (Mul (Mul (Mul (Mul (Mul a5~42@ a5~42@) a5~42@) b5~44@) (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ d5~48@))) (Mul d5~48@ (Add (Add d5~48@ d5~48@) (Add b5~44@ c5~46@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2287@ temp_5_1~2516@))) (=> (= temp_5_0~2287@ temp_5_1~2516@) (=> (= temp_6_0~2809@ (Mul (Mul (Mul (Mul (Mul (Sub b6~52@ d6~56@) (Mul b6~52@ c6~54@)) d6~56@) (Mul (Sub (Mul a6~50@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ c6~54@)))) (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Add a6~50@ d6~56@)) (Mul (Mul 35 a6~50@) (Mul d6~56@ b6~52@))) (Mul (Sub (Mul a6~50@ c6~54@) (Add a6~50@ b6~52@)) (Mul (Mul c6~54@ c6~54@) 92)))) (Mul (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@ d6~56@) d6~56@))) (Mul (Sub (Mul b6~52@ (Mul d6~56@ c6~54@)) (Mul (Mul c6~54@ 20) (Mul b6~52@ b6~52@))) (Mul (Add (Sub d6~56@ b6~52@) (Mul d6~56@ c6~54@)) (Add (Sub b6~52@ a6~50@) (Mul d6~56@ d6~56@))))))) (=> (= temp_6_1~3110@ (Mul (Mul (Mul (Mul (Mul (Sub b6~52@ d6~56@) (Mul b6~52@ c6~54@)) d6~56@) (Mul (Sub (Mul a6~50@ b6~52@) (Mul c6~54@ c6~54@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ c6~54@)))) (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Add a6~50@ d6~56@)) (Mul (Mul 35 a6~50@) (Mul d6~56@ b6~52@))) (Mul (Sub (Mul a6~50@ c6~54@) (Add a6~50@ b6~52@)) (Mul (Mul c6~54@ c6~54@) 92)))) (Mul (Mul (Mul (Mul (Mul d6~56@ c6~54@) (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ d6~56@)) (Mul (Mul c6~54@ d6~56@) d6~56@))) (Sub (Mul (Mul b6~52@ (Mul d6~56@ c6~54@)) (Mul (Add (Sub d6~56@ b6~52@) (Mul d6~56@ c6~54@)) (Add (Sub b6~52@ a6~50@) (Mul d6~56@ d6~56@)))) (Mul (Mul (Mul c6~54@ 20) (Mul b6~52@ b6~52@)) (Mul (Add (Sub d6~56@ b6~52@) (Mul d6~56@ c6~54@)) (Add (Sub b6~52@ a6~50@) (Mul d6~56@ d6~56@)))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~2809@ temp_6_1~3110@))) (=> (= temp_6_0~2809@ temp_6_1~3110@) (=> (= temp_7_0~3331@ (Mul (Mul (Sub (Mul c7~62@ (Mul (Mul b7~60@ c7~62@) (Sub a7~58@ d7~64@))) (Mul (Mul a7~58@ (Mul d7~64@ a7~58@)) (Sub (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)))) (Mul (Mul c7~62@ (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Mul (Add a7~58@ b7~60@) (Mul b7~60@ a7~58@)) (Mul (Add c7~62@ b7~60@) (Mul d7~64@ b7~60@))))) (Mul (Mul (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) a7~58@)) (Mul (Sub (Mul a7~58@ d7~64@) (Sub a7~58@ a7~58@)) (Sub (Sub 33 c7~62@) (Sub c7~62@ d7~64@)))) (Sub (Mul c7~62@ (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ c7~62@))) b7~60@)))) (=> (= temp_7_1~3528@ (Mul (Mul (Sub (Mul c7~62@ (Mul (Mul b7~60@ c7~62@) (Sub a7~58@ d7~64@))) (Mul (Mul a7~58@ (Mul d7~64@ a7~58@)) (Sub (Mul a7~58@ b7~60@) (Mul c7~62@ c7~62@)))) (Mul (Mul c7~62@ (Mul (Mul a7~58@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Mul (Add a7~58@ b7~60@) (Mul b7~60@ a7~58@)) (Mul (Add c7~62@ b7~60@) (Mul d7~64@ b7~60@))))) (Mul (Mul (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ d7~64@)) (Mul (Mul d7~64@ b7~60@) a7~58@)) (Mul (Sub (Mul a7~58@ d7~64@) (Sub a7~58@ a7~58@)) (Sub (Sub 33 c7~62@) (Sub c7~62@ d7~64@)))) (Sub (Mul c7~62@ (Mul (Mul c7~62@ d7~64@) (Mul a7~58@ c7~62@))) b7~60@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3331@ temp_7_1~3528@))) (=> (= temp_7_0~3331@ temp_7_1~3528@) (=> (= temp_8_0~3717@ (Mul (Mul (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ d8~72@))) (Sub (Mul d8~72@ (Mul b8~68@ a8~66@)) (Mul (Sub d8~72@ a8~66@) (Mul c8~70@ c8~70@)))) (Mul (Sub (Mul (Mul b8~68@ b8~68@) (Sub a8~66@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul a8~66@ a8~66@))) b8~68@)) (Mul (Mul (Mul (Add (Mul a8~66@ a8~66@) a8~66@) (Mul (Add c8~70@ a8~66@) (Mul c8~70@ c8~70@))) (Mul (Mul (Mul b8~68@ b8~68@) c8~70@) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ c8~70@)))) (Mul d8~72@ (Mul a8~66@ b8~68@))))) (=> (= temp_8_1~3882@ (Mul (Mul (Mul (Mul (Mul (Mul d8~72@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ d8~72@))) (Sub (Mul d8~72@ (Mul b8~68@ a8~66@)) (Mul (Sub d8~72@ a8~66@) (Mul c8~70@ c8~70@)))) (Mul (Sub (Mul (Mul b8~68@ b8~68@) (Sub a8~66@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul a8~66@ a8~66@))) b8~68@)) (Mul (Mul (Mul (Mul (Add c8~70@ a8~66@) (Mul c8~70@ c8~70@)) (Add (Mul a8~66@ a8~66@) a8~66@)) (Mul (Mul (Mul b8~68@ b8~68@) c8~70@) (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ c8~70@)))) (Mul d8~72@ (Mul a8~66@ b8~68@))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~3717@ temp_8_1~3882@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
