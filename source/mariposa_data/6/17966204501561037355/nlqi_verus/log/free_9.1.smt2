...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~309@ (Mul (Mul (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ c0~6@))) (Add d0~8@ (Mul (Add a0~2@ b0~4@) (Mul b0~4@ d0~8@)))) (Mul (Mul (Mul d0~8@ (Mul b0~4@ d0~8@)) (Sub b0~4@ (Add d0~8@ a0~2@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Sub c0~6@ c0~6@) (Mul c0~6@ b0~4@))))) (Add (Mul (Add b0~4@ (Mul (Mul a0~2@ c0~6@) (Mul b0~4@ a0~2@))) (Mul (Mul (Mul d0~8@ b0~4@) (Add b0~4@ 58)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ b0~4@)))) (Mul (Mul (Mul (Add d0~8@ d0~8@) (Sub c0~6@ a0~2@)) (Sub (Mul b0~4@ a0~2@) (Add a0~2@ b0~4@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ a0~2@)) b0~4@))))) (=> (= temp_0_1~534@ (Mul (Mul (Mul (Mul (Mul (Mul c0~6@ d0~8@) (Mul c0~6@ c0~6@)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ c0~6@))) (Add d0~8@ (Mul (Add a0~2@ b0~4@) (Mul b0~4@ d0~8@)))) (Mul (Mul (Mul d0~8@ (Mul b0~4@ d0~8@)) (Sub b0~4@ (Add d0~8@ a0~2@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Sub c0~6@ c0~6@) (Mul c0~6@ b0~4@))))) (Add (Mul (Add b0~4@ (Mul (Mul a0~2@ c0~6@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul d0~8@ b0~4@) (Add b0~4@ 58)) (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ b0~4@)))) (Mul (Mul (Mul (Add d0~8@ d0~8@) (Sub c0~6@ a0~2@)) (Sub (Mul b0~4@ a0~2@) (Add a0~2@ b0~4@))) (Mul (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ a0~2@)) b0~4@))))) (=> (= tmp%1@ (= temp_0_0~309@ temp_0_1~534@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~686@ (Mul (Mul (Mul (Mul (Mul a1~10@ (Add d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul b1~12@ d1~16@)) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ b1~12@)))) (Mul (Mul (Mul b1~12@ a1~10@) (Add (Sub b1~12@ b1~12@) (Mul b1~12@ d1~16@))) a1~10@)) (Mul (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Sub c1~14@ c1~14@)) d1~16@) (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ d1~16@)) b1~12@)) (Mul d1~16@ b1~12@)))) (=> (= temp_1_1~823@ (Mul (Mul (Mul (Mul (Mul a1~10@ (Add d1~16@ c1~14@)) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ a1~10@))) (Mul (Mul (Mul a1~10@ b1~12@) (Mul d1~16@ b1~12@)) (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ b1~12@)))) (Mul (Mul (Mul b1~12@ a1~10@) (Add (Sub b1~12@ b1~12@) (Mul b1~12@ d1~16@))) a1~10@)) (Mul (Mul (Mul (Mul (Mul c1~14@ a1~10@) (Sub c1~14@ c1~14@)) d1~16@) (Mul (Mul (Mul d1~16@ a1~10@) (Mul a1~10@ d1~16@)) b1~12@)) (Mul d1~16@ b1~12@)))) (=> (= tmp%2@ (= temp_1_0~686@ temp_1_1~823@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~1067@ (Mul (Mul (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ b2~20@)) (Mul a2~18@ (Add c2~22@ b2~20@))) (Mul (Mul (Mul a2~18@ d2~24@) (Sub d2~24@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ a2~18@)))) (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@)) (Mul d2~24@ (Add b2~20@ b2~20@))) (Sub (Mul d2~24@ (Mul d2~24@ b2~20@)) a2~18@))) (Mul (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ c2~22@))) (Sub (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ c2~22@)) (Sub a2~18@ (Mul a2~18@ d2~24@)))) (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Mul c2~22@ b2~20@) (Sub b2~20@ c2~22@))))))) (=> (= temp_2_1~1296@ (Mul (Mul (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ b2~20@)) (Mul a2~18@ (Add c2~22@ b2~20@))) (Mul (Mul (Mul a2~18@ d2~24@) (Sub d2~24@ d2~24@)) (Mul (Mul c2~22@ b2~20@) (Mul c2~22@ a2~18@)))) (Mul (Mul (Mul (Mul a2~18@ c2~22@) (Mul d2~24@ a2~18@)) (Mul d2~24@ (Add b2~20@ b2~20@))) (Sub (Mul d2~24@ (Mul d2~24@ b2~20@)) a2~18@))) (Mul (Mul (Mul (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ c2~22@))) (Sub (Mul (Mul d2~24@ a2~18@) (Mul b2~20@ c2~22@)) (Sub a2~18@ (Mul d2~24@ a2~18@)))) (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ a2~18@)) (Mul (Mul c2~22@ a2~18@) (Mul c2~22@ d2~24@))) (Mul (Mul (Mul a2~18@ c2~22@) (Mul c2~22@ a2~18@)) (Mul (Mul c2~22@ b2~20@) (Sub b2~20@ c2~22@))))))) (=> (= tmp%3@ (= temp_2_0~1067@ temp_2_1~1296@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1572@ (Mul (Sub (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@)) (Mul c3~30@ (Mul c3~30@ c3~30@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Sub b3~28@ a3~26@) (Add d3~32@ b3~28@)))) (Mul (Mul (Mul (Mul a3~26@ c3~30@) (Sub c3~30@ a3~26@)) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ d3~32@))) (Add (Mul (Mul c3~30@ c3~30@) (Add b3~28@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Add a3~26@ c3~30@))))) (Mul (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Add a3~26@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Add d3~32@ b3~28@))) (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@)) (Sub (Sub b3~28@ b3~28@) (Mul b3~28@ 88)))) (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul 82 a3~26@)) (Mul (Mul a3~26@ c3~30@) a3~26@)) (Mul c3~30@ (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ b3~28@))))))) (=> (= temp_3_1~1833@ (Mul (Sub (Mul (Mul (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ b3~28@)) (Mul c3~30@ (Mul c3~30@ c3~30@))) (Mul (Mul (Mul a3~26@ d3~32@) (Mul d3~32@ b3~28@)) (Mul (Sub b3~28@ a3~26@) (Add d3~32@ b3~28@)))) (Mul (Mul (Mul a3~26@ (Mul c3~30@ (Sub c3~30@ a3~26@))) (Mul (Mul c3~30@ c3~30@) (Mul b3~28@ d3~32@))) (Add (Mul (Mul c3~30@ c3~30@) (Add b3~28@ d3~32@)) (Mul (Sub a3~26@ a3~26@) (Add a3~26@ c3~30@))))) (Mul (Mul (Mul (Mul (Mul b3~28@ d3~32@) (Add a3~26@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Add d3~32@ b3~28@))) (Mul (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ b3~28@)) (Sub (Sub b3~28@ b3~28@) (Mul b3~28@ 88)))) (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul 82 a3~26@)) (Mul (Mul a3~26@ c3~30@) a3~26@)) (Mul c3~30@ (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ b3~28@))))))) (=> (= tmp%4@ (= temp_3_0~1572@ temp_3_1~1833@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~2105@ (Add (Mul (Add (Mul (Mul (Add b4~36@ a4~34@) (Mul b4~36@ d4~40@)) (Mul d4~40@ (Mul a4~34@ a4~34@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ d4~40@)))) (Sub (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul b4~36@ (Sub c4~38@ d4~40@))) (Mul (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@)) (Add (Mul d4~40@ d4~40@) (Mul d4~40@ c4~38@))))) (Mul (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ b4~36@)) (Add (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ b4~36@)) (Mul (Sub d4~40@ c4~38@) (Mul a4~34@ c4~38@)))) (Mul (Sub (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ c4~38@)) (Sub (Mul c4~38@ a4~34@) (Mul d4~40@ 47))) (Mul (Mul c4~38@ (Mul a4~34@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ c4~38@))))))) (=> (= temp_4_1~2362@ (Add (Mul (Add (Mul (Mul (Add b4~36@ a4~34@) (Mul b4~36@ d4~40@)) (Mul d4~40@ (Mul a4~34@ a4~34@))) (Mul (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul d4~40@ d4~40@)))) (Sub (Mul (Mul (Mul d4~40@ c4~38@) (Mul a4~34@ d4~40@)) (Mul b4~36@ (Sub c4~38@ d4~40@))) (Mul (Sub (Mul b4~36@ c4~38@) (Mul a4~34@ b4~36@)) (Add (Mul d4~40@ d4~40@) (Mul d4~40@ c4~38@))))) (Mul (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ b4~36@)) (Add (Mul a4~34@ d4~40@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ b4~36@)) (Mul (Sub d4~40@ c4~38@) (Mul a4~34@ c4~38@)))) (Mul (Sub (Mul (Mul c4~38@ b4~36@) (Mul b4~36@ c4~38@)) (Sub (Mul c4~38@ a4~34@) (Mul d4~40@ 47))) (Mul (Mul c4~38@ (Mul a4~34@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ c4~38@))))))) (=> (= tmp%5@ (= temp_4_0~2105@ temp_4_1~2362@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~2642@ (Mul (Sub (Mul (Mul (Mul (Mul d5~48@ a5~42@) c5~46@) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Sub b5~44@ c5~46@) (Mul c5~46@ b5~44@)))) (Mul (Mul (Mul (Sub c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul 38 b5~44@) (Mul b5~44@ c5~46@)) (Mul (Mul b5~44@ 59) (Mul c5~46@ a5~42@))))) (Mul (Mul (Mul (Sub (Mul c5~46@ c5~46@) a5~42@) (Mul (Mul a5~42@ b5~44@) (Sub c5~46@ c5~46@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ b5~44@)) (Mul (Mul a5~42@ d5~48@) c5~46@))) (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Add d5~48@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul a5~42@ c5~46@) d5~48@)))))) (=> (= temp_5_1~2907@ (Mul (Sub (Mul (Mul (Mul (Mul d5~48@ a5~42@) c5~46@) (Mul (Mul d5~48@ b5~44@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul a5~42@ d5~48@) (Mul b5~44@ d5~48@)) (Mul (Sub b5~44@ c5~46@) (Mul c5~46@ b5~44@)))) (Mul (Mul (Mul (Sub c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ a5~42@))) (Mul (Mul (Mul 38 b5~44@) (Mul b5~44@ c5~46@)) (Mul (Mul b5~44@ 59) (Mul c5~46@ a5~42@))))) (Mul (Mul (Mul (Sub (Mul c5~46@ c5~46@) a5~42@) (Mul (Mul a5~42@ b5~44@) (Sub c5~46@ c5~46@))) (Mul (Mul (Mul b5~44@ d5~48@) (Mul a5~42@ b5~44@)) (Mul (Mul a5~42@ d5~48@) c5~46@))) (Mul (Mul (Mul (Mul c5~46@ c5~46@) (Add d5~48@ a5~42@)) (Mul (Mul c5~46@ c5~46@) (Mul c5~46@ c5~46@))) (Mul (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ b5~44@)) (Mul (Mul a5~42@ c5~46@) d5~48@)))))) (=> (= tmp%6@ (= temp_5_0~2642@ temp_5_1~2907@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~3159@ (Mul (Mul (Mul (Mul (Add (Mul d6~56@ c6~54@) d6~56@) d6~56@) (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Add b6~52@ a6~50@) (Mul c6~54@ b6~52@)))) (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Add c6~54@ b6~52@))) (Mul (Mul (Sub a6~50@ b6~52@) (Mul b6~52@ c6~54@)) a6~50@))) (Mul (Mul (Mul (Sub (Mul b6~52@ d6~56@) (Mul d6~56@ 40)) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ c6~54@))) (Sub (Mul (Mul c6~54@ a6~50@) (Add b6~52@ d6~56@)) (Mul (Mul b6~52@ c6~54@) b6~52@))) (Mul (Sub d6~56@ (Mul (Mul a6~50@ d6~56@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ a6~50@)) (Sub (Mul c6~54@ 8) (Sub b6~52@ b6~52@))))))) (=> (= temp_6_1~3396@ (Mul (Mul (Mul (Mul (Add (Mul d6~56@ c6~54@) d6~56@) d6~56@) (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ b6~52@)) (Mul (Add b6~52@ a6~50@) (Mul c6~54@ b6~52@)))) (Mul (Mul (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Add c6~54@ b6~52@))) (Mul (Mul (Sub a6~50@ b6~52@) (Mul b6~52@ c6~54@)) a6~50@))) (Mul (Mul (Mul (Sub (Mul b6~52@ d6~56@) (Mul d6~56@ 40)) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ c6~54@))) (Sub (Mul (Mul c6~54@ a6~50@) (Add b6~52@ d6~56@)) (Mul (Mul b6~52@ c6~54@) b6~52@))) (Mul (Sub d6~56@ (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul b6~52@ b6~52@) (Mul d6~56@ a6~50@)) (Sub (Mul c6~54@ 8) (Sub b6~52@ b6~52@))))))) (=> (= tmp%7@ (= temp_6_0~3159@ temp_6_1~3396@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~3536@ (Mul (Mul (Mul (Mul (Sub b7~60@ (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Mul (Mul d7~64@ b7~60@) c7~62@) (Add (Mul b7~60@ b7~60@) (Mul c7~62@ c7~62@)))) (Mul (Add (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ c7~62@)) a7~58@) (Mul (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul 21 c7~62@))))) d7~64@)) (=> (= temp_7_1~3661@ (Mul (Mul (Mul (Mul (Sub b7~60@ (Mul d7~64@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ d7~64@))) (Mul (Add (Mul b7~60@ b7~60@) (Mul c7~62@ c7~62@)) (Mul (Mul d7~64@ b7~60@) c7~62@))) (Mul (Add (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ c7~62@)) a7~58@) (Mul (Mul (Mul c7~62@ b7~60@) (Mul a7~58@ d7~64@)) (Mul (Mul d7~64@ a7~58@) (Mul 21 c7~62@))))) d7~64@)) (=> (= tmp%8@ (= temp_7_0~3536@ temp_7_1~3661@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~3793@ (Mul (Mul (Mul (Mul (Add (Add a8~66@ d8~72@) (Add b8~68@ b8~68@)) (Mul (Mul a8~66@ c8~70@) c8~70@)) b8~68@) (Sub (Mul (Mul (Mul c8~70@ c8~70@) (Sub b8~68@ b8~68@)) (Mul (Sub a8~66@ c8~70@) (Sub a8~66@ a8~66@))) (Sub (Mul a8~66@ b8~68@) a8~66@))) (Mul (Mul (Sub (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ a8~66@)) (Add (Mul a8~66@ b8~68@) (Add c8~70@ a8~66@))) c8~70@) b8~68@))) (=> (= temp_8_1~3910@ (Mul (Mul (Mul (Mul (Mul (Mul a8~66@ c8~70@) c8~70@) (Add (Add a8~66@ d8~72@) (Add b8~68@ b8~68@))) b8~68@) (Sub (Mul (Mul (Mul c8~70@ c8~70@) (Sub b8~68@ b8~68@)) (Mul (Sub a8~66@ c8~70@) (Sub a8~66@ a8~66@))) (Sub (Mul a8~66@ b8~68@) a8~66@))) (Mul (Mul (Sub (Mul (Mul c8~70@ b8~68@) (Mul d8~72@ a8~66@)) (Add (Mul a8~66@ b8~68@) (Add c8~70@ a8~66@))) c8~70@) b8~68@))) (=> (= tmp%9@ (= temp_8_0~3793@ temp_8_1~3910@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
