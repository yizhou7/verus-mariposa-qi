...
(declare-const temp_1_1~868@ Int)
(declare-const temp_2_0~1093@ Int)
(declare-const temp_2_1~1294@ Int)
(declare-const temp_3_0~1543@ Int)
(declare-const temp_3_1~1768@ Int)
(declare-const temp_4_0~2057@ Int)
(declare-const temp_4_1~2322@ Int)
(declare-const temp_5_0~2575@ Int)
(declare-const temp_5_1~2804@ Int)
(declare-const temp_6_0~3005@ Int)
(declare-const temp_6_1~3182@ Int)
(declare-const temp_7_0~3455@ Int)
(declare-const temp_7_1~3704@ Int)
(declare-const temp_8_0~3957@ Int)
(declare-const temp_8_1~4186@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~293@ (Mul (Mul (Add (Sub (Mul (Mul a0~2@ c0~6@) d0~8@) (Mul (Sub c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (Mul b0~4@ (Sub (Mul d0~8@ b0~4@) (Mul b0~4@ b0~4@)))) (Mul (Mul (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@))) (Mul (Add (Mul c0~6@ c0~6@) d0~8@) (Mul (Mul b0~4@ d0~8@) b0~4@)))) (Mul (Mul (Mul (Mul (Mul c0~6@ d0~8@) d0~8@) c0~6@) (Mul (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ b0~4@)))) (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@)) (Add a0~2@ (Mul b0~4@ d0~8@))))))) (=> (= temp_0_1~506@ (Mul (Mul (Add (Sub (Mul (Mul a0~2@ c0~6@) d0~8@) (Mul (Sub c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (Mul b0~4@ (Sub (Mul d0~8@ b0~4@) (Mul b0~4@ b0~4@)))) (Mul (Mul (Add (Mul c0~6@ c0~6@) d0~8@) (Mul (Mul b0~4@ d0~8@) b0~4@)) (Mul (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ a0~2@)) (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@))))) (Mul (Mul (Mul (Mul (Mul c0~6@ d0~8@) d0~8@) c0~6@) (Mul (Mul (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Mul c0~6@ a0~2@) (Mul d0~8@ b0~4@)))) (Mul (Mul (Mul (Mul a0~2@ d0~8@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ b0~4@))) (Mul (Mul (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@)) (Add a0~2@ (Mul b0~4@ d0~8@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~293@ temp_0_1~506@))) (=> (= temp_0_0~293@ temp_0_1~506@) (=> (= temp_1_0~699@ (Mul (Add (Mul c1~14@ (Add (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ d1~16@)))) (Mul (Mul (Mul (Sub a1~10@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Mul b1~12@ d1~16@) (Mul a1~10@ b1~12@))) (Mul (Mul (Sub a1~10@ c1~14@) (Mul a1~10@ d1~16@)) b1~12@))) (Add (Mul (Mul (Mul a1~10@ (Sub c1~14@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@))) (Sub d1~16@ b1~12@)) (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@)) a1~10@) (Mul (Mul a1~10@ a1~10@) (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ b1~12@))))))) (=> (= temp_1_1~868@ (Mul (Add (Mul c1~14@ (Add (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ d1~16@)))) (Mul (Mul (Mul (Sub a1~10@ d1~16@) (Mul a1~10@ a1~10@)) (Mul (Mul b1~12@ d1~16@) (Mul b1~12@ a1~10@))) (Mul (Mul (Sub a1~10@ c1~14@) (Mul a1~10@ d1~16@)) b1~12@))) (Add (Mul (Mul (Mul a1~10@ (Sub c1~14@ d1~16@)) (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@))) (Sub d1~16@ b1~12@)) (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ c1~14@)) a1~10@) (Mul (Mul a1~10@ a1~10@) (Mul (Mul b1~12@ a1~10@) (Mul b1~12@ b1~12@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~699@ temp_1_1~868@))) (=> (= temp_1_0~699@ temp_1_1~868@) (=> (= temp_2_0~1093@ (Mul (Mul (Mul (Mul (Sub d2~24@ (Mul a2~18@ b2~20@)) (Mul (Mul 81 a2~18@) (Mul c2~22@ b2~20@))) (Mul b2~20@ (Mul (Mul c2~22@ d2~24@) (Sub d2~24@ a2~18@)))) (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ a2~18@) b2~20@)) (Mul (Mul (Mul c2~22@ d2~24@) (Add a2~18@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ c2~22@))))) (Mul (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Add b2~20@ d2~24@)) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ 39)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ b2~20@)))) a2~18@))) (=> (= temp_2_1~1294@ (Mul (Mul (Mul (Mul (Sub d2~24@ (Mul a2~18@ b2~20@)) (Mul (Mul 81 a2~18@) (Mul c2~22@ b2~20@))) (Mul b2~20@ (Mul (Mul c2~22@ d2~24@) (Sub d2~24@ a2~18@)))) (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ a2~18@)) (Mul (Mul b2~20@ a2~18@) b2~20@)) (Mul (Mul (Mul c2~22@ d2~24@) (Add a2~18@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ c2~22@))))) (Mul (Mul (Mul (Mul (Mul a2~18@ b2~20@) (Add b2~20@ d2~24@)) (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ c2~22@))) (Mul (Mul (Mul d2~24@ c2~22@) (Mul b2~20@ 39)) (Mul (Mul b2~20@ d2~24@) (Mul a2~18@ b2~20@)))) a2~18@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1093@ temp_2_1~1294@))) (=> (= temp_2_0~1093@ temp_2_1~1294@) (=> (= temp_3_0~1543@ (Mul (Mul (Mul (Sub (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ d3~32@)) (Add (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@))) (Mul d3~32@ (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ d3~32@)))) (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@)) (Mul a3~26@ (Mul a3~26@ a3~26@))) (Add (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Add c3~30@ c3~30@))))) (Mul (Mul (Mul (Sub (Mul d3~32@ b3~28@) d3~32@) (Mul (Mul 74 c3~30@) d3~32@)) (Mul (Mul (Mul b3~28@ c3~30@) (Sub c3~30@ b3~28@)) (Mul b3~28@ b3~28@))) (Mul (Mul (Add (Sub c3~30@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ b3~28@))) (Mul d3~32@ (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ c3~30@))))))) (=> (= temp_3_1~1768@ (Mul (Mul (Mul (Sub (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ d3~32@)) (Add (Mul a3~26@ c3~30@) (Mul b3~28@ a3~26@))) (Mul d3~32@ (Mul (Mul d3~32@ d3~32@) (Mul a3~26@ d3~32@)))) (Mul (Mul (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ b3~28@)) (Mul a3~26@ (Mul a3~26@ a3~26@))) (Add (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ a3~26@)) (Mul (Mul c3~30@ a3~26@) (Add c3~30@ c3~30@))))) (Mul (Mul (Mul (Sub (Mul d3~32@ b3~28@) d3~32@) (Mul (Mul 74 c3~30@) d3~32@)) (Mul (Mul (Mul b3~28@ c3~30@) (Sub c3~30@ b3~28@)) (Mul b3~28@ b3~28@))) (Mul (Mul (Add (Sub c3~30@ b3~28@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ b3~28@))) (Mul d3~32@ (Mul (Mul c3~30@ b3~28@) (Mul b3~28@ c3~30@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1543@ temp_3_1~1768@))) (=> (= temp_3_0~1543@ temp_3_1~1768@) (=> (= temp_4_0~2057@ (Sub (Mul (Add (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul 98 b4~36@) b4~36@)) (Mul (Mul (Mul c4~38@ c4~38@) (Add c4~38@ a4~34@)) (Mul (Add c4~38@ b4~36@) (Mul c4~38@ d4~40@)))) (Mul (Mul (Sub (Mul d4~40@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@ d4~40@) (Add a4~34@ c4~38@))) (Mul (Mul (Sub d4~40@ b4~36@) a4~34@) (Mul (Mul a4~34@ b4~36@) c4~38@)))) (Mul (Add (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul 57 d4~40@) (Mul a4~34@ b4~36@)))) (Mul (Mul (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@))) (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@)) (Mul d4~40@ (Mul a4~34@ a4~34@))))))) (=> (= temp_4_1~2322@ (Sub (Mul (Add (Mul (Mul (Mul d4~40@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul 98 b4~36@) b4~36@)) (Mul (Mul (Mul c4~38@ c4~38@) (Add c4~38@ a4~34@)) (Mul (Add c4~38@ b4~36@) (Mul c4~38@ d4~40@)))) (Mul (Mul (Sub (Mul d4~40@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Mul b4~36@ d4~40@) (Add a4~34@ c4~38@))) (Mul (Mul (Sub d4~40@ b4~36@) a4~34@) (Mul (Mul a4~34@ b4~36@) c4~38@)))) (Mul (Add (Mul (Mul (Mul b4~36@ c4~38@) (Mul c4~38@ b4~36@)) (Mul (Mul a4~34@ c4~38@) (Mul d4~40@ a4~34@))) (Mul (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ c4~38@)) (Mul (Mul 57 d4~40@) (Mul a4~34@ b4~36@)))) (Mul (Mul (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ b4~36@)) (Mul d4~40@ (Mul a4~34@ a4~34@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul c4~38@ c4~38@)) (Mul (Mul d4~40@ d4~40@) (Mul a4~34@ a4~34@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~2057@ temp_4_1~2322@))) (=> (= temp_4_0~2057@ temp_4_1~2322@) (=> (= temp_5_0~2575@ (Sub (Mul (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ c5~46@)) (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ d5~48@))) c5~46@) (Mul (Add (Add (Add a5~42@ d5~48@) (Mul a5~42@ a5~42@)) c5~46@) (Mul (Mul (Mul c5~46@ a5~42@) (Sub a5~42@ d5~48@)) (Mul (Mul a5~42@ d5~48@) (Add b5~44@ a5~42@))))) (Mul (Mul (Mul (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ d5~48@)) (Add (Mul d5~48@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul c5~46@ c5~46@) (Sub a5~42@ c5~46@)) (Mul (Sub d5~48@ 28) (Mul c5~46@ b5~44@)))) (Mul (Add (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ c5~46@))) (Sub (Mul (Sub b5~44@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ c5~46@))))))) (=> (= temp_5_1~2804@ (Sub (Mul (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ c5~46@)) (Mul (Sub b5~44@ b5~44@) (Mul b5~44@ d5~48@))) c5~46@) (Mul (Add (Add (Add a5~42@ d5~48@) (Mul a5~42@ a5~42@)) c5~46@) (Mul (Mul (Mul c5~46@ a5~42@) (Sub a5~42@ d5~48@)) (Mul a5~42@ (Mul d5~48@ (Add b5~44@ a5~42@)))))) (Mul (Mul (Mul (Mul (Sub b5~44@ a5~42@) (Mul d5~48@ d5~48@)) (Add (Mul d5~48@ a5~42@) (Mul c5~46@ d5~48@))) (Mul (Mul (Mul c5~46@ c5~46@) (Sub a5~42@ c5~46@)) (Mul (Sub d5~48@ 28) (Mul c5~46@ b5~44@)))) (Mul (Add (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ c5~46@))) (Sub (Mul (Sub b5~44@ a5~42@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ d5~48@) (Mul a5~42@ c5~46@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2575@ temp_5_1~2804@))) (=> (= temp_5_0~2575@ temp_5_1~2804@) (=> (= temp_6_0~3005@ (Add (Mul (Add (Mul a6~50@ (Mul (Sub c6~54@ b6~52@) (Mul a6~50@ b6~52@))) b6~52@) (Mul (Mul (Mul (Mul b6~52@ b6~52@) a6~50@) (Mul (Add d6~56@ b6~52@) a6~50@)) (Sub a6~50@ (Sub (Add a6~50@ a6~50@) (Mul d6~56@ c6~54@))))) (Mul (Sub (Mul (Mul d6~56@ d6~56@) (Add c6~54@ (Sub b6~52@ c6~54@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ a6~50@)))) (Add (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Sub a6~50@ c6~54@) (Mul b6~52@ b6~52@))) (Sub (Mul c6~54@ (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ c6~54@) d6~56@)))))) (=> (= temp_6_1~3182@ (Add (Mul (Add (Mul a6~50@ (Mul (Sub c6~54@ b6~52@) (Mul a6~50@ b6~52@))) b6~52@) (Mul (Mul (Mul b6~52@ b6~52@) a6~50@) (Mul (Mul (Add d6~56@ b6~52@) a6~50@) (Sub a6~50@ (Sub (Add a6~50@ a6~50@) (Mul d6~56@ c6~54@)))))) (Mul (Sub (Mul (Mul d6~56@ d6~56@) (Add c6~54@ (Sub b6~52@ c6~54@))) (Mul (Mul (Mul a6~50@ c6~54@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ a6~50@)))) (Add (Mul (Mul (Mul c6~54@ d6~56@) (Mul d6~56@ d6~56@)) (Mul (Sub a6~50@ c6~54@) (Mul b6~52@ b6~52@))) (Sub (Mul c6~54@ (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ c6~54@) d6~56@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~3005@ temp_6_1~3182@))) (=> (= temp_6_0~3005@ temp_6_1~3182@) (=> (= temp_7_0~3455@ (Sub (Mul (Mul (Mul (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ c7~62@))) (Sub (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ d7~64@)) (Mul (Add d7~64@ a7~58@) (Mul d7~64@ d7~64@)))) (Mul (Mul (Sub (Add b7~60@ a7~58@) (Mul a7~58@ c7~62@)) (Add (Add a7~58@ d7~64@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul d7~64@ c7~62@)) b7~60@))) (Mul (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ a7~58@) (Sub 49 d7~64@))) (Sub (Mul b7~60@ (Mul b7~60@ a7~58@)) (Mul (Sub c7~62@ a7~58@) c7~62@))) (Mul (Sub (Mul (Sub a7~58@ d7~64@) (Add b7~60@ b7~60@)) (Sub (Add a7~58@ b7~60@) (Mul b7~60@ a7~58@))) (Mul (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ c7~62@)) (Add (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@))))))) (=> (= temp_7_1~3704@ (Sub (Mul (Mul (Mul (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ c7~62@))) (Sub (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ d7~64@)) (Mul (Add d7~64@ a7~58@) (Mul d7~64@ d7~64@)))) (Mul (Mul (Sub (Add b7~60@ a7~58@) (Mul a7~58@ c7~62@)) (Add (Add a7~58@ d7~64@) (Mul a7~58@ a7~58@))) (Mul b7~60@ (Mul (Mul b7~60@ d7~64@) (Mul d7~64@ c7~62@))))) (Mul (Mul (Mul (Mul (Mul d7~64@ d7~64@) (Mul b7~60@ d7~64@)) (Mul (Mul b7~60@ a7~58@) (Sub 49 d7~64@))) (Sub (Mul b7~60@ (Mul b7~60@ a7~58@)) (Mul (Sub c7~62@ a7~58@) c7~62@))) (Mul (Sub (Mul (Sub a7~58@ d7~64@) (Add b7~60@ b7~60@)) (Sub (Add a7~58@ b7~60@) (Mul b7~60@ a7~58@))) (Mul (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ c7~62@)) (Add (Mul a7~58@ d7~64@) (Mul c7~62@ c7~62@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3455@ temp_7_1~3704@))) (=> (= temp_7_0~3455@ temp_7_1~3704@) (=> (= temp_8_0~3957@ (Mul (Mul (Mul (Sub (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@)) (Add (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Add b8~68@ c8~70@) (Mul a8~66@ b8~68@)))) (Mul (Mul (Mul d8~72@ 78) (Mul (Sub d8~72@ c8~70@) (Mul d8~72@ d8~72@))) (Add (Mul (Mul d8~72@ 49) (Mul b8~68@ d8~72@)) (Add a8~66@ (Add a8~66@ c8~70@))))) (Sub (Mul (Mul c8~70@ (Mul (Mul d8~72@ a8~66@) (Add c8~70@ b8~68@))) (Mul (Mul a8~66@ (Mul d8~72@ a8~66@)) (Mul (Sub b8~68@ d8~72@) (Mul c8~70@ b8~68@)))) (Mul (Sub (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ c8~70@)) b8~68@) (Mul (Mul b8~68@ (Sub c8~70@ a8~66@)) (Sub b8~68@ (Mul b8~68@ b8~68@))))))) (=> (= temp_8_1~4186@ (Mul (Mul (Mul (Sub (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ b8~68@)) (Add (Mul a8~66@ a8~66@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul d8~72@ a8~66@) a8~66@) (Mul (Add b8~68@ c8~70@) (Mul a8~66@ b8~68@)))) (Mul (Mul d8~72@ 78) (Mul (Mul (Sub d8~72@ c8~70@) (Mul d8~72@ d8~72@)) (Add (Mul (Mul d8~72@ 49) (Mul b8~68@ d8~72@)) (Add a8~66@ (Add a8~66@ c8~70@)))))) (Sub (Mul (Mul c8~70@ (Mul (Mul d8~72@ a8~66@) (Add c8~70@ b8~68@))) (Mul (Mul a8~66@ (Mul d8~72@ a8~66@)) (Mul (Sub b8~68@ d8~72@) (Mul c8~70@ b8~68@)))) (Mul (Sub (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ c8~70@)) b8~68@) (Mul (Mul b8~68@ (Sub c8~70@ a8~66@)) (Sub b8~68@ (Mul b8~68@ b8~68@))))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~3957@ temp_8_1~4186@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
