...
(assert (=> %%query%% (not (=> (= temp_0_0~277@ (Mul (Mul (Mul (Mul (Sub (Mul d0~8@ b0~4@) (Sub a0~2@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ b0~4@))) (Mul (Add d0~8@ d0~8@) (Mul (Mul a0~2@ d0~8@) (Add b0~4@ d0~8@)))) (Mul c0~6@ (Mul (Mul (Mul c0~6@ a0~2@) (Add b0~4@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))))) (Mul (Mul (Mul (Mul (Sub b0~4@ b0~4@) d0~8@) (Mul (Mul d0~8@ b0~4@) d0~8@)) (Mul (Mul (Mul d0~8@ b0~4@) (Sub d0~8@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Sub a0~2@ b0~4@)))) (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@))) (Mul d0~8@ (Mul (Add c0~6@ c0~6@) d0~8@)))))) (=> (= temp_0_1~474@ (Mul (Mul (Mul (Mul (Sub (Mul d0~8@ b0~4@) (Sub a0~2@ a0~2@)) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ b0~4@))) (Mul (Add d0~8@ d0~8@) (Mul (Mul a0~2@ d0~8@) (Add b0~4@ d0~8@)))) (Mul c0~6@ (Mul (Mul (Mul c0~6@ a0~2@) (Add b0~4@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Mul b0~4@ b0~4@))))) (Mul (Mul (Mul (Mul (Sub b0~4@ b0~4@) d0~8@) (Mul (Mul d0~8@ b0~4@) d0~8@)) (Mul (Mul (Mul d0~8@ b0~4@) (Sub d0~8@ b0~4@)) (Mul (Mul b0~4@ b0~4@) (Sub a0~2@ b0~4@)))) (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Mul a0~2@ b0~4@))) (Mul d0~8@ (Mul (Add c0~6@ c0~6@) d0~8@)))))) (=> (= tmp%1@ (= temp_0_0~277@ temp_0_1~474@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~594@ (Mul b1~12@ (Mul (Mul (Sub (Mul (Mul c1~14@ b1~12@) (Sub d1~16@ a1~10@)) c1~14@) (Mul (Mul (Add b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Add (Mul d1~16@ a1~10@) (Mul c1~14@ a1~10@)))) (Mul d1~16@ (Add (Mul (Sub b1~12@ c1~14@) (Mul a1~10@ 98)) (Mul (Mul a1~10@ c1~14@) (Sub d1~16@ b1~12@))))))) (=> (= temp_1_1~699@ (Mul b1~12@ (Mul (Mul (Sub (Mul c1~14@ (Mul b1~12@ (Sub d1~16@ a1~10@))) c1~14@) (Mul (Mul (Add b1~12@ a1~10@) (Mul d1~16@ d1~16@)) (Add (Mul d1~16@ a1~10@) (Mul c1~14@ a1~10@)))) (Mul d1~16@ (Add (Mul (Sub b1~12@ c1~14@) (Mul a1~10@ 98)) (Mul (Mul a1~10@ c1~14@) (Sub d1~16@ b1~12@))))))) (=> (= tmp%2@ (= temp_1_0~594@ temp_1_1~699@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~823@ (Sub a2~18@ (Mul (Mul (Mul c2~22@ (Mul (Mul a2~18@ a2~18@) (Sub d2~24@ c2~22@))) (Mul (Mul (Mul d2~24@ d2~24@) a2~18@) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@)))) (Mul (Mul (Mul (Mul a2~18@ a2~18@) b2~20@) (Mul d2~24@ (Mul a2~18@ a2~18@))) (Mul (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Sub b2~20@ b2~20@) (Mul b2~20@ d2~24@))))))) (=> (= temp_2_1~932@ (Sub a2~18@ (Mul (Mul (Mul c2~22@ (Mul (Mul a2~18@ a2~18@) (Sub d2~24@ c2~22@))) (Mul (Mul (Mul d2~24@ d2~24@) a2~18@) (Mul (Mul b2~20@ b2~20@) (Mul d2~24@ a2~18@)))) (Mul (Mul (Mul (Mul a2~18@ a2~18@) b2~20@) (Mul (Mul d2~24@ a2~18@) a2~18@)) (Mul (Mul (Mul a2~18@ c2~22@) (Mul a2~18@ a2~18@)) (Mul (Sub b2~20@ b2~20@) (Mul b2~20@ d2~24@))))))) (=> (= tmp%3@ (= temp_2_0~823@ temp_2_1~932@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1192@ (Mul (Mul (Add (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@)) (Mul (Mul c3~30@ 62) (Sub d3~32@ c3~30@))) (Add (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@)) (Sub (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@)))) (Mul (Mul c3~30@ (Add (Mul d3~32@ d3~32@) d3~32@)) (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@))))) (Add (Add (Mul (Mul c3~30@ (Mul a3~26@ b3~28@)) (Mul b3~28@ (Mul a3~26@ c3~30@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@)) (Add (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)))) (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@)) (Sub (Mul c3~30@ b3~28@) (Mul b3~28@ a3~26@))))))) (=> (= temp_3_1~1437@ (Mul (Mul (Add (Mul (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@)) (Mul (Mul c3~30@ 62) (Sub d3~32@ c3~30@))) (Add (Mul (Mul b3~28@ c3~30@) (Mul c3~30@ a3~26@)) (Sub (Mul a3~26@ b3~28@) (Mul c3~30@ a3~26@)))) (Mul (Mul c3~30@ (Add (Mul d3~32@ d3~32@) d3~32@)) (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ b3~28@)) (Mul (Mul c3~30@ d3~32@) (Mul d3~32@ a3~26@))))) (Add (Add (Mul (Mul c3~30@ (Mul a3~26@ b3~28@)) (Mul b3~28@ (Mul a3~26@ c3~30@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul d3~32@ c3~30@)) (Add (Mul b3~28@ c3~30@) (Mul d3~32@ d3~32@)))) (Mul (Mul (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@)) (Sub (Mul c3~30@ b3~28@) (Mul a3~26@ b3~28@))))))) (=> (= tmp%4@ (= temp_3_0~1192@ temp_3_1~1437@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1693@ (Mul (Mul (Mul (Add (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))) (Add (Mul (Mul d4~40@ 69) (Mul c4~38@ c4~38@)) (Mul (Add d4~40@ b4~36@) (Mul 62 d4~40@)))) (Mul (Mul (Mul c4~38@ (Add b4~36@ b4~36@)) (Sub (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul 66 d4~40@)) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ c4~38@))))) (Mul (Sub (Mul (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ 34))) (Mul (Add (Mul b4~36@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Add d4~40@ b4~36@) (Mul d4~40@ b4~36@)))) b4~36@))) (=> (= temp_4_1~1934@ (Mul (Mul (Mul (Add (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Mul b4~36@ d4~40@))) (Add (Mul (Mul d4~40@ 69) (Mul c4~38@ c4~38@)) (Mul (Add d4~40@ b4~36@) (Mul 62 d4~40@)))) (Mul (Mul (Mul c4~38@ (Add b4~36@ b4~36@)) (Sub (Mul c4~38@ a4~34@) (Mul b4~36@ a4~34@))) (Mul (Mul (Mul a4~34@ b4~36@) (Mul 66 d4~40@)) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ c4~38@))))) (Mul b4~36@ (Sub (Mul (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ b4~36@)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ 34))) (Mul (Add (Mul b4~36@ d4~40@) (Mul a4~34@ b4~36@)) (Mul (Add d4~40@ b4~36@) (Mul d4~40@ b4~36@))))))) (=> (= tmp%5@ (= temp_4_0~1693@ temp_4_1~1934@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~2150@ (Add (Add (Mul (Mul (Mul (Add c5~46@ b5~44@) (Add c5~46@ c5~46@)) (Mul (Add 21 d5~48@) (Mul d5~48@ c5~46@))) (Add (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ a5~42@)) (Mul (Sub b5~44@ d5~48@) (Mul d5~48@ d5~48@)))) d5~48@) (Sub (Sub (Mul (Mul d5~48@ (Add a5~42@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ 27))) (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@)) (Mul a5~42@ (Mul b5~44@ b5~44@)))) (Mul (Sub d5~48@ (Add (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@))) (Mul (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ d5~48@)) (Mul (Sub c5~46@ b5~44@) (Add b5~44@ b5~44@))))))) (=> (= temp_5_1~2351@ (Add (Add (Mul (Mul (Mul (Add c5~46@ b5~44@) (Add c5~46@ c5~46@)) (Mul (Add 21 d5~48@) (Mul d5~48@ c5~46@))) (Add (Mul (Mul d5~48@ a5~42@) (Mul c5~46@ a5~42@)) (Mul (Sub b5~44@ d5~48@) (Mul d5~48@ d5~48@)))) d5~48@) (Sub (Sub (Mul (Mul d5~48@ (Add a5~42@ d5~48@)) (Mul (Mul a5~42@ b5~44@) (Mul c5~46@ 27))) (Mul (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@)) (Mul a5~42@ (Mul b5~44@ b5~44@)))) (Mul (Sub d5~48@ (Add (Mul d5~48@ b5~44@) (Mul b5~44@ d5~48@))) (Mul (Mul (Sub c5~46@ b5~44@) (Add b5~44@ b5~44@)) (Mul (Mul a5~42@ a5~42@) (Mul a5~42@ d5~48@))))))) (=> (= tmp%6@ (= temp_5_0~2150@ temp_5_1~2351@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~2523@ (Mul (Mul d6~56@ (Mul (Mul (Sub c6~54@ (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ c6~54@))) d6~56@)) (Mul (Mul (Mul (Mul (Mul b6~52@ a6~50@) c6~54@) (Add (Mul b6~52@ a6~50@) c6~54@)) (Mul b6~52@ (Mul (Add b6~52@ c6~54@) (Mul a6~50@ b6~52@)))) (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@)) (Mul (Mul a6~50@ d6~56@) (Add b6~52@ a6~50@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@)) (Mul (Mul 17 a6~50@) (Mul c6~54@ a6~50@))))))) (=> (= temp_6_1~2680@ (Mul (Mul d6~56@ (Mul (Mul (Sub c6~54@ (Mul d6~56@ b6~52@)) (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ c6~54@))) d6~56@)) (Mul (Mul (Mul (Mul (Mul b6~52@ a6~50@) c6~54@) (Add (Mul b6~52@ a6~50@) c6~54@)) (Mul b6~52@ (Mul (Add b6~52@ c6~54@) (Mul a6~50@ b6~52@)))) (Sub (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Add b6~52@ a6~50@))) (Mul (Mul (Mul a6~50@ a6~50@) (Mul b6~52@ a6~50@)) (Mul (Mul 17 a6~50@) (Mul c6~54@ a6~50@))))))) (=> (= tmp%7@ (= temp_6_0~2523@ temp_6_1~2680@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~2904@ (Mul (Mul (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Sub b7~60@ c7~62@)) (Add (Mul b7~60@ c7~62@) (Mul d7~64@ a7~58@))) (Mul (Mul d7~64@ (Mul a7~58@ 29)) (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ b7~60@)))) (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Add d7~64@ c7~62@) b7~60@)) d7~64@)) (Mul (Mul (Mul (Mul (Sub a7~58@ c7~62@) b7~60@) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ c7~62@))) (Mul (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul d7~64@ c7~62@) a7~58@))) (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Add b7~60@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ b7~60@))) (Sub (Mul a7~58@ (Mul a7~58@ c7~62@)) c7~62@))))) (=> (= temp_7_1~3113@ (Mul (Mul (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Sub b7~60@ c7~62@)) (Add (Mul b7~60@ c7~62@) (Mul d7~64@ a7~58@))) (Mul (Mul d7~64@ (Mul a7~58@ 29)) (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ b7~60@)))) (Mul (Mul (Mul (Mul b7~60@ a7~58@) (Mul c7~62@ a7~58@)) (Mul (Add d7~64@ c7~62@) b7~60@)) d7~64@)) (Mul (Mul (Mul (Sub a7~58@ c7~62@) b7~60@) (Mul (Mul d7~64@ d7~64@) (Mul d7~64@ c7~62@))) (Mul (Mul (Mul (Mul a7~58@ c7~62@) (Mul d7~64@ c7~62@)) (Mul (Mul d7~64@ c7~62@) a7~58@)) (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Add b7~60@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul a7~58@ b7~60@))) (Sub (Mul a7~58@ (Mul a7~58@ c7~62@)) c7~62@)))))) (=> (= tmp%8@ (= temp_7_0~2904@ temp_7_1~3113@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~3329@ (Mul (Mul (Add c8~70@ (Sub (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ d8~72@) (Add a8~66@ b8~68@)))) (Mul (Mul (Add (Mul d8~72@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ 52))) (Add (Mul (Mul c8~70@ d8~72@) a8~66@) (Add b8~68@ (Mul c8~70@ c8~70@))))) (Add (Mul (Add (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) a8~66@) (Add (Mul d8~72@ (Mul a8~66@ d8~72@)) (Mul (Mul a8~66@ a8~66@) (Add b8~68@ a8~66@)))) (Sub (Mul (Add (Mul a8~66@ a8~66@) (Add b8~68@ b8~68@)) (Mul (Mul b8~68@ d8~72@) c8~70@)) (Mul (Sub (Mul d8~72@ c8~70@) (Mul d8~72@ b8~68@)) d8~72@))))) (=> (= temp_8_1~3530@ (Mul (Mul (Add c8~70@ (Sub (Mul (Mul d8~72@ a8~66@) (Mul b8~68@ c8~70@)) (Mul (Mul c8~70@ d8~72@) (Add a8~66@ b8~68@)))) (Mul (Mul (Add (Mul d8~72@ c8~70@) (Mul c8~70@ a8~66@)) (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ 52))) (Add (Mul (Mul c8~70@ d8~72@) a8~66@) (Add b8~68@ (Mul c8~70@ c8~70@))))) (Add (Mul (Add (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ b8~68@)) a8~66@) (Add (Mul (Mul a8~66@ d8~72@) d8~72@) (Mul (Mul a8~66@ a8~66@) (Add b8~68@ a8~66@)))) (Sub (Mul (Add (Mul a8~66@ a8~66@) (Add b8~68@ b8~68@)) (Mul (Mul b8~68@ d8~72@) c8~70@)) (Mul (Sub (Mul d8~72@ c8~70@) (Mul d8~72@ b8~68@)) d8~72@))))) (=> (= tmp%9@ (= temp_8_0~3329@ temp_8_1~3530@)) (=> %%location_label%%8 tmp%9@)))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
