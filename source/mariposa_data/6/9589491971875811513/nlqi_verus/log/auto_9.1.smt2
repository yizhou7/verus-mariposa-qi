...
(declare-const temp_1_1~988@ Int)
(declare-const temp_2_0~1265@ Int)
(declare-const temp_2_1~1518@ Int)
(declare-const temp_3_0~1803@ Int)
(declare-const temp_3_1~2064@ Int)
(declare-const temp_4_0~2201@ Int)
(declare-const temp_4_1~2330@ Int)
(declare-const temp_5_0~2515@ Int)
(declare-const temp_5_1~2676@ Int)
(declare-const temp_6_0~2905@ Int)
(declare-const temp_6_1~3110@ Int)
(declare-const temp_7_0~3387@ Int)
(declare-const temp_7_1~3640@ Int)
(declare-const temp_8_0~3913@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~289@ (Add (Mul (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@)) (Sub (Mul d0~8@ d0~8@) (Sub d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Add d0~8@ a0~2@) (Add a0~2@ 79)))) (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@)) (Sub (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@))) (Sub (Sub (Mul d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ b0~4@))))) (Add (Add (Mul (Mul (Mul b0~4@ a0~2@) (Mul b0~4@ b0~4@)) (Add (Mul d0~8@ c0~6@) a0~2@)) d0~8@) (Mul b0~4@ (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Add d0~8@ d0~8@) (Mul c0~6@ c0~6@))))))) (=> (= temp_0_1~498@ (Add (Mul (Mul (Mul (Mul (Mul d0~8@ c0~6@) (Mul d0~8@ c0~6@)) (Sub (Mul d0~8@ d0~8@) (Sub d0~8@ c0~6@))) (Mul (Mul (Mul a0~2@ a0~2@) (Mul d0~8@ b0~4@)) (Mul (Add d0~8@ a0~2@) (Add a0~2@ 79)))) (Mul (Mul (Mul (Mul b0~4@ a0~2@) (Add c0~6@ c0~6@)) (Sub (Mul d0~8@ d0~8@) (Mul c0~6@ d0~8@))) (Sub (Sub (Mul d0~8@ c0~6@) (Mul d0~8@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ b0~4@))))) (Add (Add (Mul (Mul (Mul a0~2@ b0~4@) (Mul b0~4@ b0~4@)) (Add (Mul d0~8@ c0~6@) a0~2@)) d0~8@) (Mul b0~4@ (Mul (Mul (Mul b0~4@ c0~6@) (Mul c0~6@ d0~8@)) (Mul (Add d0~8@ d0~8@) (Mul c0~6@ c0~6@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~289@ temp_0_1~498@))) (=> (= temp_0_0~289@ temp_0_1~498@) (=> (= temp_1_0~755@ (Mul (Mul (Mul (Mul (Mul (Add c1~14@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Add d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Mul d1~16@ (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ a1~10@)))) (Mul (Mul (Mul (Sub d1~16@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Sub a1~10@ b1~12@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@)) (Mul a1~10@ (Mul c1~14@ c1~14@))))) (Mul (Sub (Mul (Sub (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub d1~16@ a1~10@)) (Mul (Mul b1~12@ a1~10@) (Add a1~10@ c1~14@)))) (Mul (Mul (Add b1~12@ (Mul c1~14@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@))) (Sub (Mul c1~14@ (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ d1~16@))))))) (=> (= temp_1_1~988@ (Mul (Mul (Mul (Mul (Mul (Add c1~14@ a1~10@) (Mul c1~14@ c1~14@)) (Mul (Add d1~16@ b1~12@) (Mul c1~14@ a1~10@))) (Mul d1~16@ (Mul (Mul c1~14@ c1~14@) (Mul c1~14@ a1~10@)))) (Mul (Mul (Mul (Sub d1~16@ a1~10@) (Mul a1~10@ a1~10@)) (Mul (Sub a1~10@ b1~12@) (Mul c1~14@ d1~16@))) (Mul (Mul (Mul b1~12@ c1~14@) (Mul d1~16@ c1~14@)) (Mul a1~10@ (Mul c1~14@ c1~14@))))) (Mul (Sub (Mul (Sub (Mul d1~16@ c1~14@) (Mul a1~10@ d1~16@)) (Mul (Mul a1~10@ a1~10@) (Mul b1~12@ b1~12@))) (Mul (Mul (Mul d1~16@ c1~14@) (Sub d1~16@ a1~10@)) (Mul (Mul b1~12@ a1~10@) (Add a1~10@ c1~14@)))) (Mul (Mul (Add b1~12@ (Mul c1~14@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Mul a1~10@ b1~12@))) (Sub (Mul c1~14@ (Mul b1~12@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ d1~16@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~755@ temp_1_1~988@))) (=> (= temp_1_0~755@ temp_1_1~988@) (=> (= temp_2_0~1265@ (Mul (Mul (Mul (Mul (Sub (Mul c2~22@ c2~22@) (Mul a2~18@ c2~22@)) (Mul (Add a2~18@ d2~24@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul b2~20@ c2~22@) (Add a2~18@ b2~20@)) (Mul (Add b2~20@ c2~22@) (Mul d2~24@ d2~24@)))) (Mul (Mul (Add (Mul a2~18@ d2~24@) c2~22@) (Add (Add a2~18@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@))))) (Sub (Sub (Add (Mul (Mul a2~18@ b2~20@) (Mul d2~24@ b2~20@)) (Mul (Sub a2~18@ a2~18@) (Mul b2~20@ d2~24@))) (Mul (Mul (Add d2~24@ b2~20@) b2~20@) (Mul d2~24@ (Mul d2~24@ c2~22@)))) (Add (Mul (Mul (Sub d2~24@ d2~24@) (Mul d2~24@ 60)) (Mul b2~20@ (Mul c2~22@ d2~24@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Add a2~18@ a2~18@))))))) (=> (= temp_2_1~1518@ (Mul (Mul (Mul (Mul (Sub (Mul c2~22@ c2~22@) (Mul a2~18@ c2~22@)) (Mul (Add a2~18@ d2~24@) (Mul d2~24@ c2~22@))) (Mul (Mul (Mul b2~20@ c2~22@) (Add a2~18@ b2~20@)) (Mul (Add b2~20@ c2~22@) (Mul d2~24@ d2~24@)))) (Mul (Mul (Add (Mul a2~18@ d2~24@) c2~22@) (Add (Add a2~18@ b2~20@) (Mul d2~24@ b2~20@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ b2~20@))))) (Sub (Sub (Add (Mul (Mul b2~20@ a2~18@) (Mul d2~24@ b2~20@)) (Mul (Sub a2~18@ a2~18@) (Mul b2~20@ d2~24@))) (Mul (Mul (Add d2~24@ b2~20@) b2~20@) (Mul d2~24@ (Mul d2~24@ c2~22@)))) (Add (Mul (Mul (Sub d2~24@ d2~24@) (Mul d2~24@ 60)) (Mul b2~20@ (Mul c2~22@ d2~24@))) (Mul (Mul (Mul b2~20@ b2~20@) (Mul b2~20@ b2~20@)) (Mul (Mul c2~22@ b2~20@) (Add a2~18@ a2~18@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1265@ temp_2_1~1518@))) (=> (= temp_2_0~1265@ temp_2_1~1518@) (=> (= temp_3_0~1803@ (Mul (Sub (Mul (Mul (Mul (Mul 27 a3~26@) (Mul c3~30@ d3~32@)) (Mul (Sub d3~32@ d3~32@) (Add c3~30@ d3~32@))) (Mul (Mul (Sub b3~28@ d3~32@) (Mul b3~28@ b3~28@)) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul a3~26@ (Mul d3~32@ c3~30@)) a3~26@) (Add (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul b3~28@ 70) (Mul b3~28@ d3~32@))))) (Sub (Mul (Sub (Mul (Mul 57 c3~30@) c3~30@) (Add (Add d3~32@ c3~30@) (Mul a3~26@ c3~30@))) (Mul b3~28@ (Sub (Mul c3~30@ b3~28@) (Add a3~26@ b3~28@)))) (Mul (Mul (Sub (Sub d3~32@ d3~32@) (Add a3~26@ b3~28@)) (Mul (Sub c3~30@ b3~28@) (Mul a3~26@ d3~32@))) (Mul (Mul (Add a3~26@ c3~30@) (Sub b3~28@ a3~26@)) (Mul c3~30@ (Mul 61 c3~30@))))))) (=> (= temp_3_1~2064@ (Mul (Sub (Mul (Mul (Mul (Mul 27 a3~26@) (Mul c3~30@ d3~32@)) (Mul (Sub d3~32@ d3~32@) (Add c3~30@ d3~32@))) (Mul (Mul (Sub b3~28@ d3~32@) (Mul b3~28@ b3~28@)) (Mul d3~32@ c3~30@))) (Mul (Mul (Mul a3~26@ (Mul d3~32@ c3~30@)) a3~26@) (Add (Mul (Mul d3~32@ d3~32@) (Mul c3~30@ b3~28@)) (Mul (Mul b3~28@ 70) (Mul b3~28@ d3~32@))))) (Sub (Mul (Sub (Mul (Mul 57 c3~30@) c3~30@) (Add (Add d3~32@ c3~30@) (Mul a3~26@ c3~30@))) (Mul b3~28@ (Sub (Mul c3~30@ b3~28@) (Add a3~26@ b3~28@)))) (Mul (Mul (Sub (Sub d3~32@ d3~32@) (Add a3~26@ b3~28@)) (Mul (Mul a3~26@ d3~32@) (Sub c3~30@ b3~28@))) (Mul (Mul (Add a3~26@ c3~30@) (Sub b3~28@ a3~26@)) (Mul c3~30@ (Mul 61 c3~30@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1803@ temp_3_1~2064@))) (=> (= temp_3_0~1803@ temp_3_1~2064@) (=> (= temp_4_0~2201@ (Mul (Mul (Mul (Mul (Add (Mul c4~38@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Sub b4~36@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Sub a4~34@ (Mul b4~36@ b4~36@)) (Mul a4~34@ (Mul a4~34@ a4~34@)))) (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Add c4~38@ d4~40@)) (Add (Mul c4~38@ c4~38@) (Mul d4~40@ c4~38@))) (Mul b4~36@ (Mul (Mul b4~36@ d4~40@) (Add a4~34@ c4~38@))))) a4~34@)) (=> (= temp_4_1~2330@ (Mul (Mul (Mul (Mul (Add (Mul c4~38@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Sub b4~36@ b4~36@) (Mul b4~36@ c4~38@))) (Mul (Sub a4~34@ (Mul b4~36@ b4~36@)) (Mul a4~34@ (Mul a4~34@ a4~34@)))) (Mul (Add (Mul (Mul (Mul c4~38@ c4~38@) (Add c4~38@ d4~40@)) (Mul c4~38@ c4~38@)) (Mul (Mul (Mul c4~38@ c4~38@) (Add c4~38@ d4~40@)) (Mul d4~40@ c4~38@))) (Mul b4~36@ (Mul (Mul b4~36@ d4~40@) (Add a4~34@ c4~38@))))) a4~34@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~2201@ temp_4_1~2330@))) (=> (= temp_4_0~2201@ temp_4_1~2330@) (=> (= temp_5_0~2515@ (Mul c5~46@ (Mul (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ 23)) c5~46@) (Mul (Mul d5~48@ (Sub d5~48@ b5~44@)) (Sub (Mul d5~48@ d5~48@) (Mul 20 d5~48@)))) (Mul (Mul (Mul (Sub a5~42@ a5~42@) (Mul 15 a5~42@)) (Mul (Add 15 d5~48@) (Mul a5~42@ a5~42@))) (Mul (Mul d5~48@ (Mul b5~44@ d5~48@)) (Sub (Mul c5~46@ d5~48@) (Add d5~48@ a5~42@))))))) (=> (= temp_5_1~2676@ (Mul c5~46@ (Mul (Mul (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ 23)) c5~46@) (Mul d5~48@ (Mul (Sub d5~48@ b5~44@) (Sub (Mul d5~48@ d5~48@) (Mul 20 d5~48@))))) (Mul (Mul (Mul (Sub a5~42@ a5~42@) (Mul 15 a5~42@)) (Mul (Add 15 d5~48@) (Mul a5~42@ a5~42@))) (Mul (Mul d5~48@ (Mul b5~44@ d5~48@)) (Sub (Mul c5~46@ d5~48@) (Add d5~48@ a5~42@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2515@ temp_5_1~2676@))) (=> (= temp_5_0~2515@ temp_5_1~2676@) (=> (= temp_6_0~2905@ (Sub (Mul (Add (Mul (Mul (Sub b6~52@ b6~52@) (Mul a6~50@ c6~54@)) d6~56@) (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Add (Mul d6~56@ c6~54@) (Sub c6~54@ c6~54@)))) (Add (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@))) c6~54@)) (Sub (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ a6~50@)) 35) (Sub (Mul (Mul d6~56@ b6~52@) (Mul a6~50@ c6~54@)) d6~56@)) (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul c6~54@ c6~54@) (Add b6~52@ c6~54@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ d6~56@))))))) (=> (= temp_6_1~3110@ (Sub (Mul (Add (Mul (Mul (Sub b6~52@ b6~52@) (Mul a6~50@ c6~54@)) d6~56@) (Mul (Mul (Mul c6~54@ a6~50@) (Mul d6~56@ d6~56@)) (Add (Mul d6~56@ c6~54@) (Sub c6~54@ c6~54@)))) (Add (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ d6~56@)) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ b6~52@))) c6~54@)) (Sub (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ a6~50@)) 35) (Sub (Mul (Mul (Mul d6~56@ b6~52@) a6~50@) c6~54@) d6~56@)) (Mul (Mul (Mul (Mul c6~54@ d6~56@) (Mul b6~52@ d6~56@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@))) (Mul (Mul (Mul c6~54@ c6~54@) (Add b6~52@ c6~54@)) (Mul (Mul a6~50@ c6~54@) (Mul c6~54@ d6~56@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~2905@ temp_6_1~3110@))) (=> (= temp_6_0~2905@ temp_6_1~3110@) (=> (= temp_7_0~3387@ (Mul (Mul (Add (Mul (Mul c7~62@ a7~58@) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ b7~60@))) (Mul (Mul b7~60@ (Mul b7~60@ b7~60@)) (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ 12)))) (Mul (Mul (Mul (Sub a7~58@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Add c7~62@ d7~64@) (Mul d7~64@ c7~62@))) (Add (Mul (Mul a7~58@ c7~62@) (Mul 78 a7~58@)) (Mul (Mul d7~64@ d7~64@) (Sub d7~64@ b7~60@))))) (Mul (Mul d7~64@ (Mul (Sub (Mul d7~64@ a7~58@) (Add a7~58@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Add 42 b7~60@)))) (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Add 85 b7~60@) (Mul b7~60@ d7~64@))) (Mul (Sub (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@)) c7~62@))))) (=> (= temp_7_1~3640@ (Mul (Mul (Add (Mul (Mul c7~62@ a7~58@) (Mul (Mul c7~62@ c7~62@) (Mul a7~58@ b7~60@))) (Mul (Mul b7~60@ (Mul b7~60@ b7~60@)) (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ 12)))) (Mul (Mul (Mul (Sub a7~58@ b7~60@) (Mul c7~62@ d7~64@)) (Mul (Add c7~62@ d7~64@) (Mul d7~64@ c7~62@))) (Add (Mul (Mul a7~58@ c7~62@) (Mul 78 a7~58@)) (Mul (Mul d7~64@ d7~64@) (Sub d7~64@ b7~60@))))) (Mul (Mul d7~64@ (Mul (Sub (Mul d7~64@ a7~58@) (Add a7~58@ a7~58@)) (Mul (Mul a7~58@ d7~64@) (Add 42 b7~60@)))) (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ d7~64@)) (Mul (Mul (Add 85 b7~60@) b7~60@) d7~64@)) (Mul (Sub (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@)) c7~62@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3387@ temp_7_1~3640@))) (=> (= temp_7_0~3387@ temp_7_1~3640@) (=> (= temp_8_0~3913@ (Mul (Mul (Add (Mul (Mul (Mul b8~68@ c8~70@) d8~72@) (Mul (Mul b8~68@ b8~68@) a8~66@)) (Mul (Mul (Mul d8~72@ b8~68@) (Sub b8~68@ c8~70@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ c8~70@)))) (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Add b8~68@ c8~70@)) a8~66@) (Mul (Sub (Sub a8~66@ d8~72@) (Mul a8~66@ c8~70@)) (Sub (Sub a8~66@ c8~70@) (Mul b8~68@ d8~72@))))) (Sub (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Add d8~72@ c8~70@)) (Mul (Add a8~66@ a8~66@) a8~66@)) (Mul (Add (Mul b8~68@ b8~68@) (Sub d8~72@ c8~70@)) (Mul c8~70@ (Mul b8~68@ c8~70@)))) (Mul (Mul (Mul b8~68@ (Mul d8~72@ b8~68@)) (Sub (Mul a8~66@ b8~68@) (Mul c8~70@ b8~68@))) (Mul (Mul (Sub d8~72@ b8~68@) (Mul a8~66@ a8~66@)) (Mul (Mul 9 b8~68@) (Sub d8~72@ 42))))))) (=> (= temp_8_1~4162@ (Mul (Mul (Add (Mul (Mul (Mul b8~68@ c8~70@) d8~72@) (Mul (Mul b8~68@ b8~68@) a8~66@)) (Mul (Mul (Mul d8~72@ b8~68@) (Sub b8~68@ c8~70@)) (Mul (Mul c8~70@ b8~68@) (Mul c8~70@ c8~70@)))) (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Add b8~68@ c8~70@)) a8~66@) (Mul (Sub (Sub a8~66@ d8~72@) (Mul c8~70@ a8~66@)) (Sub (Sub a8~66@ c8~70@) (Mul b8~68@ d8~72@))))) (Sub (Mul (Mul (Mul (Mul c8~70@ d8~72@) (Add d8~72@ c8~70@)) (Mul (Add a8~66@ a8~66@) a8~66@)) (Mul (Add (Mul b8~68@ b8~68@) (Sub d8~72@ c8~70@)) (Mul c8~70@ (Mul b8~68@ c8~70@)))) (Mul (Mul (Mul b8~68@ (Mul d8~72@ b8~68@)) (Sub (Mul a8~66@ b8~68@) (Mul c8~70@ b8~68@))) (Mul (Mul (Sub d8~72@ b8~68@) (Mul a8~66@ a8~66@)) (Mul (Mul 9 b8~68@) (Sub d8~72@ 42))))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~3913@ temp_8_1~4162@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
