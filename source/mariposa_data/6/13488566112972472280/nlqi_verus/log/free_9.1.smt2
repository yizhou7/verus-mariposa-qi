...
(assert (=> %%query%% (not (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> (= temp_0_0~297@ (Mul (Mul (Mul c0~6@ (Mul (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Add c0~6@ (Mul c0~6@ a0~2@)))) (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ a0~2@)) (Mul b0~4@ (Mul b0~4@ d0~8@))) (Mul (Mul c0~6@ (Sub d0~8@ c0~6@)) (Mul (Add b0~4@ d0~8@) (Mul a0~2@ c0~6@))))) (Mul (Mul (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@)) (Add (Mul b0~4@ d0~8@) (Sub a0~2@ b0~4@))) (Mul (Mul (Add d0~8@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)))) (Mul (Mul (Mul (Sub c0~6@ c0~6@) b0~4@) (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ c0~6@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ a0~2@))))))) (=> (= temp_0_1~510@ (Mul (Mul (Mul c0~6@ (Mul (Mul (Mul d0~8@ b0~4@) (Mul a0~2@ d0~8@)) (Add c0~6@ (Mul c0~6@ a0~2@)))) (Mul (Mul (Mul b0~4@ (Mul b0~4@ d0~8@)) (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ a0~2@))) (Mul (Mul c0~6@ (Sub d0~8@ c0~6@)) (Mul (Add b0~4@ d0~8@) (Mul a0~2@ c0~6@))))) (Mul (Mul (Mul (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ a0~2@)) (Add (Mul b0~4@ d0~8@) (Sub a0~2@ b0~4@))) (Mul (Mul (Add d0~8@ b0~4@) (Mul c0~6@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Mul b0~4@ d0~8@)))) (Mul (Mul (Mul (Sub c0~6@ c0~6@) b0~4@) (Mul (Mul d0~8@ c0~6@) (Sub b0~4@ c0~6@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ a0~2@)) (Mul (Mul d0~8@ a0~2@) (Mul a0~2@ a0~2@))))))) (=> (= tmp%1@ (= temp_0_0~297@ temp_0_1~510@)) (and (=> %%location_label%%0 tmp%1@) (=> tmp%1@ (=> (= temp_1_0~734@ (Mul (Mul (Mul (Mul (Mul (Add a1~10@ a1~10@) b1~12@) (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ d1~16@))) (Mul d1~16@ (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@)))) (Add (Mul (Mul (Add c1~14@ d1~16@) (Mul d1~16@ b1~12@)) (Sub (Mul a1~10@ a1~10@) (Mul b1~12@ a1~10@))) (Mul (Sub (Mul a1~10@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ b1~12@) b1~12@)))) (Mul (Mul (Mul (Mul (Add d1~16@ a1~10@) (Mul d1~16@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ d1~16@))) (Mul b1~12@ (Mul d1~16@ (Add d1~16@ a1~10@)))) (Mul (Mul (Sub (Mul c1~14@ a1~10@) (Mul b1~12@ b1~12@)) (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Sub (Mul c1~14@ a1~10@) (Mul d1~16@ a1~10@)) a1~10@))))) (=> (= temp_1_1~943@ (Mul (Mul (Add (Mul (Mul (Add c1~14@ d1~16@) (Mul d1~16@ b1~12@)) (Sub (Mul a1~10@ a1~10@) (Mul b1~12@ a1~10@))) (Mul (Sub (Mul a1~10@ c1~14@) (Mul a1~10@ c1~14@)) (Mul (Mul a1~10@ b1~12@) b1~12@))) (Mul (Mul (Mul (Add a1~10@ a1~10@) b1~12@) (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ d1~16@))) (Mul d1~16@ (Mul (Mul c1~14@ c1~14@) (Mul b1~12@ b1~12@))))) (Mul (Mul (Mul (Mul (Add d1~16@ a1~10@) (Mul d1~16@ c1~14@)) (Mul (Mul b1~12@ c1~14@) (Mul c1~14@ d1~16@))) (Mul b1~12@ (Mul d1~16@ (Add d1~16@ a1~10@)))) (Mul (Mul (Sub (Mul c1~14@ a1~10@) (Mul b1~12@ b1~12@)) (Mul (Mul d1~16@ b1~12@) (Mul b1~12@ a1~10@))) (Mul (Sub (Mul c1~14@ a1~10@) (Mul d1~16@ a1~10@)) a1~10@))))) (=> (= tmp%2@ (= temp_1_0~734@ temp_1_1~943@)) (and (=> %%location_label%%1 tmp%2@) (=> tmp%2@ (=> (= temp_2_0~1171@ (Mul (Sub (Mul (Mul (Mul b2~20@ c2~22@) (Mul (Mul b2~20@ c2~22@) a2~18@)) (Mul (Mul (Sub d2~24@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ d2~24@) (Sub c2~22@ a2~18@)))) (Mul (Mul (Add (Sub c2~22@ a2~18@) (Sub a2~18@ a2~18@)) (Add (Mul b2~20@ a2~18@) (Sub c2~22@ b2~20@))) (Mul (Mul (Add a2~18@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Sub c2~22@ b2~20@))))) (Mul (Mul (Sub (Add (Mul b2~20@ c2~22@) (Sub d2~24@ b2~20@)) (Mul (Mul a2~18@ b2~20@) d2~24@)) (Add (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@)))) (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ b2~20@))) b2~20@)))) (=> (= temp_2_1~1384@ (Mul (Sub (Mul (Mul (Mul b2~20@ c2~22@) (Mul (Mul b2~20@ c2~22@) a2~18@)) (Mul (Mul (Sub d2~24@ d2~24@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ d2~24@) (Sub c2~22@ a2~18@)))) (Mul (Mul (Add (Sub c2~22@ a2~18@) (Sub a2~18@ a2~18@)) (Add (Mul b2~20@ a2~18@) (Sub c2~22@ b2~20@))) (Mul (Mul (Mul a2~18@ b2~20@) (Add a2~18@ b2~20@)) (Mul (Mul a2~18@ a2~18@) (Sub c2~22@ b2~20@))))) (Mul (Mul (Sub (Add (Mul b2~20@ c2~22@) (Sub d2~24@ b2~20@)) (Mul (Mul a2~18@ b2~20@) d2~24@)) (Add (Mul (Mul b2~20@ b2~20@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ d2~24@) (Mul c2~22@ c2~22@)))) (Mul (Mul (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul a2~18@ b2~20@) (Mul a2~18@ b2~20@))) b2~20@)))) (=> (= tmp%3@ (= temp_2_0~1171@ temp_2_1~1384@)) (and (=> %%location_label%%2 tmp%3@) (=> tmp%3@ (=> (= temp_3_0~1552@ (Mul (Mul (Sub (Sub (Mul b3~28@ (Mul a3~26@ c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@))) (Mul (Add (Mul a3~26@ b3~28@) (Mul c3~30@ b3~28@)) d3~32@)) d3~32@) (Mul (Mul c3~30@ (Mul (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@)) b3~28@)) (Mul (Sub (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ c3~30@)) 9) (Mul (Mul (Mul b3~28@ b3~28@) (Sub d3~32@ d3~32@)) (Mul (Mul 29 a3~26@) (Mul a3~26@ d3~32@))))))) (=> (= temp_3_1~1705@ (Mul (Mul (Sub (Sub (Mul b3~28@ (Mul a3~26@ c3~30@)) (Mul (Mul b3~28@ b3~28@) (Mul a3~26@ c3~30@))) (Mul (Add (Mul a3~26@ b3~28@) (Mul c3~30@ b3~28@)) d3~32@)) d3~32@) (Mul (Mul c3~30@ (Mul (Mul (Mul d3~32@ d3~32@) (Mul b3~28@ c3~30@)) b3~28@)) (Mul (Sub (Mul (Mul b3~28@ a3~26@) (Mul a3~26@ c3~30@)) 9) (Mul (Mul b3~28@ (Mul b3~28@ (Sub d3~32@ d3~32@))) (Mul (Mul 29 a3~26@) (Mul a3~26@ d3~32@))))))) (=> (= tmp%4@ (= temp_3_0~1552@ temp_3_1~1705@)) (and (=> %%location_label%%3 tmp%4@) (=> tmp%4@ (=> (= temp_4_0~1969@ (Mul (Mul (Sub (Sub (Add (Mul a4~34@ b4~36@) (Mul b4~36@ a4~34@)) (Sub (Mul d4~40@ c4~38@) (Mul 83 b4~36@))) (Mul (Mul (Mul a4~34@ b4~36@) (Sub c4~38@ d4~40@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ b4~36@)))) (Mul (Add (Mul (Mul d4~40@ b4~36@) (Mul 70 a4~34@)) (Mul (Mul a4~34@ c4~38@) c4~38@)) (Mul (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@))))) (Add (Mul (Mul a4~34@ (Add (Mul c4~38@ c4~38@) (Mul 21 c4~38@))) d4~40@) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ a4~34@))))))) (=> (= temp_4_1~2218@ (Mul (Mul (Sub (Sub (Add (Mul b4~36@ a4~34@) (Mul b4~36@ a4~34@)) (Sub (Mul d4~40@ c4~38@) (Mul 83 b4~36@))) (Mul (Mul (Mul a4~34@ b4~36@) (Sub c4~38@ d4~40@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ b4~36@)))) (Mul (Add (Mul (Mul d4~40@ b4~36@) (Mul 70 a4~34@)) (Mul (Mul a4~34@ c4~38@) c4~38@)) (Mul (Mul (Mul a4~34@ d4~40@) (Mul b4~36@ c4~38@)) (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ d4~40@))))) (Add (Mul (Mul a4~34@ (Add (Mul c4~38@ c4~38@) (Mul 21 c4~38@))) d4~40@) (Mul (Mul (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ d4~40@))) (Mul (Mul (Mul a4~34@ c4~38@) (Mul c4~38@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Mul b4~36@ a4~34@))))))) (=> (= tmp%5@ (= temp_4_0~1969@ temp_4_1~2218@)) (and (=> %%location_label%%4 tmp%5@) (=> tmp%5@ (=> (= temp_5_0~2426@ (Mul (Mul (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Sub a5~42@ c5~46@)) (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ c5~46@))) (Add (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ c5~46@)) (Mul (Mul c5~46@ a5~42@) c5~46@))) c5~46@) (Mul (Mul (Add (Mul (Mul c5~46@ c5~46@) (Add b5~44@ a5~42@)) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@)))) (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ a5~42@))))))) (=> (= temp_5_1~2619@ (Mul (Mul (Mul (Mul (Mul (Mul b5~44@ a5~42@) (Sub a5~42@ c5~46@)) (Mul (Mul c5~46@ d5~48@) (Mul d5~48@ c5~46@))) (Add (Mul (Mul c5~46@ d5~48@) (Mul b5~44@ c5~46@)) (Mul c5~46@ (Mul a5~42@ c5~46@)))) c5~46@) (Mul (Mul (Add (Mul (Mul c5~46@ c5~46@) (Add b5~44@ a5~42@)) (Mul (Mul b5~44@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul a5~42@ c5~46@) (Mul c5~46@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Mul a5~42@ c5~46@)))) (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ c5~46@)) (Sub (Mul d5~48@ d5~48@) (Mul c5~46@ a5~42@))) (Mul (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul d5~48@ a5~42@) (Mul b5~44@ a5~42@))))))) (=> (= tmp%6@ (= temp_5_0~2426@ temp_5_1~2619@)) (and (=> %%location_label%%5 tmp%6@) (=> tmp%6@ (=> (= temp_6_0~2851@ (Mul (Sub (Mul (Sub (Mul (Mul c6~54@ c6~54@) b6~52@) (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ d6~56@)))) (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul b6~52@ a6~50@) (Sub c6~54@ c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@))))) (Sub (Mul (Mul (Mul (Mul b6~52@ a6~50@) c6~54@) (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ c6~54@))) (Mul (Add (Add c6~54@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul a6~50@ d6~56@) a6~50@))) (Mul c6~54@ (Sub (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Sub b6~52@ b6~52@) (Mul d6~56@ c6~54@))))))) (=> (= temp_6_1~3076@ (Mul (Sub (Mul (Sub (Mul (Mul c6~54@ c6~54@) b6~52@) (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@))) (Mul (Mul (Mul c6~54@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul d6~56@ d6~56@) (Mul c6~54@ d6~56@)))) (Mul (Mul (Add (Mul d6~56@ b6~52@) (Mul b6~52@ c6~54@)) (Mul (Mul c6~54@ a6~50@) (Mul b6~52@ d6~56@))) (Mul (Sub (Mul (Mul b6~52@ a6~50@) c6~54@) (Mul (Mul b6~52@ a6~50@) c6~54@)) (Mul (Mul c6~54@ d6~56@) (Mul a6~50@ a6~50@))))) (Sub (Mul (Mul (Mul (Mul b6~52@ a6~50@) c6~54@) (Mul (Mul b6~52@ b6~52@) (Mul b6~52@ c6~54@))) (Mul (Add (Add c6~54@ d6~56@) (Mul c6~54@ c6~54@)) (Mul (Mul a6~50@ d6~56@) a6~50@))) (Mul c6~54@ (Sub (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ a6~50@)) (Mul (Sub b6~52@ b6~52@) (Mul d6~56@ c6~54@))))))) (=> (= tmp%7@ (= temp_6_0~2851@ temp_6_1~3076@)) (and (=> %%location_label%%6 tmp%7@) (=> tmp%7@ (=> (= temp_7_0~3272@ (Mul (Mul c7~62@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) c7~62@) (Mul a7~58@ (Sub a7~58@ c7~62@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@))))) (Mul (Mul (Mul (Mul (Mul b7~60@ d7~64@) d7~64@) (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ b7~60@))) (Mul (Add (Mul a7~58@ b7~60@) 3) (Add (Mul d7~64@ c7~62@) (Mul c7~62@ b7~60@)))) (Mul (Add (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ a7~58@))) (Mul (Mul (Mul b7~60@ a7~58@) (Add d7~64@ b7~60@)) d7~64@))))) (=> (= temp_7_1~3453@ (Mul (Mul c7~62@ (Mul (Mul (Mul (Mul a7~58@ c7~62@) c7~62@) (Mul a7~58@ (Sub a7~58@ c7~62@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul d7~64@ b7~60@)) (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ d7~64@))))) (Mul (Mul (Mul (Mul (Mul b7~60@ d7~64@) d7~64@) (Mul (Mul a7~58@ c7~62@) (Mul a7~58@ b7~60@))) (Mul (Add (Mul a7~58@ b7~60@) 3) (Add (Mul d7~64@ c7~62@) (Mul c7~62@ b7~60@)))) (Mul (Add (Mul (Mul b7~60@ a7~58@) (Mul a7~58@ b7~60@)) (Mul (Mul d7~64@ a7~58@) (Mul a7~58@ a7~58@))) (Mul (Mul (Add d7~64@ b7~60@) (Mul b7~60@ a7~58@)) d7~64@))))) (=> (= tmp%8@ (= temp_7_0~3272@ temp_7_1~3453@)) (and (=> %%location_label%%7 tmp%8@) (=> tmp%8@ (=> (= temp_8_0~3721@ (Mul (Mul (Mul (Mul (Add (Mul d8~72@ a8~66@) (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ d8~72@)))) (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul 52 a8~66@) (Mul c8~70@ b8~68@))) (Mul (Mul (Sub b8~68@ c8~70@) (Mul a8~66@ d8~72@)) (Mul (Mul c8~70@ a8~66@) d8~72@)))) (Mul (Sub (Mul (Add (Mul d8~72@ a8~66@) (Mul b8~68@ a8~66@)) (Mul c8~70@ (Mul a8~66@ a8~66@))) (Mul (Sub (Mul c8~70@ b8~68@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ a8~66@) b8~68@))) (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ a8~66@)) (Mul (Mul c8~70@ c8~70@) d8~72@)) (Sub (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ a8~66@)) (Add (Sub c8~70@ b8~68@) (Add b8~68@ d8~72@))))))) (=> (= temp_8_1~3974@ (Mul (Mul (Mul (Mul (Add (Mul d8~72@ a8~66@) (Mul b8~68@ d8~72@)) (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ c8~70@))) (Mul (Mul (Mul d8~72@ a8~66@) (Mul d8~72@ c8~70@)) (Mul (Mul c8~70@ c8~70@) (Mul d8~72@ d8~72@)))) (Mul (Mul (Mul (Mul a8~66@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul 52 a8~66@) (Mul c8~70@ b8~68@))) (Mul (Mul (Sub b8~68@ c8~70@) (Mul a8~66@ d8~72@)) (Mul (Mul c8~70@ a8~66@) d8~72@)))) (Mul (Sub (Mul (Add (Mul d8~72@ a8~66@) (Mul b8~68@ a8~66@)) (Mul (Mul a8~66@ a8~66@) c8~70@)) (Mul (Sub (Mul c8~70@ b8~68@) (Mul c8~70@ a8~66@)) (Mul (Mul d8~72@ a8~66@) b8~68@))) (Mul (Mul (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ a8~66@)) (Mul (Mul c8~70@ c8~70@) d8~72@)) (Sub (Mul (Mul c8~70@ b8~68@) (Mul a8~66@ a8~66@)) (Add (Sub c8~70@ b8~68@) (Add b8~68@ d8~72@))))))) (=> (= tmp%9@ (= temp_8_0~3721@ temp_8_1~3974@)) (=> %%location_label%%8 tmp%9@))))))))))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
