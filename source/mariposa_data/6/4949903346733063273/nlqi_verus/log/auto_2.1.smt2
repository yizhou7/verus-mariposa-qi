...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Add (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul 0 c0~6@))) (Add (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@)) (Mul (Add d0~8@ a0~2@) (Mul d0~8@ d0~8@)))) (Mul (Mul (Mul c0~6@ (Mul d0~8@ a0~2@)) (Add (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@))) (Sub (Mul (Mul a0~2@ b0~4@) b0~4@) (Mul b0~4@ (Mul d0~8@ c0~6@))))) (Mul (Mul (Mul (Sub c0~6@ (Sub c0~6@ b0~4@)) (Add (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) a0~2@) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ c0~6@)))) (Sub (Mul d0~8@ (Sub d0~8@ (Mul a0~2@ c0~6@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ b0~4@)) (Sub (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@))))))) (=> (= temp_0_1~602@ (Mul (Add (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul 0 c0~6@))) (Add (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@)) (Mul (Add d0~8@ a0~2@) (Mul d0~8@ d0~8@)))) (Mul (Mul (Mul c0~6@ (Mul d0~8@ a0~2@)) (Add (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@))) (Sub (Mul (Mul a0~2@ b0~4@) b0~4@) (Mul b0~4@ (Mul d0~8@ c0~6@))))) (Sub (Mul (Mul (Mul (Sub c0~6@ (Sub c0~6@ b0~4@)) (Add (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) a0~2@) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ c0~6@)))) (Mul d0~8@ (Sub d0~8@ (Mul a0~2@ c0~6@)))) (Mul (Mul (Mul (Sub c0~6@ (Sub c0~6@ b0~4@)) (Add (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) a0~2@) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ c0~6@)))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ b0~4@)) (Sub (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~602@))) (=> (= temp_0_0~313@ temp_0_1~602@) (=> (= temp_1_0~739@ (Mul (Mul (Mul c1~14@ (Mul (Mul a1~10@ (Sub d1~16@ d1~16@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ b1~12@)))) (Mul (Mul (Add (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ 76)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))))) d1~16@)) (=> (= temp_1_1~852@ (Mul (Mul (Mul c1~14@ (Mul (Mul a1~10@ (Sub d1~16@ d1~16@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ b1~12@)))) (Mul (Mul (Add (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul (Mul a1~10@ d1~16@) d1~16@) 76) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))))) d1~16@)) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~739@ temp_1_1~852@))))))))))))
(assert %%query%%)
(check-sat)
