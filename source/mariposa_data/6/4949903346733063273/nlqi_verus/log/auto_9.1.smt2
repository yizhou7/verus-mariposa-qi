...
(declare-const temp_1_1~852@ Int)
(declare-const temp_2_0~1081@ Int)
(declare-const temp_2_1~1286@ Int)
(declare-const temp_3_0~1443@ Int)
(declare-const temp_3_1~1576@ Int)
(declare-const temp_4_0~1789@ Int)
(declare-const temp_4_1~1978@ Int)
(declare-const temp_5_0~2191@ Int)
(declare-const temp_5_1~2380@ Int)
(declare-const temp_6_0~2641@ Int)
(declare-const temp_6_1~2886@ Int)
(declare-const temp_7_0~3091@ Int)
(declare-const temp_7_1~3272@ Int)
(declare-const temp_8_0~3473@ Int)
(declare-const temp_8_1~3650@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~313@ (Mul (Add (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul 0 c0~6@))) (Add (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@)) (Mul (Add d0~8@ a0~2@) (Mul d0~8@ d0~8@)))) (Mul (Mul (Mul c0~6@ (Mul d0~8@ a0~2@)) (Add (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@))) (Sub (Mul (Mul a0~2@ b0~4@) b0~4@) (Mul b0~4@ (Mul d0~8@ c0~6@))))) (Mul (Mul (Mul (Sub c0~6@ (Sub c0~6@ b0~4@)) (Add (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) a0~2@) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ c0~6@)))) (Sub (Mul d0~8@ (Sub d0~8@ (Mul a0~2@ c0~6@))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ b0~4@)) (Sub (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@))))))) (=> (= temp_0_1~602@ (Mul (Add (Mul (Mul (Mul (Mul a0~2@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul d0~8@ a0~2@) (Mul 0 c0~6@))) (Add (Mul (Mul a0~2@ a0~2@) (Mul a0~2@ b0~4@)) (Mul (Add d0~8@ a0~2@) (Mul d0~8@ d0~8@)))) (Mul (Mul (Mul c0~6@ (Mul d0~8@ a0~2@)) (Add (Mul a0~2@ d0~8@) (Mul c0~6@ a0~2@))) (Sub (Mul (Mul a0~2@ b0~4@) b0~4@) (Mul b0~4@ (Mul d0~8@ c0~6@))))) (Sub (Mul (Mul (Mul (Sub c0~6@ (Sub c0~6@ b0~4@)) (Add (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) a0~2@) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ c0~6@)))) (Mul d0~8@ (Sub d0~8@ (Mul a0~2@ c0~6@)))) (Mul (Mul (Mul (Sub c0~6@ (Sub c0~6@ b0~4@)) (Add (Mul c0~6@ a0~2@) (Mul d0~8@ c0~6@))) (Mul (Mul (Mul c0~6@ a0~2@) a0~2@) (Mul (Mul c0~6@ c0~6@) (Mul c0~6@ c0~6@)))) (Mul (Mul (Mul a0~2@ b0~4@) (Mul a0~2@ b0~4@)) (Sub (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~313@ temp_0_1~602@))) (=> (= temp_0_0~313@ temp_0_1~602@) (=> (= temp_1_0~739@ (Mul (Mul (Mul c1~14@ (Mul (Mul a1~10@ (Sub d1~16@ d1~16@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ b1~12@)))) (Mul (Mul (Add (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul a1~10@ d1~16@) (Mul d1~16@ 76)) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))))) d1~16@)) (=> (= temp_1_1~852@ (Mul (Mul (Mul c1~14@ (Mul (Mul a1~10@ (Sub d1~16@ d1~16@)) (Mul (Mul c1~14@ a1~10@) (Mul c1~14@ b1~12@)))) (Mul (Mul (Add (Mul a1~10@ d1~16@) (Mul c1~14@ a1~10@)) (Mul (Mul d1~16@ c1~14@) (Mul c1~14@ c1~14@))) (Mul (Mul (Mul (Mul a1~10@ d1~16@) d1~16@) 76) (Mul (Mul c1~14@ c1~14@) (Mul a1~10@ c1~14@))))) d1~16@)) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~739@ temp_1_1~852@))) (=> (= temp_1_0~739@ temp_1_1~852@) (=> (= temp_2_0~1081@ (Sub (Mul (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ a2~18@)) a2~18@) (Add (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ d2~24@)) (Sub (Mul b2~20@ b2~20@) (Mul 70 b2~20@)))) (Add (Mul d2~24@ (Mul (Mul c2~22@ b2~20@) c2~22@)) (Sub (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ c2~22@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ c2~22@))))) (Mul (Mul (Mul (Mul d2~24@ (Mul b2~20@ c2~22@)) d2~24@) (Mul (Mul (Mul a2~18@ c2~22@) b2~20@) c2~22@)) (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ d2~24@))) (Sub (Mul b2~20@ (Mul a2~18@ d2~24@)) (Mul (Mul a2~18@ b2~20@) (Add a2~18@ b2~20@))))))) (=> (= temp_2_1~1286@ (Sub (Mul (Mul (Mul (Mul (Mul c2~22@ d2~24@) (Mul a2~18@ a2~18@)) a2~18@) (Add (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ d2~24@)) (Sub (Mul b2~20@ b2~20@) (Mul 70 b2~20@)))) (Add (Mul d2~24@ (Mul (Mul c2~22@ b2~20@) c2~22@)) (Sub (Mul (Mul c2~22@ a2~18@) (Mul b2~20@ c2~22@)) (Mul (Mul d2~24@ a2~18@) (Mul a2~18@ c2~22@))))) (Mul (Mul (Mul (Mul d2~24@ (Mul b2~20@ c2~22@)) d2~24@) (Mul (Mul (Mul a2~18@ c2~22@) b2~20@) c2~22@)) (Mul (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ d2~24@)) (Mul (Mul b2~20@ d2~24@) (Mul d2~24@ d2~24@))) (Sub (Mul b2~20@ (Mul a2~18@ d2~24@)) (Mul a2~18@ (Mul b2~20@ (Add a2~18@ b2~20@)))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1081@ temp_2_1~1286@))) (=> (= temp_2_0~1081@ temp_2_1~1286@) (=> (= temp_3_0~1443@ (Add (Mul b3~28@ a3~26@) (Mul (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ b3~28@) d3~32@)) (Mul a3~26@ (Mul (Mul d3~32@ b3~28@) (Mul d3~32@ a3~26@)))) (Mul (Mul (Mul (Mul 10 a3~26@) (Mul b3~28@ c3~30@)) (Mul (Sub b3~28@ d3~32@) (Sub d3~32@ a3~26@))) (Add (Mul (Sub b3~28@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ b3~28@))))))) (=> (= temp_3_1~1576@ (Add (Mul b3~28@ a3~26@) (Mul (Mul (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ b3~28@) d3~32@)) (Mul a3~26@ (Mul (Mul (Mul d3~32@ b3~28@) d3~32@) a3~26@))) (Mul (Mul (Mul (Mul 10 a3~26@) (Mul b3~28@ c3~30@)) (Mul (Sub b3~28@ d3~32@) (Sub d3~32@ a3~26@))) (Add (Mul (Sub b3~28@ c3~30@) (Mul b3~28@ c3~30@)) (Mul (Mul c3~30@ a3~26@) (Mul b3~28@ b3~28@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1443@ temp_3_1~1576@))) (=> (= temp_3_0~1443@ temp_3_1~1576@) (=> (= temp_4_0~1789@ (Mul (Mul (Mul (Mul (Mul a4~34@ (Add a4~34@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul d4~40@ c4~38@) a4~34@) (Mul (Mul 2 a4~34@) (Add a4~34@ d4~40@)))) (Mul (Mul (Add (Mul b4~36@ b4~36@) (Mul c4~38@ b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul d4~40@ b4~36@))) (Add (Mul b4~36@ (Mul a4~34@ b4~36@)) (Add b4~36@ (Sub d4~40@ d4~40@))))) (Sub c4~38@ (Mul (Mul (Mul c4~38@ (Sub b4~36@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ d4~40@))) (Mul (Sub (Sub 78 c4~38@) (Mul d4~40@ a4~34@)) d4~40@))))) (=> (= temp_4_1~1978@ (Mul (Mul (Mul (Mul (Mul a4~34@ (Add a4~34@ a4~34@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul 2 a4~34@) (Add a4~34@ d4~40@)) (Mul (Mul d4~40@ c4~38@) a4~34@))) (Mul (Mul (Add (Mul b4~36@ b4~36@) (Mul c4~38@ b4~36@)) (Sub (Mul a4~34@ b4~36@) (Mul d4~40@ b4~36@))) (Add (Mul b4~36@ (Mul a4~34@ b4~36@)) (Add b4~36@ (Sub d4~40@ d4~40@))))) (Sub c4~38@ (Mul (Mul (Mul c4~38@ (Sub b4~36@ c4~38@)) (Mul (Mul d4~40@ a4~34@) (Mul d4~40@ d4~40@))) (Mul (Sub (Sub 78 c4~38@) (Mul d4~40@ a4~34@)) d4~40@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~1789@ temp_4_1~1978@))) (=> (= temp_4_0~1789@ temp_4_1~1978@) (=> (= temp_5_0~2191@ (Mul (Mul (Mul (Mul (Add (Mul b5~44@ b5~44@) (Sub b5~44@ d5~48@)) (Mul (Add b5~44@ c5~46@) b5~44@)) (Mul a5~42@ (Mul (Mul a5~42@ a5~42@) d5~48@))) (Add a5~42@ (Mul (Mul (Sub a5~42@ c5~46@) (Mul 6 b5~44@)) b5~44@))) (Sub (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Mul b5~44@ (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ b5~44@)))) (Mul (Mul b5~44@ (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ a5~42@))) (Add (Mul (Add a5~42@ b5~44@) b5~44@) (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@))))))) (=> (= temp_5_1~2380@ (Mul (Mul (Mul (Add (Mul b5~44@ b5~44@) (Sub b5~44@ d5~48@)) (Mul (Add b5~44@ c5~46@) b5~44@)) (Mul (Mul a5~42@ (Mul (Mul a5~42@ a5~42@) d5~48@)) (Add a5~42@ (Mul (Mul (Sub a5~42@ c5~46@) (Mul 6 b5~44@)) b5~44@)))) (Sub (Mul (Mul (Mul (Mul b5~44@ b5~44@) (Mul c5~46@ d5~48@)) (Mul (Mul d5~48@ c5~46@) (Mul b5~44@ c5~46@))) (Mul (Mul b5~44@ (Mul b5~44@ a5~42@)) (Mul (Mul d5~48@ b5~44@) (Mul a5~42@ b5~44@)))) (Mul (Mul b5~44@ (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ a5~42@))) (Add (Mul (Add a5~42@ b5~44@) b5~44@) (Mul (Mul c5~46@ b5~44@) (Mul c5~46@ d5~48@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2191@ temp_5_1~2380@))) (=> (= temp_5_0~2191@ temp_5_1~2380@) (=> (= temp_6_0~2641@ (Mul (Mul (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Sub c6~54@ c6~54@)) (Add (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@)))) (Add (Mul (Mul (Mul a6~50@ c6~54@) (Sub d6~56@ a6~50@)) c6~54@) (Mul (Mul (Mul c6~54@ b6~52@) (Add c6~54@ b6~52@)) (Mul (Mul a6~50@ d6~56@) d6~56@)))) (Sub (Mul (Add (Mul (Add b6~52@ c6~54@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ d6~56@))) (Mul (Sub (Mul c6~54@ a6~50@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ b6~52@)))) (Mul (Sub b6~52@ (Sub b6~52@ (Mul c6~54@ a6~50@))) (Sub (Mul (Mul 60 d6~56@) (Mul c6~54@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Sub a6~50@ d6~56@))))))) (=> (= temp_6_1~2886@ (Mul (Mul (Mul (Mul (Mul (Mul b6~52@ a6~50@) (Sub c6~54@ c6~54@)) (Add (Mul a6~50@ d6~56@) (Mul a6~50@ b6~52@))) (Mul (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ a6~50@)) (Mul (Mul d6~56@ b6~52@) (Mul d6~56@ c6~54@)))) (Add (Mul (Sub (Mul (Mul a6~50@ c6~54@) d6~56@) (Mul (Mul a6~50@ c6~54@) a6~50@)) c6~54@) (Mul (Mul (Mul c6~54@ b6~52@) (Add c6~54@ b6~52@)) (Mul (Mul a6~50@ d6~56@) d6~56@)))) (Sub (Mul (Add (Mul (Add b6~52@ c6~54@) (Mul d6~56@ d6~56@)) (Mul (Mul b6~52@ a6~50@) (Mul b6~52@ d6~56@))) (Mul (Sub (Mul c6~54@ a6~50@) (Mul a6~50@ d6~56@)) (Mul (Mul b6~52@ c6~54@) (Mul d6~56@ b6~52@)))) (Mul (Sub b6~52@ (Sub b6~52@ (Mul c6~54@ a6~50@))) (Sub (Mul (Mul 60 d6~56@) (Mul c6~54@ d6~56@)) (Mul (Mul a6~50@ a6~50@) (Sub a6~50@ d6~56@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~2641@ temp_6_1~2886@))) (=> (= temp_6_0~2641@ temp_6_1~2886@) (=> (= temp_7_0~3091@ (Mul (Mul (Mul (Mul (Mul c7~62@ (Mul c7~62@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@))) (Mul (Mul (Add b7~60@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Mul c7~62@ c7~62@) (Add c7~62@ b7~60@)))) (Mul (Sub c7~62@ (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ a7~58@))) (Sub (Add (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@)) (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@))))) (Sub (Add (Mul (Sub (Mul a7~58@ d7~64@) (Mul b7~60@ 59)) (Mul (Mul b7~60@ d7~64@) (Add b7~60@ d7~64@))) (Mul (Add (Mul c7~62@ b7~60@) (Mul c7~62@ a7~58@)) a7~58@)) a7~58@))) (=> (= temp_7_1~3272@ (Mul (Mul (Mul (Mul (Mul c7~62@ (Mul b7~60@ c7~62@)) (Mul (Mul c7~62@ a7~58@) (Mul d7~64@ b7~60@))) (Mul (Mul (Add b7~60@ a7~58@) (Mul c7~62@ d7~64@)) (Mul (Mul c7~62@ c7~62@) (Add c7~62@ b7~60@)))) (Mul (Sub c7~62@ (Mul (Mul a7~58@ d7~64@) (Mul b7~60@ a7~58@))) (Sub (Add (Mul d7~64@ c7~62@) (Mul a7~58@ a7~58@)) (Mul (Mul c7~62@ c7~62@) (Mul d7~64@ a7~58@))))) (Sub (Add (Mul (Sub (Mul a7~58@ d7~64@) (Mul b7~60@ 59)) (Mul (Mul b7~60@ d7~64@) (Add b7~60@ d7~64@))) (Mul (Add (Mul c7~62@ b7~60@) (Mul c7~62@ a7~58@)) a7~58@)) a7~58@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3091@ temp_7_1~3272@))) (=> (= temp_7_0~3091@ temp_7_1~3272@) (=> (= temp_8_0~3473@ (Mul (Mul (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ b8~68@) b8~68@)) (Mul (Mul (Add d8~72@ a8~66@) (Mul b8~68@ c8~70@)) c8~70@)) (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ a8~66@))) (Mul (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul b8~68@ c8~70@) a8~66@)))) (Mul (Mul (Mul (Add (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ c8~70@)))) d8~72@))) (=> (= temp_8_1~3650@ (Mul (Mul (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Mul a8~66@ b8~68@) b8~68@)) (Mul (Mul (Add d8~72@ a8~66@) (Mul b8~68@ c8~70@)) c8~70@)) (Mul (Mul (Mul (Mul c8~70@ c8~70@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ d8~72@) (Mul b8~68@ a8~66@))) (Mul (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ a8~66@)) (Mul b8~68@ (Mul c8~70@ a8~66@))))) (Mul (Mul (Mul (Add (Mul c8~70@ a8~66@) (Mul d8~72@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul a8~66@ a8~66@))) (Mul (Mul (Mul b8~68@ d8~72@) (Mul d8~72@ a8~66@)) (Mul (Mul b8~68@ a8~66@) (Mul b8~68@ c8~70@)))) d8~72@))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~3473@ temp_8_1~3650@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
