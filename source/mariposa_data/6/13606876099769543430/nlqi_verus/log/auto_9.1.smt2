...
(declare-const temp_1_0~699@ Int)
(declare-const temp_1_1~932@ Int)
(declare-const temp_2_0~1185@ Int)
(declare-const temp_2_1~1414@ Int)
(declare-const temp_3_0~1655@ Int)
(declare-const temp_3_1~1872@ Int)
(declare-const temp_4_0~2113@ Int)
(declare-const temp_4_1~2330@ Int)
(declare-const temp_5_0~2583@ Int)
(declare-const temp_5_1~2812@ Int)
(declare-const temp_6_0~2925@ Int)
(declare-const temp_6_1~3014@ Int)
(declare-const temp_7_0~3271@ Int)
(declare-const temp_7_1~3504@ Int)
(declare-const temp_8_0~3789@ Int)
(declare-const temp_8_1~4050@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~261@ (Mul (Mul (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ c0~6@)) (Sub (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@))) (Mul (Mul (Add d0~8@ c0~6@) (Mul c0~6@ c0~6@)) d0~8@)) (Mul (Sub (Mul (Mul d0~8@ a0~2@) (Add d0~8@ b0~4@)) (Sub (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))) (Sub (Sub c0~6@ (Mul b0~4@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ c0~6@))))) (Mul (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ b0~4@))) (Mul (Mul (Mul b0~4@ a0~2@) (Add d0~8@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@)))) b0~4@))) (=> (= temp_0_1~442@ (Mul (Mul (Mul (Mul (Mul (Mul c0~6@ c0~6@) (Mul a0~2@ c0~6@)) (Sub (Mul d0~8@ c0~6@) (Mul c0~6@ d0~8@))) (Mul (Mul (Add d0~8@ c0~6@) (Mul c0~6@ c0~6@)) d0~8@)) (Mul (Sub (Mul (Mul d0~8@ a0~2@) (Add d0~8@ b0~4@)) (Sub (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@))) (Sub (Sub c0~6@ (Mul b0~4@ c0~6@)) (Mul (Mul c0~6@ a0~2@) (Mul a0~2@ c0~6@))))) (Mul (Mul (Mul (Mul (Mul d0~8@ d0~8@) (Mul d0~8@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Mul b0~4@ d0~8@))) (Mul (Mul (Mul b0~4@ a0~2@) (Add d0~8@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ c0~6@)))) b0~4@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~261@ temp_0_1~442@))) (=> (= temp_0_0~261@ temp_0_1~442@) (=> (= temp_1_0~699@ (Mul (Mul (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Sub a1~10@ d1~16@))) (Add (Add (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@)))) (Mul (Mul (Sub (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@)) d1~16@) (Mul (Mul (Mul b1~12@ d1~16@) (Mul d1~16@ c1~14@)) (Mul (Mul c1~14@ a1~10@) (Sub c1~14@ c1~14@))))) (Mul (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Add a1~10@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Add b1~12@ d1~16@))) (Add (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Mul b1~12@ d1~16@) (Sub b1~12@ c1~14@)))) (Mul (Mul c1~14@ (Mul (Sub b1~12@ b1~12@) (Add b1~12@ b1~12@))) (Mul (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ b1~12@)) (Sub (Mul b1~12@ d1~16@) (Sub c1~14@ d1~16@))))))) (=> (= temp_1_1~932@ (Mul (Mul (Mul (Mul (Mul (Mul d1~16@ c1~14@) (Mul a1~10@ b1~12@)) (Mul (Mul a1~10@ b1~12@) (Sub a1~10@ d1~16@))) (Add (Add (Mul b1~12@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Mul d1~16@ b1~12@) (Mul c1~14@ c1~14@)))) (Mul (Mul (Sub (Mul a1~10@ c1~14@) (Mul d1~16@ a1~10@)) d1~16@) (Mul (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ d1~16@)) (Mul (Mul c1~14@ a1~10@) (Sub c1~14@ c1~14@))))) (Mul (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Add a1~10@ c1~14@)) (Mul (Mul d1~16@ a1~10@) (Add b1~12@ d1~16@))) (Add (Mul (Mul b1~12@ d1~16@) (Mul c1~14@ b1~12@)) (Mul (Mul b1~12@ d1~16@) (Sub b1~12@ c1~14@)))) (Mul (Mul c1~14@ (Mul (Sub b1~12@ b1~12@) (Add b1~12@ b1~12@))) (Mul (Mul (Mul a1~10@ a1~10@) (Mul c1~14@ b1~12@)) (Sub (Mul b1~12@ d1~16@) (Sub c1~14@ d1~16@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~699@ temp_1_1~932@))) (=> (= temp_1_0~699@ temp_1_1~932@) (=> (= temp_2_0~1185@ (Sub (Mul (Mul (Sub (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ 66)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ a2~18@))) (Add (Mul (Mul b2~20@ c2~22@) (Sub a2~18@ c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)))) (Mul (Mul (Add (Mul a2~18@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ c2~22@) d2~24@)) (Add (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ d2~24@)) (Mul c2~22@ (Mul a2~18@ d2~24@))))) (Mul (Mul (Mul d2~24@ (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ c2~22@))) (Mul (Sub (Mul d2~24@ b2~20@) (Sub c2~22@ b2~20@)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ c2~22@)))) (Mul (Mul (Mul b2~20@ (Mul d2~24@ d2~24@)) c2~22@) (Mul (Sub (Mul c2~22@ d2~24@) a2~18@) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@))))))) (=> (= temp_2_1~1414@ (Sub (Mul (Mul (Sub (Mul (Mul b2~20@ c2~22@) (Mul a2~18@ 66)) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ a2~18@))) (Add (Mul (Mul b2~20@ c2~22@) (Sub a2~18@ c2~22@)) (Mul (Mul c2~22@ c2~22@) (Mul a2~18@ a2~18@)))) (Mul (Mul (Add (Mul a2~18@ b2~20@) (Mul d2~24@ a2~18@)) (Mul (Mul d2~24@ c2~22@) d2~24@)) (Add (Mul (Mul b2~20@ b2~20@) (Mul c2~22@ d2~24@)) (Mul c2~22@ (Mul a2~18@ d2~24@))))) (Mul (Mul (Mul (Mul b2~20@ (Mul d2~24@ d2~24@)) c2~22@) (Mul (Sub (Mul c2~22@ d2~24@) a2~18@) (Mul (Mul d2~24@ c2~22@) (Mul c2~22@ c2~22@)))) (Mul (Mul d2~24@ (Mul (Mul b2~20@ a2~18@) (Mul c2~22@ c2~22@))) (Mul (Sub (Mul d2~24@ b2~20@) (Sub c2~22@ b2~20@)) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ c2~22@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1185@ temp_2_1~1414@))) (=> (= temp_2_0~1185@ temp_2_1~1414@) (=> (= temp_3_0~1655@ (Add (Mul (Sub (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@)) a3~26@) (Sub (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ b3~28@)))) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ (Mul (Mul a3~26@ c3~30@) (Add b3~28@ c3~30@))))) (Mul (Mul (Mul (Mul (Sub b3~28@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ c3~30@) (Mul d3~32@ a3~26@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ b3~28@)))) (Mul (Mul (Add (Mul c3~30@ d3~32@) (Sub b3~28@ b3~28@)) (Mul d3~32@ (Mul c3~30@ c3~30@))) (Mul (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Sub a3~26@ 85) (Sub d3~32@ a3~26@))))))) (=> (= temp_3_1~1872@ (Add (Mul (Sub (Mul (Mul (Mul d3~32@ c3~30@) (Mul c3~30@ c3~30@)) a3~26@) (Sub (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ b3~28@)) (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ b3~28@)))) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ (Mul (Mul a3~26@ c3~30@) (Add b3~28@ c3~30@))))) (Mul (Mul (Mul (Mul (Sub b3~28@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul d3~32@ a3~26@) (Mul c3~30@ c3~30@))) (Mul (Mul (Mul b3~28@ c3~30@) (Mul a3~26@ d3~32@)) (Mul (Mul c3~30@ d3~32@) (Sub b3~28@ b3~28@)))) (Mul (Mul (Add (Mul c3~30@ d3~32@) (Sub b3~28@ b3~28@)) (Mul d3~32@ (Mul c3~30@ c3~30@))) (Mul (Mul (Mul c3~30@ b3~28@) (Mul a3~26@ d3~32@)) (Mul (Sub a3~26@ 85) (Sub d3~32@ a3~26@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1655@ temp_3_1~1872@))) (=> (= temp_3_0~1655@ temp_3_1~1872@) (=> (= temp_4_0~2113@ (Mul (Mul (Mul (Add (Sub (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Sub b4~36@ 61))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Mul c4~38@ b4~36@) (Sub a4~34@ d4~40@)))) (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@))) (Sub (Add c4~38@ (Mul b4~36@ d4~40@)) (Mul (Add d4~40@ d4~40@) (Mul d4~40@ a4~34@))))) (Mul (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@)) (Sub (Mul d4~40@ d4~40@) (Sub a4~34@ d4~40@))) b4~36@) (Sub (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ b4~36@)) 97) (Mul b4~36@ (Mul c4~38@ c4~38@)))))) (=> (= temp_4_1~2330@ (Mul (Mul (Mul (Add (Sub (Mul b4~36@ a4~34@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ d4~40@) (Sub b4~36@ 61))) (Mul (Mul (Mul d4~40@ a4~34@) (Mul c4~38@ a4~34@)) (Mul (Sub a4~34@ d4~40@) (Mul c4~38@ b4~36@)))) (Mul (Mul (Mul (Mul c4~38@ d4~40@) (Mul a4~34@ c4~38@)) (Mul (Mul d4~40@ c4~38@) (Mul b4~36@ b4~36@))) (Sub (Add c4~38@ (Mul b4~36@ d4~40@)) (Mul (Add d4~40@ d4~40@) (Mul d4~40@ a4~34@))))) (Mul (Mul (Mul (Mul (Mul c4~38@ a4~34@) (Mul d4~40@ b4~36@)) (Sub (Mul d4~40@ d4~40@) (Sub a4~34@ d4~40@))) b4~36@) (Sub (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ b4~36@)) 97) (Mul b4~36@ (Mul c4~38@ c4~38@)))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~2113@ temp_4_1~2330@))) (=> (= temp_4_0~2113@ temp_4_1~2330@) (=> (= temp_5_0~2583@ (Mul (Mul (Mul (Mul (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ a5~42@)) (Mul d5~48@ (Mul b5~44@ b5~44@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@ d5~48@) (Sub c5~46@ d5~48@)))) (Sub (Add (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ b5~44@)) (Mul (Mul b5~44@ 76) (Mul d5~48@ b5~44@))) (Mul (Mul c5~46@ b5~44@) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ a5~42@))))) (Mul (Mul (Mul (Mul (Sub c5~46@ c5~46@) (Mul a5~42@ b5~44@)) (Mul c5~46@ (Mul a5~42@ d5~48@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@)) a5~42@)) (Mul (Mul d5~48@ (Mul (Mul a5~42@ d5~48@) (Sub d5~48@ c5~46@))) (Mul (Mul (Mul a5~42@ a5~42@) (Add d5~48@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ d5~48@))))))) (=> (= temp_5_1~2812@ (Mul (Mul (Mul (Mul (Mul (Sub d5~48@ b5~44@) (Mul c5~46@ a5~42@)) (Mul d5~48@ (Mul b5~44@ b5~44@))) (Mul (Mul (Mul b5~44@ c5~46@) (Mul c5~46@ b5~44@)) (Mul (Mul a5~42@ d5~48@) (Sub c5~46@ d5~48@)))) (Sub (Add (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ b5~44@)) (Mul (Mul b5~44@ 76) (Mul d5~48@ b5~44@))) (Mul (Mul c5~46@ b5~44@) (Mul (Mul b5~44@ a5~42@) (Mul a5~42@ a5~42@))))) (Mul (Mul (Mul (Mul (Sub c5~46@ c5~46@) (Mul a5~42@ b5~44@)) (Mul c5~46@ (Mul a5~42@ d5~48@))) (Mul (Mul (Mul c5~46@ c5~46@) (Mul b5~44@ a5~42@)) a5~42@)) (Mul (Mul (Mul (Mul a5~42@ a5~42@) (Add d5~48@ d5~48@)) (Mul (Mul a5~42@ a5~42@) (Mul c5~46@ d5~48@))) (Mul d5~48@ (Mul (Mul a5~42@ d5~48@) (Sub d5~48@ c5~46@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2583@ temp_5_1~2812@))) (=> (= temp_5_0~2583@ temp_5_1~2812@) (=> (= temp_6_0~2925@ (Mul b6~52@ (Mul (Add (Mul (Add (Mul b6~52@ a6~50@) d6~56@) (Sub (Mul c6~54@ d6~56@) (Mul b6~52@ c6~54@))) (Mul (Mul (Mul a6~50@ c6~54@) d6~56@) (Mul d6~56@ (Mul a6~50@ d6~56@)))) (Mul b6~52@ (Add (Add b6~52@ (Sub a6~50@ b6~52@)) (Mul (Mul b6~52@ a6~50@) (Mul c6~54@ a6~50@))))))) (=> (= temp_6_1~3014@ (Mul b6~52@ (Mul (Add (Mul (Add (Mul b6~52@ a6~50@) d6~56@) (Sub (Mul c6~54@ d6~56@) (Mul b6~52@ c6~54@))) (Mul (Mul (Mul a6~50@ c6~54@) d6~56@) (Mul d6~56@ (Mul a6~50@ d6~56@)))) (Mul b6~52@ (Add (Add b6~52@ (Sub a6~50@ b6~52@)) (Mul (Mul b6~52@ a6~50@) (Mul a6~50@ c6~54@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~2925@ temp_6_1~3014@))) (=> (= temp_6_0~2925@ temp_6_1~3014@) (=> (= temp_7_0~3271@ (Sub (Mul (Mul (Mul a7~58@ (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@))) (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ b7~60@) c7~62@))) (Mul (Sub (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Sub d7~64@ d7~64@))) (Sub (Add (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ a7~58@))))) (Mul (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@)) (Sub (Add d7~64@ a7~58@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ d7~64@) a7~58@))) (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@)) (Add d7~64@ (Mul b7~60@ d7~64@))) (Mul (Mul (Sub c7~62@ b7~60@) (Mul c7~62@ b7~60@)) (Sub (Mul d7~64@ d7~64@) (Sub d7~64@ c7~62@))))))) (=> (= temp_7_1~3504@ (Sub (Mul (Mul (Mul (Sub (Mul c7~62@ c7~62@) (Mul a7~58@ d7~64@)) a7~58@) (Mul (Mul (Mul b7~60@ d7~64@) (Mul c7~62@ c7~62@)) (Mul (Mul c7~62@ b7~60@) c7~62@))) (Mul (Sub (Mul (Mul c7~62@ b7~60@) (Mul b7~60@ b7~60@)) (Mul (Mul c7~62@ a7~58@) (Sub d7~64@ d7~64@))) (Sub (Add (Mul c7~62@ a7~58@) (Mul b7~60@ a7~58@)) (Mul (Mul d7~64@ a7~58@) (Mul d7~64@ a7~58@))))) (Mul (Mul (Mul (Mul (Mul d7~64@ c7~62@) (Mul d7~64@ a7~58@)) (Sub (Add d7~64@ a7~58@) (Mul d7~64@ d7~64@))) (Mul (Mul (Mul a7~58@ a7~58@) (Mul c7~62@ b7~60@)) (Mul (Mul d7~64@ d7~64@) a7~58@))) (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Mul c7~62@ b7~60@)) (Add d7~64@ (Mul b7~60@ d7~64@))) (Mul (Mul (Sub c7~62@ b7~60@) (Mul c7~62@ b7~60@)) (Sub (Mul d7~64@ d7~64@) (Sub d7~64@ c7~62@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3271@ temp_7_1~3504@))) (=> (= temp_7_0~3271@ temp_7_1~3504@) (=> (= temp_8_0~3789@ (Mul (Mul (Mul (Add (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ a8~66@)) (Sub (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@)))) (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@)) (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ d8~72@))) (Mul (Mul a8~66@ (Mul c8~70@ a8~66@)) (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ d8~72@))))) (Add (Add (Mul (Add (Add b8~68@ d8~72@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Sub c8~70@ 6))) (Add (Add (Mul c8~70@ d8~72@) (Sub c8~70@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ d8~72@)))) (Add (Add (Sub (Mul d8~72@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ a8~66@) d8~72@)) (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@)) (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ d8~72@))))))) (=> (= temp_8_1~4050@ (Mul (Mul (Mul (Add (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ c8~70@)) (Mul (Mul a8~66@ a8~66@) (Mul c8~70@ d8~72@))) (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ a8~66@)) (Sub (Mul b8~68@ a8~66@) (Mul a8~66@ b8~68@)))) (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ c8~70@)) (Mul (Mul d8~72@ b8~68@) (Mul b8~68@ d8~72@))) (Mul (Mul a8~66@ (Mul c8~70@ a8~66@)) (Mul (Mul b8~68@ d8~72@) (Mul a8~66@ d8~72@))))) (Add (Add (Mul (Add (Add b8~68@ d8~72@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ d8~72@) (Sub c8~70@ 6))) (Add (Add (Mul c8~70@ d8~72@) (Sub c8~70@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ d8~72@)))) (Add (Add (Sub (Mul d8~72@ d8~72@) (Mul d8~72@ b8~68@)) (Mul (Mul c8~70@ a8~66@) d8~72@)) (Mul (Mul (Mul a8~66@ b8~68@) (Mul c8~70@ a8~66@)) (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ d8~72@))))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~3789@ temp_8_1~4050@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
