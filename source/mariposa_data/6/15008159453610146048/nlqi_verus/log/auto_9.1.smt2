...
(declare-const temp_1_0~835@ Int)
(declare-const temp_1_1~1084@ Int)
(declare-const temp_2_0~1277@ Int)
(declare-const temp_2_1~1446@ Int)
(declare-const temp_3_0~1655@ Int)
(declare-const temp_3_1~1840@ Int)
(declare-const temp_4_0~2081@ Int)
(declare-const temp_4_1~2298@ Int)
(declare-const temp_5_0~2503@ Int)
(declare-const temp_5_1~2684@ Int)
(declare-const temp_6_0~2921@ Int)
(declare-const temp_6_1~3142@ Int)
(declare-const temp_7_0~3335@ Int)
(declare-const temp_7_1~3504@ Int)
(declare-const temp_8_0~3745@ Int)
(declare-const temp_8_1~3962@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~321@ (Mul (Mul (Mul (Mul (Mul (Mul b0~4@ 76) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Sub a0~2@ b0~4@))) a0~2@) (Mul (Sub (Add (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Sub 96 b0~4@))) (Mul (Sub (Mul c0~6@ d0~8@) c0~6@) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ b0~4@))))) (Mul (Sub (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ b0~4@) b0~4@)) (Mul 59 (Sub (Mul a0~2@ b0~4@) a0~2@))) (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Sub d0~8@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))) (Add (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@))))))) (=> (= temp_0_1~562@ (Mul (Mul (Sub (Mul (Mul (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ b0~4@) b0~4@)) (Mul 59 (Sub (Mul a0~2@ b0~4@) a0~2@))) (Mul (Mul (Mul (Mul c0~6@ b0~4@) (Sub d0~8@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul b0~4@ d0~8@))) (Add (Mul (Mul d0~8@ b0~4@) (Mul d0~8@ b0~4@)) (Mul (Mul b0~4@ c0~6@) (Mul a0~2@ b0~4@))))) (Mul (Mul (Mul (Mul (Mul b0~4@ 76) (Mul b0~4@ b0~4@)) (Mul (Mul c0~6@ d0~8@) (Sub a0~2@ b0~4@))) a0~2@) (Mul (Sub (Add (Mul a0~2@ b0~4@) (Mul c0~6@ b0~4@)) (Mul (Mul b0~4@ a0~2@) (Sub 96 b0~4@))) (Mul (Sub (Mul c0~6@ d0~8@) c0~6@) (Mul (Mul b0~4@ b0~4@) (Mul d0~8@ b0~4@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~321@ temp_0_1~562@))) (=> (= temp_0_0~321@ temp_0_1~562@) (=> (= temp_1_0~835@ (Add (Mul (Mul (Mul (Mul (Add a1~10@ c1~14@) (Mul b1~12@ b1~12@)) (Mul (Mul b1~12@ d1~16@) a1~10@)) (Mul (Mul (Mul c1~14@ 92) (Mul c1~14@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Add d1~16@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Add d1~16@ d1~16@) (Mul b1~12@ d1~16@))))) (Add (Mul (Sub (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@))) (Mul (Sub (Sub b1~12@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Add a1~10@ c1~14@) (Mul b1~12@ b1~12@)))) (Mul (Mul (Mul c1~14@ (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ d1~16@))) (Mul (Mul (Sub b1~12@ b1~12@) (Mul d1~16@ b1~12@)) d1~16@))))) (=> (= temp_1_1~1084@ (Add (Mul (Mul (Mul (Mul (Mul b1~12@ b1~12@) (Add a1~10@ c1~14@)) (Mul (Mul b1~12@ d1~16@) a1~10@)) (Mul (Mul (Mul c1~14@ 92) (Mul c1~14@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Mul c1~14@ d1~16@)))) (Mul (Mul (Mul (Mul a1~10@ a1~10@) (Add d1~16@ b1~12@)) (Mul (Mul c1~14@ d1~16@) (Mul d1~16@ c1~14@))) (Mul (Mul (Mul d1~16@ b1~12@) (Mul a1~10@ a1~10@)) (Mul (Add d1~16@ d1~16@) (Mul b1~12@ d1~16@))))) (Add (Mul (Sub (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ a1~10@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ c1~14@))) (Mul (Sub (Sub b1~12@ d1~16@) (Mul c1~14@ c1~14@)) (Mul (Add a1~10@ c1~14@) (Mul b1~12@ b1~12@)))) (Mul (Mul (Mul c1~14@ (Mul d1~16@ b1~12@)) (Mul (Mul b1~12@ c1~14@) (Mul a1~10@ d1~16@))) (Mul (Mul (Sub b1~12@ b1~12@) (Mul d1~16@ b1~12@)) d1~16@))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~835@ temp_1_1~1084@))) (=> (= temp_1_0~835@ temp_1_1~1084@) (=> (= temp_2_0~1277@ (Mul (Mul (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Mul a2~18@ (Mul a2~18@ a2~18@)) (Sub (Mul c2~22@ a2~18@) (Mul c2~22@ d2~24@)))) b2~20@) (Mul (Mul (Mul (Add (Mul d2~24@ a2~18@) (Mul c2~22@ d2~24@)) (Mul a2~18@ (Mul d2~24@ a2~18@))) (Add d2~24@ (Mul (Mul d2~24@ b2~20@) (Sub d2~24@ d2~24@)))) (Mul (Mul (Mul d2~24@ (Sub a2~18@ d2~24@)) (Add (Mul a2~18@ b2~20@) c2~22@)) (Mul (Mul (Mul a2~18@ a2~18@) (Sub b2~20@ b2~20@)) (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ c2~22@))))))) (=> (= temp_2_1~1446@ (Mul (Mul (Mul (Mul (Mul (Mul b2~20@ a2~18@) (Mul a2~18@ c2~22@)) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ d2~24@))) (Mul (Mul a2~18@ (Mul a2~18@ a2~18@)) (Sub (Mul c2~22@ a2~18@) (Mul c2~22@ d2~24@)))) b2~20@) (Mul (Mul (Add (Mul d2~24@ a2~18@) (Mul c2~22@ d2~24@)) (Mul (Mul a2~18@ (Mul d2~24@ a2~18@)) (Add d2~24@ (Mul (Mul d2~24@ b2~20@) (Sub d2~24@ d2~24@))))) (Mul (Mul (Mul d2~24@ (Sub a2~18@ d2~24@)) (Add (Mul a2~18@ b2~20@) c2~22@)) (Mul (Mul (Mul a2~18@ a2~18@) (Sub b2~20@ b2~20@)) (Mul (Mul b2~20@ d2~24@) (Mul b2~20@ c2~22@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1277@ temp_2_1~1446@))) (=> (= temp_2_0~1277@ temp_2_1~1446@) (=> (= temp_3_0~1655@ (Add (Mul (Mul (Mul a3~26@ (Mul a3~26@ (Mul b3~28@ a3~26@))) (Mul 38 (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ c3~30@)))) (Mul (Sub (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@)) b3~28@) (Mul b3~28@ (Mul (Sub a3~26@ c3~30@) (Mul a3~26@ d3~32@))))) (Mul (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Mul b3~28@ a3~26@) a3~26@)) (Mul (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@)) (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@)))) (Mul (Add (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ d3~32@)) (Add (Mul c3~30@ d3~32@) (Add c3~30@ a3~26@))) b3~28@)))) (=> (= temp_3_1~1840@ (Add (Mul (Mul (Mul a3~26@ (Mul a3~26@ (Mul b3~28@ a3~26@))) (Mul 38 (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ c3~30@)))) (Mul (Sub (Mul (Mul d3~32@ b3~28@) (Mul a3~26@ b3~28@)) b3~28@) (Mul b3~28@ (Mul (Sub a3~26@ c3~30@) (Mul a3~26@ d3~32@))))) (Mul (Mul (Mul (Mul (Mul d3~32@ b3~28@) (Mul c3~30@ a3~26@)) (Mul (Mul b3~28@ a3~26@) a3~26@)) (Mul (Mul (Mul c3~30@ a3~26@) (Mul c3~30@ c3~30@)) (Mul (Mul d3~32@ a3~26@) (Mul a3~26@ c3~30@)))) (Mul (Add (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ d3~32@)) (Add (Mul c3~30@ d3~32@) (Add c3~30@ a3~26@))) b3~28@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1655@ temp_3_1~1840@))) (=> (= temp_3_0~1655@ temp_3_1~1840@) (=> (= temp_4_0~2081@ (Mul (Mul (Mul (Mul d4~40@ (Mul b4~36@ (Mul a4~34@ d4~40@))) (Mul (Mul (Mul d4~40@ a4~34@) a4~34@) d4~40@)) (Mul (Mul (Sub (Mul a4~34@ c4~38@) (Mul d4~40@ d4~40@)) (Mul (Mul a4~34@ c4~38@) (Sub d4~40@ a4~34@))) (Mul (Mul (Add b4~36@ d4~40@) (Add c4~38@ b4~36@)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ d4~40@))))) (Mul (Sub (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul b4~36@ c4~38@))) (Sub (Mul b4~36@ (Mul c4~38@ d4~40@)) (Add (Mul a4~34@ a4~34@) (Mul b4~36@ b4~36@)))) (Mul (Mul (Sub b4~36@ (Mul b4~36@ b4~36@)) (Add (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ d4~40@))))))) (=> (= temp_4_1~2298@ (Mul (Mul (Mul (Mul d4~40@ (Mul b4~36@ (Mul a4~34@ d4~40@))) (Mul (Mul (Mul d4~40@ a4~34@) a4~34@) d4~40@)) (Mul (Mul (Sub (Mul a4~34@ c4~38@) (Mul d4~40@ d4~40@)) (Mul (Mul a4~34@ c4~38@) (Sub d4~40@ a4~34@))) (Mul (Mul (Add b4~36@ d4~40@) (Add c4~38@ b4~36@)) (Mul (Mul b4~36@ d4~40@) (Mul b4~36@ d4~40@))))) (Mul (Sub (Mul (Mul (Mul a4~34@ b4~36@) (Mul d4~40@ a4~34@)) (Mul (Mul b4~36@ b4~36@) (Mul c4~38@ b4~36@))) (Sub (Mul b4~36@ (Mul c4~38@ d4~40@)) (Add (Mul a4~34@ a4~34@) (Mul b4~36@ b4~36@)))) (Mul (Mul (Sub b4~36@ (Mul b4~36@ b4~36@)) (Add (Mul c4~38@ c4~38@) (Mul b4~36@ d4~40@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul d4~40@ c4~38@)) (Mul (Mul c4~38@ b4~36@) (Mul c4~38@ d4~40@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~2081@ temp_4_1~2298@))) (=> (= temp_4_0~2081@ temp_4_1~2298@) (=> (= temp_5_0~2503@ (Mul (Mul (Add (Mul (Sub c5~46@ b5~44@) (Sub (Mul a5~42@ b5~44@) d5~48@)) (Mul (Add (Sub d5~48@ b5~44@) b5~44@) (Mul (Mul 52 b5~44@) (Mul b5~44@ c5~46@)))) (Mul (Sub (Mul (Mul a5~42@ c5~46@) c5~46@) c5~46@) (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ c5~46@)) c5~46@))) (Mul (Mul b5~44@ (Sub b5~44@ (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)))) (Mul (Mul (Add d5~48@ (Add a5~42@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ c5~46@))) (Sub (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ d5~48@))))))) (=> (= temp_5_1~2684@ (Mul (Mul (Add (Mul (Sub c5~46@ b5~44@) (Sub (Mul a5~42@ b5~44@) d5~48@)) (Mul (Add (Sub d5~48@ b5~44@) b5~44@) (Mul (Mul 52 b5~44@) (Mul b5~44@ c5~46@)))) (Mul (Sub (Mul c5~46@ (Mul a5~42@ c5~46@)) c5~46@) (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ c5~46@)) c5~46@))) (Mul (Mul b5~44@ (Sub b5~44@ (Mul (Mul b5~44@ c5~46@) (Mul a5~42@ d5~48@)))) (Mul (Mul (Add d5~48@ (Add a5~42@ c5~46@)) (Mul (Mul a5~42@ b5~44@) (Mul b5~44@ c5~46@))) (Sub (Mul (Mul b5~44@ b5~44@) (Mul a5~42@ d5~48@)) (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ d5~48@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2503@ temp_5_1~2684@))) (=> (= temp_5_0~2503@ temp_5_1~2684@) (=> (= temp_6_0~2921@ (Mul (Mul (Add (Mul (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@)) b6~52@) (Add (Mul (Sub d6~56@ a6~50@) c6~54@) (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ 3)))) (Mul c6~54@ (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ d6~56@))))) (Sub (Add b6~52@ (Add (Mul d6~56@ (Mul a6~50@ b6~52@)) (Mul (Mul a6~50@ b6~52@) (Sub a6~50@ b6~52@)))) (Mul (Mul (Add (Sub d6~56@ d6~56@) (Add a6~50@ c6~54@)) (Mul d6~56@ (Mul b6~52@ a6~50@))) (Mul (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ a6~50@)) (Add (Mul 35 a6~50@) (Mul 26 c6~54@))))))) (=> (= temp_6_1~3142@ (Mul (Mul (Add (Mul (Mul (Mul b6~52@ d6~56@) (Mul c6~54@ d6~56@)) b6~52@) (Add (Mul (Sub d6~56@ a6~50@) c6~54@) (Mul (Mul c6~54@ a6~50@) (Mul a6~50@ 3)))) (Mul c6~54@ (Mul (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ b6~52@)) (Mul (Mul a6~50@ c6~54@) (Mul a6~50@ d6~56@))))) (Sub (Add b6~52@ (Add (Mul d6~56@ (Mul a6~50@ b6~52@)) (Sub (Mul (Mul a6~50@ b6~52@) a6~50@) (Mul (Mul a6~50@ b6~52@) b6~52@)))) (Mul (Mul (Add (Sub d6~56@ d6~56@) (Add a6~50@ c6~54@)) (Mul d6~56@ (Mul b6~52@ a6~50@))) (Mul (Mul (Mul b6~52@ d6~56@) (Mul a6~50@ a6~50@)) (Add (Mul 35 a6~50@) (Mul 26 c6~54@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~2921@ temp_6_1~3142@))) (=> (= temp_6_0~2921@ temp_6_1~3142@) (=> (= temp_7_0~3335@ (Mul (Add (Mul (Sub b7~60@ (Add (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@))) (Mul (Mul c7~62@ (Sub d7~64@ c7~62@)) (Sub (Sub c7~62@ d7~64@) (Mul 97 d7~64@)))) b7~60@) (Mul (Mul (Mul (Mul (Mul d7~64@ a7~58@) (Sub b7~60@ a7~58@)) (Sub (Mul c7~62@ c7~62@) (Add a7~58@ a7~58@))) (Mul a7~58@ (Mul (Add b7~60@ c7~62@) (Add d7~64@ d7~64@)))) (Mul (Mul (Mul (Mul a7~58@ c7~62@) a7~58@) (Mul c7~62@ (Mul b7~60@ d7~64@))) (Mul (Mul c7~62@ (Mul c7~62@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ d7~64@))))))) (=> (= temp_7_1~3504@ (Mul (Add (Mul (Sub b7~60@ (Add (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@))) (Mul (Mul c7~62@ (Sub d7~64@ c7~62@)) (Sub (Sub c7~62@ d7~64@) (Mul 97 d7~64@)))) b7~60@) (Mul (Mul (Mul a7~58@ (Mul (Add b7~60@ c7~62@) (Add d7~64@ d7~64@))) (Mul (Mul (Mul d7~64@ a7~58@) (Sub b7~60@ a7~58@)) (Sub (Mul c7~62@ c7~62@) (Add a7~58@ a7~58@)))) (Mul (Mul (Mul (Mul a7~58@ c7~62@) a7~58@) (Mul c7~62@ (Mul b7~60@ d7~64@))) (Mul (Mul c7~62@ (Mul c7~62@ c7~62@)) (Mul (Mul b7~60@ b7~60@) (Mul c7~62@ d7~64@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3335@ temp_7_1~3504@))) (=> (= temp_7_0~3335@ temp_7_1~3504@) (=> (= temp_8_0~3745@ (Mul (Add (Mul (Mul (Mul d8~72@ (Mul b8~68@ c8~70@)) d8~72@) (Mul (Mul (Mul d8~72@ d8~72@) b8~68@) (Add (Mul a8~66@ c8~70@) (Mul b8~68@ c8~70@)))) (Add (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ a8~66@))) (Mul (Add (Mul 13 a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ c8~70@))))) (Mul (Mul (Sub (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ c8~70@)) (Sub (Mul c8~70@ c8~70@) (Sub d8~72@ d8~72@))) (Mul (Sub (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@)) (Add (Mul a8~66@ d8~72@) (Add d8~72@ c8~70@)))) (Mul d8~72@ (Mul (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul d8~72@ a8~66@) d8~72@)))))) (=> (= temp_8_1~3962@ (Mul (Add (Mul (Mul (Mul d8~72@ (Mul b8~68@ c8~70@)) d8~72@) (Mul (Mul (Mul d8~72@ d8~72@) b8~68@) (Add (Mul a8~66@ c8~70@) (Mul b8~68@ c8~70@)))) (Add (Mul (Mul (Mul d8~72@ a8~66@) (Mul a8~66@ b8~68@)) (Mul (Mul b8~68@ a8~66@) (Mul d8~72@ a8~66@))) (Mul (Add (Mul 13 a8~66@) (Mul c8~70@ c8~70@)) (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ c8~70@))))) (Mul (Mul (Sub (Mul (Mul b8~68@ c8~70@) (Mul a8~66@ c8~70@)) (Sub (Mul c8~70@ c8~70@) (Sub d8~72@ d8~72@))) (Mul (Add (Mul a8~66@ d8~72@) (Add d8~72@ c8~70@)) (Sub (Mul b8~68@ a8~66@) (Mul b8~68@ b8~68@)))) (Mul d8~72@ (Mul (Mul (Mul a8~66@ d8~72@) (Mul b8~68@ c8~70@)) (Mul (Mul d8~72@ a8~66@) d8~72@)))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~3745@ temp_8_1~3962@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
