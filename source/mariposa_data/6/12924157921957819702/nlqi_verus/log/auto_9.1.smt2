...
(declare-const temp_1_0~803@ Int)
(declare-const temp_1_1~940@ Int)
(declare-const temp_2_0~1249@ Int)
(declare-const temp_2_1~1550@ Int)
(declare-const temp_3_0~1799@ Int)
(declare-const temp_3_1~2024@ Int)
(declare-const temp_4_0~2285@ Int)
(declare-const temp_4_1~2522@ Int)
(declare-const temp_5_0~2775@ Int)
(declare-const temp_5_1~3004@ Int)
(declare-const temp_6_0~3281@ Int)
(declare-const temp_6_1~3534@ Int)
(declare-const temp_7_0~3735@ Int)
(declare-const temp_7_1~3912@ Int)
(declare-const temp_8_0~4193@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~361@ (Mul (Sub (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Mul b0~4@ d0~8@)) (Add (Mul b0~4@ 68) (Add 54 a0~2@))) (Mul (Mul c0~6@ (Mul d0~8@ d0~8@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@)))) (Mul (Mul (Add (Mul b0~4@ c0~6@) (Add d0~8@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Add d0~8@ b0~4@))) (Sub (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Sub b0~4@ a0~2@) (Mul b0~4@ d0~8@))))) (Add (Mul (Add c0~6@ (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ d0~8@))) (Add (Add (Mul 83 b0~4@) c0~6@) (Add (Mul a0~2@ a0~2@) (Mul a0~2@ 57)))) (Add (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ a0~2@))) (Sub (Add (Mul c0~6@ c0~6@) (Mul a0~2@ c0~6@)) (Add c0~6@ (Sub a0~2@ c0~6@))))))) (=> (= temp_0_1~642@ (Mul (Sub (Mul (Mul (Mul (Mul b0~4@ d0~8@) (Mul d0~8@ b0~4@)) (Add (Mul b0~4@ 68) (Add 54 a0~2@))) (Mul (Mul c0~6@ (Mul d0~8@ d0~8@)) (Mul (Mul a0~2@ c0~6@) (Mul c0~6@ d0~8@)))) (Mul (Mul (Add (Mul b0~4@ c0~6@) (Add d0~8@ a0~2@)) (Mul (Mul b0~4@ c0~6@) (Add d0~8@ b0~4@))) (Sub (Mul (Mul c0~6@ d0~8@) (Mul b0~4@ b0~4@)) (Mul (Sub b0~4@ a0~2@) (Mul b0~4@ d0~8@))))) (Add (Mul (Add c0~6@ (Mul (Mul c0~6@ a0~2@) (Mul b0~4@ d0~8@))) (Add (Add (Mul 83 b0~4@) c0~6@) (Add (Mul a0~2@ a0~2@) (Mul a0~2@ 57)))) (Add (Mul (Mul (Mul d0~8@ a0~2@) (Mul c0~6@ b0~4@)) (Mul (Mul a0~2@ d0~8@) (Mul d0~8@ a0~2@))) (Sub (Add (Mul c0~6@ c0~6@) (Mul a0~2@ c0~6@)) (Add c0~6@ (Sub a0~2@ c0~6@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~361@ temp_0_1~642@))) (=> (= temp_0_0~361@ temp_0_1~642@) (=> (= temp_1_0~803@ (Mul (Mul (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@)) (Mul a1~10@ (Mul b1~12@ a1~10@))) (Mul b1~12@ (Add (Sub c1~14@ c1~14@) (Sub b1~12@ a1~10@)))) (Sub (Mul (Mul (Add a1~10@ c1~14@) (Mul c1~14@ c1~14@)) b1~12@) d1~16@)) (Add b1~12@ (Sub (Mul (Sub a1~10@ (Mul d1~16@ d1~16@)) (Sub (Mul d1~16@ b1~12@) (Sub b1~12@ c1~14@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Add b1~12@ c1~14@))))))) (=> (= temp_1_1~940@ (Mul (Mul (Mul (Mul (Mul (Mul c1~14@ b1~12@) (Mul c1~14@ c1~14@)) (Mul a1~10@ (Mul b1~12@ a1~10@))) (Mul b1~12@ (Add (Sub c1~14@ c1~14@) (Sub b1~12@ a1~10@)))) (Sub (Mul (Mul (Add a1~10@ c1~14@) (Mul c1~14@ c1~14@)) b1~12@) d1~16@)) (Add b1~12@ (Sub (Mul (Sub (Mul d1~16@ b1~12@) (Sub b1~12@ c1~14@)) (Sub a1~10@ (Mul d1~16@ d1~16@))) (Mul (Mul (Mul d1~16@ d1~16@) (Mul d1~16@ b1~12@)) (Mul (Mul d1~16@ d1~16@) (Add b1~12@ c1~14@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~803@ temp_1_1~940@))) (=> (= temp_1_0~803@ temp_1_1~940@) (=> (= temp_2_0~1249@ (Add (Mul (Mul (Mul (Add (Sub b2~20@ a2~18@) (Sub b2~20@ c2~22@)) (Add (Mul c2~22@ d2~24@) (Sub b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ a2~18@) (Sub b2~20@ 95)) (Mul (Add a2~18@ a2~18@) (Mul d2~24@ b2~20@)))) (Mul (Mul (Mul (Add b2~20@ a2~18@) (Mul d2~24@ c2~22@)) (Mul (Mul 54 a2~18@) (Mul a2~18@ a2~18@))) (Mul (Sub (Mul b2~20@ b2~20@) (Mul b2~20@ c2~22@)) (Mul (Mul d2~24@ b2~20@) a2~18@)))) (Sub (Mul (Mul (Sub (Mul c2~22@ b2~20@) (Sub d2~24@ a2~18@)) (Mul (Mul a2~18@ a2~18@) (Add d2~24@ a2~18@))) (Mul (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ c2~22@)) (Sub (Mul 69 c2~22@) (Mul a2~18@ d2~24@)))) (Mul (Mul (Mul (Mul d2~24@ d2~24@) b2~20@) (Mul (Sub b2~20@ a2~18@) (Mul b2~20@ b2~20@))) (Mul (Add (Mul b2~20@ d2~24@) (Mul b2~20@ b2~20@)) (Add (Mul a2~18@ c2~22@) (Mul c2~22@ b2~20@))))))) (=> (= temp_2_1~1550@ (Add (Mul (Mul (Mul (Add (Sub b2~20@ a2~18@) (Sub b2~20@ c2~22@)) (Add (Mul c2~22@ d2~24@) (Sub b2~20@ c2~22@))) (Mul (Mul (Mul d2~24@ a2~18@) (Sub b2~20@ 95)) (Mul (Add a2~18@ a2~18@) (Mul d2~24@ b2~20@)))) (Mul (Mul (Mul (Add b2~20@ a2~18@) (Mul d2~24@ c2~22@)) (Mul (Mul 54 a2~18@) (Mul a2~18@ a2~18@))) (Mul (Sub (Mul b2~20@ b2~20@) (Mul b2~20@ c2~22@)) (Mul (Mul d2~24@ b2~20@) a2~18@)))) (Sub (Mul (Mul (Sub (Mul c2~22@ b2~20@) (Sub d2~24@ a2~18@)) (Mul (Mul a2~18@ a2~18@) (Add d2~24@ a2~18@))) (Mul (Mul (Mul c2~22@ c2~22@) (Mul d2~24@ c2~22@)) (Sub (Mul 69 c2~22@) (Mul a2~18@ d2~24@)))) (Mul (Mul (Mul (Mul d2~24@ d2~24@) b2~20@) (Mul (Sub b2~20@ a2~18@) (Mul b2~20@ b2~20@))) (Add (Mul (Mul b2~20@ d2~24@) (Add (Mul a2~18@ c2~22@) (Mul c2~22@ b2~20@))) (Mul (Mul b2~20@ b2~20@) (Add (Mul a2~18@ c2~22@) (Mul c2~22@ b2~20@)))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1249@ temp_2_1~1550@))) (=> (= temp_2_0~1249@ temp_2_1~1550@) (=> (= temp_3_0~1799@ (Mul (Mul (Mul (Mul a3~26@ (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@)))) (Mul (Sub (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Sub c3~30@ d3~32@))) (Mul (Mul (Mul a3~26@ a3~26@) (Add a3~26@ d3~32@)) (Add (Mul a3~26@ d3~32@) (Add d3~32@ c3~30@))))) (Mul (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Sub a3~26@ a3~26@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))) d3~32@) (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Sub a3~26@ a3~26@)) (Mul (Add a3~26@ b3~28@) b3~28@)) (Mul (Mul (Mul d3~32@ 44) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@))))))) (=> (= temp_3_1~2024@ (Mul (Mul (Mul (Mul a3~26@ (Mul (Mul d3~32@ c3~30@) (Mul b3~28@ d3~32@))) (Mul (Mul (Mul a3~26@ c3~30@) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ c3~30@) (Mul a3~26@ c3~30@)))) (Mul (Sub (Mul (Mul c3~30@ d3~32@) (Mul c3~30@ c3~30@)) (Mul (Mul c3~30@ d3~32@) (Sub c3~30@ d3~32@))) (Mul (Mul (Mul a3~26@ a3~26@) (Add a3~26@ d3~32@)) (Add (Mul a3~26@ d3~32@) (Add d3~32@ c3~30@))))) (Mul (Mul (Mul (Mul (Mul d3~32@ d3~32@) (Sub a3~26@ a3~26@)) (Mul (Add a3~26@ b3~28@) b3~28@)) (Mul (Mul (Mul d3~32@ 44) (Mul b3~28@ d3~32@)) (Mul (Mul d3~32@ b3~28@) (Mul b3~28@ a3~26@)))) (Mul (Mul (Mul (Mul b3~28@ a3~26@) (Sub a3~26@ a3~26@)) (Mul (Mul a3~26@ d3~32@) (Mul b3~28@ a3~26@))) d3~32@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1799@ temp_3_1~2024@))) (=> (= temp_3_0~1799@ temp_3_1~2024@) (=> (= temp_4_0~2285@ (Mul (Add (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ b4~36@) (Add 99 b4~36@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ c4~38@)) (Mul (Mul 97 b4~36@) (Mul a4~34@ a4~34@)))) (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ a4~34@)) (Mul d4~40@ (Mul a4~34@ b4~36@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@))))) (Mul (Mul (Mul (Add (Mul b4~36@ c4~38@) (Mul a4~34@ a4~34@)) a4~34@) (Add (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)) c4~38@)) (Mul (Sub (Mul (Mul 56 c4~38@) (Mul d4~40@ d4~40@)) (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@))) b4~36@)))) (=> (= temp_4_1~2522@ (Mul (Add (Mul (Mul (Mul (Mul b4~36@ c4~38@) (Mul b4~36@ c4~38@)) (Mul (Mul c4~38@ b4~36@) (Add 99 b4~36@))) (Mul (Mul (Mul a4~34@ d4~40@) (Mul a4~34@ c4~38@)) (Mul (Mul (Mul 97 b4~36@) a4~34@) a4~34@))) (Mul (Mul (Mul (Mul c4~38@ c4~38@) (Mul a4~34@ a4~34@)) (Mul d4~40@ (Mul a4~34@ b4~36@))) (Mul (Mul (Mul b4~36@ a4~34@) (Mul d4~40@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ b4~36@))))) (Mul (Mul (Mul (Add (Mul b4~36@ c4~38@) (Mul a4~34@ a4~34@)) a4~34@) (Add (Mul (Mul d4~40@ d4~40@) (Mul c4~38@ c4~38@)) c4~38@)) (Mul (Sub (Mul (Mul 56 c4~38@) (Mul d4~40@ d4~40@)) (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ b4~36@))) b4~36@)))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~2285@ temp_4_1~2522@))) (=> (= temp_4_0~2285@ temp_4_1~2522@) (=> (= temp_5_0~2775@ (Mul (Add (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Add d5~48@ c5~46@)) d5~48@) (Add (Mul (Mul c5~46@ c5~46@) (Add a5~42@ 86)) (Mul (Add a5~42@ c5~46@) (Mul c5~46@ a5~42@)))) (Mul (Mul d5~48@ c5~46@) (Add (Mul (Add b5~44@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Add c5~46@ a5~42@))))) (Mul (Mul (Mul c5~46@ (Mul (Mul b5~44@ d5~48@) (Mul d5~48@ d5~48@))) (Sub (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@)) (Add (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@)))) (Add (Mul (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Add (Mul c5~46@ c5~46@) c5~46@)) (Mul (Mul (Add c5~46@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul 67 a5~42@) (Mul b5~44@ c5~46@))))))) (=> (= temp_5_1~3004@ (Mul (Add (Mul (Mul (Mul (Mul d5~48@ c5~46@) (Add d5~48@ c5~46@)) d5~48@) (Add (Mul (Mul c5~46@ c5~46@) (Add a5~42@ 86)) (Mul (Add a5~42@ c5~46@) (Mul c5~46@ a5~42@)))) (Mul (Mul d5~48@ c5~46@) (Add (Mul (Add b5~44@ a5~42@) (Mul b5~44@ d5~48@)) (Mul (Mul a5~42@ c5~46@) (Add c5~46@ a5~42@))))) (Mul (Mul (Mul c5~46@ (Mul (Mul d5~48@ b5~44@) (Mul d5~48@ d5~48@))) (Sub (Mul (Mul d5~48@ d5~48@) (Mul c5~46@ c5~46@)) (Add (Mul d5~48@ c5~46@) (Mul d5~48@ d5~48@)))) (Add (Mul (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ c5~46@)) (Add (Mul c5~46@ c5~46@) c5~46@)) (Mul (Mul (Add c5~46@ b5~44@) (Mul a5~42@ b5~44@)) (Mul (Mul 67 a5~42@) (Mul b5~44@ c5~46@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2775@ temp_5_1~3004@))) (=> (= temp_5_0~2775@ temp_5_1~3004@) (=> (= temp_6_0~3281@ (Mul (Mul (Mul (Mul (Mul (Add c6~54@ c6~54@) (Mul b6~52@ d6~56@)) (Mul (Mul b6~52@ c6~54@) (Mul b6~52@ c6~54@))) (Add (Mul (Mul c6~54@ a6~50@) (Add c6~54@ b6~52@)) (Mul b6~52@ b6~52@))) (Add (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ d6~56@))) (Sub (Sub (Mul b6~52@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@ d6~56@) (Mul c6~54@ c6~54@))))) (Mul (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Add b6~52@ d6~56@))) (Mul (Add c6~54@ (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ 42)))) (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ d6~56@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ d6~56@)) (Mul c6~54@ (Add c6~54@ b6~52@))))))) (=> (= temp_6_1~3534@ (Mul (Mul (Mul (Mul (Mul (Add c6~54@ c6~54@) (Mul b6~52@ d6~56@)) (Mul (Mul b6~52@ c6~54@) (Mul b6~52@ c6~54@))) (Add (Mul (Mul c6~54@ a6~50@) (Add c6~54@ b6~52@)) (Mul b6~52@ b6~52@))) (Add (Mul (Mul (Mul b6~52@ a6~50@) (Mul d6~56@ c6~54@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ d6~56@))) (Sub (Sub (Mul b6~52@ b6~52@) (Mul c6~54@ a6~50@)) (Mul (Mul c6~54@ c6~54@) (Mul c6~54@ d6~56@))))) (Mul (Mul (Mul (Mul (Mul b6~52@ d6~56@) (Mul d6~56@ c6~54@)) (Mul (Mul a6~50@ d6~56@) (Add b6~52@ d6~56@))) (Mul (Add c6~54@ (Mul c6~54@ a6~50@)) (Mul (Mul d6~56@ a6~50@) (Mul b6~52@ 42)))) (Mul (Mul (Mul (Mul a6~50@ b6~52@) (Mul d6~56@ d6~56@)) (Mul (Mul d6~56@ b6~52@) (Mul b6~52@ d6~56@))) (Mul (Mul (Mul d6~56@ b6~52@) (Mul c6~54@ d6~56@)) (Mul c6~54@ (Add c6~54@ b6~52@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~3281@ temp_6_1~3534@))) (=> (= temp_6_0~3281@ temp_6_1~3534@) (=> (= temp_7_0~3735@ (Mul (Add (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Add a7~58@ a7~58@) (Mul c7~62@ b7~60@))) (Mul (Mul (Add b7~60@ a7~58@) (Mul a7~58@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ c7~62@)))) (Add (Mul (Mul (Mul c7~62@ a7~58@) (Sub b7~60@ d7~64@)) (Add (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)) (Sub (Sub c7~62@ a7~58@) (Mul a7~58@ c7~62@))))) (Mul (Mul (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ c7~62@)) (Mul d7~64@ (Mul c7~62@ a7~58@))) (Add b7~60@ (Mul c7~62@ (Mul c7~62@ d7~64@)))) c7~62@))) (=> (= temp_7_1~3912@ (Mul (Add (Mul (Mul (Mul (Mul a7~58@ a7~58@) (Mul b7~60@ c7~62@)) (Mul (Add a7~58@ a7~58@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul a7~58@ a7~58@) (Add b7~60@ a7~58@)) (Mul (Mul c7~62@ d7~64@) (Mul b7~60@ c7~62@)))) (Add (Mul (Mul (Mul c7~62@ a7~58@) (Sub b7~60@ d7~64@)) (Add (Mul d7~64@ b7~60@) (Mul b7~60@ d7~64@))) (Mul (Mul (Mul a7~58@ d7~64@) (Mul a7~58@ c7~62@)) (Sub (Sub c7~62@ a7~58@) (Mul a7~58@ c7~62@))))) (Mul (Mul (Mul (Mul (Add c7~62@ d7~64@) (Mul d7~64@ c7~62@)) (Mul d7~64@ (Mul c7~62@ a7~58@))) (Add b7~60@ (Mul c7~62@ (Mul c7~62@ d7~64@)))) c7~62@))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3735@ temp_7_1~3912@))) (=> (= temp_7_0~3735@ temp_7_1~3912@) (=> (= temp_8_0~4193@ (Mul (Mul (Mul (Mul (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul d8~72@ a8~66@) (Sub b8~68@ c8~70@)) (Mul (Add b8~68@ c8~70@) (Mul b8~68@ d8~72@)))) (Mul (Mul (Sub (Mul a8~66@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ a8~66@) (Mul 34 c8~70@))) (Mul (Mul (Mul a8~66@ b8~68@) b8~68@) (Mul (Sub c8~70@ c8~70@) (Mul a8~66@ c8~70@))))) (Mul (Mul (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ d8~72@)) (Mul (Mul c8~70@ c8~70@) d8~72@)) (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ c8~70@)))) (Mul (Sub (Add (Mul b8~68@ d8~72@) c8~70@) (Sub (Mul d8~72@ c8~70@) (Mul d8~72@ c8~70@))) (Sub (Mul (Mul a8~66@ a8~66@) (Sub b8~68@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ a8~66@))))))) (=> (= temp_8_1~4450@ (Mul (Mul (Mul (Mul (Mul (Mul b8~68@ b8~68@) (Mul d8~72@ c8~70@)) (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ a8~66@))) (Mul (Mul (Mul d8~72@ a8~66@) (Sub b8~68@ c8~70@)) (Mul (Add b8~68@ c8~70@) (Mul b8~68@ d8~72@)))) (Mul (Mul (Sub (Mul a8~66@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul a8~66@ a8~66@) (Mul 34 c8~70@))) (Mul (Mul (Mul a8~66@ b8~68@) b8~68@) (Mul (Sub c8~70@ c8~70@) (Mul a8~66@ c8~70@))))) (Mul (Mul (Mul (Mul (Mul d8~72@ b8~68@) (Mul c8~70@ d8~72@)) (Mul (Mul c8~70@ c8~70@) d8~72@)) (Mul (Mul (Mul b8~68@ d8~72@) (Mul c8~70@ b8~68@)) (Mul (Mul b8~68@ c8~70@) (Mul d8~72@ c8~70@)))) (Mul (Sub (Add (Mul b8~68@ d8~72@) c8~70@) (Sub (Mul d8~72@ c8~70@) (Mul d8~72@ c8~70@))) (Sub (Mul (Mul a8~66@ a8~66@) (Sub b8~68@ a8~66@)) (Mul (Mul c8~70@ a8~66@) (Mul c8~70@ a8~66@))))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~4193@ temp_8_1~4450@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
