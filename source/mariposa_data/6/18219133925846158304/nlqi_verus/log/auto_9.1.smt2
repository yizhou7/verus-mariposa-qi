...
(declare-const temp_1_0~807@ Int)
(declare-const temp_1_1~1068@ Int)
(declare-const temp_2_0~1341@ Int)
(declare-const temp_2_1~1590@ Int)
(declare-const temp_3_0~1823@ Int)
(declare-const temp_3_1~2032@ Int)
(declare-const temp_4_0~2309@ Int)
(declare-const temp_4_1~2562@ Int)
(declare-const temp_5_0~2751@ Int)
(declare-const temp_5_1~2916@ Int)
(declare-const temp_6_0~3129@ Int)
(declare-const temp_6_1~3422@ Int)
(declare-const temp_7_0~3667@ Int)
(declare-const temp_7_1~3888@ Int)
(declare-const temp_8_0~4081@ Int)
...
(assert (=> %%query%% (not (=> (= temp_0_0~301@ (Mul (Mul (Mul (Mul (Sub (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@)) (Add (Sub c0~6@ d0~8@) (Mul a0~2@ b0~4@))) (Mul (Mul (Sub a0~2@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul d0~8@ b0~4@) (Mul c0~6@ b0~4@)))) (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ c0~6@)) (Sub (Mul d0~8@ a0~2@) (Mul d0~8@ b0~4@))) (Mul (Mul (Mul a0~2@ c0~6@) d0~8@) b0~4@))) (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Mul (Mul b0~4@ b0~4@) (Add c0~6@ b0~4@))) (Sub (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ b0~4@)) (Add (Mul b0~4@ a0~2@) (Mul a0~2@ b0~4@)))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul (Sub b0~4@ d0~8@) c0~6@)) (Mul (Mul (Mul d0~8@ b0~4@) (Sub a0~2@ a0~2@)) (Mul (Sub b0~4@ d0~8@) (Add a0~2@ b0~4@))))))) (=> (= temp_0_1~522@ (Mul (Mul (Mul (Mul (Sub (Mul a0~2@ d0~8@) (Mul a0~2@ d0~8@)) (Add (Sub c0~6@ d0~8@) (Mul a0~2@ b0~4@))) (Mul (Mul (Sub a0~2@ d0~8@) (Mul a0~2@ b0~4@)) (Mul (Mul c0~6@ b0~4@) (Mul d0~8@ b0~4@)))) (Mul (Mul (Mul (Mul d0~8@ a0~2@) (Mul d0~8@ c0~6@)) (Sub (Mul d0~8@ a0~2@) (Mul d0~8@ b0~4@))) (Mul (Mul (Mul a0~2@ c0~6@) d0~8@) b0~4@))) (Mul (Mul (Mul (Mul d0~8@ b0~4@) (Mul (Mul b0~4@ b0~4@) (Add c0~6@ b0~4@))) (Sub (Mul (Mul b0~4@ b0~4@) (Mul a0~2@ b0~4@)) (Add (Mul b0~4@ a0~2@) (Mul a0~2@ b0~4@)))) (Mul (Mul (Mul c0~6@ c0~6@) (Mul (Sub b0~4@ d0~8@) c0~6@)) (Mul (Mul (Mul d0~8@ b0~4@) (Sub a0~2@ a0~2@)) (Mul (Sub b0~4@ d0~8@) (Add a0~2@ b0~4@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%0 (= temp_0_0~301@ temp_0_1~522@))) (=> (= temp_0_0~301@ temp_0_1~522@) (=> (= temp_1_0~807@ (Mul (Mul (Mul (Mul (Mul (Mul a1~10@ a1~10@) a1~10@) (Add (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@))) (Mul (Mul (Add a1~10@ d1~16@) (Add d1~16@ c1~14@)) (Sub a1~10@ (Mul a1~10@ c1~14@)))) (Mul (Add (Add c1~14@ (Mul c1~14@ 41)) (Sub (Mul d1~16@ d1~16@) (Mul a1~10@ a1~10@))) (Mul (Mul (Sub c1~14@ d1~16@) (Mul d1~16@ c1~14@)) (Sub (Mul d1~16@ c1~14@) (Mul c1~14@ a1~10@))))) (Mul (Mul (Mul (Mul (Sub c1~14@ a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ b1~12@) (Add d1~16@ d1~16@)) (Add (Mul b1~12@ a1~10@) (Sub c1~14@ a1~10@)))) (Mul (Add (Mul (Sub b1~12@ 65) (Mul c1~14@ c1~14@)) (Mul (Add a1~10@ d1~16@) a1~10@)) (Mul (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@)) (Mul b1~12@ (Mul d1~16@ d1~16@))))))) (=> (= temp_1_1~1068@ (Mul (Mul (Mul (Mul (Mul (Mul a1~10@ a1~10@) a1~10@) (Add (Mul d1~16@ c1~14@) (Mul d1~16@ c1~14@))) (Mul (Mul (Add a1~10@ d1~16@) (Add d1~16@ c1~14@)) (Sub a1~10@ (Mul a1~10@ c1~14@)))) (Mul (Mul (Add (Add c1~14@ (Mul c1~14@ 41)) (Sub (Mul d1~16@ d1~16@) (Mul a1~10@ a1~10@))) (Mul (Sub c1~14@ d1~16@) (Mul d1~16@ c1~14@))) (Sub (Mul d1~16@ c1~14@) (Mul c1~14@ a1~10@)))) (Mul (Mul (Mul (Mul (Sub c1~14@ a1~10@) (Mul b1~12@ d1~16@)) (Mul (Mul b1~12@ c1~14@) (Mul b1~12@ d1~16@))) (Mul (Mul (Mul d1~16@ b1~12@) (Add d1~16@ d1~16@)) (Add (Mul b1~12@ a1~10@) (Sub c1~14@ a1~10@)))) (Mul (Add (Mul (Sub b1~12@ 65) (Mul c1~14@ c1~14@)) (Mul (Add a1~10@ d1~16@) a1~10@)) (Mul (Mul (Mul a1~10@ c1~14@) (Mul b1~12@ a1~10@)) (Mul b1~12@ (Mul d1~16@ d1~16@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%1 (= temp_1_0~807@ temp_1_1~1068@))) (=> (= temp_1_0~807@ temp_1_1~1068@) (=> (= temp_2_0~1341@ (Mul (Mul (Mul (Mul (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@)) (Mul (Add d2~24@ b2~20@) (Mul b2~20@ a2~18@))) (Mul (Add (Mul a2~18@ c2~22@) (Mul d2~24@ c2~22@)) (Sub (Sub c2~22@ a2~18@) a2~18@))) (Add (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul c2~22@ a2~18@) 78) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@))))) (Mul (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Add b2~20@ a2~18@) (Mul 92 d2~24@))) (Mul (Mul (Mul c2~22@ b2~20@) d2~24@) (Mul (Add c2~22@ a2~18@) (Add c2~22@ b2~20@)))) (Mul (Mul d2~24@ (Mul (Mul b2~20@ b2~20@) c2~22@)) (Mul (Sub (Mul d2~24@ b2~20@) b2~20@) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@))))))) (=> (= temp_2_1~1590@ (Mul (Mul (Add (Mul (Mul (Mul c2~22@ a2~18@) (Mul a2~18@ b2~20@)) (Mul (Mul b2~20@ a2~18@) (Mul d2~24@ d2~24@))) (Mul (Mul (Mul c2~22@ a2~18@) 78) (Mul (Mul c2~22@ b2~20@) (Mul a2~18@ c2~22@)))) (Mul (Mul (Sub (Mul b2~20@ d2~24@) (Mul b2~20@ a2~18@)) (Mul (Add d2~24@ b2~20@) (Mul b2~20@ a2~18@))) (Mul (Add (Mul a2~18@ c2~22@) (Mul d2~24@ c2~22@)) (Sub (Sub c2~22@ a2~18@) a2~18@)))) (Mul (Mul (Mul (Mul (Mul d2~24@ d2~24@) (Mul d2~24@ a2~18@)) (Mul (Add b2~20@ a2~18@) (Mul 92 d2~24@))) (Mul (Mul (Mul c2~22@ b2~20@) d2~24@) (Mul (Add c2~22@ a2~18@) (Add c2~22@ b2~20@)))) (Mul (Mul d2~24@ (Mul (Mul b2~20@ b2~20@) c2~22@)) (Mul (Sub (Mul d2~24@ b2~20@) b2~20@) (Mul (Mul b2~20@ d2~24@) (Mul c2~22@ a2~18@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%2 (= temp_2_0~1341@ temp_2_1~1590@))) (=> (= temp_2_0~1341@ temp_2_1~1590@) (=> (= temp_3_0~1823@ (Sub (Mul (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ b3~28@) (Add c3~30@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ 14)) (Mul (Mul a3~26@ a3~26@) (Sub a3~26@ d3~32@)))) b3~28@) (Mul (Add (Mul (Sub (Mul c3~30@ d3~32@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul a3~26@ a3~26@) c3~30@) (Mul (Sub c3~30@ c3~30@) (Mul c3~30@ c3~30@)))) (Mul (Mul (Mul 17 (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Sub b3~28@ b3~28@))) (Mul (Mul (Sub d3~32@ a3~26@) (Mul c3~30@ d3~32@)) (Mul (Mul c3~30@ c3~30@) c3~30@)))))) (=> (= temp_3_1~2032@ (Sub (Mul (Mul (Mul (Mul (Mul a3~26@ b3~28@) (Mul a3~26@ b3~28@)) (Mul (Mul c3~30@ b3~28@) (Add c3~30@ c3~30@))) (Mul (Mul (Mul b3~28@ d3~32@) (Mul a3~26@ 14)) (Mul (Mul a3~26@ a3~26@) (Sub a3~26@ d3~32@)))) b3~28@) (Mul (Add (Mul (Sub (Mul c3~30@ d3~32@) (Mul a3~26@ b3~28@)) (Mul (Mul b3~28@ b3~28@) (Mul b3~28@ a3~26@))) (Mul (Mul (Mul a3~26@ a3~26@) c3~30@) (Mul (Sub c3~30@ c3~30@) (Mul c3~30@ c3~30@)))) (Mul (Mul (Mul 17 (Mul a3~26@ b3~28@)) (Mul (Mul a3~26@ a3~26@) (Sub b3~28@ b3~28@))) (Mul (Mul (Sub d3~32@ a3~26@) (Mul c3~30@ d3~32@)) (Mul c3~30@ (Mul c3~30@ c3~30@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%3 (= temp_3_0~1823@ temp_3_1~2032@))) (=> (= temp_3_0~1823@ temp_3_1~2032@) (=> (= temp_4_0~2309@ (Mul (Add (Add (Sub (Mul (Mul c4~38@ a4~34@) (Mul 48 a4~34@)) (Mul (Mul d4~40@ a4~34@) b4~36@)) (Mul (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@)) (Sub (Mul b4~36@ d4~40@) (Mul c4~38@ 9)))) (Mul (Sub (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ b4~36@))) a4~34@)) (Mul (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Mul d4~40@ a4~34@)))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul (Add b4~36@ b4~36@) (Sub c4~38@ b4~36@))) (Mul (Mul (Add d4~40@ b4~36@) (Add d4~40@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul 89 b4~36@))))))) (=> (= temp_4_1~2562@ (Mul (Add (Add (Sub (Mul (Mul c4~38@ a4~34@) (Mul 48 a4~34@)) (Mul (Mul d4~40@ a4~34@) b4~36@)) (Mul (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ d4~40@)) (Sub (Mul b4~36@ d4~40@) (Mul c4~38@ 9)))) (Mul (Sub (Mul (Mul b4~36@ d4~40@) (Mul a4~34@ d4~40@)) (Mul (Mul d4~40@ a4~34@) (Mul b4~36@ b4~36@))) a4~34@)) (Mul (Mul (Mul (Mul (Mul d4~40@ b4~36@) (Mul a4~34@ b4~36@)) (Mul (Mul c4~38@ d4~40@) (Mul b4~36@ c4~38@))) (Mul (Mul (Mul a4~34@ a4~34@) (Mul c4~38@ c4~38@)) (Mul (Mul a4~34@ a4~34@) (Mul a4~34@ d4~40@)))) (Mul (Mul (Mul d4~40@ b4~36@) (Mul (Add b4~36@ b4~36@) (Sub c4~38@ b4~36@))) (Mul (Mul (Add d4~40@ b4~36@) (Add d4~40@ d4~40@)) (Mul (Mul c4~38@ c4~38@) (Mul 89 b4~36@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%4 (= temp_4_0~2309@ temp_4_1~2562@))) (=> (= temp_4_0~2309@ temp_4_1~2562@) (=> (= temp_5_0~2751@ (Mul (Mul a5~42@ (Mul (Mul (Mul (Mul b5~44@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Sub c5~46@ c5~46@) (Mul c5~46@ d5~48@))) (Mul (Add (Mul d5~48@ d5~48@) (Sub d5~48@ a5~42@)) (Mul (Sub d5~48@ a5~42@) (Add d5~48@ d5~48@))))) (Mul (Sub (Mul (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ d5~48@) (Mul b5~44@ c5~46@))) (Add (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ b5~44@)))) (Add c5~46@ (Mul (Mul (Mul b5~44@ b5~44@) a5~42@) (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@))))))) (=> (= temp_5_1~2916@ (Mul (Mul a5~42@ (Mul (Mul (Mul (Mul c5~46@ b5~44@) (Mul b5~44@ a5~42@)) (Mul (Sub c5~46@ c5~46@) (Mul c5~46@ d5~48@))) (Mul (Add (Mul d5~48@ d5~48@) (Sub d5~48@ a5~42@)) (Mul (Sub d5~48@ a5~42@) (Add d5~48@ d5~48@))))) (Mul (Sub (Mul (Mul (Mul c5~46@ a5~42@) (Mul d5~48@ d5~48@)) (Mul (Mul b5~44@ d5~48@) (Mul b5~44@ c5~46@))) (Add (Mul (Mul a5~42@ c5~46@) (Mul b5~44@ a5~42@)) (Mul (Mul a5~42@ b5~44@) (Mul a5~42@ b5~44@)))) (Add c5~46@ (Mul (Mul (Mul b5~44@ b5~44@) a5~42@) (Mul (Mul c5~46@ a5~42@) (Mul a5~42@ d5~48@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%5 (= temp_5_0~2751@ temp_5_1~2916@))) (=> (= temp_5_0~2751@ temp_5_1~2916@) (=> (= temp_6_0~3129@ (Mul (Add (Add (Mul (Mul (Mul b6~52@ d6~56@) b6~52@) (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ b6~52@))) (Mul (Add (Mul b6~52@ c6~54@) (Mul a6~50@ c6~54@)) b6~52@)) (Mul b6~52@ (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@)) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ d6~56@))))) (Mul (Mul (Add (Add (Add c6~54@ b6~52@) (Mul d6~56@ b6~52@)) (Sub (Mul b6~52@ d6~56@) d6~56@)) (Mul (Mul (Mul a6~50@ c6~54@) c6~54@) (Add (Add d6~56@ a6~50@) (Mul a6~50@ b6~52@)))) (Mul (Add (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ b6~52@)) c6~54@) (Mul (Mul (Mul a6~50@ b6~52@) d6~56@) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ a6~50@))))))) (=> (= temp_6_1~3422@ (Add (Mul (Add (Mul (Mul (Mul b6~52@ d6~56@) b6~52@) (Mul (Mul b6~52@ c6~54@) (Mul a6~50@ b6~52@))) (Mul (Add (Mul b6~52@ c6~54@) (Mul a6~50@ c6~54@)) b6~52@)) (Mul (Mul (Add (Add (Add c6~54@ b6~52@) (Mul d6~56@ b6~52@)) (Sub (Mul b6~52@ d6~56@) d6~56@)) (Mul (Mul (Mul a6~50@ c6~54@) c6~54@) (Add (Add d6~56@ a6~50@) (Mul a6~50@ b6~52@)))) (Mul (Add (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ b6~52@)) c6~54@) (Mul (Mul (Mul a6~50@ b6~52@) d6~56@) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ a6~50@)))))) (Mul (Mul b6~52@ (Mul (Mul (Mul a6~50@ b6~52@) (Mul b6~52@ b6~52@)) (Mul (Mul b6~52@ c6~54@) (Mul c6~54@ d6~56@)))) (Mul (Mul (Add (Add (Add c6~54@ b6~52@) (Mul d6~56@ b6~52@)) (Sub (Mul b6~52@ d6~56@) d6~56@)) (Mul (Mul (Mul a6~50@ c6~54@) c6~54@) (Add (Add d6~56@ a6~50@) (Mul a6~50@ b6~52@)))) (Mul (Add (Mul (Mul d6~56@ a6~50@) (Mul a6~50@ b6~52@)) c6~54@) (Mul (Mul (Mul a6~50@ b6~52@) d6~56@) (Mul (Mul d6~56@ d6~56@) (Mul a6~50@ a6~50@)))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%6 (= temp_6_0~3129@ temp_6_1~3422@))) (=> (= temp_6_0~3129@ temp_6_1~3422@) (=> (= temp_7_0~3667@ (Mul (Add (Mul (Sub (Mul (Mul a7~58@ b7~60@) c7~62@) b7~60@) (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ a7~58@)) (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ b7~60@)))) (Mul (Mul d7~64@ (Sub (Mul b7~60@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul d7~64@ c7~62@) (Sub 97 d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul d7~64@ a7~58@))))) (Mul (Mul (Sub d7~64@ (Mul (Mul d7~64@ d7~64@) (Sub b7~60@ a7~58@))) (Mul (Mul d7~64@ (Mul a7~58@ c7~62@)) (Mul (Add d7~64@ b7~60@) (Mul d7~64@ c7~62@)))) (Add (Sub (Mul (Sub d7~64@ c7~62@) (Mul a7~58@ a7~58@)) (Add (Mul a7~58@ d7~64@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul c7~62@ a7~58@) (Sub c7~62@ b7~60@)) (Add d7~64@ (Mul d7~64@ b7~60@))))))) (=> (= temp_7_1~3888@ (Mul (Add (Mul (Sub (Mul (Mul a7~58@ b7~60@) c7~62@) b7~60@) (Mul (Mul (Mul c7~62@ d7~64@) (Mul d7~64@ a7~58@)) (Mul (Mul d7~64@ c7~62@) (Mul c7~62@ b7~60@)))) (Mul (Mul d7~64@ (Sub (Mul b7~60@ b7~60@) (Mul c7~62@ b7~60@))) (Mul (Mul (Mul d7~64@ c7~62@) (Sub 97 d7~64@)) (Mul (Mul d7~64@ b7~60@) (Mul a7~58@ d7~64@))))) (Mul (Mul (Sub d7~64@ (Mul (Mul d7~64@ d7~64@) (Sub b7~60@ a7~58@))) (Mul (Mul d7~64@ (Mul a7~58@ c7~62@)) (Mul (Add d7~64@ b7~60@) (Mul d7~64@ c7~62@)))) (Add (Sub (Mul (Sub d7~64@ c7~62@) (Mul a7~58@ a7~58@)) (Add (Mul a7~58@ d7~64@) (Mul a7~58@ b7~60@))) (Mul (Mul (Mul c7~62@ a7~58@) (Sub c7~62@ b7~60@)) (Add d7~64@ (Mul d7~64@ b7~60@))))))) (and (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%7 (= temp_7_0~3667@ temp_7_1~3888@))) (=> (= temp_7_0~3667@ temp_7_1~3888@) (=> (= temp_8_0~4081@ (Add (Mul (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Add c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Sub c8~70@ b8~68@) (Sub b8~68@ c8~70@)))) (Mul d8~72@ c8~70@)) (Mul (Mul (Add (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ a8~66@) a8~66@)) (Mul (Mul (Add b8~68@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Sub c8~70@ a8~66@)))) (Mul c8~70@ (Mul (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ d8~72@))))))) (=> (= temp_8_1~4250@ (Add (Mul (Mul (Mul (Mul (Mul (Mul d8~72@ c8~70@) (Add c8~70@ b8~68@)) (Mul (Mul a8~66@ b8~68@) (Mul d8~72@ d8~72@))) (Mul (Mul (Mul a8~66@ d8~72@) (Mul d8~72@ c8~70@)) (Mul (Sub c8~70@ b8~68@) (Sub b8~68@ c8~70@)))) d8~72@) c8~70@) (Mul (Mul (Add (Mul (Mul a8~66@ c8~70@) (Mul c8~70@ b8~68@)) (Mul (Mul c8~70@ a8~66@) a8~66@)) (Mul (Mul (Add b8~68@ d8~72@) (Mul a8~66@ a8~66@)) (Mul (Mul d8~72@ a8~66@) (Sub c8~70@ a8~66@)))) (Mul c8~70@ (Mul (Mul (Mul b8~68@ c8~70@) (Mul b8~68@ b8~68@)) (Mul (Mul c8~70@ c8~70@) (Mul c8~70@ d8~72@))))))) (=> (ens%main!nl_basics.lemma_mul_properties_auto_1. 0) (=> %%location_label%%8 (= temp_8_0~4081@ temp_8_1~4250@))))))))))))))))))))))))))))))))))))))))
(assert %%query%%)
(check-sat)
