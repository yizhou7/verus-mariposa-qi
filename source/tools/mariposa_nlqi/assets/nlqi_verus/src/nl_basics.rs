...
pub closed spec fn leq_(x: Elem, y: Elem) -> bool;
...
ensures
	...
	forall |x: Elem|
		(leq_(x, x)),
	forall |x: Elem, y: Elem, z: Elem|
		((leq_(x, y) && leq_(y, z)) ==> leq_(x, z)),
	forall |x: Elem, y: Elem|
		(eq_(x, y) ==> leq_(x, y)),
	forall |x: Elem, y: Elem|
		leq_(x, add_(x, y)),
	forall |x0: Elem, x1: Elem, y0: Elem|
		(leq_(x0, x1) ==> leq_(add_(x0, y0), add_(x1, y0))),
	forall |x0: Elem, y0: Elem, y1: Elem|
		(leq_(y0, y1) ==> leq_(add_(x0, y0), add_(x0, y1))),
	forall |x: Elem, y: Elem|
		leq_(x, mul_(x, y)),
	forall |x0: Elem, x1: Elem, y0: Elem|
		(leq_(x0, x1) ==> leq_(mul_(x0, y0), mul_(x1, y0))),
	forall |x0: Elem, y0: Elem, y1: Elem|
		(leq_(y0, y1) ==> leq_(mul_(x0, y0), mul_(x0, y1))),
